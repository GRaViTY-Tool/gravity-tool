	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasicPackage.TACCESS: {
				...
				if (result == null) result = caseTElementWithId(tAccess);
			...
			case BasicPackage.TANNOTATION: {
				...
				if (result == null) result = caseTElementWithId(tAnnotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TCLASS: {
				...
				if (result == null) result = caseTElementWithId(tClass);
			...
			case BasicPackage.TFIELD: {
				...
				if (result == null) result = caseTElementWithId(tField);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TFIELD_DEFINITION: {
				...
				if (result == null) result = caseTElementWithId(tFieldDefinition);
			...
			case BasicPackage.TFIELD_SIGNATURE: {
				...
				if (result == null) result = caseTElementWithId(tFieldSignature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TMEMBER: {
				...
				if (result == null) result = caseTElementWithId(tMember);
			...
			case BasicPackage.TMETHOD: {
				...
				if (result == null) result = caseTElementWithId(tMethod);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TMETHOD_DEFINITION: {
				...
				if (result == null) result = caseTElementWithId(tMethodDefinition);
			...
			case BasicPackage.TMETHOD_SIGNATURE: {
				...
				if (result == null) result = caseTElementWithId(tMethodSignature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TPACKAGE: {
				...
				if (result == null) result = caseTElementWithId(tPackage);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TPARAMETER: {
				...
				if (result == null) result = caseTElementWithId(tParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TPARAMETER_LIST: {
				...
				if (result == null) result = caseTElementWithId(tParameterList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TSIGNATURE: {
				...
				if (result == null) result = caseTElementWithId(tSignature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TYPE_GRAPH: {
				...
				if (result == null) result = caseTElementWithId(typeGraph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TINTERFACE: {
				...
				if (result == null) result = caseTElementWithId(tInterface);
			...
			case BasicPackage.TABSTRACT_TYPE: {
				...
				if (result == null) result = caseTElementWithId(tAbstractType);
			...
			case BasicPackage.TANNOTATION_TYPE: {
				...
				if (result == null) result = caseTElementWithId(tAnnotationType);
			...
			case BasicPackage.TTEXT_ANNOTATION: {
				...
				if (result == null) result = caseTElementWithId(tTextAnnotation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TCONSTRUCTOR_NAME: {
				...
				if (result == null) result = caseTElementWithId(tConstructorName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TCONSTRUCTOR_SIGNATURE: {
				...
				if (result == null) result = caseTElementWithId(tConstructorSignature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasicPackage.TCONSTRUCTOR_DEFINITION: {
				...
				if (result == null) result = caseTElementWithId(tConstructorDefinition);
