...
public abstract class TAnnotatableImpl extends MinimalEObjectImpl.Container implements TAnnotatable {
	...
	public EList<TAnnotation> getTAnnotation() {
		if (tAnnotation == null) {
			tAnnotation = new EObjectContainmentWithInverseEList<TAnnotation>(TAnnotation.class, this, BasicPackage.TANNOTATABLE__TANNOTATION, BasicPackage.TANNOTATION__TANNOTATED);
		}
		return tAnnotation;
	}
