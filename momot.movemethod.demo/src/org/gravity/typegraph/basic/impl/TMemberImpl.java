...
public abstract class TMemberImpl extends TElementWithIdImpl implements TMember {
	...
	public EList<TAnnotation> getTAnnotation() {
		if (tAnnotation == null) {
			tAnnotation = new EObjectContainmentWithInverseEList<TAnnotation>(TAnnotation.class, this, BasicPackage.TMEMBER__TANNOTATION, BasicPackage.TANNOTATION__TANNOTATED);
		}
		return tAnnotation;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TAnnotatable.class) {
			switch (derivedFeatureID) {
				case BasicPackage.TMEMBER__TANNOTATION: return BasicPackage.TANNOTATABLE__TANNOTATION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TAnnotatable.class) {
			switch (baseFeatureID) {
				case BasicPackage.TANNOTATABLE__TANNOTATION: return BasicPackage.TMEMBER__TANNOTATION;
				default: return -1;
			}
		}
