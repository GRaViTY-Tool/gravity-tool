...
public class TAnnotationTypeImpl extends TAbstractTypeImpl implements TAnnotationType {
	...
	public EList<TAnnotation> getAnnotations() {
		if (annotations == null) {
			annotations = new EObjectWithInverseResolvingEList<TAnnotation>(TAnnotation.class, this, BasicPackage.TANNOTATION_TYPE__ANNOTATIONS, BasicPackage.TANNOTATION__TYPE);
		}
		return annotations;
	}
