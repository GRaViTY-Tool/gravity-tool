...
public class BasicPackageImpl extends EPackageImpl implements BasicPackage {
	...
	public void initializePackageContents() {
		...
		initEOperation(getTClass__GetAllTMembers(), theContainersPackage.getTMemberContainer(), "getAllTMembers", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(tElementWithIdEClass, TElementWithId.class, "TElementWithId", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTElementWithId_ID(), ecorePackage.getEInt(), "ID", null, 1, 1, TElementWithId.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEOperation(getTFieldDefinition__GetSignatureString(), ecorePackage.getEString(), "getSignatureString", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getTMethodDefinition__GetSignatureString(), ecorePackage.getEString(), "getSignatureString", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getTypeGraph_TAnnotationTypes(), this.getTAnnotationType(), null, "tAnnotationTypes", null, 0, -1, TypeGraph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
