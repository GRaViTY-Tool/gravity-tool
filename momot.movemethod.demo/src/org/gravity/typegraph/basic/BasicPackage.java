...
public interface BasicPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int TABSTRACT_TYPE___GET_FULLY_QUALIFIED_NAME = TELEMENT_WITH_ID_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TABSTRACT_TYPE_OPERATION_COUNT = TELEMENT_WITH_ID_OPERATION_COUNT + 1;
	 ...
	 * @ordered
	 */
	int TMEMBER___GET_SIGNATURE = TELEMENT_WITH_ID_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TMEMBER___GET_SIGNATURE_STRING = TELEMENT_WITH_ID_OPERATION_COUNT + 1;
	 ...
	 * @ordered
	 */
	int TMEMBER_OPERATION_COUNT = TELEMENT_WITH_ID_OPERATION_COUNT + 2;
	 ...
	 * @ordered
	 */
	int TTEXT_ANNOTATION__ID = TANNOTATION__ID;
	 ...
	 * @ordered
	 */
	int TCONSTRUCTOR_NAME__ID = TMETHOD__ID;
	 ...
	 * @ordered
	 */
	int TCONSTRUCTOR_SIGNATURE__ID = TMETHOD_SIGNATURE__ID;
	 ...
	 * @ordered
	 */
	int TCONSTRUCTOR_DEFINITION__ID = TMETHOD_DEFINITION__ID;
