...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Class2 TClass</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class Class2TClassImpl extends AbstractCorrespondenceImpl implements Class2TClass {
	/**
	...
	protected EClass eStaticClass() {
		return UmlPackage.Literals.CLASS2_TCLASS;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlPackage.CLASS2_TCLASS__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(org.eclipse.uml2.uml.Class newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.CLASS2_TCLASS__SOURCE, oldSource, source));
	}
	...
	public TClass getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmlPackage.CLASS2_TCLASS__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public void setTarget(TClass newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UmlPackage.CLASS2_TCLASS__TARGET, oldTarget, target));
	}
