...
public class ModelNested2TypeGraphImpl extends AbstractRuleImpl implements ModelNested2TypeGraph {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ModelNested2TypeGraphImpl
				.pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_blackBBBBBB(ruleresult, model, model2PM, pm,
		...
		ModelNested2TypeGraphImpl.pattern_ModelNested2TypeGraph_1_5_registerobjects_expressionBBBBBBB(this, ruleresult,
				model, model2PM, pm, outerModel2PM, outerModel);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ModelNested2TypeGraphImpl
				.pattern_ModelNested2TypeGraph_2_2_corematch_blackBFBB(model, outerModel, match)) {
			Model2TypeGraph outerModel2PM = (Model2TypeGraph) result2_black[1];
			// ForEach 
			for (Object[] result3_black : ModelNested2TypeGraphImpl
					.pattern_ModelNested2TypeGraph_2_3_findcontext_blackBBB(model, outerModel2PM, outerModel)) {
				Object[] result3_green = ModelNested2TypeGraphImpl
						.pattern_ModelNested2TypeGraph_2_3_findcontext_greenBBBFFFF(model, outerModel2PM, outerModel);
				...
				Object[] result4_bindingAndBlack = ModelNested2TypeGraphImpl
						.pattern_ModelNested2TypeGraph_2_4_solveCSP_bindingAndBlackFBBBBB(this, isApplicableMatch,
								model, outerModel2PM, outerModel);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject model, EObject model2PM, EObject pm,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ModelNested2TypeGraphImpl
				.pattern_ModelNested2TypeGraph_11_3_bookkeepingforedges_blackBBBBBB(ruleresult, model, model2PM, pm,
						outerModel2PM, outerModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[model] = " + model + ", " + "[model2PM] = " + model2PM + ", " + "[pm] = " + pm + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject model, EObject model2PM, EObject pm,
			EObject outerModel2PM, EObject outerModel) {
		ruleresult.registerObject("model", model);
		ruleresult.registerObject("model2PM", model2PM);
		ruleresult.registerObject("pm", pm);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MODEL_NESTED2_TYPE_GRAPH___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODEL_MODEL2TYPEGRAPH_MODEL:
		...
		if (tmpModel instanceof Model) {
			...
			if (tmpOuterModel2PM instanceof Model2TypeGraph) {
				...
				if (tmpOuterModel instanceof Model) {
					...
					return new Object[] { model, outerModel2PM, outerModel, isApplicableMatch };
				}
			}
		}
		return null;
		...
		if (!model.equals(outerModel)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { model, outerModel2PM, outerModel, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ModelNested2TypeGraph_1_1_performtransformation_bindingAndBlackFFFFBB(
		...
		if (result_pattern_ModelNested2TypeGraph_1_1_performtransformation_binding != null) {
			...
			Model2TypeGraph outerModel2PM = (Model2TypeGraph) result_pattern_ModelNested2TypeGraph_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_ModelNested2TypeGraph_1_1_performtransformation_black = pattern_ModelNested2TypeGraph_1_1_performtransformation_blackBBBFBB(
					model, outerModel2PM, outerModel, _this, isApplicableMatch);
	...
	public static final Object[] pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_blackBBBBBB(
			PerformRuleResult ruleresult, EObject model, EObject model2PM, EObject pm, EObject outerModel2PM,
			EObject outerModel) {
									...
									if (!outerModel2PM.equals(pm)) {
										if (!outerModel.equals(pm)) {
											if (!outerModel.equals(outerModel2PM)) {
												return new Object[] { ruleresult, model, model2PM, pm, outerModel2PM,
														outerModel };
											}
										}
									}
	...
	public static final Object[] pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject model, EObject model2PM, EObject pm, EObject outerModel) {
		...
		outerModel__model____nestedPackage.setName(outerModel__model____nestedPackage_name_prime);
		model__outerModel____nestingPackage.setName(model__outerModel____nestingPackage_name_prime);
		return new Object[] { ruleresult, model, model2PM, pm, outerModel, model2PM__model____source,
	...
	public static final void pattern_ModelNested2TypeGraph_1_5_registerobjects_expressionBBBBBBB(
			ModelNested2TypeGraph _this, PerformRuleResult ruleresult, EObject model, EObject model2PM, EObject pm,
			EObject outerModel2PM, EObject outerModel) {
		_this.registerObjects_FWD(ruleresult, model, model2PM, pm, outerModel2PM, outerModel);
	...
	public static final Iterable<Object[]> pattern_ModelNested2TypeGraph_2_2_corematch_blackBFBB(Model model,
		...
		if (!model.equals(outerModel)) {
			for (Model2TypeGraph outerModel2PM : org.moflon.core.utilities.eMoflonEMFUtil
				...
				_result.add(new Object[] { model, outerModel2PM, outerModel, match });
			}
		}
		return _result;
	}
		...
		if (!model.equals(outerModel)) {
			if (outerModel.getNestedPackages().contains(model)) {
				if (outerModel.equals(outerModel2PM.getSource())) {
					_result.add(new Object[] { model, outerModel2PM, outerModel });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_ModelNested2TypeGraph_2_3_findcontext_greenBBBFFFF(Model model,
		...
		return new Object[] { model, outerModel2PM, outerModel, isApplicableMatch, outerModel__model____nestedPackage,
	...
	public static final Object[] pattern_ModelNested2TypeGraph_2_4_solveCSP_bindingFBBBBB(ModelNested2TypeGraph _this,
			IsApplicableMatch isApplicableMatch, Model model, Model2TypeGraph outerModel2PM, Model outerModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, model, outerModel2PM, outerModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model, outerModel2PM, outerModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ModelNested2TypeGraph_2_4_solveCSP_bindingAndBlackFBBBBB(
			ModelNested2TypeGraph _this, IsApplicableMatch isApplicableMatch, Model model,
			Model2TypeGraph outerModel2PM, Model outerModel) {
		Object[] result_pattern_ModelNested2TypeGraph_2_4_solveCSP_binding = pattern_ModelNested2TypeGraph_2_4_solveCSP_bindingFBBBBB(
				_this, isApplicableMatch, model, outerModel2PM, outerModel);
	...
	public static final Object[] pattern_ModelNested2TypeGraph_11_1_performtransformation_greenFFBBB(TypeGraph pm,
		...
		return new Object[] { model, model2PM, pm, outerModel, csp };
	}
	...
	public static final void pattern_ModelNested2TypeGraph_11_5_registerobjects_expressionBBBBBBB(
			ModelNested2TypeGraph _this, PerformRuleResult ruleresult, EObject model, EObject model2PM, EObject pm,
			EObject outerModel2PM, EObject outerModel) {
		_this.registerObjects_BWD(ruleresult, model, model2PM, pm, outerModel2PM, outerModel);
	...
	public static final Object[] pattern_ModelNested2TypeGraph_12_3_findcontext_greenBBBFFF(TypeGraph pm,
		...
		outerModel2PM__outerModel____source.setName(outerModel2PM__outerModel____source_name_prime);
		return new Object[] { pm, outerModel2PM, outerModel, isApplicableMatch, outerModel2PM__pm____target,
	...
	public static final Object[] pattern_ModelNested2TypeGraph_29_6_perform_greenFFFBBB(Model outerModel,
		...
		return new Object[] { model, model2PM, pm, outerModel, ruleResult, csp };
	}
