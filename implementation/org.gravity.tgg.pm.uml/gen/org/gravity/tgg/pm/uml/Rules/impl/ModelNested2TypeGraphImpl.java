...
public class ModelNested2TypeGraphImpl extends AbstractRuleImpl implements ModelNested2TypeGraph {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ModelNested2TypeGraphImpl
				.pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_blackBBBBBB(ruleresult, pm, outerModel, model,
		...
		ModelNested2TypeGraphImpl.pattern_ModelNested2TypeGraph_1_5_registerobjects_expressionBBBBBBB(this, ruleresult,
				pm, outerModel, model, outerModel2PM, model2PM);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject pm, EObject outerModel, EObject model,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ModelNested2TypeGraphImpl
				.pattern_ModelNested2TypeGraph_11_3_bookkeepingforedges_blackBBBBBB(ruleresult, pm, outerModel, model,
						outerModel2PM, model2PM);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[pm] = " + pm + ", " + "[outerModel] = " + outerModel + ", " + "[model] = " + model + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject pm, EObject outerModel, EObject model,
			EObject outerModel2PM, EObject model2PM) {
		ruleresult.registerObject("pm", pm);
		ruleresult.registerObject("outerModel", outerModel);
		ruleresult.registerObject("model", model);
	...
	public static final Object[] pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_blackBBBBBB(
			PerformRuleResult ruleresult, EObject pm, EObject outerModel, EObject model, EObject outerModel2PM,
			EObject model2PM) {
									...
									if (!model2PM.equals(pm)) {
										if (!model2PM.equals(outerModel)) {
											if (!model2PM.equals(outerModel2PM)) {
												return new Object[] { ruleresult, pm, outerModel, model, outerModel2PM,
														model2PM };
											}
										}
									}
	...
	public static final Object[] pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject pm, EObject outerModel, EObject model, EObject model2PM) {
		...
		outerModel__model____nestedPackage.setName(outerModel__model____nestedPackage_name_prime);
		model__outerModel____nestingPackage.setName(model__outerModel____nestingPackage_name_prime);
		return new Object[] { ruleresult, pm, outerModel, model, model2PM, model2PM__pm____target,
	...
	public static final void pattern_ModelNested2TypeGraph_1_5_registerobjects_expressionBBBBBBB(
			ModelNested2TypeGraph _this, PerformRuleResult ruleresult, EObject pm, EObject outerModel, EObject model,
			EObject outerModel2PM, EObject model2PM) {
		_this.registerObjects_FWD(ruleresult, pm, outerModel, model, outerModel2PM, model2PM);
	...
	public static final Object[] pattern_ModelNested2TypeGraph_2_3_findcontext_greenBBBFFFF(Model outerModel,
		...
		outerModel__model____nestedPackage.setName(outerModel__model____nestedPackage_name_prime);
		model__outerModel____nestingPackage.setName(model__outerModel____nestingPackage_name_prime);
		return new Object[] { outerModel, model, outerModel2PM, isApplicableMatch, outerModel2PM__outerModel____source,
	...
	public static final Object[] pattern_ModelNested2TypeGraph_11_1_performtransformation_greenBBFFB(TypeGraph pm,
		...
		return new Object[] { pm, outerModel, model, model2PM, csp };
	}
	...
	public static final void pattern_ModelNested2TypeGraph_11_5_registerobjects_expressionBBBBBBB(
			ModelNested2TypeGraph _this, PerformRuleResult ruleresult, EObject pm, EObject outerModel, EObject model,
			EObject outerModel2PM, EObject model2PM) {
		_this.registerObjects_BWD(ruleresult, pm, outerModel, model, outerModel2PM, model2PM);
	...
	public static final Object[] pattern_ModelNested2TypeGraph_29_6_perform_greenFBFFBB(Model outerModel,
		...
		return new Object[] { pm, outerModel, model, model2PM, ruleResult, csp };
	}
