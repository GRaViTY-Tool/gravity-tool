...
public class ModelNested2TypeGraphImpl extends AbstractRuleImpl implements ModelNested2TypeGraph {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ModelNested2TypeGraphImpl
				.pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_blackBBBBBB(ruleresult, pm, outerModel2PM, model,
						outerModel, model2PM);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[pm] = " + pm + ", " + "[outerModel2PM] = " + outerModel2PM + ", " + "[model] = " + model
		...
		ModelNested2TypeGraphImpl.pattern_ModelNested2TypeGraph_1_5_registerobjects_expressionBBBBBBB(this, ruleresult,
				pm, outerModel2PM, model, outerModel, model2PM);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM, EObject model,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ModelNested2TypeGraphImpl
				.pattern_ModelNested2TypeGraph_11_3_bookkeepingforedges_blackBBBBBB(ruleresult, pm, outerModel2PM,
						model, outerModel, model2PM);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[pm] = " + pm + ", " + "[outerModel2PM] = " + outerModel2PM + ", " + "[model] = " + model
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM, EObject model,
			EObject outerModel, EObject model2PM) {
		ruleresult.registerObject("pm", pm);
		ruleresult.registerObject("outerModel2PM", outerModel2PM);
		ruleresult.registerObject("model", model);
	...
	public static final Object[] pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_blackBBBBBB(
			PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM, EObject model, EObject outerModel,
			EObject model2PM) {
									...
									if (!model2PM.equals(pm)) {
										if (!model2PM.equals(outerModel2PM)) {
											if (!model2PM.equals(outerModel)) {
												return new Object[] { ruleresult, pm, outerModel2PM, model, outerModel,
														model2PM };
											}
										}
									}
	...
	public static final void pattern_ModelNested2TypeGraph_1_5_registerobjects_expressionBBBBBBB(
			ModelNested2TypeGraph _this, PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM, EObject model,
			EObject outerModel, EObject model2PM) {
		_this.registerObjects_FWD(ruleresult, pm, outerModel2PM, model, outerModel, model2PM);
	...
	public static final void pattern_ModelNested2TypeGraph_11_5_registerobjects_expressionBBBBBBB(
			ModelNested2TypeGraph _this, PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM, EObject model,
			EObject outerModel, EObject model2PM) {
		_this.registerObjects_BWD(ruleresult, pm, outerModel2PM, model, outerModel, model2PM);
