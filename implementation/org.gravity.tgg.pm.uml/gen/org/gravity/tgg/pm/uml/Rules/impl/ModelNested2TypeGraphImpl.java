...
public class ModelNested2TypeGraphImpl extends AbstractRuleImpl implements ModelNested2TypeGraph {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ModelNested2TypeGraphImpl
				.pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_blackBBBBBB(ruleresult, pm, outerModel2PM,
						outerModel, model2PM, model);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[pm] = " + pm + ", " + "[outerModel2PM] = " + outerModel2PM + ", " + "[outerModel] = "
					+ outerModel + ", " + "[model2PM] = " + model2PM + ", " + "[model] = " + model + ".");
		}
		...
		ModelNested2TypeGraphImpl.pattern_ModelNested2TypeGraph_1_5_registerobjects_expressionBBBBBBB(this, ruleresult,
				pm, outerModel2PM, outerModel, model2PM, model);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM, EObject outerModel,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM, EObject outerModel,
			EObject model2PM, EObject model) {
		ruleresult.registerObject("pm", pm);
		ruleresult.registerObject("outerModel2PM", outerModel2PM);
		ruleresult.registerObject("outerModel", outerModel);
	...
	public static final Object[] pattern_ModelNested2TypeGraph_1_3_bookkeepingforedges_blackBBBBBB(
			PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM, EObject outerModel, EObject model2PM,
			EObject model) {
									...
									if (!model.equals(outerModel2PM)) {
										if (!model.equals(outerModel)) {
											if (!model.equals(model2PM)) {
												return new Object[] { ruleresult, pm, outerModel2PM, outerModel,
														model2PM, model };
											}
										}
									}
	...
	public static final void pattern_ModelNested2TypeGraph_1_5_registerobjects_expressionBBBBBBB(
			ModelNested2TypeGraph _this, PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM,
			EObject outerModel, EObject model2PM, EObject model) {
		_this.registerObjects_FWD(ruleresult, pm, outerModel2PM, outerModel, model2PM, model);
	...
	public static final void pattern_ModelNested2TypeGraph_11_5_registerobjects_expressionBBBBBBB(
			ModelNested2TypeGraph _this, PerformRuleResult ruleresult, EObject pm, EObject outerModel2PM,
			EObject outerModel, EObject model2PM, EObject model) {
		_this.registerObjects_BWD(ruleresult, pm, outerModel2PM, outerModel, model2PM, model);
