...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TName</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.gravity.typegraph.basic.impl.TNameImpl#getTName <em>TName</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TNameImpl extends MinimalEObjectImpl.Container implements TName {
	/**
	...
	protected EClass eStaticClass() {
		return BasicPackage.Literals.TNAME;
	}
	...
	public void setTName(String newTName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasicPackage.TNAME__TNAME, oldTName, tName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasicPackage.TNAME__TNAME:
				return getTName();
		}
