...
public class GradleImportHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		GradleImport importer = new GradleImport(currentUsersHomeDir + File.separator + ".gradle",
				currentUsersHomeDir + File.separator + "Android/Sdk");
		...
		try {
			...
			IJavaProject project = importer.importGradleProject(parentFile, name, monitor);
			if(project != null) {
