 ...
 * @generated
 */
public class HAntiPatternDetection extends HAntiPatternHandling {

	public HAntiPatternDetection() {
		this.getDependencyGraph();
	}

	public HAntiPatternDetection(final String programLocation) {
		this();
		this.setProgramLocation(programLocation);
	}
