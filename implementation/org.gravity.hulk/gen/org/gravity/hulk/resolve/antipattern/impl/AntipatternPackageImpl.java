...
public class AntipatternPackageImpl extends EPackageImpl implements AntipatternPackage {
	...
	public static AntipatternPackage init() {
		...
		org.gravity.hulk.detection.antipattern.impl.AntipatternPackageImpl theAntipatternPackage_1 = (org.gravity.hulk.detection.antipattern.impl.AntipatternPackageImpl) (registeredPackage instanceof org.gravity.hulk.detection.antipattern.impl.AntipatternPackageImpl
				? registeredPackage
	...
	public EReference getHBlobResolver_ExecutedMoves() {
		return (EReference) hBlobResolverEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getHBlobResolver_Original_apg() {
		return (EReference) hBlobResolverEClass.getEStructuralFeatures().get(1);
	}
	...
	public EReference getHBlobResolver_Copy_apg() {
		return (EReference) hBlobResolverEClass.getEStructuralFeatures().get(2);
	}
	...
	public EOperation getHBlobResolver__Detect__HAntiPatternGraph() {
		return hBlobResolverEClass.getEOperations().get(0);
	}
	...
	public EOperation getHBlobResolver__IsRefactoringPossible__HRefactoring() {
		return hBlobResolverEClass.getEOperations().get(1);
	}
	...
	public EOperation getHBlobResolver__CreateMove__TMemberContainer_TClass_TClass_HBlobResolveAnnotation() {
		return hBlobResolverEClass.getEOperations().get(2);
	}
	...
	public EOperation getHBlobResolver__AllowedToTouch__TAnnotatable() {
		return hBlobResolverEClass.getEOperations().get(3);
	}
	...
	public EOperation getHBlobResolver__Init__HAntiPatternGraph() {
		return hBlobResolverEClass.getEOperations().get(4);
	}
	...
	public EClass getHAlternativeBlobresolver() {
		return hAlternativeBlobresolverEClass;
	}
	...
	public EOperation getHAlternativeBlobresolver__Detect__HAntiPatternGraph() {
		return hAlternativeBlobresolverEClass.getEOperations().get(0);
	}
	...
	public EOperation getHAlternativeBlobresolver__Process__HInBlobClusterAccess_TClass_HBlobResolveAnnotation() {
		return hAlternativeBlobresolverEClass.getEOperations().get(1);
	}
	...
	public void createPackageContents() {
		...
		hBlobResolverEClass = createEClass(HBLOB_RESOLVER);
		createEReference(hBlobResolverEClass, HBLOB_RESOLVER__EXECUTED_MOVES);
		createEReference(hBlobResolverEClass, HBLOB_RESOLVER__ORIGINAL_APG);
		createEReference(hBlobResolverEClass, HBLOB_RESOLVER__COPY_APG);
		createEOperation(hBlobResolverEClass, HBLOB_RESOLVER___DETECT__HANTIPATTERNGRAPH);
		createEOperation(hBlobResolverEClass, HBLOB_RESOLVER___IS_REFACTORING_POSSIBLE__HREFACTORING);
		createEOperation(hBlobResolverEClass,
				HBLOB_RESOLVER___CREATE_MOVE__TMEMBERCONTAINER_TCLASS_TCLASS_HBLOBRESOLVEANNOTATION);
		createEOperation(hBlobResolverEClass, HBLOB_RESOLVER___ALLOWED_TO_TOUCH__TANNOTATABLE);
		createEOperation(hBlobResolverEClass, HBLOB_RESOLVER___INIT__HANTIPATTERNGRAPH);

		hAlternativeBlobresolverEClass = createEClass(HALTERNATIVE_BLOBRESOLVER);
		createEOperation(hAlternativeBlobresolverEClass, HALTERNATIVE_BLOBRESOLVER___DETECT__HANTIPATTERNGRAPH);
		createEOperation(hAlternativeBlobresolverEClass,
	...
	public void initializePackageContents() {
		...
		hBlobResolverEClass.getESuperTypes().add(theDetectionPackage.getHAntiPatternDetector());
		hBlobResolverEClass.getESuperTypes().add(theResolvePackage.getHAntiPatternResolver());
		hAlternativeBlobresolverEClass.getESuperTypes().add(this.getHBlobResolver());

		// Initialize classes, features, and operations; add parameters
		initEClass(hBlobResolverEClass, HBlobResolver.class, "HBlobResolver", !IS_ABSTRACT, !IS_INTERFACE,
		...
		EOperation op = initEOperation(getHBlobResolver__Detect__HAntiPatternGraph(), ecorePackage.getEBoolean(),
		...
		op = initEOperation(getHBlobResolver__IsRefactoringPossible__HRefactoring(), ecorePackage.getEBoolean(),
		...
		addEParameter(op, theContainersPackage.getTMemberContainer(), "members", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getHBlobResolver__AllowedToTouch__TAnnotatable(), ecorePackage.getEBoolean(),
		...
		initEClass(hAlternativeBlobresolverEClass, HAlternativeBlobresolver.class, "HAlternativeBlobresolver",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		op = initEOperation(getHAlternativeBlobresolver__Detect__HAntiPatternGraph(), ecorePackage.getEBoolean(),
				"detect", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theAntipatterngraphPackage.getHAntiPatternGraph(), "apg", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getHAlternativeBlobresolver__Process__HInBlobClusterAccess_TClass_HBlobResolveAnnotation(),
				ecorePackage.getEBoolean(), "process", 0, 1, IS_UNIQUE, IS_ORDERED);
