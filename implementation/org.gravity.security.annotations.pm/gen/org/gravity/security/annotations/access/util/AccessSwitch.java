...
public class AccessSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case AccessPackage.TAPI: {
			TApi tApi = (TApi) theEObject;
			T result = caseTApi(tApi);
			if (result == null)
				result = caseTAnnotation(tApi);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TApi</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>TApi</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTApi(TApi object) {
		return null;
	}
