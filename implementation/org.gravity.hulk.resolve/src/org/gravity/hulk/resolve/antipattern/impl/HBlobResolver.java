 ...
 * <ul>
 * <li>{@link org.gravity.hulk.resolve.antipattern.impl.HBlobResolver#getExecutedMoves
 * <em>Executed Moves</em>}</li>
 * <li>{@link org.gravity.hulk.resolve.antipattern.impl.HBlobResolver#getOriginal_apg
 * <em>Original apg</em>}</li>
 * <li>{@link org.gravity.hulk.resolve.antipattern.impl.HBlobResolver#getCopy_apg
 * <em>Copy apg</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HBlobResolver extends AbstractHDetector implements HResolver {

	/**
	 * The logger of this class
	 */
	private static final Logger LOGGER = Logger.getLogger(HBlobResolver.class);
	 ...
	 * @ordered
	 */
	protected HAntiPatternGraph originalAPG;
	 ...
	 * @generated
	 */
	public HBlobResolver(final DFSGraph graph, final HMethodToDataClassAccessCalculator m2dc,
	...
	private void resolve(final HAntiPatternGraph apg, final TClass tClass, final HBlobResolveAnnotation annotation) {
		for (final TMember tDefinition : tClass.getDefines()) {
			if (this.allowedToTouch(tDefinition)) {
				//
				final var iba = HBlobResolver.searchInBlobAccess(tDefinition);
				if (iba != null) {
