...
public class PublicInterfacesAccessHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Job job = new CreateProgramModelJob("Create PG", selection);
		job.setUser(true);
		job.schedule();
	...
	private static void dfs(TMember member, Set<TAnnotationType> allowed, Set<String> names, Set<TMember> visited) {
	...
	private static final class CreateProgramModelJob extends Job {
		private final List<Object> selection;

		private CreateProgramModelJob(String name, List<Object> selection) {
			super(name);
