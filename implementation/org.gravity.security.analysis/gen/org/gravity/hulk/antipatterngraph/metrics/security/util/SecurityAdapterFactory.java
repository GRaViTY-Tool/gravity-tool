/**
 */
package org.gravity.hulk.antipatterngraph.metrics.security.util;
...
import org.gravity.hulk.antipatterngraph.metrics.security.*;
...
public class SecurityAdapterFactory extends AdapterFactoryImpl {
	...
	protected SecuritySwitch<Adapter> modelSwitch =
		new SecuritySwitch<Adapter>() {
			@Override
			public Adapter caseCriticalClassRatio(CriticalClassRatio object) {
				return createCriticalClassRatioAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.gravity.hulk.antipatterngraph.metrics.security.CriticalClassRatio <em>Critical Class Ratio</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createCriticalClassRatioAdapter() {
		return null;
	}
