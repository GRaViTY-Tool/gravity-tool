...
public class SecuritySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SecurityPackage.CRITICAL_CLASS_RATIO: {
				CriticalClassRatio criticalClassRatio = (CriticalClassRatio)theEObject;
				T result = caseCriticalClassRatio(criticalClassRatio);
				if (result == null) result = caseHMetric(criticalClassRatio);
				if (result == null) result = caseHAnnotation(criticalClassRatio);
				if (result == null) result = caseTAnnotation(criticalClassRatio);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Critical Class Ratio</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Critical Class Ratio</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCriticalClassRatio(CriticalClassRatio object) {
		return null;
	}
