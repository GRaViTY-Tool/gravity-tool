...
public class MClassInstanceCreationImpl extends ClassInstanceCreationImpl implements MClassInstanceCreation {
	...
	public EList<MFlow> getIncomingFlows() {
		if (incomingFlows == null) {
			incomingFlows = new EObjectWithInverseResolvingEList<MFlow>(MFlow.class, this, ModiscoPackage.MCLASS_INSTANCE_CREATION__INCOMING_FLOWS, ModiscoPackage.MFLOW__FLOW_TARGET);
		}
	...
	public EList<MFlow> getOutgoingFlows() {
		if (outgoingFlows == null) {
			outgoingFlows = new EObjectWithInverseResolvingEList<MFlow>(MFlow.class, this, ModiscoPackage.MCLASS_INSTANCE_CREATION__OUTGOING_FLOWS, ModiscoPackage.MFLOW__FLOW_SOURCE);
		}
