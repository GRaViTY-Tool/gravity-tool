...
public class FieldDefinitionImpl extends AbstractRuleImpl implements FieldDefinition {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = FieldDefinitionImpl.pattern_FieldDefinition_1_2_collecttranslatedelements_blackBBBBB(
				mDefinition, mBodyToTAnnotation, mDefinitionToTMember, mDefinitionToTDefinition, tDefinition);
		...
		Object[] result3_black = FieldDefinitionImpl.pattern_FieldDefinition_1_3_bookkeepingforedges_blackBBBBBBBBB(
				ruleresult, mDefinition, mSignatureToTFieldSignature, mBodyToTAnnotation, mDefinitionToTMember,
				mDefinitionToTDefinition, tFieldSignature, tDefinition, mSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mDefinition] = " + mDefinition + ", " + "[mSignatureToTFieldSignature] = "
					+ mSignatureToTFieldSignature + ", " + "[mBodyToTAnnotation] = " + mBodyToTAnnotation + ", "
		...
		FieldDefinitionImpl.pattern_FieldDefinition_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFF(ruleresult,
				mDefinition, mBodyToTAnnotation, mDefinitionToTMember, mDefinitionToTDefinition, tFieldSignature,
		...
		FieldDefinitionImpl.pattern_FieldDefinition_1_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult,
				mDefinition, mSignatureToTFieldSignature, mBodyToTAnnotation, mDefinitionToTMember,
				mDefinitionToTDefinition, tFieldSignature, tDefinition, mSignature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldDefinitionImpl.pattern_FieldDefinition_2_2_corematch_blackBFFBB(mDefinition,
				mSignature, match)) {
			...
			for (Object[] result3_black : FieldDefinitionImpl.pattern_FieldDefinition_2_3_findcontext_blackBBBB(
					mDefinition, mSignatureToTFieldSignature, tFieldSignature, mSignature)) {
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mDefinition,
			EObject mSignatureToTFieldSignature, EObject mBodyToTAnnotation, EObject mDefinitionToTMember,
			EObject mDefinitionToTDefinition, EObject tFieldSignature, EObject tDefinition, EObject mSignature) {
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mDefinition,
			EObject mSignatureToTFieldSignature, EObject mBodyToTAnnotation, EObject mDefinitionToTMember,
			EObject mDefinitionToTDefinition, EObject tFieldSignature, EObject tDefinition, EObject mSignature) {
		ruleresult.registerObject("mDefinition", mDefinition);
		ruleresult.registerObject("mSignatureToTFieldSignature", mSignatureToTFieldSignature);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (FieldDefinitionImpl.pattern_FieldDefinition_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldDefinitionImpl.pattern_FieldDefinition_24_5_matchcorrcontext_blackFBBBB(
				...
				FieldDefinitionImpl.pattern_FieldDefinition_24_6_createcorrespondence_greenBFFFBB(mDefinition,
						tDefinition, ccMatch);
		...
		for (Object[] result2_black : FieldDefinitionImpl
			...
			if (FieldDefinitionImpl.pattern_FieldDefinition_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					FieldDefinitionImpl.pattern_FieldDefinition_29_6_perform_greenFFFFBFBB(tFieldSignature, mSignature,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEFINITION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MFIELDDEFINITION_MSIGNATURETOTSIGNATURE_TFIELDSIGNATURE_MFIELDSIGNATURE:
		...
		case RulesPackage.FIELD_DEFINITION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_41__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEFINITION___IS_APPLICABLE_SOLVE_CSP_CC__MFIELDDEFINITION_TFIELDSIGNATURE_TFIELDDEFINITION_MFIELDSIGNATURE_MATCH_MATCH:
			...
			if (tmpMSignatureToTFieldSignature instanceof MSignatureToTSignature) {
				...
				if (tmpTFieldSignature instanceof TFieldSignature) {
					...
					if (tmpMSignature instanceof MFieldSignature) {
						...
						return new Object[] { mDefinition, mSignatureToTFieldSignature, tFieldSignature, mSignature,
								isApplicableMatch };
					}
				}
			}
	...
	public static final Object[] pattern_FieldDefinition_1_1_performtransformation_blackBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinition, mSignatureToTFieldSignature, tFieldSignature, mSignature, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_FieldDefinition_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_FieldDefinition_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldDefinition_1_1_performtransformation_black = pattern_FieldDefinition_1_1_performtransformation_blackBBBBFBB(
					mDefinition, mSignatureToTFieldSignature, tFieldSignature, mSignature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldDefinition_1_1_performtransformation_greenBFFFBF(
		...
		return new Object[] { mDefinition, mBodyToTAnnotation, mDefinitionToTMember, mDefinitionToTDefinition,
				tFieldSignature, tDefinition };
	}

	public static final Object[] pattern_FieldDefinition_1_2_collecttranslatedelements_blackBBBBB(
			MFieldDefinition mDefinition, ASTNodeToTAnnotatable mBodyToTAnnotation,
	...
	public static final Object[] pattern_FieldDefinition_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, mDefinition, mBodyToTAnnotation, mDefinitionToTMember,
	...
	public static final Object[] pattern_FieldDefinition_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mDefinition, EObject mSignatureToTFieldSignature,
			EObject mBodyToTAnnotation, EObject mDefinitionToTMember, EObject mDefinitionToTDefinition,
			EObject tFieldSignature, EObject tDefinition, EObject mSignature) {
	...
	public static final Object[] pattern_FieldDefinition_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mDefinition, EObject mBodyToTAnnotation, EObject mDefinitionToTMember,
			EObject mDefinitionToTDefinition, EObject tFieldSignature, EObject tDefinition, EObject mSignature) {
	...
	public static final void pattern_FieldDefinition_1_5_registerobjects_expressionBBBBBBBBBB(FieldDefinition _this,
			...
			EObject mBodyToTAnnotation, EObject mDefinitionToTMember, EObject mDefinitionToTDefinition,
			EObject tFieldSignature, EObject tDefinition, EObject mSignature) {
		_this.registerObjects_FWD(ruleresult, mDefinition, mSignatureToTFieldSignature, mBodyToTAnnotation,
				mDefinitionToTMember, mDefinitionToTDefinition, tFieldSignature, tDefinition, mSignature);
	...
	public static final Iterable<Object[]> pattern_FieldDefinition_2_2_corematch_blackBFFBB(
		...
		for (MSignatureToTSignature mSignatureToTFieldSignature : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTFieldSignature instanceof TFieldSignature) {
				TFieldSignature tFieldSignature = (TFieldSignature) tmpTFieldSignature;
				_result.add(
						new Object[] { mDefinition, mSignatureToTFieldSignature, tFieldSignature, mSignature, match });
			}
		...
		if (tFieldSignature.equals(mSignatureToTFieldSignature.getTarget())) {
			if (mSignature.getMDefinitions().contains(mDefinition)) {
				if (mSignature.equals(mSignatureToTFieldSignature.getSource())) {
					_result.add(new Object[] { mDefinition, mSignatureToTFieldSignature, tFieldSignature, mSignature });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_FieldDefinition_2_3_findcontext_greenBBBBFFFFF(MFieldDefinition mDefinition,
		...
		return new Object[] { mDefinition, mSignatureToTFieldSignature, tFieldSignature, mSignature, isApplicableMatch,
	...
	public static final Object[] pattern_FieldDefinition_2_4_solveCSP_bindingAndBlackFBBBBBB(FieldDefinition _this,
		...
		Object[] result_pattern_FieldDefinition_2_4_solveCSP_binding = pattern_FieldDefinition_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, mDefinition, mSignatureToTFieldSignature, tFieldSignature, mSignature);
	...
	public static final void pattern_FieldDefinition_11_5_registerobjects_expressionBBBBBBBBBB(FieldDefinition _this,
			...
			EObject mBodyToTAnnotation, EObject mDefinitionToTMember, EObject mDefinitionToTDefinition,
			EObject tFieldSignature, EObject tDefinition, EObject mSignature) {
		_this.registerObjects_BWD(ruleresult, mDefinition, mSignatureToTFieldSignature, mBodyToTAnnotation,
				mDefinitionToTMember, mDefinitionToTDefinition, tFieldSignature, tDefinition, mSignature);
	...
	public static final Object[] pattern_FieldDefinition_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TSignature __DEC_tDefinition_signature_367373 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_367373 != null) {
			if (!tFieldSignature.equals(__DEC_tDefinition_signature_367373)) {
	...
	public static final Object[] pattern_FieldDefinition_21_2_testcorematchandDECs_black_nac_0BB(
			MFieldDefinition mDefinition, MFieldSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_937148 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_937148 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_937148)) {
		...
		if (tmpMDefinition instanceof MFieldDefinition) {
			...
			if (tmpTFieldSignature instanceof TFieldSignature) {
				...
				if (tmpTDefinition instanceof TFieldDefinition) {
					...
					if (tmpMSignature instanceof MFieldSignature) {
						MFieldSignature mSignature = (MFieldSignature) tmpMSignature;
						return new Object[] { mDefinition, tFieldSignature, tDefinition, mSignature, sourceMatch,
								targetMatch };
					}
				}
			}
	...
	public static final Object[] pattern_FieldDefinition_24_2_matchsrctrgcontext_blackBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mDefinition, tFieldSignature, tDefinition, mSignature, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDefinition_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_FieldDefinition_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_FieldDefinition_24_2_matchsrctrgcontext_black = pattern_FieldDefinition_24_2_matchsrctrgcontext_blackBBBBBB(
					mDefinition, tFieldSignature, tDefinition, mSignature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldDefinition_24_3_solvecsp_bindingFBBBBBBB(FieldDefinition _this,
			MFieldDefinition mDefinition, TFieldSignature tFieldSignature, TFieldDefinition tDefinition,
			MFieldSignature mSignature, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mDefinition, tFieldSignature, tDefinition, mSignature,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mDefinition, tFieldSignature, tDefinition, mSignature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDefinition_24_3_solvecsp_bindingAndBlackFBBBBBBB(FieldDefinition _this,
		...
		Object[] result_pattern_FieldDefinition_24_3_solvecsp_binding = pattern_FieldDefinition_24_3_solvecsp_bindingFBBBBBBB(
				_this, mDefinition, tFieldSignature, tDefinition, mSignature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldDefinition_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { mDefinition, tFieldSignature, tDefinition, mSignature, ccMatch };
	}
	...
	public static final Object[] pattern_FieldDefinition_27_1_matchtggpattern_black_nac_0BB(
			MFieldDefinition mDefinition, MFieldSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_831592 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_831592 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_831592)) {
				return new Object[] { mDefinition, mSignature };
			}
		}
	...
	public static final Object[] pattern_FieldDefinition_28_1_matchtggpattern_black_nac_0BB(
			TFieldDefinition tDefinition, TFieldSignature tFieldSignature) {
		TSignature __DEC_tDefinition_signature_478076 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_478076 != null) {
			if (!tFieldSignature.equals(__DEC_tDefinition_signature_478076)) {
				return new Object[] { tDefinition, tFieldSignature };
			}
		}
	...
	public static final Object[] pattern_FieldDefinition_29_6_perform_greenFFFFBFBB(TFieldSignature tFieldSignature,
			MFieldSignature mSignature, ModelgeneratorRuleResult ruleResult) {
		MFieldDefinition mDefinition = ModiscoFactory.eINSTANCE.createMFieldDefinition();
		ASTNodeToTAnnotatable mBodyToTAnnotation = PmFactory.eINSTANCE.createASTNodeToTAnnotatable();
		MDefinitionToTMember mDefinitionToTMember = PmFactory.eINSTANCE.createMDefinitionToTMember();
		...
		return new Object[] { mDefinition, mBodyToTAnnotation, mDefinitionToTMember, mDefinitionToTDefinition,
				tFieldSignature, tDefinition, mSignature, ruleResult };
	}
