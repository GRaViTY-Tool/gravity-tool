...
public class FieldDefinitionImpl extends AbstractRuleImpl implements FieldDefinition {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = FieldDefinitionImpl.pattern_FieldDefinition_1_2_collecttranslatedelements_blackBBBBB(
				mDefinitionToTMember, tDefinition, mBodyToTAnnotation, mDefinition, mDefinitionToTDefinition);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mDefinitionToTMember] = "
					+ mDefinitionToTMember + ", " + "[tDefinition] = " + tDefinition + ", " + "[mBodyToTAnnotation] = "
		...
		Object[] result3_black = FieldDefinitionImpl.pattern_FieldDefinition_1_3_bookkeepingforedges_blackBBBBBBBBB(
				ruleresult, mSignatureToTFieldSignature, tFieldSignature, mDefinitionToTMember, tDefinition,
				mBodyToTAnnotation, mSignature, mDefinition, mDefinitionToTDefinition);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ mDefinitionToTMember + ", " + "[tDefinition] = " + tDefinition + ", " + "[mBodyToTAnnotation] = "
					+ mBodyToTAnnotation + ", " + "[mSignature] = " + mSignature + ", " + "[mDefinition] = "
		...
		FieldDefinitionImpl.pattern_FieldDefinition_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFF(ruleresult,
				tFieldSignature, mDefinitionToTMember, tDefinition, mBodyToTAnnotation, mSignature, mDefinition,
		...
		FieldDefinitionImpl.pattern_FieldDefinition_1_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult,
				mSignatureToTFieldSignature, tFieldSignature, mDefinitionToTMember, tDefinition, mBodyToTAnnotation,
				mSignature, mDefinition, mDefinitionToTDefinition);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mSignatureToTFieldSignature,
			EObject tFieldSignature, EObject mDefinitionToTMember, EObject tDefinition, EObject mBodyToTAnnotation,
			EObject mSignature, EObject mDefinition, EObject mDefinitionToTDefinition) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_237(EMoflonEdge _edge_mDefinitions) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (FieldDefinitionImpl.pattern_FieldDefinition_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldDefinitionImpl.pattern_FieldDefinition_24_5_matchcorrcontext_blackFBBBB(
				...
				FieldDefinitionImpl.pattern_FieldDefinition_24_6_createcorrespondence_greenFBFBFB(tDefinition,
						mDefinition, ccMatch);
		...
		for (Object[] result2_black : FieldDefinitionImpl
			...
			if (FieldDefinitionImpl.pattern_FieldDefinition_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					FieldDefinitionImpl.pattern_FieldDefinition_29_6_perform_greenBFFFBFFB(tFieldSignature, mSignature,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEFINITION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_228__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_228((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_DEFINITION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_237__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEFINITION___IS_APPLICABLE_SOLVE_CSP_CC__TFIELDSIGNATURE_TFIELDDEFINITION_MFIELDSIGNATURE_MFIELDDEFINITION_MATCH_MATCH:
	...
	public static final Object[] pattern_FieldDefinition_1_1_performtransformation_greenBFFFBF(
		...
		return new Object[] { tFieldSignature, mDefinitionToTMember, tDefinition, mBodyToTAnnotation, mDefinition,
				mDefinitionToTDefinition };
	}
	...
	public static final Object[] pattern_FieldDefinition_1_2_collecttranslatedelements_blackBBBBB(
		...
		return new Object[] { mDefinitionToTMember, tDefinition, mBodyToTAnnotation, mDefinition,
				mDefinitionToTDefinition };
	}
	...
	public static final Object[] pattern_FieldDefinition_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, mDefinitionToTMember, tDefinition, mBodyToTAnnotation, mDefinition,
				mDefinitionToTDefinition };
	}

	public static final Object[] pattern_FieldDefinition_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mSignatureToTFieldSignature, EObject tFieldSignature,
			EObject mDefinitionToTMember, EObject tDefinition, EObject mBodyToTAnnotation, EObject mSignature,
			EObject mDefinition, EObject mDefinitionToTDefinition) {
	...
	public static final Object[] pattern_FieldDefinition_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tFieldSignature, EObject mDefinitionToTMember, EObject tDefinition,
			EObject mBodyToTAnnotation, EObject mSignature, EObject mDefinition, EObject mDefinitionToTDefinition) {
		...
		return new Object[] { ruleresult, tFieldSignature, mDefinitionToTMember, tDefinition, mBodyToTAnnotation,
				mSignature, mDefinition, mDefinitionToTDefinition, mDefinitionToTMember__tDefinition____target,
	...
	public static final void pattern_FieldDefinition_1_5_registerobjects_expressionBBBBBBBBBB(FieldDefinition _this,
			...
			EObject mDefinitionToTMember, EObject tDefinition, EObject mBodyToTAnnotation, EObject mSignature,
			EObject mDefinition, EObject mDefinitionToTDefinition) {
		_this.registerObjects_FWD(ruleresult, mSignatureToTFieldSignature, tFieldSignature, mDefinitionToTMember,
				tDefinition, mBodyToTAnnotation, mSignature, mDefinition, mDefinitionToTDefinition);
	...
	public static final Object[] pattern_FieldDefinition_11_1_performtransformation_greenFBFBFF(
		...
		mDefinitionToTDefinition.setTarget(tDefinition);
		mDefinitionToTDefinition.setSource(mDefinition);
		return new Object[] { mDefinitionToTMember, tDefinition, mBodyToTAnnotation, mSignature, mDefinition,
				mDefinitionToTDefinition };
	}
	...
	public static final void pattern_FieldDefinition_11_5_registerobjects_expressionBBBBBBBBBB(FieldDefinition _this,
			...
			EObject mDefinitionToTMember, EObject tDefinition, EObject mBodyToTAnnotation, EObject mSignature,
			EObject mDefinition, EObject mDefinitionToTDefinition) {
		_this.registerObjects_BWD(ruleresult, mSignatureToTFieldSignature, tFieldSignature, mDefinitionToTMember,
				tDefinition, mBodyToTAnnotation, mSignature, mDefinition, mDefinitionToTDefinition);
	...
	public static final Object[] pattern_FieldDefinition_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TSignature __DEC_tDefinition_signature_508990 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_508990 != null) {
			if (!tFieldSignature.equals(__DEC_tDefinition_signature_508990)) {
	...
	public static final Object[] pattern_FieldDefinition_21_2_testcorematchandDECs_black_nac_0BB(
		...
		MSignature __DEC_mDefinition_mDefinitions_786264 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_786264 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_786264)) {
		...
		if (tmpTFieldSignature instanceof TFieldSignature) {
			...
			if (tmpTDefinition instanceof TFieldDefinition) {
				...
				if (tmpMSignature instanceof MFieldSignature) {
					...
					if (tmpMDefinition instanceof MFieldDefinition) {
						MFieldDefinition mDefinition = (MFieldDefinition) tmpMDefinition;
						return new Object[] { tFieldSignature, tDefinition, mSignature, mDefinition, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_FieldDefinition_24_2_matchsrctrgcontext_blackBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tFieldSignature, tDefinition, mSignature, mDefinition, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDefinition_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_FieldDefinition_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_FieldDefinition_24_2_matchsrctrgcontext_black = pattern_FieldDefinition_24_2_matchsrctrgcontext_blackBBBBBB(
					tFieldSignature, tDefinition, mSignature, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldDefinition_24_3_solvecsp_bindingFBBBBBBB(FieldDefinition _this,
			TFieldSignature tFieldSignature, TFieldDefinition tDefinition, MFieldSignature mSignature,
			MFieldDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tFieldSignature, tDefinition, mSignature, mDefinition,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tFieldSignature, tDefinition, mSignature, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDefinition_24_3_solvecsp_bindingAndBlackFBBBBBBB(FieldDefinition _this,
		...
		Object[] result_pattern_FieldDefinition_24_3_solvecsp_binding = pattern_FieldDefinition_24_3_solvecsp_bindingFBBBBBBB(
				_this, tFieldSignature, tDefinition, mSignature, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldDefinition_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { tFieldSignature, tDefinition, mSignature, mDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_FieldDefinition_27_1_matchtggpattern_black_nac_0BB(
			MFieldDefinition mDefinition, MFieldSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_786086 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_786086 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_786086)) {
				return new Object[] { mDefinition, mSignature };
			}
		}
	...
	public static final Object[] pattern_FieldDefinition_28_1_matchtggpattern_black_nac_0BB(
			TFieldDefinition tDefinition, TFieldSignature tFieldSignature) {
		TSignature __DEC_tDefinition_signature_417259 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_417259 != null) {
			if (!tFieldSignature.equals(__DEC_tDefinition_signature_417259)) {
				return new Object[] { tDefinition, tFieldSignature };
			}
		}
	...
	public static final Object[] pattern_FieldDefinition_29_6_perform_greenBFFFBFFB(TFieldSignature tFieldSignature,
			MFieldSignature mSignature, ModelgeneratorRuleResult ruleResult) {
		MDefinitionToTMember mDefinitionToTMember = PmFactory.eINSTANCE.createMDefinitionToTMember();
		TFieldDefinition tDefinition = BasicFactory.eINSTANCE.createTFieldDefinition();
		ASTNodeToTAnnotatable mBodyToTAnnotation = PmFactory.eINSTANCE.createASTNodeToTAnnotatable();
		...
		return new Object[] { tFieldSignature, mDefinitionToTMember, tDefinition, mBodyToTAnnotation, mSignature,
				mDefinition, mDefinitionToTDefinition, ruleResult };
	}
