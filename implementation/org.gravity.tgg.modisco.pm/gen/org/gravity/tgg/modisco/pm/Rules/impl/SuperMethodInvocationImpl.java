...
public class SuperMethodInvocationImpl extends AbstractRuleImpl implements SuperMethodInvocation {
	...
	public boolean isAppropriate_FWD(Match match, MSuperMethodInvocation invocation, MDefinition mMember,
		...
		Object[] result1_black = SuperMethodInvocationImpl.pattern_SuperMethodInvocation_0_1_initialbindings_blackBBBBB(
		...
		Object[] result2_bindingAndBlack = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_0_2_SolveCSP_bindingAndBlackFBBBBB(this, match, invocation, mMember,
						mMethod);
		...
		if (SuperMethodInvocationImpl.pattern_SuperMethodInvocation_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_0_4_collectelementstobetranslated_blackBBBB(match, invocation,
							mMember, mMethod);
			...
			SuperMethodInvocationImpl.pattern_SuperMethodInvocation_0_4_collectelementstobetranslated_greenBBBBFFF(
			...
			Object[] result5_black = SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_0_5_collectcontextelements_blackBBBB(match, invocation, mMember,
							mMethod);
			...
			SuperMethodInvocationImpl.pattern_SuperMethodInvocation_0_5_collectcontextelements_greenBBB(match, mMember,
					mMethod);

			// 
			SuperMethodInvocationImpl.pattern_SuperMethodInvocation_0_6_registerobjectstomatch_expressionBBBBB(this,
					match, invocation, mMember, mMethod);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_1_1_performtransformation_greenBBFBFF(invocation, tMember, tMethod);
		...
		Object[] result3_black = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, invocation,
		...
		SuperMethodInvocationImpl.pattern_SuperMethodInvocation_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
		...
		// 
		// 
		SuperMethodInvocationImpl.pattern_SuperMethodInvocation_1_5_registerobjects_expressionBBBBBBBBBBBB(this,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result2_binding = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_2_2_corematch_bindingFFFB(match);
		...
		for (Object[] result2_black : SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_2_2_corematch_blackBFFFFBBB(invocation, mMember, mMethod, match)) {
			...
			for (Object[] result3_black : SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_2_3_findcontext_blackBBBBBBB(invocation, mMemberToTMember, tMember,
							mMethodToTMethod, tMethod, mMember, mMethod)) {
				Object[] result3_green = SuperMethodInvocationImpl
						.pattern_SuperMethodInvocation_2_3_findcontext_greenBBBBBBBFFFFFFFF(invocation,
				...
				Object[] result4_bindingAndBlack = SuperMethodInvocationImpl
						.pattern_SuperMethodInvocation_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, MSuperMethodInvocation invocation, MDefinition mMember,
	...
	public boolean isAppropriate_BWD(Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		...
		Object[] result1_black = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_10_1_initialbindings_blackBBBBB(this, match, tMember, tAccess, tMethod);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, tMember, tAccess,
						tMethod);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tMember] = " + tMember + ", " + "[tAccess] = " + tAccess + ", "
		...
		if (SuperMethodInvocationImpl.pattern_SuperMethodInvocation_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_10_4_collectelementstobetranslated_blackBBBB(match, tMember, tAccess,
							tMethod);
			if (result4_black == null) {
				throw new RuntimeException(
			...
			SuperMethodInvocationImpl.pattern_SuperMethodInvocation_10_4_collectelementstobetranslated_greenBBBBFFFF(
			...
			Object[] result5_black = SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_10_5_collectcontextelements_blackBBBB(match, tMember, tAccess,
							tMethod);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[tMember] = "
			...
			SuperMethodInvocationImpl.pattern_SuperMethodInvocation_10_5_collectcontextelements_greenBBB(match, tMember,
					tMethod);

			// 
			SuperMethodInvocationImpl.pattern_SuperMethodInvocation_10_6_registerobjectstomatch_expressionBBBBB(this,
					match, tMember, tAccess, tMethod);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_11_1_performtransformation_greenFBBFFB(tAccess, mMember, mMethod);
		...
		Object[] result3_black = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, invocation,
						mMemberToTMember, tMember, mMethodToTMethod, tAccess, tMethod, mMember,
						mFlowElementToTFlowElement, invocationToTAccess, mMethod);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
		...
		SuperMethodInvocationImpl.pattern_SuperMethodInvocation_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
				ruleresult, invocation, tMember, tAccess, tMethod, mMember, mFlowElementToTFlowElement,
				invocationToTAccess, mMethod);
		//nothing EMoflonEdge invocation__mMethod____method = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge mMethod__invocation____usages = (EMoflonEdge) result3_green[10];
		...
		// 
		// 
		SuperMethodInvocationImpl.pattern_SuperMethodInvocation_11_5_registerobjects_expressionBBBBBBBBBBBB(this,
				ruleresult, invocation, mMemberToTMember, tMember, mMethodToTMethod, tAccess, tMethod, mMember,
				mFlowElementToTFlowElement, invocationToTAccess, mMethod);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_12_2_corematch_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_12_2_corematch_blackFBFBBFFB(tMember, tAccess, tMethod, match)) {
			...
			// ForEach 
			for (Object[] result3_black : SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_12_3_findcontext_blackBBBBBBB(mMemberToTMember, tMember,
							mMethodToTMethod, tAccess, tMethod, mMember, mMethod)) {
				Object[] result3_green = SuperMethodInvocationImpl
						.pattern_SuperMethodInvocation_12_3_findcontext_greenBBBBBBBFFFFFFFFF(mMemberToTMember, tMember,
								mMethodToTMethod, tAccess, tMethod, mMember, mMethod);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = SuperMethodInvocationImpl
						.pattern_SuperMethodInvocation_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_74(EMoflonEdge _edge_tAccessing) {
		...
		// ForEach 
		for (Object[] result2_black : SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_20_2_testcorematchandDECs_blackFFFB(_edge_tAccessing)) {
			...
			if (SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, tMember, tAccess, tMethod)) {
				// 
				if (SuperMethodInvocationImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_77(EMoflonEdge _edge_method) {
		...
		// ForEach 
		for (Object[] result2_black : SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_21_2_testcorematchandDECs_blackFFFB(_edge_method)) {
			...
			// 
			if (SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, invocation, mMember, mMethod)) {
				// 
				if (SuperMethodInvocationImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(sourceMatch,
						targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result3_bindingAndBlack = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, invocation, tMember,
		...
		if (SuperMethodInvocationImpl.pattern_SuperMethodInvocation_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_24_5_matchcorrcontext_blackFBFBBBBB(tMember, tMethod, mMember,
				...
				Object[] result5_green = SuperMethodInvocationImpl
						.pattern_SuperMethodInvocation_24_5_matchcorrcontext_greenBBBBF(mMemberToTMember,
								mMethodToTMethod, sourceMatch, targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[4];

				Object[] result6_black = SuperMethodInvocationImpl
						.pattern_SuperMethodInvocation_24_6_createcorrespondence_blackBBBBBBB(invocation, tMember,
	...
	public boolean checkDEC_FWD(MSuperMethodInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {// 
		Object[] result1_black = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_27_1_matchtggpattern_blackBBB(invocation, mMember, mMethod);
		if (result1_black != null) {
	...
	public boolean checkDEC_BWD(TMember tMember, TCall tAccess, TMember tMethod) {// 
		Object[] result1_black = SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_28_1_matchtggpattern_blackBBB(tMember, tAccess, tMethod);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		// ForEach 
		for (Object[] result2_black : SuperMethodInvocationImpl
				.pattern_SuperMethodInvocation_29_2_isapplicablecore_blackFFFFFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			Object[] result3_bindingAndBlack = SuperMethodInvocationImpl
					.pattern_SuperMethodInvocation_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
			...
			if (SuperMethodInvocationImpl.pattern_SuperMethodInvocation_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = SuperMethodInvocationImpl
						.pattern_SuperMethodInvocation_29_5_checknacs_blackBBBBBB(mMemberToTMember, tMember,
								mMethodToTMethod, tMethod, mMember, mMethod);
				if (result5_black != null) {

					Object[] result6_black = SuperMethodInvocationImpl
							.pattern_SuperMethodInvocation_29_6_perform_blackBBBBBBB(mMemberToTMember, tMember,
					...
					SuperMethodInvocationImpl.pattern_SuperMethodInvocation_29_6_perform_greenFBFBBFFBB(tMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.SUPER_METHOD_INVOCATION___IS_APPROPRIATE_FWD__MATCH_MSUPERMETHODINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MSUPERMETHODINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (MSuperMethodInvocation) arguments.get(1),
					(MDefinition) arguments.get(2), (AbstractMethodDeclaration) arguments.get(3));
			return null;
		case RulesPackage.SUPER_METHOD_INVOCATION___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MSUPERMETHODINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MSUPERMETHODINVOCATION_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___IS_APPROPRIATE_BWD__MATCH_TMEMBER_TCALL_TMEMBER:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TMEMBER_TCALL_TMEMBER:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TMember) arguments.get(1), (TCall) arguments.get(2),
					(TMember) arguments.get(3));
			return null;
		case RulesPackage.SUPER_METHOD_INVOCATION___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TMEMBER_TCALL_TMEMBER:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITIONTOTMEMBER_TCALL_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_74__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_74((EMoflonEdge) arguments.get(0));
		case RulesPackage.SUPER_METHOD_INVOCATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_77__EMOFLONEDGE:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___IS_APPLICABLE_SOLVE_CSP_CC__MSUPERMETHODINVOCATION_TMEMBER_TCALL_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___CHECK_DEC_FWD__MSUPERMETHODINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.SUPER_METHOD_INVOCATION___CHECK_DEC_BWD__TMEMBER_TCALL_TMEMBER:
			return checkDEC_BWD((TMember) arguments.get(0), (TCall) arguments.get(1), (TMember) arguments.get(2));
		case RulesPackage.SUPER_METHOD_INVOCATION___GENERATE_MODEL__RULEENTRYCONTAINER_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER:
			return generateModel((RuleEntryContainer) arguments.get(0), (MDefinitionToTMember) arguments.get(1),
					(MDefinitionToTMember) arguments.get(2));
		case RulesPackage.SUPER_METHOD_INVOCATION___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_SuperMethodInvocation_0_1_initialbindings_blackBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_0_2_SolveCSP_bindingFBBBBB(SuperMethodInvocation _this,
			Match match, MSuperMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_0_2_SolveCSP_bindingAndBlackFBBBBB(
			SuperMethodInvocation _this, Match match, MSuperMethodInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		Object[] result_pattern_SuperMethodInvocation_0_2_SolveCSP_binding = pattern_SuperMethodInvocation_0_2_SolveCSP_bindingFBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_0_4_collectelementstobetranslated_blackBBBB(Match match,
			MSuperMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		return new Object[] { match, invocation, mMember, mMethod };
	}

	public static final Object[] pattern_SuperMethodInvocation_0_4_collectelementstobetranslated_greenBBBBFFF(
			Match match, MSuperMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_0_5_collectcontextelements_blackBBBB(Match match,
			MSuperMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		return new Object[] { match, invocation, mMember, mMethod };
	}

	public static final Object[] pattern_SuperMethodInvocation_0_5_collectcontextelements_greenBBB(Match match,
	...
	public static final void pattern_SuperMethodInvocation_0_6_registerobjectstomatch_expressionBBBBB(
			SuperMethodInvocation _this, Match match, MSuperMethodInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_1_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_SuperMethodInvocation_1_1_performtransformation_blackBBBBBBBFBB(
			...
			AbstractMethodDeclaration mMethod, SuperMethodInvocation _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_SuperMethodInvocation_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			SuperMethodInvocation _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_SuperMethodInvocation_1_1_performtransformation_binding = pattern_SuperMethodInvocation_1_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_SuperMethodInvocation_1_1_performtransformation_binding != null) {
			...
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_SuperMethodInvocation_1_1_performtransformation_binding[3];
			TMember tMethod = (TMember) result_pattern_SuperMethodInvocation_1_1_performtransformation_binding[4];
			MDefinition mMember = (MDefinition) result_pattern_SuperMethodInvocation_1_1_performtransformation_binding[5];
			AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) result_pattern_SuperMethodInvocation_1_1_performtransformation_binding[6];

			Object[] result_pattern_SuperMethodInvocation_1_1_performtransformation_black = pattern_SuperMethodInvocation_1_1_performtransformation_blackBBBBBBBFBB(
			...
			if (result_pattern_SuperMethodInvocation_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_SuperMethodInvocation_1_1_performtransformation_black[7];
	...
	public static final Object[] pattern_SuperMethodInvocation_1_1_performtransformation_greenBBFBFF(
			MSuperMethodInvocation invocation, TMember tMember, TMember tMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
	...
	public static final void pattern_SuperMethodInvocation_1_5_registerobjects_expressionBBBBBBBBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_2_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_SuperMethodInvocation_2_2_corematch_blackBFFFFBBB(
			MSuperMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod, Match match) {
	...
	public static final Iterable<Object[]> pattern_SuperMethodInvocation_2_3_findcontext_blackBBBBBBB(
			MSuperMethodInvocation invocation, MDefinitionToTMember mMemberToTMember, TMember tMember,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_SuperMethodInvocation_2_3_findcontext_greenBBBBBBBFFFFFFFF(
			MSuperMethodInvocation invocation, MDefinitionToTMember mMemberToTMember, TMember tMember,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_2_4_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			SuperMethodInvocation _this, IsApplicableMatch isApplicableMatch, MSuperMethodInvocation invocation,
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		Object[] result_pattern_SuperMethodInvocation_2_4_solveCSP_binding = pattern_SuperMethodInvocation_2_4_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_10_1_initialbindings_blackBBBBB(
			SuperMethodInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		if (!tMember.equals(tMethod)) {
	...
	public static final Object[] pattern_SuperMethodInvocation_10_2_SolveCSP_bindingFBBBBB(SuperMethodInvocation _this,
	...
	public static final Object[] pattern_SuperMethodInvocation_10_2_SolveCSP_bindingAndBlackFBBBBB(
			SuperMethodInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		Object[] result_pattern_SuperMethodInvocation_10_2_SolveCSP_binding = pattern_SuperMethodInvocation_10_2_SolveCSP_bindingFBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_10_4_collectelementstobetranslated_blackBBBB(Match match,
	...
	public static final Object[] pattern_SuperMethodInvocation_10_4_collectelementstobetranslated_greenBBBBFFFF(
			Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		EMoflonEdge tMember__tAccess____tAccessing = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAccess__tMember____tSource = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAccess__tMethod____tTarget = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_SuperMethodInvocation_10_5_collectcontextelements_blackBBBB(Match match,
			TMember tMember, TCall tAccess, TMember tMethod) {
		if (!tMember.equals(tMethod)) {
			return new Object[] { match, tMember, tAccess, tMethod };
		}
	...
	public static final Object[] pattern_SuperMethodInvocation_10_5_collectcontextelements_greenBBB(Match match,
	...
	public static final void pattern_SuperMethodInvocation_10_6_registerobjectstomatch_expressionBBBBB(
			SuperMethodInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_11_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_SuperMethodInvocation_11_1_performtransformation_blackBBBBBBBFBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
	...
	public static final Object[] pattern_SuperMethodInvocation_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			SuperMethodInvocation _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_SuperMethodInvocation_11_1_performtransformation_binding = pattern_SuperMethodInvocation_11_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_SuperMethodInvocation_11_1_performtransformation_binding != null) {
			...
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_SuperMethodInvocation_11_1_performtransformation_binding[2];
			TCall tAccess = (TCall) result_pattern_SuperMethodInvocation_11_1_performtransformation_binding[3];
			TMember tMethod = (TMember) result_pattern_SuperMethodInvocation_11_1_performtransformation_binding[4];
			MDefinition mMember = (MDefinition) result_pattern_SuperMethodInvocation_11_1_performtransformation_binding[5];
			AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) result_pattern_SuperMethodInvocation_11_1_performtransformation_binding[6];

			Object[] result_pattern_SuperMethodInvocation_11_1_performtransformation_black = pattern_SuperMethodInvocation_11_1_performtransformation_blackBBBBBBBFBB(
			...
			if (result_pattern_SuperMethodInvocation_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_SuperMethodInvocation_11_1_performtransformation_black[7];
	...
	public static final Object[] pattern_SuperMethodInvocation_11_1_performtransformation_greenFBBFFB(TCall tAccess,
			MDefinition mMember, AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_11_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject invocation, EObject mMemberToTMember, EObject tMember,
			EObject mMethodToTMethod, EObject tAccess, EObject tMethod, EObject mMember,
			EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
		if (!invocation.equals(mMemberToTMember)) {
	...
	public static final Object[] pattern_SuperMethodInvocation_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject invocation, EObject tMember, EObject tAccess, EObject tMethod,
			EObject mMember, EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
		EMoflonEdge invocation__mMethod____method = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mMethod__invocation____usages = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_SuperMethodInvocation_11_5_registerobjects_expressionBBBBBBBBBBBB(
			SuperMethodInvocation _this, PerformRuleResult ruleresult, EObject invocation, EObject mMemberToTMember,
			EObject tMember, EObject mMethodToTMethod, EObject tAccess, EObject tMethod, EObject mMember,
			EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_12_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_SuperMethodInvocation_12_2_corematch_blackFBFBBFFB(TMember tMember,
	...
	public static final Iterable<Object[]> pattern_SuperMethodInvocation_12_3_findcontext_blackBBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
			TCall tAccess, TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mMemberToTMember.equals(mMethodToTMethod)) {
	...
	public static final Object[] pattern_SuperMethodInvocation_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
			TCall tAccess, TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge mMethodToTMethod__tMethod____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_SuperMethodInvocation_12_4_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			SuperMethodInvocation _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			TMember tMember, MDefinitionToTMember mMethodToTMethod, TCall tAccess, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		Object[] result_pattern_SuperMethodInvocation_12_4_solveCSP_binding = pattern_SuperMethodInvocation_12_4_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Iterable<Object[]> pattern_SuperMethodInvocation_20_2_testcorematchandDECs_blackFFFB(
	...
	public static final boolean pattern_SuperMethodInvocation_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			SuperMethodInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_21_2_testcorematchandDECs_black_nac_0B(
		...
		for (AnnotationMemberValuePair __DEC_invocation_value_918819 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_SuperMethodInvocation_21_2_testcorematchandDECs_black_nac_1BB(
		...
		for (MDefinition __DEC_invocation_mMethodInvocations_323621 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_323621)) {
	...
	public static final Iterable<Object[]> pattern_SuperMethodInvocation_21_2_testcorematchandDECs_blackFFFB(
	...
	public static final boolean pattern_SuperMethodInvocation_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			SuperMethodInvocation _this, Match match, MSuperMethodInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_bindingFFFFFFBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MSuperMethodInvocation invocation, TMember tMember, TCall tAccess, TMember tMethod, MDefinition mMember,
	...
	public static final Object[] pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_binding = pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_bindingFFFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_binding != null) {
			...
			TMember tMethod = (TMember) result_pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_binding[3];
			MDefinition mMember = (MDefinition) result_pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_binding[4];
			AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) result_pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_binding[5];

			Object[] result_pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_black = pattern_SuperMethodInvocation_24_2_matchsrctrgcontext_blackBBBBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_24_3_solvecsp_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			SuperMethodInvocation _this, MSuperMethodInvocation invocation, TMember tMember, TCall tAccess,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_SuperMethodInvocation_24_3_solvecsp_binding = pattern_SuperMethodInvocation_24_3_solvecsp_bindingFBBBBBBBBB(
	...
	public static final Iterable<Object[]> pattern_SuperMethodInvocation_24_5_matchcorrcontext_blackFBFBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_24_5_matchcorrcontext_greenBBBBF(
	...
	public static final Object[] pattern_SuperMethodInvocation_24_6_createcorrespondence_blackBBBBBBB(
			MSuperMethodInvocation invocation, TMember tMember, TCall tAccess, TMember tMethod, MDefinition mMember,
	...
	public static final Object[] pattern_SuperMethodInvocation_27_1_matchtggpattern_black_nac_0B(
			MSuperMethodInvocation invocation) {
		for (AnnotationMemberValuePair __DEC_invocation_value_331503 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { invocation };
		}
		return null;
	...
	public static final Object[] pattern_SuperMethodInvocation_27_1_matchtggpattern_black_nac_1BB(
			MSuperMethodInvocation invocation, MDefinition mMember) {
		for (MDefinition __DEC_invocation_mMethodInvocations_788384 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_788384)) {
				return new Object[] { invocation, mMember };
			}
		}
		return null;
	...
	public static final Object[] pattern_SuperMethodInvocation_27_1_matchtggpattern_blackBBB(
			MSuperMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		if (mMethod.equals(invocation.getMethod())) {
			if (mMember.getMMethodInvocations().contains(invocation)) {
	...
	public static final Object[] pattern_SuperMethodInvocation_28_1_matchtggpattern_blackBBB(TMember tMember,
	...
	public static final Object[] pattern_SuperMethodInvocation_29_2_isapplicablecore_black_nac_3BB(
	...
	public static final Object[] pattern_SuperMethodInvocation_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_SuperMethodInvocation_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Iterable<Object[]> pattern_SuperMethodInvocation_29_2_isapplicablecore_blackFFFFFFFFBB(
							...
							if (tMember != null) {
								...
								if (tmpMMember instanceof MDefinition) {
									...
									if (pattern_SuperMethodInvocation_29_2_isapplicablecore_black_nac_0BB(ruleResult,
										...
										if (pattern_SuperMethodInvocation_29_2_isapplicablecore_black_nac_1BB(
												ruleResult, tMember) == null) {
											if (pattern_SuperMethodInvocation_29_2_isapplicablecore_black_nac_2BB(
													...
													if (tmpMMethodToTMethod instanceof MDefinitionToTMember) {
														...
														if (!mMemberToTMember.equals(mMethodToTMethod)) {
															...
															if (tmpMMethod instanceof AbstractMethodDeclaration) {
																...
																if (tMethod != null) {
																	if (!tMember.equals(tMethod)) {
																		if (pattern_SuperMethodInvocation_29_2_isapplicablecore_black_nac_3BB(
																				ruleResult, mMethodToTMethod) == null) {
																			if (pattern_SuperMethodInvocation_29_2_isapplicablecore_black_nac_4BB(
																					ruleResult, mMethod) == null) {
																				if (pattern_SuperMethodInvocation_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Object[] pattern_SuperMethodInvocation_29_3_solveCSP_bindingFBBBBBBBBB(
			SuperMethodInvocation _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			TMember tMember, MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
	...
	public static final Object[] pattern_SuperMethodInvocation_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			SuperMethodInvocation _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			TMember tMember, MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_SuperMethodInvocation_29_3_solveCSP_binding = pattern_SuperMethodInvocation_29_3_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_SuperMethodInvocation_29_5_checknacs_blackBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		if (!mMemberToTMember.equals(mMethodToTMethod)) {
			if (!tMember.equals(tMethod)) {
	...
	public static final Object[] pattern_SuperMethodInvocation_29_6_perform_blackBBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod,
	...
	public static final Object[] pattern_SuperMethodInvocation_29_6_perform_greenFBFBBFFBB(TMember tMember,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod,
			ModelgeneratorRuleResult ruleResult) {
		MSuperMethodInvocation invocation = ModiscoFactory.eINSTANCE.createMSuperMethodInvocation();
		TCall tAccess = BasicFactory.eINSTANCE.createTCall();
