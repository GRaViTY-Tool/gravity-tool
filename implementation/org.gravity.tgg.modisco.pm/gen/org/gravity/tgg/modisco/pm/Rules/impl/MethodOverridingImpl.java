...
public class MethodOverridingImpl extends AbstractRuleImpl implements MethodOverriding {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		MDefinitionToTMember mOverridingToTOverriding = (MDefinitionToTMember) result1_bindingAndBlack[5];
		...
		Object[] result3_black = MethodOverridingImpl.pattern_MethodOverriding_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod, mOverridingToTOverriding);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tMethod] = " + tMethod + ", " + "[mOverriding] = " + mOverriding + ", " + "[mMethod] = "
					+ mMethod + ", " + "[tOverriding] = " + tOverriding + ", " + "[mMethodToTMethod] = "
		...
		MethodOverridingImpl.pattern_MethodOverriding_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, tMethod,
				mOverriding, mMethod, tOverriding);
		...
		MethodOverridingImpl.pattern_MethodOverriding_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tMethod,
				mOverriding, mMethod, tOverriding, mMethodToTMethod, mOverridingToTOverriding);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodOverridingImpl
				.pattern_MethodOverriding_2_2_corematch_blackFBBFFFB(mOverriding, mMethod, match)) {
			...
			for (Object[] result3_black : MethodOverridingImpl.pattern_MethodOverriding_2_3_findcontext_blackBBBBBB(
					tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod, mOverridingToTOverriding)) {
				Object[] result3_green = MethodOverridingImpl
						.pattern_MethodOverriding_2_3_findcontext_greenBBBBBBFFFFFFF(tMethod, mOverriding, mMethod,
								tOverriding, mMethodToTMethod, mOverridingToTOverriding);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMethodDefinition tMethod,
			MMethodDefinition mOverriding, MMethodDefinition mMethod, TMethodDefinition tOverriding,
			MDefinitionToTMember mMethodToTMethod, MDefinitionToTMember mOverridingToTOverriding) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tMethod, EObject mOverriding, EObject mMethod,
			EObject tOverriding, EObject mMethodToTMethod, EObject mOverridingToTOverriding) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodOverridingImpl.pattern_MethodOverriding_12_2_corematch_blackBFFBFFB(tMethod,
				tOverriding, match)) {
			...
			for (Object[] result3_black : MethodOverridingImpl.pattern_MethodOverriding_12_3_findcontext_blackBBBBBB(
					tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod, mOverridingToTOverriding)) {
				Object[] result3_green = MethodOverridingImpl
						.pattern_MethodOverriding_12_3_findcontext_greenBBBBBBFFFFFFF(tMethod, mOverriding, mMethod,
								tOverriding, mMethodToTMethod, mOverridingToTOverriding);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tMethod, EObject mOverriding, EObject mMethod,
			EObject tOverriding, EObject mMethodToTMethod, EObject mOverridingToTOverriding) {
		ruleresult.registerObject("tMethod", tMethod);
		ruleresult.registerObject("mOverriding", mOverriding);
		ruleresult.registerObject("mMethod", mMethod);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_75(EMoflonEdge _edge_overriddenBy) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_80(EMoflonEdge _edge_redefinitions) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodOverridingImpl
				.pattern_MethodOverriding_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tMethod, mOverriding, mMethod,
						tOverriding, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tMethod] = " + tMethod + ", " + "[mOverriding] = " + mOverriding + ", " + "[mMethod] = "
					+ mMethod + ", " + "[tOverriding] = " + tOverriding + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (MethodOverridingImpl.pattern_MethodOverriding_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodOverridingImpl
					.pattern_MethodOverriding_24_5_matchcorrcontext_blackBBBBFFBB(tMethod, mOverriding, mMethod,
							tOverriding, sourceMatch, targetMatch)) {
				MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result5_black[4];
				MDefinitionToTMember mOverridingToTOverriding = (MDefinitionToTMember) result5_black[5];
				...
				Object[] result6_black = MethodOverridingImpl
						.pattern_MethodOverriding_24_6_createcorrespondence_blackBBBBB(tMethod, mOverriding, mMethod,
								tOverriding, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMethodDefinition tMethod, MMethodDefinition mOverriding,
			MMethodDefinition mMethod, TMethodDefinition tOverriding, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : MethodOverridingImpl
			...
			Object[] result3_bindingAndBlack = MethodOverridingImpl
					.pattern_MethodOverriding_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, tMethod,
							mOverriding, mMethod, tOverriding, mMethodToTMethod, mOverridingToTOverriding, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMethod] = " + tMethod + ", "
						+ "[mOverriding] = " + mOverriding + ", " + "[mMethod] = " + mMethod + ", " + "[tOverriding] = "
						+ tOverriding + ", " + "[mMethodToTMethod] = " + mMethodToTMethod + ", "
						+ "[mOverridingToTOverriding] = " + mOverridingToTOverriding + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethod] = "
								+ tMethod + ", " + "[mOverriding] = " + mOverriding + ", " + "[mMethod] = " + mMethod
								+ ", " + "[tOverriding] = " + tOverriding + ", " + "[mMethodToTMethod] = "
								+ mMethodToTMethod + ", " + "[mOverridingToTOverriding] = " + mOverridingToTOverriding
								+ ", " + "[ruleResult] = " + ruleResult + ".");
					}
					MethodOverridingImpl.pattern_MethodOverriding_29_6_perform_greenBBBBB(tMethod, mOverriding, mMethod,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.METHOD_OVERRIDING___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_MMETHODDEFINITION_MMETHODDEFINITION_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						...
						(MDefinitionToTMember) arguments.get(5), (MDefinitionToTMember) arguments.get(6));
			...
			case RulesPackage.METHOD_OVERRIDING___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_MMETHODDEFINITION_MMETHODDEFINITION_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER:
			...
			case RulesPackage.METHOD_OVERRIDING___IS_APPROPRIATE_BWD_EMOFLON_EDGE_75__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_75((EMoflonEdge) arguments.get(0));
			case RulesPackage.METHOD_OVERRIDING___IS_APPROPRIATE_FWD_EMOFLON_EDGE_80__EMOFLONEDGE:
			...
			case RulesPackage.METHOD_OVERRIDING___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_MMETHODDEFINITION_MMETHODDEFINITION_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodOverriding_1_1_performtransformation_bindingFFFFFFB(
		...
		EObject _localVariable_5 = isApplicableMatch.getObject("mOverridingToTOverriding");
		...
		EObject tmpMOverridingToTOverriding = _localVariable_5;
					...
					if (tmpTOverriding instanceof TMethodDefinition) {
						...
						if (tmpMMethodToTMethod instanceof MDefinitionToTMember) {
							...
							if (tmpMOverridingToTOverriding instanceof MDefinitionToTMember) {
								...
								return new Object[] { tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod,
										mOverridingToTOverriding, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodOverriding_1_1_performtransformation_blackBBBBBBFBB(
			TMethodDefinition tMethod, MMethodDefinition mOverriding, MMethodDefinition mMethod,
			TMethodDefinition tOverriding, MDefinitionToTMember mMethodToTMethod,
			MDefinitionToTMember mOverridingToTOverriding, MethodOverriding _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!mMethodToTMethod.equals(mOverridingToTOverriding)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod,
									mOverridingToTOverriding, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodOverriding_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodOverriding_1_1_performtransformation_binding != null) {
			...
			MDefinitionToTMember mOverridingToTOverriding = (MDefinitionToTMember) result_pattern_MethodOverriding_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_MethodOverriding_1_1_performtransformation_black = pattern_MethodOverriding_1_1_performtransformation_blackBBBBBBFBB(
					tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod, mOverridingToTOverriding, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodOverriding_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tMethod, EObject mOverriding, EObject mMethod, EObject tOverriding,
			EObject mMethodToTMethod, EObject mOverridingToTOverriding) {
		if (!tMethod.equals(tOverriding)) {
	...
	public static final Object[] pattern_MethodOverriding_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		mOverriding__mMethod____redefinedMethodDeclaration
				.setName(mOverriding__mMethod____redefinedMethodDeclaration_name_prime);
		return new Object[] { ruleresult, tMethod, mOverriding, mMethod, tOverriding,
	...
	public static final void pattern_MethodOverriding_1_5_registerobjects_expressionBBBBBBBB(MethodOverriding _this,
			PerformRuleResult ruleresult, EObject tMethod, EObject mOverriding, EObject mMethod, EObject tOverriding,
			EObject mMethodToTMethod, EObject mOverridingToTOverriding) {
		_this.registerObjects_FWD(ruleresult, tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod,
				mOverridingToTOverriding);
	...
	public static final Iterable<Object[]> pattern_MethodOverriding_2_2_corematch_blackFBBFFFB(
					...
					for (MDefinitionToTMember mOverridingToTOverriding : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mMethodToTMethod.equals(mOverridingToTOverriding)) {
							...
							if (tmpTOverriding instanceof TMethodDefinition) {
								TMethodDefinition tOverriding = (TMethodDefinition) tmpTOverriding;
								if (!tMethod.equals(tOverriding)) {
									_result.add(new Object[] { tMethod, mOverriding, mMethod, tOverriding,
											mMethodToTMethod, mOverridingToTOverriding, match });
								}
							}
	...
	public static final Iterable<Object[]> pattern_MethodOverriding_2_3_findcontext_blackBBBBBB(
			TMethodDefinition tMethod, MMethodDefinition mOverriding, MMethodDefinition mMethod,
			TMethodDefinition tOverriding, MDefinitionToTMember mMethodToTMethod,
			MDefinitionToTMember mOverridingToTOverriding) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tMethod.equals(tOverriding)) {
			if (!mMethod.equals(mOverriding)) {
				if (!mMethodToTMethod.equals(mOverridingToTOverriding)) {
	...
	public static final Object[] pattern_MethodOverriding_2_3_findcontext_greenBBBBBBFFFFFFF(TMethodDefinition tMethod,
		...
		return new Object[] { tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod, mOverridingToTOverriding,
	...
	public static final Object[] pattern_MethodOverriding_2_4_solveCSP_bindingFBBBBBBBB(MethodOverriding _this,
			IsApplicableMatch isApplicableMatch, TMethodDefinition tMethod, MMethodDefinition mOverriding,
			MMethodDefinition mMethod, TMethodDefinition tOverriding, MDefinitionToTMember mMethodToTMethod,
			MDefinitionToTMember mOverridingToTOverriding) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tMethod, mOverriding, mMethod,
				tOverriding, mMethodToTMethod, mOverridingToTOverriding);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethod, mOverriding, mMethod, tOverriding,
					mMethodToTMethod, mOverridingToTOverriding };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodOverriding_2_4_solveCSP_bindingAndBlackFBBBBBBBB(MethodOverriding _this,
		...
		Object[] result_pattern_MethodOverriding_2_4_solveCSP_binding = pattern_MethodOverriding_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod,
				mOverridingToTOverriding);
	...
	public static final Object[] pattern_MethodOverriding_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodOverriding_11_1_performtransformation_binding != null) {
			...
			MDefinitionToTMember mOverridingToTOverriding = (MDefinitionToTMember) result_pattern_MethodOverriding_11_1_performtransformation_binding[5];
	...
	public static final void pattern_MethodOverriding_11_5_registerobjects_expressionBBBBBBBB(MethodOverriding _this,
			PerformRuleResult ruleresult, EObject tMethod, EObject mOverriding, EObject mMethod, EObject tOverriding,
			EObject mMethodToTMethod, EObject mOverridingToTOverriding) {
		_this.registerObjects_BWD(ruleresult, tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod,
				mOverridingToTOverriding);
	...
	public static final Iterable<Object[]> pattern_MethodOverriding_12_2_corematch_blackBFFBFFB(
	...
	public static final Object[] pattern_MethodOverriding_12_3_findcontext_greenBBBBBBFFFFFFF(TMethodDefinition tMethod,
		...
		return new Object[] { tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod, mOverridingToTOverriding,
				...
				mMethodToTMethod__mMethod____source, mMethodToTMethod__tMethod____target,
				mOverridingToTOverriding__mOverriding____source, mOverridingToTOverriding__tOverriding____target };
	}
	...
	public static final Object[] pattern_MethodOverriding_12_4_solveCSP_bindingFBBBBBBBB(MethodOverriding _this,
			...
			MMethodDefinition mMethod, TMethodDefinition tOverriding, MDefinitionToTMember mMethodToTMethod,
			MDefinitionToTMember mOverridingToTOverriding) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tMethod, mOverriding, mMethod,
				tOverriding, mMethodToTMethod, mOverridingToTOverriding);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethod, mOverriding, mMethod, tOverriding,
		...
		if (tmpTMethod instanceof TMethodDefinition) {
			...
			if (tmpMOverriding instanceof MMethodDefinition) {
				...
				if (tmpMMethod instanceof MMethodDefinition) {
					...
					if (tmpTOverriding instanceof TMethodDefinition) {
						TMethodDefinition tOverriding = (TMethodDefinition) tmpTOverriding;
						return new Object[] { tMethod, mOverriding, mMethod, tOverriding, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodOverriding_24_2_matchsrctrgcontext_blackBBBBBB(TMethodDefinition tMethod,
			MMethodDefinition mOverriding, MMethodDefinition mMethod, TMethodDefinition tOverriding, Match sourceMatch,
			Match targetMatch) {
		if (!tMethod.equals(tOverriding)) {
			if (!mMethod.equals(mOverriding)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tMethod, mOverriding, mMethod, tOverriding, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodOverriding_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodOverriding_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodOverriding_24_2_matchsrctrgcontext_black = pattern_MethodOverriding_24_2_matchsrctrgcontext_blackBBBBBB(
					tMethod, mOverriding, mMethod, tOverriding, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodOverriding_24_3_solvecsp_bindingFBBBBBBB(MethodOverriding _this,
		...
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tMethod, mOverriding, mMethod, tOverriding, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tMethod, mOverriding, mMethod, tOverriding, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodOverriding_24_3_solvecsp_bindingAndBlackFBBBBBBB(MethodOverriding _this,
		...
		Object[] result_pattern_MethodOverriding_24_3_solvecsp_binding = pattern_MethodOverriding_24_3_solvecsp_bindingFBBBBBBB(
				_this, tMethod, mOverriding, mMethod, tOverriding, sourceMatch, targetMatch);
		if (result_pattern_MethodOverriding_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MethodOverriding_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tMethod, mOverriding, mMethod, tOverriding, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MethodOverriding_24_5_matchcorrcontext_blackBBBBFFBB(
			TMethodDefinition tMethod, MMethodDefinition mOverriding, MMethodDefinition mMethod,
			TMethodDefinition tOverriding, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tMethod.equals(tOverriding)) {
	...
	public static final Object[] pattern_MethodOverriding_24_6_createcorrespondence_blackBBBBB(
		...
		if (!tMethod.equals(tOverriding)) {
			if (!mMethod.equals(mOverriding)) {
				return new Object[] { tMethod, mOverriding, mMethod, tOverriding, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodOverriding_29_3_solveCSP_bindingFBBBBBBBBB(MethodOverriding _this,
			IsApplicableMatch isApplicableMatch, TMethodDefinition tMethod, MMethodDefinition mOverriding,
			MMethodDefinition mMethod, TMethodDefinition tOverriding, MDefinitionToTMember mMethodToTMethod,
			MDefinitionToTMember mOverridingToTOverriding, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tMethod, mOverriding, mMethod,
				tOverriding, mMethodToTMethod, mOverridingToTOverriding, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethod, mOverriding, mMethod, tOverriding,
					mMethodToTMethod, mOverridingToTOverriding, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodOverriding_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MethodOverriding_29_3_solveCSP_binding = pattern_MethodOverriding_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMethod, mOverriding, mMethod, tOverriding, mMethodToTMethod,
				mOverridingToTOverriding, ruleResult);
	...
	public static final Object[] pattern_MethodOverriding_29_6_perform_greenBBBBB(TMethodDefinition tMethod,
		...
		return new Object[] { tMethod, mOverriding, mMethod, tOverriding, ruleResult };
	}
