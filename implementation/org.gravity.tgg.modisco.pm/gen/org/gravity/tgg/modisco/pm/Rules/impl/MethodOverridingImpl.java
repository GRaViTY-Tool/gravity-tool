...
public class MethodOverridingImpl extends AbstractRuleImpl implements MethodOverriding {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodOverridingImpl.pattern_MethodOverriding_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding, mOverriding, tMethod);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tOverriding] = " + tOverriding + ", " + "[mMethodToTMethod] = " + mMethodToTMethod + ", "
		...
		MethodOverridingImpl.pattern_MethodOverriding_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding, mOverriding, tMethod);
		...
		for (Object[] result2_black : MethodOverridingImpl.pattern_MethodOverriding_2_2_corematch_blackFFBFBFB(mMethod,
			...
			for (Object[] result3_black : MethodOverridingImpl.pattern_MethodOverriding_2_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = MethodOverridingImpl
						.pattern_MethodOverriding_2_3_findcontext_greenBBBBBBFFFFFFF(tOverriding, mMethodToTMethod,
								mMethod, mOverridingToTOverriding, mOverriding, tMethod);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge mMethodToTMethod__mMethod____source = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge mMethod__mOverriding____redefinitions = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mOverriding__mMethod____redefinedMethodDeclaration = (EMoflonEdge) result3_green[9];
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMethodDefinition tOverriding,
			MDefinitionToTMember mMethodToTMethod, MMethodDefinition mMethod,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tOverriding, EObject mMethodToTMethod,
			EObject mMethod, EObject mOverridingToTOverriding, EObject mOverriding, EObject tMethod) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodOverridingImpl
			...
			for (Object[] result3_black : MethodOverridingImpl.pattern_MethodOverriding_12_3_findcontext_blackBBBBBB(
					tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding, mOverriding, tMethod)) {
				Object[] result3_green = MethodOverridingImpl
						.pattern_MethodOverriding_12_3_findcontext_greenBBBBBBFFFFFFF(tOverriding, mMethodToTMethod,
								mMethod, mOverridingToTOverriding, mOverriding, tMethod);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge mMethodToTMethod__mMethod____source = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge mOverridingToTOverriding__tOverriding____target = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMethod__tOverriding____overriddenBy = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge tOverriding__tMethod____overriding = (EMoflonEdge) result3_green[10];
				//nothing EMoflonEdge mMethodToTMethod__tMethod____target = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge mOverridingToTOverriding__mOverriding____source = (EMoflonEdge) result3_green[12];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tOverriding, EObject mMethodToTMethod,
			EObject mMethod, EObject mOverridingToTOverriding, EObject mOverriding, EObject tMethod) {
		ruleresult.registerObject("tOverriding", tOverriding);
		ruleresult.registerObject("mMethodToTMethod", mMethodToTMethod);
		ruleresult.registerObject("mMethod", mMethod);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_756(EMoflonEdge _edge_overriddenBy) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_777(EMoflonEdge _edge_redefinitions) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodOverridingImpl.pattern_MethodOverriding_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodOverridingImpl
					.pattern_MethodOverriding_24_5_matchcorrcontext_blackBFBFBBBB(tOverriding, mMethod, mOverriding,
							tMethod, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : MethodOverridingImpl
			...
			if (MethodOverridingImpl.pattern_MethodOverriding_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tOverriding] = "
								+ tOverriding + ", " + "[mMethodToTMethod] = " + mMethodToTMethod + ", "
								+ "[mMethod] = " + mMethod + ", " + "[mOverridingToTOverriding] = "
								+ mOverridingToTOverriding + ", " + "[mOverriding] = " + mOverriding + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_OVERRIDING___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_TMETHODDEFINITION:
		...
		case RulesPackage.METHOD_OVERRIDING___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_TMETHODDEFINITION:
		...
		case RulesPackage.METHOD_OVERRIDING___IS_APPROPRIATE_BWD_EMOFLON_EDGE_756__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_756((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_OVERRIDING___IS_APPROPRIATE_FWD_EMOFLON_EDGE_777__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_777((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.METHOD_OVERRIDING___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_TMETHODDEFINITION_MODELGENERATORRULERESULT:
					...
					if (tmpMOverridingToTOverriding instanceof MDefinitionToTMember) {
						...
						if (tmpMOverriding instanceof MMethodDefinition) {
							...
							if (tmpTMethod instanceof TMethodDefinition) {
								...
								return new Object[] { tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding,
	...
	public static final Object[] pattern_MethodOverriding_1_1_performtransformation_blackBBBBBBFBB(
			TMethodDefinition tOverriding, MDefinitionToTMember mMethodToTMethod, MMethodDefinition mMethod,
			MDefinitionToTMember mOverridingToTOverriding, MMethodDefinition mOverriding, TMethodDefinition tMethod,
	...
	public static final Object[] pattern_MethodOverriding_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodOverriding_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodOverriding_1_1_performtransformation_black = pattern_MethodOverriding_1_1_performtransformation_blackBBBBBBFBB(
					tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding, mOverriding, tMethod, _this,
					isApplicableMatch);
			if (result_pattern_MethodOverriding_1_1_performtransformation_black != null) {
				...
				return new Object[] { tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding, mOverriding,
	...
	public static final Object[] pattern_MethodOverriding_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tOverriding, EObject mMethodToTMethod, EObject mMethod,
	...
	public static final void pattern_MethodOverriding_1_5_registerobjects_expressionBBBBBBBB(MethodOverriding _this,
			PerformRuleResult ruleresult, EObject tOverriding, EObject mMethodToTMethod, EObject mMethod,
			EObject mOverridingToTOverriding, EObject mOverriding, EObject tMethod) {
		_this.registerObjects_FWD(ruleresult, tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding,
				mOverriding, tMethod);
					...
					for (MDefinitionToTMember mOverridingToTOverriding : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mMethodToTMethod.equals(mOverridingToTOverriding)) {
							...
							if (tmpTOverriding instanceof TMethodDefinition) {
								TMethodDefinition tOverriding = (TMethodDefinition) tmpTOverriding;
								if (!tMethod.equals(tOverriding)) {
									_result.add(new Object[] { tOverriding, mMethodToTMethod, mMethod,
	...
	public static final Object[] pattern_MethodOverriding_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding, mOverriding, tMethod,
				isApplicableMatch, mMethodToTMethod__mMethod____source, mMethod__mOverriding____redefinitions,
				mOverriding__mMethod____redefinedMethodDeclaration, mOverridingToTOverriding__tOverriding____target,
				mMethodToTMethod__tMethod____target, mOverridingToTOverriding__mOverriding____source };
	}

	public static final Object[] pattern_MethodOverriding_2_4_solveCSP_bindingFBBBBBBBB(MethodOverriding _this,
			IsApplicableMatch isApplicableMatch, TMethodDefinition tOverriding, MDefinitionToTMember mMethodToTMethod,
			MMethodDefinition mMethod, MDefinitionToTMember mOverridingToTOverriding, MMethodDefinition mOverriding,
			TMethodDefinition tMethod) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tOverriding, mMethodToTMethod,
				mMethod, mOverridingToTOverriding, mOverriding, tMethod);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tOverriding, mMethodToTMethod, mMethod,
					mOverridingToTOverriding, mOverriding, tMethod };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodOverriding_2_4_solveCSP_bindingAndBlackFBBBBBBBB(MethodOverriding _this,
		...
		Object[] result_pattern_MethodOverriding_2_4_solveCSP_binding = pattern_MethodOverriding_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding, mOverriding,
				tMethod);
	...
	public static final void pattern_MethodOverriding_11_5_registerobjects_expressionBBBBBBBB(MethodOverriding _this,
			PerformRuleResult ruleresult, EObject tOverriding, EObject mMethodToTMethod, EObject mMethod,
			EObject mOverridingToTOverriding, EObject mOverriding, EObject tMethod) {
		_this.registerObjects_BWD(ruleresult, tOverriding, mMethodToTMethod, mMethod, mOverridingToTOverriding,
				mOverriding, tMethod);
	...
	public static final Object[] pattern_MethodOverriding_12_4_solveCSP_bindingFBBBBBBBB(MethodOverriding _this,
			...
			MMethodDefinition mMethod, MDefinitionToTMember mOverridingToTOverriding, MMethodDefinition mOverriding,
			TMethodDefinition tMethod) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tOverriding, mMethodToTMethod,
				mMethod, mOverridingToTOverriding, mOverriding, tMethod);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tOverriding, mMethodToTMethod, mMethod,
	...
	public static final Iterable<Object[]> pattern_MethodOverriding_24_5_matchcorrcontext_blackBFBFBBBB(
			TMethodDefinition tOverriding, MMethodDefinition mMethod, MMethodDefinition mOverriding,
			TMethodDefinition tMethod, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mMethod.equals(mOverriding)) {
	...
	public static final Object[] pattern_MethodOverriding_29_3_solveCSP_bindingFBBBBBBBBB(MethodOverriding _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tOverriding, mMethodToTMethod,
				mMethod, mOverridingToTOverriding, mOverriding, tMethod, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tOverriding, mMethodToTMethod, mMethod,
