...
import org.gravity.tgg.modisco.pm.TypeParameterToTClass;
 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.TypeParameterToTClassImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.TypeParameterToTClassImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeParameterToTClassImpl extends AbstractCorrespondenceImpl implements TypeParameterToTClass {
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.TYPE_PARAMETER_TO_TCLASS;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.TYPE_PARAMETER_TO_TCLASS__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(TypeParameter newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.TYPE_PARAMETER_TO_TCLASS__SOURCE, oldSource,
					source));
	}
	...
	public TClass getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.TYPE_PARAMETER_TO_TCLASS__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TClass newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.TYPE_PARAMETER_TO_TCLASS__TARGET, oldTarget,
					target));
	}
