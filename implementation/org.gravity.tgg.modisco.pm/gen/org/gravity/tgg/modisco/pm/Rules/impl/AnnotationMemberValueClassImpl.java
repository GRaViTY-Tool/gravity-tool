...
public class AnnotationMemberValueClassImpl extends AbstractRuleImpl implements AnnotationMemberValueClass {
			...
			for (Object[] result3_black : AnnotationMemberValueClassImpl
				...
				Object[] result4_bindingAndBlack = AnnotationMemberValueClassImpl
						.pattern_AnnotationMemberValueClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								...
								mAnnotationValue, tType, mTypeToTType, mOwner, mValue, tAnnotationValue, mType);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_55(EMoflonEdge _edge_tClass) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_VALUE_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATION_TYPEACCESS_ANNOTATIONMEMBERVALUEPAIRTOTANNOTATIONVALUE_ANNOTATIONMEMBERVALUEPAIR_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_BODYDECLARATION_TYPELITERAL_TANNOTATIONVALUE_TYPE:
		...
		case RulesPackage.ANNOTATION_MEMBER_VALUE_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_55__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_55((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_VALUE_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_57__EMOFLONEDGE:
										...
										if (tmpTAnnotationValue instanceof TAnnotationValue) {
											...
											if (tmpMType instanceof Type) {
												...
												return new Object[] { annotation, mAccess,
														annotationMemberValuePairToTAnnotationValue, mAnnotationValue,
														tType, mTypeToTType, mOwner, mValue, tAnnotationValue, mType,
														isApplicableMatch };
											}
										}
									}
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				...
				return new Object[] { annotation, mAccess, annotationMemberValuePairToTAnnotationValue,
						mAnnotationValue, tType, mTypeToTType, mOwner, mValue, tAnnotationValue, mType, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_AnnotationMemberValueClass_1_5_registerobjects_expressionBBBBBBBBBBBBBB(
		...
		_this.registerObjects_FWD(ruleresult, annotation, mAccess, annotationMemberValuePairToTAnnotationValue,
				mAnnotationValue, tType, mTypeToTType, tValue, mOwner, mValueToTValue, mValue, tAnnotationValue, mType);
	...
	public static final Object[] pattern_AnnotationMemberValueClass_2_4_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, annotation, mAccess,
				annotationMemberValuePairToTAnnotationValue, mAnnotationValue, tType, mTypeToTType, mOwner, mValue,
				tAnnotationValue, mType);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_AnnotationMemberValueClass_21_2_testcorematchandDECs_black_nac_0BBB(
		...
		for (AbstractTypeDeclaration __DEC_mAccess_superInterfaces_484046 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mOwner.equals(__DEC_mAccess_superInterfaces_484046)) {
				if (!mType.equals(__DEC_mAccess_superInterfaces_484046)) {
	...
	public static final Object[] pattern_AnnotationMemberValueClass_21_2_testcorematchandDECs_black_nac_1BB(
		...
		for (Annotation __DEC_mAccess_type_61853 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, Annotation.class, "type")) {
			if (!annotation.equals(__DEC_mAccess_type_61853)) {
	...
	public static final Object[] pattern_AnnotationMemberValueClass_21_2_testcorematchandDECs_black_nac_2BB(
		...
		for (ArrayType __DEC_mAccess_elementType_434989 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ArrayType.class, "elementType")) {
			if (!mType.equals(__DEC_mAccess_elementType_434989)) {
	...
	public static final Object[] pattern_AnnotationMemberValueClass_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess mAccess) {
		for (ClassInstanceCreation __DEC_mAccess_type_963272 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationMemberValueClass_21_2_testcorematchandDECs_black_nac_4BBB(
			TypeAccess mAccess, BodyDeclaration mOwner, Type mType) {
		for (ClassDeclaration __DEC_mAccess_superClass_756421 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ClassDeclaration.class, "superClass")) {
			if (!mOwner.equals(__DEC_mAccess_superClass_756421)) {
				if (!mType.equals(__DEC_mAccess_superClass_756421)) {
					return new Object[] { mAccess, mOwner, mType };
				}
			}
		}
	...
	public static final Object[] pattern_AnnotationMemberValueClass_21_2_testcorematchandDECs_black_nac_5BB(
		...
		for (MethodDeclaration __DEC_mAccess_returnType_471553 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, MethodDeclaration.class, "returnType")) {
			if (!mOwner.equals(__DEC_mAccess_returnType_471553)) {
	...
	public static final Object[] pattern_AnnotationMemberValueClass_21_2_testcorematchandDECs_black_nac_6BB(
			TypeAccess mAccess, Type mType) {
		for (ParameterizedType __DEC_mAccess_type_837615 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mAccess_type_837615)) {
				return new Object[] { mAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberValueClass_21_2_testcorematchandDECs_black_nac_7BB(
		...
		for (AnnotationMemberValuePair __DEC_mAccess_value_747606 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, AnnotationMemberValuePair.class, "value")) {
			if (!mAnnotationValue.equals(__DEC_mAccess_value_747606)) {
	...
	public static final Object[] pattern_AnnotationMemberValueClass_27_1_matchtggpattern_black_nac_0BBB(
			TypeAccess mAccess, BodyDeclaration mOwner, Type mType) {
		for (AbstractTypeDeclaration __DEC_mAccess_superInterfaces_527840 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mOwner.equals(__DEC_mAccess_superInterfaces_527840)) {
				if (!mType.equals(__DEC_mAccess_superInterfaces_527840)) {
					return new Object[] { mAccess, mOwner, mType };
				}
			}
		}
	...
	public static final Object[] pattern_AnnotationMemberValueClass_27_1_matchtggpattern_black_nac_1BB(
			TypeAccess mAccess, Annotation annotation) {
		for (Annotation __DEC_mAccess_type_295612 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, Annotation.class, "type")) {
			if (!annotation.equals(__DEC_mAccess_type_295612)) {
				return new Object[] { mAccess, annotation };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberValueClass_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess mAccess, Type mType) {
		for (ArrayType __DEC_mAccess_elementType_445333 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ArrayType.class, "elementType")) {
			if (!mType.equals(__DEC_mAccess_elementType_445333)) {
				return new Object[] { mAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberValueClass_27_1_matchtggpattern_black_nac_3B(
			TypeAccess mAccess) {
		for (ClassInstanceCreation __DEC_mAccess_type_422256 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { mAccess };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberValueClass_27_1_matchtggpattern_black_nac_4BBB(
			TypeAccess mAccess, BodyDeclaration mOwner, Type mType) {
		for (ClassDeclaration __DEC_mAccess_superClass_412234 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ClassDeclaration.class, "superClass")) {
			if (!mOwner.equals(__DEC_mAccess_superClass_412234)) {
				if (!mType.equals(__DEC_mAccess_superClass_412234)) {
					return new Object[] { mAccess, mOwner, mType };
				}
			}
		}
	...
	public static final Object[] pattern_AnnotationMemberValueClass_27_1_matchtggpattern_black_nac_5BB(
			TypeAccess mAccess, BodyDeclaration mOwner) {
		for (MethodDeclaration __DEC_mAccess_returnType_174647 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, MethodDeclaration.class, "returnType")) {
			if (!mOwner.equals(__DEC_mAccess_returnType_174647)) {
				return new Object[] { mAccess, mOwner };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberValueClass_27_1_matchtggpattern_black_nac_6BB(
			TypeAccess mAccess, Type mType) {
		for (ParameterizedType __DEC_mAccess_type_856746 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mAccess_type_856746)) {
				return new Object[] { mAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberValueClass_27_1_matchtggpattern_black_nac_7BB(
			TypeAccess mAccess, AnnotationMemberValuePair mAnnotationValue) {
		for (AnnotationMemberValuePair __DEC_mAccess_value_980127 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, AnnotationMemberValuePair.class, "value")) {
			if (!mAnnotationValue.equals(__DEC_mAccess_value_980127)) {
				return new Object[] { mAccess, mAnnotationValue };
			}
		}
		return null;
