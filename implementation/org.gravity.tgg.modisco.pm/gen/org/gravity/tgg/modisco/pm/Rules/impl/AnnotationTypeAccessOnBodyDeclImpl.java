...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Annotation Type Access On Body Decl</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class AnnotationTypeAccessOnBodyDeclImpl extends AbstractRuleImpl implements AnnotationTypeAccessOnBodyDecl {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected AnnotationTypeAccessOnBodyDeclImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getAnnotationTypeAccessOnBodyDecl();
	}
	...
	public boolean isAppropriate_FWD(Match match, TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType,
		...
		Object[] result1_black = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_0_1_initialbindings_blackBBBBBB(this, match, mAccess,
		...
		Object[] result2_bindingAndBlack = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, mAccess,
						mAnnotationType, mOwner, mAnnotation);
		...
		// 
		if (AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_0_3_CheckCSP_expressionFBB(this,
				csp)) {

			Object[] result4_black = AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_0_4_collectelementstobetranslated_blackBBBBB(match, mAccess,
							mAnnotationType, mOwner, mAnnotation);
			...
			AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_0_4_collectelementstobetranslated_greenBBBBFFF(match,
			...
			Object[] result5_black = AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_0_5_collectcontextelements_blackBBBBB(match, mAccess,
							mAnnotationType, mOwner, mAnnotation);
			...
			AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_0_5_collectcontextelements_greenBBBBF(match,
							mAnnotationType, mOwner, mAnnotation);
			//nothing EMoflonEdge mOwner__mAnnotation____annotations = (EMoflonEdge) result5_green[4];

			// 
			AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_0_6_registerobjectstomatch_expressionBBBBBB(this, match,
							mAccess, mAnnotationType, mOwner, mAnnotation);
			return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_0_7_expressionF();
		} else {
			return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(this,
						isApplicableMatch);
		...
		AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_1_1_performtransformation_greenBB(tAnnotation, tAnnotationType);

		Object[] result2_black = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_1_2_collecttranslatedelements_blackB(mAccess);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mAccess] = " + mAccess + ".");
		}
		Object[] result2_green = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_1_2_collecttranslatedelements_greenFB(mAccess);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		EOperation performOperation = (EOperation) result1_bindingAndBlack[0];
		//nothing EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_2_2_corematch_bindingFFFFB(match);
		...
		for (Object[] result2_black : AnnotationTypeAccessOnBodyDeclImpl
			...
			for (Object[] result3_black : AnnotationTypeAccessOnBodyDeclImpl
				...
				//nothing EMoflonEdge mOwner__mAnnotation____annotations = (EMoflonEdge) result3_green[16];
				...
				// 
				if (AnnotationTypeAccessOnBodyDeclImpl
						.pattern_AnnotationTypeAccessOnBodyDecl_2_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = AnnotationTypeAccessOnBodyDeclImpl
							.pattern_AnnotationTypeAccessOnBodyDecl_2_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					...
					AnnotationTypeAccessOnBodyDeclImpl
							.pattern_AnnotationTypeAccessOnBodyDecl_2_6_addmatchtoruleresult_greenBB(ruleresult,
									isApplicableMatch);
		...
		return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_2_7_expressionFB(ruleresult);
	}
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType,
			BodyDeclaration mOwner, Annotation mAnnotation) {// Create CSP
	...
	public boolean isAppropriate_BWD(Match match, TAnnotation tAnnotation, TAnnotationType tAnnotationType) {
		...
		Object[] result1_black = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_10_1_initialbindings_blackBBBB(this, match, tAnnotation,
						tAnnotationType);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_bindingAndBlackFBBBB(this, match, tAnnotation,
						tAnnotationType);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[tAnnotationType] = "
		...
		CSP csp = (CSP) result2_bindingAndBlack[0];
		// 
		if (AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_10_3_CheckCSP_expressionFBB(this,
				csp)) {

			Object[] result4_black = AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_10_4_collectelementstobetranslated_blackBBB(match,
			...
			AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_10_4_collectelementstobetranslated_greenBBBFF(match,
							tAnnotation, tAnnotationType);
			...
			Object[] result5_black = AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_10_5_collectcontextelements_blackBBB(match, tAnnotation,
							tAnnotationType);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tAnnotation] = " + tAnnotation + ", " + "[tAnnotationType] = " + tAnnotationType + ".");
			...
			AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_10_5_collectcontextelements_greenBBB(match, tAnnotation,
							tAnnotationType);

			// 
			AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_10_6_registerobjectstomatch_expressionBBBB(this, match,
							tAnnotation, tAnnotationType);
			return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_10_7_expressionF();
		} else {
			return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		Object[] result1_green = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_11_1_performtransformation_greenFBB(mAnnotationType,
						mAnnotation);
		TypeAccess mAccess = (TypeAccess) result1_green[0];

		Object[] result2_black = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_11_2_collecttranslatedelements_blackB(mAccess);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mAccess] = " + mAccess + ".");
		}
		Object[] result2_green = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_11_2_collecttranslatedelements_greenFB(mAccess);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Object[] result1_bindingAndBlack = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		EOperation performOperation = (EOperation) result1_bindingAndBlack[0];
		//nothing EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_12_2_corematch_bindingFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : AnnotationTypeAccessOnBodyDeclImpl
			...
			for (Object[] result3_black : AnnotationTypeAccessOnBodyDeclImpl
				...
				// 
				if (AnnotationTypeAccessOnBodyDeclImpl
						.pattern_AnnotationTypeAccessOnBodyDecl_12_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = AnnotationTypeAccessOnBodyDeclImpl
							.pattern_AnnotationTypeAccessOnBodyDecl_12_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					...
					AnnotationTypeAccessOnBodyDeclImpl
							.pattern_AnnotationTypeAccessOnBodyDecl_12_6_addmatchtoruleresult_greenBB(ruleresult,
									isApplicableMatch);
		...
		return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_12_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_608(EMoflonEdge _edge_annotations) {
		...
		Object[] result1_green = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach 
		for (Object[] result2_black : AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_20_2_testcorematchandDECs_blackFFB(_edge_annotations)) {
			TAnnotation tAnnotation = (TAnnotation) result2_black[0];
			TAnnotationType tAnnotationType = (TAnnotationType) result2_black[1];
			Object[] result2_green = AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_20_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// 
			if (AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
							this, match, tAnnotation, tAnnotationType)) {
				// 
				if (AnnotationTypeAccessOnBodyDeclImpl
						.pattern_AnnotationTypeAccessOnBodyDecl_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					Object[] result5_black = AnnotationTypeAccessOnBodyDeclImpl
							.pattern_AnnotationTypeAccessOnBodyDecl_20_5_Addmatchtoruleresult_blackBBBB(match,
					...
					AnnotationTypeAccessOnBodyDeclImpl
							.pattern_AnnotationTypeAccessOnBodyDecl_20_5_Addmatchtoruleresult_greenBBBB(match,
									__performOperation, __result, isApplicableCC);
		...
		return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_20_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_654(EMoflonEdge _edge_type) {
		...
		EOperation isApplicableCC = (EOperation) result1_bindingAndBlack[3];
		Object[] result1_green = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach 
		for (Object[] result2_black : AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_blackFFFFB(_edge_type)) {
			...
			Object[] result2_green = AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// 
			if (AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
							this, match, mAccess, mAnnotationType, mOwner, mAnnotation)) {
				// 
				if (AnnotationTypeAccessOnBodyDeclImpl
						.pattern_AnnotationTypeAccessOnBodyDecl_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					Object[] result5_black = AnnotationTypeAccessOnBodyDeclImpl
							.pattern_AnnotationTypeAccessOnBodyDecl_21_5_Addmatchtoruleresult_blackBBBB(match,
									__performOperation, __result, isApplicableCC);
					if (result5_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match
								+ ", " + "[__performOperation] = " + __performOperation + ", " + "[__result] = "
					...
					AnnotationTypeAccessOnBodyDeclImpl
							.pattern_AnnotationTypeAccessOnBodyDecl_21_5_Addmatchtoruleresult_greenBBBB(match,
									__performOperation, __result, isApplicableCC);
		...
		return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_21_6_expressionFB(__result);
	}
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result1_black = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_24_1_prepare_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_24_1_prepare_greenF();
		IsApplicableRuleResult result = (IsApplicableRuleResult) result1_green[0];

		Object[] result2_bindingAndBlack = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(sourceMatch,
						targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result3_bindingAndBlack = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAnnotation,
		...
		if (AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationTypeAccessOnBodyDeclImpl
				...
				Object[] result6_black = AnnotationTypeAccessOnBodyDeclImpl
						.pattern_AnnotationTypeAccessOnBodyDecl_24_6_createcorrespondence_blackBBBBBBB(tAnnotation,
				...
				Object[] result7_black = AnnotationTypeAccessOnBodyDeclImpl
						.pattern_AnnotationTypeAccessOnBodyDecl_24_7_addtoreturnedresult_blackBB(result, ccMatch);
				if (result7_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[result] = " + result
							+ ", " + "[ccMatch] = " + ccMatch + ".");
				}
				AnnotationTypeAccessOnBodyDeclImpl
						.pattern_AnnotationTypeAccessOnBodyDecl_24_7_addtoreturnedresult_greenBB(result, ccMatch);

			}

		} else {
		}
		return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_24_8_expressionFB(result);
	}
	...
	public CSP isApplicable_solveCsp_CC(TAnnotation tAnnotation, TypeAccess mAccess,
			AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner, Annotation mAnnotation,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner,
			Annotation mAnnotation) {// 
		Object[] result1_black = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_blackBBBB(mAccess, mAnnotationType, mOwner,
						mAnnotation);
		if (result1_black != null) {
			return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_27_2_expressionF();
		} else {
			return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_27_3_expressionF();
		}
	...
	public boolean checkDEC_BWD(TAnnotation tAnnotation, TAnnotationType tAnnotationType) {// 
		Object[] result1_black = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_28_1_matchtggpattern_blackBB(tAnnotation, tAnnotationType);
		if (result1_black != null) {
			return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_28_2_expressionF();
		} else {
			return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_28_3_expressionF();
		}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		Object[] result1_black = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_29_1_createresult_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_29_1_createresult_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach 
		for (Object[] result2_black : AnnotationTypeAccessOnBodyDeclImpl
				.pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_blackFFFFFFFFFBB(ruleEntryContainer,
						ruleResult)) {
			...
			// 
			if (AnnotationTypeAccessOnBodyDeclImpl
					.pattern_AnnotationTypeAccessOnBodyDecl_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = AnnotationTypeAccessOnBodyDeclImpl
				...
				if (result5_black != null) {
					...
					AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_29_6_perform_greenBFBBBB(
		...
		return AnnotationTypeAccessOnBodyDeclImpl.pattern_AnnotationTypeAccessOnBodyDecl_29_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_TYPE_ACCESS_ON_BODY_DECL___IS_APPROPRIATE_BWD_EMOFLON_EDGE_608__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_608((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_TYPE_ACCESS_ON_BODY_DECL___IS_APPROPRIATE_FWD_EMOFLON_EDGE_654__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_654((EMoflonEdge) arguments.get(0));
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_0_1_initialbindings_blackBBBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TypeAccess mAccess,
			AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner, Annotation mAnnotation) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_bindingFBBBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TypeAccess mAccess,
			AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner, Annotation mAnnotation) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_bindingAndBlackFBBBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TypeAccess mAccess,
			AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner, Annotation mAnnotation) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_binding = pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, mAccess, mAnnotationType, mOwner, mAnnotation);
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_binding[0];

			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_black = pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_blackB(
					csp);
			if (result_pattern_AnnotationTypeAccessOnBodyDecl_0_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_0_3_CheckCSP_expressionFBB(
			AnnotationTypeAccessOnBodyDecl _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_0_4_collectelementstobetranslated_blackBBBBB(
			Match match, TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner,
			Annotation mAnnotation) {
		if (!mAnnotationType.equals(mOwner)) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_0_4_collectelementstobetranslated_greenBBBBFFF(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_0_5_collectcontextelements_blackBBBBB(
			Match match, TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner,
			Annotation mAnnotation) {
		if (!mAnnotationType.equals(mOwner)) {
			return new Object[] { match, mAccess, mAnnotationType, mOwner, mAnnotation };
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_0_5_collectcontextelements_greenBBBBF(
			Match match, AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner, Annotation mAnnotation) {
		...
		return new Object[] { match, mAnnotationType, mOwner, mAnnotation, mOwner__mAnnotation____annotations };
	}

	public static final void pattern_AnnotationTypeAccessOnBodyDecl_0_6_registerobjectstomatch_expressionBBBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TypeAccess mAccess,
			AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner, Annotation mAnnotation) {
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_0_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_1_1_performtransformation_bindingFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
			AnnotationTypeAccessOnBodyDecl _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_1_1_performtransformation_binding = pattern_AnnotationTypeAccessOnBodyDecl_1_1_performtransformation_bindingFFFFFFFFB(
				isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_1_1_performtransformation_greenBB(
			TAnnotation tAnnotation, TAnnotationType tAnnotationType) {
		tAnnotationType.getAnnotations().add(tAnnotation);
		return new Object[] { tAnnotation, tAnnotationType };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_1_2_collecttranslatedelements_blackB(
			TypeAccess mAccess) {
		return new Object[] { mAccess };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_1_2_collecttranslatedelements_greenFB(
			TypeAccess mAccess) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		String ruleresult_ruleName_prime = "AnnotationTypeAccessOnBodyDecl";
		String mAccess__mAnnotationType____type_name_prime = "type";
		String mAnnotationType__mAccess____usagesInTypeAccess_name_prime = "usagesInTypeAccess";
		String mAnnotation__mAccess____type_name_prime = "type";
	...
	public static final PerformRuleResult pattern_AnnotationTypeAccessOnBodyDecl_1_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_bindingFB(
			AnnotationTypeAccessOnBodyDecl _this) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_blackFBB(EClass eClass,
			AnnotationTypeAccessOnBodyDecl _this) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_bindingAndBlackFFB(
			AnnotationTypeAccessOnBodyDecl _this) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_binding = pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_black = pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "AnnotationTypeAccessOnBodyDecl";
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_2_corematch_bindingFFFFB(Match match) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_3_findcontext_greenBBBBBBBBFFFFFFFFF(
		...
		return new Object[] { tAnnotation, mAccess, annotationToTAnnotation, mAnnotationType,
				...
				annotationTypeToTAnnotationType__mAnnotationType____source, mOwner__mAnnotation____annotations };
	}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_2_4_solveCSP_binding != null) {
			...
			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_2_4_solveCSP_black = pattern_AnnotationTypeAccessOnBodyDecl_2_4_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_2_5_checkCSP_expressionFBB(
			AnnotationTypeAccessOnBodyDecl _this, CSP csp) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "AnnotationTypeAccessOnBodyDecl";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_AnnotationTypeAccessOnBodyDecl_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_10_1_initialbindings_blackBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TAnnotation tAnnotation,
			TAnnotationType tAnnotationType) {
		return new Object[] { _this, match, tAnnotation, tAnnotationType };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_bindingFBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TAnnotation tAnnotation,
			TAnnotationType tAnnotationType) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_bindingAndBlackFBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TAnnotation tAnnotation,
			TAnnotationType tAnnotationType) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_binding = pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_bindingFBBBB(
				_this, match, tAnnotation, tAnnotationType);
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_binding[0];

			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_black = pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_blackB(
					csp);
			if (result_pattern_AnnotationTypeAccessOnBodyDecl_10_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_10_3_CheckCSP_expressionFBB(
			AnnotationTypeAccessOnBodyDecl _this, CSP csp) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_10_4_collectelementstobetranslated_blackBBB(
			Match match, TAnnotation tAnnotation, TAnnotationType tAnnotationType) {
		return new Object[] { match, tAnnotation, tAnnotationType };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_10_4_collectelementstobetranslated_greenBBBFF(
			Match match, TAnnotation tAnnotation, TAnnotationType tAnnotationType) {
		EMoflonEdge tAnnotationType__tAnnotation____annotations = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAnnotation__tAnnotationType____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		String tAnnotationType__tAnnotation____annotations_name_prime = "annotations";
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_10_5_collectcontextelements_blackBBB(
			Match match, TAnnotation tAnnotation, TAnnotationType tAnnotationType) {
		return new Object[] { match, tAnnotation, tAnnotationType };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_10_5_collectcontextelements_greenBBB(
			Match match, TAnnotation tAnnotation, TAnnotationType tAnnotationType) {
	...
	public static final void pattern_AnnotationTypeAccessOnBodyDecl_10_6_registerobjectstomatch_expressionBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TAnnotation tAnnotation,
			TAnnotationType tAnnotationType) {
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_10_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			AnnotationTypeAccessOnBodyDecl _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_11_1_performtransformation_binding = pattern_AnnotationTypeAccessOnBodyDecl_11_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_11_1_performtransformation_greenFBB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_11_2_collecttranslatedelements_blackB(
			TypeAccess mAccess) {
		return new Object[] { mAccess };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_11_2_collecttranslatedelements_greenFB(
			TypeAccess mAccess) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_11_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tAnnotation, EObject mAccess, EObject mAnnotationType,
			EObject mAnnotation, EObject tAnnotationType) {
		EMoflonEdge mAccess__mAnnotationType____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mAnnotationType__mAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final PerformRuleResult pattern_AnnotationTypeAccessOnBodyDecl_11_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_bindingFB(
			AnnotationTypeAccessOnBodyDecl _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_blackFBB(EClass eClass,
			AnnotationTypeAccessOnBodyDecl _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperation_name = performOperation.getName();
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_bindingAndBlackFFB(
			AnnotationTypeAccessOnBodyDecl _this) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_binding = pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_binding[0];

			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_black = pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "AnnotationTypeAccessOnBodyDecl";
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_2_corematch_bindingFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeAccessOnBodyDecl_12_2_corematch_blackBFFFFBB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { tAnnotation, annotationToTAnnotation, mAnnotationType, annotationTypeToTAnnotationType,
				...
				tAnnotation__tAnnotationType____type, mOwner__mAnnotation____annotations };
	}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_12_4_solveCSP_binding != null) {
			...
			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_12_4_solveCSP_black = pattern_AnnotationTypeAccessOnBodyDecl_12_4_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_12_5_checkCSP_expressionFBB(
			AnnotationTypeAccessOnBodyDecl _this, CSP csp) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_12_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "AnnotationTypeAccessOnBodyDecl";
	...
	public static final IsApplicableRuleResult pattern_AnnotationTypeAccessOnBodyDecl_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_bindingFB(
			AnnotationTypeAccessOnBodyDecl _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_blackFBBF(
			EClass __eClass, AnnotationTypeAccessOnBodyDecl _this) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_bindingAndBlackFFBF(
			AnnotationTypeAccessOnBodyDecl _this) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_binding = pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_binding[0];

			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_black = pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_20_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_AnnotationTypeAccessOnBodyDecl_20_2_testcorematchandDECs_blackFFB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_20_2_testcorematchandDECs_greenFB(
			EClass __eClass) {
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TAnnotation tAnnotation,
			TAnnotationType tAnnotationType) {
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_BWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_20_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_20_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_AnnotationTypeAccessOnBodyDecl_20_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_bindingFB(
			AnnotationTypeAccessOnBodyDecl _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_blackFBBF(
			EClass __eClass, AnnotationTypeAccessOnBodyDecl _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperation_name = __performOperation.getName();
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_bindingAndBlackFFBF(
			AnnotationTypeAccessOnBodyDecl _this) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_binding = pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_binding[0];

			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_black = pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_0BBB(
			TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner) {
		if (!mAnnotationType.equals(mOwner)) {
			for (AbstractTypeDeclaration __DEC_mAccess_superInterfaces_25701 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!mAnnotationType.equals(__DEC_mAccess_superInterfaces_25701)) {
					if (!mOwner.equals(__DEC_mAccess_superInterfaces_25701)) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_1BB(
		...
		for (AnnotationTypeMemberDeclaration __DEC_mAccess_type_599711 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			if (!mOwner.equals(__DEC_mAccess_type_599711)) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess mAccess) {
		for (ArrayType __DEC_mAccess_elementType_542158 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess mAccess) {
		for (ClassInstanceCreation __DEC_mAccess_type_86616 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_4BB(
			TypeAccess mAccess, BodyDeclaration mOwner) {
		for (ClassDeclaration __DEC_mAccess_superClass_193524 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ClassDeclaration.class, "superClass")) {
			if (!mOwner.equals(__DEC_mAccess_superClass_193524)) {
				return new Object[] { mAccess, mOwner };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess mAccess, BodyDeclaration mOwner) {
		for (MethodDeclaration __DEC_mAccess_returnType_657352 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, MethodDeclaration.class, "returnType")) {
			if (!mOwner.equals(__DEC_mAccess_returnType_657352)) {
				return new Object[] { mAccess, mOwner };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess mAccess) {
		for (ParameterizedType __DEC_mAccess_type_993081 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess mAccess) {
		for (TypeLiteral __DEC_mAccess_type_976021 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_8B(
			TypeAccess mAccess) {
		for (AnnotationMemberValuePair __DEC_mAccess_value_662385 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_9BB(
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_blackFFFFB(
		...
		if (tmpMAccess instanceof TypeAccess) {
			...
			if (tmpMAnnotationType instanceof AnnotationTypeDeclaration) {
				AnnotationTypeDeclaration mAnnotationType = (AnnotationTypeDeclaration) tmpMAnnotationType;
				if (mAnnotationType.equals(mAccess.getType())) {
					if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_2B(
							mAccess) == null) {
						if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_3B(
								mAccess) == null) {
							if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_6B(
									mAccess) == null) {
								if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_7B(
										mAccess) == null) {
									if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_8B(
											mAccess) == null) {
										if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_9BB(
											...
											for (Annotation mAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
												...
												for (BodyDeclaration mOwner : org.moflon.core.utilities.eMoflonEMFUtil
														.getOppositeReferenceTyped(mAnnotation, BodyDeclaration.class,
																"annotations")) {
													if (!mAnnotationType.equals(mOwner)) {
														if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_0BBB(
																mAccess, mAnnotationType, mOwner) == null) {
															if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_1BB(
																	mAccess, mOwner) == null) {
																if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_4BB(
																		mAccess, mOwner) == null) {
																	if (pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_black_nac_5BB(
																			mAccess, mOwner) == null) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_2_testcorematchandDECs_greenFB(
			EClass __eClass) {
		Match match = RuntimeFactory.eINSTANCE.createMatch();
		String __eClass_name = __eClass.getName();
		String match_ruleName_prime = __eClass_name;
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match, TypeAccess mAccess,
			AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner, Annotation mAnnotation) {
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			AnnotationTypeAccessOnBodyDecl _this, Match match) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_5_Addmatchtoruleresult_blackBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		if (!__performOperation.equals(isApplicableCC)) {
			return new Object[] { match, __performOperation, __result, isApplicableCC };
		}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_21_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
		match.setIsApplicableCCOperation(isApplicableCC);
	...
	public static final EObjectContainer pattern_AnnotationTypeAccessOnBodyDecl_21_6_expressionFB(
			EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_1_prepare_blackB(
			AnnotationTypeAccessOnBodyDecl _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_1_prepare_greenF() {
		IsApplicableRuleResult result = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		return new Object[] { result };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_bindingFFFFFFBB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TAnnotation tAnnotation, TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType,
			BodyDeclaration mOwner, Annotation mAnnotation, TAnnotationType tAnnotationType, Match sourceMatch,
			Match targetMatch) {
		if (!mAnnotationType.equals(mOwner)) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_binding = pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_bindingFFFFFFBB(
				targetMatch, sourceMatch);
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_binding != null) {
			TAnnotation tAnnotation = (TAnnotation) result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_binding[0];
			TypeAccess mAccess = (TypeAccess) result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_binding[1];
			AnnotationTypeDeclaration mAnnotationType = (AnnotationTypeDeclaration) result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_binding[2];
			BodyDeclaration mOwner = (BodyDeclaration) result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_binding[3];
			Annotation mAnnotation = (Annotation) result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_binding[4];
			TAnnotationType tAnnotationType = (TAnnotationType) result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_binding[5];

			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_black = pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAnnotation, mAccess, mAnnotationType, mOwner, mAnnotation, tAnnotationType, sourceMatch,
					targetMatch);
			if (result_pattern_AnnotationTypeAccessOnBodyDecl_24_2_matchsrctrgcontext_black != null) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_bindingFBBBBBBBBB(
			AnnotationTypeAccessOnBodyDecl _this, TAnnotation tAnnotation, TypeAccess mAccess,
			AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner, Annotation mAnnotation,
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationTypeAccessOnBodyDecl _this, TAnnotation tAnnotation, TypeAccess mAccess,
			AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner, Annotation mAnnotation,
			TAnnotationType tAnnotationType, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_binding = pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAnnotation, mAccess, mAnnotationType, mOwner, mAnnotation, tAnnotationType, sourceMatch,
				targetMatch);
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_binding != null) {
			CSP csp = (CSP) result_pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_binding[0];

			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_black = pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_blackB(
					csp);
			if (result_pattern_AnnotationTypeAccessOnBodyDecl_24_3_solvecsp_black != null) {
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_24_4_checkCSP_expressionFB(CSP csp) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_5_matchcorrcontext_greenBBBBF(
			AnnotationToTAnnotation annotationToTAnnotation, TypeToTAbstractType annotationTypeToTAnnotationType,
			Match sourceMatch, Match targetMatch) {
		CCMatch ccMatch = RuntimeFactory.eINSTANCE.createCCMatch();
		String ccMatch_ruleName_prime = "AnnotationTypeAccessOnBodyDecl";
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_6_createcorrespondence_blackBBBBBBB(
			TAnnotation tAnnotation, TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType,
			BodyDeclaration mOwner, Annotation mAnnotation, TAnnotationType tAnnotationType, CCMatch ccMatch) {
		if (!mAnnotationType.equals(mOwner)) {
			return new Object[] { tAnnotation, mAccess, mAnnotationType, mOwner, mAnnotation, tAnnotationType,
					ccMatch };
		}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_7_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
		return new Object[] { result, ccMatch };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_24_7_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
	...
	public static final IsApplicableRuleResult pattern_AnnotationTypeAccessOnBodyDecl_24_8_expressionFB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_0BBB(
			TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner) {
		if (!mAnnotationType.equals(mOwner)) {
			for (AbstractTypeDeclaration __DEC_mAccess_superInterfaces_154353 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!mAnnotationType.equals(__DEC_mAccess_superInterfaces_154353)) {
					if (!mOwner.equals(__DEC_mAccess_superInterfaces_154353)) {
						return new Object[] { mAccess, mAnnotationType, mOwner };
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_1BB(
			TypeAccess mAccess, BodyDeclaration mOwner) {
		for (AnnotationTypeMemberDeclaration __DEC_mAccess_type_631340 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			if (!mOwner.equals(__DEC_mAccess_type_631340)) {
				return new Object[] { mAccess, mOwner };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_2B(
			TypeAccess mAccess) {
		for (ArrayType __DEC_mAccess_elementType_689293 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ArrayType.class, "elementType")) {
			return new Object[] { mAccess };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_3B(
			TypeAccess mAccess) {
		for (ClassInstanceCreation __DEC_mAccess_type_26167 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { mAccess };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_4BB(
			TypeAccess mAccess, BodyDeclaration mOwner) {
		for (ClassDeclaration __DEC_mAccess_superClass_476764 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ClassDeclaration.class, "superClass")) {
			if (!mOwner.equals(__DEC_mAccess_superClass_476764)) {
				return new Object[] { mAccess, mOwner };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_5BB(
			TypeAccess mAccess, BodyDeclaration mOwner) {
		for (MethodDeclaration __DEC_mAccess_returnType_282271 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, MethodDeclaration.class, "returnType")) {
			if (!mOwner.equals(__DEC_mAccess_returnType_282271)) {
				return new Object[] { mAccess, mOwner };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_6B(
			TypeAccess mAccess) {
		for (ParameterizedType __DEC_mAccess_type_81089 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, ParameterizedType.class, "type")) {
			return new Object[] { mAccess };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_7B(
			TypeAccess mAccess) {
		for (TypeLiteral __DEC_mAccess_type_310165 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, TypeLiteral.class, "type")) {
			return new Object[] { mAccess };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_8B(
			TypeAccess mAccess) {
		for (AnnotationMemberValuePair __DEC_mAccess_value_252813 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mAccess };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_9BB(
			AnnotationTypeDeclaration mAnnotationType, TypeAccess mAccess) {
		if (mAnnotationType.getSuperInterfaces().contains(mAccess)) {
			return new Object[] { mAnnotationType, mAccess };
		}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_blackBBBB(
			TypeAccess mAccess, AnnotationTypeDeclaration mAnnotationType, BodyDeclaration mOwner,
			Annotation mAnnotation) {
		if (!mAnnotationType.equals(mOwner)) {
			if (mAnnotationType.equals(mAccess.getType())) {
				if (mAccess.equals(mAnnotation.getType())) {
					if (mOwner.getAnnotations().contains(mAnnotation)) {
						if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_0BBB(mAccess,
								mAnnotationType, mOwner) == null) {
							if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_1BB(mAccess,
									mOwner) == null) {
								if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_2B(
										mAccess) == null) {
									if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_3B(
											mAccess) == null) {
										if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_4BB(
												mAccess, mOwner) == null) {
											if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_5BB(
													mAccess, mOwner) == null) {
												if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_6B(
														mAccess) == null) {
													if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_7B(
															mAccess) == null) {
														if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_8B(
																mAccess) == null) {
															if (pattern_AnnotationTypeAccessOnBodyDecl_27_1_matchtggpattern_black_nac_9BB(
																	mAnnotationType, mAccess) == null) {
																return new Object[] { mAccess, mAnnotationType, mOwner,
																		mAnnotation };
															}
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_27_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_27_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_28_1_matchtggpattern_blackBB(
			TAnnotation tAnnotation, TAnnotationType tAnnotationType) {
		if (tAnnotationType.getAnnotations().contains(tAnnotation)) {
			return new Object[] { tAnnotation, tAnnotationType };
		}
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_28_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_28_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_1_createresult_blackB(
			AnnotationTypeAccessOnBodyDecl _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_1_createresult_greenFF() {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_0BB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_1BB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_2BB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_3BB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_6BB(
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_blackFFFFFFFFFBB(
					...
					for (EObject tmpAnnotationToTAnnotation : annotationToTAnnotationList.getEntryObjects()) {
						if (tmpAnnotationToTAnnotation instanceof AnnotationToTAnnotation) {
							...
							if (tAnnotation != null) {
								Annotation mAnnotation = annotationToTAnnotation.getSource();
								if (mAnnotation != null) {
									if (pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_1BB(
											ruleResult, annotationToTAnnotation) == null) {
										if (pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_0BB(
												ruleResult, tAnnotation) == null) {
											if (pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_2BB(
												...
												for (EObject tmpAnnotationTypeToTAnnotationType : annotationTypeToTAnnotationTypeList
													...
													if (tmpAnnotationTypeToTAnnotationType instanceof TypeToTAbstractType) {
														...
														if (tmpMAnnotationType instanceof AnnotationTypeDeclaration) {
															...
															if (tmpTAnnotationType instanceof TAnnotationType) {
																TAnnotationType tAnnotationType = (TAnnotationType) tmpTAnnotationType;
																if (pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_5BB(
																		ruleResult,
																		annotationTypeToTAnnotationType) == null) {
																	if (pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_4BB(
																			ruleResult, mAnnotationType) == null) {
																		if (pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_6BB(
																			...
																			for (BodyDeclaration mOwner : org.moflon.core.utilities.eMoflonEMFUtil
																					.getOppositeReferenceTyped(
																							...
																							"annotations")) {
																				if (!mAnnotationType.equals(mOwner)) {
																					if (pattern_AnnotationTypeAccessOnBodyDecl_29_2_isapplicablecore_black_nac_3BB(
																							ruleResult,
																							mOwner) == null) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_3_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_3_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		if (result_pattern_AnnotationTypeAccessOnBodyDecl_29_3_solveCSP_binding != null) {
			...
			Object[] result_pattern_AnnotationTypeAccessOnBodyDecl_29_3_solveCSP_black = pattern_AnnotationTypeAccessOnBodyDecl_29_3_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_AnnotationTypeAccessOnBodyDecl_29_4_checkCSP_expressionFBB(
			AnnotationTypeAccessOnBodyDecl _this, CSP csp) {
	...
	public static final Object[] pattern_AnnotationTypeAccessOnBodyDecl_29_6_perform_greenBFBBBB(
			TAnnotation tAnnotation, AnnotationTypeDeclaration mAnnotationType, Annotation mAnnotation,
			TAnnotationType tAnnotationType, ModelgeneratorRuleResult ruleResult) {
		TypeAccess mAccess = JavaFactory.eINSTANCE.createTypeAccess();
		tAnnotationType.getAnnotations().add(tAnnotation);
	...
	public static final ModelgeneratorRuleResult pattern_AnnotationTypeAccessOnBodyDecl_29_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
