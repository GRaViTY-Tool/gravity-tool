...
public class SubPackageToPGPackageImpl extends AbstractRuleImpl implements SubPackageToPGPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_1_1_performtransformation_greenFBBFBB(tParent, mPackage, typeGraph, csp);
		...
		Object[] result2_black = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_1_2_collecttranslatedelements_blackBBB(mPackageToTSub, mPackage, tSub);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPackageToTSub] = "
					+ mPackageToTSub + ", " + "[mPackage] = " + mPackage + ", " + "[tSub] = " + tSub + ".");
		}
		Object[] result2_green = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_1_2_collecttranslatedelements_greenFBBB(mPackageToTSub, mPackage, tSub);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, mPackageToTSub,
						tParent, mParentPackageToTParent, mPackage, tSub, typeGraph, mParentPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mPackageToTSub] = " + mPackageToTSub + ", " + "[tParent] = " + tParent + ", "
					+ "[mParentPackageToTParent] = " + mParentPackageToTParent + ", " + "[mPackage] = " + mPackage
					+ ", " + "[tSub] = " + tSub + ", " + "[typeGraph] = " + typeGraph + ", " + "[mParentPackage] = "
					+ mParentPackage + ".");
		}
		SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(ruleresult,
				mPackageToTSub, tParent, mPackage, tSub, typeGraph, mParentPackage);
		//nothing EMoflonEdge tParent__tSub____subpackage = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge tSub__tParent____parent = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge mPackageToTSub__mPackage____source = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge mPackage__mParentPackage____package = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge mParentPackage__mPackage____ownedPackages = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge mPackageToTSub__tSub____target = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge tSub__typeGraph____typeGraph = (EMoflonEdge) result3_green[13];

		// 
		// 
		SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, mPackageToTSub, tParent, mParentPackageToTParent, mPackage, tSub, typeGraph,
				mParentPackage);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_2_2_corematch_blackFFBBB(mPackage, mParentPackage, match)) {
			...
			for (Object[] result3_black : SubPackageToPGPackageImpl
					.pattern_SubPackageToPGPackage_2_3_findcontext_blackBBBFB(tParent, mParentPackageToTParent,
							mPackage, mParentPackage)) {
				...
				Object[] result3_green = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_2_3_findcontext_greenBBBBBFFFFFF(tParent,
								mParentPackageToTParent, mPackage, typeGraph, mParentPackage);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				//nothing EMoflonEdge tParent__typeGraph____typeGraph = (EMoflonEdge) result3_green[6];
				//nothing EMoflonEdge mPackage__mParentPackage____package = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge mParentPackage__mPackage____ownedPackages = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mParentPackageToTParent__tParent____target = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
								tParent, mParentPackageToTParent, mPackage, typeGraph, mParentPackage);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tParent] = " + tParent + ", "
							+ "[mParentPackageToTParent] = " + mParentPackageToTParent + ", " + "[mPackage] = "
							+ mPackage + ", " + "[typeGraph] = " + typeGraph + ", " + "[mParentPackage] = "
							+ mParentPackage + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TPackage tParent,
			PackageToTPackage mParentPackageToTParent, org.eclipse.modisco.java.Package mPackage, TypeGraph typeGraph,
			org.eclipse.modisco.java.Package mParentPackage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPackageToTSub, EObject tParent,
			EObject mParentPackageToTParent, EObject mPackage, EObject tSub, EObject typeGraph,
	...
	public boolean isAppropriate_BWD(Match match, TPackage tParent, TPackage tSub, TypeGraph typeGraph) {
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tParent] = " + tParent + ", " + "[tSub] = " + tSub + ", "
					+ "[typeGraph] = " + typeGraph + ".");
		}
		...
		if (SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[tParent] = "
								+ tParent + ", " + "[tSub] = " + tSub + ", " + "[typeGraph] = " + typeGraph + ".");
			}
			...
			//nothing EMoflonEdge tParent__tSub____subpackage = (EMoflonEdge) result4_green[4];
			//nothing EMoflonEdge tSub__tParent____parent = (EMoflonEdge) result4_green[5];
			//nothing EMoflonEdge tSub__typeGraph____typeGraph = (EMoflonEdge) result4_green[6];
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		TPackage tParent = (TPackage) result1_bindingAndBlack[0];
		PackageToTPackage mParentPackageToTParent = (PackageToTPackage) result1_bindingAndBlack[1];
		TPackage tSub = (TPackage) result1_bindingAndBlack[2];
		TypeGraph typeGraph = (TypeGraph) result1_bindingAndBlack[3];
		org.eclipse.modisco.java.Package mParentPackage = (org.eclipse.modisco.java.Package) result1_bindingAndBlack[4];
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_11_1_performtransformation_greenFFBBB(tSub, mParentPackage, csp);
		PackageToTPackage mPackageToTSub = (PackageToTPackage) result1_green[0];
		org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) result1_green[1];

		Object[] result2_black = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_11_2_collecttranslatedelements_blackBBB(mPackageToTSub, mPackage, tSub);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPackageToTSub] = "
					+ mPackageToTSub + ", " + "[mPackage] = " + mPackage + ", " + "[tSub] = " + tSub + ".");
		}
		Object[] result2_green = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_11_2_collecttranslatedelements_greenFBBB(mPackageToTSub, mPackage, tSub);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_11_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, mPackageToTSub,
						tParent, mParentPackageToTParent, mPackage, tSub, typeGraph, mParentPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mPackageToTSub] = " + mPackageToTSub + ", " + "[tParent] = " + tParent + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_12_2_corematch_blackBFBBFB(tParent, tSub, typeGraph, match)) {
			PackageToTPackage mParentPackageToTParent = (PackageToTPackage) result2_black[1];
			org.eclipse.modisco.java.Package mParentPackage = (org.eclipse.modisco.java.Package) result2_black[4];
			// ForEach 
			for (Object[] result3_black : SubPackageToPGPackageImpl
					.pattern_SubPackageToPGPackage_12_3_findcontext_blackBBBBB(tParent, mParentPackageToTParent, tSub,
							typeGraph, mParentPackage)) {
				Object[] result3_green = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_12_3_findcontext_greenBBBBBFFFFFFF(tParent,
								mParentPackageToTParent, tSub, typeGraph, mParentPackage);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				//nothing EMoflonEdge tParent__typeGraph____typeGraph = (EMoflonEdge) result3_green[6];
				//nothing EMoflonEdge tParent__tSub____subpackage = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge tSub__tParent____parent = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mParentPackageToTParent__tParent____target = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge tSub__typeGraph____typeGraph = (EMoflonEdge) result3_green[10];
				...
				Object[] result4_bindingAndBlack = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
								tParent, mParentPackageToTParent, tSub, typeGraph, mParentPackage);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tParent] = " + tParent + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TPackage tParent,
			PackageToTPackage mParentPackageToTParent, TPackage tSub, TypeGraph typeGraph,
			org.eclipse.modisco.java.Package mParentPackage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mPackageToTSub, EObject tParent,
			EObject mParentPackageToTParent, EObject mPackage, EObject tSub, EObject typeGraph,
			EObject mParentPackage) {
		ruleresult.registerObject("mPackageToTSub", mPackageToTSub);
		ruleresult.registerObject("tParent", tParent);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_100(EMoflonEdge _edge_subpackage) {
		...
		// ForEach 
		for (Object[] result2_black : SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_blackFFFB(_edge_subpackage)) {
			TPackage tParent = (TPackage) result2_black[0];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_102(EMoflonEdge _edge_package) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		TPackage tParent = (TPackage) result2_bindingAndBlack[0];
		org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) result2_bindingAndBlack[1];
		TPackage tSub = (TPackage) result2_bindingAndBlack[2];
		TypeGraph typeGraph = (TypeGraph) result2_bindingAndBlack[3];
		org.eclipse.modisco.java.Package mParentPackage = (org.eclipse.modisco.java.Package) result2_bindingAndBlack[4];

		Object[] result3_bindingAndBlack = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, tParent, mPackage, tSub,
						typeGraph, mParentPackage, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tParent] = " + tParent + ", " + "[mPackage] = " + mPackage + ", " + "[tSub] = " + tSub + ", "
					+ "[typeGraph] = " + typeGraph + ", " + "[mParentPackage] = " + mParentPackage + ", "
		...
		if (SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : SubPackageToPGPackageImpl
				...
				Object[] result6_black = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_24_6_createcorrespondence_blackBBBBBB(tParent, mPackage, tSub,
								typeGraph, mParentPackage, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tParent] = " + tParent
							+ ", " + "[mPackage] = " + mPackage + ", " + "[tSub] = " + tSub + ", " + "[typeGraph] = "
							+ typeGraph + ", " + "[mParentPackage] = " + mParentPackage + ", " + "[ccMatch] = "
							+ ccMatch + ".");
				}
				SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_24_6_createcorrespondence_greenFBBB(mPackage,
						tSub, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TPackage tParent, org.eclipse.modisco.java.Package mPackage, TPackage tSub,
			TypeGraph typeGraph, org.eclipse.modisco.java.Package mParentPackage, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TPackage tParent, TPackage tSub, TypeGraph typeGraph) {// 
		Object[] result1_black = SubPackageToPGPackageImpl
		...
		for (Object[] result2_black : SubPackageToPGPackageImpl
			...
			if (SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_29_6_perform_greenFBFFBBBB(tParent,
					...
					//nothing TPackage tSub = (TPackage) result6_green[3];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SUB_PACKAGE_TO_PG_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPACKAGE_PACKAGETOTPACKAGE_PACKAGE_TYPEGRAPH_PACKAGE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TPackage) arguments.get(1),
					(PackageToTPackage) arguments.get(2), (org.eclipse.modisco.java.Package) arguments.get(3),
					(TypeGraph) arguments.get(4), (org.eclipse.modisco.java.Package) arguments.get(5));
		...
		case RulesPackage.SUB_PACKAGE_TO_PG_PACKAGE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPACKAGE_PACKAGETOTPACKAGE_TPACKAGE_TYPEGRAPH_PACKAGE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TPackage) arguments.get(1),
					(PackageToTPackage) arguments.get(2), (TPackage) arguments.get(3), (TypeGraph) arguments.get(4),
		...
		case RulesPackage.SUB_PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_100__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_100((EMoflonEdge) arguments.get(0));
		case RulesPackage.SUB_PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_102__EMOFLONEDGE:
		...
		case RulesPackage.SUB_PACKAGE_TO_PG_PACKAGE___IS_APPLICABLE_SOLVE_CSP_CC__TPACKAGE_PACKAGE_TPACKAGE_TYPEGRAPH_PACKAGE_MATCH_MATCH:
				...
				if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
					...
					if (tmpTypeGraph instanceof TypeGraph) {
						...
						if (tmpMParentPackage instanceof org.eclipse.modisco.java.Package) {
							...
							return new Object[] { tParent, mParentPackageToTParent, mPackage, typeGraph, mParentPackage,
									isApplicableMatch };
						}
					}
				}
		...
		if (!mPackage.equals(mParentPackage)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { tParent, mParentPackageToTParent, mPackage, typeGraph, mParentPackage, csp,
	...
	public static final Object[] pattern_SubPackageToPGPackage_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_SubPackageToPGPackage_1_1_performtransformation_binding != null) {
			...
			org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) result_pattern_SubPackageToPGPackage_1_1_performtransformation_binding[2];
			TypeGraph typeGraph = (TypeGraph) result_pattern_SubPackageToPGPackage_1_1_performtransformation_binding[3];
			org.eclipse.modisco.java.Package mParentPackage = (org.eclipse.modisco.java.Package) result_pattern_SubPackageToPGPackage_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_SubPackageToPGPackage_1_1_performtransformation_black = pattern_SubPackageToPGPackage_1_1_performtransformation_blackBBBBBFBB(
					tParent, mParentPackageToTParent, mPackage, typeGraph, mParentPackage, _this, isApplicableMatch);
			if (result_pattern_SubPackageToPGPackage_1_1_performtransformation_black != null) {
				...
				return new Object[] { tParent, mParentPackageToTParent, mPackage, typeGraph, mParentPackage, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_SubPackageToPGPackage_1_1_performtransformation_greenFBBFBB(TPackage tParent,
		...
		return new Object[] { mPackageToTSub, tParent, mPackage, tSub, typeGraph, csp };
	}

	public static final Object[] pattern_SubPackageToPGPackage_1_2_collecttranslatedelements_blackBBB(
			PackageToTPackage mPackageToTSub, org.eclipse.modisco.java.Package mPackage, TPackage tSub) {
		return new Object[] { mPackageToTSub, mPackage, tSub };
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_1_2_collecttranslatedelements_greenFBBB(
		...
		return new Object[] { ruleresult, mPackageToTSub, mPackage, tSub };
	}

	public static final Object[] pattern_SubPackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject mPackageToTSub, EObject tParent, EObject mParentPackageToTParent,
			EObject mPackage, EObject tSub, EObject typeGraph, EObject mParentPackage) {
	...
	public static final Object[] pattern_SubPackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject mPackageToTSub, EObject tParent, EObject mPackage, EObject tSub,
			EObject typeGraph, EObject mParentPackage) {
		...
		return new Object[] { ruleresult, mPackageToTSub, tParent, mPackage, tSub, typeGraph, mParentPackage,
				tParent__tSub____subpackage, tSub__tParent____parent, mPackageToTSub__mPackage____source,
				mPackage__mParentPackage____package, mParentPackage__mPackage____ownedPackages,
				mPackageToTSub__tSub____target, tSub__typeGraph____typeGraph };
	}

	public static final void pattern_SubPackageToPGPackage_1_5_registerobjects_expressionBBBBBBBBB(
			SubPackageToPGPackage _this, PerformRuleResult ruleresult, EObject mPackageToTSub, EObject tParent,
			EObject mParentPackageToTParent, EObject mPackage, EObject tSub, EObject typeGraph,
			EObject mParentPackage) {
		_this.registerObjects_FWD(ruleresult, mPackageToTSub, tParent, mParentPackageToTParent, mPackage, tSub,
				typeGraph, mParentPackage);
	...
	public static final Iterable<Object[]> pattern_SubPackageToPGPackage_2_2_corematch_blackFFBBB(
		...
		if (!mPackage.equals(mParentPackage)) {
			for (PackageToTPackage mParentPackageToTParent : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tParent != null) {
					_result.add(new Object[] { tParent, mParentPackageToTParent, mPackage, mParentPackage, match });
				}
	...
	public static final Iterable<Object[]> pattern_SubPackageToPGPackage_2_3_findcontext_blackBBBFB(TPackage tParent,
			PackageToTPackage mParentPackageToTParent, org.eclipse.modisco.java.Package mPackage,
			org.eclipse.modisco.java.Package mParentPackage) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mPackage.equals(mParentPackage)) {
			if (mParentPackage.equals(mPackage.getPackage())) {
				if (tParent.equals(mParentPackageToTParent.getTarget())) {
					if (mParentPackage.equals(mParentPackageToTParent.getSource())) {
						...
						if (typeGraph != null) {
							_result.add(new Object[] { tParent, mParentPackageToTParent, mPackage, typeGraph,
									mParentPackage });
						}
	...
	public static final Object[] pattern_SubPackageToPGPackage_2_3_findcontext_greenBBBBBFFFFFF(TPackage tParent,
		...
		return new Object[] { tParent, mParentPackageToTParent, mPackage, typeGraph, mParentPackage, isApplicableMatch,
				tParent__typeGraph____typeGraph, mPackage__mParentPackage____package,
				mParentPackage__mPackage____ownedPackages, mParentPackageToTParent__tParent____target,
				mParentPackageToTParent__mParentPackage____source };
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_2_4_solveCSP_bindingFBBBBBBB(SubPackageToPGPackage _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tParent, mParentPackageToTParent,
				mPackage, typeGraph, mParentPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParent, mParentPackageToTParent, mPackage, typeGraph,
					mParentPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_2_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_SubPackageToPGPackage_2_4_solveCSP_binding = pattern_SubPackageToPGPackage_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, tParent, mParentPackageToTParent, mPackage, typeGraph, mParentPackage);
		if (result_pattern_SubPackageToPGPackage_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_SubPackageToPGPackage_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tParent, mParentPackageToTParent, mPackage,
						typeGraph, mParentPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_SubPackageToPGPackage_11_1_performtransformation_bindingFFFFFB(
		...
		EObject _localVariable_0 = isApplicableMatch.getObject("tParent");
		EObject _localVariable_1 = isApplicableMatch.getObject("mParentPackageToTParent");
		EObject _localVariable_2 = isApplicableMatch.getObject("tSub");
		EObject _localVariable_3 = isApplicableMatch.getObject("typeGraph");
		EObject _localVariable_4 = isApplicableMatch.getObject("mParentPackage");
		EObject tmpTParent = _localVariable_0;
		EObject tmpMParentPackageToTParent = _localVariable_1;
			...
			if (tmpMParentPackageToTParent instanceof PackageToTPackage) {
				...
				if (tmpTSub instanceof TPackage) {
					...
					if (tmpTypeGraph instanceof TypeGraph) {
						...
						if (tmpMParentPackage instanceof org.eclipse.modisco.java.Package) {
							org.eclipse.modisco.java.Package mParentPackage = (org.eclipse.modisco.java.Package) tmpMParentPackage;
							return new Object[] { tParent, mParentPackageToTParent, tSub, typeGraph, mParentPackage,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_SubPackageToPGPackage_11_1_performtransformation_blackBBBBBFBB(
			TPackage tParent, PackageToTPackage mParentPackageToTParent, TPackage tSub, TypeGraph typeGraph,
			org.eclipse.modisco.java.Package mParentPackage, SubPackageToPGPackage _this,
			IsApplicableMatch isApplicableMatch) {
		if (!tParent.equals(tSub)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { tParent, mParentPackageToTParent, tSub, typeGraph, mParentPackage, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_SubPackageToPGPackage_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_SubPackageToPGPackage_11_1_performtransformation_binding != null) {
			...
			PackageToTPackage mParentPackageToTParent = (PackageToTPackage) result_pattern_SubPackageToPGPackage_11_1_performtransformation_binding[1];
			TPackage tSub = (TPackage) result_pattern_SubPackageToPGPackage_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_SubPackageToPGPackage_11_1_performtransformation_black = pattern_SubPackageToPGPackage_11_1_performtransformation_blackBBBBBFBB(
					tParent, mParentPackageToTParent, tSub, typeGraph, mParentPackage, _this, isApplicableMatch);
	...
	public static final Object[] pattern_SubPackageToPGPackage_11_1_performtransformation_greenFFBBB(TPackage tSub,
		...
		return new Object[] { mPackageToTSub, mPackage, tSub, mParentPackage, csp };
	}
	...
	public static final void pattern_SubPackageToPGPackage_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject mParentPackageToTParent, EObject mPackage, EObject tSub, EObject typeGraph,
			EObject mParentPackage) {
		_this.registerObjects_BWD(ruleresult, mPackageToTSub, tParent, mParentPackageToTParent, mPackage, tSub,
				typeGraph, mParentPackage);
	...
	public static final Iterable<Object[]> pattern_SubPackageToPGPackage_12_2_corematch_blackBFBBFB(TPackage tParent,
		...
		if (!tParent.equals(tSub)) {
			for (PackageToTPackage mParentPackageToTParent : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mParentPackage != null) {
					_result.add(
							new Object[] { tParent, mParentPackageToTParent, tSub, typeGraph, mParentPackage, match });
				}
				...
				if (tParent.getSubpackage().contains(tSub)) {
					if (tParent.equals(mParentPackageToTParent.getTarget())) {
						if (typeGraph.equals(tSub.getTypeGraph())) {
							if (mParentPackage.equals(mParentPackageToTParent.getSource())) {
								_result.add(new Object[] { tParent, mParentPackageToTParent, tSub, typeGraph,
										mParentPackage });
							}
						}
					}
	...
	public static final Object[] pattern_SubPackageToPGPackage_12_3_findcontext_greenBBBBBFFFFFFF(TPackage tParent,
		...
		mParentPackageToTParent__mParentPackage____source
				.setName(mParentPackageToTParent__mParentPackage____source_name_prime);
		return new Object[] { tParent, mParentPackageToTParent, tSub, typeGraph, mParentPackage, isApplicableMatch,
				tParent__typeGraph____typeGraph, tParent__tSub____subpackage, tSub__tParent____parent,
				mParentPackageToTParent__tParent____target, tSub__typeGraph____typeGraph,
				mParentPackageToTParent__mParentPackage____source };
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_12_4_solveCSP_bindingFBBBBBBB(
			...
			PackageToTPackage mParentPackageToTParent, TPackage tSub, TypeGraph typeGraph,
			org.eclipse.modisco.java.Package mParentPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tParent, mParentPackageToTParent,
				tSub, typeGraph, mParentPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParent, mParentPackageToTParent, tSub, typeGraph,
					mParentPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_SubPackageToPGPackage_12_4_solveCSP_binding = pattern_SubPackageToPGPackage_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, tParent, mParentPackageToTParent, tSub, typeGraph, mParentPackage);
	...
	public static final Object[] pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_0BB(TPackage tSub,
			TPackage tParent) {
		if (!tParent.equals(tSub)) {
			TPackage __DEC_tSub_parent_989650 = tSub.getParent();
			if (__DEC_tSub_parent_989650 != null) {
				if (!tSub.equals(__DEC_tSub_parent_989650)) {
					if (!tParent.equals(__DEC_tSub_parent_989650)) {
	...
	public static final Object[] pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_1BB(TPackage tSub,
			TypeGraph typeGraph) {
		TypeGraph __DEC_tSub_packages_24801 = tSub.getPg();
		if (__DEC_tSub_packages_24801 != null) {
			if (!typeGraph.equals(__DEC_tSub_packages_24801)) {
							...
							if (typeGraph.equals(tSub.getTypeGraph())) {
								if (pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_0BB(tSub,
									...
									if (pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_1BB(tSub,
											typeGraph) == null) {
										if (pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_2BB(
												typeGraph, tSub) == null) {
	...
	public static final Object[] pattern_SubPackageToPGPackage_21_2_testcorematchandDECs_black_nac_0B(
		...
		Model __DEC_mPackage_model_274269 = mPackage.getModel();
		if (__DEC_mPackage_model_274269 != null) {
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_bindingFFFFFBB(Match targetMatch,
			Match sourceMatch) {
		EObject _localVariable_0 = targetMatch.getObject("tParent");
		...
		EObject _localVariable_4 = sourceMatch.getObject("mParentPackage");
		EObject tmpTParent = _localVariable_0;
			...
			if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
				...
				if (tmpTSub instanceof TPackage) {
					...
					if (tmpTypeGraph instanceof TypeGraph) {
						...
						if (tmpMParentPackage instanceof org.eclipse.modisco.java.Package) {
							org.eclipse.modisco.java.Package mParentPackage = (org.eclipse.modisco.java.Package) tmpMParentPackage;
							return new Object[] { tParent, mPackage, tSub, typeGraph, mParentPackage, targetMatch,
									sourceMatch };
						}
					}
				}
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_blackBBBBBBB(TPackage tParent,
			org.eclipse.modisco.java.Package mPackage, TPackage tSub, TypeGraph typeGraph,
			org.eclipse.modisco.java.Package mParentPackage, Match sourceMatch, Match targetMatch) {
		if (!tParent.equals(tSub)) {
			if (!mPackage.equals(mParentPackage)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tParent, mPackage, tSub, typeGraph, mParentPackage, sourceMatch,
							targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_binding != null) {
			TPackage tParent = (TPackage) result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_binding[0];
			org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_binding[1];
			TPackage tSub = (TPackage) result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_binding[2];
			TypeGraph typeGraph = (TypeGraph) result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_binding[3];
			org.eclipse.modisco.java.Package mParentPackage = (org.eclipse.modisco.java.Package) result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_black = pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_blackBBBBBBB(
					tParent, mPackage, tSub, typeGraph, mParentPackage, sourceMatch, targetMatch);
			if (result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { tParent, mPackage, tSub, typeGraph, mParentPackage, sourceMatch, targetMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_3_solvecsp_bindingFBBBBBBBB(
			SubPackageToPGPackage _this, TPackage tParent, org.eclipse.modisco.java.Package mPackage, TPackage tSub,
			TypeGraph typeGraph, org.eclipse.modisco.java.Package mParentPackage, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(tParent, mPackage, tSub, typeGraph, mParentPackage,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, tParent, mPackage, tSub, typeGraph, mParentPackage, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_SubPackageToPGPackage_24_3_solvecsp_binding = pattern_SubPackageToPGPackage_24_3_solvecsp_bindingFBBBBBBBB(
				_this, tParent, mPackage, tSub, typeGraph, mParentPackage, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_6_createcorrespondence_blackBBBBBB(TPackage tParent,
			org.eclipse.modisco.java.Package mPackage, TPackage tSub, TypeGraph typeGraph,
			org.eclipse.modisco.java.Package mParentPackage, CCMatch ccMatch) {
		if (!tParent.equals(tSub)) {
			if (!mPackage.equals(mParentPackage)) {
				return new Object[] { tParent, mPackage, tSub, typeGraph, mParentPackage, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_6_createcorrespondence_greenFBBB(
		...
		return new Object[] { mPackageToTSub, mPackage, tSub, ccMatch };
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Package mPackage) {
		Model __DEC_mPackage_model_314651 = mPackage.getModel();
		if (__DEC_mPackage_model_314651 != null) {
			return new Object[] { mPackage };
		}
	...
	public static final Object[] pattern_SubPackageToPGPackage_28_1_matchtggpattern_black_nac_0BB(TPackage tSub,
			TPackage tParent) {
		if (!tParent.equals(tSub)) {
			TPackage __DEC_tSub_parent_518549 = tSub.getParent();
			if (__DEC_tSub_parent_518549 != null) {
				if (!tSub.equals(__DEC_tSub_parent_518549)) {
					if (!tParent.equals(__DEC_tSub_parent_518549)) {
						return new Object[] { tSub, tParent };
					}
				}
			}
	...
	public static final Object[] pattern_SubPackageToPGPackage_28_1_matchtggpattern_black_nac_1BB(TPackage tSub,
			TypeGraph typeGraph) {
		TypeGraph __DEC_tSub_packages_404771 = tSub.getPg();
		if (__DEC_tSub_packages_404771 != null) {
			if (!typeGraph.equals(__DEC_tSub_packages_404771)) {
				return new Object[] { tSub, typeGraph };
			}
		}
	...
	public static final Object[] pattern_SubPackageToPGPackage_29_6_perform_greenFBFFBBBB(TPackage tParent,
		...
		return new Object[] { mPackageToTSub, tParent, mPackage, tSub, typeGraph, mParentPackage, ruleResult, csp };
	}
