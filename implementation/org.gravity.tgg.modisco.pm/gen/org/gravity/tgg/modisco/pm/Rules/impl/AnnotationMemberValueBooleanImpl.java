...
public class AnnotationMemberValueBooleanImpl extends AbstractRuleImpl implements AnnotationMemberValueBoolean {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.ANNOTATION_MEMBER_VALUE_BOOLEAN___IS_APPROPRIATE_BWD_EMOFLON_EDGE_15__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_15((EMoflonEdge) arguments.get(0));
			case RulesPackage.ANNOTATION_MEMBER_VALUE_BOOLEAN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_16__EMOFLONEDGE:
