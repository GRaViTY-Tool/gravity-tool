...
public class SuperConstructorInvocationImpl extends AbstractRuleImpl implements SuperConstructorInvocation {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SUPER_CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_31__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_31((EMoflonEdge) arguments.get(0));
		case RulesPackage.SUPER_CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_32__EMOFLONEDGE:
	...
	public static final Object[] pattern_SuperConstructorInvocation_21_2_testcorematchandDECs_black_nac_0BB(
			MSuperConstructorInvocation invocation, MDefinition mMember) {
		for (MDefinition __DEC_invocation_mMethodInvocations_477515 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_477515)) {
	...
	public static final Object[] pattern_SuperConstructorInvocation_27_1_matchtggpattern_black_nac_0BB(
			MSuperConstructorInvocation invocation, MDefinition mMember) {
		for (MDefinition __DEC_invocation_mMethodInvocations_944101 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_944101)) {
				return new Object[] { invocation, mMember };
			}
		}
		return null;
