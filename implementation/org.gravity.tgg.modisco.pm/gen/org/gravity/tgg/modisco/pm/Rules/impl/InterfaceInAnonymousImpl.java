...
public class InterfaceInAnonymousImpl extends AbstractRuleImpl implements InterfaceInAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_1_1_performtransformation_greenBBBFFFFB(tClass, mNestedType, pg, csp);
		...
		Object[] result2_black = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_1_2_collecttranslatedelements_blackBBBBB(mNestedType, mbodyToTAnnotatable,
						tNestedType, mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType);
		...
		Object[] result2_green = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_1_2_collecttranslatedelements_greenFBBBBB(mNestedType,
						mbodyToTAnnotatable, tNestedType, mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType);
		...
		Object[] result3_black = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tClass, mNestedType,
						pg, mbodyToTAnnotatable, tNestedType, mInterfaceDeclarationtoTInterface,
		...
		InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFF(
				ruleresult, tClass, mNestedType, pg, mbodyToTAnnotatable, tNestedType,
				mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType, eAnonymousClassDeclaration);
		//nothing EMoflonEdge mbodyToTAnnotatable__mNestedType____source = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge pg__tNestedType____interfaces = (EMoflonEdge) result3_green[10];
		...
		//nothing EMoflonEdge mInterfaceDeclarationtoTInterface__tNestedType____target = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge mNestedTypeToTNestedType__mNestedType____source = (EMoflonEdge) result3_green[14];
		//nothing EMoflonEdge mInterfaceDeclarationtoTInterface__mNestedType____source = (EMoflonEdge) result3_green[15];
		//nothing EMoflonEdge mbodyToTAnnotatable__tNestedType____target = (EMoflonEdge) result3_green[16];
		//nothing EMoflonEdge mNestedTypeToTNestedType__tNestedType____target = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge pg__tNestedType____ownedTypes = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge tNestedType__pg____pg = (EMoflonEdge) result3_green[19];
		...
		InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tClass, mNestedType, pg, mbodyToTAnnotatable, tNestedType,
				mInterfaceDeclarationtoTInterface, eAnonymousClassDeclarationToTClass, mNestedTypeToTNestedType,
				eAnonymousClassDeclaration);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_2_2_corematch_blackFBFBB(
			...
			for (Object[] result3_black : InterfaceInAnonymousImpl
					.pattern_InterfaceInAnonymous_2_3_findcontext_blackBBFBB(tClass, mNestedType,
				...
				Object[] result3_green = InterfaceInAnonymousImpl
						.pattern_InterfaceInAnonymous_2_3_findcontext_greenBBBBBFFFFFFFF(tClass, mNestedType, pg,
								eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration);
				...
				Object[] result4_bindingAndBlack = InterfaceInAnonymousImpl
						.pattern_InterfaceInAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TClass tClass,
			InterfaceDeclaration mNestedType, TypeGraph pg,
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TClass tClass, TypeGraph pg, TInterface tNestedType) {

		Object[] result1_black = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_10_1_initialbindings_blackBBBBB(this, match, tClass, pg, tNestedType);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, tClass, pg, tNestedType);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tClass] = " + tClass + ", " + "[pg] = " + pg + ", "
					+ "[tNestedType] = " + tNestedType + ".");
		...
		if (InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = InterfaceInAnonymousImpl
					.pattern_InterfaceInAnonymous_10_4_collectelementstobetranslated_blackBBBB(match, tClass, pg,
							tNestedType);
			if (result4_black == null) {
				throw new RuntimeException(
			...
			//nothing EMoflonEdge tNestedType__pg____pg = (EMoflonEdge) result4_green[8];

			Object[] result5_black = InterfaceInAnonymousImpl
					.pattern_InterfaceInAnonymous_10_5_collectcontextelements_blackBBBB(match, tClass, pg, tNestedType);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[tClass] = "
								+ tClass + ", " + "[pg] = " + pg + ", " + "[tNestedType] = " + tNestedType + ".");
			}
			InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_10_5_collectcontextelements_greenBBBFFF(match, tClass,
					pg);
			...
			// 
			InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_10_6_registerobjectstomatch_expressionBBBBB(this,
					match, tClass, pg, tNestedType);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_11_1_performtransformation_bindingAndBlackFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_11_1_performtransformation_greenFFBFFBB(tNestedType,
		...
		InterfaceDeclarationToTInterface mInterfaceDeclarationtoTInterface = (InterfaceDeclarationToTInterface) result1_green[3];
		TypeToTAbstractType mNestedTypeToTNestedType = (TypeToTAbstractType) result1_green[4];

		Object[] result2_black = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_11_2_collecttranslatedelements_blackBBBBB(mNestedType,
						mbodyToTAnnotatable, tNestedType, mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mNestedType] = " + mNestedType
					+ ", " + "[mbodyToTAnnotatable] = " + mbodyToTAnnotatable + ", " + "[tNestedType] = " + tNestedType
		...
		Object[] result2_green = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_11_2_collecttranslatedelements_greenFBBBBB(mNestedType,
						mbodyToTAnnotatable, tNestedType, mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFF(
				ruleresult, tClass, mNestedType, pg, mbodyToTAnnotatable, tNestedType,
				mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType, eAnonymousClassDeclaration);
		//nothing EMoflonEdge mbodyToTAnnotatable__mNestedType____source = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge pg__tNestedType____interfaces = (EMoflonEdge) result3_green[10];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_12_2_corematch_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_12_2_corematch_blackBBBFFB(tClass, pg, tNestedType, match)) {
			...
			// ForEach 
			for (Object[] result3_black : InterfaceInAnonymousImpl
					.pattern_InterfaceInAnonymous_12_3_findcontext_blackBBBBB(tClass, pg, tNestedType,
							eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration)) {
				Object[] result3_green = InterfaceInAnonymousImpl
						.pattern_InterfaceInAnonymous_12_3_findcontext_greenBBBBBFFFFFFFFFFF(tClass, pg, tNestedType,
								eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				//nothing EMoflonEdge pg__tClass____classes = (EMoflonEdge) result3_green[6];
				//nothing EMoflonEdge eAnonymousClassDeclarationToTClass__tClass____target = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge pg__tNestedType____interfaces = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge eAnonymousClassDeclarationToTClass__eAnonymousClassDeclaration____source = (EMoflonEdge) result3_green[9];
				...
				//nothing EMoflonEdge tClass__pg____pg = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge pg__tNestedType____ownedTypes = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge tNestedType__pg____pg = (EMoflonEdge) result3_green[15];

				Object[] result4_bindingAndBlack = InterfaceInAnonymousImpl
						.pattern_InterfaceInAnonymous_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
								tClass, pg, tNestedType, eAnonymousClassDeclarationToTClass,
								eAnonymousClassDeclaration);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tClass] = " + tClass + ", "
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TClass tClass, TypeGraph pg, TInterface tNestedType) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TClass tClass, TypeGraph pg, TInterface tNestedType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_156(EMoflonEdge _edge_interfaces) {
		...
		// ForEach 
		for (Object[] result2_black : InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_blackFFFB(_edge_interfaces)) {
			TClass tClass = (TClass) result2_black[0];
			...
			if (InterfaceInAnonymousImpl
					.pattern_InterfaceInAnonymous_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, tClass, pg, tNestedType)) {
				// 
				if (InterfaceInAnonymousImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_160(EMoflonEdge _edge_anonymousClassDeclarationOwner) {
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(TripleMatch __tripleMatch) {
		...
		eq0.setRuleName("InterfaceInAnonymous");
		eq0.solve(var_mNestedType_name, var_tNestedType_tName);

		eq1.setRuleName("InterfaceInAnonymous");
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result3_bindingAndBlack = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, tClass, mNestedType, pg,
		...
		if (InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceInAnonymousImpl
				...
				Object[] result6_black = InterfaceInAnonymousImpl
						.pattern_InterfaceInAnonymous_24_6_createcorrespondence_blackBBBBBB(tClass, mNestedType, pg,
				...
				InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_24_6_createcorrespondence_greenBFBFFB(mNestedType,
						tNestedType, ccMatch);
				...
				//nothing TypeToTAbstractType mNestedTypeToTNestedType = (TypeToTAbstractType) result6_green[4];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TClass tClass, InterfaceDeclaration mNestedType, TypeGraph pg,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TClass tClass, TypeGraph pg, TInterface tNestedType) {// 
		Object[] result1_black = InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_28_1_matchtggpattern_blackBBB(tClass, pg, tNestedType);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		// ForEach 
		for (Object[] result2_black : InterfaceInAnonymousImpl
				.pattern_InterfaceInAnonymous_29_2_isapplicablecore_blackFFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			Object[] result3_bindingAndBlack = InterfaceInAnonymousImpl
					.pattern_InterfaceInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, tClass,
			...
			if (InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_29_5_checknacs_blackBBBB(
						tClass, pg, eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration);
				if (result5_black != null) {

					Object[] result6_black = InterfaceInAnonymousImpl
							.pattern_InterfaceInAnonymous_29_6_perform_blackBBBBB(tClass, pg,
					...
					InterfaceInAnonymousImpl.pattern_InterfaceInAnonymous_29_6_perform_greenBFBFFFFBBB(tClass, pg,
					...
					//nothing InterfaceDeclarationToTInterface mInterfaceDeclarationtoTInterface = (InterfaceDeclarationToTInterface) result6_green[5];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TCLASS_INTERFACEDECLARATION_TYPEGRAPH_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TClass) arguments.get(1),
					(InterfaceDeclaration) arguments.get(2), (TypeGraph) arguments.get(3),
		...
		case RulesPackage.INTERFACE_IN_ANONYMOUS___IS_APPROPRIATE_BWD__MATCH_TCLASS_TYPEGRAPH_TINTERFACE:
		...
		case RulesPackage.INTERFACE_IN_ANONYMOUS___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TCLASS_TYPEGRAPH_TINTERFACE:
			...
			return null;
		case RulesPackage.INTERFACE_IN_ANONYMOUS___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TCLASS_TYPEGRAPH_TINTERFACE:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (TClass) arguments.get(1),
					(TypeGraph) arguments.get(2), (TInterface) arguments.get(3));
		case RulesPackage.INTERFACE_IN_ANONYMOUS___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.INTERFACE_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TCLASS_TYPEGRAPH_TINTERFACE_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION:
		...
		case RulesPackage.INTERFACE_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_156__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_156((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_160__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__TCLASS_INTERFACEDECLARATION_TYPEGRAPH_TINTERFACE_ANONYMOUSCLASSDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.INTERFACE_IN_ANONYMOUS___CHECK_DEC_BWD__TCLASS_TYPEGRAPH_TINTERFACE:
			return checkDEC_BWD((TClass) arguments.get(0), (TypeGraph) arguments.get(1), (TInterface) arguments.get(2));
		...
		case RulesPackage.INTERFACE_IN_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TCLASS_TYPEGRAPH_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_InterfaceInAnonymous_1_1_performtransformation_bindingFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_1_1_performtransformation_blackBBBBBFBB(TClass tClass,
			InterfaceDeclaration mNestedType, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
	...
	public static final Object[] pattern_InterfaceInAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFBB(
			InterfaceInAnonymous _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_InterfaceInAnonymous_1_1_performtransformation_binding = pattern_InterfaceInAnonymous_1_1_performtransformation_bindingFFFFFB(
				isApplicableMatch);
		if (result_pattern_InterfaceInAnonymous_1_1_performtransformation_binding != null) {
			...
			TypeGraph pg = (TypeGraph) result_pattern_InterfaceInAnonymous_1_1_performtransformation_binding[2];
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass = (AnonymousClassDeclarationToTClass) result_pattern_InterfaceInAnonymous_1_1_performtransformation_binding[3];
			AnonymousClassDeclaration eAnonymousClassDeclaration = (AnonymousClassDeclaration) result_pattern_InterfaceInAnonymous_1_1_performtransformation_binding[4];

			Object[] result_pattern_InterfaceInAnonymous_1_1_performtransformation_black = pattern_InterfaceInAnonymous_1_1_performtransformation_blackBBBBBFBB(
			...
			if (result_pattern_InterfaceInAnonymous_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_InterfaceInAnonymous_1_1_performtransformation_black[5];
	...
	public static final Object[] pattern_InterfaceInAnonymous_1_1_performtransformation_greenBBBFFFFB(TClass tClass,
		...
		mInterfaceDeclarationtoTInterface.setSource(mNestedType);
		...
		return new Object[] { tClass, mNestedType, pg, mbodyToTAnnotatable, tNestedType,
				mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType, csp };
	}

	public static final Object[] pattern_InterfaceInAnonymous_1_2_collecttranslatedelements_blackBBBBB(
			InterfaceDeclaration mNestedType, ASTNodeToTAnnotatable mbodyToTAnnotatable, TInterface tNestedType,
			InterfaceDeclarationToTInterface mInterfaceDeclarationtoTInterface,
			TypeToTAbstractType mNestedTypeToTNestedType) {
		return new Object[] { mNestedType, mbodyToTAnnotatable, tNestedType, mInterfaceDeclarationtoTInterface,
				mNestedTypeToTNestedType };
	}

	public static final Object[] pattern_InterfaceInAnonymous_1_2_collecttranslatedelements_greenFBBBBB(
			InterfaceDeclaration mNestedType, ASTNodeToTAnnotatable mbodyToTAnnotatable, TInterface tNestedType,
			InterfaceDeclarationToTInterface mInterfaceDeclarationtoTInterface,
			TypeToTAbstractType mNestedTypeToTNestedType) {
		...
		return new Object[] { ruleresult, mNestedType, mbodyToTAnnotatable, tNestedType,
				mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType };
	}
	...
	public static final Object[] pattern_InterfaceInAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject tNestedType, EObject mInterfaceDeclarationtoTInterface, EObject eAnonymousClassDeclarationToTClass,
										...
										if (!mbodyToTAnnotatable.equals(tClass)) {
											if (!mbodyToTAnnotatable.equals(pg)) {
												if (!mbodyToTAnnotatable.equals(tNestedType)) {
													if (!mInterfaceDeclarationtoTInterface.equals(tClass)) {
														if (!mInterfaceDeclarationtoTInterface.equals(mNestedType)) {
															if (!mInterfaceDeclarationtoTInterface.equals(pg)) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tClass, EObject mNestedType, EObject pg, EObject mbodyToTAnnotatable,
			EObject tNestedType, EObject mInterfaceDeclarationtoTInterface, EObject mNestedTypeToTNestedType,
			EObject eAnonymousClassDeclaration) {
		...
		EMoflonEdge mInterfaceDeclarationtoTInterface__mNestedType____source = RuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		...
		String mInterfaceDeclarationtoTInterface__mNestedType____source_name_prime = "source";
		...
		mInterfaceDeclarationtoTInterface__mNestedType____source.setSrc(mInterfaceDeclarationtoTInterface);
		mInterfaceDeclarationtoTInterface__mNestedType____source.setTrg(mNestedType);
		ruleresult.getCreatedEdges().add(mInterfaceDeclarationtoTInterface__mNestedType____source);
		...
		mInterfaceDeclarationtoTInterface__mNestedType____source
				.setName(mInterfaceDeclarationtoTInterface__mNestedType____source_name_prime);
		...
		return new Object[] { ruleresult, tClass, mNestedType, pg, mbodyToTAnnotatable, tNestedType,
				mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType, eAnonymousClassDeclaration,
				mbodyToTAnnotatable__mNestedType____source, pg__tNestedType____interfaces,
				tClass__tNestedType____innerTypes, tNestedType__tClass____outerType,
				mInterfaceDeclarationtoTInterface__tNestedType____target,
				mNestedTypeToTNestedType__mNestedType____source,
				mInterfaceDeclarationtoTInterface__mNestedType____source, mbodyToTAnnotatable__tNestedType____target,
				mNestedTypeToTNestedType__tNestedType____target, pg__tNestedType____ownedTypes, tNestedType__pg____pg,
				mNestedType__eAnonymousClassDeclaration____anonymousClassDeclarationOwner,
				eAnonymousClassDeclaration__mNestedType____bodyDeclarations };
	}

	public static final void pattern_InterfaceInAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(
			InterfaceInAnonymous _this, PerformRuleResult ruleresult, EObject tClass, EObject mNestedType, EObject pg,
			EObject mbodyToTAnnotatable, EObject tNestedType, EObject mInterfaceDeclarationtoTInterface,
			EObject eAnonymousClassDeclarationToTClass, EObject mNestedTypeToTNestedType,
			EObject eAnonymousClassDeclaration) {
	...
	public static final Iterable<Object[]> pattern_InterfaceInAnonymous_2_3_findcontext_blackBBFBB(TClass tClass,
	...
	public static final Object[] pattern_InterfaceInAnonymous_2_3_findcontext_greenBBBBBFFFFFFFF(TClass tClass,
			InterfaceDeclaration mNestedType, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		...
		return new Object[] { tClass, mNestedType, pg, eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration,
				...
				tClass__pg____pg, mNestedType__eAnonymousClassDeclaration____anonymousClassDeclarationOwner,
				eAnonymousClassDeclaration__mNestedType____bodyDeclarations };
	}

	public static final Object[] pattern_InterfaceInAnonymous_2_4_solveCSP_bindingFBBBBBBB(InterfaceInAnonymous _this,
			IsApplicableMatch isApplicableMatch, TClass tClass, InterfaceDeclaration mNestedType, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBB(
			InterfaceInAnonymous _this, IsApplicableMatch isApplicableMatch, TClass tClass,
			InterfaceDeclaration mNestedType, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		Object[] result_pattern_InterfaceInAnonymous_2_4_solveCSP_binding = pattern_InterfaceInAnonymous_2_4_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_InterfaceInAnonymous_10_1_initialbindings_blackBBBBB(
			InterfaceInAnonymous _this, Match match, TClass tClass, TypeGraph pg, TInterface tNestedType) {
		return new Object[] { _this, match, tClass, pg, tNestedType };
	}

	public static final Object[] pattern_InterfaceInAnonymous_10_2_SolveCSP_bindingFBBBBB(InterfaceInAnonymous _this,
	...
	public static final Object[] pattern_InterfaceInAnonymous_10_2_SolveCSP_bindingAndBlackFBBBBB(
			InterfaceInAnonymous _this, Match match, TClass tClass, TypeGraph pg, TInterface tNestedType) {
		Object[] result_pattern_InterfaceInAnonymous_10_2_SolveCSP_binding = pattern_InterfaceInAnonymous_10_2_SolveCSP_bindingFBBBBB(
	...
	public static final Object[] pattern_InterfaceInAnonymous_10_4_collectelementstobetranslated_blackBBBB(Match match,
			TClass tClass, TypeGraph pg, TInterface tNestedType) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_10_5_collectcontextelements_blackBBBB(Match match,
			TClass tClass, TypeGraph pg, TInterface tNestedType) {
		return new Object[] { match, tClass, pg, tNestedType };
	}

	public static final Object[] pattern_InterfaceInAnonymous_10_5_collectcontextelements_greenBBBFFF(Match match,
	...
	public static final void pattern_InterfaceInAnonymous_10_6_registerobjectstomatch_expressionBBBBB(
			InterfaceInAnonymous _this, Match match, TClass tClass, TypeGraph pg, TInterface tNestedType) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_11_1_performtransformation_bindingFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("tClass");
	...
	public static final Object[] pattern_InterfaceInAnonymous_11_1_performtransformation_blackBBBBBFBB(TClass tClass,
	...
	public static final Object[] pattern_InterfaceInAnonymous_11_1_performtransformation_bindingAndBlackFFFFFFBB(
			InterfaceInAnonymous _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_InterfaceInAnonymous_11_1_performtransformation_binding = pattern_InterfaceInAnonymous_11_1_performtransformation_bindingFFFFFB(
				isApplicableMatch);
		if (result_pattern_InterfaceInAnonymous_11_1_performtransformation_binding != null) {
			...
			TypeGraph pg = (TypeGraph) result_pattern_InterfaceInAnonymous_11_1_performtransformation_binding[1];
			TInterface tNestedType = (TInterface) result_pattern_InterfaceInAnonymous_11_1_performtransformation_binding[2];
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass = (AnonymousClassDeclarationToTClass) result_pattern_InterfaceInAnonymous_11_1_performtransformation_binding[3];
			AnonymousClassDeclaration eAnonymousClassDeclaration = (AnonymousClassDeclaration) result_pattern_InterfaceInAnonymous_11_1_performtransformation_binding[4];

			Object[] result_pattern_InterfaceInAnonymous_11_1_performtransformation_black = pattern_InterfaceInAnonymous_11_1_performtransformation_blackBBBBBFBB(
			...
			if (result_pattern_InterfaceInAnonymous_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_InterfaceInAnonymous_11_1_performtransformation_black[5];
	...
	public static final Object[] pattern_InterfaceInAnonymous_11_1_performtransformation_greenFFBFFBB(
		...
		return new Object[] { mNestedType, mbodyToTAnnotatable, tNestedType, mInterfaceDeclarationtoTInterface,
				mNestedTypeToTNestedType, eAnonymousClassDeclaration, csp };
	}

	public static final Object[] pattern_InterfaceInAnonymous_11_2_collecttranslatedelements_blackBBBBB(
			InterfaceDeclaration mNestedType, ASTNodeToTAnnotatable mbodyToTAnnotatable, TInterface tNestedType,
			InterfaceDeclarationToTInterface mInterfaceDeclarationtoTInterface,
			TypeToTAbstractType mNestedTypeToTNestedType) {
		return new Object[] { mNestedType, mbodyToTAnnotatable, tNestedType, mInterfaceDeclarationtoTInterface,
	...
	public static final Object[] pattern_InterfaceInAnonymous_11_2_collecttranslatedelements_greenFBBBBB(
			InterfaceDeclaration mNestedType, ASTNodeToTAnnotatable mbodyToTAnnotatable, TInterface tNestedType,
			InterfaceDeclarationToTInterface mInterfaceDeclarationtoTInterface,
			TypeToTAbstractType mNestedTypeToTNestedType) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_InterfaceInAnonymous_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tClass, EObject mNestedType, EObject pg, EObject mbodyToTAnnotatable,
			EObject tNestedType, EObject mInterfaceDeclarationtoTInterface, EObject mNestedTypeToTNestedType,
			EObject eAnonymousClassDeclaration) {
		EMoflonEdge mbodyToTAnnotatable__mNestedType____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_InterfaceInAnonymous_12_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_InterfaceInAnonymous_12_2_corematch_blackBBBFFB(TClass tClass,
			TypeGraph pg, TInterface tNestedType, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_InterfaceInAnonymous_12_3_findcontext_blackBBBBB(TClass tClass,
			TypeGraph pg, TInterface tNestedType, AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (pg.getClasses().contains(tClass)) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_12_3_findcontext_greenBBBBBFFFFFFFFFFF(TClass tClass,
			TypeGraph pg, TInterface tNestedType, AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge pg__tClass____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { tClass, pg, tNestedType, eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration,
				...
				tClass__pg____pg, pg__tNestedType____ownedTypes, tNestedType__pg____pg };
	}

	public static final Object[] pattern_InterfaceInAnonymous_12_4_solveCSP_bindingFBBBBBBB(InterfaceInAnonymous _this,
			IsApplicableMatch isApplicableMatch, TClass tClass, TypeGraph pg, TInterface tNestedType,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_12_4_solveCSP_bindingAndBlackFBBBBBBB(
			InterfaceInAnonymous _this, IsApplicableMatch isApplicableMatch, TClass tClass, TypeGraph pg,
			TInterface tNestedType, AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		Object[] result_pattern_InterfaceInAnonymous_12_4_solveCSP_binding = pattern_InterfaceInAnonymous_12_4_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_black_nac_0B(
			TInterface tNestedType) {
		for (TPackage __DEC_tNestedType_interfaces_921206 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_black_nac_1BB(
		...
		for (TypeGraph __DEC_tNestedType_interfaces_114153 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tNestedType_interfaces_114153)) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_black_nac_2B(
			TInterface tNestedType) {
		TPackage __DEC_tNestedType_ownedTypes_445500 = tNestedType.getPackage();
		if (__DEC_tNestedType_ownedTypes_445500 != null) {
			return new Object[] { tNestedType };
		}
	...
	public static final Object[] pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_black_nac_3BB(
		...
		TAbstractType __DEC_tNestedType_innerTypes_774795 = tNestedType.getOuterType();
		if (__DEC_tNestedType_innerTypes_774795 != null) {
			if (!tNestedType.equals(__DEC_tNestedType_innerTypes_774795)) {
				if (!tClass.equals(__DEC_tNestedType_innerTypes_774795)) {
	...
	public static final Iterable<Object[]> pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_blackFFFB(
				...
				if (pg.getInterfaces().contains(tNestedType)) {
					if (pg.getOwnedTypes().contains(tNestedType)) {
						...
						if (tmpTClass instanceof TClass) {
							...
							if (pg.getClasses().contains(tClass)) {
								if (pg.getOwnedTypes().contains(tClass)) {
									if (pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_black_nac_0B(
											tNestedType) == null) {
										if (pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_black_nac_1BB(
												tNestedType, pg) == null) {
											if (pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_black_nac_2B(
													tNestedType) == null) {
												if (pattern_InterfaceInAnonymous_20_2_testcorematchandDECs_black_nac_3BB(
														tNestedType, tClass) == null) {
													_result.add(
															new Object[] { tClass, pg, tNestedType, _edge_interfaces });
												}
											}
										}
									}
	...
	public static final boolean pattern_InterfaceInAnonymous_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			InterfaceInAnonymous _this, Match match, TClass tClass, TypeGraph pg, TInterface tNestedType) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_21_2_testcorematchandDECs_black_nac_0B(
		...
		AbstractTypeDeclaration __DEC_mNestedType_abstractTypeDeclaration_563271 = mNestedType
				.getAbstractTypeDeclaration();
		if (__DEC_mNestedType_abstractTypeDeclaration_563271 != null) {
			if (!mNestedType.equals(__DEC_mNestedType_abstractTypeDeclaration_563271)) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_21_2_testcorematchandDECs_black_nac_1B(
			InterfaceDeclaration mNestedType) {
		for (Model __DEC_mNestedType_orphanTypes_88535 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceInAnonymous_21_2_testcorematchandDECs_black_nac_2B(
			InterfaceDeclaration mNestedType) {
		org.eclipse.modisco.java.Package __DEC_mNestedType_ownedElements_216832 = mNestedType.getPackage();
		if (__DEC_mNestedType_ownedElements_216832 != null) {
			return new Object[] { mNestedType };
		}
	...
	public static final Object[] pattern_InterfaceInAnonymous_21_2_testcorematchandDECs_black_nac_3B(
			InterfaceDeclaration mNestedType) {
		for (MAbstractMethodDefinition __DEC_mNestedType_mInnerTypes_105558 : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (pattern_InterfaceInAnonymous_21_2_testcorematchandDECs_black_nac_0B(mNestedType) == null) {
						if (pattern_InterfaceInAnonymous_21_2_testcorematchandDECs_black_nac_1B(mNestedType) == null) {
							if (pattern_InterfaceInAnonymous_21_2_testcorematchandDECs_black_nac_2B(
									mNestedType) == null) {
								if (pattern_InterfaceInAnonymous_21_2_testcorematchandDECs_black_nac_3B(
										mNestedType) == null) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_bindingFFFFFBB(Match targetMatch,
			Match sourceMatch) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_blackBBBBBBB(TClass tClass,
			InterfaceDeclaration mNestedType, TypeGraph pg, TInterface tNestedType,
	...
	public static final Object[] pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_binding = pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_bindingFFFFFBB(
				targetMatch, sourceMatch);
		if (result_pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			TypeGraph pg = (TypeGraph) result_pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_binding[2];
			TInterface tNestedType = (TInterface) result_pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_binding[3];
			AnonymousClassDeclaration eAnonymousClassDeclaration = (AnonymousClassDeclaration) result_pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_binding[4];

			Object[] result_pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_black = pattern_InterfaceInAnonymous_24_2_matchsrctrgcontext_blackBBBBBBB(
	...
	public static final Object[] pattern_InterfaceInAnonymous_24_3_solvecsp_bindingFBBBBBBBB(InterfaceInAnonymous _this,
			TClass tClass, InterfaceDeclaration mNestedType, TypeGraph pg, TInterface tNestedType,
			AnonymousClassDeclaration eAnonymousClassDeclaration, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
			InterfaceInAnonymous _this, TClass tClass, InterfaceDeclaration mNestedType, TypeGraph pg,
			TInterface tNestedType, AnonymousClassDeclaration eAnonymousClassDeclaration, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_InterfaceInAnonymous_24_3_solvecsp_binding = pattern_InterfaceInAnonymous_24_3_solvecsp_bindingFBBBBBBBB(
	...
	public static final Object[] pattern_InterfaceInAnonymous_24_6_createcorrespondence_blackBBBBBB(TClass tClass,
			InterfaceDeclaration mNestedType, TypeGraph pg, TInterface tNestedType,
	...
	public static final Object[] pattern_InterfaceInAnonymous_24_6_createcorrespondence_greenBFBFFB(
		...
		return new Object[] { mNestedType, mbodyToTAnnotatable, tNestedType, mInterfaceDeclarationtoTInterface,
				mNestedTypeToTNestedType, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceInAnonymous_27_1_matchtggpattern_black_nac_0B(
			InterfaceDeclaration mNestedType) {
		AbstractTypeDeclaration __DEC_mNestedType_abstractTypeDeclaration_506526 = mNestedType
				.getAbstractTypeDeclaration();
		if (__DEC_mNestedType_abstractTypeDeclaration_506526 != null) {
			if (!mNestedType.equals(__DEC_mNestedType_abstractTypeDeclaration_506526)) {
				return new Object[] { mNestedType };
			}
		}
	...
	public static final Object[] pattern_InterfaceInAnonymous_27_1_matchtggpattern_black_nac_1B(
			InterfaceDeclaration mNestedType) {
		for (Model __DEC_mNestedType_orphanTypes_221376 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mNestedType, Model.class, "orphanTypes")) {
			return new Object[] { mNestedType };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceInAnonymous_27_1_matchtggpattern_black_nac_2B(
			InterfaceDeclaration mNestedType) {
		org.eclipse.modisco.java.Package __DEC_mNestedType_ownedElements_959622 = mNestedType.getPackage();
		if (__DEC_mNestedType_ownedElements_959622 != null) {
			return new Object[] { mNestedType };
		}
	...
	public static final Object[] pattern_InterfaceInAnonymous_27_1_matchtggpattern_black_nac_3B(
			InterfaceDeclaration mNestedType) {
		for (MAbstractMethodDefinition __DEC_mNestedType_mInnerTypes_722222 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mNestedType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mNestedType };
		}
		return null;
			...
			if (pattern_InterfaceInAnonymous_27_1_matchtggpattern_black_nac_0B(mNestedType) == null) {
				if (pattern_InterfaceInAnonymous_27_1_matchtggpattern_black_nac_1B(mNestedType) == null) {
					if (pattern_InterfaceInAnonymous_27_1_matchtggpattern_black_nac_2B(mNestedType) == null) {
						if (pattern_InterfaceInAnonymous_27_1_matchtggpattern_black_nac_3B(mNestedType) == null) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_28_1_matchtggpattern_black_nac_0B(
			TInterface tNestedType) {
		for (TPackage __DEC_tNestedType_interfaces_456213 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TPackage.class, "interfaces")) {
			return new Object[] { tNestedType };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceInAnonymous_28_1_matchtggpattern_black_nac_1BB(TInterface tNestedType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tNestedType_interfaces_271521 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tNestedType_interfaces_271521)) {
				return new Object[] { tNestedType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceInAnonymous_28_1_matchtggpattern_black_nac_2B(
			TInterface tNestedType) {
		TPackage __DEC_tNestedType_ownedTypes_54811 = tNestedType.getPackage();
		if (__DEC_tNestedType_ownedTypes_54811 != null) {
			return new Object[] { tNestedType };
		}
	...
	public static final Object[] pattern_InterfaceInAnonymous_28_1_matchtggpattern_black_nac_3BB(TInterface tNestedType,
			TClass tClass) {
		TAbstractType __DEC_tNestedType_innerTypes_496767 = tNestedType.getOuterType();
		if (__DEC_tNestedType_innerTypes_496767 != null) {
			if (!tNestedType.equals(__DEC_tNestedType_innerTypes_496767)) {
				if (!tClass.equals(__DEC_tNestedType_innerTypes_496767)) {
					return new Object[] { tNestedType, tClass };
				}
			}
		}
	...
	public static final Object[] pattern_InterfaceInAnonymous_28_1_matchtggpattern_blackBBB(TClass tClass, TypeGraph pg,
			TInterface tNestedType) {
		if (pg.getClasses().contains(tClass)) {
			if (pg.getInterfaces().contains(tNestedType)) {
				if (tClass.getInnerTypes().contains(tNestedType)) {
					if (pg.getOwnedTypes().contains(tClass)) {
						if (pg.getOwnedTypes().contains(tNestedType)) {
							if (pattern_InterfaceInAnonymous_28_1_matchtggpattern_black_nac_0B(tNestedType) == null) {
								if (pattern_InterfaceInAnonymous_28_1_matchtggpattern_black_nac_1BB(tNestedType,
										pg) == null) {
									if (pattern_InterfaceInAnonymous_28_1_matchtggpattern_black_nac_2B(
											tNestedType) == null) {
										if (pattern_InterfaceInAnonymous_28_1_matchtggpattern_black_nac_3BB(tNestedType,
												tClass) == null) {
	...
	public static final Iterable<Object[]> pattern_InterfaceInAnonymous_29_2_isapplicablecore_blackFFFFFBB(
				...
				if (tmpEAnonymousClassDeclarationToTClass instanceof AnonymousClassDeclarationToTClass) {
					...
					if (tClass != null) {
						...
						if (eAnonymousClassDeclaration != null) {
							...
							if (pg != null) {
								if (pg.getClasses().contains(tClass)) {
									if (pattern_InterfaceInAnonymous_29_2_isapplicablecore_black_nac_1BB(ruleResult,
											eAnonymousClassDeclarationToTClass) == null) {
										if (pattern_InterfaceInAnonymous_29_2_isapplicablecore_black_nac_0BB(ruleResult,
												tClass) == null) {
	...
	public static final Object[] pattern_InterfaceInAnonymous_29_3_solveCSP_bindingFBBBBBBB(InterfaceInAnonymous _this,
	...
	public static final Object[] pattern_InterfaceInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBB(
			InterfaceInAnonymous _this, IsApplicableMatch isApplicableMatch, TClass tClass, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_InterfaceInAnonymous_29_3_solveCSP_binding = pattern_InterfaceInAnonymous_29_3_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_InterfaceInAnonymous_29_5_checknacs_blackBBBB(TClass tClass, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		return new Object[] { tClass, pg, eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration };
	}

	public static final Object[] pattern_InterfaceInAnonymous_29_6_perform_blackBBBBB(TClass tClass, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tClass, pg, eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration, ruleResult };
	}

	public static final Object[] pattern_InterfaceInAnonymous_29_6_perform_greenBFBFFFFBBB(TClass tClass, TypeGraph pg,
		...
		return new Object[] { tClass, mNestedType, pg, mbodyToTAnnotatable, tNestedType,
				mInterfaceDeclarationtoTInterface, mNestedTypeToTNestedType, eAnonymousClassDeclaration, ruleResult,
				csp };
	}
