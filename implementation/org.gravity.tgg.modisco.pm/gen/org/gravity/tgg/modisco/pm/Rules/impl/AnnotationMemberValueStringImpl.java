...
public class AnnotationMemberValueStringImpl extends AbstractRuleImpl implements AnnotationMemberValueString {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.ANNOTATION_MEMBER_VALUE_STRING___IS_APPROPRIATE_BWD_EMOFLON_EDGE_39__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_39((EMoflonEdge) arguments.get(0));
			case RulesPackage.ANNOTATION_MEMBER_VALUE_STRING___IS_APPROPRIATE_FWD_EMOFLON_EDGE_42__EMOFLONEDGE:
