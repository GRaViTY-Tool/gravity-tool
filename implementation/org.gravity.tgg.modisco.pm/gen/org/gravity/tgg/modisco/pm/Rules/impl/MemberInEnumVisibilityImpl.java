...
public class MemberInEnumVisibilityImpl extends AbstractRuleImpl implements MemberInEnumVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mModifier,
						tModifier, tClass, mClass, defToMember, mModifierToTModifier, mDefinition, mTypeToTType,
						tMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModifier] = " + mModifier + ", " + "[tModifier] = " + tModifier + ", " + "[tClass] = "
					+ tClass + ", " + "[mClass] = " + mClass + ", " + "[defToMember] = " + defToMember + ", "
		...
		MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				mModifier, tModifier, mModifierToTModifier, mDefinition, tMember);
		...
		MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mModifier, tModifier, tClass, mClass, defToMember, mModifierToTModifier, mDefinition,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_2_2_corematch_blackBFBFBFFB(mModifier, mClass, mDefinition, match)) {
			...
			for (Object[] result3_black : MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_2_3_findcontext_blackBBBBBBB(mModifier, tClass, mClass, defToMember,
				...
				Object[] result4_bindingAndBlack = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mModifier] = " + mModifier + ", "
							+ "[tClass] = " + tClass + ", " + "[mClass] = " + mClass + ", " + "[defToMember] = "
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject tModifier, EObject tClass,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_12_2_corematch_blackBBFFFFBB(tModifier, tClass, tMember, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_12_3_findcontext_blackBBBBBBB(tModifier, tClass, mClass,
							defToMember, mDefinition, mTypeToTType, tMember)) {
				Object[] result3_green = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tModifier, tClass,
								mClass, defToMember, mDefinition, mTypeToTType, tMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tClass__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tClass____definedBy = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mModifier, EObject tModifier, EObject tClass,
			EObject mClass, EObject defToMember, EObject mModifierToTModifier, EObject mDefinition,
			EObject mTypeToTType, EObject tMember) {
		ruleresult.registerObject("mModifier", mModifier);
		ruleresult.registerObject("tModifier", tModifier);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_96(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_98(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mModifier, tModifier,
						tClass, mClass, mDefinition, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mModifier] = " + mModifier + ", " + "[tModifier] = " + tModifier + ", " + "[tClass] = " + tClass
					+ ", " + "[mClass] = " + mClass + ", " + "[mDefinition] = " + mDefinition + ", " + "[tMember] = "
		...
		if (MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInEnumVisibilityImpl
				...
				Object[] result6_black = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_24_6_createcorrespondence_blackBBBBBBB(mModifier, tModifier,
								tClass, mClass, mDefinition, tMember, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModifier] = "
							+ mModifier + ", " + "[tModifier] = " + tModifier + ", " + "[tClass] = " + tClass + ", "
							+ "[mClass] = " + mClass + ", " + "[mDefinition] = " + mDefinition + ", " + "[tMember] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Modifier mModifier, TModifier tModifier, TClass tClass, EnumDeclaration mClass,
			MDefinition mDefinition, TMember tMember, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : MemberInEnumVisibilityImpl
			...
			if (MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_29_6_perform_greenFFFBBBB(mDefinition,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_TCLASS_ENUMDECLARATION_MDEFINITIONTOTMEMBER_MDEFINITION_TYPETOTABSTRACTTYPE_TMEMBER:
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMODIFIER_TCLASS_ENUMDECLARATION_MDEFINITIONTOTMEMBER_MDEFINITION_TYPETOTABSTRACTTYPE_TMEMBER:
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_96__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_96((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_98__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__MODIFIER_TMODIFIER_TCLASS_ENUMDECLARATION_MDEFINITION_TMEMBER_MATCH_MATCH:
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								if (tmpTMember instanceof TMember) {
									...
									return new Object[] { mModifier, tClass, mClass, defToMember, mDefinition,
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			Modifier mModifier, TClass tClass, EnumDeclaration mClass, MDefinitionToTMember defToMember,
			MDefinition mDefinition, TypeToTAbstractType mTypeToTType, TMember tMember, MemberInEnumVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember, csp,
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInEnumVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInEnumVisibility_1_1_performtransformation_black = pattern_MemberInEnumVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifier, EObject tModifier, EObject tClass, EObject mClass,
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		mDefinition__mModifier____modifier.setName(mDefinition__mModifier____modifier_name_prime);
		mModifier__mDefinition____bodyDeclaration.setName(mModifier__mDefinition____bodyDeclaration_name_prime);
		return new Object[] { ruleresult, mModifier, tModifier, mModifierToTModifier, mDefinition, tMember,
	...
	public static final void pattern_MemberInEnumVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInEnumVisibility _this, PerformRuleResult ruleresult, EObject mModifier, EObject tModifier,
			EObject tClass, EObject mClass, EObject defToMember, EObject mModifierToTModifier, EObject mDefinition,
			EObject mTypeToTType, EObject tMember) {
		_this.registerObjects_FWD(ruleresult, mModifier, tModifier, tClass, mClass, defToMember, mModifierToTModifier,
				mDefinition, mTypeToTType, tMember);
	...
	public static final Iterable<Object[]> pattern_MemberInEnumVisibility_2_2_corematch_blackBFBFBFFB(
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTClass instanceof TClass) {
						TClass tClass = (TClass) tmpTClass;
						_result.add(new Object[] { mModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType,
								tMember, match });
					}
	...
	public static final Iterable<Object[]> pattern_MemberInEnumVisibility_2_3_findcontext_blackBBBBBBB(
			Modifier mModifier, TClass tClass, EnumDeclaration mClass, MDefinitionToTMember defToMember,
			MDefinition mDefinition, TypeToTAbstractType mTypeToTType, TMember tMember) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
						...
						if (mClass.equals(mTypeToTType.getSource())) {
							if (tClass.equals(mTypeToTType.getTarget())) {
								if (mModifier.equals(mDefinition.getModifier())) {
									_result.add(new Object[] { mModifier, tClass, mClass, defToMember, mDefinition,
											mTypeToTType, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInEnumVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		mDefinition__mModifier____modifier.setName(mDefinition__mModifier____modifier_name_prime);
		mModifier__mDefinition____bodyDeclaration.setName(mModifier__mDefinition____bodyDeclaration_name_prime);
		return new Object[] { mModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember,
	...
	public static final Object[] pattern_MemberInEnumVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModifier, tClass, mClass,
				defToMember, mDefinition, mTypeToTType, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, tClass, mClass, defToMember, mDefinition,
					mTypeToTType, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_2_4_solveCSP_binding = pattern_MemberInEnumVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember);
		if (result_pattern_MemberInEnumVisibility_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInEnumVisibility_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mModifier, tClass, mClass, defToMember,
						mDefinition, mTypeToTType, tMember };
			}
		}
		return null;
					...
					if (tmpDefToMember instanceof MDefinitionToTMember) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								if (tmpTMember instanceof TMember) {
									TMember tMember = (TMember) tmpTMember;
									return new Object[] { tModifier, tClass, mClass, defToMember, mDefinition,
											mTypeToTType, tMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInEnumVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TModifier tModifier, TClass tClass, EnumDeclaration mClass, MDefinitionToTMember defToMember,
			MDefinition mDefinition, TypeToTAbstractType mTypeToTType, TMember tMember, MemberInEnumVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInEnumVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInEnumVisibility_11_1_performtransformation_binding != null) {
			TModifier tModifier = (TModifier) result_pattern_MemberInEnumVisibility_11_1_performtransformation_binding[0];
			...
			Object[] result_pattern_MemberInEnumVisibility_11_1_performtransformation_black = pattern_MemberInEnumVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					tModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInEnumVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tClass, EObject mClass, EObject defToMember, EObject mModifierToTModifier, EObject mDefinition,
			EObject mTypeToTType, EObject tMember) {
		_this.registerObjects_BWD(ruleresult, mModifier, tModifier, tClass, mClass, defToMember, mModifierToTModifier,
				mDefinition, mTypeToTType, tMember);
	...
	public static final Iterable<Object[]> pattern_MemberInEnumVisibility_12_2_corematch_blackBBFFFFBB(
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMDefinition instanceof MDefinition) {
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMClass instanceof EnumDeclaration) {
						EnumDeclaration mClass = (EnumDeclaration) tmpMClass;
						_result.add(new Object[] { tModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType,
								tMember, match });
					}
				...
				if (mDefinition.equals(defToMember.getSource())) {
					if (tMember.equals(defToMember.getTarget())) {
						if (tModifier.equals(tMember.getTModifier())) {
							if (mClass.equals(mTypeToTType.getSource())) {
								if (tClass.equals(mTypeToTType.getTarget())) {
									_result.add(new Object[] { tModifier, tClass, mClass, defToMember, mDefinition,
											mTypeToTType, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInEnumVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mTypeToTType__mClass____source.setName(mTypeToTType__mClass____source_name_prime);
		mTypeToTType__tClass____target.setName(mTypeToTType__tClass____target_name_prime);
		return new Object[] { tModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember,
				isApplicableMatch, tClass__tMember____defines, tMember__tClass____definedBy,
				mClass__mDefinition____bodyDeclarations, mDefinition__mClass____abstractTypeDeclaration,
	...
	public static final Object[] pattern_MemberInEnumVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			MemberInEnumVisibility _this, IsApplicableMatch isApplicableMatch, TModifier tModifier, TClass tClass,
			EnumDeclaration mClass, MDefinitionToTMember defToMember, MDefinition mDefinition,
			TypeToTAbstractType mTypeToTType, TMember tMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tModifier, tClass, mClass,
				defToMember, mDefinition, mTypeToTType, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tModifier, tClass, mClass, defToMember, mDefinition,
					mTypeToTType, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_12_4_solveCSP_binding = pattern_MemberInEnumVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tModifier, tClass, mClass, defToMember, mDefinition, mTypeToTType, tMember);
		if (result_pattern_MemberInEnumVisibility_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInEnumVisibility_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tModifier, tClass, mClass, defToMember,
						mDefinition, mTypeToTType, tMember };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInEnumVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_323093 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_323093)) {
				...
				if (tmpTClass instanceof TClass) {
					...
					if (tmpMClass instanceof EnumDeclaration) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { mModifier, tModifier, tClass, mClass, mDefinition, tMember,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			Modifier mModifier, TModifier tModifier, TClass tClass, EnumDeclaration mClass, MDefinition mDefinition,
			TMember tMember, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mModifier, tModifier, tClass, mClass, mDefinition, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mModifier, tModifier, tClass, mClass, mDefinition, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInEnumVisibility _this, Modifier mModifier, TModifier tModifier, TClass tClass,
			EnumDeclaration mClass, MDefinition mDefinition, TMember tMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mModifier, tModifier, tClass, mClass, mDefinition,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mModifier, tModifier, tClass, mClass, mDefinition, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_24_3_solvecsp_binding = pattern_MemberInEnumVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mModifier, tModifier, tClass, mClass, mDefinition, tMember, sourceMatch, targetMatch);
		if (result_pattern_MemberInEnumVisibility_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MemberInEnumVisibility_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mModifier, tModifier, tClass, mClass, mDefinition, tMember,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mModifier, tModifier, tClass, mClass, mDefinition, tMember, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_158228 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_158228)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInEnumVisibility_29_6_perform_greenFFFBBBB(MDefinition mDefinition,
		...
		return new Object[] { mModifier, tModifier, mModifierToTModifier, mDefinition, tMember, ruleResult, csp };
	}
