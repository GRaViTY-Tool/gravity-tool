...
public class MemberInEnumVisibilityImpl extends AbstractRuleImpl implements MemberInEnumVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mDefinition,
						tModifier, tClass, mModifier, mClass, mModifierToTModifier, mTypeToTType, tMember, defToMember);
		...
		MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mDefinition, tModifier, tClass, mModifier, mClass, mModifierToTModifier, mTypeToTType,
				tMember, defToMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_2_2_corematch_blackBFBBFFFB(mDefinition, mModifier, mClass, match)) {
			...
			for (Object[] result3_black : MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_2_3_findcontext_blackBBBBBBB(mDefinition, tClass, mModifier, mClass,
				...
				Object[] result3_green = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mDefinition, tClass,
								mModifier, mClass, mTypeToTType, tMember, defToMember);
				...
				Object[] result4_bindingAndBlack = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mDefinition, tClass, mModifier, mClass, mTypeToTType, tMember, defToMember);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition, TClass tClass,
			Modifier mModifier, EnumDeclaration mClass, TypeToTAbstractType mTypeToTType, TMember tMember,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mDefinition, EObject tModifier,
			EObject tClass, EObject mModifier, EObject mClass, EObject mModifierToTModifier, EObject mTypeToTType,
			EObject tMember, EObject defToMember) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_12_2_corematch_blackFBBFFBFB(tModifier, tClass, tMember, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_12_3_findcontext_blackBBBBBBB(mDefinition, tModifier, tClass,
							mClass, mTypeToTType, tMember, defToMember)) {
				Object[] result3_green = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mDefinition, tModifier,
								tClass, mClass, mTypeToTType, tMember, defToMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tClass__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tClass____definedBy = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mDefinition, tModifier, tClass, mClass, mTypeToTType, tMember, defToMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition,
			TModifier tModifier, TClass tClass, EnumDeclaration mClass, TypeToTAbstractType mTypeToTType,
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mDefinition, tModifier,
						tClass, mModifier, mClass, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mDefinition] = " + mDefinition + ", " + "[tModifier] = " + tModifier + ", " + "[tClass] = "
					+ tClass + ", " + "[mModifier] = " + mModifier + ", " + "[mClass] = " + mClass + ", "
		...
		if (MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_24_5_matchcorrcontext_blackBBBFBFBB(mDefinition, tClass, mClass,
				...
				Object[] result6_black = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_24_6_createcorrespondence_blackBBBBBBB(mDefinition, tModifier,
								tClass, mModifier, mClass, tMember, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MDefinition mDefinition, TModifier tModifier, TClass tClass, Modifier mModifier,
		...
		for (Object[] result2_black : MemberInEnumVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mDefinition, tClass, mClass, mTypeToTType, tMember, defToMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition + ", "
			...
			if (MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_29_5_checknacs_blackBBBBBB(mDefinition, tClass, mClass,
								mTypeToTType, tMember, defToMember);
				if (result5_black != null) {

					Object[] result6_black = MemberInEnumVisibilityImpl
							.pattern_MemberInEnumVisibility_29_6_perform_blackBBBBBBB(mDefinition, tClass, mClass,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition, TClass tClass,
			EnumDeclaration mClass, TypeToTAbstractType mTypeToTType, TMember tMember, MDefinitionToTMember defToMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITION_TCLASS_MODIFIER_ENUMDECLARATION_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER:
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_TMODIFIER_TCLASS_ENUMDECLARATION_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (MDefinition) arguments.get(1),
					(TModifier) arguments.get(2), (TClass) arguments.get(3), (EnumDeclaration) arguments.get(4),
					(TypeToTAbstractType) arguments.get(5), (TMember) arguments.get(6),
					(MDefinitionToTMember) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_38__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_38((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_41__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__MDEFINITION_TMODIFIER_TCLASS_MODIFIER_ENUMDECLARATION_TMEMBER_MATCH_MATCH:
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_TCLASS_ENUMDECLARATION_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpDefToMember instanceof MDefinitionToTMember) {
									...
									return new Object[] { mDefinition, tClass, mModifier, mClass, mTypeToTType, tMember,
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			MDefinition mDefinition, TClass tClass, Modifier mModifier, EnumDeclaration mClass,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinition, tClass, mModifier, mClass, mTypeToTType, tMember, defToMember, csp,
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInEnumVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInEnumVisibility_1_1_performtransformation_black = pattern_MemberInEnumVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mDefinition, tClass, mModifier, mClass, mTypeToTType, tMember, defToMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mDefinition, EObject tModifier, EObject tClass, EObject mModifier,
			EObject mClass, EObject mModifierToTModifier, EObject mTypeToTType, EObject tMember, EObject defToMember) {
	...
	public static final void pattern_MemberInEnumVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tClass, EObject mModifier, EObject mClass, EObject mModifierToTModifier, EObject mTypeToTType,
			EObject tMember, EObject defToMember) {
		_this.registerObjects_FWD(ruleresult, mDefinition, tModifier, tClass, mModifier, mClass, mModifierToTModifier,
				mTypeToTType, tMember, defToMember);
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTClass instanceof TClass) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { mDefinition, tClass, mModifier, mClass, mTypeToTType, tMember,
								defToMember, match });
					}
						...
						if (mDefinition.equals(defToMember.getSource())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (tClass.equals(mTypeToTType.getTarget())) {
									_result.add(new Object[] { mDefinition, tClass, mModifier, mClass, mTypeToTType,
											tMember, defToMember });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInEnumVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mDefinition, tClass, mModifier, mClass, mTypeToTType, tMember, defToMember,
				...
				mTypeToTType__mClass____source, defToMember__mDefinition____source, defToMember__tMember____target,
	...
	public static final Object[] pattern_MemberInEnumVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mDefinition, tClass, mModifier,
				mClass, mTypeToTType, tMember, defToMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, tClass, mModifier, mClass, mTypeToTType,
					tMember, defToMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_2_4_solveCSP_binding = pattern_MemberInEnumVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, tClass, mModifier, mClass, mTypeToTType, tMember, defToMember);
		if (result_pattern_MemberInEnumVisibility_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInEnumVisibility_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mDefinition, tClass, mModifier, mClass,
						mTypeToTType, tMember, defToMember };
			}
		}
		return null;
					...
					if (tmpMClass instanceof EnumDeclaration) {
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpDefToMember instanceof MDefinitionToTMember) {
									MDefinitionToTMember defToMember = (MDefinitionToTMember) tmpDefToMember;
									return new Object[] { mDefinition, tModifier, tClass, mClass, mTypeToTType, tMember,
											defToMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInEnumVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			MDefinition mDefinition, TModifier tModifier, TClass tClass, EnumDeclaration mClass,
			TypeToTAbstractType mTypeToTType, TMember tMember, MDefinitionToTMember defToMember,
			MemberInEnumVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinition, tModifier, tClass, mClass, mTypeToTType, tMember, defToMember, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInEnumVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInEnumVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInEnumVisibility_11_1_performtransformation_black = pattern_MemberInEnumVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					mDefinition, tModifier, tClass, mClass, mTypeToTType, tMember, defToMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInEnumVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tClass, EObject mModifier, EObject mClass, EObject mModifierToTModifier, EObject mTypeToTType,
			EObject tMember, EObject defToMember) {
		_this.registerObjects_BWD(ruleresult, mDefinition, tModifier, tClass, mModifier, mClass, mModifierToTModifier,
				mTypeToTType, tMember, defToMember);
	...
	public static final Iterable<Object[]> pattern_MemberInEnumVisibility_12_2_corematch_blackFBBFFBFB(
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMDefinition instanceof MDefinition) {
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMClass instanceof EnumDeclaration) {
						EnumDeclaration mClass = (EnumDeclaration) tmpMClass;
						_result.add(new Object[] { mDefinition, tModifier, tClass, mClass, mTypeToTType, tMember,
								defToMember, match });
					}
				...
				if (mClass.equals(mTypeToTType.getSource())) {
					if (tModifier.equals(tMember.getTModifier())) {
						if (mDefinition.equals(defToMember.getSource())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (tClass.equals(mTypeToTType.getTarget())) {
									_result.add(new Object[] { mDefinition, tModifier, tClass, mClass, mTypeToTType,
											tMember, defToMember });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInEnumVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		mTypeToTType__tClass____target.setName(mTypeToTType__tClass____target_name_prime);
		return new Object[] { mDefinition, tModifier, tClass, mClass, mTypeToTType, tMember, defToMember,
				isApplicableMatch, tClass__tMember____defines, tMember__tClass____definedBy,
				mClass__mDefinition____bodyDeclarations, mDefinition__mClass____abstractTypeDeclaration,
				mTypeToTType__mClass____source, tMember__tModifier____tModifier, defToMember__mDefinition____source,
	...
	public static final Object[] pattern_MemberInEnumVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mDefinition, tModifier, tClass,
				mClass, mTypeToTType, tMember, defToMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, tModifier, tClass, mClass, mTypeToTType,
					tMember, defToMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_12_4_solveCSP_binding = pattern_MemberInEnumVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, tModifier, tClass, mClass, mTypeToTType, tMember, defToMember);
		if (result_pattern_MemberInEnumVisibility_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInEnumVisibility_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mDefinition, tModifier, tClass, mClass,
						mTypeToTType, tMember, defToMember };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInEnumVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_477213 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_477213)) {
				...
				if (tmpTClass instanceof TClass) {
					...
					if (tmpMModifier instanceof Modifier) {
						...
						if (tmpMClass instanceof EnumDeclaration) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { mDefinition, tModifier, tClass, mModifier, mClass, tMember,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MDefinition mDefinition, TModifier tModifier, TClass tClass, Modifier mModifier, EnumDeclaration mClass,
			TMember tMember, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mDefinition, tModifier, tClass, mModifier, mClass, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mDefinition, tModifier, tClass, mModifier, mClass, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInEnumVisibility _this, MDefinition mDefinition, TModifier tModifier, TClass tClass,
			Modifier mModifier, EnumDeclaration mClass, TMember tMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mDefinition, tModifier, tClass, mModifier, mClass,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mDefinition, tModifier, tClass, mModifier, mClass, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_24_3_solvecsp_binding = pattern_MemberInEnumVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mDefinition, tModifier, tClass, mModifier, mClass, tMember, sourceMatch, targetMatch);
		if (result_pattern_MemberInEnumVisibility_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MemberInEnumVisibility_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mDefinition, tModifier, tClass, mModifier, mClass, tMember,
						sourceMatch, targetMatch };
			}
		}
		return null;
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tClass.equals(mTypeToTType.getTarget())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { mDefinition, tClass, mClass, mTypeToTType, tMember, defToMember,
									sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mDefinition, tModifier, tClass, mModifier, mClass, tMember, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_376101 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_376101)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInEnumVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, tClass, mClass, mTypeToTType, tMember,
	...
	public static final Object[] pattern_MemberInEnumVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_29_3_solveCSP_binding = pattern_MemberInEnumVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, tClass, mClass, mTypeToTType, tMember, defToMember, ruleResult);
	...
	public static final Object[] pattern_MemberInEnumVisibility_29_5_checknacs_blackBBBBBB(MDefinition mDefinition,
			TClass tClass, EnumDeclaration mClass, TypeToTAbstractType mTypeToTType, TMember tMember,
			MDefinitionToTMember defToMember) {
		return new Object[] { mDefinition, tClass, mClass, mTypeToTType, tMember, defToMember };
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_29_6_perform_blackBBBBBBB(MDefinition mDefinition,
		...
		return new Object[] { mDefinition, tClass, mClass, mTypeToTType, tMember, defToMember, ruleResult };
	}
