 ...
 * @generated
 */
public class MethodInvocationImpl extends AbstractRuleImpl implements MethodInvocation {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getMethodInvocation();
	}
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, MMethodInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {

		Object[] result1_black = MethodInvocationImpl.pattern_MethodInvocation_0_1_initialbindings_blackBBBBB(this,
		...
		Object[] result2_bindingAndBlack = MethodInvocationImpl
				.pattern_MethodInvocation_0_2_SolveCSP_bindingAndBlackFBBBBB(this, match, invocation, mMember, mMethod);
		...
		// 
		if (MethodInvocationImpl.pattern_MethodInvocation_0_3_CheckCSP_expressionFBB(this, csp)) {

			Object[] result4_black = MethodInvocationImpl
					.pattern_MethodInvocation_0_4_collectelementstobetranslated_blackBBBB(match, invocation, mMember,
							mMethod);
			...
			MethodInvocationImpl.pattern_MethodInvocation_0_4_collectelementstobetranslated_greenBBBBFFF(match,
			...
			Object[] result5_black = MethodInvocationImpl
					.pattern_MethodInvocation_0_5_collectcontextelements_blackBBBB(match, invocation, mMember, mMethod);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[invocation] = "
								+ invocation + ", " + "[mMember] = " + mMember + ", " + "[mMethod] = " + mMethod + ".");
			}
			MethodInvocationImpl.pattern_MethodInvocation_0_5_collectcontextelements_greenBBB(match, mMember, mMethod);

			// 
			MethodInvocationImpl.pattern_MethodInvocation_0_6_registerobjectstomatch_expressionBBBBB(this, match,
					invocation, mMember, mMethod);
			return MethodInvocationImpl.pattern_MethodInvocation_0_7_expressionF();
		} else {
			return MethodInvocationImpl.pattern_MethodInvocation_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = MethodInvocationImpl
				.pattern_MethodInvocation_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(this, isApplicableMatch);
		...
		Object[] result1_green = MethodInvocationImpl
				.pattern_MethodInvocation_1_1_performtransformation_greenBBFBFF(invocation, tMember, tMethod);
		...
		Object[] result2_black = MethodInvocationImpl.pattern_MethodInvocation_1_2_collecttranslatedelements_blackBBBB(
				invocation, tAccess, mFlowElementToTFlowElement, invocationToTAccess);
		...
		Object[] result2_green = MethodInvocationImpl.pattern_MethodInvocation_1_2_collecttranslatedelements_greenFBBBB(
				invocation, tAccess, mFlowElementToTFlowElement, invocationToTAccess);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = MethodInvocationImpl.pattern_MethodInvocation_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
		...
		MethodInvocationImpl.pattern_MethodInvocation_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(ruleresult,
		...
		// 
		// 
		MethodInvocationImpl.pattern_MethodInvocation_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				invocation, mMemberToTMember, tMember, tAccess, mMethodToTMethod, tMethod, mMember,
				mFlowElementToTFlowElement, invocationToTAccess, mMethod);
		return MethodInvocationImpl.pattern_MethodInvocation_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = MethodInvocationImpl
				.pattern_MethodInvocation_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		...
		Object[] result1_green = MethodInvocationImpl
				.pattern_MethodInvocation_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = MethodInvocationImpl.pattern_MethodInvocation_2_2_corematch_bindingFFFB(match);
		...
		for (Object[] result2_black : MethodInvocationImpl
				.pattern_MethodInvocation_2_2_corematch_blackBFFFFBBB(invocation, mMember, mMethod, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationImpl.pattern_MethodInvocation_2_3_findcontext_blackBBBBBBB(
					invocation, mMemberToTMember, tMember, mMethodToTMethod, tMethod, mMember, mMethod)) {
				Object[] result3_green = MethodInvocationImpl
						.pattern_MethodInvocation_2_3_findcontext_greenBBBBBBBFFFFFFFF(invocation, mMemberToTMember,
				...
				Object[] result4_bindingAndBlack = MethodInvocationImpl
						.pattern_MethodInvocation_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								invocation, mMemberToTMember, tMember, mMethodToTMethod, tMethod, mMember, mMethod);
				...
				// 
				if (MethodInvocationImpl.pattern_MethodInvocation_2_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = MethodInvocationImpl
							.pattern_MethodInvocation_2_6_addmatchtoruleresult_blackBB(ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					MethodInvocationImpl.pattern_MethodInvocation_2_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return MethodInvocationImpl.pattern_MethodInvocation_2_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, MMethodInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, MMethodInvocation invocation, MDefinition mMember,
	...
	public boolean isAppropriate_BWD(Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		...
		Object[] result1_black = MethodInvocationImpl.pattern_MethodInvocation_10_1_initialbindings_blackBBBBB(this,
		...
		Object[] result2_bindingAndBlack = MethodInvocationImpl
				.pattern_MethodInvocation_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, tMember, tAccess, tMethod);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tMember] = " + tMember + ", " + "[tAccess] = " + tAccess + ", "
					+ "[tMethod] = " + tMethod + ".");
		...
		CSP csp = (CSP) result2_bindingAndBlack[0];
		// 
		if (MethodInvocationImpl.pattern_MethodInvocation_10_3_CheckCSP_expressionFBB(this, csp)) {

			Object[] result4_black = MethodInvocationImpl
					.pattern_MethodInvocation_10_4_collectelementstobetranslated_blackBBBB(match, tMember, tAccess,
							tMethod);
			if (result4_black == null) {
				throw new RuntimeException(
			...
			MethodInvocationImpl.pattern_MethodInvocation_10_4_collectelementstobetranslated_greenBBBBFFFF(match,
			...
			Object[] result5_black = MethodInvocationImpl
					.pattern_MethodInvocation_10_5_collectcontextelements_blackBBBB(match, tMember, tAccess, tMethod);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[tMember] = "
								+ tMember + ", " + "[tAccess] = " + tAccess + ", " + "[tMethod] = " + tMethod + ".");
			}
			MethodInvocationImpl.pattern_MethodInvocation_10_5_collectcontextelements_greenBBB(match, tMember, tMethod);

			// 
			MethodInvocationImpl.pattern_MethodInvocation_10_6_registerobjectstomatch_expressionBBBBB(this, match,
					tMember, tAccess, tMethod);
			return MethodInvocationImpl.pattern_MethodInvocation_10_7_expressionF();
		} else {
			return MethodInvocationImpl.pattern_MethodInvocation_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = MethodInvocationImpl
				.pattern_MethodInvocation_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = MethodInvocationImpl
				.pattern_MethodInvocation_11_1_performtransformation_greenFBBFFB(tAccess, mMember, mMethod);
		...
		Object[] result2_black = MethodInvocationImpl.pattern_MethodInvocation_11_2_collecttranslatedelements_blackBBBB(
				invocation, tAccess, mFlowElementToTFlowElement, invocationToTAccess);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[invocation] = " + invocation
					+ ", " + "[tAccess] = " + tAccess + ", " + "[mFlowElementToTFlowElement] = "
		...
		Object[] result2_green = MethodInvocationImpl
				.pattern_MethodInvocation_11_2_collecttranslatedelements_greenFBBBB(invocation, tAccess,
						mFlowElementToTFlowElement, invocationToTAccess);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = MethodInvocationImpl
				.pattern_MethodInvocation_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, invocation,
		...
		MethodInvocationImpl.pattern_MethodInvocation_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(ruleresult,
				invocation, tMember, tAccess, tMethod, mMember, mFlowElementToTFlowElement, invocationToTAccess,
				mMethod);
		//nothing EMoflonEdge invocation__mMethod____method = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge mMethod__invocation____usages = (EMoflonEdge) result3_green[10];
		...
		// 
		// 
		MethodInvocationImpl.pattern_MethodInvocation_11_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				invocation, mMemberToTMember, tMember, tAccess, mMethodToTMethod, tMethod, mMember,
				mFlowElementToTFlowElement, invocationToTAccess, mMethod);
		return MethodInvocationImpl.pattern_MethodInvocation_11_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Object[] result1_bindingAndBlack = MethodInvocationImpl
				.pattern_MethodInvocation_12_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		EOperation performOperation = (EOperation) result1_bindingAndBlack[0];
		//nothing EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = MethodInvocationImpl
				.pattern_MethodInvocation_12_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = MethodInvocationImpl.pattern_MethodInvocation_12_2_corematch_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : MethodInvocationImpl
				.pattern_MethodInvocation_12_2_corematch_blackFBBFBFFB(tMember, tAccess, tMethod, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationImpl.pattern_MethodInvocation_12_3_findcontext_blackBBBBBBB(
					mMemberToTMember, tMember, tAccess, mMethodToTMethod, tMethod, mMember, mMethod)) {
				Object[] result3_green = MethodInvocationImpl
						.pattern_MethodInvocation_12_3_findcontext_greenBBBBBBBFFFFFFFFF(mMemberToTMember, tMember,
				...
				Object[] result4_bindingAndBlack = MethodInvocationImpl
						.pattern_MethodInvocation_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mMemberToTMember, tMember, tAccess, mMethodToTMethod, tMethod, mMember, mMethod);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
				...
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
				if (MethodInvocationImpl.pattern_MethodInvocation_12_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = MethodInvocationImpl
							.pattern_MethodInvocation_12_6_addmatchtoruleresult_blackBB(ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					MethodInvocationImpl.pattern_MethodInvocation_12_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return MethodInvocationImpl.pattern_MethodInvocation_12_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_71(EMoflonEdge _edge_tAccessing) {
		...
		Object[] result1_green = MethodInvocationImpl.pattern_MethodInvocation_20_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach 
		for (Object[] result2_black : MethodInvocationImpl
				.pattern_MethodInvocation_20_2_testcorematchandDECs_blackFFFB(_edge_tAccessing)) {
			TMember tMember = (TMember) result2_black[0];
			TCall tAccess = (TCall) result2_black[1];
			TMember tMethod = (TMember) result2_black[2];
			Object[] result2_green = MethodInvocationImpl
					.pattern_MethodInvocation_20_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// 
			if (MethodInvocationImpl
					.pattern_MethodInvocation_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, tMember, tAccess, tMethod)) {
				// 
				if (MethodInvocationImpl
						.pattern_MethodInvocation_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(this,
								match)) {

					Object[] result5_black = MethodInvocationImpl
							.pattern_MethodInvocation_20_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
					...
					MethodInvocationImpl.pattern_MethodInvocation_20_5_Addmatchtoruleresult_greenBBBB(match,
		...
		return MethodInvocationImpl.pattern_MethodInvocation_20_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_74(EMoflonEdge _edge_method) {
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		EOperation isApplicableCC = (EOperation) result1_bindingAndBlack[3];
		Object[] result1_green = MethodInvocationImpl.pattern_MethodInvocation_21_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach 
		for (Object[] result2_black : MethodInvocationImpl
				.pattern_MethodInvocation_21_2_testcorematchandDECs_blackFFFB(_edge_method)) {
			...
			Object[] result2_green = MethodInvocationImpl
					.pattern_MethodInvocation_21_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// 
			if (MethodInvocationImpl
					.pattern_MethodInvocation_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, invocation, mMember, mMethod)) {
				// 
				if (MethodInvocationImpl
						.pattern_MethodInvocation_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(this,
								match)) {

					Object[] result5_black = MethodInvocationImpl
							.pattern_MethodInvocation_21_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
									__result, isApplicableCC);
					if (result5_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match
								+ ", " + "[__performOperation] = " + __performOperation + ", " + "[__result] = "
					...
					MethodInvocationImpl.pattern_MethodInvocation_21_5_Addmatchtoruleresult_greenBBBB(match,
							__performOperation, __result, isApplicableCC);
		...
		return MethodInvocationImpl.pattern_MethodInvocation_21_6_expressionFB(__result);
	}
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result1_black = MethodInvocationImpl.pattern_MethodInvocation_24_1_prepare_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = MethodInvocationImpl.pattern_MethodInvocation_24_1_prepare_greenF();
		IsApplicableRuleResult result = (IsApplicableRuleResult) result1_green[0];

		Object[] result2_bindingAndBlack = MethodInvocationImpl
				.pattern_MethodInvocation_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result3_bindingAndBlack = MethodInvocationImpl
				.pattern_MethodInvocation_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, invocation, tMember, tAccess,
						tMethod, mMember, mMethod, sourceMatch, targetMatch);
		...
		// 
		if (MethodInvocationImpl.pattern_MethodInvocation_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : MethodInvocationImpl
					.pattern_MethodInvocation_24_5_matchcorrcontext_blackFBFBBBBB(tMember, tMethod, mMember, mMethod,
				...
				Object[] result5_green = MethodInvocationImpl.pattern_MethodInvocation_24_5_matchcorrcontext_greenBBBBF(
						mMemberToTMember, mMethodToTMethod, sourceMatch, targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[4];

				Object[] result6_black = MethodInvocationImpl
						.pattern_MethodInvocation_24_6_createcorrespondence_blackBBBBBBB(invocation, tMember, tAccess,
								tMethod, mMember, mMethod, ccMatch);
				if (result6_black == null) {
				...
				MethodInvocationImpl.pattern_MethodInvocation_24_6_createcorrespondence_greenBBFFB(invocation, tAccess,
						ccMatch);
				...
				Object[] result7_black = MethodInvocationImpl
						.pattern_MethodInvocation_24_7_addtoreturnedresult_blackBB(result, ccMatch);
				if (result7_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[result] = " + result
							+ ", " + "[ccMatch] = " + ccMatch + ".");
				}
				MethodInvocationImpl.pattern_MethodInvocation_24_7_addtoreturnedresult_greenBB(result, ccMatch);

			}

		} else {
		}
		return MethodInvocationImpl.pattern_MethodInvocation_24_8_expressionFB(result);
	}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MMethodInvocation invocation, TMember tMember, TCall tAccess, TMember tMethod,
			MDefinition mMember, AbstractMethodDeclaration mMethod, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(MMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {// 
		Object[] result1_black = MethodInvocationImpl.pattern_MethodInvocation_27_1_matchtggpattern_blackBBB(invocation,
				mMember, mMethod);
		if (result1_black != null) {
			return MethodInvocationImpl.pattern_MethodInvocation_27_2_expressionF();
		} else {
			return MethodInvocationImpl.pattern_MethodInvocation_27_3_expressionF();
		}
	...
	public boolean checkDEC_BWD(TMember tMember, TCall tAccess, TMember tMethod) {// 
		Object[] result1_black = MethodInvocationImpl.pattern_MethodInvocation_28_1_matchtggpattern_blackBBB(tMember,
				tAccess, tMethod);
		if (result1_black != null) {
			return MethodInvocationImpl.pattern_MethodInvocation_28_2_expressionF();
		} else {
			return MethodInvocationImpl.pattern_MethodInvocation_28_3_expressionF();
		}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		Object[] result1_black = MethodInvocationImpl.pattern_MethodInvocation_29_1_createresult_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = MethodInvocationImpl.pattern_MethodInvocation_29_1_createresult_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach 
		for (Object[] result2_black : MethodInvocationImpl
				.pattern_MethodInvocation_29_2_isapplicablecore_blackFFFFFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			Object[] result3_bindingAndBlack = MethodInvocationImpl
					.pattern_MethodInvocation_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
			...
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (MethodInvocationImpl.pattern_MethodInvocation_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MethodInvocationImpl.pattern_MethodInvocation_29_5_checknacs_blackBBBBBB(
						mMemberToTMember, tMember, mMethodToTMethod, tMethod, mMember, mMethod);
				if (result5_black != null) {

					Object[] result6_black = MethodInvocationImpl.pattern_MethodInvocation_29_6_perform_blackBBBBBBB(
							mMemberToTMember, tMember, mMethodToTMethod, tMethod, mMember, mMethod, ruleResult);
					if (result6_black == null) {
					...
					MethodInvocationImpl.pattern_MethodInvocation_29_6_perform_greenFBFBBFFBB(tMember, tMethod, mMember,
							mMethod, ruleResult);
		...
		return MethodInvocationImpl.pattern_MethodInvocation_29_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.METHOD_INVOCATION___IS_APPROPRIATE_FWD__MATCH_MMETHODINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.METHOD_INVOCATION___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MMETHODINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (MMethodInvocation) arguments.get(1),
					(MDefinition) arguments.get(2), (AbstractMethodDeclaration) arguments.get(3));
			return null;
		case RulesPackage.METHOD_INVOCATION___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MMETHODINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.METHOD_INVOCATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MMETHODINVOCATION_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.METHOD_INVOCATION___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.METHOD_INVOCATION___IS_APPROPRIATE_BWD__MATCH_TMEMBER_TCALL_TMEMBER:
		...
		case RulesPackage.METHOD_INVOCATION___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TMEMBER_TCALL_TMEMBER:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TMember) arguments.get(1), (TCall) arguments.get(2),
					(TMember) arguments.get(3));
			return null;
		case RulesPackage.METHOD_INVOCATION___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TMEMBER_TCALL_TMEMBER:
		...
		case RulesPackage.METHOD_INVOCATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TMEMBER_TCALL_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.METHOD_INVOCATION___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.METHOD_INVOCATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_71__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_71((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_74__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION___IS_APPLICABLE_SOLVE_CSP_CC__MMETHODINVOCATION_TMEMBER_TCALL_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.METHOD_INVOCATION___CHECK_DEC_FWD__MMETHODINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.METHOD_INVOCATION___CHECK_DEC_BWD__TMEMBER_TCALL_TMEMBER:
			return checkDEC_BWD((TMember) arguments.get(0), (TCall) arguments.get(1), (TMember) arguments.get(2));
		case RulesPackage.METHOD_INVOCATION___GENERATE_MODEL__RULEENTRYCONTAINER_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER:
			return generateModel((RuleEntryContainer) arguments.get(0), (MDefinitionToTMember) arguments.get(1),
					(MDefinitionToTMember) arguments.get(2));
		case RulesPackage.METHOD_INVOCATION___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodInvocation_0_1_initialbindings_blackBBBBB(MethodInvocation _this,
			Match match, MMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		return new Object[] { _this, match, invocation, mMember, mMethod };
	}

	public static final Object[] pattern_MethodInvocation_0_2_SolveCSP_bindingFBBBBB(MethodInvocation _this,
			Match match, MMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_MethodInvocation_0_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_MethodInvocation_0_2_SolveCSP_bindingAndBlackFBBBBB(MethodInvocation _this,
			Match match, MMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		Object[] result_pattern_MethodInvocation_0_2_SolveCSP_binding = pattern_MethodInvocation_0_2_SolveCSP_bindingFBBBBB(
				_this, match, invocation, mMember, mMethod);
		if (result_pattern_MethodInvocation_0_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_MethodInvocation_0_2_SolveCSP_binding[0];

			Object[] result_pattern_MethodInvocation_0_2_SolveCSP_black = pattern_MethodInvocation_0_2_SolveCSP_blackB(
					csp);
			if (result_pattern_MethodInvocation_0_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_MethodInvocation_0_3_CheckCSP_expressionFBB(MethodInvocation _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_0_4_collectelementstobetranslated_blackBBBB(Match match,
			MMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		return new Object[] { match, invocation, mMember, mMethod };
	}

	public static final Object[] pattern_MethodInvocation_0_4_collectelementstobetranslated_greenBBBBFFF(Match match,
			MMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_MethodInvocation_0_5_collectcontextelements_blackBBBB(Match match,
			MMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		return new Object[] { match, invocation, mMember, mMethod };
	}

	public static final Object[] pattern_MethodInvocation_0_5_collectcontextelements_greenBBB(Match match,
	...
	public static final void pattern_MethodInvocation_0_6_registerobjectstomatch_expressionBBBBB(MethodInvocation _this,
			Match match, MMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		_this.registerObjectsToMatch_FWD(match, invocation, mMember, mMethod);

	}

	public static final boolean pattern_MethodInvocation_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_MethodInvocation_0_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_1_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_MethodInvocation_1_1_performtransformation_blackBBBBBBBFBB(
			MMethodInvocation invocation, MDefinitionToTMember mMemberToTMember, TMember tMember,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod, MethodInvocation _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_MethodInvocation_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			MethodInvocation _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_MethodInvocation_1_1_performtransformation_binding = pattern_MethodInvocation_1_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_MethodInvocation_1_1_performtransformation_binding != null) {
			MMethodInvocation invocation = (MMethodInvocation) result_pattern_MethodInvocation_1_1_performtransformation_binding[0];
			MDefinitionToTMember mMemberToTMember = (MDefinitionToTMember) result_pattern_MethodInvocation_1_1_performtransformation_binding[1];
			TMember tMember = (TMember) result_pattern_MethodInvocation_1_1_performtransformation_binding[2];
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_MethodInvocation_1_1_performtransformation_binding[3];
			TMember tMethod = (TMember) result_pattern_MethodInvocation_1_1_performtransformation_binding[4];
			MDefinition mMember = (MDefinition) result_pattern_MethodInvocation_1_1_performtransformation_binding[5];
			AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) result_pattern_MethodInvocation_1_1_performtransformation_binding[6];

			Object[] result_pattern_MethodInvocation_1_1_performtransformation_black = pattern_MethodInvocation_1_1_performtransformation_blackBBBBBBBFBB(
					invocation, mMemberToTMember, tMember, mMethodToTMethod, tMethod, mMember, mMethod, _this,
					isApplicableMatch);
			if (result_pattern_MethodInvocation_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_MethodInvocation_1_1_performtransformation_black[7];
	...
	public static final Object[] pattern_MethodInvocation_1_1_performtransformation_greenBBFBFF(
			MMethodInvocation invocation, TMember tMember, TMember tMethod) {
	...
	public static final Object[] pattern_MethodInvocation_1_2_collecttranslatedelements_blackBBBB(
	...
	public static final Object[] pattern_MethodInvocation_1_2_collecttranslatedelements_greenFBBBB(
			MMethodInvocation invocation, TCall tAccess,
			MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement,
			AbstractMethodInvocationToTAccess invocationToTAccess) {
	...
	public static final Object[] pattern_MethodInvocation_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
	...
	public static final Object[] pattern_MethodInvocation_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
		...
		String ruleresult_ruleName_prime = "MethodInvocation";
		String invocation__mMethod____method_name_prime = "method";
		String mMethod__invocation____usages_name_prime = "usages";
	...
	public static final void pattern_MethodInvocation_1_5_registerobjects_expressionBBBBBBBBBBBB(MethodInvocation _this,
			PerformRuleResult ruleresult, EObject invocation, EObject mMemberToTMember, EObject tMember,
			EObject tAccess, EObject mMethodToTMethod, EObject tMethod, EObject mMember,
			EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
	...
	public static final PerformRuleResult pattern_MethodInvocation_1_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_2_1_preparereturnvalue_bindingFB(MethodInvocation _this) {
	...
	public static final Object[] pattern_MethodInvocation_2_1_preparereturnvalue_blackFBB(EClass eClass,
			MethodInvocation _this) {
	...
	public static final Object[] pattern_MethodInvocation_2_1_preparereturnvalue_bindingAndBlackFFB(
			MethodInvocation _this) {
		Object[] result_pattern_MethodInvocation_2_1_preparereturnvalue_binding = pattern_MethodInvocation_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_MethodInvocation_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_MethodInvocation_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_MethodInvocation_2_1_preparereturnvalue_black = pattern_MethodInvocation_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_MethodInvocation_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_MethodInvocation_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_MethodInvocation_2_1_preparereturnvalue_greenBF(EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "MethodInvocation";
	...
	public static final Object[] pattern_MethodInvocation_2_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_MethodInvocation_2_2_corematch_blackBFFFFBBB(
			MMethodInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod, Match match) {
	...
	public static final Iterable<Object[]> pattern_MethodInvocation_2_3_findcontext_blackBBBBBBB(
			MMethodInvocation invocation, MDefinitionToTMember mMemberToTMember, TMember tMember,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_MethodInvocation_2_3_findcontext_greenBBBBBBBFFFFFFFF(
			MMethodInvocation invocation, MDefinitionToTMember mMemberToTMember, TMember tMember,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_MethodInvocation_2_4_solveCSP_bindingFBBBBBBBBB(MethodInvocation _this,
			IsApplicableMatch isApplicableMatch, MMethodInvocation invocation, MDefinitionToTMember mMemberToTMember,
			TMember tMember, MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_MethodInvocation_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_MethodInvocation_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(MethodInvocation _this,
			IsApplicableMatch isApplicableMatch, MMethodInvocation invocation, MDefinitionToTMember mMemberToTMember,
			TMember tMember, MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		Object[] result_pattern_MethodInvocation_2_4_solveCSP_binding = pattern_MethodInvocation_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, invocation, mMemberToTMember, tMember, mMethodToTMethod, tMethod, mMember,
				mMethod);
		if (result_pattern_MethodInvocation_2_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_MethodInvocation_2_4_solveCSP_binding[0];

			Object[] result_pattern_MethodInvocation_2_4_solveCSP_black = pattern_MethodInvocation_2_4_solveCSP_blackB(
					csp);
			if (result_pattern_MethodInvocation_2_4_solveCSP_black != null) {
	...
	public static final boolean pattern_MethodInvocation_2_5_checkCSP_expressionFBB(MethodInvocation _this, CSP csp) {
		boolean _localVariable_0 = _this.isApplicable_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_MethodInvocation_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "MethodInvocation";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_MethodInvocation_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_10_1_initialbindings_blackBBBBB(MethodInvocation _this,
	...
	public static final Object[] pattern_MethodInvocation_10_2_SolveCSP_bindingFBBBBB(MethodInvocation _this,
			Match match, TMember tMember, TCall tAccess, TMember tMethod) {
	...
	public static final Object[] pattern_MethodInvocation_10_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_MethodInvocation_10_2_SolveCSP_bindingAndBlackFBBBBB(MethodInvocation _this,
			Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		Object[] result_pattern_MethodInvocation_10_2_SolveCSP_binding = pattern_MethodInvocation_10_2_SolveCSP_bindingFBBBBB(
				_this, match, tMember, tAccess, tMethod);
		if (result_pattern_MethodInvocation_10_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_MethodInvocation_10_2_SolveCSP_binding[0];

			Object[] result_pattern_MethodInvocation_10_2_SolveCSP_black = pattern_MethodInvocation_10_2_SolveCSP_blackB(
					csp);
			if (result_pattern_MethodInvocation_10_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_MethodInvocation_10_3_CheckCSP_expressionFBB(MethodInvocation _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_BWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_10_4_collectelementstobetranslated_blackBBBB(Match match,
	...
	public static final Object[] pattern_MethodInvocation_10_4_collectelementstobetranslated_greenBBBBFFFF(Match match,
			TMember tMember, TCall tAccess, TMember tMethod) {
		EMoflonEdge tMember__tAccess____tAccessing = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAccess__tMember____tSource = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAccess__tMethod____tTarget = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_MethodInvocation_10_5_collectcontextelements_blackBBBB(Match match,
			TMember tMember, TCall tAccess, TMember tMethod) {
		if (!tMember.equals(tMethod)) {
			return new Object[] { match, tMember, tAccess, tMethod };
		}
	...
	public static final Object[] pattern_MethodInvocation_10_5_collectcontextelements_greenBBB(Match match,
	...
	public static final void pattern_MethodInvocation_10_6_registerobjectstomatch_expressionBBBBB(
			MethodInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		_this.registerObjectsToMatch_BWD(match, tMember, tAccess, tMethod);

	}

	public static final boolean pattern_MethodInvocation_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_MethodInvocation_10_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_11_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_MethodInvocation_11_1_performtransformation_blackBBBBBBBFBB(
	...
	public static final Object[] pattern_MethodInvocation_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			MethodInvocation _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_MethodInvocation_11_1_performtransformation_binding = pattern_MethodInvocation_11_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_MethodInvocation_11_1_performtransformation_binding != null) {
			MDefinitionToTMember mMemberToTMember = (MDefinitionToTMember) result_pattern_MethodInvocation_11_1_performtransformation_binding[0];
			TMember tMember = (TMember) result_pattern_MethodInvocation_11_1_performtransformation_binding[1];
			TCall tAccess = (TCall) result_pattern_MethodInvocation_11_1_performtransformation_binding[2];
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_MethodInvocation_11_1_performtransformation_binding[3];
			TMember tMethod = (TMember) result_pattern_MethodInvocation_11_1_performtransformation_binding[4];
			MDefinition mMember = (MDefinition) result_pattern_MethodInvocation_11_1_performtransformation_binding[5];
			AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) result_pattern_MethodInvocation_11_1_performtransformation_binding[6];

			Object[] result_pattern_MethodInvocation_11_1_performtransformation_black = pattern_MethodInvocation_11_1_performtransformation_blackBBBBBBBFBB(
					mMemberToTMember, tMember, tAccess, mMethodToTMethod, tMethod, mMember, mMethod, _this,
					isApplicableMatch);
			if (result_pattern_MethodInvocation_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_MethodInvocation_11_1_performtransformation_black[7];
	...
	public static final Object[] pattern_MethodInvocation_11_1_performtransformation_greenFBBFFB(TCall tAccess,
			MDefinition mMember, AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_MethodInvocation_11_2_collecttranslatedelements_blackBBBB(
			MMethodInvocation invocation, TCall tAccess,
			MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement,
			AbstractMethodInvocationToTAccess invocationToTAccess) {
		return new Object[] { invocation, tAccess, mFlowElementToTFlowElement, invocationToTAccess };
	...
	public static final Object[] pattern_MethodInvocation_11_2_collecttranslatedelements_greenFBBBB(
			MMethodInvocation invocation, TCall tAccess,
			MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement,
			AbstractMethodInvocationToTAccess invocationToTAccess) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_MethodInvocation_11_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject invocation, EObject mMemberToTMember, EObject tMember,
			EObject tAccess, EObject mMethodToTMethod, EObject tMethod, EObject mMember,
			EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
		if (!invocation.equals(mMemberToTMember)) {
	...
	public static final Object[] pattern_MethodInvocation_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject invocation, EObject tMember, EObject tAccess, EObject tMethod,
			EObject mMember, EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
		EMoflonEdge invocation__mMethod____method = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mMethod__invocation____usages = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_MethodInvocation_11_5_registerobjects_expressionBBBBBBBBBBBB(
			MethodInvocation _this, PerformRuleResult ruleresult, EObject invocation, EObject mMemberToTMember,
			EObject tMember, EObject tAccess, EObject mMethodToTMethod, EObject tMethod, EObject mMember,
			EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
	...
	public static final PerformRuleResult pattern_MethodInvocation_11_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_12_1_preparereturnvalue_bindingFB(MethodInvocation _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
			return new Object[] { eClass, _this };
	...
	public static final Object[] pattern_MethodInvocation_12_1_preparereturnvalue_blackFBB(EClass eClass,
			MethodInvocation _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperation_name = performOperation.getName();
	...
	public static final Object[] pattern_MethodInvocation_12_1_preparereturnvalue_bindingAndBlackFFB(
			MethodInvocation _this) {
		Object[] result_pattern_MethodInvocation_12_1_preparereturnvalue_binding = pattern_MethodInvocation_12_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_MethodInvocation_12_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_MethodInvocation_12_1_preparereturnvalue_binding[0];

			Object[] result_pattern_MethodInvocation_12_1_preparereturnvalue_black = pattern_MethodInvocation_12_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_MethodInvocation_12_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_MethodInvocation_12_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_MethodInvocation_12_1_preparereturnvalue_greenBF(EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "MethodInvocation";
		ruleresult.setPerformOperation(performOperation);
	...
	public static final Object[] pattern_MethodInvocation_12_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_MethodInvocation_12_2_corematch_blackFBBFBFFB(TMember tMember,
	...
	public static final Iterable<Object[]> pattern_MethodInvocation_12_3_findcontext_blackBBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, TCall tAccess,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_MethodInvocation_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
			MDefinitionToTMember mMemberToTMember, TMember tMember, TCall tAccess,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_MethodInvocation_12_4_solveCSP_bindingFBBBBBBBBB(MethodInvocation _this,
	...
	public static final Object[] pattern_MethodInvocation_12_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_MethodInvocation_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			MethodInvocation _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			TMember tMember, TCall tAccess, MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		Object[] result_pattern_MethodInvocation_12_4_solveCSP_binding = pattern_MethodInvocation_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mMemberToTMember, tMember, tAccess, mMethodToTMethod, tMethod, mMember,
				mMethod);
		if (result_pattern_MethodInvocation_12_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_MethodInvocation_12_4_solveCSP_binding[0];

			Object[] result_pattern_MethodInvocation_12_4_solveCSP_black = pattern_MethodInvocation_12_4_solveCSP_blackB(
					csp);
			if (result_pattern_MethodInvocation_12_4_solveCSP_black != null) {
	...
	public static final boolean pattern_MethodInvocation_12_5_checkCSP_expressionFBB(MethodInvocation _this, CSP csp) {
		boolean _localVariable_0 = _this.isApplicable_checkCsp_BWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_12_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_MethodInvocation_12_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "MethodInvocation";
	...
	public static final IsApplicableRuleResult pattern_MethodInvocation_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_20_1_preparereturnvalue_bindingFB(MethodInvocation _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_MethodInvocation_20_1_preparereturnvalue_blackFBBF(EClass __eClass,
			MethodInvocation _this) {
	...
	public static final Object[] pattern_MethodInvocation_20_1_preparereturnvalue_bindingAndBlackFFBF(
			MethodInvocation _this) {
		Object[] result_pattern_MethodInvocation_20_1_preparereturnvalue_binding = pattern_MethodInvocation_20_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_MethodInvocation_20_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_MethodInvocation_20_1_preparereturnvalue_binding[0];

			Object[] result_pattern_MethodInvocation_20_1_preparereturnvalue_black = pattern_MethodInvocation_20_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_MethodInvocation_20_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_MethodInvocation_20_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_MethodInvocation_20_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_MethodInvocation_20_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_MethodInvocation_20_2_testcorematchandDECs_blackFFFB(
	...
	public static final Object[] pattern_MethodInvocation_20_2_testcorematchandDECs_greenFB(EClass __eClass) {
	...
	public static final boolean pattern_MethodInvocation_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			MethodInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
	...
	public static final boolean pattern_MethodInvocation_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			MethodInvocation _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_BWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_20_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_MethodInvocation_20_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_MethodInvocation_20_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_21_1_preparereturnvalue_bindingFB(MethodInvocation _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
			return new Object[] { __eClass, _this };
	...
	public static final Object[] pattern_MethodInvocation_21_1_preparereturnvalue_blackFBBF(EClass __eClass,
			MethodInvocation _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperation_name = __performOperation.getName();
	...
	public static final Object[] pattern_MethodInvocation_21_1_preparereturnvalue_bindingAndBlackFFBF(
			MethodInvocation _this) {
		Object[] result_pattern_MethodInvocation_21_1_preparereturnvalue_binding = pattern_MethodInvocation_21_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_MethodInvocation_21_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_MethodInvocation_21_1_preparereturnvalue_binding[0];

			Object[] result_pattern_MethodInvocation_21_1_preparereturnvalue_black = pattern_MethodInvocation_21_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_MethodInvocation_21_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_MethodInvocation_21_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_MethodInvocation_21_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_MethodInvocation_21_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_MethodInvocation_21_2_testcorematchandDECs_black_nac_0B(
		...
		for (AnnotationMemberValuePair __DEC_invocation_value_79937 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_MethodInvocation_21_2_testcorematchandDECs_black_nac_1BB(
		...
		for (MDefinition __DEC_invocation_mMethodInvocations_161880 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_161880)) {
	...
	public static final Iterable<Object[]> pattern_MethodInvocation_21_2_testcorematchandDECs_blackFFFB(
		...
		if (tmpInvocation instanceof MMethodInvocation) {
			...
			if (tmpMMethod instanceof AbstractMethodDeclaration) {
				AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) tmpMMethod;
				if (mMethod.equals(invocation.getMethod())) {
					if (pattern_MethodInvocation_21_2_testcorematchandDECs_black_nac_0B(invocation) == null) {
						for (MDefinition mMember : org.moflon.core.utilities.eMoflonEMFUtil
								.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
							if (pattern_MethodInvocation_21_2_testcorematchandDECs_black_nac_1BB(invocation,
									mMember) == null) {
	...
	public static final Object[] pattern_MethodInvocation_21_2_testcorematchandDECs_greenFB(EClass __eClass) {
		Match match = RuntimeFactory.eINSTANCE.createMatch();
		String __eClass_name = __eClass.getName();
		String match_ruleName_prime = __eClass_name;
		match.setRuleName(match_ruleName_prime);
	...
	public static final boolean pattern_MethodInvocation_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			MethodInvocation _this, Match match, MMethodInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	...
	public static final boolean pattern_MethodInvocation_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			MethodInvocation _this, Match match) {
	...
	public static final Object[] pattern_MethodInvocation_21_5_Addmatchtoruleresult_blackBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		if (!__performOperation.equals(isApplicableCC)) {
			return new Object[] { match, __performOperation, __result, isApplicableCC };
		}
	...
	public static final Object[] pattern_MethodInvocation_21_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
		match.setIsApplicableCCOperation(isApplicableCC);
	...
	public static final EObjectContainer pattern_MethodInvocation_21_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_24_1_prepare_blackB(MethodInvocation _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_MethodInvocation_24_1_prepare_greenF() {
		IsApplicableRuleResult result = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		return new Object[] { result };
	}

	public static final Object[] pattern_MethodInvocation_24_2_matchsrctrgcontext_bindingFFFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_MethodInvocation_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MMethodInvocation invocation, TMember tMember, TCall tAccess, TMember tMethod, MDefinition mMember,
	...
	public static final Object[] pattern_MethodInvocation_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_MethodInvocation_24_2_matchsrctrgcontext_binding = pattern_MethodInvocation_24_2_matchsrctrgcontext_bindingFFFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_MethodInvocation_24_2_matchsrctrgcontext_binding != null) {
			MMethodInvocation invocation = (MMethodInvocation) result_pattern_MethodInvocation_24_2_matchsrctrgcontext_binding[0];
			TMember tMember = (TMember) result_pattern_MethodInvocation_24_2_matchsrctrgcontext_binding[1];
			TCall tAccess = (TCall) result_pattern_MethodInvocation_24_2_matchsrctrgcontext_binding[2];
			TMember tMethod = (TMember) result_pattern_MethodInvocation_24_2_matchsrctrgcontext_binding[3];
			MDefinition mMember = (MDefinition) result_pattern_MethodInvocation_24_2_matchsrctrgcontext_binding[4];
			AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) result_pattern_MethodInvocation_24_2_matchsrctrgcontext_binding[5];

			Object[] result_pattern_MethodInvocation_24_2_matchsrctrgcontext_black = pattern_MethodInvocation_24_2_matchsrctrgcontext_blackBBBBBBBB(
					invocation, tMember, tAccess, tMethod, mMember, mMethod, sourceMatch, targetMatch);
			if (result_pattern_MethodInvocation_24_2_matchsrctrgcontext_black != null) {
	...
	public static final Object[] pattern_MethodInvocation_24_3_solvecsp_bindingFBBBBBBBBB(MethodInvocation _this,
			MMethodInvocation invocation, TMember tMember, TCall tAccess, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_MethodInvocation_24_3_solvecsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_MethodInvocation_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			MethodInvocation _this, MMethodInvocation invocation, TMember tMember, TCall tAccess, TMember tMethod,
			MDefinition mMember, AbstractMethodDeclaration mMethod, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_MethodInvocation_24_3_solvecsp_binding = pattern_MethodInvocation_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, invocation, tMember, tAccess, tMethod, mMember, mMethod, sourceMatch, targetMatch);
		if (result_pattern_MethodInvocation_24_3_solvecsp_binding != null) {
			CSP csp = (CSP) result_pattern_MethodInvocation_24_3_solvecsp_binding[0];

			Object[] result_pattern_MethodInvocation_24_3_solvecsp_black = pattern_MethodInvocation_24_3_solvecsp_blackB(
					csp);
			if (result_pattern_MethodInvocation_24_3_solvecsp_black != null) {
	...
	public static final boolean pattern_MethodInvocation_24_4_checkCSP_expressionFB(CSP csp) {
		boolean _localVariable_0 = csp.check();
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Iterable<Object[]> pattern_MethodInvocation_24_5_matchcorrcontext_blackFBFBBBBB(TMember tMember,
	...
	public static final Object[] pattern_MethodInvocation_24_5_matchcorrcontext_greenBBBBF(
			MDefinitionToTMember mMemberToTMember, MDefinitionToTMember mMethodToTMethod, Match sourceMatch,
			Match targetMatch) {
		CCMatch ccMatch = RuntimeFactory.eINSTANCE.createCCMatch();
		String ccMatch_ruleName_prime = "MethodInvocation";
	...
	public static final Object[] pattern_MethodInvocation_24_6_createcorrespondence_blackBBBBBBB(
			MMethodInvocation invocation, TMember tMember, TCall tAccess, TMember tMethod, MDefinition mMember,
	...
	public static final Object[] pattern_MethodInvocation_24_6_createcorrespondence_greenBBFFB(
	...
	public static final Object[] pattern_MethodInvocation_24_7_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
		return new Object[] { result, ccMatch };
	}

	public static final Object[] pattern_MethodInvocation_24_7_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
	...
	public static final IsApplicableRuleResult pattern_MethodInvocation_24_8_expressionFB(
	...
	public static final Object[] pattern_MethodInvocation_27_1_matchtggpattern_black_nac_0B(
			MMethodInvocation invocation) {
		for (AnnotationMemberValuePair __DEC_invocation_value_646357 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { invocation };
		}
		return null;
	...
	public static final Object[] pattern_MethodInvocation_27_1_matchtggpattern_black_nac_1BB(
			MMethodInvocation invocation, MDefinition mMember) {
		for (MDefinition __DEC_invocation_mMethodInvocations_909258 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_909258)) {
				return new Object[] { invocation, mMember };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodInvocation_27_1_matchtggpattern_blackBBB(MMethodInvocation invocation,
			MDefinition mMember, AbstractMethodDeclaration mMethod) {
		if (mMethod.equals(invocation.getMethod())) {
			if (mMember.getMMethodInvocations().contains(invocation)) {
				if (pattern_MethodInvocation_27_1_matchtggpattern_black_nac_0B(invocation) == null) {
					if (pattern_MethodInvocation_27_1_matchtggpattern_black_nac_1BB(invocation, mMember) == null) {
	...
	public static final boolean pattern_MethodInvocation_27_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_MethodInvocation_27_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_28_1_matchtggpattern_blackBBB(TMember tMember, TCall tAccess,
			TMember tMethod) {
		if (!tMember.equals(tMethod)) {
			if (tMember.getTAccessing().contains(tAccess)) {
				if (tMethod.equals(tAccess.getTTarget())) {
	...
	public static final boolean pattern_MethodInvocation_28_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_MethodInvocation_28_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_29_1_createresult_blackB(MethodInvocation _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_MethodInvocation_29_1_createresult_greenFF() {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_MethodInvocation_29_2_isapplicablecore_black_nac_0BB(
	...
	public static final Object[] pattern_MethodInvocation_29_2_isapplicablecore_black_nac_3BB(
	...
	public static final Object[] pattern_MethodInvocation_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_MethodInvocation_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Iterable<Object[]> pattern_MethodInvocation_29_2_isapplicablecore_blackFFFFFFFFBB(
													...
													if (tmpMMethodToTMethod instanceof MDefinitionToTMember) {
														...
														if (!mMemberToTMember.equals(mMethodToTMethod)) {
															...
															if (tmpMMethod instanceof AbstractMethodDeclaration) {
																...
																if (tMethod != null) {
																	if (!tMember.equals(tMethod)) {
																		if (pattern_MethodInvocation_29_2_isapplicablecore_black_nac_3BB(
																				ruleResult, mMethodToTMethod) == null) {
																			if (pattern_MethodInvocation_29_2_isapplicablecore_black_nac_4BB(
																					ruleResult, mMethod) == null) {
																				if (pattern_MethodInvocation_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Object[] pattern_MethodInvocation_29_3_solveCSP_bindingFBBBBBBBBB(MethodInvocation _this,
	...
	public static final Object[] pattern_MethodInvocation_29_3_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_MethodInvocation_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			MethodInvocation _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			TMember tMember, MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_MethodInvocation_29_3_solveCSP_binding = pattern_MethodInvocation_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mMemberToTMember, tMember, mMethodToTMethod, tMethod, mMember, mMethod,
				ruleResult);
		if (result_pattern_MethodInvocation_29_3_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_MethodInvocation_29_3_solveCSP_binding[0];

			Object[] result_pattern_MethodInvocation_29_3_solveCSP_black = pattern_MethodInvocation_29_3_solveCSP_blackB(
					csp);
			if (result_pattern_MethodInvocation_29_3_solveCSP_black != null) {
	...
	public static final boolean pattern_MethodInvocation_29_4_checkCSP_expressionFBB(MethodInvocation _this, CSP csp) {
		boolean _localVariable_0 = _this.generateModel_checkCsp_BWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_MethodInvocation_29_5_checknacs_blackBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
	...
	public static final Object[] pattern_MethodInvocation_29_6_perform_blackBBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod,
	...
	public static final Object[] pattern_MethodInvocation_29_6_perform_greenFBFBBFFBB(TMember tMember, TMember tMethod,
			MDefinition mMember, AbstractMethodDeclaration mMethod, ModelgeneratorRuleResult ruleResult) {
		MMethodInvocation invocation = ModiscoFactory.eINSTANCE.createMMethodInvocation();
		TCall tAccess = BasicFactory.eINSTANCE.createTCall();
		MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement = PmFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
	...
	public static final ModelgeneratorRuleResult pattern_MethodInvocation_29_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
