...
public class VariableDeclarationFragmentImpl extends AbstractRuleImpl implements VariableDeclarationFragment {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = VariableDeclarationFragmentImpl
				.pattern_VariableDeclarationFragment_1_3_bookkeepingforedges_blackBBBBBB(ruleresult, mDefinition,
						tDefinition, varDeclFragment, eFieldDeclarationToTFieldDefinition,
						varDeclFragmentToTFieldDefinition);
		...
		VariableDeclarationFragmentImpl.pattern_VariableDeclarationFragment_1_3_bookkeepingforedges_greenBBBBBFFFF(
				ruleresult, mDefinition, tDefinition, varDeclFragment, varDeclFragmentToTFieldDefinition);
		...
		VariableDeclarationFragmentImpl.pattern_VariableDeclarationFragment_1_5_registerobjects_expressionBBBBBBB(this,
				ruleresult, mDefinition, tDefinition, varDeclFragment, eFieldDeclarationToTFieldDefinition,
				varDeclFragmentToTFieldDefinition);
	...
	public static final Object[] pattern_VariableDeclarationFragment_1_3_bookkeepingforedges_blackBBBBBB(
			PerformRuleResult ruleresult, EObject mDefinition, EObject tDefinition, EObject varDeclFragment,
									...
									if (!eFieldDeclarationToTFieldDefinition.equals(tDefinition)) {
										if (!eFieldDeclarationToTFieldDefinition.equals(varDeclFragment)) {
											if (!eFieldDeclarationToTFieldDefinition
												...
												return new Object[] { ruleresult, mDefinition, tDefinition,
														varDeclFragment, eFieldDeclarationToTFieldDefinition,
														varDeclFragmentToTFieldDefinition };
											}
										}
	...
	public static final Object[] pattern_VariableDeclarationFragment_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		return new Object[] { ruleresult, mDefinition, tDefinition, varDeclFragment, varDeclFragmentToTFieldDefinition,
	...
	public static final void pattern_VariableDeclarationFragment_1_5_registerobjects_expressionBBBBBBB(
			VariableDeclarationFragment _this, PerformRuleResult ruleresult, EObject mDefinition, EObject tDefinition,
			EObject varDeclFragment, EObject eFieldDeclarationToTFieldDefinition,
			EObject varDeclFragmentToTFieldDefinition) {
		_this.registerObjects_FWD(ruleresult, mDefinition, tDefinition, varDeclFragment,
				eFieldDeclarationToTFieldDefinition, varDeclFragmentToTFieldDefinition);
	...
	public static final Object[] pattern_VariableDeclarationFragment_26_6_perform_greenBBFFB(
		...
		return new Object[] { mDefinition, tDefinition, varDeclFragment, varDeclFragmentToTFieldDefinition,
				ruleResult };
	}
