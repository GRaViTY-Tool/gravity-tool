...
public class InterfaceInPackageImpl extends AbstractRuleImpl implements InterfaceInPackage {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_IN_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_61__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_61((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_IN_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_63__EMOFLONEDGE:
	...
	public static final Object[] pattern_InterfaceInPackage_20_2_testcorematchandDECs_black_nac_0BB(TInterface tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_interfaces_706722 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "interfaces")) {
			if (!tPackage.equals(__DEC_tType_interfaces_706722)) {
	...
	public static final Object[] pattern_InterfaceInPackage_20_2_testcorematchandDECs_black_nac_1BB(TInterface tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_interfaces_571624 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tType_interfaces_571624)) {
	...
	public static final Object[] pattern_InterfaceInPackage_20_2_testcorematchandDECs_black_nac_2BB(TInterface tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_156662 = tType.getPackage();
		if (__DEC_tType_ownedTypes_156662 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_156662)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_InterfaceInPackage_20_2_testcorematchandDECs_black_nac_3B(TInterface tType) {
		TAbstractType __DEC_tType_innerTypes_370987 = tType.getOuterType();
		if (__DEC_tType_innerTypes_370987 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_370987)) {
	...
	public static final Object[] pattern_InterfaceInPackage_21_2_testcorematchandDECs_black_nac_0B(
			InterfaceDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_841934 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_841934 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_841934)) {
	...
	public static final Object[] pattern_InterfaceInPackage_21_2_testcorematchandDECs_black_nac_1B(
			InterfaceDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_806178 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_806178 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_InterfaceInPackage_21_2_testcorematchandDECs_black_nac_2B(
			InterfaceDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_798735 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceInPackage_27_1_matchtggpattern_black_nac_0B(
			InterfaceDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_719713 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_719713 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_719713)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_InterfaceInPackage_27_1_matchtggpattern_black_nac_1B(
			InterfaceDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_116553 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_116553 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_InterfaceInPackage_27_1_matchtggpattern_black_nac_2B(
			InterfaceDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_711001 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceInPackage_28_1_matchtggpattern_black_nac_0BB(TInterface tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_interfaces_463716 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "interfaces")) {
			if (!tPackage.equals(__DEC_tType_interfaces_463716)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceInPackage_28_1_matchtggpattern_black_nac_1BB(TInterface tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_interfaces_320854 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tType_interfaces_320854)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceInPackage_28_1_matchtggpattern_black_nac_2BB(TInterface tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_616726 = tType.getPackage();
		if (__DEC_tType_ownedTypes_616726 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_616726)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_InterfaceInPackage_28_1_matchtggpattern_black_nac_3B(TInterface tType) {
		TAbstractType __DEC_tType_innerTypes_810092 = tType.getOuterType();
		if (__DEC_tType_innerTypes_810092 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_810092)) {
				return new Object[] { tType };
			}
		}
