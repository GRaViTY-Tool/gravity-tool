...
public class ModelToPgImpl extends AbstractRuleImpl implements ModelToPg {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = ModelToPgImpl.pattern_ModelToPg_1_2_collecttranslatedelements_blackBBBBB(mModel, tPG,
				mModelToTPG, primitives, proxies);
		...
		Object[] result2_green = ModelToPgImpl.pattern_ModelToPg_1_2_collecttranslatedelements_greenFBBBBB(mModel, tPG,
				mModelToTPG, primitives, proxies);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = ModelToPgImpl.pattern_ModelToPg_1_3_bookkeepingforedges_blackBBBBBB(ruleresult, mModel,
				tPG, mModelToTPG, primitives, proxies);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModel] = " + mModel + ", " + "[tPG] = " + tPG + ", " + "[mModelToTPG] = " + mModelToTPG
					+ ", " + "[primitives] = " + primitives + ", " + "[proxies] = " + proxies + ".");
		}
		ModelToPgImpl.pattern_ModelToPg_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, mModel, tPG, mModelToTPG,
				primitives, proxies);
		//nothing EMoflonEdge tPG__primitives____modules = (EMoflonEdge) result3_green[6];
		...
		//nothing EMoflonEdge tPG__proxies____modules = (EMoflonEdge) result3_green[9];

		// 
		// 
		ModelToPgImpl.pattern_ModelToPg_1_5_registerobjects_expressionBBBBBBB(this, ruleresult, mModel, tPG,
				mModelToTPG, primitives, proxies);
	...
	public boolean isAppropriate_BWD(Match match, TypeGraph tPG, TModule primitives, TModule proxies) {
		...
		if (ModelToPgImpl.pattern_ModelToPg_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			ModelToPgImpl.pattern_ModelToPg_10_4_collectelementstobetranslated_greenBBBBFF(match, tPG, primitives,
					proxies);
			//nothing EMoflonEdge tPG__primitives____modules = (EMoflonEdge) result4_green[4];
			//nothing EMoflonEdge tPG__proxies____modules = (EMoflonEdge) result4_green[5];
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = ModelToPgImpl.pattern_ModelToPg_11_2_collecttranslatedelements_blackBBBBB(mModel, tPG,
				mModelToTPG, primitives, proxies);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModel] = " + mModel + ", "
					+ "[tPG] = " + tPG + ", " + "[mModelToTPG] = " + mModelToTPG + ", " + "[primitives] = " + primitives
		...
		Object[] result2_green = ModelToPgImpl.pattern_ModelToPg_11_2_collecttranslatedelements_greenFBBBBB(mModel, tPG,
				mModelToTPG, primitives, proxies);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = ModelToPgImpl.pattern_ModelToPg_11_3_bookkeepingforedges_blackBBBBBB(ruleresult,
				mModel, tPG, mModelToTPG, primitives, proxies);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModel] = " + mModel + ", " + "[tPG] = " + tPG + ", " + "[mModelToTPG] = " + mModelToTPG
					+ ", " + "[primitives] = " + primitives + ", " + "[proxies] = " + proxies + ".");
		}
		ModelToPgImpl.pattern_ModelToPg_11_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, mModel, tPG, mModelToTPG,
				primitives, proxies);
		//nothing EMoflonEdge tPG__primitives____modules = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mModelToTPG__mModel____source = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mModelToTPG__tPG____target = (EMoflonEdge) result3_green[8];
		...
		// 
		// 
		ModelToPgImpl.pattern_ModelToPg_11_5_registerobjects_expressionBBBBBBB(this, ruleresult, mModel, tPG,
				mModelToTPG, primitives, proxies);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : ModelToPgImpl.pattern_ModelToPg_12_2_corematch_blackBBBB(tPG, primitives, proxies,
			...
			for (Object[] result3_black : ModelToPgImpl.pattern_ModelToPg_12_3_findcontext_blackBBB(tPG, primitives,
				...
				//nothing EMoflonEdge tPG__primitives____modules = (EMoflonEdge) result3_green[4];
				//nothing EMoflonEdge tPG__proxies____modules = (EMoflonEdge) result3_green[5];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_MGravityModel_7(MGravityModel mModel) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_585(EMoflonEdge _edge_modules) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MODEL_TO_PG___IS_APPROPRIATE_FWD_MGRAVITY_MODEL_7__MGRAVITYMODEL:
			return isAppropriate_FWD_MGravityModel_7((MGravityModel) arguments.get(0));
		case RulesPackage.MODEL_TO_PG___IS_APPROPRIATE_BWD_EMOFLON_EDGE_585__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_585((EMoflonEdge) arguments.get(0));
	...
	public static final Object[] pattern_ModelToPg_1_1_performtransformation_greenBFFFFB(MGravityModel mModel,
		...
		return new Object[] { mModel, tPG, mModelToTPG, primitives, proxies, csp };
	}

	public static final Object[] pattern_ModelToPg_1_2_collecttranslatedelements_blackBBBBB(MGravityModel mModel,
			TypeGraph tPG, ModelToTypeGraph mModelToTPG, TModule primitives, TModule proxies) {
		if (!primitives.equals(proxies)) {
			return new Object[] { mModel, tPG, mModelToTPG, primitives, proxies };
		}
		return null;
	}
	...
	public static final Object[] pattern_ModelToPg_1_2_collecttranslatedelements_greenFBBBBB(MGravityModel mModel,
		...
		return new Object[] { ruleresult, mModel, tPG, mModelToTPG, primitives, proxies };
	}

	public static final Object[] pattern_ModelToPg_1_3_bookkeepingforedges_blackBBBBBB(PerformRuleResult ruleresult,
			EObject mModel, EObject tPG, EObject mModelToTPG, EObject primitives, EObject proxies) {
									...
									if (!primitives.equals(tPG)) {
										if (!primitives.equals(proxies)) {
											if (!proxies.equals(tPG)) {
												return new Object[] { ruleresult, mModel, tPG, mModelToTPG, primitives,
														proxies };
											}
										}
									}
	...
	public static final Object[] pattern_ModelToPg_1_3_bookkeepingforedges_greenBBBBBBFFFF(PerformRuleResult ruleresult,
		...
		return new Object[] { ruleresult, mModel, tPG, mModelToTPG, primitives, proxies, tPG__primitives____modules,
				mModelToTPG__mModel____source, mModelToTPG__tPG____target, tPG__proxies____modules };
	}

	public static final void pattern_ModelToPg_1_5_registerobjects_expressionBBBBBBB(ModelToPg _this,
			PerformRuleResult ruleresult, EObject mModel, EObject tPG, EObject mModelToTPG, EObject primitives,
			EObject proxies) {
		_this.registerObjects_FWD(ruleresult, mModel, tPG, mModelToTPG, primitives, proxies);
	...
	public static final Object[] pattern_ModelToPg_10_4_collectelementstobetranslated_greenBBBBFF(Match match,
		...
		tPG__primitives____modules.setName(tPG__primitives____modules_name_prime);
		tPG__proxies____modules.setName(tPG__proxies____modules_name_prime);
		return new Object[] { match, tPG, primitives, proxies, tPG__primitives____modules, tPG__proxies____modules };
	}
	...
	public static final void pattern_ModelToPg_11_5_registerobjects_expressionBBBBBBB(ModelToPg _this,
			PerformRuleResult ruleresult, EObject mModel, EObject tPG, EObject mModelToTPG, EObject primitives,
			EObject proxies) {
		_this.registerObjects_BWD(ruleresult, mModel, tPG, mModelToTPG, primitives, proxies);
	...
	public static final Object[] pattern_ModelToPg_12_3_findcontext_greenBBBFFF(TypeGraph tPG, TModule primitives,
		...
		tPG__primitives____modules.setName(tPG__primitives____modules_name_prime);
		tPG__proxies____modules.setName(tPG__proxies____modules_name_prime);
		return new Object[] { tPG, primitives, proxies, isApplicableMatch, tPG__primitives____modules,
				tPG__proxies____modules };
	}
	...
	public static final Iterable<Object[]> pattern_ModelToPg_21_2_testcorematchandDECs_blackFFFB(
		...
		if (tmpTPG instanceof TypeGraph) {
			TypeGraph tPG = (TypeGraph) tmpTPG;
			EObject tmpPrimitives = _edge_modules.getTrg();
			if (tmpPrimitives instanceof TModule) {
				TModule primitives = (TModule) tmpPrimitives;
				if (tPG.getModules().contains(primitives)) {
					String primitives_location = primitives.getLocation();
					if (primitives_location.equals("${JVM.PRIMITIVES}")) {
						for (TModule proxies : tPG.getModules()) {
							if (!primitives.equals(proxies)) {
								String proxies_location = proxies.getLocation();
								if (proxies_location.equals("${PROXIES}")) {
	...
	public static final Object[] pattern_ModelToPg_29_6_perform_greenFFFFFBB(ModelgeneratorRuleResult ruleResult,
		...
		return new Object[] { mModel, tPG, mModelToTPG, primitives, proxies, ruleResult, csp };
	}
