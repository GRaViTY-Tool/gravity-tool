...
public class ModelToPgImpl extends AbstractRuleImpl implements ModelToPg {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = ModelToPgImpl.pattern_ModelToPg_1_2_collecttranslatedelements_blackBBBB(mModel,
				mModelToTPG, tPG, tProxyPackage);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModel] = " + mModel + ", "
					+ "[mModelToTPG] = " + mModelToTPG + ", " + "[tPG] = " + tPG + ", " + "[tProxyPackage] = "
					+ tProxyPackage + ".");
		}
		Object[] result2_green = ModelToPgImpl.pattern_ModelToPg_1_2_collecttranslatedelements_greenFBBBB(mModel,
				mModelToTPG, tPG, tProxyPackage);
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModel] = " + mModel + ", " + "[mModelToTPG] = " + mModelToTPG + ", " + "[tPG] = " + tPG
					+ ", " + "[tProxyPackage] = " + tProxyPackage + ".");
		}
		ModelToPgImpl.pattern_ModelToPg_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, mModel, mModelToTPG, tPG,
				tProxyPackage);
		//nothing EMoflonEdge mModelToTPG__mModel____source = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge tPG__tProxyPackage____packages = (EMoflonEdge) result3_green[6];
		...
		// 
		// 
		ModelToPgImpl.pattern_ModelToPg_1_5_registerobjects_expressionBBBBBB(this, ruleresult, mModel, mModelToTPG, tPG,
				tProxyPackage);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = ModelToPgImpl.pattern_ModelToPg_11_2_collecttranslatedelements_blackBBBB(mModel,
				mModelToTPG, tPG, tProxyPackage);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModel] = " + mModel + ", "
					+ "[mModelToTPG] = " + mModelToTPG + ", " + "[tPG] = " + tPG + ", " + "[tProxyPackage] = "
		...
		Object[] result2_green = ModelToPgImpl.pattern_ModelToPg_11_2_collecttranslatedelements_greenFBBBB(mModel,
				mModelToTPG, tPG, tProxyPackage);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		ModelToPgImpl.pattern_ModelToPg_11_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, mModel, mModelToTPG, tPG,
				tProxyPackage);
		//nothing EMoflonEdge mModelToTPG__mModel____source = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge tPG__tProxyPackage____packages = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mModelToTPG__tPG____target = (EMoflonEdge) result3_green[7];
		...
		// 
		// 
		ModelToPgImpl.pattern_ModelToPg_11_5_registerobjects_expressionBBBBBB(this, ruleresult, mModel, mModelToTPG,
				tPG, tProxyPackage);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_92(EMoflonEdge _edge_packages) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MODEL_TO_PG___IS_APPROPRIATE_BWD_EMOFLON_EDGE_92__EMOFLONEDGE:
	...
	public static final Object[] pattern_ModelToPg_1_1_performtransformation_greenBFFFB(MGravityModel mModel, CSP csp) {
		...
		return new Object[] { mModel, mModelToTPG, tPG, tProxyPackage, csp };
	}

	public static final Object[] pattern_ModelToPg_1_2_collecttranslatedelements_blackBBBB(MGravityModel mModel,
			ModelToTypeGraph mModelToTPG, TypeGraph tPG, TPackage tProxyPackage) {
		return new Object[] { mModel, mModelToTPG, tPG, tProxyPackage };
	}
	...
	public static final Object[] pattern_ModelToPg_1_2_collecttranslatedelements_greenFBBBB(MGravityModel mModel,
		...
		return new Object[] { ruleresult, mModel, mModelToTPG, tPG, tProxyPackage };
	}

	public static final Object[] pattern_ModelToPg_1_3_bookkeepingforedges_blackBBBBB(PerformRuleResult ruleresult,
			EObject mModel, EObject mModelToTPG, EObject tPG, EObject tProxyPackage) {
	...
	public static final Object[] pattern_ModelToPg_1_3_bookkeepingforedges_greenBBBBBFFFF(PerformRuleResult ruleresult,
		...
		return new Object[] { ruleresult, mModel, mModelToTPG, tPG, tProxyPackage, mModelToTPG__mModel____source,
				tPG__tProxyPackage____packages, mModelToTPG__tPG____target, tProxyPackage__tPG____model };
	}

	public static final void pattern_ModelToPg_1_5_registerobjects_expressionBBBBBB(ModelToPg _this,
			PerformRuleResult ruleresult, EObject mModel, EObject mModelToTPG, EObject tPG, EObject tProxyPackage) {
		_this.registerObjects_FWD(ruleresult, mModel, mModelToTPG, tPG, tProxyPackage);
	...
	public static final Object[] pattern_ModelToPg_10_4_collectelementstobetranslated_greenBBBFF(Match match,
		...
		tPG__tProxyPackage____packages.setName(tPG__tProxyPackage____packages_name_prime);
		tProxyPackage__tPG____model.setName(tProxyPackage__tPG____model_name_prime);
		return new Object[] { match, tPG, tProxyPackage, tPG__tProxyPackage____packages, tProxyPackage__tPG____model };
	}
	...
	public static final void pattern_ModelToPg_11_5_registerobjects_expressionBBBBBB(ModelToPg _this,
			PerformRuleResult ruleresult, EObject mModel, EObject mModelToTPG, EObject tPG, EObject tProxyPackage) {
		_this.registerObjects_BWD(ruleresult, mModel, mModelToTPG, tPG, tProxyPackage);
	...
	public static final Object[] pattern_ModelToPg_21_2_testcorematchandDECs_black_nac_0B(TPackage tProxyPackage) {
		TPackage __DEC_tProxyPackage_subpackages_329607 = tProxyPackage.getParent();
		if (__DEC_tProxyPackage_subpackages_329607 != null) {
			if (!tProxyPackage.equals(__DEC_tProxyPackage_subpackages_329607)) {
	...
	public static final Object[] pattern_ModelToPg_28_1_matchtggpattern_black_nac_0B(TPackage tProxyPackage) {
		TPackage __DEC_tProxyPackage_subpackages_343796 = tProxyPackage.getParent();
		if (__DEC_tProxyPackage_subpackages_343796 != null) {
			if (!tProxyPackage.equals(__DEC_tProxyPackage_subpackages_343796)) {
				return new Object[] { tProxyPackage };
			}
		}
	...
	public static final Object[] pattern_ModelToPg_29_6_perform_greenFFFFBB(ModelgeneratorRuleResult ruleResult,
		...
		return new Object[] { mModel, mModelToTPG, tPG, tProxyPackage, ruleResult, csp };
	}
