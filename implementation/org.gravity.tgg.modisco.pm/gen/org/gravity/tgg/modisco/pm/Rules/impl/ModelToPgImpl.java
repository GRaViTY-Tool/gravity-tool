...
public class ModelToPgImpl extends AbstractRuleImpl implements ModelToPg {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = ModelToPgImpl.pattern_ModelToPg_1_2_collecttranslatedelements_blackBBBBB(primitives,
				tPG, mModelToTPG, mModel, proxies);
		...
		Object[] result3_black = ModelToPgImpl.pattern_ModelToPg_1_3_bookkeepingforedges_blackBBBBBB(ruleresult,
				primitives, tPG, mModelToTPG, mModel, proxies);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[primitives] = " + primitives + ", " + "[tPG] = " + tPG + ", " + "[mModelToTPG] = "
					+ mModelToTPG + ", " + "[mModel] = " + mModel + ", " + "[proxies] = " + proxies + ".");
		}
		ModelToPgImpl.pattern_ModelToPg_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, primitives, tPG,
				mModelToTPG, mModel, proxies);
		...
		// 
		// 
		ModelToPgImpl.pattern_ModelToPg_1_5_registerobjects_expressionBBBBBBB(this, ruleresult, primitives, tPG,
				mModelToTPG, mModel, proxies);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject primitives, EObject tPG, EObject mModelToTPG,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		ModelToPgImpl.pattern_ModelToPg_11_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, primitives, tPG,
				mModelToTPG, mModel, proxies);
		//nothing EMoflonEdge tPG__primitives____modules = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mModelToTPG__mModel____source = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mModelToTPG__tPG____target = (EMoflonEdge) result3_green[8];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject primitives, EObject tPG, EObject mModelToTPG,
			EObject mModel, EObject proxies) {
		ruleresult.registerObject("primitives", primitives);
		ruleresult.registerObject("tPG", tPG);
		ruleresult.registerObject("mModelToTPG", mModelToTPG);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_34(EMoflonEdge _edge_modules) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MODEL_TO_PG___IS_APPROPRIATE_BWD_EMOFLON_EDGE_34__EMOFLONEDGE:
	...
	public static final Object[] pattern_ModelToPg_1_1_performtransformation_greenFFFBFB(MGravityModel mModel,
		...
		return new Object[] { primitives, tPG, mModelToTPG, mModel, proxies, csp };
	}

	public static final Object[] pattern_ModelToPg_1_2_collecttranslatedelements_blackBBBBB(TModule primitives,
			TypeGraph tPG, ModelToTypeGraph mModelToTPG, MGravityModel mModel, TModule proxies) {
		if (!primitives.equals(proxies)) {
			return new Object[] { primitives, tPG, mModelToTPG, mModel, proxies };
		}
		return null;
	}
	...
	public static final Object[] pattern_ModelToPg_1_2_collecttranslatedelements_greenFBBBBB(TModule primitives,
		...
		return new Object[] { ruleresult, primitives, tPG, mModelToTPG, mModel, proxies };
	}

	public static final Object[] pattern_ModelToPg_1_3_bookkeepingforedges_blackBBBBBB(PerformRuleResult ruleresult,
			EObject primitives, EObject tPG, EObject mModelToTPG, EObject mModel, EObject proxies) {
									...
									if (!mModel.equals(mModelToTPG)) {
										if (!mModel.equals(proxies)) {
											if (!proxies.equals(tPG)) {
												return new Object[] { ruleresult, primitives, tPG, mModelToTPG, mModel,
														proxies };
											}
										}
									}
	...
	public static final Object[] pattern_ModelToPg_1_3_bookkeepingforedges_greenBBBBBBFFFF(PerformRuleResult ruleresult,
		...
		return new Object[] { ruleresult, primitives, tPG, mModelToTPG, mModel, proxies, tPG__primitives____modules,
	...
	public static final void pattern_ModelToPg_1_5_registerobjects_expressionBBBBBBB(ModelToPg _this,
			PerformRuleResult ruleresult, EObject primitives, EObject tPG, EObject mModelToTPG, EObject mModel,
			EObject proxies) {
		_this.registerObjects_FWD(ruleresult, primitives, tPG, mModelToTPG, mModel, proxies);
	...
	public static final Object[] pattern_ModelToPg_10_4_collectelementstobetranslated_greenBBBBFF(Match match,
		...
		tPG__primitives____modules.setName(tPG__primitives____modules_name_prime);
		tPG__proxies____modules.setName(tPG__proxies____modules_name_prime);
		return new Object[] { match, primitives, tPG, proxies, tPG__primitives____modules, tPG__proxies____modules };
	}
	...
	public static final void pattern_ModelToPg_11_5_registerobjects_expressionBBBBBBB(ModelToPg _this,
			PerformRuleResult ruleresult, EObject primitives, EObject tPG, EObject mModelToTPG, EObject mModel,
			EObject proxies) {
		_this.registerObjects_BWD(ruleresult, primitives, tPG, mModelToTPG, mModel, proxies);
	...
	public static final Object[] pattern_ModelToPg_12_3_findcontext_greenBBBFFF(TModule primitives, TypeGraph tPG,
		...
		tPG__primitives____modules.setName(tPG__primitives____modules_name_prime);
		tPG__proxies____modules.setName(tPG__proxies____modules_name_prime);
		return new Object[] { primitives, tPG, proxies, isApplicableMatch, tPG__primitives____modules,
	...
	public static final Object[] pattern_ModelToPg_29_6_perform_greenFFFFFBB(ModelgeneratorRuleResult ruleResult,
		...
		return new Object[] { primitives, tPG, mModelToTPG, mModel, proxies, ruleResult, csp };
	}
