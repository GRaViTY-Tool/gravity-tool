...
public class OrphanedEnumImpl extends AbstractRuleImpl implements OrphanedEnum {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ORPHANED_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_42__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_42((EMoflonEdge) arguments.get(0));
		case RulesPackage.ORPHANED_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_44__EMOFLONEDGE:
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_0BB(TClass tType,
			TPackage tProxyPackage) {
		for (TPackage __DEC_tType_classes_185048 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tProxyPackage.equals(__DEC_tType_classes_185048)) {
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_1BB(TClass tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_241760 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_241760)) {
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_2BB(TClass tType,
			TPackage tProxyPackage) {
		TPackage __DEC_tType_ownedTypes_804222 = tType.getPackage();
		if (__DEC_tType_ownedTypes_804222 != null) {
			if (!tProxyPackage.equals(__DEC_tType_ownedTypes_804222)) {
				return new Object[] { tType, tProxyPackage };
			}
		}
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_300907 = tType.getOuterType();
		if (__DEC_tType_innerTypes_300907 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_300907)) {
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_4BBBB(TEnum tEnum,
		...
		TAnnotatable __DEC_tEnum_tAnnotation_897069 = tEnum.getTAnnotated();
		if (__DEC_tEnum_tAnnotation_897069 != null) {
			if (!tType.equals(__DEC_tEnum_tAnnotation_897069)) {
				if (!pg.equals(__DEC_tEnum_tAnnotation_897069)) {
					if (!tProxyPackage.equals(__DEC_tEnum_tAnnotation_897069)) {
	...
	public static final Object[] pattern_OrphanedEnum_21_2_testcorematchandDECs_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_273695 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_273695 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_273695)) {
	...
	public static final Object[] pattern_OrphanedEnum_21_2_testcorematchandDECs_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_983091 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_983091 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_OrphanedEnum_21_2_testcorematchandDECs_black_nac_2B(EnumDeclaration mType) {
		org.eclipse.modisco.java.Package __DEC_mType_ownedElements_434197 = mType.getPackage();
		if (__DEC_mType_ownedElements_434197 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_OrphanedEnum_21_2_testcorematchandDECs_black_nac_3B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_879869 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_OrphanedEnum_27_1_matchtggpattern_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_582605 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_582605 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_582605)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_OrphanedEnum_27_1_matchtggpattern_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_171853 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_171853 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_OrphanedEnum_27_1_matchtggpattern_black_nac_2B(EnumDeclaration mType) {
		org.eclipse.modisco.java.Package __DEC_mType_ownedElements_826445 = mType.getPackage();
		if (__DEC_mType_ownedElements_826445 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_OrphanedEnum_27_1_matchtggpattern_black_nac_3B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_311207 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_0BB(TClass tType,
			TPackage tProxyPackage) {
		for (TPackage __DEC_tType_classes_424850 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tProxyPackage.equals(__DEC_tType_classes_424850)) {
				return new Object[] { tType, tProxyPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_800362 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_800362)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_2BB(TClass tType,
			TPackage tProxyPackage) {
		TPackage __DEC_tType_ownedTypes_396117 = tType.getPackage();
		if (__DEC_tType_ownedTypes_396117 != null) {
			if (!tProxyPackage.equals(__DEC_tType_ownedTypes_396117)) {
				return new Object[] { tType, tProxyPackage };
			}
		}
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_92060 = tType.getOuterType();
		if (__DEC_tType_innerTypes_92060 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_92060)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_4BBBB(TEnum tEnum, TClass tType,
		...
		TAnnotatable __DEC_tEnum_tAnnotation_618984 = tEnum.getTAnnotated();
		if (__DEC_tEnum_tAnnotation_618984 != null) {
			if (!tType.equals(__DEC_tEnum_tAnnotation_618984)) {
				if (!pg.equals(__DEC_tEnum_tAnnotation_618984)) {
					if (!tProxyPackage.equals(__DEC_tEnum_tAnnotation_618984)) {
						return new Object[] { tEnum, tType, pg, tProxyPackage };
					}
				}
			}
