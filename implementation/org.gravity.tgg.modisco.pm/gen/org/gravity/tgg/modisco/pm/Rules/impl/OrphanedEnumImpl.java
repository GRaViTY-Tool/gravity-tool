...
public class OrphanedEnumImpl extends AbstractRuleImpl implements OrphanedEnum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OrphanedEnumImpl.pattern_OrphanedEnum_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, tType, mAnnotatableToTAnnotatable, mTypeToTType, tEnum, pg, mModel, tProxyPackage, mType,
				mModelToTypeGraph);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[tType] = "
							+ tType + ", " + "[mAnnotatableToTAnnotatable] = " + mAnnotatableToTAnnotatable + ", "
							+ "[mTypeToTType] = " + mTypeToTType + ", " + "[tEnum] = " + tEnum + ", " + "[pg] = " + pg
		...
		OrphanedEnumImpl.pattern_OrphanedEnum_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(ruleresult, tType,
				mAnnotatableToTAnnotatable, mTypeToTType, tEnum, pg, mModel, tProxyPackage, mType);
		...
		OrphanedEnumImpl.pattern_OrphanedEnum_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, tType,
				mAnnotatableToTAnnotatable, mTypeToTType, tEnum, pg, mModel, tProxyPackage, mType, mModelToTypeGraph);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ORPHANED_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_69__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_69((EMoflonEdge) arguments.get(0));
		case RulesPackage.ORPHANED_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_71__EMOFLONEDGE:
	...
	public static final Object[] pattern_OrphanedEnum_1_1_performtransformation_greenFFFFBBBB(TypeGraph pg,
		...
		return new Object[] { tType, mAnnotatableToTAnnotatable, mTypeToTType, tEnum, pg, tProxyPackage, mType, csp };
	}
	...
	public static final Object[] pattern_OrphanedEnum_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, tType, mAnnotatableToTAnnotatable, mTypeToTType, tEnum, pg, mModel,
				tProxyPackage, mType, mModel__mType____orphanTypes, mAnnotatableToTAnnotatable__tType____target,
				mTypeToTType__tType____target, mAnnotatableToTAnnotatable__mType____source,
				mTypeToTType__mType____source, pg__tType____ownedTypes, tType__pg____model, tEnum__tType____tAnnotated,
	...
	public static final void pattern_OrphanedEnum_1_5_registerobjects_expressionBBBBBBBBBBB(OrphanedEnum _this,
			...
			EObject tEnum, EObject pg, EObject mModel, EObject tProxyPackage, EObject mType,
			EObject mModelToTypeGraph) {
		_this.registerObjects_FWD(ruleresult, tType, mAnnotatableToTAnnotatable, mTypeToTType, tEnum, pg, mModel,
				tProxyPackage, mType, mModelToTypeGraph);
	...
	public static final void pattern_OrphanedEnum_11_5_registerobjects_expressionBBBBBBBBBBB(OrphanedEnum _this,
			...
			EObject tEnum, EObject pg, EObject mModel, EObject tProxyPackage, EObject mType,
			EObject mModelToTypeGraph) {
		_this.registerObjects_BWD(ruleresult, tType, mAnnotatableToTAnnotatable, mTypeToTType, tEnum, pg, mModel,
				tProxyPackage, mType, mModelToTypeGraph);
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_0BB(TClass tType,
			TPackage tProxyPackage) {
		for (TPackage __DEC_tType_classes_654587 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tProxyPackage.equals(__DEC_tType_classes_654587)) {
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_1BB(TClass tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_79404 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_79404)) {
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_2BB(TClass tType,
			TPackage tProxyPackage) {
		TPackage __DEC_tType_ownedTypes_131247 = tType.getPackage();
		if (__DEC_tType_ownedTypes_131247 != null) {
			if (!tProxyPackage.equals(__DEC_tType_ownedTypes_131247)) {
				return new Object[] { tType, tProxyPackage };
			}
		}
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_791257 = tType.getOuterType();
		if (__DEC_tType_innerTypes_791257 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_791257)) {
	...
	public static final Object[] pattern_OrphanedEnum_20_2_testcorematchandDECs_black_nac_4BBBB(TEnum tEnum,
		...
		TAnnotatable __DEC_tEnum_tAnnotation_575840 = tEnum.getTAnnotated();
		if (__DEC_tEnum_tAnnotation_575840 != null) {
			if (!tType.equals(__DEC_tEnum_tAnnotation_575840)) {
				if (!pg.equals(__DEC_tEnum_tAnnotation_575840)) {
					if (!tProxyPackage.equals(__DEC_tEnum_tAnnotation_575840)) {
	...
	public static final Object[] pattern_OrphanedEnum_21_2_testcorematchandDECs_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_78023 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_78023 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_78023)) {
	...
	public static final Object[] pattern_OrphanedEnum_21_2_testcorematchandDECs_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_606287 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_606287 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_OrphanedEnum_21_2_testcorematchandDECs_black_nac_2B(EnumDeclaration mType) {
		org.eclipse.modisco.java.Package __DEC_mType_ownedElements_200375 = mType.getPackage();
		if (__DEC_mType_ownedElements_200375 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_OrphanedEnum_21_2_testcorematchandDECs_black_nac_3B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_86907 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_OrphanedEnum_27_1_matchtggpattern_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_810508 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_810508 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_810508)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_OrphanedEnum_27_1_matchtggpattern_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_137002 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_137002 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_OrphanedEnum_27_1_matchtggpattern_black_nac_2B(EnumDeclaration mType) {
		org.eclipse.modisco.java.Package __DEC_mType_ownedElements_830620 = mType.getPackage();
		if (__DEC_mType_ownedElements_830620 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_OrphanedEnum_27_1_matchtggpattern_black_nac_3B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_157073 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_0BB(TClass tType,
			TPackage tProxyPackage) {
		for (TPackage __DEC_tType_classes_435824 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tProxyPackage.equals(__DEC_tType_classes_435824)) {
				return new Object[] { tType, tProxyPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_416089 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_416089)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_2BB(TClass tType,
			TPackage tProxyPackage) {
		TPackage __DEC_tType_ownedTypes_803078 = tType.getPackage();
		if (__DEC_tType_ownedTypes_803078 != null) {
			if (!tProxyPackage.equals(__DEC_tType_ownedTypes_803078)) {
				return new Object[] { tType, tProxyPackage };
			}
		}
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_454441 = tType.getOuterType();
		if (__DEC_tType_innerTypes_454441 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_454441)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_OrphanedEnum_28_1_matchtggpattern_black_nac_4BBBB(TEnum tEnum, TClass tType,
		...
		TAnnotatable __DEC_tEnum_tAnnotation_654101 = tEnum.getTAnnotated();
		if (__DEC_tEnum_tAnnotation_654101 != null) {
			if (!tType.equals(__DEC_tEnum_tAnnotation_654101)) {
				if (!pg.equals(__DEC_tEnum_tAnnotation_654101)) {
					if (!tProxyPackage.equals(__DEC_tEnum_tAnnotation_654101)) {
						return new Object[] { tEnum, tType, pg, tProxyPackage };
					}
				}
			}
	...
	public static final Object[] pattern_OrphanedEnum_29_6_perform_greenFFFFBBBFBB(TypeGraph pg, Model mModel,
		...
		return new Object[] { tType, mAnnotatableToTAnnotatable, mTypeToTType, tEnum, pg, mModel, tProxyPackage, mType,
				ruleResult, csp };
	}
