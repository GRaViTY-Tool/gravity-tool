...
public class EnumImpl extends AbstractRuleImpl implements org.gravity.tgg.modisco.pm.Rules.Enum {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_105(EMoflonEdge _edge_classes) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_107(EMoflonEdge _edge_ownedElements) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_105__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_105((EMoflonEdge) arguments.get(0));
		case RulesPackage.ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_107__EMOFLONEDGE:
	...
	public static final Object[] pattern_Enum_20_2_testcorematchandDECs_black_nac_0BBBB(TEnum tAnnotation, TClass tType,
			TPackage tPackage, TypeGraph pg) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_892936 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_892936 != null) {
			if (!tType.equals(__DEC_tAnnotation_tAnnotated_892936)) {
				if (!tPackage.equals(__DEC_tAnnotation_tAnnotated_892936)) {
					if (!pg.equals(__DEC_tAnnotation_tAnnotated_892936)) {
	...
	public static final Object[] pattern_Enum_20_2_testcorematchandDECs_black_nac_1BB(TClass tType, TPackage tPackage) {
		for (TPackage __DEC_tType_classes_406742 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_406742)) {
	...
	public static final Object[] pattern_Enum_20_2_testcorematchandDECs_black_nac_2BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_216914 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_216914)) {
	...
	public static final Object[] pattern_Enum_20_2_testcorematchandDECs_black_nac_3BB(TClass tType, TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_11025 = tType.getPackage();
		if (__DEC_tType_ownedTypes_11025 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_11025)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Enum_20_2_testcorematchandDECs_black_nac_4B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_795323 = tType.getOuterType();
		if (__DEC_tType_innerTypes_795323 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_795323)) {
	...
	public static final Object[] pattern_Enum_21_2_testcorematchandDECs_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_729705 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_729705 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_729705)) {
	...
	public static final Object[] pattern_Enum_21_2_testcorematchandDECs_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_362825 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_362825 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Enum_21_2_testcorematchandDECs_black_nac_2B(EnumDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_688091 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Enum_21_2_testcorematchandDECs_black_nac_3B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_112384 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Enum_27_1_matchtggpattern_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_351436 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_351436 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_351436)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_Enum_27_1_matchtggpattern_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_45187 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_45187 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Enum_27_1_matchtggpattern_black_nac_2B(EnumDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_877041 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, Model.class, "orphanTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Enum_27_1_matchtggpattern_black_nac_3B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_209307 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Enum_28_1_matchtggpattern_black_nac_0BBBB(TEnum tAnnotation, TClass tType,
			TPackage tPackage, TypeGraph pg) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_267733 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_267733 != null) {
			if (!tType.equals(__DEC_tAnnotation_tAnnotated_267733)) {
				if (!tPackage.equals(__DEC_tAnnotation_tAnnotated_267733)) {
					if (!pg.equals(__DEC_tAnnotation_tAnnotated_267733)) {
						return new Object[] { tAnnotation, tType, tPackage, pg };
					}
				}
			}
	...
	public static final Object[] pattern_Enum_28_1_matchtggpattern_black_nac_1BB(TClass tType, TPackage tPackage) {
		for (TPackage __DEC_tType_classes_815909 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_815909)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_Enum_28_1_matchtggpattern_black_nac_2BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_719649 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_719649)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_Enum_28_1_matchtggpattern_black_nac_3BB(TClass tType, TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_777099 = tType.getPackage();
		if (__DEC_tType_ownedTypes_777099 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_777099)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Enum_28_1_matchtggpattern_black_nac_4B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_968305 = tType.getOuterType();
		if (__DEC_tType_innerTypes_968305 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_968305)) {
				return new Object[] { tType };
			}
		}
