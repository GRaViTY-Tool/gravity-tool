...
public class FieldNameImpl extends AbstractRuleImpl implements FieldName {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FieldNameImpl.pattern_FieldName_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				tField, typeGraph, modelToTypeGraph, mFieldName, model, eFieldDeclarationToTField);
		...
		FieldNameImpl.pattern_FieldName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tField, typeGraph,
				mFieldName, model, eFieldDeclarationToTField);
		...
		// 
		// 
		FieldNameImpl.pattern_FieldName_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tField, typeGraph,
				modelToTypeGraph, mFieldName, model, eFieldDeclarationToTField);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldNameImpl.pattern_FieldName_2_2_corematch_blackFFBBB(mFieldName, model,
			...
			// ForEach 
			for (Object[] result3_black : FieldNameImpl.pattern_FieldName_2_3_findcontext_blackBBBB(typeGraph,
					modelToTypeGraph, mFieldName, model)) {
				Object[] result3_green = FieldNameImpl.pattern_FieldName_2_3_findcontext_greenBBBBFFFF(typeGraph,
						modelToTypeGraph, mFieldName, model);
				...
				Object[] result4_bindingAndBlack = FieldNameImpl.pattern_FieldName_2_4_solveCSP_bindingAndBlackFBBBBBB(
						this, isApplicableMatch, typeGraph, modelToTypeGraph, mFieldName, model);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeGraph typeGraph,
			ModelToTypeGraph modelToTypeGraph, MFieldName mFieldName, MGravityModel model) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tField, EObject typeGraph,
			EObject modelToTypeGraph, EObject mFieldName, EObject model, EObject eFieldDeclarationToTField) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		FieldNameImpl.pattern_FieldName_11_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tField, typeGraph,
				mFieldName, model, eFieldDeclarationToTField);
		//nothing EMoflonEdge model__mFieldName____mFieldNames = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge typeGraph__tField____fields = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge tField__typeGraph____model = (EMoflonEdge) result3_green[8];
		...
		// 
		// 
		FieldNameImpl.pattern_FieldName_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tField, typeGraph,
				modelToTypeGraph, mFieldName, model, eFieldDeclarationToTField);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldNameImpl.pattern_FieldName_12_2_corematch_blackBBFFB(tField, typeGraph,
				match)) {
			ModelToTypeGraph modelToTypeGraph = (ModelToTypeGraph) result2_black[2];
			MGravityModel model = (MGravityModel) result2_black[3];
			// ForEach 
			for (Object[] result3_black : FieldNameImpl.pattern_FieldName_12_3_findcontext_blackBBBB(tField, typeGraph,
				...
				Object[] result4_bindingAndBlack = FieldNameImpl.pattern_FieldName_12_4_solveCSP_bindingAndBlackFBBBBBB(
						this, isApplicableMatch, tField, typeGraph, modelToTypeGraph, model);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TField tField, TypeGraph typeGraph,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tField, EObject typeGraph,
			EObject modelToTypeGraph, EObject mFieldName, EObject model, EObject eFieldDeclarationToTField) {
		ruleresult.registerObject("tField", tField);
		ruleresult.registerObject("typeGraph", typeGraph);
		ruleresult.registerObject("modelToTypeGraph", modelToTypeGraph);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_4(EMoflonEdge _edge_fields) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_4(EMoflonEdge _edge_mFieldNames) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = FieldNameImpl.pattern_FieldName_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
				tField, typeGraph, mFieldName, model, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tField] = " + tField + ", " + "[typeGraph] = " + typeGraph + ", " + "[mFieldName] = "
					+ mFieldName + ", " + "[model] = " + model + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (FieldNameImpl.pattern_FieldName_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldNameImpl.pattern_FieldName_24_5_matchcorrcontext_blackBFBBB(typeGraph,
				...
				Object[] result6_black = FieldNameImpl.pattern_FieldName_24_6_createcorrespondence_blackBBBBB(tField,
						typeGraph, mFieldName, model, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TField tField, TypeGraph typeGraph, MFieldName mFieldName, MGravityModel model,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_NAME___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEGRAPH_MODELTOTYPEGRAPH_MFIELDNAME_MGRAVITYMODEL:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TypeGraph) arguments.get(1),
					(ModelToTypeGraph) arguments.get(2), (MFieldName) arguments.get(3),
		...
		case RulesPackage.FIELD_NAME___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TFIELD_TYPEGRAPH_MODELTOTYPEGRAPH_MGRAVITYMODEL:
		...
		case RulesPackage.FIELD_NAME___IS_APPROPRIATE_BWD_EMOFLON_EDGE_4__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_4((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_NAME___IS_APPROPRIATE_FWD_EMOFLON_EDGE_4__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_NAME___IS_APPLICABLE_SOLVE_CSP_CC__TFIELD_TYPEGRAPH_MFIELDNAME_MGRAVITYMODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TField) arguments.get(0), (TypeGraph) arguments.get(1),
					(MFieldName) arguments.get(2), (MGravityModel) arguments.get(3), (Match) arguments.get(4),
			...
			if (tmpModelToTypeGraph instanceof ModelToTypeGraph) {
				...
				if (tmpMFieldName instanceof MFieldName) {
					...
					if (tmpModel instanceof MGravityModel) {
						...
						return new Object[] { typeGraph, modelToTypeGraph, mFieldName, model, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_FieldName_1_1_performtransformation_blackBBBBFBB(TypeGraph typeGraph,
			ModelToTypeGraph modelToTypeGraph, MFieldName mFieldName, MGravityModel model, FieldName _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { typeGraph, modelToTypeGraph, mFieldName, model, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldName_1_1_performtransformation_bindingAndBlackFFFFFBB(FieldName _this,
		...
		if (result_pattern_FieldName_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldName_1_1_performtransformation_black = pattern_FieldName_1_1_performtransformation_blackBBBBFBB(
					typeGraph, modelToTypeGraph, mFieldName, model, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldName_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject tField, EObject typeGraph, EObject modelToTypeGraph, EObject mFieldName, EObject model,
														...
														if (!eFieldDeclarationToTField.equals(modelToTypeGraph)) {
															if (!eFieldDeclarationToTField.equals(mFieldName)) {
																if (!eFieldDeclarationToTField.equals(model)) {
																	return new Object[] { ruleresult, tField, typeGraph,
																			modelToTypeGraph, mFieldName, model,
	...
	public static final Object[] pattern_FieldName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tField, EObject typeGraph, EObject mFieldName, EObject model,
			EObject eFieldDeclarationToTField) {
		EMoflonEdge model__mFieldName____mFieldNames = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, tField, typeGraph, mFieldName, model, eFieldDeclarationToTField,
	...
	public static final void pattern_FieldName_1_5_registerobjects_expressionBBBBBBBB(FieldName _this,
			PerformRuleResult ruleresult, EObject tField, EObject typeGraph, EObject modelToTypeGraph,
			EObject mFieldName, EObject model, EObject eFieldDeclarationToTField) {
		_this.registerObjects_FWD(ruleresult, tField, typeGraph, modelToTypeGraph, mFieldName, model,
				eFieldDeclarationToTField);
	...
	public static final Iterable<Object[]> pattern_FieldName_2_2_corematch_blackFFBBB(MFieldName mFieldName,
		...
		for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (typeGraph != null) {
				_result.add(new Object[] { typeGraph, modelToTypeGraph, mFieldName, model, match });
			}
	...
	public static final Iterable<Object[]> pattern_FieldName_2_3_findcontext_blackBBBB(TypeGraph typeGraph,
			ModelToTypeGraph modelToTypeGraph, MFieldName mFieldName, MGravityModel model) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (typeGraph.equals(modelToTypeGraph.getTarget())) {
			if (model.getMFieldNames().contains(mFieldName)) {
				if (model.equals(modelToTypeGraph.getSource())) {
					_result.add(new Object[] { typeGraph, modelToTypeGraph, mFieldName, model });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_FieldName_2_4_solveCSP_bindingFBBBBBB(FieldName _this,
			...
			MFieldName mFieldName, MGravityModel model) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, typeGraph, modelToTypeGraph,
				mFieldName, model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, typeGraph, modelToTypeGraph, mFieldName, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldName_2_4_solveCSP_bindingAndBlackFBBBBBB(FieldName _this,
		...
		Object[] result_pattern_FieldName_2_4_solveCSP_binding = pattern_FieldName_2_4_solveCSP_bindingFBBBBBB(_this,
				isApplicableMatch, typeGraph, modelToTypeGraph, mFieldName, model);
		...
		if (tmpTField instanceof TField) {
			...
			if (tmpTypeGraph instanceof TypeGraph) {
				...
				if (tmpModelToTypeGraph instanceof ModelToTypeGraph) {
					...
					if (tmpModel instanceof MGravityModel) {
						MGravityModel model = (MGravityModel) tmpModel;
						return new Object[] { tField, typeGraph, modelToTypeGraph, model, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_FieldName_11_1_performtransformation_blackBBBBFBB(TField tField,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tField, typeGraph, modelToTypeGraph, model, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldName_11_1_performtransformation_bindingAndBlackFFFFFBB(FieldName _this,
		...
		if (result_pattern_FieldName_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldName_11_1_performtransformation_black = pattern_FieldName_11_1_performtransformation_blackBBBBFBB(
					tField, typeGraph, modelToTypeGraph, model, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldName_11_1_performtransformation_greenBFBFB(TField tField,
		...
		return new Object[] { tField, mFieldName, model, eFieldDeclarationToTField, csp };
	}
	...
	public static final void pattern_FieldName_11_5_registerobjects_expressionBBBBBBBB(FieldName _this,
			PerformRuleResult ruleresult, EObject tField, EObject typeGraph, EObject modelToTypeGraph,
			EObject mFieldName, EObject model, EObject eFieldDeclarationToTField) {
		_this.registerObjects_BWD(ruleresult, tField, typeGraph, modelToTypeGraph, mFieldName, model,
				eFieldDeclarationToTField);
	...
	public static final Iterable<Object[]> pattern_FieldName_12_2_corematch_blackBBFFB(TField tField,
		...
		for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpModel instanceof MGravityModel) {
				MGravityModel model = (MGravityModel) tmpModel;
				_result.add(new Object[] { tField, typeGraph, modelToTypeGraph, model, match });
			}
		...
		if (typeGraph.equals(modelToTypeGraph.getTarget())) {
			if (model.equals(modelToTypeGraph.getSource())) {
				if (typeGraph.getFields().contains(tField)) {
					_result.add(new Object[] { tField, typeGraph, modelToTypeGraph, model });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_FieldName_12_3_findcontext_greenBBBBFFFFF(TField tField, TypeGraph typeGraph,
	...
	public static final Object[] pattern_FieldName_12_4_solveCSP_bindingFBBBBBB(FieldName _this,
			IsApplicableMatch isApplicableMatch, TField tField, TypeGraph typeGraph, ModelToTypeGraph modelToTypeGraph,
			MGravityModel model) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tField, typeGraph, modelToTypeGraph,
				model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tField, typeGraph, modelToTypeGraph, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldName_12_4_solveCSP_bindingAndBlackFBBBBBB(FieldName _this,
		...
		Object[] result_pattern_FieldName_12_4_solveCSP_binding = pattern_FieldName_12_4_solveCSP_bindingFBBBBBB(_this,
				isApplicableMatch, tField, typeGraph, modelToTypeGraph, model);
	...
	public static final Object[] pattern_FieldName_20_2_testcorematchandDECs_black_nac_0BB(TField tField,
			TypeGraph typeGraph) {
		TypeGraph __DEC_tField_model_522864 = tField.getModel();
		if (__DEC_tField_model_522864 != null) {
			if (!typeGraph.equals(__DEC_tField_model_522864)) {
		...
		if (tmpTField instanceof TField) {
			...
			if (tmpTypeGraph instanceof TypeGraph) {
				...
				if (tmpMFieldName instanceof MFieldName) {
					...
					if (tmpModel instanceof MGravityModel) {
						MGravityModel model = (MGravityModel) tmpModel;
						return new Object[] { tField, typeGraph, mFieldName, model, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_FieldName_24_2_matchsrctrgcontext_blackBBBBBB(TField tField,
			TypeGraph typeGraph, MFieldName mFieldName, MGravityModel model, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tField, typeGraph, mFieldName, model, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldName_24_3_solvecsp_bindingFBBBBBBB(FieldName _this, TField tField,
			TypeGraph typeGraph, MFieldName mFieldName, MGravityModel model, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tField, typeGraph, mFieldName, model, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tField, typeGraph, mFieldName, model, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldName_24_6_createcorrespondence_blackBBBBB(TField tField,
			TypeGraph typeGraph, MFieldName mFieldName, MGravityModel model, CCMatch ccMatch) {
		return new Object[] { tField, typeGraph, mFieldName, model, ccMatch };
	}
	...
	public static final Object[] pattern_FieldName_28_1_matchtggpattern_black_nac_0BB(TField tField,
			TypeGraph typeGraph) {
		TypeGraph __DEC_tField_model_893500 = tField.getModel();
		if (__DEC_tField_model_893500 != null) {
			if (!typeGraph.equals(__DEC_tField_model_893500)) {
				return new Object[] { tField, typeGraph };
			}
		}
	...
	public static final Object[] pattern_FieldName_29_6_perform_greenFBFBFBB(TypeGraph typeGraph, MGravityModel model,
		...
		return new Object[] { tField, typeGraph, mFieldName, model, eFieldDeclarationToTField, ruleResult, csp };
	}
