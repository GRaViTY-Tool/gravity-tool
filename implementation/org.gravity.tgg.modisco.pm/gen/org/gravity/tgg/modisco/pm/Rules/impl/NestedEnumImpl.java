...
public class NestedEnumImpl extends AbstractRuleImpl implements NestedEnum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = NestedEnumImpl.pattern_NestedEnum_1_1_performtransformation_greenFBFBFBFBB(eNestedType,
				typeGraph, tOuterType, tOuterPackage, csp);
		...
		Object[] result2_black = NestedEnumImpl.pattern_NestedEnum_1_2_collecttranslatedelements_blackBBBBB(tAnnotation,
				eNestedType, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation);
		...
		Object[] result2_green = NestedEnumImpl.pattern_NestedEnum_1_2_collecttranslatedelements_greenFBBBBB(
				tAnnotation, eNestedType, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = NestedEnumImpl.pattern_NestedEnum_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult,
				tAnnotation, eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
		...
		NestedEnumImpl.pattern_NestedEnum_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult,
				tAnnotation, eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
		...
		//nothing EMoflonEdge tNestedType__tAnnotation____tAnnotation = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge tAnnotation__tNestedType____tAnnotated = (EMoflonEdge) result3_green[14];
		...
		//nothing EMoflonEdge mBodyToTAnnotation__tNestedType____target = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge eNestedTypeToTNestedType__eNestedType____source = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge eNestedType__eOuterType____abstractTypeDeclaration = (EMoflonEdge) result3_green[19];
		//nothing EMoflonEdge eOuterType__eNestedType____bodyDeclarations = (EMoflonEdge) result3_green[20];
		//nothing EMoflonEdge typeGraph__tNestedType____classes = (EMoflonEdge) result3_green[21];
		//nothing EMoflonEdge tOuterPackage__tNestedType____ownedTypes = (EMoflonEdge) result3_green[22];
		//nothing EMoflonEdge tNestedType__tOuterPackage____package = (EMoflonEdge) result3_green[23];
		//nothing EMoflonEdge eNestedTypeToTNestedType__tNestedType____target = (EMoflonEdge) result3_green[24];

		// 
		// 
		NestedEnumImpl.pattern_NestedEnum_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, tAnnotation,
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType,
		...
		Object[] result1_black = NestedEnumImpl.pattern_NestedEnum_10_1_initialbindings_blackBBBBBBB(this, match,
				tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[typeGraph] = "
		...
		Object[] result2_bindingAndBlack = NestedEnumImpl.pattern_NestedEnum_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this,
				match, tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[typeGraph] = "
					+ typeGraph + ", " + "[tNestedType] = " + tNestedType + ", " + "[tOuterType] = " + tOuterType + ", "
		...
		if (NestedEnumImpl.pattern_NestedEnum_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tAnnotation] = " + tAnnotation + ", " + "[typeGraph] = " + typeGraph + ", "
						+ "[tNestedType] = " + tNestedType + ", " + "[tOuterType] = " + tOuterType + ", "
						+ "[tOuterPackage] = " + tOuterPackage + ".");
			}
			NestedEnumImpl.pattern_NestedEnum_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFF(match,
					tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage);
			//nothing EMoflonEdge typeGraph__tNestedType____ownedTypes = (EMoflonEdge) result4_green[6];
			//nothing EMoflonEdge tNestedType__typeGraph____model = (EMoflonEdge) result4_green[7];
			//nothing EMoflonEdge tNestedType__tAnnotation____tAnnotation = (EMoflonEdge) result4_green[8];
			//nothing EMoflonEdge tAnnotation__tNestedType____tAnnotated = (EMoflonEdge) result4_green[9];
			//nothing EMoflonEdge tOuterType__tNestedType____innerTypes = (EMoflonEdge) result4_green[10];
			//nothing EMoflonEdge tNestedType__tOuterType____outerType = (EMoflonEdge) result4_green[11];
			//nothing EMoflonEdge typeGraph__tNestedType____classes = (EMoflonEdge) result4_green[12];
			//nothing EMoflonEdge tOuterPackage__tNestedType____ownedTypes = (EMoflonEdge) result4_green[13];
			//nothing EMoflonEdge tNestedType__tOuterPackage____package = (EMoflonEdge) result4_green[14];
			...
			// 
			NestedEnumImpl.pattern_NestedEnum_10_6_registerobjectstomatch_expressionBBBBBBB(this, match, tAnnotation,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		NestedEnumImpl.pattern_NestedEnum_11_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult,
				tAnnotation, eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
				mBodyToTAnnotation, eOuterType, tOuterPackage);
		//nothing EMoflonEdge mBodyToTAnnotation__eNestedType____source = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge typeGraph__tNestedType____ownedTypes = (EMoflonEdge) result3_green[11];
		...
		// 
		// 
		NestedEnumImpl.pattern_NestedEnum_11_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, tAnnotation,
				eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
				mBodyToTAnnotation, eOuterType, tOuterPackage);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : NestedEnumImpl.pattern_NestedEnum_12_2_corematch_blackBBBBFFBB(tAnnotation,
			...
			// ForEach 
			for (Object[] result3_black : NestedEnumImpl.pattern_NestedEnum_12_3_findcontext_blackBBBBBBB(tAnnotation,
					typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType, tOuterPackage)) {
				Object[] result3_green = NestedEnumImpl
						.pattern_NestedEnum_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFFF(tAnnotation, typeGraph,
				...
				//nothing EMoflonEdge typeGraph__tOuterType____ownedTypes = (EMoflonEdge) result3_green[12];
				//nothing EMoflonEdge tOuterType__typeGraph____model = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge tNestedType__tAnnotation____tAnnotation = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge tAnnotation__tNestedType____tAnnotated = (EMoflonEdge) result3_green[15];
				//nothing EMoflonEdge tOuterType__tNestedType____innerTypes = (EMoflonEdge) result3_green[16];
				//nothing EMoflonEdge tNestedType__tOuterType____outerType = (EMoflonEdge) result3_green[17];
				//nothing EMoflonEdge tOuterType__tOuterPackage____package = (EMoflonEdge) result3_green[18];
				//nothing EMoflonEdge tOuterPackage__tOuterType____ownedTypes = (EMoflonEdge) result3_green[19];
				//nothing EMoflonEdge typeGraph__tNestedType____classes = (EMoflonEdge) result3_green[20];
				//nothing EMoflonEdge tOuterPackage__tNestedType____ownedTypes = (EMoflonEdge) result3_green[21];
				//nothing EMoflonEdge tNestedType__tOuterPackage____package = (EMoflonEdge) result3_green[22];
				//nothing EMoflonEdge eOuterTypeToTOuterInterface__tOuterType____target = (EMoflonEdge) result3_green[23];

				Object[] result4_bindingAndBlack = NestedEnumImpl
						.pattern_NestedEnum_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAnnotation, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, TPackage tOuterPackage) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TEnum tAnnotation, TypeGraph typeGraph,
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_62(EMoflonEdge _edge_ownedTypes) {
		...
		for (Object[] result2_black : NestedEnumImpl
				.pattern_NestedEnum_20_2_testcorematchandDECs_blackFFFFFB(_edge_ownedTypes)) {
			...
			// 
			if (NestedEnumImpl.pattern_NestedEnum_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
					this, match, tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage)) {
				// 
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_65(EMoflonEdge _edge_abstractTypeDeclaration) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = NestedEnumImpl
				.pattern_NestedEnum_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result3_bindingAndBlack = NestedEnumImpl.pattern_NestedEnum_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
				this, tAnnotation, eNestedType, typeGraph, tNestedType, tOuterType, eOuterType, tOuterPackage,
		...
		if (NestedEnumImpl.pattern_NestedEnum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : NestedEnumImpl.pattern_NestedEnum_24_5_matchcorrcontext_blackBFBBB(tOuterType,
				...
				Object[] result6_black = NestedEnumImpl.pattern_NestedEnum_24_6_createcorrespondence_blackBBBBBBBB(
						tAnnotation, eNestedType, typeGraph, tNestedType, tOuterType, eOuterType, tOuterPackage,
						ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAnnotation] = "
							+ tAnnotation + ", " + "[eNestedType] = " + eNestedType + ", " + "[typeGraph] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TEnum tAnnotation, EnumDeclaration eNestedType, TypeGraph typeGraph,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {// 
		Object[] result1_black = NestedEnumImpl.pattern_NestedEnum_28_1_matchtggpattern_blackBBBBB(tAnnotation,
				typeGraph, tNestedType, tOuterType, tOuterPackage);
		if (result1_black != null) {
		...
		for (Object[] result2_black : NestedEnumImpl
			...
			if (NestedEnumImpl.pattern_NestedEnum_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					NestedEnumImpl.pattern_NestedEnum_29_6_perform_greenFFFBFBFBBBB(typeGraph, tOuterType, eOuterType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.NESTED_ENUM___IS_APPROPRIATE_BWD__MATCH_TENUM_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
			return isAppropriate_BWD((Match) arguments.get(0), (TEnum) arguments.get(1), (TypeGraph) arguments.get(2),
		...
		case RulesPackage.NESTED_ENUM___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TENUM_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TEnum) arguments.get(1), (TypeGraph) arguments.get(2),
					(TClass) arguments.get(3), (TAbstractType) arguments.get(4), (TPackage) arguments.get(5));
			return null;
		case RulesPackage.NESTED_ENUM___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TENUM_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
		...
		case RulesPackage.NESTED_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TENUM_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE:
		...
		case RulesPackage.NESTED_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_62__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_62((EMoflonEdge) arguments.get(0));
		case RulesPackage.NESTED_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_65__EMOFLONEDGE:
		...
		case RulesPackage.NESTED_ENUM___IS_APPLICABLE_SOLVE_CSP_CC__TENUM_ENUMDECLARATION_TYPEGRAPH_TCLASS_TABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE_MATCH_MATCH:
		...
		case RulesPackage.NESTED_ENUM___CHECK_DEC_BWD__TENUM_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
			return checkDEC_BWD((TEnum) arguments.get(0), (TypeGraph) arguments.get(1), (TClass) arguments.get(2),
	...
	public static final Object[] pattern_NestedEnum_1_1_performtransformation_greenFBFBFBFBB(
		...
		return new Object[] { tAnnotation, eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
				mBodyToTAnnotation, tOuterPackage, csp };
	}

	public static final Object[] pattern_NestedEnum_1_2_collecttranslatedelements_blackBBBBB(TEnum tAnnotation,
			EnumDeclaration eNestedType, TypeToTAbstractType eNestedTypeToTNestedType, TClass tNestedType,
			ASTNodeToTAnnotatable mBodyToTAnnotation) {
		return new Object[] { tAnnotation, eNestedType, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation };
	}

	public static final Object[] pattern_NestedEnum_1_2_collecttranslatedelements_greenFBBBBB(TEnum tAnnotation,
			EnumDeclaration eNestedType, TypeToTAbstractType eNestedTypeToTNestedType, TClass tNestedType,
			ASTNodeToTAnnotatable mBodyToTAnnotation) {
		...
		return new Object[] { ruleresult, tAnnotation, eNestedType, eNestedTypeToTNestedType, tNestedType,
				mBodyToTAnnotation };
	}
	...
	public static final Object[] pattern_NestedEnum_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tAnnotation, EObject eNestedType, EObject eNestedTypeToTNestedType,
		...
		return new Object[] { ruleresult, tAnnotation, eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType,
				...
				typeGraph__tNestedType____classes, tOuterPackage__tNestedType____ownedTypes,
	...
	public static final void pattern_NestedEnum_1_5_registerobjects_expressionBBBBBBBBBBBB(NestedEnum _this,
			...
			EObject typeGraph, EObject tNestedType, EObject tOuterType, EObject eOuterTypeToTOuterInterface,
			EObject mBodyToTAnnotation, EObject eOuterType, EObject tOuterPackage) {
		_this.registerObjects_FWD(ruleresult, tAnnotation, eNestedType, eNestedTypeToTNestedType, typeGraph,
	...
	public static final Object[] pattern_NestedEnum_10_1_initialbindings_blackBBBBBBB(NestedEnum _this, Match match,
			TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
		if (!tNestedType.equals(tOuterType)) {
			return new Object[] { _this, match, tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_NestedEnum_10_2_SolveCSP_bindingFBBBBBBB(NestedEnum _this, Match match,
			TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, tAnnotation, typeGraph, tNestedType, tOuterType,
				tOuterPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_NestedEnum_10_2_SolveCSP_bindingAndBlackFBBBBBBB(NestedEnum _this, Match match,
		...
		Object[] result_pattern_NestedEnum_10_2_SolveCSP_binding = pattern_NestedEnum_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage);
		if (result_pattern_NestedEnum_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_NestedEnum_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, tAnnotation, typeGraph, tNestedType, tOuterType,
						tOuterPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_NestedEnum_10_4_collectelementstobetranslated_blackBBBBBB(Match match,
			...
			TPackage tOuterPackage) {
		if (!tNestedType.equals(tOuterType)) {
			return new Object[] { match, tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage };
		}
		return null;
	}

	public static final Object[] pattern_NestedEnum_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFF(Match match,
			TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
		EMoflonEdge typeGraph__tNestedType____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tNestedType__typeGraph____model = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_NestedEnum_10_6_registerobjectstomatch_expressionBBBBBBB(NestedEnum _this,
			Match match, TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
		_this.registerObjectsToMatch_BWD(match, tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage);
					...
					if (tmpTOuterType instanceof TAbstractType) {
						...
						if (tmpEOuterTypeToTOuterInterface instanceof TypeToTAbstractType) {
							...
							if (tmpEOuterType instanceof AbstractTypeDeclaration) {
								...
								if (tmpTOuterPackage instanceof TPackage) {
									TPackage tOuterPackage = (TPackage) tmpTOuterPackage;
									return new Object[] { tAnnotation, typeGraph, tNestedType, tOuterType,
	...
	public static final Object[] pattern_NestedEnum_11_1_performtransformation_blackBBBBBBBFBB(TEnum tAnnotation,
		...
		if (!tNestedType.equals(tOuterType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { tAnnotation, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
	...
	public static final Object[] pattern_NestedEnum_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_NestedEnum_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_NestedEnum_11_1_performtransformation_black = pattern_NestedEnum_11_1_performtransformation_blackBBBBBBBFBB(
					tAnnotation, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType,
	...
	public static final Object[] pattern_NestedEnum_11_2_collecttranslatedelements_blackBBBBB(TEnum tAnnotation,
			EnumDeclaration eNestedType, TypeToTAbstractType eNestedTypeToTNestedType, TClass tNestedType,
			ASTNodeToTAnnotatable mBodyToTAnnotation) {
		return new Object[] { tAnnotation, eNestedType, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation };
	}

	public static final Object[] pattern_NestedEnum_11_2_collecttranslatedelements_greenFBBBBB(TEnum tAnnotation,
			EnumDeclaration eNestedType, TypeToTAbstractType eNestedTypeToTNestedType, TClass tNestedType,
			ASTNodeToTAnnotatable mBodyToTAnnotation) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_NestedEnum_11_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tAnnotation, EObject eNestedType, EObject eNestedTypeToTNestedType,
			EObject typeGraph, EObject tNestedType, EObject tOuterType, EObject mBodyToTAnnotation, EObject eOuterType,
			EObject tOuterPackage) {
		EMoflonEdge mBodyToTAnnotation__eNestedType____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_NestedEnum_11_5_registerobjects_expressionBBBBBBBBBBBB(NestedEnum _this,
			...
			EObject typeGraph, EObject tNestedType, EObject tOuterType, EObject eOuterTypeToTOuterInterface,
			EObject mBodyToTAnnotation, EObject eOuterType, EObject tOuterPackage) {
		_this.registerObjects_BWD(ruleresult, tAnnotation, eNestedType, eNestedTypeToTNestedType, typeGraph,
				tNestedType, tOuterType, eOuterTypeToTOuterInterface, mBodyToTAnnotation, eOuterType, tOuterPackage);
			...
			if (tmpTypeGraph instanceof TypeGraph) {
				...
				if (tmpTNestedType instanceof TClass) {
					...
					if (tmpTOuterType instanceof TAbstractType) {
						...
						if (tmpTOuterPackage instanceof TPackage) {
							TPackage tOuterPackage = (TPackage) tmpTOuterPackage;
							return new Object[] { tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage,
									match };
						}
					}
				}
	...
	public static final Iterable<Object[]> pattern_NestedEnum_12_2_corematch_blackBBBBFFBB(TEnum tAnnotation,
		...
		if (!tNestedType.equals(tOuterType)) {
			for (TypeToTAbstractType eOuterTypeToTOuterInterface : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpEOuterType instanceof AbstractTypeDeclaration) {
					AbstractTypeDeclaration eOuterType = (AbstractTypeDeclaration) tmpEOuterType;
					_result.add(new Object[] { tAnnotation, typeGraph, tNestedType, tOuterType,
	...
	public static final Iterable<Object[]> pattern_NestedEnum_12_3_findcontext_blackBBBBBBB(TEnum tAnnotation,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
									...
									if (tOuterPackage.equals(tOuterType.getPackage())) {
										if (typeGraph.getClasses().contains(tNestedType)) {
											if (tOuterPackage.getOwnedTypes().contains(tNestedType)) {
												if (tOuterType.equals(eOuterTypeToTOuterInterface.getTarget())) {
													_result.add(new Object[] { tAnnotation, typeGraph, tNestedType,
															tOuterType, eOuterTypeToTOuterInterface, eOuterType,
															tOuterPackage });
												}
											}
	...
	public static final Object[] pattern_NestedEnum_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFFF(TEnum tAnnotation,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		...
		eOuterTypeToTOuterInterface__tOuterType____target
				.setName(eOuterTypeToTOuterInterface__tOuterType____target_name_prime);
		return new Object[] { tAnnotation, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType,
				tOuterPackage, isApplicableMatch, tOuterPackage__typeGraph____model,
	...
	public static final Object[] pattern_NestedEnum_12_4_solveCSP_bindingFBBBBBBBBB(NestedEnum _this,
			IsApplicableMatch isApplicableMatch, TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tAnnotation, typeGraph, tNestedType,
				tOuterType, eOuterTypeToTOuterInterface, eOuterType, tOuterPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAnnotation, typeGraph, tNestedType, tOuterType,
					eOuterTypeToTOuterInterface, eOuterType, tOuterPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_NestedEnum_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(NestedEnum _this,
		...
		Object[] result_pattern_NestedEnum_12_4_solveCSP_binding = pattern_NestedEnum_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAnnotation, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
				eOuterType, tOuterPackage);
	...
	public static final Object[] pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_0BBBBB(TEnum tAnnotation,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
		if (!tNestedType.equals(tOuterType)) {
			TAnnotatable __DEC_tAnnotation_tAnnotated_453563 = tAnnotation.getTAnnotated();
			if (__DEC_tAnnotation_tAnnotated_453563 != null) {
				if (!typeGraph.equals(__DEC_tAnnotation_tAnnotated_453563)) {
					if (!tNestedType.equals(__DEC_tAnnotation_tAnnotated_453563)) {
						if (!tOuterType.equals(__DEC_tAnnotation_tAnnotated_453563)) {
							if (!tOuterPackage.equals(__DEC_tAnnotation_tAnnotated_453563)) {
								return new Object[] { tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage };
							}
						}
					}
	...
	public static final Object[] pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_1BB(TClass tNestedType,
			TPackage tOuterPackage) {
		for (TPackage __DEC_tNestedType_classes_506175 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TPackage.class, "classes")) {
			if (!tOuterPackage.equals(__DEC_tNestedType_classes_506175)) {
	...
	public static final Object[] pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_2BB(TClass tNestedType,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_classes_189677 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tNestedType_classes_189677)) {
	...
	public static final Object[] pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_3BB(TClass tNestedType,
			TPackage tOuterPackage) {
		TPackage __DEC_tNestedType_ownedTypes_922470 = tNestedType.getPackage();
		if (__DEC_tNestedType_ownedTypes_922470 != null) {
			if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_922470)) {
				return new Object[] { tNestedType, tOuterPackage };
			}
		}
	...
	public static final Object[] pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_4BB(TClass tNestedType,
		...
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_607113 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_607113 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_607113)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_607113)) {
	...
	public static final Object[] pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_5BB(TEnum tAnnotation,
			TypeGraph typeGraph) {
	...
	public static final Object[] pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_6BB(TEnum tAnnotation,
			TAbstractType tOuterType) {
	...
	public static final Object[] pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_8BB(TPackage tOuterPackage,
			TClass tNestedType) {
	...
	public static final Iterable<Object[]> pattern_NestedEnum_20_2_testcorematchandDECs_blackFFFFFB(
												...
												if (pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_2BB(
													...
													if (pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_4BB(
														...
														if (pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_1BB(
															...
															if (pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_3BB(
																	tNestedType, tOuterPackage) == null) {
																if (pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_8BB(
																	...
																	for (TAnnotation tmpTAnnotation : tNestedType
																		...
																		if (tmpTAnnotation instanceof TEnum) {
																			TEnum tAnnotation = (TEnum) tmpTAnnotation;
																			if (pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_0BBBBB(
																					tAnnotation, typeGraph, tNestedType,
																					tOuterType,
																					tOuterPackage) == null) {
																				if (pattern_NestedEnum_20_2_testcorematchandDECs_black_nac_5BB(
																						tAnnotation,
																						typeGraph) == null) {
	...
	public static final boolean pattern_NestedEnum_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			NestedEnum _this, Match match, TEnum tAnnotation, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, TPackage tOuterPackage) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tAnnotation, typeGraph, tNestedType, tOuterType,
				tOuterPackage);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_0B(
		...
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_244765 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_244765 != null) {
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_1B(
			EnumDeclaration eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_157540 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_2B(
			EnumDeclaration eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_125809 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_125809 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_NestedEnum_21_2_testcorematchandDECs_black_nac_3B(
			EnumDeclaration eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_78109 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_NestedEnum_24_2_matchsrctrgcontext_bindingFFFFFFFBB(Match targetMatch,
			Match sourceMatch) {
					...
					if (tmpTNestedType instanceof TClass) {
						...
						if (tmpTOuterType instanceof TAbstractType) {
							...
							if (tmpEOuterType instanceof AbstractTypeDeclaration) {
								...
								if (tmpTOuterPackage instanceof TPackage) {
									TPackage tOuterPackage = (TPackage) tmpTOuterPackage;
									return new Object[] { tAnnotation, eNestedType, typeGraph, tNestedType, tOuterType,
											eOuterType, tOuterPackage, targetMatch, sourceMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_NestedEnum_24_2_matchsrctrgcontext_blackBBBBBBBBB(TEnum tAnnotation,
			EnumDeclaration eNestedType, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage, Match sourceMatch, Match targetMatch) {
		if (!eNestedType.equals(eOuterType)) {
			if (!tNestedType.equals(tOuterType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tAnnotation, eNestedType, typeGraph, tNestedType, tOuterType, eOuterType,
	...
	public static final Object[] pattern_NestedEnum_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_NestedEnum_24_2_matchsrctrgcontext_binding = pattern_NestedEnum_24_2_matchsrctrgcontext_bindingFFFFFFFBB(
		...
		if (result_pattern_NestedEnum_24_2_matchsrctrgcontext_binding != null) {
			...
			TypeGraph typeGraph = (TypeGraph) result_pattern_NestedEnum_24_2_matchsrctrgcontext_binding[2];
			TClass tNestedType = (TClass) result_pattern_NestedEnum_24_2_matchsrctrgcontext_binding[3];
			TAbstractType tOuterType = (TAbstractType) result_pattern_NestedEnum_24_2_matchsrctrgcontext_binding[4];
			AbstractTypeDeclaration eOuterType = (AbstractTypeDeclaration) result_pattern_NestedEnum_24_2_matchsrctrgcontext_binding[5];
			TPackage tOuterPackage = (TPackage) result_pattern_NestedEnum_24_2_matchsrctrgcontext_binding[6];

			Object[] result_pattern_NestedEnum_24_2_matchsrctrgcontext_black = pattern_NestedEnum_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					tAnnotation, eNestedType, typeGraph, tNestedType, tOuterType, eOuterType, tOuterPackage,
					sourceMatch, targetMatch);
	...
	public static final Object[] pattern_NestedEnum_24_3_solvecsp_bindingFBBBBBBBBBB(NestedEnum _this,
			TEnum tAnnotation, EnumDeclaration eNestedType, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(tAnnotation, eNestedType, typeGraph, tNestedType,
				tOuterType, eOuterType, tOuterPackage, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, tAnnotation, eNestedType, typeGraph, tNestedType, tOuterType, eOuterType,
					tOuterPackage, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_NestedEnum_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(NestedEnum _this,
			TEnum tAnnotation, EnumDeclaration eNestedType, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_NestedEnum_24_3_solvecsp_binding = pattern_NestedEnum_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, tAnnotation, eNestedType, typeGraph, tNestedType, tOuterType, eOuterType, tOuterPackage,
				sourceMatch, targetMatch);
		if (result_pattern_NestedEnum_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_NestedEnum_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tAnnotation, eNestedType, typeGraph, tNestedType, tOuterType,
	...
	public static final Object[] pattern_NestedEnum_24_6_createcorrespondence_blackBBBBBBBB(TEnum tAnnotation,
			EnumDeclaration eNestedType, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
	...
	public static final Object[] pattern_NestedEnum_27_1_matchtggpattern_black_nac_0B(EnumDeclaration eNestedType) {
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_221773 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_221773 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_NestedEnum_27_1_matchtggpattern_black_nac_1B(EnumDeclaration eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_119383 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, Model.class, "orphanTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_NestedEnum_27_1_matchtggpattern_black_nac_2B(EnumDeclaration eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_613829 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_613829 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_NestedEnum_27_1_matchtggpattern_black_nac_3B(EnumDeclaration eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_398570 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_0BBBBB(TEnum tAnnotation,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
		if (!tNestedType.equals(tOuterType)) {
			TAnnotatable __DEC_tAnnotation_tAnnotated_666415 = tAnnotation.getTAnnotated();
			if (__DEC_tAnnotation_tAnnotated_666415 != null) {
				if (!typeGraph.equals(__DEC_tAnnotation_tAnnotated_666415)) {
					if (!tNestedType.equals(__DEC_tAnnotation_tAnnotated_666415)) {
						if (!tOuterType.equals(__DEC_tAnnotation_tAnnotated_666415)) {
							if (!tOuterPackage.equals(__DEC_tAnnotation_tAnnotated_666415)) {
								return new Object[] { tAnnotation, typeGraph, tNestedType, tOuterType, tOuterPackage };
							}
						}
					}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_1BB(TClass tNestedType,
			TPackage tOuterPackage) {
		for (TPackage __DEC_tNestedType_classes_196419 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TPackage.class, "classes")) {
			if (!tOuterPackage.equals(__DEC_tNestedType_classes_196419)) {
				return new Object[] { tNestedType, tOuterPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_2BB(TClass tNestedType,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_classes_298866 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tNestedType_classes_298866)) {
				return new Object[] { tNestedType, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_3BB(TClass tNestedType,
			TPackage tOuterPackage) {
		TPackage __DEC_tNestedType_ownedTypes_392054 = tNestedType.getPackage();
		if (__DEC_tNestedType_ownedTypes_392054 != null) {
			if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_392054)) {
				return new Object[] { tNestedType, tOuterPackage };
			}
		}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_4BB(TClass tNestedType,
			TAbstractType tOuterType) {
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_342384 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_342384 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_342384)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_342384)) {
						return new Object[] { tNestedType, tOuterType };
					}
				}
			}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_5BB(TEnum tAnnotation,
			TypeGraph typeGraph) {
		if (typeGraph.equals(tAnnotation.getTAnnotated())) {
			return new Object[] { tAnnotation, typeGraph };
		}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_6BB(TEnum tAnnotation,
			TAbstractType tOuterType) {
		if (tOuterType.equals(tAnnotation.getTAnnotated())) {
			return new Object[] { tAnnotation, tOuterType };
		}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_black_nac_8BB(TPackage tOuterPackage,
			TClass tNestedType) {
		if (tOuterPackage.getClasses().contains(tNestedType)) {
			return new Object[] { tOuterPackage, tNestedType };
		}
	...
	public static final Object[] pattern_NestedEnum_28_1_matchtggpattern_blackBBBBB(TEnum tAnnotation,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
		if (!tNestedType.equals(tOuterType)) {
			if (typeGraph.equals(tOuterPackage.getModel())) {
				if (typeGraph.getOwnedTypes().contains(tNestedType)) {
						...
						if (tNestedType.getTAnnotation().contains(tAnnotation)) {
							if (tOuterType.getInnerTypes().contains(tNestedType)) {
								if (tOuterPackage.equals(tOuterType.getPackage())) {
									if (typeGraph.getClasses().contains(tNestedType)) {
										if (tOuterPackage.getOwnedTypes().contains(tNestedType)) {
											if (pattern_NestedEnum_28_1_matchtggpattern_black_nac_0BBBBB(tAnnotation,
													typeGraph, tNestedType, tOuterType, tOuterPackage) == null) {
												if (pattern_NestedEnum_28_1_matchtggpattern_black_nac_1BB(tNestedType,
														tOuterPackage) == null) {
	...
	public static final Object[] pattern_NestedEnum_29_6_perform_greenFFFBFBFBBBB(TypeGraph typeGraph,
