...
public class AnnotationTypeNestedImpl extends AbstractRuleImpl implements AnnotationTypeNested {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing EMoflonEdge tNestedPackage__typeGraph____typeGraph = (EMoflonEdge) result3_green[17];
	...
	public boolean isAppropriate_BWD(Match match, TPackage tNestedPackage, TypeGraph typeGraph,
		...
		if (AnnotationTypeNestedImpl.pattern_AnnotationTypeNested_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			//nothing EMoflonEdge tNestedPackage__typeGraph____typeGraph = (EMoflonEdge) result4_green[12];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationTypeNestedImpl
			...
			for (Object[] result3_black : AnnotationTypeNestedImpl
				...
				//nothing EMoflonEdge typeGraph__tNestedType____ownedTypes = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge tNestedType__typeGraph____pg = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge typeGraph__tOuterType____ownedTypes = (EMoflonEdge) result3_green[15];
				//nothing EMoflonEdge tOuterType__typeGraph____pg = (EMoflonEdge) result3_green[16];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_125(EMoflonEdge _edge_ownedTypes) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_128(EMoflonEdge _edge_abstractTypeDeclaration) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_TYPE_NESTED___IS_APPROPRIATE_BWD_EMOFLON_EDGE_125__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_125((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_TYPE_NESTED___IS_APPROPRIATE_FWD_EMOFLON_EDGE_128__EMOFLONEDGE:
	...
	public static final Object[] pattern_AnnotationTypeNested_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(
		...
		return new Object[] { match, tNestedPackage, typeGraph, tNestedType, tOuterType, tOuterPackage,
				...
				typeGraph__tNestedType____ownedTypes, tNestedType__typeGraph____pg,
				tNestedPackage__typeGraph____typeGraph, tOuterType__tNestedType____innerTypes,
				tNestedType__tOuterType____outerType, typeGraph__tNestedType____tAnnotationTypes };
	}
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_0BB(
		...
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_394565 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_394565 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_394565)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_394565)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TypeGraph __DEC_tNestedPackage_packages_832430 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_832430 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_832430)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_2BB(
		...
		for (TypeGraph __DEC_tNestedType_tAnnotationTypes_865019 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "tAnnotationTypes")) {
			if (!typeGraph.equals(__DEC_tNestedType_tAnnotationTypes_865019)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_3BBB(
		...
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_939958 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_939958 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_939958)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_939958)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_4BB(
		...
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_462835 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_462835 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_462835)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_462835)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_21_2_testcorematchandDECs_black_nac_0B(
		...
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_862755 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_862755 != null) {
	...
	public static final Object[] pattern_AnnotationTypeNested_21_2_testcorematchandDECs_black_nac_1B(
			AnnotationTypeDeclaration eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_533936 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeNested_21_2_testcorematchandDECs_black_nac_2B(
			AnnotationTypeDeclaration eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_320265 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_320265 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeNested_21_2_testcorematchandDECs_black_nac_3B(
			AnnotationTypeDeclaration eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_84740 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeNested_27_1_matchtggpattern_black_nac_0B(
			AnnotationTypeDeclaration eNestedType) {
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_762093 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_762093 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeNested_27_1_matchtggpattern_black_nac_1B(
			AnnotationTypeDeclaration eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_5837 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, Model.class, "orphanTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeNested_27_1_matchtggpattern_black_nac_2B(
			AnnotationTypeDeclaration eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_746469 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_746469 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeNested_27_1_matchtggpattern_black_nac_3B(
			AnnotationTypeDeclaration eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_476227 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_0BB(
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_521495 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_521495 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_521495)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_521495)) {
						return new Object[] { tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_1BB(
			TPackage tNestedPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tNestedPackage_packages_138636 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_138636 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_138636)) {
				return new Object[] { tNestedPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_2BB(
			TAnnotationType tNestedType, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_tAnnotationTypes_116253 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "tAnnotationTypes")) {
			if (!typeGraph.equals(__DEC_tNestedType_tAnnotationTypes_116253)) {
				return new Object[] { tNestedType, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_3BBB(
			TAnnotationType tNestedType, TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_302857 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_302857 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_302857)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_302857)) {
						return new Object[] { tNestedType, tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_4BB(
			TAnnotationType tNestedType, TAbstractType tOuterType) {
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_670100 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_670100 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_670100)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_670100)) {
						return new Object[] { tNestedType, tOuterType };
					}
				}
			}
