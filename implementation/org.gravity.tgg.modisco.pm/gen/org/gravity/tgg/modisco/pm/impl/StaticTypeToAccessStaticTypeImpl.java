...
import org.gravity.tgg.modisco.pm.StaticTypeToAccessStaticType;
 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.StaticTypeToAccessStaticTypeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.StaticTypeToAccessStaticTypeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StaticTypeToAccessStaticTypeImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.STATIC_TYPE_TO_ACCESS_STATIC_TYPE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.STATIC_TYPE_TO_ACCESS_STATIC_TYPE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Type newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.STATIC_TYPE_TO_ACCESS_STATIC_TYPE__SOURCE,
					oldSource, source));
	}
	...
	public TCall getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.STATIC_TYPE_TO_ACCESS_STATIC_TYPE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TCall newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.STATIC_TYPE_TO_ACCESS_STATIC_TYPE__TARGET,
					oldTarget, target));
	}
