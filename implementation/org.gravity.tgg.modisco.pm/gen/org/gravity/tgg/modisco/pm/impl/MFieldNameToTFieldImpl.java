 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MFieldNameToTFieldImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MFieldNameToTFieldImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MFieldNameToTFieldImpl extends AbstractCorrespondenceImpl implements MFieldNameToTField {
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.MFIELD_NAME_TO_TFIELD;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.MFIELD_NAME_TO_TFIELD__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(MFieldName newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.MFIELD_NAME_TO_TFIELD__SOURCE, oldSource,
					source));
	}
	...
	public TField getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.MFIELD_NAME_TO_TFIELD__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public void setTarget(TField newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.MFIELD_NAME_TO_TFIELD__TARGET, oldTarget,
					target));
	}
