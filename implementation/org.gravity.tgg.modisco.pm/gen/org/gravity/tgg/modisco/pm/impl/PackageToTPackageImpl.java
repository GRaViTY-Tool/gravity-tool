 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.PackageToTPackageImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.PackageToTPackageImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PackageToTPackageImpl extends AbstractCorrespondenceImpl implements PackageToTPackage {
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.PACKAGE_TO_TPACKAGE;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.PACKAGE_TO_TPACKAGE__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(org.eclipse.modisco.java.Package newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.PACKAGE_TO_TPACKAGE__SOURCE, oldSource,
					source));
	}
	...
	public TPackage getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.PACKAGE_TO_TPACKAGE__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public void setTarget(TPackage newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.PACKAGE_TO_TPACKAGE__TARGET, oldTarget,
					target));
	}
