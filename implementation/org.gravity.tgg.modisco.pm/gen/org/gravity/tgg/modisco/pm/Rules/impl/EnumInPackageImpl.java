...
public class EnumInPackageImpl extends AbstractRuleImpl implements EnumInPackage {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM_IN_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_28__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_28((EMoflonEdge) arguments.get(0));
		case RulesPackage.ENUM_IN_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_30__EMOFLONEDGE:
	...
	public static final Object[] pattern_EnumInPackage_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(
		...
		tAnnotation__tType____tAnnotated.setName(tAnnotation__tType____tAnnotated_name_prime);
		pg__tType____classes.setName(pg__tType____classes_name_prime);
		return new Object[] { match, tAnnotation, tPackage, tType, pg, pg__tType____allTypes, tType__pg____model,
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_0BBBB(TEnum tAnnotation,
		...
		TAnnotatable __DEC_tAnnotation_tAnnotated_380488 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_380488 != null) {
			if (!tPackage.equals(__DEC_tAnnotation_tAnnotated_380488)) {
				if (!tType.equals(__DEC_tAnnotation_tAnnotated_380488)) {
					if (!pg.equals(__DEC_tAnnotation_tAnnotated_380488)) {
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_1BB(TClass tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_classes_294067 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_294067)) {
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_2BB(TClass tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_517855 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_517855)) {
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_19360 = tType.getOuterType();
		if (__DEC_tType_innerTypes_19360 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_19360)) {
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_4BB(TClass tType,
			TPackage tPackage) {
		TPackage __DEC_tType_allTypes_911888 = tType.getPackage();
		if (__DEC_tType_allTypes_911888 != null) {
			if (!tPackage.equals(__DEC_tType_allTypes_911888)) {
				return new Object[] { tType, tPackage };
			}
		}
																...
																if (pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_5BB(
																	...
																	if (pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_6BB(
																		...
																		_result.add(new Object[] { tAnnotation,
																				tPackage, tType, pg, _edge_allTypes });
																	}
																}
															}
														}
	...
	public static final Object[] pattern_EnumInPackage_21_2_testcorematchandDECs_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_887921 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_887921 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_887921)) {
	...
	public static final Object[] pattern_EnumInPackage_21_2_testcorematchandDECs_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_562184 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_562184 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_EnumInPackage_21_2_testcorematchandDECs_black_nac_2B(EnumDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_933575 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_EnumInPackage_21_2_testcorematchandDECs_black_nac_3B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_196178 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_EnumInPackage_27_1_matchtggpattern_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_629409 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_629409 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_629409)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_EnumInPackage_27_1_matchtggpattern_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_402086 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_402086 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_EnumInPackage_27_1_matchtggpattern_black_nac_2B(EnumDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_731163 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, Model.class, "orphanTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_EnumInPackage_27_1_matchtggpattern_black_nac_3B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_122105 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_0BBBB(TEnum tAnnotation,
			TPackage tPackage, TClass tType, TypeGraph pg) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_77470 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_77470 != null) {
			if (!tPackage.equals(__DEC_tAnnotation_tAnnotated_77470)) {
				if (!tType.equals(__DEC_tAnnotation_tAnnotated_77470)) {
					if (!pg.equals(__DEC_tAnnotation_tAnnotated_77470)) {
						return new Object[] { tAnnotation, tPackage, tType, pg };
					}
				}
			}
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_1BB(TClass tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_classes_115265 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_115265)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_2BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_118034 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_118034)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_13216 = tType.getOuterType();
		if (__DEC_tType_innerTypes_13216 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_13216)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_4BB(TClass tType,
			TPackage tPackage) {
		TPackage __DEC_tType_allTypes_606831 = tType.getPackage();
		if (__DEC_tType_allTypes_606831 != null) {
			if (!tPackage.equals(__DEC_tType_allTypes_606831)) {
				return new Object[] { tType, tPackage };
			}
		}
