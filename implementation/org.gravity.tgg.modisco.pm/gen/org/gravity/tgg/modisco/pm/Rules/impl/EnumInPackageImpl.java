...
public class EnumInPackageImpl extends AbstractRuleImpl implements EnumInPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = EnumInPackageImpl.pattern_EnumInPackage_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, tAnnotation, annotatable2Annotatable, mPackageToTPackage, tType, tPackage, mPackage, pg,
				type2Type, mType);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		EnumInPackageImpl.pattern_EnumInPackage_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				tAnnotation, annotatable2Annotatable, mPackageToTPackage, tType, tPackage, mPackage, pg, type2Type,
				mType);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM_IN_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_84__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_84((EMoflonEdge) arguments.get(0));
		case RulesPackage.ENUM_IN_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_88__EMOFLONEDGE:
	...
	public static final void pattern_EnumInPackage_1_5_registerobjects_expressionBBBBBBBBBBB(EnumInPackage _this,
			...
			EObject mPackageToTPackage, EObject tType, EObject tPackage, EObject mPackage, EObject pg,
			EObject type2Type, EObject mType) {
		_this.registerObjects_FWD(ruleresult, tAnnotation, annotatable2Annotatable, mPackageToTPackage, tType, tPackage,
	...
	public static final void pattern_EnumInPackage_11_5_registerobjects_expressionBBBBBBBBBBB(EnumInPackage _this,
			...
			EObject mPackageToTPackage, EObject tType, EObject tPackage, EObject mPackage, EObject pg,
			EObject type2Type, EObject mType) {
		_this.registerObjects_BWD(ruleresult, tAnnotation, annotatable2Annotatable, mPackageToTPackage, tType, tPackage,
				mPackage, pg, type2Type, mType);
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_0BBBB(TEnum tAnnotation,
		...
		TAnnotatable __DEC_tAnnotation_tAnnotated_46920 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_46920 != null) {
			if (!tType.equals(__DEC_tAnnotation_tAnnotated_46920)) {
				if (!tPackage.equals(__DEC_tAnnotation_tAnnotated_46920)) {
					if (!pg.equals(__DEC_tAnnotation_tAnnotated_46920)) {
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_1BB(TClass tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_classes_343013 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_343013)) {
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_2BB(TClass tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_335305 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_335305)) {
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_232898 = tType.getOuterType();
		if (__DEC_tType_innerTypes_232898 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_232898)) {
	...
	public static final Object[] pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_4BB(TEnum tAnnotation,
			TPackage tPackage) {
												...
												for (TAnnotation tmpTAnnotation : tType.getTAnnotation()) {
													if (tmpTAnnotation instanceof TEnum) {
														...
														if (pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_0BBBB(
															...
															if (pattern_EnumInPackage_20_2_testcorematchandDECs_black_nac_4BB(
	...
	public static final Object[] pattern_EnumInPackage_21_2_testcorematchandDECs_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_386488 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_386488 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_386488)) {
	...
	public static final Object[] pattern_EnumInPackage_21_2_testcorematchandDECs_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_320849 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_320849 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_EnumInPackage_21_2_testcorematchandDECs_black_nac_2B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_685301 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_EnumInPackage_27_1_matchtggpattern_black_nac_0B(EnumDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_808827 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_808827 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_808827)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_EnumInPackage_27_1_matchtggpattern_black_nac_1B(EnumDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_100601 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_100601 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_EnumInPackage_27_1_matchtggpattern_black_nac_2B(EnumDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_109224 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_0BBBB(TEnum tAnnotation,
			TClass tType, TPackage tPackage, TypeGraph pg) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_364618 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_364618 != null) {
			if (!tType.equals(__DEC_tAnnotation_tAnnotated_364618)) {
				if (!tPackage.equals(__DEC_tAnnotation_tAnnotated_364618)) {
					if (!pg.equals(__DEC_tAnnotation_tAnnotated_364618)) {
						return new Object[] { tAnnotation, tType, tPackage, pg };
					}
				}
			}
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_1BB(TClass tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_classes_352329 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_352329)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_2BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_412575 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_412575)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_633360 = tType.getOuterType();
		if (__DEC_tType_innerTypes_633360 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_633360)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_EnumInPackage_28_1_matchtggpattern_black_nac_4BB(TEnum tAnnotation,
			TPackage tPackage) {
		if (tPackage.equals(tAnnotation.getTAnnotated())) {
			return new Object[] { tAnnotation, tPackage };
		}
									...
									if (pattern_EnumInPackage_28_1_matchtggpattern_black_nac_1BB(tType,
										...
										if (pattern_EnumInPackage_28_1_matchtggpattern_black_nac_2BB(tType,
											...
											if (pattern_EnumInPackage_28_1_matchtggpattern_black_nac_3B(
													tType) == null) {
												if (pattern_EnumInPackage_28_1_matchtggpattern_black_nac_4BB(
														tAnnotation, tPackage) == null) {
