...
public class AnnotationMemberValueNumberArrayImpl extends AbstractRuleImpl implements AnnotationMemberValueNumberArray {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		NumberLiteral mValue = (NumberLiteral) result1_bindingAndBlack[3];
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberValueNumberArrayImpl
				.pattern_AnnotationMemberValueNumberArray_2_2_corematch_blackFBBBFB(mAnnotationValue, mArray, mValue,
						match)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		NumberLiteral mValue = (NumberLiteral) result2_bindingAndBlack[3];
	...
	public CSP isApplicable_solveCsp_CC(AnnotationMemberValuePair mAnnotationValue, ArrayInitializer mArray,
			TNumberNode tValue, NumberLiteral mValue, TAnnotationValue tAnnotationValue, Match sourceMatch,
		...
		for (Object[] result2_black : AnnotationMemberValueNumberArrayImpl
			...
			if (AnnotationMemberValueNumberArrayImpl
				...
				if (result5_black != null) {
					...
					AnnotationMemberValueNumberArrayImpl
							.pattern_AnnotationMemberValueNumberArray_29_6_perform_greenFBFFBBB(mArray,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER_ARRAY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONMEMBERVALUEPAIRTOTANNOTATIONVALUE_ANNOTATIONMEMBERVALUEPAIR_ARRAYINITIALIZER_NUMBERLITERAL_TANNOTATIONVALUE:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						...
						(NumberLiteral) arguments.get(4), (TAnnotationValue) arguments.get(5));
			...
			case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER_ARRAY___IS_APPLICABLE_SOLVE_CSP_CC__ANNOTATIONMEMBERVALUEPAIR_ARRAYINITIALIZER_TNUMBERNODE_NUMBERLITERAL_TANNOTATIONVALUE_MATCH_MATCH:
				return isApplicable_solveCsp_CC((AnnotationMemberValuePair) arguments.get(0),
						...
						(NumberLiteral) arguments.get(3), (TAnnotationValue) arguments.get(4), (Match) arguments.get(5),
	...
	public static final Object[] pattern_AnnotationMemberValueNumberArray_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberValueNumberArray_1_1_performtransformation_binding != null) {
			...
			NumberLiteral mValue = (NumberLiteral) result_pattern_AnnotationMemberValueNumberArray_1_1_performtransformation_binding[3];
			TAnnotationValue tAnnotationValue = (TAnnotationValue) result_pattern_AnnotationMemberValueNumberArray_1_1_performtransformation_binding[4];
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberValueNumberArray_2_2_corematch_blackFBBBFB(
	...
	public static final Object[] pattern_AnnotationMemberValueNumberArray_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AnnotationMemberValuePair __DEC_mValue_value_361363 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mValue, AnnotationMemberValuePair.class, "value")) {
			if (!mAnnotationValue.equals(__DEC_mValue_value_361363)) {
	...
	public static final Object[] pattern_AnnotationMemberValueNumberArray_24_2_matchsrctrgcontext_blackBBBBBBB(
			AnnotationMemberValuePair mAnnotationValue, ArrayInitializer mArray, TNumberNode tValue,
			NumberLiteral mValue, TAnnotationValue tAnnotationValue, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_AnnotationMemberValueNumberArray_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_AnnotationMemberValueNumberArray_24_2_matchsrctrgcontext_binding != null) {
			...
			NumberLiteral mValue = (NumberLiteral) result_pattern_AnnotationMemberValueNumberArray_24_2_matchsrctrgcontext_binding[3];
			TAnnotationValue tAnnotationValue = (TAnnotationValue) result_pattern_AnnotationMemberValueNumberArray_24_2_matchsrctrgcontext_binding[4];
	...
	public static final Object[] pattern_AnnotationMemberValueNumberArray_24_6_createcorrespondence_blackBBBBBB(
			AnnotationMemberValuePair mAnnotationValue, ArrayInitializer mArray, TNumberNode tValue,
			NumberLiteral mValue, TAnnotationValue tAnnotationValue, CCMatch ccMatch) {
	...
	public static final Object[] pattern_AnnotationMemberValueNumberArray_27_1_matchtggpattern_black_nac_0BB(
			NumberLiteral mValue, AnnotationMemberValuePair mAnnotationValue) {
		for (AnnotationMemberValuePair __DEC_mValue_value_566316 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mValue, AnnotationMemberValuePair.class, "value")) {
			if (!mAnnotationValue.equals(__DEC_mValue_value_566316)) {
				return new Object[] { mValue, mAnnotationValue };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberValueNumberArray_29_6_perform_greenFBFFBBB(
