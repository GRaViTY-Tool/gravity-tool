...
public class InitializerInTypeImpl extends AbstractRuleImpl implements InitializerInType {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INITIALIZER_IN_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_43__EMOFLONEDGE:
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TAbstractType __DEC_tSignature_returnType_422825 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_422825 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_422825)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TMethod __DEC_tSignature_signatures_828130 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_828130 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_828130)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_2BB(TModifier tModifier,
			TAbstractType tType) {
		for (TAbstractType __DEC_tModifier_tModifier_828743 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_828743)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_432174 = tName.getModel();
		if (__DEC_tName_methods_432174 != null) {
			if (!tPM.equals(__DEC_tName_methods_432174)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_4BB(
		...
		TAbstractType __DEC_tDefinition_returnType_135108 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_135108 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_135108)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_5BB(
		...
		TSignature __DEC_tDefinition_definitions_906190 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_906190 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_906190)) {
	...
	public static final Object[] pattern_InitializerInType_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_344519 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_344519 != null) {
	...
	public static final Object[] pattern_InitializerInType_27_1_matchtggpattern_black_nac_0B(MInitializer mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_1819 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_1819 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_0BB(
			TMethodSignature tSignature, TAbstractType tType) {
		TAbstractType __DEC_tSignature_returnType_845597 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_845597 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_845597)) {
				return new Object[] { tSignature, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_1BB(
			TMethodSignature tSignature, TMethod tName) {
		TMethod __DEC_tSignature_signatures_430741 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_430741 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_430741)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_2BB(TModifier tModifier,
			TAbstractType tType) {
		for (TAbstractType __DEC_tModifier_tModifier_774928 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_774928)) {
				return new Object[] { tModifier, tType };
			}
		}
		return null;
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_557020 = tName.getModel();
		if (__DEC_tName_methods_557020 != null) {
			if (!tPM.equals(__DEC_tName_methods_557020)) {
				return new Object[] { tName, tPM };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_4BB(
			TMethodDefinition tDefinition, TAbstractType tType) {
		TAbstractType __DEC_tDefinition_returnType_69462 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_69462 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_69462)) {
				return new Object[] { tDefinition, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_5BB(
			TMethodDefinition tDefinition, TMethodSignature tSignature) {
		TSignature __DEC_tDefinition_definitions_826901 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_826901 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_826901)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
