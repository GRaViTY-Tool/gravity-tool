...
public class InitializerInTypeImpl extends AbstractRuleImpl implements InitializerInType {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INITIALIZER_IN_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_58__EMOFLONEDGE:
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TAbstractType __DEC_tSignature_returnType_30470 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_30470 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_30470)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TMethod __DEC_tSignature_signatures_635982 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_635982 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_635982)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_2BB(TModifier tModifier,
			TAbstractType tType) {
		for (TAbstractType __DEC_tModifier_tModifier_277142 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_277142)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_232469 = tName.getModel();
		if (__DEC_tName_methods_232469 != null) {
			if (!tPM.equals(__DEC_tName_methods_232469)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_4BB(
		...
		TAbstractType __DEC_tDefinition_returnType_896278 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_896278 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_896278)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_5BB(
		...
		TSignature __DEC_tDefinition_definitions_930473 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_930473 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_930473)) {
	...
	public static final Object[] pattern_InitializerInType_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_87938 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_87938 != null) {
	...
	public static final Object[] pattern_InitializerInType_27_1_matchtggpattern_black_nac_0B(MInitializer mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_748038 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_748038 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_0BB(
			TMethodSignature tSignature, TAbstractType tType) {
		TAbstractType __DEC_tSignature_returnType_913509 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_913509 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_913509)) {
				return new Object[] { tSignature, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_1BB(
			TMethodSignature tSignature, TMethod tName) {
		TMethod __DEC_tSignature_signatures_952424 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_952424 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_952424)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_2BB(TModifier tModifier,
			TAbstractType tType) {
		for (TAbstractType __DEC_tModifier_tModifier_319114 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_319114)) {
				return new Object[] { tModifier, tType };
			}
		}
		return null;
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_981895 = tName.getModel();
		if (__DEC_tName_methods_981895 != null) {
			if (!tPM.equals(__DEC_tName_methods_981895)) {
				return new Object[] { tName, tPM };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_4BB(
			TMethodDefinition tDefinition, TAbstractType tType) {
		TAbstractType __DEC_tDefinition_returnType_499729 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_499729 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_499729)) {
				return new Object[] { tDefinition, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_5BB(
			TMethodDefinition tDefinition, TMethodSignature tSignature) {
		TSignature __DEC_tDefinition_definitions_543573 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_543573 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_543573)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
