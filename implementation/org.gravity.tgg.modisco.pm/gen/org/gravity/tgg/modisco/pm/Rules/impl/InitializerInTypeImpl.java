...
public class InitializerInTypeImpl extends AbstractRuleImpl implements InitializerInType {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INITIALIZER_IN_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_19__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_19((EMoflonEdge) arguments.get(0));
		case RulesPackage.INITIALIZER_IN_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_21__EMOFLONEDGE:
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TAbstractType __DEC_tSignature_returnType_984222 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_984222 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_984222)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TMethod __DEC_tSignature_signatures_654789 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_654789 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_654789)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_2BB(TModifier tModifier,
			TAbstractType tType) {
		for (TAbstractType __DEC_tModifier_tModifier_772048 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_772048)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_573250 = tName.getModel();
		if (__DEC_tName_methods_573250 != null) {
			if (!tPM.equals(__DEC_tName_methods_573250)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_4BB(
		...
		TAbstractType __DEC_tDefinition_returnType_541031 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_541031 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_541031)) {
	...
	public static final Object[] pattern_InitializerInType_20_2_testcorematchandDECs_black_nac_5BB(
		...
		TSignature __DEC_tDefinition_definitions_490481 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_490481 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_490481)) {
	...
	public static final Object[] pattern_InitializerInType_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_402366 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_402366 != null) {
	...
	public static final Object[] pattern_InitializerInType_27_1_matchtggpattern_black_nac_0B(MInitializer mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_737770 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_737770 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_0BB(
			TMethodSignature tSignature, TAbstractType tType) {
		TAbstractType __DEC_tSignature_returnType_634517 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_634517 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_634517)) {
				return new Object[] { tSignature, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_1BB(
			TMethodSignature tSignature, TMethod tName) {
		TMethod __DEC_tSignature_signatures_488997 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_488997 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_488997)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_2BB(TModifier tModifier,
			TAbstractType tType) {
		for (TAbstractType __DEC_tModifier_tModifier_43792 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_43792)) {
				return new Object[] { tModifier, tType };
			}
		}
		return null;
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_812672 = tName.getModel();
		if (__DEC_tName_methods_812672 != null) {
			if (!tPM.equals(__DEC_tName_methods_812672)) {
				return new Object[] { tName, tPM };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_4BB(
			TMethodDefinition tDefinition, TAbstractType tType) {
		TAbstractType __DEC_tDefinition_returnType_21206 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_21206 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_21206)) {
				return new Object[] { tDefinition, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInType_28_1_matchtggpattern_black_nac_5BB(
			TMethodDefinition tDefinition, TMethodSignature tSignature) {
		TSignature __DEC_tDefinition_definitions_393082 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_393082 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_393082)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
