...
public class AnnotationMemberValueNumberImpl extends AbstractRuleImpl implements AnnotationMemberValueNumber {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_7__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_7((EMoflonEdge) arguments.get(0));
			case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_8__EMOFLONEDGE:
			...
			case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER___IS_APPLICABLE_SOLVE_CSP_CC__ANNOTATION_ANNOTATIONMEMBERVALUEPAIR_TNUMBERNODE_BODYDECLARATION_NUMBERLITERAL_TANNOTATIONVALUE_MATCH_MATCH:
				return isApplicable_solveCsp_CC((Annotation) arguments.get(0),
						...
						(BodyDeclaration) arguments.get(3), (NumberLiteral) arguments.get(4),
