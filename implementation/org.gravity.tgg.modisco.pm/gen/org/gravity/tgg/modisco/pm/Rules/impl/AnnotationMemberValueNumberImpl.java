...
public class AnnotationMemberValueNumberImpl extends AbstractRuleImpl implements AnnotationMemberValueNumber {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_68(EMoflonEdge _edge_value) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_64__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_64((EMoflonEdge) arguments.get(0));
			case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_68__EMOFLONEDGE:
			...
			case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER___IS_APPLICABLE_SOLVE_CSP_CC__ANNOTATION_ANNOTATIONMEMBERVALUEPAIR_TNUMBERNODE_BODYDECLARATION_TANNOTATIONVALUE_NUMBERLITERAL_MATCH_MATCH:
				return isApplicable_solveCsp_CC((Annotation) arguments.get(0),
						(AnnotationMemberValuePair) arguments.get(1), (TNumberNode) arguments.get(2),
						(BodyDeclaration) arguments.get(3), (TAnnotationValue) arguments.get(4),
						(NumberLiteral) arguments.get(5), (Match) arguments.get(6), (Match) arguments.get(7));
