...
public class AnnotationMemberValueNumberImpl extends AbstractRuleImpl implements AnnotationMemberValueNumber {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = AnnotationMemberValueNumberImpl
				.pattern_AnnotationMemberValueNumber_1_1_performtransformation_greenFFBBB(tAnnotationValue, mValue,
						csp);
		NumberLiteralToTNumberNode mTypeToTType = (NumberLiteralToTNumberNode) result1_green[0];
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberValueNumberImpl
				.pattern_AnnotationMemberValueNumber_2_2_corematch_blackBBFBFBB(annotation, mAnnotationValue, mOwner,
						mValue, match)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Annotation annotation,
			...
			AnnotationMemberValuePairToTAnnotationValue AnnotationMemberValuePairToTAnnotationValue,
			BodyDeclaration mOwner, TAnnotationValue tAnnotationValue, NumberLiteral mValue) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = AnnotationMemberValueNumberImpl
				.pattern_AnnotationMemberValueNumber_11_1_performtransformation_greenBFBFB(mAnnotationValue, tValue,
						csp);
		NumberLiteralToTNumberNode mTypeToTType = (NumberLiteralToTNumberNode) result1_green[1];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_129(EMoflonEdge _edge_tValue) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (AnnotationMemberValueNumberImpl.pattern_AnnotationMemberValueNumber_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberValueNumberImpl
				...
				//nothing NumberLiteralToTNumberNode mTypeToTType = (NumberLiteralToTNumberNode) result6_green[0];
		...
		for (Object[] result2_black : AnnotationMemberValueNumberImpl
			...
			if (AnnotationMemberValueNumberImpl.pattern_AnnotationMemberValueNumber_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					//nothing NumberLiteralToTNumberNode mTypeToTType = (NumberLiteralToTNumberNode) result6_green[1];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATION_ANNOTATIONMEMBERVALUEPAIR_ANNOTATIONMEMBERVALUEPAIRTOTANNOTATIONVALUE_BODYDECLARATION_TANNOTATIONVALUE_NUMBERLITERAL:
		...
		case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_129__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_129((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_VALUE_NUMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_132__EMOFLONEDGE:
	...
	public static final Object[] pattern_AnnotationMemberValueNumber_1_1_performtransformation_blackBBBBBBFBB(
			...
			AnnotationMemberValuePairToTAnnotationValue annotationMemberValuePairToTAnnotationValue,
			BodyDeclaration mOwner, TAnnotationValue tAnnotationValue, NumberLiteral mValue,
	...
	public static final Object[] pattern_AnnotationMemberValueNumber_1_1_performtransformation_greenFFBBB(
		...
		NumberLiteralToTNumberNode mTypeToTType = PmFactory.eINSTANCE.createNumberLiteralToTNumberNode();
	...
	public static final Object[] pattern_AnnotationMemberValueNumber_1_2_collecttranslatedelements_blackBBB(
			NumberLiteralToTNumberNode mTypeToTType, TNumberNode tValue, NumberLiteral mValue) {
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberValueNumber_2_2_corematch_blackBBFBFBB(
			Annotation annotation, AnnotationMemberValuePair mAnnotationValue, BodyDeclaration mOwner,
