 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MMethodNameToTMethodImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MMethodNameToTMethodImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MMethodNameToTMethodImpl extends AbstractCorrespondenceImpl implements MMethodNameToTMethod {
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.MMETHOD_NAME_TO_TMETHOD;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.MMETHOD_NAME_TO_TMETHOD__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(MMethodName newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.MMETHOD_NAME_TO_TMETHOD__SOURCE, oldSource,
					source));
	}
	...
	public TMethod getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.MMETHOD_NAME_TO_TMETHOD__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public void setTarget(TMethod newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.MMETHOD_NAME_TO_TMETHOD__TARGET, oldTarget,
					target));
	}
