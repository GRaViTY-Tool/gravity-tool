...
public class PrimitiveTypeIsByteImpl extends AbstractRuleImpl implements PrimitiveTypeIsByte {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BYTE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_31__EMOFLONEDGE:
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_20_2_testcorematchandDECs_black_nac_0B(
		...
		for (TPackage __DEC_tPrimitiveClass_classes_990348 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_20_2_testcorematchandDECs_black_nac_1BB(
		...
		for (TypeGraph __DEC_tPrimitiveClass_classes_706739 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_706739)) {
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_20_2_testcorematchandDECs_black_nac_2B(
			TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_353302 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_353302 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_353302)) {
				return new Object[] { tPrimitiveClass };
			}
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_28_1_matchtggpattern_black_nac_0B(TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_161036 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TPackage.class, "classes")) {
			return new Object[] { tPrimitiveClass };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_28_1_matchtggpattern_black_nac_1BB(TClass tPrimitiveClass,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tPrimitiveClass_classes_339923 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_339923)) {
				return new Object[] { tPrimitiveClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsByte_28_1_matchtggpattern_black_nac_2B(TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_185208 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_185208 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_185208)) {
				return new Object[] { tPrimitiveClass };
			}
		}
