...
public class TypeParameterImpl extends AbstractRuleImpl implements TypeParameter {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypeParameterImpl.pattern_TypeParameter_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, eModelToPg, eModel, eAnonymousClassDeclarationToTClass, typeParameter, pg, tClass);
		...
		TypeParameterImpl.pattern_TypeParameter_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult, eModel,
				eAnonymousClassDeclarationToTClass, typeParameter, pg, tClass);
		...
		TypeParameterImpl.pattern_TypeParameter_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, eModelToPg,
				eModel, eAnonymousClassDeclarationToTClass, typeParameter, pg, tClass);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eModelToPg, EObject eModel,
			EObject eAnonymousClassDeclarationToTClass, EObject typeParameter, EObject pg, EObject tClass) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeParameterImpl.pattern_TypeParameter_12_2_corematch_blackFFBBB(pg, tClass,
			...
			for (Object[] result3_black : TypeParameterImpl.pattern_TypeParameter_12_3_findcontext_blackBBBB(eModelToPg,
					eModel, pg, tClass)) {
				Object[] result3_green = TypeParameterImpl
						.pattern_TypeParameter_12_3_findcontext_greenBBBBFFFFFF(eModelToPg, eModel, pg, tClass);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				//nothing EMoflonEdge eModelToPg__eModel____source = (EMoflonEdge) result3_green[5];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ModelToTypeGraph eModelToPg,
			MGravityModel eModel, TypeGraph pg, TClass tClass) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject eModelToPg, EObject eModel,
			EObject eAnonymousClassDeclarationToTClass, EObject typeParameter, EObject pg, EObject tClass) {
		ruleresult.registerObject("eModelToPg", eModelToPg);
		ruleresult.registerObject("eModel", eModel);
		ruleresult.registerObject("eAnonymousClassDeclarationToTClass", eAnonymousClassDeclarationToTClass);
		...
		for (Object[] result2_black : TypeParameterImpl
			...
			if (TypeParameterImpl.pattern_TypeParameter_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					TypeParameterImpl.pattern_TypeParameter_29_6_perform_greenBFFBFB(eModel, pg, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_PARAMETER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_MGRAVITYMODEL_TYPEGRAPH_TCLASS:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ModelToTypeGraph) arguments.get(1),
					(MGravityModel) arguments.get(2), (TypeGraph) arguments.get(3), (TClass) arguments.get(4));
	...
	public static final Object[] pattern_TypeParameter_1_1_performtransformation_greenFBBF(
		...
		return new Object[] { eAnonymousClassDeclarationToTClass, typeParameter, pg, tClass };
	}
	...
	public static final Object[] pattern_TypeParameter_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject eModelToPg, EObject eModel,
			EObject eAnonymousClassDeclarationToTClass, EObject typeParameter, EObject pg, EObject tClass) {
	...
	public static final Object[] pattern_TypeParameter_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(
			...
			EObject typeParameter, EObject pg, EObject tClass) {
		EMoflonEdge eModel__typeParameter____typeParameters = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, eModel, eAnonymousClassDeclarationToTClass, typeParameter, pg, tClass,
	...
	public static final void pattern_TypeParameter_1_5_registerobjects_expressionBBBBBBBB(TypeParameter _this,
			PerformRuleResult ruleresult, EObject eModelToPg, EObject eModel,
			EObject eAnonymousClassDeclarationToTClass, EObject typeParameter, EObject pg, EObject tClass) {
		_this.registerObjects_FWD(ruleresult, eModelToPg, eModel, eAnonymousClassDeclarationToTClass, typeParameter, pg,
				tClass);
	...
	public static final Object[] pattern_TypeParameter_11_1_performtransformation_blackBBBBFBB(
			ModelToTypeGraph eModelToPg, MGravityModel eModel, TypeGraph pg, TClass tClass, TypeParameter _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
	...
	public static final void pattern_TypeParameter_11_5_registerobjects_expressionBBBBBBBB(TypeParameter _this,
			PerformRuleResult ruleresult, EObject eModelToPg, EObject eModel,
			EObject eAnonymousClassDeclarationToTClass, EObject typeParameter, EObject pg, EObject tClass) {
		_this.registerObjects_BWD(ruleresult, eModelToPg, eModel, eAnonymousClassDeclarationToTClass, typeParameter, pg,
				tClass);
	...
	public static final Object[] pattern_TypeParameter_12_3_findcontext_greenBBBBFFFFFF(ModelToTypeGraph eModelToPg,
		...
		eModelToPg__pg____target.setName(eModelToPg__pg____target_name_prime);
		pg__tClass____classes.setName(pg__tClass____classes_name_prime);
		return new Object[] { eModelToPg, eModel, pg, tClass, isApplicableMatch, eModelToPg__eModel____source,
				pg__tClass____ownedTypes, tClass__pg____model, eModelToPg__pg____target, pg__tClass____classes };
	}
	...
	public static final Object[] pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_0B(TClass tClass) {
		for (TPackage __DEC_tClass_classes_647051 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_1BB(TClass tClass,
			TypeGraph pg) {
		for (TypeGraph __DEC_tClass_classes_814680 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tClass, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tClass_classes_814680)) {
	...
	public static final Object[] pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_2B(TClass tClass) {
		TAbstractType __DEC_tClass_innerTypes_349292 = tClass.getOuterType();
		if (__DEC_tClass_innerTypes_349292 != null) {
			if (!tClass.equals(__DEC_tClass_innerTypes_349292)) {
				return new Object[] { tClass };
			}
		}
	...
	public static final Object[] pattern_TypeParameter_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (MGravityModel __DEC_typeParameter_typeParameters_677759 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeParameter, MGravityModel.class, "typeParameters")) {
			if (!eModel.equals(__DEC_typeParameter_typeParameters_677759)) {
	...
	public static final Object[] pattern_TypeParameter_27_1_matchtggpattern_black_nac_0BB(
			org.eclipse.modisco.java.TypeParameter typeParameter, MGravityModel eModel) {
		for (MGravityModel __DEC_typeParameter_typeParameters_923475 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeParameter, MGravityModel.class, "typeParameters")) {
			if (!eModel.equals(__DEC_typeParameter_typeParameters_923475)) {
				return new Object[] { typeParameter, eModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_0B(TClass tClass) {
		for (TPackage __DEC_tClass_classes_891773 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tClass, TPackage.class, "classes")) {
			return new Object[] { tClass };
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_1BB(TClass tClass, TypeGraph pg) {
		for (TypeGraph __DEC_tClass_classes_836715 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tClass, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tClass_classes_836715)) {
				return new Object[] { tClass, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_2B(TClass tClass) {
		TAbstractType __DEC_tClass_innerTypes_760719 = tClass.getOuterType();
		if (__DEC_tClass_innerTypes_760719 != null) {
			if (!tClass.equals(__DEC_tClass_innerTypes_760719)) {
				return new Object[] { tClass };
			}
		}
	...
	public static final Object[] pattern_TypeParameter_29_6_perform_greenBFFBFB(MGravityModel eModel, TypeGraph pg,
			ModelgeneratorRuleResult ruleResult) {
		TypeToTAbstractType eAnonymousClassDeclarationToTClass = PmFactory.eINSTANCE.createTypeToTAbstractType();
		org.eclipse.modisco.java.TypeParameter typeParameter = JavaFactory.eINSTANCE.createTypeParameter();
		TClass tClass = BasicFactory.eINSTANCE.createTClass();
		...
		return new Object[] { eModel, eAnonymousClassDeclarationToTClass, typeParameter, pg, tClass, ruleResult };
	}
