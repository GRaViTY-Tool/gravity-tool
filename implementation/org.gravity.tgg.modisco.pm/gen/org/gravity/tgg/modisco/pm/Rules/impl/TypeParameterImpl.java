...
public class TypeParameterImpl extends AbstractRuleImpl implements TypeParameter {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypeParameterImpl.pattern_TypeParameter_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, eModel, eModelToPg, tClass, typeParameter, eAnonymousClassDeclarationToTClass, pg);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[eModel] = "
							+ eModel + ", " + "[eModelToPg] = " + eModelToPg + ", " + "[tClass] = " + tClass + ", "
							+ "[typeParameter] = " + typeParameter + ", " + "[eAnonymousClassDeclarationToTClass] = "
							+ eAnonymousClassDeclarationToTClass + ", " + "[pg] = " + pg + ".");
		}
		TypeParameterImpl.pattern_TypeParameter_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult, eModel, tClass,
				typeParameter, eAnonymousClassDeclarationToTClass, pg);
		...
		TypeParameterImpl.pattern_TypeParameter_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, eModel,
				eModelToPg, tClass, typeParameter, eAnonymousClassDeclarationToTClass, pg);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eModel, EObject eModelToPg, EObject tClass,
			EObject typeParameter, EObject eAnonymousClassDeclarationToTClass, EObject pg) {
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject eModel, EObject eModelToPg, EObject tClass,
			EObject typeParameter, EObject eAnonymousClassDeclarationToTClass, EObject pg) {
		ruleresult.registerObject("eModel", eModel);
		ruleresult.registerObject("eModelToPg", eModelToPg);
		ruleresult.registerObject("tClass", tClass);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_PARAMETER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_25__EMOFLONEDGE:
	...
	public static final Object[] pattern_TypeParameter_1_1_performtransformation_greenFBFB(
		...
		return new Object[] { tClass, typeParameter, eAnonymousClassDeclarationToTClass, pg };
	}
	...
	public static final Object[] pattern_TypeParameter_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject eModel, EObject eModelToPg, EObject tClass, EObject typeParameter,
															...
															if (!pg.equals(tClass)) {
																if (!pg.equals(typeParameter)) {
																	return new Object[] { ruleresult, eModel,
																			eModelToPg, tClass, typeParameter,
	...
	public static final Object[] pattern_TypeParameter_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject eModel, EObject tClass, EObject typeParameter,
			EObject eAnonymousClassDeclarationToTClass, EObject pg) {
		...
		return new Object[] { ruleresult, eModel, tClass, typeParameter, eAnonymousClassDeclarationToTClass, pg,
				eAnonymousClassDeclarationToTClass__typeParameter____source,
	...
	public static final void pattern_TypeParameter_1_5_registerobjects_expressionBBBBBBBB(TypeParameter _this,
			PerformRuleResult ruleresult, EObject eModel, EObject eModelToPg, EObject tClass, EObject typeParameter,
			EObject eAnonymousClassDeclarationToTClass, EObject pg) {
		_this.registerObjects_FWD(ruleresult, eModel, eModelToPg, tClass, typeParameter,
				eAnonymousClassDeclarationToTClass, pg);
	...
	public static final Object[] pattern_TypeParameter_2_3_findcontext_greenBBBBFFFF(MGravityModel eModel,
		...
		return new Object[] { eModel, eModelToPg, typeParameter, pg, isApplicableMatch, eModelToPg__eModel____source,
	...
	public static final void pattern_TypeParameter_11_5_registerobjects_expressionBBBBBBBB(TypeParameter _this,
			PerformRuleResult ruleresult, EObject eModel, EObject eModelToPg, EObject tClass, EObject typeParameter,
			EObject eAnonymousClassDeclarationToTClass, EObject pg) {
		_this.registerObjects_BWD(ruleresult, eModel, eModelToPg, tClass, typeParameter,
				eAnonymousClassDeclarationToTClass, pg);
	...
	public static final Object[] pattern_TypeParameter_12_3_findcontext_greenBBBBFFFFFF(MGravityModel eModel,
		...
		return new Object[] { eModel, eModelToPg, tClass, pg, isApplicableMatch, eModelToPg__eModel____source,
				pg__tClass____classes, eModelToPg__pg____target, pg__tClass____ownedTypes, tClass__pg____model };
	}
	...
	public static final Object[] pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_0B(TClass tClass) {
		for (TPackage __DEC_tClass_classes_258338 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_1BB(TClass tClass,
			TypeGraph pg) {
		for (TypeGraph __DEC_tClass_classes_373436 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tClass, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tClass_classes_373436)) {
	...
	public static final Object[] pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_2B(TClass tClass) {
		TPackage __DEC_tClass_ownedTypes_866100 = tClass.getPackage();
		if (__DEC_tClass_ownedTypes_866100 != null) {
			return new Object[] { tClass };
		}
	...
	public static final Object[] pattern_TypeParameter_20_2_testcorematchandDECs_black_nac_3B(TClass tClass) {
		TAbstractType __DEC_tClass_innerTypes_358712 = tClass.getOuterType();
		if (__DEC_tClass_innerTypes_358712 != null) {
			if (!tClass.equals(__DEC_tClass_innerTypes_358712)) {
				return new Object[] { tClass };
			}
		}
	...
	public static final Object[] pattern_TypeParameter_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (MGravityModel __DEC_typeParameter_typeParameters_149631 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeParameter, MGravityModel.class, "typeParameters")) {
			if (!eModel.equals(__DEC_typeParameter_typeParameters_149631)) {
	...
	public static final Object[] pattern_TypeParameter_21_2_testcorematchandDECs_black_nac_1BB(
			org.eclipse.modisco.java.TypeParameter typeParameter, MGravityModel eModel) {
		for (Model __DEC_typeParameter_orphanTypes_694458 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeParameter, Model.class, "orphanTypes")) {
			if (!eModel.equals(__DEC_typeParameter_orphanTypes_694458)) {
				return new Object[] { typeParameter, eModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_27_1_matchtggpattern_black_nac_0BB(
			org.eclipse.modisco.java.TypeParameter typeParameter, MGravityModel eModel) {
		for (MGravityModel __DEC_typeParameter_typeParameters_146584 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeParameter, MGravityModel.class, "typeParameters")) {
			if (!eModel.equals(__DEC_typeParameter_typeParameters_146584)) {
				return new Object[] { typeParameter, eModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_27_1_matchtggpattern_black_nac_1BB(
			org.eclipse.modisco.java.TypeParameter typeParameter, MGravityModel eModel) {
		for (Model __DEC_typeParameter_orphanTypes_359939 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeParameter, Model.class, "orphanTypes")) {
			if (!eModel.equals(__DEC_typeParameter_orphanTypes_359939)) {
				return new Object[] { typeParameter, eModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_0B(TClass tClass) {
		for (TPackage __DEC_tClass_classes_885271 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tClass, TPackage.class, "classes")) {
			return new Object[] { tClass };
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_1BB(TClass tClass, TypeGraph pg) {
		for (TypeGraph __DEC_tClass_classes_78250 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tClass, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tClass_classes_78250)) {
				return new Object[] { tClass, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_2B(TClass tClass) {
		TPackage __DEC_tClass_ownedTypes_123397 = tClass.getPackage();
		if (__DEC_tClass_ownedTypes_123397 != null) {
			return new Object[] { tClass };
		}
	...
	public static final Object[] pattern_TypeParameter_28_1_matchtggpattern_black_nac_3B(TClass tClass) {
		TAbstractType __DEC_tClass_innerTypes_489246 = tClass.getOuterType();
		if (__DEC_tClass_innerTypes_489246 != null) {
			if (!tClass.equals(__DEC_tClass_innerTypes_489246)) {
				return new Object[] { tClass };
			}
		}
	...
	public static final Object[] pattern_TypeParameter_29_6_perform_greenBFFFBB(MGravityModel eModel, TypeGraph pg,
		...
		return new Object[] { eModel, tClass, typeParameter, eAnonymousClassDeclarationToTClass, pg, ruleResult };
	}
