...
import org.gravity.tgg.modisco.pm.FieldAccessToTAccess;
 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.FieldAccessToTAccessImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.FieldAccessToTAccessImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FieldAccessToTAccessImpl extends AbstractCorrespondenceImpl implements FieldAccessToTAccess {
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.FIELD_ACCESS_TO_TACCESS;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.FIELD_ACCESS_TO_TACCESS__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(FieldAccess newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.FIELD_ACCESS_TO_TACCESS__SOURCE, oldSource,
					source));
	}
	...
	public TAccess getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.FIELD_ACCESS_TO_TACCESS__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public void setTarget(TAccess newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.FIELD_ACCESS_TO_TACCESS__TARGET, oldTarget,
					target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PmPackage.FIELD_ACCESS_TO_TACCESS__SOURCE:
				if (resolve)
					return getSource();
				return basicGetSource();
			case PmPackage.FIELD_ACCESS_TO_TACCESS__TARGET:
				if (resolve)
					return getTarget();
