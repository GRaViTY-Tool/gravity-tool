...
public class MethodInvocationStaticTypeImpl extends AbstractRuleImpl implements MethodInvocationStaticType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType, tStaticType, invocation);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ mStaticTypeTotStaticType + ", " + "[tStaticType] = " + tStaticType + ", " + "[invocation] = "
					+ invocation + ".");
		}
		MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_greenBBBBBFF(
				ruleresult, mStaticType, tAccess, tStaticType, invocation);
		...
		MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType, tStaticType,
				invocation);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
			...
			for (Object[] result3_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_2_3_findcontext_blackBBBBBB(invocationToTAccess, mStaticType,
							tAccess, mStaticTypeTotStaticType, tStaticType, invocation)) {
				Object[] result3_green = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_2_3_findcontext_greenBBBBBBFFFFFF(invocationToTAccess,
								mStaticType, tAccess, mStaticTypeTotStaticType, tStaticType, invocation);
				...
				Object[] result4_bindingAndBlack = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			TypeToTAbstractType mStaticTypeTotStaticType, TAbstractType tStaticType, MMethodInvocation invocation) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject invocationToTAccess, EObject mStaticType,
			EObject tAccess, EObject mStaticTypeTotStaticType, EObject tStaticType, EObject invocation) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_12_3_findcontext_blackBBBBBB(invocationToTAccess, mStaticType,
							tAccess, mStaticTypeTotStaticType, tStaticType, invocation)) {
				Object[] result3_green = MethodInvocationStaticTypeImpl
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject invocationToTAccess, EObject mStaticType,
			EObject tAccess, EObject mStaticTypeTotStaticType, EObject tStaticType, EObject invocation) {
		ruleresult.registerObject("invocationToTAccess", invocationToTAccess);
		ruleresult.registerObject("mStaticType", mStaticType);
		ruleresult.registerObject("tAccess", tAccess);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_222(EMoflonEdge _edge_staticType) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_231(EMoflonEdge _edge_mStaticType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mStaticType, tAccess,
						tStaticType, invocation, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mStaticType] = " + mStaticType + ", " + "[tAccess] = " + tAccess + ", " + "[tStaticType] = "
		...
		if (MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_24_5_matchcorrcontext_blackFBBFBBBB(mStaticType, tAccess,
							tStaticType, invocation, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_24_6_createcorrespondence_blackBBBBB(mStaticType, tAccess,
								tStaticType, invocation, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mStaticType] = "
							+ mStaticType + ", " + "[tAccess] = " + tAccess + ", " + "[tStaticType] = " + tStaticType
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Type mStaticType, TCall tAccess, TAbstractType tStaticType,
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
			...
			Object[] result3_bindingAndBlack = MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType, tStaticType,
			...
			if (MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_29_5_checknacs_blackBBBBBB(invocationToTAccess, mStaticType,
								tAccess, mStaticTypeTotStaticType, tStaticType, invocation);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								+ "[invocationToTAccess] = " + invocationToTAccess + ", " + "[mStaticType] = "
								+ mStaticType + ", " + "[tAccess] = " + tAccess + ", " + "[mStaticTypeTotStaticType] = "
								+ mStaticTypeTotStaticType + ", " + "[tStaticType] = " + tStaticType + ", "
					...
					MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_29_6_perform_greenBBBBB(
							mStaticType, tAccess, tStaticType, invocation, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AbstractMethodInvocationToTAccess invocationToTAccess, Type mStaticType, TCall tAccess,
			TypeToTAbstractType mStaticTypeTotStaticType, TAbstractType tStaticType, MMethodInvocation invocation,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPE_TCALL_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MMETHODINVOCATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractMethodInvocationToTAccess) arguments.get(1), (Type) arguments.get(2),
					(TCall) arguments.get(3), (TypeToTAbstractType) arguments.get(4), (TAbstractType) arguments.get(5),
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPE_TCALL_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MMETHODINVOCATION:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_222__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_222((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_231__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TYPE_TCALL_TABSTRACTTYPE_MMETHODINVOCATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Type) arguments.get(0), (TCall) arguments.get(1),
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPE_TCALL_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MMETHODINVOCATION_MODELGENERATORRULERESULT:
					...
					if (tmpMStaticTypeTotStaticType instanceof TypeToTAbstractType) {
						...
						if (tmpTStaticType instanceof TAbstractType) {
							...
							if (tmpInvocation instanceof MMethodInvocation) {
								...
								return new Object[] { invocationToTAccess, mStaticType, tAccess,
										mStaticTypeTotStaticType, tStaticType, invocation, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType, tStaticType,
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationStaticType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodInvocationStaticType_1_1_performtransformation_black = pattern_MethodInvocationStaticType_1_1_performtransformation_blackBBBBBBFBB(
					invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType, tStaticType, invocation, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject invocationToTAccess, EObject mStaticType, EObject tAccess,
			EObject mStaticTypeTotStaticType, EObject tStaticType, EObject invocation) {
															...
															if (!invocation.equals(mStaticTypeTotStaticType)) {
																if (!invocation.equals(tStaticType)) {
																	return new Object[] { ruleresult,
																			...
																			mStaticTypeTotStaticType, tStaticType,
																			invocation };
																}
															}
														}
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_greenBBBBBFF(
			PerformRuleResult ruleresult, EObject mStaticType, EObject tAccess, EObject tStaticType,
			EObject invocation) {
		...
		invocation__mStaticType____mStaticType.setName(invocation__mStaticType____mStaticType_name_prime);
		return new Object[] { ruleresult, mStaticType, tAccess, tStaticType, invocation,
	...
	public static final void pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mStaticType, EObject tAccess, EObject mStaticTypeTotStaticType, EObject tStaticType,
			EObject invocation) {
		_this.registerObjects_FWD(ruleresult, invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType,
				tStaticType, invocation);
		...
		for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tStaticType != null) {
				for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTAccess instanceof TCall) {
						TCall tAccess = (TCall) tmpTAccess;
						_result.add(new Object[] { invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType,
				...
				if (mStaticType.equals(mStaticTypeTotStaticType.getSource())) {
					if (mStaticType.equals(invocation.getMStaticType())) {
						if (invocation.equals(invocationToTAccess.getSource())) {
							_result.add(new Object[] { invocationToTAccess, mStaticType, tAccess,
									mStaticTypeTotStaticType, tStaticType, invocation });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType, tStaticType,
				invocation, isApplicableMatch, mStaticTypeTotStaticType__tStaticType____target,
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractMethodInvocationToTAccess invocationToTAccess, Type mStaticType, TCall tAccess,
			TypeToTAbstractType mStaticTypeTotStaticType, TAbstractType tStaticType, MMethodInvocation invocation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, invocationToTAccess, mStaticType,
				tAccess, mStaticTypeTotStaticType, tStaticType, invocation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, mStaticType, tAccess,
					mStaticTypeTotStaticType, tStaticType, invocation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationStaticType_2_4_solveCSP_binding = pattern_MethodInvocationStaticType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType,
				tStaticType, invocation);
	...
	public static final void pattern_MethodInvocationStaticType_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mStaticType, EObject tAccess, EObject mStaticTypeTotStaticType, EObject tStaticType,
			EObject invocation) {
		_this.registerObjects_BWD(ruleresult, invocationToTAccess, mStaticType, tAccess, mStaticTypeTotStaticType,
				tStaticType, invocation);
	...
	public static final Object[] pattern_MethodInvocationStaticType_12_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractMethodInvocationToTAccess invocationToTAccess, Type mStaticType, TCall tAccess,
			TypeToTAbstractType mStaticTypeTotStaticType, TAbstractType tStaticType, MMethodInvocation invocation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, invocationToTAccess, mStaticType,
				tAccess, mStaticTypeTotStaticType, tStaticType, invocation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, mStaticType, tAccess,
		...
		if (tmpMStaticType instanceof Type) {
			...
			if (tmpTAccess instanceof TCall) {
				...
				if (tmpTStaticType instanceof TAbstractType) {
					...
					if (tmpInvocation instanceof MMethodInvocation) {
						MMethodInvocation invocation = (MMethodInvocation) tmpInvocation;
						return new Object[] { mStaticType, tAccess, tStaticType, invocation, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_blackBBBBBB(
			Type mStaticType, TCall tAccess, TAbstractType tStaticType, MMethodInvocation invocation, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_black = pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_blackBBBBBB(
					mStaticType, tAccess, tStaticType, invocation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_3_solvecsp_bindingFBBBBBBB(
			MethodInvocationStaticType _this, Type mStaticType, TCall tAccess, TAbstractType tStaticType,
			MMethodInvocation invocation, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mStaticType, tAccess, tStaticType, invocation,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mStaticType, tAccess, tStaticType, invocation, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationStaticType_24_3_solvecsp_binding = pattern_MethodInvocationStaticType_24_3_solvecsp_bindingFBBBBBBB(
				_this, mStaticType, tAccess, tStaticType, invocation, sourceMatch, targetMatch);
		if (result_pattern_MethodInvocationStaticType_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MethodInvocationStaticType_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mStaticType, tAccess, tStaticType, invocation, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MethodInvocationStaticType_24_5_matchcorrcontext_blackFBBFBBBB(
			Type mStaticType, TCall tAccess, TAbstractType tStaticType, MMethodInvocation invocation, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mStaticType.equals(mStaticTypeTotStaticType.getSource())) {
					for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (invocation.equals(invocationToTAccess.getSource())) {
							_result.add(new Object[] { invocationToTAccess, mStaticType, tAccess,
									mStaticTypeTotStaticType, tStaticType, invocation, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_6_createcorrespondence_blackBBBBB(
			Type mStaticType, TCall tAccess, TAbstractType tStaticType, MMethodInvocation invocation, CCMatch ccMatch) {
		return new Object[] { mStaticType, tAccess, tStaticType, invocation, ccMatch };
	}
																	...
																	if (pattern_MethodInvocationStaticType_29_2_isapplicablecore_black_nac_3BB(
																		...
																		if (pattern_MethodInvocationStaticType_29_2_isapplicablecore_black_nac_5BB(
																			...
																			_result.add(new Object[] {
																					...
																					tStaticType, ruleEntryContainer,
																					ruleResult });
																		}
																	}
																}
	...
	public static final Object[] pattern_MethodInvocationStaticType_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, invocationToTAccess, mStaticType,
				tAccess, mStaticTypeTotStaticType, tStaticType, invocation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, mStaticType, tAccess,
					mStaticTypeTotStaticType, tStaticType, invocation, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_29_6_perform_greenBBBBB(Type mStaticType,
			TCall tAccess, TAbstractType tStaticType, MMethodInvocation invocation,
			ModelgeneratorRuleResult ruleResult) {
		tAccess.setStaticType(tStaticType);
		invocation.setMStaticType(mStaticType);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { mStaticType, tAccess, tStaticType, invocation, ruleResult };
	}
