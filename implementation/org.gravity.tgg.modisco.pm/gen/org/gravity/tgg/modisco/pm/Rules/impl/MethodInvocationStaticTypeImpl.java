...
public class MethodInvocationStaticTypeImpl extends AbstractRuleImpl implements MethodInvocationStaticType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Type mStaticType = (Type) result1_bindingAndBlack[3];
		TAbstractType tStaticType = (TAbstractType) result1_bindingAndBlack[4];
		...
		Object[] result3_black = MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType, invocation);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[invocationToTAccess] = " + invocationToTAccess + ", " + "[mStaticTypeTotStaticType] = "
					+ mStaticTypeTotStaticType + ", " + "[tAccess] = " + tAccess + ", " + "[mStaticType] = "
					+ mStaticType + ", " + "[tStaticType] = " + tStaticType + ", " + "[invocation] = " + invocation
					+ ".");
		}
		MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_greenBBBBBFF(
				ruleresult, tAccess, mStaticType, tStaticType, invocation);
		...
		MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType,
				invocation);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_2_2_corematch_blackFFFBFBB(mStaticType, invocation, match)) {
			...
			TAbstractType tStaticType = (TAbstractType) result2_black[4];
			// ForEach 
			for (Object[] result3_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_2_3_findcontext_blackBBBBBB(invocationToTAccess,
							mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType, invocation)) {
				...
				Object[] result4_bindingAndBlack = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType,
								tStaticType, invocation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[invocationToTAccess] = "
							+ invocationToTAccess + ", " + "[mStaticTypeTotStaticType] = " + mStaticTypeTotStaticType
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			TCall tAccess, Type mStaticType, TAbstractType tStaticType, MMethodInvocation invocation) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject invocationToTAccess,
			EObject mStaticTypeTotStaticType, EObject tAccess, EObject mStaticType, EObject tStaticType,
			EObject invocation) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_12_2_corematch_blackFFBFBFB(tAccess, tStaticType, match)) {
			AbstractMethodInvocationToTAccess invocationToTAccess = (AbstractMethodInvocationToTAccess) result2_black[0];
			TypeToTAbstractType mStaticTypeTotStaticType = (TypeToTAbstractType) result2_black[1];
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_12_3_findcontext_blackBBBBBB(invocationToTAccess,
							mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType, invocation)) {
				Object[] result3_green = MethodInvocationStaticTypeImpl
				...
				//nothing EMoflonEdge mStaticTypeTotStaticType__mStaticType____source = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mStaticTypeTotStaticType__tStaticType____target = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge tAccess__tStaticType____staticType = (EMoflonEdge) result3_green[10];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_16(EMoflonEdge _edge_mStaticType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tAccess, mStaticType,
						tStaticType, invocation, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tAccess] = " + tAccess + ", " + "[mStaticType] = " + mStaticType + ", " + "[tStaticType] = "
					+ tStaticType + ", " + "[invocation] = " + invocation + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_24_5_matchcorrcontext_blackFFBBBBBB(tAccess, mStaticType,
							tStaticType, invocation, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_24_6_createcorrespondence_blackBBBBB(tAccess, mStaticType,
								tStaticType, invocation, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAccess] = " + tAccess
							+ ", " + "[mStaticType] = " + mStaticType + ", " + "[tStaticType] = " + tStaticType + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TCall tAccess, Type mStaticType, TAbstractType tStaticType,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
			...
			Type mStaticType = (Type) result2_black[6];
			TAbstractType tStaticType = (TAbstractType) result2_black[7];

			Object[] result3_bindingAndBlack = MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType,
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ invocationToTAccess + ", " + "[mStaticTypeTotStaticType] = " + mStaticTypeTotStaticType + ", "
						+ "[tAccess] = " + tAccess + ", " + "[mStaticType] = " + mStaticType + ", " + "[tStaticType] = "
						+ tStaticType + ", " + "[invocation] = " + invocation + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_29_5_checknacs_blackBBBBBB(invocationToTAccess,
								mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType, invocation);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								...
								+ tAccess + ", " + "[mStaticType] = " + mStaticType + ", " + "[tStaticType] = "
								+ tStaticType + ", " + "[invocation] = " + invocation + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
					MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_29_6_perform_greenBBBBB(tAccess,
							mStaticType, tStaticType, invocation, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AbstractMethodInvocationToTAccess invocationToTAccess, TypeToTAbstractType mStaticTypeTotStaticType,
			TCall tAccess, Type mStaticType, TAbstractType tStaticType, MMethodInvocation invocation,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPETOTABSTRACTTYPE_TCALL_TYPE_TABSTRACTTYPE_MMETHODINVOCATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractMethodInvocationToTAccess) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TCall) arguments.get(3), (Type) arguments.get(4), (TAbstractType) arguments.get(5),
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPETOTABSTRACTTYPE_TCALL_TYPE_TABSTRACTTYPE_MMETHODINVOCATION:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_16__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TCALL_TYPE_TABSTRACTTYPE_MMETHODINVOCATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TCall) arguments.get(0), (Type) arguments.get(1),
					(TAbstractType) arguments.get(2), (MMethodInvocation) arguments.get(3), (Match) arguments.get(4),
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___GENERATE_MODEL__RULEENTRYCONTAINER_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPETOTABSTRACTTYPE:
			return generateModel((RuleEntryContainer) arguments.get(0),
					(AbstractMethodInvocationToTAccess) arguments.get(1), (TypeToTAbstractType) arguments.get(2));
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPETOTABSTRACTTYPE_TCALL_TYPE_TABSTRACTTYPE_MMETHODINVOCATION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_bindingFFFFFFB(
		...
		EObject _localVariable_3 = isApplicableMatch.getObject("mStaticType");
		EObject _localVariable_4 = isApplicableMatch.getObject("tStaticType");
		...
		EObject tmpTStaticType = _localVariable_4;
					...
					if (tmpMStaticType instanceof Type) {
						...
						if (tmpTStaticType instanceof TAbstractType) {
							...
							if (tmpInvocation instanceof MMethodInvocation) {
								...
								return new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tAccess,
										mStaticType, tStaticType, invocation, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType,
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationStaticType_1_1_performtransformation_binding != null) {
			...
			Type mStaticType = (Type) result_pattern_MethodInvocationStaticType_1_1_performtransformation_binding[3];
			TAbstractType tStaticType = (TAbstractType) result_pattern_MethodInvocationStaticType_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_MethodInvocationStaticType_1_1_performtransformation_black = pattern_MethodInvocationStaticType_1_1_performtransformation_blackBBBBBBFBB(
					invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType, invocation, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject invocationToTAccess, EObject mStaticTypeTotStaticType,
			EObject tAccess, EObject mStaticType, EObject tStaticType, EObject invocation) {
															...
															if (!invocation.equals(mStaticType)) {
																if (!invocation.equals(tStaticType)) {
																	return new Object[] { ruleresult,
																			...
																			mStaticType, tStaticType, invocation };
																}
															}
														}
													}
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_greenBBBBBFF(
			PerformRuleResult ruleresult, EObject tAccess, EObject mStaticType, EObject tStaticType,
			EObject invocation) {
		...
		invocation__mStaticType____mStaticType.setName(invocation__mStaticType____mStaticType_name_prime);
		return new Object[] { ruleresult, tAccess, mStaticType, tStaticType, invocation,
	...
	public static final void pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mStaticTypeTotStaticType, EObject tAccess, EObject mStaticType, EObject tStaticType,
			EObject invocation) {
		_this.registerObjects_FWD(ruleresult, invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType,
				tStaticType, invocation);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationStaticType_2_2_corematch_blackFFFBFBB(
		...
		for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tStaticType != null) {
				for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTAccess instanceof TCall) {
						TCall tAccess = (TCall) tmpTAccess;
						_result.add(new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType,
								tStaticType, invocation, match });
					}
				...
				if (tStaticType.equals(mStaticTypeTotStaticType.getTarget())) {
					if (invocation.equals(invocationToTAccess.getSource())) {
						if (mStaticType.equals(invocation.getMStaticType())) {
							_result.add(new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tAccess,
									mStaticType, tStaticType, invocation });
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType,
				...
				invocationToTAccess__invocation____source, invocation__mStaticType____mStaticType };
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType, tAccess,
					mStaticType, tStaticType, invocation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationStaticType_2_4_solveCSP_binding = pattern_MethodInvocationStaticType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType,
				tStaticType, invocation);
		if (result_pattern_MethodInvocationStaticType_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodInvocationStaticType_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType,
						tAccess, mStaticType, tStaticType, invocation };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationStaticType_11_1_performtransformation_binding != null) {
			...
			Type mStaticType = (Type) result_pattern_MethodInvocationStaticType_11_1_performtransformation_binding[3];
			TAbstractType tStaticType = (TAbstractType) result_pattern_MethodInvocationStaticType_11_1_performtransformation_binding[4];
	...
	public static final void pattern_MethodInvocationStaticType_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mStaticTypeTotStaticType, EObject tAccess, EObject mStaticType, EObject tStaticType,
			EObject invocation) {
		_this.registerObjects_BWD(ruleresult, invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType,
				tStaticType, invocation);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationStaticType_12_2_corematch_blackFFBFBFB(TCall tAccess,
	...
	public static final Object[] pattern_MethodInvocationStaticType_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType,
				invocation, isApplicableMatch, invocationToTAccess__tAccess____target,
				mStaticTypeTotStaticType__mStaticType____source, mStaticTypeTotStaticType__tStaticType____target,
				tAccess__tStaticType____staticType, invocationToTAccess__invocation____source };
	}
		...
		if (tmpTAccess instanceof TCall) {
			...
			if (tmpMStaticType instanceof Type) {
				...
				if (tmpTStaticType instanceof TAbstractType) {
					...
					if (tmpInvocation instanceof MMethodInvocation) {
						MMethodInvocation invocation = (MMethodInvocation) tmpInvocation;
						return new Object[] { tAccess, mStaticType, tStaticType, invocation, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_blackBBBBBB(TCall tAccess,
			Type mStaticType, TAbstractType tStaticType, MMethodInvocation invocation, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tAccess, mStaticType, tStaticType, invocation, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_black = pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_blackBBBBBB(
					tAccess, mStaticType, tStaticType, invocation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_3_solvecsp_bindingFBBBBBBB(
			MethodInvocationStaticType _this, TCall tAccess, Type mStaticType, TAbstractType tStaticType,
			MMethodInvocation invocation, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tAccess, mStaticType, tStaticType, invocation,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tAccess, mStaticType, tStaticType, invocation, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationStaticType_24_3_solvecsp_binding = pattern_MethodInvocationStaticType_24_3_solvecsp_bindingFBBBBBBB(
				_this, tAccess, mStaticType, tStaticType, invocation, sourceMatch, targetMatch);
		if (result_pattern_MethodInvocationStaticType_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MethodInvocationStaticType_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tAccess, mStaticType, tStaticType, invocation, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MethodInvocationStaticType_24_5_matchcorrcontext_blackFFBBBBBB(
			TCall tAccess, Type mStaticType, TAbstractType tStaticType, MMethodInvocation invocation, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (invocation.equals(invocationToTAccess.getSource())) {
					for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tStaticType.equals(mStaticTypeTotStaticType.getTarget())) {
							_result.add(new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tAccess,
									mStaticType, tStaticType, invocation, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_6_createcorrespondence_blackBBBBB(TCall tAccess,
			Type mStaticType, TAbstractType tStaticType, MMethodInvocation invocation, CCMatch ccMatch) {
		return new Object[] { tAccess, mStaticType, tStaticType, invocation, ccMatch };
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, invocationToTAccess,
				mStaticTypeTotStaticType, tAccess, mStaticType, tStaticType, invocation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType, tAccess,
					mStaticType, tStaticType, invocation, ruleResult };
	...
	public static final Object[] pattern_MethodInvocationStaticType_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationStaticType_29_3_solveCSP_binding = pattern_MethodInvocationStaticType_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType, tAccess, mStaticType,
				tStaticType, invocation, ruleResult);
		if (result_pattern_MethodInvocationStaticType_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_MethodInvocationStaticType_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType,
						tAccess, mStaticType, tStaticType, invocation, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_29_6_perform_greenBBBBB(TCall tAccess,
			Type mStaticType, TAbstractType tStaticType, MMethodInvocation invocation,
			ModelgeneratorRuleResult ruleResult) {
		tAccess.setStaticType(tStaticType);
		invocation.setMStaticType(mStaticType);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { tAccess, mStaticType, tStaticType, invocation, ruleResult };
	}
