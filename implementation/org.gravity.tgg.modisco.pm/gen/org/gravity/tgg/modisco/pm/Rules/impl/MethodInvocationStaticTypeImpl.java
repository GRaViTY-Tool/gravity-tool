...
public class MethodInvocationStaticTypeImpl extends AbstractRuleImpl implements MethodInvocationStaticType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						mStaticTypeTotStaticType, tStaticType, mStaticType, invocation, invocationToTAccess, tAccess);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mStaticTypeTotStaticType] = " + mStaticTypeTotStaticType + ", " + "[tStaticType] = "
					+ tStaticType + ", " + "[mStaticType] = " + mStaticType + ", " + "[invocation] = " + invocation
		...
		MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_greenBBBBBFF(
				ruleresult, tStaticType, mStaticType, invocation, tAccess);
		...
		MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, mStaticTypeTotStaticType, tStaticType, mStaticType, invocation, invocationToTAccess,
				tAccess);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_2_2_corematch_blackFFBBFFB(mStaticType, invocation, match)) {
			...
			for (Object[] result3_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_2_3_findcontext_blackBBBBBB(mStaticTypeTotStaticType,
							tStaticType, mStaticType, invocation, invocationToTAccess, tAccess)) {
				...
				Object[] result4_bindingAndBlack = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, mStaticTypeTotStaticType, tStaticType, mStaticType, invocation,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			MMethodInvocation invocation, AbstractMethodInvocationToTAccess invocationToTAccess, TCall tAccess) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mStaticTypeTotStaticType, EObject tStaticType,
			EObject mStaticType, EObject invocation, EObject invocationToTAccess, EObject tAccess) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_18(EMoflonEdge _edge_staticType) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_19(EMoflonEdge _edge_mStaticType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tStaticType,
						mStaticType, invocation, tAccess, sourceMatch, targetMatch);
		...
		if (MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_24_5_matchcorrcontext_blackFBBBFBBB(tStaticType, mStaticType,
				...
				Object[] result6_black = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_24_6_createcorrespondence_blackBBBBB(tStaticType,
								mStaticType, invocation, tAccess, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tStaticType] = "
							+ tStaticType + ", " + "[mStaticType] = " + mStaticType + ", " + "[invocation] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAbstractType tStaticType, Type mStaticType, MMethodInvocation invocation,
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
			...
			Object[] result3_bindingAndBlack = MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mStaticTypeTotStaticType, tStaticType, mStaticType, invocation, invocationToTAccess,
							tAccess, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mStaticTypeTotStaticType] = "
						+ mStaticTypeTotStaticType + ", " + "[tStaticType] = " + tStaticType + ", " + "[mStaticType] = "
						+ mStaticType + ", " + "[invocation] = " + invocation + ", " + "[invocationToTAccess] = "
						+ invocationToTAccess + ", " + "[tAccess] = " + tAccess + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodInvocationStaticTypeImpl
							.pattern_MethodInvocationStaticType_29_6_perform_blackBBBBBBB(mStaticTypeTotStaticType,
									tStaticType, mStaticType, invocation, invocationToTAccess, tAccess, ruleResult);
					if (result6_black == null) {
					...
					MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_29_6_perform_greenBBBBB(
							tStaticType, mStaticType, invocation, tAccess, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TYPE_MMETHODINVOCATION_ABSTRACTMETHODINVOCATIONTOTACCESS_TCALL:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (TAbstractType) arguments.get(2), (Type) arguments.get(3),
					(MMethodInvocation) arguments.get(4), (AbstractMethodInvocationToTAccess) arguments.get(5),
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TYPE_MMETHODINVOCATION_ABSTRACTMETHODINVOCATIONTOTACCESS_TCALL:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_18__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_18((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_19__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TABSTRACTTYPE_TYPE_MMETHODINVOCATION_TCALL_MATCH_MATCH:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TYPE_MMETHODINVOCATION_ABSTRACTMETHODINVOCATIONTOTACCESS_TCALL_MODELGENERATORRULERESULT:
					...
					if (tmpInvocation instanceof MMethodInvocation) {
						...
						if (tmpInvocationToTAccess instanceof AbstractMethodInvocationToTAccess) {
							...
							if (tmpTAccess instanceof TCall) {
								...
								return new Object[] { mStaticTypeTotStaticType, tStaticType, mStaticType, invocation,
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationStaticType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodInvocationStaticType_1_1_performtransformation_black = pattern_MethodInvocationStaticType_1_1_performtransformation_blackBBBBBBFBB(
					mStaticTypeTotStaticType, tStaticType, mStaticType, invocation, invocationToTAccess, tAccess, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mStaticTypeTotStaticType, EObject tStaticType, EObject mStaticType,
			EObject invocation, EObject invocationToTAccess, EObject tAccess) {
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_greenBBBBBFF(
			PerformRuleResult ruleresult, EObject tStaticType, EObject mStaticType, EObject invocation,
			EObject tAccess) {
		EMoflonEdge invocation__mStaticType____mStaticType = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, tStaticType, mStaticType, invocation, tAccess,
	...
	public static final void pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tStaticType, EObject mStaticType, EObject invocation, EObject invocationToTAccess,
			EObject tAccess) {
		_this.registerObjects_FWD(ruleresult, mStaticTypeTotStaticType, tStaticType, mStaticType, invocation,
				invocationToTAccess, tAccess);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationStaticType_2_2_corematch_blackFFBBFFB(
		...
		for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tStaticType != null) {
				for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTAccess instanceof TCall) {
						TCall tAccess = (TCall) tmpTAccess;
						_result.add(new Object[] { mStaticTypeTotStaticType, tStaticType, mStaticType, invocation,
								invocationToTAccess, tAccess, match });
					}
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { mStaticTypeTotStaticType, tStaticType, mStaticType, invocation, invocationToTAccess,
				tAccess, isApplicableMatch, mStaticTypeTotStaticType__tStaticType____target,
				mStaticTypeTotStaticType__mStaticType____source, invocation__mStaticType____mStaticType,
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mStaticTypeTotStaticType, tStaticType,
				mStaticType, invocation, invocationToTAccess, tAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mStaticTypeTotStaticType, tStaticType, mStaticType,
					invocation, invocationToTAccess, tAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationStaticType_2_4_solveCSP_binding = pattern_MethodInvocationStaticType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mStaticTypeTotStaticType, tStaticType, mStaticType, invocation,
				invocationToTAccess, tAccess);
	...
	public static final void pattern_MethodInvocationStaticType_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tStaticType, EObject mStaticType, EObject invocation, EObject invocationToTAccess,
			EObject tAccess) {
		_this.registerObjects_BWD(ruleresult, mStaticTypeTotStaticType, tStaticType, mStaticType, invocation,
				invocationToTAccess, tAccess);
		...
		if (tmpTStaticType instanceof TAbstractType) {
			...
			if (tmpMStaticType instanceof Type) {
				...
				if (tmpInvocation instanceof MMethodInvocation) {
					...
					if (tmpTAccess instanceof TCall) {
						TCall tAccess = (TCall) tmpTAccess;
						return new Object[] { tStaticType, mStaticType, invocation, tAccess, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_blackBBBBBB(
			TAbstractType tStaticType, Type mStaticType, MMethodInvocation invocation, TCall tAccess, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tStaticType, mStaticType, invocation, tAccess, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_black = pattern_MethodInvocationStaticType_24_2_matchsrctrgcontext_blackBBBBBB(
					tStaticType, mStaticType, invocation, tAccess, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_3_solvecsp_bindingFBBBBBBB(
			MethodInvocationStaticType _this, TAbstractType tStaticType, Type mStaticType, MMethodInvocation invocation,
			TCall tAccess, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tStaticType, mStaticType, invocation, tAccess,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tStaticType, mStaticType, invocation, tAccess, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationStaticType_24_3_solvecsp_binding = pattern_MethodInvocationStaticType_24_3_solvecsp_bindingFBBBBBBB(
				_this, tStaticType, mStaticType, invocation, tAccess, sourceMatch, targetMatch);
		if (result_pattern_MethodInvocationStaticType_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MethodInvocationStaticType_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tStaticType, mStaticType, invocation, tAccess, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MethodInvocationStaticType_24_5_matchcorrcontext_blackFBBBFBBB(
			TAbstractType tStaticType, Type mStaticType, MMethodInvocation invocation, TCall tAccess, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mStaticType.equals(mStaticTypeTotStaticType.getSource())) {
					for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tAccess.equals(invocationToTAccess.getTarget())) {
							_result.add(new Object[] { mStaticTypeTotStaticType, tStaticType, mStaticType, invocation,
									invocationToTAccess, tAccess, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationStaticType_24_6_createcorrespondence_blackBBBBB(
			TAbstractType tStaticType, Type mStaticType, MMethodInvocation invocation, TCall tAccess, CCMatch ccMatch) {
		return new Object[] { tStaticType, mStaticType, invocation, tAccess, ccMatch };
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mStaticTypeTotStaticType, tStaticType, mStaticType,
					invocation, invocationToTAccess, tAccess, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_29_6_perform_greenBBBBB(TAbstractType tStaticType,
			Type mStaticType, MMethodInvocation invocation, TCall tAccess, ModelgeneratorRuleResult ruleResult) {
		invocation.setMStaticType(mStaticType);
		tAccess.setStaticType(tStaticType);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { tStaticType, mStaticType, invocation, tAccess, ruleResult };
	}
