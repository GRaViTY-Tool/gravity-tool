...
public class MethodInvocationStaticTypeImpl extends AbstractRuleImpl implements MethodInvocationStaticType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess, tStaticType, mStaticType);
		...
		MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess, tStaticType,
				mStaticType);
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
			...
			for (Object[] result3_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_2_3_findcontext_blackBBBBBB(invocationToTAccess, invocation,
							mStaticTypeTotStaticType, tAccess, tStaticType, mStaticType)) {
				Object[] result3_green = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_2_3_findcontext_greenBBBBBBFFFFFF(invocationToTAccess,
								invocation, mStaticTypeTotStaticType, tAccess, tStaticType, mStaticType);
				...
				Object[] result4_bindingAndBlack = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			TypeToTAbstractType mStaticTypeTotStaticType, TCall tAccess, TAbstractType tStaticType, Type mStaticType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject invocationToTAccess, EObject invocation,
			EObject mStaticTypeTotStaticType, EObject tAccess, EObject tStaticType, EObject mStaticType) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_12_2_corematch_blackFFFBBFB(tAccess, tStaticType, match)) {
			AbstractMethodInvocationToTAccess invocationToTAccess = (AbstractMethodInvocationToTAccess) result2_black[0];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_40(EMoflonEdge _edge_staticType) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_41(EMoflonEdge _edge_mStaticType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_24_5_matchcorrcontext_blackFBFBBBBB(invocation, tAccess,
							tStaticType, mStaticType, sourceMatch, targetMatch)) {
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AbstractMethodInvocationToTAccess invocationToTAccess, MMethodInvocation invocation,
			TypeToTAbstractType mStaticTypeTotStaticType, TCall tAccess, TAbstractType tStaticType, Type mStaticType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_MMETHODINVOCATION_TYPETOTABSTRACTTYPE_TCALL_TABSTRACTTYPE_TYPE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractMethodInvocationToTAccess) arguments.get(1), (MMethodInvocation) arguments.get(2),
					(TypeToTAbstractType) arguments.get(3), (TCall) arguments.get(4), (TAbstractType) arguments.get(5),
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_MMETHODINVOCATION_TYPETOTABSTRACTTYPE_TCALL_TABSTRACTTYPE_TYPE:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_40__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_40((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_41__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_MMETHODINVOCATION_TYPETOTABSTRACTTYPE_TCALL_TABSTRACTTYPE_TYPE_MODELGENERATORRULERESULT:
					...
					if (tmpTAccess instanceof TCall) {
						...
						if (tmpTStaticType instanceof TAbstractType) {
							...
							if (tmpMStaticType instanceof Type) {
								...
								return new Object[] { invocationToTAccess, invocation, mStaticTypeTotStaticType,
										tAccess, tStaticType, mStaticType, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess, tStaticType,
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationStaticType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodInvocationStaticType_1_1_performtransformation_black = pattern_MethodInvocationStaticType_1_1_performtransformation_blackBBBBBBFBB(
					invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess, tStaticType, mStaticType, _this,
					isApplicableMatch);
	...
	public static final void pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mStaticType) {
		_this.registerObjects_FWD(ruleresult, invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess,
				tStaticType, mStaticType);
		...
		for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTAccess instanceof TCall) {
				...
				for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tStaticType != null) {
						_result.add(new Object[] { invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess,
				...
				if (mStaticType.equals(invocation.getMStaticType())) {
					if (tStaticType.equals(mStaticTypeTotStaticType.getTarget())) {
						if (mStaticType.equals(mStaticTypeTotStaticType.getSource())) {
							_result.add(new Object[] { invocationToTAccess, invocation, mStaticTypeTotStaticType,
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess, tStaticType,
				mStaticType, isApplicableMatch, invocationToTAccess__tAccess____target,
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationStaticType_2_4_solveCSP_binding = pattern_MethodInvocationStaticType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess,
				tStaticType, mStaticType);
	...
	public static final void pattern_MethodInvocationStaticType_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject invocation, EObject mStaticTypeTotStaticType, EObject tAccess, EObject tStaticType,
			EObject mStaticType) {
		_this.registerObjects_BWD(ruleresult, invocationToTAccess, invocation, mStaticTypeTotStaticType, tAccess,
				tStaticType, mStaticType);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationStaticType_12_2_corematch_blackFFFBBFB(TCall tAccess,
			...
			for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (invocation.equals(invocationToTAccess.getSource())) {
					for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mStaticType.equals(mStaticTypeTotStaticType.getSource())) {
							_result.add(new Object[] { invocationToTAccess, invocation, mStaticTypeTotStaticType,
									tAccess, tStaticType, mStaticType, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationStaticType_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, invocationToTAccess, invocation,
				mStaticTypeTotStaticType, tAccess, tStaticType, mStaticType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, invocation,
					mStaticTypeTotStaticType, tAccess, tStaticType, mStaticType, ruleResult };
