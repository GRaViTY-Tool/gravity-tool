...
public class MethodInvocationStaticTypeImpl extends AbstractRuleImpl implements MethodInvocationStaticType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						invocationToTAccess, mStaticTypeTotStaticType, tStaticType, invocation, mStaticType, tAccess);
		...
		MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, invocationToTAccess, mStaticTypeTotStaticType, tStaticType, invocation, mStaticType,
				tAccess);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_2_2_corematch_blackFFFBBFB(invocation, mStaticType, match)) {
			...
			for (Object[] result3_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_2_3_findcontext_blackBBBBBB(invocationToTAccess,
							mStaticTypeTotStaticType, tStaticType, invocation, mStaticType, tAccess)) {
				...
				Object[] result4_bindingAndBlack = MethodInvocationStaticTypeImpl
						.pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType, tStaticType,
								invocation, mStaticType, tAccess);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			TAbstractType tStaticType, MMethodInvocation invocation, Type mStaticType, TCall tAccess) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject invocationToTAccess,
			EObject mStaticTypeTotStaticType, EObject tStaticType, EObject invocation, EObject mStaticType,
			EObject tAccess) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
				.pattern_MethodInvocationStaticType_12_2_corematch_blackFFBFFBB(tStaticType, tAccess, match)) {
			AbstractMethodInvocationToTAccess invocationToTAccess = (AbstractMethodInvocationToTAccess) result2_black[0];
			TypeToTAbstractType mStaticTypeTotStaticType = (TypeToTAbstractType) result2_black[1];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_15(EMoflonEdge _edge_staticType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodInvocationStaticTypeImpl.pattern_MethodInvocationStaticType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_24_5_matchcorrcontext_blackFFBBBBBB(tStaticType, invocation,
							mStaticType, tAccess, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : MethodInvocationStaticTypeImpl
			...
			Object[] result3_bindingAndBlack = MethodInvocationStaticTypeImpl
					.pattern_MethodInvocationStaticType_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							invocationToTAccess, mStaticTypeTotStaticType, tStaticType, invocation, mStaticType,
							tAccess, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[invocationToTAccess] = "
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								...
								+ tStaticType + ", " + "[invocation] = " + invocation + ", " + "[mStaticType] = "
								+ mStaticType + ", " + "[tAccess] = " + tAccess + ", " + "[ruleResult] = " + ruleResult
								+ ".");
					}
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AbstractMethodInvocationToTAccess invocationToTAccess, TypeToTAbstractType mStaticTypeTotStaticType,
			TAbstractType tStaticType, MMethodInvocation invocation, Type mStaticType, TCall tAccess,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MMETHODINVOCATION_TYPE_TCALL:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractMethodInvocationToTAccess) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TAbstractType) arguments.get(3), (MMethodInvocation) arguments.get(4), (Type) arguments.get(5),
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MMETHODINVOCATION_TYPE_TCALL:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_15__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___GENERATE_MODEL__RULEENTRYCONTAINER_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPETOTABSTRACTTYPE:
			return generateModel((RuleEntryContainer) arguments.get(0),
					(AbstractMethodInvocationToTAccess) arguments.get(1), (TypeToTAbstractType) arguments.get(2));
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MMETHODINVOCATION_TYPE_TCALL_MODELGENERATORRULERESULT:
					...
					if (tmpInvocation instanceof MMethodInvocation) {
						...
						if (tmpMStaticType instanceof Type) {
							...
							if (tmpTAccess instanceof TCall) {
								...
								return new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tStaticType,
										invocation, mStaticType, tAccess, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tStaticType, invocation,
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationStaticType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodInvocationStaticType_1_1_performtransformation_black = pattern_MethodInvocationStaticType_1_1_performtransformation_blackBBBBBBFBB(
					invocationToTAccess, mStaticTypeTotStaticType, tStaticType, invocation, mStaticType, tAccess, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodInvocationStaticType_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject tStaticType, EObject invocation, EObject mStaticType, EObject tAccess) {
	...
	public static final void pattern_MethodInvocationStaticType_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mStaticTypeTotStaticType, EObject tStaticType, EObject invocation, EObject mStaticType,
			EObject tAccess) {
		_this.registerObjects_FWD(ruleresult, invocationToTAccess, mStaticTypeTotStaticType, tStaticType, invocation,
				mStaticType, tAccess);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationStaticType_2_2_corematch_blackFFFBBFB(
		...
		for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTAccess instanceof TCall) {
				...
				for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tStaticType != null) {
						_result.add(new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tStaticType,
								invocation, mStaticType, tAccess, match });
					}
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tStaticType, invocation, mStaticType,
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_4_solveCSP_bindingFBBBBBBBB(
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType,
					tStaticType, invocation, mStaticType, tAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationStaticType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationStaticType_2_4_solveCSP_binding = pattern_MethodInvocationStaticType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType, tStaticType, invocation,
				mStaticType, tAccess);
	...
	public static final void pattern_MethodInvocationStaticType_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mStaticTypeTotStaticType, EObject tStaticType, EObject invocation, EObject mStaticType,
			EObject tAccess) {
		_this.registerObjects_BWD(ruleresult, invocationToTAccess, mStaticTypeTotStaticType, tStaticType, invocation,
				mStaticType, tAccess);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationStaticType_12_2_corematch_blackFFBFFBB(
			...
			for (TypeToTAbstractType mStaticTypeTotStaticType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mStaticType.equals(mStaticTypeTotStaticType.getSource())) {
					for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tAccess.equals(invocationToTAccess.getTarget())) {
							_result.add(new Object[] { invocationToTAccess, mStaticTypeTotStaticType, tStaticType,
									invocation, mStaticType, tAccess, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationStaticType_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, invocationToTAccess,
				mStaticTypeTotStaticType, tStaticType, invocation, mStaticType, tAccess, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, mStaticTypeTotStaticType,
					tStaticType, invocation, mStaticType, tAccess, ruleResult };
