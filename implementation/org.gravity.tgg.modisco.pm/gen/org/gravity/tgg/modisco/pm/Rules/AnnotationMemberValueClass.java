...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Annotation Member Value Class</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see org.gravity.tgg.modisco.pm.Rules.RulesPackage#getAnnotationMemberValueClass()
 * @model
 * @generated
 */
public interface AnnotationMemberValueClass extends EObject, AbstractRule {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_BWD_EMoflonEdge_965(EMoflonEdge _edge_tClass);
	 ...
	 * @generated
	 */
	EObjectContainer isAppropriate_FWD_EMoflonEdge_1060(EMoflonEdge _edge_type);
	...
	CSP isApplicable_solveCsp_CC(Annotation annotation, TypeAccess mAccess, AnnotationMemberValuePair mAnnotationValue,
			TAbstractType tType, TClassNode tValue, BodyDeclaration mOwner, TypeLiteral mValue,
