...
public class MethodSignatureImpl extends AbstractRuleImpl implements MethodSignature {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MethodSignatureImpl
				.pattern_MethodSignature_1_1_performtransformation_greenFFBBFBB(mSignature, tAbstractType, tName, csp);
		...
		Object[] result3_black = MethodSignatureImpl.pattern_MethodSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, mType, mNameToTName, tSignature, mSignatureToTSignature, mSignature, mName, tAbstractType,
				mTypeToTType, mFlowElementToTFlowElement, tName);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[mType] = "
							+ mType + ", " + "[mNameToTName] = " + mNameToTName + ", " + "[tSignature] = " + tSignature
							+ ", " + "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[mSignature] = "
							+ mSignature + ", " + "[mName] = " + mName + ", " + "[tAbstractType] = " + tAbstractType
							+ ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[mFlowElementToTFlowElement] = "
							+ mFlowElementToTFlowElement + ", " + "[tName] = " + tName + ".");
		}
		MethodSignatureImpl.pattern_MethodSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(ruleresult, mType,
				tSignature, mSignatureToTSignature, mSignature, mName, tAbstractType, mFlowElementToTFlowElement,
				tName);
		...
		MethodSignatureImpl.pattern_MethodSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, mType,
				mNameToTName, tSignature, mSignatureToTSignature, mSignature, mName, tAbstractType, mTypeToTType,
				mFlowElementToTFlowElement, tName);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodSignatureImpl.pattern_MethodSignature_2_2_corematch_blackBFBBFFFB(mType,
			...
			for (Object[] result3_black : MethodSignatureImpl.pattern_MethodSignature_2_3_findcontext_blackBBBBBBB(
					mType, mNameToTName, mSignature, mName, tAbstractType, mTypeToTType, tName)) {
				Object[] result3_green = MethodSignatureImpl
						.pattern_MethodSignature_2_3_findcontext_greenBBBBBBBFFFFFFF(mType, mNameToTName, mSignature,
								mName, tAbstractType, mTypeToTType, tName);
				...
				Object[] result4_bindingAndBlack = MethodSignatureImpl
						.pattern_MethodSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mType,
								mNameToTName, mSignature, mName, tAbstractType, mTypeToTType, tName);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Type mType,
			MMethodNameToTMethod mNameToTName, MMethodSignature mSignature, MMethodName mName,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, TMethod tName) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mType, EObject mNameToTName,
			EObject tSignature, EObject mSignatureToTSignature, EObject mSignature, EObject mName,
			EObject tAbstractType, EObject mTypeToTType, EObject mFlowElementToTFlowElement, EObject tName) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodSignatureImpl
				.pattern_MethodSignature_12_2_corematch_blackFFBFBFBB(tSignature, tAbstractType, tName, match)) {
			...
			for (Object[] result3_black : MethodSignatureImpl.pattern_MethodSignature_12_3_findcontext_blackBBBBBBB(
					mType, mNameToTName, tSignature, mName, tAbstractType, mTypeToTType, tName)) {
				Object[] result3_green = MethodSignatureImpl
						.pattern_MethodSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(mType, mNameToTName, tSignature,
								mName, tAbstractType, mTypeToTType, tName);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mNameToTName__mName____source = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mTypeToTType__mType____source = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = MethodSignatureImpl
						.pattern_MethodSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mType,
								mNameToTName, tSignature, mName, tAbstractType, mTypeToTType, tName);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mType] = " + mType + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Type mType,
			MMethodNameToTMethod mNameToTName, TMethodSignature tSignature, MMethodName mName,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, TMethod tName) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mType, EObject mNameToTName,
			EObject tSignature, EObject mSignatureToTSignature, EObject mSignature, EObject mName,
			EObject tAbstractType, EObject mTypeToTType, EObject mFlowElementToTFlowElement, EObject tName) {
		ruleresult.registerObject("mType", mType);
		ruleresult.registerObject("mNameToTName", mNameToTName);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_69(EMoflonEdge _edge_returnType) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_73(EMoflonEdge _edge_returnType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodSignatureImpl
				.pattern_MethodSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mType, tSignature, mSignature,
						mName, tAbstractType, tName, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mType] = " + mType + ", " + "[tSignature] = " + tSignature + ", " + "[mSignature] = "
					+ mSignature + ", " + "[mName] = " + mName + ", " + "[tAbstractType] = " + tAbstractType + ", "
		...
		if (MethodSignatureImpl.pattern_MethodSignature_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodSignatureImpl
					.pattern_MethodSignature_24_5_matchcorrcontext_blackBFBBFBBB(mType, mName, tAbstractType, tName,
				...
				Object[] result6_black = MethodSignatureImpl
						.pattern_MethodSignature_24_6_createcorrespondence_blackBBBBBBB(mType, tSignature, mSignature,
								mName, tAbstractType, tName, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mType] = " + mType + ", "
							+ "[tSignature] = " + tSignature + ", " + "[mSignature] = " + mSignature + ", "
							+ "[mName] = " + mName + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[tName] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Type mType, TMethodSignature tSignature, MMethodSignature mSignature,
			MMethodName mName, TAbstractType tAbstractType, TMethod tName, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : MethodSignatureImpl
			...
			Object[] result3_bindingAndBlack = MethodSignatureImpl
					.pattern_MethodSignature_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mType,
							mNameToTName, mName, tAbstractType, mTypeToTType, tName, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mType] = " + mType + ", "
						+ "[mNameToTName] = " + mNameToTName + ", " + "[mName] = " + mName + ", " + "[tAbstractType] = "
						+ tAbstractType + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tName] = " + tName + ", "
			...
			if (MethodSignatureImpl.pattern_MethodSignature_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = MethodSignatureImpl.pattern_MethodSignature_29_5_checknacs_blackBBBBBB(mType,
						mNameToTName, mName, tAbstractType, mTypeToTType, tName);
				if (result5_black != null) {

					Object[] result6_black = MethodSignatureImpl.pattern_MethodSignature_29_6_perform_blackBBBBBBB(
							mType, mNameToTName, mName, tAbstractType, mTypeToTType, tName, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mType] = " + mType
					...
					MethodSignatureImpl.pattern_MethodSignature_29_6_perform_greenBFFFBBFBBB(mType, mName,
							tAbstractType, tName, ruleResult, csp);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Type mType,
			MMethodNameToTMethod mNameToTName, MMethodName mName, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, TMethod tName, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPE_MMETHODNAMETOTMETHOD_MMETHODSIGNATURE_MMETHODNAME_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TMETHOD:
		...
		case RulesPackage.METHOD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPE_MMETHODNAMETOTMETHOD_TMETHODSIGNATURE_MMETHODNAME_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TMETHOD:
		...
		case RulesPackage.METHOD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_CC__TYPE_TMETHODSIGNATURE_MMETHODSIGNATURE_MMETHODNAME_TABSTRACTTYPE_TMETHOD_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Type) arguments.get(0), (TMethodSignature) arguments.get(1),
					(MMethodSignature) arguments.get(2), (MMethodName) arguments.get(3),
					(TAbstractType) arguments.get(4), (TMethod) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.METHOD_SIGNATURE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPE_MMETHODNAMETOTMETHOD_MMETHODNAME_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TMETHOD_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Type) arguments.get(1),
					(MMethodNameToTMethod) arguments.get(2), (MMethodName) arguments.get(3),
					(TAbstractType) arguments.get(4), (TypeToTAbstractType) arguments.get(5),
					(TMethod) arguments.get(6), (ModelgeneratorRuleResult) arguments.get(7));
						...
						if (tmpTAbstractType instanceof TAbstractType) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								if (tmpTName instanceof TMethod) {
									...
									return new Object[] { mType, mNameToTName, mSignature, mName, tAbstractType,
	...
	public static final Object[] pattern_MethodSignature_1_1_performtransformation_blackBBBBBBBFBB(Type mType,
			MMethodNameToTMethod mNameToTName, MMethodSignature mSignature, MMethodName mName,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, TMethod tName, MethodSignature _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mNameToTName, mSignature, mName, tAbstractType, mTypeToTType, tName, csp,
	...
	public static final Object[] pattern_MethodSignature_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MethodSignature_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodSignature_1_1_performtransformation_black = pattern_MethodSignature_1_1_performtransformation_blackBBBBBBBFBB(
					mType, mNameToTName, mSignature, mName, tAbstractType, mTypeToTType, tName, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodSignature_1_1_performtransformation_greenFFBBFBB(
		...
		return new Object[] { tSignature, mSignatureToTSignature, mSignature, tAbstractType, mFlowElementToTFlowElement,
				tName, csp };
	}
	...
	public static final Object[] pattern_MethodSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mType, EObject mNameToTName, EObject tSignature,
			EObject mSignatureToTSignature, EObject mSignature, EObject mName, EObject tAbstractType,
			EObject mTypeToTType, EObject mFlowElementToTFlowElement, EObject tName) {
	...
	public static final Object[] pattern_MethodSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mType, EObject tSignature, EObject mSignatureToTSignature,
			EObject mSignature, EObject mName, EObject tAbstractType, EObject mFlowElementToTFlowElement,
			EObject tName) {
		...
		return new Object[] { ruleresult, mType, tSignature, mSignatureToTSignature, mSignature, mName, tAbstractType,
				mFlowElementToTFlowElement, tName, mSignatureToTSignature__tSignature____target,
	...
	public static final void pattern_MethodSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(MethodSignature _this,
			...
			EObject mSignatureToTSignature, EObject mSignature, EObject mName, EObject tAbstractType,
			EObject mTypeToTType, EObject mFlowElementToTFlowElement, EObject tName) {
		_this.registerObjects_FWD(ruleresult, mType, mNameToTName, tSignature, mSignatureToTSignature, mSignature,
				mName, tAbstractType, mTypeToTType, mFlowElementToTFlowElement, tName);
	...
	public static final Iterable<Object[]> pattern_MethodSignature_2_2_corematch_blackBFBBFFFB(Type mType,
			...
			if (tName != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAbstractType != null) {
						_result.add(new Object[] { mType, mNameToTName, mSignature, mName, tAbstractType, mTypeToTType,
								tName, match });
					}
	...
	public static final Iterable<Object[]> pattern_MethodSignature_2_3_findcontext_blackBBBBBBB(Type mType,
			MMethodNameToTMethod mNameToTName, MMethodSignature mSignature, MMethodName mName,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, TMethod tName) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
					...
					if (mType.equals(mSignature.getReturnType())) {
						if (mName.getMSignatures().contains(mSignature)) {
							if (tName.equals(mNameToTName.getTarget())) {
								_result.add(new Object[] { mType, mNameToTName, mSignature, mName, tAbstractType,
										mTypeToTType, tName });
							}
						}
					}
	...
	public static final Object[] pattern_MethodSignature_2_3_findcontext_greenBBBBBBBFFFFFFF(Type mType,
		...
		return new Object[] { mType, mNameToTName, mSignature, mName, tAbstractType, mTypeToTType, tName,
				isApplicableMatch, mNameToTName__mName____source, mTypeToTType__mType____source,
				mTypeToTType__tAbstractType____target, mSignature__mType____returnType,
				mName__mSignature____mSignatures, mNameToTName__tName____target };
	}

	public static final Object[] pattern_MethodSignature_2_4_solveCSP_bindingFBBBBBBBBB(MethodSignature _this,
			IsApplicableMatch isApplicableMatch, Type mType, MMethodNameToTMethod mNameToTName,
			MMethodSignature mSignature, MMethodName mName, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, TMethod tName) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mType, mNameToTName, mSignature,
				mName, tAbstractType, mTypeToTType, tName);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mNameToTName, mSignature, mName, tAbstractType,
					mTypeToTType, tName };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(MethodSignature _this,
		...
		Object[] result_pattern_MethodSignature_2_4_solveCSP_binding = pattern_MethodSignature_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, mNameToTName, mSignature, mName, tAbstractType, mTypeToTType, tName);
		if (result_pattern_MethodSignature_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodSignature_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mType, mNameToTName, mSignature, mName,
						tAbstractType, mTypeToTType, tName };
			}
		}
		return null;
	}
					...
					if (tmpMName instanceof MMethodName) {
						...
						if (tmpTAbstractType instanceof TAbstractType) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								if (tmpTName instanceof TMethod) {
									TMethod tName = (TMethod) tmpTName;
									return new Object[] { mType, mNameToTName, tSignature, mName, tAbstractType,
											mTypeToTType, tName, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MethodSignature_11_1_performtransformation_blackBBBBBBBFBB(Type mType,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mNameToTName, tSignature, mName, tAbstractType, mTypeToTType, tName, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodSignature_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MethodSignature_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodSignature_11_1_performtransformation_black = pattern_MethodSignature_11_1_performtransformation_blackBBBBBBBFBB(
					mType, mNameToTName, tSignature, mName, tAbstractType, mTypeToTType, tName, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodSignature_11_1_performtransformation_greenBBFFBF(Type mType,
		...
		mFlowElementToTFlowElement.setSource(mSignature);
		mFlowElementToTFlowElement.setTarget(tSignature);
		return new Object[] { mType, tSignature, mSignatureToTSignature, mSignature, mName,
				mFlowElementToTFlowElement };
	}
	...
	public static final void pattern_MethodSignature_11_5_registerobjects_expressionBBBBBBBBBBBB(MethodSignature _this,
			...
			EObject mSignatureToTSignature, EObject mSignature, EObject mName, EObject tAbstractType,
			EObject mTypeToTType, EObject mFlowElementToTFlowElement, EObject tName) {
		_this.registerObjects_BWD(ruleresult, mType, mNameToTName, tSignature, mSignatureToTSignature, mSignature,
				mName, tAbstractType, mTypeToTType, mFlowElementToTFlowElement, tName);
	...
	public static final Iterable<Object[]> pattern_MethodSignature_12_2_corematch_blackFFBFBFBB(
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mType != null) {
					for (MMethodNameToTMethod mNameToTName : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mName != null) {
							_result.add(new Object[] { mType, mNameToTName, tSignature, mName, tAbstractType,
	...
	public static final Object[] pattern_MethodSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(Type mType,
		...
		tSignature__tName____method.setName(tSignature__tName____method_name_prime);
		mNameToTName__tName____target.setName(mNameToTName__tName____target_name_prime);
		return new Object[] { mType, mNameToTName, tSignature, mName, tAbstractType, mTypeToTType, tName,
				isApplicableMatch, mNameToTName__mName____source, mTypeToTType__mType____source,
	...
	public static final Object[] pattern_MethodSignature_12_4_solveCSP_bindingFBBBBBBBBB(MethodSignature _this,
			IsApplicableMatch isApplicableMatch, Type mType, MMethodNameToTMethod mNameToTName,
			TMethodSignature tSignature, MMethodName mName, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, TMethod tName) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mType, mNameToTName, tSignature,
				mName, tAbstractType, mTypeToTType, tName);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mNameToTName, tSignature, mName, tAbstractType,
					mTypeToTType, tName };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(MethodSignature _this,
		...
		Object[] result_pattern_MethodSignature_12_4_solveCSP_binding = pattern_MethodSignature_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, mNameToTName, tSignature, mName, tAbstractType, mTypeToTType, tName);
		if (result_pattern_MethodSignature_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodSignature_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mType, mNameToTName, tSignature, mName,
						tAbstractType, mTypeToTType, tName };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodSignature_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TMethod __DEC_tSignature_method_281820 = tSignature.getMethod();
		if (__DEC_tSignature_method_281820 != null) {
			if (!tName.equals(__DEC_tSignature_method_281820)) {
				...
				if (tmpMSignature instanceof MMethodSignature) {
					...
					if (tmpMName instanceof MMethodName) {
						...
						if (tmpTAbstractType instanceof TAbstractType) {
							...
							if (tmpTName instanceof TMethod) {
								TMethod tName = (TMethod) tmpTName;
								return new Object[] { mType, tSignature, mSignature, mName, tAbstractType, tName,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_MethodSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(Type mType,
			TMethodSignature tSignature, MMethodSignature mSignature, MMethodName mName, TAbstractType tAbstractType,
			TMethod tName, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			int tSignature_lowerBound = tSignature.getLowerBound();
			if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
				return new Object[] { mType, tSignature, mSignature, mName, tAbstractType, tName, sourceMatch,
						targetMatch };
			}
	...
	public static final Object[] pattern_MethodSignature_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MethodSignature_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodSignature_24_2_matchsrctrgcontext_black = pattern_MethodSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mType, tSignature, mSignature, mName, tAbstractType, tName, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodSignature_24_3_solvecsp_bindingFBBBBBBBBB(MethodSignature _this,
			Type mType, TMethodSignature tSignature, MMethodSignature mSignature, MMethodName mName,
			TAbstractType tAbstractType, TMethod tName, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mType, tSignature, mSignature, mName, tAbstractType,
				tName, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mType, tSignature, mSignature, mName, tAbstractType, tName, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(MethodSignature _this,
		...
		Object[] result_pattern_MethodSignature_24_3_solvecsp_binding = pattern_MethodSignature_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mType, tSignature, mSignature, mName, tAbstractType, tName, sourceMatch, targetMatch);
		if (result_pattern_MethodSignature_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MethodSignature_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mType, tSignature, mSignature, mName, tAbstractType, tName,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MethodSignature_24_5_matchcorrcontext_blackBFBBFBBB(Type mType,
			MMethodName mName, TAbstractType tAbstractType, TMethod tName, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (MMethodNameToTMethod mNameToTName : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mName, MMethodNameToTMethod.class, "source")) {
				if (tName.equals(mNameToTName.getTarget())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mType, TypeToTAbstractType.class, "source")) {
						if (tAbstractType.equals(mTypeToTType.getTarget())) {
							_result.add(new Object[] { mType, mNameToTName, mName, tAbstractType, mTypeToTType, tName,
									sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MethodSignature_24_6_createcorrespondence_blackBBBBBBB(Type mType,
		...
		return new Object[] { mType, tSignature, mSignature, mName, tAbstractType, tName, ccMatch };
	}
	...
	public static final Object[] pattern_MethodSignature_28_1_matchtggpattern_black_nac_0BB(TMethodSignature tSignature,
			TMethod tName) {
		TMethod __DEC_tSignature_method_6527 = tSignature.getMethod();
		if (__DEC_tSignature_method_6527 != null) {
			if (!tName.equals(__DEC_tSignature_method_6527)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_MethodSignature_29_3_solveCSP_bindingFBBBBBBBBB(MethodSignature _this,
			IsApplicableMatch isApplicableMatch, Type mType, MMethodNameToTMethod mNameToTName, MMethodName mName,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, TMethod tName,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mType, mNameToTName, mName,
				tAbstractType, mTypeToTType, tName, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mNameToTName, mName, tAbstractType,
	...
	public static final Object[] pattern_MethodSignature_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(MethodSignature _this,
		...
		Object[] result_pattern_MethodSignature_29_3_solveCSP_binding = pattern_MethodSignature_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, mNameToTName, mName, tAbstractType, mTypeToTType, tName, ruleResult);
	...
	public static final Object[] pattern_MethodSignature_29_5_checknacs_blackBBBBBB(Type mType,
			MMethodNameToTMethod mNameToTName, MMethodName mName, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, TMethod tName) {
		return new Object[] { mType, mNameToTName, mName, tAbstractType, mTypeToTType, tName };
	}

	public static final Object[] pattern_MethodSignature_29_6_perform_blackBBBBBBB(Type mType,
			MMethodNameToTMethod mNameToTName, MMethodName mName, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, TMethod tName, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mType, mNameToTName, mName, tAbstractType, mTypeToTType, tName, ruleResult };
	}

	public static final Object[] pattern_MethodSignature_29_6_perform_greenBFFFBBFBBB(Type mType, MMethodName mName,
			TAbstractType tAbstractType, TMethod tName, ModelgeneratorRuleResult ruleResult, CSP csp) {
		TMethodSignature tSignature = BasicFactory.eINSTANCE.createTMethodSignature();
		MSignatureToTSignature mSignatureToTSignature = PmFactory.eINSTANCE.createMSignatureToTSignature();
		MMethodSignature mSignature = ModiscoFactory.eINSTANCE.createMMethodSignature();
		MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement = PmFactory.eINSTANCE
		...
		return new Object[] { mType, tSignature, mSignatureToTSignature, mSignature, mName, tAbstractType,
				mFlowElementToTFlowElement, tName, ruleResult, csp };
	}
