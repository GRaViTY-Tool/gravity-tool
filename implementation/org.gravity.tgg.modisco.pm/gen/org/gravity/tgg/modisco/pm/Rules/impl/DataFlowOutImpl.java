...
public class DataFlowOutImpl extends AbstractRuleImpl implements DataFlowOut {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = DataFlowOutImpl.pattern_DataFlowOut_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mTarget] = " + mTarget + ", " + "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = "
					+ mFlowToTFlow + ", " + "[mSourceToTSource] = " + mSourceToTSource + ", " + "[mSource] = " + mSource
					+ ", " + "[tSource] = " + tSource + ".");
		}
		...
		DataFlowOutImpl.pattern_DataFlowOut_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mTarget, tFlow,
				mFlowToTFlow, mSourceToTSource, mSource, tSource);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : DataFlowOutImpl.pattern_DataFlowOut_2_2_corematch_blackBFFFBFB(mTarget, mSource,
				match)) {
			...
			for (Object[] result3_black : DataFlowOutImpl.pattern_DataFlowOut_2_3_findcontext_blackBBBBBB(mTarget,
					tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MAbstractFlowElement mTarget,
			...
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, MFlow mSource, TAbstractFlowElement tSource) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mTarget, EObject tFlow, EObject mFlowToTFlow,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mTarget, EObject tFlow, EObject mFlowToTFlow,
			EObject mSourceToTSource, EObject mSource, EObject tSource) {
		ruleresult.registerObject("mTarget", mTarget);
		ruleresult.registerObject("tFlow", tFlow);
		ruleresult.registerObject("mFlowToTFlow", mFlowToTFlow);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_89(EMoflonEdge _edge_outgoingFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_92(EMoflonEdge _edge_incomingFlows) {
		...
		for (Object[] result2_black : DataFlowOutImpl
			...
			Object[] result3_bindingAndBlack = DataFlowOutImpl
					.pattern_DataFlowOut_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mTarget,
							tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTarget] = " + mTarget + ", "
						+ "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", "
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mTarget] = "
								+ mTarget + ", " + "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow
								+ ", " + "[mSourceToTSource] = " + mSourceToTSource + ", " + "[mSource] = " + mSource
								+ ", " + "[tSource] = " + tSource + ", " + "[ruleResult] = " + ruleResult + ".");
					}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_89__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_89((EMoflonEdge) arguments.get(0));
		case RulesPackage.DATA_FLOW_OUT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_92__EMOFLONEDGE:
		...
		case RulesPackage.DATA_FLOW_OUT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpMSourceToTSource instanceof MAbstractFlowElementToTAbstractFlowElement) {
						...
						if (tmpMSource instanceof MFlow) {
							...
							if (tmpTSource instanceof TAbstractFlowElement) {
								...
								return new Object[] { mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource,
										isApplicableMatch };
							}
						}
					}
				...
				if (!mSource.equals(mTarget)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource, csp,
	...
	public static final Object[] pattern_DataFlowOut_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_DataFlowOut_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_DataFlowOut_1_1_performtransformation_black = pattern_DataFlowOut_1_1_performtransformation_blackBBBBBBFBB(
					mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource, _this, isApplicableMatch);
			if (result_pattern_DataFlowOut_1_1_performtransformation_black != null) {
				...
				return new Object[] { mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowOut_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject mTarget, EObject tFlow, EObject mFlowToTFlow, EObject mSourceToTSource, EObject mSource,
			EObject tSource) {
															...
															if (!mSource.equals(mSourceToTSource)) {
																if (!mSource.equals(tSource)) {
																	return new Object[] { ruleresult, mTarget, tFlow,
																			mFlowToTFlow, mSourceToTSource, mSource,
																			tSource };
																}
															}
														}
	...
	public static final void pattern_DataFlowOut_1_5_registerobjects_expressionBBBBBBBB(DataFlowOut _this,
			PerformRuleResult ruleresult, EObject mTarget, EObject tFlow, EObject mFlowToTFlow,
			EObject mSourceToTSource, EObject mSource, EObject tSource) {
		_this.registerObjects_FWD(ruleresult, mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource);
	...
	public static final Iterable<Object[]> pattern_DataFlowOut_2_2_corematch_blackBFFFBFB(MAbstractFlowElement mTarget,
				...
				if (tFlow != null) {
					for (MAbstractFlowElementToTAbstractFlowElement mSourceToTSource : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mFlowToTFlow.equals(mSourceToTSource)) {
							...
							if (tSource != null) {
								if (!tFlow.equals(tSource)) {
									_result.add(new Object[] { mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource,
											tSource, match });
								}
							}
							...
							if (tFlow.equals(mFlowToTFlow.getTarget())) {
								if (mSource.equals(mSourceToTSource.getSource())) {
									if (tSource.equals(mSourceToTSource.getTarget())) {
										_result.add(new Object[] { mTarget, tFlow, mFlowToTFlow, mSourceToTSource,
												mSource, tSource });
									}
								}
							}
	...
	public static final Object[] pattern_DataFlowOut_2_3_findcontext_greenBBBBBBFFFFFFF(MAbstractFlowElement mTarget,
		...
		return new Object[] { mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource, isApplicableMatch,
	...
	public static final Object[] pattern_DataFlowOut_2_4_solveCSP_bindingFBBBBBBBB(DataFlowOut _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, MFlow mSource, TAbstractFlowElement tSource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mTarget, tFlow, mFlowToTFlow,
				mSourceToTSource, mSource, tSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTarget, tFlow, mFlowToTFlow, mSourceToTSource,
					mSource, tSource };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowOut_2_4_solveCSP_bindingAndBlackFBBBBBBBB(DataFlowOut _this,
		...
		Object[] result_pattern_DataFlowOut_2_4_solveCSP_binding = pattern_DataFlowOut_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource);
	...
	public static final void pattern_DataFlowOut_11_5_registerobjects_expressionBBBBBBBB(DataFlowOut _this,
			PerformRuleResult ruleresult, EObject mTarget, EObject tFlow, EObject mFlowToTFlow,
			EObject mSourceToTSource, EObject mSource, EObject tSource) {
		_this.registerObjects_BWD(ruleresult, mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource);
	...
	public static final Object[] pattern_DataFlowOut_12_3_findcontext_greenBBBBBBFFFFFFF(MAbstractFlowElement mTarget,
		...
		return new Object[] { mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource, isApplicableMatch,
				...
				tSource__tFlow____incomingFlows, mSourceToTSource__mSource____source,
				mSourceToTSource__tSource____target };
	}
	...
	public static final Object[] pattern_DataFlowOut_12_4_solveCSP_bindingFBBBBBBBB(DataFlowOut _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, MFlow mSource, TAbstractFlowElement tSource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mTarget, tFlow, mFlowToTFlow,
				mSourceToTSource, mSource, tSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTarget, tFlow, mFlowToTFlow, mSourceToTSource,
	...
	public static final Object[] pattern_DataFlowOut_29_3_solveCSP_bindingFBBBBBBBBB(DataFlowOut _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mTarget, tFlow, mFlowToTFlow,
	...
	public static final Object[] pattern_DataFlowOut_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(DataFlowOut _this,
		...
		Object[] result_pattern_DataFlowOut_29_3_solveCSP_binding = pattern_DataFlowOut_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTarget, tFlow, mFlowToTFlow, mSourceToTSource, mSource, tSource, ruleResult);
