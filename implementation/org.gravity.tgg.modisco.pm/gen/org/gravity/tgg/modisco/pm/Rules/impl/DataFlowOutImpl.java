...
public class DataFlowOutImpl extends AbstractRuleImpl implements DataFlowOut {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = DataFlowOutImpl.pattern_DataFlowOut_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource);
		...
		DataFlowOutImpl.pattern_DataFlowOut_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, mTarget, tFlow, tSource,
				mSource);
		...
		// 
		// 
		DataFlowOutImpl.pattern_DataFlowOut_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mTarget, tFlow,
				tSource, mSource, mFlowToTFlow, mSourceToTSource);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : DataFlowOutImpl.pattern_DataFlowOut_2_2_corematch_blackBFFBFFB(mTarget, mSource,
			...
			for (Object[] result3_black : DataFlowOutImpl.pattern_DataFlowOut_2_3_findcontext_blackBBBBBB(mTarget,
					tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource)) {
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mTarget, EObject tFlow, EObject tSource,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		DataFlowOutImpl.pattern_DataFlowOut_11_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, mTarget, tFlow, tSource,
				mSource);
		//nothing EMoflonEdge mTarget__mSource____incomingFlows = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge mSource__mTarget____flowTarget = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge tFlow__tSource____outgoingFlows = (EMoflonEdge) result3_green[7];
		...
		// 
		// 
		DataFlowOutImpl.pattern_DataFlowOut_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mTarget, tFlow,
				tSource, mSource, mFlowToTFlow, mSourceToTSource);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : DataFlowOutImpl.pattern_DataFlowOut_12_2_corematch_blackFBBFFFB(tFlow, tSource,
				match)) {
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mTarget, EObject tFlow, EObject tSource,
			EObject mSource, EObject mFlowToTFlow, EObject mSourceToTSource) {
		ruleresult.registerObject("mTarget", mTarget);
		ruleresult.registerObject("tFlow", tFlow);
		ruleresult.registerObject("tSource", tSource);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_64(EMoflonEdge _edge_outgoingFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_67(EMoflonEdge _edge_incomingFlows) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = DataFlowOutImpl.pattern_DataFlowOut_24_3_solvecsp_bindingAndBlackFBBBBBBB(
				this, mTarget, tFlow, tSource, mSource, sourceMatch, targetMatch);
		...
		if (DataFlowOutImpl.pattern_DataFlowOut_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : DataFlowOutImpl.pattern_DataFlowOut_24_5_matchcorrcontext_blackBBBBFFBB(
				...
				Object[] result6_black = DataFlowOutImpl.pattern_DataFlowOut_24_6_createcorrespondence_blackBBBBB(
						mTarget, tFlow, tSource, mSource, ccMatch);
				if (result6_black == null) {
		...
		for (Object[] result2_black : DataFlowOutImpl
			...
			Object[] result3_bindingAndBlack = DataFlowOutImpl
					.pattern_DataFlowOut_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mTarget,
							tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTarget] = " + mTarget + ", "
						+ "[tFlow] = " + tFlow + ", " + "[tSource] = " + tSource + ", " + "[mSource] = " + mSource
			...
			if (DataFlowOutImpl.pattern_DataFlowOut_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = DataFlowOutImpl.pattern_DataFlowOut_29_5_checknacs_blackBBBBBB(mTarget, tFlow,
						tSource, mSource, mFlowToTFlow, mSourceToTSource);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mTarget] = "
								+ mTarget + ", " + "[tFlow] = " + tFlow + ", " + "[tSource] = " + tSource + ", "
								+ "[mSource] = " + mSource + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", "
								+ "[mSourceToTSource] = " + mSourceToTSource + ", " + "[ruleResult] = " + ruleResult
								+ ".");
					}
					DataFlowOutImpl.pattern_DataFlowOut_29_6_perform_greenBBBBB(mTarget, tFlow, tSource, mSource,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_64__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_64((EMoflonEdge) arguments.get(0));
		case RulesPackage.DATA_FLOW_OUT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_67__EMOFLONEDGE:
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPLICABLE_SOLVE_CSP_CC__MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_MATCH_MATCH:
		...
		case RulesPackage.DATA_FLOW_OUT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpMSource instanceof MFlow) {
						...
						if (tmpMFlowToTFlow instanceof MAbstractFlowElementToTAbstractFlowElement) {
							...
							if (tmpMSourceToTSource instanceof MAbstractFlowElementToTAbstractFlowElement) {
								...
								return new Object[] { mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource,
										isApplicableMatch };
							}
						}
					}
				...
				if (!mFlowToTFlow.equals(mSourceToTSource)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource, csp,
	...
	public static final Object[] pattern_DataFlowOut_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_DataFlowOut_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_DataFlowOut_1_1_performtransformation_black = pattern_DataFlowOut_1_1_performtransformation_blackBBBBBBFBB(
					mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource, _this, isApplicableMatch);
			if (result_pattern_DataFlowOut_1_1_performtransformation_black != null) {
				...
				return new Object[] { mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowOut_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject mTarget, EObject tFlow, EObject tSource, EObject mSource, EObject mFlowToTFlow,
	...
	public static final Object[] pattern_DataFlowOut_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		return new Object[] { ruleresult, mTarget, tFlow, tSource, mSource, mTarget__mSource____incomingFlows,
	...
	public static final void pattern_DataFlowOut_1_5_registerobjects_expressionBBBBBBBB(DataFlowOut _this,
		...
		_this.registerObjects_FWD(ruleresult, mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource);
				...
				if (tFlow != null) {
					for (MAbstractFlowElementToTAbstractFlowElement mSourceToTSource : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mFlowToTFlow.equals(mSourceToTSource)) {
							...
							if (tSource != null) {
								if (!tFlow.equals(tSource)) {
									_result.add(new Object[] { mTarget, tFlow, tSource, mSource, mFlowToTFlow,
	...
	public static final Object[] pattern_DataFlowOut_2_3_findcontext_greenBBBBBBFFFFFFF(MAbstractFlowElement mTarget,
		...
		return new Object[] { mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource, isApplicableMatch,
	...
	public static final Object[] pattern_DataFlowOut_2_4_solveCSP_bindingFBBBBBBBB(DataFlowOut _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mTarget, tFlow, tSource, mSource,
				mFlowToTFlow, mSourceToTSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTarget, tFlow, tSource, mSource, mFlowToTFlow,
					mSourceToTSource };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowOut_2_4_solveCSP_bindingAndBlackFBBBBBBBB(DataFlowOut _this,
		...
		Object[] result_pattern_DataFlowOut_2_4_solveCSP_binding = pattern_DataFlowOut_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource);
	...
	public static final void pattern_DataFlowOut_11_5_registerobjects_expressionBBBBBBBB(DataFlowOut _this,
			PerformRuleResult ruleresult, EObject mTarget, EObject tFlow, EObject tSource, EObject mSource,
			EObject mFlowToTFlow, EObject mSourceToTSource) {
		_this.registerObjects_BWD(ruleresult, mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource);
	...
	public static final Iterable<Object[]> pattern_DataFlowOut_12_2_corematch_blackFBBFFFB(TAbstractFlowElement tFlow,
	...
	public static final Object[] pattern_DataFlowOut_12_4_solveCSP_bindingFBBBBBBBB(DataFlowOut _this,
			...
			TAbstractFlowElement tSource, MFlow mSource, MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mTarget, tFlow, tSource, mSource,
				mFlowToTFlow, mSourceToTSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTarget, tFlow, tSource, mSource, mFlowToTFlow,
	...
	public static final Object[] pattern_DataFlowOut_29_3_solveCSP_bindingFBBBBBBBBB(DataFlowOut _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mTarget, tFlow, tSource, mSource,
	...
	public static final Object[] pattern_DataFlowOut_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(DataFlowOut _this,
		...
		Object[] result_pattern_DataFlowOut_29_3_solveCSP_binding = pattern_DataFlowOut_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTarget, tFlow, tSource, mSource, mFlowToTFlow, mSourceToTSource, ruleResult);
