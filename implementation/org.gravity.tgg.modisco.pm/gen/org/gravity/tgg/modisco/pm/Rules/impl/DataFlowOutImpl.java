...
public class DataFlowOutImpl extends AbstractRuleImpl implements DataFlowOut {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = DataFlowOutImpl.pattern_DataFlowOut_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mSourceToTSource] = " + mSourceToTSource + ", " + "[tSource] = " + tSource + ", "
					+ "[mSource] = " + mSource + ", " + "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow
					+ ", " + "[mTarget] = " + mTarget + ".");
		}
		...
		DataFlowOutImpl.pattern_DataFlowOut_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mSourceToTSource,
				tSource, mSource, tFlow, mFlowToTFlow, mTarget);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : DataFlowOutImpl.pattern_DataFlowOut_2_2_corematch_blackFFBFFBB(mSource, mTarget,
				match)) {
			...
			for (Object[] result3_black : DataFlowOutImpl.pattern_DataFlowOut_2_3_findcontext_blackBBBBBB(
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mSourceToTSource + ", " + "[tSource] = " + tSource + ", " + "[mSource] = " + mSource
							+ ", " + "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", "
							+ "[mTarget] = " + mTarget + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tSource, MFlow mSource,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mSourceToTSource, EObject tSource,
			EObject mSource, EObject tFlow, EObject mFlowToTFlow, EObject mTarget) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : DataFlowOutImpl.pattern_DataFlowOut_12_2_corematch_blackFBFBFFB(tSource, tFlow,
				match)) {
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource = (MAbstractFlowElementToTAbstractFlowElement) result2_black[0];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_146(EMoflonEdge _edge_outgoingFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_150(EMoflonEdge _edge_incomingFlows) {
		...
		for (Object[] result2_black : DataFlowOutImpl
			...
			Object[] result3_bindingAndBlack = DataFlowOutImpl
					.pattern_DataFlowOut_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSourceToTSource] = "
						+ mSourceToTSource + ", " + "[tSource] = " + tSource + ", " + "[mSource] = " + mSource + ", "
						+ "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mTarget] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_146__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_146((EMoflonEdge) arguments.get(0));
		case RulesPackage.DATA_FLOW_OUT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_150__EMOFLONEDGE:
		...
		case RulesPackage.DATA_FLOW_OUT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpTFlow instanceof TAbstractFlowElement) {
						...
						if (tmpMFlowToTFlow instanceof MAbstractFlowElementToTAbstractFlowElement) {
							...
							if (tmpMTarget instanceof MAbstractFlowElement) {
								...
								return new Object[] { mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget,
										isApplicableMatch };
							}
						}
					}
				...
				if (!mFlowToTFlow.equals(mSourceToTSource)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget, csp,
	...
	public static final Object[] pattern_DataFlowOut_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_DataFlowOut_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_DataFlowOut_1_1_performtransformation_black = pattern_DataFlowOut_1_1_performtransformation_blackBBBBBBFBB(
					mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget, _this, isApplicableMatch);
			if (result_pattern_DataFlowOut_1_1_performtransformation_black != null) {
				...
				return new Object[] { mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowOut_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject mSourceToTSource, EObject tSource, EObject mSource, EObject tFlow, EObject mFlowToTFlow,
			EObject mTarget) {
															...
															if (!mTarget.equals(tSource)) {
																if (!mTarget.equals(tFlow)) {
																	return new Object[] { ruleresult, mSourceToTSource,
																			tSource, mSource, tFlow, mFlowToTFlow,
																			mTarget };
																}
															}
														}
	...
	public static final void pattern_DataFlowOut_1_5_registerobjects_expressionBBBBBBBB(DataFlowOut _this,
			PerformRuleResult ruleresult, EObject mSourceToTSource, EObject tSource, EObject mSource, EObject tFlow,
			EObject mFlowToTFlow, EObject mTarget) {
		_this.registerObjects_FWD(ruleresult, mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget);
	...
	public static final Iterable<Object[]> pattern_DataFlowOut_2_2_corematch_blackFFBFFBB(MFlow mSource,
				...
				if (tSource != null) {
					for (MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mFlowToTFlow.equals(mSourceToTSource)) {
							...
							if (tFlow != null) {
								if (!tFlow.equals(tSource)) {
									_result.add(new Object[] { mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow,
											mTarget, match });
								}
							}
							...
							if (mTarget.equals(mFlowToTFlow.getSource())) {
								if (mTarget.getIncomingFlows().contains(mSource)) {
									if (tSource.equals(mSourceToTSource.getTarget())) {
										_result.add(new Object[] { mSourceToTSource, tSource, mSource, tFlow,
	...
	public static final Object[] pattern_DataFlowOut_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget, isApplicableMatch,
	...
	public static final Object[] pattern_DataFlowOut_2_4_solveCSP_bindingFBBBBBBBB(DataFlowOut _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mSourceToTSource, tSource, mSource,
				tFlow, mFlowToTFlow, mTarget);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSourceToTSource, tSource, mSource, tFlow,
					mFlowToTFlow, mTarget };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowOut_2_4_solveCSP_bindingAndBlackFBBBBBBBB(DataFlowOut _this,
		...
		Object[] result_pattern_DataFlowOut_2_4_solveCSP_binding = pattern_DataFlowOut_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget);
	...
	public static final void pattern_DataFlowOut_11_5_registerobjects_expressionBBBBBBBB(DataFlowOut _this,
			PerformRuleResult ruleresult, EObject mSourceToTSource, EObject tSource, EObject mSource, EObject tFlow,
			EObject mFlowToTFlow, EObject mTarget) {
		_this.registerObjects_BWD(ruleresult, mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget);
	...
	public static final Iterable<Object[]> pattern_DataFlowOut_12_2_corematch_blackFBFBFFB(TAbstractFlowElement tSource,
	...
	public static final Object[] pattern_DataFlowOut_12_4_solveCSP_bindingFBBBBBBBB(DataFlowOut _this,
			...
			TAbstractFlowElement tSource, MFlow mSource, TAbstractFlowElement tFlow,
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow, MAbstractFlowElement mTarget) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mSourceToTSource, tSource, mSource,
				tFlow, mFlowToTFlow, mTarget);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSourceToTSource, tSource, mSource, tFlow,
	...
	public static final Iterable<Object[]> pattern_DataFlowOut_24_5_matchcorrcontext_blackFBBBFBBB(
			TAbstractFlowElement tSource, MFlow mSource, TAbstractFlowElement tFlow, MAbstractFlowElement mTarget,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mSource.equals(mTarget)) {
	...
	public static final Object[] pattern_DataFlowOut_29_3_solveCSP_bindingFBBBBBBBBB(DataFlowOut _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mSourceToTSource, tSource, mSource,
				tFlow, mFlowToTFlow, mTarget, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSourceToTSource, tSource, mSource, tFlow,
	...
	public static final Object[] pattern_DataFlowOut_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(DataFlowOut _this,
		...
		Object[] result_pattern_DataFlowOut_29_3_solveCSP_binding = pattern_DataFlowOut_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mSourceToTSource, tSource, mSource, tFlow, mFlowToTFlow, mTarget, ruleResult);
