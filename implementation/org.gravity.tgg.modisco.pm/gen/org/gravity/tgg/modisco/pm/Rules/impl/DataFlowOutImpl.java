...
public class DataFlowOutImpl extends AbstractRuleImpl implements DataFlowOut {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = DataFlowOutImpl.pattern_DataFlowOut_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource);
		...
		// 
		// 
		DataFlowOutImpl.pattern_DataFlowOut_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tFlow, mTarget,
				mSource, mFlowToTFlow, mSourceToTSource, tSource);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : DataFlowOutImpl.pattern_DataFlowOut_2_2_corematch_blackFBBFFFB(mTarget, mSource,
			...
			for (Object[] result3_black : DataFlowOutImpl.pattern_DataFlowOut_2_3_findcontext_blackBBBBBB(tFlow,
					mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource)) {
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tFlow, EObject mTarget, EObject mSource,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		// 
		// 
		DataFlowOutImpl.pattern_DataFlowOut_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tFlow, mTarget,
				mSource, mFlowToTFlow, mSourceToTSource, tSource);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tFlow, EObject mTarget, EObject mSource,
			EObject mFlowToTFlow, EObject mSourceToTSource, EObject tSource) {
		ruleresult.registerObject("tFlow", tFlow);
		ruleresult.registerObject("mTarget", mTarget);
		ruleresult.registerObject("mSource", mSource);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_19(EMoflonEdge _edge_incomingFlows) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (DataFlowOutImpl.pattern_DataFlowOut_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : DataFlowOutImpl.pattern_DataFlowOut_24_5_matchcorrcontext_blackBBBFFBBB(tFlow,
		...
		for (Object[] result2_black : DataFlowOutImpl
			...
			Object[] result3_bindingAndBlack = DataFlowOutImpl
					.pattern_DataFlowOut_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, tFlow,
							mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tFlow] = " + tFlow + ", "
						+ "[mTarget] = " + mTarget + ", " + "[mSource] = " + mSource + ", " + "[mFlowToTFlow] = "
			...
			if (DataFlowOutImpl.pattern_DataFlowOut_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = DataFlowOutImpl.pattern_DataFlowOut_29_5_checknacs_blackBBBBBB(tFlow, mTarget,
						mSource, mFlowToTFlow, mSourceToTSource, tSource);
				if (result5_black != null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_OUT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_19__EMOFLONEDGE:
		...
		case RulesPackage.DATA_FLOW_OUT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpMFlowToTFlow instanceof MAbstractFlowElementToTAbstractFlowElement) {
						...
						if (tmpMSourceToTSource instanceof MAbstractFlowElementToTAbstractFlowElement) {
							...
							if (tmpTSource instanceof TAbstractFlowElement) {
								...
								return new Object[] { tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource,
										isApplicableMatch };
							}
						}
					}
				...
				if (!mFlowToTFlow.equals(mSourceToTSource)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource, csp,
	...
	public static final Object[] pattern_DataFlowOut_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_DataFlowOut_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_DataFlowOut_1_1_performtransformation_black = pattern_DataFlowOut_1_1_performtransformation_blackBBBBBBFBB(
					tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource, _this, isApplicableMatch);
			if (result_pattern_DataFlowOut_1_1_performtransformation_black != null) {
				...
				return new Object[] { tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowOut_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject tFlow, EObject mTarget, EObject mSource, EObject mFlowToTFlow, EObject mSourceToTSource,
			EObject tSource) {
		if (!tFlow.equals(tSource)) {
															...
															if (!mSourceToTSource.equals(mTarget)) {
																if (!mSourceToTSource.equals(tSource)) {
																	return new Object[] { ruleresult, tFlow, mTarget,
																			mSource, mFlowToTFlow, mSourceToTSource,
																			tSource };
																}
															}
														}
	...
	public static final void pattern_DataFlowOut_1_5_registerobjects_expressionBBBBBBBB(DataFlowOut _this,
			PerformRuleResult ruleresult, EObject tFlow, EObject mTarget, EObject mSource, EObject mFlowToTFlow,
			EObject mSourceToTSource, EObject tSource) {
		_this.registerObjects_FWD(ruleresult, tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource);
				...
				if (tFlow != null) {
					for (MAbstractFlowElementToTAbstractFlowElement mSourceToTSource : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mFlowToTFlow.equals(mSourceToTSource)) {
							...
							if (tSource != null) {
								if (!tFlow.equals(tSource)) {
									_result.add(new Object[] { tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource,
											tSource, match });
								}
							}
							...
							if (mTarget.equals(mFlowToTFlow.getSource())) {
								if (mSource.equals(mSourceToTSource.getSource())) {
									if (tSource.equals(mSourceToTSource.getTarget())) {
										_result.add(new Object[] { tFlow, mTarget, mSource, mFlowToTFlow,
	...
	public static final Object[] pattern_DataFlowOut_2_3_findcontext_greenBBBBBBFFFFFFF(TAbstractFlowElement tFlow,
		...
		return new Object[] { tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource, isApplicableMatch,
	...
	public static final Object[] pattern_DataFlowOut_2_4_solveCSP_bindingFBBBBBBBB(DataFlowOut _this,
			...
			MFlow mSource, MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tSource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tFlow, mTarget, mSource, mFlowToTFlow,
				mSourceToTSource, tSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tFlow, mTarget, mSource, mFlowToTFlow,
					mSourceToTSource, tSource };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowOut_2_4_solveCSP_bindingAndBlackFBBBBBBBB(DataFlowOut _this,
		...
		Object[] result_pattern_DataFlowOut_2_4_solveCSP_binding = pattern_DataFlowOut_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource);
	...
	public static final void pattern_DataFlowOut_11_5_registerobjects_expressionBBBBBBBB(DataFlowOut _this,
			PerformRuleResult ruleresult, EObject tFlow, EObject mTarget, EObject mSource, EObject mFlowToTFlow,
			EObject mSourceToTSource, EObject tSource) {
		_this.registerObjects_BWD(ruleresult, tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource);
	...
	public static final Object[] pattern_DataFlowOut_12_4_solveCSP_bindingFBBBBBBBB(DataFlowOut _this,
			...
			MFlow mSource, MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tSource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tFlow, mTarget, mSource, mFlowToTFlow,
				mSourceToTSource, tSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tFlow, mTarget, mSource, mFlowToTFlow,
	...
	public static final Iterable<Object[]> pattern_DataFlowOut_24_5_matchcorrcontext_blackBBBFFBBB(
			TAbstractFlowElement tFlow, MAbstractFlowElement mTarget, MFlow mSource, TAbstractFlowElement tSource,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tFlow.equals(tSource)) {
	...
	public static final Object[] pattern_DataFlowOut_29_3_solveCSP_bindingFBBBBBBBBB(DataFlowOut _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tFlow, mTarget, mSource,
	...
	public static final Object[] pattern_DataFlowOut_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(DataFlowOut _this,
		...
		Object[] result_pattern_DataFlowOut_29_3_solveCSP_binding = pattern_DataFlowOut_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tFlow, mTarget, mSource, mFlowToTFlow, mSourceToTSource, tSource, ruleResult);
