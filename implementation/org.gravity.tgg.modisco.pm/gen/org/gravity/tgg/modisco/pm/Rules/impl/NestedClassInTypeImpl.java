...
public class NestedClassInTypeImpl extends AbstractRuleImpl implements NestedClassInType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = NestedClassInTypeImpl
				.pattern_NestedClassInType_1_1_performtransformation_greenBFBFBFBB(eNestedType, typeGraph, tOuterType,
						tOuterPackage, csp);
		TypeToTAbstractType eNestedTypeToTNestedType = (TypeToTAbstractType) result1_green[1];
		TClass tNestedType = (TClass) result1_green[3];
		ASTNodeToTAnnotatable mBodyToTAnnotation = (ASTNodeToTAnnotatable) result1_green[5];

		Object[] result2_black = NestedClassInTypeImpl
				.pattern_NestedClassInType_1_2_collecttranslatedelements_blackBBBB(eNestedType,
		...
		Object[] result2_green = NestedClassInTypeImpl
				.pattern_NestedClassInType_1_2_collecttranslatedelements_greenFBBBB(eNestedType,
						eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = NestedClassInTypeImpl
				.pattern_NestedClassInType_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, eNestedType,
						eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
		...
		NestedClassInTypeImpl.pattern_NestedClassInType_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(ruleresult,
				eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType, mBodyToTAnnotation,
				eOuterType, tOuterPackage);
		//nothing EMoflonEdge mBodyToTAnnotation__eNestedType____source = (EMoflonEdge) result3_green[9];
		...
		//nothing EMoflonEdge tOuterPackage__tNestedType____classes = (EMoflonEdge) result3_green[12];
		...
		//nothing EMoflonEdge mBodyToTAnnotation__tNestedType____target = (EMoflonEdge) result3_green[15];
		...
		//nothing EMoflonEdge eNestedTypeToTNestedType__eNestedType____source = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge typeGraph__tNestedType____classes = (EMoflonEdge) result3_green[19];
		//nothing EMoflonEdge tOuterPackage__tNestedType____ownedTypes = (EMoflonEdge) result3_green[20];
		...
		// 
		// 
		NestedClassInTypeImpl.pattern_NestedClassInType_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
				mBodyToTAnnotation, eOuterType, tOuterPackage);
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {

		Object[] result1_black = NestedClassInTypeImpl.pattern_NestedClassInType_10_1_initialbindings_blackBBBBBB(this,
		...
		Object[] result2_bindingAndBlack = NestedClassInTypeImpl
				.pattern_NestedClassInType_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, typeGraph, tNestedType,
		...
		if (NestedClassInTypeImpl.pattern_NestedClassInType_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = NestedClassInTypeImpl
					.pattern_NestedClassInType_10_4_collectelementstobetranslated_blackBBBBB(match, typeGraph,
			...
			NestedClassInTypeImpl.pattern_NestedClassInType_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(match,
			...
			//nothing EMoflonEdge tOuterPackage__tNestedType____classes = (EMoflonEdge) result4_green[7];
			//nothing EMoflonEdge tOuterType__tNestedType____innerTypes = (EMoflonEdge) result4_green[8];
			//nothing EMoflonEdge tNestedType__tOuterType____outerType = (EMoflonEdge) result4_green[9];
			//nothing EMoflonEdge typeGraph__tNestedType____classes = (EMoflonEdge) result4_green[10];
			//nothing EMoflonEdge tOuterPackage__tNestedType____ownedTypes = (EMoflonEdge) result4_green[11];
			//nothing EMoflonEdge tNestedType__tOuterPackage____package = (EMoflonEdge) result4_green[12];

			Object[] result5_black = NestedClassInTypeImpl
					.pattern_NestedClassInType_10_5_collectcontextelements_blackBBBBB(match, typeGraph, tNestedType,
							tOuterType, tOuterPackage);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[typeGraph] = " + typeGraph + ", " + "[tNestedType] = " + tNestedType + ", "
			...
			// 
			NestedClassInTypeImpl.pattern_NestedClassInType_10_6_registerobjectstomatch_expressionBBBBBB(this, match,
					typeGraph, tNestedType, tOuterType, tOuterPackage);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = NestedClassInTypeImpl
				.pattern_NestedClassInType_11_1_performtransformation_bindingAndBlackFFFFFFFBB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		TypeGraph typeGraph = (TypeGraph) result1_bindingAndBlack[0];
		TClass tNestedType = (TClass) result1_bindingAndBlack[1];
		TAbstractType tOuterType = (TAbstractType) result1_bindingAndBlack[2];
		TypeToTAbstractType eOuterTypeToTOuterInterface = (TypeToTAbstractType) result1_bindingAndBlack[3];
		AbstractTypeDeclaration eOuterType = (AbstractTypeDeclaration) result1_bindingAndBlack[4];
		TPackage tOuterPackage = (TPackage) result1_bindingAndBlack[5];
		...
		Object[] result2_black = NestedClassInTypeImpl
				.pattern_NestedClassInType_11_2_collecttranslatedelements_blackBBBB(eNestedType,
						eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eNestedType] = " + eNestedType
					+ ", " + "[eNestedTypeToTNestedType] = " + eNestedTypeToTNestedType + ", " + "[tNestedType] = "
		...
		Object[] result2_green = NestedClassInTypeImpl
				.pattern_NestedClassInType_11_2_collecttranslatedelements_greenFBBBB(eNestedType,
						eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = NestedClassInTypeImpl
				.pattern_NestedClassInType_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, eNestedType,
						eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
						mBodyToTAnnotation, eOuterType, tOuterPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
		...
		NestedClassInTypeImpl.pattern_NestedClassInType_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
				ruleresult, eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
				mBodyToTAnnotation, eOuterType, tOuterPackage);
		//nothing EMoflonEdge mBodyToTAnnotation__eNestedType____source = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge typeGraph__tNestedType____ownedTypes = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge tNestedType__typeGraph____model = (EMoflonEdge) result3_green[11];
		...
		// 
		// 
		NestedClassInTypeImpl.pattern_NestedClassInType_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface,
				mBodyToTAnnotation, eOuterType, tOuterPackage);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = NestedClassInTypeImpl.pattern_NestedClassInType_12_2_corematch_bindingFFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		TypeGraph typeGraph = (TypeGraph) result2_binding[0];
		TClass tNestedType = (TClass) result2_binding[1];
		TAbstractType tOuterType = (TAbstractType) result2_binding[2];
		TPackage tOuterPackage = (TPackage) result2_binding[3];
		for (Object[] result2_black : NestedClassInTypeImpl.pattern_NestedClassInType_12_2_corematch_blackBBBFFBB(
			...
			// ForEach 
			for (Object[] result3_black : NestedClassInTypeImpl.pattern_NestedClassInType_12_3_findcontext_blackBBBBBB(
					typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType, tOuterPackage)) {
				Object[] result3_green = NestedClassInTypeImpl
						.pattern_NestedClassInType_12_3_findcontext_greenBBBBBBFFFFFFFFFFFFFFFF(typeGraph, tNestedType,
								tOuterType, eOuterTypeToTOuterInterface, eOuterType, tOuterPackage);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge tOuterPackage__typeGraph____model = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge eOuterTypeToTOuterInterface__eOuterType____source = (EMoflonEdge) result3_green[8];
				...
				//nothing EMoflonEdge tOuterPackage__tNestedType____classes = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge tOuterType__tNestedType____innerTypes = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge tNestedType__tOuterType____outerType = (EMoflonEdge) result3_green[15];
				//nothing EMoflonEdge tOuterType__tOuterPackage____package = (EMoflonEdge) result3_green[16];
				//nothing EMoflonEdge tOuterPackage__tOuterType____ownedTypes = (EMoflonEdge) result3_green[17];
				//nothing EMoflonEdge typeGraph__tNestedType____classes = (EMoflonEdge) result3_green[18];
				...
				Object[] result4_bindingAndBlack = NestedClassInTypeImpl
						.pattern_NestedClassInType_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TypeGraph typeGraph, TClass tNestedType,
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TypeGraph typeGraph, TClass tNestedType,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_32(EMoflonEdge _edge_ownedTypes) {
		...
		// ForEach 
		for (Object[] result2_black : NestedClassInTypeImpl
				.pattern_NestedClassInType_20_2_testcorematchandDECs_blackFFFFB(_edge_ownedTypes)) {
			TypeGraph typeGraph = (TypeGraph) result2_black[0];
			TClass tNestedType = (TClass) result2_black[1];
			...
			if (NestedClassInTypeImpl
					.pattern_NestedClassInType_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(this,
							match, typeGraph, tNestedType, tOuterType, tOuterPackage)) {
				// 
				if (NestedClassInTypeImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_34(EMoflonEdge _edge_abstractTypeDeclaration) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = NestedClassInTypeImpl
				.pattern_NestedClassInType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		TClass tNestedType = (TClass) result2_bindingAndBlack[2];
		...
		Object[] result3_bindingAndBlack = NestedClassInTypeImpl
				.pattern_NestedClassInType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, eNestedType, typeGraph,
		...
		if (NestedClassInTypeImpl.pattern_NestedClassInType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : NestedClassInTypeImpl
				...
				Object[] result6_black = NestedClassInTypeImpl
						.pattern_NestedClassInType_24_6_createcorrespondence_blackBBBBBBB(eNestedType, typeGraph,
				...
				NestedClassInTypeImpl.pattern_NestedClassInType_24_6_createcorrespondence_greenBFBFB(eNestedType,
						tNestedType, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MClass eNestedType, TypeGraph typeGraph, TClass tNestedType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {// 
		Object[] result1_black = NestedClassInTypeImpl.pattern_NestedClassInType_28_1_matchtggpattern_blackBBBB(
				typeGraph, tNestedType, tOuterType, tOuterPackage);
		if (result1_black != null) {
		...
		for (Object[] result2_black : NestedClassInTypeImpl
			...
			if (NestedClassInTypeImpl.pattern_NestedClassInType_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					NestedClassInTypeImpl.pattern_NestedClassInType_29_6_perform_greenFFBFBFBBBB(typeGraph, tOuterType,
							eOuterType, tOuterPackage, ruleResult, csp);
					//nothing MClass eNestedType = (MClass) result6_green[0];
					//nothing TypeToTAbstractType eNestedTypeToTNestedType = (TypeToTAbstractType) result6_green[1];
					//nothing TClass tNestedType = (TClass) result6_green[3];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPROPRIATE_BWD__MATCH_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TypeGraph) arguments.get(1),
					(TClass) arguments.get(2), (TAbstractType) arguments.get(3), (TPackage) arguments.get(4));
			return null;
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (TypeGraph) arguments.get(1),
					(TClass) arguments.get(2), (TAbstractType) arguments.get(3), (TPackage) arguments.get(4));
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TypeGraph) arguments.get(1),
					(TClass) arguments.get(2), (TAbstractType) arguments.get(3), (TypeToTAbstractType) arguments.get(4),
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_32__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_32((EMoflonEdge) arguments.get(0));
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_34__EMOFLONEDGE:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__MCLASS_TYPEGRAPH_TCLASS_TABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MClass) arguments.get(0), (TypeGraph) arguments.get(1),
					(TClass) arguments.get(2), (TAbstractType) arguments.get(3),
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___CHECK_DEC_BWD__TYPEGRAPH_TCLASS_TABSTRACTTYPE_TPACKAGE:
	...
	public static final Object[] pattern_NestedClassInType_1_1_performtransformation_greenBFBFBFBB(MClass eNestedType,
		...
		return new Object[] { eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
				mBodyToTAnnotation, tOuterPackage, csp };
	}

	public static final Object[] pattern_NestedClassInType_1_2_collecttranslatedelements_blackBBBB(MClass eNestedType,
			TypeToTAbstractType eNestedTypeToTNestedType, TClass tNestedType,
	...
	public static final Object[] pattern_NestedClassInType_1_2_collecttranslatedelements_greenFBBBB(MClass eNestedType,
			TypeToTAbstractType eNestedTypeToTNestedType, TClass tNestedType,
			ASTNodeToTAnnotatable mBodyToTAnnotation) {
		...
		return new Object[] { ruleresult, eNestedType, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation };
	}

	public static final Object[] pattern_NestedClassInType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject eNestedType, EObject eNestedTypeToTNestedType, EObject typeGraph,
										...
										if (!eNestedTypeToTNestedType.equals(typeGraph)) {
											if (!eNestedTypeToTNestedType.equals(tNestedType)) {
												if (!eNestedTypeToTNestedType.equals(tOuterType)) {
													if (!eNestedTypeToTNestedType.equals(eOuterTypeToTOuterInterface)) {
														if (!eNestedTypeToTNestedType.equals(mBodyToTAnnotation)) {
															if (!eNestedTypeToTNestedType.equals(eOuterType)) {
																if (!eNestedTypeToTNestedType.equals(tOuterPackage)) {
																	if (!tNestedType.equals(typeGraph)) {
																		if (!tNestedType.equals(tOuterType)) {
																			if (!tNestedType.equals(tOuterPackage)) {
																				if (!tOuterType.equals(typeGraph)) {
	...
	public static final Object[] pattern_NestedClassInType_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject eNestedType, EObject eNestedTypeToTNestedType, EObject typeGraph,
			EObject tNestedType, EObject tOuterType, EObject mBodyToTAnnotation, EObject eOuterType,
		...
		return new Object[] { ruleresult, eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
				...
				tOuterPackage__tNestedType____classes, tOuterType__tNestedType____innerTypes,
				tNestedType__tOuterType____outerType, mBodyToTAnnotation__tNestedType____target,
				...
				tOuterPackage__tNestedType____ownedTypes, tNestedType__tOuterPackage____package,
				eNestedTypeToTNestedType__tNestedType____target };
	}

	public static final void pattern_NestedClassInType_1_5_registerobjects_expressionBBBBBBBBBBB(
			NestedClassInType _this, PerformRuleResult ruleresult, EObject eNestedType,
			...
			EObject tOuterPackage) {
		_this.registerObjects_FWD(ruleresult, eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
	...
	public static final Object[] pattern_NestedClassInType_10_1_initialbindings_blackBBBBBB(NestedClassInType _this,
			Match match, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
		if (!tNestedType.equals(tOuterType)) {
	...
	public static final Object[] pattern_NestedClassInType_10_2_SolveCSP_bindingFBBBBBB(NestedClassInType _this,
			Match match, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedClassInType_10_2_SolveCSP_bindingAndBlackFBBBBBB(NestedClassInType _this,
			Match match, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
		Object[] result_pattern_NestedClassInType_10_2_SolveCSP_binding = pattern_NestedClassInType_10_2_SolveCSP_bindingFBBBBBB(
	...
	public static final Object[] pattern_NestedClassInType_10_4_collectelementstobetranslated_blackBBBBB(Match match,
	...
	public static final Object[] pattern_NestedClassInType_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(
			Match match, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
		EMoflonEdge typeGraph__tNestedType____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tNestedType__typeGraph____model = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tOuterPackage__tNestedType____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_NestedClassInType_10_5_collectcontextelements_blackBBBBB(Match match,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage) {
		if (!tNestedType.equals(tOuterType)) {
			return new Object[] { match, typeGraph, tNestedType, tOuterType, tOuterPackage };
		}
	...
	public static final void pattern_NestedClassInType_10_6_registerobjectstomatch_expressionBBBBBB(
			NestedClassInType _this, Match match, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedClassInType_11_1_performtransformation_bindingFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_NestedClassInType_11_1_performtransformation_blackBBBBBBFBB(
	...
	public static final Object[] pattern_NestedClassInType_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
			NestedClassInType _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_NestedClassInType_11_1_performtransformation_binding = pattern_NestedClassInType_11_1_performtransformation_bindingFFFFFFB(
				isApplicableMatch);
		if (result_pattern_NestedClassInType_11_1_performtransformation_binding != null) {
			TypeGraph typeGraph = (TypeGraph) result_pattern_NestedClassInType_11_1_performtransformation_binding[0];
			TClass tNestedType = (TClass) result_pattern_NestedClassInType_11_1_performtransformation_binding[1];
			TAbstractType tOuterType = (TAbstractType) result_pattern_NestedClassInType_11_1_performtransformation_binding[2];
			TypeToTAbstractType eOuterTypeToTOuterInterface = (TypeToTAbstractType) result_pattern_NestedClassInType_11_1_performtransformation_binding[3];
			AbstractTypeDeclaration eOuterType = (AbstractTypeDeclaration) result_pattern_NestedClassInType_11_1_performtransformation_binding[4];
			TPackage tOuterPackage = (TPackage) result_pattern_NestedClassInType_11_1_performtransformation_binding[5];

			Object[] result_pattern_NestedClassInType_11_1_performtransformation_black = pattern_NestedClassInType_11_1_performtransformation_blackBBBBBBFBB(
			...
			if (result_pattern_NestedClassInType_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_NestedClassInType_11_1_performtransformation_black[6];
	...
	public static final Object[] pattern_NestedClassInType_11_2_collecttranslatedelements_blackBBBB(MClass eNestedType,
			TypeToTAbstractType eNestedTypeToTNestedType, TClass tNestedType,
			ASTNodeToTAnnotatable mBodyToTAnnotation) {
		return new Object[] { eNestedType, eNestedTypeToTNestedType, tNestedType, mBodyToTAnnotation };
	}

	public static final Object[] pattern_NestedClassInType_11_2_collecttranslatedelements_greenFBBBB(MClass eNestedType,
			TypeToTAbstractType eNestedTypeToTNestedType, TClass tNestedType,
			ASTNodeToTAnnotatable mBodyToTAnnotation) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_NestedClassInType_11_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject eNestedType, EObject eNestedTypeToTNestedType, EObject typeGraph,
			EObject tNestedType, EObject tOuterType, EObject eOuterTypeToTOuterInterface, EObject mBodyToTAnnotation,
			EObject eOuterType, EObject tOuterPackage) {
		if (!eNestedType.equals(eNestedTypeToTNestedType)) {
	...
	public static final Object[] pattern_NestedClassInType_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject eNestedType, EObject eNestedTypeToTNestedType, EObject typeGraph,
			EObject tNestedType, EObject tOuterType, EObject mBodyToTAnnotation, EObject eOuterType,
			EObject tOuterPackage) {
		EMoflonEdge mBodyToTAnnotation__eNestedType____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_NestedClassInType_11_5_registerobjects_expressionBBBBBBBBBBB(
			NestedClassInType _this, PerformRuleResult ruleresult, EObject eNestedType,
			EObject eNestedTypeToTNestedType, EObject typeGraph, EObject tNestedType, EObject tOuterType,
			EObject eOuterTypeToTOuterInterface, EObject mBodyToTAnnotation, EObject eOuterType,
			EObject tOuterPackage) {
		_this.registerObjects_BWD(ruleresult, eNestedType, eNestedTypeToTNestedType, typeGraph, tNestedType, tOuterType,
				eOuterTypeToTOuterInterface, mBodyToTAnnotation, eOuterType, tOuterPackage);
	...
	public static final Object[] pattern_NestedClassInType_12_2_corematch_bindingFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_NestedClassInType_12_2_corematch_blackBBBFFBB(TypeGraph typeGraph,
			TClass tNestedType, TAbstractType tOuterType, TPackage tOuterPackage, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tNestedType.equals(tOuterType)) {
			for (TypeToTAbstractType eOuterTypeToTOuterInterface : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_NestedClassInType_12_3_findcontext_blackBBBBBB(TypeGraph typeGraph,
	...
	public static final Object[] pattern_NestedClassInType_12_3_findcontext_greenBBBBBBFFFFFFFFFFFFFFFF(
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		...
		return new Object[] { typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType,
				...
				tOuterPackage__tNestedType____classes, tOuterType__tNestedType____innerTypes,
				tNestedType__tOuterType____outerType, tOuterType__tOuterPackage____package,
				tOuterPackage__tOuterType____ownedTypes, typeGraph__tNestedType____classes,
				tOuterPackage__tNestedType____ownedTypes, tNestedType__tOuterPackage____package,
				eOuterTypeToTOuterInterface__tOuterType____target };
	}

	public static final Object[] pattern_NestedClassInType_12_4_solveCSP_bindingFBBBBBBBB(NestedClassInType _this,
			IsApplicableMatch isApplicableMatch, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedClassInType_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
			NestedClassInType _this, IsApplicableMatch isApplicableMatch, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage) {
		Object[] result_pattern_NestedClassInType_12_4_solveCSP_binding = pattern_NestedClassInType_12_4_solveCSP_bindingFBBBBBBBB(
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_0BB(TClass tNestedType,
			TPackage tOuterPackage) {
		for (TPackage __DEC_tNestedType_classes_204570 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TPackage.class, "classes")) {
			if (!tOuterPackage.equals(__DEC_tNestedType_classes_204570)) {
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_1BB(TClass tNestedType,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_classes_334906 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tNestedType_classes_334906)) {
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_2BB(TClass tNestedType,
			TPackage tOuterPackage) {
		TPackage __DEC_tNestedType_ownedTypes_108202 = tNestedType.getPackage();
		if (__DEC_tNestedType_ownedTypes_108202 != null) {
			if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_108202)) {
				return new Object[] { tNestedType, tOuterPackage };
			}
		}
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_3BB(TClass tNestedType,
		...
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_318773 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_318773 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_318773)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_318773)) {
	...
	public static final Iterable<Object[]> pattern_NestedClassInType_20_2_testcorematchandDECs_blackFFFFB(
													...
													if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_1BB(
														...
														if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_3BB(
															...
															if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_0BB(
																...
																if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_2BB(
																		tNestedType, tOuterPackage) == null) {
	...
	public static final boolean pattern_NestedClassInType_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			NestedClassInType _this, Match match, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_0B(MClass eNestedType) {
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_770937 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_770937 != null) {
	...
	public static final Object[] pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_1B(MClass eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_964874 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_2B(MClass eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_608770 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_608770 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_3B(MClass eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_326756 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_NestedClassInType_24_2_matchsrctrgcontext_bindingFFFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_NestedClassInType_24_2_matchsrctrgcontext_blackBBBBBBBB(MClass eNestedType,
	...
	public static final Object[] pattern_NestedClassInType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding = pattern_NestedClassInType_24_2_matchsrctrgcontext_bindingFFFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding != null) {
			...
			TypeGraph typeGraph = (TypeGraph) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[1];
			TClass tNestedType = (TClass) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[2];
			TAbstractType tOuterType = (TAbstractType) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[3];
			AbstractTypeDeclaration eOuterType = (AbstractTypeDeclaration) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[4];
			TPackage tOuterPackage = (TPackage) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[5];

			Object[] result_pattern_NestedClassInType_24_2_matchsrctrgcontext_black = pattern_NestedClassInType_24_2_matchsrctrgcontext_blackBBBBBBBB(
	...
	public static final Object[] pattern_NestedClassInType_24_3_solvecsp_bindingFBBBBBBBBB(NestedClassInType _this,
			MClass eNestedType, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
	...
	public static final Object[] pattern_NestedClassInType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			NestedClassInType _this, MClass eNestedType, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_NestedClassInType_24_3_solvecsp_binding = pattern_NestedClassInType_24_3_solvecsp_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_NestedClassInType_24_6_createcorrespondence_blackBBBBBBB(MClass eNestedType,
			TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType, AbstractTypeDeclaration eOuterType,
	...
	public static final Object[] pattern_NestedClassInType_24_6_createcorrespondence_greenBFBFB(MClass eNestedType,
	...
	public static final Object[] pattern_NestedClassInType_27_1_matchtggpattern_black_nac_0B(MClass eNestedType) {
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_79356 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_79356 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_NestedClassInType_27_1_matchtggpattern_black_nac_1B(MClass eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_653207 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, Model.class, "orphanTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_NestedClassInType_27_1_matchtggpattern_black_nac_2B(MClass eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_965328 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_965328 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_NestedClassInType_27_1_matchtggpattern_black_nac_3B(MClass eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_476171 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_0BB(TClass tNestedType,
			TPackage tOuterPackage) {
		for (TPackage __DEC_tNestedType_classes_874042 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TPackage.class, "classes")) {
			if (!tOuterPackage.equals(__DEC_tNestedType_classes_874042)) {
				return new Object[] { tNestedType, tOuterPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_1BB(TClass tNestedType,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_classes_143206 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tNestedType_classes_143206)) {
				return new Object[] { tNestedType, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_2BB(TClass tNestedType,
			TPackage tOuterPackage) {
		TPackage __DEC_tNestedType_ownedTypes_778649 = tNestedType.getPackage();
		if (__DEC_tNestedType_ownedTypes_778649 != null) {
			if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_778649)) {
				return new Object[] { tNestedType, tOuterPackage };
			}
		}
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_3BB(TClass tNestedType,
			TAbstractType tOuterType) {
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_324352 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_324352 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_324352)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_324352)) {
						return new Object[] { tNestedType, tOuterType };
					}
				}
			}
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_blackBBBB(TypeGraph typeGraph,
										...
										if (tOuterPackage.getOwnedTypes().contains(tNestedType)) {
											if (pattern_NestedClassInType_28_1_matchtggpattern_black_nac_0BB(
												...
												if (pattern_NestedClassInType_28_1_matchtggpattern_black_nac_1BB(
														tNestedType, typeGraph) == null) {
													if (pattern_NestedClassInType_28_1_matchtggpattern_black_nac_2BB(
															tNestedType, tOuterPackage) == null) {
	...
	public static final Object[] pattern_NestedClassInType_29_6_perform_greenFFBFBFBBBB(TypeGraph typeGraph,
