...
public class ClassImpl extends AbstractRuleImpl implements org.gravity.tgg.modisco.pm.Rules.Class {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ClassImpl.pattern_Class_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
				mClassDeclarationToTClass, mPackageToTPackage, tPackage, tType, mPackage, mTypeToTType, pg,
		...
		ClassImpl.pattern_Class_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(ruleresult,
				mClassDeclarationToTClass, tPackage, tType, mPackage, mTypeToTType, pg, mBodyToTAnnotation, mType);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_91(EMoflonEdge _edge_ownedElements) {
		...
		for (Object[] result2_black : ClassImpl.pattern_Class_29_2_isapplicablecore_blackFFFFFBB(ruleEntryContainer,
			...
			if (ClassImpl.pattern_Class_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					ClassImpl.pattern_Class_29_6_perform_greenFBFBFBFFBB(tPackage, mPackage, pg, ruleResult, csp);
					//nothing ClassDeclarationToTClass mClassDeclarationToTClass = (ClassDeclarationToTClass) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_89__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_89((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_91__EMOFLONEDGE:
	...
	public static final Object[] pattern_Class_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, mClassDeclarationToTClass, tPackage, tType, mPackage, mTypeToTType, pg,
	...
	public static final void pattern_Class_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mClassDeclarationToTClass, EObject mPackageToTPackage, EObject tPackage, EObject tType,
			EObject mPackage, EObject mTypeToTType, EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		_this.registerObjects_FWD(ruleresult, mClassDeclarationToTClass, mPackageToTPackage, tPackage, tType, mPackage,
	...
	public static final void pattern_Class_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mClassDeclarationToTClass, EObject mPackageToTPackage, EObject tPackage, EObject tType,
			EObject mPackage, EObject mTypeToTType, EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		_this.registerObjects_BWD(ruleresult, mClassDeclarationToTClass, mPackageToTPackage, tPackage, tType, mPackage,
				mTypeToTType, pg, mBodyToTAnnotation, mType);
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_0BB(TClass tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_classes_547311 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_547311)) {
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_376741 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_376741)) {
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_2BB(TClass tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_789891 = tType.getPackage();
		if (__DEC_tType_ownedTypes_789891 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_789891)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_390699 = tType.getOuterType();
		if (__DEC_tType_innerTypes_390699 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_390699)) {
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_0B(MClass mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_240323 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_240323 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_240323)) {
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_1B(MClass mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_538684 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_538684 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_2B(MClass mType) {
		for (Model __DEC_mType_orphanTypes_175316 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_3B(MClass mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_35560 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_0B(MClass mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_327599 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_327599 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_327599)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_1B(MClass mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_546206 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_546206 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_2B(MClass mType) {
		for (Model __DEC_mType_orphanTypes_186507 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, Model.class, "orphanTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_3B(MClass mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_73087 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_0BB(TClass tType, TPackage tPackage) {
		for (TPackage __DEC_tType_classes_900223 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_900223)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_852443 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_852443)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_2BB(TClass tType, TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_722540 = tType.getPackage();
		if (__DEC_tType_ownedTypes_722540 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_722540)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_917858 = tType.getOuterType();
		if (__DEC_tType_innerTypes_917858 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_917858)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_Class_29_6_perform_greenFBFBFBFFBB(TPackage tPackage,
		...
		return new Object[] { mClassDeclarationToTClass, tPackage, tType, mPackage, mTypeToTType, pg,
