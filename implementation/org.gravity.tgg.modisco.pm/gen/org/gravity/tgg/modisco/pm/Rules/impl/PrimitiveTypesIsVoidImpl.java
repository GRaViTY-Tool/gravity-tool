...
public class PrimitiveTypesIsVoidImpl extends AbstractRuleImpl implements PrimitiveTypesIsVoid {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_1_1_performtransformation_bindingAndBlackFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_1_1_performtransformation_greenBBBFF(ePrimitiveType, primitives,
						typeGraph);
		...
		Object[] result2_black = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_1_2_collecttranslatedelements_blackBBB(ePrimitiveType,
		...
		Object[] result2_green = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_1_2_collecttranslatedelements_greenFBBB(ePrimitiveType,
						typeToTAbstractType, tPrimitiveClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : PrimitiveTypesIsVoidImpl
			...
			for (Object[] result3_black : PrimitiveTypesIsVoidImpl
					.pattern_PrimitiveTypesIsVoid_2_3_findcontext_blackBBFBB(ePrimitiveType, eModelToTypeGraph,
							typeGraph, eModel)) {
				TModule primitives = (TModule) result3_black[2];
				Object[] result3_green = PrimitiveTypesIsVoidImpl
						.pattern_PrimitiveTypesIsVoid_2_3_findcontext_greenBBBBBFFFFF(ePrimitiveType, eModelToTypeGraph,
				...
				Object[] result4_bindingAndBlack = PrimitiveTypesIsVoidImpl
						.pattern_PrimitiveTypesIsVoid_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
	...
	public boolean isAppropriate_BWD(Match match, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
		...
		Object[] result1_black = PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_10_1_initialbindings_blackBBBBB(
		...
		Object[] result2_bindingAndBlack = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, primitives, typeGraph,
						tPrimitiveClass);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[primitives] = " + primitives + ", " + "[typeGraph] = " + typeGraph
		...
		if (PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = PrimitiveTypesIsVoidImpl
					.pattern_PrimitiveTypesIsVoid_10_4_collectelementstobetranslated_blackBBBB(match, primitives,
			...
			PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_10_4_collectelementstobetranslated_greenBBBBFFFFF(
			...
			Object[] result5_black = PrimitiveTypesIsVoidImpl
					.pattern_PrimitiveTypesIsVoid_10_5_collectcontextelements_blackBBBB(match, primitives, typeGraph,
							tPrimitiveClass);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[primitives] = " + primitives + ", " + "[typeGraph] = " + typeGraph + ", "
			...
			PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_10_5_collectcontextelements_greenBBBF(match,
					primitives, typeGraph);
			//nothing EMoflonEdge typeGraph__primitives____modules = (EMoflonEdge) result5_green[3];

			// 
			PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_10_6_registerobjectstomatch_expressionBBBBB(this,
					match, primitives, typeGraph, tPrimitiveClass);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_11_1_performtransformation_bindingAndBlackFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_11_1_performtransformation_greenFFBB(tPrimitiveClass, eModel);
		...
		Object[] result2_black = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_11_2_collecttranslatedelements_blackBBB(ePrimitiveType,
						typeToTAbstractType, tPrimitiveClass);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ePrimitiveType] = "
					+ ePrimitiveType + ", " + "[typeToTAbstractType] = " + typeToTAbstractType + ", "
		...
		Object[] result2_green = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_11_2_collecttranslatedelements_greenFBBB(ePrimitiveType,
						typeToTAbstractType, tPrimitiveClass);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_12_2_corematch_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_12_2_corematch_blackFBBBFB(
			...
			// ForEach 
			for (Object[] result3_black : PrimitiveTypesIsVoidImpl
					.pattern_PrimitiveTypesIsVoid_12_3_findcontext_blackBBBBB(eModelToTypeGraph, primitives, typeGraph,
							tPrimitiveClass, eModel)) {
				Object[] result3_green = PrimitiveTypesIsVoidImpl
						.pattern_PrimitiveTypesIsVoid_12_3_findcontext_greenBBBBBFFFFFFFFF(eModelToTypeGraph,
				...
				Object[] result4_bindingAndBlack = PrimitiveTypesIsVoidImpl
						.pattern_PrimitiveTypesIsVoid_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_627(EMoflonEdge _edge_allTypes) {
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_blackFFFB(_edge_allTypes)) {
			...
			if (PrimitiveTypesIsVoidImpl
					.pattern_PrimitiveTypesIsVoid_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, primitives, typeGraph, tPrimitiveClass)) {
				// 
				if (PrimitiveTypesIsVoidImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_673(EMoflonEdge _edge_orphanTypes) {
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_21_2_testcorematchandDECs_blackFFB(_edge_orphanTypes)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		PrimitiveTypeVoid ePrimitiveType = (PrimitiveTypeVoid) result2_bindingAndBlack[0];
		...
		Object[] result3_bindingAndBlack = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, ePrimitiveType, primitives,
		...
		// 
		if (PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : PrimitiveTypesIsVoidImpl
					.pattern_PrimitiveTypesIsVoid_24_5_matchcorrcontext_blackFBBBB(typeGraph, eModel, sourceMatch,
							targetMatch)) {
				ModelToTypeGraph eModelToTypeGraph = (ModelToTypeGraph) result5_black[0];
				Object[] result5_green = PrimitiveTypesIsVoidImpl
						.pattern_PrimitiveTypesIsVoid_24_5_matchcorrcontext_greenBBBF(eModelToTypeGraph, sourceMatch,
								targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[3];

				Object[] result6_black = PrimitiveTypesIsVoidImpl
						.pattern_PrimitiveTypesIsVoid_24_6_createcorrespondence_blackBBBBBB(ePrimitiveType, primitives,
				...
				PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_24_6_createcorrespondence_greenBFBB(
				...
				Object[] result7_black = PrimitiveTypesIsVoidImpl
						.pattern_PrimitiveTypesIsVoid_24_7_addtoreturnedresult_blackBB(result, ccMatch);
				if (result7_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[result] = " + result
							+ ", " + "[ccMatch] = " + ccMatch + ".");
				}
				PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_24_7_addtoreturnedresult_greenBB(result, ccMatch);

			}

		} else {
		}
		return PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_24_8_expressionFB(result);
	}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(PrimitiveTypeVoid ePrimitiveType, TModule primitives, TypeGraph typeGraph,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(PrimitiveTypeVoid ePrimitiveType, Model eModel) {// 
		Object[] result1_black = PrimitiveTypesIsVoidImpl
	...
	public boolean checkDEC_BWD(TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {// 
		Object[] result1_black = PrimitiveTypesIsVoidImpl
				.pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_blackBBB(primitives, typeGraph, tPrimitiveClass);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : PrimitiveTypesIsVoidImpl
			...
			if (PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_29_5_checknacs_blackBBBB(
						eModelToTypeGraph, primitives, typeGraph, eModel);
				if (result5_black != null) {

					Object[] result6_black = PrimitiveTypesIsVoidImpl
							.pattern_PrimitiveTypesIsVoid_29_6_perform_blackBBBBB(eModelToTypeGraph, primitives,
					...
					PrimitiveTypesIsVoidImpl.pattern_PrimitiveTypesIsVoid_29_6_perform_greenFBBFFBB(primitives,
							typeGraph, eModel, ruleResult);
					//nothing PrimitiveTypeVoid ePrimitiveType = (PrimitiveTypeVoid) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PRIMITIVE_TYPES_IS_VOID___IS_APPROPRIATE_BWD_EMOFLON_EDGE_627__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_627((EMoflonEdge) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPES_IS_VOID___IS_APPROPRIATE_FWD_EMOFLON_EDGE_673__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_673((EMoflonEdge) arguments.get(0));
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_1_1_performtransformation_bindingFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_1_1_performtransformation_blackBBBBBFBB(
			PrimitiveTypeVoid ePrimitiveType, ModelToTypeGraph eModelToTypeGraph, TModule primitives,
			TypeGraph typeGraph, Model eModel, PrimitiveTypesIsVoid _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_1_1_performtransformation_bindingAndBlackFFFFFFBB(
			PrimitiveTypesIsVoid _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_PrimitiveTypesIsVoid_1_1_performtransformation_binding = pattern_PrimitiveTypesIsVoid_1_1_performtransformation_bindingFFFFFB(
				isApplicableMatch);
		if (result_pattern_PrimitiveTypesIsVoid_1_1_performtransformation_binding != null) {
			...
			TModule primitives = (TModule) result_pattern_PrimitiveTypesIsVoid_1_1_performtransformation_binding[2];
			TypeGraph typeGraph = (TypeGraph) result_pattern_PrimitiveTypesIsVoid_1_1_performtransformation_binding[3];
			Model eModel = (Model) result_pattern_PrimitiveTypesIsVoid_1_1_performtransformation_binding[4];

			Object[] result_pattern_PrimitiveTypesIsVoid_1_1_performtransformation_black = pattern_PrimitiveTypesIsVoid_1_1_performtransformation_blackBBBBBFBB(
			...
			if (result_pattern_PrimitiveTypesIsVoid_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_PrimitiveTypesIsVoid_1_1_performtransformation_black[5];
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_1_1_performtransformation_greenBBBFF(
			PrimitiveTypeVoid ePrimitiveType, TModule primitives, TypeGraph typeGraph) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_1_2_collecttranslatedelements_blackBBB(
			PrimitiveTypeVoid ePrimitiveType, TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		return new Object[] { ePrimitiveType, typeToTAbstractType, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypesIsVoid_1_2_collecttranslatedelements_greenFBBB(
			PrimitiveTypeVoid ePrimitiveType, TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypesIsVoid_2_3_findcontext_blackBBFBB(
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_2_3_findcontext_greenBBBBBFFFFF(
			PrimitiveTypeVoid ePrimitiveType, ModelToTypeGraph eModelToTypeGraph, TModule primitives,
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_2_4_solveCSP_bindingFBBBBBBB(PrimitiveTypesIsVoid _this,
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_2_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_PrimitiveTypesIsVoid_2_4_solveCSP_binding = pattern_PrimitiveTypesIsVoid_2_4_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_10_1_initialbindings_blackBBBBB(
			PrimitiveTypesIsVoid _this, Match match, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
		return new Object[] { _this, match, primitives, typeGraph, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypesIsVoid_10_2_SolveCSP_bindingFBBBBB(PrimitiveTypesIsVoid _this,
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_10_2_SolveCSP_bindingAndBlackFBBBBB(
			PrimitiveTypesIsVoid _this, Match match, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
		Object[] result_pattern_PrimitiveTypesIsVoid_10_2_SolveCSP_binding = pattern_PrimitiveTypesIsVoid_10_2_SolveCSP_bindingFBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_10_4_collectelementstobetranslated_blackBBBB(Match match,
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_10_4_collectelementstobetranslated_greenBBBBFFFFF(
			Match match, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
		EMoflonEdge typeGraph__tPrimitiveClass____allTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tPrimitiveClass__typeGraph____model = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge typeGraph__tPrimitiveClass____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_10_5_collectcontextelements_blackBBBB(Match match,
			TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
		return new Object[] { match, primitives, typeGraph, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypesIsVoid_10_5_collectcontextelements_greenBBBF(Match match,
	...
	public static final void pattern_PrimitiveTypesIsVoid_10_6_registerobjectstomatch_expressionBBBBB(
			PrimitiveTypesIsVoid _this, Match match, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_11_1_performtransformation_bindingFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_11_1_performtransformation_blackBBBBBFBB(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
			Model eModel, PrimitiveTypesIsVoid _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_11_1_performtransformation_bindingAndBlackFFFFFFBB(
			PrimitiveTypesIsVoid _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_PrimitiveTypesIsVoid_11_1_performtransformation_binding = pattern_PrimitiveTypesIsVoid_11_1_performtransformation_bindingFFFFFB(
				isApplicableMatch);
		if (result_pattern_PrimitiveTypesIsVoid_11_1_performtransformation_binding != null) {
			...
			TModule primitives = (TModule) result_pattern_PrimitiveTypesIsVoid_11_1_performtransformation_binding[1];
			TypeGraph typeGraph = (TypeGraph) result_pattern_PrimitiveTypesIsVoid_11_1_performtransformation_binding[2];
			TClass tPrimitiveClass = (TClass) result_pattern_PrimitiveTypesIsVoid_11_1_performtransformation_binding[3];
			Model eModel = (Model) result_pattern_PrimitiveTypesIsVoid_11_1_performtransformation_binding[4];

			Object[] result_pattern_PrimitiveTypesIsVoid_11_1_performtransformation_black = pattern_PrimitiveTypesIsVoid_11_1_performtransformation_blackBBBBBFBB(
			...
			if (result_pattern_PrimitiveTypesIsVoid_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_PrimitiveTypesIsVoid_11_1_performtransformation_black[5];
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_11_1_performtransformation_greenFFBB(
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_11_2_collecttranslatedelements_blackBBB(
			PrimitiveTypeVoid ePrimitiveType, TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		return new Object[] { ePrimitiveType, typeToTAbstractType, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypesIsVoid_11_2_collecttranslatedelements_greenFBBB(
			PrimitiveTypeVoid ePrimitiveType, TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_12_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypesIsVoid_12_2_corematch_blackFBBBFB(TModule primitives,
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypesIsVoid_12_3_findcontext_blackBBBBB(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
			Model eModel) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_12_3_findcontext_greenBBBBBFFFFFFFFF(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
			Model eModel) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge typeGraph__tPrimitiveClass____allTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_12_4_solveCSP_bindingFBBBBBBB(PrimitiveTypesIsVoid _this,
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_PrimitiveTypesIsVoid_12_4_solveCSP_binding = pattern_PrimitiveTypesIsVoid_12_4_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_black_nac_0B(
			TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_933548 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_black_nac_1BB(
		...
		for (TypeGraph __DEC_tPrimitiveClass_classes_988778 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_988778)) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_black_nac_2B(
			TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_631017 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_631017 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_631017)) {
				return new Object[] { tPrimitiveClass };
			}
		}
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_black_nac_3B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_allTypes_133481 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_allTypes_133481 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_blackFFFB(
							...
							if (typeGraph.getModules().contains(primitives)) {
								...
								if (tPrimitiveClass_tName.equals("void")) {
									...
									if (Boolean.valueOf(tPrimitiveClass_tLib).equals(Boolean.valueOf(true))) {
										String primitives_location = primitives.getLocation();
										if (primitives_location.equals("${JVM.PRIMITIVES}")) {
											if (pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_black_nac_0B(
													tPrimitiveClass) == null) {
												if (pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_black_nac_1BB(
														tPrimitiveClass, typeGraph) == null) {
													if (pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_black_nac_2B(
															tPrimitiveClass) == null) {
														if (pattern_PrimitiveTypesIsVoid_20_2_testcorematchandDECs_black_nac_3B(
																tPrimitiveClass) == null) {
	...
	public static final boolean pattern_PrimitiveTypesIsVoid_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			PrimitiveTypesIsVoid _this, Match match, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_bindingFFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_blackBBBBBBB(
			PrimitiveTypeVoid ePrimitiveType, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_binding = pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_bindingFFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_binding != null) {
			PrimitiveTypeVoid ePrimitiveType = (PrimitiveTypeVoid) result_pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_binding[0];
			TModule primitives = (TModule) result_pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_binding[1];
			TypeGraph typeGraph = (TypeGraph) result_pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_binding[2];
			TClass tPrimitiveClass = (TClass) result_pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_binding[3];
			Model eModel = (Model) result_pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_binding[4];

			Object[] result_pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_black = pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_blackBBBBBBB(
					ePrimitiveType, primitives, typeGraph, tPrimitiveClass, eModel, sourceMatch, targetMatch);
			if (result_pattern_PrimitiveTypesIsVoid_24_2_matchsrctrgcontext_black != null) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_24_3_solvecsp_bindingFBBBBBBBB(PrimitiveTypesIsVoid _this,
			PrimitiveTypeVoid ePrimitiveType, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
			Model eModel, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_24_3_solvecsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_PrimitiveTypesIsVoid_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
			PrimitiveTypesIsVoid _this, PrimitiveTypeVoid ePrimitiveType, TModule primitives, TypeGraph typeGraph,
			TClass tPrimitiveClass, Model eModel, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypesIsVoid_24_3_solvecsp_binding = pattern_PrimitiveTypesIsVoid_24_3_solvecsp_bindingFBBBBBBBB(
				_this, ePrimitiveType, primitives, typeGraph, tPrimitiveClass, eModel, sourceMatch, targetMatch);
		if (result_pattern_PrimitiveTypesIsVoid_24_3_solvecsp_binding != null) {
			CSP csp = (CSP) result_pattern_PrimitiveTypesIsVoid_24_3_solvecsp_binding[0];

			Object[] result_pattern_PrimitiveTypesIsVoid_24_3_solvecsp_black = pattern_PrimitiveTypesIsVoid_24_3_solvecsp_blackB(
					csp);
			if (result_pattern_PrimitiveTypesIsVoid_24_3_solvecsp_black != null) {
	...
	public static final boolean pattern_PrimitiveTypesIsVoid_24_4_checkCSP_expressionFB(CSP csp) {
		boolean _localVariable_0 = csp.check();
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Iterable<Object[]> pattern_PrimitiveTypesIsVoid_24_5_matchcorrcontext_blackFBBBB(
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_24_5_matchcorrcontext_greenBBBF(
			ModelToTypeGraph eModelToTypeGraph, Match sourceMatch, Match targetMatch) {
		CCMatch ccMatch = RuntimeFactory.eINSTANCE.createCCMatch();
		String ccMatch_ruleName_prime = "PrimitiveTypesIsVoid";
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_24_6_createcorrespondence_blackBBBBBB(
			PrimitiveTypeVoid ePrimitiveType, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_24_7_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
		return new Object[] { result, ccMatch };
	}

	public static final Object[] pattern_PrimitiveTypesIsVoid_24_7_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
	...
	public static final IsApplicableRuleResult pattern_PrimitiveTypesIsVoid_24_8_expressionFB(
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_black_nac_0B(
			TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_541736 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TPackage.class, "classes")) {
			return new Object[] { tPrimitiveClass };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_black_nac_1BB(TClass tPrimitiveClass,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tPrimitiveClass_classes_783297 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_783297)) {
				return new Object[] { tPrimitiveClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_black_nac_2B(
			TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_669294 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_669294 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_669294)) {
				return new Object[] { tPrimitiveClass };
			}
		}
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_black_nac_3B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_allTypes_388522 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_allTypes_388522 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_blackBBB(TModule primitives,
			...
			if (typeGraph.getClasses().contains(tPrimitiveClass)) {
				if (primitives.getContains().contains(tPrimitiveClass)) {
					if (typeGraph.getModules().contains(primitives)) {
						String primitives_location = primitives.getLocation();
						if (primitives_location.equals("${JVM.PRIMITIVES}")) {
							if (pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_black_nac_0B(
									tPrimitiveClass) == null) {
								if (pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_black_nac_1BB(tPrimitiveClass,
										typeGraph) == null) {
									if (pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_black_nac_2B(
											tPrimitiveClass) == null) {
										if (pattern_PrimitiveTypesIsVoid_28_1_matchtggpattern_black_nac_3B(
												tPrimitiveClass) == null) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypesIsVoid_29_2_isapplicablecore_blackFFFFFBB(
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_29_3_solveCSP_bindingFBBBBBBB(PrimitiveTypesIsVoid _this,
			IsApplicableMatch isApplicableMatch, ModelToTypeGraph eModelToTypeGraph, TModule primitives,
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_29_3_solveCSP_bindingAndBlackFBBBBBBB(
			PrimitiveTypesIsVoid _this, IsApplicableMatch isApplicableMatch, ModelToTypeGraph eModelToTypeGraph,
			TModule primitives, TypeGraph typeGraph, Model eModel, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_PrimitiveTypesIsVoid_29_3_solveCSP_binding = pattern_PrimitiveTypesIsVoid_29_3_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_29_5_checknacs_blackBBBB(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, Model eModel) {
		String primitives_location = primitives.getLocation();
		if (primitives_location.equals("${JVM.PRIMITIVES}")) {
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_29_6_perform_blackBBBBB(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, Model eModel,
	...
	public static final Object[] pattern_PrimitiveTypesIsVoid_29_6_perform_greenFBBFFBB(TModule primitives,
			TypeGraph typeGraph, Model eModel, ModelgeneratorRuleResult ruleResult) {
		PrimitiveTypeVoid ePrimitiveType = JavaFactory.eINSTANCE.createPrimitiveTypeVoid();
		TypeToTAbstractType typeToTAbstractType = PmFactory.eINSTANCE.createTypeToTAbstractType();
		TClass tPrimitiveClass = BasicFactory.eINSTANCE.createTClass();
