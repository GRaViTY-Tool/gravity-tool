...
public class MethodNameImpl extends AbstractRuleImpl implements MethodName {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MethodNameImpl.pattern_MethodName_1_1_performtransformation_greenFBFBB(mName, pg, csp);
		...
		Object[] result3_black = MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				mNameToTName, modelToPg, mName, mModel, tName, pg);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mNameToTName] = " + mNameToTName + ", " + "[modelToPg] = " + modelToPg + ", "
					+ "[mName] = " + mName + ", " + "[mModel] = " + mModel + ", " + "[tName] = " + tName + ", "
					+ "[pg] = " + pg + ".");
		}
		MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mNameToTName, mName,
				mModel, tName, pg);
		...
		// 
		// 
		MethodNameImpl.pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mNameToTName,
				modelToPg, mName, mModel, tName, pg);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mNameToTName, EObject modelToPg,
			EObject mName, EObject mModel, EObject tName, EObject pg) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MethodNameImpl.pattern_MethodName_11_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mNameToTName, mName,
				mModel, tName, pg);
		//nothing EMoflonEdge mNameToTName__tName____target = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mModel__mName____mMethodNames = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mNameToTName__mName____source = (EMoflonEdge) result3_green[8];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mNameToTName, EObject modelToPg,
			EObject mName, EObject mModel, EObject tName, EObject pg) {
		ruleresult.registerObject("mNameToTName", mNameToTName);
		ruleresult.registerObject("modelToPg", modelToPg);
		ruleresult.registerObject("mName", mName);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_15(EMoflonEdge _edge_methods) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_16(EMoflonEdge _edge_mMethodNames) {
		...
		for (Object[] result2_black : MethodNameImpl
			...
			if (MethodNameImpl.pattern_MethodName_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					MethodNameImpl.pattern_MethodName_29_6_perform_greenFFBFBBB(mModel, pg, ruleResult, csp);
					//nothing MMethodNameToTMethod mNameToTName = (MMethodNameToTMethod) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_NAME___IS_APPROPRIATE_BWD_EMOFLON_EDGE_15__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_15((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_NAME___IS_APPROPRIATE_FWD_EMOFLON_EDGE_16__EMOFLONEDGE:
	...
	public static final Object[] pattern_MethodName_1_1_performtransformation_greenFBFBB(MMethodName mName,
		...
		return new Object[] { mNameToTName, mName, tName, pg, csp };
	}
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject mNameToTName, EObject modelToPg, EObject mName, EObject mModel, EObject tName, EObject pg) {
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mNameToTName, EObject mName, EObject mModel, EObject tName,
			EObject pg) {
		...
		return new Object[] { ruleresult, mNameToTName, mName, mModel, tName, pg, mNameToTName__tName____target,
	...
	public static final void pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject mNameToTName, EObject modelToPg, EObject mName, EObject mModel,
			EObject tName, EObject pg) {
		_this.registerObjects_FWD(ruleresult, mNameToTName, modelToPg, mName, mModel, tName, pg);
	...
	public static final Object[] pattern_MethodName_2_3_findcontext_greenBBBBFFFF(ModelToTypeGraph modelToPg,
		...
		return new Object[] { modelToPg, mName, mModel, pg, isApplicableMatch, mModel__mName____mMethodNames,
	...
	public static final Object[] pattern_MethodName_11_1_performtransformation_greenFFBBB(MGravityModel mModel,
		...
		return new Object[] { mNameToTName, mName, mModel, tName, csp };
	}
	...
	public static final void pattern_MethodName_11_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject mNameToTName, EObject modelToPg, EObject mName, EObject mModel,
			EObject tName, EObject pg) {
		_this.registerObjects_BWD(ruleresult, mNameToTName, modelToPg, mName, mModel, tName, pg);
	...
	public static final Object[] pattern_MethodName_12_3_findcontext_greenBBBBFFFFF(ModelToTypeGraph modelToPg,
		...
		modelToPg__mModel____source.setName(modelToPg__mModel____source_name_prime);
		modelToPg__pg____target.setName(modelToPg__pg____target_name_prime);
		return new Object[] { modelToPg, mModel, tName, pg, isApplicableMatch, pg__tName____methods, tName__pg____model,
				modelToPg__mModel____source, modelToPg__pg____target };
	}
	...
	public static final Object[] pattern_MethodName_20_2_testcorematchandDECs_black_nac_0BB(TMethod tName,
			TypeGraph pg) {
		TypeGraph __DEC_tName_model_26194 = tName.getModel();
		if (__DEC_tName_model_26194 != null) {
			if (!pg.equals(__DEC_tName_model_26194)) {
	...
	public static final Object[] pattern_MethodName_28_1_matchtggpattern_black_nac_0BB(TMethod tName, TypeGraph pg) {
		TypeGraph __DEC_tName_model_80131 = tName.getModel();
		if (__DEC_tName_model_80131 != null) {
			if (!pg.equals(__DEC_tName_model_80131)) {
				return new Object[] { tName, pg };
			}
		}
	...
	public static final Object[] pattern_MethodName_29_6_perform_greenFFBFBBB(MGravityModel mModel, TypeGraph pg,
		...
		return new Object[] { mNameToTName, mName, mModel, tName, pg, ruleResult, csp };
	}
