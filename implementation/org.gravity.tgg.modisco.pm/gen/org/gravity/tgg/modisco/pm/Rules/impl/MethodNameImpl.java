...
public class MethodNameImpl extends AbstractRuleImpl implements MethodName {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				mName, tName, pg, mNameToTName, mModel, modelToPg);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[mName] = "
							+ mName + ", " + "[tName] = " + tName + ", " + "[pg] = " + pg + ", " + "[mNameToTName] = "
							+ mNameToTName + ", " + "[mModel] = " + mModel + ", " + "[modelToPg] = " + modelToPg + ".");
		}
		MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mName, tName, pg,
				mNameToTName, mModel);
		...
		// 
		// 
		MethodNameImpl.pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mName, tName, pg,
				mNameToTName, mModel, modelToPg);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodNameImpl.pattern_MethodName_2_2_corematch_blackBFBFB(mName, mModel,
				match)) {
			TypeGraph pg = (TypeGraph) result2_black[1];
			ModelToTypeGraph modelToPg = (ModelToTypeGraph) result2_black[3];
			// ForEach 
			for (Object[] result3_black : MethodNameImpl.pattern_MethodName_2_3_findcontext_blackBBBB(mName, pg, mModel,
					modelToPg)) {
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[pg] = " + pg + ", " + "[mModel] = " + mModel + ", " + "[modelToPg] = " + modelToPg
							+ ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MMethodName mName, TypeGraph pg,
			MGravityModel mModel, ModelToTypeGraph modelToPg) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mName, EObject tName, EObject pg,
			EObject mNameToTName, EObject mModel, EObject modelToPg) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		ModelToTypeGraph modelToPg = (ModelToTypeGraph) result1_bindingAndBlack[3];
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = MethodNameImpl.pattern_MethodName_11_1_performtransformation_greenFBFBB(tName, mModel,
				csp);
		...
		MethodNameImpl.pattern_MethodName_11_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mName, tName, pg,
				mNameToTName, mModel);
		//nothing EMoflonEdge pg__tName____methods = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge tName__pg____model = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mNameToTName__mName____source = (EMoflonEdge) result3_green[8];
		...
		// 
		// 
		MethodNameImpl.pattern_MethodName_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mName, tName, pg,
				mNameToTName, mModel, modelToPg);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mName, EObject tName, EObject pg,
			EObject mNameToTName, EObject mModel, EObject modelToPg) {
		ruleresult.registerObject("mName", mName);
		ruleresult.registerObject("tName", tName);
		ruleresult.registerObject("pg", pg);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_64(EMoflonEdge _edge_methods) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_66(EMoflonEdge _edge_mMethodNames) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodNameImpl.pattern_MethodName_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
				mName, tName, pg, mModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mName] = " + mName + ", " + "[tName] = " + tName + ", " + "[pg] = " + pg + ", " + "[mModel] = "
		...
		if (MethodNameImpl.pattern_MethodName_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodNameImpl.pattern_MethodName_24_5_matchcorrcontext_blackBBFBB(pg, mModel,
				...
				Object[] result6_black = MethodNameImpl.pattern_MethodName_24_6_createcorrespondence_blackBBBBB(mName,
						tName, pg, mModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mName] = " + mName + ", "
							+ "[tName] = " + tName + ", " + "[pg] = " + pg + ", " + "[mModel] = " + mModel + ", "
							+ "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MMethodName mName, TMethod tName, TypeGraph pg, MGravityModel mModel,
		...
		for (Object[] result2_black : MethodNameImpl
			...
			if (MethodNameImpl.pattern_MethodName_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					MethodNameImpl.pattern_MethodName_29_6_perform_greenFFBFBBB(pg, mModel, ruleResult, csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_NAME___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MMETHODNAME_TYPEGRAPH_MGRAVITYMODEL_MODELTOTYPEGRAPH:
		...
		case RulesPackage.METHOD_NAME___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHOD_TYPEGRAPH_MGRAVITYMODEL_MODELTOTYPEGRAPH:
		...
		case RulesPackage.METHOD_NAME___IS_APPROPRIATE_BWD_EMOFLON_EDGE_64__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_64((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_NAME___IS_APPROPRIATE_FWD_EMOFLON_EDGE_66__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_NAME___IS_APPLICABLE_SOLVE_CSP_CC__MMETHODNAME_TMETHOD_TYPEGRAPH_MGRAVITYMODEL_MATCH_MATCH:
			...
			if (tmpPg instanceof TypeGraph) {
				...
				if (tmpMModel instanceof MGravityModel) {
					...
					if (tmpModelToPg instanceof ModelToTypeGraph) {
						...
						return new Object[] { mName, pg, mModel, modelToPg, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodName_1_1_performtransformation_blackBBBBFBB(MMethodName mName,
			TypeGraph pg, MGravityModel mModel, ModelToTypeGraph modelToPg, MethodName _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mName, pg, mModel, modelToPg, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_1_1_performtransformation_bindingAndBlackFFFFFBB(MethodName _this,
		...
		if (result_pattern_MethodName_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodName_1_1_performtransformation_black = pattern_MethodName_1_1_performtransformation_blackBBBBFBB(
					mName, pg, mModel, modelToPg, _this, isApplicableMatch);
	...
	public static final Object[] pattern_MethodName_1_1_performtransformation_greenBFBFB(MMethodName mName,
		...
		return new Object[] { mName, tName, pg, mNameToTName, csp };
	}
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject mName, EObject tName, EObject pg, EObject mNameToTName, EObject mModel, EObject modelToPg) {
														...
														if (!mModel.equals(modelToPg)) {
															if (!modelToPg.equals(tName)) {
																if (!modelToPg.equals(pg)) {
																	return new Object[] { ruleresult, mName, tName, pg,
																			mNameToTName, mModel, modelToPg };
																}
															}
														}
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mName, EObject tName, EObject pg, EObject mNameToTName,
			EObject mModel) {
		...
		mModel__mName____mMethodNames.setName(mModel__mName____mMethodNames_name_prime);
		return new Object[] { ruleresult, mName, tName, pg, mNameToTName, mModel, pg__tName____methods,
				tName__pg____model, mNameToTName__mName____source, mNameToTName__tName____target,
	...
	public static final void pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject mName, EObject tName, EObject pg, EObject mNameToTName,
			EObject mModel, EObject modelToPg) {
		_this.registerObjects_FWD(ruleresult, mName, tName, pg, mNameToTName, mModel, modelToPg);
	...
	public static final Iterable<Object[]> pattern_MethodName_2_2_corematch_blackBFBFB(MMethodName mName,
		...
		for (ModelToTypeGraph modelToPg : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mModel,
			...
			if (pg != null) {
				_result.add(new Object[] { mName, pg, mModel, modelToPg, match });
			}
	...
	public static final Object[] pattern_MethodName_2_3_findcontext_greenBBBBFFFF(MMethodName mName, TypeGraph pg,
		...
		return new Object[] { mName, pg, mModel, modelToPg, isApplicableMatch, mModel__mName____mMethodNames,
	...
	public static final Object[] pattern_MethodName_2_4_solveCSP_bindingFBBBBBB(MethodName _this,
			IsApplicableMatch isApplicableMatch, MMethodName mName, TypeGraph pg, MGravityModel mModel,
			ModelToTypeGraph modelToPg) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mName, pg, mModel, modelToPg);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mName, pg, mModel, modelToPg };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_2_4_solveCSP_bindingAndBlackFBBBBBB(MethodName _this,
		...
		Object[] result_pattern_MethodName_2_4_solveCSP_binding = pattern_MethodName_2_4_solveCSP_bindingFBBBBBB(_this,
				isApplicableMatch, mName, pg, mModel, modelToPg);
		...
		if (tmpTName instanceof TMethod) {
			...
			if (tmpPg instanceof TypeGraph) {
				...
				if (tmpMModel instanceof MGravityModel) {
					...
					if (tmpModelToPg instanceof ModelToTypeGraph) {
						ModelToTypeGraph modelToPg = (ModelToTypeGraph) tmpModelToPg;
						return new Object[] { tName, pg, mModel, modelToPg, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodName_11_1_performtransformation_blackBBBBFBB(TMethod tName, TypeGraph pg,
			MGravityModel mModel, ModelToTypeGraph modelToPg, MethodName _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tName, pg, mModel, modelToPg, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_11_1_performtransformation_bindingAndBlackFFFFFBB(MethodName _this,
		...
		if (result_pattern_MethodName_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodName_11_1_performtransformation_black = pattern_MethodName_11_1_performtransformation_blackBBBBFBB(
					tName, pg, mModel, modelToPg, _this, isApplicableMatch);
	...
	public static final Object[] pattern_MethodName_11_1_performtransformation_greenFBFBB(TMethod tName,
		...
		return new Object[] { mName, tName, mNameToTName, mModel, csp };
	}
	...
	public static final void pattern_MethodName_11_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject mName, EObject tName, EObject pg, EObject mNameToTName,
			EObject mModel, EObject modelToPg) {
		_this.registerObjects_BWD(ruleresult, mName, tName, pg, mNameToTName, mModel, modelToPg);
	...
	public static final Iterable<Object[]> pattern_MethodName_12_2_corematch_blackBBFFB(TMethod tName, TypeGraph pg,
		...
		for (ModelToTypeGraph modelToPg : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(pg,
			...
			if (tmpMModel instanceof MGravityModel) {
				MGravityModel mModel = (MGravityModel) tmpMModel;
				_result.add(new Object[] { tName, pg, mModel, modelToPg, match });
			}
	...
	public static final Iterable<Object[]> pattern_MethodName_12_3_findcontext_blackBBBB(TMethod tName, TypeGraph pg,
		...
		if (pg.getMethods().contains(tName)) {
			if (mModel.equals(modelToPg.getSource())) {
				if (pg.equals(modelToPg.getTarget())) {
					_result.add(new Object[] { tName, pg, mModel, modelToPg });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_MethodName_12_3_findcontext_greenBBBBFFFFF(TMethod tName, TypeGraph pg,
		...
		modelToPg__mModel____source.setName(modelToPg__mModel____source_name_prime);
		modelToPg__pg____target.setName(modelToPg__pg____target_name_prime);
		return new Object[] { tName, pg, mModel, modelToPg, isApplicableMatch, pg__tName____methods, tName__pg____model,
				modelToPg__mModel____source, modelToPg__pg____target };
	}

	public static final Object[] pattern_MethodName_12_4_solveCSP_bindingFBBBBBB(MethodName _this,
			IsApplicableMatch isApplicableMatch, TMethod tName, TypeGraph pg, MGravityModel mModel,
			ModelToTypeGraph modelToPg) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tName, pg, mModel, modelToPg);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tName, pg, mModel, modelToPg };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_12_4_solveCSP_bindingAndBlackFBBBBBB(MethodName _this,
		...
		Object[] result_pattern_MethodName_12_4_solveCSP_binding = pattern_MethodName_12_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, tName, pg, mModel, modelToPg);
	...
	public static final Object[] pattern_MethodName_20_2_testcorematchandDECs_black_nac_0BB(TMethod tName,
			TypeGraph pg) {
		TypeGraph __DEC_tName_model_419268 = tName.getModel();
		if (__DEC_tName_model_419268 != null) {
			if (!pg.equals(__DEC_tName_model_419268)) {
		...
		if (tmpMName instanceof MMethodName) {
			...
			if (tmpTName instanceof TMethod) {
				...
				if (tmpPg instanceof TypeGraph) {
					...
					if (tmpMModel instanceof MGravityModel) {
						MGravityModel mModel = (MGravityModel) tmpMModel;
						return new Object[] { mName, tName, pg, mModel, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodName_24_2_matchsrctrgcontext_blackBBBBBB(MMethodName mName,
			TMethod tName, TypeGraph pg, MGravityModel mModel, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_MethodName_24_3_solvecsp_bindingFBBBBBBB(MethodName _this, MMethodName mName,
			TMethod tName, TypeGraph pg, MGravityModel mModel, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mName, tName, pg, mModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mName, tName, pg, mModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_24_3_solvecsp_bindingAndBlackFBBBBBBB(MethodName _this,
			MMethodName mName, TMethod tName, TypeGraph pg, MGravityModel mModel, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_MethodName_24_3_solvecsp_binding = pattern_MethodName_24_3_solvecsp_bindingFBBBBBBB(
				_this, mName, tName, pg, mModel, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodName_24_6_createcorrespondence_blackBBBBB(MMethodName mName,
			TMethod tName, TypeGraph pg, MGravityModel mModel, CCMatch ccMatch) {
		return new Object[] { mName, tName, pg, mModel, ccMatch };
	}
	...
	public static final Object[] pattern_MethodName_28_1_matchtggpattern_black_nac_0BB(TMethod tName, TypeGraph pg) {
		TypeGraph __DEC_tName_model_792619 = tName.getModel();
		if (__DEC_tName_model_792619 != null) {
			if (!pg.equals(__DEC_tName_model_792619)) {
				return new Object[] { tName, pg };
			}
		}
	...
	public static final Object[] pattern_MethodName_29_6_perform_greenFFBFBBB(TypeGraph pg, MGravityModel mModel,
		...
		return new Object[] { mName, tName, pg, mNameToTName, mModel, ruleResult, csp };
	}
