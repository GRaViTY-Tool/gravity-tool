...
public class MethodNameImpl extends AbstractRuleImpl implements MethodName {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				modelToPg, pg, mNameToTName, mName, mModel, tName);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[modelToPg] = " + modelToPg + ", " + "[pg] = " + pg + ", " + "[mNameToTName] = "
					+ mNameToTName + ", " + "[mName] = " + mName + ", " + "[mModel] = " + mModel + ", " + "[tName] = "
					+ tName + ".");
		}
		MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, pg, mNameToTName, mName,
				mModel, tName);
		...
		// 
		// 
		MethodNameImpl.pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, modelToPg, pg,
				mNameToTName, mName, mModel, tName);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject modelToPg, EObject pg, EObject mNameToTName,
			EObject mName, EObject mModel, EObject tName) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MethodNameImpl.pattern_MethodName_11_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, pg, mNameToTName, mName,
				mModel, tName);
		//nothing EMoflonEdge pg__tName____methods = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge tName__pg____model = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mNameToTName__mName____source = (EMoflonEdge) result3_green[8];
		...
		// 
		// 
		MethodNameImpl.pattern_MethodName_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, modelToPg, pg,
				mNameToTName, mName, mModel, tName);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject modelToPg, EObject pg, EObject mNameToTName,
			EObject mName, EObject mModel, EObject tName) {
		ruleresult.registerObject("modelToPg", modelToPg);
		ruleresult.registerObject("pg", pg);
		ruleresult.registerObject("mNameToTName", mNameToTName);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_149(EMoflonEdge _edge_methods) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_160(EMoflonEdge _edge_mMethodNames) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodNameImpl.pattern_MethodName_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
				pg, mName, mModel, tName, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[pg] = " + pg + ", " + "[mName] = " + mName + ", " + "[mModel] = " + mModel + ", " + "[tName] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeGraph pg, MMethodName mName, MGravityModel mModel, TMethod tName,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_NAME___IS_APPROPRIATE_BWD_EMOFLON_EDGE_149__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_149((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_NAME___IS_APPROPRIATE_FWD_EMOFLON_EDGE_160__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_NAME___IS_APPLICABLE_SOLVE_CSP_CC__TYPEGRAPH_MMETHODNAME_MGRAVITYMODEL_TMETHOD_MATCH_MATCH:
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject modelToPg, EObject pg, EObject mNameToTName, EObject mName, EObject mModel, EObject tName) {
														...
														if (!mModel.equals(mNameToTName)) {
															if (!mModel.equals(mName)) {
																if (!mModel.equals(tName)) {
																	return new Object[] { ruleresult, modelToPg, pg,
																			mNameToTName, mName, mModel, tName };
																}
															}
														}
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject pg, EObject mNameToTName, EObject mName, EObject mModel,
			EObject tName) {
		...
		return new Object[] { ruleresult, pg, mNameToTName, mName, mModel, tName, pg__tName____methods,
				tName__pg____model, mNameToTName__mName____source, mModel__mName____mMethodNames,
	...
	public static final void pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject modelToPg, EObject pg, EObject mNameToTName, EObject mName,
			EObject mModel, EObject tName) {
		_this.registerObjects_FWD(ruleresult, modelToPg, pg, mNameToTName, mName, mModel, tName);
	...
	public static final void pattern_MethodName_11_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject modelToPg, EObject pg, EObject mNameToTName, EObject mName,
			EObject mModel, EObject tName) {
		_this.registerObjects_BWD(ruleresult, modelToPg, pg, mNameToTName, mName, mModel, tName);
	...
	public static final Object[] pattern_MethodName_20_2_testcorematchandDECs_black_nac_0BB(TMethod tName,
			TypeGraph pg) {
		TypeGraph __DEC_tName_model_782858 = tName.getModel();
		if (__DEC_tName_model_782858 != null) {
			if (!pg.equals(__DEC_tName_model_782858)) {
		...
		if (tmpPg instanceof TypeGraph) {
			...
			if (tmpMName instanceof MMethodName) {
				...
				if (tmpMModel instanceof MGravityModel) {
					...
					if (tmpTName instanceof TMethod) {
						TMethod tName = (TMethod) tmpTName;
						return new Object[] { pg, mName, mModel, tName, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodName_24_2_matchsrctrgcontext_blackBBBBBB(TypeGraph pg, MMethodName mName,
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { pg, mName, mModel, tName, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_24_3_solvecsp_bindingFBBBBBBB(MethodName _this, TypeGraph pg,
			MMethodName mName, MGravityModel mModel, TMethod tName, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(pg, mName, mModel, tName, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, pg, mName, mModel, tName, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_24_3_solvecsp_bindingAndBlackFBBBBBBB(MethodName _this,
			TypeGraph pg, MMethodName mName, MGravityModel mModel, TMethod tName, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_MethodName_24_3_solvecsp_binding = pattern_MethodName_24_3_solvecsp_bindingFBBBBBBB(
				_this, pg, mName, mModel, tName, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodName_24_6_createcorrespondence_blackBBBBB(TypeGraph pg,
			MMethodName mName, MGravityModel mModel, TMethod tName, CCMatch ccMatch) {
		return new Object[] { pg, mName, mModel, tName, ccMatch };
	}
	...
	public static final Object[] pattern_MethodName_28_1_matchtggpattern_black_nac_0BB(TMethod tName, TypeGraph pg) {
		TypeGraph __DEC_tName_model_188853 = tName.getModel();
		if (__DEC_tName_model_188853 != null) {
			if (!pg.equals(__DEC_tName_model_188853)) {
				return new Object[] { tName, pg };
			}
		}
	...
	public static final Object[] pattern_MethodName_29_6_perform_greenBFFBFBB(TypeGraph pg, MGravityModel mModel,
		...
		return new Object[] { pg, mNameToTName, mName, mModel, tName, ruleResult, csp };
	}
