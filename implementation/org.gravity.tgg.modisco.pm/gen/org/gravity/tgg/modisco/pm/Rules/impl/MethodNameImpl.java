...
public class MethodNameImpl extends AbstractRuleImpl implements MethodName {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				tName, pg, modelToPg, mName, mModel, mNameToTName);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[tName] = "
							+ tName + ", " + "[pg] = " + pg + ", " + "[modelToPg] = " + modelToPg + ", " + "[mName] = "
							+ mName + ", " + "[mModel] = " + mModel + ", " + "[mNameToTName] = " + mNameToTName + ".");
		}
		MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tName, pg, mName, mModel,
				mNameToTName);
		...
		// 
		// 
		MethodNameImpl.pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tName, pg, modelToPg,
				mName, mModel, mNameToTName);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tName, EObject pg, EObject modelToPg,
			EObject mName, EObject mModel, EObject mNameToTName) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		// 
		// 
		MethodNameImpl.pattern_MethodName_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tName, pg,
				modelToPg, mName, mModel, mNameToTName);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tName, EObject pg, EObject modelToPg,
			EObject mName, EObject mModel, EObject mNameToTName) {
		ruleresult.registerObject("tName", tName);
		ruleresult.registerObject("pg", pg);
		ruleresult.registerObject("modelToPg", modelToPg);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_84(EMoflonEdge _edge_methods) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_86(EMoflonEdge _edge_mMethodNames) {
		...
		for (Object[] result2_black : MethodNameImpl
			...
			if (MethodNameImpl.pattern_MethodName_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					MethodNameImpl.pattern_MethodName_29_6_perform_greenFBFBFBB(pg, mModel, ruleResult, csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_NAME___IS_APPROPRIATE_BWD_EMOFLON_EDGE_84__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_84((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_NAME___IS_APPROPRIATE_FWD_EMOFLON_EDGE_86__EMOFLONEDGE:
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject tName, EObject pg, EObject modelToPg, EObject mName, EObject mModel, EObject mNameToTName) {
		if (!pg.equals(tName)) {
														...
														if (!mNameToTName.equals(tName)) {
															if (!mNameToTName.equals(pg)) {
																if (!mNameToTName.equals(modelToPg)) {
																	return new Object[] { ruleresult, tName, pg,
																			modelToPg, mName, mModel, mNameToTName };
																}
															}
														}
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tName, EObject pg, EObject mName, EObject mModel,
		...
		return new Object[] { ruleresult, tName, pg, mName, mModel, mNameToTName, pg__tName____methods,
				tName__pg____model, mModel__mName____mMethodNames, mNameToTName__tName____target,
	...
	public static final void pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject tName, EObject pg, EObject modelToPg, EObject mName, EObject mModel,
			EObject mNameToTName) {
		_this.registerObjects_FWD(ruleresult, tName, pg, modelToPg, mName, mModel, mNameToTName);
	...
	public static final Object[] pattern_MethodName_2_3_findcontext_greenBBBBFFFF(TypeGraph pg,
		...
		return new Object[] { pg, modelToPg, mName, mModel, isApplicableMatch, mModel__mName____mMethodNames,
	...
	public static final void pattern_MethodName_11_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject tName, EObject pg, EObject modelToPg, EObject mName, EObject mModel,
			EObject mNameToTName) {
		_this.registerObjects_BWD(ruleresult, tName, pg, modelToPg, mName, mModel, mNameToTName);
	...
	public static final Object[] pattern_MethodName_20_2_testcorematchandDECs_black_nac_0BB(TMethod tName,
			TypeGraph pg) {
		TypeGraph __DEC_tName_model_726305 = tName.getModel();
		if (__DEC_tName_model_726305 != null) {
			if (!pg.equals(__DEC_tName_model_726305)) {
	...
	public static final Object[] pattern_MethodName_28_1_matchtggpattern_black_nac_0BB(TMethod tName, TypeGraph pg) {
		TypeGraph __DEC_tName_model_809165 = tName.getModel();
		if (__DEC_tName_model_809165 != null) {
			if (!pg.equals(__DEC_tName_model_809165)) {
				return new Object[] { tName, pg };
			}
		}
	...
	public static final Object[] pattern_MethodName_29_6_perform_greenFBFBFBB(TypeGraph pg, MGravityModel mModel,
		...
		return new Object[] { tName, pg, mName, mModel, mNameToTName, ruleResult, csp };
	}
