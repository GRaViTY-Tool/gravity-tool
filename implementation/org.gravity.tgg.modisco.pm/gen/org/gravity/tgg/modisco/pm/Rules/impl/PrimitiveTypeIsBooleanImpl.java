...
public class PrimitiveTypeIsBooleanImpl extends AbstractRuleImpl implements PrimitiveTypeIsBoolean {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_greenBBFF(ePrimitiveType, typeGraph);
		...
		Object[] result3_black = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, ePrimitiveType,
		...
		PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult,
		...
		// 
		// 
		PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_1_5_registerobjects_expressionBBBBBBBB(this,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, ePrimitiveType,
						eModelToTypeGraph, typeGraph, typeToTAbstractType, tPrimitiveClass, eModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[ePrimitiveType] = " + ePrimitiveType + ", " + "[eModelToTypeGraph] = "
		...
		PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_11_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult,
				ePrimitiveType, typeGraph, typeToTAbstractType, tPrimitiveClass, eModel);
		//nothing EMoflonEdge eModel__ePrimitiveType____orphanTypes = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge typeGraph__tPrimitiveClass____classes = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge typeToTAbstractType__tPrimitiveClass____target = (EMoflonEdge) result3_green[8];
		...
		// 
		// 
		PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_11_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, ePrimitiveType, eModelToTypeGraph, typeGraph, typeToTAbstractType, tPrimitiveClass, eModel);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_61(EMoflonEdge _edge_classes) {
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_blackFFB(_edge_classes)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result3_bindingAndBlack = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, ePrimitiveType, typeGraph,
		...
		if (PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : PrimitiveTypeIsBooleanImpl
				...
				Object[] result6_black = PrimitiveTypeIsBooleanImpl
						.pattern_PrimitiveTypeIsBoolean_24_6_createcorrespondence_blackBBBBB(ePrimitiveType, typeGraph,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(PrimitiveTypeBoolean ePrimitiveType, TypeGraph typeGraph,
		...
		for (Object[] result2_black : PrimitiveTypeIsBooleanImpl
			...
			if (PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_29_6_perform_greenFBFFBB(typeGraph,
							eModel, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPROPRIATE_BWD_EMOFLON_EDGE_61__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_61((EMoflonEdge) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_64__EMOFLONEDGE:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPLICABLE_SOLVE_CSP_CC__PRIMITIVETYPEBOOLEAN_TYPEGRAPH_TCLASS_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((PrimitiveTypeBoolean) arguments.get(0), (TypeGraph) arguments.get(1),
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_greenBBFF(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_1_3_bookkeepingforedges_blackBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(
	...
	public static final void pattern_PrimitiveTypeIsBoolean_1_5_registerobjects_expressionBBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_11_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject ePrimitiveType, EObject eModelToTypeGraph, EObject typeGraph,
			EObject typeToTAbstractType, EObject tPrimitiveClass, EObject eModel) {
		if (!ePrimitiveType.equals(typeGraph)) {
			if (!ePrimitiveType.equals(typeToTAbstractType)) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_11_3_bookkeepingforedges_greenBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject ePrimitiveType, EObject typeGraph, EObject typeToTAbstractType,
			EObject tPrimitiveClass, EObject eModel) {
		EMoflonEdge eModel__ePrimitiveType____orphanTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge typeGraph__tPrimitiveClass____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_PrimitiveTypeIsBoolean_11_5_registerobjects_expressionBBBBBBBB(
			PrimitiveTypeIsBoolean _this, PerformRuleResult ruleresult, EObject ePrimitiveType,
			EObject eModelToTypeGraph, EObject typeGraph, EObject typeToTAbstractType, EObject tPrimitiveClass,
			EObject eModel) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_0B(
		...
		for (TPackage __DEC_tPrimitiveClass_classes_659185 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_1BB(
		...
		for (TypeGraph __DEC_tPrimitiveClass_classes_649419 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_649419)) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_2B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_ownedTypes_950915 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_ownedTypes_950915 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_3B(
			TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_165193 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_165193 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_165193)) {
				return new Object[] { tPrimitiveClass };
			}
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_bindingFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_blackBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding = pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_bindingFFFFBB(
		...
		if (result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding != null) {
			...
			TypeGraph typeGraph = (TypeGraph) result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding[1];
			TClass tPrimitiveClass = (TClass) result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding[2];
			Model eModel = (Model) result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding[3];

			Object[] result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_black = pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_blackBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_bindingFBBBBBBB(
			PrimitiveTypeIsBoolean _this, PrimitiveTypeBoolean ePrimitiveType, TypeGraph typeGraph,
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			PrimitiveTypeIsBoolean _this, PrimitiveTypeBoolean ePrimitiveType, TypeGraph typeGraph,
			TClass tPrimitiveClass, Model eModel, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_binding = pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_bindingFBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_6_createcorrespondence_blackBBBBB(
			PrimitiveTypeBoolean ePrimitiveType, TypeGraph typeGraph, TClass tPrimitiveClass, Model eModel,
			CCMatch ccMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_0B(
			TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_54056 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TPackage.class, "classes")) {
			return new Object[] { tPrimitiveClass };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_1BB(
			TClass tPrimitiveClass, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tPrimitiveClass_classes_9503 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_9503)) {
				return new Object[] { tPrimitiveClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_2B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_ownedTypes_435384 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_ownedTypes_435384 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_3B(
			TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_455401 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_455401 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_455401)) {
				return new Object[] { tPrimitiveClass };
			}
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_29_6_perform_greenFBFFBB(TypeGraph typeGraph,
