...
public class PrimitiveTypeIsBooleanImpl extends AbstractRuleImpl implements PrimitiveTypeIsBoolean {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_bindingAndBlackFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_greenBBBFF(ePrimitiveType, primitives,
						typeGraph);
		...
		Object[] result2_black = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_1_2_collecttranslatedelements_blackBBB(ePrimitiveType,
		...
		Object[] result2_green = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_1_2_collecttranslatedelements_greenFBBB(ePrimitiveType,
						typeToTAbstractType, tPrimitiveClass);
		...
		PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(
				ruleresult, ePrimitiveType, primitives, typeGraph, typeToTAbstractType, tPrimitiveClass, eModel);
		...
		PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, ePrimitiveType, eModelToTypeGraph, primitives, typeGraph, typeToTAbstractType,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : PrimitiveTypeIsBooleanImpl
			...
			for (Object[] result3_black : PrimitiveTypeIsBooleanImpl
					.pattern_PrimitiveTypeIsBoolean_2_3_findcontext_blackBBFBB(ePrimitiveType, eModelToTypeGraph,
							typeGraph, eModel)) {
				TModule primitives = (TModule) result3_black[2];
				Object[] result3_green = PrimitiveTypeIsBooleanImpl
						.pattern_PrimitiveTypeIsBoolean_2_3_findcontext_greenBBBBBFFFFF(ePrimitiveType,
				...
				Object[] result4_bindingAndBlack = PrimitiveTypeIsBooleanImpl
						.pattern_PrimitiveTypeIsBoolean_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
	...
	public boolean isAppropriate_BWD(Match match, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
		...
		Object[] result1_black = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_10_1_initialbindings_blackBBBBB(this, match, primitives, typeGraph,
						tPrimitiveClass);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, primitives, typeGraph,
						tPrimitiveClass);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[primitives] = " + primitives + ", " + "[typeGraph] = " + typeGraph
		...
		if (PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = PrimitiveTypeIsBooleanImpl
					.pattern_PrimitiveTypeIsBoolean_10_4_collectelementstobetranslated_blackBBBB(match, primitives,
			...
			PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_10_4_collectelementstobetranslated_greenBBBBFFFFF(
			...
			Object[] result5_black = PrimitiveTypeIsBooleanImpl
					.pattern_PrimitiveTypeIsBoolean_10_5_collectcontextelements_blackBBBB(match, primitives, typeGraph,
							tPrimitiveClass);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[primitives] = " + primitives + ", " + "[typeGraph] = " + typeGraph + ", "
			...
			PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_10_5_collectcontextelements_greenBBBF(match,
					primitives, typeGraph);
			//nothing EMoflonEdge typeGraph__primitives____modules = (EMoflonEdge) result5_green[3];

			// 
			PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_10_6_registerobjectstomatch_expressionBBBBB(this,
					match, primitives, typeGraph, tPrimitiveClass);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_bindingAndBlackFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_greenFFBB(tPrimitiveClass, eModel);
		...
		Object[] result2_black = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_11_2_collecttranslatedelements_blackBBB(ePrimitiveType,
						typeToTAbstractType, tPrimitiveClass);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ePrimitiveType] = "
					+ ePrimitiveType + ", " + "[typeToTAbstractType] = " + typeToTAbstractType + ", "
		...
		Object[] result2_green = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_11_2_collecttranslatedelements_greenFBBB(ePrimitiveType,
						typeToTAbstractType, tPrimitiveClass);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_12_2_corematch_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_12_2_corematch_blackFBBBFB(primitives, typeGraph, tPrimitiveClass,
						match)) {
			ModelToTypeGraph eModelToTypeGraph = (ModelToTypeGraph) result2_black[0];
			Model eModel = (Model) result2_black[4];
			// ForEach 
			for (Object[] result3_black : PrimitiveTypeIsBooleanImpl
					.pattern_PrimitiveTypeIsBoolean_12_3_findcontext_blackBBBBB(eModelToTypeGraph, primitives,
							typeGraph, tPrimitiveClass, eModel)) {
				Object[] result3_green = PrimitiveTypeIsBooleanImpl
						.pattern_PrimitiveTypeIsBoolean_12_3_findcontext_greenBBBBBFFFFFFFFF(eModelToTypeGraph,
				...
				Object[] result4_bindingAndBlack = PrimitiveTypeIsBooleanImpl
						.pattern_PrimitiveTypeIsBoolean_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_183(EMoflonEdge _edge_classes) {
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_blackFFFB(_edge_classes)) {
			...
			if (PrimitiveTypeIsBooleanImpl
					.pattern_PrimitiveTypeIsBoolean_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_199(EMoflonEdge _edge_orphanTypes) {
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_21_2_testcorematchandDECs_blackFFB(_edge_orphanTypes)) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(sourceMatch,
						targetMatch);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		PrimitiveTypeBoolean ePrimitiveType = (PrimitiveTypeBoolean) result2_bindingAndBlack[0];
		...
		Object[] result3_bindingAndBlack = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, ePrimitiveType, primitives,
		...
		// 
		if (PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : PrimitiveTypeIsBooleanImpl
					.pattern_PrimitiveTypeIsBoolean_24_5_matchcorrcontext_blackFBBBB(typeGraph, eModel, sourceMatch,
							targetMatch)) {
				ModelToTypeGraph eModelToTypeGraph = (ModelToTypeGraph) result5_black[0];
				Object[] result5_green = PrimitiveTypeIsBooleanImpl
						.pattern_PrimitiveTypeIsBoolean_24_5_matchcorrcontext_greenBBBF(eModelToTypeGraph, sourceMatch,
								targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[3];

				Object[] result6_black = PrimitiveTypeIsBooleanImpl
						.pattern_PrimitiveTypeIsBoolean_24_6_createcorrespondence_blackBBBBBB(ePrimitiveType,
								primitives, typeGraph, tPrimitiveClass, eModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ePrimitiveType] = "
				...
				PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_24_6_createcorrespondence_greenBFBB(
				...
				Object[] result7_black = PrimitiveTypeIsBooleanImpl
						.pattern_PrimitiveTypeIsBoolean_24_7_addtoreturnedresult_blackBB(result, ccMatch);
				if (result7_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[result] = " + result
							+ ", " + "[ccMatch] = " + ccMatch + ".");
				}
				PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_24_7_addtoreturnedresult_greenBB(result,
						ccMatch);
		...
		return PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_24_8_expressionFB(result);
	}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(PrimitiveTypeBoolean ePrimitiveType, TModule primitives, TypeGraph typeGraph,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(PrimitiveTypeBoolean ePrimitiveType, Model eModel) {// 
		Object[] result1_black = PrimitiveTypeIsBooleanImpl
	...
	public boolean checkDEC_BWD(TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {// 
		Object[] result1_black = PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_blackBBB(primitives, typeGraph, tPrimitiveClass);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypeIsBooleanImpl
				.pattern_PrimitiveTypeIsBoolean_29_2_isapplicablecore_blackFFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			Object[] result3_bindingAndBlack = PrimitiveTypeIsBooleanImpl
					.pattern_PrimitiveTypeIsBoolean_29_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
			...
			if (PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = PrimitiveTypeIsBooleanImpl
						.pattern_PrimitiveTypeIsBoolean_29_5_checknacs_blackBBBB(eModelToTypeGraph, primitives,
								typeGraph, eModel);
				if (result5_black != null) {

					Object[] result6_black = PrimitiveTypeIsBooleanImpl
							.pattern_PrimitiveTypeIsBoolean_29_6_perform_blackBBBBB(eModelToTypeGraph, primitives,
					...
					PrimitiveTypeIsBooleanImpl.pattern_PrimitiveTypeIsBoolean_29_6_perform_greenFBBFFBB(primitives,
							typeGraph, eModel, ruleResult);
					//nothing PrimitiveTypeBoolean ePrimitiveType = (PrimitiveTypeBoolean) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PRIMITIVETYPEBOOLEAN_MODELTOTYPEGRAPH_TMODULE_TYPEGRAPH_MODEL:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPROPRIATE_BWD__MATCH_TMODULE_TYPEGRAPH_TCLASS:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TMODULE_TYPEGRAPH_TCLASS:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TModule) arguments.get(1),
					(TypeGraph) arguments.get(2), (TClass) arguments.get(3));
			return null;
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TMODULE_TYPEGRAPH_TCLASS:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_TMODULE_TYPEGRAPH_TCLASS_MODEL:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPROPRIATE_BWD_EMOFLON_EDGE_183__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_183((EMoflonEdge) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_199__EMOFLONEDGE:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPLICABLE_SOLVE_CSP_CC__PRIMITIVETYPEBOOLEAN_TMODULE_TYPEGRAPH_TCLASS_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((PrimitiveTypeBoolean) arguments.get(0), (TModule) arguments.get(1),
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___CHECK_DEC_BWD__TMODULE_TYPEGRAPH_TCLASS:
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_TMODULE_TYPEGRAPH_MODEL_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_bindingFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_blackBBBBBFBB(
			PrimitiveTypeBoolean ePrimitiveType, ModelToTypeGraph eModelToTypeGraph, TModule primitives,
			TypeGraph typeGraph, Model eModel, PrimitiveTypeIsBoolean _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_bindingAndBlackFFFFFFBB(
			PrimitiveTypeIsBoolean _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_binding = pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_bindingFFFFFB(
				isApplicableMatch);
		if (result_pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_binding != null) {
			...
			TModule primitives = (TModule) result_pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_binding[2];
			TypeGraph typeGraph = (TypeGraph) result_pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_binding[3];
			Model eModel = (Model) result_pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_binding[4];

			Object[] result_pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_black = pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_blackBBBBBFBB(
			...
			if (result_pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_black[5];
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_1_1_performtransformation_greenBBBFF(
			PrimitiveTypeBoolean ePrimitiveType, TModule primitives, TypeGraph typeGraph) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_1_2_collecttranslatedelements_blackBBB(
			PrimitiveTypeBoolean ePrimitiveType, TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		return new Object[] { ePrimitiveType, typeToTAbstractType, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypeIsBoolean_1_2_collecttranslatedelements_greenFBBB(
			PrimitiveTypeBoolean ePrimitiveType, TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
	...
	public static final void pattern_PrimitiveTypeIsBoolean_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eModelToTypeGraph, EObject primitives, EObject typeGraph, EObject typeToTAbstractType,
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeIsBoolean_2_3_findcontext_blackBBFBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_2_3_findcontext_greenBBBBBFFFFF(
			PrimitiveTypeBoolean ePrimitiveType, ModelToTypeGraph eModelToTypeGraph, TModule primitives,
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_2_4_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_2_4_solveCSP_bindingAndBlackFBBBBBBB(
			PrimitiveTypeIsBoolean _this, IsApplicableMatch isApplicableMatch, PrimitiveTypeBoolean ePrimitiveType,
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, Model eModel) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_2_4_solveCSP_binding = pattern_PrimitiveTypeIsBoolean_2_4_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_10_1_initialbindings_blackBBBBB(
			PrimitiveTypeIsBoolean _this, Match match, TModule primitives, TypeGraph typeGraph,
			TClass tPrimitiveClass) {
		return new Object[] { _this, match, primitives, typeGraph, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypeIsBoolean_10_2_SolveCSP_bindingFBBBBB(
			PrimitiveTypeIsBoolean _this, Match match, TModule primitives, TypeGraph typeGraph,
			TClass tPrimitiveClass) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_10_2_SolveCSP_bindingAndBlackFBBBBB(
			PrimitiveTypeIsBoolean _this, Match match, TModule primitives, TypeGraph typeGraph,
			TClass tPrimitiveClass) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_10_2_SolveCSP_binding = pattern_PrimitiveTypeIsBoolean_10_2_SolveCSP_bindingFBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_10_4_collectelementstobetranslated_blackBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_10_4_collectelementstobetranslated_greenBBBBFFFFF(
			Match match, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
		EMoflonEdge typeGraph__tPrimitiveClass____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge typeGraph__tPrimitiveClass____allTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tPrimitiveClass__typeGraph____model = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_10_5_collectcontextelements_blackBBBB(Match match,
			TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass) {
		return new Object[] { match, primitives, typeGraph, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypeIsBoolean_10_5_collectcontextelements_greenBBBF(Match match,
	...
	public static final void pattern_PrimitiveTypeIsBoolean_10_6_registerobjectstomatch_expressionBBBBB(
			PrimitiveTypeIsBoolean _this, Match match, TModule primitives, TypeGraph typeGraph,
			TClass tPrimitiveClass) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_bindingFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_blackBBBBBFBB(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
			Model eModel, PrimitiveTypeIsBoolean _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_bindingAndBlackFFFFFFBB(
			PrimitiveTypeIsBoolean _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_binding = pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_bindingFFFFFB(
				isApplicableMatch);
		if (result_pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_binding != null) {
			...
			TModule primitives = (TModule) result_pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_binding[1];
			TypeGraph typeGraph = (TypeGraph) result_pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_binding[2];
			TClass tPrimitiveClass = (TClass) result_pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_binding[3];
			Model eModel = (Model) result_pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_binding[4];

			Object[] result_pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_black = pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_blackBBBBBFBB(
			...
			if (result_pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_black[5];
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_11_1_performtransformation_greenFFBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_11_2_collecttranslatedelements_blackBBB(
			PrimitiveTypeBoolean ePrimitiveType, TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		return new Object[] { ePrimitiveType, typeToTAbstractType, tPrimitiveClass };
	}

	public static final Object[] pattern_PrimitiveTypeIsBoolean_11_2_collecttranslatedelements_greenFBBB(
			PrimitiveTypeBoolean ePrimitiveType, TypeToTAbstractType typeToTAbstractType, TClass tPrimitiveClass) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_12_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeIsBoolean_12_2_corematch_blackFBBBFB(TModule primitives,
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeIsBoolean_12_3_findcontext_blackBBBBB(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
			Model eModel) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_12_3_findcontext_greenBBBBBFFFFFFFFF(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
			Model eModel) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge typeGraph__tPrimitiveClass____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_12_4_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_12_4_solveCSP_bindingAndBlackFBBBBBBB(
			PrimitiveTypeIsBoolean _this, IsApplicableMatch isApplicableMatch, ModelToTypeGraph eModelToTypeGraph,
			TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass, Model eModel) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_12_4_solveCSP_binding = pattern_PrimitiveTypeIsBoolean_12_4_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_0B(
			TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_377929 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_1BB(
		...
		for (TypeGraph __DEC_tPrimitiveClass_classes_409252 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_409252)) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_2B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_allTypes_505868 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_allTypes_505868 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_3B(
			TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_121190 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_121190 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_121190)) {
				return new Object[] { tPrimitiveClass };
			}
		}
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_blackFFFB(
							...
							if (typeGraph.getModules().contains(primitives)) {
								...
								if (tPrimitiveClass_tName.equals("boolean")) {
									...
									if (Boolean.valueOf(tPrimitiveClass_tLib).equals(Boolean.valueOf(true))) {
										String primitives_location = primitives.getLocation();
										if (primitives_location.equals("${JVM.PRIMITIVES}")) {
											if (pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_0B(
													tPrimitiveClass) == null) {
												if (pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_1BB(
	...
	public static final boolean pattern_PrimitiveTypeIsBoolean_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			PrimitiveTypeIsBoolean _this, Match match, TModule primitives, TypeGraph typeGraph,
			TClass tPrimitiveClass) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_bindingFFFFFBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_blackBBBBBBB(
			PrimitiveTypeBoolean ePrimitiveType, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding = pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_bindingFFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding != null) {
			PrimitiveTypeBoolean ePrimitiveType = (PrimitiveTypeBoolean) result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding[0];
			TModule primitives = (TModule) result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding[1];
			TypeGraph typeGraph = (TypeGraph) result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding[2];
			TClass tPrimitiveClass = (TClass) result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding[3];
			Model eModel = (Model) result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_binding[4];

			Object[] result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_black = pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_blackBBBBBBB(
					ePrimitiveType, primitives, typeGraph, tPrimitiveClass, eModel, sourceMatch, targetMatch);
			if (result_pattern_PrimitiveTypeIsBoolean_24_2_matchsrctrgcontext_black != null) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_bindingFBBBBBBBB(
			PrimitiveTypeIsBoolean _this, PrimitiveTypeBoolean ePrimitiveType, TModule primitives, TypeGraph typeGraph,
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
			PrimitiveTypeIsBoolean _this, PrimitiveTypeBoolean ePrimitiveType, TModule primitives, TypeGraph typeGraph,
			TClass tPrimitiveClass, Model eModel, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_binding = pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_bindingFBBBBBBBB(
				_this, ePrimitiveType, primitives, typeGraph, tPrimitiveClass, eModel, sourceMatch, targetMatch);
		if (result_pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_binding != null) {
			CSP csp = (CSP) result_pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_binding[0];

			Object[] result_pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_black = pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_blackB(
					csp);
			if (result_pattern_PrimitiveTypeIsBoolean_24_3_solvecsp_black != null) {
	...
	public static final boolean pattern_PrimitiveTypeIsBoolean_24_4_checkCSP_expressionFB(CSP csp) {
		boolean _localVariable_0 = csp.check();
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Iterable<Object[]> pattern_PrimitiveTypeIsBoolean_24_5_matchcorrcontext_blackFBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_5_matchcorrcontext_greenBBBF(
			ModelToTypeGraph eModelToTypeGraph, Match sourceMatch, Match targetMatch) {
		CCMatch ccMatch = RuntimeFactory.eINSTANCE.createCCMatch();
		String ccMatch_ruleName_prime = "PrimitiveTypeIsBoolean";
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_6_createcorrespondence_blackBBBBBB(
			PrimitiveTypeBoolean ePrimitiveType, TModule primitives, TypeGraph typeGraph, TClass tPrimitiveClass,
			Model eModel, CCMatch ccMatch) {
		return new Object[] { ePrimitiveType, primitives, typeGraph, tPrimitiveClass, eModel, ccMatch };
	}

	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_6_createcorrespondence_greenBFBB(
			PrimitiveTypeBoolean ePrimitiveType, TClass tPrimitiveClass, CCMatch ccMatch) {
		TypeToTAbstractType typeToTAbstractType = PmFactory.eINSTANCE.createTypeToTAbstractType();
		typeToTAbstractType.setSource(ePrimitiveType);
		typeToTAbstractType.setTarget(tPrimitiveClass);
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_7_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
		return new Object[] { result, ccMatch };
	}

	public static final Object[] pattern_PrimitiveTypeIsBoolean_24_7_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
	...
	public static final IsApplicableRuleResult pattern_PrimitiveTypeIsBoolean_24_8_expressionFB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_0B(
			TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_443216 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TPackage.class, "classes")) {
			return new Object[] { tPrimitiveClass };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_1BB(
			TClass tPrimitiveClass, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tPrimitiveClass_classes_670330 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_670330)) {
				return new Object[] { tPrimitiveClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_2B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_allTypes_661763 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_allTypes_661763 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_3B(
			TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_307517 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_307517 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_307517)) {
				return new Object[] { tPrimitiveClass };
			}
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_blackBBB(TModule primitives,
			...
			if (typeGraph.getAllTypes().contains(tPrimitiveClass)) {
				if (primitives.getContains().contains(tPrimitiveClass)) {
					if (typeGraph.getModules().contains(primitives)) {
						String primitives_location = primitives.getLocation();
						if (primitives_location.equals("${JVM.PRIMITIVES}")) {
							if (pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_0B(
									tPrimitiveClass) == null) {
								if (pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_1BB(tPrimitiveClass,
										typeGraph) == null) {
									if (pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_2B(
											tPrimitiveClass) == null) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_29_2_isapplicablecore_black_nac_3BB(
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeIsBoolean_29_2_isapplicablecore_blackFFFFFBB(
						...
						if (eModel != null) {
							if (pattern_PrimitiveTypeIsBoolean_29_2_isapplicablecore_black_nac_0BB(ruleResult,
								...
								if (pattern_PrimitiveTypeIsBoolean_29_2_isapplicablecore_black_nac_1BB(ruleResult,
										typeGraph) == null) {
									if (pattern_PrimitiveTypeIsBoolean_29_2_isapplicablecore_black_nac_3BB(ruleResult,
											eModel) == null) {
										for (TModule primitives : typeGraph.getModules()) {
											String primitives_location = primitives.getLocation();
											if (primitives_location.equals("${JVM.PRIMITIVES}")) {
												if (pattern_PrimitiveTypeIsBoolean_29_2_isapplicablecore_black_nac_2BB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_29_3_solveCSP_bindingFBBBBBBB(
			PrimitiveTypeIsBoolean _this, IsApplicableMatch isApplicableMatch, ModelToTypeGraph eModelToTypeGraph,
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_29_3_solveCSP_bindingAndBlackFBBBBBBB(
			PrimitiveTypeIsBoolean _this, IsApplicableMatch isApplicableMatch, ModelToTypeGraph eModelToTypeGraph,
			TModule primitives, TypeGraph typeGraph, Model eModel, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_PrimitiveTypeIsBoolean_29_3_solveCSP_binding = pattern_PrimitiveTypeIsBoolean_29_3_solveCSP_bindingFBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_29_5_checknacs_blackBBBB(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, Model eModel) {
		String primitives_location = primitives.getLocation();
		if (primitives_location.equals("${JVM.PRIMITIVES}")) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_29_6_perform_blackBBBBB(
			ModelToTypeGraph eModelToTypeGraph, TModule primitives, TypeGraph typeGraph, Model eModel,
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_29_6_perform_greenFBBFFBB(TModule primitives,
