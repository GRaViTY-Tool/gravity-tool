...
public class ConstructorDefinitionImpl extends AbstractRuleImpl implements ConstructorDefinition {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_68(EMoflonEdge _edge_definitions) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_71(EMoflonEdge _edge_mDefinitions) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CONSTRUCTOR_DEFINITION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_68__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_68((EMoflonEdge) arguments.get(0));
		case RulesPackage.CONSTRUCTOR_DEFINITION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_71__EMOFLONEDGE:
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_509277 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_509277 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_509277)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_509277)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tDefinition_signature_150052 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_150052 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_150052)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_533257 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_533257 != null) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_3B(
			TMethodDefinition tDefinition) {
		TModule __DEC_tDefinition_contains_354887 = tDefinition.getModule();
		if (__DEC_tDefinition_contains_354887 != null) {
			return new Object[] { tDefinition };
		}
	...
	public static final Object[] pattern_ConstructorDefinition_21_2_testcorematchandDECs_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_277879 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_277879 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_277879)) {
	...
	public static final Object[] pattern_ConstructorDefinition_27_1_matchtggpattern_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_240703 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_240703 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_240703)) {
				return new Object[] { mDefinition, mSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_831415 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_831415 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_831415)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_831415)) {
					return new Object[] { tAnnotation, tMethodSignature, tDefinition };
				}
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_1BB(
			TMethodDefinition tDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tDefinition_signature_193731 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_193731 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_193731)) {
				return new Object[] { tDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_12142 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_12142 != null) {
			return new Object[] { tDefinition };
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_3B(
			TMethodDefinition tDefinition) {
		TModule __DEC_tDefinition_contains_686850 = tDefinition.getModule();
		if (__DEC_tDefinition_contains_686850 != null) {
			return new Object[] { tDefinition };
		}
