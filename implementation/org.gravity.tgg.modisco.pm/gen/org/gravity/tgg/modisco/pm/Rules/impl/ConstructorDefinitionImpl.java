...
public class ConstructorDefinitionImpl extends AbstractRuleImpl implements ConstructorDefinition {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CONSTRUCTOR_DEFINITION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_57__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_57((EMoflonEdge) arguments.get(0));
		case RulesPackage.CONSTRUCTOR_DEFINITION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_58__EMOFLONEDGE:
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_540060 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_540060 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_540060)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_540060)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tDefinition_signature_688083 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_688083 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_688083)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_725983 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_725983 != null) {
	...
	public static final Object[] pattern_ConstructorDefinition_21_2_testcorematchandDECs_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_823348 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_823348 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_823348)) {
	...
	public static final Object[] pattern_ConstructorDefinition_27_1_matchtggpattern_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_401205 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_401205 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_401205)) {
				return new Object[] { mDefinition, mSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_120003 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_120003 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_120003)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_120003)) {
					return new Object[] { tAnnotation, tMethodSignature, tDefinition };
				}
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_1BB(
			TMethodDefinition tDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tDefinition_signature_665978 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_665978 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_665978)) {
				return new Object[] { tDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_233714 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_233714 != null) {
			return new Object[] { tDefinition };
		}
