...
public class ConstructorDefinitionImpl extends AbstractRuleImpl implements ConstructorDefinition {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_76(EMoflonEdge _edge_definitions) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_79(EMoflonEdge _edge_mDefinitions) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CONSTRUCTOR_DEFINITION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_76__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_76((EMoflonEdge) arguments.get(0));
		case RulesPackage.CONSTRUCTOR_DEFINITION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_79__EMOFLONEDGE:
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_865879 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_865879 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_865879)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_865879)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tDefinition_signature_419613 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_419613 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_419613)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_781464 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_781464 != null) {
	...
	public static final Object[] pattern_ConstructorDefinition_21_2_testcorematchandDECs_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_93603 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_93603 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_93603)) {
	...
	public static final Object[] pattern_ConstructorDefinition_27_1_matchtggpattern_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_477847 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_477847 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_477847)) {
				return new Object[] { mDefinition, mSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_553000 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_553000 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_553000)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_553000)) {
					return new Object[] { tAnnotation, tMethodSignature, tDefinition };
				}
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_1BB(
			TMethodDefinition tDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tDefinition_signature_711953 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_711953 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_711953)) {
				return new Object[] { tDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_717210 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_717210 != null) {
			return new Object[] { tDefinition };
		}
