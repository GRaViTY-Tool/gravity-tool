...
public class ConstructorDefinitionImpl extends AbstractRuleImpl implements ConstructorDefinition {
		...
		switch (operationID) {
			...
			case RulesPackage.CONSTRUCTOR_DEFINITION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_MCONSTRUCTORDEFINITION_MMETHODSIGNATURE:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(TMethodSignature) arguments.get(1), (MSignatureToTSignature) arguments.get(2),
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_683325 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_683325 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_683325)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_683325)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tDefinition_signature_73221 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_73221 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_73221)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_515423 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_515423 != null) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_3B(
			TMethodDefinition tDefinition) {
		TModule __DEC_tDefinition_contains_235531 = tDefinition.getModule();
		if (__DEC_tDefinition_contains_235531 != null) {
			return new Object[] { tDefinition };
		}
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_4BB(
			TMethodDefinition tDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tDefinition_definitions_261232 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_261232 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_definitions_261232)) {
				return new Object[] { tDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_21_2_testcorematchandDECs_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_591407 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_591407 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_591407)) {
	...
	public static final Object[] pattern_ConstructorDefinition_27_1_matchtggpattern_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_433971 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_433971 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_433971)) {
				return new Object[] { mDefinition, mSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_880962 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_880962 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_880962)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_880962)) {
					return new Object[] { tAnnotation, tMethodSignature, tDefinition };
				}
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_1BB(
			TMethodDefinition tDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tDefinition_signature_305297 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_305297 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_305297)) {
				return new Object[] { tDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_55226 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_55226 != null) {
			return new Object[] { tDefinition };
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_3B(
			TMethodDefinition tDefinition) {
		TModule __DEC_tDefinition_contains_895115 = tDefinition.getModule();
		if (__DEC_tDefinition_contains_895115 != null) {
			return new Object[] { tDefinition };
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_4BB(
			TMethodDefinition tDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tDefinition_definitions_484440 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_484440 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_definitions_484440)) {
				return new Object[] { tDefinition, tMethodSignature };
			}
		}
