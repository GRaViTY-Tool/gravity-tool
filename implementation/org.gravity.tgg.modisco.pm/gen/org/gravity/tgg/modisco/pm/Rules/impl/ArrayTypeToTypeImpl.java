...
public class ArrayTypeToTypeImpl extends AbstractRuleImpl implements ArrayTypeToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, tModel, modelToTypeGraph, mArrayType, arrayTypeToTArrayClass, mTypeAccess, mType,
				tAbstractType, mTypeToTType, mModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tModel] = " + tModel + ", " + "[modelToTypeGraph] = " + modelToTypeGraph + ", "
					+ "[mArrayType] = " + mArrayType + ", " + "[arrayTypeToTArrayClass] = " + arrayTypeToTArrayClass
		...
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(ruleresult, mArrayType,
				arrayTypeToTArrayClass, mTypeAccess, mType, tAbstractType, mModel);
		...
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, tModel,
				modelToTypeGraph, mArrayType, arrayTypeToTArrayClass, mTypeAccess, mType, tAbstractType, mTypeToTType,
				mModel);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_2_2_corematch_blackFFBBBFFBB(mArrayType, mTypeAccess, mType, mModel, match)) {
			...
			for (Object[] result3_black : ArrayTypeToTypeImpl.pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(
					tModel, modelToTypeGraph, mArrayType, mTypeAccess, mType, tAbstractType, mTypeToTType, mModel)) {
				Object[] result3_green = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(tModel, modelToTypeGraph,
								mArrayType, mTypeAccess, mType, tAbstractType, mTypeToTType, mModel);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[8];
				//nothing EMoflonEdge modelToTypeGraph__tModel____target = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mArrayType__mTypeAccess____elementType = (EMoflonEdge) result3_green[10];
				//nothing EMoflonEdge tModel__tAbstractType____ownedTypes = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge tAbstractType__tModel____model = (EMoflonEdge) result3_green[12];
				...
				Object[] result4_bindingAndBlack = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
								tModel, modelToTypeGraph, mArrayType, mTypeAccess, mType, tAbstractType, mTypeToTType,
								mModel);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeGraph tModel,
			ModelToTypeGraph modelToTypeGraph, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, Model mModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tModel, EObject modelToTypeGraph,
			EObject mArrayType, EObject arrayTypeToTArrayClass, EObject mTypeAccess, EObject mType,
			EObject tAbstractType, EObject mTypeToTType, EObject mModel) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_86(EMoflonEdge _edge_elementType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tModel, mArrayType, mTypeAccess,
						mType, tAbstractType, mModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tModel] = " + tModel + ", " + "[mArrayType] = " + mArrayType + ", " + "[mTypeAccess] = "
					+ mTypeAccess + ", " + "[mType] = " + mType + ", " + "[tAbstractType] = " + tAbstractType + ", "
		...
		if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBFBBFBBB(tModel, mType, tAbstractType, mModel,
				...
				Object[] result6_black = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(tModel, mArrayType, mTypeAccess,
								mType, tAbstractType, mModel, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeGraph tModel, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType,
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
			...
			Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, tModel,
							modelToTypeGraph, mType, tAbstractType, mTypeToTType, mModel, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tModel] = " + tModel + ", "
			...
			if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(tModel,
						modelToTypeGraph, mType, tAbstractType, mTypeToTType, mModel);
				if (result5_black != null) {

					Object[] result6_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(
							tModel, modelToTypeGraph, mType, tAbstractType, mTypeToTType, mModel, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tModel] = " + tModel
								+ ", " + "[modelToTypeGraph] = " + modelToTypeGraph + ", " + "[mType] = " + mType + ", "
								+ "[tAbstractType] = " + tAbstractType + ", " + "[mTypeToTType] = " + mTypeToTType
					...
					ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_greenFFFBBBB(mType, tAbstractType, mModel,
							ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeGraph tModel,
			ModelToTypeGraph modelToTypeGraph, Type mType, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, Model mModel, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEGRAPH_MODELTOTYPEGRAPH_ARRAYTYPE_TYPEACCESS_TYPE_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_MODEL:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TypeGraph) arguments.get(1),
					(ModelToTypeGraph) arguments.get(2), (ArrayType) arguments.get(3), (TypeAccess) arguments.get(4),
					(Type) arguments.get(5), (TAbstractType) arguments.get(6), (TypeToTAbstractType) arguments.get(7),
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_86__EMOFLONEDGE:
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TYPEGRAPH_ARRAYTYPE_TYPEACCESS_TYPE_TABSTRACTTYPE_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeGraph) arguments.get(0), (ArrayType) arguments.get(1),
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_MODELTOTYPEGRAPH_TYPE_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_MODEL_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TypeGraph) arguments.get(1),
					(ModelToTypeGraph) arguments.get(2), (Type) arguments.get(3), (TAbstractType) arguments.get(4),
							...
							if (tmpTAbstractType instanceof TAbstractType) {
								...
								if (tmpMTypeToTType instanceof TypeToTAbstractType) {
									...
									if (tmpMModel instanceof Model) {
										...
										return new Object[] { tModel, modelToTypeGraph, mArrayType, mTypeAccess, mType,
												tAbstractType, mTypeToTType, mModel, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_blackBBBBBBBBFBB(TypeGraph tModel,
			ModelToTypeGraph modelToTypeGraph, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, Model mModel, ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch) {
		if (!mArrayType.equals(mType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { tModel, modelToTypeGraph, mArrayType, mTypeAccess, mType, tAbstractType,
							mTypeToTType, mModel, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tModel, EObject modelToTypeGraph, EObject mArrayType,
			EObject arrayTypeToTArrayClass, EObject mTypeAccess, EObject mType, EObject tAbstractType,
			EObject mTypeToTType, EObject mModel) {
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			...
			EObject mType, EObject tAbstractType, EObject mModel) {
		EMoflonEdge mArrayType__mTypeAccess____elementType = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		mModel__mArrayType____orphanTypes.setName(mModel__mArrayType____orphanTypes_name_prime);
		return new Object[] { ruleresult, mArrayType, arrayTypeToTArrayClass, mTypeAccess, mType, tAbstractType, mModel,
	...
	public static final void pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(ArrayTypeToType _this,
			...
			EObject arrayTypeToTArrayClass, EObject mTypeAccess, EObject mType, EObject tAbstractType,
			EObject mTypeToTType, EObject mModel) {
		_this.registerObjects_FWD(ruleresult, tModel, modelToTypeGraph, mArrayType, arrayTypeToTArrayClass, mTypeAccess,
				mType, tAbstractType, mTypeToTType, mModel);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_2_corematch_blackFFBBBFFBB(ArrayType mArrayType,
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAbstractType != null) {
					for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tModel != null) {
							_result.add(new Object[] { tModel, modelToTypeGraph, mArrayType, mTypeAccess, mType,
									tAbstractType, mTypeToTType, mModel, match });
						}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(TypeGraph tModel,
			ModelToTypeGraph modelToTypeGraph, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, Model mModel) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mArrayType.equals(mType)) {
								...
								if (tAbstractType.equals(mTypeToTType.getTarget())) {
									if (mModel.getOrphanTypes().contains(mArrayType)) {
										if (mModel.equals(modelToTypeGraph.getSource())) {
											_result.add(new Object[] { tModel, modelToTypeGraph, mArrayType,
													mTypeAccess, mType, tAbstractType, mTypeToTType, mModel });
										}
									}
								}
							}
	...
	public static final Object[] pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(TypeGraph tModel,
		...
		return new Object[] { tModel, modelToTypeGraph, mArrayType, mTypeAccess, mType, tAbstractType, mTypeToTType,
				mModel, isApplicableMatch, modelToTypeGraph__tModel____target, mArrayType__mTypeAccess____elementType,
				tModel__tAbstractType____ownedTypes, tAbstractType__tModel____model, mTypeAccess__mType____type,
				mType__mTypeAccess____usagesInTypeAccess, mTypeToTType__mType____source,
				mTypeToTType__tAbstractType____target, mModel__mArrayType____orphanTypes,
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, TypeGraph tModel, ModelToTypeGraph modelToTypeGraph,
			ArrayType mArrayType, TypeAccess mTypeAccess, Type mType, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, Model mModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tModel, modelToTypeGraph, mArrayType,
				mTypeAccess, mType, tAbstractType, mTypeToTType, mModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tModel, modelToTypeGraph, mArrayType, mTypeAccess,
					mType, tAbstractType, mTypeToTType, mModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_2_4_solveCSP_binding = pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, tModel, modelToTypeGraph, mArrayType, mTypeAccess, mType, tAbstractType,
				mTypeToTType, mModel);
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_285525 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_285525)) {
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_mTypeAccess_type_765986 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_258648 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_799497 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_280566 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_280566)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_5B(
			TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_361668 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_715276 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_715276)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_343660 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_16362 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpMTypeAccess instanceof TypeAccess) {
					...
					if (tmpMType instanceof Type) {
						...
						if (tmpTAbstractType instanceof TAbstractType) {
							...
							if (tmpMModel instanceof Model) {
								Model mModel = (Model) tmpMModel;
								return new Object[] { tModel, mArrayType, mTypeAccess, mType, tAbstractType, mModel,
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(TypeGraph tModel,
			ArrayType mArrayType, TypeAccess mTypeAccess, Type mType, TAbstractType tAbstractType, Model mModel,
			Match sourceMatch, Match targetMatch) {
		if (!mArrayType.equals(mType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { tModel, mArrayType, mTypeAccess, mType, tAbstractType, mModel, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_black = pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(
					tModel, mArrayType, mTypeAccess, mType, tAbstractType, mModel, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(ArrayTypeToType _this,
			TypeGraph tModel, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType, TAbstractType tAbstractType,
			Model mModel, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tModel, mArrayType, mTypeAccess, mType, tAbstractType,
				mModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tModel, mArrayType, mTypeAccess, mType, tAbstractType, mModel,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_21_3_solvecsp_binding = pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, tModel, mArrayType, mTypeAccess, mType, tAbstractType, mModel, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBFBBFBBB(TypeGraph tModel,
			...
			for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mModel.equals(modelToTypeGraph.getSource())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mType, TypeToTAbstractType.class, "source")) {
						if (tAbstractType.equals(mTypeToTType.getTarget())) {
							_result.add(new Object[] { tModel, modelToTypeGraph, mType, tAbstractType, mTypeToTType,
									mModel, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(TypeGraph tModel,
			...
			CCMatch ccMatch) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { tModel, mArrayType, mTypeAccess, mType, tAbstractType, mModel, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_610747 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_610747)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_1B(TypeAccess mTypeAccess) {
		for (Annotation __DEC_mTypeAccess_type_97097 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, Annotation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_2B(TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_590702 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_3B(TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_729077 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_146357 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_146357)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_5B(TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_787212 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_94803 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_94803)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_7B(TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_657449 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_8B(TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_399064 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, TypeGraph tModel, ModelToTypeGraph modelToTypeGraph, Type mType,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, Model mModel,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tModel, modelToTypeGraph, mType,
				tAbstractType, mTypeToTType, mModel, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tModel, modelToTypeGraph, mType, tAbstractType,
					mTypeToTType, mModel, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_26_3_solveCSP_binding = pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tModel, modelToTypeGraph, mType, tAbstractType, mTypeToTType, mModel,
				ruleResult);
	...
	public static final Object[] pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(TypeGraph tModel,
			ModelToTypeGraph modelToTypeGraph, Type mType, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, Model mModel) {
		return new Object[] { tModel, modelToTypeGraph, mType, tAbstractType, mTypeToTType, mModel };
	}

	public static final Object[] pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(TypeGraph tModel,
			ModelToTypeGraph modelToTypeGraph, Type mType, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, Model mModel, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tModel, modelToTypeGraph, mType, tAbstractType, mTypeToTType, mModel, ruleResult };
	}

	public static final Object[] pattern_ArrayTypeToType_26_6_perform_greenFFFBBBB(Type mType,
		...
		return new Object[] { mArrayType, arrayTypeToTArrayClass, mTypeAccess, mType, tAbstractType, mModel,
				ruleResult };
	}
