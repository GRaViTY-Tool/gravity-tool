...
public class ArrayTypeToTypeImpl extends AbstractRuleImpl implements ArrayTypeToType {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType,
			Model mModel) {

		Object[] result1_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_0_1_initialbindings_blackBBBBBB(this,
				match, mArrayType, mTypeAccess, mType, mModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[mArrayType] = " + mArrayType + ", " + "[mTypeAccess] = "
					+ mTypeAccess + ", " + "[mType] = " + mType + ", " + "[mModel] = " + mModel + ".");
		}

		Object[] result2_bindingAndBlack = ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, mArrayType, mTypeAccess,
						mType, mModel);
		...
		if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_0_4_collectelementstobetranslated_blackBBBBB(match, mArrayType,
							mTypeAccess, mType, mModel);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[mArrayType] = " + mArrayType + ", " + "[mTypeAccess] = " + mTypeAccess + ", " + "[mType] = "
						+ mType + ", " + "[mModel] = " + mModel + ".");
			}
			ArrayTypeToTypeImpl.pattern_ArrayTypeToType_0_4_collectelementstobetranslated_greenBBBBBFFFF(match,
					mArrayType, mTypeAccess, mType, mModel);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mArrayType, tModel, arrayTypeToTArrayClass, mTypeToTType, mTypeAccess, modelToTypeGraph,
				tAbstractType, mType, mModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tAbstractType] = " + tAbstractType + ", " + "[mType] = " + mType + ", " + "[mModel] = " + mModel
					+ ".");
		}
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(ruleresult, mArrayType,
				arrayTypeToTArrayClass, mTypeAccess, tAbstractType, mType, mModel);
		//nothing EMoflonEdge arrayTypeToTArrayClass__mArrayType____source = (EMoflonEdge) result3_green[7];
		...
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mArrayType, tModel, arrayTypeToTArrayClass, mTypeToTType, mTypeAccess, modelToTypeGraph, tAbstractType,
				mType, mModel);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_2_2_corematch_blackBFFBFFBBB(mArrayType, mTypeAccess, mType, mModel, match)) {
			...
			for (Object[] result3_black : ArrayTypeToTypeImpl.pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(
					mArrayType, tModel, mTypeToTType, mTypeAccess, modelToTypeGraph, tAbstractType, mType, mModel)) {
				Object[] result3_green = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(mArrayType, tModel,
								mTypeToTType, mTypeAccess, modelToTypeGraph, tAbstractType, mType, mModel);
				...
				Object[] result4_bindingAndBlack = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
								mArrayType, tModel, mTypeToTType, mTypeAccess, modelToTypeGraph, tAbstractType, mType,
								mModel);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mArrayType] = " + mArrayType
							+ ", " + "[tModel] = " + tModel + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
							+ "[mTypeAccess] = " + mTypeAccess + ", " + "[modelToTypeGraph] = " + modelToTypeGraph
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType,
			Model mModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ArrayType mArrayType, TypeGraph tModel,
			TypeToTAbstractType mTypeToTType, TypeAccess mTypeAccess, ModelToTypeGraph modelToTypeGraph,
			TAbstractType tAbstractType, Type mType, Model mModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mArrayType, EObject tModel,
			EObject arrayTypeToTArrayClass, EObject mTypeToTType, EObject mTypeAccess, EObject modelToTypeGraph,
			EObject tAbstractType, EObject mType, EObject mModel) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_21(EMoflonEdge _edge_elementType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mArrayType, tModel, mTypeAccess,
						tAbstractType, mType, mModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mArrayType] = " + mArrayType + ", " + "[tModel] = " + tModel + ", " + "[mTypeAccess] = "
					+ mTypeAccess + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mType] = " + mType + ", "
		...
		if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBFFBBBBB(tModel, tAbstractType, mType, mModel,
				...
				Object[] result6_black = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(mArrayType, tModel, mTypeAccess,
								tAbstractType, mType, mModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mArrayType] = "
							+ mArrayType + ", " + "[tModel] = " + tModel + ", " + "[mTypeAccess] = " + mTypeAccess
							+ ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mType] = " + mType + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ArrayType mArrayType, TypeGraph tModel, TypeAccess mTypeAccess,
			TAbstractType tAbstractType, Type mType, Model mModel, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(ArrayType mArrayType, TypeAccess mTypeAccess, Type mType, Model mModel) {// 
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
			...
			Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, tModel,
							mTypeToTType, modelToTypeGraph, tAbstractType, mType, mModel, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tModel] = " + tModel + ", "
						+ "[mTypeToTType] = " + mTypeToTType + ", " + "[modelToTypeGraph] = " + modelToTypeGraph + ", "
						+ "[tAbstractType] = " + tAbstractType + ", " + "[mType] = " + mType + ", " + "[mModel] = "
			...
			if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(tModel,
						mTypeToTType, modelToTypeGraph, tAbstractType, mType, mModel);
				if (result5_black != null) {

					Object[] result6_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(
							tModel, mTypeToTType, modelToTypeGraph, tAbstractType, mType, mModel, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tModel] = " + tModel
								+ ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[modelToTypeGraph] = "
								+ modelToTypeGraph + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mType] = "
								+ mType + ", " + "[mModel] = " + mModel + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_greenFFFBBBB(tAbstractType, mType, mModel,
							ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeGraph tModel,
			TypeToTAbstractType mTypeToTType, ModelToTypeGraph modelToTypeGraph, TAbstractType tAbstractType,
			Type mType, Model mModel, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_FWD__MATCH_ARRAYTYPE_TYPEACCESS_TYPE_MODEL:
				return isAppropriate_FWD((Match) arguments.get(0), (ArrayType) arguments.get(1),
						(TypeAccess) arguments.get(2), (Type) arguments.get(3), (Model) arguments.get(4));
			...
			case RulesPackage.ARRAY_TYPE_TO_TYPE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_ARRAYTYPE_TYPEACCESS_TYPE_MODEL:
				registerObjectsToMatch_FWD((Match) arguments.get(0), (ArrayType) arguments.get(1),
						(TypeAccess) arguments.get(2), (Type) arguments.get(3), (Model) arguments.get(4));
				return null;
			case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_ARRAYTYPE_TYPEACCESS_TYPE_MODEL:
			...
			case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ARRAYTYPE_TYPEGRAPH_TYPETOTABSTRACTTYPE_TYPEACCESS_MODELTOTYPEGRAPH_TABSTRACTTYPE_TYPE_MODEL:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ArrayType) arguments.get(1),
						...
						(TypeAccess) arguments.get(4), (ModelToTypeGraph) arguments.get(5),
						(TAbstractType) arguments.get(6), (Type) arguments.get(7), (Model) arguments.get(8));
			...
			case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_21__EMOFLONEDGE:
			...
			case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__ARRAYTYPE_TYPEGRAPH_TYPEACCESS_TABSTRACTTYPE_TYPE_MODEL_MATCH_MATCH:
				return isApplicable_solveCsp_CC((ArrayType) arguments.get(0), (TypeGraph) arguments.get(1),
						(TypeAccess) arguments.get(2), (TAbstractType) arguments.get(3), (Type) arguments.get(4),
			...
			case RulesPackage.ARRAY_TYPE_TO_TYPE___CHECK_DEC_FWD__ARRAYTYPE_TYPEACCESS_TYPE_MODEL:
				return checkDEC_FWD((ArrayType) arguments.get(0), (TypeAccess) arguments.get(1),
						(Type) arguments.get(2), (Model) arguments.get(3));
			...
			case RulesPackage.ARRAY_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_TYPETOTABSTRACTTYPE_MODELTOTYPEGRAPH_TABSTRACTTYPE_TYPE_MODEL_MODELGENERATORRULERESULT:
				return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TypeGraph) arguments.get(1),
						...
						(TAbstractType) arguments.get(4), (Type) arguments.get(5), (Model) arguments.get(6),
	...
	public static final Object[] pattern_ArrayTypeToType_0_1_initialbindings_blackBBBBBB(ArrayTypeToType _this,
			Match match, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType, Model mModel) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { _this, match, mArrayType, mTypeAccess, mType, mModel };
		}
		return null;
	}

	public static final Object[] pattern_ArrayTypeToType_0_2_SolveCSP_bindingFBBBBBB(ArrayTypeToType _this, Match match,
			ArrayType mArrayType, TypeAccess mTypeAccess, Type mType, Model mModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, mArrayType, mTypeAccess, mType, mModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, mArrayType, mTypeAccess, mType, mModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_0_2_SolveCSP_binding = pattern_ArrayTypeToType_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, mArrayType, mTypeAccess, mType, mModel);
	...
	public static final Object[] pattern_ArrayTypeToType_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			ArrayType mArrayType, TypeAccess mTypeAccess, Type mType, Model mModel) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { match, mArrayType, mTypeAccess, mType, mModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_0_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		return new Object[] { match, mArrayType, mTypeAccess, mType, mModel, mArrayType__mTypeAccess____elementType,
	...
	public static final void pattern_ArrayTypeToType_0_6_registerobjectstomatch_expressionBBBBBB(ArrayTypeToType _this,
			Match match, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType, Model mModel) {
		_this.registerObjectsToMatch_FWD(match, mArrayType, mTypeAccess, mType, mModel);
							...
							if (tmpTAbstractType instanceof TAbstractType) {
								...
								if (tmpMType instanceof Type) {
									...
									if (tmpMModel instanceof Model) {
										...
										return new Object[] { mArrayType, tModel, mTypeToTType, mTypeAccess,
												modelToTypeGraph, tAbstractType, mType, mModel, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_blackBBBBBBBBFBB(
			ArrayType mArrayType, TypeGraph tModel, TypeToTAbstractType mTypeToTType, TypeAccess mTypeAccess,
			ModelToTypeGraph modelToTypeGraph, TAbstractType tAbstractType, Type mType, Model mModel,
			ArrayTypeToType _this, IsApplicableMatch isApplicableMatch) {
		if (!mArrayType.equals(mType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { mArrayType, tModel, mTypeToTType, mTypeAccess, modelToTypeGraph,
							tAbstractType, mType, mModel, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_1_1_performtransformation_binding != null) {
			...
			Type mType = (Type) result_pattern_ArrayTypeToType_1_1_performtransformation_binding[6];
			...
			if (result_pattern_ArrayTypeToType_1_1_performtransformation_black != null) {
				...
				return new Object[] { mArrayType, tModel, mTypeToTType, mTypeAccess, modelToTypeGraph, tAbstractType,
						mType, mModel, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mArrayType, EObject tModel, EObject arrayTypeToTArrayClass,
			EObject mTypeToTType, EObject mTypeAccess, EObject modelToTypeGraph, EObject tAbstractType, EObject mType,
			EObject mModel) {
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject mArrayType, EObject arrayTypeToTArrayClass, EObject mTypeAccess,
			EObject tAbstractType, EObject mType, EObject mModel) {
		...
		mType__mTypeAccess____usagesInTypeAccess.setName(mType__mTypeAccess____usagesInTypeAccess_name_prime);
		mModel__mArrayType____orphanTypes.setName(mModel__mArrayType____orphanTypes_name_prime);
		return new Object[] { ruleresult, mArrayType, arrayTypeToTArrayClass, mTypeAccess, tAbstractType, mType, mModel,
				arrayTypeToTArrayClass__mArrayType____source, mArrayType__mTypeAccess____elementType,
				arrayTypeToTArrayClass__tAbstractType____target, mTypeAccess__mType____type,
	...
	public static final void pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(ArrayTypeToType _this,
			...
			EObject mTypeToTType, EObject mTypeAccess, EObject modelToTypeGraph, EObject tAbstractType, EObject mType,
			EObject mModel) {
		_this.registerObjects_FWD(ruleresult, mArrayType, tModel, arrayTypeToTArrayClass, mTypeToTType, mTypeAccess,
				modelToTypeGraph, tAbstractType, mType, mModel);
		...
		if (tmpMArrayType instanceof ArrayType) {
			...
			if (tmpMTypeAccess instanceof TypeAccess) {
				...
				if (tmpMType instanceof Type) {
					...
					if (tmpMModel instanceof Model) {
						Model mModel = (Model) tmpMModel;
						return new Object[] { mArrayType, mTypeAccess, mType, mModel, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_2_corematch_blackBFFBFFBBB(ArrayType mArrayType,
			TypeAccess mTypeAccess, Type mType, Model mModel, Match match) {
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAbstractType != null) {
					for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tModel != null) {
							_result.add(new Object[] { mArrayType, tModel, mTypeToTType, mTypeAccess, modelToTypeGraph,
									tAbstractType, mType, mModel, match });
						}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(ArrayType mArrayType,
			TypeGraph tModel, TypeToTAbstractType mTypeToTType, TypeAccess mTypeAccess,
			ModelToTypeGraph modelToTypeGraph, TAbstractType tAbstractType, Type mType, Model mModel) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mArrayType.equals(mType)) {
								...
								if (mModel.getOrphanTypes().contains(mArrayType)) {
									if (mModel.equals(modelToTypeGraph.getSource())) {
										if (tModel.equals(modelToTypeGraph.getTarget())) {
											_result.add(new Object[] { mArrayType, tModel, mTypeToTType, mTypeAccess,
													modelToTypeGraph, tAbstractType, mType, mModel });
										}
									}
								}
	...
	public static final Object[] pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(ArrayType mArrayType,
		...
		return new Object[] { mArrayType, tModel, mTypeToTType, mTypeAccess, modelToTypeGraph, tAbstractType, mType,
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, ArrayType mArrayType, TypeGraph tModel,
			TypeToTAbstractType mTypeToTType, TypeAccess mTypeAccess, ModelToTypeGraph modelToTypeGraph,
			TAbstractType tAbstractType, Type mType, Model mModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mArrayType, tModel, mTypeToTType,
				mTypeAccess, modelToTypeGraph, tAbstractType, mType, mModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mArrayType, tModel, mTypeToTType, mTypeAccess,
					modelToTypeGraph, tAbstractType, mType, mModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_2_4_solveCSP_binding = pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mArrayType, tModel, mTypeToTType, mTypeAccess, modelToTypeGraph,
				tAbstractType, mType, mModel);
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_614173 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_614173)) {
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_mTypeAccess_type_255578 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_112035 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_908179 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_311312 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_311312)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_5B(
			TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_695122 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_977906 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_977906)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_116939 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_809781 : org.moflon.core.utilities.eMoflonEMFUtil
														...
														if (pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_4BB(
															...
															if (pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_6BB(
																...
																for (Model mModel : org.moflon.core.utilities.eMoflonEMFUtil
																	...
																	_result.add(new Object[] { mArrayType, mTypeAccess,
																			mType, mModel, _edge_elementType });
																}
															}
														}
													}
	...
	public static final boolean pattern_ArrayTypeToType_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ArrayTypeToType _this, Match match, ArrayType mArrayType, TypeAccess mTypeAccess, Type mType,
			Model mModel) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, mArrayType, mTypeAccess, mType, mModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpMTypeAccess instanceof TypeAccess) {
					...
					if (tmpTAbstractType instanceof TAbstractType) {
						...
						if (tmpMType instanceof Type) {
							...
							if (tmpMModel instanceof Model) {
								Model mModel = (Model) tmpMModel;
								return new Object[] { mArrayType, tModel, mTypeAccess, tAbstractType, mType, mModel,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(ArrayType mArrayType,
			TypeGraph tModel, TypeAccess mTypeAccess, TAbstractType tAbstractType, Type mType, Model mModel,
			Match sourceMatch, Match targetMatch) {
		if (!mArrayType.equals(mType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { mArrayType, tModel, mTypeAccess, tAbstractType, mType, mModel, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_black = pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(
					mArrayType, tModel, mTypeAccess, tAbstractType, mType, mModel, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(ArrayTypeToType _this,
			ArrayType mArrayType, TypeGraph tModel, TypeAccess mTypeAccess, TAbstractType tAbstractType, Type mType,
			Model mModel, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mArrayType, tModel, mTypeAccess, tAbstractType, mType,
				mModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mArrayType, tModel, mTypeAccess, tAbstractType, mType, mModel,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_21_3_solvecsp_binding = pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, mArrayType, tModel, mTypeAccess, tAbstractType, mType, mModel, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBFFBBBBB(TypeGraph tModel,
			TAbstractType tAbstractType, Type mType, Model mModel, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mType.equals(mTypeToTType.getSource())) {
					for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mModel, ModelToTypeGraph.class, "source")) {
						if (tModel.equals(modelToTypeGraph.getTarget())) {
							_result.add(new Object[] { tModel, mTypeToTType, modelToTypeGraph, tAbstractType, mType,
									mModel, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(ArrayType mArrayType,
			...
			CCMatch ccMatch) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { mArrayType, tModel, mTypeAccess, tAbstractType, mType, mModel, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_871585 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_871585)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_1B(TypeAccess mTypeAccess) {
		for (Annotation __DEC_mTypeAccess_type_286668 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, Annotation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_2B(TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_807111 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_3B(TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_878800 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_315737 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_315737)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_5B(TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_167530 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_558336 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_558336)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_7B(TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_119036 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_8B(TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_388605 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_blackBBBB(ArrayType mArrayType,
			TypeAccess mTypeAccess, Type mType, Model mModel) {
		if (!mArrayType.equals(mType)) {
			if (mTypeAccess.equals(mArrayType.getElementType())) {
				if (mType.equals(mTypeAccess.getType())) {
					if (mModel.getOrphanTypes().contains(mArrayType)) {
												...
												if (pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_6BB(
													...
													if (pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_7B(
														...
														if (pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_8B(
																mTypeAccess) == null) {
															return new Object[] { mArrayType, mTypeAccess, mType,
																	mModel };
														}
													}
												}
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, TypeGraph tModel, TypeToTAbstractType mTypeToTType,
			ModelToTypeGraph modelToTypeGraph, TAbstractType tAbstractType, Type mType, Model mModel,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tModel, mTypeToTType,
				modelToTypeGraph, tAbstractType, mType, mModel, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tModel, mTypeToTType, modelToTypeGraph, tAbstractType,
					mType, mModel, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_26_3_solveCSP_binding = pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tModel, mTypeToTType, modelToTypeGraph, tAbstractType, mType, mModel,
				ruleResult);
		if (result_pattern_ArrayTypeToType_26_3_solveCSP_binding != null) {
			...
			if (result_pattern_ArrayTypeToType_26_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tModel, mTypeToTType, modelToTypeGraph,
						tAbstractType, mType, mModel, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(TypeGraph tModel,
			TypeToTAbstractType mTypeToTType, ModelToTypeGraph modelToTypeGraph, TAbstractType tAbstractType,
			Type mType, Model mModel) {
		return new Object[] { tModel, mTypeToTType, modelToTypeGraph, tAbstractType, mType, mModel };
	}

	public static final Object[] pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(TypeGraph tModel,
			TypeToTAbstractType mTypeToTType, ModelToTypeGraph modelToTypeGraph, TAbstractType tAbstractType,
			Type mType, Model mModel, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tModel, mTypeToTType, modelToTypeGraph, tAbstractType, mType, mModel, ruleResult };
	}

	public static final Object[] pattern_ArrayTypeToType_26_6_perform_greenFFFBBBB(TAbstractType tAbstractType,
			Type mType, Model mModel, ModelgeneratorRuleResult ruleResult) {
		...
		return new Object[] { mArrayType, arrayTypeToTArrayClass, mTypeAccess, tAbstractType, mType, mModel,
				ruleResult };
	}
