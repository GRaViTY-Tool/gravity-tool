...
public class ArrayTypeToTypeImpl extends AbstractRuleImpl implements ArrayTypeToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mTypeAccess, mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType, mArrayType,
				arrayTypeToTArrayClass, mModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mTypeAccess] = " + mTypeAccess + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
					+ "[mType] = " + mType + ", " + "[modelToTypeGraph] = " + modelToTypeGraph + ", " + "[tModel] = "
					+ tModel + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mArrayType] = " + mArrayType
					+ ", " + "[arrayTypeToTArrayClass] = " + arrayTypeToTArrayClass + ", " + "[mModel] = " + mModel
					+ ".");
		}
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(ruleresult, mTypeAccess,
				mType, tAbstractType, mArrayType, arrayTypeToTArrayClass, mModel);
		...
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mTypeAccess, mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType, mArrayType,
				arrayTypeToTArrayClass, mModel);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_2_2_corematch_blackBFBFFFBBB(mTypeAccess, mType, mArrayType, mModel, match)) {
			...
			for (Object[] result3_black : ArrayTypeToTypeImpl.pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(
					mTypeAccess, mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType, mArrayType, mModel)) {
				Object[] result3_green = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(mTypeAccess, mTypeToTType,
								mType, modelToTypeGraph, tModel, tAbstractType, mArrayType, mModel);
				...
				//nothing EMoflonEdge tModel__tAbstractType____allTypes = (EMoflonEdge) result3_green[12];
				//nothing EMoflonEdge tAbstractType__tModel____model = (EMoflonEdge) result3_green[13];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeAccess mTypeAccess,
			TypeToTAbstractType mTypeToTType, Type mType, ModelToTypeGraph modelToTypeGraph, TypeGraph tModel,
			TAbstractType tAbstractType, ArrayType mArrayType, Model mModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mTypeAccess, EObject mTypeToTType,
			EObject mType, EObject modelToTypeGraph, EObject tModel, EObject tAbstractType, EObject mArrayType,
			EObject arrayTypeToTArrayClass, EObject mModel) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_TypeGraph_10(TypeGraph tModel) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_183(EMoflonEdge _edge_type) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mTypeAccess, mType, tModel,
						tAbstractType, mArrayType, mModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mTypeAccess] = " + mTypeAccess + ", " + "[mType] = " + mType + ", " + "[tModel] = " + tModel
					+ ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mArrayType] = " + mArrayType + ", "
		...
		if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_21_5_matchcorrcontext_blackFBFBBBBB(mType, tModel, tAbstractType, mModel,
				...
				Object[] result6_black = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(mTypeAccess, mType, tModel,
								tAbstractType, mArrayType, mModel, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess mTypeAccess, Type mType, TypeGraph tModel,
			TAbstractType tAbstractType, ArrayType mArrayType, Model mModel, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
			...
			Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType, mModel, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(
						mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType, mModel);
				if (result5_black != null) {
					...
					ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_greenFBBFFBB(mType, tAbstractType, mModel,
							ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			Type mType, ModelToTypeGraph modelToTypeGraph, TypeGraph tModel, TAbstractType tAbstractType, Model mModel,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEACCESS_TYPETOTABSTRACTTYPE_TYPE_MODELTOTYPEGRAPH_TYPEGRAPH_TABSTRACTTYPE_ARRAYTYPE_MODEL:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TypeAccess) arguments.get(1),
					...
					(ModelToTypeGraph) arguments.get(4), (TypeGraph) arguments.get(5), (TAbstractType) arguments.get(6),
					(ArrayType) arguments.get(7), (Model) arguments.get(8));
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_BWD_TYPE_GRAPH_10__TYPEGRAPH:
			return isAppropriate_BWD_TypeGraph_10((TypeGraph) arguments.get(0));
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_183__EMOFLONEDGE:
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_TYPE_TYPEGRAPH_TABSTRACTTYPE_ARRAYTYPE_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeAccess) arguments.get(0), (Type) arguments.get(1),
					(TypeGraph) arguments.get(2), (TAbstractType) arguments.get(3), (ArrayType) arguments.get(4),
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TYPE_MODELTOTYPEGRAPH_TYPEGRAPH_TABSTRACTTYPE_MODEL_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (Type) arguments.get(2),
					(ModelToTypeGraph) arguments.get(3), (TypeGraph) arguments.get(4), (TAbstractType) arguments.get(5),
	...
	public static final Object[] pattern_ArrayTypeToType_0_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		return new Object[] { match, mTypeAccess, mType, mArrayType, mModel, mTypeAccess__mType____type,
							...
							if (tmpTAbstractType instanceof TAbstractType) {
								...
								if (tmpMArrayType instanceof ArrayType) {
									...
									if (tmpMModel instanceof Model) {
										...
										return new Object[] { mTypeAccess, mTypeToTType, mType, modelToTypeGraph,
												tModel, tAbstractType, mArrayType, mModel, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_blackBBBBBBBBFBB(
			TypeAccess mTypeAccess, TypeToTAbstractType mTypeToTType, Type mType, ModelToTypeGraph modelToTypeGraph,
			TypeGraph tModel, TAbstractType tAbstractType, ArrayType mArrayType, Model mModel, ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch) {
		if (!mArrayType.equals(mType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { mTypeAccess, mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType,
							mArrayType, mModel, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_1_1_performtransformation_binding != null) {
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_ArrayTypeToType_1_1_performtransformation_binding[1];
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mTypeAccess, EObject mTypeToTType, EObject mType,
			EObject modelToTypeGraph, EObject tModel, EObject tAbstractType, EObject mArrayType,
			EObject arrayTypeToTArrayClass, EObject mModel) {
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject mTypeAccess, EObject mType, EObject tAbstractType, EObject mArrayType,
			EObject arrayTypeToTArrayClass, EObject mModel) {
		EMoflonEdge mTypeAccess__mType____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mType__mTypeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mArrayType__mTypeAccess____elementType = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		mModel__mArrayType____orphanTypes.setName(mModel__mArrayType____orphanTypes_name_prime);
		return new Object[] { ruleresult, mTypeAccess, mType, tAbstractType, mArrayType, arrayTypeToTArrayClass, mModel,
				mTypeAccess__mType____type, mType__mTypeAccess____usagesInTypeAccess,
				mArrayType__mTypeAccess____elementType, arrayTypeToTArrayClass__tAbstractType____target,
				arrayTypeToTArrayClass__mArrayType____source, mModel__mArrayType____orphanTypes };
	}
	...
	public static final void pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(ArrayTypeToType _this,
			...
			EObject modelToTypeGraph, EObject tModel, EObject tAbstractType, EObject mArrayType,
			EObject arrayTypeToTArrayClass, EObject mModel) {
		_this.registerObjects_FWD(ruleresult, mTypeAccess, mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType,
				mArrayType, arrayTypeToTArrayClass, mModel);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_2_corematch_blackBFBFFFBBB(TypeAccess mTypeAccess,
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAbstractType != null) {
					for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tModel != null) {
							_result.add(new Object[] { mTypeAccess, mTypeToTType, mType, modelToTypeGraph, tModel,
									tAbstractType, mArrayType, mModel, match });
						}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(TypeAccess mTypeAccess,
			TypeToTAbstractType mTypeToTType, Type mType, ModelToTypeGraph modelToTypeGraph, TypeGraph tModel,
			TAbstractType tAbstractType, ArrayType mArrayType, Model mModel) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mArrayType.equals(mType)) {
								...
								if (mModel.equals(modelToTypeGraph.getSource())) {
									if (mModel.getOrphanTypes().contains(mArrayType)) {
										if (tAbstractType.equals(mTypeToTType.getTarget())) {
											_result.add(new Object[] { mTypeAccess, mTypeToTType, mType,
													modelToTypeGraph, tModel, tAbstractType, mArrayType, mModel });
										}
									}
								}
							}
	...
	public static final Object[] pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(
			TypeAccess mTypeAccess, TypeToTAbstractType mTypeToTType, Type mType, ModelToTypeGraph modelToTypeGraph,
			TypeGraph tModel, TAbstractType tAbstractType, ArrayType mArrayType, Model mModel) {
		...
		return new Object[] { mTypeAccess, mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType, mArrayType,
				mModel, isApplicableMatch, mTypeAccess__mType____type, mType__mTypeAccess____usagesInTypeAccess,
				mTypeToTType__mType____source, tModel__tAbstractType____allTypes, tAbstractType__tModel____model,
				mArrayType__mTypeAccess____elementType, modelToTypeGraph__tModel____target,
				modelToTypeGraph__mModel____source, mModel__mArrayType____orphanTypes,
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, TypeAccess mTypeAccess, TypeToTAbstractType mTypeToTType, Type mType,
			ModelToTypeGraph modelToTypeGraph, TypeGraph tModel, TAbstractType tAbstractType, ArrayType mArrayType,
			Model mModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mTypeAccess, mTypeToTType, mType,
				modelToTypeGraph, tModel, tAbstractType, mArrayType, mModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeAccess, mTypeToTType, mType, modelToTypeGraph,
					tModel, tAbstractType, mArrayType, mModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_2_4_solveCSP_binding = pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mTypeAccess, mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType,
				mArrayType, mModel);
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_448601 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_448601)) {
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_mTypeAccess_type_156648 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_365982 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_240717 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_340577 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_340577)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_5B(
			TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_893423 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_868372 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_868372)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_336452 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_520182 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpTModel instanceof TypeGraph) {
					...
					if (tmpTAbstractType instanceof TAbstractType) {
						...
						if (tmpMArrayType instanceof ArrayType) {
							...
							if (tmpMModel instanceof Model) {
								Model mModel = (Model) tmpMModel;
								return new Object[] { mTypeAccess, mType, tModel, tAbstractType, mArrayType, mModel,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(TypeAccess mTypeAccess,
			Type mType, TypeGraph tModel, TAbstractType tAbstractType, ArrayType mArrayType, Model mModel,
			Match sourceMatch, Match targetMatch) {
		if (!mArrayType.equals(mType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { mTypeAccess, mType, tModel, tAbstractType, mArrayType, mModel, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_black = pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(
					mTypeAccess, mType, tModel, tAbstractType, mArrayType, mModel, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(ArrayTypeToType _this,
			TypeAccess mTypeAccess, Type mType, TypeGraph tModel, TAbstractType tAbstractType, ArrayType mArrayType,
			Model mModel, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mTypeAccess, mType, tModel, tAbstractType, mArrayType,
				mModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mTypeAccess, mType, tModel, tAbstractType, mArrayType, mModel,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_21_3_solvecsp_binding = pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, mTypeAccess, mType, tModel, tAbstractType, mArrayType, mModel, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_21_5_matchcorrcontext_blackFBFBBBBB(Type mType,
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAbstractType.equals(mTypeToTType.getTarget())) {
					for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mModel.equals(modelToTypeGraph.getSource())) {
							_result.add(new Object[] { mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType,
									mModel, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(TypeAccess mTypeAccess,
			...
			CCMatch ccMatch) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { mTypeAccess, mType, tModel, tAbstractType, mArrayType, mModel, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_816148 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_816148)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_1B(TypeAccess mTypeAccess) {
		for (Annotation __DEC_mTypeAccess_type_823576 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, Annotation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_2B(TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_672723 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_3B(TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_88685 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_315317 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_315317)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_5B(TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_23680 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_203154 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_203154)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_7B(TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_960762 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_8B(TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_289815 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType, Type mType,
			ModelToTypeGraph modelToTypeGraph, TypeGraph tModel, TAbstractType tAbstractType, Model mModel,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mTypeToTType, mType,
				modelToTypeGraph, tModel, tAbstractType, mModel, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, mType, modelToTypeGraph, tModel,
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_26_3_solveCSP_binding = pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType, mModel,
				ruleResult);
	...
	public static final Object[] pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(TypeToTAbstractType mTypeToTType,
			Type mType, ModelToTypeGraph modelToTypeGraph, TypeGraph tModel, TAbstractType tAbstractType,
			Model mModel) {
		return new Object[] { mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType, mModel };
	}

	public static final Object[] pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(TypeToTAbstractType mTypeToTType,
			Type mType, ModelToTypeGraph modelToTypeGraph, TypeGraph tModel, TAbstractType tAbstractType, Model mModel,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mTypeToTType, mType, modelToTypeGraph, tModel, tAbstractType, mModel, ruleResult };
	}

	public static final Object[] pattern_ArrayTypeToType_26_6_perform_greenFBBFFBB(Type mType,
		...
		return new Object[] { mTypeAccess, mType, tAbstractType, mArrayType, arrayTypeToTArrayClass, mModel,
				ruleResult };
	}
