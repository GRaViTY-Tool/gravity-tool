...
public class ArrayTypeToTypeImpl extends AbstractRuleImpl implements ArrayTypeToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ArrayType mArrayType = (ArrayType) result1_bindingAndBlack[2];
		...
		Object[] result3_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mTypeAccess, mType, mArrayType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel,
				tModel, arrayTypeToTArrayClass);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mTypeAccess] = " + mTypeAccess + ", " + "[mType] = " + mType + ", " + "[mArrayType] = "
					+ mArrayType + ", " + "[modelToTypeGraph] = " + modelToTypeGraph + ", " + "[mTypeToTType] = "
					+ mTypeToTType + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mModel] = " + mModel + ", "
		...
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mTypeAccess, mType, mArrayType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel, tModel,
				arrayTypeToTArrayClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_2_2_corematch_blackBBBFFFBFB(mTypeAccess, mType, mArrayType, mModel, match)) {
			...
			for (Object[] result3_black : ArrayTypeToTypeImpl.pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(
				...
				Object[] result3_green = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(mTypeAccess, mType,
								mArrayType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel, tModel);
				...
				//nothing EMoflonEdge tModel__tAbstractType____allTypes = (EMoflonEdge) result3_green[15];
				//nothing EMoflonEdge tAbstractType__tModel____model = (EMoflonEdge) result3_green[16];
				...
				Object[] result4_bindingAndBlack = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
								mTypeAccess, mType, mArrayType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel,
								tModel);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeAccess mTypeAccess, Type mType,
			ArrayType mArrayType, ModelToTypeGraph modelToTypeGraph, TypeToTAbstractType mTypeToTType,
			TAbstractType tAbstractType, Model mModel, TypeGraph tModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mTypeAccess, EObject mType,
			EObject mArrayType, EObject modelToTypeGraph, EObject mTypeToTType, EObject tAbstractType, EObject mModel,
			EObject tModel, EObject arrayTypeToTArrayClass) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mTypeAccess, mType, mArrayType,
						tAbstractType, mModel, tModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mTypeAccess] = " + mTypeAccess + ", " + "[mType] = " + mType + ", " + "[mArrayType] = "
					+ mArrayType + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mModel] = " + mModel + ", "
		...
		if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBFFBBBBB(mType, tAbstractType, mModel, tModel,
				...
				Object[] result6_black = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(mTypeAccess, mType, mArrayType,
								tAbstractType, mModel, tModel, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess mTypeAccess, Type mType, ArrayType mArrayType,
			TAbstractType tAbstractType, Model mModel, TypeGraph tModel, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
			...
			Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mType,
							modelToTypeGraph, mTypeToTType, tAbstractType, mModel, tModel, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mType] = " + mType + ", "
						+ "[modelToTypeGraph] = " + modelToTypeGraph + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
						+ "[tAbstractType] = " + tAbstractType + ", " + "[mModel] = " + mModel + ", " + "[tModel] = "
						+ tModel + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(mType,
						modelToTypeGraph, mTypeToTType, tAbstractType, mModel, tModel);
				if (result5_black != null) {

					Object[] result6_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(
							mType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel, tModel, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mType] = " + mType
								+ ", " + "[modelToTypeGraph] = " + modelToTypeGraph + ", " + "[mTypeToTType] = "
								+ mTypeToTType + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mModel] = "
								+ mModel + ", " + "[tModel] = " + tModel + ", " + "[ruleResult] = " + ruleResult + ".");
					}
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Type mType,
			...
			Model mModel, TypeGraph tModel, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEACCESS_TYPE_ARRAYTYPE_MODELTOTYPEGRAPH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MODEL_TYPEGRAPH:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TypeAccess) arguments.get(1),
					...
					(TypeToTAbstractType) arguments.get(5), (TAbstractType) arguments.get(6), (Model) arguments.get(7),
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_72__EMOFLONEDGE:
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_TYPE_ARRAYTYPE_TABSTRACTTYPE_MODEL_TYPEGRAPH_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeAccess) arguments.get(0), (Type) arguments.get(1),
					(ArrayType) arguments.get(2), (TAbstractType) arguments.get(3), (Model) arguments.get(4),
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPE_MODELTOTYPEGRAPH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MODEL_TYPEGRAPH_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Type) arguments.get(1),
					(ModelToTypeGraph) arguments.get(2), (TypeToTAbstractType) arguments.get(3),
					(TAbstractType) arguments.get(4), (Model) arguments.get(5), (TypeGraph) arguments.get(6),
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_bindingFFFFFFFFB(
		...
		EObject _localVariable_2 = isApplicableMatch.getObject("mArrayType");
							...
							if (tmpTAbstractType instanceof TAbstractType) {
								...
								if (tmpMModel instanceof Model) {
									...
									if (tmpTModel instanceof TypeGraph) {
										...
										return new Object[] { mTypeAccess, mType, mArrayType, modelToTypeGraph,
												mTypeToTType, tAbstractType, mModel, tModel, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_blackBBBBBBBBFBB(
			TypeAccess mTypeAccess, Type mType, ArrayType mArrayType, ModelToTypeGraph modelToTypeGraph,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, Model mModel, TypeGraph tModel,
			ArrayTypeToType _this, IsApplicableMatch isApplicableMatch) {
		if (!mArrayType.equals(mType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { mTypeAccess, mType, mArrayType, modelToTypeGraph, mTypeToTType, tAbstractType,
							mModel, tModel, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_1_1_performtransformation_binding != null) {
			...
			ArrayType mArrayType = (ArrayType) result_pattern_ArrayTypeToType_1_1_performtransformation_binding[2];
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mTypeAccess, EObject mType, EObject mArrayType,
			EObject modelToTypeGraph, EObject mTypeToTType, EObject tAbstractType, EObject mModel, EObject tModel,
	...
	public static final void pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(ArrayTypeToType _this,
			...
			EObject modelToTypeGraph, EObject mTypeToTType, EObject tAbstractType, EObject mModel, EObject tModel,
			EObject arrayTypeToTArrayClass) {
		_this.registerObjects_FWD(ruleresult, mTypeAccess, mType, mArrayType, modelToTypeGraph, mTypeToTType,
				tAbstractType, mModel, tModel, arrayTypeToTArrayClass);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_2_corematch_blackBBBFFFBFB(TypeAccess mTypeAccess,
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAbstractType != null) {
					for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tModel != null) {
							_result.add(new Object[] { mTypeAccess, mType, mArrayType, modelToTypeGraph, mTypeToTType,
									tAbstractType, mModel, tModel, match });
						}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(TypeAccess mTypeAccess,
			Type mType, ArrayType mArrayType, ModelToTypeGraph modelToTypeGraph, TypeToTAbstractType mTypeToTType,
			TAbstractType tAbstractType, Model mModel, TypeGraph tModel) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mArrayType.equals(mType)) {
								...
								if (tModel.getAllTypes().contains(tAbstractType)) {
									if (tModel.equals(modelToTypeGraph.getTarget())) {
										if (mTypeAccess.equals(mArrayType.getElementType())) {
											_result.add(new Object[] { mTypeAccess, mType, mArrayType, modelToTypeGraph,
													mTypeToTType, tAbstractType, mModel, tModel });
										}
									}
								}
							}
	...
	public static final Object[] pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(
		...
		mArrayType__mTypeAccess____elementType.setName(mArrayType__mTypeAccess____elementType_name_prime);
		return new Object[] { mTypeAccess, mType, mArrayType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel,
				tModel, isApplicableMatch, mTypeToTType__mType____source, mTypeToTType__tAbstractType____target,
				mTypeAccess__mType____type, mType__mTypeAccess____usagesInTypeAccess, mModel__mArrayType____orphanTypes,
				modelToTypeGraph__mModel____source, tModel__tAbstractType____allTypes, tAbstractType__tModel____model,
				modelToTypeGraph__tModel____target, mArrayType__mTypeAccess____elementType };
	}

	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, TypeAccess mTypeAccess, Type mType, ArrayType mArrayType,
			ModelToTypeGraph modelToTypeGraph, TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType,
			Model mModel, TypeGraph tModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mTypeAccess, mType, mArrayType,
				modelToTypeGraph, mTypeToTType, tAbstractType, mModel, tModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeAccess, mType, mArrayType, modelToTypeGraph,
					mTypeToTType, tAbstractType, mModel, tModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_2_4_solveCSP_binding = pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mTypeAccess, mType, mArrayType, modelToTypeGraph, mTypeToTType, tAbstractType,
				mModel, tModel);
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_311509 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_311509)) {
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_mTypeAccess_type_416572 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_495614 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_79915 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_608011 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_608011)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_5B(
			TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_571194 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_538624 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_538624)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_541095 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_608546 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpMArrayType instanceof ArrayType) {
					...
					if (tmpTAbstractType instanceof TAbstractType) {
						...
						if (tmpMModel instanceof Model) {
							...
							if (tmpTModel instanceof TypeGraph) {
								TypeGraph tModel = (TypeGraph) tmpTModel;
								return new Object[] { mTypeAccess, mType, mArrayType, tAbstractType, mModel, tModel,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(TypeAccess mTypeAccess,
			Type mType, ArrayType mArrayType, TAbstractType tAbstractType, Model mModel, TypeGraph tModel,
			Match sourceMatch, Match targetMatch) {
		if (!mArrayType.equals(mType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { mTypeAccess, mType, mArrayType, tAbstractType, mModel, tModel, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_black = pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(
					mTypeAccess, mType, mArrayType, tAbstractType, mModel, tModel, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(ArrayTypeToType _this,
			TypeAccess mTypeAccess, Type mType, ArrayType mArrayType, TAbstractType tAbstractType, Model mModel,
			TypeGraph tModel, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mTypeAccess, mType, mArrayType, tAbstractType, mModel,
				tModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mTypeAccess, mType, mArrayType, tAbstractType, mModel, tModel,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_21_3_solvecsp_binding = pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, mTypeAccess, mType, mArrayType, tAbstractType, mModel, tModel, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBFFBBBBB(Type mType,
			TAbstractType tAbstractType, Model mModel, TypeGraph tModel, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mType, TypeToTAbstractType.class, "source")) {
				if (tAbstractType.equals(mTypeToTType.getTarget())) {
					for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mModel, ModelToTypeGraph.class, "source")) {
						if (tModel.equals(modelToTypeGraph.getTarget())) {
							_result.add(new Object[] { mType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel,
									tModel, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(TypeAccess mTypeAccess,
			...
			CCMatch ccMatch) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { mTypeAccess, mType, mArrayType, tAbstractType, mModel, tModel, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_721851 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_721851)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_1B(TypeAccess mTypeAccess) {
		for (Annotation __DEC_mTypeAccess_type_474983 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, Annotation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_2B(TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_905794 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_3B(TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_703635 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_962974 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_962974)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_5B(TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_743892 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_924071 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_924071)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_7B(TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_856433 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_8B(TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_666250 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, Type mType, ModelToTypeGraph modelToTypeGraph,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, Model mModel, TypeGraph tModel,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mType, modelToTypeGraph,
				mTypeToTType, tAbstractType, mModel, tModel, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, modelToTypeGraph, mTypeToTType, tAbstractType,
					mModel, tModel, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_26_3_solveCSP_binding = pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel, tModel,
				ruleResult);
		if (result_pattern_ArrayTypeToType_26_3_solveCSP_binding != null) {
			...
			if (result_pattern_ArrayTypeToType_26_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mType, modelToTypeGraph, mTypeToTType,
						tAbstractType, mModel, tModel, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(Type mType,
			ModelToTypeGraph modelToTypeGraph, TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType,
			Model mModel, TypeGraph tModel) {
		return new Object[] { mType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel, tModel };
	}
	...
	public static final Object[] pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(Type mType,
		...
		return new Object[] { mType, modelToTypeGraph, mTypeToTType, tAbstractType, mModel, tModel, ruleResult };
	}
