...
public class ArrayTypeToTypeImpl extends AbstractRuleImpl implements ArrayTypeToType {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Model mModel, Type mType, ArrayType mArrayType,
		...
		Object[] result1_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_0_1_initialbindings_blackBBBBBB(this,
				match, mModel, mType, mArrayType, mTypeAccess);
		...
		Object[] result2_bindingAndBlack = ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, mModel, mType, mArrayType,
						mTypeAccess);
		...
		if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[mModel] = " + mModel + ", " + "[mType] = " + mType + ", " + "[mArrayType] = " + mArrayType
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mModel, arrayTypeToTArrayClass, tModel, mTypeToTType, tAbstractType, mType,
				modelToTypeGraph, mArrayType, mTypeAccess);
		...
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(ruleresult, mModel,
				arrayTypeToTArrayClass, tAbstractType, mType, mArrayType, mTypeAccess);
		...
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, mModel,
				arrayTypeToTArrayClass, tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph, mArrayType,
				mTypeAccess);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl.pattern_ArrayTypeToType_2_2_corematch_blackBFFFBFBBB(mModel,
				mType, mArrayType, mTypeAccess, match)) {
			...
			for (Object[] result3_black : ArrayTypeToTypeImpl.pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(
					mModel, tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph, mArrayType, mTypeAccess)) {
				Object[] result3_green = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(mModel, tModel, mTypeToTType,
								tAbstractType, mType, modelToTypeGraph, mArrayType, mTypeAccess);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[8];
				//nothing EMoflonEdge mTypeToTType__mType____source = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge modelToTypeGraph__mModel____source = (EMoflonEdge) result3_green[10];
				...
				Object[] result4_bindingAndBlack = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
								mModel, tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph, mArrayType,
								mTypeAccess);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, Model mModel, Type mType, ArrayType mArrayType,
			TypeAccess mTypeAccess) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, Model mModel, Type mType, ArrayType mArrayType,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Model mModel, TypeGraph tModel,
			...
			ModelToTypeGraph modelToTypeGraph, ArrayType mArrayType, TypeAccess mTypeAccess) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModel, EObject arrayTypeToTArrayClass,
			EObject tModel, EObject mTypeToTType, EObject tAbstractType, EObject mType, EObject modelToTypeGraph,
			EObject mArrayType, EObject mTypeAccess) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_53(EMoflonEdge _edge_elementType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mModel, tModel, tAbstractType,
						mType, mArrayType, mTypeAccess, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mModel] = " + mModel + ", " + "[tModel] = " + tModel + ", " + "[tAbstractType] = "
					+ tAbstractType + ", " + "[mType] = " + mType + ", " + "[mArrayType] = " + mArrayType + ", "
		...
		if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBBFBBFBB(mModel, tModel, tAbstractType, mType,
				...
				Object[] result6_black = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(mModel, tModel, tAbstractType,
								mType, mArrayType, mTypeAccess, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Model mModel, TypeGraph tModel, TAbstractType tAbstractType, Type mType,
			ArrayType mArrayType, TypeAccess mTypeAccess, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(Model mModel, Type mType, ArrayType mArrayType, TypeAccess mTypeAccess) {// 
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
			...
			Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mModel,
							tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mModel] = " + mModel + ", "
						+ "[tModel] = " + tModel + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
			...
			if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(mModel,
						tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph);
				if (result5_black != null) {

					Object[] result6_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(
							mModel, tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModel] = " + mModel
								+ ", " + "[tModel] = " + tModel + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
								+ "[tAbstractType] = " + tAbstractType + ", " + "[mType] = " + mType + ", "
					...
					ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_greenBFBBFFB(mModel, tAbstractType, mType,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODEL_TYPEGRAPH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TYPE_MODELTOTYPEGRAPH_ARRAYTYPE_TYPEACCESS:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Model) arguments.get(1),
					...
					(TAbstractType) arguments.get(4), (Type) arguments.get(5), (ModelToTypeGraph) arguments.get(6),
					(ArrayType) arguments.get(7), (TypeAccess) arguments.get(8));
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_53__EMOFLONEDGE:
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__MODEL_TYPEGRAPH_TABSTRACTTYPE_TYPE_ARRAYTYPE_TYPEACCESS_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Model) arguments.get(0), (TypeGraph) arguments.get(1),
					(TAbstractType) arguments.get(2), (Type) arguments.get(3), (ArrayType) arguments.get(4),
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODEL_TYPEGRAPH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TYPE_MODELTOTYPEGRAPH_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ArrayTypeToType_0_1_initialbindings_blackBBBBBB(ArrayTypeToType _this,
			Match match, Model mModel, Type mType, ArrayType mArrayType, TypeAccess mTypeAccess) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { _this, match, mModel, mType, mArrayType, mTypeAccess };
		}
		return null;
	}

	public static final Object[] pattern_ArrayTypeToType_0_2_SolveCSP_bindingFBBBBBB(ArrayTypeToType _this, Match match,
			Model mModel, Type mType, ArrayType mArrayType, TypeAccess mTypeAccess) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, mModel, mType, mArrayType, mTypeAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, mModel, mType, mArrayType, mTypeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_0_2_SolveCSP_binding = pattern_ArrayTypeToType_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, mModel, mType, mArrayType, mTypeAccess);
	...
	public static final Object[] pattern_ArrayTypeToType_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			Model mModel, Type mType, ArrayType mArrayType, TypeAccess mTypeAccess) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { match, mModel, mType, mArrayType, mTypeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_0_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		return new Object[] { match, mModel, mType, mArrayType, mTypeAccess, mArrayType__mTypeAccess____elementType,
	...
	public static final void pattern_ArrayTypeToType_0_6_registerobjectstomatch_expressionBBBBBB(ArrayTypeToType _this,
			Match match, Model mModel, Type mType, ArrayType mArrayType, TypeAccess mTypeAccess) {
		_this.registerObjectsToMatch_FWD(match, mModel, mType, mArrayType, mTypeAccess);
							...
							if (tmpModelToTypeGraph instanceof ModelToTypeGraph) {
								...
								if (tmpMArrayType instanceof ArrayType) {
									...
									if (tmpMTypeAccess instanceof TypeAccess) {
										...
										return new Object[] { mModel, tModel, mTypeToTType, tAbstractType, mType,
												modelToTypeGraph, mArrayType, mTypeAccess, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_blackBBBBBBBBFBB(Model mModel,
			TypeGraph tModel, TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, Type mType,
			ModelToTypeGraph modelToTypeGraph, ArrayType mArrayType, TypeAccess mTypeAccess, ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch) {
		if (!mArrayType.equals(mType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { mModel, tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph,
							mArrayType, mTypeAccess, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_1_1_performtransformation_binding != null) {
			...
			if (result_pattern_ArrayTypeToType_1_1_performtransformation_black != null) {
				...
				return new Object[] { mModel, tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph, mArrayType,
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModel, EObject arrayTypeToTArrayClass, EObject tModel,
			EObject mTypeToTType, EObject tAbstractType, EObject mType, EObject modelToTypeGraph, EObject mArrayType,
			EObject mTypeAccess) {
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			...
			EObject mType, EObject mArrayType, EObject mTypeAccess) {
		EMoflonEdge mArrayType__mTypeAccess____elementType = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		mTypeAccess__mType____type.setName(mTypeAccess__mType____type_name_prime);
		mType__mTypeAccess____usagesInTypeAccess.setName(mType__mTypeAccess____usagesInTypeAccess_name_prime);
		return new Object[] { ruleresult, mModel, arrayTypeToTArrayClass, tAbstractType, mType, mArrayType, mTypeAccess,
	...
	public static final void pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(ArrayTypeToType _this,
			...
			EObject mTypeToTType, EObject tAbstractType, EObject mType, EObject modelToTypeGraph, EObject mArrayType,
			EObject mTypeAccess) {
		_this.registerObjects_FWD(ruleresult, mModel, arrayTypeToTArrayClass, tModel, mTypeToTType, tAbstractType,
				mType, modelToTypeGraph, mArrayType, mTypeAccess);
		...
		if (tmpMModel instanceof Model) {
			...
			if (tmpMType instanceof Type) {
				...
				if (tmpMArrayType instanceof ArrayType) {
					...
					if (tmpMTypeAccess instanceof TypeAccess) {
						TypeAccess mTypeAccess = (TypeAccess) tmpMTypeAccess;
						return new Object[] { mModel, mType, mArrayType, mTypeAccess, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_2_corematch_blackBFFFBFBBB(Model mModel,
			Type mType, ArrayType mArrayType, TypeAccess mTypeAccess, Match match) {
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAbstractType != null) {
					for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tModel != null) {
							_result.add(new Object[] { mModel, tModel, mTypeToTType, tAbstractType, mType,
									modelToTypeGraph, mArrayType, mTypeAccess, match });
						}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(Model mModel,
			TypeGraph tModel, TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, Type mType,
			ModelToTypeGraph modelToTypeGraph, ArrayType mArrayType, TypeAccess mTypeAccess) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mArrayType.equals(mType)) {
								...
								if (tModel.getOwnedTypes().contains(tAbstractType)) {
									if (mModel.getOrphanTypes().contains(mArrayType)) {
										if (mType.equals(mTypeAccess.getType())) {
											_result.add(new Object[] { mModel, tModel, mTypeToTType, tAbstractType,
													mType, modelToTypeGraph, mArrayType, mTypeAccess });
										}
									}
								}
	...
	public static final Object[] pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(Model mModel,
		...
		mType__mTypeAccess____usagesInTypeAccess.setName(mType__mTypeAccess____usagesInTypeAccess_name_prime);
		return new Object[] { mModel, tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph, mArrayType,
				mTypeAccess, isApplicableMatch, mTypeToTType__mType____source, modelToTypeGraph__mModel____source,
				modelToTypeGraph__tModel____target, mArrayType__mTypeAccess____elementType,
				mTypeToTType__tAbstractType____target, tModel__tAbstractType____ownedTypes,
				tAbstractType__tModel____model, mModel__mArrayType____orphanTypes, mTypeAccess__mType____type,
				mType__mTypeAccess____usagesInTypeAccess };
	}

	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, Model mModel, TypeGraph tModel, TypeToTAbstractType mTypeToTType,
			TAbstractType tAbstractType, Type mType, ModelToTypeGraph modelToTypeGraph, ArrayType mArrayType,
			TypeAccess mTypeAccess) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModel, tModel, mTypeToTType,
				tAbstractType, mType, modelToTypeGraph, mArrayType, mTypeAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModel, tModel, mTypeToTType, tAbstractType, mType,
					modelToTypeGraph, mArrayType, mTypeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_2_4_solveCSP_binding = pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mModel, tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph,
				mArrayType, mTypeAccess);
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_315373 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_315373)) {
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_1B(
			TypeAccess mTypeAccess) {
		for (Annotation __DEC_mTypeAccess_type_272386 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_46460 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_968306 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_196448 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_196448)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_5B(
			TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_540841 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_72061 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_72061)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_97582 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_535240 : org.moflon.core.utilities.eMoflonEMFUtil
														...
														if (pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_4BB(
															...
															if (pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_6BB(
																...
																for (Model mModel : org.moflon.core.utilities.eMoflonEMFUtil
																	...
																	_result.add(
																			new Object[] { mModel, mType, mArrayType,
																					mTypeAccess, _edge_elementType });
																}
															}
														}
													}
	...
	public static final boolean pattern_ArrayTypeToType_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ArrayTypeToType _this, Match match, Model mModel, Type mType, ArrayType mArrayType,
			TypeAccess mTypeAccess) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, mModel, mType, mArrayType, mTypeAccess);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpTAbstractType instanceof TAbstractType) {
					...
					if (tmpMType instanceof Type) {
						...
						if (tmpMArrayType instanceof ArrayType) {
							...
							if (tmpMTypeAccess instanceof TypeAccess) {
								TypeAccess mTypeAccess = (TypeAccess) tmpMTypeAccess;
								return new Object[] { mModel, tModel, tAbstractType, mType, mArrayType, mTypeAccess,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(Model mModel,
			TypeGraph tModel, TAbstractType tAbstractType, Type mType, ArrayType mArrayType, TypeAccess mTypeAccess,
			Match sourceMatch, Match targetMatch) {
		if (!mArrayType.equals(mType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { mModel, tModel, tAbstractType, mType, mArrayType, mTypeAccess, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_black = pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(
					mModel, tModel, tAbstractType, mType, mArrayType, mTypeAccess, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(ArrayTypeToType _this,
			Model mModel, TypeGraph tModel, TAbstractType tAbstractType, Type mType, ArrayType mArrayType,
			TypeAccess mTypeAccess, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mModel, tModel, tAbstractType, mType, mArrayType,
				mTypeAccess, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mModel, tModel, tAbstractType, mType, mArrayType, mTypeAccess,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_21_3_solvecsp_binding = pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, mModel, tModel, tAbstractType, mType, mArrayType, mTypeAccess, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBBFBBFBB(Model mModel,
			TypeGraph tModel, TAbstractType tAbstractType, Type mType, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mType, TypeToTAbstractType.class, "source")) {
	...
	public static final Object[] pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(Model mModel,
			...
			CCMatch ccMatch) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { mModel, tModel, tAbstractType, mType, mArrayType, mTypeAccess, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_526984 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_526984)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_1B(TypeAccess mTypeAccess) {
		for (Annotation __DEC_mTypeAccess_type_84763 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, Annotation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_2B(TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_168840 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_3B(TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_469396 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_808710 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_808710)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_5B(TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_329361 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_432326 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_432326)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_7B(TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_402740 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_8B(TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_661154 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mTypeAccess };
		}
		return null;
												...
												if (pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_6BB(
													...
													if (pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_7B(
														...
														if (pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_8B(
																mTypeAccess) == null) {
															return new Object[] { mModel, mType, mArrayType,
																	mTypeAccess };
														}
													}
												}
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(ArrayTypeToType _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mModel, tModel, mTypeToTType,
				tAbstractType, mType, modelToTypeGraph, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModel, tModel, mTypeToTType, tAbstractType, mType,
	...
	public static final Object[] pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(Model mModel, TypeGraph tModel,
		...
		return new Object[] { mModel, tModel, mTypeToTType, tAbstractType, mType, modelToTypeGraph, ruleResult };
	}

	public static final Object[] pattern_ArrayTypeToType_26_6_perform_greenBFBBFFB(Model mModel,
		...
		return new Object[] { mModel, arrayTypeToTArrayClass, tAbstractType, mType, mArrayType, mTypeAccess,
				ruleResult };
	}
