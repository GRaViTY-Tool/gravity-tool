...
public class ArrayTypeToTypeImpl extends AbstractRuleImpl implements ArrayTypeToType {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Model mModel, TypeAccess mTypeAccess, Type mType,
		...
		Object[] result1_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_0_1_initialbindings_blackBBBBBB(this,
				match, mModel, mTypeAccess, mType, mArrayType);
		...
		Object[] result2_bindingAndBlack = ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, mModel, mTypeAccess, mType,
						mArrayType);
		...
		if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[mModel] = " + mModel + ", " + "[mTypeAccess] = " + mTypeAccess + ", " + "[mType] = " + mType
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mModel, tAbstractType, mTypeToTType, mTypeAccess, mType, tModel, arrayTypeToTArrayClass,
				mArrayType, modelToTypeGraph);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModel] = " + mModel + ", " + "[tAbstractType] = " + tAbstractType + ", "
					+ "[mTypeToTType] = " + mTypeToTType + ", " + "[mTypeAccess] = " + mTypeAccess + ", " + "[mType] = "
					+ mType + ", " + "[tModel] = " + tModel + ", " + "[arrayTypeToTArrayClass] = "
					+ arrayTypeToTArrayClass + ", " + "[mArrayType] = " + mArrayType + ", " + "[modelToTypeGraph] = "
					+ modelToTypeGraph + ".");
		}
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(ruleresult, mModel,
				tAbstractType, mTypeAccess, mType, arrayTypeToTArrayClass, mArrayType);
		...
		ArrayTypeToTypeImpl.pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, mModel,
				tAbstractType, mTypeToTType, mTypeAccess, mType, tModel, arrayTypeToTArrayClass, mArrayType,
				modelToTypeGraph);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl.pattern_ArrayTypeToType_2_2_corematch_blackBFFBBFBFB(mModel,
				mTypeAccess, mType, mArrayType, match)) {
			...
			for (Object[] result3_black : ArrayTypeToTypeImpl.pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(
					mModel, tAbstractType, mTypeToTType, mTypeAccess, mType, tModel, mArrayType, modelToTypeGraph)) {
				Object[] result3_green = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(mModel, tAbstractType,
								mTypeToTType, mTypeAccess, mType, tModel, mArrayType, modelToTypeGraph);
				...
				//nothing EMoflonEdge mTypeAccess__mType____type = (EMoflonEdge) result3_green[16];
				//nothing EMoflonEdge mType__mTypeAccess____usagesInTypeAccess = (EMoflonEdge) result3_green[17];
				...
				Object[] result4_bindingAndBlack = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
								mModel, tAbstractType, mTypeToTType, mTypeAccess, mType, tModel, mArrayType,
								modelToTypeGraph);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mModel] = " + mModel + ", "
							+ "[tAbstractType] = " + tAbstractType + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
							+ "[mTypeAccess] = " + mTypeAccess + ", " + "[mType] = " + mType + ", " + "[tModel] = "
							+ tModel + ", " + "[mArrayType] = " + mArrayType + ", " + "[modelToTypeGraph] = "
							+ modelToTypeGraph + ".");
				}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, Model mModel, TypeAccess mTypeAccess, Type mType,
			ArrayType mArrayType) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, Model mModel, TypeAccess mTypeAccess, Type mType,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Model mModel, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, TypeAccess mTypeAccess, Type mType, TypeGraph tModel,
			ArrayType mArrayType, ModelToTypeGraph modelToTypeGraph) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModel, EObject tAbstractType,
			EObject mTypeToTType, EObject mTypeAccess, EObject mType, EObject tModel, EObject arrayTypeToTArrayClass,
			EObject mArrayType, EObject modelToTypeGraph) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
				.pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mModel, tAbstractType,
						mTypeAccess, mType, tModel, mArrayType, sourceMatch, targetMatch);
		...
		if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBBFBBFBB(mModel, tAbstractType, mType, tModel,
				...
				Object[] result6_black = ArrayTypeToTypeImpl
						.pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(mModel, tAbstractType,
								mTypeAccess, mType, tModel, mArrayType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModel] = " + mModel
							...
							+ ", " + "[mType] = " + mType + ", " + "[tModel] = " + tModel + ", " + "[mArrayType] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Model mModel, TAbstractType tAbstractType, TypeAccess mTypeAccess, Type mType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(Model mModel, TypeAccess mTypeAccess, Type mType, ArrayType mArrayType) {// 
		...
		for (Object[] result2_black : ArrayTypeToTypeImpl
			...
			Object[] result3_bindingAndBlack = ArrayTypeToTypeImpl
					.pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mModel,
							tAbstractType, mTypeToTType, mType, tModel, modelToTypeGraph, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mModel] = " + mModel + ", "
						+ "[tAbstractType] = " + tAbstractType + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
			...
			if (ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(mModel,
						tAbstractType, mTypeToTType, mType, tModel, modelToTypeGraph);
				if (result5_black != null) {

					Object[] result6_black = ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(
							mModel, tAbstractType, mTypeToTType, mType, tModel, modelToTypeGraph, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModel] = " + mModel
								+ ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mTypeToTType] = "
								+ mTypeToTType + ", " + "[mType] = " + mType + ", " + "[tModel] = " + tModel + ", "
								+ "[modelToTypeGraph] = " + modelToTypeGraph + ", " + "[ruleResult] = " + ruleResult
								+ ".");
					}
					ArrayTypeToTypeImpl.pattern_ArrayTypeToType_26_6_perform_greenBBFBFFB(mModel, tAbstractType, mType,
							ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Model mModel,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, Type mType, TypeGraph tModel,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_FWD__MATCH_MODEL_TYPEACCESS_TYPE_ARRAYTYPE:
			return isAppropriate_FWD((Match) arguments.get(0), (Model) arguments.get(1), (TypeAccess) arguments.get(2),
					(Type) arguments.get(3), (ArrayType) arguments.get(4));
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MODEL_TYPEACCESS_TYPE_ARRAYTYPE:
			...
			return null;
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MODEL_TYPEACCESS_TYPE_ARRAYTYPE:
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODEL_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TYPEACCESS_TYPE_TYPEGRAPH_ARRAYTYPE_MODELTOTYPEGRAPH:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Model) arguments.get(1),
					...
					(TypeAccess) arguments.get(4), (Type) arguments.get(5), (TypeGraph) arguments.get(6),
					(ArrayType) arguments.get(7), (ModelToTypeGraph) arguments.get(8));
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_35__EMOFLONEDGE:
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__MODEL_TABSTRACTTYPE_TYPEACCESS_TYPE_TYPEGRAPH_ARRAYTYPE_MATCH_MATCH:
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___CHECK_DEC_FWD__MODEL_TYPEACCESS_TYPE_ARRAYTYPE:
			return checkDEC_FWD((Model) arguments.get(0), (TypeAccess) arguments.get(1), (Type) arguments.get(2),
		...
		case RulesPackage.ARRAY_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODEL_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TYPE_TYPEGRAPH_MODELTOTYPEGRAPH_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ArrayTypeToType_0_1_initialbindings_blackBBBBBB(ArrayTypeToType _this,
			Match match, Model mModel, TypeAccess mTypeAccess, Type mType, ArrayType mArrayType) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { _this, match, mModel, mTypeAccess, mType, mArrayType };
		}
		return null;
	}

	public static final Object[] pattern_ArrayTypeToType_0_2_SolveCSP_bindingFBBBBBB(ArrayTypeToType _this, Match match,
			Model mModel, TypeAccess mTypeAccess, Type mType, ArrayType mArrayType) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, mModel, mTypeAccess, mType, mArrayType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, mModel, mTypeAccess, mType, mArrayType };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_0_2_SolveCSP_binding = pattern_ArrayTypeToType_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, mModel, mTypeAccess, mType, mArrayType);
	...
	public static final Object[] pattern_ArrayTypeToType_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			Model mModel, TypeAccess mTypeAccess, Type mType, ArrayType mArrayType) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { match, mModel, mTypeAccess, mType, mArrayType };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_0_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		return new Object[] { match, mModel, mTypeAccess, mType, mArrayType, mModel__mArrayType____orphanTypes,
	...
	public static final void pattern_ArrayTypeToType_0_6_registerobjectstomatch_expressionBBBBBB(ArrayTypeToType _this,
			Match match, Model mModel, TypeAccess mTypeAccess, Type mType, ArrayType mArrayType) {
		_this.registerObjectsToMatch_FWD(match, mModel, mTypeAccess, mType, mArrayType);
							...
							if (tmpTModel instanceof TypeGraph) {
								...
								if (tmpMArrayType instanceof ArrayType) {
									...
									if (tmpModelToTypeGraph instanceof ModelToTypeGraph) {
										...
										return new Object[] { mModel, tAbstractType, mTypeToTType, mTypeAccess, mType,
												tModel, mArrayType, modelToTypeGraph, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_ArrayTypeToType_1_1_performtransformation_blackBBBBBBBBFBB(Model mModel,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, TypeAccess mTypeAccess, Type mType,
			TypeGraph tModel, ArrayType mArrayType, ModelToTypeGraph modelToTypeGraph, ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch) {
		if (!mArrayType.equals(mType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { mModel, tAbstractType, mTypeToTType, mTypeAccess, mType, tModel, mArrayType,
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModel, EObject tAbstractType, EObject mTypeToTType,
			EObject mTypeAccess, EObject mType, EObject tModel, EObject arrayTypeToTArrayClass, EObject mArrayType,
	...
	public static final Object[] pattern_ArrayTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject mModel, EObject tAbstractType, EObject mTypeAccess, EObject mType,
		...
		mTypeAccess__mType____type.setName(mTypeAccess__mType____type_name_prime);
		mType__mTypeAccess____usagesInTypeAccess.setName(mType__mTypeAccess____usagesInTypeAccess_name_prime);
		return new Object[] { ruleresult, mModel, tAbstractType, mTypeAccess, mType, arrayTypeToTArrayClass, mArrayType,
	...
	public static final void pattern_ArrayTypeToType_1_5_registerobjects_expressionBBBBBBBBBBB(ArrayTypeToType _this,
			...
			EObject mTypeAccess, EObject mType, EObject tModel, EObject arrayTypeToTArrayClass, EObject mArrayType,
			EObject modelToTypeGraph) {
		_this.registerObjects_FWD(ruleresult, mModel, tAbstractType, mTypeToTType, mTypeAccess, mType, tModel,
				arrayTypeToTArrayClass, mArrayType, modelToTypeGraph);
		...
		if (tmpMModel instanceof Model) {
			...
			if (tmpMTypeAccess instanceof TypeAccess) {
				...
				if (tmpMType instanceof Type) {
					...
					if (tmpMArrayType instanceof ArrayType) {
						ArrayType mArrayType = (ArrayType) tmpMArrayType;
						return new Object[] { mModel, mTypeAccess, mType, mArrayType, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_2_corematch_blackBFFBBFBFB(Model mModel,
			TypeAccess mTypeAccess, Type mType, ArrayType mArrayType, Match match) {
				...
				if (tModel != null) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tAbstractType != null) {
							_result.add(new Object[] { mModel, tAbstractType, mTypeToTType, mTypeAccess, mType, tModel,
									mArrayType, modelToTypeGraph, match });
						}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_2_3_findcontext_blackBBBBBBBB(Model mModel,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, TypeAccess mTypeAccess, Type mType,
			TypeGraph tModel, ArrayType mArrayType, ModelToTypeGraph modelToTypeGraph) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mArrayType.equals(mType)) {
								...
								if (mType.equals(mTypeToTType.getSource())) {
									if (mType.equals(mTypeAccess.getType())) {
										if (tModel.equals(modelToTypeGraph.getTarget())) {
											_result.add(new Object[] { mModel, tAbstractType, mTypeToTType, mTypeAccess,
													mType, tModel, mArrayType, modelToTypeGraph });
										}
									}
								}
							}
	...
	public static final Object[] pattern_ArrayTypeToType_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(Model mModel,
		...
		return new Object[] { mModel, tAbstractType, mTypeToTType, mTypeAccess, mType, tModel, mArrayType,
				modelToTypeGraph, isApplicableMatch, mModel__mArrayType____orphanTypes,
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(ArrayTypeToType _this,
			...
			TypeToTAbstractType mTypeToTType, TypeAccess mTypeAccess, Type mType, TypeGraph tModel,
			ArrayType mArrayType, ModelToTypeGraph modelToTypeGraph) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModel, tAbstractType, mTypeToTType,
				mTypeAccess, mType, tModel, mArrayType, modelToTypeGraph);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModel, tAbstractType, mTypeToTType, mTypeAccess,
					mType, tModel, mArrayType, modelToTypeGraph };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_2_4_solveCSP_binding = pattern_ArrayTypeToType_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mModel, tAbstractType, mTypeToTType, mTypeAccess, mType, tModel, mArrayType,
				modelToTypeGraph);
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_343827 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_343827)) {
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_mTypeAccess_type_833205 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_927249 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_174575 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_158881 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_158881)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_5B(
			TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_58883 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_763123 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_763123)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_865803 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_832561 : org.moflon.core.utilities.eMoflonEMFUtil
															...
															if (pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_4BB(
																...
																if (pattern_ArrayTypeToType_18_2_testcorematchandDECs_black_nac_6BB(
																	...
																	_result.add(new Object[] { mModel, mTypeAccess,
																			mType, mArrayType, _edge_orphanTypes });
																}
															}
														}
													}
	...
	public static final boolean pattern_ArrayTypeToType_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ArrayTypeToType _this, Match match, Model mModel, TypeAccess mTypeAccess, Type mType,
			ArrayType mArrayType) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, mModel, mTypeAccess, mType, mArrayType);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpMTypeAccess instanceof TypeAccess) {
					...
					if (tmpMType instanceof Type) {
						...
						if (tmpTModel instanceof TypeGraph) {
							...
							if (tmpMArrayType instanceof ArrayType) {
								ArrayType mArrayType = (ArrayType) tmpMArrayType;
								return new Object[] { mModel, tAbstractType, mTypeAccess, mType, tModel, mArrayType,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(Model mModel,
			TAbstractType tAbstractType, TypeAccess mTypeAccess, Type mType, TypeGraph tModel, ArrayType mArrayType,
			Match sourceMatch, Match targetMatch) {
		if (!mArrayType.equals(mType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { mModel, tAbstractType, mTypeAccess, mType, tModel, mArrayType, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ArrayTypeToType_21_2_matchsrctrgcontext_black = pattern_ArrayTypeToType_21_2_matchsrctrgcontext_blackBBBBBBBB(
					mModel, tAbstractType, mTypeAccess, mType, tModel, mArrayType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(ArrayTypeToType _this,
			Model mModel, TAbstractType tAbstractType, TypeAccess mTypeAccess, Type mType, TypeGraph tModel,
			ArrayType mArrayType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mModel, tAbstractType, mTypeAccess, mType, tModel,
				mArrayType, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mModel, tAbstractType, mTypeAccess, mType, tModel, mArrayType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_21_3_solvecsp_binding = pattern_ArrayTypeToType_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, mModel, tAbstractType, mTypeAccess, mType, tModel, mArrayType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToType_21_5_matchcorrcontext_blackBBFBBFBB(Model mModel,
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mType.equals(mTypeToTType.getSource())) {
					for (ModelToTypeGraph modelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mModel, ModelToTypeGraph.class, "source")) {
						if (tModel.equals(modelToTypeGraph.getTarget())) {
							_result.add(new Object[] { mModel, tAbstractType, mTypeToTType, mType, tModel,
	...
	public static final Object[] pattern_ArrayTypeToType_21_6_createcorrespondence_blackBBBBBBB(Model mModel,
			...
			CCMatch ccMatch) {
		if (!mArrayType.equals(mType)) {
			return new Object[] { mModel, tAbstractType, mTypeAccess, mType, tModel, mArrayType, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_0BB(TypeAccess mTypeAccess,
			Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_281222 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_281222)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_1B(TypeAccess mTypeAccess) {
		for (Annotation __DEC_mTypeAccess_type_936754 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, Annotation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_2B(TypeAccess mTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_mTypeAccess_type_993098 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_3B(TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_886786 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_4BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_184326 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_184326)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_5B(TypeAccess mTypeAccess) {
		for (MethodDeclaration __DEC_mTypeAccess_returnType_532429 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_6BB(TypeAccess mTypeAccess,
			Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_937536 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_937536)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_7B(TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_696949 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_8B(TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_953347 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToType_24_1_matchtggpattern_blackBBBB(Model mModel,
			TypeAccess mTypeAccess, Type mType, ArrayType mArrayType) {
		if (!mArrayType.equals(mType)) {
			if (mModel.getOrphanTypes().contains(mArrayType)) {
				if (mTypeAccess.equals(mArrayType.getElementType())) {
					if (mType.equals(mTypeAccess.getType())) {
												...
												if (pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_6BB(
													...
													if (pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_7B(
														...
														if (pattern_ArrayTypeToType_24_1_matchtggpattern_black_nac_8B(
																mTypeAccess) == null) {
															return new Object[] { mModel, mTypeAccess, mType,
																	mArrayType };
														}
													}
												}
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(ArrayTypeToType _this,
			IsApplicableMatch isApplicableMatch, Model mModel, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, Type mType, TypeGraph tModel, ModelToTypeGraph modelToTypeGraph,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mModel, tAbstractType, mTypeToTType,
				mType, tModel, modelToTypeGraph, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModel, tAbstractType, mTypeToTType, mType, tModel,
	...
	public static final Object[] pattern_ArrayTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(ArrayTypeToType _this,
		...
		Object[] result_pattern_ArrayTypeToType_26_3_solveCSP_binding = pattern_ArrayTypeToType_26_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModel, tAbstractType, mTypeToTType, mType, tModel, modelToTypeGraph,
				ruleResult);
	...
	public static final Object[] pattern_ArrayTypeToType_26_5_checknacs_blackBBBBBB(Model mModel,
		...
		return new Object[] { mModel, tAbstractType, mTypeToTType, mType, tModel, modelToTypeGraph };
	}
	...
	public static final Object[] pattern_ArrayTypeToType_26_6_perform_blackBBBBBBB(Model mModel,
		...
		return new Object[] { mModel, tAbstractType, mTypeToTType, mType, tModel, modelToTypeGraph, ruleResult };
	}

	public static final Object[] pattern_ArrayTypeToType_26_6_perform_greenBBFBFFB(Model mModel,
		...
		return new Object[] { mModel, tAbstractType, mTypeAccess, mType, arrayTypeToTArrayClass, mArrayType,
				ruleResult };
	}
