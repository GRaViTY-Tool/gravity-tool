...
public class LinkDefinitionToTypeImpl extends AbstractRuleImpl implements LinkDefinitionToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mDefinitionToTMember,
						mTypeToTType, tSignature, mDefinition, tType, tDefinition, mType, mSignature,
						mSignatureToTSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember + ", " + "[mTypeToTType] = "
					+ mTypeToTType + ", " + "[tSignature] = " + tSignature + ", " + "[mDefinition] = " + mDefinition
					+ ", " + "[tType] = " + tType + ", " + "[tDefinition] = " + tDefinition + ", " + "[mType] = "
					+ mType + ", " + "[mSignature] = " + mSignature + ", " + "[mSignatureToTSignature] = "
					+ mSignatureToTSignature + ".");
		}
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				tSignature, mDefinition, tType, tDefinition, mType);
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType, tDefinition, mType,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_2_2_corematch_blackFFFBFFBBFB(mDefinition, mType, mSignature, match)) {
			...
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_2_3_findcontext_blackBBBBBBBBB(mDefinitionToTMember, mTypeToTType,
							tSignature, mDefinition, tType, tDefinition, mType, mSignature, mSignatureToTSignature)) {
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this, isApplicableMatch,
								mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType, tDefinition, mType,
								mSignature, mSignatureToTSignature);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinitionToTMember mDefinitionToTMember,
			TypeToTAbstractType mTypeToTType, TSignature tSignature, MDefinition mDefinition, TAbstractType tType,
			TMember tDefinition, AbstractTypeDeclaration mType, MSignature mSignature,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mDefinitionToTMember, EObject mTypeToTType,
			EObject tSignature, EObject mDefinition, EObject tType, EObject tDefinition, EObject mType,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_12_2_corematch_blackFFBFBBFFFB(tSignature, tType, tDefinition, match)) {
			MDefinitionToTMember mDefinitionToTMember = (MDefinitionToTMember) result2_black[0];
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[1];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_19(EMoflonEdge _edge_defines) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_19(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tSignature, mDefinition,
						tType, tDefinition, mType, mSignature, sourceMatch, targetMatch);
		...
		if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackFFBBBBBBFBB(tSignature, mDefinition, tType,
							tDefinition, mType, mSignature, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(tSignature, mDefinition,
								tType, tDefinition, mType, mSignature, ccMatch);
				if (result6_black == null) {
	...
	public CSP isApplicable_solveCsp_CC(TSignature tSignature, MDefinition mDefinition, TAbstractType tType,
			TMember tDefinition, AbstractTypeDeclaration mType, MSignature mSignature, Match sourceMatch,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinitionToTMember] = "
						+ mDefinitionToTMember + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tSignature] = "
						+ tSignature + ", " + "[mDefinition] = " + mDefinition + ", " + "[tType] = " + tType + ", "
						+ "[tDefinition] = " + tDefinition + ", " + "[mType] = " + mType + ", " + "[mSignature] = "
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								+ "[mDefinitionToTMember] = " + mDefinitionToTMember + ", " + "[mTypeToTType] = "
								+ mTypeToTType + ", " + "[tSignature] = " + tSignature + ", " + "[mDefinition] = "
								+ mDefinition + ", " + "[tType] = " + tType + ", " + "[tDefinition] = " + tDefinition
					...
					LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(tSignature,
							mDefinition, tType, tDefinition, mType, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			MDefinitionToTMember mDefinitionToTMember, TypeToTAbstractType mTypeToTType, TSignature tSignature,
			MDefinition mDefinition, TAbstractType tType, TMember tDefinition, AbstractTypeDeclaration mType,
			MSignature mSignature, MSignatureToTSignature mSignatureToTSignature, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TYPETOTABSTRACTTYPE_TSIGNATURE_MDEFINITION_TABSTRACTTYPE_TMEMBER_ABSTRACTTYPEDECLARATION_MSIGNATURE_MSIGNATURETOTSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TSignature) arguments.get(3), (MDefinition) arguments.get(4), (TAbstractType) arguments.get(5),
					(TMember) arguments.get(6), (AbstractTypeDeclaration) arguments.get(7),
					(MSignature) arguments.get(8), (MSignatureToTSignature) arguments.get(9));
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TYPETOTABSTRACTTYPE_TSIGNATURE_MDEFINITION_TABSTRACTTYPE_TMEMBER_ABSTRACTTYPEDECLARATION_MSIGNATURE_MSIGNATURETOTSIGNATURE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_19__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_19((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_19__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TSIGNATURE_MDEFINITION_TABSTRACTTYPE_TMEMBER_ABSTRACTTYPEDECLARATION_MSIGNATURE_MATCH_MATCH:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TYPETOTABSTRACTTYPE_TSIGNATURE_MDEFINITION_TABSTRACTTYPE_TMEMBER_ABSTRACTTYPEDECLARATION_MSIGNATURE_MSIGNATURETOTSIGNATURE_MODELGENERATORRULERESULT:
								...
								if (tmpMType instanceof AbstractTypeDeclaration) {
									...
									if (tmpMSignature instanceof MSignature) {
										...
										if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
											...
											return new Object[] { mDefinitionToTMember, mTypeToTType, tSignature,
													mDefinition, tType, tDefinition, mType, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
			MDefinitionToTMember mDefinitionToTMember, TypeToTAbstractType mTypeToTType, TSignature tSignature,
			MDefinition mDefinition, TAbstractType tType, TMember tDefinition, AbstractTypeDeclaration mType,
			MSignature mSignature, MSignatureToTSignature mSignatureToTSignature, LinkDefinitionToType _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType, tDefinition,
						mType, mSignature, mSignatureToTSignature, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_1_1_performtransformation_black = pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
					mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType, tDefinition, mType, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mDefinitionToTMember, EObject mTypeToTType, EObject tSignature,
			EObject mDefinition, EObject tType, EObject tDefinition, EObject mType, EObject mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tSignature, EObject mDefinition, EObject tType, EObject tDefinition,
			EObject mType) {
		...
		return new Object[] { ruleresult, tSignature, mDefinition, tType, tDefinition, mType,
	...
	public static final void pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mTypeToTType, EObject tSignature, EObject mDefinition, EObject tType, EObject tDefinition,
			EObject mType, EObject mSignature, EObject mSignatureToTSignature) {
		_this.registerObjects_FWD(ruleresult, mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType,
				tDefinition, mType, mSignature, mSignatureToTSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_2_2_corematch_blackFFFBFFBBFB(
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tType != null) {
						for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tSignature != null) {
								_result.add(new Object[] { mDefinitionToTMember, mTypeToTType, tSignature, mDefinition,
										tType, tDefinition, mType, mSignature, mSignatureToTSignature, match });
							}
								...
								if (mSignature.getMDefinitions().contains(mDefinition)) {
									if (mSignature.equals(mSignatureToTSignature.getSource())) {
										if (tSignature.equals(mSignatureToTSignature.getTarget())) {
											_result.add(new Object[] { mDefinitionToTMember, mTypeToTType, tSignature,
													mDefinition, tType, tDefinition, mType, mSignature,
													mSignatureToTSignature });
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType, tDefinition, mType,
				mSignature, mSignatureToTSignature, isApplicableMatch, mDefinitionToTMember__mDefinition____source,
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinitionToTMember, mTypeToTType, tSignature,
					mDefinition, tType, tDefinition, mType, mSignature, mSignatureToTSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_2_4_solveCSP_binding = pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType,
				tDefinition, mType, mSignature, mSignatureToTSignature);
	...
	public static final void pattern_LinkDefinitionToType_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mTypeToTType, EObject tSignature, EObject mDefinition, EObject tType, EObject tDefinition,
			EObject mType, EObject mSignature, EObject mSignatureToTSignature) {
		_this.registerObjects_BWD(ruleresult, mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType,
				tDefinition, mType, mSignature, mSignatureToTSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_12_2_corematch_blackFFBFBBFFFB(
										...
										if (mSignature.equals(mSignatureToTSignature.getSource())) {
											if (tSignature.equals(mSignatureToTSignature.getTarget())) {
												_result.add(new Object[] { mDefinitionToTMember, mTypeToTType,
														tSignature, mDefinition, tType, tDefinition, mType, mSignature,
														mSignatureToTSignature });
											}
										}
									}
				...
				if (tmpTType instanceof TAbstractType) {
					...
					if (tmpTDefinition instanceof TMember) {
						...
						if (tmpMType instanceof AbstractTypeDeclaration) {
							...
							if (tmpMSignature instanceof MSignature) {
								MSignature mSignature = (MSignature) tmpMSignature;
								return new Object[] { tSignature, mDefinition, tType, tDefinition, mType, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TSignature tSignature, MDefinition mDefinition, TAbstractType tType, TMember tDefinition,
			AbstractTypeDeclaration mType, MSignature mSignature, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tSignature, mDefinition, tType, tDefinition, mType, mSignature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tSignature, mDefinition, tType, tDefinition, mType, mSignature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
			...
			TMember tDefinition, AbstractTypeDeclaration mType, MSignature mSignature, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tSignature, mDefinition, tType, tDefinition, mType,
				mSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tSignature, mDefinition, tType, tDefinition, mType, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_24_3_solvecsp_binding = pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tSignature, mDefinition, tType, tDefinition, mType, mSignature, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackFFBBBBBBFBB(
			TSignature tSignature, MDefinition mDefinition, TAbstractType tType, TMember tDefinition,
			AbstractTypeDeclaration mType, MSignature mSignature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tSignature, mDefinition, tType, tDefinition, mType, mSignature, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mDefinitionToTMember, mTypeToTType,
				tSignature, mDefinition, tType, tDefinition, mType, mSignature, mSignatureToTSignature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinitionToTMember, mTypeToTType, tSignature,
					mDefinition, tType, tDefinition, mType, mSignature, mSignatureToTSignature, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_29_3_solveCSP_binding = pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType,
				tDefinition, mType, mSignature, mSignatureToTSignature, ruleResult);
	...
	public static final Object[] pattern_LinkDefinitionToType_29_6_perform_blackBBBBBBBBBB(
			MDefinitionToTMember mDefinitionToTMember, TypeToTAbstractType mTypeToTType, TSignature tSignature,
			MDefinition mDefinition, TAbstractType tType, TMember tDefinition, AbstractTypeDeclaration mType,
			MSignature mSignature, MSignatureToTSignature mSignatureToTSignature, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mDefinitionToTMember, mTypeToTType, tSignature, mDefinition, tType, tDefinition, mType,
				mSignature, mSignatureToTSignature, ruleResult };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(TSignature tSignature,
		...
		return new Object[] { tSignature, mDefinition, tType, tDefinition, mType, ruleResult };
	}
