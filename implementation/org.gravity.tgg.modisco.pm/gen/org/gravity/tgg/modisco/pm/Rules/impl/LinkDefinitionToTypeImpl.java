...
public class LinkDefinitionToTypeImpl extends AbstractRuleImpl implements LinkDefinitionToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mType,
						mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType,
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature, tSignature,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_2_2_corematch_blackBFFBFBFFFB(mType, mDefinition, mSignature, match)) {
			...
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_2_3_findcontext_blackBBBBBBBBB(mType, mDefinitionToTMember,
							tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType,
							mSignatureToTSignature)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(mType,
								mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature, tSignature,
								tType, mSignatureToTSignature);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this, isApplicableMatch,
								mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature,
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ tDefinition + ", " + "[mDefinition] = " + mDefinition + ", " + "[mTypeToTType] = "
							+ mTypeToTType + ", " + "[mSignature] = " + mSignature + ", " + "[tSignature] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AbstractTypeDeclaration mType,
			MDefinitionToTMember mDefinitionToTMember, TMember tDefinition, MDefinition mDefinition,
			TypeToTAbstractType mTypeToTType, MSignature mSignature, TSignature tSignature, TAbstractType tType,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mType, EObject mDefinitionToTMember,
			EObject tDefinition, EObject mDefinition, EObject mTypeToTType, EObject mSignature, EObject tSignature,
			EObject tType, EObject mSignatureToTSignature) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mType,
						mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType,
						mSignatureToTSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_12_2_corematch_blackFFBFFFBBFB(tDefinition, tSignature, tType, match)) {
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_12_3_findcontext_blackBBBBBBBBB(mType, mDefinitionToTMember,
							tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType,
							mSignatureToTSignature)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(mType,
								mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature, tSignature,
								tType, mSignatureToTSignature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[9];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mType, EObject mDefinitionToTMember,
			EObject tDefinition, EObject mDefinition, EObject mTypeToTType, EObject mSignature, EObject tSignature,
			EObject tType, EObject mSignatureToTSignature) {
		ruleresult.registerObject("mType", mType);
		ruleresult.registerObject("mDefinitionToTMember", mDefinitionToTMember);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_74(EMoflonEdge _edge_signature) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_77(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mType, tDefinition,
						mDefinition, mSignature, tSignature, tType, sourceMatch, targetMatch);
		...
		if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackBFBBFBBBFBB(mType, tDefinition,
							mDefinition, mSignature, tSignature, tType, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(mType, tDefinition,
								mDefinition, mSignature, tSignature, tType, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AbstractTypeDeclaration mType, TMember tDefinition, MDefinition mDefinition,
			MSignature mSignature, TSignature tSignature, TAbstractType tType, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this, isApplicableMatch,
							mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature, tSignature,
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ "[mSignature] = " + mSignature + ", " + "[tSignature] = " + tSignature + ", " + "[tType] = "
			...
			if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_29_5_checknacs_blackBBBBBBBBB(mType, mDefinitionToTMember,
								tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType,
								mSignatureToTSignature);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToTypeImpl
							.pattern_LinkDefinitionToType_29_6_perform_blackBBBBBBBBBB(mType, mDefinitionToTMember,
									tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_TYPETOTABSTRACTTYPE_MSIGNATURE_TSIGNATURE_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractTypeDeclaration) arguments.get(1), (MDefinitionToTMember) arguments.get(2),
					(TMember) arguments.get(3), (MDefinition) arguments.get(4), (TypeToTAbstractType) arguments.get(5),
					(MSignature) arguments.get(6), (TSignature) arguments.get(7), (TAbstractType) arguments.get(8),
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_TYPETOTABSTRACTTYPE_MSIGNATURE_TSIGNATURE_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_74__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_74((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_77__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__ABSTRACTTYPEDECLARATION_TMEMBER_MDEFINITION_MSIGNATURE_TSIGNATURE_TABSTRACTTYPE_MATCH_MATCH:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_TYPETOTABSTRACTTYPE_MSIGNATURE_TSIGNATURE_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE_MODELGENERATORRULERESULT:
								...
								if (tmpTSignature instanceof TSignature) {
									...
									if (tmpTType instanceof TAbstractType) {
										...
										if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
											...
											return new Object[] { mType, mDefinitionToTMember, tDefinition, mDefinition,
													mTypeToTType, mSignature, tSignature, tType, mSignatureToTSignature,
													isApplicableMatch };
										}
									}
								}
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
			AbstractTypeDeclaration mType, MDefinitionToTMember mDefinitionToTMember, TMember tDefinition,
			MDefinition mDefinition, TypeToTAbstractType mTypeToTType, MSignature mSignature, TSignature tSignature,
			TAbstractType tType, MSignatureToTSignature mSignatureToTSignature, LinkDefinitionToType _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_1_1_performtransformation_black = pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
					mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mType, EObject mDefinitionToTMember, EObject tDefinition,
			EObject mDefinition, EObject mTypeToTType, EObject mSignature, EObject tSignature, EObject tType,
	...
	public static final void pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(
			LinkDefinitionToType _this, PerformRuleResult ruleresult, EObject mType, EObject mDefinitionToTMember,
			EObject tDefinition, EObject mDefinition, EObject mTypeToTType, EObject mSignature, EObject tSignature,
			EObject tType, EObject mSignatureToTSignature) {
		_this.registerObjects_FWD(ruleresult, mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType,
				mSignature, tSignature, tType, mSignatureToTSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_2_2_corematch_blackBFFBFBFFFB(
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tType != null) {
						for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tSignature != null) {
								_result.add(new Object[] { mType, mDefinitionToTMember, tDefinition, mDefinition,
										mTypeToTType, mSignature, tSignature, tType, mSignatureToTSignature, match });
							}
								...
								if (tSignature.equals(mSignatureToTSignature.getTarget())) {
									if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
										if (tType.equals(mTypeToTType.getTarget())) {
											_result.add(new Object[] { mType, mDefinitionToTMember, tDefinition,
													mDefinition, mTypeToTType, mSignature, tSignature, tType,
													mSignatureToTSignature });
										}
									}
								}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature,
				...
				mDefinition__mType____abstractTypeDeclaration, mDefinitionToTMember__mDefinition____source,
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TypeToTAbstractType mTypeToTType, MSignature mSignature, TSignature tSignature, TAbstractType tType,
			MSignatureToTSignature mSignatureToTSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mType, mDefinitionToTMember,
				tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType, mSignatureToTSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mDefinitionToTMember, tDefinition, mDefinition,
					mTypeToTType, mSignature, tSignature, tType, mSignatureToTSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_2_4_solveCSP_binding = pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType,
				mSignature, tSignature, tType, mSignatureToTSignature);
		if (result_pattern_LinkDefinitionToType_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_LinkDefinitionToType_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mType, mDefinitionToTMember, tDefinition,
						mDefinition, mTypeToTType, mSignature, tSignature, tType, mSignatureToTSignature };
			}
		}
		return null;
	}
	...
	public static final void pattern_LinkDefinitionToType_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tDefinition, EObject mDefinition, EObject mTypeToTType, EObject mSignature, EObject tSignature,
			EObject tType, EObject mSignatureToTSignature) {
		_this.registerObjects_BWD(ruleresult, mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType,
				mSignature, tSignature, tType, mSignatureToTSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_12_2_corematch_blackFFBFFFBBFB(
	...
	public static final Object[] pattern_LinkDefinitionToType_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(
		...
		mTypeToTType__tType____target.setName(mTypeToTType__tType____target_name_prime);
		return new Object[] { mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType, mSignature,
				tSignature, tType, mSignatureToTSignature, isApplicableMatch,
	...
	public static final Object[] pattern_LinkDefinitionToType_12_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TypeToTAbstractType mTypeToTType, MSignature mSignature, TSignature tSignature, TAbstractType tType,
			MSignatureToTSignature mSignatureToTSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mType, mDefinitionToTMember,
				tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType, mSignatureToTSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mDefinitionToTMember, tDefinition, mDefinition,
				...
				if (tmpMDefinition instanceof MDefinition) {
					...
					if (tmpMSignature instanceof MSignature) {
						...
						if (tmpTSignature instanceof TSignature) {
							...
							if (tmpTType instanceof TAbstractType) {
								TAbstractType tType = (TAbstractType) tmpTType;
								return new Object[] { mType, tDefinition, mDefinition, mSignature, tSignature, tType,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
			AbstractTypeDeclaration mType, TMember tDefinition, MDefinition mDefinition, MSignature mSignature,
			TSignature tSignature, TAbstractType tType, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mType, tDefinition, mDefinition, mSignature, tSignature, tType, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mType, tDefinition, mDefinition, mSignature, tSignature, tType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToType _this, AbstractTypeDeclaration mType, TMember tDefinition, MDefinition mDefinition,
			MSignature mSignature, TSignature tSignature, TAbstractType tType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mType, tDefinition, mDefinition, mSignature, tSignature,
				tType, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mType, tDefinition, mDefinition, mSignature, tSignature, tType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_24_3_solvecsp_binding = pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mType, tDefinition, mDefinition, mSignature, tSignature, tType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackBFBBFBBBFBB(
			AbstractTypeDeclaration mType, TMember tDefinition, MDefinition mDefinition, MSignature mSignature,
			TSignature tSignature, TAbstractType tType, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mType, tDefinition, mDefinition, mSignature, tSignature, tType, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mType, mDefinitionToTMember,
				tDefinition, mDefinition, mTypeToTType, mSignature, tSignature, tType, mSignatureToTSignature,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mDefinitionToTMember, tDefinition, mDefinition,
					mTypeToTType, mSignature, tSignature, tType, mSignatureToTSignature, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_29_3_solveCSP_binding = pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, mType, mDefinitionToTMember, tDefinition, mDefinition, mTypeToTType,
				mSignature, tSignature, tType, mSignatureToTSignature, ruleResult);
		if (result_pattern_LinkDefinitionToType_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_LinkDefinitionToType_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mType, mDefinitionToTMember, tDefinition,
						mDefinition, mTypeToTType, mSignature, tSignature, tType, mSignatureToTSignature, ruleResult };
			}
		}
		return null;
	}
