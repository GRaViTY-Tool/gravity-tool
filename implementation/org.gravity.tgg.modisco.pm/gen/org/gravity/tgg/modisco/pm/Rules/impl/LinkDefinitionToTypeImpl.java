...
public class LinkDefinitionToTypeImpl extends AbstractRuleImpl implements LinkDefinitionToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result1_bindingAndBlack[8];
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						mSignatureToTSignature, tDefinition, mType, tType, mSignature, mDefinitionToTMember,
						mDefinition, tSignature, mTypeToTType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[tDefinition] = "
					+ tDefinition + ", " + "[mType] = " + mType + ", " + "[tType] = " + tType + ", " + "[mSignature] = "
					+ mSignature + ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember + ", " + "[mDefinition] = "
					+ mDefinition + ", " + "[tSignature] = " + tSignature + ", " + "[mTypeToTType] = " + mTypeToTType
					+ ".");
		}
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				tDefinition, mType, tType, mDefinition, tSignature);
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mSignatureToTSignature, tDefinition, mType, tType, mSignature, mDefinitionToTMember,
				mDefinition, tSignature, mTypeToTType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_2_2_corematch_blackFFBFBFBFFB(mType, mSignature, mDefinition, match)) {
			...
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_2_3_findcontext_blackBBBBBBBBB(mSignatureToTSignature, tDefinition,
							mType, tType, mSignature, mDefinitionToTMember, mDefinition, tSignature, mTypeToTType)) {
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mSignatureToTSignature + ", " + "[tDefinition] = " + tDefinition + ", " + "[mType] = "
							+ mType + ", " + "[tType] = " + tType + ", " + "[mSignature] = " + mSignature + ", "
							+ "[mDefinitionToTMember] = " + mDefinitionToTMember + ", " + "[mDefinition] = "
							+ mDefinition + ", " + "[tSignature] = " + tSignature + ", " + "[mTypeToTType] = "
							+ mTypeToTType + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			MSignatureToTSignature mSignatureToTSignature, TMember tDefinition, AbstractTypeDeclaration mType,
			TAbstractType tType, MSignature mSignature, MDefinitionToTMember mDefinitionToTMember,
			MDefinition mDefinition, TSignature tSignature, TypeToTAbstractType mTypeToTType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mSignatureToTSignature, EObject tDefinition,
			EObject mType, EObject tType, EObject mSignature, EObject mDefinitionToTMember, EObject mDefinition,
			EObject tSignature, EObject mTypeToTType) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_12_2_corematch_blackFBFBFFFBFB(tDefinition, tType, tSignature, match)) {
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_12_3_findcontext_blackBBBBBBBBB(mSignatureToTSignature, tDefinition,
							mType, tType, mSignature, mDefinitionToTMember, mDefinition, tSignature, mTypeToTType)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mSignatureToTSignature, EObject tDefinition,
			EObject mType, EObject tType, EObject mSignature, EObject mDefinitionToTMember, EObject mDefinition,
			EObject tSignature, EObject mTypeToTType) {
		ruleresult.registerObject("mSignatureToTSignature", mSignatureToTSignature);
		ruleresult.registerObject("tDefinition", tDefinition);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tDefinition, mType, tType,
						mSignature, mDefinition, tSignature, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tDefinition] = " + tDefinition + ", " + "[mType] = " + mType + ", " + "[tType] = " + tType
		...
		if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackFBBBBFBBFBB(tDefinition, mType, tType,
							mSignature, mDefinition, tSignature, sourceMatch, targetMatch)) {
				...
				TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result5_black[8];
				...
				Object[] result6_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(tDefinition, mType, tType,
								mSignature, mDefinition, tSignature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tDefinition] = "
							+ tDefinition + ", " + "[mType] = " + mType + ", " + "[tType] = " + tType + ", "
							+ "[mSignature] = " + mSignature + ", " + "[mDefinition] = " + mDefinition + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMember tDefinition, AbstractTypeDeclaration mType, TAbstractType tType,
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this, isApplicableMatch,
							mSignatureToTSignature, tDefinition, mType, tType, mSignature, mDefinitionToTMember,
							mDefinition, tSignature, mTypeToTType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSignatureToTSignature] = "
						+ mSignatureToTSignature + ", " + "[tDefinition] = " + tDefinition + ", " + "[mType] = " + mType
						+ ", " + "[tType] = " + tType + ", " + "[mSignature] = " + mSignature + ", "
			...
			if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_29_5_checknacs_blackBBBBBBBBB(mSignatureToTSignature, tDefinition,
								mType, tType, mSignature, mDefinitionToTMember, mDefinition, tSignature, mTypeToTType);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToTypeImpl
							.pattern_LinkDefinitionToType_29_6_perform_blackBBBBBBBBBB(mSignatureToTSignature,
									tDefinition, mType, tType, mSignature, mDefinitionToTMember, mDefinition,
									tSignature, mTypeToTType, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								+ "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[tDefinition] = "
								+ tDefinition + ", " + "[mType] = " + mType + ", " + "[tType] = " + tType + ", "
								+ "[mSignature] = " + mSignature + ", " + "[mDefinitionToTMember] = "
								+ mDefinitionToTMember + ", " + "[mDefinition] = " + mDefinition + ", "
								+ "[tSignature] = " + tSignature + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(tDefinition, mType,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			MSignatureToTSignature mSignatureToTSignature, TMember tDefinition, AbstractTypeDeclaration mType,
			TAbstractType tType, MSignature mSignature, MDefinitionToTMember mDefinitionToTMember,
			MDefinition mDefinition, TSignature tSignature, TypeToTAbstractType mTypeToTType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MSIGNATURETOTSIGNATURE_TMEMBER_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_MSIGNATURE_MDEFINITIONTOTMEMBER_MDEFINITION_TSIGNATURE_TYPETOTABSTRACTTYPE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MSignatureToTSignature) arguments.get(1), (TMember) arguments.get(2),
					(AbstractTypeDeclaration) arguments.get(3), (TAbstractType) arguments.get(4),
					(MSignature) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
					(MDefinition) arguments.get(7), (TSignature) arguments.get(8),
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MSIGNATURETOTSIGNATURE_TMEMBER_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_MSIGNATURE_MDEFINITIONTOTMEMBER_MDEFINITION_TSIGNATURE_TYPETOTABSTRACTTYPE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_10__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TMEMBER_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_MSIGNATURE_MDEFINITION_TSIGNATURE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TMember) arguments.get(0), (AbstractTypeDeclaration) arguments.get(1),
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MSIGNATURETOTSIGNATURE_TMEMBER_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_MSIGNATURE_MDEFINITIONTOTMEMBER_MDEFINITION_TSIGNATURE_TYPETOTABSTRACTTYPE_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(MSignatureToTSignature) arguments.get(1), (TMember) arguments.get(2),
					(AbstractTypeDeclaration) arguments.get(3), (TAbstractType) arguments.get(4),
					(MSignature) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
					(MDefinition) arguments.get(7), (TSignature) arguments.get(8),
					(TypeToTAbstractType) arguments.get(9), (ModelgeneratorRuleResult) arguments.get(10));
								...
								if (tmpMDefinition instanceof MDefinition) {
									...
									if (tmpTSignature instanceof TSignature) {
										...
										if (tmpMTypeToTType instanceof TypeToTAbstractType) {
											...
											return new Object[] { mSignatureToTSignature, tDefinition, mType, tType,
													mSignature, mDefinitionToTMember, mDefinition, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mSignatureToTSignature, tDefinition, mType, tType, mSignature,
						mDefinitionToTMember, mDefinition, tSignature, mTypeToTType, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_1_1_performtransformation_binding != null) {
			...
			MSignature mSignature = (MSignature) result_pattern_LinkDefinitionToType_1_1_performtransformation_binding[4];
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_LinkDefinitionToType_1_1_performtransformation_binding[8];
			...
			Object[] result_pattern_LinkDefinitionToType_1_1_performtransformation_black = pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
					mSignatureToTSignature, tDefinition, mType, tType, mSignature, mDefinitionToTMember, mDefinition,
					tSignature, mTypeToTType, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mSignatureToTSignature, EObject tDefinition, EObject mType,
			EObject tType, EObject mSignature, EObject mDefinitionToTMember, EObject mDefinition, EObject tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tDefinition, EObject mType, EObject tType, EObject mDefinition,
			EObject tSignature) {
		EMoflonEdge mType__mDefinition____bodyDeclarations = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mDefinition__mType____abstractTypeDeclaration = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, tDefinition, mType, tType, mDefinition, tSignature,
	...
	public static final void pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tDefinition, EObject mType, EObject tType, EObject mSignature, EObject mDefinitionToTMember,
			EObject mDefinition, EObject tSignature, EObject mTypeToTType) {
		_this.registerObjects_FWD(ruleresult, mSignatureToTSignature, tDefinition, mType, tType, mSignature,
				mDefinitionToTMember, mDefinition, tSignature, mTypeToTType);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_2_2_corematch_blackFFBFBFBFFB(
				...
				for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tDefinition != null) {
						for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tType != null) {
								_result.add(
										new Object[] { mSignatureToTSignature, tDefinition, mType, tType, mSignature,
												mDefinitionToTMember, mDefinition, tSignature, mTypeToTType, match });
							}
								...
								if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
									if (mType.equals(mTypeToTType.getSource())) {
										if (tType.equals(mTypeToTType.getTarget())) {
											_result.add(new Object[] { mSignatureToTSignature, tDefinition, mType,
													tType, mSignature, mDefinitionToTMember, mDefinition, tSignature,
													mTypeToTType });
										}
									}
								}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { mSignatureToTSignature, tDefinition, mType, tType, mSignature, mDefinitionToTMember,
				mDefinition, tSignature, mTypeToTType, isApplicableMatch, mSignature__mDefinition____mDefinitions,
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TAbstractType tType, MSignature mSignature, MDefinitionToTMember mDefinitionToTMember,
			MDefinition mDefinition, TSignature tSignature, TypeToTAbstractType mTypeToTType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mSignatureToTSignature, tDefinition,
				mType, tType, mSignature, mDefinitionToTMember, mDefinition, tSignature, mTypeToTType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSignatureToTSignature, tDefinition, mType, tType,
					mSignature, mDefinitionToTMember, mDefinition, tSignature, mTypeToTType };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_2_4_solveCSP_binding = pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mSignatureToTSignature, tDefinition, mType, tType, mSignature,
				mDefinitionToTMember, mDefinition, tSignature, mTypeToTType);
	...
	public static final Object[] pattern_LinkDefinitionToType_11_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_11_1_performtransformation_binding != null) {
			...
			MSignature mSignature = (MSignature) result_pattern_LinkDefinitionToType_11_1_performtransformation_binding[4];
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_LinkDefinitionToType_11_1_performtransformation_binding[8];
	...
	public static final void pattern_LinkDefinitionToType_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tDefinition, EObject mType, EObject tType, EObject mSignature, EObject mDefinitionToTMember,
			EObject mDefinition, EObject tSignature, EObject mTypeToTType) {
		_this.registerObjects_BWD(ruleresult, mSignatureToTSignature, tDefinition, mType, tType, mSignature,
				mDefinitionToTMember, mDefinition, tSignature, mTypeToTType);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_12_2_corematch_blackFBFBFFFBFB(
								...
								if (tSignature.getDefinitions().contains(tDefinition)) {
									if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
										if (mType.equals(mTypeToTType.getSource())) {
											if (tType.equals(mTypeToTType.getTarget())) {
												_result.add(new Object[] { mSignatureToTSignature, tDefinition, mType,
														tType, mSignature, mDefinitionToTMember, mDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToType_12_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TAbstractType tType, MSignature mSignature, MDefinitionToTMember mDefinitionToTMember,
			MDefinition mDefinition, TSignature tSignature, TypeToTAbstractType mTypeToTType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mSignatureToTSignature, tDefinition,
				mType, tType, mSignature, mDefinitionToTMember, mDefinition, tSignature, mTypeToTType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSignatureToTSignature, tDefinition, mType, tType,
				...
				if (tmpTType instanceof TAbstractType) {
					...
					if (tmpMSignature instanceof MSignature) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpTSignature instanceof TSignature) {
								TSignature tSignature = (TSignature) tmpTSignature;
								return new Object[] { tDefinition, mType, tType, mSignature, mDefinition, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(TMember tDefinition,
			AbstractTypeDeclaration mType, TAbstractType tType, MSignature mSignature, MDefinition mDefinition,
			TSignature tSignature, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tDefinition, mType, tType, mSignature, mDefinition, tSignature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tDefinition, mType, tType, mSignature, mDefinition, tSignature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToType _this, TMember tDefinition, AbstractTypeDeclaration mType, TAbstractType tType,
			MSignature mSignature, MDefinition mDefinition, TSignature tSignature, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tDefinition, mType, tType, mSignature, mDefinition,
				tSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tDefinition, mType, tType, mSignature, mDefinition, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_24_3_solvecsp_binding = pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tDefinition, mType, tType, mSignature, mDefinition, tSignature, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackFBBBBFBBFBB(
			TMember tDefinition, AbstractTypeDeclaration mType, TAbstractType tType, MSignature mSignature,
					...
					for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
							for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
									.getOppositeReferenceTyped(mType, TypeToTAbstractType.class, "source")) {
								if (tType.equals(mTypeToTType.getTarget())) {
									_result.add(new Object[] { mSignatureToTSignature, tDefinition, mType, tType,
											mSignature, mDefinitionToTMember, mDefinition, tSignature, mTypeToTType,
											sourceMatch, targetMatch });
								}
							}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tDefinition, mType, tType, mSignature, mDefinition, tSignature, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mSignatureToTSignature, tDefinition,
				mType, tType, mSignature, mDefinitionToTMember, mDefinition, tSignature, mTypeToTType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSignatureToTSignature, tDefinition, mType, tType,
					mSignature, mDefinitionToTMember, mDefinition, tSignature, mTypeToTType, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_29_3_solveCSP_binding = pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, mSignatureToTSignature, tDefinition, mType, tType, mSignature,
				mDefinitionToTMember, mDefinition, tSignature, mTypeToTType, ruleResult);
	...
	public static final Object[] pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(TMember tDefinition,
			AbstractTypeDeclaration mType, TAbstractType tType, MDefinition mDefinition, TSignature tSignature,
			ModelgeneratorRuleResult ruleResult) {
		mType.getBodyDeclarations().add(mDefinition);
		tType.getSignature().add(tSignature);
		tType.getDefines().add(tDefinition);
		...
		return new Object[] { tDefinition, mType, tType, mDefinition, tSignature, ruleResult };
	}
