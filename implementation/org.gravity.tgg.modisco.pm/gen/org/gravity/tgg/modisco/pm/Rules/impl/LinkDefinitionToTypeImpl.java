...
public class LinkDefinitionToTypeImpl extends AbstractRuleImpl implements LinkDefinitionToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tType, mTypeToTType,
						tDefinition, mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType,
						mSignature);
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				tType, tDefinition, tSignature, mDefinition, mType);
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tType, mTypeToTType, tDefinition, mDefinitionToTMember, tSignature, mDefinition,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_2_2_corematch_blackFFFFFBFBBB(mDefinition, mType, mSignature, match)) {
			...
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_2_3_findcontext_blackBBBBBBBBB(tType, mTypeToTType, tDefinition,
							mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType, mSignature)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(tType, mTypeToTType,
								tDefinition, mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature,
								mType, mSignature);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this, isApplicableMatch,
								tType, mTypeToTType, tDefinition, mDefinitionToTMember, tSignature, mDefinition,
								mSignatureToTSignature, mType, mSignature);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TAbstractType tType,
			TypeToTAbstractType mTypeToTType, TMember tDefinition, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MDefinition mDefinition, MSignatureToTSignature mSignatureToTSignature,
			AbstractTypeDeclaration mType, MSignature mSignature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tType, EObject mTypeToTType,
			EObject tDefinition, EObject mDefinitionToTMember, EObject tSignature, EObject mDefinition,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tType, mTypeToTType,
						tDefinition, mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType,
						mSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_12_2_corematch_blackBFBFBFFFFB(tType, tDefinition, tSignature, match)) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[1];
			MDefinitionToTMember mDefinitionToTMember = (MDefinitionToTMember) result2_black[3];
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_12_3_findcontext_blackBBBBBBBBB(tType, mTypeToTType, tDefinition,
							mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType, mSignature)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(tType, mTypeToTType,
								tDefinition, mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature,
								mType, mSignature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[9];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_5(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tType, tDefinition,
						tSignature, mDefinition, mType, mSignature, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tType] = " + tType + ", " + "[tDefinition] = " + tDefinition + ", " + "[tSignature] = "
					+ tSignature + ", " + "[mDefinition] = " + mDefinition + ", " + "[mType] = " + mType + ", "
		...
		if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackBFBFBBFBBBB(tType, tDefinition, tSignature,
							mDefinition, mType, mSignature, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(tType, tDefinition,
								tSignature, mDefinition, mType, mSignature, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAbstractType tType, TMember tDefinition, TSignature tSignature,
			MDefinition mDefinition, AbstractTypeDeclaration mType, MSignature mSignature, Match sourceMatch,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
			...
			if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_29_5_checknacs_blackBBBBBBBBB(tType, mTypeToTType, tDefinition,
								mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType,
								mSignature);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToTypeImpl
							.pattern_LinkDefinitionToType_29_6_perform_blackBBBBBBBBBB(tType, mTypeToTType, tDefinition,
									mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TAbstractType tType,
			TypeToTAbstractType mTypeToTType, TMember tDefinition, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MDefinition mDefinition, MSignatureToTSignature mSignatureToTSignature,
			AbstractTypeDeclaration mType, MSignature mSignature, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER_TSIGNATURE_MDEFINITION_MSIGNATURETOTSIGNATURE_ABSTRACTTYPEDECLARATION_MSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TAbstractType) arguments.get(1),
					...
					(MDefinition) arguments.get(6), (MSignatureToTSignature) arguments.get(7),
					(AbstractTypeDeclaration) arguments.get(8), (MSignature) arguments.get(9));
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER_TSIGNATURE_MDEFINITION_MSIGNATURETOTSIGNATURE_ABSTRACTTYPEDECLARATION_MSIGNATURE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_5__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_5((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_5__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TABSTRACTTYPE_TMEMBER_TSIGNATURE_MDEFINITION_ABSTRACTTYPEDECLARATION_MSIGNATURE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TAbstractType) arguments.get(0), (TMember) arguments.get(1),
					(TSignature) arguments.get(2), (MDefinition) arguments.get(3),
					(AbstractTypeDeclaration) arguments.get(4), (MSignature) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER_TSIGNATURE_MDEFINITION_MSIGNATURETOTSIGNATURE_ABSTRACTTYPEDECLARATION_MSIGNATURE_MODELGENERATORRULERESULT:
								...
								if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
									...
									if (tmpMType instanceof AbstractTypeDeclaration) {
										...
										if (tmpMSignature instanceof MSignature) {
											...
											return new Object[] { tType, mTypeToTType, tDefinition,
													mDefinitionToTMember, tSignature, mDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
			...
			MDefinitionToTMember mDefinitionToTMember, TSignature tSignature, MDefinition mDefinition,
			MSignatureToTSignature mSignatureToTSignature, AbstractTypeDeclaration mType, MSignature mSignature,
			LinkDefinitionToType _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tType, mTypeToTType, tDefinition, mDefinitionToTMember, tSignature, mDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tType, EObject mTypeToTType, EObject tDefinition,
			EObject mDefinitionToTMember, EObject tSignature, EObject mDefinition, EObject mSignatureToTSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tType, EObject tDefinition, EObject tSignature, EObject mDefinition,
			EObject mType) {
		...
		mType__mDefinition____bodyDeclarations.setName(mType__mDefinition____bodyDeclarations_name_prime);
		mDefinition__mType____abstractTypeDeclaration.setName(mDefinition__mType____abstractTypeDeclaration_name_prime);
		return new Object[] { ruleresult, tType, tDefinition, tSignature, mDefinition, mType,
	...
	public static final void pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(
			LinkDefinitionToType _this, PerformRuleResult ruleresult, EObject tType, EObject mTypeToTType,
			EObject tDefinition, EObject mDefinitionToTMember, EObject tSignature, EObject mDefinition,
			EObject mSignatureToTSignature, EObject mType, EObject mSignature) {
		_this.registerObjects_FWD(ruleresult, tType, mTypeToTType, tDefinition, mDefinitionToTMember, tSignature,
				mDefinition, mSignatureToTSignature, mType, mSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_2_2_corematch_blackFFFFFBFBBB(
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tType != null) {
						for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tSignature != null) {
								_result.add(new Object[] { tType, mTypeToTType, tDefinition, mDefinitionToTMember,
										tSignature, mDefinition, mSignatureToTSignature, mType, mSignature, match });
							}
								...
								if (mSignature.equals(mSignatureToTSignature.getSource())) {
									if (mSignature.getMDefinitions().contains(mDefinition)) {
										if (mType.getBodyDeclarations().contains(mDefinition)) {
											_result.add(new Object[] { tType, mTypeToTType, tDefinition,
													mDefinitionToTMember, tSignature, mDefinition,
													mSignatureToTSignature, mType, mSignature });
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		mDefinition__mType____abstractTypeDeclaration.setName(mDefinition__mType____abstractTypeDeclaration_name_prime);
		return new Object[] { tType, mTypeToTType, tDefinition, mDefinitionToTMember, tSignature, mDefinition,
				mSignatureToTSignature, mType, mSignature, isApplicableMatch, mTypeToTType__tType____target,
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tType, mTypeToTType, tDefinition,
				mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType, mSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tType, mTypeToTType, tDefinition, mDefinitionToTMember,
					tSignature, mDefinition, mSignatureToTSignature, mType, mSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_2_4_solveCSP_binding = pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, tType, mTypeToTType, tDefinition, mDefinitionToTMember, tSignature,
				mDefinition, mSignatureToTSignature, mType, mSignature);
		if (result_pattern_LinkDefinitionToType_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_LinkDefinitionToType_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tType, mTypeToTType, tDefinition,
						mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType, mSignature };
			}
		}
		return null;
	...
	public static final void pattern_LinkDefinitionToType_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tDefinition, EObject mDefinitionToTMember, EObject tSignature, EObject mDefinition,
			EObject mSignatureToTSignature, EObject mType, EObject mSignature) {
		_this.registerObjects_BWD(ruleresult, tType, mTypeToTType, tDefinition, mDefinitionToTMember, tSignature,
				mDefinition, mSignatureToTSignature, mType, mSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_12_2_corematch_blackBFBFBFFFFB(
	...
	public static final Object[] pattern_LinkDefinitionToType_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(
		...
		mDefinition__mSignature____mSignature.setName(mDefinition__mSignature____mSignature_name_prime);
		return new Object[] { tType, mTypeToTType, tDefinition, mDefinitionToTMember, tSignature, mDefinition,
				mSignatureToTSignature, mType, mSignature, isApplicableMatch, tType__tSignature____signature,
				mTypeToTType__tType____target, mDefinitionToTMember__tDefinition____target,
				mSignatureToTSignature__tSignature____target, tType__tDefinition____defines,
	...
	public static final Object[] pattern_LinkDefinitionToType_12_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TSignature tSignature, MDefinition mDefinition, MSignatureToTSignature mSignatureToTSignature,
			AbstractTypeDeclaration mType, MSignature mSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tType, mTypeToTType, tDefinition,
				mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType, mSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tType, mTypeToTType, tDefinition, mDefinitionToTMember,
				...
				if (tmpTSignature instanceof TSignature) {
					...
					if (tmpMDefinition instanceof MDefinition) {
						...
						if (tmpMType instanceof AbstractTypeDeclaration) {
							...
							if (tmpMSignature instanceof MSignature) {
								MSignature mSignature = (MSignature) tmpMSignature;
								return new Object[] { tType, tDefinition, tSignature, mDefinition, mType, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(TAbstractType tType,
			TMember tDefinition, TSignature tSignature, MDefinition mDefinition, AbstractTypeDeclaration mType,
			MSignature mSignature, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tType, tDefinition, tSignature, mDefinition, mType, mSignature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tType, tDefinition, tSignature, mDefinition, mType, mSignature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToType _this, TAbstractType tType, TMember tDefinition, TSignature tSignature,
			MDefinition mDefinition, AbstractTypeDeclaration mType, MSignature mSignature, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tType, tDefinition, tSignature, mDefinition, mType,
				mSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tType, tDefinition, tSignature, mDefinition, mType, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_24_3_solvecsp_binding = pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tType, tDefinition, tSignature, mDefinition, mType, mSignature, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackBFBFBBFBBBB(
			TAbstractType tType, TMember tDefinition, TSignature tSignature, MDefinition mDefinition,
			AbstractTypeDeclaration mType, MSignature mSignature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tType, TypeToTAbstractType.class, "target")) {
	...
	public static final Object[] pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(
			TAbstractType tType, TMember tDefinition, TSignature tSignature, MDefinition mDefinition,
			AbstractTypeDeclaration mType, MSignature mSignature, CCMatch ccMatch) {
		return new Object[] { tType, tDefinition, tSignature, mDefinition, mType, mSignature, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
			...
			TypeToTAbstractType mTypeToTType, TMember tDefinition, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MDefinition mDefinition, MSignatureToTSignature mSignatureToTSignature,
			AbstractTypeDeclaration mType, MSignature mSignature, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tType, mTypeToTType, tDefinition,
				mDefinitionToTMember, tSignature, mDefinition, mSignatureToTSignature, mType, mSignature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tType, mTypeToTType, tDefinition, mDefinitionToTMember,
					tSignature, mDefinition, mSignatureToTSignature, mType, mSignature, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_29_3_solveCSP_binding = pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, tType, mTypeToTType, tDefinition, mDefinitionToTMember, tSignature,
				mDefinition, mSignatureToTSignature, mType, mSignature, ruleResult);
	...
	public static final Object[] pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(TAbstractType tType,
		...
		return new Object[] { tType, tDefinition, tSignature, mDefinition, mType, ruleResult };
	}
