...
public class LinkDefinitionToTypeImpl extends AbstractRuleImpl implements LinkDefinitionToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mType, mTypeToTType,
						mDefinition, mDefinitionToTMember, mSignature, tDefinition, tSignature, tType,
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				mType, mDefinition, tDefinition, tSignature, tType);
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature, tDefinition, tSignature,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_2_2_corematch_blackBFBFBFFFFB(mType, mDefinition, mSignature, match)) {
			...
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_2_3_findcontext_blackBBBBBBBBB(mType, mTypeToTType, mDefinition,
							mDefinitionToTMember, mSignature, tDefinition, tSignature, tType, mSignatureToTSignature)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(mType, mTypeToTType,
								mDefinition, mDefinitionToTMember, mSignature, tDefinition, tSignature, tType,
								mSignatureToTSignature);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this, isApplicableMatch,
								mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature, tDefinition,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AbstractTypeDeclaration mType,
			TypeToTAbstractType mTypeToTType, MDefinition mDefinition, MDefinitionToTMember mDefinitionToTMember,
			MSignature mSignature, TMember tDefinition, TSignature tSignature, TAbstractType tType,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType,
			EObject mDefinition, EObject mDefinitionToTMember, EObject mSignature, EObject tDefinition,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mType, mTypeToTType,
						mDefinition, mDefinitionToTMember, mSignature, tDefinition, tSignature, tType,
						mSignatureToTSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_12_2_corematch_blackFFFFFBBBFB(tDefinition, tSignature, tType, match)) {
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_12_3_findcontext_blackBBBBBBBBB(mType, mTypeToTType, mDefinition,
							mDefinitionToTMember, mSignature, tDefinition, tSignature, tType, mSignatureToTSignature)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(mType, mTypeToTType,
								mDefinition, mDefinitionToTMember, mSignature, tDefinition, tSignature, tType,
								mSignatureToTSignature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[9];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_43(EMoflonEdge _edge_defines) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mType, mDefinition,
						mSignature, tDefinition, tSignature, tType, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mType] = " + mType + ", " + "[mDefinition] = " + mDefinition + ", " + "[mSignature] = "
					+ mSignature + ", " + "[tDefinition] = " + tDefinition + ", " + "[tSignature] = " + tSignature
		...
		if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackBFBFBBBBFBB(mType, mDefinition, mSignature,
							tDefinition, tSignature, tType, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(mType, mDefinition,
								mSignature, tDefinition, tSignature, tType, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AbstractTypeDeclaration mType, MDefinition mDefinition, MSignature mSignature,
			TMember tDefinition, TSignature tSignature, TAbstractType tType, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this, isApplicableMatch,
							mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature, tDefinition, tSignature,
			...
			if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_29_5_checknacs_blackBBBBBBBBB(mType, mTypeToTType, mDefinition,
								mDefinitionToTMember, mSignature, tDefinition, tSignature, tType,
								mSignatureToTSignature);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToTypeImpl
							.pattern_LinkDefinitionToType_29_6_perform_blackBBBBBBBBBB(mType, mTypeToTType, mDefinition,
									mDefinitionToTMember, mSignature, tDefinition, tSignature, tType,
					...
					LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(mType, mDefinition,
							tDefinition, tSignature, tType, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITION_MDEFINITIONTOTMEMBER_MSIGNATURE_TMEMBER_TSIGNATURE_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractTypeDeclaration) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(MDefinition) arguments.get(3), (MDefinitionToTMember) arguments.get(4),
					(MSignature) arguments.get(5), (TMember) arguments.get(6), (TSignature) arguments.get(7),
					(TAbstractType) arguments.get(8), (MSignatureToTSignature) arguments.get(9));
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITION_MDEFINITIONTOTMEMBER_MSIGNATURE_TMEMBER_TSIGNATURE_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_43__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_43((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_47__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__ABSTRACTTYPEDECLARATION_MDEFINITION_MSIGNATURE_TMEMBER_TSIGNATURE_TABSTRACTTYPE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((AbstractTypeDeclaration) arguments.get(0), (MDefinition) arguments.get(1),
					(MSignature) arguments.get(2), (TMember) arguments.get(3), (TSignature) arguments.get(4),
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITION_MDEFINITIONTOTMEMBER_MSIGNATURE_TMEMBER_TSIGNATURE_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE_MODELGENERATORRULERESULT:
								...
								if (tmpTSignature instanceof TSignature) {
									...
									if (tmpTType instanceof TAbstractType) {
										...
										if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
											...
											return new Object[] { mType, mTypeToTType, mDefinition,
													mDefinitionToTMember, mSignature, tDefinition, tSignature, tType,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
			AbstractTypeDeclaration mType, TypeToTAbstractType mTypeToTType, MDefinition mDefinition,
			MDefinitionToTMember mDefinitionToTMember, MSignature mSignature, TMember tDefinition,
			TSignature tSignature, TAbstractType tType, MSignatureToTSignature mSignatureToTSignature,
			LinkDefinitionToType _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature, tDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_1_1_performtransformation_black = pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
					mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature, tDefinition, tSignature, tType,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType, EObject mDefinition,
			EObject mDefinitionToTMember, EObject mSignature, EObject tDefinition, EObject tSignature, EObject tType,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mType, EObject mDefinition, EObject tDefinition, EObject tSignature,
			EObject tType) {
		EMoflonEdge mType__mDefinition____bodyDeclarations = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mDefinition__mType____abstractTypeDeclaration = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mType, mDefinition, tDefinition, tSignature, tType,
	...
	public static final void pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(
			LinkDefinitionToType _this, PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType,
			EObject mDefinition, EObject mDefinitionToTMember, EObject mSignature, EObject tDefinition,
			EObject tSignature, EObject tType, EObject mSignatureToTSignature) {
		_this.registerObjects_FWD(ruleresult, mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature,
				tDefinition, tSignature, tType, mSignatureToTSignature);
				...
				for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tSignature != null) {
						for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tDefinition != null) {
								_result.add(new Object[] { mType, mTypeToTType, mDefinition, mDefinitionToTMember,
										mSignature, tDefinition, tSignature, tType, mSignatureToTSignature, match });
							}
								...
								if (mSignature.equals(mSignatureToTSignature.getSource())) {
									if (mDefinition.equals(mDefinitionToTMember.getSource())) {
										if (tSignature.equals(mSignatureToTSignature.getTarget())) {
											_result.add(new Object[] { mType, mTypeToTType, mDefinition,
													mDefinitionToTMember, mSignature, tDefinition, tSignature, tType,
													mSignatureToTSignature });
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			MSignature mSignature, TMember tDefinition, TSignature tSignature, TAbstractType tType,
			MSignatureToTSignature mSignatureToTSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mType, mTypeToTType, mDefinition,
				mDefinitionToTMember, mSignature, tDefinition, tSignature, tType, mSignatureToTSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, mDefinition, mDefinitionToTMember,
					mSignature, tDefinition, tSignature, tType, mSignatureToTSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_2_4_solveCSP_binding = pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature,
				tDefinition, tSignature, tType, mSignatureToTSignature);
		if (result_pattern_LinkDefinitionToType_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_LinkDefinitionToType_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, mDefinition,
						mDefinitionToTMember, mSignature, tDefinition, tSignature, tType, mSignatureToTSignature };
			}
		}
		return null;
	...
	public static final void pattern_LinkDefinitionToType_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mDefinition, EObject mDefinitionToTMember, EObject mSignature, EObject tDefinition,
			EObject tSignature, EObject tType, EObject mSignatureToTSignature) {
		_this.registerObjects_BWD(ruleresult, mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature,
				tDefinition, tSignature, tType, mSignatureToTSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_12_2_corematch_blackFFFFFBBBFB(
								...
								if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
									if (mSignature.equals(mSignatureToTSignature.getSource())) {
										if (mDefinition.equals(mDefinitionToTMember.getSource())) {
											if (tSignature.equals(mSignatureToTSignature.getTarget())) {
												_result.add(new Object[] { mType, mTypeToTType, mDefinition,
														mDefinitionToTMember, mSignature, tDefinition, tSignature,
														tType, mSignatureToTSignature });
											}
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToType_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(
		...
		return new Object[] { mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature, tDefinition,
				...
				mDefinition__mSignature____mSignature, mTypeToTType__mType____source,
				tSignature__tDefinition____definitions, tDefinition__tSignature____signature,
				mTypeToTType__tType____target, tType__tDefinition____defines, tDefinition__tType____definedBy,
				tType__tSignature____signature, mDefinitionToTMember__tDefinition____target,
				mSignatureToTSignature__mSignature____source, mDefinitionToTMember__mDefinition____source,
				mSignatureToTSignature__tSignature____target };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_12_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			MSignature mSignature, TMember tDefinition, TSignature tSignature, TAbstractType tType,
			MSignatureToTSignature mSignatureToTSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mType, mTypeToTType, mDefinition,
				mDefinitionToTMember, mSignature, tDefinition, tSignature, tType, mSignatureToTSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, mDefinition, mDefinitionToTMember,
				...
				if (tmpMSignature instanceof MSignature) {
					...
					if (tmpTDefinition instanceof TMember) {
						...
						if (tmpTSignature instanceof TSignature) {
							...
							if (tmpTType instanceof TAbstractType) {
								TAbstractType tType = (TAbstractType) tmpTType;
								return new Object[] { mType, mDefinition, mSignature, tDefinition, tSignature, tType,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
			AbstractTypeDeclaration mType, MDefinition mDefinition, MSignature mSignature, TMember tDefinition,
			TSignature tSignature, TAbstractType tType, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mType, mDefinition, mSignature, tDefinition, tSignature, tType, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mType, mDefinition, mSignature, tDefinition, tSignature, tType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToType _this, AbstractTypeDeclaration mType, MDefinition mDefinition, MSignature mSignature,
			TMember tDefinition, TSignature tSignature, TAbstractType tType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mType, mDefinition, mSignature, tDefinition, tSignature,
				tType, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mType, mDefinition, mSignature, tDefinition, tSignature, tType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_24_3_solvecsp_binding = pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mType, mDefinition, mSignature, tDefinition, tSignature, tType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackBFBFBBBBFBB(
			AbstractTypeDeclaration mType, MDefinition mDefinition, MSignature mSignature, TMember tDefinition,
			TSignature tSignature, TAbstractType tType, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mType, mDefinition, mSignature, tDefinition, tSignature, tType, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mType, mTypeToTType, mDefinition,
				mDefinitionToTMember, mSignature, tDefinition, tSignature, tType, mSignatureToTSignature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, mDefinition, mDefinitionToTMember,
					mSignature, tDefinition, tSignature, tType, mSignatureToTSignature, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_29_3_solveCSP_binding = pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, mType, mTypeToTType, mDefinition, mDefinitionToTMember, mSignature,
				tDefinition, tSignature, tType, mSignatureToTSignature, ruleResult);
	...
	public static final Object[] pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(AbstractTypeDeclaration mType,
			MDefinition mDefinition, TMember tDefinition, TSignature tSignature, TAbstractType tType,
			ModelgeneratorRuleResult ruleResult) {
		mType.getBodyDeclarations().add(mDefinition);
		tType.getDefines().add(tDefinition);
		tType.getSignature().add(tSignature);
		...
		return new Object[] { mType, mDefinition, tDefinition, tSignature, tType, ruleResult };
	}
