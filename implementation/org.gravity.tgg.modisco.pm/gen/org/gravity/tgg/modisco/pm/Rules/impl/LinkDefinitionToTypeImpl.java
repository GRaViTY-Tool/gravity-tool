...
public class LinkDefinitionToTypeImpl extends AbstractRuleImpl implements LinkDefinitionToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember,
						tSignature, mSignature, mDefinition);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[mTypeToTType] = "
					+ mTypeToTType + ", " + "[tType] = " + tType + ", " + "[tDefinition] = " + tDefinition + ", "
					+ "[mType] = " + mType + ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember + ", "
					+ "[tSignature] = " + tSignature + ", " + "[mSignature] = " + mSignature + ", " + "[mDefinition] = "
					+ mDefinition + ".");
		}
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				tType, tDefinition, mType, tSignature, mDefinition);
		//nothing EMoflonEdge tType__tSignature____signature = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mType__mDefinition____bodyDeclarations = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mDefinition__mType____abstractTypeDeclaration = (EMoflonEdge) result3_green[8];
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember,
				tSignature, mSignature, mDefinition);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_2_2_corematch_blackFFFFBFFBBB(mType, mSignature, mDefinition, match)) {
			...
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_2_3_findcontext_blackBBBBBBBBB(mSignatureToTSignature, mTypeToTType,
							tType, tDefinition, mType, mDefinitionToTMember, tSignature, mSignature, mDefinition)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
								mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember,
								tSignature, mSignature, mDefinition);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mSignatureToTSignature + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tType] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			MSignatureToTSignature mSignatureToTSignature, TypeToTAbstractType mTypeToTType, TAbstractType tType,
			TMember tDefinition, AbstractTypeDeclaration mType, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MSignature mSignature, MDefinition mDefinition) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mSignatureToTSignature, EObject mTypeToTType,
			EObject tType, EObject tDefinition, EObject mType, EObject mDefinitionToTMember, EObject tSignature,
			EObject mSignature, EObject mDefinition) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember,
						tSignature, mSignature, mDefinition);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_12_2_corematch_blackFFBBFFBFFB(tType, tDefinition, tSignature, match)) {
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result2_black[0];
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[1];
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_12_3_findcontext_blackBBBBBBBBB(mSignatureToTSignature, mTypeToTType,
							tType, tDefinition, mType, mDefinitionToTMember, tSignature, mSignature, mDefinition)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mSignatureToTSignature, EObject mTypeToTType,
			EObject tType, EObject tDefinition, EObject mType, EObject mDefinitionToTMember, EObject tSignature,
			EObject mSignature, EObject mDefinition) {
		ruleresult.registerObject("mSignatureToTSignature", mSignatureToTSignature);
		ruleresult.registerObject("mTypeToTType", mTypeToTType);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_170(EMoflonEdge _edge_signature) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_181(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tType, tDefinition, mType,
						tSignature, mSignature, mDefinition, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tType] = " + tType + ", " + "[tDefinition] = " + tDefinition + ", " + "[mType] = " + mType
		...
		if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackFFBBBFBBBBB(tType, tDefinition, mType,
							tSignature, mSignature, mDefinition, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(tType, tDefinition, mType,
								tSignature, mSignature, mDefinition, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tType] = " + tType + ", "
							+ "[tDefinition] = " + tDefinition + ", " + "[mType] = " + mType + ", " + "[tSignature] = "
							+ tSignature + ", " + "[mSignature] = " + mSignature + ", " + "[mDefinition] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAbstractType tType, TMember tDefinition, AbstractTypeDeclaration mType,
			TSignature tSignature, MSignature mSignature, MDefinition mDefinition, Match sourceMatch,
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this, isApplicableMatch,
							mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember,
							tSignature, mSignature, mDefinition, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSignatureToTSignature] = "
						+ mSignatureToTSignature + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tType] = "
			...
			if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_29_5_checknacs_blackBBBBBBBBB(mSignatureToTSignature,
								mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember, tSignature, mSignature,
								mDefinition);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToTypeImpl
							.pattern_LinkDefinitionToType_29_6_perform_blackBBBBBBBBBB(mSignatureToTSignature,
									mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember, tSignature,
									mSignature, mDefinition, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								+ "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[mTypeToTType] = "
								+ mTypeToTType + ", " + "[tType] = " + tType + ", " + "[tDefinition] = " + tDefinition
								+ ", " + "[mType] = " + mType + ", " + "[mDefinitionToTMember] = "
								+ mDefinitionToTMember + ", " + "[tSignature] = " + tSignature + ", "
								+ "[mSignature] = " + mSignature + ", " + "[mDefinition] = " + mDefinition + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(tType, tDefinition,
							mType, tSignature, mDefinition, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			MSignatureToTSignature mSignatureToTSignature, TypeToTAbstractType mTypeToTType, TAbstractType tType,
			TMember tDefinition, AbstractTypeDeclaration mType, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MSignature mSignature, MDefinition mDefinition,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MSIGNATURETOTSIGNATURE_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TMEMBER_ABSTRACTTYPEDECLARATION_MDEFINITIONTOTMEMBER_TSIGNATURE_MSIGNATURE_MDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MSignatureToTSignature) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TAbstractType) arguments.get(3), (TMember) arguments.get(4),
					(AbstractTypeDeclaration) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
					(TSignature) arguments.get(7), (MSignature) arguments.get(8), (MDefinition) arguments.get(9));
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MSIGNATURETOTSIGNATURE_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TMEMBER_ABSTRACTTYPEDECLARATION_MDEFINITIONTOTMEMBER_TSIGNATURE_MSIGNATURE_MDEFINITION:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_170__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_170((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_181__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TABSTRACTTYPE_TMEMBER_ABSTRACTTYPEDECLARATION_TSIGNATURE_MSIGNATURE_MDEFINITION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TAbstractType) arguments.get(0), (TMember) arguments.get(1),
					(AbstractTypeDeclaration) arguments.get(2), (TSignature) arguments.get(3),
					(MSignature) arguments.get(4), (MDefinition) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MSIGNATURETOTSIGNATURE_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TMEMBER_ABSTRACTTYPEDECLARATION_MDEFINITIONTOTMEMBER_TSIGNATURE_MSIGNATURE_MDEFINITION_MODELGENERATORRULERESULT:
								...
								if (tmpTSignature instanceof TSignature) {
									...
									if (tmpMSignature instanceof MSignature) {
										...
										if (tmpMDefinition instanceof MDefinition) {
											...
											return new Object[] { mSignatureToTSignature, mTypeToTType, tType,
													tDefinition, mType, mDefinitionToTMember, tSignature, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
			MSignatureToTSignature mSignatureToTSignature, TypeToTAbstractType mTypeToTType, TAbstractType tType,
			TMember tDefinition, AbstractTypeDeclaration mType, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MSignature mSignature, MDefinition mDefinition, LinkDefinitionToType _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType,
						mDefinitionToTMember, tSignature, mSignature, mDefinition, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_1_1_performtransformation_binding != null) {
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result_pattern_LinkDefinitionToType_1_1_performtransformation_binding[0];
			...
			TMember tDefinition = (TMember) result_pattern_LinkDefinitionToType_1_1_performtransformation_binding[3];
			...
			MDefinition mDefinition = (MDefinition) result_pattern_LinkDefinitionToType_1_1_performtransformation_binding[8];
			...
			Object[] result_pattern_LinkDefinitionToType_1_1_performtransformation_black = pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
					mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mSignatureToTSignature, EObject mTypeToTType, EObject tType,
			EObject tDefinition, EObject mType, EObject mDefinitionToTMember, EObject tSignature, EObject mSignature,
			EObject mDefinition) {
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tType, EObject tDefinition, EObject mType, EObject tSignature,
			EObject mDefinition) {
		...
		return new Object[] { ruleresult, tType, tDefinition, mType, tSignature, mDefinition,
				tType__tSignature____signature, mType__mDefinition____bodyDeclarations,
				mDefinition__mType____abstractTypeDeclaration, tType__tDefinition____defines,
	...
	public static final void pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(
			LinkDefinitionToType _this, PerformRuleResult ruleresult, EObject mSignatureToTSignature,
			EObject mTypeToTType, EObject tType, EObject tDefinition, EObject mType, EObject mDefinitionToTMember,
			EObject tSignature, EObject mSignature, EObject mDefinition) {
		_this.registerObjects_FWD(ruleresult, mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType,
				mDefinitionToTMember, tSignature, mSignature, mDefinition);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_2_2_corematch_blackFFFFBFFBBB(
				...
				for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tSignature != null) {
						for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tDefinition != null) {
								_result.add(new Object[] { mSignatureToTSignature, mTypeToTType, tType, tDefinition,
										mType, mDefinitionToTMember, tSignature, mSignature, mDefinition, match });
							}
								...
								if (mSignature.getMDefinitions().contains(mDefinition)) {
									if (mSignature.equals(mSignatureToTSignature.getSource())) {
										if (mDefinition.equals(mDefinitionToTMember.getSource())) {
											_result.add(new Object[] { mSignatureToTSignature, mTypeToTType, tType,
													tDefinition, mType, mDefinitionToTMember, tSignature, mSignature,
													mDefinition });
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember,
				tSignature, mSignature, mDefinition, isApplicableMatch, mType__mDefinition____bodyDeclarations,
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TMember tDefinition, AbstractTypeDeclaration mType, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MSignature mSignature, MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mSignatureToTSignature, mTypeToTType,
				tType, tDefinition, mType, mDefinitionToTMember, tSignature, mSignature, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSignatureToTSignature, mTypeToTType, tType,
					tDefinition, mType, mDefinitionToTMember, tSignature, mSignature, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_2_4_solveCSP_binding = pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType,
				mDefinitionToTMember, tSignature, mSignature, mDefinition);
	...
	public static final Object[] pattern_LinkDefinitionToType_11_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_11_1_performtransformation_binding != null) {
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result_pattern_LinkDefinitionToType_11_1_performtransformation_binding[0];
			...
			TMember tDefinition = (TMember) result_pattern_LinkDefinitionToType_11_1_performtransformation_binding[3];
			...
			MDefinition mDefinition = (MDefinition) result_pattern_LinkDefinitionToType_11_1_performtransformation_binding[8];
	...
	public static final void pattern_LinkDefinitionToType_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mTypeToTType, EObject tType, EObject tDefinition, EObject mType, EObject mDefinitionToTMember,
			EObject tSignature, EObject mSignature, EObject mDefinition) {
		_this.registerObjects_BWD(ruleresult, mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType,
				mDefinitionToTMember, tSignature, mSignature, mDefinition);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_12_2_corematch_blackFFBBFFBFFB(
								...
								if (tType.getDefines().contains(tDefinition)) {
									if (mSignature.getMDefinitions().contains(mDefinition)) {
										if (mSignature.equals(mSignatureToTSignature.getSource())) {
											if (mDefinition.equals(mDefinitionToTMember.getSource())) {
												_result.add(new Object[] { mSignatureToTSignature, mTypeToTType, tType,
														tDefinition, mType, mDefinitionToTMember, tSignature,
														mSignature, mDefinition });
											}
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToType_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(
		...
		mDefinitionToTMember__mDefinition____source.setName(mDefinitionToTMember__mDefinition____source_name_prime);
		return new Object[] { mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType, mDefinitionToTMember,
				tSignature, mSignature, mDefinition, isApplicableMatch, tType__tSignature____signature,
				mTypeToTType__mType____source, tSignature__tDefinition____definitions,
				...
				tType__tDefinition____defines, tDefinition__tType____definedBy, mSignature__mDefinition____mDefinitions,
				mDefinition__mSignature____mSignature, mSignatureToTSignature__mSignature____source,
				mDefinitionToTMember__mDefinition____source };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_12_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TMember tDefinition, AbstractTypeDeclaration mType, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MSignature mSignature, MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mSignatureToTSignature, mTypeToTType,
				tType, tDefinition, mType, mDefinitionToTMember, tSignature, mSignature, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSignatureToTSignature, mTypeToTType, tType,
				...
				if (tmpMType instanceof AbstractTypeDeclaration) {
					...
					if (tmpTSignature instanceof TSignature) {
						...
						if (tmpMSignature instanceof MSignature) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								MDefinition mDefinition = (MDefinition) tmpMDefinition;
								return new Object[] { tType, tDefinition, mType, tSignature, mSignature, mDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(TAbstractType tType,
			TMember tDefinition, AbstractTypeDeclaration mType, TSignature tSignature, MSignature mSignature,
			MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tType, tDefinition, mType, tSignature, mSignature, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_binding != null) {
			...
			MDefinition mDefinition = (MDefinition) result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tType, tDefinition, mType, tSignature, mSignature, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToType _this, TAbstractType tType, TMember tDefinition, AbstractTypeDeclaration mType,
			TSignature tSignature, MSignature mSignature, MDefinition mDefinition, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tType, tDefinition, mType, tSignature, mSignature,
				mDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tType, tDefinition, mType, tSignature, mSignature, mDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_24_3_solvecsp_binding = pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tType, tDefinition, mType, tSignature, mSignature, mDefinition, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackFFBBBFBBBBB(
					...
					for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mDefinition.equals(mDefinitionToTMember.getSource())) {
							for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (mSignature.equals(mSignatureToTSignature.getSource())) {
									_result.add(new Object[] { mSignatureToTSignature, mTypeToTType, tType, tDefinition,
											mType, mDefinitionToTMember, tSignature, mSignature, mDefinition,
											sourceMatch, targetMatch });
								}
							}
						}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tType, tDefinition, mType, tSignature, mSignature, mDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mSignatureToTSignature, mTypeToTType,
				tType, tDefinition, mType, mDefinitionToTMember, tSignature, mSignature, mDefinition, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSignatureToTSignature, mTypeToTType, tType,
					tDefinition, mType, mDefinitionToTMember, tSignature, mSignature, mDefinition, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_29_3_solveCSP_binding = pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, mSignatureToTSignature, mTypeToTType, tType, tDefinition, mType,
				mDefinitionToTMember, tSignature, mSignature, mDefinition, ruleResult);
	...
	public static final Object[] pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(TAbstractType tType,
			TMember tDefinition, AbstractTypeDeclaration mType, TSignature tSignature, MDefinition mDefinition,
			ModelgeneratorRuleResult ruleResult) {
		tType.getSignature().add(tSignature);
		mType.getBodyDeclarations().add(mDefinition);
		tType.getDefines().add(tDefinition);
		...
		return new Object[] { tType, tDefinition, mType, tSignature, mDefinition, ruleResult };
	}
