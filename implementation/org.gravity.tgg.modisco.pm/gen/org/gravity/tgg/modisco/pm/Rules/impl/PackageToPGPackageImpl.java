...
public class PackageToPGPackageImpl extends AbstractRuleImpl implements PackageToPGPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = PackageToPGPackageImpl.pattern_PackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, typeGraph, mModelToTypeGraph, mModel, mPackageToTPackage, tPackage, mPackage);
		...
		PackageToPGPackageImpl.pattern_PackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult,
				typeGraph, mModel, mPackageToTPackage, tPackage, mPackage);
		...
		PackageToPGPackageImpl.pattern_PackageToPGPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				typeGraph, mModelToTypeGraph, mModel, mPackageToTPackage, tPackage, mPackage);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : PackageToPGPackageImpl.pattern_PackageToPGPackage_2_2_corematch_blackFFBBB(mModel,
			...
			for (Object[] result3_black : PackageToPGPackageImpl.pattern_PackageToPGPackage_2_3_findcontext_blackBBBB(
					typeGraph, mModelToTypeGraph, mModel, mPackage)) {
				Object[] result3_green = PackageToPGPackageImpl
						.pattern_PackageToPGPackage_2_3_findcontext_greenBBBBFFFFF(typeGraph, mModelToTypeGraph, mModel,
								mPackage);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeGraph typeGraph,
			ModelToTypeGraph mModelToTypeGraph, Model mModel, org.eclipse.modisco.java.Package mPackage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject typeGraph, EObject mModelToTypeGraph,
			EObject mModel, EObject mPackageToTPackage, EObject tPackage, EObject mPackage) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = PackageToPGPackageImpl
				.pattern_PackageToPGPackage_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, typeGraph,
						mModelToTypeGraph, mModel, mPackageToTPackage, tPackage, mPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[typeGraph] = " + typeGraph + ", " + "[mModelToTypeGraph] = " + mModelToTypeGraph + ", "
					+ "[mModel] = " + mModel + ", " + "[mPackageToTPackage] = " + mPackageToTPackage + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject typeGraph, EObject mModelToTypeGraph,
			EObject mModel, EObject mPackageToTPackage, EObject tPackage, EObject mPackage) {
		ruleresult.registerObject("typeGraph", typeGraph);
		ruleresult.registerObject("mModelToTypeGraph", mModelToTypeGraph);
		ruleresult.registerObject("mModel", mModel);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_27(EMoflonEdge _edge_packages) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_29(EMoflonEdge _edge_model) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PACKAGE_TO_PG_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEGRAPH_MODELTOTYPEGRAPH_MODEL_PACKAGE:
		...
		case RulesPackage.PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_27__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_27((EMoflonEdge) arguments.get(0));
		case RulesPackage.PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_29__EMOFLONEDGE:
			...
			if (tmpMModelToTypeGraph instanceof ModelToTypeGraph) {
				...
				if (tmpMModel instanceof Model) {
					...
					if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
						...
						return new Object[] { typeGraph, mModelToTypeGraph, mModel, mPackage, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_1_1_performtransformation_blackBBBBFBB(TypeGraph typeGraph,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { typeGraph, mModelToTypeGraph, mModel, mPackage, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_PackageToPGPackage_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_PackageToPGPackage_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_PackageToPGPackage_1_1_performtransformation_black = pattern_PackageToPGPackage_1_1_performtransformation_blackBBBBFBB(
					typeGraph, mModelToTypeGraph, mModel, mPackage, _this, isApplicableMatch);
	...
	public static final Object[] pattern_PackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject typeGraph, EObject mModelToTypeGraph, EObject mModel,
			EObject mPackageToTPackage, EObject tPackage, EObject mPackage) {
	...
	public static final Object[] pattern_PackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject typeGraph, EObject mModel, EObject mPackageToTPackage,
		...
		mPackage__mModel____model.setName(mPackage__mModel____model_name_prime);
		mModel__mPackage____ownedElements.setName(mModel__mPackage____ownedElements_name_prime);
		return new Object[] { ruleresult, typeGraph, mModel, mPackageToTPackage, tPackage, mPackage,
	...
	public static final void pattern_PackageToPGPackage_1_5_registerobjects_expressionBBBBBBBB(PackageToPGPackage _this,
			PerformRuleResult ruleresult, EObject typeGraph, EObject mModelToTypeGraph, EObject mModel,
			EObject mPackageToTPackage, EObject tPackage, EObject mPackage) {
		_this.registerObjects_FWD(ruleresult, typeGraph, mModelToTypeGraph, mModel, mPackageToTPackage, tPackage,
				mPackage);
	...
	public static final Iterable<Object[]> pattern_PackageToPGPackage_2_2_corematch_blackFFBBB(Model mModel,
		...
		for (ModelToTypeGraph mModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (typeGraph != null) {
				_result.add(new Object[] { typeGraph, mModelToTypeGraph, mModel, mPackage, match });
			}
		...
		if (mModel.equals(mModelToTypeGraph.getSource())) {
			if (typeGraph.equals(mModelToTypeGraph.getTarget())) {
				if (mModel.equals(mPackage.getModel())) {
					_result.add(new Object[] { typeGraph, mModelToTypeGraph, mModel, mPackage });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_PackageToPGPackage_2_4_solveCSP_bindingFBBBBBB(PackageToPGPackage _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, typeGraph, mModelToTypeGraph, mModel,
				mPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, typeGraph, mModelToTypeGraph, mModel, mPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_PackageToPGPackage_2_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_PackageToPGPackage_2_4_solveCSP_binding = pattern_PackageToPGPackage_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, typeGraph, mModelToTypeGraph, mModel, mPackage);
	...
	public static final Object[] pattern_PackageToPGPackage_11_1_performtransformation_greenBFBFB(Model mModel,
		...
		return new Object[] { mModel, mPackageToTPackage, tPackage, mPackage, csp };
	}
	...
	public static final void pattern_PackageToPGPackage_11_5_registerobjects_expressionBBBBBBBB(
			PackageToPGPackage _this, PerformRuleResult ruleresult, EObject typeGraph, EObject mModelToTypeGraph,
			EObject mModel, EObject mPackageToTPackage, EObject tPackage, EObject mPackage) {
		_this.registerObjects_BWD(ruleresult, typeGraph, mModelToTypeGraph, mModel, mPackageToTPackage, tPackage,
				mPackage);
	...
	public static final Object[] pattern_PackageToPGPackage_20_2_testcorematchandDECs_black_nac_0B(TPackage tPackage) {
		TPackage __DEC_tPackage_subpackages_790496 = tPackage.getParent();
		if (__DEC_tPackage_subpackages_790496 != null) {
			if (!tPackage.equals(__DEC_tPackage_subpackages_790496)) {
	...
	public static final Object[] pattern_PackageToPGPackage_21_2_testcorematchandDECs_black_nac_0B(
			org.eclipse.modisco.java.Package mPackage) {
		org.eclipse.modisco.java.Package __DEC_mPackage_package_791126 = mPackage.getPackage();
		if (__DEC_mPackage_package_791126 != null) {
			if (!mPackage.equals(__DEC_mPackage_package_791126)) {
	...
	public static final Object[] pattern_PackageToPGPackage_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Package mPackage) {
		org.eclipse.modisco.java.Package __DEC_mPackage_package_145809 = mPackage.getPackage();
		if (__DEC_mPackage_package_145809 != null) {
			if (!mPackage.equals(__DEC_mPackage_package_145809)) {
				return new Object[] { mPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_28_1_matchtggpattern_black_nac_0B(TPackage tPackage) {
		TPackage __DEC_tPackage_subpackages_210840 = tPackage.getParent();
		if (__DEC_tPackage_subpackages_210840 != null) {
			if (!tPackage.equals(__DEC_tPackage_subpackages_210840)) {
				return new Object[] { tPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_29_6_perform_greenBBFFFBB(TypeGraph typeGraph, Model mModel,
		...
		return new Object[] { typeGraph, mModel, mPackageToTPackage, tPackage, mPackage, ruleResult, csp };
	}
