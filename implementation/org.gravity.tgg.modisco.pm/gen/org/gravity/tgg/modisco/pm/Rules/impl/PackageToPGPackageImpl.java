...
public class PackageToPGPackageImpl extends AbstractRuleImpl implements PackageToPGPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = PackageToPGPackageImpl.pattern_PackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mPackage, mModel, mModelToTypeGraph, typeGraph, mPackageToTPackage, tPackage);
		...
		PackageToPGPackageImpl.pattern_PackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBFFFFFFF(ruleresult,
				mPackage, mModel, typeGraph, mPackageToTPackage, tPackage);
		...
		//nothing EMoflonEdge tPackage__typeGraph____pg = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge mPackageToTPackage__tPackage____target = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge tPackage__typeGraph____typeGraph = (EMoflonEdge) result3_green[12];

		// 
		// 
		PackageToPGPackageImpl.pattern_PackageToPGPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mPackage, mModel, mModelToTypeGraph, typeGraph, mPackageToTPackage, tPackage);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPackage, EObject mModel,
			EObject mModelToTypeGraph, EObject typeGraph, EObject mPackageToTPackage, EObject tPackage) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = PackageToPGPackageImpl
				.pattern_PackageToPGPackage_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mPackage, mModel,
						mModelToTypeGraph, typeGraph, mPackageToTPackage, tPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mPackage] = " + mPackage + ", " + "[mModel] = " + mModel + ", "
					+ "[mModelToTypeGraph] = " + mModelToTypeGraph + ", " + "[typeGraph] = " + typeGraph + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : PackageToPGPackageImpl
			...
			for (Object[] result3_black : PackageToPGPackageImpl.pattern_PackageToPGPackage_12_3_findcontext_blackBBBB(
				...
				//nothing EMoflonEdge tPackage__typeGraph____pg = (EMoflonEdge) result3_green[8];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_137(EMoflonEdge _edge_packages) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_141(EMoflonEdge _edge_model) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_137__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_137((EMoflonEdge) arguments.get(0));
		case RulesPackage.PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_141__EMOFLONEDGE:
	...
	public static final Object[] pattern_PackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject typeGraph, EObject mPackageToTPackage, EObject tPackage) {
															...
															if (!mPackageToTPackage.equals(tPackage)) {
																if (!tPackage.equals(typeGraph)) {
																	return new Object[] { ruleresult, mPackage, mModel,
																			mModelToTypeGraph, typeGraph,
																			mPackageToTPackage, tPackage };
																}
															}
														}
													}
	...
	public static final Object[] pattern_PackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject mPackage, EObject mModel, EObject typeGraph,
			EObject mPackageToTPackage, EObject tPackage) {
		...
		return new Object[] { ruleresult, mPackage, mModel, typeGraph, mPackageToTPackage, tPackage,
	...
	public static final void pattern_PackageToPGPackage_1_5_registerobjects_expressionBBBBBBBB(PackageToPGPackage _this,
			PerformRuleResult ruleresult, EObject mPackage, EObject mModel, EObject mModelToTypeGraph,
			EObject typeGraph, EObject mPackageToTPackage, EObject tPackage) {
		_this.registerObjects_FWD(ruleresult, mPackage, mModel, mModelToTypeGraph, typeGraph, mPackageToTPackage,
				tPackage);
	...
	public static final Object[] pattern_PackageToPGPackage_11_1_performtransformation_greenFBFBB(Model mModel,
		...
		return new Object[] { mPackage, mModel, mPackageToTPackage, tPackage, csp };
	}
	...
	public static final void pattern_PackageToPGPackage_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mModelToTypeGraph, EObject typeGraph, EObject mPackageToTPackage, EObject tPackage) {
		_this.registerObjects_BWD(ruleresult, mPackage, mModel, mModelToTypeGraph, typeGraph, mPackageToTPackage,
				tPackage);
	...
	public static final Object[] pattern_PackageToPGPackage_20_2_testcorematchandDECs_black_nac_0B(TPackage tPackage) {
		TPackage __DEC_tPackage_parent_343920 = tPackage.getParent();
		if (__DEC_tPackage_parent_343920 != null) {
			if (!tPackage.equals(__DEC_tPackage_parent_343920)) {
	...
	public static final Object[] pattern_PackageToPGPackage_20_2_testcorematchandDECs_black_nac_1B(TPackage tPackage) {
		TPackage __DEC_tPackage_subpackage_70179 = tPackage.getParent();
		if (__DEC_tPackage_subpackage_70179 != null) {
			if (!tPackage.equals(__DEC_tPackage_subpackage_70179)) {
				return new Object[] { tPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_21_2_testcorematchandDECs_black_nac_0B(
		...
		org.eclipse.modisco.java.Package __DEC_mPackage_package_323718 = mPackage.getPackage();
		if (__DEC_mPackage_package_323718 != null) {
			if (!mPackage.equals(__DEC_mPackage_package_323718)) {
	...
	public static final Object[] pattern_PackageToPGPackage_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Package mPackage) {
		org.eclipse.modisco.java.Package __DEC_mPackage_package_142671 = mPackage.getPackage();
		if (__DEC_mPackage_package_142671 != null) {
			if (!mPackage.equals(__DEC_mPackage_package_142671)) {
				return new Object[] { mPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_28_1_matchtggpattern_black_nac_0B(TPackage tPackage) {
		TPackage __DEC_tPackage_parent_619929 = tPackage.getParent();
		if (__DEC_tPackage_parent_619929 != null) {
			if (!tPackage.equals(__DEC_tPackage_parent_619929)) {
				return new Object[] { tPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_28_1_matchtggpattern_black_nac_1B(TPackage tPackage) {
		TPackage __DEC_tPackage_subpackage_839943 = tPackage.getParent();
		if (__DEC_tPackage_subpackage_839943 != null) {
			if (!tPackage.equals(__DEC_tPackage_subpackage_839943)) {
				return new Object[] { tPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_29_6_perform_greenFBBFFBB(Model mModel, TypeGraph typeGraph,
		...
		return new Object[] { mPackage, mModel, typeGraph, mPackageToTPackage, tPackage, ruleResult, csp };
	}
