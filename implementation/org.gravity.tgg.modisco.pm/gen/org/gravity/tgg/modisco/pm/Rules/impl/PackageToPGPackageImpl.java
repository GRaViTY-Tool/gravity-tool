...
public class PackageToPGPackageImpl extends AbstractRuleImpl implements PackageToPGPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = PackageToPGPackageImpl.pattern_PackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mModelToTypeGraph, mPackage, typeGraph, mModel, mPackageToTPackage, tPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModelToTypeGraph] = " + mModelToTypeGraph + ", " + "[mPackage] = " + mPackage + ", "
					+ "[typeGraph] = " + typeGraph + ", " + "[mModel] = " + mModel + ", " + "[mPackageToTPackage] = "
		...
		PackageToPGPackageImpl.pattern_PackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBFFFFFFF(ruleresult,
				mPackage, typeGraph, mModel, mPackageToTPackage, tPackage);
		...
		PackageToPGPackageImpl.pattern_PackageToPGPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mModelToTypeGraph, mPackage, typeGraph, mModel, mPackageToTPackage, tPackage);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mPackage,
			EObject typeGraph, EObject mModel, EObject mPackageToTPackage, EObject tPackage) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : PackageToPGPackageImpl
			...
			for (Object[] result3_black : PackageToPGPackageImpl.pattern_PackageToPGPackage_12_3_findcontext_blackBBBB(
				...
				Object[] result3_green = PackageToPGPackageImpl
						.pattern_PackageToPGPackage_12_3_findcontext_greenBBBBFFFFFF(mModelToTypeGraph, typeGraph,
								mModel, tPackage);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				//nothing EMoflonEdge mModelToTypeGraph__typeGraph____target = (EMoflonEdge) result3_green[5];
				//nothing EMoflonEdge typeGraph__tPackage____packages = (EMoflonEdge) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mPackage,
			EObject typeGraph, EObject mModel, EObject mPackageToTPackage, EObject tPackage) {
		ruleresult.registerObject("mModelToTypeGraph", mModelToTypeGraph);
		ruleresult.registerObject("mPackage", mPackage);
		ruleresult.registerObject("typeGraph", typeGraph);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_7(EMoflonEdge _edge_packages) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_7__EMOFLONEDGE:
	...
	public static final Object[] pattern_PackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mPackage, EObject typeGraph,
			EObject mModel, EObject mPackageToTPackage, EObject tPackage) {
	...
	public static final Object[] pattern_PackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject mPackage, EObject typeGraph, EObject mModel,
		...
		return new Object[] { ruleresult, mPackage, typeGraph, mModel, mPackageToTPackage, tPackage,
				typeGraph__tPackage____packages, tPackage__typeGraph____pg, mPackage__mModel____model,
				mModel__mPackage____ownedElements, mPackageToTPackage__mPackage____source,
				mPackageToTPackage__tPackage____target, tPackage__typeGraph____typeGraph };
	}

	public static final void pattern_PackageToPGPackage_1_5_registerobjects_expressionBBBBBBBB(PackageToPGPackage _this,
			PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mPackage, EObject typeGraph,
			EObject mModel, EObject mPackageToTPackage, EObject tPackage) {
		_this.registerObjects_FWD(ruleresult, mModelToTypeGraph, mPackage, typeGraph, mModel, mPackageToTPackage,
				tPackage);
	...
	public static final void pattern_PackageToPGPackage_11_5_registerobjects_expressionBBBBBBBB(
			PackageToPGPackage _this, PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mPackage,
			EObject typeGraph, EObject mModel, EObject mPackageToTPackage, EObject tPackage) {
		_this.registerObjects_BWD(ruleresult, mModelToTypeGraph, mPackage, typeGraph, mModel, mPackageToTPackage,
				tPackage);
	...
	public static final Object[] pattern_PackageToPGPackage_12_3_findcontext_greenBBBBFFFFFF(
			ModelToTypeGraph mModelToTypeGraph, TypeGraph typeGraph, Model mModel, TPackage tPackage) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge mModelToTypeGraph__typeGraph____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge typeGraph__tPackage____packages = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		tPackage__typeGraph____typeGraph.setName(tPackage__typeGraph____typeGraph_name_prime);
		return new Object[] { mModelToTypeGraph, typeGraph, mModel, tPackage, isApplicableMatch,
				mModelToTypeGraph__typeGraph____target, typeGraph__tPackage____packages, tPackage__typeGraph____pg,
				mModelToTypeGraph__mModel____source, tPackage__typeGraph____typeGraph };
	}
	...
	public static final Object[] pattern_PackageToPGPackage_20_2_testcorematchandDECs_black_nac_0B(TPackage tPackage) {
		TPackage __DEC_tPackage_parent_223574 = tPackage.getParent();
		if (__DEC_tPackage_parent_223574 != null) {
			if (!tPackage.equals(__DEC_tPackage_parent_223574)) {
	...
	public static final Object[] pattern_PackageToPGPackage_20_2_testcorematchandDECs_black_nac_1B(TPackage tPackage) {
		TPackage __DEC_tPackage_subpackage_106845 = tPackage.getParent();
		if (__DEC_tPackage_subpackage_106845 != null) {
			if (!tPackage.equals(__DEC_tPackage_subpackage_106845)) {
				return new Object[] { tPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_21_2_testcorematchandDECs_black_nac_0B(
		...
		org.eclipse.modisco.java.Package __DEC_mPackage_package_332150 = mPackage.getPackage();
		if (__DEC_mPackage_package_332150 != null) {
			if (!mPackage.equals(__DEC_mPackage_package_332150)) {
	...
	public static final Object[] pattern_PackageToPGPackage_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Package mPackage) {
		org.eclipse.modisco.java.Package __DEC_mPackage_package_720685 = mPackage.getPackage();
		if (__DEC_mPackage_package_720685 != null) {
			if (!mPackage.equals(__DEC_mPackage_package_720685)) {
				return new Object[] { mPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_28_1_matchtggpattern_black_nac_0B(TPackage tPackage) {
		TPackage __DEC_tPackage_parent_923596 = tPackage.getParent();
		if (__DEC_tPackage_parent_923596 != null) {
			if (!tPackage.equals(__DEC_tPackage_parent_923596)) {
				return new Object[] { tPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_28_1_matchtggpattern_black_nac_1B(TPackage tPackage) {
		TPackage __DEC_tPackage_subpackage_566102 = tPackage.getParent();
		if (__DEC_tPackage_subpackage_566102 != null) {
			if (!tPackage.equals(__DEC_tPackage_subpackage_566102)) {
				return new Object[] { tPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_29_6_perform_greenFBBFFBB(TypeGraph typeGraph, Model mModel,
		...
		return new Object[] { mPackage, typeGraph, mModel, mPackageToTPackage, tPackage, ruleResult, csp };
	}
