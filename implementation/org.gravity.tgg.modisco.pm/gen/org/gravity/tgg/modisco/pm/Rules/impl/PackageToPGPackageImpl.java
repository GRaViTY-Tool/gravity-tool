...
public class PackageToPGPackageImpl extends AbstractRuleImpl implements PackageToPGPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = PackageToPGPackageImpl.pattern_PackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mPackageToTPackage, mPackage, tPackage, typeGraph, mModel, mModelToTypeGraph);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mPackageToTPackage] = " + mPackageToTPackage + ", " + "[mPackage] = " + mPackage + ", "
					+ "[tPackage] = " + tPackage + ", " + "[typeGraph] = " + typeGraph + ", " + "[mModel] = " + mModel
		...
		PackageToPGPackageImpl.pattern_PackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult,
				mPackageToTPackage, mPackage, tPackage, typeGraph, mModel);
		...
		PackageToPGPackageImpl.pattern_PackageToPGPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mPackageToTPackage, mPackage, tPackage, typeGraph, mModel, mModelToTypeGraph);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject mPackage,
			EObject tPackage, EObject typeGraph, EObject mModel, EObject mModelToTypeGraph) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = PackageToPGPackageImpl
				.pattern_PackageToPGPackage_11_1_performtransformation_greenFFBBB(tPackage, mModel, csp);
		PackageToTPackage mPackageToTPackage = (PackageToTPackage) result1_green[0];
		...
		Object[] result3_black = PackageToPGPackageImpl
				.pattern_PackageToPGPackage_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mPackageToTPackage,
						mPackage, tPackage, typeGraph, mModel, mModelToTypeGraph);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mPackageToTPackage] = " + mPackageToTPackage + ", " + "[mPackage] = " + mPackage + ", "
					+ "[tPackage] = " + tPackage + ", " + "[typeGraph] = " + typeGraph + ", " + "[mModel] = " + mModel
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_35(EMoflonEdge _edge_model) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_38(EMoflonEdge _edge_model) {
		...
		for (Object[] result2_black : PackageToPGPackageImpl
			...
			if (PackageToPGPackageImpl.pattern_PackageToPGPackage_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					PackageToPGPackageImpl.pattern_PackageToPGPackage_29_6_perform_greenFFFBBBB(typeGraph, mModel,
							ruleResult, csp);
					//nothing PackageToTPackage mPackageToTPackage = (PackageToTPackage) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_35__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_35((EMoflonEdge) arguments.get(0));
		case RulesPackage.PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_38__EMOFLONEDGE:
	...
	public static final Object[] pattern_PackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject mPackage, EObject tPackage,
			EObject typeGraph, EObject mModel, EObject mModelToTypeGraph) {
															...
															if (!mModelToTypeGraph.equals(tPackage)) {
																if (!mModelToTypeGraph.equals(typeGraph)) {
																	return new Object[] { ruleresult,
																			...
																			typeGraph, mModel, mModelToTypeGraph };
																}
															}
														}
													}
	...
	public static final Object[] pattern_PackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject mPackage, EObject tPackage,
			EObject typeGraph, EObject mModel) {
		...
		return new Object[] { ruleresult, mPackageToTPackage, mPackage, tPackage, typeGraph, mModel,
	...
	public static final void pattern_PackageToPGPackage_1_5_registerobjects_expressionBBBBBBBB(PackageToPGPackage _this,
			PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject mPackage, EObject tPackage,
			EObject typeGraph, EObject mModel, EObject mModelToTypeGraph) {
		_this.registerObjects_FWD(ruleresult, mPackageToTPackage, mPackage, tPackage, typeGraph, mModel,
				mModelToTypeGraph);
	...
	public static final Object[] pattern_PackageToPGPackage_11_1_performtransformation_greenFFBBB(TPackage tPackage,
		...
		return new Object[] { mPackageToTPackage, mPackage, tPackage, mModel, csp };
	}
	...
	public static final void pattern_PackageToPGPackage_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tPackage, EObject typeGraph, EObject mModel, EObject mModelToTypeGraph) {
		_this.registerObjects_BWD(ruleresult, mPackageToTPackage, mPackage, tPackage, typeGraph, mModel,
				mModelToTypeGraph);
	...
	public static final Object[] pattern_PackageToPGPackage_20_2_testcorematchandDECs_black_nac_0B(TPackage tPackage) {
		TPackage __DEC_tPackage_subpackages_736521 = tPackage.getParent();
		if (__DEC_tPackage_subpackages_736521 != null) {
			if (!tPackage.equals(__DEC_tPackage_subpackages_736521)) {
	...
	public static final Object[] pattern_PackageToPGPackage_21_2_testcorematchandDECs_black_nac_0B(
		...
		org.eclipse.modisco.java.Package __DEC_mPackage_ownedPackages_778108 = mPackage.getPackage();
		if (__DEC_mPackage_ownedPackages_778108 != null) {
			if (!mPackage.equals(__DEC_mPackage_ownedPackages_778108)) {
	...
	public static final Object[] pattern_PackageToPGPackage_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Package mPackage) {
		org.eclipse.modisco.java.Package __DEC_mPackage_ownedPackages_8428 = mPackage.getPackage();
		if (__DEC_mPackage_ownedPackages_8428 != null) {
			if (!mPackage.equals(__DEC_mPackage_ownedPackages_8428)) {
				return new Object[] { mPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_28_1_matchtggpattern_black_nac_0B(TPackage tPackage) {
		TPackage __DEC_tPackage_subpackages_955660 = tPackage.getParent();
		if (__DEC_tPackage_subpackages_955660 != null) {
			if (!tPackage.equals(__DEC_tPackage_subpackages_955660)) {
				return new Object[] { tPackage };
			}
		}
	...
	public static final Object[] pattern_PackageToPGPackage_29_6_perform_greenFFFBBBB(TypeGraph typeGraph, Model mModel,
		...
		return new Object[] { mPackageToTPackage, mPackage, tPackage, typeGraph, mModel, ruleResult, csp };
	}
