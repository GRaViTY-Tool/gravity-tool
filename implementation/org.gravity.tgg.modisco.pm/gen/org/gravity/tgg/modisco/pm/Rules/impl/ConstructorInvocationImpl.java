...
public class ConstructorInvocationImpl extends AbstractRuleImpl implements ConstructorInvocation {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_92(EMoflonEdge _edge_mMethodInvocations) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_86__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_86((EMoflonEdge) arguments.get(0));
			case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_92__EMOFLONEDGE:
	...
	public static final Object[] pattern_ConstructorInvocation_21_2_testcorematchandDECs_black_nac_0BB(
			MConstructorInvocation invocation, MDefinition mMember) {
		for (MDefinition __DEC_invocation_mMethodInvocations_170316 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_170316)) {
	...
	public static final Object[] pattern_ConstructorInvocation_27_1_matchtggpattern_black_nac_0BB(
			MConstructorInvocation invocation, MDefinition mMember) {
		for (MDefinition __DEC_invocation_mMethodInvocations_960585 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_960585)) {
				return new Object[] { invocation, mMember };
			}
		}
		return null;
