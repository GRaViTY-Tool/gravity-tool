...
public class ConstructorInvocationImpl extends AbstractRuleImpl implements ConstructorInvocation {
	...
	public boolean isAppropriate_FWD(Match match, MConstructorInvocation invocation, MDefinition mMember,
		...
		Object[] result1_black = ConstructorInvocationImpl.pattern_ConstructorInvocation_0_1_initialbindings_blackBBBBB(
		...
		Object[] result2_bindingAndBlack = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_0_2_SolveCSP_bindingAndBlackFBBBBB(this, match, invocation, mMember,
						mMethod);
		...
		if (ConstructorInvocationImpl.pattern_ConstructorInvocation_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = ConstructorInvocationImpl
					.pattern_ConstructorInvocation_0_4_collectelementstobetranslated_blackBBBB(match, invocation,
							mMember, mMethod);
			...
			ConstructorInvocationImpl.pattern_ConstructorInvocation_0_4_collectelementstobetranslated_greenBBBBFFF(
			...
			Object[] result5_black = ConstructorInvocationImpl
					.pattern_ConstructorInvocation_0_5_collectcontextelements_blackBBBB(match, invocation, mMember,
							mMethod);
			...
			ConstructorInvocationImpl.pattern_ConstructorInvocation_0_5_collectcontextelements_greenBBB(match, mMember,
					mMethod);

			// 
			ConstructorInvocationImpl.pattern_ConstructorInvocation_0_6_registerobjectstomatch_expressionBBBBB(this,
					match, invocation, mMember, mMethod);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_1_1_performtransformation_greenBBFBFF(invocation, tMember, tMethod);
		...
		Object[] result3_black = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, invocation,
		...
		ConstructorInvocationImpl.pattern_ConstructorInvocation_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
		...
		// 
		// 
		ConstructorInvocationImpl.pattern_ConstructorInvocation_1_5_registerobjects_expressionBBBBBBBBBBBB(this,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result2_binding = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_2_2_corematch_bindingFFFB(match);
		...
		for (Object[] result2_black : ConstructorInvocationImpl
				.pattern_ConstructorInvocation_2_2_corematch_blackBFFFFBBB(invocation, mMember, mMethod, match)) {
			...
			for (Object[] result3_black : ConstructorInvocationImpl
					.pattern_ConstructorInvocation_2_3_findcontext_blackBBBBBBB(invocation, mMemberToTMember, tMember,
							mMethodToTMethod, tMethod, mMember, mMethod)) {
				Object[] result3_green = ConstructorInvocationImpl
						.pattern_ConstructorInvocation_2_3_findcontext_greenBBBBBBBFFFFFFFF(invocation,
				...
				Object[] result4_bindingAndBlack = ConstructorInvocationImpl
						.pattern_ConstructorInvocation_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, MConstructorInvocation invocation, MDefinition mMember,
	...
	public boolean isAppropriate_BWD(Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		...
		Object[] result1_black = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_10_1_initialbindings_blackBBBBB(this, match, tMember, tAccess, tMethod);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, tMember, tAccess,
						tMethod);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tMember] = " + tMember + ", " + "[tAccess] = " + tAccess + ", "
		...
		if (ConstructorInvocationImpl.pattern_ConstructorInvocation_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = ConstructorInvocationImpl
					.pattern_ConstructorInvocation_10_4_collectelementstobetranslated_blackBBBB(match, tMember, tAccess,
							tMethod);
			if (result4_black == null) {
				throw new RuntimeException(
			...
			ConstructorInvocationImpl.pattern_ConstructorInvocation_10_4_collectelementstobetranslated_greenBBBBFFFF(
			...
			Object[] result5_black = ConstructorInvocationImpl
					.pattern_ConstructorInvocation_10_5_collectcontextelements_blackBBBB(match, tMember, tAccess,
							tMethod);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[tMember] = "
			...
			ConstructorInvocationImpl.pattern_ConstructorInvocation_10_5_collectcontextelements_greenBBB(match, tMember,
					tMethod);

			// 
			ConstructorInvocationImpl.pattern_ConstructorInvocation_10_6_registerobjectstomatch_expressionBBBBB(this,
					match, tMember, tAccess, tMethod);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_11_1_performtransformation_greenFBBFFB(tAccess, mMember, mMethod);
		...
		Object[] result3_black = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, invocation,
						mMemberToTMember, tMember, tAccess, mMethodToTMethod, tMethod, mMember,
						mFlowElementToTFlowElement, invocationToTAccess, mMethod);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
		...
		ConstructorInvocationImpl.pattern_ConstructorInvocation_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
				ruleresult, invocation, tMember, tAccess, tMethod, mMember, mFlowElementToTFlowElement,
				invocationToTAccess, mMethod);
		//nothing EMoflonEdge invocation__mMethod____method = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge mMethod__invocation____usages = (EMoflonEdge) result3_green[10];
		...
		// 
		// 
		ConstructorInvocationImpl.pattern_ConstructorInvocation_11_5_registerobjects_expressionBBBBBBBBBBBB(this,
				ruleresult, invocation, mMemberToTMember, tMember, tAccess, mMethodToTMethod, tMethod, mMember,
				mFlowElementToTFlowElement, invocationToTAccess, mMethod);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_12_2_corematch_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : ConstructorInvocationImpl
				.pattern_ConstructorInvocation_12_2_corematch_blackFBBFBFFB(tMember, tAccess, tMethod, match)) {
			...
			// ForEach 
			for (Object[] result3_black : ConstructorInvocationImpl
					.pattern_ConstructorInvocation_12_3_findcontext_blackBBBBBBB(mMemberToTMember, tMember, tAccess,
							mMethodToTMethod, tMethod, mMember, mMethod)) {
				Object[] result3_green = ConstructorInvocationImpl
						.pattern_ConstructorInvocation_12_3_findcontext_greenBBBBBBBFFFFFFFFF(mMemberToTMember, tMember,
				...
				Object[] result4_bindingAndBlack = ConstructorInvocationImpl
						.pattern_ConstructorInvocation_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_14(EMoflonEdge _edge_tAccessing) {
		...
		// ForEach 
		for (Object[] result2_black : ConstructorInvocationImpl
				.pattern_ConstructorInvocation_20_2_testcorematchandDECs_blackFFFB(_edge_tAccessing)) {
			...
			if (ConstructorInvocationImpl
					.pattern_ConstructorInvocation_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, tMember, tAccess, tMethod)) {
				// 
				if (ConstructorInvocationImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_15(EMoflonEdge _edge_method) {
		...
		// ForEach 
		for (Object[] result2_black : ConstructorInvocationImpl
				.pattern_ConstructorInvocation_21_2_testcorematchandDECs_blackFFFB(_edge_method)) {
			...
			// 
			if (ConstructorInvocationImpl
					.pattern_ConstructorInvocation_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, invocation, mMember, mMethod)) {
				// 
				if (ConstructorInvocationImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(sourceMatch,
						targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result3_bindingAndBlack = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, invocation, tMember,
		...
		if (ConstructorInvocationImpl.pattern_ConstructorInvocation_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ConstructorInvocationImpl
					.pattern_ConstructorInvocation_24_5_matchcorrcontext_blackFBFBBBBB(tMember, tMethod, mMember,
				...
				Object[] result5_green = ConstructorInvocationImpl
						.pattern_ConstructorInvocation_24_5_matchcorrcontext_greenBBBBF(mMemberToTMember,
								mMethodToTMethod, sourceMatch, targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[4];

				Object[] result6_black = ConstructorInvocationImpl
						.pattern_ConstructorInvocation_24_6_createcorrespondence_blackBBBBBBB(invocation, tMember,
	...
	public boolean checkDEC_FWD(MConstructorInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {// 
		Object[] result1_black = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_27_1_matchtggpattern_blackBBB(invocation, mMember, mMethod);
		if (result1_black != null) {
	...
	public boolean checkDEC_BWD(TMember tMember, TCall tAccess, TMember tMethod) {// 
		Object[] result1_black = ConstructorInvocationImpl
				.pattern_ConstructorInvocation_28_1_matchtggpattern_blackBBB(tMember, tAccess, tMethod);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		// ForEach 
		for (Object[] result2_black : ConstructorInvocationImpl
				.pattern_ConstructorInvocation_29_2_isapplicablecore_blackFFFFFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			Object[] result3_bindingAndBlack = ConstructorInvocationImpl
					.pattern_ConstructorInvocation_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
			...
			if (ConstructorInvocationImpl.pattern_ConstructorInvocation_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = ConstructorInvocationImpl
						.pattern_ConstructorInvocation_29_5_checknacs_blackBBBBBB(mMemberToTMember, tMember,
								mMethodToTMethod, tMethod, mMember, mMethod);
				if (result5_black != null) {

					Object[] result6_black = ConstructorInvocationImpl
							.pattern_ConstructorInvocation_29_6_perform_blackBBBBBBB(mMemberToTMember, tMember,
					...
					ConstructorInvocationImpl.pattern_ConstructorInvocation_29_6_perform_greenFBFBBFFBB(tMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_FWD__MATCH_MCONSTRUCTORINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MCONSTRUCTORINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (MConstructorInvocation) arguments.get(1),
					(MDefinition) arguments.get(2), (AbstractMethodDeclaration) arguments.get(3));
			return null;
		case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MCONSTRUCTORINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MCONSTRUCTORINVOCATION_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_BWD__MATCH_TMEMBER_TCALL_TMEMBER:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TMEMBER_TCALL_TMEMBER:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TMember) arguments.get(1), (TCall) arguments.get(2),
					(TMember) arguments.get(3));
			return null;
		case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TMEMBER_TCALL_TMEMBER:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TMEMBER_TCALL_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_14__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_14((EMoflonEdge) arguments.get(0));
		case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_15__EMOFLONEDGE:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___IS_APPLICABLE_SOLVE_CSP_CC__MCONSTRUCTORINVOCATION_TMEMBER_TCALL_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___CHECK_DEC_FWD__MCONSTRUCTORINVOCATION_MDEFINITION_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.CONSTRUCTOR_INVOCATION___CHECK_DEC_BWD__TMEMBER_TCALL_TMEMBER:
			return checkDEC_BWD((TMember) arguments.get(0), (TCall) arguments.get(1), (TMember) arguments.get(2));
		case RulesPackage.CONSTRUCTOR_INVOCATION___GENERATE_MODEL__RULEENTRYCONTAINER_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER:
			return generateModel((RuleEntryContainer) arguments.get(0), (MDefinitionToTMember) arguments.get(1),
					(MDefinitionToTMember) arguments.get(2));
		case RulesPackage.CONSTRUCTOR_INVOCATION___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_ABSTRACTMETHODDECLARATION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ConstructorInvocation_0_1_initialbindings_blackBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_0_2_SolveCSP_bindingFBBBBB(ConstructorInvocation _this,
			Match match, MConstructorInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_0_2_SolveCSP_bindingAndBlackFBBBBB(
			ConstructorInvocation _this, Match match, MConstructorInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		Object[] result_pattern_ConstructorInvocation_0_2_SolveCSP_binding = pattern_ConstructorInvocation_0_2_SolveCSP_bindingFBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_0_4_collectelementstobetranslated_blackBBBB(Match match,
			MConstructorInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		return new Object[] { match, invocation, mMember, mMethod };
	}

	public static final Object[] pattern_ConstructorInvocation_0_4_collectelementstobetranslated_greenBBBBFFF(
			Match match, MConstructorInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_0_5_collectcontextelements_blackBBBB(Match match,
			MConstructorInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		return new Object[] { match, invocation, mMember, mMethod };
	}

	public static final Object[] pattern_ConstructorInvocation_0_5_collectcontextelements_greenBBB(Match match,
	...
	public static final void pattern_ConstructorInvocation_0_6_registerobjectstomatch_expressionBBBBB(
			ConstructorInvocation _this, Match match, MConstructorInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_1_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ConstructorInvocation_1_1_performtransformation_blackBBBBBBBFBB(
			...
			AbstractMethodDeclaration mMethod, ConstructorInvocation _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ConstructorInvocation_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			ConstructorInvocation _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_ConstructorInvocation_1_1_performtransformation_binding = pattern_ConstructorInvocation_1_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_ConstructorInvocation_1_1_performtransformation_binding != null) {
			...
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_ConstructorInvocation_1_1_performtransformation_binding[3];
			TMember tMethod = (TMember) result_pattern_ConstructorInvocation_1_1_performtransformation_binding[4];
			MDefinition mMember = (MDefinition) result_pattern_ConstructorInvocation_1_1_performtransformation_binding[5];
			AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) result_pattern_ConstructorInvocation_1_1_performtransformation_binding[6];

			Object[] result_pattern_ConstructorInvocation_1_1_performtransformation_black = pattern_ConstructorInvocation_1_1_performtransformation_blackBBBBBBBFBB(
			...
			if (result_pattern_ConstructorInvocation_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_ConstructorInvocation_1_1_performtransformation_black[7];
	...
	public static final Object[] pattern_ConstructorInvocation_1_1_performtransformation_greenBBFBFF(
			MConstructorInvocation invocation, TMember tMember, TMember tMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
	...
	public static final void pattern_ConstructorInvocation_1_5_registerobjects_expressionBBBBBBBBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_2_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_ConstructorInvocation_2_2_corematch_blackBFFFFBBB(
			MConstructorInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod, Match match) {
	...
	public static final Iterable<Object[]> pattern_ConstructorInvocation_2_3_findcontext_blackBBBBBBB(
			MConstructorInvocation invocation, MDefinitionToTMember mMemberToTMember, TMember tMember,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_ConstructorInvocation_2_3_findcontext_greenBBBBBBBFFFFFFFF(
			MConstructorInvocation invocation, MDefinitionToTMember mMemberToTMember, TMember tMember,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_2_4_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			ConstructorInvocation _this, IsApplicableMatch isApplicableMatch, MConstructorInvocation invocation,
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		Object[] result_pattern_ConstructorInvocation_2_4_solveCSP_binding = pattern_ConstructorInvocation_2_4_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_10_1_initialbindings_blackBBBBB(
			ConstructorInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		if (!tMember.equals(tMethod)) {
	...
	public static final Object[] pattern_ConstructorInvocation_10_2_SolveCSP_bindingFBBBBB(ConstructorInvocation _this,
	...
	public static final Object[] pattern_ConstructorInvocation_10_2_SolveCSP_bindingAndBlackFBBBBB(
			ConstructorInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		Object[] result_pattern_ConstructorInvocation_10_2_SolveCSP_binding = pattern_ConstructorInvocation_10_2_SolveCSP_bindingFBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_10_4_collectelementstobetranslated_blackBBBB(Match match,
	...
	public static final Object[] pattern_ConstructorInvocation_10_4_collectelementstobetranslated_greenBBBBFFFF(
			Match match, TMember tMember, TCall tAccess, TMember tMethod) {
		EMoflonEdge tMember__tAccess____tAccessing = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAccess__tMember____tSource = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAccess__tMethod____tTarget = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_ConstructorInvocation_10_5_collectcontextelements_blackBBBB(Match match,
			TMember tMember, TCall tAccess, TMember tMethod) {
		if (!tMember.equals(tMethod)) {
			return new Object[] { match, tMember, tAccess, tMethod };
		}
	...
	public static final Object[] pattern_ConstructorInvocation_10_5_collectcontextelements_greenBBB(Match match,
	...
	public static final void pattern_ConstructorInvocation_10_6_registerobjectstomatch_expressionBBBBB(
			ConstructorInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_11_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ConstructorInvocation_11_1_performtransformation_blackBBBBBBBFBB(
	...
	public static final Object[] pattern_ConstructorInvocation_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			ConstructorInvocation _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_ConstructorInvocation_11_1_performtransformation_binding = pattern_ConstructorInvocation_11_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_ConstructorInvocation_11_1_performtransformation_binding != null) {
			...
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_ConstructorInvocation_11_1_performtransformation_binding[3];
			TMember tMethod = (TMember) result_pattern_ConstructorInvocation_11_1_performtransformation_binding[4];
			MDefinition mMember = (MDefinition) result_pattern_ConstructorInvocation_11_1_performtransformation_binding[5];
			AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) result_pattern_ConstructorInvocation_11_1_performtransformation_binding[6];

			Object[] result_pattern_ConstructorInvocation_11_1_performtransformation_black = pattern_ConstructorInvocation_11_1_performtransformation_blackBBBBBBBFBB(
			...
			if (result_pattern_ConstructorInvocation_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_ConstructorInvocation_11_1_performtransformation_black[7];
	...
	public static final Object[] pattern_ConstructorInvocation_11_1_performtransformation_greenFBBFFB(TCall tAccess,
			MDefinition mMember, AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_11_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject invocation, EObject mMemberToTMember, EObject tMember,
			EObject tAccess, EObject mMethodToTMethod, EObject tMethod, EObject mMember,
			EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
		if (!invocation.equals(mMemberToTMember)) {
	...
	public static final Object[] pattern_ConstructorInvocation_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject invocation, EObject tMember, EObject tAccess, EObject tMethod,
			EObject mMember, EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
		EMoflonEdge invocation__mMethod____method = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mMethod__invocation____usages = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_ConstructorInvocation_11_5_registerobjects_expressionBBBBBBBBBBBB(
			ConstructorInvocation _this, PerformRuleResult ruleresult, EObject invocation, EObject mMemberToTMember,
			EObject tMember, EObject tAccess, EObject mMethodToTMethod, EObject tMethod, EObject mMember,
			EObject mFlowElementToTFlowElement, EObject invocationToTAccess, EObject mMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_12_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_ConstructorInvocation_12_2_corematch_blackFBBFBFFB(TMember tMember,
	...
	public static final Iterable<Object[]> pattern_ConstructorInvocation_12_3_findcontext_blackBBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, TCall tAccess,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_ConstructorInvocation_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
			MDefinitionToTMember mMemberToTMember, TMember tMember, TCall tAccess,
			MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_ConstructorInvocation_12_4_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			ConstructorInvocation _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			TMember tMember, TCall tAccess, MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
		Object[] result_pattern_ConstructorInvocation_12_4_solveCSP_binding = pattern_ConstructorInvocation_12_4_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Iterable<Object[]> pattern_ConstructorInvocation_20_2_testcorematchandDECs_blackFFFB(
	...
	public static final boolean pattern_ConstructorInvocation_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			ConstructorInvocation _this, Match match, TMember tMember, TCall tAccess, TMember tMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (MDefinition __DEC_invocation_mMethodInvocations_870533 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_870533)) {
	...
	public static final Iterable<Object[]> pattern_ConstructorInvocation_21_2_testcorematchandDECs_blackFFFB(
	...
	public static final boolean pattern_ConstructorInvocation_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			ConstructorInvocation _this, Match match, MConstructorInvocation invocation, MDefinition mMember,
			AbstractMethodDeclaration mMethod) {
	...
	public static final Object[] pattern_ConstructorInvocation_24_2_matchsrctrgcontext_bindingFFFFFFBB(
	...
	public static final Object[] pattern_ConstructorInvocation_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MConstructorInvocation invocation, TMember tMember, TCall tAccess, TMember tMethod, MDefinition mMember,
	...
	public static final Object[] pattern_ConstructorInvocation_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_ConstructorInvocation_24_2_matchsrctrgcontext_binding = pattern_ConstructorInvocation_24_2_matchsrctrgcontext_bindingFFFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_ConstructorInvocation_24_2_matchsrctrgcontext_binding != null) {
			...
			TMember tMethod = (TMember) result_pattern_ConstructorInvocation_24_2_matchsrctrgcontext_binding[3];
			MDefinition mMember = (MDefinition) result_pattern_ConstructorInvocation_24_2_matchsrctrgcontext_binding[4];
			AbstractMethodDeclaration mMethod = (AbstractMethodDeclaration) result_pattern_ConstructorInvocation_24_2_matchsrctrgcontext_binding[5];

			Object[] result_pattern_ConstructorInvocation_24_2_matchsrctrgcontext_black = pattern_ConstructorInvocation_24_2_matchsrctrgcontext_blackBBBBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_24_3_solvecsp_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			ConstructorInvocation _this, MConstructorInvocation invocation, TMember tMember, TCall tAccess,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_ConstructorInvocation_24_3_solvecsp_binding = pattern_ConstructorInvocation_24_3_solvecsp_bindingFBBBBBBBBB(
	...
	public static final Iterable<Object[]> pattern_ConstructorInvocation_24_5_matchcorrcontext_blackFBFBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_24_5_matchcorrcontext_greenBBBBF(
	...
	public static final Object[] pattern_ConstructorInvocation_24_6_createcorrespondence_blackBBBBBBB(
			MConstructorInvocation invocation, TMember tMember, TCall tAccess, TMember tMethod, MDefinition mMember,
	...
	public static final Object[] pattern_ConstructorInvocation_27_1_matchtggpattern_black_nac_0BB(
			MConstructorInvocation invocation, MDefinition mMember) {
		for (MDefinition __DEC_invocation_mMethodInvocations_599005 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(invocation, MDefinition.class, "mMethodInvocations")) {
			if (!mMember.equals(__DEC_invocation_mMethodInvocations_599005)) {
				return new Object[] { invocation, mMember };
			}
		}
		return null;
	...
	public static final Object[] pattern_ConstructorInvocation_27_1_matchtggpattern_blackBBB(
			MConstructorInvocation invocation, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		if (mMethod.equals(invocation.getMethod())) {
			if (mMember.getMMethodInvocations().contains(invocation)) {
	...
	public static final Object[] pattern_ConstructorInvocation_28_1_matchtggpattern_blackBBB(TMember tMember,
	...
	public static final Object[] pattern_ConstructorInvocation_29_2_isapplicablecore_black_nac_3BB(
	...
	public static final Object[] pattern_ConstructorInvocation_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_ConstructorInvocation_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Iterable<Object[]> pattern_ConstructorInvocation_29_2_isapplicablecore_blackFFFFFFFFBB(
							...
							if (tMember != null) {
								...
								if (tmpMMember instanceof MDefinition) {
									...
									if (pattern_ConstructorInvocation_29_2_isapplicablecore_black_nac_0BB(ruleResult,
										...
										if (pattern_ConstructorInvocation_29_2_isapplicablecore_black_nac_1BB(
												ruleResult, tMember) == null) {
											if (pattern_ConstructorInvocation_29_2_isapplicablecore_black_nac_2BB(
													...
													if (tmpMMethodToTMethod instanceof MDefinitionToTMember) {
														...
														if (!mMemberToTMember.equals(mMethodToTMethod)) {
															...
															if (tmpMMethod instanceof AbstractMethodDeclaration) {
																...
																if (tMethod != null) {
																	if (!tMember.equals(tMethod)) {
																		if (pattern_ConstructorInvocation_29_2_isapplicablecore_black_nac_3BB(
																				ruleResult, mMethodToTMethod) == null) {
																			if (pattern_ConstructorInvocation_29_2_isapplicablecore_black_nac_4BB(
																					ruleResult, mMethod) == null) {
																				if (pattern_ConstructorInvocation_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Object[] pattern_ConstructorInvocation_29_3_solveCSP_bindingFBBBBBBBBB(
			ConstructorInvocation _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			TMember tMember, MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
	...
	public static final Object[] pattern_ConstructorInvocation_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			ConstructorInvocation _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			TMember tMember, MDefinitionToTMember mMethodToTMethod, TMember tMethod, MDefinition mMember,
			AbstractMethodDeclaration mMethod, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_ConstructorInvocation_29_3_solveCSP_binding = pattern_ConstructorInvocation_29_3_solveCSP_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_ConstructorInvocation_29_5_checknacs_blackBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod) {
		if (!mMemberToTMember.equals(mMethodToTMethod)) {
			if (!tMember.equals(tMethod)) {
	...
	public static final Object[] pattern_ConstructorInvocation_29_6_perform_blackBBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MDefinitionToTMember mMethodToTMethod,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod,
	...
	public static final Object[] pattern_ConstructorInvocation_29_6_perform_greenFBFBBFFBB(TMember tMember,
			TMember tMethod, MDefinition mMember, AbstractMethodDeclaration mMethod,
			ModelgeneratorRuleResult ruleResult) {
		MConstructorInvocation invocation = ModiscoFactory.eINSTANCE.createMConstructorInvocation();
		TCall tAccess = BasicFactory.eINSTANCE.createTCall();
