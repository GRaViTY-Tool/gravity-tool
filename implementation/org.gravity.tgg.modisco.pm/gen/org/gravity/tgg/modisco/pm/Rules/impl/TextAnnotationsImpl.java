...
public class TextAnnotationsImpl extends AbstractRuleImpl implements TextAnnotations {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TextAnnotationsImpl.pattern_TextAnnotations_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, tText, mMemberToTMember, tMember, mCommentToTText, mMember, mComment);
		...
		TextAnnotationsImpl.pattern_TextAnnotations_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tText,
				mMemberToTMember, tMember, mCommentToTText, mMember, mComment);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tText, EObject mMemberToTMember,
			EObject tMember, EObject mCommentToTText, EObject mMember, EObject mComment) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		TextAnnotationsImpl.pattern_TextAnnotations_11_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tText,
				tMember, mCommentToTText, mMember, mComment);
		//nothing EMoflonEdge mCommentToTText__tText____target = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mMember__mComment____comments = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mCommentToTText__mComment____source = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge tText__tMember____tAnnotated = (EMoflonEdge) result3_green[9];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_16(EMoflonEdge _edge_tAnnotated) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_16(EMoflonEdge _edge_comments) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TextAnnotationsImpl
				.pattern_TextAnnotations_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tText, tMember, mMember, mComment,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tText] = " + tText + ", " + "[tMember] = " + tMember + ", " + "[mMember] = " + mMember + ", "
		...
		if (TextAnnotationsImpl.pattern_TextAnnotations_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TextAnnotationsImpl.pattern_TextAnnotations_24_5_matchcorrcontext_blackFBBBB(
				...
				Object[] result6_black = TextAnnotationsImpl
						.pattern_TextAnnotations_24_6_createcorrespondence_blackBBBBB(tText, tMember, mMember, mComment,
								ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tText] = " + tText + ", "
							+ "[tMember] = " + tMember + ", " + "[mMember] = " + mMember + ", " + "[mComment] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TTextAnnotation tText, TMember tMember, MDefinition mMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TEXT_ANNOTATIONS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_16__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_16((EMoflonEdge) arguments.get(0));
		case RulesPackage.TEXT_ANNOTATIONS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_16__EMOFLONEDGE:
		...
		case RulesPackage.TEXT_ANNOTATIONS___IS_APPLICABLE_SOLVE_CSP_CC__TTEXTANNOTATION_TMEMBER_MDEFINITION_LINECOMMENT_MATCH_MATCH:
	...
	public static final Object[] pattern_TextAnnotations_1_1_performtransformation_greenFBFBB(TMember tMember,
		...
		return new Object[] { tText, tMember, mCommentToTText, mComment, csp };
	}
	...
	public static final Object[] pattern_TextAnnotations_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tText, EObject mMemberToTMember, EObject tMember,
	...
	public static final Object[] pattern_TextAnnotations_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tText, EObject tMember, EObject mCommentToTText, EObject mMember,
			EObject mComment) {
		...
		return new Object[] { ruleresult, tText, tMember, mCommentToTText, mMember, mComment,
	...
	public static final void pattern_TextAnnotations_1_5_registerobjects_expressionBBBBBBBB(TextAnnotations _this,
			PerformRuleResult ruleresult, EObject tText, EObject mMemberToTMember, EObject tMember,
			EObject mCommentToTText, EObject mMember, EObject mComment) {
		_this.registerObjects_FWD(ruleresult, tText, mMemberToTMember, tMember, mCommentToTText, mMember, mComment);
	...
	public static final void pattern_TextAnnotations_11_5_registerobjects_expressionBBBBBBBB(TextAnnotations _this,
			PerformRuleResult ruleresult, EObject tText, EObject mMemberToTMember, EObject tMember,
			EObject mCommentToTText, EObject mMember, EObject mComment) {
		_this.registerObjects_BWD(ruleresult, tText, mMemberToTMember, tMember, mCommentToTText, mMember, mComment);
	...
	public static final Object[] pattern_TextAnnotations_20_2_testcorematchandDECs_black_nac_0BB(TTextAnnotation tText,
			TMember tMember) {
		TAnnotatable __DEC_tText_tAnnotation_904418 = tText.getTAnnotated();
		if (__DEC_tText_tAnnotation_904418 != null) {
			if (!tMember.equals(__DEC_tText_tAnnotation_904418)) {
		...
		if (tmpTText instanceof TTextAnnotation) {
			...
			if (tmpTMember instanceof TMember) {
				...
				if (tmpMMember instanceof MDefinition) {
					...
					if (tmpMComment instanceof LineComment) {
						LineComment mComment = (LineComment) tmpMComment;
						return new Object[] { tText, tMember, mMember, mComment, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_TextAnnotations_24_2_matchsrctrgcontext_blackBBBBBB(TTextAnnotation tText,
			TMember tMember, MDefinition mMember, LineComment mComment, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			boolean mComment_prefixOfParent = mComment.isPrefixOfParent();
			if (Boolean.valueOf(mComment_prefixOfParent).equals(Boolean.valueOf(true))) {
				return new Object[] { tText, tMember, mMember, mComment, sourceMatch, targetMatch };
			}
	...
	public static final Object[] pattern_TextAnnotations_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_TextAnnotations_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TextAnnotations_24_2_matchsrctrgcontext_black = pattern_TextAnnotations_24_2_matchsrctrgcontext_blackBBBBBB(
					tText, tMember, mMember, mComment, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_TextAnnotations_24_3_solvecsp_bindingFBBBBBBB(TextAnnotations _this,
			TTextAnnotation tText, TMember tMember, MDefinition mMember, LineComment mComment, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tText, tMember, mMember, mComment, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tText, tMember, mMember, mComment, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TextAnnotations_24_3_solvecsp_bindingAndBlackFBBBBBBB(TextAnnotations _this,
		...
		Object[] result_pattern_TextAnnotations_24_3_solvecsp_binding = pattern_TextAnnotations_24_3_solvecsp_bindingFBBBBBBB(
				_this, tText, tMember, mMember, mComment, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_TextAnnotations_24_6_createcorrespondence_blackBBBBB(TTextAnnotation tText,
			TMember tMember, MDefinition mMember, LineComment mComment, CCMatch ccMatch) {
		return new Object[] { tText, tMember, mMember, mComment, ccMatch };
	}
	...
	public static final Object[] pattern_TextAnnotations_28_1_matchtggpattern_black_nac_0BB(TTextAnnotation tText,
			TMember tMember) {
		TAnnotatable __DEC_tText_tAnnotation_619978 = tText.getTAnnotated();
		if (__DEC_tText_tAnnotation_619978 != null) {
			if (!tMember.equals(__DEC_tText_tAnnotation_619978)) {
				return new Object[] { tText, tMember };
			}
		}
	...
	public static final Object[] pattern_TextAnnotations_29_6_perform_greenFBFBFBB(TMember tMember, MDefinition mMember,
		...
		return new Object[] { tText, tMember, mCommentToTText, mMember, mComment, ruleResult, csp };
	}
