...
public class AnnotationTypeMemberImpl extends AbstractRuleImpl implements AnnotationTypeMember {
	...
	public boolean isAppropriate_FWD(Match match, AnnotationTypeMemberDeclaration mMember, TypeAccess access,
		...
		Object[] result1_black = AnnotationTypeMemberImpl.pattern_AnnotationTypeMember_0_1_initialbindings_blackBBBBBB(
				this, match, mMember, access, mType, mAnnotation);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[mMember] = " + mMember + ", " + "[access] = " + access + ", "
					+ "[mType] = " + mType + ", " + "[mAnnotation] = " + mAnnotation + ".");
		}

		Object[] result2_bindingAndBlack = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, mMember, access, mType,
						mAnnotation);
		...
		if (AnnotationTypeMemberImpl.pattern_AnnotationTypeMember_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[mMember] = " + mMember + ", " + "[access] = " + access + ", " + "[mType] = " + mType + ", "
			...
			AnnotationTypeMemberImpl.pattern_AnnotationTypeMember_0_4_collectelementstobetranslated_greenBBBBBFFFFF(
					match, mMember, access, mType, mAnnotation);
			...
			Object[] result5_black = AnnotationTypeMemberImpl
					.pattern_AnnotationTypeMember_0_5_collectcontextelements_blackBBBBB(match, mMember, access, mType,
							mAnnotation);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_1_1_performtransformation_greenFBFBBFBFFB(mMember, tType, tAnnotation, pm,
						csp);
		...
		Object[] result2_black = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_1_2_collecttranslatedelements_blackBBBBBBB(tName, mMember, memberToMember,
						tMember, anntotatableToTannotatable, access, tSignature);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tName] = " + tName + ", "
					+ "[mMember] = " + mMember + ", " + "[memberToMember] = " + memberToMember + ", " + "[tMember] = "
					+ tMember + ", " + "[anntotatableToTannotatable] = " + anntotatableToTannotatable + ", "
					+ "[access] = " + access + ", " + "[tSignature] = " + tSignature + ".");
		}
		Object[] result2_green = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_1_2_collecttranslatedelements_greenFBBBBBBB(tName, mMember,
						memberToMember, tMember, anntotatableToTannotatable, access, tSignature);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBBB(ruleresult, tName, mMember,
						memberToMember, tType, mTypeToType, tAnnotation, tMember, pm, anntotatableToTannotatable,
						access, mAnnotationToAnnotation, mType, mAnnotation, tSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tName] = " + tName + ", " + "[mMember] = " + mMember + ", " + "[memberToMember] = "
					+ memberToMember + ", " + "[tType] = " + tType + ", " + "[mTypeToType] = " + mTypeToType + ", "
					+ "[tAnnotation] = " + tAnnotation + ", " + "[tMember] = " + tMember + ", " + "[pm] = " + pm + ", "
		...
		AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_1_3_bookkeepingforedges_greenBBBBBBBBBBBBBFFFFFFFFFFFFFFFFFFF(ruleresult,
						tName, mMember, memberToMember, tType, tAnnotation, tMember, pm, anntotatableToTannotatable,
						access, mType, mAnnotation, tSignature);
		...
		//nothing EMoflonEdge anntotatableToTannotatable__mMember____source = (EMoflonEdge) result3_green[26];
		//nothing EMoflonEdge tSignature__tType____type = (EMoflonEdge) result3_green[27];
		...
		AnnotationTypeMemberImpl.pattern_AnnotationTypeMember_1_5_registerobjects_expressionBBBBBBBBBBBBBBBB(this,
				ruleresult, tName, mMember, memberToMember, tType, mTypeToType, tAnnotation, tMember, pm,
				anntotatableToTannotatable, access, mAnnotationToAnnotation, mType, mAnnotation, tSignature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_2_2_corematch_blackBFFFBFBBB(mMember, access, mType, mAnnotation,
						match)) {
			...
			for (Object[] result3_black : AnnotationTypeMemberImpl
					.pattern_AnnotationTypeMember_2_3_findcontext_blackBBBBFBBBB(mMember, tType, mTypeToType,
							tAnnotation, access, mAnnotationToAnnotation, mType, mAnnotation)) {
				TypeGraph pm = (TypeGraph) result3_black[4];
				Object[] result3_green = AnnotationTypeMemberImpl
						.pattern_AnnotationTypeMember_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(mMember, tType,
								mTypeToType, tAnnotation, pm, access, mAnnotationToAnnotation, mType, mAnnotation);
				...
				Object[] result4_bindingAndBlack = AnnotationTypeMemberImpl
						.pattern_AnnotationTypeMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this, isApplicableMatch,
								mMember, tType, mTypeToType, tAnnotation, pm, access, mAnnotationToAnnotation, mType,
								mAnnotation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mMember] = " + mMember + ", "
							+ "[tType] = " + tType + ", " + "[mTypeToType] = " + mTypeToType + ", " + "[tAnnotation] = "
							+ tAnnotation + ", " + "[pm] = " + pm + ", " + "[access] = " + access + ", "
							+ "[mAnnotationToAnnotation] = " + mAnnotationToAnnotation + ", " + "[mType] = " + mType
							+ ", " + "[mAnnotation] = " + mAnnotation + ".");
				}
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, AnnotationTypeMemberDeclaration mMember, TypeAccess access,
			Type mType, AnnotationTypeDeclaration mAnnotation) {// Create CSP
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tName, EObject mMember,
			EObject memberToMember, EObject tType, EObject mTypeToType, EObject tAnnotation, EObject tMember,
			EObject pm, EObject anntotatableToTannotatable, EObject access, EObject mAnnotationToAnnotation,
			EObject mType, EObject mAnnotation, EObject tSignature) {
	...
	public boolean isAppropriate_BWD(Match match, TField tName, TAbstractType tType, TAnnotationType tAnnotation,
		...
		Object[] result2_bindingAndBlack = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_10_2_SolveCSP_bindingAndBlackFBBBBBBBB(this, match, tName, tType,
						tAnnotation, tMember, pm, tSignature);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tName] = " + tName + ", " + "[tType] = " + tType + ", "
					+ "[tAnnotation] = " + tAnnotation + ", " + "[tMember] = " + tMember + ", " + "[pm] = " + pm + ", "
		...
		if (AnnotationTypeMemberImpl.pattern_AnnotationTypeMember_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			AnnotationTypeMemberImpl.pattern_AnnotationTypeMember_10_6_registerobjectstomatch_expressionBBBBBBBB(this,
					match, tName, tType, tAnnotation, tMember, pm, tSignature);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		TypeGraph pm = (TypeGraph) result1_bindingAndBlack[5];
		TypeToTAbstractType mAnnotationToAnnotation = (TypeToTAbstractType) result1_bindingAndBlack[6];
		Type mType = (Type) result1_bindingAndBlack[7];
		AnnotationTypeDeclaration mAnnotation = (AnnotationTypeDeclaration) result1_bindingAndBlack[8];
		...
		Object[] result1_green = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_11_1_performtransformation_greenFFBFFBBB(tMember, mType, mAnnotation,
						csp);
		...
		Object[] result2_black = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_11_2_collecttranslatedelements_blackBBBBBBB(tName, mMember,
						memberToMember, tMember, anntotatableToTannotatable, access, tSignature);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tName] = " + tName + ", "
					+ "[mMember] = " + mMember + ", " + "[memberToMember] = " + memberToMember + ", " + "[tMember] = "
		...
		Object[] result2_green = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_11_2_collecttranslatedelements_greenFBBBBBBB(tName, mMember,
						memberToMember, tMember, anntotatableToTannotatable, access, tSignature);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_11_3_bookkeepingforedges_blackBBBBBBBBBBBBBBB(ruleresult, tName, mMember,
						memberToMember, tType, mTypeToType, tAnnotation, tMember, pm, anntotatableToTannotatable,
						access, mAnnotationToAnnotation, mType, mAnnotation, tSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_12_2_corematch_blackBBFBBBFFFBB(tName, tType, tAnnotation, tMember, pm,
						tSignature, match)) {
			TypeToTAbstractType mTypeToType = (TypeToTAbstractType) result2_black[2];
			...
			// ForEach 
			for (Object[] result3_black : AnnotationTypeMemberImpl
					.pattern_AnnotationTypeMember_12_3_findcontext_blackBBBBBBBBBB(tName, tType, mTypeToType,
							tAnnotation, tMember, pm, mAnnotationToAnnotation, mType, mAnnotation, tSignature)) {
				Object[] result3_green = AnnotationTypeMemberImpl
						.pattern_AnnotationTypeMember_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFFFFF(tName, tType,
								mTypeToType, tAnnotation, tMember, pm, mAnnotationToAnnotation, mType, mAnnotation,
								tSignature);
				...
				//nothing EMoflonEdge tAnnotation__pm____model = (EMoflonEdge) result3_green[16];
				//nothing EMoflonEdge pm__tAnnotation____allTypes = (EMoflonEdge) result3_green[17];
				...
				//nothing EMoflonEdge mAnnotationToAnnotation__mAnnotation____source = (EMoflonEdge) result3_green[23];
				...
				Object[] result4_bindingAndBlack = AnnotationTypeMemberImpl
						.pattern_AnnotationTypeMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, tName, tType, mTypeToType, tAnnotation, tMember, pm,
								mAnnotationToAnnotation, mType, mAnnotation, tSignature);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tName] = " + tName + ", "
							+ "[tType] = " + tType + ", " + "[mTypeToType] = " + mTypeToType + ", " + "[tAnnotation] = "
							+ tAnnotation + ", " + "[tMember] = " + tMember + ", " + "[pm] = " + pm + ", "
							+ "[mAnnotationToAnnotation] = " + mAnnotationToAnnotation + ", " + "[mType] = " + mType
							+ ", " + "[mAnnotation] = " + mAnnotation + ", " + "[tSignature] = " + tSignature + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
	...
	public CSP isAppropriate_solveCsp_BWD(Match match, TField tName, TAbstractType tType, TAnnotationType tAnnotation,
			TFieldDefinition tMember, TypeGraph pm, TFieldSignature tSignature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TField tName, TAbstractType tType,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tName, EObject mMember,
			EObject memberToMember, EObject tType, EObject mTypeToType, EObject tAnnotation, EObject tMember,
			EObject pm, EObject anntotatableToTannotatable, EObject access, EObject mAnnotationToAnnotation,
			EObject mType, EObject mAnnotation, EObject tSignature) {
		ruleresult.registerObject("tName", tName);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_89(EMoflonEdge _edge_model) {
		...
		for (Object[] result2_black : AnnotationTypeMemberImpl
			...
			if (AnnotationTypeMemberImpl
					.pattern_AnnotationTypeMember_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBBB(
							this, match, tName, tType, tAnnotation, tMember, pm, tSignature)) {
				// 
				if (AnnotationTypeMemberImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBB(this, tName, mMember, tType,
						tAnnotation, tMember, pm, access, mType, mAnnotation, tSignature, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tName] = " + tName + ", " + "[mMember] = " + mMember + ", " + "[tType] = " + tType + ", "
					+ "[tAnnotation] = " + tAnnotation + ", " + "[tMember] = " + tMember + ", " + "[pm] = " + pm + ", "
		...
		if (AnnotationTypeMemberImpl.pattern_AnnotationTypeMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationTypeMemberImpl
				...
				Object[] result6_black = AnnotationTypeMemberImpl
						.pattern_AnnotationTypeMember_24_6_createcorrespondence_blackBBBBBBBBBBB(tName, mMember, tType,
								tAnnotation, tMember, pm, access, mType, mAnnotation, tSignature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
							"Pattern matching failed." + " Variables: " + "[tName] = " + tName + ", " + "[mMember] = "
									+ mMember + ", " + "[tType] = " + tType + ", " + "[tAnnotation] = " + tAnnotation
									+ ", " + "[tMember] = " + tMember + ", " + "[pm] = " + pm + ", " + "[access] = "
									+ access + ", " + "[mType] = " + mType + ", " + "[mAnnotation] = " + mAnnotation
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TField tName, AnnotationTypeMemberDeclaration mMember, TAbstractType tType,
			TAnnotationType tAnnotation, TFieldDefinition tMember, TypeGraph pm, TypeAccess access, Type mType,
			AnnotationTypeDeclaration mAnnotation, TFieldSignature tSignature, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(AnnotationTypeMemberDeclaration mMember, TypeAccess access, Type mType,
			AnnotationTypeDeclaration mAnnotation) {// 
		Object[] result1_black = AnnotationTypeMemberImpl
				.pattern_AnnotationTypeMember_27_1_matchtggpattern_blackBBBB(mMember, access, mType, mAnnotation);
		if (result1_black != null) {
		...
		for (Object[] result2_black : AnnotationTypeMemberImpl
			...
			Object[] result3_bindingAndBlack = AnnotationTypeMemberImpl
					.pattern_AnnotationTypeMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
							tType, mTypeToType, tAnnotation, pm, mAnnotationToAnnotation, mType, mAnnotation,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tType] = " + tType + ", "
						+ "[mTypeToType] = " + mTypeToType + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[pm] = "
						+ pm + ", " + "[mAnnotationToAnnotation] = " + mAnnotationToAnnotation + ", " + "[mType] = "
						+ mType + ", " + "[mAnnotation] = " + mAnnotation + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (AnnotationTypeMemberImpl.pattern_AnnotationTypeMember_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = AnnotationTypeMemberImpl
						.pattern_AnnotationTypeMember_29_5_checknacs_blackBBBBBBB(tType, mTypeToType, tAnnotation, pm,
								mAnnotationToAnnotation, mType, mAnnotation);
				if (result5_black != null) {

					Object[] result6_black = AnnotationTypeMemberImpl
							.pattern_AnnotationTypeMember_29_6_perform_blackBBBBBBBB(tType, mTypeToType, tAnnotation,
									pm, mAnnotationToAnnotation, mType, mAnnotation, ruleResult);
					if (result6_black == null) {
					...
					AnnotationTypeMemberImpl.pattern_AnnotationTypeMember_29_6_perform_greenFFFBBFBFFBBFBB(tType,
							tAnnotation, pm, mType, mAnnotation, ruleResult, csp);
					...
					//nothing TFieldDefinition tMember = (TFieldDefinition) result6_green[5];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.ANNOTATION_TYPE_MEMBER___IS_APPROPRIATE_FWD__MATCH_ANNOTATIONTYPEMEMBERDECLARATION_TYPEACCESS_TYPE_ANNOTATIONTYPEDECLARATION:
		...
		case RulesPackage.ANNOTATION_TYPE_MEMBER___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_ANNOTATIONTYPEMEMBERDECLARATION_TYPEACCESS_TYPE_ANNOTATIONTYPEDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (AnnotationTypeMemberDeclaration) arguments.get(1),
					(TypeAccess) arguments.get(2), (Type) arguments.get(3),
					(AnnotationTypeDeclaration) arguments.get(4));
			return null;
		case RulesPackage.ANNOTATION_TYPE_MEMBER___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_ANNOTATIONTYPEMEMBERDECLARATION_TYPEACCESS_TYPE_ANNOTATIONTYPEDECLARATION:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
					(AnnotationTypeMemberDeclaration) arguments.get(1), (TypeAccess) arguments.get(2),
					(Type) arguments.get(3), (AnnotationTypeDeclaration) arguments.get(4));
		case RulesPackage.ANNOTATION_TYPE_MEMBER___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.ANNOTATION_TYPE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONTYPEMEMBERDECLARATION_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TANNOTATIONTYPE_TYPEGRAPH_TYPEACCESS_TYPETOTABSTRACTTYPE_TYPE_ANNOTATIONTYPEDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AnnotationTypeMemberDeclaration) arguments.get(1), (TAbstractType) arguments.get(2),
					(TypeToTAbstractType) arguments.get(3), (TAnnotationType) arguments.get(4),
					(TypeGraph) arguments.get(5), (TypeAccess) arguments.get(6), (TypeToTAbstractType) arguments.get(7),
					(Type) arguments.get(8), (AnnotationTypeDeclaration) arguments.get(9));
		...
		case RulesPackage.ANNOTATION_TYPE_MEMBER___IS_APPROPRIATE_BWD__MATCH_TFIELD_TABSTRACTTYPE_TANNOTATIONTYPE_TFIELDDEFINITION_TYPEGRAPH_TFIELDSIGNATURE:
			return isAppropriate_BWD((Match) arguments.get(0), (TField) arguments.get(1),
					...
					(TFieldSignature) arguments.get(6));
		...
		case RulesPackage.ANNOTATION_TYPE_MEMBER___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TFIELD_TABSTRACTTYPE_TANNOTATIONTYPE_TFIELDDEFINITION_TYPEGRAPH_TFIELDSIGNATURE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TField) arguments.get(1),
					(TAbstractType) arguments.get(2), (TAnnotationType) arguments.get(3),
					(TFieldDefinition) arguments.get(4), (TypeGraph) arguments.get(5),
					(TFieldSignature) arguments.get(6));
			return null;
		case RulesPackage.ANNOTATION_TYPE_MEMBER___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TFIELD_TABSTRACTTYPE_TANNOTATIONTYPE_TFIELDDEFINITION_TYPEGRAPH_TFIELDSIGNATURE:
		...
		case RulesPackage.ANNOTATION_TYPE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TFIELD_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TANNOTATIONTYPE_TFIELDDEFINITION_TYPEGRAPH_TYPETOTABSTRACTTYPE_TYPE_ANNOTATIONTYPEDECLARATION_TFIELDSIGNATURE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TField) arguments.get(1),
					...
					(TypeGraph) arguments.get(6), (TypeToTAbstractType) arguments.get(7), (Type) arguments.get(8),
					(AnnotationTypeDeclaration) arguments.get(9), (TFieldSignature) arguments.get(10));
		...
		case RulesPackage.ANNOTATION_TYPE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_89__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION_TYPE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__TFIELD_ANNOTATIONTYPEMEMBERDECLARATION_TABSTRACTTYPE_TANNOTATIONTYPE_TFIELDDEFINITION_TYPEGRAPH_TYPEACCESS_TYPE_ANNOTATIONTYPEDECLARATION_TFIELDSIGNATURE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TField) arguments.get(0),
					(AnnotationTypeMemberDeclaration) arguments.get(1), (TAbstractType) arguments.get(2),
					(TAnnotationType) arguments.get(3), (TFieldDefinition) arguments.get(4),
					(TypeGraph) arguments.get(5), (TypeAccess) arguments.get(6), (Type) arguments.get(7),
					(AnnotationTypeDeclaration) arguments.get(8), (TFieldSignature) arguments.get(9),
		...
		case RulesPackage.ANNOTATION_TYPE_MEMBER___CHECK_DEC_FWD__ANNOTATIONTYPEMEMBERDECLARATION_TYPEACCESS_TYPE_ANNOTATIONTYPEDECLARATION:
		...
		case RulesPackage.ANNOTATION_TYPE_MEMBER___CHECK_DEC_BWD__TFIELD_TABSTRACTTYPE_TANNOTATIONTYPE_TFIELDDEFINITION_TYPEGRAPH_TFIELDSIGNATURE:
			return checkDEC_BWD((TField) arguments.get(0), (TAbstractType) arguments.get(1),
					...
					(TypeGraph) arguments.get(4), (TFieldSignature) arguments.get(5));
		...
		case RulesPackage.ANNOTATION_TYPE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TANNOTATIONTYPE_TYPEGRAPH_TYPETOTABSTRACTTYPE_TYPE_ANNOTATIONTYPEDECLARATION_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TAbstractType) arguments.get(1),
					...
					(TypeGraph) arguments.get(4), (TypeToTAbstractType) arguments.get(5), (Type) arguments.get(6),
	...
	public static final Object[] pattern_AnnotationTypeMember_0_1_initialbindings_blackBBBBBB(
		...
		if (!mAnnotation.equals(mType)) {
			return new Object[] { _this, match, mMember, access, mType, mAnnotation };
		}
		return null;
	}

	public static final Object[] pattern_AnnotationTypeMember_0_2_SolveCSP_bindingFBBBBBB(AnnotationTypeMember _this,
			Match match, AnnotationTypeMemberDeclaration mMember, TypeAccess access, Type mType,
			AnnotationTypeDeclaration mAnnotation) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, mMember, access, mType, mAnnotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, mMember, access, mType, mAnnotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_AnnotationTypeMember_0_2_SolveCSP_binding = pattern_AnnotationTypeMember_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, mMember, access, mType, mAnnotation);
	...
	public static final Object[] pattern_AnnotationTypeMember_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			AnnotationTypeMemberDeclaration mMember, TypeAccess access, Type mType,
			AnnotationTypeDeclaration mAnnotation) {
		if (!mAnnotation.equals(mType)) {
			return new Object[] { match, mMember, access, mType, mAnnotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_0_4_collectelementstobetranslated_greenBBBBBFFFFF(
		...
		return new Object[] { match, mMember, access, mType, mAnnotation, mMember__access____type,
	...
	public static final void pattern_AnnotationTypeMember_0_6_registerobjectstomatch_expressionBBBBBB(
			AnnotationTypeMember _this, Match match, AnnotationTypeMemberDeclaration mMember, TypeAccess access,
			Type mType, AnnotationTypeDeclaration mAnnotation) {
		_this.registerObjectsToMatch_FWD(match, mMember, access, mType, mAnnotation);
								...
								if (tmpMAnnotationToAnnotation instanceof TypeToTAbstractType) {
									...
									if (tmpMType instanceof Type) {
										...
										if (tmpMAnnotation instanceof AnnotationTypeDeclaration) {
											...
											return new Object[] { mMember, tType, mTypeToType, tAnnotation, pm, access,
													mAnnotationToAnnotation, mType, mAnnotation, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_AnnotationTypeMember_1_1_performtransformation_blackBBBBBBBBBFBB(
			AnnotationTypeMemberDeclaration mMember, TAbstractType tType, TypeToTAbstractType mTypeToType,
			TAnnotationType tAnnotation, TypeGraph pm, TypeAccess access, TypeToTAbstractType mAnnotationToAnnotation,
			Type mType, AnnotationTypeDeclaration mAnnotation, AnnotationTypeMember _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!mAnnotation.equals(mType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mMember, tType, mTypeToType, tAnnotation, pm, access,
									mAnnotationToAnnotation, mType, mAnnotation, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationTypeMember_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_AnnotationTypeMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationTypeMember_1_1_performtransformation_black = pattern_AnnotationTypeMember_1_1_performtransformation_blackBBBBBBBBBFBB(
					mMember, tType, mTypeToType, tAnnotation, pm, access, mAnnotationToAnnotation, mType, mAnnotation,
			...
			if (result_pattern_AnnotationTypeMember_1_1_performtransformation_black != null) {
				...
				return new Object[] { mMember, tType, mTypeToType, tAnnotation, pm, access, mAnnotationToAnnotation,
						mType, mAnnotation, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}

	public static final Object[] pattern_AnnotationTypeMember_1_1_performtransformation_greenFBFBBFBFFB(
		...
		return new Object[] { tName, mMember, memberToMember, tType, tAnnotation, tMember, pm,
				anntotatableToTannotatable, tSignature, csp };
	}

	public static final Object[] pattern_AnnotationTypeMember_1_2_collecttranslatedelements_blackBBBBBBB(TField tName,
			AnnotationTypeMemberDeclaration mMember, MDefinitionToTMember memberToMember, TFieldDefinition tMember,
			ASTNodeToTAnnotatable anntotatableToTannotatable, TypeAccess access, TFieldSignature tSignature) {
		return new Object[] { tName, mMember, memberToMember, tMember, anntotatableToTannotatable, access, tSignature };
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_1_2_collecttranslatedelements_greenFBBBBBBB(TField tName,
		...
		return new Object[] { ruleresult, tName, mMember, memberToMember, tMember, anntotatableToTannotatable, access,
				tSignature };
	}

	public static final Object[] pattern_AnnotationTypeMember_1_3_bookkeepingforedges_blackBBBBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tName, EObject mMember, EObject memberToMember, EObject tType,
			EObject mTypeToType, EObject tAnnotation, EObject tMember, EObject pm, EObject anntotatableToTannotatable,
			EObject access, EObject mAnnotationToAnnotation, EObject mType, EObject mAnnotation, EObject tSignature) {
	...
	public static final Object[] pattern_AnnotationTypeMember_1_3_bookkeepingforedges_greenBBBBBBBBBBBBBFFFFFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tName, EObject mMember, EObject memberToMember, EObject tType,
			EObject tAnnotation, EObject tMember, EObject pm, EObject anntotatableToTannotatable, EObject access,
			EObject mType, EObject mAnnotation, EObject tSignature) {
		...
		return new Object[] { ruleresult, tName, mMember, memberToMember, tType, tAnnotation, tMember, pm,
				anntotatableToTannotatable, access, mType, mAnnotation, tSignature, tName__pm____model,
				pm__tName____fields, tAnnotation__tSignature____signature, tAnnotation__tMember____defines,
				tMember__tAnnotation____definedBy, memberToMember__mMember____source, memberToMember__tMember____target,
				mMember__access____type, access__mType____type, mType__access____usagesInTypeAccess,
				...
				tSignature__tType____type, mAnnotation__mMember____bodyDeclarations,
				mMember__mAnnotation____abstractTypeDeclaration, tSignature__tMember____definitions,
	...
	public static final void pattern_AnnotationTypeMember_1_5_registerobjects_expressionBBBBBBBBBBBBBBBB(
			AnnotationTypeMember _this, PerformRuleResult ruleresult, EObject tName, EObject mMember,
			EObject memberToMember, EObject tType, EObject mTypeToType, EObject tAnnotation, EObject tMember,
			EObject pm, EObject anntotatableToTannotatable, EObject access, EObject mAnnotationToAnnotation,
			EObject mType, EObject mAnnotation, EObject tSignature) {
		_this.registerObjects_FWD(ruleresult, tName, mMember, memberToMember, tType, mTypeToType, tAnnotation, tMember,
				pm, anntotatableToTannotatable, access, mAnnotationToAnnotation, mType, mAnnotation, tSignature);
		...
		if (tmpMMember instanceof AnnotationTypeMemberDeclaration) {
			...
			if (tmpAccess instanceof TypeAccess) {
				...
				if (tmpMType instanceof Type) {
					...
					if (tmpMAnnotation instanceof AnnotationTypeDeclaration) {
						AnnotationTypeDeclaration mAnnotation = (AnnotationTypeDeclaration) tmpMAnnotation;
						return new Object[] { mMember, access, mType, mAnnotation, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeMember_2_2_corematch_blackBFFFBFBBB(
			AnnotationTypeMemberDeclaration mMember, TypeAccess access, Type mType,
			AnnotationTypeDeclaration mAnnotation, Match match) {
					...
					for (TypeToTAbstractType mAnnotationToAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mAnnotationToAnnotation.equals(mTypeToType)) {
							...
							if (tmpTAnnotation instanceof TAnnotationType) {
								TAnnotationType tAnnotation = (TAnnotationType) tmpTAnnotation;
								if (!tAnnotation.equals(tType)) {
									_result.add(new Object[] { mMember, tType, mTypeToType, tAnnotation, access,
											mAnnotationToAnnotation, mType, mAnnotation, match });
								}
							}
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeMember_2_3_findcontext_blackBBBBFBBBB(
			AnnotationTypeMemberDeclaration mMember, TAbstractType tType, TypeToTAbstractType mTypeToType,
			TAnnotationType tAnnotation, TypeAccess access, TypeToTAbstractType mAnnotationToAnnotation, Type mType,
			AnnotationTypeDeclaration mAnnotation) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tAnnotation.equals(tType)) {
			if (!mAnnotationToAnnotation.equals(mTypeToType)) {
									...
									if (mType.equals(mTypeToType.getSource())) {
										if (mAnnotation.equals(mAnnotationToAnnotation.getSource())) {
											if (mAnnotation.getBodyDeclarations().contains(mMember)) {
												...
												if (pm != null) {
													_result.add(new Object[] { mMember, tType, mTypeToType, tAnnotation,
															pm, access, mAnnotationToAnnotation, mType, mAnnotation });
												}
	...
	public static final Object[] pattern_AnnotationTypeMember_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		mMember__mAnnotation____abstractTypeDeclaration
				.setName(mMember__mAnnotation____abstractTypeDeclaration_name_prime);
		return new Object[] { mMember, tType, mTypeToType, tAnnotation, pm, access, mAnnotationToAnnotation, mType,
				mAnnotation, isApplicableMatch, tAnnotation__pm____model, pm__tAnnotation____allTypes,
				mMember__access____type, mTypeToType__tType____target, access__mType____type,
				mType__access____usagesInTypeAccess, mAnnotationToAnnotation__tAnnotation____target,
				mTypeToType__mType____source, mAnnotationToAnnotation__mAnnotation____source,
	...
	public static final Object[] pattern_AnnotationTypeMember_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TypeAccess access, TypeToTAbstractType mAnnotationToAnnotation, Type mType,
			AnnotationTypeDeclaration mAnnotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mMember, tType, mTypeToType,
				tAnnotation, pm, access, mAnnotationToAnnotation, mType, mAnnotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mMember, tType, mTypeToType, tAnnotation, pm, access,
					mAnnotationToAnnotation, mType, mAnnotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationTypeMember_2_4_solveCSP_binding = pattern_AnnotationTypeMember_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mMember, tType, mTypeToType, tAnnotation, pm, access, mAnnotationToAnnotation,
				mType, mAnnotation);
		if (result_pattern_AnnotationTypeMember_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationTypeMember_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mMember, tType, mTypeToType, tAnnotation, pm,
						access, mAnnotationToAnnotation, mType, mAnnotation };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_10_1_initialbindings_blackBBBBBBBB(
			...
			TFieldDefinition tMember, TypeGraph pm, TFieldSignature tSignature) {
		if (!tAnnotation.equals(tType)) {
			return new Object[] { _this, match, tName, tType, tAnnotation, tMember, pm, tSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_10_2_SolveCSP_bindingFBBBBBBBB(AnnotationTypeMember _this,
		...
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, tName, tType, tAnnotation, tMember, pm,
				tSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, tName, tType, tAnnotation, tMember, pm, tSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_10_2_SolveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_AnnotationTypeMember_10_2_SolveCSP_binding = pattern_AnnotationTypeMember_10_2_SolveCSP_bindingFBBBBBBBB(
				_this, match, tName, tType, tAnnotation, tMember, pm, tSignature);
	...
	public static final Object[] pattern_AnnotationTypeMember_10_4_collectelementstobetranslated_blackBBBBBBB(
			...
			TypeGraph pm, TFieldSignature tSignature) {
		if (!tAnnotation.equals(tType)) {
			return new Object[] { match, tName, tType, tAnnotation, tMember, pm, tSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_10_4_collectelementstobetranslated_greenBBBBBBBFFFFFFFFFF(
		...
		tSignature__tMember____definitions.setName(tSignature__tMember____definitions_name_prime);
		tMember__tSignature____signature.setName(tMember__tSignature____signature_name_prime);
		return new Object[] { match, tName, tType, tAnnotation, tMember, pm, tSignature, tName__pm____model,
				pm__tName____fields, tAnnotation__tSignature____signature, tAnnotation__tMember____defines,
				tMember__tAnnotation____definedBy, tName__tSignature____signatures, tSignature__tName____field,
	...
	public static final Object[] pattern_AnnotationTypeMember_10_5_collectcontextelements_blackBBBBBBB(Match match,
			TField tName, TAbstractType tType, TAnnotationType tAnnotation, TFieldDefinition tMember, TypeGraph pm,
	...
	public static final Object[] pattern_AnnotationTypeMember_10_5_collectcontextelements_greenBBBBFF(Match match,
		...
		tAnnotation__pm____model.setName(tAnnotation__pm____model_name_prime);
		pm__tAnnotation____allTypes.setName(pm__tAnnotation____allTypes_name_prime);
		return new Object[] { match, tType, tAnnotation, pm, tAnnotation__pm____model, pm__tAnnotation____allTypes };
	}

	public static final void pattern_AnnotationTypeMember_10_6_registerobjectstomatch_expressionBBBBBBBB(
			AnnotationTypeMember _this, Match match, TField tName, TAbstractType tType, TAnnotationType tAnnotation,
			TFieldDefinition tMember, TypeGraph pm, TFieldSignature tSignature) {
		_this.registerObjectsToMatch_BWD(match, tName, tType, tAnnotation, tMember, pm, tSignature);
	...
	public static final Object[] pattern_AnnotationTypeMember_11_1_performtransformation_bindingFFFFFFFFFFB(
		...
		EObject _localVariable_5 = isApplicableMatch.getObject("pm");
		EObject _localVariable_6 = isApplicableMatch.getObject("mAnnotationToAnnotation");
		EObject _localVariable_7 = isApplicableMatch.getObject("mType");
		EObject _localVariable_8 = isApplicableMatch.getObject("mAnnotation");
									...
									if (tmpMType instanceof Type) {
										...
										if (tmpMAnnotation instanceof AnnotationTypeDeclaration) {
											...
											if (tmpTSignature instanceof TFieldSignature) {
												...
												return new Object[] { tName, tType, mTypeToType, tAnnotation, tMember,
														pm, mAnnotationToAnnotation, mType, mAnnotation, tSignature,
														isApplicableMatch };
											}
										}
									}
	...
	public static final Object[] pattern_AnnotationTypeMember_11_1_performtransformation_blackBBBBBBBBBBFBB(
			TField tName, TAbstractType tType, TypeToTAbstractType mTypeToType, TAnnotationType tAnnotation,
			TFieldDefinition tMember, TypeGraph pm, TypeToTAbstractType mAnnotationToAnnotation, Type mType,
			AnnotationTypeDeclaration mAnnotation, TFieldSignature tSignature, AnnotationTypeMember _this,
			IsApplicableMatch isApplicableMatch) {
		if (!tAnnotation.equals(tType)) {
			if (!mAnnotationToAnnotation.equals(mTypeToType)) {
				if (!mAnnotation.equals(mType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tName, tType, mTypeToType, tAnnotation, tMember, pm,
									mAnnotationToAnnotation, mType, mAnnotation, tSignature, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_AnnotationTypeMember_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_AnnotationTypeMember_11_1_performtransformation_binding != null) {
			...
			TAnnotationType tAnnotation = (TAnnotationType) result_pattern_AnnotationTypeMember_11_1_performtransformation_binding[3];
			TFieldDefinition tMember = (TFieldDefinition) result_pattern_AnnotationTypeMember_11_1_performtransformation_binding[4];
			TypeGraph pm = (TypeGraph) result_pattern_AnnotationTypeMember_11_1_performtransformation_binding[5];
			...
			Type mType = (Type) result_pattern_AnnotationTypeMember_11_1_performtransformation_binding[7];
			...
			Object[] result_pattern_AnnotationTypeMember_11_1_performtransformation_black = pattern_AnnotationTypeMember_11_1_performtransformation_blackBBBBBBBBBBFBB(
					tName, tType, mTypeToType, tAnnotation, tMember, pm, mAnnotationToAnnotation, mType, mAnnotation,
			...
			if (result_pattern_AnnotationTypeMember_11_1_performtransformation_black != null) {
				...
				return new Object[] { tName, tType, mTypeToType, tAnnotation, tMember, pm, mAnnotationToAnnotation,
						mType, mAnnotation, tSignature, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}

	public static final Object[] pattern_AnnotationTypeMember_11_1_performtransformation_greenFFBFFBBB(
		...
		return new Object[] { mMember, memberToMember, tMember, anntotatableToTannotatable, access, mType, mAnnotation,
				csp };
	}
	...
	public static final void pattern_AnnotationTypeMember_11_5_registerobjects_expressionBBBBBBBBBBBBBBBB(
			...
			EObject pm, EObject anntotatableToTannotatable, EObject access, EObject mAnnotationToAnnotation,
			EObject mType, EObject mAnnotation, EObject tSignature) {
		_this.registerObjects_BWD(ruleresult, tName, mMember, memberToMember, tType, mTypeToType, tAnnotation, tMember,
				pm, anntotatableToTannotatable, access, mAnnotationToAnnotation, mType, mAnnotation, tSignature);
				...
				if (tmpTAnnotation instanceof TAnnotationType) {
					...
					if (tmpTMember instanceof TFieldDefinition) {
						...
						if (tmpPm instanceof TypeGraph) {
							...
							if (tmpTSignature instanceof TFieldSignature) {
								TFieldSignature tSignature = (TFieldSignature) tmpTSignature;
								return new Object[] { tName, tType, tAnnotation, tMember, pm, tSignature, match };
							}
						}
					}
				}
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeMember_12_2_corematch_blackBBFBBBFFFBB(TField tName,
			TAbstractType tType, TAnnotationType tAnnotation, TFieldDefinition tMember, TypeGraph pm,
						...
						for (TypeToTAbstractType mAnnotationToAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (!mAnnotationToAnnotation.equals(mTypeToType)) {
								...
								if (tmpMAnnotation instanceof AnnotationTypeDeclaration) {
									AnnotationTypeDeclaration mAnnotation = (AnnotationTypeDeclaration) tmpMAnnotation;
									if (!mAnnotation.equals(mType)) {
										_result.add(new Object[] { tName, tType, mTypeToType, tAnnotation, tMember, pm,
												mAnnotationToAnnotation, mType, mAnnotation, tSignature, match });
									}
								}
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeMember_12_3_findcontext_blackBBBBBBBBBB(TField tName,
			TAbstractType tType, TypeToTAbstractType mTypeToType, TAnnotationType tAnnotation, TFieldDefinition tMember,
			TypeGraph pm, TypeToTAbstractType mAnnotationToAnnotation, Type mType,
			AnnotationTypeDeclaration mAnnotation, TFieldSignature tSignature) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tAnnotation.equals(tType)) {
			if (!mAnnotationToAnnotation.equals(mTypeToType)) {
				if (!mAnnotation.equals(mType)) {
															...
															if (tSignature.getDefinitions().contains(tMember)) {
																...
																if (Integer.valueOf(tSignature_lowerBound)
																	...
																	_result.add(new Object[] { tName, tType,
																			mTypeToType, tAnnotation, tMember, pm,
																			mAnnotationToAnnotation, mType, mAnnotation,
																			tSignature });
																}
	...
	public static final Object[] pattern_AnnotationTypeMember_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFFFFF(
		...
		tSignature__tMember____definitions.setName(tSignature__tMember____definitions_name_prime);
		tMember__tSignature____signature.setName(tMember__tSignature____signature_name_prime);
		return new Object[] { tName, tType, mTypeToType, tAnnotation, tMember, pm, mAnnotationToAnnotation, mType,
				mAnnotation, tSignature, isApplicableMatch, tName__pm____model, pm__tName____fields,
				tAnnotation__tSignature____signature, tAnnotation__tMember____defines,
				tMember__tAnnotation____definedBy, tAnnotation__pm____model, pm__tAnnotation____allTypes,
				mTypeToType__tType____target, tName__tSignature____signatures, tSignature__tName____field,
				mAnnotationToAnnotation__tAnnotation____target, mTypeToType__mType____source,
				mAnnotationToAnnotation__mAnnotation____source, tSignature__tType____type,
	...
	public static final Object[] pattern_AnnotationTypeMember_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			AnnotationTypeMember _this, IsApplicableMatch isApplicableMatch, TField tName, TAbstractType tType,
			TypeToTAbstractType mTypeToType, TAnnotationType tAnnotation, TFieldDefinition tMember, TypeGraph pm,
			TypeToTAbstractType mAnnotationToAnnotation, Type mType, AnnotationTypeDeclaration mAnnotation,
			TFieldSignature tSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tName, tType, mTypeToType,
				tAnnotation, tMember, pm, mAnnotationToAnnotation, mType, mAnnotation, tSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tName, tType, mTypeToType, tAnnotation, tMember, pm,
					mAnnotationToAnnotation, mType, mAnnotation, tSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationTypeMember_12_4_solveCSP_binding = pattern_AnnotationTypeMember_12_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, tName, tType, mTypeToType, tAnnotation, tMember, pm, mAnnotationToAnnotation,
				mType, mAnnotation, tSignature);
		if (result_pattern_AnnotationTypeMember_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationTypeMember_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tName, tType, mTypeToType, tAnnotation, tMember,
						pm, mAnnotationToAnnotation, mType, mAnnotation, tSignature };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_20_2_testcorematchandDECs_black_nac_0BB(TField tName,
			TypeGraph pm) {
		TypeGraph __DEC_tName_fields_595402 = tName.getModel();
		if (__DEC_tName_fields_595402 != null) {
			if (!pm.equals(__DEC_tName_fields_595402)) {
	...
	public static final Object[] pattern_AnnotationTypeMember_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tMember_signature_244039 = tMember.getSignature();
		if (__DEC_tMember_signature_244039 != null) {
			if (!tSignature.equals(__DEC_tMember_signature_244039)) {
	...
	public static final Object[] pattern_AnnotationTypeMember_20_2_testcorematchandDECs_black_nac_2B(
		...
		TModule __DEC_tMember_contains_527993 = tMember.getModule();
		if (__DEC_tMember_contains_527993 != null) {
	...
	public static final Object[] pattern_AnnotationTypeMember_20_2_testcorematchandDECs_black_nac_3BB(
		...
		TField __DEC_tSignature_field_657523 = tSignature.getField();
		if (__DEC_tSignature_field_657523 != null) {
			if (!tName.equals(__DEC_tSignature_field_657523)) {
					...
					if (pattern_AnnotationTypeMember_20_2_testcorematchandDECs_black_nac_0BB(tName, pm) == null) {
						for (TFieldSignature tSignature : tName.getSignatures()) {
							...
							if (tType != null) {
								int tSignature_lowerBound = tSignature.getLowerBound();
								if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
									if (pattern_AnnotationTypeMember_20_2_testcorematchandDECs_black_nac_3BB(tSignature,
											tName) == null) {
	...
	public static final boolean pattern_AnnotationTypeMember_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBBB(
			AnnotationTypeMember _this, Match match, TField tName, TAbstractType tType, TAnnotationType tAnnotation,
			TFieldDefinition tMember, TypeGraph pm, TFieldSignature tSignature) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tName, tType, tAnnotation, tMember, pm, tSignature);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!mAnnotation.equals(mType)) {
			AbstractTypeDeclaration __DEC_mMember_abstractTypeDeclaration_576952 = mMember.getAbstractTypeDeclaration();
			if (__DEC_mMember_abstractTypeDeclaration_576952 != null) {
				if (!mType.equals(__DEC_mMember_abstractTypeDeclaration_576952)) {
					if (!mAnnotation.equals(__DEC_mMember_abstractTypeDeclaration_576952)) {
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_1B(
		...
		AnonymousClassDeclaration __DEC_mMember_anonymousClassDeclarationOwner_329128 = mMember
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMember_anonymousClassDeclarationOwner_329128 != null) {
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_2BBB(
		...
		if (!mAnnotation.equals(mType)) {
			for (AbstractTypeDeclaration __DEC_access_superInterfaces_30792 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(access, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!mType.equals(__DEC_access_superInterfaces_30792)) {
					if (!mAnnotation.equals(__DEC_access_superInterfaces_30792)) {
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess access) {
		for (Annotation __DEC_access_type_999337 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_4BB(TypeAccess access,
			Type mType) {
		for (ArrayType __DEC_access_elementType_316690 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, ArrayType.class, "elementType")) {
			if (!mType.equals(__DEC_access_elementType_316690)) {
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess access) {
		for (ClassInstanceCreation __DEC_access_type_708154 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_6BB(TypeAccess access,
			Type mType) {
		for (ClassDeclaration __DEC_access_superClass_14280 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_access_superClass_14280)) {
				return new Object[] { access, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess access) {
		for (MethodDeclaration __DEC_access_returnType_952628 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_8BB(TypeAccess access,
			Type mType) {
		for (ParameterizedType __DEC_access_type_781722 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_access_type_781722)) {
				return new Object[] { access, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_9B(
			TypeAccess access) {
		for (TypeLiteral __DEC_access_type_84171 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeMember_21_2_testcorematchandDECs_black_nac_10B(
			TypeAccess access) {
		for (AnnotationMemberValuePair __DEC_access_value_120171 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final boolean pattern_AnnotationTypeMember_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			AnnotationTypeMember _this, Match match, AnnotationTypeMemberDeclaration mMember, TypeAccess access,
			Type mType, AnnotationTypeDeclaration mAnnotation) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, mMember, access, mType, mAnnotation);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
								...
								if (tmpAccess instanceof TypeAccess) {
									...
									if (tmpMType instanceof Type) {
										...
										if (tmpMAnnotation instanceof AnnotationTypeDeclaration) {
											...
											if (tmpTSignature instanceof TFieldSignature) {
												TFieldSignature tSignature = (TFieldSignature) tmpTSignature;
												return new Object[] { tName, mMember, tType, tAnnotation, tMember, pm,
														access, mType, mAnnotation, tSignature, targetMatch,
														sourceMatch };
											}
										}
									}
	...
	public static final Object[] pattern_AnnotationTypeMember_24_2_matchsrctrgcontext_blackBBBBBBBBBBBB(TField tName,
			AnnotationTypeMemberDeclaration mMember, TAbstractType tType, TAnnotationType tAnnotation,
			TFieldDefinition tMember, TypeGraph pm, TypeAccess access, Type mType,
		...
		if (!tAnnotation.equals(tType)) {
			if (!mAnnotation.equals(mType)) {
				if (!sourceMatch.equals(targetMatch)) {
					int tSignature_lowerBound = tSignature.getLowerBound();
					if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
						return new Object[] { tName, mMember, tType, tAnnotation, tMember, pm, access, mType,
								mAnnotation, tSignature, sourceMatch, targetMatch };
					}
	...
	public static final Object[] pattern_AnnotationTypeMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_AnnotationTypeMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationTypeMember_24_2_matchsrctrgcontext_black = pattern_AnnotationTypeMember_24_2_matchsrctrgcontext_blackBBBBBBBBBBBB(
					tName, mMember, tType, tAnnotation, tMember, pm, access, mType, mAnnotation, tSignature,
					sourceMatch, targetMatch);
			if (result_pattern_AnnotationTypeMember_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { tName, mMember, tType, tAnnotation, tMember, pm, access, mType, mAnnotation,
	...
	public static final Object[] pattern_AnnotationTypeMember_24_3_solvecsp_bindingFBBBBBBBBBBBBB(
			AnnotationTypeMember _this, TField tName, AnnotationTypeMemberDeclaration mMember, TAbstractType tType,
			TAnnotationType tAnnotation, TFieldDefinition tMember, TypeGraph pm, TypeAccess access, Type mType,
			AnnotationTypeDeclaration mAnnotation, TFieldSignature tSignature, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_10 = _this.isApplicable_solveCsp_CC(tName, mMember, tType, tAnnotation, tMember, pm, access,
				mType, mAnnotation, tSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_10;
		if (csp != null) {
			return new Object[] { csp, _this, tName, mMember, tType, tAnnotation, tMember, pm, access, mType,
					mAnnotation, tSignature, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationTypeMember_24_3_solvecsp_binding = pattern_AnnotationTypeMember_24_3_solvecsp_bindingFBBBBBBBBBBBBB(
				_this, tName, mMember, tType, tAnnotation, tMember, pm, access, mType, mAnnotation, tSignature,
				sourceMatch, targetMatch);
						...
						if (mType.equals(mTypeToType.getSource())) {
							for (TypeToTAbstractType mAnnotationToAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!mAnnotationToAnnotation.equals(mTypeToType)) {
									if (mAnnotation.equals(mAnnotationToAnnotation.getSource())) {
										_result.add(
												new Object[] { tType, mTypeToType, tAnnotation, mAnnotationToAnnotation,
														mType, mAnnotation, sourceMatch, targetMatch });
									}
								}
							}
						}
	...
	public static final Object[] pattern_AnnotationTypeMember_24_6_createcorrespondence_blackBBBBBBBBBBB(TField tName,
			AnnotationTypeMemberDeclaration mMember, TAbstractType tType, TAnnotationType tAnnotation,
			TFieldDefinition tMember, TypeGraph pm, TypeAccess access, Type mType,
			AnnotationTypeDeclaration mAnnotation, TFieldSignature tSignature, CCMatch ccMatch) {
		if (!tAnnotation.equals(tType)) {
			if (!mAnnotation.equals(mType)) {
				return new Object[] { tName, mMember, tType, tAnnotation, tMember, pm, access, mType, mAnnotation,
						tSignature, ccMatch };
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_0BBB(
			AnnotationTypeMemberDeclaration mMember, Type mType, AnnotationTypeDeclaration mAnnotation) {
		if (!mAnnotation.equals(mType)) {
			AbstractTypeDeclaration __DEC_mMember_abstractTypeDeclaration_105741 = mMember.getAbstractTypeDeclaration();
			if (__DEC_mMember_abstractTypeDeclaration_105741 != null) {
				if (!mType.equals(__DEC_mMember_abstractTypeDeclaration_105741)) {
					if (!mAnnotation.equals(__DEC_mMember_abstractTypeDeclaration_105741)) {
						return new Object[] { mMember, mType, mAnnotation };
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_1B(
			AnnotationTypeMemberDeclaration mMember) {
		AnonymousClassDeclaration __DEC_mMember_anonymousClassDeclarationOwner_459364 = mMember
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMember_anonymousClassDeclarationOwner_459364 != null) {
			return new Object[] { mMember };
		}
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_2BBB(TypeAccess access,
			Type mType, AnnotationTypeDeclaration mAnnotation) {
		if (!mAnnotation.equals(mType)) {
			for (AbstractTypeDeclaration __DEC_access_superInterfaces_576211 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(access, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!mType.equals(__DEC_access_superInterfaces_576211)) {
					if (!mAnnotation.equals(__DEC_access_superInterfaces_576211)) {
						return new Object[] { access, mType, mAnnotation };
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_3B(TypeAccess access) {
		for (Annotation __DEC_access_type_977349 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, Annotation.class, "type")) {
			return new Object[] { access };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_4BB(TypeAccess access,
			Type mType) {
		for (ArrayType __DEC_access_elementType_182373 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, ArrayType.class, "elementType")) {
			if (!mType.equals(__DEC_access_elementType_182373)) {
				return new Object[] { access, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_5B(TypeAccess access) {
		for (ClassInstanceCreation __DEC_access_type_26041 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, ClassInstanceCreation.class, "type")) {
			return new Object[] { access };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_6BB(TypeAccess access,
			Type mType) {
		for (ClassDeclaration __DEC_access_superClass_79843 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_access_superClass_79843)) {
				return new Object[] { access, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_7B(TypeAccess access) {
		for (MethodDeclaration __DEC_access_returnType_437903 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, MethodDeclaration.class, "returnType")) {
			return new Object[] { access };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_8BB(TypeAccess access,
			Type mType) {
		for (ParameterizedType __DEC_access_type_597989 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_access_type_597989)) {
				return new Object[] { access, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_9B(TypeAccess access) {
		for (TypeLiteral __DEC_access_type_166220 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, TypeLiteral.class, "type")) {
			return new Object[] { access };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_10B(TypeAccess access) {
		for (AnnotationMemberValuePair __DEC_access_value_678994 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(access, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { access };
		}
		return null;
															...
															if (pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_9B(
																...
																if (pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_10B(
																	...
																	if (pattern_AnnotationTypeMember_27_1_matchtggpattern_black_nac_11BB(
																			mAnnotation, access) == null) {
																		return new Object[] { mMember, access, mType,
																				mAnnotation };
																	}
																}
															}
	...
	public static final Object[] pattern_AnnotationTypeMember_28_1_matchtggpattern_black_nac_0BB(TField tName,
			TypeGraph pm) {
		TypeGraph __DEC_tName_fields_636475 = tName.getModel();
		if (__DEC_tName_fields_636475 != null) {
			if (!pm.equals(__DEC_tName_fields_636475)) {
				return new Object[] { tName, pm };
			}
		}
	...
	public static final Object[] pattern_AnnotationTypeMember_28_1_matchtggpattern_black_nac_1BB(
			TFieldDefinition tMember, TFieldSignature tSignature) {
		TSignature __DEC_tMember_signature_342 = tMember.getSignature();
		if (__DEC_tMember_signature_342 != null) {
			if (!tSignature.equals(__DEC_tMember_signature_342)) {
				return new Object[] { tMember, tSignature };
			}
		}
	...
	public static final Object[] pattern_AnnotationTypeMember_28_1_matchtggpattern_black_nac_2B(
			TFieldDefinition tMember) {
		TModule __DEC_tMember_contains_156564 = tMember.getModule();
		if (__DEC_tMember_contains_156564 != null) {
			return new Object[] { tMember };
		}
	...
	public static final Object[] pattern_AnnotationTypeMember_28_1_matchtggpattern_black_nac_3BB(
			TFieldSignature tSignature, TField tName) {
		TField __DEC_tSignature_field_346355 = tSignature.getField();
		if (__DEC_tSignature_field_346355 != null) {
			if (!tName.equals(__DEC_tSignature_field_346355)) {
				return new Object[] { tSignature, tName };
			}
		}
											...
											if (pattern_AnnotationTypeMember_28_1_matchtggpattern_black_nac_1BB(tMember,
												...
												if (pattern_AnnotationTypeMember_28_1_matchtggpattern_black_nac_2B(
													...
													if (pattern_AnnotationTypeMember_28_1_matchtggpattern_black_nac_3BB(
														...
														return new Object[] { tName, tType, tAnnotation, tMember, pm,
																tSignature };
													}
												}
											}
	...
	public static final Object[] pattern_AnnotationTypeMember_29_3_solveCSP_bindingFBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tType, mTypeToType, tAnnotation, pm,
				mAnnotationToAnnotation, mType, mAnnotation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tType, mTypeToType, tAnnotation, pm,
					mAnnotationToAnnotation, mType, mAnnotation, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationTypeMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationTypeMember_29_3_solveCSP_binding = pattern_AnnotationTypeMember_29_3_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, tType, mTypeToType, tAnnotation, pm, mAnnotationToAnnotation, mType,
	...
	public static final Object[] pattern_AnnotationTypeMember_29_5_checknacs_blackBBBBBBB(TAbstractType tType,
		...
		if (!tAnnotation.equals(tType)) {
			if (!mAnnotationToAnnotation.equals(mTypeToType)) {
				if (!mAnnotation.equals(mType)) {
					return new Object[] { tType, mTypeToType, tAnnotation, pm, mAnnotationToAnnotation, mType,
							mAnnotation };
				}
			}
		}
	...
	public static final Object[] pattern_AnnotationTypeMember_29_6_perform_greenFFFBBFBFFBBFBB(TAbstractType tType,
			TAnnotationType tAnnotation, TypeGraph pm, Type mType, AnnotationTypeDeclaration mAnnotation,
		...
		return new Object[] { tName, mMember, memberToMember, tType, tAnnotation, tMember, pm,
				anntotatableToTannotatable, access, mType, mAnnotation, tSignature, ruleResult, csp };
	}
