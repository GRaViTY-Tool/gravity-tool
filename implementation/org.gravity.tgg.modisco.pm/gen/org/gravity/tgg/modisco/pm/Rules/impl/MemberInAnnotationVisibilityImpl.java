...
public class MemberInAnnotationVisibilityImpl extends AbstractRuleImpl implements MemberInAnnotationVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, defToMember,
						tAnnotation, Annotation, tMember, tModifier, mTypeToTType, mModifierToTModifier, mDefinition,
						mModifier);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[defToMember] = " + defToMember + ", " + "[tAnnotation] = " + tAnnotation + ", "
					+ "[Annotation] = " + Annotation + ", " + "[tMember] = " + tMember + ", " + "[tModifier] = "
					+ tModifier + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[mModifierToTModifier] = "
		...
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, tMember, tModifier, mModifierToTModifier, mDefinition, mModifier);
		...
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
				this, ruleresult, defToMember, tAnnotation, Annotation, tMember, tModifier, mTypeToTType,
				mModifierToTModifier, mDefinition, mModifier);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_2_2_corematch_blackFFBFFBBB(Annotation, mDefinition, mModifier,
						match)) {
			...
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_2_3_findcontext_blackBBBBBBB(defToMember, tAnnotation,
							Annotation, tMember, mTypeToTType, mDefinition, mModifier)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(defToMember,
								tAnnotation, Annotation, tMember, mTypeToTType, mDefinition, mModifier);
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, defToMember, tAnnotation, Annotation, tMember, mTypeToTType,
								mDefinition, mModifier);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinitionToTMember defToMember,
			TAnnotationType tAnnotation, AnnotationTypeDeclaration Annotation, TMember tMember,
			TypeToTAbstractType mTypeToTType, MDefinition mDefinition, Modifier mModifier) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject defToMember, EObject tAnnotation,
			EObject Annotation, EObject tMember, EObject tModifier, EObject mTypeToTType, EObject mModifierToTModifier,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						defToMember, tAnnotation, Annotation, tMember, tModifier, mTypeToTType, mModifierToTModifier,
						mDefinition, mModifier);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
			...
			// ForEach 
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_12_3_findcontext_blackBBBBBBB(defToMember, tAnnotation,
							Annotation, tMember, tModifier, mTypeToTType, mDefinition)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(defToMember,
								tAnnotation, Annotation, tMember, tModifier, mTypeToTType, mDefinition);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, defToMember, tAnnotation, Annotation, tMember, tModifier,
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinitionToTMember defToMember,
			TAnnotationType tAnnotation, AnnotationTypeDeclaration Annotation, TMember tMember, TModifier tModifier,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject defToMember, EObject tAnnotation,
			EObject Annotation, EObject tMember, EObject tModifier, EObject mTypeToTType, EObject mModifierToTModifier,
			EObject mDefinition, EObject mModifier) {
		ruleresult.registerObject("defToMember", defToMember);
		ruleresult.registerObject("tAnnotation", tAnnotation);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_158(EMoflonEdge _edge_tModifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAnnotation,
						Annotation, tMember, tModifier, mDefinition, mModifier, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tAnnotation] = " + tAnnotation + ", " + "[Annotation] = " + Annotation + ", " + "[tMember] = "
					+ tMember + ", " + "[tModifier] = " + tModifier + ", " + "[mDefinition] = " + mDefinition + ", "
		...
		if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_24_5_matchcorrcontext_blackFBBBFBBB(tAnnotation, Annotation,
				...
				Object[] result6_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(tAnnotation,
								Annotation, tMember, tModifier, mDefinition, mModifier, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAnnotation] = "
							+ tAnnotation + ", " + "[Annotation] = " + Annotation + ", " + "[tMember] = " + tMember
	...
	public CSP isApplicable_solveCsp_CC(TAnnotationType tAnnotation, AnnotationTypeDeclaration Annotation,
			TMember tMember, TModifier tModifier, MDefinition mDefinition, Modifier mModifier, Match sourceMatch,
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, defToMember, tAnnotation, Annotation, tMember, mTypeToTType, mDefinition,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[defToMember] = " + defToMember + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TANNOTATIONTYPE_ANNOTATIONTYPEDECLARATION_TMEMBER_TYPETOTABSTRACTTYPE_MDEFINITION_MODIFIER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (TAnnotationType) arguments.get(2),
					(AnnotationTypeDeclaration) arguments.get(3), (TMember) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TANNOTATIONTYPE_ANNOTATIONTYPEDECLARATION_TMEMBER_TMODIFIER_TYPETOTABSTRACTTYPE_MDEFINITION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (TAnnotationType) arguments.get(2),
					(AnnotationTypeDeclaration) arguments.get(3), (TMember) arguments.get(4),
					(TModifier) arguments.get(5), (TypeToTAbstractType) arguments.get(6),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_158__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_158((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_174__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__TANNOTATIONTYPE_ANNOTATIONTYPEDECLARATION_TMEMBER_TMODIFIER_MDEFINITION_MODIFIER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TAnnotationType) arguments.get(0),
					...
					(TModifier) arguments.get(3), (MDefinition) arguments.get(4), (Modifier) arguments.get(5),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TANNOTATIONTYPE_ANNOTATIONTYPEDECLARATION_TMEMBER_TYPETOTABSTRACTTYPE_MDEFINITION_MODELGENERATORRULERESULT:
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpMModifier instanceof Modifier) {
									...
									return new Object[] { defToMember, tAnnotation, annotation, tMember, mTypeToTType,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { defToMember, tAnnotation, annotation, tMember, mTypeToTType, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_black = pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					defToMember, tAnnotation, annotation, tMember, mTypeToTType, mDefinition, mModifier, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject defToMember, EObject tAnnotation, EObject annotation, EObject tMember,
			EObject tModifier, EObject mTypeToTType, EObject mModifierToTModifier, EObject mDefinition,
			EObject mModifier) {
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, tMember, tModifier, mModifierToTModifier, mDefinition, mModifier,
	...
	public static final void pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInAnnotationVisibility _this, PerformRuleResult ruleresult, EObject defToMember, EObject tAnnotation,
			EObject annotation, EObject tMember, EObject tModifier, EObject mTypeToTType, EObject mModifierToTModifier,
			EObject mDefinition, EObject mModifier) {
		_this.registerObjects_FWD(ruleresult, defToMember, tAnnotation, annotation, tMember, tModifier, mTypeToTType,
				mModifierToTModifier, mDefinition, mModifier);
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTAnnotation instanceof TAnnotationType) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { defToMember, tAnnotation, annotation, tMember, mTypeToTType,
						...
						if (mModifier.equals(mDefinition.getModifier())) {
							if (tAnnotation.equals(mTypeToTType.getTarget())) {
								if (mDefinition.equals(defToMember.getSource())) {
									_result.add(new Object[] { defToMember, tAnnotation, annotation, tMember,
											mTypeToTType, mDefinition, mModifier });
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { defToMember, tAnnotation, annotation, tMember, mTypeToTType, mDefinition, mModifier,
				...
				mDefinition__mModifier____modifier, mModifier__mDefinition____bodyDeclaration,
				mTypeToTType__tAnnotation____target, defToMember__mDefinition____source };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, defToMember, tAnnotation, annotation,
				tMember, mTypeToTType, mDefinition, mModifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, defToMember, tAnnotation, annotation, tMember,
					mTypeToTType, mDefinition, mModifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_2_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, defToMember, tAnnotation, annotation, tMember, mTypeToTType, mDefinition,
				mModifier);
					...
					if (tmpTMember instanceof TMember) {
						...
						if (tmpTModifier instanceof TModifier) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									MDefinition mDefinition = (MDefinition) tmpMDefinition;
									return new Object[] { defToMember, tAnnotation, annotation, tMember, tModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			MDefinitionToTMember defToMember, TAnnotationType tAnnotation, AnnotationTypeDeclaration annotation,
			TMember tMember, TModifier tModifier, TypeToTAbstractType mTypeToTType, MDefinition mDefinition,
			MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { defToMember, tAnnotation, annotation, tMember, tModifier, mTypeToTType,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_black = pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					defToMember, tAnnotation, annotation, tMember, tModifier, mTypeToTType, mDefinition, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotation, EObject tMember, EObject tModifier, EObject mTypeToTType, EObject mModifierToTModifier,
			EObject mDefinition, EObject mModifier) {
		_this.registerObjects_BWD(ruleresult, defToMember, tAnnotation, annotation, tMember, tModifier, mTypeToTType,
				mModifierToTModifier, mDefinition, mModifier);
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMDefinition instanceof MDefinition) {
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
						AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
						_result.add(new Object[] { defToMember, tAnnotation, annotation, tMember, tModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mTypeToTType__tAnnotation____target.setName(mTypeToTType__tAnnotation____target_name_prime);
		defToMember__mDefinition____source.setName(defToMember__mDefinition____source_name_prime);
		return new Object[] { defToMember, tAnnotation, annotation, tMember, tModifier, mTypeToTType, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, defToMember, tAnnotation, annotation,
				tMember, tModifier, mTypeToTType, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, defToMember, tAnnotation, annotation, tMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_12_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, defToMember, tAnnotation, annotation, tMember, tModifier, mTypeToTType,
				mDefinition);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_108846 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_108846)) {
				...
				if (tmpTMember instanceof TMember) {
					...
					if (tmpTModifier instanceof TModifier) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpMModifier instanceof Modifier) {
								Modifier mModifier = (Modifier) tmpMModifier;
								return new Object[] { tAnnotation, annotation, tMember, tModifier, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tAnnotation, annotation, tMember, tModifier, mDefinition, mModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAnnotation, annotation, tMember, tModifier, mDefinition, mModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			...
			TMember tMember, TModifier tModifier, MDefinition mDefinition, Modifier mModifier, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tAnnotation, annotation, tMember, tModifier, mDefinition,
				mModifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tAnnotation, annotation, tMember, tModifier, mDefinition, mModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_24_3_solvecsp_binding = pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAnnotation, annotation, tMember, tModifier, mDefinition, mModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tAnnotation, annotation, tMember, tModifier, mDefinition, mModifier, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_28_1_matchtggpattern_black_nac_0BB(
			TModifier tModifier, TAnnotationType tAnnotation) {
		for (TAbstractType __DEC_tModifier_tModifier_866215 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_866215)) {
				return new Object[] { tModifier, tAnnotation };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, defToMember, tAnnotation, annotation,
				tMember, mTypeToTType, mDefinition, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, defToMember, tAnnotation, annotation, tMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(
		...
		return new Object[] { defToMember, tAnnotation, annotation, tMember, mTypeToTType, mDefinition, ruleResult };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_greenBFFBFBB(TMember tMember,
		...
		return new Object[] { tMember, tModifier, mModifierToTModifier, mDefinition, mModifier, ruleResult, csp };
	}
