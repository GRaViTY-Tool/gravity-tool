...
public class MemberInAnnotationVisibilityImpl extends AbstractRuleImpl implements MemberInAnnotationVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, Annotation,
						mDefinition, tAnnotation, tMember, mModifierToTModifier, defToMember, mModifier, tModifier,
						mTypeToTType);
		...
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
				this, ruleresult, Annotation, mDefinition, tAnnotation, tMember, mModifierToTModifier, defToMember,
				mModifier, tModifier, mTypeToTType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_2_2_corematch_blackBBFFFBFB(Annotation, mDefinition, mModifier,
						match)) {
			...
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_2_3_findcontext_blackBBBBBBB(Annotation, mDefinition,
							tAnnotation, tMember, defToMember, mModifier, mTypeToTType)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(Annotation,
								mDefinition, tAnnotation, tMember, defToMember, mModifier, mTypeToTType);
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, Annotation, mDefinition, tAnnotation, tMember, defToMember,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AnnotationTypeDeclaration Annotation,
			MDefinition mDefinition, TAnnotationType tAnnotation, TMember tMember, MDefinitionToTMember defToMember,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject Annotation, EObject mDefinition,
			EObject tAnnotation, EObject tMember, EObject mModifierToTModifier, EObject defToMember, EObject mModifier,
			EObject tModifier, EObject mTypeToTType) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						Annotation, mDefinition, tAnnotation, tMember, mModifierToTModifier, defToMember, mModifier,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_12_2_corematch_blackFFBBFBFB(tAnnotation, tMember, tModifier,
						match)) {
			...
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_12_3_findcontext_blackBBBBBBB(Annotation, mDefinition,
							tAnnotation, tMember, defToMember, tModifier, mTypeToTType)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(Annotation,
								mDefinition, tAnnotation, tMember, defToMember, tModifier, mTypeToTType);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tAnnotation__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tAnnotation____definedBy = (EMoflonEdge) result3_green[9];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, AnnotationTypeDeclaration Annotation,
			MDefinition mDefinition, TAnnotationType tAnnotation, TMember tMember, MDefinitionToTMember defToMember,
			TModifier tModifier, TypeToTAbstractType mTypeToTType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, Annotation,
						mDefinition, tAnnotation, tMember, mModifier, tModifier, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[Annotation] = " + Annotation + ", " + "[mDefinition] = " + mDefinition + ", "
					+ "[tAnnotation] = " + tAnnotation + ", " + "[tMember] = " + tMember + ", " + "[mModifier] = "
					+ mModifier + ", " + "[tModifier] = " + tModifier + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
	...
	public CSP isApplicable_solveCsp_CC(AnnotationTypeDeclaration Annotation, MDefinition mDefinition,
			TAnnotationType tAnnotation, TMember tMember, Modifier mModifier, TModifier tModifier, Match sourceMatch,
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, Annotation, mDefinition, tAnnotation, tMember, defToMember, mTypeToTType,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[Annotation] = " + Annotation + ", "
			...
			if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_29_4_checkCSP_expressionFBB(this,
				...
				Object[] result5_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_29_5_checknacs_blackBBBBBB(Annotation, mDefinition,
								tAnnotation, tMember, defToMember, mTypeToTType);
				if (result5_black != null) {

					Object[] result6_black = MemberInAnnotationVisibilityImpl
							.pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(Annotation, mDefinition,
									tAnnotation, tMember, defToMember, mTypeToTType, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[Annotation] = "
								+ Annotation + ", " + "[mDefinition] = " + mDefinition + ", " + "[tAnnotation] = "
								+ tAnnotation + ", " + "[tMember] = " + tMember + ", " + "[defToMember] = "
								+ defToMember + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONTYPEDECLARATION_MDEFINITION_TANNOTATIONTYPE_TMEMBER_MDEFINITIONTOTMEMBER_MODIFIER_TYPETOTABSTRACTTYPE:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(AnnotationTypeDeclaration) arguments.get(1), (MDefinition) arguments.get(2),
						(TAnnotationType) arguments.get(3), (TMember) arguments.get(4),
						(MDefinitionToTMember) arguments.get(5), (Modifier) arguments.get(6),
			...
			case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTYPEDECLARATION_MDEFINITION_TANNOTATIONTYPE_TMEMBER_MDEFINITIONTOTMEMBER_TMODIFIER_TYPETOTABSTRACTTYPE:
			...
			case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_97__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_97((EMoflonEdge) arguments.get(0));
			case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_103__EMOFLONEDGE:
			...
			case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__ANNOTATIONTYPEDECLARATION_MDEFINITION_TANNOTATIONTYPE_TMEMBER_MODIFIER_TMODIFIER_MATCH_MATCH:
				return isApplicable_solveCsp_CC((AnnotationTypeDeclaration) arguments.get(0),
						...
						(Modifier) arguments.get(4), (TModifier) arguments.get(5), (Match) arguments.get(6),
			...
			case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTYPEDECLARATION_MDEFINITION_TANNOTATIONTYPE_TMEMBER_MDEFINITIONTOTMEMBER_TYPETOTABSTRACTTYPE_MODELGENERATORRULERESULT:
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMModifier instanceof Modifier) {
								...
								if (tmpMTypeToTType instanceof TypeToTAbstractType) {
									...
									return new Object[] { annotation, mDefinition, tAnnotation, tMember, defToMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			...
			MDefinitionToTMember defToMember, Modifier mModifier, TypeToTAbstractType mTypeToTType,
			MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotation, mDefinition, tAnnotation, tMember, defToMember, mModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_black = pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					annotation, mDefinition, tAnnotation, tMember, defToMember, mModifier, mTypeToTType, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject annotation, EObject mDefinition, EObject tAnnotation, EObject tMember,
			EObject mModifierToTModifier, EObject defToMember, EObject mModifier, EObject tModifier,
	...
	public static final void pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tAnnotation, EObject tMember, EObject mModifierToTModifier, EObject defToMember, EObject mModifier,
			EObject tModifier, EObject mTypeToTType) {
		_this.registerObjects_FWD(ruleresult, annotation, mDefinition, tAnnotation, tMember, mModifierToTModifier,
				defToMember, mModifier, tModifier, mTypeToTType);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_2_2_corematch_blackBBFFFBFB(
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTAnnotation instanceof TAnnotationType) {
						TAnnotationType tAnnotation = (TAnnotationType) tmpTAnnotation;
						_result.add(new Object[] { annotation, mDefinition, tAnnotation, tMember, defToMember,
						...
						if (mModifier.equals(mDefinition.getModifier())) {
							if (annotation.equals(mTypeToTType.getSource())) {
								if (tAnnotation.equals(mTypeToTType.getTarget())) {
									_result.add(new Object[] { annotation, mDefinition, tAnnotation, tMember,
											defToMember, mModifier, mTypeToTType });
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { annotation, mDefinition, tAnnotation, tMember, defToMember, mModifier, mTypeToTType,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, annotation, mDefinition, tAnnotation,
				tMember, defToMember, mModifier, mTypeToTType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotation, mDefinition, tAnnotation, tMember,
					defToMember, mModifier, mTypeToTType };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_2_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotation, mDefinition, tAnnotation, tMember, defToMember, mModifier,
				mTypeToTType);
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpTModifier instanceof TModifier) {
								...
								if (tmpMTypeToTType instanceof TypeToTAbstractType) {
									TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) tmpMTypeToTType;
									return new Object[] { annotation, mDefinition, tAnnotation, tMember, defToMember,
											tModifier, mTypeToTType, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotation, mDefinition, tAnnotation, tMember, defToMember, tModifier,
						mTypeToTType, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_black = pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					annotation, mDefinition, tAnnotation, tMember, defToMember, tModifier, mTypeToTType, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tAnnotation, EObject tMember, EObject mModifierToTModifier, EObject defToMember, EObject mModifier,
			EObject tModifier, EObject mTypeToTType) {
		_this.registerObjects_BWD(ruleresult, annotation, mDefinition, tAnnotation, tMember, mModifierToTModifier,
				defToMember, mModifier, tModifier, mTypeToTType);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_12_2_corematch_blackFFBBFBFB(
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mTypeToTType__Annotation____source.setName(mTypeToTType__Annotation____source_name_prime);
		mTypeToTType__tAnnotation____target.setName(mTypeToTType__tAnnotation____target_name_prime);
		return new Object[] { annotation, mDefinition, tAnnotation, tMember, defToMember, tModifier, mTypeToTType,
				isApplicableMatch, tAnnotation__tMember____defines, tMember__tAnnotation____definedBy,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, annotation, mDefinition, tAnnotation,
				tMember, defToMember, tModifier, mTypeToTType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotation, mDefinition, tAnnotation, tMember,
					defToMember, tModifier, mTypeToTType };
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_12_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotation, mDefinition, tAnnotation, tMember, defToMember, tModifier,
				mTypeToTType);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_344631 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_344631)) {
				...
				if (tmpTAnnotation instanceof TAnnotationType) {
					...
					if (tmpTMember instanceof TMember) {
						...
						if (tmpMModifier instanceof Modifier) {
							...
							if (tmpTModifier instanceof TModifier) {
								TModifier tModifier = (TModifier) tmpTModifier;
								return new Object[] { annotation, mDefinition, tAnnotation, tMember, mModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			AnnotationTypeDeclaration annotation, MDefinition mDefinition, TAnnotationType tAnnotation, TMember tMember,
			Modifier mModifier, TModifier tModifier, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { annotation, mDefinition, tAnnotation, tMember, mModifier, tModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					annotation, mDefinition, tAnnotation, tMember, mModifier, tModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			...
			TAnnotationType tAnnotation, TMember tMember, Modifier mModifier, TModifier tModifier, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(annotation, mDefinition, tAnnotation, tMember, mModifier,
				tModifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, annotation, mDefinition, tAnnotation, tMember, mModifier, tModifier,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_24_3_solvecsp_binding = pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, annotation, mDefinition, tAnnotation, tMember, mModifier, tModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { annotation, mDefinition, tAnnotation, tMember, mModifier, tModifier, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_28_1_matchtggpattern_black_nac_0BB(
			TModifier tModifier, TAnnotationType tAnnotation) {
		for (TAbstractType __DEC_tModifier_tModifier_518649 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_518649)) {
				return new Object[] { tModifier, tAnnotation };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, annotation, mDefinition, tAnnotation,
				tMember, defToMember, mTypeToTType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotation, mDefinition, tAnnotation, tMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_29_3_solveCSP_binding = pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotation, mDefinition, tAnnotation, tMember, defToMember, mTypeToTType,
				ruleResult);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_5_checknacs_blackBBBBBB(
		...
		return new Object[] { annotation, mDefinition, tAnnotation, tMember, defToMember, mTypeToTType };
	}

	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(
			AnnotationTypeDeclaration annotation, MDefinition mDefinition, TAnnotationType tAnnotation, TMember tMember,
			MDefinitionToTMember defToMember, TypeToTAbstractType mTypeToTType, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { annotation, mDefinition, tAnnotation, tMember, defToMember, mTypeToTType, ruleResult };
	}
