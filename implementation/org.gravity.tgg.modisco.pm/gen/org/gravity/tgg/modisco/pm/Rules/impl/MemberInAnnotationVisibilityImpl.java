...
public class MemberInAnnotationVisibilityImpl extends AbstractRuleImpl implements MemberInAnnotationVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, Annotation,
						mDefinition, tAnnotation, mTypeToTType, tMember, tModifier, mModifierToTModifier, defToMember,
						mModifier);
		...
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
				this, ruleresult, Annotation, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier,
				mModifierToTModifier, defToMember, mModifier);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_2_2_corematch_blackBBFFFFBB(Annotation, mDefinition, mModifier,
						match)) {
			...
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_2_3_findcontext_blackBBBBBBB(Annotation, mDefinition,
							tAnnotation, mTypeToTType, tMember, defToMember, mModifier)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(Annotation,
								mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, mModifier);
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, Annotation, mDefinition, tAnnotation, mTypeToTType, tMember,
								defToMember, mModifier);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AnnotationTypeDeclaration Annotation,
			...
			MDefinitionToTMember defToMember, Modifier mModifier) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject Annotation, EObject mDefinition,
			EObject tAnnotation, EObject mTypeToTType, EObject tMember, EObject tModifier, EObject mModifierToTModifier,
			EObject defToMember, EObject mModifier) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						Annotation, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier, mModifierToTModifier,
						defToMember, mModifier);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_12_2_corematch_blackFFBFBBFB(tAnnotation, tMember, tModifier,
						match)) {
			...
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_12_3_findcontext_blackBBBBBBB(Annotation, mDefinition,
							tAnnotation, mTypeToTType, tMember, tModifier, defToMember)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(Annotation,
								mDefinition, tAnnotation, mTypeToTType, tMember, tModifier, defToMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mTypeToTType__Annotation____source = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tAnnotation__tMember____defines = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge tMember__tAnnotation____definedBy = (EMoflonEdge) result3_green[10];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_85(EMoflonEdge _edge_tModifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, Annotation,
						mDefinition, tAnnotation, tMember, tModifier, mModifier, sourceMatch, targetMatch);
		...
		if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_24_5_matchcorrcontext_blackBBBFBFBB(Annotation, mDefinition,
				...
				Object[] result6_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(Annotation,
								mDefinition, tAnnotation, tMember, tModifier, mModifier, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[Annotation] = "
							+ Annotation + ", " + "[mDefinition] = " + mDefinition + ", " + "[tAnnotation] = "
	...
	public CSP isApplicable_solveCsp_CC(AnnotationTypeDeclaration Annotation, MDefinition mDefinition,
			TAnnotationType tAnnotation, TMember tMember, TModifier tModifier, Modifier mModifier, Match sourceMatch,
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, Annotation, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[Annotation] = " + Annotation + ", "
			...
			if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_29_4_checkCSP_expressionFBB(this,
				...
				Object[] result5_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_29_5_checknacs_blackBBBBBB(Annotation, mDefinition,
								tAnnotation, mTypeToTType, tMember, defToMember);
				if (result5_black != null) {

					Object[] result6_black = MemberInAnnotationVisibilityImpl
							.pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(Annotation, mDefinition,
									tAnnotation, mTypeToTType, tMember, defToMember, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[Annotation] = "
								+ Annotation + ", " + "[mDefinition] = " + mDefinition + ", " + "[tAnnotation] = "
								+ tAnnotation + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tMember] = "
								+ tMember + ", " + "[defToMember] = " + defToMember + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONTYPEDECLARATION_MDEFINITION_TANNOTATIONTYPE_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER_MODIFIER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					...
					(TMember) arguments.get(5), (MDefinitionToTMember) arguments.get(6), (Modifier) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTYPEDECLARATION_MDEFINITION_TANNOTATIONTYPE_TYPETOTABSTRACTTYPE_TMEMBER_TMODIFIER_MDEFINITIONTOTMEMBER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(AnnotationTypeDeclaration) arguments.get(1), (MDefinition) arguments.get(2),
					(TAnnotationType) arguments.get(3), (TypeToTAbstractType) arguments.get(4),
					(TMember) arguments.get(5), (TModifier) arguments.get(6), (MDefinitionToTMember) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_85__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__ANNOTATIONTYPEDECLARATION_MDEFINITION_TANNOTATIONTYPE_TMEMBER_TMODIFIER_MODIFIER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((AnnotationTypeDeclaration) arguments.get(0),
					(MDefinition) arguments.get(1), (TAnnotationType) arguments.get(2), (TMember) arguments.get(3),
					(TModifier) arguments.get(4), (Modifier) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTYPEDECLARATION_MDEFINITION_TANNOTATIONTYPE_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpMModifier instanceof Modifier) {
									...
									return new Object[] { annotation, mDefinition, tAnnotation, mTypeToTType, tMember,
											defToMember, mModifier, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			...
			TypeToTAbstractType mTypeToTType, TMember tMember, MDefinitionToTMember defToMember, Modifier mModifier,
			MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotation, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_black = pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					annotation, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, mModifier, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject annotation, EObject mDefinition, EObject tAnnotation,
			EObject mTypeToTType, EObject tMember, EObject tModifier, EObject mModifierToTModifier, EObject defToMember,
			EObject mModifier) {
	...
	public static final void pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tAnnotation, EObject mTypeToTType, EObject tMember, EObject tModifier, EObject mModifierToTModifier,
			EObject defToMember, EObject mModifier) {
		_this.registerObjects_FWD(ruleresult, annotation, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier,
				mModifierToTModifier, defToMember, mModifier);
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTAnnotation instanceof TAnnotationType) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { annotation, mDefinition, tAnnotation, mTypeToTType, tMember,
								defToMember, mModifier, match });
					}
						...
						if (tAnnotation.equals(mTypeToTType.getTarget())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (annotation.getBodyDeclarations().contains(mDefinition)) {
									_result.add(new Object[] { annotation, mDefinition, tAnnotation, mTypeToTType,
											tMember, defToMember, mModifier });
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		mDefinition__Annotation____abstractTypeDeclaration
				.setName(mDefinition__Annotation____abstractTypeDeclaration_name_prime);
		return new Object[] { annotation, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, mModifier,
				isApplicableMatch, mTypeToTType__Annotation____source, tAnnotation__tMember____defines,
				tMember__tAnnotation____definedBy, mDefinition__mModifier____modifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			AnnotationTypeDeclaration annotation, MDefinition mDefinition, TAnnotationType tAnnotation,
			TypeToTAbstractType mTypeToTType, TMember tMember, MDefinitionToTMember defToMember, Modifier mModifier) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, annotation, mDefinition, tAnnotation,
				mTypeToTType, tMember, defToMember, mModifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotation, mDefinition, tAnnotation, mTypeToTType,
					tMember, defToMember, mModifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_2_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotation, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember,
				mModifier);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			AnnotationTypeDeclaration annotation, MDefinition mDefinition, TAnnotationType tAnnotation,
			TypeToTAbstractType mTypeToTType, TMember tMember, TModifier tModifier, MDefinitionToTMember defToMember,
			MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotation, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_black = pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					annotation, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier, defToMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tAnnotation, EObject mTypeToTType, EObject tMember, EObject tModifier, EObject mModifierToTModifier,
			EObject defToMember, EObject mModifier) {
		_this.registerObjects_BWD(ruleresult, annotation, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier,
				mModifierToTModifier, defToMember, mModifier);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_12_2_corematch_blackFFBFBBFB(
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mDefinition__Annotation____abstractTypeDeclaration
				.setName(mDefinition__Annotation____abstractTypeDeclaration_name_prime);
		return new Object[] { annotation, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier, defToMember,
				isApplicableMatch, mTypeToTType__Annotation____source, tAnnotation__tMember____defines,
				tMember__tAnnotation____definedBy, tMember__tModifier____tModifier, defToMember__mDefinition____source,
				mTypeToTType__tAnnotation____target, defToMember__tMember____target,
				annotation__mDefinition____bodyDeclarations, mDefinition__Annotation____abstractTypeDeclaration };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			AnnotationTypeDeclaration annotation, MDefinition mDefinition, TAnnotationType tAnnotation,
			TypeToTAbstractType mTypeToTType, TMember tMember, TModifier tModifier, MDefinitionToTMember defToMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, annotation, mDefinition, tAnnotation,
				mTypeToTType, tMember, tModifier, defToMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotation, mDefinition, tAnnotation, mTypeToTType,
					tMember, tModifier, defToMember };
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_12_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotation, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier,
				defToMember);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_35254 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_35254)) {
				...
				if (tmpTAnnotation instanceof TAnnotationType) {
					...
					if (tmpTMember instanceof TMember) {
						...
						if (tmpTModifier instanceof TModifier) {
							...
							if (tmpMModifier instanceof Modifier) {
								Modifier mModifier = (Modifier) tmpMModifier;
								return new Object[] { annotation, mDefinition, tAnnotation, tMember, tModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { annotation, mDefinition, tAnnotation, tMember, tModifier, mModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					annotation, mDefinition, tAnnotation, tMember, tModifier, mModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			...
			TAnnotationType tAnnotation, TMember tMember, TModifier tModifier, Modifier mModifier, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(annotation, mDefinition, tAnnotation, tMember, tModifier,
				mModifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, annotation, mDefinition, tAnnotation, tMember, tModifier, mModifier,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_24_3_solvecsp_binding = pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, annotation, mDefinition, tAnnotation, tMember, tModifier, mModifier, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_24_5_matchcorrcontext_blackBBBFBFBB(
			AnnotationTypeDeclaration annotation, MDefinition mDefinition, TAnnotationType tAnnotation, TMember tMember,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { annotation, mDefinition, tAnnotation, tMember, tModifier, mModifier, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_28_1_matchtggpattern_black_nac_0BB(
			TModifier tModifier, TAnnotationType tAnnotation) {
		for (TAbstractType __DEC_tModifier_tModifier_826910 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_826910)) {
				return new Object[] { tModifier, tAnnotation };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, annotation, mDefinition, tAnnotation,
				mTypeToTType, tMember, defToMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotation, mDefinition, tAnnotation, mTypeToTType,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(
			...
			TypeToTAbstractType mTypeToTType, TMember tMember, MDefinitionToTMember defToMember,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { annotation, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, ruleResult };
	}
