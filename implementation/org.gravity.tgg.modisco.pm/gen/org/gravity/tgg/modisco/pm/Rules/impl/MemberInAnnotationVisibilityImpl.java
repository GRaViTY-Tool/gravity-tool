...
public class MemberInAnnotationVisibilityImpl extends AbstractRuleImpl implements MemberInAnnotationVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						mModifierToTModifier, tMember, tAnnotation, mModifier, tModifier, mTypeToTType, defToMember,
						mDefinition, Annotation);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModifierToTModifier] = " + mModifierToTModifier + ", " + "[tMember] = " + tMember + ", "
					+ "[tAnnotation] = " + tAnnotation + ", " + "[mModifier] = " + mModifier + ", " + "[tModifier] = "
					+ tModifier + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[defToMember] = " + defToMember
		...
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
				this, ruleresult, mModifierToTModifier, tMember, tAnnotation, mModifier, tModifier, mTypeToTType,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_2_2_corematch_blackFFBFFBBB(mModifier, mDefinition, Annotation,
						match)) {
			...
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_2_3_findcontext_blackBBBBBBB(tMember, tAnnotation, mModifier,
							mTypeToTType, defToMember, mDefinition, Annotation)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(tMember,
								tAnnotation, mModifier, mTypeToTType, defToMember, mDefinition, Annotation);
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, tMember, tAnnotation, mModifier, mTypeToTType, defToMember,
								mDefinition, Annotation);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMember tMember,
			...
			MDefinitionToTMember defToMember, MDefinition mDefinition, AnnotationTypeDeclaration Annotation) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifierToTModifier, EObject tMember,
			EObject tAnnotation, EObject mModifier, EObject tModifier, EObject mTypeToTType, EObject defToMember,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_12_2_corematch_blackBBBFFFFB(tMember, tAnnotation, tModifier,
						match)) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[3];
			MDefinitionToTMember defToMember = (MDefinitionToTMember) result2_black[4];
			...
			// ForEach 
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_12_3_findcontext_blackBBBBBBB(tMember, tAnnotation, tModifier,
							mTypeToTType, defToMember, mDefinition, Annotation)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tMember,
								tAnnotation, tModifier, mTypeToTType, defToMember, mDefinition, Annotation);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tAnnotation__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tAnnotation____definedBy = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mTypeToTType__tAnnotation____target = (EMoflonEdge) result3_green[10];
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, tMember, tAnnotation, tModifier, mTypeToTType, defToMember,
								mDefinition, Annotation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMember] = " + tMember + ", "
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tMember,
						tAnnotation, mModifier, tModifier, mDefinition, Annotation, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tMember] = " + tMember + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[mModifier] = "
		...
		if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_24_5_matchcorrcontext_blackBBFFBBBB(tMember, tAnnotation,
				...
				Object[] result6_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(tMember,
								tAnnotation, mModifier, tModifier, mDefinition, Annotation, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMember tMember, TAnnotationType tAnnotation, Modifier mModifier,
			TModifier tModifier, MDefinition mDefinition, AnnotationTypeDeclaration Annotation, Match sourceMatch,
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, tMember, tAnnotation, mTypeToTType, defToMember, mDefinition, Annotation,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMember] = " + tMember + ", "
			...
			if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_29_5_checknacs_blackBBBBBB(tMember, tAnnotation,
								mTypeToTType, defToMember, mDefinition, Annotation);
				if (result5_black != null) {

					Object[] result6_black = MemberInAnnotationVisibilityImpl
							.pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(tMember, tAnnotation,
									mTypeToTType, defToMember, mDefinition, Annotation, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMember] = "
								+ tMember + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[mTypeToTType] = "
								+ mTypeToTType + ", " + "[defToMember] = " + defToMember + ", " + "[mDefinition] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMEMBER_TANNOTATIONTYPE_MODIFIER_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_MDEFINITION_ANNOTATIONTYPEDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TMember) arguments.get(1),
					(TAnnotationType) arguments.get(2), (Modifier) arguments.get(3),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_TANNOTATIONTYPE_TMODIFIER_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_MDEFINITION_ANNOTATIONTYPEDECLARATION:
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_18__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__TMEMBER_TANNOTATIONTYPE_MODIFIER_TMODIFIER_MDEFINITION_ANNOTATIONTYPEDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TMember) arguments.get(0), (TAnnotationType) arguments.get(1),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_TANNOTATIONTYPE_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_MDEFINITION_ANNOTATIONTYPEDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
									...
									return new Object[] { tMember, tAnnotation, mModifier, mTypeToTType, defToMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			TMember tMember, TAnnotationType tAnnotation, Modifier mModifier, TypeToTAbstractType mTypeToTType,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMember, tAnnotation, mModifier, mTypeToTType, defToMember, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_black = pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					tMember, tAnnotation, mModifier, mTypeToTType, defToMember, mDefinition, annotation, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifierToTModifier, EObject tMember, EObject tAnnotation,
			EObject mModifier, EObject tModifier, EObject mTypeToTType, EObject defToMember, EObject mDefinition,
			EObject annotation) {
	...
	public static final void pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tMember, EObject tAnnotation, EObject mModifier, EObject tModifier, EObject mTypeToTType,
			EObject defToMember, EObject mDefinition, EObject annotation) {
		_this.registerObjects_FWD(ruleresult, mModifierToTModifier, tMember, tAnnotation, mModifier, tModifier,
				mTypeToTType, defToMember, mDefinition, annotation);
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTAnnotation instanceof TAnnotationType) {
						TAnnotationType tAnnotation = (TAnnotationType) tmpTAnnotation;
						_result.add(new Object[] { tMember, tAnnotation, mModifier, mTypeToTType, defToMember,
						...
						if (mDefinition.equals(defToMember.getSource())) {
							if (annotation.equals(mTypeToTType.getSource())) {
								if (annotation.getBodyDeclarations().contains(mDefinition)) {
									_result.add(new Object[] { tMember, tAnnotation, mModifier, mTypeToTType,
											defToMember, mDefinition, annotation });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		mDefinition__Annotation____abstractTypeDeclaration
				.setName(mDefinition__Annotation____abstractTypeDeclaration_name_prime);
		return new Object[] { tMember, tAnnotation, mModifier, mTypeToTType, defToMember, mDefinition, annotation,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			TAnnotationType tAnnotation, Modifier mModifier, TypeToTAbstractType mTypeToTType,
			MDefinitionToTMember defToMember, MDefinition mDefinition, AnnotationTypeDeclaration annotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tMember, tAnnotation, mModifier,
				mTypeToTType, defToMember, mDefinition, annotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, tAnnotation, mModifier, mTypeToTType,
					defToMember, mDefinition, annotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_2_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, tAnnotation, mModifier, mTypeToTType, defToMember, mDefinition,
				annotation);
					...
					if (tmpMTypeToTType instanceof TypeToTAbstractType) {
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
									AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
									return new Object[] { tMember, tAnnotation, tModifier, mTypeToTType, defToMember,
											mDefinition, annotation, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TMember tMember, TAnnotationType tAnnotation, TModifier tModifier, TypeToTAbstractType mTypeToTType,
			MDefinitionToTMember defToMember, MDefinition mDefinition, AnnotationTypeDeclaration annotation,
			MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMember, tAnnotation, tModifier, mTypeToTType, defToMember, mDefinition,
						annotation, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_black = pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					tMember, tAnnotation, tModifier, mTypeToTType, defToMember, mDefinition, annotation, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tMember, EObject tAnnotation, EObject mModifier, EObject tModifier, EObject mTypeToTType,
			EObject defToMember, EObject mDefinition, EObject annotation) {
		_this.registerObjects_BWD(ruleresult, mModifierToTModifier, tMember, tAnnotation, mModifier, tModifier,
				mTypeToTType, defToMember, mDefinition, annotation);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_12_2_corematch_blackBBBFFFFB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tMember, tAnnotation, tModifier, mTypeToTType, defToMember,
								mDefinition, annotation, match });
					}
				...
				if (tModifier.equals(tMember.getTModifier())) {
					if (tMember.equals(defToMember.getTarget())) {
						if (mDefinition.equals(defToMember.getSource())) {
							if (annotation.equals(mTypeToTType.getSource())) {
								if (annotation.getBodyDeclarations().contains(mDefinition)) {
									_result.add(new Object[] { tMember, tAnnotation, tModifier, mTypeToTType,
											defToMember, mDefinition, annotation });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mDefinition__Annotation____abstractTypeDeclaration
				.setName(mDefinition__Annotation____abstractTypeDeclaration_name_prime);
		return new Object[] { tMember, tAnnotation, tModifier, mTypeToTType, defToMember, mDefinition, annotation,
				isApplicableMatch, tAnnotation__tMember____defines, tMember__tAnnotation____definedBy,
				mTypeToTType__tAnnotation____target, tMember__tModifier____tModifier, defToMember__tMember____target,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			TAnnotationType tAnnotation, TModifier tModifier, TypeToTAbstractType mTypeToTType,
			MDefinitionToTMember defToMember, MDefinition mDefinition, AnnotationTypeDeclaration annotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tMember, tAnnotation, tModifier,
				mTypeToTType, defToMember, mDefinition, annotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, tAnnotation, tModifier, mTypeToTType,
					defToMember, mDefinition, annotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_12_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, tAnnotation, tModifier, mTypeToTType, defToMember, mDefinition,
				annotation);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_230655 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_230655)) {
				...
				if (tmpMModifier instanceof Modifier) {
					...
					if (tmpTModifier instanceof TModifier) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
								AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
								return new Object[] { tMember, tAnnotation, mModifier, tModifier, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TMember tMember, TAnnotationType tAnnotation, Modifier mModifier, TModifier tModifier,
			MDefinition mDefinition, AnnotationTypeDeclaration annotation, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMember, tAnnotation, mModifier, tModifier, mDefinition, annotation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tMember, tAnnotation, mModifier, tModifier, mDefinition, annotation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInAnnotationVisibility _this, TMember tMember, TAnnotationType tAnnotation, Modifier mModifier,
			TModifier tModifier, MDefinition mDefinition, AnnotationTypeDeclaration annotation, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tMember, tAnnotation, mModifier, tModifier, mDefinition,
				annotation, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tMember, tAnnotation, mModifier, tModifier, mDefinition, annotation,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_24_3_solvecsp_binding = pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tMember, tAnnotation, mModifier, tModifier, mDefinition, annotation, sourceMatch, targetMatch);
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (annotation.equals(mTypeToTType.getSource())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tMember, MDefinitionToTMember.class, "target")) {
						if (mDefinition.equals(defToMember.getSource())) {
							_result.add(new Object[] { tMember, tAnnotation, mTypeToTType, defToMember, mDefinition,
									annotation, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tMember, tAnnotation, mModifier, tModifier, mDefinition, annotation, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_28_1_matchtggpattern_black_nac_0BB(
			TModifier tModifier, TAnnotationType tAnnotation) {
		for (TAbstractType __DEC_tModifier_tModifier_292298 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_292298)) {
				return new Object[] { tModifier, tAnnotation };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tMember, tAnnotation, mTypeToTType,
				defToMember, mDefinition, annotation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, tAnnotation, mTypeToTType, defToMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_29_3_solveCSP_binding = pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, tAnnotation, mTypeToTType, defToMember, mDefinition, annotation,
				ruleResult);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_5_checknacs_blackBBBBBB(TMember tMember,
			TAnnotationType tAnnotation, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember,
			MDefinition mDefinition, AnnotationTypeDeclaration annotation) {
		return new Object[] { tMember, tAnnotation, mTypeToTType, defToMember, mDefinition, annotation };
	}

	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(TMember tMember,
			TAnnotationType tAnnotation, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember,
			MDefinition mDefinition, AnnotationTypeDeclaration annotation, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tMember, tAnnotation, mTypeToTType, defToMember, mDefinition, annotation, ruleResult };
	}
