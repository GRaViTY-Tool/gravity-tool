...
public class MemberInAnnotationVisibilityImpl extends AbstractRuleImpl implements MemberInAnnotationVisibility {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Modifier mModifier, AnnotationTypeDeclaration Annotation,
			MDefinition mDefinition) {

		Object[] result1_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_0_1_initialbindings_blackBBBBB(this, match, mModifier, Annotation,
						mDefinition);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[mModifier] = " + mModifier + ", " + "[Annotation] = " + Annotation
					+ ", " + "[mDefinition] = " + mDefinition + ".");
		}
		...
		if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_0_3_CheckCSP_expressionFBB(this,
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[mModifier] = " + mModifier + ", " + "[Annotation] = " + Annotation + ", "
						+ "[mDefinition] = " + mDefinition + ".");
			}
			...
			MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_0_6_registerobjectstomatch_expressionBBBBB(this, match,
							mModifier, Annotation, mDefinition);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mTypeToTType,
						tAnnotation, mModifierToTModifier, mModifier, tMember, defToMember, Annotation, mDefinition,
						tModifier);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tMember] = " + tMember + ", " + "[defToMember] = " + defToMember + ", " + "[Annotation] = "
		...
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
				this, ruleresult, mTypeToTType, tAnnotation, mModifierToTModifier, mModifier, tMember, defToMember,
				Annotation, mDefinition, tModifier);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_2_2_corematch_blackFFBFFBBB(mModifier, Annotation, mDefinition,
						match)) {
			...
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_2_3_findcontext_blackBBBBBBB(mTypeToTType, tAnnotation,
							mModifier, tMember, defToMember, Annotation, mDefinition)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mTypeToTType,
								tAnnotation, mModifier, tMember, defToMember, Annotation, mDefinition);
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mTypeToTType, tAnnotation, mModifier, tMember, defToMember,
								Annotation, mDefinition);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, Modifier mModifier, AnnotationTypeDeclaration Annotation,
			MDefinition mDefinition) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, Modifier mModifier, AnnotationTypeDeclaration Annotation,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			TAnnotationType tAnnotation, Modifier mModifier, TMember tMember, MDefinitionToTMember defToMember,
			AnnotationTypeDeclaration Annotation, MDefinition mDefinition) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mTypeToTType, EObject tAnnotation,
			EObject mModifierToTModifier, EObject mModifier, EObject tMember, EObject defToMember, EObject Annotation,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mTypeToTType,
						tAnnotation, mModifierToTModifier, mModifier, tMember, defToMember, Annotation, mDefinition,
						tModifier);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
		...
		MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						mTypeToTType, tAnnotation, mModifierToTModifier, mModifier, tMember, defToMember, Annotation,
						mDefinition, tModifier);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_12_2_corematch_blackFBBFFFBB(tAnnotation, tMember, tModifier,
						match)) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_12_3_findcontext_blackBBBBBBB(mTypeToTType, tAnnotation,
							tMember, defToMember, Annotation, mDefinition, tModifier)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mTypeToTType,
								tAnnotation, tMember, defToMember, Annotation, mDefinition, tModifier);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tAnnotation__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tAnnotation____definedBy = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mTypeToTType__tAnnotation____target = (EMoflonEdge) result3_green[10];
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mTypeToTType, tAnnotation, tMember, defToMember, Annotation,
								mDefinition, tModifier);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTypeToTType] = " + mTypeToTType
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			TAnnotationType tAnnotation, TMember tMember, MDefinitionToTMember defToMember,
			AnnotationTypeDeclaration Annotation, MDefinition mDefinition, TModifier tModifier) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mTypeToTType, EObject tAnnotation,
			EObject mModifierToTModifier, EObject mModifier, EObject tMember, EObject defToMember, EObject Annotation,
			EObject mDefinition, EObject tModifier) {
		ruleresult.registerObject("mTypeToTType", mTypeToTType);
		ruleresult.registerObject("tAnnotation", tAnnotation);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_575(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_622(EMoflonEdge _edge_modifier) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
			...
			if (MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
							this, match, mModifier, Annotation, mDefinition)) {
				// 
				if (MemberInAnnotationVisibilityImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAnnotation,
						mModifier, tMember, Annotation, mDefinition, tModifier, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tAnnotation] = " + tAnnotation + ", " + "[mModifier] = " + mModifier + ", " + "[tMember] = "
					+ tMember + ", " + "[Annotation] = " + Annotation + ", " + "[mDefinition] = " + mDefinition + ", "
		...
		if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_24_5_matchcorrcontext_blackFBBFBBBB(tAnnotation, tMember,
							Annotation, mDefinition, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(tAnnotation,
								mModifier, tMember, Annotation, mDefinition, tModifier, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAnnotation] = "
							+ tAnnotation + ", " + "[mModifier] = " + mModifier + ", " + "[tMember] = " + tMember + ", "
							+ "[Annotation] = " + Annotation + ", " + "[mDefinition] = " + mDefinition + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAnnotationType tAnnotation, Modifier mModifier, TMember tMember,
			AnnotationTypeDeclaration Annotation, MDefinition mDefinition, TModifier tModifier, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(Modifier mModifier, AnnotationTypeDeclaration Annotation, MDefinition mDefinition) {// 
		Object[] result1_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_27_1_matchtggpattern_blackBBB(mModifier, Annotation, mDefinition);
		if (result1_black != null) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, mTypeToTType, tAnnotation, tMember, defToMember, Annotation, mDefinition,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTypeToTType] = " + mTypeToTType
			...
			if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_29_5_checknacs_blackBBBBBB(mTypeToTType, tAnnotation,
								tMember, defToMember, Annotation, mDefinition);
				if (result5_black != null) {

					Object[] result6_black = MemberInAnnotationVisibilityImpl
							.pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(mTypeToTType, tAnnotation,
									tMember, defToMember, Annotation, mDefinition, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mTypeToTType] = "
								+ mTypeToTType + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[tMember] = "
								+ tMember + ", " + "[defToMember] = " + defToMember + ", " + "[Annotation] = "
								+ Annotation + ", " + "[mDefinition] = " + mDefinition + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			TAnnotationType tAnnotation, TMember tMember, MDefinitionToTMember defToMember,
			AnnotationTypeDeclaration Annotation, MDefinition mDefinition, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_FWD__MATCH_MODIFIER_ANNOTATIONTYPEDECLARATION_MDEFINITION:
			return isAppropriate_FWD((Match) arguments.get(0), (Modifier) arguments.get(1),
					(AnnotationTypeDeclaration) arguments.get(2), (MDefinition) arguments.get(3));
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MODIFIER_ANNOTATIONTYPEDECLARATION_MDEFINITION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (Modifier) arguments.get(1),
					(AnnotationTypeDeclaration) arguments.get(2), (MDefinition) arguments.get(3));
			return null;
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MODIFIER_ANNOTATIONTYPEDECLARATION_MDEFINITION:
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TANNOTATIONTYPE_MODIFIER_TMEMBER_MDEFINITIONTOTMEMBER_ANNOTATIONTYPEDECLARATION_MDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (TAnnotationType) arguments.get(2),
					(Modifier) arguments.get(3), (TMember) arguments.get(4), (MDefinitionToTMember) arguments.get(5),
					(AnnotationTypeDeclaration) arguments.get(6), (MDefinition) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TANNOTATIONTYPE_TMEMBER_MDEFINITIONTOTMEMBER_ANNOTATIONTYPEDECLARATION_MDEFINITION_TMODIFIER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (TAnnotationType) arguments.get(2),
					(TMember) arguments.get(3), (MDefinitionToTMember) arguments.get(4),
					(AnnotationTypeDeclaration) arguments.get(5), (MDefinition) arguments.get(6),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_575__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_575((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_622__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_622((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__TANNOTATIONTYPE_MODIFIER_TMEMBER_ANNOTATIONTYPEDECLARATION_MDEFINITION_TMODIFIER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TAnnotationType) arguments.get(0), (Modifier) arguments.get(1),
					(TMember) arguments.get(2), (AnnotationTypeDeclaration) arguments.get(3),
					(MDefinition) arguments.get(4), (TModifier) arguments.get(5), (Match) arguments.get(6),
					(Match) arguments.get(7));
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_CHECK_CSP_CC__CSP:
			return isApplicable_checkCsp_CC((CSP) arguments.get(0));
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___CHECK_DEC_FWD__MODIFIER_ANNOTATIONTYPEDECLARATION_MDEFINITION:
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___GENERATE_MODEL__RULEENTRYCONTAINER_TYPETOTABSTRACTTYPE:
			return generateModel((RuleEntryContainer) arguments.get(0), (TypeToTAbstractType) arguments.get(1));
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TANNOTATIONTYPE_TMEMBER_MDEFINITIONTOTMEMBER_ANNOTATIONTYPEDECLARATION_MDEFINITION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_0_1_initialbindings_blackBBBBB(
			MemberInAnnotationVisibility _this, Match match, Modifier mModifier, AnnotationTypeDeclaration annotation,
			MDefinition mDefinition) {
		return new Object[] { _this, match, mModifier, annotation, mDefinition };
	}

	public static final Object[] pattern_MemberInAnnotationVisibility_0_2_SolveCSP_bindingFBBBBB(
			MemberInAnnotationVisibility _this, Match match, Modifier mModifier, AnnotationTypeDeclaration annotation,
			MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, mModifier, annotation, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, mModifier, annotation, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_0_2_SolveCSP_bindingAndBlackFBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_0_2_SolveCSP_binding = pattern_MemberInAnnotationVisibility_0_2_SolveCSP_bindingFBBBBB(
				_this, match, mModifier, annotation, mDefinition);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_0_4_collectelementstobetranslated_blackBBBB(
			Match match, Modifier mModifier, AnnotationTypeDeclaration annotation, MDefinition mDefinition) {
		return new Object[] { match, mModifier, annotation, mDefinition };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_0_5_collectcontextelements_blackBBBB(Match match,
			Modifier mModifier, AnnotationTypeDeclaration annotation, MDefinition mDefinition) {
		return new Object[] { match, mModifier, annotation, mDefinition };
	}
	...
	public static final void pattern_MemberInAnnotationVisibility_0_6_registerobjectstomatch_expressionBBBBB(
			MemberInAnnotationVisibility _this, Match match, Modifier mModifier, AnnotationTypeDeclaration annotation,
			MDefinition mDefinition) {
		_this.registerObjectsToMatch_FWD(match, mModifier, annotation, mDefinition);
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									...
									return new Object[] { mTypeToTType, tAnnotation, mModifier, tMember, defToMember,
											annotation, mDefinition, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			TypeToTAbstractType mTypeToTType, TAnnotationType tAnnotation, Modifier mModifier, TMember tMember,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mTypeToTType, tAnnotation, mModifier, tMember, defToMember, annotation,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_binding != null) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_binding[0];
			...
			Object[] result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_black = pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mTypeToTType, tAnnotation, mModifier, tMember, defToMember, annotation, mDefinition, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mTypeToTType, EObject tAnnotation, EObject mModifierToTModifier,
			EObject mModifier, EObject tMember, EObject defToMember, EObject annotation, EObject mDefinition,
			EObject tModifier) {
	...
	public static final void pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInAnnotationVisibility _this, PerformRuleResult ruleresult, EObject mTypeToTType, EObject tAnnotation,
			EObject mModifierToTModifier, EObject mModifier, EObject tMember, EObject defToMember, EObject annotation,
			EObject mDefinition, EObject tModifier) {
		_this.registerObjects_FWD(ruleresult, mTypeToTType, tAnnotation, mModifierToTModifier, mModifier, tMember,
				defToMember, annotation, mDefinition, tModifier);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_2_corematch_bindingFFFB(Match match) {
		...
		if (tmpMModifier instanceof Modifier) {
			...
			if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
				...
				if (tmpMDefinition instanceof MDefinition) {
					MDefinition mDefinition = (MDefinition) tmpMDefinition;
					return new Object[] { mModifier, annotation, mDefinition, match };
				}
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_2_2_corematch_blackFFBFFBBB(
			Modifier mModifier, AnnotationTypeDeclaration annotation, MDefinition mDefinition, Match match) {
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTAnnotation instanceof TAnnotationType) {
						TAnnotationType tAnnotation = (TAnnotationType) tmpTAnnotation;
						_result.add(new Object[] { mTypeToTType, tAnnotation, mModifier, tMember, defToMember,
								annotation, mDefinition, match });
					}
						...
						if (mDefinition.equals(defToMember.getSource())) {
							if (mModifier.equals(mDefinition.getModifier())) {
								if (annotation.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { mTypeToTType, tAnnotation, mModifier, tMember,
											defToMember, annotation, mDefinition });
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mTypeToTType, tAnnotation, mModifier, tMember, defToMember, annotation, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
			MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			TAnnotationType tAnnotation, Modifier mModifier, TMember tMember, MDefinitionToTMember defToMember,
			AnnotationTypeDeclaration annotation, MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mTypeToTType, tAnnotation, mModifier,
				tMember, defToMember, annotation, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, tAnnotation, mModifier, tMember,
					defToMember, annotation, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_2_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, tAnnotation, mModifier, tMember, defToMember, annotation,
				mDefinition);
						...
						if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpTModifier instanceof TModifier) {
									...
									return new Object[] { mTypeToTType, tAnnotation, tMember, defToMember, annotation,
											mDefinition, tModifier, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TypeToTAbstractType mTypeToTType, TAnnotationType tAnnotation, TMember tMember,
			MDefinitionToTMember defToMember, AnnotationTypeDeclaration annotation, MDefinition mDefinition,
			TModifier tModifier, MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mTypeToTType, tAnnotation, tMember, defToMember, annotation, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding != null) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding[0];
			TAnnotationType tAnnotation = (TAnnotationType) result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding[1];
			...
			Object[] result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_black = pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					mTypeToTType, tAnnotation, tMember, defToMember, annotation, mDefinition, tModifier, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mModifierToTModifier, EObject mModifier, EObject tMember, EObject defToMember, EObject annotation,
			EObject mDefinition, EObject tModifier) {
		_this.registerObjects_BWD(ruleresult, mTypeToTType, tAnnotation, mModifierToTModifier, mModifier, tMember,
				defToMember, annotation, mDefinition, tModifier);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_12_2_corematch_blackFBBFFFBB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { mTypeToTType, tAnnotation, tMember, defToMember, annotation,
								mDefinition, tModifier, match });
					}
				...
				if (tModifier.equals(tMember.getTModifier())) {
					if (annotation.getBodyDeclarations().contains(mDefinition)) {
						if (tMember.equals(defToMember.getTarget())) {
							if (mDefinition.equals(defToMember.getSource())) {
								if (annotation.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { mTypeToTType, tAnnotation, tMember, defToMember,
											annotation, mDefinition, tModifier });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		defToMember__mDefinition____source.setName(defToMember__mDefinition____source_name_prime);
		mTypeToTType__Annotation____source.setName(mTypeToTType__Annotation____source_name_prime);
		return new Object[] { mTypeToTType, tAnnotation, tMember, defToMember, annotation, mDefinition, tModifier,
				isApplicableMatch, tAnnotation__tMember____defines, tMember__tAnnotation____definedBy,
				mTypeToTType__tAnnotation____target, tMember__tModifier____tModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			TAnnotationType tAnnotation, TMember tMember, MDefinitionToTMember defToMember,
			AnnotationTypeDeclaration annotation, MDefinition mDefinition, TModifier tModifier) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mTypeToTType, tAnnotation, tMember,
				defToMember, annotation, mDefinition, tModifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, tAnnotation, tMember, defToMember,
					annotation, mDefinition, tModifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_12_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, tAnnotation, tMember, defToMember, annotation, mDefinition,
				tModifier);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_933174 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_933174)) {
		...
		if (tmpMDefinition instanceof MDefinition) {
			...
			if (tmpMModifier instanceof Modifier) {
				...
				if (mModifier.equals(mDefinition.getModifier())) {
					...
					if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
						AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
						_result.add(new Object[] { mModifier, annotation, mDefinition, _edge_modifier });
					}
	...
	public static final boolean pattern_MemberInAnnotationVisibility_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			MemberInAnnotationVisibility _this, Match match, Modifier mModifier, AnnotationTypeDeclaration annotation,
			MDefinition mDefinition) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, mModifier, annotation, mDefinition);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpTMember instanceof TMember) {
					...
					if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpTModifier instanceof TModifier) {
								TModifier tModifier = (TModifier) tmpTModifier;
								return new Object[] { tAnnotation, mModifier, tMember, annotation, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TAnnotationType tAnnotation, Modifier mModifier, TMember tMember, AnnotationTypeDeclaration annotation,
			MDefinition mDefinition, TModifier tModifier, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tAnnotation, mModifier, tMember, annotation, mDefinition, tModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Modifier mModifier = (Modifier) result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_binding[1];
			...
			MDefinition mDefinition = (MDefinition) result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAnnotation, mModifier, tMember, annotation, mDefinition, tModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInAnnotationVisibility _this, TAnnotationType tAnnotation, Modifier mModifier, TMember tMember,
			AnnotationTypeDeclaration annotation, MDefinition mDefinition, TModifier tModifier, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tAnnotation, mModifier, tMember, annotation, mDefinition,
				tModifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tAnnotation, mModifier, tMember, annotation, mDefinition, tModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_24_3_solvecsp_binding = pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAnnotation, mModifier, tMember, annotation, mDefinition, tModifier, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_24_5_matchcorrcontext_blackFBBFBBBB(
			TAnnotationType tAnnotation, TMember tMember, AnnotationTypeDeclaration annotation, MDefinition mDefinition,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(
			TAnnotationType tAnnotation, Modifier mModifier, TMember tMember, AnnotationTypeDeclaration annotation,
			MDefinition mDefinition, TModifier tModifier, CCMatch ccMatch) {
		return new Object[] { tAnnotation, mModifier, tMember, annotation, mDefinition, tModifier, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_27_1_matchtggpattern_blackBBB(Modifier mModifier,
		...
		if (annotation.getBodyDeclarations().contains(mDefinition)) {
			if (mModifier.equals(mDefinition.getModifier())) {
				return new Object[] { mModifier, annotation, mDefinition };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_28_1_matchtggpattern_black_nac_0BB(
			TModifier tModifier, TAnnotationType tAnnotation) {
		for (TAbstractType __DEC_tModifier_tModifier_138765 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_138765)) {
				return new Object[] { tModifier, tAnnotation };
			}
		}
		return null;
			...
			for (EObject tmpMTypeToTType : mTypeToTTypeList.getEntryObjects()) {
				if (tmpMTypeToTType instanceof TypeToTAbstractType) {
					...
					if (tmpTAnnotation instanceof TAnnotationType) {
						...
						if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
							AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
							if (pattern_MemberInAnnotationVisibility_29_2_isapplicablecore_black_nac_0BB(ruleResult,
									mTypeToTType) == null) {
								if (pattern_MemberInAnnotationVisibility_29_2_isapplicablecore_black_nac_1BB(ruleResult,
										tAnnotation) == null) {
									if (pattern_MemberInAnnotationVisibility_29_2_isapplicablecore_black_nac_5BB(
											ruleResult, annotation) == null) {
										for (TMember tMember : tAnnotation.getDefines()) {
											if (pattern_MemberInAnnotationVisibility_29_2_isapplicablecore_black_nac_2BB(
													ruleResult, tMember) == null) {
												for (BodyDeclaration tmpMDefinition : annotation
														.getBodyDeclarations()) {
													if (tmpMDefinition instanceof MDefinition) {
														MDefinition mDefinition = (MDefinition) tmpMDefinition;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
			MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			TAnnotationType tAnnotation, TMember tMember, MDefinitionToTMember defToMember,
			AnnotationTypeDeclaration annotation, MDefinition mDefinition, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mTypeToTType, tAnnotation, tMember,
				defToMember, annotation, mDefinition, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, tAnnotation, tMember, defToMember,
					annotation, mDefinition, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(
		...
		return new Object[] { mTypeToTType, tAnnotation, tMember, defToMember, annotation, mDefinition, ruleResult };
	}
