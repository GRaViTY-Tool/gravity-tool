...
public class AnonymousEnumConstantImpl extends AbstractRuleImpl implements AnonymousEnumConstant {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = AnonymousEnumConstantImpl
				.pattern_AnonymousEnumConstant_1_1_performtransformation_greenBBBFBFB(tPackage, pg, mAnonymous, tType,
						csp);
		...
		Object[] result3_black = AnonymousEnumConstantImpl
				.pattern_AnonymousEnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tPackage, pg,
						mMemberToTMember, mAnonymous, tAnonymous, tType, tMember, eAnonymousClassDeclarationToTClass,
						mMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tPackage] = " + tPackage + ", " + "[pg] = " + pg + ", " + "[mMemberToTMember] = "
					+ mMemberToTMember + ", " + "[mAnonymous] = " + mAnonymous + ", " + "[tAnonymous] = " + tAnonymous
		...
		AnonymousEnumConstantImpl.pattern_AnonymousEnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(
				ruleresult, tPackage, pg, mAnonymous, tAnonymous, tType, eAnonymousClassDeclarationToTClass, mMember);
		...
		AnonymousEnumConstantImpl.pattern_AnonymousEnumConstant_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tPackage, pg, mMemberToTMember, mAnonymous, tAnonymous, tType, tMember,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnonymousEnumConstantImpl
			...
			for (Object[] result3_black : AnonymousEnumConstantImpl
					.pattern_AnonymousEnumConstant_2_3_findcontext_blackFFBBFBB(mMemberToTMember, mAnonymous, tMember,
							mMember)) {
				...
				Object[] result3_green = AnonymousEnumConstantImpl
						.pattern_AnonymousEnumConstant_2_3_findcontext_greenBBBBBBBFFFFFFFFF(tPackage, pg,
								mMemberToTMember, mAnonymous, tType, tMember, mMember);
				...
				Object[] result4_bindingAndBlack = AnonymousEnumConstantImpl
						.pattern_AnonymousEnumConstant_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tPackage, pg, mMemberToTMember, mAnonymous, tType, tMember, mMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tPackage] = " + tPackage + ", "
							+ "[pg] = " + pg + ", " + "[mMemberToTMember] = " + mMemberToTMember + ", "
							+ "[mAnonymous] = " + mAnonymous + ", " + "[tType] = " + tType + ", " + "[tMember] = "
							+ tMember + ", " + "[mMember] = " + mMember + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TPackage tPackage, TypeGraph pg,
			MDefinitionToTMember mMemberToTMember, AnonymousClassDeclaration mAnonymous, TAbstractType tType,
			TMember tMember, MEnumConstantDeclaration mMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tPackage, EObject pg,
			EObject mMemberToTMember, EObject mAnonymous, EObject tAnonymous, EObject tType, EObject tMember,
	...
	public boolean isAppropriate_BWD(Match match, TPackage tPackage, TypeGraph pg, TClass tAnonymous,
			TAbstractType tType, TMember tMember) {

		Object[] result1_black = AnonymousEnumConstantImpl
				.pattern_AnonymousEnumConstant_10_1_initialbindings_blackBBBBBBB(this, match, tPackage, pg, tAnonymous,
						tType, tMember);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[match] = " + match
							+ ", " + "[tPackage] = " + tPackage + ", " + "[pg] = " + pg + ", " + "[tAnonymous] = "
							+ tAnonymous + ", " + "[tType] = " + tType + ", " + "[tMember] = " + tMember + ".");
		}

		Object[] result2_bindingAndBlack = AnonymousEnumConstantImpl
				.pattern_AnonymousEnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, tPackage, pg,
						tAnonymous, tType, tMember);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[match] = " + match
							+ ", " + "[tPackage] = " + tPackage + ", " + "[pg] = " + pg + ", " + "[tAnonymous] = "
		...
		if (AnonymousEnumConstantImpl.pattern_AnonymousEnumConstant_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result5_black = AnonymousEnumConstantImpl
					.pattern_AnonymousEnumConstant_10_5_collectcontextelements_blackBBBBBB(match, tPackage, pg,
							tAnonymous, tType, tMember);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tPackage] = " + tPackage + ", " + "[pg] = " + pg + ", " + "[tAnonymous] = " + tAnonymous
			...
			AnonymousEnumConstantImpl.pattern_AnonymousEnumConstant_10_6_registerobjectstomatch_expressionBBBBBBB(this,
					match, tPackage, pg, tAnonymous, tType, tMember);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnonymousEnumConstantImpl
				.pattern_AnonymousEnumConstant_12_2_corematch_blackBBFBBBFB(tPackage, pg, tAnonymous, tType, tMember,
						match)) {
			...
			// ForEach 
			for (Object[] result3_black : AnonymousEnumConstantImpl
					.pattern_AnonymousEnumConstant_12_3_findcontext_blackBBBBBBB(tPackage, pg, mMemberToTMember,
							tAnonymous, tType, tMember, mMember)) {
				Object[] result3_green = AnonymousEnumConstantImpl
						.pattern_AnonymousEnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFF(tPackage, pg,
								mMemberToTMember, tAnonymous, tType, tMember, mMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tPackage__tAnonymous____allTypes = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tAnonymous__tPackage____package = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge pg__tAnonymous____allTypes = (EMoflonEdge) result3_green[10];
				...
				//nothing EMoflonEdge tPackage__tType____allTypes = (EMoflonEdge) result3_green[16];
				...
				Object[] result4_bindingAndBlack = AnonymousEnumConstantImpl
						.pattern_AnonymousEnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tPackage, pg, mMemberToTMember, tAnonymous, tType, tMember, mMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tPackage] = " + tPackage + ", "
							+ "[pg] = " + pg + ", " + "[mMemberToTMember] = " + mMemberToTMember + ", "
							+ "[tAnonymous] = " + tAnonymous + ", " + "[tType] = " + tType + ", " + "[tMember] = "
							+ tMember + ", " + "[mMember] = " + mMember + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isAppropriate_solveCsp_BWD(Match match, TPackage tPackage, TypeGraph pg, TClass tAnonymous,
			TAbstractType tType, TMember tMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TPackage tPackage, TypeGraph pg,
			MDefinitionToTMember mMemberToTMember, TClass tAnonymous, TAbstractType tType, TMember tMember,
			MEnumConstantDeclaration mMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tPackage, EObject pg,
			EObject mMemberToTMember, EObject mAnonymous, EObject tAnonymous, EObject tType, EObject tMember,
			EObject eAnonymousClassDeclarationToTClass, EObject mMember) {
		ruleresult.registerObject("tPackage", tPackage);
		ruleresult.registerObject("pg", pg);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_68(EMoflonEdge _edge_allTypes) {
		...
		for (Object[] result2_black : AnonymousEnumConstantImpl
			...
			if (AnonymousEnumConstantImpl
					.pattern_AnonymousEnumConstant_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
							this, match, tPackage, pg, tAnonymous, tType, tMember)) {
				// 
				if (AnonymousEnumConstantImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_72(EMoflonEdge _edge_anonymousClassDeclaration) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnonymousEnumConstantImpl
				.pattern_AnonymousEnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, tPackage, pg, mAnonymous,
						tAnonymous, tType, tMember, mMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tPackage] = " + tPackage + ", " + "[pg] = " + pg + ", " + "[mAnonymous] = " + mAnonymous + ", "
		...
		if (AnonymousEnumConstantImpl.pattern_AnonymousEnumConstant_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnonymousEnumConstantImpl
				...
				Object[] result6_black = AnonymousEnumConstantImpl
						.pattern_AnonymousEnumConstant_24_6_createcorrespondence_blackBBBBBBBB(tPackage, pg, mAnonymous,
								tAnonymous, tType, tMember, mMember, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TPackage tPackage, TypeGraph pg, AnonymousClassDeclaration mAnonymous,
			TClass tAnonymous, TAbstractType tType, TMember tMember, MEnumConstantDeclaration mMember,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TPackage tPackage, TypeGraph pg, TClass tAnonymous, TAbstractType tType,
			TMember tMember) {// 
		Object[] result1_black = AnonymousEnumConstantImpl
				.pattern_AnonymousEnumConstant_28_1_matchtggpattern_blackBBBBB(tPackage, pg, tAnonymous, tType,
						tMember);
		if (result1_black != null) {
		...
		for (Object[] result2_black : AnonymousEnumConstantImpl
			...
			Object[] result3_bindingAndBlack = AnonymousEnumConstantImpl
					.pattern_AnonymousEnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tPackage, pg, mMemberToTMember, tType, tMember, mMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tPackage] = " + tPackage + ", "
						+ "[pg] = " + pg + ", " + "[mMemberToTMember] = " + mMemberToTMember + ", " + "[tType] = "
						+ tType + ", " + "[tMember] = " + tMember + ", " + "[mMember] = " + mMember + ", "
			...
			if (AnonymousEnumConstantImpl.pattern_AnonymousEnumConstant_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = AnonymousEnumConstantImpl
						.pattern_AnonymousEnumConstant_29_5_checknacs_blackBBBBBB(tPackage, pg, mMemberToTMember, tType,
								tMember, mMember);
				if (result5_black != null) {

					Object[] result6_black = AnonymousEnumConstantImpl
							.pattern_AnonymousEnumConstant_29_6_perform_blackBBBBBBB(tPackage, pg, mMemberToTMember,
									tType, tMember, mMember, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tPackage] = "
								+ tPackage + ", " + "[pg] = " + pg + ", " + "[mMemberToTMember] = " + mMemberToTMember
								+ ", " + "[tType] = " + tType + ", " + "[tMember] = " + tMember + ", " + "[mMember] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TPackage tPackage, TypeGraph pg,
			MDefinitionToTMember mMemberToTMember, TAbstractType tType, TMember tMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPACKAGE_TYPEGRAPH_MDEFINITIONTOTMEMBER_ANONYMOUSCLASSDECLARATION_TABSTRACTTYPE_TMEMBER_MENUMCONSTANTDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TPackage) arguments.get(1),
					...
					(AnonymousClassDeclaration) arguments.get(4), (TAbstractType) arguments.get(5),
					(TMember) arguments.get(6), (MEnumConstantDeclaration) arguments.get(7));
		...
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___IS_APPROPRIATE_BWD__MATCH_TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TMEMBER:
		...
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TMEMBER:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TPackage) arguments.get(1),
					(TypeGraph) arguments.get(2), (TClass) arguments.get(3), (TAbstractType) arguments.get(4),
					(TMember) arguments.get(5));
			return null;
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TMEMBER:
		...
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPACKAGE_TYPEGRAPH_MDEFINITIONTOTMEMBER_TCLASS_TABSTRACTTYPE_TMEMBER_MENUMCONSTANTDECLARATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TPackage) arguments.get(1),
					(TypeGraph) arguments.get(2), (MDefinitionToTMember) arguments.get(3), (TClass) arguments.get(4),
					(TAbstractType) arguments.get(5), (TMember) arguments.get(6),
		...
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_68__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_68((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_72__EMOFLONEDGE:
		...
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_CC__TPACKAGE_TYPEGRAPH_ANONYMOUSCLASSDECLARATION_TCLASS_TABSTRACTTYPE_TMEMBER_MENUMCONSTANTDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TPackage) arguments.get(0), (TypeGraph) arguments.get(1),
					...
					(TAbstractType) arguments.get(4), (TMember) arguments.get(5),
		...
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___CHECK_DEC_BWD__TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_TMEMBER:
		...
		case RulesPackage.ANONYMOUS_ENUM_CONSTANT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPACKAGE_TYPEGRAPH_MDEFINITIONTOTMEMBER_TABSTRACTTYPE_TMEMBER_MENUMCONSTANTDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpTType instanceof TAbstractType) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpMMember instanceof MEnumConstantDeclaration) {
									...
									return new Object[] { tPackage, pg, mMemberToTMember, mAnonymous, tType, tMember,
	...
	public static final Object[] pattern_AnonymousEnumConstant_1_1_performtransformation_blackBBBBBBBFBB(
			TPackage tPackage, TypeGraph pg, MDefinitionToTMember mMemberToTMember,
			AnonymousClassDeclaration mAnonymous, TAbstractType tType, TMember tMember,
			MEnumConstantDeclaration mMember, AnonymousEnumConstant _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tPackage, pg, mMemberToTMember, mAnonymous, tType, tMember, mMember, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnonymousEnumConstant_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnonymousEnumConstant_1_1_performtransformation_binding != null) {
			...
			TMember tMember = (TMember) result_pattern_AnonymousEnumConstant_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_AnonymousEnumConstant_1_1_performtransformation_black = pattern_AnonymousEnumConstant_1_1_performtransformation_blackBBBBBBBFBB(
					tPackage, pg, mMemberToTMember, mAnonymous, tType, tMember, mMember, _this, isApplicableMatch);
	...
	public static final Object[] pattern_AnonymousEnumConstant_1_1_performtransformation_greenBBBFBFB(TPackage tPackage,
		...
		return new Object[] { tPackage, pg, mAnonymous, tAnonymous, tType, eAnonymousClassDeclarationToTClass, csp };
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tPackage, EObject pg, EObject mMemberToTMember, EObject mAnonymous,
			EObject tAnonymous, EObject tType, EObject tMember, EObject eAnonymousClassDeclarationToTClass,
			EObject mMember) {
	...
	public static final Object[] pattern_AnonymousEnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tPackage, EObject pg, EObject mAnonymous, EObject tAnonymous,
		...
		return new Object[] { ruleresult, tPackage, pg, mAnonymous, tAnonymous, tType,
				eAnonymousClassDeclarationToTClass, mMember, tPackage__tAnonymous____allTypes,
				tAnonymous__tPackage____package, pg__tAnonymous____allTypes, tAnonymous__pg____model,
				tPackage__tAnonymous____classes, pg__tAnonymous____classes, tType__tAnonymous____innerTypes,
				tAnonymous__tType____outerType, eAnonymousClassDeclarationToTClass__tAnonymous____target,
				mMember__mAnonymous____anonymousClassDeclaration,
				eAnonymousClassDeclarationToTClass__mAnonymous____source };
	}

	public static final void pattern_AnonymousEnumConstant_1_5_registerobjects_expressionBBBBBBBBBBB(
			AnonymousEnumConstant _this, PerformRuleResult ruleresult, EObject tPackage, EObject pg,
			EObject mMemberToTMember, EObject mAnonymous, EObject tAnonymous, EObject tType, EObject tMember,
			EObject eAnonymousClassDeclarationToTClass, EObject mMember) {
		_this.registerObjects_FWD(ruleresult, tPackage, pg, mMemberToTMember, mAnonymous, tAnonymous, tType, tMember,
				eAnonymousClassDeclarationToTClass, mMember);
	...
	public static final Iterable<Object[]> pattern_AnonymousEnumConstant_2_2_corematch_blackFBFBB(
		...
		for (MDefinitionToTMember mMemberToTMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				_result.add(new Object[] { mMemberToTMember, mAnonymous, tMember, mMember, match });
			}
	...
	public static final Iterable<Object[]> pattern_AnonymousEnumConstant_2_3_findcontext_blackFFBBFBB(
			MDefinitionToTMember mMemberToTMember, AnonymousClassDeclaration mAnonymous, TMember tMember,
			MEnumConstantDeclaration mMember) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (mAnonymous.equals(mMember.getAnonymousClassDeclaration())) {
					...
					if (tType != null) {
						...
						if (tPackage != null) {
							...
							if (pg != null) {
								_result.add(new Object[] { tPackage, pg, mMemberToTMember, mAnonymous, tType, tMember,
										mMember });
							}
	...
	public static final Object[] pattern_AnonymousEnumConstant_2_3_findcontext_greenBBBBBBBFFFFFFFFF(TPackage tPackage,
			...
			TAbstractType tType, TMember tMember, MEnumConstantDeclaration mMember) {
		...
		mMember__mAnonymous____anonymousClassDeclaration
				.setName(mMember__mAnonymous____anonymousClassDeclaration_name_prime);
		return new Object[] { tPackage, pg, mMemberToTMember, mAnonymous, tType, tMember, mMember, isApplicableMatch,
				tPackage__pg____model, tType__tPackage____package, tPackage__tType____allTypes,
	...
	public static final Object[] pattern_AnonymousEnumConstant_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			MDefinitionToTMember mMemberToTMember, AnonymousClassDeclaration mAnonymous, TAbstractType tType,
			TMember tMember, MEnumConstantDeclaration mMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tPackage, pg, mMemberToTMember,
				mAnonymous, tType, tMember, mMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPackage, pg, mMemberToTMember, mAnonymous, tType,
					tMember, mMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnonymousEnumConstant_2_4_solveCSP_binding = pattern_AnonymousEnumConstant_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tPackage, pg, mMemberToTMember, mAnonymous, tType, tMember, mMember);
	...
	public static final Object[] pattern_AnonymousEnumConstant_10_1_initialbindings_blackBBBBBBB(
			AnonymousEnumConstant _this, Match match, TPackage tPackage, TypeGraph pg, TClass tAnonymous,
			TAbstractType tType, TMember tMember) {
		if (!tAnonymous.equals(tType)) {
			return new Object[] { _this, match, tPackage, pg, tAnonymous, tType, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_10_2_SolveCSP_bindingFBBBBBBB(
			AnonymousEnumConstant _this, Match match, TPackage tPackage, TypeGraph pg, TClass tAnonymous,
			TAbstractType tType, TMember tMember) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, tPackage, pg, tAnonymous, tType, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, tPackage, pg, tAnonymous, tType, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_AnonymousEnumConstant_10_2_SolveCSP_binding = pattern_AnonymousEnumConstant_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, tPackage, pg, tAnonymous, tType, tMember);
	...
	public static final Object[] pattern_AnonymousEnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, TPackage tPackage, TypeGraph pg, TClass tAnonymous, TAbstractType tType, TMember tMember) {
		if (!tAnonymous.equals(tType)) {
			return new Object[] { match, tPackage, pg, tAnonymous, tType, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_10_5_collectcontextelements_blackBBBBBB(Match match,
			TPackage tPackage, TypeGraph pg, TClass tAnonymous, TAbstractType tType, TMember tMember) {
		if (!tAnonymous.equals(tType)) {
			return new Object[] { match, tPackage, pg, tAnonymous, tType, tMember };
		}
		return null;
	...
	public static final Object[] pattern_AnonymousEnumConstant_10_5_collectcontextelements_greenBBBBBFFFFF(Match match,
			TPackage tPackage, TypeGraph pg, TAbstractType tType, TMember tMember) {
		EMoflonEdge tPackage__pg____model = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tType__tPackage____package = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tPackage__tType____allTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tType__tMember____defines = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		tType__tMember____defines.setName(tType__tMember____defines_name_prime);
		tMember__tType____definedBy.setName(tMember__tType____definedBy_name_prime);
		return new Object[] { match, tPackage, pg, tType, tMember, tPackage__pg____model, tType__tPackage____package,
	...
	public static final void pattern_AnonymousEnumConstant_10_6_registerobjectstomatch_expressionBBBBBBB(
			AnonymousEnumConstant _this, Match match, TPackage tPackage, TypeGraph pg, TClass tAnonymous,
			TAbstractType tType, TMember tMember) {
		_this.registerObjectsToMatch_BWD(match, tPackage, pg, tAnonymous, tType, tMember);
					...
					if (tmpTAnonymous instanceof TClass) {
						...
						if (tmpTType instanceof TAbstractType) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpMMember instanceof MEnumConstantDeclaration) {
									MEnumConstantDeclaration mMember = (MEnumConstantDeclaration) tmpMMember;
									return new Object[] { tPackage, pg, mMemberToTMember, tAnonymous, tType, tMember,
											mMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_AnonymousEnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
			TPackage tPackage, TypeGraph pg, MDefinitionToTMember mMemberToTMember, TClass tAnonymous,
			TAbstractType tType, TMember tMember, MEnumConstantDeclaration mMember, AnonymousEnumConstant _this,
			IsApplicableMatch isApplicableMatch) {
		if (!tAnonymous.equals(tType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { tPackage, pg, mMemberToTMember, tAnonymous, tType, tMember, mMember, csp,
	...
	public static final Object[] pattern_AnonymousEnumConstant_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnonymousEnumConstant_11_1_performtransformation_binding != null) {
			...
			TMember tMember = (TMember) result_pattern_AnonymousEnumConstant_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_AnonymousEnumConstant_11_1_performtransformation_black = pattern_AnonymousEnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
					tPackage, pg, mMemberToTMember, tAnonymous, tType, tMember, mMember, _this, isApplicableMatch);
			if (result_pattern_AnonymousEnumConstant_11_1_performtransformation_black != null) {
				...
				return new Object[] { tPackage, pg, mMemberToTMember, tAnonymous, tType, tMember, mMember, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_AnonymousEnumConstant_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mMemberToTMember, EObject mAnonymous, EObject tAnonymous, EObject tType, EObject tMember,
			EObject eAnonymousClassDeclarationToTClass, EObject mMember) {
		_this.registerObjects_BWD(ruleresult, tPackage, pg, mMemberToTMember, mAnonymous, tAnonymous, tType, tMember,
				eAnonymousClassDeclarationToTClass, mMember);
			...
			if (tmpPg instanceof TypeGraph) {
				...
				if (tmpTAnonymous instanceof TClass) {
					...
					if (tmpTType instanceof TAbstractType) {
						...
						if (tmpTMember instanceof TMember) {
							TMember tMember = (TMember) tmpTMember;
							return new Object[] { tPackage, pg, tAnonymous, tType, tMember, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_AnonymousEnumConstant_12_2_corematch_blackBBFBBBFB(TPackage tPackage,
			TypeGraph pg, TClass tAnonymous, TAbstractType tType, TMember tMember, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tAnonymous.equals(tType)) {
			for (MDefinitionToTMember mMemberToTMember : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpMMember instanceof MEnumConstantDeclaration) {
					MEnumConstantDeclaration mMember = (MEnumConstantDeclaration) tmpMMember;
					_result.add(new Object[] { tPackage, pg, mMemberToTMember, tAnonymous, tType, tMember, mMember,
							match });
				}
								...
								if (tPackage.equals(tType.getPackage())) {
									if (tType.getInnerTypes().contains(tAnonymous)) {
										if (tType.getDefines().contains(tMember)) {
											if (tMember.equals(mMemberToTMember.getTarget())) {
												if (mMember.equals(mMemberToTMember.getSource())) {
													_result.add(new Object[] { tPackage, pg, mMemberToTMember,
															tAnonymous, tType, tMember, mMember });
												}
											}
										}
	...
	public static final Object[] pattern_AnonymousEnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFF(
		...
		mMemberToTMember__tMember____target.setName(mMemberToTMember__tMember____target_name_prime);
		mMemberToTMember__mMember____source.setName(mMemberToTMember__mMember____source_name_prime);
		return new Object[] { tPackage, pg, mMemberToTMember, tAnonymous, tType, tMember, mMember, isApplicableMatch,
				tPackage__tAnonymous____allTypes, tAnonymous__tPackage____package, pg__tAnonymous____allTypes,
				tAnonymous__pg____model, tPackage__tAnonymous____classes, tPackage__pg____model,
				pg__tAnonymous____classes, tType__tPackage____package, tPackage__tType____allTypes,
				tType__tAnonymous____innerTypes, tAnonymous__tType____outerType, tType__tMember____defines,
				tMember__tType____definedBy, mMemberToTMember__tMember____target, mMemberToTMember__mMember____source };
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			MDefinitionToTMember mMemberToTMember, TClass tAnonymous, TAbstractType tType, TMember tMember,
			MEnumConstantDeclaration mMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tPackage, pg, mMemberToTMember,
				tAnonymous, tType, tMember, mMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPackage, pg, mMemberToTMember, tAnonymous, tType,
					tMember, mMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnonymousEnumConstant_12_4_solveCSP_binding = pattern_AnonymousEnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tPackage, pg, mMemberToTMember, tAnonymous, tType, tMember, mMember);
	...
	public static final Object[] pattern_AnonymousEnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TPackage __DEC_tAnonymous_classes_347050 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tAnonymous_classes_347050)) {
	...
	public static final Object[] pattern_AnonymousEnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
		...
		for (TypeGraph __DEC_tAnonymous_classes_198723 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tAnonymous_classes_198723)) {
	...
	public static final Object[] pattern_AnonymousEnumConstant_20_2_testcorematchandDECs_black_nac_2BB(
			TClass tAnonymous, TPackage tPackage) {
		TPackage __DEC_tAnonymous_allTypes_180256 = tAnonymous.getPackage();
		if (__DEC_tAnonymous_allTypes_180256 != null) {
			if (!tPackage.equals(__DEC_tAnonymous_allTypes_180256)) {
				return new Object[] { tAnonymous, tPackage };
			}
		}
	...
	public static final Object[] pattern_AnonymousEnumConstant_20_2_testcorematchandDECs_black_nac_3BB(
		...
		if (!tAnonymous.equals(tType)) {
			TAbstractType __DEC_tAnonymous_innerTypes_962226 = tAnonymous.getOuterType();
			if (__DEC_tAnonymous_innerTypes_962226 != null) {
				if (!tAnonymous.equals(__DEC_tAnonymous_innerTypes_962226)) {
					if (!tType.equals(__DEC_tAnonymous_innerTypes_962226)) {
														...
														if (pattern_AnonymousEnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
															...
															if (pattern_AnonymousEnumConstant_20_2_testcorematchandDECs_black_nac_3BB(
																...
																for (TMember tMember : tType.getDefines()) {
																	_result.add(new Object[] { tPackage, pg, tAnonymous,
																			tType, tMember, _edge_allTypes });
																}
															}
														}
													}
	...
	public static final boolean pattern_AnonymousEnumConstant_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			AnonymousEnumConstant _this, Match match, TPackage tPackage, TypeGraph pg, TClass tAnonymous,
			TAbstractType tType, TMember tMember) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tPackage, pg, tAnonymous, tType, tMember);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_21_2_testcorematchandDECs_black_nac_0B(
		...
		ClassInstanceCreation __DEC_mAnonymous_anonymousClassDeclaration_389076 = mAnonymous.getClassInstanceCreation();
		if (__DEC_mAnonymous_anonymousClassDeclaration_389076 != null) {
					...
					if (tmpTAnonymous instanceof TClass) {
						...
						if (tmpTType instanceof TAbstractType) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpMMember instanceof MEnumConstantDeclaration) {
									MEnumConstantDeclaration mMember = (MEnumConstantDeclaration) tmpMMember;
									return new Object[] { tPackage, pg, mAnonymous, tAnonymous, tType, tMember, mMember,
	...
	public static final Object[] pattern_AnonymousEnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(TPackage tPackage,
			TypeGraph pg, AnonymousClassDeclaration mAnonymous, TClass tAnonymous, TAbstractType tType, TMember tMember,
			MEnumConstantDeclaration mMember, Match sourceMatch, Match targetMatch) {
		if (!tAnonymous.equals(tType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { tPackage, pg, mAnonymous, tAnonymous, tType, tMember, mMember, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnonymousEnumConstant_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_AnonymousEnumConstant_24_2_matchsrctrgcontext_binding != null) {
			...
			TMember tMember = (TMember) result_pattern_AnonymousEnumConstant_24_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_AnonymousEnumConstant_24_2_matchsrctrgcontext_black = pattern_AnonymousEnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					tPackage, pg, mAnonymous, tAnonymous, tType, tMember, mMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnonymousEnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(
			AnonymousEnumConstant _this, TPackage tPackage, TypeGraph pg, AnonymousClassDeclaration mAnonymous,
			TClass tAnonymous, TAbstractType tType, TMember tMember, MEnumConstantDeclaration mMember,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(tPackage, pg, mAnonymous, tAnonymous, tType, tMember,
				mMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, tPackage, pg, mAnonymous, tAnonymous, tType, tMember, mMember,
	...
	public static final Object[] pattern_AnonymousEnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_AnonymousEnumConstant_24_3_solvecsp_binding = pattern_AnonymousEnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, tPackage, pg, mAnonymous, tAnonymous, tType, tMember, mMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnonymousEnumConstant_24_6_createcorrespondence_blackBBBBBBBB(
			TPackage tPackage, TypeGraph pg, AnonymousClassDeclaration mAnonymous, TClass tAnonymous,
			TAbstractType tType, TMember tMember, MEnumConstantDeclaration mMember, CCMatch ccMatch) {
		if (!tAnonymous.equals(tType)) {
			return new Object[] { tPackage, pg, mAnonymous, tAnonymous, tType, tMember, mMember, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_27_1_matchtggpattern_black_nac_0B(
			AnonymousClassDeclaration mAnonymous) {
		ClassInstanceCreation __DEC_mAnonymous_anonymousClassDeclaration_883627 = mAnonymous.getClassInstanceCreation();
		if (__DEC_mAnonymous_anonymousClassDeclaration_883627 != null) {
			return new Object[] { mAnonymous };
		}
	...
	public static final Object[] pattern_AnonymousEnumConstant_28_1_matchtggpattern_black_nac_0BB(TClass tAnonymous,
			TPackage tPackage) {
		for (TPackage __DEC_tAnonymous_classes_403343 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tAnonymous_classes_403343)) {
				return new Object[] { tAnonymous, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnonymousEnumConstant_28_1_matchtggpattern_black_nac_1BB(TClass tAnonymous,
			TypeGraph pg) {
		for (TypeGraph __DEC_tAnonymous_classes_377152 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tAnonymous_classes_377152)) {
				return new Object[] { tAnonymous, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnonymousEnumConstant_28_1_matchtggpattern_black_nac_2BB(TClass tAnonymous,
			TPackage tPackage) {
		TPackage __DEC_tAnonymous_allTypes_314205 = tAnonymous.getPackage();
		if (__DEC_tAnonymous_allTypes_314205 != null) {
			if (!tPackage.equals(__DEC_tAnonymous_allTypes_314205)) {
				return new Object[] { tAnonymous, tPackage };
			}
		}
	...
	public static final Object[] pattern_AnonymousEnumConstant_28_1_matchtggpattern_black_nac_3BB(TClass tAnonymous,
			TAbstractType tType) {
		if (!tAnonymous.equals(tType)) {
			TAbstractType __DEC_tAnonymous_innerTypes_928760 = tAnonymous.getOuterType();
			if (__DEC_tAnonymous_innerTypes_928760 != null) {
				if (!tAnonymous.equals(__DEC_tAnonymous_innerTypes_928760)) {
					if (!tType.equals(__DEC_tAnonymous_innerTypes_928760)) {
						return new Object[] { tAnonymous, tType };
					}
				}
			}
	...
	public static final Object[] pattern_AnonymousEnumConstant_28_1_matchtggpattern_blackBBBBB(TPackage tPackage,
			TypeGraph pg, TClass tAnonymous, TAbstractType tType, TMember tMember) {
		if (!tAnonymous.equals(tType)) {
			if (tPackage.getAllTypes().contains(tAnonymous)) {
				if (pg.getAllTypes().contains(tAnonymous)) {
					if (tPackage.getClasses().contains(tAnonymous)) {
												...
												if (pattern_AnonymousEnumConstant_28_1_matchtggpattern_black_nac_1BB(
													...
													if (pattern_AnonymousEnumConstant_28_1_matchtggpattern_black_nac_2BB(
														...
														if (pattern_AnonymousEnumConstant_28_1_matchtggpattern_black_nac_3BB(
																tAnonymous, tType) == null) {
															return new Object[] { tPackage, pg, tAnonymous, tType,
																	tMember };
														}
													}
												}
	...
	public static final Object[] pattern_AnonymousEnumConstant_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tPackage, pg, mMemberToTMember,
				tType, tMember, mMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPackage, pg, mMemberToTMember, tType, tMember,
					mMember, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnonymousEnumConstant_29_3_solveCSP_binding = pattern_AnonymousEnumConstant_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tPackage, pg, mMemberToTMember, tType, tMember, mMember, ruleResult);
	...
	public static final Object[] pattern_AnonymousEnumConstant_29_5_checknacs_blackBBBBBB(TPackage tPackage,
			TypeGraph pg, MDefinitionToTMember mMemberToTMember, TAbstractType tType, TMember tMember,
			MEnumConstantDeclaration mMember) {
		return new Object[] { tPackage, pg, mMemberToTMember, tType, tMember, mMember };
	}

	public static final Object[] pattern_AnonymousEnumConstant_29_6_perform_blackBBBBBBB(TPackage tPackage,
			TypeGraph pg, MDefinitionToTMember mMemberToTMember, TAbstractType tType, TMember tMember,
			MEnumConstantDeclaration mMember, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tPackage, pg, mMemberToTMember, tType, tMember, mMember, ruleResult };
	}
	...
	public static final Object[] pattern_AnonymousEnumConstant_29_6_perform_greenBBFFBFBBB(TPackage tPackage,
		...
		return new Object[] { tPackage, pg, mAnonymous, tAnonymous, tType, eAnonymousClassDeclarationToTClass, mMember,
				ruleResult, csp };
	}
