...
public class ClassExtendsClassImpl extends AbstractRuleImpl implements ClassExtendsClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ClassExtendsClassImpl.pattern_ClassExtendsClass_1_3_bookkeepingforedges_blackBBBBBBBB(
				ruleresult, eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass,
				eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass);
		...
		ClassExtendsClassImpl.pattern_ClassExtendsClass_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass, tClass);
		...
		ClassExtendsClassImpl.pattern_ClassExtendsClass_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult,
				eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass, eExtendedClassToTExtendedClass,
			...
			for (Object[] result3_black : ClassExtendsClassImpl.pattern_ClassExtendsClass_2_3_findcontext_blackBBBBBBB(
				...
				Object[] result3_green = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_2_3_findcontext_greenBBBBBBBFFFFFFFF(eClassDeclaration,
								eExtendedClass, eTypeAccess, tExtendedClass, eExtendedClassToTExtendedClass,
								eClassDeclarationToTClass, tClass);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eClassDeclaration, EObject eExtendedClass,
			EObject eTypeAccess, EObject tExtendedClass, EObject eExtendedClassToTExtendedClass,
			...
			for (Object[] result3_black : ClassExtendsClassImpl.pattern_ClassExtendsClass_12_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_12_3_findcontext_greenBBBBBBFFFFFFF(eClassDeclaration,
								eExtendedClass, tExtendedClass, eExtendedClassToTExtendedClass,
								eClassDeclarationToTClass, tClass);
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration eClassDeclaration,
			...
			TypeToTAbstractType eClassDeclarationToTClass, TClass tClass) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ClassExtendsClassImpl
				.pattern_ClassExtendsClass_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eClassDeclaration,
						eExtendedClass, eTypeAccess, tExtendedClass, tClass, sourceMatch, targetMatch);
		...
		if (ClassExtendsClassImpl.pattern_ClassExtendsClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ClassExtendsClassImpl
					.pattern_ClassExtendsClass_24_5_matchcorrcontext_blackBBBFFBBB(eClassDeclaration, eExtendedClass,
				...
				Object[] result6_black = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_24_6_createcorrespondence_blackBBBBBB(eClassDeclaration,
								eExtendedClass, eTypeAccess, tExtendedClass, tClass, ccMatch);
				if (result6_black == null) {
	...
	public CSP isApplicable_solveCsp_CC(ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass,
			TypeAccess eTypeAccess, TClass tExtendedClass, TClass tClass, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : ClassExtendsClassImpl
			...
			if (ClassExtendsClassImpl.pattern_ClassExtendsClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					ClassExtendsClassImpl.pattern_ClassExtendsClass_29_6_perform_greenBBFBBB(eClassDeclaration,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration eClassDeclaration,
			ClassDeclaration eExtendedClass, TClass tExtendedClass, TypeToTAbstractType eExtendedClassToTExtendedClass,
			TypeToTAbstractType eClassDeclarationToTClass, TClass tClass, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSDECLARATION_CLASSDECLARATION_TYPEACCESS_TCLASS_TYPETOTABSTRACTTYPE_TYPETOTABSTRACTTYPE_TCLASS:
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_CLASSDECLARATION_TCLASS_TYPETOTABSTRACTTYPE_TYPETOTABSTRACTTYPE_TCLASS:
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_51__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_51((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_54__EMOFLONEDGE:
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__CLASSDECLARATION_CLASSDECLARATION_TYPEACCESS_TCLASS_TCLASS_MATCH_MATCH:
			return isApplicable_solveCsp_CC((ClassDeclaration) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(TypeAccess) arguments.get(2), (TClass) arguments.get(3), (TClass) arguments.get(4),
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_CLASSDECLARATION_TCLASS_TYPETOTABSTRACTTYPE_TYPETOTABSTRACTTYPE_TCLASS_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ClassExtendsClass_1_1_performtransformation_blackBBBBBBBFBB(
			...
			TypeToTAbstractType eClassDeclarationToTClass, TClass tClass, ClassExtendsClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!eClassDeclaration.equals(eExtendedClass)) {
				...
				if (!tClass.equals(tExtendedClass)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass,
									eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_ClassExtendsClass_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eClassDeclaration, EObject eExtendedClass, EObject eTypeAccess,
			EObject tExtendedClass, EObject eExtendedClassToTExtendedClass, EObject eClassDeclarationToTClass,
			EObject tClass) {
		if (!eClassDeclaration.equals(eExtendedClass)) {
	...
	public static final Object[] pattern_ClassExtendsClass_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass, tClass,
				eTypeAccess__eExtendedClass____type, eExtendedClass__eTypeAccess____usagesInTypeAccess,
	...
	public static final void pattern_ClassExtendsClass_1_5_registerobjects_expressionBBBBBBBBB(ClassExtendsClass _this,
			...
			EObject tExtendedClass, EObject eExtendedClassToTExtendedClass, EObject eClassDeclarationToTClass,
			EObject tClass) {
		_this.registerObjects_FWD(ruleresult, eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass,
				eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass);
					...
					for (TypeToTAbstractType eClassDeclarationToTClass : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eClassDeclarationToTClass.equals(eExtendedClassToTExtendedClass)) {
							...
							if (tmpTClass instanceof TClass) {
								TClass tClass = (TClass) tmpTClass;
								if (!tClass.equals(tExtendedClass)) {
									_result.add(new Object[] { eClassDeclaration, eExtendedClass, eTypeAccess,
											tExtendedClass, eExtendedClassToTExtendedClass, eClassDeclarationToTClass,
											tClass, match });
								}
							}
	...
	public static final Object[] pattern_ClassExtendsClass_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		eClassDeclaration__eTypeAccess____superClass.setName(eClassDeclaration__eTypeAccess____superClass_name_prime);
		return new Object[] { eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass,
				eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass, isApplicableMatch,
				eTypeAccess__eExtendedClass____type, eExtendedClass__eTypeAccess____usagesInTypeAccess,
				eExtendedClassToTExtendedClass__eExtendedClass____source,
				eClassDeclarationToTClass__eClassDeclaration____source,
	...
	public static final Object[] pattern_ClassExtendsClass_2_4_solveCSP_bindingFBBBBBBBBB(ClassExtendsClass _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eClassDeclaration, eExtendedClass,
				eTypeAccess, tExtendedClass, eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eClassDeclaration, eExtendedClass, eTypeAccess,
					tExtendedClass, eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ClassExtendsClass_2_4_solveCSP_binding = pattern_ClassExtendsClass_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass,
				eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass);
	...
	public static final void pattern_ClassExtendsClass_11_5_registerobjects_expressionBBBBBBBBB(ClassExtendsClass _this,
			...
			EObject tExtendedClass, EObject eExtendedClassToTExtendedClass, EObject eClassDeclarationToTClass,
			EObject tClass) {
		_this.registerObjects_BWD(ruleresult, eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass,
				eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass);
							...
							if (tmpEClassDeclaration instanceof ClassDeclaration) {
								...
								if (!eClassDeclaration.equals(eExtendedClass)) {
									_result.add(new Object[] { eClassDeclaration, eExtendedClass, tExtendedClass,
											eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass, match });
								}
							}
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!eClassDeclaration.equals(eExtendedClass)) {
			for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_920840 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!eClassDeclaration.equals(__DEC_eTypeAccess_superInterfaces_920840)) {
					if (!eExtendedClass.equals(__DEC_eTypeAccess_superInterfaces_920840)) {
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_320098 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_580360 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_737141 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_253241 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_95500 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_981827 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_263426 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_28937 : org.moflon.core.utilities.eMoflonEMFUtil
		...
		if (!eClassDeclaration.equals(eExtendedClass)) {
			if (!tClass.equals(tExtendedClass)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass, tClass,
	...
	public static final Object[] pattern_ClassExtendsClass_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_ClassExtendsClass_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ClassExtendsClass_24_2_matchsrctrgcontext_black = pattern_ClassExtendsClass_24_2_matchsrctrgcontext_blackBBBBBBB(
					eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass, tClass, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ClassExtendsClass_24_3_solvecsp_bindingFBBBBBBBB(ClassExtendsClass _this,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass, TypeAccess eTypeAccess,
			TClass tExtendedClass, TClass tClass, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eClassDeclaration, eExtendedClass, eTypeAccess,
				tExtendedClass, tClass, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass, tClass,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
			...
			TypeAccess eTypeAccess, TClass tExtendedClass, TClass tClass, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_ClassExtendsClass_24_3_solvecsp_binding = pattern_ClassExtendsClass_24_3_solvecsp_bindingFBBBBBBBB(
				_this, eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass, tClass, sourceMatch,
				targetMatch);
		if (result_pattern_ClassExtendsClass_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_ClassExtendsClass_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass,
						tClass, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_ClassExtendsClass_24_5_matchcorrcontext_blackBBBFFBBB(
	...
	public static final Object[] pattern_ClassExtendsClass_24_6_createcorrespondence_blackBBBBBB(
		...
		if (!eClassDeclaration.equals(eExtendedClass)) {
			if (!tClass.equals(tExtendedClass)) {
				return new Object[] { eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass, tClass, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_0BBB(TypeAccess eTypeAccess,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass) {
		if (!eClassDeclaration.equals(eExtendedClass)) {
			for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_402175 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!eClassDeclaration.equals(__DEC_eTypeAccess_superInterfaces_402175)) {
					if (!eExtendedClass.equals(__DEC_eTypeAccess_superInterfaces_402175)) {
						return new Object[] { eTypeAccess, eClassDeclaration, eExtendedClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_1B(TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_772247 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_2B(TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_520331 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_3B(TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_373279 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_4B(TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_501504 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_5B(TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_46115 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_6B(TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_537084 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_7B(TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_678901 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_8B(TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_964864 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_29_3_solveCSP_bindingFBBBBBBBBB(ClassExtendsClass _this,
			IsApplicableMatch isApplicableMatch, ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass,
			TClass tExtendedClass, TypeToTAbstractType eExtendedClassToTExtendedClass,
			TypeToTAbstractType eClassDeclarationToTClass, TClass tClass, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, eClassDeclaration, eExtendedClass,
				tExtendedClass, eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eClassDeclaration, eExtendedClass, tExtendedClass,
					eExtendedClassToTExtendedClass, eClassDeclarationToTClass, tClass, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_29_6_perform_greenBBFBBB(ClassDeclaration eClassDeclaration,
		...
		return new Object[] { eClassDeclaration, eExtendedClass, eTypeAccess, tExtendedClass, tClass, ruleResult };
	}
