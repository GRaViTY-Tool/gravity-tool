...
public class AnonymousClassInTypeImpl extends AbstractRuleImpl implements AnonymousClassInType {
	...
	public boolean isAppropriate_FWD(Match match, MClassInstanceCreation mCreation, MDefinition mMember,
			AnonymousClassDeclaration mAnonymous, AbstractTypeDeclaration mType) {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = AnonymousClassInTypeImpl
				.pattern_AnonymousClassInType_1_1_performtransformation_greenBFBBBFB(tType, tPackage, pg, mAnonymous,
						csp);
		...
		Object[] result3_black = AnonymousClassInTypeImpl
				.pattern_AnonymousClassInType_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult, mMemberToTMember,
						mCreation, tType, tAnonymous, mTypeToTType, tPackage, tMember, pg, mMember, mAnonymous,
		...
		AnonymousClassInTypeImpl.pattern_AnonymousClassInType_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFFF(
				ruleresult, mCreation, tType, tAnonymous, tPackage, pg, mAnonymous, eAnonymousClassDeclarationToTClass);
		...
		AnonymousClassInTypeImpl.pattern_AnonymousClassInType_1_5_registerobjects_expressionBBBBBBBBBBBBBB(this,
				ruleresult, mMemberToTMember, mCreation, tType, tAnonymous, mTypeToTType, tPackage, tMember, pg,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnonymousClassInTypeImpl
			...
			for (Object[] result3_black : AnonymousClassInTypeImpl
					.pattern_AnonymousClassInType_2_3_findcontext_blackBBBBFBFBBB(mMemberToTMember, mCreation, tType,
							mTypeToTType, tMember, mMember, mAnonymous, mType)) {
				...
				Object[] result3_green = AnonymousClassInTypeImpl
						.pattern_AnonymousClassInType_2_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFFF(mMemberToTMember,
								mCreation, tType, mTypeToTType, tPackage, tMember, pg, mMember, mAnonymous, mType);
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, MClassInstanceCreation mCreation, MDefinition mMember,
			AnonymousClassDeclaration mAnonymous, AbstractTypeDeclaration mType) {// Create CSP
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			MClassInstanceCreation mCreation, TAbstractType tType, TypeToTAbstractType mTypeToTType, TPackage tPackage,
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TAbstractType tType, TClass tAnonymous, TPackage tPackage,
			TMember tMember, TypeGraph pg) {

		Object[] result1_black = AnonymousClassInTypeImpl
				.pattern_AnonymousClassInType_10_1_initialbindings_blackBBBBBBB(this, match, tType, tAnonymous,
						tPackage, tMember, pg);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = AnonymousClassInTypeImpl
				.pattern_AnonymousClassInType_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, tType, tAnonymous,
						tPackage, tMember, pg);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tType] = " + tType + ", " + "[tAnonymous] = " + tAnonymous + ", "
		...
		if (AnonymousClassInTypeImpl.pattern_AnonymousClassInType_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = AnonymousClassInTypeImpl
					.pattern_AnonymousClassInType_10_4_collectelementstobetranslated_blackBBBBBB(match, tType,
			...
			AnonymousClassInTypeImpl.pattern_AnonymousClassInType_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(
					match, tType, tAnonymous, tPackage, pg);
			...
			Object[] result5_black = AnonymousClassInTypeImpl
					.pattern_AnonymousClassInType_10_5_collectcontextelements_blackBBBBBB(match, tType, tAnonymous,
							tPackage, tMember, pg);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tType] = " + tType + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[tPackage] = "
			...
			AnonymousClassInTypeImpl.pattern_AnonymousClassInType_10_6_registerobjectstomatch_expressionBBBBBBB(this,
					match, tType, tAnonymous, tPackage, tMember, pg);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = AnonymousClassInTypeImpl
				.pattern_AnonymousClassInType_11_1_performtransformation_greenBBFF(mCreation, tAnonymous);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnonymousClassInTypeImpl
				.pattern_AnonymousClassInType_12_2_corematch_blackFBBFBBBFFB(tType, tAnonymous, tPackage, tMember, pg,
						match)) {
			MDefinitionToTMember mMemberToTMember = (MDefinitionToTMember) result2_black[0];
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[3];
			...
			// ForEach 
			for (Object[] result3_black : AnonymousClassInTypeImpl
					.pattern_AnonymousClassInType_12_3_findcontext_blackBFBBBBBBBB(mMemberToTMember, tType, tAnonymous,
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TAbstractType tType, TClass tAnonymous, TPackage tPackage,
			TMember tMember, TypeGraph pg) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TAbstractType tType, TClass tAnonymous, TPackage tPackage,
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			MClassInstanceCreation mCreation, TAbstractType tType, TClass tAnonymous, TypeToTAbstractType mTypeToTType,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_9(EMoflonEdge _edge_anonymousClassDeclaration) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnonymousClassInTypeImpl
				.pattern_AnonymousClassInType_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBBB(this, mCreation, tType,
		...
		if (AnonymousClassInTypeImpl.pattern_AnonymousClassInType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnonymousClassInTypeImpl
					.pattern_AnonymousClassInType_24_5_matchcorrcontext_blackFBFBBBBB(tType, tMember, mMember, mType,
				...
				Object[] result6_black = AnonymousClassInTypeImpl
						.pattern_AnonymousClassInType_24_6_createcorrespondence_blackBBBBBBBBBB(mCreation, tType,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MClassInstanceCreation mCreation, TAbstractType tType, TClass tAnonymous,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TAbstractType tType, TClass tAnonymous, TPackage tPackage, TMember tMember,
			TypeGraph pg) {// 
		Object[] result1_black = AnonymousClassInTypeImpl
				.pattern_AnonymousClassInType_28_1_matchtggpattern_blackBBBBB(tType, tAnonymous, tPackage, tMember, pg);
		if (result1_black != null) {
		...
		for (Object[] result2_black : AnonymousClassInTypeImpl
			...
			Object[] result3_bindingAndBlack = AnonymousClassInTypeImpl
					.pattern_AnonymousClassInType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this, isApplicableMatch,
							mMemberToTMember, mCreation, tType, mTypeToTType, tPackage, tMember, pg, mMember, mType,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mMemberToTMember] = "
			...
			if (AnonymousClassInTypeImpl.pattern_AnonymousClassInType_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = AnonymousClassInTypeImpl
						.pattern_AnonymousClassInType_29_5_checknacs_blackBBBBBBBBB(mMemberToTMember, mCreation, tType,
								mTypeToTType, tPackage, tMember, pg, mMember, mType);
				if (result5_black != null) {
					...
					AnonymousClassInTypeImpl.pattern_AnonymousClassInType_29_6_perform_greenBBFBBFFBB(mCreation, tType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPROPRIATE_FWD__MATCH_MCLASSINSTANCECREATION_MDEFINITION_ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION:
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MCLASSINSTANCECREATION_MDEFINITION_ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (MClassInstanceCreation) arguments.get(1),
					(MDefinition) arguments.get(2), (AnonymousClassDeclaration) arguments.get(3),
					(AbstractTypeDeclaration) arguments.get(4));
			return null;
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MCLASSINSTANCECREATION_MDEFINITION_ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION:
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_MCLASSINSTANCECREATION_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TPACKAGE_TMEMBER_TYPEGRAPH_MDEFINITION_ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION:
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPROPRIATE_BWD__MATCH_TABSTRACTTYPE_TCLASS_TPACKAGE_TMEMBER_TYPEGRAPH:
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TABSTRACTTYPE_TCLASS_TPACKAGE_TMEMBER_TYPEGRAPH:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TAbstractType) arguments.get(1),
					(TClass) arguments.get(2), (TPackage) arguments.get(3), (TMember) arguments.get(4),
					(TypeGraph) arguments.get(5));
			return null;
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TABSTRACTTYPE_TCLASS_TPACKAGE_TMEMBER_TYPEGRAPH:
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_MCLASSINSTANCECREATION_TABSTRACTTYPE_TCLASS_TYPETOTABSTRACTTYPE_TPACKAGE_TMEMBER_TYPEGRAPH_MDEFINITION_ABSTRACTTYPEDECLARATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (MClassInstanceCreation) arguments.get(2),
					(TAbstractType) arguments.get(3), (TClass) arguments.get(4), (TypeToTAbstractType) arguments.get(5),
					(TPackage) arguments.get(6), (TMember) arguments.get(7), (TypeGraph) arguments.get(8),
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_8__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_8((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_9__EMOFLONEDGE:
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__MCLASSINSTANCECREATION_TABSTRACTTYPE_TCLASS_TPACKAGE_TMEMBER_TYPEGRAPH_MDEFINITION_ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MClassInstanceCreation) arguments.get(0), (TAbstractType) arguments.get(1),
					(TClass) arguments.get(2), (TPackage) arguments.get(3), (TMember) arguments.get(4),
					(TypeGraph) arguments.get(5), (MDefinition) arguments.get(6),
					(AnonymousClassDeclaration) arguments.get(7), (AbstractTypeDeclaration) arguments.get(8),
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___CHECK_DEC_FWD__MCLASSINSTANCECREATION_MDEFINITION_ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION:
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___CHECK_DEC_BWD__TABSTRACTTYPE_TCLASS_TPACKAGE_TMEMBER_TYPEGRAPH:
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_MCLASSINSTANCECREATION_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_TPACKAGE_TMEMBER_TYPEGRAPH_MDEFINITION_ABSTRACTTYPEDECLARATION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_AnonymousClassInType_0_4_collectelementstobetranslated_greenBBBFF(Match match,
			MClassInstanceCreation mCreation, AnonymousClassDeclaration mAnonymous) {
	...
	public static final Object[] pattern_AnonymousClassInType_1_1_performtransformation_blackBBBBBBBBBBFBB(
			MDefinitionToTMember mMemberToTMember, MClassInstanceCreation mCreation, TAbstractType tType,
			TypeToTAbstractType mTypeToTType, TPackage tPackage, TMember tMember, TypeGraph pg, MDefinition mMember,
			AnonymousClassDeclaration mAnonymous, AbstractTypeDeclaration mType, AnonymousClassInType _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_AnonymousClassInType_1_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_AnonymousClassInType_1_1_performtransformation_binding != null) {
			...
			TAbstractType tType = (TAbstractType) result_pattern_AnonymousClassInType_1_1_performtransformation_binding[2];
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_AnonymousClassInType_1_1_performtransformation_binding[3];
			...
			AnonymousClassDeclaration mAnonymous = (AnonymousClassDeclaration) result_pattern_AnonymousClassInType_1_1_performtransformation_binding[8];
	...
	public static final Object[] pattern_AnonymousClassInType_1_1_performtransformation_greenBFBBBFB(
			TAbstractType tType, TPackage tPackage, TypeGraph pg, AnonymousClassDeclaration mAnonymous, CSP csp) {
		...
		for (MDefinitionToTMember mMemberToTMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tType != null) {
						_result.add(new Object[] { mMemberToTMember, mCreation, tType, mTypeToTType, tMember, mMember,
	...
	public static final Iterable<Object[]> pattern_AnonymousClassInType_2_3_findcontext_blackBBBBFBFBBB(
			MDefinitionToTMember mMemberToTMember, MClassInstanceCreation mCreation, TAbstractType tType,
			TypeToTAbstractType mTypeToTType, TMember tMember, MDefinition mMember,
			AnonymousClassDeclaration mAnonymous, AbstractTypeDeclaration mType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
								...
								if (tMember.equals(mMemberToTMember.getTarget())) {
									if (mType.equals(mTypeToTType.getSource())) {
										...
										if (tPackage != null) {
											...
											if (pg != null) {
												_result.add(
														new Object[] { mMemberToTMember, mCreation, tType, mTypeToTType,
																tPackage, tMember, pg, mMember, mAnonymous, mType });
											}
	...
	public static final Object[] pattern_AnonymousClassInType_10_1_initialbindings_blackBBBBBBB(
			AnonymousClassInType _this, Match match, TAbstractType tType, TClass tAnonymous, TPackage tPackage,
			TMember tMember, TypeGraph pg) {
		if (!tAnonymous.equals(tType)) {
	...
	public static final Object[] pattern_AnonymousClassInType_10_2_SolveCSP_bindingFBBBBBBB(AnonymousClassInType _this,
			Match match, TAbstractType tType, TClass tAnonymous, TPackage tPackage, TMember tMember, TypeGraph pg) {
	...
	public static final Object[] pattern_AnonymousClassInType_10_5_collectcontextelements_blackBBBBBB(Match match,
			TAbstractType tType, TClass tAnonymous, TPackage tPackage, TMember tMember, TypeGraph pg) {
		if (!tAnonymous.equals(tType)) {
			return new Object[] { match, tType, tAnonymous, tPackage, tMember, pg };
		}
		return null;
	...
	public static final Object[] pattern_AnonymousClassInType_11_1_performtransformation_blackBBBBBBBBBBFBB(
			MDefinitionToTMember mMemberToTMember, MClassInstanceCreation mCreation, TAbstractType tType,
			TClass tAnonymous, TypeToTAbstractType mTypeToTType, TPackage tPackage, TMember tMember, TypeGraph pg,
	...
	public static final Object[] pattern_AnonymousClassInType_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_AnonymousClassInType_11_1_performtransformation_binding != null) {
			...
			TAbstractType tType = (TAbstractType) result_pattern_AnonymousClassInType_11_1_performtransformation_binding[2];
			TClass tAnonymous = (TClass) result_pattern_AnonymousClassInType_11_1_performtransformation_binding[3];
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_AnonymousClassInType_11_1_performtransformation_binding[4];
	...
	public static final Object[] pattern_AnonymousClassInType_11_1_performtransformation_greenBBFF(
	...
	public static final Iterable<Object[]> pattern_AnonymousClassInType_12_2_corematch_blackFBBFBBBFFB(
			TAbstractType tType, TClass tAnonymous, TPackage tPackage, TMember tMember, TypeGraph pg, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tAnonymous.equals(tType)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_AnonymousClassInType_12_3_findcontext_blackBFBBBBBBBB(
			MDefinitionToTMember mMemberToTMember, TAbstractType tType, TClass tAnonymous,
			TypeToTAbstractType mTypeToTType, TPackage tPackage, TMember tMember, TypeGraph pg, MDefinition mMember,
			AbstractTypeDeclaration mType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tAnonymous.equals(tType)) {
	...
	public static final Object[] pattern_AnonymousClassInType_20_2_testcorematchandDECs_black_nac_0BB(TClass tAnonymous,
			TPackage tPackage) {
		for (TPackage __DEC_tAnonymous_classes_404233 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tAnonymous_classes_404233)) {
	...
	public static final Object[] pattern_AnonymousClassInType_20_2_testcorematchandDECs_black_nac_1BB(TClass tAnonymous,
			TypeGraph pg) {
		for (TypeGraph __DEC_tAnonymous_classes_956549 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tAnonymous_classes_956549)) {
	...
	public static final Object[] pattern_AnonymousClassInType_20_2_testcorematchandDECs_black_nac_2BB(TClass tAnonymous,
			TAbstractType tType) {
		if (!tAnonymous.equals(tType)) {
			TAbstractType __DEC_tAnonymous_innerTypes_694112 = tAnonymous.getOuterType();
			if (__DEC_tAnonymous_innerTypes_694112 != null) {
				if (!tAnonymous.equals(__DEC_tAnonymous_innerTypes_694112)) {
					if (!tType.equals(__DEC_tAnonymous_innerTypes_694112)) {
	...
	public static final Object[] pattern_AnonymousClassInType_20_2_testcorematchandDECs_black_nac_3BB(TClass tAnonymous,
			TPackage tPackage) {
		TPackage __DEC_tAnonymous_allTypes_563288 = tAnonymous.getPackage();
		if (__DEC_tAnonymous_allTypes_563288 != null) {
			if (!tPackage.equals(__DEC_tAnonymous_allTypes_563288)) {
				return new Object[] { tAnonymous, tPackage };
			}
		}
	...
	public static final Object[] pattern_AnonymousClassInType_21_2_testcorematchandDECs_black_nac_0B(
			AnonymousClassDeclaration mAnonymous) {
		for (EnumConstantDeclaration __DEC_mAnonymous_anonymousClassDeclaration_924557 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnonymousClassInType_24_2_matchsrctrgcontext_blackBBBBBBBBBBB(
			MClassInstanceCreation mCreation, TAbstractType tType, TClass tAnonymous, TPackage tPackage,
			TMember tMember, TypeGraph pg, MDefinition mMember, AnonymousClassDeclaration mAnonymous,
	...
	public static final Object[] pattern_AnonymousClassInType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_AnonymousClassInType_24_2_matchsrctrgcontext_binding != null) {
			...
			TAbstractType tType = (TAbstractType) result_pattern_AnonymousClassInType_24_2_matchsrctrgcontext_binding[1];
			TClass tAnonymous = (TClass) result_pattern_AnonymousClassInType_24_2_matchsrctrgcontext_binding[2];
			...
			AnonymousClassDeclaration mAnonymous = (AnonymousClassDeclaration) result_pattern_AnonymousClassInType_24_2_matchsrctrgcontext_binding[7];
	...
	public static final Object[] pattern_AnonymousClassInType_24_3_solvecsp_bindingFBBBBBBBBBBBB(
			AnonymousClassInType _this, MClassInstanceCreation mCreation, TAbstractType tType, TClass tAnonymous,
			TPackage tPackage, TMember tMember, TypeGraph pg, MDefinition mMember, AnonymousClassDeclaration mAnonymous,
			AbstractTypeDeclaration mType, Match sourceMatch, Match targetMatch) {
	...
	public static final Iterable<Object[]> pattern_AnonymousClassInType_24_5_matchcorrcontext_blackFBFBBBBB(
	...
	public static final Object[] pattern_AnonymousClassInType_27_1_matchtggpattern_black_nac_0B(
			AnonymousClassDeclaration mAnonymous) {
		for (EnumConstantDeclaration __DEC_mAnonymous_anonymousClassDeclaration_263214 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAnonymous, EnumConstantDeclaration.class, "anonymousClassDeclaration")) {
			return new Object[] { mAnonymous };
		}
		return null;
	...
	public static final Object[] pattern_AnonymousClassInType_28_1_matchtggpattern_black_nac_0BB(TClass tAnonymous,
			TPackage tPackage) {
		for (TPackage __DEC_tAnonymous_classes_369336 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tAnonymous_classes_369336)) {
				return new Object[] { tAnonymous, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnonymousClassInType_28_1_matchtggpattern_black_nac_1BB(TClass tAnonymous,
			TypeGraph pg) {
		for (TypeGraph __DEC_tAnonymous_classes_189529 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tAnonymous_classes_189529)) {
				return new Object[] { tAnonymous, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnonymousClassInType_28_1_matchtggpattern_black_nac_2BB(TClass tAnonymous,
			TAbstractType tType) {
		if (!tAnonymous.equals(tType)) {
			TAbstractType __DEC_tAnonymous_innerTypes_733183 = tAnonymous.getOuterType();
			if (__DEC_tAnonymous_innerTypes_733183 != null) {
				if (!tAnonymous.equals(__DEC_tAnonymous_innerTypes_733183)) {
					if (!tType.equals(__DEC_tAnonymous_innerTypes_733183)) {
						return new Object[] { tAnonymous, tType };
					}
				}
			}
	...
	public static final Object[] pattern_AnonymousClassInType_28_1_matchtggpattern_black_nac_3BB(TClass tAnonymous,
			TPackage tPackage) {
		TPackage __DEC_tAnonymous_allTypes_126802 = tAnonymous.getPackage();
		if (__DEC_tAnonymous_allTypes_126802 != null) {
			if (!tPackage.equals(__DEC_tAnonymous_allTypes_126802)) {
				return new Object[] { tAnonymous, tPackage };
			}
		}
	...
	public static final Object[] pattern_AnonymousClassInType_28_1_matchtggpattern_blackBBBBB(TAbstractType tType,
	...
	public static final Object[] pattern_AnonymousClassInType_29_6_perform_greenBBFBBFFBB(
