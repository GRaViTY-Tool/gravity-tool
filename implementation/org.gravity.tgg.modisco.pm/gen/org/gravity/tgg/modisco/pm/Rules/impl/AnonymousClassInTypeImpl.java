...
public class AnonymousClassInTypeImpl extends AbstractRuleImpl implements AnonymousClassInType {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_69(EMoflonEdge _edge_ownedTypes) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_69__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_69((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANONYMOUS_CLASS_IN_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_72__EMOFLONEDGE:
	...
	public static final Object[] pattern_AnonymousClassInType_20_2_testcorematchandDECs_black_nac_0BB(TClass tAnonymous,
			TPackage tPackage) {
		for (TPackage __DEC_tAnonymous_classes_167853 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tAnonymous_classes_167853)) {
	...
	public static final Object[] pattern_AnonymousClassInType_20_2_testcorematchandDECs_black_nac_1BB(TClass tAnonymous,
			TypeGraph pg) {
		for (TypeGraph __DEC_tAnonymous_classes_554433 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tAnonymous_classes_554433)) {
	...
	public static final Object[] pattern_AnonymousClassInType_20_2_testcorematchandDECs_black_nac_2BB(TClass tAnonymous,
			TAbstractType tType) {
		if (!tAnonymous.equals(tType)) {
			TAbstractType __DEC_tAnonymous_innerTypes_289396 = tAnonymous.getOuterType();
			if (__DEC_tAnonymous_innerTypes_289396 != null) {
				if (!tAnonymous.equals(__DEC_tAnonymous_innerTypes_289396)) {
					if (!tType.equals(__DEC_tAnonymous_innerTypes_289396)) {
													...
													if (pattern_AnonymousClassInType_20_2_testcorematchandDECs_black_nac_1BB(
														...
														if (pattern_AnonymousClassInType_20_2_testcorematchandDECs_black_nac_2BB(
															...
															for (TMember tMember : tType.getDefines()) {
																_result.add(new Object[] { tType, tAnonymous, tMember,
																		tPackage, pg, _edge_ownedTypes });
															}
														}
													}
												}
	...
	public static final Object[] pattern_AnonymousClassInType_28_1_matchtggpattern_black_nac_0BB(TClass tAnonymous,
			TPackage tPackage) {
		for (TPackage __DEC_tAnonymous_classes_533458 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tAnonymous_classes_533458)) {
				return new Object[] { tAnonymous, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnonymousClassInType_28_1_matchtggpattern_black_nac_1BB(TClass tAnonymous,
			TypeGraph pg) {
		for (TypeGraph __DEC_tAnonymous_classes_33250 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tAnonymous, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tAnonymous_classes_33250)) {
				return new Object[] { tAnonymous, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnonymousClassInType_28_1_matchtggpattern_black_nac_2BB(TClass tAnonymous,
			TAbstractType tType) {
		if (!tAnonymous.equals(tType)) {
			TAbstractType __DEC_tAnonymous_innerTypes_369374 = tAnonymous.getOuterType();
			if (__DEC_tAnonymous_innerTypes_369374 != null) {
				if (!tAnonymous.equals(__DEC_tAnonymous_innerTypes_369374)) {
					if (!tType.equals(__DEC_tAnonymous_innerTypes_369374)) {
						return new Object[] { tAnonymous, tType };
					}
				}
			}
