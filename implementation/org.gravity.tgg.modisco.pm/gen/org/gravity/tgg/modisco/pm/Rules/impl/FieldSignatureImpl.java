...
public class FieldSignatureImpl extends AbstractRuleImpl implements FieldSignature {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FieldSignatureImpl
				.pattern_FieldSignature_1_1_performtransformation_greenBBBFFFB(tAbstractType, mSignature, tField, csp);
		...
		Object[] result3_black = FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField, mTypeToTType, tField,
				mType, tSignature, mFlowElementToTFlowElement, mSignatureToTSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mSignature] = " + mSignature + ", "
					+ "[mFieldName] = " + mFieldName + ", " + "[eFieldDeclarationToTField] = "
					+ eFieldDeclarationToTField + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tField] = "
					+ tField + ", " + "[mType] = " + mType + ", " + "[tSignature] = " + tSignature + ", "
		...
		FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(ruleresult,
				tAbstractType, mSignature, mFieldName, tField, mType, tSignature, mFlowElementToTFlowElement,
		...
		FieldSignatureImpl.pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField, mTypeToTType, tField, mType,
				tSignature, mFlowElementToTFlowElement, mSignatureToTSignature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl.pattern_FieldSignature_2_2_corematch_blackFBBFFFBB(mSignature,
			...
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_2_3_findcontext_blackBBBBBBB(
				...
				Object[] result4_bindingAndBlack = FieldSignatureImpl
						.pattern_FieldSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField, mTypeToTType, tField,
								mType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			MFieldSignature mSignature, MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField,
			TypeToTAbstractType mTypeToTType, TField tField, Type mType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tAbstractType, EObject mSignature,
			EObject mFieldName, EObject eFieldDeclarationToTField, EObject mTypeToTType, EObject tField, EObject mType,
			EObject tSignature, EObject mFlowElementToTFlowElement, EObject mSignatureToTSignature) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FieldSignatureImpl
				.pattern_FieldSignature_11_1_performtransformation_greenFBBBFF(mFieldName, mType, tSignature);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl
				.pattern_FieldSignature_12_2_corematch_blackBFFFBFBB(tAbstractType, tField, tSignature, match)) {
			...
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_12_3_findcontext_blackBBBBBBB(
					tAbstractType, mFieldName, eFieldDeclarationToTField, mTypeToTType, tField, mType, tSignature)) {
				Object[] result3_green = FieldSignatureImpl
						.pattern_FieldSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(tAbstractType, mFieldName,
								eFieldDeclarationToTField, mTypeToTType, tField, mType, tSignature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = FieldSignatureImpl
						.pattern_FieldSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAbstractType, mFieldName, eFieldDeclarationToTField, mTypeToTType, tField, mType,
								tSignature);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tAbstractType] = " + tAbstractType
							...
							+ "[tField] = " + tField + ", " + "[mType] = " + mType + ", " + "[tSignature] = "
							+ tSignature + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			...
			TField tField, Type mType, TFieldSignature tSignature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tAbstractType, EObject mSignature,
			EObject mFieldName, EObject eFieldDeclarationToTField, EObject mTypeToTType, EObject tField, EObject mType,
			EObject tSignature, EObject mFlowElementToTFlowElement, EObject mSignatureToTSignature) {
		ruleresult.registerObject("tAbstractType", tAbstractType);
		ruleresult.registerObject("mSignature", mSignature);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_40(EMoflonEdge _edge_type) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_41(EMoflonEdge _edge_mSignatures) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = FieldSignatureImpl
				.pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAbstractType, mSignature,
						mFieldName, tField, mType, tSignature, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tAbstractType] = " + tAbstractType + ", " + "[mSignature] = " + mSignature + ", "
					+ "[mFieldName] = " + mFieldName + ", " + "[tField] = " + tField + ", " + "[mType] = " + mType
		...
		if (FieldSignatureImpl.pattern_FieldSignature_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldSignatureImpl.pattern_FieldSignature_24_5_matchcorrcontext_blackBBFFBBBB(
				...
				Object[] result6_black = FieldSignatureImpl
						.pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(tAbstractType, mSignature,
								mFieldName, tField, mType, tSignature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAbstractType] = "
							+ tAbstractType + ", " + "[mSignature] = " + mSignature + ", " + "[mFieldName] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAbstractType tAbstractType, MFieldSignature mSignature, MFieldName mFieldName,
			TField tField, Type mType, TFieldSignature tSignature, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : FieldSignatureImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ ", " + "[mFieldName] = " + mFieldName + ", " + "[eFieldDeclarationToTField] = "
						+ eFieldDeclarationToTField + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tField] = "
						+ tField + ", " + "[mType] = " + mType + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (FieldSignatureImpl.pattern_FieldSignature_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					FieldSignatureImpl.pattern_FieldSignature_29_6_perform_greenBFBBBFFFBB(tAbstractType, mFieldName,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_MFIELDSIGNATURE_MFIELDNAME_MFIELDNAMETOTFIELD_TYPETOTABSTRACTTYPE_TFIELD_TYPE:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TAbstractType) arguments.get(1),
						...
						(MFieldNameToTField) arguments.get(4), (TypeToTAbstractType) arguments.get(5),
						(TField) arguments.get(6), (Type) arguments.get(7));
			...
			case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_MFIELDNAME_MFIELDNAMETOTFIELD_TYPETOTABSTRACTTYPE_TFIELD_TYPE_TFIELDSIGNATURE:
			...
			case RulesPackage.FIELD_SIGNATURE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_40__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_40((EMoflonEdge) arguments.get(0));
			case RulesPackage.FIELD_SIGNATURE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_41__EMOFLONEDGE:
			...
			case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_CC__TABSTRACTTYPE_MFIELDSIGNATURE_MFIELDNAME_TFIELD_TYPE_TFIELDSIGNATURE_MATCH_MATCH:
				return isApplicable_solveCsp_CC((TAbstractType) arguments.get(0), (MFieldSignature) arguments.get(1),
			...
			case RulesPackage.FIELD_SIGNATURE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_MFIELDNAME_MFIELDNAMETOTFIELD_TYPETOTABSTRACTTYPE_TFIELD_TYPE_MODELGENERATORRULERESULT:
				return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
						(TAbstractType) arguments.get(1), (MFieldName) arguments.get(2),
						(MFieldNameToTField) arguments.get(3), (TypeToTAbstractType) arguments.get(4),
						(TField) arguments.get(5), (Type) arguments.get(6),
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpTField instanceof TField) {
								...
								if (tmpMType instanceof Type) {
									...
									return new Object[] { tAbstractType, mSignature, mFieldName,
											eFieldDeclarationToTField, mTypeToTType, tField, mType, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_blackBBBBBBBFBB(
			...
			MFieldNameToTField eFieldDeclarationToTField, TypeToTAbstractType mTypeToTType, TField tField, Type mType,
			FieldSignature _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField, mTypeToTType,
						tField, mType, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_greenBBBFFFB(
		...
		return new Object[] { tAbstractType, mSignature, tField, tSignature, mFlowElementToTFlowElement,
				mSignatureToTSignature, csp };
	}

	public static final Object[] pattern_FieldSignature_1_2_collecttranslatedelements_blackBBBB(
			MFieldSignature mSignature, TFieldSignature tSignature,
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tAbstractType, EObject mSignature, EObject mFieldName,
			EObject eFieldDeclarationToTField, EObject mTypeToTType, EObject tField, EObject mType, EObject tSignature,
			EObject mFlowElementToTFlowElement, EObject mSignatureToTSignature) {
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tAbstractType, EObject mSignature, EObject mFieldName, EObject tField,
			EObject mType, EObject tSignature, EObject mFlowElementToTFlowElement, EObject mSignatureToTSignature) {
		EMoflonEdge mFieldName__mSignature____mSignatures = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, tAbstractType, mSignature, mFieldName, tField, mType, tSignature,
				mFlowElementToTFlowElement, mSignatureToTSignature, mFieldName__mSignature____mSignatures,
				mFlowElementToTFlowElement__mSignature____source, mFlowElementToTFlowElement__tSignature____target,
				mSignature__mType____type, tSignature__tAbstractType____type, tField__tSignature____signatures,
	...
	public static final void pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject eFieldDeclarationToTField, EObject mTypeToTType, EObject tField, EObject mType, EObject tSignature,
			EObject mFlowElementToTFlowElement, EObject mSignatureToTSignature) {
		_this.registerObjects_FWD(ruleresult, tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField,
				mTypeToTType, tField, mType, tSignature, mFlowElementToTFlowElement, mSignatureToTSignature);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_2_2_corematch_blackFBBFFFBB(
			...
			if (tField != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAbstractType != null) {
						_result.add(new Object[] { tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField,
								mTypeToTType, tField, mType, match });
					}
					...
					if (mType.equals(mTypeToTType.getSource())) {
						if (mType.equals(mSignature.getType())) {
							if (tField.equals(eFieldDeclarationToTField.getTarget())) {
								_result.add(new Object[] { tAbstractType, mSignature, mFieldName,
										eFieldDeclarationToTField, mTypeToTType, tField, mType });
							}
						}
					}
				}
	...
	public static final Object[] pattern_FieldSignature_2_3_findcontext_greenBBBBBBBFFFFFFF(TAbstractType tAbstractType,
			MFieldSignature mSignature, MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField,
			TypeToTAbstractType mTypeToTType, TField tField, Type mType) {
		...
		return new Object[] { tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField, mTypeToTType, tField,
				mType, isApplicableMatch, mFieldName__mSignature____mSignatures,
				eFieldDeclarationToTField__mFieldName____source, mTypeToTType__tAbstractType____target,
				mTypeToTType__mType____source, mSignature__mType____type, eFieldDeclarationToTField__tField____target };
	}

	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType, MFieldSignature mSignature,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, TypeToTAbstractType mTypeToTType,
			TField tField, Type mType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tAbstractType, mSignature, mFieldName,
				eFieldDeclarationToTField, mTypeToTType, tField, mType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mSignature, mFieldName,
					eFieldDeclarationToTField, mTypeToTType, tField, mType };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_2_4_solveCSP_binding = pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField,
				mTypeToTType, tField, mType);
							...
							if (tmpMType instanceof Type) {
								...
								if (tmpTSignature instanceof TFieldSignature) {
									...
									return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField,
											mTypeToTType, tField, mType, tSignature, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_blackBBBBBBBFBB(
			...
			TypeToTAbstractType mTypeToTType, TField tField, Type mType, TFieldSignature tSignature,
			FieldSignature _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mTypeToTType, tField, mType,
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_greenFBBBFF(MFieldName mFieldName,
		...
		mSignatureToTSignature.setTarget(tSignature);
		mSignatureToTSignature.setSource(mSignature);
		return new Object[] { mSignature, mFieldName, mType, tSignature, mFlowElementToTFlowElement,
				mSignatureToTSignature };
	}
	...
	public static final void pattern_FieldSignature_11_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject eFieldDeclarationToTField, EObject mTypeToTType, EObject tField, EObject mType, EObject tSignature,
			EObject mFlowElementToTFlowElement, EObject mSignatureToTSignature) {
		_this.registerObjects_BWD(ruleresult, tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField,
				mTypeToTType, tField, mType, tSignature, mFlowElementToTFlowElement, mSignatureToTSignature);
					...
					for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mFieldName != null) {
							_result.add(new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField,
									mTypeToTType, tField, mType, tSignature, match });
						}
					...
					if (tAbstractType.equals(tSignature.getType())) {
						if (tField.getSignatures().contains(tSignature)) {
							if (tField.equals(eFieldDeclarationToTField.getTarget())) {
								...
								if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
									_result.add(new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField,
											mTypeToTType, tField, mType, tSignature });
								}
	...
	public static final Object[] pattern_FieldSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		eFieldDeclarationToTField__tField____target.setName(eFieldDeclarationToTField__tField____target_name_prime);
		return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mTypeToTType, tField, mType,
				tSignature, isApplicableMatch, eFieldDeclarationToTField__mFieldName____source,
				mTypeToTType__tAbstractType____target, mTypeToTType__mType____source, tSignature__tAbstractType____type,
				tField__tSignature____signatures, tSignature__tField____field,
	...
	public static final Object[] pattern_FieldSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_12_4_solveCSP_binding = pattern_FieldSignature_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAbstractType, mFieldName, eFieldDeclarationToTField, mTypeToTType, tField,
				mType, tSignature);
	...
	public static final Object[] pattern_FieldSignature_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TField __DEC_tSignature_field_64324 = tSignature.getField();
		if (__DEC_tSignature_field_64324 != null) {
			if (!tField.equals(__DEC_tSignature_field_64324)) {
				...
				if (tmpMFieldName instanceof MFieldName) {
					...
					if (tmpTField instanceof TField) {
						...
						if (tmpMType instanceof Type) {
							...
							if (tmpTSignature instanceof TFieldSignature) {
								TFieldSignature tSignature = (TFieldSignature) tmpTSignature;
								return new Object[] { tAbstractType, mSignature, mFieldName, tField, mType, tSignature,
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TAbstractType tAbstractType, MFieldSignature mSignature, MFieldName mFieldName, TField tField, Type mType,
			TFieldSignature tSignature, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			int tSignature_lowerBound = tSignature.getLowerBound();
			if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
				return new Object[] { tAbstractType, mSignature, mFieldName, tField, mType, tSignature, sourceMatch,
						targetMatch };
			}
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_FieldSignature_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_FieldSignature_24_2_matchsrctrgcontext_black = pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAbstractType, mSignature, mFieldName, tField, mType, tSignature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(FieldSignature _this,
			TAbstractType tAbstractType, MFieldSignature mSignature, MFieldName mFieldName, TField tField, Type mType,
			TFieldSignature tSignature, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tAbstractType, mSignature, mFieldName, tField, mType,
				tSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tAbstractType, mSignature, mFieldName, tField, mType, tSignature,
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_24_3_solvecsp_binding = pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAbstractType, mSignature, mFieldName, tField, mType, tSignature, sourceMatch, targetMatch);
			...
			for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tField.equals(eFieldDeclarationToTField.getTarget())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mType.equals(mTypeToTType.getSource())) {
							_result.add(new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField,
									mTypeToTType, tField, mType, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tAbstractType, mSignature, mFieldName, tField, mType, tSignature, ccMatch };
	}
	...
	public static final Object[] pattern_FieldSignature_28_1_matchtggpattern_black_nac_0BB(TFieldSignature tSignature,
			TField tField) {
		TField __DEC_tSignature_field_59676 = tSignature.getField();
		if (__DEC_tSignature_field_59676 != null) {
			if (!tField.equals(__DEC_tSignature_field_59676)) {
				return new Object[] { tSignature, tField };
			}
		}
	...
	public static final Object[] pattern_FieldSignature_29_3_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tAbstractType, mFieldName,
				eFieldDeclarationToTField, mTypeToTType, tField, mType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mFieldName, eFieldDeclarationToTField,
					mTypeToTType, tField, mType, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_29_6_perform_greenBFBBBFFFBB(TAbstractType tAbstractType,
		...
		return new Object[] { tAbstractType, mSignature, mFieldName, tField, mType, tSignature,
				mFlowElementToTFlowElement, mSignatureToTSignature, ruleResult, csp };
	}
