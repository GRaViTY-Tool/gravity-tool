...
public class FieldSignatureImpl extends AbstractRuleImpl implements FieldSignature {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FieldSignatureImpl
				.pattern_FieldSignature_1_1_performtransformation_greenFBFFBBB(tField, mSignature, tAbstractType, csp);
		...
		Object[] result3_black = FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, mType, mTypeToTType, mSignatureToTSignature, tField, mFieldName, tSignature,
				mFlowElementToTFlowElement, mSignature, eFieldDeclarationToTField, tAbstractType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mType] = " + mType + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
					+ "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[tField] = " + tField + ", "
					+ "[mFieldName] = " + mFieldName + ", " + "[tSignature] = " + tSignature + ", "
					+ "[mFlowElementToTFlowElement] = " + mFlowElementToTFlowElement + ", " + "[mSignature] = "
					+ mSignature + ", " + "[eFieldDeclarationToTField] = " + eFieldDeclarationToTField + ", "
		...
		FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(ruleresult, mType,
				mSignatureToTSignature, tField, mFieldName, tSignature, mFlowElementToTFlowElement, mSignature,
				tAbstractType);
		...
		FieldSignatureImpl.pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, mType,
				mTypeToTType, mSignatureToTSignature, tField, mFieldName, tSignature, mFlowElementToTFlowElement,
				mSignature, eFieldDeclarationToTField, tAbstractType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl.pattern_FieldSignature_2_2_corematch_blackBFFBBFFB(mType,
			...
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_2_3_findcontext_blackBBBBBBB(mType,
					mTypeToTType, tField, mFieldName, mSignature, eFieldDeclarationToTField, tAbstractType)) {
				Object[] result3_green = FieldSignatureImpl.pattern_FieldSignature_2_3_findcontext_greenBBBBBBBFFFFFFF(
						mType, mTypeToTType, tField, mFieldName, mSignature, eFieldDeclarationToTField, tAbstractType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Type mType,
			TypeToTAbstractType mTypeToTType, TField tField, MFieldName mFieldName, MFieldSignature mSignature,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType,
			EObject mSignatureToTSignature, EObject tField, EObject mFieldName, EObject tSignature,
			EObject mFlowElementToTFlowElement, EObject mSignature, EObject eFieldDeclarationToTField,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl.pattern_FieldSignature_12_2_corematch_blackFFBFBFBB(tField,
			...
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_12_3_findcontext_blackBBBBBBB(mType,
					mTypeToTType, tField, mFieldName, tSignature, eFieldDeclarationToTField, tAbstractType)) {
				Object[] result3_green = FieldSignatureImpl
						.pattern_FieldSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(mType, mTypeToTType, tField,
								mFieldName, tSignature, eFieldDeclarationToTField, tAbstractType);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Type mType,
			TypeToTAbstractType mTypeToTType, TField tField, MFieldName mFieldName, TFieldSignature tSignature,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_11(EMoflonEdge _edge_mSignatures) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = FieldSignatureImpl
				.pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mType, tField, mFieldName,
						tSignature, mSignature, tAbstractType, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mType] = " + mType + ", " + "[tField] = " + tField + ", " + "[mFieldName] = " + mFieldName
		...
		if (FieldSignatureImpl.pattern_FieldSignature_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldSignatureImpl.pattern_FieldSignature_24_5_matchcorrcontext_blackBFBBFBBB(
					mType, tField, mFieldName, tAbstractType, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = FieldSignatureImpl
						.pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(mType, tField, mFieldName,
								tSignature, mSignature, tAbstractType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mType] = " + mType + ", "
							+ "[tField] = " + tField + ", " + "[mFieldName] = " + mFieldName + ", " + "[tSignature] = "
							+ tSignature + ", " + "[mSignature] = " + mSignature + ", " + "[tAbstractType] = "
							+ tAbstractType + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				FieldSignatureImpl.pattern_FieldSignature_24_6_createcorrespondence_greenFBFBB(tSignature, mSignature,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Type mType, TField tField, MFieldName mFieldName, TFieldSignature tSignature,
			MFieldSignature mSignature, TAbstractType tAbstractType, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : FieldSignatureImpl
			...
			Object[] result3_bindingAndBlack = FieldSignatureImpl
					.pattern_FieldSignature_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mType,
							mTypeToTType, tField, mFieldName, eFieldDeclarationToTField, tAbstractType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mType] = " + mType + ", "
						+ "[mTypeToTType] = " + mTypeToTType + ", " + "[tField] = " + tField + ", " + "[mFieldName] = "
			...
			if (FieldSignatureImpl.pattern_FieldSignature_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = FieldSignatureImpl.pattern_FieldSignature_29_5_checknacs_blackBBBBBB(mType,
						mTypeToTType, tField, mFieldName, eFieldDeclarationToTField, tAbstractType);
				if (result5_black != null) {
					...
					FieldSignatureImpl.pattern_FieldSignature_29_6_perform_greenBFBBFFFBBB(mType, tField, mFieldName,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Type mType,
			TypeToTAbstractType mTypeToTType, TField tField, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPE_TYPETOTABSTRACTTYPE_TFIELD_MFIELDNAME_MFIELDSIGNATURE_MFIELDNAMETOTFIELD_TABSTRACTTYPE:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Type) arguments.get(1),
						(TypeToTAbstractType) arguments.get(2), (TField) arguments.get(3),
						(MFieldName) arguments.get(4), (MFieldSignature) arguments.get(5),
						(MFieldNameToTField) arguments.get(6), (TAbstractType) arguments.get(7));
			...
			case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPE_TYPETOTABSTRACTTYPE_TFIELD_MFIELDNAME_TFIELDSIGNATURE_MFIELDNAMETOTFIELD_TABSTRACTTYPE:
				return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Type) arguments.get(1),
						(TypeToTAbstractType) arguments.get(2), (TField) arguments.get(3),
						(MFieldName) arguments.get(4), (TFieldSignature) arguments.get(5),
						(MFieldNameToTField) arguments.get(6), (TAbstractType) arguments.get(7));
			...
			case RulesPackage.FIELD_SIGNATURE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_11__EMOFLONEDGE:
			...
			case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_CC__TYPE_TFIELD_MFIELDNAME_TFIELDSIGNATURE_MFIELDSIGNATURE_TABSTRACTTYPE_MATCH_MATCH:
				return isApplicable_solveCsp_CC((Type) arguments.get(0), (TField) arguments.get(1),
						(MFieldName) arguments.get(2), (TFieldSignature) arguments.get(3),
						(MFieldSignature) arguments.get(4), (TAbstractType) arguments.get(5), (Match) arguments.get(6),
			...
			case RulesPackage.FIELD_SIGNATURE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPE_TYPETOTABSTRACTTYPE_TFIELD_MFIELDNAME_MFIELDNAMETOTFIELD_TABSTRACTTYPE_MODELGENERATORRULERESULT:
						...
						if (tmpMSignature instanceof MFieldSignature) {
							...
							if (tmpEFieldDeclarationToTField instanceof MFieldNameToTField) {
								...
								if (tmpTAbstractType instanceof TAbstractType) {
									...
									return new Object[] { mType, mTypeToTType, tField, mFieldName, mSignature,
											eFieldDeclarationToTField, tAbstractType, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_blackBBBBBBBFBB(Type mType,
			TypeToTAbstractType mTypeToTType, TField tField, MFieldName mFieldName, MFieldSignature mSignature,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType, FieldSignature _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mTypeToTType, tField, mFieldName, mSignature, eFieldDeclarationToTField,
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_greenFBFFBBB(TField tField,
		...
		return new Object[] { mSignatureToTSignature, tField, tSignature, mFlowElementToTFlowElement, mSignature,
				tAbstractType, csp };
	}
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType, EObject mSignatureToTSignature,
			EObject tField, EObject mFieldName, EObject tSignature, EObject mFlowElementToTFlowElement,
			EObject mSignature, EObject eFieldDeclarationToTField, EObject tAbstractType) {
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mType, EObject mSignatureToTSignature, EObject tField,
			EObject mFieldName, EObject tSignature, EObject mFlowElementToTFlowElement, EObject mSignature,
			EObject tAbstractType) {
		EMoflonEdge mFieldName__mSignature____mSignatures = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mType, mSignatureToTSignature, tField, mFieldName, tSignature,
				mFlowElementToTFlowElement, mSignature, tAbstractType, mFieldName__mSignature____mSignatures,
				...
				tSignature__tField____field, mFlowElementToTFlowElement__tSignature____target,
				mSignature__mType____type, tSignature__tAbstractType____type };
	}
	...
	public static final void pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject tField, EObject mFieldName, EObject tSignature, EObject mFlowElementToTFlowElement,
			EObject mSignature, EObject eFieldDeclarationToTField, EObject tAbstractType) {
		_this.registerObjects_FWD(ruleresult, mType, mTypeToTType, mSignatureToTSignature, tField, mFieldName,
				tSignature, mFlowElementToTFlowElement, mSignature, eFieldDeclarationToTField, tAbstractType);
			...
			if (tField != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAbstractType != null) {
						_result.add(new Object[] { mType, mTypeToTType, tField, mFieldName, mSignature,
								eFieldDeclarationToTField, tAbstractType, match });
					}
					...
					if (mType.equals(mTypeToTType.getSource())) {
						if (tAbstractType.equals(mTypeToTType.getTarget())) {
							if (mType.equals(mSignature.getType())) {
								_result.add(new Object[] { mType, mTypeToTType, tField, mFieldName, mSignature,
										eFieldDeclarationToTField, tAbstractType });
							}
						}
					}
				}
	...
	public static final Object[] pattern_FieldSignature_2_3_findcontext_greenBBBBBBBFFFFFFF(Type mType,
		...
		mSignature__mType____type.setName(mSignature__mType____type_name_prime);
		return new Object[] { mType, mTypeToTType, tField, mFieldName, mSignature, eFieldDeclarationToTField,
				tAbstractType, isApplicableMatch, mFieldName__mSignature____mSignatures,
	...
	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			IsApplicableMatch isApplicableMatch, Type mType, TypeToTAbstractType mTypeToTType, TField tField,
			MFieldName mFieldName, MFieldSignature mSignature, MFieldNameToTField eFieldDeclarationToTField,
			TAbstractType tAbstractType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mType, mTypeToTType, tField,
				mFieldName, mSignature, eFieldDeclarationToTField, tAbstractType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, tField, mFieldName, mSignature,
					eFieldDeclarationToTField, tAbstractType };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_2_4_solveCSP_binding = pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, mTypeToTType, tField, mFieldName, mSignature,
				eFieldDeclarationToTField, tAbstractType);
		if (result_pattern_FieldSignature_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_FieldSignature_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, tField, mFieldName,
						mSignature, eFieldDeclarationToTField, tAbstractType };
			}
		}
		return null;
					...
					if (tmpMFieldName instanceof MFieldName) {
						...
						if (tmpTSignature instanceof TFieldSignature) {
							...
							if (tmpEFieldDeclarationToTField instanceof MFieldNameToTField) {
								...
								if (tmpTAbstractType instanceof TAbstractType) {
									TAbstractType tAbstractType = (TAbstractType) tmpTAbstractType;
									return new Object[] { mType, mTypeToTType, tField, mFieldName, tSignature,
											eFieldDeclarationToTField, tAbstractType, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_blackBBBBBBBFBB(Type mType,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mTypeToTType, tField, mFieldName, tSignature, eFieldDeclarationToTField,
						tAbstractType, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_FieldSignature_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldSignature_11_1_performtransformation_black = pattern_FieldSignature_11_1_performtransformation_blackBBBBBBBFBB(
					mType, mTypeToTType, tField, mFieldName, tSignature, eFieldDeclarationToTField, tAbstractType,
					_this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_greenBFBBFF(Type mType,
		...
		return new Object[] { mType, mSignatureToTSignature, mFieldName, tSignature, mFlowElementToTFlowElement,
				mSignature };
	}
	...
	public static final void pattern_FieldSignature_11_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject tField, EObject mFieldName, EObject tSignature, EObject mFlowElementToTFlowElement,
			EObject mSignature, EObject eFieldDeclarationToTField, EObject tAbstractType) {
		_this.registerObjects_BWD(ruleresult, mType, mTypeToTType, mSignatureToTSignature, tField, mFieldName,
				tSignature, mFlowElementToTFlowElement, mSignature, eFieldDeclarationToTField, tAbstractType);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_12_2_corematch_blackFFBFBFBB(TField tField,
			...
			for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mFieldName != null) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mType != null) {
							_result.add(new Object[] { mType, mTypeToTType, tField, mFieldName, tSignature,
									eFieldDeclarationToTField, tAbstractType, match });
						}
	...
	public static final Object[] pattern_FieldSignature_12_4_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			IsApplicableMatch isApplicableMatch, Type mType, TypeToTAbstractType mTypeToTType, TField tField,
			MFieldName mFieldName, TFieldSignature tSignature, MFieldNameToTField eFieldDeclarationToTField,
			TAbstractType tAbstractType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mType, mTypeToTType, tField,
				mFieldName, tSignature, eFieldDeclarationToTField, tAbstractType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, tField, mFieldName, tSignature,
					eFieldDeclarationToTField, tAbstractType };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_12_4_solveCSP_binding = pattern_FieldSignature_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, mTypeToTType, tField, mFieldName, tSignature,
				eFieldDeclarationToTField, tAbstractType);
		if (result_pattern_FieldSignature_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_FieldSignature_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, tField, mFieldName,
						tSignature, eFieldDeclarationToTField, tAbstractType };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TField __DEC_tSignature_field_23890 = tSignature.getField();
		if (__DEC_tSignature_field_23890 != null) {
			if (!tField.equals(__DEC_tSignature_field_23890)) {
				...
				if (tmpMFieldName instanceof MFieldName) {
					...
					if (tmpTSignature instanceof TFieldSignature) {
						...
						if (tmpMSignature instanceof MFieldSignature) {
							...
							if (tmpTAbstractType instanceof TAbstractType) {
								TAbstractType tAbstractType = (TAbstractType) tmpTAbstractType;
								return new Object[] { mType, tField, mFieldName, tSignature, mSignature, tAbstractType,
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(Type mType, TField tField,
			MFieldName mFieldName, TFieldSignature tSignature, MFieldSignature mSignature, TAbstractType tAbstractType,
			Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			int tSignature_lowerBound = tSignature.getLowerBound();
			if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
				return new Object[] { mType, tField, mFieldName, tSignature, mSignature, tAbstractType, sourceMatch,
						targetMatch };
			}
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_FieldSignature_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_FieldSignature_24_2_matchsrctrgcontext_black = pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mType, tField, mFieldName, tSignature, mSignature, tAbstractType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(FieldSignature _this,
			Type mType, TField tField, MFieldName mFieldName, TFieldSignature tSignature, MFieldSignature mSignature,
			TAbstractType tAbstractType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mType, tField, mFieldName, tSignature, mSignature,
				tAbstractType, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mType, tField, mFieldName, tSignature, mSignature, tAbstractType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_24_3_solvecsp_binding = pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mType, tField, mFieldName, tSignature, mSignature, tAbstractType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_24_5_matchcorrcontext_blackBFBBFBBB(Type mType,
			TField tField, MFieldName mFieldName, TAbstractType tAbstractType, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mFieldName, MFieldNameToTField.class, "source")) {
				if (tField.equals(eFieldDeclarationToTField.getTarget())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mType, TypeToTAbstractType.class, "source")) {
						if (tAbstractType.equals(mTypeToTType.getTarget())) {
							_result.add(new Object[] { mType, mTypeToTType, tField, mFieldName,
	...
	public static final Object[] pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(Type mType,
			TField tField, MFieldName mFieldName, TFieldSignature tSignature, MFieldSignature mSignature,
			TAbstractType tAbstractType, CCMatch ccMatch) {
		return new Object[] { mType, tField, mFieldName, tSignature, mSignature, tAbstractType, ccMatch };
	}

	public static final Object[] pattern_FieldSignature_24_6_createcorrespondence_greenFBFBB(TFieldSignature tSignature,
	...
	public static final Object[] pattern_FieldSignature_28_1_matchtggpattern_black_nac_0BB(TFieldSignature tSignature,
			TField tField) {
		TField __DEC_tSignature_field_245339 = tSignature.getField();
		if (__DEC_tSignature_field_245339 != null) {
			if (!tField.equals(__DEC_tSignature_field_245339)) {
				return new Object[] { tSignature, tField };
			}
		}
	...
	public static final Object[] pattern_FieldSignature_29_3_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			IsApplicableMatch isApplicableMatch, Type mType, TypeToTAbstractType mTypeToTType, TField tField,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mType, mTypeToTType, tField,
				mFieldName, eFieldDeclarationToTField, tAbstractType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, tField, mFieldName,
	...
	public static final Object[] pattern_FieldSignature_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_29_3_solveCSP_binding = pattern_FieldSignature_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, mTypeToTType, tField, mFieldName, eFieldDeclarationToTField,
	...
	public static final Object[] pattern_FieldSignature_29_5_checknacs_blackBBBBBB(Type mType,
			TypeToTAbstractType mTypeToTType, TField tField, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType) {
		return new Object[] { mType, mTypeToTType, tField, mFieldName, eFieldDeclarationToTField, tAbstractType };
	}
	...
	public static final Object[] pattern_FieldSignature_29_6_perform_greenBFBBFFFBBB(Type mType, TField tField,
			MFieldName mFieldName, TAbstractType tAbstractType, ModelgeneratorRuleResult ruleResult, CSP csp) {
		MSignatureToTSignature mSignatureToTSignature = PmFactory.eINSTANCE.createMSignatureToTSignature();
		TFieldSignature tSignature = BasicFactory.eINSTANCE.createTFieldSignature();
		MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement = PmFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		...
		return new Object[] { mType, mSignatureToTSignature, tField, mFieldName, tSignature, mFlowElementToTFlowElement,
				mSignature, tAbstractType, ruleResult, csp };
	}
