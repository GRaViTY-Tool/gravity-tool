...
public class FieldSignatureImpl extends AbstractRuleImpl implements FieldSignature {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FieldSignatureImpl
				.pattern_FieldSignature_1_1_performtransformation_greenBFFBFBB(tAbstractType, mSignature, tField, csp);
		...
		Object[] result3_black = FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, tAbstractType, mFieldName, mFlowElementToTFlowElement, mSignatureToTSignature,
				eFieldDeclarationToTField, mSignature, mType, tSignature, mTypeToTType, tField);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[eFieldDeclarationToTField] = "
					+ eFieldDeclarationToTField + ", " + "[mSignature] = " + mSignature + ", " + "[mType] = " + mType
		...
		FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(ruleresult,
				tAbstractType, mFieldName, mFlowElementToTFlowElement, mSignatureToTSignature, mSignature, mType,
				tSignature, tField);
		...
		FieldSignatureImpl.pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				tAbstractType, mFieldName, mFlowElementToTFlowElement, mSignatureToTSignature,
				eFieldDeclarationToTField, mSignature, mType, tSignature, mTypeToTType, tField);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl.pattern_FieldSignature_2_2_corematch_blackFBFBBFFB(mFieldName,
			...
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_2_3_findcontext_blackBBBBBBB(
					tAbstractType, mFieldName, eFieldDeclarationToTField, mSignature, mType, mTypeToTType, tField)) {
				...
				Object[] result4_bindingAndBlack = FieldSignatureImpl
						.pattern_FieldSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAbstractType, mFieldName, eFieldDeclarationToTField, mSignature, mType, mTypeToTType,
								tField);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tAbstractType] = " + tAbstractType
							+ ", " + "[mFieldName] = " + mFieldName + ", " + "[eFieldDeclarationToTField] = "
							+ eFieldDeclarationToTField + ", " + "[mSignature] = " + mSignature + ", " + "[mType] = "
							+ mType + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tField] = " + tField + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, MFieldSignature mSignature, Type mType,
			TypeToTAbstractType mTypeToTType, TField tField) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tAbstractType, EObject mFieldName,
			EObject mFlowElementToTFlowElement, EObject mSignatureToTSignature, EObject eFieldDeclarationToTField,
			EObject mSignature, EObject mType, EObject tSignature, EObject mTypeToTType, EObject tField) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl
				.pattern_FieldSignature_12_2_corematch_blackBFFFBFBB(tAbstractType, tSignature, tField, match)) {
			...
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_12_3_findcontext_blackBBBBBBB(
					tAbstractType, mFieldName, eFieldDeclarationToTField, mType, tSignature, mTypeToTType, tField)) {
				Object[] result3_green = FieldSignatureImpl
						.pattern_FieldSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(tAbstractType, mFieldName,
								eFieldDeclarationToTField, mType, tSignature, mTypeToTType, tField);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = FieldSignatureImpl
						.pattern_FieldSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAbstractType, mFieldName, eFieldDeclarationToTField, mType, tSignature, mTypeToTType,
								tField);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tAbstractType] = " + tAbstractType
							+ ", " + "[mFieldName] = " + mFieldName + ", " + "[eFieldDeclarationToTField] = "
							+ eFieldDeclarationToTField + ", " + "[mType] = " + mType + ", " + "[tSignature] = "
							+ tSignature + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tField] = " + tField
							+ ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, Type mType, TFieldSignature tSignature,
			TypeToTAbstractType mTypeToTType, TField tField) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tAbstractType, EObject mFieldName,
			EObject mFlowElementToTFlowElement, EObject mSignatureToTSignature, EObject eFieldDeclarationToTField,
			EObject mSignature, EObject mType, EObject tSignature, EObject mTypeToTType, EObject tField) {
		ruleresult.registerObject("tAbstractType", tAbstractType);
		ruleresult.registerObject("mFieldName", mFieldName);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_62(EMoflonEdge _edge_mSignatures) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = FieldSignatureImpl
				.pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAbstractType, mFieldName,
						mSignature, mType, tSignature, tField, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tAbstractType] = " + tAbstractType + ", " + "[mFieldName] = " + mFieldName + ", "
					+ "[mSignature] = " + mSignature + ", " + "[mType] = " + mType + ", " + "[tSignature] = "
					+ tSignature + ", " + "[tField] = " + tField + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (FieldSignatureImpl.pattern_FieldSignature_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldSignatureImpl.pattern_FieldSignature_24_5_matchcorrcontext_blackBBFBFBBB(
					tAbstractType, mFieldName, mType, tField, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = FieldSignatureImpl
						.pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(tAbstractType, mFieldName,
								mSignature, mType, tSignature, tField, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAbstractType] = "
							+ tAbstractType + ", " + "[mFieldName] = " + mFieldName + ", " + "[mSignature] = "
							+ mSignature + ", " + "[mType] = " + mType + ", " + "[tSignature] = " + tSignature + ", "
							+ "[tField] = " + tField + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				FieldSignatureImpl.pattern_FieldSignature_24_6_createcorrespondence_greenFFBBB(mSignature, tSignature,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAbstractType tAbstractType, MFieldName mFieldName, MFieldSignature mSignature,
			Type mType, TFieldSignature tSignature, TField tField, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : FieldSignatureImpl
			...
			Object[] result3_bindingAndBlack = FieldSignatureImpl
					.pattern_FieldSignature_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tAbstractType, mFieldName, eFieldDeclarationToTField, mType, mTypeToTType, tField,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tAbstractType] = " + tAbstractType
						+ ", " + "[mFieldName] = " + mFieldName + ", " + "[eFieldDeclarationToTField] = "
						+ eFieldDeclarationToTField + ", " + "[mType] = " + mType + ", " + "[mTypeToTType] = "
						+ mTypeToTType + ", " + "[tField] = " + tField + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAbstractType] = "
								...
								+ "[eFieldDeclarationToTField] = " + eFieldDeclarationToTField + ", " + "[mType] = "
								+ mType + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tField] = " + tField
								+ ", " + "[ruleResult] = " + ruleResult + ".");
					}
					FieldSignatureImpl.pattern_FieldSignature_29_6_perform_greenBBFFFBFBBB(tAbstractType, mFieldName,
							mType, tField, ruleResult, csp);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, Type mType,
			TypeToTAbstractType mTypeToTType, TField tField, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_MFIELDNAME_MFIELDNAMETOTFIELD_MFIELDSIGNATURE_TYPE_TYPETOTABSTRACTTYPE_TFIELD:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TAbstractType) arguments.get(1),
					(MFieldName) arguments.get(2), (MFieldNameToTField) arguments.get(3),
					(MFieldSignature) arguments.get(4), (Type) arguments.get(5), (TypeToTAbstractType) arguments.get(6),
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_MFIELDNAME_MFIELDNAMETOTFIELD_TYPE_TFIELDSIGNATURE_TYPETOTABSTRACTTYPE_TFIELD:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TAbstractType) arguments.get(1),
					(MFieldName) arguments.get(2), (MFieldNameToTField) arguments.get(3), (Type) arguments.get(4),
					(TFieldSignature) arguments.get(5), (TypeToTAbstractType) arguments.get(6),
					(TField) arguments.get(7));
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_62__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_CC__TABSTRACTTYPE_MFIELDNAME_MFIELDSIGNATURE_TYPE_TFIELDSIGNATURE_TFIELD_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TAbstractType) arguments.get(0), (MFieldName) arguments.get(1),
					(MFieldSignature) arguments.get(2), (Type) arguments.get(3), (TFieldSignature) arguments.get(4),
		...
		case RulesPackage.FIELD_SIGNATURE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_MFIELDNAME_MFIELDNAMETOTFIELD_TYPE_TYPETOTABSTRACTTYPE_TFIELD_MODELGENERATORRULERESULT:
						...
						if (tmpMType instanceof Type) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								if (tmpTField instanceof TField) {
									...
									return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField,
											mSignature, mType, mTypeToTType, tField, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_blackBBBBBBBFBB(
			...
			MFieldSignature mSignature, Type mType, TypeToTAbstractType mTypeToTType, TField tField,
			FieldSignature _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mSignature, mType,
						mTypeToTType, tField, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_greenBFFBFBB(
		...
		return new Object[] { tAbstractType, mFlowElementToTFlowElement, mSignatureToTSignature, mSignature, tSignature,
				tField, csp };
	}
	...
	public static final Object[] pattern_FieldSignature_1_2_collecttranslatedelements_blackBBBB(
			...
			MSignatureToTSignature mSignatureToTSignature, MFieldSignature mSignature, TFieldSignature tSignature) {
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tAbstractType, EObject mFieldName, EObject mFlowElementToTFlowElement,
			EObject mSignatureToTSignature, EObject eFieldDeclarationToTField, EObject mSignature, EObject mType,
			EObject tSignature, EObject mTypeToTType, EObject tField) {
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tAbstractType, EObject mFieldName, EObject mFlowElementToTFlowElement,
			EObject mSignatureToTSignature, EObject mSignature, EObject mType, EObject tSignature, EObject tField) {
		EMoflonEdge mFieldName__mSignature____mSignatures = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, tAbstractType, mFieldName, mFlowElementToTFlowElement, mSignatureToTSignature,
				mSignature, mType, tSignature, tField, mFieldName__mSignature____mSignatures,
	...
	public static final void pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject mSignatureToTSignature, EObject eFieldDeclarationToTField, EObject mSignature, EObject mType,
			EObject tSignature, EObject mTypeToTType, EObject tField) {
		_this.registerObjects_FWD(ruleresult, tAbstractType, mFieldName, mFlowElementToTFlowElement,
				mSignatureToTSignature, eFieldDeclarationToTField, mSignature, mType, tSignature, mTypeToTType, tField);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_2_2_corematch_blackFBFBBFFB(MFieldName mFieldName,
			...
			if (tField != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAbstractType != null) {
						_result.add(new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mSignature,
								mType, mTypeToTType, tField, match });
					}
					...
					if (mType.equals(mTypeToTType.getSource())) {
						if (tAbstractType.equals(mTypeToTType.getTarget())) {
							if (tField.equals(eFieldDeclarationToTField.getTarget())) {
								_result.add(new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField,
										mSignature, mType, mTypeToTType, tField });
							}
						}
					}
				}
	...
	public static final Object[] pattern_FieldSignature_2_3_findcontext_greenBBBBBBBFFFFFFF(TAbstractType tAbstractType,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, MFieldSignature mSignature, Type mType,
			TypeToTAbstractType mTypeToTType, TField tField) {
		...
		return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mSignature, mType, mTypeToTType,
				tField, isApplicableMatch, mFieldName__mSignature____mSignatures,
				eFieldDeclarationToTField__mFieldName____source, mSignature__mType____type,
	...
	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, MFieldSignature mSignature, Type mType,
			TypeToTAbstractType mTypeToTType, TField tField) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tAbstractType, mFieldName,
				eFieldDeclarationToTField, mSignature, mType, mTypeToTType, tField);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mFieldName, eFieldDeclarationToTField,
					mSignature, mType, mTypeToTType, tField };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_2_4_solveCSP_binding = pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAbstractType, mFieldName, eFieldDeclarationToTField, mSignature, mType,
				mTypeToTType, tField);
		if (result_pattern_FieldSignature_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_FieldSignature_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mFieldName,
						eFieldDeclarationToTField, mSignature, mType, mTypeToTType, tField };
			}
		}
		return null;
					...
					if (tmpMType instanceof Type) {
						...
						if (tmpTSignature instanceof TFieldSignature) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								if (tmpTField instanceof TField) {
									TField tField = (TField) tmpTField;
									return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mType,
											tSignature, mTypeToTType, tField, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_blackBBBBBBBFBB(
			TAbstractType tAbstractType, MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField,
			Type mType, TFieldSignature tSignature, TypeToTAbstractType mTypeToTType, TField tField,
			FieldSignature _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mType, tSignature,
						mTypeToTType, tField, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_FieldSignature_11_1_performtransformation_binding != null) {
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_FieldSignature_11_1_performtransformation_binding[5];
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_greenBFFFBB(MFieldName mFieldName,
		...
		mFlowElementToTFlowElement.setSource(mSignature);
		return new Object[] { mFieldName, mFlowElementToTFlowElement, mSignatureToTSignature, mSignature, mType,
				tSignature };
	}
	...
	public static final void pattern_FieldSignature_11_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject mSignatureToTSignature, EObject eFieldDeclarationToTField, EObject mSignature, EObject mType,
			EObject tSignature, EObject mTypeToTType, EObject tField) {
		_this.registerObjects_BWD(ruleresult, tAbstractType, mFieldName, mFlowElementToTFlowElement,
				mSignatureToTSignature, eFieldDeclarationToTField, mSignature, mType, tSignature, mTypeToTType, tField);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_12_2_corematch_blackBFFFBFBB(
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mType != null) {
					for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mFieldName != null) {
							_result.add(new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mType,
									tSignature, mTypeToTType, tField, match });
						}
					...
					if (tAbstractType.equals(tSignature.getType())) {
						if (tAbstractType.equals(mTypeToTType.getTarget())) {
							if (tField.equals(eFieldDeclarationToTField.getTarget())) {
								...
								if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
									_result.add(new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField,
											mType, tSignature, mTypeToTType, tField });
								}
	...
	public static final Object[] pattern_FieldSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		mTypeToTType__tAbstractType____target.setName(mTypeToTType__tAbstractType____target_name_prime);
		eFieldDeclarationToTField__tField____target.setName(eFieldDeclarationToTField__tField____target_name_prime);
		return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mType, tSignature, mTypeToTType,
				tField, isApplicableMatch, eFieldDeclarationToTField__mFieldName____source,
	...
	public static final Object[] pattern_FieldSignature_12_4_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, Type mType, TFieldSignature tSignature,
			TypeToTAbstractType mTypeToTType, TField tField) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tAbstractType, mFieldName,
				eFieldDeclarationToTField, mType, tSignature, mTypeToTType, tField);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mFieldName, eFieldDeclarationToTField,
	...
	public static final Object[] pattern_FieldSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_12_4_solveCSP_binding = pattern_FieldSignature_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAbstractType, mFieldName, eFieldDeclarationToTField, mType, tSignature,
				mTypeToTType, tField);
	...
	public static final Object[] pattern_FieldSignature_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TField __DEC_tSignature_field_626636 = tSignature.getField();
		if (__DEC_tSignature_field_626636 != null) {
			if (!tField.equals(__DEC_tSignature_field_626636)) {
				...
				if (tmpMSignature instanceof MFieldSignature) {
					...
					if (tmpMType instanceof Type) {
						...
						if (tmpTSignature instanceof TFieldSignature) {
							...
							if (tmpTField instanceof TField) {
								TField tField = (TField) tmpTField;
								return new Object[] { tAbstractType, mFieldName, mSignature, mType, tSignature, tField,
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TAbstractType tAbstractType, MFieldName mFieldName, MFieldSignature mSignature, Type mType,
			TFieldSignature tSignature, TField tField, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			int tSignature_lowerBound = tSignature.getLowerBound();
			if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
				return new Object[] { tAbstractType, mFieldName, mSignature, mType, tSignature, tField, sourceMatch,
						targetMatch };
			}
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_FieldSignature_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_FieldSignature_24_2_matchsrctrgcontext_black = pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAbstractType, mFieldName, mSignature, mType, tSignature, tField, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(FieldSignature _this,
			TAbstractType tAbstractType, MFieldName mFieldName, MFieldSignature mSignature, Type mType,
			TFieldSignature tSignature, TField tField, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tAbstractType, mFieldName, mSignature, mType, tSignature,
				tField, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tAbstractType, mFieldName, mSignature, mType, tSignature, tField,
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_24_3_solvecsp_binding = pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAbstractType, mFieldName, mSignature, mType, tSignature, tField, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_24_5_matchcorrcontext_blackBBFBFBBB(
			TAbstractType tAbstractType, MFieldName mFieldName, Type mType, TField tField, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tField.equals(eFieldDeclarationToTField.getTarget())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tAbstractType.equals(mTypeToTType.getTarget())) {
							_result.add(new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mType,
									mTypeToTType, tField, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(
			TAbstractType tAbstractType, MFieldName mFieldName, MFieldSignature mSignature, Type mType,
			TFieldSignature tSignature, TField tField, CCMatch ccMatch) {
		return new Object[] { tAbstractType, mFieldName, mSignature, mType, tSignature, tField, ccMatch };
	}

	public static final Object[] pattern_FieldSignature_24_6_createcorrespondence_greenFFBBB(MFieldSignature mSignature,
	...
	public static final Object[] pattern_FieldSignature_28_1_matchtggpattern_black_nac_0BB(TFieldSignature tSignature,
			TField tField) {
		TField __DEC_tSignature_field_878936 = tSignature.getField();
		if (__DEC_tSignature_field_878936 != null) {
			if (!tField.equals(__DEC_tSignature_field_878936)) {
				return new Object[] { tSignature, tField };
			}
		}
	...
	public static final Object[] pattern_FieldSignature_29_3_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, Type mType, TypeToTAbstractType mTypeToTType, TField tField,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tAbstractType, mFieldName,
				eFieldDeclarationToTField, mType, mTypeToTType, tField, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mFieldName, eFieldDeclarationToTField,
					mType, mTypeToTType, tField, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_29_3_solveCSP_binding = pattern_FieldSignature_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAbstractType, mFieldName, eFieldDeclarationToTField, mType, mTypeToTType,
				tField, ruleResult);
	...
	public static final Object[] pattern_FieldSignature_29_5_checknacs_blackBBBBBB(TAbstractType tAbstractType,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, Type mType,
			TypeToTAbstractType mTypeToTType, TField tField) {
		return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mType, mTypeToTType, tField };
	}

	public static final Object[] pattern_FieldSignature_29_6_perform_blackBBBBBBB(TAbstractType tAbstractType,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, Type mType,
			TypeToTAbstractType mTypeToTType, TField tField, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tAbstractType, mFieldName, eFieldDeclarationToTField, mType, mTypeToTType, tField,
				ruleResult };
	}

	public static final Object[] pattern_FieldSignature_29_6_perform_greenBBFFFBFBBB(TAbstractType tAbstractType,
			MFieldName mFieldName, Type mType, TField tField, ModelgeneratorRuleResult ruleResult, CSP csp) {
		MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement = PmFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MSignatureToTSignature mSignatureToTSignature = PmFactory.eINSTANCE.createMSignatureToTSignature();
		MFieldSignature mSignature = ModiscoFactory.eINSTANCE.createMFieldSignature();
		...
		return new Object[] { tAbstractType, mFieldName, mFlowElementToTFlowElement, mSignatureToTSignature, mSignature,
				mType, tSignature, tField, ruleResult, csp };
	}
