...
public class FieldSignatureImpl extends AbstractRuleImpl implements FieldSignature {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FieldSignatureImpl
				.pattern_FieldSignature_1_1_performtransformation_greenBBBFFFB(tAbstractType, tField, mSignature, csp);
		...
		Object[] result3_black = FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mSignature,
				tSignature, mType, mSignatureToTSignature, mFlowElementToTFlowElement);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[eFieldDeclarationToTField] = "
					+ eFieldDeclarationToTField + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mFieldName] = "
					+ mFieldName + ", " + "[tField] = " + tField + ", " + "[mSignature] = " + mSignature + ", "
		...
		FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(ruleresult,
				tAbstractType, mFieldName, tField, mSignature, tSignature, mType, mSignatureToTSignature,
				mFlowElementToTFlowElement);
		...
		FieldSignatureImpl.pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mSignature, tSignature,
				mType, mSignatureToTSignature, mFlowElementToTFlowElement);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl.pattern_FieldSignature_2_2_corematch_blackFFFBFBBB(mFieldName,
			...
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_2_3_findcontext_blackBBBBBBB(
					mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mSignature, mType)) {
				...
				Object[] result4_bindingAndBlack = FieldSignatureImpl
						.pattern_FieldSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mSignature,
								mType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[tField] = " + tField + ", " + "[mSignature] = " + mSignature + ", " + "[mType] = "
							+ mType + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType, MFieldName mFieldName,
			TField tField, MFieldSignature mSignature, Type mType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mTypeToTType,
			EObject eFieldDeclarationToTField, EObject tAbstractType, EObject mFieldName, EObject tField,
			EObject mSignature, EObject tSignature, EObject mType, EObject mSignatureToTSignature,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FieldSignatureImpl
				.pattern_FieldSignature_11_1_performtransformation_greenBFBBFF(mFieldName, tSignature, mType);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl
			...
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_12_3_findcontext_blackBBBBBBB(
					mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, tSignature, mType)) {
				Object[] result3_green = FieldSignatureImpl
						.pattern_FieldSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(mTypeToTType,
								eFieldDeclarationToTField, tAbstractType, mFieldName, tField, tSignature, mType);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mTypeToTType__tAbstractType____target = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mTypeToTType__mType____source = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge eFieldDeclarationToTField__mFieldName____source = (EMoflonEdge) result3_green[10];
				...
				Object[] result4_bindingAndBlack = FieldSignatureImpl
						.pattern_FieldSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, tSignature,
								mType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTypeToTType] = " + mTypeToTType
							+ ", " + "[eFieldDeclarationToTField] = " + eFieldDeclarationToTField + ", "
							+ "[tAbstractType] = " + tAbstractType + ", " + "[mFieldName] = " + mFieldName + ", "
							+ "[tField] = " + tField + ", " + "[tSignature] = " + tSignature + ", " + "[mType] = "
							+ mType + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType, MFieldName mFieldName,
			TField tField, TFieldSignature tSignature, Type mType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_63(EMoflonEdge _edge_mSignatures) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = FieldSignatureImpl
				.pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAbstractType, mFieldName, tField,
						mSignature, tSignature, mType, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tAbstractType] = " + tAbstractType + ", " + "[mFieldName] = " + mFieldName + ", "
					+ "[tField] = " + tField + ", " + "[mSignature] = " + mSignature + ", " + "[tSignature] = "
					+ tSignature + ", " + "[mType] = " + mType + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (FieldSignatureImpl.pattern_FieldSignature_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldSignatureImpl.pattern_FieldSignature_24_5_matchcorrcontext_blackFFBBBBBB(
					tAbstractType, mFieldName, tField, mType, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = FieldSignatureImpl
						.pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(tAbstractType, mFieldName,
								tField, mSignature, tSignature, mType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAbstractType] = "
							+ tAbstractType + ", " + "[mFieldName] = " + mFieldName + ", " + "[tField] = " + tField
							+ ", " + "[mSignature] = " + mSignature + ", " + "[tSignature] = " + tSignature + ", "
							+ "[mType] = " + mType + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				FieldSignatureImpl.pattern_FieldSignature_24_6_createcorrespondence_greenBBFFB(mSignature, tSignature,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAbstractType tAbstractType, MFieldName mFieldName, TField tField,
			MFieldSignature mSignature, TFieldSignature tSignature, Type mType, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : FieldSignatureImpl
			...
			Object[] result3_bindingAndBlack = FieldSignatureImpl
					.pattern_FieldSignature_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mType,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTypeToTType] = " + mTypeToTType
						+ ", " + "[eFieldDeclarationToTField] = " + eFieldDeclarationToTField + ", "
						+ "[tAbstractType] = " + tAbstractType + ", " + "[mFieldName] = " + mFieldName + ", "
						+ "[tField] = " + tField + ", " + "[mType] = " + mType + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (FieldSignatureImpl.pattern_FieldSignature_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					FieldSignatureImpl.pattern_FieldSignature_29_6_perform_greenBBBFFBFFBB(tAbstractType, mFieldName,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_MFIELDNAMETOTFIELD_TABSTRACTTYPE_MFIELDNAME_TFIELD_MFIELDSIGNATURE_TYPE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (MFieldNameToTField) arguments.get(2),
					(TAbstractType) arguments.get(3), (MFieldName) arguments.get(4), (TField) arguments.get(5),
					(MFieldSignature) arguments.get(6), (Type) arguments.get(7));
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_MFIELDNAMETOTFIELD_TABSTRACTTYPE_MFIELDNAME_TFIELD_TFIELDSIGNATURE_TYPE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (MFieldNameToTField) arguments.get(2),
					(TAbstractType) arguments.get(3), (MFieldName) arguments.get(4), (TField) arguments.get(5),
					(TFieldSignature) arguments.get(6), (Type) arguments.get(7));
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_61__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_CC__TABSTRACTTYPE_MFIELDNAME_TFIELD_MFIELDSIGNATURE_TFIELDSIGNATURE_TYPE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TAbstractType) arguments.get(0), (MFieldName) arguments.get(1),
					(TField) arguments.get(2), (MFieldSignature) arguments.get(3), (TFieldSignature) arguments.get(4),
		...
		case RulesPackage.FIELD_SIGNATURE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_MFIELDNAMETOTFIELD_TABSTRACTTYPE_MFIELDNAME_TFIELD_TYPE_MODELGENERATORRULERESULT:
						...
						if (tmpTField instanceof TField) {
							...
							if (tmpMSignature instanceof MFieldSignature) {
								...
								if (tmpMType instanceof Type) {
									...
									return new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType,
											mFieldName, tField, mSignature, mType, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_blackBBBBBBBFBB(
			TypeToTAbstractType mTypeToTType, MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType,
			MFieldName mFieldName, TField tField, MFieldSignature mSignature, Type mType, FieldSignature _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField,
						mSignature, mType, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_FieldSignature_1_1_performtransformation_binding != null) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_FieldSignature_1_1_performtransformation_binding[0];
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_greenBBBFFFB(
		...
		return new Object[] { tAbstractType, tField, mSignature, tSignature, mSignatureToTSignature,
				mFlowElementToTFlowElement, csp };
	}

	public static final Object[] pattern_FieldSignature_1_2_collecttranslatedelements_blackBBBB(
			MFieldSignature mSignature, TFieldSignature tSignature, MSignatureToTSignature mSignatureToTSignature,
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mTypeToTType, EObject eFieldDeclarationToTField,
			EObject tAbstractType, EObject mFieldName, EObject tField, EObject mSignature, EObject tSignature,
			EObject mType, EObject mSignatureToTSignature, EObject mFlowElementToTFlowElement) {
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tAbstractType, EObject mFieldName, EObject tField, EObject mSignature,
			EObject tSignature, EObject mType, EObject mSignatureToTSignature, EObject mFlowElementToTFlowElement) {
		...
		mSignature__mType____type.setName(mSignature__mType____type_name_prime);
		return new Object[] { ruleresult, tAbstractType, mFieldName, tField, mSignature, tSignature, mType,
				mSignatureToTSignature, mFlowElementToTFlowElement, tSignature__tAbstractType____type,
				mSignatureToTSignature__tSignature____target, mSignatureToTSignature__mSignature____source,
				mFieldName__mSignature____mSignatures, tField__tSignature____signatures, tSignature__tField____field,
	...
	public static final void pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject tAbstractType, EObject mFieldName, EObject tField, EObject mSignature, EObject tSignature,
			EObject mType, EObject mSignatureToTSignature, EObject mFlowElementToTFlowElement) {
		_this.registerObjects_FWD(ruleresult, mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName,
				tField, mSignature, tSignature, mType, mSignatureToTSignature, mFlowElementToTFlowElement);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_2_2_corematch_blackFFFBFBBB(MFieldName mFieldName,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAbstractType != null) {
				for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tField != null) {
						_result.add(new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName,
								tField, mSignature, mType, match });
					}
	...
	public static final Iterable<Object[]> pattern_FieldSignature_2_3_findcontext_blackBBBBBBB(
			TypeToTAbstractType mTypeToTType, MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType,
			MFieldName mFieldName, TField tField, MFieldSignature mSignature, Type mType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
					...
					if (mFieldName.getMSignatures().contains(mSignature)) {
						if (tField.equals(eFieldDeclarationToTField.getTarget())) {
							if (mType.equals(mSignature.getType())) {
								_result.add(new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType,
										mFieldName, tField, mSignature, mType });
							}
						}
					}
				}
	...
	public static final Object[] pattern_FieldSignature_2_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		mSignature__mType____type.setName(mSignature__mType____type_name_prime);
		return new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mSignature,
				mType, isApplicableMatch, mTypeToTType__tAbstractType____target, mTypeToTType__mType____source,
				eFieldDeclarationToTField__mFieldName____source, mFieldName__mSignature____mSignatures,
	...
	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			...
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType, MFieldName mFieldName,
			TField tField, MFieldSignature mSignature, Type mType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mTypeToTType,
				eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mSignature, mType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, eFieldDeclarationToTField, tAbstractType,
					mFieldName, tField, mSignature, mType };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_2_4_solveCSP_binding = pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField,
				mSignature, mType);
		if (result_pattern_FieldSignature_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_FieldSignature_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, eFieldDeclarationToTField,
						tAbstractType, mFieldName, tField, mSignature, mType };
			}
		}
		return null;
	}
						...
						if (tmpTField instanceof TField) {
							...
							if (tmpTSignature instanceof TFieldSignature) {
								...
								if (tmpMType instanceof Type) {
									Type mType = (Type) tmpMType;
									return new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType,
											mFieldName, tField, tSignature, mType, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_blackBBBBBBBFBB(
			TypeToTAbstractType mTypeToTType, MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType,
			MFieldName mFieldName, TField tField, TFieldSignature tSignature, Type mType, FieldSignature _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField,
						tSignature, mType, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_FieldSignature_11_1_performtransformation_binding != null) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_FieldSignature_11_1_performtransformation_binding[0];
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_greenBFBBFF(MFieldName mFieldName,
		...
		mFlowElementToTFlowElement.setSource(mSignature);
		mFlowElementToTFlowElement.setTarget(tSignature);
		return new Object[] { mFieldName, mSignature, tSignature, mType, mSignatureToTSignature,
				mFlowElementToTFlowElement };
	}
	...
	public static final void pattern_FieldSignature_11_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject tAbstractType, EObject mFieldName, EObject tField, EObject mSignature, EObject tSignature,
			EObject mType, EObject mSignatureToTSignature, EObject mFlowElementToTFlowElement) {
		_this.registerObjects_BWD(ruleresult, mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName,
				tField, mSignature, tSignature, mType, mSignatureToTSignature, mFlowElementToTFlowElement);
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mType != null) {
					for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mFieldName != null) {
							_result.add(new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType,
									mFieldName, tField, tSignature, mType, match });
						}
	...
	public static final Iterable<Object[]> pattern_FieldSignature_12_3_findcontext_blackBBBBBBB(
			TypeToTAbstractType mTypeToTType, MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType,
			MFieldName mFieldName, TField tField, TFieldSignature tSignature, Type mType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (tAbstractType.equals(mTypeToTType.getTarget())) {
			if (mType.equals(mTypeToTType.getSource())) {
				if (mFieldName.equals(eFieldDeclarationToTField.getSource())) {
					if (tAbstractType.equals(tSignature.getType())) {
						if (tField.getSignatures().contains(tSignature)) {
							if (tField.equals(eFieldDeclarationToTField.getTarget())) {
								...
								if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
									_result.add(new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType,
											mFieldName, tField, tSignature, mType });
								}
	...
	public static final Object[] pattern_FieldSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		tSignature__tField____field.setName(tSignature__tField____field_name_prime);
		eFieldDeclarationToTField__tField____target.setName(eFieldDeclarationToTField__tField____target_name_prime);
		return new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, tSignature,
				mType, isApplicableMatch, mTypeToTType__tAbstractType____target, mTypeToTType__mType____source,
	...
	public static final Object[] pattern_FieldSignature_12_4_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType, MFieldName mFieldName,
			TField tField, TFieldSignature tSignature, Type mType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mTypeToTType,
				eFieldDeclarationToTField, tAbstractType, mFieldName, tField, tSignature, mType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, eFieldDeclarationToTField, tAbstractType,
	...
	public static final Object[] pattern_FieldSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		if (result_pattern_FieldSignature_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_FieldSignature_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, eFieldDeclarationToTField,
						tAbstractType, mFieldName, tField, tSignature, mType };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TField __DEC_tSignature_field_783330 = tSignature.getField();
		if (__DEC_tSignature_field_783330 != null) {
			if (!tField.equals(__DEC_tSignature_field_783330)) {
				...
				if (tmpTField instanceof TField) {
					...
					if (tmpMSignature instanceof MFieldSignature) {
						...
						if (tmpTSignature instanceof TFieldSignature) {
							...
							if (tmpMType instanceof Type) {
								Type mType = (Type) tmpMType;
								return new Object[] { tAbstractType, mFieldName, tField, mSignature, tSignature, mType,
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TAbstractType tAbstractType, MFieldName mFieldName, TField tField, MFieldSignature mSignature,
			TFieldSignature tSignature, Type mType, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			int tSignature_lowerBound = tSignature.getLowerBound();
			if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
				return new Object[] { tAbstractType, mFieldName, tField, mSignature, tSignature, mType, sourceMatch,
						targetMatch };
			}
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_FieldSignature_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_FieldSignature_24_2_matchsrctrgcontext_black = pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAbstractType, mFieldName, tField, mSignature, tSignature, mType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(FieldSignature _this,
			TAbstractType tAbstractType, MFieldName mFieldName, TField tField, MFieldSignature mSignature,
			TFieldSignature tSignature, Type mType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tAbstractType, mFieldName, tField, mSignature, tSignature,
				mType, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tAbstractType, mFieldName, tField, mSignature, tSignature, mType,
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_24_3_solvecsp_binding = pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAbstractType, mFieldName, tField, mSignature, tSignature, mType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_24_5_matchcorrcontext_blackFFBBBBBB(
			TAbstractType tAbstractType, MFieldName mFieldName, TField tField, Type mType, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mType.equals(mTypeToTType.getSource())) {
					for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tField.equals(eFieldDeclarationToTField.getTarget())) {
							_result.add(new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType,
									mFieldName, tField, mType, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(
			TAbstractType tAbstractType, MFieldName mFieldName, TField tField, MFieldSignature mSignature,
			TFieldSignature tSignature, Type mType, CCMatch ccMatch) {
		return new Object[] { tAbstractType, mFieldName, tField, mSignature, tSignature, mType, ccMatch };
	}

	public static final Object[] pattern_FieldSignature_24_6_createcorrespondence_greenBBFFB(MFieldSignature mSignature,
	...
	public static final Object[] pattern_FieldSignature_28_1_matchtggpattern_black_nac_0BB(TFieldSignature tSignature,
			TField tField) {
		TField __DEC_tSignature_field_382397 = tSignature.getField();
		if (__DEC_tSignature_field_382397 != null) {
			if (!tField.equals(__DEC_tSignature_field_382397)) {
				return new Object[] { tSignature, tField };
			}
		}
	...
	public static final Object[] pattern_FieldSignature_29_3_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mTypeToTType,
				eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, eFieldDeclarationToTField, tAbstractType,
	...
	public static final Object[] pattern_FieldSignature_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		if (result_pattern_FieldSignature_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_FieldSignature_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, eFieldDeclarationToTField,
						tAbstractType, mFieldName, tField, mType, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_29_5_checknacs_blackBBBBBB(TypeToTAbstractType mTypeToTType,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType, MFieldName mFieldName,
			TField tField, Type mType) {
		return new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mType };
	}

	public static final Object[] pattern_FieldSignature_29_6_perform_blackBBBBBBB(TypeToTAbstractType mTypeToTType,
			MFieldNameToTField eFieldDeclarationToTField, TAbstractType tAbstractType, MFieldName mFieldName,
			TField tField, Type mType, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mTypeToTType, eFieldDeclarationToTField, tAbstractType, mFieldName, tField, mType,
				ruleResult };
	...
	public static final Object[] pattern_FieldSignature_29_6_perform_greenBBBFFBFFBB(TAbstractType tAbstractType,
			MFieldName mFieldName, TField tField, Type mType, ModelgeneratorRuleResult ruleResult, CSP csp) {
		MFieldSignature mSignature = ModiscoFactory.eINSTANCE.createMFieldSignature();
		TFieldSignature tSignature = BasicFactory.eINSTANCE.createTFieldSignature();
		MSignatureToTSignature mSignatureToTSignature = PmFactory.eINSTANCE.createMSignatureToTSignature();
		MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement = PmFactory.eINSTANCE
		...
		return new Object[] { tAbstractType, mFieldName, tField, mSignature, tSignature, mType, mSignatureToTSignature,
