...
public class FieldSignatureImpl extends AbstractRuleImpl implements FieldSignature {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FieldSignatureImpl
				.pattern_FieldSignature_1_1_performtransformation_greenFBBFFBB(tAbstractType, mSignature, tField, csp);
		...
		Object[] result3_black = FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, mType, mFlowElementToTFlowElement, mTypeToTType, tAbstractType, mSignature,
				mSignatureToTSignature, mFieldName, eFieldDeclarationToTField, tSignature, tField);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[mFieldName] = " + mFieldName
					+ ", " + "[eFieldDeclarationToTField] = " + eFieldDeclarationToTField + ", " + "[tSignature] = "
					+ tSignature + ", " + "[tField] = " + tField + ".");
		}
		FieldSignatureImpl.pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(ruleresult, mType,
				mFlowElementToTFlowElement, tAbstractType, mSignature, mSignatureToTSignature, mFieldName, tSignature,
				tField);
		...
		//nothing EMoflonEdge tField__tSignature____signatures = (EMoflonEdge) result3_green[15];
		//nothing EMoflonEdge tSignature__tField____field = (EMoflonEdge) result3_green[16];
		//nothing EMoflonEdge mFieldName__mSignature____mSignatures = (EMoflonEdge) result3_green[17];

		// 
		// 
		FieldSignatureImpl.pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, mType,
				mFlowElementToTFlowElement, mTypeToTType, tAbstractType, mSignature, mSignatureToTSignature, mFieldName,
				eFieldDeclarationToTField, tSignature, tField);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl.pattern_FieldSignature_2_2_corematch_blackBFFBBFFB(mType,
			...
			// ForEach 
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_2_3_findcontext_blackBBBBBBB(mType,
					mTypeToTType, tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField, tField)) {
				Object[] result3_green = FieldSignatureImpl.pattern_FieldSignature_2_3_findcontext_greenBBBBBBBFFFFFFF(
						mType, mTypeToTType, tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField, tField);
				...
				Object[] result4_bindingAndBlack = FieldSignatureImpl
						.pattern_FieldSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mType,
								mTypeToTType, tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField, tField);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldSignature mSignature,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, TField tField) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mType, EObject mFlowElementToTFlowElement,
			EObject mTypeToTType, EObject tAbstractType, EObject mSignature, EObject mSignatureToTSignature,
			EObject mFieldName, EObject eFieldDeclarationToTField, EObject tSignature, EObject tField) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FieldSignatureImpl.pattern_FieldSignature_11_1_performtransformation_greenBFFFBB(mType,
		...
		FieldSignatureImpl.pattern_FieldSignature_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(ruleresult, mType,
				mFlowElementToTFlowElement, tAbstractType, mSignature, mSignatureToTSignature, mFieldName, tSignature,
				tField);
		//nothing EMoflonEdge mFlowElementToTFlowElement__mSignature____source = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge mSignatureToTSignature__mSignature____source = (EMoflonEdge) result3_green[10];
		...
		// 
		// 
		FieldSignatureImpl.pattern_FieldSignature_11_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, mType,
				mFlowElementToTFlowElement, mTypeToTType, tAbstractType, mSignature, mSignatureToTSignature, mFieldName,
				eFieldDeclarationToTField, tSignature, tField);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldSignatureImpl
				.pattern_FieldSignature_12_2_corematch_blackFFBFFBBB(tAbstractType, tSignature, tField, match)) {
			...
			// ForEach 
			for (Object[] result3_black : FieldSignatureImpl.pattern_FieldSignature_12_3_findcontext_blackBBBBBBB(mType,
					mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField, tSignature, tField)) {
				Object[] result3_green = FieldSignatureImpl
						.pattern_FieldSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(mType, mTypeToTType,
								tAbstractType, mFieldName, eFieldDeclarationToTField, tSignature, tField);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mTypeToTType__mType____source = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mTypeToTType__tAbstractType____target = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = FieldSignatureImpl
						.pattern_FieldSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mType,
								mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField, tSignature, tField);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mType] = " + mType + ", "
							...
							+ eFieldDeclarationToTField + ", " + "[tSignature] = " + tSignature + ", " + "[tField] = "
							+ tField + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Type mType,
			...
			MFieldNameToTField eFieldDeclarationToTField, TFieldSignature tSignature, TField tField) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_2(EMoflonEdge _edge_type) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = FieldSignatureImpl
				.pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mType, tAbstractType, mSignature,
						mFieldName, tSignature, tField, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mType] = " + mType + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mSignature] = "
					+ mSignature + ", " + "[mFieldName] = " + mFieldName + ", " + "[tSignature] = " + tSignature + ", "
		...
		if (FieldSignatureImpl.pattern_FieldSignature_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldSignatureImpl.pattern_FieldSignature_24_5_matchcorrcontext_blackBFBBFBBB(
					mType, tAbstractType, mFieldName, tField, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = FieldSignatureImpl
						.pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(mType, tAbstractType, mSignature,
								mFieldName, tSignature, tField, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Type mType, TAbstractType tAbstractType, MFieldSignature mSignature,
			MFieldName mFieldName, TFieldSignature tSignature, TField tField, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : FieldSignatureImpl
			...
			Object[] result3_bindingAndBlack = FieldSignatureImpl
					.pattern_FieldSignature_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mType,
							mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField, tField, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mType] = " + mType + ", "
						+ "[mTypeToTType] = " + mTypeToTType + ", " + "[tAbstractType] = " + tAbstractType + ", "
						+ "[mFieldName] = " + mFieldName + ", " + "[eFieldDeclarationToTField] = "
						+ eFieldDeclarationToTField + ", " + "[tField] = " + tField + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (FieldSignatureImpl.pattern_FieldSignature_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = FieldSignatureImpl.pattern_FieldSignature_29_5_checknacs_blackBBBBBB(mType,
						mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField, tField);
				if (result5_black != null) {

					Object[] result6_black = FieldSignatureImpl.pattern_FieldSignature_29_6_perform_blackBBBBBBB(mType,
							mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField, tField, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mType] = " + mType
								...
								+ "[eFieldDeclarationToTField] = " + eFieldDeclarationToTField + ", " + "[tField] = "
								+ tField + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					FieldSignatureImpl.pattern_FieldSignature_29_6_perform_greenBFBFFBFBBB(mType, tAbstractType,
							mFieldName, tField, ruleResult, csp);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, TField tField, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPE_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MFIELDSIGNATURE_MFIELDNAME_MFIELDNAMETOTFIELD_TFIELD:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Type) arguments.get(1),
					...
					(MFieldSignature) arguments.get(4), (MFieldName) arguments.get(5),
					(MFieldNameToTField) arguments.get(6), (TField) arguments.get(7));
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPE_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MFIELDNAME_MFIELDNAMETOTFIELD_TFIELDSIGNATURE_TFIELD:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Type) arguments.get(1),
					(TypeToTAbstractType) arguments.get(2), (TAbstractType) arguments.get(3),
					(MFieldName) arguments.get(4), (MFieldNameToTField) arguments.get(5),
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_2__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_SIGNATURE___IS_APPLICABLE_SOLVE_CSP_CC__TYPE_TABSTRACTTYPE_MFIELDSIGNATURE_MFIELDNAME_TFIELDSIGNATURE_TFIELD_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Type) arguments.get(0), (TAbstractType) arguments.get(1),
					(MFieldSignature) arguments.get(2), (MFieldName) arguments.get(3),
					(TFieldSignature) arguments.get(4), (TField) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.FIELD_SIGNATURE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPE_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MFIELDNAME_MFIELDNAMETOTFIELD_TFIELD_MODELGENERATORRULERESULT:
						...
						if (tmpMFieldName instanceof MFieldName) {
							...
							if (tmpEFieldDeclarationToTField instanceof MFieldNameToTField) {
								...
								if (tmpTField instanceof TField) {
									...
									return new Object[] { mType, mTypeToTType, tAbstractType, mSignature, mFieldName,
											eFieldDeclarationToTField, tField, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_blackBBBBBBBFBB(Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldSignature mSignature,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, TField tField, FieldSignature _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mTypeToTType, tAbstractType, mSignature, mFieldName,
						eFieldDeclarationToTField, tField, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_FieldSignature_1_1_performtransformation_binding != null) {
			Type mType = (Type) result_pattern_FieldSignature_1_1_performtransformation_binding[0];
			...
			MFieldName mFieldName = (MFieldName) result_pattern_FieldSignature_1_1_performtransformation_binding[4];
	...
	public static final Object[] pattern_FieldSignature_1_1_performtransformation_greenFBBFFBB(
		...
		return new Object[] { mFlowElementToTFlowElement, tAbstractType, mSignature, mSignatureToTSignature, tSignature,
				tField, csp };
	}
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mType, EObject mFlowElementToTFlowElement, EObject mTypeToTType,
			EObject tAbstractType, EObject mSignature, EObject mSignatureToTSignature, EObject mFieldName,
			EObject eFieldDeclarationToTField, EObject tSignature, EObject tField) {
	...
	public static final Object[] pattern_FieldSignature_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mType, EObject mFlowElementToTFlowElement, EObject tAbstractType,
			EObject mSignature, EObject mSignatureToTSignature, EObject mFieldName, EObject tSignature,
			EObject tField) {
		...
		mFieldName__mSignature____mSignatures.setName(mFieldName__mSignature____mSignatures_name_prime);
		return new Object[] { ruleresult, mType, mFlowElementToTFlowElement, tAbstractType, mSignature,
				mSignatureToTSignature, mFieldName, tSignature, tField,
	...
	public static final void pattern_FieldSignature_1_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject tAbstractType, EObject mSignature, EObject mSignatureToTSignature, EObject mFieldName,
			EObject eFieldDeclarationToTField, EObject tSignature, EObject tField) {
		_this.registerObjects_FWD(ruleresult, mType, mFlowElementToTFlowElement, mTypeToTType, tAbstractType,
				mSignature, mSignatureToTSignature, mFieldName, eFieldDeclarationToTField, tSignature, tField);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_2_2_corematch_blackBFFBBFFB(Type mType,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAbstractType != null) {
				for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tField != null) {
						_result.add(new Object[] { mType, mTypeToTType, tAbstractType, mSignature, mFieldName,
								eFieldDeclarationToTField, tField, match });
					}
	...
	public static final Iterable<Object[]> pattern_FieldSignature_2_3_findcontext_blackBBBBBBB(Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldSignature mSignature,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, TField tField) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_FieldSignature_2_3_findcontext_greenBBBBBBBFFFFFFF(Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldSignature mSignature,
			MFieldName mFieldName, MFieldNameToTField eFieldDeclarationToTField, TField tField) {
		...
		mFieldName__mSignature____mSignatures.setName(mFieldName__mSignature____mSignatures_name_prime);
		return new Object[] { mType, mTypeToTType, tAbstractType, mSignature, mFieldName, eFieldDeclarationToTField,
				tField, isApplicableMatch, mTypeToTType__mType____source, mTypeToTType__tAbstractType____target,
				mSignature__mType____type, eFieldDeclarationToTField__mFieldName____source,
	...
	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
			IsApplicableMatch isApplicableMatch, Type mType, TypeToTAbstractType mTypeToTType,
			TAbstractType tAbstractType, MFieldSignature mSignature, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, TField tField) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mType, mTypeToTType, tAbstractType,
				mSignature, mFieldName, eFieldDeclarationToTField, tField);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, tAbstractType, mSignature,
					mFieldName, eFieldDeclarationToTField, tField };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_2_4_solveCSP_binding = pattern_FieldSignature_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, mTypeToTType, tAbstractType, mSignature, mFieldName,
				eFieldDeclarationToTField, tField);
	...
	public static final Object[] pattern_FieldSignature_10_4_collectelementstobetranslated_greenBBBBFFF(Match match,
		...
		tField__tSignature____signatures.setName(tField__tSignature____signatures_name_prime);
		tSignature__tField____field.setName(tSignature__tField____field_name_prime);
		return new Object[] { match, tAbstractType, tSignature, tField, tSignature__tAbstractType____type,
					...
					if (tmpMFieldName instanceof MFieldName) {
						...
						if (tmpEFieldDeclarationToTField instanceof MFieldNameToTField) {
							...
							if (tmpTSignature instanceof TFieldSignature) {
								...
								if (tmpTField instanceof TField) {
									TField tField = (TField) tmpTField;
									return new Object[] { mType, mTypeToTType, tAbstractType, mFieldName,
											eFieldDeclarationToTField, tSignature, tField, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_blackBBBBBBBFBB(Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, TFieldSignature tSignature, TField tField,
			FieldSignature _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField,
						tSignature, tField, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_FieldSignature_11_1_performtransformation_binding != null) {
			Type mType = (Type) result_pattern_FieldSignature_11_1_performtransformation_binding[0];
			...
			Object[] result_pattern_FieldSignature_11_1_performtransformation_black = pattern_FieldSignature_11_1_performtransformation_blackBBBBBBBFBB(
					mType, mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField, tSignature, tField,
					_this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldSignature_11_1_performtransformation_greenBFFFBB(Type mType,
		...
		mSignatureToTSignature.setSource(mSignature);
		mSignatureToTSignature.setTarget(tSignature);
		return new Object[] { mType, mFlowElementToTFlowElement, mSignature, mSignatureToTSignature, mFieldName,
				tSignature };
	}
	...
	public static final void pattern_FieldSignature_11_5_registerobjects_expressionBBBBBBBBBBBB(FieldSignature _this,
			...
			EObject tAbstractType, EObject mSignature, EObject mSignatureToTSignature, EObject mFieldName,
			EObject eFieldDeclarationToTField, EObject tSignature, EObject tField) {
		_this.registerObjects_BWD(ruleresult, mType, mFlowElementToTFlowElement, mTypeToTType, tAbstractType,
				mSignature, mSignatureToTSignature, mFieldName, eFieldDeclarationToTField, tSignature, tField);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_12_2_corematch_blackFFBFFBBB(
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mType != null) {
					for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mFieldName != null) {
							_result.add(new Object[] { mType, mTypeToTType, tAbstractType, mFieldName,
									eFieldDeclarationToTField, tSignature, tField, match });
						}
	...
	public static final Iterable<Object[]> pattern_FieldSignature_12_3_findcontext_blackBBBBBBB(Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, TFieldSignature tSignature, TField tField) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (mType.equals(mTypeToTType.getSource())) {
	...
	public static final Object[] pattern_FieldSignature_12_3_findcontext_greenBBBBBBBFFFFFFFF(Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, TFieldSignature tSignature, TField tField) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge mTypeToTType__mType____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		tSignature__tField____field.setName(tSignature__tField____field_name_prime);
		eFieldDeclarationToTField__tField____target.setName(eFieldDeclarationToTField__tField____target_name_prime);
		return new Object[] { mType, mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField, tSignature,
				tField, isApplicableMatch, mTypeToTType__mType____source, mTypeToTType__tAbstractType____target,
	...
	public static final Object[] pattern_FieldSignature_12_4_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mType, mTypeToTType, tAbstractType,
				mFieldName, eFieldDeclarationToTField, tSignature, tField);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, tAbstractType, mFieldName,
					eFieldDeclarationToTField, tSignature, tField };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_12_4_solveCSP_binding = pattern_FieldSignature_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField,
				tSignature, tField);
	...
	public static final Object[] pattern_FieldSignature_20_2_testcorematchandDECs_black_nac_0BB(
			TFieldSignature tSignature, TField tField) {
		TField __DEC_tSignature_field_288654 = tSignature.getField();
		if (__DEC_tSignature_field_288654 != null) {
			if (!tField.equals(__DEC_tSignature_field_288654)) {
					...
					if (tField != null) {
						...
						if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
							if (pattern_FieldSignature_20_2_testcorematchandDECs_black_nac_0BB(tSignature,
									tField) == null) {
								_result.add(new Object[] { tAbstractType, tSignature, tField, _edge_type });
							}
						}
				...
				if (tmpMSignature instanceof MFieldSignature) {
					...
					if (tmpMFieldName instanceof MFieldName) {
						...
						if (tmpTSignature instanceof TFieldSignature) {
							...
							if (tmpTField instanceof TField) {
								TField tField = (TField) tmpTField;
								return new Object[] { mType, tAbstractType, mSignature, mFieldName, tSignature, tField,
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(Type mType,
			TAbstractType tAbstractType, MFieldSignature mSignature, MFieldName mFieldName, TFieldSignature tSignature,
			TField tField, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			int tSignature_lowerBound = tSignature.getLowerBound();
			if (Integer.valueOf(tSignature_lowerBound).equals(Integer.valueOf(0))) {
				return new Object[] { mType, tAbstractType, mSignature, mFieldName, tSignature, tField, sourceMatch,
						targetMatch };
			}
	...
	public static final Object[] pattern_FieldSignature_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_FieldSignature_24_2_matchsrctrgcontext_binding != null) {
			Type mType = (Type) result_pattern_FieldSignature_24_2_matchsrctrgcontext_binding[0];
			TAbstractType tAbstractType = (TAbstractType) result_pattern_FieldSignature_24_2_matchsrctrgcontext_binding[1];
			MFieldSignature mSignature = (MFieldSignature) result_pattern_FieldSignature_24_2_matchsrctrgcontext_binding[2];
			MFieldName mFieldName = (MFieldName) result_pattern_FieldSignature_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_FieldSignature_24_2_matchsrctrgcontext_black = pattern_FieldSignature_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mType, tAbstractType, mSignature, mFieldName, tSignature, tField, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(FieldSignature _this,
			Type mType, TAbstractType tAbstractType, MFieldSignature mSignature, MFieldName mFieldName,
			TFieldSignature tSignature, TField tField, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mType, tAbstractType, mSignature, mFieldName, tSignature,
				tField, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mType, tAbstractType, mSignature, mFieldName, tSignature, tField,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(FieldSignature _this,
		...
		Object[] result_pattern_FieldSignature_24_3_solvecsp_binding = pattern_FieldSignature_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mType, tAbstractType, mSignature, mFieldName, tSignature, tField, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_FieldSignature_24_5_matchcorrcontext_blackBFBBFBBB(Type mType,
			TAbstractType tAbstractType, MFieldName mFieldName, TField tField, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mType, TypeToTAbstractType.class, "source")) {
				if (tAbstractType.equals(mTypeToTType.getTarget())) {
					for (MFieldNameToTField eFieldDeclarationToTField : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tField.equals(eFieldDeclarationToTField.getTarget())) {
							_result.add(new Object[] { mType, mTypeToTType, tAbstractType, mFieldName,
									eFieldDeclarationToTField, tField, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_FieldSignature_24_6_createcorrespondence_blackBBBBBBB(Type mType,
			TAbstractType tAbstractType, MFieldSignature mSignature, MFieldName mFieldName, TFieldSignature tSignature,
			TField tField, CCMatch ccMatch) {
		return new Object[] { mType, tAbstractType, mSignature, mFieldName, tSignature, tField, ccMatch };
	}
	...
	public static final Object[] pattern_FieldSignature_28_1_matchtggpattern_black_nac_0BB(TFieldSignature tSignature,
			TField tField) {
		TField __DEC_tSignature_field_712351 = tSignature.getField();
		if (__DEC_tSignature_field_712351 != null) {
			if (!tField.equals(__DEC_tSignature_field_712351)) {
				return new Object[] { tSignature, tField };
			}
		}
	...
	public static final Object[] pattern_FieldSignature_29_3_solveCSP_bindingFBBBBBBBBB(FieldSignature _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mType, mTypeToTType, tAbstractType,
				mFieldName, eFieldDeclarationToTField, tField, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, tAbstractType, mFieldName,
					eFieldDeclarationToTField, tField, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldSignature_29_5_checknacs_blackBBBBBB(Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, TField tField) {
		return new Object[] { mType, mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField, tField };
	}

	public static final Object[] pattern_FieldSignature_29_6_perform_blackBBBBBBB(Type mType,
			TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType, MFieldName mFieldName,
			MFieldNameToTField eFieldDeclarationToTField, TField tField, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mType, mTypeToTType, tAbstractType, mFieldName, eFieldDeclarationToTField, tField,
				ruleResult };
	}

	public static final Object[] pattern_FieldSignature_29_6_perform_greenBFBFFBFBBB(Type mType,
			TAbstractType tAbstractType, MFieldName mFieldName, TField tField, ModelgeneratorRuleResult ruleResult,
			CSP csp) {
		MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement = PmFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MFieldSignature mSignature = ModiscoFactory.eINSTANCE.createMFieldSignature();
		...
		return new Object[] { mType, mFlowElementToTFlowElement, tAbstractType, mSignature, mSignatureToTSignature,
				mFieldName, tSignature, tField, ruleResult, csp };
	}
