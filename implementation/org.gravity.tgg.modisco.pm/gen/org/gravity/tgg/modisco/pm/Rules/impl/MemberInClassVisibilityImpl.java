...
public class MemberInClassVisibilityImpl extends AbstractRuleImpl implements MemberInClassVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tModifier,
						mModifierToTModifier, mDefinition, tClass, mClass, mTypeToTType, mModifier, defToMember,
						tMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ mClass + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[mModifier] = " + mModifier + ", "
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tModifier, mModifierToTModifier, mDefinition, tClass, mClass, mTypeToTType, mModifier,
				defToMember, tMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_2_2_corematch_blackBFBFBFFB(mDefinition, mClass, mModifier, match)) {
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(mDefinition, tClass, mClass,
							mTypeToTType, mModifier, defToMember, tMember)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mDefinition, tClass,
								mClass, mTypeToTType, mModifier, defToMember, tMember);
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mDefinition, tClass, mClass, mTypeToTType, mModifier, defToMember, tMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition
							+ ", " + "[tClass] = " + tClass + ", " + "[mClass] = " + mClass + ", " + "[mTypeToTType] = "
							+ mTypeToTType + ", " + "[mModifier] = " + mModifier + ", " + "[defToMember] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition, TClass tClass,
			ClassDeclaration mClass, TypeToTAbstractType mTypeToTType, Modifier mModifier,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tModifier, EObject mModifierToTModifier,
			EObject mDefinition, EObject tClass, EObject mClass, EObject mTypeToTType, EObject mModifier,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_12_2_corematch_blackBFBFFFBB(tModifier, tClass, tMember, match)) {
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, tModifier, mDefinition, tClass, mClass, mTypeToTType, defToMember,
								tMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tModifier] = " + tModifier + ", "
							+ "[mDefinition] = " + mDefinition + ", " + "[tClass] = " + tClass + ", " + "[mClass] = "
							+ mClass + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[defToMember] = "
							+ defToMember + ", " + "[tMember] = " + tMember + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TModifier tModifier,
			MDefinition mDefinition, TClass tClass, ClassDeclaration mClass, TypeToTAbstractType mTypeToTType,
			MDefinitionToTMember defToMember, TMember tMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tModifier, mDefinition,
						tClass, mClass, mModifier, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tModifier] = " + tModifier + ", " + "[mDefinition] = " + mDefinition + ", " + "[tClass] = "
					+ tClass + ", " + "[mClass] = " + mClass + ", " + "[mModifier] = " + mModifier + ", "
		...
		if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackBBBFFBBB(mDefinition, tClass, mClass,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TModifier tModifier, MDefinition mDefinition, TClass tClass,
			ClassDeclaration mClass, Modifier mModifier, TMember tMember, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mDefinition, tClass, mClass, mTypeToTType, defToMember, tMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition + ", "
						+ "[tClass] = " + tClass + ", " + "[mClass] = " + mClass + ", " + "[mTypeToTType] = "
						+ mTypeToTType + ", " + "[defToMember] = " + defToMember + ", " + "[tMember] = " + tMember
			...
			if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(mDefinition, tClass, mClass,
								mTypeToTType, defToMember, tMember);
				if (result5_black != null) {

					Object[] result6_black = MemberInClassVisibilityImpl
							.pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(mDefinition, tClass, mClass,
									mTypeToTType, defToMember, tMember, ruleResult);
					if (result6_black == null) {
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition, TClass tClass,
			ClassDeclaration mClass, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITION_TCLASS_CLASSDECLARATION_TYPETOTABSTRACTTYPE_MODIFIER_MDEFINITIONTOTMEMBER_TMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MDefinition) arguments.get(1),
					(TClass) arguments.get(2), (ClassDeclaration) arguments.get(3),
					(TypeToTAbstractType) arguments.get(4), (Modifier) arguments.get(5),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMODIFIER_MDEFINITION_TCLASS_CLASSDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TMEMBER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TModifier) arguments.get(1),
					(MDefinition) arguments.get(2), (TClass) arguments.get(3), (ClassDeclaration) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_10__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_10((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_11__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__TMODIFIER_MDEFINITION_TCLASS_CLASSDECLARATION_MODIFIER_TMEMBER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TModifier) arguments.get(0), (MDefinition) arguments.get(1),
					(TClass) arguments.get(2), (ClassDeclaration) arguments.get(3), (Modifier) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_TCLASS_CLASSDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TMEMBER_MODELGENERATORRULERESULT:
						...
						if (tmpMModifier instanceof Modifier) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTMember instanceof TMember) {
									...
									return new Object[] { mDefinition, tClass, mClass, mTypeToTType, mModifier,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			MDefinition mDefinition, TClass tClass, ClassDeclaration mClass, TypeToTAbstractType mTypeToTType,
			Modifier mModifier, MDefinitionToTMember defToMember, TMember tMember, MemberInClassVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinition, tClass, mClass, mTypeToTType, mModifier, defToMember, tMember, csp,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_1_1_performtransformation_black = pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mDefinition, tClass, mClass, mTypeToTType, mModifier, defToMember, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject tClass, EObject mClass, EObject mTypeToTType, EObject mModifier, EObject defToMember,
			EObject tMember) {
	...
	public static final void pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mModifierToTModifier, EObject mDefinition, EObject tClass, EObject mClass, EObject mTypeToTType,
			EObject mModifier, EObject defToMember, EObject tMember) {
		_this.registerObjects_FWD(ruleresult, tModifier, mModifierToTModifier, mDefinition, tClass, mClass,
				mTypeToTType, mModifier, defToMember, tMember);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_2_2_corematch_blackBFBFBFFB(
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTClass instanceof TClass) {
						TClass tClass = (TClass) tmpTClass;
						_result.add(new Object[] { mDefinition, tClass, mClass, mTypeToTType, mModifier, defToMember,
								tMember, match });
					}
						...
						if (mDefinition.equals(defToMember.getSource())) {
							if (mClass.equals(mTypeToTType.getSource())) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { mDefinition, tClass, mClass, mTypeToTType, mModifier,
											defToMember, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mDefinition, tClass, mClass, mTypeToTType, mModifier, defToMember, tMember,
				...
				defToMember__mDefinition____source, mTypeToTType__mClass____source, defToMember__tMember____target };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mDefinition, tClass, mClass,
				mTypeToTType, mModifier, defToMember, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, tClass, mClass, mTypeToTType, mModifier,
					defToMember, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_2_4_solveCSP_binding = pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, tClass, mClass, mTypeToTType, mModifier, defToMember, tMember);
		if (result_pattern_MemberInClassVisibility_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mDefinition, tClass, mClass, mTypeToTType,
					...
					if (tmpMClass instanceof ClassDeclaration) {
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTMember instanceof TMember) {
									TMember tMember = (TMember) tmpTMember;
									return new Object[] { tModifier, mDefinition, tClass, mClass, mTypeToTType,
											defToMember, tMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TModifier tModifier, MDefinition mDefinition, TClass tClass, ClassDeclaration mClass,
			TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember, TMember tMember,
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tModifier, mDefinition, tClass, mClass, mTypeToTType, defToMember, tMember, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_11_1_performtransformation_black = pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					tModifier, mDefinition, tClass, mClass, mTypeToTType, defToMember, tMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInClassVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mModifierToTModifier, EObject mDefinition, EObject tClass, EObject mClass, EObject mTypeToTType,
			EObject mModifier, EObject defToMember, EObject tMember) {
		_this.registerObjects_BWD(ruleresult, tModifier, mModifierToTModifier, mDefinition, tClass, mClass,
				mTypeToTType, mModifier, defToMember, tMember);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_12_2_corematch_blackBFBFFFBB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMClass instanceof ClassDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tModifier, mDefinition, tClass, mClass, mTypeToTType, defToMember,
								tMember, match });
					}
						...
						if (mClass.equals(mTypeToTType.getSource())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (tModifier.equals(tMember.getTModifier())) {
									_result.add(new Object[] { tModifier, mDefinition, tClass, mClass, mTypeToTType,
											defToMember, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		tMember__tModifier____tModifier.setName(tMember__tModifier____tModifier_name_prime);
		return new Object[] { tModifier, mDefinition, tClass, mClass, mTypeToTType, defToMember, tMember,
				...
				mTypeToTType__tClass____target, defToMember__mDefinition____source, mTypeToTType__mClass____source,
				defToMember__tMember____target, tMember__tModifier____tModifier };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tModifier, mDefinition, tClass, mClass, mTypeToTType,
					defToMember, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_12_4_solveCSP_binding = pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tModifier, mDefinition, tClass, mClass, mTypeToTType, defToMember, tMember);
		if (result_pattern_MemberInClassVisibility_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tModifier, mDefinition, tClass, mClass,
						mTypeToTType, defToMember, tMember };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_636705 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_636705)) {
				...
				if (tmpTClass instanceof TClass) {
					...
					if (tmpMClass instanceof ClassDeclaration) {
						...
						if (tmpMModifier instanceof Modifier) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { tModifier, mDefinition, tClass, mClass, mModifier, tMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TModifier tModifier, MDefinition mDefinition, TClass tClass, ClassDeclaration mClass, Modifier mModifier,
			TMember tMember, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tModifier, mDefinition, tClass, mClass, mModifier, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			TClass tClass = (TClass) result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_binding[2];
			...
			Object[] result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tModifier, mDefinition, tClass, mClass, mModifier, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, TModifier tModifier, MDefinition mDefinition, TClass tClass,
			ClassDeclaration mClass, Modifier mModifier, TMember tMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tModifier, mDefinition, tClass, mClass, mModifier,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tModifier, mDefinition, tClass, mClass, mModifier, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_24_3_solvecsp_binding = pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tModifier, mDefinition, tClass, mClass, mModifier, tMember, sourceMatch, targetMatch);
		if (result_pattern_MemberInClassVisibility_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tModifier, mDefinition, tClass, mClass, mModifier, tMember,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackBBBFFBBB(
			MDefinition mDefinition, TClass tClass, ClassDeclaration mClass, TMember tMember, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mClass.equals(mTypeToTType.getSource())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { mDefinition, tClass, mClass, mTypeToTType, defToMember, tMember,
									sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tModifier, mDefinition, tClass, mClass, mModifier, tMember, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_93170 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_93170)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mDefinition, tClass, mClass,
				mTypeToTType, defToMember, tMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, tClass, mClass, mTypeToTType, defToMember,
					tMember, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_29_3_solveCSP_binding = pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, tClass, mClass, mTypeToTType, defToMember, tMember, ruleResult);
	...
	public static final Object[] pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(MDefinition mDefinition,
			TClass tClass, ClassDeclaration mClass, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember,
			TMember tMember) {
		return new Object[] { mDefinition, tClass, mClass, mTypeToTType, defToMember, tMember };
	}

	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(MDefinition mDefinition,
			TClass tClass, ClassDeclaration mClass, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember,
			TMember tMember, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mDefinition, tClass, mClass, mTypeToTType, defToMember, tMember, ruleResult };
	}
