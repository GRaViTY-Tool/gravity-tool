...
public class MemberInClassVisibilityImpl extends AbstractRuleImpl implements MemberInClassVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mClass, tMember,
						mModifier, mDefinition, tModifier, defToMember, mModifierToTModifier, mTypeToTType, tClass);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mClass] = " + mClass + ", " + "[tMember] = " + tMember + ", " + "[mModifier] = "
					+ mModifier + ", " + "[mDefinition] = " + mDefinition + ", " + "[tModifier] = " + tModifier + ", "
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				tMember, mModifier, mDefinition, tModifier, mModifierToTModifier);
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mClass, tMember, mModifier, mDefinition, tModifier, defToMember, mModifierToTModifier,
				mTypeToTType, tClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_2_2_corematch_blackBFBBFFFB(mClass, mModifier, mDefinition, match)) {
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(mClass, tMember, mModifier,
							mDefinition, defToMember, mTypeToTType, tClass)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mClass, tMember,
								mModifier, mDefinition, defToMember, mTypeToTType, tClass);
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mClass, tMember, mModifier, mDefinition, defToMember, mTypeToTType, tClass);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mClass] = " + mClass + ", "
							+ "[tMember] = " + tMember + ", " + "[mModifier] = " + mModifier + ", " + "[mDefinition] = "
							+ mDefinition + ", " + "[defToMember] = " + defToMember + ", " + "[mTypeToTType] = "
							+ mTypeToTType + ", " + "[tClass] = " + tClass + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ClassDeclaration mClass, TMember tMember,
			Modifier mModifier, MDefinition mDefinition, MDefinitionToTMember defToMember,
			TypeToTAbstractType mTypeToTType, TClass tClass) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mClass, EObject tMember, EObject mModifier,
			EObject mDefinition, EObject tModifier, EObject defToMember, EObject mModifierToTModifier,
			EObject mTypeToTType, EObject tClass) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_11_1_performtransformation_greenFBBFB(mDefinition, tModifier, csp);
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mClass, tMember,
						mModifier, mDefinition, tModifier, defToMember, mModifierToTModifier, mTypeToTType, tClass);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mClass] = " + mClass + ", " + "[tMember] = " + tMember + ", " + "[mModifier] = "
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_11_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, tMember, mModifier, mDefinition, tModifier, mModifierToTModifier);
		//nothing EMoflonEdge mDefinition__mModifier____modifier = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mModifier__mDefinition____bodyDeclaration = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge tMember__tModifier____tModifier = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge mModifierToTModifier__tModifier____target = (EMoflonEdge) result3_green[9];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_12_2_corematch_blackFBFBFFBB(tMember, tModifier, tClass, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_12_3_findcontext_blackBBBBBBB(mClass, tMember, mDefinition,
							tModifier, defToMember, mTypeToTType, tClass)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mClass, tMember,
								mDefinition, tModifier, defToMember, mTypeToTType, tClass);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tMember__tModifier____tModifier = (EMoflonEdge) result3_green[8];
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mClass, tMember, mDefinition, tModifier, defToMember, mTypeToTType,
								tClass);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mClass] = " + mClass + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration mClass, TMember tMember,
			MDefinition mDefinition, TModifier tModifier, MDefinitionToTMember defToMember,
			TypeToTAbstractType mTypeToTType, TClass tClass) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mClass, EObject tMember, EObject mModifier,
			EObject mDefinition, EObject tModifier, EObject defToMember, EObject mModifierToTModifier,
			EObject mTypeToTType, EObject tClass) {
		ruleresult.registerObject("mClass", mClass);
		ruleresult.registerObject("tMember", tMember);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_48(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_50(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mClass, tMember,
						mModifier, mDefinition, tModifier, tClass, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mClass] = " + mClass + ", " + "[tMember] = " + tMember + ", " + "[mModifier] = " + mModifier
		...
		if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackBBBFFBBB(mClass, tMember, mDefinition,
				...
				Object[] result6_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(mClass, tMember,
								mModifier, mDefinition, tModifier, tClass, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ClassDeclaration mClass, TMember tMember, Modifier mModifier,
			MDefinition mDefinition, TModifier tModifier, TClass tClass, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mClass, tMember, mDefinition, defToMember, mTypeToTType, tClass, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mClass] = " + mClass + ", "
						+ "[tMember] = " + tMember + ", " + "[mDefinition] = " + mDefinition + ", " + "[defToMember] = "
						+ defToMember + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tClass] = " + tClass + ", "
			...
			if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(mClass, tMember, mDefinition,
								defToMember, mTypeToTType, tClass);
				if (result5_black != null) {

					Object[] result6_black = MemberInClassVisibilityImpl
							.pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(mClass, tMember, mDefinition,
									defToMember, mTypeToTType, tClass, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mClass] = " + mClass
								+ ", " + "[tMember] = " + tMember + ", " + "[mDefinition] = " + mDefinition + ", "
					...
					MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_29_6_perform_greenBFBFFBB(tMember,
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration mClass, TMember tMember,
			MDefinition mDefinition, MDefinitionToTMember defToMember, TypeToTAbstractType mTypeToTType, TClass tClass,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSDECLARATION_TMEMBER_MODIFIER_MDEFINITION_MDEFINITIONTOTMEMBER_TYPETOTABSTRACTTYPE_TCLASS:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(TMember) arguments.get(2), (Modifier) arguments.get(3), (MDefinition) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_TMEMBER_MDEFINITION_TMODIFIER_MDEFINITIONTOTMEMBER_TYPETOTABSTRACTTYPE_TCLASS:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_48__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_48((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_50__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__CLASSDECLARATION_TMEMBER_MODIFIER_MDEFINITION_TMODIFIER_TCLASS_MATCH_MATCH:
			return isApplicable_solveCsp_CC((ClassDeclaration) arguments.get(0), (TMember) arguments.get(1),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_TMEMBER_MDEFINITION_MDEFINITIONTOTMEMBER_TYPETOTABSTRACTTYPE_TCLASS_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(TMember) arguments.get(2), (MDefinition) arguments.get(3), (MDefinitionToTMember) arguments.get(4),
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								if (tmpTClass instanceof TClass) {
									...
									return new Object[] { mClass, tMember, mModifier, mDefinition, defToMember,
											mTypeToTType, tClass, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			ClassDeclaration mClass, TMember tMember, Modifier mModifier, MDefinition mDefinition,
			MDefinitionToTMember defToMember, TypeToTAbstractType mTypeToTType, TClass tClass,
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mClass, tMember, mModifier, mDefinition, defToMember, mTypeToTType, tClass, csp,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_1_1_performtransformation_binding != null) {
			...
			MDefinitionToTMember defToMember = (MDefinitionToTMember) result_pattern_MemberInClassVisibility_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_MemberInClassVisibility_1_1_performtransformation_black = pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mClass, tMember, mModifier, mDefinition, defToMember, mTypeToTType, tClass, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mClass, EObject tMember, EObject mModifier, EObject mDefinition,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tMember, EObject mModifier, EObject mDefinition, EObject tModifier,
		...
		return new Object[] { ruleresult, tMember, mModifier, mDefinition, tModifier, mModifierToTModifier,
	...
	public static final void pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInClassVisibility _this, PerformRuleResult ruleresult, EObject mClass, EObject tMember,
			EObject mModifier, EObject mDefinition, EObject tModifier, EObject defToMember,
			EObject mModifierToTModifier, EObject mTypeToTType, EObject tClass) {
		_this.registerObjects_FWD(ruleresult, mClass, tMember, mModifier, mDefinition, tModifier, defToMember,
				mModifierToTModifier, mTypeToTType, tClass);
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTClass instanceof TClass) {
						TClass tClass = (TClass) tmpTClass;
						_result.add(new Object[] { mClass, tMember, mModifier, mDefinition, defToMember, mTypeToTType,
								tClass, match });
					}
						...
						if (mClass.equals(mTypeToTType.getSource())) {
							if (tClass.getDefines().contains(tMember)) {
								if (tClass.equals(mTypeToTType.getTarget())) {
									_result.add(new Object[] { mClass, tMember, mModifier, mDefinition, defToMember,
											mTypeToTType, tClass });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mClass, tMember, mModifier, mDefinition, defToMember, mTypeToTType, tClass,
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			TMember tMember, Modifier mModifier, MDefinition mDefinition, MDefinitionToTMember defToMember,
			TypeToTAbstractType mTypeToTType, TClass tClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mClass, tMember, mModifier,
				mDefinition, defToMember, mTypeToTType, tClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mClass, tMember, mModifier, mDefinition, defToMember,
					mTypeToTType, tClass };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_2_4_solveCSP_binding = pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mClass, tMember, mModifier, mDefinition, defToMember, mTypeToTType, tClass);
		if (result_pattern_MemberInClassVisibility_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mClass, tMember, mModifier, mDefinition,
						defToMember, mTypeToTType, tClass };
			}
		}
		return null;
					...
					if (tmpTModifier instanceof TModifier) {
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								if (tmpTClass instanceof TClass) {
									TClass tClass = (TClass) tmpTClass;
									return new Object[] { mClass, tMember, mDefinition, tModifier, defToMember,
											mTypeToTType, tClass, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			ClassDeclaration mClass, TMember tMember, MDefinition mDefinition, TModifier tModifier,
			MDefinitionToTMember defToMember, TypeToTAbstractType mTypeToTType, TClass tClass,
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mClass, tMember, mDefinition, tModifier, defToMember, mTypeToTType, tClass, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_11_1_performtransformation_black = pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					mClass, tMember, mDefinition, tModifier, defToMember, mTypeToTType, tClass, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_greenFBBFB(
		...
		return new Object[] { mModifier, mDefinition, tModifier, mModifierToTModifier, csp };
	}
	...
	public static final void pattern_MemberInClassVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mModifier, EObject mDefinition, EObject tModifier, EObject defToMember,
			EObject mModifierToTModifier, EObject mTypeToTType, EObject tClass) {
		_this.registerObjects_BWD(ruleresult, mClass, tMember, mModifier, mDefinition, tModifier, defToMember,
				mModifierToTModifier, mTypeToTType, tClass);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_12_2_corematch_blackFBFBFFBB(TMember tMember,
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMDefinition instanceof MDefinition) {
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMClass instanceof ClassDeclaration) {
						ClassDeclaration mClass = (ClassDeclaration) tmpMClass;
						_result.add(new Object[] { mClass, tMember, mDefinition, tModifier, defToMember, mTypeToTType,
								tClass, match });
					}
				...
				if (mClass.getBodyDeclarations().contains(mDefinition)) {
					if (mDefinition.equals(defToMember.getSource())) {
						if (mClass.equals(mTypeToTType.getSource())) {
							if (tClass.getDefines().contains(tMember)) {
								if (tClass.equals(mTypeToTType.getTarget())) {
									_result.add(new Object[] { mClass, tMember, mDefinition, tModifier, defToMember,
											mTypeToTType, tClass });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		tMember__tClass____definedBy.setName(tMember__tClass____definedBy_name_prime);
		mTypeToTType__tClass____target.setName(mTypeToTType__tClass____target_name_prime);
		return new Object[] { mClass, tMember, mDefinition, tModifier, defToMember, mTypeToTType, tClass,
				...
				defToMember__mDefinition____source, mTypeToTType__mClass____source, tClass__tMember____defines,
				tMember__tClass____definedBy, mTypeToTType__tClass____target };
	}

	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch, ClassDeclaration mClass,
			TMember tMember, MDefinition mDefinition, TModifier tModifier, MDefinitionToTMember defToMember,
			TypeToTAbstractType mTypeToTType, TClass tClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mClass, tMember, mDefinition,
				tModifier, defToMember, mTypeToTType, tClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mClass, tMember, mDefinition, tModifier, defToMember,
					mTypeToTType, tClass };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_12_4_solveCSP_binding = pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mClass, tMember, mDefinition, tModifier, defToMember, mTypeToTType, tClass);
		if (result_pattern_MemberInClassVisibility_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mClass, tMember, mDefinition, tModifier,
						defToMember, mTypeToTType, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_387527 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_387527)) {
				...
				if (tmpMModifier instanceof Modifier) {
					...
					if (tmpMDefinition instanceof MDefinition) {
						...
						if (tmpTModifier instanceof TModifier) {
							...
							if (tmpTClass instanceof TClass) {
								TClass tClass = (TClass) tmpTClass;
								return new Object[] { mClass, tMember, mModifier, mDefinition, tModifier, tClass,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			ClassDeclaration mClass, TMember tMember, Modifier mModifier, MDefinition mDefinition, TModifier tModifier,
			TClass tClass, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mClass, tMember, mModifier, mDefinition, tModifier, tClass, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mClass, tMember, mModifier, mDefinition, tModifier, tClass, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, ClassDeclaration mClass, TMember tMember, Modifier mModifier,
			MDefinition mDefinition, TModifier tModifier, TClass tClass, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mClass, tMember, mModifier, mDefinition, tModifier,
				tClass, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mClass, tMember, mModifier, mDefinition, tModifier, tClass, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_24_3_solvecsp_binding = pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mClass, tMember, mModifier, mDefinition, tModifier, tClass, sourceMatch, targetMatch);
		if (result_pattern_MemberInClassVisibility_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mClass, tMember, mModifier, mDefinition, tModifier, tClass,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackBBBFFBBB(
			ClassDeclaration mClass, TMember tMember, MDefinition mDefinition, TClass tClass, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mDefinition.equals(defToMember.getSource())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mClass, TypeToTAbstractType.class, "source")) {
						if (tClass.equals(mTypeToTType.getTarget())) {
							_result.add(new Object[] { mClass, tMember, mDefinition, defToMember, mTypeToTType, tClass,
									sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(
			ClassDeclaration mClass, TMember tMember, Modifier mModifier, MDefinition mDefinition, TModifier tModifier,
			TClass tClass, CCMatch ccMatch) {
		return new Object[] { mClass, tMember, mModifier, mDefinition, tModifier, tClass, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_325703 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_325703)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch, ClassDeclaration mClass,
			TMember tMember, MDefinition mDefinition, MDefinitionToTMember defToMember,
			TypeToTAbstractType mTypeToTType, TClass tClass, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mClass, tMember, mDefinition,
				defToMember, mTypeToTType, tClass, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mClass, tMember, mDefinition, defToMember,
					mTypeToTType, tClass, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_29_3_solveCSP_binding = pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mClass, tMember, mDefinition, defToMember, mTypeToTType, tClass, ruleResult);
	...
	public static final Object[] pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(ClassDeclaration mClass,
			TMember tMember, MDefinition mDefinition, MDefinitionToTMember defToMember,
			TypeToTAbstractType mTypeToTType, TClass tClass) {
		return new Object[] { mClass, tMember, mDefinition, defToMember, mTypeToTType, tClass };
	}

	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(ClassDeclaration mClass,
			TMember tMember, MDefinition mDefinition, MDefinitionToTMember defToMember,
			TypeToTAbstractType mTypeToTType, TClass tClass, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mClass, tMember, mDefinition, defToMember, mTypeToTType, tClass, ruleResult };
	}

	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_greenBFBFFBB(TMember tMember,
		...
		return new Object[] { tMember, mModifier, mDefinition, tModifier, mModifierToTModifier, ruleResult, csp };
	}
