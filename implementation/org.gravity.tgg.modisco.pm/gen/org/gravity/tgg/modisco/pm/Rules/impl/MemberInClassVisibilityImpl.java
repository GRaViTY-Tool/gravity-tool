...
public class MemberInClassVisibilityImpl extends AbstractRuleImpl implements MemberInClassVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tModifier,
						mModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mModifierToTModifier,
						mDefinition);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tModifier] = " + tModifier + ", " + "[mModifier] = " + mModifier + ", "
					+ "[mTypeToTType] = " + mTypeToTType + ", " + "[tClass] = " + tClass + ", " + "[defToMember] = "
					+ defToMember + ", " + "[tMember] = " + tMember + ", " + "[mClass] = " + mClass + ", "
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				tModifier, mModifier, tMember, mModifierToTModifier, mDefinition);
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tModifier, mModifier, mTypeToTType, tClass, defToMember, tMember, mClass,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_2_2_corematch_blackBFFFFBBB(mModifier, mClass, mDefinition, match)) {
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(mModifier, mTypeToTType, tClass,
							defToMember, tMember, mClass, mDefinition)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mModifier,
								mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition);
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Modifier mModifier,
			TypeToTAbstractType mTypeToTType, TClass tClass, MDefinitionToTMember defToMember, TMember tMember,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tModifier, EObject mModifier,
			EObject mTypeToTType, EObject tClass, EObject defToMember, EObject tMember, EObject mClass,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_11_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, tModifier, mModifier, tMember, mModifierToTModifier, mDefinition);
		//nothing EMoflonEdge mModifierToTModifier__mModifier____source = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mModifierToTModifier__tModifier____target = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge tMember__tModifier____tModifier = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge mDefinition__mModifier____modifier = (EMoflonEdge) result3_green[9];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			// ForEach 
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_12_3_findcontext_blackBBBBBBB(tModifier, mTypeToTType, tClass,
							defToMember, tMember, mClass, mDefinition)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tModifier,
								mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mTypeToTType__tClass____target = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tClass__tMember____defines = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, tModifier, mTypeToTType, tClass, defToMember, tMember, mClass,
								mDefinition);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_62(EMoflonEdge _edge_tModifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tModifier, mModifier,
						tClass, tMember, mClass, mDefinition, sourceMatch, targetMatch);
		...
		if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackFBFBBBBB(tClass, tMember, mClass,
				...
				Object[] result6_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(tModifier, mModifier,
								tClass, tMember, mClass, mDefinition, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TModifier tModifier, Modifier mModifier, TClass tClass, TMember tMember,
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(mTypeToTType, tClass, defToMember,
								tMember, mClass, mDefinition);
				if (result5_black != null) {

					Object[] result6_black = MemberInClassVisibilityImpl
							.pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(mTypeToTType, tClass,
									defToMember, tMember, mClass, mDefinition, ruleResult);
					if (result6_black == null) {
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			TClass tClass, MDefinitionToTMember defToMember, TMember tMember, ClassDeclaration mClass,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_TYPETOTABSTRACTTYPE_TCLASS_MDEFINITIONTOTMEMBER_TMEMBER_CLASSDECLARATION_MDEFINITION:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMODIFIER_TYPETOTABSTRACTTYPE_TCLASS_MDEFINITIONTOTMEMBER_TMEMBER_CLASSDECLARATION_MDEFINITION:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_62__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_62((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_66__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__TMODIFIER_MODIFIER_TCLASS_TMEMBER_CLASSDECLARATION_MDEFINITION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TModifier) arguments.get(0), (Modifier) arguments.get(1),
					(TClass) arguments.get(2), (TMember) arguments.get(3), (ClassDeclaration) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TCLASS_MDEFINITIONTOTMEMBER_TMEMBER_CLASSDECLARATION_MDEFINITION_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					...
					(ClassDeclaration) arguments.get(5), (MDefinition) arguments.get(6),
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpMClass instanceof ClassDeclaration) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									...
									return new Object[] { mModifier, mTypeToTType, tClass, defToMember, tMember, mClass,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			Modifier mModifier, TypeToTAbstractType mTypeToTType, TClass tClass, MDefinitionToTMember defToMember,
			TMember tMember, ClassDeclaration mClass, MDefinition mDefinition, MemberInClassVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition, csp,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_1_1_performtransformation_black = pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tModifier, EObject mModifier, EObject mTypeToTType, EObject tClass,
			EObject defToMember, EObject tMember, EObject mClass, EObject mModifierToTModifier, EObject mDefinition) {
	...
	public static final void pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInClassVisibility _this, PerformRuleResult ruleresult, EObject tModifier, EObject mModifier,
			EObject mTypeToTType, EObject tClass, EObject defToMember, EObject tMember, EObject mClass,
			EObject mModifierToTModifier, EObject mDefinition) {
		_this.registerObjects_FWD(ruleresult, tModifier, mModifier, mTypeToTType, tClass, defToMember, tMember, mClass,
				mModifierToTModifier, mDefinition);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_2_2_corematch_blackBFFFFBBB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTClass instanceof TClass) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { mModifier, mTypeToTType, tClass, defToMember, tMember, mClass,
								mDefinition, match });
					}
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(
			Modifier mModifier, TypeToTAbstractType mTypeToTType, TClass tClass, MDefinitionToTMember defToMember,
			TMember tMember, ClassDeclaration mClass, MDefinition mDefinition) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
						...
						if (mClass.equals(mTypeToTType.getSource())) {
							if (mDefinition.equals(defToMember.getSource())) {
								if (mModifier.equals(mDefinition.getModifier())) {
									_result.add(new Object[] { mModifier, mTypeToTType, tClass, defToMember, tMember,
											mClass, mDefinition });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		mDefinition__mModifier____modifier.setName(mDefinition__mModifier____modifier_name_prime);
		mModifier__mDefinition____bodyDeclaration.setName(mModifier__mDefinition____bodyDeclaration_name_prime);
		return new Object[] { mModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition,
				isApplicableMatch, mTypeToTType__tClass____target, tClass__tMember____defines,
				tMember__tClass____definedBy, defToMember__tMember____target, mClass__mDefinition____bodyDeclarations,
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			TypeToTAbstractType mTypeToTType, TClass tClass, MDefinitionToTMember defToMember, TMember tMember,
			ClassDeclaration mClass, MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModifier, mTypeToTType, tClass,
				defToMember, tMember, mClass, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, mTypeToTType, tClass, defToMember, tMember,
					mClass, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_2_4_solveCSP_binding = pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition);
		if (result_pattern_MemberInClassVisibility_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mModifier, mTypeToTType, tClass, defToMember,
						tMember, mClass, mDefinition };
			}
		}
		return null;
					...
					if (tmpDefToMember instanceof MDefinitionToTMember) {
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpMClass instanceof ClassDeclaration) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									MDefinition mDefinition = (MDefinition) tmpMDefinition;
									return new Object[] { tModifier, mTypeToTType, tClass, defToMember, tMember, mClass,
											mDefinition, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TModifier tModifier, TypeToTAbstractType mTypeToTType, TClass tClass, MDefinitionToTMember defToMember,
			TMember tMember, ClassDeclaration mClass, MDefinition mDefinition, MemberInClassVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_11_1_performtransformation_black = pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					tModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInClassVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mTypeToTType, EObject tClass, EObject defToMember, EObject tMember, EObject mClass,
			EObject mModifierToTModifier, EObject mDefinition) {
		_this.registerObjects_BWD(ruleresult, tModifier, mModifier, mTypeToTType, tClass, defToMember, tMember, mClass,
				mModifierToTModifier, mDefinition);
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMClass instanceof ClassDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tModifier, mTypeToTType, tClass, defToMember, tMember, mClass,
								mDefinition, match });
					}
					...
					if (mClass.getBodyDeclarations().contains(mDefinition)) {
						if (mClass.equals(mTypeToTType.getSource())) {
							if (tModifier.equals(tMember.getTModifier())) {
								if (mDefinition.equals(defToMember.getSource())) {
									_result.add(new Object[] { tModifier, mTypeToTType, tClass, defToMember, tMember,
											mClass, mDefinition });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		tMember__tModifier____tModifier.setName(tMember__tModifier____tModifier_name_prime);
		defToMember__mDefinition____source.setName(defToMember__mDefinition____source_name_prime);
		return new Object[] { tModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition,
				isApplicableMatch, mTypeToTType__tClass____target, tClass__tMember____defines,
				tMember__tClass____definedBy, defToMember__tMember____target, mClass__mDefinition____bodyDeclarations,
				mDefinition__mClass____abstractTypeDeclaration, mTypeToTType__mClass____source,
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			TypeToTAbstractType mTypeToTType, TClass tClass, MDefinitionToTMember defToMember, TMember tMember,
			ClassDeclaration mClass, MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tModifier, mTypeToTType, tClass,
				defToMember, tMember, mClass, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tModifier, mTypeToTType, tClass, defToMember, tMember,
					mClass, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_12_4_solveCSP_binding = pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tModifier, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition);
		if (result_pattern_MemberInClassVisibility_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tModifier, mTypeToTType, tClass, defToMember,
						tMember, mClass, mDefinition };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_357432 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_357432)) {
				...
				if (tmpTClass instanceof TClass) {
					...
					if (tmpTMember instanceof TMember) {
						...
						if (tmpMClass instanceof ClassDeclaration) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								MDefinition mDefinition = (MDefinition) tmpMDefinition;
								return new Object[] { tModifier, mModifier, tClass, tMember, mClass, mDefinition,
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TModifier tModifier, Modifier mModifier, TClass tClass, TMember tMember, ClassDeclaration mClass,
			MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tModifier, mModifier, tClass, tMember, mClass, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tModifier, mModifier, tClass, tMember, mClass, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, TModifier tModifier, Modifier mModifier, TClass tClass, TMember tMember,
			ClassDeclaration mClass, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tModifier, mModifier, tClass, tMember, mClass,
				mDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tModifier, mModifier, tClass, tMember, mClass, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_24_3_solvecsp_binding = pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tModifier, mModifier, tClass, tMember, mClass, mDefinition, sourceMatch, targetMatch);
		if (result_pattern_MemberInClassVisibility_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tModifier, mModifier, tClass, tMember, mClass, mDefinition,
						sourceMatch, targetMatch };
			}
		}
		return null;
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mClass.equals(mTypeToTType.getSource())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tMember, MDefinitionToTMember.class, "target")) {
						if (mDefinition.equals(defToMember.getSource())) {
							_result.add(new Object[] { mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition,
									sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tModifier, mModifier, tClass, tMember, mClass, mDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_111624 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_111624)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mTypeToTType, tClass, defToMember,
				tMember, mClass, mDefinition, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, tClass, defToMember, tMember, mClass,
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_29_3_solveCSP_binding = pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition, ruleResult);
	...
	public static final Object[] pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(
			TypeToTAbstractType mTypeToTType, TClass tClass, MDefinitionToTMember defToMember, TMember tMember,
			ClassDeclaration mClass, MDefinition mDefinition) {
		return new Object[] { mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(
		...
		return new Object[] { mTypeToTType, tClass, defToMember, tMember, mClass, mDefinition, ruleResult };
	}
