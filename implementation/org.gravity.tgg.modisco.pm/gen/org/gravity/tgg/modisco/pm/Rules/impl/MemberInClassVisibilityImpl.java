...
public class MemberInClassVisibilityImpl extends AbstractRuleImpl implements MemberInClassVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_1_performtransformation_greenBFBFB(mModifier, tMember, csp);
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mModifier, mClass,
						mTypeToTType, tClass, mDefinition, mModifierToTModifier, tMember, defToMember, tModifier);
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				mModifier, mDefinition, mModifierToTModifier, tMember, tModifier);
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mModifier, mClass, mTypeToTType, tClass, mDefinition, mModifierToTModifier, tMember,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_2_2_corematch_blackBBFFBFFB(mModifier, mClass, mDefinition, match)) {
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(mModifier, mClass, mTypeToTType,
							tClass, mDefinition, tMember, defToMember)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mModifier, mClass,
								mTypeToTType, tClass, mDefinition, tMember, defToMember);
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mModifier, mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mModifier] = " + mModifier + ", "
							+ "[mClass] = " + mClass + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tClass] = "
							+ tClass + ", " + "[mDefinition] = " + mDefinition + ", " + "[tMember] = " + tMember + ", "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Modifier mModifier,
			ClassDeclaration mClass, TypeToTAbstractType mTypeToTType, TClass tClass, MDefinition mDefinition,
			TMember tMember, MDefinitionToTMember defToMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject mClass,
			EObject mTypeToTType, EObject tClass, EObject mDefinition, EObject mModifierToTModifier, EObject tMember,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_11_1_performtransformation_greenFBFBB(mDefinition, tModifier, csp);
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mModifier, mClass,
						mTypeToTType, tClass, mDefinition, mModifierToTModifier, tMember, defToMember, tModifier);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModifier] = " + mModifier + ", " + "[mClass] = " + mClass + ", " + "[mTypeToTType] = "
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_11_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, mModifier, mDefinition, mModifierToTModifier, tMember, tModifier);
		//nothing EMoflonEdge mDefinition__mModifier____modifier = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mModifier__mDefinition____bodyDeclaration = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mModifierToTModifier__mModifier____source = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge tMember__tModifier____tModifier = (EMoflonEdge) result3_green[9];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_12_2_corematch_blackFFBFBFBB(tClass, tMember, tModifier, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_12_3_findcontext_blackBBBBBBB(mClass, mTypeToTType, tClass,
							mDefinition, tMember, defToMember, tModifier)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mClass, mTypeToTType,
								tClass, mDefinition, tMember, defToMember, tModifier);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tClass__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tClass____definedBy = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mClass__mDefinition____bodyDeclarations = (EMoflonEdge) result3_green[10];
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember,
								tModifier);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration mClass,
			TypeToTAbstractType mTypeToTType, TClass tClass, MDefinition mDefinition, TMember tMember,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mModifier, EObject mClass,
			EObject mTypeToTType, EObject tClass, EObject mDefinition, EObject mModifierToTModifier, EObject tMember,
			EObject defToMember, EObject tModifier) {
		ruleresult.registerObject("mModifier", mModifier);
		ruleresult.registerObject("mClass", mClass);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_99(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_103(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mModifier, mClass,
						tClass, mDefinition, tMember, tModifier, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mModifier] = " + mModifier + ", " + "[mClass] = " + mClass + ", " + "[tClass] = " + tClass
					+ ", " + "[mDefinition] = " + mDefinition + ", " + "[tMember] = " + tMember + ", "
		...
		if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackBFBBBFBB(mClass, tClass, mDefinition,
				...
				Object[] result6_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(mModifier, mClass,
								tClass, mDefinition, tMember, tModifier, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModifier] = "
							+ mModifier + ", " + "[mClass] = " + mClass + ", " + "[tClass] = " + tClass + ", "
							+ "[mDefinition] = " + mDefinition + ", " + "[tMember] = " + tMember + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Modifier mModifier, ClassDeclaration mClass, TClass tClass,
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mClass] = " + mClass + ", "
						+ "[mTypeToTType] = " + mTypeToTType + ", " + "[tClass] = " + tClass + ", " + "[mDefinition] = "
			...
			if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(mClass, mTypeToTType, tClass,
								mDefinition, tMember, defToMember);
				if (result5_black != null) {

					Object[] result6_black = MemberInClassVisibilityImpl
							.pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(mClass, mTypeToTType, tClass,
									mDefinition, tMember, defToMember, ruleResult);
					if (result6_black == null) {
					...
					MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_29_6_perform_greenFBFBFBB(mDefinition,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_CLASSDECLARATION_TYPETOTABSTRACTTYPE_TCLASS_MDEFINITION_TMEMBER_MDEFINITIONTOTMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Modifier) arguments.get(1),
					...
					(TClass) arguments.get(4), (MDefinition) arguments.get(5), (TMember) arguments.get(6),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_TYPETOTABSTRACTTYPE_TCLASS_MDEFINITION_TMEMBER_MDEFINITIONTOTMEMBER_TMODIFIER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(TypeToTAbstractType) arguments.get(2), (TClass) arguments.get(3), (MDefinition) arguments.get(4),
					(TMember) arguments.get(5), (MDefinitionToTMember) arguments.get(6), (TModifier) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_99__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_99((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_103__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__MODIFIER_CLASSDECLARATION_TCLASS_MDEFINITION_TMEMBER_TMODIFIER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Modifier) arguments.get(0), (ClassDeclaration) arguments.get(1),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_TYPETOTABSTRACTTYPE_TCLASS_MDEFINITION_TMEMBER_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(TypeToTAbstractType) arguments.get(2), (TClass) arguments.get(3), (MDefinition) arguments.get(4),
					(TMember) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpDefToMember instanceof MDefinitionToTMember) {
									...
									return new Object[] { mModifier, mClass, mTypeToTType, tClass, mDefinition, tMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			Modifier mModifier, ClassDeclaration mClass, TypeToTAbstractType mTypeToTType, TClass tClass,
			MDefinition mDefinition, TMember tMember, MDefinitionToTMember defToMember, MemberInClassVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember, csp,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_1_1_performtransformation_binding != null) {
			...
			TMember tMember = (TMember) result_pattern_MemberInClassVisibility_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_MemberInClassVisibility_1_1_performtransformation_black = pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_greenBFBFB(
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifier, EObject mClass, EObject mTypeToTType, EObject tClass,
			EObject mDefinition, EObject mModifierToTModifier, EObject tMember, EObject defToMember,
			EObject tModifier) {
	...
	public static final void pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInClassVisibility _this, PerformRuleResult ruleresult, EObject mModifier, EObject mClass,
			EObject mTypeToTType, EObject tClass, EObject mDefinition, EObject mModifierToTModifier, EObject tMember,
			EObject defToMember, EObject tModifier) {
		_this.registerObjects_FWD(ruleresult, mModifier, mClass, mTypeToTType, tClass, mDefinition,
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_2_2_corematch_blackBBFFBFFB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTClass instanceof TClass) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { mModifier, mClass, mTypeToTType, tClass, mDefinition, tMember,
								defToMember, match });
					}
						...
						if (tClass.equals(mTypeToTType.getTarget())) {
							if (mDefinition.equals(defToMember.getSource())) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { mModifier, mClass, mTypeToTType, tClass, mDefinition,
											tMember, defToMember });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mModifier, mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch, Modifier mModifier,
			ClassDeclaration mClass, TypeToTAbstractType mTypeToTType, TClass tClass, MDefinition mDefinition,
			TMember tMember, MDefinitionToTMember defToMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModifier, mClass, mTypeToTType,
				tClass, mDefinition, tMember, defToMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, mClass, mTypeToTType, tClass, mDefinition,
					tMember, defToMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_2_4_solveCSP_binding = pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember);
		if (result_pattern_MemberInClassVisibility_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mModifier, mClass, mTypeToTType, tClass,
						mDefinition, tMember, defToMember };
			}
		}
		return null;
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTModifier instanceof TModifier) {
									...
									return new Object[] { mClass, mTypeToTType, tClass, mDefinition, tMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			ClassDeclaration mClass, TypeToTAbstractType mTypeToTType, TClass tClass, MDefinition mDefinition,
			TMember tMember, MDefinitionToTMember defToMember, TModifier tModifier, MemberInClassVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember, tModifier, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_11_1_performtransformation_black = pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember, tModifier, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInClassVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mTypeToTType, EObject tClass, EObject mDefinition, EObject mModifierToTModifier, EObject tMember,
			EObject defToMember, EObject tModifier) {
		_this.registerObjects_BWD(ruleresult, mModifier, mClass, mTypeToTType, tClass, mDefinition,
				mModifierToTModifier, tMember, defToMember, tModifier);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_12_2_corematch_blackFFBFBFBB(TClass tClass,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMClass instanceof ClassDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember,
								tModifier, match });
					}
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_12_3_findcontext_blackBBBBBBB(
			ClassDeclaration mClass, TypeToTAbstractType mTypeToTType, TClass tClass, MDefinition mDefinition,
			TMember tMember, MDefinitionToTMember defToMember, TModifier tModifier) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (tClass.getDefines().contains(tMember)) {
			if (mClass.getBodyDeclarations().contains(mDefinition)) {
				if (mClass.equals(mTypeToTType.getSource())) {
					if (tClass.equals(mTypeToTType.getTarget())) {
						if (mDefinition.equals(defToMember.getSource())) {
							if (tModifier.equals(tMember.getTModifier())) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { mClass, mTypeToTType, tClass, mDefinition, tMember,
											defToMember, tModifier });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		tMember__tModifier____tModifier.setName(tMember__tModifier____tModifier_name_prime);
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		return new Object[] { mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember, tModifier,
				isApplicableMatch, tClass__tMember____defines, tMember__tClass____definedBy,
				mClass__mDefinition____bodyDeclarations, mDefinition__mClass____abstractTypeDeclaration,
				mTypeToTType__mClass____source, mTypeToTType__tClass____target, defToMember__mDefinition____source,
				tMember__tModifier____tModifier, defToMember__tMember____target };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mClass, mTypeToTType, tClass,
				mDefinition, tMember, defToMember, tModifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mClass, mTypeToTType, tClass, mDefinition, tMember,
					defToMember, tModifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_12_4_solveCSP_binding = pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember, tModifier);
	...
	public static final Object[] pattern_MemberInClassVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_680173 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_680173)) {
				...
				if (tmpTClass instanceof TClass) {
					...
					if (tmpMDefinition instanceof MDefinition) {
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpTModifier instanceof TModifier) {
								TModifier tModifier = (TModifier) tmpTModifier;
								return new Object[] { mModifier, mClass, tClass, mDefinition, tMember, tModifier,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			Modifier mModifier, ClassDeclaration mClass, TClass tClass, MDefinition mDefinition, TMember tMember,
			TModifier tModifier, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mModifier, mClass, tClass, mDefinition, tMember, tModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mModifier, mClass, tClass, mDefinition, tMember, tModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, Modifier mModifier, ClassDeclaration mClass, TClass tClass,
			MDefinition mDefinition, TMember tMember, TModifier tModifier, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mModifier, mClass, tClass, mDefinition, tMember,
				tModifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mModifier, mClass, tClass, mDefinition, tMember, tModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_24_3_solvecsp_binding = pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mModifier, mClass, tClass, mDefinition, tMember, tModifier, sourceMatch, targetMatch);
		if (result_pattern_MemberInClassVisibility_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mModifier, mClass, tClass, mDefinition, tMember, tModifier,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackBFBBBFBB(
			ClassDeclaration mClass, TClass tClass, MDefinition mDefinition, TMember tMember, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(
			Modifier mModifier, ClassDeclaration mClass, TClass tClass, MDefinition mDefinition, TMember tMember,
			TModifier tModifier, CCMatch ccMatch) {
		return new Object[] { mModifier, mClass, tClass, mDefinition, tMember, tModifier, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_490797 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_490797)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mClass, mTypeToTType, tClass,
				mDefinition, tMember, defToMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mClass, mTypeToTType, tClass, mDefinition, tMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_29_3_solveCSP_binding = pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember, ruleResult);
	...
	public static final Object[] pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(ClassDeclaration mClass,
		...
		return new Object[] { mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember };
	}

	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(ClassDeclaration mClass,
			TypeToTAbstractType mTypeToTType, TClass tClass, MDefinition mDefinition, TMember tMember,
			MDefinitionToTMember defToMember, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mClass, mTypeToTType, tClass, mDefinition, tMember, defToMember, ruleResult };
	}

	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_greenFBFBFBB(MDefinition mDefinition,
