...
public class MemberInClassVisibilityImpl extends AbstractRuleImpl implements MemberInClassVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mModifier,
						mModifierToTModifier, tMember, tModifier, tClass, defToMember, mClass, mDefinition,
						mTypeToTType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ tClass + ", " + "[defToMember] = " + defToMember + ", " + "[mClass] = " + mClass + ", "
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mModifier, mModifierToTModifier, tMember, tModifier, tClass, defToMember, mClass,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_2_2_corematch_blackBFFFBBFB(mModifier, mClass, mDefinition, match)) {
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(mModifier, tMember, tClass,
							defToMember, mClass, mDefinition, mTypeToTType)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mModifier, tMember,
								tClass, defToMember, mClass, mDefinition, mTypeToTType);
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mModifier, tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mModifier] = " + mModifier + ", "
							+ "[tMember] = " + tMember + ", " + "[tClass] = " + tClass + ", " + "[defToMember] = "
							+ defToMember + ", " + "[mClass] = " + mClass + ", " + "[mDefinition] = " + mDefinition
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Modifier mModifier, TMember tMember,
			TClass tClass, MDefinitionToTMember defToMember, ClassDeclaration mClass, MDefinition mDefinition,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject mModifierToTModifier,
			EObject tMember, EObject tModifier, EObject tClass, EObject defToMember, EObject mClass,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_12_2_corematch_blackBBBFFFFB(tMember, tModifier, tClass, match)) {
			MDefinitionToTMember defToMember = (MDefinitionToTMember) result2_black[3];
			...
			// ForEach 
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_12_3_findcontext_blackBBBBBBB(tMember, tModifier, tClass,
							defToMember, mClass, mDefinition, mTypeToTType)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tMember, tModifier,
								tClass, defToMember, mClass, mDefinition, mTypeToTType);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tClass__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tClass____definedBy = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, tMember, tModifier, tClass, defToMember, mClass, mDefinition,
								mTypeToTType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackBBFBBFBB(tMember, tClass, mClass,
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMember] = " + tMember + ", "
						+ "[tClass] = " + tClass + ", " + "[defToMember] = " + defToMember + ", " + "[mClass] = "
						+ mClass + ", " + "[mDefinition] = " + mDefinition + ", " + "[mTypeToTType] = " + mTypeToTType
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMember tMember, TClass tClass,
			MDefinitionToTMember defToMember, ClassDeclaration mClass, MDefinition mDefinition,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_TMEMBER_TCLASS_MDEFINITIONTOTMEMBER_CLASSDECLARATION_MDEFINITION_TYPETOTABSTRACTTYPE:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_TMODIFIER_TCLASS_MDEFINITIONTOTMEMBER_CLASSDECLARATION_MDEFINITION_TYPETOTABSTRACTTYPE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TMember) arguments.get(1),
					(TModifier) arguments.get(2), (TClass) arguments.get(3), (MDefinitionToTMember) arguments.get(4),
					(ClassDeclaration) arguments.get(5), (MDefinition) arguments.get(6),
					(TypeToTAbstractType) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_44__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_44((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_47__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_TCLASS_MDEFINITIONTOTMEMBER_CLASSDECLARATION_MDEFINITION_TYPETOTABSTRACTTYPE_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TMember) arguments.get(1),
					...
					(ClassDeclaration) arguments.get(4), (MDefinition) arguments.get(5),
						...
						if (tmpMClass instanceof ClassDeclaration) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpMTypeToTType instanceof TypeToTAbstractType) {
									...
									return new Object[] { mModifier, tMember, tClass, defToMember, mClass, mDefinition,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			Modifier mModifier, TMember tMember, TClass tClass, MDefinitionToTMember defToMember,
			ClassDeclaration mClass, MDefinition mDefinition, TypeToTAbstractType mTypeToTType,
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType, csp,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_1_1_performtransformation_black = pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject tModifier, EObject tClass, EObject defToMember, EObject mClass, EObject mDefinition,
	...
	public static final void pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mModifierToTModifier, EObject tMember, EObject tModifier, EObject tClass, EObject defToMember,
			EObject mClass, EObject mDefinition, EObject mTypeToTType) {
		_this.registerObjects_FWD(ruleresult, mModifier, mModifierToTModifier, tMember, tModifier, tClass, defToMember,
				mClass, mDefinition, mTypeToTType);
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTClass instanceof TClass) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { mModifier, tMember, tClass, defToMember, mClass, mDefinition,
								mTypeToTType, match });
					}
						...
						if (mClass.equals(mTypeToTType.getSource())) {
							if (mModifier.equals(mDefinition.getModifier())) {
								if (mDefinition.equals(defToMember.getSource())) {
									_result.add(new Object[] { mModifier, tMember, tClass, defToMember, mClass,
											mDefinition, mTypeToTType });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mModifier, tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType,
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModifier, tMember, tClass,
				defToMember, mClass, mDefinition, mTypeToTType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, tMember, tClass, defToMember, mClass,
					mDefinition, mTypeToTType };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_2_4_solveCSP_binding = pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType);
					...
					if (tmpDefToMember instanceof MDefinitionToTMember) {
						...
						if (tmpMClass instanceof ClassDeclaration) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpMTypeToTType instanceof TypeToTAbstractType) {
									TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) tmpMTypeToTType;
									return new Object[] { tMember, tModifier, tClass, defToMember, mClass, mDefinition,
											mTypeToTType, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TMember tMember, TModifier tModifier, TClass tClass, MDefinitionToTMember defToMember,
			ClassDeclaration mClass, MDefinition mDefinition, TypeToTAbstractType mTypeToTType,
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMember, tModifier, tClass, defToMember, mClass, mDefinition, mTypeToTType, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_11_1_performtransformation_black = pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					tMember, tModifier, tClass, defToMember, mClass, mDefinition, mTypeToTType, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInClassVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mModifierToTModifier, EObject tMember, EObject tModifier, EObject tClass, EObject defToMember,
			EObject mClass, EObject mDefinition, EObject mTypeToTType) {
		_this.registerObjects_BWD(ruleresult, mModifier, mModifierToTModifier, tMember, tModifier, tClass, defToMember,
				mClass, mDefinition, mTypeToTType);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_12_2_corematch_blackBBBFFFFB(TMember tMember,
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMDefinition instanceof MDefinition) {
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMClass instanceof ClassDeclaration) {
						ClassDeclaration mClass = (ClassDeclaration) tmpMClass;
						_result.add(new Object[] { tMember, tModifier, tClass, defToMember, mClass, mDefinition,
								mTypeToTType, match });
					}
				...
				if (tModifier.equals(tMember.getTModifier())) {
					if (mClass.getBodyDeclarations().contains(mDefinition)) {
						if (tClass.equals(mTypeToTType.getTarget())) {
							if (mClass.equals(mTypeToTType.getSource())) {
								if (mDefinition.equals(defToMember.getSource())) {
									_result.add(new Object[] { tMember, tModifier, tClass, defToMember, mClass,
											mDefinition, mTypeToTType });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mTypeToTType__mClass____source.setName(mTypeToTType__mClass____source_name_prime);
		defToMember__mDefinition____source.setName(defToMember__mDefinition____source_name_prime);
		return new Object[] { tMember, tModifier, tClass, defToMember, mClass, mDefinition, mTypeToTType,
				isApplicableMatch, tClass__tMember____defines, tMember__tClass____definedBy,
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch, TMember tMember, TModifier tModifier,
			TClass tClass, MDefinitionToTMember defToMember, ClassDeclaration mClass, MDefinition mDefinition,
			TypeToTAbstractType mTypeToTType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tMember, tModifier, tClass,
				defToMember, mClass, mDefinition, mTypeToTType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, tModifier, tClass, defToMember, mClass,
					mDefinition, mTypeToTType };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_12_4_solveCSP_binding = pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, tModifier, tClass, defToMember, mClass, mDefinition, mTypeToTType);
	...
	public static final Object[] pattern_MemberInClassVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_671974 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_671974)) {
			...
			for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mDefinition.equals(defToMember.getSource())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tClass, TypeToTAbstractType.class, "target")) {
						if (mClass.equals(mTypeToTType.getSource())) {
							_result.add(new Object[] { tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType,
									sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MemberInClassVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_369991 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_369991)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tMember, tClass, defToMember, mClass,
				mDefinition, mTypeToTType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, tClass, defToMember, mClass, mDefinition,
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_29_3_solveCSP_binding = pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType, ruleResult);
	...
	public static final Object[] pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(TMember tMember,
			TClass tClass, MDefinitionToTMember defToMember, ClassDeclaration mClass, MDefinition mDefinition,
			TypeToTAbstractType mTypeToTType) {
		return new Object[] { tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType };
	}

	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(TMember tMember,
			TClass tClass, MDefinitionToTMember defToMember, ClassDeclaration mClass, MDefinition mDefinition,
			TypeToTAbstractType mTypeToTType, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tMember, tClass, defToMember, mClass, mDefinition, mTypeToTType, ruleResult };
	}
