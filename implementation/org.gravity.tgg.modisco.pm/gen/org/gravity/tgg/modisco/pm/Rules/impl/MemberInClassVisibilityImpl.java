...
public class MemberInClassVisibilityImpl extends AbstractRuleImpl implements MemberInClassVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mClass, tMember,
						mDefinition, mModifier, mModifierToTModifier, mTypeToTType, defToMember, tClass, tModifier);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mClass] = " + mClass + ", " + "[tMember] = " + tMember + ", " + "[mDefinition] = "
					+ mDefinition + ", " + "[mModifier] = " + mModifier + ", " + "[mModifierToTModifier] = "
					+ mModifierToTModifier + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[defToMember] = "
					+ defToMember + ", " + "[tClass] = " + tClass + ", " + "[tModifier] = " + tModifier + ".");
		}
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mClass, tMember, mDefinition, mModifier, mModifierToTModifier, mTypeToTType, defToMember,
				tClass, tModifier);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(mClass, tMember, mDefinition,
							mModifier, mTypeToTType, defToMember, tClass)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mClass, tMember,
								mDefinition, mModifier, mTypeToTType, defToMember, tClass);
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mClass, tMember, mDefinition, mModifier, mTypeToTType, defToMember, tClass);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mClass, EObject tMember, EObject mDefinition,
			EObject mModifier, EObject mModifierToTModifier, EObject mTypeToTType, EObject defToMember, EObject tClass,
			EObject tModifier) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_12_3_findcontext_blackBBBBBBB(mClass, tMember, mDefinition,
							mTypeToTType, defToMember, tClass, tModifier)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mClass, tMember,
								mDefinition, mTypeToTType, defToMember, tClass, tModifier);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mClass__mDefinition____bodyDeclarations = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mDefinition__mClass____abstractTypeDeclaration = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass,
								tModifier);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mClass] = " + mClass + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration mClass, TMember tMember,
			MDefinition mDefinition, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember, TClass tClass,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mClass, EObject tMember, EObject mDefinition,
			EObject mModifier, EObject mModifierToTModifier, EObject mTypeToTType, EObject defToMember, EObject tClass,
			EObject tModifier) {
		ruleresult.registerObject("mClass", mClass);
		ruleresult.registerObject("tMember", tMember);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_727(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_747(EMoflonEdge _edge_modifier) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mClass] = " + mClass + ", "
						+ "[tMember] = " + tMember + ", " + "[mDefinition] = " + mDefinition + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSDECLARATION_TMEMBER_MDEFINITION_MODIFIER_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TCLASS:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(TMember) arguments.get(2), (MDefinition) arguments.get(3), (Modifier) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_TMEMBER_MDEFINITION_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TCLASS_TMODIFIER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(TMember) arguments.get(2), (MDefinition) arguments.get(3), (TypeToTAbstractType) arguments.get(4),
					(MDefinitionToTMember) arguments.get(5), (TClass) arguments.get(6), (TModifier) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_727__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_727((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_747__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_747((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__CLASSDECLARATION_TMEMBER_MDEFINITION_MODIFIER_TCLASS_TMODIFIER_MATCH_MATCH:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_TMEMBER_MDEFINITION_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TCLASS_MODELGENERATORRULERESULT:
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTClass instanceof TClass) {
									...
									return new Object[] { mClass, tMember, mDefinition, mModifier, mTypeToTType,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			ClassDeclaration mClass, TMember tMember, MDefinition mDefinition, Modifier mModifier,
			TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember, TClass tClass,
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mClass, tMember, mDefinition, mModifier, mTypeToTType, defToMember, tClass, csp,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_1_1_performtransformation_black = pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mClass, tMember, mDefinition, mModifier, mTypeToTType, defToMember, tClass, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mClass, EObject tMember, EObject mDefinition, EObject mModifier,
			EObject mModifierToTModifier, EObject mTypeToTType, EObject defToMember, EObject tClass,
			EObject tModifier) {
	...
	public static final void pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mDefinition, EObject mModifier, EObject mModifierToTModifier, EObject mTypeToTType,
			EObject defToMember, EObject tClass, EObject tModifier) {
		_this.registerObjects_FWD(ruleresult, mClass, tMember, mDefinition, mModifier, mModifierToTModifier,
				mTypeToTType, defToMember, tClass, tModifier);
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTClass instanceof TClass) {
						TClass tClass = (TClass) tmpTClass;
						_result.add(new Object[] { mClass, tMember, mDefinition, mModifier, mTypeToTType, defToMember,
								tClass, match });
					}
						...
						if (tClass.getDefines().contains(tMember)) {
							if (tClass.equals(mTypeToTType.getTarget())) {
								if (mClass.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { mClass, tMember, mDefinition, mModifier, mTypeToTType,
											defToMember, tClass });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mClass, tMember, mDefinition, mModifier, mTypeToTType, defToMember, tClass,
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mClass, tMember, mDefinition,
				mModifier, mTypeToTType, defToMember, tClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mClass, tMember, mDefinition, mModifier, mTypeToTType,
					defToMember, tClass };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_2_4_solveCSP_binding = pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mClass, tMember, mDefinition, mModifier, mTypeToTType, defToMember, tClass);
		if (result_pattern_MemberInClassVisibility_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mClass, tMember, mDefinition, mModifier,
						mTypeToTType, defToMember, tClass };
			}
		}
		return null;
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpTClass instanceof TClass) {
								...
								if (tmpTModifier instanceof TModifier) {
									...
									return new Object[] { mClass, tMember, mDefinition, mTypeToTType, defToMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			ClassDeclaration mClass, TMember tMember, MDefinition mDefinition, TypeToTAbstractType mTypeToTType,
			MDefinitionToTMember defToMember, TClass tClass, TModifier tModifier, MemberInClassVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass, tModifier, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_11_1_performtransformation_black = pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass, tModifier, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInClassVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mDefinition, EObject mModifier, EObject mModifierToTModifier, EObject mTypeToTType,
			EObject defToMember, EObject tClass, EObject tModifier) {
		_this.registerObjects_BWD(ruleresult, mClass, tMember, mDefinition, mModifier, mModifierToTModifier,
				mTypeToTType, defToMember, tClass, tModifier);
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMDefinition instanceof MDefinition) {
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMClass instanceof ClassDeclaration) {
						ClassDeclaration mClass = (ClassDeclaration) tmpMClass;
						_result.add(new Object[] { mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass,
								tModifier, match });
					}
				...
				if (tMember.equals(defToMember.getTarget())) {
					if (tModifier.equals(tMember.getTModifier())) {
						if (tClass.getDefines().contains(tMember)) {
							if (tClass.equals(mTypeToTType.getTarget())) {
								if (mClass.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { mClass, tMember, mDefinition, mTypeToTType, defToMember,
											tClass, tModifier });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mTypeToTType__tClass____target.setName(mTypeToTType__tClass____target_name_prime);
		mTypeToTType__mClass____source.setName(mTypeToTType__mClass____source_name_prime);
		return new Object[] { mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass, tModifier,
				isApplicableMatch, mClass__mDefinition____bodyDeclarations,
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mClass, tMember, mDefinition, mTypeToTType,
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_12_4_solveCSP_binding = pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass, tModifier);
	...
	public static final Object[] pattern_MemberInClassVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_330582 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_330582)) {
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			ClassDeclaration mClass, TMember tMember, MDefinition mDefinition, Modifier mModifier, TClass tClass,
	...
	public static final Object[] pattern_MemberInClassVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_137766 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_137766)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_29_3_solveCSP_binding = pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass, ruleResult);
	...
	public static final Object[] pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(ClassDeclaration mClass,
			TMember tMember, MDefinition mDefinition, TypeToTAbstractType mTypeToTType,
			MDefinitionToTMember defToMember, TClass tClass) {
		return new Object[] { mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass };
	}

	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(ClassDeclaration mClass,
			TMember tMember, MDefinition mDefinition, TypeToTAbstractType mTypeToTType,
			MDefinitionToTMember defToMember, TClass tClass, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mClass, tMember, mDefinition, mTypeToTType, defToMember, tClass, ruleResult };
	}
