...
public class EnumConstantImpl extends AbstractRuleImpl implements EnumConstant {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = EnumConstantImpl.pattern_EnumConstant_1_1_performtransformation_greenFBBFFBFFB(model,
		...
		Object[] result2_black = EnumConstantImpl.pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
				mDefinitionToTMember, mDefinition, tDefinition, tName, tSignature, mBodyToTAnnotation);
		...
		Object[] result3_black = EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, mDefinitionToTMember, model, mDefinition, mEnumToTEnum, tDefinition, tName, tEnum,
				tSignature, mBodyToTAnnotation, mEnum);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tDefinition] = " + tDefinition + ", " + "[tName] = " + tName + ", " + "[tEnum] = " + tEnum
		...
		EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult,
				mDefinitionToTMember, model, mDefinition, tDefinition, tName, tEnum, tSignature, mBodyToTAnnotation,
				mEnum);
		...
		EnumConstantImpl.pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				mDefinitionToTMember, model, mDefinition, mEnumToTEnum, tDefinition, tName, tEnum, tSignature,
				mBodyToTAnnotation, mEnum);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mDefinitionToTMember, EObject model,
			EObject mDefinition, EObject mEnumToTEnum, EObject tDefinition, EObject tName, EObject tEnum,
			EObject tSignature, EObject mBodyToTAnnotation, EObject mEnum) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TypeGraph model, TFieldDefinition tDefinition, TField tName,
		...
		Object[] result1_black = EnumConstantImpl.pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(this, match,
				model, tDefinition, tName, tEnum, tSignature);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = EnumConstantImpl.pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
				this, match, model, tDefinition, tName, tEnum, tSignature);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[model] = " + model + ", " + "[tDefinition] = " + tDefinition
					+ ", " + "[tName] = " + tName + ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = " + tSignature
		...
		if (EnumConstantImpl.pattern_EnumConstant_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = EnumConstantImpl
					.pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(match, model, tDefinition,
							tName, tEnum, tSignature);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[model] = " + model + ", " + "[tDefinition] = " + tDefinition + ", " + "[tName] = " + tName
			...
			EnumConstantImpl.pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(match, model,
					tDefinition, tName, tEnum, tSignature);
			...
			Object[] result5_black = EnumConstantImpl.pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(
					match, model, tDefinition, tName, tEnum, tSignature);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[model] = " + model + ", " + "[tDefinition] = " + tDefinition + ", " + "[tName] = " + tName
						+ ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = " + tSignature + ".");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = EnumConstantImpl
				.pattern_EnumConstant_11_1_performtransformation_greenFFBFBB(tDefinition, mEnum, csp);
		MDefinitionToTMember mDefinitionToTMember = (MDefinitionToTMember) result1_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_12_2_corematch_blackBFBBBBFB(model,
				tDefinition, tName, tEnum, tSignature, match)) {
			TypeToTAbstractType mEnumToTEnum = (TypeToTAbstractType) result2_black[1];
			...
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(model,
					mEnumToTEnum, tDefinition, tName, tEnum, tSignature, mEnum)) {
				Object[] result3_green = EnumConstantImpl
						.pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(model, mEnumToTEnum,
								tDefinition, tName, tEnum, tSignature, mEnum);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[model] = " + model + ", "
							+ "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[tDefinition] = " + tDefinition + ", "
							+ "[tName] = " + tName + ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = " + tSignature
							+ ", " + "[mEnum] = " + mEnum + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TypeGraph model, TFieldDefinition tDefinition, TField tName,
			TClass tEnum, TFieldSignature tSignature) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TypeGraph model, TFieldDefinition tDefinition, TField tName,
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeGraph model,
			TypeToTAbstractType mEnumToTEnum, TFieldDefinition tDefinition, TField tName, TClass tEnum,
			TFieldSignature tSignature, EnumDeclaration mEnum) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mDefinitionToTMember, EObject model,
			EObject mDefinition, EObject mEnumToTEnum, EObject tDefinition, EObject tName, EObject tEnum,
			EObject tSignature, EObject mBodyToTAnnotation, EObject mEnum) {
		ruleresult.registerObject("mDefinitionToTMember", mDefinitionToTMember);
		ruleresult.registerObject("model", model);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_236(EMoflonEdge _edge_defines) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_246(EMoflonEdge _edge_enumConstants) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = EnumConstantImpl
				.pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, model, mDefinition, tDefinition,
						tName, tEnum, tSignature, mEnum, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[model] = " + model + ", " + "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = "
					+ tDefinition + ", " + "[tName] = " + tName + ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = "
					+ tSignature + ", " + "[mEnum] = " + mEnum + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (EnumConstantImpl.pattern_EnumConstant_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : EnumConstantImpl.pattern_EnumConstant_24_5_matchcorrcontext_blackFBBBB(tEnum,
				...
				Object[] result6_black = EnumConstantImpl.pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(
						model, mDefinition, tDefinition, tName, tEnum, tSignature, mEnum, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeGraph model, MEnumConstantDeclaration mDefinition,
			TFieldDefinition tDefinition, TField tName, TClass tEnum, TFieldSignature tSignature, EnumDeclaration mEnum,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TypeGraph model, TFieldDefinition tDefinition, TField tName, TClass tEnum,
		...
		for (Object[] result2_black : EnumConstantImpl
			...
			if (EnumConstantImpl.pattern_EnumConstant_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					EnumConstantImpl.pattern_EnumConstant_29_6_perform_greenFBFFFBFFBBB(model, tEnum, mEnum, ruleResult,
							csp);
					//nothing MDefinitionToTMember mDefinitionToTMember = (MDefinitionToTMember) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD__MATCH_TYPEGRAPH_TFIELDDEFINITION_TFIELD_TCLASS_TFIELDSIGNATURE:
			return isAppropriate_BWD((Match) arguments.get(0), (TypeGraph) arguments.get(1),
					(TFieldDefinition) arguments.get(2), (TField) arguments.get(3), (TClass) arguments.get(4),
		...
		case RulesPackage.ENUM_CONSTANT___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TYPEGRAPH_TFIELDDEFINITION_TFIELD_TCLASS_TFIELDSIGNATURE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TypeGraph) arguments.get(1),
					(TFieldDefinition) arguments.get(2), (TField) arguments.get(3), (TClass) arguments.get(4),
					(TFieldSignature) arguments.get(5));
			return null;
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TYPEGRAPH_TFIELDDEFINITION_TFIELD_TCLASS_TFIELDSIGNATURE:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (TypeGraph) arguments.get(1),
					(TFieldDefinition) arguments.get(2), (TField) arguments.get(3), (TClass) arguments.get(4),
					(TFieldSignature) arguments.get(5));
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_TYPETOTABSTRACTTYPE_TFIELDDEFINITION_TFIELD_TCLASS_TFIELDSIGNATURE_ENUMDECLARATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TypeGraph) arguments.get(1),
					(TypeToTAbstractType) arguments.get(2), (TFieldDefinition) arguments.get(3),
					(TField) arguments.get(4), (TClass) arguments.get(5), (TFieldSignature) arguments.get(6),
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_236__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_236((EMoflonEdge) arguments.get(0));
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_246__EMOFLONEDGE:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_CC__TYPEGRAPH_MENUMCONSTANTDECLARATION_TFIELDDEFINITION_TFIELD_TCLASS_TFIELDSIGNATURE_ENUMDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeGraph) arguments.get(0), (MEnumConstantDeclaration) arguments.get(1),
					(TFieldDefinition) arguments.get(2), (TField) arguments.get(3), (TClass) arguments.get(4),
					(TFieldSignature) arguments.get(5), (EnumDeclaration) arguments.get(6), (Match) arguments.get(7),
		...
		case RulesPackage.ENUM_CONSTANT___CHECK_DEC_BWD__TYPEGRAPH_TFIELDDEFINITION_TFIELD_TCLASS_TFIELDSIGNATURE:
			return checkDEC_BWD((TypeGraph) arguments.get(0), (TFieldDefinition) arguments.get(1),
					(TField) arguments.get(2), (TClass) arguments.get(3), (TFieldSignature) arguments.get(4));
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_greenFBBFFBFFB(TypeGraph model,
		...
		return new Object[] { mDefinitionToTMember, model, mDefinition, tDefinition, tName, tEnum, tSignature,
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
		...
		return new Object[] { mDefinitionToTMember, mDefinition, tDefinition, tName, tSignature, mBodyToTAnnotation };
	}
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_greenFBBBBBB(
		...
		return new Object[] { ruleresult, mDefinitionToTMember, mDefinition, tDefinition, tName, tSignature,
				mBodyToTAnnotation };
	}

	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mDefinitionToTMember, EObject model, EObject mDefinition,
			EObject mEnumToTEnum, EObject tDefinition, EObject tName, EObject tEnum, EObject tSignature,
			EObject mBodyToTAnnotation, EObject mEnum) {
	...
	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mDefinitionToTMember, EObject model, EObject mDefinition,
			EObject tDefinition, EObject tName, EObject tEnum, EObject tSignature, EObject mBodyToTAnnotation,
			EObject mEnum) {
		...
		return new Object[] { ruleresult, mDefinitionToTMember, model, mDefinition, tDefinition, tName, tEnum,
				tSignature, mBodyToTAnnotation, mEnum, mDefinitionToTMember__mDefinition____source,
				mDefinitionToTMember__tDefinition____target, tEnum__tDefinition____defines,
				...
				tSignature__tName____field, tName__tSignature____signatures, mEnum__mDefinition____enumConstants,
	...
	public static final void pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mEnumToTEnum, EObject tDefinition, EObject tName, EObject tEnum, EObject tSignature,
			EObject mBodyToTAnnotation, EObject mEnum) {
		_this.registerObjects_FWD(ruleresult, mDefinitionToTMember, model, mDefinition, mEnumToTEnum, tDefinition,
				tName, tEnum, tSignature, mBodyToTAnnotation, mEnum);
	...
	public static final Object[] pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(EnumConstant _this, Match match,
			TypeGraph model, TFieldDefinition tDefinition, TField tName, TClass tEnum, TFieldSignature tSignature) {
		return new Object[] { _this, match, model, tDefinition, tName, tEnum, tSignature };
	}

	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(EnumConstant _this, Match match,
			TypeGraph model, TFieldDefinition tDefinition, TField tName, TClass tEnum, TFieldSignature tSignature) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, model, tDefinition, tName, tEnum, tSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, model, tDefinition, tName, tEnum, tSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
			Match match, TypeGraph model, TFieldDefinition tDefinition, TField tName, TClass tEnum,
			TFieldSignature tSignature) {
		Object[] result_pattern_EnumConstant_10_2_SolveCSP_binding = pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, model, tDefinition, tName, tEnum, tSignature);
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(Match match,
			TypeGraph model, TFieldDefinition tDefinition, TField tName, TClass tEnum, TFieldSignature tSignature) {
		return new Object[] { match, model, tDefinition, tName, tEnum, tSignature };
	}
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(
		...
		tDefinition__tSignature____signature.setName(tDefinition__tSignature____signature_name_prime);
		tSignature__tDefinition____definitions.setName(tSignature__tDefinition____definitions_name_prime);
		return new Object[] { match, model, tDefinition, tName, tEnum, tSignature, tEnum__tDefinition____defines,
				tDefinition__tEnum____definedBy, tEnum__tSignature____signature, tSignature__tEnum____type,
	...
	public static final void pattern_EnumConstant_10_6_registerobjectstomatch_expressionBBBBBBB(EnumConstant _this,
			Match match, TypeGraph model, TFieldDefinition tDefinition, TField tName, TClass tEnum,
			TFieldSignature tSignature) {
		_this.registerObjectsToMatch_BWD(match, model, tDefinition, tName, tEnum, tSignature);
					...
					if (tmpTName instanceof TField) {
						...
						if (tmpTEnum instanceof TClass) {
							...
							if (tmpTSignature instanceof TFieldSignature) {
								...
								if (tmpMEnum instanceof EnumDeclaration) {
									EnumDeclaration mEnum = (EnumDeclaration) tmpMEnum;
									return new Object[] { model, mEnumToTEnum, tDefinition, tName, tEnum, tSignature,
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(TypeGraph model,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { model, mEnumToTEnum, tDefinition, tName, tEnum, tSignature, mEnum, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_EnumConstant_11_1_performtransformation_black = pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
					model, mEnumToTEnum, tDefinition, tName, tEnum, tSignature, mEnum, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_greenFFBFBB(
		...
		return new Object[] { mDefinitionToTMember, mDefinition, tDefinition, mBodyToTAnnotation, mEnum, csp };
	}
	...
	public static final void pattern_EnumConstant_11_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mEnumToTEnum, EObject tDefinition, EObject tName, EObject tEnum, EObject tSignature,
			EObject mBodyToTAnnotation, EObject mEnum) {
		_this.registerObjects_BWD(ruleresult, mDefinitionToTMember, model, mDefinition, mEnumToTEnum, tDefinition,
				tName, tEnum, tSignature, mBodyToTAnnotation, mEnum);
			...
			if (tmpTDefinition instanceof TFieldDefinition) {
				...
				if (tmpTName instanceof TField) {
					...
					if (tmpTEnum instanceof TClass) {
						...
						if (tmpTSignature instanceof TFieldSignature) {
							TFieldSignature tSignature = (TFieldSignature) tmpTSignature;
							return new Object[] { model, tDefinition, tName, tEnum, tSignature, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_2_corematch_blackBFBBBBFB(TypeGraph model,
			TFieldDefinition tDefinition, TField tName, TClass tEnum, TFieldSignature tSignature, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMEnum instanceof EnumDeclaration) {
				EnumDeclaration mEnum = (EnumDeclaration) tmpMEnum;
				_result.add(new Object[] { model, mEnumToTEnum, tDefinition, tName, tEnum, tSignature, mEnum, match });
			}
								...
								if (mEnum.equals(mEnumToTEnum.getSource())) {
									if (model.getFields().contains(tName)) {
										if (tSignature.equals(tDefinition.getSignature())) {
											_result.add(new Object[] { model, mEnumToTEnum, tDefinition, tName, tEnum,
													tSignature, mEnum });
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(TypeGraph model,
		...
		tDefinition__tSignature____signature.setName(tDefinition__tSignature____signature_name_prime);
		tSignature__tDefinition____definitions.setName(tSignature__tDefinition____definitions_name_prime);
		return new Object[] { model, mEnumToTEnum, tDefinition, tName, tEnum, tSignature, mEnum, isApplicableMatch,
				mEnumToTEnum__tEnum____target, tEnum__model____model, model__tEnum____ownedTypes,
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(EnumConstant _this,
			...
			TFieldDefinition tDefinition, TField tName, TClass tEnum, TFieldSignature tSignature,
			EnumDeclaration mEnum) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, model, mEnumToTEnum, tDefinition,
				tName, tEnum, tSignature, mEnum);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model, mEnumToTEnum, tDefinition, tName, tEnum,
					tSignature, mEnum };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_12_4_solveCSP_binding = pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, model, mEnumToTEnum, tDefinition, tName, tEnum, tSignature, mEnum);
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TSignature __DEC_tDefinition_definitions_799843 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_799843 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_799843)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TField __DEC_tSignature_signatures_132493 = tSignature.getField();
		if (__DEC_tSignature_signatures_132493 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_132493)) {
										...
										if (model.getFields().contains(tName)) {
											if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
												...
												if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
													...
													_result.add(new Object[] { model, tDefinition, tName, tEnum,
	...
	public static final boolean pattern_EnumConstant_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			EnumConstant _this, Match match, TypeGraph model, TFieldDefinition tDefinition, TField tName, TClass tEnum,
			TFieldSignature tSignature) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, model, tDefinition, tName, tEnum, tSignature);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_EnumConstant_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_862596 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_862596 != null) {
					...
					if (tmpTName instanceof TField) {
						...
						if (tmpTEnum instanceof TClass) {
							...
							if (tmpTSignature instanceof TFieldSignature) {
								...
								if (tmpMEnum instanceof EnumDeclaration) {
									EnumDeclaration mEnum = (EnumDeclaration) tmpMEnum;
									return new Object[] { model, mDefinition, tDefinition, tName, tEnum, tSignature,
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(TypeGraph model,
			MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition, TField tName, TClass tEnum,
			TFieldSignature tSignature, EnumDeclaration mEnum, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { model, mDefinition, tDefinition, tName, tEnum, tSignature, mEnum, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_EnumConstant_24_2_matchsrctrgcontext_black = pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					model, mDefinition, tDefinition, tName, tEnum, tSignature, mEnum, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(EnumConstant _this,
			TypeGraph model, MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition, TField tName,
			TClass tEnum, TFieldSignature tSignature, EnumDeclaration mEnum, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(model, mDefinition, tDefinition, tName, tEnum, tSignature,
				mEnum, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, model, mDefinition, tDefinition, tName, tEnum, tSignature, mEnum,
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_24_3_solvecsp_binding = pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, model, mDefinition, tDefinition, tName, tEnum, tSignature, mEnum, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(TypeGraph model,
			MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition, TField tName, TClass tEnum,
			TFieldSignature tSignature, EnumDeclaration mEnum, CCMatch ccMatch) {
		return new Object[] { model, mDefinition, tDefinition, tName, tEnum, tSignature, mEnum, ccMatch };
	}
	...
	public static final Object[] pattern_EnumConstant_27_1_matchtggpattern_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_605664 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_605664 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(TFieldDefinition tDefinition,
			TFieldSignature tSignature) {
		TSignature __DEC_tDefinition_definitions_747157 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_747157 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_747157)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(TFieldSignature tSignature,
			TField tName) {
		TField __DEC_tSignature_signatures_148955 = tSignature.getField();
		if (__DEC_tSignature_signatures_148955 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_148955)) {
				return new Object[] { tSignature, tName };
			}
		}
								...
								if (tSignature.equals(tDefinition.getSignature())) {
									if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(tDefinition,
										...
										if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(tSignature,
												tName) == null) {
											return new Object[] { model, tDefinition, tName, tEnum, tSignature };
										}
									}
								}
							}
	...
	public static final Object[] pattern_EnumConstant_29_6_perform_greenFBFFFBFFBBB(TypeGraph model, TClass tEnum,
		...
		return new Object[] { mDefinitionToTMember, model, mDefinition, tDefinition, tName, tEnum, tSignature,
				mBodyToTAnnotation, mEnum, ruleResult, csp };
	}
