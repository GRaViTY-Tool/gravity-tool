...
public class EnumConstantImpl extends AbstractRuleImpl implements EnumConstant {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = EnumConstantImpl.pattern_EnumConstant_1_1_performtransformation_greenBFFBFBFFB(model,
		...
		Object[] result2_black = EnumConstantImpl.pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
				tSignature, mBodyToTAnnotation, tDefinition, mDefinition, tName, mDefinitionToTMember);
		...
		Object[] result3_black = EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, model, mEnumToTEnum, tSignature, mBodyToTAnnotation, mEnum, tEnum, tDefinition, mDefinition,
				tName, mDefinitionToTMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[model] = " + model + ", " + "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[tSignature] = "
					+ tSignature + ", " + "[mBodyToTAnnotation] = " + mBodyToTAnnotation + ", " + "[mEnum] = " + mEnum
					+ ", " + "[tEnum] = " + tEnum + ", " + "[tDefinition] = " + tDefinition + ", " + "[mDefinition] = "
					+ mDefinition + ", " + "[tName] = " + tName + ", " + "[mDefinitionToTMember] = "
					+ mDefinitionToTMember + ".");
		}
		EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult, model,
				tSignature, mBodyToTAnnotation, mEnum, tEnum, tDefinition, mDefinition, tName, mDefinitionToTMember);
		...
		//nothing EMoflonEdge mEnum__mDefinition____enumConstants = (EMoflonEdge) result3_green[14];
		...
		EnumConstantImpl.pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, model,
				mEnumToTEnum, tSignature, mBodyToTAnnotation, mEnum, tEnum, tDefinition, mDefinition, tName,
				mDefinitionToTMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_2_2_corematch_blackFBFBB(mEnum, mDefinition,
			...
			// ForEach 
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_blackFBBBB(mEnumToTEnum,
				...
				Object[] result3_green = EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(model,
						mEnumToTEnum, mEnum, tEnum, mDefinition);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeGraph model,
			...
			MEnumConstantDeclaration mDefinition) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject model, EObject mEnumToTEnum,
			EObject tSignature, EObject mBodyToTAnnotation, EObject mEnum, EObject tEnum, EObject tDefinition,
			EObject mDefinition, EObject tName, EObject mDefinitionToTMember) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TypeGraph model, TFieldSignature tSignature, TClass tEnum,
			TFieldDefinition tDefinition, TField tName) {

		Object[] result1_black = EnumConstantImpl.pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(this, match,
				model, tSignature, tEnum, tDefinition, tName);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[match] = " + match
							+ ", " + "[model] = " + model + ", " + "[tSignature] = " + tSignature + ", " + "[tEnum] = "
							+ tEnum + ", " + "[tDefinition] = " + tDefinition + ", " + "[tName] = " + tName + ".");
		}

		Object[] result2_bindingAndBlack = EnumConstantImpl.pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
				this, match, model, tSignature, tEnum, tDefinition, tName);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[match] = " + match
							+ ", " + "[model] = " + model + ", " + "[tSignature] = " + tSignature + ", " + "[tEnum] = "
		...
		if (EnumConstantImpl.pattern_EnumConstant_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = EnumConstantImpl
					.pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(match, model, tSignature,
							tEnum, tDefinition, tName);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[model] = " + model + ", " + "[tSignature] = " + tSignature + ", " + "[tEnum] = " + tEnum
						+ ", " + "[tDefinition] = " + tDefinition + ", " + "[tName] = " + tName + ".");
			}
			EnumConstantImpl.pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(match, model,
					tSignature, tEnum, tDefinition, tName);
			...
			Object[] result5_black = EnumConstantImpl.pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(
					match, model, tSignature, tEnum, tDefinition, tName);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[model] = " + model + ", " + "[tSignature] = " + tSignature + ", " + "[tEnum] = " + tEnum
						+ ", " + "[tDefinition] = " + tDefinition + ", " + "[tName] = " + tName + ".");
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_12_2_corematch_blackBFBFBBBB(model,
				tSignature, tEnum, tDefinition, tName, match)) {
			...
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(model,
					mEnumToTEnum, tSignature, mEnum, tEnum, tDefinition, tName)) {
				Object[] result3_green = EnumConstantImpl
						.pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(model, mEnumToTEnum,
								tSignature, mEnum, tEnum, tDefinition, tName);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[model] = " + model + ", "
							+ "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[tSignature] = " + tSignature + ", "
							+ "[mEnum] = " + mEnum + ", " + "[tEnum] = " + tEnum + ", " + "[tDefinition] = "
							+ tDefinition + ", " + "[tName] = " + tName + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TypeGraph model, TFieldSignature tSignature, TClass tEnum,
			TFieldDefinition tDefinition, TField tName) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TypeGraph model, TFieldSignature tSignature, TClass tEnum,
			TFieldDefinition tDefinition, TField tName) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeGraph model,
			TypeToTAbstractType mEnumToTEnum, TFieldSignature tSignature, EnumDeclaration mEnum, TClass tEnum,
			TFieldDefinition tDefinition, TField tName) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject model, EObject mEnumToTEnum,
			EObject tSignature, EObject mBodyToTAnnotation, EObject mEnum, EObject tEnum, EObject tDefinition,
			EObject mDefinition, EObject tName, EObject mDefinitionToTMember) {
		ruleresult.registerObject("model", model);
		ruleresult.registerObject("mEnumToTEnum", mEnumToTEnum);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_77(EMoflonEdge _edge_enumConstants) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = EnumConstantImpl
				.pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, model, tSignature, mEnum, tEnum,
						tDefinition, mDefinition, tName, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[model] = " + model + ", " + "[tSignature] = " + tSignature + ", " + "[mEnum] = " + mEnum + ", "
					+ "[tEnum] = " + tEnum + ", " + "[tDefinition] = " + tDefinition + ", " + "[mDefinition] = "
					+ mDefinition + ", " + "[tName] = " + tName + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (EnumConstantImpl.pattern_EnumConstant_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : EnumConstantImpl.pattern_EnumConstant_24_5_matchcorrcontext_blackFBBBB(mEnum,
				...
				Object[] result6_black = EnumConstantImpl.pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(
						model, tSignature, mEnum, tEnum, tDefinition, mDefinition, tName, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[model] = " + model + ", "
							+ "[tSignature] = " + tSignature + ", " + "[mEnum] = " + mEnum + ", " + "[tEnum] = " + tEnum
							+ ", " + "[tDefinition] = " + tDefinition + ", " + "[mDefinition] = " + mDefinition + ", "
							+ "[tName] = " + tName + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				EnumConstantImpl.pattern_EnumConstant_24_6_createcorrespondence_greenFBBFB(tDefinition, mDefinition,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeGraph model, TFieldSignature tSignature, EnumDeclaration mEnum,
			TClass tEnum, TFieldDefinition tDefinition, MEnumConstantDeclaration mDefinition, TField tName,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TypeGraph model, TFieldSignature tSignature, TClass tEnum, TFieldDefinition tDefinition,
			TField tName) {// 
		...
		for (Object[] result2_black : EnumConstantImpl
			...
			Object[] result3_bindingAndBlack = EnumConstantImpl
					.pattern_EnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, model,
							mEnumToTEnum, mEnum, tEnum, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[model] = " + model + ", "
						+ "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[mEnum] = " + mEnum + ", " + "[tEnum] = " + tEnum
			...
			if (EnumConstantImpl.pattern_EnumConstant_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					EnumConstantImpl.pattern_EnumConstant_29_6_perform_greenBFFBBFFFFBB(model, mEnum, tEnum, ruleResult,
							csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEGRAPH_TYPETOTABSTRACTTYPE_ENUMDECLARATION_TCLASS_MENUMCONSTANTDECLARATION:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD__MATCH_TYPEGRAPH_TFIELDSIGNATURE_TCLASS_TFIELDDEFINITION_TFIELD:
			return isAppropriate_BWD((Match) arguments.get(0), (TypeGraph) arguments.get(1),
					(TFieldSignature) arguments.get(2), (TClass) arguments.get(3), (TFieldDefinition) arguments.get(4),
		...
		case RulesPackage.ENUM_CONSTANT___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TYPEGRAPH_TFIELDSIGNATURE_TCLASS_TFIELDDEFINITION_TFIELD:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TypeGraph) arguments.get(1),
					(TFieldSignature) arguments.get(2), (TClass) arguments.get(3), (TFieldDefinition) arguments.get(4),
					(TField) arguments.get(5));
			return null;
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TYPEGRAPH_TFIELDSIGNATURE_TCLASS_TFIELDDEFINITION_TFIELD:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (TypeGraph) arguments.get(1),
					(TFieldSignature) arguments.get(2), (TClass) arguments.get(3), (TFieldDefinition) arguments.get(4),
					(TField) arguments.get(5));
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_TYPETOTABSTRACTTYPE_TFIELDSIGNATURE_ENUMDECLARATION_TCLASS_TFIELDDEFINITION_TFIELD:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TypeGraph) arguments.get(1),
					(TypeToTAbstractType) arguments.get(2), (TFieldSignature) arguments.get(3),
					(EnumDeclaration) arguments.get(4), (TClass) arguments.get(5), (TFieldDefinition) arguments.get(6),
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_74__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_74((EMoflonEdge) arguments.get(0));
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_77__EMOFLONEDGE:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_CC__TYPEGRAPH_TFIELDSIGNATURE_ENUMDECLARATION_TCLASS_TFIELDDEFINITION_MENUMCONSTANTDECLARATION_TFIELD_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeGraph) arguments.get(0), (TFieldSignature) arguments.get(1),
					(EnumDeclaration) arguments.get(2), (TClass) arguments.get(3), (TFieldDefinition) arguments.get(4),
					(MEnumConstantDeclaration) arguments.get(5), (TField) arguments.get(6), (Match) arguments.get(7),
		...
		case RulesPackage.ENUM_CONSTANT___CHECK_DEC_BWD__TYPEGRAPH_TFIELDSIGNATURE_TCLASS_TFIELDDEFINITION_TFIELD:
		...
		case RulesPackage.ENUM_CONSTANT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_TYPETOTABSTRACTTYPE_ENUMDECLARATION_TCLASS_MODELGENERATORRULERESULT:
				...
				if (tmpMEnum instanceof EnumDeclaration) {
					...
					if (tmpTEnum instanceof TClass) {
						...
						if (tmpMDefinition instanceof MEnumConstantDeclaration) {
							...
							return new Object[] { model, mEnumToTEnum, mEnum, tEnum, mDefinition, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(TypeGraph model,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { model, mEnumToTEnum, mEnum, tEnum, mDefinition, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_EnumConstant_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_EnumConstant_1_1_performtransformation_black = pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(
					model, mEnumToTEnum, mEnum, tEnum, mDefinition, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_greenBFFBFBFFB(TypeGraph model,
		...
		return new Object[] { model, tSignature, mBodyToTAnnotation, tEnum, tDefinition, mDefinition, tName,
				mDefinitionToTMember, csp };
	}

	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
			TFieldSignature tSignature, ASTNodeToTAnnotatable mBodyToTAnnotation, TFieldDefinition tDefinition,
			MEnumConstantDeclaration mDefinition, TField tName, MDefinitionToTMember mDefinitionToTMember) {
		return new Object[] { tSignature, mBodyToTAnnotation, tDefinition, mDefinition, tName, mDefinitionToTMember };
	}
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_greenFBBBBBB(
		...
		return new Object[] { ruleresult, tSignature, mBodyToTAnnotation, tDefinition, mDefinition, tName,
				mDefinitionToTMember };
	}

	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject model, EObject mEnumToTEnum, EObject tSignature,
			EObject mBodyToTAnnotation, EObject mEnum, EObject tEnum, EObject tDefinition, EObject mDefinition,
			EObject tName, EObject mDefinitionToTMember) {
	...
	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject model, EObject tSignature, EObject mBodyToTAnnotation, EObject mEnum,
			EObject tEnum, EObject tDefinition, EObject mDefinition, EObject tName, EObject mDefinitionToTMember) {
		...
		return new Object[] { ruleresult, model, tSignature, mBodyToTAnnotation, mEnum, tEnum, tDefinition, mDefinition,
				tName, mDefinitionToTMember, model__tName____fields, tName__model____model, tSignature__tName____field,
				tName__tSignature____signatures, mEnum__mDefinition____enumConstants, tEnum__tDefinition____defines,
				tDefinition__tEnum____definedBy, tSignature__tEnum____type, mBodyToTAnnotation__tDefinition____target,
				tEnum__tSignature____signature, mBodyToTAnnotation__mDefinition____source,
	...
	public static final void pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mBodyToTAnnotation, EObject mEnum, EObject tEnum, EObject tDefinition, EObject mDefinition,
			EObject tName, EObject mDefinitionToTMember) {
		_this.registerObjects_FWD(ruleresult, model, mEnumToTEnum, tSignature, mBodyToTAnnotation, mEnum, tEnum,
				tDefinition, mDefinition, tName, mDefinitionToTMember);
		...
		if (mEnum.equals(mEnumToTEnum.getSource())) {
			if (mEnum.getEnumConstants().contains(mDefinition)) {
				if (tEnum.equals(mEnumToTEnum.getTarget())) {
					...
					if (model != null) {
						_result.add(new Object[] { model, mEnumToTEnum, mEnum, tEnum, mDefinition });
					}
	...
	public static final Object[] pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(TypeGraph model,
		...
		return new Object[] { model, mEnumToTEnum, mEnum, tEnum, mDefinition, isApplicableMatch,
				mEnumToTEnum__mEnum____source, mEnum__mDefinition____enumConstants, mEnumToTEnum__tEnum____target,
	...
	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, TypeGraph model, TypeToTAbstractType mEnumToTEnum,
			EnumDeclaration mEnum, TClass tEnum, MEnumConstantDeclaration mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, model, mEnumToTEnum, mEnum, tEnum,
				mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model, mEnumToTEnum, mEnum, tEnum, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_2_4_solveCSP_binding = pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, model, mEnumToTEnum, mEnum, tEnum, mDefinition);
	...
	public static final Object[] pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(EnumConstant _this, Match match,
			TypeGraph model, TFieldSignature tSignature, TClass tEnum, TFieldDefinition tDefinition, TField tName) {
		return new Object[] { _this, match, model, tSignature, tEnum, tDefinition, tName };
	}

	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(EnumConstant _this, Match match,
			TypeGraph model, TFieldSignature tSignature, TClass tEnum, TFieldDefinition tDefinition, TField tName) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, model, tSignature, tEnum, tDefinition, tName);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, model, tSignature, tEnum, tDefinition, tName };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
			Match match, TypeGraph model, TFieldSignature tSignature, TClass tEnum, TFieldDefinition tDefinition,
			TField tName) {
		Object[] result_pattern_EnumConstant_10_2_SolveCSP_binding = pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, model, tSignature, tEnum, tDefinition, tName);
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(Match match,
			TypeGraph model, TFieldSignature tSignature, TClass tEnum, TFieldDefinition tDefinition, TField tName) {
		return new Object[] { match, model, tSignature, tEnum, tDefinition, tName };
	}
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(
		...
		tDefinition__tSignature____signature.setName(tDefinition__tSignature____signature_name_prime);
		tSignature__tDefinition____definitions.setName(tSignature__tDefinition____definitions_name_prime);
		return new Object[] { match, model, tSignature, tEnum, tDefinition, tName, model__tName____fields,
	...
	public static final void pattern_EnumConstant_10_6_registerobjectstomatch_expressionBBBBBBB(EnumConstant _this,
			Match match, TypeGraph model, TFieldSignature tSignature, TClass tEnum, TFieldDefinition tDefinition,
			TField tName) {
		_this.registerObjectsToMatch_BWD(match, model, tSignature, tEnum, tDefinition, tName);
						...
						if (tmpTEnum instanceof TClass) {
							...
							if (tmpTDefinition instanceof TFieldDefinition) {
								...
								if (tmpTName instanceof TField) {
									...
									return new Object[] { model, mEnumToTEnum, tSignature, mEnum, tEnum, tDefinition,
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(TypeGraph model,
			TypeToTAbstractType mEnumToTEnum, TFieldSignature tSignature, EnumDeclaration mEnum, TClass tEnum,
			TFieldDefinition tDefinition, TField tName, EnumConstant _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { model, mEnumToTEnum, tSignature, mEnum, tEnum, tDefinition, tName, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_11_1_performtransformation_binding != null) {
			...
			TClass tEnum = (TClass) result_pattern_EnumConstant_11_1_performtransformation_binding[4];
			...
			Object[] result_pattern_EnumConstant_11_1_performtransformation_black = pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
					model, mEnumToTEnum, tSignature, mEnum, tEnum, tDefinition, tName, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_greenFBBFFB(EnumDeclaration mEnum,
		...
		return new Object[] { mBodyToTAnnotation, mEnum, tDefinition, mDefinition, mDefinitionToTMember, csp };
	}
	...
	public static final void pattern_EnumConstant_11_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mBodyToTAnnotation, EObject mEnum, EObject tEnum, EObject tDefinition, EObject mDefinition,
			EObject tName, EObject mDefinitionToTMember) {
		_this.registerObjects_BWD(ruleresult, model, mEnumToTEnum, tSignature, mBodyToTAnnotation, mEnum, tEnum,
				tDefinition, mDefinition, tName, mDefinitionToTMember);
			...
			if (tmpTSignature instanceof TFieldSignature) {
				...
				if (tmpTEnum instanceof TClass) {
					...
					if (tmpTDefinition instanceof TFieldDefinition) {
						...
						if (tmpTName instanceof TField) {
							TField tName = (TField) tmpTName;
							return new Object[] { model, tSignature, tEnum, tDefinition, tName, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_2_corematch_blackBFBFBBBB(TypeGraph model,
			TFieldSignature tSignature, TClass tEnum, TFieldDefinition tDefinition, TField tName, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMEnum instanceof EnumDeclaration) {
				EnumDeclaration mEnum = (EnumDeclaration) tmpMEnum;
				_result.add(new Object[] { model, mEnumToTEnum, tSignature, mEnum, tEnum, tDefinition, tName, match });
			}
								...
								if (tEnum.getSignature().contains(tSignature)) {
									if (model.equals(tEnum.getModel())) {
										if (tSignature.equals(tDefinition.getSignature())) {
											_result.add(new Object[] { model, mEnumToTEnum, tSignature, mEnum, tEnum,
													tDefinition, tName });
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(TypeGraph model,
		...
		tDefinition__tSignature____signature.setName(tDefinition__tSignature____signature_name_prime);
		tSignature__tDefinition____definitions.setName(tSignature__tDefinition____definitions_name_prime);
		return new Object[] { model, mEnumToTEnum, tSignature, mEnum, tEnum, tDefinition, tName, isApplicableMatch,
				model__tName____fields, tName__model____model, tSignature__tName____field,
				tName__tSignature____signatures, mEnumToTEnum__mEnum____source, mEnumToTEnum__tEnum____target,
				tEnum__tDefinition____defines, tDefinition__tEnum____definedBy, tSignature__tEnum____type,
				tEnum__tSignature____signature, tEnum__model____model, model__tEnum____ownedTypes,
				tDefinition__tSignature____signature, tSignature__tDefinition____definitions };
	}

	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, TypeGraph model, TypeToTAbstractType mEnumToTEnum,
			TFieldSignature tSignature, EnumDeclaration mEnum, TClass tEnum, TFieldDefinition tDefinition,
			TField tName) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, model, mEnumToTEnum, tSignature,
				mEnum, tEnum, tDefinition, tName);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model, mEnumToTEnum, tSignature, mEnum, tEnum,
					tDefinition, tName };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_12_4_solveCSP_binding = pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, model, mEnumToTEnum, tSignature, mEnum, tEnum, tDefinition, tName);
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TField __DEC_tSignature_signatures_208001 = tSignature.getField();
		if (__DEC_tSignature_signatures_208001 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_208001)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tDefinition_definitions_181406 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_181406 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_181406)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_250978 = tName.getModel();
		if (__DEC_tName_model_250978 != null) {
			if (!model.equals(__DEC_tName_model_250978)) {
	...
	public static final Iterable<Object[]> pattern_EnumConstant_20_2_testcorematchandDECs_blackFFFFFB(
		...
		if (tmpModel instanceof TypeGraph) {
			...
			if (tmpTName instanceof TField) {
				TField tName = (TField) tmpTName;
				if (model.getFields().contains(tName)) {
					if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(tName, model) == null) {
													...
													if (tmpTDefinition instanceof TFieldDefinition) {
														...
														if (tSignature.equals(tDefinition.getSignature())) {
															if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
																...
																_result.add(new Object[] { model, tSignature, tEnum,
																		tDefinition, tName, _edge_fields });
															}
														}
													}
												}
	...
	public static final boolean pattern_EnumConstant_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			EnumConstant _this, Match match, TypeGraph model, TFieldSignature tSignature, TClass tEnum,
			TFieldDefinition tDefinition, TField tName) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, model, tSignature, tEnum, tDefinition, tName);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_EnumConstant_21_2_testcorematchandDECs_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_132343 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_132343 != null) {
					...
					if (tmpTEnum instanceof TClass) {
						...
						if (tmpTDefinition instanceof TFieldDefinition) {
							...
							if (tmpMDefinition instanceof MEnumConstantDeclaration) {
								...
								if (tmpTName instanceof TField) {
									TField tName = (TField) tmpTName;
									return new Object[] { model, tSignature, mEnum, tEnum, tDefinition, mDefinition,
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(TypeGraph model,
			TFieldSignature tSignature, EnumDeclaration mEnum, TClass tEnum, TFieldDefinition tDefinition,
			MEnumConstantDeclaration mDefinition, TField tName, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { model, tSignature, mEnum, tEnum, tDefinition, mDefinition, tName, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_EnumConstant_24_2_matchsrctrgcontext_black = pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					model, tSignature, mEnum, tEnum, tDefinition, mDefinition, tName, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(EnumConstant _this,
			TypeGraph model, TFieldSignature tSignature, EnumDeclaration mEnum, TClass tEnum,
			TFieldDefinition tDefinition, MEnumConstantDeclaration mDefinition, TField tName, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(model, tSignature, mEnum, tEnum, tDefinition, mDefinition,
				tName, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, model, tSignature, mEnum, tEnum, tDefinition, mDefinition, tName,
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_24_3_solvecsp_binding = pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, model, tSignature, mEnum, tEnum, tDefinition, mDefinition, tName, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(TypeGraph model,
			TFieldSignature tSignature, EnumDeclaration mEnum, TClass tEnum, TFieldDefinition tDefinition,
			MEnumConstantDeclaration mDefinition, TField tName, CCMatch ccMatch) {
		return new Object[] { model, tSignature, mEnum, tEnum, tDefinition, mDefinition, tName, ccMatch };
	}

	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_greenFBBFB(TFieldDefinition tDefinition,
		...
		return new Object[] { mBodyToTAnnotation, tDefinition, mDefinition, mDefinitionToTMember, ccMatch };
	}
	...
	public static final Object[] pattern_EnumConstant_27_1_matchtggpattern_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_14141 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_14141 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(TFieldSignature tSignature,
			TField tName) {
		TField __DEC_tSignature_signatures_609456 = tSignature.getField();
		if (__DEC_tSignature_signatures_609456 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_609456)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(TFieldDefinition tDefinition,
		...
		TSignature __DEC_tDefinition_definitions_684037 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_684037 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_684037)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_132284 = tName.getModel();
		if (__DEC_tName_model_132284 != null) {
			if (!model.equals(__DEC_tName_model_132284)) {
				return new Object[] { tName, model };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_blackBBBBB(TypeGraph model,
			TFieldSignature tSignature, TClass tEnum, TFieldDefinition tDefinition, TField tName) {
		if (model.getFields().contains(tName)) {
			if (tName.equals(tSignature.getField())) {
				if (tEnum.getDefines().contains(tDefinition)) {
					if (tEnum.equals(tSignature.getType())) {
									...
									if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(tSignature,
										...
										if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(tDefinition,
											...
											if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(tName,
													model) == null) {
												return new Object[] { model, tSignature, tEnum, tDefinition, tName };
											}
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_29_3_solveCSP_bindingFBBBBBBB(EnumConstant _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, model, mEnumToTEnum, mEnum, tEnum,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model, mEnumToTEnum, mEnum, tEnum, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_29_3_solveCSP_binding = pattern_EnumConstant_29_3_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, model, mEnumToTEnum, mEnum, tEnum, ruleResult);
	...
	public static final Object[] pattern_EnumConstant_29_5_checknacs_blackBBBB(TypeGraph model,
			TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum, TClass tEnum) {
		return new Object[] { model, mEnumToTEnum, mEnum, tEnum };
	}

	public static final Object[] pattern_EnumConstant_29_6_perform_blackBBBBB(TypeGraph model,
			TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum, TClass tEnum,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { model, mEnumToTEnum, mEnum, tEnum, ruleResult };
	}

	public static final Object[] pattern_EnumConstant_29_6_perform_greenBFFBBFFFFBB(TypeGraph model,
		...
		return new Object[] { model, tSignature, mBodyToTAnnotation, mEnum, tEnum, tDefinition, mDefinition, tName,
