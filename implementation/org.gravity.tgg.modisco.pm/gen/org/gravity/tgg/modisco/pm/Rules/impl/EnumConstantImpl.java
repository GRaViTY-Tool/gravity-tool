...
public class EnumConstantImpl extends AbstractRuleImpl implements EnumConstant {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = EnumConstantImpl.pattern_EnumConstant_1_1_performtransformation_greenFFFBFFBBB(tEnum,
		...
		Object[] result2_black = EnumConstantImpl.pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
				mBodyToTAnnotation, tName, tDefinition, mDefinitionToTMember, tSignature, mDefinition);
		...
		Object[] result3_black = EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, mEnumToTEnum, mBodyToTAnnotation, mEnum, tName, tDefinition, tEnum, mDefinitionToTMember,
				tSignature, model, mDefinition);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[mBodyToTAnnotation] = " + mBodyToTAnnotation
					+ ", " + "[mEnum] = " + mEnum + ", " + "[tName] = " + tName + ", " + "[tDefinition] = "
					+ tDefinition + ", " + "[tEnum] = " + tEnum + ", " + "[mDefinitionToTMember] = "
					+ mDefinitionToTMember + ", " + "[tSignature] = " + tSignature + ", " + "[model] = " + model + ", "
					+ "[mDefinition] = " + mDefinition + ".");
		}
		EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult,
				mBodyToTAnnotation, mEnum, tName, tDefinition, tEnum, mDefinitionToTMember, tSignature, model,
				mDefinition);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mEnumToTEnum, EObject mBodyToTAnnotation,
			EObject mEnum, EObject tName, EObject tDefinition, EObject tEnum, EObject mDefinitionToTMember,
			EObject tSignature, EObject model, EObject mDefinition) {
	...
	public boolean isAppropriate_BWD(Match match, TField tName, TFieldDefinition tDefinition, TClass tEnum,
		...
		Object[] result1_black = EnumConstantImpl.pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(this, match,
				tName, tDefinition, tEnum, tSignature, model);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = EnumConstantImpl.pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
				this, match, tName, tDefinition, tEnum, tSignature, model);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tName] = " + tName + ", " + "[tDefinition] = " + tDefinition
					+ ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = " + tSignature + ", " + "[model] = " + model
		...
		if (EnumConstantImpl.pattern_EnumConstant_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			EnumConstantImpl.pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(match, tName,
					tDefinition, tEnum, tSignature, model);
			...
			Object[] result5_black = EnumConstantImpl.pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(
					match, tName, tDefinition, tEnum, tSignature, model);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tName] = " + tName + ", " + "[tDefinition] = " + tDefinition + ", " + "[tEnum] = " + tEnum
						+ ", " + "[tSignature] = " + tSignature + ", " + "[model] = " + model + ".");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		EnumConstantImpl.pattern_EnumConstant_11_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				mEnumToTEnum, mBodyToTAnnotation, mEnum, tName, tDefinition, tEnum, mDefinitionToTMember, tSignature,
				model, mDefinition);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_12_2_corematch_blackFFBBBBBB(tName,
				tDefinition, tEnum, tSignature, model, match)) {
			TypeToTAbstractType mEnumToTEnum = (TypeToTAbstractType) result2_black[0];
			...
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(
					mEnumToTEnum, mEnum, tName, tDefinition, tEnum, tSignature, model)) {
				Object[] result3_green = EnumConstantImpl
						.pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(mEnumToTEnum, mEnum, tName,
								tDefinition, tEnum, tSignature, model);
				...
				//nothing EMoflonEdge mEnumToTEnum__tEnum____target = (EMoflonEdge) result3_green[12];
				...
				//nothing EMoflonEdge mEnumToTEnum__mEnum____source = (EMoflonEdge) result3_green[16];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mEnumToTEnum,
			EnumDeclaration mEnum, TField tName, TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature,
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = EnumConstantImpl
				.pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, mEnum, tName, tDefinition, tEnum,
						tSignature, model, mDefinition, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mEnum] = " + mEnum + ", " + "[tName] = " + tName + ", " + "[tDefinition] = " + tDefinition
					+ ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = " + tSignature + ", " + "[model] = " + model
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(EnumDeclaration mEnum, TField tName, TFieldDefinition tDefinition, TClass tEnum,
			TFieldSignature tSignature, TypeGraph model, MEnumConstantDeclaration mDefinition, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TField tName, TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature,
			TypeGraph model) {// 
		...
		for (Object[] result2_black : EnumConstantImpl
			...
			if (EnumConstantImpl.pattern_EnumConstant_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					EnumConstantImpl.pattern_EnumConstant_29_6_perform_greenFBFFBFFBFBB(mEnum, tEnum, model, ruleResult,
							csp);
					//nothing ASTNodeToTAnnotatable mBodyToTAnnotation = (ASTNodeToTAnnotatable) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD__MATCH_TFIELD_TFIELDDEFINITION_TCLASS_TFIELDSIGNATURE_TYPEGRAPH:
		...
		case RulesPackage.ENUM_CONSTANT___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TFIELD_TFIELDDEFINITION_TCLASS_TFIELDSIGNATURE_TYPEGRAPH:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TField) arguments.get(1),
					(TFieldDefinition) arguments.get(2), (TClass) arguments.get(3), (TFieldSignature) arguments.get(4),
					(TypeGraph) arguments.get(5));
			return null;
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TFIELD_TFIELDDEFINITION_TCLASS_TFIELDSIGNATURE_TYPEGRAPH:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_ENUMDECLARATION_TFIELD_TFIELDDEFINITION_TCLASS_TFIELDSIGNATURE_TYPEGRAPH:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (EnumDeclaration) arguments.get(2),
					(TField) arguments.get(3), (TFieldDefinition) arguments.get(4), (TClass) arguments.get(5),
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_75__EMOFLONEDGE:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_CC__ENUMDECLARATION_TFIELD_TFIELDDEFINITION_TCLASS_TFIELDSIGNATURE_TYPEGRAPH_MENUMCONSTANTDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.ENUM_CONSTANT___CHECK_DEC_BWD__TFIELD_TFIELDDEFINITION_TCLASS_TFIELDSIGNATURE_TYPEGRAPH:
			return checkDEC_BWD((TField) arguments.get(0), (TFieldDefinition) arguments.get(1),
					(TClass) arguments.get(2), (TFieldSignature) arguments.get(3), (TypeGraph) arguments.get(4));
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_greenFFFBFFBBB(TClass tEnum,
		...
		return new Object[] { mBodyToTAnnotation, tName, tDefinition, tEnum, mDefinitionToTMember, tSignature, model,
				mDefinition, csp };
	}
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
		...
		return new Object[] { mBodyToTAnnotation, tName, tDefinition, mDefinitionToTMember, tSignature, mDefinition };
	}
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_greenFBBBBBB(
		...
		return new Object[] { ruleresult, mBodyToTAnnotation, tName, tDefinition, mDefinitionToTMember, tSignature,
				mDefinition };
	}

	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mEnumToTEnum, EObject mBodyToTAnnotation, EObject mEnum,
			EObject tName, EObject tDefinition, EObject tEnum, EObject mDefinitionToTMember, EObject tSignature,
	...
	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mEnum, EObject tName, EObject tDefinition,
			EObject tEnum, EObject mDefinitionToTMember, EObject tSignature, EObject model, EObject mDefinition) {
		EMoflonEdge mEnum__mDefinition____enumConstants = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mBodyToTAnnotation, mEnum, tName, tDefinition, tEnum, mDefinitionToTMember,
				tSignature, model, mDefinition, mEnum__mDefinition____enumConstants,
				...
				tEnum__tSignature____signature, mDefinitionToTMember__tDefinition____target, tSignature__tEnum____type,
	...
	public static final void pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject tName, EObject tDefinition, EObject tEnum, EObject mDefinitionToTMember, EObject tSignature,
			EObject model, EObject mDefinition) {
		_this.registerObjects_FWD(ruleresult, mEnumToTEnum, mBodyToTAnnotation, mEnum, tName, tDefinition, tEnum,
				mDefinitionToTMember, tSignature, model, mDefinition);
	...
	public static final Object[] pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(TypeToTAbstractType mEnumToTEnum,
		...
		return new Object[] { mEnumToTEnum, mEnum, tEnum, model, mDefinition, isApplicableMatch,
				mEnum__mDefinition____enumConstants, tEnum__model____model, model__tEnum____ownedTypes,
				mEnumToTEnum__tEnum____target, mEnumToTEnum__mEnum____source };
	}
	...
	public static final Object[] pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(EnumConstant _this, Match match,
			TField tName, TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature, TypeGraph model) {
		return new Object[] { _this, match, tName, tDefinition, tEnum, tSignature, model };
	}

	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(EnumConstant _this, Match match,
			TField tName, TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature, TypeGraph model) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, tName, tDefinition, tEnum, tSignature, model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, tName, tDefinition, tEnum, tSignature, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
			Match match, TField tName, TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature,
			TypeGraph model) {
		Object[] result_pattern_EnumConstant_10_2_SolveCSP_binding = pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, tName, tDefinition, tEnum, tSignature, model);
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(Match match,
			TField tName, TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature, TypeGraph model) {
		return new Object[] { match, tName, tDefinition, tEnum, tSignature, model };
	}
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(
		...
		model__tName____fields.setName(model__tName____fields_name_prime);
		tName__model____model.setName(tName__model____model_name_prime);
		return new Object[] { match, tName, tDefinition, tEnum, tSignature, model, tDefinition__tSignature____signature,
				tSignature__tDefinition____definitions, tEnum__tDefinition____defines, tDefinition__tEnum____definedBy,
	...
	public static final Object[] pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(Match match, TField tName,
			TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature, TypeGraph model) {
		return new Object[] { match, tName, tDefinition, tEnum, tSignature, model };
	}
	...
	public static final void pattern_EnumConstant_10_6_registerobjectstomatch_expressionBBBBBBB(EnumConstant _this,
			Match match, TField tName, TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature,
			TypeGraph model) {
		_this.registerObjectsToMatch_BWD(match, tName, tDefinition, tEnum, tSignature, model);
					...
					if (tmpTDefinition instanceof TFieldDefinition) {
						...
						if (tmpTEnum instanceof TClass) {
							...
							if (tmpTSignature instanceof TFieldSignature) {
								...
								if (tmpModel instanceof TypeGraph) {
									TypeGraph model = (TypeGraph) tmpModel;
									return new Object[] { mEnumToTEnum, mEnum, tName, tDefinition, tEnum, tSignature,
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
			TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum, TField tName, TFieldDefinition tDefinition,
			TClass tEnum, TFieldSignature tSignature, TypeGraph model, EnumConstant _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mEnumToTEnum, mEnum, tName, tDefinition, tEnum, tSignature, model, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_EnumConstant_11_1_performtransformation_black = pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
					mEnumToTEnum, mEnum, tName, tDefinition, tEnum, tSignature, model, _this, isApplicableMatch);
	...
	public static final void pattern_EnumConstant_11_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject tName, EObject tDefinition, EObject tEnum, EObject mDefinitionToTMember, EObject tSignature,
			EObject model, EObject mDefinition) {
		_this.registerObjects_BWD(ruleresult, mEnumToTEnum, mBodyToTAnnotation, mEnum, tName, tDefinition, tEnum,
				mDefinitionToTMember, tSignature, model, mDefinition);
			...
			if (tmpTDefinition instanceof TFieldDefinition) {
				...
				if (tmpTEnum instanceof TClass) {
					...
					if (tmpTSignature instanceof TFieldSignature) {
						...
						if (tmpModel instanceof TypeGraph) {
							TypeGraph model = (TypeGraph) tmpModel;
							return new Object[] { tName, tDefinition, tEnum, tSignature, model, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_2_corematch_blackFFBBBBBB(TField tName,
			TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature, TypeGraph model, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMEnum instanceof EnumDeclaration) {
				EnumDeclaration mEnum = (EnumDeclaration) tmpMEnum;
				_result.add(new Object[] { mEnumToTEnum, mEnum, tName, tDefinition, tEnum, tSignature, model, match });
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(
			TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum, TField tName, TFieldDefinition tDefinition,
			TClass tEnum, TFieldSignature tSignature, TypeGraph model) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
								...
								if (tEnum.equals(tSignature.getType())) {
									if (tName.equals(tSignature.getField())) {
										if (model.getFields().contains(tName)) {
											_result.add(new Object[] { mEnumToTEnum, mEnum, tName, tDefinition, tEnum,
													tSignature, model });
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(
		...
		model__tName____fields.setName(model__tName____fields_name_prime);
		tName__model____model.setName(tName__model____model_name_prime);
		return new Object[] { mEnumToTEnum, mEnum, tName, tDefinition, tEnum, tSignature, model, isApplicableMatch,
				tDefinition__tSignature____signature, tSignature__tDefinition____definitions, tEnum__model____model,
				model__tEnum____ownedTypes, mEnumToTEnum__tEnum____target, tEnum__tDefinition____defines,
				tDefinition__tEnum____definedBy, tEnum__tSignature____signature, mEnumToTEnum__mEnum____source,
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum, TField tName,
			TFieldDefinition tDefinition, TClass tEnum, TFieldSignature tSignature, TypeGraph model) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mEnumToTEnum, mEnum, tName,
				tDefinition, tEnum, tSignature, model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEnumToTEnum, mEnum, tName, tDefinition, tEnum,
					tSignature, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_12_4_solveCSP_binding = pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mEnumToTEnum, mEnum, tName, tDefinition, tEnum, tSignature, model);
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_607156 = tName.getModel();
		if (__DEC_tName_model_607156 != null) {
			if (!model.equals(__DEC_tName_model_607156)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tDefinition_definitions_309484 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_309484 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_309484)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(
		...
		TField __DEC_tSignature_signatures_584452 = tSignature.getField();
		if (__DEC_tSignature_signatures_584452 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_584452)) {
											...
											if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
												...
												if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(
													...
													if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
															tName, model) == null) {
														_result.add(new Object[] { tName, tDefinition, tEnum,
																tSignature, model, _edge_signature });
													}
												}
											}
										}
	...
	public static final boolean pattern_EnumConstant_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			EnumConstant _this, Match match, TField tName, TFieldDefinition tDefinition, TClass tEnum,
			TFieldSignature tSignature, TypeGraph model) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tName, tDefinition, tEnum, tSignature, model);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_EnumConstant_21_2_testcorematchandDECs_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_57658 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_57658 != null) {
					...
					if (tmpTEnum instanceof TClass) {
						...
						if (tmpTSignature instanceof TFieldSignature) {
							...
							if (tmpModel instanceof TypeGraph) {
								...
								if (tmpMDefinition instanceof MEnumConstantDeclaration) {
									MEnumConstantDeclaration mDefinition = (MEnumConstantDeclaration) tmpMDefinition;
									return new Object[] { mEnum, tName, tDefinition, tEnum, tSignature, model,
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(EnumDeclaration mEnum,
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mEnum, tName, tDefinition, tEnum, tSignature, model, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_EnumConstant_24_2_matchsrctrgcontext_black = pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					mEnum, tName, tDefinition, tEnum, tSignature, model, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(EnumConstant _this,
		...
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(mEnum, tName, tDefinition, tEnum, tSignature, model,
				mDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, mEnum, tName, tDefinition, tEnum, tSignature, model, mDefinition,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_24_3_solvecsp_binding = pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, mEnum, tName, tDefinition, tEnum, tSignature, model, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(EnumDeclaration mEnum,
		...
		return new Object[] { mEnum, tName, tDefinition, tEnum, tSignature, model, mDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_EnumConstant_27_1_matchtggpattern_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_383823 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_383823 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_59383 = tName.getModel();
		if (__DEC_tName_model_59383 != null) {
			if (!model.equals(__DEC_tName_model_59383)) {
				return new Object[] { tName, model };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(TFieldDefinition tDefinition,
		...
		TSignature __DEC_tDefinition_definitions_383913 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_383913 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_383913)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(TFieldSignature tSignature,
			TField tName) {
		TField __DEC_tSignature_signatures_95796 = tSignature.getField();
		if (__DEC_tSignature_signatures_95796 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_95796)) {
				return new Object[] { tSignature, tName };
			}
		}
									...
									if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(tName, model) == null) {
										if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(tDefinition,
											...
											if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(tSignature,
													tName) == null) {
												return new Object[] { tName, tDefinition, tEnum, tSignature, model };
											}
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_29_6_perform_greenFBFFBFFBFBB(EnumDeclaration mEnum, TClass tEnum,
		...
		return new Object[] { mBodyToTAnnotation, mEnum, tName, tDefinition, tEnum, mDefinitionToTMember, tSignature,
