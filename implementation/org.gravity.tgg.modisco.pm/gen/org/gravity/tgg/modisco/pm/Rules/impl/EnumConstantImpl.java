...
public class EnumConstantImpl extends AbstractRuleImpl implements EnumConstant {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = EnumConstantImpl.pattern_EnumConstant_1_1_performtransformation_greenFFBFFFBBB(tEnum,
		...
		Object[] result2_black = EnumConstantImpl.pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
				mBodyToTAnnotation, tName, tSignature, tDefinition, mDefinitionToTMember, mDefinition);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mBodyToTAnnotation] = "
					+ mBodyToTAnnotation + ", " + "[tName] = " + tName + ", " + "[tSignature] = " + tSignature + ", "
					+ "[tDefinition] = " + tDefinition + ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember
		...
		Object[] result3_black = EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, mBodyToTAnnotation, mEnum, tName, mEnumToTEnum, tEnum, tSignature, tDefinition,
				mDefinitionToTMember, mDefinition, model);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mBodyToTAnnotation] = " + mBodyToTAnnotation + ", " + "[mEnum] = " + mEnum + ", "
					+ "[tName] = " + tName + ", " + "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[tEnum] = " + tEnum
		...
		EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult,
				mBodyToTAnnotation, mEnum, tName, tEnum, tSignature, tDefinition, mDefinitionToTMember, mDefinition,
				model);
		...
		//nothing EMoflonEdge tSignature__tEnum____type = (EMoflonEdge) result3_green[15];
		...
		//nothing EMoflonEdge model__tName____fields = (EMoflonEdge) result3_green[22];
		//nothing EMoflonEdge tName__model____model = (EMoflonEdge) result3_green[23];
		...
		EnumConstantImpl.pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				mBodyToTAnnotation, mEnum, tName, mEnumToTEnum, tEnum, tSignature, tDefinition, mDefinitionToTMember,
				mDefinition, model);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_2_2_corematch_blackBFFBB(mEnum, mDefinition,
			...
			// ForEach 
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_blackBBBBF(mEnum,
				...
				Object[] result3_green = EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(mEnum,
						mEnumToTEnum, tEnum, mDefinition, model);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, EnumDeclaration mEnum,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum, MEnumConstantDeclaration mDefinition, TypeGraph model) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mEnum,
			EObject tName, EObject mEnumToTEnum, EObject tEnum, EObject tSignature, EObject tDefinition,
			EObject mDefinitionToTMember, EObject mDefinition, EObject model) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TField tName, TClass tEnum, TFieldSignature tSignature,
		...
		Object[] result1_black = EnumConstantImpl.pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(this, match,
				tName, tEnum, tSignature, tDefinition, model);
		if (result1_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[match] = " + match
							+ ", " + "[tName] = " + tName + ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = "
							+ tSignature + ", " + "[tDefinition] = " + tDefinition + ", " + "[model] = " + model + ".");
		}

		Object[] result2_bindingAndBlack = EnumConstantImpl.pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
				this, match, tName, tEnum, tSignature, tDefinition, model);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[match] = " + match
							+ ", " + "[tName] = " + tName + ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = "
		...
		if (EnumConstantImpl.pattern_EnumConstant_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = EnumConstantImpl
					.pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(match, tName, tEnum,
							tSignature, tDefinition, model);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tName] = " + tName + ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = " + tSignature
			...
			EnumConstantImpl.pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(match, tName,
					tEnum, tSignature, tDefinition, model);
			...
			Object[] result5_black = EnumConstantImpl.pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(
					match, tName, tEnum, tSignature, tDefinition, model);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tName] = " + tName + ", " + "[tEnum] = " + tEnum + ", " + "[tSignature] = " + tSignature
						+ ", " + "[tDefinition] = " + tDefinition + ", " + "[model] = " + model + ".");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		TFieldDefinition tDefinition = (TFieldDefinition) result1_bindingAndBlack[5];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_12_2_corematch_blackFBFBBBBB(tName, tEnum,
				tSignature, tDefinition, model, match)) {
			...
			// ForEach 
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(mEnum,
					tName, mEnumToTEnum, tEnum, tSignature, tDefinition, model)) {
				Object[] result3_green = EnumConstantImpl
						.pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(mEnum, tName, mEnumToTEnum,
								tEnum, tSignature, tDefinition, model);
				...
				//nothing EMoflonEdge mEnumToTEnum__mEnum____source = (EMoflonEdge) result3_green[11];
				...
				Object[] result4_bindingAndBlack = EnumConstantImpl
						.pattern_EnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mEnum,
								tName, mEnumToTEnum, tEnum, tSignature, tDefinition, model);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mEnum] = " + mEnum + ", "
							+ "[tName] = " + tName + ", " + "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[tEnum] = "
							+ tEnum + ", " + "[tSignature] = " + tSignature + ", " + "[tDefinition] = " + tDefinition
							+ ", " + "[model] = " + model + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TField tName, TClass tEnum, TFieldSignature tSignature,
			TFieldDefinition tDefinition, TypeGraph model) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TField tName, TClass tEnum, TFieldSignature tSignature,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, EnumDeclaration mEnum, TField tName,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mEnum,
			EObject tName, EObject mEnumToTEnum, EObject tEnum, EObject tSignature, EObject tDefinition,
			EObject mDefinitionToTMember, EObject mDefinition, EObject model) {
		ruleresult.registerObject("mBodyToTAnnotation", mBodyToTAnnotation);
		ruleresult.registerObject("mEnum", mEnum);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_197(EMoflonEdge _edge_field) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_205(EMoflonEdge _edge_enumConstants) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = EnumConstantImpl
				.pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, mEnum, tName, tEnum, tSignature,
						tDefinition, mDefinition, model, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mEnum] = " + mEnum + ", " + "[tName] = " + tName + ", " + "[tEnum] = " + tEnum + ", "
					+ "[tSignature] = " + tSignature + ", " + "[tDefinition] = " + tDefinition + ", "
					+ "[mDefinition] = " + mDefinition + ", " + "[model] = " + model + ", " + "[sourceMatch] = "
		...
		if (EnumConstantImpl.pattern_EnumConstant_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : EnumConstantImpl.pattern_EnumConstant_24_5_matchcorrcontext_blackBFBBB(mEnum,
				...
				Object[] result6_black = EnumConstantImpl.pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(
						mEnum, tName, tEnum, tSignature, tDefinition, mDefinition, model, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(EnumDeclaration mEnum, TField tName, TClass tEnum, TFieldSignature tSignature,
			TFieldDefinition tDefinition, MEnumConstantDeclaration mDefinition, TypeGraph model, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TField tName, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition,
			TypeGraph model) {// 
		Object[] result1_black = EnumConstantImpl.pattern_EnumConstant_28_1_matchtggpattern_blackBBBBB(tName, tEnum,
				tSignature, tDefinition, model);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : EnumConstantImpl
			...
			Object[] result3_bindingAndBlack = EnumConstantImpl
					.pattern_EnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, mEnum,
							mEnumToTEnum, tEnum, model, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mEnum] = " + mEnum + ", "
						+ "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[tEnum] = " + tEnum + ", " + "[model] = " + model
			...
			if (EnumConstantImpl.pattern_EnumConstant_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = EnumConstantImpl.pattern_EnumConstant_29_5_checknacs_blackBBBB(mEnum,
						mEnumToTEnum, tEnum, model);
				if (result5_black != null) {

					Object[] result6_black = EnumConstantImpl.pattern_EnumConstant_29_6_perform_blackBBBBB(mEnum,
							mEnumToTEnum, tEnum, model, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mEnum] = " + mEnum
								+ ", " + "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[tEnum] = " + tEnum + ", "
					...
					EnumConstantImpl.pattern_EnumConstant_29_6_perform_greenFBFBFFFFBBB(mEnum, tEnum, model, ruleResult,
							csp);
					//nothing ASTNodeToTAnnotatable mBodyToTAnnotation = (ASTNodeToTAnnotatable) result6_green[0];
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, EnumDeclaration mEnum,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum, TypeGraph model, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ENUMDECLARATION_TYPETOTABSTRACTTYPE_TCLASS_MENUMCONSTANTDECLARATION_TYPEGRAPH:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD__MATCH_TFIELD_TCLASS_TFIELDSIGNATURE_TFIELDDEFINITION_TYPEGRAPH:
			return isAppropriate_BWD((Match) arguments.get(0), (TField) arguments.get(1), (TClass) arguments.get(2),
					(TFieldSignature) arguments.get(3), (TFieldDefinition) arguments.get(4),
		...
		case RulesPackage.ENUM_CONSTANT___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TFIELD_TCLASS_TFIELDSIGNATURE_TFIELDDEFINITION_TYPEGRAPH:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TField) arguments.get(1), (TClass) arguments.get(2),
					(TFieldSignature) arguments.get(3), (TFieldDefinition) arguments.get(4),
					(TypeGraph) arguments.get(5));
			return null;
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TFIELD_TCLASS_TFIELDSIGNATURE_TFIELDDEFINITION_TYPEGRAPH:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (TField) arguments.get(1),
					(TClass) arguments.get(2), (TFieldSignature) arguments.get(3), (TFieldDefinition) arguments.get(4),
					(TypeGraph) arguments.get(5));
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMDECLARATION_TFIELD_TYPETOTABSTRACTTYPE_TCLASS_TFIELDSIGNATURE_TFIELDDEFINITION_TYPEGRAPH:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (EnumDeclaration) arguments.get(1),
					(TField) arguments.get(2), (TypeToTAbstractType) arguments.get(3), (TClass) arguments.get(4),
					(TFieldSignature) arguments.get(5), (TFieldDefinition) arguments.get(6),
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_197__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_197((EMoflonEdge) arguments.get(0));
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_205__EMOFLONEDGE:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_CC__ENUMDECLARATION_TFIELD_TCLASS_TFIELDSIGNATURE_TFIELDDEFINITION_MENUMCONSTANTDECLARATION_TYPEGRAPH_MATCH_MATCH:
			return isApplicable_solveCsp_CC((EnumDeclaration) arguments.get(0), (TField) arguments.get(1),
					(TClass) arguments.get(2), (TFieldSignature) arguments.get(3), (TFieldDefinition) arguments.get(4),
					(MEnumConstantDeclaration) arguments.get(5), (TypeGraph) arguments.get(6), (Match) arguments.get(7),
		...
		case RulesPackage.ENUM_CONSTANT___CHECK_DEC_BWD__TFIELD_TCLASS_TFIELDSIGNATURE_TFIELDDEFINITION_TYPEGRAPH:
			return checkDEC_BWD((TField) arguments.get(0), (TClass) arguments.get(1),
		...
		case RulesPackage.ENUM_CONSTANT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMDECLARATION_TYPETOTABSTRACTTYPE_TCLASS_TYPEGRAPH_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (EnumDeclaration) arguments.get(1),
					(TypeToTAbstractType) arguments.get(2), (TClass) arguments.get(3), (TypeGraph) arguments.get(4),
				...
				if (tmpTEnum instanceof TClass) {
					...
					if (tmpMDefinition instanceof MEnumConstantDeclaration) {
						...
						if (tmpModel instanceof TypeGraph) {
							...
							return new Object[] { mEnum, mEnumToTEnum, tEnum, mDefinition, model, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(EnumDeclaration mEnum,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum, MEnumConstantDeclaration mDefinition, TypeGraph model,
			EnumConstant _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mEnum, mEnumToTEnum, tEnum, mDefinition, model, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_EnumConstant_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_EnumConstant_1_1_performtransformation_black = pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(
					mEnum, mEnumToTEnum, tEnum, mDefinition, model, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_greenFFBFFFBBB(TClass tEnum,
		...
		return new Object[] { mBodyToTAnnotation, tName, tEnum, tSignature, tDefinition, mDefinitionToTMember,
				mDefinition, model, csp };
	}

	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
			ASTNodeToTAnnotatable mBodyToTAnnotation, TField tName, TFieldSignature tSignature,
			TFieldDefinition tDefinition, MDefinitionToTMember mDefinitionToTMember,
			MEnumConstantDeclaration mDefinition) {
		return new Object[] { mBodyToTAnnotation, tName, tSignature, tDefinition, mDefinitionToTMember, mDefinition };
	}
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_greenFBBBBBB(
		...
		return new Object[] { ruleresult, mBodyToTAnnotation, tName, tSignature, tDefinition, mDefinitionToTMember,
				mDefinition };
	}

	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mEnum, EObject tName,
			EObject mEnumToTEnum, EObject tEnum, EObject tSignature, EObject tDefinition, EObject mDefinitionToTMember,
			EObject mDefinition, EObject model) {
	...
	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mEnum, EObject tName, EObject tEnum,
			EObject tSignature, EObject tDefinition, EObject mDefinitionToTMember, EObject mDefinition, EObject model) {
		...
		mEnum__mDefinition____enumConstants.setName(mEnum__mDefinition____enumConstants_name_prime);
		return new Object[] { ruleresult, mBodyToTAnnotation, mEnum, tName, tEnum, tSignature, tDefinition,
				mDefinitionToTMember, mDefinition, model, tSignature__tName____field, tName__tSignature____signatures,
				mBodyToTAnnotation__tDefinition____target, tDefinition__tSignature____signature,
				tSignature__tDefinition____definitions, tSignature__tEnum____type, tEnum__tDefinition____defines,
				tDefinition__tEnum____definedBy, mDefinitionToTMember__tDefinition____target,
				mBodyToTAnnotation__mDefinition____source, tEnum__tSignature____signature,
				mDefinitionToTMember__mDefinition____source, model__tName____fields, tName__model____model,
	...
	public static final void pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mEnumToTEnum, EObject tEnum, EObject tSignature, EObject tDefinition, EObject mDefinitionToTMember,
			EObject mDefinition, EObject model) {
		_this.registerObjects_FWD(ruleresult, mBodyToTAnnotation, mEnum, tName, mEnumToTEnum, tEnum, tSignature,
				tDefinition, mDefinitionToTMember, mDefinition, model);
	...
	public static final Iterable<Object[]> pattern_EnumConstant_2_3_findcontext_blackBBBBF(EnumDeclaration mEnum,
		...
		if (tEnum.equals(mEnumToTEnum.getTarget())) {
			if (mEnum.equals(mEnumToTEnum.getSource())) {
				if (mEnum.getEnumConstants().contains(mDefinition)) {
					...
					if (model != null) {
						_result.add(new Object[] { mEnum, mEnumToTEnum, tEnum, mDefinition, model });
					}
	...
	public static final Object[] pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(EnumDeclaration mEnum,
		...
		mEnum__mDefinition____enumConstants.setName(mEnum__mDefinition____enumConstants_name_prime);
		return new Object[] { mEnum, mEnumToTEnum, tEnum, mDefinition, model, isApplicableMatch, tEnum__model____model,
	...
	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, EnumDeclaration mEnum, TypeToTAbstractType mEnumToTEnum, TClass tEnum,
			MEnumConstantDeclaration mDefinition, TypeGraph model) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mEnum, mEnumToTEnum, tEnum,
				mDefinition, model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEnum, mEnumToTEnum, tEnum, mDefinition, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_2_4_solveCSP_binding = pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mEnum, mEnumToTEnum, tEnum, mDefinition, model);
	...
	public static final Object[] pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(EnumConstant _this, Match match,
			TField tName, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition, TypeGraph model) {
		return new Object[] { _this, match, tName, tEnum, tSignature, tDefinition, model };
	}

	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(EnumConstant _this, Match match,
			TField tName, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition, TypeGraph model) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, tName, tEnum, tSignature, tDefinition, model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, tName, tEnum, tSignature, tDefinition, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
			Match match, TField tName, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition,
			TypeGraph model) {
		Object[] result_pattern_EnumConstant_10_2_SolveCSP_binding = pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, tName, tEnum, tSignature, tDefinition, model);
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(Match match,
			TField tName, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition, TypeGraph model) {
		return new Object[] { match, tName, tEnum, tSignature, tDefinition, model };
	}
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(
		...
		model__tName____fields.setName(model__tName____fields_name_prime);
		tName__model____model.setName(tName__model____model_name_prime);
		return new Object[] { match, tName, tEnum, tSignature, tDefinition, model, tSignature__tName____field,
				tName__tSignature____signatures, tDefinition__tSignature____signature,
				tSignature__tDefinition____definitions, tSignature__tEnum____type, tEnum__tDefinition____defines,
				tDefinition__tEnum____definedBy, tEnum__tSignature____signature, model__tName____fields,
	...
	public static final Object[] pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(Match match, TField tName,
			TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition, TypeGraph model) {
		return new Object[] { match, tName, tEnum, tSignature, tDefinition, model };
	}
	...
	public static final void pattern_EnumConstant_10_6_registerobjectstomatch_expressionBBBBBBB(EnumConstant _this,
			Match match, TField tName, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition,
			TypeGraph model) {
		_this.registerObjectsToMatch_BWD(match, tName, tEnum, tSignature, tDefinition, model);
					...
					if (tmpTEnum instanceof TClass) {
						...
						if (tmpTSignature instanceof TFieldSignature) {
							...
							if (tmpTDefinition instanceof TFieldDefinition) {
								...
								if (tmpModel instanceof TypeGraph) {
									TypeGraph model = (TypeGraph) tmpModel;
									return new Object[] { mEnum, tName, mEnumToTEnum, tEnum, tSignature, tDefinition,
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(EnumDeclaration mEnum,
			TField tName, TypeToTAbstractType mEnumToTEnum, TClass tEnum, TFieldSignature tSignature,
			TFieldDefinition tDefinition, TypeGraph model, EnumConstant _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mEnum, tName, mEnumToTEnum, tEnum, tSignature, tDefinition, model, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_11_1_performtransformation_binding != null) {
			EnumDeclaration mEnum = (EnumDeclaration) result_pattern_EnumConstant_11_1_performtransformation_binding[0];
			...
			TFieldSignature tSignature = (TFieldSignature) result_pattern_EnumConstant_11_1_performtransformation_binding[4];
			TFieldDefinition tDefinition = (TFieldDefinition) result_pattern_EnumConstant_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_EnumConstant_11_1_performtransformation_black = pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
					mEnum, tName, mEnumToTEnum, tEnum, tSignature, tDefinition, model, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_greenFBBFFB(EnumDeclaration mEnum,
		...
		return new Object[] { mBodyToTAnnotation, mEnum, tDefinition, mDefinitionToTMember, mDefinition, csp };
	}
	...
	public static final void pattern_EnumConstant_11_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mEnumToTEnum, EObject tEnum, EObject tSignature, EObject tDefinition, EObject mDefinitionToTMember,
			EObject mDefinition, EObject model) {
		_this.registerObjects_BWD(ruleresult, mBodyToTAnnotation, mEnum, tName, mEnumToTEnum, tEnum, tSignature,
				tDefinition, mDefinitionToTMember, mDefinition, model);
			...
			if (tmpTEnum instanceof TClass) {
				...
				if (tmpTSignature instanceof TFieldSignature) {
					...
					if (tmpTDefinition instanceof TFieldDefinition) {
						...
						if (tmpModel instanceof TypeGraph) {
							TypeGraph model = (TypeGraph) tmpModel;
							return new Object[] { tName, tEnum, tSignature, tDefinition, model, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_2_corematch_blackFBFBBBBB(TField tName, TClass tEnum,
			TFieldSignature tSignature, TFieldDefinition tDefinition, TypeGraph model, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMEnum instanceof EnumDeclaration) {
				EnumDeclaration mEnum = (EnumDeclaration) tmpMEnum;
				_result.add(new Object[] { mEnum, tName, mEnumToTEnum, tEnum, tSignature, tDefinition, model, match });
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(EnumDeclaration mEnum,
			TField tName, TypeToTAbstractType mEnumToTEnum, TClass tEnum, TFieldSignature tSignature,
			TFieldDefinition tDefinition, TypeGraph model) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
								...
								if (tEnum.getDefines().contains(tDefinition)) {
									if (tEnum.getSignature().contains(tSignature)) {
										if (model.getFields().contains(tName)) {
											_result.add(new Object[] { mEnum, tName, mEnumToTEnum, tEnum, tSignature,
													tDefinition, model });
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(
			EnumDeclaration mEnum, TField tName, TypeToTAbstractType mEnumToTEnum, TClass tEnum,
			TFieldSignature tSignature, TFieldDefinition tDefinition, TypeGraph model) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge tEnum__model____model = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge model__tEnum____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mEnumToTEnum__tEnum____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		model__tName____fields.setName(model__tName____fields_name_prime);
		tName__model____model.setName(tName__model____model_name_prime);
		return new Object[] { mEnum, tName, mEnumToTEnum, tEnum, tSignature, tDefinition, model, isApplicableMatch,
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, EnumDeclaration mEnum, TField tName, TypeToTAbstractType mEnumToTEnum,
			TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition, TypeGraph model) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mEnum, tName, mEnumToTEnum, tEnum,
				tSignature, tDefinition, model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEnum, tName, mEnumToTEnum, tEnum, tSignature,
					tDefinition, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_12_4_solveCSP_binding = pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mEnum, tName, mEnumToTEnum, tEnum, tSignature, tDefinition, model);
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_776486 = tName.getModel();
		if (__DEC_tName_model_776486 != null) {
			if (!model.equals(__DEC_tName_model_776486)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TField __DEC_tSignature_signatures_573632 = tSignature.getField();
		if (__DEC_tSignature_signatures_573632 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_573632)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(
		...
		TSignature __DEC_tDefinition_definitions_345060 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_345060 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_345060)) {
												...
												if (tmpTDefinition instanceof TFieldDefinition) {
													...
													if (tEnum.getDefines().contains(tDefinition)) {
														if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(
															...
															_result.add(new Object[] { tName, tEnum, tSignature,
																	tDefinition, model, _edge_field });
														}
													}
												}
											}
	...
	public static final boolean pattern_EnumConstant_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			EnumConstant _this, Match match, TField tName, TClass tEnum, TFieldSignature tSignature,
			TFieldDefinition tDefinition, TypeGraph model) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tName, tEnum, tSignature, tDefinition, model);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_EnumConstant_21_2_testcorematchandDECs_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_194545 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_194545 != null) {
					...
					if (tmpTSignature instanceof TFieldSignature) {
						...
						if (tmpTDefinition instanceof TFieldDefinition) {
							...
							if (tmpMDefinition instanceof MEnumConstantDeclaration) {
								...
								if (tmpModel instanceof TypeGraph) {
									TypeGraph model = (TypeGraph) tmpModel;
									return new Object[] { mEnum, tName, tEnum, tSignature, tDefinition, mDefinition,
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(EnumDeclaration mEnum,
			TField tName, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition,
			MEnumConstantDeclaration mDefinition, TypeGraph model, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mEnum, tName, tEnum, tSignature, tDefinition, mDefinition, model, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding != null) {
			...
			TField tName = (TField) result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding[1];
			TClass tEnum = (TClass) result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding[2];
			TFieldSignature tSignature = (TFieldSignature) result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_EnumConstant_24_2_matchsrctrgcontext_black = pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					mEnum, tName, tEnum, tSignature, tDefinition, mDefinition, model, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(EnumConstant _this,
			EnumDeclaration mEnum, TField tName, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition,
			MEnumConstantDeclaration mDefinition, TypeGraph model, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(mEnum, tName, tEnum, tSignature, tDefinition, mDefinition,
				model, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, mEnum, tName, tEnum, tSignature, tDefinition, mDefinition, model,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_24_3_solvecsp_binding = pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, mEnum, tName, tEnum, tSignature, tDefinition, mDefinition, model, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(EnumDeclaration mEnum,
			TField tName, TClass tEnum, TFieldSignature tSignature, TFieldDefinition tDefinition,
			MEnumConstantDeclaration mDefinition, TypeGraph model, CCMatch ccMatch) {
		return new Object[] { mEnum, tName, tEnum, tSignature, tDefinition, mDefinition, model, ccMatch };
	}
	...
	public static final Object[] pattern_EnumConstant_27_1_matchtggpattern_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_136005 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_136005 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_888503 = tName.getModel();
		if (__DEC_tName_model_888503 != null) {
			if (!model.equals(__DEC_tName_model_888503)) {
				return new Object[] { tName, model };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(TFieldSignature tSignature,
			TField tName) {
		TField __DEC_tSignature_signatures_343898 = tSignature.getField();
		if (__DEC_tSignature_signatures_343898 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_343898)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(TFieldDefinition tDefinition,
		...
		TSignature __DEC_tDefinition_definitions_908601 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_908601 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_908601)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_blackBBBBB(TField tName, TClass tEnum,
			TFieldSignature tSignature, TFieldDefinition tDefinition, TypeGraph model) {
		if (model.equals(tEnum.getModel())) {
			if (tName.equals(tSignature.getField())) {
				if (tSignature.equals(tDefinition.getSignature())) {
									...
									if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(tName, model) == null) {
										if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(tSignature,
											...
											if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(tDefinition,
													tSignature) == null) {
												return new Object[] { tName, tEnum, tSignature, tDefinition, model };
											}
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_29_3_solveCSP_bindingFBBBBBBB(EnumConstant _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mEnum, mEnumToTEnum, tEnum, model,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEnum, mEnumToTEnum, tEnum, model, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_29_3_solveCSP_binding = pattern_EnumConstant_29_3_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mEnum, mEnumToTEnum, tEnum, model, ruleResult);
	...
	public static final Object[] pattern_EnumConstant_29_5_checknacs_blackBBBB(EnumDeclaration mEnum,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum, TypeGraph model) {
		return new Object[] { mEnum, mEnumToTEnum, tEnum, model };
	}

	public static final Object[] pattern_EnumConstant_29_6_perform_blackBBBBB(EnumDeclaration mEnum,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum, TypeGraph model, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mEnum, mEnumToTEnum, tEnum, model, ruleResult };
	}

	public static final Object[] pattern_EnumConstant_29_6_perform_greenFBFBFFFFBBB(EnumDeclaration mEnum, TClass tEnum,
		...
		return new Object[] { mBodyToTAnnotation, mEnum, tName, tEnum, tSignature, tDefinition, mDefinitionToTMember,
				mDefinition, model, ruleResult, csp };
	}
