...
public class EnumConstantImpl extends AbstractRuleImpl implements EnumConstant {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = EnumConstantImpl
				.pattern_EnumConstant_1_1_performtransformation_greenFBFFFFBBB(mDefinition, model, tEnum, csp);
		...
		Object[] result2_black = EnumConstantImpl.pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(tName,
				mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, tSignature);
		...
		Object[] result3_black = EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, tName, mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, mEnumToTEnum,
				tSignature, model, mEnum, tEnum);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tName] = " + tName + ", " + "[mDefinition] = " + mDefinition + ", "
					+ "[mDefinitionToTMember] = " + mDefinitionToTMember + ", " + "[mBodyToTAnnotation] = "
					+ mBodyToTAnnotation + ", " + "[tDefinition] = " + tDefinition + ", " + "[mEnumToTEnum] = "
					+ mEnumToTEnum + ", " + "[tSignature] = " + tSignature + ", " + "[model] = " + model + ", "
					+ "[mEnum] = " + mEnum + ", " + "[tEnum] = " + tEnum + ".");
		}
		EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult, tName,
				mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, tSignature, model, mEnum, tEnum);
		...
		//nothing EMoflonEdge mEnum__mDefinition____enumConstants = (EMoflonEdge) result3_green[21];
		...
		EnumConstantImpl.pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, tName,
				mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, mEnumToTEnum, tSignature, model,
				mEnum, tEnum);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_2_2_corematch_blackBFBFB(mDefinition, mEnum,
			...
			// ForEach 
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_blackBBFBB(mDefinition,
					mEnumToTEnum, mEnum, tEnum)) {
				...
				Object[] result3_green = EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(
						mDefinition, mEnumToTEnum, model, mEnum, tEnum);
				...
				Object[] result4_bindingAndBlack = EnumConstantImpl
						.pattern_EnumConstant_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, mDefinition,
								mEnumToTEnum, model, mEnum, tEnum);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MEnumConstantDeclaration mDefinition,
			TypeToTAbstractType mEnumToTEnum, TypeGraph model, EnumDeclaration mEnum, TClass tEnum) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tName, EObject mDefinition,
			EObject mDefinitionToTMember, EObject mBodyToTAnnotation, EObject tDefinition, EObject mEnumToTEnum,
			EObject tSignature, EObject model, EObject mEnum, EObject tEnum) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TField tName, TFieldDefinition tDefinition,
			TFieldSignature tSignature, TypeGraph model, TClass tEnum) {

		Object[] result1_black = EnumConstantImpl.pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(this, match,
				tName, tDefinition, tSignature, model, tEnum);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tName] = " + tName + ", " + "[tDefinition] = " + tDefinition
					+ ", " + "[tSignature] = " + tSignature + ", " + "[model] = " + model + ", " + "[tEnum] = " + tEnum
					+ ".");
		}

		Object[] result2_bindingAndBlack = EnumConstantImpl.pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
				this, match, tName, tDefinition, tSignature, model, tEnum);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tName] = " + tName + ", " + "[tDefinition] = " + tDefinition
					+ ", " + "[tSignature] = " + tSignature + ", " + "[model] = " + model + ", " + "[tEnum] = " + tEnum
		...
		if (EnumConstantImpl.pattern_EnumConstant_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result5_black = EnumConstantImpl.pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(
					match, tName, tDefinition, tSignature, model, tEnum);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tName] = " + tName + ", " + "[tDefinition] = " + tDefinition + ", " + "[tSignature] = "
						+ tSignature + ", " + "[model] = " + model + ", " + "[tEnum] = " + tEnum + ".");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_green = EnumConstantImpl.pattern_EnumConstant_11_2_collecttranslatedelements_greenFBBBBBB(
				tName, mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, tSignature);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_12_2_corematch_blackBBFBBFBB(tName,
				tDefinition, tSignature, model, tEnum, match)) {
			...
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(tName,
					tDefinition, mEnumToTEnum, tSignature, model, mEnum, tEnum)) {
				Object[] result3_green = EnumConstantImpl
						.pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(tName, tDefinition,
								mEnumToTEnum, tSignature, model, mEnum, tEnum);
				...
				//nothing EMoflonEdge mEnumToTEnum__tEnum____target = (EMoflonEdge) result3_green[19];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[tDefinition] = " + tDefinition + ", " + "[mEnumToTEnum] = " + mEnumToTEnum + ", "
							+ "[tSignature] = " + tSignature + ", " + "[model] = " + model + ", " + "[mEnum] = " + mEnum
							+ ", " + "[tEnum] = " + tEnum + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TField tName, TFieldDefinition tDefinition,
			TFieldSignature tSignature, TypeGraph model, TClass tEnum) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TField tName, TFieldDefinition tDefinition,
			TFieldSignature tSignature, TypeGraph model, TClass tEnum) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TField tName,
			TFieldDefinition tDefinition, TypeToTAbstractType mEnumToTEnum, TFieldSignature tSignature, TypeGraph model,
			EnumDeclaration mEnum, TClass tEnum) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tName, EObject mDefinition,
			EObject mDefinitionToTMember, EObject mBodyToTAnnotation, EObject tDefinition, EObject mEnumToTEnum,
			EObject tSignature, EObject model, EObject mEnum, EObject tEnum) {
		ruleresult.registerObject("tName", tName);
		ruleresult.registerObject("mDefinition", mDefinition);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_77(EMoflonEdge _edge_signature) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_80(EMoflonEdge _edge_enumConstants) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = EnumConstantImpl
				.pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, tName, mDefinition, tDefinition,
						tSignature, model, mEnum, tEnum, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tName] = " + tName + ", " + "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = "
					+ tDefinition + ", " + "[tSignature] = " + tSignature + ", " + "[model] = " + model + ", "
					+ "[mEnum] = " + mEnum + ", " + "[tEnum] = " + tEnum + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (EnumConstantImpl.pattern_EnumConstant_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : EnumConstantImpl.pattern_EnumConstant_24_5_matchcorrcontext_blackFBBBB(mEnum,
				...
				Object[] result6_black = EnumConstantImpl.pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(
						tName, mDefinition, tDefinition, tSignature, model, mEnum, tEnum, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tName] = " + tName + ", "
							+ "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = " + tDefinition + ", "
							+ "[tSignature] = " + tSignature + ", " + "[model] = " + model + ", " + "[mEnum] = " + mEnum
							+ ", " + "[tEnum] = " + tEnum + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TField tName, MEnumConstantDeclaration mDefinition,
			TFieldDefinition tDefinition, TFieldSignature tSignature, TypeGraph model, EnumDeclaration mEnum,
			TClass tEnum, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TField tName, TFieldDefinition tDefinition, TFieldSignature tSignature, TypeGraph model,
			TClass tEnum) {// 
		...
		for (Object[] result2_black : EnumConstantImpl
			...
			Object[] result3_bindingAndBlack = EnumConstantImpl
					.pattern_EnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, mEnumToTEnum,
							model, mEnum, tEnum, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mEnumToTEnum] = " + mEnumToTEnum
						+ ", " + "[model] = " + model + ", " + "[mEnum] = " + mEnum + ", " + "[tEnum] = " + tEnum + ", "
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mEnumToTEnum] = "
								+ mEnumToTEnum + ", " + "[model] = " + model + ", " + "[mEnum] = " + mEnum + ", "
								+ "[tEnum] = " + tEnum + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					EnumConstantImpl.pattern_EnumConstant_29_6_perform_greenFFFFFFBBBBB(model, mEnum, tEnum, ruleResult,
							csp);
					//nothing TField tName = (TField) result6_green[0];
					//nothing MEnumConstantDeclaration mDefinition = (MEnumConstantDeclaration) result6_green[1];
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mEnumToTEnum,
			TypeGraph model, EnumDeclaration mEnum, TClass tEnum, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENUMCONSTANTDECLARATION_TYPETOTABSTRACTTYPE_TYPEGRAPH_ENUMDECLARATION_TCLASS:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MEnumConstantDeclaration) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TypeGraph) arguments.get(3), (EnumDeclaration) arguments.get(4), (TClass) arguments.get(5));
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD__MATCH_TFIELD_TFIELDDEFINITION_TFIELDSIGNATURE_TYPEGRAPH_TCLASS:
		...
		case RulesPackage.ENUM_CONSTANT___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TFIELD_TFIELDDEFINITION_TFIELDSIGNATURE_TYPEGRAPH_TCLASS:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TField) arguments.get(1),
					(TFieldDefinition) arguments.get(2), (TFieldSignature) arguments.get(3),
					(TypeGraph) arguments.get(4), (TClass) arguments.get(5));
			return null;
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TFIELD_TFIELDDEFINITION_TFIELDSIGNATURE_TYPEGRAPH_TCLASS:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TFIELD_TFIELDDEFINITION_TYPETOTABSTRACTTYPE_TFIELDSIGNATURE_TYPEGRAPH_ENUMDECLARATION_TCLASS:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TField) arguments.get(1),
					(TFieldDefinition) arguments.get(2), (TypeToTAbstractType) arguments.get(3),
					(TFieldSignature) arguments.get(4), (TypeGraph) arguments.get(5),
					(EnumDeclaration) arguments.get(6), (TClass) arguments.get(7));
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_77__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_77((EMoflonEdge) arguments.get(0));
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_80__EMOFLONEDGE:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_CC__TFIELD_MENUMCONSTANTDECLARATION_TFIELDDEFINITION_TFIELDSIGNATURE_TYPEGRAPH_ENUMDECLARATION_TCLASS_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TField) arguments.get(0), (MEnumConstantDeclaration) arguments.get(1),
					(TFieldDefinition) arguments.get(2), (TFieldSignature) arguments.get(3),
					(TypeGraph) arguments.get(4), (EnumDeclaration) arguments.get(5), (TClass) arguments.get(6),
		...
		case RulesPackage.ENUM_CONSTANT___CHECK_DEC_BWD__TFIELD_TFIELDDEFINITION_TFIELDSIGNATURE_TYPEGRAPH_TCLASS:
			return checkDEC_BWD((TField) arguments.get(0), (TFieldDefinition) arguments.get(1),
					(TFieldSignature) arguments.get(2), (TypeGraph) arguments.get(3), (TClass) arguments.get(4));
		case RulesPackage.ENUM_CONSTANT___GENERATE_MODEL__RULEENTRYCONTAINER_TYPETOTABSTRACTTYPE:
			return generateModel((RuleEntryContainer) arguments.get(0), (TypeToTAbstractType) arguments.get(1));
		case RulesPackage.ENUM_CONSTANT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TYPEGRAPH_ENUMDECLARATION_TCLASS_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (TypeGraph) arguments.get(2),
					(EnumDeclaration) arguments.get(3), (TClass) arguments.get(4),
				...
				if (tmpModel instanceof TypeGraph) {
					...
					if (tmpMEnum instanceof EnumDeclaration) {
						...
						if (tmpTEnum instanceof TClass) {
							...
							return new Object[] { mDefinition, mEnumToTEnum, model, mEnum, tEnum, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(
			MEnumConstantDeclaration mDefinition, TypeToTAbstractType mEnumToTEnum, TypeGraph model,
			EnumDeclaration mEnum, TClass tEnum, EnumConstant _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinition, mEnumToTEnum, model, mEnum, tEnum, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_EnumConstant_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_EnumConstant_1_1_performtransformation_black = pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(
					mDefinition, mEnumToTEnum, model, mEnum, tEnum, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_greenFBFFFFBBB(
		...
		return new Object[] { tName, mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, tSignature,
				model, tEnum, csp };
	}
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(TField tName,
			...
			ASTNodeToTAnnotatable mBodyToTAnnotation, TFieldDefinition tDefinition, TFieldSignature tSignature) {
		return new Object[] { tName, mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, tSignature };
	}
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_greenFBBBBBB(TField tName,
		...
		return new Object[] { ruleresult, tName, mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition,
				tSignature };
	}

	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tName, EObject mDefinition, EObject mDefinitionToTMember,
			EObject mBodyToTAnnotation, EObject tDefinition, EObject mEnumToTEnum, EObject tSignature, EObject model,
			EObject mEnum, EObject tEnum) {
	...
	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tName, EObject mDefinition, EObject mDefinitionToTMember,
			EObject mBodyToTAnnotation, EObject tDefinition, EObject tSignature, EObject model, EObject mEnum,
			EObject tEnum) {
		...
		return new Object[] { ruleresult, tName, mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition,
				tSignature, model, mEnum, tEnum, mBodyToTAnnotation__mDefinition____source,
				...
				mDefinitionToTMember__mDefinition____source, tSignature__tEnum____type, model__tName____fields,
				tName__model____model, tSignature__tName____field, tName__tSignature____signatures,
				mEnum__mDefinition____enumConstants, tEnum__tSignature____signature, tEnum__tDefinition____defines,
	...
	public static final void pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mBodyToTAnnotation, EObject tDefinition, EObject mEnumToTEnum, EObject tSignature, EObject model,
			EObject mEnum, EObject tEnum) {
		_this.registerObjects_FWD(ruleresult, tName, mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition,
				mEnumToTEnum, tSignature, model, mEnum, tEnum);
	...
	public static final Iterable<Object[]> pattern_EnumConstant_2_2_corematch_blackBFBFB(
		...
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTEnum instanceof TClass) {
				TClass tEnum = (TClass) tmpTEnum;
				_result.add(new Object[] { mDefinition, mEnumToTEnum, mEnum, tEnum, match });
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_2_3_findcontext_blackBBFBB(
			MEnumConstantDeclaration mDefinition, TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum,
			TClass tEnum) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (mEnum.getEnumConstants().contains(mDefinition)) {
			if (mEnum.equals(mEnumToTEnum.getSource())) {
				if (tEnum.equals(mEnumToTEnum.getTarget())) {
					...
					if (model != null) {
						_result.add(new Object[] { mDefinition, mEnumToTEnum, model, mEnum, tEnum });
					}
	...
	public static final Object[] pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(
			MEnumConstantDeclaration mDefinition, TypeToTAbstractType mEnumToTEnum, TypeGraph model,
			EnumDeclaration mEnum, TClass tEnum) {
	...
	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, MEnumConstantDeclaration mDefinition, TypeToTAbstractType mEnumToTEnum,
			TypeGraph model, EnumDeclaration mEnum, TClass tEnum) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mDefinition, mEnumToTEnum, model,
				mEnum, tEnum);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, mEnumToTEnum, model, mEnum, tEnum };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_2_4_solveCSP_binding = pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mDefinition, mEnumToTEnum, model, mEnum, tEnum);
	...
	public static final Object[] pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(EnumConstant _this, Match match,
			TField tName, TFieldDefinition tDefinition, TFieldSignature tSignature, TypeGraph model, TClass tEnum) {
		return new Object[] { _this, match, tName, tDefinition, tSignature, model, tEnum };
	}

	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(EnumConstant _this, Match match,
			TField tName, TFieldDefinition tDefinition, TFieldSignature tSignature, TypeGraph model, TClass tEnum) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, tName, tDefinition, tSignature, model, tEnum);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, tName, tDefinition, tSignature, model, tEnum };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
			Match match, TField tName, TFieldDefinition tDefinition, TFieldSignature tSignature, TypeGraph model,
			TClass tEnum) {
		Object[] result_pattern_EnumConstant_10_2_SolveCSP_binding = pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, tName, tDefinition, tSignature, model, tEnum);
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(Match match,
			TField tName, TFieldDefinition tDefinition, TFieldSignature tSignature, TypeGraph model, TClass tEnum) {
		return new Object[] { match, tName, tDefinition, tSignature, model, tEnum };
	}
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(
		...
		tEnum__tDefinition____defines.setName(tEnum__tDefinition____defines_name_prime);
		tDefinition__tEnum____definedBy.setName(tDefinition__tEnum____definedBy_name_prime);
		return new Object[] { match, tName, tDefinition, tSignature, model, tEnum, tDefinition__tSignature____signature,
	...
	public static final Object[] pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(Match match, TField tName,
			TFieldDefinition tDefinition, TFieldSignature tSignature, TypeGraph model, TClass tEnum) {
		return new Object[] { match, tName, tDefinition, tSignature, model, tEnum };
	}
	...
	public static final void pattern_EnumConstant_10_6_registerobjectstomatch_expressionBBBBBBB(EnumConstant _this,
			Match match, TField tName, TFieldDefinition tDefinition, TFieldSignature tSignature, TypeGraph model,
			TClass tEnum) {
		_this.registerObjectsToMatch_BWD(match, tName, tDefinition, tSignature, model, tEnum);
					...
					if (tmpTSignature instanceof TFieldSignature) {
						...
						if (tmpModel instanceof TypeGraph) {
							...
							if (tmpMEnum instanceof EnumDeclaration) {
								...
								if (tmpTEnum instanceof TClass) {
									TClass tEnum = (TClass) tmpTEnum;
									return new Object[] { tName, tDefinition, mEnumToTEnum, tSignature, model, mEnum,
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(TField tName,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tName, tDefinition, mEnumToTEnum, tSignature, model, mEnum, tEnum, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_EnumConstant_11_1_performtransformation_black = pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
					tName, tDefinition, mEnumToTEnum, tSignature, model, mEnum, tEnum, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_greenFFFBBB(
		...
		return new Object[] { mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, mEnum, csp };
	}
	...
	public static final void pattern_EnumConstant_11_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mBodyToTAnnotation, EObject tDefinition, EObject mEnumToTEnum, EObject tSignature, EObject model,
			EObject mEnum, EObject tEnum) {
		_this.registerObjects_BWD(ruleresult, tName, mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition,
				mEnumToTEnum, tSignature, model, mEnum, tEnum);
			...
			if (tmpTDefinition instanceof TFieldDefinition) {
				...
				if (tmpTSignature instanceof TFieldSignature) {
					...
					if (tmpModel instanceof TypeGraph) {
						...
						if (tmpTEnum instanceof TClass) {
							TClass tEnum = (TClass) tmpTEnum;
							return new Object[] { tName, tDefinition, tSignature, model, tEnum, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_2_corematch_blackBBFBBFBB(TField tName,
			TFieldDefinition tDefinition, TFieldSignature tSignature, TypeGraph model, TClass tEnum, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMEnum instanceof EnumDeclaration) {
				EnumDeclaration mEnum = (EnumDeclaration) tmpMEnum;
				_result.add(new Object[] { tName, tDefinition, mEnumToTEnum, tSignature, model, mEnum, tEnum, match });
			}
								...
								if (mEnum.equals(mEnumToTEnum.getSource())) {
									if (tEnum.equals(mEnumToTEnum.getTarget())) {
										if (model.equals(tEnum.getModel())) {
											_result.add(new Object[] { tName, tDefinition, mEnumToTEnum, tSignature,
													model, mEnum, tEnum });
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(TField tName,
		...
		tEnum__model____model.setName(tEnum__model____model_name_prime);
		model__tEnum____allTypes.setName(model__tEnum____allTypes_name_prime);
		return new Object[] { tName, tDefinition, mEnumToTEnum, tSignature, model, mEnum, tEnum, isApplicableMatch,
				...
				tName__tSignature____signatures, tEnum__tSignature____signature, tEnum__tDefinition____defines,
				tDefinition__tEnum____definedBy, mEnumToTEnum__mEnum____source, mEnumToTEnum__tEnum____target,
				tEnum__model____model, model__tEnum____allTypes };
	}

	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, TField tName, TFieldDefinition tDefinition,
			TypeToTAbstractType mEnumToTEnum, TFieldSignature tSignature, TypeGraph model, EnumDeclaration mEnum,
			TClass tEnum) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tName, tDefinition, mEnumToTEnum,
				tSignature, model, mEnum, tEnum);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tName, tDefinition, mEnumToTEnum, tSignature, model,
					mEnum, tEnum };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_12_4_solveCSP_binding = pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tName, tDefinition, mEnumToTEnum, tSignature, model, mEnum, tEnum);
		if (result_pattern_EnumConstant_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_EnumConstant_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tName, tDefinition, mEnumToTEnum, tSignature,
						model, mEnum, tEnum };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_222914 = tName.getModel();
		if (__DEC_tName_model_222914 != null) {
			if (!model.equals(__DEC_tName_model_222914)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1B(
		...
		TModule __DEC_tDefinition_contains_176716 = tDefinition.getModule();
		if (__DEC_tDefinition_contains_176716 != null) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(
		...
		TSignature __DEC_tDefinition_definitions_27757 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_27757 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_27757)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_3BB(
		...
		TField __DEC_tSignature_signatures_82800 = tSignature.getField();
		if (__DEC_tSignature_signatures_82800 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_82800)) {
												...
												if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(
													...
													if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_3BB(
														...
														if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
																tName, model) == null) {
															_result.add(new Object[] { tName, tDefinition, tSignature,
																	model, tEnum, _edge_signature });
														}
													}
												}
											}
	...
	public static final boolean pattern_EnumConstant_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			EnumConstant _this, Match match, TField tName, TFieldDefinition tDefinition, TFieldSignature tSignature,
			TypeGraph model, TClass tEnum) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tName, tDefinition, tSignature, model, tEnum);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_EnumConstant_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_913135 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_913135 != null) {
					...
					if (tmpTSignature instanceof TFieldSignature) {
						...
						if (tmpModel instanceof TypeGraph) {
							...
							if (tmpMEnum instanceof EnumDeclaration) {
								...
								if (tmpTEnum instanceof TClass) {
									TClass tEnum = (TClass) tmpTEnum;
									return new Object[] { tName, mDefinition, tDefinition, tSignature, model, mEnum,
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(TField tName,
			...
			TypeGraph model, EnumDeclaration mEnum, TClass tEnum, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tName, mDefinition, tDefinition, tSignature, model, mEnum, tEnum, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_EnumConstant_24_2_matchsrctrgcontext_black = pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					tName, mDefinition, tDefinition, tSignature, model, mEnum, tEnum, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(EnumConstant _this, TField tName,
			MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition, TFieldSignature tSignature,
			TypeGraph model, EnumDeclaration mEnum, TClass tEnum, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(tName, mDefinition, tDefinition, tSignature, model, mEnum,
				tEnum, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, tName, mDefinition, tDefinition, tSignature, model, mEnum, tEnum,
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(EnumConstant _this,
			TField tName, MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition,
			TFieldSignature tSignature, TypeGraph model, EnumDeclaration mEnum, TClass tEnum, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_EnumConstant_24_3_solvecsp_binding = pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, tName, mDefinition, tDefinition, tSignature, model, mEnum, tEnum, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(TField tName,
			MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition, TFieldSignature tSignature,
			TypeGraph model, EnumDeclaration mEnum, TClass tEnum, CCMatch ccMatch) {
		return new Object[] { tName, mDefinition, tDefinition, tSignature, model, mEnum, tEnum, ccMatch };
	}
	...
	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_greenBFFBB(
		...
		return new Object[] { mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_EnumConstant_27_1_matchtggpattern_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_256366 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_256366 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_619423 = tName.getModel();
		if (__DEC_tName_model_619423 != null) {
			if (!model.equals(__DEC_tName_model_619423)) {
				return new Object[] { tName, model };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_1B(TFieldDefinition tDefinition) {
		TModule __DEC_tDefinition_contains_253889 = tDefinition.getModule();
		if (__DEC_tDefinition_contains_253889 != null) {
			return new Object[] { tDefinition };
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(TFieldDefinition tDefinition,
		...
		TSignature __DEC_tDefinition_definitions_847539 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_847539 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_847539)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_3BB(TFieldSignature tSignature,
			TField tName) {
		TField __DEC_tSignature_signatures_920767 = tSignature.getField();
		if (__DEC_tSignature_signatures_920767 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_920767)) {
				return new Object[] { tSignature, tName };
			}
		}
										...
										if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_1B(
											...
											if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(tDefinition,
												...
												if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_3BB(tSignature,
														tName) == null) {
													return new Object[] { tName, tDefinition, tSignature, model,
															tEnum };
												}
											}
										}
									...
									if (pattern_EnumConstant_29_2_isapplicablecore_black_nac_1BB(ruleResult,
										...
										if (pattern_EnumConstant_29_2_isapplicablecore_black_nac_2BB(ruleResult,
											...
											if (pattern_EnumConstant_29_2_isapplicablecore_black_nac_3BB(ruleResult,
													model) == null) {
												_result.add(new Object[] { mEnumToTEnumList, mEnumToTEnum, mEnum, tEnum,
	...
	public static final Object[] pattern_EnumConstant_29_3_solveCSP_bindingFBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, TypeToTAbstractType mEnumToTEnum, TypeGraph model,
			EnumDeclaration mEnum, TClass tEnum, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mEnumToTEnum, model, mEnum, tEnum,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEnumToTEnum, model, mEnum, tEnum, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_29_3_solveCSP_binding = pattern_EnumConstant_29_3_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mEnumToTEnum, model, mEnum, tEnum, ruleResult);
	...
	public static final Object[] pattern_EnumConstant_29_5_checknacs_blackBBBB(TypeToTAbstractType mEnumToTEnum,
			TypeGraph model, EnumDeclaration mEnum, TClass tEnum) {
		return new Object[] { mEnumToTEnum, model, mEnum, tEnum };
	}

	public static final Object[] pattern_EnumConstant_29_6_perform_blackBBBBB(TypeToTAbstractType mEnumToTEnum,
			TypeGraph model, EnumDeclaration mEnum, TClass tEnum, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mEnumToTEnum, model, mEnum, tEnum, ruleResult };
	}

	public static final Object[] pattern_EnumConstant_29_6_perform_greenFFFFFFBBBBB(TypeGraph model,
		...
		return new Object[] { tName, mDefinition, mDefinitionToTMember, mBodyToTAnnotation, tDefinition, tSignature,
				model, mEnum, tEnum, ruleResult, csp };
	}
