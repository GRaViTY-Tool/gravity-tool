...
public class EnumConstantImpl extends AbstractRuleImpl implements EnumConstant {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = EnumConstantImpl
				.pattern_EnumConstant_1_1_performtransformation_greenFFFBFBFBB(mDefinition, model, tEnum, csp);
		...
		Object[] result2_black = EnumConstantImpl.pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
				tDefinition, tSignature, mBodyToTAnnotation, mDefinition, tName, mDefinitionToTMember);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tDefinition] = " + tDefinition
					...
					+ ", " + "[mDefinition] = " + mDefinition + ", " + "[tName] = " + tName + ", "
		...
		Object[] result3_black = EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, tDefinition, tSignature, mEnum, mBodyToTAnnotation, mDefinition, tName, model,
				mDefinitionToTMember, mEnumToTEnum, tEnum);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tDefinition] = " + tDefinition + ", " + "[tSignature] = " + tSignature + ", "
					+ "[mEnum] = " + mEnum + ", " + "[mBodyToTAnnotation] = " + mBodyToTAnnotation + ", "
					+ "[mDefinition] = " + mDefinition + ", " + "[tName] = " + tName + ", " + "[model] = " + model
					+ ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember + ", " + "[mEnumToTEnum] = "
		...
		EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult,
				tDefinition, tSignature, mEnum, mBodyToTAnnotation, mDefinition, tName, model, mDefinitionToTMember,
				tEnum);
		...
		//nothing EMoflonEdge mEnum__mDefinition____enumConstants = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge mBodyToTAnnotation__mDefinition____source = (EMoflonEdge) result3_green[13];
		...
		//nothing EMoflonEdge mBodyToTAnnotation__tDefinition____target = (EMoflonEdge) result3_green[16];
		...
		EnumConstantImpl.pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, tDefinition,
				tSignature, mEnum, mBodyToTAnnotation, mDefinition, tName, model, mDefinitionToTMember, mEnumToTEnum,
				tEnum);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_2_2_corematch_blackBBFFB(mEnum, mDefinition,
				match)) {
			TypeToTAbstractType mEnumToTEnum = (TypeToTAbstractType) result2_black[2];
			TClass tEnum = (TClass) result2_black[3];
			// ForEach 
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_blackBBFBB(mEnum,
					mDefinition, mEnumToTEnum, tEnum)) {
				...
				Object[] result3_green = EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(mEnum,
						mDefinition, model, mEnumToTEnum, tEnum);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, EnumDeclaration mEnum,
			MEnumConstantDeclaration mDefinition, TypeGraph model, TypeToTAbstractType mEnumToTEnum, TClass tEnum) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tDefinition, EObject tSignature,
			EObject mEnum, EObject mBodyToTAnnotation, EObject mDefinition, EObject tName, EObject model,
			EObject mDefinitionToTMember, EObject mEnumToTEnum, EObject tEnum) {
	...
	public boolean isAppropriate_BWD(Match match, TFieldDefinition tDefinition, TFieldSignature tSignature,
		...
		if (EnumConstantImpl.pattern_EnumConstant_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			//nothing EMoflonEdge tEnum__tDefinition____defines = (EMoflonEdge) result4_green[13];
			//nothing EMoflonEdge tDefinition__tEnum____definedBy = (EMoflonEdge) result4_green[14];
			...
			Object[] result5_black = EnumConstantImpl.pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(
					match, tDefinition, tSignature, tName, model, tEnum);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tDefinition] = " + tDefinition + ", " + "[tSignature] = " + tSignature + ", " + "[tName] = "
						+ tName + ", " + "[model] = " + model + ", " + "[tEnum] = " + tEnum + ".");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		TClass tEnum = (TClass) result1_bindingAndBlack[6];
		CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = EnumConstantImpl
				.pattern_EnumConstant_11_1_performtransformation_greenBBFFFB(tDefinition, mEnum, csp);
		ASTNodeToTAnnotatable mBodyToTAnnotation = (ASTNodeToTAnnotatable) result1_green[2];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		TClass tEnum = (TClass) result2_binding[4];
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_12_2_corematch_blackBBFBBFBB(tDefinition,
				tSignature, tName, model, tEnum, match)) {
			EnumDeclaration mEnum = (EnumDeclaration) result2_black[2];
			...
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(
					tDefinition, tSignature, mEnum, tName, model, mEnumToTEnum, tEnum)) {
				Object[] result3_green = EnumConstantImpl
						.pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(tDefinition, tSignature,
								mEnum, tName, model, mEnumToTEnum, tEnum);
				...
				//nothing EMoflonEdge mEnumToTEnum__tEnum____target = (EMoflonEdge) result3_green[20];
				//nothing EMoflonEdge tEnum__tSignature____signature = (EMoflonEdge) result3_green[21];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ ", " + "[tSignature] = " + tSignature + ", " + "[mEnum] = " + mEnum + ", " + "[tName] = "
							+ tName + ", " + "[model] = " + model + ", " + "[mEnumToTEnum] = " + mEnumToTEnum + ", "
							+ "[tEnum] = " + tEnum + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isAppropriate_solveCsp_BWD(Match match, TFieldDefinition tDefinition, TFieldSignature tSignature,
			TField tName, TypeGraph model, TClass tEnum) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TFieldDefinition tDefinition,
			TFieldSignature tSignature, EnumDeclaration mEnum, TField tName, TypeGraph model,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_73(EMoflonEdge _edge_field) {
		...
		for (Object[] result2_black : EnumConstantImpl
			...
			TClass tEnum = (TClass) result2_black[4];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		TClass tEnum = (TClass) result2_bindingAndBlack[6];

		Object[] result3_bindingAndBlack = EnumConstantImpl
				.pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, tDefinition, tSignature, mEnum,
						mDefinition, tName, model, tEnum, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tDefinition] = " + tDefinition + ", " + "[tSignature] = " + tSignature + ", " + "[mEnum] = "
					+ mEnum + ", " + "[mDefinition] = " + mDefinition + ", " + "[tName] = " + tName + ", "
					+ "[model] = " + model + ", " + "[tEnum] = " + tEnum + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (EnumConstantImpl.pattern_EnumConstant_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : EnumConstantImpl.pattern_EnumConstant_24_5_matchcorrcontext_blackBFBBB(mEnum,
				...
				Object[] result6_black = EnumConstantImpl.pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(
						tDefinition, tSignature, mEnum, mDefinition, tName, model, tEnum, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tDefinition] = "
							+ tDefinition + ", " + "[tSignature] = " + tSignature + ", " + "[mEnum] = " + mEnum + ", "
							+ "[mDefinition] = " + mDefinition + ", " + "[tName] = " + tName + ", " + "[model] = "
							+ model + ", " + "[tEnum] = " + tEnum + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				EnumConstantImpl.pattern_EnumConstant_24_6_createcorrespondence_greenBFBFB(tDefinition, mDefinition,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TFieldDefinition tDefinition, TFieldSignature tSignature, EnumDeclaration mEnum,
			MEnumConstantDeclaration mDefinition, TField tName, TypeGraph model, TClass tEnum, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TFieldDefinition tDefinition, TFieldSignature tSignature, TField tName, TypeGraph model,
			TClass tEnum) {// 
		Object[] result1_black = EnumConstantImpl.pattern_EnumConstant_28_1_matchtggpattern_blackBBBBB(tDefinition,
				tSignature, tName, model, tEnum);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : EnumConstantImpl
			...
			Object[] result3_bindingAndBlack = EnumConstantImpl
					.pattern_EnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch, mEnum, model,
							mEnumToTEnum, tEnum, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mEnum] = " + mEnum + ", "
						+ "[model] = " + model + ", " + "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[tEnum] = " + tEnum
			...
			if (EnumConstantImpl.pattern_EnumConstant_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = EnumConstantImpl.pattern_EnumConstant_29_5_checknacs_blackBBBB(mEnum, model,
						mEnumToTEnum, tEnum);
				if (result5_black != null) {

					Object[] result6_black = EnumConstantImpl.pattern_EnumConstant_29_6_perform_blackBBBBB(mEnum, model,
							mEnumToTEnum, tEnum, ruleResult);
					if (result6_black == null) {
					...
					EnumConstantImpl.pattern_EnumConstant_29_6_perform_greenFFBFFFBFBBB(mEnum, model, tEnum, ruleResult,
							csp);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, EnumDeclaration mEnum, TypeGraph model,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ENUMDECLARATION_MENUMCONSTANTDECLARATION_TYPEGRAPH_TYPETOTABSTRACTTYPE_TCLASS:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD__MATCH_TFIELDDEFINITION_TFIELDSIGNATURE_TFIELD_TYPEGRAPH_TCLASS:
		...
		case RulesPackage.ENUM_CONSTANT___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TFIELDDEFINITION_TFIELDSIGNATURE_TFIELD_TYPEGRAPH_TCLASS:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TFieldDefinition) arguments.get(1),
					(TFieldSignature) arguments.get(2), (TField) arguments.get(3), (TypeGraph) arguments.get(4),
					(TClass) arguments.get(5));
			return null;
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TFIELDDEFINITION_TFIELDSIGNATURE_TFIELD_TYPEGRAPH_TCLASS:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TFIELDDEFINITION_TFIELDSIGNATURE_ENUMDECLARATION_TFIELD_TYPEGRAPH_TYPETOTABSTRACTTYPE_TCLASS:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TFieldDefinition) arguments.get(1),
					(TFieldSignature) arguments.get(2), (EnumDeclaration) arguments.get(3), (TField) arguments.get(4),
					(TypeGraph) arguments.get(5), (TypeToTAbstractType) arguments.get(6), (TClass) arguments.get(7));
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_CC__TFIELDDEFINITION_TFIELDSIGNATURE_ENUMDECLARATION_MENUMCONSTANTDECLARATION_TFIELD_TYPEGRAPH_TCLASS_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TFieldDefinition) arguments.get(0), (TFieldSignature) arguments.get(1),
					(EnumDeclaration) arguments.get(2), (MEnumConstantDeclaration) arguments.get(3),
					(TField) arguments.get(4), (TypeGraph) arguments.get(5), (TClass) arguments.get(6),
		...
		case RulesPackage.ENUM_CONSTANT___CHECK_DEC_BWD__TFIELDDEFINITION_TFIELDSIGNATURE_TFIELD_TYPEGRAPH_TCLASS:
			return checkDEC_BWD((TFieldDefinition) arguments.get(0), (TFieldSignature) arguments.get(1),
					(TField) arguments.get(2), (TypeGraph) arguments.get(3), (TClass) arguments.get(4));
		case RulesPackage.ENUM_CONSTANT___GENERATE_MODEL__RULEENTRYCONTAINER_TYPETOTABSTRACTTYPE:
			return generateModel((RuleEntryContainer) arguments.get(0), (TypeToTAbstractType) arguments.get(1));
		case RulesPackage.ENUM_CONSTANT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMDECLARATION_TYPEGRAPH_TYPETOTABSTRACTTYPE_TCLASS_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (EnumDeclaration) arguments.get(1),
					(TypeGraph) arguments.get(2), (TypeToTAbstractType) arguments.get(3), (TClass) arguments.get(4),
				...
				if (tmpModel instanceof TypeGraph) {
					...
					if (tmpMEnumToTEnum instanceof TypeToTAbstractType) {
						...
						if (tmpTEnum instanceof TClass) {
							...
							return new Object[] { mEnum, mDefinition, model, mEnumToTEnum, tEnum, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(EnumDeclaration mEnum,
			MEnumConstantDeclaration mDefinition, TypeGraph model, TypeToTAbstractType mEnumToTEnum, TClass tEnum,
			EnumConstant _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mEnum, mDefinition, model, mEnumToTEnum, tEnum, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_EnumConstant_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_EnumConstant_1_1_performtransformation_black = pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(
					mEnum, mDefinition, model, mEnumToTEnum, tEnum, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_greenFFFBFBFBB(
		...
		return new Object[] { tDefinition, tSignature, mBodyToTAnnotation, mDefinition, tName, model,
				mDefinitionToTMember, tEnum, csp };
	}

	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
			TFieldDefinition tDefinition, TFieldSignature tSignature, ASTNodeToTAnnotatable mBodyToTAnnotation,
			MEnumConstantDeclaration mDefinition, TField tName, MDefinitionToTMember mDefinitionToTMember) {
		return new Object[] { tDefinition, tSignature, mBodyToTAnnotation, mDefinition, tName, mDefinitionToTMember };
	}
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_greenFBBBBBB(
		...
		return new Object[] { ruleresult, tDefinition, tSignature, mBodyToTAnnotation, mDefinition, tName,
				mDefinitionToTMember };
	}

	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tDefinition, EObject tSignature, EObject mEnum,
			EObject mBodyToTAnnotation, EObject mDefinition, EObject tName, EObject model, EObject mDefinitionToTMember,
			EObject mEnumToTEnum, EObject tEnum) {
	...
	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, tDefinition, tSignature, mEnum, mBodyToTAnnotation, mDefinition, tName, model,
				mDefinitionToTMember, tEnum, tSignature__tName____field, tName__tSignature____signatures,
				...
				mBodyToTAnnotation__tDefinition____target, model__tName____fields, tName__model____model,
	...
	public static final void pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mBodyToTAnnotation, EObject mDefinition, EObject tName, EObject model, EObject mDefinitionToTMember,
			EObject mEnumToTEnum, EObject tEnum) {
		_this.registerObjects_FWD(ruleresult, tDefinition, tSignature, mEnum, mBodyToTAnnotation, mDefinition, tName,
				model, mDefinitionToTMember, mEnumToTEnum, tEnum);
	...
	public static final Iterable<Object[]> pattern_EnumConstant_2_2_corematch_blackBBFFB(EnumDeclaration mEnum,
		...
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTEnum instanceof TClass) {
				TClass tEnum = (TClass) tmpTEnum;
				_result.add(new Object[] { mEnum, mDefinition, mEnumToTEnum, tEnum, match });
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_2_3_findcontext_blackBBFBB(EnumDeclaration mEnum,
		...
		if (mEnum.getEnumConstants().contains(mDefinition)) {
			if (mEnum.equals(mEnumToTEnum.getSource())) {
				if (tEnum.equals(mEnumToTEnum.getTarget())) {
					...
					if (model != null) {
						_result.add(new Object[] { mEnum, mDefinition, model, mEnumToTEnum, tEnum });
					}
	...
	public static final Object[] pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(EnumDeclaration mEnum,
		...
		return new Object[] { mEnum, mDefinition, model, mEnumToTEnum, tEnum, isApplicableMatch,
				mEnum__mDefinition____enumConstants, mEnumToTEnum__mEnum____source, tEnum__model____model,
				model__tEnum____ownedTypes, mEnumToTEnum__tEnum____target };
	}

	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, EnumDeclaration mEnum, MEnumConstantDeclaration mDefinition,
			TypeGraph model, TypeToTAbstractType mEnumToTEnum, TClass tEnum) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mEnum, mDefinition, model,
				mEnumToTEnum, tEnum);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEnum, mDefinition, model, mEnumToTEnum, tEnum };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_2_4_solveCSP_binding = pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mEnum, mDefinition, model, mEnumToTEnum, tEnum);
	...
	public static final Object[] pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(EnumConstant _this, Match match,
			TFieldDefinition tDefinition, TFieldSignature tSignature, TField tName, TypeGraph model, TClass tEnum) {
		return new Object[] { _this, match, tDefinition, tSignature, tName, model, tEnum };
	}

	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(EnumConstant _this, Match match,
			TFieldDefinition tDefinition, TFieldSignature tSignature, TField tName, TypeGraph model, TClass tEnum) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, tDefinition, tSignature, tName, model, tEnum);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, tDefinition, tSignature, tName, model, tEnum };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
			Match match, TFieldDefinition tDefinition, TFieldSignature tSignature, TField tName, TypeGraph model,
			TClass tEnum) {
		Object[] result_pattern_EnumConstant_10_2_SolveCSP_binding = pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, tDefinition, tSignature, tName, model, tEnum);
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(Match match,
			TFieldDefinition tDefinition, TFieldSignature tSignature, TField tName, TypeGraph model, TClass tEnum) {
		return new Object[] { match, tDefinition, tSignature, tName, model, tEnum };
	}
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(
		...
		tDefinition__tEnum____definedBy.setName(tDefinition__tEnum____definedBy_name_prime);
		tEnum__tSignature____signature.setName(tEnum__tSignature____signature_name_prime);
		return new Object[] { match, tDefinition, tSignature, tName, model, tEnum, tSignature__tName____field,
	...
	public static final void pattern_EnumConstant_10_6_registerobjectstomatch_expressionBBBBBBB(EnumConstant _this,
			Match match, TFieldDefinition tDefinition, TFieldSignature tSignature, TField tName, TypeGraph model,
			TClass tEnum) {
		_this.registerObjectsToMatch_BWD(match, tDefinition, tSignature, tName, model, tEnum);
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_bindingFFFFFFFB(
		...
		EObject _localVariable_6 = isApplicableMatch.getObject("tEnum");
		...
		EObject tmpTEnum = _localVariable_6;
					...
					if (tmpTName instanceof TField) {
						...
						if (tmpModel instanceof TypeGraph) {
							...
							if (tmpMEnumToTEnum instanceof TypeToTAbstractType) {
								...
								if (tmpTEnum instanceof TClass) {
									TClass tEnum = (TClass) tmpTEnum;
									return new Object[] { tDefinition, tSignature, mEnum, tName, model, mEnumToTEnum,
											tEnum, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
			TFieldDefinition tDefinition, TFieldSignature tSignature, EnumDeclaration mEnum, TField tName,
			TypeGraph model, TypeToTAbstractType mEnumToTEnum, TClass tEnum, EnumConstant _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tDefinition, tSignature, mEnum, tName, model, mEnumToTEnum, tEnum, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_11_1_performtransformation_binding != null) {
			...
			EnumDeclaration mEnum = (EnumDeclaration) result_pattern_EnumConstant_11_1_performtransformation_binding[2];
			...
			TClass tEnum = (TClass) result_pattern_EnumConstant_11_1_performtransformation_binding[6];
			...
			Object[] result_pattern_EnumConstant_11_1_performtransformation_black = pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
					tDefinition, tSignature, mEnum, tName, model, mEnumToTEnum, tEnum, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_greenBBFFFB(
		...
		return new Object[] { tDefinition, mEnum, mBodyToTAnnotation, mDefinition, mDefinitionToTMember, csp };
	}
	...
	public static final void pattern_EnumConstant_11_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mBodyToTAnnotation, EObject mDefinition, EObject tName, EObject model, EObject mDefinitionToTMember,
			EObject mEnumToTEnum, EObject tEnum) {
		_this.registerObjects_BWD(ruleresult, tDefinition, tSignature, mEnum, mBodyToTAnnotation, mDefinition, tName,
				model, mDefinitionToTMember, mEnumToTEnum, tEnum);
	...
	public static final Object[] pattern_EnumConstant_12_2_corematch_bindingFFFFFB(Match match) {
		...
		EObject _localVariable_4 = match.getObject("tEnum");
		EObject tmpTDefinition = _localVariable_0;
		EObject tmpTSignature = _localVariable_1;
			...
			if (tmpTSignature instanceof TFieldSignature) {
				...
				if (tmpTName instanceof TField) {
					...
					if (tmpModel instanceof TypeGraph) {
						...
						if (tmpTEnum instanceof TClass) {
							TClass tEnum = (TClass) tmpTEnum;
							return new Object[] { tDefinition, tSignature, tName, model, tEnum, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_2_corematch_blackBBFBBFBB(
			TFieldDefinition tDefinition, TFieldSignature tSignature, TField tName, TypeGraph model, TClass tEnum,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMEnum instanceof EnumDeclaration) {
				EnumDeclaration mEnum = (EnumDeclaration) tmpMEnum;
				_result.add(new Object[] { tDefinition, tSignature, mEnum, tName, model, mEnumToTEnum, tEnum, match });
			}
								...
								if (model.equals(tEnum.getModel())) {
									if (tEnum.equals(mEnumToTEnum.getTarget())) {
										if (tEnum.getSignature().contains(tSignature)) {
											_result.add(new Object[] { tDefinition, tSignature, mEnum, tName, model,
													mEnumToTEnum, tEnum });
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(
		...
		mEnumToTEnum__tEnum____target.setName(mEnumToTEnum__tEnum____target_name_prime);
		tEnum__tSignature____signature.setName(tEnum__tSignature____signature_name_prime);
		return new Object[] { tDefinition, tSignature, mEnum, tName, model, mEnumToTEnum, tEnum, isApplicableMatch,
				tSignature__tName____field, tName__tSignature____signatures, tDefinition__tSignature____signature,
				tSignature__tDefinition____definitions, model__tName____fields, tName__model____model,
				tSignature__tEnum____type, mEnumToTEnum__mEnum____source, tEnum__tDefinition____defines,
				tDefinition__tEnum____definedBy, tEnum__model____model, model__tEnum____ownedTypes,
				mEnumToTEnum__tEnum____target, tEnum__tSignature____signature };
	}

	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, TFieldDefinition tDefinition, TFieldSignature tSignature,
			EnumDeclaration mEnum, TField tName, TypeGraph model, TypeToTAbstractType mEnumToTEnum, TClass tEnum) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tDefinition, tSignature, mEnum, tName,
				model, mEnumToTEnum, tEnum);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tDefinition, tSignature, mEnum, tName, model,
					mEnumToTEnum, tEnum };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_12_4_solveCSP_binding = pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tDefinition, tSignature, mEnum, tName, model, mEnumToTEnum, tEnum);
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TSignature __DEC_tDefinition_definitions_562191 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_562191 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_562191)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TField __DEC_tSignature_signatures_748141 = tSignature.getField();
		if (__DEC_tSignature_signatures_748141 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_748141)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_82738 = tName.getModel();
		if (__DEC_tName_model_82738 != null) {
			if (!model.equals(__DEC_tName_model_82738)) {
												...
												if (tmpTDefinition instanceof TFieldDefinition) {
													...
													if (tEnum.getDefines().contains(tDefinition)) {
														if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
															...
															_result.add(new Object[] { tDefinition, tSignature, tName,
																	model, tEnum, _edge_field });
														}
													}
												}
											}
	...
	public static final boolean pattern_EnumConstant_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			...
			TypeGraph model, TClass tEnum) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tDefinition, tSignature, tName, model, tEnum);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_EnumConstant_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_213289 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_213289 != null) {
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_bindingFFFFFFFBB(Match targetMatch,
		...
		EObject _localVariable_6 = targetMatch.getObject("tEnum");
		EObject tmpTDefinition = _localVariable_0;
		EObject tmpTSignature = _localVariable_1;
		EObject tmpMEnum = _localVariable_2;
					...
					if (tmpMDefinition instanceof MEnumConstantDeclaration) {
						...
						if (tmpTName instanceof TField) {
							...
							if (tmpModel instanceof TypeGraph) {
								...
								if (tmpTEnum instanceof TClass) {
									TClass tEnum = (TClass) tmpTEnum;
									return new Object[] { tDefinition, tSignature, mEnum, mDefinition, tName, model,
											tEnum, targetMatch, sourceMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tDefinition, tSignature, mEnum, mDefinition, tName, model, tEnum, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding != null) {
			...
			TClass tEnum = (TClass) result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding[6];
			...
			Object[] result_pattern_EnumConstant_24_2_matchsrctrgcontext_black = pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					tDefinition, tSignature, mEnum, mDefinition, tName, model, tEnum, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(EnumConstant _this,
			...
			MEnumConstantDeclaration mDefinition, TField tName, TypeGraph model, TClass tEnum, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(tDefinition, tSignature, mEnum, mDefinition, tName, model,
				tEnum, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, tDefinition, tSignature, mEnum, mDefinition, tName, model, tEnum,
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_24_3_solvecsp_binding = pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, tDefinition, tSignature, mEnum, mDefinition, tName, model, tEnum, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(
			TFieldDefinition tDefinition, TFieldSignature tSignature, EnumDeclaration mEnum,
			MEnumConstantDeclaration mDefinition, TField tName, TypeGraph model, TClass tEnum, CCMatch ccMatch) {
		return new Object[] { tDefinition, tSignature, mEnum, mDefinition, tName, model, tEnum, ccMatch };
	}

	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_greenBFBFB(TFieldDefinition tDefinition,
		...
		return new Object[] { tDefinition, mBodyToTAnnotation, mDefinition, mDefinitionToTMember, ccMatch };
	}
	...
	public static final Object[] pattern_EnumConstant_27_1_matchtggpattern_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_285378 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_285378 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(TFieldDefinition tDefinition,
		...
		TSignature __DEC_tDefinition_definitions_170607 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_170607 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_170607)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(TFieldSignature tSignature,
			TField tName) {
		TField __DEC_tSignature_signatures_523619 = tSignature.getField();
		if (__DEC_tSignature_signatures_523619 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_523619)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_703659 = tName.getModel();
		if (__DEC_tName_model_703659 != null) {
			if (!model.equals(__DEC_tName_model_703659)) {
				return new Object[] { tName, model };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_blackBBBBB(TFieldDefinition tDefinition,
			TFieldSignature tSignature, TField tName, TypeGraph model, TClass tEnum) {
		if (tName.equals(tSignature.getField())) {
			if (tSignature.equals(tDefinition.getSignature())) {
				if (model.getFields().contains(tName)) {
					if (tEnum.equals(tSignature.getType())) {
									...
									if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(tDefinition,
										...
										if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(tSignature,
											...
											if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(tName,
													model) == null) {
												return new Object[] { tDefinition, tSignature, tName, model, tEnum };
											}
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_29_3_solveCSP_bindingFBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, EnumDeclaration mEnum, TypeGraph model,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mEnum, model, mEnumToTEnum, tEnum,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEnum, model, mEnumToTEnum, tEnum, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_29_3_solveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_29_3_solveCSP_binding = pattern_EnumConstant_29_3_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mEnum, model, mEnumToTEnum, tEnum, ruleResult);
	...
	public static final Object[] pattern_EnumConstant_29_5_checknacs_blackBBBB(EnumDeclaration mEnum, TypeGraph model,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum) {
		return new Object[] { mEnum, model, mEnumToTEnum, tEnum };
	}

	public static final Object[] pattern_EnumConstant_29_6_perform_blackBBBBB(EnumDeclaration mEnum, TypeGraph model,
			TypeToTAbstractType mEnumToTEnum, TClass tEnum, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mEnum, model, mEnumToTEnum, tEnum, ruleResult };
	}

	public static final Object[] pattern_EnumConstant_29_6_perform_greenFFBFFFBFBBB(EnumDeclaration mEnum,
			TypeGraph model, TClass tEnum, ModelgeneratorRuleResult ruleResult, CSP csp) {
		TFieldDefinition tDefinition = BasicFactory.eINSTANCE.createTFieldDefinition();
		TFieldSignature tSignature = BasicFactory.eINSTANCE.createTFieldSignature();
		ASTNodeToTAnnotatable mBodyToTAnnotation = PmFactory.eINSTANCE.createASTNodeToTAnnotatable();
		MEnumConstantDeclaration mDefinition = ModiscoFactory.eINSTANCE.createMEnumConstantDeclaration();
		...
		return new Object[] { tDefinition, tSignature, mEnum, mBodyToTAnnotation, mDefinition, tName, model,
				mDefinitionToTMember, tEnum, ruleResult, csp };
	}
