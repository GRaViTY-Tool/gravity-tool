...
public class EnumConstantImpl extends AbstractRuleImpl implements EnumConstant {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = EnumConstantImpl
				.pattern_EnumConstant_1_1_performtransformation_greenFFBFBFBFB(mDefinition, tEnum, model, csp);
		...
		Object[] result2_black = EnumConstantImpl.pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
				mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition, tName, tSignature);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mBodyToTAnnotation] = "
					+ mBodyToTAnnotation + ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember + ", "
					+ "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = " + tDefinition + ", " + "[tName] = "
					+ tName + ", " + "[tSignature] = " + tSignature + ".");
		}
		...
		Object[] result3_black = EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, mEnumToTEnum, mEnum, mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition,
				tEnum, tName, model, tSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mEnumToTEnum] = " + mEnumToTEnum + ", " + "[mEnum] = " + mEnum + ", "
					+ "[mBodyToTAnnotation] = " + mBodyToTAnnotation + ", " + "[mDefinitionToTMember] = "
					+ mDefinitionToTMember + ", " + "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = "
					+ tDefinition + ", " + "[tEnum] = " + tEnum + ", " + "[tName] = " + tName + ", " + "[model] = "
					+ model + ", " + "[tSignature] = " + tSignature + ".");
		}
		EnumConstantImpl.pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult, mEnum,
				mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition, tEnum, tName, model, tSignature);
		...
		EnumConstantImpl.pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult, mEnumToTEnum,
				mEnum, mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition, tEnum, tName, model,
				tSignature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_2_2_corematch_blackFBBFB(mEnum, mDefinition,
				match)) {
			...
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_blackBBBBF(mEnumToTEnum,
				...
				Object[] result3_green = EnumConstantImpl.pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(
						mEnumToTEnum, mEnum, mDefinition, tEnum, model);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mEnumToTEnum,
			EnumDeclaration mEnum, MEnumConstantDeclaration mDefinition, TClass tEnum, TypeGraph model) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mEnumToTEnum, EObject mEnum,
			EObject mBodyToTAnnotation, EObject mDefinitionToTMember, EObject mDefinition, EObject tDefinition,
			EObject tEnum, EObject tName, EObject model, EObject tSignature) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TFieldDefinition tDefinition, TClass tEnum, TField tName,
		...
		Object[] result1_black = EnumConstantImpl.pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(this, match,
				tDefinition, tEnum, tName, model, tSignature);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tDefinition] = " + tDefinition + ", " + "[tEnum] = " + tEnum
					+ ", " + "[tName] = " + tName + ", " + "[model] = " + model + ", " + "[tSignature] = " + tSignature
					+ ".");
		}

		Object[] result2_bindingAndBlack = EnumConstantImpl.pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
				this, match, tDefinition, tEnum, tName, model, tSignature);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tDefinition] = " + tDefinition + ", " + "[tEnum] = " + tEnum
					+ ", " + "[tName] = " + tName + ", " + "[model] = " + model + ", " + "[tSignature] = " + tSignature
		...
		if (EnumConstantImpl.pattern_EnumConstant_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = EnumConstantImpl
					.pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(match, tDefinition, tEnum,
							tName, model, tSignature);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tDefinition] = " + tDefinition + ", " + "[tEnum] = " + tEnum + ", " + "[tName] = " + tName
			...
			//nothing EMoflonEdge tSignature__tName____field = (EMoflonEdge) result4_green[7];
			...
			Object[] result5_black = EnumConstantImpl.pattern_EnumConstant_10_5_collectcontextelements_blackBBBBBB(
					match, tDefinition, tEnum, tName, model, tSignature);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tDefinition] = " + tDefinition + ", " + "[tEnum] = " + tEnum + ", " + "[tName] = " + tName
						+ ", " + "[model] = " + model + ", " + "[tSignature] = " + tSignature + ".");
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		EnumConstantImpl.pattern_EnumConstant_11_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				mEnumToTEnum, mEnum, mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition, tEnum, tName,
				model, tSignature);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : EnumConstantImpl.pattern_EnumConstant_12_2_corematch_blackFFBBBBBB(tDefinition,
				tEnum, tName, model, tSignature, match)) {
			TypeToTAbstractType mEnumToTEnum = (TypeToTAbstractType) result2_black[0];
			...
			for (Object[] result3_black : EnumConstantImpl.pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(
					mEnumToTEnum, mEnum, tDefinition, tEnum, tName, model, tSignature)) {
				Object[] result3_green = EnumConstantImpl
						.pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(mEnumToTEnum, mEnum,
								tDefinition, tEnum, tName, model, tSignature);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mEnumToTEnum] = " + mEnumToTEnum
							+ ", " + "[mEnum] = " + mEnum + ", " + "[tDefinition] = " + tDefinition + ", "
							+ "[tEnum] = " + tEnum + ", " + "[tName] = " + tName + ", " + "[model] = " + model + ", "
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TFieldDefinition tDefinition, TClass tEnum, TField tName,
			TypeGraph model, TFieldSignature tSignature) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TFieldDefinition tDefinition, TClass tEnum, TField tName,
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mEnumToTEnum,
			EnumDeclaration mEnum, TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mEnumToTEnum, EObject mEnum,
			EObject mBodyToTAnnotation, EObject mDefinitionToTMember, EObject mDefinition, EObject tDefinition,
			EObject tEnum, EObject tName, EObject model, EObject tSignature) {
		ruleresult.registerObject("mEnumToTEnum", mEnumToTEnum);
		ruleresult.registerObject("mEnum", mEnum);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_53(EMoflonEdge _edge_signature) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_55(EMoflonEdge _edge_enumConstants) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = EnumConstantImpl
				.pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, mEnum, mDefinition, tDefinition,
						tEnum, tName, model, tSignature, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mEnum] = " + mEnum + ", " + "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = "
					+ tDefinition + ", " + "[tEnum] = " + tEnum + ", " + "[tName] = " + tName + ", " + "[model] = "
					+ model + ", " + "[tSignature] = " + tSignature + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (EnumConstantImpl.pattern_EnumConstant_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : EnumConstantImpl.pattern_EnumConstant_24_5_matchcorrcontext_blackFBBBB(mEnum,
				...
				Object[] result6_black = EnumConstantImpl.pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(
						mEnum, mDefinition, tDefinition, tEnum, tName, model, tSignature, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(EnumDeclaration mEnum, MEnumConstantDeclaration mDefinition,
			TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model, TFieldSignature tSignature,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model,
		...
		for (Object[] result2_black : EnumConstantImpl
			...
			if (EnumConstantImpl.pattern_EnumConstant_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					EnumConstantImpl.pattern_EnumConstant_29_6_perform_greenBFFFFBFBFBB(mEnum, tEnum, model, ruleResult,
							csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_ENUMDECLARATION_MENUMCONSTANTDECLARATION_TCLASS_TYPEGRAPH:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD__MATCH_TFIELDDEFINITION_TCLASS_TFIELD_TYPEGRAPH_TFIELDSIGNATURE:
			return isAppropriate_BWD((Match) arguments.get(0), (TFieldDefinition) arguments.get(1),
					(TClass) arguments.get(2), (TField) arguments.get(3), (TypeGraph) arguments.get(4),
		...
		case RulesPackage.ENUM_CONSTANT___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TFIELDDEFINITION_TCLASS_TFIELD_TYPEGRAPH_TFIELDSIGNATURE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TFieldDefinition) arguments.get(1),
					(TClass) arguments.get(2), (TField) arguments.get(3), (TypeGraph) arguments.get(4),
					(TFieldSignature) arguments.get(5));
			return null;
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TFIELDDEFINITION_TCLASS_TFIELD_TYPEGRAPH_TFIELDSIGNATURE:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_ENUMDECLARATION_TFIELDDEFINITION_TCLASS_TFIELD_TYPEGRAPH_TFIELDSIGNATURE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (EnumDeclaration) arguments.get(2),
					(TFieldDefinition) arguments.get(3), (TClass) arguments.get(4), (TField) arguments.get(5),
					(TypeGraph) arguments.get(6), (TFieldSignature) arguments.get(7));
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_53__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_53((EMoflonEdge) arguments.get(0));
		case RulesPackage.ENUM_CONSTANT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_55__EMOFLONEDGE:
		...
		case RulesPackage.ENUM_CONSTANT___IS_APPLICABLE_SOLVE_CSP_CC__ENUMDECLARATION_MENUMCONSTANTDECLARATION_TFIELDDEFINITION_TCLASS_TFIELD_TYPEGRAPH_TFIELDSIGNATURE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((EnumDeclaration) arguments.get(0),
					(MEnumConstantDeclaration) arguments.get(1), (TFieldDefinition) arguments.get(2),
					(TClass) arguments.get(3), (TField) arguments.get(4), (TypeGraph) arguments.get(5),
					(TFieldSignature) arguments.get(6), (Match) arguments.get(7), (Match) arguments.get(8));
		...
		case RulesPackage.ENUM_CONSTANT___CHECK_DEC_BWD__TFIELDDEFINITION_TCLASS_TFIELD_TYPEGRAPH_TFIELDSIGNATURE:
			return checkDEC_BWD((TFieldDefinition) arguments.get(0), (TClass) arguments.get(1),
					(TField) arguments.get(2), (TypeGraph) arguments.get(3), (TFieldSignature) arguments.get(4));
				...
				if (tmpMDefinition instanceof MEnumConstantDeclaration) {
					...
					if (tmpTEnum instanceof TClass) {
						...
						if (tmpModel instanceof TypeGraph) {
							...
							return new Object[] { mEnumToTEnum, mEnum, mDefinition, tEnum, model, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(
			TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum, MEnumConstantDeclaration mDefinition, TClass tEnum,
			TypeGraph model, EnumConstant _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mEnumToTEnum, mEnum, mDefinition, tEnum, model, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_EnumConstant_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_EnumConstant_1_1_performtransformation_black = pattern_EnumConstant_1_1_performtransformation_blackBBBBBFBB(
					mEnumToTEnum, mEnum, mDefinition, tEnum, model, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_1_1_performtransformation_greenFFBFBFBFB(
		...
		return new Object[] { mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition, tEnum, tName, model,
				tSignature, csp };
	}

	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_blackBBBBBB(
			ASTNodeToTAnnotatable mBodyToTAnnotation, MDefinitionToTMember mDefinitionToTMember,
			MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition, TField tName,
			TFieldSignature tSignature) {
		return new Object[] { mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition, tName, tSignature };
	}
	...
	public static final Object[] pattern_EnumConstant_1_2_collecttranslatedelements_greenFBBBBBB(
		...
		return new Object[] { ruleresult, mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition, tName,
				tSignature };
	}

	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mEnumToTEnum, EObject mEnum, EObject mBodyToTAnnotation,
			EObject mDefinitionToTMember, EObject mDefinition, EObject tDefinition, EObject tEnum, EObject tName,
			EObject model, EObject tSignature) {
	...
	public static final Object[] pattern_EnumConstant_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mEnum, EObject mBodyToTAnnotation, EObject mDefinitionToTMember,
			EObject mDefinition, EObject tDefinition, EObject tEnum, EObject tName, EObject model, EObject tSignature) {
		EMoflonEdge mEnum__mDefinition____enumConstants = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mEnum, mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition,
				tEnum, tName, model, tSignature, mEnum__mDefinition____enumConstants,
				mBodyToTAnnotation__mDefinition____source, mBodyToTAnnotation__tDefinition____target,
	...
	public static final void pattern_EnumConstant_1_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mDefinitionToTMember, EObject mDefinition, EObject tDefinition, EObject tEnum, EObject tName,
			EObject model, EObject tSignature) {
		_this.registerObjects_FWD(ruleresult, mEnumToTEnum, mEnum, mBodyToTAnnotation, mDefinitionToTMember,
				mDefinition, tDefinition, tEnum, tName, model, tSignature);
	...
	public static final Iterable<Object[]> pattern_EnumConstant_2_2_corematch_blackFBBFB(EnumDeclaration mEnum,
		...
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTEnum instanceof TClass) {
				TClass tEnum = (TClass) tmpTEnum;
				_result.add(new Object[] { mEnumToTEnum, mEnum, mDefinition, tEnum, match });
			}
		...
		if (mEnum.getEnumConstants().contains(mDefinition)) {
			if (mEnum.equals(mEnumToTEnum.getSource())) {
				if (tEnum.equals(mEnumToTEnum.getTarget())) {
					...
					if (model != null) {
						_result.add(new Object[] { mEnumToTEnum, mEnum, mDefinition, tEnum, model });
					}
	...
	public static final Object[] pattern_EnumConstant_2_3_findcontext_greenBBBBBFFFFFF(TypeToTAbstractType mEnumToTEnum,
			EnumDeclaration mEnum, MEnumConstantDeclaration mDefinition, TClass tEnum, TypeGraph model) {
	...
	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum,
			MEnumConstantDeclaration mDefinition, TClass tEnum, TypeGraph model) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mEnumToTEnum, mEnum, mDefinition,
				tEnum, model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEnumToTEnum, mEnum, mDefinition, tEnum, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_2_4_solveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_2_4_solveCSP_binding = pattern_EnumConstant_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mEnumToTEnum, mEnum, mDefinition, tEnum, model);
	...
	public static final Object[] pattern_EnumConstant_10_1_initialbindings_blackBBBBBBB(EnumConstant _this, Match match,
			TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model, TFieldSignature tSignature) {
		return new Object[] { _this, match, tDefinition, tEnum, tName, model, tSignature };
	}

	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(EnumConstant _this, Match match,
			TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model, TFieldSignature tSignature) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, tDefinition, tEnum, tName, model, tSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, tDefinition, tEnum, tName, model, tSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_10_2_SolveCSP_bindingAndBlackFBBBBBBB(EnumConstant _this,
			Match match, TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model,
			TFieldSignature tSignature) {
		Object[] result_pattern_EnumConstant_10_2_SolveCSP_binding = pattern_EnumConstant_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, tDefinition, tEnum, tName, model, tSignature);
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_blackBBBBBB(Match match,
			TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model, TFieldSignature tSignature) {
		return new Object[] { match, tDefinition, tEnum, tName, model, tSignature };
	}
	...
	public static final Object[] pattern_EnumConstant_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFF(
		...
		tDefinition__tSignature____signature.setName(tDefinition__tSignature____signature_name_prime);
		tSignature__tDefinition____definitions.setName(tSignature__tDefinition____definitions_name_prime);
		return new Object[] { match, tDefinition, tEnum, tName, model, tSignature, tEnum__tSignature____signature,
	...
	public static final void pattern_EnumConstant_10_6_registerobjectstomatch_expressionBBBBBBB(EnumConstant _this,
			Match match, TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model,
			TFieldSignature tSignature) {
		_this.registerObjectsToMatch_BWD(match, tDefinition, tEnum, tName, model, tSignature);
						...
						if (tmpTName instanceof TField) {
							...
							if (tmpModel instanceof TypeGraph) {
								...
								if (tmpTSignature instanceof TFieldSignature) {
									...
									return new Object[] { mEnumToTEnum, mEnum, tDefinition, tEnum, tName, model,
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
			TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum, TFieldDefinition tDefinition, TClass tEnum,
			TField tName, TypeGraph model, TFieldSignature tSignature, EnumConstant _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mEnumToTEnum, mEnum, tDefinition, tEnum, tName, model, tSignature, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_EnumConstant_11_1_performtransformation_black = pattern_EnumConstant_11_1_performtransformation_blackBBBBBBBFBB(
					mEnumToTEnum, mEnum, tDefinition, tEnum, tName, model, tSignature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_EnumConstant_11_1_performtransformation_greenBFFFBB(EnumDeclaration mEnum,
		...
		return new Object[] { mEnum, mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition, csp };
	}
	...
	public static final void pattern_EnumConstant_11_5_registerobjects_expressionBBBBBBBBBBBB(EnumConstant _this,
			...
			EObject mDefinitionToTMember, EObject mDefinition, EObject tDefinition, EObject tEnum, EObject tName,
			EObject model, EObject tSignature) {
		_this.registerObjects_BWD(ruleresult, mEnumToTEnum, mEnum, mBodyToTAnnotation, mDefinitionToTMember,
				mDefinition, tDefinition, tEnum, tName, model, tSignature);
			...
			if (tmpTEnum instanceof TClass) {
				...
				if (tmpTName instanceof TField) {
					...
					if (tmpModel instanceof TypeGraph) {
						...
						if (tmpTSignature instanceof TFieldSignature) {
							TFieldSignature tSignature = (TFieldSignature) tmpTSignature;
							return new Object[] { tDefinition, tEnum, tName, model, tSignature, match };
						}
					}
				}
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_2_corematch_blackFFBBBBBB(
			TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model, TFieldSignature tSignature,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (TypeToTAbstractType mEnumToTEnum : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMEnum instanceof EnumDeclaration) {
				EnumDeclaration mEnum = (EnumDeclaration) tmpMEnum;
				_result.add(new Object[] { mEnumToTEnum, mEnum, tDefinition, tEnum, tName, model, tSignature, match });
			}
	...
	public static final Iterable<Object[]> pattern_EnumConstant_12_3_findcontext_blackBBBBBBB(
			TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum, TFieldDefinition tDefinition, TClass tEnum,
			TField tName, TypeGraph model, TFieldSignature tSignature) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (mEnum.equals(mEnumToTEnum.getSource())) {
			if (tEnum.equals(mEnumToTEnum.getTarget())) {
								...
								if (tEnum.getDefines().contains(tDefinition)) {
									if (model.getFields().contains(tName)) {
										if (tSignature.equals(tDefinition.getSignature())) {
											_result.add(new Object[] { mEnumToTEnum, mEnum, tDefinition, tEnum, tName,
													model, tSignature });
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFF(
		...
		tDefinition__tSignature____signature.setName(tDefinition__tSignature____signature_name_prime);
		tSignature__tDefinition____definitions.setName(tSignature__tDefinition____definitions_name_prime);
		return new Object[] { mEnumToTEnum, mEnum, tDefinition, tEnum, tName, model, tSignature, isApplicableMatch,
				mEnumToTEnum__mEnum____source, mEnumToTEnum__tEnum____target, tEnum__model____model,
				model__tEnum____ownedTypes, tEnum__tSignature____signature, tSignature__tName____field,
				tName__tSignature____signatures, tSignature__tEnum____type, tEnum__tDefinition____defines,
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(EnumConstant _this,
			IsApplicableMatch isApplicableMatch, TypeToTAbstractType mEnumToTEnum, EnumDeclaration mEnum,
			TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model, TFieldSignature tSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mEnumToTEnum, mEnum, tDefinition,
				tEnum, tName, model, tSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEnumToTEnum, mEnum, tDefinition, tEnum, tName, model,
					tSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_12_4_solveCSP_binding = pattern_EnumConstant_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mEnumToTEnum, mEnum, tDefinition, tEnum, tName, model, tSignature);
		if (result_pattern_EnumConstant_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_EnumConstant_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mEnumToTEnum, mEnum, tDefinition, tEnum, tName,
						model, tSignature };
			}
		}
		return null;
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TSignature __DEC_tDefinition_definitions_369181 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_369181 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_369181)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_1BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_776934 = tName.getModel();
		if (__DEC_tName_model_776934 != null) {
			if (!model.equals(__DEC_tName_model_776934)) {
	...
	public static final Object[] pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_2BB(
		...
		TField __DEC_tSignature_signatures_410379 = tSignature.getField();
		if (__DEC_tSignature_signatures_410379 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_410379)) {
												...
												if (tmpTDefinition instanceof TFieldDefinition) {
													...
													if (tSignature.equals(tDefinition.getSignature())) {
														if (pattern_EnumConstant_20_2_testcorematchandDECs_black_nac_0BB(
															...
															_result.add(new Object[] { tDefinition, tEnum, tName, model,
	...
	public static final boolean pattern_EnumConstant_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			EnumConstant _this, Match match, TFieldDefinition tDefinition, TClass tEnum, TField tName, TypeGraph model,
			TFieldSignature tSignature) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tDefinition, tEnum, tName, model, tSignature);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_EnumConstant_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_968306 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_968306 != null) {
					...
					if (tmpTEnum instanceof TClass) {
						...
						if (tmpTName instanceof TField) {
							...
							if (tmpModel instanceof TypeGraph) {
								...
								if (tmpTSignature instanceof TFieldSignature) {
									TFieldSignature tSignature = (TFieldSignature) tmpTSignature;
									return new Object[] { mEnum, mDefinition, tDefinition, tEnum, tName, model,
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(EnumDeclaration mEnum,
			MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition, TClass tEnum, TField tName,
			TypeGraph model, TFieldSignature tSignature, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mEnum, mDefinition, tDefinition, tEnum, tName, model, tSignature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_EnumConstant_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_EnumConstant_24_2_matchsrctrgcontext_black = pattern_EnumConstant_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					mEnum, mDefinition, tDefinition, tEnum, tName, model, tSignature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(EnumConstant _this,
			EnumDeclaration mEnum, MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition, TClass tEnum,
			TField tName, TypeGraph model, TFieldSignature tSignature, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(mEnum, mDefinition, tDefinition, tEnum, tName, model,
				tSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, mEnum, mDefinition, tDefinition, tEnum, tName, model, tSignature,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_EnumConstant_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(EnumConstant _this,
		...
		Object[] result_pattern_EnumConstant_24_3_solvecsp_binding = pattern_EnumConstant_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, mEnum, mDefinition, tDefinition, tEnum, tName, model, tSignature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_EnumConstant_24_6_createcorrespondence_blackBBBBBBBB(EnumDeclaration mEnum,
			MEnumConstantDeclaration mDefinition, TFieldDefinition tDefinition, TClass tEnum, TField tName,
			TypeGraph model, TFieldSignature tSignature, CCMatch ccMatch) {
		return new Object[] { mEnum, mDefinition, tDefinition, tEnum, tName, model, tSignature, ccMatch };
	}
	...
	public static final Object[] pattern_EnumConstant_27_1_matchtggpattern_black_nac_0B(
			MEnumConstantDeclaration mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_459623 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_459623 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(TFieldDefinition tDefinition,
			TFieldSignature tSignature) {
		TSignature __DEC_tDefinition_definitions_602010 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_602010 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_602010)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(TField tName,
			TypeGraph model) {
		TypeGraph __DEC_tName_model_508054 = tName.getModel();
		if (__DEC_tName_model_508054 != null) {
			if (!model.equals(__DEC_tName_model_508054)) {
				return new Object[] { tName, model };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(TFieldSignature tSignature,
			TField tName) {
		TField __DEC_tSignature_signatures_566272 = tSignature.getField();
		if (__DEC_tSignature_signatures_566272 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_566272)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_EnumConstant_28_1_matchtggpattern_blackBBBBB(TFieldDefinition tDefinition,
			TClass tEnum, TField tName, TypeGraph model, TFieldSignature tSignature) {
		if (model.equals(tEnum.getModel())) {
			if (tEnum.getSignature().contains(tSignature)) {
				if (tName.equals(tSignature.getField())) {
					if (tEnum.equals(tSignature.getType())) {
									...
									if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_0BB(tDefinition,
										...
										if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_1BB(tName,
											...
											if (pattern_EnumConstant_28_1_matchtggpattern_black_nac_2BB(tSignature,
													tName) == null) {
												return new Object[] { tDefinition, tEnum, tName, model, tSignature };
											}
										}
									}
								}
	...
	public static final Object[] pattern_EnumConstant_29_6_perform_greenBFFFFBFBFBB(EnumDeclaration mEnum, TClass tEnum,
		...
		return new Object[] { mEnum, mBodyToTAnnotation, mDefinitionToTMember, mDefinition, tDefinition, tEnum, tName,
				model, tSignature, ruleResult, csp };
	}
