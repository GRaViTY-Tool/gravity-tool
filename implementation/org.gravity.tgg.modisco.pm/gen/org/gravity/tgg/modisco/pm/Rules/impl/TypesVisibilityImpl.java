...
public class TypesVisibilityImpl extends AbstractRuleImpl implements TypesVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypesVisibilityImpl.pattern_TypesVisibility_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, tModifier, mType, mModifierToTModifier, tType, mTypeToTType, mModifier);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tModifier] = " + tModifier + ", " + "[mType] = " + mType + ", "
		...
		TypesVisibilityImpl.pattern_TypesVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tModifier,
				mType, mModifierToTModifier, tType, mModifier);
		...
		TypesVisibilityImpl.pattern_TypesVisibility_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tModifier,
				mType, mModifierToTModifier, tType, mTypeToTType, mModifier);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypesVisibilityImpl.pattern_TypesVisibility_2_2_corematch_blackBFFBB(mType,
				mModifier, match)) {
			...
			for (Object[] result3_black : TypesVisibilityImpl.pattern_TypesVisibility_2_3_findcontext_blackBBBB(mType,
					tType, mTypeToTType, mModifier)) {
				Object[] result3_green = TypesVisibilityImpl
						.pattern_TypesVisibility_2_3_findcontext_greenBBBBFFFFF(mType, tType, mTypeToTType, mModifier);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[tType] = " + tType + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[mModifier] = "
							+ mModifier + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AbstractTypeDeclaration mType,
			TAbstractType tType, TypeToTAbstractType mTypeToTType, Modifier mModifier) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tModifier, EObject mType,
			EObject mModifierToTModifier, EObject tType, EObject mTypeToTType, EObject mModifier) {
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tModifier, EObject mType,
			EObject mModifierToTModifier, EObject tType, EObject mTypeToTType, EObject mModifier) {
		ruleresult.registerObject("tModifier", tModifier);
		ruleresult.registerObject("mType", mType);
		ruleresult.registerObject("mModifierToTModifier", mModifierToTModifier);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_13(EMoflonEdge _edge_tModifier) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPES_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_MODIFIER:
		...
		case RulesPackage.TYPES_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_13__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_13((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPES_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_14__EMOFLONEDGE:
			...
			if (tmpTType instanceof TAbstractType) {
				...
				if (tmpMTypeToTType instanceof TypeToTAbstractType) {
					...
					if (tmpMModifier instanceof Modifier) {
						...
						return new Object[] { mType, tType, mTypeToTType, mModifier, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_TypesVisibility_1_1_performtransformation_blackBBBBFBB(
			AbstractTypeDeclaration mType, TAbstractType tType, TypeToTAbstractType mTypeToTType, Modifier mModifier,
			TypesVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, tType, mTypeToTType, mModifier, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesVisibility_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_TypesVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypesVisibility_1_1_performtransformation_black = pattern_TypesVisibility_1_1_performtransformation_blackBBBBFBB(
					mType, tType, mTypeToTType, mModifier, _this, isApplicableMatch);
	...
	public static final Object[] pattern_TypesVisibility_1_1_performtransformation_greenFFBBB(TAbstractType tType,
		...
		return new Object[] { tModifier, mModifierToTModifier, tType, mModifier, csp };
	}
	...
	public static final Object[] pattern_TypesVisibility_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tModifier, EObject mType, EObject mModifierToTModifier, EObject tType,
	...
	public static final Object[] pattern_TypesVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, tModifier, mType, mModifierToTModifier, tType, mModifier,
	...
	public static final void pattern_TypesVisibility_1_5_registerobjects_expressionBBBBBBBB(TypesVisibility _this,
			PerformRuleResult ruleresult, EObject tModifier, EObject mType, EObject mModifierToTModifier, EObject tType,
			EObject mTypeToTType, EObject mModifier) {
		_this.registerObjects_FWD(ruleresult, tModifier, mType, mModifierToTModifier, tType, mTypeToTType, mModifier);
	...
	public static final Iterable<Object[]> pattern_TypesVisibility_2_2_corematch_blackBFFBB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tType != null) {
				_result.add(new Object[] { mType, tType, mTypeToTType, mModifier, match });
			}
		...
		if (mModifier.equals(mType.getModifier())) {
			if (mType.equals(mTypeToTType.getSource())) {
				if (tType.equals(mTypeToTType.getTarget())) {
					_result.add(new Object[] { mType, tType, mTypeToTType, mModifier });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_TypesVisibility_2_3_findcontext_greenBBBBFFFFF(AbstractTypeDeclaration mType,
			TAbstractType tType, TypeToTAbstractType mTypeToTType, Modifier mModifier) {
		...
		return new Object[] { mType, tType, mTypeToTType, mModifier, isApplicableMatch, mType__mModifier____modifier,
	...
	public static final Object[] pattern_TypesVisibility_2_4_solveCSP_bindingFBBBBBB(TypesVisibility _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mType, tType, mTypeToTType,
				mModifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, tType, mTypeToTType, mModifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesVisibility_2_4_solveCSP_bindingAndBlackFBBBBBB(TypesVisibility _this,
		...
		Object[] result_pattern_TypesVisibility_2_4_solveCSP_binding = pattern_TypesVisibility_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, mType, tType, mTypeToTType, mModifier);
	...
	public static final Object[] pattern_TypesVisibility_11_1_performtransformation_greenBBFFB(TModifier tModifier,
		...
		return new Object[] { tModifier, mType, mModifierToTModifier, mModifier, csp };
	}
	...
	public static final void pattern_TypesVisibility_11_5_registerobjects_expressionBBBBBBBB(TypesVisibility _this,
			PerformRuleResult ruleresult, EObject tModifier, EObject mType, EObject mModifierToTModifier, EObject tType,
			EObject mTypeToTType, EObject mModifier) {
		_this.registerObjects_BWD(ruleresult, tModifier, mType, mModifierToTModifier, tType, mTypeToTType, mModifier);
	...
	public static final Object[] pattern_TypesVisibility_20_2_testcorematchandDECs_black_nac_0B(TModifier tModifier) {
		for (TMember __DEC_tModifier_tModifier_963306 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypesVisibility_28_1_matchtggpattern_black_nac_0B(TModifier tModifier) {
		for (TMember __DEC_tModifier_tModifier_513809 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TMember.class, "tModifier")) {
			return new Object[] { tModifier };
		}
		return null;
	...
	public static final Object[] pattern_TypesVisibility_29_6_perform_greenFBFBFBB(AbstractTypeDeclaration mType,
		...
		return new Object[] { tModifier, mType, mModifierToTModifier, tType, mModifier, ruleResult, csp };
	}
