...
public class TypesVisibilityImpl extends AbstractRuleImpl implements TypesVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypesVisibilityImpl.pattern_TypesVisibility_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mModifier, mType, mTypeToTType, mModifierToTModifier, tModifier, tType);
		...
		TypesVisibilityImpl.pattern_TypesVisibility_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mModifier,
				mType, mTypeToTType, mModifierToTModifier, tModifier, tType);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject mType,
			EObject mTypeToTType, EObject mModifierToTModifier, EObject tModifier, EObject tType) {
	...
	public static final Object[] pattern_TypesVisibility_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifier, EObject mType, EObject mTypeToTType,
			EObject mModifierToTModifier, EObject tModifier, EObject tType) {
	...
	public static final Object[] pattern_TypesVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mModifier, EObject mType, EObject mModifierToTModifier,
		...
		return new Object[] { ruleresult, mModifier, mType, mModifierToTModifier, tModifier, tType,
	...
	public static final void pattern_TypesVisibility_1_5_registerobjects_expressionBBBBBBBB(TypesVisibility _this,
			PerformRuleResult ruleresult, EObject mModifier, EObject mType, EObject mTypeToTType,
			EObject mModifierToTModifier, EObject tModifier, EObject tType) {
		_this.registerObjects_FWD(ruleresult, mModifier, mType, mTypeToTType, mModifierToTModifier, tModifier, tType);
	...
	public static final void pattern_TypesVisibility_11_5_registerobjects_expressionBBBBBBBB(TypesVisibility _this,
			PerformRuleResult ruleresult, EObject mModifier, EObject mType, EObject mTypeToTType,
			EObject mModifierToTModifier, EObject tModifier, EObject tType) {
		_this.registerObjects_BWD(ruleresult, mModifier, mType, mTypeToTType, mModifierToTModifier, tModifier, tType);
	...
	public static final Object[] pattern_TypesVisibility_20_2_testcorematchandDECs_black_nac_0B(TModifier tModifier) {
		for (TMember __DEC_tModifier_tModifier_179493 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypesVisibility_28_1_matchtggpattern_black_nac_0B(TModifier tModifier) {
		for (TMember __DEC_tModifier_tModifier_878185 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TMember.class, "tModifier")) {
			return new Object[] { tModifier };
		}
		return null;
	...
	public static final Object[] pattern_TypesVisibility_29_6_perform_greenFBFFBBB(AbstractTypeDeclaration mType,
		...
		return new Object[] { mModifier, mType, mModifierToTModifier, tModifier, tType, ruleResult, csp };
	}
