...
public class TypesVisibilityImpl extends AbstractRuleImpl implements TypesVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		TypesVisibilityImpl.pattern_TypesVisibility_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mTypeToTType, mModifier, tType, mType, mModifierToTModifier, tModifier);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mTypeToTType, EObject mModifier,
			EObject tType, EObject mType, EObject mModifierToTModifier, EObject tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_214(EMoflonEdge _edge_modifier) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPES_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_206__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_206((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPES_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_214__EMOFLONEDGE:
	...
	public static final Object[] pattern_TypesVisibility_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mTypeToTType, EObject mModifier, EObject tType, EObject mType,
	...
	public static final Object[] pattern_TypesVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mModifier, EObject tType, EObject mType, EObject mModifierToTModifier,
			EObject tModifier) {
		EMoflonEdge mType__mModifier____modifier = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mModifier__mType____bodyDeclaration = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mModifier, tType, mType, mModifierToTModifier, tModifier,
	...
	public static final void pattern_TypesVisibility_1_5_registerobjects_expressionBBBBBBBB(TypesVisibility _this,
			PerformRuleResult ruleresult, EObject mTypeToTType, EObject mModifier, EObject tType, EObject mType,
			EObject mModifierToTModifier, EObject tModifier) {
		_this.registerObjects_FWD(ruleresult, mTypeToTType, mModifier, tType, mType, mModifierToTModifier, tModifier);
	...
	public static final Object[] pattern_TypesVisibility_2_3_findcontext_greenBBBBFFFFF(
		...
		mType__mModifier____modifier.setName(mType__mModifier____modifier_name_prime);
		mModifier__mType____bodyDeclaration.setName(mModifier__mType____bodyDeclaration_name_prime);
		return new Object[] { mTypeToTType, mModifier, tType, mType, isApplicableMatch, mTypeToTType__tType____target,
	...
	public static final void pattern_TypesVisibility_11_5_registerobjects_expressionBBBBBBBB(TypesVisibility _this,
			PerformRuleResult ruleresult, EObject mTypeToTType, EObject mModifier, EObject tType, EObject mType,
			EObject mModifierToTModifier, EObject tModifier) {
		_this.registerObjects_BWD(ruleresult, mTypeToTType, mModifier, tType, mType, mModifierToTModifier, tModifier);
	...
	public static final Object[] pattern_TypesVisibility_20_2_testcorematchandDECs_black_nac_0B(TModifier tModifier) {
		for (TMember __DEC_tModifier_tModifier_30926 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypesVisibility_28_1_matchtggpattern_black_nac_0B(TModifier tModifier) {
		for (TMember __DEC_tModifier_tModifier_220667 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TMember.class, "tModifier")) {
			return new Object[] { tModifier };
		}
		return null;
	...
	public static final Object[] pattern_TypesVisibility_29_6_perform_greenFBBFFBB(TAbstractType tType,
		...
		return new Object[] { mModifier, tType, mType, mModifierToTModifier, tModifier, ruleResult, csp };
	}
