...
public class TypesVisibilityImpl extends AbstractRuleImpl implements TypesVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypesVisibilityImpl.pattern_TypesVisibility_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mModifier, mTypeToTType, mModifierToTModifier, tModifier, tType, mType);
		...
		TypesVisibilityImpl.pattern_TypesVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mModifier,
				mModifierToTModifier, tModifier, tType, mType);
		...
		TypesVisibilityImpl.pattern_TypesVisibility_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mModifier,
				mTypeToTType, mModifierToTModifier, tModifier, tType, mType);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject mTypeToTType,
			EObject mModifierToTModifier, EObject tModifier, EObject tType, EObject mType) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = TypesVisibilityImpl
				.pattern_TypesVisibility_11_1_performtransformation_greenFFBBB(tModifier, mType, csp);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypesVisibilityImpl
				.pattern_TypesVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mModifier, tModifier, tType, mType,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mModifier] = " + mModifier + ", " + "[tModifier] = " + tModifier + ", " + "[tType] = " + tType
		...
		if (TypesVisibilityImpl.pattern_TypesVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypesVisibilityImpl
				...
				Object[] result6_black = TypesVisibilityImpl
						.pattern_TypesVisibility_24_6_createcorrespondence_blackBBBBB(mModifier, tModifier, tType,
								mType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModifier] = "
							+ mModifier + ", " + "[tModifier] = " + tModifier + ", " + "[tType] = " + tType + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Modifier mModifier, TModifier tModifier, TAbstractType tType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPES_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_33__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_33((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPES_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_36__EMOFLONEDGE:
		...
		case RulesPackage.TYPES_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__MODIFIER_TMODIFIER_TABSTRACTTYPE_ABSTRACTTYPEDECLARATION_MATCH_MATCH:
	...
	public static final Object[] pattern_TypesVisibility_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifier, EObject mTypeToTType, EObject mModifierToTModifier,
			EObject tModifier, EObject tType, EObject mType) {
	...
	public static final Object[] pattern_TypesVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		mType__mModifier____modifier.setName(mType__mModifier____modifier_name_prime);
		mModifier__mType____bodyDeclaration.setName(mModifier__mType____bodyDeclaration_name_prime);
		return new Object[] { ruleresult, mModifier, mModifierToTModifier, tModifier, tType, mType,
	...
	public static final void pattern_TypesVisibility_1_5_registerobjects_expressionBBBBBBBB(TypesVisibility _this,
			PerformRuleResult ruleresult, EObject mModifier, EObject mTypeToTType, EObject mModifierToTModifier,
			EObject tModifier, EObject tType, EObject mType) {
		_this.registerObjects_FWD(ruleresult, mModifier, mTypeToTType, mModifierToTModifier, tModifier, tType, mType);
	...
	public static final Object[] pattern_TypesVisibility_11_1_performtransformation_greenFFBBB(TModifier tModifier,
		...
		return new Object[] { mModifier, mModifierToTModifier, tModifier, mType, csp };
	}
	...
	public static final void pattern_TypesVisibility_11_5_registerobjects_expressionBBBBBBBB(TypesVisibility _this,
			PerformRuleResult ruleresult, EObject mModifier, EObject mTypeToTType, EObject mModifierToTModifier,
			EObject tModifier, EObject tType, EObject mType) {
		_this.registerObjects_BWD(ruleresult, mModifier, mTypeToTType, mModifierToTModifier, tModifier, tType, mType);
	...
	public static final Object[] pattern_TypesVisibility_20_2_testcorematchandDECs_black_nac_0B(TModifier tModifier) {
		for (TMember __DEC_tModifier_tModifier_379437 : org.moflon.core.utilities.eMoflonEMFUtil
		...
		if (tmpMModifier instanceof Modifier) {
			...
			if (tmpTModifier instanceof TModifier) {
				...
				if (tmpTType instanceof TAbstractType) {
					...
					if (tmpMType instanceof AbstractTypeDeclaration) {
						AbstractTypeDeclaration mType = (AbstractTypeDeclaration) tmpMType;
						return new Object[] { mModifier, tModifier, tType, mType, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_TypesVisibility_24_2_matchsrctrgcontext_blackBBBBBB(Modifier mModifier,
			TModifier tModifier, TAbstractType tType, AbstractTypeDeclaration mType, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_TypesVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_TypesVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypesVisibility_24_2_matchsrctrgcontext_black = pattern_TypesVisibility_24_2_matchsrctrgcontext_blackBBBBBB(
					mModifier, tModifier, tType, mType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_TypesVisibility_24_3_solvecsp_bindingFBBBBBBB(TypesVisibility _this,
			Modifier mModifier, TModifier tModifier, TAbstractType tType, AbstractTypeDeclaration mType,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mModifier, tModifier, tType, mType, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mModifier, tModifier, tType, mType, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBB(TypesVisibility _this,
		...
		Object[] result_pattern_TypesVisibility_24_3_solvecsp_binding = pattern_TypesVisibility_24_3_solvecsp_bindingFBBBBBBB(
				_this, mModifier, tModifier, tType, mType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_TypesVisibility_24_6_createcorrespondence_blackBBBBB(Modifier mModifier,
			TModifier tModifier, TAbstractType tType, AbstractTypeDeclaration mType, CCMatch ccMatch) {
		return new Object[] { mModifier, tModifier, tType, mType, ccMatch };
	}
	...
	public static final Object[] pattern_TypesVisibility_28_1_matchtggpattern_black_nac_0B(TModifier tModifier) {
		for (TMember __DEC_tModifier_tModifier_921145 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TMember.class, "tModifier")) {
			return new Object[] { tModifier };
		}
		return null;
	...
	public static final Object[] pattern_TypesVisibility_29_6_perform_greenFFFBBBB(TAbstractType tType,
		...
		return new Object[] { mModifier, mModifierToTModifier, tModifier, tType, mType, ruleResult, csp };
	}
