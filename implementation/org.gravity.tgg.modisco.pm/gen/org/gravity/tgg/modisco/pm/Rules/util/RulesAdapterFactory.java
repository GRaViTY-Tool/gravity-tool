...
public class RulesAdapterFactory extends AdapterFactoryImpl {
	...
	protected RulesSwitch<Adapter> modelSwitch = new RulesSwitch<Adapter>() {
		...
		@Override
		public Adapter caseMethodInvocationTargetRecursive(MethodInvocationTargetRecursive object) {
			return createMethodInvocationTargetRecursiveAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.gravity.tgg.modisco.pm.Rules.MethodInvocationTargetRecursive <em>Method Invocation Target Recursive</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.gravity.tgg.modisco.pm.Rules.MethodInvocationTargetRecursive
	 * @generated
	 */
	public Adapter createMethodInvocationTargetRecursiveAdapter() {
		return null;
	}
