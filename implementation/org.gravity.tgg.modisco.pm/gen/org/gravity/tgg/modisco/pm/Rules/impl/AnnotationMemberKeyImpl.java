...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						annotationMemberValuePairToTAnnotationValue, mValue, ownerToWoner, tOwner,
						annotationToTAnnotation, mAnnotation, mOwner, tAnnotationValue, tAnnotation);
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult,
				annotationMemberValuePairToTAnnotationValue, mValue, mAnnotation, tAnnotationValue, tAnnotation);
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				annotationMemberValuePairToTAnnotationValue, mValue, ownerToWoner, tOwner, annotationToTAnnotation,
				mAnnotation, mOwner, tAnnotationValue, tAnnotation);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackBFFFBBFB(mValue, mAnnotation, mOwner, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(mValue, ownerToWoner, tOwner,
							annotationToTAnnotation, mAnnotation, mOwner, tAnnotation)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(mValue, ownerToWoner, tOwner,
								annotationToTAnnotation, mAnnotation, mOwner, tAnnotation);
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mValue, ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner,
								tAnnotation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mAnnotation + ", " + "[mOwner] = " + mOwner + ", " + "[tAnnotation] = " + tAnnotation
							+ ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AnnotationMemberValuePair mValue,
			...
			Annotation mAnnotation, BodyDeclaration mOwner, TAnnotation tAnnotation) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackFBFFFBBB(
			...
			// ForEach 
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(ownerToWoner, tOwner,
							annotationToTAnnotation, mAnnotation, mOwner, tAnnotationValue, tAnnotation)) {
				Object[] result3_green = AnnotationMemberKeyImpl
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner, tAnnotationValue,
								tAnnotation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[ownerToWoner] = " + ownerToWoner
							+ ", " + "[tOwner] = " + tOwner + ", " + "[annotationToTAnnotation] = "
							+ annotationToTAnnotation + ", " + "[mAnnotation] = " + mAnnotation + ", " + "[mOwner] = "
							+ mOwner + ", " + "[tAnnotationValue] = " + tAnnotationValue + ", " + "[tAnnotation] = "
							+ tAnnotation + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNodeToTAnnotatable ownerToWoner,
			...
			BodyDeclaration mOwner, TAnnotationValue tAnnotationValue, TAnnotation tAnnotation) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_218(EMoflonEdge _edge_tValues) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_227(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mValue, tOwner, mAnnotation,
						mOwner, tAnnotationValue, tAnnotation, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mValue] = " + mValue + ", " + "[tOwner] = " + tOwner + ", " + "[mAnnotation] = " + mAnnotation
					+ ", " + "[mOwner] = " + mOwner + ", " + "[tAnnotationValue] = " + tAnnotationValue + ", "
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackFBFBBBBB(tOwner, mAnnotation, mOwner,
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(mValue, tOwner, mAnnotation,
								mOwner, tAnnotationValue, tAnnotation, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AnnotationMemberValuePair mValue, TAnnotatable tOwner, Annotation mAnnotation,
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
			...
			Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner, tAnnotation,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[ownerToWoner] = " + ownerToWoner
						+ ", " + "[tOwner] = " + tOwner + ", " + "[annotationToTAnnotation] = "
						+ annotationToTAnnotation + ", " + "[mAnnotation] = " + mAnnotation + ", " + "[mOwner] = "
						+ mOwner + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = AnnotationMemberKeyImpl
							.pattern_AnnotationMemberKey_29_6_perform_blackBBBBBBB(ownerToWoner, tOwner,
									annotationToTAnnotation, mAnnotation, mOwner, tAnnotation, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ownerToWoner] = "
								+ ownerToWoner + ", " + "[tOwner] = " + tOwner + ", " + "[annotationToTAnnotation] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONMEMBERVALUEPAIR_ASTNODETOTANNOTATABLE_TANNOTATABLE_ANNOTATIONTOTANNOTATION_ANNOTATION_BODYDECLARATION_TANNOTATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AnnotationMemberValuePair) arguments.get(1), (ASTNodeToTAnnotatable) arguments.get(2),
					(TAnnotatable) arguments.get(3), (AnnotationToTAnnotation) arguments.get(4),
					(Annotation) arguments.get(5), (BodyDeclaration) arguments.get(6), (TAnnotation) arguments.get(7));
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODETOTANNOTATABLE_TANNOTATABLE_ANNOTATIONTOTANNOTATION_ANNOTATION_BODYDECLARATION_TANNOTATIONVALUE_TANNOTATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(ASTNodeToTAnnotatable) arguments.get(1), (TAnnotatable) arguments.get(2),
					(AnnotationToTAnnotation) arguments.get(3), (Annotation) arguments.get(4),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_218__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_218((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_227__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__ANNOTATIONMEMBERVALUEPAIR_TANNOTATABLE_ANNOTATION_BODYDECLARATION_TANNOTATIONVALUE_TANNOTATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((AnnotationMemberValuePair) arguments.get(0),
					(TAnnotatable) arguments.get(1), (Annotation) arguments.get(2), (BodyDeclaration) arguments.get(3),
					(TAnnotationValue) arguments.get(4), (TAnnotation) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODETOTANNOTATABLE_TANNOTATABLE_ANNOTATIONTOTANNOTATION_ANNOTATION_BODYDECLARATION_TANNOTATION_MODELGENERATORRULERESULT:
						...
						if (tmpMAnnotation instanceof Annotation) {
							...
							if (tmpMOwner instanceof BodyDeclaration) {
								...
								if (tmpTAnnotation instanceof TAnnotation) {
									...
									return new Object[] { mValue, ownerToWoner, tOwner, annotationToTAnnotation,
											mAnnotation, mOwner, tAnnotation, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
			...
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, BodyDeclaration mOwner,
			TAnnotation tAnnotation, AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mValue, ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					mValue, ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner, tAnnotation, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject ownerToWoner, EObject tOwner, EObject annotationToTAnnotation, EObject mAnnotation, EObject mOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(
		...
		return new Object[] { ruleresult, annotationMemberValuePairToTAnnotationValue, mValue, mAnnotation,
				tAnnotationValue, tAnnotation, mAnnotation__mValue____values,
				annotationMemberValuePairToTAnnotationValue__tAnnotationValue____target,
				annotationMemberValuePairToTAnnotationValue__mValue____source,
	...
	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationMemberValuePairToTAnnotationValue, EObject mValue, EObject ownerToWoner, EObject tOwner,
			EObject annotationToTAnnotation, EObject mAnnotation, EObject mOwner, EObject tAnnotationValue,
			EObject tAnnotation) {
		_this.registerObjects_FWD(ruleresult, annotationMemberValuePairToTAnnotationValue, mValue, ownerToWoner, tOwner,
				annotationToTAnnotation, mAnnotation, mOwner, tAnnotationValue, tAnnotation);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_2_2_corematch_blackBFFFBBFB(
		...
		for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tOwner != null) {
				for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAnnotation != null) {
						_result.add(new Object[] { mValue, ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation,
								mOwner, tAnnotation, match });
					}
						...
						if (tOwner.getTAnnotation().contains(tAnnotation)) {
							if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
								if (tOwner.equals(ownerToWoner.getTarget())) {
									_result.add(new Object[] { mValue, ownerToWoner, tOwner, annotationToTAnnotation,
											mAnnotation, mOwner, tAnnotation });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		return new Object[] { mValue, ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner, tAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			...
			TAnnotatable tOwner, AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation,
			BodyDeclaration mOwner, TAnnotation tAnnotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mValue, ownerToWoner, tOwner,
				annotationToTAnnotation, mAnnotation, mOwner, tAnnotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mValue, ownerToWoner, tOwner, annotationToTAnnotation,
					mAnnotation, mOwner, tAnnotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mValue, ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner,
				tAnnotation);
		if (result_pattern_AnnotationMemberKey_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationMemberKey_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mValue, ownerToWoner, tOwner,
						annotationToTAnnotation, mAnnotation, mOwner, tAnnotation };
			}
		}
		return null;
					...
					if (tmpMAnnotation instanceof Annotation) {
						...
						if (tmpMOwner instanceof BodyDeclaration) {
							...
							if (tmpTAnnotationValue instanceof TAnnotationValue) {
								...
								if (tmpTAnnotation instanceof TAnnotation) {
									TAnnotation tAnnotation = (TAnnotation) tmpTAnnotation;
									return new Object[] { ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation,
											mOwner, tAnnotationValue, tAnnotation, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, BodyDeclaration mOwner, TAnnotationValue tAnnotationValue, TAnnotation tAnnotation,
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner, tAnnotationValue, tAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_greenFFBBB(
		...
		return new Object[] { annotationMemberValuePairToTAnnotationValue, mValue, mAnnotation, tAnnotationValue, csp };
	}
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationToTAnnotation, EObject mAnnotation, EObject mOwner, EObject tAnnotationValue,
			EObject tAnnotation) {
		_this.registerObjects_BWD(ruleresult, annotationMemberValuePairToTAnnotationValue, mValue, ownerToWoner, tOwner,
				annotationToTAnnotation, mAnnotation, mOwner, tAnnotationValue, tAnnotation);
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (mAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMOwner instanceof BodyDeclaration) {
						BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
						_result.add(new Object[] { ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner,
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, BodyDeclaration mOwner, TAnnotationValue tAnnotationValue,
			TAnnotation tAnnotation) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (mOwner.getAnnotations().contains(mAnnotation)) {
			if (mOwner.equals(ownerToWoner.getSource())) {
						...
						if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
							if (tOwner.equals(ownerToWoner.getTarget())) {
								if (tAnnotation.getTValues().contains(tAnnotationValue)) {
									_result.add(new Object[] { ownerToWoner, tOwner, annotationToTAnnotation,
											mAnnotation, mOwner, tAnnotationValue, tAnnotation });
								}
							}
						}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		ownerToWoner__tOwner____target.setName(ownerToWoner__tOwner____target_name_prime);
		tAnnotation__tAnnotationValue____tValues.setName(tAnnotation__tAnnotationValue____tValues_name_prime);
		return new Object[] { ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner, tAnnotationValue,
				tAnnotation, isApplicableMatch, mOwner__mAnnotation____annotations, ownerToWoner__mOwner____source,
				annotationToTAnnotation__mAnnotation____source, tOwner__tAnnotation____tAnnotation,
				tAnnotation__tOwner____tAnnotated, annotationToTAnnotation__tAnnotation____target,
				ownerToWoner__tOwner____target, tAnnotation__tAnnotationValue____tValues };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			...
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, BodyDeclaration mOwner,
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, ownerToWoner, tOwner,
				annotationToTAnnotation, mAnnotation, mOwner, tAnnotationValue, tAnnotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ownerToWoner, tOwner, annotationToTAnnotation,
					mAnnotation, mOwner, tAnnotationValue, tAnnotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_12_4_solveCSP_binding = pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner,
				tAnnotationValue, tAnnotation);
				...
				if (tmpMAnnotation instanceof Annotation) {
					...
					if (tmpMOwner instanceof BodyDeclaration) {
						...
						if (tmpTAnnotationValue instanceof TAnnotationValue) {
							...
							if (tmpTAnnotation instanceof TAnnotation) {
								TAnnotation tAnnotation = (TAnnotation) tmpTAnnotation;
								return new Object[] { mValue, tOwner, mAnnotation, mOwner, tAnnotationValue,
										tAnnotation, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
			AnnotationMemberValuePair mValue, TAnnotatable tOwner, Annotation mAnnotation, BodyDeclaration mOwner,
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mValue, tOwner, mAnnotation, mOwner, tAnnotationValue, tAnnotation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mValue, tOwner, mAnnotation, mOwner, tAnnotationValue, tAnnotation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			AnnotationMemberValuePair mValue, TAnnotatable tOwner, Annotation mAnnotation, BodyDeclaration mOwner,
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mValue, tOwner, mAnnotation, mOwner, tAnnotationValue,
				tAnnotation, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mValue, tOwner, mAnnotation, mOwner, tAnnotationValue, tAnnotation,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, AnnotationMemberValuePair mValue, TAnnotatable tOwner, Annotation mAnnotation,
			BodyDeclaration mOwner, TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mValue, tOwner, mAnnotation, mOwner, tAnnotationValue, tAnnotation, sourceMatch, targetMatch);
			...
			for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tOwner.equals(ownerToWoner.getTarget())) {
					for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mAnnotation, AnnotationToTAnnotation.class, "source")) {
						if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
							_result.add(new Object[] { ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mValue, tOwner, mAnnotation, mOwner, tAnnotationValue, tAnnotation, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, ownerToWoner, tOwner,
				annotationToTAnnotation, mAnnotation, mOwner, tAnnotation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ownerToWoner, tOwner, annotationToTAnnotation,
					mAnnotation, mOwner, tAnnotation, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_5_checknacs_blackBBBBBB(
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, BodyDeclaration mOwner, TAnnotation tAnnotation) {
		return new Object[] { ownerToWoner, tOwner, annotationToTAnnotation, mAnnotation, mOwner, tAnnotation };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_6_perform_greenFFBFBBB(Annotation mAnnotation,
		...
		return new Object[] { annotationMemberValuePairToTAnnotationValue, mValue, mAnnotation, tAnnotationValue,
				tAnnotation, ruleResult, csp };
	}
