...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mOwner, mAnnotation,
						annotationToTAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation, tOwner,
						mValue, ownerToWoner, tAnnotationValue);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[mOwner] = "
							...
							+ ownerToWoner + ", " + "[tAnnotationValue] = " + tAnnotationValue + ".");
		}
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult,
				mAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation, mValue, tAnnotationValue);
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mOwner, mAnnotation, annotationToTAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation,
				tOwner, mValue, ownerToWoner, tAnnotationValue);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackBBFFFBFB(mOwner, mAnnotation, mValue, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(mOwner, mAnnotation,
							annotationToTAnnotation, tAnnotation, tOwner, mValue, ownerToWoner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(mOwner, mAnnotation,
								annotationToTAnnotation, tAnnotation, tOwner, mValue, ownerToWoner);
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner, mValue,
								ownerToWoner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ tOwner + ", " + "[mValue] = " + mValue + ", " + "[ownerToWoner] = " + ownerToWoner + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, BodyDeclaration mOwner,
			...
			TAnnotatable tOwner, AnnotationMemberValuePair mValue, ASTNodeToTAnnotatable ownerToWoner) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mOwner, EObject mAnnotation,
			EObject annotationToTAnnotation, EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation,
			EObject tOwner, EObject mValue, EObject ownerToWoner, EObject tAnnotationValue) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mOwner, mAnnotation,
						annotationToTAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation, tOwner,
						mValue, ownerToWoner, tAnnotationValue);
		if (result3_black == null) {
			throw new RuntimeException(
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackFFFBBFBB(
			...
			// ForEach 
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(mOwner, mAnnotation,
							annotationToTAnnotation, tAnnotation, tOwner, ownerToWoner, tAnnotationValue)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(mOwner, mAnnotation,
								annotationToTAnnotation, tAnnotation, tOwner, ownerToWoner, tAnnotationValue);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner, ownerToWoner,
								tAnnotationValue);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mOwner] = " + mOwner + ", "
							+ "[mAnnotation] = " + mAnnotation + ", " + "[annotationToTAnnotation] = "
							+ annotationToTAnnotation + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[tOwner] = "
							+ tOwner + ", " + "[ownerToWoner] = " + ownerToWoner + ", " + "[tAnnotationValue] = "
							+ tAnnotationValue + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, BodyDeclaration mOwner,
			Annotation mAnnotation, AnnotationToTAnnotation annotationToTAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, ASTNodeToTAnnotatable ownerToWoner, TAnnotationValue tAnnotationValue) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mOwner, EObject mAnnotation,
			EObject annotationToTAnnotation, EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation,
			EObject tOwner, EObject mValue, EObject ownerToWoner, EObject tAnnotationValue) {
		ruleresult.registerObject("mOwner", mOwner);
		ruleresult.registerObject("mAnnotation", mAnnotation);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_62(EMoflonEdge _edge_tValues) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_65(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mOwner, mAnnotation,
						tAnnotation, tOwner, mValue, tAnnotationValue, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mOwner] = " + mOwner + ", " + "[mAnnotation] = " + mAnnotation + ", " + "[tAnnotation] = "
					+ tAnnotation + ", " + "[tOwner] = " + tOwner + ", " + "[mValue] = " + mValue + ", "
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackBBFBBFBB(mOwner, mAnnotation, tAnnotation,
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(mOwner, mAnnotation,
								tAnnotation, tOwner, mValue, tAnnotationValue, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mOwner] = " + mOwner
							...
							+ "[tOwner] = " + tOwner + ", " + "[mValue] = " + mValue + ", " + "[tAnnotationValue] = "
							+ tAnnotationValue + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(BodyDeclaration mOwner, Annotation mAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, AnnotationMemberValuePair mValue, TAnnotationValue tAnnotationValue, Match sourceMatch,
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ "[mAnnotation] = " + mAnnotation + ", " + "[annotationToTAnnotation] = "
						+ annotationToTAnnotation + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[tOwner] = "
						+ tOwner + ", " + "[ownerToWoner] = " + ownerToWoner + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = AnnotationMemberKeyImpl
							.pattern_AnnotationMemberKey_29_6_perform_blackBBBBBBB(mOwner, mAnnotation,
									annotationToTAnnotation, tAnnotation, tOwner, ownerToWoner, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mOwner] = " + mOwner
								+ ", " + "[mAnnotation] = " + mAnnotation + ", " + "[annotationToTAnnotation] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_BODYDECLARATION_ANNOTATION_ANNOTATIONTOTANNOTATION_TANNOTATION_TANNOTATABLE_ANNOTATIONMEMBERVALUEPAIR_ASTNODETOTANNOTATABLE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (BodyDeclaration) arguments.get(1),
					...
					(TAnnotation) arguments.get(4), (TAnnotatable) arguments.get(5),
					(AnnotationMemberValuePair) arguments.get(6), (ASTNodeToTAnnotatable) arguments.get(7));
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BODYDECLARATION_ANNOTATION_ANNOTATIONTOTANNOTATION_TANNOTATION_TANNOTATABLE_ASTNODETOTANNOTATABLE_TANNOTATIONVALUE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (BodyDeclaration) arguments.get(1),
					(Annotation) arguments.get(2), (AnnotationToTAnnotation) arguments.get(3),
					(TAnnotation) arguments.get(4), (TAnnotatable) arguments.get(5),
					(ASTNodeToTAnnotatable) arguments.get(6), (TAnnotationValue) arguments.get(7));
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_62__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_62((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_65__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__BODYDECLARATION_ANNOTATION_TANNOTATION_TANNOTATABLE_ANNOTATIONMEMBERVALUEPAIR_TANNOTATIONVALUE_MATCH_MATCH:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BODYDECLARATION_ANNOTATION_ANNOTATIONTOTANNOTATION_TANNOTATION_TANNOTATABLE_ASTNODETOTANNOTATABLE_MODELGENERATORRULERESULT:
						...
						if (tmpTOwner instanceof TAnnotatable) {
							...
							if (tmpMValue instanceof AnnotationMemberValuePair) {
								...
								if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
									...
									return new Object[] { mOwner, mAnnotation, annotationToTAnnotation, tAnnotation,
											tOwner, mValue, ownerToWoner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner, mValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner, mValue, ownerToWoner, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mOwner, EObject mAnnotation, EObject annotationToTAnnotation,
			EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation, EObject tOwner, EObject mValue,
			EObject ownerToWoner, EObject tAnnotationValue) {
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject mAnnotation, EObject annotationMemberValuePairToTAnnotationValue,
		...
		return new Object[] { ruleresult, mAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation, mValue,
				tAnnotationValue, mAnnotation__mValue____values, tAnnotation__tAnnotationValue____tValues,
				annotationMemberValuePairToTAnnotationValue__mValue____source,
				annotationMemberValuePairToTAnnotationValue__tAnnotationValue____target };
	}

	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			AnnotationMemberKey _this, PerformRuleResult ruleresult, EObject mOwner, EObject mAnnotation,
			EObject annotationToTAnnotation, EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation,
			EObject tOwner, EObject mValue, EObject ownerToWoner, EObject tAnnotationValue) {
		_this.registerObjects_FWD(ruleresult, mOwner, mAnnotation, annotationToTAnnotation,
				annotationMemberValuePairToTAnnotationValue, tAnnotation, tOwner, mValue, ownerToWoner,
				tAnnotationValue);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_2_2_corematch_blackBBFFFBFB(
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tOwner != null) {
						_result.add(new Object[] { mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner,
								mValue, ownerToWoner, match });
					}
						...
						if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
							if (mOwner.equals(ownerToWoner.getSource())) {
								if (tOwner.equals(ownerToWoner.getTarget())) {
									_result.add(new Object[] { mOwner, mAnnotation, annotationToTAnnotation,
											tAnnotation, tOwner, mValue, ownerToWoner });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		return new Object[] { mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner, mValue, ownerToWoner,
				...
				ownerToWoner__mOwner____source, ownerToWoner__tOwner____target };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mOwner, mAnnotation,
				annotationToTAnnotation, tAnnotation, tOwner, mValue, ownerToWoner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mOwner, mAnnotation, annotationToTAnnotation,
					tAnnotation, tOwner, mValue, ownerToWoner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			...
			Annotation mAnnotation, AnnotationToTAnnotation annotationToTAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, AnnotationMemberValuePair mValue, ASTNodeToTAnnotatable ownerToWoner) {
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner, mValue,
				ownerToWoner);
						...
						if (tmpTOwner instanceof TAnnotatable) {
							...
							if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
								...
								if (tmpTAnnotationValue instanceof TAnnotationValue) {
									...
									return new Object[] { mOwner, mAnnotation, annotationToTAnnotation, tAnnotation,
											tOwner, ownerToWoner, tAnnotationValue, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
			BodyDeclaration mOwner, Annotation mAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
			TAnnotation tAnnotation, TAnnotatable tOwner, ASTNodeToTAnnotatable ownerToWoner,
			TAnnotationValue tAnnotationValue, AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner, ownerToWoner,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner, ownerToWoner, tAnnotationValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_greenBFFBB(
		...
		return new Object[] { mAnnotation, annotationMemberValuePairToTAnnotationValue, mValue, tAnnotationValue, csp };
	}
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationToTAnnotation, EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation,
			EObject tOwner, EObject mValue, EObject ownerToWoner, EObject tAnnotationValue) {
		_this.registerObjects_BWD(ruleresult, mOwner, mAnnotation, annotationToTAnnotation,
				annotationMemberValuePairToTAnnotationValue, tAnnotation, tOwner, mValue, ownerToWoner,
				tAnnotationValue);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_12_2_corematch_blackFFFBBFBB(
			...
			if (mAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMOwner instanceof BodyDeclaration) {
						BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
						_result.add(new Object[] { mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner,
								ownerToWoner, tAnnotationValue, match });
					}
					...
					if (tOwner.getTAnnotation().contains(tAnnotation)) {
						if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
							if (mOwner.equals(ownerToWoner.getSource())) {
								if (tOwner.equals(ownerToWoner.getTarget())) {
									_result.add(new Object[] { mOwner, mAnnotation, annotationToTAnnotation,
											tAnnotation, tOwner, ownerToWoner, tAnnotationValue });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, BodyDeclaration mOwner, Annotation mAnnotation,
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotation tAnnotation, TAnnotatable tOwner,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotationValue tAnnotationValue) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mOwner, mAnnotation,
				annotationToTAnnotation, tAnnotation, tOwner, ownerToWoner, tAnnotationValue);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mOwner, mAnnotation, annotationToTAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch, BodyDeclaration mOwner,
			Annotation mAnnotation, AnnotationToTAnnotation annotationToTAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, ASTNodeToTAnnotatable ownerToWoner, TAnnotationValue tAnnotationValue) {
		Object[] result_pattern_AnnotationMemberKey_12_4_solveCSP_binding = pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mOwner, mAnnotation, annotationToTAnnotation, tAnnotation, tOwner,
				ownerToWoner, tAnnotationValue);
				...
				if (tmpTAnnotation instanceof TAnnotation) {
					...
					if (tmpTOwner instanceof TAnnotatable) {
						...
						if (tmpMValue instanceof AnnotationMemberValuePair) {
							...
							if (tmpTAnnotationValue instanceof TAnnotationValue) {
								TAnnotationValue tAnnotationValue = (TAnnotationValue) tmpTAnnotationValue;
								return new Object[] { mOwner, mAnnotation, tAnnotation, tOwner, mValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mOwner, mAnnotation, tAnnotation, tOwner, mValue, tAnnotationValue, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mOwner, mAnnotation, tAnnotation, tOwner, mValue, tAnnotationValue, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			BodyDeclaration mOwner, Annotation mAnnotation, TAnnotation tAnnotation, TAnnotatable tOwner,
			AnnotationMemberValuePair mValue, TAnnotationValue tAnnotationValue, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mOwner, mAnnotation, tAnnotation, tOwner, mValue,
				tAnnotationValue, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mOwner, mAnnotation, tAnnotation, tOwner, mValue, tAnnotationValue,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, BodyDeclaration mOwner, Annotation mAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, AnnotationMemberValuePair mValue, TAnnotationValue tAnnotationValue, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mOwner, mAnnotation, tAnnotation, tOwner, mValue, tAnnotationValue, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackBBFBBFBB(
			BodyDeclaration mOwner, Annotation mAnnotation, TAnnotation tAnnotation, TAnnotatable tOwner,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
					for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mOwner, ASTNodeToTAnnotatable.class, "source")) {
						if (tOwner.equals(ownerToWoner.getTarget())) {
							_result.add(new Object[] { mOwner, mAnnotation, annotationToTAnnotation, tAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mOwner, mAnnotation, tAnnotation, tOwner, mValue, tAnnotationValue, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mOwner, mAnnotation,
				annotationToTAnnotation, tAnnotation, tOwner, ownerToWoner, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mOwner, mAnnotation, annotationToTAnnotation,
					tAnnotation, tOwner, ownerToWoner, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_6_perform_greenBFBFFBB(Annotation mAnnotation,
		...
		return new Object[] { mAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation, mValue,
