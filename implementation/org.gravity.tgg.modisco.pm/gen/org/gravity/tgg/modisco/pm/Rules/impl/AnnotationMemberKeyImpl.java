...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						annotationToTAnnotation, tOwner, mValue, mOwner, tAnnotationValue,
						annotationMemberValuePairToTAnnotationValue, mAnnotation, ownerToWoner, tAnnotation);
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, mValue,
				tAnnotationValue, annotationMemberValuePairToTAnnotationValue, mAnnotation, tAnnotation);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackFFBBBFFB(mValue, mOwner, mAnnotation, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(annotationToTAnnotation, tOwner, mValue,
							mOwner, mAnnotation, ownerToWoner, tAnnotation)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(annotationToTAnnotation,
								tOwner, mValue, mOwner, mAnnotation, ownerToWoner, tAnnotation);
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								annotationToTAnnotation, tOwner, mValue, mOwner, mAnnotation, ownerToWoner,
								tAnnotation);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			BodyDeclaration mOwner, Annotation mAnnotation, ASTNodeToTAnnotatable ownerToWoner,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject annotationToTAnnotation, EObject tOwner,
			EObject mValue, EObject mOwner, EObject tAnnotationValue,
			EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation, EObject ownerToWoner,
			EObject tAnnotation) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackFBFBFFBB(
			...
			// ForEach 
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(annotationToTAnnotation, tOwner, mOwner,
							tAnnotationValue, mAnnotation, ownerToWoner, tAnnotation)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(annotationToTAnnotation,
								tOwner, mOwner, tAnnotationValue, mAnnotation, ownerToWoner, tAnnotation);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tOwner__tAnnotation____tAnnotation = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tAnnotation__tOwner____tAnnotated = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge annotationToTAnnotation__mAnnotation____source = (EMoflonEdge) result3_green[10];
				//nothing EMoflonEdge ownerToWoner__tOwner____target = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge mOwner__mAnnotation____annotations = (EMoflonEdge) result3_green[12];
				//nothing EMoflonEdge tAnnotation__tAnnotationValue____tValues = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge annotationToTAnnotation__tAnnotation____target = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge ownerToWoner__mOwner____source = (EMoflonEdge) result3_green[15];

				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								annotationToTAnnotation, tOwner, mOwner, tAnnotationValue, mAnnotation, ownerToWoner,
								tAnnotation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[annotationToTAnnotation] = "
							+ annotationToTAnnotation + ", " + "[tOwner] = " + tOwner + ", " + "[mOwner] = " + mOwner
							+ ", " + "[tAnnotationValue] = " + tAnnotationValue + ", " + "[mAnnotation] = "
							+ mAnnotation + ", " + "[ownerToWoner] = " + ownerToWoner + ", " + "[tAnnotation] = "
							+ tAnnotation + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_4(EMoflonEdge _edge_tValues) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_4(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tOwner, mValue, mOwner,
						tAnnotationValue, mAnnotation, tAnnotation, sourceMatch, targetMatch);
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackFBBBFBBB(tOwner, mOwner, mAnnotation,
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(tOwner, mValue, mOwner,
								tAnnotationValue, mAnnotation, tAnnotation, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tOwner] = " + tOwner
							+ ", " + "[mValue] = " + mValue + ", " + "[mOwner] = " + mOwner + ", "
							+ "[tAnnotationValue] = " + tAnnotationValue + ", " + "[mAnnotation] = " + mAnnotation
	...
	public CSP isApplicable_solveCsp_CC(TAnnotatable tOwner, AnnotationMemberValuePair mValue, BodyDeclaration mOwner,
			TAnnotationValue tAnnotationValue, Annotation mAnnotation, TAnnotation tAnnotation, Match sourceMatch,
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
			...
			Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							annotationToTAnnotation, tOwner, mOwner, mAnnotation, ownerToWoner, tAnnotation,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[annotationToTAnnotation] = "
				...
				if (result5_black != null) {
					...
					Object[] result6_black = AnnotationMemberKeyImpl
							.pattern_AnnotationMemberKey_29_6_perform_blackBBBBBBB(annotationToTAnnotation, tOwner,
									mOwner, mAnnotation, ownerToWoner, tAnnotation, ruleResult);
					if (result6_black == null) {
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner,
			Annotation mAnnotation, ASTNodeToTAnnotatable ownerToWoner, TAnnotation tAnnotation,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_TANNOTATABLE_ANNOTATIONMEMBERVALUEPAIR_BODYDECLARATION_ANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					...
					(Annotation) arguments.get(5), (ASTNodeToTAnnotatable) arguments.get(6),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_TANNOTATABLE_BODYDECLARATION_TANNOTATIONVALUE_ANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(AnnotationToTAnnotation) arguments.get(1), (TAnnotatable) arguments.get(2),
					(BodyDeclaration) arguments.get(3), (TAnnotationValue) arguments.get(4),
					(Annotation) arguments.get(5), (ASTNodeToTAnnotatable) arguments.get(6),
					(TAnnotation) arguments.get(7));
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_4__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_4((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_4__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__TANNOTATABLE_ANNOTATIONMEMBERVALUEPAIR_BODYDECLARATION_TANNOTATIONVALUE_ANNOTATION_TANNOTATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TAnnotatable) arguments.get(0),
					...
					(TAnnotationValue) arguments.get(3), (Annotation) arguments.get(4), (TAnnotation) arguments.get(5),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_TANNOTATABLE_BODYDECLARATION_ANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATION_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(AnnotationToTAnnotation) arguments.get(1), (TAnnotatable) arguments.get(2),
					(BodyDeclaration) arguments.get(3), (Annotation) arguments.get(4),
					(ASTNodeToTAnnotatable) arguments.get(5), (TAnnotation) arguments.get(6),
						...
						if (tmpMAnnotation instanceof Annotation) {
							...
							if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
								...
								if (tmpTAnnotation instanceof TAnnotation) {
									...
									return new Object[] { annotationToTAnnotation, tOwner, mValue, mOwner, mAnnotation,
											ownerToWoner, tAnnotation, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotatable tOwner, AnnotationMemberValuePair mValue,
			BodyDeclaration mOwner, Annotation mAnnotation, ASTNodeToTAnnotatable ownerToWoner, TAnnotation tAnnotation,
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotationToTAnnotation, tOwner, mValue, mOwner, mAnnotation, ownerToWoner,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					annotationToTAnnotation, tOwner, mValue, mOwner, mAnnotation, ownerToWoner, tAnnotation, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject annotationToTAnnotation, EObject tOwner, EObject mValue,
			EObject mOwner, EObject tAnnotationValue, EObject annotationMemberValuePairToTAnnotationValue,
			EObject mAnnotation, EObject ownerToWoner, EObject tAnnotation) {
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject mValue, EObject tAnnotationValue,
	...
	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation, EObject ownerToWoner,
			EObject tAnnotation) {
		_this.registerObjects_FWD(ruleresult, annotationToTAnnotation, tOwner, mValue, mOwner, tAnnotationValue,
				annotationMemberValuePairToTAnnotationValue, mAnnotation, ownerToWoner, tAnnotation);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_2_2_corematch_blackFFBBBFFB(
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tOwner != null) {
						_result.add(new Object[] { annotationToTAnnotation, tOwner, mValue, mOwner, mAnnotation,
								ownerToWoner, tAnnotation, match });
					}
						...
						if (mAnnotation.getValues().contains(mValue)) {
							if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
								if (mOwner.equals(ownerToWoner.getSource())) {
									_result.add(new Object[] { annotationToTAnnotation, tOwner, mValue, mOwner,
											mAnnotation, ownerToWoner, tAnnotation });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		return new Object[] { annotationToTAnnotation, tOwner, mValue, mOwner, mAnnotation, ownerToWoner, tAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			...
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner, Annotation mAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotation tAnnotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, annotationToTAnnotation, tOwner,
				mValue, mOwner, mAnnotation, ownerToWoner, tAnnotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, tOwner, mValue, mOwner,
					mAnnotation, ownerToWoner, tAnnotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotationToTAnnotation, tOwner, mValue, mOwner, mAnnotation, ownerToWoner,
				tAnnotation);
					...
					if (tmpTAnnotationValue instanceof TAnnotationValue) {
						...
						if (tmpMAnnotation instanceof Annotation) {
							...
							if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
								...
								if (tmpTAnnotation instanceof TAnnotation) {
									TAnnotation tAnnotation = (TAnnotation) tmpTAnnotation;
									return new Object[] { annotationToTAnnotation, tOwner, mOwner, tAnnotationValue,
											mAnnotation, ownerToWoner, tAnnotation, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotationToTAnnotation, tOwner, mOwner, tAnnotationValue, mAnnotation,
						ownerToWoner, tAnnotation, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					annotationToTAnnotation, tOwner, mOwner, tAnnotationValue, mAnnotation, ownerToWoner, tAnnotation,
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation, EObject ownerToWoner,
			EObject tAnnotation) {
		_this.registerObjects_BWD(ruleresult, annotationToTAnnotation, tOwner, mValue, mOwner, tAnnotationValue,
				annotationMemberValuePairToTAnnotationValue, mAnnotation, ownerToWoner, tAnnotation);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_12_2_corematch_blackFBFBFFBB(TAnnotatable tOwner,
		...
		for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMOwner instanceof BodyDeclaration) {
				...
				for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (mAnnotation != null) {
						_result.add(new Object[] { annotationToTAnnotation, tOwner, mOwner, tAnnotationValue,
								mAnnotation, ownerToWoner, tAnnotation, match });
					}
				...
				if (tOwner.equals(ownerToWoner.getTarget())) {
					if (mOwner.getAnnotations().contains(mAnnotation)) {
						if (tAnnotation.getTValues().contains(tAnnotationValue)) {
							if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
								if (mOwner.equals(ownerToWoner.getSource())) {
									_result.add(new Object[] { annotationToTAnnotation, tOwner, mOwner,
											tAnnotationValue, mAnnotation, ownerToWoner, tAnnotation });
								}
							}
						}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		annotationToTAnnotation__tAnnotation____target
				.setName(annotationToTAnnotation__tAnnotation____target_name_prime);
		ownerToWoner__mOwner____source.setName(ownerToWoner__mOwner____source_name_prime);
		return new Object[] { annotationToTAnnotation, tOwner, mOwner, tAnnotationValue, mAnnotation, ownerToWoner,
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, AnnotationToTAnnotation annotationToTAnnotation, TAnnotatable tOwner,
			BodyDeclaration mOwner, TAnnotationValue tAnnotationValue, Annotation mAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotation tAnnotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, annotationToTAnnotation, tOwner,
				mOwner, tAnnotationValue, mAnnotation, ownerToWoner, tAnnotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, tOwner, mOwner,
					tAnnotationValue, mAnnotation, ownerToWoner, tAnnotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_12_4_solveCSP_binding = pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotationToTAnnotation, tOwner, mOwner, tAnnotationValue, mAnnotation,
				ownerToWoner, tAnnotation);
				...
				if (tmpMOwner instanceof BodyDeclaration) {
					...
					if (tmpTAnnotationValue instanceof TAnnotationValue) {
						...
						if (tmpMAnnotation instanceof Annotation) {
							...
							if (tmpTAnnotation instanceof TAnnotation) {
								TAnnotation tAnnotation = (TAnnotation) tmpTAnnotation;
								return new Object[] { tOwner, mValue, mOwner, tAnnotationValue, mAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(TAnnotatable tOwner,
			...
			Annotation mAnnotation, TAnnotation tAnnotation, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tOwner, mValue, mOwner, tAnnotationValue, mAnnotation, tAnnotation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tOwner, mValue, mOwner, tAnnotationValue, mAnnotation, tAnnotation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			TAnnotatable tOwner, AnnotationMemberValuePair mValue, BodyDeclaration mOwner,
			TAnnotationValue tAnnotationValue, Annotation mAnnotation, TAnnotation tAnnotation, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tOwner, mValue, mOwner, tAnnotationValue, mAnnotation,
				tAnnotation, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tOwner, mValue, mOwner, tAnnotationValue, mAnnotation, tAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tOwner, mValue, mOwner, tAnnotationValue, mAnnotation, tAnnotation, sourceMatch, targetMatch);
			...
			for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
					for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tOwner, ASTNodeToTAnnotatable.class, "target")) {
						if (mOwner.equals(ownerToWoner.getSource())) {
							_result.add(new Object[] { annotationToTAnnotation, tOwner, mOwner, mAnnotation,
									ownerToWoner, tAnnotation, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(TAnnotatable tOwner,
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner, TAnnotationValue tAnnotationValue,
			Annotation mAnnotation, TAnnotation tAnnotation, CCMatch ccMatch) {
		return new Object[] { tOwner, mValue, mOwner, tAnnotationValue, mAnnotation, tAnnotation, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, tOwner, mOwner, mAnnotation,
					ownerToWoner, tAnnotation, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_29_3_solveCSP_binding = pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotationToTAnnotation, tOwner, mOwner, mAnnotation, ownerToWoner,
		...
		if (result_pattern_AnnotationMemberKey_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationMemberKey_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, tOwner, mOwner,
						mAnnotation, ownerToWoner, tAnnotation, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_5_checknacs_blackBBBBBB(
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner,
			Annotation mAnnotation, ASTNodeToTAnnotatable ownerToWoner, TAnnotation tAnnotation) {
		return new Object[] { annotationToTAnnotation, tOwner, mOwner, mAnnotation, ownerToWoner, tAnnotation };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_6_perform_greenFFFBBBB(Annotation mAnnotation,
		...
		return new Object[] { mValue, tAnnotationValue, annotationMemberValuePairToTAnnotationValue, mAnnotation,
				tAnnotation, ruleResult, csp };
	}
