...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mValue,
						tAnnotationValue, annotationToTAnnotation, mAnnotation,
						annotationMemberValuePairToTAnnotationValue, tAnnotation, tOwner, mOwner, ownerToWoner);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mValue] = " + mValue + ", " + "[tAnnotationValue] = " + tAnnotationValue + ", "
					+ "[annotationToTAnnotation] = " + annotationToTAnnotation + ", " + "[mAnnotation] = " + mAnnotation
					+ ", " + "[annotationMemberValuePairToTAnnotationValue] = "
					+ annotationMemberValuePairToTAnnotationValue + ", " + "[tAnnotation] = " + tAnnotation + ", "
					+ "[tOwner] = " + tOwner + ", " + "[mOwner] = " + mOwner + ", " + "[ownerToWoner] = " + ownerToWoner
					+ ".");
		}
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, mValue,
				tAnnotationValue, mAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation);
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mValue, tAnnotationValue, annotationToTAnnotation, mAnnotation,
				annotationMemberValuePairToTAnnotationValue, tAnnotation, tOwner, mOwner, ownerToWoner);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackBFBFFBFB(mValue, mAnnotation, mOwner, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(mValue, annotationToTAnnotation,
							mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(mValue,
								annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner);
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner,
								ownerToWoner);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AnnotationMemberValuePair mValue,
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, BodyDeclaration mOwner, ASTNodeToTAnnotatable ownerToWoner) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mValue, EObject tAnnotationValue,
			EObject annotationToTAnnotation, EObject mAnnotation, EObject annotationMemberValuePairToTAnnotationValue,
			EObject tAnnotation, EObject tOwner, EObject mOwner, EObject ownerToWoner) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_11_1_performtransformation_greenFBBFB(tAnnotationValue, mAnnotation, csp);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackBFFBBFFB(
			...
			// ForEach 
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(tAnnotationValue,
							annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAnnotationValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner,
								ownerToWoner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[tOwner] = " + tOwner + ", " + "[mOwner] = " + mOwner + ", " + "[ownerToWoner] = "
							+ ownerToWoner + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mValue, EObject tAnnotationValue,
			EObject annotationToTAnnotation, EObject mAnnotation, EObject annotationMemberValuePairToTAnnotationValue,
			EObject tAnnotation, EObject tOwner, EObject mOwner, EObject ownerToWoner) {
		ruleresult.registerObject("mValue", mValue);
		ruleresult.registerObject("tAnnotationValue", tAnnotationValue);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_160(EMoflonEdge _edge_tValues) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_170(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mValue, tAnnotationValue,
						mAnnotation, tAnnotation, tOwner, mOwner, sourceMatch, targetMatch);
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackFBBBBFBB(mAnnotation, tAnnotation, tOwner,
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(mValue, tAnnotationValue,
								mAnnotation, tAnnotation, tOwner, mOwner, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mValue] = " + mValue
							+ ", " + "[tAnnotationValue] = " + tAnnotationValue + ", " + "[mAnnotation] = "
							+ mAnnotation + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[tOwner] = " + tOwner
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AnnotationMemberValuePair mValue, TAnnotationValue tAnnotationValue,
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ annotationToTAnnotation + ", " + "[mAnnotation] = " + mAnnotation + ", " + "[tAnnotation] = "
			...
			if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = AnnotationMemberKeyImpl
							.pattern_AnnotationMemberKey_29_6_perform_blackBBBBBBB(annotationToTAnnotation, mAnnotation,
									tAnnotation, tOwner, mOwner, ownerToWoner, ruleResult);
					if (result6_black == null) {
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, BodyDeclaration mOwner, ASTNodeToTAnnotatable ownerToWoner,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONMEMBERVALUEPAIR_ANNOTATIONTOTANNOTATION_ANNOTATION_TANNOTATION_TANNOTATABLE_BODYDECLARATION_ASTNODETOTANNOTATABLE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AnnotationMemberValuePair) arguments.get(1), (AnnotationToTAnnotation) arguments.get(2),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TANNOTATIONVALUE_ANNOTATIONTOTANNOTATION_ANNOTATION_TANNOTATION_TANNOTATABLE_BODYDECLARATION_ASTNODETOTANNOTATABLE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TAnnotationValue) arguments.get(1),
					...
					(TAnnotation) arguments.get(4), (TAnnotatable) arguments.get(5), (BodyDeclaration) arguments.get(6),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_160__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_160((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_170__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__ANNOTATIONMEMBERVALUEPAIR_TANNOTATIONVALUE_ANNOTATION_TANNOTATION_TANNOTATABLE_BODYDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((AnnotationMemberValuePair) arguments.get(0),
					(TAnnotationValue) arguments.get(1), (Annotation) arguments.get(2), (TAnnotation) arguments.get(3),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_ANNOTATION_TANNOTATION_TANNOTATABLE_BODYDECLARATION_ASTNODETOTANNOTATABLE_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(AnnotationToTAnnotation) arguments.get(1), (Annotation) arguments.get(2),
					(TAnnotation) arguments.get(3), (TAnnotatable) arguments.get(4), (BodyDeclaration) arguments.get(5),
						...
						if (tmpTOwner instanceof TAnnotatable) {
							...
							if (tmpMOwner instanceof BodyDeclaration) {
								...
								if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
									...
									return new Object[] { mValue, annotationToTAnnotation, mAnnotation, tAnnotation,
											tOwner, mOwner, ownerToWoner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
			...
			TAnnotation tAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner, ASTNodeToTAnnotatable ownerToWoner,
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					mValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_greenBFFBB(
		...
		return new Object[] { mValue, tAnnotationValue, annotationMemberValuePairToTAnnotationValue, tAnnotation, csp };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mValue, EObject tAnnotationValue, EObject annotationToTAnnotation,
			EObject mAnnotation, EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation,
			EObject tOwner, EObject mOwner, EObject ownerToWoner) {
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject mValue, EObject tAnnotationValue, EObject mAnnotation,
			EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation) {
		EMoflonEdge mAnnotation__mValue____values = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mValue, tAnnotationValue, mAnnotation,
				annotationMemberValuePairToTAnnotationValue, tAnnotation, mAnnotation__mValue____values,
				annotationMemberValuePairToTAnnotationValue__tAnnotationValue____target,
				annotationMemberValuePairToTAnnotationValue__mValue____source,
	...
	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			AnnotationMemberKey _this, PerformRuleResult ruleresult, EObject mValue, EObject tAnnotationValue,
			EObject annotationToTAnnotation, EObject mAnnotation, EObject annotationMemberValuePairToTAnnotationValue,
			EObject tAnnotation, EObject tOwner, EObject mOwner, EObject ownerToWoner) {
		_this.registerObjects_FWD(ruleresult, mValue, tAnnotationValue, annotationToTAnnotation, mAnnotation,
				annotationMemberValuePairToTAnnotationValue, tAnnotation, tOwner, mOwner, ownerToWoner);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_2_2_corematch_blackBFBFFBFB(
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tOwner != null) {
						_result.add(new Object[] { mValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner,
						...
						if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
							if (mOwner.equals(ownerToWoner.getSource())) {
								if (mOwner.getAnnotations().contains(mAnnotation)) {
									_result.add(new Object[] { mValue, annotationToTAnnotation, mAnnotation,
											tAnnotation, tOwner, mOwner, ownerToWoner });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		mOwner__mAnnotation____annotations.setName(mOwner__mAnnotation____annotations_name_prime);
		return new Object[] { mValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner,
				isApplicableMatch, annotationToTAnnotation__mAnnotation____source, mAnnotation__mValue____values,
				tOwner__tAnnotation____tAnnotation, tAnnotation__tOwner____tAnnotated, ownerToWoner__tOwner____target,
				annotationToTAnnotation__tAnnotation____target, ownerToWoner__mOwner____source,
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, AnnotationMemberValuePair mValue,
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, BodyDeclaration mOwner, ASTNodeToTAnnotatable ownerToWoner) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mValue, annotationToTAnnotation,
				mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mValue, annotationToTAnnotation, mAnnotation,
					tAnnotation, tOwner, mOwner, ownerToWoner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner,
				ownerToWoner);
					...
					if (tmpTAnnotation instanceof TAnnotation) {
						...
						if (tmpTOwner instanceof TAnnotatable) {
							...
							if (tmpMOwner instanceof BodyDeclaration) {
								...
								if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
									ASTNodeToTAnnotatable ownerToWoner = (ASTNodeToTAnnotatable) tmpOwnerToWoner;
									return new Object[] { tAnnotationValue, annotationToTAnnotation, mAnnotation,
											tAnnotation, tOwner, mOwner, ownerToWoner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
			TAnnotationValue tAnnotationValue, AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation,
			TAnnotation tAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner, ASTNodeToTAnnotatable ownerToWoner,
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAnnotationValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					tAnnotationValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_greenFBBFB(
		...
		return new Object[] { mValue, tAnnotationValue, mAnnotation, annotationMemberValuePairToTAnnotationValue, csp };
	}
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationToTAnnotation, EObject mAnnotation, EObject annotationMemberValuePairToTAnnotationValue,
			EObject tAnnotation, EObject tOwner, EObject mOwner, EObject ownerToWoner) {
		_this.registerObjects_BWD(ruleresult, mValue, tAnnotationValue, annotationToTAnnotation, mAnnotation,
				annotationMemberValuePairToTAnnotationValue, tAnnotation, tOwner, mOwner, ownerToWoner);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_12_2_corematch_blackBFFBBFFB(
		...
		for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMOwner instanceof BodyDeclaration) {
				...
				for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (mAnnotation != null) {
						_result.add(new Object[] { tAnnotationValue, annotationToTAnnotation, mAnnotation, tAnnotation,
								tOwner, mOwner, ownerToWoner, match });
					}
				...
				if (tOwner.getTAnnotation().contains(tAnnotation)) {
					if (tOwner.equals(ownerToWoner.getTarget())) {
						if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
							if (mOwner.equals(ownerToWoner.getSource())) {
								if (mOwner.getAnnotations().contains(mAnnotation)) {
									_result.add(new Object[] { tAnnotationValue, annotationToTAnnotation, mAnnotation,
											tAnnotation, tOwner, mOwner, ownerToWoner });
								}
							}
						}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		ownerToWoner__mOwner____source.setName(ownerToWoner__mOwner____source_name_prime);
		mOwner__mAnnotation____annotations.setName(mOwner__mAnnotation____annotations_name_prime);
		return new Object[] { tAnnotationValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner,
				ownerToWoner, isApplicableMatch, annotationToTAnnotation__mAnnotation____source,
				tAnnotation__tAnnotationValue____tValues, tOwner__tAnnotation____tAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, TAnnotationValue tAnnotationValue,
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, BodyDeclaration mOwner, ASTNodeToTAnnotatable ownerToWoner) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tAnnotationValue,
				annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAnnotationValue, annotationToTAnnotation, mAnnotation,
					tAnnotation, tOwner, mOwner, ownerToWoner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_12_4_solveCSP_binding = pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAnnotationValue, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner,
				mOwner, ownerToWoner);
		if (result_pattern_AnnotationMemberKey_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationMemberKey_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tAnnotationValue, annotationToTAnnotation,
						mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner };
			}
		}
		return null;
				...
				if (tmpMAnnotation instanceof Annotation) {
					...
					if (tmpTAnnotation instanceof TAnnotation) {
						...
						if (tmpTOwner instanceof TAnnotatable) {
							...
							if (tmpMOwner instanceof BodyDeclaration) {
								BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
								return new Object[] { mValue, tAnnotationValue, mAnnotation, tAnnotation, tOwner,
										mOwner, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
			AnnotationMemberValuePair mValue, TAnnotationValue tAnnotationValue, Annotation mAnnotation,
			TAnnotation tAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mValue, tAnnotationValue, mAnnotation, tAnnotation, tOwner, mOwner, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mValue, tAnnotationValue, mAnnotation, tAnnotation, tOwner, mOwner, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			...
			TAnnotation tAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mValue, tAnnotationValue, mAnnotation, tAnnotation,
				tOwner, mOwner, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mValue, tAnnotationValue, mAnnotation, tAnnotation, tOwner, mOwner,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, AnnotationMemberValuePair mValue, TAnnotationValue tAnnotationValue,
			Annotation mAnnotation, TAnnotation tAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mValue, tAnnotationValue, mAnnotation, tAnnotation, tOwner, mOwner, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackFBBBBFBB(
			Annotation mAnnotation, TAnnotation tAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
					for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tOwner, ASTNodeToTAnnotatable.class, "target")) {
						if (mOwner.equals(ownerToWoner.getSource())) {
							_result.add(new Object[] { annotationToTAnnotation, mAnnotation, tAnnotation, tOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mValue, tAnnotationValue, mAnnotation, tAnnotation, tOwner, mOwner, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, annotationToTAnnotation, mAnnotation,
				tAnnotation, tOwner, mOwner, ownerToWoner, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, mAnnotation, tAnnotation,
					tOwner, mOwner, ownerToWoner, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_29_3_solveCSP_binding = pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_29_5_checknacs_blackBBBBBB(
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, TAnnotation tAnnotation,
			TAnnotatable tOwner, BodyDeclaration mOwner, ASTNodeToTAnnotatable ownerToWoner) {
		return new Object[] { annotationToTAnnotation, mAnnotation, tAnnotation, tOwner, mOwner, ownerToWoner };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_6_perform_greenFFBFBBB(Annotation mAnnotation,
		...
		return new Object[] { mValue, tAnnotationValue, mAnnotation, annotationMemberValuePairToTAnnotationValue,
				tAnnotation, ruleResult, csp };
	}
