...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						annotationMemberValuePairToTAnnotationValue, annotationToTAnnotation, tAnnotation, ownerToWoner,
						tOwner, mAnnotation, tAnnotationValue, mValue, mOwner);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tAnnotationValue] = " + tAnnotationValue + ", " + "[mValue] = " + mValue + ", " + "[mOwner] = "
					+ mOwner + ".");
		}
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				annotationMemberValuePairToTAnnotationValue, annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner,
				mAnnotation, tAnnotationValue, mValue, mOwner);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackFFFFBBBB(mAnnotation, mValue, mOwner, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(annotationToTAnnotation, tAnnotation,
							ownerToWoner, tOwner, mAnnotation, mValue, mOwner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(annotationToTAnnotation,
								tAnnotation, ownerToWoner, tOwner, mAnnotation, mValue, mOwner);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mAnnotation__mValue____values = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge ownerToWoner__tOwner____target = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation, mValue,
								mOwner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[mAnnotation] = " + mAnnotation + ", " + "[mValue] = " + mValue + ", " + "[mOwner] = "
							+ mOwner + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject annotationMemberValuePairToTAnnotationValue,
			EObject annotationToTAnnotation, EObject tAnnotation, EObject ownerToWoner, EObject tOwner,
			EObject mAnnotation, EObject tAnnotationValue, EObject mValue, EObject mOwner) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackFBFBFBFB(
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(annotationToTAnnotation, tAnnotation,
							ownerToWoner, tOwner, mAnnotation, tAnnotationValue, mOwner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(annotationToTAnnotation,
								tAnnotation, ownerToWoner, tOwner, mAnnotation, tAnnotationValue, mOwner);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation,
								tAnnotationValue, mOwner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[annotationToTAnnotation] = "
							+ annotationToTAnnotation + ", " + "[tAnnotation] = " + tAnnotation + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotation tAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, Annotation mAnnotation,
			TAnnotationValue tAnnotationValue, BodyDeclaration mOwner) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_572(EMoflonEdge _edge_tValues) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_619(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAnnotation, tOwner,
						mAnnotation, tAnnotationValue, mValue, mOwner, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tAnnotation] = " + tAnnotation + ", " + "[tOwner] = " + tOwner + ", " + "[mAnnotation] = "
					+ mAnnotation + ", " + "[tAnnotationValue] = " + tAnnotationValue + ", " + "[mValue] = " + mValue
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackFBFBBBBB(tAnnotation, tOwner, mAnnotation,
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(tAnnotation, tOwner,
								mAnnotation, tAnnotationValue, mValue, mOwner, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAnnotation tAnnotation, TAnnotatable tOwner, Annotation mAnnotation,
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
			...
			Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation, mOwner,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[annotationToTAnnotation] = "
						+ annotationToTAnnotation + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[ownerToWoner] = "
						+ ownerToWoner + ", " + "[tOwner] = " + tOwner + ", " + "[mAnnotation] = " + mAnnotation + ", "
						+ "[mOwner] = " + mOwner + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					Object[] result6_black = AnnotationMemberKeyImpl
							.pattern_AnnotationMemberKey_29_6_perform_blackBBBBBBB(annotationToTAnnotation, tAnnotation,
									ownerToWoner, tOwner, mAnnotation, mOwner, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								+ "[annotationToTAnnotation] = " + annotationToTAnnotation + ", " + "[tAnnotation] = "
								+ tAnnotation + ", " + "[ownerToWoner] = " + ownerToWoner + ", " + "[tOwner] = "
								+ tOwner + ", " + "[mAnnotation] = " + mAnnotation + ", " + "[mOwner] = " + mOwner
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotation tAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, Annotation mAnnotation, BodyDeclaration mOwner,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_TANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATABLE_ANNOTATION_ANNOTATIONMEMBERVALUEPAIR_BODYDECLARATION:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_TANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATABLE_ANNOTATION_TANNOTATIONVALUE_BODYDECLARATION:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_572__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_572((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_619__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_619((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__TANNOTATION_TANNOTATABLE_ANNOTATION_TANNOTATIONVALUE_ANNOTATIONMEMBERVALUEPAIR_BODYDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_TANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATABLE_ANNOTATION_BODYDECLARATION_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(AnnotationToTAnnotation) arguments.get(1), (TAnnotation) arguments.get(2),
					(ASTNodeToTAnnotatable) arguments.get(3), (TAnnotatable) arguments.get(4),
					(Annotation) arguments.get(5), (BodyDeclaration) arguments.get(6),
						...
						if (tmpMAnnotation instanceof Annotation) {
							...
							if (tmpMValue instanceof AnnotationMemberValuePair) {
								...
								if (tmpMOwner instanceof BodyDeclaration) {
									...
									return new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner,
											mAnnotation, mValue, mOwner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation, mValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation, mValue, mOwner, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject annotationMemberValuePairToTAnnotationValue,
			EObject annotationToTAnnotation, EObject tAnnotation, EObject ownerToWoner, EObject tOwner,
			EObject mAnnotation, EObject tAnnotationValue, EObject mValue, EObject mOwner) {
	...
	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject ownerToWoner, EObject tOwner, EObject mAnnotation, EObject tAnnotationValue, EObject mValue,
			EObject mOwner) {
		_this.registerObjects_FWD(ruleresult, annotationMemberValuePairToTAnnotationValue, annotationToTAnnotation,
				tAnnotation, ownerToWoner, tOwner, mAnnotation, tAnnotationValue, mValue, mOwner);
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tOwner != null) {
						_result.add(new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner,
								mAnnotation, mValue, mOwner, match });
					}
							...
							if (mOwner.equals(ownerToWoner.getSource())) {
								if (mOwner.getAnnotations().contains(mAnnotation)) {
									_result.add(new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner,
											tOwner, mAnnotation, mValue, mOwner });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		mOwner__mAnnotation____annotations.setName(mOwner__mAnnotation____annotations_name_prime);
		return new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation, mValue, mOwner,
				isApplicableMatch, mAnnotation__mValue____values, ownerToWoner__tOwner____target,
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			...
			TAnnotation tAnnotation, ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, Annotation mAnnotation,
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner) {
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation,
				mValue, mOwner);
						...
						if (tmpMAnnotation instanceof Annotation) {
							...
							if (tmpTAnnotationValue instanceof TAnnotationValue) {
								...
								if (tmpMOwner instanceof BodyDeclaration) {
									BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
									return new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner,
											mAnnotation, tAnnotationValue, mOwner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotation tAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, Annotation mAnnotation,
			TAnnotationValue tAnnotationValue, BodyDeclaration mOwner, AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation,
						tAnnotationValue, mOwner, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			TAnnotatable tOwner = (TAnnotatable) result_pattern_AnnotationMemberKey_11_1_performtransformation_binding[3];
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation, tAnnotationValue, mOwner,
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject ownerToWoner, EObject tOwner, EObject mAnnotation, EObject tAnnotationValue, EObject mValue,
			EObject mOwner) {
		_this.registerObjects_BWD(ruleresult, annotationMemberValuePairToTAnnotationValue, annotationToTAnnotation,
				tAnnotation, ownerToWoner, tOwner, mAnnotation, tAnnotationValue, mValue, mOwner);
		...
		for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMOwner instanceof BodyDeclaration) {
				...
				for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (mAnnotation != null) {
						_result.add(new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner,
								mAnnotation, tAnnotationValue, mOwner, match });
					}
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotation tAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, Annotation mAnnotation,
			TAnnotationValue tAnnotationValue, BodyDeclaration mOwner) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
					...
					if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
						if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
							if (mOwner.equals(ownerToWoner.getSource())) {
								if (mOwner.getAnnotations().contains(mAnnotation)) {
									_result.add(new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner,
											tOwner, mAnnotation, tAnnotationValue, mOwner });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		ownerToWoner__mOwner____source.setName(ownerToWoner__mOwner____source_name_prime);
		mOwner__mAnnotation____annotations.setName(mOwner__mAnnotation____annotations_name_prime);
		return new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation, tAnnotationValue,
				mOwner, isApplicableMatch, tAnnotation__tAnnotationValue____tValues, ownerToWoner__tOwner____target,
				tOwner__tAnnotation____tAnnotation, tAnnotation__tOwner____tAnnotated,
				annotationToTAnnotation__tAnnotation____target, annotationToTAnnotation__mAnnotation____source,
				ownerToWoner__mOwner____source, mOwner__mAnnotation____annotations };
	}
				...
				if (tmpMAnnotation instanceof Annotation) {
					...
					if (tmpTAnnotationValue instanceof TAnnotationValue) {
						...
						if (tmpMValue instanceof AnnotationMemberValuePair) {
							...
							if (tmpMOwner instanceof BodyDeclaration) {
								BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
								return new Object[] { tAnnotation, tOwner, mAnnotation, tAnnotationValue, mValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TAnnotation tAnnotation, TAnnotatable tOwner, Annotation mAnnotation, TAnnotationValue tAnnotationValue,
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tAnnotation, tOwner, mAnnotation, tAnnotationValue, mValue, mOwner, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAnnotation, tOwner, mAnnotation, tAnnotationValue, mValue, mOwner, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			TAnnotation tAnnotation, TAnnotatable tOwner, Annotation mAnnotation, TAnnotationValue tAnnotationValue,
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tAnnotation, tOwner, mAnnotation, tAnnotationValue,
				mValue, mOwner, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tAnnotation, tOwner, mAnnotation, tAnnotationValue, mValue, mOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, TAnnotation tAnnotation, TAnnotatable tOwner, Annotation mAnnotation,
			TAnnotationValue tAnnotationValue, AnnotationMemberValuePair mValue, BodyDeclaration mOwner,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAnnotation, tOwner, mAnnotation, tAnnotationValue, mValue, mOwner, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tAnnotation, tOwner, mAnnotation, tAnnotationValue, mValue, mOwner, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, tAnnotation, ownerToWoner,
					tOwner, mAnnotation, mOwner, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_5_checknacs_blackBBBBBB(
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotation tAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, Annotation mAnnotation, BodyDeclaration mOwner) {
		return new Object[] { annotationToTAnnotation, tAnnotation, ownerToWoner, tOwner, mAnnotation, mOwner };
	}
