...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tAnnotationValue,
						ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation,
						annotationMemberValuePairToTAnnotationValue, mAnnotation, mValue, tOwner);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ ", " + "[mAnnotation] = " + mAnnotation + ", " + "[mValue] = " + mValue + ", " + "[tOwner] = "
					+ tOwner + ".");
		}
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult,
				tAnnotationValue, tAnnotation, annotationMemberValuePairToTAnnotationValue, mAnnotation, mValue);
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				tAnnotationValue, ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation,
				annotationMemberValuePairToTAnnotationValue, mAnnotation, mValue, tOwner);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackFBFFBBFB(mOwner, mAnnotation, mValue, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(ownerToWoner, mOwner, tAnnotation,
							annotationToTAnnotation, mAnnotation, mValue, tOwner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(ownerToWoner, mOwner,
								tAnnotation, annotationToTAnnotation, mAnnotation, mValue, tOwner);
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation, mAnnotation, mValue,
								tOwner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mAnnotation + ", " + "[mValue] = " + mValue + ", " + "[tOwner] = " + tOwner + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNodeToTAnnotatable ownerToWoner,
			...
			Annotation mAnnotation, AnnotationMemberValuePair mValue, TAnnotatable tOwner) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tAnnotationValue, EObject ownerToWoner,
			...
			EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation, EObject mValue, EObject tOwner) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_11_1_performtransformation_greenBFBFB(tAnnotationValue, mAnnotation, csp);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackBFFBFFBB(
			...
			// ForEach 
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(tAnnotationValue, ownerToWoner, mOwner,
							tAnnotation, annotationToTAnnotation, mAnnotation, tOwner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(tAnnotationValue,
								ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation, mAnnotation, tOwner);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge ownerToWoner__mOwner____source = (EMoflonEdge) result3_green[8];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ tAnnotationValue + ", " + "[ownerToWoner] = " + ownerToWoner + ", " + "[mOwner] = "
							+ mOwner + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[annotationToTAnnotation] = "
							+ annotationToTAnnotation + ", " + "[mAnnotation] = " + mAnnotation + ", " + "[tOwner] = "
							+ tOwner + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TAnnotationValue tAnnotationValue,
			ASTNodeToTAnnotatable ownerToWoner, BodyDeclaration mOwner, TAnnotation tAnnotation,
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, TAnnotatable tOwner) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_17(EMoflonEdge _edge_tValues) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_18(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAnnotationValue, mOwner,
						tAnnotation, mAnnotation, mValue, tOwner, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tAnnotationValue] = " + tAnnotationValue + ", " + "[mOwner] = " + mOwner + ", "
					+ "[tAnnotation] = " + tAnnotation + ", " + "[mAnnotation] = " + mAnnotation + ", " + "[mValue] = "
					+ mValue + ", " + "[tOwner] = " + tOwner + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackFBBFBBBB(mOwner, tAnnotation, mAnnotation,
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(tAnnotationValue, mOwner,
								tAnnotation, mAnnotation, mValue, tOwner, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAnnotationValue] = "
							+ tAnnotationValue + ", " + "[mOwner] = " + mOwner + ", " + "[tAnnotation] = " + tAnnotation
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAnnotationValue tAnnotationValue, BodyDeclaration mOwner,
			TAnnotation tAnnotation, Annotation mAnnotation, AnnotationMemberValuePair mValue, TAnnotatable tOwner,
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ ", " + "[mOwner] = " + mOwner + ", " + "[tAnnotation] = " + tAnnotation + ", "
						+ "[annotationToTAnnotation] = " + annotationToTAnnotation + ", " + "[mAnnotation] = "
						+ mAnnotation + ", " + "[tOwner] = " + tOwner + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = AnnotationMemberKeyImpl
							.pattern_AnnotationMemberKey_29_6_perform_blackBBBBBBB(ownerToWoner, mOwner, tAnnotation,
									annotationToTAnnotation, mAnnotation, tOwner, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ownerToWoner] = "
								+ ownerToWoner + ", " + "[mOwner] = " + mOwner + ", " + "[tAnnotation] = " + tAnnotation
								+ ", " + "[annotationToTAnnotation] = " + annotationToTAnnotation + ", "
								+ "[mAnnotation] = " + mAnnotation + ", " + "[tOwner] = " + tOwner + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_29_6_perform_greenFBFBFBB(tAnnotation,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNodeToTAnnotatable ownerToWoner,
			BodyDeclaration mOwner, TAnnotation tAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, TAnnotatable tOwner, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODETOTANNOTATABLE_BODYDECLARATION_TANNOTATION_ANNOTATIONTOTANNOTATION_ANNOTATION_ANNOTATIONMEMBERVALUEPAIR_TANNOTATABLE:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(ASTNodeToTAnnotatable) arguments.get(1), (BodyDeclaration) arguments.get(2),
						(TAnnotation) arguments.get(3), (AnnotationToTAnnotation) arguments.get(4),
						(Annotation) arguments.get(5), (AnnotationMemberValuePair) arguments.get(6),
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TANNOTATIONVALUE_ASTNODETOTANNOTATABLE_BODYDECLARATION_TANNOTATION_ANNOTATIONTOTANNOTATION_ANNOTATION_TANNOTATABLE:
				return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
						(TAnnotationValue) arguments.get(1), (ASTNodeToTAnnotatable) arguments.get(2),
						(BodyDeclaration) arguments.get(3), (TAnnotation) arguments.get(4),
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_17__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_17((EMoflonEdge) arguments.get(0));
			case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_18__EMOFLONEDGE:
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__TANNOTATIONVALUE_BODYDECLARATION_TANNOTATION_ANNOTATION_ANNOTATIONMEMBERVALUEPAIR_TANNOTATABLE_MATCH_MATCH:
				return isApplicable_solveCsp_CC((TAnnotationValue) arguments.get(0), (BodyDeclaration) arguments.get(1),
						(TAnnotation) arguments.get(2), (Annotation) arguments.get(3),
						(AnnotationMemberValuePair) arguments.get(4), (TAnnotatable) arguments.get(5),
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODETOTANNOTATABLE_BODYDECLARATION_TANNOTATION_ANNOTATIONTOTANNOTATION_ANNOTATION_TANNOTATABLE_MODELGENERATORRULERESULT:
				return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
						(ASTNodeToTAnnotatable) arguments.get(1), (BodyDeclaration) arguments.get(2),
						(TAnnotation) arguments.get(3), (AnnotationToTAnnotation) arguments.get(4),
						(Annotation) arguments.get(5), (TAnnotatable) arguments.get(6),
						...
						if (tmpMAnnotation instanceof Annotation) {
							...
							if (tmpMValue instanceof AnnotationMemberValuePair) {
								...
								if (tmpTOwner instanceof TAnnotatable) {
									...
									return new Object[] { ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation,
											mAnnotation, mValue, tOwner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation, mAnnotation, mValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation, mAnnotation, mValue, tOwner, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tAnnotationValue, EObject ownerToWoner, EObject mOwner,
			EObject tAnnotation, EObject annotationToTAnnotation, EObject annotationMemberValuePairToTAnnotationValue,
			EObject mAnnotation, EObject mValue, EObject tOwner) {
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			...
			EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation, EObject mValue) {
		...
		return new Object[] { ruleresult, tAnnotationValue, tAnnotation, annotationMemberValuePairToTAnnotationValue,
				mAnnotation, mValue, tAnnotation__tAnnotationValue____tValues,
	...
	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mOwner, EObject tAnnotation, EObject annotationToTAnnotation,
			EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation, EObject mValue, EObject tOwner) {
		_this.registerObjects_FWD(ruleresult, tAnnotationValue, ownerToWoner, mOwner, tAnnotation,
				annotationToTAnnotation, annotationMemberValuePairToTAnnotationValue, mAnnotation, mValue, tOwner);
		...
		for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tOwner != null) {
				for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAnnotation != null) {
						_result.add(new Object[] { ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation,
								mAnnotation, mValue, tOwner, match });
					}
						...
						if (tOwner.getTAnnotation().contains(tAnnotation)) {
							if (mOwner.getAnnotations().contains(mAnnotation)) {
								if (tOwner.equals(ownerToWoner.getTarget())) {
									_result.add(new Object[] { ownerToWoner, mOwner, tAnnotation,
											annotationToTAnnotation, mAnnotation, mValue, tOwner });
								}
							}
						}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		return new Object[] { ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation, mAnnotation, mValue, tOwner,
				isApplicableMatch, ownerToWoner__mOwner____source, mAnnotation__mValue____values,
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			...
			AnnotationMemberValuePair mValue, TAnnotatable tOwner) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, ownerToWoner, mOwner, tAnnotation,
				annotationToTAnnotation, mAnnotation, mValue, tOwner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ownerToWoner, mOwner, tAnnotation,
					annotationToTAnnotation, mAnnotation, mValue, tOwner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			...
			BodyDeclaration mOwner, TAnnotation tAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, AnnotationMemberValuePair mValue, TAnnotatable tOwner) {
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation, mAnnotation,
				mValue, tOwner);
					...
					if (tmpTAnnotation instanceof TAnnotation) {
						...
						if (tmpAnnotationToTAnnotation instanceof AnnotationToTAnnotation) {
							...
							if (tmpMAnnotation instanceof Annotation) {
								...
								if (tmpTOwner instanceof TAnnotatable) {
									TAnnotatable tOwner = (TAnnotatable) tmpTOwner;
									return new Object[] { tAnnotationValue, ownerToWoner, mOwner, tAnnotation,
											annotationToTAnnotation, mAnnotation, tOwner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
			TAnnotationValue tAnnotationValue, ASTNodeToTAnnotatable ownerToWoner, BodyDeclaration mOwner,
			TAnnotation tAnnotation, AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation,
			TAnnotatable tOwner, AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAnnotationValue, ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation,
						mAnnotation, tOwner, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					tAnnotationValue, ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation, mAnnotation, tOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_greenBFBFB(
		...
		return new Object[] { tAnnotationValue, annotationMemberValuePairToTAnnotationValue, mAnnotation, mValue, csp };
	}
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mOwner, EObject tAnnotation, EObject annotationToTAnnotation,
			EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation, EObject mValue, EObject tOwner) {
		_this.registerObjects_BWD(ruleresult, tAnnotationValue, ownerToWoner, mOwner, tAnnotation,
				annotationToTAnnotation, annotationMemberValuePairToTAnnotationValue, mAnnotation, mValue, tOwner);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_12_2_corematch_blackBFFBFFBB(
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (mAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMOwner instanceof BodyDeclaration) {
						BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
						_result.add(new Object[] { tAnnotationValue, ownerToWoner, mOwner, tAnnotation,
								annotationToTAnnotation, mAnnotation, tOwner, match });
					}
					...
					if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
						if (tOwner.getTAnnotation().contains(tAnnotation)) {
							if (mOwner.getAnnotations().contains(mAnnotation)) {
								if (tOwner.equals(ownerToWoner.getTarget())) {
									_result.add(new Object[] { tAnnotationValue, ownerToWoner, mOwner, tAnnotation,
											annotationToTAnnotation, mAnnotation, tOwner });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		mOwner__mAnnotation____annotations.setName(mOwner__mAnnotation____annotations_name_prime);
		ownerToWoner__tOwner____target.setName(ownerToWoner__tOwner____target_name_prime);
		return new Object[] { tAnnotationValue, ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation, mAnnotation,
				tOwner, isApplicableMatch, ownerToWoner__mOwner____source, tAnnotation__tAnnotationValue____tValues,
				annotationToTAnnotation__tAnnotation____target, annotationToTAnnotation__mAnnotation____source,
				tOwner__tAnnotation____tAnnotation, tAnnotation__tOwner____tAnnotated,
				mOwner__mAnnotation____annotations, ownerToWoner__tOwner____target };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			...
			BodyDeclaration mOwner, TAnnotation tAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, TAnnotatable tOwner) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tAnnotationValue, ownerToWoner,
				mOwner, tAnnotation, annotationToTAnnotation, mAnnotation, tOwner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAnnotationValue, ownerToWoner, mOwner, tAnnotation,
					annotationToTAnnotation, mAnnotation, tOwner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			...
			ASTNodeToTAnnotatable ownerToWoner, BodyDeclaration mOwner, TAnnotation tAnnotation,
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, TAnnotatable tOwner) {
		Object[] result_pattern_AnnotationMemberKey_12_4_solveCSP_binding = pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAnnotationValue, ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation,
				mAnnotation, tOwner);
		if (result_pattern_AnnotationMemberKey_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationMemberKey_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tAnnotationValue, ownerToWoner, mOwner,
						tAnnotation, annotationToTAnnotation, mAnnotation, tOwner };
			}
		}
		return null;
				...
				if (tmpTAnnotation instanceof TAnnotation) {
					...
					if (tmpMAnnotation instanceof Annotation) {
						...
						if (tmpMValue instanceof AnnotationMemberValuePair) {
							...
							if (tmpTOwner instanceof TAnnotatable) {
								TAnnotatable tOwner = (TAnnotatable) tmpTOwner;
								return new Object[] { tAnnotationValue, mOwner, tAnnotation, mAnnotation, mValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TAnnotationValue tAnnotationValue, BodyDeclaration mOwner, TAnnotation tAnnotation, Annotation mAnnotation,
			AnnotationMemberValuePair mValue, TAnnotatable tOwner, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tAnnotationValue, mOwner, tAnnotation, mAnnotation, mValue, tOwner, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAnnotationValue, mOwner, tAnnotation, mAnnotation, mValue, tOwner, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			TAnnotationValue tAnnotationValue, BodyDeclaration mOwner, TAnnotation tAnnotation, Annotation mAnnotation,
			AnnotationMemberValuePair mValue, TAnnotatable tOwner, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tAnnotationValue, mOwner, tAnnotation, mAnnotation,
				mValue, tOwner, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tAnnotationValue, mOwner, tAnnotation, mAnnotation, mValue, tOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, TAnnotationValue tAnnotationValue, BodyDeclaration mOwner,
			TAnnotation tAnnotation, Annotation mAnnotation, AnnotationMemberValuePair mValue, TAnnotatable tOwner,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAnnotationValue, mOwner, tAnnotation, mAnnotation, mValue, tOwner, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackFBBFBBBB(
			BodyDeclaration mOwner, TAnnotation tAnnotation, Annotation mAnnotation, TAnnotatable tOwner,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tOwner.equals(ownerToWoner.getTarget())) {
					for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
							_result.add(new Object[] { ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation,
									mAnnotation, tOwner, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(
			TAnnotationValue tAnnotationValue, BodyDeclaration mOwner, TAnnotation tAnnotation, Annotation mAnnotation,
			AnnotationMemberValuePair mValue, TAnnotatable tOwner, CCMatch ccMatch) {
		return new Object[] { tAnnotationValue, mOwner, tAnnotation, mAnnotation, mValue, tOwner, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, ownerToWoner, mOwner, tAnnotation,
				annotationToTAnnotation, mAnnotation, tOwner, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ownerToWoner, mOwner, tAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch, ASTNodeToTAnnotatable ownerToWoner,
			BodyDeclaration mOwner, TAnnotation tAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, TAnnotatable tOwner, ModelgeneratorRuleResult ruleResult) {
	...
	public static final Object[] pattern_AnnotationMemberKey_29_5_checknacs_blackBBBBBB(
			ASTNodeToTAnnotatable ownerToWoner, BodyDeclaration mOwner, TAnnotation tAnnotation,
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, TAnnotatable tOwner) {
		return new Object[] { ownerToWoner, mOwner, tAnnotation, annotationToTAnnotation, mAnnotation, tOwner };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_6_perform_greenFBFBFBB(TAnnotation tAnnotation,
		...
		return new Object[] { tAnnotationValue, tAnnotation, annotationMemberValuePairToTAnnotationValue, mAnnotation,
