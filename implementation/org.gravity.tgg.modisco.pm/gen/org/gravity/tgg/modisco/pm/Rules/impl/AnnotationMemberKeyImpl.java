...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mAnnotation,
						annotationMemberValuePairToTAnnotationValue, ownerToWoner, tAnnotation, tAnnotationValue,
						annotationToTAnnotation, tOwner, mValue, mOwner);
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult,
				mAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation, tAnnotationValue, mValue);
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mAnnotation, annotationMemberValuePairToTAnnotationValue, ownerToWoner, tAnnotation, tAnnotationValue,
				annotationToTAnnotation, tOwner, mValue, mOwner);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackBFFFFBBB(mAnnotation, mValue, mOwner, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(mAnnotation, ownerToWoner, tAnnotation,
							annotationToTAnnotation, tOwner, mValue, mOwner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(mAnnotation, ownerToWoner,
								tAnnotation, annotationToTAnnotation, tOwner, mValue, mOwner);
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mAnnotation, ownerToWoner, tAnnotation, annotationToTAnnotation, tOwner, mValue,
								mOwner);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mAnnotation,
			EObject annotationMemberValuePairToTAnnotationValue, EObject ownerToWoner, EObject tAnnotation,
			EObject tAnnotationValue, EObject annotationToTAnnotation, EObject tOwner, EObject mValue, EObject mOwner) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackFFBBFBFB(
			...
			// ForEach 
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(mAnnotation, ownerToWoner, tAnnotation,
							tAnnotationValue, annotationToTAnnotation, tOwner, mOwner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(mAnnotation, ownerToWoner,
								tAnnotation, tAnnotationValue, annotationToTAnnotation, tOwner, mOwner);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mAnnotation, ownerToWoner, tAnnotation, tAnnotationValue, annotationToTAnnotation,
								tOwner, mOwner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mAnnotation] = " + mAnnotation
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Annotation mAnnotation,
			...
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mAnnotation,
			EObject annotationMemberValuePairToTAnnotationValue, EObject ownerToWoner, EObject tAnnotation,
			EObject tAnnotationValue, EObject annotationToTAnnotation, EObject tOwner, EObject mValue, EObject mOwner) {
		ruleresult.registerObject("mAnnotation", mAnnotation);
		ruleresult.registerObject("annotationMemberValuePairToTAnnotationValue",
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_78(EMoflonEdge _edge_tValues) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_81(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackBFBFBBBB(mAnnotation, tAnnotation, tOwner,
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(mAnnotation, tAnnotation,
								tAnnotationValue, tOwner, mValue, mOwner, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mAnnotation] = "
							+ mAnnotation + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[tAnnotationValue] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Annotation mAnnotation, TAnnotation tAnnotation,
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
			...
			Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mAnnotation, ownerToWoner, tAnnotation, annotationToTAnnotation, tOwner, mOwner,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mAnnotation] = " + mAnnotation + ", "
			...
			if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = AnnotationMemberKeyImpl
							.pattern_AnnotationMemberKey_29_6_perform_blackBBBBBBB(mAnnotation, ownerToWoner,
									tAnnotation, annotationToTAnnotation, tOwner, mOwner, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mAnnotation] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATION_ANNOTATIONTOTANNOTATION_TANNOTATABLE_ANNOTATIONMEMBERVALUEPAIR_BODYDECLARATION:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATION_TANNOTATIONVALUE_ANNOTATIONTOTANNOTATION_TANNOTATABLE_BODYDECLARATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Annotation) arguments.get(1),
					...
					(TAnnotatable) arguments.get(6), (BodyDeclaration) arguments.get(7));
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_78__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_78((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_81__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__ANNOTATION_TANNOTATION_TANNOTATIONVALUE_TANNOTATABLE_ANNOTATIONMEMBERVALUEPAIR_BODYDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATION_ANNOTATIONTOTANNOTATION_TANNOTATABLE_BODYDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpTOwner instanceof TAnnotatable) {
							...
							if (tmpMValue instanceof AnnotationMemberValuePair) {
								...
								if (tmpMOwner instanceof BodyDeclaration) {
									...
									return new Object[] { mAnnotation, ownerToWoner, tAnnotation,
											annotationToTAnnotation, tOwner, mValue, mOwner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mAnnotation, ownerToWoner, tAnnotation, annotationToTAnnotation, tOwner, mValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					mAnnotation, ownerToWoner, tAnnotation, annotationToTAnnotation, tOwner, mValue, mOwner, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject ownerToWoner, EObject tAnnotation, EObject tAnnotationValue, EObject annotationToTAnnotation,
			EObject tOwner, EObject mValue, EObject mOwner) {
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(
		...
		mAnnotation__mValue____values.setName(mAnnotation__mValue____values_name_prime);
		return new Object[] { ruleresult, mAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation,
	...
	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			AnnotationMemberKey _this, PerformRuleResult ruleresult, EObject mAnnotation,
			EObject annotationMemberValuePairToTAnnotationValue, EObject ownerToWoner, EObject tAnnotation,
			EObject tAnnotationValue, EObject annotationToTAnnotation, EObject tOwner, EObject mValue, EObject mOwner) {
		_this.registerObjects_FWD(ruleresult, mAnnotation, annotationMemberValuePairToTAnnotationValue, ownerToWoner,
				tAnnotation, tAnnotationValue, annotationToTAnnotation, tOwner, mValue, mOwner);
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tOwner != null) {
						_result.add(new Object[] { mAnnotation, ownerToWoner, tAnnotation, annotationToTAnnotation,
								tOwner, mValue, mOwner, match });
					}
						...
						if (tOwner.getTAnnotation().contains(tAnnotation)) {
							if (mOwner.equals(ownerToWoner.getSource())) {
								if (mOwner.getAnnotations().contains(mAnnotation)) {
									_result.add(new Object[] { mAnnotation, ownerToWoner, tAnnotation,
											annotationToTAnnotation, tOwner, mValue, mOwner });
								}
							}
						}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		mOwner__mAnnotation____annotations.setName(mOwner__mAnnotation____annotations_name_prime);
		return new Object[] { mAnnotation, ownerToWoner, tAnnotation, annotationToTAnnotation, tOwner, mValue, mOwner,
				isApplicableMatch, annotationToTAnnotation__mAnnotation____source, ownerToWoner__tOwner____target,
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, Annotation mAnnotation, ASTNodeToTAnnotatable ownerToWoner,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mAnnotation, ownerToWoner,
				tAnnotation, annotationToTAnnotation, tOwner, mValue, mOwner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mAnnotation, ownerToWoner, tAnnotation,
					annotationToTAnnotation, tOwner, mValue, mOwner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mAnnotation, ownerToWoner, tAnnotation, annotationToTAnnotation, tOwner,
				mValue, mOwner);
					...
					if (tmpTAnnotationValue instanceof TAnnotationValue) {
						...
						if (tmpAnnotationToTAnnotation instanceof AnnotationToTAnnotation) {
							...
							if (tmpTOwner instanceof TAnnotatable) {
								...
								if (tmpMOwner instanceof BodyDeclaration) {
									BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
									return new Object[] { mAnnotation, ownerToWoner, tAnnotation, tAnnotationValue,
											annotationToTAnnotation, tOwner, mOwner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mAnnotation, ownerToWoner, tAnnotation, tAnnotationValue, annotationToTAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					mAnnotation, ownerToWoner, tAnnotation, tAnnotationValue, annotationToTAnnotation, tOwner, mOwner,
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationMemberValuePairToTAnnotationValue, EObject ownerToWoner, EObject tAnnotation,
			EObject tAnnotationValue, EObject annotationToTAnnotation, EObject tOwner, EObject mValue, EObject mOwner) {
		_this.registerObjects_BWD(ruleresult, mAnnotation, annotationMemberValuePairToTAnnotationValue, ownerToWoner,
				tAnnotation, tAnnotationValue, annotationToTAnnotation, tOwner, mValue, mOwner);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_12_2_corematch_blackFFBBFBFB(
		...
		for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMOwner instanceof BodyDeclaration) {
				...
				for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (mAnnotation != null) {
						_result.add(new Object[] { mAnnotation, ownerToWoner, tAnnotation, tAnnotationValue,
								annotationToTAnnotation, tOwner, mOwner, match });
					}
					...
					if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
						if (tOwner.getTAnnotation().contains(tAnnotation)) {
							if (mOwner.equals(ownerToWoner.getSource())) {
								if (mOwner.getAnnotations().contains(mAnnotation)) {
									_result.add(new Object[] { mAnnotation, ownerToWoner, tAnnotation, tAnnotationValue,
											annotationToTAnnotation, tOwner, mOwner });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		ownerToWoner__mOwner____source.setName(ownerToWoner__mOwner____source_name_prime);
		mOwner__mAnnotation____annotations.setName(mOwner__mAnnotation____annotations_name_prime);
		return new Object[] { mAnnotation, ownerToWoner, tAnnotation, tAnnotationValue, annotationToTAnnotation, tOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mAnnotation, ownerToWoner,
				tAnnotation, tAnnotationValue, annotationToTAnnotation, tOwner, mOwner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mAnnotation, ownerToWoner, tAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_12_4_solveCSP_binding = pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mAnnotation, ownerToWoner, tAnnotation, tAnnotationValue,
				annotationToTAnnotation, tOwner, mOwner);
				...
				if (tmpTAnnotationValue instanceof TAnnotationValue) {
					...
					if (tmpTOwner instanceof TAnnotatable) {
						...
						if (tmpMValue instanceof AnnotationMemberValuePair) {
							...
							if (tmpMOwner instanceof BodyDeclaration) {
								BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
								return new Object[] { mAnnotation, tAnnotation, tAnnotationValue, tOwner, mValue,
										mOwner, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
			Annotation mAnnotation, TAnnotation tAnnotation, TAnnotationValue tAnnotationValue, TAnnotatable tOwner,
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mAnnotation, tAnnotation, tAnnotationValue, tOwner, mValue, mOwner, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mAnnotation, tAnnotation, tAnnotationValue, tOwner, mValue, mOwner, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			Annotation mAnnotation, TAnnotation tAnnotation, TAnnotationValue tAnnotationValue, TAnnotatable tOwner,
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mAnnotation, tAnnotation, tAnnotationValue, tOwner,
				mValue, mOwner, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mAnnotation, tAnnotation, tAnnotationValue, tOwner, mValue, mOwner,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, Annotation mAnnotation, TAnnotation tAnnotation,
			TAnnotationValue tAnnotationValue, TAnnotatable tOwner, AnnotationMemberValuePair mValue,
		...
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mAnnotation, tAnnotation, tAnnotationValue, tOwner, mValue, mOwner, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mAnnotation, tAnnotation, tAnnotationValue, tOwner, mValue, mOwner, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mAnnotation, ownerToWoner,
				tAnnotation, annotationToTAnnotation, tOwner, mOwner, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mAnnotation, ownerToWoner, tAnnotation,
					annotationToTAnnotation, tOwner, mOwner, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_5_checknacs_blackBBBBBB(Annotation mAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotation tAnnotation,
			AnnotationToTAnnotation annotationToTAnnotation, TAnnotatable tOwner, BodyDeclaration mOwner) {
		return new Object[] { mAnnotation, ownerToWoner, tAnnotation, annotationToTAnnotation, tOwner, mOwner };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_6_perform_greenBFBFFBB(Annotation mAnnotation,
		...
		return new Object[] { mAnnotation, annotationMemberValuePairToTAnnotationValue, tAnnotation, tAnnotationValue,
