...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tAnnotationValue,
						annotationMemberValuePairToTAnnotationValue, tAnnotation, mValue, tOwner, mAnnotation,
						annotationToTAnnotation, ownerToWoner, mOwner);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ ", " + "[tAnnotation] = " + tAnnotation + ", " + "[mValue] = " + mValue + ", " + "[tOwner] = "
					+ tOwner + ", " + "[mAnnotation] = " + mAnnotation + ", " + "[annotationToTAnnotation] = "
					+ annotationToTAnnotation + ", " + "[ownerToWoner] = " + ownerToWoner + ", " + "[mOwner] = "
					+ mOwner + ".");
		}
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				tAnnotationValue, annotationMemberValuePairToTAnnotationValue, tAnnotation, mValue, tOwner, mAnnotation,
				annotationToTAnnotation, ownerToWoner, mOwner);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackFBFBFFBB(mValue, mAnnotation, mOwner, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(tAnnotation, mValue, tOwner, mAnnotation,
							annotationToTAnnotation, ownerToWoner, mOwner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(tAnnotation, mValue, tOwner,
								mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner);
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAnnotation, mValue, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner,
								mOwner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tAnnotation] = " + tAnnotation
							+ ", " + "[mValue] = " + mValue + ", " + "[tOwner] = " + tOwner + ", " + "[mAnnotation] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TAnnotation tAnnotation,
			AnnotationMemberValuePair mValue, TAnnotatable tOwner, Annotation mAnnotation,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tAnnotationValue,
			EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation, EObject mValue, EObject tOwner,
			EObject mAnnotation, EObject annotationToTAnnotation, EObject ownerToWoner, EObject mOwner) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackBBBFFFFB(
			...
			// ForEach 
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(tAnnotationValue, tAnnotation, tOwner,
							mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(tAnnotationValue,
								tAnnotation, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAnnotationValue, tAnnotation, tOwner, mAnnotation, annotationToTAnnotation,
								ownerToWoner, mOwner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TAnnotationValue tAnnotationValue,
			TAnnotation tAnnotation, TAnnotatable tOwner, Annotation mAnnotation,
			AnnotationToTAnnotation annotationToTAnnotation, ASTNodeToTAnnotatable ownerToWoner,
			BodyDeclaration mOwner) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_11(EMoflonEdge _edge_tValues) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_11(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAnnotationValue,
						tAnnotation, mValue, tOwner, mAnnotation, mOwner, sourceMatch, targetMatch);
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackBBBFFBBB(tAnnotation, tOwner, mAnnotation,
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(tAnnotationValue,
								tAnnotation, mValue, tOwner, mAnnotation, mOwner, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAnnotationValue] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TANNOTATION_ANNOTATIONMEMBERVALUEPAIR_TANNOTATABLE_ANNOTATION_ANNOTATIONTOTANNOTATION_ASTNODETOTANNOTATABLE_BODYDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TAnnotation) arguments.get(1),
					...
					(Annotation) arguments.get(4), (AnnotationToTAnnotation) arguments.get(5),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TANNOTATIONVALUE_TANNOTATION_TANNOTATABLE_ANNOTATION_ANNOTATIONTOTANNOTATION_ASTNODETOTANNOTATABLE_BODYDECLARATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TAnnotationValue) arguments.get(1),
					(TAnnotation) arguments.get(2), (TAnnotatable) arguments.get(3), (Annotation) arguments.get(4),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_11__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_11((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_11__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__TANNOTATIONVALUE_TANNOTATION_ANNOTATIONMEMBERVALUEPAIR_TANNOTATABLE_ANNOTATION_BODYDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TAnnotationValue) arguments.get(0), (TAnnotation) arguments.get(1),
					(AnnotationMemberValuePair) arguments.get(2), (TAnnotatable) arguments.get(3),
					(Annotation) arguments.get(4), (BodyDeclaration) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TANNOTATION_TANNOTATABLE_ANNOTATION_ANNOTATIONTOTANNOTATION_ASTNODETOTANNOTATABLE_BODYDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpAnnotationToTAnnotation instanceof AnnotationToTAnnotation) {
							...
							if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
								...
								if (tmpMOwner instanceof BodyDeclaration) {
									...
									return new Object[] { tAnnotation, mValue, tOwner, mAnnotation,
											annotationToTAnnotation, ownerToWoner, mOwner, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
			TAnnotation tAnnotation, AnnotationMemberValuePair mValue, TAnnotatable tOwner, Annotation mAnnotation,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAnnotation, mValue, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					tAnnotation, mValue, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject tAnnotation, EObject mValue, EObject tOwner, EObject mAnnotation, EObject annotationToTAnnotation,
	...
	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation, EObject mValue, EObject tOwner,
			EObject mAnnotation, EObject annotationToTAnnotation, EObject ownerToWoner, EObject mOwner) {
		_this.registerObjects_FWD(ruleresult, tAnnotationValue, annotationMemberValuePairToTAnnotationValue,
				tAnnotation, mValue, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_2_2_corematch_blackFBFBFFBB(
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tOwner != null) {
						_result.add(new Object[] { tAnnotation, mValue, tOwner, mAnnotation, annotationToTAnnotation,
						...
						if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
							if (mOwner.getAnnotations().contains(mAnnotation)) {
								if (mOwner.equals(ownerToWoner.getSource())) {
									_result.add(new Object[] { tAnnotation, mValue, tOwner, mAnnotation,
											annotationToTAnnotation, ownerToWoner, mOwner });
								}
							}
						}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		return new Object[] { tAnnotation, mValue, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tAnnotation, mValue, tOwner,
				mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAnnotation, mValue, tOwner, mAnnotation,
					annotationToTAnnotation, ownerToWoner, mOwner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAnnotation, mValue, tOwner, mAnnotation, annotationToTAnnotation,
				ownerToWoner, mOwner);
					...
					if (tmpMAnnotation instanceof Annotation) {
						...
						if (tmpAnnotationToTAnnotation instanceof AnnotationToTAnnotation) {
							...
							if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
								...
								if (tmpMOwner instanceof BodyDeclaration) {
									BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
									return new Object[] { tAnnotationValue, tAnnotation, tOwner, mAnnotation,
											annotationToTAnnotation, ownerToWoner, mOwner, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, TAnnotatable tOwner, Annotation mAnnotation,
			AnnotationToTAnnotation annotationToTAnnotation, ASTNodeToTAnnotatable ownerToWoner, BodyDeclaration mOwner,
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAnnotationValue, tAnnotation, tOwner, mAnnotation, annotationToTAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					tAnnotationValue, tAnnotation, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner,
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationMemberValuePairToTAnnotationValue, EObject tAnnotation, EObject mValue, EObject tOwner,
			EObject mAnnotation, EObject annotationToTAnnotation, EObject ownerToWoner, EObject mOwner) {
		_this.registerObjects_BWD(ruleresult, tAnnotationValue, annotationMemberValuePairToTAnnotationValue,
				tAnnotation, mValue, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner);
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (mAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMOwner instanceof BodyDeclaration) {
						BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
						_result.add(new Object[] { tAnnotationValue, tAnnotation, tOwner, mAnnotation,
								annotationToTAnnotation, ownerToWoner, mOwner, match });
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		mOwner__mAnnotation____annotations.setName(mOwner__mAnnotation____annotations_name_prime);
		ownerToWoner__mOwner____source.setName(ownerToWoner__mOwner____source_name_prime);
		return new Object[] { tAnnotationValue, tAnnotation, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner,
				mOwner, isApplicableMatch, tAnnotation__tAnnotationValue____tValues, tOwner__tAnnotation____tAnnotation,
				tAnnotation__tOwner____tAnnotated, annotationToTAnnotation__tAnnotation____target,
				ownerToWoner__tOwner____target, annotationToTAnnotation__mAnnotation____source,
				mOwner__mAnnotation____annotations, ownerToWoner__mOwner____source };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, TAnnotationValue tAnnotationValue, TAnnotation tAnnotation,
			TAnnotatable tOwner, Annotation mAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, BodyDeclaration mOwner) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tAnnotationValue, tAnnotation, tOwner,
				mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAnnotationValue, tAnnotation, tOwner, mAnnotation,
					annotationToTAnnotation, ownerToWoner, mOwner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_12_4_solveCSP_binding = pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAnnotationValue, tAnnotation, tOwner, mAnnotation, annotationToTAnnotation,
				ownerToWoner, mOwner);
				...
				if (tmpMValue instanceof AnnotationMemberValuePair) {
					...
					if (tmpTOwner instanceof TAnnotatable) {
						...
						if (tmpMAnnotation instanceof Annotation) {
							...
							if (tmpMOwner instanceof BodyDeclaration) {
								BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
								return new Object[] { tAnnotationValue, tAnnotation, mValue, tOwner, mAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, AnnotationMemberValuePair mValue,
			TAnnotatable tOwner, Annotation mAnnotation, BodyDeclaration mOwner, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tAnnotationValue, tAnnotation, mValue, tOwner, mAnnotation, mOwner, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAnnotationValue, tAnnotation, mValue, tOwner, mAnnotation, mOwner, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, AnnotationMemberValuePair mValue,
			TAnnotatable tOwner, Annotation mAnnotation, BodyDeclaration mOwner, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tAnnotationValue, tAnnotation, mValue, tOwner,
				mAnnotation, mOwner, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tAnnotationValue, tAnnotation, mValue, tOwner, mAnnotation, mOwner,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAnnotationValue, tAnnotation, mValue, tOwner, mAnnotation, mOwner, sourceMatch, targetMatch);
			...
			for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
					for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tOwner, ASTNodeToTAnnotatable.class, "target")) {
						if (mOwner.equals(ownerToWoner.getSource())) {
							_result.add(new Object[] { tAnnotation, tOwner, mAnnotation, annotationToTAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, AnnotationMemberValuePair mValue,
			TAnnotatable tOwner, Annotation mAnnotation, BodyDeclaration mOwner, CCMatch ccMatch) {
		return new Object[] { tAnnotationValue, tAnnotation, mValue, tOwner, mAnnotation, mOwner, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAnnotation, tOwner, mAnnotation,
					annotationToTAnnotation, ownerToWoner, mOwner, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_29_3_solveCSP_binding = pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAnnotation, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner,
				mOwner, ruleResult);
	...
	public static final Object[] pattern_AnnotationMemberKey_29_5_checknacs_blackBBBBBB(TAnnotation tAnnotation,
			TAnnotatable tOwner, Annotation mAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, BodyDeclaration mOwner) {
		return new Object[] { tAnnotation, tOwner, mAnnotation, annotationToTAnnotation, ownerToWoner, mOwner };
	}
