...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_1_performtransformation_greenBFFBB(mValue, tAnnotation, csp);
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner,
						annotationMemberValuePairToTAnnotationValue, mAnnotation, tAnnotationValue, tAnnotation);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[annotationToTAnnotation] = " + annotationToTAnnotation + ", " + "[ownerToWoner] = "
					+ ownerToWoner + ", " + "[tOwner] = " + tOwner + ", " + "[mValue] = " + mValue + ", "
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackFFFBBBFB(mValue, mOwner, mAnnotation, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(annotationToTAnnotation, ownerToWoner,
							tOwner, mValue, mOwner, mAnnotation, tAnnotation)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(annotationToTAnnotation,
								ownerToWoner, tOwner, mValue, mOwner, mAnnotation, tAnnotation);
				...
				//nothing EMoflonEdge mAnnotation__mValue____values = (EMoflonEdge) result3_green[14];
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner, mAnnotation,
								tAnnotation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[annotationToTAnnotation] = "
							+ annotationToTAnnotation + ", " + "[ownerToWoner] = " + ownerToWoner + ", " + "[tOwner] = "
							+ tOwner + ", " + "[mValue] = " + mValue + ", " + "[mOwner] = " + mOwner + ", "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			AnnotationToTAnnotation annotationToTAnnotation, ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner,
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner, Annotation mAnnotation, TAnnotation tAnnotation) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject annotationToTAnnotation, EObject ownerToWoner,
			EObject tOwner, EObject mValue, EObject mOwner, EObject annotationMemberValuePairToTAnnotationValue,
			EObject mAnnotation, EObject tAnnotationValue, EObject tAnnotation) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackFFBFFBBB(
			...
			// ForEach 
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(annotationToTAnnotation, ownerToWoner,
							tOwner, mOwner, mAnnotation, tAnnotationValue, tAnnotation)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(annotationToTAnnotation,
								ownerToWoner, tOwner, mOwner, mAnnotation, tAnnotationValue, tAnnotation);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tOwner__tAnnotation____tAnnotation = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tAnnotation__tOwner____tAnnotated = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge ownerToWoner__mOwner____source = (EMoflonEdge) result3_green[10];
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								annotationToTAnnotation, ownerToWoner, tOwner, mOwner, mAnnotation, tAnnotationValue,
								tAnnotation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[annotationToTAnnotation] = "
							+ annotationToTAnnotation + ", " + "[ownerToWoner] = " + ownerToWoner + ", " + "[tOwner] = "
							+ tOwner + ", " + "[mOwner] = " + mOwner + ", " + "[mAnnotation] = " + mAnnotation + ", "
							+ "[tAnnotationValue] = " + tAnnotationValue + ", " + "[tAnnotation] = " + tAnnotation
							+ ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject annotationToTAnnotation, EObject ownerToWoner,
			EObject tOwner, EObject mValue, EObject mOwner, EObject annotationMemberValuePairToTAnnotationValue,
			EObject mAnnotation, EObject tAnnotationValue, EObject tAnnotation) {
		ruleresult.registerObject("annotationToTAnnotation", annotationToTAnnotation);
		ruleresult.registerObject("ownerToWoner", ownerToWoner);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_94(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tOwner, mValue, mOwner,
						mAnnotation, tAnnotationValue, tAnnotation, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tOwner] = " + tOwner + ", " + "[mValue] = " + mValue + ", " + "[mOwner] = " + mOwner + ", "
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackFFBBBBBB(tOwner, mOwner, mAnnotation,
				...
				ASTNodeToTAnnotatable ownerToWoner = (ASTNodeToTAnnotatable) result5_black[1];
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(tOwner, mValue, mOwner,
								mAnnotation, tAnnotationValue, tAnnotation, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAnnotatable tOwner, AnnotationMemberValuePair mValue, BodyDeclaration mOwner,
			Annotation mAnnotation, TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, Match sourceMatch,
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
			...
			Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							annotationToTAnnotation, ownerToWoner, tOwner, mOwner, mAnnotation, tAnnotation,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[annotationToTAnnotation] = "
			...
			if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = AnnotationMemberKeyImpl
							.pattern_AnnotationMemberKey_29_6_perform_blackBBBBBBB(annotationToTAnnotation,
									ownerToWoner, tOwner, mOwner, mAnnotation, tAnnotation, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								+ "[annotationToTAnnotation] = " + annotationToTAnnotation + ", " + "[ownerToWoner] = "
								+ ownerToWoner + ", " + "[tOwner] = " + tOwner + ", " + "[mOwner] = " + mOwner + ", "
								+ "[mAnnotation] = " + mAnnotation + ", " + "[tAnnotation] = " + tAnnotation + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_29_6_perform_greenFFBFBBB(mAnnotation,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATABLE_ANNOTATIONMEMBERVALUEPAIR_BODYDECLARATION_ANNOTATION_TANNOTATION:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(AnnotationToTAnnotation) arguments.get(1), (ASTNodeToTAnnotatable) arguments.get(2),
						(TAnnotatable) arguments.get(3), (AnnotationMemberValuePair) arguments.get(4),
						(BodyDeclaration) arguments.get(5), (Annotation) arguments.get(6),
						(TAnnotation) arguments.get(7));
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATABLE_BODYDECLARATION_ANNOTATION_TANNOTATIONVALUE_TANNOTATION:
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_94__EMOFLONEDGE:
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__TANNOTATABLE_ANNOTATIONMEMBERVALUEPAIR_BODYDECLARATION_ANNOTATION_TANNOTATIONVALUE_TANNOTATION_MATCH_MATCH:
				return isApplicable_solveCsp_CC((TAnnotatable) arguments.get(0),
						(AnnotationMemberValuePair) arguments.get(1), (BodyDeclaration) arguments.get(2),
						(Annotation) arguments.get(3), (TAnnotationValue) arguments.get(4),
						(TAnnotation) arguments.get(5), (Match) arguments.get(6), (Match) arguments.get(7));
			...
			case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANNOTATIONTOTANNOTATION_ASTNODETOTANNOTATABLE_TANNOTATABLE_BODYDECLARATION_ANNOTATION_TANNOTATION_MODELGENERATORRULERESULT:
				return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
						(AnnotationToTAnnotation) arguments.get(1), (ASTNodeToTAnnotatable) arguments.get(2),
						(TAnnotatable) arguments.get(3), (BodyDeclaration) arguments.get(4),
						(Annotation) arguments.get(5), (TAnnotation) arguments.get(6),
						...
						if (tmpMOwner instanceof BodyDeclaration) {
							...
							if (tmpMAnnotation instanceof Annotation) {
								...
								if (tmpTAnnotation instanceof TAnnotation) {
									...
									return new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner,
											mAnnotation, tAnnotation, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner, mAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner, mAnnotation, tAnnotation, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_greenBFFBB(
		...
		return new Object[] { mValue, annotationMemberValuePairToTAnnotationValue, tAnnotationValue, tAnnotation, csp };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject annotationToTAnnotation, EObject ownerToWoner, EObject tOwner,
			EObject mValue, EObject mOwner, EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation,
			EObject tAnnotationValue, EObject tAnnotation) {
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_greenBBBBBBFFFF(
		...
		return new Object[] { ruleresult, mValue, annotationMemberValuePairToTAnnotationValue, mAnnotation,
				tAnnotationValue, tAnnotation, annotationMemberValuePairToTAnnotationValue__mValue____source,
	...
	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			AnnotationMemberKey _this, PerformRuleResult ruleresult, EObject annotationToTAnnotation,
			EObject ownerToWoner, EObject tOwner, EObject mValue, EObject mOwner,
			EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation, EObject tAnnotationValue,
			EObject tAnnotation) {
		_this.registerObjects_FWD(ruleresult, annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner,
				annotationMemberValuePairToTAnnotationValue, mAnnotation, tAnnotationValue, tAnnotation);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_2_2_corematch_blackFFFBBBFB(
		...
		for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tOwner != null) {
				for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAnnotation != null) {
						_result.add(new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner,
								mAnnotation, tAnnotation, match });
					}
						...
						if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
							if (mAnnotation.getValues().contains(mValue)) {
								if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
									_result.add(new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mValue,
											mOwner, mAnnotation, tAnnotation });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		return new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner, mAnnotation, tAnnotation,
				isApplicableMatch, tOwner__tAnnotation____tAnnotation, tAnnotation__tOwner____tAnnotated,
				ownerToWoner__mOwner____source, mOwner__mAnnotation____annotations, ownerToWoner__tOwner____target,
				annotationToTAnnotation__mAnnotation____source, mAnnotation__mValue____values,
				annotationToTAnnotation__tAnnotation____target };
	}

	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, AnnotationToTAnnotation annotationToTAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, AnnotationMemberValuePair mValue,
			BodyDeclaration mOwner, Annotation mAnnotation, TAnnotation tAnnotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, annotationToTAnnotation, ownerToWoner,
				tOwner, mValue, mOwner, mAnnotation, tAnnotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, ownerToWoner, tOwner, mValue,
					mOwner, mAnnotation, tAnnotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner, mAnnotation,
				tAnnotation);
		if (result_pattern_AnnotationMemberKey_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationMemberKey_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, ownerToWoner, tOwner,
						mValue, mOwner, mAnnotation, tAnnotation };
			}
		}
		return null;
	}
					...
					if (tmpMOwner instanceof BodyDeclaration) {
						...
						if (tmpMAnnotation instanceof Annotation) {
							...
							if (tmpTAnnotationValue instanceof TAnnotationValue) {
								...
								if (tmpTAnnotation instanceof TAnnotation) {
									TAnnotation tAnnotation = (TAnnotation) tmpTAnnotation;
									return new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mOwner,
											mAnnotation, tAnnotationValue, tAnnotation, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
			AnnotationToTAnnotation annotationToTAnnotation, ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner,
			BodyDeclaration mOwner, Annotation mAnnotation, TAnnotationValue tAnnotationValue, TAnnotation tAnnotation,
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mOwner, mAnnotation,
						tAnnotationValue, tAnnotation, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			TAnnotationValue tAnnotationValue = (TAnnotationValue) result_pattern_AnnotationMemberKey_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					annotationToTAnnotation, ownerToWoner, tOwner, mOwner, mAnnotation, tAnnotationValue, tAnnotation,
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject annotationMemberValuePairToTAnnotationValue, EObject mAnnotation, EObject tAnnotationValue,
			EObject tAnnotation) {
		_this.registerObjects_BWD(ruleresult, annotationToTAnnotation, ownerToWoner, tOwner, mValue, mOwner,
				annotationMemberValuePairToTAnnotationValue, mAnnotation, tAnnotationValue, tAnnotation);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_12_2_corematch_blackFFBFFBBB(TAnnotatable tOwner,
		...
		for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMOwner instanceof BodyDeclaration) {
				...
				for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (mAnnotation != null) {
						_result.add(new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mOwner, mAnnotation,
								tAnnotationValue, tAnnotation, match });
					}
					...
					if (tOwner.equals(ownerToWoner.getTarget())) {
						if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
							if (tAnnotation.getTValues().contains(tAnnotationValue)) {
								if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
									_result.add(new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mOwner,
											mAnnotation, tAnnotationValue, tAnnotation });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		annotationToTAnnotation__tAnnotation____target
				.setName(annotationToTAnnotation__tAnnotation____target_name_prime);
		return new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mOwner, mAnnotation, tAnnotationValue,
				tAnnotation, isApplicableMatch, tOwner__tAnnotation____tAnnotation, tAnnotation__tOwner____tAnnotated,
				ownerToWoner__mOwner____source, mOwner__mAnnotation____annotations, ownerToWoner__tOwner____target,
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, AnnotationToTAnnotation annotationToTAnnotation,
			ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner, BodyDeclaration mOwner, Annotation mAnnotation,
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, annotationToTAnnotation, ownerToWoner,
				tOwner, mOwner, mAnnotation, tAnnotationValue, tAnnotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, ownerToWoner, tOwner, mOwner,
					mAnnotation, tAnnotationValue, tAnnotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_12_4_solveCSP_binding = pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, annotationToTAnnotation, ownerToWoner, tOwner, mOwner, mAnnotation,
				tAnnotationValue, tAnnotation);
		if (result_pattern_AnnotationMemberKey_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationMemberKey_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, ownerToWoner, tOwner,
						mOwner, mAnnotation, tAnnotationValue, tAnnotation };
			}
		}
		return null;
	}
				...
				if (tmpMOwner instanceof BodyDeclaration) {
					...
					if (tmpMAnnotation instanceof Annotation) {
						...
						if (tmpTAnnotationValue instanceof TAnnotationValue) {
							...
							if (tmpTAnnotation instanceof TAnnotation) {
								TAnnotation tAnnotation = (TAnnotation) tmpTAnnotation;
								return new Object[] { tOwner, mValue, mOwner, mAnnotation, tAnnotationValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(TAnnotatable tOwner,
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner, Annotation mAnnotation,
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tOwner, mValue, mOwner, mAnnotation, tAnnotationValue, tAnnotation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			TAnnotationValue tAnnotationValue = (TAnnotationValue) result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tOwner, mValue, mOwner, mAnnotation, tAnnotationValue, tAnnotation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			TAnnotatable tOwner, AnnotationMemberValuePair mValue, BodyDeclaration mOwner, Annotation mAnnotation,
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tOwner, mValue, mOwner, mAnnotation, tAnnotationValue,
				tAnnotation, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tOwner, mValue, mOwner, mAnnotation, tAnnotationValue, tAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, TAnnotatable tOwner, AnnotationMemberValuePair mValue, BodyDeclaration mOwner,
			Annotation mAnnotation, TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tOwner, mValue, mOwner, mAnnotation, tAnnotationValue, tAnnotation, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackFFBBBBBB(
			TAnnotatable tOwner, BodyDeclaration mOwner, Annotation mAnnotation, TAnnotation tAnnotation,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tOwner.equals(ownerToWoner.getTarget())) {
					for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tAnnotation.equals(annotationToTAnnotation.getTarget())) {
							_result.add(new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mOwner,
									mAnnotation, tAnnotation, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(TAnnotatable tOwner,
			AnnotationMemberValuePair mValue, BodyDeclaration mOwner, Annotation mAnnotation,
			TAnnotationValue tAnnotationValue, TAnnotation tAnnotation, CCMatch ccMatch) {
		return new Object[] { tOwner, mValue, mOwner, mAnnotation, tAnnotationValue, tAnnotation, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, annotationToTAnnotation,
				ownerToWoner, tOwner, mOwner, mAnnotation, tAnnotation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, ownerToWoner, tOwner, mOwner,
					mAnnotation, tAnnotation, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		if (result_pattern_AnnotationMemberKey_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationMemberKey_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, annotationToTAnnotation, ownerToWoner, tOwner,
						mOwner, mAnnotation, tAnnotation, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_5_checknacs_blackBBBBBB(
			AnnotationToTAnnotation annotationToTAnnotation, ASTNodeToTAnnotatable ownerToWoner, TAnnotatable tOwner,
			BodyDeclaration mOwner, Annotation mAnnotation, TAnnotation tAnnotation) {
		return new Object[] { annotationToTAnnotation, ownerToWoner, tOwner, mOwner, mAnnotation, tAnnotation };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_6_perform_greenFFBFBBB(Annotation mAnnotation,
		...
		return new Object[] { mValue, annotationMemberValuePairToTAnnotationValue, mAnnotation, tAnnotationValue,
				tAnnotation, ruleResult, csp };
	}
