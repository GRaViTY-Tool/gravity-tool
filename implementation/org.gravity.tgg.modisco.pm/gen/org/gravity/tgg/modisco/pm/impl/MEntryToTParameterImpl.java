 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MEntryToTParameterImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MEntryToTParameterImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MEntryToTParameterImpl extends AbstractCorrespondenceImpl implements MEntryToTParameter {
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.MENTRY_TO_TPARAMETER;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.MENTRY_TO_TPARAMETER__SOURCE,
							oldSource, source));
			}
		}
		return source;
	...
	public void setSource(MEntry newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.MENTRY_TO_TPARAMETER__SOURCE, oldSource,
					source));
	}
	...
	public TParameter getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PmPackage.MENTRY_TO_TPARAMETER__TARGET,
							oldTarget, target));
			}
		}
		return target;
	...
	public void setTarget(TParameter newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.MENTRY_TO_TPARAMETER__TARGET, oldTarget,
					target));
	}
