...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mInterface, mTypeToTType, mModifierToTModifier, tModifier, tInterface, defToMember,
				mModifier, tMember, mDefinition);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tInterface] = " + tInterface + ", " + "[defToMember] = " + defToMember + ", " + "[mModifier] = "
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mInterface, mTypeToTType, mModifierToTModifier, tModifier, tInterface, defToMember, mModifier, tMember,
				mDefinition);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_2_2_corematch_blackBFFFBFBB(mInterface, mModifier, mDefinition, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					mInterface, mTypeToTType, tInterface, defToMember, mModifier, tMember, mDefinition)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mInterface, mTypeToTType,
								tInterface, defToMember, mModifier, tMember, mDefinition);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface,
			...
			Modifier mModifier, TMember tMember, MDefinition mDefinition) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mInterface, EObject mTypeToTType,
			EObject mModifierToTModifier, EObject tModifier, EObject tInterface, EObject defToMember, EObject mModifier,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_12_2_corematch_blackFFBBFBFB(tModifier, tInterface, tMember, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					mInterface, mTypeToTType, tModifier, tInterface, defToMember, tMember, mDefinition)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mInterface, mTypeToTType,
								tModifier, tInterface, defToMember, tMember, mDefinition);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mInterface__mDefinition____bodyDeclarations = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mDefinition__mInterface____abstractTypeDeclaration = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge tInterface__tMember____defines = (EMoflonEdge) result3_green[10];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface,
			TypeToTAbstractType mTypeToTType, TModifier tModifier, TInterface tInterface,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mInterface, EObject mTypeToTType,
			EObject mModifierToTModifier, EObject tModifier, EObject tInterface, EObject defToMember, EObject mModifier,
			EObject tMember, EObject mDefinition) {
		ruleresult.registerObject("mInterface", mInterface);
		ruleresult.registerObject("mTypeToTType", mTypeToTType);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mInterface, tModifier,
						tInterface, mModifier, tMember, mDefinition, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mInterface] = " + mInterface + ", " + "[tModifier] = " + tModifier + ", " + "[tInterface] = "
					+ tInterface + ", " + "[mModifier] = " + mModifier + ", " + "[tMember] = " + tMember + ", "
		...
		if (InterfaceMemberImpl.pattern_InterfaceMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceMemberImpl
					.pattern_InterfaceMember_24_5_matchcorrcontext_blackBFBFBBBB(mInterface, tInterface, tMember,
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(mInterface, tModifier,
								tInterface, mModifier, tMember, mDefinition, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mInterface] = "
							+ mInterface + ", " + "[tModifier] = " + tModifier + ", " + "[tInterface] = " + tInterface
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(InterfaceDeclaration mInterface, TModifier tModifier, TInterface tInterface,
			Modifier mModifier, TMember tMember, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mInterface, mTypeToTType, tInterface, defToMember, tMember, mDefinition, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mInterface] = " + mInterface + ", "
						+ "[mTypeToTType] = " + mTypeToTType + ", " + "[tInterface] = " + tInterface + ", "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(
						mInterface, mTypeToTType, tInterface, defToMember, tMember, mDefinition);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mInterface] = "
								...
								+ tInterface + ", " + "[defToMember] = " + defToMember + ", " + "[tMember] = " + tMember
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface,
			TypeToTAbstractType mTypeToTType, TInterface tInterface, MDefinitionToTMember defToMember, TMember tMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TINTERFACE_MDEFINITIONTOTMEMBER_MODIFIER_TMEMBER_MDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TInterface) arguments.get(3), (MDefinitionToTMember) arguments.get(4), (Modifier) arguments.get(5),
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TMODIFIER_TINTERFACE_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TModifier) arguments.get(3), (TInterface) arguments.get(4),
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_70__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_70((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_74__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__INTERFACEDECLARATION_TMODIFIER_TINTERFACE_MODIFIER_TMEMBER_MDEFINITION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((InterfaceDeclaration) arguments.get(0), (TModifier) arguments.get(1),
					(TInterface) arguments.get(2), (Modifier) arguments.get(3), (TMember) arguments.get(4),
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TINTERFACE_MDEFINITIONTOTMEMBER_TMEMBER_MDEFINITION_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TInterface) arguments.get(3), (MDefinitionToTMember) arguments.get(4), (TMember) arguments.get(5),
						...
						if (tmpMModifier instanceof Modifier) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									...
									return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, mModifier,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, mModifier, tMember,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					mInterface, mTypeToTType, tInterface, defToMember, mModifier, tMember, mDefinition, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mInterface, EObject mTypeToTType, EObject mModifierToTModifier,
			EObject tModifier, EObject tInterface, EObject defToMember, EObject mModifier, EObject tMember,
			EObject mDefinition) {
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject tModifier, EObject tInterface, EObject defToMember, EObject mModifier, EObject tMember,
			EObject mDefinition) {
		_this.registerObjects_FWD(ruleresult, mInterface, mTypeToTType, mModifierToTModifier, tModifier, tInterface,
				defToMember, mModifier, tMember, mDefinition);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_2_corematch_blackBFFFBFBB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInterface instanceof TInterface) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { mInterface, mTypeToTType, tInterface, defToMember, mModifier,
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, mModifier, tMember, mDefinition,
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			...
			TInterface tInterface, MDefinitionToTMember defToMember, Modifier mModifier, TMember tMember,
			MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mInterface, mTypeToTType, tInterface,
				defToMember, mModifier, tMember, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mInterface, mTypeToTType, tInterface, defToMember, mModifier, tMember,
				mDefinition);
					...
					if (tmpTInterface instanceof TInterface) {
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									MDefinition mDefinition = (MDefinition) tmpMDefinition;
									return new Object[] { mInterface, mTypeToTType, tModifier, tInterface, defToMember,
											tMember, mDefinition, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
			InterfaceDeclaration mInterface, TypeToTAbstractType mTypeToTType, TModifier tModifier,
			TInterface tInterface, MDefinitionToTMember defToMember, TMember tMember, MDefinition mDefinition,
			InterfaceMember _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mInterface, mTypeToTType, tModifier, tInterface, defToMember, tMember,
						mDefinition, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					mInterface, mTypeToTType, tModifier, tInterface, defToMember, tMember, mDefinition, _this,
					isApplicableMatch);
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject tModifier, EObject tInterface, EObject defToMember, EObject mModifier, EObject tMember,
			EObject mDefinition) {
		_this.registerObjects_BWD(ruleresult, mInterface, mTypeToTType, mModifierToTModifier, tModifier, tInterface,
				defToMember, mModifier, tMember, mDefinition);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_12_2_corematch_blackFFBBFBFB(TModifier tModifier,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMInterface instanceof InterfaceDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { mInterface, mTypeToTType, tModifier, tInterface, defToMember,
								tMember, mDefinition, match });
					}
					...
					if (tInterface.equals(mTypeToTType.getTarget())) {
						if (tMember.equals(defToMember.getTarget())) {
							if (tModifier.equals(tMember.getTModifier())) {
								if (mDefinition.equals(defToMember.getSource())) {
									_result.add(new Object[] { mInterface, mTypeToTType, tModifier, tInterface,
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		tMember__tModifier____tModifier.setName(tMember__tModifier____tModifier_name_prime);
		defToMember__mDefinition____source.setName(defToMember__mDefinition____source_name_prime);
		return new Object[] { mInterface, mTypeToTType, tModifier, tInterface, defToMember, tMember, mDefinition,
				isApplicableMatch, mInterface__mDefinition____bodyDeclarations,
				mDefinition__mInterface____abstractTypeDeclaration, tInterface__tMember____defines,
				tMember__tInterface____definedBy, mTypeToTType__mInterface____source,
				mTypeToTType__tInterface____target, defToMember__tMember____target, tMember__tModifier____tModifier,
				defToMember__mDefinition____source };
	}

	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface, TypeToTAbstractType mTypeToTType,
			TModifier tModifier, TInterface tInterface, MDefinitionToTMember defToMember, TMember tMember,
			MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mInterface, mTypeToTType, tModifier,
				tInterface, defToMember, tMember, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInterface, mTypeToTType, tModifier, tInterface,
					defToMember, tMember, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mInterface, mTypeToTType, tModifier, tInterface, defToMember, tMember,
				mDefinition);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_865916 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_865916)) {
				...
				if (tmpTInterface instanceof TInterface) {
					...
					if (tmpMModifier instanceof Modifier) {
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								MDefinition mDefinition = (MDefinition) tmpMDefinition;
								return new Object[] { mInterface, tModifier, tInterface, mModifier, tMember,
										mDefinition, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
			InterfaceDeclaration mInterface, TModifier tModifier, TInterface tInterface, Modifier mModifier,
			TMember tMember, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mInterface, tModifier, tInterface, mModifier, tMember, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mInterface, tModifier, tInterface, mModifier, tMember, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
			InterfaceDeclaration mInterface, TModifier tModifier, TInterface tInterface, Modifier mModifier,
			TMember tMember, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mInterface, tModifier, tInterface, mModifier, tMember,
				mDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mInterface, tModifier, tInterface, mModifier, tMember, mDefinition,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mInterface, tModifier, tInterface, mModifier, tMember, mDefinition, sourceMatch, targetMatch);
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tInterface.equals(mTypeToTType.getTarget())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tMember, MDefinitionToTMember.class, "target")) {
						if (mDefinition.equals(defToMember.getSource())) {
							_result.add(new Object[] { mInterface, mTypeToTType, tInterface, defToMember, tMember,
									mDefinition, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mInterface, tModifier, tInterface, mModifier, tMember, mDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_655899 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_655899)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mInterface, mTypeToTType, tInterface,
				defToMember, tMember, mDefinition, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInterface, mTypeToTType, tInterface, defToMember,
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_29_3_solveCSP_binding = pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mInterface, mTypeToTType, tInterface, defToMember, tMember, mDefinition,
				ruleResult);
	...
	public static final Object[] pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(InterfaceDeclaration mInterface,
			TypeToTAbstractType mTypeToTType, TInterface tInterface, MDefinitionToTMember defToMember, TMember tMember,
			MDefinition mDefinition) {
		return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, tMember, mDefinition };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(InterfaceDeclaration mInterface,
		...
		return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, tMember, mDefinition, ruleResult };
	}
