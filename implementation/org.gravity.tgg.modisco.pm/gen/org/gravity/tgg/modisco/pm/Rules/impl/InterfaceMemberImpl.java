...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, tModifier, mModifier, tInterface, mModifierToTModifier, mTypeToTType, mInterface,
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[mDefinition] = " + mDefinition + ", " + "[defToMember] = " + defToMember + ", " + "[tMember] = "
					+ tMember + ".");
		}
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				tModifier, mModifier, tInterface, mModifierToTModifier, mTypeToTType, mInterface, mDefinition,
				defToMember, tMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl.pattern_InterfaceMember_2_2_corematch_blackBFFBBFFB(mModifier,
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					mModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mModifier, tInterface,
								mTypeToTType, mInterface, mDefinition, defToMember, tMember);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tModifier, EObject mModifier,
			EObject tInterface, EObject mModifierToTModifier, EObject mTypeToTType, EObject mInterface,
			EObject mDefinition, EObject defToMember, EObject tMember) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_12_2_corematch_blackBBFFFFBB(tModifier, tInterface, tMember, match)) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[2];
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					tModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TModifier tModifier,
			...
			MDefinition mDefinition, MDefinitionToTMember defToMember, TMember tMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tModifier, mModifier, tInterface,
						mInterface, mDefinition, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tModifier] = " + tModifier + ", " + "[mModifier] = " + mModifier + ", " + "[tInterface] = "
					+ tInterface + ", " + "[mInterface] = " + mInterface + ", " + "[mDefinition] = " + mDefinition
		...
		if (InterfaceMemberImpl.pattern_InterfaceMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceMemberImpl
					.pattern_InterfaceMember_24_5_matchcorrcontext_blackBFBBFBBB(tInterface, mInterface, mDefinition,
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(tModifier, mModifier,
								tInterface, mInterface, mDefinition, tMember, ccMatch);
				if (result6_black == null) {
	...
	public CSP isApplicable_solveCsp_CC(TModifier tModifier, Modifier mModifier, TInterface tInterface,
			InterfaceDeclaration mInterface, MDefinition mDefinition, TMember tMember, Match sourceMatch,
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(
						tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tInterface] = "
								+ tInterface + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[mInterface] = "
								+ mInterface + ", " + "[mDefinition] = " + mDefinition + ", " + "[defToMember] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_TINTERFACE_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_MDEFINITION_MDEFINITIONTOTMEMBER_TMEMBER:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMODIFIER_TINTERFACE_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_MDEFINITION_MDEFINITIONTOTMEMBER_TMEMBER:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_56__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_56((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_58__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__TMODIFIER_MODIFIER_TINTERFACE_INTERFACEDECLARATION_MDEFINITION_TMEMBER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TModifier) arguments.get(0), (Modifier) arguments.get(1),
					...
					(MDefinition) arguments.get(4), (TMember) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_MDEFINITION_MDEFINITIONTOTMEMBER_TMEMBER_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TInterface) arguments.get(1),
					...
					(MDefinition) arguments.get(4), (MDefinitionToTMember) arguments.get(5), (TMember) arguments.get(6),
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTMember instanceof TMember) {
									...
									return new Object[] { mModifier, tInterface, mTypeToTType, mInterface, mDefinition,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(Modifier mModifier,
			TInterface tInterface, TypeToTAbstractType mTypeToTType, InterfaceDeclaration mInterface,
			MDefinition mDefinition, MDefinitionToTMember defToMember, TMember tMember, InterfaceMember _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tModifier, EObject mModifier, EObject tInterface,
			EObject mModifierToTModifier, EObject mTypeToTType, EObject mInterface, EObject mDefinition,
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mModifierToTModifier, EObject mTypeToTType, EObject mInterface, EObject mDefinition,
			EObject defToMember, EObject tMember) {
		_this.registerObjects_FWD(ruleresult, tModifier, mModifier, tInterface, mModifierToTModifier, mTypeToTType,
				mInterface, mDefinition, defToMember, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_2_corematch_blackBFFBBFFB(Modifier mModifier,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInterface instanceof TInterface) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { mModifier, tInterface, mTypeToTType, mInterface, mDefinition,
						...
						if (mDefinition.equals(defToMember.getSource())) {
							if (tInterface.equals(mTypeToTType.getTarget())) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { mModifier, tInterface, mTypeToTType, mInterface,
											mDefinition, defToMember, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(Modifier mModifier,
		...
		return new Object[] { mModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember,
				...
				mTypeToTType__tInterface____target, defToMember__tMember____target };
	}

	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, Modifier mModifier, TInterface tInterface,
			TypeToTAbstractType mTypeToTType, InterfaceDeclaration mInterface, MDefinition mDefinition,
			MDefinitionToTMember defToMember, TMember tMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModifier, tInterface, mTypeToTType,
				mInterface, mDefinition, defToMember, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, tInterface, mTypeToTType, mInterface,
					mDefinition, defToMember, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember,
				tMember);
					...
					if (tmpMInterface instanceof InterfaceDeclaration) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTMember instanceof TMember) {
									TMember tMember = (TMember) tmpTMember;
									return new Object[] { tModifier, tInterface, mTypeToTType, mInterface, mDefinition,
											defToMember, tMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(TModifier tModifier,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember,
						tMember, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					tModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mModifierToTModifier, EObject mTypeToTType, EObject mInterface, EObject mDefinition,
			EObject defToMember, EObject tMember) {
		_this.registerObjects_BWD(ruleresult, tModifier, mModifier, tInterface, mModifierToTModifier, mTypeToTType,
				mInterface, mDefinition, defToMember, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_12_2_corematch_blackBBFFFFBB(TModifier tModifier,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMInterface instanceof InterfaceDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tModifier, tInterface, mTypeToTType, mInterface, mDefinition,
								defToMember, tMember, match });
					}
				...
				if (tInterface.getDefines().contains(tMember)) {
					if (mDefinition.equals(defToMember.getSource())) {
						if (tModifier.equals(tMember.getTModifier())) {
							if (tInterface.equals(mTypeToTType.getTarget())) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { tModifier, tInterface, mTypeToTType, mInterface,
											mDefinition, defToMember, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(TModifier tModifier,
		...
		mTypeToTType__tInterface____target.setName(mTypeToTType__tInterface____target_name_prime);
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		return new Object[] { tModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember,
				isApplicableMatch, mInterface__mDefinition____bodyDeclarations,
				mDefinition__mInterface____abstractTypeDeclaration, mTypeToTType__mInterface____source,
				tInterface__tMember____defines, tMember__tInterface____definedBy, defToMember__mDefinition____source,
				tMember__tModifier____tModifier, mTypeToTType__tInterface____target, defToMember__tMember____target };
	}

	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TModifier tModifier, TInterface tInterface,
			TypeToTAbstractType mTypeToTType, InterfaceDeclaration mInterface, MDefinition mDefinition,
			MDefinitionToTMember defToMember, TMember tMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tModifier, tInterface, mTypeToTType,
				mInterface, mDefinition, defToMember, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tModifier, tInterface, mTypeToTType, mInterface,
					mDefinition, defToMember, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tModifier, tInterface, mTypeToTType, mInterface, mDefinition, defToMember,
				tMember);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_871855 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_871855)) {
				...
				if (tmpTInterface instanceof TInterface) {
					...
					if (tmpMInterface instanceof InterfaceDeclaration) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { tModifier, mModifier, tInterface, mInterface, mDefinition,
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(TModifier tModifier,
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tModifier, mModifier, tInterface, mInterface, mDefinition, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tModifier, mModifier, tInterface, mInterface, mDefinition, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
			TModifier tModifier, Modifier mModifier, TInterface tInterface, InterfaceDeclaration mInterface,
			MDefinition mDefinition, TMember tMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tModifier, mModifier, tInterface, mInterface, mDefinition,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tModifier, mModifier, tInterface, mInterface, mDefinition, tMember,
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tModifier, mModifier, tInterface, mInterface, mDefinition, tMember, sourceMatch, targetMatch);
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tInterface.equals(mTypeToTType.getTarget())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { tInterface, mTypeToTType, mInterface, mDefinition, defToMember,
									tMember, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(TModifier tModifier,
			Modifier mModifier, TInterface tInterface, InterfaceDeclaration mInterface, MDefinition mDefinition,
			TMember tMember, CCMatch ccMatch) {
		return new Object[] { tModifier, mModifier, tInterface, mInterface, mDefinition, tMember, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_331791 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_331791)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			...
			InterfaceDeclaration mInterface, MDefinition mDefinition, MDefinitionToTMember defToMember, TMember tMember,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tInterface, mTypeToTType, mInterface,
				mDefinition, defToMember, tMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInterface, mTypeToTType, mInterface, mDefinition,
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_29_3_solveCSP_binding = pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember,
				ruleResult);
	...
	public static final Object[] pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(TInterface tInterface,
			TypeToTAbstractType mTypeToTType, InterfaceDeclaration mInterface, MDefinition mDefinition,
			MDefinitionToTMember defToMember, TMember tMember) {
		return new Object[] { tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(TInterface tInterface,
		...
		return new Object[] { tInterface, mTypeToTType, mInterface, mDefinition, defToMember, tMember, ruleResult };
	}
