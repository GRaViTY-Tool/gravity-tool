...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, tMember, tInterface, tModifier, mTypeToTType, mModifier, mModifierToTModifier, mInterface,
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tMember,
				tModifier, mModifier, mModifierToTModifier, mDefinition);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, tMember,
				tInterface, tModifier, mTypeToTType, mModifier, mModifierToTModifier, mInterface, defToMember,
				mDefinition);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl.pattern_InterfaceMember_2_2_corematch_blackFFFBBFBB(mModifier,
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					tMember, tInterface, mTypeToTType, mModifier, mInterface, defToMember, mDefinition)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(tMember, tInterface,
								mTypeToTType, mModifier, mInterface, defToMember, mDefinition);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMember tMember, TInterface tInterface,
			TypeToTAbstractType mTypeToTType, Modifier mModifier, InterfaceDeclaration mInterface,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tMember, EObject tInterface,
			EObject tModifier, EObject mTypeToTType, EObject mModifier, EObject mModifierToTModifier,
			EObject mInterface, EObject defToMember, EObject mDefinition) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		InterfaceMemberImpl.pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				tMember, tInterface, tModifier, mTypeToTType, mModifier, mModifierToTModifier, mInterface, defToMember,
				mDefinition);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl.pattern_InterfaceMember_12_2_corematch_blackBBBFFFFB(tMember,
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					tMember, tInterface, tModifier, mTypeToTType, mInterface, defToMember, mDefinition)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tMember, tInterface, tModifier,
								mTypeToTType, mInterface, defToMember, mDefinition);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tInterface__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tInterface____definedBy = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge defToMember__tMember____target = (EMoflonEdge) result3_green[10];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMember tMember, TInterface tInterface,
			TModifier tModifier, TypeToTAbstractType mTypeToTType, InterfaceDeclaration mInterface,
			MDefinitionToTMember defToMember, MDefinition mDefinition) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_591(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_637(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tMember, tInterface, tModifier,
						mModifier, mInterface, mDefinition, sourceMatch, targetMatch);
		...
		if (InterfaceMemberImpl.pattern_InterfaceMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceMemberImpl
					.pattern_InterfaceMember_24_5_matchcorrcontext_blackBBFBFBBB(tMember, tInterface, mInterface,
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(tMember, tInterface, tModifier,
								mModifier, mInterface, mDefinition, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMember tMember, TInterface tInterface, TModifier tModifier, Modifier mModifier,
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, tMember,
							tInterface, mTypeToTType, mInterface, defToMember, mDefinition, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMember] = " + tMember + ", "
						+ "[tInterface] = " + tInterface + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(tMember,
						tInterface, mTypeToTType, mInterface, defToMember, mDefinition);
				if (result5_black != null) {

					Object[] result6_black = InterfaceMemberImpl.pattern_InterfaceMember_29_6_perform_blackBBBBBBB(
							tMember, tInterface, mTypeToTType, mInterface, defToMember, mDefinition, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMember] = "
								+ tMember + ", " + "[tInterface] = " + tInterface + ", " + "[mTypeToTType] = "
								+ mTypeToTType + ", " + "[mInterface] = " + mInterface + ", " + "[defToMember] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMember tMember, TInterface tInterface,
			TypeToTAbstractType mTypeToTType, InterfaceDeclaration mInterface, MDefinitionToTMember defToMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMEMBER_TINTERFACE_TYPETOTABSTRACTTYPE_MODIFIER_INTERFACEDECLARATION_MDEFINITIONTOTMEMBER_MDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TMember) arguments.get(1),
					(TInterface) arguments.get(2), (TypeToTAbstractType) arguments.get(3), (Modifier) arguments.get(4),
					(InterfaceDeclaration) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_TINTERFACE_TMODIFIER_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_MDEFINITIONTOTMEMBER_MDEFINITION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TMember) arguments.get(1),
					(TInterface) arguments.get(2), (TModifier) arguments.get(3), (TypeToTAbstractType) arguments.get(4),
					(InterfaceDeclaration) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
					(MDefinition) arguments.get(7));
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_591__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_591((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_637__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_637((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__TMEMBER_TINTERFACE_TMODIFIER_MODIFIER_INTERFACEDECLARATION_MDEFINITION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TMember) arguments.get(0), (TInterface) arguments.get(1),
					(TModifier) arguments.get(2), (Modifier) arguments.get(3), (InterfaceDeclaration) arguments.get(4),
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_TINTERFACE_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_MDEFINITIONTOTMEMBER_MDEFINITION_MODELGENERATORRULERESULT:
						...
						if (tmpMInterface instanceof InterfaceDeclaration) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									...
									return new Object[] { tMember, tInterface, mTypeToTType, mModifier, mInterface,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(TMember tMember,
			TInterface tInterface, TypeToTAbstractType mTypeToTType, Modifier mModifier,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMember, tInterface, mTypeToTType, mModifier, mInterface, defToMember,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					tMember, tInterface, mTypeToTType, mModifier, mInterface, defToMember, mDefinition, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tMember, EObject tInterface, EObject tModifier, EObject mTypeToTType,
			EObject mModifier, EObject mModifierToTModifier, EObject mInterface, EObject defToMember,
			EObject mDefinition) {
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tMember, EObject tModifier, EObject mModifier,
		...
		mDefinition__mModifier____modifier.setName(mDefinition__mModifier____modifier_name_prime);
		mModifier__mDefinition____bodyDeclaration.setName(mModifier__mDefinition____bodyDeclaration_name_prime);
		return new Object[] { ruleresult, tMember, tModifier, mModifier, mModifierToTModifier, mDefinition,
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mModifier, EObject mModifierToTModifier, EObject mInterface, EObject defToMember,
			EObject mDefinition) {
		_this.registerObjects_FWD(ruleresult, tMember, tInterface, tModifier, mTypeToTType, mModifier,
				mModifierToTModifier, mInterface, defToMember, mDefinition);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_2_corematch_blackFFFBBFBB(Modifier mModifier,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInterface instanceof TInterface) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { tMember, tInterface, mTypeToTType, mModifier, mInterface,
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(TMember tMember,
		...
		mDefinition__mModifier____modifier.setName(mDefinition__mModifier____modifier_name_prime);
		mModifier__mDefinition____bodyDeclaration.setName(mModifier__mDefinition____bodyDeclaration_name_prime);
		return new Object[] { tMember, tInterface, mTypeToTType, mModifier, mInterface, defToMember, mDefinition,
				...
				mDefinition__mInterface____abstractTypeDeclaration, mDefinition__mModifier____modifier,
				mModifier__mDefinition____bodyDeclaration };
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tMember, tInterface, mTypeToTType,
				mModifier, mInterface, defToMember, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, tInterface, mTypeToTType, mModifier,
					mInterface, defToMember, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, tInterface, mTypeToTType, mModifier, mInterface, defToMember,
				mDefinition);
					...
					if (tmpMTypeToTType instanceof TypeToTAbstractType) {
						...
						if (tmpMInterface instanceof InterfaceDeclaration) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									MDefinition mDefinition = (MDefinition) tmpMDefinition;
									return new Object[] { tMember, tInterface, tModifier, mTypeToTType, mInterface,
											defToMember, mDefinition, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(TMember tMember,
			TInterface tInterface, TModifier tModifier, TypeToTAbstractType mTypeToTType,
			InterfaceDeclaration mInterface, MDefinitionToTMember defToMember, MDefinition mDefinition,
			InterfaceMember _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMember, tInterface, tModifier, mTypeToTType, mInterface, defToMember,
						mDefinition, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_InterfaceMember_11_1_performtransformation_binding[3];
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					tMember, tInterface, tModifier, mTypeToTType, mInterface, defToMember, mDefinition, _this,
					isApplicableMatch);
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mModifier, EObject mModifierToTModifier, EObject mInterface, EObject defToMember,
			EObject mDefinition) {
		_this.registerObjects_BWD(ruleresult, tMember, tInterface, tModifier, mTypeToTType, mModifier,
				mModifierToTModifier, mInterface, defToMember, mDefinition);
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMDefinition instanceof MDefinition) {
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMInterface instanceof InterfaceDeclaration) {
						InterfaceDeclaration mInterface = (InterfaceDeclaration) tmpMInterface;
						_result.add(new Object[] { tMember, tInterface, tModifier, mTypeToTType, mInterface,
								defToMember, mDefinition, match });
					}
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(TMember tMember,
		...
		mDefinition__mInterface____abstractTypeDeclaration
				.setName(mDefinition__mInterface____abstractTypeDeclaration_name_prime);
		return new Object[] { tMember, tInterface, tModifier, mTypeToTType, mInterface, defToMember, mDefinition,
				isApplicableMatch, tInterface__tMember____defines, tMember__tInterface____definedBy,
				defToMember__tMember____target, mTypeToTType__mInterface____source, mTypeToTType__tInterface____target,
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, tInterface, tModifier, mTypeToTType,
					mInterface, defToMember, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, tInterface, tModifier, mTypeToTType, mInterface, defToMember,
				mDefinition);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_984993 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_984993)) {
				...
				if (tmpTModifier instanceof TModifier) {
					...
					if (tmpMModifier instanceof Modifier) {
						...
						if (tmpMInterface instanceof InterfaceDeclaration) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								MDefinition mDefinition = (MDefinition) tmpMDefinition;
								return new Object[] { tMember, tInterface, tModifier, mModifier, mInterface,
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(TMember tMember,
			TInterface tInterface, TModifier tModifier, Modifier mModifier, InterfaceDeclaration mInterface,
			MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMember, tInterface, tModifier, mModifier, mInterface, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tMember, tInterface, tModifier, mModifier, mInterface, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
			TMember tMember, TInterface tInterface, TModifier tModifier, Modifier mModifier,
			InterfaceDeclaration mInterface, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tMember, tInterface, tModifier, mModifier, mInterface,
				mDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tMember, tInterface, tModifier, mModifier, mInterface, mDefinition,
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tMember, tInterface, tModifier, mModifier, mInterface, mDefinition, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_24_5_matchcorrcontext_blackBBFBFBBB(TMember tMember,
			...
			for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mDefinition.equals(defToMember.getSource())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mInterface, TypeToTAbstractType.class, "source")) {
						if (tInterface.equals(mTypeToTType.getTarget())) {
							_result.add(new Object[] { tMember, tInterface, mTypeToTType, mInterface, defToMember,
									mDefinition, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(TMember tMember,
			TInterface tInterface, TModifier tModifier, Modifier mModifier, InterfaceDeclaration mInterface,
			MDefinition mDefinition, CCMatch ccMatch) {
		return new Object[] { tMember, tInterface, tModifier, mModifier, mInterface, mDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_166476 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_166476)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tMember, tInterface, mTypeToTType,
				mInterface, defToMember, mDefinition, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, tInterface, mTypeToTType, mInterface,
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_29_3_solveCSP_binding = pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, tInterface, mTypeToTType, mInterface, defToMember, mDefinition,
				ruleResult);
	...
	public static final Object[] pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(TMember tMember,
			TInterface tInterface, TypeToTAbstractType mTypeToTType, InterfaceDeclaration mInterface,
			MDefinitionToTMember defToMember, MDefinition mDefinition) {
		return new Object[] { tMember, tInterface, mTypeToTType, mInterface, defToMember, mDefinition };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(TMember tMember,
		...
		return new Object[] { tMember, tInterface, mTypeToTType, mInterface, defToMember, mDefinition, ruleResult };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_greenBFFFBBB(TMember tMember,
		...
		return new Object[] { tMember, tModifier, mModifier, mModifierToTModifier, mDefinition, ruleResult, csp };
	}
