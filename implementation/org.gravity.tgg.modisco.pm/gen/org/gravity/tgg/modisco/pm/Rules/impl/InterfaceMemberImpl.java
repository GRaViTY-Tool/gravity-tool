...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, tInterface, tModifier, mTypeToTType, mDefinition, mInterface, mModifier,
				mModifierToTModifier, defToMember, tMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[mModifierToTModifier] = " + mModifierToTModifier + ", " + "[defToMember] = " + defToMember
					+ ", " + "[tMember] = " + tMember + ".");
		}
		InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tModifier,
				mDefinition, mModifier, mModifierToTModifier, tMember);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				tInterface, tModifier, mTypeToTType, mDefinition, mInterface, mModifier, mModifierToTModifier,
				defToMember, tMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_2_2_corematch_blackFFBBBFFB(mDefinition, mInterface, mModifier, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					tInterface, mTypeToTType, mDefinition, mInterface, mModifier, defToMember, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(tInterface, mTypeToTType,
								mDefinition, mInterface, mModifier, defToMember, tMember);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TInterface tInterface,
			TypeToTAbstractType mTypeToTType, MDefinition mDefinition, InterfaceDeclaration mInterface,
			Modifier mModifier, MDefinitionToTMember defToMember, TMember tMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tInterface, EObject tModifier,
			EObject mTypeToTType, EObject mDefinition, EObject mInterface, EObject mModifier,
			EObject mModifierToTModifier, EObject defToMember, EObject tMember) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = InterfaceMemberImpl
				.pattern_InterfaceMember_11_1_performtransformation_greenBBFFB(tModifier, mDefinition, csp);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_12_2_corematch_blackBBFFFFBB(tInterface, tModifier, tMember, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					tInterface, tModifier, mTypeToTType, mDefinition, mInterface, defToMember, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tInterface, tModifier,
								mTypeToTType, mDefinition, mInterface, defToMember, tMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tInterface__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tInterface____definedBy = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mInterface__mDefinition____bodyDeclarations = (EMoflonEdge) result3_green[10];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TInterface tInterface,
			...
			InterfaceDeclaration mInterface, MDefinitionToTMember defToMember, TMember tMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tInterface, EObject tModifier,
			EObject mTypeToTType, EObject mDefinition, EObject mInterface, EObject mModifier,
			EObject mModifierToTModifier, EObject defToMember, EObject tMember) {
		ruleresult.registerObject("tInterface", tInterface);
		ruleresult.registerObject("tModifier", tModifier);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_6(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_6(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tInterface, tModifier,
						mDefinition, mInterface, mModifier, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tInterface] = " + tInterface + ", " + "[tModifier] = " + tModifier + ", " + "[mDefinition] = "
					+ mDefinition + ", " + "[mInterface] = " + mInterface + ", " + "[mModifier] = " + mModifier + ", "
		...
		if (InterfaceMemberImpl.pattern_InterfaceMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceMemberImpl
					.pattern_InterfaceMember_24_5_matchcorrcontext_blackBFBBFBBB(tInterface, mDefinition, mInterface,
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(tInterface, tModifier,
								mDefinition, mInterface, mModifier, tMember, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tInterface] = "
							+ tInterface + ", " + "[tModifier] = " + tModifier + ", " + "[mDefinition] = " + mDefinition
							+ ", " + "[mInterface] = " + mInterface + ", " + "[mModifier] = " + mModifier + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TInterface tInterface, TModifier tModifier, MDefinition mDefinition,
			InterfaceDeclaration mInterface, Modifier mModifier, TMember tMember, Match sourceMatch,
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tInterface, mTypeToTType, mDefinition, mInterface, defToMember, tMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tInterface] = " + tInterface + ", "
						+ "[mTypeToTType] = " + mTypeToTType + ", " + "[mDefinition] = " + mDefinition + ", "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(
						tInterface, mTypeToTType, mDefinition, mInterface, defToMember, tMember);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tInterface] = "
								...
								+ mDefinition + ", " + "[mInterface] = " + mInterface + ", " + "[defToMember] = "
								+ defToMember + ", " + "[tMember] = " + tMember + ", " + "[ruleResult] = " + ruleResult
								+ ".");
					}
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TInterface tInterface,
			TypeToTAbstractType mTypeToTType, MDefinition mDefinition, InterfaceDeclaration mInterface,
			MDefinitionToTMember defToMember, TMember tMember, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TINTERFACE_TYPETOTABSTRACTTYPE_MDEFINITION_INTERFACEDECLARATION_MODIFIER_MDEFINITIONTOTMEMBER_TMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TInterface) arguments.get(1),
					...
					(InterfaceDeclaration) arguments.get(4), (Modifier) arguments.get(5),
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_TMODIFIER_TYPETOTABSTRACTTYPE_MDEFINITION_INTERFACEDECLARATION_MDEFINITIONTOTMEMBER_TMEMBER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TInterface) arguments.get(1),
					(TModifier) arguments.get(2), (TypeToTAbstractType) arguments.get(3),
					(MDefinition) arguments.get(4), (InterfaceDeclaration) arguments.get(5),
					(MDefinitionToTMember) arguments.get(6), (TMember) arguments.get(7));
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_6__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_6((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_6__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__TINTERFACE_TMODIFIER_MDEFINITION_INTERFACEDECLARATION_MODIFIER_TMEMBER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TInterface) arguments.get(0), (TModifier) arguments.get(1),
					(MDefinition) arguments.get(2), (InterfaceDeclaration) arguments.get(3),
					(Modifier) arguments.get(4), (TMember) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_TYPETOTABSTRACTTYPE_MDEFINITION_INTERFACEDECLARATION_MDEFINITIONTOTMEMBER_TMEMBER_MODELGENERATORRULERESULT:
						...
						if (tmpMModifier instanceof Modifier) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTMember instanceof TMember) {
									...
									return new Object[] { tInterface, mTypeToTType, mDefinition, mInterface, mModifier,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
			...
			InterfaceDeclaration mInterface, Modifier mModifier, MDefinitionToTMember defToMember, TMember tMember,
			InterfaceMember _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tInterface, mTypeToTType, mDefinition, mInterface, mModifier, defToMember,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					tInterface, mTypeToTType, mDefinition, mInterface, mModifier, defToMember, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tInterface, EObject tModifier, EObject mTypeToTType,
			EObject mDefinition, EObject mInterface, EObject mModifier, EObject mModifierToTModifier,
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tModifier, EObject mDefinition, EObject mModifier,
		...
		return new Object[] { ruleresult, tModifier, mDefinition, mModifier, mModifierToTModifier, tMember,
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mDefinition, EObject mInterface, EObject mModifier, EObject mModifierToTModifier,
			EObject defToMember, EObject tMember) {
		_this.registerObjects_FWD(ruleresult, tInterface, tModifier, mTypeToTType, mDefinition, mInterface, mModifier,
				mModifierToTModifier, defToMember, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_2_corematch_blackFFBBBFFB(MDefinition mDefinition,
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTInterface instanceof TInterface) {
						TInterface tInterface = (TInterface) tmpTInterface;
						_result.add(new Object[] { tInterface, mTypeToTType, mDefinition, mInterface, mModifier,
								defToMember, tMember, match });
					}
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(TInterface tInterface,
			TypeToTAbstractType mTypeToTType, MDefinition mDefinition, InterfaceDeclaration mInterface,
			Modifier mModifier, MDefinitionToTMember defToMember, TMember tMember) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(TInterface tInterface,
		...
		return new Object[] { tInterface, mTypeToTType, mDefinition, mInterface, mModifier, defToMember, tMember,
				...
				mTypeToTType__mInterface____source, mDefinition__mModifier____modifier,
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tInterface, mTypeToTType, mDefinition,
				mInterface, mModifier, defToMember, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInterface, mTypeToTType, mDefinition, mInterface, mModifier, defToMember,
				tMember);
					...
					if (tmpMDefinition instanceof MDefinition) {
						...
						if (tmpMInterface instanceof InterfaceDeclaration) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTMember instanceof TMember) {
									TMember tMember = (TMember) tmpTMember;
									return new Object[] { tInterface, tModifier, mTypeToTType, mDefinition, mInterface,
											defToMember, tMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
			TInterface tInterface, TModifier tModifier, TypeToTAbstractType mTypeToTType, MDefinition mDefinition,
			InterfaceDeclaration mInterface, MDefinitionToTMember defToMember, TMember tMember, InterfaceMember _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tInterface, tModifier, mTypeToTType, mDefinition, mInterface, defToMember,
						tMember, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_InterfaceMember_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					tInterface, tModifier, mTypeToTType, mDefinition, mInterface, defToMember, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_greenBBFFB(TModifier tModifier,
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mDefinition, EObject mInterface, EObject mModifier, EObject mModifierToTModifier,
			EObject defToMember, EObject tMember) {
		_this.registerObjects_BWD(ruleresult, tInterface, tModifier, mTypeToTType, mDefinition, mInterface, mModifier,
				mModifierToTModifier, defToMember, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_12_2_corematch_blackBBFFFFBB(TInterface tInterface,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMInterface instanceof InterfaceDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tInterface, tModifier, mTypeToTType, mDefinition, mInterface,
								defToMember, tMember, match });
					}
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(TInterface tInterface,
			TModifier tModifier, TypeToTAbstractType mTypeToTType, MDefinition mDefinition,
			InterfaceDeclaration mInterface, MDefinitionToTMember defToMember, TMember tMember) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (tInterface.getDefines().contains(tMember)) {
			if (mInterface.getBodyDeclarations().contains(mDefinition)) {
				if (mDefinition.equals(defToMember.getSource())) {
					if (tInterface.equals(mTypeToTType.getTarget())) {
						if (mInterface.equals(mTypeToTType.getSource())) {
							if (tModifier.equals(tMember.getTModifier())) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { tInterface, tModifier, mTypeToTType, mDefinition,
											mInterface, defToMember, tMember });
								}
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(TInterface tInterface,
		...
		tMember__tModifier____tModifier.setName(tMember__tModifier____tModifier_name_prime);
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		return new Object[] { tInterface, tModifier, mTypeToTType, mDefinition, mInterface, defToMember, tMember,
				isApplicableMatch, tInterface__tMember____defines, tMember__tInterface____definedBy,
				mInterface__mDefinition____bodyDeclarations, mDefinition__mInterface____abstractTypeDeclaration,
				defToMember__mDefinition____source, mTypeToTType__tInterface____target,
				mTypeToTType__mInterface____source, tMember__tModifier____tModifier, defToMember__tMember____target };
	}

	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TInterface tInterface, TModifier tModifier,
			TypeToTAbstractType mTypeToTType, MDefinition mDefinition, InterfaceDeclaration mInterface,
			MDefinitionToTMember defToMember, TMember tMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tInterface, tModifier, mTypeToTType,
				mDefinition, mInterface, defToMember, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInterface, tModifier, mTypeToTType, mDefinition,
					mInterface, defToMember, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInterface, tModifier, mTypeToTType, mDefinition, mInterface, defToMember,
				tMember);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_176950 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_176950)) {
				...
				if (tmpMDefinition instanceof MDefinition) {
					...
					if (tmpMInterface instanceof InterfaceDeclaration) {
						...
						if (tmpMModifier instanceof Modifier) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { tInterface, tModifier, mDefinition, mInterface, mModifier,
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(TInterface tInterface,
			TModifier tModifier, MDefinition mDefinition, InterfaceDeclaration mInterface, Modifier mModifier,
			TMember tMember, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tInterface, tModifier, mDefinition, mInterface, mModifier, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			...
			TModifier tModifier = (TModifier) result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding[1];
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tInterface, tModifier, mDefinition, mInterface, mModifier, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
			TInterface tInterface, TModifier tModifier, MDefinition mDefinition, InterfaceDeclaration mInterface,
			Modifier mModifier, TMember tMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tInterface, tModifier, mDefinition, mInterface, mModifier,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tInterface, tModifier, mDefinition, mInterface, mModifier, tMember,
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tInterface, tModifier, mDefinition, mInterface, mModifier, tMember, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_24_5_matchcorrcontext_blackBFBBFBBB(
			...
			for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tMember.equals(defToMember.getTarget())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tInterface, TypeToTAbstractType.class, "target")) {
						if (mInterface.equals(mTypeToTType.getSource())) {
							_result.add(new Object[] { tInterface, mTypeToTType, mDefinition, mInterface, defToMember,
									tMember, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(TInterface tInterface,
			TModifier tModifier, MDefinition mDefinition, InterfaceDeclaration mInterface, Modifier mModifier,
			TMember tMember, CCMatch ccMatch) {
		return new Object[] { tInterface, tModifier, mDefinition, mInterface, mModifier, tMember, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_969927 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_969927)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TInterface tInterface, TypeToTAbstractType mTypeToTType,
			MDefinition mDefinition, InterfaceDeclaration mInterface, MDefinitionToTMember defToMember, TMember tMember,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tInterface, mTypeToTType,
				mDefinition, mInterface, defToMember, tMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInterface, mTypeToTType, mDefinition, mInterface,
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_29_3_solveCSP_binding = pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInterface, mTypeToTType, mDefinition, mInterface, defToMember, tMember,
				ruleResult);
	...
	public static final Object[] pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(TInterface tInterface,
			TypeToTAbstractType mTypeToTType, MDefinition mDefinition, InterfaceDeclaration mInterface,
			MDefinitionToTMember defToMember, TMember tMember) {
		return new Object[] { tInterface, mTypeToTType, mDefinition, mInterface, defToMember, tMember };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(TInterface tInterface,
		...
		return new Object[] { tInterface, mTypeToTType, mDefinition, mInterface, defToMember, tMember, ruleResult };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_greenFBFFBBB(MDefinition mDefinition,
		...
		return new Object[] { tModifier, mDefinition, mModifier, mModifierToTModifier, tMember, ruleResult, csp };
	}
