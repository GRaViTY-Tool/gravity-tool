...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, tInterface, mInterface, mDefinition, tModifier, mModifier, mModifierToTModifier,
				mTypeToTType, tMember, defToMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tInterface] = " + tInterface + ", " + "[mInterface] = " + mInterface + ", "
					+ "[mDefinition] = " + mDefinition + ", " + "[tModifier] = " + tModifier + ", " + "[mModifier] = "
					+ mModifier + ", " + "[mModifierToTModifier] = " + mModifierToTModifier + ", " + "[mTypeToTType] = "
					+ mTypeToTType + ", " + "[tMember] = " + tMember + ", " + "[defToMember] = " + defToMember + ".");
		}
		InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mDefinition,
				tModifier, mModifier, mModifierToTModifier, tMember);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				tInterface, mInterface, mDefinition, tModifier, mModifier, mModifierToTModifier, mTypeToTType, tMember,
				defToMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_2_2_corematch_blackFBBBFFFB(mInterface, mDefinition, mModifier, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					tInterface, mInterface, mDefinition, mModifier, mTypeToTType, tMember, defToMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(tInterface, mInterface,
								mDefinition, mModifier, mTypeToTType, tMember, defToMember);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TInterface tInterface,
			...
			TypeToTAbstractType mTypeToTType, TMember tMember, MDefinitionToTMember defToMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tInterface, EObject mInterface,
			EObject mDefinition, EObject tModifier, EObject mModifier, EObject mModifierToTModifier,
			EObject mTypeToTType, EObject tMember, EObject defToMember) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_12_2_corematch_blackBFFBFBFB(tInterface, tModifier, tMember, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					tInterface, mInterface, mDefinition, tModifier, mTypeToTType, tMember, defToMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tInterface, mInterface,
								mDefinition, tModifier, mTypeToTType, tMember, defToMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tInterface__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tInterface____definedBy = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mTypeToTType__tInterface____target = (EMoflonEdge) result3_green[10];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TInterface tInterface,
			InterfaceDeclaration mInterface, MDefinition mDefinition, TModifier tModifier,
			TypeToTAbstractType mTypeToTType, TMember tMember, MDefinitionToTMember defToMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tInterface, EObject mInterface,
			EObject mDefinition, EObject tModifier, EObject mModifier, EObject mModifierToTModifier,
			EObject mTypeToTType, EObject tMember, EObject defToMember) {
		ruleresult.registerObject("tInterface", tInterface);
		ruleresult.registerObject("mInterface", mInterface);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tInterface, mInterface,
						mDefinition, tModifier, mModifier, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tInterface] = " + tInterface + ", " + "[mInterface] = " + mInterface + ", " + "[mDefinition] = "
		...
		if (InterfaceMemberImpl.pattern_InterfaceMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceMemberImpl
					.pattern_InterfaceMember_24_5_matchcorrcontext_blackBBBFBFBB(tInterface, mInterface, mDefinition,
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(tInterface, mInterface,
								mDefinition, tModifier, mModifier, tMember, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tInterface] = "
							+ tInterface + ", " + "[mInterface] = " + mInterface + ", " + "[mDefinition] = "
							+ mDefinition + ", " + "[tModifier] = " + tModifier + ", " + "[mModifier] = " + mModifier
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TInterface tInterface, InterfaceDeclaration mInterface, MDefinition mDefinition,
			TModifier tModifier, Modifier mModifier, TMember tMember, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tInterface, mInterface, mDefinition, mTypeToTType, tMember, defToMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tInterface] = " + tInterface + ", "
						+ "[mInterface] = " + mInterface + ", " + "[mDefinition] = " + mDefinition + ", "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(
						tInterface, mInterface, mDefinition, mTypeToTType, tMember, defToMember);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tInterface] = "
								+ tInterface + ", " + "[mInterface] = " + mInterface + ", " + "[mDefinition] = "
								+ mDefinition + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tMember] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TInterface tInterface,
			InterfaceDeclaration mInterface, MDefinition mDefinition, TypeToTAbstractType mTypeToTType, TMember tMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TINTERFACE_INTERFACEDECLARATION_MDEFINITION_MODIFIER_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TInterface) arguments.get(1),
					...
					(Modifier) arguments.get(4), (TypeToTAbstractType) arguments.get(5), (TMember) arguments.get(6),
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_INTERFACEDECLARATION_MDEFINITION_TMODIFIER_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TInterface) arguments.get(1),
					(InterfaceDeclaration) arguments.get(2), (MDefinition) arguments.get(3),
					(TModifier) arguments.get(4), (TypeToTAbstractType) arguments.get(5), (TMember) arguments.get(6),
					(MDefinitionToTMember) arguments.get(7));
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_8__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__TINTERFACE_INTERFACEDECLARATION_MDEFINITION_TMODIFIER_MODIFIER_TMEMBER_MATCH_MATCH:
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_INTERFACEDECLARATION_MDEFINITION_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpDefToMember instanceof MDefinitionToTMember) {
									...
									return new Object[] { tInterface, mInterface, mDefinition, mModifier, mTypeToTType,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
			TInterface tInterface, InterfaceDeclaration mInterface, MDefinition mDefinition, Modifier mModifier,
			TypeToTAbstractType mTypeToTType, TMember tMember, MDefinitionToTMember defToMember, InterfaceMember _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tInterface, mInterface, mDefinition, mModifier, mTypeToTType, tMember,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					tInterface, mInterface, mDefinition, mModifier, mTypeToTType, tMember, defToMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tInterface, EObject mInterface, EObject mDefinition,
			EObject tModifier, EObject mModifier, EObject mModifierToTModifier, EObject mTypeToTType, EObject tMember,
			EObject defToMember) {
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject tModifier, EObject mModifier, EObject mModifierToTModifier, EObject mTypeToTType, EObject tMember,
			EObject defToMember) {
		_this.registerObjects_FWD(ruleresult, tInterface, mInterface, mDefinition, tModifier, mModifier,
				mModifierToTModifier, mTypeToTType, tMember, defToMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_2_corematch_blackFBBBFFFB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInterface instanceof TInterface) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { tInterface, mInterface, mDefinition, mModifier, mTypeToTType,
						...
						if (mModifier.equals(mDefinition.getModifier())) {
							if (mDefinition.equals(defToMember.getSource())) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { tInterface, mInterface, mDefinition, mModifier,
											mTypeToTType, tMember, defToMember });
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(TInterface tInterface,
		...
		return new Object[] { tInterface, mInterface, mDefinition, mModifier, mTypeToTType, tMember, defToMember,
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TInterface tInterface, InterfaceDeclaration mInterface,
			MDefinition mDefinition, Modifier mModifier, TypeToTAbstractType mTypeToTType, TMember tMember,
			MDefinitionToTMember defToMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tInterface, mInterface, mDefinition,
				mModifier, mTypeToTType, tMember, defToMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInterface, mInterface, mDefinition, mModifier,
					mTypeToTType, tMember, defToMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInterface, mInterface, mDefinition, mModifier, mTypeToTType, tMember,
				defToMember);
					...
					if (tmpTModifier instanceof TModifier) {
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpTMember instanceof TMember) {
								...
								if (tmpDefToMember instanceof MDefinitionToTMember) {
									MDefinitionToTMember defToMember = (MDefinitionToTMember) tmpDefToMember;
									return new Object[] { tInterface, mInterface, mDefinition, tModifier, mTypeToTType,
											tMember, defToMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
			TInterface tInterface, InterfaceDeclaration mInterface, MDefinition mDefinition, TModifier tModifier,
			TypeToTAbstractType mTypeToTType, TMember tMember, MDefinitionToTMember defToMember, InterfaceMember _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tInterface, mInterface, mDefinition, tModifier, mTypeToTType, tMember,
						defToMember, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					tInterface, mInterface, mDefinition, tModifier, mTypeToTType, tMember, defToMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject tModifier, EObject mModifier, EObject mModifierToTModifier, EObject mTypeToTType, EObject tMember,
			EObject defToMember) {
		_this.registerObjects_BWD(ruleresult, tInterface, mInterface, mDefinition, tModifier, mModifier,
				mModifierToTModifier, mTypeToTType, tMember, defToMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_12_2_corematch_blackBFFBFBFB(TInterface tInterface,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMInterface instanceof InterfaceDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tInterface, mInterface, mDefinition, tModifier, mTypeToTType,
								tMember, defToMember, match });
					}
					...
					if (mInterface.getBodyDeclarations().contains(mDefinition)) {
						if (mDefinition.equals(defToMember.getSource())) {
							if (tModifier.equals(tMember.getTModifier())) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { tInterface, mInterface, mDefinition, tModifier,
											mTypeToTType, tMember, defToMember });
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(TInterface tInterface,
		...
		tMember__tModifier____tModifier.setName(tMember__tModifier____tModifier_name_prime);
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		return new Object[] { tInterface, mInterface, mDefinition, tModifier, mTypeToTType, tMember, defToMember,
				isApplicableMatch, tInterface__tMember____defines, tMember__tInterface____definedBy,
				mTypeToTType__tInterface____target, mTypeToTType__mInterface____source,
				mInterface__mDefinition____bodyDeclarations, mDefinition__mInterface____abstractTypeDeclaration,
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TInterface tInterface, InterfaceDeclaration mInterface,
			MDefinition mDefinition, TModifier tModifier, TypeToTAbstractType mTypeToTType, TMember tMember,
			MDefinitionToTMember defToMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tInterface, mInterface, mDefinition,
				tModifier, mTypeToTType, tMember, defToMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInterface, mInterface, mDefinition, tModifier,
					mTypeToTType, tMember, defToMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInterface, mInterface, mDefinition, tModifier, mTypeToTType, tMember,
				defToMember);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_373790 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_373790)) {
				...
				if (tmpMDefinition instanceof MDefinition) {
					...
					if (tmpTModifier instanceof TModifier) {
						...
						if (tmpMModifier instanceof Modifier) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { tInterface, mInterface, mDefinition, tModifier, mModifier,
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(TInterface tInterface,
			InterfaceDeclaration mInterface, MDefinition mDefinition, TModifier tModifier, Modifier mModifier,
			TMember tMember, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tInterface, mInterface, mDefinition, tModifier, mModifier, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tInterface, mInterface, mDefinition, tModifier, mModifier, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tInterface, mInterface, mDefinition, tModifier, mModifier,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tInterface, mInterface, mDefinition, tModifier, mModifier, tMember,
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tInterface, mInterface, mDefinition, tModifier, mModifier, tMember, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_24_5_matchcorrcontext_blackBBBFBFBB(
			TInterface tInterface, InterfaceDeclaration mInterface, MDefinition mDefinition, TMember tMember,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mInterface.equals(mTypeToTType.getSource())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { tInterface, mInterface, mDefinition, mTypeToTType, tMember,
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(TInterface tInterface,
			InterfaceDeclaration mInterface, MDefinition mDefinition, TModifier tModifier, Modifier mModifier,
			TMember tMember, CCMatch ccMatch) {
		return new Object[] { tInterface, mInterface, mDefinition, tModifier, mModifier, tMember, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_42660 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_42660)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tInterface, mInterface, mDefinition,
				mTypeToTType, tMember, defToMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInterface, mInterface, mDefinition, mTypeToTType,
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_29_3_solveCSP_binding = pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInterface, mInterface, mDefinition, mTypeToTType, tMember, defToMember,
				ruleResult);
	...
	public static final Object[] pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(TInterface tInterface,
			InterfaceDeclaration mInterface, MDefinition mDefinition, TypeToTAbstractType mTypeToTType, TMember tMember,
			MDefinitionToTMember defToMember) {
		return new Object[] { tInterface, mInterface, mDefinition, mTypeToTType, tMember, defToMember };
	}

	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(TInterface tInterface,
			InterfaceDeclaration mInterface, MDefinition mDefinition, TypeToTAbstractType mTypeToTType, TMember tMember,
			MDefinitionToTMember defToMember, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tInterface, mInterface, mDefinition, mTypeToTType, tMember, defToMember, ruleResult };
	}
