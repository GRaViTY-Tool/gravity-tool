...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mModifier, tInterface, tModifier, mDefinition, mModifierToTModifier, mInterface,
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mModifier,
				tModifier, mDefinition, mModifierToTModifier, tMember);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mModifier, tInterface, tModifier, mDefinition, mModifierToTModifier, mInterface, mTypeToTType,
				defToMember, tMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl.pattern_InterfaceMember_2_2_corematch_blackBFBBFFFB(mModifier,
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					mModifier, tInterface, mDefinition, mInterface, mTypeToTType, defToMember, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mModifier, tInterface,
								mDefinition, mInterface, mTypeToTType, defToMember, tMember);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Modifier mModifier, TInterface tInterface,
			MDefinition mDefinition, InterfaceDeclaration mInterface, TypeToTAbstractType mTypeToTType,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject tInterface,
			EObject tModifier, EObject mDefinition, EObject mModifierToTModifier, EObject mInterface,
			EObject mTypeToTType, EObject defToMember, EObject tMember) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					tInterface, tModifier, mDefinition, mInterface, mTypeToTType, defToMember, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TInterface tInterface,
			TModifier tModifier, MDefinition mDefinition, InterfaceDeclaration mInterface,
			TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember, TMember tMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mModifier, EObject tInterface,
			EObject tModifier, EObject mDefinition, EObject mModifierToTModifier, EObject mInterface,
			EObject mTypeToTType, EObject defToMember, EObject tMember) {
		ruleresult.registerObject("mModifier", mModifier);
		ruleresult.registerObject("tInterface", tInterface);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_206(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_223(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mModifier, tInterface, tModifier,
						mDefinition, mInterface, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mModifier] = " + mModifier + ", " + "[tInterface] = " + tInterface + ", " + "[tModifier] = "
					+ tModifier + ", " + "[mDefinition] = " + mDefinition + ", " + "[mInterface] = " + mInterface + ", "
		...
		if (InterfaceMemberImpl.pattern_InterfaceMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceMemberImpl
					.pattern_InterfaceMember_24_5_matchcorrcontext_blackBBBFFBBB(tInterface, mDefinition, mInterface,
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(mModifier, tInterface,
								tModifier, mDefinition, mInterface, tMember, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Modifier mModifier, TInterface tInterface, TModifier tModifier,
			MDefinition mDefinition, InterfaceDeclaration mInterface, TMember tMember, Match sourceMatch,
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tInterface, mDefinition, mInterface, mTypeToTType, defToMember, tMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tInterface] = " + tInterface + ", "
						+ "[mDefinition] = " + mDefinition + ", " + "[mInterface] = " + mInterface + ", "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(
						tInterface, mDefinition, mInterface, mTypeToTType, defToMember, tMember);
				if (result5_black != null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_TINTERFACE_MDEFINITION_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TMEMBER:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_TMODIFIER_MDEFINITION_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TMEMBER:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_206__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_206((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_223__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__MODIFIER_TINTERFACE_TMODIFIER_MDEFINITION_INTERFACEDECLARATION_TMEMBER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Modifier) arguments.get(0), (TInterface) arguments.get(1),
					(TModifier) arguments.get(2), (MDefinition) arguments.get(3),
					(InterfaceDeclaration) arguments.get(4), (TMember) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_MDEFINITION_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TMEMBER_MODELGENERATORRULERESULT:
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTMember instanceof TMember) {
									...
									return new Object[] { mModifier, tInterface, mDefinition, mInterface, mTypeToTType,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(Modifier mModifier,
			...
			TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember, TMember tMember, InterfaceMember _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, tInterface, mDefinition, mInterface, mTypeToTType, defToMember,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, tInterface, mDefinition, mInterface, mTypeToTType, defToMember, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifier, EObject tInterface, EObject tModifier, EObject mDefinition,
			EObject mModifierToTModifier, EObject mInterface, EObject mTypeToTType, EObject defToMember,
			EObject tMember) {
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mModifierToTModifier, EObject mInterface, EObject mTypeToTType, EObject defToMember,
			EObject tMember) {
		_this.registerObjects_FWD(ruleresult, mModifier, tInterface, tModifier, mDefinition, mModifierToTModifier,
				mInterface, mTypeToTType, defToMember, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_2_corematch_blackBFBBFFFB(Modifier mModifier,
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTInterface instanceof TInterface) {
						TInterface tInterface = (TInterface) tmpTInterface;
						_result.add(new Object[] { mModifier, tInterface, mDefinition, mInterface, mTypeToTType,
						...
						if (tMember.equals(defToMember.getTarget())) {
							if (mInterface.getBodyDeclarations().contains(mDefinition)) {
								if (mInterface.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { mModifier, tInterface, mDefinition, mInterface,
											mTypeToTType, defToMember, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(Modifier mModifier,
		...
		return new Object[] { mModifier, tInterface, mDefinition, mInterface, mTypeToTType, defToMember, tMember,
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, tInterface, mDefinition, mInterface,
					mTypeToTType, defToMember, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, tInterface, mDefinition, mInterface, mTypeToTType, defToMember,
				tMember);
					...
					if (tmpMInterface instanceof InterfaceDeclaration) {
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpTMember instanceof TMember) {
									TMember tMember = (TMember) tmpTMember;
									return new Object[] { tInterface, tModifier, mDefinition, mInterface, mTypeToTType,
											defToMember, tMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tInterface, tModifier, mDefinition, mInterface, mTypeToTType, defToMember,
						tMember, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					tInterface, tModifier, mDefinition, mInterface, mTypeToTType, defToMember, tMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mModifierToTModifier, EObject mInterface, EObject mTypeToTType, EObject defToMember,
			EObject tMember) {
		_this.registerObjects_BWD(ruleresult, mModifier, tInterface, tModifier, mDefinition, mModifierToTModifier,
				mInterface, mTypeToTType, defToMember, tMember);
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMInterface instanceof InterfaceDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tInterface, tModifier, mDefinition, mInterface, mTypeToTType,
								defToMember, tMember, match });
					}
				...
				if (mDefinition.equals(defToMember.getSource())) {
					if (tModifier.equals(tMember.getTModifier())) {
						if (tMember.equals(defToMember.getTarget())) {
							if (mInterface.getBodyDeclarations().contains(mDefinition)) {
								if (mInterface.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { tInterface, tModifier, mDefinition, mInterface,
											mTypeToTType, defToMember, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(TInterface tInterface,
		...
		mDefinition__mInterface____abstractTypeDeclaration
				.setName(mDefinition__mInterface____abstractTypeDeclaration_name_prime);
		mTypeToTType__mInterface____source.setName(mTypeToTType__mInterface____source_name_prime);
		return new Object[] { tInterface, tModifier, mDefinition, mInterface, mTypeToTType, defToMember, tMember,
				isApplicableMatch, tInterface__tMember____defines, tMember__tInterface____definedBy,
				mTypeToTType__tInterface____target, defToMember__mDefinition____source, tMember__tModifier____tModifier,
				defToMember__tMember____target, mInterface__mDefinition____bodyDeclarations,
				mDefinition__mInterface____abstractTypeDeclaration, mTypeToTType__mInterface____source };
	}

	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TInterface tInterface, TModifier tModifier, MDefinition mDefinition,
			InterfaceDeclaration mInterface, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember,
			TMember tMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tInterface, tModifier, mDefinition,
				mInterface, mTypeToTType, defToMember, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInterface, tModifier, mDefinition, mInterface,
					mTypeToTType, defToMember, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInterface, tModifier, mDefinition, mInterface, mTypeToTType, defToMember,
				tMember);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_226357 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_226357)) {
				...
				if (tmpTModifier instanceof TModifier) {
					...
					if (tmpMDefinition instanceof MDefinition) {
						...
						if (tmpMInterface instanceof InterfaceDeclaration) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { mModifier, tInterface, tModifier, mDefinition, mInterface,
										tMember, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(Modifier mModifier,
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mModifier, tInterface, tModifier, mDefinition, mInterface, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mModifier, tInterface, tModifier, mDefinition, mInterface, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
			Modifier mModifier, TInterface tInterface, TModifier tModifier, MDefinition mDefinition,
			InterfaceDeclaration mInterface, TMember tMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mModifier, tInterface, tModifier, mDefinition, mInterface,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mModifier, tInterface, tModifier, mDefinition, mInterface, tMember,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mModifier, tInterface, tModifier, mDefinition, mInterface, tMember, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_24_5_matchcorrcontext_blackBBBFFBBB(
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mInterface.equals(mTypeToTType.getSource())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { tInterface, mDefinition, mInterface, mTypeToTType, defToMember,
									tMember, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(Modifier mModifier,
			TInterface tInterface, TModifier tModifier, MDefinition mDefinition, InterfaceDeclaration mInterface,
			TMember tMember, CCMatch ccMatch) {
		return new Object[] { mModifier, tInterface, tModifier, mDefinition, mInterface, tMember, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_331000 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_331000)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tInterface, mDefinition, mInterface,
				mTypeToTType, defToMember, tMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInterface, mDefinition, mInterface, mTypeToTType,
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_29_3_solveCSP_binding = pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInterface, mDefinition, mInterface, mTypeToTType, defToMember, tMember,
				ruleResult);
	...
	public static final Object[] pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(TInterface tInterface,
		...
		return new Object[] { tInterface, mDefinition, mInterface, mTypeToTType, defToMember, tMember };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(TInterface tInterface,
		...
		return new Object[] { tInterface, mDefinition, mInterface, mTypeToTType, defToMember, tMember, ruleResult };
	}
