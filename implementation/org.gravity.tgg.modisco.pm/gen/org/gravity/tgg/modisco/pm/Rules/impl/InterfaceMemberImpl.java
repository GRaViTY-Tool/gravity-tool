...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mInterface, mModifier, mTypeToTType, tInterface, mModifierToTModifier, defToMember,
				tModifier, mDefinition, tMember);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mModifier,
				mModifierToTModifier, tModifier, mDefinition, tMember);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mInterface, mModifier, mTypeToTType, tInterface, mModifierToTModifier, defToMember, tModifier,
				mDefinition, tMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_2_2_corematch_blackBBFFFBFB(mInterface, mModifier, mDefinition, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					mInterface, mModifier, mTypeToTType, tInterface, defToMember, mDefinition, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mInterface, mModifier,
								mTypeToTType, tInterface, defToMember, mDefinition, tMember);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface,
			Modifier mModifier, TypeToTAbstractType mTypeToTType, TInterface tInterface,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mInterface, EObject mModifier,
			EObject mTypeToTType, EObject tInterface, EObject mModifierToTModifier, EObject defToMember,
			EObject tModifier, EObject mDefinition, EObject tMember) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = InterfaceMemberImpl
				.pattern_InterfaceMember_11_1_performtransformation_greenFFBBB(tModifier, mDefinition, csp);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_12_2_corematch_blackFFBFBFBB(tInterface, tModifier, tMember, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					mInterface, mTypeToTType, tInterface, defToMember, tModifier, mDefinition, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mInterface, mTypeToTType,
								tInterface, defToMember, tModifier, mDefinition, tMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tInterface__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tInterface____definedBy = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mTypeToTType__tInterface____target = (EMoflonEdge) result3_green[10];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface,
			TypeToTAbstractType mTypeToTType, TInterface tInterface, MDefinitionToTMember defToMember,
			TModifier tModifier, MDefinition mDefinition, TMember tMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mInterface, EObject mModifier,
			EObject mTypeToTType, EObject tInterface, EObject mModifierToTModifier, EObject defToMember,
			EObject tModifier, EObject mDefinition, EObject tMember) {
		ruleresult.registerObject("mInterface", mInterface);
		ruleresult.registerObject("mModifier", mModifier);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_67(EMoflonEdge _edge_tModifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mInterface, mModifier,
						tInterface, tModifier, mDefinition, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mInterface] = " + mInterface + ", " + "[mModifier] = " + mModifier + ", " + "[tInterface] = "
		...
		if (InterfaceMemberImpl.pattern_InterfaceMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceMemberImpl
					.pattern_InterfaceMember_24_5_matchcorrcontext_blackBFBFBBBB(mInterface, tInterface, mDefinition,
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(mInterface, mModifier,
								tInterface, tModifier, mDefinition, tMember, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mInterface] = "
							+ mInterface + ", " + "[mModifier] = " + mModifier + ", " + "[tInterface] = " + tInterface
							+ ", " + "[tModifier] = " + tModifier + ", " + "[mDefinition] = " + mDefinition + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(InterfaceDeclaration mInterface, Modifier mModifier, TInterface tInterface,
			TModifier tModifier, MDefinition mDefinition, TMember tMember, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mInterface, mTypeToTType, tInterface, defToMember, mDefinition, tMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mInterface] = " + mInterface + ", "
						+ "[mTypeToTType] = " + mTypeToTType + ", " + "[tInterface] = " + tInterface + ", "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(
						mInterface, mTypeToTType, tInterface, defToMember, mDefinition, tMember);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mInterface] = "
								+ mInterface + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tInterface] = "
								+ tInterface + ", " + "[defToMember] = " + defToMember + ", " + "[mDefinition] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_MODIFIER_TYPETOTABSTRACTTYPE_TINTERFACE_MDEFINITIONTOTMEMBER_MDEFINITION_TMEMBER:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TINTERFACE_MDEFINITIONTOTMEMBER_TMODIFIER_MDEFINITION_TMEMBER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TInterface) arguments.get(3), (MDefinitionToTMember) arguments.get(4),
					(TModifier) arguments.get(5), (MDefinition) arguments.get(6), (TMember) arguments.get(7));
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_67__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_67((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_70__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__INTERFACEDECLARATION_MODIFIER_TINTERFACE_TMODIFIER_MDEFINITION_TMEMBER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((InterfaceDeclaration) arguments.get(0), (Modifier) arguments.get(1),
					(TInterface) arguments.get(2), (TModifier) arguments.get(3), (MDefinition) arguments.get(4),
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TINTERFACE_MDEFINITIONTOTMEMBER_MDEFINITION_TMEMBER_MODELGENERATORRULERESULT:
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpTMember instanceof TMember) {
									...
									return new Object[] { mInterface, mModifier, mTypeToTType, tInterface, defToMember,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
			InterfaceDeclaration mInterface, Modifier mModifier, TypeToTAbstractType mTypeToTType,
			TInterface tInterface, MDefinitionToTMember defToMember, MDefinition mDefinition, TMember tMember,
			InterfaceMember _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mInterface, mModifier, mTypeToTType, tInterface, defToMember, mDefinition,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					mInterface, mModifier, mTypeToTType, tInterface, defToMember, mDefinition, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mInterface, EObject mModifier, EObject mTypeToTType,
			EObject tInterface, EObject mModifierToTModifier, EObject defToMember, EObject tModifier,
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mModifier, EObject mModifierToTModifier, EObject tModifier,
			EObject mDefinition, EObject tMember) {
		...
		return new Object[] { ruleresult, mModifier, mModifierToTModifier, tModifier, mDefinition, tMember,
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject tInterface, EObject mModifierToTModifier, EObject defToMember, EObject tModifier,
			EObject mDefinition, EObject tMember) {
		_this.registerObjects_FWD(ruleresult, mInterface, mModifier, mTypeToTType, tInterface, mModifierToTModifier,
				defToMember, tModifier, mDefinition, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_2_corematch_blackBBFFFBFB(
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTInterface instanceof TInterface) {
						TInterface tInterface = (TInterface) tmpTInterface;
						_result.add(new Object[] { mInterface, mModifier, mTypeToTType, tInterface, defToMember,
						...
						if (mInterface.equals(mTypeToTType.getSource())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (mInterface.getBodyDeclarations().contains(mDefinition)) {
									_result.add(new Object[] { mInterface, mModifier, mTypeToTType, tInterface,
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		mDefinition__mInterface____abstractTypeDeclaration
				.setName(mDefinition__mInterface____abstractTypeDeclaration_name_prime);
		return new Object[] { mInterface, mModifier, mTypeToTType, tInterface, defToMember, mDefinition, tMember,
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface, Modifier mModifier,
			TypeToTAbstractType mTypeToTType, TInterface tInterface, MDefinitionToTMember defToMember,
			MDefinition mDefinition, TMember tMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mInterface, mModifier, mTypeToTType,
				tInterface, defToMember, mDefinition, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInterface, mModifier, mTypeToTType, tInterface,
					defToMember, mDefinition, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mInterface, mModifier, mTypeToTType, tInterface, defToMember, mDefinition,
				tMember);
					...
					if (tmpDefToMember instanceof MDefinitionToTMember) {
						...
						if (tmpTModifier instanceof TModifier) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpTMember instanceof TMember) {
									TMember tMember = (TMember) tmpTMember;
									return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, tModifier,
											mDefinition, tMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
			...
			MDefinitionToTMember defToMember, TModifier tModifier, MDefinition mDefinition, TMember tMember,
			InterfaceMember _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, tModifier, mDefinition,
						tMember, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					mInterface, mTypeToTType, tInterface, defToMember, tModifier, mDefinition, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_greenFFBBB(TModifier tModifier,
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject tInterface, EObject mModifierToTModifier, EObject defToMember, EObject tModifier,
			EObject mDefinition, EObject tMember) {
		_this.registerObjects_BWD(ruleresult, mInterface, mModifier, mTypeToTType, tInterface, mModifierToTModifier,
				defToMember, tModifier, mDefinition, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_12_2_corematch_blackFFBFBFBB(TInterface tInterface,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMInterface instanceof InterfaceDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { mInterface, mTypeToTType, tInterface, defToMember, tModifier,
								mDefinition, tMember, match });
					}
				...
				if (mDefinition.equals(defToMember.getSource())) {
					if (mInterface.equals(mTypeToTType.getSource())) {
						if (tModifier.equals(tMember.getTModifier())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (mInterface.getBodyDeclarations().contains(mDefinition)) {
									_result.add(new Object[] { mInterface, mTypeToTType, tInterface, defToMember,
											tModifier, mDefinition, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mDefinition__mInterface____abstractTypeDeclaration
				.setName(mDefinition__mInterface____abstractTypeDeclaration_name_prime);
		return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, tModifier, mDefinition, tMember,
				isApplicableMatch, tInterface__tMember____defines, tMember__tInterface____definedBy,
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			...
			TInterface tInterface, MDefinitionToTMember defToMember, TModifier tModifier, MDefinition mDefinition,
			TMember tMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mInterface, mTypeToTType, tInterface,
				defToMember, tModifier, mDefinition, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInterface, mTypeToTType, tInterface, defToMember,
					tModifier, mDefinition, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mInterface, mTypeToTType, tInterface, defToMember, tModifier, mDefinition,
				tMember);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_348816 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_348816)) {
				...
				if (tmpTInterface instanceof TInterface) {
					...
					if (tmpTModifier instanceof TModifier) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { mInterface, mModifier, tInterface, tModifier, mDefinition,
										tMember, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mInterface, mModifier, tInterface, tModifier, mDefinition, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mInterface, mModifier, tInterface, tModifier, mDefinition, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
			InterfaceDeclaration mInterface, Modifier mModifier, TInterface tInterface, TModifier tModifier,
			MDefinition mDefinition, TMember tMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mInterface, mModifier, tInterface, tModifier, mDefinition,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mInterface, mModifier, tInterface, tModifier, mDefinition, tMember,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mInterface, mModifier, tInterface, tModifier, mDefinition, tMember, sourceMatch, targetMatch);
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mInterface.equals(mTypeToTType.getSource())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { mInterface, mTypeToTType, tInterface, defToMember, mDefinition,
									tMember, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mInterface, mModifier, tInterface, tModifier, mDefinition, tMember, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_694533 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_694533)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mInterface, mTypeToTType, tInterface,
				defToMember, mDefinition, tMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInterface, mTypeToTType, tInterface, defToMember,
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_29_3_solveCSP_binding = pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mInterface, mTypeToTType, tInterface, defToMember, mDefinition, tMember,
				ruleResult);
	...
	public static final Object[] pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(InterfaceDeclaration mInterface,
			TypeToTAbstractType mTypeToTType, TInterface tInterface, MDefinitionToTMember defToMember,
			MDefinition mDefinition, TMember tMember) {
		return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, mDefinition, tMember };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(InterfaceDeclaration mInterface,
		...
		return new Object[] { mInterface, mTypeToTType, tInterface, defToMember, mDefinition, tMember, ruleResult };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_greenFFFBBBB(MDefinition mDefinition,
		...
		return new Object[] { mModifier, mModifierToTModifier, tModifier, mDefinition, tMember, ruleResult, csp };
	}
