...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = InterfaceMemberImpl
				.pattern_InterfaceMember_1_1_performtransformation_greenBFFBB(mModifier, tMember, csp);
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mModifier, mInterface, tModifier, mTypeToTType, mModifierToTModifier, defToMember,
				tInterface, mDefinition, tMember);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mModifier,
				tModifier, mModifierToTModifier, mDefinition, tMember);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mModifier, mInterface, tModifier, mTypeToTType, mModifierToTModifier, defToMember, tInterface,
				mDefinition, tMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl.pattern_InterfaceMember_2_2_corematch_blackBBFFFBFB(mModifier,
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					mModifier, mInterface, mTypeToTType, defToMember, tInterface, mDefinition, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mModifier, mInterface,
								mTypeToTType, defToMember, tInterface, mDefinition, tMember);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Modifier mModifier,
			InterfaceDeclaration mInterface, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember,
			TInterface tInterface, MDefinition mDefinition, TMember tMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject mInterface,
			EObject tModifier, EObject mTypeToTType, EObject mModifierToTModifier, EObject defToMember,
			EObject tInterface, EObject mDefinition, EObject tMember) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_12_2_corematch_blackFBFFBFBB(tModifier, tInterface, tMember, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					mInterface, tModifier, mTypeToTType, defToMember, tInterface, mDefinition, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mInterface, tModifier,
								mTypeToTType, defToMember, tInterface, mDefinition, tMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mInterface__mDefinition____bodyDeclarations = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mDefinition__mInterface____abstractTypeDeclaration = (EMoflonEdge) result3_green[9];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mModifier, EObject mInterface,
			EObject tModifier, EObject mTypeToTType, EObject mModifierToTModifier, EObject defToMember,
			EObject tInterface, EObject mDefinition, EObject tMember) {
		ruleresult.registerObject("mModifier", mModifier);
		ruleresult.registerObject("mInterface", mInterface);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_671(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_688(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mModifier, mInterface, tModifier,
						tInterface, mDefinition, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mModifier] = " + mModifier + ", " + "[mInterface] = " + mInterface + ", " + "[tModifier] = "
					+ tModifier + ", " + "[tInterface] = " + tInterface + ", " + "[mDefinition] = " + mDefinition + ", "
		...
		if (InterfaceMemberImpl.pattern_InterfaceMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceMemberImpl
					.pattern_InterfaceMember_24_5_matchcorrcontext_blackBFFBBBBB(mInterface, tInterface, mDefinition,
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(mModifier, mInterface,
								tModifier, tInterface, mDefinition, tMember, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModifier] = "
							+ mModifier + ", " + "[mInterface] = " + mInterface + ", " + "[tModifier] = " + tModifier
							+ ", " + "[tInterface] = " + tInterface + ", " + "[mDefinition] = " + mDefinition + ", "
							+ "[tMember] = " + tMember + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				InterfaceMemberImpl.pattern_InterfaceMember_24_6_createcorrespondence_greenBBFB(mModifier, tModifier,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Modifier mModifier, InterfaceDeclaration mInterface, TModifier tModifier,
			TInterface tInterface, MDefinition mDefinition, TMember tMember, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mInterface, mTypeToTType, defToMember, tInterface, mDefinition, tMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mInterface] = " + mInterface + ", "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(
						mInterface, mTypeToTType, defToMember, tInterface, mDefinition, tMember);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mInterface] = "
								+ mInterface + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[defToMember] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface,
			TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember, TInterface tInterface,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TINTERFACE_MDEFINITION_TMEMBER:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TMODIFIER_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TINTERFACE_MDEFINITION_TMEMBER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (TModifier) arguments.get(2),
					(TypeToTAbstractType) arguments.get(3), (MDefinitionToTMember) arguments.get(4),
					(TInterface) arguments.get(5), (MDefinition) arguments.get(6), (TMember) arguments.get(7));
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_671__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_671((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_688__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_688((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__MODIFIER_INTERFACEDECLARATION_TMODIFIER_TINTERFACE_MDEFINITION_TMEMBER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Modifier) arguments.get(0), (InterfaceDeclaration) arguments.get(1),
					(TModifier) arguments.get(2), (TInterface) arguments.get(3), (MDefinition) arguments.get(4),
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_MDEFINITIONTOTMEMBER_TINTERFACE_MDEFINITION_TMEMBER_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(MDefinitionToTMember) arguments.get(3), (TInterface) arguments.get(4),
						...
						if (tmpTInterface instanceof TInterface) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpTMember instanceof TMember) {
									...
									return new Object[] { mModifier, mInterface, mTypeToTType, defToMember, tInterface,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(Modifier mModifier,
			InterfaceDeclaration mInterface, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember,
			TInterface tInterface, MDefinition mDefinition, TMember tMember, InterfaceMember _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, mInterface, mTypeToTType, defToMember, tInterface, mDefinition,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, mInterface, mTypeToTType, defToMember, tInterface, mDefinition, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_greenBFFBB(Modifier mModifier,
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifier, EObject mInterface, EObject tModifier,
			EObject mTypeToTType, EObject mModifierToTModifier, EObject defToMember, EObject tInterface,
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mTypeToTType, EObject mModifierToTModifier, EObject defToMember, EObject tInterface,
			EObject mDefinition, EObject tMember) {
		_this.registerObjects_FWD(ruleresult, mModifier, mInterface, tModifier, mTypeToTType, mModifierToTModifier,
				defToMember, tInterface, mDefinition, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_2_corematch_blackBBFFFBFB(Modifier mModifier,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInterface instanceof TInterface) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { mModifier, mInterface, mTypeToTType, defToMember, tInterface,
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(Modifier mModifier,
			InterfaceDeclaration mInterface, TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember,
			TInterface tInterface, MDefinition mDefinition, TMember tMember) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
						...
						if (mDefinition.equals(defToMember.getSource())) {
							if (mModifier.equals(mDefinition.getModifier())) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { mModifier, mInterface, mTypeToTType, defToMember,
											tInterface, mDefinition, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(Modifier mModifier,
		...
		return new Object[] { mModifier, mInterface, mTypeToTType, defToMember, tInterface, mDefinition, tMember,
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			...
			TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember, TInterface tInterface,
			MDefinition mDefinition, TMember tMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModifier, mInterface, mTypeToTType,
				defToMember, tInterface, mDefinition, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, mInterface, mTypeToTType, defToMember,
					tInterface, mDefinition, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, mInterface, mTypeToTType, defToMember, tInterface, mDefinition,
				tMember);
					...
					if (tmpDefToMember instanceof MDefinitionToTMember) {
						...
						if (tmpTInterface instanceof TInterface) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpTMember instanceof TMember) {
									TMember tMember = (TMember) tmpTMember;
									return new Object[] { mInterface, tModifier, mTypeToTType, defToMember, tInterface,
											mDefinition, tMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
			InterfaceDeclaration mInterface, TModifier tModifier, TypeToTAbstractType mTypeToTType,
			MDefinitionToTMember defToMember, TInterface tInterface, MDefinition mDefinition, TMember tMember,
			InterfaceMember _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mInterface, tModifier, mTypeToTType, defToMember, tInterface, mDefinition,
						tMember, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					mInterface, tModifier, mTypeToTType, defToMember, tInterface, mDefinition, tMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject mTypeToTType, EObject mModifierToTModifier, EObject defToMember, EObject tInterface,
			EObject mDefinition, EObject tMember) {
		_this.registerObjects_BWD(ruleresult, mModifier, mInterface, tModifier, mTypeToTType, mModifierToTModifier,
				defToMember, tInterface, mDefinition, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_12_2_corematch_blackFBFFBFBB(TModifier tModifier,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMInterface instanceof InterfaceDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { mInterface, tModifier, mTypeToTType, defToMember, tInterface,
								mDefinition, tMember, match });
					}
						...
						if (mDefinition.equals(defToMember.getSource())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (tModifier.equals(tMember.getTModifier())) {
									_result.add(new Object[] { mInterface, tModifier, mTypeToTType, defToMember,
											tInterface, mDefinition, tMember });
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		tMember__tModifier____tModifier.setName(tMember__tModifier____tModifier_name_prime);
		return new Object[] { mInterface, tModifier, mTypeToTType, defToMember, tInterface, mDefinition, tMember,
				isApplicableMatch, mInterface__mDefinition____bodyDeclarations,
				mDefinition__mInterface____abstractTypeDeclaration, mTypeToTType__mInterface____source,
				mTypeToTType__tInterface____target, tInterface__tMember____defines, tMember__tInterface____definedBy,
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface, TModifier tModifier,
			TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember, TInterface tInterface,
			MDefinition mDefinition, TMember tMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mInterface, tModifier, mTypeToTType,
				defToMember, tInterface, mDefinition, tMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInterface, tModifier, mTypeToTType, defToMember,
					tInterface, mDefinition, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mInterface, tModifier, mTypeToTType, defToMember, tInterface, mDefinition,
				tMember);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_574273 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_574273)) {
				...
				if (tmpTModifier instanceof TModifier) {
					...
					if (tmpTInterface instanceof TInterface) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { mModifier, mInterface, tModifier, tInterface, mDefinition,
										tMember, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(Modifier mModifier,
			InterfaceDeclaration mInterface, TModifier tModifier, TInterface tInterface, MDefinition mDefinition,
			TMember tMember, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mModifier, mInterface, tModifier, tInterface, mDefinition, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			Modifier mModifier = (Modifier) result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding[0];
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mModifier, mInterface, tModifier, tInterface, mDefinition, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
			Modifier mModifier, InterfaceDeclaration mInterface, TModifier tModifier, TInterface tInterface,
			MDefinition mDefinition, TMember tMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mModifier, mInterface, tModifier, tInterface, mDefinition,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mModifier, mInterface, tModifier, tInterface, mDefinition, tMember,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mModifier, mInterface, tModifier, tInterface, mDefinition, tMember, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_24_5_matchcorrcontext_blackBFFBBBBB(
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tInterface.equals(mTypeToTType.getTarget())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { mInterface, mTypeToTType, defToMember, tInterface, mDefinition,
									tMember, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(Modifier mModifier,
			InterfaceDeclaration mInterface, TModifier tModifier, TInterface tInterface, MDefinition mDefinition,
			TMember tMember, CCMatch ccMatch) {
		return new Object[] { mModifier, mInterface, tModifier, tInterface, mDefinition, tMember, ccMatch };
	}

	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_greenBBFB(Modifier mModifier,
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_201961 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_201961)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, InterfaceDeclaration mInterface, TypeToTAbstractType mTypeToTType,
			MDefinitionToTMember defToMember, TInterface tInterface, MDefinition mDefinition, TMember tMember,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mInterface, mTypeToTType,
				defToMember, tInterface, mDefinition, tMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInterface, mTypeToTType, defToMember, tInterface,
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_29_3_solveCSP_binding = pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mInterface, mTypeToTType, defToMember, tInterface, mDefinition, tMember,
				ruleResult);
	...
	public static final Object[] pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(InterfaceDeclaration mInterface,
			TypeToTAbstractType mTypeToTType, MDefinitionToTMember defToMember, TInterface tInterface,
			MDefinition mDefinition, TMember tMember) {
		return new Object[] { mInterface, mTypeToTType, defToMember, tInterface, mDefinition, tMember };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(InterfaceDeclaration mInterface,
		...
		return new Object[] { mInterface, mTypeToTType, defToMember, tInterface, mDefinition, tMember, ruleResult };
	}
