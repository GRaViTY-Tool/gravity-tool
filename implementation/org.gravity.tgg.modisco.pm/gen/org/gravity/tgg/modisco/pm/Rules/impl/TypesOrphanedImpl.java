...
public class TypesOrphanedImpl extends AbstractRuleImpl implements TypesOrphaned {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypesOrphanedImpl.pattern_TypesOrphaned_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModelToTypeGraph] = " + mModelToTypeGraph + ", " + "[mModel] = " + mModel + ", "
					+ "[pg] = " + pg + ", " + "[mType] = " + mType + ", " + "[tType] = " + tType + ", "
					+ "[mTypeToTType] = " + mTypeToTType + ".");
		}
		TypesOrphanedImpl.pattern_TypesOrphaned_1_3_bookkeepingforedges_greenBBBBBFFF(ruleresult, mModel, pg, mType,
				tType);
		...
		TypesOrphanedImpl.pattern_TypesOrphaned_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypesOrphanedImpl.pattern_TypesOrphaned_2_2_corematch_blackFBFBFFB(mModel, mType,
				match)) {
			...
			// ForEach 
			for (Object[] result3_black : TypesOrphanedImpl.pattern_TypesOrphaned_2_3_findcontext_blackBBBBBB(
					mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType)) {
				...
				Object[] result4_bindingAndBlack = TypesOrphanedImpl
						.pattern_TypesOrphaned_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ModelToTypeGraph mModelToTypeGraph,
			Model mModel, TypeGraph pg, MClass mType, TClass tType, TypeToTAbstractType mTypeToTType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mModel, EObject pg,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		TypesOrphanedImpl.pattern_TypesOrphaned_11_3_bookkeepingforedges_greenBBBBBFFF(ruleresult, mModel, pg, mType,
				tType);
		//nothing EMoflonEdge mModel__mType____orphanTypes = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge pg__tType____ownedTypes = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge tType__pg____model = (EMoflonEdge) result3_green[7];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypesOrphanedImpl.pattern_TypesOrphaned_12_2_corematch_blackFFBFBFB(pg, tType,
				match)) {
			ModelToTypeGraph mModelToTypeGraph = (ModelToTypeGraph) result2_black[0];
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[5];
			// ForEach 
			for (Object[] result3_black : TypesOrphanedImpl.pattern_TypesOrphaned_12_3_findcontext_blackBBBBBB(
					mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType)) {
				...
				Object[] result4_bindingAndBlack = TypesOrphanedImpl
						.pattern_TypesOrphaned_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mModelToTypeGraph] = "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mModel, EObject pg,
			EObject mType, EObject tType, EObject mTypeToTType) {
		ruleresult.registerObject("mModelToTypeGraph", mModelToTypeGraph);
		ruleresult.registerObject("mModel", mModel);
		ruleresult.registerObject("pg", pg);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_12(EMoflonEdge _edge_ownedTypes) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_12(EMoflonEdge _edge_orphanTypes) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypesOrphanedImpl
				.pattern_TypesOrphaned_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mModel, pg, mType, tType,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mModel] = " + mModel + ", " + "[pg] = " + pg + ", " + "[mType] = " + mType + ", " + "[tType] = "
		...
		if (TypesOrphanedImpl.pattern_TypesOrphaned_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : TypesOrphanedImpl.pattern_TypesOrphaned_24_5_matchcorrcontext_blackFBBBBFBB(
					mModel, pg, mType, tType, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = TypesOrphanedImpl
						.pattern_TypesOrphaned_24_6_createcorrespondence_blackBBBBB(mModel, pg, mType, tType, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Model mModel, TypeGraph pg, MClass mType, TClass tType, Match sourceMatch,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : TypesOrphanedImpl
			...
			MClass mType = (MClass) result2_black[5];
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[6];
			TClass tType = (TClass) result2_black[7];

			Object[] result3_bindingAndBlack = TypesOrphanedImpl
					.pattern_TypesOrphaned_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mModelToTypeGraph] = "
						+ mModelToTypeGraph + ", " + "[mModel] = " + mModel + ", " + "[pg] = " + pg + ", "
						+ "[mType] = " + mType + ", " + "[tType] = " + tType + ", " + "[mTypeToTType] = " + mTypeToTType
			...
			if (TypesOrphanedImpl.pattern_TypesOrphaned_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = TypesOrphanedImpl.pattern_TypesOrphaned_29_5_checknacs_blackBBBBBB(
						mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType);
				if (result5_black != null) {

					Object[] result6_black = TypesOrphanedImpl.pattern_TypesOrphaned_29_6_perform_blackBBBBBBB(
							mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType, ruleResult);
					if (result6_black == null) {
					...
					TypesOrphanedImpl.pattern_TypesOrphaned_29_6_perform_greenBBBBB(mModel, pg, mType, tType,
							ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ModelToTypeGraph mModelToTypeGraph,
			Model mModel, TypeGraph pg, MClass mType, TClass tType, TypeToTAbstractType mTypeToTType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_MODEL_TYPEGRAPH_MCLASS_TCLASS_TYPETOTABSTRACTTYPE:
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_MODEL_TYPEGRAPH_MCLASS_TCLASS_TYPETOTABSTRACTTYPE:
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPROPRIATE_BWD_EMOFLON_EDGE_12__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_12((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPES_ORPHANED___IS_APPROPRIATE_FWD_EMOFLON_EDGE_12__EMOFLONEDGE:
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPLICABLE_SOLVE_CSP_CC__MODEL_TYPEGRAPH_MCLASS_TCLASS_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Model) arguments.get(0), (TypeGraph) arguments.get(1),
					(MClass) arguments.get(2), (TClass) arguments.get(3), (Match) arguments.get(4),
		...
		case RulesPackage.TYPES_ORPHANED___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_MODEL_TYPEGRAPH_MCLASS_TCLASS_TYPETOTABSTRACTTYPE_MODELGENERATORRULERESULT:
					...
					if (tmpMType instanceof MClass) {
						...
						if (tmpTType instanceof TClass) {
							...
							if (tmpMTypeToTType instanceof TypeToTAbstractType) {
								...
								return new Object[] { mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_TypesOrphaned_1_1_performtransformation_blackBBBBBBFBB(
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg, MClass mType, TClass tType,
			TypeToTAbstractType mTypeToTType, TypesOrphaned _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypesOrphaned_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypesOrphaned_1_1_performtransformation_binding != null) {
			...
			TClass tType = (TClass) result_pattern_TypesOrphaned_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_TypesOrphaned_1_1_performtransformation_black = pattern_TypesOrphaned_1_1_performtransformation_blackBBBBBBFBB(
					mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType, _this, isApplicableMatch);
	...
	public static final Object[] pattern_TypesOrphaned_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mModel, EObject pg, EObject mType,
			EObject tType, EObject mTypeToTType) {
															...
															if (!mTypeToTType.equals(pg)) {
																if (!mTypeToTType.equals(tType)) {
																	return new Object[] { ruleresult, mModelToTypeGraph,
																			mModel, pg, mType, tType, mTypeToTType };
																}
															}
														}
													}
	...
	public static final Object[] pattern_TypesOrphaned_1_3_bookkeepingforedges_greenBBBBBFFF(
			PerformRuleResult ruleresult, EObject mModel, EObject pg, EObject mType, EObject tType) {
		EMoflonEdge mModel__mType____orphanTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mModel, pg, mType, tType, mModel__mType____orphanTypes,
	...
	public static final void pattern_TypesOrphaned_1_5_registerobjects_expressionBBBBBBBB(TypesOrphaned _this,
			PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mModel, EObject pg, EObject mType,
			EObject tType, EObject mTypeToTType) {
		_this.registerObjects_FWD(ruleresult, mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType);
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_2_2_corematch_blackFBFBFFB(Model mModel, MClass mType,
			Match match) {
		...
		for (ModelToTypeGraph mModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (pg != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTType instanceof TClass) {
						TClass tType = (TClass) tmpTType;
						_result.add(new Object[] { mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType, match });
					}
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_2_3_findcontext_blackBBBBBB(
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg, MClass mType, TClass tType,
				...
				if (mModel.getOrphanTypes().contains(mType)) {
					if (tType.equals(mTypeToTType.getTarget())) {
						if (mType.equals(mTypeToTType.getSource())) {
							_result.add(new Object[] { mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType });
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypesOrphaned_2_3_findcontext_greenBBBBBBFFFFFF(
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg, MClass mType, TClass tType,
			TypeToTAbstractType mTypeToTType) {
		...
		return new Object[] { mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType, isApplicableMatch,
				mModelToTypeGraph__mModel____source, mModelToTypeGraph__pg____target, mModel__mType____orphanTypes,
	...
	public static final Object[] pattern_TypesOrphaned_2_4_solveCSP_bindingFBBBBBBBB(TypesOrphaned _this,
			...
			MClass mType, TClass tType, TypeToTAbstractType mTypeToTType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModelToTypeGraph, mModel, pg, mType,
				tType, mTypeToTType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModelToTypeGraph, mModel, pg, mType, tType,
					mTypeToTType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesOrphaned_2_4_solveCSP_bindingAndBlackFBBBBBBBB(TypesOrphaned _this,
		...
		Object[] result_pattern_TypesOrphaned_2_4_solveCSP_binding = pattern_TypesOrphaned_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType);
	...
	public static final Object[] pattern_TypesOrphaned_11_1_performtransformation_blackBBBBBBFBB(
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg, MClass mType, TClass tType,
			TypeToTAbstractType mTypeToTType, TypesOrphaned _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
	...
	public static final Object[] pattern_TypesOrphaned_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypesOrphaned_11_1_performtransformation_binding != null) {
			...
			TClass tType = (TClass) result_pattern_TypesOrphaned_11_1_performtransformation_binding[4];
	...
	public static final void pattern_TypesOrphaned_11_5_registerobjects_expressionBBBBBBBB(TypesOrphaned _this,
			PerformRuleResult ruleresult, EObject mModelToTypeGraph, EObject mModel, EObject pg, EObject mType,
			EObject tType, EObject mTypeToTType) {
		_this.registerObjects_BWD(ruleresult, mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType);
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_12_2_corematch_blackFFBFBFB(TypeGraph pg, TClass tType,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_12_3_findcontext_blackBBBBBB(
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg, MClass mType, TClass tType,
			TypeToTAbstractType mTypeToTType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (mModel.equals(mModelToTypeGraph.getSource())) {
	...
	public static final Object[] pattern_TypesOrphaned_12_3_findcontext_greenBBBBBBFFFFFFF(
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg, MClass mType, TClass tType,
			TypeToTAbstractType mTypeToTType) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge mModelToTypeGraph__mModel____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		mTypeToTType__mType____source.setName(mTypeToTType__mType____source_name_prime);
		return new Object[] { mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType, isApplicableMatch,
				mModelToTypeGraph__mModel____source, mModelToTypeGraph__pg____target, mTypeToTType__tType____target,
	...
	public static final Object[] pattern_TypesOrphaned_12_4_solveCSP_bindingFBBBBBBBB(TypesOrphaned _this,
			IsApplicableMatch isApplicableMatch, ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg,
			MClass mType, TClass tType, TypeToTAbstractType mTypeToTType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mModelToTypeGraph, mModel, pg, mType,
				tType, mTypeToTType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModelToTypeGraph, mModel, pg, mType, tType,
		...
		if (tmpMModel instanceof Model) {
			...
			if (tmpPg instanceof TypeGraph) {
				...
				if (tmpMType instanceof MClass) {
					...
					if (tmpTType instanceof TClass) {
						TClass tType = (TClass) tmpTType;
						return new Object[] { mModel, pg, mType, tType, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_TypesOrphaned_24_2_matchsrctrgcontext_blackBBBBBB(Model mModel, TypeGraph pg,
			MClass mType, TClass tType, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_TypesOrphaned_24_3_solvecsp_bindingFBBBBBBB(TypesOrphaned _this, Model mModel,
			TypeGraph pg, MClass mType, TClass tType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mModel, pg, mType, tType, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mModel, pg, mType, tType, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesOrphaned_24_3_solvecsp_bindingAndBlackFBBBBBBB(TypesOrphaned _this,
			Model mModel, TypeGraph pg, MClass mType, TClass tType, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_TypesOrphaned_24_3_solvecsp_binding = pattern_TypesOrphaned_24_3_solvecsp_bindingFBBBBBBB(
				_this, mModel, pg, mType, tType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_24_5_matchcorrcontext_blackFBBBBFBB(Model mModel,
			TypeGraph pg, MClass mType, TClass tType, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (ModelToTypeGraph mModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypesOrphaned_24_6_createcorrespondence_blackBBBBB(Model mModel, TypeGraph pg,
			MClass mType, TClass tType, CCMatch ccMatch) {
		return new Object[] { mModel, pg, mType, tType, ccMatch };
	}
	...
	public static final Object[] pattern_TypesOrphaned_29_3_solveCSP_bindingFBBBBBBBBB(TypesOrphaned _this,
			IsApplicableMatch isApplicableMatch, ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg,
			MClass mType, TClass tType, TypeToTAbstractType mTypeToTType, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mModelToTypeGraph, mModel, pg, mType,
	...
	public static final Object[] pattern_TypesOrphaned_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(TypesOrphaned _this,
		...
		Object[] result_pattern_TypesOrphaned_29_3_solveCSP_binding = pattern_TypesOrphaned_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType, ruleResult);
	...
	public static final Object[] pattern_TypesOrphaned_29_5_checknacs_blackBBBBBB(ModelToTypeGraph mModelToTypeGraph,
			Model mModel, TypeGraph pg, MClass mType, TClass tType, TypeToTAbstractType mTypeToTType) {
		return new Object[] { mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType };
	}

	public static final Object[] pattern_TypesOrphaned_29_6_perform_blackBBBBBBB(ModelToTypeGraph mModelToTypeGraph,
			Model mModel, TypeGraph pg, MClass mType, TClass tType, TypeToTAbstractType mTypeToTType,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mModelToTypeGraph, mModel, pg, mType, tType, mTypeToTType, ruleResult };
	}

	public static final Object[] pattern_TypesOrphaned_29_6_perform_greenBBBBB(Model mModel, TypeGraph pg, MClass mType,
		...
		return new Object[] { mModel, pg, mType, tType, ruleResult };
	}
