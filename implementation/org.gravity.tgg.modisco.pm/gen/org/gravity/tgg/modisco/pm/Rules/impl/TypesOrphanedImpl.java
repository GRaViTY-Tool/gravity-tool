...
public class TypesOrphanedImpl extends AbstractRuleImpl implements TypesOrphaned {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypesOrphanedImpl.pattern_TypesOrphaned_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mType] = " + mType + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[pg] = " + pg
					+ ", " + "[tType] = " + tType + ", " + "[mModel] = " + mModel + ", " + "[mModelToTypeGraph] = "
					+ mModelToTypeGraph + ".");
		}
		TypesOrphanedImpl.pattern_TypesOrphaned_1_3_bookkeepingforedges_greenBBBBBFFF(ruleresult, mType, pg, tType,
				mModel);
		...
		TypesOrphanedImpl.pattern_TypesOrphaned_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mType,
				mTypeToTType, pg, tType, mModel, mModelToTypeGraph);
		...
		for (Object[] result2_black : TypesOrphanedImpl.pattern_TypesOrphaned_2_2_corematch_blackBFFFBFB(mType, mModel,
			...
			for (Object[] result3_black : TypesOrphanedImpl.pattern_TypesOrphaned_2_3_findcontext_blackBBBBBB(mType,
				...
				Object[] result3_green = TypesOrphanedImpl.pattern_TypesOrphaned_2_3_findcontext_greenBBBBBBFFFFFF(
						mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[mTypeToTType] = " + mTypeToTType + ", " + "[pg] = " + pg + ", " + "[tType] = " + tType
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MClass mType,
			TypeToTAbstractType mTypeToTType, TypeGraph pg, TClass tType, Model mModel,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType, EObject pg,
			EObject tType, EObject mModel, EObject mModelToTypeGraph) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		TypesOrphanedImpl.pattern_TypesOrphaned_11_3_bookkeepingforedges_greenBBBBBFFF(ruleresult, mType, pg, tType,
				mModel);
		//nothing EMoflonEdge pg__tType____ownedTypes = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge tType__pg____model = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mModel__mType____orphanTypes = (EMoflonEdge) result3_green[7];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypesOrphanedImpl.pattern_TypesOrphaned_12_2_corematch_blackFFBBFFB(pg, tType,
				match)) {
			...
			for (Object[] result3_black : TypesOrphanedImpl.pattern_TypesOrphaned_12_3_findcontext_blackBBBBBB(mType,
				...
				//nothing EMoflonEdge mModelToTypeGraph__mModel____source = (EMoflonEdge) result3_green[11];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType, EObject pg,
			EObject tType, EObject mModel, EObject mModelToTypeGraph) {
		ruleresult.registerObject("mType", mType);
		ruleresult.registerObject("mTypeToTType", mTypeToTType);
		ruleresult.registerObject("pg", pg);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_244(EMoflonEdge _edge_ownedTypes) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_254(EMoflonEdge _edge_orphanTypes) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypesOrphanedImpl
				.pattern_TypesOrphaned_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mType, pg, tType, mModel,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mType] = " + mType + ", " + "[pg] = " + pg + ", " + "[tType] = " + tType + ", " + "[mModel] = "
		...
		if (TypesOrphanedImpl.pattern_TypesOrphaned_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypesOrphanedImpl.pattern_TypesOrphaned_24_5_matchcorrcontext_blackBFBBBFBB(
					mType, pg, tType, mModel, sourceMatch, targetMatch)) {
				TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result5_black[1];
				ModelToTypeGraph mModelToTypeGraph = (ModelToTypeGraph) result5_black[5];
				Object[] result5_green = TypesOrphanedImpl.pattern_TypesOrphaned_24_5_matchcorrcontext_greenBBBBF(
						mTypeToTType, mModelToTypeGraph, sourceMatch, targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[4];

				Object[] result6_black = TypesOrphanedImpl
						.pattern_TypesOrphaned_24_6_createcorrespondence_blackBBBBB(mType, pg, tType, mModel, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MClass mType, TypeGraph pg, TClass tType, Model mModel, Match sourceMatch,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : TypesOrphanedImpl
			...
			ModelToTypeGraph mModelToTypeGraph = (ModelToTypeGraph) result2_black[6];
			...
			Object[] result3_bindingAndBlack = TypesOrphanedImpl
					.pattern_TypesOrphaned_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mType,
							mTypeToTType, pg, tType, mModel, mModelToTypeGraph, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mType] = " + mType + ", "
						+ "[mTypeToTType] = " + mTypeToTType + ", " + "[pg] = " + pg + ", " + "[tType] = " + tType
			...
			if (TypesOrphanedImpl.pattern_TypesOrphaned_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					TypesOrphanedImpl.pattern_TypesOrphaned_29_6_perform_greenBBBBB(mType, pg, tType, mModel,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MCLASS_TYPETOTABSTRACTTYPE_TYPEGRAPH_TCLASS_MODEL_MODELTOTYPEGRAPH:
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MCLASS_TYPETOTABSTRACTTYPE_TYPEGRAPH_TCLASS_MODEL_MODELTOTYPEGRAPH:
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPROPRIATE_BWD_EMOFLON_EDGE_244__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_244((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPES_ORPHANED___IS_APPROPRIATE_FWD_EMOFLON_EDGE_254__EMOFLONEDGE:
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPLICABLE_SOLVE_CSP_CC__MCLASS_TYPEGRAPH_TCLASS_MODEL_MATCH_MATCH:
		...
		case RulesPackage.TYPES_ORPHANED___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MCLASS_TYPETOTABSTRACTTYPE_TYPEGRAPH_TCLASS_MODEL_MODELTOTYPEGRAPH_MODELGENERATORRULERESULT:
					...
					if (tmpTType instanceof TClass) {
						...
						if (tmpMModel instanceof Model) {
							...
							if (tmpMModelToTypeGraph instanceof ModelToTypeGraph) {
								...
								return new Object[] { mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_TypesOrphaned_1_1_performtransformation_blackBBBBBBFBB(MClass mType,
			TypeToTAbstractType mTypeToTType, TypeGraph pg, TClass tType, Model mModel,
			ModelToTypeGraph mModelToTypeGraph, TypesOrphaned _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypesOrphaned_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypesOrphaned_1_1_performtransformation_binding != null) {
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_TypesOrphaned_1_1_performtransformation_binding[1];
			TypeGraph pg = (TypeGraph) result_pattern_TypesOrphaned_1_1_performtransformation_binding[2];
			TClass tType = (TClass) result_pattern_TypesOrphaned_1_1_performtransformation_binding[3];
			Model mModel = (Model) result_pattern_TypesOrphaned_1_1_performtransformation_binding[4];
			ModelToTypeGraph mModelToTypeGraph = (ModelToTypeGraph) result_pattern_TypesOrphaned_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_TypesOrphaned_1_1_performtransformation_black = pattern_TypesOrphaned_1_1_performtransformation_blackBBBBBBFBB(
					mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph, _this, isApplicableMatch);
	...
	public static final Object[] pattern_TypesOrphaned_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType, EObject pg, EObject tType,
			EObject mModel, EObject mModelToTypeGraph) {
	...
	public static final Object[] pattern_TypesOrphaned_1_3_bookkeepingforedges_greenBBBBBFFF(
			PerformRuleResult ruleresult, EObject mType, EObject pg, EObject tType, EObject mModel) {
		...
		mModel__mType____orphanTypes.setName(mModel__mType____orphanTypes_name_prime);
		return new Object[] { ruleresult, mType, pg, tType, mModel, pg__tType____ownedTypes, tType__pg____model,
	...
	public static final void pattern_TypesOrphaned_1_5_registerobjects_expressionBBBBBBBB(TypesOrphaned _this,
			PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType, EObject pg, EObject tType,
			EObject mModel, EObject mModelToTypeGraph) {
		_this.registerObjects_FWD(ruleresult, mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph);
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTType instanceof TClass) {
				...
				for (ModelToTypeGraph mModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (pg != null) {
						_result.add(new Object[] { mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph, match });
					}
				...
				if (mModel.getOrphanTypes().contains(mType)) {
					if (mModel.equals(mModelToTypeGraph.getSource())) {
						if (pg.equals(mModelToTypeGraph.getTarget())) {
							_result.add(new Object[] { mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph });
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypesOrphaned_2_3_findcontext_greenBBBBBBFFFFFF(MClass mType,
		...
		return new Object[] { mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph, isApplicableMatch,
				mTypeToTType__mType____source, mTypeToTType__tType____target, mModel__mType____orphanTypes,
	...
	public static final Object[] pattern_TypesOrphaned_2_4_solveCSP_bindingFBBBBBBBB(TypesOrphaned _this,
			IsApplicableMatch isApplicableMatch, MClass mType, TypeToTAbstractType mTypeToTType, TypeGraph pg,
			TClass tType, Model mModel, ModelToTypeGraph mModelToTypeGraph) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mType, mTypeToTType, pg, tType,
				mModel, mModelToTypeGraph);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, pg, tType, mModel,
					mModelToTypeGraph };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesOrphaned_2_4_solveCSP_bindingAndBlackFBBBBBBBB(TypesOrphaned _this,
		...
		Object[] result_pattern_TypesOrphaned_2_4_solveCSP_binding = pattern_TypesOrphaned_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph);
	...
	public static final Object[] pattern_TypesOrphaned_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypesOrphaned_11_1_performtransformation_binding != null) {
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_TypesOrphaned_11_1_performtransformation_binding[1];
			...
			ModelToTypeGraph mModelToTypeGraph = (ModelToTypeGraph) result_pattern_TypesOrphaned_11_1_performtransformation_binding[5];
	...
	public static final void pattern_TypesOrphaned_11_5_registerobjects_expressionBBBBBBBB(TypesOrphaned _this,
			PerformRuleResult ruleresult, EObject mType, EObject mTypeToTType, EObject pg, EObject tType,
			EObject mModel, EObject mModelToTypeGraph) {
		_this.registerObjects_BWD(ruleresult, mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph);
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_12_2_corematch_blackFFBBFFB(TypeGraph pg, TClass tType,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypesOrphaned_12_3_findcontext_greenBBBBBBFFFFFFF(MClass mType,
		...
		return new Object[] { mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph, isApplicableMatch,
				...
				mTypeToTType__tType____target, mModelToTypeGraph__mModel____source, mModelToTypeGraph__pg____target };
	}

	public static final Object[] pattern_TypesOrphaned_12_4_solveCSP_bindingFBBBBBBBB(TypesOrphaned _this,
			IsApplicableMatch isApplicableMatch, MClass mType, TypeToTAbstractType mTypeToTType, TypeGraph pg,
			TClass tType, Model mModel, ModelToTypeGraph mModelToTypeGraph) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mType, mTypeToTType, pg, tType,
				mModel, mModelToTypeGraph);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mTypeToTType, pg, tType, mModel,
		...
		if (tmpMType instanceof MClass) {
			...
			if (tmpPg instanceof TypeGraph) {
				...
				if (tmpTType instanceof TClass) {
					...
					if (tmpMModel instanceof Model) {
						Model mModel = (Model) tmpMModel;
						return new Object[] { mType, pg, tType, mModel, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_TypesOrphaned_24_2_matchsrctrgcontext_blackBBBBBB(MClass mType, TypeGraph pg,
			TClass tType, Model mModel, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_TypesOrphaned_24_3_solvecsp_bindingFBBBBBBB(TypesOrphaned _this, MClass mType,
			TypeGraph pg, TClass tType, Model mModel, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mType, pg, tType, mModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mType, pg, tType, mModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesOrphaned_24_3_solvecsp_bindingAndBlackFBBBBBBB(TypesOrphaned _this,
			MClass mType, TypeGraph pg, TClass tType, Model mModel, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_TypesOrphaned_24_3_solvecsp_binding = pattern_TypesOrphaned_24_3_solvecsp_bindingFBBBBBBB(
				_this, mType, pg, tType, mModel, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_24_5_matchcorrcontext_blackBFBBBFBB(MClass mType,
			TypeGraph pg, TClass tType, Model mModel, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypesOrphaned_24_5_matchcorrcontext_greenBBBBF(
			TypeToTAbstractType mTypeToTType, ModelToTypeGraph mModelToTypeGraph, Match sourceMatch,
			Match targetMatch) {
		...
		return new Object[] { mTypeToTType, mModelToTypeGraph, sourceMatch, targetMatch, ccMatch };
	}

	public static final Object[] pattern_TypesOrphaned_24_6_createcorrespondence_blackBBBBB(MClass mType, TypeGraph pg,
			TClass tType, Model mModel, CCMatch ccMatch) {
		return new Object[] { mType, pg, tType, mModel, ccMatch };
	}
	...
	public static final Object[] pattern_TypesOrphaned_29_3_solveCSP_bindingFBBBBBBBBB(TypesOrphaned _this,
			IsApplicableMatch isApplicableMatch, MClass mType, TypeToTAbstractType mTypeToTType, TypeGraph pg,
			TClass tType, Model mModel, ModelToTypeGraph mModelToTypeGraph, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mType, mTypeToTType, pg, tType,
	...
	public static final Object[] pattern_TypesOrphaned_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(TypesOrphaned _this,
		...
		Object[] result_pattern_TypesOrphaned_29_3_solveCSP_binding = pattern_TypesOrphaned_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph, ruleResult);
	...
	public static final Object[] pattern_TypesOrphaned_29_6_perform_blackBBBBBBB(MClass mType,
		...
		return new Object[] { mType, mTypeToTType, pg, tType, mModel, mModelToTypeGraph, ruleResult };
	}

	public static final Object[] pattern_TypesOrphaned_29_6_perform_greenBBBBB(MClass mType, TypeGraph pg, TClass tType,
		...
		return new Object[] { mType, pg, tType, mModel, ruleResult };
	}
