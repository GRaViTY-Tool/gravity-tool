...
public class InterfaceExtendsInterfaceImpl extends AbstractRuleImpl implements InterfaceExtendsInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, eSuperInterface,
						...
						tSuperInterface, tInterface, eInterfaceDeclaration);
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, eSuperInterface, eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclaration);
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eSuperInterface, eInterfaceDeclarationToTInterface, eTypeAccess,
				eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_2_2_corematch_blackBFBFFFBB(eSuperInterface, eTypeAccess,
			...
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_2_3_findcontext_blackBBBBBBB(eSuperInterface,
							eInterfaceDeclarationToTInterface, eTypeAccess, eSuperInterfaceToTSuperInterface,
							tSuperInterface, tInterface, eInterfaceDeclaration)) {
				...
				//nothing EMoflonEdge eInterfaceDeclarationToTInterface__eInterfaceDeclaration____source = (EMoflonEdge) result3_green[13];
				...
				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, eSuperInterface, eInterfaceDeclarationToTInterface, eTypeAccess,
								eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, InterfaceDeclaration eSuperInterface,
			...
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, TInterface tSuperInterface, TInterface tInterface,
			InterfaceDeclaration eInterfaceDeclaration) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eSuperInterface,
			EObject eInterfaceDeclarationToTInterface, EObject eTypeAccess, EObject eSuperInterfaceToTSuperInterface,
			EObject tSuperInterface, EObject tInterface, EObject eInterfaceDeclaration) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
			...
			// ForEach 
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_12_3_findcontext_blackBBBBBB(eSuperInterface,
							eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, tSuperInterface,
							tInterface, eInterfaceDeclaration)) {
				Object[] result3_green = InterfaceExtendsInterfaceImpl
				...
				//nothing EMoflonEdge tInterface__tSuperInterface____parentInterfaces = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge tSuperInterface__tInterface____childInterfaces = (EMoflonEdge) result3_green[12];

				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, eSuperInterface, eInterfaceDeclarationToTInterface,
								eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eSuperInterface] = "
							...
							+ "[tInterface] = " + tInterface + ", " + "[eInterfaceDeclaration] = "
							+ eInterfaceDeclaration + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, InterfaceDeclaration eSuperInterface,
			...
			TInterface tSuperInterface, TInterface tInterface, InterfaceDeclaration eInterfaceDeclaration) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject eSuperInterface,
			EObject eInterfaceDeclarationToTInterface, EObject eTypeAccess, EObject eSuperInterfaceToTSuperInterface,
			EObject tSuperInterface, EObject tInterface, EObject eInterfaceDeclaration) {
		ruleresult.registerObject("eSuperInterface", eSuperInterface);
		ruleresult.registerObject("eInterfaceDeclarationToTInterface", eInterfaceDeclarationToTInterface);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_72(EMoflonEdge _edge_parentInterfaces) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eSuperInterface,
						eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclaration, sourceMatch, targetMatch);
		...
		if (InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_24_5_matchcorrcontext_blackBFFBBBBB(eSuperInterface,
							tSuperInterface, tInterface, eInterfaceDeclaration, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_24_6_createcorrespondence_blackBBBBBB(eSuperInterface,
								eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclaration, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eSuperInterface] = "
							+ eSuperInterface + ", " + "[eTypeAccess] = " + eTypeAccess + ", " + "[tSuperInterface] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(InterfaceDeclaration eSuperInterface, TypeAccess eTypeAccess,
			TInterface tSuperInterface, TInterface tInterface, InterfaceDeclaration eInterfaceDeclaration,
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
			...
			Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							eSuperInterface, eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface,
							tSuperInterface, tInterface, eInterfaceDeclaration, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_29_5_checknacs_blackBBBBBB(eSuperInterface,
								eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, tSuperInterface,
								tInterface, eInterfaceDeclaration);
				if (result5_black != null) {
					...
					InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_29_6_perform_greenBFBBBB(
							eSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TYPEACCESS_TYPETOTABSTRACTTYPE_TINTERFACE_TINTERFACE_INTERFACEDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TypeAccess) arguments.get(3), (TypeToTAbstractType) arguments.get(4),
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TYPETOTABSTRACTTYPE_TINTERFACE_TINTERFACE_INTERFACEDECLARATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (TypeToTAbstractType) arguments.get(2),
					(TypeToTAbstractType) arguments.get(3), (TInterface) arguments.get(4),
					(TInterface) arguments.get(5), (InterfaceDeclaration) arguments.get(6));
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_72__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_72((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_75__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TYPETOTABSTRACTTYPE_TINTERFACE_TINTERFACE_INTERFACEDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpTSuperInterface instanceof TInterface) {
							...
							if (tmpTInterface instanceof TInterface) {
								...
								if (tmpEInterfaceDeclaration instanceof InterfaceDeclaration) {
									...
									return new Object[] { eSuperInterface, eInterfaceDeclarationToTInterface,
											eTypeAccess, eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_1_performtransformation_blackBBBBBBBFBB(
			InterfaceDeclaration eSuperInterface, TypeToTAbstractType eInterfaceDeclarationToTInterface,
			TypeAccess eTypeAccess, TypeToTAbstractType eSuperInterfaceToTSuperInterface, TInterface tSuperInterface,
			TInterface tInterface, InterfaceDeclaration eInterfaceDeclaration, InterfaceExtendsInterface _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!eInterfaceDeclaration.equals(eSuperInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eSuperInterface, eInterfaceDeclarationToTInterface, eTypeAccess,
									eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding != null) {
			...
			TypeAccess eTypeAccess = (TypeAccess) result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding[2];
			TypeToTAbstractType eSuperInterfaceToTSuperInterface = (TypeToTAbstractType) result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black = pattern_InterfaceExtendsInterface_1_1_performtransformation_blackBBBBBBBFBB(
					eSuperInterface, eInterfaceDeclarationToTInterface, eTypeAccess, eSuperInterfaceToTSuperInterface,
					tSuperInterface, tInterface, eInterfaceDeclaration, _this, isApplicableMatch);
			if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black != null) {
				...
				return new Object[] { eSuperInterface, eInterfaceDeclarationToTInterface, eTypeAccess,
						eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration, csp,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eSuperInterface, EObject eInterfaceDeclarationToTInterface,
			EObject eTypeAccess, EObject eSuperInterfaceToTSuperInterface, EObject tSuperInterface, EObject tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject eSuperInterface, EObject eTypeAccess, EObject tSuperInterface,
			EObject tInterface, EObject eInterfaceDeclaration) {
		EMoflonEdge eTypeAccess__eSuperInterface____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eSuperInterface__eTypeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eInterfaceDeclaration__eTypeAccess____superInterfaces = RuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		...
		return new Object[] { ruleresult, eSuperInterface, eTypeAccess, tSuperInterface, tInterface,
	...
	public static final void pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eInterfaceDeclarationToTInterface, EObject eTypeAccess, EObject eSuperInterfaceToTSuperInterface,
			EObject tSuperInterface, EObject tInterface, EObject eInterfaceDeclaration) {
		_this.registerObjects_FWD(ruleresult, eSuperInterface, eInterfaceDeclarationToTInterface, eTypeAccess,
				eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration);
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_2_2_corematch_blackBFBFFFBB(
			InterfaceDeclaration eSuperInterface, TypeAccess eTypeAccess, InterfaceDeclaration eInterfaceDeclaration,
			Match match) {
					...
					for (TypeToTAbstractType eSuperInterfaceToTSuperInterface : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
							...
							if (tmpTSuperInterface instanceof TInterface) {
								TInterface tSuperInterface = (TInterface) tmpTSuperInterface;
								if (!tInterface.equals(tSuperInterface)) {
									_result.add(new Object[] { eSuperInterface, eInterfaceDeclarationToTInterface,
											eTypeAccess, eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface,
											eInterfaceDeclaration, match });
								}
							}
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_2_3_findcontext_blackBBBBBBB(
			InterfaceDeclaration eSuperInterface, TypeToTAbstractType eInterfaceDeclarationToTInterface,
			TypeAccess eTypeAccess, TypeToTAbstractType eSuperInterfaceToTSuperInterface, TInterface tSuperInterface,
			TInterface tInterface, InterfaceDeclaration eInterfaceDeclaration) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
			if (!tInterface.equals(tSuperInterface)) {
				if (!eInterfaceDeclaration.equals(eSuperInterface)) {
								...
								if (eInterfaceDeclaration.getSuperInterfaces().contains(eTypeAccess)) {
									if (eInterfaceDeclaration.equals(eInterfaceDeclarationToTInterface.getSource())) {
										if (eSuperInterface.equals(eSuperInterfaceToTSuperInterface.getSource())) {
											_result.add(
													new Object[] { eSuperInterface, eInterfaceDeclarationToTInterface,
															eTypeAccess, eSuperInterfaceToTSuperInterface,
															tSuperInterface, tInterface, eInterfaceDeclaration });
										}
									}
								}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { eSuperInterface, eInterfaceDeclarationToTInterface, eTypeAccess,
				eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration, isApplicableMatch,
				eTypeAccess__eSuperInterface____type, eSuperInterface__eTypeAccess____usagesInTypeAccess,
				eSuperInterfaceToTSuperInterface__tSuperInterface____target,
				eInterfaceDeclarationToTInterface__tInterface____target,
				eInterfaceDeclaration__eTypeAccess____superInterfaces,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, TInterface tSuperInterface, TInterface tInterface,
			InterfaceDeclaration eInterfaceDeclaration) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eSuperInterface,
				eInterfaceDeclarationToTInterface, eTypeAccess, eSuperInterfaceToTSuperInterface, tSuperInterface,
				tInterface, eInterfaceDeclaration);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSuperInterface, eInterfaceDeclarationToTInterface,
					eTypeAccess, eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_2_4_solveCSP_binding = pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eSuperInterface, eInterfaceDeclarationToTInterface, eTypeAccess,
				eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration);
	...
	public static final void pattern_InterfaceExtendsInterface_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eInterfaceDeclarationToTInterface, EObject eTypeAccess, EObject eSuperInterfaceToTSuperInterface,
			EObject tSuperInterface, EObject tInterface, EObject eInterfaceDeclaration) {
		_this.registerObjects_BWD(ruleresult, eSuperInterface, eInterfaceDeclarationToTInterface, eTypeAccess,
				eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		tSuperInterface__tInterface____childInterfaces
				.setName(tSuperInterface__tInterface____childInterfaces_name_prime);
		return new Object[] { eSuperInterface, eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface,
				tSuperInterface, tInterface, eInterfaceDeclaration, isApplicableMatch,
				eSuperInterfaceToTSuperInterface__tSuperInterface____target,
				eInterfaceDeclarationToTInterface__tInterface____target,
				eInterfaceDeclarationToTInterface__eInterfaceDeclaration____source,
				eSuperInterfaceToTSuperInterface__eSuperInterface____source,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, eSuperInterface,
				eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface,
				eInterfaceDeclaration);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSuperInterface, eInterfaceDeclarationToTInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_12_4_solveCSP_binding = pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eSuperInterface, eInterfaceDeclarationToTInterface,
				eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_325515 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_655717 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_372119 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_70704 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_943320 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_13740 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_945302 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_613929 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_275092 : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpETypeAccess instanceof TypeAccess) {
				...
				if (tmpTSuperInterface instanceof TInterface) {
					...
					if (tmpTInterface instanceof TInterface) {
						...
						if (tmpEInterfaceDeclaration instanceof InterfaceDeclaration) {
							InterfaceDeclaration eInterfaceDeclaration = (InterfaceDeclaration) tmpEInterfaceDeclaration;
							return new Object[] { eSuperInterface, eTypeAccess, tSuperInterface, tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
			InterfaceDeclaration eSuperInterface, TypeAccess eTypeAccess, TInterface tSuperInterface,
			TInterface tInterface, InterfaceDeclaration eInterfaceDeclaration, Match sourceMatch, Match targetMatch) {
		if (!tInterface.equals(tSuperInterface)) {
			if (!eInterfaceDeclaration.equals(eSuperInterface)) {
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black = pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
					eSuperInterface, eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclaration, sourceMatch,
					targetMatch);
			if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { eSuperInterface, eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclaration,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
			InterfaceExtendsInterface _this, InterfaceDeclaration eSuperInterface, TypeAccess eTypeAccess,
			TInterface tSuperInterface, TInterface tInterface, InterfaceDeclaration eInterfaceDeclaration,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eSuperInterface, eTypeAccess, tSuperInterface, tInterface,
				eInterfaceDeclaration, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eSuperInterface, eTypeAccess, tSuperInterface, tInterface,
					eInterfaceDeclaration, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_24_3_solvecsp_binding = pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
				_this, eSuperInterface, eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclaration, sourceMatch,
				targetMatch);
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_24_5_matchcorrcontext_blackBFFBBBBB(
			InterfaceDeclaration eSuperInterface, TInterface tSuperInterface, TInterface tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_6_createcorrespondence_blackBBBBBB(
			InterfaceDeclaration eSuperInterface, TypeAccess eTypeAccess, TInterface tSuperInterface,
			TInterface tInterface, InterfaceDeclaration eInterfaceDeclaration, CCMatch ccMatch) {
		if (!tInterface.equals(tSuperInterface)) {
			if (!eInterfaceDeclaration.equals(eSuperInterface)) {
				return new Object[] { eSuperInterface, eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclaration,
						ccMatch };
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_2416 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_790000 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_631904 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_16494 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_294755 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_519451 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_940708 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_626814 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_532535 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSuperInterface, eInterfaceDeclarationToTInterface,
					eSuperInterfaceToTSuperInterface, tSuperInterface, tInterface, eInterfaceDeclaration, ruleResult };
		}
		return null;
	}
