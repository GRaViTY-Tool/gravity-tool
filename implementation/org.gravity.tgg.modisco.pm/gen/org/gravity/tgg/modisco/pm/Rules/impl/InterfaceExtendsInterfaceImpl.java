...
public class InterfaceExtendsInterfaceImpl extends AbstractRuleImpl implements InterfaceExtendsInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
						eInterfaceDeclarationToTInterface, tInterface, tSuperInterface, eTypeAccess,
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eInterfaceDeclarationToTInterface, tInterface, tSuperInterface, eTypeAccess,
				eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_2_2_corematch_blackFFFBBFBB(eTypeAccess, eInterfaceDeclaration,
			...
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_2_3_findcontext_blackBBBBBBB(eInterfaceDeclarationToTInterface,
							tInterface, tSuperInterface, eTypeAccess, eInterfaceDeclaration,
				...
				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, eInterfaceDeclarationToTInterface, tInterface, tSuperInterface,
								eTypeAccess, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			TypeToTAbstractType eInterfaceDeclarationToTInterface, TInterface tInterface, TInterface tSuperInterface,
			TypeAccess eTypeAccess, InterfaceDeclaration eInterfaceDeclaration,
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
			...
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_12_3_findcontext_blackBBBBBB(eInterfaceDeclarationToTInterface,
							tInterface, tSuperInterface, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
							eSuperInterface)) {
				Object[] result3_green = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_12_3_findcontext_greenBBBBBBFFFFFFF(
								eInterfaceDeclarationToTInterface, tInterface, tSuperInterface, eInterfaceDeclaration,
								eSuperInterfaceToTSuperInterface, eSuperInterface);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_89(EMoflonEdge _edge_parentInterfaces) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, tInterface,
						tSuperInterface, eTypeAccess, eInterfaceDeclaration, eSuperInterface, sourceMatch, targetMatch);
		...
		if (InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_24_5_matchcorrcontext_blackFBBBFBBB(tInterface, tSuperInterface,
				...
				Object[] result6_black = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_24_6_createcorrespondence_blackBBBBBB(tInterface,
								tSuperInterface, eTypeAccess, eInterfaceDeclaration, eSuperInterface, ccMatch);
				if (result6_black == null) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = InterfaceExtendsInterfaceImpl
							.pattern_InterfaceExtendsInterface_29_6_perform_blackBBBBBBB(
									eInterfaceDeclarationToTInterface, tInterface, tSuperInterface,
									eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface,
									ruleResult);
					if (result6_black == null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TINTERFACE_TINTERFACE_TYPEACCESS_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TINTERFACE_TINTERFACE_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_89__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_89((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_94__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TINTERFACE_TINTERFACE_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpEInterfaceDeclaration instanceof InterfaceDeclaration) {
							...
							if (tmpESuperInterfaceToTSuperInterface instanceof TypeToTAbstractType) {
								...
								if (tmpESuperInterface instanceof InterfaceDeclaration) {
									...
									return new Object[] { eInterfaceDeclarationToTInterface, tInterface,
				...
				if (!eInterfaceDeclaration.equals(eSuperInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eInterfaceDeclarationToTInterface, tInterface, tSuperInterface,
									eTypeAccess, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black = pattern_InterfaceExtendsInterface_1_1_performtransformation_blackBBBBBBBFBB(
					eInterfaceDeclarationToTInterface, tInterface, tSuperInterface, eTypeAccess, eInterfaceDeclaration,
			...
			if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black != null) {
				...
				return new Object[] { eInterfaceDeclarationToTInterface, tInterface, tSuperInterface, eTypeAccess,
						eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eInterfaceDeclarationToTInterface, EObject tInterface,
			EObject tSuperInterface, EObject eTypeAccess, EObject eInterfaceDeclaration,
			EObject eSuperInterfaceToTSuperInterface, EObject eSuperInterface) {
	...
	public static final void pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject tInterface, EObject tSuperInterface, EObject eTypeAccess, EObject eInterfaceDeclaration,
			EObject eSuperInterfaceToTSuperInterface, EObject eSuperInterface) {
		_this.registerObjects_FWD(ruleresult, eInterfaceDeclarationToTInterface, tInterface, tSuperInterface,
				eTypeAccess, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
					...
					for (TypeToTAbstractType eSuperInterfaceToTSuperInterface : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
							...
							if (tmpTSuperInterface instanceof TInterface) {
								TInterface tSuperInterface = (TInterface) tmpTSuperInterface;
								if (!tInterface.equals(tSuperInterface)) {
									_result.add(new Object[] { eInterfaceDeclarationToTInterface, tInterface,
											tSuperInterface, eTypeAccess, eInterfaceDeclaration,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { eInterfaceDeclarationToTInterface, tInterface, tSuperInterface, eTypeAccess,
				eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface, isApplicableMatch,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eInterfaceDeclarationToTInterface,
				tInterface, tSuperInterface, eTypeAccess, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
				eSuperInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eInterfaceDeclarationToTInterface, tInterface,
					tSuperInterface, eTypeAccess, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
					eSuperInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_2_4_solveCSP_binding = pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eInterfaceDeclarationToTInterface, tInterface, tSuperInterface, eTypeAccess,
				eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
				...
				if (!eInterfaceDeclaration.equals(eSuperInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eInterfaceDeclarationToTInterface, tInterface, tSuperInterface,
									eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface, csp,
	...
	public static final void pattern_InterfaceExtendsInterface_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject tInterface, EObject tSuperInterface, EObject eTypeAccess, EObject eInterfaceDeclaration,
			EObject eSuperInterfaceToTSuperInterface, EObject eSuperInterface) {
		_this.registerObjects_BWD(ruleresult, eInterfaceDeclarationToTInterface, tInterface, tSuperInterface,
				eTypeAccess, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		eSuperInterfaceToTSuperInterface__eSuperInterface____source
				.setName(eSuperInterfaceToTSuperInterface__eSuperInterface____source_name_prime);
		return new Object[] { eInterfaceDeclarationToTInterface, tInterface, tSuperInterface, eInterfaceDeclaration,
				eSuperInterfaceToTSuperInterface, eSuperInterface, isApplicableMatch,
				eInterfaceDeclarationToTInterface__tInterface____target,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, eInterfaceDeclarationToTInterface,
				tInterface, tSuperInterface, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eInterfaceDeclarationToTInterface, tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_12_4_solveCSP_binding = pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eInterfaceDeclarationToTInterface, tInterface, tSuperInterface,
				eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_262089 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_393914 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_918666 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_142548 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_891531 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_176265 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_7863 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_790202 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_157562 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black = pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
					tInterface, tSuperInterface, eTypeAccess, eInterfaceDeclaration, eSuperInterface, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
			...
			InterfaceDeclaration eInterfaceDeclaration, InterfaceDeclaration eSuperInterface, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(tInterface, tSuperInterface, eTypeAccess,
				eInterfaceDeclaration, eSuperInterface, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, tInterface, tSuperInterface, eTypeAccess, eInterfaceDeclaration,
					eSuperInterface, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_24_3_solvecsp_binding = pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
				_this, tInterface, tSuperInterface, eTypeAccess, eInterfaceDeclaration, eSuperInterface, sourceMatch,
				targetMatch);
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_24_5_matchcorrcontext_blackFBBBFBBB(
			TInterface tInterface, TInterface tSuperInterface, InterfaceDeclaration eInterfaceDeclaration,
							...
							for (TypeToTAbstractType eSuperInterfaceToTSuperInterface : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
									if (eSuperInterface.equals(eSuperInterfaceToTSuperInterface.getSource())) {
										_result.add(new Object[] { eInterfaceDeclarationToTInterface, tInterface,
												tSuperInterface, eInterfaceDeclaration,
												eSuperInterfaceToTSuperInterface, eSuperInterface, sourceMatch,
												targetMatch });
									}
								}
							}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_6_createcorrespondence_blackBBBBBB(
			TInterface tInterface, TInterface tSuperInterface, TypeAccess eTypeAccess,
			InterfaceDeclaration eInterfaceDeclaration, InterfaceDeclaration eSuperInterface, CCMatch ccMatch) {
		if (!tInterface.equals(tSuperInterface)) {
			if (!eInterfaceDeclaration.equals(eSuperInterface)) {
				return new Object[] { tInterface, tSuperInterface, eTypeAccess, eInterfaceDeclaration, eSuperInterface,
						ccMatch };
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_629894 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_315254 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_764298 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_238042 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_954972 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_155582 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_828543 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_630984 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_889563 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_29_3_solveCSP_binding = pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eInterfaceDeclarationToTInterface, tInterface, tSuperInterface,
				eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface, ruleResult);
