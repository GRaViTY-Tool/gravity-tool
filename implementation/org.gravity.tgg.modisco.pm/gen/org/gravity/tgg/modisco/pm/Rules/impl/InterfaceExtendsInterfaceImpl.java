...
public class InterfaceExtendsInterfaceImpl extends AbstractRuleImpl implements InterfaceExtendsInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
						eInterfaceDeclaration, eTypeAccess, eInterfaceDeclarationToTInterface, tInterface,
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ eTypeAccess + ", " + "[eInterfaceDeclarationToTInterface] = " + eInterfaceDeclarationToTInterface
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, eInterfaceDeclaration, eTypeAccess, tInterface, tSuperInterface, eSuperInterface);
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eInterfaceDeclaration, eTypeAccess, eInterfaceDeclarationToTInterface, tInterface,
				eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_2_2_corematch_blackBBFFFFBB(eInterfaceDeclaration, eTypeAccess,
			...
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_2_3_findcontext_blackBBBBBBB(eInterfaceDeclaration, eTypeAccess,
							eInterfaceDeclarationToTInterface, tInterface, eSuperInterfaceToTSuperInterface,
							tSuperInterface, eSuperInterface)) {
				Object[] result3_green = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_2_3_findcontext_greenBBBBBBBFFFFFFFF(eInterfaceDeclaration,
								eTypeAccess, eInterfaceDeclarationToTInterface, tInterface,
								eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface);
				...
				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, eInterfaceDeclaration, eTypeAccess,
								eInterfaceDeclarationToTInterface, tInterface, eSuperInterfaceToTSuperInterface,
								tSuperInterface, eSuperInterface);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eInterfaceDeclaration, EObject eTypeAccess,
			EObject eInterfaceDeclarationToTInterface, EObject tInterface, EObject eSuperInterfaceToTSuperInterface,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_12_2_corematch_blackFFBFBFB(tInterface, tSuperInterface, match)) {
			...
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
				...
				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, eInterfaceDeclaration, eInterfaceDeclarationToTInterface, tInterface,
								eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eInterfaceDeclaration] = "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			...
			TInterface tInterface, TypeToTAbstractType eSuperInterfaceToTSuperInterface, TInterface tSuperInterface,
			InterfaceDeclaration eSuperInterface) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_86(EMoflonEdge _edge_parentInterfaces) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_90(EMoflonEdge _edge_superInterfaces) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eInterfaceDeclaration,
						eTypeAccess, tInterface, tSuperInterface, eSuperInterface, sourceMatch, targetMatch);
		...
		if (InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_24_5_matchcorrcontext_blackBFBFBBBB(eInterfaceDeclaration,
							tInterface, tSuperInterface, eSuperInterface, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_24_6_createcorrespondence_blackBBBBBB(eInterfaceDeclaration,
								eTypeAccess, tInterface, tSuperInterface, eSuperInterface, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: "
							+ "[eInterfaceDeclaration] = " + eInterfaceDeclaration + ", " + "[eTypeAccess] = "
							+ eTypeAccess + ", " + "[tInterface] = " + tInterface + ", " + "[tSuperInterface] = "
							+ tSuperInterface + ", " + "[eSuperInterface] = " + eSuperInterface + ", " + "[ccMatch] = "
							+ ccMatch + ".");
				}
	...
	public CSP isApplicable_solveCsp_CC(InterfaceDeclaration eInterfaceDeclaration, TypeAccess eTypeAccess,
			TInterface tInterface, TInterface tSuperInterface, InterfaceDeclaration eSuperInterface, Match sourceMatch,
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
			...
			Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							...
							eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eInterfaceDeclaration] = "
						+ eInterfaceDeclaration + ", " + "[eInterfaceDeclarationToTInterface] = "
				...
				if (result5_black != null) {
					...
					Object[] result6_black = InterfaceExtendsInterfaceImpl
							.pattern_InterfaceExtendsInterface_29_6_perform_blackBBBBBBB(eInterfaceDeclaration,
									eInterfaceDeclarationToTInterface, tInterface, eSuperInterfaceToTSuperInterface,
									tSuperInterface, eSuperInterface, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
					...
					InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_29_6_perform_greenBFBBBB(
							eInterfaceDeclaration, tInterface, tSuperInterface, eSuperInterface, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPEACCESS_TYPETOTABSTRACTTYPE_TINTERFACE_TYPETOTABSTRACTTYPE_TINTERFACE_INTERFACEDECLARATION:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TINTERFACE_TYPETOTABSTRACTTYPE_TINTERFACE_INTERFACEDECLARATION:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_86__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_86((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_90__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_TINTERFACE_TYPETOTABSTRACTTYPE_TINTERFACE_INTERFACEDECLARATION_MODELGENERATORRULERESULT:
				...
				if (!tInterface.equals(tSuperInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eInterfaceDeclaration, eTypeAccess, eInterfaceDeclarationToTInterface,
									tInterface, eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface, csp,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black = pattern_InterfaceExtendsInterface_1_1_performtransformation_blackBBBBBBBFBB(
					eInterfaceDeclaration, eTypeAccess, eInterfaceDeclarationToTInterface, tInterface,
					eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface, _this, isApplicableMatch);
			if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black != null) {
				...
				return new Object[] { eInterfaceDeclaration, eTypeAccess, eInterfaceDeclarationToTInterface, tInterface,
						eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject eInterfaceDeclaration, EObject eTypeAccess, EObject tInterface,
			EObject tSuperInterface, EObject eSuperInterface) {
		EMoflonEdge eInterfaceDeclaration__eTypeAccess____superInterfaces = RuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		EMoflonEdge eTypeAccess__eSuperInterface____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, eInterfaceDeclaration, eTypeAccess, tInterface, tSuperInterface,
	...
	public static final void pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eTypeAccess, EObject eInterfaceDeclarationToTInterface, EObject tInterface,
			EObject eSuperInterfaceToTSuperInterface, EObject tSuperInterface, EObject eSuperInterface) {
		_this.registerObjects_FWD(ruleresult, eInterfaceDeclaration, eTypeAccess, eInterfaceDeclarationToTInterface,
				tInterface, eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface);
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_2_2_corematch_blackBBFFFFBB(
			InterfaceDeclaration eInterfaceDeclaration, TypeAccess eTypeAccess, InterfaceDeclaration eSuperInterface,
			Match match) {
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { eInterfaceDeclaration, eTypeAccess, eInterfaceDeclarationToTInterface, tInterface,
				eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface, isApplicableMatch,
				eInterfaceDeclarationToTInterface__eInterfaceDeclaration____source,
				eInterfaceDeclarationToTInterface__tInterface____target,
				eInterfaceDeclaration__eTypeAccess____superInterfaces, eTypeAccess__eSuperInterface____type,
				eSuperInterface__eTypeAccess____usagesInTypeAccess,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eInterfaceDeclaration, eTypeAccess,
				eInterfaceDeclarationToTInterface, tInterface, eSuperInterfaceToTSuperInterface, tSuperInterface,
				eSuperInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_2_4_solveCSP_binding = pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eInterfaceDeclaration, eTypeAccess, eInterfaceDeclarationToTInterface,
				tInterface, eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface);
			...
			if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
				if (!tInterface.equals(tSuperInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eInterfaceDeclaration, eInterfaceDeclarationToTInterface, tInterface,
									eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface, csp, _this,
									isApplicableMatch };
						}
					}
	...
	public static final void pattern_InterfaceExtendsInterface_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eTypeAccess, EObject eInterfaceDeclarationToTInterface, EObject tInterface,
			EObject eSuperInterfaceToTSuperInterface, EObject tSuperInterface, EObject eSuperInterface) {
		_this.registerObjects_BWD(ruleresult, eInterfaceDeclaration, eTypeAccess, eInterfaceDeclarationToTInterface,
				tInterface, eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface);
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_12_2_corematch_blackFFBFBFB(
							...
							if (tmpESuperInterface instanceof InterfaceDeclaration) {
								...
								if (!eInterfaceDeclaration.equals(eSuperInterface)) {
									_result.add(new Object[] { eInterfaceDeclaration, eInterfaceDeclarationToTInterface,
											tInterface, eSuperInterfaceToTSuperInterface, tSuperInterface,
											eSuperInterface, match });
								}
							}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_12_4_solveCSP_binding = pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eInterfaceDeclaration, eInterfaceDeclarationToTInterface, tInterface,
				eSuperInterfaceToTSuperInterface, tSuperInterface, eSuperInterface);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_494299 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_642047 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_733856 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_136777 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_417341 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_654495 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_976105 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_624486 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_390513 : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpETypeAccess instanceof TypeAccess) {
				...
				if (tmpTInterface instanceof TInterface) {
					...
					if (tmpTSuperInterface instanceof TInterface) {
						...
						if (tmpESuperInterface instanceof InterfaceDeclaration) {
							InterfaceDeclaration eSuperInterface = (InterfaceDeclaration) tmpESuperInterface;
							return new Object[] { eInterfaceDeclaration, eTypeAccess, tInterface, tSuperInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
			InterfaceDeclaration eInterfaceDeclaration, TypeAccess eTypeAccess, TInterface tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black = pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
					eInterfaceDeclaration, eTypeAccess, tInterface, tSuperInterface, eSuperInterface, sourceMatch,
					targetMatch);
			if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { eInterfaceDeclaration, eTypeAccess, tInterface, tSuperInterface, eSuperInterface,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
			...
			TInterface tInterface, TInterface tSuperInterface, InterfaceDeclaration eSuperInterface, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eInterfaceDeclaration, eTypeAccess, tInterface,
				tSuperInterface, eSuperInterface, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eInterfaceDeclaration, eTypeAccess, tInterface, tSuperInterface,
					eSuperInterface, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_24_3_solvecsp_binding = pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
				_this, eInterfaceDeclaration, eTypeAccess, tInterface, tSuperInterface, eSuperInterface, sourceMatch,
				targetMatch);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_950209 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_687379 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_266000 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_465831 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_692740 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_418155 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_975502 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_851467 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_747206 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
