...
public class InterfaceExtendsInterfaceImpl extends AbstractRuleImpl implements InterfaceExtendsInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, eTypeAccess,
						...
						eInterfaceDeclaration, tInterface, tSuperInterface);
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, eTypeAccess, eSuperInterface, eInterfaceDeclaration, tInterface, tSuperInterface);
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eTypeAccess, eSuperInterfaceToTSuperInterface, eSuperInterface,
				eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface, tSuperInterface);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_2_2_corematch_blackBFBFBFFB(eTypeAccess, eSuperInterface,
			...
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
				...
				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, eTypeAccess, eSuperInterfaceToTSuperInterface, eSuperInterface,
								eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface, tSuperInterface);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeAccess eTypeAccess,
			...
			TInterface tInterface, TInterface tSuperInterface) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_12_2_corematch_blackFFFFBBB(tInterface, tSuperInterface, match)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_92(EMoflonEdge _edge_parentInterfaces) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		InterfaceDeclaration eInterfaceDeclaration = (InterfaceDeclaration) result2_bindingAndBlack[2];
		...
		Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eTypeAccess,
						eSuperInterface, eInterfaceDeclaration, tInterface, tSuperInterface, sourceMatch, targetMatch);
		...
		if (InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_24_5_matchcorrcontext_blackFBFBBBBB(eSuperInterface,
							eInterfaceDeclaration, tInterface, tSuperInterface, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_24_6_createcorrespondence_blackBBBBBB(eTypeAccess,
								eSuperInterface, eInterfaceDeclaration, tInterface, tSuperInterface, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
							"Pattern matching failed." + " Variables: " + "[eTypeAccess] = " + eTypeAccess + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess eTypeAccess, InterfaceDeclaration eSuperInterface,
			InterfaceDeclaration eInterfaceDeclaration, TInterface tInterface, TInterface tSuperInterface,
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
			...
			Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclarationToTInterface,
							eInterfaceDeclaration, tInterface, tSuperInterface, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_29_6_perform_greenFBBBBB(
							eSuperInterface, eInterfaceDeclaration, tInterface, tSuperInterface, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, InterfaceDeclaration eSuperInterface,
			TypeToTAbstractType eInterfaceDeclarationToTInterface, InterfaceDeclaration eInterfaceDeclaration,
			TInterface tInterface, TInterface tSuperInterface, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEACCESS_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_TINTERFACE_TINTERFACE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TypeAccess) arguments.get(1),
					...
					(TInterface) arguments.get(6), (TInterface) arguments.get(7));
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_TINTERFACE_TINTERFACE:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_92__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_92((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_95__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_INTERFACEDECLARATION_INTERFACEDECLARATION_TINTERFACE_TINTERFACE_MATCH_MATCH:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_TINTERFACE_TINTERFACE_MODELGENERATORRULERESULT:
							...
							if (tmpTInterface instanceof TInterface) {
								...
								if (tmpTSuperInterface instanceof TInterface) {
									...
									return new Object[] { eTypeAccess, eSuperInterfaceToTSuperInterface,
											...
											tInterface, tSuperInterface, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_1_performtransformation_blackBBBBBBBFBB(
			TypeAccess eTypeAccess, TypeToTAbstractType eSuperInterfaceToTSuperInterface,
				...
				if (!tInterface.equals(tSuperInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eTypeAccess, eSuperInterfaceToTSuperInterface, eSuperInterface,
									eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black = pattern_InterfaceExtendsInterface_1_1_performtransformation_blackBBBBBBBFBB(
					eTypeAccess, eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclarationToTInterface,
					eInterfaceDeclaration, tInterface, tSuperInterface, _this, isApplicableMatch);
			if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black != null) {
				...
				return new Object[] { eTypeAccess, eSuperInterfaceToTSuperInterface, eSuperInterface,
						eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface, tSuperInterface, csp,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(
			...
			EObject eSuperInterface, EObject eInterfaceDeclarationToTInterface, EObject eInterfaceDeclaration,
			EObject tInterface, EObject tSuperInterface) {
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject eTypeAccess, EObject eSuperInterface, EObject eInterfaceDeclaration,
			EObject tInterface, EObject tSuperInterface) {
		EMoflonEdge eTypeAccess__eSuperInterface____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eSuperInterface__eTypeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		eInterfaceDeclaration__eTypeAccess____superInterfaces
				.setName(eInterfaceDeclaration__eTypeAccess____superInterfaces_name_prime);
		return new Object[] { ruleresult, eTypeAccess, eSuperInterface, eInterfaceDeclaration, tInterface,
	...
	public static final void pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eInterfaceDeclarationToTInterface, EObject eInterfaceDeclaration, EObject tInterface,
			EObject tSuperInterface) {
		_this.registerObjects_FWD(ruleresult, eTypeAccess, eSuperInterfaceToTSuperInterface, eSuperInterface,
				eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface, tSuperInterface);
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_2_2_corematch_blackBFBFBFFB(
			TypeAccess eTypeAccess, InterfaceDeclaration eSuperInterface, InterfaceDeclaration eInterfaceDeclaration,
			Match match) {
							...
							if (tmpTInterface instanceof TInterface) {
								...
								if (!tInterface.equals(tSuperInterface)) {
									_result.add(new Object[] { eTypeAccess, eSuperInterfaceToTSuperInterface,
											eSuperInterface, eInterfaceDeclarationToTInterface, eInterfaceDeclaration,
											tInterface, tSuperInterface, match });
								}
							}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { eTypeAccess, eSuperInterfaceToTSuperInterface, eSuperInterface,
				eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface, tSuperInterface,
				isApplicableMatch, eTypeAccess__eSuperInterface____type,
				eSuperInterface__eTypeAccess____usagesInTypeAccess,
				eSuperInterfaceToTSuperInterface__eSuperInterface____source,
				eInterfaceDeclarationToTInterface__tInterface____target,
				eInterfaceDeclarationToTInterface__eInterfaceDeclaration____source,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_2_4_solveCSP_binding = pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eTypeAccess, eSuperInterfaceToTSuperInterface, eSuperInterface,
				eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface, tSuperInterface);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_11_1_performtransformation_blackBBBBBBFBB(
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, InterfaceDeclaration eSuperInterface,
			TypeToTAbstractType eInterfaceDeclarationToTInterface, InterfaceDeclaration eInterfaceDeclaration,
			TInterface tInterface, TInterface tSuperInterface, InterfaceExtendsInterface _this,
			IsApplicableMatch isApplicableMatch) {
		if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
			if (!eInterfaceDeclaration.equals(eSuperInterface)) {
				if (!tInterface.equals(tSuperInterface)) {
	...
	public static final void pattern_InterfaceExtendsInterface_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eInterfaceDeclarationToTInterface, EObject eInterfaceDeclaration, EObject tInterface,
			EObject tSuperInterface) {
		_this.registerObjects_BWD(ruleresult, eTypeAccess, eSuperInterfaceToTSuperInterface, eSuperInterface,
				eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface, tSuperInterface);
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_12_2_corematch_blackFFFFBBB(
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclarationToTInterface,
				eInterfaceDeclaration, tInterface, tSuperInterface, isApplicableMatch,
				eSuperInterfaceToTSuperInterface__eSuperInterface____source,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, eSuperInterfaceToTSuperInterface,
				eSuperInterface, eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface, tSuperInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_936688 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_805769 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_666839 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_389232 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_210739 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_915794 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_405172 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_726138 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_593371 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_bindingFFFFFBB(
		...
		EObject _localVariable_2 = sourceMatch.getObject("eInterfaceDeclaration");
			...
			if (tmpESuperInterface instanceof InterfaceDeclaration) {
				...
				if (tmpEInterfaceDeclaration instanceof InterfaceDeclaration) {
					...
					if (tmpTInterface instanceof TInterface) {
						...
						if (tmpTSuperInterface instanceof TInterface) {
							TInterface tSuperInterface = (TInterface) tmpTSuperInterface;
							return new Object[] { eTypeAccess, eSuperInterface, eInterfaceDeclaration, tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
			TypeAccess eTypeAccess, InterfaceDeclaration eSuperInterface, InterfaceDeclaration eInterfaceDeclaration,
			TInterface tInterface, TInterface tSuperInterface, Match sourceMatch, Match targetMatch) {
		if (!eInterfaceDeclaration.equals(eSuperInterface)) {
			if (!tInterface.equals(tSuperInterface)) {
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_binding != null) {
			...
			InterfaceDeclaration eInterfaceDeclaration = (InterfaceDeclaration) result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_binding[2];
			...
			Object[] result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black = pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
					eTypeAccess, eSuperInterface, eInterfaceDeclaration, tInterface, tSuperInterface, sourceMatch,
					targetMatch);
			if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { eTypeAccess, eSuperInterface, eInterfaceDeclaration, tInterface, tSuperInterface,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
			InterfaceExtendsInterface _this, TypeAccess eTypeAccess, InterfaceDeclaration eSuperInterface,
			InterfaceDeclaration eInterfaceDeclaration, TInterface tInterface, TInterface tSuperInterface,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eTypeAccess, eSuperInterface, eInterfaceDeclaration,
				tInterface, tSuperInterface, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eTypeAccess, eSuperInterface, eInterfaceDeclaration, tInterface,
					tSuperInterface, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_24_3_solvecsp_binding = pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
				_this, eTypeAccess, eSuperInterface, eInterfaceDeclaration, tInterface, tSuperInterface, sourceMatch,
				targetMatch);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_6_createcorrespondence_blackBBBBBB(
			TypeAccess eTypeAccess, InterfaceDeclaration eSuperInterface, InterfaceDeclaration eInterfaceDeclaration,
			TInterface tInterface, TInterface tSuperInterface, CCMatch ccMatch) {
		if (!eInterfaceDeclaration.equals(eSuperInterface)) {
			if (!tInterface.equals(tSuperInterface)) {
				return new Object[] { eTypeAccess, eSuperInterface, eInterfaceDeclaration, tInterface, tSuperInterface,
						ccMatch };
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_841765 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_767321 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_726778 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_793021 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_976165 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_509905 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_87008 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_669438 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_817535 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingFBBBBBBBBB(
			...
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, InterfaceDeclaration eSuperInterface,
			TypeToTAbstractType eInterfaceDeclarationToTInterface, InterfaceDeclaration eInterfaceDeclaration,
			TInterface tInterface, TInterface tSuperInterface, ModelgeneratorRuleResult ruleResult) {
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSuperInterfaceToTSuperInterface, eSuperInterface,
					eInterfaceDeclarationToTInterface, eInterfaceDeclaration, tInterface, tSuperInterface, ruleResult };
		}
		return null;
	}
