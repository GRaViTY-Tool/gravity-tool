...
public class InterfaceExtendsInterfaceImpl extends AbstractRuleImpl implements InterfaceExtendsInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, eTypeAccess,
						tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
						eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration);
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, eTypeAccess, tSuperInterface, tInterface, eSuperInterface, eInterfaceDeclaration);
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
				eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_2_2_corematch_blackBFFFFBBB(eTypeAccess, eSuperInterface,
			...
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_2_3_findcontext_blackBBBBBBB(eTypeAccess, tSuperInterface,
							tInterface, eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface,
							eSuperInterface, eInterfaceDeclaration)) {
				Object[] result3_green = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_2_3_findcontext_greenBBBBBBBFFFFFFFF(eTypeAccess,
								tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
								eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration);
				...
				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, eTypeAccess, tSuperInterface, tInterface,
								eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[eSuperInterface] = " + eSuperInterface + ", " + "[eInterfaceDeclaration] = "
							+ eInterfaceDeclaration + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeAccess eTypeAccess,
			TInterface tSuperInterface, TInterface tInterface, TypeToTAbstractType eInterfaceDeclarationToTInterface,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eTypeAccess, EObject tSuperInterface,
			EObject tInterface, EObject eInterfaceDeclarationToTInterface, EObject eSuperInterfaceToTSuperInterface,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_11_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, eTypeAccess,
						tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
						eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_12_2_corematch_blackBBFFFFB(tSuperInterface, tInterface, match)) {
			...
			// ForEach 
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_12_3_findcontext_blackBBBBBB(tSuperInterface, tInterface,
							eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
							eInterfaceDeclaration)) {
				Object[] result3_green = InterfaceExtendsInterfaceImpl
				...
				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
								eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject eTypeAccess, EObject tSuperInterface,
			EObject tInterface, EObject eInterfaceDeclarationToTInterface, EObject eSuperInterfaceToTSuperInterface,
			EObject eSuperInterface, EObject eInterfaceDeclaration) {
		ruleresult.registerObject("eTypeAccess", eTypeAccess);
		ruleresult.registerObject("tSuperInterface", tSuperInterface);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_1(EMoflonEdge _edge_parentInterfaces) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eTypeAccess,
						tSuperInterface, tInterface, eSuperInterface, eInterfaceDeclaration, sourceMatch, targetMatch);
		...
		if (InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_24_5_matchcorrcontext_blackBBFFBBBB(tSuperInterface, tInterface,
				...
				Object[] result6_black = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_24_6_createcorrespondence_blackBBBBBB(eTypeAccess,
								tSuperInterface, tInterface, eSuperInterface, eInterfaceDeclaration, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess eTypeAccess, TInterface tSuperInterface, TInterface tInterface,
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
			...
			Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
							eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_29_5_checknacs_blackBBBBBB(tSuperInterface, tInterface,
								eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
								eInterfaceDeclaration);
				if (result5_black != null) {

					Object[] result6_black = InterfaceExtendsInterfaceImpl
							.pattern_InterfaceExtendsInterface_29_6_perform_blackBBBBBBB(tSuperInterface, tInterface,
									eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface,
									eSuperInterface, eInterfaceDeclaration, ruleResult);
					if (result6_black == null) {
					...
					InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_29_6_perform_greenFBBBBB(
							tSuperInterface, tInterface, eSuperInterface, eInterfaceDeclaration, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEACCESS_TINTERFACE_TINTERFACE_TYPETOTABSTRACTTYPE_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_INTERFACEDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TypeAccess) arguments.get(1),
					...
					(InterfaceDeclaration) arguments.get(6), (InterfaceDeclaration) arguments.get(7));
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_TINTERFACE_TYPETOTABSTRACTTYPE_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_INTERFACEDECLARATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TInterface) arguments.get(1),
					(TInterface) arguments.get(2), (TypeToTAbstractType) arguments.get(3),
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_1__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_1((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_TINTERFACE_TINTERFACE_INTERFACEDECLARATION_INTERFACEDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeAccess) arguments.get(0), (TInterface) arguments.get(1),
					(TInterface) arguments.get(2), (InterfaceDeclaration) arguments.get(3),
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_TINTERFACE_TYPETOTABSTRACTTYPE_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_INTERFACEDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpESuperInterfaceToTSuperInterface instanceof TypeToTAbstractType) {
							...
							if (tmpESuperInterface instanceof InterfaceDeclaration) {
								...
								if (tmpEInterfaceDeclaration instanceof InterfaceDeclaration) {
									...
									return new Object[] { eTypeAccess, tSuperInterface, tInterface,
											eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface,
											eSuperInterface, eInterfaceDeclaration, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_1_performtransformation_blackBBBBBBBFBB(
			TypeAccess eTypeAccess, TInterface tSuperInterface, TInterface tInterface,
				...
				if (!eInterfaceDeclaration.equals(eSuperInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							...
							return new Object[] { eTypeAccess, tSuperInterface, tInterface,
									eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface,
									eSuperInterface, eInterfaceDeclaration, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding != null) {
			TypeAccess eTypeAccess = (TypeAccess) result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding[0];
			TInterface tSuperInterface = (TInterface) result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding[1];
			TInterface tInterface = (TInterface) result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding[2];
			TypeToTAbstractType eInterfaceDeclarationToTInterface = (TypeToTAbstractType) result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black = pattern_InterfaceExtendsInterface_1_1_performtransformation_blackBBBBBBBFBB(
					...
					eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration, _this, isApplicableMatch);
			if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black != null) {
				...
				return new Object[] { eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
						eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eTypeAccess, EObject tSuperInterface, EObject tInterface,
			EObject eInterfaceDeclarationToTInterface, EObject eSuperInterfaceToTSuperInterface,
			EObject eSuperInterface, EObject eInterfaceDeclaration) {
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		eInterfaceDeclaration__eTypeAccess____superInterfaces
				.setName(eInterfaceDeclaration__eTypeAccess____superInterfaces_name_prime);
		return new Object[] { ruleresult, eTypeAccess, tSuperInterface, tInterface, eSuperInterface,
	...
	public static final void pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(
			InterfaceExtendsInterface _this, PerformRuleResult ruleresult, EObject eTypeAccess, EObject tSuperInterface,
			EObject tInterface, EObject eInterfaceDeclarationToTInterface, EObject eSuperInterfaceToTSuperInterface,
			EObject eSuperInterface, EObject eInterfaceDeclaration) {
		_this.registerObjects_FWD(ruleresult, eTypeAccess, tSuperInterface, tInterface,
				eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
				eInterfaceDeclaration);
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_2_2_corematch_blackBFFFFBBB(
			TypeAccess eTypeAccess, InterfaceDeclaration eSuperInterface, InterfaceDeclaration eInterfaceDeclaration,
			Match match) {
					...
					for (TypeToTAbstractType eInterfaceDeclarationToTInterface : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
							...
							if (tmpTInterface instanceof TInterface) {
								TInterface tInterface = (TInterface) tmpTInterface;
								if (!tInterface.equals(tSuperInterface)) {
									_result.add(new Object[] { eTypeAccess, tSuperInterface, tInterface,
											eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface,
											eSuperInterface, eInterfaceDeclaration, match });
								}
							}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
				eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration, isApplicableMatch,
				eTypeAccess__eSuperInterface____type, eSuperInterface__eTypeAccess____usagesInTypeAccess,
				eSuperInterfaceToTSuperInterface__tSuperInterface____target,
				eSuperInterfaceToTSuperInterface__eSuperInterface____source,
				eInterfaceDeclarationToTInterface__tInterface____target,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
			InterfaceExtendsInterface _this, IsApplicableMatch isApplicableMatch, TypeAccess eTypeAccess,
			TInterface tSuperInterface, TInterface tInterface, TypeToTAbstractType eInterfaceDeclarationToTInterface,
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, InterfaceDeclaration eSuperInterface,
			InterfaceDeclaration eInterfaceDeclaration) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eTypeAccess, tSuperInterface,
				tInterface, eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
				eInterfaceDeclaration);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eTypeAccess, tSuperInterface, tInterface,
					eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
					eInterfaceDeclaration };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_2_4_solveCSP_binding = pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eTypeAccess, tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
				eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration);
				...
				if (tmpEInterfaceDeclarationToTInterface instanceof TypeToTAbstractType) {
					...
					if (tmpESuperInterfaceToTSuperInterface instanceof TypeToTAbstractType) {
						...
						if (tmpESuperInterface instanceof InterfaceDeclaration) {
							...
							if (tmpEInterfaceDeclaration instanceof InterfaceDeclaration) {
								InterfaceDeclaration eInterfaceDeclaration = (InterfaceDeclaration) tmpEInterfaceDeclaration;
								return new Object[] { tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
										eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration,
										isApplicableMatch };
							}
						}
				...
				if (!eInterfaceDeclaration.equals(eSuperInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
									eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration, csp,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceExtendsInterface_11_1_performtransformation_black = pattern_InterfaceExtendsInterface_11_1_performtransformation_blackBBBBBBFBB(
					tSuperInterface, tInterface, eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface,
					eSuperInterface, eInterfaceDeclaration, _this, isApplicableMatch);
	...
	public static final void pattern_InterfaceExtendsInterface_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject tInterface, EObject eInterfaceDeclarationToTInterface, EObject eSuperInterfaceToTSuperInterface,
			EObject eSuperInterface, EObject eInterfaceDeclaration) {
		_this.registerObjects_BWD(ruleresult, eTypeAccess, tSuperInterface, tInterface,
				eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
				eInterfaceDeclaration);
					...
					for (TypeToTAbstractType eInterfaceDeclarationToTInterface : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
							...
							if (tmpEInterfaceDeclaration instanceof InterfaceDeclaration) {
								InterfaceDeclaration eInterfaceDeclaration = (InterfaceDeclaration) tmpEInterfaceDeclaration;
								if (!eInterfaceDeclaration.equals(eSuperInterface)) {
									_result.add(new Object[] { tSuperInterface, tInterface,
											eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface,
											eSuperInterface, eInterfaceDeclaration, match });
								}
							}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
			...
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, InterfaceDeclaration eSuperInterface,
			InterfaceDeclaration eInterfaceDeclaration) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tSuperInterface, tInterface,
				eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
				eInterfaceDeclaration);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSuperInterface, tInterface,
					eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
					eInterfaceDeclaration };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_12_4_solveCSP_binding = pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tSuperInterface, tInterface, eInterfaceDeclarationToTInterface,
				eSuperInterfaceToTSuperInterface, eSuperInterface, eInterfaceDeclaration);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_506650 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_109412 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_924366 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_620840 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_687653 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_768178 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_99304 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_488805 : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTSuperInterface instanceof TInterface) {
				...
				if (tmpTInterface instanceof TInterface) {
					...
					if (tmpESuperInterface instanceof InterfaceDeclaration) {
						...
						if (tmpEInterfaceDeclaration instanceof InterfaceDeclaration) {
							InterfaceDeclaration eInterfaceDeclaration = (InterfaceDeclaration) tmpEInterfaceDeclaration;
							return new Object[] { eTypeAccess, tSuperInterface, tInterface, eSuperInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black = pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
					eTypeAccess, tSuperInterface, tInterface, eSuperInterface, eInterfaceDeclaration, sourceMatch,
					targetMatch);
			if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { eTypeAccess, tSuperInterface, tInterface, eSuperInterface, eInterfaceDeclaration,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
			InterfaceExtendsInterface _this, TypeAccess eTypeAccess, TInterface tSuperInterface, TInterface tInterface,
			InterfaceDeclaration eSuperInterface, InterfaceDeclaration eInterfaceDeclaration, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eTypeAccess, tSuperInterface, tInterface, eSuperInterface,
				eInterfaceDeclaration, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eTypeAccess, tSuperInterface, tInterface, eSuperInterface,
					eInterfaceDeclaration, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_24_3_solvecsp_binding = pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
				_this, eTypeAccess, tSuperInterface, tInterface, eSuperInterface, eInterfaceDeclaration, sourceMatch,
				targetMatch);
	...
	public static final Iterable<Object[]> pattern_InterfaceExtendsInterface_24_5_matchcorrcontext_blackBBFFBBBB(
			TInterface tSuperInterface, TInterface tInterface, InterfaceDeclaration eSuperInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_746083 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_130140 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_286844 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_874026 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_477323 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_612148 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_50306 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_806426 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tSuperInterface, tInterface,
				eInterfaceDeclarationToTInterface, eSuperInterfaceToTSuperInterface, eSuperInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_29_6_perform_greenFBBBBB(TInterface tSuperInterface,
			TInterface tInterface, InterfaceDeclaration eSuperInterface, InterfaceDeclaration eInterfaceDeclaration,
