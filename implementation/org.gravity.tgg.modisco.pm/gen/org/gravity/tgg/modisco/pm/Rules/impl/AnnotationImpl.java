...
public class AnnotationImpl extends AbstractRuleImpl implements Annotation {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationImpl.pattern_Annotation_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				AnnotationToTAnnotation, tAnnotable, tAnnotation, astNode, aSTNodeToTAnnotable, Annotation);
		...
		//nothing EMoflonEdge AnnotationToTAnnotation__Annotation____source = (EMoflonEdge) result3_green[8];
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject AnnotationToTAnnotation, EObject tAnnotable,
			EObject tAnnotation, EObject astNode, EObject aSTNodeToTAnnotable, EObject Annotation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_24(EMoflonEdge _edge_tAnnotated) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_26(EMoflonEdge _edge_annotations) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TANNOTATABLE_BODYDECLARATION_ASTNODETOTANNOTATABLE_ANNOTATION:
		...
		case RulesPackage.ANNOTATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_24__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_24((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_26__EMOFLONEDGE:
			...
			if (tmpAstNode instanceof BodyDeclaration) {
				...
				if (tmpASTNodeToTAnnotable instanceof ASTNodeToTAnnotatable) {
					...
					if (tmpAnnotation instanceof org.eclipse.modisco.java.Annotation) {
						...
						return new Object[] { tAnnotable, astNode, aSTNodeToTAnnotable, annotation, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_Annotation_1_1_performtransformation_blackBBBBFBB(TAnnotatable tAnnotable,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAnnotable, astNode, aSTNodeToTAnnotable, annotation, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Annotation_1_1_performtransformation_bindingAndBlackFFFFFBB(Annotation _this,
		...
		if (result_pattern_Annotation_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Annotation_1_1_performtransformation_black = pattern_Annotation_1_1_performtransformation_blackBBBBFBB(
					tAnnotable, astNode, aSTNodeToTAnnotable, annotation, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Annotation_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			...
			EObject aSTNodeToTAnnotable, EObject annotation) {
	...
	public static final Object[] pattern_Annotation_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, annotationToTAnnotation, tAnnotable, tAnnotation, astNode, annotation,
				annotationToTAnnotation__tAnnotation____target, astNode__Annotation____annotations,
	...
	public static final void pattern_Annotation_1_5_registerobjects_expressionBBBBBBBB(Annotation _this,
			PerformRuleResult ruleresult, EObject annotationToTAnnotation, EObject tAnnotable, EObject tAnnotation,
			EObject astNode, EObject aSTNodeToTAnnotable, EObject annotation) {
		_this.registerObjects_FWD(ruleresult, annotationToTAnnotation, tAnnotable, tAnnotation, astNode,
	...
	public static final Iterable<Object[]> pattern_Annotation_2_2_corematch_blackFBFBB(BodyDeclaration astNode,
		...
		for (ASTNodeToTAnnotatable aSTNodeToTAnnotable : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAnnotable != null) {
				_result.add(new Object[] { tAnnotable, astNode, aSTNodeToTAnnotable, annotation, match });
			}
		...
		if (tAnnotable.equals(aSTNodeToTAnnotable.getTarget())) {
			if (astNode.getAnnotations().contains(annotation)) {
				if (astNode.equals(aSTNodeToTAnnotable.getSource())) {
					_result.add(new Object[] { tAnnotable, astNode, aSTNodeToTAnnotable, annotation });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_Annotation_2_4_solveCSP_bindingFBBBBBB(Annotation _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tAnnotable, astNode,
				aSTNodeToTAnnotable, annotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAnnotable, astNode, aSTNodeToTAnnotable, annotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_Annotation_2_4_solveCSP_bindingAndBlackFBBBBBB(Annotation _this,
		...
		Object[] result_pattern_Annotation_2_4_solveCSP_binding = pattern_Annotation_2_4_solveCSP_bindingFBBBBBB(_this,
				isApplicableMatch, tAnnotable, astNode, aSTNodeToTAnnotable, annotation);
	...
	public static final void pattern_Annotation_11_5_registerobjects_expressionBBBBBBBB(Annotation _this,
			PerformRuleResult ruleresult, EObject annotationToTAnnotation, EObject tAnnotable, EObject tAnnotation,
			EObject astNode, EObject aSTNodeToTAnnotable, EObject annotation) {
		_this.registerObjects_BWD(ruleresult, annotationToTAnnotation, tAnnotable, tAnnotation, astNode,
				aSTNodeToTAnnotable, annotation);
	...
	public static final Object[] pattern_Annotation_20_2_testcorematchandDECs_black_nac_0BB(TAnnotation tAnnotation,
			TAnnotatable tAnnotable) {
		TAnnotatable __DEC_tAnnotation_tAnnotation_820333 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotation_820333 != null) {
			if (!tAnnotable.equals(__DEC_tAnnotation_tAnnotation_820333)) {
	...
	public static final Object[] pattern_Annotation_21_2_testcorematchandDECs_black_nac_0B(
			org.eclipse.modisco.java.Annotation annotation) {
		for (AnnotationMemberValuePair __DEC_Annotation_value_587872 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Annotation_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Annotation annotation) {
		for (AnnotationMemberValuePair __DEC_Annotation_value_972711 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(annotation, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { annotation };
		}
		return null;
	...
	public static final Object[] pattern_Annotation_28_1_matchtggpattern_black_nac_0BB(TAnnotation tAnnotation,
			TAnnotatable tAnnotable) {
		TAnnotatable __DEC_tAnnotation_tAnnotation_769686 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotation_769686 != null) {
			if (!tAnnotable.equals(__DEC_tAnnotation_tAnnotation_769686)) {
				return new Object[] { tAnnotation, tAnnotable };
			}
		}
