...
public class AnnotationImpl extends AbstractRuleImpl implements Annotation {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationImpl.pattern_Annotation_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				tAnnotation, astNode, tAnnotable, AnnotationToTAnnotation, aSTNodeToTAnnotable, Annotation);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tAnnotation] = " + tAnnotation + ", " + "[astNode] = " + astNode + ", "
					+ "[tAnnotable] = " + tAnnotable + ", " + "[AnnotationToTAnnotation] = " + AnnotationToTAnnotation
					+ ", " + "[aSTNodeToTAnnotable] = " + aSTNodeToTAnnotable + ", " + "[Annotation] = " + Annotation
					+ ".");
		}
		AnnotationImpl.pattern_Annotation_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tAnnotation, astNode,
				tAnnotable, AnnotationToTAnnotation, Annotation);
		...
		// 
		// 
		AnnotationImpl.pattern_Annotation_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tAnnotation, astNode,
				tAnnotable, AnnotationToTAnnotation, aSTNodeToTAnnotable, Annotation);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationImpl.pattern_Annotation_2_2_corematch_blackBFFBB(astNode, Annotation,
			...
			for (Object[] result3_black : AnnotationImpl.pattern_Annotation_2_3_findcontext_blackBBBB(astNode,
					tAnnotable, aSTNodeToTAnnotable, Annotation)) {
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tAnnotation, EObject astNode,
			EObject tAnnotable, EObject AnnotationToTAnnotation, EObject aSTNodeToTAnnotable, EObject Annotation) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = AnnotationImpl.pattern_Annotation_11_1_performtransformation_greenBBFF(tAnnotation,
				astNode);
		AnnotationToTAnnotation AnnotationToTAnnotation = (AnnotationToTAnnotation) result1_green[2];
		...
		AnnotationImpl.pattern_Annotation_11_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tAnnotation, astNode,
				tAnnotable, AnnotationToTAnnotation, Annotation);
		//nothing EMoflonEdge AnnotationToTAnnotation__tAnnotation____target = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge tAnnotation__tAnnotable____tAnnotated = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge tAnnotable__tAnnotation____tAnnotation = (EMoflonEdge) result3_green[8];
		...
		AnnotationImpl.pattern_Annotation_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tAnnotation,
				astNode, tAnnotable, AnnotationToTAnnotation, aSTNodeToTAnnotable, Annotation);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_36(EMoflonEdge _edge_tAnnotated) {
		...
		if (AnnotationImpl.pattern_Annotation_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationImpl.pattern_Annotation_24_5_matchcorrcontext_blackBBFBB(astNode,
				...
				Object[] result6_black = AnnotationImpl.pattern_Annotation_24_6_createcorrespondence_blackBBBBB(
						tAnnotation, astNode, tAnnotable, Annotation, ccMatch);
				if (result6_black == null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_BODYDECLARATION_TANNOTATABLE_ASTNODETOTANNOTATABLE_ANNOTATION:
		...
		case RulesPackage.ANNOTATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_36__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_36((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_38__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION___IS_APPLICABLE_SOLVE_CSP_CC__TANNOTATION_BODYDECLARATION_TANNOTATABLE_ANNOTATION_MATCH_MATCH:
	...
	public static final Object[] pattern_Annotation_1_1_performtransformation_greenFBFB(TAnnotatable tAnnotable,
		...
		return new Object[] { tAnnotation, tAnnotable, annotationToTAnnotation, annotation };
	}
	...
	public static final Object[] pattern_Annotation_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject tAnnotation, EObject astNode, EObject tAnnotable, EObject annotationToTAnnotation,
	...
	public static final Object[] pattern_Annotation_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tAnnotation, EObject astNode, EObject tAnnotable,
		...
		astNode__Annotation____annotations.setName(astNode__Annotation____annotations_name_prime);
		return new Object[] { ruleresult, tAnnotation, astNode, tAnnotable, annotationToTAnnotation, annotation,
	...
	public static final void pattern_Annotation_1_5_registerobjects_expressionBBBBBBBB(Annotation _this,
			PerformRuleResult ruleresult, EObject tAnnotation, EObject astNode, EObject tAnnotable,
			EObject annotationToTAnnotation, EObject aSTNodeToTAnnotable, EObject annotation) {
		_this.registerObjects_FWD(ruleresult, tAnnotation, astNode, tAnnotable, annotationToTAnnotation,
				aSTNodeToTAnnotable, annotation);
	...
	public static final Object[] pattern_Annotation_11_1_performtransformation_greenBBFF(TAnnotation tAnnotation,
			BodyDeclaration astNode) {
		AnnotationToTAnnotation annotationToTAnnotation = PmFactory.eINSTANCE.createAnnotationToTAnnotation();
	...
	public static final void pattern_Annotation_11_5_registerobjects_expressionBBBBBBBB(Annotation _this,
			PerformRuleResult ruleresult, EObject tAnnotation, EObject astNode, EObject tAnnotable,
			EObject annotationToTAnnotation, EObject aSTNodeToTAnnotable, EObject annotation) {
		_this.registerObjects_BWD(ruleresult, tAnnotation, astNode, tAnnotable, annotationToTAnnotation,
				aSTNodeToTAnnotable, annotation);
	...
	public static final Object[] pattern_Annotation_20_2_testcorematchandDECs_black_nac_0BB(TAnnotation tAnnotation,
			TAnnotatable tAnnotable) {
		TAnnotatable __DEC_tAnnotation_tAnnotation_576175 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotation_576175 != null) {
			if (!tAnnotable.equals(__DEC_tAnnotation_tAnnotation_576175)) {
	...
	public static final Object[] pattern_Annotation_21_2_testcorematchandDECs_black_nac_0B(
			org.eclipse.modisco.java.Annotation annotation) {
		for (AnnotationMemberValuePair __DEC_Annotation_value_423972 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Annotation_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Annotation annotation) {
		for (AnnotationMemberValuePair __DEC_Annotation_value_662515 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(annotation, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { annotation };
		}
		return null;
	...
	public static final Object[] pattern_Annotation_28_1_matchtggpattern_black_nac_0BB(TAnnotation tAnnotation,
			TAnnotatable tAnnotable) {
		TAnnotatable __DEC_tAnnotation_tAnnotation_411967 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotation_411967 != null) {
			if (!tAnnotable.equals(__DEC_tAnnotation_tAnnotation_411967)) {
				return new Object[] { tAnnotation, tAnnotable };
			}
		}
	...
	public static final Object[] pattern_Annotation_29_6_perform_greenFBBFFB(BodyDeclaration astNode,
		...
		return new Object[] { tAnnotation, astNode, tAnnotable, annotationToTAnnotation, annotation, ruleResult };
	}
