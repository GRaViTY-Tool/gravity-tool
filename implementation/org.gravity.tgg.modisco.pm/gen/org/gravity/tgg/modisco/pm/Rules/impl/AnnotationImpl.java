...
public class AnnotationImpl extends AbstractRuleImpl implements Annotation {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationImpl.pattern_Annotation_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				aSTNodeToTAnnotable, Annotation, tAnnotable, AnnotationToTAnnotation, astNode, tAnnotation);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[aSTNodeToTAnnotable] = " + aSTNodeToTAnnotable + ", " + "[Annotation] = " + Annotation
					+ ", " + "[tAnnotable] = " + tAnnotable + ", " + "[AnnotationToTAnnotation] = "
					+ AnnotationToTAnnotation + ", " + "[astNode] = " + astNode + ", " + "[tAnnotation] = "
					+ tAnnotation + ".");
		}
		AnnotationImpl.pattern_Annotation_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, Annotation, tAnnotable,
				AnnotationToTAnnotation, astNode, tAnnotation);
		...
		AnnotationImpl.pattern_Annotation_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, aSTNodeToTAnnotable,
				Annotation, tAnnotable, AnnotationToTAnnotation, astNode, tAnnotation);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject aSTNodeToTAnnotable, EObject Annotation,
			EObject tAnnotable, EObject AnnotationToTAnnotation, EObject astNode, EObject tAnnotation) {
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject aSTNodeToTAnnotable, EObject Annotation,
			EObject tAnnotable, EObject AnnotationToTAnnotation, EObject astNode, EObject tAnnotation) {
		ruleresult.registerObject("aSTNodeToTAnnotable", aSTNodeToTAnnotable);
		ruleresult.registerObject("Annotation", Annotation);
		ruleresult.registerObject("tAnnotable", tAnnotable);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_6(EMoflonEdge _edge_annotations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationImpl.pattern_Annotation_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
				Annotation, tAnnotable, astNode, tAnnotation, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[Annotation] = " + Annotation + ", " + "[tAnnotable] = " + tAnnotable + ", " + "[astNode] = "
		...
		if (AnnotationImpl.pattern_Annotation_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationImpl.pattern_Annotation_24_5_matchcorrcontext_blackFBBBB(tAnnotable,
				...
				Object[] result6_black = AnnotationImpl.pattern_Annotation_24_6_createcorrespondence_blackBBBBB(
						Annotation, tAnnotable, astNode, tAnnotation, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[Annotation] = "
							+ Annotation + ", " + "[tAnnotable] = " + tAnnotable + ", " + "[astNode] = " + astNode
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODETOTANNOTATABLE_ANNOTATION_TANNOTATABLE_BODYDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(ASTNodeToTAnnotatable) arguments.get(1), (org.eclipse.modisco.java.Annotation) arguments.get(2),
		...
		case RulesPackage.ANNOTATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_6__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_6((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_6__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION___IS_APPLICABLE_SOLVE_CSP_CC__ANNOTATION_TANNOTATABLE_BODYDECLARATION_TANNOTATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((org.eclipse.modisco.java.Annotation) arguments.get(0),
					(TAnnotatable) arguments.get(1), (BodyDeclaration) arguments.get(2), (TAnnotation) arguments.get(3),
	...
	public static final Object[] pattern_Annotation_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject aSTNodeToTAnnotable, EObject annotation, EObject tAnnotable, EObject annotationToTAnnotation,
	...
	public static final Object[] pattern_Annotation_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, annotation, tAnnotable, annotationToTAnnotation, astNode, tAnnotation,
	...
	public static final void pattern_Annotation_1_5_registerobjects_expressionBBBBBBBB(Annotation _this,
			PerformRuleResult ruleresult, EObject aSTNodeToTAnnotable, EObject annotation, EObject tAnnotable,
			EObject annotationToTAnnotation, EObject astNode, EObject tAnnotation) {
		_this.registerObjects_FWD(ruleresult, aSTNodeToTAnnotable, annotation, tAnnotable, annotationToTAnnotation,
				astNode, tAnnotation);
	...
	public static final Object[] pattern_Annotation_11_1_performtransformation_greenFFBB(BodyDeclaration astNode,
		...
		annotationToTAnnotation.setSource(annotation);
		annotationToTAnnotation.setTarget(tAnnotation);
		return new Object[] { annotation, annotationToTAnnotation, astNode, tAnnotation };
	}
	...
	public static final void pattern_Annotation_11_5_registerobjects_expressionBBBBBBBB(Annotation _this,
			PerformRuleResult ruleresult, EObject aSTNodeToTAnnotable, EObject annotation, EObject tAnnotable,
			EObject annotationToTAnnotation, EObject astNode, EObject tAnnotation) {
		_this.registerObjects_BWD(ruleresult, aSTNodeToTAnnotable, annotation, tAnnotable, annotationToTAnnotation,
				astNode, tAnnotation);
	...
	public static final Object[] pattern_Annotation_20_2_testcorematchandDECs_black_nac_0BB(TAnnotation tAnnotation,
			TAnnotatable tAnnotable) {
		TAnnotatable __DEC_tAnnotation_tAnnotation_873867 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotation_873867 != null) {
			if (!tAnnotable.equals(__DEC_tAnnotation_tAnnotation_873867)) {
	...
	public static final Object[] pattern_Annotation_21_2_testcorematchandDECs_black_nac_0B(
		...
		for (AnnotationMemberValuePair __DEC_Annotation_value_750716 : org.moflon.core.utilities.eMoflonEMFUtil
		...
		if (tmpAnnotation instanceof org.eclipse.modisco.java.Annotation) {
			...
			if (tmpTAnnotable instanceof TAnnotatable) {
				...
				if (tmpAstNode instanceof BodyDeclaration) {
					...
					if (tmpTAnnotation instanceof TAnnotation) {
						TAnnotation tAnnotation = (TAnnotation) tmpTAnnotation;
						return new Object[] { annotation, tAnnotable, astNode, tAnnotation, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_Annotation_24_3_solvecsp_bindingFBBBBBBB(Annotation _this,
			org.eclipse.modisco.java.Annotation annotation, TAnnotatable tAnnotable, BodyDeclaration astNode,
			TAnnotation tAnnotation, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(annotation, tAnnotable, astNode, tAnnotation, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, annotation, tAnnotable, astNode, tAnnotation, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Annotation_24_3_solvecsp_bindingAndBlackFBBBBBBB(Annotation _this,
		...
		Object[] result_pattern_Annotation_24_3_solvecsp_binding = pattern_Annotation_24_3_solvecsp_bindingFBBBBBBB(
				_this, annotation, tAnnotable, astNode, tAnnotation, sourceMatch, targetMatch);
		if (result_pattern_Annotation_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_Annotation_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, annotation, tAnnotable, astNode, tAnnotation, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Annotation_24_6_createcorrespondence_blackBBBBB(
			org.eclipse.modisco.java.Annotation annotation, TAnnotatable tAnnotable, BodyDeclaration astNode,
			TAnnotation tAnnotation, CCMatch ccMatch) {
		return new Object[] { annotation, tAnnotable, astNode, tAnnotation, ccMatch };
	}
	...
	public static final Object[] pattern_Annotation_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Annotation annotation) {
		for (AnnotationMemberValuePair __DEC_Annotation_value_829176 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(annotation, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { annotation };
		}
		return null;
	...
	public static final Object[] pattern_Annotation_28_1_matchtggpattern_black_nac_0BB(TAnnotation tAnnotation,
			TAnnotatable tAnnotable) {
		TAnnotatable __DEC_tAnnotation_tAnnotation_449180 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotation_449180 != null) {
			if (!tAnnotable.equals(__DEC_tAnnotation_tAnnotation_449180)) {
				return new Object[] { tAnnotation, tAnnotable };
			}
		}
	...
	public static final Object[] pattern_Annotation_29_6_perform_greenFBFBFB(TAnnotatable tAnnotable,
		...
		return new Object[] { annotation, tAnnotable, annotationToTAnnotation, astNode, tAnnotation, ruleResult };
	}
