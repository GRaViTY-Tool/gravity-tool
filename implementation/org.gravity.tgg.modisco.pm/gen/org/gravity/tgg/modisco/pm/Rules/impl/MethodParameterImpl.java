...
public class MethodParameterImpl extends AbstractRuleImpl implements MethodParameter {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MethodParameterImpl
				.pattern_MethodParameter_1_1_performtransformation_greenBBFFFBB(tSiganture, tAbstractType, mEntry, csp);
		...
		Object[] result2_black = MethodParameterImpl.pattern_MethodParameter_1_2_collecttranslatedelements_blackBBBB(
				mEntryToTParameter, mFlowElementToTFlowElement, tParameter, mEntry);
		...
		Object[] result3_black = MethodParameterImpl.pattern_MethodParameter_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, tSiganture, tAbstractType, mEntryToTParameter, mTypeToTType, mSignature,
				mSignatureToTSignature, mFlowElementToTFlowElement, mType, tParameter, mEntry);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ ", " + "[mFlowElementToTFlowElement] = " + mFlowElementToTFlowElement + ", " + "[mType] = "
					+ mType + ", " + "[tParameter] = " + tParameter + ", " + "[mEntry] = " + mEntry + ".");
		}
		MethodParameterImpl.pattern_MethodParameter_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult,
				tSiganture, tAbstractType, mEntryToTParameter, mSignature, mFlowElementToTFlowElement, mType,
				tParameter, mEntry);
		...
		MethodParameterImpl.pattern_MethodParameter_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				tSiganture, tAbstractType, mEntryToTParameter, mTypeToTType, mSignature, mSignatureToTSignature,
				mFlowElementToTFlowElement, mType, tParameter, mEntry);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterImpl
			...
			for (Object[] result3_black : MethodParameterImpl.pattern_MethodParameter_2_3_findcontext_blackBBBBBBB(
					tSiganture, tAbstractType, mTypeToTType, mSignature, mSignatureToTSignature, mType, mEntry)) {
				Object[] result3_green = MethodParameterImpl
						.pattern_MethodParameter_2_3_findcontext_greenBBBBBBBFFFFFFF(tSiganture, tAbstractType,
								mTypeToTType, mSignature, mSignatureToTSignature, mType, mEntry);
				...
				Object[] result4_bindingAndBlack = MethodParameterImpl
						.pattern_MethodParameter_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tSiganture, tAbstractType, mTypeToTType, mSignature, mSignatureToTSignature, mType,
								mEntry);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mSignatureToTSignature + ", " + "[mType] = " + mType + ", " + "[mEntry] = " + mEntry
							+ ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMethodSignature tSiganture,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, MMethodSignature mSignature,
			MSignatureToTSignature mSignatureToTSignature, Type mType, MEntry mEntry) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tSiganture, EObject tAbstractType,
			EObject mEntryToTParameter, EObject mTypeToTType, EObject mSignature, EObject mSignatureToTSignature,
			EObject mFlowElementToTFlowElement, EObject mType, EObject tParameter, EObject mEntry) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MethodParameterImpl
				.pattern_MethodParameter_11_1_performtransformation_greenFBFBBF(mSignature, mType, tParameter);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterImpl
			...
			for (Object[] result3_black : MethodParameterImpl.pattern_MethodParameter_12_3_findcontext_blackBBBBBBB(
					tSiganture, tAbstractType, mTypeToTType, mSignature, mSignatureToTSignature, mType, tParameter)) {
				Object[] result3_green = MethodParameterImpl
						.pattern_MethodParameter_12_3_findcontext_greenBBBBBBBFFFFFFF(tSiganture, tAbstractType,
								mTypeToTType, mSignature, mSignatureToTSignature, mType, tParameter);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge mTypeToTType__tAbstractType____target = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tSiganture__tParameter____parameters = (EMoflonEdge) result3_green[9];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ ", " + "[tAbstractType] = " + tAbstractType + ", " + "[mTypeToTType] = " + mTypeToTType
							+ ", " + "[mSignature] = " + mSignature + ", " + "[mSignatureToTSignature] = "
							+ mSignatureToTSignature + ", " + "[mType] = " + mType + ", " + "[tParameter] = "
							+ tParameter + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethodSignature tSiganture,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, MMethodSignature mSignature,
			MSignatureToTSignature mSignatureToTSignature, Type mType, TParameter tParameter) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_68(EMoflonEdge _edge_mEntrys) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodParameterImpl
				.pattern_MethodParameter_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tSiganture, tAbstractType,
		...
		if (MethodParameterImpl.pattern_MethodParameter_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterImpl
					.pattern_MethodParameter_24_5_matchcorrcontext_blackBBFBFBBB(tSiganture, tAbstractType, mSignature,
				...
				Object[] result6_black = MethodParameterImpl
						.pattern_MethodParameter_24_6_createcorrespondence_blackBBBBBBB(tSiganture, tAbstractType,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMethodSignature tSiganture, TAbstractType tAbstractType,
		...
		for (Object[] result2_black : MethodParameterImpl
			...
			if (MethodParameterImpl.pattern_MethodParameter_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					MethodParameterImpl.pattern_MethodParameter_29_6_perform_greenBBFBFBFFBB(tSiganture, tAbstractType,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethodSignature tSiganture,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, MMethodSignature mSignature,
			MSignatureToTSignature mSignatureToTSignature, Type mType, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_MMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_TYPE_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_MMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_TYPE_TPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_65__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_65((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_68__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPLICABLE_SOLVE_CSP_CC__TMETHODSIGNATURE_TABSTRACTTYPE_MMETHODSIGNATURE_TYPE_TPARAMETER_MENTRY_MATCH_MATCH:
		...
		case RulesPackage.METHOD_PARAMETER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_MMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_TYPE_MODELGENERATORRULERESULT:
						...
						if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
							...
							if (tmpMType instanceof Type) {
								...
								if (tmpMEntry instanceof MEntry) {
									...
									return new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature,
											mSignatureToTSignature, mType, mEntry, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MethodParameter_1_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature, mSignatureToTSignature,
	...
	public static final Object[] pattern_MethodParameter_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MethodParameter_1_1_performtransformation_binding != null) {
			...
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result_pattern_MethodParameter_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_MethodParameter_1_1_performtransformation_black = pattern_MethodParameter_1_1_performtransformation_blackBBBBBBBFBB(
					tSiganture, tAbstractType, mTypeToTType, mSignature, mSignatureToTSignature, mType, mEntry, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodParameter_1_1_performtransformation_greenBBFFFBB(
		...
		return new Object[] { tSiganture, tAbstractType, mEntryToTParameter, mFlowElementToTFlowElement, tParameter,
				mEntry, csp };
	}
	...
	public static final Object[] pattern_MethodParameter_1_2_collecttranslatedelements_blackBBBB(
			...
			MEntry mEntry) {
		return new Object[] { mEntryToTParameter, mFlowElementToTFlowElement, tParameter, mEntry };
	}
	...
	public static final Object[] pattern_MethodParameter_1_2_collecttranslatedelements_greenFBBBB(
		...
		return new Object[] { ruleresult, mEntryToTParameter, mFlowElementToTFlowElement, tParameter, mEntry };
	}

	public static final Object[] pattern_MethodParameter_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tSiganture, EObject tAbstractType, EObject mEntryToTParameter,
	...
	public static final Object[] pattern_MethodParameter_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject tSiganture, EObject tAbstractType, EObject mEntryToTParameter,
			EObject mSignature, EObject mFlowElementToTFlowElement, EObject mType, EObject tParameter, EObject mEntry) {
		...
		mEntry__mType____type.setName(mEntry__mType____type_name_prime);
		return new Object[] { ruleresult, tSiganture, tAbstractType, mEntryToTParameter, mSignature,
				mFlowElementToTFlowElement, mType, tParameter, mEntry, tSiganture__tParameter____parameters,
				mEntryToTParameter__tParameter____target, mFlowElementToTFlowElement__tParameter____target,
				mSignature__mEntry____mEntrys, mEntryToTParameter__mEntry____source,
				mFlowElementToTFlowElement__mEntry____source, tParameter__tAbstractType____type,
	...
	public static final void pattern_MethodParameter_1_5_registerobjects_expressionBBBBBBBBBBBB(MethodParameter _this,
			...
			EObject mTypeToTType, EObject mSignature, EObject mSignatureToTSignature,
			EObject mFlowElementToTFlowElement, EObject mType, EObject tParameter, EObject mEntry) {
		_this.registerObjects_FWD(ruleresult, tSiganture, tAbstractType, mEntryToTParameter, mTypeToTType, mSignature,
				mSignatureToTSignature, mFlowElementToTFlowElement, mType, tParameter, mEntry);
			...
			if (tmpTSiganture instanceof TMethodSignature) {
				...
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAbstractType != null) {
						_result.add(new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature,
								mSignatureToTSignature, mType, mEntry, match });
					}
					...
					if (mSignature.getMEntrys().contains(mEntry)) {
						if (mType.equals(mTypeToTType.getSource())) {
							if (mType.equals(mEntry.getType())) {
								_result.add(new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature,
										mSignatureToTSignature, mType, mEntry });
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameter_2_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		mEntry__mType____type.setName(mEntry__mType____type_name_prime);
		return new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature, mSignatureToTSignature, mType,
				mEntry, isApplicableMatch, mTypeToTType__tAbstractType____target,
				mSignatureToTSignature__mSignature____source, mSignatureToTSignature__tSiganture____target,
				mSignature__mEntry____mEntrys, mTypeToTType__mType____source, mEntry__mType____type };
	}
	...
	public static final Object[] pattern_MethodParameter_2_4_solveCSP_bindingFBBBBBBBBB(MethodParameter _this,
			...
			MSignatureToTSignature mSignatureToTSignature, Type mType, MEntry mEntry) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tSiganture, tAbstractType,
				mTypeToTType, mSignature, mSignatureToTSignature, mType, mEntry);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSiganture, tAbstractType, mTypeToTType, mSignature,
					mSignatureToTSignature, mType, mEntry };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		Object[] result_pattern_MethodParameter_2_4_solveCSP_binding = pattern_MethodParameter_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tSiganture, tAbstractType, mTypeToTType, mSignature, mSignatureToTSignature,
				mType, mEntry);
		if (result_pattern_MethodParameter_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodParameter_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tSiganture, tAbstractType, mTypeToTType,
						mSignature, mSignatureToTSignature, mType, mEntry };
			}
		}
		return null;
	}
						...
						if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
							...
							if (tmpMType instanceof Type) {
								...
								if (tmpTParameter instanceof TParameter) {
									...
									return new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature,
											mSignatureToTSignature, mType, tParameter, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MethodParameter_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MethodParameter_11_1_performtransformation_binding != null) {
			...
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result_pattern_MethodParameter_11_1_performtransformation_binding[4];
	...
	public static final Object[] pattern_MethodParameter_11_1_performtransformation_greenFBFBBF(
		...
		return new Object[] { mEntryToTParameter, mSignature, mFlowElementToTFlowElement, mType, tParameter, mEntry };
	}
	...
	public static final void pattern_MethodParameter_11_5_registerobjects_expressionBBBBBBBBBBBB(MethodParameter _this,
			...
			EObject mTypeToTType, EObject mSignature, EObject mSignatureToTSignature,
			EObject mFlowElementToTFlowElement, EObject mType, EObject tParameter, EObject mEntry) {
		_this.registerObjects_BWD(ruleresult, tSiganture, tAbstractType, mEntryToTParameter, mTypeToTType, mSignature,
				mSignatureToTSignature, mFlowElementToTFlowElement, mType, tParameter, mEntry);
				...
				if (mType != null) {
					for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tmpMSignature instanceof MMethodSignature) {
							MMethodSignature mSignature = (MMethodSignature) tmpMSignature;
							_result.add(new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature,
									mSignatureToTSignature, mType, tParameter, match });
						}
					...
					if (tSiganture.equals(mSignatureToTSignature.getTarget())) {
						if (mType.equals(mTypeToTType.getSource())) {
							if (tAbstractType.equals(tParameter.getType())) {
								...
								if (Integer.valueOf(tParameter_lowerBound).equals(Integer.valueOf(0))) {
									_result.add(new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature,
											mSignatureToTSignature, mType, tParameter });
								}
	...
	public static final Object[] pattern_MethodParameter_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		return new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature, mSignatureToTSignature, mType,
				...
				tSiganture__tParameter____parameters, mSignatureToTSignature__mSignature____source,
	...
	public static final Object[] pattern_MethodParameter_12_4_solveCSP_bindingFBBBBBBBBB(MethodParameter _this,
			IsApplicableMatch isApplicableMatch, TMethodSignature tSiganture, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, MMethodSignature mSignature,
			MSignatureToTSignature mSignatureToTSignature, Type mType, TParameter tParameter) {
	...
	public static final Object[] pattern_MethodParameter_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		if (result_pattern_MethodParameter_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodParameter_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tSiganture, tAbstractType, mTypeToTType,
						mSignature, mSignatureToTSignature, mType, tParameter };
			}
		}
		return null;
	}
				...
				if (tmpMSignature instanceof MMethodSignature) {
					...
					if (tmpMType instanceof Type) {
						...
						if (tmpTParameter instanceof TParameter) {
							...
							if (tmpMEntry instanceof MEntry) {
								MEntry mEntry = (MEntry) tmpMEntry;
								return new Object[] { tSiganture, tAbstractType, mSignature, mType, tParameter, mEntry,
	...
	public static final Object[] pattern_MethodParameter_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			int tParameter_lowerBound = tParameter.getLowerBound();
			if (Integer.valueOf(tParameter_lowerBound).equals(Integer.valueOf(0))) {
				return new Object[] { tSiganture, tAbstractType, mSignature, mType, tParameter, mEntry, sourceMatch,
						targetMatch };
			}
	...
	public static final Object[] pattern_MethodParameter_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MethodParameter_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodParameter_24_2_matchsrctrgcontext_black = pattern_MethodParameter_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tSiganture, tAbstractType, mSignature, mType, tParameter, mEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameter_24_3_solvecsp_bindingFBBBBBBBBB(MethodParameter _this,
			TMethodSignature tSiganture, TAbstractType tAbstractType, MMethodSignature mSignature, Type mType,
			TParameter tParameter, MEntry mEntry, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tSiganture, tAbstractType, mSignature, mType, tParameter,
				mEntry, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tSiganture, tAbstractType, mSignature, mType, tParameter, mEntry,
	...
	public static final Object[] pattern_MethodParameter_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		Object[] result_pattern_MethodParameter_24_3_solvecsp_binding = pattern_MethodParameter_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tSiganture, tAbstractType, mSignature, mType, tParameter, mEntry, sourceMatch, targetMatch);
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mType.equals(mTypeToTType.getSource())) {
					for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tSiganture.equals(mSignatureToTSignature.getTarget())) {
							_result.add(new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature,
									mSignatureToTSignature, mType, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameter_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tSiganture, tAbstractType, mSignature, mType, tParameter, mEntry, ccMatch };
	}
	...
	public static final Object[] pattern_MethodParameter_24_6_createcorrespondence_greenFFBBB(TParameter tParameter,
		...
		return new Object[] { mEntryToTParameter, mFlowElementToTFlowElement, tParameter, mEntry, ccMatch };
	}
	...
	public static final Object[] pattern_MethodParameter_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameter _this,
			IsApplicableMatch isApplicableMatch, TMethodSignature tSiganture, TAbstractType tAbstractType,
			TypeToTAbstractType mTypeToTType, MMethodSignature mSignature,
			MSignatureToTSignature mSignatureToTSignature, Type mType, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tSiganture, tAbstractType,
				mTypeToTType, mSignature, mSignatureToTSignature, mType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSiganture, tAbstractType, mTypeToTType, mSignature,
	...
	public static final Object[] pattern_MethodParameter_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		if (result_pattern_MethodParameter_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_MethodParameter_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tSiganture, tAbstractType, mTypeToTType,
						mSignature, mSignatureToTSignature, mType, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_29_5_checknacs_blackBBBBBB(TMethodSignature tSiganture,
			TAbstractType tAbstractType, TypeToTAbstractType mTypeToTType, MMethodSignature mSignature,
			MSignatureToTSignature mSignatureToTSignature, Type mType) {
		return new Object[] { tSiganture, tAbstractType, mTypeToTType, mSignature, mSignatureToTSignature, mType };
	}
	...
	public static final Object[] pattern_MethodParameter_29_6_perform_greenBBFBFBFFBB(TMethodSignature tSiganture,
		...
		return new Object[] { tSiganture, tAbstractType, mEntryToTParameter, mSignature, mFlowElementToTFlowElement,
