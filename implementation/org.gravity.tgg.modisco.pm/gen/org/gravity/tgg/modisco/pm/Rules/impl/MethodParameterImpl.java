...
public class MethodParameterImpl extends AbstractRuleImpl implements MethodParameter {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = MethodParameterImpl.pattern_MethodParameter_1_2_collecttranslatedelements_blackBBBB(
				mFlowElementToTFlowElement, mEntry, tParameter, mEntryToTParameter);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mFlowElementToTFlowElement] = "
					+ mFlowElementToTFlowElement + ", " + "[mEntry] = " + mEntry + ", " + "[tParameter] = " + tParameter
		...
		Object[] result3_black = MethodParameterImpl.pattern_MethodParameter_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, mSignature, mType, tSiganture, mFlowElementToTFlowElement, mTypeToTType, mEntry, tParameter,
				mEntryToTParameter, tAbstractType, mSignatureToTSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mSignature] = " + mSignature + ", " + "[mType] = " + mType + ", " + "[tSiganture] = "
					+ tSiganture + ", " + "[mFlowElementToTFlowElement] = " + mFlowElementToTFlowElement + ", "
					+ "[mTypeToTType] = " + mTypeToTType + ", " + "[mEntry] = " + mEntry + ", " + "[tParameter] = "
		...
		MethodParameterImpl.pattern_MethodParameter_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult,
				mSignature, mType, tSiganture, mFlowElementToTFlowElement, mEntry, tParameter, mEntryToTParameter,
				tAbstractType);
		...
		//nothing EMoflonEdge mFlowElementToTFlowElement__mEntry____source = (EMoflonEdge) result3_green[12];
		...
		MethodParameterImpl.pattern_MethodParameter_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				mSignature, mType, tSiganture, mFlowElementToTFlowElement, mTypeToTType, mEntry, tParameter,
				mEntryToTParameter, tAbstractType, mSignatureToTSignature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterImpl
				.pattern_MethodParameter_2_2_corematch_blackBBFFBFFB(mSignature, mType, mEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterImpl.pattern_MethodParameter_2_3_findcontext_blackBBBBBBB(
					mSignature, mType, tSiganture, mTypeToTType, mEntry, tAbstractType, mSignatureToTSignature)) {
				Object[] result3_green = MethodParameterImpl
						.pattern_MethodParameter_2_3_findcontext_greenBBBBBBBFFFFFFF(mSignature, mType, tSiganture,
								mTypeToTType, mEntry, tAbstractType, mSignatureToTSignature);
				...
				Object[] result4_bindingAndBlack = MethodParameterImpl
						.pattern_MethodParameter_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mSignature, mType, tSiganture, mTypeToTType, mEntry, tAbstractType,
								mSignatureToTSignature);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSignature] = " + mSignature
							+ ", " + "[mType] = " + mType + ", " + "[tSiganture] = " + tSiganture + ", "
							+ "[mTypeToTType] = " + mTypeToTType + ", " + "[mEntry] = " + mEntry + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MMethodSignature mSignature, Type mType,
			TMethodSignature tSiganture, TypeToTAbstractType mTypeToTType, MEntry mEntry, TAbstractType tAbstractType,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mSignature, EObject mType, EObject tSiganture,
			EObject mFlowElementToTFlowElement, EObject mTypeToTType, EObject mEntry, EObject tParameter,
			EObject mEntryToTParameter, EObject tAbstractType, EObject mSignatureToTSignature) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MethodParameterImpl
				.pattern_MethodParameter_11_1_performtransformation_greenBBFFBF(mSignature, mType, tParameter);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterImpl
				.pattern_MethodParameter_12_2_corematch_blackFFBFBBFB(tSiganture, tParameter, tAbstractType, match)) {
			...
			for (Object[] result3_black : MethodParameterImpl.pattern_MethodParameter_12_3_findcontext_blackBBBBBBB(
					mSignature, mType, tSiganture, mTypeToTType, tParameter, tAbstractType, mSignatureToTSignature)) {
				Object[] result3_green = MethodParameterImpl
						.pattern_MethodParameter_12_3_findcontext_greenBBBBBBBFFFFFFF(mSignature, mType, tSiganture,
								mTypeToTType, tParameter, tAbstractType, mSignatureToTSignature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = MethodParameterImpl
						.pattern_MethodParameter_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mSignature, mType, tSiganture, mTypeToTType, tParameter, tAbstractType,
								mSignatureToTSignature);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSignature] = " + mSignature
							+ ", " + "[mType] = " + mType + ", " + "[tSiganture] = " + tSiganture + ", "
							+ "[mTypeToTType] = " + mTypeToTType + ", " + "[tParameter] = " + tParameter + ", "
							+ "[tAbstractType] = " + tAbstractType + ", " + "[mSignatureToTSignature] = "
							+ mSignatureToTSignature + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MMethodSignature mSignature, Type mType,
			TMethodSignature tSiganture, TypeToTAbstractType mTypeToTType, TParameter tParameter,
			TAbstractType tAbstractType, MSignatureToTSignature mSignatureToTSignature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mSignature, EObject mType, EObject tSiganture,
			EObject mFlowElementToTFlowElement, EObject mTypeToTType, EObject mEntry, EObject tParameter,
			EObject mEntryToTParameter, EObject tAbstractType, EObject mSignatureToTSignature) {
		ruleresult.registerObject("mSignature", mSignature);
		ruleresult.registerObject("mType", mType);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_79(EMoflonEdge _edge_parameters) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_81(EMoflonEdge _edge_mEntrys) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodParameterImpl
				.pattern_MethodParameter_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mSignature, mType, tSiganture,
						mEntry, tParameter, tAbstractType, sourceMatch, targetMatch);
		...
		if (MethodParameterImpl.pattern_MethodParameter_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterImpl
					.pattern_MethodParameter_24_5_matchcorrcontext_blackBBBFBFBB(mSignature, mType, tSiganture,
				...
				Object[] result6_black = MethodParameterImpl
						.pattern_MethodParameter_24_6_createcorrespondence_blackBBBBBBB(mSignature, mType, tSiganture,
								mEntry, tParameter, tAbstractType, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MMethodSignature mSignature, Type mType, TMethodSignature tSiganture,
			MEntry mEntry, TParameter tParameter, TAbstractType tAbstractType, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : MethodParameterImpl
			...
			Object[] result3_bindingAndBlack = MethodParameterImpl
					.pattern_MethodParameter_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mSignature, mType, tSiganture, mTypeToTType, tAbstractType, mSignatureToTSignature,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSignature] = " + mSignature + ", "
						+ "[mType] = " + mType + ", " + "[tSiganture] = " + tSiganture + ", " + "[mTypeToTType] = "
						+ mTypeToTType + ", " + "[tAbstractType] = " + tAbstractType + ", "
			...
			if (MethodParameterImpl.pattern_MethodParameter_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					MethodParameterImpl.pattern_MethodParameter_29_6_perform_greenBBBFFFFBBB(mSignature, mType,
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MMethodSignature mSignature, Type mType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MMETHODSIGNATURE_TYPE_TMETHODSIGNATURE_TYPETOTABSTRACTTYPE_MENTRY_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MMethodSignature) arguments.get(1),
					(Type) arguments.get(2), (TMethodSignature) arguments.get(3),
					(TypeToTAbstractType) arguments.get(4), (MEntry) arguments.get(5), (TAbstractType) arguments.get(6),
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MMETHODSIGNATURE_TYPE_TMETHODSIGNATURE_TYPETOTABSTRACTTYPE_TPARAMETER_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (MMethodSignature) arguments.get(1),
					(Type) arguments.get(2), (TMethodSignature) arguments.get(3),
					(TypeToTAbstractType) arguments.get(4), (TParameter) arguments.get(5),
					(TAbstractType) arguments.get(6), (MSignatureToTSignature) arguments.get(7));
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_79__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_79((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_81__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPLICABLE_SOLVE_CSP_CC__MMETHODSIGNATURE_TYPE_TMETHODSIGNATURE_MENTRY_TPARAMETER_TABSTRACTTYPE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MMethodSignature) arguments.get(0), (Type) arguments.get(1),
					(TMethodSignature) arguments.get(2), (MEntry) arguments.get(3), (TParameter) arguments.get(4),
		...
		case RulesPackage.METHOD_PARAMETER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MMETHODSIGNATURE_TYPE_TMETHODSIGNATURE_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE_MODELGENERATORRULERESULT:
						...
						if (tmpMEntry instanceof MEntry) {
							...
							if (tmpTAbstractType instanceof TAbstractType) {
								...
								if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
									...
									return new Object[] { mSignature, mType, tSiganture, mTypeToTType, mEntry,
											tAbstractType, mSignatureToTSignature, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MethodParameter_1_1_performtransformation_blackBBBBBBBFBB(
			MMethodSignature mSignature, Type mType, TMethodSignature tSiganture, TypeToTAbstractType mTypeToTType,
			MEntry mEntry, TAbstractType tAbstractType, MSignatureToTSignature mSignatureToTSignature,
			MethodParameter _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mSignature, mType, tSiganture, mTypeToTType, mEntry, tAbstractType,
	...
	public static final Object[] pattern_MethodParameter_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MethodParameter_1_1_performtransformation_binding != null) {
			...
			TMethodSignature tSiganture = (TMethodSignature) result_pattern_MethodParameter_1_1_performtransformation_binding[2];
			...
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result_pattern_MethodParameter_1_1_performtransformation_binding[6];
			...
			Object[] result_pattern_MethodParameter_1_1_performtransformation_black = pattern_MethodParameter_1_1_performtransformation_blackBBBBBBBFBB(
					mSignature, mType, tSiganture, mTypeToTType, mEntry, tAbstractType, mSignatureToTSignature, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodParameter_1_1_performtransformation_greenBFBFFBB(
		...
		return new Object[] { tSiganture, mFlowElementToTFlowElement, mEntry, tParameter, mEntryToTParameter,
				tAbstractType, csp };
	}

	public static final Object[] pattern_MethodParameter_1_2_collecttranslatedelements_blackBBBB(
			MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement, MEntry mEntry, TParameter tParameter,
			MEntryToTParameter mEntryToTParameter) {
		return new Object[] { mFlowElementToTFlowElement, mEntry, tParameter, mEntryToTParameter };
	}
	...
	public static final Object[] pattern_MethodParameter_1_2_collecttranslatedelements_greenFBBBB(
		...
		return new Object[] { ruleresult, mFlowElementToTFlowElement, mEntry, tParameter, mEntryToTParameter };
	}

	public static final Object[] pattern_MethodParameter_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mSignature, EObject mType, EObject tSiganture,
			EObject mFlowElementToTFlowElement, EObject mTypeToTType, EObject mEntry, EObject tParameter,
			EObject mEntryToTParameter, EObject tAbstractType, EObject mSignatureToTSignature) {
	...
	public static final Object[] pattern_MethodParameter_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject mSignature, EObject mType, EObject tSiganture,
			EObject mFlowElementToTFlowElement, EObject mEntry, EObject tParameter, EObject mEntryToTParameter,
		...
		return new Object[] { ruleresult, mSignature, mType, tSiganture, mFlowElementToTFlowElement, mEntry, tParameter,
				mEntryToTParameter, tAbstractType, mSignature__mEntry____mEntrys, tSiganture__tParameter____parameters,
				mEntry__mType____type, mFlowElementToTFlowElement__mEntry____source,
	...
	public static final void pattern_MethodParameter_1_5_registerobjects_expressionBBBBBBBBBBBB(MethodParameter _this,
			...
			EObject mFlowElementToTFlowElement, EObject mTypeToTType, EObject mEntry, EObject tParameter,
			EObject mEntryToTParameter, EObject tAbstractType, EObject mSignatureToTSignature) {
		_this.registerObjects_FWD(ruleresult, mSignature, mType, tSiganture, mFlowElementToTFlowElement, mTypeToTType,
				mEntry, tParameter, mEntryToTParameter, tAbstractType, mSignatureToTSignature);
	...
	public static final Iterable<Object[]> pattern_MethodParameter_2_2_corematch_blackBBFFBFFB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAbstractType != null) {
				for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTSiganture instanceof TMethodSignature) {
						TMethodSignature tSiganture = (TMethodSignature) tmpTSiganture;
						_result.add(new Object[] { mSignature, mType, tSiganture, mTypeToTType, mEntry, tAbstractType,
					...
					if (mSignature.equals(mSignatureToTSignature.getSource())) {
						if (tAbstractType.equals(mTypeToTType.getTarget())) {
							if (tSiganture.equals(mSignatureToTSignature.getTarget())) {
								_result.add(new Object[] { mSignature, mType, tSiganture, mTypeToTType, mEntry,
										tAbstractType, mSignatureToTSignature });
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameter_2_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		return new Object[] { mSignature, mType, tSiganture, mTypeToTType, mEntry, tAbstractType,
				mSignatureToTSignature, isApplicableMatch, mSignature__mEntry____mEntrys, mTypeToTType__mType____source,
				mEntry__mType____type, mSignatureToTSignature__mSignature____source,
	...
	public static final Object[] pattern_MethodParameter_2_4_solveCSP_bindingFBBBBBBBBB(MethodParameter _this,
			IsApplicableMatch isApplicableMatch, MMethodSignature mSignature, Type mType, TMethodSignature tSiganture,
			TypeToTAbstractType mTypeToTType, MEntry mEntry, TAbstractType tAbstractType,
			MSignatureToTSignature mSignatureToTSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mSignature, mType, tSiganture,
				mTypeToTType, mEntry, tAbstractType, mSignatureToTSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSignature, mType, tSiganture, mTypeToTType, mEntry,
					tAbstractType, mSignatureToTSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		Object[] result_pattern_MethodParameter_2_4_solveCSP_binding = pattern_MethodParameter_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mSignature, mType, tSiganture, mTypeToTType, mEntry, tAbstractType,
				mSignatureToTSignature);
		if (result_pattern_MethodParameter_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodParameter_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mSignature, mType, tSiganture, mTypeToTType,
						mEntry, tAbstractType, mSignatureToTSignature };
			}
		}
		return null;
	}
					...
					if (tmpMTypeToTType instanceof TypeToTAbstractType) {
						...
						if (tmpTParameter instanceof TParameter) {
							...
							if (tmpTAbstractType instanceof TAbstractType) {
								...
								if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
									MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) tmpMSignatureToTSignature;
									return new Object[] { mSignature, mType, tSiganture, mTypeToTType, tParameter,
											tAbstractType, mSignatureToTSignature, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MethodParameter_11_1_performtransformation_blackBBBBBBBFBB(
			MMethodSignature mSignature, Type mType, TMethodSignature tSiganture, TypeToTAbstractType mTypeToTType,
			TParameter tParameter, TAbstractType tAbstractType, MSignatureToTSignature mSignatureToTSignature,
			MethodParameter _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mSignature, mType, tSiganture, mTypeToTType, tParameter, tAbstractType,
						mSignatureToTSignature, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameter_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MethodParameter_11_1_performtransformation_binding != null) {
			...
			Type mType = (Type) result_pattern_MethodParameter_11_1_performtransformation_binding[1];
	...
	public static final Object[] pattern_MethodParameter_11_1_performtransformation_greenBBFFBF(
		...
		mEntryToTParameter.setTarget(tParameter);
		mEntryToTParameter.setSource(mEntry);
		return new Object[] { mSignature, mType, mFlowElementToTFlowElement, mEntry, tParameter, mEntryToTParameter };
	}
	...
	public static final void pattern_MethodParameter_11_5_registerobjects_expressionBBBBBBBBBBBB(MethodParameter _this,
			...
			EObject mFlowElementToTFlowElement, EObject mTypeToTType, EObject mEntry, EObject tParameter,
			EObject mEntryToTParameter, EObject tAbstractType, EObject mSignatureToTSignature) {
		_this.registerObjects_BWD(ruleresult, mSignature, mType, tSiganture, mFlowElementToTFlowElement, mTypeToTType,
				mEntry, tParameter, mEntryToTParameter, tAbstractType, mSignatureToTSignature);
	...
	public static final Iterable<Object[]> pattern_MethodParameter_12_2_corematch_blackFFBFBBFB(
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mType != null) {
					for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tmpMSignature instanceof MMethodSignature) {
							MMethodSignature mSignature = (MMethodSignature) tmpMSignature;
							_result.add(new Object[] { mSignature, mType, tSiganture, mTypeToTType, tParameter,
									tAbstractType, mSignatureToTSignature, match });
						}
	...
	public static final Object[] pattern_MethodParameter_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		mSignatureToTSignature__tSiganture____target.setName(mSignatureToTSignature__tSiganture____target_name_prime);
		return new Object[] { mSignature, mType, tSiganture, mTypeToTType, tParameter, tAbstractType,
				mSignatureToTSignature, isApplicableMatch, mTypeToTType__mType____source,
				tSiganture__tParameter____parameters, tParameter__tAbstractType____type,
				mSignatureToTSignature__mSignature____source, mTypeToTType__tAbstractType____target,
	...
	public static final Object[] pattern_MethodParameter_12_4_solveCSP_bindingFBBBBBBBBB(MethodParameter _this,
			IsApplicableMatch isApplicableMatch, MMethodSignature mSignature, Type mType, TMethodSignature tSiganture,
			TypeToTAbstractType mTypeToTType, TParameter tParameter, TAbstractType tAbstractType,
			MSignatureToTSignature mSignatureToTSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mSignature, mType, tSiganture,
				mTypeToTType, tParameter, tAbstractType, mSignatureToTSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSignature, mType, tSiganture, mTypeToTType,
					tParameter, tAbstractType, mSignatureToTSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		Object[] result_pattern_MethodParameter_12_4_solveCSP_binding = pattern_MethodParameter_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mSignature, mType, tSiganture, mTypeToTType, tParameter, tAbstractType,
				mSignatureToTSignature);
				...
				if (tmpTSiganture instanceof TMethodSignature) {
					...
					if (tmpMEntry instanceof MEntry) {
						...
						if (tmpTParameter instanceof TParameter) {
							...
							if (tmpTAbstractType instanceof TAbstractType) {
								TAbstractType tAbstractType = (TAbstractType) tmpTAbstractType;
								return new Object[] { mSignature, mType, tSiganture, mEntry, tParameter, tAbstractType,
	...
	public static final Object[] pattern_MethodParameter_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MMethodSignature mSignature, Type mType, TMethodSignature tSiganture, MEntry mEntry, TParameter tParameter,
			TAbstractType tAbstractType, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			int tParameter_lowerBound = tParameter.getLowerBound();
			if (Integer.valueOf(tParameter_lowerBound).equals(Integer.valueOf(0))) {
				return new Object[] { mSignature, mType, tSiganture, mEntry, tParameter, tAbstractType, sourceMatch,
						targetMatch };
			}
	...
	public static final Object[] pattern_MethodParameter_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MethodParameter_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodParameter_24_2_matchsrctrgcontext_black = pattern_MethodParameter_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mSignature, mType, tSiganture, mEntry, tParameter, tAbstractType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameter_24_3_solvecsp_bindingFBBBBBBBBB(MethodParameter _this,
			MMethodSignature mSignature, Type mType, TMethodSignature tSiganture, MEntry mEntry, TParameter tParameter,
			TAbstractType tAbstractType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mSignature, mType, tSiganture, mEntry, tParameter,
				tAbstractType, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mSignature, mType, tSiganture, mEntry, tParameter, tAbstractType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		Object[] result_pattern_MethodParameter_24_3_solvecsp_binding = pattern_MethodParameter_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mSignature, mType, tSiganture, mEntry, tParameter, tAbstractType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MethodParameter_24_5_matchcorrcontext_blackBBBFBFBB(
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAbstractType.equals(mTypeToTType.getTarget())) {
					for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mSignature, MSignatureToTSignature.class, "source")) {
						if (tSiganture.equals(mSignatureToTSignature.getTarget())) {
							_result.add(new Object[] { mSignature, mType, tSiganture, mTypeToTType, tAbstractType,
	...
	public static final Object[] pattern_MethodParameter_24_6_createcorrespondence_blackBBBBBBB(
			MMethodSignature mSignature, Type mType, TMethodSignature tSiganture, MEntry mEntry, TParameter tParameter,
			TAbstractType tAbstractType, CCMatch ccMatch) {
		return new Object[] { mSignature, mType, tSiganture, mEntry, tParameter, tAbstractType, ccMatch };
	}
	...
	public static final Object[] pattern_MethodParameter_24_6_createcorrespondence_greenFBBFB(MEntry mEntry,
		...
		return new Object[] { mFlowElementToTFlowElement, mEntry, tParameter, mEntryToTParameter, ccMatch };
	}
	...
	public static final Object[] pattern_MethodParameter_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameter _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mSignature, mType, tSiganture,
				mTypeToTType, tAbstractType, mSignatureToTSignature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSignature, mType, tSiganture, mTypeToTType,
					tAbstractType, mSignatureToTSignature, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		Object[] result_pattern_MethodParameter_29_3_solveCSP_binding = pattern_MethodParameter_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mSignature, mType, tSiganture, mTypeToTType, tAbstractType,
	...
	public static final Object[] pattern_MethodParameter_29_5_checknacs_blackBBBBBB(MMethodSignature mSignature,
			Type mType, TMethodSignature tSiganture, TypeToTAbstractType mTypeToTType, TAbstractType tAbstractType,
			MSignatureToTSignature mSignatureToTSignature) {
		return new Object[] { mSignature, mType, tSiganture, mTypeToTType, tAbstractType, mSignatureToTSignature };
	}
	...
	public static final Object[] pattern_MethodParameter_29_6_perform_greenBBBFFFFBBB(MMethodSignature mSignature,
		...
		return new Object[] { mSignature, mType, tSiganture, mFlowElementToTFlowElement, mEntry, tParameter,
				mEntryToTParameter, tAbstractType, ruleResult, csp };
	}
