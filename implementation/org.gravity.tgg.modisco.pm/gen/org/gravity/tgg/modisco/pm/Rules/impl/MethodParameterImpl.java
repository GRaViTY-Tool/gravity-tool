...
public class MethodParameterImpl extends AbstractRuleImpl implements MethodParameter {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MethodParameterImpl
				.pattern_MethodParameter_1_1_performtransformation_greenBFFFBBB(tAbstractType, tSiganture, mEntry, csp);
		...
		Object[] result3_black = MethodParameterImpl.pattern_MethodParameter_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
				ruleresult, tAbstractType, mSignatureToTSignature, mFlowElementToTFlowElement, mEntryToTParameter,
				tParameter, mTypeToTType, mSignature, tSiganture, mType, mEntry);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tSiganture] = " + tSiganture + ", " + "[mType] = " + mType + ", " + "[mEntry] = " + mEntry
					+ ".");
		}
		MethodParameterImpl.pattern_MethodParameter_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(ruleresult,
				tAbstractType, mFlowElementToTFlowElement, mEntryToTParameter, tParameter, mSignature, tSiganture,
				mType, mEntry);
		...
		MethodParameterImpl.pattern_MethodParameter_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
				tAbstractType, mSignatureToTSignature, mFlowElementToTFlowElement, mEntryToTParameter, tParameter,
				mTypeToTType, mSignature, tSiganture, mType, mEntry);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterImpl
				.pattern_MethodParameter_2_2_corematch_blackFFFBFBBB(mSignature, mType, mEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterImpl.pattern_MethodParameter_2_3_findcontext_blackBBBBBBB(
					tAbstractType, mSignatureToTSignature, mTypeToTType, mSignature, tSiganture, mType, mEntry)) {
				Object[] result3_green = MethodParameterImpl
						.pattern_MethodParameter_2_3_findcontext_greenBBBBBBBFFFFFFF(tAbstractType,
								mSignatureToTSignature, mTypeToTType, mSignature, tSiganture, mType, mEntry);
				...
				Object[] result4_bindingAndBlack = MethodParameterImpl
						.pattern_MethodParameter_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAbstractType, mSignatureToTSignature, mTypeToTType, mSignature, tSiganture, mType,
								mEntry);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mTypeToTType + ", " + "[mSignature] = " + mSignature + ", " + "[tSiganture] = "
							+ tSiganture + ", " + "[mType] = " + mType + ", " + "[mEntry] = " + mEntry + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			...
			MMethodSignature mSignature, TMethodSignature tSiganture, Type mType, MEntry mEntry) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tAbstractType, EObject mSignatureToTSignature,
			EObject mFlowElementToTFlowElement, EObject mEntryToTParameter, EObject tParameter, EObject mTypeToTType,
			EObject mSignature, EObject tSiganture, EObject mType, EObject mEntry) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterImpl
				.pattern_MethodParameter_12_2_corematch_blackBFBFFBFB(tAbstractType, tParameter, tSiganture, match)) {
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result2_black[1];
			...
			for (Object[] result3_black : MethodParameterImpl.pattern_MethodParameter_12_3_findcontext_blackBBBBBBB(
					tAbstractType, mSignatureToTSignature, tParameter, mTypeToTType, mSignature, tSiganture, mType)) {
				Object[] result3_green = MethodParameterImpl
						.pattern_MethodParameter_12_3_findcontext_greenBBBBBBBFFFFFFF(tAbstractType,
								mSignatureToTSignature, tParameter, mTypeToTType, mSignature, tSiganture, mType);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = MethodParameterImpl
						.pattern_MethodParameter_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tAbstractType, mSignatureToTSignature, tParameter, mTypeToTType, mSignature, tSiganture,
								mType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tAbstractType] = " + tAbstractType
							+ ", " + "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[tParameter] = "
							+ tParameter + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[mSignature] = "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			MSignatureToTSignature mSignatureToTSignature, TParameter tParameter, TypeToTAbstractType mTypeToTType,
			MMethodSignature mSignature, TMethodSignature tSiganture, Type mType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tAbstractType, EObject mSignatureToTSignature,
			EObject mFlowElementToTFlowElement, EObject mEntryToTParameter, EObject tParameter, EObject mTypeToTType,
			EObject mSignature, EObject tSiganture, EObject mType, EObject mEntry) {
		ruleresult.registerObject("tAbstractType", tAbstractType);
		ruleresult.registerObject("mSignatureToTSignature", mSignatureToTSignature);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_2(EMoflonEdge _edge_mEntrys) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodParameterImpl
				.pattern_MethodParameter_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tAbstractType, tParameter,
						mSignature, tSiganture, mType, mEntry, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tAbstractType] = " + tAbstractType + ", " + "[tParameter] = " + tParameter + ", "
					+ "[mSignature] = " + mSignature + ", " + "[tSiganture] = " + tSiganture + ", " + "[mType] = "
					+ mType + ", " + "[mEntry] = " + mEntry + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (MethodParameterImpl.pattern_MethodParameter_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterImpl
					.pattern_MethodParameter_24_5_matchcorrcontext_blackBFFBBBBB(tAbstractType, mSignature, tSiganture,
				...
				Object[] result6_black = MethodParameterImpl
						.pattern_MethodParameter_24_6_createcorrespondence_blackBBBBBBB(tAbstractType, tParameter,
								mSignature, tSiganture, mType, mEntry, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAbstractType] = "
							+ tAbstractType + ", " + "[tParameter] = " + tParameter + ", " + "[mSignature] = "
							+ mSignature + ", " + "[tSiganture] = " + tSiganture + ", " + "[mType] = " + mType + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAbstractType tAbstractType, TParameter tParameter, MMethodSignature mSignature,
			TMethodSignature tSiganture, Type mType, MEntry mEntry, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : MethodParameterImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tAbstractType] = " + tAbstractType
						+ ", " + "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[mTypeToTType] = "
						+ mTypeToTType + ", " + "[mSignature] = " + mSignature + ", " + "[tSiganture] = " + tSiganture
			...
			if (MethodParameterImpl.pattern_MethodParameter_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					MethodParameterImpl.pattern_MethodParameter_29_6_perform_greenBFFFBBBFBB(tAbstractType, mSignature,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			MSignatureToTSignature mSignatureToTSignature, TypeToTAbstractType mTypeToTType,
			MMethodSignature mSignature, TMethodSignature tSiganture, Type mType, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE_TYPETOTABSTRACTTYPE_MMETHODSIGNATURE_TMETHODSIGNATURE_TYPE_MENTRY:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TAbstractType) arguments.get(1),
					...
					(MMethodSignature) arguments.get(4), (TMethodSignature) arguments.get(5), (Type) arguments.get(6),
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE_TPARAMETER_TYPETOTABSTRACTTYPE_MMETHODSIGNATURE_TMETHODSIGNATURE_TYPE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TAbstractType) arguments.get(1),
					(MSignatureToTSignature) arguments.get(2), (TParameter) arguments.get(3),
					(TypeToTAbstractType) arguments.get(4), (MMethodSignature) arguments.get(5),
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_2__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_2((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_2__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER___IS_APPLICABLE_SOLVE_CSP_CC__TABSTRACTTYPE_TPARAMETER_MMETHODSIGNATURE_TMETHODSIGNATURE_TYPE_MENTRY_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TAbstractType) arguments.get(0), (TParameter) arguments.get(1),
		...
		case RulesPackage.METHOD_PARAMETER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_MSIGNATURETOTSIGNATURE_TYPETOTABSTRACTTYPE_MMETHODSIGNATURE_TMETHODSIGNATURE_TYPE_MODELGENERATORRULERESULT:
						...
						if (tmpTSiganture instanceof TMethodSignature) {
							...
							if (tmpMType instanceof Type) {
								...
								if (tmpMEntry instanceof MEntry) {
									...
									return new Object[] { tAbstractType, mSignatureToTSignature, mTypeToTType,
											mSignature, tSiganture, mType, mEntry, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MethodParameter_1_1_performtransformation_blackBBBBBBBFBB(
			...
			TypeToTAbstractType mTypeToTType, MMethodSignature mSignature, TMethodSignature tSiganture, Type mType,
			MEntry mEntry, MethodParameter _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAbstractType, mSignatureToTSignature, mTypeToTType, mSignature, tSiganture,
	...
	public static final Object[] pattern_MethodParameter_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MethodParameter_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodParameter_1_1_performtransformation_black = pattern_MethodParameter_1_1_performtransformation_blackBBBBBBBFBB(
					tAbstractType, mSignatureToTSignature, mTypeToTType, mSignature, tSiganture, mType, mEntry, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodParameter_1_1_performtransformation_greenBFFFBBB(
		...
		return new Object[] { tAbstractType, mFlowElementToTFlowElement, mEntryToTParameter, tParameter, tSiganture,
				mEntry, csp };
	}
	...
	public static final Object[] pattern_MethodParameter_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tAbstractType, EObject mSignatureToTSignature,
			EObject mFlowElementToTFlowElement, EObject mEntryToTParameter, EObject tParameter, EObject mTypeToTType,
			EObject mSignature, EObject tSiganture, EObject mType, EObject mEntry) {
	...
	public static final Object[] pattern_MethodParameter_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject tAbstractType, EObject mFlowElementToTFlowElement,
		...
		mEntry__mType____type.setName(mEntry__mType____type_name_prime);
		return new Object[] { ruleresult, tAbstractType, mFlowElementToTFlowElement, mEntryToTParameter, tParameter,
				mSignature, tSiganture, mType, mEntry, mEntryToTParameter__tParameter____target,
	...
	public static final void pattern_MethodParameter_1_5_registerobjects_expressionBBBBBBBBBBBB(MethodParameter _this,
			...
			EObject mFlowElementToTFlowElement, EObject mEntryToTParameter, EObject tParameter, EObject mTypeToTType,
			EObject mSignature, EObject tSiganture, EObject mType, EObject mEntry) {
		_this.registerObjects_FWD(ruleresult, tAbstractType, mSignatureToTSignature, mFlowElementToTFlowElement,
				mEntryToTParameter, tParameter, mTypeToTType, mSignature, tSiganture, mType, mEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameter_2_2_corematch_blackFFFBFBBB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAbstractType != null) {
				for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTSiganture instanceof TMethodSignature) {
						TMethodSignature tSiganture = (TMethodSignature) tmpTSiganture;
						_result.add(new Object[] { tAbstractType, mSignatureToTSignature, mTypeToTType, mSignature,
								tSiganture, mType, mEntry, match });
					}
					...
					if (tSiganture.equals(mSignatureToTSignature.getTarget())) {
						if (mType.equals(mEntry.getType())) {
							if (tAbstractType.equals(mTypeToTType.getTarget())) {
								_result.add(new Object[] { tAbstractType, mSignatureToTSignature, mTypeToTType,
										mSignature, tSiganture, mType, mEntry });
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameter_2_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		return new Object[] { tAbstractType, mSignatureToTSignature, mTypeToTType, mSignature, tSiganture, mType,
				mEntry, isApplicableMatch, mSignature__mEntry____mEntrys, mTypeToTType__mType____source,
				mSignatureToTSignature__mSignature____source, mSignatureToTSignature__tSiganture____target,
				mEntry__mType____type, mTypeToTType__tAbstractType____target };
	}

	public static final Object[] pattern_MethodParameter_2_4_solveCSP_bindingFBBBBBBBBB(MethodParameter _this,
			IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			MSignatureToTSignature mSignatureToTSignature, TypeToTAbstractType mTypeToTType,
			MMethodSignature mSignature, TMethodSignature tSiganture, Type mType, MEntry mEntry) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tAbstractType, mSignatureToTSignature,
				mTypeToTType, mSignature, tSiganture, mType, mEntry);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mSignatureToTSignature, mTypeToTType,
					mSignature, tSiganture, mType, mEntry };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		Object[] result_pattern_MethodParameter_2_4_solveCSP_binding = pattern_MethodParameter_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAbstractType, mSignatureToTSignature, mTypeToTType, mSignature, tSiganture,
				mType, mEntry);
		if (result_pattern_MethodParameter_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodParameter_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mSignatureToTSignature,
						mTypeToTType, mSignature, tSiganture, mType, mEntry };
			}
		}
		return null;
					...
					if (tmpMTypeToTType instanceof TypeToTAbstractType) {
						...
						if (tmpMSignature instanceof MMethodSignature) {
							...
							if (tmpTSiganture instanceof TMethodSignature) {
								...
								if (tmpMType instanceof Type) {
									Type mType = (Type) tmpMType;
									return new Object[] { tAbstractType, mSignatureToTSignature, tParameter,
											mTypeToTType, mSignature, tSiganture, mType, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MethodParameter_11_1_performtransformation_blackBBBBBBBFBB(
			TAbstractType tAbstractType, MSignatureToTSignature mSignatureToTSignature, TParameter tParameter,
			TypeToTAbstractType mTypeToTType, MMethodSignature mSignature, TMethodSignature tSiganture, Type mType,
			MethodParameter _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAbstractType, mSignatureToTSignature, tParameter, mTypeToTType, mSignature,
	...
	public static final void pattern_MethodParameter_11_5_registerobjects_expressionBBBBBBBBBBBB(MethodParameter _this,
			...
			EObject mFlowElementToTFlowElement, EObject mEntryToTParameter, EObject tParameter, EObject mTypeToTType,
			EObject mSignature, EObject tSiganture, EObject mType, EObject mEntry) {
		_this.registerObjects_BWD(ruleresult, tAbstractType, mSignatureToTSignature, mFlowElementToTFlowElement,
				mEntryToTParameter, tParameter, mTypeToTType, mSignature, tSiganture, mType, mEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameter_12_2_corematch_blackBFBFFBFB(
			...
			for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpMSignature instanceof MMethodSignature) {
					...
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mType != null) {
							_result.add(new Object[] { tAbstractType, mSignatureToTSignature, tParameter, mTypeToTType,
									mSignature, tSiganture, mType, match });
						}
					...
					if (tSiganture.getParameters().contains(tParameter)) {
						if (tSiganture.equals(mSignatureToTSignature.getTarget())) {
							if (tAbstractType.equals(mTypeToTType.getTarget())) {
								int tParameter_lowerBound = tParameter.getLowerBound();
								if (Integer.valueOf(tParameter_lowerBound).equals(Integer.valueOf(0))) {
									_result.add(new Object[] { tAbstractType, mSignatureToTSignature, tParameter,
											mTypeToTType, mSignature, tSiganture, mType });
								}
	...
	public static final Object[] pattern_MethodParameter_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		mSignatureToTSignature__tSiganture____target.setName(mSignatureToTSignature__tSiganture____target_name_prime);
		mTypeToTType__tAbstractType____target.setName(mTypeToTType__tAbstractType____target_name_prime);
		return new Object[] { tAbstractType, mSignatureToTSignature, tParameter, mTypeToTType, mSignature, tSiganture,
				mType, isApplicableMatch, tParameter__tAbstractType____type, mTypeToTType__mType____source,
	...
	public static final Object[] pattern_MethodParameter_12_4_solveCSP_bindingFBBBBBBBBB(MethodParameter _this,
			IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			MSignatureToTSignature mSignatureToTSignature, TParameter tParameter, TypeToTAbstractType mTypeToTType,
			MMethodSignature mSignature, TMethodSignature tSiganture, Type mType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tAbstractType, mSignatureToTSignature,
				tParameter, mTypeToTType, mSignature, tSiganture, mType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mSignatureToTSignature, tParameter,
					mTypeToTType, mSignature, tSiganture, mType };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		Object[] result_pattern_MethodParameter_12_4_solveCSP_binding = pattern_MethodParameter_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAbstractType, mSignatureToTSignature, tParameter, mTypeToTType, mSignature,
				tSiganture, mType);
				...
				if (tmpMSignature instanceof MMethodSignature) {
					...
					if (tmpTSiganture instanceof TMethodSignature) {
						...
						if (tmpMType instanceof Type) {
							...
							if (tmpMEntry instanceof MEntry) {
								MEntry mEntry = (MEntry) tmpMEntry;
								return new Object[] { tAbstractType, tParameter, mSignature, tSiganture, mType, mEntry,
	...
	public static final Object[] pattern_MethodParameter_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TAbstractType tAbstractType, TParameter tParameter, MMethodSignature mSignature,
			TMethodSignature tSiganture, Type mType, MEntry mEntry, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			int tParameter_lowerBound = tParameter.getLowerBound();
			if (Integer.valueOf(tParameter_lowerBound).equals(Integer.valueOf(0))) {
				return new Object[] { tAbstractType, tParameter, mSignature, tSiganture, mType, mEntry, sourceMatch,
						targetMatch };
			}
	...
	public static final Object[] pattern_MethodParameter_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MethodParameter_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodParameter_24_2_matchsrctrgcontext_black = pattern_MethodParameter_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tAbstractType, tParameter, mSignature, tSiganture, mType, mEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameter_24_3_solvecsp_bindingFBBBBBBBBB(MethodParameter _this,
			TAbstractType tAbstractType, TParameter tParameter, MMethodSignature mSignature,
			TMethodSignature tSiganture, Type mType, MEntry mEntry, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tAbstractType, tParameter, mSignature, tSiganture, mType,
				mEntry, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tAbstractType, tParameter, mSignature, tSiganture, mType, mEntry,
	...
	public static final Object[] pattern_MethodParameter_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		Object[] result_pattern_MethodParameter_24_3_solvecsp_binding = pattern_MethodParameter_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tAbstractType, tParameter, mSignature, tSiganture, mType, mEntry, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MethodParameter_24_5_matchcorrcontext_blackBFFBBBBB(
			TAbstractType tAbstractType, MMethodSignature mSignature, TMethodSignature tSiganture, Type mType,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_MethodParameter_24_6_createcorrespondence_blackBBBBBBB(
			TAbstractType tAbstractType, TParameter tParameter, MMethodSignature mSignature,
			TMethodSignature tSiganture, Type mType, MEntry mEntry, CCMatch ccMatch) {
		return new Object[] { tAbstractType, tParameter, mSignature, tSiganture, mType, mEntry, ccMatch };
	}
	...
	public static final Object[] pattern_MethodParameter_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameter _this,
			IsApplicableMatch isApplicableMatch, TAbstractType tAbstractType,
			MSignatureToTSignature mSignatureToTSignature, TypeToTAbstractType mTypeToTType,
			MMethodSignature mSignature, TMethodSignature tSiganture, Type mType, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tAbstractType,
				mSignatureToTSignature, mTypeToTType, mSignature, tSiganture, mType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mSignatureToTSignature, mTypeToTType,
					mSignature, tSiganture, mType, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(MethodParameter _this,
		...
		if (result_pattern_MethodParameter_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_MethodParameter_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tAbstractType, mSignatureToTSignature,
						mTypeToTType, mSignature, tSiganture, mType, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameter_29_6_perform_greenBFFFBBBFBB(TAbstractType tAbstractType,
			MMethodSignature mSignature, TMethodSignature tSiganture, Type mType, ModelgeneratorRuleResult ruleResult,
			CSP csp) {
		MAbstractFlowElementToTAbstractFlowElement mFlowElementToTFlowElement = PmFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		...
		return new Object[] { tAbstractType, mFlowElementToTFlowElement, mEntryToTParameter, tParameter, mSignature,
				tSiganture, mType, mEntry, ruleResult, csp };
	}
