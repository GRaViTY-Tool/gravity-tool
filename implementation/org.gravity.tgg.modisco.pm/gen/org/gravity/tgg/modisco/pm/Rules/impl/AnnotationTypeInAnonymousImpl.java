...
public class AnnotationTypeInAnonymousImpl extends AbstractRuleImpl implements AnnotationTypeInAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_1_1_performtransformation_greenBBFBFFB(tClass, mNestedType, pg, csp);
		...
		Object[] result3_black = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tClass,
						mNestedType, mASTNodeToAnnotatable, tPackage, pg, tNestedType,
		...
		AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(ruleresult, tClass,
						mNestedType, mASTNodeToAnnotatable, pg, tNestedType, eAnonymousClassDeclaration,
						mNestedTypeToTNestedType);
		//nothing EMoflonEdge mASTNodeToAnnotatable__mNestedType____source = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge pg__tNestedType____annotationTypes = (EMoflonEdge) result3_green[9];
		...
		//nothing EMoflonEdge pg__tNestedType____allTypes = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge tNestedType__pg____model = (EMoflonEdge) result3_green[14];
		//nothing EMoflonEdge mNestedTypeToTNestedType__tNestedType____target = (EMoflonEdge) result3_green[15];
		//nothing EMoflonEdge mASTNodeToAnnotatable__tNestedType____target = (EMoflonEdge) result3_green[16];
		...
		// 
		// 
		AnnotationTypeInAnonymousImpl.pattern_AnnotationTypeInAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(this,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationTypeInAnonymousImpl
			...
			for (Object[] result3_black : AnnotationTypeInAnonymousImpl
					.pattern_AnnotationTypeInAnonymous_2_3_findcontext_blackBBFFBB(tClass, mNestedType,
				...
				Object[] result3_green = AnnotationTypeInAnonymousImpl
						.pattern_AnnotationTypeInAnonymous_2_3_findcontext_greenBBBBBBFFFFFFFFFF(tClass, mNestedType,
				...
				//nothing EMoflonEdge tPackage__tClass____allTypes = (EMoflonEdge) result3_green[9];
				...
				//nothing EMoflonEdge pg__tClass____allTypes = (EMoflonEdge) result3_green[12];
				...
				Object[] result4_bindingAndBlack = AnnotationTypeInAnonymousImpl
						.pattern_AnnotationTypeInAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tClass, mNestedType, tPackage, pg,
								eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TClass tClass,
			AnnotationTypeDeclaration mNestedType, TPackage tPackage, TypeGraph pg,
	...
	public boolean isAppropriate_BWD(Match match, TClass tClass, TPackage tPackage, TypeGraph pg,
		...
		Object[] result1_black = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_10_1_initialbindings_blackBBBBBB(this, match, tClass, tPackage, pg,
						tNestedType);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, tClass, tPackage,
						pg, tNestedType);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tClass] = " + tClass + ", " + "[tPackage] = " + tPackage + ", "
		...
		if (AnnotationTypeInAnonymousImpl.pattern_AnnotationTypeInAnonymous_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = AnnotationTypeInAnonymousImpl
					.pattern_AnnotationTypeInAnonymous_10_4_collectelementstobetranslated_blackBBBBB(match, tClass,
			...
			AnnotationTypeInAnonymousImpl
					.pattern_AnnotationTypeInAnonymous_10_4_collectelementstobetranslated_greenBBBBFFFFF(match, tClass,
							pg, tNestedType);
			//nothing EMoflonEdge pg__tNestedType____annotationTypes = (EMoflonEdge) result4_green[4];
			...
			//nothing EMoflonEdge pg__tNestedType____allTypes = (EMoflonEdge) result4_green[7];
			//nothing EMoflonEdge tNestedType__pg____model = (EMoflonEdge) result4_green[8];

			Object[] result5_black = AnnotationTypeInAnonymousImpl
					.pattern_AnnotationTypeInAnonymous_10_5_collectcontextelements_blackBBBBB(match, tClass, tPackage,
							pg, tNestedType);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tClass] = " + tClass + ", " + "[tPackage] = " + tPackage + ", " + "[pg] = " + pg + ", "
			...
			AnnotationTypeInAnonymousImpl.pattern_AnnotationTypeInAnonymous_10_5_collectcontextelements_greenBBBBFFFFF(
					match, tClass, tPackage, pg);
			...
			//nothing EMoflonEdge tPackage__tClass____allTypes = (EMoflonEdge) result5_green[6];
			//nothing EMoflonEdge pg__tClass____allTypes = (EMoflonEdge) result5_green[7];
			//nothing EMoflonEdge tClass__pg____model = (EMoflonEdge) result5_green[8];

			// 
			AnnotationTypeInAnonymousImpl
					.pattern_AnnotationTypeInAnonymous_10_6_registerobjectstomatch_expressionBBBBBB(this, match, tClass,
							tPackage, pg, tNestedType);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_11_1_performtransformation_bindingAndBlackFFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		TAnnotationType tNestedType = (TAnnotationType) result1_bindingAndBlack[3];
		AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass = (AnonymousClassDeclarationToTClass) result1_bindingAndBlack[4];
		AnonymousClassDeclaration eAnonymousClassDeclaration = (AnonymousClassDeclaration) result1_bindingAndBlack[5];
		CSP csp = (CSP) result1_bindingAndBlack[6];
		Object[] result1_green = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_11_1_performtransformation_greenFFBBFB(tNestedType,
		...
		Object[] result3_black = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tClass,
						mNestedType, mASTNodeToAnnotatable, tPackage, pg, tNestedType,
						eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration, mNestedTypeToTNestedType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
		...
		AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_11_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(ruleresult, tClass,
						mNestedType, mASTNodeToAnnotatable, pg, tNestedType, eAnonymousClassDeclaration,
						mNestedTypeToTNestedType);
		//nothing EMoflonEdge mASTNodeToAnnotatable__mNestedType____source = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge pg__tNestedType____annotationTypes = (EMoflonEdge) result3_green[9];
		...
		// 
		// 
		AnnotationTypeInAnonymousImpl.pattern_AnnotationTypeInAnonymous_11_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tClass, mNestedType, mASTNodeToAnnotatable, tPackage, pg, tNestedType,
				eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration, mNestedTypeToTNestedType);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_12_2_corematch_bindingFFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_12_2_corematch_blackBBBBFFB(tClass, tPackage, pg, tNestedType,
						match)) {
			...
			// ForEach 
			for (Object[] result3_black : AnnotationTypeInAnonymousImpl
					.pattern_AnnotationTypeInAnonymous_12_3_findcontext_blackBBBBBB(tClass, tPackage, pg, tNestedType,
							eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration)) {
				Object[] result3_green = AnnotationTypeInAnonymousImpl
						.pattern_AnnotationTypeInAnonymous_12_3_findcontext_greenBBBBBBFFFFFFFFFFFFF(tClass, tPackage,
				...
				//nothing EMoflonEdge tPackage__tClass____allTypes = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge eAnonymousClassDeclarationToTClass__tClass____target = (EMoflonEdge) result3_green[10];
				//nothing EMoflonEdge pg__tNestedType____annotationTypes = (EMoflonEdge) result3_green[11];
				...
				//nothing EMoflonEdge pg__tNestedType____allTypes = (EMoflonEdge) result3_green[15];
				//nothing EMoflonEdge tNestedType__pg____model = (EMoflonEdge) result3_green[16];
				//nothing EMoflonEdge pg__tClass____allTypes = (EMoflonEdge) result3_green[17];
				//nothing EMoflonEdge tClass__pg____model = (EMoflonEdge) result3_green[18];

				Object[] result4_bindingAndBlack = AnnotationTypeInAnonymousImpl
						.pattern_AnnotationTypeInAnonymous_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tClass, tPackage, pg, tNestedType,
								eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tClass] = " + tClass + ", "
	...
	public CSP isAppropriate_solveCsp_BWD(Match match, TClass tClass, TPackage tPackage, TypeGraph pg,
			TAnnotationType tNestedType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_975(EMoflonEdge _edge_annotationTypes) {
		...
		// ForEach 
		for (Object[] result2_black : AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_blackFFFFB(_edge_annotationTypes)) {
			TClass tClass = (TClass) result2_black[0];
			TPackage tPackage = (TPackage) result2_black[1];
			TypeGraph pg = (TypeGraph) result2_black[2];
			TAnnotationType tNestedType = (TAnnotationType) result2_black[3];
			Object[] result2_green = AnnotationTypeInAnonymousImpl
			...
			if (AnnotationTypeInAnonymousImpl
					.pattern_AnnotationTypeInAnonymous_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_1070(EMoflonEdge _edge_anonymousClassDeclarationOwner) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(sourceMatch,
						targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		TAnnotationType tNestedType = (TAnnotationType) result2_bindingAndBlack[4];
		...
		Object[] result3_bindingAndBlack = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tClass, mNestedType,
		...
		if (AnnotationTypeInAnonymousImpl.pattern_AnnotationTypeInAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationTypeInAnonymousImpl
				...
				Object[] result6_black = AnnotationTypeInAnonymousImpl
						.pattern_AnnotationTypeInAnonymous_24_6_createcorrespondence_blackBBBBBBB(tClass, mNestedType,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TClass tClass, AnnotationTypeDeclaration mNestedType, TPackage tPackage,
			TypeGraph pg, TAnnotationType tNestedType, AnonymousClassDeclaration eAnonymousClassDeclaration,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TClass tClass, TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType) {// 
		Object[] result1_black = AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_blackBBBB(tClass, tPackage, pg, tNestedType);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		// ForEach 
		for (Object[] result2_black : AnnotationTypeInAnonymousImpl
				.pattern_AnnotationTypeInAnonymous_29_2_isapplicablecore_blackFFFFFFBB(ruleEntryContainer,
						ruleResult)) {
			...
			Object[] result3_bindingAndBlack = AnnotationTypeInAnonymousImpl
					.pattern_AnnotationTypeInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
			...
			if (AnnotationTypeInAnonymousImpl.pattern_AnnotationTypeInAnonymous_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = AnnotationTypeInAnonymousImpl
						.pattern_AnnotationTypeInAnonymous_29_5_checknacs_blackBBBBB(tClass, tPackage, pg,
								eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration);
				if (result5_black != null) {

					Object[] result6_black = AnnotationTypeInAnonymousImpl
							.pattern_AnnotationTypeInAnonymous_29_6_perform_blackBBBBBB(tClass, tPackage, pg,
					...
					AnnotationTypeInAnonymousImpl.pattern_AnnotationTypeInAnonymous_29_6_perform_greenBFFBFBFBB(tClass,
		...
		switch (operationID) {
			...
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_ANNOTATIONTYPEDECLARATION_ANONYMOUSCLASSDECLARATION:
				return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
						(AnnotationTypeDeclaration) arguments.get(1), (AnonymousClassDeclaration) arguments.get(2));
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
				return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TCLASS_ANNOTATIONTYPEDECLARATION_TPACKAGE_TYPEGRAPH_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TClass) arguments.get(1),
						(AnnotationTypeDeclaration) arguments.get(2), (TPackage) arguments.get(3),
			...
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
			...
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPROPRIATE_BWD__MATCH_TCLASS_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE:
			...
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TCLASS_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE:
				registerObjectsToMatch_BWD((Match) arguments.get(0), (TClass) arguments.get(1),
						(TPackage) arguments.get(2), (TypeGraph) arguments.get(3), (TAnnotationType) arguments.get(4));
				return null;
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TCLASS_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE:
				return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (TClass) arguments.get(1),
						(TPackage) arguments.get(2), (TypeGraph) arguments.get(3), (TAnnotationType) arguments.get(4));
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
				return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TCLASS_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION:
			...
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
			...
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_975__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_975((EMoflonEdge) arguments.get(0));
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1070__EMOFLONEDGE:
				return isAppropriate_FWD_EMoflonEdge_1070((EMoflonEdge) arguments.get(0));
			...
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__TCLASS_ANNOTATIONTYPEDECLARATION_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE_ANONYMOUSCLASSDECLARATION_MATCH_MATCH:
			...
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___CHECK_DEC_BWD__TCLASS_TPACKAGE_TYPEGRAPH_TANNOTATIONTYPE:
			...
			case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TCLASS_TPACKAGE_TYPEGRAPH_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_1_1_performtransformation_bindingFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_1_1_performtransformation_blackBBBBBBFBB(
			TClass tClass, AnnotationTypeDeclaration mNestedType, TPackage tPackage, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
			AnnotationTypeInAnonymous _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_AnnotationTypeInAnonymous_1_1_performtransformation_binding = pattern_AnnotationTypeInAnonymous_1_1_performtransformation_bindingFFFFFFB(
				isApplicableMatch);
		if (result_pattern_AnnotationTypeInAnonymous_1_1_performtransformation_binding != null) {
			...
			TPackage tPackage = (TPackage) result_pattern_AnnotationTypeInAnonymous_1_1_performtransformation_binding[2];
			TypeGraph pg = (TypeGraph) result_pattern_AnnotationTypeInAnonymous_1_1_performtransformation_binding[3];
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass = (AnonymousClassDeclarationToTClass) result_pattern_AnnotationTypeInAnonymous_1_1_performtransformation_binding[4];
			AnonymousClassDeclaration eAnonymousClassDeclaration = (AnonymousClassDeclaration) result_pattern_AnnotationTypeInAnonymous_1_1_performtransformation_binding[5];

			Object[] result_pattern_AnnotationTypeInAnonymous_1_1_performtransformation_black = pattern_AnnotationTypeInAnonymous_1_1_performtransformation_blackBBBBBBFBB(
			...
			if (result_pattern_AnnotationTypeInAnonymous_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_AnnotationTypeInAnonymous_1_1_performtransformation_black[6];
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_1_1_performtransformation_greenBBFBFFB(TClass tClass,
		...
		pg.getAnnotationTypes().add(tNestedType);
		tClass.getInnerTypes().add(tNestedType);
		pg.getAllTypes().add(tNestedType);
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_1_2_collecttranslatedelements_blackBBBB(
			AnnotationTypeDeclaration mNestedType, ASTNodeToTAnnotatable mASTNodeToAnnotatable,
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tClass, EObject mNestedType, EObject mASTNodeToAnnotatable,
		...
		EMoflonEdge pg__tNestedType____annotationTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		EMoflonEdge pg__tNestedType____allTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		String pg__tNestedType____annotationTypes_name_prime = "annotationTypes";
		...
		String pg__tNestedType____allTypes_name_prime = "allTypes";
		...
		pg__tNestedType____annotationTypes.setSrc(pg);
		pg__tNestedType____annotationTypes.setTrg(tNestedType);
		ruleresult.getCreatedEdges().add(pg__tNestedType____annotationTypes);
		...
		pg__tNestedType____allTypes.setSrc(pg);
		pg__tNestedType____allTypes.setTrg(tNestedType);
		ruleresult.getCreatedEdges().add(pg__tNestedType____allTypes);
		...
		pg__tNestedType____annotationTypes.setName(pg__tNestedType____annotationTypes_name_prime);
		...
		pg__tNestedType____allTypes.setName(pg__tNestedType____allTypes_name_prime);
		...
		return new Object[] { ruleresult, tClass, mNestedType, mASTNodeToAnnotatable, pg, tNestedType,
				...
				pg__tNestedType____annotationTypes, tClass__tNestedType____innerTypes, tNestedType__tClass____outerType,
				mNestedTypeToTNestedType__mNestedType____source, pg__tNestedType____allTypes, tNestedType__pg____model,
				mNestedTypeToTNestedType__tNestedType____target, mASTNodeToAnnotatable__tNestedType____target,
				mNestedType__eAnonymousClassDeclaration____anonymousClassDeclarationOwner,
				eAnonymousClassDeclaration__mNestedType____bodyDeclarations };
	}

	public static final void pattern_AnnotationTypeInAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeInAnonymous_2_3_findcontext_blackBBFFBB(TClass tClass,
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_2_3_findcontext_greenBBBBBBFFFFFFFFFF(TClass tClass,
			AnnotationTypeDeclaration mNestedType, TPackage tPackage, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		...
		EMoflonEdge tPackage__tClass____allTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		String tPackage__tClass____allTypes_name_prime = "allTypes";
		...
		tPackage__tClass____allTypes.setSrc(tPackage);
		tPackage__tClass____allTypes.setTrg(tClass);
		isApplicableMatch.getAllContextElements().add(tPackage__tClass____allTypes);
		...
		tPackage__tClass____allTypes.setName(tPackage__tClass____allTypes_name_prime);
		...
		return new Object[] { tClass, mNestedType, tPackage, pg, eAnonymousClassDeclarationToTClass,
				...
				tPackage__tClass____allTypes, eAnonymousClassDeclarationToTClass__tClass____target,
				eAnonymousClassDeclarationToTClass__eAnonymousClassDeclaration____source, pg__tClass____allTypes,
				tClass__pg____model, mNestedType__eAnonymousClassDeclaration____anonymousClassDeclarationOwner,
				eAnonymousClassDeclaration__mNestedType____bodyDeclarations };
	}

	public static final Object[] pattern_AnnotationTypeInAnonymous_2_4_solveCSP_bindingFBBBBBBBB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			AnnotationTypeInAnonymous _this, IsApplicableMatch isApplicableMatch, TClass tClass,
			AnnotationTypeDeclaration mNestedType, TPackage tPackage, TypeGraph pg,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		Object[] result_pattern_AnnotationTypeInAnonymous_2_4_solveCSP_binding = pattern_AnnotationTypeInAnonymous_2_4_solveCSP_bindingFBBBBBBBB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_10_1_initialbindings_blackBBBBBB(
			AnnotationTypeInAnonymous _this, Match match, TClass tClass, TPackage tPackage, TypeGraph pg,
			TAnnotationType tNestedType) {
		return new Object[] { _this, match, tClass, tPackage, pg, tNestedType };
	}

	public static final Object[] pattern_AnnotationTypeInAnonymous_10_2_SolveCSP_bindingFBBBBBB(
			AnnotationTypeInAnonymous _this, Match match, TClass tClass, TPackage tPackage, TypeGraph pg,
			TAnnotationType tNestedType) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_10_2_SolveCSP_bindingAndBlackFBBBBBB(
			AnnotationTypeInAnonymous _this, Match match, TClass tClass, TPackage tPackage, TypeGraph pg,
			TAnnotationType tNestedType) {
		Object[] result_pattern_AnnotationTypeInAnonymous_10_2_SolveCSP_binding = pattern_AnnotationTypeInAnonymous_10_2_SolveCSP_bindingFBBBBBB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_10_4_collectelementstobetranslated_blackBBBBB(
			Match match, TClass tClass, TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType) {
		return new Object[] { match, tClass, tPackage, pg, tNestedType };
	}

	public static final Object[] pattern_AnnotationTypeInAnonymous_10_4_collectelementstobetranslated_greenBBBBFFFFF(
		...
		pg__tNestedType____annotationTypes.setSrc(pg);
		pg__tNestedType____annotationTypes.setTrg(tNestedType);
		match.getToBeTranslatedEdges().add(pg__tNestedType____annotationTypes);
		tClass__tNestedType____innerTypes.setSrc(tClass);
		tClass__tNestedType____innerTypes.setTrg(tNestedType);
		...
		pg__tNestedType____allTypes.setSrc(pg);
		pg__tNestedType____allTypes.setTrg(tNestedType);
		match.getToBeTranslatedEdges().add(pg__tNestedType____allTypes);
		tNestedType__pg____model.setSrc(tNestedType);
		tNestedType__pg____model.setTrg(pg);
		...
		pg__tNestedType____allTypes.setName(pg__tNestedType____allTypes_name_prime);
		tNestedType__pg____model.setName(tNestedType__pg____model_name_prime);
		return new Object[] { match, tClass, pg, tNestedType, pg__tNestedType____annotationTypes,
				tClass__tNestedType____innerTypes, tNestedType__tClass____outerType, pg__tNestedType____allTypes,
				tNestedType__pg____model };
	}

	public static final Object[] pattern_AnnotationTypeInAnonymous_10_5_collectcontextelements_blackBBBBB(Match match,
			TClass tClass, TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType) {
		return new Object[] { match, tClass, tPackage, pg, tNestedType };
	}

	public static final Object[] pattern_AnnotationTypeInAnonymous_10_5_collectcontextelements_greenBBBBFFFFF(
			Match match, TClass tClass, TPackage tPackage, TypeGraph pg) {
		EMoflonEdge pg__tClass____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tClass__tPackage____package = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tPackage__tClass____allTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge pg__tClass____allTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		tPackage__tClass____allTypes.setSrc(tPackage);
		tPackage__tClass____allTypes.setTrg(tClass);
		match.getContextEdges().add(tPackage__tClass____allTypes);
		pg__tClass____allTypes.setSrc(pg);
		pg__tClass____allTypes.setTrg(tClass);
		match.getContextEdges().add(pg__tClass____allTypes);
		tClass__pg____model.setSrc(tClass);
		tClass__pg____model.setTrg(pg);
		...
		return new Object[] { match, tClass, tPackage, pg, pg__tClass____classes, tClass__tPackage____package,
				tPackage__tClass____allTypes, pg__tClass____allTypes, tClass__pg____model };
	}

	public static final void pattern_AnnotationTypeInAnonymous_10_6_registerobjectstomatch_expressionBBBBBB(
			AnnotationTypeInAnonymous _this, Match match, TClass tClass, TPackage tPackage, TypeGraph pg,
			TAnnotationType tNestedType) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_11_1_performtransformation_bindingFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("tClass");
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_11_1_performtransformation_blackBBBBBBFBB(
			TClass tClass, TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration, AnnotationTypeInAnonymous _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
			AnnotationTypeInAnonymous _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_binding = pattern_AnnotationTypeInAnonymous_11_1_performtransformation_bindingFFFFFFB(
				isApplicableMatch);
		if (result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_binding != null) {
			...
			TPackage tPackage = (TPackage) result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_binding[1];
			TypeGraph pg = (TypeGraph) result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_binding[2];
			TAnnotationType tNestedType = (TAnnotationType) result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_binding[3];
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass = (AnonymousClassDeclarationToTClass) result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_binding[4];
			AnonymousClassDeclaration eAnonymousClassDeclaration = (AnonymousClassDeclaration) result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_binding[5];

			Object[] result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_black = pattern_AnnotationTypeInAnonymous_11_1_performtransformation_blackBBBBBBFBB(
			...
			if (result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_AnnotationTypeInAnonymous_11_1_performtransformation_black[6];
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_11_1_performtransformation_greenFFBBFB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_11_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tClass, EObject mNestedType, EObject mASTNodeToAnnotatable,
			EObject tPackage, EObject pg, EObject tNestedType, EObject eAnonymousClassDeclarationToTClass,
			EObject eAnonymousClassDeclaration, EObject mNestedTypeToTNestedType) {
		if (!tClass.equals(tPackage)) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_11_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tClass, EObject mNestedType, EObject mASTNodeToAnnotatable,
			EObject pg, EObject tNestedType, EObject eAnonymousClassDeclaration, EObject mNestedTypeToTNestedType) {
		EMoflonEdge mASTNodeToAnnotatable__mNestedType____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge pg__tNestedType____annotationTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		pg__tNestedType____annotationTypes.setSrc(pg);
		pg__tNestedType____annotationTypes.setTrg(tNestedType);
		ruleresult.getTranslatedEdges().add(pg__tNestedType____annotationTypes);
		tClass__tNestedType____innerTypes.setSrc(tClass);
		tClass__tNestedType____innerTypes.setTrg(tNestedType);
		...
		pg__tNestedType____allTypes.setSrc(pg);
		pg__tNestedType____allTypes.setTrg(tNestedType);
		ruleresult.getTranslatedEdges().add(pg__tNestedType____allTypes);
		tNestedType__pg____model.setSrc(tNestedType);
		tNestedType__pg____model.setTrg(pg);
	...
	public static final void pattern_AnnotationTypeInAnonymous_11_5_registerobjects_expressionBBBBBBBBBBB(
			AnnotationTypeInAnonymous _this, PerformRuleResult ruleresult, EObject tClass, EObject mNestedType,
			EObject mASTNodeToAnnotatable, EObject tPackage, EObject pg, EObject tNestedType,
			EObject eAnonymousClassDeclarationToTClass, EObject eAnonymousClassDeclaration,
			EObject mNestedTypeToTNestedType) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_12_2_corematch_bindingFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeInAnonymous_12_2_corematch_blackBBBBFFB(TClass tClass,
			TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeInAnonymous_12_3_findcontext_blackBBBBBB(TClass tClass,
			TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (pg.getClasses().contains(tClass)) {
			if (tPackage.equals(tClass.getPackage())) {
				if (tClass.equals(eAnonymousClassDeclarationToTClass.getTarget())) {
					if (pg.getAnnotationTypes().contains(tNestedType)) {
						if (eAnonymousClassDeclaration.equals(eAnonymousClassDeclarationToTClass.getSource())) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_12_3_findcontext_greenBBBBBBFFFFFFFFFFFFF(
			TClass tClass, TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		...
		pg__tNestedType____annotationTypes.setSrc(pg);
		pg__tNestedType____annotationTypes.setTrg(tNestedType);
		isApplicableMatch.getAllContextElements().add(pg__tNestedType____annotationTypes);
		eAnonymousClassDeclarationToTClass__eAnonymousClassDeclaration____source
				.setSrc(eAnonymousClassDeclarationToTClass);
		eAnonymousClassDeclarationToTClass__eAnonymousClassDeclaration____source.setTrg(eAnonymousClassDeclaration);
		isApplicableMatch.getAllContextElements()
		...
		pg__tNestedType____allTypes.setSrc(pg);
		pg__tNestedType____allTypes.setTrg(tNestedType);
		isApplicableMatch.getAllContextElements().add(pg__tNestedType____allTypes);
		tNestedType__pg____model.setSrc(tNestedType);
		tNestedType__pg____model.setTrg(pg);
		...
		return new Object[] { tClass, tPackage, pg, tNestedType, eAnonymousClassDeclarationToTClass,
				eAnonymousClassDeclaration, isApplicableMatch, pg__tClass____classes, tClass__tPackage____package,
				tPackage__tClass____allTypes, eAnonymousClassDeclarationToTClass__tClass____target,
				pg__tNestedType____annotationTypes,
				eAnonymousClassDeclarationToTClass__eAnonymousClassDeclaration____source,
				tClass__tNestedType____innerTypes, tNestedType__tClass____outerType, pg__tNestedType____allTypes,
				tNestedType__pg____model, pg__tClass____allTypes, tClass__pg____model };
	}

	public static final Object[] pattern_AnnotationTypeInAnonymous_12_4_solveCSP_bindingFBBBBBBBB(
			AnnotationTypeInAnonymous _this, IsApplicableMatch isApplicableMatch, TClass tClass, TPackage tPackage,
			TypeGraph pg, TAnnotationType tNestedType,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
			AnnotationTypeInAnonymous _this, IsApplicableMatch isApplicableMatch, TClass tClass, TPackage tPackage,
			TypeGraph pg, TAnnotationType tNestedType,
			AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration) {
		Object[] result_pattern_AnnotationTypeInAnonymous_12_4_solveCSP_binding = pattern_AnnotationTypeInAnonymous_12_4_solveCSP_bindingFBBBBBBBB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TypeGraph __DEC_tNestedType_annotationTypes_438744 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "annotationTypes")) {
			if (!pg.equals(__DEC_tNestedType_annotationTypes_438744)) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_black_nac_1BB(
			TAnnotationType tNestedType, TClass tClass) {
		TAbstractType __DEC_tNestedType_innerTypes_28161 = tNestedType.getOuterType();
		if (__DEC_tNestedType_innerTypes_28161 != null) {
			if (!tNestedType.equals(__DEC_tNestedType_innerTypes_28161)) {
				if (!tClass.equals(__DEC_tNestedType_innerTypes_28161)) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_black_nac_2BB(
			TAnnotationType tNestedType, TPackage tPackage) {
		TPackage __DEC_tNestedType_allTypes_867473 = tNestedType.getPackage();
		if (__DEC_tNestedType_allTypes_867473 != null) {
			if (!tPackage.equals(__DEC_tNestedType_allTypes_867473)) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_black_nac_3BB(
			TPackage tPackage, TAnnotationType tNestedType) {
		if (tPackage.getAllTypes().contains(tNestedType)) {
			return new Object[] { tPackage, tNestedType };
		}
		return null;
	}

	public static final Iterable<Object[]> pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_blackFFFFB(
			EMoflonEdge _edge_annotationTypes) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		EObject tmpPg = _edge_annotationTypes.getSrc();
		if (tmpPg instanceof TypeGraph) {
			TypeGraph pg = (TypeGraph) tmpPg;
			EObject tmpTNestedType = _edge_annotationTypes.getTrg();
			if (tmpTNestedType instanceof TAnnotationType) {
				TAnnotationType tNestedType = (TAnnotationType) tmpTNestedType;
				if (pg.getAnnotationTypes().contains(tNestedType)) {
					if (pg.getAllTypes().contains(tNestedType)) {
								...
								if (pg.getAllTypes().contains(tClass)) {
									...
									if (tPackage != null) {
										if (pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_black_nac_0BB(
												tNestedType, pg) == null) {
											if (pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_black_nac_1BB(
	...
	public static final boolean pattern_AnnotationTypeInAnonymous_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			AnnotationTypeInAnonymous _this, Match match, TClass tClass, TPackage tPackage, TypeGraph pg,
			TAnnotationType tNestedType) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_21_2_testcorematchandDECs_black_nac_0B(
		...
		AbstractTypeDeclaration __DEC_mNestedType_abstractTypeDeclaration_549864 = mNestedType
				.getAbstractTypeDeclaration();
		if (__DEC_mNestedType_abstractTypeDeclaration_549864 != null) {
			if (!mNestedType.equals(__DEC_mNestedType_abstractTypeDeclaration_549864)) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_21_2_testcorematchandDECs_black_nac_1B(
			AnnotationTypeDeclaration mNestedType) {
		for (Model __DEC_mNestedType_orphanTypes_480363 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_21_2_testcorematchandDECs_black_nac_2B(
			AnnotationTypeDeclaration mNestedType) {
		org.eclipse.modisco.java.Package __DEC_mNestedType_ownedElements_976597 = mNestedType.getPackage();
		if (__DEC_mNestedType_ownedElements_976597 != null) {
			return new Object[] { mNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_21_2_testcorematchandDECs_black_nac_3B(
			AnnotationTypeDeclaration mNestedType) {
		for (MAbstractMethodDefinition __DEC_mNestedType_mInnerTypes_830966 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_bindingFFFFFFBB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(TClass tClass,
			AnnotationTypeDeclaration mNestedType, TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType,
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_binding = pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_bindingFFFFFFBB(
		...
		if (result_pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			TPackage tPackage = (TPackage) result_pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_binding[2];
			TypeGraph pg = (TypeGraph) result_pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_binding[3];
			TAnnotationType tNestedType = (TAnnotationType) result_pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_binding[4];
			AnonymousClassDeclaration eAnonymousClassDeclaration = (AnonymousClassDeclaration) result_pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_binding[5];

			Object[] result_pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_black = pattern_AnnotationTypeInAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
			AnnotationTypeInAnonymous _this, TClass tClass, AnnotationTypeDeclaration mNestedType, TPackage tPackage,
			TypeGraph pg, TAnnotationType tNestedType, AnonymousClassDeclaration eAnonymousClassDeclaration,
			Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationTypeInAnonymous _this, TClass tClass, AnnotationTypeDeclaration mNestedType, TPackage tPackage,
			TypeGraph pg, TAnnotationType tNestedType, AnonymousClassDeclaration eAnonymousClassDeclaration,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_AnnotationTypeInAnonymous_24_3_solvecsp_binding = pattern_AnnotationTypeInAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_24_6_createcorrespondence_blackBBBBBBB(TClass tClass,
			AnnotationTypeDeclaration mNestedType, TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType,
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_27_1_matchtggpattern_black_nac_0B(
			AnnotationTypeDeclaration mNestedType) {
		AbstractTypeDeclaration __DEC_mNestedType_abstractTypeDeclaration_903068 = mNestedType
				.getAbstractTypeDeclaration();
		if (__DEC_mNestedType_abstractTypeDeclaration_903068 != null) {
			if (!mNestedType.equals(__DEC_mNestedType_abstractTypeDeclaration_903068)) {
				return new Object[] { mNestedType };
			}
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_27_1_matchtggpattern_black_nac_1B(
			AnnotationTypeDeclaration mNestedType) {
		for (Model __DEC_mNestedType_orphanTypes_487077 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mNestedType, Model.class, "orphanTypes")) {
			return new Object[] { mNestedType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_27_1_matchtggpattern_black_nac_2B(
			AnnotationTypeDeclaration mNestedType) {
		org.eclipse.modisco.java.Package __DEC_mNestedType_ownedElements_945780 = mNestedType.getPackage();
		if (__DEC_mNestedType_ownedElements_945780 != null) {
			return new Object[] { mNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_27_1_matchtggpattern_black_nac_3B(
			AnnotationTypeDeclaration mNestedType) {
		for (MAbstractMethodDefinition __DEC_mNestedType_mInnerTypes_288580 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mNestedType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mNestedType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_0BB(
			TAnnotationType tNestedType, TypeGraph pg) {
		for (TypeGraph __DEC_tNestedType_annotationTypes_793937 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "annotationTypes")) {
			if (!pg.equals(__DEC_tNestedType_annotationTypes_793937)) {
				return new Object[] { tNestedType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_1BB(
			TAnnotationType tNestedType, TClass tClass) {
		TAbstractType __DEC_tNestedType_innerTypes_436518 = tNestedType.getOuterType();
		if (__DEC_tNestedType_innerTypes_436518 != null) {
			if (!tNestedType.equals(__DEC_tNestedType_innerTypes_436518)) {
				if (!tClass.equals(__DEC_tNestedType_innerTypes_436518)) {
					return new Object[] { tNestedType, tClass };
				}
			}
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_2BB(
			TAnnotationType tNestedType, TPackage tPackage) {
		TPackage __DEC_tNestedType_allTypes_939032 = tNestedType.getPackage();
		if (__DEC_tNestedType_allTypes_939032 != null) {
			if (!tPackage.equals(__DEC_tNestedType_allTypes_939032)) {
				return new Object[] { tNestedType, tPackage };
			}
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_3BB(TPackage tPackage,
			TAnnotationType tNestedType) {
		if (tPackage.getAllTypes().contains(tNestedType)) {
			return new Object[] { tPackage, tNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_blackBBBB(TClass tClass,
			TPackage tPackage, TypeGraph pg, TAnnotationType tNestedType) {
		if (pg.getClasses().contains(tClass)) {
			if (tPackage.equals(tClass.getPackage())) {
				if (pg.getAnnotationTypes().contains(tNestedType)) {
						...
						if (pg.getAllTypes().contains(tNestedType)) {
							if (pg.getAllTypes().contains(tClass)) {
								if (pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_0BB(tNestedType,
										pg) == null) {
									if (pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_1BB(
											tNestedType, tClass) == null) {
										if (pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_2BB(
												tNestedType, tPackage) == null) {
											if (pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_3BB(
													tPackage, tNestedType) == null) {
												return new Object[] { tClass, tPackage, pg, tNestedType };
											}
										}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Iterable<Object[]> pattern_AnnotationTypeInAnonymous_29_2_isapplicablecore_blackFFFFFFBB(
									...
									if (pg.getClasses().contains(tClass)) {
										if (pattern_AnnotationTypeInAnonymous_29_2_isapplicablecore_black_nac_3BB(
											...
											if (pattern_AnnotationTypeInAnonymous_29_2_isapplicablecore_black_nac_0BB(
												...
												if (pattern_AnnotationTypeInAnonymous_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_29_3_solveCSP_bindingFBBBBBBBB(
			AnnotationTypeInAnonymous _this, IsApplicableMatch isApplicableMatch, TClass tClass, TPackage tPackage,
			TypeGraph pg, AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBB(
			AnnotationTypeInAnonymous _this, IsApplicableMatch isApplicableMatch, TClass tClass, TPackage tPackage,
			TypeGraph pg, AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_AnnotationTypeInAnonymous_29_3_solveCSP_binding = pattern_AnnotationTypeInAnonymous_29_3_solveCSP_bindingFBBBBBBBB(
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_29_5_checknacs_blackBBBBB(TClass tClass,
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_29_6_perform_blackBBBBBB(TClass tClass,
			TPackage tPackage, TypeGraph pg, AnonymousClassDeclarationToTClass eAnonymousClassDeclarationToTClass,
			AnonymousClassDeclaration eAnonymousClassDeclaration, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tClass, tPackage, pg, eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration,
				ruleResult };
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_29_6_perform_greenBFFBFBFBB(TClass tClass,
