...
public class AnnotationMemberValueAnnotationImpl extends AbstractRuleImpl implements AnnotationMemberValueAnnotation {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_VALUE_ANNOTATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_41__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_41((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_VALUE_ANNOTATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_43__EMOFLONEDGE:
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_20_2_testcorematchandDECs_black_nac_0B(
			TAnnotation tValue) {
		TAnnotatable __DEC_tValue_tAnnotated_823683 = tValue.getTAnnotated();
		if (__DEC_tValue_tAnnotated_823683 != null) {
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_20_2_testcorematchandDECs_black_nac_1B(
			TAnnotation tValue) {
		TAnnotatable __DEC_tValue_tAnnotation_803327 = tValue.getTAnnotated();
		if (__DEC_tValue_tAnnotation_803327 != null) {
			return new Object[] { tValue };
		}
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (BodyDeclaration __DEC_mValue_annotations_246892 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mValue, BodyDeclaration.class, "annotations")) {
			if (!mOwner.equals(__DEC_mValue_annotations_246892)) {
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_27_1_matchtggpattern_black_nac_0BB(
			Annotation mValue, BodyDeclaration mOwner) {
		for (BodyDeclaration __DEC_mValue_annotations_415068 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mValue, BodyDeclaration.class, "annotations")) {
			if (!mOwner.equals(__DEC_mValue_annotations_415068)) {
				return new Object[] { mValue, mOwner };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_28_1_matchtggpattern_black_nac_0B(
			TAnnotation tValue) {
		TAnnotatable __DEC_tValue_tAnnotated_982251 = tValue.getTAnnotated();
		if (__DEC_tValue_tAnnotated_982251 != null) {
			return new Object[] { tValue };
		}
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_28_1_matchtggpattern_black_nac_1B(
			TAnnotation tValue) {
		TAnnotatable __DEC_tValue_tAnnotation_139380 = tValue.getTAnnotated();
		if (__DEC_tValue_tAnnotation_139380 != null) {
			return new Object[] { tValue };
		}
