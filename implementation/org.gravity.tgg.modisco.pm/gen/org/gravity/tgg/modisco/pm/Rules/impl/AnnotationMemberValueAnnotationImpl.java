...
public class AnnotationMemberValueAnnotationImpl extends AbstractRuleImpl implements AnnotationMemberValueAnnotation {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_34(EMoflonEdge _edge_tValue) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_VALUE_ANNOTATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_34__EMOFLONEDGE:
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_20_2_testcorematchandDECs_black_nac_0B(
			TAnnotation tValue) {
		TAnnotatable __DEC_tValue_tAnnotated_44352 = tValue.getTAnnotated();
		if (__DEC_tValue_tAnnotated_44352 != null) {
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_20_2_testcorematchandDECs_black_nac_1B(
			TAnnotation tValue) {
		TAnnotatable __DEC_tValue_tAnnotation_12729 = tValue.getTAnnotated();
		if (__DEC_tValue_tAnnotation_12729 != null) {
			return new Object[] { tValue };
		}
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (BodyDeclaration __DEC_mValue_annotations_43027 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mValue, BodyDeclaration.class, "annotations")) {
			if (!mOwner.equals(__DEC_mValue_annotations_43027)) {
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_27_1_matchtggpattern_black_nac_0BB(
			Annotation mValue, BodyDeclaration mOwner) {
		for (BodyDeclaration __DEC_mValue_annotations_800443 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mValue, BodyDeclaration.class, "annotations")) {
			if (!mOwner.equals(__DEC_mValue_annotations_800443)) {
				return new Object[] { mValue, mOwner };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_28_1_matchtggpattern_black_nac_0B(
			TAnnotation tValue) {
		TAnnotatable __DEC_tValue_tAnnotated_714003 = tValue.getTAnnotated();
		if (__DEC_tValue_tAnnotated_714003 != null) {
			return new Object[] { tValue };
		}
	...
	public static final Object[] pattern_AnnotationMemberValueAnnotation_28_1_matchtggpattern_black_nac_1B(
			TAnnotation tValue) {
		TAnnotatable __DEC_tValue_tAnnotation_779754 = tValue.getTAnnotated();
		if (__DEC_tValue_tAnnotation_779754 != null) {
			return new Object[] { tValue };
		}
