...
public class FlowNodeImpl extends AbstractRuleImpl implements FlowNode {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = FlowNodeImpl.pattern_FlowNode_1_2_collecttranslatedelements_blackBBBB(
				mAbstFlowToTAbstFlow, mFlowToTFlow, tFlow, mFlow);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mAbstFlowToTAbstFlow] = "
					+ mAbstFlowToTAbstFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[tFlow] = " + tFlow
					+ ", " + "[mFlow] = " + mFlow + ".");
		}
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
				mAbstFlowToTAbstFlow, mFlowToTFlow, tOwner, mOwnerToTOwner, tFlow, mFlow, mOwner);
		...
		FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, mAbstFlowToTAbstFlow,
				mFlowToTFlow, tOwner, tFlow, mFlow, mOwner);
		...
		FlowNodeImpl.pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, mAbstFlowToTAbstFlow,
				mFlowToTFlow, tOwner, mOwnerToTOwner, tFlow, mFlow, mOwner);
		...
		for (Object[] result2_black : FlowNodeImpl.pattern_FlowNode_2_2_corematch_blackFFBBB(mFlow, mOwner, match)) {
			...
			for (Object[] result3_black : FlowNodeImpl.pattern_FlowNode_2_3_findcontext_blackBBBB(tOwner,
				...
				Object[] result4_bindingAndBlack = FlowNodeImpl.pattern_FlowNode_2_4_solveCSP_bindingAndBlackFBBBBBB(
						this, isApplicableMatch, tOwner, mOwnerToTOwner, mFlow, mOwner);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TAbstractFlowElement tOwner,
			MAbstractFlowElementToTAbstractFlowElement mOwnerToTOwner, MFlow mFlow, MAbstractFlowElement mOwner) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mAbstFlowToTAbstFlow, EObject mFlowToTFlow,
			EObject tOwner, EObject mOwnerToTOwner, EObject tFlow, EObject mFlow, EObject mOwner) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_69(EMoflonEdge _edge_ownedFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_73(EMoflonEdge _edge_ownedFlows) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FLOW_NODE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENT:
		...
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_69__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_69((EMoflonEdge) arguments.get(0));
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_73__EMOFLONEDGE:
			...
			if (tmpMOwnerToTOwner instanceof MAbstractFlowElementToTAbstractFlowElement) {
				...
				if (tmpMFlow instanceof MFlow) {
					...
					if (tmpMOwner instanceof MAbstractFlowElement) {
						...
						return new Object[] { tOwner, mOwnerToTOwner, mFlow, mOwner, isApplicableMatch };
					}
				}
			}
		}
		...
		if (!mFlow.equals(mOwner)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { tOwner, mOwnerToTOwner, mFlow, mOwner, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_bindingAndBlackFFFFFBB(FlowNode _this,
		...
		if (result_pattern_FlowNode_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FlowNode_1_1_performtransformation_black = pattern_FlowNode_1_1_performtransformation_blackBBBBFBB(
					tOwner, mOwnerToTOwner, mFlow, mOwner, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_greenFFBFB(TAbstractFlowElement tOwner,
		...
		return new Object[] { mAbstFlowToTAbstFlow, mFlowToTFlow, tOwner, tFlow, mFlow };
	}
	...
	public static final Object[] pattern_FlowNode_1_2_collecttranslatedelements_blackBBBB(
			...
			MFlow mFlow) {
		return new Object[] { mAbstFlowToTAbstFlow, mFlowToTFlow, tFlow, mFlow };
	}
	...
	public static final Object[] pattern_FlowNode_1_2_collecttranslatedelements_greenFBBBB(
		...
		return new Object[] { ruleresult, mAbstFlowToTAbstFlow, mFlowToTFlow, tFlow, mFlow };
	}

	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(PerformRuleResult ruleresult,
			EObject mAbstFlowToTAbstFlow, EObject mFlowToTFlow, EObject tOwner, EObject mOwnerToTOwner, EObject tFlow,
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(
		...
		mOwner__mFlow____ownedFlows.setName(mOwner__mFlow____ownedFlows_name_prime);
		mFlow__mOwner____flowOwner.setName(mFlow__mOwner____flowOwner_name_prime);
		return new Object[] { ruleresult, mAbstFlowToTAbstFlow, mFlowToTFlow, tOwner, tFlow, mFlow, mOwner,
				tOwner__tFlow____ownedFlows, tFlow__tOwner____flowOwner, mAbstFlowToTAbstFlow__tFlow____target,
				mFlowToTFlow__mFlow____source, mFlowToTFlow__tFlow____target, mAbstFlowToTAbstFlow__mFlow____source,
	...
	public static final void pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mAbstFlowToTAbstFlow, EObject mFlowToTFlow, EObject tOwner,
			EObject mOwnerToTOwner, EObject tFlow, EObject mFlow, EObject mOwner) {
		_this.registerObjects_FWD(ruleresult, mAbstFlowToTAbstFlow, mFlowToTFlow, tOwner, mOwnerToTOwner, tFlow, mFlow,
				mOwner);
	...
	public static final Iterable<Object[]> pattern_FlowNode_2_2_corematch_blackFFBBB(MFlow mFlow,
		...
		if (!mFlow.equals(mOwner)) {
			for (MAbstractFlowElementToTAbstractFlowElement mOwnerToTOwner : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tOwner != null) {
					_result.add(new Object[] { tOwner, mOwnerToTOwner, mFlow, mOwner, match });
				}
			...
			if (tOwner.equals(mOwnerToTOwner.getTarget())) {
				if (mOwner.getOwnedFlows().contains(mFlow)) {
					if (mOwner.equals(mOwnerToTOwner.getSource())) {
						_result.add(new Object[] { tOwner, mOwnerToTOwner, mFlow, mOwner });
					}
				}
			}
		}
	...
	public static final Object[] pattern_FlowNode_2_4_solveCSP_bindingFBBBBBB(FlowNode _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mOwnerToTOwner, MFlow mFlow, MAbstractFlowElement mOwner) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tOwner, mOwnerToTOwner, mFlow,
				mOwner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tOwner, mOwnerToTOwner, mFlow, mOwner };
		}
		return null;
	}
	...
	public static final Object[] pattern_FlowNode_2_4_solveCSP_bindingAndBlackFBBBBBB(FlowNode _this,
		...
		Object[] result_pattern_FlowNode_2_4_solveCSP_binding = pattern_FlowNode_2_4_solveCSP_bindingFBBBBBB(_this,
				isApplicableMatch, tOwner, mOwnerToTOwner, mFlow, mOwner);
	...
	public static final Object[] pattern_FlowNode_11_1_performtransformation_greenFFBFB(TFlow tFlow,
		...
		return new Object[] { mAbstFlowToTAbstFlow, mFlowToTFlow, tFlow, mFlow, mOwner };
	}
	...
	public static final void pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mAbstFlowToTAbstFlow, EObject mFlowToTFlow, EObject tOwner,
			EObject mOwnerToTOwner, EObject tFlow, EObject mFlow, EObject mOwner) {
		_this.registerObjects_BWD(ruleresult, mAbstFlowToTAbstFlow, mFlowToTFlow, tOwner, mOwnerToTOwner, tFlow, mFlow,
				mOwner);
	...
	public static final Object[] pattern_FlowNode_24_6_createcorrespondence_greenFFBBB(TFlow tFlow, MFlow mFlow,
		...
		return new Object[] { mAbstFlowToTAbstFlow, mFlowToTFlow, tFlow, mFlow, ccMatch };
	}
	...
	public static final Object[] pattern_FlowNode_29_6_perform_greenFFBFFBB(TAbstractFlowElement tOwner,
		...
		return new Object[] { mAbstFlowToTAbstFlow, mFlowToTFlow, tOwner, tFlow, mFlow, mOwner, ruleResult };
	}
