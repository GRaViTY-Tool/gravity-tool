...
public class FlowNodeImpl extends AbstractRuleImpl implements FlowNode {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = FlowNodeImpl.pattern_FlowNode_1_2_collecttranslatedelements_blackBBBB(
				mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mFlow);
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, mOwner,
				mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mOwnerToTOwner, mFlow, tOwner);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mOwner] = " + mOwner + ", " + "[mAbstFlowToTAbstFlow] = " + mAbstFlowToTAbstFlow + ", "
					+ "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mOwnerToTOwner] = "
					+ mOwnerToTOwner + ", " + "[mFlow] = " + mFlow + ", " + "[tOwner] = " + tOwner + ".");
		}
		FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, mOwner,
				mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mFlow, tOwner);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mOwner, EObject mAbstFlowToTAbstFlow,
			EObject tFlow, EObject mFlowToTFlow, EObject mOwnerToTOwner, EObject mFlow, EObject tOwner) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_11_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
				mOwner, mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mOwnerToTOwner, mFlow, tOwner);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mOwner] = " + mOwner + ", " + "[mAbstFlowToTAbstFlow] = " + mAbstFlowToTAbstFlow + ", "
					+ "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mOwnerToTOwner] = "
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_264(EMoflonEdge _edge_ownedFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_275(EMoflonEdge _edge_ownedFlows) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (FlowNodeImpl.pattern_FlowNode_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FlowNodeImpl.pattern_FlowNode_24_5_matchcorrcontext_blackBFBBB(mOwner, tOwner,
				...
				FlowNodeImpl.pattern_FlowNode_24_6_createcorrespondence_greenFBFBB(tFlow, mFlow, ccMatch);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_264__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_264((EMoflonEdge) arguments.get(0));
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_275__EMOFLONEDGE:
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_greenFFFBB(MFlow mFlow,
		...
		return new Object[] { mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mFlow, tOwner };
	}
	...
	public static final Object[] pattern_FlowNode_1_2_collecttranslatedelements_blackBBBB(
			...
			MFlow mFlow) {
		return new Object[] { mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mFlow };
	}
	...
	public static final Object[] pattern_FlowNode_1_2_collecttranslatedelements_greenFBBBB(
		...
		return new Object[] { ruleresult, mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mFlow };
	}

	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(PerformRuleResult ruleresult,
			EObject mOwner, EObject mAbstFlowToTAbstFlow, EObject tFlow, EObject mFlowToTFlow, EObject mOwnerToTOwner,
			EObject mFlow, EObject tOwner) {
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject mOwner, EObject mAbstFlowToTAbstFlow, EObject tFlow,
		...
		return new Object[] { ruleresult, mOwner, mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mFlow, tOwner,
				mOwner__mFlow____ownedFlows, mFlow__mOwner____flowOwner, mFlowToTFlow__tFlow____target,
				mAbstFlowToTAbstFlow__tFlow____target, mFlowToTFlow__mFlow____source, tOwner__tFlow____ownedFlows,
	...
	public static final void pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mOwner, EObject mAbstFlowToTAbstFlow, EObject tFlow,
			EObject mFlowToTFlow, EObject mOwnerToTOwner, EObject mFlow, EObject tOwner) {
		_this.registerObjects_FWD(ruleresult, mOwner, mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mOwnerToTOwner, mFlow,
				tOwner);
	...
	public static final Object[] pattern_FlowNode_2_3_findcontext_greenBBBBFFFFF(MAbstractFlowElement mOwner,
		...
		return new Object[] { mOwner, mOwnerToTOwner, mFlow, tOwner, isApplicableMatch, mOwner__mFlow____ownedFlows,
	...
	public static final Object[] pattern_FlowNode_11_1_performtransformation_greenBFBFF(MAbstractFlowElement mOwner,
		...
		mFlowToTFlow.setSource(mFlow);
		mAbstFlowToTAbstFlow.setSource(mFlow);
		return new Object[] { mOwner, mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mFlow };
	}
	...
	public static final void pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mOwner, EObject mAbstFlowToTAbstFlow, EObject tFlow,
			EObject mFlowToTFlow, EObject mOwnerToTOwner, EObject mFlow, EObject tOwner) {
		_this.registerObjects_BWD(ruleresult, mOwner, mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mOwnerToTOwner, mFlow,
				tOwner);
	...
	public static final Object[] pattern_FlowNode_24_6_createcorrespondence_greenFBFBB(TFlow tFlow, MFlow mFlow,
			CCMatch ccMatch) {
		MAbstractFlowElementToTAbstractFlowElement mAbstFlowToTAbstFlow = PmFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MFlowToTFlow mFlowToTFlow = PmFactory.eINSTANCE.createMFlowToTFlow();
		...
		return new Object[] { mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mFlow, ccMatch };
	}
	...
	public static final Object[] pattern_FlowNode_29_6_perform_greenBFFFFBB(MAbstractFlowElement mOwner,
		...
		return new Object[] { mOwner, mAbstFlowToTAbstFlow, tFlow, mFlowToTFlow, mFlow, tOwner, ruleResult };
	}
