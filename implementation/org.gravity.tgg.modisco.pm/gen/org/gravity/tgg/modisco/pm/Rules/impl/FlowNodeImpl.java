...
public class FlowNodeImpl extends AbstractRuleImpl implements FlowNode {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, tFlow,
				mAbstFlowToTAbstFlow, mOwnerToTOwner, mFlowToTFlow, mFlow, tOwner, mOwner);
		...
		FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, tFlow,
				mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow, tOwner, mOwner);
		...
		//nothing EMoflonEdge tOwner__tFlow____ownedFlows = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge tFlow__tOwner____flowOwner = (EMoflonEdge) result3_green[11];
		...
		for (Object[] result2_black : FlowNodeImpl.pattern_FlowNode_2_2_corematch_blackFBFBB(mFlow, mOwner, match)) {
			...
			for (Object[] result3_black : FlowNodeImpl.pattern_FlowNode_2_3_findcontext_blackBBBB(mOwnerToTOwner, mFlow,
				...
				Object[] result4_bindingAndBlack = FlowNodeImpl.pattern_FlowNode_2_4_solveCSP_bindingAndBlackFBBBBBB(
						this, isApplicableMatch, mOwnerToTOwner, mFlow, tOwner, mOwner);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tFlow, EObject mAbstFlowToTAbstFlow,
			EObject mOwnerToTOwner, EObject mFlowToTFlow, EObject mFlow, EObject tOwner, EObject mOwner) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MAbstractFlowElement mOwner = (MAbstractFlowElement) result1_bindingAndBlack[3];
		//nothing CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = FlowNodeImpl.pattern_FlowNode_11_1_performtransformation_greenBFFFB(tFlow, mOwner);
		MAbstractFlowElementToTAbstractFlowElement mAbstFlowToTAbstFlow = (MAbstractFlowElementToTAbstractFlowElement) result1_green[1];
		MFlowToTFlow mFlowToTFlow = (MFlowToTFlow) result1_green[2];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_83(EMoflonEdge _edge_ownedFlows) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.FLOW_NODE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT:
			...
			case RulesPackage.FLOW_NODE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_83__EMOFLONEDGE:
			...
			if (tmpMFlow instanceof MFlow) {
				...
				if (tmpTOwner instanceof TAbstractFlowElement) {
					...
					if (tmpMOwner instanceof MAbstractFlowElement) {
						...
						return new Object[] { mOwnerToTOwner, mFlow, tOwner, mOwner, isApplicableMatch };
					}
				}
			}
		}
		...
		if (!mFlow.equals(mOwner)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { mOwnerToTOwner, mFlow, tOwner, mOwner, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_bindingAndBlackFFFFFBB(FlowNode _this,
		...
		if (result_pattern_FlowNode_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FlowNode_1_1_performtransformation_black = pattern_FlowNode_1_1_performtransformation_blackBBBBFBB(
					mOwnerToTOwner, mFlow, tOwner, mOwner, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(PerformRuleResult ruleresult,
			EObject tFlow, EObject mAbstFlowToTAbstFlow, EObject mOwnerToTOwner, EObject mFlowToTFlow, EObject mFlow,
			EObject tOwner, EObject mOwner) {
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject tFlow, EObject mAbstFlowToTAbstFlow, EObject mFlowToTFlow,
			EObject mFlow, EObject tOwner, EObject mOwner) {
		...
		mOwner__mFlow____ownedFlows.setName(mOwner__mFlow____ownedFlows_name_prime);
		mFlow__mOwner____flowOwner.setName(mFlow__mOwner____flowOwner_name_prime);
		return new Object[] { ruleresult, tFlow, mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow, tOwner, mOwner,
	...
	public static final void pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject tFlow, EObject mAbstFlowToTAbstFlow, EObject mOwnerToTOwner,
			EObject mFlowToTFlow, EObject mFlow, EObject tOwner, EObject mOwner) {
		_this.registerObjects_FWD(ruleresult, tFlow, mAbstFlowToTAbstFlow, mOwnerToTOwner, mFlowToTFlow, mFlow, tOwner,
				mOwner);
	...
	public static final Iterable<Object[]> pattern_FlowNode_2_2_corematch_blackFBFBB(MFlow mFlow,
		...
		if (!mFlow.equals(mOwner)) {
			for (MAbstractFlowElementToTAbstractFlowElement mOwnerToTOwner : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tOwner != null) {
					_result.add(new Object[] { mOwnerToTOwner, mFlow, tOwner, mOwner, match });
				}
			...
			if (tOwner.equals(mOwnerToTOwner.getTarget())) {
				if (mOwner.getOwnedFlows().contains(mFlow)) {
					if (mOwner.equals(mOwnerToTOwner.getSource())) {
						_result.add(new Object[] { mOwnerToTOwner, mFlow, tOwner, mOwner });
					}
				}
			}
		}
	...
	public static final Object[] pattern_FlowNode_2_4_solveCSP_bindingFBBBBBB(FlowNode _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mOwnerToTOwner, mFlow, tOwner,
				mOwner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mOwnerToTOwner, mFlow, tOwner, mOwner };
		}
		return null;
	}
	...
	public static final Object[] pattern_FlowNode_2_4_solveCSP_bindingAndBlackFBBBBBB(FlowNode _this,
		...
		Object[] result_pattern_FlowNode_2_4_solveCSP_binding = pattern_FlowNode_2_4_solveCSP_bindingFBBBBBB(_this,
				isApplicableMatch, mOwnerToTOwner, mFlow, tOwner, mOwner);
	...
	public static final Object[] pattern_FlowNode_11_1_performtransformation_greenBFFFB(TFlow tFlow,
			MAbstractFlowElement mOwner) {
		MAbstractFlowElementToTAbstractFlowElement mAbstFlowToTAbstFlow = PmFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MFlowToTFlow mFlowToTFlow = PmFactory.eINSTANCE.createMFlowToTFlow();
		...
		return new Object[] { tFlow, mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow, mOwner };
	}
	...
	public static final void pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject tFlow, EObject mAbstFlowToTAbstFlow, EObject mOwnerToTOwner,
			EObject mFlowToTFlow, EObject mFlow, EObject tOwner, EObject mOwner) {
		_this.registerObjects_BWD(ruleresult, tFlow, mAbstFlowToTAbstFlow, mOwnerToTOwner, mFlowToTFlow, mFlow, tOwner,
				mOwner);
	...
	public static final Object[] pattern_FlowNode_29_6_perform_greenFFFFBBB(TAbstractFlowElement tOwner,
		...
		return new Object[] { tFlow, mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow, tOwner, mOwner, ruleResult };
	}
