...
public class FlowNodeImpl extends AbstractRuleImpl implements FlowNode {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, mOwner,
				tFlow, mFlowToTFlow, tOwner, mOwnerToTOwner, mFlow, mAbstFlowToTAbstFlow);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mOwner] = " + mOwner + ", " + "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = "
					+ mFlowToTFlow + ", " + "[tOwner] = " + tOwner + ", " + "[mOwnerToTOwner] = " + mOwnerToTOwner
		...
		FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, mOwner, tFlow,
				mFlowToTFlow, tOwner, mFlow, mAbstFlowToTAbstFlow);
		...
		FlowNodeImpl.pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, mOwner, tFlow,
				mFlowToTFlow, tOwner, mOwnerToTOwner, mFlow, mAbstFlowToTAbstFlow);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mOwner, EObject tFlow, EObject mFlowToTFlow,
			EObject tOwner, EObject mOwnerToTOwner, EObject mFlow, EObject mAbstFlowToTAbstFlow) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_11_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
				mOwner, tFlow, mFlowToTFlow, tOwner, mOwnerToTOwner, mFlow, mAbstFlowToTAbstFlow);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mOwner] = " + mOwner + ", " + "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = "
					+ mFlowToTFlow + ", " + "[tOwner] = " + tOwner + ", " + "[mOwnerToTOwner] = " + mOwnerToTOwner
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mOwner, EObject tFlow, EObject mFlowToTFlow,
			EObject tOwner, EObject mOwnerToTOwner, EObject mFlow, EObject mAbstFlowToTAbstFlow) {
		ruleresult.registerObject("mOwner", mOwner);
		ruleresult.registerObject("tFlow", tFlow);
		ruleresult.registerObject("mFlowToTFlow", mFlowToTFlow);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_0(EMoflonEdge _edge_ownedFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_1(EMoflonEdge _edge_ownedFlows) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_0__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_0((EMoflonEdge) arguments.get(0));
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1__EMOFLONEDGE:
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_greenFFBBF(TAbstractFlowElement tOwner,
		...
		return new Object[] { tFlow, mFlowToTFlow, tOwner, mFlow, mAbstFlowToTAbstFlow };
	}
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(PerformRuleResult ruleresult,
			EObject mOwner, EObject tFlow, EObject mFlowToTFlow, EObject tOwner, EObject mOwnerToTOwner, EObject mFlow,
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject mOwner, EObject tFlow, EObject mFlowToTFlow, EObject tOwner,
		...
		return new Object[] { ruleresult, mOwner, tFlow, mFlowToTFlow, tOwner, mFlow, mAbstFlowToTAbstFlow,
				mOwner__mFlow____ownedFlows, mFlow__mOwner____flowOwner, mFlowToTFlow__tFlow____target,
				mFlowToTFlow__mFlow____source, tOwner__tFlow____ownedFlows, tFlow__tOwner____flowOwner,
	...
	public static final void pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mOwner, EObject tFlow, EObject mFlowToTFlow, EObject tOwner,
			EObject mOwnerToTOwner, EObject mFlow, EObject mAbstFlowToTAbstFlow) {
		_this.registerObjects_FWD(ruleresult, mOwner, tFlow, mFlowToTFlow, tOwner, mOwnerToTOwner, mFlow,
				mAbstFlowToTAbstFlow);
	...
	public static final void pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mOwner, EObject tFlow, EObject mFlowToTFlow, EObject tOwner,
			EObject mOwnerToTOwner, EObject mFlow, EObject mAbstFlowToTAbstFlow) {
		_this.registerObjects_BWD(ruleresult, mOwner, tFlow, mFlowToTFlow, tOwner, mOwnerToTOwner, mFlow,
				mAbstFlowToTAbstFlow);
	...
	public static final Object[] pattern_FlowNode_29_6_perform_greenBFFBFFB(MAbstractFlowElement mOwner,
		...
		return new Object[] { mOwner, tFlow, mFlowToTFlow, tOwner, mFlow, mAbstFlowToTAbstFlow, ruleResult };
	}
