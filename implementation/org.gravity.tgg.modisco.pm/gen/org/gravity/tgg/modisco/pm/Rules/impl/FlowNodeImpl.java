...
public class FlowNodeImpl extends AbstractRuleImpl implements FlowNode {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = FlowNodeImpl.pattern_FlowNode_1_2_collecttranslatedelements_blackBBBB(mFlowToTFlow,
				tFlow, mAbstFlowToTAbstFlow, mFlow);
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, mOwner,
				mFlowToTFlow, tOwner, tFlow, mOwnerToTOwner, mAbstFlowToTAbstFlow, mFlow);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mOwner] = " + mOwner + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[tOwner] = "
					+ tOwner + ", " + "[tFlow] = " + tFlow + ", " + "[mOwnerToTOwner] = " + mOwnerToTOwner + ", "
					+ "[mAbstFlowToTAbstFlow] = " + mAbstFlowToTAbstFlow + ", " + "[mFlow] = " + mFlow + ".");
		}
		FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, mOwner, mFlowToTFlow,
				tOwner, tFlow, mAbstFlowToTAbstFlow, mFlow);
		...
		// 
		// 
		FlowNodeImpl.pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, mOwner, mFlowToTFlow,
				tOwner, tFlow, mOwnerToTOwner, mAbstFlowToTAbstFlow, mFlow);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mOwner, EObject mFlowToTFlow, EObject tOwner,
			EObject tFlow, EObject mOwnerToTOwner, EObject mAbstFlowToTAbstFlow, EObject mFlow) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_11_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
				mOwner, mFlowToTFlow, tOwner, tFlow, mOwnerToTOwner, mAbstFlowToTAbstFlow, mFlow);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mOwner] = " + mOwner + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[tOwner] = "
					+ tOwner + ", " + "[tFlow] = " + tFlow + ", " + "[mOwnerToTOwner] = " + mOwnerToTOwner + ", "
		...
		FlowNodeImpl.pattern_FlowNode_11_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, mOwner, mFlowToTFlow,
				tOwner, tFlow, mAbstFlowToTAbstFlow, mFlow);
		//nothing EMoflonEdge mOwner__mFlow____ownedFlows = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mFlow__mOwner____flowOwner = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge tOwner__tFlow____ownedFlows = (EMoflonEdge) result3_green[9];
		...
		// 
		// 
		FlowNodeImpl.pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, mOwner, mFlowToTFlow,
				tOwner, tFlow, mOwnerToTOwner, mAbstFlowToTAbstFlow, mFlow);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mOwner, EObject mFlowToTFlow, EObject tOwner,
			EObject tFlow, EObject mOwnerToTOwner, EObject mAbstFlowToTAbstFlow, EObject mFlow) {
		ruleresult.registerObject("mOwner", mOwner);
		ruleresult.registerObject("mFlowToTFlow", mFlowToTFlow);
		ruleresult.registerObject("tOwner", tOwner);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_47(EMoflonEdge _edge_ownedFlows) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = FlowNodeImpl.pattern_FlowNode_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
				mOwner, tOwner, tFlow, mFlow, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[mOwner] = " + mOwner
							+ ", " + "[tOwner] = " + tOwner + ", " + "[tFlow] = " + tFlow + ", " + "[mFlow] = " + mFlow
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MAbstractFlowElement mOwner, TAbstractFlowElement tOwner, TFlow tFlow,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_47__EMOFLONEDGE:
		...
		case RulesPackage.FLOW_NODE___IS_APPLICABLE_SOLVE_CSP_CC__MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_TFLOW_MFLOW_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MAbstractFlowElement) arguments.get(0),
					(TAbstractFlowElement) arguments.get(1), (TFlow) arguments.get(2), (MFlow) arguments.get(3),
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_greenFBFFB(TAbstractFlowElement tOwner,
		...
		return new Object[] { mFlowToTFlow, tOwner, tFlow, mAbstFlowToTAbstFlow, mFlow };
	}

	public static final Object[] pattern_FlowNode_1_2_collecttranslatedelements_blackBBBB(MFlowToTFlow mFlowToTFlow,
			TFlow tFlow, MAbstractFlowElementToTAbstractFlowElement mAbstFlowToTAbstFlow, MFlow mFlow) {
		return new Object[] { mFlowToTFlow, tFlow, mAbstFlowToTAbstFlow, mFlow };
	}
	...
	public static final Object[] pattern_FlowNode_1_2_collecttranslatedelements_greenFBBBB(MFlowToTFlow mFlowToTFlow,
		...
		return new Object[] { ruleresult, mFlowToTFlow, tFlow, mAbstFlowToTAbstFlow, mFlow };
	}

	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(PerformRuleResult ruleresult,
			EObject mOwner, EObject mFlowToTFlow, EObject tOwner, EObject tFlow, EObject mOwnerToTOwner,
			EObject mAbstFlowToTAbstFlow, EObject mFlow) {
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject mOwner, EObject mFlowToTFlow, EObject tOwner, EObject tFlow,
			EObject mAbstFlowToTAbstFlow, EObject mFlow) {
		EMoflonEdge mOwner__mFlow____ownedFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mFlow__mOwner____flowOwner = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mOwner, mFlowToTFlow, tOwner, tFlow, mAbstFlowToTAbstFlow, mFlow,
				mOwner__mFlow____ownedFlows, mFlow__mOwner____flowOwner, tOwner__tFlow____ownedFlows,
				tFlow__tOwner____flowOwner, mFlowToTFlow__tFlow____target, mAbstFlowToTAbstFlow__tFlow____target,
	...
	public static final void pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mOwner, EObject mFlowToTFlow, EObject tOwner, EObject tFlow,
			EObject mOwnerToTOwner, EObject mAbstFlowToTAbstFlow, EObject mFlow) {
		_this.registerObjects_FWD(ruleresult, mOwner, mFlowToTFlow, tOwner, tFlow, mOwnerToTOwner, mAbstFlowToTAbstFlow,
				mFlow);
	...
	public static final Object[] pattern_FlowNode_2_3_findcontext_greenBBBBFFFFF(MAbstractFlowElement mOwner,
		...
		return new Object[] { mOwner, tOwner, mOwnerToTOwner, mFlow, isApplicableMatch, mOwner__mFlow____ownedFlows,
				mFlow__mOwner____flowOwner, mOwnerToTOwner__tOwner____target, mOwnerToTOwner__mOwner____source };
	}
	...
	public static final Object[] pattern_FlowNode_11_1_performtransformation_greenBFBFF(MAbstractFlowElement mOwner,
		...
		mAbstFlowToTAbstFlow.setSource(mFlow);
		mFlowToTFlow.setSource(mFlow);
		return new Object[] { mOwner, mFlowToTFlow, tFlow, mAbstFlowToTAbstFlow, mFlow };
	}
	...
	public static final void pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mOwner, EObject mFlowToTFlow, EObject tOwner, EObject tFlow,
			EObject mOwnerToTOwner, EObject mAbstFlowToTAbstFlow, EObject mFlow) {
		_this.registerObjects_BWD(ruleresult, mOwner, mFlowToTFlow, tOwner, tFlow, mOwnerToTOwner, mAbstFlowToTAbstFlow,
				mFlow);
		...
		if (tmpMOwner instanceof MAbstractFlowElement) {
			...
			if (tmpTOwner instanceof TAbstractFlowElement) {
				...
				if (tmpTFlow instanceof TFlow) {
					...
					if (tmpMFlow instanceof MFlow) {
						MFlow mFlow = (MFlow) tmpMFlow;
						return new Object[] { mOwner, tOwner, tFlow, mFlow, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_FlowNode_24_2_matchsrctrgcontext_blackBBBBBB(MAbstractFlowElement mOwner,
			TAbstractFlowElement tOwner, TFlow tFlow, MFlow mFlow, Match sourceMatch, Match targetMatch) {
		if (!tFlow.equals(tOwner)) {
			if (!mFlow.equals(mOwner)) {
	...
	public static final Object[] pattern_FlowNode_24_3_solvecsp_bindingFBBBBBBB(FlowNode _this,
			MAbstractFlowElement mOwner, TAbstractFlowElement tOwner, TFlow tFlow, MFlow mFlow, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mOwner, tOwner, tFlow, mFlow, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mOwner, tOwner, tFlow, mFlow, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FlowNode_24_6_createcorrespondence_blackBBBBB(MAbstractFlowElement mOwner,
			TAbstractFlowElement tOwner, TFlow tFlow, MFlow mFlow, CCMatch ccMatch) {
		if (!tFlow.equals(tOwner)) {
			if (!mFlow.equals(mOwner)) {
				return new Object[] { mOwner, tOwner, tFlow, mFlow, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_FlowNode_24_6_createcorrespondence_greenFBFBB(TFlow tFlow, MFlow mFlow,
		...
		return new Object[] { mFlowToTFlow, tFlow, mAbstFlowToTAbstFlow, mFlow, ccMatch };
	}
	...
	public static final Object[] pattern_FlowNode_29_6_perform_greenBFBFFFB(MAbstractFlowElement mOwner,
		...
		return new Object[] { mOwner, mFlowToTFlow, tOwner, tFlow, mAbstFlowToTAbstFlow, mFlow, ruleResult };
	}
