...
public class FlowNodeImpl extends AbstractRuleImpl implements FlowNode {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FlowNodeImpl.pattern_FlowNode_1_1_performtransformation_greenFBFFB(tOwner, mFlow);
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, tFlow,
				mOwnerToTOwner, tOwner, mOwner, mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tFlow] = " + tFlow + ", " + "[mOwnerToTOwner] = " + mOwnerToTOwner + ", " + "[tOwner] = "
					+ tOwner + ", " + "[mOwner] = " + mOwner + ", " + "[mAbstFlowToTAbstFlow] = " + mAbstFlowToTAbstFlow
					+ ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mFlow] = " + mFlow + ".");
		}
		FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, tFlow, tOwner, mOwner,
				mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow);
		...
		FlowNodeImpl.pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, tFlow, mOwnerToTOwner,
				tOwner, mOwner, mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FlowNodeImpl.pattern_FlowNode_2_2_corematch_blackFFBBB(mOwner, mFlow, match)) {
			...
			for (Object[] result3_black : FlowNodeImpl.pattern_FlowNode_2_3_findcontext_blackBBBB(mOwnerToTOwner,
				...
				Object[] result4_bindingAndBlack = FlowNodeImpl.pattern_FlowNode_2_4_solveCSP_bindingAndBlackFBBBBBB(
						this, isApplicableMatch, mOwnerToTOwner, tOwner, mOwner, mFlow);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			MAbstractFlowElement mOwner, MFlow mFlow) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tFlow, EObject mOwnerToTOwner, EObject tOwner,
			EObject mOwner, EObject mAbstFlowToTAbstFlow, EObject mFlowToTFlow, EObject mFlow) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = FlowNodeImpl.pattern_FlowNode_11_1_performtransformation_greenBBFFF(tFlow, mOwner);
		MAbstractFlowElementToTAbstractFlowElement mAbstFlowToTAbstFlow = (MAbstractFlowElementToTAbstractFlowElement) result1_green[2];
		MFlowToTFlow mFlowToTFlow = (MFlowToTFlow) result1_green[3];
		...
		FlowNodeImpl.pattern_FlowNode_11_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, tFlow, tOwner, mOwner,
				mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow);
		//nothing EMoflonEdge mOwner__mFlow____ownedFlows = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mFlow__mOwner____flowOwner = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge tOwner__tFlow____ownedFlows = (EMoflonEdge) result3_green[9];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tFlow, EObject mOwnerToTOwner, EObject tOwner,
			EObject mOwner, EObject mAbstFlowToTAbstFlow, EObject mFlowToTFlow, EObject mFlow) {
		ruleresult.registerObject("tFlow", tFlow);
		ruleresult.registerObject("mOwnerToTOwner", mOwnerToTOwner);
		ruleresult.registerObject("tOwner", tOwner);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_17(EMoflonEdge _edge_ownedFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_18(EMoflonEdge _edge_ownedFlows) {
		...
		for (Object[] result2_black : FlowNodeImpl
			...
			if (FlowNodeImpl.pattern_FlowNode_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					FlowNodeImpl.pattern_FlowNode_29_6_perform_greenFBBFFFB(tOwner, mOwner, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FLOW_NODE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_MFLOW:
		...
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_17__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_17((EMoflonEdge) arguments.get(0));
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_18__EMOFLONEDGE:
			...
			if (tmpTOwner instanceof TAbstractFlowElement) {
				...
				if (tmpMOwner instanceof MAbstractFlowElement) {
					...
					if (tmpMFlow instanceof MFlow) {
						...
						return new Object[] { mOwnerToTOwner, tOwner, mOwner, mFlow, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_blackBBBBFBB(
			MAbstractFlowElementToTAbstractFlowElement mOwnerToTOwner, TAbstractFlowElement tOwner,
			MAbstractFlowElement mOwner, MFlow mFlow, FlowNode _this, IsApplicableMatch isApplicableMatch) {
		if (!mFlow.equals(mOwner)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { mOwnerToTOwner, tOwner, mOwner, mFlow, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_bindingAndBlackFFFFFBB(FlowNode _this,
		...
		if (result_pattern_FlowNode_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FlowNode_1_1_performtransformation_black = pattern_FlowNode_1_1_performtransformation_blackBBBBFBB(
					mOwnerToTOwner, tOwner, mOwner, mFlow, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_greenFBFFB(TAbstractFlowElement tOwner,
			MFlow mFlow) {
		...
		return new Object[] { tFlow, tOwner, mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow };
	}
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(PerformRuleResult ruleresult,
			EObject tFlow, EObject mOwnerToTOwner, EObject tOwner, EObject mOwner, EObject mAbstFlowToTAbstFlow,
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject tFlow, EObject tOwner, EObject mOwner, EObject mAbstFlowToTAbstFlow,
			EObject mFlowToTFlow, EObject mFlow) {
		EMoflonEdge mOwner__mFlow____ownedFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mFlow__mOwner____flowOwner = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, tFlow, tOwner, mOwner, mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow,
	...
	public static final void pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject tFlow, EObject mOwnerToTOwner, EObject tOwner, EObject mOwner,
			EObject mAbstFlowToTAbstFlow, EObject mFlowToTFlow, EObject mFlow) {
		_this.registerObjects_FWD(ruleresult, tFlow, mOwnerToTOwner, tOwner, mOwner, mAbstFlowToTAbstFlow, mFlowToTFlow,
				mFlow);
	...
	public static final Iterable<Object[]> pattern_FlowNode_2_2_corematch_blackFFBBB(MAbstractFlowElement mOwner,
		...
		if (!mFlow.equals(mOwner)) {
			for (MAbstractFlowElementToTAbstractFlowElement mOwnerToTOwner : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tOwner != null) {
					_result.add(new Object[] { mOwnerToTOwner, tOwner, mOwner, mFlow, match });
				}
			...
			if (mOwner.equals(mOwnerToTOwner.getSource())) {
				if (mOwner.getOwnedFlows().contains(mFlow)) {
					if (tOwner.equals(mOwnerToTOwner.getTarget())) {
						_result.add(new Object[] { mOwnerToTOwner, tOwner, mOwner, mFlow });
					}
				}
			}
		}
	...
	public static final Object[] pattern_FlowNode_2_4_solveCSP_bindingFBBBBBB(FlowNode _this,
			...
			TAbstractFlowElement tOwner, MAbstractFlowElement mOwner, MFlow mFlow) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mOwnerToTOwner, tOwner, mOwner,
				mFlow);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mOwnerToTOwner, tOwner, mOwner, mFlow };
		}
		return null;
	}
	...
	public static final Object[] pattern_FlowNode_2_4_solveCSP_bindingAndBlackFBBBBBB(FlowNode _this,
		...
		Object[] result_pattern_FlowNode_2_4_solveCSP_binding = pattern_FlowNode_2_4_solveCSP_bindingFBBBBBB(_this,
				isApplicableMatch, mOwnerToTOwner, tOwner, mOwner, mFlow);
	...
	public static final Object[] pattern_FlowNode_11_1_performtransformation_greenBBFFF(TFlow tFlow,
			MAbstractFlowElement mOwner) {
		MAbstractFlowElementToTAbstractFlowElement mAbstFlowToTAbstFlow = PmFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MFlowToTFlow mFlowToTFlow = PmFactory.eINSTANCE.createMFlowToTFlow();
		...
		mAbstFlowToTAbstFlow.setSource(mFlow);
		mFlowToTFlow.setSource(mFlow);
		return new Object[] { tFlow, mOwner, mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow };
	}
	...
	public static final void pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject tFlow, EObject mOwnerToTOwner, EObject tOwner, EObject mOwner,
			EObject mAbstFlowToTAbstFlow, EObject mFlowToTFlow, EObject mFlow) {
		_this.registerObjects_BWD(ruleresult, tFlow, mOwnerToTOwner, tOwner, mOwner, mAbstFlowToTAbstFlow, mFlowToTFlow,
				mFlow);
	...
	public static final Object[] pattern_FlowNode_12_3_findcontext_greenBBBBFFFFF(TFlow tFlow,
		...
		tFlow__tOwner____flowOwner.setName(tFlow__tOwner____flowOwner_name_prime);
		return new Object[] { tFlow, mOwnerToTOwner, tOwner, mOwner, isApplicableMatch,
				mOwnerToTOwner__mOwner____source, mOwnerToTOwner__tOwner____target, tOwner__tFlow____ownedFlows,
	...
	public static final Object[] pattern_FlowNode_29_6_perform_greenFBBFFFB(TAbstractFlowElement tOwner,
			MAbstractFlowElement mOwner, ModelgeneratorRuleResult ruleResult) {
		TFlow tFlow = BasicFactory.eINSTANCE.createTFlow();
		MAbstractFlowElementToTAbstractFlowElement mAbstFlowToTAbstFlow = PmFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		...
		return new Object[] { tFlow, tOwner, mOwner, mAbstFlowToTAbstFlow, mFlowToTFlow, mFlow, ruleResult };
	}
