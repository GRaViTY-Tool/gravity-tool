...
public class ParameterizedTypeToTypeImpl extends AbstractRuleImpl implements ParameterizedTypeToType {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, Model model) {

		Object[] result1_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_0_1_initialbindings_blackBBBBBB(this, match, eParameterizedType,
						eTypeAccess, eType, model);
		...
		if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_0_4_collectelementstobetranslated_blackBBBBB(match,
							eParameterizedType, eTypeAccess, eType, model);
			...
			ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_0_6_registerobjectstomatch_expressionBBBBBB(
					this, match, eParameterizedType, eTypeAccess, eType, model);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, eParameterizedType,
						eTypeToTAbstractType, eTypeAccess, eType, tAbstractType, model,
						eParameterizedTypeToTAbstractType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[eParameterizedType] = " + eParameterizedType + ", " + "[eTypeToTAbstractType] = "
					+ eTypeToTAbstractType + ", " + "[eTypeAccess] = " + eTypeAccess + ", " + "[eType] = " + eType
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
				ruleresult, eParameterizedType, eTypeAccess, eType, tAbstractType, model,
				eParameterizedTypeToTAbstractType);
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType, tAbstractType, model,
				eParameterizedTypeToTAbstractType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_2_2_corematch_blackBFBBFBB(eParameterizedType, eTypeAccess, eType,
						model, match)) {
			...
			for (Object[] result3_black : ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_2_3_findcontext_blackBBBBBB(eParameterizedType,
							eTypeToTAbstractType, eTypeAccess, eType, tAbstractType, model)) {
				Object[] result3_green = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_2_3_findcontext_greenBBBBBBFFFFFFF(eParameterizedType,
								eTypeToTAbstractType, eTypeAccess, eType, tAbstractType, model);
				...
				//nothing EMoflonEdge model__eParameterizedType____orphanTypes = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge eParameterizedType__eTypeAccess____type = (EMoflonEdge) result3_green[12];
				...
				Object[] result4_bindingAndBlack = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType, tAbstractType, model);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, Model model) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eParameterizedType,
			EObject eTypeToTAbstractType, EObject eTypeAccess, EObject eType, EObject tAbstractType, EObject model,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_286(EMoflonEdge _edge_type) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eParameterizedType,
						eTypeAccess, eType, tAbstractType, model, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[eParameterizedType] = " + eParameterizedType + ", " + "[eTypeAccess] = " + eTypeAccess + ", "
					+ "[eType] = " + eType + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[model] = " + model
			...
			for (Object[] result5_black : ParameterizedTypeToTypeImpl
				...
				Object[] result6_black = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(eParameterizedType,
								eTypeAccess, eType, tAbstractType, model, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eParameterizedType] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, TAbstractType tAbstractType, Model model, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, Model model) {// 
		Object[] result1_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_24_1_matchtggpattern_blackBBBB(eParameterizedType, eTypeAccess, eType,
						model);
		if (result1_black != null) {
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
			...
			Object[] result3_bindingAndBlack = ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
							eTypeToTAbstractType, eType, tAbstractType, model, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eTypeToTAbstractType] = "
						+ eTypeToTAbstractType + ", " + "[eType] = " + eType + ", " + "[tAbstractType] = "
			...
			if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_26_5_checknacs_blackBBBB(eTypeToTAbstractType, eType,
								tAbstractType, model);
				if (result5_black != null) {

					Object[] result6_black = ParameterizedTypeToTypeImpl
							.pattern_ParameterizedTypeToType_26_6_perform_blackBBBBB(eTypeToTAbstractType, eType,
					...
					ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_6_perform_greenFFBBBFB(eType,
							tAbstractType, model, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_FWD__MATCH_PARAMETERIZEDTYPE_TYPEACCESS_ABSTRACTTYPEDECLARATION_MODEL:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_PARAMETERIZEDTYPE_TYPEACCESS_ABSTRACTTYPEDECLARATION_MODEL:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (ParameterizedType) arguments.get(1),
					(TypeAccess) arguments.get(2), (AbstractTypeDeclaration) arguments.get(3),
					(Model) arguments.get(4));
			return null;
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_PARAMETERIZEDTYPE_TYPEACCESS_ABSTRACTTYPEDECLARATION_MODEL:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PARAMETERIZEDTYPE_TYPETOTABSTRACTTYPE_TYPEACCESS_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_MODEL:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_BWD_TABSTRACT_TYPE_4__TABSTRACTTYPE:
			return isAppropriate_BWD_TAbstractType_4((TAbstractType) arguments.get(0));
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_286__EMOFLONEDGE:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__PARAMETERIZEDTYPE_TYPEACCESS_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((ParameterizedType) arguments.get(0), (TypeAccess) arguments.get(1),
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___CHECK_DEC_FWD__PARAMETERIZEDTYPE_TYPEACCESS_ABSTRACTTYPEDECLARATION_MODEL:
			return checkDEC_FWD((ParameterizedType) arguments.get(0), (TypeAccess) arguments.get(1),
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_MODEL_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_1_initialbindings_blackBBBBBB(
			ParameterizedTypeToType _this, Match match, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, Model model) {
		return new Object[] { _this, match, eParameterizedType, eTypeAccess, eType, model };
	}

	public static final Object[] pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingFBBBBBB(
			ParameterizedTypeToType _this, Match match, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, Model model) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, eParameterizedType, eTypeAccess, eType, model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, eParameterizedType, eTypeAccess, eType, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_0_2_SolveCSP_binding = pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, eParameterizedType, eTypeAccess, eType, model);
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_4_collectelementstobetranslated_blackBBBBB(
			Match match, ParameterizedType eParameterizedType, TypeAccess eTypeAccess, AbstractTypeDeclaration eType,
			Model model) {
		return new Object[] { match, eParameterizedType, eTypeAccess, eType, model };
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_4_collectelementstobetranslated_greenBBBBBFFFF(
		...
		return new Object[] { match, eParameterizedType, eTypeAccess, eType, model, eTypeAccess__eType____type,
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_5_collectcontextelements_blackBBBBB(Match match,
			ParameterizedType eParameterizedType, TypeAccess eTypeAccess, AbstractTypeDeclaration eType, Model model) {
		return new Object[] { match, eParameterizedType, eTypeAccess, eType, model };
	}
	...
	public static final void pattern_ParameterizedTypeToType_0_6_registerobjectstomatch_expressionBBBBBB(
			ParameterizedTypeToType _this, Match match, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, Model model) {
		_this.registerObjectsToMatch_FWD(match, eParameterizedType, eTypeAccess, eType, model);
					...
					if (tmpEType instanceof AbstractTypeDeclaration) {
						...
						if (tmpTAbstractType instanceof TAbstractType) {
							...
							if (tmpModel instanceof Model) {
								...
								return new Object[] { eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType,
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(
			ParameterizedType eParameterizedType, TypeToTAbstractType eTypeToTAbstractType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, TAbstractType tAbstractType, Model model, ParameterizedTypeToType _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType, tAbstractType,
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_ParameterizedTypeToType_1_1_performtransformation_black = pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(
					eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType, tAbstractType, model, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eParameterizedType, EObject eTypeToTAbstractType, EObject eTypeAccess,
			EObject eType, EObject tAbstractType, EObject model, EObject eParameterizedTypeToTAbstractType) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject eParameterizedType, EObject eTypeAccess, EObject eType,
			EObject tAbstractType, EObject model, EObject eParameterizedTypeToTAbstractType) {
		EMoflonEdge eTypeAccess__eType____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eType__eTypeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge model__eParameterizedType____orphanTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		eParameterizedType__eTypeAccess____type.setName(eParameterizedType__eTypeAccess____type_name_prime);
		return new Object[] { ruleresult, eParameterizedType, eTypeAccess, eType, tAbstractType, model,
				eParameterizedTypeToTAbstractType, eTypeAccess__eType____type, eType__eTypeAccess____usagesInTypeAccess,
				model__eParameterizedType____orphanTypes, eParameterizedTypeToTAbstractType__tAbstractType____target,
				eParameterizedTypeToTAbstractType__eParameterizedType____source,
				eParameterizedType__eTypeAccess____type };
	}

	public static final void pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(
			ParameterizedTypeToType _this, PerformRuleResult ruleresult, EObject eParameterizedType,
			EObject eTypeToTAbstractType, EObject eTypeAccess, EObject eType, EObject tAbstractType, EObject model,
			EObject eParameterizedTypeToTAbstractType) {
		_this.registerObjects_FWD(ruleresult, eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType,
				tAbstractType, model, eParameterizedTypeToTAbstractType);
		...
		if (tmpEParameterizedType instanceof ParameterizedType) {
			...
			if (tmpETypeAccess instanceof TypeAccess) {
				...
				if (tmpEType instanceof AbstractTypeDeclaration) {
					...
					if (tmpModel instanceof Model) {
						Model model = (Model) tmpModel;
						return new Object[] { eParameterizedType, eTypeAccess, eType, model, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_ParameterizedTypeToType_2_2_corematch_blackBFBBFBB(
			ParameterizedType eParameterizedType, TypeAccess eTypeAccess, AbstractTypeDeclaration eType, Model model,
			Match match) {
		...
		for (TypeToTAbstractType eTypeToTAbstractType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAbstractType != null) {
				_result.add(new Object[] { eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType, tAbstractType,
						model, match });
			}
				...
				if (tAbstractType.equals(eTypeToTAbstractType.getTarget())) {
					if (model.getOrphanTypes().contains(eParameterizedType)) {
						if (eTypeAccess.equals(eParameterizedType.getType())) {
							_result.add(new Object[] { eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType,
									tAbstractType, model });
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		model__eParameterizedType____orphanTypes.setName(model__eParameterizedType____orphanTypes_name_prime);
		eParameterizedType__eTypeAccess____type.setName(eParameterizedType__eTypeAccess____type_name_prime);
		return new Object[] { eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType, tAbstractType, model,
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eParameterizedType, eTypeToTAbstractType, eTypeAccess,
					eType, tAbstractType, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_2_4_solveCSP_binding = pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eParameterizedType, eTypeToTAbstractType, eTypeAccess, eType, tAbstractType,
				model);
		if (result_pattern_ParameterizedTypeToType_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_ParameterizedTypeToType_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, eParameterizedType, eTypeToTAbstractType,
						eTypeAccess, eType, tAbstractType, model };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_644907 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_644907)) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_eTypeAccess_type_511667 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_555292 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_57339 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_4BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_960057 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_960057)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_431260 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_539258 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_508693 : org.moflon.core.utilities.eMoflonEMFUtil
														...
														for (ParameterizedType eParameterizedType : org.moflon.core.utilities.eMoflonEMFUtil
															...
															for (Model model : org.moflon.core.utilities.eMoflonEMFUtil
																...
																_result.add(new Object[] { eParameterizedType,
																		eTypeAccess, eType, model, _edge_type });
															}
														}
													}
												}
	...
	public static final boolean pattern_ParameterizedTypeToType_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ParameterizedTypeToType _this, Match match, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, Model model) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, eParameterizedType, eTypeAccess, eType, model);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
			...
			if (tmpETypeAccess instanceof TypeAccess) {
				...
				if (tmpEType instanceof AbstractTypeDeclaration) {
					...
					if (tmpTAbstractType instanceof TAbstractType) {
						...
						if (tmpModel instanceof Model) {
							Model model = (Model) tmpModel;
							return new Object[] { eParameterizedType, eTypeAccess, eType, tAbstractType, model,
									sourceMatch, targetMatch };
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { eParameterizedType, eTypeAccess, eType, tAbstractType, model, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_black = pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(
					eParameterizedType, eTypeAccess, eType, tAbstractType, model, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
			ParameterizedTypeToType _this, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			AbstractTypeDeclaration eType, TAbstractType tAbstractType, Model model, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eParameterizedType, eTypeAccess, eType, tAbstractType,
				model, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eParameterizedType, eTypeAccess, eType, tAbstractType, model, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding = pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
				_this, eParameterizedType, eTypeAccess, eType, tAbstractType, model, sourceMatch, targetMatch);
		if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding != null) {
			...
			if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, eParameterizedType, eTypeAccess, eType, tAbstractType, model,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(
		...
		return new Object[] { eParameterizedType, eTypeAccess, eType, tAbstractType, model, ccMatch };
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_0BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_489875 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_489875)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_340181 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_602275 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_882163 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_4BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_366195 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_366195)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_148852 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_129180 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_245475 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
											...
											if (pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_6B(
												...
												if (pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_7B(
													...
													if (pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_8BB(
															eType, eTypeAccess) == null) {
														return new Object[] { eParameterizedType, eTypeAccess, eType,
																model };
													}
												}
											}
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_3_solveCSP_bindingFBBBBBBB(
			ParameterizedTypeToType _this, IsApplicableMatch isApplicableMatch,
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, TAbstractType tAbstractType,
			Model model, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, eTypeToTAbstractType, eType,
				tAbstractType, model, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eTypeToTAbstractType, eType, tAbstractType, model,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_26_3_solveCSP_binding = pattern_ParameterizedTypeToType_26_3_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, eTypeToTAbstractType, eType, tAbstractType, model, ruleResult);
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_5_checknacs_blackBBBB(
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, TAbstractType tAbstractType,
			Model model) {
		return new Object[] { eTypeToTAbstractType, eType, tAbstractType, model };
	}

	public static final Object[] pattern_ParameterizedTypeToType_26_6_perform_blackBBBBB(
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, TAbstractType tAbstractType,
			Model model, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { eTypeToTAbstractType, eType, tAbstractType, model, ruleResult };
	}

	public static final Object[] pattern_ParameterizedTypeToType_26_6_perform_greenFFBBBFB(
			AbstractTypeDeclaration eType, TAbstractType tAbstractType, Model model,
