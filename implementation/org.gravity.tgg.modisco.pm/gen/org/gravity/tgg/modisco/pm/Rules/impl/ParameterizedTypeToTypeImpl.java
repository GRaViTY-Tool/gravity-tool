...
public class ParameterizedTypeToTypeImpl extends AbstractRuleImpl implements ParameterizedTypeToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
						eParameterizedTypeToTAbstractType, eParameterizedType, model, eTypeToTAbstractType, eType,
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
				ruleresult, eParameterizedTypeToTAbstractType, eParameterizedType, model, eType, tAbstractType,
				eTypeAccess);
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eParameterizedTypeToTAbstractType, eParameterizedType, model, eTypeToTAbstractType, eType,
				tAbstractType, eTypeAccess);
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
			...
			for (Object[] result3_black : ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_2_3_findcontext_blackBBBBBB(eParameterizedType, model,
							eTypeToTAbstractType, eType, tAbstractType, eTypeAccess)) {
				...
				Object[] result4_bindingAndBlack = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								eParameterizedType, model, eTypeToTAbstractType, eType, tAbstractType, eTypeAccess);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eParameterizedType] = "
							+ eParameterizedType + ", " + "[model] = " + model + ", " + "[eTypeToTAbstractType] = "
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eParameterizedTypeToTAbstractType,
			EObject eParameterizedType, EObject model, EObject eTypeToTAbstractType, EObject eType,
			EObject tAbstractType, EObject eTypeAccess) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eParameterizedType, model,
						eType, tAbstractType, eTypeAccess, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[eParameterizedType] = " + eParameterizedType + ", " + "[model] = " + model + ", " + "[eType] = "
					+ eType + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[eTypeAccess] = " + eTypeAccess
			...
			for (Object[] result5_black : ParameterizedTypeToTypeImpl
				...
				Object[] result6_black = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(eParameterizedType,
								model, eType, tAbstractType, eTypeAccess, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eParameterizedType] = "
							+ eParameterizedType + ", " + "[model] = " + model + ", " + "[eType] = " + eType + ", "
							+ "[tAbstractType] = " + tAbstractType + ", " + "[eTypeAccess] = " + eTypeAccess + ", "
							+ "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ParameterizedType eParameterizedType, Model model,
			AbstractTypeDeclaration eType, TAbstractType tAbstractType, TypeAccess eTypeAccess, Match sourceMatch,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, Model modelParameter,
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
			...
			AbstractTypeDeclaration eType = (AbstractTypeDeclaration) result2_black[4];
			...
			Object[] result3_bindingAndBlack = ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
							model, eTypeToTAbstractType, eType, tAbstractType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_26_5_checknacs_blackBBBB(model, eTypeToTAbstractType, eType,
								tAbstractType);
				if (result5_black != null) {

					Object[] result6_black = ParameterizedTypeToTypeImpl
							.pattern_ParameterizedTypeToType_26_6_perform_blackBBBBB(model, eTypeToTAbstractType, eType,
									tAbstractType, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[model] = " + model
								+ ", " + "[eTypeToTAbstractType] = " + eTypeToTAbstractType + ", " + "[eType] = "
								+ eType + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
					ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_6_perform_greenFFBBBFB(model, eType,
							tAbstractType, ruleResult);
					//nothing TypeToTAbstractType eParameterizedTypeToTAbstractType = (TypeToTAbstractType) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PARAMETERIZEDTYPE_MODEL_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_TYPEACCESS:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_79__EMOFLONEDGE:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__PARAMETERIZEDTYPE_MODEL_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_TYPEACCESS_MATCH_MATCH:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODEL_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TABSTRACTTYPE_MODELGENERATORRULERESULT:
					...
					if (tmpEType instanceof AbstractTypeDeclaration) {
						...
						if (tmpTAbstractType instanceof TAbstractType) {
							...
							if (tmpETypeAccess instanceof TypeAccess) {
								...
								return new Object[] { eParameterizedType, model, eTypeToTAbstractType, eType,
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(
			ParameterizedType eParameterizedType, Model model, TypeToTAbstractType eTypeToTAbstractType,
			AbstractTypeDeclaration eType, TAbstractType tAbstractType, TypeAccess eTypeAccess,
			ParameterizedTypeToType _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { eParameterizedType, model, eTypeToTAbstractType, eType, tAbstractType,
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_ParameterizedTypeToType_1_1_performtransformation_black = pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(
					eParameterizedType, model, eTypeToTAbstractType, eType, tAbstractType, eTypeAccess, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eParameterizedTypeToTAbstractType, EObject eParameterizedType,
			EObject model, EObject eTypeToTAbstractType, EObject eType, EObject tAbstractType, EObject eTypeAccess) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject eParameterizedTypeToTAbstractType, EObject eParameterizedType,
			EObject model, EObject eType, EObject tAbstractType, EObject eTypeAccess) {
		EMoflonEdge model__eParameterizedType____orphanTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eTypeAccess__eType____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eType__eTypeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		eParameterizedType__eTypeAccess____type.setName(eParameterizedType__eTypeAccess____type_name_prime);
		return new Object[] { ruleresult, eParameterizedTypeToTAbstractType, eParameterizedType, model, eType,
				tAbstractType, eTypeAccess, model__eParameterizedType____orphanTypes, eTypeAccess__eType____type,
	...
	public static final void pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eParameterizedType, EObject model, EObject eTypeToTAbstractType, EObject eType,
			EObject tAbstractType, EObject eTypeAccess) {
		_this.registerObjects_FWD(ruleresult, eParameterizedTypeToTAbstractType, eParameterizedType, model,
				eTypeToTAbstractType, eType, tAbstractType, eTypeAccess);
	...
	public static final Iterable<Object[]> pattern_ParameterizedTypeToType_2_2_corematch_blackBBFBFBB(
		...
		for (TypeToTAbstractType eTypeToTAbstractType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAbstractType != null) {
				_result.add(new Object[] { eParameterizedType, model, eTypeToTAbstractType, eType, tAbstractType,
						eTypeAccess, match });
			}
				...
				if (eType.equals(eTypeAccess.getType())) {
					if (eTypeAccess.equals(eParameterizedType.getType())) {
						if (tAbstractType.equals(eTypeToTAbstractType.getTarget())) {
							_result.add(new Object[] { eParameterizedType, model, eTypeToTAbstractType, eType,
									tAbstractType, eTypeAccess });
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { eParameterizedType, model, eTypeToTAbstractType, eType, tAbstractType, eTypeAccess,
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
			...
			Model model, TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType,
			TAbstractType tAbstractType, TypeAccess eTypeAccess) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eParameterizedType, model,
				eTypeToTAbstractType, eType, tAbstractType, eTypeAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eParameterizedType, model, eTypeToTAbstractType, eType,
					tAbstractType, eTypeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_2_4_solveCSP_binding = pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eParameterizedType, model, eTypeToTAbstractType, eType, tAbstractType,
				eTypeAccess);
		if (result_pattern_ParameterizedTypeToType_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_ParameterizedTypeToType_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, eParameterizedType, model, eTypeToTAbstractType,
						eType, tAbstractType, eTypeAccess };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_608569 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_608569)) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_496412 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_166835 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_341408 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_932077 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_268493 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_268493)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_399335 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_563572 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_973223 : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpModel instanceof Model) {
				...
				if (tmpEType instanceof AbstractTypeDeclaration) {
					...
					if (tmpTAbstractType instanceof TAbstractType) {
						...
						if (tmpETypeAccess instanceof TypeAccess) {
							TypeAccess eTypeAccess = (TypeAccess) tmpETypeAccess;
							return new Object[] { eParameterizedType, model, eType, tAbstractType, eTypeAccess,
									sourceMatch, targetMatch };
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(
			ParameterizedType eParameterizedType, Model model, AbstractTypeDeclaration eType,
			TAbstractType tAbstractType, TypeAccess eTypeAccess, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { eParameterizedType, model, eType, tAbstractType, eTypeAccess, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_black = pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(
					eParameterizedType, model, eType, tAbstractType, eTypeAccess, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
			...
			AbstractTypeDeclaration eType, TAbstractType tAbstractType, TypeAccess eTypeAccess, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eParameterizedType, model, eType, tAbstractType,
				eTypeAccess, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eParameterizedType, model, eType, tAbstractType, eTypeAccess, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding = pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
				_this, eParameterizedType, model, eType, tAbstractType, eTypeAccess, sourceMatch, targetMatch);
		if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding != null) {
			...
			if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, eParameterizedType, model, eType, tAbstractType, eTypeAccess,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(
		...
		return new Object[] { eParameterizedType, model, eType, tAbstractType, eTypeAccess, ccMatch };
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_0BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_848547 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_848547)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_346693 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_123047 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_440628 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_501336 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_5BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_486707 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_486707)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_971577 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_993513 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_985649 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
													...
													if (pattern_ParameterizedTypeToType_26_2_isapplicablecore_black_nac_2BB(
														...
														if (pattern_ParameterizedTypeToType_26_2_isapplicablecore_black_nac_3BB(
															...
															_result.add(new Object[] { modelList, model,
																	...
																	eType, tAbstractType, ruleEntryContainer,
																	ruleResult });
														}
													}
												}
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_3_solveCSP_bindingFBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, model, eTypeToTAbstractType, eType,
				tAbstractType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model, eTypeToTAbstractType, eType, tAbstractType,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_26_3_solveCSP_binding = pattern_ParameterizedTypeToType_26_3_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, model, eTypeToTAbstractType, eType, tAbstractType, ruleResult);
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_5_checknacs_blackBBBB(Model model,
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, TAbstractType tAbstractType) {
		return new Object[] { model, eTypeToTAbstractType, eType, tAbstractType };
	}

	public static final Object[] pattern_ParameterizedTypeToType_26_6_perform_blackBBBBB(Model model,
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, TAbstractType tAbstractType,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { model, eTypeToTAbstractType, eType, tAbstractType, ruleResult };
	}

	public static final Object[] pattern_ParameterizedTypeToType_26_6_perform_greenFFBBBFB(Model model,
		...
		return new Object[] { eParameterizedTypeToTAbstractType, eParameterizedType, model, eType, tAbstractType,
