...
public class ParameterizedTypeToTypeImpl extends AbstractRuleImpl implements ParameterizedTypeToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, eTypeAccess,
						eParameterizedType, eParameterizedTypeToTAbstractType, tAbstractType, eTypeToTAbstractType,
						eType, model);
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
				ruleresult, eTypeAccess, eParameterizedType, eParameterizedTypeToTAbstractType, tAbstractType, eType,
				model);
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eTypeAccess, eParameterizedType, eParameterizedTypeToTAbstractType, tAbstractType,
				eTypeToTAbstractType, eType, model);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_2_2_corematch_blackBBFFBBB(eTypeAccess, eParameterizedType, eType,
						model, match)) {
			...
			for (Object[] result3_black : ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_2_3_findcontext_blackBBBBBB(eTypeAccess, eParameterizedType,
							tAbstractType, eTypeToTAbstractType, eType, model)) {
				Object[] result3_green = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_2_3_findcontext_greenBBBBBBFFFFFFF(eTypeAccess,
								eParameterizedType, tAbstractType, eTypeToTAbstractType, eType, model);
				...
				Object[] result4_bindingAndBlack = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								eTypeAccess, eParameterizedType, tAbstractType, eTypeToTAbstractType, eType, model);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeAccess eTypeAccess,
			ParameterizedType eParameterizedType, TAbstractType tAbstractType, TypeToTAbstractType eTypeToTAbstractType,
			AbstractTypeDeclaration eType, Model model) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eTypeAccess, EObject eParameterizedType,
			EObject eParameterizedTypeToTAbstractType, EObject tAbstractType, EObject eTypeToTAbstractType,
			EObject eType, EObject model) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eTypeAccess,
						eParameterizedType, tAbstractType, eType, model, sourceMatch, targetMatch);
			...
			for (Object[] result5_black : ParameterizedTypeToTypeImpl
				...
				Object[] result6_black = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(eTypeAccess,
								eParameterizedType, tAbstractType, eType, model, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eTypeAccess] = "
							+ eTypeAccess + ", " + "[eParameterizedType] = " + eParameterizedType + ", "
							+ "[tAbstractType] = " + tAbstractType + ", " + "[eType] = " + eType + ", " + "[model] = "
	...
	public CSP isApplicable_solveCsp_CC(TypeAccess eTypeAccess, ParameterizedType eParameterizedType,
			TAbstractType tAbstractType, AbstractTypeDeclaration eType, Model model, Match sourceMatch,
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
			...
			Object[] result3_bindingAndBlack = ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
							tAbstractType, eTypeToTAbstractType, eType, model, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_26_5_checknacs_blackBBBB(tAbstractType, eTypeToTAbstractType,
								eType, model);
				if (result5_black != null) {

					Object[] result6_black = ParameterizedTypeToTypeImpl
							.pattern_ParameterizedTypeToType_26_6_perform_blackBBBBB(tAbstractType,
									eTypeToTAbstractType, eType, model, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAbstractType] = "
								+ tAbstractType + ", " + "[eTypeToTAbstractType] = " + eTypeToTAbstractType + ", "
								+ "[eType] = " + eType + ", " + "[model] = " + model + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
					ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_6_perform_greenFFFBBBB(tAbstractType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEACCESS_PARAMETERIZEDTYPE_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_MODEL:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_34__EMOFLONEDGE:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_PARAMETERIZEDTYPE_TABSTRACTTYPE_ABSTRACTTYPEDECLARATION_MODEL_MATCH_MATCH:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_MODEL_MODELGENERATORRULERESULT:
					...
					if (tmpETypeToTAbstractType instanceof TypeToTAbstractType) {
						...
						if (tmpEType instanceof AbstractTypeDeclaration) {
							...
							if (tmpModel instanceof Model) {
								...
								return new Object[] { eTypeAccess, eParameterizedType, tAbstractType,
										eTypeToTAbstractType, eType, model, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(
			TypeAccess eTypeAccess, ParameterizedType eParameterizedType, TAbstractType tAbstractType,
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, Model model,
			ParameterizedTypeToType _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { eTypeAccess, eParameterizedType, tAbstractType, eTypeToTAbstractType, eType,
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_ParameterizedTypeToType_1_1_performtransformation_black = pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(
					eTypeAccess, eParameterizedType, tAbstractType, eTypeToTAbstractType, eType, model, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eTypeAccess, EObject eParameterizedType,
			EObject eParameterizedTypeToTAbstractType, EObject tAbstractType, EObject eTypeToTAbstractType,
			EObject eType, EObject model) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
		...
		model__eParameterizedType____orphanTypes.setName(model__eParameterizedType____orphanTypes_name_prime);
		return new Object[] { ruleresult, eTypeAccess, eParameterizedType, eParameterizedTypeToTAbstractType,
				tAbstractType, eType, model, eTypeAccess__eType____type, eType__eTypeAccess____usagesInTypeAccess,
				eParameterizedTypeToTAbstractType__eParameterizedType____source,
	...
	public static final void pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eParameterizedType, EObject eParameterizedTypeToTAbstractType, EObject tAbstractType,
			EObject eTypeToTAbstractType, EObject eType, EObject model) {
		_this.registerObjects_FWD(ruleresult, eTypeAccess, eParameterizedType, eParameterizedTypeToTAbstractType,
				tAbstractType, eTypeToTAbstractType, eType, model);
	...
	public static final Iterable<Object[]> pattern_ParameterizedTypeToType_2_2_corematch_blackBBFFBBB(
		...
		for (TypeToTAbstractType eTypeToTAbstractType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAbstractType != null) {
				_result.add(new Object[] { eTypeAccess, eParameterizedType, tAbstractType, eTypeToTAbstractType, eType,
						model, match });
			}
				...
				if (tAbstractType.equals(eTypeToTAbstractType.getTarget())) {
					if (eType.equals(eTypeToTAbstractType.getSource())) {
						if (model.getOrphanTypes().contains(eParameterizedType)) {
							_result.add(new Object[] { eTypeAccess, eParameterizedType, tAbstractType,
									eTypeToTAbstractType, eType, model });
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		model__eParameterizedType____orphanTypes.setName(model__eParameterizedType____orphanTypes_name_prime);
		return new Object[] { eTypeAccess, eParameterizedType, tAbstractType, eTypeToTAbstractType, eType, model,
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
			...
			ParameterizedType eParameterizedType, TAbstractType tAbstractType, TypeToTAbstractType eTypeToTAbstractType,
			AbstractTypeDeclaration eType, Model model) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eTypeAccess, eParameterizedType,
				tAbstractType, eTypeToTAbstractType, eType, model);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eTypeAccess, eParameterizedType, tAbstractType,
					eTypeToTAbstractType, eType, model };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_2_4_solveCSP_binding = pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eTypeAccess, eParameterizedType, tAbstractType, eTypeToTAbstractType, eType,
				model);
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_559797 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_559797)) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_eTypeAccess_type_254167 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_343334 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_172385 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_42091 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_458997 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_458997)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_117339 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_66853 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_770088 : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpEParameterizedType instanceof ParameterizedType) {
				...
				if (tmpTAbstractType instanceof TAbstractType) {
					...
					if (tmpEType instanceof AbstractTypeDeclaration) {
						...
						if (tmpModel instanceof Model) {
							Model model = (Model) tmpModel;
							return new Object[] { eTypeAccess, eParameterizedType, tAbstractType, eType, model,
									sourceMatch, targetMatch };
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { eTypeAccess, eParameterizedType, tAbstractType, eType, model, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_black = pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(
					eTypeAccess, eParameterizedType, tAbstractType, eType, model, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
			...
			TAbstractType tAbstractType, AbstractTypeDeclaration eType, Model model, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eTypeAccess, eParameterizedType, tAbstractType, eType,
				model, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eTypeAccess, eParameterizedType, tAbstractType, eType, model, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding = pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
				_this, eTypeAccess, eParameterizedType, tAbstractType, eType, model, sourceMatch, targetMatch);
		if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding != null) {
			...
			if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, eTypeAccess, eParameterizedType, tAbstractType, eType, model,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(
		...
		return new Object[] { eTypeAccess, eParameterizedType, tAbstractType, eType, model, ccMatch };
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_0BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_610375 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_610375)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_272950 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_577781 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_27595 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_754842 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_5BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_480362 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_480362)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_509863 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_977404 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_295738 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_3_solveCSP_bindingFBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tAbstractType, eTypeToTAbstractType,
				eType, model, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAbstractType, eTypeToTAbstractType, eType, model,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_26_3_solveCSP_binding = pattern_ParameterizedTypeToType_26_3_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, tAbstractType, eTypeToTAbstractType, eType, model, ruleResult);
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_5_checknacs_blackBBBB(TAbstractType tAbstractType,
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, Model model) {
		return new Object[] { tAbstractType, eTypeToTAbstractType, eType, model };
	}

	public static final Object[] pattern_ParameterizedTypeToType_26_6_perform_blackBBBBB(TAbstractType tAbstractType,
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, Model model,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tAbstractType, eTypeToTAbstractType, eType, model, ruleResult };
	}

	public static final Object[] pattern_ParameterizedTypeToType_26_6_perform_greenFFFBBBB(TAbstractType tAbstractType,
		...
		return new Object[] { eTypeAccess, eParameterizedType, eParameterizedTypeToTAbstractType, tAbstractType, eType,
				model, ruleResult };
	}
