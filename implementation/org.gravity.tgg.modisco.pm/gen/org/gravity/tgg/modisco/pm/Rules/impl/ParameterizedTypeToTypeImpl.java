...
public class ParameterizedTypeToTypeImpl extends AbstractRuleImpl implements ParameterizedTypeToType {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Model model, AbstractTypeDeclaration eType, TypeAccess eTypeAccess,
			ParameterizedType eParameterizedType) {

		Object[] result1_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_0_1_initialbindings_blackBBBBBB(this, match, model, eType, eTypeAccess,
						eParameterizedType);
		...
		if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[model] = " + model + ", " + "[eType] = " + eType + ", " + "[eTypeAccess] = " + eTypeAccess
			...
			ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_0_4_collectelementstobetranslated_greenBBBBBFFFF(match, model,
							eType, eTypeAccess, eParameterizedType);
			...
			ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_0_6_registerobjectstomatch_expressionBBBBBB(
					this, match, model, eType, eTypeAccess, eParameterizedType);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, model, eType,
						eTypeAccess, eParameterizedTypeToTAbstractType, eTypeToTAbstractType, eParameterizedType,
						tAbstractType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[model] = " + model + ", " + "[eType] = " + eType + ", " + "[eTypeAccess] = "
					+ eTypeAccess + ", " + "[eParameterizedTypeToTAbstractType] = " + eParameterizedTypeToTAbstractType
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
				ruleresult, model, eType, eTypeAccess, eParameterizedTypeToTAbstractType, eParameterizedType,
				tAbstractType);
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, model, eType, eTypeAccess, eParameterizedTypeToTAbstractType, eTypeToTAbstractType,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_2_2_corematch_blackBBBFBFB(model, eType, eTypeAccess,
			...
			for (Object[] result3_black : ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_2_3_findcontext_blackBBBBBB(model, eType, eTypeAccess,
							eTypeToTAbstractType, eParameterizedType, tAbstractType)) {
				Object[] result3_green = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_2_3_findcontext_greenBBBBBBFFFFFFF(model, eType, eTypeAccess,
								eTypeToTAbstractType, eParameterizedType, tAbstractType);
				...
				Object[] result4_bindingAndBlack = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								model, eType, eTypeAccess, eTypeToTAbstractType, eParameterizedType, tAbstractType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Model model,
			AbstractTypeDeclaration eType, TypeAccess eTypeAccess, TypeToTAbstractType eTypeToTAbstractType,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject model, EObject eType, EObject eTypeAccess,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_87(EMoflonEdge _edge_orphanTypes) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(this, model, eType, eTypeAccess,
		...
		if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ParameterizedTypeToTypeImpl
				...
				Object[] result6_black = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(model, eType,
								eTypeAccess, eParameterizedType, tAbstractType, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Model model, AbstractTypeDeclaration eType, TypeAccess eTypeAccess,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(Model model, AbstractTypeDeclaration eType, TypeAccess eTypeAccess,
			ParameterizedType eParameterizedType) {// 
		Object[] result1_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_24_1_matchtggpattern_blackBBBB(model, eType, eTypeAccess,
						eParameterizedType);
		if (result1_black != null) {
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
			...
			if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_6_perform_greenBBFFFBB(model, eType,
							tAbstractType, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_FWD__MATCH_MODEL_ABSTRACTTYPEDECLARATION_TYPEACCESS_PARAMETERIZEDTYPE:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MODEL_ABSTRACTTYPEDECLARATION_TYPEACCESS_PARAMETERIZEDTYPE:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (Model) arguments.get(1),
					(AbstractTypeDeclaration) arguments.get(2), (TypeAccess) arguments.get(3),
					(ParameterizedType) arguments.get(4));
			return null;
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MODEL_ABSTRACTTYPEDECLARATION_TYPEACCESS_PARAMETERIZEDTYPE:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODEL_ABSTRACTTYPEDECLARATION_TYPEACCESS_TYPETOTABSTRACTTYPE_PARAMETERIZEDTYPE_TABSTRACTTYPE:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_87__EMOFLONEDGE:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__MODEL_ABSTRACTTYPEDECLARATION_TYPEACCESS_PARAMETERIZEDTYPE_TABSTRACTTYPE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Model) arguments.get(0), (AbstractTypeDeclaration) arguments.get(1),
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___CHECK_DEC_FWD__MODEL_ABSTRACTTYPEDECLARATION_TYPEACCESS_PARAMETERIZEDTYPE:
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_1_initialbindings_blackBBBBBB(
			...
			TypeAccess eTypeAccess, ParameterizedType eParameterizedType) {
		return new Object[] { _this, match, model, eType, eTypeAccess, eParameterizedType };
	}

	public static final Object[] pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingFBBBBBB(
			ParameterizedTypeToType _this, Match match, Model model, AbstractTypeDeclaration eType,
			TypeAccess eTypeAccess, ParameterizedType eParameterizedType) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, model, eType, eTypeAccess, eParameterizedType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, model, eType, eTypeAccess, eParameterizedType };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_0_2_SolveCSP_binding = pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, model, eType, eTypeAccess, eParameterizedType);
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_4_collectelementstobetranslated_blackBBBBB(
			Match match, Model model, AbstractTypeDeclaration eType, TypeAccess eTypeAccess,
			ParameterizedType eParameterizedType) {
		return new Object[] { match, model, eType, eTypeAccess, eParameterizedType };
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_5_collectcontextelements_blackBBBBB(Match match,
			Model model, AbstractTypeDeclaration eType, TypeAccess eTypeAccess, ParameterizedType eParameterizedType) {
		return new Object[] { match, model, eType, eTypeAccess, eParameterizedType };
	}
	...
	public static final void pattern_ParameterizedTypeToType_0_6_registerobjectstomatch_expressionBBBBBB(
			ParameterizedTypeToType _this, Match match, Model model, AbstractTypeDeclaration eType,
			TypeAccess eTypeAccess, ParameterizedType eParameterizedType) {
		_this.registerObjectsToMatch_FWD(match, model, eType, eTypeAccess, eParameterizedType);
					...
					if (tmpETypeToTAbstractType instanceof TypeToTAbstractType) {
						...
						if (tmpEParameterizedType instanceof ParameterizedType) {
							...
							if (tmpTAbstractType instanceof TAbstractType) {
								...
								return new Object[] { model, eType, eTypeAccess, eTypeToTAbstractType,
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(Model model,
			AbstractTypeDeclaration eType, TypeAccess eTypeAccess, TypeToTAbstractType eTypeToTAbstractType,
			ParameterizedType eParameterizedType, TAbstractType tAbstractType, ParameterizedTypeToType _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { model, eType, eTypeAccess, eTypeToTAbstractType, eParameterizedType,
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_ParameterizedTypeToType_1_1_performtransformation_black = pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(
					model, eType, eTypeAccess, eTypeToTAbstractType, eParameterizedType, tAbstractType, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject model, EObject eType, EObject eTypeAccess,
			EObject eParameterizedTypeToTAbstractType, EObject eTypeToTAbstractType, EObject eParameterizedType,
			EObject tAbstractType) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
		...
		eTypeAccess__eType____type.setName(eTypeAccess__eType____type_name_prime);
		eType__eTypeAccess____usagesInTypeAccess.setName(eType__eTypeAccess____usagesInTypeAccess_name_prime);
		return new Object[] { ruleresult, model, eType, eTypeAccess, eParameterizedTypeToTAbstractType,
				eParameterizedType, tAbstractType, model__eParameterizedType____orphanTypes,
				eParameterizedTypeToTAbstractType__eParameterizedType____source,
	...
	public static final void pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(
			ParameterizedTypeToType _this, PerformRuleResult ruleresult, EObject model, EObject eType,
			EObject eTypeAccess, EObject eParameterizedTypeToTAbstractType, EObject eTypeToTAbstractType,
			EObject eParameterizedType, EObject tAbstractType) {
		_this.registerObjects_FWD(ruleresult, model, eType, eTypeAccess, eParameterizedTypeToTAbstractType,
				eTypeToTAbstractType, eParameterizedType, tAbstractType);
		...
		if (tmpModel instanceof Model) {
			...
			if (tmpEType instanceof AbstractTypeDeclaration) {
				...
				if (tmpETypeAccess instanceof TypeAccess) {
					...
					if (tmpEParameterizedType instanceof ParameterizedType) {
						ParameterizedType eParameterizedType = (ParameterizedType) tmpEParameterizedType;
						return new Object[] { model, eType, eTypeAccess, eParameterizedType, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_ParameterizedTypeToType_2_2_corematch_blackBBBFBFB(Model model,
			AbstractTypeDeclaration eType, TypeAccess eTypeAccess, ParameterizedType eParameterizedType, Match match) {
		...
		for (TypeToTAbstractType eTypeToTAbstractType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAbstractType != null) {
				_result.add(new Object[] { model, eType, eTypeAccess, eTypeToTAbstractType, eParameterizedType,
						tAbstractType, match });
			}
				...
				if (eType.equals(eTypeToTAbstractType.getSource())) {
					if (eType.equals(eTypeAccess.getType())) {
						if (tAbstractType.equals(eTypeToTAbstractType.getTarget())) {
							_result.add(new Object[] { model, eType, eTypeAccess, eTypeToTAbstractType,
									eParameterizedType, tAbstractType });
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_3_findcontext_greenBBBBBBFFFFFFF(Model model,
		...
		return new Object[] { model, eType, eTypeAccess, eTypeToTAbstractType, eParameterizedType, tAbstractType,
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractTypeDeclaration eType, TypeAccess eTypeAccess, TypeToTAbstractType eTypeToTAbstractType,
			ParameterizedType eParameterizedType, TAbstractType tAbstractType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, model, eType, eTypeAccess,
				eTypeToTAbstractType, eParameterizedType, tAbstractType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model, eType, eTypeAccess, eTypeToTAbstractType,
					eParameterizedType, tAbstractType };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_2_4_solveCSP_binding = pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, model, eType, eTypeAccess, eTypeToTAbstractType, eParameterizedType,
				tAbstractType);
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_140879 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_140879)) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_eTypeAccess_type_561371 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_93809 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_596262 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_871383 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_916984 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_916984)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_114532 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_132510 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_807192 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final boolean pattern_ParameterizedTypeToType_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ParameterizedTypeToType _this, Match match, Model model, AbstractTypeDeclaration eType,
			TypeAccess eTypeAccess, ParameterizedType eParameterizedType) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, model, eType, eTypeAccess, eParameterizedType);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
			...
			if (tmpEType instanceof AbstractTypeDeclaration) {
				...
				if (tmpETypeAccess instanceof TypeAccess) {
					...
					if (tmpEParameterizedType instanceof ParameterizedType) {
						...
						if (tmpTAbstractType instanceof TAbstractType) {
							TAbstractType tAbstractType = (TAbstractType) tmpTAbstractType;
							return new Object[] { model, eType, eTypeAccess, eParameterizedType, tAbstractType,
									sourceMatch, targetMatch };
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(Model model,
			AbstractTypeDeclaration eType, TypeAccess eTypeAccess, ParameterizedType eParameterizedType,
			TAbstractType tAbstractType, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { model, eType, eTypeAccess, eParameterizedType, tAbstractType, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_black = pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(
					model, eType, eTypeAccess, eParameterizedType, tAbstractType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
			ParameterizedTypeToType _this, Model model, AbstractTypeDeclaration eType, TypeAccess eTypeAccess,
			ParameterizedType eParameterizedType, TAbstractType tAbstractType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(model, eType, eTypeAccess, eParameterizedType,
				tAbstractType, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, model, eType, eTypeAccess, eParameterizedType, tAbstractType, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding = pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
				_this, model, eType, eTypeAccess, eParameterizedType, tAbstractType, sourceMatch, targetMatch);
		if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding != null) {
			...
			if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, model, eType, eTypeAccess, eParameterizedType, tAbstractType,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(Model model,
		...
		return new Object[] { model, eType, eTypeAccess, eParameterizedType, tAbstractType, ccMatch };
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_0BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_538140 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_538140)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_57815 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_935560 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_974959 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_336162 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_5BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_355504 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_355504)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_704862 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_428065 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_472039 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
												...
												if (pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_7B(
													...
													if (pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_8B(
														...
														if (pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_9BB(
																eType, eTypeAccess) == null) {
															return new Object[] { model, eType, eTypeAccess,
																	eParameterizedType };
														}
													}
												}
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_6_perform_greenBBFFFBB(Model model,
		...
		return new Object[] { model, eType, eTypeAccess, eParameterizedTypeToTAbstractType, eParameterizedType,
				tAbstractType, ruleResult };
	}
