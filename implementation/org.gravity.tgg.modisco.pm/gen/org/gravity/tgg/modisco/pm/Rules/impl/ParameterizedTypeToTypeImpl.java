...
public class ParameterizedTypeToTypeImpl extends AbstractRuleImpl implements ParameterizedTypeToType {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, AbstractTypeDeclaration eType, ParameterizedType eParameterizedType,
			Model model, TypeAccess eTypeAccess) {

		Object[] result1_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_0_1_initialbindings_blackBBBBBB(this, match, eType, eParameterizedType,
						model, eTypeAccess);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[eType] = " + eType + ", " + "[eParameterizedType] = "
					+ eParameterizedType + ", " + "[model] = " + model + ", " + "[eTypeAccess] = " + eTypeAccess + ".");
		}

		Object[] result2_bindingAndBlack = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, eType,
						eParameterizedType, model, eTypeAccess);
		...
		if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result5_black = ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_0_5_collectcontextelements_blackBBBBB(match, eType,
							eParameterizedType, model, eTypeAccess);
			...
			ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_0_6_registerobjectstomatch_expressionBBBBBB(
					this, match, eType, eParameterizedType, model, eTypeAccess);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, eTypeToTAbstractType,
						eType, eParameterizedTypeToTAbstractType, eParameterizedType, model, tAbstractType,
						eTypeAccess);
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
				ruleresult, eType, eParameterizedTypeToTAbstractType, eParameterizedType, model, tAbstractType,
				eTypeAccess);
		...
		ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eTypeToTAbstractType, eType, eParameterizedTypeToTAbstractType, eParameterizedType, model,
				tAbstractType, eTypeAccess);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_2_2_corematch_blackFBBBFBB(eType, eParameterizedType, model,
						eTypeAccess, match)) {
			...
			for (Object[] result3_black : ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_2_3_findcontext_blackBBBBBB(eTypeToTAbstractType, eType,
							eParameterizedType, model, tAbstractType, eTypeAccess)) {
				Object[] result3_green = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_2_3_findcontext_greenBBBBBBFFFFFFF(eTypeToTAbstractType, eType,
								eParameterizedType, model, tAbstractType, eTypeAccess);
				...
				Object[] result4_bindingAndBlack = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								eTypeToTAbstractType, eType, eParameterizedType, model, tAbstractType, eTypeAccess);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eTypeToTAbstractType] = "
							+ eTypeToTAbstractType + ", " + "[eType] = " + eType + ", " + "[eParameterizedType] = "
							+ eParameterizedType + ", " + "[model] = " + model + ", " + "[tAbstractType] = "
							+ tAbstractType + ", " + "[eTypeAccess] = " + eTypeAccess + ".");
				}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, AbstractTypeDeclaration eType,
			ParameterizedType eParameterizedType, Model model, TypeAccess eTypeAccess) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, AbstractTypeDeclaration eType,
			ParameterizedType eParameterizedType, Model model, TypeAccess eTypeAccess) {// Create CSP
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType eTypeToTAbstractType,
			...
			TAbstractType tAbstractType, TypeAccess eTypeAccess) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eTypeToTAbstractType, EObject eType,
			EObject eParameterizedTypeToTAbstractType, EObject eParameterizedType, EObject model, EObject tAbstractType,
			EObject eTypeAccess) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eType, eParameterizedType,
						model, tAbstractType, eTypeAccess, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[eType] = " + eType + ", " + "[eParameterizedType] = " + eParameterizedType + ", " + "[model] = "
					+ model + ", " + "[tAbstractType] = " + tAbstractType + ", " + "[eTypeAccess] = " + eTypeAccess
		...
		if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ParameterizedTypeToTypeImpl
				...
				Object[] result6_black = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(eType,
								eParameterizedType, model, tAbstractType, eTypeAccess, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AbstractTypeDeclaration eType, ParameterizedType eParameterizedType,
			Model model, TAbstractType tAbstractType, TypeAccess eTypeAccess, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(AbstractTypeDeclaration eType, ParameterizedType eParameterizedType, Model model,
			TypeAccess eTypeAccess) {// 
		Object[] result1_black = ParameterizedTypeToTypeImpl
				.pattern_ParameterizedTypeToType_24_1_matchtggpattern_blackBBBB(eType, eParameterizedType, model,
						eTypeAccess);
		if (result1_black != null) {
		...
		for (Object[] result2_black : ParameterizedTypeToTypeImpl
			...
			Object[] result3_bindingAndBlack = ParameterizedTypeToTypeImpl
					.pattern_ParameterizedTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
							eTypeToTAbstractType, eType, model, tAbstractType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eTypeToTAbstractType] = "
						+ eTypeToTAbstractType + ", " + "[eType] = " + eType + ", " + "[model] = " + model + ", "
			...
			if (ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = ParameterizedTypeToTypeImpl
						.pattern_ParameterizedTypeToType_26_5_checknacs_blackBBBB(eTypeToTAbstractType, eType, model,
								tAbstractType);
				if (result5_black != null) {

					Object[] result6_black = ParameterizedTypeToTypeImpl
							.pattern_ParameterizedTypeToType_26_6_perform_blackBBBBB(eTypeToTAbstractType, eType, model,
					...
					ParameterizedTypeToTypeImpl.pattern_ParameterizedTypeToType_26_6_perform_greenBFFBBFB(eType, model,
							tAbstractType, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_FWD__MATCH_ABSTRACTTYPEDECLARATION_PARAMETERIZEDTYPE_MODEL_TYPEACCESS:
			return isAppropriate_FWD((Match) arguments.get(0), (AbstractTypeDeclaration) arguments.get(1),
					(ParameterizedType) arguments.get(2), (Model) arguments.get(3), (TypeAccess) arguments.get(4));
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_ABSTRACTTYPEDECLARATION_PARAMETERIZEDTYPE_MODEL_TYPEACCESS:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (AbstractTypeDeclaration) arguments.get(1),
					(ParameterizedType) arguments.get(2), (Model) arguments.get(3), (TypeAccess) arguments.get(4));
			return null;
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_ABSTRACTTYPEDECLARATION_PARAMETERIZEDTYPE_MODEL_TYPEACCESS:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_PARAMETERIZEDTYPE_MODEL_TABSTRACTTYPE_TYPEACCESS:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (AbstractTypeDeclaration) arguments.get(2),
					(ParameterizedType) arguments.get(3), (Model) arguments.get(4), (TAbstractType) arguments.get(5),
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__ABSTRACTTYPEDECLARATION_PARAMETERIZEDTYPE_MODEL_TABSTRACTTYPE_TYPEACCESS_MATCH_MATCH:
			return isApplicable_solveCsp_CC((AbstractTypeDeclaration) arguments.get(0),
					(ParameterizedType) arguments.get(1), (Model) arguments.get(2), (TAbstractType) arguments.get(3),
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___CHECK_DEC_FWD__ABSTRACTTYPEDECLARATION_PARAMETERIZEDTYPE_MODEL_TYPEACCESS:
			return checkDEC_FWD((AbstractTypeDeclaration) arguments.get(0), (ParameterizedType) arguments.get(1),
					(Model) arguments.get(2), (TypeAccess) arguments.get(3));
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_MODEL_TABSTRACTTYPE_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_1_initialbindings_blackBBBBBB(
			ParameterizedTypeToType _this, Match match, AbstractTypeDeclaration eType,
			ParameterizedType eParameterizedType, Model model, TypeAccess eTypeAccess) {
		return new Object[] { _this, match, eType, eParameterizedType, model, eTypeAccess };
	}

	public static final Object[] pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingFBBBBBB(
			ParameterizedTypeToType _this, Match match, AbstractTypeDeclaration eType,
			ParameterizedType eParameterizedType, Model model, TypeAccess eTypeAccess) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, eType, eParameterizedType, model, eTypeAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, eType, eParameterizedType, model, eTypeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_0_2_SolveCSP_binding = pattern_ParameterizedTypeToType_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, eType, eParameterizedType, model, eTypeAccess);
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_4_collectelementstobetranslated_blackBBBBB(
			Match match, AbstractTypeDeclaration eType, ParameterizedType eParameterizedType, Model model,
			TypeAccess eTypeAccess) {
		return new Object[] { match, eType, eParameterizedType, model, eTypeAccess };
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_0_5_collectcontextelements_blackBBBBB(Match match,
			AbstractTypeDeclaration eType, ParameterizedType eParameterizedType, Model model, TypeAccess eTypeAccess) {
		return new Object[] { match, eType, eParameterizedType, model, eTypeAccess };
	}
	...
	public static final void pattern_ParameterizedTypeToType_0_6_registerobjectstomatch_expressionBBBBBB(
			ParameterizedTypeToType _this, Match match, AbstractTypeDeclaration eType,
			ParameterizedType eParameterizedType, Model model, TypeAccess eTypeAccess) {
		_this.registerObjectsToMatch_FWD(match, eType, eParameterizedType, model, eTypeAccess);
					...
					if (tmpModel instanceof Model) {
						...
						if (tmpTAbstractType instanceof TAbstractType) {
							...
							if (tmpETypeAccess instanceof TypeAccess) {
								...
								return new Object[] { eTypeToTAbstractType, eType, eParameterizedType, model,
										tAbstractType, eTypeAccess, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(
			...
			ParameterizedType eParameterizedType, Model model, TAbstractType tAbstractType, TypeAccess eTypeAccess,
			ParameterizedTypeToType _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { eTypeToTAbstractType, eType, eParameterizedType, model, tAbstractType,
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_1_1_performtransformation_binding != null) {
			...
			Model model = (Model) result_pattern_ParameterizedTypeToType_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_ParameterizedTypeToType_1_1_performtransformation_black = pattern_ParameterizedTypeToType_1_1_performtransformation_blackBBBBBBFBB(
					eTypeToTAbstractType, eType, eParameterizedType, model, tAbstractType, eTypeAccess, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eTypeToTAbstractType, EObject eType,
			EObject eParameterizedTypeToTAbstractType, EObject eParameterizedType, EObject model, EObject tAbstractType,
			EObject eTypeAccess) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			...
			EObject eParameterizedType, EObject model, EObject tAbstractType, EObject eTypeAccess) {
		...
		eTypeAccess__eType____type.setName(eTypeAccess__eType____type_name_prime);
		eType__eTypeAccess____usagesInTypeAccess.setName(eType__eTypeAccess____usagesInTypeAccess_name_prime);
		return new Object[] { ruleresult, eType, eParameterizedTypeToTAbstractType, eParameterizedType, model,
				tAbstractType, eTypeAccess, eParameterizedTypeToTAbstractType__tAbstractType____target,
				model__eParameterizedType____orphanTypes, eParameterizedType__eTypeAccess____type,
	...
	public static final void pattern_ParameterizedTypeToType_1_5_registerobjects_expressionBBBBBBBBB(
			ParameterizedTypeToType _this, PerformRuleResult ruleresult, EObject eTypeToTAbstractType, EObject eType,
			EObject eParameterizedTypeToTAbstractType, EObject eParameterizedType, EObject model, EObject tAbstractType,
			EObject eTypeAccess) {
		_this.registerObjects_FWD(ruleresult, eTypeToTAbstractType, eType, eParameterizedTypeToTAbstractType,
				eParameterizedType, model, tAbstractType, eTypeAccess);
		...
		if (tmpEType instanceof AbstractTypeDeclaration) {
			...
			if (tmpEParameterizedType instanceof ParameterizedType) {
				...
				if (tmpModel instanceof Model) {
					...
					if (tmpETypeAccess instanceof TypeAccess) {
						TypeAccess eTypeAccess = (TypeAccess) tmpETypeAccess;
						return new Object[] { eType, eParameterizedType, model, eTypeAccess, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_ParameterizedTypeToType_2_2_corematch_blackFBBBFBB(
			AbstractTypeDeclaration eType, ParameterizedType eParameterizedType, Model model, TypeAccess eTypeAccess,
			Match match) {
		...
		for (TypeToTAbstractType eTypeToTAbstractType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAbstractType != null) {
				_result.add(new Object[] { eTypeToTAbstractType, eType, eParameterizedType, model, tAbstractType,
						eTypeAccess, match });
			}
				...
				if (eTypeAccess.equals(eParameterizedType.getType())) {
					if (tAbstractType.equals(eTypeToTAbstractType.getTarget())) {
						if (eType.equals(eTypeAccess.getType())) {
							_result.add(new Object[] { eTypeToTAbstractType, eType, eParameterizedType, model,
									tAbstractType, eTypeAccess });
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		eTypeAccess__eType____type.setName(eTypeAccess__eType____type_name_prime);
		eType__eTypeAccess____usagesInTypeAccess.setName(eType__eTypeAccess____usagesInTypeAccess_name_prime);
		return new Object[] { eTypeToTAbstractType, eType, eParameterizedType, model, tAbstractType, eTypeAccess,
				isApplicableMatch, eTypeToTAbstractType__eType____source, model__eParameterizedType____orphanTypes,
				eParameterizedType__eTypeAccess____type, eTypeToTAbstractType__tAbstractType____target,
				eTypeAccess__eType____type, eType__eTypeAccess____usagesInTypeAccess };
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
			...
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType,
			ParameterizedType eParameterizedType, Model model, TAbstractType tAbstractType, TypeAccess eTypeAccess) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eTypeToTAbstractType, eType,
				eParameterizedType, model, tAbstractType, eTypeAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eTypeToTAbstractType, eType, eParameterizedType, model,
					tAbstractType, eTypeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_2_4_solveCSP_binding = pattern_ParameterizedTypeToType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eTypeToTAbstractType, eType, eParameterizedType, model, tAbstractType,
				eTypeAccess);
		if (result_pattern_ParameterizedTypeToType_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_ParameterizedTypeToType_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, eTypeToTAbstractType, eType, eParameterizedType,
						model, tAbstractType, eTypeAccess };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_72221 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_72221)) {
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_828393 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_590681 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_80189 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_379974 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_900786 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_900786)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_829008 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_621306 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToType_18_2_testcorematchandDECs_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_563067 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final boolean pattern_ParameterizedTypeToType_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ParameterizedTypeToType _this, Match match, AbstractTypeDeclaration eType,
			ParameterizedType eParameterizedType, Model model, TypeAccess eTypeAccess) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, eType, eParameterizedType, model, eTypeAccess);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
			...
			if (tmpEParameterizedType instanceof ParameterizedType) {
				...
				if (tmpModel instanceof Model) {
					...
					if (tmpTAbstractType instanceof TAbstractType) {
						...
						if (tmpETypeAccess instanceof TypeAccess) {
							TypeAccess eTypeAccess = (TypeAccess) tmpETypeAccess;
							return new Object[] { eType, eParameterizedType, model, tAbstractType, eTypeAccess,
									sourceMatch, targetMatch };
						}
					}
				}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(
			AbstractTypeDeclaration eType, ParameterizedType eParameterizedType, Model model,
			TAbstractType tAbstractType, TypeAccess eTypeAccess, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { eType, eParameterizedType, model, tAbstractType, eTypeAccess, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_black = pattern_ParameterizedTypeToType_21_2_matchsrctrgcontext_blackBBBBBBB(
					eType, eParameterizedType, model, tAbstractType, eTypeAccess, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
			ParameterizedTypeToType _this, AbstractTypeDeclaration eType, ParameterizedType eParameterizedType,
			Model model, TAbstractType tAbstractType, TypeAccess eTypeAccess, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eType, eParameterizedType, model, tAbstractType,
				eTypeAccess, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eType, eParameterizedType, model, tAbstractType, eTypeAccess, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding = pattern_ParameterizedTypeToType_21_3_solvecsp_bindingFBBBBBBBB(
				_this, eType, eParameterizedType, model, tAbstractType, eTypeAccess, sourceMatch, targetMatch);
		if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_binding != null) {
			...
			if (result_pattern_ParameterizedTypeToType_21_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, eType, eParameterizedType, model, tAbstractType, eTypeAccess,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_21_6_createcorrespondence_blackBBBBBB(
			AbstractTypeDeclaration eType, ParameterizedType eParameterizedType, Model model,
			TAbstractType tAbstractType, TypeAccess eTypeAccess, CCMatch ccMatch) {
		return new Object[] { eType, eParameterizedType, model, tAbstractType, eTypeAccess, ccMatch };
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_0BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_374338 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_374338)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_207719 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (AnnotationTypeMemberDeclaration __DEC_eTypeAccess_type_810521 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationTypeMemberDeclaration.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_473932 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_962591 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_5BB(
			TypeAccess eTypeAccess, AbstractTypeDeclaration eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_571316 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_571316)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_953974 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_271480 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_8B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_198058 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
												...
												if (pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_7B(
													...
													if (pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_8B(
														...
														if (pattern_ParameterizedTypeToType_24_1_matchtggpattern_black_nac_9BB(
																eType, eTypeAccess) == null) {
															return new Object[] { eType, eParameterizedType, model,
																	eTypeAccess };
														}
													}
												}
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_3_solveCSP_bindingFBBBBBBB(
			ParameterizedTypeToType _this, IsApplicableMatch isApplicableMatch,
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, Model model,
			TAbstractType tAbstractType, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, eTypeToTAbstractType, eType, model,
				tAbstractType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eTypeToTAbstractType, eType, model, tAbstractType,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_3_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToType_26_3_solveCSP_binding = pattern_ParameterizedTypeToType_26_3_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, eTypeToTAbstractType, eType, model, tAbstractType, ruleResult);
	...
	public static final Object[] pattern_ParameterizedTypeToType_26_5_checknacs_blackBBBB(
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, Model model,
			TAbstractType tAbstractType) {
		return new Object[] { eTypeToTAbstractType, eType, model, tAbstractType };
	}

	public static final Object[] pattern_ParameterizedTypeToType_26_6_perform_blackBBBBB(
			TypeToTAbstractType eTypeToTAbstractType, AbstractTypeDeclaration eType, Model model,
			TAbstractType tAbstractType, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { eTypeToTAbstractType, eType, model, tAbstractType, ruleResult };
	}

	public static final Object[] pattern_ParameterizedTypeToType_26_6_perform_greenBFFBBFB(
			AbstractTypeDeclaration eType, Model model, TAbstractType tAbstractType,
		...
		return new Object[] { eType, eParameterizedTypeToTAbstractType, eParameterizedType, model, tAbstractType,
