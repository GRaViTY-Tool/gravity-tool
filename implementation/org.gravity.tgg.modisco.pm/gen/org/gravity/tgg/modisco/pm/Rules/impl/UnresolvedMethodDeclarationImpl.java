...
public class UnresolvedMethodDeclarationImpl extends AbstractRuleImpl implements UnresolvedMethodDeclaration {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult,
						unresolved2Definiton, tMethodSignature, tMethodName, model2pm, mModel, tModel,
						tMethodDefinition, mMethod);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[unresolved2Definiton] = " + unresolved2Definiton + ", " + "[tMethodSignature] = "
					+ tMethodSignature + ", " + "[tMethodName] = " + tMethodName + ", " + "[model2pm] = " + model2pm
					+ ", " + "[mModel] = " + mModel + ", " + "[tModel] = " + tModel + ", " + "[tMethodDefinition] = "
					+ tMethodDefinition + ", " + "[mMethod] = " + mMethod + ".");
		}
		UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(ruleresult,
						unresolved2Definiton, tMethodSignature, tMethodName, mModel, tModel, tMethodDefinition,
						mMethod);
		...
		UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
				this, ruleresult, unresolved2Definiton, tMethodSignature, tMethodName, model2pm, mModel, tModel,
				tMethodDefinition, mMethod);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject unresolved2Definiton,
			EObject tMethodSignature, EObject tMethodName, EObject model2pm, EObject mModel, EObject tModel,
			EObject tMethodDefinition, EObject mMethod) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBBFFBBB(tMethodSignature, tMethodName, tModel,
			...
			for (Object[] result3_black : UnresolvedMethodDeclarationImpl
					.pattern_UnresolvedMethodDeclaration_12_3_findcontext_blackBBBBBB(tMethodSignature, tMethodName,
							model2pm, mModel, tModel, tMethodDefinition)) {
				Object[] result3_green = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(tMethodSignature,
								tMethodName, model2pm, mModel, tModel, tMethodDefinition);
				...
				Object[] result4_bindingAndBlack = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tMethodSignature, tMethodName, model2pm, mModel, tModel,
								tMethodDefinition);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMethodSignature] = "
							+ tMethodSignature + ", " + "[tMethodName] = " + tMethodName + ", " + "[model2pm] = "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethodSignature tMethodSignature,
			TMethod tMethodName, ModelToTypeGraph model2pm, Model mModel, TypeGraph tModel,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_63(EMoflonEdge _edge_signatures) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tMethodSignature,
						tMethodName, mModel, tModel, tMethodDefinition, mMethod, sourceMatch, targetMatch);
			...
			for (Object[] result5_black : UnresolvedMethodDeclarationImpl
				...
				Object[] result6_black = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(tMethodSignature,
								tMethodName, mModel, tModel, tMethodDefinition, mMethod, ccMatch);
				if (result6_black == null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_TMETHOD_MODELTOTYPEGRAPH_MODEL_TYPEGRAPH_TMETHODDEFINITION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TMethodSignature) arguments.get(1),
					(TMethod) arguments.get(2), (ModelToTypeGraph) arguments.get(3), (Model) arguments.get(4),
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_63__EMOFLONEDGE:
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_CC__TMETHODSIGNATURE_TMETHOD_MODEL_TYPEGRAPH_TMETHODDEFINITION_UNRESOLVEDMETHODDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TMethodSignature) arguments.get(0), (TMethod) arguments.get(1),
					(Model) arguments.get(2), (TypeGraph) arguments.get(3), (TMethodDefinition) arguments.get(4),
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFFFBFBB(
		...
		return new Object[] { unresolved2Definiton, tMethodSignature, tMethodName, tModel, tMethodDefinition, mMethod,
				csp };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(
			...
			EObject model2pm, EObject mModel, EObject tModel, EObject tMethodDefinition, EObject mMethod) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject unresolved2Definiton, EObject tMethodSignature, EObject tMethodName,
			EObject mModel, EObject tModel, EObject tMethodDefinition, EObject mMethod) {
		...
		mModel__mMethod____unresolvedItems.setName(mModel__mMethod____unresolvedItems_name_prime);
		return new Object[] { ruleresult, unresolved2Definiton, tMethodSignature, tMethodName, mModel, tModel,
				tMethodDefinition, mMethod, tMethodName__tMethodSignature____signatures,
				...
				tMethodName__tModel____model, unresolved2Definiton__tMethodDefinition____target,
	...
	public static final void pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tMethodSignature, EObject tMethodName, EObject model2pm, EObject mModel, EObject tModel,
			EObject tMethodDefinition, EObject mMethod) {
		_this.registerObjects_FWD(ruleresult, unresolved2Definiton, tMethodSignature, tMethodName, model2pm, mModel,
				tModel, tMethodDefinition, mMethod);
					...
					if (tmpMModel instanceof Model) {
						...
						if (tmpTModel instanceof TypeGraph) {
							...
							if (tmpTMethodDefinition instanceof TMethodDefinition) {
								...
								return new Object[] { tMethodSignature, tMethodName, model2pm, mModel, tModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
			TMethodSignature tMethodSignature, TMethod tMethodName, ModelToTypeGraph model2pm, Model mModel,
			TypeGraph tModel, TMethodDefinition tMethodDefinition, UnresolvedMethodDeclaration _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMethodSignature, tMethodName, model2pm, mModel, tModel, tMethodDefinition, csp,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_black = pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
					tMethodSignature, tMethodName, model2pm, mModel, tModel, tMethodDefinition, _this,
					isApplicableMatch);
	...
	public static final void pattern_UnresolvedMethodDeclaration_11_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tMethodSignature, EObject tMethodName, EObject model2pm, EObject mModel, EObject tModel,
			EObject tMethodDefinition, EObject mMethod) {
		_this.registerObjects_BWD(ruleresult, unresolved2Definiton, tMethodSignature, tMethodName, model2pm, mModel,
				tModel, tMethodDefinition, mMethod);
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBBFFBBB(
		...
		for (ModelToTypeGraph model2pm : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(tModel,
			...
			if (mModel != null) {
				_result.add(new Object[] { tMethodSignature, tMethodName, model2pm, mModel, tModel, tMethodDefinition,
						match });
			}
			...
			if (mModel.equals(model2pm.getSource())) {
				if (tMethodSignature.getDefinitions().contains(tMethodDefinition)) {
					if (tModel.getMethods().contains(tMethodName)) {
						if (tModel.equals(model2pm.getTarget())) {
							_result.add(new Object[] { tMethodSignature, tMethodName, model2pm, mModel, tModel,
									tMethodDefinition });
						}
					}
				}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(
		...
		tMethodName__tModel____model.setName(tMethodName__tModel____model_name_prime);
		model2pm__tModel____target.setName(model2pm__tModel____target_name_prime);
		return new Object[] { tMethodSignature, tMethodName, model2pm, mModel, tModel, tMethodDefinition,
				isApplicableMatch, tMethodName__tMethodSignature____signatures, tMethodSignature__tMethodName____method,
				model2pm__mModel____source, tMethodSignature__tMethodDefinition____definitions,
				tMethodDefinition__tMethodSignature____signature, tModel__tMethodName____methods,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
			...
			TMethod tMethodName, ModelToTypeGraph model2pm, Model mModel, TypeGraph tModel,
			TMethodDefinition tMethodDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tMethodSignature, tMethodName,
				model2pm, mModel, tModel, tMethodDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethodSignature, tMethodName, model2pm, mModel,
					tModel, tMethodDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_binding = pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tMethodSignature, tMethodName, model2pm, mModel, tModel, tMethodDefinition);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TMethod __DEC_tMethodSignature_method_330893 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_330893 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_330893)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_1B(
		...
		TAbstractType __DEC_tMethodSignature_returnType_148608 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_148608 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2BB(
		...
		TypeGraph __DEC_tMethodName_model_30080 = tMethodName.getModel();
		if (__DEC_tMethodName_model_30080 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_30080)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3BB(
		...
		TSignature __DEC_tMethodDefinition_signature_505076 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_505076 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_505076)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_4B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_799544 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_799544 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_334194 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_334194 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_441907 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_441907 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_67679 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_67679 != null) {
			return new Object[] { mMethod };
		}
				...
				if (tmpMModel instanceof Model) {
					...
					if (tmpTModel instanceof TypeGraph) {
						...
						if (tmpTMethodDefinition instanceof TMethodDefinition) {
							...
							if (tmpMMethod instanceof org.eclipse.modisco.java.UnresolvedMethodDeclaration) {
								org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod = (org.eclipse.modisco.java.UnresolvedMethodDeclaration) tmpMMethod;
								return new Object[] { tMethodSignature, tMethodName, mModel, tModel, tMethodDefinition,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMethodSignature, tMethodName, mModel, tModel, tMethodDefinition, mMethod,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_black = pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tMethodSignature, tMethodName, mModel, tModel, tMethodDefinition, mMethod, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
		...
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tMethodSignature, tMethodName, mModel, tModel,
				tMethodDefinition, mMethod, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tMethodSignature, tMethodName, mModel, tModel, tMethodDefinition, mMethod,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding = pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tMethodSignature, tMethodName, mModel, tModel, tMethodDefinition, mMethod, sourceMatch,
				targetMatch);
		if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tMethodSignature, tMethodName, mModel, tModel, tMethodDefinition,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(
			...
			TMethodDefinition tMethodDefinition, org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod,
			CCMatch ccMatch) {
		return new Object[] { tMethodSignature, tMethodName, mModel, tModel, tMethodDefinition, mMethod, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_431982 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_431982 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_125128 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_125128 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_557359 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_557359 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0BB(
			TMethodSignature tMethodSignature, TMethod tMethodName) {
		TMethod __DEC_tMethodSignature_method_916599 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_916599 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_916599)) {
				return new Object[] { tMethodSignature, tMethodName };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_196607 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_196607 != null) {
			return new Object[] { tMethodSignature };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2BB(
			TMethod tMethodName, TypeGraph tModel) {
		TypeGraph __DEC_tMethodName_model_730857 = tMethodName.getModel();
		if (__DEC_tMethodName_model_730857 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_730857)) {
				return new Object[] { tMethodName, tModel };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_3BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_922075 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_922075 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_922075)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_4B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_31475 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_31475 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_29_6_perform_greenFFFBBFFBB(Model mModel,
		...
		return new Object[] { unresolved2Definiton, tMethodSignature, tMethodName, mModel, tModel, tMethodDefinition,
