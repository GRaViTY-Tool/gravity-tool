...
public class UnresolvedMethodDeclarationImpl extends AbstractRuleImpl implements UnresolvedMethodDeclaration {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFBBFFFB(mMethod, tModel, csp);
		...
		Object[] result2_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(tMethodSignature, mMethod,
						tMethodName, unresolved2Definiton, tMethodDefinition);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodSignature] = "
					+ tMethodSignature + ", " + "[mMethod] = " + mMethod + ", " + "[tMethodName] = " + tMethodName
		...
		Object[] result2_green = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_greenFBBBBB(tMethodSignature,
						mMethod, tMethodName, unresolved2Definiton, tMethodDefinition);
		...
		Object[] result3_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult,
						tMethodSignature, mMethod, mModel, tModel, model2pm, tMethodName, unresolved2Definiton,
						tMethodDefinition);
		...
		UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(ruleresult,
						tMethodSignature, mMethod, mModel, tModel, tMethodName, unresolved2Definiton,
						tMethodDefinition);
		...
		UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
				this, ruleresult, tMethodSignature, mMethod, mModel, tModel, model2pm, tMethodName,
				unresolved2Definiton, tMethodDefinition);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tMethodSignature, EObject mMethod,
			EObject mModel, EObject tModel, EObject model2pm, EObject tMethodName, EObject unresolved2Definiton,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_11_1_performtransformation_greenFBFBB(mModel, tMethodDefinition,
						csp);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBFBFBBB(tMethodSignature, tModel, tMethodName,
						tMethodDefinition, match)) {
			Model mModel = (Model) result2_black[1];
			ModelToTypeGraph model2pm = (ModelToTypeGraph) result2_black[3];
			// ForEach 
			for (Object[] result3_black : UnresolvedMethodDeclarationImpl
					.pattern_UnresolvedMethodDeclaration_12_3_findcontext_blackBBBBBB(tMethodSignature, mModel, tModel,
							model2pm, tMethodName, tMethodDefinition)) {
				Object[] result3_green = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(tMethodSignature,
								mModel, tModel, model2pm, tMethodName, tMethodDefinition);
				...
				Object[] result4_bindingAndBlack = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tMethodSignature, mModel, tModel, model2pm, tMethodName,
								tMethodDefinition);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMethodSignature] = "
							+ tMethodSignature + ", " + "[mModel] = " + mModel + ", " + "[tModel] = " + tModel + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethodSignature tMethodSignature,
			Model mModel, TypeGraph tModel, ModelToTypeGraph model2pm, TMethod tMethodName,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tMethodSignature, EObject mMethod,
			EObject mModel, EObject tModel, EObject model2pm, EObject tMethodName, EObject unresolved2Definiton,
			EObject tMethodDefinition) {
		ruleresult.registerObject("tMethodSignature", tMethodSignature);
		ruleresult.registerObject("mMethod", mMethod);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_68(EMoflonEdge _edge_methods) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_70(EMoflonEdge _edge_unresolvedItems) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tMethodSignature,
						mMethod, mModel, tModel, tMethodName, tMethodDefinition, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tMethodSignature] = " + tMethodSignature + ", " + "[mMethod] = " + mMethod + ", "
					+ "[mModel] = " + mModel + ", " + "[tModel] = " + tModel + ", " + "[tMethodName] = " + tMethodName
			...
			for (Object[] result5_black : UnresolvedMethodDeclarationImpl
				...
				Object[] result6_black = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(tMethodSignature,
								mMethod, mModel, tModel, tMethodName, tMethodDefinition, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodSignature] = "
							+ tMethodSignature + ", " + "[mMethod] = " + mMethod + ", " + "[mModel] = " + mModel + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMethodSignature tMethodSignature,
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, Model mModel, TypeGraph tModel,
			TMethod tMethodName, TMethodDefinition tMethodDefinition, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_MODEL_TYPEGRAPH_MODELTOTYPEGRAPH_TMETHOD_TMETHODDEFINITION:
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_68__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_68((EMoflonEdge) arguments.get(0));
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_70__EMOFLONEDGE:
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_CC__TMETHODSIGNATURE_UNRESOLVEDMETHODDECLARATION_MODEL_TYPEGRAPH_TMETHOD_TMETHODDEFINITION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TMethodSignature) arguments.get(0),
					(org.eclipse.modisco.java.UnresolvedMethodDeclaration) arguments.get(1), (Model) arguments.get(2),
					(TypeGraph) arguments.get(3), (TMethod) arguments.get(4), (TMethodDefinition) arguments.get(5),
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFBBFFFB(
		...
		return new Object[] { tMethodSignature, mMethod, tModel, tMethodName, unresolved2Definiton, tMethodDefinition,
				csp };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(
			...
			TMethod tMethodName, MDefinitionToTMember unresolved2Definiton, TMethodDefinition tMethodDefinition) {
		return new Object[] { tMethodSignature, mMethod, tMethodName, unresolved2Definiton, tMethodDefinition };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, tMethodSignature, mMethod, tMethodName, unresolved2Definiton,
				tMethodDefinition };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tMethodSignature, EObject mMethod, EObject mModel, EObject tModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tMethodSignature, EObject mMethod, EObject mModel, EObject tModel,
			EObject tMethodName, EObject unresolved2Definiton, EObject tMethodDefinition) {
		...
		return new Object[] { ruleresult, tMethodSignature, mMethod, mModel, tModel, tMethodName, unresolved2Definiton,
				tMethodDefinition, tModel__tMethodName____methods, tMethodName__tModel____model,
	...
	public static final void pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
			UnresolvedMethodDeclaration _this, PerformRuleResult ruleresult, EObject tMethodSignature, EObject mMethod,
			EObject mModel, EObject tModel, EObject model2pm, EObject tMethodName, EObject unresolved2Definiton,
			EObject tMethodDefinition) {
		_this.registerObjects_FWD(ruleresult, tMethodSignature, mMethod, mModel, tModel, model2pm, tMethodName,
				unresolved2Definiton, tMethodDefinition);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_2_3_findcontext_greenBBBBFFFF(
		...
		mModel__mMethod____unresolvedItems.setName(mModel__mMethod____unresolvedItems_name_prime);
		return new Object[] { mMethod, mModel, tModel, model2pm, isApplicableMatch, model2pm__tModel____target,
					...
					if (tmpModel2pm instanceof ModelToTypeGraph) {
						...
						if (tmpTMethodName instanceof TMethod) {
							...
							if (tmpTMethodDefinition instanceof TMethodDefinition) {
								...
								return new Object[] { tMethodSignature, mModel, tModel, model2pm, tMethodName,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
			TMethodSignature tMethodSignature, Model mModel, TypeGraph tModel, ModelToTypeGraph model2pm,
			TMethod tMethodName, TMethodDefinition tMethodDefinition, UnresolvedMethodDeclaration _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMethodSignature, mModel, tModel, model2pm, tMethodName, tMethodDefinition, csp,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_black = pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
					tMethodSignature, mModel, tModel, model2pm, tMethodName, tMethodDefinition, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_greenFBFBB(Model mModel,
		...
		return new Object[] { mMethod, mModel, unresolved2Definiton, tMethodDefinition, csp };
	}
	...
	public static final void pattern_UnresolvedMethodDeclaration_11_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject mModel, EObject tModel, EObject model2pm, EObject tMethodName, EObject unresolved2Definiton,
			EObject tMethodDefinition) {
		_this.registerObjects_BWD(ruleresult, tMethodSignature, mMethod, mModel, tModel, model2pm, tMethodName,
				unresolved2Definiton, tMethodDefinition);
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBFBFBBB(
		...
		for (ModelToTypeGraph model2pm : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(tModel,
			...
			if (mModel != null) {
				_result.add(new Object[] { tMethodSignature, mModel, tModel, model2pm, tMethodName, tMethodDefinition,
						match });
			}
			...
			if (tModel.equals(model2pm.getTarget())) {
				if (tMethodSignature.getDefinitions().contains(tMethodDefinition)) {
					if (tMethodName.getSignatures().contains(tMethodSignature)) {
						if (mModel.equals(model2pm.getSource())) {
							_result.add(new Object[] { tMethodSignature, mModel, tModel, model2pm, tMethodName,
									tMethodDefinition });
						}
					}
				}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(
		...
		tMethodSignature__tMethodName____method.setName(tMethodSignature__tMethodName____method_name_prime);
		model2pm__mModel____source.setName(model2pm__mModel____source_name_prime);
		return new Object[] { tMethodSignature, mModel, tModel, model2pm, tMethodName, tMethodDefinition,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
			...
			Model mModel, TypeGraph tModel, ModelToTypeGraph model2pm, TMethod tMethodName,
			TMethodDefinition tMethodDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tMethodSignature, mModel, tModel,
				model2pm, tMethodName, tMethodDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethodSignature, mModel, tModel, model2pm,
					tMethodName, tMethodDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_binding = pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tMethodSignature, mModel, tModel, model2pm, tMethodName, tMethodDefinition);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TMethod __DEC_tMethodSignature_method_341848 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_341848 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_341848)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_1B(
		...
		TAbstractType __DEC_tMethodSignature_returnType_633514 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_633514 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2BB(
		...
		TypeGraph __DEC_tMethodName_model_279379 = tMethodName.getModel();
		if (__DEC_tMethodName_model_279379 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_279379)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3BB(
		...
		TSignature __DEC_tMethodDefinition_signature_1334 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_1334 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_1334)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_4B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_665194 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_665194 != null) {
											...
											if (pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3BB(
												...
												if (pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_4B(
													...
													_result.add(new Object[] { tMethodSignature, tModel, tMethodName,
															tMethodDefinition, _edge_methods });
												}
											}
										}
									}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_0B(
		...
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_9469 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_9469 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_998307 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_998307 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_541206 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_541206 != null) {
			return new Object[] { mMethod };
		}
				...
				if (tmpMModel instanceof Model) {
					...
					if (tmpTModel instanceof TypeGraph) {
						...
						if (tmpTMethodName instanceof TMethod) {
							...
							if (tmpTMethodDefinition instanceof TMethodDefinition) {
								TMethodDefinition tMethodDefinition = (TMethodDefinition) tmpTMethodDefinition;
								return new Object[] { tMethodSignature, mMethod, mModel, tModel, tMethodName,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TMethodSignature tMethodSignature, org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod,
			Model mModel, TypeGraph tModel, TMethod tMethodName, TMethodDefinition tMethodDefinition, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMethodSignature, mMethod, mModel, tModel, tMethodName, tMethodDefinition,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_black = pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tMethodSignature, mMethod, mModel, tModel, tMethodName, tMethodDefinition, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
			UnresolvedMethodDeclaration _this, TMethodSignature tMethodSignature,
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, Model mModel, TypeGraph tModel,
			TMethod tMethodName, TMethodDefinition tMethodDefinition, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tMethodSignature, mMethod, mModel, tModel, tMethodName,
				tMethodDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tMethodSignature, mMethod, mModel, tModel, tMethodName, tMethodDefinition,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding = pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tMethodSignature, mMethod, mModel, tModel, tMethodName, tMethodDefinition, sourceMatch,
				targetMatch);
		if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tMethodSignature, mMethod, mModel, tModel, tMethodName,
						tMethodDefinition, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(
			TMethodSignature tMethodSignature, org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod,
			Model mModel, TypeGraph tModel, TMethod tMethodName, TMethodDefinition tMethodDefinition, CCMatch ccMatch) {
		return new Object[] { tMethodSignature, mMethod, mModel, tModel, tMethodName, tMethodDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_298880 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_298880 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_695396 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_695396 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_154600 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_154600 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0BB(
			TMethodSignature tMethodSignature, TMethod tMethodName) {
		TMethod __DEC_tMethodSignature_method_694898 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_694898 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_694898)) {
				return new Object[] { tMethodSignature, tMethodName };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_259243 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_259243 != null) {
			return new Object[] { tMethodSignature };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2BB(
			TMethod tMethodName, TypeGraph tModel) {
		TypeGraph __DEC_tMethodName_model_691965 = tMethodName.getModel();
		if (__DEC_tMethodName_model_691965 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_691965)) {
				return new Object[] { tMethodName, tModel };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_3BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_875948 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_875948 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_875948)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_4B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_492975 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_492975 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_29_6_perform_greenFFBBFFFBB(Model mModel,
		...
		return new Object[] { tMethodSignature, mMethod, mModel, tModel, tMethodName, unresolved2Definiton,
