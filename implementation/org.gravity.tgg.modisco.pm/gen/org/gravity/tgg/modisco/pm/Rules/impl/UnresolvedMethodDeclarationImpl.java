...
public class UnresolvedMethodDeclarationImpl extends AbstractRuleImpl implements UnresolvedMethodDeclaration {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFFBFBFB(mMethod, tModel, csp);
		...
		Object[] result2_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(tMethodName,
						unresolved2Definiton, mMethod, tMethodDefinition, tMethodSignature);
		...
		Object[] result3_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult, tMethodName,
						mModel, unresolved2Definiton, model2pm, mMethod, tMethodDefinition, tModel, tMethodSignature);
		...
		UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(ruleresult,
						tMethodName, mModel, unresolved2Definiton, mMethod, tMethodDefinition, tModel,
						tMethodSignature);
		...
		UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
				this, ruleresult, tMethodName, mModel, unresolved2Definiton, model2pm, mMethod, tMethodDefinition,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tMethodName, EObject mModel,
			EObject unresolved2Definiton, EObject model2pm, EObject mMethod, EObject tMethodDefinition, EObject tModel,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBFFBBBB(tMethodName, tMethodDefinition, tModel,
						tMethodSignature, match)) {
			Model mModel = (Model) result2_black[1];
			ModelToTypeGraph model2pm = (ModelToTypeGraph) result2_black[2];
			// ForEach 
			for (Object[] result3_black : UnresolvedMethodDeclarationImpl
					.pattern_UnresolvedMethodDeclaration_12_3_findcontext_blackBBBBBB(tMethodName, mModel, model2pm,
							tMethodDefinition, tModel, tMethodSignature)) {
				Object[] result3_green = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(tMethodName, mModel,
								model2pm, tMethodDefinition, tModel, tMethodSignature);
				...
				Object[] result4_bindingAndBlack = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tMethodName, mModel, model2pm, tMethodDefinition, tModel,
								tMethodSignature);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethod tMethodName, Model mModel,
			ModelToTypeGraph model2pm, TMethodDefinition tMethodDefinition, TypeGraph tModel,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_20(EMoflonEdge _edge_signatures) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_22(EMoflonEdge _edge_unresolvedItems) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tMethodName, mModel,
						mMethod, tMethodDefinition, tModel, tMethodSignature, sourceMatch, targetMatch);
			...
			for (Object[] result5_black : UnresolvedMethodDeclarationImpl
				...
				Object[] result6_black = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(tMethodName, mModel,
								mMethod, tMethodDefinition, tModel, tMethodSignature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodName] = "
							+ tMethodName + ", " + "[mModel] = " + mModel + ", " + "[mMethod] = " + mMethod + ", "
							+ "[tMethodDefinition] = " + tMethodDefinition + ", " + "[tModel] = " + tModel + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMethod tMethodName, Model mModel,
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TMethodDefinition tMethodDefinition,
			TypeGraph tModel, TMethodSignature tMethodSignature, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHOD_MODEL_MODELTOTYPEGRAPH_TMETHODDEFINITION_TYPEGRAPH_TMETHODSIGNATURE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TMethod) arguments.get(1),
					(Model) arguments.get(2), (ModelToTypeGraph) arguments.get(3), (TMethodDefinition) arguments.get(4),
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_20__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_20((EMoflonEdge) arguments.get(0));
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_22__EMOFLONEDGE:
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_CC__TMETHOD_MODEL_UNRESOLVEDMETHODDECLARATION_TMETHODDEFINITION_TYPEGRAPH_TMETHODSIGNATURE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TMethod) arguments.get(0), (Model) arguments.get(1),
					(org.eclipse.modisco.java.UnresolvedMethodDeclaration) arguments.get(2),
					(TMethodDefinition) arguments.get(3), (TypeGraph) arguments.get(4),
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFFBFBFB(
		...
		return new Object[] { tMethodName, unresolved2Definiton, mMethod, tMethodDefinition, tModel, tMethodSignature,
				csp };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(
			TMethod tMethodName, MDefinitionToTMember unresolved2Definiton,
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TMethodDefinition tMethodDefinition,
			TMethodSignature tMethodSignature) {
		return new Object[] { tMethodName, unresolved2Definiton, mMethod, tMethodDefinition, tMethodSignature };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, tMethodName, unresolved2Definiton, mMethod, tMethodDefinition,
				tMethodSignature };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tMethodName, EObject mModel, EObject unresolved2Definiton,
			EObject model2pm, EObject mMethod, EObject tMethodDefinition, EObject tModel, EObject tMethodSignature) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tMethodName, EObject mModel, EObject unresolved2Definiton,
			EObject mMethod, EObject tMethodDefinition, EObject tModel, EObject tMethodSignature) {
		...
		return new Object[] { ruleresult, tMethodName, mModel, unresolved2Definiton, mMethod, tMethodDefinition, tModel,
	...
	public static final void pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject unresolved2Definiton, EObject model2pm, EObject mMethod, EObject tMethodDefinition, EObject tModel,
			EObject tMethodSignature) {
		_this.registerObjects_FWD(ruleresult, tMethodName, mModel, unresolved2Definiton, model2pm, mMethod,
				tMethodDefinition, tModel, tMethodSignature);
					...
					if (tmpTMethodDefinition instanceof TMethodDefinition) {
						...
						if (tmpTModel instanceof TypeGraph) {
							...
							if (tmpTMethodSignature instanceof TMethodSignature) {
								...
								return new Object[] { tMethodName, mModel, model2pm, tMethodDefinition, tModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMethodName, mModel, model2pm, tMethodDefinition, tModel, tMethodSignature, csp,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_black = pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
					tMethodName, mModel, model2pm, tMethodDefinition, tModel, tMethodSignature, _this,
					isApplicableMatch);
	...
	public static final void pattern_UnresolvedMethodDeclaration_11_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject unresolved2Definiton, EObject model2pm, EObject mMethod, EObject tMethodDefinition, EObject tModel,
			EObject tMethodSignature) {
		_this.registerObjects_BWD(ruleresult, tMethodName, mModel, unresolved2Definiton, model2pm, mMethod,
				tMethodDefinition, tModel, tMethodSignature);
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBFFBBBB(
		...
		for (ModelToTypeGraph model2pm : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(tModel,
			...
			if (mModel != null) {
				_result.add(new Object[] { tMethodName, mModel, model2pm, tMethodDefinition, tModel, tMethodSignature,
						match });
			}
				...
				if (tModel.getMethods().contains(tMethodName)) {
					if (tModel.equals(model2pm.getTarget())) {
						if (tMethodSignature.getDefinitions().contains(tMethodDefinition)) {
							_result.add(new Object[] { tMethodName, mModel, model2pm, tMethodDefinition, tModel,
									tMethodSignature });
						}
					}
				}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(
		...
		tMethodDefinition__tMethodSignature____signature
				.setName(tMethodDefinition__tMethodSignature____signature_name_prime);
		return new Object[] { tMethodName, mModel, model2pm, tMethodDefinition, tModel, tMethodSignature,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
			...
			ModelToTypeGraph model2pm, TMethodDefinition tMethodDefinition, TypeGraph tModel,
			TMethodSignature tMethodSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tMethodName, mModel, model2pm,
				tMethodDefinition, tModel, tMethodSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethodName, mModel, model2pm, tMethodDefinition,
					tModel, tMethodSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_binding = pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tMethodName, mModel, model2pm, tMethodDefinition, tModel, tMethodSignature);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TypeGraph __DEC_tMethodName_model_294730 = tMethodName.getModel();
		if (__DEC_tMethodName_model_294730 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_294730)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_1BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_808067 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_808067 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_808067)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2B(
		...
		TAbstractType __DEC_tMethodDefinition_returnType_832341 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_832341 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_841040 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_841040 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_4BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_definitions_604768 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_definitions_604768 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_definitions_604768)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_5BB(
		...
		TMethod __DEC_tMethodSignature_method_213246 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_213246 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_213246)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_6B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_99630 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_99630 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_14403 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_14403 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_728195 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_728195 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_421500 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_421500 != null) {
			return new Object[] { mMethod };
		}
				...
				if (tmpMMethod instanceof org.eclipse.modisco.java.UnresolvedMethodDeclaration) {
					...
					if (tmpTMethodDefinition instanceof TMethodDefinition) {
						...
						if (tmpTModel instanceof TypeGraph) {
							...
							if (tmpTMethodSignature instanceof TMethodSignature) {
								TMethodSignature tMethodSignature = (TMethodSignature) tmpTMethodSignature;
								return new Object[] { tMethodName, mModel, mMethod, tMethodDefinition, tModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
			...
			TMethodDefinition tMethodDefinition, TypeGraph tModel, TMethodSignature tMethodSignature, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMethodName, mModel, mMethod, tMethodDefinition, tModel, tMethodSignature,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_black = pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tMethodName, mModel, mMethod, tMethodDefinition, tModel, tMethodSignature, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
			UnresolvedMethodDeclaration _this, TMethod tMethodName, Model mModel,
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TMethodDefinition tMethodDefinition,
			TypeGraph tModel, TMethodSignature tMethodSignature, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tMethodName, mModel, mMethod, tMethodDefinition, tModel,
				tMethodSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tMethodName, mModel, mMethod, tMethodDefinition, tModel, tMethodSignature,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding = pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tMethodName, mModel, mMethod, tMethodDefinition, tModel, tMethodSignature, sourceMatch,
				targetMatch);
		if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tMethodName, mModel, mMethod, tMethodDefinition, tModel,
						tMethodSignature, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(
			TMethod tMethodName, Model mModel, org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod,
			TMethodDefinition tMethodDefinition, TypeGraph tModel, TMethodSignature tMethodSignature, CCMatch ccMatch) {
		return new Object[] { tMethodName, mModel, mMethod, tMethodDefinition, tModel, tMethodSignature, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_53578 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_53578 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_825986 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_825986 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_658660 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_658660 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0BB(
			TMethod tMethodName, TypeGraph tModel) {
		TypeGraph __DEC_tMethodName_model_807622 = tMethodName.getModel();
		if (__DEC_tMethodName_model_807622 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_807622)) {
				return new Object[] { tMethodName, tModel };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_688729 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_688729 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_688729)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_570105 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_570105 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_3B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_366356 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_366356 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_4BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_definitions_197671 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_definitions_197671 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_definitions_197671)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_5BB(
			TMethodSignature tMethodSignature, TMethod tMethodName) {
		TMethod __DEC_tMethodSignature_method_362465 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_362465 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_362465)) {
				return new Object[] { tMethodSignature, tMethodName };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_6B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_478800 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_478800 != null) {
			return new Object[] { tMethodSignature };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_29_6_perform_greenFBFFFBFBB(Model mModel,
		...
		return new Object[] { tMethodName, mModel, unresolved2Definiton, mMethod, tMethodDefinition, tModel,
