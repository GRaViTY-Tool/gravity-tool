...
public class UnresolvedMethodDeclarationImpl extends AbstractRuleImpl implements UnresolvedMethodDeclaration {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFFFBBFB(mMethod, tModel, csp);
		...
		Object[] result2_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(tMethodName,
						tMethodDefinition, unresolved2Definiton, mMethod, tMethodSignature);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodName] = " + tMethodName
					...
					+ unresolved2Definiton + ", " + "[mMethod] = " + mMethod + ", " + "[tMethodSignature] = "
					+ tMethodSignature + ".");
		}
		...
		Object[] result3_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult, tMethodName,
						tMethodDefinition, unresolved2Definiton, model2pm, mMethod, mModel, tModel, tMethodSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ ", " + "[mMethod] = " + mMethod + ", " + "[mModel] = " + mModel + ", " + "[tModel] = " + tModel
		...
		UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(ruleresult,
						tMethodName, tMethodDefinition, unresolved2Definiton, mMethod, mModel, tModel,
						tMethodSignature);
		...
		//nothing EMoflonEdge unresolved2Definiton__tMethodDefinition____target = (EMoflonEdge) result3_green[10];
		...
		UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
				this, ruleresult, tMethodName, tMethodDefinition, unresolved2Definiton, model2pm, mMethod, mModel,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_2_2_corematch_blackFBBFB(mMethod, mModel, match)) {
			...
			for (Object[] result3_black : UnresolvedMethodDeclarationImpl
					.pattern_UnresolvedMethodDeclaration_2_3_findcontext_blackBBBB(model2pm, mMethod, mModel, tModel)) {
				Object[] result3_green = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_2_3_findcontext_greenBBBBFFFF(model2pm, mMethod, mModel,
								tModel);
				...
				Object[] result4_bindingAndBlack = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_2_4_solveCSP_bindingAndBlackFBBBBBB(this,
								isApplicableMatch, model2pm, mMethod, mModel, tModel);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ModelToTypeGraph model2pm,
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, Model mModel, TypeGraph tModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tMethodName, EObject tMethodDefinition,
			EObject unresolved2Definiton, EObject model2pm, EObject mMethod, EObject mModel, EObject tModel,
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
			...
			for (Object[] result3_black : UnresolvedMethodDeclarationImpl
					.pattern_UnresolvedMethodDeclaration_12_3_findcontext_blackBBBBBB(tMethodName, tMethodDefinition,
							model2pm, mModel, tModel, tMethodSignature)) {
				Object[] result3_green = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(tMethodName,
								tMethodDefinition, model2pm, mModel, tModel, tMethodSignature);
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethod tMethodName,
			TMethodDefinition tMethodDefinition, ModelToTypeGraph model2pm, Model mModel, TypeGraph tModel,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_2(EMoflonEdge _edge_signatures) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tMethodName,
						tMethodDefinition, mMethod, mModel, tModel, tMethodSignature, sourceMatch, targetMatch);
			...
			for (Object[] result5_black : UnresolvedMethodDeclarationImpl
				...
				Object[] result6_black = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(tMethodName,
								tMethodDefinition, mMethod, mModel, tModel, tMethodSignature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodName] = "
							+ tMethodName + ", " + "[tMethodDefinition] = " + tMethodDefinition + ", " + "[mMethod] = "
							+ mMethod + ", " + "[mModel] = " + mModel + ", " + "[tModel] = " + tModel + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMethod tMethodName, TMethodDefinition tMethodDefinition,
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
			...
			if (UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_29_6_perform_greenFFFFBBFBB(
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_UNRESOLVEDMETHODDECLARATION_MODEL_TYPEGRAPH:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ModelToTypeGraph) arguments.get(1),
					(org.eclipse.modisco.java.UnresolvedMethodDeclaration) arguments.get(2), (Model) arguments.get(3),
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHOD_TMETHODDEFINITION_MODELTOTYPEGRAPH_MODEL_TYPEGRAPH_TMETHODSIGNATURE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TMethod) arguments.get(1),
					(TMethodDefinition) arguments.get(2), (ModelToTypeGraph) arguments.get(3), (Model) arguments.get(4),
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_2__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_2((EMoflonEdge) arguments.get(0));
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_4__EMOFLONEDGE:
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_CC__TMETHOD_TMETHODDEFINITION_UNRESOLVEDMETHODDECLARATION_MODEL_TYPEGRAPH_TMETHODSIGNATURE_MATCH_MATCH:
			...
			if (tmpMMethod instanceof org.eclipse.modisco.java.UnresolvedMethodDeclaration) {
				...
				if (tmpMModel instanceof Model) {
					...
					if (tmpTModel instanceof TypeGraph) {
						...
						return new Object[] { model2pm, mMethod, mModel, tModel, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_1_performtransformation_blackBBBBFBB(
			ModelToTypeGraph model2pm, org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, Model mModel,
			TypeGraph tModel, UnresolvedMethodDeclaration _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { model2pm, mMethod, mModel, tModel, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_1_1_performtransformation_black = pattern_UnresolvedMethodDeclaration_1_1_performtransformation_blackBBBBFBB(
					model2pm, mMethod, mModel, tModel, _this, isApplicableMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFFFBBFB(
		...
		return new Object[] { tMethodName, tMethodDefinition, unresolved2Definiton, mMethod, tModel, tMethodSignature,
				csp };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(
		...
		return new Object[] { tMethodName, tMethodDefinition, unresolved2Definiton, mMethod, tMethodSignature };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, tMethodName, tMethodDefinition, unresolved2Definiton, mMethod,
				tMethodSignature };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tMethodName, EObject tMethodDefinition, EObject unresolved2Definiton,
			EObject model2pm, EObject mMethod, EObject mModel, EObject tModel, EObject tMethodSignature) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tMethodName, EObject tMethodDefinition, EObject unresolved2Definiton,
			EObject mMethod, EObject mModel, EObject tModel, EObject tMethodSignature) {
		...
		return new Object[] { ruleresult, tMethodName, tMethodDefinition, unresolved2Definiton, mMethod, mModel, tModel,
				tMethodSignature, tMethodName__tMethodSignature____signatures, tMethodSignature__tMethodName____method,
	...
	public static final void pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tMethodDefinition, EObject unresolved2Definiton, EObject model2pm, EObject mMethod, EObject mModel,
			EObject tModel, EObject tMethodSignature) {
		_this.registerObjects_FWD(ruleresult, tMethodName, tMethodDefinition, unresolved2Definiton, model2pm, mMethod,
				mModel, tModel, tMethodSignature);
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_2_2_corematch_blackFBBFB(
		...
		for (ModelToTypeGraph model2pm : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mModel,
			...
			if (tModel != null) {
				_result.add(new Object[] { model2pm, mMethod, mModel, tModel, match });
			}
		...
		if (mModel.getUnresolvedItems().contains(mMethod)) {
			if (mModel.equals(model2pm.getSource())) {
				if (tModel.equals(model2pm.getTarget())) {
					_result.add(new Object[] { model2pm, mMethod, mModel, tModel });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_2_3_findcontext_greenBBBBFFFF(
		...
		return new Object[] { model2pm, mMethod, mModel, tModel, isApplicableMatch, mModel__mMethod____unresolvedItems,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_2_4_solveCSP_bindingFBBBBBB(
			...
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, Model mModel, TypeGraph tModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, model2pm, mMethod, mModel, tModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model2pm, mMethod, mModel, tModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_2_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_2_4_solveCSP_binding = pattern_UnresolvedMethodDeclaration_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, model2pm, mMethod, mModel, tModel);
					...
					if (tmpMModel instanceof Model) {
						...
						if (tmpTModel instanceof TypeGraph) {
							...
							if (tmpTMethodSignature instanceof TMethodSignature) {
								...
								return new Object[] { tMethodName, tMethodDefinition, model2pm, mModel, tModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
			TMethod tMethodName, TMethodDefinition tMethodDefinition, ModelToTypeGraph model2pm, Model mModel,
			TypeGraph tModel, TMethodSignature tMethodSignature, UnresolvedMethodDeclaration _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMethodName, tMethodDefinition, model2pm, mModel, tModel, tMethodSignature, csp,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_black = pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
					tMethodName, tMethodDefinition, model2pm, mModel, tModel, tMethodSignature, _this,
					isApplicableMatch);
	...
	public static final void pattern_UnresolvedMethodDeclaration_11_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tMethodDefinition, EObject unresolved2Definiton, EObject model2pm, EObject mMethod, EObject mModel,
			EObject tModel, EObject tMethodSignature) {
		_this.registerObjects_BWD(ruleresult, tMethodName, tMethodDefinition, unresolved2Definiton, model2pm, mMethod,
				mModel, tModel, tMethodSignature);
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBBFFBBB(
		...
		for (ModelToTypeGraph model2pm : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(tModel,
			...
			if (mModel != null) {
				_result.add(new Object[] { tMethodName, tMethodDefinition, model2pm, mModel, tModel, tMethodSignature,
						match });
			}
				...
				if (tModel.getMethods().contains(tMethodName)) {
					if (tModel.equals(model2pm.getTarget())) {
						if (tMethodSignature.getDefinitions().contains(tMethodDefinition)) {
							_result.add(new Object[] { tMethodName, tMethodDefinition, model2pm, mModel, tModel,
									tMethodSignature });
						}
					}
				}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(
		...
		tMethodDefinition__tMethodSignature____signature
				.setName(tMethodDefinition__tMethodSignature____signature_name_prime);
		return new Object[] { tMethodName, tMethodDefinition, model2pm, mModel, tModel, tMethodSignature,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethodName, tMethodDefinition, model2pm, mModel,
					tModel, tMethodSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_binding = pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tMethodName, tMethodDefinition, model2pm, mModel, tModel, tMethodSignature);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TypeGraph __DEC_tMethodName_model_50194 = tMethodName.getModel();
		if (__DEC_tMethodName_model_50194 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_50194)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tMethodDefinition_signature_815906 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_815906 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_815906)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2B(
		...
		TAbstractType __DEC_tMethodDefinition_returnType_617662 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_617662 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_708557 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_708557 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_4BB(
		...
		TMethod __DEC_tMethodSignature_method_159059 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_159059 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_159059)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_5B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_266877 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_266877 != null) {
												...
												if (pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2B(
													...
													if (pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3B(
														...
														_result.add(new Object[] { tMethodName, tMethodDefinition,
																tModel, tMethodSignature, _edge_signatures });
													}
												}
											}
										}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_0B(
		...
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_401451 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_401451 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_975343 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_975343 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_756339 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_756339 != null) {
			return new Object[] { mMethod };
		}
				...
				if (tmpMMethod instanceof org.eclipse.modisco.java.UnresolvedMethodDeclaration) {
					...
					if (tmpMModel instanceof Model) {
						...
						if (tmpTModel instanceof TypeGraph) {
							...
							if (tmpTMethodSignature instanceof TMethodSignature) {
								TMethodSignature tMethodSignature = (TMethodSignature) tmpTMethodSignature;
								return new Object[] { tMethodName, tMethodDefinition, mMethod, mModel, tModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMethodName, tMethodDefinition, mMethod, mModel, tModel, tMethodSignature,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_black = pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tMethodName, tMethodDefinition, mMethod, mModel, tModel, tMethodSignature, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
			UnresolvedMethodDeclaration _this, TMethod tMethodName, TMethodDefinition tMethodDefinition,
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, Model mModel, TypeGraph tModel,
			TMethodSignature tMethodSignature, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tMethodName, tMethodDefinition, mMethod, mModel, tModel,
				tMethodSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tMethodName, tMethodDefinition, mMethod, mModel, tModel, tMethodSignature,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding = pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tMethodName, tMethodDefinition, mMethod, mModel, tModel, tMethodSignature, sourceMatch,
				targetMatch);
		if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tMethodName, tMethodDefinition, mMethod, mModel, tModel,
						tMethodSignature, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(
			...
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, Model mModel, TypeGraph tModel,
			TMethodSignature tMethodSignature, CCMatch ccMatch) {
		return new Object[] { tMethodName, tMethodDefinition, mMethod, mModel, tModel, tMethodSignature, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_84718 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_84718 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_249554 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_249554 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_629982 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_629982 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0BB(
			TMethod tMethodName, TypeGraph tModel) {
		TypeGraph __DEC_tMethodName_model_256959 = tMethodName.getModel();
		if (__DEC_tMethodName_model_256959 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_256959)) {
				return new Object[] { tMethodName, tModel };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_662988 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_662988 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_662988)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_921209 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_921209 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_3B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_192494 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_192494 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_4BB(
			TMethodSignature tMethodSignature, TMethod tMethodName) {
		TMethod __DEC_tMethodSignature_method_108925 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_108925 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_108925)) {
				return new Object[] { tMethodSignature, tMethodName };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_5B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_523369 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_523369 != null) {
			return new Object[] { tMethodSignature };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_29_6_perform_greenFFFFBBFBB(Model mModel,
		...
		return new Object[] { tMethodName, tMethodDefinition, unresolved2Definiton, mMethod, mModel, tModel,
