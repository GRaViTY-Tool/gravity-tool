...
public class UnresolvedMethodDeclarationImpl extends AbstractRuleImpl implements UnresolvedMethodDeclaration {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(tMethodDefinition,
						tMethodSignature, tMethodName, mMethod, unresolved2Definiton);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodDefinition] = "
					+ tMethodDefinition + ", " + "[tMethodSignature] = " + tMethodSignature + ", " + "[tMethodName] = "
		...
		Object[] result3_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult,
						tMethodDefinition, tMethodSignature, tMethodName, mMethod, unresolved2Definiton, model2pm,
						tModel, mModel);
		...
		UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(ruleresult,
						tMethodDefinition, tMethodSignature, tMethodName, mMethod, unresolved2Definiton, tModel,
						mModel);
		...
		UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
				this, ruleresult, tMethodDefinition, tMethodSignature, tMethodName, mMethod, unresolved2Definiton,
				model2pm, tModel, mModel);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tMethodDefinition, EObject tMethodSignature,
			EObject tMethodName, EObject mMethod, EObject unresolved2Definiton, EObject model2pm, EObject tModel,
			EObject mModel) {
	...
	public boolean isAppropriate_BWD(Match match, TMethodDefinition tMethodDefinition,
		...
		Object[] result1_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_10_1_initialbindings_blackBBBBBB(this, match, tMethodDefinition,
						tMethodSignature, tMethodName, tModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match,
						tMethodDefinition, tMethodSignature, tMethodName, tModel);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tMethodDefinition] = " + tMethodDefinition + ", "
					+ "[tMethodSignature] = " + tMethodSignature + ", " + "[tMethodName] = " + tMethodName + ", "
		...
		if (UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_10_3_CheckCSP_expressionFBB(this,
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tMethodDefinition] = " + tMethodDefinition + ", " + "[tMethodSignature] = "
						+ tMethodSignature + ", " + "[tMethodName] = " + tMethodName + ", " + "[tModel] = " + tModel
						+ ".");
			}
			UnresolvedMethodDeclarationImpl
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBBBFBFB(tMethodDefinition, tMethodSignature,
						tMethodName, tModel, match)) {
			ModelToTypeGraph model2pm = (ModelToTypeGraph) result2_black[3];
			Model mModel = (Model) result2_black[5];
			// ForEach 
			for (Object[] result3_black : UnresolvedMethodDeclarationImpl
					.pattern_UnresolvedMethodDeclaration_12_3_findcontext_blackBBBBBB(tMethodDefinition,
							tMethodSignature, tMethodName, model2pm, tModel, mModel)) {
				Object[] result3_green = UnresolvedMethodDeclarationImpl
				...
				Object[] result4_bindingAndBlack = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tMethodDefinition, tMethodSignature, tMethodName, model2pm, tModel,
								mModel);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isAppropriate_solveCsp_BWD(Match match, TMethodDefinition tMethodDefinition,
			TMethodSignature tMethodSignature, TMethod tMethodName, TypeGraph tModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethodDefinition tMethodDefinition,
			TMethodSignature tMethodSignature, TMethod tMethodName, ModelToTypeGraph model2pm, TypeGraph tModel,
			Model mModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tMethodDefinition, EObject tMethodSignature,
			EObject tMethodName, EObject mMethod, EObject unresolved2Definiton, EObject model2pm, EObject tModel,
			EObject mModel) {
		ruleresult.registerObject("tMethodDefinition", tMethodDefinition);
		ruleresult.registerObject("tMethodSignature", tMethodSignature);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_571(EMoflonEdge _edge_signatures) {
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
			...
			if (UnresolvedMethodDeclarationImpl
					.pattern_UnresolvedMethodDeclaration_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
							this, match, tMethodDefinition, tMethodSignature, tMethodName, tModel)) {
				// 
				if (UnresolvedMethodDeclarationImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_618(EMoflonEdge _edge_unresolvedItems) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tMethodDefinition,
						tMethodSignature, tMethodName, mMethod, tModel, mModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tMethodDefinition] = " + tMethodDefinition + ", " + "[tMethodSignature] = " + tMethodSignature
					+ ", " + "[tMethodName] = " + tMethodName + ", " + "[mMethod] = " + mMethod + ", " + "[tModel] = "
					+ tModel + ", " + "[mModel] = " + mModel + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
			...
			for (Object[] result5_black : UnresolvedMethodDeclarationImpl
				...
				Object[] result6_black = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(tMethodDefinition,
								tMethodSignature, tMethodName, mMethod, tModel, mModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodDefinition] = "
							+ tMethodDefinition + ", " + "[tMethodSignature] = " + tMethodSignature + ", "
							+ "[tMethodName] = " + tMethodName + ", " + "[mMethod] = " + mMethod + ", " + "[tModel] = "
	...
	public CSP isApplicable_solveCsp_CC(TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature,
			TMethod tMethodName, org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TypeGraph tModel,
			Model mModel, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_BWD__MATCH_TMETHODDEFINITION_TMETHODSIGNATURE_TMETHOD_TYPEGRAPH:
			return isAppropriate_BWD((Match) arguments.get(0), (TMethodDefinition) arguments.get(1),
					(TMethodSignature) arguments.get(2), (TMethod) arguments.get(3), (TypeGraph) arguments.get(4));
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TMETHODDEFINITION_TMETHODSIGNATURE_TMETHOD_TYPEGRAPH:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TMethodDefinition) arguments.get(1),
					(TMethodSignature) arguments.get(2), (TMethod) arguments.get(3), (TypeGraph) arguments.get(4));
			return null;
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TMETHODDEFINITION_TMETHODSIGNATURE_TMETHOD_TYPEGRAPH:
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_TMETHODSIGNATURE_TMETHOD_MODELTOTYPEGRAPH_TYPEGRAPH_MODEL:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TMethodDefinition) arguments.get(1),
					...
					(ModelToTypeGraph) arguments.get(4), (TypeGraph) arguments.get(5), (Model) arguments.get(6));
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_571__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_571((EMoflonEdge) arguments.get(0));
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_618__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_618((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_CC__TMETHODDEFINITION_TMETHODSIGNATURE_TMETHOD_UNRESOLVEDMETHODDECLARATION_TYPEGRAPH_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TMethodDefinition) arguments.get(0), (TMethodSignature) arguments.get(1),
					(TMethod) arguments.get(2), (org.eclipse.modisco.java.UnresolvedMethodDeclaration) arguments.get(3),
					(TypeGraph) arguments.get(4), (Model) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___CHECK_DEC_BWD__TMETHODDEFINITION_TMETHODSIGNATURE_TMETHOD_TYPEGRAPH:
			return checkDEC_BWD((TMethodDefinition) arguments.get(0), (TMethodSignature) arguments.get(1),
					(TMethod) arguments.get(2), (TypeGraph) arguments.get(3));
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFFFBFBB(
		...
		return new Object[] { tMethodDefinition, tMethodSignature, tMethodName, mMethod, unresolved2Definiton, tModel,
				csp };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature, TMethod tMethodName,
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, MDefinitionToTMember unresolved2Definiton) {
		return new Object[] { tMethodDefinition, tMethodSignature, tMethodName, mMethod, unresolved2Definiton };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, tMethodDefinition, tMethodSignature, tMethodName, mMethod,
				unresolved2Definiton };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tMethodDefinition, EObject tMethodSignature, EObject tMethodName,
			EObject mMethod, EObject unresolved2Definiton, EObject model2pm, EObject tModel, EObject mModel) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tMethodDefinition, EObject tMethodSignature, EObject tMethodName,
			EObject mMethod, EObject unresolved2Definiton, EObject tModel, EObject mModel) {
		...
		mModel__mMethod____unresolvedItems.setName(mModel__mMethod____unresolvedItems_name_prime);
		return new Object[] { ruleresult, tMethodDefinition, tMethodSignature, tMethodName, mMethod,
				unresolved2Definiton, tModel, mModel, unresolved2Definiton__tMethodDefinition____target,
	...
	public static final void pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tMethodSignature, EObject tMethodName, EObject mMethod, EObject unresolved2Definiton,
			EObject model2pm, EObject tModel, EObject mModel) {
		_this.registerObjects_FWD(ruleresult, tMethodDefinition, tMethodSignature, tMethodName, mMethod,
				unresolved2Definiton, model2pm, tModel, mModel);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_10_1_initialbindings_blackBBBBBB(
			...
			TMethodSignature tMethodSignature, TMethod tMethodName, TypeGraph tModel) {
		return new Object[] { _this, match, tMethodDefinition, tMethodSignature, tMethodName, tModel };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_10_2_SolveCSP_bindingFBBBBBB(
			UnresolvedMethodDeclaration _this, Match match, TMethodDefinition tMethodDefinition,
			TMethodSignature tMethodSignature, TMethod tMethodName, TypeGraph tModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, tMethodDefinition, tMethodSignature, tMethodName,
				tModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, tMethodDefinition, tMethodSignature, tMethodName, tModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_10_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_10_2_SolveCSP_binding = pattern_UnresolvedMethodDeclaration_10_2_SolveCSP_bindingFBBBBBB(
				_this, match, tMethodDefinition, tMethodSignature, tMethodName, tModel);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_10_4_collectelementstobetranslated_blackBBBBB(
			Match match, TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature, TMethod tMethodName,
			TypeGraph tModel) {
		return new Object[] { match, tMethodDefinition, tMethodSignature, tMethodName, tModel };
	}
	...
	public static final void pattern_UnresolvedMethodDeclaration_10_6_registerobjectstomatch_expressionBBBBBB(
			UnresolvedMethodDeclaration _this, Match match, TMethodDefinition tMethodDefinition,
			TMethodSignature tMethodSignature, TMethod tMethodName, TypeGraph tModel) {
		_this.registerObjectsToMatch_BWD(match, tMethodDefinition, tMethodSignature, tMethodName, tModel);
				...
				if (tmpTMethodName instanceof TMethod) {
					...
					if (tmpModel2pm instanceof ModelToTypeGraph) {
						...
						if (tmpTModel instanceof TypeGraph) {
							...
							if (tmpMModel instanceof Model) {
								Model mModel = (Model) tmpMModel;
								return new Object[] { tMethodDefinition, tMethodSignature, tMethodName, model2pm,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature, TMethod tMethodName,
			ModelToTypeGraph model2pm, TypeGraph tModel, Model mModel, UnresolvedMethodDeclaration _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMethodDefinition, tMethodSignature, tMethodName, model2pm, tModel, mModel, csp,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_black = pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
					tMethodDefinition, tMethodSignature, tMethodName, model2pm, tModel, mModel, _this,
					isApplicableMatch);
	...
	public static final void pattern_UnresolvedMethodDeclaration_11_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tMethodSignature, EObject tMethodName, EObject mMethod, EObject unresolved2Definiton,
			EObject model2pm, EObject tModel, EObject mModel) {
		_this.registerObjects_BWD(ruleresult, tMethodDefinition, tMethodSignature, tMethodName, mMethod,
				unresolved2Definiton, model2pm, tModel, mModel);
		...
		if (tmpTMethodDefinition instanceof TMethodDefinition) {
			...
			if (tmpTMethodSignature instanceof TMethodSignature) {
				...
				if (tmpTMethodName instanceof TMethod) {
					...
					if (tmpTModel instanceof TypeGraph) {
						TypeGraph tModel = (TypeGraph) tmpTModel;
						return new Object[] { tMethodDefinition, tMethodSignature, tMethodName, tModel, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBBBFBFB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature, TMethod tMethodName,
		...
		for (ModelToTypeGraph model2pm : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(tModel,
			...
			if (mModel != null) {
				_result.add(new Object[] { tMethodDefinition, tMethodSignature, tMethodName, model2pm, tModel, mModel,
						match });
			}
		...
		if (tMethodName.getSignatures().contains(tMethodSignature)) {
			if (tMethodSignature.getDefinitions().contains(tMethodDefinition)) {
				if (tModel.getMethods().contains(tMethodName)) {
					if (tModel.equals(model2pm.getTarget())) {
						if (mModel.equals(model2pm.getSource())) {
							_result.add(new Object[] { tMethodDefinition, tMethodSignature, tMethodName, model2pm,
									tModel, mModel });
						}
					}
				}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(
		...
		model2pm__tModel____target.setName(model2pm__tModel____target_name_prime);
		model2pm__mModel____source.setName(model2pm__mModel____source_name_prime);
		return new Object[] { tMethodDefinition, tMethodSignature, tMethodName, model2pm, tModel, mModel,
				isApplicableMatch, tMethodName__tMethodSignature____signatures, tMethodSignature__tMethodName____method,
				tMethodSignature__tMethodDefinition____definitions, tMethodDefinition__tMethodSignature____signature,
				tModel__tMethodName____methods, tMethodName__tModel____model, model2pm__tModel____target,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
			...
			TMethodSignature tMethodSignature, TMethod tMethodName, ModelToTypeGraph model2pm, TypeGraph tModel,
			Model mModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tMethodDefinition, tMethodSignature,
				tMethodName, model2pm, tModel, mModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethodDefinition, tMethodSignature, tMethodName,
					model2pm, tModel, mModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_binding = pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tMethodDefinition, tMethodSignature, tMethodName, model2pm, tModel, mModel);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_0BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_81049 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_81049 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_81049)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_1B(
		...
		TAbstractType __DEC_tMethodDefinition_returnType_781157 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_781157 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_126787 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_126787 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_definitions_928260 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_definitions_928260 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_definitions_928260)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_4BB(
		...
		TMethod __DEC_tMethodSignature_method_66658 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_66658 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_66658)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_5B(
		...
		TAbstractType __DEC_tMethodSignature_returnType_317273 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_317273 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_6BB(
			TMethod tMethodName, TypeGraph tModel) {
		TypeGraph __DEC_tMethodName_model_373255 = tMethodName.getModel();
		if (__DEC_tMethodName_model_373255 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_373255)) {
												...
												if (pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_1B(
													...
													if (pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2B(
														...
														if (pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3BB(
																tMethodDefinition, tMethodSignature) == null) {
															_result.add(
																	new Object[] { tMethodDefinition, tMethodSignature,
																			tMethodName, tModel, _edge_signatures });
														}
													}
												}
											}
	...
	public static final boolean pattern_UnresolvedMethodDeclaration_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			UnresolvedMethodDeclaration _this, Match match, TMethodDefinition tMethodDefinition,
			TMethodSignature tMethodSignature, TMethod tMethodName, TypeGraph tModel) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tMethodDefinition, tMethodSignature, tMethodName,
				tModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_0B(
		...
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_982581 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_982581 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_839242 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_839242 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_151587 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_151587 != null) {
			return new Object[] { mMethod };
		}
				...
				if (tmpTMethodName instanceof TMethod) {
					...
					if (tmpMMethod instanceof org.eclipse.modisco.java.UnresolvedMethodDeclaration) {
						...
						if (tmpTModel instanceof TypeGraph) {
							...
							if (tmpMModel instanceof Model) {
								Model mModel = (Model) tmpMModel;
								return new Object[] { tMethodDefinition, tMethodSignature, tMethodName, mMethod, tModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMethodDefinition, tMethodSignature, tMethodName, mMethod, tModel, mModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_black = pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tMethodDefinition, tMethodSignature, tMethodName, mMethod, tModel, mModel, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
		...
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tMethodDefinition, tMethodSignature, tMethodName, mMethod,
				tModel, mModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tMethodDefinition, tMethodSignature, tMethodName, mMethod, tModel, mModel,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding = pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tMethodDefinition, tMethodSignature, tMethodName, mMethod, tModel, mModel, sourceMatch,
				targetMatch);
		if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tMethodDefinition, tMethodSignature, tMethodName, mMethod, tModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(
			...
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TypeGraph tModel, Model mModel,
			CCMatch ccMatch) {
		return new Object[] { tMethodDefinition, tMethodSignature, tMethodName, mMethod, tModel, mModel, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_488000 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_488000 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_847239 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_847239 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_938240 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_938240 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_735126 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_735126 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_735126)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_237510 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_237510 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_866225 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_866225 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_3BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_definitions_519876 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_definitions_519876 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_definitions_519876)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_4BB(
			TMethodSignature tMethodSignature, TMethod tMethodName) {
		TMethod __DEC_tMethodSignature_method_858268 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_858268 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_858268)) {
				return new Object[] { tMethodSignature, tMethodName };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_5B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_55853 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_55853 != null) {
			return new Object[] { tMethodSignature };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_6BB(
			TMethod tMethodName, TypeGraph tModel) {
		TypeGraph __DEC_tMethodName_model_60918 = tMethodName.getModel();
		if (__DEC_tMethodName_model_60918 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_60918)) {
				return new Object[] { tMethodName, tModel };
			}
		}
									...
									if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_4BB(
										...
										if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_5B(
											...
											if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_6BB(
													tMethodName, tModel) == null) {
												return new Object[] { tMethodDefinition, tMethodSignature, tMethodName,
														tModel };
											}
										}
									}
