...
public class UnresolvedMethodDeclarationImpl extends AbstractRuleImpl implements UnresolvedMethodDeclaration {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult,
						unresolved2Definiton, mMethod, model2pm, tMethodDefinition, tMethodName, tModel, mModel,
						tMethodSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tMethodName] = " + tMethodName + ", " + "[tModel] = " + tModel + ", " + "[mModel] = " + mModel
		...
		UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(ruleresult,
						unresolved2Definiton, mMethod, tMethodDefinition, tMethodName, tModel, mModel,
						tMethodSignature);
		...
		UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
				this, ruleresult, unresolved2Definiton, mMethod, model2pm, tMethodDefinition, tMethodName, tModel,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject unresolved2Definiton, EObject mMethod,
			EObject model2pm, EObject tMethodDefinition, EObject tMethodName, EObject tModel, EObject mModel,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
			...
			// ForEach 
			for (Object[] result3_black : UnresolvedMethodDeclarationImpl
					.pattern_UnresolvedMethodDeclaration_12_3_findcontext_blackBBBBBB(model2pm, tMethodDefinition,
							tMethodName, tModel, mModel, tMethodSignature)) {
				Object[] result3_green = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(model2pm,
								tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature);
				...
				Object[] result4_bindingAndBlack = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, model2pm, tMethodDefinition, tMethodName, tModel, mModel,
								tMethodSignature);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ModelToTypeGraph model2pm,
			TMethodDefinition tMethodDefinition, TMethod tMethodName, TypeGraph tModel, Model mModel,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_74(EMoflonEdge _edge_signatures) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_78(EMoflonEdge _edge_unresolvedItems) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mMethod,
						tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature, sourceMatch, targetMatch);
			...
			for (Object[] result5_black : UnresolvedMethodDeclarationImpl
				...
				Object[] result6_black = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(mMethod,
								tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mMethod] = " + mMethod
							...
							+ tMethodName + ", " + "[tModel] = " + tModel + ", " + "[mModel] = " + mModel + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_TMETHODDEFINITION_TMETHOD_TYPEGRAPH_MODEL_TMETHODSIGNATURE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ModelToTypeGraph) arguments.get(1),
					...
					(Model) arguments.get(5), (TMethodSignature) arguments.get(6));
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_74__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_74((EMoflonEdge) arguments.get(0));
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_78__EMOFLONEDGE:
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_CC__UNRESOLVEDMETHODDECLARATION_TMETHODDEFINITION_TMETHOD_TYPEGRAPH_MODEL_TMETHODSIGNATURE_MATCH_MATCH:
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject unresolved2Definiton, EObject mMethod, EObject model2pm,
			EObject tMethodDefinition, EObject tMethodName, EObject tModel, EObject mModel, EObject tMethodSignature) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject unresolved2Definiton, EObject mMethod, EObject tMethodDefinition,
			EObject tMethodName, EObject tModel, EObject mModel, EObject tMethodSignature) {
		...
		return new Object[] { ruleresult, unresolved2Definiton, mMethod, tMethodDefinition, tMethodName, tModel, mModel,
	...
	public static final void pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject mMethod, EObject model2pm, EObject tMethodDefinition, EObject tMethodName, EObject tModel,
			EObject mModel, EObject tMethodSignature) {
		_this.registerObjects_FWD(ruleresult, unresolved2Definiton, mMethod, model2pm, tMethodDefinition, tMethodName,
				tModel, mModel, tMethodSignature);
					...
					if (tmpTModel instanceof TypeGraph) {
						...
						if (tmpMModel instanceof Model) {
							...
							if (tmpTMethodSignature instanceof TMethodSignature) {
								...
								return new Object[] { model2pm, tMethodDefinition, tMethodName, tModel, mModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
			ModelToTypeGraph model2pm, TMethodDefinition tMethodDefinition, TMethod tMethodName, TypeGraph tModel,
			Model mModel, TMethodSignature tMethodSignature, UnresolvedMethodDeclaration _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { model2pm, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature, csp,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_black = pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
					model2pm, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature, _this,
					isApplicableMatch);
	...
	public static final void pattern_UnresolvedMethodDeclaration_11_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject mMethod, EObject model2pm, EObject tMethodDefinition, EObject tMethodName, EObject tModel,
			EObject mModel, EObject tMethodSignature) {
		_this.registerObjects_BWD(ruleresult, unresolved2Definiton, mMethod, model2pm, tMethodDefinition, tMethodName,
				tModel, mModel, tMethodSignature);
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_12_2_corematch_blackFBBBFBB(
		...
		for (ModelToTypeGraph model2pm : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(tModel,
			...
			if (mModel != null) {
				_result.add(new Object[] { model2pm, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature,
						match });
			}
				...
				if (mModel.equals(model2pm.getSource())) {
					if (tMethodSignature.getDefinitions().contains(tMethodDefinition)) {
						if (tModel.getMethods().contains(tMethodName)) {
							_result.add(new Object[] { model2pm, tMethodDefinition, tMethodName, tModel, mModel,
									tMethodSignature });
						}
					}
				}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(
		...
		tModel__tMethodName____methods.setName(tModel__tMethodName____methods_name_prime);
		tMethodName__tModel____model.setName(tMethodName__tModel____model_name_prime);
		return new Object[] { model2pm, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
			...
			TMethodDefinition tMethodDefinition, TMethod tMethodName, TypeGraph tModel, Model mModel,
			TMethodSignature tMethodSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, model2pm, tMethodDefinition,
				tMethodName, tModel, mModel, tMethodSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model2pm, tMethodDefinition, tMethodName, tModel,
					mModel, tMethodSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_binding = pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, model2pm, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TSignature __DEC_tMethodDefinition_signature_748864 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_748864 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_748864)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_1B(
		...
		TAbstractType __DEC_tMethodDefinition_returnType_310529 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_310529 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_500669 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_500669 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3BB(
		...
		TypeGraph __DEC_tMethodName_model_688793 = tMethodName.getModel();
		if (__DEC_tMethodName_model_688793 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_688793)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_4BB(
		...
		TMethod __DEC_tMethodSignature_method_839 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_839 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_839)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_5B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_362028 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_362028 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_0B(
		...
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_107183 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_107183 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_183210 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_183210 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_757543 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_757543 != null) {
			return new Object[] { mMethod };
		}
				...
				if (tmpTMethodName instanceof TMethod) {
					...
					if (tmpTModel instanceof TypeGraph) {
						...
						if (tmpMModel instanceof Model) {
							...
							if (tmpTMethodSignature instanceof TMethodSignature) {
								TMethodSignature tMethodSignature = (TMethodSignature) tmpTMethodSignature;
								return new Object[] { mMethod, tMethodDefinition, tMethodName, tModel, mModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
			...
			TMethod tMethodName, TypeGraph tModel, Model mModel, TMethodSignature tMethodSignature, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mMethod, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_black = pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mMethod, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
		...
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mMethod, tMethodDefinition, tMethodName, tModel, mModel,
				tMethodSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mMethod, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding = pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mMethod, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature, sourceMatch,
				targetMatch);
		if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mMethod, tMethodDefinition, tMethodName, tModel, mModel,
						tMethodSignature, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TMethodDefinition tMethodDefinition,
			TMethod tMethodName, TypeGraph tModel, Model mModel, TMethodSignature tMethodSignature, CCMatch ccMatch) {
		return new Object[] { mMethod, tMethodDefinition, tMethodName, tModel, mModel, tMethodSignature, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_742678 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_742678 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_108507 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_108507 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_305647 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_305647 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_87426 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_87426 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_87426)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_962251 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_962251 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_650525 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_650525 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_3BB(
			TMethod tMethodName, TypeGraph tModel) {
		TypeGraph __DEC_tMethodName_model_985897 = tMethodName.getModel();
		if (__DEC_tMethodName_model_985897 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_985897)) {
				return new Object[] { tMethodName, tModel };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_4BB(
			TMethodSignature tMethodSignature, TMethod tMethodName) {
		TMethod __DEC_tMethodSignature_method_236692 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_236692 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_236692)) {
				return new Object[] { tMethodSignature, tMethodName };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_5B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_555597 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_555597 != null) {
			return new Object[] { tMethodSignature };
		}
					...
					if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0BB(tMethodDefinition,
						...
						if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1B(
							...
							if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2B(
									tMethodDefinition) == null) {
								if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_3BB(tMethodName,
										tModel) == null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_29_6_perform_greenFFFFBBFBB(TypeGraph tModel,
		...
		return new Object[] { unresolved2Definiton, mMethod, tMethodDefinition, tMethodName, tModel, mModel,
