...
public class UnresolvedMethodDeclarationImpl extends AbstractRuleImpl implements UnresolvedMethodDeclaration {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenBFBFFFB(mMethod, tModel, csp);
		...
		Object[] result2_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(mMethod, tMethodSignature,
						tMethodDefinition, tMethodName, unresolved2Definiton);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mMethod] = " + mMethod + ", "
					...
					+ ", " + "[tMethodName] = " + tMethodName + ", " + "[unresolved2Definiton] = "
		...
		Object[] result2_green = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_greenFBBBBB(mMethod,
						tMethodSignature, tMethodDefinition, tMethodName, unresolved2Definiton);
		...
		Object[] result3_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult, model2pm,
						mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel,
						unresolved2Definiton);
		...
		UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(ruleresult, mMethod,
						tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel, unresolved2Definiton);
		...
		UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
				this, ruleresult, model2pm, mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel,
				unresolved2Definiton);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject model2pm, EObject mMethod,
			EObject tMethodSignature, EObject tModel, EObject tMethodDefinition, EObject tMethodName, EObject mModel,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_12_2_corematch_blackFBBBBFB(tMethodSignature, tModel,
			...
			for (Object[] result3_black : UnresolvedMethodDeclarationImpl
				...
				Object[] result3_green = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(model2pm,
								tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel);
				...
				Object[] result4_bindingAndBlack = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, model2pm, tMethodSignature, tModel, tMethodDefinition, tMethodName,
								mModel);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[model2pm] = " + model2pm + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ModelToTypeGraph model2pm,
			...
			TMethod tMethodName, Model mModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject model2pm, EObject mMethod,
			EObject tMethodSignature, EObject tModel, EObject tMethodDefinition, EObject tMethodName, EObject mModel,
			EObject unresolved2Definiton) {
		ruleresult.registerObject("model2pm", model2pm);
		ruleresult.registerObject("mMethod", mMethod);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_31(EMoflonEdge _edge_methods) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_33(EMoflonEdge _edge_unresolvedItems) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mMethod,
						tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mMethod] = " + mMethod + ", " + "[tMethodSignature] = " + tMethodSignature + ", "
					+ "[tModel] = " + tModel + ", " + "[tMethodDefinition] = " + tMethodDefinition + ", "
					+ "[tMethodName] = " + tMethodName + ", " + "[mModel] = " + mModel + ", " + "[sourceMatch] = "
			...
			for (Object[] result5_black : UnresolvedMethodDeclarationImpl
				...
				Object[] result6_black = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(mMethod,
								tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mMethod] = " + mMethod
							+ ", " + "[tMethodSignature] = " + tMethodSignature + ", " + "[tModel] = " + tModel + ", "
							+ "[tMethodDefinition] = " + tMethodDefinition + ", " + "[tMethodName] = " + tMethodName
	...
	public CSP isApplicable_solveCsp_CC(org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod,
			TMethodSignature tMethodSignature, TypeGraph tModel, TMethodDefinition tMethodDefinition,
			TMethod tMethodName, Model mModel, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_TMETHODSIGNATURE_TYPEGRAPH_TMETHODDEFINITION_TMETHOD_MODEL:
				return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
						(ModelToTypeGraph) arguments.get(1), (TMethodSignature) arguments.get(2),
						(TypeGraph) arguments.get(3), (TMethodDefinition) arguments.get(4), (TMethod) arguments.get(5),
			...
			case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_31__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_31((EMoflonEdge) arguments.get(0));
			case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_33__EMOFLONEDGE:
			...
			case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_CC__UNRESOLVEDMETHODDECLARATION_TMETHODSIGNATURE_TYPEGRAPH_TMETHODDEFINITION_TMETHOD_MODEL_MATCH_MATCH:
				return isApplicable_solveCsp_CC((org.eclipse.modisco.java.UnresolvedMethodDeclaration) arguments.get(0),
						(TMethodSignature) arguments.get(1), (TypeGraph) arguments.get(2),
						(TMethodDefinition) arguments.get(3), (TMethod) arguments.get(4), (Model) arguments.get(5),
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenBFBFFFB(
		...
		return new Object[] { mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName, unresolved2Definiton,
				csp };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(
			...
			TMethodDefinition tMethodDefinition, TMethod tMethodName, MDefinitionToTMember unresolved2Definiton) {
		return new Object[] { mMethod, tMethodSignature, tMethodDefinition, tMethodName, unresolved2Definiton };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, mMethod, tMethodSignature, tMethodDefinition, tMethodName,
				unresolved2Definiton };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject model2pm, EObject mMethod, EObject tMethodSignature, EObject tModel,
			EObject tMethodDefinition, EObject tMethodName, EObject mModel, EObject unresolved2Definiton) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mMethod, EObject tMethodSignature, EObject tModel,
			EObject tMethodDefinition, EObject tMethodName, EObject mModel, EObject unresolved2Definiton) {
		...
		mModel__mMethod____unresolvedItems.setName(mModel__mMethod____unresolvedItems_name_prime);
		return new Object[] { ruleresult, mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel,
	...
	public static final void pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
			UnresolvedMethodDeclaration _this, PerformRuleResult ruleresult, EObject model2pm, EObject mMethod,
			EObject tMethodSignature, EObject tModel, EObject tMethodDefinition, EObject tMethodName, EObject mModel,
			EObject unresolved2Definiton) {
		_this.registerObjects_FWD(ruleresult, model2pm, mMethod, tMethodSignature, tModel, tMethodDefinition,
				tMethodName, mModel, unresolved2Definiton);
				...
				if (tmpTModel instanceof TypeGraph) {
					...
					if (tmpTMethodDefinition instanceof TMethodDefinition) {
						...
						if (tmpTMethodName instanceof TMethod) {
							...
							if (tmpMModel instanceof Model) {
								Model mModel = (Model) tmpMModel;
								return new Object[] { model2pm, tMethodSignature, tModel, tMethodDefinition,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
			ModelToTypeGraph model2pm, TMethodSignature tMethodSignature, TypeGraph tModel,
			TMethodDefinition tMethodDefinition, TMethod tMethodName, Model mModel, UnresolvedMethodDeclaration _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { model2pm, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel, csp,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_black = pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
					model2pm, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_greenFBBFB(
		...
		return new Object[] { mMethod, tMethodDefinition, mModel, unresolved2Definiton, csp };
	}
	...
	public static final void pattern_UnresolvedMethodDeclaration_11_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tMethodSignature, EObject tModel, EObject tMethodDefinition, EObject tMethodName, EObject mModel,
			EObject unresolved2Definiton) {
		_this.registerObjects_BWD(ruleresult, model2pm, mMethod, tMethodSignature, tModel, tMethodDefinition,
				tMethodName, mModel, unresolved2Definiton);
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_12_2_corematch_blackFBBBBFB(
		...
		for (ModelToTypeGraph model2pm : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(tModel,
			...
			if (mModel != null) {
				_result.add(new Object[] { model2pm, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel,
						match });
			}
			...
			if (tModel.equals(model2pm.getTarget())) {
				if (tMethodSignature.getDefinitions().contains(tMethodDefinition)) {
					if (tMethodName.getSignatures().contains(tMethodSignature)) {
						if (mModel.equals(model2pm.getSource())) {
							_result.add(new Object[] { model2pm, tMethodSignature, tModel, tMethodDefinition,
									tMethodName, mModel });
						}
					}
				}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(
		...
		tMethodSignature__tMethodName____method.setName(tMethodSignature__tMethodName____method_name_prime);
		model2pm__mModel____source.setName(model2pm__mModel____source_name_prime);
		return new Object[] { model2pm, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
			UnresolvedMethodDeclaration _this, IsApplicableMatch isApplicableMatch, ModelToTypeGraph model2pm,
			TMethodSignature tMethodSignature, TypeGraph tModel, TMethodDefinition tMethodDefinition,
			TMethod tMethodName, Model mModel) {
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, model2pm, tMethodSignature, tModel, tMethodDefinition,
					tMethodName, mModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_binding = pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, model2pm, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel);
		if (result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, model2pm, tMethodSignature, tModel,
						tMethodDefinition, tMethodName, mModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TMethod __DEC_tMethodSignature_method_2067 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_2067 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_2067)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_1B(
		...
		TAbstractType __DEC_tMethodSignature_returnType_632985 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_632985 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2BB(
		...
		TSignature __DEC_tMethodDefinition_signature_871674 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_871674 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_871674)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_3B(
		...
		TAbstractType __DEC_tMethodDefinition_returnType_494216 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_494216 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_4B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_326825 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_326825 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_5BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_definitions_565920 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_definitions_565920 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_definitions_565920)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_6BB(
		...
		TypeGraph __DEC_tMethodName_model_96584 = tMethodName.getModel();
		if (__DEC_tMethodName_model_96584 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_96584)) {
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_blackFFFFB(
		...
		if (tmpTModel instanceof TypeGraph) {
			...
			if (tmpTMethodName instanceof TMethod) {
				TMethod tMethodName = (TMethod) tmpTMethodName;
				if (tModel.getMethods().contains(tMethodName)) {
					if (pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_6BB(tMethodName,
							tModel) == null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_0B(
		...
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_120692 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_120692 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_560751 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_560751 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_499888 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_499888 != null) {
			return new Object[] { mMethod };
		}
				...
				if (tmpTModel instanceof TypeGraph) {
					...
					if (tmpTMethodDefinition instanceof TMethodDefinition) {
						...
						if (tmpTMethodName instanceof TMethod) {
							...
							if (tmpMModel instanceof Model) {
								Model mModel = (Model) tmpMModel;
								return new Object[] { mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TMethodSignature tMethodSignature,
			TypeGraph tModel, TMethodDefinition tMethodDefinition, TMethod tMethodName, Model mModel, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_black = pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
			...
			TMethodSignature tMethodSignature, TypeGraph tModel, TMethodDefinition tMethodDefinition,
			TMethod tMethodName, Model mModel, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mMethod, tMethodSignature, tModel, tMethodDefinition,
				tMethodName, mModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding = pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel, sourceMatch,
				targetMatch);
		if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName,
						mModel, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TMethodSignature tMethodSignature,
			TypeGraph tModel, TMethodDefinition tMethodDefinition, TMethod tMethodName, Model mModel, CCMatch ccMatch) {
		return new Object[] { mMethod, tMethodSignature, tModel, tMethodDefinition, tMethodName, mModel, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_781231 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_781231 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_802313 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_802313 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_70766 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_70766 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0BB(
			TMethodSignature tMethodSignature, TMethod tMethodName) {
		TMethod __DEC_tMethodSignature_method_878859 = tMethodSignature.getMethod();
		if (__DEC_tMethodSignature_method_878859 != null) {
			if (!tMethodName.equals(__DEC_tMethodSignature_method_878859)) {
				return new Object[] { tMethodSignature, tMethodName };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_711108 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_711108 != null) {
			return new Object[] { tMethodSignature };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_181162 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_181162 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_181162)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_3B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_844573 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_844573 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_4B(
			TMethodDefinition tMethodDefinition) {
		TModule __DEC_tMethodDefinition_contains_305527 = tMethodDefinition.getModule();
		if (__DEC_tMethodDefinition_contains_305527 != null) {
			return new Object[] { tMethodDefinition };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_5BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_definitions_898586 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_definitions_898586 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_definitions_898586)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_6BB(
			TMethod tMethodName, TypeGraph tModel) {
		TypeGraph __DEC_tMethodName_model_377942 = tMethodName.getModel();
		if (__DEC_tMethodName_model_377942 != null) {
			if (!tModel.equals(__DEC_tMethodName_model_377942)) {
				return new Object[] { tMethodName, tModel };
			}
		}
