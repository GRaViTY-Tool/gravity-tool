...
public class MethodInvocationTargetImpl extends AbstractRuleImpl implements MethodInvocationTarget {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, invocationToTAccess,
						tInvokedMember, invocation, mInvokedMemberToTInvokedMember, mInvokedMember, tAccess);
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, invocationToTAccess, tInvokedMember, invocation, mInvokedMemberToTInvokedMember,
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_2_3_findcontext_blackBBBBBB(invocationToTAccess, tInvokedMember,
							invocation, mInvokedMemberToTInvokedMember, mInvokedMember, tAccess)) {
				...
				Object[] result4_bindingAndBlack = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								invocationToTAccess, tInvokedMember, invocation, mInvokedMemberToTInvokedMember,
								mInvokedMember, tAccess);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			AbstractMethodDeclaration mInvokedMember, TAccess tAccess) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject invocationToTAccess, EObject tInvokedMember,
			EObject invocation, EObject mInvokedMemberToTInvokedMember, EObject mInvokedMember, EObject tAccess) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackFBBFBBBB(tInvokedMember, invocation,
							mInvokedMember, tAccess, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			Object[] result3_bindingAndBlack = MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							invocationToTAccess, tInvokedMember, invocation, mInvokedMemberToTInvokedMember,
							mInvokedMember, tAccess, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[invocationToTAccess] = "
						+ invocationToTAccess + ", " + "[tInvokedMember] = " + tInvokedMember + ", " + "[invocation] = "
						+ invocation + ", " + "[mInvokedMemberToTInvokedMember] = " + mInvokedMemberToTInvokedMember
						+ ", " + "[mInvokedMember] = " + mInvokedMember + ", " + "[tAccess] = " + tAccess + ", "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			AbstractMethodInvocationToTAccess invocationToTAccess, TMethodDefinition tInvokedMember,
			AbstractMethodInvocation invocation, MDefinitionToTMember mInvokedMemberToTInvokedMember,
			AbstractMethodDeclaration mInvokedMember, TAccess tAccess, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TMETHODDEFINITION_ABSTRACTMETHODINVOCATION_MDEFINITIONTOTMEMBER_ABSTRACTMETHODDECLARATION_TACCESS:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractMethodInvocationToTAccess) arguments.get(1), (TMethodDefinition) arguments.get(2),
					(AbstractMethodInvocation) arguments.get(3), (MDefinitionToTMember) arguments.get(4),
					(AbstractMethodDeclaration) arguments.get(5), (TAccess) arguments.get(6));
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TMETHODDEFINITION_ABSTRACTMETHODINVOCATION_MDEFINITIONTOTMEMBER_ABSTRACTMETHODDECLARATION_TACCESS:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TMETHODDEFINITION_ABSTRACTMETHODINVOCATION_MDEFINITIONTOTMEMBER_ABSTRACTMETHODDECLARATION_TACCESS_MODELGENERATORRULERESULT:
					...
					if (tmpMInvokedMemberToTInvokedMember instanceof MDefinitionToTMember) {
						...
						if (tmpMInvokedMember instanceof AbstractMethodDeclaration) {
							...
							if (tmpTAccess instanceof TAccess) {
								...
								return new Object[] { invocationToTAccess, tInvokedMember, invocation,
										mInvokedMemberToTInvokedMember, mInvokedMember, tAccess, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
			AbstractMethodInvocationToTAccess invocationToTAccess, TMethodDefinition tInvokedMember,
			AbstractMethodInvocation invocation, MDefinitionToTMember mInvokedMemberToTInvokedMember,
			AbstractMethodDeclaration mInvokedMember, TAccess tAccess, MethodInvocationTarget _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { invocationToTAccess, tInvokedMember, invocation, mInvokedMemberToTInvokedMember,
						mInvokedMember, tAccess, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationTarget_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodInvocationTarget_1_1_performtransformation_black = pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
					invocationToTAccess, tInvokedMember, invocation, mInvokedMemberToTInvokedMember, mInvokedMember,
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject mInvokedMemberToTInvokedMember, EObject mInvokedMember, EObject tAccess) {
	...
	public static final void pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tInvokedMember, EObject invocation, EObject mInvokedMemberToTInvokedMember, EObject mInvokedMember,
			EObject tAccess) {
		_this.registerObjects_FWD(ruleresult, invocationToTAccess, tInvokedMember, invocation,
				mInvokedMemberToTInvokedMember, mInvokedMember, tAccess);
		...
		for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAccess != null) {
				for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTInvokedMember instanceof TMethodDefinition) {
						TMethodDefinition tInvokedMember = (TMethodDefinition) tmpTInvokedMember;
						_result.add(new Object[] { invocationToTAccess, tInvokedMember, invocation,
								mInvokedMemberToTInvokedMember, mInvokedMember, tAccess, match });
					}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { invocationToTAccess, tInvokedMember, invocation, mInvokedMemberToTInvokedMember,
				mInvokedMember, tAccess, isApplicableMatch, invocationToTAccess__invocation____source,
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_2_4_solveCSP_binding = pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, invocationToTAccess, tInvokedMember, invocation,
				mInvokedMemberToTInvokedMember, mInvokedMember, tAccess);
	...
	public static final void pattern_MethodInvocationTarget_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tInvokedMember, EObject invocation, EObject mInvokedMemberToTInvokedMember, EObject mInvokedMember,
			EObject tAccess) {
		_this.registerObjects_BWD(ruleresult, invocationToTAccess, tInvokedMember, invocation,
				mInvokedMemberToTInvokedMember, mInvokedMember, tAccess);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackFBBFBBBB(
			TMethodDefinition tInvokedMember, AbstractMethodInvocation invocation,
			AbstractMethodDeclaration mInvokedMember, TAccess tAccess, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAccess.equals(invocationToTAccess.getTarget())) {
					for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mInvokedMember.equals(mInvokedMemberToTInvokedMember.getSource())) {
							_result.add(new Object[] { invocationToTAccess, tInvokedMember, invocation,
									mInvokedMemberToTInvokedMember, mInvokedMember, tAccess, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, invocationToTAccess, tInvokedMember,
				invocation, mInvokedMemberToTInvokedMember, mInvokedMember, tAccess, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, tInvokedMember, invocation,
					mInvokedMemberToTInvokedMember, mInvokedMember, tAccess, ruleResult };
		}
		return null;
	}
