...
public class MethodInvocationTargetImpl extends AbstractRuleImpl implements MethodInvocationTarget {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tAccess, invocation,
						tInvokedMember, invocationToTAccess, mInvokedMemberToTInvokedMember, mInvokedMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tAccess] = " + tAccess + ", " + "[invocation] = " + invocation + ", "
					+ "[tInvokedMember] = " + tInvokedMember + ", " + "[invocationToTAccess] = " + invocationToTAccess
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, tAccess, invocation, tInvokedMember, invocationToTAccess, mInvokedMemberToTInvokedMember,
				mInvokedMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_2_3_findcontext_blackBBBBBB(tAccess, invocation, tInvokedMember,
							invocationToTAccess, mInvokedMemberToTInvokedMember, mInvokedMember)) {
				...
				Object[] result4_bindingAndBlack = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								tAccess, invocation, tInvokedMember, invocationToTAccess,
								mInvokedMemberToTInvokedMember, mInvokedMember);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tAccess, EObject invocation,
			EObject tInvokedMember, EObject invocationToTAccess, EObject mInvokedMemberToTInvokedMember,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_12_3_findcontext_blackBBBBBB(tAccess, invocation, tInvokedMember,
							invocationToTAccess, mInvokedMemberToTInvokedMember, mInvokedMember)) {
				Object[] result3_green = MethodInvocationTargetImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_58(EMoflonEdge _edge_target) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_61(EMoflonEdge _edge_method) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackBBBFFBBB(tAccess, invocation,
							tInvokedMember, mInvokedMember, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			Object[] result3_bindingAndBlack = MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tAccess, invocation, tInvokedMember, invocationToTAccess, mInvokedMemberToTInvokedMember,
			...
			if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_29_5_checknacs_blackBBBBBB(tAccess, invocation, tInvokedMember,
								invocationToTAccess, mInvokedMemberToTInvokedMember, mInvokedMember);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAccess] = "
								+ tAccess + ", " + "[invocation] = " + invocation + ", " + "[tInvokedMember] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TACCESS_ABSTRACTMETHODINVOCATION_TMETHODDEFINITION_ABSTRACTMETHODINVOCATIONTOTACCESS_MDEFINITIONTOTMEMBER_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TACCESS_ABSTRACTMETHODINVOCATION_TMETHODDEFINITION_ABSTRACTMETHODINVOCATIONTOTACCESS_MDEFINITIONTOTMEMBER_ABSTRACTMETHODDECLARATION:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_BWD_EMOFLON_EDGE_58__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_58((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_FWD_EMOFLON_EDGE_61__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TACCESS_ABSTRACTMETHODINVOCATION_TMETHODDEFINITION_ABSTRACTMETHODINVOCATIONTOTACCESS_MDEFINITIONTOTMEMBER_ABSTRACTMETHODDECLARATION_MODELGENERATORRULERESULT:
					...
					if (tmpInvocationToTAccess instanceof AbstractMethodInvocationToTAccess) {
						...
						if (tmpMInvokedMemberToTInvokedMember instanceof MDefinitionToTMember) {
							...
							if (tmpMInvokedMember instanceof AbstractMethodDeclaration) {
								...
								return new Object[] { tAccess, invocation, tInvokedMember, invocationToTAccess,
										mInvokedMemberToTInvokedMember, mInvokedMember, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tAccess, invocation, tInvokedMember, invocationToTAccess,
						mInvokedMemberToTInvokedMember, mInvokedMember, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject invocationToTAccess, EObject mInvokedMemberToTInvokedMember, EObject mInvokedMember) {
	...
	public static final void pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tInvokedMember, EObject invocationToTAccess, EObject mInvokedMemberToTInvokedMember,
			EObject mInvokedMember) {
		_this.registerObjects_FWD(ruleresult, tAccess, invocation, tInvokedMember, invocationToTAccess,
				mInvokedMemberToTInvokedMember, mInvokedMember);
		...
		for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAccess != null) {
				for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTInvokedMember instanceof TMethodDefinition) {
						TMethodDefinition tInvokedMember = (TMethodDefinition) tmpTInvokedMember;
						_result.add(new Object[] { tAccess, invocation, tInvokedMember, invocationToTAccess,
								mInvokedMemberToTInvokedMember, mInvokedMember, match });
					}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(TAccess tAccess,
		...
		invocation__mInvokedMember____method.setName(invocation__mInvokedMember____method_name_prime);
		mInvokedMember__invocation____usages.setName(mInvokedMember__invocation____usages_name_prime);
		return new Object[] { tAccess, invocation, tInvokedMember, invocationToTAccess, mInvokedMemberToTInvokedMember,
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractMethodInvocationToTAccess invocationToTAccess, MDefinitionToTMember mInvokedMemberToTInvokedMember,
			AbstractMethodDeclaration mInvokedMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tAccess, invocation, tInvokedMember,
				invocationToTAccess, mInvokedMemberToTInvokedMember, mInvokedMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAccess, invocation, tInvokedMember,
					invocationToTAccess, mInvokedMemberToTInvokedMember, mInvokedMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_2_4_solveCSP_binding = pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tAccess, invocation, tInvokedMember, invocationToTAccess,
				mInvokedMemberToTInvokedMember, mInvokedMember);
	...
	public static final void pattern_MethodInvocationTarget_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tInvokedMember, EObject invocationToTAccess, EObject mInvokedMemberToTInvokedMember,
			EObject mInvokedMember) {
		_this.registerObjects_BWD(ruleresult, tAccess, invocation, tInvokedMember, invocationToTAccess,
				mInvokedMemberToTInvokedMember, mInvokedMember);
	...
	public static final Object[] pattern_MethodInvocationTarget_12_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractMethodInvocationToTAccess invocationToTAccess, MDefinitionToTMember mInvokedMemberToTInvokedMember,
			AbstractMethodDeclaration mInvokedMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tAccess, invocation, tInvokedMember,
				invocationToTAccess, mInvokedMemberToTInvokedMember, mInvokedMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAccess, invocation, tInvokedMember,
			...
			for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAccess.equals(invocationToTAccess.getTarget())) {
					for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mInvokedMember.equals(mInvokedMemberToTInvokedMember.getSource())) {
							_result.add(new Object[] { tAccess, invocation, tInvokedMember, invocationToTAccess,
									mInvokedMemberToTInvokedMember, mInvokedMember, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tAccess, invocation, tInvokedMember,
				invocationToTAccess, mInvokedMemberToTInvokedMember, mInvokedMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tAccess, invocation, tInvokedMember,
					invocationToTAccess, mInvokedMemberToTInvokedMember, mInvokedMember, ruleResult };
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_29_3_solveCSP_binding = pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tAccess, invocation, tInvokedMember, invocationToTAccess,
				mInvokedMemberToTInvokedMember, mInvokedMember, ruleResult);
