...
public class MethodInvocationTargetImpl extends AbstractRuleImpl implements MethodInvocationTarget {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tInvokedMember,
						mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess, invocation);
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess,
				tAccess, invocation);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_2_3_findcontext_blackBBBBBB(tInvokedMember,
							mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess, invocation)) {
				Object[] result3_green = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(tInvokedMember,
								mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess,
								invocation);
				...
				Object[] result4_bindingAndBlack = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess,
								tAccess, invocation);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tInvokedMember,
			EObject mInvokedMemberToTInvokedMember, EObject mInvokedMember, EObject invocationToTAccess,
			EObject tAccess, EObject invocation) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_12_2_corematch_blackBFFFBFB(tInvokedMember, tAccess, match)) {
			MDefinitionToTMember mInvokedMemberToTInvokedMember = (MDefinitionToTMember) result2_black[1];
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_12_3_findcontext_blackBBBBBB(tInvokedMember,
							mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess, invocation)) {
				Object[] result3_green = MethodInvocationTargetImpl
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tInvokedMember,
			EObject mInvokedMemberToTInvokedMember, EObject mInvokedMember, EObject invocationToTAccess,
			EObject tAccess, EObject invocation) {
		ruleresult.registerObject("tInvokedMember", tInvokedMember);
		ruleresult.registerObject("mInvokedMemberToTInvokedMember", mInvokedMemberToTInvokedMember);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_190(EMoflonEdge _edge_target) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_198(EMoflonEdge _edge_method) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackBFBFBBBB(tInvokedMember, mInvokedMember,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			TAccess tAccess = (TAccess) result2_black[6];
			...
			if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_29_5_checknacs_blackBBBBBB(tInvokedMember,
								mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess,
								invocation);
				if (result5_black != null) {

					Object[] result6_black = MethodInvocationTargetImpl
							.pattern_MethodInvocationTarget_29_6_perform_blackBBBBBBB(tInvokedMember,
									mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethodDefinition tInvokedMember,
			MDefinitionToTMember mInvokedMemberToTInvokedMember, AbstractMethodDeclaration mInvokedMember,
			AbstractMethodInvocationToTAccess invocationToTAccess, TAccess tAccess, AbstractMethodInvocation invocation,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATIONTOTACCESS_TACCESS_ABSTRACTMETHODINVOCATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TMethodDefinition) arguments.get(1),
					(MDefinitionToTMember) arguments.get(2), (AbstractMethodDeclaration) arguments.get(3),
					(AbstractMethodInvocationToTAccess) arguments.get(4), (TAccess) arguments.get(5),
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATIONTOTACCESS_TACCESS_ABSTRACTMETHODINVOCATION:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_BWD_EMOFLON_EDGE_190__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_190((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_FWD_EMOFLON_EDGE_198__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATIONTOTACCESS_TACCESS_ABSTRACTMETHODINVOCATION_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					...
					(TAccess) arguments.get(5), (AbstractMethodInvocation) arguments.get(6),
					...
					if (tmpInvocationToTAccess instanceof AbstractMethodInvocationToTAccess) {
						...
						if (tmpTAccess instanceof TAccess) {
							...
							if (tmpInvocation instanceof AbstractMethodInvocation) {
								...
								return new Object[] { tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember,
										invocationToTAccess, tAccess, invocation, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
			...
			TAccess tAccess, AbstractMethodInvocation invocation, MethodInvocationTarget _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember,
						invocationToTAccess, tAccess, invocation, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationTarget_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodInvocationTarget_1_1_performtransformation_black = pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
					tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess,
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tInvokedMember, EObject mInvokedMemberToTInvokedMember,
			EObject mInvokedMember, EObject invocationToTAccess, EObject tAccess, EObject invocation) {
	...
	public static final void pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(
			MethodInvocationTarget _this, PerformRuleResult ruleresult, EObject tInvokedMember,
			EObject mInvokedMemberToTInvokedMember, EObject mInvokedMember, EObject invocationToTAccess,
			EObject tAccess, EObject invocation) {
		_this.registerObjects_FWD(ruleresult, tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember,
		...
		for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInvokedMember instanceof TMethodDefinition) {
				...
				for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAccess != null) {
						_result.add(new Object[] { tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember,
								invocationToTAccess, tAccess, invocation, match });
					}
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_2_3_findcontext_blackBBBBBB(
			TMethodDefinition tInvokedMember, MDefinitionToTMember mInvokedMemberToTInvokedMember,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocationToTAccess invocationToTAccess,
			TAccess tAccess, AbstractMethodInvocation invocation) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		invocation__mInvokedMember____method.setName(invocation__mInvokedMember____method_name_prime);
		mInvokedMember__invocation____usages.setName(mInvokedMember__invocation____usages_name_prime);
		return new Object[] { tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess,
				tAccess, invocation, isApplicableMatch, mInvokedMemberToTInvokedMember__tInvokedMember____target,
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractMethodInvocationToTAccess invocationToTAccess, TAccess tAccess,
			AbstractMethodInvocation invocation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tInvokedMember,
				mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess, invocation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInvokedMember, mInvokedMemberToTInvokedMember,
					mInvokedMember, invocationToTAccess, tAccess, invocation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_2_4_solveCSP_binding = pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember,
				invocationToTAccess, tAccess, invocation);
	...
	public static final void pattern_MethodInvocationTarget_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mInvokedMemberToTInvokedMember, EObject mInvokedMember, EObject invocationToTAccess,
			EObject tAccess, EObject invocation) {
		_this.registerObjects_BWD(ruleresult, tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember,
				invocationToTAccess, tAccess, invocation);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_12_2_corematch_blackBFFFBFB(
	...
	public static final Object[] pattern_MethodInvocationTarget_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess,
				tAccess, invocation, isApplicableMatch, mInvokedMemberToTInvokedMember__tInvokedMember____target,
				mInvokedMemberToTInvokedMember__mInvokedMember____source, invocationToTAccess__tAccess____target,
				invocationToTAccess__invocation____source, tAccess__tInvokedMember____target,
				tInvokedMember__tAccess____accessedBy };
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_12_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractMethodInvocationToTAccess invocationToTAccess, TAccess tAccess,
			AbstractMethodInvocation invocation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tInvokedMember,
				mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess, invocation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInvokedMember, mInvokedMemberToTInvokedMember,
			...
			for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mInvokedMember.equals(mInvokedMemberToTInvokedMember.getSource())) {
					for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (invocation.equals(invocationToTAccess.getSource())) {
							_result.add(new Object[] { tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember,
									invocationToTAccess, tAccess, invocation, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tInvokedMember,
				mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess, tAccess, invocation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInvokedMember, mInvokedMemberToTInvokedMember,
					mInvokedMember, invocationToTAccess, tAccess, invocation, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_29_3_solveCSP_binding = pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember,
				invocationToTAccess, tAccess, invocation, ruleResult);
	...
	public static final Object[] pattern_MethodInvocationTarget_29_6_perform_blackBBBBBBB(
			TMethodDefinition tInvokedMember, MDefinitionToTMember mInvokedMemberToTInvokedMember,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocationToTAccess invocationToTAccess,
			TAccess tAccess, AbstractMethodInvocation invocation, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tInvokedMember, mInvokedMemberToTInvokedMember, mInvokedMember, invocationToTAccess,
				tAccess, invocation, ruleResult };
	}
