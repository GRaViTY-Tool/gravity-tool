...
public class MethodInvocationTargetImpl extends AbstractRuleImpl implements MethodInvocationTarget {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember, invocationToTAccess,
						tInvokedMember);
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember, invocationToTAccess,
				tInvokedMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_2_3_findcontext_blackBBBBBB(mInvokedMemberToTInvokedMember, tAccess,
							invocation, mInvokedMember, invocationToTAccess, tInvokedMember)) {
				Object[] result3_green = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(
								mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			MDefinitionToTMember mInvokedMemberToTInvokedMember, TAccess tAccess, AbstractMethodInvocation invocation,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mInvokedMemberToTInvokedMember,
			EObject tAccess, EObject invocation, EObject mInvokedMember, EObject invocationToTAccess,
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_12_3_findcontext_blackBBBBBB(mInvokedMemberToTInvokedMember,
							tAccess, invocation, mInvokedMember, invocationToTAccess, tInvokedMember)) {
				Object[] result3_green = MethodInvocationTargetImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_592(EMoflonEdge _edge_target) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_638(EMoflonEdge _edge_method) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackFBBBFBBB(tAccess, invocation,
							mInvokedMember, tInvokedMember, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ mInvokedMemberToTInvokedMember + ", " + "[tAccess] = " + tAccess + ", " + "[invocation] = "
						+ invocation + ", " + "[mInvokedMember] = " + mInvokedMember + ", " + "[invocationToTAccess] = "
						+ invocationToTAccess + ", " + "[tInvokedMember] = " + tInvokedMember + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TACCESS_ABSTRACTMETHODINVOCATION_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATIONTOTACCESS_TMETHODDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (TAccess) arguments.get(2),
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TACCESS_ABSTRACTMETHODINVOCATION_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATIONTOTACCESS_TMETHODDEFINITION:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_BWD_EMOFLON_EDGE_592__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_592((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_FWD_EMOFLON_EDGE_638__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_638((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_TACCESS_ABSTRACTMETHODINVOCATION_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATIONTOTACCESS_TMETHODDEFINITION_MODELGENERATORRULERESULT:
					...
					if (tmpMInvokedMember instanceof AbstractMethodDeclaration) {
						...
						if (tmpInvocationToTAccess instanceof AbstractMethodInvocationToTAccess) {
							...
							if (tmpTInvokedMember instanceof TMethodDefinition) {
								...
								return new Object[] { mInvokedMemberToTInvokedMember, tAccess, invocation,
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember,
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mInvokedMemberToTInvokedMember, EObject tAccess, EObject invocation,
	...
	public static final void pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tAccess, EObject invocation, EObject mInvokedMember, EObject invocationToTAccess,
			EObject tInvokedMember) {
		_this.registerObjects_FWD(ruleresult, mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember,
				invocationToTAccess, tInvokedMember);
		...
		for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInvokedMember instanceof TMethodDefinition) {
				...
				for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAccess != null) {
						_result.add(new Object[] { mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember,
				...
				if (tAccess.equals(invocationToTAccess.getTarget())) {
					if (invocation.equals(invocationToTAccess.getSource())) {
						if (tInvokedMember.equals(mInvokedMemberToTInvokedMember.getTarget())) {
							_result.add(new Object[] { mInvokedMemberToTInvokedMember, tAccess, invocation,
	...
	public static final Object[] pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember, invocationToTAccess,
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInvokedMemberToTInvokedMember, tAccess, invocation,
					mInvokedMember, invocationToTAccess, tInvokedMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_2_4_solveCSP_binding = pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember,
				invocationToTAccess, tInvokedMember);
		if (result_pattern_MethodInvocationTarget_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodInvocationTarget_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mInvokedMemberToTInvokedMember, tAccess,
						invocation, mInvokedMember, invocationToTAccess, tInvokedMember };
			}
		}
		return null;
	...
	public static final void pattern_MethodInvocationTarget_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tAccess, EObject invocation, EObject mInvokedMember, EObject invocationToTAccess,
			EObject tInvokedMember) {
		_this.registerObjects_BWD(ruleresult, mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember,
				invocationToTAccess, tInvokedMember);
	...
	public static final Object[] pattern_MethodInvocationTarget_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		mInvokedMemberToTInvokedMember__tInvokedMember____target
				.setName(mInvokedMemberToTInvokedMember__tInvokedMember____target_name_prime);
		return new Object[] { mInvokedMemberToTInvokedMember, tAccess, invocation, mInvokedMember, invocationToTAccess,
				tInvokedMember, isApplicableMatch, mInvokedMemberToTInvokedMember__mInvokedMember____source,
				tAccess__tInvokedMember____target, tInvokedMember__tAccess____accessedBy,
				invocationToTAccess__tAccess____target, invocationToTAccess__invocation____source,
				mInvokedMemberToTInvokedMember__tInvokedMember____target };
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mInvokedMemberToTInvokedMember,
				tAccess, invocation, mInvokedMember, invocationToTAccess, tInvokedMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInvokedMemberToTInvokedMember, tAccess, invocation,
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		if (result_pattern_MethodInvocationTarget_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_MethodInvocationTarget_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mInvokedMemberToTInvokedMember, tAccess,
						invocation, mInvokedMember, invocationToTAccess, tInvokedMember, ruleResult };
			}
		}
		return null;
	}
