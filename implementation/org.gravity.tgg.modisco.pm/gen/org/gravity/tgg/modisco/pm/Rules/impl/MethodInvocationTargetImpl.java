...
public class MethodInvocationTargetImpl extends AbstractRuleImpl implements MethodInvocationTarget {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mInvokedMember,
						tAccess, invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember);
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				mInvokedMember, tAccess, invocation, tInvokedMember);
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, mInvokedMember, tAccess, invocationToTAccess, mInvokedMemberToTInvokedMember, invocation,
				tInvokedMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_2_2_corematch_blackBFFFBFB(mInvokedMember, invocation, match)) {
			...
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_2_3_findcontext_blackBBBBBB(mInvokedMember, tAccess,
							invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember)) {
				Object[] result3_green = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(mInvokedMember, tAccess,
								invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember);
				...
				Object[] result4_bindingAndBlack = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								mInvokedMember, tAccess, invocationToTAccess, mInvokedMemberToTInvokedMember,
								invocation, tInvokedMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mInvokedMember] = "
							+ mInvokedMember + ", " + "[tAccess] = " + tAccess + ", " + "[invocationToTAccess] = "
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mInvokedMember, EObject tAccess,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_12_2_corematch_blackFBFFFBB(tAccess, tInvokedMember, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_12_3_findcontext_blackBBBBBB(mInvokedMember, tAccess,
							invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember)) {
				Object[] result3_green = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_12_3_findcontext_greenBBBBBBFFFFFFF(mInvokedMember, tAccess,
								invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mInvokedMember, EObject tAccess,
			EObject invocationToTAccess, EObject mInvokedMemberToTInvokedMember, EObject invocation,
			EObject tInvokedMember) {
		ruleresult.registerObject("mInvokedMember", mInvokedMember);
		ruleresult.registerObject("tAccess", tAccess);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_26(EMoflonEdge _edge_target) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_26(EMoflonEdge _edge_method) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackBBFFBBBB(mInvokedMember, tAccess,
							invocation, tInvokedMember, sourceMatch, targetMatch)) {
				...
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mInvokedMember] = "
							+ mInvokedMember + ", " + "[tAccess] = " + tAccess + ", " + "[invocation] = " + invocation
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			Object[] result3_bindingAndBlack = MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mInvokedMember, tAccess, invocationToTAccess, mInvokedMemberToTInvokedMember, invocation,
			...
			if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_29_5_checknacs_blackBBBBBB(mInvokedMember, tAccess,
								invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember);
				if (result5_black != null) {

					Object[] result6_black = MethodInvocationTargetImpl
							.pattern_MethodInvocationTarget_29_6_perform_blackBBBBBBB(mInvokedMember, tAccess,
									invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember,
									ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mInvokedMember] = "
					...
					MethodInvocationTargetImpl.pattern_MethodInvocationTarget_29_6_perform_greenBBBBB(mInvokedMember,
							tAccess, invocation, tInvokedMember, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTMETHODDECLARATION_TACCESS_ABSTRACTMETHODINVOCATIONTOTACCESS_MDEFINITIONTOTMEMBER_ABSTRACTMETHODINVOCATION_TMETHODDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractMethodDeclaration) arguments.get(1), (TAccess) arguments.get(2),
					(AbstractMethodInvocationToTAccess) arguments.get(3), (MDefinitionToTMember) arguments.get(4),
					(AbstractMethodInvocation) arguments.get(5), (TMethodDefinition) arguments.get(6));
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODDECLARATION_TACCESS_ABSTRACTMETHODINVOCATIONTOTACCESS_MDEFINITIONTOTMEMBER_ABSTRACTMETHODINVOCATION_TMETHODDEFINITION:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_BWD_EMOFLON_EDGE_26__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_26((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_FWD_EMOFLON_EDGE_26__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_CC__ABSTRACTMETHODDECLARATION_TACCESS_ABSTRACTMETHODINVOCATION_TMETHODDEFINITION_MATCH_MATCH:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODDECLARATION_TACCESS_ABSTRACTMETHODINVOCATIONTOTACCESS_MDEFINITIONTOTMEMBER_ABSTRACTMETHODINVOCATION_TMETHODDEFINITION_MODELGENERATORRULERESULT:
					...
					if (tmpMInvokedMemberToTInvokedMember instanceof MDefinitionToTMember) {
						...
						if (tmpInvocation instanceof AbstractMethodInvocation) {
							...
							if (tmpTInvokedMember instanceof TMethodDefinition) {
								...
								return new Object[] { mInvokedMember, tAccess, invocationToTAccess,
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mInvokedMember, tAccess, invocationToTAccess, mInvokedMemberToTInvokedMember,
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mInvokedMember, EObject tAccess, EObject invocationToTAccess,
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject mInvokedMember, EObject tAccess, EObject invocation,
			EObject tInvokedMember) {
		...
		invocation__mInvokedMember____method.setName(invocation__mInvokedMember____method_name_prime);
		mInvokedMember__invocation____usages.setName(mInvokedMember__invocation____usages_name_prime);
		return new Object[] { ruleresult, mInvokedMember, tAccess, invocation, tInvokedMember,
	...
	public static final void pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(
			MethodInvocationTarget _this, PerformRuleResult ruleresult, EObject mInvokedMember, EObject tAccess,
			EObject invocationToTAccess, EObject mInvokedMemberToTInvokedMember, EObject invocation,
			EObject tInvokedMember) {
		_this.registerObjects_FWD(ruleresult, mInvokedMember, tAccess, invocationToTAccess,
		...
		for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInvokedMember instanceof TMethodDefinition) {
				...
				for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAccess != null) {
						_result.add(new Object[] { mInvokedMember, tAccess, invocationToTAccess,
	...
	public static final Object[] pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mInvokedMember, tAccess, invocationToTAccess, mInvokedMemberToTInvokedMember, invocation,
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
			...
			MDefinitionToTMember mInvokedMemberToTInvokedMember, AbstractMethodInvocation invocation,
			TMethodDefinition tInvokedMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mInvokedMember, tAccess,
				invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInvokedMember, tAccess, invocationToTAccess,
					mInvokedMemberToTInvokedMember, invocation, tInvokedMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_2_4_solveCSP_binding = pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mInvokedMember, tAccess, invocationToTAccess, mInvokedMemberToTInvokedMember,
				invocation, tInvokedMember);
	...
	public static final void pattern_MethodInvocationTarget_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject invocationToTAccess, EObject mInvokedMemberToTInvokedMember, EObject invocation,
			EObject tInvokedMember) {
		_this.registerObjects_BWD(ruleresult, mInvokedMember, tAccess, invocationToTAccess,
				mInvokedMemberToTInvokedMember, invocation, tInvokedMember);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_12_2_corematch_blackFBFFFBB(TAccess tAccess,
	...
	public static final Object[] pattern_MethodInvocationTarget_12_4_solveCSP_bindingFBBBBBBBB(
			...
			MDefinitionToTMember mInvokedMemberToTInvokedMember, AbstractMethodInvocation invocation,
			TMethodDefinition tInvokedMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mInvokedMember, tAccess,
				invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInvokedMember, tAccess, invocationToTAccess,
		...
		if (tmpMInvokedMember instanceof AbstractMethodDeclaration) {
			...
			if (tmpTAccess instanceof TAccess) {
				...
				if (tmpInvocation instanceof AbstractMethodInvocation) {
					...
					if (tmpTInvokedMember instanceof TMethodDefinition) {
						TMethodDefinition tInvokedMember = (TMethodDefinition) tmpTInvokedMember;
						return new Object[] { mInvokedMember, tAccess, invocation, tInvokedMember, sourceMatch,
								targetMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_blackBBBBBB(
			AbstractMethodDeclaration mInvokedMember, TAccess tAccess, AbstractMethodInvocation invocation,
			TMethodDefinition tInvokedMember, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mInvokedMember, tAccess, invocation, tInvokedMember, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_black = pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_blackBBBBBB(
					mInvokedMember, tAccess, invocation, tInvokedMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodInvocationTarget_24_3_solvecsp_bindingFBBBBBBB(
			...
			AbstractMethodInvocation invocation, TMethodDefinition tInvokedMember, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mInvokedMember, tAccess, invocation, tInvokedMember,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mInvokedMember, tAccess, invocation, tInvokedMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_24_3_solvecsp_binding = pattern_MethodInvocationTarget_24_3_solvecsp_bindingFBBBBBBB(
				_this, mInvokedMember, tAccess, invocation, tInvokedMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodInvocationTarget_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { mInvokedMember, tAccess, invocation, tInvokedMember, ccMatch };
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mInvokedMember, tAccess,
				invocationToTAccess, mInvokedMemberToTInvokedMember, invocation, tInvokedMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mInvokedMember, tAccess, invocationToTAccess,
	...
	public static final Object[] pattern_MethodInvocationTarget_29_6_perform_greenBBBBB(
		...
		return new Object[] { mInvokedMember, tAccess, invocation, tInvokedMember, ruleResult };
	}
