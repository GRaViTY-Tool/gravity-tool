...
public class MethodInvocationTargetImpl extends AbstractRuleImpl implements MethodInvocationTarget {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		TMethodDefinition tInvokedMember = (TMethodDefinition) result1_bindingAndBlack[2];
		TAccess tAccess = (TAccess) result1_bindingAndBlack[3];
		...
		Object[] result3_black = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, invocation,
						mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember, invocationToTAccess);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[invocation] = " + invocation + ", " + "[mInvokedMemberToTInvokedMember] = "
					+ mInvokedMemberToTInvokedMember + ", " + "[tInvokedMember] = " + tInvokedMember + ", "
					+ "[tAccess] = " + tAccess + ", " + "[mInvokedMember] = " + mInvokedMember + ", "
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				invocation, tInvokedMember, tAccess, mInvokedMember);
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
				invocationToTAccess);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_2_2_corematch_blackBFFFBFB(invocation, mInvokedMember, match)) {
			MDefinitionToTMember mInvokedMemberToTInvokedMember = (MDefinitionToTMember) result2_black[1];
			TMethodDefinition tInvokedMember = (TMethodDefinition) result2_black[2];
			...
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_2_3_findcontext_blackBBBBBB(invocation,
							mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
							invocationToTAccess)) {
				Object[] result3_green = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(invocation,
								mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
								invocationToTAccess);
				...
				Object[] result4_bindingAndBlack = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
								invocationToTAccess);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AbstractMethodInvocation invocation,
			MDefinitionToTMember mInvokedMemberToTInvokedMember, TMethodDefinition tInvokedMember, TAccess tAccess,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocationToTAccess invocationToTAccess) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject invocation,
			EObject mInvokedMemberToTInvokedMember, EObject tInvokedMember, EObject tAccess, EObject mInvokedMember,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, invocation,
						mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember, invocationToTAccess);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[invocation] = " + invocation + ", " + "[mInvokedMemberToTInvokedMember] = "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_12_2_corematch_blackFFBBFFB(tInvokedMember, tAccess, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_12_3_findcontext_blackBBBBBB(invocation,
							mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
							invocationToTAccess)) {
				Object[] result3_green = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_12_3_findcontext_greenBBBBBBFFFFFFF(invocation,
								mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
								invocationToTAccess);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge mInvokedMemberToTInvokedMember__tInvokedMember____target = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge tAccess__tInvokedMember____target = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tInvokedMember__tAccess____accessedBy = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mInvokedMemberToTInvokedMember__mInvokedMember____source = (EMoflonEdge) result3_green[10];
				//nothing EMoflonEdge invocationToTAccess__invocation____source = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge invocationToTAccess__tAccess____target = (EMoflonEdge) result3_green[12];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject invocation,
			EObject mInvokedMemberToTInvokedMember, EObject tInvokedMember, EObject tAccess, EObject mInvokedMember,
			EObject invocationToTAccess) {
		ruleresult.registerObject("invocation", invocation);
		ruleresult.registerObject("mInvokedMemberToTInvokedMember", mInvokedMemberToTInvokedMember);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_205(EMoflonEdge _edge_target) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_213(EMoflonEdge _edge_method) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, invocation, tInvokedMember,
						tAccess, mInvokedMember, sourceMatch, targetMatch);
		...
		if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackBFBBBFBB(invocation, tInvokedMember,
							tAccess, mInvokedMember, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_24_6_createcorrespondence_blackBBBBB(invocation, tInvokedMember,
								tAccess, mInvokedMember, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AbstractMethodInvocation invocation, TMethodDefinition tInvokedMember,
			TAccess tAccess, AbstractMethodDeclaration mInvokedMember, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_29_5_checknacs_blackBBBBBB(invocation,
								mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
								invocationToTAccess);
				if (result5_black != null) {

					Object[] result6_black = MethodInvocationTargetImpl
							.pattern_MethodInvocationTarget_29_6_perform_blackBBBBBBB(invocation,
									mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
									invocationToTAccess, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[invocation] = "
								+ invocation + ", " + "[mInvokedMemberToTInvokedMember] = "
								+ mInvokedMemberToTInvokedMember + ", " + "[tInvokedMember] = " + tInvokedMember + ", "
								+ "[tAccess] = " + tAccess + ", " + "[mInvokedMember] = " + mInvokedMember + ", "
					...
					MethodInvocationTargetImpl.pattern_MethodInvocationTarget_29_6_perform_greenBBBBB(invocation,
							tInvokedMember, tAccess, mInvokedMember, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, AbstractMethodInvocation invocation,
			MDefinitionToTMember mInvokedMemberToTInvokedMember, TMethodDefinition tInvokedMember, TAccess tAccess,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocationToTAccess invocationToTAccess,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATION_MDEFINITIONTOTMEMBER_TMETHODDEFINITION_TACCESS_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATIONTOTACCESS:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractMethodInvocation) arguments.get(1), (MDefinitionToTMember) arguments.get(2),
					(TMethodDefinition) arguments.get(3), (TAccess) arguments.get(4),
					(AbstractMethodDeclaration) arguments.get(5), (AbstractMethodInvocationToTAccess) arguments.get(6));
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATION_MDEFINITIONTOTMEMBER_TMETHODDEFINITION_TACCESS_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATIONTOTACCESS:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_BWD_EMOFLON_EDGE_205__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_205((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_FWD_EMOFLON_EDGE_213__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_CC__ABSTRACTMETHODINVOCATION_TMETHODDEFINITION_TACCESS_ABSTRACTMETHODDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((AbstractMethodInvocation) arguments.get(0),
					(TMethodDefinition) arguments.get(1), (TAccess) arguments.get(2),
					(AbstractMethodDeclaration) arguments.get(3), (Match) arguments.get(4), (Match) arguments.get(5));
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATION_MDEFINITIONTOTMEMBER_TMETHODDEFINITION_TACCESS_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATIONTOTACCESS_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_bindingFFFFFFB(
		...
		EObject _localVariable_2 = isApplicableMatch.getObject("tInvokedMember");
					...
					if (tmpTAccess instanceof TAccess) {
						...
						if (tmpMInvokedMember instanceof AbstractMethodDeclaration) {
							...
							if (tmpInvocationToTAccess instanceof AbstractMethodInvocationToTAccess) {
								...
								return new Object[] { invocation, mInvokedMemberToTInvokedMember, tInvokedMember,
										tAccess, mInvokedMember, invocationToTAccess, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
			AbstractMethodInvocation invocation, MDefinitionToTMember mInvokedMemberToTInvokedMember,
			TMethodDefinition tInvokedMember, TAccess tAccess, AbstractMethodDeclaration mInvokedMember,
			AbstractMethodInvocationToTAccess invocationToTAccess, MethodInvocationTarget _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess,
						mInvokedMember, invocationToTAccess, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationTarget_1_1_performtransformation_binding != null) {
			AbstractMethodInvocation invocation = (AbstractMethodInvocation) result_pattern_MethodInvocationTarget_1_1_performtransformation_binding[0];
			...
			TMethodDefinition tInvokedMember = (TMethodDefinition) result_pattern_MethodInvocationTarget_1_1_performtransformation_binding[2];
			TAccess tAccess = (TAccess) result_pattern_MethodInvocationTarget_1_1_performtransformation_binding[3];
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject invocation, EObject mInvokedMemberToTInvokedMember,
			EObject tInvokedMember, EObject tAccess, EObject mInvokedMember, EObject invocationToTAccess) {
															...
															if (!invocationToTAccess.equals(tAccess)) {
																if (!invocationToTAccess.equals(mInvokedMember)) {
																	return new Object[] { ruleresult, invocation,
																			...
																			tInvokedMember, tAccess, mInvokedMember,
																			invocationToTAccess };
																}
															}
														}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject invocation, EObject tInvokedMember, EObject tAccess,
		...
		return new Object[] { ruleresult, invocation, tInvokedMember, tAccess, mInvokedMember,
	...
	public static final void pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(
			MethodInvocationTarget _this, PerformRuleResult ruleresult, EObject invocation,
			EObject mInvokedMemberToTInvokedMember, EObject tInvokedMember, EObject tAccess, EObject mInvokedMember,
			EObject invocationToTAccess) {
		_this.registerObjects_FWD(ruleresult, invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess,
				mInvokedMember, invocationToTAccess);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_2_2_corematch_blackBFFFBFB(
		...
		for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInvokedMember instanceof TMethodDefinition) {
				...
				for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAccess != null) {
						_result.add(new Object[] { invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess,
								mInvokedMember, invocationToTAccess, match });
					}
				...
				if (mInvokedMember.equals(mInvokedMemberToTInvokedMember.getSource())) {
					if (invocation.equals(invocationToTAccess.getSource())) {
						if (tAccess.equals(invocationToTAccess.getTarget())) {
							_result.add(new Object[] { invocation, mInvokedMemberToTInvokedMember, tInvokedMember,
									tAccess, mInvokedMember, invocationToTAccess });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
				invocationToTAccess, isApplicableMatch, invocation__mInvokedMember____method,
				mInvokedMember__invocation____usages, mInvokedMemberToTInvokedMember__tInvokedMember____target,
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
			MethodInvocationTarget _this, IsApplicableMatch isApplicableMatch, AbstractMethodInvocation invocation,
			MDefinitionToTMember mInvokedMemberToTInvokedMember, TMethodDefinition tInvokedMember, TAccess tAccess,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocationToTAccess invocationToTAccess) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, invocation,
				mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember, invocationToTAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocation, mInvokedMemberToTInvokedMember,
					tInvokedMember, tAccess, mInvokedMember, invocationToTAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_2_4_solveCSP_binding = pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess,
				mInvokedMember, invocationToTAccess);
	...
	public static final Object[] pattern_MethodInvocationTarget_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationTarget_11_1_performtransformation_binding != null) {
			AbstractMethodInvocation invocation = (AbstractMethodInvocation) result_pattern_MethodInvocationTarget_11_1_performtransformation_binding[0];
			...
			TMethodDefinition tInvokedMember = (TMethodDefinition) result_pattern_MethodInvocationTarget_11_1_performtransformation_binding[2];
			TAccess tAccess = (TAccess) result_pattern_MethodInvocationTarget_11_1_performtransformation_binding[3];
	...
	public static final void pattern_MethodInvocationTarget_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mInvokedMemberToTInvokedMember, EObject tInvokedMember, EObject tAccess, EObject mInvokedMember,
			EObject invocationToTAccess) {
		_this.registerObjects_BWD(ruleresult, invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess,
				mInvokedMember, invocationToTAccess);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_12_2_corematch_blackFFBBFFB(
	...
	public static final Object[] pattern_MethodInvocationTarget_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		invocationToTAccess__tAccess____target.setName(invocationToTAccess__tAccess____target_name_prime);
		return new Object[] { invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember,
				invocationToTAccess, isApplicableMatch, mInvokedMemberToTInvokedMember__tInvokedMember____target,
				tAccess__tInvokedMember____target, tInvokedMember__tAccess____accessedBy,
				mInvokedMemberToTInvokedMember__mInvokedMember____source, invocationToTAccess__invocation____source,
				invocationToTAccess__tAccess____target };
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_12_4_solveCSP_bindingFBBBBBBBB(
			...
			MDefinitionToTMember mInvokedMemberToTInvokedMember, TMethodDefinition tInvokedMember, TAccess tAccess,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocationToTAccess invocationToTAccess) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, invocation,
				mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember, invocationToTAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocation, mInvokedMemberToTInvokedMember,
		...
		if (tmpInvocation instanceof AbstractMethodInvocation) {
			...
			if (tmpTInvokedMember instanceof TMethodDefinition) {
				...
				if (tmpTAccess instanceof TAccess) {
					...
					if (tmpMInvokedMember instanceof AbstractMethodDeclaration) {
						AbstractMethodDeclaration mInvokedMember = (AbstractMethodDeclaration) tmpMInvokedMember;
						return new Object[] { invocation, tInvokedMember, tAccess, mInvokedMember, sourceMatch,
								targetMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_blackBBBBBB(
			AbstractMethodInvocation invocation, TMethodDefinition tInvokedMember, TAccess tAccess,
			AbstractMethodDeclaration mInvokedMember, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { invocation, tInvokedMember, tAccess, mInvokedMember, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_binding != null) {
			AbstractMethodInvocation invocation = (AbstractMethodInvocation) result_pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_binding[0];
			...
			Object[] result_pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_black = pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_blackBBBBBB(
					invocation, tInvokedMember, tAccess, mInvokedMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodInvocationTarget_24_3_solvecsp_bindingFBBBBBBB(
			MethodInvocationTarget _this, AbstractMethodInvocation invocation, TMethodDefinition tInvokedMember,
			TAccess tAccess, AbstractMethodDeclaration mInvokedMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(invocation, tInvokedMember, tAccess, mInvokedMember,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, invocation, tInvokedMember, tAccess, mInvokedMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_24_3_solvecsp_binding = pattern_MethodInvocationTarget_24_3_solvecsp_bindingFBBBBBBB(
				_this, invocation, tInvokedMember, tAccess, mInvokedMember, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackBFBBBFBB(
			AbstractMethodInvocation invocation, TMethodDefinition tInvokedMember, TAccess tAccess,
			AbstractMethodDeclaration mInvokedMember, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mInvokedMember.equals(mInvokedMemberToTInvokedMember.getSource())) {
					for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tAccess.equals(invocationToTAccess.getTarget())) {
							_result.add(new Object[] { invocation, mInvokedMemberToTInvokedMember, tInvokedMember,
									tAccess, mInvokedMember, invocationToTAccess, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { invocation, tInvokedMember, tAccess, mInvokedMember, ccMatch };
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, invocation,
				mInvokedMemberToTInvokedMember, tInvokedMember, tAccess, mInvokedMember, invocationToTAccess,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocation, mInvokedMemberToTInvokedMember,
					tInvokedMember, tAccess, mInvokedMember, invocationToTAccess, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_29_3_solveCSP_binding = pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, invocation, mInvokedMemberToTInvokedMember, tInvokedMember, tAccess,
				mInvokedMember, invocationToTAccess, ruleResult);
	...
	public static final Object[] pattern_MethodInvocationTarget_29_6_perform_greenBBBBB(
		...
		return new Object[] { invocation, tInvokedMember, tAccess, mInvokedMember, ruleResult };
	}
