...
public class MethodInvocationTargetImpl extends AbstractRuleImpl implements MethodInvocationTarget {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		TAccess tAccess = (TAccess) result1_bindingAndBlack[1];
		MDefinitionToTMember mInvokedMemberToTInvokedMember = (MDefinitionToTMember) result1_bindingAndBlack[2];
		...
		AbstractMethodInvocation invocation = (AbstractMethodInvocation) result1_bindingAndBlack[5];
		...
		Object[] result3_black = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, invocationToTAccess,
						tAccess, mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation);
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				tAccess, tInvokedMember, mInvokedMember, invocation);
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember, tInvokedMember,
				mInvokedMember, invocation);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_2_2_corematch_blackFFFFBBB(mInvokedMember, invocation, match)) {
			...
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_2_3_findcontext_blackBBBBBB(invocationToTAccess, tAccess,
							mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation)) {
				Object[] result3_green = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(invocationToTAccess, tAccess,
								mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation);
				...
				//nothing EMoflonEdge invocation__mInvokedMember____method = (EMoflonEdge) result3_green[10];
				//nothing EMoflonEdge mInvokedMember__invocation____usages = (EMoflonEdge) result3_green[11];
				...
				Object[] result4_bindingAndBlack = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember, tInvokedMember,
								mInvokedMember, invocation);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocation invocation) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject invocationToTAccess, EObject tAccess,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_12_2_corematch_blackFBFBFFB(tAccess, tInvokedMember, match)) {
			AbstractMethodInvocationToTAccess invocationToTAccess = (AbstractMethodInvocationToTAccess) result2_black[0];
			MDefinitionToTMember mInvokedMemberToTInvokedMember = (MDefinitionToTMember) result2_black[2];
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_12_3_findcontext_blackBBBBBB(invocationToTAccess, tAccess,
							mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation)) {
				Object[] result3_green = MethodInvocationTargetImpl
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject invocationToTAccess, EObject tAccess,
			EObject mInvokedMemberToTInvokedMember, EObject tInvokedMember, EObject mInvokedMember,
			EObject invocation) {
		ruleresult.registerObject("invocationToTAccess", invocationToTAccess);
		ruleresult.registerObject("tAccess", tAccess);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_955(EMoflonEdge _edge_target) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_1049(EMoflonEdge _edge_method) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tAccess, tInvokedMember,
						mInvokedMember, invocation, sourceMatch, targetMatch);
		...
		if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackFBFBBBBB(tAccess, tInvokedMember,
							mInvokedMember, invocation, sourceMatch, targetMatch)) {
				AbstractMethodInvocationToTAccess invocationToTAccess = (AbstractMethodInvocationToTAccess) result5_black[0];
				MDefinitionToTMember mInvokedMemberToTInvokedMember = (MDefinitionToTMember) result5_black[2];
				...
				Object[] result6_black = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_24_6_createcorrespondence_blackBBBBB(tAccess, tInvokedMember,
								mInvokedMember, invocation, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tAccess] = " + tAccess
							+ ", " + "[tInvokedMember] = " + tInvokedMember + ", " + "[mInvokedMember] = "
							+ mInvokedMember + ", " + "[invocation] = " + invocation + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAccess tAccess, TMethodDefinition tInvokedMember,
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			Object[] result3_bindingAndBlack = MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember, tInvokedMember,
							mInvokedMember, invocation, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[invocationToTAccess] = "
						+ invocationToTAccess + ", " + "[tAccess] = " + tAccess + ", "
			...
			if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_29_5_checknacs_blackBBBBBB(invocationToTAccess, tAccess,
								mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation);
				if (result5_black != null) {

					Object[] result6_black = MethodInvocationTargetImpl
							.pattern_MethodInvocationTarget_29_6_perform_blackBBBBBBB(invocationToTAccess, tAccess,
									mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation,
									ruleResult);
					if (result6_black == null) {
					...
					MethodInvocationTargetImpl.pattern_MethodInvocationTarget_29_6_perform_greenBBBBB(tAccess,
							tInvokedMember, mInvokedMember, invocation, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TACCESS_MDEFINITIONTOTMEMBER_TMETHODDEFINITION_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATION:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(AbstractMethodInvocationToTAccess) arguments.get(1), (TAccess) arguments.get(2),
						(MDefinitionToTMember) arguments.get(3), (TMethodDefinition) arguments.get(4),
						(AbstractMethodDeclaration) arguments.get(5), (AbstractMethodInvocation) arguments.get(6));
			...
			case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TACCESS_MDEFINITIONTOTMEMBER_TMETHODDEFINITION_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATION:
			...
			case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_BWD_EMOFLON_EDGE_955__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_955((EMoflonEdge) arguments.get(0));
			case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1049__EMOFLONEDGE:
				return isAppropriate_FWD_EMoflonEdge_1049((EMoflonEdge) arguments.get(0));
			...
			case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_CC__TACCESS_TMETHODDEFINITION_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATION_MATCH_MATCH:
				return isApplicable_solveCsp_CC((TAccess) arguments.get(0), (TMethodDefinition) arguments.get(1),
						(AbstractMethodDeclaration) arguments.get(2), (AbstractMethodInvocation) arguments.get(3),
			...
			case RulesPackage.METHOD_INVOCATION_TARGET___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTMETHODINVOCATIONTOTACCESS_TACCESS_MDEFINITIONTOTMEMBER_TMETHODDEFINITION_ABSTRACTMETHODDECLARATION_ABSTRACTMETHODINVOCATION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_bindingFFFFFFB(
		...
		EObject _localVariable_2 = isApplicableMatch.getObject("mInvokedMemberToTInvokedMember");
		...
		EObject tmpMInvokedMemberToTInvokedMember = _localVariable_2;
					...
					if (tmpTInvokedMember instanceof TMethodDefinition) {
						...
						if (tmpMInvokedMember instanceof AbstractMethodDeclaration) {
							...
							if (tmpInvocation instanceof AbstractMethodInvocation) {
								...
								return new Object[] { invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember,
										tInvokedMember, mInvokedMember, invocation, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
			AbstractMethodInvocationToTAccess invocationToTAccess, TAccess tAccess,
			MDefinitionToTMember mInvokedMemberToTInvokedMember, TMethodDefinition tInvokedMember,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocation invocation, MethodInvocationTarget _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember, tInvokedMember,
						mInvokedMember, invocation, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationTarget_1_1_performtransformation_binding != null) {
			...
			TAccess tAccess = (TAccess) result_pattern_MethodInvocationTarget_1_1_performtransformation_binding[1];
			MDefinitionToTMember mInvokedMemberToTInvokedMember = (MDefinitionToTMember) result_pattern_MethodInvocationTarget_1_1_performtransformation_binding[2];
			...
			AbstractMethodInvocation invocation = (AbstractMethodInvocation) result_pattern_MethodInvocationTarget_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_MethodInvocationTarget_1_1_performtransformation_black = pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
					invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember,
					invocation, _this, isApplicableMatch);
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject invocationToTAccess, EObject tAccess,
			EObject mInvokedMemberToTInvokedMember, EObject tInvokedMember, EObject mInvokedMember,
			EObject invocation) {
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject tAccess, EObject tInvokedMember, EObject mInvokedMember,
			EObject invocation) {
		...
		invocation__mInvokedMember____method.setName(invocation__mInvokedMember____method_name_prime);
		mInvokedMember__invocation____usages.setName(mInvokedMember__invocation____usages_name_prime);
		return new Object[] { ruleresult, tAccess, tInvokedMember, mInvokedMember, invocation,
	...
	public static final void pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(
			MethodInvocationTarget _this, PerformRuleResult ruleresult, EObject invocationToTAccess, EObject tAccess,
			EObject mInvokedMemberToTInvokedMember, EObject tInvokedMember, EObject mInvokedMember,
			EObject invocation) {
		_this.registerObjects_FWD(ruleresult, invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember,
				tInvokedMember, mInvokedMember, invocation);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_2_2_corematch_blackFFFFBBB(
		...
		for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTInvokedMember instanceof TMethodDefinition) {
				...
				for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAccess != null) {
						_result.add(new Object[] { invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember,
								tInvokedMember, mInvokedMember, invocation, match });
					}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember, tInvokedMember,
				mInvokedMember, invocation, isApplicableMatch, mInvokedMemberToTInvokedMember__tInvokedMember____target,
				mInvokedMemberToTInvokedMember__mInvokedMember____source, invocationToTAccess__tAccess____target,
				invocation__mInvokedMember____method, mInvokedMember__invocation____usages,
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
			...
			MDefinitionToTMember mInvokedMemberToTInvokedMember, TMethodDefinition tInvokedMember,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocation invocation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, invocationToTAccess, tAccess,
				mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, tAccess,
					mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_2_4_solveCSP_binding = pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember, tInvokedMember,
				mInvokedMember, invocation);
	...
	public static final Object[] pattern_MethodInvocationTarget_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodInvocationTarget_11_1_performtransformation_binding != null) {
			...
			TAccess tAccess = (TAccess) result_pattern_MethodInvocationTarget_11_1_performtransformation_binding[1];
			MDefinitionToTMember mInvokedMemberToTInvokedMember = (MDefinitionToTMember) result_pattern_MethodInvocationTarget_11_1_performtransformation_binding[2];
			...
			AbstractMethodInvocation invocation = (AbstractMethodInvocation) result_pattern_MethodInvocationTarget_11_1_performtransformation_binding[5];
	...
	public static final void pattern_MethodInvocationTarget_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mInvokedMemberToTInvokedMember, EObject tInvokedMember, EObject mInvokedMember,
			EObject invocation) {
		_this.registerObjects_BWD(ruleresult, invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember,
				tInvokedMember, mInvokedMember, invocation);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_12_2_corematch_blackFBFBFFB(TAccess tAccess,
	...
	public static final Object[] pattern_MethodInvocationTarget_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		invocationToTAccess__invocation____source.setName(invocationToTAccess__invocation____source_name_prime);
		return new Object[] { invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember, tInvokedMember,
				mInvokedMember, invocation, isApplicableMatch, tAccess__tInvokedMember____target,
				tInvokedMember__tAccess____accessedBy, mInvokedMemberToTInvokedMember__tInvokedMember____target,
				mInvokedMemberToTInvokedMember__mInvokedMember____source, invocationToTAccess__tAccess____target,
				invocationToTAccess__invocation____source };
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_12_4_solveCSP_bindingFBBBBBBBB(
			...
			MDefinitionToTMember mInvokedMemberToTInvokedMember, TMethodDefinition tInvokedMember,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocation invocation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, invocationToTAccess, tAccess,
				mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, tAccess,
		...
		if (tmpTAccess instanceof TAccess) {
			...
			if (tmpTInvokedMember instanceof TMethodDefinition) {
				...
				if (tmpMInvokedMember instanceof AbstractMethodDeclaration) {
					...
					if (tmpInvocation instanceof AbstractMethodInvocation) {
						AbstractMethodInvocation invocation = (AbstractMethodInvocation) tmpInvocation;
						return new Object[] { tAccess, tInvokedMember, mInvokedMember, invocation, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_blackBBBBBB(TAccess tAccess,
			TMethodDefinition tInvokedMember, AbstractMethodDeclaration mInvokedMember,
			AbstractMethodInvocation invocation, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tAccess, tInvokedMember, mInvokedMember, invocation, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_black = pattern_MethodInvocationTarget_24_2_matchsrctrgcontext_blackBBBBBB(
					tAccess, tInvokedMember, mInvokedMember, invocation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodInvocationTarget_24_3_solvecsp_bindingFBBBBBBB(
			MethodInvocationTarget _this, TAccess tAccess, TMethodDefinition tInvokedMember,
			AbstractMethodDeclaration mInvokedMember, AbstractMethodInvocation invocation, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tAccess, tInvokedMember, mInvokedMember, invocation,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tAccess, tInvokedMember, mInvokedMember, invocation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_24_3_solvecsp_binding = pattern_MethodInvocationTarget_24_3_solvecsp_bindingFBBBBBBB(
				_this, tAccess, tInvokedMember, mInvokedMember, invocation, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackFBFBBBBB(
			TAccess tAccess, TMethodDefinition tInvokedMember, AbstractMethodDeclaration mInvokedMember,
			AbstractMethodInvocation invocation, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mInvokedMember.equals(mInvokedMemberToTInvokedMember.getSource())) {
					for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (invocation.equals(invocationToTAccess.getSource())) {
							_result.add(new Object[] { invocationToTAccess, tAccess, mInvokedMemberToTInvokedMember,
									tInvokedMember, mInvokedMember, invocation, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationTarget_24_6_createcorrespondence_blackBBBBB(TAccess tAccess,
		...
		return new Object[] { tAccess, tInvokedMember, mInvokedMember, invocation, ccMatch };
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, invocationToTAccess, tAccess,
				mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, invocationToTAccess, tAccess,
					mInvokedMemberToTInvokedMember, tInvokedMember, mInvokedMember, invocation, ruleResult };
	...
	public static final Object[] pattern_MethodInvocationTarget_29_6_perform_greenBBBBB(TAccess tAccess,
		...
		return new Object[] { tAccess, tInvokedMember, mInvokedMember, invocation, ruleResult };
	}
