...
public class MethodInvocationTargetImpl extends AbstractRuleImpl implements MethodInvocationTarget {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodInvocationTargetImpl
				.pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tInvokedMember,
						invocationToTAccess, mInvokedMember, tAccess, invocation, mInvokedMemberToTInvokedMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tInvokedMember] = " + tInvokedMember + ", " + "[invocationToTAccess] = "
					+ invocationToTAccess + ", " + "[mInvokedMember] = " + mInvokedMember + ", " + "[tAccess] = "
					+ tAccess + ", " + "[invocation] = " + invocation + ", " + "[mInvokedMemberToTInvokedMember] = "
		...
		MethodInvocationTargetImpl.pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, tInvokedMember, invocationToTAccess, mInvokedMember, tAccess, invocation,
				mInvokedMemberToTInvokedMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_2_3_findcontext_blackBBBBBB(tInvokedMember, invocationToTAccess,
							mInvokedMember, tAccess, invocation, mInvokedMemberToTInvokedMember)) {
				Object[] result3_green = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(tInvokedMember,
								invocationToTAccess, mInvokedMember, tAccess, invocation,
								mInvokedMemberToTInvokedMember);
				...
				Object[] result4_bindingAndBlack = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								tInvokedMember, invocationToTAccess, mInvokedMember, tAccess, invocation,
								mInvokedMemberToTInvokedMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tInvokedMember] = "
							+ tInvokedMember + ", " + "[invocationToTAccess] = " + invocationToTAccess + ", "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMethodDefinition tInvokedMember,
			...
			TAccess tAccess, AbstractMethodInvocation invocation, MDefinitionToTMember mInvokedMemberToTInvokedMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tInvokedMember, EObject invocationToTAccess,
			EObject mInvokedMember, EObject tAccess, EObject invocation, EObject mInvokedMemberToTInvokedMember) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			// ForEach 
			for (Object[] result3_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_12_3_findcontext_blackBBBBBB(tInvokedMember, invocationToTAccess,
							mInvokedMember, tAccess, invocation, mInvokedMemberToTInvokedMember)) {
				Object[] result3_green = MethodInvocationTargetImpl
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tInvokedMember, EObject invocationToTAccess,
			EObject mInvokedMember, EObject tAccess, EObject invocation, EObject mInvokedMemberToTInvokedMember) {
		ruleresult.registerObject("tInvokedMember", tInvokedMember);
		ruleresult.registerObject("invocationToTAccess", invocationToTAccess);
		ruleresult.registerObject("mInvokedMember", mInvokedMember);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_148(EMoflonEdge _edge_target) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_159(EMoflonEdge _edge_method) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodInvocationTargetImpl
					.pattern_MethodInvocationTarget_24_5_matchcorrcontext_blackBFBBBFBB(tInvokedMember, mInvokedMember,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : MethodInvocationTargetImpl
			...
			if (MethodInvocationTargetImpl.pattern_MethodInvocationTarget_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MethodInvocationTargetImpl
						.pattern_MethodInvocationTarget_29_5_checknacs_blackBBBBBB(tInvokedMember, invocationToTAccess,
								mInvokedMember, tAccess, invocation, mInvokedMemberToTInvokedMember);
				if (result5_black != null) {
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethodDefinition tInvokedMember,
			AbstractMethodInvocationToTAccess invocationToTAccess, AbstractMethodDeclaration mInvokedMember,
			TAccess tAccess, AbstractMethodInvocation invocation, MDefinitionToTMember mInvokedMemberToTInvokedMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_ABSTRACTMETHODINVOCATIONTOTACCESS_ABSTRACTMETHODDECLARATION_TACCESS_ABSTRACTMETHODINVOCATION_MDEFINITIONTOTMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TMethodDefinition) arguments.get(1),
					...
					(TAccess) arguments.get(4), (AbstractMethodInvocation) arguments.get(5),
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_ABSTRACTMETHODINVOCATIONTOTACCESS_ABSTRACTMETHODDECLARATION_TACCESS_ABSTRACTMETHODINVOCATION_MDEFINITIONTOTMEMBER:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_BWD_EMOFLON_EDGE_148__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_148((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_INVOCATION_TARGET___IS_APPROPRIATE_FWD_EMOFLON_EDGE_159__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_INVOCATION_TARGET___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODDEFINITION_ABSTRACTMETHODINVOCATIONTOTACCESS_ABSTRACTMETHODDECLARATION_TACCESS_ABSTRACTMETHODINVOCATION_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(TMethodDefinition) arguments.get(1), (AbstractMethodInvocationToTAccess) arguments.get(2),
					(AbstractMethodDeclaration) arguments.get(3), (TAccess) arguments.get(4),
					(AbstractMethodInvocation) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
					...
					if (tmpTAccess instanceof TAccess) {
						...
						if (tmpInvocation instanceof AbstractMethodInvocation) {
							...
							if (tmpMInvokedMemberToTInvokedMember instanceof MDefinitionToTMember) {
								...
								return new Object[] { tInvokedMember, invocationToTAccess, mInvokedMember, tAccess,
										invocation, mInvokedMemberToTInvokedMember, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodInvocationTarget_1_1_performtransformation_blackBBBBBBFBB(
			TMethodDefinition tInvokedMember, AbstractMethodInvocationToTAccess invocationToTAccess,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tInvokedMember, invocationToTAccess, mInvokedMember, tAccess, invocation,
	...
	public static final Object[] pattern_MethodInvocationTarget_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tInvokedMember, EObject invocationToTAccess, EObject mInvokedMember,
			EObject tAccess, EObject invocation, EObject mInvokedMemberToTInvokedMember) {
	...
	public static final void pattern_MethodInvocationTarget_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject invocationToTAccess, EObject mInvokedMember, EObject tAccess, EObject invocation,
			EObject mInvokedMemberToTInvokedMember) {
		_this.registerObjects_FWD(ruleresult, tInvokedMember, invocationToTAccess, mInvokedMember, tAccess, invocation,
				mInvokedMemberToTInvokedMember);
		...
		for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAccess != null) {
				for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTInvokedMember instanceof TMethodDefinition) {
						TMethodDefinition tInvokedMember = (TMethodDefinition) tmpTInvokedMember;
						_result.add(new Object[] { tInvokedMember, invocationToTAccess, mInvokedMember, tAccess,
								invocation, mInvokedMemberToTInvokedMember, match });
					}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { tInvokedMember, invocationToTAccess, mInvokedMember, tAccess, invocation,
				...
				invocationToTAccess__invocation____source, mInvokedMemberToTInvokedMember__mInvokedMember____source,
				mInvokedMemberToTInvokedMember__tInvokedMember____target };
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractMethodInvocationToTAccess invocationToTAccess, AbstractMethodDeclaration mInvokedMember,
			TAccess tAccess, AbstractMethodInvocation invocation, MDefinitionToTMember mInvokedMemberToTInvokedMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tInvokedMember, invocationToTAccess,
				mInvokedMember, tAccess, invocation, mInvokedMemberToTInvokedMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInvokedMember, invocationToTAccess, mInvokedMember,
					tAccess, invocation, mInvokedMemberToTInvokedMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodInvocationTarget_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodInvocationTarget_2_4_solveCSP_binding = pattern_MethodInvocationTarget_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tInvokedMember, invocationToTAccess, mInvokedMember, tAccess, invocation,
				mInvokedMemberToTInvokedMember);
		if (result_pattern_MethodInvocationTarget_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodInvocationTarget_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tInvokedMember, invocationToTAccess,
						mInvokedMember, tAccess, invocation, mInvokedMemberToTInvokedMember };
			}
		}
		return null;
	...
	public static final void pattern_MethodInvocationTarget_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject invocationToTAccess, EObject mInvokedMember, EObject tAccess, EObject invocation,
			EObject mInvokedMemberToTInvokedMember) {
		_this.registerObjects_BWD(ruleresult, tInvokedMember, invocationToTAccess, mInvokedMember, tAccess, invocation,
				mInvokedMemberToTInvokedMember);
	...
	public static final Object[] pattern_MethodInvocationTarget_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		mInvokedMemberToTInvokedMember__tInvokedMember____target
				.setName(mInvokedMemberToTInvokedMember__tInvokedMember____target_name_prime);
		return new Object[] { tInvokedMember, invocationToTAccess, mInvokedMember, tAccess, invocation,
				mInvokedMemberToTInvokedMember, isApplicableMatch, tAccess__tInvokedMember____target,
	...
	public static final Object[] pattern_MethodInvocationTarget_12_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractMethodInvocationToTAccess invocationToTAccess, AbstractMethodDeclaration mInvokedMember,
			TAccess tAccess, AbstractMethodInvocation invocation, MDefinitionToTMember mInvokedMemberToTInvokedMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tInvokedMember, invocationToTAccess,
				mInvokedMember, tAccess, invocation, mInvokedMemberToTInvokedMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInvokedMember, invocationToTAccess, mInvokedMember,
			...
			for (AbstractMethodInvocationToTAccess invocationToTAccess : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (invocation.equals(invocationToTAccess.getSource())) {
					for (MDefinitionToTMember mInvokedMemberToTInvokedMember : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tInvokedMember.equals(mInvokedMemberToTInvokedMember.getTarget())) {
							_result.add(new Object[] { tInvokedMember, invocationToTAccess, mInvokedMember, tAccess,
									invocation, mInvokedMemberToTInvokedMember, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodInvocationTarget_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tInvokedMember, invocationToTAccess,
				mInvokedMember, tAccess, invocation, mInvokedMemberToTInvokedMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tInvokedMember, invocationToTAccess, mInvokedMember,
					tAccess, invocation, mInvokedMemberToTInvokedMember, ruleResult };
		}
		return null;
	}
