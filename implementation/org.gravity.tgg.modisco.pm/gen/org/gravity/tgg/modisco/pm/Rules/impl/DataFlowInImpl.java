...
public class DataFlowInImpl extends AbstractRuleImpl implements DataFlowIn {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = DataFlowInImpl.pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget);
		...
		DataFlowInImpl.pattern_DataFlowIn_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, tSource, tFlow, mSource,
				mTarget);
		...
		DataFlowInImpl.pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tSource,
				mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : DataFlowInImpl.pattern_DataFlowIn_2_2_corematch_blackFFFFBBB(mSource, mTarget,
				match)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TAbstractFlowElement tSource,
			...
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow, MFlow mSource, MAbstractFlowElement mTarget) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tSource, EObject mSourceToTSource,
			EObject tFlow, EObject mFlowToTFlow, EObject mSource, EObject mTarget) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		DataFlowInImpl.pattern_DataFlowIn_11_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, tSource, tFlow, mSource,
				mTarget);
		//nothing EMoflonEdge tFlow__tSource____incomingFlows = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge tSource__tFlow____outgoingFlows = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mTarget__mSource____incomingFlows = (EMoflonEdge) result3_green[7];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : DataFlowInImpl.pattern_DataFlowIn_12_2_corematch_blackBFBFFFB(tSource, tFlow,
				match)) {
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource = (MAbstractFlowElementToTAbstractFlowElement) result2_black[1];
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow = (MAbstractFlowElementToTAbstractFlowElement) result2_black[3];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_93(EMoflonEdge _edge_incomingFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_96(EMoflonEdge _edge_incomingFlows) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = DataFlowInImpl.pattern_DataFlowIn_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
				tSource, tFlow, mSource, mTarget, sourceMatch, targetMatch);
		...
		if (DataFlowInImpl.pattern_DataFlowIn_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : DataFlowInImpl.pattern_DataFlowIn_24_5_matchcorrcontext_blackBFBFBBBB(tSource,
					tFlow, mSource, mTarget, sourceMatch, targetMatch)) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAbstractFlowElement tSource, TAbstractFlowElement tFlow, MFlow mSource,
		...
		for (Object[] result2_black : DataFlowInImpl
			...
			Object[] result3_bindingAndBlack = DataFlowInImpl
					.pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, tSource,
							mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tSource] = " + tSource + ", "
						+ "[mSourceToTSource] = " + mSourceToTSource + ", " + "[tFlow] = " + tFlow + ", "
						+ "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mSource] = " + mSource + ", " + "[mTarget] = "
						+ mTarget + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tSource] = "
								+ tSource + ", " + "[mSourceToTSource] = " + mSourceToTSource + ", " + "[tFlow] = "
								+ tFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mSource] = " + mSource
								+ ", " + "[mTarget] = " + mTarget + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					DataFlowInImpl.pattern_DataFlowIn_29_6_perform_greenBBBBB(tSource, tFlow, mSource, mTarget,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPROPRIATE_BWD_EMOFLON_EDGE_93__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_93((EMoflonEdge) arguments.get(0));
		case RulesPackage.DATA_FLOW_IN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_96__EMOFLONEDGE:
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPLICABLE_SOLVE_CSP_CC__TABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENT_MATCH_MATCH:
		...
		case RulesPackage.DATA_FLOW_IN___GENERATE_MODEL__RULEENTRYCONTAINER_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT:
			return generateModel((RuleEntryContainer) arguments.get(0),
					...
					(MAbstractFlowElementToTAbstractFlowElement) arguments.get(2));
		case RulesPackage.DATA_FLOW_IN___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpMFlowToTFlow instanceof MAbstractFlowElementToTAbstractFlowElement) {
						...
						if (tmpMSource instanceof MFlow) {
							...
							if (tmpMTarget instanceof MAbstractFlowElement) {
								...
								return new Object[] { tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_DataFlowIn_1_1_performtransformation_blackBBBBBBFBB(
			...
			MAbstractFlowElement mTarget, DataFlowIn _this, IsApplicableMatch isApplicableMatch) {
				...
				if (!mSource.equals(mTarget)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget, csp,
	...
	public static final Object[] pattern_DataFlowIn_1_1_performtransformation_bindingAndBlackFFFFFFFBB(DataFlowIn _this,
		...
		if (result_pattern_DataFlowIn_1_1_performtransformation_binding != null) {
			...
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow = (MAbstractFlowElementToTAbstractFlowElement) result_pattern_DataFlowIn_1_1_performtransformation_binding[3];
			MFlow mSource = (MFlow) result_pattern_DataFlowIn_1_1_performtransformation_binding[4];
			MAbstractFlowElement mTarget = (MAbstractFlowElement) result_pattern_DataFlowIn_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_DataFlowIn_1_1_performtransformation_black = pattern_DataFlowIn_1_1_performtransformation_blackBBBBBBFBB(
					tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget, _this, isApplicableMatch);
			if (result_pattern_DataFlowIn_1_1_performtransformation_black != null) {
				...
				return new Object[] { tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject tSource, EObject mSourceToTSource, EObject tFlow, EObject mFlowToTFlow, EObject mSource,
			EObject mTarget) {
															...
															if (!mTarget.equals(tSource)) {
																if (!mTarget.equals(tFlow)) {
																	return new Object[] { ruleresult, tSource,
																			mSourceToTSource, tFlow, mFlowToTFlow,
																			mSource, mTarget };
																}
															}
														}
	...
	public static final Object[] pattern_DataFlowIn_1_3_bookkeepingforedges_greenBBBBBFFFF(PerformRuleResult ruleresult,
			EObject tSource, EObject tFlow, EObject mSource, EObject mTarget) {
		...
		mTarget__mSource____incomingFlows.setName(mTarget__mSource____incomingFlows_name_prime);
		mSource__mTarget____flowTarget.setName(mSource__mTarget____flowTarget_name_prime);
		return new Object[] { ruleresult, tSource, tFlow, mSource, mTarget, tFlow__tSource____incomingFlows,
	...
	public static final void pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			PerformRuleResult ruleresult, EObject tSource, EObject mSourceToTSource, EObject tFlow,
			EObject mFlowToTFlow, EObject mSource, EObject mTarget) {
		_this.registerObjects_FWD(ruleresult, tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget);
	...
	public static final Iterable<Object[]> pattern_DataFlowIn_2_2_corematch_blackFFFFBBB(MFlow mSource,
				...
				if (tSource != null) {
					for (MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mFlowToTFlow.equals(mSourceToTSource)) {
							...
							if (tFlow != null) {
								if (!tFlow.equals(tSource)) {
									_result.add(new Object[] { tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource,
											mTarget, match });
								}
							}
							...
							if (mTarget.getIncomingFlows().contains(mSource)) {
								if (tFlow.equals(mFlowToTFlow.getTarget())) {
									if (mTarget.equals(mFlowToTFlow.getSource())) {
										_result.add(new Object[] { tSource, mSourceToTSource, tFlow, mFlowToTFlow,
												mSource, mTarget });
									}
								}
							}
	...
	public static final Object[] pattern_DataFlowIn_2_3_findcontext_greenBBBBBBFFFFFFF(TAbstractFlowElement tSource,
		...
		return new Object[] { tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget, isApplicableMatch,
				mSourceToTSource__tSource____target, mSourceToTSource__mSource____source,
				mTarget__mSource____incomingFlows, mSource__mTarget____flowTarget, mFlowToTFlow__tFlow____target,
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(DataFlowIn _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tFlow,
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow, MFlow mSource, MAbstractFlowElement mTarget) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tSource, mSourceToTSource, tFlow,
				mFlowToTFlow, mSource, mTarget);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSource, mSourceToTSource, tFlow, mFlowToTFlow,
					mSource, mTarget };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingAndBlackFBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_2_4_solveCSP_binding = pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget);
	...
	public static final Object[] pattern_DataFlowIn_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_DataFlowIn_11_1_performtransformation_binding != null) {
			...
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow = (MAbstractFlowElementToTAbstractFlowElement) result_pattern_DataFlowIn_11_1_performtransformation_binding[3];
			MFlow mSource = (MFlow) result_pattern_DataFlowIn_11_1_performtransformation_binding[4];
			MAbstractFlowElement mTarget = (MAbstractFlowElement) result_pattern_DataFlowIn_11_1_performtransformation_binding[5];
	...
	public static final Object[] pattern_DataFlowIn_11_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject tSource, EObject tFlow, EObject mSource, EObject mTarget) {
		EMoflonEdge tFlow__tSource____incomingFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tSource__tFlow____outgoingFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mTarget__mSource____incomingFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mSource__mTarget____flowTarget = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_DataFlowIn_11_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			PerformRuleResult ruleresult, EObject tSource, EObject mSourceToTSource, EObject tFlow,
			EObject mFlowToTFlow, EObject mSource, EObject mTarget) {
		_this.registerObjects_BWD(ruleresult, tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget);
	...
	public static final Iterable<Object[]> pattern_DataFlowIn_12_2_corematch_blackBFBFFFB(TAbstractFlowElement tSource,
	...
	public static final Object[] pattern_DataFlowIn_12_3_findcontext_greenBBBBBBFFFFFFF(TAbstractFlowElement tSource,
		...
		mFlowToTFlow__mTarget____source.setName(mFlowToTFlow__mTarget____source_name_prime);
		return new Object[] { tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget, isApplicableMatch,
				tFlow__tSource____incomingFlows, tSource__tFlow____outgoingFlows, mSourceToTSource__tSource____target,
	...
	public static final Object[] pattern_DataFlowIn_12_4_solveCSP_bindingFBBBBBBBB(DataFlowIn _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tFlow,
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow, MFlow mSource, MAbstractFlowElement mTarget) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tSource, mSourceToTSource, tFlow,
				mFlowToTFlow, mSource, mTarget);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSource, mSourceToTSource, tFlow, mFlowToTFlow,
		...
		if (tmpTSource instanceof TAbstractFlowElement) {
			...
			if (tmpTFlow instanceof TAbstractFlowElement) {
				...
				if (tmpMSource instanceof MFlow) {
					...
					if (tmpMTarget instanceof MAbstractFlowElement) {
						MAbstractFlowElement mTarget = (MAbstractFlowElement) tmpMTarget;
						return new Object[] { tSource, tFlow, mSource, mTarget, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_DataFlowIn_24_2_matchsrctrgcontext_blackBBBBBB(TAbstractFlowElement tSource,
			TAbstractFlowElement tFlow, MFlow mSource, MAbstractFlowElement mTarget, Match sourceMatch,
			Match targetMatch) {
		if (!tFlow.equals(tSource)) {
			if (!mSource.equals(mTarget)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tSource, tFlow, mSource, mTarget, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowIn_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(Match sourceMatch,
		...
		if (result_pattern_DataFlowIn_24_2_matchsrctrgcontext_binding != null) {
			...
			MFlow mSource = (MFlow) result_pattern_DataFlowIn_24_2_matchsrctrgcontext_binding[2];
	...
	public static final Object[] pattern_DataFlowIn_24_3_solvecsp_bindingFBBBBBBB(DataFlowIn _this,
			TAbstractFlowElement tSource, TAbstractFlowElement tFlow, MFlow mSource, MAbstractFlowElement mTarget,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tSource, tFlow, mSource, mTarget, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tSource, tFlow, mSource, mTarget, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_24_3_solvecsp_bindingAndBlackFBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_24_3_solvecsp_binding = pattern_DataFlowIn_24_3_solvecsp_bindingFBBBBBBB(
				_this, tSource, tFlow, mSource, mTarget, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_DataFlowIn_24_5_matchcorrcontext_blackBFBFBBBB(
			TAbstractFlowElement tSource, TAbstractFlowElement tFlow, MFlow mSource, MAbstractFlowElement mTarget,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tFlow.equals(tSource)) {
						...
						if (mSource.equals(mSourceToTSource.getSource())) {
							for (MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!mFlowToTFlow.equals(mSourceToTSource)) {
									if (mTarget.equals(mFlowToTFlow.getSource())) {
										_result.add(new Object[] { tSource, mSourceToTSource, tFlow, mFlowToTFlow,
												mSource, mTarget, sourceMatch, targetMatch });
									}
								}
							}
						}
	...
	public static final Object[] pattern_DataFlowIn_24_6_createcorrespondence_blackBBBBB(TAbstractFlowElement tSource,
			TAbstractFlowElement tFlow, MFlow mSource, MAbstractFlowElement mTarget, CCMatch ccMatch) {
		if (!tFlow.equals(tSource)) {
			if (!mSource.equals(mTarget)) {
				return new Object[] { tSource, tFlow, mSource, mTarget, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(DataFlowIn _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tSource, mSourceToTSource, tFlow,
				mFlowToTFlow, mSource, mTarget, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSource, mSourceToTSource, tFlow, mFlowToTFlow,
					mSource, mTarget, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_29_3_solveCSP_binding = pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tSource, mSourceToTSource, tFlow, mFlowToTFlow, mSource, mTarget, ruleResult);
	...
	public static final Object[] pattern_DataFlowIn_29_6_perform_greenBBBBB(TAbstractFlowElement tSource,
			TAbstractFlowElement tFlow, MFlow mSource, MAbstractFlowElement mTarget,
			ModelgeneratorRuleResult ruleResult) {
		tFlow.getIncomingFlows().add(tSource);
		mTarget.getIncomingFlows().add(mSource);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { tSource, tFlow, mSource, mTarget, ruleResult };
	}
