...
public class DataFlowInImpl extends AbstractRuleImpl implements DataFlowIn {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = DataFlowInImpl.pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget);
		...
		DataFlowInImpl.pattern_DataFlowIn_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, tFlow, tSource, mSource,
				mTarget);
		...
		DataFlowInImpl.pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mFlowToTFlow,
				mSourceToTSource, tFlow, tSource, mSource, mTarget);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			TAbstractFlowElement tSource, MFlow mSource, MAbstractFlowElement mTarget) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mFlowToTFlow, EObject mSourceToTSource,
			EObject tFlow, EObject tSource, EObject mSource, EObject mTarget) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		DataFlowInImpl.pattern_DataFlowIn_11_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, tFlow, tSource, mSource,
				mTarget);
		//nothing EMoflonEdge tFlow__tSource____incomingFlows = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge tSource__tFlow____outgoingFlows = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mTarget__mSource____incomingFlows = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_82(EMoflonEdge _edge_incomingFlows) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (DataFlowInImpl.pattern_DataFlowIn_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : DataFlowInImpl.pattern_DataFlowIn_24_5_matchcorrcontext_blackFFBBBBBB(tFlow,
		...
		for (Object[] result2_black : DataFlowInImpl
			...
			Object[] result3_bindingAndBlack = DataFlowInImpl
					.pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mFlowToTFlow,
							mSourceToTSource, tFlow, tSource, mSource, mTarget, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mFlowToTFlow] = " + mFlowToTFlow
						+ ", " + "[mSourceToTSource] = " + mSourceToTSource + ", " + "[tFlow] = " + tFlow + ", "
			...
			if (DataFlowInImpl.pattern_DataFlowIn_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					DataFlowInImpl.pattern_DataFlowIn_29_6_perform_greenBBBBB(tFlow, tSource, mSource, mTarget,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					...
					(MFlow) arguments.get(5), (MAbstractFlowElement) arguments.get(6));
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_82__EMOFLONEDGE:
		...
		case RulesPackage.DATA_FLOW_IN___GENERATE_MODEL__RULEENTRYCONTAINER_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT:
			return generateModel((RuleEntryContainer) arguments.get(0),
					(MAbstractFlowElementToTAbstractFlowElement) arguments.get(1),
					(MAbstractFlowElementToTAbstractFlowElement) arguments.get(2));
		case RulesPackage.DATA_FLOW_IN___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_MABSTRACTFLOWELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpTSource instanceof TAbstractFlowElement) {
						...
						if (tmpMSource instanceof MFlow) {
							...
							if (tmpMTarget instanceof MAbstractFlowElement) {
								...
								return new Object[] { mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_DataFlowIn_1_1_performtransformation_blackBBBBBBFBB(
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tFlow,
			TAbstractFlowElement tSource, MFlow mSource, MAbstractFlowElement mTarget, DataFlowIn _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!mSource.equals(mTarget)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget, csp,
	...
	public static final Object[] pattern_DataFlowIn_1_1_performtransformation_bindingAndBlackFFFFFFFBB(DataFlowIn _this,
		...
		if (result_pattern_DataFlowIn_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_DataFlowIn_1_1_performtransformation_black = pattern_DataFlowIn_1_1_performtransformation_blackBBBBBBFBB(
					mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget, _this, isApplicableMatch);
			if (result_pattern_DataFlowIn_1_1_performtransformation_black != null) {
				...
				return new Object[] { mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject mFlowToTFlow, EObject mSourceToTSource, EObject tFlow, EObject tSource, EObject mSource,
			EObject mTarget) {
		if (!mFlowToTFlow.equals(mSourceToTSource)) {
	...
	public static final Object[] pattern_DataFlowIn_1_3_bookkeepingforedges_greenBBBBBFFFF(PerformRuleResult ruleresult,
		...
		mTarget__mSource____incomingFlows.setName(mTarget__mSource____incomingFlows_name_prime);
		mSource__mTarget____flowTarget.setName(mSource__mTarget____flowTarget_name_prime);
		return new Object[] { ruleresult, tFlow, tSource, mSource, mTarget, tFlow__tSource____incomingFlows,
	...
	public static final void pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			...
			EObject tSource, EObject mSource, EObject mTarget) {
		_this.registerObjects_FWD(ruleresult, mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget);
				...
				if (tSource != null) {
					for (MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mFlowToTFlow.equals(mSourceToTSource)) {
							...
							if (tFlow != null) {
								if (!tFlow.equals(tSource)) {
									_result.add(new Object[] { mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource,
											mTarget, match });
								}
							}
							...
							if (mSource.equals(mSourceToTSource.getSource())) {
								if (mTarget.getIncomingFlows().contains(mSource)) {
									if (mTarget.equals(mFlowToTFlow.getSource())) {
										_result.add(new Object[] { mFlowToTFlow, mSourceToTSource, tFlow, tSource,
												mSource, mTarget });
									}
								}
							}
	...
	public static final Object[] pattern_DataFlowIn_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget, isApplicableMatch,
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(DataFlowIn _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mFlowToTFlow, mSourceToTSource, tFlow,
				tSource, mSource, mTarget);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mFlowToTFlow, mSourceToTSource, tFlow, tSource,
					mSource, mTarget };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingAndBlackFBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_2_4_solveCSP_binding = pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget);
	...
	public static final void pattern_DataFlowIn_11_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			PerformRuleResult ruleresult, EObject mFlowToTFlow, EObject mSourceToTSource, EObject tFlow,
			EObject tSource, EObject mSource, EObject mTarget) {
		_this.registerObjects_BWD(ruleresult, mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget);
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(DataFlowIn _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mFlowToTFlow, mSourceToTSource,
				tFlow, tSource, mSource, mTarget, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mFlowToTFlow, mSourceToTSource, tFlow, tSource,
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_29_3_solveCSP_binding = pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mFlowToTFlow, mSourceToTSource, tFlow, tSource, mSource, mTarget, ruleResult);
