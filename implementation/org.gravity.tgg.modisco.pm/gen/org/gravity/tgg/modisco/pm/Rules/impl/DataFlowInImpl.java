...
public class DataFlowInImpl extends AbstractRuleImpl implements DataFlowIn {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = DataFlowInImpl.pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow);
		...
		DataFlowInImpl.pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mFlowToTFlow,
				mSourceToTSource, mTarget, tSource, mSource, tFlow);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			TAbstractFlowElement tSource, MFlow mSource, TAbstractFlowElement tFlow) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_932(EMoflonEdge _edge_incomingFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_1025(EMoflonEdge _edge_incomingFlows) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (DataFlowInImpl.pattern_DataFlowIn_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : DataFlowInImpl.pattern_DataFlowIn_24_5_matchcorrcontext_blackFFBBBBBB(mTarget,
		...
		for (Object[] result2_black : DataFlowInImpl
			...
			Object[] result3_bindingAndBlack = DataFlowInImpl
					.pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mFlowToTFlow,
							mSourceToTSource, mTarget, tSource, mSource, tFlow, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mFlowToTFlow] = " + mFlowToTFlow
						+ ", " + "[mSourceToTSource] = " + mSourceToTSource + ", " + "[mTarget] = " + mTarget + ", "
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mFlowToTFlow] = "
								+ mFlowToTFlow + ", " + "[mSourceToTSource] = " + mSourceToTSource + ", "
								+ "[mTarget] = " + mTarget + ", " + "[tSource] = " + tSource + ", " + "[mSource] = "
								+ mSource + ", " + "[tFlow] = " + tFlow + ", " + "[ruleResult] = " + ruleResult + ".");
					}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.DATA_FLOW_IN___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						...
						(MFlow) arguments.get(5), (TAbstractFlowElement) arguments.get(6));
			...
			case RulesPackage.DATA_FLOW_IN___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT:
			...
			case RulesPackage.DATA_FLOW_IN___IS_APPROPRIATE_BWD_EMOFLON_EDGE_932__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_932((EMoflonEdge) arguments.get(0));
			case RulesPackage.DATA_FLOW_IN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1025__EMOFLONEDGE:
			...
			case RulesPackage.DATA_FLOW_IN___GENERATE_MODEL__RULEENTRYCONTAINER_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT:
				return generateModel((RuleEntryContainer) arguments.get(0),
						(MAbstractFlowElementToTAbstractFlowElement) arguments.get(1),
						(MAbstractFlowElementToTAbstractFlowElement) arguments.get(2));
			case RulesPackage.DATA_FLOW_IN___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpTSource instanceof TAbstractFlowElement) {
						...
						if (tmpMSource instanceof MFlow) {
							...
							if (tmpTFlow instanceof TAbstractFlowElement) {
								...
								return new Object[] { mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_DataFlowIn_1_1_performtransformation_blackBBBBBBFBB(
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, MAbstractFlowElement mTarget,
			TAbstractFlowElement tSource, MFlow mSource, TAbstractFlowElement tFlow, DataFlowIn _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!tFlow.equals(tSource)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow, csp,
	...
	public static final Object[] pattern_DataFlowIn_1_1_performtransformation_bindingAndBlackFFFFFFFBB(DataFlowIn _this,
		...
		if (result_pattern_DataFlowIn_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_DataFlowIn_1_1_performtransformation_black = pattern_DataFlowIn_1_1_performtransformation_blackBBBBBBFBB(
					mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow, _this, isApplicableMatch);
			if (result_pattern_DataFlowIn_1_1_performtransformation_black != null) {
				...
				return new Object[] { mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject mFlowToTFlow, EObject mSourceToTSource, EObject mTarget, EObject tSource, EObject mSource,
			EObject tFlow) {
		if (!mFlowToTFlow.equals(mSourceToTSource)) {
															...
															if (!mSource.equals(tFlow)) {
																if (!tFlow.equals(tSource)) {
																	return new Object[] { ruleresult, mFlowToTFlow,
																			mSourceToTSource, mTarget, tSource, mSource,
																			tFlow };
																}
															}
														}
	...
	public static final void pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			PerformRuleResult ruleresult, EObject mFlowToTFlow, EObject mSourceToTSource, EObject mTarget,
			EObject tSource, EObject mSource, EObject tFlow) {
		_this.registerObjects_FWD(ruleresult, mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow);
				...
				if (tFlow != null) {
					for (MAbstractFlowElementToTAbstractFlowElement mSourceToTSource : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mFlowToTFlow.equals(mSourceToTSource)) {
							...
							if (tSource != null) {
								if (!tFlow.equals(tSource)) {
									_result.add(new Object[] { mFlowToTFlow, mSourceToTSource, mTarget, tSource,
											mSource, tFlow, match });
								}
							}
	...
	public static final Object[] pattern_DataFlowIn_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow, isApplicableMatch,
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(DataFlowIn _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, MAbstractFlowElement mTarget,
			TAbstractFlowElement tSource, MFlow mSource, TAbstractFlowElement tFlow) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mFlowToTFlow, mSourceToTSource,
				mTarget, tSource, mSource, tFlow);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mFlowToTFlow, mSourceToTSource, mTarget, tSource,
					mSource, tFlow };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingAndBlackFBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_2_4_solveCSP_binding = pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow);
	...
	public static final void pattern_DataFlowIn_11_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			PerformRuleResult ruleresult, EObject mFlowToTFlow, EObject mSourceToTSource, EObject mTarget,
			EObject tSource, EObject mSource, EObject tFlow) {
		_this.registerObjects_BWD(ruleresult, mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow);
	...
	public static final Object[] pattern_DataFlowIn_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		mSourceToTSource__tSource____target.setName(mSourceToTSource__tSource____target_name_prime);
		return new Object[] { mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow, isApplicableMatch,
				mFlowToTFlow__mTarget____source, mSourceToTSource__mSource____source, tFlow__tSource____incomingFlows,
				tSource__tFlow____outgoingFlows, mFlowToTFlow__tFlow____target, mSourceToTSource__tSource____target };
	}
	...
	public static final Object[] pattern_DataFlowIn_12_4_solveCSP_bindingFBBBBBBBB(DataFlowIn _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, MAbstractFlowElement mTarget,
			TAbstractFlowElement tSource, MFlow mSource, TAbstractFlowElement tFlow) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mFlowToTFlow, mSourceToTSource,
				mTarget, tSource, mSource, tFlow);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mFlowToTFlow, mSourceToTSource, mTarget, tSource,
	...
	public static final Iterable<Object[]> pattern_DataFlowIn_24_5_matchcorrcontext_blackFFBBBBBB(
			MAbstractFlowElement mTarget, TAbstractFlowElement tSource, MFlow mSource, TAbstractFlowElement tFlow,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mSource.equals(mTarget)) {
						...
						if (tFlow.equals(mFlowToTFlow.getTarget())) {
							for (MAbstractFlowElementToTAbstractFlowElement mSourceToTSource : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!mFlowToTFlow.equals(mSourceToTSource)) {
									if (tSource.equals(mSourceToTSource.getTarget())) {
										_result.add(new Object[] { mFlowToTFlow, mSourceToTSource, mTarget, tSource,
												mSource, tFlow, sourceMatch, targetMatch });
									}
								}
							}
						}
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(DataFlowIn _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mFlowToTFlow, mSourceToTSource,
				mTarget, tSource, mSource, tFlow, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mFlowToTFlow, mSourceToTSource, mTarget, tSource,
					mSource, tFlow, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_29_3_solveCSP_binding = pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mFlowToTFlow, mSourceToTSource, mTarget, tSource, mSource, tFlow, ruleResult);
