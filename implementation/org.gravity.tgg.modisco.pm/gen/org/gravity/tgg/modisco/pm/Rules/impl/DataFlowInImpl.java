...
public class DataFlowInImpl extends AbstractRuleImpl implements DataFlowIn {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = DataFlowInImpl.pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mSourceToTSource] = " + mSourceToTSource + ", " + "[tFlow] = " + tFlow + ", "
					+ "[mTarget] = " + mTarget + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mSource] = "
					+ mSource + ", " + "[tSource] = " + tSource + ".");
		}
		DataFlowInImpl.pattern_DataFlowIn_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, tFlow, mTarget, mSource,
				tSource);
		...
		DataFlowInImpl.pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mSourceToTSource,
				tFlow, mTarget, mFlowToTFlow, mSource, tSource);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : DataFlowInImpl.pattern_DataFlowIn_2_2_corematch_blackFFBFBFB(mTarget, mSource,
				match)) {
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mSourceToTSource, EObject tFlow,
			EObject mTarget, EObject mFlowToTFlow, EObject mSource, EObject tSource) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		DataFlowInImpl.pattern_DataFlowIn_11_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, tFlow, mTarget, mSource,
				tSource);
		//nothing EMoflonEdge mTarget__mSource____incomingFlows = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge mSource__mTarget____flowTarget = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge tFlow__tSource____incomingFlows = (EMoflonEdge) result3_green[7];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : DataFlowInImpl.pattern_DataFlowIn_12_2_corematch_blackFBFFFBB(tFlow, tSource,
				match)) {
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource = (MAbstractFlowElementToTAbstractFlowElement) result2_black[0];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mSourceToTSource, EObject tFlow,
			EObject mTarget, EObject mFlowToTFlow, EObject mSource, EObject tSource) {
		ruleresult.registerObject("mSourceToTSource", mSourceToTSource);
		ruleresult.registerObject("tFlow", tFlow);
		ruleresult.registerObject("mTarget", mTarget);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_159(EMoflonEdge _edge_incomingFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_163(EMoflonEdge _edge_incomingFlows) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (DataFlowInImpl.pattern_DataFlowIn_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : DataFlowInImpl.pattern_DataFlowIn_24_5_matchcorrcontext_blackFBBFBBBB(tFlow,
		...
		for (Object[] result2_black : DataFlowInImpl
			...
			Object[] result3_bindingAndBlack = DataFlowInImpl
					.pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSourceToTSource] = "
						+ mSourceToTSource + ", " + "[tFlow] = " + tFlow + ", " + "[mTarget] = " + mTarget + ", "
			...
			if (DataFlowInImpl.pattern_DataFlowIn_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					DataFlowInImpl.pattern_DataFlowIn_29_6_perform_greenBBBBB(tFlow, mTarget, mSource, tSource,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT:
		...
		case RulesPackage.DATA_FLOW_IN___IS_APPROPRIATE_BWD_EMOFLON_EDGE_159__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_159((EMoflonEdge) arguments.get(0));
		case RulesPackage.DATA_FLOW_IN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_163__EMOFLONEDGE:
		...
		case RulesPackage.DATA_FLOW_IN___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_TABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENT_MABSTRACTFLOWELEMENTTOTABSTRACTFLOWELEMENT_MFLOW_TABSTRACTFLOWELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpMFlowToTFlow instanceof MAbstractFlowElementToTAbstractFlowElement) {
						...
						if (tmpMSource instanceof MFlow) {
							...
							if (tmpTSource instanceof TAbstractFlowElement) {
								...
								return new Object[] { mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource,
										isApplicableMatch };
							}
						}
					}
				...
				if (!mSource.equals(mTarget)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource, csp,
	...
	public static final Object[] pattern_DataFlowIn_1_1_performtransformation_bindingAndBlackFFFFFFFBB(DataFlowIn _this,
		...
		if (result_pattern_DataFlowIn_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_DataFlowIn_1_1_performtransformation_black = pattern_DataFlowIn_1_1_performtransformation_blackBBBBBBFBB(
					mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource, _this, isApplicableMatch);
			if (result_pattern_DataFlowIn_1_1_performtransformation_black != null) {
				...
				return new Object[] { mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject mSourceToTSource, EObject tFlow, EObject mTarget, EObject mFlowToTFlow, EObject mSource,
			EObject tSource) {
															...
															if (!mSource.equals(mTarget)) {
																if (!mSource.equals(tSource)) {
																	return new Object[] { ruleresult, mSourceToTSource,
																			tFlow, mTarget, mFlowToTFlow, mSource,
																			tSource };
																}
															}
														}
	...
	public static final Object[] pattern_DataFlowIn_1_3_bookkeepingforedges_greenBBBBBFFFF(PerformRuleResult ruleresult,
			EObject tFlow, EObject mTarget, EObject mSource, EObject tSource) {
		EMoflonEdge mTarget__mSource____incomingFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mSource__mTarget____flowTarget = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			PerformRuleResult ruleresult, EObject mSourceToTSource, EObject tFlow, EObject mTarget,
			EObject mFlowToTFlow, EObject mSource, EObject tSource) {
		_this.registerObjects_FWD(ruleresult, mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource);
	...
	public static final Iterable<Object[]> pattern_DataFlowIn_2_2_corematch_blackFFBFBFB(MAbstractFlowElement mTarget,
				...
				if (tSource != null) {
					for (MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mFlowToTFlow.equals(mSourceToTSource)) {
							...
							if (tFlow != null) {
								if (!tFlow.equals(tSource)) {
									_result.add(new Object[] { mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource,
											tSource, match });
								}
							}
							...
							if (mSource.equals(mSourceToTSource.getSource())) {
								if (tSource.equals(mSourceToTSource.getTarget())) {
									if (mTarget.equals(mFlowToTFlow.getSource())) {
										_result.add(new Object[] { mSourceToTSource, tFlow, mTarget, mFlowToTFlow,
												mSource, tSource });
									}
								}
							}
	...
	public static final Object[] pattern_DataFlowIn_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource, isApplicableMatch,
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(DataFlowIn _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mSourceToTSource, tFlow, mTarget,
				mFlowToTFlow, mSource, tSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSourceToTSource, tFlow, mTarget, mFlowToTFlow,
					mSource, tSource };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingAndBlackFBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_2_4_solveCSP_binding = pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource);
	...
	public static final void pattern_DataFlowIn_11_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			PerformRuleResult ruleresult, EObject mSourceToTSource, EObject tFlow, EObject mTarget,
			EObject mFlowToTFlow, EObject mSource, EObject tSource) {
		_this.registerObjects_BWD(ruleresult, mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource);
	...
	public static final Iterable<Object[]> pattern_DataFlowIn_12_2_corematch_blackFBFFFBB(TAbstractFlowElement tFlow,
	...
	public static final Object[] pattern_DataFlowIn_12_4_solveCSP_bindingFBBBBBBBB(DataFlowIn _this,
			...
			TAbstractFlowElement tFlow, MAbstractFlowElement mTarget,
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow, MFlow mSource, TAbstractFlowElement tSource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mSourceToTSource, tFlow, mTarget,
				mFlowToTFlow, mSource, tSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSourceToTSource, tFlow, mTarget, mFlowToTFlow,
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(DataFlowIn _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mSourceToTSource, tFlow, mTarget,
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_29_3_solveCSP_binding = pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mSourceToTSource, tFlow, mTarget, mFlowToTFlow, mSource, tSource, ruleResult);
