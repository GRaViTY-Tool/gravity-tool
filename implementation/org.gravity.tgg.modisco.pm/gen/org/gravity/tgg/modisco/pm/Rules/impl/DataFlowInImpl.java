...
public class DataFlowInImpl extends AbstractRuleImpl implements DataFlowIn {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = DataFlowInImpl.pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tFlow] = " + tFlow + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mSource] = "
					+ mSource + ", " + "[mTarget] = " + mTarget + ", " + "[mSourceToTSource] = " + mSourceToTSource
					+ ", " + "[tSource] = " + tSource + ".");
		}
		DataFlowInImpl.pattern_DataFlowIn_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, tFlow, mSource, mTarget,
				tSource);
		...
		// 
		// 
		DataFlowInImpl.pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tFlow, mFlowToTFlow,
				mSource, mTarget, mSourceToTSource, tSource);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : DataFlowInImpl.pattern_DataFlowIn_2_2_corematch_blackFFBBFFB(mSource, mTarget,
			...
			// ForEach 
			for (Object[] result3_black : DataFlowInImpl.pattern_DataFlowIn_2_3_findcontext_blackBBBBBB(tFlow,
					mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TAbstractFlowElement tFlow,
			...
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tSource) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tFlow, EObject mFlowToTFlow, EObject mSource,
			EObject mTarget, EObject mSourceToTSource, EObject tSource) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		DataFlowInImpl.pattern_DataFlowIn_11_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, tFlow, mSource, mTarget,
				tSource);
		//nothing EMoflonEdge mTarget__mSource____incomingFlows = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge mSource__mTarget____flowTarget = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge tFlow__tSource____incomingFlows = (EMoflonEdge) result3_green[7];
		...
		// 
		// 
		DataFlowInImpl.pattern_DataFlowIn_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tFlow, mFlowToTFlow,
				mSource, mTarget, mSourceToTSource, tSource);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : DataFlowInImpl.pattern_DataFlowIn_12_2_corematch_blackBFFFFBB(tFlow, tSource,
				match)) {
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow = (MAbstractFlowElementToTAbstractFlowElement) result2_black[1];
			...
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource = (MAbstractFlowElementToTAbstractFlowElement) result2_black[4];
			// ForEach 
			for (Object[] result3_black : DataFlowInImpl.pattern_DataFlowIn_12_3_findcontext_blackBBBBBB(tFlow,
					mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource)) {
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tFlow, EObject mFlowToTFlow, EObject mSource,
			EObject mTarget, EObject mSourceToTSource, EObject tSource) {
		ruleresult.registerObject("tFlow", tFlow);
		ruleresult.registerObject("mFlowToTFlow", mFlowToTFlow);
		ruleresult.registerObject("mSource", mSource);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_60(EMoflonEdge _edge_incomingFlows) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = DataFlowInImpl.pattern_DataFlowIn_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
				tFlow, mSource, mTarget, tSource, sourceMatch, targetMatch);
		...
		if (DataFlowInImpl.pattern_DataFlowIn_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : DataFlowInImpl.pattern_DataFlowIn_24_5_matchcorrcontext_blackBFBBFBBB(tFlow,
					mSource, mTarget, tSource, sourceMatch, targetMatch)) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TAbstractFlowElement tFlow, MFlow mSource, MAbstractFlowElement mTarget,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : DataFlowInImpl
			...
			Object[] result3_bindingAndBlack = DataFlowInImpl
					.pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, tFlow,
							mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tFlow] = " + tFlow + ", "
						+ "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mSource] = " + mSource + ", " + "[mTarget] = "
						+ mTarget + ", " + "[mSourceToTSource] = " + mSourceToTSource + ", " + "[tSource] = " + tSource
			...
			if (DataFlowInImpl.pattern_DataFlowIn_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = DataFlowInImpl.pattern_DataFlowIn_29_5_checknacs_blackBBBBBB(tFlow,
						mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource);
				if (result5_black != null) {

					Object[] result6_black = DataFlowInImpl.pattern_DataFlowIn_29_6_perform_blackBBBBBBB(tFlow,
							mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tFlow] = " + tFlow
								+ ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mSource] = " + mSource + ", "
					...
					DataFlowInImpl.pattern_DataFlowIn_29_6_perform_greenBBBBB(tFlow, mSource, mTarget, tSource,
							ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.DATA_FLOW_IN___IS_APPROPRIATE_BWD_EMOFLON_EDGE_60__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_60((EMoflonEdge) arguments.get(0));
			case RulesPackage.DATA_FLOW_IN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_64__EMOFLONEDGE:
					...
					if (tmpMTarget instanceof MAbstractFlowElement) {
						...
						if (tmpMSourceToTSource instanceof MAbstractFlowElementToTAbstractFlowElement) {
							...
							if (tmpTSource instanceof TAbstractFlowElement) {
								...
								return new Object[] { tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_DataFlowIn_1_1_performtransformation_blackBBBBBBFBB(TAbstractFlowElement tFlow,
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow, MFlow mSource, MAbstractFlowElement mTarget,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tSource, DataFlowIn _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!mSource.equals(mTarget)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource, csp,
	...
	public static final Object[] pattern_DataFlowIn_1_1_performtransformation_bindingAndBlackFFFFFFFBB(DataFlowIn _this,
		...
		if (result_pattern_DataFlowIn_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_DataFlowIn_1_1_performtransformation_black = pattern_DataFlowIn_1_1_performtransformation_blackBBBBBBFBB(
					tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource, _this, isApplicableMatch);
			if (result_pattern_DataFlowIn_1_1_performtransformation_black != null) {
				...
				return new Object[] { tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowIn_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject tFlow, EObject mFlowToTFlow, EObject mSource, EObject mTarget, EObject mSourceToTSource,
			EObject tSource) {
		if (!tFlow.equals(tSource)) {
	...
	public static final Object[] pattern_DataFlowIn_1_3_bookkeepingforedges_greenBBBBBFFFF(PerformRuleResult ruleresult,
			EObject tFlow, EObject mSource, EObject mTarget, EObject tSource) {
		EMoflonEdge mTarget__mSource____incomingFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mSource__mTarget____flowTarget = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, tFlow, mSource, mTarget, tSource, mTarget__mSource____incomingFlows,
	...
	public static final void pattern_DataFlowIn_1_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			PerformRuleResult ruleresult, EObject tFlow, EObject mFlowToTFlow, EObject mSource, EObject mTarget,
			EObject mSourceToTSource, EObject tSource) {
		_this.registerObjects_FWD(ruleresult, tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource);
				...
				if (tFlow != null) {
					for (MAbstractFlowElementToTAbstractFlowElement mSourceToTSource : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mFlowToTFlow.equals(mSourceToTSource)) {
							...
							if (tSource != null) {
								if (!tFlow.equals(tSource)) {
									_result.add(new Object[] { tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource,
											tSource, match });
								}
							}
							...
							if (mSource.equals(mSourceToTSource.getSource())) {
								if (mTarget.getIncomingFlows().contains(mSource)) {
									if (tSource.equals(mSourceToTSource.getTarget())) {
										_result.add(new Object[] { tFlow, mFlowToTFlow, mSource, mTarget,
												mSourceToTSource, tSource });
									}
								}
							}
	...
	public static final Object[] pattern_DataFlowIn_2_3_findcontext_greenBBBBBBFFFFFFF(TAbstractFlowElement tFlow,
		...
		return new Object[] { tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource, isApplicableMatch,
				mFlowToTFlow__tFlow____target, mFlowToTFlow__mTarget____source, mSourceToTSource__mSource____source,
				mTarget__mSource____incomingFlows, mSource__mTarget____flowTarget,
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(DataFlowIn _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow, MFlow mSource, MAbstractFlowElement mTarget,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tSource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tFlow, mFlowToTFlow, mSource, mTarget,
				mSourceToTSource, tSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tFlow, mFlowToTFlow, mSource, mTarget,
					mSourceToTSource, tSource };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_2_4_solveCSP_bindingAndBlackFBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_2_4_solveCSP_binding = pattern_DataFlowIn_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource);
	...
	public static final Object[] pattern_DataFlowIn_11_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject tFlow, EObject mSource, EObject mTarget, EObject tSource) {
		EMoflonEdge mTarget__mSource____incomingFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mSource__mTarget____flowTarget = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tFlow__tSource____incomingFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tSource__tFlow____outgoingFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_DataFlowIn_11_5_registerobjects_expressionBBBBBBBB(DataFlowIn _this,
			PerformRuleResult ruleresult, EObject tFlow, EObject mFlowToTFlow, EObject mSource, EObject mTarget,
			EObject mSourceToTSource, EObject tSource) {
		_this.registerObjects_BWD(ruleresult, tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource);
	...
	public static final Iterable<Object[]> pattern_DataFlowIn_12_2_corematch_blackBFFFFBB(TAbstractFlowElement tFlow,
	...
	public static final Object[] pattern_DataFlowIn_12_4_solveCSP_bindingFBBBBBBBB(DataFlowIn _this,
			...
			MAbstractFlowElementToTAbstractFlowElement mFlowToTFlow, MFlow mSource, MAbstractFlowElement mTarget,
			MAbstractFlowElementToTAbstractFlowElement mSourceToTSource, TAbstractFlowElement tSource) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tFlow, mFlowToTFlow, mSource, mTarget,
				mSourceToTSource, tSource);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tFlow, mFlowToTFlow, mSource, mTarget,
		...
		if (tmpTFlow instanceof TAbstractFlowElement) {
			...
			if (tmpMSource instanceof MFlow) {
				...
				if (tmpMTarget instanceof MAbstractFlowElement) {
					...
					if (tmpTSource instanceof TAbstractFlowElement) {
						TAbstractFlowElement tSource = (TAbstractFlowElement) tmpTSource;
						return new Object[] { tFlow, mSource, mTarget, tSource, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_DataFlowIn_24_2_matchsrctrgcontext_blackBBBBBB(TAbstractFlowElement tFlow,
			MFlow mSource, MAbstractFlowElement mTarget, TAbstractFlowElement tSource, Match sourceMatch,
			Match targetMatch) {
		if (!tFlow.equals(tSource)) {
			if (!mSource.equals(mTarget)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tFlow, mSource, mTarget, tSource, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_DataFlowIn_24_3_solvecsp_bindingFBBBBBBB(DataFlowIn _this,
			TAbstractFlowElement tFlow, MFlow mSource, MAbstractFlowElement mTarget, TAbstractFlowElement tSource,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tFlow, mSource, mTarget, tSource, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tFlow, mSource, mTarget, tSource, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_24_3_solvecsp_bindingAndBlackFBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_24_3_solvecsp_binding = pattern_DataFlowIn_24_3_solvecsp_bindingFBBBBBBB(
				_this, tFlow, mSource, mTarget, tSource, sourceMatch, targetMatch);
						...
						if (mTarget.equals(mFlowToTFlow.getSource())) {
							for (MAbstractFlowElementToTAbstractFlowElement mSourceToTSource : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!mFlowToTFlow.equals(mSourceToTSource)) {
									if (tSource.equals(mSourceToTSource.getTarget())) {
										_result.add(new Object[] { tFlow, mFlowToTFlow, mSource, mTarget,
												mSourceToTSource, tSource, sourceMatch, targetMatch });
									}
								}
							}
						}
	...
	public static final Object[] pattern_DataFlowIn_24_6_createcorrespondence_blackBBBBB(TAbstractFlowElement tFlow,
			MFlow mSource, MAbstractFlowElement mTarget, TAbstractFlowElement tSource, CCMatch ccMatch) {
		if (!tFlow.equals(tSource)) {
			if (!mSource.equals(mTarget)) {
				return new Object[] { tFlow, mSource, mTarget, tSource, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(DataFlowIn _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tFlow, mFlowToTFlow, mSource,
				mTarget, mSourceToTSource, tSource, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tFlow, mFlowToTFlow, mSource, mTarget,
					mSourceToTSource, tSource, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_DataFlowIn_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(DataFlowIn _this,
		...
		Object[] result_pattern_DataFlowIn_29_3_solveCSP_binding = pattern_DataFlowIn_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tFlow, mFlowToTFlow, mSource, mTarget, mSourceToTSource, tSource, ruleResult);
	...
	public static final Object[] pattern_DataFlowIn_29_6_perform_greenBBBBB(TAbstractFlowElement tFlow, MFlow mSource,
		...
		return new Object[] { tFlow, mSource, mTarget, tSource, ruleResult };
	}
