...
public class LinkDefinitionToAnonymousImpl extends AbstractRuleImpl implements LinkDefinitionToAnonymous {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, MDefinition mDefinition, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, MSignature mSignature) {

		Object[] result1_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_0_1_initialbindings_blackBBBBBB(this, match, mDefinition, mInstance,
						mAnonymous, mSignature);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[mDefinition] = " + mDefinition + ", " + "[mInstance] = "
					+ mInstance + ", " + "[mAnonymous] = " + mAnonymous + ", " + "[mSignature] = " + mSignature + ".");
		}
		...
		Object[] result2_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, mDefinition,
						mInstance, mAnonymous, mSignature);
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_0_5_collectcontextelements_greenBBBBBFFFF(
					match, mDefinition, mInstance, mAnonymous, mSignature);
			...
			LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_0_6_registerobjectstomatch_expressionBBBBBB(
					this, match, mDefinition, mInstance, mAnonymous, mSignature);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ClassInstanceCreation mInstance = (ClassInstanceCreation) result1_bindingAndBlack[4];
		...
		Object[] result3_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, tSignature,
						mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature, mInstance, mAnonymous, tAnonymous,
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ mSignatureToTSignature + ", " + "[mInstance] = " + mInstance + ", " + "[mAnonymous] = "
					+ mAnonymous + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[tDefinition] = " + tDefinition
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, tSignature, mDefinition, mAnonymous, tAnonymous, tDefinition);
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBBB(this,
				ruleresult, tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature, mInstance,
				mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFBFFBBFFBFB(mDefinition, mInstance, mAnonymous,
						mSignature, match)) {
			...
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_2_3_findcontext_blackBBBBBBBBBB(tSignature, mDefinition,
							mAnonymousToTAnonymous, mSignatureToTSignature, mInstance, mAnonymous, tAnonymous,
							tDefinition, mSignature, mDefinitionToTMember)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFFF(tSignature,
								mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature, mInstance, mAnonymous,
								tAnonymous, tDefinition, mSignature, mDefinitionToTMember);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, tSignature, mDefinition, mAnonymousToTAnonymous,
								mSignatureToTSignature, mInstance, mAnonymous, tAnonymous, tDefinition, mSignature,
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, MDefinition mDefinition, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, MSignature mSignature) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, MDefinition mDefinition, ClassInstanceCreation mInstance,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TSignature tSignature,
			MDefinition mDefinition, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous,
			MSignatureToTSignature mSignatureToTSignature, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, TClass tAnonymous, TMember tDefinition, MSignature mSignature,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tSignature, EObject mDefinition,
			EObject mAnonymousToTAnonymous, EObject mSignatureToTSignature, EObject mInstance, EObject mAnonymous,
			EObject tAnonymous, EObject tDefinition, EObject mSignature, EObject mDefinitionToTMember) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBBB(
				this, ruleresult, tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature, mInstance,
				mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_12_2_corematch_blackBFFFFBBFFB(tSignature, tAnonymous, tDefinition,
						match)) {
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_12_3_findcontext_blackBBBBFBBBBB(tSignature, mDefinition,
							mAnonymousToTAnonymous, mSignatureToTSignature, mAnonymous, tAnonymous, tDefinition,
							mSignature, mDefinitionToTMember)) {
				ClassInstanceCreation mInstance = (ClassInstanceCreation) result3_black[4];
				Object[] result3_green = LinkDefinitionToAnonymousImpl
				...
				//nothing EMoflonEdge mDefinitionToTMember__mDefinition____source = (EMoflonEdge) result3_green[22];
				//nothing EMoflonEdge mDefinitionToTMember__tDefinition____target = (EMoflonEdge) result3_green[23];
				//nothing EMoflonEdge tAnonymous__tSignature____signature = (EMoflonEdge) result3_green[24];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tSignature, EObject mDefinition,
			EObject mAnonymousToTAnonymous, EObject mSignatureToTSignature, EObject mInstance, EObject mAnonymous,
			EObject tAnonymous, EObject tDefinition, EObject mSignature, EObject mDefinitionToTMember) {
		ruleresult.registerObject("tSignature", tSignature);
		ruleresult.registerObject("mDefinition", mDefinition);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_186(EMoflonEdge _edge_defines) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, tSignature,
						mDefinition, mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, sourceMatch,
						targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tSignature] = " + tSignature + ", " + "[mDefinition] = " + mDefinition + ", " + "[mInstance] = "
					+ mInstance + ", " + "[mAnonymous] = " + mAnonymous + ", " + "[tAnonymous] = " + tAnonymous + ", "
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackBBFFBBBBFBB(tSignature, mDefinition,
							mAnonymous, tAnonymous, tDefinition, mSignature, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBBB(tSignature,
								mDefinition, mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tSignature] = "
							+ tSignature + ", " + "[mDefinition] = " + mDefinition + ", " + "[mInstance] = " + mInstance
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TSignature tSignature, MDefinition mDefinition, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, TClass tAnonymous, TMember tDefinition, MSignature mSignature,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(MDefinition mDefinition, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, MSignature mSignature) {// 
		Object[] result1_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_27_1_matchtggpattern_blackBBBB(mDefinition, mInstance, mAnonymous,
						mSignature);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
			...
			ClassInstanceCreation mInstance = (ClassInstanceCreation) result2_black[10];
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBBB(this,
							isApplicableMatch, tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature,
							mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tSignature] = " + tSignature + ", "
			...
			if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_29_5_checknacs_blackBBBBBBBBBB(tSignature, mDefinition,
								mAnonymousToTAnonymous, mSignatureToTSignature, mInstance, mAnonymous, tAnonymous,
								tDefinition, mSignature, mDefinitionToTMember);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToAnonymousImpl
							.pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBBB(tSignature, mDefinition,
									mAnonymousToTAnonymous, mSignatureToTSignature, mInstance, mAnonymous, tAnonymous,
									tDefinition, mSignature, mDefinitionToTMember, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tSignature] = "
								+ tSignature + ", " + "[mDefinition] = " + mDefinition + ", "
								+ "[mAnonymousToTAnonymous] = " + mAnonymousToTAnonymous + ", "
								+ "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[mInstance] = "
								+ mInstance + ", " + "[mAnonymous] = " + mAnonymous + ", " + "[tAnonymous] = "
								+ tAnonymous + ", " + "[tDefinition] = " + tDefinition + ", " + "[mSignature] = "
					...
					LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(tSignature,
							mDefinition, mAnonymous, tAnonymous, tDefinition, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_FWD__MATCH_MDEFINITION_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATION_MSIGNATURE:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MDEFINITION_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATION_MSIGNATURE:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (MDefinition) arguments.get(1),
					(ClassInstanceCreation) arguments.get(2), (AnonymousClassDeclaration) arguments.get(3),
					(MSignature) arguments.get(4));
			return null;
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MDEFINITION_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATION_MSIGNATURE:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TSIGNATURE_MDEFINITION_ANONYMOUSCLASSDECLARATIONTOTCLASS_MSIGNATURETOTSIGNATURE_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATION_TCLASS_TMEMBER_MSIGNATURE_MDEFINITIONTOTMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TSignature) arguments.get(1),
					(MDefinition) arguments.get(2), (AnonymousClassDeclarationToTClass) arguments.get(3),
					(MSignatureToTSignature) arguments.get(4), (ClassInstanceCreation) arguments.get(5),
					(AnonymousClassDeclaration) arguments.get(6), (TClass) arguments.get(7), (TMember) arguments.get(8),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TSIGNATURE_MDEFINITION_ANONYMOUSCLASSDECLARATIONTOTCLASS_MSIGNATURETOTSIGNATURE_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATION_TCLASS_TMEMBER_MSIGNATURE_MDEFINITIONTOTMEMBER:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_186__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__TSIGNATURE_MDEFINITION_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATION_TCLASS_TMEMBER_MSIGNATURE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TSignature) arguments.get(0), (MDefinition) arguments.get(1),
					(ClassInstanceCreation) arguments.get(2), (AnonymousClassDeclaration) arguments.get(3),
					(TClass) arguments.get(4), (TMember) arguments.get(5), (MSignature) arguments.get(6),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___CHECK_DEC_FWD__MDEFINITION_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATION_MSIGNATURE:
			return checkDEC_FWD((MDefinition) arguments.get(0), (ClassInstanceCreation) arguments.get(1),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TSIGNATURE_MDEFINITION_ANONYMOUSCLASSDECLARATIONTOTCLASS_MSIGNATURETOTSIGNATURE_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATION_TCLASS_TMEMBER_MSIGNATURE_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_0_1_initialbindings_blackBBBBBB(
			LinkDefinitionToAnonymous _this, Match match, MDefinition mDefinition, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, MSignature mSignature) {
		return new Object[] { _this, match, mDefinition, mInstance, mAnonymous, mSignature };
	}

	public static final Object[] pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_bindingFBBBBBB(
			LinkDefinitionToAnonymous _this, Match match, MDefinition mDefinition, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, MSignature mSignature) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, mDefinition, mInstance, mAnonymous, mSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, mDefinition, mInstance, mAnonymous, mSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_binding = pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, mDefinition, mInstance, mAnonymous, mSignature);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_0_4_collectelementstobetranslated_blackBBBBB(
			Match match, MDefinition mDefinition, ClassInstanceCreation mInstance, AnonymousClassDeclaration mAnonymous,
			MSignature mSignature) {
		return new Object[] { match, mDefinition, mInstance, mAnonymous, mSignature };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_0_5_collectcontextelements_blackBBBBB(Match match,
			MDefinition mDefinition, ClassInstanceCreation mInstance, AnonymousClassDeclaration mAnonymous,
			MSignature mSignature) {
		return new Object[] { match, mDefinition, mInstance, mAnonymous, mSignature };
	}
	...
	public static final void pattern_LinkDefinitionToAnonymous_0_6_registerobjectstomatch_expressionBBBBBB(
			LinkDefinitionToAnonymous _this, Match match, MDefinition mDefinition, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, MSignature mSignature) {
		_this.registerObjectsToMatch_FWD(match, mDefinition, mInstance, mAnonymous, mSignature);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_bindingFFFFFFFFFFB(
		...
		EObject _localVariable_4 = isApplicableMatch.getObject("mInstance");
									...
									if (tmpTDefinition instanceof TMember) {
										...
										if (tmpMSignature instanceof MSignature) {
											...
											if (tmpMDefinitionToTMember instanceof MDefinitionToTMember) {
												...
												return new Object[] { tSignature, mDefinition, mAnonymousToTAnonymous,
														mSignatureToTSignature, mInstance, mAnonymous, tAnonymous,
														tDefinition, mSignature, mDefinitionToTMember,
														isApplicableMatch };
											}
										}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBBFBB(
			TSignature tSignature, MDefinition mDefinition, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous,
			MSignatureToTSignature mSignatureToTSignature, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, TClass tAnonymous, TMember tDefinition, MSignature mSignature,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature,
						mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding != null) {
			...
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding[3];
			ClassInstanceCreation mInstance = (ClassInstanceCreation) result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_black = pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBBFBB(
					tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature, mInstance, mAnonymous,
					tAnonymous, tDefinition, mSignature, mDefinitionToTMember, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tSignature, EObject mDefinition, EObject mAnonymousToTAnonymous,
			EObject mSignatureToTSignature, EObject mInstance, EObject mAnonymous, EObject tAnonymous,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tSignature, EObject mDefinition, EObject mAnonymous,
		...
		return new Object[] { ruleresult, tSignature, mDefinition, mAnonymous, tAnonymous, tDefinition,
	...
	public static final void pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBBB(
			LinkDefinitionToAnonymous _this, PerformRuleResult ruleresult, EObject tSignature, EObject mDefinition,
			EObject mAnonymousToTAnonymous, EObject mSignatureToTSignature, EObject mInstance, EObject mAnonymous,
			EObject tAnonymous, EObject tDefinition, EObject mSignature, EObject mDefinitionToTMember) {
		_this.registerObjects_FWD(ruleresult, tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature,
				mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember);
		...
		if (tmpMDefinition instanceof MDefinition) {
			...
			if (tmpMInstance instanceof ClassInstanceCreation) {
				...
				if (tmpMAnonymous instanceof AnonymousClassDeclaration) {
					...
					if (tmpMSignature instanceof MSignature) {
						MSignature mSignature = (MSignature) tmpMSignature;
						return new Object[] { mDefinition, mInstance, mAnonymous, mSignature, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFBFFBBFFBFB(
			MDefinition mDefinition, ClassInstanceCreation mInstance, AnonymousClassDeclaration mAnonymous,
				...
				for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tDefinition != null) {
						for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tSignature != null) {
								_result.add(new Object[] { tSignature, mDefinition, mAnonymousToTAnonymous,
										mSignatureToTSignature, mInstance, mAnonymous, tAnonymous, tDefinition,
										mSignature, mDefinitionToTMember, match });
							}
									...
									if (mDefinition.equals(mDefinitionToTMember.getSource())) {
										if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
											if (mSignature.equals(mSignatureToTSignature.getSource())) {
												_result.add(new Object[] { tSignature, mDefinition,
														mAnonymousToTAnonymous, mSignatureToTSignature, mInstance,
														mAnonymous, tAnonymous, tDefinition, mSignature,
														mDefinitionToTMember });
											}
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
		...
		return new Object[] { tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature, mInstance,
				mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember, isApplicableMatch,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBBB(
			...
			AnonymousClassDeclaration mAnonymous, TClass tAnonymous, TMember tDefinition, MSignature mSignature,
			MDefinitionToTMember mDefinitionToTMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tSignature, mDefinition,
				mAnonymousToTAnonymous, mSignatureToTSignature, mInstance, mAnonymous, tAnonymous, tDefinition,
				mSignature, mDefinitionToTMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSignature, mDefinition, mAnonymousToTAnonymous,
					mSignatureToTSignature, mInstance, mAnonymous, tAnonymous, tDefinition, mSignature,
					mDefinitionToTMember };
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding = pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature,
				mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_11_1_performtransformation_binding != null) {
			...
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result_pattern_LinkDefinitionToAnonymous_11_1_performtransformation_binding[3];
			ClassInstanceCreation mInstance = (ClassInstanceCreation) result_pattern_LinkDefinitionToAnonymous_11_1_performtransformation_binding[4];
	...
	public static final void pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject mAnonymousToTAnonymous, EObject mSignatureToTSignature, EObject mInstance, EObject mAnonymous,
			EObject tAnonymous, EObject tDefinition, EObject mSignature, EObject mDefinitionToTMember) {
		_this.registerObjects_BWD(ruleresult, tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature,
				mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_12_2_corematch_blackBFFFFBBFFB(
					...
					if (mAnonymous != null) {
						for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tmpMDefinition instanceof MDefinition) {
								MDefinition mDefinition = (MDefinition) tmpMDefinition;
								_result.add(new Object[] { tSignature, mDefinition, mAnonymousToTAnonymous,
										mSignatureToTSignature, mAnonymous, tAnonymous, tDefinition, mSignature,
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_12_3_findcontext_blackBBBBFBBBBB(
			TSignature tSignature, MDefinition mDefinition, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous,
			MSignatureToTSignature mSignatureToTSignature, AnonymousClassDeclaration mAnonymous, TClass tAnonymous,
			TMember tDefinition, MSignature mSignature, MDefinitionToTMember mDefinitionToTMember) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (mAnonymous.equals(mAnonymousToTAnonymous.getSource())) {
			if (tSignature.equals(mSignatureToTSignature.getTarget())) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			...
			AnonymousClassDeclaration mAnonymous, TClass tAnonymous, TMember tDefinition, MSignature mSignature,
			MDefinitionToTMember mDefinitionToTMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tSignature, mDefinition,
				mAnonymousToTAnonymous, mSignatureToTSignature, mInstance, mAnonymous, tAnonymous, tDefinition,
				mSignature, mDefinitionToTMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			...
			if (tmpMDefinition instanceof MDefinition) {
				...
				if (mAnonymous.getBodyDeclarations().contains(mDefinition)) {
					...
					if (mInstance != null) {
						...
						if (mSignature != null) {
							_result.add(new Object[] { mDefinition, mInstance, mAnonymous, mSignature,
	...
	public static final boolean pattern_LinkDefinitionToAnonymous_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			LinkDefinitionToAnonymous _this, Match match, MDefinition mDefinition, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, MSignature mSignature) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, mDefinition, mInstance, mAnonymous, mSignature);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
					...
					if (tmpMAnonymous instanceof AnonymousClassDeclaration) {
						...
						if (tmpTAnonymous instanceof TClass) {
							...
							if (tmpTDefinition instanceof TMember) {
								...
								if (tmpMSignature instanceof MSignature) {
									MSignature mSignature = (MSignature) tmpMSignature;
									return new Object[] { tSignature, mDefinition, mInstance, mAnonymous, tAnonymous,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			TSignature tSignature, MDefinition mDefinition, ClassInstanceCreation mInstance,
			AnonymousClassDeclaration mAnonymous, TClass tAnonymous, TMember tDefinition, MSignature mSignature,
			Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tSignature, mDefinition, mInstance, mAnonymous, tAnonymous, tDefinition, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			MDefinition mDefinition = (MDefinition) result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding[1];
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					tSignature, mDefinition, mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, sourceMatch,
					targetMatch);
			if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { tSignature, mDefinition, mInstance, mAnonymous, tAnonymous, tDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBBB(
			LinkDefinitionToAnonymous _this, TSignature tSignature, MDefinition mDefinition,
			ClassInstanceCreation mInstance, AnonymousClassDeclaration mAnonymous, TClass tAnonymous,
			TMember tDefinition, MSignature mSignature, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(tSignature, mDefinition, mInstance, mAnonymous,
				tAnonymous, tDefinition, mSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, tSignature, mDefinition, mInstance, mAnonymous, tAnonymous, tDefinition,
					mSignature, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding = pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, tSignature, mDefinition, mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, sourceMatch,
				targetMatch);
		if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tSignature, mDefinition, mInstance, mAnonymous, tAnonymous,
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackBBFFBBBBFBB(
			TSignature tSignature, MDefinition mDefinition, AnonymousClassDeclaration mAnonymous, TClass tAnonymous,
			TMember tDefinition, MSignature mSignature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (AnonymousClassDeclarationToTClass mAnonymousToTAnonymous : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_27_1_matchtggpattern_blackBBBB(
		...
		if (mAnonymous.equals(mInstance.getAnonymousClassDeclaration())) {
			if (mAnonymous.getBodyDeclarations().contains(mDefinition)) {
				if (mSignature.getMDefinitions().contains(mDefinition)) {
					return new Object[] { mDefinition, mInstance, mAnonymous, mSignature };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingFBBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tSignature, mDefinition,
				mAnonymousToTAnonymous, mSignatureToTSignature, mInstance, mAnonymous, tAnonymous, tDefinition,
				mSignature, mDefinitionToTMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSignature, mDefinition, mAnonymousToTAnonymous,
					mSignatureToTSignature, mInstance, mAnonymous, tAnonymous, tDefinition, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_29_3_solveCSP_binding = pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingFBBBBBBBBBBBBB(
				_this, isApplicableMatch, tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature,
				mInstance, mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember, ruleResult);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBBB(TSignature tSignature,
			...
			MDefinitionToTMember mDefinitionToTMember, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tSignature, mDefinition, mAnonymousToTAnonymous, mSignatureToTSignature, mInstance,
				mAnonymous, tAnonymous, tDefinition, mSignature, mDefinitionToTMember, ruleResult };
	}

	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(TSignature tSignature,
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous, TClass tAnonymous, TMember tDefinition,
		...
		return new Object[] { tSignature, mDefinition, mAnonymous, tAnonymous, tDefinition, ruleResult };
	}
