...
public class LinkDefinitionToAnonymousImpl extends AbstractRuleImpl implements LinkDefinitionToAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous, tDefinition,
						mSignatureToTSignature, mAnonymous, tSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember + ", " + "[mAnonymousToTAnonymous] = "
					+ mAnonymousToTAnonymous + ", " + "[mSignature] = " + mSignature + ", " + "[mDefinition] = "
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature);
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous,
				tDefinition, mSignatureToTSignature, mAnonymous, tSignature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFFBBFFFBFB(mSignature, mDefinition, mAnonymous,
						match)) {
			...
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_2_3_findcontext_blackBBBBBBBBB(mDefinitionToTMember,
							mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous, tDefinition,
							mSignatureToTSignature, mAnonymous, tSignature)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
								mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous,
								tDefinition, mSignatureToTSignature, mAnonymous, tSignature);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, mDefinitionToTMember, mAnonymousToTAnonymous, mSignature,
								mDefinition, tAnonymous, tDefinition, mSignatureToTSignature, mAnonymous, tSignature);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinitionToTMember mDefinitionToTMember,
			AnonymousClassDeclarationToTClass mAnonymousToTAnonymous, MSignature mSignature, MDefinition mDefinition,
			TClass tAnonymous, TMember tDefinition, MSignatureToTSignature mSignatureToTSignature,
			AnonymousClassDeclaration mAnonymous, TSignature tSignature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mDefinitionToTMember,
			EObject mAnonymousToTAnonymous, EObject mSignature, EObject mDefinition, EObject tAnonymous,
			EObject tDefinition, EObject mSignatureToTSignature, EObject mAnonymous, EObject tSignature) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFFFFBBFFBB(tAnonymous, tDefinition, tSignature,
						match)) {
			MDefinitionToTMember mDefinitionToTMember = (MDefinitionToTMember) result2_black[0];
			AnonymousClassDeclarationToTClass mAnonymousToTAnonymous = (AnonymousClassDeclarationToTClass) result2_black[1];
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_12_3_findcontext_blackBBBBBBBBB(mDefinitionToTMember,
							mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous, tDefinition,
							mSignatureToTSignature, mAnonymous, tSignature)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_96(EMoflonEdge _edge_signature) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mSignature,
						mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature, sourceMatch, targetMatch);
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackFFBBBBFBBBB(mSignature, mDefinition,
							tAnonymous, tDefinition, mAnonymous, tSignature, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(mSignature,
								mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MSignature mSignature, MDefinition mDefinition, TClass tAnonymous,
			TMember tDefinition, AnonymousClassDeclaration mAnonymous, TSignature tSignature, Match sourceMatch,
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition,
							tAnonymous, tDefinition, mSignatureToTSignature, mAnonymous, tSignature, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinitionToTMember] = "
						+ mDefinitionToTMember + ", " + "[mAnonymousToTAnonymous] = " + mAnonymousToTAnonymous + ", "
				...
				if (result5_black != null) {
					...
					Object[] result6_black = LinkDefinitionToAnonymousImpl
							.pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBB(mDefinitionToTMember,
									mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous, tDefinition,
									mSignatureToTSignature, mAnonymous, tSignature, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching failed." + " Variables: " + "[mDefinitionToTMember] = "
										+ mDefinitionToTMember + ", " + "[mAnonymousToTAnonymous] = "
										+ mAnonymousToTAnonymous + ", " + "[mSignature] = " + mSignature + ", "
										+ "[mDefinition] = " + mDefinition + ", " + "[tAnonymous] = " + tAnonymous
					...
					LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(
							mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			...
			MSignature mSignature, MDefinition mDefinition, TClass tAnonymous, TMember tDefinition,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_ANONYMOUSCLASSDECLARATIONTOTCLASS_MSIGNATURE_MDEFINITION_TCLASS_TMEMBER_MSIGNATURETOTSIGNATURE_ANONYMOUSCLASSDECLARATION_TSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (AnonymousClassDeclarationToTClass) arguments.get(2),
					(MSignature) arguments.get(3), (MDefinition) arguments.get(4), (TClass) arguments.get(5),
					(TMember) arguments.get(6), (MSignatureToTSignature) arguments.get(7),
					(AnonymousClassDeclaration) arguments.get(8), (TSignature) arguments.get(9));
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_ANONYMOUSCLASSDECLARATIONTOTCLASS_MSIGNATURE_MDEFINITION_TCLASS_TMEMBER_MSIGNATURETOTSIGNATURE_ANONYMOUSCLASSDECLARATION_TSIGNATURE:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_96__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_96((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_101__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__MSIGNATURE_MDEFINITION_TCLASS_TMEMBER_ANONYMOUSCLASSDECLARATION_TSIGNATURE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MSignature) arguments.get(0), (MDefinition) arguments.get(1),
					(TClass) arguments.get(2), (TMember) arguments.get(3), (AnonymousClassDeclaration) arguments.get(4),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_ANONYMOUSCLASSDECLARATIONTOTCLASS_MSIGNATURE_MDEFINITION_TCLASS_TMEMBER_MSIGNATURETOTSIGNATURE_ANONYMOUSCLASSDECLARATION_TSIGNATURE_MODELGENERATORRULERESULT:
									...
									if (tmpMAnonymous instanceof AnonymousClassDeclaration) {
										...
										if (tmpTSignature instanceof TSignature) {
											...
											return new Object[] { mDefinitionToTMember, mAnonymousToTAnonymous,
													mSignature, mDefinition, tAnonymous, tDefinition,
													mSignatureToTSignature, mAnonymous, tSignature, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous,
						tDefinition, mSignatureToTSignature, mAnonymous, tSignature, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_black = pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
					mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous, tDefinition,
					mSignatureToTSignature, mAnonymous, tSignature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject mSignature, EObject mDefinition, EObject tAnonymous, EObject tDefinition,
			EObject mSignatureToTSignature, EObject mAnonymous, EObject tSignature) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mDefinition, EObject tAnonymous, EObject tDefinition,
		...
		mDefinition__mAnonymous____anonymousClassDeclarationOwner
				.setName(mDefinition__mAnonymous____anonymousClassDeclarationOwner_name_prime);
		return new Object[] { ruleresult, mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature,
	...
	public static final void pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mAnonymousToTAnonymous, EObject mSignature, EObject mDefinition, EObject tAnonymous,
			EObject tDefinition, EObject mSignatureToTSignature, EObject mAnonymous, EObject tSignature) {
		_this.registerObjects_FWD(ruleresult, mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition,
				tAnonymous, tDefinition, mSignatureToTSignature, mAnonymous, tSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFFBBFFFBFB(
				...
				for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tSignature != null) {
						for (AnonymousClassDeclarationToTClass mAnonymousToTAnonymous : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tAnonymous != null) {
								_result.add(new Object[] { mDefinitionToTMember, mAnonymousToTAnonymous, mSignature,
										mDefinition, tAnonymous, tDefinition, mSignatureToTSignature, mAnonymous,
										tSignature, match });
							}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous,
				tDefinition, mSignatureToTSignature, mAnonymous, tSignature, isApplicableMatch,
				...
				mSignatureToTSignature__tSignature____target, mAnonymous__mDefinition____bodyDeclarations,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mDefinitionToTMember,
				mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous, tDefinition, mSignatureToTSignature,
				mAnonymous, tSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinitionToTMember, mAnonymousToTAnonymous,
					mSignature, mDefinition, tAnonymous, tDefinition, mSignatureToTSignature, mAnonymous, tSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding = pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition,
				tAnonymous, tDefinition, mSignatureToTSignature, mAnonymous, tSignature);
		if (result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mDefinitionToTMember, mAnonymousToTAnonymous,
						mSignature, mDefinition, tAnonymous, tDefinition, mSignatureToTSignature, mAnonymous,
						tSignature };
			}
		}
		return null;
	...
	public static final void pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mAnonymousToTAnonymous, EObject mSignature, EObject mDefinition, EObject tAnonymous,
			EObject tDefinition, EObject mSignatureToTSignature, EObject mAnonymous, EObject tSignature) {
		_this.registerObjects_BWD(ruleresult, mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition,
				tAnonymous, tDefinition, mSignatureToTSignature, mAnonymous, tSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFFFFBBFFBB(
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(
		...
		return new Object[] { mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous,
				tDefinition, mSignatureToTSignature, mAnonymous, tSignature, isApplicableMatch,
				mSignature__mDefinition____mDefinitions, mDefinition__mSignature____mSignature,
				mDefinitionToTMember__mDefinition____source, tAnonymous__tSignature____signature,
				mAnonymousToTAnonymous__tAnonymous____target, tAnonymous__tDefinition____defines,
				...
				if (tmpTAnonymous instanceof TClass) {
					...
					if (tmpTDefinition instanceof TMember) {
						...
						if (tmpMAnonymous instanceof AnonymousClassDeclaration) {
							...
							if (tmpTSignature instanceof TSignature) {
								TSignature tSignature = (TSignature) tmpTSignature;
								return new Object[] { mSignature, mDefinition, tAnonymous, tDefinition, mAnonymous,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mSignature, mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mSignature, mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature, sourceMatch, targetMatch);
			if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { mSignature, mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToAnonymous _this, MSignature mSignature, MDefinition mDefinition, TClass tAnonymous,
			TMember tDefinition, AnonymousClassDeclaration mAnonymous, TSignature tSignature, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mSignature, mDefinition, tAnonymous, tDefinition,
				mAnonymous, tSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mSignature, mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding = pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mSignature, mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature, sourceMatch,
				targetMatch);
		if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mSignature, mDefinition, tAnonymous, tDefinition, mAnonymous,
						tSignature, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackFFBBBBFBBBB(
			MSignature mSignature, MDefinition mDefinition, TClass tAnonymous, TMember tDefinition,
			AnonymousClassDeclaration mAnonymous, TSignature tSignature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(
			MSignature mSignature, MDefinition mDefinition, TClass tAnonymous, TMember tDefinition,
			AnonymousClassDeclaration mAnonymous, TSignature tSignature, CCMatch ccMatch) {
		return new Object[] { mSignature, mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mDefinitionToTMember,
				mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous, tDefinition, mSignatureToTSignature,
				mAnonymous, tSignature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinitionToTMember, mAnonymousToTAnonymous,
					mSignature, mDefinition, tAnonymous, tDefinition, mSignatureToTSignature, mAnonymous, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBB(
			...
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mDefinitionToTMember, mAnonymousToTAnonymous, mSignature, mDefinition, tAnonymous,
				tDefinition, mSignatureToTSignature, mAnonymous, tSignature, ruleResult };
	}

	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(MDefinition mDefinition,
			TClass tAnonymous, TMember tDefinition, AnonymousClassDeclaration mAnonymous, TSignature tSignature,
			ModelgeneratorRuleResult ruleResult) {
		tAnonymous.getSignature().add(tSignature);
		tAnonymous.getDefines().add(tDefinition);
		mAnonymous.getBodyDeclarations().add(mDefinition);
		...
		return new Object[] { mDefinition, tAnonymous, tDefinition, mAnonymous, tSignature, ruleResult };
	}
