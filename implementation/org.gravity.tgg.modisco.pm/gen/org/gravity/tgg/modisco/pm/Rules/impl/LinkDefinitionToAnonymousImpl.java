...
public class LinkDefinitionToAnonymousImpl extends AbstractRuleImpl implements LinkDefinitionToAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tDefinition,
						mDefinitionToTMember, mDefinition, mAnonymous, mSignatureToTSignature, tSignature, mSignature,
						tAnonymous, mAnonymousToTAnonymous);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tDefinition] = " + tDefinition + ", " + "[mDefinitionToTMember] = "
					+ mDefinitionToTMember + ", " + "[mDefinition] = " + mDefinition + ", " + "[mAnonymous] = "
					+ mAnonymous + ", " + "[mSignatureToTSignature] = " + mSignatureToTSignature + ", "
					+ "[tSignature] = " + tSignature + ", " + "[mSignature] = " + mSignature + ", " + "[tAnonymous] = "
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, tDefinition, mDefinition, mAnonymous, tSignature, tAnonymous);
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tDefinition, mDefinitionToTMember, mDefinition, mAnonymous, mSignatureToTSignature,
				tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFFBBFFBFFB(mDefinition, mAnonymous, mSignature,
						match)) {
			...
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_2_3_findcontext_blackBBBBBBBBB(tDefinition, mDefinitionToTMember,
							mDefinition, mAnonymous, mSignatureToTSignature, tSignature, mSignature, tAnonymous,
				...
				Object[] result3_green = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(tDefinition,
								mDefinitionToTMember, mDefinition, mAnonymous, mSignatureToTSignature, tSignature,
								mSignature, tAnonymous, mAnonymousToTAnonymous);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, tDefinition, mDefinitionToTMember, mDefinition, mAnonymous,
								mSignatureToTSignature, tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mSignatureToTSignature + ", " + "[tSignature] = " + tSignature + ", " + "[mSignature] = "
							+ mSignature + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[mAnonymousToTAnonymous] = "
							+ mAnonymousToTAnonymous + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMember tDefinition,
			MDefinitionToTMember mDefinitionToTMember, MDefinition mDefinition, AnonymousClassDeclaration mAnonymous,
			MSignatureToTSignature mSignatureToTSignature, TSignature tSignature, MSignature mSignature,
			TClass tAnonymous, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tDefinition, EObject mDefinitionToTMember,
			EObject mDefinition, EObject mAnonymous, EObject mSignatureToTSignature, EObject tSignature,
			EObject mSignature, EObject tAnonymous, EObject mAnonymousToTAnonymous) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_12_2_corematch_blackBFFFFBFBFB(tDefinition, tSignature, tAnonymous,
						match)) {
			MDefinitionToTMember mDefinitionToTMember = (MDefinitionToTMember) result2_black[1];
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_12_3_findcontext_blackBBBBBBBBB(tDefinition,
							mDefinitionToTMember, mDefinition, mAnonymous, mSignatureToTSignature, tSignature,
							mSignature, tAnonymous, mAnonymousToTAnonymous)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
				...
				//nothing EMoflonEdge tAnonymous__tSignature____signature = (EMoflonEdge) result3_green[19];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tDefinition,
						mDefinition, mAnonymous, tSignature, mSignature, tAnonymous, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tDefinition] = " + tDefinition + ", " + "[mDefinition] = " + mDefinition + ", "
					+ "[mAnonymous] = " + mAnonymous + ", " + "[tSignature] = " + tSignature + ", " + "[mSignature] = "
					+ mSignature + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackBFBBFBBBFBB(tDefinition, mDefinition,
							mAnonymous, tSignature, mSignature, tAnonymous, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(tDefinition,
								mDefinition, mAnonymous, tSignature, mSignature, tAnonymous, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tDefinition] = "
							+ tDefinition + ", " + "[mDefinition] = " + mDefinition + ", " + "[mAnonymous] = "
							+ mAnonymous + ", " + "[tSignature] = " + tSignature + ", " + "[mSignature] = " + mSignature
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMember tDefinition, MDefinition mDefinition,
			AnonymousClassDeclaration mAnonymous, TSignature tSignature, MSignature mSignature, TClass tAnonymous,
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ mSignatureToTSignature + ", " + "[tSignature] = " + tSignature + ", " + "[mSignature] = "
						+ mSignature + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[mAnonymousToTAnonymous] = "
						+ mAnonymousToTAnonymous + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_29_5_checknacs_blackBBBBBBBBB(tDefinition,
								mDefinitionToTMember, mDefinition, mAnonymous, mSignatureToTSignature, tSignature,
								mSignature, tAnonymous, mAnonymousToTAnonymous);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToAnonymousImpl
							.pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBB(tDefinition,
									mDefinitionToTMember, mDefinition, mAnonymous, mSignatureToTSignature, tSignature,
									mSignature, tAnonymous, mAnonymousToTAnonymous, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tDefinition] = "
								+ tDefinition + ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember + ", "
								+ "[mDefinition] = " + mDefinition + ", " + "[mAnonymous] = " + mAnonymous + ", "
								+ "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[tSignature] = "
								+ tSignature + ", " + "[mSignature] = " + mSignature + ", " + "[tAnonymous] = "
								+ tAnonymous + ", " + "[mAnonymousToTAnonymous] = " + mAnonymousToTAnonymous + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(
							tDefinition, mDefinition, mAnonymous, tSignature, tAnonymous, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMEMBER_MDEFINITIONTOTMEMBER_MDEFINITION_ANONYMOUSCLASSDECLARATION_MSIGNATURETOTSIGNATURE_TSIGNATURE_MSIGNATURE_TCLASS_ANONYMOUSCLASSDECLARATIONTOTCLASS:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TMember) arguments.get(1),
						...
						(AnonymousClassDeclaration) arguments.get(4), (MSignatureToTSignature) arguments.get(5),
						(TSignature) arguments.get(6), (MSignature) arguments.get(7), (TClass) arguments.get(8),
			...
			case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_MDEFINITIONTOTMEMBER_MDEFINITION_ANONYMOUSCLASSDECLARATION_MSIGNATURETOTSIGNATURE_TSIGNATURE_MSIGNATURE_TCLASS_ANONYMOUSCLASSDECLARATIONTOTCLASS:
			...
			case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__TMEMBER_MDEFINITION_ANONYMOUSCLASSDECLARATION_TSIGNATURE_MSIGNATURE_TCLASS_MATCH_MATCH:
				return isApplicable_solveCsp_CC((TMember) arguments.get(0), (MDefinition) arguments.get(1),
						(AnonymousClassDeclaration) arguments.get(2), (TSignature) arguments.get(3),
						(MSignature) arguments.get(4), (TClass) arguments.get(5), (Match) arguments.get(6),
			...
			case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_MDEFINITIONTOTMEMBER_MDEFINITION_ANONYMOUSCLASSDECLARATION_MSIGNATURETOTSIGNATURE_TSIGNATURE_MSIGNATURE_TCLASS_ANONYMOUSCLASSDECLARATIONTOTCLASS_MODELGENERATORRULERESULT:
								...
								if (tmpMSignature instanceof MSignature) {
									...
									if (tmpTAnonymous instanceof TClass) {
										...
										if (tmpMAnonymousToTAnonymous instanceof AnonymousClassDeclarationToTClass) {
											...
											return new Object[] { tDefinition, mDefinitionToTMember, mDefinition,
													mAnonymous, mSignatureToTSignature, tSignature, mSignature,
													tAnonymous, mAnonymousToTAnonymous, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
			TMember tDefinition, MDefinitionToTMember mDefinitionToTMember, MDefinition mDefinition,
			AnonymousClassDeclaration mAnonymous, MSignatureToTSignature mSignatureToTSignature, TSignature tSignature,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tDefinition, mDefinitionToTMember, mDefinition, mAnonymous,
						mSignatureToTSignature, tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_black = pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
					tDefinition, mDefinitionToTMember, mDefinition, mAnonymous, mSignatureToTSignature, tSignature,
					mSignature, tAnonymous, mAnonymousToTAnonymous, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tDefinition, EObject mDefinitionToTMember, EObject mDefinition,
			EObject mAnonymous, EObject mSignatureToTSignature, EObject tSignature, EObject mSignature,
			EObject tAnonymous, EObject mAnonymousToTAnonymous) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tDefinition, EObject mDefinition, EObject mAnonymous,
			EObject tSignature, EObject tAnonymous) {
		...
		mDefinition__mAnonymous____anonymousClassDeclarationOwner
				.setName(mDefinition__mAnonymous____anonymousClassDeclarationOwner_name_prime);
		return new Object[] { ruleresult, tDefinition, mDefinition, mAnonymous, tSignature, tAnonymous,
	...
	public static final void pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(
			LinkDefinitionToAnonymous _this, PerformRuleResult ruleresult, EObject tDefinition,
			EObject mDefinitionToTMember, EObject mDefinition, EObject mAnonymous, EObject mSignatureToTSignature,
			EObject tSignature, EObject mSignature, EObject tAnonymous, EObject mAnonymousToTAnonymous) {
		_this.registerObjects_FWD(ruleresult, tDefinition, mDefinitionToTMember, mDefinition, mAnonymous,
				mSignatureToTSignature, tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFFBBFFBFFB(
				...
				for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tSignature != null) {
						for (AnonymousClassDeclarationToTClass mAnonymousToTAnonymous : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tAnonymous != null) {
								_result.add(new Object[] { tDefinition, mDefinitionToTMember, mDefinition, mAnonymous,
										mSignatureToTSignature, tSignature, mSignature, tAnonymous,
								...
								if (mSignature.equals(mSignatureToTSignature.getSource())) {
									if (tAnonymous.equals(mAnonymousToTAnonymous.getTarget())) {
										if (mAnonymous.equals(mAnonymousToTAnonymous.getSource())) {
											_result.add(new Object[] { tDefinition, mDefinitionToTMember, mDefinition,
													mAnonymous, mSignatureToTSignature, tSignature, mSignature,
													tAnonymous, mAnonymousToTAnonymous });
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { tDefinition, mDefinitionToTMember, mDefinition, mAnonymous, mSignatureToTSignature,
				tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous, isApplicableMatch,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tDefinition, mDefinitionToTMember, mDefinition,
					mAnonymous, mSignatureToTSignature, tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding = pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, tDefinition, mDefinitionToTMember, mDefinition, mAnonymous,
				mSignatureToTSignature, tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous);
		if (result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tDefinition, mDefinitionToTMember, mDefinition,
						mAnonymous, mSignatureToTSignature, tSignature, mSignature, tAnonymous,
						mAnonymousToTAnonymous };
			}
		}
		return null;
	...
	public static final void pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mDefinitionToTMember, EObject mDefinition, EObject mAnonymous, EObject mSignatureToTSignature,
			EObject tSignature, EObject mSignature, EObject tAnonymous, EObject mAnonymousToTAnonymous) {
		_this.registerObjects_BWD(ruleresult, tDefinition, mDefinitionToTMember, mDefinition, mAnonymous,
				mSignatureToTSignature, tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_12_2_corematch_blackBFFFFBFBFB(
							...
							if (tAnonymous.getDefines().contains(tDefinition)) {
								if (tAnonymous.getSignature().contains(tSignature)) {
									if (mSignature.equals(mSignatureToTSignature.getSource())) {
										if (tAnonymous.equals(mAnonymousToTAnonymous.getTarget())) {
											if (mAnonymous.equals(mAnonymousToTAnonymous.getSource())) {
												_result.add(new Object[] { tDefinition, mDefinitionToTMember,
														mDefinition, mAnonymous, mSignatureToTSignature, tSignature,
														mSignature, tAnonymous, mAnonymousToTAnonymous });
											}
										}
									}
				...
				if (tmpMAnonymous instanceof AnonymousClassDeclaration) {
					...
					if (tmpTSignature instanceof TSignature) {
						...
						if (tmpMSignature instanceof MSignature) {
							...
							if (tmpTAnonymous instanceof TClass) {
								TClass tAnonymous = (TClass) tmpTAnonymous;
								return new Object[] { tDefinition, mDefinition, mAnonymous, tSignature, mSignature,
										tAnonymous, targetMatch, sourceMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TMember tDefinition, MDefinition mDefinition, AnonymousClassDeclaration mAnonymous, TSignature tSignature,
			MSignature mSignature, TClass tAnonymous, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tDefinition, mDefinition, mAnonymous, tSignature, mSignature, tAnonymous, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tDefinition, mDefinition, mAnonymous, tSignature, mSignature, tAnonymous, sourceMatch, targetMatch);
			if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { tDefinition, mDefinition, mAnonymous, tSignature, mSignature, tAnonymous,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToAnonymous _this, TMember tDefinition, MDefinition mDefinition,
			AnonymousClassDeclaration mAnonymous, TSignature tSignature, MSignature mSignature, TClass tAnonymous,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tDefinition, mDefinition, mAnonymous, tSignature,
				mSignature, tAnonymous, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tDefinition, mDefinition, mAnonymous, tSignature, mSignature, tAnonymous,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding = pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tDefinition, mDefinition, mAnonymous, tSignature, mSignature, tAnonymous, sourceMatch,
				targetMatch);
		if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tDefinition, mDefinition, mAnonymous, tSignature, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(
			TMember tDefinition, MDefinition mDefinition, AnonymousClassDeclaration mAnonymous, TSignature tSignature,
			MSignature mSignature, TClass tAnonymous, CCMatch ccMatch) {
		return new Object[] { tDefinition, mDefinition, mAnonymous, tSignature, mSignature, tAnonymous, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_29_3_solveCSP_binding = pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, tDefinition, mDefinitionToTMember, mDefinition, mAnonymous,
				mSignatureToTSignature, tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous, ruleResult);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBB(TMember tDefinition,
			...
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tDefinition, mDefinitionToTMember, mDefinition, mAnonymous, mSignatureToTSignature,
				tSignature, mSignature, tAnonymous, mAnonymousToTAnonymous, ruleResult };
	}

	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(TMember tDefinition,
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous, TSignature tSignature, TClass tAnonymous,
			ModelgeneratorRuleResult ruleResult) {
		tAnonymous.getDefines().add(tDefinition);
		tAnonymous.getSignature().add(tSignature);
		mAnonymous.getBodyDeclarations().add(mDefinition);
		...
		return new Object[] { tDefinition, mDefinition, mAnonymous, tSignature, tAnonymous, ruleResult };
	}
