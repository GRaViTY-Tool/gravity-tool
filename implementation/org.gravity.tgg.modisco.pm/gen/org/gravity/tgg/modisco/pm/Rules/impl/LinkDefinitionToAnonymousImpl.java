...
public class LinkDefinitionToAnonymousImpl extends AbstractRuleImpl implements LinkDefinitionToAnonymous {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, ClassInstanceCreation mInstance, MSignature mSignature,
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous) {

		Object[] result1_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_0_1_initialbindings_blackBBBBBB(this, match, mInstance, mSignature,
						mDefinition, mAnonymous);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[mInstance] = " + mInstance + ", " + "[mSignature] = " + mSignature
		...
		Object[] result2_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, mInstance,
						mSignature, mDefinition, mAnonymous);
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_0_5_collectcontextelements_greenBBBBBFFFF(
					match, mInstance, mSignature, mDefinition, mAnonymous);
			...
			LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_0_6_registerobjectstomatch_expressionBBBBBB(
					this, match, mInstance, mSignature, mDefinition, mAnonymous);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult,
						mDefinitionToTMember, mSignatureToTSignature, mInstance, mAnonymousToTAnonymous, mSignature,
						tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember + ", " + "[mSignatureToTSignature] = "
					+ mSignatureToTSignature + ", " + "[mInstance] = " + mInstance + ", "
					+ "[mAnonymousToTAnonymous] = " + mAnonymousToTAnonymous + ", " + "[mSignature] = " + mSignature
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous);
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBBB(this,
				ruleresult, mDefinitionToTMember, mSignatureToTSignature, mInstance, mAnonymousToTAnonymous, mSignature,
				tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFFBFBFBFFBB(mInstance, mSignature, mDefinition,
						mAnonymous, match)) {
			...
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_2_3_findcontext_blackBBBBBBBBBB(mDefinitionToTMember,
							mSignatureToTSignature, mInstance, mAnonymousToTAnonymous, mSignature, tAnonymous,
							mDefinition, tDefinition, tSignature, mAnonymous)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
								mDefinitionToTMember, mSignatureToTSignature, mInstance, mAnonymousToTAnonymous,
								mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, mDefinitionToTMember, mSignatureToTSignature, mInstance,
								mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition, tDefinition, tSignature,
								mAnonymous);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mAnonymousToTAnonymous + ", " + "[mSignature] = " + mSignature + ", " + "[tAnonymous] = "
							+ tAnonymous + ", " + "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = "
							+ tDefinition + ", " + "[tSignature] = " + tSignature + ", " + "[mAnonymous] = "
							+ mAnonymous + ".");
				}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, ClassInstanceCreation mInstance, MSignature mSignature,
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, ClassInstanceCreation mInstance, MSignature mSignature,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinitionToTMember mDefinitionToTMember,
			...
			AnonymousClassDeclarationToTClass mAnonymousToTAnonymous, MSignature mSignature, TClass tAnonymous,
			MDefinition mDefinition, TMember tDefinition, TSignature tSignature, AnonymousClassDeclaration mAnonymous) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mDefinitionToTMember,
			EObject mSignatureToTSignature, EObject mInstance, EObject mAnonymousToTAnonymous, EObject mSignature,
			EObject tAnonymous, EObject mDefinition, EObject tDefinition, EObject tSignature, EObject mAnonymous) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBBB(
				this, ruleresult, mDefinitionToTMember, mSignatureToTSignature, mInstance, mAnonymousToTAnonymous,
				mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFFFFBFBBFB(tAnonymous, tDefinition, tSignature,
						match)) {
			MDefinitionToTMember mDefinitionToTMember = (MDefinitionToTMember) result2_black[0];
			MSignatureToTSignature mSignatureToTSignature = (MSignatureToTSignature) result2_black[1];
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_12_3_findcontext_blackBBFBBBBBBB(mDefinitionToTMember,
							mSignatureToTSignature, mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition,
							tDefinition, tSignature, mAnonymous)) {
				...
				//nothing EMoflonEdge tAnonymous__tDefinition____defines = (EMoflonEdge) result3_green[19];
				//nothing EMoflonEdge tDefinition__tAnonymous____definedBy = (EMoflonEdge) result3_green[20];
				...
				//nothing EMoflonEdge mAnonymousToTAnonymous__mAnonymous____source = (EMoflonEdge) result3_green[24];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_75(EMoflonEdge _edge_signature) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, mInstance, mSignature,
						tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mInstance] = " + mInstance + ", " + "[mSignature] = " + mSignature + ", " + "[tAnonymous] = "
					+ tAnonymous + ", " + "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = " + tDefinition
					+ ", " + "[tSignature] = " + tSignature + ", " + "[mAnonymous] = " + mAnonymous + ", "
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackFFFBBBBBBBB(mSignature, tAnonymous,
							mDefinition, tDefinition, tSignature, mAnonymous, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBBB(mInstance,
								mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mInstance] = "
							+ mInstance + ", " + "[mSignature] = " + mSignature + ", " + "[tAnonymous] = " + tAnonymous
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ClassInstanceCreation mInstance, MSignature mSignature, TClass tAnonymous,
			MDefinition mDefinition, TMember tDefinition, TSignature tSignature, AnonymousClassDeclaration mAnonymous,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(ClassInstanceCreation mInstance, MSignature mSignature, MDefinition mDefinition,
			AnonymousClassDeclaration mAnonymous) {// 
		Object[] result1_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_27_1_matchtggpattern_blackBBBB(mInstance, mSignature, mDefinition,
						mAnonymous);
		if (result1_black != null) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = LinkDefinitionToAnonymousImpl
							.pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBBB(mDefinitionToTMember,
									mSignatureToTSignature, mInstance, mAnonymousToTAnonymous, mSignature, tAnonymous,
									mDefinition, tDefinition, tSignature, mAnonymous, ruleResult);
					if (result6_black == null) {
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			...
			MSignature mSignature, TClass tAnonymous, MDefinition mDefinition, TMember tDefinition,
			TSignature tSignature, AnonymousClassDeclaration mAnonymous, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_FWD__MATCH_CLASSINSTANCECREATION_MSIGNATURE_MDEFINITION_ANONYMOUSCLASSDECLARATION:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_CLASSINSTANCECREATION_MSIGNATURE_MDEFINITION_ANONYMOUSCLASSDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (ClassInstanceCreation) arguments.get(1),
					(MSignature) arguments.get(2), (MDefinition) arguments.get(3),
					(AnonymousClassDeclaration) arguments.get(4));
			return null;
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_CLASSINSTANCECREATION_MSIGNATURE_MDEFINITION_ANONYMOUSCLASSDECLARATION:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_MSIGNATURETOTSIGNATURE_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATIONTOTCLASS_MSIGNATURE_TCLASS_MDEFINITION_TMEMBER_TSIGNATURE_ANONYMOUSCLASSDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (MSignatureToTSignature) arguments.get(2),
					(ClassInstanceCreation) arguments.get(3), (AnonymousClassDeclarationToTClass) arguments.get(4),
					(MSignature) arguments.get(5), (TClass) arguments.get(6), (MDefinition) arguments.get(7),
					(TMember) arguments.get(8), (TSignature) arguments.get(9),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_MSIGNATURETOTSIGNATURE_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATIONTOTCLASS_MSIGNATURE_TCLASS_MDEFINITION_TMEMBER_TSIGNATURE_ANONYMOUSCLASSDECLARATION:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_75__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_75((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_78__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__CLASSINSTANCECREATION_MSIGNATURE_TCLASS_MDEFINITION_TMEMBER_TSIGNATURE_ANONYMOUSCLASSDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((ClassInstanceCreation) arguments.get(0), (MSignature) arguments.get(1),
					(TClass) arguments.get(2), (MDefinition) arguments.get(3), (TMember) arguments.get(4),
					(TSignature) arguments.get(5), (AnonymousClassDeclaration) arguments.get(6),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___CHECK_DEC_FWD__CLASSINSTANCECREATION_MSIGNATURE_MDEFINITION_ANONYMOUSCLASSDECLARATION:
			return checkDEC_FWD((ClassInstanceCreation) arguments.get(0), (MSignature) arguments.get(1),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_MSIGNATURETOTSIGNATURE_CLASSINSTANCECREATION_ANONYMOUSCLASSDECLARATIONTOTCLASS_MSIGNATURE_TCLASS_MDEFINITION_TMEMBER_TSIGNATURE_ANONYMOUSCLASSDECLARATION_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (MSignatureToTSignature) arguments.get(2),
					(ClassInstanceCreation) arguments.get(3), (AnonymousClassDeclarationToTClass) arguments.get(4),
					(MSignature) arguments.get(5), (TClass) arguments.get(6), (MDefinition) arguments.get(7),
					(TMember) arguments.get(8), (TSignature) arguments.get(9),
					(AnonymousClassDeclaration) arguments.get(10), (ModelgeneratorRuleResult) arguments.get(11));
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_0_1_initialbindings_blackBBBBBB(
			LinkDefinitionToAnonymous _this, Match match, ClassInstanceCreation mInstance, MSignature mSignature,
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous) {
		return new Object[] { _this, match, mInstance, mSignature, mDefinition, mAnonymous };
	}

	public static final Object[] pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_bindingFBBBBBB(
			LinkDefinitionToAnonymous _this, Match match, ClassInstanceCreation mInstance, MSignature mSignature,
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, mInstance, mSignature, mDefinition, mAnonymous);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, mInstance, mSignature, mDefinition, mAnonymous };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_binding = pattern_LinkDefinitionToAnonymous_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, mInstance, mSignature, mDefinition, mAnonymous);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_0_4_collectelementstobetranslated_blackBBBBB(
			Match match, ClassInstanceCreation mInstance, MSignature mSignature, MDefinition mDefinition,
			AnonymousClassDeclaration mAnonymous) {
		return new Object[] { match, mInstance, mSignature, mDefinition, mAnonymous };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_0_5_collectcontextelements_blackBBBBB(Match match,
			ClassInstanceCreation mInstance, MSignature mSignature, MDefinition mDefinition,
			AnonymousClassDeclaration mAnonymous) {
		return new Object[] { match, mInstance, mSignature, mDefinition, mAnonymous };
	}
	...
	public static final void pattern_LinkDefinitionToAnonymous_0_6_registerobjectstomatch_expressionBBBBBB(
			LinkDefinitionToAnonymous _this, Match match, ClassInstanceCreation mInstance, MSignature mSignature,
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous) {
		_this.registerObjectsToMatch_FWD(match, mInstance, mSignature, mDefinition, mAnonymous);
									...
									if (tmpTDefinition instanceof TMember) {
										...
										if (tmpTSignature instanceof TSignature) {
											...
											if (tmpMAnonymous instanceof AnonymousClassDeclaration) {
												...
												return new Object[] { mDefinitionToTMember, mSignatureToTSignature,
														mInstance, mAnonymousToTAnonymous, mSignature, tAnonymous,
														mDefinition, tDefinition, tSignature, mAnonymous,
														isApplicableMatch };
											}
										}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBBFBB(
			...
			ClassInstanceCreation mInstance, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous,
			MSignature mSignature, TClass tAnonymous, MDefinition mDefinition, TMember tDefinition,
			TSignature tSignature, AnonymousClassDeclaration mAnonymous, LinkDefinitionToAnonymous _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinitionToTMember, mSignatureToTSignature, mInstance, mAnonymousToTAnonymous,
						mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding != null) {
			...
			MDefinition mDefinition = (MDefinition) result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding[6];
			...
			AnonymousClassDeclaration mAnonymous = (AnonymousClassDeclaration) result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding[9];
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_black = pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBBFBB(
					mDefinitionToTMember, mSignatureToTSignature, mInstance, mAnonymousToTAnonymous, mSignature,
					tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mDefinitionToTMember, EObject mSignatureToTSignature,
			EObject mInstance, EObject mAnonymousToTAnonymous, EObject mSignature, EObject tAnonymous,
			EObject mDefinition, EObject tDefinition, EObject tSignature, EObject mAnonymous) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tAnonymous, EObject mDefinition, EObject tDefinition,
			EObject tSignature, EObject mAnonymous) {
		...
		mDefinition__mAnonymous____anonymousClassDeclarationOwner
				.setName(mDefinition__mAnonymous____anonymousClassDeclarationOwner_name_prime);
		return new Object[] { ruleresult, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous,
	...
	public static final void pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject mSignatureToTSignature, EObject mInstance, EObject mAnonymousToTAnonymous, EObject mSignature,
			EObject tAnonymous, EObject mDefinition, EObject tDefinition, EObject tSignature, EObject mAnonymous) {
		_this.registerObjects_FWD(ruleresult, mDefinitionToTMember, mSignatureToTSignature, mInstance,
				mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous);
		...
		if (tmpMInstance instanceof ClassInstanceCreation) {
			...
			if (tmpMSignature instanceof MSignature) {
				...
				if (tmpMDefinition instanceof MDefinition) {
					...
					if (tmpMAnonymous instanceof AnonymousClassDeclaration) {
						AnonymousClassDeclaration mAnonymous = (AnonymousClassDeclaration) tmpMAnonymous;
						return new Object[] { mInstance, mSignature, mDefinition, mAnonymous, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFFBFBFBFFBB(
			ClassInstanceCreation mInstance, MSignature mSignature, MDefinition mDefinition,
				...
				for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tDefinition != null) {
						for (AnonymousClassDeclarationToTClass mAnonymousToTAnonymous : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tAnonymous != null) {
								_result.add(new Object[] { mDefinitionToTMember, mSignatureToTSignature, mInstance,
										mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition, tDefinition,
										tSignature, mAnonymous, match });
							}
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_2_3_findcontext_blackBBBBBBBBBB(
			...
			ClassInstanceCreation mInstance, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous,
			MSignature mSignature, TClass tAnonymous, MDefinition mDefinition, TMember tDefinition,
			TSignature tSignature, AnonymousClassDeclaration mAnonymous) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
									...
									if (mAnonymous.equals(mAnonymousToTAnonymous.getSource())) {
										if (mAnonymous.getBodyDeclarations().contains(mDefinition)) {
											if (tSignature.equals(mSignatureToTSignature.getTarget())) {
												_result.add(new Object[] { mDefinitionToTMember, mSignatureToTSignature,
														mInstance, mAnonymousToTAnonymous, mSignature, tAnonymous,
														mDefinition, tDefinition, tSignature, mAnonymous });
											}
										}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
		...
		return new Object[] { mDefinitionToTMember, mSignatureToTSignature, mInstance, mAnonymousToTAnonymous,
				mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous, isApplicableMatch,
				mInstance__mAnonymous____anonymousClassDeclaration, mAnonymous__mInstance____classInstanceCreation,
				mSignature__mDefinition____mDefinitions, mDefinition__mSignature____mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mDefinitionToTMember,
				mSignatureToTSignature, mInstance, mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition,
				tDefinition, tSignature, mAnonymous);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinitionToTMember, mSignatureToTSignature,
					mInstance, mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition, tDefinition, tSignature,
					mAnonymous };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding = pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, mDefinitionToTMember, mSignatureToTSignature, mInstance,
				mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_11_1_performtransformation_binding != null) {
			...
			MDefinition mDefinition = (MDefinition) result_pattern_LinkDefinitionToAnonymous_11_1_performtransformation_binding[6];
			...
			AnonymousClassDeclaration mAnonymous = (AnonymousClassDeclaration) result_pattern_LinkDefinitionToAnonymous_11_1_performtransformation_binding[9];
	...
	public static final void pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject mSignatureToTSignature, EObject mInstance, EObject mAnonymousToTAnonymous, EObject mSignature,
			EObject tAnonymous, EObject mDefinition, EObject tDefinition, EObject tSignature, EObject mAnonymous) {
		_this.registerObjects_BWD(ruleresult, mDefinitionToTMember, mSignatureToTSignature, mInstance,
				mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFFFFBFBBFB(
											...
											if (tSignature.equals(mSignatureToTSignature.getTarget())) {
												...
												if (mInstance != null) {
													_result.add(new Object[] { mDefinitionToTMember,
															mSignatureToTSignature, mInstance, mAnonymousToTAnonymous,
															mSignature, tAnonymous, mDefinition, tDefinition,
															tSignature, mAnonymous });
												}
			...
			if (tmpMDefinition instanceof MDefinition) {
				...
				if (mAnonymous.getBodyDeclarations().contains(mDefinition)) {
					...
					if (mInstance != null) {
						...
						if (mSignature != null) {
							_result.add(new Object[] { mInstance, mSignature, mDefinition, mAnonymous,
	...
	public static final boolean pattern_LinkDefinitionToAnonymous_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			LinkDefinitionToAnonymous _this, Match match, ClassInstanceCreation mInstance, MSignature mSignature,
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, mInstance, mSignature, mDefinition, mAnonymous);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
					...
					if (tmpMDefinition instanceof MDefinition) {
						...
						if (tmpTDefinition instanceof TMember) {
							...
							if (tmpTSignature instanceof TSignature) {
								...
								if (tmpMAnonymous instanceof AnonymousClassDeclaration) {
									AnonymousClassDeclaration mAnonymous = (AnonymousClassDeclaration) tmpMAnonymous;
									return new Object[] { mInstance, mSignature, tAnonymous, mDefinition, tDefinition,
											tSignature, mAnonymous, sourceMatch, targetMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			ClassInstanceCreation mInstance, MSignature mSignature, TClass tAnonymous, MDefinition mDefinition,
			TMember tDefinition, TSignature tSignature, AnonymousClassDeclaration mAnonymous, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mInstance, mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			AnonymousClassDeclaration mAnonymous = (AnonymousClassDeclaration) result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding[6];
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					mInstance, mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous, sourceMatch,
					targetMatch);
			if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { mInstance, mSignature, tAnonymous, mDefinition, tDefinition, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBBB(
			LinkDefinitionToAnonymous _this, ClassInstanceCreation mInstance, MSignature mSignature, TClass tAnonymous,
			MDefinition mDefinition, TMember tDefinition, TSignature tSignature, AnonymousClassDeclaration mAnonymous,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(mInstance, mSignature, tAnonymous, mDefinition,
				tDefinition, tSignature, mAnonymous, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, mInstance, mSignature, tAnonymous, mDefinition, tDefinition, tSignature,
					mAnonymous, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding = pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, mInstance, mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous, sourceMatch,
				targetMatch);
		if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mInstance, mSignature, tAnonymous, mDefinition, tDefinition,
						tSignature, mAnonymous, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackFFFBBBBBBBB(
			MSignature mSignature, TClass tAnonymous, MDefinition mDefinition, TMember tDefinition,
			TSignature tSignature, AnonymousClassDeclaration mAnonymous, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (AnonymousClassDeclarationToTClass mAnonymousToTAnonymous : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tAnonymous, AnonymousClassDeclarationToTClass.class, "target")) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBBB(
			ClassInstanceCreation mInstance, MSignature mSignature, TClass tAnonymous, MDefinition mDefinition,
			TMember tDefinition, TSignature tSignature, AnonymousClassDeclaration mAnonymous, CCMatch ccMatch) {
		return new Object[] { mInstance, mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous,
				ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_27_1_matchtggpattern_blackBBBB(
		...
		if (mAnonymous.equals(mInstance.getAnonymousClassDeclaration())) {
			if (mSignature.getMDefinitions().contains(mDefinition)) {
				if (mAnonymous.getBodyDeclarations().contains(mDefinition)) {
					return new Object[] { mInstance, mSignature, mDefinition, mAnonymous };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingFBBBBBBBBBBBBB(
			...
			ClassInstanceCreation mInstance, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous,
			MSignature mSignature, TClass tAnonymous, MDefinition mDefinition, TMember tDefinition,
			TSignature tSignature, AnonymousClassDeclaration mAnonymous, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mDefinitionToTMember,
				mSignatureToTSignature, mInstance, mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition,
				tDefinition, tSignature, mAnonymous, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinitionToTMember, mSignatureToTSignature,
					mInstance, mAnonymousToTAnonymous, mSignature, tAnonymous, mDefinition, tDefinition, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBBB(
			...
			TSignature tSignature, AnonymousClassDeclaration mAnonymous, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mDefinitionToTMember, mSignatureToTSignature, mInstance, mAnonymousToTAnonymous,
				mSignature, tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous, ruleResult };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(TClass tAnonymous,
		...
		return new Object[] { tAnonymous, mDefinition, tDefinition, tSignature, mAnonymous, ruleResult };
	}
