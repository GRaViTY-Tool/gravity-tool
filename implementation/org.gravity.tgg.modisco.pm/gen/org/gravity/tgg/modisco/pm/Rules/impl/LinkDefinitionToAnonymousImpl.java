...
public class LinkDefinitionToAnonymousImpl extends AbstractRuleImpl implements LinkDefinitionToAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition, tSignature, tAnonymous,
						mSignature, mDefinitionToTMember, mDefinition);
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, mAnonymous, tDefinition, tSignature, tAnonymous, mDefinition);
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition, tSignature,
				tAnonymous, mSignature, mDefinitionToTMember, mDefinition);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFBFFFFBFBB(mAnonymous, mSignature, mDefinition,
						match)) {
			...
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_2_3_findcontext_blackBBBBBBBBB(mAnonymousToTAnonymous,
							mAnonymous, mSignatureToTSignature, tDefinition, tSignature, tAnonymous, mSignature,
				...
				Object[] result3_green = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
								mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition, tSignature,
								tAnonymous, mSignature, mDefinitionToTMember, mDefinition);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature,
								tDefinition, tSignature, tAnonymous, mSignature, mDefinitionToTMember, mDefinition);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ tDefinition + ", " + "[tSignature] = " + tSignature + ", " + "[tAnonymous] = "
							+ tAnonymous + ", " + "[mSignature] = " + mSignature + ", " + "[mDefinitionToTMember] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			MSignatureToTSignature mSignatureToTSignature, TMember tDefinition, TSignature tSignature,
			TClass tAnonymous, MSignature mSignature, MDefinitionToTMember mDefinitionToTMember,
			MDefinition mDefinition) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mAnonymousToTAnonymous, EObject mAnonymous,
			EObject mSignatureToTSignature, EObject tDefinition, EObject tSignature, EObject tAnonymous,
			EObject mSignature, EObject mDefinitionToTMember, EObject mDefinition) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFFFBBBFFFB(tDefinition, tSignature, tAnonymous,
						match)) {
			AnonymousClassDeclarationToTClass mAnonymousToTAnonymous = (AnonymousClassDeclarationToTClass) result2_black[0];
			...
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
				...
				//nothing EMoflonEdge tDefinition__tSignature____signature = (EMoflonEdge) result3_green[12];
				//nothing EMoflonEdge mSignatureToTSignature__tSignature____target = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge tAnonymous__tDefinition____defines = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge tDefinition__tAnonymous____definedBy = (EMoflonEdge) result3_green[15];
				...
				//nothing EMoflonEdge mDefinitionToTMember__mDefinition____source = (EMoflonEdge) result3_green[20];
				//nothing EMoflonEdge tAnonymous__tSignature____signature = (EMoflonEdge) result3_green[21];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mAnonymousToTAnonymous, EObject mAnonymous,
			EObject mSignatureToTSignature, EObject tDefinition, EObject tSignature, EObject tAnonymous,
			EObject mSignature, EObject mDefinitionToTMember, EObject mDefinition) {
		ruleresult.registerObject("mAnonymousToTAnonymous", mAnonymousToTAnonymous);
		ruleresult.registerObject("mAnonymous", mAnonymous);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mAnonymous,
						tDefinition, tSignature, tAnonymous, mSignature, mDefinition, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mAnonymous] = " + mAnonymous + ", " + "[tDefinition] = " + tDefinition + ", "
					+ "[tSignature] = " + tSignature + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[mSignature] = "
					+ mSignature + ", " + "[mDefinition] = " + mDefinition + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackFBFBBBBFBBB(mAnonymous, tDefinition,
							tSignature, tAnonymous, mSignature, mDefinition, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(mAnonymous,
								tDefinition, tSignature, tAnonymous, mSignature, mDefinition, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mAnonymous] = "
							+ mAnonymous + ", " + "[tDefinition] = " + tDefinition + ", " + "[tSignature] = "
							+ tSignature + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[mSignature] = " + mSignature
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AnonymousClassDeclaration mAnonymous, TMember tDefinition,
			TSignature tSignature, TClass tAnonymous, MSignature mSignature, MDefinition mDefinition, Match sourceMatch,
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition,
							tSignature, tAnonymous, mSignature, mDefinitionToTMember, mDefinition, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mAnonymousToTAnonymous] = "
						+ mAnonymousToTAnonymous + ", " + "[mAnonymous] = " + mAnonymous + ", "
						+ "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[tDefinition] = "
						+ tDefinition + ", " + "[tSignature] = " + tSignature + ", " + "[tAnonymous] = " + tAnonymous
						+ ", " + "[mSignature] = " + mSignature + ", " + "[mDefinitionToTMember] = "
						+ mDefinitionToTMember + ", " + "[mDefinition] = " + mDefinition + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(mAnonymous,
							tDefinition, tSignature, tAnonymous, mDefinition, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION_MSIGNATURETOTSIGNATURE_TMEMBER_TSIGNATURE_TCLASS_MSIGNATURE_MDEFINITIONTOTMEMBER_MDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AnonymousClassDeclarationToTClass) arguments.get(1), (AnonymousClassDeclaration) arguments.get(2),
					(MSignatureToTSignature) arguments.get(3), (TMember) arguments.get(4),
					(TSignature) arguments.get(5), (TClass) arguments.get(6), (MSignature) arguments.get(7),
					(MDefinitionToTMember) arguments.get(8), (MDefinition) arguments.get(9));
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION_MSIGNATURETOTSIGNATURE_TMEMBER_TSIGNATURE_TCLASS_MSIGNATURE_MDEFINITIONTOTMEMBER_MDEFINITION:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_80__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION_MSIGNATURETOTSIGNATURE_TMEMBER_TSIGNATURE_TCLASS_MSIGNATURE_MDEFINITIONTOTMEMBER_MDEFINITION_MODELGENERATORRULERESULT:
								...
								if (tmpMSignature instanceof MSignature) {
									...
									if (tmpMDefinitionToTMember instanceof MDefinitionToTMember) {
										...
										if (tmpMDefinition instanceof MDefinition) {
											...
											return new Object[] { mAnonymousToTAnonymous, mAnonymous,
													mSignatureToTSignature, tDefinition, tSignature, tAnonymous,
													mSignature, mDefinitionToTMember, mDefinition, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition,
						tSignature, tAnonymous, mSignature, mDefinitionToTMember, mDefinition, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_black = pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
					mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition, tSignature, tAnonymous,
					mSignature, mDefinitionToTMember, mDefinition, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mAnonymousToTAnonymous, EObject mAnonymous,
			EObject mSignatureToTSignature, EObject tDefinition, EObject tSignature, EObject tAnonymous,
			EObject mSignature, EObject mDefinitionToTMember, EObject mDefinition) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mAnonymous, EObject tDefinition, EObject tSignature,
		...
		return new Object[] { ruleresult, mAnonymous, tDefinition, tSignature, tAnonymous, mDefinition,
	...
	public static final void pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mAnonymous, EObject mSignatureToTSignature, EObject tDefinition, EObject tSignature,
			EObject tAnonymous, EObject mSignature, EObject mDefinitionToTMember, EObject mDefinition) {
		_this.registerObjects_FWD(ruleresult, mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition,
				tSignature, tAnonymous, mSignature, mDefinitionToTMember, mDefinition);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_2_2_corematch_blackFBFFFFBFBB(
				...
				for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tDefinition != null) {
						for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tSignature != null) {
								_result.add(new Object[] { mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature,
										tDefinition, tSignature, tAnonymous, mSignature, mDefinitionToTMember,
										mDefinition, match });
							}
								...
								if (mAnonymous.getBodyDeclarations().contains(mDefinition)) {
									if (mDefinition.equals(mDefinitionToTMember.getSource())) {
										if (mSignature.equals(mSignatureToTSignature.getSource())) {
											_result.add(new Object[] { mAnonymousToTAnonymous, mAnonymous,
													mSignatureToTSignature, tDefinition, tSignature, tAnonymous,
													mSignature, mDefinitionToTMember, mDefinition });
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition, tSignature,
				tAnonymous, mSignature, mDefinitionToTMember, mDefinition, isApplicableMatch,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TClass tAnonymous, MSignature mSignature, MDefinitionToTMember mDefinitionToTMember,
			MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mAnonymousToTAnonymous, mAnonymous,
				mSignatureToTSignature, tDefinition, tSignature, tAnonymous, mSignature, mDefinitionToTMember,
				mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mAnonymousToTAnonymous, mAnonymous,
					mSignatureToTSignature, tDefinition, tSignature, tAnonymous, mSignature, mDefinitionToTMember,
					mDefinition };
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding = pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition,
				tSignature, tAnonymous, mSignature, mDefinitionToTMember, mDefinition);
	...
	public static final void pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mAnonymous, EObject mSignatureToTSignature, EObject tDefinition, EObject tSignature,
			EObject tAnonymous, EObject mSignature, EObject mDefinitionToTMember, EObject mDefinition) {
		_this.registerObjects_BWD(ruleresult, mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition,
				tSignature, tAnonymous, mSignature, mDefinitionToTMember, mDefinition);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFFFBBBFFFB(
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_12_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TClass tAnonymous, MSignature mSignature, MDefinitionToTMember mDefinitionToTMember,
			MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mAnonymousToTAnonymous, mAnonymous,
				mSignatureToTSignature, tDefinition, tSignature, tAnonymous, mSignature, mDefinitionToTMember,
				mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
				...
				if (tmpTSignature instanceof TSignature) {
					...
					if (tmpTAnonymous instanceof TClass) {
						...
						if (tmpMSignature instanceof MSignature) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								MDefinition mDefinition = (MDefinition) tmpMDefinition;
								return new Object[] { mAnonymous, tDefinition, tSignature, tAnonymous, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
			AnonymousClassDeclaration mAnonymous, TMember tDefinition, TSignature tSignature, TClass tAnonymous,
			MSignature mSignature, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mAnonymous, tDefinition, tSignature, tAnonymous, mSignature, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mAnonymous, tDefinition, tSignature, tAnonymous, mSignature, mDefinition, sourceMatch, targetMatch);
			if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { mAnonymous, tDefinition, tSignature, tAnonymous, mSignature, mDefinition,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToAnonymous _this, AnonymousClassDeclaration mAnonymous, TMember tDefinition,
			TSignature tSignature, TClass tAnonymous, MSignature mSignature, MDefinition mDefinition, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mAnonymous, tDefinition, tSignature, tAnonymous,
				mSignature, mDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mAnonymous, tDefinition, tSignature, tAnonymous, mSignature, mDefinition,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding = pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mAnonymous, tDefinition, tSignature, tAnonymous, mSignature, mDefinition, sourceMatch,
				targetMatch);
		if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mAnonymous, tDefinition, tSignature, tAnonymous, mSignature,
						mDefinition, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackFBFBBBBFBBB(
			AnonymousClassDeclaration mAnonymous, TMember tDefinition, TSignature tSignature, TClass tAnonymous,
			MSignature mSignature, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
					...
					for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mSignature.equals(mSignatureToTSignature.getSource())) {
							for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (mDefinition.equals(mDefinitionToTMember.getSource())) {
									_result.add(new Object[] { mAnonymousToTAnonymous, mAnonymous,
											mSignatureToTSignature, tDefinition, tSignature, tAnonymous, mSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mAnonymous, tDefinition, tSignature, tAnonymous, mSignature, mDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mAnonymousToTAnonymous, mAnonymous,
				mSignatureToTSignature, tDefinition, tSignature, tAnonymous, mSignature, mDefinitionToTMember,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBB(
			...
			MDefinition mDefinition, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mAnonymousToTAnonymous, mAnonymous, mSignatureToTSignature, tDefinition, tSignature,
				tAnonymous, mSignature, mDefinitionToTMember, mDefinition, ruleResult };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(
		...
		return new Object[] { mAnonymous, tDefinition, tSignature, tAnonymous, mDefinition, ruleResult };
	}
