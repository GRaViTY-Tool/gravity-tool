...
public class LinkDefinitionToAnonymousImpl extends AbstractRuleImpl implements LinkDefinitionToAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mDefinition,
						mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous, mSignature, mSignatureToTSignature,
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, mDefinition, mAnonymous, tAnonymous, tSignature, tDefinition);
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous, mSignature,
				mSignatureToTSignature, tAnonymous, tSignature, tDefinition);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_2_2_corematch_blackBFFBBFFFFB(mDefinition, mAnonymous, mSignature,
						match)) {
			...
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_2_3_findcontext_blackBBBBBBBBB(mDefinition, mDefinitionToTMember,
							mAnonymousToTAnonymous, mAnonymous, mSignature, mSignatureToTSignature, tAnonymous,
							tSignature, tDefinition)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(mDefinition,
								mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous, mSignature,
								mSignatureToTSignature, tAnonymous, tSignature, tDefinition);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous,
								mAnonymous, mSignature, mSignatureToTSignature, tAnonymous, tSignature, tDefinition);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ mAnonymous + ", " + "[mSignature] = " + mSignature + ", " + "[mSignatureToTSignature] = "
							+ mSignatureToTSignature + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[tSignature] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition,
			...
			AnonymousClassDeclaration mAnonymous, MSignature mSignature, MSignatureToTSignature mSignatureToTSignature,
			TClass tAnonymous, TSignature tSignature, TMember tDefinition) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mDefinition, EObject mDefinitionToTMember,
			EObject mAnonymousToTAnonymous, EObject mAnonymous, EObject mSignature, EObject mSignatureToTSignature,
			EObject tAnonymous, EObject tSignature, EObject tDefinition) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFFFFFFBBBB(tAnonymous, tSignature, tDefinition,
						match)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_63(EMoflonEdge _edge_signature) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mDefinition,
						mAnonymous, mSignature, tAnonymous, tSignature, tDefinition, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mDefinition] = " + mDefinition + ", " + "[mAnonymous] = " + mAnonymous + ", "
					+ "[mSignature] = " + mSignature + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[tSignature] = "
					+ tSignature + ", " + "[tDefinition] = " + tDefinition + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackBFFBBFBBBBB(mDefinition, mAnonymous,
							mSignature, tAnonymous, tSignature, tDefinition, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(mDefinition,
								mAnonymous, mSignature, tAnonymous, tSignature, tDefinition, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mDefinition] = "
							+ mDefinition + ", " + "[mAnonymous] = " + mAnonymous + ", " + "[mSignature] = "
							+ mSignature + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[tSignature] = " + tSignature
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MDefinition mDefinition, AnonymousClassDeclaration mAnonymous,
			MSignature mSignature, TClass tAnonymous, TSignature tSignature, TMember tDefinition, Match sourceMatch,
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous,
							mSignature, mSignatureToTSignature, tAnonymous, tSignature, tDefinition, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition + ", "
						+ "[mDefinitionToTMember] = " + mDefinitionToTMember + ", " + "[mAnonymousToTAnonymous] = "
						+ mAnonymousToTAnonymous + ", " + "[mAnonymous] = " + mAnonymous + ", " + "[mSignature] = "
				...
				if (result5_black != null) {
					...
					Object[] result6_black = LinkDefinitionToAnonymousImpl
							.pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBB(mDefinition,
									mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous, mSignature,
									mSignatureToTSignature, tAnonymous, tSignature, tDefinition, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mDefinition] = "
								...
								+ tAnonymous + ", " + "[tSignature] = " + tSignature + ", " + "[tDefinition] = "
								+ tDefinition + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(
							mDefinition, mAnonymous, tAnonymous, tSignature, tDefinition, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition,
			MDefinitionToTMember mDefinitionToTMember, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous,
			AnonymousClassDeclaration mAnonymous, MSignature mSignature, MSignatureToTSignature mSignatureToTSignature,
			TClass tAnonymous, TSignature tSignature, TMember tDefinition, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITION_MDEFINITIONTOTMEMBER_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION_MSIGNATURE_MSIGNATURETOTSIGNATURE_TCLASS_TSIGNATURE_TMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MDefinition) arguments.get(1),
					(MDefinitionToTMember) arguments.get(2), (AnonymousClassDeclarationToTClass) arguments.get(3),
					(AnonymousClassDeclaration) arguments.get(4), (MSignature) arguments.get(5),
					(MSignatureToTSignature) arguments.get(6), (TClass) arguments.get(7), (TSignature) arguments.get(8),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_MDEFINITIONTOTMEMBER_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION_MSIGNATURE_MSIGNATURETOTSIGNATURE_TCLASS_TSIGNATURE_TMEMBER:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_63__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_63((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_65__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__MDEFINITION_ANONYMOUSCLASSDECLARATION_MSIGNATURE_TCLASS_TSIGNATURE_TMEMBER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MDefinition) arguments.get(0),
					...
					(TClass) arguments.get(3), (TSignature) arguments.get(4), (TMember) arguments.get(5),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_MDEFINITIONTOTMEMBER_ANONYMOUSCLASSDECLARATIONTOTCLASS_ANONYMOUSCLASSDECLARATION_MSIGNATURE_MSIGNATURETOTSIGNATURE_TCLASS_TSIGNATURE_TMEMBER_MODELGENERATORRULERESULT:
								...
								if (tmpTAnonymous instanceof TClass) {
									...
									if (tmpTSignature instanceof TSignature) {
										...
										if (tmpTDefinition instanceof TMember) {
											...
											return new Object[] { mDefinition, mDefinitionToTMember,
													mAnonymousToTAnonymous, mAnonymous, mSignature,
													mSignatureToTSignature, tAnonymous, tSignature, tDefinition,
													isApplicableMatch };
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
			...
			MSignature mSignature, MSignatureToTSignature mSignatureToTSignature, TClass tAnonymous,
			TSignature tSignature, TMember tDefinition, LinkDefinitionToAnonymous _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous, mSignature,
						mSignatureToTSignature, tAnonymous, tSignature, tDefinition, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_black = pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
					mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous, mSignature,
					mSignatureToTSignature, tAnonymous, tSignature, tDefinition, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mDefinition, EObject mDefinitionToTMember,
			EObject mAnonymousToTAnonymous, EObject mAnonymous, EObject mSignature, EObject mSignatureToTSignature,
			EObject tAnonymous, EObject tSignature, EObject tDefinition) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mDefinition, EObject mAnonymous, EObject tAnonymous,
		...
		return new Object[] { ruleresult, mDefinition, mAnonymous, tAnonymous, tSignature, tDefinition,
	...
	public static final void pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mDefinitionToTMember, EObject mAnonymousToTAnonymous, EObject mAnonymous, EObject mSignature,
			EObject mSignatureToTSignature, EObject tAnonymous, EObject tSignature, EObject tDefinition) {
		_this.registerObjects_FWD(ruleresult, mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous,
				mSignature, mSignatureToTSignature, tAnonymous, tSignature, tDefinition);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_2_2_corematch_blackBFFBBFFFFB(
				...
				for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tSignature != null) {
						for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tDefinition != null) {
								_result.add(new Object[] { mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous,
										mAnonymous, mSignature, mSignatureToTSignature, tAnonymous, tSignature,
										tDefinition, match });
							}
								...
								if (tSignature.equals(mSignatureToTSignature.getTarget())) {
									if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
										if (mDefinition.equals(mDefinitionToTMember.getSource())) {
											_result.add(new Object[] { mDefinition, mDefinitionToTMember,
													mAnonymousToTAnonymous, mAnonymous, mSignature,
													mSignatureToTSignature, tAnonymous, tSignature, tDefinition });
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous, mSignature,
				mSignatureToTSignature, tAnonymous, tSignature, tDefinition, isApplicableMatch,
				...
				mAnonymousToTAnonymous__tAnonymous____target, tSignature__tDefinition____definitions,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mDefinition, mDefinitionToTMember,
				mAnonymousToTAnonymous, mAnonymous, mSignature, mSignatureToTSignature, tAnonymous, tSignature,
				tDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, mDefinitionToTMember,
					mAnonymousToTAnonymous, mAnonymous, mSignature, mSignatureToTSignature, tAnonymous, tSignature,
					tDefinition };
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding = pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous,
				mSignature, mSignatureToTSignature, tAnonymous, tSignature, tDefinition);
	...
	public static final void pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mDefinitionToTMember, EObject mAnonymousToTAnonymous, EObject mAnonymous, EObject mSignature,
			EObject mSignatureToTSignature, EObject tAnonymous, EObject tSignature, EObject tDefinition) {
		_this.registerObjects_BWD(ruleresult, mDefinition, mDefinitionToTMember, mAnonymousToTAnonymous, mAnonymous,
				mSignature, mSignatureToTSignature, tAnonymous, tSignature, tDefinition);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFFFFFFBBBB(
				...
				if (tmpMSignature instanceof MSignature) {
					...
					if (tmpTAnonymous instanceof TClass) {
						...
						if (tmpTSignature instanceof TSignature) {
							...
							if (tmpTDefinition instanceof TMember) {
								TMember tDefinition = (TMember) tmpTDefinition;
								return new Object[] { mDefinition, mAnonymous, mSignature, tAnonymous, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous, MSignature mSignature, TClass tAnonymous,
			TSignature tSignature, TMember tDefinition, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mDefinition, mAnonymous, mSignature, tAnonymous, tSignature, tDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mDefinition, mAnonymous, mSignature, tAnonymous, tSignature, tDefinition, sourceMatch, targetMatch);
			if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { mDefinition, mAnonymous, mSignature, tAnonymous, tSignature, tDefinition,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToAnonymous _this, MDefinition mDefinition, AnonymousClassDeclaration mAnonymous,
			MSignature mSignature, TClass tAnonymous, TSignature tSignature, TMember tDefinition, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mDefinition, mAnonymous, mSignature, tAnonymous,
				tSignature, tDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mDefinition, mAnonymous, mSignature, tAnonymous, tSignature, tDefinition,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding = pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mDefinition, mAnonymous, mSignature, tAnonymous, tSignature, tDefinition, sourceMatch,
				targetMatch);
		if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mDefinition, mAnonymous, mSignature, tAnonymous, tSignature,
						tDefinition, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackBFFBBFBBBBB(
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous, MSignature mSignature, TClass tAnonymous,
			TSignature tSignature, TMember tDefinition, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
					...
					for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tSignature.equals(mSignatureToTSignature.getTarget())) {
							for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (mDefinition.equals(mDefinitionToTMember.getSource())) {
									_result.add(new Object[] { mDefinition, mDefinitionToTMember,
											mAnonymousToTAnonymous, mAnonymous, mSignature, mSignatureToTSignature,
											tAnonymous, tSignature, tDefinition, sourceMatch, targetMatch });
								}
							}
						}
					}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(
			MDefinition mDefinition, AnonymousClassDeclaration mAnonymous, MSignature mSignature, TClass tAnonymous,
			TSignature tSignature, TMember tDefinition, CCMatch ccMatch) {
		return new Object[] { mDefinition, mAnonymous, mSignature, tAnonymous, tSignature, tDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingFBBBBBBBBBBBB(
			...
			MDefinitionToTMember mDefinitionToTMember, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous,
			AnonymousClassDeclaration mAnonymous, MSignature mSignature, MSignatureToTSignature mSignatureToTSignature,
			TClass tAnonymous, TSignature tSignature, TMember tDefinition, ModelgeneratorRuleResult ruleResult) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(MDefinition mDefinition,
			AnonymousClassDeclaration mAnonymous, TClass tAnonymous, TSignature tSignature, TMember tDefinition,
		...
		return new Object[] { mDefinition, mAnonymous, tAnonymous, tSignature, tDefinition, ruleResult };
	}
