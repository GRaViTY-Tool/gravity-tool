...
public class LinkDefinitionToAnonymousImpl extends AbstractRuleImpl implements LinkDefinitionToAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mAnonymous,
						mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember, tSignature,
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature);
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mAnonymous, mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous,
				mDefinitionToTMember, tSignature, mSignatureToTSignature, mSignature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_2_2_corematch_blackBBFFFFFFBB(mAnonymous, mDefinition, mSignature,
						match)) {
			...
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_2_3_findcontext_blackBBBBBBBBB(mAnonymous, mDefinition,
							tDefinition, tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember, tSignature,
							mSignatureToTSignature, mSignature)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(mAnonymous,
								mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember,
								tSignature, mSignatureToTSignature, mSignature);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, mAnonymous, mDefinition, tDefinition, tAnonymous,
								mAnonymousToTAnonymous, mDefinitionToTMember, tSignature, mSignatureToTSignature,
								mSignature);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AnonymousClassDeclaration mAnonymous,
			...
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, MSignature mSignature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mAnonymous, EObject mDefinition,
			EObject tDefinition, EObject tAnonymous, EObject mAnonymousToTAnonymous, EObject mDefinitionToTMember,
			EObject tSignature, EObject mSignatureToTSignature, EObject mSignature) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFFBBFFBFFB(tDefinition, tAnonymous, tSignature,
						match)) {
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_12_3_findcontext_blackBBBBBBBBB(mAnonymous, mDefinition,
							tDefinition, tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember, tSignature,
							mSignatureToTSignature, mSignature)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mAnonymous, EObject mDefinition,
			EObject tDefinition, EObject tAnonymous, EObject mAnonymousToTAnonymous, EObject mDefinitionToTMember,
			EObject tSignature, EObject mSignatureToTSignature, EObject mSignature) {
		ruleresult.registerObject("mAnonymous", mAnonymous);
		ruleresult.registerObject("mDefinition", mDefinition);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_581(EMoflonEdge _edge_defines) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_628(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mAnonymous,
						mDefinition, tDefinition, tAnonymous, tSignature, mSignature, sourceMatch, targetMatch);
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackBBBBFFBFBBB(mAnonymous, mDefinition,
							tDefinition, tAnonymous, tSignature, mSignature, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(mAnonymous,
								mDefinition, tDefinition, tAnonymous, tSignature, mSignature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException(
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AnonymousClassDeclaration mAnonymous, MDefinition mDefinition,
			TMember tDefinition, TClass tAnonymous, TSignature tSignature, MSignature mSignature, Match sourceMatch,
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, mAnonymous, mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous,
							mDefinitionToTMember, tSignature, mSignatureToTSignature, mSignature, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mAnonymous] = " + mAnonymous + ", "
						+ "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = " + tDefinition + ", "
			...
			if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_29_5_checknacs_blackBBBBBBBBB(mAnonymous, mDefinition,
								tDefinition, tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember, tSignature,
								mSignatureToTSignature, mSignature);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToAnonymousImpl
							.pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBB(mAnonymous, mDefinition,
									tDefinition, tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember, tSignature,
					...
					LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(mAnonymous,
							mDefinition, tDefinition, tAnonymous, tSignature, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, AnonymousClassDeclaration mAnonymous,
			MDefinition mDefinition, TMember tDefinition, TClass tAnonymous,
			AnonymousClassDeclarationToTClass mAnonymousToTAnonymous, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, MSignature mSignature,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_MDEFINITION_TMEMBER_TCLASS_ANONYMOUSCLASSDECLARATIONTOTCLASS_MDEFINITIONTOTMEMBER_TSIGNATURE_MSIGNATURETOTSIGNATURE_MSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AnonymousClassDeclaration) arguments.get(1), (MDefinition) arguments.get(2),
					(TMember) arguments.get(3), (TClass) arguments.get(4),
					(AnonymousClassDeclarationToTClass) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
					(TSignature) arguments.get(7), (MSignatureToTSignature) arguments.get(8),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_MDEFINITION_TMEMBER_TCLASS_ANONYMOUSCLASSDECLARATIONTOTCLASS_MDEFINITIONTOTMEMBER_TSIGNATURE_MSIGNATURETOTSIGNATURE_MSIGNATURE:
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_581__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_581((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_628__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_628((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__ANONYMOUSCLASSDECLARATION_MDEFINITION_TMEMBER_TCLASS_TSIGNATURE_MSIGNATURE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((AnonymousClassDeclaration) arguments.get(0),
					(MDefinition) arguments.get(1), (TMember) arguments.get(2), (TClass) arguments.get(3),
		...
		case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_MDEFINITION_TMEMBER_TCLASS_ANONYMOUSCLASSDECLARATIONTOTCLASS_MDEFINITIONTOTMEMBER_TSIGNATURE_MSIGNATURETOTSIGNATURE_MSIGNATURE_MODELGENERATORRULERESULT:
								...
								if (tmpTSignature instanceof TSignature) {
									...
									if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
										...
										if (tmpMSignature instanceof MSignature) {
											...
											return new Object[] { mAnonymous, mDefinition, tDefinition, tAnonymous,
													mAnonymousToTAnonymous, mDefinitionToTMember, tSignature,
													mSignatureToTSignature, mSignature, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
			AnonymousClassDeclaration mAnonymous, MDefinition mDefinition, TMember tDefinition, TClass tAnonymous,
			AnonymousClassDeclarationToTClass mAnonymousToTAnonymous, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, MSignature mSignature,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mAnonymous, mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous,
						mDefinitionToTMember, tSignature, mSignatureToTSignature, mSignature, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_black = pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
					mAnonymous, mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember,
					tSignature, mSignatureToTSignature, mSignature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mAnonymous, EObject mDefinition, EObject tDefinition,
			EObject tAnonymous, EObject mAnonymousToTAnonymous, EObject mDefinitionToTMember, EObject tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature,
	...
	public static final void pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(
			LinkDefinitionToAnonymous _this, PerformRuleResult ruleresult, EObject mAnonymous, EObject mDefinition,
			EObject tDefinition, EObject tAnonymous, EObject mAnonymousToTAnonymous, EObject mDefinitionToTMember,
			EObject tSignature, EObject mSignatureToTSignature, EObject mSignature) {
		_this.registerObjects_FWD(ruleresult, mAnonymous, mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous,
				mDefinitionToTMember, tSignature, mSignatureToTSignature, mSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_2_2_corematch_blackBBFFFFFFBB(
				...
				for (AnonymousClassDeclarationToTClass mAnonymousToTAnonymous : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAnonymous != null) {
						for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tSignature != null) {
								_result.add(new Object[] { mAnonymous, mDefinition, tDefinition, tAnonymous,
										mAnonymousToTAnonymous, mDefinitionToTMember, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		mDefinition__mSignature____mSignature.setName(mDefinition__mSignature____mSignature_name_prime);
		return new Object[] { mAnonymous, mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous,
				mDefinitionToTMember, tSignature, mSignatureToTSignature, mSignature, isApplicableMatch,
				mAnonymous__mDefinition____bodyDeclarations, mDefinition__mAnonymous____anonymousClassDeclarationOwner,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			AnonymousClassDeclarationToTClass mAnonymousToTAnonymous, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, MSignature mSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mAnonymous, mDefinition, tDefinition,
				tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember, tSignature, mSignatureToTSignature,
				mSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mAnonymous, mDefinition, tDefinition, tAnonymous,
					mAnonymousToTAnonymous, mDefinitionToTMember, tSignature, mSignatureToTSignature, mSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding = pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mAnonymous, mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous,
				mDefinitionToTMember, tSignature, mSignatureToTSignature, mSignature);
	...
	public static final void pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tDefinition, EObject tAnonymous, EObject mAnonymousToTAnonymous, EObject mDefinitionToTMember,
			EObject tSignature, EObject mSignatureToTSignature, EObject mSignature) {
		_this.registerObjects_BWD(ruleresult, mAnonymous, mDefinition, tDefinition, tAnonymous, mAnonymousToTAnonymous,
				mDefinitionToTMember, tSignature, mSignatureToTSignature, mSignature);
							...
							if (mAnonymous.equals(mAnonymousToTAnonymous.getSource())) {
								if (tAnonymous.equals(mAnonymousToTAnonymous.getTarget())) {
									if (tSignature.equals(mSignatureToTSignature.getTarget())) {
										if (mSignature.equals(mSignatureToTSignature.getSource())) {
											if (mSignature.getMDefinitions().contains(mDefinition)) {
												_result.add(new Object[] { mAnonymous, mDefinition, tDefinition,
														tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember,
														tSignature, mSignatureToTSignature, mSignature });
											}
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_12_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			AnonymousClassDeclarationToTClass mAnonymousToTAnonymous, MDefinitionToTMember mDefinitionToTMember,
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, MSignature mSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mAnonymous, mDefinition, tDefinition,
				tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember, tSignature, mSignatureToTSignature,
				mSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
				...
				if (tmpTDefinition instanceof TMember) {
					...
					if (tmpTAnonymous instanceof TClass) {
						...
						if (tmpTSignature instanceof TSignature) {
							...
							if (tmpMSignature instanceof MSignature) {
								MSignature mSignature = (MSignature) tmpMSignature;
								return new Object[] { mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature, mSignature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature, mSignature, sourceMatch, targetMatch);
			if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature, mSignature,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToAnonymous _this, AnonymousClassDeclaration mAnonymous, MDefinition mDefinition,
			TMember tDefinition, TClass tAnonymous, TSignature tSignature, MSignature mSignature, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mAnonymous, mDefinition, tDefinition, tAnonymous,
				tSignature, mSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature, mSignature,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding = pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature, mSignature, sourceMatch,
				targetMatch);
		if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature,
						mSignature, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature, mSignature, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mAnonymous, mDefinition, tDefinition,
				tAnonymous, mAnonymousToTAnonymous, mDefinitionToTMember, tSignature, mSignatureToTSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(
		...
		return new Object[] { mAnonymous, mDefinition, tDefinition, tAnonymous, tSignature, ruleResult };
	}
