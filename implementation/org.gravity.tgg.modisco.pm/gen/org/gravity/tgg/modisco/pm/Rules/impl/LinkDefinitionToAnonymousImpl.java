...
public class LinkDefinitionToAnonymousImpl extends AbstractRuleImpl implements LinkDefinitionToAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mDefinition,
						tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature, mSignatureToTSignature,
						mDefinitionToTMember, mSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = " + tDefinition + ", "
					+ "[mAnonymousToTAnonymous] = " + mAnonymousToTAnonymous + ", " + "[tAnonymous] = " + tAnonymous
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature);
		...
		LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_2_2_corematch_blackBFFFBFFFBB(mDefinition, mAnonymous, mSignature,
						match)) {
			...
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_2_3_findcontext_blackBBBBBBBBB(mDefinition, tDefinition,
							mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature, mSignatureToTSignature,
							mDefinitionToTMember, mSignature)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(mDefinition,
								tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature,
								mSignatureToTSignature, mDefinitionToTMember, mSignature);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous,
								mAnonymous, tSignature, mSignatureToTSignature, mDefinitionToTMember, mSignature);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition
							+ ", " + "[tDefinition] = " + tDefinition + ", " + "[mAnonymousToTAnonymous] = "
							+ mAnonymousToTAnonymous + ", " + "[tAnonymous] = " + tAnonymous + ", " + "[mAnonymous] = "
							+ mAnonymous + ", " + "[tSignature] = " + tSignature + ", " + "[mSignatureToTSignature] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition,
			TMember tDefinition, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous, TClass tAnonymous,
			AnonymousClassDeclaration mAnonymous, TSignature tSignature, MSignatureToTSignature mSignatureToTSignature,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mDefinition, EObject tDefinition,
			EObject mAnonymousToTAnonymous, EObject tAnonymous, EObject mAnonymous, EObject tSignature,
			EObject mSignatureToTSignature, EObject mDefinitionToTMember, EObject mSignature) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFBFBFBFFFB(tDefinition, tAnonymous, tSignature,
						match)) {
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_12_3_findcontext_blackBBBBBBBBB(mDefinition, tDefinition,
							mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature, mSignatureToTSignature,
							mDefinitionToTMember, mSignature)) {
				Object[] result3_green = LinkDefinitionToAnonymousImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
				.pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mDefinition,
						tDefinition, tAnonymous, mAnonymous, tSignature, mSignature, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mDefinition] = " + mDefinition + ", " + "[tDefinition] = " + tDefinition + ", "
					+ "[tAnonymous] = " + tAnonymous + ", " + "[mAnonymous] = " + mAnonymous + ", " + "[tSignature] = "
					+ tSignature + ", " + "[mSignature] = " + mSignature + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackBBFBBBFFBBB(mDefinition, tDefinition,
							tAnonymous, mAnonymous, tSignature, mSignature, sourceMatch, targetMatch)) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MDefinition mDefinition, TMember tDefinition, TClass tAnonymous,
			AnonymousClassDeclaration mAnonymous, TSignature tSignature, MSignature mSignature, Match sourceMatch,
		...
		for (Object[] result2_black : LinkDefinitionToAnonymousImpl
			...
			Object[] result3_bindingAndBlack = LinkDefinitionToAnonymousImpl
					.pattern_LinkDefinitionToAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous,
							tSignature, mSignatureToTSignature, mDefinitionToTMember, mSignature, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition + ", "
						+ "[tDefinition] = " + tDefinition + ", " + "[mAnonymousToTAnonymous] = "
			...
			if (LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = LinkDefinitionToAnonymousImpl
						.pattern_LinkDefinitionToAnonymous_29_5_checknacs_blackBBBBBBBBB(mDefinition, tDefinition,
								mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature, mSignatureToTSignature,
								mDefinitionToTMember, mSignature);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToAnonymousImpl
							.pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBB(mDefinition, tDefinition,
									mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature, mSignatureToTSignature,
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mDefinition] = "
								...
								+ tAnonymous + ", " + "[mAnonymous] = " + mAnonymous + ", " + "[tSignature] = "
					...
					LinkDefinitionToAnonymousImpl.pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(
							mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITION_TMEMBER_ANONYMOUSCLASSDECLARATIONTOTCLASS_TCLASS_ANONYMOUSCLASSDECLARATION_TSIGNATURE_MSIGNATURETOTSIGNATURE_MDEFINITIONTOTMEMBER_MSIGNATURE:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MDefinition) arguments.get(1),
						(TMember) arguments.get(2), (AnonymousClassDeclarationToTClass) arguments.get(3),
						(TClass) arguments.get(4), (AnonymousClassDeclaration) arguments.get(5),
						(TSignature) arguments.get(6), (MSignatureToTSignature) arguments.get(7),
						(MDefinitionToTMember) arguments.get(8), (MSignature) arguments.get(9));
			...
			case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_TMEMBER_ANONYMOUSCLASSDECLARATIONTOTCLASS_TCLASS_ANONYMOUSCLASSDECLARATION_TSIGNATURE_MSIGNATURETOTSIGNATURE_MDEFINITIONTOTMEMBER_MSIGNATURE:
			...
			case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_12__EMOFLONEDGE:
			...
			case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__MDEFINITION_TMEMBER_TCLASS_ANONYMOUSCLASSDECLARATION_TSIGNATURE_MSIGNATURE_MATCH_MATCH:
				return isApplicable_solveCsp_CC((MDefinition) arguments.get(0), (TMember) arguments.get(1),
						(TClass) arguments.get(2), (AnonymousClassDeclaration) arguments.get(3),
						(TSignature) arguments.get(4), (MSignature) arguments.get(5), (Match) arguments.get(6),
			...
			case RulesPackage.LINK_DEFINITION_TO_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_TMEMBER_ANONYMOUSCLASSDECLARATIONTOTCLASS_TCLASS_ANONYMOUSCLASSDECLARATION_TSIGNATURE_MSIGNATURETOTSIGNATURE_MDEFINITIONTOTMEMBER_MSIGNATURE_MODELGENERATORRULERESULT:
								...
								if (tmpMSignatureToTSignature instanceof MSignatureToTSignature) {
									...
									if (tmpMDefinitionToTMember instanceof MDefinitionToTMember) {
										...
										if (tmpMSignature instanceof MSignature) {
											...
											return new Object[] { mDefinition, tDefinition, mAnonymousToTAnonymous,
													tAnonymous, mAnonymous, tSignature, mSignatureToTSignature,
													mDefinitionToTMember, mSignature, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
			MDefinition mDefinition, TMember tDefinition, AnonymousClassDeclarationToTClass mAnonymousToTAnonymous,
			TClass tAnonymous, AnonymousClassDeclaration mAnonymous, TSignature tSignature,
			MSignatureToTSignature mSignatureToTSignature, MDefinitionToTMember mDefinitionToTMember,
			MSignature mSignature, LinkDefinitionToAnonymous _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous,
						tSignature, mSignatureToTSignature, mDefinitionToTMember, mSignature, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding != null) {
			...
			TMember tDefinition = (TMember) result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding[1];
			...
			AnonymousClassDeclaration mAnonymous = (AnonymousClassDeclaration) result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_1_1_performtransformation_black = pattern_LinkDefinitionToAnonymous_1_1_performtransformation_blackBBBBBBBBBFBB(
					mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature,
					mSignatureToTSignature, mDefinitionToTMember, mSignature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mDefinition, EObject tDefinition, EObject mAnonymousToTAnonymous,
			EObject tAnonymous, EObject mAnonymous, EObject tSignature, EObject mSignatureToTSignature,
			EObject mDefinitionToTMember, EObject mSignature) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mDefinition, EObject tDefinition, EObject tAnonymous,
		...
		return new Object[] { ruleresult, mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature,
	...
	public static final void pattern_LinkDefinitionToAnonymous_1_5_registerobjects_expressionBBBBBBBBBBB(
			LinkDefinitionToAnonymous _this, PerformRuleResult ruleresult, EObject mDefinition, EObject tDefinition,
			EObject mAnonymousToTAnonymous, EObject tAnonymous, EObject mAnonymous, EObject tSignature,
			EObject mSignatureToTSignature, EObject mDefinitionToTMember, EObject mSignature) {
		_this.registerObjects_FWD(ruleresult, mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous,
				tSignature, mSignatureToTSignature, mDefinitionToTMember, mSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_2_2_corematch_blackBFFFBFFFBB(
				...
				for (AnonymousClassDeclarationToTClass mAnonymousToTAnonymous : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tAnonymous != null) {
						for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tSignature != null) {
								_result.add(new Object[] { mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous,
										mAnonymous, tSignature, mSignatureToTSignature, mDefinitionToTMember,
										mSignature, match });
							}
								...
								if (mSignature.equals(mSignatureToTSignature.getSource())) {
									if (tSignature.equals(mSignatureToTSignature.getTarget())) {
										if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
											_result.add(new Object[] { mDefinition, tDefinition, mAnonymousToTAnonymous,
													tAnonymous, mAnonymous, tSignature, mSignatureToTSignature,
													mDefinitionToTMember, mSignature });
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature,
				mSignatureToTSignature, mDefinitionToTMember, mSignature, isApplicableMatch,
				mAnonymousToTAnonymous__tAnonymous____target, mAnonymous__mDefinition____bodyDeclarations,
				mDefinition__mAnonymous____anonymousClassDeclarationOwner, mDefinitionToTMember__mDefinition____source,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, tDefinition, mAnonymousToTAnonymous,
					tAnonymous, mAnonymous, tSignature, mSignatureToTSignature, mDefinitionToTMember, mSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_2_4_solveCSP_binding = pattern_LinkDefinitionToAnonymous_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous,
				tSignature, mSignatureToTSignature, mDefinitionToTMember, mSignature);
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_11_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_11_1_performtransformation_binding != null) {
			...
			TMember tDefinition = (TMember) result_pattern_LinkDefinitionToAnonymous_11_1_performtransformation_binding[1];
			...
			AnonymousClassDeclaration mAnonymous = (AnonymousClassDeclaration) result_pattern_LinkDefinitionToAnonymous_11_1_performtransformation_binding[4];
	...
	public static final void pattern_LinkDefinitionToAnonymous_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mAnonymousToTAnonymous, EObject tAnonymous, EObject mAnonymous, EObject tSignature,
			EObject mSignatureToTSignature, EObject mDefinitionToTMember, EObject mSignature) {
		_this.registerObjects_BWD(ruleresult, mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous,
				tSignature, mSignatureToTSignature, mDefinitionToTMember, mSignature);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_12_2_corematch_blackFBFBFBFFFB(
										...
										if (tSignature.equals(mSignatureToTSignature.getTarget())) {
											if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
												_result.add(new Object[] { mDefinition, tDefinition,
														mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature,
														mSignatureToTSignature, mDefinitionToTMember, mSignature });
											}
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_12_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			AnonymousClassDeclaration mAnonymous, TSignature tSignature, MSignatureToTSignature mSignatureToTSignature,
			MDefinitionToTMember mDefinitionToTMember, MSignature mSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mDefinition, tDefinition,
				mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature, mSignatureToTSignature,
				mDefinitionToTMember, mSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
				...
				if (tmpTAnonymous instanceof TClass) {
					...
					if (tmpMAnonymous instanceof AnonymousClassDeclaration) {
						...
						if (tmpTSignature instanceof TSignature) {
							...
							if (tmpMSignature instanceof MSignature) {
								MSignature mSignature = (MSignature) tmpMSignature;
								return new Object[] { mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature,
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MDefinition mDefinition, TMember tDefinition, TClass tAnonymous, AnonymousClassDeclaration mAnonymous,
			TSignature tSignature, MSignature mSignature, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature, mSignature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature, mSignature, sourceMatch, targetMatch);
			if (result_pattern_LinkDefinitionToAnonymous_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature, mSignature,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToAnonymous _this, MDefinition mDefinition, TMember tDefinition, TClass tAnonymous,
			AnonymousClassDeclaration mAnonymous, TSignature tSignature, MSignature mSignature, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mDefinition, tDefinition, tAnonymous, mAnonymous,
				tSignature, mSignature, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature, mSignature,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding = pattern_LinkDefinitionToAnonymous_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature, mSignature, sourceMatch,
				targetMatch);
		if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_LinkDefinitionToAnonymous_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature,
						mSignature, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToAnonymous_24_5_matchcorrcontext_blackBBFBBBFFBBB(
			MDefinition mDefinition, TMember tDefinition, TClass tAnonymous, AnonymousClassDeclaration mAnonymous,
			TSignature tSignature, MSignature mSignature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature, mSignature, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_blackBBBBBBBBBB(MDefinition mDefinition,
			...
			MDefinitionToTMember mDefinitionToTMember, MSignature mSignature, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mDefinition, tDefinition, mAnonymousToTAnonymous, tAnonymous, mAnonymous, tSignature,
				mSignatureToTSignature, mDefinitionToTMember, mSignature, ruleResult };
	}

	public static final Object[] pattern_LinkDefinitionToAnonymous_29_6_perform_greenBBBBBB(MDefinition mDefinition,
			TMember tDefinition, TClass tAnonymous, AnonymousClassDeclaration mAnonymous, TSignature tSignature,
		...
		return new Object[] { mDefinition, tDefinition, tAnonymous, mAnonymous, tSignature, ruleResult };
	}
