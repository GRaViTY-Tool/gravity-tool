...
public class InitializerInAnonymousImpl extends AbstractRuleImpl implements InitializerInAnonymous {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INITIALIZER_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_19__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_19((EMoflonEdge) arguments.get(0));
		case RulesPackage.INITIALIZER_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_19__EMOFLONEDGE:
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TAbstractType __DEC_tSignature_returnType_956833 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_956833 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_956833)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TMethod __DEC_tSignature_signatures_145605 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_145605 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_145605)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_2BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_236499 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_236499)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_268240 = tName.getModel();
		if (__DEC_tName_methods_268240 != null) {
			if (!tPM.equals(__DEC_tName_methods_268240)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_4BB(
		...
		TAbstractType __DEC_tDefinition_returnType_834356 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_834356 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_834356)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_5BB(
		...
		TSignature __DEC_tDefinition_definitions_95598 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_95598 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_95598)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_822189 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_822189 != null) {
	...
	public static final Object[] pattern_InitializerInAnonymous_27_1_matchtggpattern_black_nac_0B(
			MInitializer mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_103352 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_103352 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_0BB(
			TMethodSignature tSignature, TClass tType) {
		TAbstractType __DEC_tSignature_returnType_591269 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_591269 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_591269)) {
				return new Object[] { tSignature, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_1BB(
			TMethodSignature tSignature, TMethod tName) {
		TMethod __DEC_tSignature_signatures_324799 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_324799 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_324799)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_2BB(TModifier tModifier,
			TClass tType) {
		for (TAbstractType __DEC_tModifier_tModifier_968562 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_968562)) {
				return new Object[] { tModifier, tType };
			}
		}
		return null;
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_629047 = tName.getModel();
		if (__DEC_tName_methods_629047 != null) {
			if (!tPM.equals(__DEC_tName_methods_629047)) {
				return new Object[] { tName, tPM };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_4BB(
			TMethodDefinition tDefinition, TClass tType) {
		TAbstractType __DEC_tDefinition_returnType_422117 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_422117 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_422117)) {
				return new Object[] { tDefinition, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_5BB(
			TMethodDefinition tDefinition, TMethodSignature tSignature) {
		TSignature __DEC_tDefinition_definitions_495777 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_495777 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_495777)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
