...
public class InitializerInAnonymousImpl extends AbstractRuleImpl implements InitializerInAnonymous {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_80(EMoflonEdge _edge_model) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INITIALIZER_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_80__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_80((EMoflonEdge) arguments.get(0));
		case RulesPackage.INITIALIZER_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_83__EMOFLONEDGE:
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TAbstractType __DEC_tSignature_returnType_989583 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_989583 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_989583)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TMethod __DEC_tSignature_signatures_363793 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_363793 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_363793)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_2BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_677538 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_677538)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_569387 = tName.getModel();
		if (__DEC_tName_methods_569387 != null) {
			if (!tPM.equals(__DEC_tName_methods_569387)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_4BB(
		...
		TAbstractType __DEC_tDefinition_returnType_929206 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_929206 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_929206)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_5BB(
		...
		TSignature __DEC_tDefinition_definitions_228032 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_228032 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_228032)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_373822 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_373822 != null) {
	...
	public static final Object[] pattern_InitializerInAnonymous_27_1_matchtggpattern_black_nac_0B(
			MInitializer mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_60829 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_60829 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_0BB(
			TMethodSignature tSignature, TClass tType) {
		TAbstractType __DEC_tSignature_returnType_556848 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_556848 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_556848)) {
				return new Object[] { tSignature, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_1BB(
			TMethodSignature tSignature, TMethod tName) {
		TMethod __DEC_tSignature_signatures_307136 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_307136 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_307136)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_2BB(TModifier tModifier,
			TClass tType) {
		for (TAbstractType __DEC_tModifier_tModifier_206738 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_206738)) {
				return new Object[] { tModifier, tType };
			}
		}
		return null;
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_645739 = tName.getModel();
		if (__DEC_tName_methods_645739 != null) {
			if (!tPM.equals(__DEC_tName_methods_645739)) {
				return new Object[] { tName, tPM };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_4BB(
			TMethodDefinition tDefinition, TClass tType) {
		TAbstractType __DEC_tDefinition_returnType_108601 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_108601 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_108601)) {
				return new Object[] { tDefinition, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_5BB(
			TMethodDefinition tDefinition, TMethodSignature tSignature) {
		TSignature __DEC_tDefinition_definitions_122280 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_122280 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_122280)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
