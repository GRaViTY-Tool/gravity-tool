...
public class InitializerInAnonymousImpl extends AbstractRuleImpl implements InitializerInAnonymous {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INITIALIZER_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_14__EMOFLONEDGE:
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TAbstractType __DEC_tSignature_returnType_622427 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_622427 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_622427)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TMethod __DEC_tSignature_signatures_436935 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_436935 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_436935)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_2BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_785585 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_785585)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_117897 = tName.getModel();
		if (__DEC_tName_methods_117897 != null) {
			if (!tPM.equals(__DEC_tName_methods_117897)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_4BB(
		...
		TAbstractType __DEC_tDefinition_returnType_819302 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_819302 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_819302)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_20_2_testcorematchandDECs_black_nac_5BB(
		...
		TSignature __DEC_tDefinition_definitions_729672 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_729672 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_729672)) {
	...
	public static final Object[] pattern_InitializerInAnonymous_21_2_testcorematchandDECs_black_nac_0B(
		...
		MSignature __DEC_mDefinition_mDefinitions_268192 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_268192 != null) {
	...
	public static final Object[] pattern_InitializerInAnonymous_27_1_matchtggpattern_black_nac_0B(
			MInitializer mDefinition) {
		MSignature __DEC_mDefinition_mDefinitions_932170 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_932170 != null) {
			return new Object[] { mDefinition };
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_0BB(
			TMethodSignature tSignature, TClass tType) {
		TAbstractType __DEC_tSignature_returnType_418861 = tSignature.getReturnType();
		if (__DEC_tSignature_returnType_418861 != null) {
			if (!tType.equals(__DEC_tSignature_returnType_418861)) {
				return new Object[] { tSignature, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_1BB(
			TMethodSignature tSignature, TMethod tName) {
		TMethod __DEC_tSignature_signatures_449042 = tSignature.getMethod();
		if (__DEC_tSignature_signatures_449042 != null) {
			if (!tName.equals(__DEC_tSignature_signatures_449042)) {
				return new Object[] { tSignature, tName };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_2BB(TModifier tModifier,
			TClass tType) {
		for (TAbstractType __DEC_tModifier_tModifier_172552 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tType.equals(__DEC_tModifier_tModifier_172552)) {
				return new Object[] { tModifier, tType };
			}
		}
		return null;
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_3BB(TMethod tName,
			TypeGraph tPM) {
		TypeGraph __DEC_tName_methods_259783 = tName.getModel();
		if (__DEC_tName_methods_259783 != null) {
			if (!tPM.equals(__DEC_tName_methods_259783)) {
				return new Object[] { tName, tPM };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_4BB(
			TMethodDefinition tDefinition, TClass tType) {
		TAbstractType __DEC_tDefinition_returnType_664173 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_664173 != null) {
			if (!tType.equals(__DEC_tDefinition_returnType_664173)) {
				return new Object[] { tDefinition, tType };
			}
		}
	...
	public static final Object[] pattern_InitializerInAnonymous_28_1_matchtggpattern_black_nac_5BB(
			TMethodDefinition tDefinition, TMethodSignature tSignature) {
		TSignature __DEC_tDefinition_definitions_204222 = tDefinition.getSignature();
		if (__DEC_tDefinition_definitions_204222 != null) {
			if (!tSignature.equals(__DEC_tDefinition_definitions_204222)) {
				return new Object[] { tDefinition, tSignature };
			}
		}
