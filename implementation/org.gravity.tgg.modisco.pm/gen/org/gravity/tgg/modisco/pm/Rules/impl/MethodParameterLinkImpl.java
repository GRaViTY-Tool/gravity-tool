...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mPrevEntry, mEntry,
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				mPrevEntry, mEntry, tPrevParameter, tParameter);
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mPrevEntry, mEntry, mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
				eSingleVariableDeclarationToTParameter);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackBBFFFFB(mPrevEntry, mEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(mPrevEntry, mEntry,
							mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
							eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(mPrevEntry, mEntry,
								mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
								eSingleVariableDeclarationToTParameter);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MEntry mPrevEntry, MEntry mEntry,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPrevEntry, EObject mEntry,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mPrevEntry, mEntry,
						mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
						eSingleVariableDeclarationToTParameter);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(mPrevEntry, mEntry,
							mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
							eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(mPrevEntry, mEntry,
								mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
								eSingleVariableDeclarationToTParameter);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge mmethodSignatureToTMethodSignature__tPrevParameter____target = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MEntry mPrevEntry, MEntry mEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mPrevEntry, EObject mEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		ruleresult.registerObject("mPrevEntry", mPrevEntry);
		ruleresult.registerObject("mEntry", mEntry);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_101(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodParameterLinkImpl
				.pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mPrevEntry, mEntry,
						tPrevParameter, tParameter, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mPrevEntry] = " + mPrevEntry + ", " + "[mEntry] = " + mEntry + ", " + "[tPrevParameter] = "
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBFBBFBB(mPrevEntry, mEntry, tPrevParameter,
				...
				Object[] result6_black = MethodParameterLinkImpl
						.pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(mPrevEntry, mEntry,
								tPrevParameter, tParameter, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPrevEntry] = "
							+ mPrevEntry + ", " + "[mEntry] = " + mEntry + ", " + "[tPrevParameter] = " + tPrevParameter
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MEntry mPrevEntry, MEntry mEntry, TParameter tPrevParameter,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(mPrevEntry, mEntry,
									mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
									eSingleVariableDeclarationToTParameter, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPrevEntry] = "
					...
					MethodParameterLinkImpl.pattern_MethodParameterLink_29_6_perform_greenBBBBB(mPrevEntry, mEntry,
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MEntry mPrevEntry, MEntry mEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_96__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_96((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_101__EMOFLONEDGE:
					...
					if (tmpTPrevParameter instanceof TParameter) {
						...
						if (tmpTParameter instanceof TParameter) {
							...
							if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
								...
								return new Object[] { mPrevEntry, mEntry, mmethodSignatureToTMethodSignature,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { mPrevEntry, mEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mPrevEntry, EObject mEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
															...
															if (!eSingleVariableDeclarationToTParameter
																...
																if (!eSingleVariableDeclarationToTParameter
																	...
																	return new Object[] { ruleresult, mPrevEntry,
																			mEntry, mmethodSignatureToTMethodSignature,
																			tPrevParameter, tParameter,
																			eSingleVariableDeclarationToTParameter };
																}
															}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject mPrevEntry, EObject mEntry, EObject tPrevParameter,
			EObject tParameter) {
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { ruleresult, mPrevEntry, mEntry, tPrevParameter, tParameter,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			MethodParameterLink _this, PerformRuleResult ruleresult, EObject mPrevEntry, EObject mEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_FWD(ruleresult, mPrevEntry, mEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackBBFFFFB(MEntry mPrevEntry,
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { mPrevEntry, mEntry, mmethodSignatureToTMethodSignature,
											tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter,
											match });
								}
							}
							...
							if (mEntry.equals(eSingleVariableDeclarationToTParameter.getSource())) {
								if (tParameter.equals(eSingleVariableDeclarationToTParameter.getTarget())) {
									if (mEntry.equals(mPrevEntry.getMNext())) {
										_result.add(new Object[] { mPrevEntry, mEntry,
												mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
												eSingleVariableDeclarationToTParameter });
									}
								}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(MEntry mPrevEntry,
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { mPrevEntry, mEntry, mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, MEntry mPrevEntry, MEntry mEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mPrevEntry, mEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPrevEntry, mEntry, mmethodSignatureToTMethodSignature,
					tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			MethodParameterLink _this, IsApplicableMatch isApplicableMatch, MEntry mPrevEntry, MEntry mEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mPrevEntry, mEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
				tParameter, eSingleVariableDeclarationToTParameter);
		if (result_pattern_MethodParameterLink_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodParameterLink_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mPrevEntry, mEntry,
						mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
						eSingleVariableDeclarationToTParameter };
			}
		}
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_blackBBBBBBFBB(
			MEntry mPrevEntry, MEntry mEntry, MEntryToTParameter mmethodSignatureToTMethodSignature,
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_BWD(ruleresult, mPrevEntry, mEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
				tParameter, eSingleVariableDeclarationToTParameter);
	...
	public static final Object[] pattern_MethodParameterLink_12_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mPrevEntry, mEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPrevEntry, mEntry, mmethodSignatureToTMethodSignature,
		...
		if (tmpMPrevEntry instanceof MEntry) {
			...
			if (tmpMEntry instanceof MEntry) {
				...
				if (tmpTPrevParameter instanceof TParameter) {
					...
					if (tmpTParameter instanceof TParameter) {
						TParameter tParameter = (TParameter) tmpTParameter;
						return new Object[] { mPrevEntry, mEntry, tPrevParameter, tParameter, sourceMatch,
								targetMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(MEntry mPrevEntry,
			MEntry mEntry, TParameter tPrevParameter, TParameter tParameter, Match sourceMatch, Match targetMatch) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { mPrevEntry, mEntry, tPrevParameter, tParameter, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_black = pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
					mPrevEntry, mEntry, tPrevParameter, tParameter, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(MethodParameterLink _this,
			MEntry mPrevEntry, MEntry mEntry, TParameter tPrevParameter, TParameter tParameter, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mPrevEntry, mEntry, tPrevParameter, tParameter,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mPrevEntry, mEntry, tPrevParameter, tParameter, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			MethodParameterLink _this, MEntry mPrevEntry, MEntry mEntry, TParameter tPrevParameter,
		...
		Object[] result_pattern_MethodParameterLink_24_3_solvecsp_binding = pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(
				_this, mPrevEntry, mEntry, tPrevParameter, tParameter, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(MEntry mPrevEntry,
			MEntry mEntry, TParameter tPrevParameter, TParameter tParameter, CCMatch ccMatch) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
				return new Object[] { mPrevEntry, mEntry, tPrevParameter, tParameter, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mPrevEntry, mEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(MEntry mPrevEntry, MEntry mEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, ModelgeneratorRuleResult ruleResult) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_greenBBBBB(MEntry mPrevEntry, MEntry mEntry,
		...
		return new Object[] { mPrevEntry, mEntry, tPrevParameter, tParameter, ruleResult };
	}
