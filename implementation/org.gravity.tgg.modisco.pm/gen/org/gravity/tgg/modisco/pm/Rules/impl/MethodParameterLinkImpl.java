...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tParameter, mEntry,
						tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry,
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				tParameter, mEntry, tPrevParameter, mPrevEntry);
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				tParameter, mEntry, tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry,
				eSingleVariableDeclarationToTParameter);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFBFFBFB(mEntry, mPrevEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(tParameter, mEntry, tPrevParameter,
							mmethodSignatureToTMethodSignature, mPrevEntry, eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(tParameter, mEntry,
								tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry,
								eSingleVariableDeclarationToTParameter);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tParameter, EObject mEntry,
			EObject tPrevParameter, EObject mmethodSignatureToTMethodSignature, EObject mPrevEntry,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackBFBFFFB(tParameter, tPrevParameter, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(tParameter, mEntry, tPrevParameter,
							mmethodSignatureToTMethodSignature, mPrevEntry, eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(tParameter, mEntry,
								tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry,
								eSingleVariableDeclarationToTParameter);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_0(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_1(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodParameterLinkImpl
				.pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tParameter, mEntry,
						tPrevParameter, mPrevEntry, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tParameter] = " + tParameter + ", " + "[mEntry] = " + mEntry + ", " + "[tPrevParameter] = "
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBBFBFBB(tParameter, mEntry, tPrevParameter,
				...
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tParameter] = "
							+ tParameter + ", " + "[mEntry] = " + mEntry + ", " + "[tPrevParameter] = " + tPrevParameter
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TParameter tParameter, MEntry mEntry, TParameter tPrevParameter,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(tParameter, mEntry, tPrevParameter,
									mmethodSignatureToTMethodSignature, mPrevEntry,
									eSingleVariableDeclarationToTParameter, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tParameter] = "
								+ tParameter + ", " + "[mEntry] = " + mEntry + ", " + "[tPrevParameter] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_MENTRYTOTPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_MENTRYTOTPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_0__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_0((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_MENTRYTOTPARAMETER_MODELGENERATORRULERESULT:
					...
					if (tmpMmethodSignatureToTMethodSignature instanceof MEntryToTParameter) {
						...
						if (tmpMPrevEntry instanceof MEntry) {
							...
							if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
								...
								return new Object[] { tParameter, mEntry, tPrevParameter,
										mmethodSignatureToTMethodSignature, mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			TParameter tParameter, MEntry mEntry, TParameter tPrevParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mPrevEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							...
							return new Object[] { tParameter, mEntry, tPrevParameter,
									mmethodSignatureToTMethodSignature, mPrevEntry,
									eSingleVariableDeclarationToTParameter, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { tParameter, mEntry, tPrevParameter, mmethodSignatureToTMethodSignature,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tParameter, EObject mEntry, EObject tPrevParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { ruleresult, tParameter, mEntry, tPrevParameter, mPrevEntry,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tPrevParameter, EObject mmethodSignatureToTMethodSignature, EObject mPrevEntry,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_FWD(ruleresult, tParameter, mEntry, tPrevParameter, mmethodSignatureToTMethodSignature,
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFBFFBFB(MEntry mEntry,
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { tParameter, mEntry, tPrevParameter,
											mmethodSignatureToTMethodSignature, mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(TParameter tParameter,
			MEntry mEntry, TParameter tPrevParameter, MEntryToTParameter mmethodSignatureToTMethodSignature,
		...
		return new Object[] { tParameter, mEntry, tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, TParameter tParameter, MEntry mEntry, TParameter tPrevParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mPrevEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tParameter, mEntry, tPrevParameter,
				mmethodSignatureToTMethodSignature, mPrevEntry, eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParameter, mEntry, tPrevParameter,
					mmethodSignatureToTMethodSignature, mPrevEntry, eSingleVariableDeclarationToTParameter };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tParameter, mEntry, tPrevParameter, mmethodSignatureToTMethodSignature,
				mPrevEntry, eSingleVariableDeclarationToTParameter);
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tPrevParameter, EObject mmethodSignatureToTMethodSignature, EObject mPrevEntry,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_BWD(ruleresult, tParameter, mEntry, tPrevParameter, mmethodSignatureToTMethodSignature,
				mPrevEntry, eSingleVariableDeclarationToTParameter);
	...
	public static final Object[] pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(TParameter tParameter,
		...
		eSingleVariableDeclarationToTParameter__tParameter____target
				.setName(eSingleVariableDeclarationToTParameter__tParameter____target_name_prime);
		return new Object[] { tParameter, mEntry, tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry,
				eSingleVariableDeclarationToTParameter, isApplicableMatch, tPrevParameter__tParameter____next,
	...
	public static final Object[] pattern_MethodParameterLink_12_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mPrevEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tParameter, mEntry, tPrevParameter,
				mmethodSignatureToTMethodSignature, mPrevEntry, eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParameter, mEntry, tPrevParameter,
		...
		if (tmpTParameter instanceof TParameter) {
			...
			if (tmpMEntry instanceof MEntry) {
				...
				if (tmpTPrevParameter instanceof TParameter) {
					...
					if (tmpMPrevEntry instanceof MEntry) {
						MEntry mPrevEntry = (MEntry) tmpMPrevEntry;
						return new Object[] { tParameter, mEntry, tPrevParameter, mPrevEntry, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(TParameter tParameter,
			MEntry mEntry, TParameter tPrevParameter, MEntry mPrevEntry, Match sourceMatch, Match targetMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tParameter, mEntry, tPrevParameter, mPrevEntry, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_black = pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
					tParameter, mEntry, tPrevParameter, mPrevEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(MethodParameterLink _this,
			TParameter tParameter, MEntry mEntry, TParameter tPrevParameter, MEntry mPrevEntry, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tParameter, mEntry, tPrevParameter, mPrevEntry,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tParameter, mEntry, tPrevParameter, mPrevEntry, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			MethodParameterLink _this, TParameter tParameter, MEntry mEntry, TParameter tPrevParameter,
		...
		Object[] result_pattern_MethodParameterLink_24_3_solvecsp_binding = pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(
				_this, tParameter, mEntry, tPrevParameter, mPrevEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(TParameter tParameter,
			MEntry mEntry, TParameter tPrevParameter, MEntry mPrevEntry, CCMatch ccMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				return new Object[] { tParameter, mEntry, tPrevParameter, mPrevEntry, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tParameter, mEntry, tPrevParameter,
				mmethodSignatureToTMethodSignature, mPrevEntry, eSingleVariableDeclarationToTParameter, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParameter, mEntry, tPrevParameter,
					mmethodSignatureToTMethodSignature, mPrevEntry, eSingleVariableDeclarationToTParameter,
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_greenBBBBB(TParameter tParameter,
			MEntry mEntry, TParameter tPrevParameter, MEntry mPrevEntry, ModelgeneratorRuleResult ruleResult) {
		tPrevParameter.setNext(tParameter);
		mPrevEntry.setMNext(mEntry);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { tParameter, mEntry, tPrevParameter, mPrevEntry, ruleResult };
	}
