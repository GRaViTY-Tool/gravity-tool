...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackBFBFFFB(mPrevEntry, mEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(mPrevEntry, tPrevParameter, mEntry,
				...
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(mPrevEntry, tPrevParameter,
								mEntry, tParameter, eSingleVariableDeclarationToTParameter,
								mmethodSignatureToTMethodSignature);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPrevEntry, EObject tPrevParameter,
			EObject mEntry, EObject tParameter, EObject eSingleVariableDeclarationToTParameter,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackFBFBFFB(tPrevParameter, tParameter, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(mPrevEntry, tPrevParameter, mEntry,
							tParameter, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(mPrevEntry, tPrevParameter,
								mEntry, tParameter, eSingleVariableDeclarationToTParameter,
								mmethodSignatureToTMethodSignature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge eSingleVariableDeclarationToTParameter__tParameter____target = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mPrevEntry, EObject tPrevParameter,
			EObject mEntry, EObject tParameter, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature) {
		ruleresult.registerObject("mPrevEntry", mPrevEntry);
		ruleresult.registerObject("tPrevParameter", tPrevParameter);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_59(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBBBFFBB(mPrevEntry, tPrevParameter, mEntry,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(mPrevEntry, tPrevParameter, mEntry,
									tParameter, eSingleVariableDeclarationToTParameter,
									mmethodSignatureToTMethodSignature, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPrevEntry] = "
								+ mPrevEntry + ", " + "[tPrevParameter] = " + tPrevParameter + ", " + "[mEntry] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRY_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MEntry) arguments.get(1),
					(TParameter) arguments.get(2), (MEntry) arguments.get(3), (TParameter) arguments.get(4),
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_56__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_56((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_59__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_MODELGENERATORRULERESULT:
					...
					if (tmpTParameter instanceof TParameter) {
						...
						if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
							...
							if (tmpMmethodSignatureToTMethodSignature instanceof MEntryToTParameter) {
								...
								return new Object[] { mPrevEntry, tPrevParameter, mEntry, tParameter,
										eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
										isApplicableMatch };
							}
						}
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			MethodParameterLink _this, PerformRuleResult ruleresult, EObject mPrevEntry, EObject tPrevParameter,
			EObject mEntry, EObject tParameter, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_FWD(ruleresult, mPrevEntry, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackBFBFFFB(MEntry mPrevEntry,
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { mPrevEntry, tPrevParameter, mEntry, tParameter,
											eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
											match });
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(MEntry mPrevEntry,
		...
		return new Object[] { mPrevEntry, tPrevParameter, mEntry, tParameter, eSingleVariableDeclarationToTParameter,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, MEntry mPrevEntry, TParameter tPrevParameter, MEntry mEntry,
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mPrevEntry, tPrevParameter, mEntry,
				tParameter, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPrevEntry, tPrevParameter, mEntry, tParameter,
					eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mPrevEntry, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature);
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mEntry, EObject tParameter, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_BWD(ruleresult, mPrevEntry, tPrevParameter, mEntry, tParameter,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature);
	...
	public static final Object[] pattern_MethodParameterLink_12_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mPrevEntry, tPrevParameter, mEntry,
				tParameter, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPrevEntry, tPrevParameter, mEntry, tParameter,
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mPrevEntry, tPrevParameter, mEntry,
				tParameter, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPrevEntry, tPrevParameter, mEntry, tParameter,
