...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tParameter,
						eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				tParameter, eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
				mmethodSignatureToTMethodSignature, mPrevEntry);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFFBFFBB(mEntry, mPrevEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(tParameter,
							eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
							mmethodSignatureToTMethodSignature, mPrevEntry)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(tParameter,
								eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
								mmethodSignatureToTMethodSignature, mPrevEntry);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry, TParameter tPrevParameter,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter, EObject mEntry, EObject tPrevParameter,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackBFFBFFB(tParameter, tPrevParameter, match)) {
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result2_black[1];
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(tParameter,
							eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
							mmethodSignatureToTMethodSignature, mPrevEntry)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(tParameter,
								eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
								mmethodSignatureToTMethodSignature, mPrevEntry);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge mmethodSignatureToTMethodSignature__tPrevParameter____target = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_39(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBFBBFBBB(tParameter, mEntry, tPrevParameter,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(tParameter,
									eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
									mmethodSignatureToTMethodSignature, mPrevEntry, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tParameter] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_36__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_36((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_39__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_MODELGENERATORRULERESULT:
					...
					if (tmpTPrevParameter instanceof TParameter) {
						...
						if (tmpMmethodSignatureToTMethodSignature instanceof MEntryToTParameter) {
							...
							if (tmpMPrevEntry instanceof MEntry) {
								...
								return new Object[] { tParameter, eSingleVariableDeclarationToTParameter, mEntry,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry,
				...
				if (!mEntry.equals(mPrevEntry)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tParameter, eSingleVariableDeclarationToTParameter, mEntry,
									tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[1];
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { tParameter, eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject mEntry, EObject tPrevParameter, EObject mmethodSignatureToTMethodSignature, EObject mPrevEntry) {
		if (!tParameter.equals(tPrevParameter)) {
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			MethodParameterLink _this, PerformRuleResult ruleresult, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter, EObject mEntry, EObject tPrevParameter,
			EObject mmethodSignatureToTMethodSignature, EObject mPrevEntry) {
		_this.registerObjects_FWD(ruleresult, tParameter, eSingleVariableDeclarationToTParameter, mEntry,
				tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFFBFFBB(MEntry mEntry,
							...
							if (tPrevParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { tParameter, eSingleVariableDeclarationToTParameter,
											mEntry, tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry,
											match });
								}
							}
							...
							if (mEntry.equals(eSingleVariableDeclarationToTParameter.getSource())) {
								if (mEntry.equals(mPrevEntry.getMNext())) {
									if (mPrevEntry.equals(mmethodSignatureToTMethodSignature.getSource())) {
										_result.add(new Object[] { tParameter, eSingleVariableDeclarationToTParameter,
												mEntry, tPrevParameter, mmethodSignatureToTMethodSignature,
												mPrevEntry });
									}
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tParameter,
				eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter, mmethodSignatureToTMethodSignature,
				mPrevEntry);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tParameter, eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
				mmethodSignatureToTMethodSignature, mPrevEntry);
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_11_1_performtransformation_binding != null) {
			...
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[1];
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject eSingleVariableDeclarationToTParameter, EObject mEntry, EObject tPrevParameter,
			EObject mmethodSignatureToTMethodSignature, EObject mPrevEntry) {
		_this.registerObjects_BWD(ruleresult, tParameter, eSingleVariableDeclarationToTParameter, mEntry,
				tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_12_2_corematch_blackBFFBFFB(
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParameter, eSingleVariableDeclarationToTParameter,
					mEntry, tPrevParameter, mmethodSignatureToTMethodSignature, mPrevEntry, ruleResult };
		}
		return null;
	}
