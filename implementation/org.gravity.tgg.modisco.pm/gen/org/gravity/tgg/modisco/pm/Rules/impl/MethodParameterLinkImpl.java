...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tPrevParameter,
						mPrevEntry, tParameter, eSingleVariableDeclarationToTParameter,
						mmethodSignatureToTMethodSignature, mEntry);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tPrevParameter] = " + tPrevParameter + ", " + "[mPrevEntry] = " + mPrevEntry + ", "
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				tPrevParameter, mPrevEntry, tParameter, mEntry);
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				tPrevParameter, mPrevEntry, tParameter, eSingleVariableDeclarationToTParameter,
				mmethodSignatureToTMethodSignature, mEntry);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFBFFFBB(mPrevEntry, mEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(tPrevParameter, mPrevEntry, tParameter,
							eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(tPrevParameter, mPrevEntry,
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ tPrevParameter + ", " + "[mPrevEntry] = " + mPrevEntry + ", " + "[tParameter] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			MEntry mPrevEntry, TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tPrevParameter, EObject mPrevEntry,
			EObject tParameter, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature, EObject mEntry) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackBFBFFFB(tPrevParameter, tParameter, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(tPrevParameter, mPrevEntry, tParameter,
							eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(tPrevParameter, mPrevEntry,
								tParameter, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
								mEntry);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				//nothing EMoflonEdge tPrevParameter__tParameter____next = (EMoflonEdge) result3_green[10];
				//nothing EMoflonEdge tParameter__tPrevParameter____previous = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge eSingleVariableDeclarationToTParameter__mEntry____source = (EMoflonEdge) result3_green[12];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tPrevParameter, EObject mPrevEntry,
			EObject tParameter, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature, EObject mEntry) {
		ruleresult.registerObject("tPrevParameter", tPrevParameter);
		ruleresult.registerObject("mPrevEntry", mPrevEntry);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_708(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_727(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		MEntry mPrevEntry = (MEntry) result2_bindingAndBlack[1];
		...
		Object[] result3_bindingAndBlack = MethodParameterLinkImpl
				.pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tPrevParameter, mPrevEntry,
						tParameter, mEntry, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tPrevParameter] = " + tPrevParameter + ", " + "[mPrevEntry] = " + mPrevEntry + ", "
					+ "[tParameter] = " + tParameter + ", " + "[mEntry] = " + mEntry + ", " + "[sourceMatch] = "
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBBFFBBB(tPrevParameter, mPrevEntry,
							tParameter, mEntry, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = MethodParameterLinkImpl
						.pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(tPrevParameter, mPrevEntry,
								tParameter, mEntry, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tPrevParameter] = "
							+ tPrevParameter + ", " + "[mPrevEntry] = " + mPrevEntry + ", " + "[tParameter] = "
							+ tParameter + ", " + "[mEntry] = " + mEntry + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			Object[] result3_bindingAndBlack = MethodParameterLinkImpl
					.pattern_MethodParameterLink_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tPrevParameter, mPrevEntry, tParameter, eSingleVariableDeclarationToTParameter,
							mmethodSignatureToTMethodSignature, mEntry, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(tPrevParameter, mPrevEntry,
									tParameter, eSingleVariableDeclarationToTParameter,
									mmethodSignatureToTMethodSignature, mEntry, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tPrevParameter] = "
					...
					MethodParameterLinkImpl.pattern_MethodParameterLink_29_6_perform_greenBBBBB(tPrevParameter,
							mPrevEntry, tParameter, mEntry, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			MEntry mPrevEntry, TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_MENTRY:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TParameter) arguments.get(1),
					(MEntry) arguments.get(2), (TParameter) arguments.get(3), (MEntryToTParameter) arguments.get(4),
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_708__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_708((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_727__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_CC__TPARAMETER_MENTRY_TPARAMETER_MENTRY_MATCH_MATCH:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_MENTRY_MODELGENERATORRULERESULT:
					...
					if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
						...
						if (tmpMmethodSignatureToTMethodSignature instanceof MEntryToTParameter) {
							...
							if (tmpMEntry instanceof MEntry) {
								...
								return new Object[] { tPrevParameter, mPrevEntry, tParameter,
										eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry, MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodParameterLink_1_1_performtransformation_black = pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
					tPrevParameter, mPrevEntry, tParameter, eSingleVariableDeclarationToTParameter,
					mmethodSignatureToTMethodSignature, mEntry, _this, isApplicableMatch);
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { tPrevParameter, mPrevEntry, tParameter, eSingleVariableDeclarationToTParameter,
						mmethodSignatureToTMethodSignature, mEntry, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tPrevParameter, EObject mPrevEntry, EObject tParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		return new Object[] { ruleresult, tPrevParameter, mPrevEntry, tParameter, mEntry, mPrevEntry__mEntry____mNext,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			MethodParameterLink _this, PerformRuleResult ruleresult, EObject tPrevParameter, EObject mPrevEntry,
			EObject tParameter, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature, EObject mEntry) {
		_this.registerObjects_FWD(ruleresult, tPrevParameter, mPrevEntry, tParameter,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFBFFFBB(MEntry mPrevEntry,
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { tPrevParameter, mPrevEntry, tParameter,
											eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
											mEntry, match });
								}
							}
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(
			TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tParameter.equals(tPrevParameter)) {
			if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
				if (!mEntry.equals(mPrevEntry)) {
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { tPrevParameter, mPrevEntry, tParameter, eSingleVariableDeclarationToTParameter,
				mmethodSignatureToTMethodSignature, mEntry, isApplicableMatch, mPrevEntry__mEntry____mNext,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tPrevParameter, mPrevEntry,
				tParameter, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPrevParameter, mPrevEntry, tParameter,
					eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tPrevParameter, mPrevEntry, tParameter,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry);
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tParameter, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature, EObject mEntry) {
		_this.registerObjects_BWD(ruleresult, tPrevParameter, mPrevEntry, tParameter,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_12_2_corematch_blackBFBFFFB(
	...
	public static final Object[] pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		eSingleVariableDeclarationToTParameter__mEntry____source
				.setName(eSingleVariableDeclarationToTParameter__mEntry____source_name_prime);
		return new Object[] { tPrevParameter, mPrevEntry, tParameter, eSingleVariableDeclarationToTParameter,
				mmethodSignatureToTMethodSignature, mEntry, isApplicableMatch,
				eSingleVariableDeclarationToTParameter__tParameter____target,
				mmethodSignatureToTMethodSignature__tPrevParameter____target,
	...
	public static final Object[] pattern_MethodParameterLink_12_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tPrevParameter, mPrevEntry,
				tParameter, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPrevParameter, mPrevEntry, tParameter,
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingFFFFBB(Match targetMatch,
		...
		EObject _localVariable_1 = sourceMatch.getObject("mPrevEntry");
		...
		if (tmpTPrevParameter instanceof TParameter) {
			...
			if (tmpMPrevEntry instanceof MEntry) {
				...
				if (tmpTParameter instanceof TParameter) {
					...
					if (tmpMEntry instanceof MEntry) {
						MEntry mEntry = (MEntry) tmpMEntry;
						return new Object[] { tPrevParameter, mPrevEntry, tParameter, mEntry, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
			TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter, MEntry mEntry, Match sourceMatch,
			Match targetMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tPrevParameter, mPrevEntry, tParameter, mEntry, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding != null) {
			...
			MEntry mPrevEntry = (MEntry) result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding[1];
			...
			Object[] result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_black = pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
					tPrevParameter, mPrevEntry, tParameter, mEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(MethodParameterLink _this,
			TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter, MEntry mEntry, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tPrevParameter, mPrevEntry, tParameter, mEntry,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tPrevParameter, mPrevEntry, tParameter, mEntry, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			MethodParameterLink _this, TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter,
		...
		Object[] result_pattern_MethodParameterLink_24_3_solvecsp_binding = pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(
				_this, tPrevParameter, mPrevEntry, tParameter, mEntry, sourceMatch, targetMatch);
							...
							for (MEntryToTParameter mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!eSingleVariableDeclarationToTParameter
									...
									if (mPrevEntry.equals(mmethodSignatureToTMethodSignature.getSource())) {
										_result.add(new Object[] { tPrevParameter, mPrevEntry, tParameter,
												eSingleVariableDeclarationToTParameter,
												mmethodSignatureToTMethodSignature, mEntry, sourceMatch, targetMatch });
									}
								}
							}
						}
	...
	public static final Object[] pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(
			TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter, MEntry mEntry, CCMatch ccMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				return new Object[] { tPrevParameter, mPrevEntry, tParameter, mEntry, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tPrevParameter, mPrevEntry,
				tParameter, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPrevParameter, mPrevEntry, tParameter,
					eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, mEntry, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_greenBBBBB(TParameter tPrevParameter,
			MEntry mPrevEntry, TParameter tParameter, MEntry mEntry, ModelgeneratorRuleResult ruleResult) {
		mPrevEntry.setMNext(mEntry);
		tPrevParameter.setNext(tParameter);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { tPrevParameter, mPrevEntry, tParameter, mEntry, ruleResult };
	}
