...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		TParameter tPrevParameter = (TParameter) result1_bindingAndBlack[0];
		TParameter tParameter = (TParameter) result1_bindingAndBlack[1];
		MEntry mPrevEntry = (MEntry) result1_bindingAndBlack[2];
		MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result1_bindingAndBlack[3];
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tPrevParameter,
						tParameter, mPrevEntry, mmethodSignatureToTMethodSignature,
						eSingleVariableDeclarationToTParameter, mEntry);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ mmethodSignatureToTMethodSignature + ", " + "[eSingleVariableDeclarationToTParameter] = "
					+ eSingleVariableDeclarationToTParameter + ", " + "[mEntry] = " + mEntry + ".");
		}
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				tPrevParameter, tParameter, mPrevEntry, mEntry);
		//nothing EMoflonEdge tPrevParameter__tParameter____next = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge tParameter__tPrevParameter____previous = (EMoflonEdge) result3_green[6];
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				tPrevParameter, tParameter, mPrevEntry, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, mEntry);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFFBFFBB(mPrevEntry, mEntry, match)) {
			TParameter tPrevParameter = (TParameter) result2_black[0];
			TParameter tParameter = (TParameter) result2_black[1];
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result2_black[3];
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(tPrevParameter, tParameter, mPrevEntry,
							mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, mEntry)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(tPrevParameter, tParameter,
								mPrevEntry, mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter,
								mEntry);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge mPrevEntry__mEntry____mNext = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge mEntry__mPrevEntry____mPrevious = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge eSingleVariableDeclarationToTParameter__mEntry____source = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mmethodSignatureToTMethodSignature__mPrevEntry____source = (EMoflonEdge) result3_green[10];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tPrevParameter] = "
							+ tPrevParameter + ", " + "[tParameter] = " + tParameter + ", " + "[mPrevEntry] = "
							+ mPrevEntry + ", " + "[mmethodSignatureToTMethodSignature] = "
							+ mmethodSignatureToTMethodSignature + ", " + "[eSingleVariableDeclarationToTParameter] = "
							+ eSingleVariableDeclarationToTParameter + ", " + "[mEntry] = " + mEntry + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			TParameter tParameter, MEntry mPrevEntry, MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tPrevParameter, EObject tParameter,
			EObject mPrevEntry, EObject mmethodSignatureToTMethodSignature,
			EObject eSingleVariableDeclarationToTParameter, EObject mEntry) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tPrevParameter,
						tParameter, mPrevEntry, mmethodSignatureToTMethodSignature,
						eSingleVariableDeclarationToTParameter, mEntry);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackBBFFFFB(tPrevParameter, tParameter, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(tPrevParameter, tParameter, mPrevEntry,
							mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, mEntry)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(tPrevParameter, tParameter,
								mPrevEntry, mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter,
								mEntry);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			TParameter tParameter, MEntry mPrevEntry, MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tPrevParameter, EObject tParameter,
			EObject mPrevEntry, EObject mmethodSignatureToTMethodSignature,
			EObject eSingleVariableDeclarationToTParameter, EObject mEntry) {
		ruleresult.registerObject("tPrevParameter", tPrevParameter);
		ruleresult.registerObject("tParameter", tParameter);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_85(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		TParameter tPrevParameter = (TParameter) result2_bindingAndBlack[0];
		TParameter tParameter = (TParameter) result2_bindingAndBlack[1];
		MEntry mPrevEntry = (MEntry) result2_bindingAndBlack[2];
		MEntry mEntry = (MEntry) result2_bindingAndBlack[3];

		Object[] result3_bindingAndBlack = MethodParameterLinkImpl
				.pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tPrevParameter, tParameter,
						mPrevEntry, mEntry, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tPrevParameter] = " + tPrevParameter + ", " + "[tParameter] = " + tParameter + ", "
					+ "[mPrevEntry] = " + mPrevEntry + ", " + "[mEntry] = " + mEntry + ", " + "[sourceMatch] = "
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBBFFBBB(tPrevParameter, tParameter,
							mPrevEntry, mEntry, sourceMatch, targetMatch)) {
				MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result5_black[3];
				MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result5_black[4];
				...
				Object[] result6_black = MethodParameterLinkImpl
						.pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(tPrevParameter, tParameter,
								mPrevEntry, mEntry, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tPrevParameter] = "
							+ tPrevParameter + ", " + "[tParameter] = " + tParameter + ", " + "[mPrevEntry] = "
							+ mPrevEntry + ", " + "[mEntry] = " + mEntry + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry,
			MEntry mEntry, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			MEntry mPrevEntry = (MEntry) result2_black[3];
			...
			Object[] result3_bindingAndBlack = MethodParameterLinkImpl
					.pattern_MethodParameterLink_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tPrevParameter, tParameter, mPrevEntry, mmethodSignatureToTMethodSignature,
							eSingleVariableDeclarationToTParameter, mEntry, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tPrevParameter] = " + tPrevParameter
						+ ", " + "[tParameter] = " + tParameter + ", " + "[mPrevEntry] = " + mPrevEntry + ", "
						...
						+ "[mEntry] = " + mEntry + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(tPrevParameter, tParameter,
									mPrevEntry, mmethodSignatureToTMethodSignature,
									eSingleVariableDeclarationToTParameter, mEntry, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tPrevParameter] = "
					...
					MethodParameterLinkImpl.pattern_MethodParameterLink_29_6_perform_greenBBBBB(tPrevParameter,
							tParameter, mPrevEntry, mEntry, ruleResult);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			TParameter tParameter, MEntry mPrevEntry, MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_MENTRY:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TParameter) arguments.get(1),
					(TParameter) arguments.get(2), (MEntry) arguments.get(3), (MEntryToTParameter) arguments.get(4),
					(MEntryToTParameter) arguments.get(5), (MEntry) arguments.get(6));
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_81__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_81((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_85__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_MENTRY_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("tPrevParameter");
		EObject _localVariable_1 = isApplicableMatch.getObject("tParameter");
		EObject _localVariable_2 = isApplicableMatch.getObject("mPrevEntry");
		...
		EObject tmpMPrevEntry = _localVariable_2;
					...
					if (tmpMmethodSignatureToTMethodSignature instanceof MEntryToTParameter) {
						...
						if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
							...
							if (tmpMEntry instanceof MEntry) {
								...
								return new Object[] { tPrevParameter, tParameter, mPrevEntry,
										mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry, MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			TParameter tPrevParameter = (TParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[0];
			TParameter tParameter = (TParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[1];
			MEntry mPrevEntry = (MEntry) result_pattern_MethodParameterLink_1_1_performtransformation_binding[2];
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[3];
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[4];
			MEntry mEntry = (MEntry) result_pattern_MethodParameterLink_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_MethodParameterLink_1_1_performtransformation_black = pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
					tPrevParameter, tParameter, mPrevEntry, mmethodSignatureToTMethodSignature,
					eSingleVariableDeclarationToTParameter, mEntry, _this, isApplicableMatch);
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { tPrevParameter, tParameter, mPrevEntry, mmethodSignatureToTMethodSignature,
						eSingleVariableDeclarationToTParameter, mEntry, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tPrevParameter, EObject tParameter, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature, EObject eSingleVariableDeclarationToTParameter,
			EObject mEntry) {
		if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { ruleresult, tPrevParameter, tParameter, mPrevEntry, mEntry,
				tPrevParameter__tParameter____next, tParameter__tPrevParameter____previous, mPrevEntry__mEntry____mNext,
				mEntry__mPrevEntry____mPrevious };
	}

	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			MethodParameterLink _this, PerformRuleResult ruleresult, EObject tPrevParameter, EObject tParameter,
			EObject mPrevEntry, EObject mmethodSignatureToTMethodSignature,
			EObject eSingleVariableDeclarationToTParameter, EObject mEntry) {
		_this.registerObjects_FWD(ruleresult, tPrevParameter, tParameter, mPrevEntry,
				mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, mEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFFBFFBB(MEntry mPrevEntry,
					...
					for (MEntryToTParameter mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tPrevParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { tPrevParameter, tParameter, mPrevEntry,
											mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter,
											mEntry, match });
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { tPrevParameter, tParameter, mPrevEntry, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, mEntry, isApplicableMatch, mPrevEntry__mEntry____mNext,
				mEntry__mPrevEntry____mPrevious, eSingleVariableDeclarationToTParameter__mEntry____source,
				mmethodSignatureToTMethodSignature__mPrevEntry____source,
				mmethodSignatureToTMethodSignature__tPrevParameter____target,
				eSingleVariableDeclarationToTParameter__tParameter____target };
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tPrevParameter, tParameter,
				mPrevEntry, mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, mEntry);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPrevParameter, tParameter, mPrevEntry,
					mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, mEntry };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			MethodParameterLink _this, IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			TParameter tParameter, MEntry mPrevEntry, MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry) {
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tPrevParameter, tParameter, mPrevEntry, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, mEntry);
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_11_1_performtransformation_binding != null) {
			TParameter tPrevParameter = (TParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[0];
			TParameter tParameter = (TParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[1];
			MEntry mPrevEntry = (MEntry) result_pattern_MethodParameterLink_11_1_performtransformation_binding[2];
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[3];
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[4];
			MEntry mEntry = (MEntry) result_pattern_MethodParameterLink_11_1_performtransformation_binding[5];
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mPrevEntry, EObject mmethodSignatureToTMethodSignature,
			EObject eSingleVariableDeclarationToTParameter, EObject mEntry) {
		_this.registerObjects_BWD(ruleresult, tPrevParameter, tParameter, mPrevEntry,
				mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, mEntry);
	...
	public static final Object[] pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		eSingleVariableDeclarationToTParameter__tParameter____target
				.setName(eSingleVariableDeclarationToTParameter__tParameter____target_name_prime);
		return new Object[] { tPrevParameter, tParameter, mPrevEntry, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, mEntry, isApplicableMatch, tPrevParameter__tParameter____next,
	...
	public static final Object[] pattern_MethodParameterLink_12_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tPrevParameter, tParameter,
				mPrevEntry, mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, mEntry);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPrevParameter, tParameter, mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingFFFFBB(Match targetMatch,
			Match sourceMatch) {
		EObject _localVariable_0 = targetMatch.getObject("tPrevParameter");
		EObject _localVariable_1 = targetMatch.getObject("tParameter");
		EObject _localVariable_2 = sourceMatch.getObject("mPrevEntry");
		...
		if (tmpTPrevParameter instanceof TParameter) {
			...
			if (tmpTParameter instanceof TParameter) {
				...
				if (tmpMPrevEntry instanceof MEntry) {
					...
					if (tmpMEntry instanceof MEntry) {
						MEntry mEntry = (MEntry) tmpMEntry;
						return new Object[] { tPrevParameter, tParameter, mPrevEntry, mEntry, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
			TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry, MEntry mEntry, Match sourceMatch,
			Match targetMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tPrevParameter, tParameter, mPrevEntry, mEntry, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding != null) {
			TParameter tPrevParameter = (TParameter) result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding[0];
			TParameter tParameter = (TParameter) result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding[1];
			MEntry mPrevEntry = (MEntry) result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding[2];
			MEntry mEntry = (MEntry) result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_black = pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
					tPrevParameter, tParameter, mPrevEntry, mEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(MethodParameterLink _this,
			TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry, MEntry mEntry, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tPrevParameter, tParameter, mPrevEntry, mEntry,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tPrevParameter, tParameter, mPrevEntry, mEntry, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			MethodParameterLink _this, TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry,
			MEntry mEntry, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_MethodParameterLink_24_3_solvecsp_binding = pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(
				_this, tPrevParameter, tParameter, mPrevEntry, mEntry, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBBFFBBB(
			TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry, MEntry mEntry, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tParameter.equals(tPrevParameter)) {
							...
							for (MEntryToTParameter mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!eSingleVariableDeclarationToTParameter
									...
									if (tPrevParameter.equals(mmethodSignatureToTMethodSignature.getTarget())) {
										_result.add(new Object[] { tPrevParameter, tParameter, mPrevEntry,
												mmethodSignatureToTMethodSignature,
												eSingleVariableDeclarationToTParameter, mEntry, sourceMatch,
												targetMatch });
									}
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(
			TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry, MEntry mEntry, CCMatch ccMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				return new Object[] { tPrevParameter, tParameter, mPrevEntry, mEntry, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tPrevParameter, tParameter,
				mPrevEntry, mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, mEntry,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPrevParameter, tParameter, mPrevEntry,
					mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, mEntry, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_5_checknacs_blackBBBBBB(TParameter tPrevParameter,
			TParameter tParameter, MEntry mPrevEntry, MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(TParameter tPrevParameter,
			TParameter tParameter, MEntry mPrevEntry, MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry,
			ModelgeneratorRuleResult ruleResult) {
		if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_greenBBBBB(TParameter tPrevParameter,
			TParameter tParameter, MEntry mPrevEntry, MEntry mEntry, ModelgeneratorRuleResult ruleResult) {
		tPrevParameter.setNext(tParameter);
		mPrevEntry.setMNext(mEntry);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { tPrevParameter, tParameter, mPrevEntry, mEntry, ruleResult };
	}
