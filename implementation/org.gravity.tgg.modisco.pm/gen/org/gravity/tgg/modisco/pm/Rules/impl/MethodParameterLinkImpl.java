...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result1_bindingAndBlack[5];
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tPrevParameter,
						tParameter, mPrevEntry, mEntry, eSingleVariableDeclarationToTParameter,
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				tPrevParameter, tParameter, mPrevEntry, mEntry, eSingleVariableDeclarationToTParameter,
				mmethodSignatureToTMethodSignature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFFBBFFB(mPrevEntry, mEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(tPrevParameter, tParameter, mPrevEntry,
							mEntry, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(tPrevParameter, tParameter,
								mPrevEntry, mEntry, eSingleVariableDeclarationToTParameter,
								mmethodSignatureToTMethodSignature);
				...
				//nothing EMoflonEdge mmethodSignatureToTMethodSignature__tPrevParameter____target = (EMoflonEdge) result3_green[12];
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			TParameter tParameter, MEntry mPrevEntry, MEntry mEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tPrevParameter, EObject tParameter,
			EObject mPrevEntry, EObject mEntry, EObject eSingleVariableDeclarationToTParameter,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_27(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBBBFFBB(tPrevParameter, tParameter,
							mPrevEntry, mEntry, sourceMatch, targetMatch)) {
				MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result5_black[4];
				MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result5_black[5];
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			TParameter tParameter, MEntry mPrevEntry, MEntry mEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPARAMETER_TPARAMETER_MENTRY_MENTRY_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TParameter) arguments.get(1),
					(TParameter) arguments.get(2), (MEntry) arguments.get(3), (MEntry) arguments.get(4),
					(MEntryToTParameter) arguments.get(5), (MEntryToTParameter) arguments.get(6));
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_TPARAMETER_MENTRY_MENTRY_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_26__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_26((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_27__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_TPARAMETER_MENTRY_MENTRY_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_MODELGENERATORRULERESULT:
					...
					if (tmpMEntry instanceof MEntry) {
						...
						if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
							...
							if (tmpMmethodSignatureToTMethodSignature instanceof MEntryToTParameter) {
								...
								return new Object[] { tPrevParameter, tParameter, mPrevEntry, mEntry,
										eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
										isApplicableMatch };
							}
						}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry, MEntry mEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tPrevParameter, tParameter, mPrevEntry, mEntry,
									eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, csp,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[5];
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject mEntry, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature) {
		if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		return new Object[] { ruleresult, tPrevParameter, tParameter, mPrevEntry, mEntry, mPrevEntry__mEntry____mNext,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mPrevEntry, EObject mEntry, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_FWD(ruleresult, tPrevParameter, tParameter, mPrevEntry, mEntry,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFFBBFFB(MEntry mPrevEntry,
					...
					for (MEntryToTParameter mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tPrevParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { tPrevParameter, tParameter, mPrevEntry, mEntry,
											eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
											match });
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { tPrevParameter, tParameter, mPrevEntry, mEntry, eSingleVariableDeclarationToTParameter,
				mmethodSignatureToTMethodSignature, isApplicableMatch, mPrevEntry__mEntry____mNext,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntry mEntry, MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tPrevParameter, tParameter,
				mPrevEntry, mEntry, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPrevParameter, tParameter, mPrevEntry, mEntry,
					eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tPrevParameter, tParameter, mPrevEntry, mEntry,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature);
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_11_1_performtransformation_binding != null) {
			...
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[5];
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mPrevEntry, EObject mEntry, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_BWD(ruleresult, tPrevParameter, tParameter, mPrevEntry, mEntry,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature);
	...
	public static final Object[] pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		mmethodSignatureToTMethodSignature__tPrevParameter____target
				.setName(mmethodSignatureToTMethodSignature__tPrevParameter____target_name_prime);
		return new Object[] { tPrevParameter, tParameter, mPrevEntry, mEntry, eSingleVariableDeclarationToTParameter,
				mmethodSignatureToTMethodSignature, isApplicableMatch, tPrevParameter__tParameter____next,
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBBBFFBB(
			TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry, MEntry mEntry, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry,
			MEntry mEntry, MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, ModelgeneratorRuleResult ruleResult) {
