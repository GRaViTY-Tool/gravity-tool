...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter, tParameter, mPrevEntry,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(eSingleVariableDeclarationToTParameter,
							mEntry, tPrevParameter, tParameter, mPrevEntry, mmethodSignatureToTMethodSignature)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			TParameter tParameter, MEntry mPrevEntry, MEntryToTParameter mmethodSignatureToTMethodSignature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eSingleVariableDeclarationToTParameter,
			EObject mEntry, EObject tPrevParameter, EObject tParameter, EObject mPrevEntry,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackFFBBFFB(tPrevParameter, tParameter, match)) {
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result2_black[0];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_0(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackFBBBBFBB(mEntry, tPrevParameter, tParameter,
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(
									eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter, tParameter,
									mPrevEntry, mmethodSignatureToTMethodSignature, ruleResult);
					if (result6_black == null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRY_TPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MEntryToTParameter) arguments.get(1), (MEntry) arguments.get(2), (TParameter) arguments.get(3),
					(TParameter) arguments.get(4), (MEntry) arguments.get(5), (MEntryToTParameter) arguments.get(6));
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRY_TPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_0__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRY_TPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER_MODELGENERATORRULERESULT:
					...
					if (tmpTParameter instanceof TParameter) {
						...
						if (tmpMPrevEntry instanceof MEntry) {
							...
							if (tmpMmethodSignatureToTMethodSignature instanceof MEntryToTParameter) {
								...
								return new Object[] { eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
										tParameter, mPrevEntry, mmethodSignatureToTMethodSignature, isApplicableMatch };
							}
						}
					}
				}
				...
				if (!tParameter.equals(tPrevParameter)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
									tParameter, mPrevEntry, mmethodSignatureToTMethodSignature, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			TParameter tParameter = (TParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[3];
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter, tParameter,
						mPrevEntry, mmethodSignatureToTMethodSignature, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject tPrevParameter, EObject tParameter, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature) {
														...
														if (!mPrevEntry.equals(mmethodSignatureToTMethodSignature)) {
															if (!mmethodSignatureToTMethodSignature
																...
																if (!mmethodSignatureToTMethodSignature
																	...
																	return new Object[] { ruleresult,
																			eSingleVariableDeclarationToTParameter,
																			mEntry, tPrevParameter, tParameter,
																			mPrevEntry,
																			mmethodSignatureToTMethodSignature };
																}
															}
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mEntry, EObject tPrevParameter, EObject tParameter, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_FWD(ruleresult, eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
					...
					for (MEntryToTParameter mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tPrevParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { eSingleVariableDeclarationToTParameter, mEntry,
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter, tParameter, mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntry mEntry, TParameter tPrevParameter, TParameter tParameter, MEntry mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter, tParameter,
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_11_1_performtransformation_binding != null) {
			...
			TParameter tParameter = (TParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[3];
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mEntry, EObject tPrevParameter, EObject tParameter, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_BWD(ruleresult, eSingleVariableDeclarationToTParameter, mEntry, tPrevParameter,
				tParameter, mPrevEntry, mmethodSignatureToTMethodSignature);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_12_2_corematch_blackFFBBFFB(
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSingleVariableDeclarationToTParameter, mEntry,
					tPrevParameter, tParameter, mPrevEntry, mmethodSignatureToTMethodSignature, ruleResult };
		}
		return null;
	}
