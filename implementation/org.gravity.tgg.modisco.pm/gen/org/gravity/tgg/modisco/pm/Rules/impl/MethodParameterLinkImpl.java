...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		MEntry mPrevEntry = (MEntry) result1_bindingAndBlack[3];
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFBFBFFB(mEntry, mPrevEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(mmethodSignatureToTMethodSignature, mEntry,
							eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mPrevEntry, TParameter tPrevParameter,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mmethodSignatureToTMethodSignature,
			EObject mEntry, EObject eSingleVariableDeclarationToTParameter, EObject mPrevEntry, EObject tPrevParameter,
			EObject tParameter) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackFFFFBBB(tPrevParameter, tParameter, match)) {
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result2_black[0];
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(mmethodSignatureToTMethodSignature,
							mEntry, eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_49(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackFBFBBBBB(mEntry, mPrevEntry, tPrevParameter,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			Object[] result3_bindingAndBlack = MethodParameterLinkImpl
					.pattern_MethodParameterLink_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mmethodSignatureToTMethodSignature, mEntry, eSingleVariableDeclarationToTParameter,
							mPrevEntry, tPrevParameter, tParameter, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", "
						+ "[mmethodSignatureToTMethodSignature] = " + mmethodSignatureToTMethodSignature + ", "
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(mmethodSignatureToTMethodSignature,
									mEntry, eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mPrevEntry, TParameter tPrevParameter,
			TParameter tParameter, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRY_TPARAMETER_TPARAMETER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MEntryToTParameter) arguments.get(1), (MEntry) arguments.get(2),
					(MEntryToTParameter) arguments.get(3), (MEntry) arguments.get(4), (TParameter) arguments.get(5),
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRY_TPARAMETER_TPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_49__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRY_TPARAMETER_TPARAMETER_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(MEntryToTParameter) arguments.get(1), (MEntry) arguments.get(2),
					(MEntryToTParameter) arguments.get(3), (MEntry) arguments.get(4), (TParameter) arguments.get(5),
					(TParameter) arguments.get(6), (ModelgeneratorRuleResult) arguments.get(7));
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingFFFFFFB(
		...
		EObject _localVariable_3 = isApplicableMatch.getObject("mPrevEntry");
					...
					if (tmpMPrevEntry instanceof MEntry) {
						...
						if (tmpTPrevParameter instanceof TParameter) {
							...
							if (tmpTParameter instanceof TParameter) {
								...
								return new Object[] { mmethodSignatureToTMethodSignature, mEntry,
										eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter,
										isApplicableMatch };
							}
						}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mPrevEntry, TParameter tPrevParameter,
			TParameter tParameter, MethodParameterLink _this, IsApplicableMatch isApplicableMatch) {
		if (!mEntry.equals(mPrevEntry)) {
				...
				if (!tParameter.equals(tPrevParameter)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mmethodSignatureToTMethodSignature, mEntry,
									eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter, csp,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			MEntry mPrevEntry = (MEntry) result_pattern_MethodParameterLink_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_MethodParameterLink_1_1_performtransformation_black = pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
					mmethodSignatureToTMethodSignature, mEntry, eSingleVariableDeclarationToTParameter, mPrevEntry,
					tPrevParameter, tParameter, _this, isApplicableMatch);
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { mmethodSignatureToTMethodSignature, mEntry,
						eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mmethodSignatureToTMethodSignature, EObject mEntry,
			EObject eSingleVariableDeclarationToTParameter, EObject mPrevEntry, EObject tPrevParameter,
			EObject tParameter) {
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { ruleresult, mEntry, mPrevEntry, tPrevParameter, tParameter,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mEntry, EObject eSingleVariableDeclarationToTParameter, EObject mPrevEntry, EObject tPrevParameter,
			EObject tParameter) {
		_this.registerObjects_FWD(ruleresult, mmethodSignatureToTMethodSignature, mEntry,
				eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFBFBFFB(MEntry mEntry,
					...
					for (MEntryToTParameter mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tPrevParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { mmethodSignatureToTMethodSignature, mEntry,
											eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter,
											tParameter, match });
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mmethodSignatureToTMethodSignature, mEntry, eSingleVariableDeclarationToTParameter,
				mPrevEntry, tPrevParameter, tParameter, isApplicableMatch,
				mmethodSignatureToTMethodSignature__tPrevParameter____target,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mPrevEntry, TParameter tPrevParameter,
			TParameter tParameter) {
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mmethodSignatureToTMethodSignature, mEntry,
					eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mmethodSignatureToTMethodSignature, mEntry,
				eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter);
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_11_1_performtransformation_binding != null) {
			...
			MEntry mPrevEntry = (MEntry) result_pattern_MethodParameterLink_11_1_performtransformation_binding[3];
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mEntry, EObject eSingleVariableDeclarationToTParameter, EObject mPrevEntry, EObject tPrevParameter,
			EObject tParameter) {
		_this.registerObjects_BWD(ruleresult, mmethodSignatureToTMethodSignature, mEntry,
				eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_12_2_corematch_blackFFFFBBB(
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_24_5_matchcorrcontext_blackFBFBBBBB(
			MEntry mEntry, MEntry mPrevEntry, TParameter tPrevParameter, TParameter tParameter, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mEntry.equals(mPrevEntry)) {
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mmethodSignatureToTMethodSignature,
				mEntry, eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mmethodSignatureToTMethodSignature, mEntry,
					eSingleVariableDeclarationToTParameter, mPrevEntry, tPrevParameter, tParameter, ruleResult };
		}
		return null;
	}
