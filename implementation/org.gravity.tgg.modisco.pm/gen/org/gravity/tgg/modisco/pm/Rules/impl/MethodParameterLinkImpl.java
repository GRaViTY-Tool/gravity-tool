...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tPrevParameter,
						tParameter, mmethodSignatureToTMethodSignature, mEntry, eSingleVariableDeclarationToTParameter,
						mPrevEntry);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ eSingleVariableDeclarationToTParameter + ", " + "[mPrevEntry] = " + mPrevEntry + ".");
		}
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				tPrevParameter, tParameter, mEntry, mPrevEntry);
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				tPrevParameter, tParameter, mmethodSignatureToTMethodSignature, mEntry,
				eSingleVariableDeclarationToTParameter, mPrevEntry);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFFFBFBB(mEntry, mPrevEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(tPrevParameter, tParameter,
							mmethodSignatureToTMethodSignature, mEntry, eSingleVariableDeclarationToTParameter,
							mPrevEntry)) {
				...
				//nothing EMoflonEdge mmethodSignatureToTMethodSignature__mPrevEntry____source = (EMoflonEdge) result3_green[8];
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ tPrevParameter + ", " + "[tParameter] = " + tParameter + ", "
							+ "[mmethodSignatureToTMethodSignature] = " + mmethodSignatureToTMethodSignature + ", "
							+ "[mEntry] = " + mEntry + ", " + "[eSingleVariableDeclarationToTParameter] = "
							+ eSingleVariableDeclarationToTParameter + ", " + "[mPrevEntry] = " + mPrevEntry + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			TParameter tParameter, MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mPrevEntry) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tPrevParameter, EObject tParameter,
			EObject mmethodSignatureToTMethodSignature, EObject mEntry, EObject eSingleVariableDeclarationToTParameter,
			EObject mPrevEntry) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(tPrevParameter, tParameter,
							mmethodSignatureToTMethodSignature, mEntry, eSingleVariableDeclarationToTParameter,
							mPrevEntry)) {
				Object[] result3_green = MethodParameterLinkImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_95(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_99(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBFBFBBB(tPrevParameter, tParameter, mEntry,
				...
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tPrevParameter] = "
							+ tPrevParameter + ", " + "[tParameter] = " + tParameter + ", " + "[mEntry] = " + mEntry
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TParameter tPrevParameter, TParameter tParameter, MEntry mEntry,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			Object[] result3_bindingAndBlack = MethodParameterLinkImpl
					.pattern_MethodParameterLink_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tPrevParameter, tParameter, mmethodSignatureToTMethodSignature, mEntry,
							eSingleVariableDeclarationToTParameter, mPrevEntry, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					MethodParameterLinkImpl.pattern_MethodParameterLink_29_6_perform_greenBBBBB(tPrevParameter,
							tParameter, mEntry, mPrevEntry, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TParameter tPrevParameter,
			TParameter tParameter, MEntryToTParameter mmethodSignatureToTMethodSignature, MEntry mEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mPrevEntry,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPARAMETER_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_95__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_95((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_99__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_TPARAMETER_MENTRYTOTPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRY_MODELGENERATORRULERESULT:
					...
					if (tmpMEntry instanceof MEntry) {
						...
						if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
							...
							if (tmpMPrevEntry instanceof MEntry) {
								...
								return new Object[] { tPrevParameter, tParameter, mmethodSignatureToTMethodSignature,
										mEntry, eSingleVariableDeclarationToTParameter, mPrevEntry, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			TParameter tPrevParameter, TParameter tParameter, MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntry mEntry, MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mPrevEntry,
				...
				if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tPrevParameter, tParameter, mmethodSignatureToTMethodSignature,
									mEntry, eSingleVariableDeclarationToTParameter, mPrevEntry, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodParameterLink_1_1_performtransformation_black = pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
					tPrevParameter, tParameter, mmethodSignatureToTMethodSignature, mEntry,
					eSingleVariableDeclarationToTParameter, mPrevEntry, _this, isApplicableMatch);
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { tPrevParameter, tParameter, mmethodSignatureToTMethodSignature, mEntry,
						eSingleVariableDeclarationToTParameter, mPrevEntry, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tPrevParameter, EObject tParameter,
			EObject mmethodSignatureToTMethodSignature, EObject mEntry, EObject eSingleVariableDeclarationToTParameter,
			EObject mPrevEntry) {
		if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject tPrevParameter, EObject tParameter, EObject mEntry,
			EObject mPrevEntry) {
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { ruleresult, tPrevParameter, tParameter, mEntry, mPrevEntry,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject mEntry, EObject eSingleVariableDeclarationToTParameter,
			EObject mPrevEntry) {
		_this.registerObjects_FWD(ruleresult, tPrevParameter, tParameter, mmethodSignatureToTMethodSignature, mEntry,
				eSingleVariableDeclarationToTParameter, mPrevEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFFFBFBB(MEntry mEntry,
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { tPrevParameter, tParameter,
											mmethodSignatureToTMethodSignature, mEntry,
											eSingleVariableDeclarationToTParameter, mPrevEntry, match });
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { tPrevParameter, tParameter, mmethodSignatureToTMethodSignature, mEntry,
				eSingleVariableDeclarationToTParameter, mPrevEntry, isApplicableMatch,
				mmethodSignatureToTMethodSignature__tPrevParameter____target,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, TParameter tPrevParameter, TParameter tParameter,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tPrevParameter, tParameter,
				mmethodSignatureToTMethodSignature, mEntry, eSingleVariableDeclarationToTParameter, mPrevEntry);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tPrevParameter, tParameter,
					mmethodSignatureToTMethodSignature, mEntry, eSingleVariableDeclarationToTParameter, mPrevEntry };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tPrevParameter, tParameter, mmethodSignatureToTMethodSignature, mEntry,
				eSingleVariableDeclarationToTParameter, mPrevEntry);
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject mEntry, EObject eSingleVariableDeclarationToTParameter,
			EObject mPrevEntry) {
		_this.registerObjects_BWD(ruleresult, tPrevParameter, tParameter, mmethodSignatureToTMethodSignature, mEntry,
				eSingleVariableDeclarationToTParameter, mPrevEntry);
		...
		if (tmpTPrevParameter instanceof TParameter) {
			...
			if (tmpTParameter instanceof TParameter) {
				...
				if (tmpMEntry instanceof MEntry) {
					...
					if (tmpMPrevEntry instanceof MEntry) {
						MEntry mPrevEntry = (MEntry) tmpMPrevEntry;
						return new Object[] { tPrevParameter, tParameter, mEntry, mPrevEntry, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
			TParameter tPrevParameter, TParameter tParameter, MEntry mEntry, MEntry mPrevEntry, Match sourceMatch,
			Match targetMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tPrevParameter, tParameter, mEntry, mPrevEntry, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_black = pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
					tPrevParameter, tParameter, mEntry, mPrevEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(MethodParameterLink _this,
			TParameter tPrevParameter, TParameter tParameter, MEntry mEntry, MEntry mPrevEntry, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tPrevParameter, tParameter, mEntry, mPrevEntry,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tPrevParameter, tParameter, mEntry, mPrevEntry, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			MethodParameterLink _this, TParameter tPrevParameter, TParameter tParameter, MEntry mEntry,
		...
		Object[] result_pattern_MethodParameterLink_24_3_solvecsp_binding = pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(
				_this, tPrevParameter, tParameter, mEntry, mPrevEntry, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBFBFBBB(
			TParameter tPrevParameter, TParameter tParameter, MEntry mEntry, MEntry mPrevEntry, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tParameter.equals(tPrevParameter)) {
							...
							for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!eSingleVariableDeclarationToTParameter
									...
									if (mEntry.equals(eSingleVariableDeclarationToTParameter.getSource())) {
										_result.add(new Object[] { tPrevParameter, tParameter,
												mmethodSignatureToTMethodSignature, mEntry,
												eSingleVariableDeclarationToTParameter, mPrevEntry, sourceMatch,
												targetMatch });
									}
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(
			TParameter tPrevParameter, TParameter tParameter, MEntry mEntry, MEntry mPrevEntry, CCMatch ccMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				return new Object[] { tPrevParameter, tParameter, mEntry, mPrevEntry, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_greenBBBBB(TParameter tPrevParameter,
			TParameter tParameter, MEntry mEntry, MEntry mPrevEntry, ModelgeneratorRuleResult ruleResult) {
		tPrevParameter.setNext(tParameter);
		mPrevEntry.setMNext(mEntry);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { tPrevParameter, tParameter, mEntry, mPrevEntry, ruleResult };
	}
