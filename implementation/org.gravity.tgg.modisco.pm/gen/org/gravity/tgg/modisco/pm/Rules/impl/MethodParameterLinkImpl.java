...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mEntry, mPrevEntry,
						mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, mEntry,
				mPrevEntry, tPrevParameter, tParameter);
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mEntry, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
				eSingleVariableDeclarationToTParameter);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackBBFFFFB(mEntry, mPrevEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(mEntry, mPrevEntry,
							mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
							eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(mEntry, mPrevEntry,
								mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
								eSingleVariableDeclarationToTParameter);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MEntry mEntry, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mEntry, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject tParameter,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mEntry, mPrevEntry,
						mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
						eSingleVariableDeclarationToTParameter);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackFFFBBFB(tPrevParameter, tParameter, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(mEntry, mPrevEntry,
							mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
							eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(mEntry, mPrevEntry,
								mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
								eSingleVariableDeclarationToTParameter);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MEntry mEntry, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mEntry, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		ruleresult.registerObject("mEntry", mEntry);
		ruleresult.registerObject("mPrevEntry", mPrevEntry);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_35(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodParameterLinkImpl
				.pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mEntry, mPrevEntry,
						tPrevParameter, tParameter, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mEntry] = " + mEntry + ", " + "[mPrevEntry] = " + mPrevEntry + ", " + "[tPrevParameter] = "
					+ tPrevParameter + ", " + "[tParameter] = " + tParameter + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBFBBFBB(mEntry, mPrevEntry, tPrevParameter,
				...
				Object[] result6_black = MethodParameterLinkImpl
						.pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(mEntry, mPrevEntry,
								tPrevParameter, tParameter, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MEntry mEntry, MEntry mPrevEntry, TParameter tPrevParameter,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(mEntry, mPrevEntry,
									mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
									eSingleVariableDeclarationToTParameter, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mEntry] = " + mEntry
					...
					MethodParameterLinkImpl.pattern_MethodParameterLink_29_6_perform_greenBBBBB(mEntry, mPrevEntry,
							tPrevParameter, tParameter, ruleResult);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MEntry mEntry, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRY_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_TPARAMETER_MENTRYTOTPARAMETER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MEntry) arguments.get(1),
					(MEntry) arguments.get(2), (MEntryToTParameter) arguments.get(3), (TParameter) arguments.get(4),
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_TPARAMETER_MENTRYTOTPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_34__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_34((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_35__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_CC__MENTRY_MENTRY_TPARAMETER_TPARAMETER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MEntry) arguments.get(0), (MEntry) arguments.get(1),
					(TParameter) arguments.get(2), (TParameter) arguments.get(3), (Match) arguments.get(4),
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_TPARAMETER_MENTRYTOTPARAMETER_MODELGENERATORRULERESULT:
					...
					if (tmpTPrevParameter instanceof TParameter) {
						...
						if (tmpTParameter instanceof TParameter) {
							...
							if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
								...
								return new Object[] { mEntry, mPrevEntry, mmethodSignatureToTMethodSignature,
										tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter,
										isApplicableMatch };
							}
						}
					}
				...
				if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mEntry, mPrevEntry, mmethodSignatureToTMethodSignature,
									tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { mEntry, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mEntry, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		if (!mEntry.equals(mPrevEntry)) {
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject mEntry, EObject mPrevEntry, EObject tPrevParameter,
			EObject tParameter) {
		EMoflonEdge mPrevEntry__mEntry____mNext = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mEntry__mPrevEntry____mPrevious = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mEntry, mPrevEntry, tPrevParameter, tParameter, mPrevEntry__mEntry____mNext,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			MethodParameterLink _this, PerformRuleResult ruleresult, EObject mEntry, EObject mPrevEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_FWD(ruleresult, mEntry, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackBBFFFFB(MEntry mEntry,
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { mEntry, mPrevEntry, mmethodSignatureToTMethodSignature,
											tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter,
											match });
								}
							}
							...
							if (mPrevEntry.equals(mmethodSignatureToTMethodSignature.getSource())) {
								if (mEntry.equals(eSingleVariableDeclarationToTParameter.getSource())) {
									if (tParameter.equals(eSingleVariableDeclarationToTParameter.getTarget())) {
										_result.add(new Object[] { mEntry, mPrevEntry,
												mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
												eSingleVariableDeclarationToTParameter });
									}
								}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(MEntry mEntry,
		...
		return new Object[] { mEntry, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, MEntry mEntry, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mEntry, mPrevEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEntry, mPrevEntry, mmethodSignatureToTMethodSignature,
					tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			MethodParameterLink _this, IsApplicableMatch isApplicableMatch, MEntry mEntry, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mEntry, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
				tParameter, eSingleVariableDeclarationToTParameter);
		if (result_pattern_MethodParameterLink_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodParameterLink_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mEntry, mPrevEntry,
						mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
						eSingleVariableDeclarationToTParameter };
			}
		}
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_BWD(ruleresult, mEntry, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
				tParameter, eSingleVariableDeclarationToTParameter);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_12_2_corematch_blackFFFBBFB(
	...
	public static final Object[] pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(MEntry mEntry,
		...
		return new Object[] { mEntry, mPrevEntry, mmethodSignatureToTMethodSignature, tPrevParameter, tParameter,
				...
				tParameter__tPrevParameter____previous, mmethodSignatureToTMethodSignature__mPrevEntry____source,
				eSingleVariableDeclarationToTParameter__mEntry____source,
				eSingleVariableDeclarationToTParameter__tParameter____target };
	}
	...
	public static final Object[] pattern_MethodParameterLink_12_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mEntry, mPrevEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEntry, mPrevEntry, mmethodSignatureToTMethodSignature,
		...
		if (tmpMEntry instanceof MEntry) {
			...
			if (tmpMPrevEntry instanceof MEntry) {
				...
				if (tmpTPrevParameter instanceof TParameter) {
					...
					if (tmpTParameter instanceof TParameter) {
						TParameter tParameter = (TParameter) tmpTParameter;
						return new Object[] { mEntry, mPrevEntry, tPrevParameter, tParameter, sourceMatch,
								targetMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(MEntry mEntry,
			MEntry mPrevEntry, TParameter tPrevParameter, TParameter tParameter, Match sourceMatch, Match targetMatch) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { mEntry, mPrevEntry, tPrevParameter, tParameter, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_black = pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
					mEntry, mPrevEntry, tPrevParameter, tParameter, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(MethodParameterLink _this,
			MEntry mEntry, MEntry mPrevEntry, TParameter tPrevParameter, TParameter tParameter, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mEntry, mPrevEntry, tPrevParameter, tParameter,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mEntry, mPrevEntry, tPrevParameter, tParameter, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			MethodParameterLink _this, MEntry mEntry, MEntry mPrevEntry, TParameter tPrevParameter,
		...
		Object[] result_pattern_MethodParameterLink_24_3_solvecsp_binding = pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(
				_this, mEntry, mPrevEntry, tPrevParameter, tParameter, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(MEntry mEntry,
			MEntry mPrevEntry, TParameter tPrevParameter, TParameter tParameter, CCMatch ccMatch) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
				return new Object[] { mEntry, mPrevEntry, tPrevParameter, tParameter, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mEntry, mPrevEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEntry, mPrevEntry, mmethodSignatureToTMethodSignature,
					tPrevParameter, tParameter, eSingleVariableDeclarationToTParameter, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(MEntry mEntry, MEntry mPrevEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, ModelgeneratorRuleResult ruleResult) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_greenBBBBB(MEntry mEntry, MEntry mPrevEntry,
			TParameter tPrevParameter, TParameter tParameter, ModelgeneratorRuleResult ruleResult) {
		mPrevEntry.setMNext(mEntry);
		tPrevParameter.setNext(tParameter);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { mEntry, mPrevEntry, tPrevParameter, tParameter, ruleResult };
	}
