...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, tPrevParameter,
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
				tParameter, mEntry);
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(eSingleVariableDeclarationToTParameter,
							mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry, tParameter, mEntry)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			TParameter tParameter, MEntry mEntry) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_211(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_225(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackFFBBBBBB(tPrevParameter, mPrevEntry,
							tParameter, mEntry, sourceMatch, targetMatch)) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			MEntry mPrevEntry = (MEntry) result2_black[6];
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ "[mmethodSignatureToTMethodSignature] = " + mmethodSignatureToTMethodSignature + ", "
						+ "[tPrevParameter] = " + tPrevParameter + ", " + "[mPrevEntry] = " + mPrevEntry + ", "
						+ "[tParameter] = " + tParameter + ", " + "[mEntry] = " + mEntry + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(
									eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
									tPrevParameter, mPrevEntry, tParameter, mEntry, ruleResult);
					if (result6_black == null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TPARAMETER_MENTRY:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MEntryToTParameter) arguments.get(1), (MEntryToTParameter) arguments.get(2),
					(TParameter) arguments.get(3), (MEntry) arguments.get(4), (TParameter) arguments.get(5),
					(MEntry) arguments.get(6));
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TPARAMETER_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_211__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_211((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_225__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TPARAMETER_MENTRY_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(MEntryToTParameter) arguments.get(1), (MEntryToTParameter) arguments.get(2),
					(TParameter) arguments.get(3), (MEntry) arguments.get(4), (TParameter) arguments.get(5),
					(MEntry) arguments.get(6), (ModelgeneratorRuleResult) arguments.get(7));
					...
					if (tmpMPrevEntry instanceof MEntry) {
						...
						if (tmpTParameter instanceof TParameter) {
							...
							if (tmpMEntry instanceof MEntry) {
								...
								return new Object[] { eSingleVariableDeclarationToTParameter,
										mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry, tParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			MEntryToTParameter eSingleVariableDeclarationToTParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mPrevEntry,
			TParameter tParameter, MEntry mEntry, MethodParameterLink _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodParameterLink_1_1_performtransformation_black = pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
					eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, tPrevParameter,
					mPrevEntry, tParameter, mEntry, _this, isApplicableMatch);
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
						tPrevParameter, mPrevEntry, tParameter, mEntry, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject eSingleVariableDeclarationToTParameter,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mPrevEntry, EObject tParameter,
			EObject mEntry) {
		if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
															...
															if (!mEntry.equals(mPrevEntry)) {
																if (!mEntry.equals(tParameter)) {
																	return new Object[] { ruleresult,
																			...
																			tPrevParameter, mPrevEntry, tParameter,
																			mEntry };
																}
															}
														}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { ruleresult, tPrevParameter, mPrevEntry, tParameter, mEntry,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mPrevEntry, EObject tParameter,
			EObject mEntry) {
		_this.registerObjects_FWD(ruleresult, eSingleVariableDeclarationToTParameter,
				mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry, tParameter, mEntry);
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { eSingleVariableDeclarationToTParameter,
											mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry, tParameter,
											mEntry, match });
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
				tPrevParameter, mPrevEntry, tParameter, mEntry, isApplicableMatch,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSingleVariableDeclarationToTParameter,
					mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry, tParameter, mEntry };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
				tPrevParameter, mPrevEntry, tParameter, mEntry);
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mPrevEntry, EObject tParameter,
			EObject mEntry) {
		_this.registerObjects_BWD(ruleresult, eSingleVariableDeclarationToTParameter,
				mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry, tParameter, mEntry);
	...
	public static final Object[] pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		eSingleVariableDeclarationToTParameter__mEntry____source
				.setName(eSingleVariableDeclarationToTParameter__mEntry____source_name_prime);
		return new Object[] { eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature,
				tPrevParameter, mPrevEntry, tParameter, mEntry, isApplicableMatch, tPrevParameter__tParameter____next,
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_24_5_matchcorrcontext_blackFFBBBBBB(
			TParameter tPrevParameter, MEntry mPrevEntry, TParameter tParameter, MEntry mEntry, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch,
				eSingleVariableDeclarationToTParameter, mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
				tParameter, mEntry, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSingleVariableDeclarationToTParameter,
					mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry, tParameter, mEntry, ruleResult };
		}
		return null;
	}
