...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		TParameter tPrevParameter = (TParameter) result1_bindingAndBlack[3];
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, mEntry, tParameter,
						mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, mEntry,
				tParameter, tPrevParameter, mPrevEntry);
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mEntry, tParameter, mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
				eSingleVariableDeclarationToTParameter);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackBFFFBFB(mEntry, mPrevEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(mEntry, tParameter,
							mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
							eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(mEntry, tParameter,
								mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
								eSingleVariableDeclarationToTParameter);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mEntry, EObject tParameter,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mPrevEntry,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackFBFBFFB(tParameter, tPrevParameter, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(mEntry, tParameter,
							mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
							eSingleVariableDeclarationToTParameter)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(mEntry, tParameter,
								mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
								eSingleVariableDeclarationToTParameter);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge mmethodSignatureToTMethodSignature__tPrevParameter____target = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_596(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_642(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		TParameter tPrevParameter = (TParameter) result2_bindingAndBlack[2];
		MEntry mPrevEntry = (MEntry) result2_bindingAndBlack[3];

		Object[] result3_bindingAndBlack = MethodParameterLinkImpl
				.pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mEntry, tParameter,
						tPrevParameter, mPrevEntry, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mEntry] = " + mEntry + ", " + "[tParameter] = " + tParameter + ", " + "[tPrevParameter] = "
					+ tPrevParameter + ", " + "[mPrevEntry] = " + mPrevEntry + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBFBBFBB(mEntry, tParameter, tPrevParameter,
				...
				Object[] result6_black = MethodParameterLinkImpl
						.pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(mEntry, tParameter,
								tPrevParameter, mPrevEntry, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MEntry mEntry, TParameter tParameter, TParameter tPrevParameter,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(mEntry, tParameter,
									mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
									eSingleVariableDeclarationToTParameter, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mEntry] = " + mEntry
					...
					MethodParameterLinkImpl.pattern_MethodParameterLink_29_6_perform_greenBBBBB(mEntry, tParameter,
							tPrevParameter, mPrevEntry, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MEntry) arguments.get(1),
					(TParameter) arguments.get(2), (MEntryToTParameter) arguments.get(3), (TParameter) arguments.get(4),
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_596__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_596((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_642__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_642((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_TPARAMETER_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingFFFFFFB(
		...
		EObject _localVariable_3 = isApplicableMatch.getObject("tPrevParameter");
					...
					if (tmpTPrevParameter instanceof TParameter) {
						...
						if (tmpMPrevEntry instanceof MEntry) {
							...
							if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
								...
								return new Object[] { mEntry, tParameter, mmethodSignatureToTMethodSignature,
										tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(MEntry mEntry,
			TParameter tParameter, MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter,
			MEntry mPrevEntry, MEntryToTParameter eSingleVariableDeclarationToTParameter, MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch) {
		if (!mEntry.equals(mPrevEntry)) {
				...
				if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mEntry, tParameter, mmethodSignatureToTMethodSignature,
									tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			TParameter tPrevParameter = (TParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[3];
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { mEntry, tParameter, mmethodSignatureToTMethodSignature, tPrevParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mEntry, EObject tParameter,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mPrevEntry,
			EObject eSingleVariableDeclarationToTParameter) {
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject mEntry, EObject tParameter, EObject tPrevParameter,
			EObject mPrevEntry) {
		EMoflonEdge mPrevEntry__mEntry____mNext = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mEntry__mPrevEntry____mPrevious = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mEntry, tParameter, tPrevParameter, mPrevEntry, mPrevEntry__mEntry____mNext,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mPrevEntry,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_FWD(ruleresult, mEntry, tParameter, mmethodSignatureToTMethodSignature, tPrevParameter,
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackBFFFBFB(MEntry mEntry,
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { mEntry, tParameter, mmethodSignatureToTMethodSignature,
											tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter,
											match });
								}
							}
							...
							if (tParameter.equals(eSingleVariableDeclarationToTParameter.getTarget())) {
								if (mPrevEntry.equals(mmethodSignatureToTMethodSignature.getSource())) {
									if (mEntry.equals(eSingleVariableDeclarationToTParameter.getSource())) {
										_result.add(new Object[] { mEntry, tParameter,
												mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
												eSingleVariableDeclarationToTParameter });
									}
								}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(MEntry mEntry,
		...
		return new Object[] { mEntry, tParameter, mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, MEntry mEntry, TParameter tParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mPrevEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mEntry, tParameter,
				mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEntry, tParameter, mmethodSignatureToTMethodSignature,
					tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mEntry, tParameter, mmethodSignatureToTMethodSignature, tPrevParameter,
				mPrevEntry, eSingleVariableDeclarationToTParameter);
		if (result_pattern_MethodParameterLink_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodParameterLink_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mEntry, tParameter,
						mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry,
						eSingleVariableDeclarationToTParameter };
			}
		}
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_11_1_performtransformation_binding != null) {
			...
			TParameter tPrevParameter = (TParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[3];
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter, EObject mPrevEntry,
			EObject eSingleVariableDeclarationToTParameter) {
		_this.registerObjects_BWD(ruleresult, mEntry, tParameter, mmethodSignatureToTMethodSignature, tPrevParameter,
				mPrevEntry, eSingleVariableDeclarationToTParameter);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_12_2_corematch_blackFBFBFFB(
	...
	public static final Object[] pattern_MethodParameterLink_12_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter, MEntry mPrevEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mEntry, tParameter,
				mmethodSignatureToTMethodSignature, tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEntry, tParameter, mmethodSignatureToTMethodSignature,
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingFFFFBB(Match sourceMatch,
		...
		EObject _localVariable_2 = targetMatch.getObject("tPrevParameter");
		...
		if (tmpMEntry instanceof MEntry) {
			...
			if (tmpTParameter instanceof TParameter) {
				...
				if (tmpTPrevParameter instanceof TParameter) {
					...
					if (tmpMPrevEntry instanceof MEntry) {
						MEntry mPrevEntry = (MEntry) tmpMPrevEntry;
						return new Object[] { mEntry, tParameter, tPrevParameter, mPrevEntry, sourceMatch,
								targetMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(MEntry mEntry,
			TParameter tParameter, TParameter tPrevParameter, MEntry mPrevEntry, Match sourceMatch, Match targetMatch) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { mEntry, tParameter, tPrevParameter, mPrevEntry, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding != null) {
			...
			TParameter tPrevParameter = (TParameter) result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding[2];
			...
			Object[] result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_black = pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
					mEntry, tParameter, tPrevParameter, mPrevEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(MethodParameterLink _this,
			MEntry mEntry, TParameter tParameter, TParameter tPrevParameter, MEntry mPrevEntry, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mEntry, tParameter, tPrevParameter, mPrevEntry,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mEntry, tParameter, tPrevParameter, mPrevEntry, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			MethodParameterLink _this, MEntry mEntry, TParameter tParameter, TParameter tPrevParameter,
		...
		Object[] result_pattern_MethodParameterLink_24_3_solvecsp_binding = pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(
				_this, mEntry, tParameter, tPrevParameter, mPrevEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(MEntry mEntry,
			TParameter tParameter, TParameter tPrevParameter, MEntry mPrevEntry, CCMatch ccMatch) {
		if (!mEntry.equals(mPrevEntry)) {
			if (!tParameter.equals(tPrevParameter)) {
				return new Object[] { mEntry, tParameter, tPrevParameter, mPrevEntry, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEntry, tParameter, mmethodSignatureToTMethodSignature,
					tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_greenBBBBB(MEntry mEntry,
			TParameter tParameter, TParameter tPrevParameter, MEntry mPrevEntry, ModelgeneratorRuleResult ruleResult) {
		mPrevEntry.setMNext(mEntry);
		tPrevParameter.setNext(tParameter);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { mEntry, tParameter, tPrevParameter, mPrevEntry, ruleResult };
	}
