...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						...
						tPrevParameter, mEntry, mPrevEntry);
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter,
				mEntry, mPrevEntry);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFFFFBBB(mEntry, mPrevEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(mmethodSignatureToTMethodSignature,
							eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter, mEntry, mPrevEntry)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tParameter, TParameter tPrevParameter,
			MEntry mEntry, MEntry mPrevEntry) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mmethodSignatureToTMethodSignature,
			EObject eSingleVariableDeclarationToTParameter, EObject tParameter, EObject tPrevParameter, EObject mEntry,
			EObject mPrevEntry) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackFFBBFFB(tParameter, tPrevParameter, match)) {
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result2_black[0];
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result2_black[1];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_209(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_218(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackFFBBBBBB(tParameter, tPrevParameter, mEntry,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ "[eSingleVariableDeclarationToTParameter] = " + eSingleVariableDeclarationToTParameter + ", "
						+ "[tParameter] = " + tParameter + ", " + "[tPrevParameter] = " + tPrevParameter + ", "
						+ "[mEntry] = " + mEntry + ", " + "[mPrevEntry] = " + mPrevEntry + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(mmethodSignatureToTMethodSignature,
									eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter, mEntry,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tParameter, TParameter tPrevParameter,
			MEntry mEntry, MEntry mPrevEntry, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_TPARAMETER_TPARAMETER_MENTRY_MENTRY:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MEntryToTParameter) arguments.get(1), (MEntryToTParameter) arguments.get(2),
					(TParameter) arguments.get(3), (TParameter) arguments.get(4), (MEntry) arguments.get(5),
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_TPARAMETER_TPARAMETER_MENTRY_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_209__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_209((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_218__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_MENTRYTOTPARAMETER_TPARAMETER_TPARAMETER_MENTRY_MENTRY_MODELGENERATORRULERESULT:
					...
					if (tmpTPrevParameter instanceof TParameter) {
						...
						if (tmpMEntry instanceof MEntry) {
							...
							if (tmpMPrevEntry instanceof MEntry) {
								...
								return new Object[] { mmethodSignatureToTMethodSignature,
										eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter, mEntry,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tParameter, TParameter tPrevParameter,
			MEntry mEntry, MEntry mPrevEntry, MethodParameterLink _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodParameterLink_1_1_performtransformation_black = pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
					mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, tParameter,
					tPrevParameter, mEntry, mPrevEntry, _this, isApplicableMatch);
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter,
						tParameter, tPrevParameter, mEntry, mPrevEntry, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mmethodSignatureToTMethodSignature,
			EObject eSingleVariableDeclarationToTParameter, EObject tParameter, EObject tPrevParameter, EObject mEntry,
			EObject mPrevEntry) {
															...
															if (!mPrevEntry.equals(tParameter)) {
																if (!mPrevEntry.equals(tPrevParameter)) {
																	return new Object[] { ruleresult,
																			...
																			eSingleVariableDeclarationToTParameter,
																			tParameter, tPrevParameter, mEntry,
																			mPrevEntry };
																}
															}
														}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { ruleresult, tParameter, tPrevParameter, mEntry, mPrevEntry,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject eSingleVariableDeclarationToTParameter, EObject tParameter, EObject tPrevParameter, EObject mEntry,
			EObject mPrevEntry) {
		_this.registerObjects_FWD(ruleresult, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter, mEntry, mPrevEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFFFFBBB(MEntry mEntry,
					...
					for (MEntryToTParameter mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tPrevParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { mmethodSignatureToTMethodSignature,
											eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter, mEntry,
											mPrevEntry, match });
								}
							}
							...
							if (tPrevParameter.equals(mmethodSignatureToTMethodSignature.getTarget())) {
								if (mPrevEntry.equals(mmethodSignatureToTMethodSignature.getSource())) {
									if (mEntry.equals(mPrevEntry.getMNext())) {
										_result.add(new Object[] { mmethodSignatureToTMethodSignature,
												eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter,
												mEntry, mPrevEntry });
									}
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, tParameter,
				tPrevParameter, mEntry, mPrevEntry, isApplicableMatch,
				eSingleVariableDeclarationToTParameter__tParameter____target,
				eSingleVariableDeclarationToTParameter__mEntry____source,
				mmethodSignatureToTMethodSignature__tPrevParameter____target,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter,
				tParameter, tPrevParameter, mEntry, mPrevEntry);
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject eSingleVariableDeclarationToTParameter, EObject tParameter, EObject tPrevParameter, EObject mEntry,
			EObject mPrevEntry) {
		_this.registerObjects_BWD(ruleresult, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter, mEntry, mPrevEntry);
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, MEntryToTParameter mmethodSignatureToTMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tParameter, TParameter tPrevParameter,
			MEntry mEntry, MEntry mPrevEntry, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter, mEntry, mPrevEntry, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mmethodSignatureToTMethodSignature,
					eSingleVariableDeclarationToTParameter, tParameter, tPrevParameter, mEntry, mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_29_3_solveCSP_binding = pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter,
				tParameter, tPrevParameter, mEntry, mPrevEntry, ruleResult);
