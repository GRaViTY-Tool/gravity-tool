...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tParameter,
						eSingleVariableDeclarationToTParameter, mPrevEntry, mEntry, mmethodSignatureToTMethodSignature,
						tPrevParameter);
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				tParameter, eSingleVariableDeclarationToTParameter, mPrevEntry, mEntry,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(tParameter,
							eSingleVariableDeclarationToTParameter, mPrevEntry, mEntry,
							mmethodSignatureToTMethodSignature, tPrevParameter)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TParameter tParameter,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mPrevEntry, MEntry mEntry,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tPrevParameter) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tParameter,
			EObject eSingleVariableDeclarationToTParameter, EObject mPrevEntry, EObject mEntry,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackBFFFFBB(tParameter, tPrevParameter, match)) {
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result2_black[1];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_38(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBFBBFBBB(tParameter, mPrevEntry, mEntry,
							tPrevParameter, sourceMatch, targetMatch)) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_37__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_37((EMoflonEdge) arguments.get(0));
			case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_38__EMOFLONEDGE:
					...
					if (tmpMEntry instanceof MEntry) {
						...
						if (tmpMmethodSignatureToTMethodSignature instanceof MEntryToTParameter) {
							...
							if (tmpTPrevParameter instanceof TParameter) {
								...
								return new Object[] { tParameter, eSingleVariableDeclarationToTParameter, mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			TParameter tParameter, MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { tParameter, eSingleVariableDeclarationToTParameter, mPrevEntry, mEntry,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject mPrevEntry, EObject mEntry, EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter) {
		if (!tParameter.equals(tPrevParameter)) {
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject eSingleVariableDeclarationToTParameter, EObject mPrevEntry, EObject mEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter) {
		_this.registerObjects_FWD(ruleresult, tParameter, eSingleVariableDeclarationToTParameter, mPrevEntry, mEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter);
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { tParameter, eSingleVariableDeclarationToTParameter,
											mPrevEntry, mEntry, mmethodSignatureToTMethodSignature, tPrevParameter,
											match });
								}
							}
							...
							if (mPrevEntry.equals(mmethodSignatureToTMethodSignature.getSource())) {
								if (tPrevParameter.equals(mmethodSignatureToTMethodSignature.getTarget())) {
									if (mEntry.equals(eSingleVariableDeclarationToTParameter.getSource())) {
										_result.add(new Object[] { tParameter, eSingleVariableDeclarationToTParameter,
												mPrevEntry, mEntry, mmethodSignatureToTMethodSignature,
												tPrevParameter });
									}
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tParameter, eSingleVariableDeclarationToTParameter, mPrevEntry, mEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter);
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject eSingleVariableDeclarationToTParameter, EObject mPrevEntry, EObject mEntry,
			EObject mmethodSignatureToTMethodSignature, EObject tPrevParameter) {
		_this.registerObjects_BWD(ruleresult, tParameter, eSingleVariableDeclarationToTParameter, mPrevEntry, mEntry,
				mmethodSignatureToTMethodSignature, tPrevParameter);
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParameter, eSingleVariableDeclarationToTParameter,
					mPrevEntry, mEntry, mmethodSignatureToTMethodSignature, tPrevParameter, ruleResult };
		}
		return null;
	}
