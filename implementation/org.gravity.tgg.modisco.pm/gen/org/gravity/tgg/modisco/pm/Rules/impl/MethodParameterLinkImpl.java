...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		TParameter tPrevParameter = (TParameter) result1_bindingAndBlack[4];
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tParameter, mEntry,
						mPrevEntry, eSingleVariableDeclarationToTParameter, tPrevParameter,
						mmethodSignatureToTMethodSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tParameter] = " + tParameter + ", " + "[mEntry] = " + mEntry + ", " + "[mPrevEntry] = "
					+ mPrevEntry + ", " + "[eSingleVariableDeclarationToTParameter] = "
					+ eSingleVariableDeclarationToTParameter + ", " + "[tPrevParameter] = " + tPrevParameter + ", "
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				tParameter, mEntry, mPrevEntry, tPrevParameter);
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				tParameter, mEntry, mPrevEntry, eSingleVariableDeclarationToTParameter, tPrevParameter,
				mmethodSignatureToTMethodSignature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFBBFFFB(mEntry, mPrevEntry, match)) {
			...
			TParameter tPrevParameter = (TParameter) result2_black[4];
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(tParameter, mEntry, mPrevEntry,
							eSingleVariableDeclarationToTParameter, tPrevParameter,
							mmethodSignatureToTMethodSignature)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(tParameter, mEntry, mPrevEntry,
								eSingleVariableDeclarationToTParameter, tPrevParameter,
								mmethodSignatureToTMethodSignature);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TParameter tParameter, MEntry mEntry,
			MEntry mPrevEntry, MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tPrevParameter,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tParameter, EObject mEntry,
			EObject mPrevEntry, EObject eSingleVariableDeclarationToTParameter, EObject tPrevParameter,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tParameter, mEntry,
						mPrevEntry, eSingleVariableDeclarationToTParameter, tPrevParameter,
						mmethodSignatureToTMethodSignature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackBFFFBFB(tParameter, tPrevParameter, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_12_3_findcontext_blackBBBBBB(tParameter, mEntry, mPrevEntry,
							eSingleVariableDeclarationToTParameter, tPrevParameter,
							mmethodSignatureToTMethodSignature)) {
				Object[] result3_green = MethodParameterLinkImpl
						.pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(tParameter, mEntry, mPrevEntry,
								eSingleVariableDeclarationToTParameter, tPrevParameter,
								mmethodSignatureToTMethodSignature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge eSingleVariableDeclarationToTParameter__mEntry____source = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TParameter tParameter, MEntry mEntry,
			MEntry mPrevEntry, MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tPrevParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tParameter, EObject mEntry,
			EObject mPrevEntry, EObject eSingleVariableDeclarationToTParameter, EObject tPrevParameter,
			EObject mmethodSignatureToTMethodSignature) {
		ruleresult.registerObject("tParameter", tParameter);
		ruleresult.registerObject("mEntry", mEntry);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_215(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_232(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodParameterLinkImpl
				.pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tParameter, mEntry, mPrevEntry,
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBBFBFBB(tParameter, mEntry, mPrevEntry,
							tPrevParameter, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = MethodParameterLinkImpl
						.pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(tParameter, mEntry,
								mPrevEntry, tPrevParameter, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tParameter] = "
							+ tParameter + ", " + "[mEntry] = " + mEntry + ", " + "[mPrevEntry] = " + mPrevEntry + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TParameter tParameter, MEntry mEntry, MEntry mPrevEntry,
		...
		for (Object[] result2_black : MethodParameterLinkImpl
			...
			if (MethodParameterLinkImpl.pattern_MethodParameterLink_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(tParameter, mEntry, mPrevEntry,
									eSingleVariableDeclarationToTParameter, tPrevParameter,
									mmethodSignatureToTMethodSignature, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tParameter] = "
					...
					MethodParameterLinkImpl.pattern_MethodParameterLink_29_6_perform_greenBBBBB(tParameter, mEntry,
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TParameter tParameter, MEntry mEntry,
			MEntry mPrevEntry, MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tPrevParameter,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRY_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_MENTRYTOTPARAMETER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TParameter) arguments.get(1),
					(MEntry) arguments.get(2), (MEntry) arguments.get(3), (MEntryToTParameter) arguments.get(4),
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRY_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_MENTRYTOTPARAMETER:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_215__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_215((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_232__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TPARAMETER_MENTRY_MENTRY_MENTRYTOTPARAMETER_TPARAMETER_MENTRYTOTPARAMETER_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingFFFFFFB(
		...
		EObject _localVariable_4 = isApplicableMatch.getObject("tPrevParameter");
		...
		EObject tmpTPrevParameter = _localVariable_4;
					...
					if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
						...
						if (tmpTPrevParameter instanceof TParameter) {
							...
							if (tmpMmethodSignatureToTMethodSignature instanceof MEntryToTParameter) {
								...
								return new Object[] { tParameter, mEntry, mPrevEntry,
										eSingleVariableDeclarationToTParameter, tPrevParameter,
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_blackBBBBBBFBB(
			TParameter tParameter, MEntry mEntry, MEntry mPrevEntry,
				...
				if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							...
							return new Object[] { tParameter, mEntry, mPrevEntry,
									eSingleVariableDeclarationToTParameter, tPrevParameter,
									mmethodSignatureToTMethodSignature, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			MEntry mEntry = (MEntry) result_pattern_MethodParameterLink_1_1_performtransformation_binding[1];
			...
			TParameter tPrevParameter = (TParameter) result_pattern_MethodParameterLink_1_1_performtransformation_binding[4];
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { tParameter, mEntry, mPrevEntry, eSingleVariableDeclarationToTParameter,
						tPrevParameter, mmethodSignatureToTMethodSignature, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tParameter, EObject mEntry, EObject mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		return new Object[] { ruleresult, tParameter, mEntry, mPrevEntry, tPrevParameter, mPrevEntry__mEntry____mNext,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			MethodParameterLink _this, PerformRuleResult ruleresult, EObject tParameter, EObject mEntry,
			EObject mPrevEntry, EObject eSingleVariableDeclarationToTParameter, EObject tPrevParameter,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_FWD(ruleresult, tParameter, mEntry, mPrevEntry, eSingleVariableDeclarationToTParameter,
				tPrevParameter, mmethodSignatureToTMethodSignature);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFBBFFFB(MEntry mEntry,
					...
					for (MEntryToTParameter mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tPrevParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { tParameter, mEntry, mPrevEntry,
											eSingleVariableDeclarationToTParameter, tPrevParameter,
	...
	public static final Object[] pattern_MethodParameterLink_2_3_findcontext_greenBBBBBBFFFFFFF(TParameter tParameter,
			...
			TParameter tPrevParameter, MEntryToTParameter mmethodSignatureToTMethodSignature) {
		...
		return new Object[] { tParameter, mEntry, mPrevEntry, eSingleVariableDeclarationToTParameter, tPrevParameter,
				mmethodSignatureToTMethodSignature, isApplicableMatch,
				eSingleVariableDeclarationToTParameter__mEntry____source,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			IsApplicableMatch isApplicableMatch, TParameter tParameter, MEntry mEntry, MEntry mPrevEntry,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tPrevParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tParameter, mEntry, mPrevEntry,
				eSingleVariableDeclarationToTParameter, tPrevParameter, mmethodSignatureToTMethodSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParameter, mEntry, mPrevEntry,
					eSingleVariableDeclarationToTParameter, tPrevParameter, mmethodSignatureToTMethodSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			MethodParameterLink _this, IsApplicableMatch isApplicableMatch, TParameter tParameter, MEntry mEntry,
			MEntry mPrevEntry, MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tPrevParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature) {
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tParameter, mEntry, mPrevEntry, eSingleVariableDeclarationToTParameter,
				tPrevParameter, mmethodSignatureToTMethodSignature);
	...
	public static final Object[] pattern_MethodParameterLink_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_11_1_performtransformation_binding != null) {
			...
			MEntry mEntry = (MEntry) result_pattern_MethodParameterLink_11_1_performtransformation_binding[1];
			...
			TParameter tPrevParameter = (TParameter) result_pattern_MethodParameterLink_11_1_performtransformation_binding[4];
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mPrevEntry, EObject eSingleVariableDeclarationToTParameter, EObject tPrevParameter,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_BWD(ruleresult, tParameter, mEntry, mPrevEntry, eSingleVariableDeclarationToTParameter,
				tPrevParameter, mmethodSignatureToTMethodSignature);
	...
	public static final Object[] pattern_MethodParameterLink_12_3_findcontext_greenBBBBBBFFFFFFF(TParameter tParameter,
		...
		return new Object[] { tParameter, mEntry, mPrevEntry, eSingleVariableDeclarationToTParameter, tPrevParameter,
				mmethodSignatureToTMethodSignature, isApplicableMatch,
				eSingleVariableDeclarationToTParameter__mEntry____source,
				eSingleVariableDeclarationToTParameter__tParameter____target, tPrevParameter__tParameter____next,
	...
	public static final Object[] pattern_MethodParameterLink_12_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			MEntryToTParameter eSingleVariableDeclarationToTParameter, TParameter tPrevParameter,
			MEntryToTParameter mmethodSignatureToTMethodSignature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tParameter, mEntry, mPrevEntry,
				eSingleVariableDeclarationToTParameter, tPrevParameter, mmethodSignatureToTMethodSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParameter, mEntry, mPrevEntry,
		...
		if (tmpTParameter instanceof TParameter) {
			...
			if (tmpMEntry instanceof MEntry) {
				...
				if (tmpMPrevEntry instanceof MEntry) {
					...
					if (tmpTPrevParameter instanceof TParameter) {
						TParameter tPrevParameter = (TParameter) tmpTPrevParameter;
						return new Object[] { tParameter, mEntry, mPrevEntry, tPrevParameter, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(TParameter tParameter,
			MEntry mEntry, MEntry mPrevEntry, TParameter tPrevParameter, Match sourceMatch, Match targetMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tParameter, mEntry, mPrevEntry, tPrevParameter, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding != null) {
			...
			MEntry mEntry = (MEntry) result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding[1];
			...
			Object[] result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_black = pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
					tParameter, mEntry, mPrevEntry, tPrevParameter, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(MethodParameterLink _this,
			TParameter tParameter, MEntry mEntry, MEntry mPrevEntry, TParameter tPrevParameter, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tParameter, mEntry, mPrevEntry, tPrevParameter,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tParameter, mEntry, mPrevEntry, tPrevParameter, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			MethodParameterLink _this, TParameter tParameter, MEntry mEntry, MEntry mPrevEntry,
		...
		Object[] result_pattern_MethodParameterLink_24_3_solvecsp_binding = pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(
				_this, tParameter, mEntry, mPrevEntry, tPrevParameter, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_24_5_matchcorrcontext_blackBBBFBFBB(
			TParameter tParameter, MEntry mEntry, MEntry mPrevEntry, TParameter tPrevParameter, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tParameter.equals(tPrevParameter)) {
	...
	public static final Object[] pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(TParameter tParameter,
			MEntry mEntry, MEntry mPrevEntry, TParameter tPrevParameter, CCMatch ccMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				return new Object[] { tParameter, mEntry, mPrevEntry, tPrevParameter, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tParameter, mEntry, mPrevEntry,
				eSingleVariableDeclarationToTParameter, tPrevParameter, mmethodSignatureToTMethodSignature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tParameter, mEntry, mPrevEntry,
					eSingleVariableDeclarationToTParameter, tPrevParameter, mmethodSignatureToTMethodSignature,
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_29_3_solveCSP_binding = pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tParameter, mEntry, mPrevEntry, eSingleVariableDeclarationToTParameter,
				tPrevParameter, mmethodSignatureToTMethodSignature, ruleResult);
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_greenBBBBB(TParameter tParameter,
			MEntry mEntry, MEntry mPrevEntry, TParameter tPrevParameter, ModelgeneratorRuleResult ruleResult) {
		mPrevEntry.setMNext(mEntry);
		tPrevParameter.setNext(tParameter);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { tParameter, mEntry, mPrevEntry, tPrevParameter, ruleResult };
	}
