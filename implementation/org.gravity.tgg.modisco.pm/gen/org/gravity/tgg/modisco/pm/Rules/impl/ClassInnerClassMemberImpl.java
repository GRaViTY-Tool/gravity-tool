...
public class ClassInnerClassMemberImpl extends AbstractRuleImpl implements ClassInnerClassMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_1_1_performtransformation_greenFBBFBFBB(mInnerClass, typeGraph,
		...
		Object[] result2_black = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_1_2_collecttranslatedelements_blackBBBB(tInnerTypeToTInnerAbstractType,
						mInnerClass, tInnerPackage, tInnerClass);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[tInnerTypeToTInnerAbstractType] = "
							+ tInnerTypeToTInnerAbstractType + ", " + "[mInnerClass] = " + mInnerClass + ", "
							+ "[tInnerPackage] = " + tInnerPackage + ", " + "[tInnerClass] = " + tInnerClass + ".");
		}
		Object[] result2_green = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_1_2_collecttranslatedelements_greenFBBBB(tInnerTypeToTInnerAbstractType,
						mInnerClass, tInnerPackage, tInnerClass);
		...
		ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFF(
				ruleresult, tInnerTypeToTInnerAbstractType, mInnerClass, typeGraph, tInnerPackage, tOuterClass,
				mDefinition, tInnerClass, tOuterPackage);
		//nothing EMoflonEdge typeGraph__tInnerClass____classes = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge tInnerPackage__tInnerClass____classes = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge tInnerTypeToTInnerAbstractType__mInnerClass____source = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge tInnerPackage__tInnerClass____ownedTypes = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge tInnerClass__tInnerPackage____package = (EMoflonEdge) result3_green[13];
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_2_2_corematch_blackBBFBFB(
			...
			for (Object[] result3_black : ClassInnerClassMemberImpl
					.pattern_ClassInnerClassMember_2_3_findcontext_blackBFBBBBF(mInnerClass, eOuterClass, tOuterClass,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType,
			...
			EObject mDefinition, EObject tInnerClass, EObject eOuterClassToTOuterClass, EObject tOuterPackage) {
	...
	public boolean isAppropriate_BWD(Match match, TypeGraph typeGraph, TPackage tInnerPackage, TClass tOuterClass,
		...
		if (ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			//nothing EMoflonEdge tInnerPackage__tInnerClass____ownedTypes = (EMoflonEdge) result4_green[8];
			//nothing EMoflonEdge tInnerClass__tInnerPackage____package = (EMoflonEdge) result4_green[9];
			//nothing EMoflonEdge tInnerPackage__tOuterPackage____parent = (EMoflonEdge) result4_green[10];
			//nothing EMoflonEdge tOuterPackage__tInnerPackage____subpackage = (EMoflonEdge) result4_green[11];
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_11_2_collecttranslatedelements_blackBBBB(tInnerTypeToTInnerAbstractType,
						mInnerClass, tInnerPackage, tInnerClass);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[tInnerTypeToTInnerAbstractType] = "
		...
		Object[] result2_green = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_11_2_collecttranslatedelements_greenFBBBB(tInnerTypeToTInnerAbstractType,
						mInnerClass, tInnerPackage, tInnerClass);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : ClassInnerClassMemberImpl
			...
			for (Object[] result3_black : ClassInnerClassMemberImpl
				...
				//nothing EMoflonEdge tInnerPackage__tInnerClass____ownedTypes = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge tInnerClass__tInnerPackage____package = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge tInnerPackage__tOuterPackage____parent = (EMoflonEdge) result3_green[15];
				//nothing EMoflonEdge tOuterPackage__tInnerPackage____subpackage = (EMoflonEdge) result3_green[16];
				//nothing EMoflonEdge typeGraph__tInnerClass____ownedTypes = (EMoflonEdge) result3_green[17];
				//nothing EMoflonEdge tInnerClass__typeGraph____pg = (EMoflonEdge) result3_green[18];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_704(EMoflonEdge _edge_classes) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_723(EMoflonEdge _edge_mInnerTypes) {
		...
		for (Object[] result2_black : ClassInnerClassMemberImpl
			...
			if (ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_29_6_perform_greenFFBFBBFBBB(typeGraph,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MCLASS_TYPEGRAPH_CLASSDECLARATION_TCLASS_MABSTRACTMETHODDEFINITION_TYPETOTABSTRACTTYPE_TPACKAGE:
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_704__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_704((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_723__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_723((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__MCLASS_TYPEGRAPH_CLASSDECLARATION_TPACKAGE_TCLASS_MABSTRACTMETHODDEFINITION_TCLASS_TPACKAGE_MATCH_MATCH:
	...
	public static final Object[] pattern_ClassInnerClassMember_1_1_performtransformation_greenFBBFBFBB(
	...
	public static final Object[] pattern_ClassInnerClassMember_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			...
			EObject tInnerClass, EObject eOuterClassToTOuterClass, EObject tOuterPackage) {
																...
																if (!eOuterClass.equals(mDefinition)) {
																	if (!eOuterClass.equals(tInnerClass)) {
																		if (!eOuterClass
																			...
																			if (!eOuterClass.equals(tOuterPackage)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, tInnerTypeToTInnerAbstractType, mInnerClass, typeGraph, tInnerPackage,
				tOuterClass, mDefinition, tInnerClass, tOuterPackage, typeGraph__tInnerClass____classes,
				...
				tOuterPackage__tInnerPackage____subpackage, typeGraph__tInnerClass____ownedTypes,
				tInnerClass__typeGraph____pg, tOuterClass__tInnerClass____innerTypes,
				tInnerClass__tOuterClass____outerType, mDefinition__mInnerClass____mInnerTypes };
	}
	...
	public static final void pattern_ClassInnerClassMember_1_5_registerobjects_expressionBBBBBBBBBBBB(
		...
		_this.registerObjects_FWD(ruleresult, tInnerTypeToTInnerAbstractType, mInnerClass, typeGraph, eOuterClass,
				tInnerPackage, tOuterClass, mDefinition, tInnerClass, eOuterClassToTOuterClass, tOuterPackage);
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TypeGraph __DEC_tInnerPackage_typeGraph_704978 = tInnerPackage.getTypeGraph();
		if (__DEC_tInnerPackage_typeGraph_704978 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_typeGraph_704978)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_1BB(
		...
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerPackage_subpackage_560626 = tInnerPackage.getParent();
			if (__DEC_tInnerPackage_subpackage_560626 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerPackage_subpackage_560626)) {
					if (!tOuterPackage.equals(__DEC_tInnerPackage_subpackage_560626)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_2BB(
			TPackage tInnerPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tInnerPackage_packages_685905 = tInnerPackage.getPg();
		if (__DEC_tInnerPackage_packages_685905 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_packages_685905)) {
				return new Object[] { tInnerPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_3BBB(
		...
		if (!tInnerPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tInnerClass_classes_619557 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tInnerClass, TPackage.class, "classes")) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_classes_619557)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_classes_619557)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_4BB(
		...
		for (TypeGraph __DEC_tInnerClass_classes_24983 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tInnerClass_classes_24983)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_5BBB(
			TClass tInnerClass, TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerClass_ownedTypes_326457 = tInnerClass.getPackage();
			if (__DEC_tInnerClass_ownedTypes_326457 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_ownedTypes_326457)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_ownedTypes_326457)) {
						return new Object[] { tInnerClass, tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_6BB(
		...
		if (!tInnerClass.equals(tOuterClass)) {
			TAbstractType __DEC_tInnerClass_innerTypes_659835 = tInnerClass.getOuterType();
			if (__DEC_tInnerClass_innerTypes_659835 != null) {
				if (!tInnerClass.equals(__DEC_tInnerClass_innerTypes_659835)) {
					if (!tOuterClass.equals(__DEC_tInnerClass_innerTypes_659835)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_0BB(
		...
		if (!eOuterClass.equals(mInnerClass)) {
			AbstractTypeDeclaration __DEC_mInnerClass_abstractTypeDeclaration_82170 = mInnerClass
					.getAbstractTypeDeclaration();
			if (__DEC_mInnerClass_abstractTypeDeclaration_82170 != null) {
				if (!mInnerClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_82170)) {
					if (!eOuterClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_82170)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_1B(
			MClass mInnerClass) {
		AnonymousClassDeclaration __DEC_mInnerClass_anonymousClassDeclarationOwner_400042 = mInnerClass
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mInnerClass_anonymousClassDeclarationOwner_400042 != null) {
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_2B(
			MClass mInnerClass) {
		for (Model __DEC_mInnerClass_orphanTypes_508886 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_3B(
			MClass mInnerClass) {
		org.eclipse.modisco.java.Package __DEC_mInnerClass_ownedElements_69189 = mInnerClass.getPackage();
		if (__DEC_mInnerClass_ownedElements_69189 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_4BB(
			MClass mInnerClass, MAbstractMethodDefinition mDefinition) {
		for (MAbstractMethodDefinition __DEC_mInnerClass_mInnerTypes_333152 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, MAbstractMethodDefinition.class, "mInnerTypes")) {
			if (!mDefinition.equals(__DEC_mInnerClass_mInnerTypes_333152)) {
			...
			if (!tInnerPackage.equals(tOuterPackage)) {
				if (!tInnerClass.equals(tOuterClass)) {
					if (!sourceMatch.equals(targetMatch)) {
						return new Object[] { mInnerClass, typeGraph, eOuterClass, tInnerPackage, tOuterClass,
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_0BB(MClass mInnerClass,
		...
		if (!eOuterClass.equals(mInnerClass)) {
			AbstractTypeDeclaration __DEC_mInnerClass_abstractTypeDeclaration_252223 = mInnerClass
					.getAbstractTypeDeclaration();
			if (__DEC_mInnerClass_abstractTypeDeclaration_252223 != null) {
				if (!mInnerClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_252223)) {
					if (!eOuterClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_252223)) {
						return new Object[] { mInnerClass, eOuterClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_1B(MClass mInnerClass) {
		AnonymousClassDeclaration __DEC_mInnerClass_anonymousClassDeclarationOwner_805914 = mInnerClass
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mInnerClass_anonymousClassDeclarationOwner_805914 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_2B(MClass mInnerClass) {
		for (Model __DEC_mInnerClass_orphanTypes_923645 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, Model.class, "orphanTypes")) {
			return new Object[] { mInnerClass };
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_3B(MClass mInnerClass) {
		org.eclipse.modisco.java.Package __DEC_mInnerClass_ownedElements_919613 = mInnerClass.getPackage();
		if (__DEC_mInnerClass_ownedElements_919613 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_4BB(MClass mInnerClass,
			MAbstractMethodDefinition mDefinition) {
		for (MAbstractMethodDefinition __DEC_mInnerClass_mInnerTypes_752796 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, MAbstractMethodDefinition.class, "mInnerTypes")) {
			if (!mDefinition.equals(__DEC_mInnerClass_mInnerTypes_752796)) {
				return new Object[] { mInnerClass, mDefinition };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_0BB(
			TPackage tInnerPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tInnerPackage_typeGraph_591900 = tInnerPackage.getTypeGraph();
		if (__DEC_tInnerPackage_typeGraph_591900 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_typeGraph_591900)) {
				return new Object[] { tInnerPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_1BB(
			TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerPackage_subpackage_521804 = tInnerPackage.getParent();
			if (__DEC_tInnerPackage_subpackage_521804 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerPackage_subpackage_521804)) {
					if (!tOuterPackage.equals(__DEC_tInnerPackage_subpackage_521804)) {
						return new Object[] { tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_2BB(
			TPackage tInnerPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tInnerPackage_packages_512671 = tInnerPackage.getPg();
		if (__DEC_tInnerPackage_packages_512671 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_packages_512671)) {
				return new Object[] { tInnerPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_3BBB(TClass tInnerClass,
			TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tInnerClass_classes_281924 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tInnerClass, TPackage.class, "classes")) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_classes_281924)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_classes_281924)) {
						return new Object[] { tInnerClass, tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_4BB(TClass tInnerClass,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tInnerClass_classes_906963 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tInnerClass_classes_906963)) {
				return new Object[] { tInnerClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_5BBB(TClass tInnerClass,
			TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerClass_ownedTypes_44564 = tInnerClass.getPackage();
			if (__DEC_tInnerClass_ownedTypes_44564 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_ownedTypes_44564)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_ownedTypes_44564)) {
						return new Object[] { tInnerClass, tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_6BB(TClass tInnerClass,
			TClass tOuterClass) {
		if (!tInnerClass.equals(tOuterClass)) {
			TAbstractType __DEC_tInnerClass_innerTypes_705003 = tInnerClass.getOuterType();
			if (__DEC_tInnerClass_innerTypes_705003 != null) {
				if (!tInnerClass.equals(__DEC_tInnerClass_innerTypes_705003)) {
					if (!tOuterClass.equals(__DEC_tInnerClass_innerTypes_705003)) {
						return new Object[] { tInnerClass, tOuterClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_29_6_perform_greenFFBFBBFBBB(TypeGraph typeGraph,
		...
		return new Object[] { tInnerTypeToTInnerAbstractType, mInnerClass, typeGraph, tInnerPackage, tOuterClass,
				mDefinition, tInnerClass, tOuterPackage, ruleResult, csp };
	}
