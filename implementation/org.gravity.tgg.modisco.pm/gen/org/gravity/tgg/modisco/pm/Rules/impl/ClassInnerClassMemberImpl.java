...
public class ClassInnerClassMemberImpl extends AbstractRuleImpl implements ClassInnerClassMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_1_1_performtransformation_greenFBBBBFB(tPackage, typeGraph, mInnerClass,
						tOuterClass, csp);
		...
		Object[] result2_black = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_1_2_collecttranslatedelements_blackBBB(tInnerTypeToTInnerAbstractType,
						mInnerClass, tInnerClass);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: "
					+ "[tInnerTypeToTInnerAbstractType] = " + tInnerTypeToTInnerAbstractType + ", " + "[mInnerClass] = "
					+ mInnerClass + ", " + "[tInnerClass] = " + tInnerClass + ".");
		}
		Object[] result2_green = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_1_2_collecttranslatedelements_greenFBBB(tInnerTypeToTInnerAbstractType,
						mInnerClass, tInnerClass);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass,
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ mInnerClass + ", " + "[eOuterClass] = " + eOuterClass + ", " + "[tOuterClass] = " + tOuterClass
					+ ", " + "[mDefinition] = " + mDefinition + ", " + "[tInnerClass] = " + tInnerClass + ", "
					+ "[eOuterClassToTOuterClass] = " + eOuterClassToTOuterClass + ".");
		}
		ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(
				ruleresult, tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass, tOuterClass, mDefinition,
				tInnerClass);
		//nothing EMoflonEdge typeGraph__tInnerClass____classes = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge tInnerTypeToTInnerAbstractType__mInnerClass____source = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge tInnerTypeToTInnerAbstractType__tInnerClass____target = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge tPackage__tInnerClass____classes = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge tPackage__tInnerClass____ownedTypes = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge tInnerClass__tPackage____package = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge typeGraph__tInnerClass____ownedTypes = (EMoflonEdge) result3_green[14];
		//nothing EMoflonEdge tInnerClass__typeGraph____model = (EMoflonEdge) result3_green[15];
		//nothing EMoflonEdge tOuterClass__tInnerClass____innerTypes = (EMoflonEdge) result3_green[16];
		//nothing EMoflonEdge tInnerClass__tOuterClass____outerType = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge mDefinition__mInnerClass____mInnerTypes = (EMoflonEdge) result3_green[18];

		// 
		// 
		ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass,
				mDefinition, tInnerClass, eOuterClassToTOuterClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_2_2_corematch_blackBBFBFB(
			...
			for (Object[] result3_black : ClassInnerClassMemberImpl
					.pattern_ClassInnerClassMember_2_3_findcontext_blackFFBBBBB(mInnerClass, eOuterClass, tOuterClass,
				...
				Object[] result3_green = ClassInnerClassMemberImpl
						.pattern_ClassInnerClassMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFF(tPackage, typeGraph,
								mInnerClass, eOuterClass, tOuterClass, mDefinition, eOuterClassToTOuterClass);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tOuterClass__typeGraph____model = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge typeGraph__tOuterClass____ownedTypes = (EMoflonEdge) result3_green[9];
				...
				//nothing EMoflonEdge tPackage__tOuterClass____ownedTypes = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge eOuterClass__mDefinition____bodyDeclarations = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge mDefinition__eOuterClass____abstractTypeDeclaration = (EMoflonEdge) result3_green[15];
				...
				Object[] result4_bindingAndBlack = ClassInnerClassMemberImpl
						.pattern_ClassInnerClassMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass, mDefinition,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TPackage tPackage, TypeGraph typeGraph,
		...
		concat.solve(var_tOuterClass_tName, literal0, var_mInnerClass_name, var_tInnerClass_tName);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType,
			EObject tPackage, EObject typeGraph, EObject mInnerClass, EObject eOuterClass, EObject tOuterClass,
	...
	public boolean isAppropriate_BWD(Match match, TPackage tPackage, TypeGraph typeGraph, TClass tOuterClass,
		...
		Object[] result1_black = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_10_1_initialbindings_blackBBBBBB(this, match, tPackage, typeGraph,
		...
		Object[] result2_bindingAndBlack = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_10_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, tPackage, typeGraph,
						tOuterClass, tInnerClass);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tPackage] = " + tPackage + ", " + "[typeGraph] = " + typeGraph
		...
		if (ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = ClassInnerClassMemberImpl
					.pattern_ClassInnerClassMember_10_4_collectelementstobetranslated_blackBBBBB(match, tPackage,
			...
			ClassInnerClassMemberImpl
					.pattern_ClassInnerClassMember_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(match,
			...
			//nothing EMoflonEdge tPackage__tInnerClass____ownedTypes = (EMoflonEdge) result4_green[7];
			//nothing EMoflonEdge tInnerClass__tPackage____package = (EMoflonEdge) result4_green[8];
			//nothing EMoflonEdge typeGraph__tInnerClass____ownedTypes = (EMoflonEdge) result4_green[9];
			//nothing EMoflonEdge tInnerClass__typeGraph____model = (EMoflonEdge) result4_green[10];
			//nothing EMoflonEdge tOuterClass__tInnerClass____innerTypes = (EMoflonEdge) result4_green[11];
			//nothing EMoflonEdge tInnerClass__tOuterClass____outerType = (EMoflonEdge) result4_green[12];

			Object[] result5_black = ClassInnerClassMemberImpl
					.pattern_ClassInnerClassMember_10_5_collectcontextelements_blackBBBBB(match, tPackage, typeGraph,
							tOuterClass, tInnerClass);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[tPackage] = " + tPackage + ", " + "[typeGraph] = " + typeGraph + ", " + "[tOuterClass] = "
			...
			ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_10_5_collectcontextelements_greenBBBBFFFF(match,
					tPackage, typeGraph, tOuterClass);
			//nothing EMoflonEdge tOuterClass__typeGraph____model = (EMoflonEdge) result5_green[4];
			//nothing EMoflonEdge typeGraph__tOuterClass____ownedTypes = (EMoflonEdge) result5_green[5];
			//nothing EMoflonEdge tOuterClass__tPackage____package = (EMoflonEdge) result5_green[6];
			//nothing EMoflonEdge tPackage__tOuterClass____ownedTypes = (EMoflonEdge) result5_green[7];

			// 
			ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_10_6_registerobjectstomatch_expressionBBBBBB(this,
					match, tPackage, typeGraph, tOuterClass, tInnerClass);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_11_1_performtransformation_greenFFBBB(mDefinition, tInnerClass, csp);
		TypeToTAbstractType tInnerTypeToTInnerAbstractType = (TypeToTAbstractType) result1_green[0];
		MClass mInnerClass = (MClass) result1_green[1];

		Object[] result2_black = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_11_2_collecttranslatedelements_blackBBB(tInnerTypeToTInnerAbstractType,
						mInnerClass, tInnerClass);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: "
					+ "[tInnerTypeToTInnerAbstractType] = " + tInnerTypeToTInnerAbstractType + ", " + "[mInnerClass] = "
		...
		Object[] result2_green = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_11_2_collecttranslatedelements_greenFBBB(tInnerTypeToTInnerAbstractType,
						mInnerClass, tInnerClass);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass,
						mDefinition, tInnerClass, eOuterClassToTOuterClass);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
		...
		ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_11_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(
				ruleresult, tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass, tOuterClass, mDefinition,
				tInnerClass);
		//nothing EMoflonEdge typeGraph__tInnerClass____classes = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge tInnerTypeToTInnerAbstractType__mInnerClass____source = (EMoflonEdge) result3_green[9];
		...
		// 
		// 
		ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_11_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass,
				mDefinition, tInnerClass, eOuterClassToTOuterClass);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_12_2_corematch_bindingFFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_12_2_corematch_blackBBFBBFB(tPackage, typeGraph, tOuterClass,
						tInnerClass, match)) {
			...
			for (Object[] result3_black : ClassInnerClassMemberImpl
				...
				//nothing EMoflonEdge tPackage__tOuterClass____ownedTypes = (EMoflonEdge) result3_green[15];
				//nothing EMoflonEdge tPackage__tInnerClass____ownedTypes = (EMoflonEdge) result3_green[16];
				//nothing EMoflonEdge tInnerClass__tPackage____package = (EMoflonEdge) result3_green[17];
				//nothing EMoflonEdge typeGraph__tInnerClass____ownedTypes = (EMoflonEdge) result3_green[18];
				//nothing EMoflonEdge tInnerClass__typeGraph____model = (EMoflonEdge) result3_green[19];
				//nothing EMoflonEdge eOuterClass__mDefinition____bodyDeclarations = (EMoflonEdge) result3_green[20];
				//nothing EMoflonEdge mDefinition__eOuterClass____abstractTypeDeclaration = (EMoflonEdge) result3_green[21];
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_77(EMoflonEdge _edge_classes) {
		...
		// ForEach 
		for (Object[] result2_black : ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_20_2_testcorematchandDECs_blackFFFFB(_edge_classes)) {
			...
			if (ClassInnerClassMemberImpl
					.pattern_ClassInnerClassMember_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_81(EMoflonEdge _edge_mInnerTypes) {
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(TripleMatch __tripleMatch) {
		...
		concat0.solve(var_tOuterClass_tName, var_literal0, var_mInnerClass_name, var_tInnerClass_tName);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(sourceMatch,
						targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result3_bindingAndBlack = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, tPackage, typeGraph,
						mInnerClass, eOuterClass, tOuterClass, mDefinition, tInnerClass, sourceMatch, targetMatch);
			...
			for (Object[] result5_black : ClassInnerClassMemberImpl
				...
				Object[] result6_black = ClassInnerClassMemberImpl
						.pattern_ClassInnerClassMember_24_6_createcorrespondence_blackBBBBBBBB(tPackage, typeGraph,
								mInnerClass, eOuterClass, tOuterClass, mDefinition, tInnerClass, ccMatch);
				if (result6_black == null) {
				...
				ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_24_6_createcorrespondence_greenFBBB(mInnerClass,
						tInnerClass, ccMatch);
	...
	public boolean checkDEC_BWD(TPackage tPackage, TypeGraph typeGraph, TClass tOuterClass, TClass tInnerClass) {// 
		Object[] result1_black = ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_28_1_matchtggpattern_blackBBBB(
				tPackage, typeGraph, tOuterClass, tInnerClass);
		if (result1_black != null) {
		...
		for (Object[] result2_black : ClassInnerClassMemberImpl
			...
			if (ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_29_6_perform_greenFBBFBBFBB(tPackage,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TPACKAGE_TYPEGRAPH_MCLASS_CLASSDECLARATION_TCLASS_MABSTRACTMETHODDEFINITION_TYPETOTABSTRACTTYPE:
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPROPRIATE_BWD__MATCH_TPACKAGE_TYPEGRAPH_TCLASS_TCLASS:
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TPACKAGE_TYPEGRAPH_TCLASS_TCLASS:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TPackage) arguments.get(1),
					(TypeGraph) arguments.get(2), (TClass) arguments.get(3), (TClass) arguments.get(4));
			return null;
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TPACKAGE_TYPEGRAPH_TCLASS_TCLASS:
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_77__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_77((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_81__EMOFLONEDGE:
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__TPACKAGE_TYPEGRAPH_MCLASS_CLASSDECLARATION_TCLASS_MABSTRACTMETHODDEFINITION_TCLASS_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TPackage) arguments.get(0), (TypeGraph) arguments.get(1),
					(MClass) arguments.get(2), (ClassDeclaration) arguments.get(3), (TClass) arguments.get(4),
					(MAbstractMethodDefinition) arguments.get(5), (TClass) arguments.get(6), (Match) arguments.get(7),
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___CHECK_DEC_BWD__TPACKAGE_TYPEGRAPH_TCLASS_TCLASS:
						...
						if (tmpTOuterClass instanceof TClass) {
							...
							if (tmpMDefinition instanceof MAbstractMethodDefinition) {
								...
								if (tmpEOuterClassToTOuterClass instanceof TypeToTAbstractType) {
									...
									return new Object[] { tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass,
		...
		if (!eOuterClass.equals(mInnerClass)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass, mDefinition,
	...
	public static final Object[] pattern_ClassInnerClassMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_ClassInnerClassMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_ClassInnerClassMember_1_1_performtransformation_black = pattern_ClassInnerClassMember_1_1_performtransformation_blackBBBBBBBFBB(
					tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass, mDefinition, eOuterClassToTOuterClass,
	...
	public static final Object[] pattern_ClassInnerClassMember_1_1_performtransformation_greenFBBBBFB(TPackage tPackage,
			TypeGraph typeGraph, MClass mInnerClass, TClass tOuterClass, CSP csp) {
		...
		tPackage.getOwnedTypes().add(tInnerClass);
		...
		return new Object[] { tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass, tOuterClass,
				tInnerClass, csp };
	}

	public static final Object[] pattern_ClassInnerClassMember_1_2_collecttranslatedelements_blackBBB(
			TypeToTAbstractType tInnerTypeToTInnerAbstractType, MClass mInnerClass, TClass tInnerClass) {
		return new Object[] { tInnerTypeToTInnerAbstractType, mInnerClass, tInnerClass };
	}

	public static final Object[] pattern_ClassInnerClassMember_1_2_collecttranslatedelements_greenFBBB(
			TypeToTAbstractType tInnerTypeToTInnerAbstractType, MClass mInnerClass, TClass tInnerClass) {
		...
		return new Object[] { ruleresult, tInnerTypeToTInnerAbstractType, mInnerClass, tInnerClass };
	}

	public static final Object[] pattern_ClassInnerClassMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType, EObject tPackage, EObject typeGraph,
			EObject mInnerClass, EObject eOuterClass, EObject tOuterClass, EObject mDefinition, EObject tInnerClass,
																...
																if (!eOuterClass.equals(mDefinition)) {
																	if (!eOuterClass.equals(tInnerClass)) {
																		if (!eOuterClass
																			...
																			if (!tOuterClass.equals(tPackage)) {
																				if (!tOuterClass.equals(typeGraph)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType, EObject tPackage, EObject typeGraph,
			EObject mInnerClass, EObject tOuterClass, EObject mDefinition, EObject tInnerClass) {
		...
		EMoflonEdge tPackage__tInnerClass____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		String tPackage__tInnerClass____ownedTypes_name_prime = "ownedTypes";
		...
		tPackage__tInnerClass____ownedTypes.setSrc(tPackage);
		tPackage__tInnerClass____ownedTypes.setTrg(tInnerClass);
		ruleresult.getCreatedEdges().add(tPackage__tInnerClass____ownedTypes);
		...
		tPackage__tInnerClass____ownedTypes.setName(tPackage__tInnerClass____ownedTypes_name_prime);
		...
		mDefinition__mInnerClass____mInnerTypes.setName(mDefinition__mInnerClass____mInnerTypes_name_prime);
		return new Object[] { ruleresult, tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass, tOuterClass,
				mDefinition, tInnerClass, typeGraph__tInnerClass____classes,
				tInnerTypeToTInnerAbstractType__mInnerClass____source,
				tInnerTypeToTInnerAbstractType__tInnerClass____target, tPackage__tInnerClass____classes,
				tPackage__tInnerClass____ownedTypes, tInnerClass__tPackage____package,
				typeGraph__tInnerClass____ownedTypes, tInnerClass__typeGraph____model,
				tOuterClass__tInnerClass____innerTypes, tInnerClass__tOuterClass____outerType,
				mDefinition__mInnerClass____mInnerTypes };
	}

	public static final void pattern_ClassInnerClassMember_1_5_registerobjects_expressionBBBBBBBBBBB(
			ClassInnerClassMember _this, PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType,
			EObject tPackage, EObject typeGraph, EObject mInnerClass, EObject eOuterClass, EObject tOuterClass,
			EObject mDefinition, EObject tInnerClass, EObject eOuterClassToTOuterClass) {
		_this.registerObjects_FWD(ruleresult, tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass,
	...
	public static final Object[] pattern_ClassInnerClassMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFF(TPackage tPackage,
			TypeGraph typeGraph, MClass mInnerClass, ClassDeclaration eOuterClass, TClass tOuterClass,
		...
		EMoflonEdge tPackage__tOuterClass____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eOuterClass__mDefinition____bodyDeclarations = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mDefinition__eOuterClass____abstractTypeDeclaration = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mDefinition__mInnerClass____mInnerTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		String tPackage__tOuterClass____ownedTypes_name_prime = "ownedTypes";
		String eOuterClass__mDefinition____bodyDeclarations_name_prime = "bodyDeclarations";
		String mDefinition__eOuterClass____abstractTypeDeclaration_name_prime = "abstractTypeDeclaration";
		String mDefinition__mInnerClass____mInnerTypes_name_prime = "mInnerTypes";
		...
		tPackage__tOuterClass____ownedTypes.setSrc(tPackage);
		tPackage__tOuterClass____ownedTypes.setTrg(tOuterClass);
		isApplicableMatch.getAllContextElements().add(tPackage__tOuterClass____ownedTypes);
		eOuterClass__mDefinition____bodyDeclarations.setSrc(eOuterClass);
		eOuterClass__mDefinition____bodyDeclarations.setTrg(mDefinition);
		...
		tPackage__tOuterClass____ownedTypes.setName(tPackage__tOuterClass____ownedTypes_name_prime);
		eOuterClass__mDefinition____bodyDeclarations.setName(eOuterClass__mDefinition____bodyDeclarations_name_prime);
		mDefinition__eOuterClass____abstractTypeDeclaration
				.setName(mDefinition__eOuterClass____abstractTypeDeclaration_name_prime);
		mDefinition__mInnerClass____mInnerTypes.setName(mDefinition__mInnerClass____mInnerTypes_name_prime);
		return new Object[] { tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass, mDefinition,
				...
				typeGraph__tOuterClass____ownedTypes, eOuterClassToTOuterClass__eOuterClass____source,
				eOuterClassToTOuterClass__tOuterClass____target, tOuterClass__tPackage____package,
				tPackage__tOuterClass____ownedTypes, eOuterClass__mDefinition____bodyDeclarations,
				mDefinition__eOuterClass____abstractTypeDeclaration, mDefinition__mInnerClass____mInnerTypes };
	}
	...
	public static final Object[] pattern_ClassInnerClassMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ClassInnerClassMember_2_4_solveCSP_binding = pattern_ClassInnerClassMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass, mDefinition,
				eOuterClassToTOuterClass);
	...
	public static final Object[] pattern_ClassInnerClassMember_10_1_initialbindings_blackBBBBBB(
			ClassInnerClassMember _this, Match match, TPackage tPackage, TypeGraph typeGraph, TClass tOuterClass,
			TClass tInnerClass) {
	...
	public static final Object[] pattern_ClassInnerClassMember_10_2_SolveCSP_bindingFBBBBBB(ClassInnerClassMember _this,
	...
	public static final Object[] pattern_ClassInnerClassMember_10_2_SolveCSP_bindingAndBlackFBBBBBB(
			ClassInnerClassMember _this, Match match, TPackage tPackage, TypeGraph typeGraph, TClass tOuterClass,
			TClass tInnerClass) {
		Object[] result_pattern_ClassInnerClassMember_10_2_SolveCSP_binding = pattern_ClassInnerClassMember_10_2_SolveCSP_bindingFBBBBBB(
	...
	public static final Object[] pattern_ClassInnerClassMember_10_4_collectelementstobetranslated_blackBBBBB(
			Match match, TPackage tPackage, TypeGraph typeGraph, TClass tOuterClass, TClass tInnerClass) {
		if (!tInnerClass.equals(tOuterClass)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_10_4_collectelementstobetranslated_greenBBBBBFFFFFFFF(
			Match match, TPackage tPackage, TypeGraph typeGraph, TClass tOuterClass, TClass tInnerClass) {
		EMoflonEdge typeGraph__tInnerClass____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tPackage__tInnerClass____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tPackage__tInnerClass____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		tPackage__tInnerClass____ownedTypes.setSrc(tPackage);
		tPackage__tInnerClass____ownedTypes.setTrg(tInnerClass);
		match.getToBeTranslatedEdges().add(tPackage__tInnerClass____ownedTypes);
		tInnerClass__tPackage____package.setSrc(tInnerClass);
		tInnerClass__tPackage____package.setTrg(tPackage);
		...
		return new Object[] { match, tPackage, typeGraph, tOuterClass, tInnerClass, typeGraph__tInnerClass____classes,
				tPackage__tInnerClass____classes, tPackage__tInnerClass____ownedTypes, tInnerClass__tPackage____package,
				typeGraph__tInnerClass____ownedTypes, tInnerClass__typeGraph____model,
				tOuterClass__tInnerClass____innerTypes, tInnerClass__tOuterClass____outerType };
	}

	public static final Object[] pattern_ClassInnerClassMember_10_5_collectcontextelements_blackBBBBB(Match match,
	...
	public static final Object[] pattern_ClassInnerClassMember_10_5_collectcontextelements_greenBBBBFFFF(Match match,
			TPackage tPackage, TypeGraph typeGraph, TClass tOuterClass) {
		EMoflonEdge tOuterClass__typeGraph____model = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge typeGraph__tOuterClass____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tOuterClass__tPackage____package = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tPackage__tOuterClass____ownedTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		tPackage__tOuterClass____ownedTypes.setSrc(tPackage);
		tPackage__tOuterClass____ownedTypes.setTrg(tOuterClass);
		match.getContextEdges().add(tPackage__tOuterClass____ownedTypes);
		tOuterClass__typeGraph____model.setName(tOuterClass__typeGraph____model_name_prime);
		typeGraph__tOuterClass____ownedTypes.setName(typeGraph__tOuterClass____ownedTypes_name_prime);
		tOuterClass__tPackage____package.setName(tOuterClass__tPackage____package_name_prime);
		tPackage__tOuterClass____ownedTypes.setName(tPackage__tOuterClass____ownedTypes_name_prime);
		return new Object[] { match, tPackage, typeGraph, tOuterClass, tOuterClass__typeGraph____model,
				typeGraph__tOuterClass____ownedTypes, tOuterClass__tPackage____package,
				tPackage__tOuterClass____ownedTypes };
	}

	public static final void pattern_ClassInnerClassMember_10_6_registerobjectstomatch_expressionBBBBBB(
			ClassInnerClassMember _this, Match match, TPackage tPackage, TypeGraph typeGraph, TClass tOuterClass,
			TClass tInnerClass) {
	...
	public static final Object[] pattern_ClassInnerClassMember_11_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("tPackage");
		EObject _localVariable_1 = isApplicableMatch.getObject("typeGraph");
	...
	public static final Object[] pattern_ClassInnerClassMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			ClassInnerClassMember _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_ClassInnerClassMember_11_1_performtransformation_binding = pattern_ClassInnerClassMember_11_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
	...
	public static final Object[] pattern_ClassInnerClassMember_11_1_performtransformation_greenFFBBB(
		...
		return new Object[] { tInnerTypeToTInnerAbstractType, mInnerClass, mDefinition, tInnerClass, csp };
	}

	public static final Object[] pattern_ClassInnerClassMember_11_2_collecttranslatedelements_blackBBB(
			TypeToTAbstractType tInnerTypeToTInnerAbstractType, MClass mInnerClass, TClass tInnerClass) {
		return new Object[] { tInnerTypeToTInnerAbstractType, mInnerClass, tInnerClass };
	}

	public static final Object[] pattern_ClassInnerClassMember_11_2_collecttranslatedelements_greenFBBB(
			TypeToTAbstractType tInnerTypeToTInnerAbstractType, MClass mInnerClass, TClass tInnerClass) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getCreatedLinkElements().add(tInnerTypeToTInnerAbstractType);
	...
	public static final Object[] pattern_ClassInnerClassMember_11_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType, EObject tPackage, EObject typeGraph,
			EObject mInnerClass, EObject eOuterClass, EObject tOuterClass, EObject mDefinition, EObject tInnerClass,
			EObject eOuterClassToTOuterClass) {
		if (!tInnerTypeToTInnerAbstractType.equals(tPackage)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_11_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType, EObject tPackage, EObject typeGraph,
			EObject mInnerClass, EObject tOuterClass, EObject mDefinition, EObject tInnerClass) {
		EMoflonEdge typeGraph__tInnerClass____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tInnerTypeToTInnerAbstractType__mInnerClass____source = RuntimeFactory.eINSTANCE
		...
		tPackage__tInnerClass____ownedTypes.setSrc(tPackage);
		tPackage__tInnerClass____ownedTypes.setTrg(tInnerClass);
		ruleresult.getTranslatedEdges().add(tPackage__tInnerClass____ownedTypes);
		tInnerClass__tPackage____package.setSrc(tInnerClass);
		tInnerClass__tPackage____package.setTrg(tPackage);
	...
	public static final void pattern_ClassInnerClassMember_11_5_registerobjects_expressionBBBBBBBBBBB(
			ClassInnerClassMember _this, PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType,
			EObject tPackage, EObject typeGraph, EObject mInnerClass, EObject eOuterClass, EObject tOuterClass,
			EObject mDefinition, EObject tInnerClass, EObject eOuterClassToTOuterClass) {
		_this.registerObjects_BWD(ruleresult, tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass,
				eOuterClass, tOuterClass, mDefinition, tInnerClass, eOuterClassToTOuterClass);
	...
	public static final Object[] pattern_ClassInnerClassMember_12_2_corematch_bindingFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_ClassInnerClassMember_12_2_corematch_blackBBFBBFB(TPackage tPackage,
			TypeGraph typeGraph, TClass tOuterClass, TClass tInnerClass, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tInnerClass.equals(tOuterClass)) {
			for (TypeToTAbstractType eOuterClassToTOuterClass : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tOuterClass.equals(eOuterClassToTOuterClass.getTarget())) {
							if (tPackage.getClasses().contains(tInnerClass)) {
								if (tPackage.equals(tOuterClass.getPackage())) {
									if (tPackage.getOwnedTypes().contains(tInnerClass)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFFF(
		...
		tPackage__tInnerClass____ownedTypes.setSrc(tPackage);
		tPackage__tInnerClass____ownedTypes.setTrg(tInnerClass);
		isApplicableMatch.getAllContextElements().add(tPackage__tInnerClass____ownedTypes);
		tInnerClass__tPackage____package.setSrc(tInnerClass);
		tInnerClass__tPackage____package.setTrg(tPackage);
		...
		return new Object[] { tPackage, typeGraph, eOuterClass, tOuterClass, mDefinition, tInnerClass,
				...
				tPackage__tInnerClass____classes, tOuterClass__tPackage____package, tPackage__tOuterClass____ownedTypes,
				tPackage__tInnerClass____ownedTypes, tInnerClass__tPackage____package,
				typeGraph__tInnerClass____ownedTypes, tInnerClass__typeGraph____model,
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TPackage __DEC_tInnerClass_classes_875184 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tInnerClass_classes_875184)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_1BB(
		...
		for (TypeGraph __DEC_tInnerClass_classes_813511 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tInnerClass_classes_813511)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_2BB(
			TClass tInnerClass, TPackage tPackage) {
		TPackage __DEC_tInnerClass_ownedTypes_488621 = tInnerClass.getPackage();
		if (__DEC_tInnerClass_ownedTypes_488621 != null) {
			if (!tPackage.equals(__DEC_tInnerClass_ownedTypes_488621)) {
				return new Object[] { tInnerClass, tPackage };
			}
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_3BB(
		...
		if (!tInnerClass.equals(tOuterClass)) {
			TAbstractType __DEC_tInnerClass_innerTypes_350777 = tInnerClass.getOuterType();
			if (__DEC_tInnerClass_innerTypes_350777 != null) {
				if (!tInnerClass.equals(__DEC_tInnerClass_innerTypes_350777)) {
					if (!tOuterClass.equals(__DEC_tInnerClass_innerTypes_350777)) {
	...
	public static final Iterable<Object[]> pattern_ClassInnerClassMember_20_2_testcorematchandDECs_blackFFFFB(
												...
												if (pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_1BB(
													...
													if (pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_0BB(
														...
														if (pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_2BB(
																tInnerClass, tPackage) == null) {
															if (pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_3BB(
	...
	public static final boolean pattern_ClassInnerClassMember_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ClassInnerClassMember _this, Match match, TPackage tPackage, TypeGraph typeGraph, TClass tOuterClass,
			TClass tInnerClass) {
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_0BB(
		...
		if (!eOuterClass.equals(mInnerClass)) {
			AbstractTypeDeclaration __DEC_mInnerClass_abstractTypeDeclaration_362884 = mInnerClass
					.getAbstractTypeDeclaration();
			if (__DEC_mInnerClass_abstractTypeDeclaration_362884 != null) {
				if (!mInnerClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_362884)) {
					if (!eOuterClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_362884)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_1B(
			MClass mInnerClass) {
		AnonymousClassDeclaration __DEC_mInnerClass_anonymousClassDeclarationOwner_459862 = mInnerClass
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mInnerClass_anonymousClassDeclarationOwner_459862 != null) {
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_2B(
			MClass mInnerClass) {
		for (Model __DEC_mInnerClass_orphanTypes_325143 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_3B(
			MClass mInnerClass) {
		org.eclipse.modisco.java.Package __DEC_mInnerClass_ownedElements_611296 = mInnerClass.getPackage();
		if (__DEC_mInnerClass_ownedElements_611296 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_4BB(
			MClass mInnerClass, MAbstractMethodDefinition mDefinition) {
		for (MAbstractMethodDefinition __DEC_mInnerClass_mInnerTypes_771486 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, MAbstractMethodDefinition.class, "mInnerTypes")) {
			if (!mDefinition.equals(__DEC_mInnerClass_mInnerTypes_771486)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_binding = pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_bindingFFFFFFFBB(
		...
		if (result_pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_black = pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass, mDefinition, tInnerClass, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_ClassInnerClassMember_24_3_solvecsp_bindingFBBBBBBBBBB(
		...
		if (csp != null) {
			return new Object[] { csp, _this, tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass, mDefinition,
					tInnerClass, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassInnerClassMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_ClassInnerClassMember_24_3_solvecsp_binding = pattern_ClassInnerClassMember_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass, mDefinition, tInnerClass,
				sourceMatch, targetMatch);
		if (result_pattern_ClassInnerClassMember_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_ClassInnerClassMember_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tPackage, typeGraph, mInnerClass, eOuterClass, tOuterClass,
	...
	public static final Object[] pattern_ClassInnerClassMember_24_6_createcorrespondence_greenFBBB(MClass mInnerClass,
			TClass tInnerClass, CCMatch ccMatch) {
		TypeToTAbstractType tInnerTypeToTInnerAbstractType = PmFactory.eINSTANCE.createTypeToTAbstractType();
		tInnerTypeToTInnerAbstractType.setSource(mInnerClass);
		tInnerTypeToTInnerAbstractType.setTarget(tInnerClass);
		ccMatch.getCreateCorr().add(tInnerTypeToTInnerAbstractType);
		return new Object[] { tInnerTypeToTInnerAbstractType, mInnerClass, tInnerClass, ccMatch };
	}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_0BB(MClass mInnerClass,
		...
		if (!eOuterClass.equals(mInnerClass)) {
			AbstractTypeDeclaration __DEC_mInnerClass_abstractTypeDeclaration_548847 = mInnerClass
					.getAbstractTypeDeclaration();
			if (__DEC_mInnerClass_abstractTypeDeclaration_548847 != null) {
				if (!mInnerClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_548847)) {
					if (!eOuterClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_548847)) {
						return new Object[] { mInnerClass, eOuterClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_1B(MClass mInnerClass) {
		AnonymousClassDeclaration __DEC_mInnerClass_anonymousClassDeclarationOwner_292761 = mInnerClass
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mInnerClass_anonymousClassDeclarationOwner_292761 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_2B(MClass mInnerClass) {
		for (Model __DEC_mInnerClass_orphanTypes_205817 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, Model.class, "orphanTypes")) {
			return new Object[] { mInnerClass };
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_3B(MClass mInnerClass) {
		org.eclipse.modisco.java.Package __DEC_mInnerClass_ownedElements_587934 = mInnerClass.getPackage();
		if (__DEC_mInnerClass_ownedElements_587934 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_4BB(MClass mInnerClass,
			MAbstractMethodDefinition mDefinition) {
		for (MAbstractMethodDefinition __DEC_mInnerClass_mInnerTypes_288319 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, MAbstractMethodDefinition.class, "mInnerTypes")) {
			if (!mDefinition.equals(__DEC_mInnerClass_mInnerTypes_288319)) {
				return new Object[] { mInnerClass, mDefinition };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_0BB(TClass tInnerClass,
			TPackage tPackage) {
		for (TPackage __DEC_tInnerClass_classes_315555 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tInnerClass_classes_315555)) {
				return new Object[] { tInnerClass, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_1BB(TClass tInnerClass,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tInnerClass_classes_891245 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tInnerClass_classes_891245)) {
				return new Object[] { tInnerClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_2BB(TClass tInnerClass,
			TPackage tPackage) {
		TPackage __DEC_tInnerClass_ownedTypes_308653 = tInnerClass.getPackage();
		if (__DEC_tInnerClass_ownedTypes_308653 != null) {
			if (!tPackage.equals(__DEC_tInnerClass_ownedTypes_308653)) {
				return new Object[] { tInnerClass, tPackage };
			}
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_3BB(TClass tInnerClass,
			TClass tOuterClass) {
		if (!tInnerClass.equals(tOuterClass)) {
			TAbstractType __DEC_tInnerClass_innerTypes_849718 = tInnerClass.getOuterType();
			if (__DEC_tInnerClass_innerTypes_849718 != null) {
				if (!tInnerClass.equals(__DEC_tInnerClass_innerTypes_849718)) {
					if (!tOuterClass.equals(__DEC_tInnerClass_innerTypes_849718)) {
						return new Object[] { tInnerClass, tOuterClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_blackBBBB(TPackage tPackage,
										...
										if (pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_0BB(
											...
											if (pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_1BB(
												...
												if (pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_2BB(
														tInnerClass, tPackage) == null) {
													if (pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_3BB(
															tInnerClass, tOuterClass) == null) {
	...
	public static final Object[] pattern_ClassInnerClassMember_29_6_perform_greenFBBFBBFBB(TPackage tPackage,
		...
		return new Object[] { tInnerTypeToTInnerAbstractType, tPackage, typeGraph, mInnerClass, tOuterClass,
				mDefinition, tInnerClass, ruleResult, csp };
	}
