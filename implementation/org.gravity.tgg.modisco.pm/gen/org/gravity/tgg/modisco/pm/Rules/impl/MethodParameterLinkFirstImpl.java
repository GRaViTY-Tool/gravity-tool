...
public class MethodParameterLinkFirstImpl extends AbstractRuleImpl implements MethodParameterLinkFirst {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkFirstImpl
				.pattern_MethodParameterLinkFirst_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						eSingleVariableDeclarationToTParameter, tParameter, mEntry, tMethodSignature, mParameterList,
		...
		MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, eSingleVariableDeclarationToTParameter, tParameter, mEntry, tMethodSignature,
		...
		for (Object[] result2_black : MethodParameterLinkFirstImpl
			...
			for (Object[] result3_black : MethodParameterLinkFirstImpl
					.pattern_MethodParameterLinkFirst_2_3_findcontext_blackBBBBBB(
							eSingleVariableDeclarationToTParameter, tParameter, mEntry, tMethodSignature,
							mParameterList, mmethodSignatureToTMethodSignature)) {
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eSingleVariableDeclarationToTParameter,
			EObject tParameter, EObject mEntry, EObject tMethodSignature, EObject mParameterList,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_17(EMoflonEdge _edge_firstParameter) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TMETHODSIGNATURE_MMETHODSIGNATURE_MSIGNATURETOTSIGNATURE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TMETHODSIGNATURE_MMETHODSIGNATURE_MSIGNATURETOTSIGNATURE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPROPRIATE_BWD_EMOFLON_EDGE_17__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_TMETHODSIGNATURE_MMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { eSingleVariableDeclarationToTParameter, tParameter, mEntry, tMethodSignature,
				...
				for (MSignatureToTSignature mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTMethodSignature instanceof TMethodSignature) {
						...
						_result.add(new Object[] { eSingleVariableDeclarationToTParameter, tParameter, mEntry,
								tMethodSignature, mParameterList, mmethodSignatureToTMethodSignature, match });
					}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingFBBBBBBBB(
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSingleVariableDeclarationToTParameter, tParameter,
					mEntry, tMethodSignature, mParameterList, mmethodSignatureToTMethodSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLinkFirst_2_4_solveCSP_binding = pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eSingleVariableDeclarationToTParameter, tParameter, mEntry, tMethodSignature,
				mParameterList, mmethodSignatureToTMethodSignature);
			...
			for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mEntry.equals(eSingleVariableDeclarationToTParameter.getSource())) {
					for (MSignatureToTSignature mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tMethodSignature.equals(mmethodSignatureToTMethodSignature.getTarget())) {
							_result.add(new Object[] { eSingleVariableDeclarationToTParameter, tParameter, mEntry,
									tMethodSignature, mParameterList, mmethodSignatureToTMethodSignature, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSingleVariableDeclarationToTParameter, tParameter,
					mEntry, tMethodSignature, mParameterList, mmethodSignatureToTMethodSignature, ruleResult };
		}
		return null;
	}
