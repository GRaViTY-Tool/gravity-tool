...
public class MethodParameterLinkFirstImpl extends AbstractRuleImpl implements MethodParameterLinkFirst {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkFirstImpl
				.pattern_MethodParameterLinkFirst_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tMethodSignature,
						mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, tParameter, mEntry,
						mParameterList);
		...
		MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, tMethodSignature, mmethodSignatureToTMethodSignature,
		...
		for (Object[] result2_black : MethodParameterLinkFirstImpl
			...
			for (Object[] result3_black : MethodParameterLinkFirstImpl
					.pattern_MethodParameterLinkFirst_2_3_findcontext_blackBBBBBB(tMethodSignature,
							mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter, tParameter,
							mEntry, mParameterList)) {
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tMethodSignature,
			...
			EObject tParameter, EObject mEntry, EObject mParameterList) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkFirstImpl
				.pattern_MethodParameterLinkFirst_12_2_corematch_blackBFFBFFB(tMethodSignature, tParameter, match)) {
			MSignatureToTSignature mmethodSignatureToTMethodSignature = (MSignatureToTSignature) result2_black[1];
			MEntryToTParameter eSingleVariableDeclarationToTParameter = (MEntryToTParameter) result2_black[2];
			...
			for (Object[] result3_black : MethodParameterLinkFirstImpl
				...
				Object[] result4_bindingAndBlack = MethodParameterLinkFirstImpl
						.pattern_MethodParameterLinkFirst_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tMethodSignature, mmethodSignatureToTMethodSignature,
								eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMethodSignature] = "
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_614(EMoflonEdge _edge_firstParameter) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_660(EMoflonEdge _edge_mFirstEntry) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkFirstImpl
					.pattern_MethodParameterLinkFirst_24_5_matchcorrcontext_blackBFFBBBBB(tMethodSignature, tParameter,
		...
		for (Object[] result2_black : MethodParameterLinkFirstImpl
			...
			Object[] result3_bindingAndBlack = MethodParameterLinkFirstImpl
					.pattern_MethodParameterLinkFirst_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tMethodSignature, mmethodSignatureToTMethodSignature,
							eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMethodSignature] = "
						+ tMethodSignature + ", " + "[mmethodSignatureToTMethodSignature] = "
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkFirstImpl
							.pattern_MethodParameterLinkFirst_29_6_perform_blackBBBBBBB(tMethodSignature,
									mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter,
									tParameter, mEntry, mParameterList, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodSignature] = "
								+ tMethodSignature + ", " + "[mmethodSignatureToTMethodSignature] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_MMETHODSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TMethodSignature) arguments.get(1),
					...
					(TParameter) arguments.get(4), (MEntry) arguments.get(5), (MMethodSignature) arguments.get(6));
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_MMETHODSIGNATURE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPROPRIATE_BWD_EMOFLON_EDGE_614__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_614((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPROPRIATE_FWD_EMOFLON_EDGE_660__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_660((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_MENTRYTOTPARAMETER_TPARAMETER_MENTRY_MMETHODSIGNATURE_MODELGENERATORRULERESULT:
					...
					if (tmpTParameter instanceof TParameter) {
						...
						if (tmpMEntry instanceof MEntry) {
							...
							if (tmpMParameterList instanceof MMethodSignature) {
								...
								return new Object[] { tMethodSignature, mmethodSignatureToTMethodSignature,
										eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList,
										isApplicableMatch };
							}
						}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMethodSignature, mmethodSignatureToTMethodSignature,
						eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLinkFirst_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodParameterLinkFirst_1_1_performtransformation_black = pattern_MethodParameterLinkFirst_1_1_performtransformation_blackBBBBBBFBB(
					tMethodSignature, mmethodSignatureToTMethodSignature, eSingleVariableDeclarationToTParameter,
					tParameter, mEntry, mParameterList, _this, isApplicableMatch);
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject tMethodSignature, EObject mmethodSignatureToTMethodSignature,
			EObject eSingleVariableDeclarationToTParameter, EObject tParameter, EObject mEntry,
	...
	public static final void pattern_MethodParameterLinkFirst_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject eSingleVariableDeclarationToTParameter,
			EObject tParameter, EObject mEntry, EObject mParameterList) {
		_this.registerObjects_FWD(ruleresult, tMethodSignature, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList);
		...
		for (MSignatureToTSignature mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTMethodSignature instanceof TMethodSignature) {
				...
				for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tParameter != null) {
						_result.add(new Object[] { tMethodSignature, mmethodSignatureToTMethodSignature,
								eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList, match });
					}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		mParameterList__mEntry____mFirstEntry.setName(mParameterList__mEntry____mFirstEntry_name_prime);
		return new Object[] { tMethodSignature, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList, isApplicableMatch,
				eSingleVariableDeclarationToTParameter__tParameter____target,
				mmethodSignatureToTMethodSignature__mParameterList____source,
				mmethodSignatureToTMethodSignature__tMethodSignature____target,
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethodSignature, mmethodSignatureToTMethodSignature,
					eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLinkFirst_2_4_solveCSP_binding = pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tMethodSignature, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList);
	...
	public static final void pattern_MethodParameterLinkFirst_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mmethodSignatureToTMethodSignature, EObject eSingleVariableDeclarationToTParameter,
			EObject tParameter, EObject mEntry, EObject mParameterList) {
		_this.registerObjects_BWD(ruleresult, tMethodSignature, mmethodSignatureToTMethodSignature,
				eSingleVariableDeclarationToTParameter, tParameter, mEntry, mParameterList);
