...
public class MethodParameterLinkFirstImpl extends AbstractRuleImpl implements MethodParameterLinkFirst {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, mEntry, eSingleVariableDeclarationToTParameter, mParameterList,
			...
			for (Object[] result3_black : MethodParameterLinkFirstImpl
				...
				Object[] result4_bindingAndBlack = MethodParameterLinkFirstImpl
						.pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								mEntry, eSingleVariableDeclarationToTParameter, mParameterList,
								mmethodSignatureToTMethodSignature, tParameter, tMethodSignature);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkFirstImpl
				.pattern_MethodParameterLinkFirst_12_2_corematch_blackFFFFBBB(tParameter, tMethodSignature, match)) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_30(EMoflonEdge _edge_firstParameter) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_32(EMoflonEdge _edge_mFirstEntry) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkFirstImpl
					.pattern_MethodParameterLinkFirst_24_5_matchcorrcontext_blackBFBFBBBB(mEntry, mParameterList,
							tParameter, tMethodSignature, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : MethodParameterLinkFirstImpl
			...
			Object[] result3_bindingAndBlack = MethodParameterLinkFirstImpl
					.pattern_MethodParameterLinkFirst_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mEntry, eSingleVariableDeclarationToTParameter, mParameterList,
							mmethodSignatureToTMethodSignature, tParameter, tMethodSignature, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mEntry] = " + mEntry + ", "
						+ "[eSingleVariableDeclarationToTParameter] = " + eSingleVariableDeclarationToTParameter + ", "
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mEntry] = " + mEntry
								...
								+ eSingleVariableDeclarationToTParameter + ", " + "[mParameterList] = " + mParameterList
								+ ", " + "[mmethodSignatureToTMethodSignature] = " + mmethodSignatureToTMethodSignature
								+ ", " + "[tParameter] = " + tParameter + ", " + "[tMethodSignature] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRY_MENTRYTOTPARAMETER_MMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_TPARAMETER_TMETHODSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MEntry) arguments.get(1),
					...
					(MSignatureToTSignature) arguments.get(4), (TParameter) arguments.get(5),
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_MENTRYTOTPARAMETER_MMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_TPARAMETER_TMETHODSIGNATURE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPROPRIATE_BWD_EMOFLON_EDGE_30__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_30((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPROPRIATE_FWD_EMOFLON_EDGE_32__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRY_MENTRYTOTPARAMETER_MMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_TPARAMETER_TMETHODSIGNATURE_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mEntry, eSingleVariableDeclarationToTParameter, mParameterList,
						mmethodSignatureToTMethodSignature, tParameter, tMethodSignature, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLinkFirst_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodParameterLinkFirst_1_1_performtransformation_black = pattern_MethodParameterLinkFirst_1_1_performtransformation_blackBBBBBBFBB(
					mEntry, eSingleVariableDeclarationToTParameter, mParameterList, mmethodSignatureToTMethodSignature,
					tParameter, tMethodSignature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject mParameterList, EObject mmethodSignatureToTMethodSignature, EObject tParameter,
				...
				for (MSignatureToTSignature mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTMethodSignature instanceof TMethodSignature) {
						...
						_result.add(new Object[] { mEntry, eSingleVariableDeclarationToTParameter, mParameterList,
								mmethodSignatureToTMethodSignature, tParameter, tMethodSignature, match });
					}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_3_findcontext_greenBBBBBBFFFFFF(MEntry mEntry,
		...
		return new Object[] { mEntry, eSingleVariableDeclarationToTParameter, mParameterList,
				mmethodSignatureToTMethodSignature, tParameter, tMethodSignature, isApplicableMatch,
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mEntry,
				eSingleVariableDeclarationToTParameter, mParameterList, mmethodSignatureToTMethodSignature, tParameter,
				tMethodSignature);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLinkFirst_2_4_solveCSP_binding = pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mEntry, eSingleVariableDeclarationToTParameter, mParameterList,
				mmethodSignatureToTMethodSignature, tParameter, tMethodSignature);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLinkFirst_12_2_corematch_blackFFFFBBB(
			...
			for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tParameter.equals(eSingleVariableDeclarationToTParameter.getTarget())) {
					for (MSignatureToTSignature mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tMethodSignature.equals(mmethodSignatureToTMethodSignature.getTarget())) {
							_result.add(new Object[] { mEntry, eSingleVariableDeclarationToTParameter, mParameterList,
									mmethodSignatureToTMethodSignature, tParameter, tMethodSignature, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mEntry, eSingleVariableDeclarationToTParameter,
					mParameterList, mmethodSignatureToTMethodSignature, tParameter, tMethodSignature, ruleResult };
		}
		return null;
	}
