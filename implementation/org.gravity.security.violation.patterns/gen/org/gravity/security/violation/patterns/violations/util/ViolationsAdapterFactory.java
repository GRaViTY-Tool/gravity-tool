...
public class ViolationsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ViolationsSwitch<Adapter> modelSwitch =
		new ViolationsSwitch<Adapter>() {
			@Override
			public Adapter caseSecureDependencyViolation(SecureDependencyViolation object) {
				return createSecureDependencyViolationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.gravity.security.violation.patterns.violations.SecureDependencyViolation <em>Secure Dependency Violation</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSecureDependencyViolationAdapter() {
		return null;
	}
