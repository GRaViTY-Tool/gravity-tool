...
public class OrphanedClassDec2OrphanedClassImpl extends AbstractRuleImpl implements OrphanedClassDec2OrphanedClass {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.ORPHANED_CLASS_DEC2_ORPHANED_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_136__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_136((EMoflonEdge) arguments.get(0));
			case RulesPackage.ORPHANED_CLASS_DEC2_ORPHANED_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_149__EMOFLONEDGE:
