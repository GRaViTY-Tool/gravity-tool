...
public class PrimitiveTypeShortImpl extends AbstractRuleImpl implements PrimitiveTypeShort {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {

		Object[] result1_black = PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_0_1_initialbindings_blackBBB(this,
				match, jpt);
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_0_2_SolveCSP_bindingAndBlackFBBB(this, match, jpt);
		...
		if (PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_0_4_collectelementstobetranslated_blackBB(match, jpt);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[jpt] = " + jpt + ".");
			}
			PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_0_4_collectelementstobetranslated_greenBB(match, jpt);

			Object[] result5_black = PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_0_5_collectcontextelements_blackBB(match, jpt);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[jpt] = " + jpt + ".");
			}
			// 
			PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_0_6_registerobjectstomatch_expressionBBB(this, match,
					jpt);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_1_1_performtransformation_bindingAndBlackFFBB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		org.eclipse.modisco.java.PrimitiveTypeShort jpt = (org.eclipse.modisco.java.PrimitiveTypeShort) result1_bindingAndBlack[0];
		CSP csp = (CSP) result1_bindingAndBlack[1];
		Object[] result1_green = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_1_1_performtransformation_greenFFBB(jpt, csp);
		...
		Object[] result2_black = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_1_2_collecttranslatedelements_blackBBB(a2a, umpt, jpt);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[a2a] = " + a2a + ", "
					+ "[umpt] = " + umpt + ", " + "[jpt] = " + jpt + ".");
		}
		Object[] result2_green = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_1_2_collecttranslatedelements_greenFBBB(a2a, umpt, jpt);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_1_3_bookkeepingforedges_blackBBBB(ruleresult, a2a, umpt, jpt);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a2a] = " + a2a + ", " + "[umpt] = " + umpt + ", " + "[jpt] = " + jpt + ".");
		}
		PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_1_3_bookkeepingforedges_greenBBBBFF(ruleresult, a2a, umpt,
				jpt);
		...
		// 
		// 
		PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_1_5_registerobjects_expressionBBBBB(this, ruleresult, a2a,
				umpt, jpt);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_2_2_corematch_bindingFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		org.eclipse.modisco.java.PrimitiveTypeShort jpt = (org.eclipse.modisco.java.PrimitiveTypeShort) result2_binding[0];
		for (Object[] result2_black : PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_2_2_corematch_blackBB(jpt,
				match)) {
			// ForEach 
			for (Object[] result3_black : PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_2_3_findcontext_blackB(jpt)) {
				Object[] result3_green = PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_2_3_findcontext_greenBF(jpt);
				...
				Object[] result4_bindingAndBlack = PrimitiveTypeShortImpl
						.pattern_PrimitiveTypeShort_2_4_solveCSP_bindingAndBlackFBBB(this, isApplicableMatch, jpt);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {// Create CSP
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			org.eclipse.modisco.java.PrimitiveTypeShort jpt) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public boolean isAppropriate_BWD(Match match, PrimitiveType umpt) {
		...
		Object[] result1_black = PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_10_1_initialbindings_blackBBB(this,
				match, umpt);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_10_2_SolveCSP_bindingAndBlackFBBB(this, match, umpt);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[umpt] = " + umpt + ".");
		}
		...
		if (PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_10_4_collectelementstobetranslated_blackBB(match, umpt);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umpt] = " + umpt + ".");
			}
			PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_10_4_collectelementstobetranslated_greenBB(match, umpt);

			Object[] result5_black = PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_10_5_collectcontextelements_blackBB(match, umpt);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umpt] = " + umpt + ".");
			}
			// 
			PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_10_6_registerobjectstomatch_expressionBBB(this, match,
					umpt);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_11_1_performtransformation_bindingAndBlackFFBB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		...
		CSP csp = (CSP) result1_bindingAndBlack[1];
		Object[] result1_green = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_11_1_performtransformation_greenFBFB(umpt, csp);
		ASTNode2Element a2a = (ASTNode2Element) result1_green[0];
		org.eclipse.modisco.java.PrimitiveTypeShort jpt = (org.eclipse.modisco.java.PrimitiveTypeShort) result1_green[2];

		Object[] result2_black = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_11_2_collecttranslatedelements_blackBBB(a2a, umpt, jpt);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[a2a] = " + a2a + ", "
					+ "[umpt] = " + umpt + ", " + "[jpt] = " + jpt + ".");
		}
		Object[] result2_green = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_11_2_collecttranslatedelements_greenFBBB(a2a, umpt, jpt);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_11_3_bookkeepingforedges_blackBBBB(ruleresult, a2a, umpt, jpt);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[a2a] = " + a2a + ", " + "[umpt] = " + umpt + ", " + "[jpt] = " + jpt + ".");
		}
		PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_11_3_bookkeepingforedges_greenBBBBFF(ruleresult, a2a, umpt,
				jpt);
		//nothing EMoflonEdge a2a__jpt____source = (EMoflonEdge) result3_green[4];
		//nothing EMoflonEdge a2a__umpt____target = (EMoflonEdge) result3_green[5];
		...
		// 
		// 
		PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_11_5_registerobjects_expressionBBBBB(this, ruleresult, a2a,
				umpt, jpt);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_12_2_corematch_bindingFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		PrimitiveType umpt = (PrimitiveType) result2_binding[0];
		for (Object[] result2_black : PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_12_2_corematch_blackBB(umpt,
				match)) {
			// ForEach 
			for (Object[] result3_black : PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_12_3_findcontext_blackB(umpt)) {
				Object[] result3_green = PrimitiveTypeShortImpl
						.pattern_PrimitiveTypeShort_12_3_findcontext_greenBF(umpt);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[1];

				Object[] result4_bindingAndBlack = PrimitiveTypeShortImpl
						.pattern_PrimitiveTypeShort_12_4_solveCSP_bindingAndBlackFBBB(this, isApplicableMatch, umpt);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_PrimitiveType_32(PrimitiveType umpt) {
		...
		for (Object[] result2_black : PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_20_2_testcorematchandDECs_blackB(umpt)) {
			Object[] result2_green = PrimitiveTypeShortImpl
			...
			if (PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBB(this,
							match, umpt)) {
				// 
				if (PrimitiveTypeShortImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_PrimitiveTypeShort_3(org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_21_2_testcorematchandDECs_blackB(jpt)) {
			Object[] result2_green = PrimitiveTypeShortImpl
			...
			// 
			if (PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBB(this,
							match, jpt)) {
				// 
				if (PrimitiveTypeShortImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_bindingAndBlackFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		PrimitiveType umpt = (PrimitiveType) result2_bindingAndBlack[0];
		org.eclipse.modisco.java.PrimitiveTypeShort jpt = (org.eclipse.modisco.java.PrimitiveTypeShort) result2_bindingAndBlack[1];

		Object[] result3_bindingAndBlack = PrimitiveTypeShortImpl
				.pattern_PrimitiveTypeShort_24_3_solvecsp_bindingAndBlackFBBBBB(this, umpt, jpt, sourceMatch,
						targetMatch);
		...
		if (PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_24_5_matchcorrcontext_blackBB(sourceMatch, targetMatch)) {
				Object[] result5_green = PrimitiveTypeShortImpl
						.pattern_PrimitiveTypeShort_24_5_matchcorrcontext_greenBBF(sourceMatch, targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[2];

				Object[] result6_black = PrimitiveTypeShortImpl
						.pattern_PrimitiveTypeShort_24_6_createcorrespondence_blackBBB(umpt, jpt, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[umpt] = " + umpt + ", "
							+ "[jpt] = " + jpt + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_24_6_createcorrespondence_greenFBBB(umpt, jpt,
						ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(PrimitiveType umpt, org.eclipse.modisco.java.PrimitiveTypeShort jpt,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(org.eclipse.modisco.java.PrimitiveTypeShort jpt) {// 
		Object[] result1_black = PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_27_1_matchtggpattern_blackB(jpt);
		if (result1_black != null) {
	...
	public boolean checkDEC_BWD(PrimitiveType umpt) {// 
		Object[] result1_black = PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_28_1_matchtggpattern_blackB(umpt);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer) {
		...
		// 
		Object[] result2_black = PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_29_2_isapplicablecore_blackB(this);
		if (result2_black != null) {

			Object[] result3_bindingAndBlack = PrimitiveTypeShortImpl
					.pattern_PrimitiveTypeShort_29_3_solveCSP_bindingAndBlackFBBB(this, isApplicableMatch, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result6_black = PrimitiveTypeShortImpl
						.pattern_PrimitiveTypeShort_29_6_perform_blackB(ruleResult);
				if (result6_black == null) {
					throw new RuntimeException(
							"Pattern matching failed." + " Variables: " + "[ruleResult] = " + ruleResult + ".");
				}
				PrimitiveTypeShortImpl.pattern_PrimitiveTypeShort_29_6_perform_greenFFFBB(ruleResult, csp);
				//nothing ASTNode2Element a2a = (ASTNode2Element) result6_green[0];
				//nothing PrimitiveType umpt = (PrimitiveType) result6_green[1];
				//nothing org.eclipse.modisco.java.PrimitiveTypeShort jpt = (org.eclipse.modisco.java.PrimitiveTypeShort) result6_green[2];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPROPRIATE_FWD__MATCH_PRIMITIVETYPESHORT:
		...
		case RulesPackage.PRIMITIVE_TYPE_SHORT___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_PRIMITIVETYPESHORT:
			registerObjectsToMatch_FWD((Match) arguments.get(0),
					(org.eclipse.modisco.java.PrimitiveTypeShort) arguments.get(1));
			return null;
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_PRIMITIVETYPESHORT:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0),
					(org.eclipse.modisco.java.PrimitiveTypeShort) arguments.get(1));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PRIMITIVETYPESHORT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(org.eclipse.modisco.java.PrimitiveTypeShort) arguments.get(1));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPLICABLE_CHECK_CSP_FWD__CSP:
			return isApplicable_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPROPRIATE_BWD__MATCH_PRIMITIVETYPE:
		...
		case RulesPackage.PRIMITIVE_TYPE_SHORT___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_PRIMITIVETYPE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (PrimitiveType) arguments.get(1));
			return null;
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_PRIMITIVETYPE:
		...
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PRIMITIVETYPE:
		...
		case RulesPackage.PRIMITIVE_TYPE_SHORT___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT:
			registerObjects_BWD((PerformRuleResult) arguments.get(0), (EObject) arguments.get(1),
					(EObject) arguments.get(2), (EObject) arguments.get(3));
			return null;
		case RulesPackage.PRIMITIVE_TYPE_SHORT___CHECK_TYPES_BWD__MATCH:
			return checkTypes_BWD((Match) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPROPRIATE_BWD_PRIMITIVE_TYPE_32__PRIMITIVETYPE:
			return isAppropriate_BWD_PrimitiveType_32((PrimitiveType) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPROPRIATE_FWD_PRIMITIVE_TYPE_SHORT_3__PRIMITIVETYPESHORT:
			return isAppropriate_FWD_PrimitiveTypeShort_3(
		...
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPLICABLE_SOLVE_CSP_CC__PRIMITIVETYPE_PRIMITIVETYPESHORT_MATCH_MATCH:
			return isApplicable_solveCsp_CC((PrimitiveType) arguments.get(0),
					(org.eclipse.modisco.java.PrimitiveTypeShort) arguments.get(1), (Match) arguments.get(2),
					(Match) arguments.get(3));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___IS_APPLICABLE_CHECK_CSP_CC__CSP:
			return isApplicable_checkCsp_CC((CSP) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___CHECK_DEC_FWD__PRIMITIVETYPESHORT:
			return checkDEC_FWD((org.eclipse.modisco.java.PrimitiveTypeShort) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___CHECK_DEC_BWD__PRIMITIVETYPE:
			return checkDEC_BWD((PrimitiveType) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___GENERATE_MODEL__RULEENTRYCONTAINER:
			return generateModel((RuleEntryContainer) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_SHORT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_PrimitiveTypeShort_0_1_initialbindings_blackBBB(PrimitiveTypeShort _this,
			Match match, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		return new Object[] { _this, match, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeShort_0_2_SolveCSP_bindingFBBB(PrimitiveTypeShort _this,
			Match match, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_0_2_SolveCSP_bindingAndBlackFBBB(PrimitiveTypeShort _this,
			Match match, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		Object[] result_pattern_PrimitiveTypeShort_0_2_SolveCSP_binding = pattern_PrimitiveTypeShort_0_2_SolveCSP_bindingFBBB(
				_this, match, jpt);
	...
	public static final Object[] pattern_PrimitiveTypeShort_0_4_collectelementstobetranslated_blackBB(Match match,
			org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		return new Object[] { match, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeShort_0_4_collectelementstobetranslated_greenBB(Match match,
			org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		match.getToBeTranslatedNodes().add(jpt);
		return new Object[] { match, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeShort_0_5_collectcontextelements_blackBB(Match match,
			org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		return new Object[] { match, jpt };
	}

	public static final void pattern_PrimitiveTypeShort_0_6_registerobjectstomatch_expressionBBB(
			PrimitiveTypeShort _this, Match match, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_1_1_performtransformation_bindingFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_1_1_performtransformation_blackBFBB(
	...
	public static final Object[] pattern_PrimitiveTypeShort_1_1_performtransformation_bindingAndBlackFFBB(
			PrimitiveTypeShort _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_PrimitiveTypeShort_1_1_performtransformation_binding = pattern_PrimitiveTypeShort_1_1_performtransformation_bindingFB(
				isApplicableMatch);
		if (result_pattern_PrimitiveTypeShort_1_1_performtransformation_binding != null) {
			org.eclipse.modisco.java.PrimitiveTypeShort jpt = (org.eclipse.modisco.java.PrimitiveTypeShort) result_pattern_PrimitiveTypeShort_1_1_performtransformation_binding[0];

			Object[] result_pattern_PrimitiveTypeShort_1_1_performtransformation_black = pattern_PrimitiveTypeShort_1_1_performtransformation_blackBFBB(
					jpt, _this, isApplicableMatch);
			if (result_pattern_PrimitiveTypeShort_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_PrimitiveTypeShort_1_1_performtransformation_black[1];
	...
	public static final Object[] pattern_PrimitiveTypeShort_1_1_performtransformation_greenFFBB(
			org.eclipse.modisco.java.PrimitiveTypeShort jpt, CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_1_2_collecttranslatedelements_blackBBB(ASTNode2Element a2a,
			PrimitiveType umpt, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		return new Object[] { a2a, umpt, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeShort_1_2_collecttranslatedelements_greenFBBB(ASTNode2Element a2a,
			PrimitiveType umpt, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_1_3_bookkeepingforedges_blackBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeShort_1_3_bookkeepingforedges_greenBBBBFF(
			PerformRuleResult ruleresult, EObject a2a, EObject umpt, EObject jpt) {
	...
	public static final void pattern_PrimitiveTypeShort_1_5_registerobjects_expressionBBBBB(PrimitiveTypeShort _this,
			PerformRuleResult ruleresult, EObject a2a, EObject umpt, EObject jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_2_2_corematch_bindingFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeShort_2_2_corematch_blackBB(
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeShort_2_3_findcontext_blackB(
			org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_PrimitiveTypeShort_2_3_findcontext_greenBF(
			org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_2_4_solveCSP_bindingFBBB(PrimitiveTypeShort _this,
			IsApplicableMatch isApplicableMatch, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_2_4_solveCSP_bindingAndBlackFBBB(PrimitiveTypeShort _this,
			IsApplicableMatch isApplicableMatch, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		Object[] result_pattern_PrimitiveTypeShort_2_4_solveCSP_binding = pattern_PrimitiveTypeShort_2_4_solveCSP_bindingFBBB(
	...
	public static final Object[] pattern_PrimitiveTypeShort_10_1_initialbindings_blackBBB(PrimitiveTypeShort _this,
			Match match, PrimitiveType umpt) {
		return new Object[] { _this, match, umpt };
	}

	public static final Object[] pattern_PrimitiveTypeShort_10_2_SolveCSP_bindingFBBB(PrimitiveTypeShort _this,
			Match match, PrimitiveType umpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_10_2_SolveCSP_bindingAndBlackFBBB(PrimitiveTypeShort _this,
			Match match, PrimitiveType umpt) {
		Object[] result_pattern_PrimitiveTypeShort_10_2_SolveCSP_binding = pattern_PrimitiveTypeShort_10_2_SolveCSP_bindingFBBB(
				_this, match, umpt);
	...
	public static final Object[] pattern_PrimitiveTypeShort_10_4_collectelementstobetranslated_blackBB(Match match,
			PrimitiveType umpt) {
		return new Object[] { match, umpt };
	}

	public static final Object[] pattern_PrimitiveTypeShort_10_4_collectelementstobetranslated_greenBB(Match match,
			PrimitiveType umpt) {
		match.getToBeTranslatedNodes().add(umpt);
		return new Object[] { match, umpt };
	}

	public static final Object[] pattern_PrimitiveTypeShort_10_5_collectcontextelements_blackBB(Match match,
			PrimitiveType umpt) {
		return new Object[] { match, umpt };
	}

	public static final void pattern_PrimitiveTypeShort_10_6_registerobjectstomatch_expressionBBB(
			PrimitiveTypeShort _this, Match match, PrimitiveType umpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_11_1_performtransformation_bindingFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_11_1_performtransformation_blackBFBB(PrimitiveType umpt,
			PrimitiveTypeShort _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
	...
	public static final Object[] pattern_PrimitiveTypeShort_11_1_performtransformation_bindingAndBlackFFBB(
			PrimitiveTypeShort _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_PrimitiveTypeShort_11_1_performtransformation_binding = pattern_PrimitiveTypeShort_11_1_performtransformation_bindingFB(
				isApplicableMatch);
		if (result_pattern_PrimitiveTypeShort_11_1_performtransformation_binding != null) {
			PrimitiveType umpt = (PrimitiveType) result_pattern_PrimitiveTypeShort_11_1_performtransformation_binding[0];

			Object[] result_pattern_PrimitiveTypeShort_11_1_performtransformation_black = pattern_PrimitiveTypeShort_11_1_performtransformation_blackBFBB(
					umpt, _this, isApplicableMatch);
			if (result_pattern_PrimitiveTypeShort_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_PrimitiveTypeShort_11_1_performtransformation_black[1];
	...
	public static final Object[] pattern_PrimitiveTypeShort_11_1_performtransformation_greenFBFB(PrimitiveType umpt,
			CSP csp) {
		ASTNode2Element a2a = UmlFactory.eINSTANCE.createASTNode2Element();
	...
	public static final Object[] pattern_PrimitiveTypeShort_11_2_collecttranslatedelements_blackBBB(ASTNode2Element a2a,
			PrimitiveType umpt, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		return new Object[] { a2a, umpt, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeShort_11_2_collecttranslatedelements_greenFBBB(
			ASTNode2Element a2a, PrimitiveType umpt, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getCreatedLinkElements().add(a2a);
	...
	public static final Object[] pattern_PrimitiveTypeShort_11_3_bookkeepingforedges_blackBBBB(
			PerformRuleResult ruleresult, EObject a2a, EObject umpt, EObject jpt) {
		if (!a2a.equals(umpt)) {
			if (!a2a.equals(jpt)) {
				if (!jpt.equals(umpt)) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_11_3_bookkeepingforedges_greenBBBBFF(
			PerformRuleResult ruleresult, EObject a2a, EObject umpt, EObject jpt) {
		EMoflonEdge a2a__jpt____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge a2a__umpt____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		String ruleresult_ruleName_prime = "PrimitiveTypeShort";
	...
	public static final void pattern_PrimitiveTypeShort_11_5_registerobjects_expressionBBBBB(PrimitiveTypeShort _this,
			PerformRuleResult ruleresult, EObject a2a, EObject umpt, EObject jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_12_2_corematch_bindingFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeShort_12_2_corematch_blackBB(PrimitiveType umpt,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeShort_12_3_findcontext_blackB(PrimitiveType umpt) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		_result.add(new Object[] { umpt });
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeShort_12_3_findcontext_greenBF(PrimitiveType umpt) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		isApplicableMatch.getAllContextElements().add(umpt);
		return new Object[] { umpt, isApplicableMatch };
	}

	public static final Object[] pattern_PrimitiveTypeShort_12_4_solveCSP_bindingFBBB(PrimitiveTypeShort _this,
	...
	public static final Object[] pattern_PrimitiveTypeShort_12_4_solveCSP_bindingAndBlackFBBB(PrimitiveTypeShort _this,
			IsApplicableMatch isApplicableMatch, PrimitiveType umpt) {
		Object[] result_pattern_PrimitiveTypeShort_12_4_solveCSP_binding = pattern_PrimitiveTypeShort_12_4_solveCSP_bindingFBBB(
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeShort_20_2_testcorematchandDECs_blackB(
			PrimitiveType umpt) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		_result.add(new Object[] { umpt });
		return _result;
	...
	public static final boolean pattern_PrimitiveTypeShort_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBB(
			PrimitiveTypeShort _this, Match match, PrimitiveType umpt) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeShort_21_2_testcorematchandDECs_blackB(
			org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		_result.add(new Object[] { jpt });
		return _result;
	...
	public static final boolean pattern_PrimitiveTypeShort_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBB(
			PrimitiveTypeShort _this, Match match, org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_bindingFFBB(Match targetMatch,
			Match sourceMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_blackBBBB(PrimitiveType umpt,
	...
	public static final Object[] pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_bindingAndBlackFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_binding = pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_bindingFFBB(
				targetMatch, sourceMatch);
		if (result_pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_binding != null) {
			PrimitiveType umpt = (PrimitiveType) result_pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_binding[0];
			org.eclipse.modisco.java.PrimitiveTypeShort jpt = (org.eclipse.modisco.java.PrimitiveTypeShort) result_pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_binding[1];

			Object[] result_pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_black = pattern_PrimitiveTypeShort_24_2_matchsrctrgcontext_blackBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeShort_24_3_solvecsp_bindingFBBBBB(PrimitiveTypeShort _this,
			PrimitiveType umpt, org.eclipse.modisco.java.PrimitiveTypeShort jpt, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_24_3_solvecsp_bindingAndBlackFBBBBB(
			PrimitiveTypeShort _this, PrimitiveType umpt, org.eclipse.modisco.java.PrimitiveTypeShort jpt,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeShort_24_3_solvecsp_binding = pattern_PrimitiveTypeShort_24_3_solvecsp_bindingFBBBBB(
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeShort_24_5_matchcorrcontext_blackBB(Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_24_5_matchcorrcontext_greenBBF(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_24_6_createcorrespondence_blackBBB(PrimitiveType umpt,
			org.eclipse.modisco.java.PrimitiveTypeShort jpt, CCMatch ccMatch) {
		return new Object[] { umpt, jpt, ccMatch };
	}

	public static final Object[] pattern_PrimitiveTypeShort_24_6_createcorrespondence_greenFBBB(PrimitiveType umpt,
			org.eclipse.modisco.java.PrimitiveTypeShort jpt, CCMatch ccMatch) {
		ASTNode2Element a2a = UmlFactory.eINSTANCE.createASTNode2Element();
		a2a.setSource(jpt);
		a2a.setTarget(umpt);
	...
	public static final Object[] pattern_PrimitiveTypeShort_27_1_matchtggpattern_blackB(
			org.eclipse.modisco.java.PrimitiveTypeShort jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_28_1_matchtggpattern_blackB(PrimitiveType umpt) {
	...
	public static final Object[] pattern_PrimitiveTypeShort_29_2_isapplicablecore_blackB(PrimitiveTypeShort _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_PrimitiveTypeShort_29_3_solveCSP_bindingFBBB(PrimitiveTypeShort _this,
	...
	public static final Object[] pattern_PrimitiveTypeShort_29_3_solveCSP_bindingAndBlackFBBB(PrimitiveTypeShort _this,
			IsApplicableMatch isApplicableMatch, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_PrimitiveTypeShort_29_3_solveCSP_binding = pattern_PrimitiveTypeShort_29_3_solveCSP_bindingFBBB(
	...
	public static final Object[] pattern_PrimitiveTypeShort_29_6_perform_blackB(ModelgeneratorRuleResult ruleResult) {
		return new Object[] { ruleResult };
	}

	public static final Object[] pattern_PrimitiveTypeShort_29_6_perform_greenFFFBB(ModelgeneratorRuleResult ruleResult,
			CSP csp) {
		ASTNode2Element a2a = UmlFactory.eINSTANCE.createASTNode2Element();
		PrimitiveType umpt = UMLFactory.eINSTANCE.createPrimitiveType();
		org.eclipse.modisco.java.PrimitiveTypeShort jpt = JavaFactory.eINSTANCE.createPrimitiveTypeShort();
