...
public class ConstructorDec2OperationWithModifierImpl extends AbstractRuleImpl
	...
	public boolean isAppropriate_FWD(Match match, Modifier modifier, MConstructorDefinition bodyDeclaration) {
		...
		Object[] result1_black = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_0_1_initialbindings_blackBBBB(this, match, modifier,
						bodyDeclaration);
		...
		Object[] result2_bindingAndBlack = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_0_2_SolveCSP_bindingAndBlackFBBBB(this, match, modifier,
						bodyDeclaration);
		...
		if (ConstructorDec2OperationWithModifierImpl
			...
			Object[] result5_black = ConstructorDec2OperationWithModifierImpl
					.pattern_ConstructorDec2OperationWithModifier_0_5_collectcontextelements_blackBBB(match, modifier,
							bodyDeclaration);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_1_1_performtransformation_greenFFFBBB(modifier,
						bodyDeclaration, csp);
		...
		Object[] result2_black = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_1_2_collecttranslatedelements_blackBBBBB(m2f, feature,
		...
		Object[] result2_green = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_1_2_collecttranslatedelements_greenFBBBBB(m2f, feature,
						b2e, modifier, bodyDeclaration);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_1_3_bookkeepingforedges_blackBBBBBB(ruleresult, m2f,
		...
		ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult, m2f,
						feature, b2e, modifier, bodyDeclaration);
		...
		// 
		ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_1_5_registerobjects_expressionBBBBBBB(this, ruleresult,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_2_2_corematch_blackBBB(modifier, bodyDeclaration,
						match)) {
			// ForEach 
			for (Object[] result3_black : ConstructorDec2OperationWithModifierImpl
					.pattern_ConstructorDec2OperationWithModifier_2_3_findcontext_blackBB(modifier, bodyDeclaration)) {
				Object[] result3_green = ConstructorDec2OperationWithModifierImpl
						.pattern_ConstructorDec2OperationWithModifier_2_3_findcontext_greenBBFFF(modifier,
								bodyDeclaration);
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, Modifier modifier, MConstructorDefinition bodyDeclaration) {// Create CSP
	...
	public boolean isAppropriate_BWD(Match match, Operation feature) {
		...
		Object[] result1_black = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_10_1_initialbindings_blackBBB(this, match, feature);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_10_2_SolveCSP_bindingAndBlackFBBB(this, match, feature);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[feature] = " + feature + ".");
		}
		...
		if (ConstructorDec2OperationWithModifierImpl
			...
			Object[] result4_black = ConstructorDec2OperationWithModifierImpl
					.pattern_ConstructorDec2OperationWithModifier_10_4_collectelementstobetranslated_blackBB(match,
							feature);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[feature] = " + feature + ".");
			...
			ConstructorDec2OperationWithModifierImpl
					.pattern_ConstructorDec2OperationWithModifier_10_4_collectelementstobetranslated_greenBB(match,
							feature);

			Object[] result5_black = ConstructorDec2OperationWithModifierImpl
					.pattern_ConstructorDec2OperationWithModifier_10_5_collectcontextelements_blackBB(match, feature);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[feature] = " + feature + ".");
			}
			// 
			ConstructorDec2OperationWithModifierImpl
					.pattern_ConstructorDec2OperationWithModifier_10_6_registerobjectstomatch_expressionBBB(this, match,
							feature);
			return ConstructorDec2OperationWithModifierImpl
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_bindingAndBlackFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		Object[] result2_black = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_11_2_collecttranslatedelements_blackBBBBB(m2f, feature,
						b2e, modifier, bodyDeclaration);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[m2f] = " + m2f + ", "
					+ "[feature] = " + feature + ", " + "[b2e] = " + b2e + ", " + "[modifier] = " + modifier + ", "
		...
		Object[] result2_green = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_11_2_collecttranslatedelements_greenFBBBBB(m2f, feature,
						b2e, modifier, bodyDeclaration);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_11_3_bookkeepingforedges_blackBBBBBB(ruleresult, m2f,
						feature, b2e, modifier, bodyDeclaration);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[m2f] = " + m2f + ", " + "[feature] = " + feature + ", " + "[b2e] = " + b2e + ", "
		...
		ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_11_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult,
						m2f, feature, b2e, modifier, bodyDeclaration);
		//nothing EMoflonEdge m2f__feature____target = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge bodyDeclaration__modifier____modifier = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge modifier__bodyDeclaration____bodyDeclaration = (EMoflonEdge) result3_green[8];
		...
		// 
		ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_11_5_registerobjects_expressionBBBBBBB(this, ruleresult,
						m2f, feature, b2e, modifier, bodyDeclaration);
		return ConstructorDec2OperationWithModifierImpl
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_12_2_corematch_bindingFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_12_2_corematch_blackBB(feature, match)) {
			// ForEach 
			for (Object[] result3_black : ConstructorDec2OperationWithModifierImpl
					.pattern_ConstructorDec2OperationWithModifier_12_3_findcontext_blackB(feature)) {
				Object[] result3_green = ConstructorDec2OperationWithModifierImpl
						.pattern_ConstructorDec2OperationWithModifier_12_3_findcontext_greenBF(feature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[1];

				Object[] result4_bindingAndBlack = ConstructorDec2OperationWithModifierImpl
						.pattern_ConstructorDec2OperationWithModifier_12_4_solveCSP_bindingAndBlackFBBB(this,
	...
	public EObjectContainer isAppropriate_BWD_Operation_3(Operation feature) {
		...
		// ForEach 
		for (Object[] result2_black : ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_20_2_testcorematchandDECs_blackB(feature)) {
			Object[] result2_green = ConstructorDec2OperationWithModifierImpl
			...
			// 
			if (ConstructorDec2OperationWithModifierImpl
					.pattern_ConstructorDec2OperationWithModifier_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBB(
							this, match, feature)) {
				// 
				if (ConstructorDec2OperationWithModifierImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_bindingAndBlackFFFBB(sourceMatch,
						targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		Object[] result3_bindingAndBlack = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_24_3_solvecsp_bindingAndBlackFBBBBBB(this, feature,
		...
		if (ConstructorDec2OperationWithModifierImpl
			...
			for (Object[] result5_black : ConstructorDec2OperationWithModifierImpl
				...
				Object[] result6_black = ConstructorDec2OperationWithModifierImpl
						.pattern_ConstructorDec2OperationWithModifier_24_6_createcorrespondence_blackBBBB(feature,
	...
	public boolean checkDEC_FWD(Modifier modifier, MConstructorDefinition bodyDeclaration) {// 
		Object[] result1_black = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_27_1_matchtggpattern_blackBB(modifier, bodyDeclaration);
		if (result1_black != null) {
			return ConstructorDec2OperationWithModifierImpl
	...
	public boolean checkDEC_BWD(Operation feature) {// 
		Object[] result1_black = ConstructorDec2OperationWithModifierImpl
				.pattern_ConstructorDec2OperationWithModifier_28_1_matchtggpattern_blackB(feature);
		if (result1_black != null) {
			return ConstructorDec2OperationWithModifierImpl
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer) {
		...
		if (result2_black != null) {
			...
			if (ConstructorDec2OperationWithModifierImpl
				...
				ConstructorDec2OperationWithModifierImpl
						.pattern_ConstructorDec2OperationWithModifier_29_6_perform_greenFFFFFBB(ruleResult, csp);
				//nothing Modifier2NamedElement m2f = (Modifier2NamedElement) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___IS_APPROPRIATE_FWD__MATCH_MODIFIER_MCONSTRUCTORDEFINITION:
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MODIFIER_MCONSTRUCTORDEFINITION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (Modifier) arguments.get(1),
					(MConstructorDefinition) arguments.get(2));
			return null;
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MODIFIER_MCONSTRUCTORDEFINITION:
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_MCONSTRUCTORDEFINITION:
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___IS_APPROPRIATE_BWD__MATCH_OPERATION:
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_OPERATION:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (Operation) arguments.get(1));
			return null;
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_OPERATION:
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_OPERATION:
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___IS_APPLICABLE_SOLVE_CSP_CC__OPERATION_MODIFIER_MCONSTRUCTORDEFINITION_MATCH_MATCH:
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___CHECK_DEC_FWD__MODIFIER_MCONSTRUCTORDEFINITION:
			return checkDEC_FWD((Modifier) arguments.get(0), (MConstructorDefinition) arguments.get(1));
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_WITH_MODIFIER___CHECK_DEC_BWD__OPERATION:
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_0_1_initialbindings_blackBBBB(
			ConstructorDec2OperationWithModifier _this, Match match, Modifier modifier,
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_1_1_performtransformation_blackBBFBB(
			Modifier modifier, MConstructorDefinition bodyDeclaration, ConstructorDec2OperationWithModifier _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_1_1_performtransformation_bindingAndBlackFFFBB(
		...
		if (result_pattern_ConstructorDec2OperationWithModifier_1_1_performtransformation_binding != null) {
			Modifier modifier = (Modifier) result_pattern_ConstructorDec2OperationWithModifier_1_1_performtransformation_binding[0];
			MConstructorDefinition bodyDeclaration = (MConstructorDefinition) result_pattern_ConstructorDec2OperationWithModifier_1_1_performtransformation_binding[1];
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_1_1_performtransformation_greenFFFBBB(
			Modifier modifier, MConstructorDefinition bodyDeclaration, CSP csp) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_1_2_collecttranslatedelements_blackBBBBB(
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_1_2_collecttranslatedelements_greenFBBBBB(
			Modifier2NamedElement m2f, Operation feature, ASTNode2Element b2e, Modifier modifier,
			MConstructorDefinition bodyDeclaration) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_1_3_bookkeepingforedges_blackBBBBBB(
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject m2f, EObject feature, EObject b2e, EObject modifier,
			EObject bodyDeclaration) {
	...
	public static final void pattern_ConstructorDec2OperationWithModifier_1_5_registerobjects_expressionBBBBBBB(
	...
	public static final Iterable<Object[]> pattern_ConstructorDec2OperationWithModifier_2_2_corematch_blackBBB(
			Modifier modifier, MConstructorDefinition bodyDeclaration, Match match) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_2_4_solveCSP_bindingFBBBB(
			ConstructorDec2OperationWithModifier _this, IsApplicableMatch isApplicableMatch, Modifier modifier,
			MConstructorDefinition bodyDeclaration) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_10_1_initialbindings_blackBBB(
			ConstructorDec2OperationWithModifier _this, Match match, Operation feature) {
		return new Object[] { _this, match, feature };
	}

	public static final Object[] pattern_ConstructorDec2OperationWithModifier_10_2_SolveCSP_bindingFBBB(
			ConstructorDec2OperationWithModifier _this, Match match, Operation feature) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_10_2_SolveCSP_bindingAndBlackFBBB(
			ConstructorDec2OperationWithModifier _this, Match match, Operation feature) {
		Object[] result_pattern_ConstructorDec2OperationWithModifier_10_2_SolveCSP_binding = pattern_ConstructorDec2OperationWithModifier_10_2_SolveCSP_bindingFBBB(
				_this, match, feature);
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_10_4_collectelementstobetranslated_blackBB(
			Match match, Operation feature) {
		return new Object[] { match, feature };
	}

	public static final Object[] pattern_ConstructorDec2OperationWithModifier_10_4_collectelementstobetranslated_greenBB(
			Match match, Operation feature) {
		match.getToBeTranslatedNodes().add(feature);
		return new Object[] { match, feature };
	}

	public static final Object[] pattern_ConstructorDec2OperationWithModifier_10_5_collectcontextelements_blackBB(
			Match match, Operation feature) {
		return new Object[] { match, feature };
	}

	public static final void pattern_ConstructorDec2OperationWithModifier_10_6_registerobjectstomatch_expressionBBB(
			ConstructorDec2OperationWithModifier _this, Match match, Operation feature) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_bindingFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_blackBFBB(
			Operation feature, ConstructorDec2OperationWithModifier _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_bindingAndBlackFFBB(
			ConstructorDec2OperationWithModifier _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_binding = pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_bindingFB(
				isApplicableMatch);
		if (result_pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_black = pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_blackBFBB(
			...
			if (result_pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_ConstructorDec2OperationWithModifier_11_1_performtransformation_black[1];
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_11_2_collecttranslatedelements_blackBBBBB(
			Modifier2NamedElement m2f, Operation feature, ASTNode2Element b2e, Modifier modifier,
			MConstructorDefinition bodyDeclaration) {
		return new Object[] { m2f, feature, b2e, modifier, bodyDeclaration };
	}

	public static final Object[] pattern_ConstructorDec2OperationWithModifier_11_2_collecttranslatedelements_greenFBBBBB(
			Modifier2NamedElement m2f, Operation feature, ASTNode2Element b2e, Modifier modifier,
			MConstructorDefinition bodyDeclaration) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
		ruleresult.getCreatedLinkElements().add(m2f);
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_11_3_bookkeepingforedges_blackBBBBBB(
			PerformRuleResult ruleresult, EObject m2f, EObject feature, EObject b2e, EObject modifier,
			EObject bodyDeclaration) {
		if (!m2f.equals(modifier)) {
			if (!feature.equals(m2f)) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_11_3_bookkeepingforedges_greenBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject m2f, EObject feature, EObject b2e, EObject modifier,
			EObject bodyDeclaration) {
		EMoflonEdge m2f__feature____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge bodyDeclaration__modifier____modifier = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_ConstructorDec2OperationWithModifier_11_5_registerobjects_expressionBBBBBBB(
			ConstructorDec2OperationWithModifier _this, PerformRuleResult ruleresult, EObject m2f, EObject feature,
			EObject b2e, EObject modifier, EObject bodyDeclaration) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_12_2_corematch_bindingFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_ConstructorDec2OperationWithModifier_12_2_corematch_blackBB(
	...
	public static final Iterable<Object[]> pattern_ConstructorDec2OperationWithModifier_12_3_findcontext_blackB(
			Operation feature) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_12_3_findcontext_greenBF(
			Operation feature) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_12_4_solveCSP_bindingFBBB(
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_12_4_solveCSP_bindingAndBlackFBBB(
			ConstructorDec2OperationWithModifier _this, IsApplicableMatch isApplicableMatch, Operation feature) {
		Object[] result_pattern_ConstructorDec2OperationWithModifier_12_4_solveCSP_binding = pattern_ConstructorDec2OperationWithModifier_12_4_solveCSP_bindingFBBB(
	...
	public static final Iterable<Object[]> pattern_ConstructorDec2OperationWithModifier_20_2_testcorematchandDECs_blackB(
			Operation feature) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		_result.add(new Object[] { feature });
		return _result;
	...
	public static final boolean pattern_ConstructorDec2OperationWithModifier_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBB(
			ConstructorDec2OperationWithModifier _this, Match match, Operation feature) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_bindingFFFBB(
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_blackBBBBB(
			Operation feature, Modifier modifier, MConstructorDefinition bodyDeclaration, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_bindingAndBlackFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_binding = pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_bindingFFFBB(
		...
		if (result_pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_binding != null) {
			...
			Modifier modifier = (Modifier) result_pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_binding[1];
			MConstructorDefinition bodyDeclaration = (MConstructorDefinition) result_pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_binding[2];

			Object[] result_pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_black = pattern_ConstructorDec2OperationWithModifier_24_2_matchsrctrgcontext_blackBBBBB(
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_24_3_solvecsp_bindingFBBBBBB(
			ConstructorDec2OperationWithModifier _this, Operation feature, Modifier modifier,
			MConstructorDefinition bodyDeclaration, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_24_3_solvecsp_bindingAndBlackFBBBBBB(
			ConstructorDec2OperationWithModifier _this, Operation feature, Modifier modifier,
			MConstructorDefinition bodyDeclaration, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_ConstructorDec2OperationWithModifier_24_3_solvecsp_binding = pattern_ConstructorDec2OperationWithModifier_24_3_solvecsp_bindingFBBBBBB(
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_24_6_createcorrespondence_blackBBBB(
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_28_1_matchtggpattern_blackB(
			Operation feature) {
	...
	public static final Object[] pattern_ConstructorDec2OperationWithModifier_29_6_perform_greenFFFFFBB(
