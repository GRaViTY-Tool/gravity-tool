...
public class InterfaceDec2InterfaceImpl extends AbstractRuleImpl implements InterfaceDec2Interface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_1_1_performtransformation_greenFBFBFB(bodyDeclaration, umlPackage, csp);
		...
		Object[] result2_black = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_1_2_collecttranslatedelements_blackBBBB(b2e, bodyDeclaration, bd2ne,
						feature);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[b2e] = " + b2e + ", " + "[bodyDeclaration] = "
							+ bodyDeclaration + ", " + "[bd2ne] = " + bd2ne + ", " + "[feature] = " + feature + ".");
		}
		Object[] result2_green = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_1_2_collecttranslatedelements_greenFBBBB(b2e, bodyDeclaration, bd2ne,
						feature);
		...
		Object[] result3_black = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, b2e, jPackage,
						bodyDeclaration, bd2ne, umlPackage, feature, jp2up);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[b2e] = " + b2e + ", " + "[jPackage] = " + jPackage + ", " + "[bodyDeclaration] = "
					+ bodyDeclaration + ", " + "[bd2ne] = " + bd2ne + ", " + "[umlPackage] = " + umlPackage + ", "
		...
		InterfaceDec2InterfaceImpl.pattern_InterfaceDec2Interface_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(
				ruleresult, b2e, jPackage, bodyDeclaration, bd2ne, umlPackage, feature);
		...
		InterfaceDec2InterfaceImpl.pattern_InterfaceDec2Interface_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, b2e, jPackage, bodyDeclaration, bd2ne, umlPackage, feature, jp2up);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_2_2_corematch_blackBBFFB(jPackage, bodyDeclaration, match)) {
			...
			for (Object[] result3_black : InterfaceDec2InterfaceImpl
					.pattern_InterfaceDec2Interface_2_3_findcontext_blackBBBB(jPackage, bodyDeclaration, umlPackage,
							jp2up)) {
				Object[] result3_green = InterfaceDec2InterfaceImpl
						.pattern_InterfaceDec2Interface_2_3_findcontext_greenBBBBFFFFF(jPackage, bodyDeclaration,
								umlPackage, jp2up);
				...
				Object[] result4_bindingAndBlack = InterfaceDec2InterfaceImpl
						.pattern_InterfaceDec2Interface_2_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch,
								jPackage, bodyDeclaration, umlPackage, jp2up);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.modisco.java.Package jPackage,
			InterfaceDeclaration bodyDeclaration, org.eclipse.uml2.uml.Package umlPackage,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject b2e, EObject jPackage,
			EObject bodyDeclaration, EObject bd2ne, EObject umlPackage, EObject feature, EObject jp2up) {
	...
	public boolean isAppropriate_BWD(Match match, org.eclipse.uml2.uml.Package umlPackage, Interface feature) {
		...
		Object[] result1_black = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_10_1_initialbindings_blackBBBB(this, match, umlPackage, feature);
		if (result1_black == null) {
			throw new RuntimeException(
		...
		Object[] result2_bindingAndBlack = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_10_2_SolveCSP_bindingAndBlackFBBBB(this, match, umlPackage, feature);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[this] = " + this + ", " + "[match] = " + match
							+ ", " + "[umlPackage] = " + umlPackage + ", " + "[feature] = " + feature + ".");
		...
		if (InterfaceDec2InterfaceImpl.pattern_InterfaceDec2Interface_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = InterfaceDec2InterfaceImpl
					.pattern_InterfaceDec2Interface_10_4_collectelementstobetranslated_blackBBB(match, umlPackage,
							feature);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umlPackage] = " + umlPackage + ", " + "[feature] = " + feature + ".");
			...
			Object[] result5_black = InterfaceDec2InterfaceImpl
					.pattern_InterfaceDec2Interface_10_5_collectcontextelements_blackBBB(match, umlPackage, feature);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umlPackage] = " + umlPackage + ", " + "[feature] = " + feature + ".");
			}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_11_1_performtransformation_greenFBFFBB(jPackage, feature, csp);
		ASTNode2Element b2e = (ASTNode2Element) result1_green[0];
		InterfaceDeclaration bodyDeclaration = (InterfaceDeclaration) result1_green[2];
		NamedElement2NamedElement bd2ne = (NamedElement2NamedElement) result1_green[3];

		Object[] result2_black = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_11_2_collecttranslatedelements_blackBBBB(b2e, bodyDeclaration, bd2ne,
						feature);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[b2e] = " + b2e + ", " + "[bodyDeclaration] = "
		...
		Object[] result2_green = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_11_2_collecttranslatedelements_greenFBBBB(b2e, bodyDeclaration, bd2ne,
						feature);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_12_2_corematch_blackFBBFB(umlPackage, feature, match)) {
			org.eclipse.modisco.java.Package jPackage = (org.eclipse.modisco.java.Package) result2_black[0];
			JavaPackage2UmlPackage jp2up = (JavaPackage2UmlPackage) result2_black[3];
			// ForEach 
			for (Object[] result3_black : InterfaceDec2InterfaceImpl
					.pattern_InterfaceDec2Interface_12_3_findcontext_blackBBBB(jPackage, umlPackage, feature, jp2up)) {
				Object[] result3_green = InterfaceDec2InterfaceImpl
						.pattern_InterfaceDec2Interface_12_3_findcontext_greenBBBBFFFF(jPackage, umlPackage, feature,
								jp2up);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				...
				Object[] result4_bindingAndBlack = InterfaceDec2InterfaceImpl
						.pattern_InterfaceDec2Interface_12_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch,
								jPackage, umlPackage, feature, jp2up);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[jPackage] = " + jPackage + ", "
							+ "[umlPackage] = " + umlPackage + ", " + "[feature] = " + feature + ", " + "[jp2up] = "
							+ jp2up + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, org.eclipse.modisco.java.Package jPackage,
			org.eclipse.uml2.uml.Package umlPackage, Interface feature, JavaPackage2UmlPackage jp2up) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject b2e, EObject jPackage,
			EObject bodyDeclaration, EObject bd2ne, EObject umlPackage, EObject feature, EObject jp2up) {
		ruleresult.registerObject("b2e", b2e);
		ruleresult.registerObject("jPackage", jPackage);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_402(EMoflonEdge _edge_packagedElement) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_413(EMoflonEdge _edge_ownedElements) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, jPackage, bodyDeclaration,
						umlPackage, feature, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[jPackage] = " + jPackage + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
					+ "[umlPackage] = " + umlPackage + ", " + "[feature] = " + feature + ", " + "[sourceMatch] = "
		...
		if (InterfaceDec2InterfaceImpl.pattern_InterfaceDec2Interface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceDec2InterfaceImpl
				...
				Object[] result6_black = InterfaceDec2InterfaceImpl
						.pattern_InterfaceDec2Interface_24_6_createcorrespondence_blackBBBBB(jPackage, bodyDeclaration,
								umlPackage, feature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jPackage] = " + jPackage
							+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[umlPackage] = " + umlPackage
							+ ", " + "[feature] = " + feature + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				InterfaceDec2InterfaceImpl.pattern_InterfaceDec2Interface_24_6_createcorrespondence_greenFBFBB(
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.modisco.java.Package jPackage, InterfaceDeclaration bodyDeclaration,
			org.eclipse.uml2.uml.Package umlPackage, Interface feature, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public boolean checkDEC_BWD(org.eclipse.uml2.uml.Package umlPackage, Interface feature) {// 
		Object[] result1_black = InterfaceDec2InterfaceImpl
				.pattern_InterfaceDec2Interface_28_1_matchtggpattern_blackBB(umlPackage, feature);
		if (result1_black != null) {
		...
		for (Object[] result2_black : InterfaceDec2InterfaceImpl
			...
			if (InterfaceDec2InterfaceImpl.pattern_InterfaceDec2Interface_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					InterfaceDec2InterfaceImpl.pattern_InterfaceDec2Interface_29_6_perform_greenFBFFBFBB(jPackage,
							umlPackage, ruleResult, csp);
					//nothing ASTNode2Element b2e = (ASTNode2Element) result6_green[0];
					//nothing InterfaceDeclaration bodyDeclaration = (InterfaceDeclaration) result6_green[2];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_DEC2_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PACKAGE_INTERFACEDECLARATION_PACKAGE_JAVAPACKAGE2UMLPACKAGE:
		...
		case RulesPackage.INTERFACE_DEC2_INTERFACE___IS_APPROPRIATE_BWD__MATCH_PACKAGE_INTERFACE:
		...
		case RulesPackage.INTERFACE_DEC2_INTERFACE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_PACKAGE_INTERFACE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (org.eclipse.uml2.uml.Package) arguments.get(1),
					(Interface) arguments.get(2));
			return null;
		case RulesPackage.INTERFACE_DEC2_INTERFACE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_PACKAGE_INTERFACE:
		...
		case RulesPackage.INTERFACE_DEC2_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_PACKAGE_INTERFACE_JAVAPACKAGE2UMLPACKAGE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(org.eclipse.modisco.java.Package) arguments.get(1),
					(org.eclipse.uml2.uml.Package) arguments.get(2), (Interface) arguments.get(3),
		...
		case RulesPackage.INTERFACE_DEC2_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_402__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_402((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_DEC2_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_413__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_DEC2_INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__PACKAGE_INTERFACEDECLARATION_PACKAGE_INTERFACE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((org.eclipse.modisco.java.Package) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (org.eclipse.uml2.uml.Package) arguments.get(2),
		...
		case RulesPackage.INTERFACE_DEC2_INTERFACE___CHECK_DEC_BWD__PACKAGE_INTERFACE:
			...
			if (tmpBodyDeclaration instanceof InterfaceDeclaration) {
				...
				if (tmpUmlPackage instanceof org.eclipse.uml2.uml.Package) {
					...
					if (tmpJp2up instanceof JavaPackage2UmlPackage) {
						...
						return new Object[] { jPackage, bodyDeclaration, umlPackage, jp2up, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_InterfaceDec2Interface_1_1_performtransformation_blackBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { jPackage, bodyDeclaration, umlPackage, jp2up, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceDec2Interface_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_InterfaceDec2Interface_1_1_performtransformation_binding != null) {
			...
			InterfaceDeclaration bodyDeclaration = (InterfaceDeclaration) result_pattern_InterfaceDec2Interface_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_InterfaceDec2Interface_1_1_performtransformation_black = pattern_InterfaceDec2Interface_1_1_performtransformation_blackBBBBFBB(
					jPackage, bodyDeclaration, umlPackage, jp2up, _this, isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceDec2Interface_1_1_performtransformation_greenFBFBFB(
		...
		return new Object[] { b2e, bodyDeclaration, bd2ne, umlPackage, feature, csp };
	}

	public static final Object[] pattern_InterfaceDec2Interface_1_2_collecttranslatedelements_blackBBBB(
			ASTNode2Element b2e, InterfaceDeclaration bodyDeclaration, NamedElement2NamedElement bd2ne,
			Interface feature) {
		return new Object[] { b2e, bodyDeclaration, bd2ne, feature };
	}
	...
	public static final Object[] pattern_InterfaceDec2Interface_1_2_collecttranslatedelements_greenFBBBB(
		...
		return new Object[] { ruleresult, b2e, bodyDeclaration, bd2ne, feature };
	}

	public static final Object[] pattern_InterfaceDec2Interface_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject b2e, EObject jPackage, EObject bodyDeclaration, EObject bd2ne,
			EObject umlPackage, EObject feature, EObject jp2up) {
	...
	public static final Object[] pattern_InterfaceDec2Interface_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject b2e, EObject jPackage, EObject bodyDeclaration, EObject bd2ne,
			EObject umlPackage, EObject feature) {
		EMoflonEdge jPackage__bodyDeclaration____ownedElements = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge bodyDeclaration__jPackage____package = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, b2e, jPackage, bodyDeclaration, bd2ne, umlPackage, feature,
				...
				umlPackage__feature____packagedElement, bd2ne__feature____target, b2e__feature____target };
	}

	public static final void pattern_InterfaceDec2Interface_1_5_registerobjects_expressionBBBBBBBBB(
			InterfaceDec2Interface _this, PerformRuleResult ruleresult, EObject b2e, EObject jPackage,
			EObject bodyDeclaration, EObject bd2ne, EObject umlPackage, EObject feature, EObject jp2up) {
		_this.registerObjects_FWD(ruleresult, b2e, jPackage, bodyDeclaration, bd2ne, umlPackage, feature, jp2up);
	...
	public static final Iterable<Object[]> pattern_InterfaceDec2Interface_2_2_corematch_blackBBFFB(
		...
		for (JavaPackage2UmlPackage jp2up : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(jPackage,
			...
			if (umlPackage != null) {
				_result.add(new Object[] { jPackage, bodyDeclaration, umlPackage, jp2up, match });
			}
		...
		if (jPackage.getOwnedElements().contains(bodyDeclaration)) {
			if (umlPackage.equals(jp2up.getTarget())) {
				if (jPackage.equals(jp2up.getSource())) {
					_result.add(new Object[] { jPackage, bodyDeclaration, umlPackage, jp2up });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_InterfaceDec2Interface_2_4_solveCSP_bindingFBBBBBB(
			...
			org.eclipse.modisco.java.Package jPackage, InterfaceDeclaration bodyDeclaration,
			org.eclipse.uml2.uml.Package umlPackage, JavaPackage2UmlPackage jp2up) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, jPackage, bodyDeclaration, umlPackage,
				jp2up);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jPackage, bodyDeclaration, umlPackage, jp2up };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceDec2Interface_2_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_InterfaceDec2Interface_2_4_solveCSP_binding = pattern_InterfaceDec2Interface_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, jPackage, bodyDeclaration, umlPackage, jp2up);
	...
	public static final Object[] pattern_InterfaceDec2Interface_10_1_initialbindings_blackBBBB(
			InterfaceDec2Interface _this, Match match, org.eclipse.uml2.uml.Package umlPackage, Interface feature) {
		...
		if (tmpJPackage instanceof org.eclipse.modisco.java.Package) {
			...
			if (tmpUmlPackage instanceof org.eclipse.uml2.uml.Package) {
				...
				if (tmpFeature instanceof Interface) {
					...
					if (tmpJp2up instanceof JavaPackage2UmlPackage) {
						JavaPackage2UmlPackage jp2up = (JavaPackage2UmlPackage) tmpJp2up;
						return new Object[] { jPackage, umlPackage, feature, jp2up, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_InterfaceDec2Interface_11_1_performtransformation_blackBBBBFBB(
			org.eclipse.modisco.java.Package jPackage, org.eclipse.uml2.uml.Package umlPackage, Interface feature,
			JavaPackage2UmlPackage jp2up, InterfaceDec2Interface _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { jPackage, umlPackage, feature, jp2up, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceDec2Interface_11_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_InterfaceDec2Interface_11_1_performtransformation_binding != null) {
			...
			org.eclipse.uml2.uml.Package umlPackage = (org.eclipse.uml2.uml.Package) result_pattern_InterfaceDec2Interface_11_1_performtransformation_binding[1];
			Interface feature = (Interface) result_pattern_InterfaceDec2Interface_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_InterfaceDec2Interface_11_1_performtransformation_black = pattern_InterfaceDec2Interface_11_1_performtransformation_blackBBBBFBB(
					jPackage, umlPackage, feature, jp2up, _this, isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceDec2Interface_11_1_performtransformation_greenFBFFBB(
		...
		return new Object[] { b2e, jPackage, bodyDeclaration, bd2ne, feature, csp };
	}
	...
	public static final void pattern_InterfaceDec2Interface_11_5_registerobjects_expressionBBBBBBBBB(
			InterfaceDec2Interface _this, PerformRuleResult ruleresult, EObject b2e, EObject jPackage,
			EObject bodyDeclaration, EObject bd2ne, EObject umlPackage, EObject feature, EObject jp2up) {
		_this.registerObjects_BWD(ruleresult, b2e, jPackage, bodyDeclaration, bd2ne, umlPackage, feature, jp2up);
	...
	public static final Iterable<Object[]> pattern_InterfaceDec2Interface_12_2_corematch_blackFBBFB(
		...
		for (JavaPackage2UmlPackage jp2up : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (jPackage != null) {
				_result.add(new Object[] { jPackage, umlPackage, feature, jp2up, match });
			}
	...
	public static final Iterable<Object[]> pattern_InterfaceDec2Interface_12_3_findcontext_blackBBBB(
		...
		if (umlPackage.getPackagedElements().contains(feature)) {
			if (umlPackage.equals(jp2up.getTarget())) {
				if (jPackage.equals(jp2up.getSource())) {
					_result.add(new Object[] { jPackage, umlPackage, feature, jp2up });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_InterfaceDec2Interface_12_4_solveCSP_bindingFBBBBBB(
			...
			org.eclipse.modisco.java.Package jPackage, org.eclipse.uml2.uml.Package umlPackage, Interface feature,
			JavaPackage2UmlPackage jp2up) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, jPackage, umlPackage, feature, jp2up);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jPackage, umlPackage, feature, jp2up };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceDec2Interface_12_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_InterfaceDec2Interface_12_4_solveCSP_binding = pattern_InterfaceDec2Interface_12_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, jPackage, umlPackage, feature, jp2up);
	...
	public static final Object[] pattern_InterfaceDec2Interface_20_2_testcorematchandDECs_black_nac_0B(
			Interface feature) {
		for (org.eclipse.uml2.uml.Class __DEC_feature_nestedClassifier_86614 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceDec2Interface_20_2_testcorematchandDECs_black_nac_1B(
			Interface feature) {
		for (Interface __DEC_feature_nestedClassifier_583547 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(feature, Interface.class, "nestedClassifier")) {
			if (!feature.equals(__DEC_feature_nestedClassifier_583547)) {
				return new Object[] { feature };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceDec2Interface_21_2_testcorematchandDECs_black_nac_0B(
			InterfaceDeclaration bodyDeclaration) {
		Modifier __DEC_bodyDeclaration_modifier_566822 = bodyDeclaration.getModifier();
		if (__DEC_bodyDeclaration_modifier_566822 != null) {
	...
	public static final Object[] pattern_InterfaceDec2Interface_21_2_testcorematchandDECs_black_nac_1B(
			InterfaceDeclaration bodyDeclaration) {
		AbstractTypeDeclaration __DEC_bodyDeclaration_bodyDeclarations_747148 = bodyDeclaration
				.getAbstractTypeDeclaration();
		if (__DEC_bodyDeclaration_bodyDeclarations_747148 != null) {
			if (!bodyDeclaration.equals(__DEC_bodyDeclaration_bodyDeclarations_747148)) {
				return new Object[] { bodyDeclaration };
			}
		}
	...
	public static final Object[] pattern_InterfaceDec2Interface_21_2_testcorematchandDECs_black_nac_2B(
			InterfaceDeclaration bodyDeclaration) {
		AnonymousClassDeclaration __DEC_bodyDeclaration_bodyDeclarations_317992 = bodyDeclaration
				.getAnonymousClassDeclarationOwner();
		if (__DEC_bodyDeclaration_bodyDeclarations_317992 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_InterfaceDec2Interface_21_2_testcorematchandDECs_black_nac_3B(
			InterfaceDeclaration bodyDeclaration) {
		for (MAbstractMethodDefinition __DEC_bodyDeclaration_mInnerTypes_671983 : org.moflon.core.utilities.eMoflonEMFUtil
		...
		if (tmpJPackage instanceof org.eclipse.modisco.java.Package) {
			...
			if (tmpBodyDeclaration instanceof InterfaceDeclaration) {
				...
				if (tmpUmlPackage instanceof org.eclipse.uml2.uml.Package) {
					...
					if (tmpFeature instanceof Interface) {
						Interface feature = (Interface) tmpFeature;
						return new Object[] { jPackage, bodyDeclaration, umlPackage, feature, sourceMatch,
								targetMatch };
					}
				}
			}
	...
	public static final Object[] pattern_InterfaceDec2Interface_24_2_matchsrctrgcontext_blackBBBBBB(
			org.eclipse.modisco.java.Package jPackage, InterfaceDeclaration bodyDeclaration,
			org.eclipse.uml2.uml.Package umlPackage, Interface feature, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { jPackage, bodyDeclaration, umlPackage, feature, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceDec2Interface_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_InterfaceDec2Interface_24_2_matchsrctrgcontext_binding != null) {
			...
			Interface feature = (Interface) result_pattern_InterfaceDec2Interface_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_InterfaceDec2Interface_24_2_matchsrctrgcontext_black = pattern_InterfaceDec2Interface_24_2_matchsrctrgcontext_blackBBBBBB(
					jPackage, bodyDeclaration, umlPackage, feature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceDec2Interface_24_3_solvecsp_bindingFBBBBBBB(
			InterfaceDec2Interface _this, org.eclipse.modisco.java.Package jPackage,
			InterfaceDeclaration bodyDeclaration, org.eclipse.uml2.uml.Package umlPackage, Interface feature,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(jPackage, bodyDeclaration, umlPackage, feature,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, jPackage, bodyDeclaration, umlPackage, feature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceDec2Interface_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_InterfaceDec2Interface_24_3_solvecsp_binding = pattern_InterfaceDec2Interface_24_3_solvecsp_bindingFBBBBBBB(
				_this, jPackage, bodyDeclaration, umlPackage, feature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceDec2Interface_24_6_createcorrespondence_blackBBBBB(
			org.eclipse.modisco.java.Package jPackage, InterfaceDeclaration bodyDeclaration,
			org.eclipse.uml2.uml.Package umlPackage, Interface feature, CCMatch ccMatch) {
		return new Object[] { jPackage, bodyDeclaration, umlPackage, feature, ccMatch };
	}

	public static final Object[] pattern_InterfaceDec2Interface_24_6_createcorrespondence_greenFBFBB(
		...
		return new Object[] { b2e, bodyDeclaration, bd2ne, feature, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceDec2Interface_27_1_matchtggpattern_black_nac_0B(
			InterfaceDeclaration bodyDeclaration) {
		Modifier __DEC_bodyDeclaration_modifier_273913 = bodyDeclaration.getModifier();
		if (__DEC_bodyDeclaration_modifier_273913 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_InterfaceDec2Interface_27_1_matchtggpattern_black_nac_1B(
			InterfaceDeclaration bodyDeclaration) {
		AbstractTypeDeclaration __DEC_bodyDeclaration_bodyDeclarations_719962 = bodyDeclaration
				.getAbstractTypeDeclaration();
		if (__DEC_bodyDeclaration_bodyDeclarations_719962 != null) {
			if (!bodyDeclaration.equals(__DEC_bodyDeclaration_bodyDeclarations_719962)) {
				return new Object[] { bodyDeclaration };
			}
		}
	...
	public static final Object[] pattern_InterfaceDec2Interface_27_1_matchtggpattern_black_nac_2B(
			InterfaceDeclaration bodyDeclaration) {
		AnonymousClassDeclaration __DEC_bodyDeclaration_bodyDeclarations_898028 = bodyDeclaration
				.getAnonymousClassDeclarationOwner();
		if (__DEC_bodyDeclaration_bodyDeclarations_898028 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_InterfaceDec2Interface_27_1_matchtggpattern_black_nac_3B(
			InterfaceDeclaration bodyDeclaration) {
		for (MAbstractMethodDefinition __DEC_bodyDeclaration_mInnerTypes_793071 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(bodyDeclaration, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { bodyDeclaration };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceDec2Interface_28_1_matchtggpattern_black_nac_0B(Interface feature) {
		for (org.eclipse.uml2.uml.Class __DEC_feature_nestedClassifier_318176 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(feature, org.eclipse.uml2.uml.Class.class, "nestedClassifier")) {
			return new Object[] { feature };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceDec2Interface_28_1_matchtggpattern_black_nac_1B(Interface feature) {
		for (Interface __DEC_feature_nestedClassifier_865636 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(feature, Interface.class, "nestedClassifier")) {
			if (!feature.equals(__DEC_feature_nestedClassifier_865636)) {
				return new Object[] { feature };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceDec2Interface_28_1_matchtggpattern_blackBB(
			org.eclipse.uml2.uml.Package umlPackage, Interface feature) {
		if (umlPackage.getPackagedElements().contains(feature)) {
	...
	public static final Object[] pattern_InterfaceDec2Interface_29_6_perform_greenFBFFBFBB(
			org.eclipse.modisco.java.Package jPackage, org.eclipse.uml2.uml.Package umlPackage,
		...
		return new Object[] { b2e, jPackage, bodyDeclaration, bd2ne, umlPackage, feature, ruleResult, csp };
	}
