	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RulesPackage.PARAMETERIZED_TYPE2_CLASS_INNER_TYPE_IN_INTERFACE: {
				...
				T result = caseParameterizedType2Class_InnerTypeInInterface(
			...
			case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_INTERFACE: {
				...
				T result = caseInnerDeclaration2InnerClassifier_InInterface(
			...
			case RulesPackage.PARAMETERIZED_TYPE2_INTERFACE_INNER_TYPE_IN_CLASS: {
				...
				T result = caseParameterizedType2Interface_InnerTypeInClass(
			...
			case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS: {
				...
				T result = caseInnerDeclaration2InnerClassifier_InAnonymous(
			...
			case RulesPackage.IGNORE_CLASS_INSTANCE_CREATION4_ARRAY_INITIALIZER: {
				...
				T result = caseIgnoreClassInstanceCreation4ArrayInitializer(
						ignoreClassInstanceCreation4ArrayInitializer);
				if (result == null)
