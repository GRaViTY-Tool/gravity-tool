...
public class ConstructorDec2OperationAnonymousImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = ConstructorDec2OperationAnonymousImpl
				.pattern_ConstructorDec2OperationAnonymous_1_2_collecttranslatedelements_blackBBBB(bd2ne, feature, b2e,
						bodyDeclaration);
		...
		Object[] result2_green = ConstructorDec2OperationAnonymousImpl
				.pattern_ConstructorDec2OperationAnonymous_1_2_collecttranslatedelements_greenFBBBB(bd2ne, feature, b2e,
						bodyDeclaration);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = ConstructorDec2OperationAnonymousImpl
				.pattern_ConstructorDec2OperationAnonymous_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, bd2ne,
						feature, b2e, mAnon, bodyDeclaration, ba2na, uAnon);
		...
		ConstructorDec2OperationAnonymousImpl
				.pattern_ConstructorDec2OperationAnonymous_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult,
						bd2ne, feature, b2e, mAnon, bodyDeclaration, uAnon);
		...
		ConstructorDec2OperationAnonymousImpl
				.pattern_ConstructorDec2OperationAnonymous_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult,
						bd2ne, feature, b2e, mAnon, bodyDeclaration, ba2na, uAnon);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = ConstructorDec2OperationAnonymousImpl
				.pattern_ConstructorDec2OperationAnonymous_11_1_performtransformation_greenFBFBFB(feature, mAnon, csp);
		NamedElement2NamedElement bd2ne = (NamedElement2NamedElement) result1_green[0];
		ASTNode2Element b2e = (ASTNode2Element) result1_green[2];
		MConstructorDefinition bodyDeclaration = (MConstructorDefinition) result1_green[4];

		Object[] result2_black = ConstructorDec2OperationAnonymousImpl
				.pattern_ConstructorDec2OperationAnonymous_11_2_collecttranslatedelements_blackBBBB(bd2ne, feature, b2e,
						bodyDeclaration);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[bd2ne] = " + bd2ne + ", " + "[feature] = " + feature
		...
		Object[] result2_green = ConstructorDec2OperationAnonymousImpl
				.pattern_ConstructorDec2OperationAnonymous_11_2_collecttranslatedelements_greenFBBBB(bd2ne, feature,
						b2e, bodyDeclaration);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = ConstructorDec2OperationAnonymousImpl
				.pattern_ConstructorDec2OperationAnonymous_11_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, bd2ne,
						feature, b2e, mAnon, bodyDeclaration, ba2na, uAnon);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bd2ne] = " + bd2ne + ", " + "[feature] = " + feature + ", " + "[b2e] = " + b2e + ", "
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_81(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (ConstructorDec2OperationAnonymousImpl
			...
			for (Object[] result5_black : ConstructorDec2OperationAnonymousImpl
				...
				ConstructorDec2OperationAnonymousImpl
						.pattern_ConstructorDec2OperationAnonymous_24_6_createcorrespondence_greenFBFBB(feature,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_81__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_81((EMoflonEdge) arguments.get(0));
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_82__EMOFLONEDGE:
	...
	public static final void pattern_ConstructorDec2OperationAnonymous_1_5_registerobjects_expressionBBBBBBBBB(
			ConstructorDec2OperationAnonymous _this, PerformRuleResult ruleresult, EObject bd2ne, EObject feature,
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_11_1_performtransformation_greenFBFBFB(
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_20_2_testcorematchandDECs_black_nac_0B(
			Operation feature) {
		DataType __DEC_feature_ownedOperation_447982 = feature.getDatatype();
		if (__DEC_feature_ownedOperation_447982 != null) {
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_20_2_testcorematchandDECs_black_nac_1B(
			Operation feature) {
		Interface __DEC_feature_ownedOperation_384224 = feature.getInterface();
		if (__DEC_feature_ownedOperation_384224 != null) {
			return new Object[] { feature };
		}
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_21_2_testcorematchandDECs_black_nac_0B(
			MConstructorDefinition bodyDeclaration) {
		Modifier __DEC_bodyDeclaration_modifier_389361 = bodyDeclaration.getModifier();
		if (__DEC_bodyDeclaration_modifier_389361 != null) {
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_21_2_testcorematchandDECs_black_nac_1B(
			MConstructorDefinition bodyDeclaration) {
		AbstractTypeDeclaration __DEC_bodyDeclaration_bodyDeclarations_283309 = bodyDeclaration
				.getAbstractTypeDeclaration();
		if (__DEC_bodyDeclaration_bodyDeclarations_283309 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_24_6_createcorrespondence_greenFBFBB(
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_27_1_matchtggpattern_black_nac_0B(
			MConstructorDefinition bodyDeclaration) {
		Modifier __DEC_bodyDeclaration_modifier_433053 = bodyDeclaration.getModifier();
		if (__DEC_bodyDeclaration_modifier_433053 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_27_1_matchtggpattern_black_nac_1B(
			MConstructorDefinition bodyDeclaration) {
		AbstractTypeDeclaration __DEC_bodyDeclaration_bodyDeclarations_920314 = bodyDeclaration
				.getAbstractTypeDeclaration();
		if (__DEC_bodyDeclaration_bodyDeclarations_920314 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_28_1_matchtggpattern_black_nac_0B(
			Operation feature) {
		DataType __DEC_feature_ownedOperation_119646 = feature.getDatatype();
		if (__DEC_feature_ownedOperation_119646 != null) {
			return new Object[] { feature };
		}
	...
	public static final Object[] pattern_ConstructorDec2OperationAnonymous_28_1_matchtggpattern_black_nac_1B(
			Operation feature) {
		Interface __DEC_feature_ownedOperation_367359 = feature.getInterface();
		if (__DEC_feature_ownedOperation_367359 != null) {
			return new Object[] { feature };
		}
