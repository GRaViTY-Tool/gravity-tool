...
public class RulesFactoryImpl extends EFactoryImpl implements RulesFactory {
	...
	public EObject create(EClass eClass) {
		...
		case RulesPackage.METHOD_DEC2_OPERATION_ANONYMOUS:
			return createMethodDec2OperationAnonymous();
		...
		case RulesPackage.TYPE_ACCESS_TYPE2_PARAMETER_TYPE_PARAMETER:
			return createTypeAccessType2ParameterType_Parameter();
		...
		case RulesPackage.TYPE_ACCESS_TYPE2_PARAMETER_TYPE_ABSTRACT:
			return createTypeAccessType2ParameterType_Abstract();
		...
		case RulesPackage.TYPE_ACCESS_TYPE2_PARAMETER_TYPE_RETURN:
			return createTypeAccessType2ParameterType_Return();
		...
		case RulesPackage.CONSTRUCTOR_DEC2_OPERATION_ANONYMOUS:
			return createConstructorDec2OperationAnonymous();
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER:
			return createVariableDec2Parameter();
		...
		case RulesPackage.TYPE_ACCESS2_RETURN_PARAM:
			return createTypeAccess2ReturnParam();
		...
		case RulesPackage.ABSTRACT_METHOD_DEC2_OPERATION_ANONYMOUS:
			return createAbstractMethodDec2OperationAnonymous();
	 ...
	 */
	@Override
	public MethodDec2OperationAnonymous createMethodDec2OperationAnonymous() {
		MethodDec2OperationAnonymousImpl methodDec2OperationAnonymous = new MethodDec2OperationAnonymousImpl();
		return methodDec2OperationAnonymous;
	}
	 ...
	 */
	@Override
	public TypeAccessType2ParameterType_Parameter createTypeAccessType2ParameterType_Parameter() {
		TypeAccessType2ParameterType_ParameterImpl typeAccessType2ParameterType_Parameter = new TypeAccessType2ParameterType_ParameterImpl();
		return typeAccessType2ParameterType_Parameter;
	}
	 ...
	 */
	@Override
	public TypeAccessType2ParameterType_Abstract createTypeAccessType2ParameterType_Abstract() {
		TypeAccessType2ParameterType_AbstractImpl typeAccessType2ParameterType_Abstract = new TypeAccessType2ParameterType_AbstractImpl();
		return typeAccessType2ParameterType_Abstract;
	}
	 ...
	 */
	@Override
	public TypeAccessType2ParameterType_Return createTypeAccessType2ParameterType_Return() {
		TypeAccessType2ParameterType_ReturnImpl typeAccessType2ParameterType_Return = new TypeAccessType2ParameterType_ReturnImpl();
		return typeAccessType2ParameterType_Return;
	}
	 ...
	 */
	@Override
	public ConstructorDec2OperationAnonymous createConstructorDec2OperationAnonymous() {
		ConstructorDec2OperationAnonymousImpl constructorDec2OperationAnonymous = new ConstructorDec2OperationAnonymousImpl();
		return constructorDec2OperationAnonymous;
	}
	 ...
	 */
	@Override
	public VariableDec2Parameter createVariableDec2Parameter() {
		VariableDec2ParameterImpl variableDec2Parameter = new VariableDec2ParameterImpl();
		return variableDec2Parameter;
	}
	 ...
	 */
	@Override
	public TypeAccess2ReturnParam createTypeAccess2ReturnParam() {
		TypeAccess2ReturnParamImpl typeAccess2ReturnParam = new TypeAccess2ReturnParamImpl();
		return typeAccess2ReturnParam;
	}
	 ...
	 */
	@Override
	public AbstractMethodDec2OperationAnonymous createAbstractMethodDec2OperationAnonymous() {
		AbstractMethodDec2OperationAnonymousImpl abstractMethodDec2OperationAnonymous = new AbstractMethodDec2OperationAnonymousImpl();
		return abstractMethodDec2OperationAnonymous;
	}
