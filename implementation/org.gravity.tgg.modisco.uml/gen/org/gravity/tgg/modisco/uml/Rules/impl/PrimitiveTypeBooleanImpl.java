 ...
 * @generated
 */
public class PrimitiveTypeBooleanImpl extends AbstractRuleImpl implements PrimitiveTypeBoolean {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getPrimitiveTypeBoolean();
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypeBooleanImpl
				.pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		...
		Object[] result1_green = PrimitiveTypeBooleanImpl
				.pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_greenBF(performOperation);
		...
		for (Object[] result2_black : PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_2_2_corematch_blackFBFBB(jm,
			...
			for (Object[] result3_black : PrimitiveTypeBooleanImpl
				...
				// 
				if (PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_2_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = PrimitiveTypeBooleanImpl
							.pattern_PrimitiveTypeBoolean_2_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_2_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_2_7_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypeBooleanImpl
				.pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		EOperation performOperation = (EOperation) result1_bindingAndBlack[0];
		//nothing EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = PrimitiveTypeBooleanImpl
				.pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];
		...
		for (Object[] result2_black : PrimitiveTypeBooleanImpl
			...
			for (Object[] result3_black : PrimitiveTypeBooleanImpl
				...
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
				if (PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_12_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = PrimitiveTypeBooleanImpl
							.pattern_PrimitiveTypeBoolean_12_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_12_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_12_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_984(EMoflonEdge _edge_packagedElement) {
		...
		Object[] result1_green = PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_greenF();
		...
		for (Object[] result2_black : PrimitiveTypeBooleanImpl
			...
			if (PrimitiveTypeBooleanImpl
				...
				if (PrimitiveTypeBooleanImpl
					...
					Object[] result5_black = PrimitiveTypeBooleanImpl
							.pattern_PrimitiveTypeBoolean_20_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
					...
					PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_20_5_Addmatchtoruleresult_greenBBBB(match,
		...
		return PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_20_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_1007(EMoflonEdge _edge_orphanTypes) {
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		EOperation isApplicableCC = (EOperation) result1_bindingAndBlack[3];
		Object[] result1_green = PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];
		...
		for (Object[] result2_black : PrimitiveTypeBooleanImpl
			...
			if (PrimitiveTypeBooleanImpl
				...
				if (PrimitiveTypeBooleanImpl
					...
					Object[] result5_black = PrimitiveTypeBooleanImpl
							.pattern_PrimitiveTypeBoolean_21_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
									__result, isApplicableCC);
					if (result5_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match
								+ ", " + "[__performOperation] = " + __performOperation + ", " + "[__result] = "
					...
					PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_21_5_Addmatchtoruleresult_greenBBBB(match,
							__performOperation, __result, isApplicableCC);
		...
		return PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_21_6_expressionFB(__result);
	}
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result1_black = PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_24_1_prepare_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_24_1_prepare_greenF();
		...
		if (PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : PrimitiveTypeBooleanImpl
				...
				PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_24_7_addtoreturnedresult_greenBB(result, ccMatch);

			}

		} else {
		}
		return PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_24_8_expressionFB(result);
	}
	...
	public boolean checkDEC_FWD(Model jm, org.eclipse.modisco.java.PrimitiveTypeBoolean jpt) {// 
		...
		if (result1_black != null) {
			...
			return PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_27_3_expressionF();
		}
	...
	public boolean checkDEC_BWD(PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {// 
		...
		if (result1_black != null) {
			...
			return PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_28_3_expressionF();
		}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		Object[] result1_green = PrimitiveTypeBooleanImpl.pattern_PrimitiveTypeBoolean_29_1_createresult_greenFF();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PRIMITIVE_TYPE_BOOLEAN___IS_APPROPRIATE_BWD_EMOFLON_EDGE_984__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_984((EMoflonEdge) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_BOOLEAN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1007__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_1007((EMoflonEdge) arguments.get(0));
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_0_2_SolveCSP_blackB(CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_0_2_SolveCSP_bindingAndBlackFBBBB(
		...
		if (result_pattern_PrimitiveTypeBoolean_0_2_SolveCSP_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeBoolean_0_2_SolveCSP_black = pattern_PrimitiveTypeBoolean_0_2_SolveCSP_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeBoolean_0_3_CheckCSP_expressionFBB(PrimitiveTypeBoolean _this,
			CSP csp) {
	...
	public static final boolean pattern_PrimitiveTypeBoolean_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_PrimitiveTypeBoolean_0_8_expressionF() {
	...
	public static final PerformRuleResult pattern_PrimitiveTypeBoolean_1_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_bindingFB(
			PrimitiveTypeBoolean _this) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_blackFBB(EClass eClass,
			PrimitiveTypeBoolean _this) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_bindingAndBlackFFB(
			PrimitiveTypeBoolean _this) {
		Object[] result_pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_binding = pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_black = pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_2_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "PrimitiveTypeBoolean";
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_2_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		if (result_pattern_PrimitiveTypeBoolean_2_4_solveCSP_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeBoolean_2_4_solveCSP_black = pattern_PrimitiveTypeBoolean_2_4_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeBoolean_2_5_checkCSP_expressionFBB(PrimitiveTypeBoolean _this,
			CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "PrimitiveTypeBoolean";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_PrimitiveTypeBoolean_2_7_expressionFB(
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_10_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_10_2_SolveCSP_bindingAndBlackFBBBB(
		...
		if (result_pattern_PrimitiveTypeBoolean_10_2_SolveCSP_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeBoolean_10_2_SolveCSP_black = pattern_PrimitiveTypeBoolean_10_2_SolveCSP_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeBoolean_10_3_CheckCSP_expressionFBB(PrimitiveTypeBoolean _this,
			CSP csp) {
	...
	public static final boolean pattern_PrimitiveTypeBoolean_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_PrimitiveTypeBoolean_10_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}
	...
	public static final PerformRuleResult pattern_PrimitiveTypeBoolean_11_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_bindingFB(
			PrimitiveTypeBoolean _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_blackFBB(EClass eClass,
			PrimitiveTypeBoolean _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperation_name = performOperation.getName();
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_bindingAndBlackFFB(
			PrimitiveTypeBoolean _this) {
		Object[] result_pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_binding = pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_binding[0];

			Object[] result_pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_black = pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_12_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "PrimitiveTypeBoolean";
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_12_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_12_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		if (result_pattern_PrimitiveTypeBoolean_12_4_solveCSP_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeBoolean_12_4_solveCSP_black = pattern_PrimitiveTypeBoolean_12_4_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeBoolean_12_5_checkCSP_expressionFBB(PrimitiveTypeBoolean _this,
			CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_12_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_12_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "PrimitiveTypeBoolean";
	...
	public static final IsApplicableRuleResult pattern_PrimitiveTypeBoolean_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_bindingFB(
			PrimitiveTypeBoolean _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_blackFBBF(EClass __eClass,
			PrimitiveTypeBoolean _this) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_bindingAndBlackFFBF(
			PrimitiveTypeBoolean _this) {
		Object[] result_pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_binding = pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_binding[0];

			Object[] result_pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_black = pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_20_1_preparereturnvalue_greenF() {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_20_2_testcorematchandDECs_black_nac_0B(
			PrimitiveType umpt) {
		for (org.eclipse.uml2.uml.Class __DEC_umpt_nestedClassifier_292609 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_20_2_testcorematchandDECs_black_nac_1B(
			PrimitiveType umpt) {
		for (Interface __DEC_umpt_nestedClassifier_980492 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_20_2_testcorematchandDECs_greenFB(EClass __eClass) {
	...
	public static final boolean pattern_PrimitiveTypeBoolean_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			PrimitiveTypeBoolean _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_BWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_20_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_20_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_PrimitiveTypeBoolean_20_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_bindingFB(
			PrimitiveTypeBoolean _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_blackFBBF(EClass __eClass,
			PrimitiveTypeBoolean _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperation_name = __performOperation.getName();
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_bindingAndBlackFFBF(
			PrimitiveTypeBoolean _this) {
		Object[] result_pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_binding = pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_binding[0];

			Object[] result_pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_black = pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_21_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_21_2_testcorematchandDECs_greenFB(EClass __eClass) {
		Match match = RuntimeFactory.eINSTANCE.createMatch();
		String __eClass_name = __eClass.getName();
		String match_ruleName_prime = __eClass_name;
		match.setRuleName(match_ruleName_prime);
	...
	public static final boolean pattern_PrimitiveTypeBoolean_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			PrimitiveTypeBoolean _this, Match match) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_21_5_Addmatchtoruleresult_blackBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		if (!__performOperation.equals(isApplicableCC)) {
			return new Object[] { match, __performOperation, __result, isApplicableCC };
		}
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_21_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
		match.setIsApplicableCCOperation(isApplicableCC);
	...
	public static final EObjectContainer pattern_PrimitiveTypeBoolean_21_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_24_1_prepare_blackB(PrimitiveTypeBoolean _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_24_1_prepare_greenF() {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_24_3_solvecsp_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		if (result_pattern_PrimitiveTypeBoolean_24_3_solvecsp_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeBoolean_24_3_solvecsp_black = pattern_PrimitiveTypeBoolean_24_3_solvecsp_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeBoolean_24_4_checkCSP_expressionFB(CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_24_7_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
	...
	public static final IsApplicableRuleResult pattern_PrimitiveTypeBoolean_24_8_expressionFB(
	...
	public static final boolean pattern_PrimitiveTypeBoolean_27_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_28_1_matchtggpattern_black_nac_0B(PrimitiveType umpt) {
		for (org.eclipse.uml2.uml.Class __DEC_umpt_nestedClassifier_533287 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(umpt, org.eclipse.uml2.uml.Class.class, "nestedClassifier")) {
			return new Object[] { umpt };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_28_1_matchtggpattern_black_nac_1B(PrimitiveType umpt) {
		for (Interface __DEC_umpt_nestedClassifier_289057 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(umpt, Interface.class, "nestedClassifier")) {
			return new Object[] { umpt };
		}
		return null;
	...
	public static final boolean pattern_PrimitiveTypeBoolean_28_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_29_1_createresult_blackB(PrimitiveTypeBoolean _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_PrimitiveTypeBoolean_29_1_createresult_greenFF() {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_29_3_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_PrimitiveTypeBoolean_29_3_solveCSP_bindingAndBlackFBBBBBB(
		...
		if (result_pattern_PrimitiveTypeBoolean_29_3_solveCSP_binding != null) {
			...
			Object[] result_pattern_PrimitiveTypeBoolean_29_3_solveCSP_black = pattern_PrimitiveTypeBoolean_29_3_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_PrimitiveTypeBoolean_29_4_checkCSP_expressionFBB(PrimitiveTypeBoolean _this,
			CSP csp) {
