...
public class VariableDec2Parameter4Impl extends AbstractRuleImpl implements VariableDec2Parameter4 {
	...
	public boolean isAppropriate_FWD(Match match, MSingleVariableDeclaration variableDec,
		...
		Object[] result1_black = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_0_1_initialbindings_blackBBBBBB(this, match, variableDec, method, jType,
						typeAccess);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[variableDec] = " + variableDec + ", " + "[method] = " + method
					+ ", " + "[jType] = " + jType + ", " + "[typeAccess] = " + typeAccess + ".");
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_1_1_performtransformation_greenBBFFBBFB(operation, variableDec,
		...
		Object[] result3_black = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(ruleresult, operation, ne2ne,
						variableDec, ty2p, method, vd2p, jType, typeAccess, uType, md2o, param);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[operation] = " + operation + ", " + "[ne2ne] = " + ne2ne + ", " + "[variableDec] = "
					+ variableDec + ", " + "[ty2p] = " + ty2p + ", " + "[method] = " + method + ", " + "[vd2p] = "
					+ vd2p + ", " + "[jType] = " + jType + ", " + "[typeAccess] = " + typeAccess + ", " + "[uType] = "
					+ uType + ", " + "[md2o] = " + md2o + ", " + "[param] = " + param + ".");
		}
		VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFF(
				ruleresult, operation, variableDec, ty2p, method, vd2p, jType, typeAccess, uType, param);
		...
		VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_1_5_registerobjects_expressionBBBBBBBBBBBBB(this,
				ruleresult, operation, ne2ne, variableDec, ty2p, method, vd2p, jType, typeAccess, uType, md2o, param);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_2_2_corematch_blackFFBBBBFFB(variableDec, method, jType, typeAccess,
						match)) {
			...
			for (Object[] result3_black : VariableDec2Parameter4Impl
					.pattern_VariableDec2Parameter4_2_3_findcontext_blackBBBBBBBB(operation, ne2ne, variableDec, method,
							jType, typeAccess, uType, md2o)) {
				Object[] result3_green = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_2_3_findcontext_greenBBBBBBBBFFFFFFFFFF(operation, ne2ne,
								variableDec, method, jType, typeAccess, uType, md2o);
				...
				Object[] result4_bindingAndBlack = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
								operation, ne2ne, variableDec, method, jType, typeAccess, uType, md2o);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[operation] = " + operation + ", "
							+ "[ne2ne] = " + ne2ne + ", " + "[variableDec] = " + variableDec + ", " + "[method] = "
							+ method + ", " + "[jType] = " + jType + ", " + "[typeAccess] = " + typeAccess + ", "
							+ "[uType] = " + uType + ", " + "[md2o] = " + md2o + ".");
				}
	...
	public CSP isAppropriate_solveCsp_FWD(Match match, MSingleVariableDeclaration variableDec,
			AbstractMethodDeclaration method, Type jType, TypeAccess typeAccess) {// Create CSP
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Operation operation,
			ASTNode2Element ne2ne, MSingleVariableDeclaration variableDec, AbstractMethodDeclaration method, Type jType,
			TypeAccess typeAccess, org.eclipse.uml2.uml.Type uType, ASTNode2Element md2o) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject operation, EObject ne2ne, EObject variableDec,
			EObject ty2p, EObject method, EObject vd2p, EObject jType, EObject typeAccess, EObject uType, EObject md2o,
			EObject param) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_11_1_performtransformation_greenFFBFBFBB(method, jType, param, csp);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : VariableDec2Parameter4Impl
			...
			// ForEach 
			for (Object[] result3_black : VariableDec2Parameter4Impl
					.pattern_VariableDec2Parameter4_12_3_findcontext_blackBBBBBBB(operation, ne2ne, method, jType,
							uType, md2o, param)) {
				Object[] result3_green = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_12_3_findcontext_greenBBBBBBBFFFFFFF(operation, ne2ne, method,
								jType, uType, md2o, param);
				...
				Object[] result4_bindingAndBlack = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								operation, ne2ne, method, jType, uType, md2o, param);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[operation] = " + operation + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Operation operation,
			ASTNode2Element ne2ne, AbstractMethodDeclaration method, Type jType, org.eclipse.uml2.uml.Type uType,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject operation, EObject ne2ne, EObject variableDec,
			EObject ty2p, EObject method, EObject vd2p, EObject jType, EObject typeAccess, EObject uType, EObject md2o,
			EObject param) {
		ruleresult.registerObject("operation", operation);
		ruleresult.registerObject("ne2ne", ne2ne);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_685(EMoflonEdge _edge_ownedParameter) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_735(EMoflonEdge _edge_type) {
		...
		for (Object[] result2_black : VariableDec2Parameter4Impl
			...
			if (VariableDec2Parameter4Impl
					.pattern_VariableDec2Parameter4_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
							this, match, variableDec, method, jType, typeAccess)) {
				// 
				if (VariableDec2Parameter4Impl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		AbstractMethodDeclaration method = (AbstractMethodDeclaration) result2_bindingAndBlack[2];
		...
		Object[] result3_bindingAndBlack = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, operation, variableDec,
						method, jType, typeAccess, uType, param, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[operation] = " + operation + ", " + "[variableDec] = " + variableDec + ", " + "[method] = "
					+ method + ", " + "[jType] = " + jType + ", " + "[typeAccess] = " + typeAccess + ", " + "[uType] = "
					+ uType + ", " + "[param] = " + param + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : VariableDec2Parameter4Impl
					.pattern_VariableDec2Parameter4_24_5_matchcorrcontext_blackBFBBBFBB(operation, method, jType, uType,
				...
				Object[] result6_black = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_24_6_createcorrespondence_blackBBBBBBBB(operation, variableDec,
								method, jType, typeAccess, uType, param, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[operation] = "
							+ operation + ", " + "[variableDec] = " + variableDec + ", " + "[method] = " + method + ", "
	...
	public CSP isApplicable_solveCsp_CC(Operation operation, MSingleVariableDeclaration variableDec,
			AbstractMethodDeclaration method, Type jType, TypeAccess typeAccess, org.eclipse.uml2.uml.Type uType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(MSingleVariableDeclaration variableDec, AbstractMethodDeclaration method, Type jType,
			TypeAccess typeAccess) {// 
		Object[] result1_black = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_27_1_matchtggpattern_blackBBBB(variableDec, method, jType, typeAccess);
		if (result1_black != null) {
		...
		for (Object[] result2_black : VariableDec2Parameter4Impl
			...
			Object[] result3_bindingAndBlack = VariableDec2Parameter4Impl
					.pattern_VariableDec2Parameter4_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							operation, ne2ne, method, jType, uType, md2o, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[operation] = " + operation + ", "
						+ "[ne2ne] = " + ne2ne + ", " + "[method] = " + method + ", " + "[jType] = " + jType + ", "
						+ "[uType] = " + uType + ", " + "[md2o] = " + md2o + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_29_5_checknacs_blackBBBBBB(operation, ne2ne, method, jType,
								uType, md2o);
				if (result5_black != null) {

					Object[] result6_black = VariableDec2Parameter4Impl
							.pattern_VariableDec2Parameter4_29_6_perform_blackBBBBBBB(operation, ne2ne, method, jType,
									uType, md2o, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[operation] = "
								+ operation + ", " + "[ne2ne] = " + ne2ne + ", " + "[method] = " + method + ", "
								+ "[jType] = " + jType + ", " + "[uType] = " + uType + ", " + "[md2o] = " + md2o + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_29_6_perform_greenBFFBFBFBFBB(operation,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPROPRIATE_FWD__MATCH_MSINGLEVARIABLEDECLARATION_ABSTRACTMETHODDECLARATION_TYPE_TYPEACCESS:
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MSINGLEVARIABLEDECLARATION_ABSTRACTMETHODDECLARATION_TYPE_TYPEACCESS:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (MSingleVariableDeclaration) arguments.get(1),
					(AbstractMethodDeclaration) arguments.get(2), (Type) arguments.get(3),
					(TypeAccess) arguments.get(4));
			return null;
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MSINGLEVARIABLEDECLARATION_ABSTRACTMETHODDECLARATION_TYPE_TYPEACCESS:
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_OPERATION_ASTNODE2ELEMENT_MSINGLEVARIABLEDECLARATION_ABSTRACTMETHODDECLARATION_TYPE_TYPEACCESS_TYPE_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Operation) arguments.get(1),
					(ASTNode2Element) arguments.get(2), (MSingleVariableDeclaration) arguments.get(3),
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_OPERATION_ASTNODE2ELEMENT_ABSTRACTMETHODDECLARATION_TYPE_TYPE_ASTNODE2ELEMENT_PARAMETER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Operation) arguments.get(1),
					(ASTNode2Element) arguments.get(2), (AbstractMethodDeclaration) arguments.get(3),
					(Type) arguments.get(4), (org.eclipse.uml2.uml.Type) arguments.get(5),
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPROPRIATE_BWD_EMOFLON_EDGE_685__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_685((EMoflonEdge) arguments.get(0));
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPROPRIATE_FWD_EMOFLON_EDGE_735__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_735((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPLICABLE_SOLVE_CSP_CC__OPERATION_MSINGLEVARIABLEDECLARATION_ABSTRACTMETHODDECLARATION_TYPE_TYPEACCESS_TYPE_PARAMETER_MATCH_MATCH:
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___CHECK_DEC_FWD__MSINGLEVARIABLEDECLARATION_ABSTRACTMETHODDECLARATION_TYPE_TYPEACCESS:
			return checkDEC_FWD((MSingleVariableDeclaration) arguments.get(0),
					(AbstractMethodDeclaration) arguments.get(1), (Type) arguments.get(2),
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_OPERATION_ASTNODE2ELEMENT_ABSTRACTMETHODDECLARATION_TYPE_TYPE_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_VariableDec2Parameter4_0_1_initialbindings_blackBBBBBB(
			...
			AbstractMethodDeclaration method, Type jType, TypeAccess typeAccess) {
		return new Object[] { _this, match, variableDec, method, jType, typeAccess };
	}

	public static final Object[] pattern_VariableDec2Parameter4_0_2_SolveCSP_bindingFBBBBBB(
			VariableDec2Parameter4 _this, Match match, MSingleVariableDeclaration variableDec,
			AbstractMethodDeclaration method, Type jType, TypeAccess typeAccess) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, variableDec, method, jType, typeAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, variableDec, method, jType, typeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_VariableDec2Parameter4_0_2_SolveCSP_binding = pattern_VariableDec2Parameter4_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, variableDec, method, jType, typeAccess);
	...
	public static final Object[] pattern_VariableDec2Parameter4_0_4_collectelementstobetranslated_blackBBBBB(
			Match match, MSingleVariableDeclaration variableDec, AbstractMethodDeclaration method, Type jType,
			TypeAccess typeAccess) {
		return new Object[] { match, variableDec, method, jType, typeAccess };
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_0_4_collectelementstobetranslated_greenBBBBBFFFFF(
		...
		return new Object[] { match, variableDec, method, jType, typeAccess, variableDec__typeAccess____type,
	...
	public static final Object[] pattern_VariableDec2Parameter4_0_5_collectcontextelements_blackBBBBB(Match match,
			MSingleVariableDeclaration variableDec, AbstractMethodDeclaration method, Type jType,
			TypeAccess typeAccess) {
		return new Object[] { match, variableDec, method, jType, typeAccess };
	}
	...
	public static final void pattern_VariableDec2Parameter4_0_6_registerobjectstomatch_expressionBBBBBB(
			VariableDec2Parameter4 _this, Match match, MSingleVariableDeclaration variableDec,
			AbstractMethodDeclaration method, Type jType, TypeAccess typeAccess) {
		_this.registerObjectsToMatch_FWD(match, variableDec, method, jType, typeAccess);
							...
							if (tmpTypeAccess instanceof TypeAccess) {
								...
								if (tmpUType instanceof org.eclipse.uml2.uml.Type) {
									...
									if (tmpMd2o instanceof ASTNode2Element) {
										...
										return new Object[] { operation, ne2ne, variableDec, method, jType, typeAccess,
												uType, md2o, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_1_performtransformation_blackBBBBBBBBFBB(
			Operation operation, ASTNode2Element ne2ne, MSingleVariableDeclaration variableDec,
			AbstractMethodDeclaration method, Type jType, TypeAccess typeAccess, org.eclipse.uml2.uml.Type uType,
		...
		if (!md2o.equals(ne2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { operation, ne2ne, variableDec, method, jType, typeAccess, uType, md2o, csp,
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_VariableDec2Parameter4_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_VariableDec2Parameter4_1_1_performtransformation_black = pattern_VariableDec2Parameter4_1_1_performtransformation_blackBBBBBBBBFBB(
					operation, ne2ne, variableDec, method, jType, typeAccess, uType, md2o, _this, isApplicableMatch);
			if (result_pattern_VariableDec2Parameter4_1_1_performtransformation_black != null) {
				...
				return new Object[] { operation, ne2ne, variableDec, method, jType, typeAccess, uType, md2o, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_1_performtransformation_greenBBFFBBFB(
			Operation operation, MSingleVariableDeclaration variableDec, TypeAccess typeAccess,
		...
		return new Object[] { operation, variableDec, ty2p, vd2p, typeAccess, uType, param, csp };
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject operation, EObject ne2ne, EObject variableDec, EObject ty2p,
			EObject method, EObject vd2p, EObject jType, EObject typeAccess, EObject uType, EObject md2o,
			EObject param) {
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject operation, EObject variableDec, EObject ty2p, EObject method,
			EObject vd2p, EObject jType, EObject typeAccess, EObject uType, EObject param) {
		...
		return new Object[] { ruleresult, operation, variableDec, ty2p, method, vd2p, jType, typeAccess, uType, param,
				operation__param____ownedParameter, variableDec__typeAccess____type, method__variableDec____parameters,
				variableDec__method____methodDeclaration, vd2p__variableDec____source, typeAccess__jType____type,
				jType__typeAccess____usagesInTypeAccess, ty2p__typeAccess____source, vd2p__param____target,
				ty2p__param____target, param__uType____type };
	}

	public static final void pattern_VariableDec2Parameter4_1_5_registerobjects_expressionBBBBBBBBBBBBB(
			VariableDec2Parameter4 _this, PerformRuleResult ruleresult, EObject operation, EObject ne2ne,
			EObject variableDec, EObject ty2p, EObject method, EObject vd2p, EObject jType, EObject typeAccess,
			EObject uType, EObject md2o, EObject param) {
		_this.registerObjects_FWD(ruleresult, operation, ne2ne, variableDec, ty2p, method, vd2p, jType, typeAccess,
				uType, md2o, param);
		...
		if (tmpVariableDec instanceof MSingleVariableDeclaration) {
			...
			if (tmpMethod instanceof AbstractMethodDeclaration) {
				...
				if (tmpJType instanceof Type) {
					...
					if (tmpTypeAccess instanceof TypeAccess) {
						TypeAccess typeAccess = (TypeAccess) tmpTypeAccess;
						return new Object[] { variableDec, method, jType, typeAccess, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_VariableDec2Parameter4_2_2_corematch_blackFFBBBBFFB(
			MSingleVariableDeclaration variableDec, AbstractMethodDeclaration method, Type jType, TypeAccess typeAccess,
			Match match) {
			...
			if (tmpUType instanceof org.eclipse.uml2.uml.Type) {
				...
				for (ASTNode2Element md2o : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(method,
					...
					if (!md2o.equals(ne2ne)) {
						...
						if (tmpOperation instanceof Operation) {
							Operation operation = (Operation) tmpOperation;
							_result.add(new Object[] { operation, ne2ne, variableDec, method, jType, typeAccess, uType,
									md2o, match });
						}
							...
							if (operation.equals(md2o.getTarget())) {
								if (uType.equals(ne2ne.getTarget())) {
									if (method.equals(md2o.getSource())) {
										_result.add(new Object[] { operation, ne2ne, variableDec, method, jType,
												typeAccess, uType, md2o });
									}
								}
							}
						}
	...
	public static final Object[] pattern_VariableDec2Parameter4_2_3_findcontext_greenBBBBBBBBFFFFFFFFFF(
		...
		return new Object[] { operation, ne2ne, variableDec, method, jType, typeAccess, uType, md2o, isApplicableMatch,
				variableDec__typeAccess____type, method__variableDec____parameters,
				variableDec__method____methodDeclaration, ne2ne__jType____source, typeAccess__jType____type,
				jType__typeAccess____usagesInTypeAccess, md2o__operation____target, ne2ne__uType____target,
				md2o__method____source };
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_2_4_solveCSP_bindingFBBBBBBBBBB(
			...
			ASTNode2Element ne2ne, MSingleVariableDeclaration variableDec, AbstractMethodDeclaration method, Type jType,
			TypeAccess typeAccess, org.eclipse.uml2.uml.Type uType, ASTNode2Element md2o) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, operation, ne2ne, variableDec, method,
				jType, typeAccess, uType, md2o);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, operation, ne2ne, variableDec, method, jType,
					typeAccess, uType, md2o };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_VariableDec2Parameter4_2_4_solveCSP_binding = pattern_VariableDec2Parameter4_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, operation, ne2ne, variableDec, method, jType, typeAccess, uType, md2o);
						...
						if (tmpUType instanceof org.eclipse.uml2.uml.Type) {
							...
							if (tmpMd2o instanceof ASTNode2Element) {
								...
								if (tmpParam instanceof Parameter) {
									...
									return new Object[] { operation, ne2ne, method, jType, uType, md2o, param,
											isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_VariableDec2Parameter4_11_1_performtransformation_blackBBBBBBBFBB(
			Operation operation, ASTNode2Element ne2ne, AbstractMethodDeclaration method, Type jType,
		...
		if (!md2o.equals(ne2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { operation, ne2ne, method, jType, uType, md2o, param, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_VariableDec2Parameter4_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_VariableDec2Parameter4_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_VariableDec2Parameter4_11_1_performtransformation_black = pattern_VariableDec2Parameter4_11_1_performtransformation_blackBBBBBBBFBB(
					operation, ne2ne, method, jType, uType, md2o, param, _this, isApplicableMatch);
	...
	public static final Object[] pattern_VariableDec2Parameter4_11_1_performtransformation_greenFFBFBFBB(
		...
		return new Object[] { variableDec, ty2p, method, vd2p, jType, typeAccess, param, csp };
	}
	...
	public static final void pattern_VariableDec2Parameter4_11_5_registerobjects_expressionBBBBBBBBBBBBB(
			...
			EObject variableDec, EObject ty2p, EObject method, EObject vd2p, EObject jType, EObject typeAccess,
			EObject uType, EObject md2o, EObject param) {
		_this.registerObjects_BWD(ruleresult, operation, ne2ne, variableDec, ty2p, method, vd2p, jType, typeAccess,
				uType, md2o, param);
			...
			if (tmpMethod instanceof AbstractMethodDeclaration) {
				...
				for (ASTNode2Element ne2ne : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(uType,
					...
					if (!md2o.equals(ne2ne)) {
						...
						if (tmpJType instanceof Type) {
							Type jType = (Type) tmpJType;
							_result.add(new Object[] { operation, ne2ne, method, jType, uType, md2o, param, match });
						}
				...
				if (jType.equals(ne2ne.getSource())) {
					if (operation.equals(md2o.getTarget())) {
						if (uType.equals(param.getType())) {
							if (uType.equals(ne2ne.getTarget())) {
								if (method.equals(md2o.getSource())) {
									_result.add(new Object[] { operation, ne2ne, method, jType, uType, md2o, param });
								}
							}
						}
					}
	...
	public static final Object[] pattern_VariableDec2Parameter4_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		ne2ne__uType____target.setName(ne2ne__uType____target_name_prime);
		md2o__method____source.setName(md2o__method____source_name_prime);
		return new Object[] { operation, ne2ne, method, jType, uType, md2o, param, isApplicableMatch,
				operation__param____ownedParameter, ne2ne__jType____source, md2o__operation____target,
	...
	public static final Object[] pattern_VariableDec2Parameter4_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, operation, ne2ne, method, jType,
				uType, md2o, param);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, operation, ne2ne, method, jType, uType, md2o, param };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_VariableDec2Parameter4_12_4_solveCSP_binding = pattern_VariableDec2Parameter4_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, operation, ne2ne, method, jType, uType, md2o, param);
		if (result_pattern_VariableDec2Parameter4_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_VariableDec2Parameter4_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, operation, ne2ne, method, jType, uType, md2o,
						param };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_typeAccess_superInterfaces_490539 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!jType.equals(__DEC_typeAccess_superInterfaces_490539)) {
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess typeAccess) {
		for (Annotation __DEC_typeAccess_type_142425 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_2BB(
			TypeAccess typeAccess, Type jType) {
		for (ArrayType __DEC_typeAccess_elementType_915682 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ArrayType.class, "elementType")) {
			if (!jType.equals(__DEC_typeAccess_elementType_915682)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_3BB(
			TypeAccess typeAccess, Type jType) {
		for (ClassDeclaration __DEC_typeAccess_superClass_234057 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ClassDeclaration.class, "superClass")) {
			if (!jType.equals(__DEC_typeAccess_superClass_234057)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_4BB(
		...
		for (MethodDeclaration __DEC_typeAccess_returnType_516829 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, MethodDeclaration.class, "returnType")) {
			if (!method.equals(__DEC_typeAccess_returnType_516829)) {
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess typeAccess, Type jType) {
		for (ParameterizedType __DEC_typeAccess_type_469632 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ParameterizedType.class, "type")) {
			if (!jType.equals(__DEC_typeAccess_type_469632)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAccess) {
		for (AnnotationMemberValuePair __DEC_typeAccess_value_942167 : org.moflon.core.utilities.eMoflonEMFUtil
											...
											if (pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_2BB(
												...
												if (pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_3BB(
													...
													if (pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_5BB(
															typeAccess, jType) == null) {
														_result.add(new Object[] { variableDec, method, jType,
	...
	public static final boolean pattern_VariableDec2Parameter4_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			VariableDec2Parameter4 _this, Match match, MSingleVariableDeclaration variableDec,
			AbstractMethodDeclaration method, Type jType, TypeAccess typeAccess) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, variableDec, method, jType, typeAccess);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
					...
					if (tmpJType instanceof Type) {
						...
						if (tmpTypeAccess instanceof TypeAccess) {
							...
							if (tmpUType instanceof org.eclipse.uml2.uml.Type) {
								...
								if (tmpParam instanceof Parameter) {
									Parameter param = (Parameter) tmpParam;
									return new Object[] { operation, variableDec, method, jType, typeAccess, uType,
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			Operation operation, MSingleVariableDeclaration variableDec, AbstractMethodDeclaration method, Type jType,
			TypeAccess typeAccess, org.eclipse.uml2.uml.Type uType, Parameter param, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { operation, variableDec, method, jType, typeAccess, uType, param, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_binding != null) {
			...
			AbstractMethodDeclaration method = (AbstractMethodDeclaration) result_pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_binding[2];
			...
			Object[] result_pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_black = pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					operation, variableDec, method, jType, typeAccess, uType, param, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_3_solvecsp_bindingFBBBBBBBBBB(
		...
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(operation, variableDec, method, jType, typeAccess, uType,
				param, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, operation, variableDec, method, jType, typeAccess, uType, param,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_VariableDec2Parameter4_24_3_solvecsp_binding = pattern_VariableDec2Parameter4_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, operation, variableDec, method, jType, typeAccess, uType, param, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_VariableDec2Parameter4_24_5_matchcorrcontext_blackBFBBBFBB(
			Operation operation, AbstractMethodDeclaration method, Type jType, org.eclipse.uml2.uml.Type uType,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (ASTNode2Element ne2ne : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(jType,
				...
				if (uType.equals(ne2ne.getTarget())) {
					for (ASTNode2Element md2o : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!md2o.equals(ne2ne)) {
							if (method.equals(md2o.getSource())) {
								_result.add(new Object[] { operation, ne2ne, method, jType, uType, md2o, sourceMatch,
										targetMatch });
							}
						}
					}
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_6_createcorrespondence_blackBBBBBBBB(
		...
		return new Object[] { operation, variableDec, method, jType, typeAccess, uType, param, ccMatch };
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_0BB(
			TypeAccess typeAccess, Type jType) {
		for (AbstractTypeDeclaration __DEC_typeAccess_superInterfaces_544249 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!jType.equals(__DEC_typeAccess_superInterfaces_544249)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAccess) {
		for (Annotation __DEC_typeAccess_type_986660 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, Annotation.class, "type")) {
			return new Object[] { typeAccess };
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess typeAccess, Type jType) {
		for (ArrayType __DEC_typeAccess_elementType_999041 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ArrayType.class, "elementType")) {
			if (!jType.equals(__DEC_typeAccess_elementType_999041)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_3BB(
			TypeAccess typeAccess, Type jType) {
		for (ClassDeclaration __DEC_typeAccess_superClass_21330 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ClassDeclaration.class, "superClass")) {
			if (!jType.equals(__DEC_typeAccess_superClass_21330)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_4BB(
			TypeAccess typeAccess, AbstractMethodDeclaration method) {
		for (MethodDeclaration __DEC_typeAccess_returnType_502155 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, MethodDeclaration.class, "returnType")) {
			if (!method.equals(__DEC_typeAccess_returnType_502155)) {
				return new Object[] { typeAccess, method };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_5BB(
			TypeAccess typeAccess, Type jType) {
		for (ParameterizedType __DEC_typeAccess_type_866626 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ParameterizedType.class, "type")) {
			if (!jType.equals(__DEC_typeAccess_type_866626)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAccess) {
		for (AnnotationMemberValuePair __DEC_typeAccess_value_450873 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAccess };
		}
		return null;
									...
									if (pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_4BB(typeAccess,
										...
										if (pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_5BB(
											...
											if (pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_6B(
													typeAccess) == null) {
												return new Object[] { variableDec, method, jType, typeAccess };
											}
										}
									}
								}
	...
	public static final Object[] pattern_VariableDec2Parameter4_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, operation, ne2ne, method, jType,
				uType, md2o, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, operation, ne2ne, method, jType, uType, md2o,
	...
	public static final Object[] pattern_VariableDec2Parameter4_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_VariableDec2Parameter4_29_3_solveCSP_binding = pattern_VariableDec2Parameter4_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, operation, ne2ne, method, jType, uType, md2o, ruleResult);
	...
	public static final Object[] pattern_VariableDec2Parameter4_29_5_checknacs_blackBBBBBB(Operation operation,
			...
			ASTNode2Element md2o) {
		if (!md2o.equals(ne2ne)) {
			return new Object[] { operation, ne2ne, method, jType, uType, md2o };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_29_6_perform_blackBBBBBBB(Operation operation,
			...
			ASTNode2Element md2o, ModelgeneratorRuleResult ruleResult) {
		if (!md2o.equals(ne2ne)) {
			return new Object[] { operation, ne2ne, method, jType, uType, md2o, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_VariableDec2Parameter4_29_6_perform_greenBFFBFBFBFBB(Operation operation,
			AbstractMethodDeclaration method, Type jType, org.eclipse.uml2.uml.Type uType,
		...
		return new Object[] { operation, variableDec, ty2p, method, vd2p, jType, typeAccess, uType, param, ruleResult,
				csp };
	}
