...
public class VariableDec2Parameter4Impl extends AbstractRuleImpl implements VariableDec2Parameter4 {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_1_1_performtransformation_greenBBBFFBFB(operation, typeAccess, uType,
						variableDec, csp);
		...
		Object[] result2_black = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_1_2_collecttranslatedelements_blackBBBBB(typeAccess, vd2p, param,
						variableDec, ty2p);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[typeAccess] = " + typeAccess
					+ ", " + "[vd2p] = " + vd2p + ", " + "[param] = " + param + ", " + "[variableDec] = " + variableDec
					+ ", " + "[ty2p] = " + ty2p + ".");
		}
		Object[] result2_green = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_1_2_collecttranslatedelements_greenFBBBBB(typeAccess, vd2p, param,
						variableDec, ty2p);
		...
		Object[] result3_black = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(ruleresult, operation,
						typeAccess, method, uType, vd2p, md2o, param, variableDec, ty2p, ne2ne, jType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[operation] = " + operation + ", " + "[typeAccess] = " + typeAccess + ", " + "[method] = "
					+ method + ", " + "[uType] = " + uType + ", " + "[vd2p] = " + vd2p + ", " + "[md2o] = " + md2o
					+ ", " + "[param] = " + param + ", " + "[variableDec] = " + variableDec + ", " + "[ty2p] = " + ty2p
					+ ", " + "[ne2ne] = " + ne2ne + ", " + "[jType] = " + jType + ".");
		}
		VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFF(
				ruleresult, operation, typeAccess, method, uType, vd2p, param, variableDec, ty2p, jType);
		...
		//nothing EMoflonEdge ty2p__param____target = (EMoflonEdge) result3_green[14];
		...
		VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_1_5_registerobjects_expressionBBBBBBBBBBBBB(this,
				ruleresult, operation, typeAccess, method, uType, vd2p, md2o, param, variableDec, ty2p, ne2ne, jType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_2_2_corematch_blackFBBFFBFBB(typeAccess, method, variableDec, jType,
						match)) {
			...
			for (Object[] result3_black : VariableDec2Parameter4Impl
					.pattern_VariableDec2Parameter4_2_3_findcontext_blackBBBBBBBB(operation, typeAccess, method, uType,
							md2o, variableDec, ne2ne, jType)) {
				Object[] result3_green = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_2_3_findcontext_greenBBBBBBBBFFFFFFFFFF(operation, typeAccess,
								method, uType, md2o, variableDec, ne2ne, jType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Operation operation,
			TypeAccess typeAccess, AbstractMethodDeclaration method, org.eclipse.uml2.uml.Type uType,
			ASTNode2Element md2o, MSingleVariableDeclaration variableDec, ASTNode2Element ne2ne, Type jType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject operation, EObject typeAccess, EObject method,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		ASTNode2Element md2o = (ASTNode2Element) result1_bindingAndBlack[3];
		...
		Object[] result1_green = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_11_1_performtransformation_greenFBFBFFBB(method, param, jType, csp);
		TypeAccess typeAccess = (TypeAccess) result1_green[0];
		ASTNode2Element vd2p = (ASTNode2Element) result1_green[2];
		MSingleVariableDeclaration variableDec = (MSingleVariableDeclaration) result1_green[4];
		TypeAccess2Parameter ty2p = (TypeAccess2Parameter) result1_green[5];

		Object[] result2_black = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_11_2_collecttranslatedelements_blackBBBBB(typeAccess, vd2p, param,
						variableDec, ty2p);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[typeAccess] = " + typeAccess
					+ ", " + "[vd2p] = " + vd2p + ", " + "[param] = " + param + ", " + "[variableDec] = " + variableDec
		...
		Object[] result2_green = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_11_2_collecttranslatedelements_greenFBBBBB(typeAccess, vd2p, param,
						variableDec, ty2p);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : VariableDec2Parameter4Impl
			...
			ASTNode2Element md2o = (ASTNode2Element) result2_black[3];
			ASTNode2Element ne2ne = (ASTNode2Element) result2_black[5];
			Type jType = (Type) result2_black[6];
			// ForEach 
			for (Object[] result3_black : VariableDec2Parameter4Impl
					.pattern_VariableDec2Parameter4_12_3_findcontext_blackBBBBBBB(operation, method, uType, md2o, param,
							ne2ne, jType)) {
				Object[] result3_green = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_12_3_findcontext_greenBBBBBBBFFFFFFF(operation, method, uType,
								md2o, param, ne2ne, jType);
				...
				Object[] result4_bindingAndBlack = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								operation, method, uType, md2o, param, ne2ne, jType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[operation] = " + operation + ", "
							+ "[method] = " + method + ", " + "[uType] = " + uType + ", " + "[md2o] = " + md2o + ", "
							+ "[param] = " + param + ", " + "[ne2ne] = " + ne2ne + ", " + "[jType] = " + jType + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Operation operation,
			...
			ASTNode2Element ne2ne, Type jType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject operation, EObject typeAccess, EObject method,
			EObject uType, EObject vd2p, EObject md2o, EObject param, EObject variableDec, EObject ty2p, EObject ne2ne,
			EObject jType) {
		ruleresult.registerObject("operation", operation);
		ruleresult.registerObject("typeAccess", typeAccess);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_274(EMoflonEdge _edge_ownedParameter) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_293(EMoflonEdge _edge_type) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = VariableDec2Parameter4Impl
				.pattern_VariableDec2Parameter4_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, operation, typeAccess,
						method, uType, param, variableDec, jType, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[operation] = " + operation + ", " + "[typeAccess] = " + typeAccess + ", " + "[method] = "
					+ method + ", " + "[uType] = " + uType + ", " + "[param] = " + param + ", " + "[variableDec] = "
					+ variableDec + ", " + "[jType] = " + jType + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : VariableDec2Parameter4Impl
					.pattern_VariableDec2Parameter4_24_5_matchcorrcontext_blackBBBFFBBB(operation, method, uType, jType,
				...
				Object[] result6_black = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_24_6_createcorrespondence_blackBBBBBBBB(operation, typeAccess,
								method, uType, param, variableDec, jType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[operation] = "
							+ operation + ", " + "[typeAccess] = " + typeAccess + ", " + "[method] = " + method + ", "
							+ "[uType] = " + uType + ", " + "[param] = " + param + ", " + "[variableDec] = "
							+ variableDec + ", " + "[jType] = " + jType + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Operation operation, TypeAccess typeAccess, AbstractMethodDeclaration method,
		...
		for (Object[] result2_black : VariableDec2Parameter4Impl
			...
			Object[] result3_bindingAndBlack = VariableDec2Parameter4Impl
					.pattern_VariableDec2Parameter4_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							operation, method, uType, md2o, ne2ne, jType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[operation] = " + operation + ", "
						+ "[method] = " + method + ", " + "[uType] = " + uType + ", " + "[md2o] = " + md2o + ", "
						+ "[ne2ne] = " + ne2ne + ", " + "[jType] = " + jType + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = VariableDec2Parameter4Impl
						.pattern_VariableDec2Parameter4_29_5_checknacs_blackBBBBBB(operation, method, uType, md2o,
								ne2ne, jType);
				if (result5_black != null) {

					Object[] result6_black = VariableDec2Parameter4Impl
							.pattern_VariableDec2Parameter4_29_6_perform_blackBBBBBBB(operation, method, uType, md2o,
									ne2ne, jType, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[operation] = "
								+ operation + ", " + "[method] = " + method + ", " + "[uType] = " + uType + ", "
								+ "[md2o] = " + md2o + ", " + "[ne2ne] = " + ne2ne + ", " + "[jType] = " + jType + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					VariableDec2Parameter4Impl.pattern_VariableDec2Parameter4_29_6_perform_greenBFBBFFFFBBB(operation,
							method, uType, jType, ruleResult, csp);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Operation operation,
			...
			ASTNode2Element ne2ne, Type jType, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_OPERATION_TYPEACCESS_ABSTRACTMETHODDECLARATION_TYPE_ASTNODE2ELEMENT_MSINGLEVARIABLEDECLARATION_ASTNODE2ELEMENT_TYPE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Operation) arguments.get(1),
					...
					(MSingleVariableDeclaration) arguments.get(6), (ASTNode2Element) arguments.get(7),
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_OPERATION_ABSTRACTMETHODDECLARATION_TYPE_ASTNODE2ELEMENT_PARAMETER_ASTNODE2ELEMENT_TYPE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Operation) arguments.get(1),
					...
					(ASTNode2Element) arguments.get(4), (Parameter) arguments.get(5),
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPROPRIATE_BWD_EMOFLON_EDGE_274__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_274((EMoflonEdge) arguments.get(0));
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPROPRIATE_FWD_EMOFLON_EDGE_293__EMOFLONEDGE:
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___IS_APPLICABLE_SOLVE_CSP_CC__OPERATION_TYPEACCESS_ABSTRACTMETHODDECLARATION_TYPE_PARAMETER_MSINGLEVARIABLEDECLARATION_TYPE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Operation) arguments.get(0), (TypeAccess) arguments.get(1),
					(AbstractMethodDeclaration) arguments.get(2), (org.eclipse.uml2.uml.Type) arguments.get(3),
					(Parameter) arguments.get(4), (MSingleVariableDeclaration) arguments.get(5),
					(Type) arguments.get(6), (Match) arguments.get(7), (Match) arguments.get(8));
		...
		case RulesPackage.VARIABLE_DEC2_PARAMETER4___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_OPERATION_ABSTRACTMETHODDECLARATION_TYPE_ASTNODE2ELEMENT_ASTNODE2ELEMENT_TYPE_MODELGENERATORRULERESULT:
							...
							if (tmpVariableDec instanceof MSingleVariableDeclaration) {
								...
								if (tmpNe2ne instanceof ASTNode2Element) {
									...
									if (tmpJType instanceof Type) {
										...
										return new Object[] { operation, typeAccess, method, uType, md2o, variableDec,
												ne2ne, jType, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_1_performtransformation_blackBBBBBBBBFBB(
			Operation operation, TypeAccess typeAccess, AbstractMethodDeclaration method,
			org.eclipse.uml2.uml.Type uType, ASTNode2Element md2o, MSingleVariableDeclaration variableDec,
			ASTNode2Element ne2ne, Type jType, VariableDec2Parameter4 _this, IsApplicableMatch isApplicableMatch) {
		if (!md2o.equals(ne2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { operation, typeAccess, method, uType, md2o, variableDec, ne2ne, jType, csp,
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_VariableDec2Parameter4_1_1_performtransformation_binding != null) {
			...
			AbstractMethodDeclaration method = (AbstractMethodDeclaration) result_pattern_VariableDec2Parameter4_1_1_performtransformation_binding[2];
			...
			ASTNode2Element ne2ne = (ASTNode2Element) result_pattern_VariableDec2Parameter4_1_1_performtransformation_binding[6];
			...
			Object[] result_pattern_VariableDec2Parameter4_1_1_performtransformation_black = pattern_VariableDec2Parameter4_1_1_performtransformation_blackBBBBBBBBFBB(
					operation, typeAccess, method, uType, md2o, variableDec, ne2ne, jType, _this, isApplicableMatch);
			if (result_pattern_VariableDec2Parameter4_1_1_performtransformation_black != null) {
				...
				return new Object[] { operation, typeAccess, method, uType, md2o, variableDec, ne2ne, jType, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_1_performtransformation_greenBBBFFBFB(
		...
		return new Object[] { operation, typeAccess, uType, vd2p, param, variableDec, ty2p, csp };
	}

	public static final Object[] pattern_VariableDec2Parameter4_1_2_collecttranslatedelements_blackBBBBB(
			TypeAccess typeAccess, ASTNode2Element vd2p, Parameter param, MSingleVariableDeclaration variableDec,
			TypeAccess2Parameter ty2p) {
		return new Object[] { typeAccess, vd2p, param, variableDec, ty2p };
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, typeAccess, vd2p, param, variableDec, ty2p };
	}

	public static final Object[] pattern_VariableDec2Parameter4_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject operation, EObject typeAccess, EObject method, EObject uType,
			EObject vd2p, EObject md2o, EObject param, EObject variableDec, EObject ty2p, EObject ne2ne,
			EObject jType) {
	...
	public static final Object[] pattern_VariableDec2Parameter4_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject operation, EObject typeAccess, EObject method, EObject uType,
			EObject vd2p, EObject param, EObject variableDec, EObject ty2p, EObject jType) {
		EMoflonEdge typeAccess__jType____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge jType__typeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		method__variableDec____parameters.setName(method__variableDec____parameters_name_prime);
		variableDec__method____methodDeclaration.setName(variableDec__method____methodDeclaration_name_prime);
		return new Object[] { ruleresult, operation, typeAccess, method, uType, vd2p, param, variableDec, ty2p, jType,
				typeAccess__jType____type, jType__typeAccess____usagesInTypeAccess, operation__param____ownedParameter,
				vd2p__param____target, ty2p__param____target, ty2p__typeAccess____source, param__uType____type,
				variableDec__typeAccess____type, vd2p__variableDec____source, method__variableDec____parameters,
	...
	public static final void pattern_VariableDec2Parameter4_1_5_registerobjects_expressionBBBBBBBBBBBBB(
			VariableDec2Parameter4 _this, PerformRuleResult ruleresult, EObject operation, EObject typeAccess,
			EObject method, EObject uType, EObject vd2p, EObject md2o, EObject param, EObject variableDec, EObject ty2p,
			EObject ne2ne, EObject jType) {
		_this.registerObjects_FWD(ruleresult, operation, typeAccess, method, uType, vd2p, md2o, param, variableDec,
				ty2p, ne2ne, jType);
	...
	public static final Iterable<Object[]> pattern_VariableDec2Parameter4_2_2_corematch_blackFBBFFBFBB(
			...
			if (tmpOperation instanceof Operation) {
				...
				for (ASTNode2Element ne2ne : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(jType,
					...
					if (!md2o.equals(ne2ne)) {
						...
						if (tmpUType instanceof org.eclipse.uml2.uml.Type) {
							org.eclipse.uml2.uml.Type uType = (org.eclipse.uml2.uml.Type) tmpUType;
							_result.add(new Object[] { operation, typeAccess, method, uType, md2o, variableDec, ne2ne,
									jType, match });
						}
							...
							if (method.getParameters().contains(variableDec)) {
								if (uType.equals(ne2ne.getTarget())) {
									if (jType.equals(ne2ne.getSource())) {
										_result.add(new Object[] { operation, typeAccess, method, uType, md2o,
												variableDec, ne2ne, jType });
									}
								}
							}
						}
	...
	public static final Object[] pattern_VariableDec2Parameter4_2_3_findcontext_greenBBBBBBBBFFFFFFFFFF(
		...
		return new Object[] { operation, typeAccess, method, uType, md2o, variableDec, ne2ne, jType, isApplicableMatch,
				typeAccess__jType____type, jType__typeAccess____usagesInTypeAccess, md2o__method____source,
				md2o__operation____target, variableDec__typeAccess____type, method__variableDec____parameters,
				variableDec__method____methodDeclaration, ne2ne__uType____target, ne2ne__jType____source };
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_2_4_solveCSP_bindingFBBBBBBBBBB(
			...
			TypeAccess typeAccess, AbstractMethodDeclaration method, org.eclipse.uml2.uml.Type uType,
			ASTNode2Element md2o, MSingleVariableDeclaration variableDec, ASTNode2Element ne2ne, Type jType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, operation, typeAccess, method, uType,
				md2o, variableDec, ne2ne, jType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, operation, typeAccess, method, uType, md2o,
					variableDec, ne2ne, jType };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_VariableDec2Parameter4_2_4_solveCSP_binding = pattern_VariableDec2Parameter4_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, operation, typeAccess, method, uType, md2o, variableDec, ne2ne, jType);
					...
					if (tmpMd2o instanceof ASTNode2Element) {
						...
						if (tmpParam instanceof Parameter) {
							...
							if (tmpNe2ne instanceof ASTNode2Element) {
								...
								if (tmpJType instanceof Type) {
									Type jType = (Type) tmpJType;
									return new Object[] { operation, method, uType, md2o, param, ne2ne, jType,
											isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_VariableDec2Parameter4_11_1_performtransformation_blackBBBBBBBFBB(
			...
			ASTNode2Element md2o, Parameter param, ASTNode2Element ne2ne, Type jType, VariableDec2Parameter4 _this,
			IsApplicableMatch isApplicableMatch) {
		if (!md2o.equals(ne2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { operation, method, uType, md2o, param, ne2ne, jType, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_VariableDec2Parameter4_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_VariableDec2Parameter4_11_1_performtransformation_binding != null) {
			...
			AbstractMethodDeclaration method = (AbstractMethodDeclaration) result_pattern_VariableDec2Parameter4_11_1_performtransformation_binding[1];
			...
			ASTNode2Element md2o = (ASTNode2Element) result_pattern_VariableDec2Parameter4_11_1_performtransformation_binding[3];
			...
			Type jType = (Type) result_pattern_VariableDec2Parameter4_11_1_performtransformation_binding[6];
			...
			Object[] result_pattern_VariableDec2Parameter4_11_1_performtransformation_black = pattern_VariableDec2Parameter4_11_1_performtransformation_blackBBBBBBBFBB(
					operation, method, uType, md2o, param, ne2ne, jType, _this, isApplicableMatch);
	...
	public static final Object[] pattern_VariableDec2Parameter4_11_1_performtransformation_greenFBFBFFBB(
		...
		return new Object[] { typeAccess, method, vd2p, param, variableDec, ty2p, jType, csp };
	}
	...
	public static final void pattern_VariableDec2Parameter4_11_5_registerobjects_expressionBBBBBBBBBBBBB(
			...
			EObject method, EObject uType, EObject vd2p, EObject md2o, EObject param, EObject variableDec, EObject ty2p,
			EObject ne2ne, EObject jType) {
		_this.registerObjects_BWD(ruleresult, operation, typeAccess, method, uType, vd2p, md2o, param, variableDec,
				ty2p, ne2ne, jType);
			...
			if (tmpMethod instanceof AbstractMethodDeclaration) {
				...
				for (ASTNode2Element ne2ne : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(uType,
					...
					if (!md2o.equals(ne2ne)) {
						...
						if (tmpJType instanceof Type) {
							Type jType = (Type) tmpJType;
							_result.add(new Object[] { operation, method, uType, md2o, param, ne2ne, jType, match });
						}
	...
	public static final Iterable<Object[]> pattern_VariableDec2Parameter4_12_3_findcontext_blackBBBBBBB(
			Operation operation, AbstractMethodDeclaration method, org.eclipse.uml2.uml.Type uType,
			ASTNode2Element md2o, Parameter param, ASTNode2Element ne2ne, Type jType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!md2o.equals(ne2ne)) {
				...
				if (method.equals(md2o.getSource())) {
					if (operation.equals(md2o.getTarget())) {
						if (uType.equals(param.getType())) {
							if (uType.equals(ne2ne.getTarget())) {
								if (jType.equals(ne2ne.getSource())) {
									_result.add(new Object[] { operation, method, uType, md2o, param, ne2ne, jType });
								}
							}
						}
					}
	...
	public static final Object[] pattern_VariableDec2Parameter4_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		ne2ne__uType____target.setName(ne2ne__uType____target_name_prime);
		ne2ne__jType____source.setName(ne2ne__jType____source_name_prime);
		return new Object[] { operation, method, uType, md2o, param, ne2ne, jType, isApplicableMatch,
	...
	public static final Object[] pattern_VariableDec2Parameter4_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			AbstractMethodDeclaration method, org.eclipse.uml2.uml.Type uType, ASTNode2Element md2o, Parameter param,
			ASTNode2Element ne2ne, Type jType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, operation, method, uType, md2o, param,
				ne2ne, jType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, operation, method, uType, md2o, param, ne2ne, jType };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_VariableDec2Parameter4_12_4_solveCSP_binding = pattern_VariableDec2Parameter4_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, operation, method, uType, md2o, param, ne2ne, jType);
		if (result_pattern_VariableDec2Parameter4_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_VariableDec2Parameter4_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, operation, method, uType, md2o, param, ne2ne,
						jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_typeAccess_superInterfaces_509815 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!jType.equals(__DEC_typeAccess_superInterfaces_509815)) {
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_typeAccess_type_187295 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_2BB(
			TypeAccess typeAccess, Type jType) {
		for (ArrayType __DEC_typeAccess_elementType_605197 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ArrayType.class, "elementType")) {
			if (!jType.equals(__DEC_typeAccess_elementType_605197)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_3BB(
			TypeAccess typeAccess, Type jType) {
		for (ClassDeclaration __DEC_typeAccess_superClass_168774 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ClassDeclaration.class, "superClass")) {
			if (!jType.equals(__DEC_typeAccess_superClass_168774)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_4BB(
		...
		for (MethodDeclaration __DEC_typeAccess_returnType_867920 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, MethodDeclaration.class, "returnType")) {
			if (!method.equals(__DEC_typeAccess_returnType_867920)) {
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess typeAccess, Type jType) {
		for (ParameterizedType __DEC_typeAccess_type_299676 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ParameterizedType.class, "type")) {
			if (!jType.equals(__DEC_typeAccess_type_299676)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAccess) {
		for (AnnotationMemberValuePair __DEC_typeAccess_value_697767 : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpUType instanceof org.eclipse.uml2.uml.Type) {
						...
						if (tmpParam instanceof Parameter) {
							...
							if (tmpVariableDec instanceof MSingleVariableDeclaration) {
								...
								if (tmpJType instanceof Type) {
									Type jType = (Type) tmpJType;
									return new Object[] { operation, typeAccess, method, uType, param, variableDec,
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_blackBBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { operation, typeAccess, method, uType, param, variableDec, jType, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_black = pattern_VariableDec2Parameter4_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					operation, typeAccess, method, uType, param, variableDec, jType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_3_solvecsp_bindingFBBBBBBBBBB(
			VariableDec2Parameter4 _this, Operation operation, TypeAccess typeAccess, AbstractMethodDeclaration method,
			org.eclipse.uml2.uml.Type uType, Parameter param, MSingleVariableDeclaration variableDec, Type jType,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(operation, typeAccess, method, uType, param, variableDec,
				jType, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, operation, typeAccess, method, uType, param, variableDec, jType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_VariableDec2Parameter4_24_3_solvecsp_binding = pattern_VariableDec2Parameter4_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, operation, typeAccess, method, uType, param, variableDec, jType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_VariableDec2Parameter4_24_5_matchcorrcontext_blackBBBFFBBB(
			Operation operation, AbstractMethodDeclaration method, org.eclipse.uml2.uml.Type uType, Type jType,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (ASTNode2Element md2o : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(method,
				...
				if (operation.equals(md2o.getTarget())) {
					for (ASTNode2Element ne2ne : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!md2o.equals(ne2ne)) {
							if (jType.equals(ne2ne.getSource())) {
								_result.add(new Object[] { operation, method, uType, md2o, ne2ne, jType, sourceMatch,
										targetMatch });
							}
						}
					}
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_6_createcorrespondence_blackBBBBBBBB(
			...
			org.eclipse.uml2.uml.Type uType, Parameter param, MSingleVariableDeclaration variableDec, Type jType,
			CCMatch ccMatch) {
		return new Object[] { operation, typeAccess, method, uType, param, variableDec, jType, ccMatch };
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_24_6_createcorrespondence_greenBFBBFB(
		...
		return new Object[] { typeAccess, vd2p, param, variableDec, ty2p, ccMatch };
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_0BB(
			TypeAccess typeAccess, Type jType) {
		for (AbstractTypeDeclaration __DEC_typeAccess_superInterfaces_874063 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!jType.equals(__DEC_typeAccess_superInterfaces_874063)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAccess) {
		for (Annotation __DEC_typeAccess_type_280834 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, Annotation.class, "type")) {
			return new Object[] { typeAccess };
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess typeAccess, Type jType) {
		for (ArrayType __DEC_typeAccess_elementType_887684 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ArrayType.class, "elementType")) {
			if (!jType.equals(__DEC_typeAccess_elementType_887684)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_3BB(
			TypeAccess typeAccess, Type jType) {
		for (ClassDeclaration __DEC_typeAccess_superClass_486654 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ClassDeclaration.class, "superClass")) {
			if (!jType.equals(__DEC_typeAccess_superClass_486654)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_4BB(
			TypeAccess typeAccess, AbstractMethodDeclaration method) {
		for (MethodDeclaration __DEC_typeAccess_returnType_321430 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, MethodDeclaration.class, "returnType")) {
			if (!method.equals(__DEC_typeAccess_returnType_321430)) {
				return new Object[] { typeAccess, method };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_5BB(
			TypeAccess typeAccess, Type jType) {
		for (ParameterizedType __DEC_typeAccess_type_209343 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ParameterizedType.class, "type")) {
			if (!jType.equals(__DEC_typeAccess_type_209343)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAccess) {
		for (AnnotationMemberValuePair __DEC_typeAccess_value_657718 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAccess };
		}
		return null;
	...
	public static final Object[] pattern_VariableDec2Parameter4_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, operation, method, uType, md2o,
				ne2ne, jType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, operation, method, uType, md2o, ne2ne, jType,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_VariableDec2Parameter4_29_3_solveCSP_binding = pattern_VariableDec2Parameter4_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, operation, method, uType, md2o, ne2ne, jType, ruleResult);
	...
	public static final Object[] pattern_VariableDec2Parameter4_29_5_checknacs_blackBBBBBB(Operation operation,
			...
			ASTNode2Element ne2ne, Type jType) {
		if (!md2o.equals(ne2ne)) {
			return new Object[] { operation, method, uType, md2o, ne2ne, jType };
		}
		return null;
	}
	...
	public static final Object[] pattern_VariableDec2Parameter4_29_6_perform_blackBBBBBBB(Operation operation,
			...
			ASTNode2Element ne2ne, Type jType, ModelgeneratorRuleResult ruleResult) {
		if (!md2o.equals(ne2ne)) {
			return new Object[] { operation, method, uType, md2o, ne2ne, jType, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_VariableDec2Parameter4_29_6_perform_greenBFBBFFFFBBB(Operation operation,
			AbstractMethodDeclaration method, org.eclipse.uml2.uml.Type uType, Type jType,
		...
		return new Object[] { operation, typeAccess, method, uType, vd2p, param, variableDec, ty2p, jType, ruleResult,
				csp };
	}
