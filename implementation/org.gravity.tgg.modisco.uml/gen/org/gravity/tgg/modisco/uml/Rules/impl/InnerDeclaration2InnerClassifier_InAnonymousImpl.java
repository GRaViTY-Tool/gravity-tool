...
public class InnerDeclaration2InnerClassifier_InAnonymousImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InnerDeclaration2InnerClassifier_InAnonymousImpl
				.pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[b2e] = " + b2e + ", " + "[jContainer] = " + jContainer + ", " + "[bodyDeclaration] = "
					+ bodyDeclaration + ", " + "[feature] = " + feature + ", " + "[uContainer] = " + uContainer + ", "
					+ "[ne2ne] = " + ne2ne + ".");
		}
		InnerDeclaration2InnerClassifier_InAnonymousImpl
				.pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_3_bookkeepingforedges_greenBBBBBFFF(ruleresult,
						jContainer, bodyDeclaration, feature, uContainer);
		...
		InnerDeclaration2InnerClassifier_InAnonymousImpl
				.pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_5_registerobjects_expressionBBBBBBBB(this,
						ruleresult, b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne);
		return InnerDeclaration2InnerClassifier_InAnonymousImpl
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
				.pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_2_corematch_blackFBBFFFB(jContainer,
			...
			for (Object[] result3_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
					.pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_3_findcontext_blackBBBBBB(b2e, jContainer,
							bodyDeclaration, feature, uContainer, ne2ne)) {
				Object[] result3_green = InnerDeclaration2InnerClassifier_InAnonymousImpl
						.pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_3_findcontext_greenBBBBBBFFFFFFF(b2e,
								jContainer, bodyDeclaration, feature, uContainer, ne2ne);
				...
				Object[] result4_bindingAndBlack = InnerDeclaration2InnerClassifier_InAnonymousImpl
						.pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
								this, isApplicableMatch, b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element b2e,
			AnonymousClassDeclaration jContainer, AbstractTypeDeclaration bodyDeclaration, Classifier feature,
			org.eclipse.uml2.uml.Class uContainer, ASTNode2Element ne2ne) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject b2e, EObject jContainer,
			EObject bodyDeclaration, EObject feature, EObject uContainer, EObject ne2ne) {
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject b2e, EObject jContainer,
			EObject bodyDeclaration, EObject feature, EObject uContainer, EObject ne2ne) {
		ruleresult.registerObject("b2e", b2e);
		ruleresult.registerObject("jContainer", jContainer);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InnerDeclaration2InnerClassifier_InAnonymousImpl
				.pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
						jContainer, bodyDeclaration, feature, uContainer, sourceMatch, targetMatch);
		...
		if (InnerDeclaration2InnerClassifier_InAnonymousImpl
			...
			for (Object[] result5_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
					.pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_5_matchcorrcontext_blackFBBBBFBB(
							jContainer, bodyDeclaration, feature, uContainer, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = InnerDeclaration2InnerClassifier_InAnonymousImpl
						.pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_6_createcorrespondence_blackBBBBB(
								jContainer, bodyDeclaration, feature, uContainer, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jContainer] = "
							+ jContainer + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[feature] = "
							+ feature + ", " + "[uContainer] = " + uContainer + ", " + "[ccMatch] = " + ccMatch + ".");
				}
		...
		for (Object[] result2_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
			...
			Object[] result3_bindingAndBlack = InnerDeclaration2InnerClassifier_InAnonymousImpl
					.pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[b2e] = " + b2e + ", "
						+ "[jContainer] = " + jContainer + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
						+ "[feature] = " + feature + ", " + "[uContainer] = " + uContainer + ", " + "[ne2ne] = " + ne2ne
				...
				if (result5_black != null) {
					...
					Object[] result6_black = InnerDeclaration2InnerClassifier_InAnonymousImpl
							.pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_6_perform_blackBBBBBBB(b2e,
									jContainer, bodyDeclaration, feature, uContainer, ne2ne, ruleResult);
					if (result6_black == null) {
					...
					InnerDeclaration2InnerClassifier_InAnonymousImpl
							.pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_6_perform_greenBBBBB(jContainer,
									bodyDeclaration, feature, uContainer, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element b2e,
			AnonymousClassDeclaration jContainer, AbstractTypeDeclaration bodyDeclaration, Classifier feature,
			org.eclipse.uml2.uml.Class uContainer, ASTNode2Element ne2ne, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION_CLASSIFIER_CLASS_ASTNODE2ELEMENT:
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION_CLASSIFIER_CLASS_ASTNODE2ELEMENT:
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_141__EMOFLONEDGE:
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION_CLASSIFIER_CLASS_MATCH_MATCH:
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ANONYMOUSCLASSDECLARATION_ABSTRACTTYPEDECLARATION_CLASSIFIER_CLASS_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpFeature instanceof Classifier) {
						...
						if (tmpUContainer instanceof org.eclipse.uml2.uml.Class) {
							...
							if (tmpNe2ne instanceof ASTNode2Element) {
								...
								return new Object[] { b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element b2e, AnonymousClassDeclaration jContainer, AbstractTypeDeclaration bodyDeclaration,
			...
			if (!feature.equals(uContainer)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne, csp, _this,
								isApplicableMatch };
					}
				}
			}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_black = pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_blackBBBBBBFBB(
					b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne, _this, isApplicableMatch);
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject b2e, EObject jContainer, EObject bodyDeclaration, EObject feature,
			EObject uContainer, EObject ne2ne) {
															...
															if (!feature.equals(ne2ne)) {
																if (!ne2ne.equals(uContainer)) {
																	return new Object[] { ruleresult, b2e, jContainer,
																			bodyDeclaration, feature, uContainer,
																			ne2ne };
																}
															}
														}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_3_bookkeepingforedges_greenBBBBBFFF(
			PerformRuleResult ruleresult, EObject jContainer, EObject bodyDeclaration, EObject feature,
			EObject uContainer) {
		EMoflonEdge jContainer__bodyDeclaration____bodyDeclarations = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge bodyDeclaration__jContainer____anonymousClassDeclarationOwner = RuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		...
		return new Object[] { ruleresult, jContainer, bodyDeclaration, feature, uContainer,
				jContainer__bodyDeclaration____bodyDeclarations,
				bodyDeclaration__jContainer____anonymousClassDeclarationOwner,
	...
	public static final void pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject jContainer, EObject bodyDeclaration, EObject feature, EObject uContainer, EObject ne2ne) {
		_this.registerObjects_FWD(ruleresult, b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne);
	...
	public static final Iterable<Object[]> pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_2_corematch_blackFBBFFFB(
				...
				for (ASTNode2Element ne2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!b2e.equals(ne2ne)) {
						...
						if (tmpUContainer instanceof org.eclipse.uml2.uml.Class) {
							org.eclipse.uml2.uml.Class uContainer = (org.eclipse.uml2.uml.Class) tmpUContainer;
							if (!feature.equals(uContainer)) {
								_result.add(new Object[] { b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne,
										match });
							}
						}
						...
						if (feature.equals(b2e.getTarget())) {
							if (jContainer.equals(ne2ne.getSource())) {
								if (uContainer.equals(ne2ne.getTarget())) {
									_result.add(new Object[] { b2e, jContainer, bodyDeclaration, feature, uContainer,
											ne2ne });
								}
							}
						}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne, isApplicableMatch,
				jContainer__bodyDeclaration____bodyDeclarations,
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_bindingFBBBBBBBB(
			...
			ASTNode2Element b2e, AnonymousClassDeclaration jContainer, AbstractTypeDeclaration bodyDeclaration,
			Classifier feature, org.eclipse.uml2.uml.Class uContainer, ASTNode2Element ne2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, b2e, jContainer, bodyDeclaration,
				feature, uContainer, ne2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, b2e, jContainer, bodyDeclaration, feature, uContainer,
					ne2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_binding = pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne);
		if (result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, b2e, jContainer, bodyDeclaration, feature,
						uContainer, ne2ne };
			}
		}
		return null;
	...
	public static final void pattern_InnerDeclaration2InnerClassifier_InAnonymous_11_5_registerobjects_expressionBBBBBBBB(
			InnerDeclaration2InnerClassifier_InAnonymous _this, PerformRuleResult ruleresult, EObject b2e,
			EObject jContainer, EObject bodyDeclaration, EObject feature, EObject uContainer, EObject ne2ne) {
		_this.registerObjects_BWD(ruleresult, b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne);
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		ne2ne__uContainer____target.setName(ne2ne__uContainer____target_name_prime);
		return new Object[] { b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne, isApplicableMatch,
				b2e__bodyDeclaration____source, b2e__feature____target, uContainer__feature____nestedClassifier,
				ne2ne__jContainer____source, ne2ne__uContainer____target };
	}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_12_4_solveCSP_bindingFBBBBBBBB(
			...
			ASTNode2Element b2e, AnonymousClassDeclaration jContainer, AbstractTypeDeclaration bodyDeclaration,
			Classifier feature, org.eclipse.uml2.uml.Class uContainer, ASTNode2Element ne2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, b2e, jContainer, bodyDeclaration,
				feature, uContainer, ne2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, b2e, jContainer, bodyDeclaration, feature, uContainer,
		...
		if (tmpJContainer instanceof AnonymousClassDeclaration) {
			...
			if (tmpBodyDeclaration instanceof AbstractTypeDeclaration) {
				...
				if (tmpFeature instanceof Classifier) {
					...
					if (tmpUContainer instanceof org.eclipse.uml2.uml.Class) {
						org.eclipse.uml2.uml.Class uContainer = (org.eclipse.uml2.uml.Class) tmpUContainer;
						return new Object[] { jContainer, bodyDeclaration, feature, uContainer, sourceMatch,
								targetMatch };
					}
				}
			}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_2_matchsrctrgcontext_blackBBBBBB(
		...
		if (!feature.equals(uContainer)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { jContainer, bodyDeclaration, feature, uContainer, sourceMatch, targetMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_3_solvecsp_bindingFBBBBBBB(
			...
			AbstractTypeDeclaration bodyDeclaration, Classifier feature, org.eclipse.uml2.uml.Class uContainer,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(jContainer, bodyDeclaration, feature, uContainer,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, jContainer, bodyDeclaration, feature, uContainer, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_3_solvecsp_binding = pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_3_solvecsp_bindingFBBBBBBB(
				_this, jContainer, bodyDeclaration, feature, uContainer, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_5_matchcorrcontext_blackFBBBBFBB(
			AnonymousClassDeclaration jContainer, AbstractTypeDeclaration bodyDeclaration, Classifier feature,
			org.eclipse.uml2.uml.Class uContainer, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!feature.equals(uContainer)) {
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_6_createcorrespondence_blackBBBBB(
		...
		if (!feature.equals(uContainer)) {
			return new Object[] { jContainer, bodyDeclaration, feature, uContainer, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, b2e, jContainer, bodyDeclaration,
				feature, uContainer, ne2ne, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, b2e, jContainer, bodyDeclaration, feature, uContainer,
					ne2ne, ruleResult };
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_binding = pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne, ruleResult);
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_6_perform_blackBBBBBBB(
		...
		if (!b2e.equals(ne2ne)) {
			if (!feature.equals(uContainer)) {
				return new Object[] { b2e, jContainer, bodyDeclaration, feature, uContainer, ne2ne, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_6_perform_greenBBBBB(
		...
		return new Object[] { jContainer, bodyDeclaration, feature, uContainer, ruleResult };
	}
