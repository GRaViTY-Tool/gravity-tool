...
public class InnerDeclaration2InnerClassifier_InAnonymousImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InnerDeclaration2InnerClassifier_InAnonymousImpl
				.pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[ne2ne] = " + ne2ne + ", " + "[feature] = " + feature + ", " + "[bodyDeclaration] = "
		...
		InnerDeclaration2InnerClassifier_InAnonymousImpl
				.pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_5_registerobjects_expressionBBBBBBBB(this,
						ruleresult, ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer);
		return InnerDeclaration2InnerClassifier_InAnonymousImpl
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
			...
			for (Object[] result3_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
					.pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_3_findcontext_blackBBBBBB(ne2ne, feature,
							bodyDeclaration, b2e, uContainer, jContainer)) {
				Object[] result3_green = InnerDeclaration2InnerClassifier_InAnonymousImpl
						.pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_3_findcontext_greenBBBBBBFFFFFFF(ne2ne,
								feature, bodyDeclaration, b2e, uContainer, jContainer);
				...
				Object[] result4_bindingAndBlack = InnerDeclaration2InnerClassifier_InAnonymousImpl
						.pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
								this, isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[ne2ne] = " + ne2ne + ", "
							+ "[feature] = " + feature + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
							+ "[b2e] = " + b2e + ", " + "[uContainer] = " + uContainer + ", " + "[jContainer] = "
							+ jContainer + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element ne2ne, Classifier feature,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject ne2ne, EObject feature,
			EObject bodyDeclaration, EObject b2e, EObject uContainer, EObject jContainer) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
				.pattern_InnerDeclaration2InnerClassifier_InAnonymous_12_2_corematch_blackFBFFBFB(feature, uContainer,
						match)) {
			ASTNode2Element ne2ne = (ASTNode2Element) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
					.pattern_InnerDeclaration2InnerClassifier_InAnonymous_12_3_findcontext_blackBBBBBB(ne2ne, feature,
							bodyDeclaration, b2e, uContainer, jContainer)) {
				Object[] result3_green = InnerDeclaration2InnerClassifier_InAnonymousImpl
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element ne2ne, Classifier feature,
			AbstractTypeDeclaration bodyDeclaration, ASTNode2Element b2e, org.eclipse.uml2.uml.Class uContainer,
			AnonymousClassDeclaration jContainer) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject ne2ne, EObject feature,
			EObject bodyDeclaration, EObject b2e, EObject uContainer, EObject jContainer) {
		ruleresult.registerObject("ne2ne", ne2ne);
		ruleresult.registerObject("feature", feature);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_166(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (InnerDeclaration2InnerClassifier_InAnonymousImpl
			...
			for (Object[] result5_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
					.pattern_InnerDeclaration2InnerClassifier_InAnonymous_24_5_matchcorrcontext_blackFBBFBBBB(feature,
		...
		for (Object[] result2_black : InnerDeclaration2InnerClassifier_InAnonymousImpl
			...
			Object[] result3_bindingAndBlack = InnerDeclaration2InnerClassifier_InAnonymousImpl
					.pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[ne2ne] = " + ne2ne + ", "
						+ "[feature] = " + feature + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[b2e] = "
						+ b2e + ", " + "[uContainer] = " + uContainer + ", " + "[jContainer] = " + jContainer + ", "
			...
			if (InnerDeclaration2InnerClassifier_InAnonymousImpl
				...
				// 
				Object[] result5_black = InnerDeclaration2InnerClassifier_InAnonymousImpl
						.pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_5_checknacs_blackBBBBBB(ne2ne, feature,
								bodyDeclaration, b2e, uContainer, jContainer);
				if (result5_black != null) {

					Object[] result6_black = InnerDeclaration2InnerClassifier_InAnonymousImpl
							.pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_6_perform_blackBBBBBBB(ne2ne,
									feature, bodyDeclaration, b2e, uContainer, jContainer, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ne2ne] = " + ne2ne
								+ ", " + "[feature] = " + feature + ", " + "[bodyDeclaration] = " + bodyDeclaration
								+ ", " + "[b2e] = " + b2e + ", " + "[uContainer] = " + uContainer + ", "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element ne2ne,
			Classifier feature, AbstractTypeDeclaration bodyDeclaration, ASTNode2Element b2e,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASSIFIER_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_CLASS_ANONYMOUSCLASSDECLARATION:
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASSIFIER_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_CLASS_ANONYMOUSCLASSDECLARATION:
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_152__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_152((EMoflonEdge) arguments.get(0));
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_166__EMOFLONEDGE:
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__CLASSIFIER_ABSTRACTTYPEDECLARATION_CLASS_ANONYMOUSCLASSDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.INNER_DECLARATION2_INNER_CLASSIFIER_IN_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASSIFIER_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_CLASS_ANONYMOUSCLASSDECLARATION_MODELGENERATORRULERESULT:
					...
					if (tmpB2e instanceof ASTNode2Element) {
						...
						if (tmpUContainer instanceof org.eclipse.uml2.uml.Class) {
							...
							if (tmpJContainer instanceof AnonymousClassDeclaration) {
								...
								return new Object[] { ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element ne2ne, Classifier feature, AbstractTypeDeclaration bodyDeclaration, ASTNode2Element b2e,
			org.eclipse.uml2.uml.Class uContainer, AnonymousClassDeclaration jContainer,
			...
			if (!b2e.equals(ne2ne)) {
				for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
					if (tmpCsp instanceof CSP) {
						CSP csp = (CSP) tmpCsp;
						return new Object[] { ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer, csp, _this,
								isApplicableMatch };
					}
				}
			}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_black = pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_1_performtransformation_blackBBBBBBFBB(
					ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer, _this, isApplicableMatch);
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject ne2ne, EObject feature, EObject bodyDeclaration, EObject b2e,
														...
														if (!b2e.equals(jContainer)) {
															if (!jContainer.equals(ne2ne)) {
																if (!jContainer.equals(uContainer)) {
																	return new Object[] { ruleresult, ne2ne, feature,
	...
	public static final void pattern_InnerDeclaration2InnerClassifier_InAnonymous_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject feature, EObject bodyDeclaration, EObject b2e, EObject uContainer, EObject jContainer) {
		_this.registerObjects_FWD(ruleresult, ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer);
				...
				for (ASTNode2Element b2e : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!b2e.equals(ne2ne)) {
						...
						if (tmpFeature instanceof Classifier) {
							Classifier feature = (Classifier) tmpFeature;
							if (!feature.equals(uContainer)) {
								_result.add(new Object[] { ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer,
										match });
							}
						}
						...
						if (bodyDeclaration.equals(b2e.getSource())) {
							if (feature.equals(b2e.getTarget())) {
								if (uContainer.equals(ne2ne.getTarget())) {
									_result.add(new Object[] { ne2ne, feature, bodyDeclaration, b2e, uContainer,
											jContainer });
								}
							}
						}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer, isApplicableMatch,
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_bindingFBBBBBBBB(
			...
			ASTNode2Element ne2ne, Classifier feature, AbstractTypeDeclaration bodyDeclaration, ASTNode2Element b2e,
			org.eclipse.uml2.uml.Class uContainer, AnonymousClassDeclaration jContainer) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e,
				uContainer, jContainer);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e, uContainer,
					jContainer };
		}
		return null;
	}
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_binding = pattern_InnerDeclaration2InnerClassifier_InAnonymous_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer);
	...
	public static final void pattern_InnerDeclaration2InnerClassifier_InAnonymous_11_5_registerobjects_expressionBBBBBBBB(
			InnerDeclaration2InnerClassifier_InAnonymous _this, PerformRuleResult ruleresult, EObject ne2ne,
			EObject feature, EObject bodyDeclaration, EObject b2e, EObject uContainer, EObject jContainer) {
		_this.registerObjects_BWD(ruleresult, ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer);
	...
	public static final Iterable<Object[]> pattern_InnerDeclaration2InnerClassifier_InAnonymous_12_2_corematch_blackFBFFBFB(
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_12_4_solveCSP_bindingFBBBBBBBB(
			...
			ASTNode2Element ne2ne, Classifier feature, AbstractTypeDeclaration bodyDeclaration, ASTNode2Element b2e,
			org.eclipse.uml2.uml.Class uContainer, AnonymousClassDeclaration jContainer) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e,
				uContainer, jContainer);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e, uContainer,
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e,
				uContainer, jContainer, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e, uContainer,
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_binding = pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer, ruleResult);
	...
	public static final Object[] pattern_InnerDeclaration2InnerClassifier_InAnonymous_29_6_perform_blackBBBBBBB(
		...
		if (!feature.equals(uContainer)) {
			if (!b2e.equals(ne2ne)) {
				return new Object[] { ne2ne, feature, bodyDeclaration, b2e, uContainer, jContainer, ruleResult };
			}
		}
		return null;
	}
