...
public class FieldDec2PropertyImpl extends AbstractRuleImpl implements FieldDec2Property {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = FieldDec2PropertyImpl
				.pattern_FieldDec2Property_1_2_collecttranslatedelements_blackBBBB(feature, bodyDeclaration, vdf, b2e);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[feature] = " + feature + ", "
					+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[vdf] = " + vdf + ", " + "[b2e] = " + b2e
					+ ".");
		}
		Object[] result2_green = FieldDec2PropertyImpl
				.pattern_FieldDec2Property_1_2_collecttranslatedelements_greenFBBBB(feature, bodyDeclaration, vdf, b2e);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = FieldDec2PropertyImpl.pattern_FieldDec2Property_1_3_bookkeepingforedges_blackBBBBB(
				ruleresult, feature, bodyDeclaration, vdf, b2e);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject feature, EObject bodyDeclaration, EObject vdf,
			EObject b2e) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = FieldDec2PropertyImpl
				.pattern_FieldDec2Property_11_2_collecttranslatedelements_blackBBBB(feature, bodyDeclaration, vdf, b2e);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[feature] = " + feature + ", "
					+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[vdf] = " + vdf + ", " + "[b2e] = " + b2e
					+ ".");
		...
		Object[] result2_green = FieldDec2PropertyImpl
				.pattern_FieldDec2Property_11_2_collecttranslatedelements_greenFBBBB(feature, bodyDeclaration, vdf,
						b2e);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject feature, EObject bodyDeclaration, EObject vdf,
			EObject b2e) {
		ruleresult.registerObject("feature", feature);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
		ruleresult.registerObject("vdf", vdf);
	...
	public static final Object[] pattern_FieldDec2Property_1_2_collecttranslatedelements_blackBBBB(Property feature,
			MFieldDefinition bodyDeclaration, VariableDeclarationFragment vdf, ASTNode2Element b2e) {
		return new Object[] { feature, bodyDeclaration, vdf, b2e };
	}
	...
	public static final Object[] pattern_FieldDec2Property_1_2_collecttranslatedelements_greenFBBBB(Property feature,
		...
		return new Object[] { ruleresult, feature, bodyDeclaration, vdf, b2e };
	}

	public static final Object[] pattern_FieldDec2Property_1_3_bookkeepingforedges_blackBBBBB(
			PerformRuleResult ruleresult, EObject feature, EObject bodyDeclaration, EObject vdf, EObject b2e) {
	...
	public static final void pattern_FieldDec2Property_1_5_registerobjects_expressionBBBBBB(FieldDec2Property _this,
			PerformRuleResult ruleresult, EObject feature, EObject bodyDeclaration, EObject vdf, EObject b2e) {
		_this.registerObjects_FWD(ruleresult, feature, bodyDeclaration, vdf, b2e);
	...
	public static final Object[] pattern_FieldDec2Property_11_1_performtransformation_greenBFFFB(Property feature,
		...
		return new Object[] { feature, bodyDeclaration, vdf, b2e, csp };
	}
	...
	public static final void pattern_FieldDec2Property_11_5_registerobjects_expressionBBBBBB(FieldDec2Property _this,
			PerformRuleResult ruleresult, EObject feature, EObject bodyDeclaration, EObject vdf, EObject b2e) {
		_this.registerObjects_BWD(ruleresult, feature, bodyDeclaration, vdf, b2e);
	...
	public static final Object[] pattern_FieldDec2Property_20_2_testcorematchandDECs_black_nac_0B(Property feature) {
		Type __DEC_feature_type_442522 = feature.getType();
		if (__DEC_feature_type_442522 != null) {
	...
	public static final Object[] pattern_FieldDec2Property_21_2_testcorematchandDECs_black_nac_0B(
		...
		Modifier __DEC_bodyDeclaration_modifier_961907 = bodyDeclaration.getModifier();
		if (__DEC_bodyDeclaration_modifier_961907 != null) {
	...
	public static final Object[] pattern_FieldDec2Property_21_2_testcorematchandDECs_black_nac_1BB(
			MFieldDefinition bodyDeclaration, VariableDeclarationFragment vdf) {
		for (VariableDeclarationFragment __DEC_bodyDeclaration_variablesContainer_939547 : bodyDeclaration
				.getFragments()) {
			if (!vdf.equals(__DEC_bodyDeclaration_variablesContainer_939547)) {
	...
	public static final Object[] pattern_FieldDec2Property_27_1_matchtggpattern_black_nac_0B(
			MFieldDefinition bodyDeclaration) {
		Modifier __DEC_bodyDeclaration_modifier_805902 = bodyDeclaration.getModifier();
		if (__DEC_bodyDeclaration_modifier_805902 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_FieldDec2Property_27_1_matchtggpattern_black_nac_1BB(
			MFieldDefinition bodyDeclaration, VariableDeclarationFragment vdf) {
		for (VariableDeclarationFragment __DEC_bodyDeclaration_variablesContainer_904043 : bodyDeclaration
				.getFragments()) {
			if (!vdf.equals(__DEC_bodyDeclaration_variablesContainer_904043)) {
				return new Object[] { bodyDeclaration, vdf };
			}
		}
		return null;
	...
	public static final Object[] pattern_FieldDec2Property_28_1_matchtggpattern_black_nac_0B(Property feature) {
		Type __DEC_feature_type_37256 = feature.getType();
		if (__DEC_feature_type_37256 != null) {
			return new Object[] { feature };
		}
	...
	public static final Object[] pattern_FieldDec2Property_29_6_perform_greenFFFFBB(ModelgeneratorRuleResult ruleResult,
		...
		return new Object[] { feature, bodyDeclaration, vdf, b2e, ruleResult, csp };
	}
