...
public class FieldDec2PropertyImpl extends AbstractRuleImpl implements FieldDec2Property {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = FieldDec2PropertyImpl
				.pattern_FieldDec2Property_1_2_collecttranslatedelements_blackBBBB(bodyDeclaration, vdf, feature, b2e);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[bodyDeclaration] = " + bodyDeclaration + ", "
							+ "[vdf] = " + vdf + ", " + "[feature] = " + feature + ", " + "[b2e] = " + b2e + ".");
		}
		Object[] result2_green = FieldDec2PropertyImpl
				.pattern_FieldDec2Property_1_2_collecttranslatedelements_greenFBBBB(bodyDeclaration, vdf, feature, b2e);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = FieldDec2PropertyImpl.pattern_FieldDec2Property_1_3_bookkeepingforedges_blackBBBBB(
				ruleresult, bodyDeclaration, vdf, feature, b2e);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[vdf] = " + vdf + ", " + "[feature] = "
					+ feature + ", " + "[b2e] = " + b2e + ".");
		}
		FieldDec2PropertyImpl.pattern_FieldDec2Property_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				bodyDeclaration, vdf, feature, b2e);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject vdf, EObject feature,
			EObject b2e) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		VariableDeclarationFragment vdf = (VariableDeclarationFragment) result1_green[1];
		ASTNode2Element b2e = (ASTNode2Element) result1_green[3];

		Object[] result2_black = FieldDec2PropertyImpl
				.pattern_FieldDec2Property_11_2_collecttranslatedelements_blackBBBB(bodyDeclaration, vdf, feature, b2e);
		if (result2_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[bodyDeclaration] = " + bodyDeclaration + ", "
							+ "[vdf] = " + vdf + ", " + "[feature] = " + feature + ", " + "[b2e] = " + b2e + ".");
		...
		Object[] result2_green = FieldDec2PropertyImpl
				.pattern_FieldDec2Property_11_2_collecttranslatedelements_greenFBBBB(bodyDeclaration, vdf, feature,
						b2e);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject vdf, EObject feature,
			EObject b2e) {
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
		ruleresult.registerObject("vdf", vdf);
		ruleresult.registerObject("feature", feature);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_20(EMoflonEdge _edge_variablesContainer) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer) {
		...
		if (result2_black != null) {
			...
			if (FieldDec2PropertyImpl.pattern_FieldDec2Property_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				//nothing VariableDeclarationFragment vdf = (VariableDeclarationFragment) result6_green[1];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEC2_PROPERTY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_20__EMOFLONEDGE:
	...
	public static final Object[] pattern_FieldDec2Property_1_2_collecttranslatedelements_blackBBBB(
			MFieldDefinition bodyDeclaration, VariableDeclarationFragment vdf, Property feature, ASTNode2Element b2e) {
		return new Object[] { bodyDeclaration, vdf, feature, b2e };
	}
	...
	public static final Object[] pattern_FieldDec2Property_1_2_collecttranslatedelements_greenFBBBB(
		...
		return new Object[] { ruleresult, bodyDeclaration, vdf, feature, b2e };
	}

	public static final Object[] pattern_FieldDec2Property_1_3_bookkeepingforedges_blackBBBBB(
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject vdf, EObject feature, EObject b2e) {
	...
	public static final Object[] pattern_FieldDec2Property_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		vdf__bodyDeclaration____variablesContainer.setName(vdf__bodyDeclaration____variablesContainer_name_prime);
		bodyDeclaration__vdf____fragments.setName(bodyDeclaration__vdf____fragments_name_prime);
		return new Object[] { ruleresult, bodyDeclaration, vdf, feature, b2e, b2e__bodyDeclaration____source,
	...
	public static final void pattern_FieldDec2Property_1_5_registerobjects_expressionBBBBBB(FieldDec2Property _this,
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject vdf, EObject feature, EObject b2e) {
		_this.registerObjects_FWD(ruleresult, bodyDeclaration, vdf, feature, b2e);
	...
	public static final Object[] pattern_FieldDec2Property_11_1_performtransformation_greenFFBFB(Property feature,
		...
		return new Object[] { bodyDeclaration, vdf, feature, b2e, csp };
	}
	...
	public static final void pattern_FieldDec2Property_11_5_registerobjects_expressionBBBBBB(FieldDec2Property _this,
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject vdf, EObject feature, EObject b2e) {
		_this.registerObjects_BWD(ruleresult, bodyDeclaration, vdf, feature, b2e);
	...
	public static final Object[] pattern_FieldDec2Property_20_2_testcorematchandDECs_black_nac_0B(Property feature) {
		Type __DEC_feature_type_686225 = feature.getType();
		if (__DEC_feature_type_686225 != null) {
	...
	public static final Object[] pattern_FieldDec2Property_21_2_testcorematchandDECs_black_nac_0B(
		...
		Modifier __DEC_bodyDeclaration_modifier_288899 = bodyDeclaration.getModifier();
		if (__DEC_bodyDeclaration_modifier_288899 != null) {
	...
	public static final Object[] pattern_FieldDec2Property_21_2_testcorematchandDECs_black_nac_1BB(
			MFieldDefinition bodyDeclaration, VariableDeclarationFragment vdf) {
		for (VariableDeclarationFragment __DEC_bodyDeclaration_variablesContainer_265140 : bodyDeclaration
				.getFragments()) {
			if (!vdf.equals(__DEC_bodyDeclaration_variablesContainer_265140)) {
	...
	public static final Object[] pattern_FieldDec2Property_27_1_matchtggpattern_black_nac_0B(
			MFieldDefinition bodyDeclaration) {
		Modifier __DEC_bodyDeclaration_modifier_102830 = bodyDeclaration.getModifier();
		if (__DEC_bodyDeclaration_modifier_102830 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_FieldDec2Property_27_1_matchtggpattern_black_nac_1BB(
			MFieldDefinition bodyDeclaration, VariableDeclarationFragment vdf) {
		for (VariableDeclarationFragment __DEC_bodyDeclaration_variablesContainer_476475 : bodyDeclaration
				.getFragments()) {
			if (!vdf.equals(__DEC_bodyDeclaration_variablesContainer_476475)) {
				return new Object[] { bodyDeclaration, vdf };
			}
		}
		return null;
	...
	public static final Object[] pattern_FieldDec2Property_28_1_matchtggpattern_black_nac_0B(Property feature) {
		Type __DEC_feature_type_174402 = feature.getType();
		if (__DEC_feature_type_174402 != null) {
			return new Object[] { feature };
		}
	...
	public static final Object[] pattern_FieldDec2Property_29_6_perform_greenFFFFBB(ModelgeneratorRuleResult ruleResult,
		...
		return new Object[] { bodyDeclaration, vdf, feature, b2e, ruleResult, csp };
	}
