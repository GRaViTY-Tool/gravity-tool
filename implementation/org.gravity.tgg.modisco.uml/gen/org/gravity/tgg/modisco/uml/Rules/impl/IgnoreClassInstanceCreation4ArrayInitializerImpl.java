		...
		switch (operationID) {
			...
			case RulesPackage.IGNORE_CLASS_INSTANCE_CREATION4_ARRAY_INITIALIZER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ARRAYINITIALIZER_CLASSINSTANCECREATION:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(ArrayInitializer) arguments.get(1), (ClassInstanceCreation) arguments.get(2));
			...
			case RulesPackage.IGNORE_CLASS_INSTANCE_CREATION4_ARRAY_INITIALIZER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_140__EMOFLONEDGE:
