...
public class JavaPackageToUMLPackage_underModelImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = JavaPackageToUMLPackage_underModelImpl
				.pattern_JavaPackageToUMLPackage_underModel_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, jm2um, up,
						jm, um, jp2up, jp);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[jm2um] = " + jm2um + ", " + "[up] = " + up + ", " + "[jm] = " + jm + ", " + "[um] = "
					+ um + ", " + "[jp2up] = " + jp2up + ", " + "[jp] = " + jp + ".");
		}
		JavaPackageToUMLPackage_underModelImpl
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject jm2um, EObject up, EObject jm, EObject um,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = JavaPackageToUMLPackage_underModelImpl
				.pattern_JavaPackageToUMLPackage_underModel_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, jm2um, up,
						jm, um, jp2up, jp);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[jm2um] = " + jm2um + ", " + "[up] = " + up + ", " + "[jm] = " + jm + ", " + "[um] = "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : JavaPackageToUMLPackage_underModelImpl
			...
			// ForEach 
			for (Object[] result3_black : JavaPackageToUMLPackage_underModelImpl
					.pattern_JavaPackageToUMLPackage_underModel_12_3_findcontext_blackBBBB(jm2um, up, jm, um)) {
				Object[] result3_green = JavaPackageToUMLPackage_underModelImpl
						.pattern_JavaPackageToUMLPackage_underModel_12_3_findcontext_greenBBBBFFFF(jm2um, up, jm, um);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				...
				Object[] result4_bindingAndBlack = JavaPackageToUMLPackage_underModelImpl
						.pattern_JavaPackageToUMLPackage_underModel_12_4_solveCSP_bindingAndBlackFBBBBBB(this,
								isApplicableMatch, jm2um, up, jm, um);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[jm2um] = " + jm2um + ", "
							+ "[up] = " + up + ", " + "[jm] = " + jm + ", " + "[um] = " + um + ".");
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage jm2um,
			org.eclipse.uml2.uml.Package up, Model jm, org.eclipse.uml2.uml.Model um) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject jm2um, EObject up, EObject jm, EObject um,
			EObject jp2up, EObject jp) {
		ruleresult.registerObject("jm2um", jm2um);
		ruleresult.registerObject("up", up);
		ruleresult.registerObject("jm", jm);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_137(EMoflonEdge _edge_ownedElements) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_PACKAGE_TO_UML_PACKAGE_UNDER_MODEL___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_JAVAMODEL2UMLPACKAGE_PACKAGE_MODEL_MODEL:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(JavaModel2UMLPackage) arguments.get(1), (org.eclipse.uml2.uml.Package) arguments.get(2),
		...
		case RulesPackage.JAVA_PACKAGE_TO_UML_PACKAGE_UNDER_MODEL___IS_APPROPRIATE_BWD_EMOFLON_EDGE_131__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_131((EMoflonEdge) arguments.get(0));
		case RulesPackage.JAVA_PACKAGE_TO_UML_PACKAGE_UNDER_MODEL___IS_APPROPRIATE_FWD_EMOFLON_EDGE_137__EMOFLONEDGE:
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject jm2um, EObject up, EObject jm, EObject um, EObject jp2up,
			EObject jp) {
		if (!jm2um.equals(up)) {
			if (!jm2um.equals(um)) {
												...
												if (!jp2up.equals(up)) {
													if (!jp2up.equals(um)) {
														if (!jp.equals(up)) {
															if (!jp.equals(um)) {
																if (!jp.equals(jp2up)) {
																	return new Object[] { ruleresult, jm2um, up, jm, um,
																			jp2up, jp };
																}
															}
														}
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, up, jm, um, jp2up, jp, jm__jp____ownedElements, jp__jm____model,
	...
	public static final void pattern_JavaPackageToUMLPackage_underModel_1_5_registerobjects_expressionBBBBBBBB(
			JavaPackageToUMLPackage_underModel _this, PerformRuleResult ruleresult, EObject jm2um, EObject up,
			EObject jm, EObject um, EObject jp2up, EObject jp) {
		_this.registerObjects_FWD(ruleresult, jm2um, up, jm, um, jp2up, jp);
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_2_3_findcontext_greenBBBBFFFFF(
		...
		return new Object[] { jm2um, jm, um, jp, isApplicableMatch, jm__jp____ownedElements, jp__jm____model,
		...
		if (tmpJm2um instanceof JavaModel2UMLPackage) {
			...
			if (tmpUp instanceof org.eclipse.uml2.uml.Package) {
				...
				if (tmpJm instanceof Model) {
					...
					if (tmpUm instanceof org.eclipse.uml2.uml.Model) {
						org.eclipse.uml2.uml.Model um = (org.eclipse.uml2.uml.Model) tmpUm;
						return new Object[] { jm2um, up, jm, um, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_11_1_performtransformation_blackBBBBFBB(
			JavaModel2UMLPackage jm2um, org.eclipse.uml2.uml.Package up, Model jm, org.eclipse.uml2.uml.Model um,
			JavaPackageToUMLPackage_underModel _this, IsApplicableMatch isApplicableMatch) {
		if (!um.equals(up)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { jm2um, up, jm, um, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_11_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_JavaPackageToUMLPackage_underModel_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_JavaPackageToUMLPackage_underModel_11_1_performtransformation_black = pattern_JavaPackageToUMLPackage_underModel_11_1_performtransformation_blackBBBBFBB(
					jm2um, up, jm, um, _this, isApplicableMatch);
	...
	public static final void pattern_JavaPackageToUMLPackage_underModel_11_5_registerobjects_expressionBBBBBBBB(
			JavaPackageToUMLPackage_underModel _this, PerformRuleResult ruleresult, EObject jm2um, EObject up,
			EObject jm, EObject um, EObject jp2up, EObject jp) {
		_this.registerObjects_BWD(ruleresult, jm2um, up, jm, um, jp2up, jp);
	...
	public static final Iterable<Object[]> pattern_JavaPackageToUMLPackage_underModel_12_2_corematch_blackFBFBB(
		...
		if (!um.equals(up)) {
			for (JavaModel2UMLPackage jm2um : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(um,
				...
				if (jm != null) {
					_result.add(new Object[] { jm2um, up, jm, um, match });
				}
	...
	public static final Iterable<Object[]> pattern_JavaPackageToUMLPackage_underModel_12_3_findcontext_blackBBBB(
		...
		if (!um.equals(up)) {
			if (um.getPackagedElements().contains(up)) {
				if (jm.equals(jm2um.getSource())) {
					if (um.equals(jm2um.getTarget())) {
						_result.add(new Object[] { jm2um, up, jm, um });
					}
				}
			}
		}
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_12_3_findcontext_greenBBBBFFFF(
		...
		jm2um__jm____source.setName(jm2um__jm____source_name_prime);
		jm2um__um____target.setName(jm2um__um____target_name_prime);
		return new Object[] { jm2um, up, jm, um, isApplicableMatch, um__up____packagedElement, jm2um__jm____source,
				jm2um__um____target };
	}
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_12_4_solveCSP_bindingFBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, jm2um, up, jm, um);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jm2um, up, jm, um };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_12_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_JavaPackageToUMLPackage_underModel_12_4_solveCSP_binding = pattern_JavaPackageToUMLPackage_underModel_12_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, jm2um, up, jm, um);
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_21_2_testcorematchandDECs_black_nac_0B(
		...
		org.eclipse.modisco.java.Package __DEC_jp_ownedPackages_542641 = jp.getPackage();
		if (__DEC_jp_ownedPackages_542641 != null) {
			if (!jp.equals(__DEC_jp_ownedPackages_542641)) {
	...
	public static final Object[] pattern_JavaPackageToUMLPackage_underModel_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Package jp) {
		org.eclipse.modisco.java.Package __DEC_jp_ownedPackages_191942 = jp.getPackage();
		if (__DEC_jp_ownedPackages_191942 != null) {
			if (!jp.equals(__DEC_jp_ownedPackages_191942)) {
				return new Object[] { jp };
			}
		}
