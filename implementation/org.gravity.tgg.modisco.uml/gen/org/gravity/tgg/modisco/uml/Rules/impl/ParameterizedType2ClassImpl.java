...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Parameterized Type2 Class</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class ParameterizedType2ClassImpl extends AbstractRuleImpl implements ParameterizedType2Class {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ParameterizedType2ClassImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getParameterizedType2Class();
	}
	...
	public boolean isAppropriate_FWD(Match match, AbstractTypeDeclaration nonParamType,
		...
		// 
		if (ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_0_3_CheckCSP_expressionFBB(this, csp)) {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = ParameterizedType2ClassImpl
		...
		Object[] result2_green = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_1_2_collecttranslatedelements_greenFBBBB(parameterizedClassifier,
						parameterizedType, ne2ne, typeTypeAccess);
		...
		ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		...
		Object[] result1_green = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_2_2_corematch_bindingFFFFB(match);
		...
		for (Object[] result2_black : ParameterizedType2ClassImpl
			...
			for (Object[] result3_black : ParameterizedType2ClassImpl
				...
				// 
				if (ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_2_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = ParameterizedType2ClassImpl
							.pattern_ParameterizedType2Class_2_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_2_6_addmatchtoruleresult_greenBB(
		...
		return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_2_7_expressionFB(ruleresult);
	}
	...
	public boolean isAppropriate_BWD(Match match, org.eclipse.uml2.uml.Package umlPackage,
		...
		Object[] result1_black = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_10_1_initialbindings_blackBBBBB(this, match, umlPackage,
		...
		Object[] result2_bindingAndBlack = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, umlPackage,
						nonParamElement, parameterizedClassifier);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[umlPackage] = " + umlPackage + ", " + "[nonParamElement] = "
		...
		CSP csp = (CSP) result2_bindingAndBlack[0];
		// 
		if (ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_10_3_CheckCSP_expressionFBB(this, csp)) {

			Object[] result4_black = ParameterizedType2ClassImpl
					.pattern_ParameterizedType2Class_10_4_collectelementstobetranslated_blackBBBB(match, umlPackage,
							nonParamElement, parameterizedClassifier);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umlPackage] = " + umlPackage + ", " + "[nonParamElement] = " + nonParamElement + ", "
			...
			ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_10_4_collectelementstobetranslated_greenBBBF(
			...
			Object[] result5_black = ParameterizedType2ClassImpl
					.pattern_ParameterizedType2Class_10_5_collectcontextelements_blackBBBB(match, umlPackage,
							nonParamElement, parameterizedClassifier);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umlPackage] = " + umlPackage + ", " + "[nonParamElement] = " + nonParamElement + ", "
			...
			ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_10_5_collectcontextelements_greenBBBF(match,
					umlPackage, nonParamElement);
			//nothing EMoflonEdge umlPackage__nonParamElement____packagedElement = (EMoflonEdge) result5_green[3];

			// 
			ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_10_6_registerobjectstomatch_expressionBBBBB(
					this, match, umlPackage, nonParamElement, parameterizedClassifier);
			return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_10_7_expressionF();
		} else {
			return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		Object[] result2_black = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_11_2_collecttranslatedelements_blackBBBB(parameterizedClassifier,
						parameterizedType, ne2ne, typeTypeAccess);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[parameterizedClassifier] = "
					+ parameterizedClassifier + ", " + "[parameterizedType] = " + parameterizedType + ", "
		...
		Object[] result2_green = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_11_2_collecttranslatedelements_greenFBBBB(parameterizedClassifier,
						parameterizedType, ne2ne, typeTypeAccess);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
		...
		ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_11_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
				ruleresult, umlPackage, parameterizedClassifier, nonParamType, parameterizedType, ne2ne,
				typeTypeAccess);
		//nothing EMoflonEdge umlPackage__parameterizedClassifier____packagedElement = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge parameterizedType__typeTypeAccess____type = (EMoflonEdge) result3_green[8];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Object[] result1_bindingAndBlack = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_12_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		EOperation performOperation = (EOperation) result1_bindingAndBlack[0];
		//nothing EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_12_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_12_2_corematch_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		org.eclipse.uml2.uml.Package umlPackage = (org.eclipse.uml2.uml.Package) result2_binding[0];
		org.eclipse.uml2.uml.Class nonParamElement = (org.eclipse.uml2.uml.Class) result2_binding[1];
		org.eclipse.uml2.uml.Class parameterizedClassifier = (org.eclipse.uml2.uml.Class) result2_binding[2];
		for (Object[] result2_black : ParameterizedType2ClassImpl
			...
			// ForEach 
			for (Object[] result3_black : ParameterizedType2ClassImpl
					.pattern_ParameterizedType2Class_12_3_findcontext_blackBBBBBBB(umlPackage, nonParamElement,
							ne2neNonParam, parameterizedClassifier, nonParamType, nonParamPackage, jp2up)) {
				Object[] result3_green = ParameterizedType2ClassImpl
						.pattern_ParameterizedType2Class_12_3_findcontext_greenBBBBBBBFFFFFFFFF(umlPackage,
				...
				Object[] result4_bindingAndBlack = ParameterizedType2ClassImpl
						.pattern_ParameterizedType2Class_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
				...
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
				if (ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_12_5_checkCSP_expressionFBB(this,
						csp)) {

					Object[] result6_black = ParameterizedType2ClassImpl
							.pattern_ParameterizedType2Class_12_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_12_6_addmatchtoruleresult_greenBB(
							ruleresult, isApplicableMatch);
		...
		return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_12_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_67(EMoflonEdge _edge_packagedElement) {
		...
		Object[] result1_green = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_20_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach 
		for (Object[] result2_black : ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_20_2_testcorematchandDECs_blackFFFB(_edge_packagedElement)) {
			org.eclipse.uml2.uml.Package umlPackage = (org.eclipse.uml2.uml.Package) result2_black[0];
			org.eclipse.uml2.uml.Class nonParamElement = (org.eclipse.uml2.uml.Class) result2_black[1];
			org.eclipse.uml2.uml.Class parameterizedClassifier = (org.eclipse.uml2.uml.Class) result2_black[2];
			Object[] result2_green = ParameterizedType2ClassImpl
					.pattern_ParameterizedType2Class_20_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// 
			if (ParameterizedType2ClassImpl
					.pattern_ParameterizedType2Class_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
							this, match, umlPackage, nonParamElement, parameterizedClassifier)) {
				// 
				if (ParameterizedType2ClassImpl
						.pattern_ParameterizedType2Class_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					Object[] result5_black = ParameterizedType2ClassImpl
							.pattern_ParameterizedType2Class_20_5_Addmatchtoruleresult_blackBBBB(match,
					...
					ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_20_5_Addmatchtoruleresult_greenBBBB(
		...
		return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_20_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_68(EMoflonEdge _edge_type) {
		...
		EOperation isApplicableCC = (EOperation) result1_bindingAndBlack[3];
		Object[] result1_green = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_21_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];
		...
		for (Object[] result2_black : ParameterizedType2ClassImpl
			...
			if (ParameterizedType2ClassImpl
				...
				if (ParameterizedType2ClassImpl
					...
					Object[] result5_black = ParameterizedType2ClassImpl
							.pattern_ParameterizedType2Class_21_5_Addmatchtoruleresult_blackBBBB(match,
									__performOperation, __result, isApplicableCC);
					if (result5_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match
								+ ", " + "[__performOperation] = " + __performOperation + ", " + "[__result] = "
					...
					ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_21_5_Addmatchtoruleresult_greenBBBB(
							match, __performOperation, __result, isApplicableCC);
		...
		return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_21_6_expressionFB(__result);
	}
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result1_black = ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_24_1_prepare_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_24_1_prepare_greenF();
		IsApplicableRuleResult result = (IsApplicableRuleResult) result1_green[0];

		Object[] result2_bindingAndBlack = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(sourceMatch,
						targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		// 
		if (ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : ParameterizedType2ClassImpl
				...
				ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_24_7_addtoreturnedresult_greenBB(result,
						ccMatch);
		...
		return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_24_8_expressionFB(result);
	}
	...
	public boolean checkDEC_FWD(AbstractTypeDeclaration nonParamType, ParameterizedType parameterizedType,
		...
		if (result1_black != null) {
			...
			return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_27_3_expressionF();
		}
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(org.eclipse.uml2.uml.Package umlPackage, org.eclipse.uml2.uml.Class nonParamElement,
			org.eclipse.uml2.uml.Class parameterizedClassifier) {// 
		Object[] result1_black = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_28_1_matchtggpattern_blackBBB(umlPackage, nonParamElement,
						parameterizedClassifier);
		if (result1_black != null) {
			return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_28_2_expressionF();
		} else {
			return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_28_3_expressionF();
		}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		Object[] result1_green = ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_29_1_createresult_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach 
		for (Object[] result2_black : ParameterizedType2ClassImpl
				.pattern_ParameterizedType2Class_29_2_isapplicablecore_blackFFFFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			Object[] result3_bindingAndBlack = ParameterizedType2ClassImpl
					.pattern_ParameterizedType2Class_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							umlPackage, nonParamElement, ne2neNonParam, nonParamType, nonParamPackage, jp2up,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[umlPackage] = " + umlPackage + ", "
			...
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = ParameterizedType2ClassImpl
						.pattern_ParameterizedType2Class_29_5_checknacs_blackBBBBBB(umlPackage, nonParamElement,
								ne2neNonParam, nonParamType, nonParamPackage, jp2up);
				if (result5_black != null) {

					Object[] result6_black = ParameterizedType2ClassImpl
							.pattern_ParameterizedType2Class_29_6_perform_blackBBBBBBB(umlPackage, nonParamElement,
					...
					ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_29_6_perform_greenBFBFFFBB(umlPackage,
		...
		return ParameterizedType2ClassImpl.pattern_ParameterizedType2Class_29_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PACKAGE_CLASS_NAMEDELEMENT2NAMEDELEMENT_ABSTRACTTYPEDECLARATION_PARAMETERIZEDTYPE_PACKAGE_JAVAPACKAGE2UMLPACKAGE_TYPEACCESS:
		...
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
			registerObjects_FWD((PerformRuleResult) arguments.get(0), (EObject) arguments.get(1),
					(EObject) arguments.get(2), (EObject) arguments.get(3), (EObject) arguments.get(4),
					(EObject) arguments.get(5), (EObject) arguments.get(6), (EObject) arguments.get(7),
					(EObject) arguments.get(8), (EObject) arguments.get(9), (EObject) arguments.get(10));
			return null;
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___CHECK_TYPES_FWD__MATCH:
			return checkTypes_FWD((Match) arguments.get(0));
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___IS_APPROPRIATE_BWD__MATCH_PACKAGE_CLASS_CLASS:
		...
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___PERFORM_BWD__ISAPPLICABLEMATCH:
			return perform_BWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___IS_APPLICABLE_BWD__MATCH:
			return isApplicable_BWD((Match) arguments.get(0));
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_PACKAGE_CLASS_CLASS:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (org.eclipse.uml2.uml.Package) arguments.get(1),
					(org.eclipse.uml2.uml.Class) arguments.get(2), (org.eclipse.uml2.uml.Class) arguments.get(3));
			return null;
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_PACKAGE_CLASS_CLASS:
		...
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_67__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_67((EMoflonEdge) arguments.get(0));
		case RulesPackage.PARAMETERIZED_TYPE2_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_68__EMOFLONEDGE:
	...
	public static final Object[] pattern_ParameterizedType2Class_0_2_SolveCSP_blackB(CSP csp) {
	...
	public static final Object[] pattern_ParameterizedType2Class_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		if (result_pattern_ParameterizedType2Class_0_2_SolveCSP_binding != null) {
			...
			Object[] result_pattern_ParameterizedType2Class_0_2_SolveCSP_black = pattern_ParameterizedType2Class_0_2_SolveCSP_blackB(
					csp);
	...
	public static final boolean pattern_ParameterizedType2Class_0_3_CheckCSP_expressionFBB(
			ParameterizedType2Class _this, CSP csp) {
	...
	public static final boolean pattern_ParameterizedType2Class_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_ParameterizedType2Class_0_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_1_1_performtransformation_bindingFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_ParameterizedType2Class_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
			ParameterizedType2Class _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_ParameterizedType2Class_1_1_performtransformation_binding = pattern_ParameterizedType2Class_1_1_performtransformation_bindingFFFFFFFFB(
				isApplicableMatch);
	...
	public static final Object[] pattern_ParameterizedType2Class_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
	...
	public static final PerformRuleResult pattern_ParameterizedType2Class_1_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_2_1_preparereturnvalue_bindingFB(
			ParameterizedType2Class _this) {
	...
	public static final Object[] pattern_ParameterizedType2Class_2_1_preparereturnvalue_blackFBB(EClass eClass,
			ParameterizedType2Class _this) {
	...
	public static final Object[] pattern_ParameterizedType2Class_2_1_preparereturnvalue_bindingAndBlackFFB(
			ParameterizedType2Class _this) {
		Object[] result_pattern_ParameterizedType2Class_2_1_preparereturnvalue_binding = pattern_ParameterizedType2Class_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_ParameterizedType2Class_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_ParameterizedType2Class_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_ParameterizedType2Class_2_1_preparereturnvalue_black = pattern_ParameterizedType2Class_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_ParameterizedType2Class_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_ParameterizedType2Class_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_ParameterizedType2Class_2_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "ParameterizedType2Class";
	...
	public static final Object[] pattern_ParameterizedType2Class_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_ParameterizedType2Class_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		if (result_pattern_ParameterizedType2Class_2_4_solveCSP_binding != null) {
			...
			Object[] result_pattern_ParameterizedType2Class_2_4_solveCSP_black = pattern_ParameterizedType2Class_2_4_solveCSP_blackB(
					csp);
	...
	public static final boolean pattern_ParameterizedType2Class_2_5_checkCSP_expressionFBB(
			ParameterizedType2Class _this, CSP csp) {
	...
	public static final Object[] pattern_ParameterizedType2Class_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_ParameterizedType2Class_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "ParameterizedType2Class";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_ParameterizedType2Class_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_10_1_initialbindings_blackBBBBB(
			ParameterizedType2Class _this, Match match, org.eclipse.uml2.uml.Package umlPackage,
			org.eclipse.uml2.uml.Class nonParamElement, org.eclipse.uml2.uml.Class parameterizedClassifier) {
		if (!nonParamElement.equals(parameterizedClassifier)) {
	...
	public static final Object[] pattern_ParameterizedType2Class_10_2_SolveCSP_bindingFBBBBB(
			ParameterizedType2Class _this, Match match, org.eclipse.uml2.uml.Package umlPackage,
			org.eclipse.uml2.uml.Class nonParamElement, org.eclipse.uml2.uml.Class parameterizedClassifier) {
	...
	public static final Object[] pattern_ParameterizedType2Class_10_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_ParameterizedType2Class_10_2_SolveCSP_bindingAndBlackFBBBBB(
			ParameterizedType2Class _this, Match match, org.eclipse.uml2.uml.Package umlPackage,
			org.eclipse.uml2.uml.Class nonParamElement, org.eclipse.uml2.uml.Class parameterizedClassifier) {
		Object[] result_pattern_ParameterizedType2Class_10_2_SolveCSP_binding = pattern_ParameterizedType2Class_10_2_SolveCSP_bindingFBBBBB(
				_this, match, umlPackage, nonParamElement, parameterizedClassifier);
		if (result_pattern_ParameterizedType2Class_10_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_ParameterizedType2Class_10_2_SolveCSP_binding[0];

			Object[] result_pattern_ParameterizedType2Class_10_2_SolveCSP_black = pattern_ParameterizedType2Class_10_2_SolveCSP_blackB(
					csp);
			if (result_pattern_ParameterizedType2Class_10_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_ParameterizedType2Class_10_3_CheckCSP_expressionFBB(
			ParameterizedType2Class _this, CSP csp) {
	...
	public static final Object[] pattern_ParameterizedType2Class_10_4_collectelementstobetranslated_blackBBBB(
			Match match, org.eclipse.uml2.uml.Package umlPackage, org.eclipse.uml2.uml.Class nonParamElement,
			org.eclipse.uml2.uml.Class parameterizedClassifier) {
		if (!nonParamElement.equals(parameterizedClassifier)) {
	...
	public static final Object[] pattern_ParameterizedType2Class_10_4_collectelementstobetranslated_greenBBBF(
	...
	public static final Object[] pattern_ParameterizedType2Class_10_5_collectcontextelements_blackBBBB(Match match,
			org.eclipse.uml2.uml.Package umlPackage, org.eclipse.uml2.uml.Class nonParamElement,
			org.eclipse.uml2.uml.Class parameterizedClassifier) {
		if (!nonParamElement.equals(parameterizedClassifier)) {
			return new Object[] { match, umlPackage, nonParamElement, parameterizedClassifier };
	...
	public static final Object[] pattern_ParameterizedType2Class_10_5_collectcontextelements_greenBBBF(Match match,
			org.eclipse.uml2.uml.Package umlPackage, org.eclipse.uml2.uml.Class nonParamElement) {
		EMoflonEdge umlPackage__nonParamElement____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_ParameterizedType2Class_10_6_registerobjectstomatch_expressionBBBBB(
			ParameterizedType2Class _this, Match match, org.eclipse.uml2.uml.Package umlPackage,
			org.eclipse.uml2.uml.Class nonParamElement, org.eclipse.uml2.uml.Class parameterizedClassifier) {
	...
	public static final boolean pattern_ParameterizedType2Class_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_ParameterizedType2Class_10_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_11_1_performtransformation_bindingFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("umlPackage");
		EObject _localVariable_1 = isApplicableMatch.getObject("nonParamElement");
		EObject _localVariable_2 = isApplicableMatch.getObject("ne2neNonParam");
	...
	public static final Object[] pattern_ParameterizedType2Class_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
			ParameterizedType2Class _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_ParameterizedType2Class_11_1_performtransformation_binding = pattern_ParameterizedType2Class_11_1_performtransformation_bindingFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_ParameterizedType2Class_11_1_performtransformation_binding != null) {
			...
			JavaPackage2UmlPackage jp2up = (JavaPackage2UmlPackage) result_pattern_ParameterizedType2Class_11_1_performtransformation_binding[6];

			Object[] result_pattern_ParameterizedType2Class_11_1_performtransformation_black = pattern_ParameterizedType2Class_11_1_performtransformation_blackBBBBBBBFBB(
			...
			if (result_pattern_ParameterizedType2Class_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_ParameterizedType2Class_11_1_performtransformation_black[7];
	...
	public static final Object[] pattern_ParameterizedType2Class_11_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject umlPackage, EObject parameterizedClassifier, EObject nonParamType,
			EObject parameterizedType, EObject ne2ne, EObject typeTypeAccess) {
		EMoflonEdge umlPackage__parameterizedClassifier____packagedElement = RuntimeFactory.eINSTANCE
				.createEMoflonEdge();
	...
	public static final PerformRuleResult pattern_ParameterizedType2Class_11_6_expressionFB(
			PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_12_1_preparereturnvalue_bindingFB(
			ParameterizedType2Class _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_ParameterizedType2Class_12_1_preparereturnvalue_blackFBB(EClass eClass,
			ParameterizedType2Class _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperation_name = performOperation.getName();
	...
	public static final Object[] pattern_ParameterizedType2Class_12_1_preparereturnvalue_bindingAndBlackFFB(
			ParameterizedType2Class _this) {
		Object[] result_pattern_ParameterizedType2Class_12_1_preparereturnvalue_binding = pattern_ParameterizedType2Class_12_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_ParameterizedType2Class_12_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_ParameterizedType2Class_12_1_preparereturnvalue_binding[0];

			Object[] result_pattern_ParameterizedType2Class_12_1_preparereturnvalue_black = pattern_ParameterizedType2Class_12_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_ParameterizedType2Class_12_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_ParameterizedType2Class_12_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_ParameterizedType2Class_12_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "ParameterizedType2Class";
	...
	public static final Object[] pattern_ParameterizedType2Class_12_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_ParameterizedType2Class_12_2_corematch_blackBBFBFFFB(
			org.eclipse.uml2.uml.Package umlPackage, org.eclipse.uml2.uml.Class nonParamElement,
	...
	public static final Object[] pattern_ParameterizedType2Class_12_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_ParameterizedType2Class_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedType2Class_12_4_solveCSP_binding = pattern_ParameterizedType2Class_12_4_solveCSP_bindingFBBBBBBBBB(
				...
				nonParamType, nonParamPackage, jp2up);
		if (result_pattern_ParameterizedType2Class_12_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_ParameterizedType2Class_12_4_solveCSP_binding[0];

			Object[] result_pattern_ParameterizedType2Class_12_4_solveCSP_black = pattern_ParameterizedType2Class_12_4_solveCSP_blackB(
					csp);
			if (result_pattern_ParameterizedType2Class_12_4_solveCSP_black != null) {
	...
	public static final boolean pattern_ParameterizedType2Class_12_5_checkCSP_expressionFBB(
			ParameterizedType2Class _this, CSP csp) {
	...
	public static final Object[] pattern_ParameterizedType2Class_12_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_ParameterizedType2Class_12_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "ParameterizedType2Class";
	...
	public static final IsApplicableRuleResult pattern_ParameterizedType2Class_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_20_1_preparereturnvalue_bindingFB(
			ParameterizedType2Class _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_ParameterizedType2Class_20_1_preparereturnvalue_blackFBBF(EClass __eClass,
			ParameterizedType2Class _this) {
	...
	public static final Object[] pattern_ParameterizedType2Class_20_1_preparereturnvalue_bindingAndBlackFFBF(
			ParameterizedType2Class _this) {
		Object[] result_pattern_ParameterizedType2Class_20_1_preparereturnvalue_binding = pattern_ParameterizedType2Class_20_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_ParameterizedType2Class_20_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_ParameterizedType2Class_20_1_preparereturnvalue_binding[0];

			Object[] result_pattern_ParameterizedType2Class_20_1_preparereturnvalue_black = pattern_ParameterizedType2Class_20_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_ParameterizedType2Class_20_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ParameterizedType2Class_20_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_ParameterizedType2Class_20_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_ParameterizedType2Class_20_1_preparereturnvalue_greenF() {
	...
	public static final Object[] pattern_ParameterizedType2Class_20_2_testcorematchandDECs_black_nac_0BB(
		...
		if (!nonParamElement.equals(parameterizedClassifier)) {
			for (org.eclipse.uml2.uml.Class __DEC_parameterizedClassifier_nestedClassifier_306947 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(parameterizedClassifier, org.eclipse.uml2.uml.Class.class,
							"nestedClassifier")) {
				if (!parameterizedClassifier.equals(__DEC_parameterizedClassifier_nestedClassifier_306947)) {
					if (!nonParamElement.equals(__DEC_parameterizedClassifier_nestedClassifier_306947)) {
	...
	public static final Object[] pattern_ParameterizedType2Class_20_2_testcorematchandDECs_black_nac_1B(
			org.eclipse.uml2.uml.Class parameterizedClassifier) {
		for (Interface __DEC_parameterizedClassifier_nestedClassifier_823663 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedType2Class_20_2_testcorematchandDECs_greenFB(EClass __eClass) {
	...
	public static final boolean pattern_ParameterizedType2Class_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			ParameterizedType2Class _this, Match match, org.eclipse.uml2.uml.Package umlPackage,
			org.eclipse.uml2.uml.Class nonParamElement, org.eclipse.uml2.uml.Class parameterizedClassifier) {
	...
	public static final boolean pattern_ParameterizedType2Class_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			ParameterizedType2Class _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_BWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_20_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_ParameterizedType2Class_20_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_ParameterizedType2Class_20_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_21_1_preparereturnvalue_bindingFB(
			ParameterizedType2Class _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_ParameterizedType2Class_21_1_preparereturnvalue_blackFBBF(EClass __eClass,
			ParameterizedType2Class _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperation_name = __performOperation.getName();
	...
	public static final Object[] pattern_ParameterizedType2Class_21_1_preparereturnvalue_bindingAndBlackFFBF(
			ParameterizedType2Class _this) {
		Object[] result_pattern_ParameterizedType2Class_21_1_preparereturnvalue_binding = pattern_ParameterizedType2Class_21_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_ParameterizedType2Class_21_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_ParameterizedType2Class_21_1_preparereturnvalue_binding[0];

			Object[] result_pattern_ParameterizedType2Class_21_1_preparereturnvalue_black = pattern_ParameterizedType2Class_21_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_ParameterizedType2Class_21_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_ParameterizedType2Class_21_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_ParameterizedType2Class_21_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_ParameterizedType2Class_21_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_typeTypeAccess_superInterfaces_932781 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!nonParamType.equals(__DEC_typeTypeAccess_superInterfaces_932781)) {
	...
	public static final Object[] pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess typeTypeAccess) {
		for (Annotation __DEC_typeTypeAccess_type_697188 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess typeTypeAccess) {
		for (ArrayType __DEC_typeTypeAccess_elementType_140104 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_3BB(
			TypeAccess typeTypeAccess, AbstractTypeDeclaration nonParamType) {
		for (ClassDeclaration __DEC_typeTypeAccess_superClass_105323 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!nonParamType.equals(__DEC_typeTypeAccess_superClass_105323)) {
				return new Object[] { typeTypeAccess, nonParamType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess typeTypeAccess) {
		for (MethodDeclaration __DEC_typeTypeAccess_returnType_158085 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess typeTypeAccess) {
		for (SingleVariableDeclaration __DEC_typeTypeAccess_type_832702 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeTypeAccess) {
		for (AnnotationMemberValuePair __DEC_typeTypeAccess_value_740624 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess typeTypeAccess) {
		for (ArrayInitializer __DEC_typeTypeAccess_expressions_883495 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_ParameterizedType2Class_21_2_testcorematchandDECs_blackFFFFB(
			...
			if (tmpTypeTypeAccess instanceof TypeAccess) {
				...
				if (typeTypeAccess.equals(parameterizedType.getType())) {
					...
					if (tmpNonParamType instanceof AbstractTypeDeclaration) {
						...
						if (nonParamPackage != null) {
							if (pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_1B(
									typeTypeAccess) == null) {
								if (pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_2B(
										typeTypeAccess) == null) {
									if (pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_4B(
											typeTypeAccess) == null) {
										if (pattern_ParameterizedType2Class_21_2_testcorematchandDECs_black_nac_5B(
												typeTypeAccess) == null) {
	...
	public static final Object[] pattern_ParameterizedType2Class_21_2_testcorematchandDECs_greenFB(EClass __eClass) {
		Match match = RuntimeFactory.eINSTANCE.createMatch();
		String __eClass_name = __eClass.getName();
		String match_ruleName_prime = __eClass_name;
		match.setRuleName(match_ruleName_prime);
	...
	public static final boolean pattern_ParameterizedType2Class_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			ParameterizedType2Class _this, Match match) {
	...
	public static final Object[] pattern_ParameterizedType2Class_21_5_Addmatchtoruleresult_blackBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		if (!__performOperation.equals(isApplicableCC)) {
			return new Object[] { match, __performOperation, __result, isApplicableCC };
		}
	...
	public static final Object[] pattern_ParameterizedType2Class_21_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
		match.setIsApplicableCCOperation(isApplicableCC);
	...
	public static final EObjectContainer pattern_ParameterizedType2Class_21_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_24_1_prepare_blackB(ParameterizedType2Class _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_ParameterizedType2Class_24_1_prepare_greenF() {
		IsApplicableRuleResult result = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		return new Object[] { result };
	}

	public static final Object[] pattern_ParameterizedType2Class_24_2_matchsrctrgcontext_bindingFFFFFFFBB(
	...
	public static final Object[] pattern_ParameterizedType2Class_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_ParameterizedType2Class_24_2_matchsrctrgcontext_binding = pattern_ParameterizedType2Class_24_2_matchsrctrgcontext_bindingFFFFFFFBB(
				targetMatch, sourceMatch);
		if (result_pattern_ParameterizedType2Class_24_2_matchsrctrgcontext_binding != null) {
			org.eclipse.uml2.uml.Package umlPackage = (org.eclipse.uml2.uml.Package) result_pattern_ParameterizedType2Class_24_2_matchsrctrgcontext_binding[0];
	...
	public static final Object[] pattern_ParameterizedType2Class_24_3_solvecsp_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_ParameterizedType2Class_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		if (result_pattern_ParameterizedType2Class_24_3_solvecsp_binding != null) {
			...
			Object[] result_pattern_ParameterizedType2Class_24_3_solvecsp_black = pattern_ParameterizedType2Class_24_3_solvecsp_blackB(
					csp);
	...
	public static final boolean pattern_ParameterizedType2Class_24_4_checkCSP_expressionFB(CSP csp) {
		boolean _localVariable_0 = csp.check();
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Iterable<Object[]> pattern_ParameterizedType2Class_24_5_matchcorrcontext_blackBBFBBFBB(
			org.eclipse.uml2.uml.Package umlPackage, org.eclipse.uml2.uml.Class nonParamElement,
			AbstractTypeDeclaration nonParamType, org.eclipse.modisco.java.Package nonParamPackage, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (NamedElement2NamedElement ne2neNonParam : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedType2Class_24_7_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
		return new Object[] { result, ccMatch };
	}

	public static final Object[] pattern_ParameterizedType2Class_24_7_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
	...
	public static final IsApplicableRuleResult pattern_ParameterizedType2Class_24_8_expressionFB(
	...
	public static final Object[] pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_0BB(
			TypeAccess typeTypeAccess, AbstractTypeDeclaration nonParamType) {
		for (AbstractTypeDeclaration __DEC_typeTypeAccess_superInterfaces_264726 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!nonParamType.equals(__DEC_typeTypeAccess_superInterfaces_264726)) {
				return new Object[] { typeTypeAccess, nonParamType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeTypeAccess) {
		for (Annotation __DEC_typeTypeAccess_type_705054 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, Annotation.class, "type")) {
			return new Object[] { typeTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_2B(
			TypeAccess typeTypeAccess) {
		for (ArrayType __DEC_typeTypeAccess_elementType_646577 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { typeTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_3BB(
			TypeAccess typeTypeAccess, AbstractTypeDeclaration nonParamType) {
		for (ClassDeclaration __DEC_typeTypeAccess_superClass_665363 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!nonParamType.equals(__DEC_typeTypeAccess_superClass_665363)) {
				return new Object[] { typeTypeAccess, nonParamType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_4B(
			TypeAccess typeTypeAccess) {
		for (MethodDeclaration __DEC_typeTypeAccess_returnType_980918 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { typeTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_5B(
			TypeAccess typeTypeAccess) {
		for (SingleVariableDeclaration __DEC_typeTypeAccess_type_654683 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, SingleVariableDeclaration.class, "type")) {
			return new Object[] { typeTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeTypeAccess) {
		for (AnnotationMemberValuePair __DEC_typeTypeAccess_value_466021 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_7B(
			TypeAccess typeTypeAccess) {
		for (ArrayInitializer __DEC_typeTypeAccess_expressions_417551 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeTypeAccess, ArrayInitializer.class, "expressions")) {
			return new Object[] { typeTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedType2Class_27_1_matchtggpattern_blackBBBB(
		...
		if (typeTypeAccess.equals(parameterizedType.getType())) {
			if (nonParamType.equals(typeTypeAccess.getType())) {
				if (nonParamPackage.getOwnedElements().contains(nonParamType)) {
					if (pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_0BB(typeTypeAccess,
							nonParamType) == null) {
						if (pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_1B(typeTypeAccess) == null) {
							if (pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_2B(
									typeTypeAccess) == null) {
								if (pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_3BB(typeTypeAccess,
										nonParamType) == null) {
									if (pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_4B(
											typeTypeAccess) == null) {
										if (pattern_ParameterizedType2Class_27_1_matchtggpattern_black_nac_5B(
												typeTypeAccess) == null) {
	...
	public static final boolean pattern_ParameterizedType2Class_27_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_ParameterizedType2Class_27_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}
	...
	public static final Object[] pattern_ParameterizedType2Class_28_1_matchtggpattern_black_nac_0BB(
			org.eclipse.uml2.uml.Class parameterizedClassifier, org.eclipse.uml2.uml.Class nonParamElement) {
		if (!nonParamElement.equals(parameterizedClassifier)) {
			for (org.eclipse.uml2.uml.Class __DEC_parameterizedClassifier_nestedClassifier_420158 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(parameterizedClassifier, org.eclipse.uml2.uml.Class.class,
							"nestedClassifier")) {
				if (!parameterizedClassifier.equals(__DEC_parameterizedClassifier_nestedClassifier_420158)) {
					if (!nonParamElement.equals(__DEC_parameterizedClassifier_nestedClassifier_420158)) {
						return new Object[] { parameterizedClassifier, nonParamElement };
					}
				}
			}
	...
	public static final Object[] pattern_ParameterizedType2Class_28_1_matchtggpattern_black_nac_1B(
			org.eclipse.uml2.uml.Class parameterizedClassifier) {
		for (Interface __DEC_parameterizedClassifier_nestedClassifier_685134 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(parameterizedClassifier, Interface.class, "nestedClassifier")) {
			return new Object[] { parameterizedClassifier };
		}
		return null;
	...
	public static final boolean pattern_ParameterizedType2Class_28_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_ParameterizedType2Class_28_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_ParameterizedType2Class_29_1_createresult_blackB(
			ParameterizedType2Class _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_ParameterizedType2Class_29_1_createresult_greenFF() {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_0BB(
	...
	public static final Object[] pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_1BB(
	...
	public static final Object[] pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_3BB(
	...
	public static final Object[] pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Iterable<Object[]> pattern_ParameterizedType2Class_29_2_isapplicablecore_blackFFFFFFFBB(
				...
				if (tmpNe2neNonParam instanceof NamedElement2NamedElement) {
					...
					if (tmpNonParamElement instanceof org.eclipse.uml2.uml.Class) {
						...
						if (tmpNonParamType instanceof AbstractTypeDeclaration) {
							...
							org.eclipse.modisco.java.Package nonParamPackage = nonParamType.getPackage();
							if (nonParamPackage != null) {
								if (pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_2BB(ruleResult,
										ne2neNonParam) == null) {
									if (pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_1BB(ruleResult,
											nonParamElement) == null) {
										if (pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_3BB(
												ruleResult, nonParamType) == null) {
											if (pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_4BB(
												...
												for (org.eclipse.uml2.uml.Package umlPackage : org.moflon.core.utilities.eMoflonEMFUtil
														.getOppositeReferenceTyped(nonParamElement,
																...
																"packagedElement")) {
													if (pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_0BB(
															ruleResult, umlPackage) == null) {
														for (JavaPackage2UmlPackage jp2up : org.moflon.core.utilities.eMoflonEMFUtil
																.getOppositeReferenceTyped(nonParamPackage,
																		JavaPackage2UmlPackage.class, "source")) {
															if (umlPackage.equals(jp2up.getTarget())) {
																if (pattern_ParameterizedType2Class_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Object[] pattern_ParameterizedType2Class_29_3_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}
	...
	public static final Object[] pattern_ParameterizedType2Class_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedType2Class_29_3_solveCSP_binding = pattern_ParameterizedType2Class_29_3_solveCSP_bindingFBBBBBBBBB(
				...
				jp2up, ruleResult);
		if (result_pattern_ParameterizedType2Class_29_3_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_ParameterizedType2Class_29_3_solveCSP_binding[0];

			Object[] result_pattern_ParameterizedType2Class_29_3_solveCSP_black = pattern_ParameterizedType2Class_29_3_solveCSP_blackB(
					csp);
			if (result_pattern_ParameterizedType2Class_29_3_solveCSP_black != null) {
	...
	public static final boolean pattern_ParameterizedType2Class_29_4_checkCSP_expressionFBB(
			ParameterizedType2Class _this, CSP csp) {
	...
	public static final Object[] pattern_ParameterizedType2Class_29_6_perform_greenBFBFFFBB(
	...
	public static final ModelgeneratorRuleResult pattern_ParameterizedType2Class_29_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
