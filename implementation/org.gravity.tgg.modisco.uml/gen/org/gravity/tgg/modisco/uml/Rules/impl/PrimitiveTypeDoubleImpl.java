...
public class PrimitiveTypeDoubleImpl extends AbstractRuleImpl implements PrimitiveTypeDouble {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {

		Object[] result1_black = PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_0_1_initialbindings_blackBBBB(this,
				match, jm, jpt);
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_0_2_SolveCSP_bindingAndBlackFBBBB(this, match, jm, jpt);
		...
		if (PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_0_4_collectelementstobetranslated_blackBBB(match, jm, jpt);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[jm] = " + jm + ", " + "[jpt] = " + jpt + ".");
			}
			PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_0_4_collectelementstobetranslated_greenBBBF(match, jm,
					jpt);
			//nothing EMoflonEdge jm__jpt____orphanTypes = (EMoflonEdge) result4_green[3];

			Object[] result5_black = PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_0_5_collectcontextelements_blackBBB(match, jm, jpt);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[jm] = " + jm + ", " + "[jpt] = " + jpt + ".");
			}
			PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_0_5_collectcontextelements_greenBB(match, jm);

			// 
			PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_0_6_registerobjectstomatch_expressionBBBB(this, match,
					jm, jpt);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_1_1_performtransformation_bindingAndBlackFFFFFBB(this, isApplicableMatch);
		...
		org.eclipse.modisco.java.PrimitiveTypeDouble jpt = (org.eclipse.modisco.java.PrimitiveTypeDouble) result1_bindingAndBlack[3];
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_1_1_performtransformation_greenFBFBB(up, jpt, csp);
		...
		Object[] result2_black = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_1_2_collecttranslatedelements_blackBBB(umpt, jpt2upt2, jpt);
		...
		Object[] result2_green = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_1_2_collecttranslatedelements_greenFBBB(umpt, jpt2upt2, jpt);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, jm2up, jm, umpt, up,
						jpt2upt2, jpt);
		...
		PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, jm,
		...
		// 
		// 
		PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_2_2_corematch_bindingFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		Model jm = (Model) result2_binding[0];
		org.eclipse.modisco.java.PrimitiveTypeDouble jpt = (org.eclipse.modisco.java.PrimitiveTypeDouble) result2_binding[1];
		for (Object[] result2_black : PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_2_2_corematch_blackFBFBB(jm,
				jpt, match)) {
			...
			for (Object[] result3_black : PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_2_3_findcontext_blackBBBB(jm2up, jm, up, jpt)) {
				Object[] result3_green = PrimitiveTypeDoubleImpl
						.pattern_PrimitiveTypeDouble_2_3_findcontext_greenBBBBFFFF(jm2up, jm, up, jpt);
				...
				Object[] result4_bindingAndBlack = PrimitiveTypeDoubleImpl
						.pattern_PrimitiveTypeDouble_2_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, jm2up,
								jm, up, jpt);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {// Create CSP
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage jm2up, Model jm,
			org.eclipse.uml2.uml.Package up, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public boolean isAppropriate_BWD(Match match, PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
		...
		Object[] result1_black = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_10_1_initialbindings_blackBBBB(this, match, umpt, up);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_10_2_SolveCSP_bindingAndBlackFBBBB(this, match, umpt, up);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[umpt] = " + umpt + ", " + "[up] = " + up + ".");
		}
		...
		if (PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_10_4_collectelementstobetranslated_blackBBB(match, umpt, up);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umpt] = " + umpt + ", " + "[up] = " + up + ".");
			}
			PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_10_4_collectelementstobetranslated_greenBBBF(match,
					umpt, up);
			//nothing EMoflonEdge up__umpt____packagedElement = (EMoflonEdge) result4_green[3];

			Object[] result5_black = PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_10_5_collectcontextelements_blackBBB(match, umpt, up);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umpt] = " + umpt + ", " + "[up] = " + up + ".");
			}
			PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_10_5_collectcontextelements_greenBB(match, up);

			// 
			PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_10_6_registerobjectstomatch_expressionBBBB(this, match,
					umpt, up);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_11_1_performtransformation_bindingAndBlackFFFFFBB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		...
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_11_1_performtransformation_greenBBFFB(jm, umpt, csp);
		NamedElement2NamedElement jpt2upt2 = (NamedElement2NamedElement) result1_green[2];
		org.eclipse.modisco.java.PrimitiveTypeDouble jpt = (org.eclipse.modisco.java.PrimitiveTypeDouble) result1_green[3];

		Object[] result2_black = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_11_2_collecttranslatedelements_blackBBB(umpt, jpt2upt2, jpt);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[umpt] = " + umpt + ", "
					+ "[jpt2upt2] = " + jpt2upt2 + ", " + "[jpt] = " + jpt + ".");
		}
		Object[] result2_green = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_11_2_collecttranslatedelements_greenFBBB(umpt, jpt2upt2, jpt);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, jm2up, jm, umpt, up,
						jpt2upt2, jpt);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[jm2up] = " + jm2up + ", " + "[jm] = " + jm + ", " + "[umpt] = " + umpt + ", " + "[up] = "
		...
		PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_11_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult, jm,
				umpt, up, jpt2upt2, jpt);
		//nothing EMoflonEdge up__umpt____packagedElement = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge jm__jpt____orphanTypes = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge jpt2upt2__jpt____source = (EMoflonEdge) result3_green[8];
		...
		// 
		// 
		PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				jm2up, jm, umpt, up, jpt2upt2, jpt);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		// ForEach 
		Object[] result2_binding = PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_12_2_corematch_bindingFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		...
		for (Object[] result2_black : PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_12_2_corematch_blackFFBBB(umpt, up, match)) {
			JavaModel2UMLPackage jm2up = (JavaModel2UMLPackage) result2_black[0];
			Model jm = (Model) result2_black[1];
			// ForEach 
			for (Object[] result3_black : PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_12_3_findcontext_blackBBBB(jm2up, jm, umpt, up)) {
				Object[] result3_green = PrimitiveTypeDoubleImpl
						.pattern_PrimitiveTypeDouble_12_3_findcontext_greenBBBBFFFF(jm2up, jm, umpt, up);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				...
				Object[] result4_bindingAndBlack = PrimitiveTypeDoubleImpl
						.pattern_PrimitiveTypeDouble_12_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch,
								jm2up, jm, umpt, up);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[jm2up] = " + jm2up + ", "
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_352(EMoflonEdge _edge_packagedElement) {
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_20_2_testcorematchandDECs_blackFFB(_edge_packagedElement)) {
			...
			if (PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(this,
							match, umpt, up)) {
				// 
				if (PrimitiveTypeDoubleImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_361(EMoflonEdge _edge_orphanTypes) {
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_21_2_testcorematchandDECs_blackFFB(_edge_orphanTypes)) {
			Model jm = (Model) result2_black[0];
			org.eclipse.modisco.java.PrimitiveTypeDouble jpt = (org.eclipse.modisco.java.PrimitiveTypeDouble) result2_black[1];
			Object[] result2_green = PrimitiveTypeDoubleImpl
			...
			// 
			if (PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(this,
							match, jm, jpt)) {
				// 
				if (PrimitiveTypeDoubleImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		org.eclipse.modisco.java.PrimitiveTypeDouble jpt = (org.eclipse.modisco.java.PrimitiveTypeDouble) result2_bindingAndBlack[3];

		Object[] result3_bindingAndBlack = PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, jm, umpt, up, jpt, sourceMatch,
						targetMatch);
		...
		if (PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_24_5_matchcorrcontext_blackFBBBB(jm, up, sourceMatch, targetMatch)) {
				JavaModel2UMLPackage jm2up = (JavaModel2UMLPackage) result5_black[0];
				Object[] result5_green = PrimitiveTypeDoubleImpl
						.pattern_PrimitiveTypeDouble_24_5_matchcorrcontext_greenBBBF(jm2up, sourceMatch, targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[3];

				Object[] result6_black = PrimitiveTypeDoubleImpl
						.pattern_PrimitiveTypeDouble_24_6_createcorrespondence_blackBBBBB(jm, umpt, up, jpt, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jm] = " + jm + ", "
							+ "[umpt] = " + umpt + ", " + "[up] = " + up + ", " + "[jpt] = " + jpt + ", "
							+ "[ccMatch] = " + ccMatch + ".");
				}
				PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_24_6_createcorrespondence_greenBFBB(umpt, jpt,
						ccMatch);
	...
	public CSP isApplicable_solveCsp_CC(Model jm, PrimitiveType umpt, org.eclipse.uml2.uml.Package up,
			org.eclipse.modisco.java.PrimitiveTypeDouble jpt, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {// 
		Object[] result1_black = PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_27_1_matchtggpattern_blackBB(jm,
				jpt);
		if (result1_black != null) {
	...
	public boolean checkDEC_BWD(PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {// 
		Object[] result1_black = PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_28_1_matchtggpattern_blackBB(umpt,
				up);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		// ForEach 
		for (Object[] result2_black : PrimitiveTypeDoubleImpl
				.pattern_PrimitiveTypeDouble_29_2_isapplicablecore_blackFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			Object[] result3_bindingAndBlack = PrimitiveTypeDoubleImpl
					.pattern_PrimitiveTypeDouble_29_3_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch, jm2up,
							jm, up, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = PrimitiveTypeDoubleImpl
						.pattern_PrimitiveTypeDouble_29_5_checknacs_blackBBB(jm2up, jm, up);
				if (result5_black != null) {

					Object[] result6_black = PrimitiveTypeDoubleImpl
							.pattern_PrimitiveTypeDouble_29_6_perform_blackBBBB(jm2up, jm, up, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching failed." + " Variables: " + "[jm2up] = " + jm2up + ", " + "[jm] = "
										+ jm + ", " + "[up] = " + up + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					PrimitiveTypeDoubleImpl.pattern_PrimitiveTypeDouble_29_6_perform_greenBFBFFBB(jm, up, ruleResult,
							csp);
					...
					//nothing org.eclipse.modisco.java.PrimitiveTypeDouble jpt = (org.eclipse.modisco.java.PrimitiveTypeDouble) result6_green[4];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPROPRIATE_FWD__MATCH_MODEL_PRIMITIVETYPEDOUBLE:
			return isAppropriate_FWD((Match) arguments.get(0), (Model) arguments.get(1),
					(org.eclipse.modisco.java.PrimitiveTypeDouble) arguments.get(2));
		...
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MODEL_PRIMITIVETYPEDOUBLE:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (Model) arguments.get(1),
					(org.eclipse.modisco.java.PrimitiveTypeDouble) arguments.get(2));
			return null;
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MODEL_PRIMITIVETYPEDOUBLE:
		...
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_JAVAMODEL2UMLPACKAGE_MODEL_PACKAGE_PRIMITIVETYPEDOUBLE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(JavaModel2UMLPackage) arguments.get(1), (Model) arguments.get(2),
					(org.eclipse.uml2.uml.Package) arguments.get(3),
					(org.eclipse.modisco.java.PrimitiveTypeDouble) arguments.get(4));
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPLICABLE_CHECK_CSP_FWD__CSP:
			return isApplicable_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPROPRIATE_BWD__MATCH_PRIMITIVETYPE_PACKAGE:
		...
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_PRIMITIVETYPE_PACKAGE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (PrimitiveType) arguments.get(1),
					(org.eclipse.uml2.uml.Package) arguments.get(2));
			return null;
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_PRIMITIVETYPE_PACKAGE:
		...
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_JAVAMODEL2UMLPACKAGE_MODEL_PRIMITIVETYPE_PACKAGE:
		...
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_352__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_352((EMoflonEdge) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_361__EMOFLONEDGE:
		...
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPLICABLE_SOLVE_CSP_CC__MODEL_PRIMITIVETYPE_PACKAGE_PRIMITIVETYPEDOUBLE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Model) arguments.get(0), (PrimitiveType) arguments.get(1),
					(org.eclipse.uml2.uml.Package) arguments.get(2),
					(org.eclipse.modisco.java.PrimitiveTypeDouble) arguments.get(3), (Match) arguments.get(4),
					(Match) arguments.get(5));
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___IS_APPLICABLE_CHECK_CSP_CC__CSP:
			return isApplicable_checkCsp_CC((CSP) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___CHECK_DEC_FWD__MODEL_PRIMITIVETYPEDOUBLE:
			return checkDEC_FWD((Model) arguments.get(0),
					(org.eclipse.modisco.java.PrimitiveTypeDouble) arguments.get(1));
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___CHECK_DEC_BWD__PRIMITIVETYPE_PACKAGE:
			return checkDEC_BWD((PrimitiveType) arguments.get(0), (org.eclipse.uml2.uml.Package) arguments.get(1));
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___GENERATE_MODEL__RULEENTRYCONTAINER_JAVAMODEL2UMLPACKAGE:
			return generateModel((RuleEntryContainer) arguments.get(0), (JavaModel2UMLPackage) arguments.get(1));
		case RulesPackage.PRIMITIVE_TYPE_DOUBLE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_JAVAMODEL2UMLPACKAGE_MODEL_PACKAGE_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_PrimitiveTypeDouble_0_1_initialbindings_blackBBBB(PrimitiveTypeDouble _this,
			Match match, Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		return new Object[] { _this, match, jm, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeDouble_0_2_SolveCSP_bindingFBBBB(PrimitiveTypeDouble _this,
			Match match, Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_0_2_SolveCSP_bindingAndBlackFBBBB(
			PrimitiveTypeDouble _this, Match match, Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		Object[] result_pattern_PrimitiveTypeDouble_0_2_SolveCSP_binding = pattern_PrimitiveTypeDouble_0_2_SolveCSP_bindingFBBBB(
				_this, match, jm, jpt);
	...
	public static final Object[] pattern_PrimitiveTypeDouble_0_4_collectelementstobetranslated_blackBBB(Match match,
			Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		return new Object[] { match, jm, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeDouble_0_4_collectelementstobetranslated_greenBBBF(Match match,
			Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_0_5_collectcontextelements_blackBBB(Match match, Model jm,
			org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		return new Object[] { match, jm, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeDouble_0_5_collectcontextelements_greenBB(Match match, Model jm) {
		match.getContextNodes().add(jm);
		return new Object[] { match, jm };
	}

	public static final void pattern_PrimitiveTypeDouble_0_6_registerobjectstomatch_expressionBBBB(
			PrimitiveTypeDouble _this, Match match, Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_1_1_performtransformation_bindingFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_1_1_performtransformation_blackBBBBFBB(
	...
	public static final Object[] pattern_PrimitiveTypeDouble_1_1_performtransformation_bindingAndBlackFFFFFBB(
			PrimitiveTypeDouble _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_PrimitiveTypeDouble_1_1_performtransformation_binding = pattern_PrimitiveTypeDouble_1_1_performtransformation_bindingFFFFB(
				isApplicableMatch);
		if (result_pattern_PrimitiveTypeDouble_1_1_performtransformation_binding != null) {
			JavaModel2UMLPackage jm2up = (JavaModel2UMLPackage) result_pattern_PrimitiveTypeDouble_1_1_performtransformation_binding[0];
			Model jm = (Model) result_pattern_PrimitiveTypeDouble_1_1_performtransformation_binding[1];
			org.eclipse.uml2.uml.Package up = (org.eclipse.uml2.uml.Package) result_pattern_PrimitiveTypeDouble_1_1_performtransformation_binding[2];
			org.eclipse.modisco.java.PrimitiveTypeDouble jpt = (org.eclipse.modisco.java.PrimitiveTypeDouble) result_pattern_PrimitiveTypeDouble_1_1_performtransformation_binding[3];

			Object[] result_pattern_PrimitiveTypeDouble_1_1_performtransformation_black = pattern_PrimitiveTypeDouble_1_1_performtransformation_blackBBBBFBB(
					jm2up, jm, up, jpt, _this, isApplicableMatch);
			if (result_pattern_PrimitiveTypeDouble_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_PrimitiveTypeDouble_1_1_performtransformation_black[4];
	...
	public static final Object[] pattern_PrimitiveTypeDouble_1_1_performtransformation_greenFBFBB(
			org.eclipse.uml2.uml.Package up, org.eclipse.modisco.java.PrimitiveTypeDouble jpt, CSP csp) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_1_2_collecttranslatedelements_blackBBB(PrimitiveType umpt,
			NamedElement2NamedElement jpt2upt2, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		return new Object[] { umpt, jpt2upt2, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeDouble_1_2_collecttranslatedelements_greenFBBB(PrimitiveType umpt,
			NamedElement2NamedElement jpt2upt2, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_1_3_bookkeepingforedges_blackBBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeDouble_1_3_bookkeepingforedges_greenBBBBBBFFFF(
	...
	public static final void pattern_PrimitiveTypeDouble_1_5_registerobjects_expressionBBBBBBBB(
			PrimitiveTypeDouble _this, PerformRuleResult ruleresult, EObject jm2up, EObject jm, EObject umpt,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_2_2_corematch_bindingFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeDouble_2_2_corematch_blackFBFBB(Model jm,
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeDouble_2_3_findcontext_blackBBBB(
			JavaModel2UMLPackage jm2up, Model jm, org.eclipse.uml2.uml.Package up,
			org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_PrimitiveTypeDouble_2_3_findcontext_greenBBBBFFFF(JavaModel2UMLPackage jm2up,
			Model jm, org.eclipse.uml2.uml.Package up, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_2_4_solveCSP_bindingFBBBBBB(PrimitiveTypeDouble _this,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_2_4_solveCSP_bindingAndBlackFBBBBBB(
			PrimitiveTypeDouble _this, IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage jm2up, Model jm,
			org.eclipse.uml2.uml.Package up, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		Object[] result_pattern_PrimitiveTypeDouble_2_4_solveCSP_binding = pattern_PrimitiveTypeDouble_2_4_solveCSP_bindingFBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeDouble_10_1_initialbindings_blackBBBB(PrimitiveTypeDouble _this,
			Match match, PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
		return new Object[] { _this, match, umpt, up };
	}

	public static final Object[] pattern_PrimitiveTypeDouble_10_2_SolveCSP_bindingFBBBB(PrimitiveTypeDouble _this,
			Match match, PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_10_2_SolveCSP_bindingAndBlackFBBBB(
			PrimitiveTypeDouble _this, Match match, PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
		Object[] result_pattern_PrimitiveTypeDouble_10_2_SolveCSP_binding = pattern_PrimitiveTypeDouble_10_2_SolveCSP_bindingFBBBB(
				_this, match, umpt, up);
	...
	public static final Object[] pattern_PrimitiveTypeDouble_10_4_collectelementstobetranslated_blackBBB(Match match,
			PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
		return new Object[] { match, umpt, up };
	}

	public static final Object[] pattern_PrimitiveTypeDouble_10_4_collectelementstobetranslated_greenBBBF(Match match,
			PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
		EMoflonEdge up__umpt____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_PrimitiveTypeDouble_10_5_collectcontextelements_blackBBB(Match match,
			PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
		return new Object[] { match, umpt, up };
	}

	public static final Object[] pattern_PrimitiveTypeDouble_10_5_collectcontextelements_greenBB(Match match,
			org.eclipse.uml2.uml.Package up) {
		match.getContextNodes().add(up);
		return new Object[] { match, up };
	}

	public static final void pattern_PrimitiveTypeDouble_10_6_registerobjectstomatch_expressionBBBB(
			PrimitiveTypeDouble _this, Match match, PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_11_1_performtransformation_bindingFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("jm2up");
		EObject _localVariable_1 = isApplicableMatch.getObject("jm");
	...
	public static final Object[] pattern_PrimitiveTypeDouble_11_1_performtransformation_blackBBBBFBB(
	...
	public static final Object[] pattern_PrimitiveTypeDouble_11_1_performtransformation_bindingAndBlackFFFFFBB(
			PrimitiveTypeDouble _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_PrimitiveTypeDouble_11_1_performtransformation_binding = pattern_PrimitiveTypeDouble_11_1_performtransformation_bindingFFFFB(
				isApplicableMatch);
		if (result_pattern_PrimitiveTypeDouble_11_1_performtransformation_binding != null) {
			JavaModel2UMLPackage jm2up = (JavaModel2UMLPackage) result_pattern_PrimitiveTypeDouble_11_1_performtransformation_binding[0];
			Model jm = (Model) result_pattern_PrimitiveTypeDouble_11_1_performtransformation_binding[1];
			PrimitiveType umpt = (PrimitiveType) result_pattern_PrimitiveTypeDouble_11_1_performtransformation_binding[2];
			org.eclipse.uml2.uml.Package up = (org.eclipse.uml2.uml.Package) result_pattern_PrimitiveTypeDouble_11_1_performtransformation_binding[3];

			Object[] result_pattern_PrimitiveTypeDouble_11_1_performtransformation_black = pattern_PrimitiveTypeDouble_11_1_performtransformation_blackBBBBFBB(
					jm2up, jm, umpt, up, _this, isApplicableMatch);
			if (result_pattern_PrimitiveTypeDouble_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_PrimitiveTypeDouble_11_1_performtransformation_black[4];
	...
	public static final Object[] pattern_PrimitiveTypeDouble_11_1_performtransformation_greenBBFFB(Model jm,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_11_2_collecttranslatedelements_blackBBB(PrimitiveType umpt,
			NamedElement2NamedElement jpt2upt2, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		return new Object[] { umpt, jpt2upt2, jpt };
	}

	public static final Object[] pattern_PrimitiveTypeDouble_11_2_collecttranslatedelements_greenFBBB(
			PrimitiveType umpt, NamedElement2NamedElement jpt2upt2, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_PrimitiveTypeDouble_11_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject jm2up, EObject jm, EObject umpt, EObject up, EObject jpt2upt2,
			EObject jpt) {
		if (!jm2up.equals(umpt)) {
			if (!jm2up.equals(up)) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_11_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject jm, EObject umpt, EObject up, EObject jpt2upt2, EObject jpt) {
		EMoflonEdge up__umpt____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge jm__jpt____orphanTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge jpt2upt2__jpt____source = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_PrimitiveTypeDouble_11_5_registerobjects_expressionBBBBBBBB(
			PrimitiveTypeDouble _this, PerformRuleResult ruleresult, EObject jm2up, EObject jm, EObject umpt,
			EObject up, EObject jpt2upt2, EObject jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_12_2_corematch_bindingFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeDouble_12_2_corematch_blackFFBBB(PrimitiveType umpt,
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeDouble_12_3_findcontext_blackBBBB(
			JavaModel2UMLPackage jm2up, Model jm, PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_PrimitiveTypeDouble_12_3_findcontext_greenBBBBFFFF(JavaModel2UMLPackage jm2up,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_12_4_solveCSP_bindingFBBBBBB(PrimitiveTypeDouble _this,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_12_4_solveCSP_bindingAndBlackFBBBBBB(
			PrimitiveTypeDouble _this, IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage jm2up, Model jm,
			PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
		Object[] result_pattern_PrimitiveTypeDouble_12_4_solveCSP_binding = pattern_PrimitiveTypeDouble_12_4_solveCSP_bindingFBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeDouble_20_2_testcorematchandDECs_black_nac_0B(
			PrimitiveType umpt) {
		for (org.eclipse.uml2.uml.Class __DEC_umpt_nestedClassifier_627918 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypeDouble_20_2_testcorematchandDECs_black_nac_1B(
			PrimitiveType umpt) {
		for (Interface __DEC_umpt_nestedClassifier_271681 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeDouble_20_2_testcorematchandDECs_blackFFB(
		...
		if (tmpUp instanceof org.eclipse.uml2.uml.Package) {
			...
			if (tmpUmpt instanceof PrimitiveType) {
				...
				if (up.getPackagedElements().contains(umpt)) {
					String up_name = up.getName();
					if (up_name.equals("Common Java datatypes")) {
						if (pattern_PrimitiveTypeDouble_20_2_testcorematchandDECs_black_nac_0B(umpt) == null) {
							if (pattern_PrimitiveTypeDouble_20_2_testcorematchandDECs_black_nac_1B(umpt) == null) {
	...
	public static final boolean pattern_PrimitiveTypeDouble_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			PrimitiveTypeDouble _this, Match match, PrimitiveType umpt, org.eclipse.uml2.uml.Package up) {
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeDouble_21_2_testcorematchandDECs_blackFFB(
	...
	public static final boolean pattern_PrimitiveTypeDouble_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			PrimitiveTypeDouble _this, Match match, Model jm, org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_bindingFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_blackBBBBBB(Model jm,
			PrimitiveType umpt, org.eclipse.uml2.uml.Package up, org.eclipse.modisco.java.PrimitiveTypeDouble jpt,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_binding = pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_bindingFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_binding != null) {
			Model jm = (Model) result_pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_binding[0];
			PrimitiveType umpt = (PrimitiveType) result_pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_binding[1];
			org.eclipse.uml2.uml.Package up = (org.eclipse.uml2.uml.Package) result_pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_binding[2];
			org.eclipse.modisco.java.PrimitiveTypeDouble jpt = (org.eclipse.modisco.java.PrimitiveTypeDouble) result_pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_binding[3];

			Object[] result_pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_black = pattern_PrimitiveTypeDouble_24_2_matchsrctrgcontext_blackBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeDouble_24_3_solvecsp_bindingFBBBBBBB(PrimitiveTypeDouble _this,
			Model jm, PrimitiveType umpt, org.eclipse.uml2.uml.Package up,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			PrimitiveTypeDouble _this, Model jm, PrimitiveType umpt, org.eclipse.uml2.uml.Package up,
			org.eclipse.modisco.java.PrimitiveTypeDouble jpt, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_PrimitiveTypeDouble_24_3_solvecsp_binding = pattern_PrimitiveTypeDouble_24_3_solvecsp_bindingFBBBBBBB(
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeDouble_24_5_matchcorrcontext_blackFBBBB(Model jm,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_24_5_matchcorrcontext_greenBBBF(JavaModel2UMLPackage jm2up,
			Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_24_6_createcorrespondence_blackBBBBB(Model jm,
			PrimitiveType umpt, org.eclipse.uml2.uml.Package up, org.eclipse.modisco.java.PrimitiveTypeDouble jpt,
			CCMatch ccMatch) {
		return new Object[] { jm, umpt, up, jpt, ccMatch };
	}

	public static final Object[] pattern_PrimitiveTypeDouble_24_6_createcorrespondence_greenBFBB(PrimitiveType umpt,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_27_1_matchtggpattern_blackBB(Model jm,
			org.eclipse.modisco.java.PrimitiveTypeDouble jpt) {
		if (jm.getOrphanTypes().contains(jpt)) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_28_1_matchtggpattern_black_nac_0B(PrimitiveType umpt) {
		for (org.eclipse.uml2.uml.Class __DEC_umpt_nestedClassifier_495571 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(umpt, org.eclipse.uml2.uml.Class.class, "nestedClassifier")) {
			return new Object[] { umpt };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeDouble_28_1_matchtggpattern_black_nac_1B(PrimitiveType umpt) {
		for (Interface __DEC_umpt_nestedClassifier_723039 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(umpt, Interface.class, "nestedClassifier")) {
			return new Object[] { umpt };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeDouble_28_1_matchtggpattern_blackBB(PrimitiveType umpt,
			org.eclipse.uml2.uml.Package up) {
		if (up.getPackagedElements().contains(umpt)) {
			String up_name = up.getName();
			if (up_name.equals("Common Java datatypes")) {
				if (pattern_PrimitiveTypeDouble_28_1_matchtggpattern_black_nac_0B(umpt) == null) {
					if (pattern_PrimitiveTypeDouble_28_1_matchtggpattern_black_nac_1B(umpt) == null) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_29_2_isapplicablecore_black_nac_0BB(
	...
	public static final Object[] pattern_PrimitiveTypeDouble_29_2_isapplicablecore_black_nac_1BB(
	...
	public static final Object[] pattern_PrimitiveTypeDouble_29_2_isapplicablecore_black_nac_2BB(
	...
	public static final Iterable<Object[]> pattern_PrimitiveTypeDouble_29_2_isapplicablecore_blackFFFFBB(
				...
				if (tmpJm2up instanceof JavaModel2UMLPackage) {
					...
					if (up != null) {
						...
						if (jm != null) {
							String up_name = up.getName();
							if (up_name.equals("Common Java datatypes")) {
								if (pattern_PrimitiveTypeDouble_29_2_isapplicablecore_black_nac_0BB(ruleResult,
										jm2up) == null) {
									if (pattern_PrimitiveTypeDouble_29_2_isapplicablecore_black_nac_1BB(ruleResult,
											up) == null) {
										if (pattern_PrimitiveTypeDouble_29_2_isapplicablecore_black_nac_2BB(ruleResult,
												jm) == null) {
	...
	public static final Object[] pattern_PrimitiveTypeDouble_29_3_solveCSP_bindingFBBBBBB(PrimitiveTypeDouble _this,
			IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage jm2up, Model jm, org.eclipse.uml2.uml.Package up,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_29_3_solveCSP_bindingAndBlackFBBBBBB(
			PrimitiveTypeDouble _this, IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage jm2up, Model jm,
			org.eclipse.uml2.uml.Package up, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_PrimitiveTypeDouble_29_3_solveCSP_binding = pattern_PrimitiveTypeDouble_29_3_solveCSP_bindingFBBBBBB(
	...
	public static final Object[] pattern_PrimitiveTypeDouble_29_5_checknacs_blackBBB(JavaModel2UMLPackage jm2up,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_29_6_perform_blackBBBB(JavaModel2UMLPackage jm2up,
	...
	public static final Object[] pattern_PrimitiveTypeDouble_29_6_perform_greenBFBFFBB(Model jm,
