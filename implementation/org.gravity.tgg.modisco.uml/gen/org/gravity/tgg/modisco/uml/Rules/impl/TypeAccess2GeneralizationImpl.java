...
public class TypeAccess2GeneralizationImpl extends AbstractRuleImpl implements TypeAccess2Generalization {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = TypeAccess2GeneralizationImpl
				.pattern_TypeAccess2Generalization_1_1_performtransformation_greenBBBFF(typeAcc, umlClassifier,
						superClass);
		...
		Object[] result3_black = TypeAccess2GeneralizationImpl
				.pattern_TypeAccess2Generalization_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, classDec,
						typeAcc, umlClassifier, superClass, generalization, superClassDec, cd2c2, cd2c, ta2g);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[classDec] = " + classDec + ", " + "[typeAcc] = " + typeAcc + ", " + "[umlClassifier] = "
					+ umlClassifier + ", " + "[superClass] = " + superClass + ", " + "[generalization] = "
		...
		TypeAccess2GeneralizationImpl.pattern_TypeAccess2Generalization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(
				ruleresult, classDec, typeAcc, umlClassifier, superClass, generalization, superClassDec, ta2g);
		...
		TypeAccess2GeneralizationImpl.pattern_TypeAccess2Generalization_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, classDec, typeAcc, umlClassifier, superClass, generalization, superClassDec, cd2c2, cd2c,
				ta2g);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2GeneralizationImpl
			...
			for (Object[] result3_black : TypeAccess2GeneralizationImpl
					.pattern_TypeAccess2Generalization_2_3_findcontext_blackBBBBBBB(classDec, typeAcc, umlClassifier,
							superClass, superClassDec, cd2c2, cd2c)) {
				Object[] result3_green = TypeAccess2GeneralizationImpl
						.pattern_TypeAccess2Generalization_2_3_findcontext_greenBBBBBBBFFFFFFFF(classDec, typeAcc,
								umlClassifier, superClass, superClassDec, cd2c2, cd2c);
				...
				Object[] result4_bindingAndBlack = TypeAccess2GeneralizationImpl
						.pattern_TypeAccess2Generalization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, classDec, typeAcc, umlClassifier, superClass, superClassDec, cd2c2,
								cd2c);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			TypeAccess typeAcc, Classifier umlClassifier, org.eclipse.uml2.uml.Class superClass, Type superClassDec,
			ASTNode2Element cd2c2, ASTNode2Element cd2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject classDec, EObject typeAcc,
			EObject umlClassifier, EObject superClass, EObject generalization, EObject superClassDec, EObject cd2c2,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2GeneralizationImpl
				.pattern_TypeAccess2Generalization_12_2_corematch_blackFBBBFFFB(umlClassifier, superClass,
			...
			// ForEach 
			for (Object[] result3_black : TypeAccess2GeneralizationImpl
					.pattern_TypeAccess2Generalization_12_3_findcontext_blackBBBBBBB(classDec, umlClassifier,
							superClass, generalization, superClassDec, cd2c2, cd2c)) {
				Object[] result3_green = TypeAccess2GeneralizationImpl
						.pattern_TypeAccess2Generalization_12_3_findcontext_greenBBBBBBBFFFFFFFF(classDec,
								umlClassifier, superClass, generalization, superClassDec, cd2c2, cd2c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = TypeAccess2GeneralizationImpl
						.pattern_TypeAccess2Generalization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, classDec, umlClassifier, superClass, generalization, superClassDec,
								cd2c2, cd2c);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			...
			Type superClassDec, ASTNode2Element cd2c2, ASTNode2Element cd2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_129(EMoflonEdge _edge_general) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeAccess2GeneralizationImpl
				.pattern_TypeAccess2Generalization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, classDec, typeAcc,
						umlClassifier, superClass, generalization, superClassDec, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[classDec] = " + classDec + ", " + "[typeAcc] = " + typeAcc + ", " + "[umlClassifier] = "
					+ umlClassifier + ", " + "[superClass] = " + superClass + ", " + "[generalization] = "
					+ generalization + ", " + "[superClassDec] = " + superClassDec + ", " + "[sourceMatch] = "
		...
		if (TypeAccess2GeneralizationImpl.pattern_TypeAccess2Generalization_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeAccess2GeneralizationImpl
					.pattern_TypeAccess2Generalization_24_5_matchcorrcontext_blackBBBBFFBB(classDec, umlClassifier,
				...
				Object[] result6_black = TypeAccess2GeneralizationImpl
						.pattern_TypeAccess2Generalization_24_6_createcorrespondence_blackBBBBBBB(classDec, typeAcc,
								umlClassifier, superClass, generalization, superClassDec, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ClassDeclaration classDec, TypeAccess typeAcc, Classifier umlClassifier,
		...
		for (Object[] result2_black : TypeAccess2GeneralizationImpl
			...
			Object[] result3_bindingAndBlack = TypeAccess2GeneralizationImpl
					.pattern_TypeAccess2Generalization_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							classDec, umlClassifier, superClass, superClassDec, cd2c2, cd2c, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
						+ "[umlClassifier] = " + umlClassifier + ", " + "[superClass] = " + superClass + ", "
						+ "[superClassDec] = " + superClassDec + ", " + "[cd2c2] = " + cd2c2 + ", " + "[cd2c] = " + cd2c
			...
			if (TypeAccess2GeneralizationImpl.pattern_TypeAccess2Generalization_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = TypeAccess2GeneralizationImpl
						.pattern_TypeAccess2Generalization_29_5_checknacs_blackBBBBBB(classDec, umlClassifier,
								superClass, superClassDec, cd2c2, cd2c);
				if (result5_black != null) {

					Object[] result6_black = TypeAccess2GeneralizationImpl
							.pattern_TypeAccess2Generalization_29_6_perform_blackBBBBBBB(classDec, umlClassifier,
									superClass, superClassDec, cd2c2, cd2c, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[classDec] = "
								+ classDec + ", " + "[umlClassifier] = " + umlClassifier + ", " + "[superClass] = "
								+ superClass + ", " + "[superClassDec] = " + superClassDec + ", " + "[cd2c2] = " + cd2c2
								+ ", " + "[cd2c] = " + cd2c + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					TypeAccess2GeneralizationImpl.pattern_TypeAccess2Generalization_29_6_perform_greenBFBBFBFB(classDec,
							umlClassifier, superClass, superClassDec, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			Classifier umlClassifier, org.eclipse.uml2.uml.Class superClass, Type superClassDec, ASTNode2Element cd2c2,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_ACCESS2_GENERALIZATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSDECLARATION_TYPEACCESS_CLASSIFIER_CLASS_TYPE_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(TypeAccess) arguments.get(2), (Classifier) arguments.get(3),
		...
		case RulesPackage.TYPE_ACCESS2_GENERALIZATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_CLASSIFIER_CLASS_GENERALIZATION_TYPE_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
		...
		case RulesPackage.TYPE_ACCESS2_GENERALIZATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_129__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_ACCESS2_GENERALIZATION___IS_APPLICABLE_SOLVE_CSP_CC__CLASSDECLARATION_TYPEACCESS_CLASSIFIER_CLASS_GENERALIZATION_TYPE_MATCH_MATCH:
		...
		case RulesPackage.TYPE_ACCESS2_GENERALIZATION___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_CLASSIFIER_CLASS_TYPE_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
						...
						if (tmpSuperClassDec instanceof Type) {
							...
							if (tmpCd2c2 instanceof ASTNode2Element) {
								...
								if (tmpCd2c instanceof ASTNode2Element) {
									...
									return new Object[] { classDec, typeAcc, umlClassifier, superClass, superClassDec,
											cd2c2, cd2c, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_TypeAccess2Generalization_1_1_performtransformation_blackBBBBBBBFBB(
			ClassDeclaration classDec, TypeAccess typeAcc, Classifier umlClassifier,
			org.eclipse.uml2.uml.Class superClass, Type superClassDec, ASTNode2Element cd2c2, ASTNode2Element cd2c,
				...
				if (!cd2c.equals(cd2c2)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { classDec, typeAcc, umlClassifier, superClass, superClassDec, cd2c2,
	...
	public static final Object[] pattern_TypeAccess2Generalization_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2Generalization_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeAccess2Generalization_1_1_performtransformation_black = pattern_TypeAccess2Generalization_1_1_performtransformation_blackBBBBBBBFBB(
					classDec, typeAcc, umlClassifier, superClass, superClassDec, cd2c2, cd2c, _this, isApplicableMatch);
			if (result_pattern_TypeAccess2Generalization_1_1_performtransformation_black != null) {
				...
				return new Object[] { classDec, typeAcc, umlClassifier, superClass, superClassDec, cd2c2, cd2c, csp,
	...
	public static final Object[] pattern_TypeAccess2Generalization_1_1_performtransformation_greenBBBFF(
		...
		return new Object[] { typeAcc, umlClassifier, superClass, generalization, ta2g };
	}
	...
	public static final Object[] pattern_TypeAccess2Generalization_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject classDec, EObject typeAcc, EObject umlClassifier, EObject superClass,
			EObject generalization, EObject superClassDec, EObject cd2c2, EObject cd2c, EObject ta2g) {
	...
	public static final Object[] pattern_TypeAccess2Generalization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject classDec, EObject typeAcc, EObject umlClassifier, EObject superClass,
			EObject generalization, EObject superClassDec, EObject ta2g) {
		EMoflonEdge typeAcc__superClassDec____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge superClassDec__typeAcc____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge classDec__typeAcc____superClass = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, classDec, typeAcc, umlClassifier, superClass, generalization, superClassDec,
	...
	public static final void pattern_TypeAccess2Generalization_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject umlClassifier, EObject superClass, EObject generalization, EObject superClassDec, EObject cd2c2,
			EObject cd2c, EObject ta2g) {
		_this.registerObjects_FWD(ruleresult, classDec, typeAcc, umlClassifier, superClass, generalization,
				superClassDec, cd2c2, cd2c, ta2g);
					...
					for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!cd2c.equals(cd2c2)) {
							...
							if (tmpUmlClassifier instanceof Classifier) {
								Classifier umlClassifier = (Classifier) tmpUmlClassifier;
								if (!superClass.equals(umlClassifier)) {
									_result.add(new Object[] { classDec, typeAcc, umlClassifier, superClass,
											superClassDec, cd2c2, cd2c, match });
								}
							}
	...
	public static final Object[] pattern_TypeAccess2Generalization_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { classDec, typeAcc, umlClassifier, superClass, superClassDec, cd2c2, cd2c,
				isApplicableMatch, typeAcc__superClassDec____type, superClassDec__typeAcc____usagesInTypeAccess,
				classDec__typeAcc____superClass, cd2c2__superClass____target, cd2c2__superClassDec____source,
				cd2c__classDec____source, cd2c__umlClassifier____target };
	}
	...
	public static final Object[] pattern_TypeAccess2Generalization_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			TypeAccess typeAcc, Classifier umlClassifier, org.eclipse.uml2.uml.Class superClass, Type superClassDec,
			ASTNode2Element cd2c2, ASTNode2Element cd2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, classDec, typeAcc, umlClassifier,
				superClass, superClassDec, cd2c2, cd2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, typeAcc, umlClassifier, superClass,
					superClassDec, cd2c2, cd2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2Generalization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2Generalization_2_4_solveCSP_binding = pattern_TypeAccess2Generalization_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, typeAcc, umlClassifier, superClass, superClassDec, cd2c2, cd2c);
					...
					if (tmpGeneralization instanceof Generalization) {
						...
						if (tmpSuperClassDec instanceof Type) {
							...
							if (tmpCd2c2 instanceof ASTNode2Element) {
								...
								if (tmpCd2c instanceof ASTNode2Element) {
									ASTNode2Element cd2c = (ASTNode2Element) tmpCd2c;
									return new Object[] { classDec, umlClassifier, superClass, generalization,
											superClassDec, cd2c2, cd2c, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_TypeAccess2Generalization_11_1_performtransformation_blackBBBBBBBFBB(
			...
			Generalization generalization, Type superClassDec, ASTNode2Element cd2c2, ASTNode2Element cd2c,
			TypeAccess2Generalization _this, IsApplicableMatch isApplicableMatch) {
		if (!classDec.equals(superClassDec)) {
			if (!superClass.equals(umlClassifier)) {
				if (!cd2c.equals(cd2c2)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { classDec, umlClassifier, superClass, generalization, superClassDec,
	...
	public static final Object[] pattern_TypeAccess2Generalization_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2Generalization_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeAccess2Generalization_11_1_performtransformation_black = pattern_TypeAccess2Generalization_11_1_performtransformation_blackBBBBBBBFBB(
					classDec, umlClassifier, superClass, generalization, superClassDec, cd2c2, cd2c, _this,
					isApplicableMatch);
			if (result_pattern_TypeAccess2Generalization_11_1_performtransformation_black != null) {
				...
				return new Object[] { classDec, umlClassifier, superClass, generalization, superClassDec, cd2c2, cd2c,
	...
	public static final void pattern_TypeAccess2Generalization_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject umlClassifier, EObject superClass, EObject generalization, EObject superClassDec, EObject cd2c2,
			EObject cd2c, EObject ta2g) {
		_this.registerObjects_BWD(ruleresult, classDec, typeAcc, umlClassifier, superClass, generalization,
				superClassDec, cd2c2, cd2c, ta2g);
	...
	public static final Iterable<Object[]> pattern_TypeAccess2Generalization_12_2_corematch_blackFBBBFFFB(
			Classifier umlClassifier, org.eclipse.uml2.uml.Class superClass, Generalization generalization,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!superClass.equals(umlClassifier)) {
					...
					for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!cd2c.equals(cd2c2)) {
							...
							if (tmpClassDec instanceof ClassDeclaration) {
								ClassDeclaration classDec = (ClassDeclaration) tmpClassDec;
								if (!classDec.equals(superClassDec)) {
									_result.add(new Object[] { classDec, umlClassifier, superClass, generalization,
											superClassDec, cd2c2, cd2c, match });
								}
							}
						...
						if (umlClassifier.getGeneralizations().contains(generalization)) {
							if (superClass.equals(cd2c2.getTarget())) {
								if (superClassDec.equals(cd2c2.getSource())) {
									if (classDec.equals(cd2c.getSource())) {
										if (umlClassifier.equals(cd2c.getTarget())) {
											_result.add(new Object[] { classDec, umlClassifier, superClass,
													generalization, superClassDec, cd2c2, cd2c });
										}
									}
								}
							}
	...
	public static final Object[] pattern_TypeAccess2Generalization_12_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { classDec, umlClassifier, superClass, generalization, superClassDec, cd2c2, cd2c,
				...
				umlClassifier__generalization____generalization, generalization__umlClassifier____specific,
				cd2c2__superClass____target, cd2c2__superClassDec____source, cd2c__classDec____source,
	...
	public static final Object[] pattern_TypeAccess2Generalization_12_4_solveCSP_bindingFBBBBBBBBB(
			TypeAccess2Generalization _this, IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			Classifier umlClassifier, org.eclipse.uml2.uml.Class superClass, Generalization generalization,
			Type superClassDec, ASTNode2Element cd2c2, ASTNode2Element cd2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, classDec, umlClassifier, superClass,
				generalization, superClassDec, cd2c2, cd2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, umlClassifier, superClass, generalization,
					superClassDec, cd2c2, cd2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2Generalization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2Generalization_12_4_solveCSP_binding = pattern_TypeAccess2Generalization_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, umlClassifier, superClass, generalization, superClassDec, cd2c2,
				cd2c);
		if (result_pattern_TypeAccess2Generalization_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_TypeAccess2Generalization_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, classDec, umlClassifier, superClass,
						generalization, superClassDec, cd2c2, cd2c };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_21_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!classDec.equals(superClassDec)) {
			for (AbstractTypeDeclaration __DEC_typeAcc_superInterfaces_466207 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(typeAcc, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!classDec.equals(__DEC_typeAcc_superInterfaces_466207)) {
					if (!superClassDec.equals(__DEC_typeAcc_superInterfaces_466207)) {
	...
	public static final Object[] pattern_TypeAccess2Generalization_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_70931 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2Generalization_21_2_testcorematchandDECs_black_nac_2BB(
		...
		for (ArrayType __DEC_typeAcc_elementType_133042 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ArrayType.class, "elementType")) {
			if (!superClassDec.equals(__DEC_typeAcc_elementType_133042)) {
	...
	public static final Object[] pattern_TypeAccess2Generalization_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_140215 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2Generalization_21_2_testcorematchandDECs_black_nac_4BB(
			TypeAccess typeAcc, Type superClassDec) {
		for (ParameterizedType __DEC_typeAcc_type_910198 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ParameterizedType.class, "type")) {
			if (!superClassDec.equals(__DEC_typeAcc_type_910198)) {
				return new Object[] { typeAcc, superClassDec };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_282816 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2Generalization_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_187933 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpUmlClassifier instanceof Classifier) {
					...
					if (tmpSuperClass instanceof org.eclipse.uml2.uml.Class) {
						...
						if (tmpGeneralization instanceof Generalization) {
							...
							if (tmpSuperClassDec instanceof Type) {
								Type superClassDec = (Type) tmpSuperClassDec;
								return new Object[] { classDec, typeAcc, umlClassifier, superClass, generalization,
		...
		if (!classDec.equals(superClassDec)) {
			if (!superClass.equals(umlClassifier)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { classDec, typeAcc, umlClassifier, superClass, generalization, superClassDec,
	...
	public static final Object[] pattern_TypeAccess2Generalization_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_TypeAccess2Generalization_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeAccess2Generalization_24_2_matchsrctrgcontext_black = pattern_TypeAccess2Generalization_24_2_matchsrctrgcontext_blackBBBBBBBB(
					classDec, typeAcc, umlClassifier, superClass, generalization, superClassDec, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_TypeAccess2Generalization_24_3_solvecsp_bindingFBBBBBBBBB(
			TypeAccess2Generalization _this, ClassDeclaration classDec, TypeAccess typeAcc, Classifier umlClassifier,
			org.eclipse.uml2.uml.Class superClass, Generalization generalization, Type superClassDec, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(classDec, typeAcc, umlClassifier, superClass,
				generalization, superClassDec, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, classDec, typeAcc, umlClassifier, superClass, generalization,
					superClassDec, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2Generalization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2Generalization_24_3_solvecsp_binding = pattern_TypeAccess2Generalization_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, classDec, typeAcc, umlClassifier, superClass, generalization, superClassDec, sourceMatch,
				targetMatch);
					...
					for (ASTNode2Element cd2c2 : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (superClassDec.equals(cd2c2.getSource())) {
							for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!cd2c.equals(cd2c2)) {
									if (umlClassifier.equals(cd2c.getTarget())) {
										_result.add(new Object[] { classDec, umlClassifier, superClass, superClassDec,
	...
	public static final Object[] pattern_TypeAccess2Generalization_27_1_matchtggpattern_black_nac_0BBB(
			TypeAccess typeAcc, ClassDeclaration classDec, Type superClassDec) {
		if (!classDec.equals(superClassDec)) {
			for (AbstractTypeDeclaration __DEC_typeAcc_superInterfaces_700637 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(typeAcc, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!classDec.equals(__DEC_typeAcc_superInterfaces_700637)) {
					if (!superClassDec.equals(__DEC_typeAcc_superInterfaces_700637)) {
						return new Object[] { typeAcc, classDec, superClassDec };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2Generalization_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_35893 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, Annotation.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess typeAcc, Type superClassDec) {
		for (ArrayType __DEC_typeAcc_elementType_233009 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ArrayType.class, "elementType")) {
			if (!superClassDec.equals(__DEC_typeAcc_elementType_233009)) {
				return new Object[] { typeAcc, superClassDec };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_27_1_matchtggpattern_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_48576 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, MethodDeclaration.class, "returnType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_27_1_matchtggpattern_black_nac_4BB(
			TypeAccess typeAcc, Type superClassDec) {
		for (ParameterizedType __DEC_typeAcc_type_128571 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ParameterizedType.class, "type")) {
			if (!superClassDec.equals(__DEC_typeAcc_type_128571)) {
				return new Object[] { typeAcc, superClassDec };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_27_1_matchtggpattern_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_501841 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, SingleVariableDeclaration.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_634988 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, classDec, umlClassifier, superClass,
				superClassDec, cd2c2, cd2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, umlClassifier, superClass, superClassDec,
	...
	public static final Object[] pattern_TypeAccess2Generalization_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2Generalization_29_3_solveCSP_binding = pattern_TypeAccess2Generalization_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, umlClassifier, superClass, superClassDec, cd2c2, cd2c, ruleResult);
	...
	public static final Object[] pattern_TypeAccess2Generalization_29_5_checknacs_blackBBBBBB(ClassDeclaration classDec,
		...
		if (!classDec.equals(superClassDec)) {
			if (!superClass.equals(umlClassifier)) {
				if (!cd2c.equals(cd2c2)) {
					return new Object[] { classDec, umlClassifier, superClass, superClassDec, cd2c2, cd2c };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_29_6_perform_blackBBBBBBB(ClassDeclaration classDec,
		...
		if (!classDec.equals(superClassDec)) {
			if (!superClass.equals(umlClassifier)) {
				if (!cd2c.equals(cd2c2)) {
					return new Object[] { classDec, umlClassifier, superClass, superClassDec, cd2c2, cd2c, ruleResult };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2Generalization_29_6_perform_greenBFBBFBFB(ClassDeclaration classDec,
		...
		return new Object[] { classDec, typeAcc, umlClassifier, superClass, generalization, superClassDec, ta2g,
				ruleResult };
	}
