...
public class TypeAccess2InterfaceGeneralizationImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypeAccess2InterfaceGeneralizationImpl
				.pattern_TypeAccess2InterfaceGeneralization_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, cd2c2,
						typeAcc, interfaceGeneralization, cd2c, superInterfaceDec, superInterface, classDec, ta2g,
						childInterface);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ ", " + "[classDec] = " + classDec + ", " + "[ta2g] = " + ta2g + ", " + "[childInterface] = "
					+ childInterface + ".");
		}
		TypeAccess2InterfaceGeneralizationImpl
				.pattern_TypeAccess2InterfaceGeneralization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(ruleresult,
						typeAcc, interfaceGeneralization, superInterfaceDec, superInterface, classDec, ta2g,
						childInterface);
		...
		TypeAccess2InterfaceGeneralizationImpl
				.pattern_TypeAccess2InterfaceGeneralization_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						cd2c2, typeAcc, interfaceGeneralization, cd2c, superInterfaceDec, superInterface, classDec,
						ta2g, childInterface);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2InterfaceGeneralizationImpl
				.pattern_TypeAccess2InterfaceGeneralization_2_2_corematch_blackFBFBFBFB(typeAcc, superInterfaceDec,
						classDec, match)) {
			...
			for (Object[] result3_black : TypeAccess2InterfaceGeneralizationImpl
					.pattern_TypeAccess2InterfaceGeneralization_2_3_findcontext_blackBBBBBBB(cd2c2, typeAcc, cd2c,
							superInterfaceDec, superInterface, classDec, childInterface)) {
				Object[] result3_green = TypeAccess2InterfaceGeneralizationImpl
						.pattern_TypeAccess2InterfaceGeneralization_2_3_findcontext_greenBBBBBBBFFFFFFFF(cd2c2, typeAcc,
								cd2c, superInterfaceDec, superInterface, classDec, childInterface);
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceGeneralizationImpl
						.pattern_TypeAccess2InterfaceGeneralization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, cd2c2, typeAcc, cd2c, superInterfaceDec, superInterface, classDec,
								childInterface);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[cd2c2] = " + cd2c2 + ", "
							+ "[typeAcc] = " + typeAcc + ", " + "[cd2c] = " + cd2c + ", " + "[superInterfaceDec] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element cd2c2, TypeAccess typeAcc,
			ASTNode2Element cd2c, InterfaceDeclaration superInterfaceDec, Interface superInterface,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject cd2c2, EObject typeAcc,
			EObject interfaceGeneralization, EObject cd2c, EObject superInterfaceDec, EObject superInterface,
			EObject classDec, EObject ta2g, EObject childInterface) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = TypeAccess2InterfaceGeneralizationImpl
				.pattern_TypeAccess2InterfaceGeneralization_11_1_performtransformation_greenFBBBF(
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2InterfaceGeneralizationImpl
				.pattern_TypeAccess2InterfaceGeneralization_12_2_corematch_blackFBFFBFBB(interfaceGeneralization,
			...
			// ForEach 
			for (Object[] result3_black : TypeAccess2InterfaceGeneralizationImpl
					.pattern_TypeAccess2InterfaceGeneralization_12_3_findcontext_blackBBBBBBB(cd2c2,
							interfaceGeneralization, cd2c, superInterfaceDec, superInterface, classDec,
							childInterface)) {
				Object[] result3_green = TypeAccess2InterfaceGeneralizationImpl
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceGeneralizationImpl
						.pattern_TypeAccess2InterfaceGeneralization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, cd2c2, interfaceGeneralization, cd2c, superInterfaceDec,
								superInterface, classDec, childInterface);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[cd2c2] = " + cd2c2 + ", "
							+ "[interfaceGeneralization] = " + interfaceGeneralization + ", " + "[cd2c] = " + cd2c
							+ ", " + "[superInterfaceDec] = " + superInterfaceDec + ", " + "[superInterface] = "
							+ superInterface + ", " + "[classDec] = " + classDec + ", " + "[childInterface] = "
							+ childInterface + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element cd2c2,
			Generalization interfaceGeneralization, ASTNode2Element cd2c, InterfaceDeclaration superInterfaceDec,
			Interface superInterface, InterfaceDeclaration classDec, Interface childInterface) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject cd2c2, EObject typeAcc,
			EObject interfaceGeneralization, EObject cd2c, EObject superInterfaceDec, EObject superInterface,
			EObject classDec, EObject ta2g, EObject childInterface) {
		ruleresult.registerObject("cd2c2", cd2c2);
		ruleresult.registerObject("typeAcc", typeAcc);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_93(EMoflonEdge _edge_general) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeAccess2InterfaceGeneralizationImpl
				.pattern_TypeAccess2InterfaceGeneralization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, typeAcc,
						interfaceGeneralization, superInterfaceDec, superInterface, classDec, childInterface,
		...
		if (TypeAccess2InterfaceGeneralizationImpl
			...
			for (Object[] result5_black : TypeAccess2InterfaceGeneralizationImpl
					.pattern_TypeAccess2InterfaceGeneralization_24_5_matchcorrcontext_blackFFBBBBBB(superInterfaceDec,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess typeAcc, Generalization interfaceGeneralization,
		...
		for (Object[] result2_black : TypeAccess2InterfaceGeneralizationImpl
			...
			Object[] result3_bindingAndBlack = TypeAccess2InterfaceGeneralizationImpl
					.pattern_TypeAccess2InterfaceGeneralization_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, cd2c2, cd2c, superInterfaceDec, superInterface, classDec, childInterface,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[cd2c2] = " + cd2c2 + ", "
			...
			if (TypeAccess2InterfaceGeneralizationImpl
				...
				// 
				Object[] result5_black = TypeAccess2InterfaceGeneralizationImpl
						.pattern_TypeAccess2InterfaceGeneralization_29_5_checknacs_blackBBBBBB(cd2c2, cd2c,
								superInterfaceDec, superInterface, classDec, childInterface);
				if (result5_black != null) {

					Object[] result6_black = TypeAccess2InterfaceGeneralizationImpl
							.pattern_TypeAccess2InterfaceGeneralization_29_6_perform_blackBBBBBBB(cd2c2, cd2c,
									superInterfaceDec, superInterface, classDec, childInterface, ruleResult);
					if (result6_black == null) {
					...
					TypeAccess2InterfaceGeneralizationImpl
							.pattern_TypeAccess2InterfaceGeneralization_29_6_perform_greenFFBBBFBB(superInterfaceDec,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_GENERALIZATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_TYPEACCESS_ASTNODE2ELEMENT_INTERFACEDECLARATION_INTERFACE_INTERFACEDECLARATION_INTERFACE:
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_GENERALIZATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_GENERALIZATION_ASTNODE2ELEMENT_INTERFACEDECLARATION_INTERFACE_INTERFACEDECLARATION_INTERFACE:
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_GENERALIZATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_93__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_93((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_ACCESS2_INTERFACE_GENERALIZATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_99__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_GENERALIZATION___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_GENERALIZATION_INTERFACEDECLARATION_INTERFACE_INTERFACEDECLARATION_INTERFACE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeAccess) arguments.get(0), (Generalization) arguments.get(1),
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_GENERALIZATION___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_INTERFACEDECLARATION_INTERFACE_INTERFACEDECLARATION_INTERFACE_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(Interface) arguments.get(4), (InterfaceDeclaration) arguments.get(5), (Interface) arguments.get(6),
						...
						if (tmpSuperInterface instanceof Interface) {
							...
							if (tmpClassDec instanceof InterfaceDeclaration) {
								...
								if (tmpChildInterface instanceof Interface) {
									...
									return new Object[] { cd2c2, typeAcc, cd2c, superInterfaceDec, superInterface,
				...
				if (!childInterface.equals(superInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { cd2c2, typeAcc, cd2c, superInterfaceDec, superInterface, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceGeneralization_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceGeneralization_1_1_performtransformation_black = pattern_TypeAccess2InterfaceGeneralization_1_1_performtransformation_blackBBBBBBBFBB(
					cd2c2, typeAcc, cd2c, superInterfaceDec, superInterface, classDec, childInterface, _this,
					isApplicableMatch);
			if (result_pattern_TypeAccess2InterfaceGeneralization_1_1_performtransformation_black != null) {
				...
				return new Object[] { cd2c2, typeAcc, cd2c, superInterfaceDec, superInterface, classDec, childInterface,
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_1_1_performtransformation_greenBFBFB(
		...
		return new Object[] { typeAcc, interfaceGeneralization, superInterface, ta2g, childInterface };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject cd2c2, EObject typeAcc, EObject interfaceGeneralization, EObject cd2c,
			EObject superInterfaceDec, EObject superInterface, EObject classDec, EObject ta2g, EObject childInterface) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject typeAcc, EObject interfaceGeneralization, EObject superInterfaceDec,
			EObject superInterface, EObject classDec, EObject ta2g, EObject childInterface) {
		EMoflonEdge typeAcc__superInterfaceDec____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge superInterfaceDec__typeAcc____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, typeAcc, interfaceGeneralization, superInterfaceDec, superInterface, classDec,
				ta2g, childInterface, typeAcc__superInterfaceDec____type,
	...
	public static final void pattern_TypeAccess2InterfaceGeneralization_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject interfaceGeneralization, EObject cd2c, EObject superInterfaceDec, EObject superInterface,
			EObject classDec, EObject ta2g, EObject childInterface) {
		_this.registerObjects_FWD(ruleresult, cd2c2, typeAcc, interfaceGeneralization, cd2c, superInterfaceDec,
				superInterface, classDec, ta2g, childInterface);
					...
					for (ASTNode2Element cd2c2 : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!cd2c.equals(cd2c2)) {
							...
							if (tmpSuperInterface instanceof Interface) {
								Interface superInterface = (Interface) tmpSuperInterface;
								if (!childInterface.equals(superInterface)) {
									_result.add(new Object[] { cd2c2, typeAcc, cd2c, superInterfaceDec, superInterface,
								...
								if (superInterface.equals(cd2c2.getTarget())) {
									if (superInterfaceDec.equals(cd2c2.getSource())) {
										if (childInterface.equals(cd2c.getTarget())) {
											_result.add(new Object[] { cd2c2, typeAcc, cd2c, superInterfaceDec,
													superInterface, classDec, childInterface });
										}
									}
								}
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			TypeAccess typeAcc, ASTNode2Element cd2c, InterfaceDeclaration superInterfaceDec, Interface superInterface,
			InterfaceDeclaration classDec, Interface childInterface) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, cd2c2, typeAcc, cd2c,
				superInterfaceDec, superInterface, classDec, childInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cd2c2, typeAcc, cd2c, superInterfaceDec,
					superInterface, classDec, childInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceGeneralization_2_4_solveCSP_binding = pattern_TypeAccess2InterfaceGeneralization_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, cd2c2, typeAcc, cd2c, superInterfaceDec, superInterface, classDec,
				childInterface);
					...
					if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
						...
						if (tmpSuperInterface instanceof Interface) {
							...
							if (tmpClassDec instanceof InterfaceDeclaration) {
								...
								if (tmpChildInterface instanceof Interface) {
									Interface childInterface = (Interface) tmpChildInterface;
									return new Object[] { cd2c2, interfaceGeneralization, cd2c, superInterfaceDec,
											superInterface, classDec, childInterface, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_11_1_performtransformation_blackBBBBBBBFBB(
			ASTNode2Element cd2c2, Generalization interfaceGeneralization, ASTNode2Element cd2c,
			InterfaceDeclaration superInterfaceDec, Interface superInterface, InterfaceDeclaration classDec,
				...
				if (!childInterface.equals(superInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { cd2c2, interfaceGeneralization, cd2c, superInterfaceDec,
									superInterface, classDec, childInterface, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceGeneralization_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceGeneralization_11_1_performtransformation_black = pattern_TypeAccess2InterfaceGeneralization_11_1_performtransformation_blackBBBBBBBFBB(
					cd2c2, interfaceGeneralization, cd2c, superInterfaceDec, superInterface, classDec, childInterface,
			...
			if (result_pattern_TypeAccess2InterfaceGeneralization_11_1_performtransformation_black != null) {
				...
				return new Object[] { cd2c2, interfaceGeneralization, cd2c, superInterfaceDec, superInterface, classDec,
						childInterface, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_11_1_performtransformation_greenFBBBF(
		...
		ta2g.setSource(typeAcc);
		ta2g.setTarget(interfaceGeneralization);
		return new Object[] { typeAcc, interfaceGeneralization, superInterfaceDec, classDec, ta2g };
	}
	...
	public static final void pattern_TypeAccess2InterfaceGeneralization_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject interfaceGeneralization, EObject cd2c, EObject superInterfaceDec, EObject superInterface,
			EObject classDec, EObject ta2g, EObject childInterface) {
		_this.registerObjects_BWD(ruleresult, cd2c2, typeAcc, interfaceGeneralization, cd2c, superInterfaceDec,
				superInterface, classDec, ta2g, childInterface);
					...
					for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!cd2c.equals(cd2c2)) {
							...
							if (tmpClassDec instanceof InterfaceDeclaration) {
								InterfaceDeclaration classDec = (InterfaceDeclaration) tmpClassDec;
								if (!classDec.equals(superInterfaceDec)) {
									_result.add(new Object[] { cd2c2, interfaceGeneralization, cd2c, superInterfaceDec,
											superInterface, classDec, childInterface, match });
								}
							}
								...
								if (superInterfaceDec.equals(cd2c2.getSource())) {
									if (childInterface.getGenerals().contains(superInterface)) {
										if (childInterface.getGeneralizations().contains(interfaceGeneralization)) {
											if (childInterface.equals(cd2c.getTarget())) {
												_result.add(new Object[] { cd2c2, interfaceGeneralization, cd2c,
														superInterfaceDec, superInterface, classDec, childInterface });
											}
										}
									}
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			Generalization interfaceGeneralization, ASTNode2Element cd2c, InterfaceDeclaration superInterfaceDec,
			Interface superInterface, InterfaceDeclaration classDec, Interface childInterface) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, cd2c2, interfaceGeneralization, cd2c,
				superInterfaceDec, superInterface, classDec, childInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cd2c2, interfaceGeneralization, cd2c,
					superInterfaceDec, superInterface, classDec, childInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceGeneralization_12_4_solveCSP_binding = pattern_TypeAccess2InterfaceGeneralization_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, cd2c2, interfaceGeneralization, cd2c, superInterfaceDec, superInterface,
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_750522 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_856645 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess typeAcc) {
		for (ClassDeclaration __DEC_typeAcc_superClass_886708 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_824156 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_705492 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_176569 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_370823 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
					...
					if (tmpSuperInterface instanceof Interface) {
						...
						if (tmpClassDec instanceof InterfaceDeclaration) {
							...
							if (tmpChildInterface instanceof Interface) {
								Interface childInterface = (Interface) tmpChildInterface;
								return new Object[] { typeAcc, interfaceGeneralization, superInterfaceDec,
										superInterface, classDec, childInterface, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_24_2_matchsrctrgcontext_blackBBBBBBBB(
			...
			Interface superInterface, InterfaceDeclaration classDec, Interface childInterface, Match sourceMatch,
			Match targetMatch) {
		if (!classDec.equals(superInterfaceDec)) {
			if (!childInterface.equals(superInterface)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { typeAcc, interfaceGeneralization, superInterfaceDec, superInterface, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceGeneralization_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceGeneralization_24_2_matchsrctrgcontext_black = pattern_TypeAccess2InterfaceGeneralization_24_2_matchsrctrgcontext_blackBBBBBBBB(
					typeAcc, interfaceGeneralization, superInterfaceDec, superInterface, classDec, childInterface,
					sourceMatch, targetMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_24_3_solvecsp_bindingFBBBBBBBBB(
			TypeAccess2InterfaceGeneralization _this, TypeAccess typeAcc, Generalization interfaceGeneralization,
			InterfaceDeclaration superInterfaceDec, Interface superInterface, InterfaceDeclaration classDec,
			Interface childInterface, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(typeAcc, interfaceGeneralization, superInterfaceDec,
				superInterface, classDec, childInterface, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, typeAcc, interfaceGeneralization, superInterfaceDec, superInterface,
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceGeneralization_24_3_solvecsp_binding = pattern_TypeAccess2InterfaceGeneralization_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, typeAcc, interfaceGeneralization, superInterfaceDec, superInterface, classDec, childInterface,
				sourceMatch, targetMatch);
					...
					for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (childInterface.equals(cd2c.getTarget())) {
							for (ASTNode2Element cd2c2 : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!cd2c.equals(cd2c2)) {
									if (superInterfaceDec.equals(cd2c2.getSource())) {
										_result.add(new Object[] { cd2c2, cd2c, superInterfaceDec, superInterface,
												classDec, childInterface, sourceMatch, targetMatch });
									}
								}
							}
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_24_6_createcorrespondence_blackBBBBBBB(
			TypeAccess typeAcc, Generalization interfaceGeneralization, InterfaceDeclaration superInterfaceDec,
			Interface superInterface, InterfaceDeclaration classDec, Interface childInterface, CCMatch ccMatch) {
		if (!classDec.equals(superInterfaceDec)) {
			if (!childInterface.equals(superInterface)) {
				return new Object[] { typeAcc, interfaceGeneralization, superInterfaceDec, superInterface, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_27_1_matchtggpattern_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_562975 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, Annotation.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_384044 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ArrayType.class, "elementType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_27_1_matchtggpattern_black_nac_2B(
			TypeAccess typeAcc) {
		for (ClassDeclaration __DEC_typeAcc_superClass_75576 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ClassDeclaration.class, "superClass")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_27_1_matchtggpattern_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_382980 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, MethodDeclaration.class, "returnType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_27_1_matchtggpattern_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_451507 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ParameterizedType.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_27_1_matchtggpattern_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_89879 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, SingleVariableDeclaration.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_360997 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, cd2c2, cd2c, superInterfaceDec,
				superInterface, classDec, childInterface, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cd2c2, cd2c, superInterfaceDec, superInterface,
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceGeneralization_29_3_solveCSP_binding = pattern_TypeAccess2InterfaceGeneralization_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, cd2c2, cd2c, superInterfaceDec, superInterface, classDec, childInterface,
				ruleResult);
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_29_5_checknacs_blackBBBBBB(
		...
		if (!cd2c.equals(cd2c2)) {
			if (!classDec.equals(superInterfaceDec)) {
				if (!childInterface.equals(superInterface)) {
					return new Object[] { cd2c2, cd2c, superInterfaceDec, superInterface, classDec, childInterface };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceGeneralization_29_6_perform_greenFFBBBFBB(
			InterfaceDeclaration superInterfaceDec, Interface superInterface, InterfaceDeclaration classDec,
		...
		return new Object[] { typeAcc, interfaceGeneralization, superInterfaceDec, superInterface, classDec, ta2g,
