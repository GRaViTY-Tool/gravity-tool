...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne);
		...
		OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, classDec,
				umlClass, bodyDeclaration, feature);
		...
		OperationInClassImpl.pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, classDec,
				umlClass, bodyDeclaration, c2c, feature, bd2ne);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl.pattern_OperationInClass_2_2_corematch_blackBFBFFFB(classDec,
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(
					classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(classDec, umlClass,
								bodyDeclaration, c2c, feature, bd2ne);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c,
			Operation feature, ASTNode2Element bd2ne) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject classDec, EObject umlClass,
			EObject bodyDeclaration, EObject c2c, EObject feature, EObject bd2ne) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
				.pattern_OperationInClass_12_2_corematch_blackFBFFBFB(umlClass, feature, match)) {
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(classDec, umlClass,
								bodyDeclaration, c2c, feature, bd2ne);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge umlClass__feature____ownedOperation = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge feature__umlClass____class = (EMoflonEdge) result3_green[8];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_117(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = OperationInClassImpl
				.pattern_OperationInClass_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, classDec, umlClass,
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackBBBFBFBB(classDec, umlClass, bodyDeclaration,
				...
				Object[] result6_black = OperationInClassImpl
						.pattern_OperationInClass_24_6_createcorrespondence_blackBBBBB(classDec, umlClass,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ClassDeclaration classDec, org.eclipse.uml2.uml.Class umlClass,
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			Object[] result3_bindingAndBlack = OperationInClassImpl
					.pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, classDec,
							umlClass, bodyDeclaration, c2c, feature, bd2ne, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
						+ "[umlClass] = " + umlClass + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
			...
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInClassImpl.pattern_OperationInClass_29_6_perform_blackBBBBBBB(
							classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne, ruleResult);
					if (result6_black == null) {
					...
					OperationInClassImpl.pattern_OperationInClass_29_6_perform_greenBBBBB(classDec, umlClass,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c,
			Operation feature, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSDECLARATION_CLASS_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_OPERATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_CLASS_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_OPERATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_117__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_117((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_121__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__CLASSDECLARATION_CLASS_MABSTRACTMETHODDEFINITION_OPERATION_MATCH_MATCH:
		...
		case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_CLASS_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_OPERATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpC2c instanceof ASTNode2Element) {
						...
						if (tmpFeature instanceof Operation) {
							...
							if (tmpBd2ne instanceof ASTNode2Element) {
								...
								return new Object[] { classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
			...
			ASTNode2Element c2c, Operation feature, ASTNode2Element bd2ne, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_1_1_performtransformation_binding != null) {
			...
			Operation feature = (Operation) result_pattern_OperationInClass_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_OperationInClass_1_1_performtransformation_black = pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
					classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject classDec, EObject umlClass, EObject bodyDeclaration, EObject c2c,
															...
															if (!bd2ne.equals(c2c)) {
																if (!bd2ne.equals(feature)) {
																	return new Object[] { ruleresult, classDec,
																			umlClass, bodyDeclaration, c2c, feature,
																			bd2ne };
																}
															}
														}
	...
	public static final void pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject classDec, EObject umlClass, EObject bodyDeclaration, EObject c2c,
			EObject feature, EObject bd2ne) {
		_this.registerObjects_FWD(ruleresult, classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne);
	...
	public static final Iterable<Object[]> pattern_OperationInClass_2_2_corematch_blackBFBFFFB(
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne, match });
						}
					...
					if (classDec.equals(c2c.getSource())) {
						if (bodyDeclaration.equals(bd2ne.getSource())) {
							if (feature.equals(bd2ne.getTarget())) {
								_result.add(new Object[] { classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(ClassDeclaration classDec,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c,
			Operation feature, ASTNode2Element bd2ne) {
		...
		return new Object[] { classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne, isApplicableMatch,
				classDec__bodyDeclaration____bodyDeclarations, bodyDeclaration__classDec____abstractTypeDeclaration,
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, ClassDeclaration classDec, org.eclipse.uml2.uml.Class umlClass,
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c, Operation feature, ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, classDec, umlClass, bodyDeclaration,
				c2c, feature, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, umlClass, bodyDeclaration, c2c, feature,
					bd2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInClass _this,
		...
		Object[] result_pattern_OperationInClass_2_4_solveCSP_binding = pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne);
	...
	public static final Object[] pattern_OperationInClass_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_11_1_performtransformation_binding != null) {
			...
			Operation feature = (Operation) result_pattern_OperationInClass_11_1_performtransformation_binding[4];
	...
	public static final void pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject classDec, EObject umlClass, EObject bodyDeclaration, EObject c2c,
			EObject feature, EObject bd2ne) {
		_this.registerObjects_BWD(ruleresult, classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne);
	...
	public static final Iterable<Object[]> pattern_OperationInClass_12_2_corematch_blackFBFFBFB(
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			OperationInClass _this, IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c,
			Operation feature, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_OperationInClass_29_3_solveCSP_binding = pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne, ruleResult);
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_blackBBBBBBB(ClassDeclaration classDec,
			...
			Operation feature, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { classDec, umlClass, bodyDeclaration, c2c, feature, bd2ne, ruleResult };
		}
		return null;
	}
