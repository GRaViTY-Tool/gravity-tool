...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		OperationInClassImpl.pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, bd2ne,
				classDec, bodyDeclaration, feature, c2c, umlClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl.pattern_OperationInClass_2_2_corematch_blackFBBFFFB(classDec,
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(
					bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(bd2ne, classDec, bodyDeclaration,
								feature, c2c, umlClass);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne,
			...
			ASTNode2Element c2c, org.eclipse.uml2.uml.Class umlClass) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bd2ne, EObject classDec,
			EObject bodyDeclaration, EObject feature, EObject c2c, EObject umlClass) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl.pattern_OperationInClass_12_2_corematch_blackFFFBFBB(feature,
				umlClass, match)) {
			ASTNode2Element bd2ne = (ASTNode2Element) result2_black[0];
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(bd2ne, classDec, bodyDeclaration,
								feature, c2c, umlClass);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject bd2ne, EObject classDec,
			EObject bodyDeclaration, EObject feature, EObject c2c, EObject umlClass) {
		ruleresult.registerObject("bd2ne", bd2ne);
		ruleresult.registerObject("classDec", classDec);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_149(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackFBBBFBBB(classDec, bodyDeclaration, feature,
	...
	public CSP isApplicable_solveCsp_CC(ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration,
			Operation feature, org.eclipse.uml2.uml.Class umlClass, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			Object[] result3_bindingAndBlack = OperationInClassImpl
					.pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, bd2ne,
							classDec, bodyDeclaration, feature, c2c, umlClass, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[bd2ne] = " + bd2ne + ", "
						+ "[classDec] = " + classDec + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
			...
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInClassImpl.pattern_OperationInClass_29_6_perform_blackBBBBBBB(
							bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass, ruleResult);
					if (result6_black == null) {
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne,
			ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			ASTNode2Element c2c, org.eclipse.uml2.uml.Class umlClass, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASSDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_ASTNODE2ELEMENT_CLASS:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASSDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_ASTNODE2ELEMENT_CLASS:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_149__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__CLASSDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_CLASS_MATCH_MATCH:
		...
		case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASSDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_ASTNODE2ELEMENT_CLASS_MODELGENERATORRULERESULT:
					...
					if (tmpFeature instanceof Operation) {
						...
						if (tmpC2c instanceof ASTNode2Element) {
							...
							if (tmpUmlClass instanceof org.eclipse.uml2.uml.Class) {
								...
								return new Object[] { bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element bd2ne, ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration,
			Operation feature, ASTNode2Element c2c, org.eclipse.uml2.uml.Class umlClass, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInClass_1_1_performtransformation_black = pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
					bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject bd2ne, EObject classDec, EObject bodyDeclaration, EObject feature,
			EObject c2c, EObject umlClass) {
															...
															if (!c2c.equals(feature)) {
																if (!c2c.equals(umlClass)) {
																	return new Object[] { ruleresult, bd2ne, classDec,
																			bodyDeclaration, feature, c2c, umlClass };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject bd2ne, EObject classDec, EObject bodyDeclaration, EObject feature,
			EObject c2c, EObject umlClass) {
		_this.registerObjects_FWD(ruleresult, bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass);
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass, match });
						}
	...
	public static final Iterable<Object[]> pattern_OperationInClass_2_3_findcontext_blackBBBBBB(ASTNode2Element bd2ne,
			ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			ASTNode2Element c2c, org.eclipse.uml2.uml.Class umlClass) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
					...
					if (classDec.equals(c2c.getSource())) {
						if (umlClass.equals(c2c.getTarget())) {
							if (bodyDeclaration.equals(bd2ne.getSource())) {
								_result.add(new Object[] { bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element bd2ne,
		...
		return new Object[] { bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass, isApplicableMatch,
				classDec__bodyDeclaration____bodyDeclarations, bodyDeclaration__classDec____abstractTypeDeclaration,
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne, ClassDeclaration classDec,
			MAbstractMethodDefinition bodyDeclaration, Operation feature, ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, bd2ne, classDec, bodyDeclaration,
				feature, c2c, umlClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bd2ne, classDec, bodyDeclaration, feature, c2c,
					umlClass };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInClass _this,
		...
		Object[] result_pattern_OperationInClass_2_4_solveCSP_binding = pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass);
	...
	public static final void pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject bd2ne, EObject classDec, EObject bodyDeclaration, EObject feature,
			EObject c2c, EObject umlClass) {
		_this.registerObjects_BWD(ruleresult, bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass);
	...
	public static final Iterable<Object[]> pattern_OperationInClass_12_2_corematch_blackFFFBFBB(Operation feature,
	...
	public static final Object[] pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element bd2ne,
		...
		bd2ne__bodyDeclaration____source.setName(bd2ne__bodyDeclaration____source_name_prime);
		return new Object[] { bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass, isApplicableMatch,
				bd2ne__feature____target, c2c__classDec____source, umlClass__feature____ownedOperation,
				feature__umlClass____class, c2c__umlClass____target, bd2ne__bodyDeclaration____source };
	}
	...
	public static final Object[] pattern_OperationInClass_12_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			...
			MAbstractMethodDefinition bodyDeclaration, Operation feature, ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, bd2ne, classDec, bodyDeclaration,
				feature, c2c, umlClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bd2ne, classDec, bodyDeclaration, feature, c2c,
	...
	public static final Iterable<Object[]> pattern_OperationInClass_24_5_matchcorrcontext_blackFBBBFBBB(
			ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			org.eclipse.uml2.uml.Class umlClass, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(OperationInClass _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, bd2ne, classDec, bodyDeclaration,
				feature, c2c, umlClass, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bd2ne, classDec, bodyDeclaration, feature, c2c,
					umlClass, ruleResult };
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			...
			ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			ASTNode2Element c2c, org.eclipse.uml2.uml.Class umlClass, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_OperationInClass_29_3_solveCSP_binding = pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass, ruleResult);
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_blackBBBBBBB(ASTNode2Element bd2ne,
			...
			ASTNode2Element c2c, org.eclipse.uml2.uml.Class umlClass, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { bd2ne, classDec, bodyDeclaration, feature, c2c, umlClass, ruleResult };
		}
		return null;
	}
