...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[umlClass] = " + umlClass + ", "
					+ "[feature] = " + feature + ", " + "[bd2ne] = " + bd2ne + ", " + "[classDec] = " + classDec + ", "
					+ "[c2c] = " + c2c + ".");
		}
		...
		OperationInClassImpl.pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
				.pattern_OperationInClass_2_2_corematch_blackBFFFBFB(bodyDeclaration, classDec, match)) {
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, umlClass, feature,
								bd2ne, classDec, c2c);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject umlClass,
			EObject feature, EObject bd2ne, EObject classDec, EObject c2c) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, umlClass,
								feature, bd2ne, classDec, c2c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge bd2ne__bodyDeclaration____source = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_65(EMoflonEdge _edge_ownedOperation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_79(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackBBBFBFBB(bodyDeclaration, umlClass, feature,
			...
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[bodyDeclaration] = "
								+ bodyDeclaration + ", " + "[umlClass] = " + umlClass + ", " + "[feature] = " + feature
								+ ", " + "[bd2ne] = " + bd2ne + ", " + "[classDec] = " + classDec + ", " + "[c2c] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			...
			ASTNode2Element bd2ne, ClassDeclaration classDec, ASTNode2Element c2c,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_CLASS_OPERATION_ASTNODE2ELEMENT_CLASSDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_CLASS_OPERATION_ASTNODE2ELEMENT_CLASSDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_65__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_65((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_79__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__MABSTRACTMETHODDEFINITION_CLASS_OPERATION_CLASSDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_CLASS_OPERATION_ASTNODE2ELEMENT_CLASSDECLARATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpBd2ne instanceof ASTNode2Element) {
						...
						if (tmpClassDec instanceof ClassDeclaration) {
							...
							if (tmpC2c instanceof ASTNode2Element) {
								...
								return new Object[] { bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
			MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass, Operation feature,
			ASTNode2Element bd2ne, ClassDeclaration classDec, ASTNode2Element c2c, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInClass_1_1_performtransformation_black = pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
					bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject umlClass, EObject feature, EObject bd2ne,
															...
															if (!c2c.equals(feature)) {
																if (!c2c.equals(classDec)) {
																	return new Object[] { ruleresult, bodyDeclaration,
																			umlClass, feature, bd2ne, classDec, c2c };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject umlClass, EObject feature, EObject bd2ne,
			EObject classDec, EObject c2c) {
		_this.registerObjects_FWD(ruleresult, bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c);
				...
				for (ASTNode2Element c2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpUmlClass instanceof org.eclipse.uml2.uml.Class) {
							org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) tmpUmlClass;
							_result.add(
									new Object[] { bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c, match });
						}
					...
					if (classDec.equals(c2c.getSource())) {
						if (feature.equals(bd2ne.getTarget())) {
							if (umlClass.equals(c2c.getTarget())) {
								_result.add(new Object[] { bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c, isApplicableMatch,
				bd2ne__bodyDeclaration____source, classDec__bodyDeclaration____bodyDeclarations,
				bodyDeclaration__classDec____abstractTypeDeclaration, c2c__classDec____source, bd2ne__feature____target,
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			...
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne, ClassDeclaration classDec,
			ASTNode2Element c2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, bodyDeclaration, umlClass, feature,
				bd2ne, classDec, c2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, umlClass, feature, bd2ne, classDec,
					c2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInClass _this,
		...
		Object[] result_pattern_OperationInClass_2_4_solveCSP_binding = pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c);
		if (result_pattern_OperationInClass_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_OperationInClass_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, umlClass, feature, bd2ne,
						classDec, c2c };
			}
		}
		return null;
	...
	public static final void pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject umlClass, EObject feature, EObject bd2ne,
			EObject classDec, EObject c2c) {
		_this.registerObjects_BWD(ruleresult, bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c);
	...
	public static final Object[] pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c, isApplicableMatch,
				...
				feature__umlClass____class, bd2ne__feature____target, c2c__umlClass____target };
	}
	...
	public static final Object[] pattern_OperationInClass_12_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			...
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne, ClassDeclaration classDec,
			ASTNode2Element c2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, bodyDeclaration, umlClass, feature,
				bd2ne, classDec, c2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, umlClass, feature, bd2ne, classDec,
	...
	public static final Iterable<Object[]> pattern_OperationInClass_24_5_matchcorrcontext_blackBBBFBFBB(
			MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass, Operation feature,
			ClassDeclaration classDec, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(OperationInClass _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, bodyDeclaration, umlClass, feature,
				bd2ne, classDec, c2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, umlClass, feature, bd2ne, classDec,
					c2c, ruleResult };
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInClass_29_3_solveCSP_binding = pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c, ruleResult);
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_blackBBBBBBB(
		...
		if (!bd2ne.equals(c2c)) {
			return new Object[] { bodyDeclaration, umlClass, feature, bd2ne, classDec, c2c, ruleResult };
		}
		return null;
	}
