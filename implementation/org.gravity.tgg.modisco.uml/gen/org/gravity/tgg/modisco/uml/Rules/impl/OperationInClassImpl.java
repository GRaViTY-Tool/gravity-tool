...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[classDec] = " + classDec + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
					+ "[c2c] = " + c2c + ", " + "[bd2ne] = " + bd2ne + ", " + "[umlClass] = " + umlClass + ", "
					+ "[feature] = " + feature + ".");
		}
		...
		OperationInClassImpl.pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, classDec,
				bodyDeclaration, c2c, bd2ne, umlClass, feature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl.pattern_OperationInClass_2_2_corematch_blackBBFFFFB(classDec,
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(
					classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(classDec, bodyDeclaration, c2c,
								bd2ne, umlClass, feature);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[c2c] = " + c2c + ", " + "[bd2ne] = "
							+ bd2ne + ", " + "[umlClass] = " + umlClass + ", " + "[feature] = " + feature + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c, ASTNode2Element bd2ne,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject classDec, EObject bodyDeclaration,
			EObject c2c, EObject bd2ne, EObject umlClass, EObject feature) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(classDec, bodyDeclaration, c2c,
								bd2ne, umlClass, feature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackBBFFBBBB(classDec, bodyDeclaration, umlClass,
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			Object[] result3_bindingAndBlack = OperationInClassImpl
					.pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, classDec,
							bodyDeclaration, c2c, bd2ne, umlClass, feature, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
						+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[c2c] = " + c2c + ", " + "[bd2ne] = "
			...
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInClassImpl.pattern_OperationInClass_29_6_perform_blackBBBBBBB(
							classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[classDec] = "
								+ classDec + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[c2c] = " + c2c
								+ ", " + "[bd2ne] = " + bd2ne + ", " + "[umlClass] = " + umlClass + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSDECLARATION_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_CLASS_OPERATION:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_CLASS_OPERATION:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_132__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_CLASS_OPERATION_MODELGENERATORRULERESULT:
					...
					if (tmpBd2ne instanceof ASTNode2Element) {
						...
						if (tmpUmlClass instanceof org.eclipse.uml2.uml.Class) {
							...
							if (tmpFeature instanceof Operation) {
								...
								return new Object[] { classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
			ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c,
			ASTNode2Element bd2ne, org.eclipse.uml2.uml.Class umlClass, Operation feature, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInClass_1_1_performtransformation_black = pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
					classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject classDec, EObject bodyDeclaration, EObject c2c, EObject bd2ne,
															...
															if (!bd2ne.equals(feature)) {
																if (!feature.equals(umlClass)) {
																	return new Object[] { ruleresult, classDec,
																			bodyDeclaration, c2c, bd2ne, umlClass,
																			feature };
																}
															}
														}
	...
	public static final void pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject classDec, EObject bodyDeclaration, EObject c2c, EObject bd2ne,
			EObject umlClass, EObject feature) {
		_this.registerObjects_FWD(ruleresult, classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature);
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature, match });
						}
					...
					if (classDec.equals(c2c.getSource())) {
						if (classDec.getBodyDeclarations().contains(bodyDeclaration)) {
							if (bodyDeclaration.equals(bd2ne.getSource())) {
								_result.add(new Object[] { classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(ClassDeclaration classDec,
		...
		return new Object[] { classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature, isApplicableMatch,
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration,
			ASTNode2Element c2c, ASTNode2Element bd2ne, org.eclipse.uml2.uml.Class umlClass, Operation feature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, classDec, bodyDeclaration, c2c, bd2ne,
				umlClass, feature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, bodyDeclaration, c2c, bd2ne, umlClass,
					feature };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInClass _this,
		...
		Object[] result_pattern_OperationInClass_2_4_solveCSP_binding = pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature);
	...
	public static final void pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject classDec, EObject bodyDeclaration, EObject c2c, EObject bd2ne,
			EObject umlClass, EObject feature) {
		_this.registerObjects_BWD(ruleresult, classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature);
	...
	public static final Object[] pattern_OperationInClass_12_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration,
			ASTNode2Element c2c, ASTNode2Element bd2ne, org.eclipse.uml2.uml.Class umlClass, Operation feature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, classDec, bodyDeclaration, c2c, bd2ne,
				umlClass, feature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, bodyDeclaration, c2c, bd2ne, umlClass,
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(OperationInClass _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, classDec, bodyDeclaration, c2c,
				bd2ne, umlClass, feature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, bodyDeclaration, c2c, bd2ne, umlClass,
					feature, ruleResult };
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInClass_29_3_solveCSP_binding = pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature, ruleResult);
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_blackBBBBBBB(ClassDeclaration classDec,
			...
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { classDec, bodyDeclaration, c2c, bd2ne, umlClass, feature, ruleResult };
		}
		return null;
	}
