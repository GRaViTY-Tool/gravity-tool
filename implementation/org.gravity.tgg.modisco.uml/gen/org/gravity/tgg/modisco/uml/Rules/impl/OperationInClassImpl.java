...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne);
		...
		// 
		// 
		OperationInClassImpl.pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, umlClass,
				bodyDeclaration, classDec, feature, c2c, bd2ne);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
				.pattern_OperationInClass_2_2_corematch_blackFBBFFFB(bodyDeclaration, classDec, match)) {
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(
					umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(umlClass, bodyDeclaration,
								classDec, feature, c2c, bd2ne);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[classDec] = " + classDec + ", "
							+ "[feature] = " + feature + ", " + "[c2c] = " + c2c + ", " + "[bd2ne] = " + bd2ne + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class umlClass,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, Operation feature,
			ASTNode2Element c2c, ASTNode2Element bd2ne) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject umlClass, EObject bodyDeclaration,
			EObject classDec, EObject feature, EObject c2c, EObject bd2ne) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
				.pattern_OperationInClass_12_2_corematch_blackBFFBFFB(umlClass, feature, match)) {
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(umlClass, bodyDeclaration,
								classDec, feature, c2c, bd2ne);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject umlClass, EObject bodyDeclaration,
			EObject classDec, EObject feature, EObject c2c, EObject bd2ne) {
		ruleresult.registerObject("umlClass", umlClass);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
		ruleresult.registerObject("classDec", classDec);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackBBBBFFBB(umlClass, bodyDeclaration, classDec,
	...
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration,
			ClassDeclaration classDec, Operation feature, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, ASTNode2Element c2cParameter,
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			Object[] result3_bindingAndBlack = OperationInClassImpl
					.pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, umlClass,
							bodyDeclaration, classDec, feature, c2c, bd2ne, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[umlClass] = " + umlClass + ", "
						+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[classDec] = " + classDec + ", "
			...
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInClassImpl.pattern_OperationInClass_29_6_perform_blackBBBBBBB(
							umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[umlClass] = "
								+ umlClass + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[classDec] = "
								+ classDec + ", " + "[feature] = " + feature + ", " + "[c2c] = " + c2c + ", "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class umlClass,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, Operation feature,
			ASTNode2Element c2c, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASS_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_OPERATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(org.eclipse.uml2.uml.Class) arguments.get(1), (MAbstractMethodDefinition) arguments.get(2),
						(ClassDeclaration) arguments.get(3), (Operation) arguments.get(4),
			...
			case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_OPERATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
			...
			case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_108__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_108((EMoflonEdge) arguments.get(0));
			case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_115__EMOFLONEDGE:
			...
			case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__CLASS_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_OPERATION_MATCH_MATCH:
			...
			case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_OPERATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpFeature instanceof Operation) {
						...
						if (tmpC2c instanceof ASTNode2Element) {
							...
							if (tmpBd2ne instanceof ASTNode2Element) {
								...
								return new Object[] { umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
			...
			Operation feature, ASTNode2Element c2c, ASTNode2Element bd2ne, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_1_1_performtransformation_binding != null) {
			org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) result_pattern_OperationInClass_1_1_performtransformation_binding[0];
			MAbstractMethodDefinition bodyDeclaration = (MAbstractMethodDefinition) result_pattern_OperationInClass_1_1_performtransformation_binding[1];
			ClassDeclaration classDec = (ClassDeclaration) result_pattern_OperationInClass_1_1_performtransformation_binding[2];
			Operation feature = (Operation) result_pattern_OperationInClass_1_1_performtransformation_binding[3];
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInClass_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_OperationInClass_1_1_performtransformation_black = pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
					umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject umlClass, EObject bodyDeclaration, EObject classDec, EObject feature,
															...
															if (!bd2ne.equals(feature)) {
																if (!bd2ne.equals(c2c)) {
																	return new Object[] { ruleresult, umlClass,
																			bodyDeclaration, classDec, feature, c2c,
																			bd2ne };
																}
															}
														}
	...
	public static final void pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject umlClass, EObject bodyDeclaration, EObject classDec, EObject feature,
			EObject c2c, EObject bd2ne) {
		_this.registerObjects_FWD(ruleresult, umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne);
	...
	public static final Iterable<Object[]> pattern_OperationInClass_2_2_corematch_blackFBBFFFB(
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne, match });
						}
	...
	public static final Iterable<Object[]> pattern_OperationInClass_2_3_findcontext_blackBBBBBB(
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
			Operation feature, ASTNode2Element c2c, ASTNode2Element bd2ne) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
					...
					if (feature.equals(bd2ne.getTarget())) {
						if (umlClass.equals(c2c.getTarget())) {
							if (bodyDeclaration.equals(bd2ne.getSource())) {
								_result.add(new Object[] { umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne, isApplicableMatch,
				classDec__bodyDeclaration____bodyDeclarations, bodyDeclaration__classDec____abstractTypeDeclaration,
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class umlClass,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, Operation feature,
			ASTNode2Element c2c, ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, umlClass, bodyDeclaration, classDec,
				feature, c2c, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlClass, bodyDeclaration, classDec, feature, c2c,
					bd2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInClass _this,
		...
		Object[] result_pattern_OperationInClass_2_4_solveCSP_binding = pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne);
	...
	public static final Object[] pattern_OperationInClass_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_11_1_performtransformation_binding != null) {
			org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) result_pattern_OperationInClass_11_1_performtransformation_binding[0];
			MAbstractMethodDefinition bodyDeclaration = (MAbstractMethodDefinition) result_pattern_OperationInClass_11_1_performtransformation_binding[1];
			ClassDeclaration classDec = (ClassDeclaration) result_pattern_OperationInClass_11_1_performtransformation_binding[2];
			Operation feature = (Operation) result_pattern_OperationInClass_11_1_performtransformation_binding[3];
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInClass_11_1_performtransformation_binding[4];
	...
	public static final void pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject umlClass, EObject bodyDeclaration, EObject classDec, EObject feature,
			EObject c2c, EObject bd2ne) {
		_this.registerObjects_BWD(ruleresult, umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne);
	...
	public static final Iterable<Object[]> pattern_OperationInClass_12_2_corematch_blackBFFBFFB(
	...
	public static final Object[] pattern_OperationInClass_12_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			...
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, Operation feature,
			ASTNode2Element c2c, ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, umlClass, bodyDeclaration, classDec,
				feature, c2c, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlClass, bodyDeclaration, classDec, feature, c2c,
	...
	public static final Iterable<Object[]> pattern_OperationInClass_24_5_matchcorrcontext_blackBBBBFFBB(
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
			Operation feature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class umlClass,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, Operation feature,
			ASTNode2Element c2c, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, umlClass, bodyDeclaration, classDec,
				feature, c2c, bd2ne, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlClass, bodyDeclaration, classDec, feature, c2c,
					bd2ne, ruleResult };
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			OperationInClass _this, IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class umlClass,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, Operation feature,
			ASTNode2Element c2c, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_OperationInClass_29_3_solveCSP_binding = pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne, ruleResult);
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_blackBBBBBBB(org.eclipse.uml2.uml.Class umlClass,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, Operation feature,
			ASTNode2Element c2c, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { umlClass, bodyDeclaration, classDec, feature, c2c, bd2ne, ruleResult };
		}
		return null;
	}
