...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl.pattern_OperationInClass_2_2_corematch_blackFBFFBFB(classDec,
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(umlClass, classDec, c2c, bd2ne,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class umlClass,
			ClassDeclaration classDec, ASTNode2Element c2c, ASTNode2Element bd2ne,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
				.pattern_OperationInClass_12_2_corematch_blackBFFFFBB(umlClass, feature, match)) {
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(umlClass, classDec, c2c, bd2ne,
								bodyDeclaration, feature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_148(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = OperationInClassImpl
				.pattern_OperationInClass_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, umlClass, classDec,
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackBBFFBBBB(umlClass, classDec, bodyDeclaration,
				...
				Object[] result6_black = OperationInClassImpl
						.pattern_OperationInClass_24_6_createcorrespondence_blackBBBBB(umlClass, classDec,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Class umlClass, ClassDeclaration classDec,
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					OperationInClassImpl.pattern_OperationInClass_29_6_perform_greenBBBBB(umlClass, classDec,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASS_CLASSDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_OPERATION:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						...
						(MAbstractMethodDefinition) arguments.get(5), (Operation) arguments.get(6));
			...
			case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_CLASSDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_OPERATION:
			...
			case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_148__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_148((EMoflonEdge) arguments.get(0));
			case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_162__EMOFLONEDGE:
			...
			case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__CLASS_CLASSDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_MATCH_MATCH:
				return isApplicable_solveCsp_CC((org.eclipse.uml2.uml.Class) arguments.get(0),
						(ClassDeclaration) arguments.get(1), (MAbstractMethodDefinition) arguments.get(2),
			...
			case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_CLASSDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_OPERATION_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
			org.eclipse.uml2.uml.Class umlClass, ClassDeclaration classDec, ASTNode2Element c2c, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, Operation feature, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
	...
	public static final Iterable<Object[]> pattern_OperationInClass_2_2_corematch_blackFBFFBFB(
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class umlClass, ClassDeclaration classDec,
			ASTNode2Element c2c, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration, Operation feature) {
	...
	public static final Iterable<Object[]> pattern_OperationInClass_12_2_corematch_blackBFFFFBB(
	...
	public static final Iterable<Object[]> pattern_OperationInClass_24_5_matchcorrcontext_blackBBFFBBBB(
			org.eclipse.uml2.uml.Class umlClass, ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration,
			Operation feature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_greenBBBBB(org.eclipse.uml2.uml.Class umlClass,
			ClassDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			ModelgeneratorRuleResult ruleResult) {
		umlClass.getOwnedOperations().add(feature);
		classDec.getBodyDeclarations().add(bodyDeclaration);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
