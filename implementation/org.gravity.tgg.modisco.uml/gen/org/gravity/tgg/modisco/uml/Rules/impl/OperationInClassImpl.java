...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c2c] = " + c2c + ", " + "[umlClass] = " + umlClass + ", " + "[feature] = " + feature
		...
		// 
		// 
		OperationInClassImpl.pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, c2c,
				umlClass, feature, bd2ne, bodyDeclaration, classDec);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
				.pattern_OperationInClass_2_2_corematch_blackFFFFBBB(bodyDeclaration, classDec, match)) {
			...
			// ForEach 
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(c2c,
					umlClass, feature, bd2ne, bodyDeclaration, classDec)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(c2c, umlClass, feature, bd2ne,
								bodyDeclaration, classDec);
				...
				Object[] result4_bindingAndBlack = OperationInClassImpl
						.pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, c2c,
								umlClass, feature, bd2ne, bodyDeclaration, classDec);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[c2c] = " + c2c + ", "
							+ "[umlClass] = " + umlClass + ", " + "[feature] = " + feature + ", " + "[bd2ne] = " + bd2ne
							+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[classDec] = " + classDec
							+ ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject c2c, EObject umlClass, EObject feature,
			EObject bd2ne, EObject bodyDeclaration, EObject classDec) {
	...
	public boolean isAppropriate_BWD(Match match, org.eclipse.uml2.uml.Class umlClass, Operation feature) {
		...
		Object[] result2_bindingAndBlack = OperationInClassImpl
				.pattern_OperationInClass_10_2_SolveCSP_bindingAndBlackFBBBB(this, match, umlClass, feature);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[umlClass] = " + umlClass + ", " + "[feature] = " + feature + ".");
		}
		...
		if (OperationInClassImpl.pattern_OperationInClass_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = OperationInClassImpl
					.pattern_OperationInClass_10_4_collectelementstobetranslated_blackBBB(match, umlClass, feature);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umlClass] = " + umlClass + ", " + "[feature] = " + feature + ".");
			}
			OperationInClassImpl.pattern_OperationInClass_10_4_collectelementstobetranslated_greenBBBFF(match, umlClass,
					feature);
			...
			Object[] result5_black = OperationInClassImpl
					.pattern_OperationInClass_10_5_collectcontextelements_blackBBB(match, umlClass, feature);
			if (result5_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[umlClass] = " + umlClass + ", " + "[feature] = " + feature + ".");
			}
			OperationInClassImpl.pattern_OperationInClass_10_5_collectcontextelements_greenBBB(match, umlClass,
					feature);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		// 
		// 
		OperationInClassImpl.pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(this, ruleresult, c2c,
				umlClass, feature, bd2ne, bodyDeclaration, classDec);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
				.pattern_OperationInClass_12_2_corematch_blackFBBFFFB(umlClass, feature, match)) {
			ASTNode2Element c2c = (ASTNode2Element) result2_black[0];
			ASTNode2Element bd2ne = (ASTNode2Element) result2_black[3];
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(c2c, umlClass, feature, bd2ne,
								bodyDeclaration, classDec);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge c2c__umlClass____target = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge bd2ne__bodyDeclaration____source = (EMoflonEdge) result3_green[8];
				...
				Object[] result4_bindingAndBlack = OperationInClassImpl
						.pattern_OperationInClass_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch, c2c,
								umlClass, feature, bd2ne, bodyDeclaration, classDec);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[c2c] = " + c2c + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject c2c, EObject umlClass, EObject feature,
			EObject bd2ne, EObject bodyDeclaration, EObject classDec) {
		ruleresult.registerObject("c2c", c2c);
		ruleresult.registerObject("umlClass", umlClass);
		ruleresult.registerObject("feature", feature);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_156(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = OperationInClassImpl
				.pattern_OperationInClass_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, umlClass, feature,
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackFBBFBBBB(umlClass, feature, bodyDeclaration,
				...
				Object[] result6_black = OperationInClassImpl
						.pattern_OperationInClass_24_6_createcorrespondence_blackBBBBB(umlClass, feature,
	...
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Class umlClass, Operation feature,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, Match sourceMatch,
	...
	public boolean checkDEC_BWD(org.eclipse.uml2.uml.Class umlClass, Operation feature) {// 
		Object[] result1_black = OperationInClassImpl.pattern_OperationInClass_28_1_matchtggpattern_blackBB(umlClass,
				feature);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, ASTNode2Element c2cParameter,
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			Object[] result3_bindingAndBlack = OperationInClassImpl
					.pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, c2c,
							umlClass, feature, bd2ne, bodyDeclaration, classDec, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[c2c] = " + c2c + ", "
						+ "[umlClass] = " + umlClass + ", " + "[feature] = " + feature + ", " + "[bd2ne] = " + bd2ne
			...
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = OperationInClassImpl.pattern_OperationInClass_29_5_checknacs_blackBBBBBB(c2c,
						umlClass, feature, bd2ne, bodyDeclaration, classDec);
				if (result5_black != null) {

					Object[] result6_black = OperationInClassImpl.pattern_OperationInClass_29_6_perform_blackBBBBBBB(
							c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[c2c] = " + c2c + ", "
								+ "[umlClass] = " + umlClass + ", " + "[feature] = " + feature + ", " + "[bd2ne] = "
								+ bd2ne + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[classDec] = "
								+ classDec + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					OperationInClassImpl.pattern_OperationInClass_29_6_perform_greenBBBBB(umlClass, feature,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASS_OPERATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_CLASSDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(ASTNode2Element) arguments.get(4), (MAbstractMethodDefinition) arguments.get(5),
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD__MATCH_CLASS_OPERATION:
		...
		case RulesPackage.OPERATION_IN_CLASS___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_CLASS_OPERATION:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (org.eclipse.uml2.uml.Class) arguments.get(1),
					(Operation) arguments.get(2));
			return null;
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_CLASS_OPERATION:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASS_OPERATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_CLASSDECLARATION:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_143__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_143((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_156__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__CLASS_OPERATION_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((org.eclipse.uml2.uml.Class) arguments.get(0), (Operation) arguments.get(1),
					(MAbstractMethodDefinition) arguments.get(2), (ClassDeclaration) arguments.get(3),
		...
		case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASS_OPERATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_MODELGENERATORRULERESULT:
					...
					if (tmpBd2ne instanceof ASTNode2Element) {
						...
						if (tmpBodyDeclaration instanceof MAbstractMethodDefinition) {
							...
							if (tmpClassDec instanceof ClassDeclaration) {
								...
								return new Object[] { c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_1_1_performtransformation_binding != null) {
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInClass_1_1_performtransformation_binding[0];
			...
			Operation feature = (Operation) result_pattern_OperationInClass_1_1_performtransformation_binding[2];
			ASTNode2Element bd2ne = (ASTNode2Element) result_pattern_OperationInClass_1_1_performtransformation_binding[3];
			MAbstractMethodDefinition bodyDeclaration = (MAbstractMethodDefinition) result_pattern_OperationInClass_1_1_performtransformation_binding[4];
			ClassDeclaration classDec = (ClassDeclaration) result_pattern_OperationInClass_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_OperationInClass_1_1_performtransformation_black = pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
					c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_greenBB(
	...
	public static final Object[] pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject c2c, EObject umlClass, EObject feature, EObject bd2ne,
															...
															if (!classDec.equals(umlClass)) {
																if (!classDec.equals(feature)) {
																	return new Object[] { ruleresult, c2c, umlClass,
																			feature, bd2ne, bodyDeclaration, classDec };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject c2c, EObject umlClass, EObject feature, EObject bd2ne,
			EObject bodyDeclaration, EObject classDec) {
		_this.registerObjects_FWD(ruleresult, c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec);
				...
				for (ASTNode2Element c2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpUmlClass instanceof org.eclipse.uml2.uml.Class) {
							org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) tmpUmlClass;
							_result.add(
									new Object[] { c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec, match });
						}
	...
	public static final Iterable<Object[]> pattern_OperationInClass_2_3_findcontext_blackBBBBBB(ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
					...
					if (feature.equals(bd2ne.getTarget())) {
						if (classDec.equals(c2c.getSource())) {
							if (classDec.getBodyDeclarations().contains(bodyDeclaration)) {
								_result.add(new Object[] { c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec) {
		...
		bodyDeclaration__classDec____abstractTypeDeclaration
				.setName(bodyDeclaration__classDec____abstractTypeDeclaration_name_prime);
		return new Object[] { c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec, isApplicableMatch,
				c2c__umlClass____target, bd2ne__bodyDeclaration____source, bd2ne__feature____target,
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, ASTNode2Element c2c, org.eclipse.uml2.uml.Class umlClass,
			Operation feature, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration,
			ClassDeclaration classDec) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, c2c, umlClass, feature, bd2ne,
				bodyDeclaration, classDec);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2c, umlClass, feature, bd2ne, bodyDeclaration,
					classDec };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInClass _this,
		...
		Object[] result_pattern_OperationInClass_2_4_solveCSP_binding = pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec);
	...
	public static final Object[] pattern_OperationInClass_11_1_performtransformation_blackBBBBBBFBB(ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
	...
	public static final Object[] pattern_OperationInClass_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_11_1_performtransformation_binding != null) {
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInClass_11_1_performtransformation_binding[0];
			...
			Operation feature = (Operation) result_pattern_OperationInClass_11_1_performtransformation_binding[2];
			ASTNode2Element bd2ne = (ASTNode2Element) result_pattern_OperationInClass_11_1_performtransformation_binding[3];
			MAbstractMethodDefinition bodyDeclaration = (MAbstractMethodDefinition) result_pattern_OperationInClass_11_1_performtransformation_binding[4];
			ClassDeclaration classDec = (ClassDeclaration) result_pattern_OperationInClass_11_1_performtransformation_binding[5];
	...
	public static final void pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject c2c, EObject umlClass, EObject feature, EObject bd2ne,
			EObject bodyDeclaration, EObject classDec) {
		_this.registerObjects_BWD(ruleresult, c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec);
	...
	public static final Iterable<Object[]> pattern_OperationInClass_12_2_corematch_blackFBBFFFB(
	...
	public static final Iterable<Object[]> pattern_OperationInClass_12_3_findcontext_blackBBBBBB(ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
	...
	public static final Object[] pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge c2c__umlClass____target = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec, isApplicableMatch,
				c2c__umlClass____target, bd2ne__bodyDeclaration____source, bd2ne__feature____target,
				c2c__classDec____source, umlClass__feature____ownedOperation, feature__umlClass____class };
	}
	...
	public static final Object[] pattern_OperationInClass_12_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			...
			Operation feature, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration,
			ClassDeclaration classDec) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, c2c, umlClass, feature, bd2ne,
				bodyDeclaration, classDec);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2c, umlClass, feature, bd2ne, bodyDeclaration,
	...
	public static final boolean pattern_OperationInClass_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			OperationInClass _this, Match match, org.eclipse.uml2.uml.Class umlClass, Operation feature) {
	...
	public static final Object[] pattern_OperationInClass_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_OperationInClass_24_2_matchsrctrgcontext_binding != null) {
			...
			MAbstractMethodDefinition bodyDeclaration = (MAbstractMethodDefinition) result_pattern_OperationInClass_24_2_matchsrctrgcontext_binding[2];
	...
	public static final Iterable<Object[]> pattern_OperationInClass_24_5_matchcorrcontext_blackFBBFBBBB(
			org.eclipse.uml2.uml.Class umlClass, Operation feature, MAbstractMethodDefinition bodyDeclaration,
			ClassDeclaration classDec, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInClass_28_1_matchtggpattern_blackBB(
			org.eclipse.uml2.uml.Class umlClass, Operation feature) {
		if (umlClass.getOwnedOperations().contains(feature)) {
			return new Object[] { umlClass, feature };
		}
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(OperationInClass _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, c2c, umlClass, feature, bd2ne,
				bodyDeclaration, classDec, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2c, umlClass, feature, bd2ne, bodyDeclaration,
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			OperationInClass _this, IsApplicableMatch isApplicableMatch, ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_OperationInClass_29_3_solveCSP_binding = pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec, ruleResult);
	...
	public static final Object[] pattern_OperationInClass_29_5_checknacs_blackBBBBBB(ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec };
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_blackBBBBBBB(ASTNode2Element c2c,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { c2c, umlClass, feature, bd2ne, bodyDeclaration, classDec, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_OperationInClass_29_6_perform_greenBBBBB(org.eclipse.uml2.uml.Class umlClass,
			Operation feature, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
