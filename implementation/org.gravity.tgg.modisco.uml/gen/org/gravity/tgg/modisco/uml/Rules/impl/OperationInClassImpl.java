...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c2c] = " + c2c + ", " + "[feature] = " + feature + ", " + "[umlClass] = " + umlClass
					+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[classDec] = " + classDec + ", "
					+ "[bd2ne] = " + bd2ne + ".");
		}
		OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, feature,
		...
		OperationInClassImpl.pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, c2c,
				feature, umlClass, bodyDeclaration, classDec, bd2ne);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
				.pattern_OperationInClass_2_2_corematch_blackFFFBBFB(bodyDeclaration, classDec, match)) {
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(c2c,
				...
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(c2c, feature, umlClass,
								bodyDeclaration, classDec, bd2ne);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element c2c, Operation feature,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject c2c, EObject feature, EObject umlClass,
			EObject bodyDeclaration, EObject classDec, EObject bd2ne) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		OperationInClassImpl.pattern_OperationInClass_11_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, feature,
				umlClass, bodyDeclaration, classDec);
		//nothing EMoflonEdge umlClass__feature____ownedOperation = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge feature__umlClass____class = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge classDec__bodyDeclaration____bodyDeclarations = (EMoflonEdge) result3_green[7];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl.pattern_OperationInClass_12_2_corematch_blackFBBFFFB(feature,
				umlClass, match)) {
			ASTNode2Element c2c = (ASTNode2Element) result2_black[0];
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(c2c, feature, umlClass,
								bodyDeclaration, classDec, bd2ne);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge c2c__classDec____source = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject c2c, EObject feature, EObject umlClass,
			EObject bodyDeclaration, EObject classDec, EObject bd2ne) {
		ruleresult.registerObject("c2c", c2c);
		ruleresult.registerObject("feature", feature);
		ruleresult.registerObject("umlClass", umlClass);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_142(EMoflonEdge _edge_ownedOperation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_153(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = OperationInClassImpl
				.pattern_OperationInClass_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, feature, umlClass,
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackFBBBBFBB(feature, umlClass, bodyDeclaration,
				...
				Object[] result6_black = OperationInClassImpl
						.pattern_OperationInClass_24_6_createcorrespondence_blackBBBBB(feature, umlClass,
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			Object[] result3_bindingAndBlack = OperationInClassImpl
					.pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, c2c,
							feature, umlClass, bodyDeclaration, classDec, bd2ne, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[c2c] = " + c2c + ", " + "[feature] = "
						+ feature + ", " + "[umlClass] = " + umlClass + ", " + "[bodyDeclaration] = " + bodyDeclaration
						+ ", " + "[classDec] = " + classDec + ", " + "[bd2ne] = " + bd2ne + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInClassImpl.pattern_OperationInClass_29_6_perform_blackBBBBBBB(
							c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne, ruleResult);
					if (result6_black == null) {
					...
					OperationInClassImpl.pattern_OperationInClass_29_6_perform_greenBBBBB(feature, umlClass,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_OPERATION_CLASS_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(Operation) arguments.get(2), (org.eclipse.uml2.uml.Class) arguments.get(3),
					(MAbstractMethodDefinition) arguments.get(4), (ClassDeclaration) arguments.get(5),
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_OPERATION_CLASS_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_142__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_142((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_153__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__OPERATION_CLASS_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_OPERATION_CLASS_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpBodyDeclaration instanceof MAbstractMethodDefinition) {
						...
						if (tmpClassDec instanceof ClassDeclaration) {
							...
							if (tmpBd2ne instanceof ASTNode2Element) {
								...
								return new Object[] { c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(ASTNode2Element c2c,
			...
			ClassDeclaration classDec, ASTNode2Element bd2ne, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_1_1_performtransformation_binding != null) {
			...
			org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) result_pattern_OperationInClass_1_1_performtransformation_binding[2];
			MAbstractMethodDefinition bodyDeclaration = (MAbstractMethodDefinition) result_pattern_OperationInClass_1_1_performtransformation_binding[3];
			ClassDeclaration classDec = (ClassDeclaration) result_pattern_OperationInClass_1_1_performtransformation_binding[4];
			ASTNode2Element bd2ne = (ASTNode2Element) result_pattern_OperationInClass_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_OperationInClass_1_1_performtransformation_black = pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
					c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject c2c, EObject feature, EObject umlClass, EObject bodyDeclaration,
			EObject classDec, EObject bd2ne) {
	...
	public static final void pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject c2c, EObject feature, EObject umlClass, EObject bodyDeclaration,
			EObject classDec, EObject bd2ne) {
		_this.registerObjects_FWD(ruleresult, c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne);
	...
	public static final Iterable<Object[]> pattern_OperationInClass_2_2_corematch_blackFFFBBFB(
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne, match });
						}
	...
	public static final Iterable<Object[]> pattern_OperationInClass_2_3_findcontext_blackBBBBBB(ASTNode2Element c2c,
			Operation feature, org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration,
			ClassDeclaration classDec, ASTNode2Element bd2ne) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
					...
					if (classDec.getBodyDeclarations().contains(bodyDeclaration)) {
						if (bodyDeclaration.equals(bd2ne.getSource())) {
							if (umlClass.equals(c2c.getTarget())) {
								_result.add(new Object[] { c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element c2c,
		...
		return new Object[] { c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne, isApplicableMatch,
				c2c__classDec____source, bd2ne__feature____target, classDec__bodyDeclaration____bodyDeclarations,
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, ASTNode2Element c2c, Operation feature,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
			ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, c2c, feature, umlClass,
				bodyDeclaration, classDec, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2c, feature, umlClass, bodyDeclaration, classDec,
					bd2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInClass _this,
		...
		Object[] result_pattern_OperationInClass_2_4_solveCSP_binding = pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne);
	...
	public static final Object[] pattern_OperationInClass_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_11_1_performtransformation_binding != null) {
			...
			org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) result_pattern_OperationInClass_11_1_performtransformation_binding[2];
			MAbstractMethodDefinition bodyDeclaration = (MAbstractMethodDefinition) result_pattern_OperationInClass_11_1_performtransformation_binding[3];
			ClassDeclaration classDec = (ClassDeclaration) result_pattern_OperationInClass_11_1_performtransformation_binding[4];
			ASTNode2Element bd2ne = (ASTNode2Element) result_pattern_OperationInClass_11_1_performtransformation_binding[5];
	...
	public static final void pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject c2c, EObject feature, EObject umlClass, EObject bodyDeclaration,
			EObject classDec, EObject bd2ne) {
		_this.registerObjects_BWD(ruleresult, c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne);
	...
	public static final Iterable<Object[]> pattern_OperationInClass_12_2_corematch_blackFBBFFFB(Operation feature,
	...
	public static final Object[] pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element c2c,
		...
		return new Object[] { c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne, isApplicableMatch,
				...
				bd2ne__feature____target, bd2ne__bodyDeclaration____source, c2c__umlClass____target };
	}
	...
	public static final Object[] pattern_OperationInClass_12_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			...
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
			ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, c2c, feature, umlClass,
				bodyDeclaration, classDec, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2c, feature, umlClass, bodyDeclaration, classDec,
	...
	public static final Object[] pattern_OperationInClass_24_2_matchsrctrgcontext_blackBBBBBB(Operation feature,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
	...
	public static final Object[] pattern_OperationInClass_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_OperationInClass_24_2_matchsrctrgcontext_binding != null) {
			Operation feature = (Operation) result_pattern_OperationInClass_24_2_matchsrctrgcontext_binding[0];
			org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) result_pattern_OperationInClass_24_2_matchsrctrgcontext_binding[1];
	...
	public static final Object[] pattern_OperationInClass_24_6_createcorrespondence_blackBBBBB(Operation feature,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
			CCMatch ccMatch) {
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(OperationInClass _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, c2c, feature, umlClass,
				bodyDeclaration, classDec, bd2ne, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2c, feature, umlClass, bodyDeclaration, classDec,
					bd2ne, ruleResult };
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			OperationInClass _this, IsApplicableMatch isApplicableMatch, ASTNode2Element c2c, Operation feature,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
			ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_OperationInClass_29_3_solveCSP_binding = pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne, ruleResult);
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_blackBBBBBBB(ASTNode2Element c2c,
			Operation feature, org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration,
			ClassDeclaration classDec, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { c2c, feature, umlClass, bodyDeclaration, classDec, bd2ne, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_OperationInClass_29_6_perform_greenBBBBB(Operation feature,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration, ClassDeclaration classDec,
