...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bd2ne] = " + bd2ne + ", " + "[c2c] = " + c2c + ", " + "[bodyDeclaration] = "
		...
		OperationInClassImpl.pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, bd2ne,
				c2c, bodyDeclaration, umlClass, classDec, feature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(
					bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(bd2ne, c2c, bodyDeclaration,
								umlClass, classDec, feature);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[c2c] = " + c2c + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
							+ "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec + ", " + "[feature] = "
							+ feature + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne,
			ASTNode2Element c2c, MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass,
			ClassDeclaration classDec, Operation feature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bd2ne, EObject c2c, EObject bodyDeclaration,
			EObject umlClass, EObject classDec, EObject feature) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(bd2ne, c2c, bodyDeclaration,
								umlClass, classDec, feature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge bd2ne__bodyDeclaration____source = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject bd2ne, EObject c2c, EObject bodyDeclaration,
			EObject umlClass, EObject classDec, EObject feature) {
		ruleresult.registerObject("bd2ne", bd2ne);
		ruleresult.registerObject("c2c", c2c);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = OperationInClassImpl
				.pattern_OperationInClass_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, bodyDeclaration, umlClass,
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackFFBBBBBB(bodyDeclaration, umlClass, classDec,
				...
				Object[] result6_black = OperationInClassImpl
						.pattern_OperationInClass_24_6_createcorrespondence_blackBBBBB(bodyDeclaration, umlClass,
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			Object[] result3_bindingAndBlack = OperationInClassImpl
					.pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, bd2ne,
							c2c, bodyDeclaration, umlClass, classDec, feature, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[bd2ne] = " + bd2ne + ", " + "[c2c] = "
						+ c2c + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[umlClass] = " + umlClass
						+ ", " + "[classDec] = " + classDec + ", " + "[feature] = " + feature + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInClassImpl.pattern_OperationInClass_29_6_perform_blackBBBBBBB(
							bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature, ruleResult);
					if (result6_black == null) {
					...
					OperationInClassImpl.pattern_OperationInClass_29_6_perform_greenBBBBB(bodyDeclaration, umlClass,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne,
			ASTNode2Element c2c, MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass,
			ClassDeclaration classDec, Operation feature, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_CLASS_CLASSDECLARATION_OPERATION:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_CLASS_CLASSDECLARATION_OPERATION:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_128__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_128((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_138__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__MABSTRACTMETHODDEFINITION_CLASS_CLASSDECLARATION_OPERATION_MATCH_MATCH:
		...
		case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_CLASS_CLASSDECLARATION_OPERATION_MODELGENERATORRULERESULT:
					...
					if (tmpUmlClass instanceof org.eclipse.uml2.uml.Class) {
						...
						if (tmpClassDec instanceof ClassDeclaration) {
							...
							if (tmpFeature instanceof Operation) {
								...
								return new Object[] { bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element bd2ne, ASTNode2Element c2c, MAbstractMethodDefinition bodyDeclaration,
			org.eclipse.uml2.uml.Class umlClass, ClassDeclaration classDec, Operation feature, OperationInClass _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_1_1_performtransformation_binding != null) {
			...
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInClass_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_OperationInClass_1_1_performtransformation_black = pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
					bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject bd2ne, EObject c2c, EObject bodyDeclaration, EObject umlClass,
														...
														if (!classDec.equals(umlClass)) {
															if (!classDec.equals(feature)) {
																if (!feature.equals(umlClass)) {
																	return new Object[] { ruleresult, bd2ne, c2c,
																			bodyDeclaration, umlClass, classDec,
																			feature };
																}
															}
														}
	...
	public static final void pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject bd2ne, EObject c2c, EObject bodyDeclaration, EObject umlClass,
			EObject classDec, EObject feature) {
		_this.registerObjects_FWD(ruleresult, bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature);
				...
				for (ASTNode2Element c2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpUmlClass instanceof org.eclipse.uml2.uml.Class) {
							org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) tmpUmlClass;
							_result.add(
									new Object[] { bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature, match });
						}
	...
	public static final Iterable<Object[]> pattern_OperationInClass_2_3_findcontext_blackBBBBBB(ASTNode2Element bd2ne,
			ASTNode2Element c2c, MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass,
			ClassDeclaration classDec, Operation feature) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
					...
					if (classDec.equals(c2c.getSource())) {
						if (classDec.getBodyDeclarations().contains(bodyDeclaration)) {
							if (feature.equals(bd2ne.getTarget())) {
								_result.add(new Object[] { bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element bd2ne,
		...
		return new Object[] { bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature, isApplicableMatch,
				bd2ne__bodyDeclaration____source, c2c__umlClass____target, c2c__classDec____source,
				classDec__bodyDeclaration____bodyDeclarations, bodyDeclaration__classDec____abstractTypeDeclaration,
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne, ASTNode2Element c2c,
			MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass, ClassDeclaration classDec,
			Operation feature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, bd2ne, c2c, bodyDeclaration, umlClass,
				classDec, feature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bd2ne, c2c, bodyDeclaration, umlClass, classDec,
					feature };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInClass _this,
		...
		Object[] result_pattern_OperationInClass_2_4_solveCSP_binding = pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature);
	...
	public static final Object[] pattern_OperationInClass_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_11_1_performtransformation_binding != null) {
			...
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInClass_11_1_performtransformation_binding[1];
	...
	public static final void pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject bd2ne, EObject c2c, EObject bodyDeclaration, EObject umlClass,
			EObject classDec, EObject feature) {
		_this.registerObjects_BWD(ruleresult, bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature);
	...
	public static final Object[] pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element bd2ne,
		...
		bd2ne__feature____target.setName(bd2ne__feature____target_name_prime);
		return new Object[] { bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature, isApplicableMatch,
				bd2ne__bodyDeclaration____source, umlClass__feature____ownedOperation, feature__umlClass____class,
	...
	public static final Object[] pattern_OperationInClass_12_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			...
			MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass, ClassDeclaration classDec,
			Operation feature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, bd2ne, c2c, bodyDeclaration, umlClass,
				classDec, feature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bd2ne, c2c, bodyDeclaration, umlClass, classDec,
	...
	public static final Iterable<Object[]> pattern_OperationInClass_24_5_matchcorrcontext_blackFFBBBBBB(
			MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass, ClassDeclaration classDec,
			Operation feature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInClass_24_5_matchcorrcontext_greenBBBBF(ASTNode2Element bd2ne,
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(OperationInClass _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, bd2ne, c2c, bodyDeclaration,
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			OperationInClass _this, IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne, ASTNode2Element c2c,
			MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass, ClassDeclaration classDec,
			Operation feature, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_OperationInClass_29_3_solveCSP_binding = pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature, ruleResult);
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_blackBBBBBBB(ASTNode2Element bd2ne,
			ASTNode2Element c2c, MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass,
			ClassDeclaration classDec, Operation feature, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { bd2ne, c2c, bodyDeclaration, umlClass, classDec, feature, ruleResult };
		}
		return null;
	}
