...
public class OperationInClassImpl extends AbstractRuleImpl implements OperationInClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInClassImpl.pattern_OperationInClass_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec);
		...
		OperationInClassImpl.pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, umlClass,
				bd2ne, feature, c2c, bodyDeclaration, classDec);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_2_3_findcontext_blackBBBBBB(
					umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(umlClass, bd2ne, feature, c2c,
								bodyDeclaration, classDec);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject umlClass, EObject bd2ne, EObject feature,
			EObject c2c, EObject bodyDeclaration, EObject classDec) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInClassImpl
				.pattern_OperationInClass_12_2_corematch_blackBFBFFFB(umlClass, feature, match)) {
			ASTNode2Element bd2ne = (ASTNode2Element) result2_black[1];
			ASTNode2Element c2c = (ASTNode2Element) result2_black[3];
			...
			for (Object[] result3_black : OperationInClassImpl.pattern_OperationInClass_12_3_findcontext_blackBBBBBB(
					umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec)) {
				Object[] result3_green = OperationInClassImpl
						.pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(umlClass, bd2ne, feature, c2c,
								bodyDeclaration, classDec);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge bd2ne__feature____target = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_706(EMoflonEdge _edge_ownedOperation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_761(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInClassImpl.pattern_OperationInClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInClassImpl
					.pattern_OperationInClass_24_5_matchcorrcontext_blackBFBFBBBB(umlClass, feature, bodyDeclaration,
		...
		for (Object[] result2_black : OperationInClassImpl
			...
			Object[] result3_bindingAndBlack = OperationInClassImpl
					.pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, umlClass,
							bd2ne, feature, c2c, bodyDeclaration, classDec, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[umlClass] = " + umlClass + ", "
						+ "[bd2ne] = " + bd2ne + ", " + "[feature] = " + feature + ", " + "[c2c] = " + c2c + ", "
			...
			if (OperationInClassImpl.pattern_OperationInClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInClassImpl.pattern_OperationInClass_29_6_perform_blackBBBBBBB(
							umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec, ruleResult);
					if (result6_black == null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASS_ASTNODE2ELEMENT_OPERATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_CLASSDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					...
					(MAbstractMethodDefinition) arguments.get(5), (ClassDeclaration) arguments.get(6));
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_ASTNODE2ELEMENT_OPERATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_CLASSDECLARATION:
		...
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_706__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_706((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_761__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_ASTNODE2ELEMENT_OPERATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_CLASSDECLARATION_MODELGENERATORRULERESULT:
					...
					if (tmpC2c instanceof ASTNode2Element) {
						...
						if (tmpBodyDeclaration instanceof MAbstractMethodDefinition) {
							...
							if (tmpClassDec instanceof ClassDeclaration) {
								...
								return new Object[] { umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
			org.eclipse.uml2.uml.Class umlClass, ASTNode2Element bd2ne, Operation feature, ASTNode2Element c2c,
		...
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInClass_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_1_1_performtransformation_binding != null) {
			...
			ASTNode2Element bd2ne = (ASTNode2Element) result_pattern_OperationInClass_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_OperationInClass_1_1_performtransformation_black = pattern_OperationInClass_1_1_performtransformation_blackBBBBBBFBB(
					umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec, _this, isApplicableMatch);
															...
															if (!classDec.equals(umlClass)) {
																if (!classDec.equals(feature)) {
																	return new Object[] { ruleresult, umlClass, bd2ne,
																			feature, c2c, bodyDeclaration, classDec };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInClass_1_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject umlClass, EObject bd2ne, EObject feature, EObject c2c,
			EObject bodyDeclaration, EObject classDec) {
		_this.registerObjects_FWD(ruleresult, umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec);
				...
				for (ASTNode2Element c2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpUmlClass instanceof org.eclipse.uml2.uml.Class) {
							org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) tmpUmlClass;
							_result.add(
									new Object[] { umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec, match });
						}
					...
					if (bodyDeclaration.equals(bd2ne.getSource())) {
						if (classDec.getBodyDeclarations().contains(bodyDeclaration)) {
							if (classDec.equals(c2c.getSource())) {
								_result.add(new Object[] { umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInClass_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec, isApplicableMatch,
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(OperationInClass _this,
			IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class umlClass, ASTNode2Element bd2ne,
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlClass, bd2ne, feature, c2c, bodyDeclaration,
					classDec };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInClass_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInClass _this,
		...
		Object[] result_pattern_OperationInClass_2_4_solveCSP_binding = pattern_OperationInClass_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec);
	...
	public static final Object[] pattern_OperationInClass_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInClass_11_1_performtransformation_binding != null) {
			...
			ASTNode2Element bd2ne = (ASTNode2Element) result_pattern_OperationInClass_11_1_performtransformation_binding[1];
	...
	public static final void pattern_OperationInClass_11_5_registerobjects_expressionBBBBBBBB(OperationInClass _this,
			PerformRuleResult ruleresult, EObject umlClass, EObject bd2ne, EObject feature, EObject c2c,
			EObject bodyDeclaration, EObject classDec) {
		_this.registerObjects_BWD(ruleresult, umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec);
	...
	public static final Iterable<Object[]> pattern_OperationInClass_12_2_corematch_blackBFBFFFB(
	...
	public static final Object[] pattern_OperationInClass_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		c2c__classDec____source.setName(c2c__classDec____source_name_prime);
		return new Object[] { umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec, isApplicableMatch,
				bd2ne__feature____target, umlClass__feature____ownedOperation, feature__umlClass____class,
	...
	public static final Iterable<Object[]> pattern_OperationInClass_24_5_matchcorrcontext_blackBFBFBBBB(
			org.eclipse.uml2.uml.Class umlClass, Operation feature, MAbstractMethodDefinition bodyDeclaration,
			ClassDeclaration classDec, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInClass_29_3_solveCSP_binding = pattern_OperationInClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec, ruleResult);
	...
	public static final Object[] pattern_OperationInClass_29_6_perform_blackBBBBBBB(org.eclipse.uml2.uml.Class umlClass,
			...
			ClassDeclaration classDec, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { umlClass, bd2ne, feature, c2c, bodyDeclaration, classDec, ruleResult };
		}
		return null;
	}
