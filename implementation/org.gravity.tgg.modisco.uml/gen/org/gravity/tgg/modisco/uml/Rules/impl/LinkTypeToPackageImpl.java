...
public class LinkTypeToPackageImpl extends AbstractRuleImpl implements LinkTypeToPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mPackage, uPackage, p2p, t2t, mType, uType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mPackage] = " + mPackage + ", " + "[uPackage] = " + uPackage + ", " + "[p2p] = " + p2p
					+ ", " + "[t2t] = " + t2t + ", " + "[mType] = " + mType + ", " + "[uType] = " + uType + ".");
		}
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_greenBBBBBFFF(ruleresult, mPackage,
				uPackage, mType, uType);
		...
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mPackage, uPackage, p2p, t2t, mType, uType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
				.pattern_LinkTypeToPackage_2_2_corematch_blackBFFFBFB(mPackage, mType, match)) {
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(mPackage, uPackage, p2p, t2t,
								mType, uType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.modisco.java.Package mPackage,
			...
			AbstractTypeDeclaration mType, Classifier uType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPackage, EObject uPackage, EObject p2p,
			EObject t2t, EObject mType, EObject uType) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
				.pattern_LinkTypeToPackage_12_2_corematch_blackFBFFFBB(uPackage, uType, match)) {
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_12_3_findcontext_blackBBBBBB(
					mPackage, uPackage, p2p, t2t, mType, uType)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(mPackage, uPackage, p2p, t2t,
								mType, uType);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge p2p__mPackage____source = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge p2p__uPackage____target = (EMoflonEdge) result3_green[8];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mPackage, EObject uPackage, EObject p2p,
			EObject t2t, EObject mType, EObject uType) {
		ruleresult.registerObject("mPackage", mPackage);
		ruleresult.registerObject("uPackage", uPackage);
		ruleresult.registerObject("p2p", p2p);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
				.pattern_LinkTypeToPackage_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mPackage, uPackage, mType, uType,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mPackage] = " + mPackage + ", " + "[uPackage] = " + uPackage + ", " + "[mType] = " + mType
		...
		if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackBBFFBBBB(mPackage, uPackage, mType, uType,
							sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_24_6_createcorrespondence_blackBBBBB(mPackage, uPackage, mType,
								uType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPackage] = " + mPackage
							+ ", " + "[uPackage] = " + uPackage + ", " + "[mType] = " + mType + ", " + "[uType] = "
	...
	public CSP isApplicable_solveCsp_CC(org.eclipse.modisco.java.Package mPackage,
			org.eclipse.uml2.uml.Package uPackage, AbstractTypeDeclaration mType, Classifier uType, Match sourceMatch,
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mPackage, uPackage, p2p, t2t, mType, uType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mPackage] = " + mPackage + ", "
						+ "[uPackage] = " + uPackage + ", " + "[p2p] = " + p2p + ", " + "[t2t] = " + t2t + ", "
						+ "[mType] = " + mType + ", " + "[uType] = " + uType + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPackage] = "
								+ mPackage + ", " + "[uPackage] = " + uPackage + ", " + "[p2p] = " + p2p + ", "
								+ "[t2t] = " + t2t + ", " + "[mType] = " + mType + ", " + "[uType] = " + uType + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_6_perform_greenBBBBB(mPackage, uPackage, mType,
							uType, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			...
			JavaPackage2UmlPackage p2p, ASTNode2Element t2t, AbstractTypeDeclaration mType, Classifier uType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PACKAGE_PACKAGE_JAVAPACKAGE2UMLPACKAGE_ASTNODE2ELEMENT_ABSTRACTTYPEDECLARATION_CLASSIFIER:
			...
			case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_PACKAGE_JAVAPACKAGE2UMLPACKAGE_ASTNODE2ELEMENT_ABSTRACTTYPEDECLARATION_CLASSIFIER:
			...
			case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_137__EMOFLONEDGE:
			...
			case RulesPackage.LINK_TYPE_TO_PACKAGE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_PACKAGE_JAVAPACKAGE2UMLPACKAGE_ASTNODE2ELEMENT_ABSTRACTTYPEDECLARATION_CLASSIFIER_MODELGENERATORRULERESULT:
					...
					if (tmpT2t instanceof ASTNode2Element) {
						...
						if (tmpMType instanceof AbstractTypeDeclaration) {
							...
							if (tmpUType instanceof Classifier) {
								...
								return new Object[] { mPackage, uPackage, p2p, t2t, mType, uType, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mPackage, uPackage, p2p, t2t, mType, uType, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkTypeToPackage_1_1_performtransformation_black = pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
					mPackage, uPackage, p2p, t2t, mType, uType, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mPackage, EObject uPackage, EObject p2p, EObject t2t, EObject mType,
			EObject uType) {
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_greenBBBBBFFF(
			PerformRuleResult ruleresult, EObject mPackage, EObject uPackage, EObject mType, EObject uType) {
		...
		mType__mPackage____package.setName(mType__mPackage____package_name_prime);
		mPackage__mType____ownedElements.setName(mPackage__mType____ownedElements_name_prime);
		return new Object[] { ruleresult, mPackage, uPackage, mType, uType, uPackage__uType____packagedElement,
	...
	public static final void pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject mPackage, EObject uPackage, EObject p2p, EObject t2t, EObject mType,
			EObject uType) {
		_this.registerObjects_FWD(ruleresult, mPackage, uPackage, p2p, t2t, mType, uType);
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_2_2_corematch_blackBFFFBFB(
		...
		for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mPackage,
			...
			if (uPackage != null) {
				for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
					...
					if (tmpUType instanceof Classifier) {
						Classifier uType = (Classifier) tmpUType;
						_result.add(new Object[] { mPackage, uPackage, p2p, t2t, mType, uType, match });
					}
				...
				if (mType.equals(t2t.getSource())) {
					if (mPackage.equals(mType.getPackage())) {
						if (uType.equals(t2t.getTarget())) {
							_result.add(new Object[] { mPackage, uPackage, p2p, t2t, mType, uType });
						}
					}
				}
			}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mPackage, uPackage, p2p, t2t, mType, uType, isApplicableMatch, p2p__mPackage____source,
				p2p__uPackage____target, t2t__mType____source, mType__mPackage____package,
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			org.eclipse.uml2.uml.Package uPackage, JavaPackage2UmlPackage p2p, ASTNode2Element t2t,
			AbstractTypeDeclaration mType, Classifier uType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mPackage, uPackage, p2p, t2t, mType,
				uType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPackage, uPackage, p2p, t2t, mType, uType };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_2_4_solveCSP_binding = pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mPackage, uPackage, p2p, t2t, mType, uType);
	...
	public static final void pattern_LinkTypeToPackage_11_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject mPackage, EObject uPackage, EObject p2p, EObject t2t, EObject mType,
			EObject uType) {
		_this.registerObjects_BWD(ruleresult, mPackage, uPackage, p2p, t2t, mType, uType);
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_12_2_corematch_blackFBFFFBB(
	...
	public static final Object[] pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		t2t__uType____target.setName(t2t__uType____target_name_prime);
		return new Object[] { mPackage, uPackage, p2p, t2t, mType, uType, isApplicableMatch, p2p__mPackage____source,
				p2p__uPackage____target, uPackage__uType____packagedElement, t2t__mType____source,
	...
	public static final Object[] pattern_LinkTypeToPackage_12_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			org.eclipse.uml2.uml.Package uPackage, JavaPackage2UmlPackage p2p, ASTNode2Element t2t,
			AbstractTypeDeclaration mType, Classifier uType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mPackage, uPackage, p2p, t2t, mType,
				uType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPackage, uPackage, p2p, t2t, mType, uType };
		...
		if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
			...
			if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
				...
				if (tmpMType instanceof AbstractTypeDeclaration) {
					...
					if (tmpUType instanceof Classifier) {
						Classifier uType = (Classifier) tmpUType;
						return new Object[] { mPackage, uPackage, mType, uType, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_LinkTypeToPackage_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkTypeToPackage_24_2_matchsrctrgcontext_black = pattern_LinkTypeToPackage_24_2_matchsrctrgcontext_blackBBBBBB(
					mPackage, uPackage, mType, uType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_24_3_solvecsp_bindingFBBBBBBB(LinkTypeToPackage _this,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage,
			AbstractTypeDeclaration mType, Classifier uType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mPackage, uPackage, mType, uType, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mPackage, uPackage, mType, uType, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_24_3_solvecsp_binding = pattern_LinkTypeToPackage_24_3_solvecsp_bindingFBBBBBBB(
				_this, mPackage, uPackage, mType, uType, sourceMatch, targetMatch);
			...
			for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (uPackage.equals(p2p.getTarget())) {
					for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
							ASTNode2Element.class, "source")) {
						if (uType.equals(t2t.getTarget())) {
							_result.add(new Object[] { mPackage, uPackage, p2p, t2t, mType, uType, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { mPackage, uPackage, mType, uType, ccMatch };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(LinkTypeToPackage _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mPackage, uPackage, p2p, t2t, mType,
				uType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPackage, uPackage, p2p, t2t, mType, uType,
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_29_3_solveCSP_binding = pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mPackage, uPackage, p2p, t2t, mType, uType, ruleResult);
	...
	public static final Object[] pattern_LinkTypeToPackage_29_5_checknacs_blackBBBBBB(
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage,
			JavaPackage2UmlPackage p2p, ASTNode2Element t2t, AbstractTypeDeclaration mType, Classifier uType) {
		return new Object[] { mPackage, uPackage, p2p, t2t, mType, uType };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(
		...
		return new Object[] { mPackage, uPackage, p2p, t2t, mType, uType, ruleResult };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_greenBBBBB(
		...
		return new Object[] { mPackage, uPackage, mType, uType, ruleResult };
	}
