...
public class LinkTypeToPackageImpl extends AbstractRuleImpl implements LinkTypeToPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, uPackage, mType, t2t, mPackage, uType, p2p);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uPackage] = " + uPackage + ", " + "[mType] = " + mType + ", " + "[t2t] = " + t2t + ", "
					+ "[mPackage] = " + mPackage + ", " + "[uType] = " + uType + ", " + "[p2p] = " + p2p + ".");
		}
		...
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				uPackage, mType, t2t, mPackage, uType, p2p);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_2_corematch_blackFBFBFFB(mType,
				mPackage, match)) {
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(uPackage, mType, t2t, mPackage,
								uType, p2p);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[mType] = " + mType + ", " + "[t2t] = " + t2t + ", " + "[mPackage] = " + mPackage + ", "
							+ "[uType] = " + uType + ", " + "[p2p] = " + p2p + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Package uPackage,
			AbstractTypeDeclaration mType, ASTNode2Element t2t, org.eclipse.modisco.java.Package mPackage,
			Classifier uType, JavaPackage2UmlPackage p2p) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject uPackage, EObject mType, EObject t2t,
			EObject mPackage, EObject uType, EObject p2p) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
				.pattern_LinkTypeToPackage_12_2_corematch_blackBFFFBFB(uPackage, uType, match)) {
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_12_3_findcontext_blackBBBBBB(
					uPackage, mType, t2t, mPackage, uType, p2p)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(uPackage, mType, t2t, mPackage,
								uType, p2p);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject uPackage, EObject mType, EObject t2t,
			EObject mPackage, EObject uType, EObject p2p) {
		ruleresult.registerObject("uPackage", uPackage);
		ruleresult.registerObject("mType", mType);
		ruleresult.registerObject("t2t", t2t);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_291(EMoflonEdge _edge_package) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackBBFBBFBB(uPackage, mType, mPackage, uType,
							sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							uPackage, mType, t2t, mPackage, uType, p2p, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uPackage] = " + uPackage + ", "
						+ "[mType] = " + mType + ", " + "[t2t] = " + t2t + ", " + "[mPackage] = " + mPackage + ", "
						+ "[uType] = " + uType + ", " + "[p2p] = " + p2p + ", " + "[ruleResult] = " + ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Package uPackage,
			AbstractTypeDeclaration mType, ASTNode2Element t2t, org.eclipse.modisco.java.Package mPackage,
			Classifier uType, JavaPackage2UmlPackage p2p, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PACKAGE_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_PACKAGE_CLASSIFIER_JAVAPACKAGE2UMLPACKAGE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(org.eclipse.uml2.uml.Package) arguments.get(1), (AbstractTypeDeclaration) arguments.get(2),
					(ASTNode2Element) arguments.get(3), (org.eclipse.modisco.java.Package) arguments.get(4),
					(Classifier) arguments.get(5), (JavaPackage2UmlPackage) arguments.get(6));
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_PACKAGE_CLASSIFIER_JAVAPACKAGE2UMLPACKAGE:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_272__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_272((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_291__EMOFLONEDGE:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_PACKAGE_CLASSIFIER_JAVAPACKAGE2UMLPACKAGE_MODELGENERATORRULERESULT:
					...
					if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
						...
						if (tmpUType instanceof Classifier) {
							...
							if (tmpP2p instanceof JavaPackage2UmlPackage) {
								...
								return new Object[] { uPackage, mType, t2t, mPackage, uType, p2p, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
			org.eclipse.uml2.uml.Package uPackage, AbstractTypeDeclaration mType, ASTNode2Element t2t,
			org.eclipse.modisco.java.Package mPackage, Classifier uType, JavaPackage2UmlPackage p2p,
			LinkTypeToPackage _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { uPackage, mType, t2t, mPackage, uType, p2p, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_1_1_performtransformation_binding != null) {
			...
			AbstractTypeDeclaration mType = (AbstractTypeDeclaration) result_pattern_LinkTypeToPackage_1_1_performtransformation_binding[1];
			...
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result_pattern_LinkTypeToPackage_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_LinkTypeToPackage_1_1_performtransformation_black = pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
					uPackage, mType, t2t, mPackage, uType, p2p, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject uPackage, EObject mType, EObject t2t, EObject mPackage, EObject uType,
			EObject p2p) {
												...
												if (!mPackage.equals(uType)) {
													if (!mPackage.equals(p2p)) {
														if (!p2p.equals(uPackage)) {
															if (!p2p.equals(t2t)) {
																if (!p2p.equals(uType)) {
																	return new Object[] { ruleresult, uPackage, mType,
																			t2t, mPackage, uType, p2p };
																}
															}
														}
													}
	...
	public static final void pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject uPackage, EObject mType, EObject t2t, EObject mPackage, EObject uType,
			EObject p2p) {
		_this.registerObjects_FWD(ruleresult, uPackage, mType, t2t, mPackage, uType, p2p);
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_2_2_corematch_blackFBFBFFB(
		...
		for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
			...
			if (tmpUType instanceof Classifier) {
				...
				for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (uPackage != null) {
						_result.add(new Object[] { uPackage, mType, t2t, mPackage, uType, p2p, match });
					}
				...
				if (uType.equals(t2t.getTarget())) {
					if (mPackage.equals(p2p.getSource())) {
						if (uPackage.equals(p2p.getTarget())) {
							_result.add(new Object[] { uPackage, mType, t2t, mPackage, uType, p2p });
						}
					}
				}
			}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { uPackage, mType, t2t, mPackage, uType, p2p, isApplicableMatch, mType__mPackage____package,
				mPackage__mType____ownedElements, t2t__mType____source, t2t__uType____target, p2p__mPackage____source,
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Package uPackage, AbstractTypeDeclaration mType,
			ASTNode2Element t2t, org.eclipse.modisco.java.Package mPackage, Classifier uType,
			JavaPackage2UmlPackage p2p) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, uPackage, mType, t2t, mPackage, uType,
				p2p);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uPackage, mType, t2t, mPackage, uType, p2p };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_11_1_performtransformation_binding != null) {
			...
			AbstractTypeDeclaration mType = (AbstractTypeDeclaration) result_pattern_LinkTypeToPackage_11_1_performtransformation_binding[1];
			...
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result_pattern_LinkTypeToPackage_11_1_performtransformation_binding[5];
	...
	public static final void pattern_LinkTypeToPackage_11_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject uPackage, EObject mType, EObject t2t, EObject mPackage, EObject uType,
			EObject p2p) {
		_this.registerObjects_BWD(ruleresult, uPackage, mType, t2t, mPackage, uType, p2p);
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_12_2_corematch_blackBFFFBFB(
	...
	public static final Object[] pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		p2p__mPackage____source.setName(p2p__mPackage____source_name_prime);
		p2p__uPackage____target.setName(p2p__uPackage____target_name_prime);
		return new Object[] { uPackage, mType, t2t, mPackage, uType, p2p, isApplicableMatch, t2t__mType____source,
				uPackage__uType____packagedElement, t2t__uType____target, p2p__mPackage____source,
				p2p__uPackage____target };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_12_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			ASTNode2Element t2t, org.eclipse.modisco.java.Package mPackage, Classifier uType,
			JavaPackage2UmlPackage p2p) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, uPackage, mType, t2t, mPackage, uType,
				p2p);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uPackage, mType, t2t, mPackage, uType, p2p };
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackBBFBBFBB(
			org.eclipse.uml2.uml.Package uPackage, AbstractTypeDeclaration mType,
			org.eclipse.modisco.java.Package mPackage, Classifier uType, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
				...
				if (uType.equals(t2t.getTarget())) {
					for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mPackage, JavaPackage2UmlPackage.class, "source")) {
						if (uPackage.equals(p2p.getTarget())) {
							_result.add(new Object[] { uPackage, mType, t2t, mPackage, uType, p2p, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(LinkTypeToPackage _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, uPackage, mType, t2t, mPackage,
				uType, p2p, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uPackage, mType, t2t, mPackage, uType, p2p,
					ruleResult };
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			LinkTypeToPackage _this, IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Package uPackage,
			AbstractTypeDeclaration mType, ASTNode2Element t2t, org.eclipse.modisco.java.Package mPackage,
			Classifier uType, JavaPackage2UmlPackage p2p, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_LinkTypeToPackage_29_3_solveCSP_binding = pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, uPackage, mType, t2t, mPackage, uType, p2p, ruleResult);
	...
	public static final Object[] pattern_LinkTypeToPackage_29_5_checknacs_blackBBBBBB(
			org.eclipse.uml2.uml.Package uPackage, AbstractTypeDeclaration mType, ASTNode2Element t2t,
			org.eclipse.modisco.java.Package mPackage, Classifier uType, JavaPackage2UmlPackage p2p) {
		return new Object[] { uPackage, mType, t2t, mPackage, uType, p2p };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(
		...
		return new Object[] { uPackage, mType, t2t, mPackage, uType, p2p, ruleResult };
	}
