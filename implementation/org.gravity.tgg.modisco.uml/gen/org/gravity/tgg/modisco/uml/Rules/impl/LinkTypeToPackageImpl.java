...
public class LinkTypeToPackageImpl extends AbstractRuleImpl implements LinkTypeToPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, t2t, uPackage, mPackage, mType, uType, p2p);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[t2t] = " + t2t + ", " + "[uPackage] = " + uPackage + ", " + "[mPackage] = " + mPackage
					+ ", " + "[mType] = " + mType + ", " + "[uType] = " + uType + ", " + "[p2p] = " + p2p + ".");
		}
		...
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, t2t,
				uPackage, mPackage, mType, uType, p2p);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_3_findcontext_blackBBBBBB(
					t2t, uPackage, mPackage, mType, uType, p2p)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(t2t, uPackage, mPackage, mType,
								uType, p2p);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element t2t,
			...
			AbstractTypeDeclaration mType, Classifier uType, JavaPackage2UmlPackage p2p) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject mPackage,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_12_3_findcontext_blackBBBBBB(
					t2t, uPackage, mPackage, mType, uType, p2p)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(t2t, uPackage, mPackage, mType,
								uType, p2p);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject mPackage,
			EObject mType, EObject uType, EObject p2p) {
		ruleresult.registerObject("t2t", t2t);
		ruleresult.registerObject("uPackage", uPackage);
		ruleresult.registerObject("mPackage", mPackage);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_29(EMoflonEdge _edge_packagedElement) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, t2t,
							uPackage, mPackage, mType, uType, p2p, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[t2t] = " + t2t + ", "
						+ "[uPackage] = " + uPackage + ", " + "[mPackage] = " + mPackage + ", " + "[mType] = " + mType
			...
			if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(
							t2t, uPackage, mPackage, mType, uType, p2p, ruleResult);
					if (result6_black == null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_PACKAGE_PACKAGE_ABSTRACTTYPEDECLARATION_CLASSIFIER_JAVAPACKAGE2UMLPACKAGE:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_PACKAGE_PACKAGE_ABSTRACTTYPEDECLARATION_CLASSIFIER_JAVAPACKAGE2UMLPACKAGE:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_29__EMOFLONEDGE:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_PACKAGE_PACKAGE_ABSTRACTTYPEDECLARATION_CLASSIFIER_JAVAPACKAGE2UMLPACKAGE_MODELGENERATORRULERESULT:
					...
					if (tmpMType instanceof AbstractTypeDeclaration) {
						...
						if (tmpUType instanceof Classifier) {
							...
							if (tmpP2p instanceof JavaPackage2UmlPackage) {
								...
								return new Object[] { t2t, uPackage, mPackage, mType, uType, p2p, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(ASTNode2Element t2t,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage,
			AbstractTypeDeclaration mType, Classifier uType, JavaPackage2UmlPackage p2p, LinkTypeToPackage _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { t2t, uPackage, mPackage, mType, uType, p2p, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkTypeToPackage_1_1_performtransformation_black = pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
					t2t, uPackage, mPackage, mType, uType, p2p, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject mPackage, EObject mType, EObject uType,
			EObject p2p) {
	...
	public static final void pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject mPackage, EObject mType, EObject uType,
			EObject p2p) {
		_this.registerObjects_FWD(ruleresult, t2t, uPackage, mPackage, mType, uType, p2p);
		...
		for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
			...
			if (tmpUType instanceof Classifier) {
				...
				for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (uPackage != null) {
						_result.add(new Object[] { t2t, uPackage, mPackage, mType, uType, p2p, match });
					}
				...
				if (mPackage.equals(p2p.getSource())) {
					if (uPackage.equals(p2p.getTarget())) {
						if (uType.equals(t2t.getTarget())) {
							_result.add(new Object[] { t2t, uPackage, mPackage, mType, uType, p2p });
						}
					}
				}
			}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element t2t,
		...
		return new Object[] { t2t, uPackage, mPackage, mType, uType, p2p, isApplicableMatch, mType__mPackage____package,
				mPackage__mType____ownedElements, t2t__mType____source, p2p__mPackage____source,
				p2p__uPackage____target, t2t__uType____target };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, t2t, uPackage, mPackage, mType, uType,
				p2p);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t2t, uPackage, mPackage, mType, uType, p2p };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_2_4_solveCSP_binding = pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, t2t, uPackage, mPackage, mType, uType, p2p);
	...
	public static final Object[] pattern_LinkTypeToPackage_11_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element t2t, org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage,
			AbstractTypeDeclaration mType, Classifier uType, JavaPackage2UmlPackage p2p, LinkTypeToPackage _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
	...
	public static final void pattern_LinkTypeToPackage_11_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject mPackage, EObject mType, EObject uType,
			EObject p2p) {
		_this.registerObjects_BWD(ruleresult, t2t, uPackage, mPackage, mType, uType, p2p);
	...
	public static final Object[] pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(ASTNode2Element t2t,
		...
		t2t__uType____target.setName(t2t__uType____target_name_prime);
		return new Object[] { t2t, uPackage, mPackage, mType, uType, p2p, isApplicableMatch,
				uPackage__uType____packagedElement, t2t__mType____source, p2p__mPackage____source,
				p2p__uPackage____target, t2t__uType____target };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_12_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			org.eclipse.modisco.java.Package mPackage, AbstractTypeDeclaration mType, Classifier uType,
			JavaPackage2UmlPackage p2p) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, t2t, uPackage, mPackage, mType, uType,
				p2p);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t2t, uPackage, mPackage, mType, uType, p2p };
			...
			for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
				...
				if (uType.equals(t2t.getTarget())) {
					for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mPackage, JavaPackage2UmlPackage.class, "source")) {
						if (uPackage.equals(p2p.getTarget())) {
							_result.add(new Object[] { t2t, uPackage, mPackage, mType, uType, p2p, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(LinkTypeToPackage _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, t2t, uPackage, mPackage, mType,
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_29_3_solveCSP_binding = pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, t2t, uPackage, mPackage, mType, uType, p2p, ruleResult);
	...
	public static final Object[] pattern_LinkTypeToPackage_29_5_checknacs_blackBBBBBB(ASTNode2Element t2t,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage,
			AbstractTypeDeclaration mType, Classifier uType, JavaPackage2UmlPackage p2p) {
		return new Object[] { t2t, uPackage, mPackage, mType, uType, p2p };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(ASTNode2Element t2t,
			...
			AbstractTypeDeclaration mType, Classifier uType, JavaPackage2UmlPackage p2p,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { t2t, uPackage, mPackage, mType, uType, p2p, ruleResult };
	}
