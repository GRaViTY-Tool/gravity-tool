...
public class LinkTypeToPackageImpl extends AbstractRuleImpl implements LinkTypeToPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, p2p, mPackage, uPackage, uType, mType, t2t);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[p2p] = " + p2p + ", " + "[mPackage] = " + mPackage + ", " + "[uPackage] = " + uPackage
		...
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, p2p,
				mPackage, uPackage, uType, mType, t2t);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
				.pattern_LinkTypeToPackage_2_2_corematch_blackFBFFBFB(mPackage, mType, match)) {
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_3_findcontext_blackBBBBBB(
					p2p, mPackage, uPackage, uType, mType, t2t)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(p2p, mPackage, uPackage, uType,
								mType, t2t);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[mPackage] = " + mPackage + ", " + "[uPackage] = " + uPackage + ", " + "[uType] = "
							+ uType + ", " + "[mType] = " + mType + ", " + "[t2t] = " + t2t + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, JavaPackage2UmlPackage p2p,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage, Classifier uType,
			AbstractTypeDeclaration mType, ASTNode2Element t2t) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject p2p, EObject mPackage, EObject uPackage,
			EObject uType, EObject mType, EObject t2t) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
				.pattern_LinkTypeToPackage_12_2_corematch_blackFFBBFFB(uPackage, uType, match)) {
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result2_black[0];
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_12_3_findcontext_blackBBBBBB(
					p2p, mPackage, uPackage, uType, mType, t2t)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(p2p, mPackage, uPackage, uType,
								mType, t2t);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge p2p__mPackage____source = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge uPackage__uType____packagedElement = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge p2p__uPackage____target = (EMoflonEdge) result3_green[9];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject p2p, EObject mPackage, EObject uPackage,
			EObject uType, EObject mType, EObject t2t) {
		ruleresult.registerObject("p2p", p2p);
		ruleresult.registerObject("mPackage", mPackage);
		ruleresult.registerObject("uPackage", uPackage);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_681(EMoflonEdge _edge_packagedElement) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_730(EMoflonEdge _edge_package) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
				.pattern_LinkTypeToPackage_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mPackage, uPackage, uType, mType,
						sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mPackage] = " + mPackage + ", " + "[uPackage] = " + uPackage + ", " + "[uType] = " + uType
		...
		if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackFBBBBFBB(mPackage, uPackage, uType, mType,
							sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_24_6_createcorrespondence_blackBBBBB(mPackage, uPackage, uType,
								mType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPackage] = " + mPackage
							+ ", " + "[uPackage] = " + uPackage + ", " + "[uType] = " + uType + ", " + "[mType] = "
	...
	public CSP isApplicable_solveCsp_CC(org.eclipse.modisco.java.Package mPackage,
			org.eclipse.uml2.uml.Package uPackage, Classifier uType, AbstractTypeDeclaration mType, Match sourceMatch,
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, p2p,
							mPackage, uPackage, uType, mType, t2t, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[p2p] = " + p2p + ", "
						+ "[mPackage] = " + mPackage + ", " + "[uPackage] = " + uPackage + ", " + "[uType] = " + uType
						+ ", " + "[mType] = " + mType + ", " + "[t2t] = " + t2t + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(
							p2p, mPackage, uPackage, uType, mType, t2t, ruleResult);
					if (result6_black == null) {
					...
					LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_6_perform_greenBBBBB(mPackage, uPackage, uType,
							mType, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, JavaPackage2UmlPackage p2p,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage, Classifier uType,
			AbstractTypeDeclaration mType, ASTNode2Element t2t, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_JAVAPACKAGE2UMLPACKAGE_PACKAGE_PACKAGE_CLASSIFIER_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_JAVAPACKAGE2UMLPACKAGE_PACKAGE_PACKAGE_CLASSIFIER_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_681__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_681((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_730__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_730((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_JAVAPACKAGE2UMLPACKAGE_PACKAGE_PACKAGE_CLASSIFIER_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpUType instanceof Classifier) {
						...
						if (tmpMType instanceof AbstractTypeDeclaration) {
							...
							if (tmpT2t instanceof ASTNode2Element) {
								...
								return new Object[] { p2p, mPackage, uPackage, uType, mType, t2t, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
			...
			org.eclipse.uml2.uml.Package uPackage, Classifier uType, AbstractTypeDeclaration mType, ASTNode2Element t2t,
			LinkTypeToPackage _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { p2p, mPackage, uPackage, uType, mType, t2t, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_1_1_performtransformation_binding != null) {
			...
			org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) result_pattern_LinkTypeToPackage_1_1_performtransformation_binding[1];
			org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) result_pattern_LinkTypeToPackage_1_1_performtransformation_binding[2];
			Classifier uType = (Classifier) result_pattern_LinkTypeToPackage_1_1_performtransformation_binding[3];
			AbstractTypeDeclaration mType = (AbstractTypeDeclaration) result_pattern_LinkTypeToPackage_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_LinkTypeToPackage_1_1_performtransformation_black = pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
					p2p, mPackage, uPackage, uType, mType, t2t, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject p2p, EObject mPackage, EObject uPackage, EObject uType, EObject mType,
			EObject t2t) {
													...
													if (!mType.equals(uType)) {
														if (!mType.equals(t2t)) {
															if (!t2t.equals(uPackage)) {
																if (!t2t.equals(uType)) {
																	return new Object[] { ruleresult, p2p, mPackage,
																			uPackage, uType, mType, t2t };
																}
															}
														}
													}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_greenBBBBBFFF(
			PerformRuleResult ruleresult, EObject mPackage, EObject uPackage, EObject uType, EObject mType) {
		...
		mType__mPackage____package.setName(mType__mPackage____package_name_prime);
		mPackage__mType____ownedElements.setName(mPackage__mType____ownedElements_name_prime);
		return new Object[] { ruleresult, mPackage, uPackage, uType, mType, uPackage__uType____packagedElement,
	...
	public static final void pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject p2p, EObject mPackage, EObject uPackage, EObject uType, EObject mType,
			EObject t2t) {
		_this.registerObjects_FWD(ruleresult, p2p, mPackage, uPackage, uType, mType, t2t);
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_2_2_corematch_blackFBFFBFB(
		...
		for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mPackage,
			...
			if (uPackage != null) {
				for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
					...
					if (tmpUType instanceof Classifier) {
						Classifier uType = (Classifier) tmpUType;
						_result.add(new Object[] { p2p, mPackage, uPackage, uType, mType, t2t, match });
					}
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_2_3_findcontext_blackBBBBBB(
			JavaPackage2UmlPackage p2p, org.eclipse.modisco.java.Package mPackage,
			org.eclipse.uml2.uml.Package uPackage, Classifier uType, AbstractTypeDeclaration mType,
			ASTNode2Element t2t) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
				...
				if (uPackage.equals(p2p.getTarget())) {
					if (uType.equals(t2t.getTarget())) {
						if (mType.equals(t2t.getSource())) {
							_result.add(new Object[] { p2p, mPackage, uPackage, uType, mType, t2t });
						}
					}
				}
			}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { p2p, mPackage, uPackage, uType, mType, t2t, isApplicableMatch, p2p__mPackage____source,
				mType__mPackage____package, mPackage__mType____ownedElements, p2p__uPackage____target,
				t2t__uType____target, t2t__mType____source };
	}

	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			IsApplicableMatch isApplicableMatch, JavaPackage2UmlPackage p2p, org.eclipse.modisco.java.Package mPackage,
			org.eclipse.uml2.uml.Package uPackage, Classifier uType, AbstractTypeDeclaration mType,
			ASTNode2Element t2t) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, p2p, mPackage, uPackage, uType, mType,
				t2t);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, p2p, mPackage, uPackage, uType, mType, t2t };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_11_1_performtransformation_binding != null) {
			...
			org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) result_pattern_LinkTypeToPackage_11_1_performtransformation_binding[1];
			org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) result_pattern_LinkTypeToPackage_11_1_performtransformation_binding[2];
			Classifier uType = (Classifier) result_pattern_LinkTypeToPackage_11_1_performtransformation_binding[3];
			AbstractTypeDeclaration mType = (AbstractTypeDeclaration) result_pattern_LinkTypeToPackage_11_1_performtransformation_binding[4];
	...
	public static final void pattern_LinkTypeToPackage_11_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject p2p, EObject mPackage, EObject uPackage, EObject uType, EObject mType,
			EObject t2t) {
		_this.registerObjects_BWD(ruleresult, p2p, mPackage, uPackage, uType, mType, t2t);
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_12_2_corematch_blackFFBBFFB(
	...
	public static final Object[] pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		t2t__mType____source.setName(t2t__mType____source_name_prime);
		return new Object[] { p2p, mPackage, uPackage, uType, mType, t2t, isApplicableMatch, p2p__mPackage____source,
				uPackage__uType____packagedElement, p2p__uPackage____target, t2t__uType____target,
	...
	public static final Object[] pattern_LinkTypeToPackage_12_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			org.eclipse.uml2.uml.Package uPackage, Classifier uType, AbstractTypeDeclaration mType,
			ASTNode2Element t2t) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, p2p, mPackage, uPackage, uType, mType,
				t2t);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, p2p, mPackage, uPackage, uType, mType, t2t };
		...
		if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
			...
			if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
				...
				if (tmpUType instanceof Classifier) {
					...
					if (tmpMType instanceof AbstractTypeDeclaration) {
						AbstractTypeDeclaration mType = (AbstractTypeDeclaration) tmpMType;
						return new Object[] { mPackage, uPackage, uType, mType, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_LinkTypeToPackage_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_24_2_matchsrctrgcontext_binding != null) {
			...
			org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) result_pattern_LinkTypeToPackage_24_2_matchsrctrgcontext_binding[1];
			...
			Object[] result_pattern_LinkTypeToPackage_24_2_matchsrctrgcontext_black = pattern_LinkTypeToPackage_24_2_matchsrctrgcontext_blackBBBBBB(
					mPackage, uPackage, uType, mType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_24_3_solvecsp_bindingFBBBBBBB(LinkTypeToPackage _this,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage, Classifier uType,
			AbstractTypeDeclaration mType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mPackage, uPackage, uType, mType, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mPackage, uPackage, uType, mType, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			LinkTypeToPackage _this, org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage,
		...
		Object[] result_pattern_LinkTypeToPackage_24_3_solvecsp_binding = pattern_LinkTypeToPackage_24_3_solvecsp_bindingFBBBBBBB(
				_this, mPackage, uPackage, uType, mType, sourceMatch, targetMatch);
			...
			for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (uPackage.equals(p2p.getTarget())) {
					for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(uType,
							ASTNode2Element.class, "target")) {
						if (mType.equals(t2t.getSource())) {
							_result.add(new Object[] { p2p, mPackage, uPackage, uType, mType, t2t, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { mPackage, uPackage, uType, mType, ccMatch };
	}
																	...
																	if (pattern_LinkTypeToPackage_29_2_isapplicablecore_black_nac_3BB(
																		...
																		if (pattern_LinkTypeToPackage_29_2_isapplicablecore_black_nac_5BB(
																			...
																			_result.add(new Object[] { p2pList, p2p,
																					mPackage, uPackage, t2tList, uType,
																					t2t, mType, ruleEntryContainer,
																					ruleResult });
																		}
																	}
																}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(LinkTypeToPackage _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, p2p, mPackage, uPackage, uType,
				mType, t2t, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, p2p, mPackage, uPackage, uType, mType, t2t,
					ruleResult };
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			LinkTypeToPackage _this, IsApplicableMatch isApplicableMatch, JavaPackage2UmlPackage p2p,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage, Classifier uType,
			AbstractTypeDeclaration mType, ASTNode2Element t2t, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_LinkTypeToPackage_29_3_solveCSP_binding = pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, p2p, mPackage, uPackage, uType, mType, t2t, ruleResult);
	...
	public static final Object[] pattern_LinkTypeToPackage_29_5_checknacs_blackBBBBBB(JavaPackage2UmlPackage p2p,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage, Classifier uType,
			AbstractTypeDeclaration mType, ASTNode2Element t2t) {
		return new Object[] { p2p, mPackage, uPackage, uType, mType, t2t };
	}

	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(JavaPackage2UmlPackage p2p,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage, Classifier uType,
			AbstractTypeDeclaration mType, ASTNode2Element t2t, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { p2p, mPackage, uPackage, uType, mType, t2t, ruleResult };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_greenBBBBB(
		...
		return new Object[] { mPackage, uPackage, uType, mType, ruleResult };
	}
