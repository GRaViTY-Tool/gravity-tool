...
public class LinkTypeToPackageImpl extends AbstractRuleImpl implements LinkTypeToPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, t2t, uPackage, p2p, mType, uType, mPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[t2t] = " + t2t + ", " + "[uPackage] = " + uPackage + ", " + "[p2p] = " + p2p + ", "
					+ "[mType] = " + mType + ", " + "[uType] = " + uType + ", " + "[mPackage] = " + mPackage + ".");
		}
		...
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, t2t,
				uPackage, p2p, mType, uType, mPackage);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_2_corematch_blackFFFBFBB(mType,
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_3_findcontext_blackBBBBBB(
					t2t, uPackage, p2p, mType, uType, mPackage)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(t2t, uPackage, p2p, mType, uType,
								mPackage);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject p2p,
			EObject mType, EObject uType, EObject mPackage) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_12_3_findcontext_blackBBBBBB(
					t2t, uPackage, p2p, mType, uType, mPackage)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(t2t, uPackage, p2p, mType, uType,
								mPackage);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge p2p__uPackage____target = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject p2p,
			EObject mType, EObject uType, EObject mPackage) {
		ruleresult.registerObject("t2t", t2t);
		ruleresult.registerObject("uPackage", uPackage);
		ruleresult.registerObject("p2p", p2p);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_134(EMoflonEdge _edge_packagedElement) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_147(EMoflonEdge _edge_package) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackFBFBBBBB(uPackage, mType, uType, mPackage,
							sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, t2t,
							uPackage, p2p, mType, uType, mPackage, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[t2t] = " + t2t + ", "
						+ "[uPackage] = " + uPackage + ", " + "[p2p] = " + p2p + ", " + "[mType] = " + mType + ", "
			...
			if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(
							t2t, uPackage, p2p, mType, uType, mPackage, ruleResult);
					if (result6_black == null) {
		...
		switch (operationID) {
			...
			case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_PACKAGE_JAVAPACKAGE2UMLPACKAGE_ABSTRACTTYPEDECLARATION_CLASSIFIER_PACKAGE:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(ASTNode2Element) arguments.get(1), (org.eclipse.uml2.uml.Package) arguments.get(2),
						(JavaPackage2UmlPackage) arguments.get(3), (AbstractTypeDeclaration) arguments.get(4),
						(Classifier) arguments.get(5), (org.eclipse.modisco.java.Package) arguments.get(6));
			...
			case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_134__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_134((EMoflonEdge) arguments.get(0));
			case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_147__EMOFLONEDGE:
					...
					if (tmpMType instanceof AbstractTypeDeclaration) {
						...
						if (tmpUType instanceof Classifier) {
							...
							if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
								...
								return new Object[] { t2t, uPackage, p2p, mType, uType, mPackage, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(ASTNode2Element t2t,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { t2t, uPackage, p2p, mType, uType, mPackage, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkTypeToPackage_1_1_performtransformation_black = pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
					t2t, uPackage, p2p, mType, uType, mPackage, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject p2p, EObject mType, EObject uType,
			EObject mPackage) {
	...
	public static final void pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject p2p, EObject mType, EObject uType,
			EObject mPackage) {
		_this.registerObjects_FWD(ruleresult, t2t, uPackage, p2p, mType, uType, mPackage);
		...
		for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
			...
			if (tmpUType instanceof Classifier) {
				...
				for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (uPackage != null) {
						_result.add(new Object[] { t2t, uPackage, p2p, mType, uType, mPackage, match });
					}
				...
				if (mType.equals(t2t.getSource())) {
					if (uType.equals(t2t.getTarget())) {
						if (mPackage.equals(p2p.getSource())) {
							_result.add(new Object[] { t2t, uPackage, p2p, mType, uType, mPackage });
						}
					}
				}
			}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element t2t,
		...
		return new Object[] { t2t, uPackage, p2p, mType, uType, mPackage, isApplicableMatch, p2p__uPackage____target,
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			org.eclipse.modisco.java.Package mPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, t2t, uPackage, p2p, mType, uType,
				mPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t2t, uPackage, p2p, mType, uType, mPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_2_4_solveCSP_binding = pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, t2t, uPackage, p2p, mType, uType, mPackage);
	...
	public static final Object[] pattern_LinkTypeToPackage_11_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element t2t, org.eclipse.uml2.uml.Package uPackage, JavaPackage2UmlPackage p2p,
			AbstractTypeDeclaration mType, Classifier uType, org.eclipse.modisco.java.Package mPackage,
			LinkTypeToPackage _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
	...
	public static final void pattern_LinkTypeToPackage_11_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject t2t, EObject uPackage, EObject p2p, EObject mType, EObject uType,
			EObject mPackage) {
		_this.registerObjects_BWD(ruleresult, t2t, uPackage, p2p, mType, uType, mPackage);
	...
	public static final Object[] pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(ASTNode2Element t2t,
		...
		p2p__mPackage____source.setName(p2p__mPackage____source_name_prime);
		return new Object[] { t2t, uPackage, p2p, mType, uType, mPackage, isApplicableMatch, p2p__uPackage____target,
				t2t__mType____source, uPackage__uType____packagedElement, t2t__uType____target,
	...
	public static final Object[] pattern_LinkTypeToPackage_12_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			JavaPackage2UmlPackage p2p, AbstractTypeDeclaration mType, Classifier uType,
			org.eclipse.modisco.java.Package mPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, t2t, uPackage, p2p, mType, uType,
				mPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t2t, uPackage, p2p, mType, uType, mPackage };
			...
			for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mPackage.equals(p2p.getSource())) {
					for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
							ASTNode2Element.class, "source")) {
						if (uType.equals(t2t.getTarget())) {
							_result.add(new Object[] { t2t, uPackage, p2p, mType, uType, mPackage, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(LinkTypeToPackage _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, t2t, uPackage, p2p, mType, uType,
				mPackage, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t2t, uPackage, p2p, mType, uType, mPackage,
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_29_3_solveCSP_binding = pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, t2t, uPackage, p2p, mType, uType, mPackage, ruleResult);
	...
	public static final Object[] pattern_LinkTypeToPackage_29_5_checknacs_blackBBBBBB(ASTNode2Element t2t,
			org.eclipse.uml2.uml.Package uPackage, JavaPackage2UmlPackage p2p, AbstractTypeDeclaration mType,
			Classifier uType, org.eclipse.modisco.java.Package mPackage) {
		return new Object[] { t2t, uPackage, p2p, mType, uType, mPackage };
	}

	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(ASTNode2Element t2t,
			org.eclipse.uml2.uml.Package uPackage, JavaPackage2UmlPackage p2p, AbstractTypeDeclaration mType,
			Classifier uType, org.eclipse.modisco.java.Package mPackage, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { t2t, uPackage, p2p, mType, uType, mPackage, ruleResult };
	}
