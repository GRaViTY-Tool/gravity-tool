...
public class LinkTypeToPackageImpl extends AbstractRuleImpl implements LinkTypeToPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, uType, mType, uPackage, mPackage, p2p, t2t);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uType] = " + uType + ", " + "[mType] = " + mType + ", " + "[uPackage] = " + uPackage
					+ ", " + "[mPackage] = " + mPackage + ", " + "[p2p] = " + p2p + ", " + "[t2t] = " + t2t + ".");
		}
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_greenBBBBBFFF(ruleresult, uType, mType,
				uPackage, mPackage);
		...
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, uType,
				mType, uPackage, mPackage, p2p, t2t);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_2_corematch_blackFBFBFFB(mType,
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_3_findcontext_blackBBBBBB(
					uType, mType, uPackage, mPackage, p2p, t2t)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(uType, mType, uPackage, mPackage,
								p2p, t2t);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Classifier uType,
			...
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, ASTNode2Element t2t) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject uType, EObject mType, EObject uPackage,
			EObject mPackage, EObject p2p, EObject t2t) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_11_3_bookkeepingforedges_greenBBBBBFFF(ruleresult, uType, mType,
				uPackage, mPackage);
		//nothing EMoflonEdge uPackage__uType____packagedElement = (EMoflonEdge) result3_green[5];
		//nothing EMoflonEdge mType__mPackage____package = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mPackage__mType____ownedElements = (EMoflonEdge) result3_green[7];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_12_2_corematch_blackBFBFFFB(uType,
				uPackage, match)) {
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_12_3_findcontext_blackBBBBBB(
					uType, mType, uPackage, mPackage, p2p, t2t)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(uType, mType, uPackage, mPackage,
								p2p, t2t);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject uType, EObject mType, EObject uPackage,
			EObject mPackage, EObject p2p, EObject t2t) {
		ruleresult.registerObject("uType", uType);
		ruleresult.registerObject("mType", mType);
		ruleresult.registerObject("uPackage", uPackage);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackBBBBFFBB(uType, mType, uPackage, mPackage,
							sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, uType,
							mType, uPackage, mPackage, p2p, t2t, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uType] = " + uType + ", "
						+ "[mType] = " + mType + ", " + "[uPackage] = " + uPackage + ", " + "[mPackage] = " + mPackage
			...
			if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(
							uType, mType, uPackage, mPackage, p2p, t2t, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uType] = " + uType
								+ ", " + "[mType] = " + mType + ", " + "[uPackage] = " + uPackage + ", "
								+ "[mPackage] = " + mPackage + ", " + "[p2p] = " + p2p + ", " + "[t2t] = " + t2t + ", "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Classifier uType,
			AbstractTypeDeclaration mType, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, ASTNode2Element t2t,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSIFIER_ABSTRACTTYPEDECLARATION_PACKAGE_PACKAGE_JAVAPACKAGE2UMLPACKAGE_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Classifier) arguments.get(1),
					(AbstractTypeDeclaration) arguments.get(2), (org.eclipse.uml2.uml.Package) arguments.get(3),
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSIFIER_ABSTRACTTYPEDECLARATION_PACKAGE_PACKAGE_JAVAPACKAGE2UMLPACKAGE_ASTNODE2ELEMENT:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_118__EMOFLONEDGE:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSIFIER_ABSTRACTTYPEDECLARATION_PACKAGE_PACKAGE_JAVAPACKAGE2UMLPACKAGE_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
						...
						if (tmpP2p instanceof JavaPackage2UmlPackage) {
							...
							if (tmpT2t instanceof ASTNode2Element) {
								...
								return new Object[] { uType, mType, uPackage, mPackage, p2p, t2t, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(Classifier uType,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { uType, mType, uPackage, mPackage, p2p, t2t, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkTypeToPackage_1_1_performtransformation_black = pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
					uType, mType, uPackage, mPackage, p2p, t2t, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject uType, EObject mType, EObject uPackage, EObject mPackage, EObject p2p,
			EObject t2t) {
														...
														if (!p2p.equals(t2t)) {
															if (!t2t.equals(uType)) {
																if (!t2t.equals(uPackage)) {
																	return new Object[] { ruleresult, uType, mType,
																			uPackage, mPackage, p2p, t2t };
																}
															}
														}
													}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_greenBBBBBFFF(
		...
		mType__mPackage____package.setName(mType__mPackage____package_name_prime);
		mPackage__mType____ownedElements.setName(mPackage__mType____ownedElements_name_prime);
		return new Object[] { ruleresult, uType, mType, uPackage, mPackage, uPackage__uType____packagedElement,
	...
	public static final void pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject uType, EObject mType, EObject uPackage, EObject mPackage, EObject p2p,
			EObject t2t) {
		_this.registerObjects_FWD(ruleresult, uType, mType, uPackage, mPackage, p2p, t2t);
		...
		for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
			...
			if (tmpUType instanceof Classifier) {
				...
				for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (uPackage != null) {
						_result.add(new Object[] { uType, mType, uPackage, mPackage, p2p, t2t, match });
					}
				...
				if (mType.equals(t2t.getSource())) {
					if (uPackage.equals(p2p.getTarget())) {
						if (mPackage.equals(p2p.getSource())) {
							_result.add(new Object[] { uType, mType, uPackage, mPackage, p2p, t2t });
						}
					}
				}
			}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(Classifier uType,
		...
		return new Object[] { uType, mType, uPackage, mPackage, p2p, t2t, isApplicableMatch, mType__mPackage____package,
				mPackage__mType____ownedElements, t2t__uType____target, t2t__mType____source, p2p__uPackage____target,
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			IsApplicableMatch isApplicableMatch, Classifier uType, AbstractTypeDeclaration mType,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, uType, mType, uPackage, mPackage, p2p,
				t2t);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uType, mType, uPackage, mPackage, p2p, t2t };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			LinkTypeToPackage _this, IsApplicableMatch isApplicableMatch, Classifier uType,
			AbstractTypeDeclaration mType, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, ASTNode2Element t2t) {
		Object[] result_pattern_LinkTypeToPackage_2_4_solveCSP_binding = pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, uType, mType, uPackage, mPackage, p2p, t2t);
	...
	public static final void pattern_LinkTypeToPackage_11_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject uType, EObject mType, EObject uPackage, EObject mPackage, EObject p2p,
			EObject t2t) {
		_this.registerObjects_BWD(ruleresult, uType, mType, uPackage, mPackage, p2p, t2t);
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_12_2_corematch_blackBFBFFFB(Classifier uType,
	...
	public static final Object[] pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(Classifier uType,
			AbstractTypeDeclaration mType, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, ASTNode2Element t2t) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge uPackage__uType____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_LinkTypeToPackage_12_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage,
			JavaPackage2UmlPackage p2p, ASTNode2Element t2t) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, uType, mType, uPackage, mPackage, p2p,
				t2t);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uType, mType, uPackage, mPackage, p2p, t2t };
			...
			for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(uType,
				...
				if (mType.equals(t2t.getSource())) {
					for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(uPackage, JavaPackage2UmlPackage.class, "target")) {
						if (mPackage.equals(p2p.getSource())) {
							_result.add(new Object[] { uType, mType, uPackage, mPackage, p2p, t2t, sourceMatch,
									targetMatch });
						}
					}
				}
																	...
																	if (pattern_LinkTypeToPackage_29_2_isapplicablecore_black_nac_3BB(
																		...
																		if (pattern_LinkTypeToPackage_29_2_isapplicablecore_black_nac_5BB(
																			...
																			_result.add(new Object[] { t2tList, uType,
																					t2t, mType, p2pList, uPackage, p2p,
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(LinkTypeToPackage _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, uType, mType, uPackage, mPackage,
				p2p, t2t, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uType, mType, uPackage, mPackage, p2p, t2t,
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_29_3_solveCSP_binding = pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, uType, mType, uPackage, mPackage, p2p, t2t, ruleResult);
	...
	public static final Object[] pattern_LinkTypeToPackage_29_5_checknacs_blackBBBBBB(Classifier uType,
			AbstractTypeDeclaration mType, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, ASTNode2Element t2t) {
		return new Object[] { uType, mType, uPackage, mPackage, p2p, t2t };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(Classifier uType,
			...
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, ASTNode2Element t2t,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { uType, mType, uPackage, mPackage, p2p, t2t, ruleResult };
	}
