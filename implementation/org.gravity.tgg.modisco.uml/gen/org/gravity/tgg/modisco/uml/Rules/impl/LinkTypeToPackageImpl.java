...
public class LinkTypeToPackageImpl extends AbstractRuleImpl implements LinkTypeToPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, p2p, uPackage, uType, mType, t2t, mPackage);
		...
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, p2p,
				uPackage, uType, mType, t2t, mPackage);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_2_corematch_blackFFFBFBB(mType,
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_3_findcontext_blackBBBBBB(
					p2p, uPackage, uType, mType, t2t, mPackage)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(p2p, uPackage, uType, mType, t2t,
								mPackage);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject p2p, EObject uPackage, EObject uType,
			EObject mType, EObject t2t, EObject mPackage) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
				.pattern_LinkTypeToPackage_12_2_corematch_blackFBBFFFB(uPackage, uType, match)) {
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result2_black[0];
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_12_3_findcontext_blackBBBBBB(
					p2p, uPackage, uType, mType, t2t, mPackage)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(p2p, uPackage, uType, mType, t2t,
								mPackage);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge p2p__uPackage____target = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject p2p, EObject uPackage, EObject uType,
			EObject mType, EObject t2t, EObject mPackage) {
		ruleresult.registerObject("p2p", p2p);
		ruleresult.registerObject("uPackage", uPackage);
		ruleresult.registerObject("uType", uType);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_161(EMoflonEdge _edge_package) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackFBBBFBBB(uPackage, uType, mType, mPackage,
							sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, p2p,
							uPackage, uType, mType, t2t, mPackage, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[p2p] = " + p2p + ", "
						+ "[uPackage] = " + uPackage + ", " + "[uType] = " + uType + ", " + "[mType] = " + mType + ", "
						+ "[t2t] = " + t2t + ", " + "[mPackage] = " + mPackage + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(
							p2p, uPackage, uType, mType, t2t, mPackage, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[p2p] = " + p2p + ", "
								+ "[uPackage] = " + uPackage + ", " + "[uType] = " + uType + ", " + "[mType] = " + mType
								+ ", " + "[t2t] = " + t2t + ", " + "[mPackage] = " + mPackage + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_JAVAPACKAGE2UMLPACKAGE_PACKAGE_CLASSIFIER_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_PACKAGE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(JavaPackage2UmlPackage) arguments.get(1), (org.eclipse.uml2.uml.Package) arguments.get(2),
					(Classifier) arguments.get(3), (AbstractTypeDeclaration) arguments.get(4),
					(ASTNode2Element) arguments.get(5), (org.eclipse.modisco.java.Package) arguments.get(6));
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_JAVAPACKAGE2UMLPACKAGE_PACKAGE_CLASSIFIER_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_PACKAGE:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_149__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_149((EMoflonEdge) arguments.get(0));
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_161__EMOFLONEDGE:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_JAVAPACKAGE2UMLPACKAGE_PACKAGE_CLASSIFIER_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_PACKAGE_MODELGENERATORRULERESULT:
					...
					if (tmpMType instanceof AbstractTypeDeclaration) {
						...
						if (tmpT2t instanceof ASTNode2Element) {
							...
							if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
								...
								return new Object[] { p2p, uPackage, uType, mType, t2t, mPackage, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { p2p, uPackage, uType, mType, t2t, mPackage, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkTypeToPackage_1_1_performtransformation_black = pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
					p2p, uPackage, uType, mType, t2t, mPackage, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject p2p, EObject uPackage, EObject uType, EObject mType, EObject t2t,
			EObject mPackage) {
	...
	public static final void pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject p2p, EObject uPackage, EObject uType, EObject mType, EObject t2t,
			EObject mPackage) {
		_this.registerObjects_FWD(ruleresult, p2p, uPackage, uType, mType, t2t, mPackage);
		...
		for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
			...
			if (tmpUType instanceof Classifier) {
				...
				for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (uPackage != null) {
						_result.add(new Object[] { p2p, uPackage, uType, mType, t2t, mPackage, match });
					}
				...
				if (mType.equals(t2t.getSource())) {
					if (uType.equals(t2t.getTarget())) {
						if (mPackage.equals(p2p.getSource())) {
							_result.add(new Object[] { p2p, uPackage, uType, mType, t2t, mPackage });
						}
					}
				}
			}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { p2p, uPackage, uType, mType, t2t, mPackage, isApplicableMatch, p2p__uPackage____target,
				mType__mPackage____package, mPackage__mType____ownedElements, t2t__mType____source,
				t2t__uType____target, p2p__mPackage____source };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			Classifier uType, AbstractTypeDeclaration mType, ASTNode2Element t2t,
			org.eclipse.modisco.java.Package mPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, p2p, uPackage, uType, mType, t2t,
				mPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, p2p, uPackage, uType, mType, t2t, mPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_2_4_solveCSP_binding = pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, p2p, uPackage, uType, mType, t2t, mPackage);
	...
	public static final void pattern_LinkTypeToPackage_11_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject p2p, EObject uPackage, EObject uType, EObject mType, EObject t2t,
			EObject mPackage) {
		_this.registerObjects_BWD(ruleresult, p2p, uPackage, uType, mType, t2t, mPackage);
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_12_2_corematch_blackFBBFFFB(
	...
	public static final Object[] pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		p2p__mPackage____source.setName(p2p__mPackage____source_name_prime);
		return new Object[] { p2p, uPackage, uType, mType, t2t, mPackage, isApplicableMatch, p2p__uPackage____target,
				uPackage__uType____packagedElement, t2t__mType____source, t2t__uType____target,
	...
	public static final Object[] pattern_LinkTypeToPackage_12_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			Classifier uType, AbstractTypeDeclaration mType, ASTNode2Element t2t,
			org.eclipse.modisco.java.Package mPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, p2p, uPackage, uType, mType, t2t,
				mPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, p2p, uPackage, uType, mType, t2t, mPackage };
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackFBBBFBBB(
			org.eclipse.uml2.uml.Package uPackage, Classifier uType, AbstractTypeDeclaration mType,
			org.eclipse.modisco.java.Package mPackage, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mPackage.equals(p2p.getSource())) {
					for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
							ASTNode2Element.class, "source")) {
						if (uType.equals(t2t.getTarget())) {
							_result.add(new Object[] { p2p, uPackage, uType, mType, t2t, mPackage, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(LinkTypeToPackage _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, p2p, uPackage, uType, mType, t2t,
				mPackage, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, p2p, uPackage, uType, mType, t2t, mPackage,
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_29_3_solveCSP_binding = pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, p2p, uPackage, uType, mType, t2t, mPackage, ruleResult);
	...
	public static final Object[] pattern_LinkTypeToPackage_29_5_checknacs_blackBBBBBB(JavaPackage2UmlPackage p2p,
			org.eclipse.uml2.uml.Package uPackage, Classifier uType, AbstractTypeDeclaration mType, ASTNode2Element t2t,
			org.eclipse.modisco.java.Package mPackage) {
		return new Object[] { p2p, uPackage, uType, mType, t2t, mPackage };
	}

	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(JavaPackage2UmlPackage p2p,
			org.eclipse.uml2.uml.Package uPackage, Classifier uType, AbstractTypeDeclaration mType, ASTNode2Element t2t,
			org.eclipse.modisco.java.Package mPackage, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { p2p, uPackage, uType, mType, t2t, mPackage, ruleResult };
	}
