...
public class LinkTypeToPackageImpl extends AbstractRuleImpl implements LinkTypeToPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mPackage, mType, p2p, t2t, uPackage, uType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mPackage] = " + mPackage + ", " + "[mType] = " + mType + ", " + "[p2p] = " + p2p + ", "
					+ "[t2t] = " + t2t + ", " + "[uPackage] = " + uPackage + ", " + "[uType] = " + uType + ".");
		}
		...
		LinkTypeToPackageImpl.pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mPackage, mType, p2p, t2t, uPackage, uType);
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_2_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(mPackage, mType, p2p, t2t,
								uPackage, uType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.modisco.java.Package mPackage,
			...
			org.eclipse.uml2.uml.Package uPackage, Classifier uType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPackage, EObject mType, EObject p2p,
			EObject t2t, EObject uPackage, EObject uType) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
				.pattern_LinkTypeToPackage_12_2_corematch_blackFFFFBBB(uPackage, uType, match)) {
			...
			for (Object[] result3_black : LinkTypeToPackageImpl.pattern_LinkTypeToPackage_12_3_findcontext_blackBBBBBB(
					mPackage, mType, p2p, t2t, uPackage, uType)) {
				Object[] result3_green = LinkTypeToPackageImpl
						.pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(mPackage, mType, p2p, t2t,
								uPackage, uType);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				//nothing EMoflonEdge uPackage__uType____packagedElement = (EMoflonEdge) result3_green[9];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (LinkTypeToPackageImpl.pattern_LinkTypeToPackage_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackBBFFBBBB(mPackage, mType, uPackage, uType,
							sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : LinkTypeToPackageImpl
			...
			Object[] result3_bindingAndBlack = LinkTypeToPackageImpl
					.pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mPackage, mType, p2p, t2t, uPackage, uType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mPackage] = " + mPackage + ", "
						+ "[mType] = " + mType + ", " + "[p2p] = " + p2p + ", " + "[t2t] = " + t2t + ", "
						+ "[uPackage] = " + uPackage + ", " + "[uType] = " + uType + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPackage] = "
								+ mPackage + ", " + "[mType] = " + mType + ", " + "[p2p] = " + p2p + ", " + "[t2t] = "
								+ t2t + ", " + "[uPackage] = " + uPackage + ", " + "[uType] = " + uType + ", "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			...
			ASTNode2Element t2t, org.eclipse.uml2.uml.Package uPackage, Classifier uType,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PACKAGE_ABSTRACTTYPEDECLARATION_JAVAPACKAGE2UMLPACKAGE_ASTNODE2ELEMENT_PACKAGE_CLASSIFIER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(org.eclipse.modisco.java.Package) arguments.get(1), (AbstractTypeDeclaration) arguments.get(2),
					(JavaPackage2UmlPackage) arguments.get(3), (ASTNode2Element) arguments.get(4),
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_ABSTRACTTYPEDECLARATION_JAVAPACKAGE2UMLPACKAGE_ASTNODE2ELEMENT_PACKAGE_CLASSIFIER:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_108__EMOFLONEDGE:
		...
		case RulesPackage.LINK_TYPE_TO_PACKAGE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_ABSTRACTTYPEDECLARATION_JAVAPACKAGE2UMLPACKAGE_ASTNODE2ELEMENT_PACKAGE_CLASSIFIER_MODELGENERATORRULERESULT:
					...
					if (tmpT2t instanceof ASTNode2Element) {
						...
						if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
							...
							if (tmpUType instanceof Classifier) {
								...
								return new Object[] { mPackage, mType, p2p, t2t, uPackage, uType, isApplicableMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
			org.eclipse.modisco.java.Package mPackage, AbstractTypeDeclaration mType, JavaPackage2UmlPackage p2p,
			ASTNode2Element t2t, org.eclipse.uml2.uml.Package uPackage, Classifier uType, LinkTypeToPackage _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mPackage, mType, p2p, t2t, uPackage, uType, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_LinkTypeToPackage_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkTypeToPackage_1_1_performtransformation_black = pattern_LinkTypeToPackage_1_1_performtransformation_blackBBBBBBFBB(
					mPackage, mType, p2p, t2t, uPackage, uType, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkTypeToPackage_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mPackage, EObject mType, EObject p2p, EObject t2t, EObject uPackage,
			EObject uType) {
	...
	public static final void pattern_LinkTypeToPackage_1_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject mPackage, EObject mType, EObject p2p, EObject t2t, EObject uPackage,
			EObject uType) {
		_this.registerObjects_FWD(ruleresult, mPackage, mType, p2p, t2t, uPackage, uType);
		...
		for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mPackage,
			...
			if (uPackage != null) {
				for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mType,
					...
					if (tmpUType instanceof Classifier) {
						Classifier uType = (Classifier) tmpUType;
						_result.add(new Object[] { mPackage, mType, p2p, t2t, uPackage, uType, match });
					}
				...
				if (uPackage.equals(p2p.getTarget())) {
					if (uType.equals(t2t.getTarget())) {
						if (mType.equals(t2t.getSource())) {
							_result.add(new Object[] { mPackage, mType, p2p, t2t, uPackage, uType });
						}
					}
				}
			}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mPackage, mType, p2p, t2t, uPackage, uType, isApplicableMatch, mType__mPackage____package,
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			AbstractTypeDeclaration mType, JavaPackage2UmlPackage p2p, ASTNode2Element t2t,
			org.eclipse.uml2.uml.Package uPackage, Classifier uType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mPackage, mType, p2p, t2t, uPackage,
				uType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPackage, mType, p2p, t2t, uPackage, uType };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_2_4_solveCSP_binding = pattern_LinkTypeToPackage_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mPackage, mType, p2p, t2t, uPackage, uType);
	...
	public static final void pattern_LinkTypeToPackage_11_5_registerobjects_expressionBBBBBBBB(LinkTypeToPackage _this,
			PerformRuleResult ruleresult, EObject mPackage, EObject mType, EObject p2p, EObject t2t, EObject uPackage,
			EObject uType) {
		_this.registerObjects_BWD(ruleresult, mPackage, mType, p2p, t2t, uPackage, uType);
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_12_2_corematch_blackFFFFBBB(
	...
	public static final Object[] pattern_LinkTypeToPackage_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		t2t__uType____target.setName(t2t__uType____target_name_prime);
		t2t__mType____source.setName(t2t__mType____source_name_prime);
		return new Object[] { mPackage, mType, p2p, t2t, uPackage, uType, isApplicableMatch, p2p__mPackage____source,
				p2p__uPackage____target, uPackage__uType____packagedElement, t2t__uType____target,
	...
	public static final Object[] pattern_LinkTypeToPackage_12_4_solveCSP_bindingFBBBBBBBB(LinkTypeToPackage _this,
			...
			AbstractTypeDeclaration mType, JavaPackage2UmlPackage p2p, ASTNode2Element t2t,
			org.eclipse.uml2.uml.Package uPackage, Classifier uType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mPackage, mType, p2p, t2t, uPackage,
				uType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPackage, mType, p2p, t2t, uPackage, uType };
	...
	public static final Iterable<Object[]> pattern_LinkTypeToPackage_24_5_matchcorrcontext_blackBBFFBBBB(
			org.eclipse.modisco.java.Package mPackage, AbstractTypeDeclaration mType,
			org.eclipse.uml2.uml.Package uPackage, Classifier uType, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (uPackage.equals(p2p.getTarget())) {
					for (ASTNode2Element t2t : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(uType,
							ASTNode2Element.class, "target")) {
						if (mType.equals(t2t.getSource())) {
							_result.add(new Object[] { mPackage, mType, p2p, t2t, uPackage, uType, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(LinkTypeToPackage _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mPackage, mType, p2p, t2t, uPackage,
				uType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPackage, mType, p2p, t2t, uPackage, uType,
	...
	public static final Object[] pattern_LinkTypeToPackage_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkTypeToPackage_29_3_solveCSP_binding = pattern_LinkTypeToPackage_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mPackage, mType, p2p, t2t, uPackage, uType, ruleResult);
	...
	public static final Object[] pattern_LinkTypeToPackage_29_5_checknacs_blackBBBBBB(
			org.eclipse.modisco.java.Package mPackage, AbstractTypeDeclaration mType, JavaPackage2UmlPackage p2p,
			ASTNode2Element t2t, org.eclipse.uml2.uml.Package uPackage, Classifier uType) {
		return new Object[] { mPackage, mType, p2p, t2t, uPackage, uType };
	}
	...
	public static final Object[] pattern_LinkTypeToPackage_29_6_perform_blackBBBBBBB(
		...
		return new Object[] { mPackage, mType, p2p, t2t, uPackage, uType, ruleResult };
	}
