...
public class OperationInInterfaceImpl extends AbstractRuleImpl implements OperationInInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInInterfaceImpl
				.pattern_OperationInInterface_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bodyDeclaration, c2c,
						feature, umlClass, classDec, bd2ne);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[c2c] = " + c2c + ", " + "[feature] = "
					+ feature + ", " + "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec + ", "
					+ "[bd2ne] = " + bd2ne + ".");
		}
		...
		OperationInInterfaceImpl.pattern_OperationInInterface_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
				.pattern_OperationInInterface_2_2_corematch_blackBFFFBFB(bodyDeclaration, classDec, match)) {
			...
			for (Object[] result3_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_2_3_findcontext_blackBBBBBB(bodyDeclaration, c2c, feature, umlClass,
							classDec, bd2ne)) {
				Object[] result3_green = OperationInInterfaceImpl
						.pattern_OperationInInterface_2_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, c2c, feature,
								umlClass, classDec, bd2ne);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ bodyDeclaration + ", " + "[c2c] = " + c2c + ", " + "[feature] = " + feature + ", "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MAbstractMethodDefinition bodyDeclaration,
			ASTNode2Element c2c, Operation feature, Interface umlClass, InterfaceDeclaration classDec,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject c2c, EObject feature,
			EObject umlClass, EObject classDec, EObject bd2ne) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInInterfaceImpl
				.pattern_OperationInInterface_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bodyDeclaration, c2c,
						feature, umlClass, classDec, bd2ne);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[c2c] = " + c2c + ", " + "[feature] = "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
			...
			// ForEach 
			for (Object[] result3_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_12_3_findcontext_blackBBBBBB(bodyDeclaration, c2c, feature, umlClass,
							classDec, bd2ne)) {
				Object[] result3_green = OperationInInterfaceImpl
						.pattern_OperationInInterface_12_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, c2c, feature,
								umlClass, classDec, bd2ne);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject c2c, EObject feature,
			EObject umlClass, EObject classDec, EObject bd2ne) {
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
		ruleresult.registerObject("c2c", c2c);
		ruleresult.registerObject("feature", feature);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_15(EMoflonEdge _edge_ownedOperation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_18(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = OperationInInterfaceImpl
				.pattern_OperationInInterface_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, bodyDeclaration, feature,
		...
		if (OperationInInterfaceImpl.pattern_OperationInInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_24_5_matchcorrcontext_blackBFBBBFBB(bodyDeclaration, feature,
							umlClass, classDec, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = OperationInInterfaceImpl
						.pattern_OperationInInterface_24_6_createcorrespondence_blackBBBBB(bodyDeclaration, feature,
		...
		for (Object[] result2_black : OperationInInterfaceImpl
			...
			Object[] result3_bindingAndBlack = OperationInInterfaceImpl
					.pattern_OperationInInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (OperationInInterfaceImpl.pattern_OperationInInterface_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = OperationInInterfaceImpl
						.pattern_OperationInInterface_29_5_checknacs_blackBBBBBB(bodyDeclaration, c2c, feature,
								umlClass, classDec, bd2ne);
				if (result5_black != null) {

					Object[] result6_black = OperationInInterfaceImpl
							.pattern_OperationInInterface_29_6_perform_blackBBBBBBB(bodyDeclaration, c2c, feature,
									umlClass, classDec, bd2ne, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[bodyDeclaration] = "
								+ bodyDeclaration + ", " + "[c2c] = " + c2c + ", " + "[feature] = " + feature + ", "
								+ "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec + ", " + "[bd2ne] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c, Operation feature, Interface umlClass,
			InterfaceDeclaration classDec, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_OPERATION_INTERFACE_INTERFACEDECLARATION_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MAbstractMethodDefinition) arguments.get(1), (ASTNode2Element) arguments.get(2),
					(Operation) arguments.get(3), (Interface) arguments.get(4), (InterfaceDeclaration) arguments.get(5),
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_OPERATION_INTERFACE_INTERFACEDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_15__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_15((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_18__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__MABSTRACTMETHODDEFINITION_OPERATION_INTERFACE_INTERFACEDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_OPERATION_INTERFACE_INTERFACEDECLARATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpUmlClass instanceof Interface) {
						...
						if (tmpClassDec instanceof InterfaceDeclaration) {
							...
							if (tmpBd2ne instanceof ASTNode2Element) {
								...
								return new Object[] { bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInInterface_1_1_performtransformation_blackBBBBBBFBB(
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c, Operation feature, Interface umlClass,
			InterfaceDeclaration classDec, ASTNode2Element bd2ne, OperationInInterface _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInInterface_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInInterface_1_1_performtransformation_binding != null) {
			...
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInInterface_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_OperationInInterface_1_1_performtransformation_black = pattern_OperationInInterface_1_1_performtransformation_blackBBBBBBFBB(
					bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInInterface_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject c2c, EObject feature, EObject umlClass,
															...
															if (!bd2ne.equals(umlClass)) {
																if (!bd2ne.equals(classDec)) {
																	return new Object[] { ruleresult, bodyDeclaration,
																			c2c, feature, umlClass, classDec, bd2ne };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInInterface_1_5_registerobjects_expressionBBBBBBBB(
			OperationInInterface _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject c2c,
			EObject feature, EObject umlClass, EObject classDec, EObject bd2ne) {
		_this.registerObjects_FWD(ruleresult, bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne);
	...
	public static final Iterable<Object[]> pattern_OperationInInterface_2_2_corematch_blackBFFFBFB(
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne, match });
						}
	...
	public static final Iterable<Object[]> pattern_OperationInInterface_2_3_findcontext_blackBBBBBB(
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c, Operation feature, Interface umlClass,
			InterfaceDeclaration classDec, ASTNode2Element bd2ne) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
					...
					if (classDec.getBodyDeclarations().contains(bodyDeclaration)) {
						if (feature.equals(bd2ne.getTarget())) {
							if (bodyDeclaration.equals(bd2ne.getSource())) {
								_result.add(new Object[] { bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInInterface_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne, isApplicableMatch,
				c2c__umlClass____target, c2c__classDec____source, classDec__bodyDeclaration____bodyDeclarations,
				bodyDeclaration__classDec____abstractTypeDeclaration, bd2ne__feature____target,
	...
	public static final Object[] pattern_OperationInInterface_2_4_solveCSP_bindingFBBBBBBBB(OperationInInterface _this,
			IsApplicableMatch isApplicableMatch, MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c,
			Operation feature, Interface umlClass, InterfaceDeclaration classDec, ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, bodyDeclaration, c2c, feature,
				umlClass, classDec, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, c2c, feature, umlClass, classDec,
					bd2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_OperationInInterface_2_4_solveCSP_binding = pattern_OperationInInterface_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne);
	...
	public static final Object[] pattern_OperationInInterface_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInInterface_11_1_performtransformation_binding != null) {
			...
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInInterface_11_1_performtransformation_binding[1];
	...
	public static final void pattern_OperationInInterface_11_5_registerobjects_expressionBBBBBBBB(
			OperationInInterface _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject c2c,
			EObject feature, EObject umlClass, EObject classDec, EObject bd2ne) {
		_this.registerObjects_BWD(ruleresult, bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne);
	...
	public static final Object[] pattern_OperationInInterface_12_4_solveCSP_bindingFBBBBBBBB(OperationInInterface _this,
			IsApplicableMatch isApplicableMatch, MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c,
			Operation feature, Interface umlClass, InterfaceDeclaration classDec, ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, bodyDeclaration, c2c, feature,
				umlClass, classDec, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, c2c, feature, umlClass, classDec,
	...
	public static final Object[] pattern_OperationInInterface_24_2_matchsrctrgcontext_blackBBBBBB(
			MAbstractMethodDefinition bodyDeclaration, Operation feature, Interface umlClass,
	...
	public static final Object[] pattern_OperationInInterface_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_OperationInInterface_24_2_matchsrctrgcontext_binding != null) {
			...
			Operation feature = (Operation) result_pattern_OperationInInterface_24_2_matchsrctrgcontext_binding[1];
	...
	public static final Object[] pattern_OperationInInterface_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			OperationInInterface _this, MAbstractMethodDefinition bodyDeclaration, Operation feature,
	...
	public static final Iterable<Object[]> pattern_OperationInInterface_24_5_matchcorrcontext_blackBFBBBFBB(
			MAbstractMethodDefinition bodyDeclaration, Operation feature, Interface umlClass,
			InterfaceDeclaration classDec, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInInterface_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, bodyDeclaration, c2c, feature,
				umlClass, classDec, bd2ne, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, c2c, feature, umlClass, classDec,
	...
	public static final Object[] pattern_OperationInInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInInterface_29_3_solveCSP_binding = pattern_OperationInInterface_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne, ruleResult);
	...
	public static final Object[] pattern_OperationInInterface_29_6_perform_blackBBBBBBB(
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element c2c, Operation feature, Interface umlClass,
			InterfaceDeclaration classDec, ASTNode2Element bd2ne, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { bodyDeclaration, c2c, feature, umlClass, classDec, bd2ne, ruleResult };
		}
		return null;
	}
