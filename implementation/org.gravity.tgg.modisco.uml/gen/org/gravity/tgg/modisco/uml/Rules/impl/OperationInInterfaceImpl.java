...
public class OperationInInterfaceImpl extends AbstractRuleImpl implements OperationInInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInInterfaceImpl
				.pattern_OperationInInterface_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, classDec, c2c, feature,
		...
		OperationInInterfaceImpl.pattern_OperationInInterface_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				classDec, feature, bodyDeclaration, umlClass);
		...
		OperationInInterfaceImpl.pattern_OperationInInterface_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
				.pattern_OperationInInterface_2_2_corematch_blackBFFBFFB(classDec, bodyDeclaration, match)) {
			...
			for (Object[] result3_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_2_3_findcontext_blackBBBBBB(classDec, c2c, feature, bodyDeclaration,
							bd2ne, umlClass)) {
				Object[] result3_green = OperationInInterfaceImpl
						.pattern_OperationInInterface_2_3_findcontext_greenBBBBBBFFFFFFF(classDec, c2c, feature,
								bodyDeclaration, bd2ne, umlClass);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, InterfaceDeclaration classDec,
			ASTNode2Element c2c, Operation feature, MAbstractMethodDefinition bodyDeclaration, ASTNode2Element bd2ne,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInInterfaceImpl
				.pattern_OperationInInterface_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, classDec, c2c, feature,
						bodyDeclaration, bd2ne, umlClass);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[classDec] = " + classDec + ", " + "[c2c] = " + c2c + ", " + "[feature] = " + feature
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
				.pattern_OperationInInterface_12_2_corematch_blackFFBFFBB(feature, umlClass, match)) {
			...
			// ForEach 
			for (Object[] result3_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_12_3_findcontext_blackBBBBBB(classDec, c2c, feature, bodyDeclaration,
							bd2ne, umlClass)) {
				Object[] result3_green = OperationInInterfaceImpl
						.pattern_OperationInInterface_12_3_findcontext_greenBBBBBBFFFFFFF(classDec, c2c, feature,
								bodyDeclaration, bd2ne, umlClass);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge c2c__classDec____source = (EMoflonEdge) result3_green[7];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = OperationInInterfaceImpl
				.pattern_OperationInInterface_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, classDec, feature,
		...
		if (OperationInInterfaceImpl.pattern_OperationInInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_24_5_matchcorrcontext_blackBFBBFBBB(classDec, feature,
							bodyDeclaration, umlClass, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = OperationInInterfaceImpl
						.pattern_OperationInInterface_24_6_createcorrespondence_blackBBBBB(classDec, feature,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(InterfaceDeclaration classDec, Operation feature,
		...
		for (Object[] result2_black : OperationInInterfaceImpl
			...
			Object[] result3_bindingAndBlack = OperationInInterfaceImpl
					.pattern_OperationInInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
						+ "[c2c] = " + c2c + ", " + "[feature] = " + feature + ", " + "[bodyDeclaration] = "
			...
			if (OperationInInterfaceImpl.pattern_OperationInInterface_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = OperationInInterfaceImpl
						.pattern_OperationInInterface_29_5_checknacs_blackBBBBBB(classDec, c2c, feature,
								bodyDeclaration, bd2ne, umlClass);
				if (result5_black != null) {

					Object[] result6_black = OperationInInterfaceImpl
							.pattern_OperationInInterface_29_6_perform_blackBBBBBBB(classDec, c2c, feature,
					...
					OperationInInterfaceImpl.pattern_OperationInInterface_29_6_perform_greenBBBBB(classDec, feature,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_ASTNODE2ELEMENT_OPERATION_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_INTERFACE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (ASTNode2Element) arguments.get(2),
					(Operation) arguments.get(3), (MAbstractMethodDefinition) arguments.get(4),
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_ASTNODE2ELEMENT_OPERATION_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_INTERFACE:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_114__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__INTERFACEDECLARATION_OPERATION_MABSTRACTMETHODDEFINITION_INTERFACE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((InterfaceDeclaration) arguments.get(0), (Operation) arguments.get(1),
		...
		case RulesPackage.OPERATION_IN_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_ASTNODE2ELEMENT_OPERATION_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_INTERFACE_MODELGENERATORRULERESULT:
					...
					if (tmpBodyDeclaration instanceof MAbstractMethodDefinition) {
						...
						if (tmpBd2ne instanceof ASTNode2Element) {
							...
							if (tmpUmlClass instanceof Interface) {
								...
								return new Object[] { classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInInterface_1_1_performtransformation_blackBBBBBBFBB(
			InterfaceDeclaration classDec, ASTNode2Element c2c, Operation feature,
		...
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInInterface_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInInterface_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInInterface_1_1_performtransformation_black = pattern_OperationInInterface_1_1_performtransformation_blackBBBBBBFBB(
					classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInInterface_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject classDec, EObject c2c, EObject feature, EObject bodyDeclaration,
															...
															if (!bd2ne.equals(bodyDeclaration)) {
																if (!bd2ne.equals(umlClass)) {
																	return new Object[] { ruleresult, classDec, c2c,
																			feature, bodyDeclaration, bd2ne, umlClass };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInInterface_1_5_registerobjects_expressionBBBBBBBB(
			OperationInInterface _this, PerformRuleResult ruleresult, EObject classDec, EObject c2c, EObject feature,
			EObject bodyDeclaration, EObject bd2ne, EObject umlClass) {
		_this.registerObjects_FWD(ruleresult, classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass);
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass, match });
						}
					...
					if (bodyDeclaration.equals(bd2ne.getSource())) {
						if (feature.equals(bd2ne.getTarget())) {
							if (umlClass.equals(c2c.getTarget())) {
								_result.add(new Object[] { classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInInterface_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass, isApplicableMatch,
	...
	public static final Object[] pattern_OperationInInterface_2_4_solveCSP_bindingFBBBBBBBB(OperationInInterface _this,
			IsApplicableMatch isApplicableMatch, InterfaceDeclaration classDec, ASTNode2Element c2c, Operation feature,
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element bd2ne, Interface umlClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, classDec, c2c, feature,
				bodyDeclaration, bd2ne, umlClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, c2c, feature, bodyDeclaration, bd2ne,
					umlClass };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_OperationInInterface_2_4_solveCSP_binding = pattern_OperationInInterface_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass);
	...
	public static final void pattern_OperationInInterface_11_5_registerobjects_expressionBBBBBBBB(
			OperationInInterface _this, PerformRuleResult ruleresult, EObject classDec, EObject c2c, EObject feature,
			EObject bodyDeclaration, EObject bd2ne, EObject umlClass) {
		_this.registerObjects_BWD(ruleresult, classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass);
	...
	public static final Iterable<Object[]> pattern_OperationInInterface_12_2_corematch_blackFFBFFBB(Operation feature,
	...
	public static final Object[] pattern_OperationInInterface_12_4_solveCSP_bindingFBBBBBBBB(OperationInInterface _this,
			IsApplicableMatch isApplicableMatch, InterfaceDeclaration classDec, ASTNode2Element c2c, Operation feature,
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element bd2ne, Interface umlClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, classDec, c2c, feature,
				bodyDeclaration, bd2ne, umlClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, c2c, feature, bodyDeclaration, bd2ne,
	...
	public static final Object[] pattern_OperationInInterface_24_2_matchsrctrgcontext_blackBBBBBB(
			InterfaceDeclaration classDec, Operation feature, MAbstractMethodDefinition bodyDeclaration,
	...
	public static final Object[] pattern_OperationInInterface_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			OperationInInterface _this, InterfaceDeclaration classDec, Operation feature,
	...
	public static final Object[] pattern_OperationInInterface_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, classDec, c2c, feature,
				bodyDeclaration, bd2ne, umlClass, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, c2c, feature, bodyDeclaration, bd2ne,
	...
	public static final Object[] pattern_OperationInInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInInterface_29_3_solveCSP_binding = pattern_OperationInInterface_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass, ruleResult);
	...
	public static final Object[] pattern_OperationInInterface_29_6_perform_blackBBBBBBB(InterfaceDeclaration classDec,
			...
			Interface umlClass, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { classDec, c2c, feature, bodyDeclaration, bd2ne, umlClass, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_OperationInInterface_29_6_perform_greenBBBBB(InterfaceDeclaration classDec,
			Operation feature, MAbstractMethodDefinition bodyDeclaration, Interface umlClass,
