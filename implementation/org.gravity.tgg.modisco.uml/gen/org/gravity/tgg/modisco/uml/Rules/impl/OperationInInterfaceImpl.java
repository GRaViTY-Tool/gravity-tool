...
public class OperationInInterfaceImpl extends AbstractRuleImpl implements OperationInInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInInterfaceImpl
				.pattern_OperationInInterface_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bodyDeclaration, feature,
						umlClass, c2c, classDec, bd2ne);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[feature] = " + feature + ", "
					+ "[umlClass] = " + umlClass + ", " + "[c2c] = " + c2c + ", " + "[classDec] = " + classDec + ", "
					+ "[bd2ne] = " + bd2ne + ".");
		}
		...
		OperationInInterfaceImpl.pattern_OperationInInterface_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
			...
			for (Object[] result3_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_2_3_findcontext_blackBBBBBB(bodyDeclaration, feature, umlClass, c2c,
							classDec, bd2ne)) {
				Object[] result3_green = OperationInInterfaceImpl
						.pattern_OperationInInterface_2_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, feature,
								umlClass, c2c, classDec, bd2ne);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MAbstractMethodDefinition bodyDeclaration,
			Operation feature, Interface umlClass, ASTNode2Element c2c, InterfaceDeclaration classDec,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject feature,
			EObject umlClass, EObject c2c, EObject classDec, EObject bd2ne) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInInterfaceImpl
				.pattern_OperationInInterface_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bodyDeclaration,
						feature, umlClass, c2c, classDec, bd2ne);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[feature] = " + feature + ", "
					+ "[umlClass] = " + umlClass + ", " + "[c2c] = " + c2c + ", " + "[classDec] = " + classDec + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
				.pattern_OperationInInterface_12_2_corematch_blackFBBFFFB(feature, umlClass, match)) {
			...
			// ForEach 
			for (Object[] result3_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_12_3_findcontext_blackBBBBBB(bodyDeclaration, feature, umlClass, c2c,
							classDec, bd2ne)) {
				Object[] result3_green = OperationInInterfaceImpl
						.pattern_OperationInInterface_12_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, feature,
								umlClass, c2c, classDec, bd2ne);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge c2c__classDec____source = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_98(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInInterfaceImpl.pattern_OperationInInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_24_5_matchcorrcontext_blackBBBFBFBB(bodyDeclaration, feature,
							umlClass, classDec, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
			...
			Object[] result3_bindingAndBlack = OperationInInterfaceImpl
					.pattern_OperationInInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (OperationInInterfaceImpl.pattern_OperationInInterface_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = OperationInInterfaceImpl
						.pattern_OperationInInterface_29_5_checknacs_blackBBBBBB(bodyDeclaration, feature, umlClass,
								c2c, classDec, bd2ne);
				if (result5_black != null) {

					Object[] result6_black = OperationInInterfaceImpl
							.pattern_OperationInInterface_29_6_perform_blackBBBBBBB(bodyDeclaration, feature, umlClass,
									c2c, classDec, bd2ne, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[bodyDeclaration] = "
								+ bodyDeclaration + ", " + "[feature] = " + feature + ", " + "[umlClass] = " + umlClass
								+ ", " + "[c2c] = " + c2c + ", " + "[classDec] = " + classDec + ", " + "[bd2ne] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			MAbstractMethodDefinition bodyDeclaration, Operation feature, Interface umlClass, ASTNode2Element c2c,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_OPERATION_INTERFACE_ASTNODE2ELEMENT_INTERFACEDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_OPERATION_INTERFACE_ASTNODE2ELEMENT_INTERFACEDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_98__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_98((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_101__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_OPERATION_INTERFACE_ASTNODE2ELEMENT_INTERFACEDECLARATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpC2c instanceof ASTNode2Element) {
						...
						if (tmpClassDec instanceof InterfaceDeclaration) {
							...
							if (tmpBd2ne instanceof ASTNode2Element) {
								...
								return new Object[] { bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne,
										isApplicableMatch };
							}
						}
					}
		...
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInInterface_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInInterface_1_1_performtransformation_binding != null) {
			...
			Operation feature = (Operation) result_pattern_OperationInInterface_1_1_performtransformation_binding[1];
			Interface umlClass = (Interface) result_pattern_OperationInInterface_1_1_performtransformation_binding[2];
			...
			Object[] result_pattern_OperationInInterface_1_1_performtransformation_black = pattern_OperationInInterface_1_1_performtransformation_blackBBBBBBFBB(
					bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInInterface_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject feature, EObject umlClass, EObject c2c,
	...
	public static final void pattern_OperationInInterface_1_5_registerobjects_expressionBBBBBBBB(
			OperationInInterface _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject feature,
			EObject umlClass, EObject c2c, EObject classDec, EObject bd2ne) {
		_this.registerObjects_FWD(ruleresult, bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne);
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne, match });
						}
					...
					if (umlClass.equals(c2c.getTarget())) {
						if (bodyDeclaration.equals(bd2ne.getSource())) {
							if (feature.equals(bd2ne.getTarget())) {
								_result.add(new Object[] { bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInInterface_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne, isApplicableMatch,
	...
	public static final Object[] pattern_OperationInInterface_2_4_solveCSP_bindingFBBBBBBBB(OperationInInterface _this,
			IsApplicableMatch isApplicableMatch, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			Interface umlClass, ASTNode2Element c2c, InterfaceDeclaration classDec, ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, bodyDeclaration, feature, umlClass,
				c2c, classDec, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, feature, umlClass, c2c, classDec,
					bd2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_OperationInInterface_2_4_solveCSP_binding = pattern_OperationInInterface_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne);
	...
	public static final Object[] pattern_OperationInInterface_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInInterface_11_1_performtransformation_binding != null) {
			...
			Operation feature = (Operation) result_pattern_OperationInInterface_11_1_performtransformation_binding[1];
			Interface umlClass = (Interface) result_pattern_OperationInInterface_11_1_performtransformation_binding[2];
	...
	public static final void pattern_OperationInInterface_11_5_registerobjects_expressionBBBBBBBB(
			OperationInInterface _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject feature,
			EObject umlClass, EObject c2c, EObject classDec, EObject bd2ne) {
		_this.registerObjects_BWD(ruleresult, bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne);
	...
	public static final Iterable<Object[]> pattern_OperationInInterface_12_2_corematch_blackFBBFFFB(Operation feature,
	...
	public static final Object[] pattern_OperationInInterface_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		bd2ne__feature____target.setName(bd2ne__feature____target_name_prime);
		return new Object[] { bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne, isApplicableMatch,
				c2c__classDec____source, c2c__umlClass____target, umlClass__feature____ownedOperation,
				feature__umlClass____interface, bd2ne__bodyDeclaration____source, bd2ne__feature____target };
	}

	public static final Object[] pattern_OperationInInterface_12_4_solveCSP_bindingFBBBBBBBB(OperationInInterface _this,
			IsApplicableMatch isApplicableMatch, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			Interface umlClass, ASTNode2Element c2c, InterfaceDeclaration classDec, ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, bodyDeclaration, feature, umlClass,
				c2c, classDec, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, feature, umlClass, c2c, classDec,
	...
	public static final Iterable<Object[]> pattern_OperationInInterface_24_5_matchcorrcontext_blackBBBFBFBB(
			MAbstractMethodDefinition bodyDeclaration, Operation feature, Interface umlClass,
			InterfaceDeclaration classDec, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInInterface_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, bodyDeclaration, feature, umlClass,
				c2c, classDec, bd2ne, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, feature, umlClass, c2c, classDec,
	...
	public static final Object[] pattern_OperationInInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInInterface_29_3_solveCSP_binding = pattern_OperationInInterface_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne, ruleResult);
	...
	public static final Object[] pattern_OperationInInterface_29_6_perform_blackBBBBBBB(
		...
		if (!bd2ne.equals(c2c)) {
			return new Object[] { bodyDeclaration, feature, umlClass, c2c, classDec, bd2ne, ruleResult };
		}
		return null;
	}
