...
public class OperationInInterfaceImpl extends AbstractRuleImpl implements OperationInInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		OperationInInterfaceImpl.pattern_OperationInInterface_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
				.pattern_OperationInInterface_2_2_corematch_blackFBBFFFB(classDec, bodyDeclaration, match)) {
			...
			for (Object[] result3_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_2_3_findcontext_blackBBBBBB(c2c, classDec, bodyDeclaration, feature,
							bd2ne, umlClass)) {
				Object[] result3_green = OperationInInterfaceImpl
						.pattern_OperationInInterface_2_3_findcontext_greenBBBBBBFFFFFFF(c2c, classDec, bodyDeclaration,
								feature, bd2ne, umlClass);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject c2c, EObject classDec,
			EObject bodyDeclaration, EObject feature, EObject bd2ne, EObject umlClass) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInInterfaceImpl
				.pattern_OperationInInterface_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, c2c, classDec,
						bodyDeclaration, feature, bd2ne, umlClass);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c2c] = " + c2c + ", " + "[classDec] = " + classDec + ", " + "[bodyDeclaration] = "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
				.pattern_OperationInInterface_12_2_corematch_blackFFFBFBB(feature, umlClass, match)) {
			ASTNode2Element c2c = (ASTNode2Element) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_12_3_findcontext_blackBBBBBB(c2c, classDec, bodyDeclaration, feature,
							bd2ne, umlClass)) {
				Object[] result3_green = OperationInInterfaceImpl
						.pattern_OperationInInterface_12_3_findcontext_greenBBBBBBFFFFFFF(c2c, classDec,
								bodyDeclaration, feature, bd2ne, umlClass);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge c2c__classDec____source = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge bd2ne__bodyDeclaration____source = (EMoflonEdge) result3_green[8];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject c2c, EObject classDec,
			EObject bodyDeclaration, EObject feature, EObject bd2ne, EObject umlClass) {
		ruleresult.registerObject("c2c", c2c);
		ruleresult.registerObject("classDec", classDec);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_123(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInInterfaceImpl.pattern_OperationInInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInInterfaceImpl
					.pattern_OperationInInterface_24_5_matchcorrcontext_blackFBBBFBBB(classDec, bodyDeclaration,
							feature, umlClass, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : OperationInInterfaceImpl
			...
			Object[] result3_bindingAndBlack = OperationInInterfaceImpl
					.pattern_OperationInInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, c2c,
							classDec, bodyDeclaration, feature, bd2ne, umlClass, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[c2c] = " + c2c + ", "
						+ "[classDec] = " + classDec + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
			...
			if (OperationInInterfaceImpl.pattern_OperationInInterface_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = OperationInInterfaceImpl
						.pattern_OperationInInterface_29_5_checknacs_blackBBBBBB(c2c, classDec, bodyDeclaration,
								feature, bd2ne, umlClass);
				if (result5_black != null) {

					Object[] result6_black = OperationInInterfaceImpl
							.pattern_OperationInInterface_29_6_perform_blackBBBBBBB(c2c, classDec, bodyDeclaration,
									feature, bd2ne, umlClass, ruleResult);
					if (result6_black == null) {
					...
					OperationInInterfaceImpl.pattern_OperationInInterface_29_6_perform_greenBBBBB(classDec,
							bodyDeclaration, feature, umlClass, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_INTERFACEDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_ASTNODE2ELEMENT_INTERFACE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(Operation) arguments.get(4), (ASTNode2Element) arguments.get(5), (Interface) arguments.get(6));
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_INTERFACEDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_ASTNODE2ELEMENT_INTERFACE:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_123__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_123((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_131__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__INTERFACEDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_INTERFACE_MATCH_MATCH:
		...
		case RulesPackage.OPERATION_IN_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_INTERFACEDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_ASTNODE2ELEMENT_INTERFACE_MODELGENERATORRULERESULT:
					...
					if (tmpFeature instanceof Operation) {
						...
						if (tmpBd2ne instanceof ASTNode2Element) {
							...
							if (tmpUmlClass instanceof Interface) {
								...
								return new Object[] { c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInInterface_1_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element c2c, InterfaceDeclaration classDec, MAbstractMethodDefinition bodyDeclaration,
			Operation feature, ASTNode2Element bd2ne, Interface umlClass, OperationInInterface _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInInterface_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInInterface_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInInterface_1_1_performtransformation_black = pattern_OperationInInterface_1_1_performtransformation_blackBBBBBBFBB(
					c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInInterface_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject c2c, EObject classDec, EObject bodyDeclaration, EObject feature,
	...
	public static final Object[] pattern_OperationInInterface_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject classDec, EObject bodyDeclaration, EObject feature,
			EObject umlClass) {
		...
		bodyDeclaration__classDec____abstractTypeDeclaration
				.setName(bodyDeclaration__classDec____abstractTypeDeclaration_name_prime);
		return new Object[] { ruleresult, classDec, bodyDeclaration, feature, umlClass,
	...
	public static final void pattern_OperationInInterface_1_5_registerobjects_expressionBBBBBBBB(
			OperationInInterface _this, PerformRuleResult ruleresult, EObject c2c, EObject classDec,
			EObject bodyDeclaration, EObject feature, EObject bd2ne, EObject umlClass) {
		_this.registerObjects_FWD(ruleresult, c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass);
	...
	public static final Iterable<Object[]> pattern_OperationInInterface_2_2_corematch_blackFBBFFFB(
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass, match });
						}
					...
					if (umlClass.equals(c2c.getTarget())) {
						if (classDec.getBodyDeclarations().contains(bodyDeclaration)) {
							if (feature.equals(bd2ne.getTarget())) {
								_result.add(new Object[] { c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInInterface_2_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element c2c,
		...
		return new Object[] { c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass, isApplicableMatch,
	...
	public static final Object[] pattern_OperationInInterface_2_4_solveCSP_bindingFBBBBBBBB(OperationInInterface _this,
			IsApplicableMatch isApplicableMatch, ASTNode2Element c2c, InterfaceDeclaration classDec,
			MAbstractMethodDefinition bodyDeclaration, Operation feature, ASTNode2Element bd2ne, Interface umlClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, c2c, classDec, bodyDeclaration,
				feature, bd2ne, umlClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2c, classDec, bodyDeclaration, feature, bd2ne,
					umlClass };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			OperationInInterface _this, IsApplicableMatch isApplicableMatch, ASTNode2Element c2c,
			InterfaceDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			ASTNode2Element bd2ne, Interface umlClass) {
		Object[] result_pattern_OperationInInterface_2_4_solveCSP_binding = pattern_OperationInInterface_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass);
	...
	public static final void pattern_OperationInInterface_11_5_registerobjects_expressionBBBBBBBB(
			OperationInInterface _this, PerformRuleResult ruleresult, EObject c2c, EObject classDec,
			EObject bodyDeclaration, EObject feature, EObject bd2ne, EObject umlClass) {
		_this.registerObjects_BWD(ruleresult, c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass);
	...
	public static final Iterable<Object[]> pattern_OperationInInterface_12_2_corematch_blackFFFBFBB(Operation feature,
	...
	public static final Iterable<Object[]> pattern_OperationInInterface_12_3_findcontext_blackBBBBBB(
			ASTNode2Element c2c, InterfaceDeclaration classDec, MAbstractMethodDefinition bodyDeclaration,
			Operation feature, ASTNode2Element bd2ne, Interface umlClass) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
			if (classDec.equals(c2c.getSource())) {
				if (bodyDeclaration.equals(bd2ne.getSource())) {
	...
	public static final Object[] pattern_OperationInInterface_12_4_solveCSP_bindingFBBBBBBBB(OperationInInterface _this,
			IsApplicableMatch isApplicableMatch, ASTNode2Element c2c, InterfaceDeclaration classDec,
			MAbstractMethodDefinition bodyDeclaration, Operation feature, ASTNode2Element bd2ne, Interface umlClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, c2c, classDec, bodyDeclaration,
				feature, bd2ne, umlClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2c, classDec, bodyDeclaration, feature, bd2ne,
		...
		if (tmpClassDec instanceof InterfaceDeclaration) {
			...
			if (tmpBodyDeclaration instanceof MAbstractMethodDefinition) {
				...
				if (tmpFeature instanceof Operation) {
					...
					if (tmpUmlClass instanceof Interface) {
						Interface umlClass = (Interface) tmpUmlClass;
						return new Object[] { classDec, bodyDeclaration, feature, umlClass, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_OperationInInterface_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_OperationInInterface_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_OperationInInterface_24_2_matchsrctrgcontext_black = pattern_OperationInInterface_24_2_matchsrctrgcontext_blackBBBBBB(
					classDec, bodyDeclaration, feature, umlClass, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_OperationInInterface_24_3_solvecsp_bindingFBBBBBBB(OperationInInterface _this,
			InterfaceDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			Interface umlClass, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(classDec, bodyDeclaration, feature, umlClass, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, classDec, bodyDeclaration, feature, umlClass, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInInterface_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_OperationInInterface_24_3_solvecsp_binding = pattern_OperationInInterface_24_3_solvecsp_bindingFBBBBBBB(
				_this, classDec, bodyDeclaration, feature, umlClass, sourceMatch, targetMatch);
		if (result_pattern_OperationInInterface_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_OperationInInterface_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, classDec, bodyDeclaration, feature, umlClass, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_OperationInInterface_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { classDec, bodyDeclaration, feature, umlClass, ccMatch };
	}
	...
	public static final Object[] pattern_OperationInInterface_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, c2c, classDec, bodyDeclaration,
				feature, bd2ne, umlClass, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2c, classDec, bodyDeclaration, feature, bd2ne,
	...
	public static final Object[] pattern_OperationInInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInInterface_29_3_solveCSP_binding = pattern_OperationInInterface_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass, ruleResult);
	...
	public static final Object[] pattern_OperationInInterface_29_6_perform_blackBBBBBBB(ASTNode2Element c2c,
			...
			ASTNode2Element bd2ne, Interface umlClass, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { c2c, classDec, bodyDeclaration, feature, bd2ne, umlClass, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInInterface_29_6_perform_greenBBBBB(InterfaceDeclaration classDec,
		...
		return new Object[] { classDec, bodyDeclaration, feature, umlClass, ruleResult };
	}
