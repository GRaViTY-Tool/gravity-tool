...
public class TypeAccess2InterfaceRealizationImpl extends AbstractRuleImpl implements TypeAccess2InterfaceRealization {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_greenBBBFF(typeAcc, superInterface,
						umlClass);
		...
		Object[] result3_black = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, typeAcc,
						superInterface, umlClass, cd2c2, classDec, ta2g, superInterfaceDec, interfaceRealization, cd2c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[typeAcc] = " + typeAcc + ", " + "[superInterface] = " + superInterface + ", "
					+ "[umlClass] = " + umlClass + ", " + "[cd2c2] = " + cd2c2 + ", " + "[classDec] = " + classDec
					+ ", " + "[ta2g] = " + ta2g + ", " + "[superInterfaceDec] = " + superInterfaceDec + ", "
		...
		TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(ruleresult,
						typeAcc, superInterface, umlClass, classDec, ta2g, superInterfaceDec, interfaceRealization);
		...
		TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						typeAcc, superInterface, umlClass, cd2c2, classDec, ta2g, superInterfaceDec,
						interfaceRealization, cd2c);
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
			...
			for (Object[] result3_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_2_3_findcontext_blackBBBBBBB(typeAcc, superInterface,
							umlClass, cd2c2, classDec, superInterfaceDec, cd2c)) {
				Object[] result3_green = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_2_3_findcontext_greenBBBBBBBFFFFFFFF(typeAcc,
								superInterface, umlClass, cd2c2, classDec, superInterfaceDec, cd2c);
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, typeAcc, superInterface, umlClass, cd2c2, classDec,
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[cd2c2] = " + cd2c2 + ", " + "[classDec] = " + classDec + ", " + "[superInterfaceDec] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeAccess typeAcc,
			Interface superInterface, BehavioredClassifier umlClass, ASTNode2Element cd2c2, ClassDeclaration classDec,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject typeAcc, EObject superInterface,
			EObject umlClass, EObject cd2c2, EObject classDec, EObject ta2g, EObject superInterfaceDec,
			EObject interfaceRealization, EObject cd2c) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_12_2_corematch_blackBBFFFBFB(superInterface, umlClass,
			...
			// ForEach 
			for (Object[] result3_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_12_3_findcontext_blackBBBBBBB(superInterface, umlClass,
							cd2c2, classDec, superInterfaceDec, interfaceRealization, cd2c)) {
				Object[] result3_green = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_12_3_findcontext_greenBBBBBBBFFFFFFFF(superInterface,
								umlClass, cd2c2, classDec, superInterfaceDec, interfaceRealization, cd2c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge umlClass__interfaceRealization____interfaceRealization = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge interfaceRealization__umlClass____implementingClassifier = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge cd2c2__superInterface____target = (EMoflonEdge) result3_green[10];
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, superInterface, umlClass, cd2c2, classDec, superInterfaceDec,
								interfaceRealization, cd2c);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[superInterface] = "
							+ superInterface + ", " + "[umlClass] = " + umlClass + ", " + "[cd2c2] = " + cd2c2 + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Interface superInterface,
			BehavioredClassifier umlClass, ASTNode2Element cd2c2, ClassDeclaration classDec,
			InterfaceDeclaration superInterfaceDec, InterfaceRealization interfaceRealization, ASTNode2Element cd2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_115(EMoflonEdge _edge_interfaceRealization) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, typeAcc,
						superInterface, umlClass, classDec, superInterfaceDec, interfaceRealization, sourceMatch,
						targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[typeAcc] = " + typeAcc + ", " + "[superInterface] = " + superInterface + ", " + "[umlClass] = "
					+ umlClass + ", " + "[classDec] = " + classDec + ", " + "[superInterfaceDec] = " + superInterfaceDec
					+ ", " + "[interfaceRealization] = " + interfaceRealization + ", " + "[sourceMatch] = "
		...
		if (TypeAccess2InterfaceRealizationImpl
			...
			for (Object[] result5_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_24_5_matchcorrcontext_blackBBFBBFBB(superInterface,
							umlClass, classDec, superInterfaceDec, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_24_6_createcorrespondence_blackBBBBBBB(typeAcc,
								superInterface, umlClass, classDec, superInterfaceDec, interfaceRealization, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[typeAcc] = " + typeAcc
							+ ", " + "[superInterface] = " + superInterface + ", " + "[umlClass] = " + umlClass + ", "
							+ "[classDec] = " + classDec + ", " + "[superInterfaceDec] = " + superInterfaceDec + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess typeAcc, Interface superInterface, BehavioredClassifier umlClass,
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
			...
			Object[] result3_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, superInterface, umlClass, cd2c2, classDec, superInterfaceDec, cd2c,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[superInterface] = " + superInterface
						+ ", " + "[umlClass] = " + umlClass + ", " + "[cd2c2] = " + cd2c2 + ", " + "[classDec] = "
						+ classDec + ", " + "[superInterfaceDec] = " + superInterfaceDec + ", " + "[cd2c] = " + cd2c
			...
			if (TypeAccess2InterfaceRealizationImpl
				...
				// 
				Object[] result5_black = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_29_5_checknacs_blackBBBBBB(superInterface, umlClass,
								cd2c2, classDec, superInterfaceDec, cd2c);
				if (result5_black != null) {

					Object[] result6_black = TypeAccess2InterfaceRealizationImpl
							.pattern_TypeAccess2InterfaceRealization_29_6_perform_blackBBBBBBB(superInterface, umlClass,
									cd2c2, classDec, superInterfaceDec, cd2c, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[superInterface] = "
								+ superInterface + ", " + "[umlClass] = " + umlClass + ", " + "[cd2c2] = " + cd2c2
								+ ", " + "[classDec] = " + classDec + ", " + "[superInterfaceDec] = "
								+ superInterfaceDec + ", " + "[cd2c] = " + cd2c + ", " + "[ruleResult] = " + ruleResult
								+ ".");
					}
					TypeAccess2InterfaceRealizationImpl
							.pattern_TypeAccess2InterfaceRealization_29_6_perform_greenFBBBFBFB(superInterface,
									umlClass, classDec, superInterfaceDec, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEACCESS_INTERFACE_BEHAVIOREDCLASSIFIER_ASTNODE2ELEMENT_CLASSDECLARATION_INTERFACEDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACE_BEHAVIOREDCLASSIFIER_ASTNODE2ELEMENT_CLASSDECLARATION_INTERFACEDECLARATION_INTERFACEREALIZATION_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Interface) arguments.get(1),
					...
					(InterfaceRealization) arguments.get(6), (ASTNode2Element) arguments.get(7));
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_115__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_115((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_122__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_INTERFACE_BEHAVIOREDCLASSIFIER_CLASSDECLARATION_INTERFACEDECLARATION_INTERFACEREALIZATION_MATCH_MATCH:
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACE_BEHAVIOREDCLASSIFIER_ASTNODE2ELEMENT_CLASSDECLARATION_INTERFACEDECLARATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
						...
						if (tmpClassDec instanceof ClassDeclaration) {
							...
							if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
								...
								if (tmpCd2c instanceof ASTNode2Element) {
									...
									return new Object[] { typeAcc, superInterface, umlClass, cd2c2, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_blackBBBBBBBFBB(
			TypeAccess typeAcc, Interface superInterface, BehavioredClassifier umlClass, ASTNode2Element cd2c2,
			ClassDeclaration classDec, InterfaceDeclaration superInterfaceDec, ASTNode2Element cd2c,
			TypeAccess2InterfaceRealization _this, IsApplicableMatch isApplicableMatch) {
		if (!cd2c.equals(cd2c2)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { typeAcc, superInterface, umlClass, cd2c2, classDec, superInterfaceDec, cd2c,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_black = pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_blackBBBBBBBFBB(
					typeAcc, superInterface, umlClass, cd2c2, classDec, superInterfaceDec, cd2c, _this,
					isApplicableMatch);
			if (result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_black != null) {
				...
				return new Object[] { typeAcc, superInterface, umlClass, cd2c2, classDec, superInterfaceDec, cd2c, csp,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_greenBBBFF(
		...
		return new Object[] { typeAcc, superInterface, umlClass, ta2g, interfaceRealization };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject typeAcc, EObject superInterface, EObject umlClass, EObject cd2c2,
			EObject classDec, EObject ta2g, EObject superInterfaceDec, EObject interfaceRealization, EObject cd2c) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject typeAcc, EObject superInterface, EObject umlClass, EObject classDec,
			EObject ta2g, EObject superInterfaceDec, EObject interfaceRealization) {
		...
		return new Object[] { ruleresult, typeAcc, superInterface, umlClass, classDec, ta2g, superInterfaceDec,
				interfaceRealization, umlClass__interfaceRealization____interfaceRealization,
	...
	public static final void pattern_TypeAccess2InterfaceRealization_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject superInterface, EObject umlClass, EObject cd2c2, EObject classDec, EObject ta2g,
			EObject superInterfaceDec, EObject interfaceRealization, EObject cd2c) {
		_this.registerObjects_FWD(ruleresult, typeAcc, superInterface, umlClass, cd2c2, classDec, ta2g,
				superInterfaceDec, interfaceRealization, cd2c);
			...
			if (tmpSuperInterface instanceof Interface) {
				...
				for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!cd2c.equals(cd2c2)) {
						...
						if (tmpUmlClass instanceof BehavioredClassifier) {
							BehavioredClassifier umlClass = (BehavioredClassifier) tmpUmlClass;
							_result.add(new Object[] { typeAcc, superInterface, umlClass, cd2c2, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, typeAcc, superInterface, umlClass,
				cd2c2, classDec, superInterfaceDec, cd2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, typeAcc, superInterface, umlClass, cd2c2, classDec,
					superInterfaceDec, cd2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, typeAcc, superInterface, umlClass, cd2c2, classDec, superInterfaceDec, cd2c);
					...
					if (tmpClassDec instanceof ClassDeclaration) {
						...
						if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
							...
							if (tmpInterfaceRealization instanceof InterfaceRealization) {
								...
								if (tmpCd2c instanceof ASTNode2Element) {
									ASTNode2Element cd2c = (ASTNode2Element) tmpCd2c;
									return new Object[] { superInterface, umlClass, cd2c2, classDec, superInterfaceDec,
											interfaceRealization, cd2c, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_blackBBBBBBBFBB(
			Interface superInterface, BehavioredClassifier umlClass, ASTNode2Element cd2c2, ClassDeclaration classDec,
			InterfaceDeclaration superInterfaceDec, InterfaceRealization interfaceRealization, ASTNode2Element cd2c,
			TypeAccess2InterfaceRealization _this, IsApplicableMatch isApplicableMatch) {
		if (!cd2c.equals(cd2c2)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { superInterface, umlClass, cd2c2, classDec, superInterfaceDec,
							interfaceRealization, cd2c, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_black = pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_blackBBBBBBBFBB(
					superInterface, umlClass, cd2c2, classDec, superInterfaceDec, interfaceRealization, cd2c, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_greenFBFBB(
		...
		ta2g.setSource(typeAcc);
		ta2g.setTarget(interfaceRealization);
		return new Object[] { typeAcc, classDec, ta2g, superInterfaceDec, interfaceRealization };
	}
	...
	public static final void pattern_TypeAccess2InterfaceRealization_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject superInterface, EObject umlClass, EObject cd2c2, EObject classDec, EObject ta2g,
			EObject superInterfaceDec, EObject interfaceRealization, EObject cd2c) {
		_this.registerObjects_BWD(ruleresult, typeAcc, superInterface, umlClass, cd2c2, classDec, ta2g,
				superInterfaceDec, interfaceRealization, cd2c);
	...
	public static final Iterable<Object[]> pattern_TypeAccess2InterfaceRealization_12_2_corematch_blackBBFFFBFB(
			...
			if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
				...
				for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(umlClass,
					...
					if (!cd2c.equals(cd2c2)) {
						...
						if (tmpClassDec instanceof ClassDeclaration) {
							ClassDeclaration classDec = (ClassDeclaration) tmpClassDec;
							_result.add(new Object[] { superInterface, umlClass, cd2c2, classDec, superInterfaceDec,
									interfaceRealization, cd2c, match });
						}
					...
					if (superInterfaceDec.equals(cd2c2.getSource())) {
						if (classDec.equals(cd2c.getSource())) {
							if (superInterface.equals(interfaceRealization.getContract())) {
								if (umlClass.equals(cd2c.getTarget())) {
									_result.add(new Object[] { superInterface, umlClass, cd2c2, classDec,
											superInterfaceDec, interfaceRealization, cd2c });
								}
							}
						}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		interfaceRealization__superInterface____contract
				.setName(interfaceRealization__superInterface____contract_name_prime);
		cd2c__umlClass____target.setName(cd2c__umlClass____target_name_prime);
		return new Object[] { superInterface, umlClass, cd2c2, classDec, superInterfaceDec, interfaceRealization, cd2c,
				...
				cd2c2__superInterfaceDec____source, cd2c__classDec____source,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			BehavioredClassifier umlClass, ASTNode2Element cd2c2, ClassDeclaration classDec,
			InterfaceDeclaration superInterfaceDec, InterfaceRealization interfaceRealization, ASTNode2Element cd2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, superInterface, umlClass, cd2c2,
				classDec, superInterfaceDec, interfaceRealization, cd2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, superInterface, umlClass, cd2c2, classDec,
					superInterfaceDec, interfaceRealization, cd2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, superInterface, umlClass, cd2c2, classDec, superInterfaceDec,
				interfaceRealization, cd2c);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		for (NamedElement __DEC_interfaceRealization_client_807310 : interfaceRealization.getClients()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_client_807310)) {
				if (!superInterface.equals(__DEC_interfaceRealization_client_807310)) {
					if (!umlClass.equals(__DEC_interfaceRealization_client_807310)) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_20_2_testcorematchandDECs_black_nac_1BBB(
			InterfaceRealization interfaceRealization, Interface superInterface, BehavioredClassifier umlClass) {
		for (NamedElement __DEC_interfaceRealization_supplier_730832 : interfaceRealization.getSuppliers()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_supplier_730832)) {
				if (!superInterface.equals(__DEC_interfaceRealization_supplier_730832)) {
					if (!umlClass.equals(__DEC_interfaceRealization_supplier_730832)) {
						return new Object[] { interfaceRealization, superInterface, umlClass };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_343742 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_692406 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_2BB(
		...
		for (ClassDeclaration __DEC_typeAcc_superClass_844869 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ClassDeclaration.class, "superClass")) {
			if (!classDec.equals(__DEC_typeAcc_superClass_844869)) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_646200 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_265479 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_671016 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_612418 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpUmlClass instanceof BehavioredClassifier) {
					...
					if (tmpClassDec instanceof ClassDeclaration) {
						...
						if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
							...
							if (tmpInterfaceRealization instanceof InterfaceRealization) {
								InterfaceRealization interfaceRealization = (InterfaceRealization) tmpInterfaceRealization;
								return new Object[] { typeAcc, superInterface, umlClass, classDec, superInterfaceDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { typeAcc, superInterface, umlClass, classDec, superInterfaceDec, interfaceRealization,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_black = pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_blackBBBBBBBB(
					typeAcc, superInterface, umlClass, classDec, superInterfaceDec, interfaceRealization, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingFBBBBBBBBB(
		...
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(typeAcc, superInterface, umlClass, classDec,
				superInterfaceDec, interfaceRealization, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, typeAcc, superInterface, umlClass, classDec, superInterfaceDec,
					interfaceRealization, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_binding = pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, typeAcc, superInterface, umlClass, classDec, superInterfaceDec, interfaceRealization,
				sourceMatch, targetMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_208004 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, Annotation.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_278968 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ArrayType.class, "elementType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess typeAcc, ClassDeclaration classDec) {
		for (ClassDeclaration __DEC_typeAcc_superClass_774093 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ClassDeclaration.class, "superClass")) {
			if (!classDec.equals(__DEC_typeAcc_superClass_774093)) {
				return new Object[] { typeAcc, classDec };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_461750 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, MethodDeclaration.class, "returnType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_645675 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ParameterizedType.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_913163 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, SingleVariableDeclaration.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_807150 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_28_1_matchtggpattern_black_nac_0BBB(
			InterfaceRealization interfaceRealization, Interface superInterface, BehavioredClassifier umlClass) {
		for (NamedElement __DEC_interfaceRealization_client_367975 : interfaceRealization.getClients()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_client_367975)) {
				if (!superInterface.equals(__DEC_interfaceRealization_client_367975)) {
					if (!umlClass.equals(__DEC_interfaceRealization_client_367975)) {
						return new Object[] { interfaceRealization, superInterface, umlClass };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_28_1_matchtggpattern_black_nac_1BBB(
			InterfaceRealization interfaceRealization, Interface superInterface, BehavioredClassifier umlClass) {
		for (NamedElement __DEC_interfaceRealization_supplier_182970 : interfaceRealization.getSuppliers()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_supplier_182970)) {
				if (!superInterface.equals(__DEC_interfaceRealization_supplier_182970)) {
					if (!umlClass.equals(__DEC_interfaceRealization_supplier_182970)) {
						return new Object[] { interfaceRealization, superInterface, umlClass };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, superInterface, umlClass, cd2c2,
				classDec, superInterfaceDec, cd2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, superInterface, umlClass, cd2c2, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, superInterface, umlClass, cd2c2, classDec, superInterfaceDec, cd2c,
				ruleResult);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_5_checknacs_blackBBBBBB(
			...
			InterfaceDeclaration superInterfaceDec, ASTNode2Element cd2c) {
		if (!cd2c.equals(cd2c2)) {
			return new Object[] { superInterface, umlClass, cd2c2, classDec, superInterfaceDec, cd2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_6_perform_blackBBBBBBB(
			...
			InterfaceDeclaration superInterfaceDec, ASTNode2Element cd2c, ModelgeneratorRuleResult ruleResult) {
		if (!cd2c.equals(cd2c2)) {
			return new Object[] { superInterface, umlClass, cd2c2, classDec, superInterfaceDec, cd2c, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_6_perform_greenFBBBFBFB(
		...
		return new Object[] { typeAcc, superInterface, umlClass, classDec, ta2g, superInterfaceDec,
