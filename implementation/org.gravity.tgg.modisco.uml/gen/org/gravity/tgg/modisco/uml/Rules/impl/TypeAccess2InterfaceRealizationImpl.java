...
public class TypeAccess2InterfaceRealizationImpl extends AbstractRuleImpl implements TypeAccess2InterfaceRealization {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_greenBBFBF(superInterface, typeAcc,
						umlClass);
		...
		Object[] result3_black = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, classDec,
						superInterface, typeAcc, cd2c2, ta2g, umlClass, cd2c, superInterfaceDec, interfaceRealization);
		...
		TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(ruleresult,
						classDec, superInterface, typeAcc, ta2g, umlClass, superInterfaceDec, interfaceRealization);
		...
		TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						classDec, superInterface, typeAcc, cd2c2, ta2g, umlClass, cd2c, superInterfaceDec,
						interfaceRealization);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_2_2_corematch_blackBFBFFFBB(classDec, typeAcc,
			...
			for (Object[] result3_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_2_3_findcontext_blackBBBBBBB(classDec, superInterface,
							typeAcc, cd2c2, umlClass, cd2c, superInterfaceDec)) {
				Object[] result3_green = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_2_3_findcontext_greenBBBBBBBFFFFFFFF(classDec,
								superInterface, typeAcc, cd2c2, umlClass, cd2c, superInterfaceDec);
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, classDec, superInterface, typeAcc, cd2c2, umlClass, cd2c,
								superInterfaceDec);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			Interface superInterface, TypeAccess typeAcc, ASTNode2Element cd2c2, BehavioredClassifier umlClass,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject classDec, EObject superInterface,
			EObject typeAcc, EObject cd2c2, EObject ta2g, EObject umlClass, EObject cd2c, EObject superInterfaceDec,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_greenBFFBB(classDec,
		...
		Object[] result3_black = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, classDec,
						superInterface, typeAcc, cd2c2, ta2g, umlClass, cd2c, superInterfaceDec, interfaceRealization);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[classDec] = " + classDec + ", " + "[superInterface] = " + superInterface + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_12_2_corematch_blackFBFBFFBB(superInterface, umlClass,
			...
			// ForEach 
			for (Object[] result3_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_12_3_findcontext_blackBBBBBBB(classDec, superInterface,
							cd2c2, umlClass, cd2c, superInterfaceDec, interfaceRealization)) {
				Object[] result3_green = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_12_3_findcontext_greenBBBBBBBFFFFFFFF(classDec,
								superInterface, cd2c2, umlClass, cd2c, superInterfaceDec, interfaceRealization);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, classDec, superInterface, cd2c2, umlClass, cd2c, superInterfaceDec,
								interfaceRealization);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ClassDeclaration classDec,
			Interface superInterface, ASTNode2Element cd2c2, BehavioredClassifier umlClass, ASTNode2Element cd2c,
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, classDec,
						superInterface, typeAcc, umlClass, superInterfaceDec, interfaceRealization, sourceMatch,
						targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[classDec] = " + classDec + ", " + "[superInterface] = " + superInterface + ", " + "[typeAcc] = "
					+ typeAcc + ", " + "[umlClass] = " + umlClass + ", " + "[superInterfaceDec] = " + superInterfaceDec
		...
		if (TypeAccess2InterfaceRealizationImpl
			...
			for (Object[] result5_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_24_5_matchcorrcontext_blackBBFBFBBB(classDec,
				...
				Object[] result6_black = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_24_6_createcorrespondence_blackBBBBBBB(classDec,
								superInterface, typeAcc, umlClass, superInterfaceDec, interfaceRealization, ccMatch);
				if (result6_black == null) {
	...
	public CSP isApplicable_solveCsp_CC(ClassDeclaration classDec, Interface superInterface, TypeAccess typeAcc,
			BehavioredClassifier umlClass, InterfaceDeclaration superInterfaceDec,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, ASTNode2Element cd2cParameter,
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
						+ "[superInterface] = " + superInterface + ", " + "[cd2c2] = " + cd2c2 + ", " + "[umlClass] = "
			...
			if (TypeAccess2InterfaceRealizationImpl
				...
				// 
				Object[] result5_black = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_29_5_checknacs_blackBBBBBB(classDec, superInterface,
								cd2c2, umlClass, cd2c, superInterfaceDec);
				if (result5_black != null) {

					Object[] result6_black = TypeAccess2InterfaceRealizationImpl
							.pattern_TypeAccess2InterfaceRealization_29_6_perform_blackBBBBBBB(classDec, superInterface,
									cd2c2, umlClass, cd2c, superInterfaceDec, ruleResult);
					if (result6_black == null) {
					...
					TypeAccess2InterfaceRealizationImpl
							.pattern_TypeAccess2InterfaceRealization_29_6_perform_greenBBFFBBFB(classDec,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSDECLARATION_INTERFACE_TYPEACCESS_ASTNODE2ELEMENT_BEHAVIOREDCLASSIFIER_ASTNODE2ELEMENT_INTERFACEDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(Interface) arguments.get(2), (TypeAccess) arguments.get(3), (ASTNode2Element) arguments.get(4),
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_INTERFACE_ASTNODE2ELEMENT_BEHAVIOREDCLASSIFIER_ASTNODE2ELEMENT_INTERFACEDECLARATION_INTERFACEREALIZATION:
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_121__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_CC__CLASSDECLARATION_INTERFACE_TYPEACCESS_BEHAVIOREDCLASSIFIER_INTERFACEDECLARATION_INTERFACEREALIZATION_MATCH_MATCH:
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATION_INTERFACE_ASTNODE2ELEMENT_BEHAVIOREDCLASSIFIER_ASTNODE2ELEMENT_INTERFACEDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpUmlClass instanceof BehavioredClassifier) {
							...
							if (tmpCd2c instanceof ASTNode2Element) {
								...
								if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
									...
									return new Object[] { classDec, superInterface, typeAcc, cd2c2, umlClass, cd2c,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_blackBBBBBBBFBB(
			ClassDeclaration classDec, Interface superInterface, TypeAccess typeAcc, ASTNode2Element cd2c2,
		...
		if (!cd2c.equals(cd2c2)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { classDec, superInterface, typeAcc, cd2c2, umlClass, cd2c, superInterfaceDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_black = pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_blackBBBBBBBFBB(
					classDec, superInterface, typeAcc, cd2c2, umlClass, cd2c, superInterfaceDec, _this,
					isApplicableMatch);
			if (result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_black != null) {
				...
				return new Object[] { classDec, superInterface, typeAcc, cd2c2, umlClass, cd2c, superInterfaceDec, csp,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_greenBBFBF(
		...
		return new Object[] { superInterface, typeAcc, ta2g, umlClass, interfaceRealization };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject classDec, EObject superInterface, EObject typeAcc, EObject cd2c2,
			EObject ta2g, EObject umlClass, EObject cd2c, EObject superInterfaceDec, EObject interfaceRealization) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject classDec, EObject superInterface, EObject typeAcc, EObject ta2g,
			EObject umlClass, EObject superInterfaceDec, EObject interfaceRealization) {
		EMoflonEdge typeAcc__superInterfaceDec____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge superInterfaceDec__typeAcc____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge classDec__typeAcc____superInterfaces = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, classDec, superInterface, typeAcc, ta2g, umlClass, superInterfaceDec,
				interfaceRealization, typeAcc__superInterfaceDec____type,
				superInterfaceDec__typeAcc____usagesInTypeAccess, classDec__typeAcc____superInterfaces,
				ta2g__typeAcc____source, umlClass__interfaceRealization____interfaceRealization,
	...
	public static final void pattern_TypeAccess2InterfaceRealization_1_5_registerobjects_expressionBBBBBBBBBBB(
			TypeAccess2InterfaceRealization _this, PerformRuleResult ruleresult, EObject classDec,
			EObject superInterface, EObject typeAcc, EObject cd2c2, EObject ta2g, EObject umlClass, EObject cd2c,
			EObject superInterfaceDec, EObject interfaceRealization) {
		_this.registerObjects_FWD(ruleresult, classDec, superInterface, typeAcc, cd2c2, ta2g, umlClass, cd2c,
				superInterfaceDec, interfaceRealization);
			...
			if (tmpUmlClass instanceof BehavioredClassifier) {
				...
				for (ASTNode2Element cd2c2 : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!cd2c.equals(cd2c2)) {
						...
						if (tmpSuperInterface instanceof Interface) {
							Interface superInterface = (Interface) tmpSuperInterface;
							_result.add(new Object[] { classDec, superInterface, typeAcc, cd2c2, umlClass, cd2c,
									superInterfaceDec, match });
						}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { classDec, superInterface, typeAcc, cd2c2, umlClass, cd2c, superInterfaceDec,
				...
				classDec__typeAcc____superInterfaces, cd2c__classDec____source, cd2c2__superInterface____target,
				cd2c__umlClass____target, cd2c2__superInterfaceDec____source };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, classDec, superInterface, typeAcc,
				cd2c2, umlClass, cd2c, superInterfaceDec);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, superInterface, typeAcc, cd2c2, umlClass,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, superInterface, typeAcc, cd2c2, umlClass, cd2c, superInterfaceDec);
						...
						if (tmpCd2c instanceof ASTNode2Element) {
							...
							if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
								...
								if (tmpInterfaceRealization instanceof InterfaceRealization) {
									...
									return new Object[] { classDec, superInterface, cd2c2, umlClass, cd2c,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_blackBBBBBBBFBB(
			ClassDeclaration classDec, Interface superInterface, ASTNode2Element cd2c2, BehavioredClassifier umlClass,
			ASTNode2Element cd2c, InterfaceDeclaration superInterfaceDec, InterfaceRealization interfaceRealization,
			TypeAccess2InterfaceRealization _this, IsApplicableMatch isApplicableMatch) {
		if (!cd2c.equals(cd2c2)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { classDec, superInterface, cd2c2, umlClass, cd2c, superInterfaceDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_binding != null) {
			...
			Interface superInterface = (Interface) result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_binding[1];
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_black = pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_blackBBBBBBBFBB(
					classDec, superInterface, cd2c2, umlClass, cd2c, superInterfaceDec, interfaceRealization, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_greenBFFBB(
		...
		ta2g.setSource(typeAcc);
		ta2g.setTarget(interfaceRealization);
		return new Object[] { classDec, typeAcc, ta2g, superInterfaceDec, interfaceRealization };
	}
	...
	public static final void pattern_TypeAccess2InterfaceRealization_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject superInterface, EObject typeAcc, EObject cd2c2, EObject ta2g, EObject umlClass, EObject cd2c,
			EObject superInterfaceDec, EObject interfaceRealization) {
		_this.registerObjects_BWD(ruleresult, classDec, superInterface, typeAcc, cd2c2, ta2g, umlClass, cd2c,
				superInterfaceDec, interfaceRealization);
	...
	public static final Iterable<Object[]> pattern_TypeAccess2InterfaceRealization_12_2_corematch_blackFBFBFFBB(
			...
			if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
				...
				for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(umlClass,
					...
					if (!cd2c.equals(cd2c2)) {
						...
						if (tmpClassDec instanceof ClassDeclaration) {
							ClassDeclaration classDec = (ClassDeclaration) tmpClassDec;
							_result.add(new Object[] { classDec, superInterface, cd2c2, umlClass, cd2c,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		interfaceRealization__superInterface____contract
				.setName(interfaceRealization__superInterface____contract_name_prime);
		return new Object[] { classDec, superInterface, cd2c2, umlClass, cd2c, superInterfaceDec, interfaceRealization,
				...
				cd2c2__superInterface____target, cd2c__umlClass____target, cd2c2__superInterfaceDec____source,
				interfaceRealization__superInterface____contract };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, classDec, superInterface, cd2c2,
				umlClass, cd2c, superInterfaceDec, interfaceRealization);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, superInterface, cd2c2, umlClass, cd2c,
					superInterfaceDec, interfaceRealization };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, superInterface, cd2c2, umlClass, cd2c, superInterfaceDec,
				interfaceRealization);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		for (NamedElement __DEC_interfaceRealization_client_614241 : interfaceRealization.getClients()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_client_614241)) {
				if (!superInterface.equals(__DEC_interfaceRealization_client_614241)) {
					if (!umlClass.equals(__DEC_interfaceRealization_client_614241)) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_20_2_testcorematchandDECs_black_nac_1BBB(
			InterfaceRealization interfaceRealization, Interface superInterface, BehavioredClassifier umlClass) {
		for (NamedElement __DEC_interfaceRealization_supplier_758895 : interfaceRealization.getSuppliers()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_supplier_758895)) {
				if (!superInterface.equals(__DEC_interfaceRealization_supplier_758895)) {
					if (!umlClass.equals(__DEC_interfaceRealization_supplier_758895)) {
						return new Object[] { interfaceRealization, superInterface, umlClass };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_304205 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_897209 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_2BB(
		...
		for (ClassDeclaration __DEC_typeAcc_superClass_224601 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ClassDeclaration.class, "superClass")) {
			if (!classDec.equals(__DEC_typeAcc_superClass_224601)) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_195340 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_915583 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_614301 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_415442 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpTypeAcc instanceof TypeAccess) {
					...
					if (tmpUmlClass instanceof BehavioredClassifier) {
						...
						if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
							...
							if (tmpInterfaceRealization instanceof InterfaceRealization) {
								InterfaceRealization interfaceRealization = (InterfaceRealization) tmpInterfaceRealization;
								return new Object[] { classDec, superInterface, typeAcc, umlClass, superInterfaceDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { classDec, superInterface, typeAcc, umlClass, superInterfaceDec, interfaceRealization,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_black = pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_blackBBBBBBBB(
					classDec, superInterface, typeAcc, umlClass, superInterfaceDec, interfaceRealization, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingFBBBBBBBBB(
			...
			TypeAccess typeAcc, BehavioredClassifier umlClass, InterfaceDeclaration superInterfaceDec,
		...
		if (csp != null) {
			return new Object[] { csp, _this, classDec, superInterface, typeAcc, umlClass, superInterfaceDec,
					interfaceRealization, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_binding = pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, classDec, superInterface, typeAcc, umlClass, superInterfaceDec, interfaceRealization,
				sourceMatch, targetMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_260500 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, Annotation.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_71004 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ArrayType.class, "elementType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess typeAcc, ClassDeclaration classDec) {
		for (ClassDeclaration __DEC_typeAcc_superClass_627824 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ClassDeclaration.class, "superClass")) {
			if (!classDec.equals(__DEC_typeAcc_superClass_627824)) {
				return new Object[] { typeAcc, classDec };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_154490 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, MethodDeclaration.class, "returnType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_427326 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ParameterizedType.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_13933 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, SingleVariableDeclaration.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_5330 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_28_1_matchtggpattern_black_nac_0BBB(
			InterfaceRealization interfaceRealization, Interface superInterface, BehavioredClassifier umlClass) {
		for (NamedElement __DEC_interfaceRealization_client_891470 : interfaceRealization.getClients()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_client_891470)) {
				if (!superInterface.equals(__DEC_interfaceRealization_client_891470)) {
					if (!umlClass.equals(__DEC_interfaceRealization_client_891470)) {
						return new Object[] { interfaceRealization, superInterface, umlClass };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_28_1_matchtggpattern_black_nac_1BBB(
			InterfaceRealization interfaceRealization, Interface superInterface, BehavioredClassifier umlClass) {
		for (NamedElement __DEC_interfaceRealization_supplier_997672 : interfaceRealization.getSuppliers()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_supplier_997672)) {
				if (!superInterface.equals(__DEC_interfaceRealization_supplier_997672)) {
					if (!umlClass.equals(__DEC_interfaceRealization_supplier_997672)) {
						return new Object[] { interfaceRealization, superInterface, umlClass };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_6_perform_blackBBBBBBB(
		...
		if (!cd2c.equals(cd2c2)) {
			return new Object[] { classDec, superInterface, cd2c2, umlClass, cd2c, superInterfaceDec, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_6_perform_greenBBFFBBFB(
			ClassDeclaration classDec, Interface superInterface, BehavioredClassifier umlClass,
			InterfaceDeclaration superInterfaceDec, ModelgeneratorRuleResult ruleResult) {
		TypeAccess typeAcc = JavaFactory.eINSTANCE.createTypeAccess();
		org.gravity.tgg.modisco.uml.TypeAccess2InterfaceRealization ta2g = UmlFactory.eINSTANCE
		...
		return new Object[] { classDec, superInterface, typeAcc, ta2g, umlClass, superInterfaceDec,
