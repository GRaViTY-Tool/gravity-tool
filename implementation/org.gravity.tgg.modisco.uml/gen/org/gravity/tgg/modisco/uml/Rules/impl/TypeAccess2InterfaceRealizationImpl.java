...
public class TypeAccess2InterfaceRealizationImpl extends AbstractRuleImpl implements TypeAccess2InterfaceRealization {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		NamedElement2NamedElement cd2c2 = (NamedElement2NamedElement) result1_bindingAndBlack[2];
		...
		NamedElement2NamedElement cd2c = (NamedElement2NamedElement) result1_bindingAndBlack[6];
		//nothing CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_greenBFBBF(superInterface, umlClass,
						typeAcc);
		...
		Object[] result3_black = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
						superInterface, ta2g, superInterfaceDec, cd2c2, umlClass, classDec, typeAcc, cd2c,
						interfaceRealization);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[superInterface] = " + superInterface + ", " + "[ta2g] = " + ta2g + ", "
					+ "[superInterfaceDec] = " + superInterfaceDec + ", " + "[cd2c2] = " + cd2c2 + ", "
					+ "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec + ", " + "[typeAcc] = " + typeAcc
		...
		TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(ruleresult,
						superInterface, ta2g, superInterfaceDec, umlClass, classDec, typeAcc, interfaceRealization);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_2_2_corematch_blackFBFFBBFB(superInterfaceDec, classDec,
						typeAcc, match)) {
			...
			for (Object[] result3_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_2_3_findcontext_blackBBBBBBB(superInterface,
							superInterfaceDec, cd2c2, umlClass, classDec, typeAcc, cd2c)) {
				Object[] result3_green = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_2_3_findcontext_greenBBBBBBBFFFFFFFF(superInterface,
								superInterfaceDec, cd2c2, umlClass, classDec, typeAcc, cd2c);
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, superInterface, superInterfaceDec, cd2c2, umlClass, classDec,
								typeAcc, cd2c);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[superInterface] = "
							+ superInterface + ", " + "[superInterfaceDec] = " + superInterfaceDec + ", " + "[cd2c2] = "
							+ cd2c2 + ", " + "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec + ", "
							+ "[typeAcc] = " + typeAcc + ", " + "[cd2c] = " + cd2c + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Interface superInterface,
			InterfaceDeclaration superInterfaceDec, NamedElement2NamedElement cd2c2, BehavioredClassifier umlClass,
			ClassDeclaration classDec, TypeAccess typeAcc, NamedElement2NamedElement cd2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject superInterface, EObject ta2g,
			EObject superInterfaceDec, EObject cd2c2, EObject umlClass, EObject classDec, EObject typeAcc, EObject cd2c,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		//nothing CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_greenFBBFB(superInterfaceDec,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_12_2_corematch_blackBFFBFFBB(superInterface, umlClass,
			...
			// ForEach 
			for (Object[] result3_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_12_3_findcontext_blackBBBBBBB(superInterface,
							superInterfaceDec, cd2c2, umlClass, classDec, cd2c, interfaceRealization)) {
				Object[] result3_green = TypeAccess2InterfaceRealizationImpl
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, superInterface, superInterfaceDec, cd2c2, umlClass, classDec, cd2c,
								interfaceRealization);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[superInterface] = "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Interface superInterface,
			InterfaceDeclaration superInterfaceDec, NamedElement2NamedElement cd2c2, BehavioredClassifier umlClass,
			ClassDeclaration classDec, NamedElement2NamedElement cd2c, InterfaceRealization interfaceRealization) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject superInterface, EObject ta2g,
			EObject superInterfaceDec, EObject cd2c2, EObject umlClass, EObject classDec, EObject typeAcc, EObject cd2c,
			EObject interfaceRealization) {
		ruleresult.registerObject("superInterface", superInterface);
		ruleresult.registerObject("ta2g", ta2g);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_980(EMoflonEdge _edge_interfaceRealization) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_1003(EMoflonEdge _edge_type) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, superInterface,
						superInterfaceDec, umlClass, classDec, typeAcc, interfaceRealization, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[superInterface] = " + superInterface + ", " + "[superInterfaceDec] = " + superInterfaceDec
					+ ", " + "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec + ", " + "[typeAcc] = "
					+ typeAcc + ", " + "[interfaceRealization] = " + interfaceRealization + ", " + "[sourceMatch] = "
		...
		if (TypeAccess2InterfaceRealizationImpl
			...
			for (Object[] result5_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_24_5_matchcorrcontext_blackBBFBBFBB(superInterface,
							superInterfaceDec, umlClass, classDec, sourceMatch, targetMatch)) {
				NamedElement2NamedElement cd2c2 = (NamedElement2NamedElement) result5_black[2];
				NamedElement2NamedElement cd2c = (NamedElement2NamedElement) result5_black[5];
				...
				Object[] result6_black = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_24_6_createcorrespondence_blackBBBBBBB(superInterface,
								superInterfaceDec, umlClass, classDec, typeAcc, interfaceRealization, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[superInterface] = "
							...
							+ "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec + ", " + "[typeAcc] = "
							+ typeAcc + ", " + "[interfaceRealization] = " + interfaceRealization + ", "
							+ "[ccMatch] = " + ccMatch + ".");
				}
				TypeAccess2InterfaceRealizationImpl
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Interface superInterface, InterfaceDeclaration superInterfaceDec,
			BehavioredClassifier umlClass, ClassDeclaration classDec, TypeAccess typeAcc,
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ ", " + "[superInterfaceDec] = " + superInterfaceDec + ", " + "[cd2c2] = " + cd2c2 + ", "
						+ "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec + ", " + "[cd2c] = " + cd2c
			...
			if (TypeAccess2InterfaceRealizationImpl
				...
				// 
				Object[] result5_black = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_29_5_checknacs_blackBBBBBB(superInterface,
								superInterfaceDec, cd2c2, umlClass, classDec, cd2c);
				if (result5_black != null) {

					Object[] result6_black = TypeAccess2InterfaceRealizationImpl
							.pattern_TypeAccess2InterfaceRealization_29_6_perform_blackBBBBBBB(superInterface,
									superInterfaceDec, cd2c2, umlClass, classDec, cd2c, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[superInterface] = "
								+ superInterface + ", " + "[superInterfaceDec] = " + superInterfaceDec + ", "
								+ "[cd2c2] = " + cd2c2 + ", " + "[umlClass] = " + umlClass + ", " + "[classDec] = "
								+ classDec + ", " + "[cd2c] = " + cd2c + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					TypeAccess2InterfaceRealizationImpl
							.pattern_TypeAccess2InterfaceRealization_29_6_perform_greenBFBBBFFB(superInterface,
									superInterfaceDec, umlClass, classDec, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Interface superInterface,
			InterfaceDeclaration superInterfaceDec, NamedElement2NamedElement cd2c2, BehavioredClassifier umlClass,
			ClassDeclaration classDec, NamedElement2NamedElement cd2c, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_INTERFACE_INTERFACEDECLARATION_NAMEDELEMENT2NAMEDELEMENT_BEHAVIOREDCLASSIFIER_CLASSDECLARATION_TYPEACCESS_NAMEDELEMENT2NAMEDELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Interface) arguments.get(1),
					(InterfaceDeclaration) arguments.get(2), (NamedElement2NamedElement) arguments.get(3),
					(BehavioredClassifier) arguments.get(4), (ClassDeclaration) arguments.get(5),
					(TypeAccess) arguments.get(6), (NamedElement2NamedElement) arguments.get(7));
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACE_INTERFACEDECLARATION_NAMEDELEMENT2NAMEDELEMENT_BEHAVIOREDCLASSIFIER_CLASSDECLARATION_NAMEDELEMENT2NAMEDELEMENT_INTERFACEREALIZATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Interface) arguments.get(1),
					(InterfaceDeclaration) arguments.get(2), (NamedElement2NamedElement) arguments.get(3),
					(BehavioredClassifier) arguments.get(4), (ClassDeclaration) arguments.get(5),
					(NamedElement2NamedElement) arguments.get(6), (InterfaceRealization) arguments.get(7));
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_980__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_980((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1003__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_1003((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_CC__INTERFACE_INTERFACEDECLARATION_BEHAVIOREDCLASSIFIER_CLASSDECLARATION_TYPEACCESS_INTERFACEREALIZATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Interface) arguments.get(0), (InterfaceDeclaration) arguments.get(1),
					...
					(TypeAccess) arguments.get(4), (InterfaceRealization) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACE_INTERFACEDECLARATION_NAMEDELEMENT2NAMEDELEMENT_BEHAVIOREDCLASSIFIER_CLASSDECLARATION_NAMEDELEMENT2NAMEDELEMENT_MODELGENERATORRULERESULT:
						...
						if (tmpClassDec instanceof ClassDeclaration) {
							...
							if (tmpTypeAcc instanceof TypeAccess) {
								...
								if (tmpCd2c instanceof NamedElement2NamedElement) {
									...
									return new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_blackBBBBBBBFBB(
			Interface superInterface, InterfaceDeclaration superInterfaceDec, NamedElement2NamedElement cd2c2,
			BehavioredClassifier umlClass, ClassDeclaration classDec, TypeAccess typeAcc,
			NamedElement2NamedElement cd2c, TypeAccess2InterfaceRealization _this,
			IsApplicableMatch isApplicableMatch) {
		if (!cd2c.equals(cd2c2)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec, typeAcc, cd2c,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding != null) {
			Interface superInterface = (Interface) result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding[0];
			...
			NamedElement2NamedElement cd2c2 = (NamedElement2NamedElement) result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding[2];
			BehavioredClassifier umlClass = (BehavioredClassifier) result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding[3];
			ClassDeclaration classDec = (ClassDeclaration) result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding[4];
			TypeAccess typeAcc = (TypeAccess) result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding[5];
			NamedElement2NamedElement cd2c = (NamedElement2NamedElement) result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding[6];
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_black = pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_blackBBBBBBBFBB(
					superInterface, superInterfaceDec, cd2c2, umlClass, classDec, typeAcc, cd2c, _this,
					isApplicableMatch);
			if (result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_black != null) {
				...
				return new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec, typeAcc, cd2c, csp,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_greenBFBBF(
			Interface superInterface, BehavioredClassifier umlClass, TypeAccess typeAcc) {
		...
		return new Object[] { superInterface, ta2g, umlClass, typeAcc, interfaceRealization };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject superInterface, EObject ta2g, EObject superInterfaceDec,
			EObject cd2c2, EObject umlClass, EObject classDec, EObject typeAcc, EObject cd2c,
			EObject interfaceRealization) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject superInterface, EObject ta2g, EObject superInterfaceDec,
			EObject umlClass, EObject classDec, EObject typeAcc, EObject interfaceRealization) {
		EMoflonEdge typeAcc__superInterfaceDec____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge superInterfaceDec__typeAcc____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, superInterface, ta2g, superInterfaceDec, umlClass, classDec, typeAcc,
				...
				ta2g__interfaceRealization____target, umlClass__interfaceRealization____interfaceRealization,
	...
	public static final void pattern_TypeAccess2InterfaceRealization_1_5_registerobjects_expressionBBBBBBBBBBB(
			TypeAccess2InterfaceRealization _this, PerformRuleResult ruleresult, EObject superInterface, EObject ta2g,
			EObject superInterfaceDec, EObject cd2c2, EObject umlClass, EObject classDec, EObject typeAcc, EObject cd2c,
			EObject interfaceRealization) {
		_this.registerObjects_FWD(ruleresult, superInterface, ta2g, superInterfaceDec, cd2c2, umlClass, classDec,
				typeAcc, cd2c, interfaceRealization);
	...
	public static final Iterable<Object[]> pattern_TypeAccess2InterfaceRealization_2_2_corematch_blackFBFFBBFB(
			...
			if (tmpSuperInterface instanceof Interface) {
				...
				for (NamedElement2NamedElement cd2c : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!cd2c.equals(cd2c2)) {
						...
						if (tmpUmlClass instanceof BehavioredClassifier) {
							BehavioredClassifier umlClass = (BehavioredClassifier) tmpUmlClass;
							_result.add(new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec,
									typeAcc, cd2c, match });
						}
	...
	public static final Iterable<Object[]> pattern_TypeAccess2InterfaceRealization_2_3_findcontext_blackBBBBBBB(
			Interface superInterface, InterfaceDeclaration superInterfaceDec, NamedElement2NamedElement cd2c2,
			BehavioredClassifier umlClass, ClassDeclaration classDec, TypeAccess typeAcc,
			NamedElement2NamedElement cd2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!cd2c.equals(cd2c2)) {
						...
						if (classDec.equals(cd2c.getSource())) {
							if (classDec.getSuperInterfaces().contains(typeAcc)) {
								if (superInterface.equals(cd2c2.getTarget())) {
									_result.add(new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec, typeAcc, cd2c,
				isApplicableMatch, cd2c2__superInterfaceDec____source, cd2c__umlClass____target,
				typeAcc__superInterfaceDec____type, superInterfaceDec__typeAcc____usagesInTypeAccess,
				cd2c__classDec____source, classDec__typeAcc____superInterfaces, cd2c2__superInterface____target };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			InterfaceDeclaration superInterfaceDec, NamedElement2NamedElement cd2c2, BehavioredClassifier umlClass,
			ClassDeclaration classDec, TypeAccess typeAcc, NamedElement2NamedElement cd2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, superInterface, superInterfaceDec,
				cd2c2, umlClass, classDec, typeAcc, cd2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, superInterface, superInterfaceDec, cd2c2, umlClass,
					classDec, typeAcc, cd2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, superInterface, superInterfaceDec, cd2c2, umlClass, classDec, typeAcc, cd2c);
						...
						if (tmpClassDec instanceof ClassDeclaration) {
							...
							if (tmpCd2c instanceof NamedElement2NamedElement) {
								...
								if (tmpInterfaceRealization instanceof InterfaceRealization) {
									...
									return new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec,
											cd2c, interfaceRealization, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_blackBBBBBBBFBB(
			Interface superInterface, InterfaceDeclaration superInterfaceDec, NamedElement2NamedElement cd2c2,
			BehavioredClassifier umlClass, ClassDeclaration classDec, NamedElement2NamedElement cd2c,
		...
		if (!cd2c.equals(cd2c2)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec, cd2c,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_binding != null) {
			...
			NamedElement2NamedElement cd2c2 = (NamedElement2NamedElement) result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_binding[2];
			...
			ClassDeclaration classDec = (ClassDeclaration) result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_binding[4];
			NamedElement2NamedElement cd2c = (NamedElement2NamedElement) result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_black = pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_blackBBBBBBBFBB(
					superInterface, superInterfaceDec, cd2c2, umlClass, classDec, cd2c, interfaceRealization, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_greenFBBFB(
		...
		return new Object[] { ta2g, superInterfaceDec, classDec, typeAcc, interfaceRealization };
	}
	...
	public static final void pattern_TypeAccess2InterfaceRealization_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject superInterfaceDec, EObject cd2c2, EObject umlClass, EObject classDec, EObject typeAcc, EObject cd2c,
			EObject interfaceRealization) {
		_this.registerObjects_BWD(ruleresult, superInterface, ta2g, superInterfaceDec, cd2c2, umlClass, classDec,
				typeAcc, cd2c, interfaceRealization);
	...
	public static final Iterable<Object[]> pattern_TypeAccess2InterfaceRealization_12_2_corematch_blackBFFBFFBB(
				...
				for (NamedElement2NamedElement cd2c2 : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!cd2c.equals(cd2c2)) {
						...
						if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
							InterfaceDeclaration superInterfaceDec = (InterfaceDeclaration) tmpSuperInterfaceDec;
							_result.add(new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec,
									cd2c, interfaceRealization, match });
						}
					...
					if (classDec.equals(cd2c.getSource())) {
						if (umlClass.getInterfaceRealizations().contains(interfaceRealization)) {
							if (superInterface.equals(interfaceRealization.getContract())) {
								if (superInterface.equals(cd2c2.getTarget())) {
									_result.add(new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass,
											classDec, cd2c, interfaceRealization });
								}
							}
						}
					}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		interfaceRealization__superInterface____contract
				.setName(interfaceRealization__superInterface____contract_name_prime);
		cd2c2__superInterface____target.setName(cd2c2__superInterface____target_name_prime);
		return new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec, cd2c, interfaceRealization,
				isApplicableMatch, cd2c2__superInterfaceDec____source, cd2c__umlClass____target,
				cd2c__classDec____source, umlClass__interfaceRealization____interfaceRealization,
				interfaceRealization__umlClass____implementingClassifier,
				interfaceRealization__superInterface____contract, cd2c2__superInterface____target };
	}

	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingFBBBBBBBBB(
			TypeAccess2InterfaceRealization _this, IsApplicableMatch isApplicableMatch, Interface superInterface,
			InterfaceDeclaration superInterfaceDec, NamedElement2NamedElement cd2c2, BehavioredClassifier umlClass,
			ClassDeclaration classDec, NamedElement2NamedElement cd2c, InterfaceRealization interfaceRealization) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, superInterface, superInterfaceDec,
				cd2c2, umlClass, classDec, cd2c, interfaceRealization);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, superInterface, superInterfaceDec, cd2c2, umlClass,
					classDec, cd2c, interfaceRealization };
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, superInterface, superInterfaceDec, cd2c2, umlClass, classDec, cd2c,
				interfaceRealization);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		for (NamedElement __DEC_interfaceRealization_client_565653 : interfaceRealization.getClients()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_client_565653)) {
				if (!superInterface.equals(__DEC_interfaceRealization_client_565653)) {
					if (!umlClass.equals(__DEC_interfaceRealization_client_565653)) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_20_2_testcorematchandDECs_black_nac_1BBB(
			InterfaceRealization interfaceRealization, Interface superInterface, BehavioredClassifier umlClass) {
		for (NamedElement __DEC_interfaceRealization_supplier_116951 : interfaceRealization.getSuppliers()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_supplier_116951)) {
				if (!superInterface.equals(__DEC_interfaceRealization_supplier_116951)) {
					if (!umlClass.equals(__DEC_interfaceRealization_supplier_116951)) {
						return new Object[] { interfaceRealization, superInterface, umlClass };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_20_2_testcorematchandDECs_black_nac_2B(
			InterfaceRealization interfaceRealization) {
		for (org.eclipse.uml2.uml.Package __DEC_interfaceRealization_packagedElement_480705 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_66118 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_69100 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_2BB(
		...
		for (ClassDeclaration __DEC_typeAcc_superClass_76836 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ClassDeclaration.class, "superClass")) {
			if (!classDec.equals(__DEC_typeAcc_superClass_76836)) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_448126 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_522497 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_752992 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_561166 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess typeAcc) {
		for (ArrayInitializer __DEC_typeAcc_expressions_172793 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpUmlClass instanceof BehavioredClassifier) {
					...
					if (tmpClassDec instanceof ClassDeclaration) {
						...
						if (tmpTypeAcc instanceof TypeAccess) {
							...
							if (tmpInterfaceRealization instanceof InterfaceRealization) {
								InterfaceRealization interfaceRealization = (InterfaceRealization) tmpInterfaceRealization;
								return new Object[] { superInterface, superInterfaceDec, umlClass, classDec, typeAcc,
										interfaceRealization, targetMatch, sourceMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_blackBBBBBBBB(
			Interface superInterface, InterfaceDeclaration superInterfaceDec, BehavioredClassifier umlClass,
			ClassDeclaration classDec, TypeAccess typeAcc, InterfaceRealization interfaceRealization, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { superInterface, superInterfaceDec, umlClass, classDec, typeAcc, interfaceRealization,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_binding != null) {
			Interface superInterface = (Interface) result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_binding[0];
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_black = pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_blackBBBBBBBB(
					superInterface, superInterfaceDec, umlClass, classDec, typeAcc, interfaceRealization, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingFBBBBBBBBB(
			TypeAccess2InterfaceRealization _this, Interface superInterface, InterfaceDeclaration superInterfaceDec,
			BehavioredClassifier umlClass, ClassDeclaration classDec, TypeAccess typeAcc,
			InterfaceRealization interfaceRealization, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(superInterface, superInterfaceDec, umlClass, classDec,
				typeAcc, interfaceRealization, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, superInterface, superInterfaceDec, umlClass, classDec, typeAcc,
					interfaceRealization, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_binding = pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, superInterface, superInterfaceDec, umlClass, classDec, typeAcc, interfaceRealization,
				sourceMatch, targetMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_6_createcorrespondence_blackBBBBBBB(
			Interface superInterface, InterfaceDeclaration superInterfaceDec, BehavioredClassifier umlClass,
			ClassDeclaration classDec, TypeAccess typeAcc, InterfaceRealization interfaceRealization, CCMatch ccMatch) {
		return new Object[] { superInterface, superInterfaceDec, umlClass, classDec, typeAcc, interfaceRealization,
				ccMatch };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_26993 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, Annotation.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_638030 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ArrayType.class, "elementType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess typeAcc, ClassDeclaration classDec) {
		for (ClassDeclaration __DEC_typeAcc_superClass_78587 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ClassDeclaration.class, "superClass")) {
			if (!classDec.equals(__DEC_typeAcc_superClass_78587)) {
				return new Object[] { typeAcc, classDec };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_871844 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, MethodDeclaration.class, "returnType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_542180 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ParameterizedType.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_876618 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, SingleVariableDeclaration.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_449247 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_7B(
			TypeAccess typeAcc) {
		for (ArrayInitializer __DEC_typeAcc_expressions_32768 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ArrayInitializer.class, "expressions")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_28_1_matchtggpattern_black_nac_0BBB(
			InterfaceRealization interfaceRealization, Interface superInterface, BehavioredClassifier umlClass) {
		for (NamedElement __DEC_interfaceRealization_client_300356 : interfaceRealization.getClients()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_client_300356)) {
				if (!superInterface.equals(__DEC_interfaceRealization_client_300356)) {
					if (!umlClass.equals(__DEC_interfaceRealization_client_300356)) {
						return new Object[] { interfaceRealization, superInterface, umlClass };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_28_1_matchtggpattern_black_nac_1BBB(
			InterfaceRealization interfaceRealization, Interface superInterface, BehavioredClassifier umlClass) {
		for (NamedElement __DEC_interfaceRealization_supplier_97782 : interfaceRealization.getSuppliers()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_supplier_97782)) {
				if (!superInterface.equals(__DEC_interfaceRealization_supplier_97782)) {
					if (!umlClass.equals(__DEC_interfaceRealization_supplier_97782)) {
						return new Object[] { interfaceRealization, superInterface, umlClass };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_28_1_matchtggpattern_black_nac_2B(
			InterfaceRealization interfaceRealization) {
		for (org.eclipse.uml2.uml.Package __DEC_interfaceRealization_packagedElement_333524 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(interfaceRealization, org.eclipse.uml2.uml.Package.class,
						"packagedElement")) {
			return new Object[] { interfaceRealization };
		}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_bindingFBBBBBBBBB(
			TypeAccess2InterfaceRealization _this, IsApplicableMatch isApplicableMatch, Interface superInterface,
			InterfaceDeclaration superInterfaceDec, NamedElement2NamedElement cd2c2, BehavioredClassifier umlClass,
			ClassDeclaration classDec, NamedElement2NamedElement cd2c, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, superInterface, superInterfaceDec,
				cd2c2, umlClass, classDec, cd2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, superInterface, superInterfaceDec, cd2c2, umlClass,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_6_perform_blackBBBBBBB(
		...
		if (!cd2c.equals(cd2c2)) {
			return new Object[] { superInterface, superInterfaceDec, cd2c2, umlClass, classDec, cd2c, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_6_perform_greenBFBBBFFB(
			Interface superInterface, InterfaceDeclaration superInterfaceDec, BehavioredClassifier umlClass,
		...
		return new Object[] { superInterface, ta2g, superInterfaceDec, umlClass, classDec, typeAcc,
