...
public class TypeAccess2InterfaceRealizationImpl extends AbstractRuleImpl implements TypeAccess2InterfaceRealization {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_greenBFFBB(typeAcc, umlClass,
						superInterface);
		...
		Object[] result3_black = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, cd2c,
						typeAcc, cd2c2, interfaceRealization, superInterfaceDec, ta2g, umlClass, classDec,
						superInterface);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[cd2c] = " + cd2c + ", " + "[typeAcc] = " + typeAcc + ", " + "[cd2c2] = " + cd2c2 + ", "
					+ "[interfaceRealization] = " + interfaceRealization + ", " + "[superInterfaceDec] = "
					+ superInterfaceDec + ", " + "[ta2g] = " + ta2g + ", " + "[umlClass] = " + umlClass + ", "
		...
		TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(ruleresult,
						typeAcc, interfaceRealization, superInterfaceDec, ta2g, umlClass, classDec, superInterface);
		...
		TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						cd2c, typeAcc, cd2c2, interfaceRealization, superInterfaceDec, ta2g, umlClass, classDec,
						superInterface);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_2_2_corematch_blackFBFBFBFB(typeAcc, superInterfaceDec,
						classDec, match)) {
			...
			for (Object[] result3_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_2_3_findcontext_blackBBBBBBB(cd2c, typeAcc, cd2c2,
							superInterfaceDec, umlClass, classDec, superInterface)) {
				Object[] result3_green = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_2_3_findcontext_greenBBBBBBBFFFFFFFF(cd2c, typeAcc,
								cd2c2, superInterfaceDec, umlClass, classDec, superInterface);
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, cd2c, typeAcc, cd2c2, superInterfaceDec, umlClass, classDec,
								superInterface);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[cd2c] = " + cd2c + ", "
							+ "[typeAcc] = " + typeAcc + ", " + "[cd2c2] = " + cd2c2 + ", " + "[superInterfaceDec] = "
							+ superInterfaceDec + ", " + "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element cd2c, TypeAccess typeAcc,
			ASTNode2Element cd2c2, InterfaceDeclaration superInterfaceDec, BehavioredClassifier umlClass,
			ClassDeclaration classDec, Interface superInterface) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject cd2c, EObject typeAcc, EObject cd2c2,
			EObject interfaceRealization, EObject superInterfaceDec, EObject ta2g, EObject umlClass, EObject classDec,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_12_2_corematch_blackFFBFBFBB(interfaceRealization, umlClass,
			...
			for (Object[] result3_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_12_3_findcontext_blackBBBBBBB(cd2c, cd2c2,
							interfaceRealization, superInterfaceDec, umlClass, classDec, superInterface)) {
				Object[] result3_green = TypeAccess2InterfaceRealizationImpl
				...
				Object[] result4_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, cd2c, cd2c2, interfaceRealization, superInterfaceDec, umlClass,
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element cd2c,
			ASTNode2Element cd2c2, InterfaceRealization interfaceRealization, InterfaceDeclaration superInterfaceDec,
			BehavioredClassifier umlClass, ClassDeclaration classDec, Interface superInterface) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject cd2c, EObject typeAcc, EObject cd2c2,
			EObject interfaceRealization, EObject superInterfaceDec, EObject ta2g, EObject umlClass, EObject classDec,
			EObject superInterface) {
		ruleresult.registerObject("cd2c", cd2c);
		ruleresult.registerObject("typeAcc", typeAcc);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_666(EMoflonEdge _edge_contract) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_716(EMoflonEdge _edge_type) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
				.pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, typeAcc,
						interfaceRealization, superInterfaceDec, umlClass, classDec, superInterface, sourceMatch,
						targetMatch);
		...
		if (TypeAccess2InterfaceRealizationImpl
			...
			for (Object[] result5_black : TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_24_5_matchcorrcontext_blackFFBBBBBB(superInterfaceDec,
							umlClass, classDec, superInterface, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_24_6_createcorrespondence_blackBBBBBBB(typeAcc,
								interfaceRealization, superInterfaceDec, umlClass, classDec, superInterface, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[typeAcc] = " + typeAcc
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess typeAcc, InterfaceRealization interfaceRealization,
			InterfaceDeclaration superInterfaceDec, BehavioredClassifier umlClass, ClassDeclaration classDec,
		...
		for (Object[] result2_black : TypeAccess2InterfaceRealizationImpl
			...
			Object[] result3_bindingAndBlack = TypeAccess2InterfaceRealizationImpl
					.pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, cd2c, cd2c2, superInterfaceDec, umlClass, classDec, superInterface,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[cd2c] = " + cd2c + ", " + "[cd2c2] = "
						+ cd2c2 + ", " + "[superInterfaceDec] = " + superInterfaceDec + ", " + "[umlClass] = "
						+ umlClass + ", " + "[classDec] = " + classDec + ", " + "[superInterface] = " + superInterface
			...
			if (TypeAccess2InterfaceRealizationImpl
				...
				// 
				Object[] result5_black = TypeAccess2InterfaceRealizationImpl
						.pattern_TypeAccess2InterfaceRealization_29_5_checknacs_blackBBBBBB(cd2c, cd2c2,
								superInterfaceDec, umlClass, classDec, superInterface);
				if (result5_black != null) {

					Object[] result6_black = TypeAccess2InterfaceRealizationImpl
							.pattern_TypeAccess2InterfaceRealization_29_6_perform_blackBBBBBBB(cd2c, cd2c2,
									superInterfaceDec, umlClass, classDec, superInterface, ruleResult);
					if (result6_black == null) {
					...
					TypeAccess2InterfaceRealizationImpl
							.pattern_TypeAccess2InterfaceRealization_29_6_perform_greenFFBFBBBB(superInterfaceDec,
									umlClass, classDec, superInterface, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element cd2c,
			ASTNode2Element cd2c2, InterfaceDeclaration superInterfaceDec, BehavioredClassifier umlClass,
			ClassDeclaration classDec, Interface superInterface, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_TYPEACCESS_ASTNODE2ELEMENT_INTERFACEDECLARATION_BEHAVIOREDCLASSIFIER_CLASSDECLARATION_INTERFACE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(InterfaceDeclaration) arguments.get(4), (BehavioredClassifier) arguments.get(5),
					(ClassDeclaration) arguments.get(6), (Interface) arguments.get(7));
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_INTERFACEREALIZATION_INTERFACEDECLARATION_BEHAVIOREDCLASSIFIER_CLASSDECLARATION_INTERFACE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(ASTNode2Element) arguments.get(2), (InterfaceRealization) arguments.get(3),
					(InterfaceDeclaration) arguments.get(4), (BehavioredClassifier) arguments.get(5),
					(ClassDeclaration) arguments.get(6), (Interface) arguments.get(7));
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_666__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_666((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_716__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_716((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_INTERFACEREALIZATION_INTERFACEDECLARATION_BEHAVIOREDCLASSIFIER_CLASSDECLARATION_INTERFACE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeAccess) arguments.get(0), (InterfaceRealization) arguments.get(1),
					(InterfaceDeclaration) arguments.get(2), (BehavioredClassifier) arguments.get(3),
					(ClassDeclaration) arguments.get(4), (Interface) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.TYPE_ACCESS2_INTERFACE_REALIZATION___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_INTERFACEDECLARATION_BEHAVIOREDCLASSIFIER_CLASSDECLARATION_INTERFACE_MODELGENERATORRULERESULT:
						...
						if (tmpUmlClass instanceof BehavioredClassifier) {
							...
							if (tmpClassDec instanceof ClassDeclaration) {
								...
								if (tmpSuperInterface instanceof Interface) {
									...
									return new Object[] { cd2c, typeAcc, cd2c2, superInterfaceDec, umlClass, classDec,
		...
		if (!cd2c.equals(cd2c2)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { cd2c, typeAcc, cd2c2, superInterfaceDec, umlClass, classDec, superInterface,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding != null) {
			...
			ASTNode2Element cd2c2 = (ASTNode2Element) result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding[2];
			...
			ClassDeclaration classDec = (ClassDeclaration) result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_black = pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_blackBBBBBBBFBB(
					cd2c, typeAcc, cd2c2, superInterfaceDec, umlClass, classDec, superInterface, _this,
					isApplicableMatch);
			if (result_pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_black != null) {
				...
				return new Object[] { cd2c, typeAcc, cd2c2, superInterfaceDec, umlClass, classDec, superInterface, csp,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_1_performtransformation_greenBFFBB(
		...
		return new Object[] { typeAcc, interfaceRealization, ta2g, umlClass, superInterface };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject cd2c, EObject typeAcc, EObject cd2c2, EObject interfaceRealization,
			EObject superInterfaceDec, EObject ta2g, EObject umlClass, EObject classDec, EObject superInterface) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject typeAcc, EObject interfaceRealization, EObject superInterfaceDec,
			EObject ta2g, EObject umlClass, EObject classDec, EObject superInterface) {
		...
		return new Object[] { ruleresult, typeAcc, interfaceRealization, superInterfaceDec, ta2g, umlClass, classDec,
				superInterface, interfaceRealization__superInterface____contract, ta2g__typeAcc____source,
	...
	public static final void pattern_TypeAccess2InterfaceRealization_1_5_registerobjects_expressionBBBBBBBBBBB(
			TypeAccess2InterfaceRealization _this, PerformRuleResult ruleresult, EObject cd2c, EObject typeAcc,
			EObject cd2c2, EObject interfaceRealization, EObject superInterfaceDec, EObject ta2g, EObject umlClass,
			EObject classDec, EObject superInterface) {
		_this.registerObjects_FWD(ruleresult, cd2c, typeAcc, cd2c2, interfaceRealization, superInterfaceDec, ta2g,
				umlClass, classDec, superInterface);
	...
	public static final Iterable<Object[]> pattern_TypeAccess2InterfaceRealization_2_2_corematch_blackFBFBFBFB(
			...
			if (tmpSuperInterface instanceof Interface) {
				...
				for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!cd2c.equals(cd2c2)) {
						...
						if (tmpUmlClass instanceof BehavioredClassifier) {
							BehavioredClassifier umlClass = (BehavioredClassifier) tmpUmlClass;
							_result.add(new Object[] { cd2c, typeAcc, cd2c2, superInterfaceDec, umlClass, classDec,
									superInterface, match });
						}
						...
						if (classDec.equals(cd2c.getSource())) {
							if (classDec.getSuperInterfaces().contains(typeAcc)) {
								if (superInterface.equals(cd2c2.getTarget())) {
									_result.add(new Object[] { cd2c, typeAcc, cd2c2, superInterfaceDec, umlClass,
											classDec, superInterface });
								}
							}
						}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			TypeAccess typeAcc, ASTNode2Element cd2c2, InterfaceDeclaration superInterfaceDec,
			BehavioredClassifier umlClass, ClassDeclaration classDec, Interface superInterface) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, cd2c, typeAcc, cd2c2,
				superInterfaceDec, umlClass, classDec, superInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cd2c, typeAcc, cd2c2, superInterfaceDec, umlClass,
					classDec, superInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, cd2c, typeAcc, cd2c2, superInterfaceDec, umlClass, classDec, superInterface);
					...
					if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
						...
						if (tmpUmlClass instanceof BehavioredClassifier) {
							...
							if (tmpClassDec instanceof ClassDeclaration) {
								...
								if (tmpSuperInterface instanceof Interface) {
									Interface superInterface = (Interface) tmpSuperInterface;
									return new Object[] { cd2c, cd2c2, interfaceRealization, superInterfaceDec,
											umlClass, classDec, superInterface, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_blackBBBBBBBFBB(
			ASTNode2Element cd2c, ASTNode2Element cd2c2, InterfaceRealization interfaceRealization,
			InterfaceDeclaration superInterfaceDec, BehavioredClassifier umlClass, ClassDeclaration classDec,
		...
		if (!cd2c.equals(cd2c2)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { cd2c, cd2c2, interfaceRealization, superInterfaceDec, umlClass, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_black = pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_blackBBBBBBBFBB(
					cd2c, cd2c2, interfaceRealization, superInterfaceDec, umlClass, classDec, superInterface, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_11_1_performtransformation_greenFBBFB(
		...
		ta2g.setSource(typeAcc);
		ta2g.setTarget(interfaceRealization);
		return new Object[] { typeAcc, interfaceRealization, superInterfaceDec, ta2g, classDec };
	}
	...
	public static final void pattern_TypeAccess2InterfaceRealization_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject cd2c2, EObject interfaceRealization, EObject superInterfaceDec, EObject ta2g, EObject umlClass,
			EObject classDec, EObject superInterface) {
		_this.registerObjects_BWD(ruleresult, cd2c, typeAcc, cd2c2, interfaceRealization, superInterfaceDec, ta2g,
				umlClass, classDec, superInterface);
			...
			if (tmpClassDec instanceof ClassDeclaration) {
				...
				for (ASTNode2Element cd2c2 : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!cd2c.equals(cd2c2)) {
						...
						if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
							InterfaceDeclaration superInterfaceDec = (InterfaceDeclaration) tmpSuperInterfaceDec;
							_result.add(new Object[] { cd2c, cd2c2, interfaceRealization, superInterfaceDec, umlClass,
					...
					if (umlClass.equals(cd2c.getTarget())) {
						if (classDec.equals(cd2c.getSource())) {
							if (umlClass.getInterfaceRealizations().contains(interfaceRealization)) {
								if (superInterface.equals(cd2c2.getTarget())) {
									_result.add(new Object[] { cd2c, cd2c2, interfaceRealization, superInterfaceDec,
											umlClass, classDec, superInterface });
								}
							}
						}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		interfaceRealization__umlClass____implementingClassifier
				.setName(interfaceRealization__umlClass____implementingClassifier_name_prime);
		cd2c2__superInterface____target.setName(cd2c2__superInterface____target_name_prime);
		return new Object[] { cd2c, cd2c2, interfaceRealization, superInterfaceDec, umlClass, classDec, superInterface,
				isApplicableMatch, interfaceRealization__superInterface____contract, cd2c2__superInterfaceDec____source,
				cd2c__umlClass____target, cd2c__classDec____source,
				umlClass__interfaceRealization____interfaceRealization,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cd2c, cd2c2, interfaceRealization, superInterfaceDec,
					umlClass, classDec, superInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, cd2c, cd2c2, interfaceRealization, superInterfaceDec, umlClass, classDec,
				superInterface);
		if (result_pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_TypeAccess2InterfaceRealization_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, cd2c, cd2c2, interfaceRealization,
						superInterfaceDec, umlClass, classDec, superInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_20_2_testcorematchandDECs_black_nac_0BBB(
			InterfaceRealization interfaceRealization, BehavioredClassifier umlClass, Interface superInterface) {
		for (NamedElement __DEC_interfaceRealization_client_628126 : interfaceRealization.getClients()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_client_628126)) {
				if (!umlClass.equals(__DEC_interfaceRealization_client_628126)) {
					if (!superInterface.equals(__DEC_interfaceRealization_client_628126)) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_20_2_testcorematchandDECs_black_nac_1BBB(
			InterfaceRealization interfaceRealization, BehavioredClassifier umlClass, Interface superInterface) {
		for (NamedElement __DEC_interfaceRealization_supplier_896430 : interfaceRealization.getSuppliers()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_supplier_896430)) {
				if (!umlClass.equals(__DEC_interfaceRealization_supplier_896430)) {
					if (!superInterface.equals(__DEC_interfaceRealization_supplier_896430)) {
						return new Object[] { interfaceRealization, umlClass, superInterface };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_210106 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_977912 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_2BB(
		...
		for (ClassDeclaration __DEC_typeAcc_superClass_521906 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ClassDeclaration.class, "superClass")) {
			if (!classDec.equals(__DEC_typeAcc_superClass_521906)) {
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_831646 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_346026 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_297494 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_669208 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpSuperInterfaceDec instanceof InterfaceDeclaration) {
					...
					if (tmpUmlClass instanceof BehavioredClassifier) {
						...
						if (tmpClassDec instanceof ClassDeclaration) {
							...
							if (tmpSuperInterface instanceof Interface) {
								Interface superInterface = (Interface) tmpSuperInterface;
								return new Object[] { typeAcc, interfaceRealization, superInterfaceDec, umlClass,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TypeAccess typeAcc, InterfaceRealization interfaceRealization, InterfaceDeclaration superInterfaceDec,
			BehavioredClassifier umlClass, ClassDeclaration classDec, Interface superInterface, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { typeAcc, interfaceRealization, superInterfaceDec, umlClass, classDec, superInterface,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_black = pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_blackBBBBBBBB(
					typeAcc, interfaceRealization, superInterfaceDec, umlClass, classDec, superInterface, sourceMatch,
					targetMatch);
			if (result_pattern_TypeAccess2InterfaceRealization_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { typeAcc, interfaceRealization, superInterfaceDec, umlClass, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingFBBBBBBBBB(
			TypeAccess2InterfaceRealization _this, TypeAccess typeAcc, InterfaceRealization interfaceRealization,
			InterfaceDeclaration superInterfaceDec, BehavioredClassifier umlClass, ClassDeclaration classDec,
			Interface superInterface, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(typeAcc, interfaceRealization, superInterfaceDec,
				umlClass, classDec, superInterface, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, typeAcc, interfaceRealization, superInterfaceDec, umlClass, classDec,
					superInterface, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_binding = pattern_TypeAccess2InterfaceRealization_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, typeAcc, interfaceRealization, superInterfaceDec, umlClass, classDec, superInterface,
				sourceMatch, targetMatch);
			...
			for (ASTNode2Element cd2c2 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (superInterface.equals(cd2c2.getTarget())) {
					for (ASTNode2Element cd2c : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!cd2c.equals(cd2c2)) {
							if (classDec.equals(cd2c.getSource())) {
								_result.add(new Object[] { cd2c, cd2c2, superInterfaceDec, umlClass, classDec,
										superInterface, sourceMatch, targetMatch });
							}
						}
					}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_24_6_createcorrespondence_blackBBBBBBB(
			TypeAccess typeAcc, InterfaceRealization interfaceRealization, InterfaceDeclaration superInterfaceDec,
			BehavioredClassifier umlClass, ClassDeclaration classDec, Interface superInterface, CCMatch ccMatch) {
		return new Object[] { typeAcc, interfaceRealization, superInterfaceDec, umlClass, classDec, superInterface,
				ccMatch };
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_0B(
			TypeAccess typeAcc) {
		for (Annotation __DEC_typeAcc_type_799320 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, Annotation.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAcc) {
		for (ArrayType __DEC_typeAcc_elementType_426698 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ArrayType.class, "elementType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess typeAcc, ClassDeclaration classDec) {
		for (ClassDeclaration __DEC_typeAcc_superClass_289723 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ClassDeclaration.class, "superClass")) {
			if (!classDec.equals(__DEC_typeAcc_superClass_289723)) {
				return new Object[] { typeAcc, classDec };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_3B(
			TypeAccess typeAcc) {
		for (MethodDeclaration __DEC_typeAcc_returnType_924961 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, MethodDeclaration.class, "returnType")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_4B(
			TypeAccess typeAcc) {
		for (ParameterizedType __DEC_typeAcc_type_638878 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, ParameterizedType.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_5B(
			TypeAccess typeAcc) {
		for (SingleVariableDeclaration __DEC_typeAcc_type_830976 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, SingleVariableDeclaration.class, "type")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAcc) {
		for (AnnotationMemberValuePair __DEC_typeAcc_value_56588 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAcc, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAcc };
		}
		return null;
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_28_1_matchtggpattern_black_nac_0BBB(
			InterfaceRealization interfaceRealization, BehavioredClassifier umlClass, Interface superInterface) {
		for (NamedElement __DEC_interfaceRealization_client_242111 : interfaceRealization.getClients()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_client_242111)) {
				if (!umlClass.equals(__DEC_interfaceRealization_client_242111)) {
					if (!superInterface.equals(__DEC_interfaceRealization_client_242111)) {
						return new Object[] { interfaceRealization, umlClass, superInterface };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_28_1_matchtggpattern_black_nac_1BBB(
			InterfaceRealization interfaceRealization, BehavioredClassifier umlClass, Interface superInterface) {
		for (NamedElement __DEC_interfaceRealization_supplier_46273 : interfaceRealization.getSuppliers()) {
			if (!interfaceRealization.equals(__DEC_interfaceRealization_supplier_46273)) {
				if (!umlClass.equals(__DEC_interfaceRealization_supplier_46273)) {
					if (!superInterface.equals(__DEC_interfaceRealization_supplier_46273)) {
						return new Object[] { interfaceRealization, umlClass, superInterface };
					}
				}
			}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_bindingFBBBBBBBBB(
			TypeAccess2InterfaceRealization _this, IsApplicableMatch isApplicableMatch, ASTNode2Element cd2c,
			ASTNode2Element cd2c2, InterfaceDeclaration superInterfaceDec, BehavioredClassifier umlClass,
			ClassDeclaration classDec, Interface superInterface, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, cd2c, cd2c2, superInterfaceDec,
				umlClass, classDec, superInterface, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, cd2c, cd2c2, superInterfaceDec, umlClass, classDec,
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_binding = pattern_TypeAccess2InterfaceRealization_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, cd2c, cd2c2, superInterfaceDec, umlClass, classDec, superInterface,
				ruleResult);
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_5_checknacs_blackBBBBBB(
			...
			BehavioredClassifier umlClass, ClassDeclaration classDec, Interface superInterface) {
		if (!cd2c.equals(cd2c2)) {
			return new Object[] { cd2c, cd2c2, superInterfaceDec, umlClass, classDec, superInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_6_perform_blackBBBBBBB(ASTNode2Element cd2c,
			...
			ClassDeclaration classDec, Interface superInterface, ModelgeneratorRuleResult ruleResult) {
		if (!cd2c.equals(cd2c2)) {
			return new Object[] { cd2c, cd2c2, superInterfaceDec, umlClass, classDec, superInterface, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeAccess2InterfaceRealization_29_6_perform_greenFFBFBBBB(
		...
		return new Object[] { typeAcc, interfaceRealization, superInterfaceDec, ta2g, umlClass, classDec,
				superInterface, ruleResult };
	}
