...
public class InterfaceDecWithModifier2InterfaceImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = InterfaceDecWithModifier2InterfaceImpl
				.pattern_InterfaceDecWithModifier2Interface_1_2_collecttranslatedelements_blackBBBBBB(m2f, b2e, feature,
						bd2ne, bodyDeclaration, modifier);
		...
		Object[] result2_green = InterfaceDecWithModifier2InterfaceImpl
				.pattern_InterfaceDecWithModifier2Interface_1_2_collecttranslatedelements_greenFBBBBBB(m2f, b2e,
		...
		InterfaceDecWithModifier2InterfaceImpl
				.pattern_InterfaceDecWithModifier2Interface_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						m2f, umlPackage, b2e, feature, bd2ne, jPackage, bodyDeclaration, modifier, jp2up);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = InterfaceDecWithModifier2InterfaceImpl
				.pattern_InterfaceDecWithModifier2Interface_11_1_performtransformation_greenFFBFBFFB(feature, jPackage,
						csp);
		Modifier2NamedElement m2f = (Modifier2NamedElement) result1_green[0];
		...
		Object[] result2_black = InterfaceDecWithModifier2InterfaceImpl
				.pattern_InterfaceDecWithModifier2Interface_11_2_collecttranslatedelements_blackBBBBBB(m2f, b2e,
						feature, bd2ne, bodyDeclaration, modifier);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[m2f] = " + m2f + ", "
					+ "[b2e] = " + b2e + ", " + "[feature] = " + feature + ", " + "[bd2ne] = " + bd2ne + ", "
		...
		Object[] result2_green = InterfaceDecWithModifier2InterfaceImpl
				.pattern_InterfaceDecWithModifier2Interface_11_2_collecttranslatedelements_greenFBBBBBB(m2f, b2e,
						feature, bd2ne, bodyDeclaration, modifier);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_270(EMoflonEdge _edge_packagedElement) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_279(EMoflonEdge _edge_ownedElements) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (InterfaceDecWithModifier2InterfaceImpl
			...
			for (Object[] result5_black : InterfaceDecWithModifier2InterfaceImpl
				...
				InterfaceDecWithModifier2InterfaceImpl
						.pattern_InterfaceDecWithModifier2Interface_24_6_createcorrespondence_greenFFBFBBB(feature,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_DEC_WITH_MODIFIER2_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_270__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_270((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_DEC_WITH_MODIFIER2_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_279__EMOFLONEDGE:
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_11_1_performtransformation_greenFFBFBFFB(
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_20_2_testcorematchandDECs_black_nac_0B(
			Interface feature) {
		for (org.eclipse.uml2.uml.Class __DEC_feature_nestedClassifier_520438 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_20_2_testcorematchandDECs_black_nac_1B(
			Interface feature) {
		for (Interface __DEC_feature_nestedClassifier_609290 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(feature, Interface.class, "nestedClassifier")) {
			if (!feature.equals(__DEC_feature_nestedClassifier_609290)) {
				return new Object[] { feature };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_21_2_testcorematchandDECs_black_nac_0B(
		...
		AbstractTypeDeclaration __DEC_bodyDeclaration_bodyDeclarations_533284 = bodyDeclaration
				.getAbstractTypeDeclaration();
		if (__DEC_bodyDeclaration_bodyDeclarations_533284 != null) {
			if (!bodyDeclaration.equals(__DEC_bodyDeclaration_bodyDeclarations_533284)) {
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_21_2_testcorematchandDECs_black_nac_1B(
			InterfaceDeclaration bodyDeclaration) {
		AnonymousClassDeclaration __DEC_bodyDeclaration_bodyDeclarations_693524 = bodyDeclaration
				.getAnonymousClassDeclarationOwner();
		if (__DEC_bodyDeclaration_bodyDeclarations_693524 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_21_2_testcorematchandDECs_black_nac_2B(
			InterfaceDeclaration bodyDeclaration) {
		for (MAbstractMethodDefinition __DEC_bodyDeclaration_mInnerTypes_163371 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_24_6_createcorrespondence_greenFFBFBBB(
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_27_1_matchtggpattern_black_nac_0B(
			InterfaceDeclaration bodyDeclaration) {
		AbstractTypeDeclaration __DEC_bodyDeclaration_bodyDeclarations_884165 = bodyDeclaration
				.getAbstractTypeDeclaration();
		if (__DEC_bodyDeclaration_bodyDeclarations_884165 != null) {
			if (!bodyDeclaration.equals(__DEC_bodyDeclaration_bodyDeclarations_884165)) {
				return new Object[] { bodyDeclaration };
			}
		}
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_27_1_matchtggpattern_black_nac_1B(
			InterfaceDeclaration bodyDeclaration) {
		AnonymousClassDeclaration __DEC_bodyDeclaration_bodyDeclarations_65051 = bodyDeclaration
				.getAnonymousClassDeclarationOwner();
		if (__DEC_bodyDeclaration_bodyDeclarations_65051 != null) {
			return new Object[] { bodyDeclaration };
		}
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_27_1_matchtggpattern_black_nac_2B(
			InterfaceDeclaration bodyDeclaration) {
		for (MAbstractMethodDefinition __DEC_bodyDeclaration_mInnerTypes_560886 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(bodyDeclaration, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { bodyDeclaration };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_28_1_matchtggpattern_black_nac_0B(
			Interface feature) {
		for (org.eclipse.uml2.uml.Class __DEC_feature_nestedClassifier_161206 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(feature, org.eclipse.uml2.uml.Class.class, "nestedClassifier")) {
			return new Object[] { feature };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceDecWithModifier2Interface_28_1_matchtggpattern_black_nac_1B(
			Interface feature) {
		for (Interface __DEC_feature_nestedClassifier_222348 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(feature, Interface.class, "nestedClassifier")) {
			if (!feature.equals(__DEC_feature_nestedClassifier_222348)) {
				return new Object[] { feature };
			}
		}
		return null;
