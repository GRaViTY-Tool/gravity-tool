...
public class MethodDec2OperationWithModifierImpl extends AbstractRuleImpl implements MethodDec2OperationWithModifier {
	...
	public boolean isAppropriate_FWD(Match match, MMethodDefinition bodyDeclaration, Modifier modifier) {
		...
		Object[] result1_black = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_0_1_initialbindings_blackBBBB(this, match, bodyDeclaration,
						modifier);
		...
		Object[] result2_bindingAndBlack = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_0_2_SolveCSP_bindingAndBlackFBBBB(this, match, bodyDeclaration,
						modifier);
		...
		if (MethodDec2OperationWithModifierImpl.pattern_MethodDec2OperationWithModifier_0_3_CheckCSP_expressionFBB(this,
			...
			Object[] result4_black = MethodDec2OperationWithModifierImpl
					.pattern_MethodDec2OperationWithModifier_0_4_collectelementstobetranslated_blackBBB(match,
			...
			Object[] result5_black = MethodDec2OperationWithModifierImpl
					.pattern_MethodDec2OperationWithModifier_0_5_collectcontextelements_blackBBB(match, bodyDeclaration,
							modifier);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_1_1_performtransformation_greenFFFBBB(bodyDeclaration,
						modifier, csp);
		...
		Object[] result2_black = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_1_2_collecttranslatedelements_blackBBBBB(m2f, b2e, feature,
						bodyDeclaration, modifier);
		...
		Object[] result2_green = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_1_2_collecttranslatedelements_greenFBBBBB(m2f, b2e, feature,
						bodyDeclaration, modifier);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_1_3_bookkeepingforedges_blackBBBBBB(ruleresult, m2f, b2e,
		...
		MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_1_3_bookkeepingforedges_greenBBBBBBFFFFFF(ruleresult, m2f, b2e,
						feature, bodyDeclaration, modifier);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_2_2_corematch_blackBBB(bodyDeclaration, modifier, match)) {
			// ForEach 
			for (Object[] result3_black : MethodDec2OperationWithModifierImpl
					.pattern_MethodDec2OperationWithModifier_2_3_findcontext_blackBB(bodyDeclaration, modifier)) {
				Object[] result3_green = MethodDec2OperationWithModifierImpl
						.pattern_MethodDec2OperationWithModifier_2_3_findcontext_greenBBFFF(bodyDeclaration, modifier);
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, MMethodDefinition bodyDeclaration, Modifier modifier) {// Create CSP
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_11_1_performtransformation_greenFFBFFB(feature, csp);
		Modifier2NamedElement m2f = (Modifier2NamedElement) result1_green[0];
		ASTNode2Element b2e = (ASTNode2Element) result1_green[1];
		...
		Object[] result2_black = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_11_2_collecttranslatedelements_blackBBBBB(m2f, b2e, feature,
						bodyDeclaration, modifier);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[m2f] = " + m2f + ", "
					+ "[b2e] = " + b2e + ", " + "[feature] = " + feature + ", " + "[bodyDeclaration] = "
		...
		Object[] result2_green = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_11_2_collecttranslatedelements_greenFBBBBB(m2f, b2e, feature,
						bodyDeclaration, modifier);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_11_3_bookkeepingforedges_blackBBBBBB(ruleresult, m2f, b2e,
						feature, bodyDeclaration, modifier);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[m2f] = " + m2f + ", " + "[b2e] = " + b2e + ", " + "[feature] = " + feature + ", "
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_24_3_solvecsp_bindingAndBlackFBBBBBB(this, feature,
		...
		if (MethodDec2OperationWithModifierImpl
			...
			for (Object[] result5_black : MethodDec2OperationWithModifierImpl
				...
				Object[] result6_black = MethodDec2OperationWithModifierImpl
						.pattern_MethodDec2OperationWithModifier_24_6_createcorrespondence_blackBBBB(feature,
				...
				MethodDec2OperationWithModifierImpl
						.pattern_MethodDec2OperationWithModifier_24_6_createcorrespondence_greenFFBBBB(feature,
								bodyDeclaration, modifier, ccMatch);
	...
	public boolean checkDEC_FWD(MMethodDefinition bodyDeclaration, Modifier modifier) {// 
		Object[] result1_black = MethodDec2OperationWithModifierImpl
				.pattern_MethodDec2OperationWithModifier_27_1_matchtggpattern_blackBB(bodyDeclaration, modifier);
		if (result1_black != null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.METHOD_DEC2_OPERATION_WITH_MODIFIER___IS_APPROPRIATE_FWD__MATCH_MMETHODDEFINITION_MODIFIER:
		...
		case RulesPackage.METHOD_DEC2_OPERATION_WITH_MODIFIER___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MMETHODDEFINITION_MODIFIER:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (MMethodDefinition) arguments.get(1),
					(Modifier) arguments.get(2));
			return null;
		case RulesPackage.METHOD_DEC2_OPERATION_WITH_MODIFIER___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MMETHODDEFINITION_MODIFIER:
		...
		case RulesPackage.METHOD_DEC2_OPERATION_WITH_MODIFIER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MMETHODDEFINITION_MODIFIER:
		...
		case RulesPackage.METHOD_DEC2_OPERATION_WITH_MODIFIER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_94__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_DEC2_OPERATION_WITH_MODIFIER___IS_APPLICABLE_SOLVE_CSP_CC__OPERATION_MMETHODDEFINITION_MODIFIER_MATCH_MATCH:
		...
		case RulesPackage.METHOD_DEC2_OPERATION_WITH_MODIFIER___CHECK_DEC_FWD__MMETHODDEFINITION_MODIFIER:
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_0_1_initialbindings_blackBBBB(
			MethodDec2OperationWithModifier _this, Match match, MMethodDefinition bodyDeclaration, Modifier modifier) {
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_0_4_collectelementstobetranslated_blackBBB(
			Match match, MMethodDefinition bodyDeclaration, Modifier modifier) {
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_1_1_performtransformation_blackBBFBB(
			MMethodDefinition bodyDeclaration, Modifier modifier, MethodDec2OperationWithModifier _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_1_1_performtransformation_bindingAndBlackFFFBB(
		...
		if (result_pattern_MethodDec2OperationWithModifier_1_1_performtransformation_binding != null) {
			MMethodDefinition bodyDeclaration = (MMethodDefinition) result_pattern_MethodDec2OperationWithModifier_1_1_performtransformation_binding[0];
			Modifier modifier = (Modifier) result_pattern_MethodDec2OperationWithModifier_1_1_performtransformation_binding[1];
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_1_1_performtransformation_greenFFFBBB(
			MMethodDefinition bodyDeclaration, Modifier modifier, CSP csp) {
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_1_2_collecttranslatedelements_blackBBBBB(
			Modifier2NamedElement m2f, ASTNode2Element b2e, Operation feature, MMethodDefinition bodyDeclaration,
			Modifier modifier) {
	...
	public static final void pattern_MethodDec2OperationWithModifier_1_5_registerobjects_expressionBBBBBBB(
			MethodDec2OperationWithModifier _this, PerformRuleResult ruleresult, EObject m2f, EObject b2e,
			EObject feature, EObject bodyDeclaration, EObject modifier) {
	...
	public static final Iterable<Object[]> pattern_MethodDec2OperationWithModifier_2_2_corematch_blackBBB(
			MMethodDefinition bodyDeclaration, Modifier modifier, Match match) {
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_2_3_findcontext_greenBBFFF(
			MMethodDefinition bodyDeclaration, Modifier modifier) {
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_11_1_performtransformation_greenFFBFFB(
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_24_2_matchsrctrgcontext_blackBBBBB(
			Operation feature, MMethodDefinition bodyDeclaration, Modifier modifier, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_24_2_matchsrctrgcontext_bindingAndBlackFFFBB(
		...
		if (result_pattern_MethodDec2OperationWithModifier_24_2_matchsrctrgcontext_binding != null) {
			...
			MMethodDefinition bodyDeclaration = (MMethodDefinition) result_pattern_MethodDec2OperationWithModifier_24_2_matchsrctrgcontext_binding[1];
			Modifier modifier = (Modifier) result_pattern_MethodDec2OperationWithModifier_24_2_matchsrctrgcontext_binding[2];
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_24_3_solvecsp_bindingFBBBBBB(
			MethodDec2OperationWithModifier _this, Operation feature, MMethodDefinition bodyDeclaration,
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_24_6_createcorrespondence_greenFFBBBB(
			Operation feature, MMethodDefinition bodyDeclaration, Modifier modifier, CCMatch ccMatch) {
		Modifier2NamedElement m2f = UmlFactory.eINSTANCE.createModifier2NamedElement();
		ASTNode2Element b2e = UmlFactory.eINSTANCE.createASTNode2Element();
		m2f.setTarget(feature);
	...
	public static final Object[] pattern_MethodDec2OperationWithModifier_27_1_matchtggpattern_blackBB(
			MMethodDefinition bodyDeclaration, Modifier modifier) {
		if (modifier.equals(bodyDeclaration.getModifier())) {
