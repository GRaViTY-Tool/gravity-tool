...
public class TypeDependency2UsageDependencyImpl extends AbstractRuleImpl implements TypeDependency2UsageDependency {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, uTrgType,
						trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, uUsage, mTrgType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uTrgType] = " + uTrgType + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[mPackage] = "
					+ mPackage + ", " + "[src2Src] = " + src2Src + ", " + "[uPackage] = " + uPackage + ", "
					+ "[uSrcType] = " + uSrcType + ", " + "[mSrcType] = " + mSrcType + ", " + "[p2p] = " + p2p + ", "
					+ "[uUsage] = " + uUsage + ", " + "[mTrgType] = " + mTrgType + ".");
		}
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(ruleresult, uTrgType,
						uPackage, uSrcType, mSrcType, uUsage, mTrgType);
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
						uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, uUsage, mTrgType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFBFFFBFBB(mPackage, mSrcType, mTrgType,
						match)) {
			...
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(uTrgType, trg2Trg, mPackage,
							src2Src, uPackage, uSrcType, mSrcType, p2p, mTrgType)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(uTrgType,
								trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, mTrgType);
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType,
								p2p, mTrgType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Classifier uTrgType,
			ASTNode2Element trg2Trg, org.eclipse.modisco.java.Package mPackage, ASTNode2Element src2Src,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject uTrgType, EObject trg2Trg, EObject mPackage,
			EObject src2Src, EObject uPackage, EObject uSrcType, EObject mSrcType, EObject p2p, EObject uUsage,
			EObject mTrgType) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_12_2_corematch_blackBFFFBBFFBFB(uTrgType, uPackage, uSrcType,
						uUsage, match)) {
			ASTNode2Element trg2Trg = (ASTNode2Element) result2_black[1];
			...
			// ForEach 
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(uTrgType, trg2Trg,
							mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, uUsage, mTrgType)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
				...
				//nothing EMoflonEdge uPackage__uUsage____packagedElement = (EMoflonEdge) result3_green[14];
				...
				//nothing EMoflonEdge uUsage__uTrgType____supplier = (EMoflonEdge) result3_green[18];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Classifier uTrgType,
			ASTNode2Element trg2Trg, org.eclipse.modisco.java.Package mPackage, ASTNode2Element src2Src,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType,
			JavaPackage2UmlPackage p2p, Usage uUsage, Type mTrgType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject uTrgType, EObject trg2Trg, EObject mPackage,
			EObject src2Src, EObject uPackage, EObject uSrcType, EObject mSrcType, EObject p2p, EObject uUsage,
			EObject mTrgType) {
		ruleresult.registerObject("uTrgType", uTrgType);
		ruleresult.registerObject("trg2Trg", trg2Trg);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_95(EMoflonEdge _edge_dependencies) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, uTrgType,
						mPackage, uPackage, uSrcType, mSrcType, uUsage, mTrgType, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[uTrgType] = " + uTrgType + ", " + "[mPackage] = " + mPackage + ", " + "[uPackage] = " + uPackage
					+ ", " + "[uSrcType] = " + uSrcType + ", " + "[mSrcType] = " + mSrcType + ", " + "[uUsage] = "
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBFBFBBBFBBB(uTrgType, mPackage,
				...
				Object[] result6_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(uTrgType,
								mPackage, uPackage, uSrcType, mSrcType, uUsage, mTrgType, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Classifier uTrgType, org.eclipse.modisco.java.Package mPackage,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage,
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p,
							mTrgType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uTrgType] = " + uTrgType + ", "
						+ "[trg2Trg] = " + trg2Trg + ", " + "[mPackage] = " + mPackage + ", " + "[src2Src] = " + src2Src
						+ ", " + "[uPackage] = " + uPackage + ", " + "[uSrcType] = " + uSrcType + ", " + "[mSrcType] = "
						+ mSrcType + ", " + "[p2p] = " + p2p + ", " + "[mTrgType] = " + mTrgType + ", "
			...
			if (TypeDependency2UsageDependencyImpl
				...
				// 
				Object[] result5_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(uTrgType, trg2Trg,
								mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, mTrgType);
				if (result5_black != null) {

					Object[] result6_black = TypeDependency2UsageDependencyImpl
							.pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(uTrgType, trg2Trg,
									mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, mTrgType, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uTrgType] = "
								+ uTrgType + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[mPackage] = " + mPackage + ", "
								+ "[src2Src] = " + src2Src + ", " + "[uPackage] = " + uPackage + ", " + "[uSrcType] = "
								+ uSrcType + ", " + "[mSrcType] = " + mSrcType + ", " + "[p2p] = " + p2p + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSIFIER_ASTNODE2ELEMENT_PACKAGE_ASTNODE2ELEMENT_PACKAGE_CLASS_MCLASS_JAVAPACKAGE2UMLPACKAGE_TYPE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSIFIER_ASTNODE2ELEMENT_PACKAGE_ASTNODE2ELEMENT_PACKAGE_CLASS_MCLASS_JAVAPACKAGE2UMLPACKAGE_USAGE_TYPE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Classifier) arguments.get(1),
					(ASTNode2Element) arguments.get(2), (org.eclipse.modisco.java.Package) arguments.get(3),
					(ASTNode2Element) arguments.get(4), (org.eclipse.uml2.uml.Package) arguments.get(5),
					(org.eclipse.uml2.uml.Class) arguments.get(6), (MClass) arguments.get(7),
					(JavaPackage2UmlPackage) arguments.get(8), (Usage) arguments.get(9), (Type) arguments.get(10));
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_92__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_92((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_95__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_CC__CLASSIFIER_PACKAGE_PACKAGE_CLASS_MCLASS_USAGE_TYPE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Classifier) arguments.get(0),
					(org.eclipse.modisco.java.Package) arguments.get(1),
					(org.eclipse.uml2.uml.Package) arguments.get(2), (org.eclipse.uml2.uml.Class) arguments.get(3),
					(MClass) arguments.get(4), (Usage) arguments.get(5), (Type) arguments.get(6),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSIFIER_ASTNODE2ELEMENT_PACKAGE_ASTNODE2ELEMENT_PACKAGE_CLASS_MCLASS_JAVAPACKAGE2UMLPACKAGE_TYPE_MODELGENERATORRULERESULT:
								...
								if (tmpMSrcType instanceof MClass) {
									...
									if (tmpP2p instanceof JavaPackage2UmlPackage) {
										...
										if (tmpMTrgType instanceof Type) {
											...
											return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage,
													uSrcType, mSrcType, p2p, mTrgType, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
			Classifier uTrgType, ASTNode2Element trg2Trg, org.eclipse.modisco.java.Package mPackage,
			ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType,
			MClass mSrcType, JavaPackage2UmlPackage p2p, Type mTrgType, TypeDependency2UsageDependency _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!mSrcType.equals(mTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black = pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
					uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, mTrgType, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black != null) {
				...
				return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, mTrgType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject uTrgType, EObject trg2Trg, EObject mPackage, EObject src2Src,
			EObject uPackage, EObject uSrcType, EObject mSrcType, EObject p2p, EObject uUsage, EObject mTrgType) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(
		...
		mSrcType__mTrgType____dependencies.setName(mSrcType__mTrgType____dependencies_name_prime);
		return new Object[] { ruleresult, uTrgType, uPackage, uSrcType, mSrcType, uUsage, mTrgType,
				uPackage__uUsage____packagedElement, uUsage__uTrgType____supplier, uUsage__uSrcType____client,
	...
	public static final void pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, PerformRuleResult ruleresult, EObject uTrgType, EObject trg2Trg,
			EObject mPackage, EObject src2Src, EObject uPackage, EObject uSrcType, EObject mSrcType, EObject p2p,
			EObject uUsage, EObject mTrgType) {
		_this.registerObjects_FWD(ruleresult, uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p,
				uUsage, mTrgType);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFBFFFBFBB(
							...
							for (ASTNode2Element trg2Trg : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!src2Src.equals(trg2Trg)) {
									...
									if (tmpUTrgType instanceof Classifier) {
										Classifier uTrgType = (Classifier) tmpUTrgType;
										if (!uSrcType.equals(uTrgType)) {
											_result.add(new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage,
													uSrcType, mSrcType, p2p, mTrgType, match });
										}
									}
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(
			Classifier uTrgType, ASTNode2Element trg2Trg, org.eclipse.modisco.java.Package mPackage,
			ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType,
			MClass mSrcType, JavaPackage2UmlPackage p2p, Type mTrgType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!src2Src.equals(trg2Trg)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
											...
											if (mSrcType.getDependencies().contains(mTrgType)) {
												if (uSrcType.equals(src2Src.getTarget())) {
													if (mTrgType.equals(trg2Trg.getSource())) {
														_result.add(new Object[] { uTrgType, trg2Trg, mPackage, src2Src,
																uPackage, uSrcType, mSrcType, p2p, mTrgType });
													}
												}
											}
										}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, mTrgType,
				...
				p2p__uPackage____target, p2p__mPackage____source, src2Src__mSrcType____source,
				mSrcType__mTrgType____dependencies, src2Src__uSrcType____target, trg2Trg__mTrgType____source };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, uTrgType, trg2Trg, mPackage, src2Src,
				uPackage, uSrcType, mSrcType, p2p, mTrgType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uTrgType, trg2Trg, mPackage, src2Src, uPackage,
					uSrcType, mSrcType, p2p, mTrgType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p,
				mTrgType);
									...
									if (tmpP2p instanceof JavaPackage2UmlPackage) {
										...
										if (tmpUUsage instanceof Usage) {
											...
											if (tmpMTrgType instanceof Type) {
												Type mTrgType = (Type) tmpMTrgType;
												return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage,
														uSrcType, mSrcType, p2p, uUsage, mTrgType, isApplicableMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
			Classifier uTrgType, ASTNode2Element trg2Trg, org.eclipse.modisco.java.Package mPackage,
			ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType,
			MClass mSrcType, JavaPackage2UmlPackage p2p, Usage uUsage, Type mTrgType,
			TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch) {
		if (!src2Src.equals(trg2Trg)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType,
									p2p, uUsage, mTrgType, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding != null) {
			...
			org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black = pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
					uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, uUsage, mTrgType, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black != null) {
				...
				return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, uUsage,
	...
	public static final void pattern_TypeDependency2UsageDependency_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject mPackage, EObject src2Src, EObject uPackage, EObject uSrcType, EObject mSrcType, EObject p2p,
			EObject uUsage, EObject mTrgType) {
		_this.registerObjects_BWD(ruleresult, uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p,
				uUsage, mTrgType);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_2_corematch_blackBFFFBBFFBFB(
			Classifier uTrgType, org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType,
							...
							for (ASTNode2Element src2Src : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!src2Src.equals(trg2Trg)) {
									...
									if (tmpMSrcType instanceof MClass) {
										...
										if (!mSrcType.equals(mTrgType)) {
											_result.add(new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage,
													uSrcType, mSrcType, p2p, uUsage, mTrgType, match });
										}
									}
											...
											if (mPackage.equals(p2p.getSource())) {
												if (mSrcType.equals(src2Src.getSource())) {
													if (uUsage.getClients().contains(uSrcType)) {
														if (uSrcType.equals(src2Src.getTarget())) {
															if (mTrgType.equals(trg2Trg.getSource())) {
																_result.add(new Object[] { uTrgType, trg2Trg, mPackage,
																		src2Src, uPackage, uSrcType, mSrcType, p2p,
																		uUsage, mTrgType });
															}
														}
													}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(
		...
		src2Src__uSrcType____target.setName(src2Src__uSrcType____target_name_prime);
		trg2Trg__mTrgType____source.setName(trg2Trg__mTrgType____source_name_prime);
		return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p, uUsage, mTrgType,
				isApplicableMatch, trg2Trg__uTrgType____target, mPackage__mSrcType____ownedElements,
				mSrcType__mPackage____package, uPackage__uUsage____packagedElement, uPackage__uSrcType____ownedElement,
				uSrcType__uPackage____owner, p2p__uPackage____target, uUsage__uTrgType____supplier,
				p2p__mPackage____source, src2Src__mSrcType____source, uUsage__uSrcType____client,
				src2Src__uSrcType____target, trg2Trg__mTrgType____source };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			...
			ASTNode2Element trg2Trg, org.eclipse.modisco.java.Package mPackage, ASTNode2Element src2Src,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType,
			JavaPackage2UmlPackage p2p, Usage uUsage, Type mTrgType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, uTrgType, trg2Trg, mPackage, src2Src,
				uPackage, uSrcType, mSrcType, p2p, uUsage, mTrgType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uTrgType, trg2Trg, mPackage, src2Src, uPackage,
					uSrcType, mSrcType, p2p, uUsage, mTrgType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_499326 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_499326)) {
					if (!uTrgType.equals(__DEC_uUsage_client_499326)) {
						if (!uPackage.equals(__DEC_uUsage_client_499326)) {
							if (!uSrcType.equals(__DEC_uUsage_client_499326)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_288065 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_288065)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_288065)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_288065)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_288065)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
					...
					if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
						...
						if (tmpMSrcType instanceof MClass) {
							...
							if (tmpUUsage instanceof Usage) {
								...
								if (tmpMTrgType instanceof Type) {
									Type mTrgType = (Type) tmpMTrgType;
									return new Object[] { uTrgType, mPackage, uPackage, uSrcType, mSrcType, uUsage,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			Classifier uTrgType, org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage, Type mTrgType, Match sourceMatch,
			Match targetMatch) {
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { uTrgType, mPackage, uPackage, uSrcType, mSrcType, uUsage, mTrgType,
							sourceMatch, targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black = pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					uTrgType, mPackage, uPackage, uSrcType, mSrcType, uUsage, mTrgType, sourceMatch, targetMatch);
			if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { uTrgType, mPackage, uPackage, uSrcType, mSrcType, uUsage, mTrgType, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
		...
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(uTrgType, mPackage, uPackage, uSrcType, mSrcType, uUsage,
				mTrgType, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, uTrgType, mPackage, uPackage, uSrcType, mSrcType, uUsage, mTrgType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_24_3_solvecsp_binding = pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, uTrgType, mPackage, uPackage, uSrcType, mSrcType, uUsage, mTrgType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBFBFBBBFBBB(
			Classifier uTrgType, org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage,
								...
								if (mPackage.equals(p2p.getSource())) {
									for (ASTNode2Element src2Src : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (!src2Src.equals(trg2Trg)) {
											if (uSrcType.equals(src2Src.getTarget())) {
												_result.add(new Object[] { uTrgType, trg2Trg, mPackage, src2Src,
														uPackage, uSrcType, mSrcType, p2p, mTrgType, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(
			Classifier uTrgType, org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage, Type mTrgType, CCMatch ccMatch) {
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				return new Object[] { uTrgType, mPackage, uPackage, uSrcType, mSrcType, uUsage, mTrgType, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_145061 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_145061)) {
					if (!uTrgType.equals(__DEC_uUsage_client_145061)) {
						if (!uPackage.equals(__DEC_uUsage_client_145061)) {
							if (!uSrcType.equals(__DEC_uUsage_client_145061)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_101193 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_101193)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_101193)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_101193)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_101193)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, uTrgType, trg2Trg, mPackage, src2Src,
				uPackage, uSrcType, mSrcType, p2p, mTrgType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uTrgType, trg2Trg, mPackage, src2Src, uPackage,
					uSrcType, mSrcType, p2p, mTrgType, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(
		...
		if (!src2Src.equals(trg2Trg)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
					return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p,
							mTrgType };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(
			Classifier uTrgType, ASTNode2Element trg2Trg, org.eclipse.modisco.java.Package mPackage,
			ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType,
			MClass mSrcType, JavaPackage2UmlPackage p2p, Type mTrgType, ModelgeneratorRuleResult ruleResult) {
		if (!src2Src.equals(trg2Trg)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
					return new Object[] { uTrgType, trg2Trg, mPackage, src2Src, uPackage, uSrcType, mSrcType, p2p,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_greenBBBBFBB(Classifier uTrgType,
		...
		return new Object[] { uTrgType, uPackage, uSrcType, mSrcType, uUsage, mTrgType, ruleResult };
	}
