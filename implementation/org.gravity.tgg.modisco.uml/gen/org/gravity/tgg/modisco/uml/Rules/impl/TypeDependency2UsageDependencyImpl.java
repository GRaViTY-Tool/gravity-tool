...
public class TypeDependency2UsageDependencyImpl extends AbstractRuleImpl implements TypeDependency2UsageDependency {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, trg2Trg,
						uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[trg2Trg] = " + trg2Trg + ", " + "[uUsage] = " + uUsage + ", " + "[p2p] = " + p2p + ", "
					+ "[mPackage] = " + mPackage + ", " + "[uTrgType] = " + uTrgType + ", " + "[mTrgType] = " + mTrgType
					+ ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = " + mSrcType + ", " + "[src2Src] = "
					+ src2Src + ", " + "[uSrcType] = " + uSrcType + ".");
		}
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(ruleresult, uUsage,
						uTrgType, mTrgType, uPackage, mSrcType, uSrcType);
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
						trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFBFBFBFFB(mPackage, mTrgType, mSrcType,
						match)) {
			...
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(trg2Trg, p2p, mPackage,
							uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(trg2Trg, p2p,
								mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType);
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType,
								src2Src, uSrcType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[trg2Trg] = " + trg2Trg + ", "
							+ "[p2p] = " + p2p + ", " + "[mPackage] = " + mPackage + ", " + "[uTrgType] = " + uTrgType
							+ ", " + "[mTrgType] = " + mTrgType + ", " + "[uPackage] = " + uPackage + ", "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element trg2Trg,
			JavaPackage2UmlPackage p2p, org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, Type mTrgType,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, ASTNode2Element src2Src,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject trg2Trg, EObject uUsage, EObject p2p,
			EObject mPackage, EObject uTrgType, EObject mTrgType, EObject uPackage, EObject mSrcType, EObject src2Src,
			EObject uSrcType) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_12_2_corematch_blackFBFFBFBFFBB(uUsage, uTrgType, uPackage,
						uSrcType, match)) {
			ASTNode2Element trg2Trg = (ASTNode2Element) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(trg2Trg, uUsage, p2p,
							mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage,
								mSrcType, src2Src, uSrcType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[trg2Trg] = " + trg2Trg + ", "
							+ "[uUsage] = " + uUsage + ", " + "[p2p] = " + p2p + ", " + "[mPackage] = " + mPackage
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element trg2Trg, Usage uUsage,
			JavaPackage2UmlPackage p2p, org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, Type mTrgType,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, ASTNode2Element src2Src,
			org.eclipse.uml2.uml.Class uSrcType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject trg2Trg, EObject uUsage, EObject p2p,
			EObject mPackage, EObject uTrgType, EObject mTrgType, EObject uPackage, EObject mSrcType, EObject src2Src,
			EObject uSrcType) {
		ruleresult.registerObject("trg2Trg", trg2Trg);
		ruleresult.registerObject("uUsage", uUsage);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_122(EMoflonEdge _edge_client) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_130(EMoflonEdge _edge_dependencies) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, uUsage, mPackage,
						uTrgType, mTrgType, uPackage, mSrcType, uSrcType, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[uUsage] = " + uUsage + ", " + "[mPackage] = " + mPackage + ", " + "[uTrgType] = " + uTrgType
					+ ", " + "[mTrgType] = " + mTrgType + ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = "
					+ mSrcType + ", " + "[uSrcType] = " + uSrcType + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackFFBBBBBFBBB(mPackage, uTrgType,
							mTrgType, uPackage, mSrcType, uSrcType, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(uUsage,
								mPackage, uTrgType, mTrgType, uPackage, mSrcType, uSrcType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uUsage] = " + uUsage
							+ ", " + "[mPackage] = " + mPackage + ", " + "[uTrgType] = " + uTrgType + ", "
							+ "[mTrgType] = " + mTrgType + ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = "
							+ mSrcType + ", " + "[uSrcType] = " + uSrcType + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Usage uUsage, org.eclipse.modisco.java.Package mPackage, Classifier uTrgType,
			Type mTrgType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.uml2.uml.Class uSrcType,
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src,
							uSrcType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[trg2Trg] = " + trg2Trg + ", "
			...
			if (TypeDependency2UsageDependencyImpl
				...
				// 
				Object[] result5_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(trg2Trg, p2p, mPackage,
								uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType);
				if (result5_black != null) {

					Object[] result6_black = TypeDependency2UsageDependencyImpl
							.pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(trg2Trg, p2p, mPackage,
									uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[trg2Trg] = "
								+ trg2Trg + ", " + "[p2p] = " + p2p + ", " + "[mPackage] = " + mPackage + ", "
								+ "[uTrgType] = " + uTrgType + ", " + "[mTrgType] = " + mTrgType + ", "
								+ "[uPackage] = " + uPackage + ", " + "[mSrcType] = " + mSrcType + ", " + "[src2Src] = "
								+ src2Src + ", " + "[uSrcType] = " + uSrcType + ", " + "[ruleResult] = " + ruleResult
								+ ".");
					}
					TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_29_6_perform_greenFBBBBBB(
							uTrgType, mTrgType, uPackage, mSrcType, uSrcType, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_JAVAPACKAGE2UMLPACKAGE_PACKAGE_CLASSIFIER_TYPE_PACKAGE_MCLASS_ASTNODE2ELEMENT_CLASS:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(JavaPackage2UmlPackage) arguments.get(2), (org.eclipse.modisco.java.Package) arguments.get(3),
					(Classifier) arguments.get(4), (Type) arguments.get(5),
					(org.eclipse.uml2.uml.Package) arguments.get(6), (MClass) arguments.get(7),
					(ASTNode2Element) arguments.get(8), (org.eclipse.uml2.uml.Class) arguments.get(9));
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_USAGE_JAVAPACKAGE2UMLPACKAGE_PACKAGE_CLASSIFIER_TYPE_PACKAGE_MCLASS_ASTNODE2ELEMENT_CLASS:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(Usage) arguments.get(2), (JavaPackage2UmlPackage) arguments.get(3),
					(org.eclipse.modisco.java.Package) arguments.get(4), (Classifier) arguments.get(5),
					(Type) arguments.get(6), (org.eclipse.uml2.uml.Package) arguments.get(7), (MClass) arguments.get(8),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_122__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_122((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_130__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_CC__USAGE_PACKAGE_CLASSIFIER_TYPE_PACKAGE_MCLASS_CLASS_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Usage) arguments.get(0),
					(org.eclipse.modisco.java.Package) arguments.get(1), (Classifier) arguments.get(2),
					(Type) arguments.get(3), (org.eclipse.uml2.uml.Package) arguments.get(4), (MClass) arguments.get(5),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_JAVAPACKAGE2UMLPACKAGE_PACKAGE_CLASSIFIER_TYPE_PACKAGE_MCLASS_ASTNODE2ELEMENT_CLASS_MODELGENERATORRULERESULT:
								...
								if (tmpMSrcType instanceof MClass) {
									...
									if (tmpSrc2Src instanceof ASTNode2Element) {
										...
										if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
											...
											return new Object[] { trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage,
													mSrcType, src2Src, uSrcType, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
			ASTNode2Element trg2Trg, JavaPackage2UmlPackage p2p, org.eclipse.modisco.java.Package mPackage,
			Classifier uTrgType, Type mTrgType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
				...
				if (!uSrcType.equals(uTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black = pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
					trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black != null) {
				...
				return new Object[] { trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject trg2Trg, EObject uUsage, EObject p2p, EObject mPackage,
			EObject uTrgType, EObject mTrgType, EObject uPackage, EObject mSrcType, EObject src2Src, EObject uSrcType) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject uUsage, EObject uTrgType, EObject mTrgType, EObject uPackage,
		...
		mSrcType__mTrgType____dependencies.setName(mSrcType__mTrgType____dependencies_name_prime);
		return new Object[] { ruleresult, uUsage, uTrgType, mTrgType, uPackage, mSrcType, uSrcType,
	...
	public static final void pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, PerformRuleResult ruleresult, EObject trg2Trg, EObject uUsage,
			EObject p2p, EObject mPackage, EObject uTrgType, EObject mTrgType, EObject uPackage, EObject mSrcType,
			EObject src2Src, EObject uSrcType) {
		_this.registerObjects_FWD(ruleresult, trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType,
				src2Src, uSrcType);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFBFBFBFFB(
							...
							if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
								...
								if (!uSrcType.equals(uTrgType)) {
									for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (uPackage != null) {
											_result.add(new Object[] { trg2Trg, p2p, mPackage, uTrgType, mTrgType,
													uPackage, mSrcType, src2Src, uSrcType, match });
										}
											...
											if (uSrcType.equals(src2Src.getTarget())) {
												if (mSrcType.getDependencies().contains(mTrgType)) {
													if (mPackage.equals(p2p.getSource())) {
														_result.add(new Object[] { trg2Trg, p2p, mPackage, uTrgType,
																mTrgType, uPackage, mSrcType, src2Src, uSrcType });
													}
												}
											}
										}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType,
				...
				src2Src__uSrcType____target, mSrcType__mTrgType____dependencies, p2p__mPackage____source };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, ASTNode2Element src2Src,
			org.eclipse.uml2.uml.Class uSrcType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, trg2Trg, p2p, mPackage, uTrgType,
				mTrgType, uPackage, mSrcType, src2Src, uSrcType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage,
					mSrcType, src2Src, uSrcType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src,
				uSrcType);
		if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, trg2Trg, p2p, mPackage, uTrgType, mTrgType,
						uPackage, mSrcType, src2Src, uSrcType };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_greenBBBBBFFF(
		...
		uUsage__uTrgType____supplier.setName(uUsage__uTrgType____supplier_name_prime);
		uPackage__uUsage____packagedElement.setName(uPackage__uUsage____packagedElement_name_prime);
		return new Object[] { match, uUsage, uTrgType, uPackage, uSrcType, uUsage__uSrcType____client,
								...
								if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
									...
									if (tmpMSrcType instanceof MClass) {
										...
										if (tmpSrc2Src instanceof ASTNode2Element) {
											...
											if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
												org.eclipse.uml2.uml.Class uSrcType = (org.eclipse.uml2.uml.Class) tmpUSrcType;
												return new Object[] { trg2Trg, uUsage, p2p, mPackage, uTrgType,
														mTrgType, uPackage, mSrcType, src2Src, uSrcType,
														isApplicableMatch };
											}
										}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
			ASTNode2Element trg2Trg, Usage uUsage, JavaPackage2UmlPackage p2p,
			...
			if (!src2Src.equals(trg2Trg)) {
				if (!uSrcType.equals(uTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage,
									mSrcType, src2Src, uSrcType, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black = pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
					trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black != null) {
				...
				return new Object[] { trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src,
	...
	public static final void pattern_TypeDependency2UsageDependency_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject p2p, EObject mPackage, EObject uTrgType, EObject mTrgType, EObject uPackage, EObject mSrcType,
			EObject src2Src, EObject uSrcType) {
		_this.registerObjects_BWD(ruleresult, trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType,
				src2Src, uSrcType);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_2_corematch_blackFBFFBFBFFBB(
							...
							for (ASTNode2Element src2Src : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!src2Src.equals(trg2Trg)) {
									...
									if (tmpMSrcType instanceof MClass) {
										MClass mSrcType = (MClass) tmpMSrcType;
										if (!mSrcType.equals(mTrgType)) {
											_result.add(new Object[] { trg2Trg, uUsage, p2p, mPackage, uTrgType,
													mTrgType, uPackage, mSrcType, src2Src, uSrcType, match });
										}
									}
												...
												if (mPackage.getOwnedElements().contains(mSrcType)) {
													if (uSrcType.equals(src2Src.getTarget())) {
														if (uPackage.getPackagedElements().contains(uUsage)) {
															if (mPackage.equals(p2p.getSource())) {
																_result.add(new Object[] { trg2Trg, uUsage, p2p,
																		mPackage, uTrgType, mTrgType, uPackage,
																		mSrcType, src2Src, uSrcType });
															}
														}
													}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(
		...
		uPackage__uUsage____packagedElement.setName(uPackage__uUsage____packagedElement_name_prime);
		p2p__mPackage____source.setName(p2p__mPackage____source_name_prime);
		return new Object[] { trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType,
				isApplicableMatch, uUsage__uSrcType____client, uUsage__uTrgType____supplier,
				trg2Trg__mTrgType____source, trg2Trg__uTrgType____target, uPackage__uSrcType____ownedElement,
				uSrcType__uPackage____owner, src2Src__mSrcType____source, p2p__uPackage____target,
				mPackage__mSrcType____ownedElements, mSrcType__mPackage____package, src2Src__uSrcType____target,
				uPackage__uUsage____packagedElement, p2p__mPackage____source };
	}

	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch, ASTNode2Element trg2Trg,
			Usage uUsage, JavaPackage2UmlPackage p2p, org.eclipse.modisco.java.Package mPackage, Classifier uTrgType,
			Type mTrgType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, ASTNode2Element src2Src,
			org.eclipse.uml2.uml.Class uSrcType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, trg2Trg, uUsage, p2p, mPackage,
				uTrgType, mTrgType, uPackage, mSrcType, src2Src, uSrcType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType,
					uPackage, mSrcType, src2Src, uSrcType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_12_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, trg2Trg, uUsage, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType,
				src2Src, uSrcType);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_144737 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_144737)) {
					if (!uTrgType.equals(__DEC_uUsage_client_144737)) {
						if (!uPackage.equals(__DEC_uUsage_client_144737)) {
							if (!uSrcType.equals(__DEC_uUsage_client_144737)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_212556 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_212556)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_212556)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_212556)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_212556)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
					...
					if (tmpMTrgType instanceof Type) {
						...
						if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
							...
							if (tmpMSrcType instanceof MClass) {
								...
								if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
									org.eclipse.uml2.uml.Class uSrcType = (org.eclipse.uml2.uml.Class) tmpUSrcType;
									return new Object[] { uUsage, mPackage, uTrgType, mTrgType, uPackage, mSrcType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			Usage uUsage, org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, Type mTrgType,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.uml2.uml.Class uSrcType,
			Match sourceMatch, Match targetMatch) {
		if (!mSrcType.equals(mTrgType)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { uUsage, mPackage, uTrgType, mTrgType, uPackage, mSrcType, uSrcType,
							sourceMatch, targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black = pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					uUsage, mPackage, uTrgType, mTrgType, uPackage, mSrcType, uSrcType, sourceMatch, targetMatch);
			if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { uUsage, mPackage, uTrgType, mTrgType, uPackage, mSrcType, uSrcType, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
			TypeDependency2UsageDependency _this, Usage uUsage, org.eclipse.modisco.java.Package mPackage,
			Classifier uTrgType, Type mTrgType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
			org.eclipse.uml2.uml.Class uSrcType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(uUsage, mPackage, uTrgType, mTrgType, uPackage, mSrcType,
				uSrcType, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, uUsage, mPackage, uTrgType, mTrgType, uPackage, mSrcType, uSrcType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_24_3_solvecsp_binding = pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, uUsage, mPackage, uTrgType, mTrgType, uPackage, mSrcType, uSrcType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackFFBBBBBFBBB(
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, Type mTrgType,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.uml2.uml.Class uSrcType,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
								...
								if (!src2Src.equals(trg2Trg)) {
									if (uSrcType.equals(src2Src.getTarget())) {
										for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
											...
											if (mPackage.equals(p2p.getSource())) {
												_result.add(new Object[] { trg2Trg, p2p, mPackage, uTrgType, mTrgType,
														uPackage, mSrcType, src2Src, uSrcType, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(
		...
		if (!mSrcType.equals(mTrgType)) {
			if (!uSrcType.equals(uTrgType)) {
				return new Object[] { uUsage, mPackage, uTrgType, mTrgType, uPackage, mSrcType, uSrcType, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_654506 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_654506)) {
					if (!uTrgType.equals(__DEC_uUsage_client_654506)) {
						if (!uPackage.equals(__DEC_uUsage_client_654506)) {
							if (!uSrcType.equals(__DEC_uUsage_client_654506)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_309721 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_309721)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_309721)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_309721)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_309721)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, trg2Trg, p2p, mPackage, uTrgType,
				mTrgType, uPackage, mSrcType, src2Src, uSrcType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage,
					mSrcType, src2Src, uSrcType, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, trg2Trg, p2p, mPackage, uTrgType, mTrgType,
						uPackage, mSrcType, src2Src, uSrcType, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(
		...
		if (!mSrcType.equals(mTrgType)) {
			if (!src2Src.equals(trg2Trg)) {
				if (!uSrcType.equals(uTrgType)) {
					return new Object[] { trg2Trg, p2p, mPackage, uTrgType, mTrgType, uPackage, mSrcType, src2Src,
							uSrcType };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_greenFBBBBBB(Classifier uTrgType,
		...
		return new Object[] { uUsage, uTrgType, mTrgType, uPackage, mSrcType, uSrcType, ruleResult };
	}
