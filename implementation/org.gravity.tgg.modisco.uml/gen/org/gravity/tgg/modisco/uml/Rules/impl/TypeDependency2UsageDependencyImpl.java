...
public class TypeDependency2UsageDependencyImpl extends AbstractRuleImpl implements TypeDependency2UsageDependency {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result1_bindingAndBlack[0];
		...
		NamedElement2NamedElement src2Src = (NamedElement2NamedElement) result1_bindingAndBlack[4];
		...
		Object[] result1_green = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_1_performtransformation_greenFBBB(uTrgType, uSrcType,
						uPackage);
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, uUsage,
						trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uUsage] = " + uUsage + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[mSrcType] = "
					+ mSrcType + ", " + "[p2p] = " + p2p + ", " + "[mTrgType] = " + mTrgType + ", " + "[src2Src] = "
					+ src2Src + ", " + "[uTrgType] = " + uTrgType + ", " + "[uSrcType] = " + uSrcType + ", "
					+ "[mPackage] = " + mPackage + ", " + "[uPackage] = " + uPackage + ".");
		}
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(ruleresult, uUsage,
						mSrcType, mTrgType, uTrgType, uSrcType, uPackage);
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
						uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_2_2_corematch_blackFBFBFFFBFB(mSrcType, mTrgType, mPackage,
						match)) {
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result2_black[0];
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result2_black[2];
			NamedElement2NamedElement src2Src = (NamedElement2NamedElement) result2_black[4];
			...
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(trg2Trg, mSrcType, p2p,
							mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(trg2Trg,
								mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage);
				...
				//nothing EMoflonEdge mSrcType__mTrgType____dependencies = (EMoflonEdge) result3_green[17];
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType,
								mPackage, uPackage);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[trg2Trg] = " + trg2Trg + ", "
							+ "[mSrcType] = " + mSrcType + ", " + "[p2p] = " + p2p + ", " + "[mTrgType] = " + mTrgType
							+ ", " + "[src2Src] = " + src2Src + ", " + "[uTrgType] = " + uTrgType + ", "
							+ "[uSrcType] = " + uSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[uPackage] = "
							+ uPackage + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, NamedElement2NamedElement trg2Trg,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject uUsage, EObject trg2Trg, EObject mSrcType,
	...
	public boolean isAppropriate_BWD(Match match, Usage uUsage, Classifier uTrgType,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result1_bindingAndBlack[1];
		...
		org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) result1_bindingAndBlack[9];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_12_2_corematch_blackBFFFFFBBFBB(uUsage, uTrgType, uSrcType,
						uPackage, match)) {
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result2_black[1];
			MClass mSrcType = (MClass) result2_black[2];
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result2_black[3];
			Type mTrgType = (Type) result2_black[4];
			...
			// ForEach 
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(uUsage, trg2Trg, mSrcType,
							p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
				...
				//nothing EMoflonEdge trg2Trg__mTrgType____source = (EMoflonEdge) result3_green[13];
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType,
								uSrcType, mPackage, uPackage);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uUsage] = " + uUsage + ", "
							+ "[trg2Trg] = " + trg2Trg + ", " + "[mSrcType] = " + mSrcType + ", " + "[p2p] = " + p2p
							+ ", " + "[mTrgType] = " + mTrgType + ", " + "[src2Src] = " + src2Src + ", "
							+ "[uTrgType] = " + uTrgType + ", " + "[uSrcType] = " + uSrcType + ", " + "[mPackage] = "
							+ mPackage + ", " + "[uPackage] = " + uPackage + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
				if (TypeDependency2UsageDependencyImpl
	...
	public CSP isAppropriate_solveCsp_BWD(Match match, Usage uUsage, Classifier uTrgType,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Usage uUsage,
			NamedElement2NamedElement trg2Trg, MClass mSrcType, JavaPackage2UmlPackage p2p, Type mTrgType,
			NamedElement2NamedElement src2Src, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject uUsage, EObject trg2Trg, EObject mSrcType,
			EObject p2p, EObject mTrgType, EObject src2Src, EObject uTrgType, EObject uSrcType, EObject mPackage,
			EObject uPackage) {
		ruleresult.registerObject("uUsage", uUsage);
		ruleresult.registerObject("trg2Trg", trg2Trg);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_103(EMoflonEdge _edge_client) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			if (TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
							this, match, uUsage, uTrgType, uSrcType, uPackage)) {
				// 
				if (TypeDependency2UsageDependencyImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_108(EMoflonEdge _edge_dependencies) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, uUsage, mSrcType,
						mTrgType, uTrgType, uSrcType, mPackage, uPackage, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[uUsage] = " + uUsage + ", " + "[mSrcType] = " + mSrcType + ", " + "[mTrgType] = " + mTrgType
					+ ", " + "[uTrgType] = " + uTrgType + ", " + "[uSrcType] = " + uSrcType + ", " + "[mPackage] = "
					+ mPackage + ", " + "[uPackage] = " + uPackage + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackFBFBFBBBBBB(mSrcType, mTrgType,
							uTrgType, uSrcType, mPackage, uPackage, sourceMatch, targetMatch)) {
				NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result5_black[0];
				JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result5_black[2];
				NamedElement2NamedElement src2Src = (NamedElement2NamedElement) result5_black[4];
				...
				Object[] result6_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(uUsage,
								mSrcType, mTrgType, uTrgType, uSrcType, mPackage, uPackage, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uUsage] = " + uUsage
							+ ", " + "[mSrcType] = " + mSrcType + ", " + "[mTrgType] = " + mTrgType + ", "
							+ "[uTrgType] = " + uTrgType + ", " + "[uSrcType] = " + uSrcType + ", " + "[mPackage] = "
							+ mPackage + ", " + "[uPackage] = " + uPackage + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Usage uUsage, MClass mSrcType, Type mTrgType, Classifier uTrgType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Usage uUsage, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage) {// 
		Object[] result1_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_blackBBBB(uUsage, uTrgType, uSrcType,
						uPackage);
		if (result1_black != null) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage,
							uPackage, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[trg2Trg] = " + trg2Trg + ", "
						+ "[mSrcType] = " + mSrcType + ", " + "[p2p] = " + p2p + ", " + "[mTrgType] = " + mTrgType
						+ ", " + "[src2Src] = " + src2Src + ", " + "[uTrgType] = " + uTrgType + ", " + "[uSrcType] = "
						+ uSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[uPackage] = " + uPackage + ", "
			...
			if (TypeDependency2UsageDependencyImpl
				...
				// 
				Object[] result5_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(trg2Trg, mSrcType, p2p,
								mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage);
				if (result5_black != null) {

					Object[] result6_black = TypeDependency2UsageDependencyImpl
							.pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(trg2Trg, mSrcType, p2p,
									mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[trg2Trg] = "
								+ trg2Trg + ", " + "[mSrcType] = " + mSrcType + ", " + "[p2p] = " + p2p + ", "
								+ "[mTrgType] = " + mTrgType + ", " + "[src2Src] = " + src2Src + ", " + "[uTrgType] = "
								+ uTrgType + ", " + "[uSrcType] = " + uSrcType + ", " + "[mPackage] = " + mPackage
								+ ", " + "[uPackage] = " + uPackage + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_29_6_perform_greenFBBBBBB(
							mSrcType, mTrgType, uTrgType, uSrcType, uPackage, ruleResult);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, NamedElement2NamedElement trg2Trg,
			MClass mSrcType, JavaPackage2UmlPackage p2p, Type mTrgType, NamedElement2NamedElement src2Src,
			Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage,
			org.eclipse.uml2.uml.Package uPackage, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_NAMEDELEMENT2NAMEDELEMENT_MCLASS_JAVAPACKAGE2UMLPACKAGE_TYPE_NAMEDELEMENT2NAMEDELEMENT_CLASSIFIER_CLASS_PACKAGE_PACKAGE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(NamedElement2NamedElement) arguments.get(1), (MClass) arguments.get(2),
					(JavaPackage2UmlPackage) arguments.get(3), (Type) arguments.get(4),
					(NamedElement2NamedElement) arguments.get(5), (Classifier) arguments.get(6),
					(org.eclipse.uml2.uml.Class) arguments.get(7), (org.eclipse.modisco.java.Package) arguments.get(8),
					(org.eclipse.uml2.uml.Package) arguments.get(9));
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD__MATCH_USAGE_CLASSIFIER_CLASS_PACKAGE:
			return isAppropriate_BWD((Match) arguments.get(0), (Usage) arguments.get(1), (Classifier) arguments.get(2),
					(org.eclipse.uml2.uml.Class) arguments.get(3), (org.eclipse.uml2.uml.Package) arguments.get(4));
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_USAGE_CLASSIFIER_CLASS_PACKAGE:
			...
			return null;
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_USAGE_CLASSIFIER_CLASS_PACKAGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_USAGE_NAMEDELEMENT2NAMEDELEMENT_MCLASS_JAVAPACKAGE2UMLPACKAGE_TYPE_NAMEDELEMENT2NAMEDELEMENT_CLASSIFIER_CLASS_PACKAGE_PACKAGE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Usage) arguments.get(1),
					(NamedElement2NamedElement) arguments.get(2), (MClass) arguments.get(3),
					(JavaPackage2UmlPackage) arguments.get(4), (Type) arguments.get(5),
					(NamedElement2NamedElement) arguments.get(6), (Classifier) arguments.get(7),
					(org.eclipse.uml2.uml.Class) arguments.get(8), (org.eclipse.modisco.java.Package) arguments.get(9),
					(org.eclipse.uml2.uml.Package) arguments.get(10));
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_103__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_103((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_108__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_CC__USAGE_MCLASS_TYPE_CLASSIFIER_CLASS_PACKAGE_PACKAGE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Usage) arguments.get(0), (MClass) arguments.get(1),
					(Type) arguments.get(2), (Classifier) arguments.get(3),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___CHECK_DEC_BWD__USAGE_CLASSIFIER_CLASS_PACKAGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_NAMEDELEMENT2NAMEDELEMENT_MCLASS_JAVAPACKAGE2UMLPACKAGE_TYPE_NAMEDELEMENT2NAMEDELEMENT_CLASSIFIER_CLASS_PACKAGE_PACKAGE_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(NamedElement2NamedElement) arguments.get(1), (MClass) arguments.get(2),
					(JavaPackage2UmlPackage) arguments.get(3), (Type) arguments.get(4),
					(NamedElement2NamedElement) arguments.get(5), (Classifier) arguments.get(6),
					(org.eclipse.uml2.uml.Class) arguments.get(7), (org.eclipse.modisco.java.Package) arguments.get(8),
					(org.eclipse.uml2.uml.Package) arguments.get(9), (ModelgeneratorRuleResult) arguments.get(10));
								...
								if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
									...
									if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
										...
										if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
											...
											return new Object[] { trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType,
													uSrcType, mPackage, uPackage, isApplicableMatch };
										}
									}
								}
							}
				...
				if (!uSrcType.equals(uTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType,
									mPackage, uPackage, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding != null) {
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding[0];
			...
			NamedElement2NamedElement src2Src = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding[4];
			...
			org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding[8];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black = pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
					trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black != null) {
				...
				return new Object[] { trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject uUsage, EObject trg2Trg, EObject mSrcType, EObject p2p,
			EObject mTrgType, EObject src2Src, EObject uTrgType, EObject uSrcType, EObject mPackage, EObject uPackage) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject uUsage, EObject mSrcType, EObject mTrgType, EObject uTrgType,
			EObject uSrcType, EObject uPackage) {
		...
		mSrcType__mTrgType____dependencies.setName(mSrcType__mTrgType____dependencies_name_prime);
		return new Object[] { ruleresult, uUsage, mSrcType, mTrgType, uTrgType, uSrcType, uPackage,
	...
	public static final void pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, PerformRuleResult ruleresult, EObject uUsage, EObject trg2Trg,
			EObject mSrcType, EObject p2p, EObject mTrgType, EObject src2Src, EObject uTrgType, EObject uSrcType,
			EObject mPackage, EObject uPackage) {
		_this.registerObjects_FWD(ruleresult, uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType,
				mPackage, uPackage);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_2_corematch_blackFBFBFFFBFB(
							...
							if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
								...
								if (!uSrcType.equals(uTrgType)) {
									for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (uPackage != null) {
											_result.add(new Object[] { trg2Trg, mSrcType, p2p, mTrgType, src2Src,
													uTrgType, uSrcType, mPackage, uPackage, match });
										}
											...
											if (mSrcType.getDependencies().contains(mTrgType)) {
												if (uSrcType.equals(src2Src.getTarget())) {
													if (mPackage.getOwnedElements().contains(mSrcType)) {
														_result.add(new Object[] { trg2Trg, mSrcType, p2p, mTrgType,
																src2Src, uTrgType, uSrcType, mPackage, uPackage });
													}
												}
											}
										}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage,
				...
				src2Src__mSrcType____source, p2p__mPackage____source, p2p__uPackage____target,
				uPackage__uSrcType____ownedElement, uSrcType__uPackage____owner, mSrcType__mTrgType____dependencies,
				src2Src__uSrcType____target, mPackage__mSrcType____ownedElements, mSrcType__mPackage____package };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			NamedElement2NamedElement src2Src, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, trg2Trg, mSrcType, p2p, mTrgType,
				src2Src, uTrgType, uSrcType, mPackage, uPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType,
					uSrcType, mPackage, uPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage,
				uPackage);
		if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, trg2Trg, mSrcType, p2p, mTrgType, src2Src,
						uTrgType, uSrcType, mPackage, uPackage };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_1_initialbindings_blackBBBBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			return new Object[] { _this, match, uUsage, uTrgType, uSrcType, uPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_2_SolveCSP_bindingFBBBBBB(
			TypeDependency2UsageDependency _this, Match match, Usage uUsage, Classifier uTrgType,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, uUsage, uTrgType, uSrcType, uPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, uUsage, uTrgType, uSrcType, uPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_10_2_SolveCSP_binding = pattern_TypeDependency2UsageDependency_10_2_SolveCSP_bindingFBBBBBB(
				_this, match, uUsage, uTrgType, uSrcType, uPackage);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_blackBBBBB(
			Match match, Usage uUsage, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			return new Object[] { match, uUsage, uTrgType, uSrcType, uPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_greenBBBBBFFF(
		...
		uUsage__uTrgType____supplier.setName(uUsage__uTrgType____supplier_name_prime);
		uPackage__uUsage____packagedElement.setName(uPackage__uUsage____packagedElement_name_prime);
		return new Object[] { match, uUsage, uTrgType, uSrcType, uPackage, uUsage__uSrcType____client,
	...
	public static final void pattern_TypeDependency2UsageDependency_10_6_registerobjectstomatch_expressionBBBBBB(
			TypeDependency2UsageDependency _this, Match match, Usage uUsage, Classifier uTrgType,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage) {
		_this.registerObjectsToMatch_BWD(match, uUsage, uTrgType, uSrcType, uPackage);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingFFFFFFFFFFB(
		...
		EObject _localVariable_9 = isApplicableMatch.getObject("uPackage");
		...
		EObject tmpUPackage = _localVariable_9;
								...
								if (tmpUTrgType instanceof Classifier) {
									...
									if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
										...
										if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
											...
											if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
												org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) tmpUPackage;
												return new Object[] { uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src,
														uTrgType, uSrcType, mPackage, uPackage, isApplicableMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
			Usage uUsage, NamedElement2NamedElement trg2Trg, MClass mSrcType, JavaPackage2UmlPackage p2p, Type mTrgType,
			NamedElement2NamedElement src2Src, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage,
			TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch) {
		if (!mSrcType.equals(mTrgType)) {
			if (!src2Src.equals(trg2Trg)) {
				if (!uSrcType.equals(uTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType,
									mPackage, uPackage, csp, _this, isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding != null) {
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[1];
			MClass mSrcType = (MClass) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[2];
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[3];
			Type mTrgType = (Type) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[4];
			NamedElement2NamedElement src2Src = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[5];
			...
			org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[9];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black = pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
					uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black != null) {
				...
				return new Object[] { uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage,
						uPackage, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final void pattern_TypeDependency2UsageDependency_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject mSrcType, EObject p2p, EObject mTrgType, EObject src2Src, EObject uTrgType, EObject uSrcType,
			EObject mPackage, EObject uPackage) {
		_this.registerObjects_BWD(ruleresult, uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType,
				mPackage, uPackage);
		...
		if (tmpUUsage instanceof Usage) {
			...
			if (tmpUTrgType instanceof Classifier) {
				...
				if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
					...
					if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
						org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) tmpUPackage;
						return new Object[] { uUsage, uTrgType, uSrcType, uPackage, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_2_corematch_blackBFFFFFBBFBB(
							...
							for (NamedElement2NamedElement src2Src : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!src2Src.equals(trg2Trg)) {
									...
									if (tmpMSrcType instanceof MClass) {
										MClass mSrcType = (MClass) tmpMSrcType;
										if (!mSrcType.equals(mTrgType)) {
											_result.add(new Object[] { uUsage, trg2Trg, mSrcType, p2p, mTrgType,
													src2Src, uTrgType, uSrcType, mPackage, uPackage, match });
										}
									}
											...
											if (uPackage.equals(p2p.getTarget())) {
												if (uPackage.getOwnedElements().contains(uSrcType)) {
													if (uPackage.getPackagedElements().contains(uUsage)) {
														if (uSrcType.equals(src2Src.getTarget())) {
															if (mPackage.getOwnedElements().contains(mSrcType)) {
																_result.add(new Object[] { uUsage, trg2Trg, mSrcType,
																		p2p, mTrgType, src2Src, uTrgType, uSrcType,
																		mPackage, uPackage });
															}
														}
													}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(
		...
		mPackage__mSrcType____ownedElements.setName(mPackage__mSrcType____ownedElements_name_prime);
		mSrcType__mPackage____package.setName(mSrcType__mPackage____package_name_prime);
		return new Object[] { uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage,
				isApplicableMatch, uUsage__uSrcType____client, uUsage__uTrgType____supplier,
				trg2Trg__mTrgType____source, trg2Trg__uTrgType____target, src2Src__mSrcType____source,
				p2p__mPackage____source, p2p__uPackage____target, uPackage__uSrcType____ownedElement,
				uSrcType__uPackage____owner, uPackage__uUsage____packagedElement, src2Src__uSrcType____target,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			...
			NamedElement2NamedElement src2Src, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, uUsage, trg2Trg, mSrcType, p2p,
				mTrgType, src2Src, uTrgType, uSrcType, mPackage, uPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src,
					uTrgType, uSrcType, mPackage, uPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_12_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, uUsage, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType,
				mPackage, uPackage);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_648029 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_648029)) {
					if (!uTrgType.equals(__DEC_uUsage_client_648029)) {
						if (!uSrcType.equals(__DEC_uUsage_client_648029)) {
							if (!uPackage.equals(__DEC_uUsage_client_648029)) {
								return new Object[] { uUsage, uTrgType, uSrcType, uPackage };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_532311 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_532311)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_532311)) {
						if (!uSrcType.equals(__DEC_uUsage_supplier_532311)) {
							if (!uPackage.equals(__DEC_uUsage_supplier_532311)) {
								return new Object[] { uUsage, uTrgType, uSrcType, uPackage };
							}
						}
					}
													...
													if (pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
														...
														if (pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
															...
															if (pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_2BB(
																...
																_result.add(new Object[] { uUsage, uTrgType, uSrcType,
	...
	public static final boolean pattern_TypeDependency2UsageDependency_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			TypeDependency2UsageDependency _this, Match match, Usage uUsage, Classifier uTrgType,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, uUsage, uTrgType, uSrcType, uPackage);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
					...
					if (tmpUTrgType instanceof Classifier) {
						...
						if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
							...
							if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
								...
								if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
									org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) tmpUPackage;
									return new Object[] { uUsage, mSrcType, mTrgType, uTrgType, uSrcType, mPackage,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			Usage uUsage, MClass mSrcType, Type mTrgType, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage, Match sourceMatch,
			Match targetMatch) {
		if (!mSrcType.equals(mTrgType)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { uUsage, mSrcType, mTrgType, uTrgType, uSrcType, mPackage, uPackage,
							sourceMatch, targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black = pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					uUsage, mSrcType, mTrgType, uTrgType, uSrcType, mPackage, uPackage, sourceMatch, targetMatch);
			if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { uUsage, mSrcType, mTrgType, uTrgType, uSrcType, mPackage, uPackage, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
			TypeDependency2UsageDependency _this, Usage uUsage, MClass mSrcType, Type mTrgType, Classifier uTrgType,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage,
			org.eclipse.uml2.uml.Package uPackage, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(uUsage, mSrcType, mTrgType, uTrgType, uSrcType, mPackage,
				uPackage, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, uUsage, mSrcType, mTrgType, uTrgType, uSrcType, mPackage, uPackage,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_24_3_solvecsp_binding = pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, uUsage, mSrcType, mTrgType, uTrgType, uSrcType, mPackage, uPackage, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackFBFBFBBBBBB(
			MClass mSrcType, Type mTrgType, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mSrcType.equals(mTrgType)) {
								...
								if (!src2Src.equals(trg2Trg)) {
									if (uSrcType.equals(src2Src.getTarget())) {
										for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
											...
											if (uPackage.equals(p2p.getTarget())) {
												_result.add(new Object[] { trg2Trg, mSrcType, p2p, mTrgType, src2Src,
														uTrgType, uSrcType, mPackage, uPackage, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(
			Usage uUsage, MClass mSrcType, Type mTrgType, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Package uPackage, CCMatch ccMatch) {
		if (!mSrcType.equals(mTrgType)) {
			if (!uSrcType.equals(uTrgType)) {
				return new Object[] { uUsage, mSrcType, mTrgType, uTrgType, uSrcType, mPackage, uPackage, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_266398 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_266398)) {
					if (!uTrgType.equals(__DEC_uUsage_client_266398)) {
						if (!uSrcType.equals(__DEC_uUsage_client_266398)) {
							if (!uPackage.equals(__DEC_uUsage_client_266398)) {
								return new Object[] { uUsage, uTrgType, uSrcType, uPackage };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_295593 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_295593)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_295593)) {
						if (!uSrcType.equals(__DEC_uUsage_supplier_295593)) {
							if (!uPackage.equals(__DEC_uUsage_supplier_295593)) {
								return new Object[] { uUsage, uTrgType, uSrcType, uPackage };
							}
						}
					}
											...
											if (pattern_TypeDependency2UsageDependency_29_2_isapplicablecore_black_nac_2BB(
												...
												for (EObject tmpSrc2Src : src2SrcList.getEntryObjects()) {
													if (tmpSrc2Src instanceof NamedElement2NamedElement) {
														NamedElement2NamedElement src2Src = (NamedElement2NamedElement) tmpSrc2Src;
														if (!src2Src.equals(trg2Trg)) {
															org.eclipse.modisco.java.NamedElement tmpMSrcType = src2Src
																	.getSource();
															if (tmpMSrcType instanceof MClass) {
																MClass mSrcType = (MClass) tmpMSrcType;
																if (!mSrcType.equals(mTrgType)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, trg2Trg, mSrcType, p2p, mTrgType,
				src2Src, uTrgType, uSrcType, mPackage, uPackage, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType,
					uSrcType, mPackage, uPackage, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, trg2Trg, mSrcType, p2p, mTrgType, src2Src,
						uTrgType, uSrcType, mPackage, uPackage, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(
		...
		if (!mSrcType.equals(mTrgType)) {
			if (!src2Src.equals(trg2Trg)) {
				if (!uSrcType.equals(uTrgType)) {
					return new Object[] { trg2Trg, mSrcType, p2p, mTrgType, src2Src, uTrgType, uSrcType, mPackage,
							uPackage };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_greenFBBBBBB(MClass mSrcType,
			Type mTrgType, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
		...
		return new Object[] { uUsage, mSrcType, mTrgType, uTrgType, uSrcType, uPackage, ruleResult };
	}
