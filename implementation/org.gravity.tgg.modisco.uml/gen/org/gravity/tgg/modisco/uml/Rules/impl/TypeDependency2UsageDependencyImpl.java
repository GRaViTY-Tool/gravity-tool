...
public class TypeDependency2UsageDependencyImpl extends AbstractRuleImpl implements TypeDependency2UsageDependency {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, uPackage,
						src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType, uUsage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uPackage] = " + uPackage + ", " + "[src2Src] = " + src2Src + ", " + "[p2p] = " + p2p
					+ ", " + "[mPackage] = " + mPackage + ", " + "[uTrgType] = " + uTrgType + ", " + "[trg2Trg] = "
					+ trg2Trg + ", " + "[mTrgType] = " + mTrgType + ", " + "[uSrcType] = " + uSrcType + ", "
					+ "[mSrcType] = " + mSrcType + ", " + "[uUsage] = " + uUsage + ".");
		}
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(ruleresult, uPackage,
						uTrgType, mTrgType, uSrcType, mSrcType, uUsage);
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
						uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType, uUsage);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFFBFFBFBB(mPackage, mTrgType, mSrcType,
						match)) {
			...
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(uPackage, src2Src, p2p,
							mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(uPackage,
								src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType);
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType,
								uSrcType, mSrcType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uPackage] = " + uPackage + ", "
							+ "[src2Src] = " + src2Src + ", " + "[p2p] = " + p2p + ", " + "[mPackage] = " + mPackage
							+ ", " + "[uTrgType] = " + uTrgType + ", " + "[trg2Trg] = " + trg2Trg + ", "
							+ "[mTrgType] = " + mTrgType + ", " + "[uSrcType] = " + uSrcType + ", " + "[mSrcType] = "
							+ mSrcType + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Package uPackage,
			ASTNode2Element src2Src, JavaPackage2UmlPackage p2p, org.eclipse.modisco.java.Package mPackage,
			Classifier uTrgType, ASTNode2Element trg2Trg, Type mTrgType, org.eclipse.uml2.uml.Class uSrcType,
			MClass mSrcType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject uPackage, EObject src2Src, EObject p2p,
			EObject mPackage, EObject uTrgType, EObject trg2Trg, EObject mTrgType, EObject uSrcType, EObject mSrcType,
			EObject uUsage) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_12_2_corematch_blackBFFFBFFBFBB(uPackage, uTrgType, uSrcType,
						uUsage, match)) {
			ASTNode2Element src2Src = (ASTNode2Element) result2_black[1];
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result2_black[2];
			...
			// ForEach 
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(uPackage, src2Src, p2p,
							mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType, uUsage)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
				...
				//nothing EMoflonEdge uUsage__uSrcType____client = (EMoflonEdge) result3_green[19];
				...
				//nothing EMoflonEdge p2p__mPackage____source = (EMoflonEdge) result3_green[23];

				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType,
								uSrcType, mSrcType, uUsage);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uPackage] = " + uPackage + ", "
							+ "[src2Src] = " + src2Src + ", " + "[p2p] = " + p2p + ", " + "[mPackage] = " + mPackage
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Package uPackage,
			ASTNode2Element src2Src, JavaPackage2UmlPackage p2p, org.eclipse.modisco.java.Package mPackage,
			Classifier uTrgType, ASTNode2Element trg2Trg, Type mTrgType, org.eclipse.uml2.uml.Class uSrcType,
			MClass mSrcType, Usage uUsage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject uPackage, EObject src2Src, EObject p2p,
			EObject mPackage, EObject uTrgType, EObject trg2Trg, EObject mTrgType, EObject uSrcType, EObject mSrcType,
			EObject uUsage) {
		ruleresult.registerObject("uPackage", uPackage);
		ruleresult.registerObject("src2Src", src2Src);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_123(EMoflonEdge _edge_dependencies) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		MClass mSrcType = (MClass) result2_bindingAndBlack[5];
		...
		Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, uPackage,
						mPackage, uTrgType, mTrgType, uSrcType, mSrcType, uUsage, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[uPackage] = " + uPackage + ", " + "[mPackage] = " + mPackage + ", " + "[uTrgType] = " + uTrgType
					+ ", " + "[mTrgType] = " + mTrgType + ", " + "[uSrcType] = " + uSrcType + ", " + "[mSrcType] = "
					+ mSrcType + ", " + "[uUsage] = " + uUsage + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBFFBBFBBBBB(uPackage, mPackage,
	...
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, Type mTrgType,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType,
							mSrcType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uPackage] = " + uPackage + ", "
						+ "[src2Src] = " + src2Src + ", " + "[p2p] = " + p2p + ", " + "[mPackage] = " + mPackage + ", "
						+ "[uTrgType] = " + uTrgType + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[mTrgType] = "
						+ mTrgType + ", " + "[uSrcType] = " + uSrcType + ", " + "[mSrcType] = " + mSrcType + ", "
			...
			if (TypeDependency2UsageDependencyImpl
				...
				// 
				Object[] result5_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(uPackage, src2Src, p2p,
								mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType);
				if (result5_black != null) {

					Object[] result6_black = TypeDependency2UsageDependencyImpl
							.pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(uPackage, src2Src, p2p,
									mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uPackage] = "
								+ uPackage + ", " + "[src2Src] = " + src2Src + ", " + "[p2p] = " + p2p + ", "
								+ "[mPackage] = " + mPackage + ", " + "[uTrgType] = " + uTrgType + ", " + "[trg2Trg] = "
								+ trg2Trg + ", " + "[mTrgType] = " + mTrgType + ", " + "[uSrcType] = " + uSrcType + ", "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Package uPackage,
			ASTNode2Element src2Src, JavaPackage2UmlPackage p2p, org.eclipse.modisco.java.Package mPackage,
			Classifier uTrgType, ASTNode2Element trg2Trg, Type mTrgType, org.eclipse.uml2.uml.Class uSrcType,
			MClass mSrcType, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_PACKAGE_ASTNODE2ELEMENT_JAVAPACKAGE2UMLPACKAGE_PACKAGE_CLASSIFIER_ASTNODE2ELEMENT_TYPE_CLASS_MCLASS:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(org.eclipse.uml2.uml.Package) arguments.get(1), (ASTNode2Element) arguments.get(2),
						(JavaPackage2UmlPackage) arguments.get(3), (org.eclipse.modisco.java.Package) arguments.get(4),
						(Classifier) arguments.get(5), (ASTNode2Element) arguments.get(6), (Type) arguments.get(7),
						(org.eclipse.uml2.uml.Class) arguments.get(8), (MClass) arguments.get(9));
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_PACKAGE_CLASSIFIER_CLASS_USAGE:
				return isAppropriate_solveCsp_BWD((Match) arguments.get(0),
						...
						(org.eclipse.uml2.uml.Class) arguments.get(3), (Usage) arguments.get(4));
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
				return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_ASTNODE2ELEMENT_JAVAPACKAGE2UMLPACKAGE_PACKAGE_CLASSIFIER_ASTNODE2ELEMENT_TYPE_CLASS_MCLASS_USAGE:
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_115__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_115((EMoflonEdge) arguments.get(0));
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_123__EMOFLONEDGE:
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_CC__PACKAGE_PACKAGE_CLASSIFIER_TYPE_CLASS_MCLASS_USAGE_MATCH_MATCH:
				return isApplicable_solveCsp_CC((org.eclipse.uml2.uml.Package) arguments.get(0),
						...
						(Type) arguments.get(3), (org.eclipse.uml2.uml.Class) arguments.get(4),
						(MClass) arguments.get(5), (Usage) arguments.get(6), (Match) arguments.get(7),
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_ASTNODE2ELEMENT_JAVAPACKAGE2UMLPACKAGE_PACKAGE_CLASSIFIER_ASTNODE2ELEMENT_TYPE_CLASS_MCLASS_MODELGENERATORRULERESULT:
								...
								if (tmpMTrgType instanceof Type) {
									...
									if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
										...
										if (tmpMSrcType instanceof MClass) {
											...
											return new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg,
													mTrgType, uSrcType, mSrcType, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
			org.eclipse.uml2.uml.Package uPackage, ASTNode2Element src2Src, JavaPackage2UmlPackage p2p,
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, ASTNode2Element trg2Trg, Type mTrgType,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, TypeDependency2UsageDependency _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!mSrcType.equals(mTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType,
									uSrcType, mSrcType, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black = pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
					uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black != null) {
				...
				return new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject uPackage, EObject src2Src, EObject p2p, EObject mPackage,
			EObject uTrgType, EObject trg2Trg, EObject mTrgType, EObject uSrcType, EObject mSrcType, EObject uUsage) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject uPackage, EObject uTrgType, EObject mTrgType, EObject uSrcType,
			EObject mSrcType, EObject uUsage) {
		...
		return new Object[] { ruleresult, uPackage, uTrgType, mTrgType, uSrcType, mSrcType, uUsage,
	...
	public static final void pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, PerformRuleResult ruleresult, EObject uPackage, EObject src2Src,
			EObject p2p, EObject mPackage, EObject uTrgType, EObject trg2Trg, EObject mTrgType, EObject uSrcType,
			EObject mSrcType, EObject uUsage) {
		_this.registerObjects_FWD(ruleresult, uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType,
				mSrcType, uUsage);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFFBFFBFBB(
							...
							if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
								...
								if (!uSrcType.equals(uTrgType)) {
									for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (uPackage != null) {
											_result.add(new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType,
													trg2Trg, mTrgType, uSrcType, mSrcType, match });
										}
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(
			org.eclipse.uml2.uml.Package uPackage, ASTNode2Element src2Src, JavaPackage2UmlPackage p2p,
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, ASTNode2Element trg2Trg, Type mTrgType,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!src2Src.equals(trg2Trg)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
											...
											if (uSrcType.equals(src2Src.getTarget())) {
												if (uTrgType.equals(trg2Trg.getTarget())) {
													if (mPackage.equals(p2p.getSource())) {
														_result.add(new Object[] { uPackage, src2Src, p2p, mPackage,
																uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType });
													}
												}
											}
										}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType,
				...
				trg2Trg__mTrgType____source, p2p__uPackage____target, uPackage__uSrcType____ownedElement,
				uSrcType__uPackage____owner, mSrcType__mTrgType____dependencies, src2Src__mSrcType____source,
				src2Src__uSrcType____target, trg2Trg__uTrgType____target, p2p__mPackage____source };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, ASTNode2Element trg2Trg, Type mTrgType,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, uPackage, src2Src, p2p, mPackage,
				uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg,
					mTrgType, uSrcType, mSrcType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType,
				mSrcType);
		if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, uPackage, src2Src, p2p, mPackage, uTrgType,
						trg2Trg, mTrgType, uSrcType, mSrcType };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_greenBBBBBFFF(
		...
		uUsage__uSrcType____client.setName(uUsage__uSrcType____client_name_prime);
		uUsage__uTrgType____supplier.setName(uUsage__uTrgType____supplier_name_prime);
		return new Object[] { match, uPackage, uTrgType, uSrcType, uUsage, uPackage__uUsage____packagedElement,
									...
									if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
										...
										if (tmpMSrcType instanceof MClass) {
											...
											if (tmpUUsage instanceof Usage) {
												...
												return new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType,
														trg2Trg, mTrgType, uSrcType, mSrcType, uUsage,
														isApplicableMatch };
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
			org.eclipse.uml2.uml.Package uPackage, ASTNode2Element src2Src, JavaPackage2UmlPackage p2p,
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, ASTNode2Element trg2Trg, Type mTrgType,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage, TypeDependency2UsageDependency _this,
			IsApplicableMatch isApplicableMatch) {
		if (!src2Src.equals(trg2Trg)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType,
									uSrcType, mSrcType, uUsage, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding != null) {
			...
			Classifier uTrgType = (Classifier) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[4];
			...
			MClass mSrcType = (MClass) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[8];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black = pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
					uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType, uUsage, _this,
					isApplicableMatch);
	...
	public static final void pattern_TypeDependency2UsageDependency_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject p2p, EObject mPackage, EObject uTrgType, EObject trg2Trg, EObject mTrgType, EObject uSrcType,
			EObject mSrcType, EObject uUsage) {
		_this.registerObjects_BWD(ruleresult, uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType,
				mSrcType, uUsage);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_2_corematch_blackBFFFBFFBFBB(
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, org.eclipse.uml2.uml.Class uSrcType,
							...
							for (ASTNode2Element trg2Trg : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!src2Src.equals(trg2Trg)) {
									...
									if (tmpMTrgType instanceof Type) {
										...
										if (!mSrcType.equals(mTrgType)) {
											_result.add(new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType,
													trg2Trg, mTrgType, uSrcType, mSrcType, uUsage, match });
										}
									}
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(
			org.eclipse.uml2.uml.Package uPackage, ASTNode2Element src2Src, JavaPackage2UmlPackage p2p,
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, ASTNode2Element trg2Trg, Type mTrgType,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!src2Src.equals(trg2Trg)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
											...
											if (uUsage.getClients().contains(uSrcType)) {
												if (uSrcType.equals(src2Src.getTarget())) {
													if (uUsage.getSuppliers().contains(uTrgType)) {
														if (uTrgType.equals(trg2Trg.getTarget())) {
															if (mPackage.equals(p2p.getSource())) {
																_result.add(new Object[] { uPackage, src2Src, p2p,
																		mPackage, uTrgType, trg2Trg, mTrgType, uSrcType,
																		mSrcType, uUsage });
															}
														}
													}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(
		...
		trg2Trg__uTrgType____target.setName(trg2Trg__uTrgType____target_name_prime);
		p2p__mPackage____source.setName(p2p__mPackage____source_name_prime);
		return new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType, uUsage,
				isApplicableMatch, uPackage__uUsage____packagedElement, mPackage__mSrcType____ownedElements,
				mSrcType__mPackage____package, trg2Trg__mTrgType____source, p2p__uPackage____target,
				uPackage__uSrcType____ownedElement, uSrcType__uPackage____owner, src2Src__mSrcType____source,
				uUsage__uSrcType____client, src2Src__uSrcType____target, uUsage__uTrgType____supplier,
				trg2Trg__uTrgType____target, p2p__mPackage____source };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			...
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, ASTNode2Element trg2Trg, Type mTrgType,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, uPackage, src2Src, p2p, mPackage,
				uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType, uUsage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg,
					mTrgType, uSrcType, mSrcType, uUsage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_391065 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_391065)) {
					if (!uPackage.equals(__DEC_uUsage_client_391065)) {
						if (!uTrgType.equals(__DEC_uUsage_client_391065)) {
							if (!uSrcType.equals(__DEC_uUsage_client_391065)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_625618 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_625618)) {
					if (!uPackage.equals(__DEC_uUsage_supplier_625618)) {
						if (!uTrgType.equals(__DEC_uUsage_supplier_625618)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_625618)) {
								return new Object[] { uUsage, uPackage, uTrgType, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingFFFFFFFBB(
		...
		EObject _localVariable_5 = sourceMatch.getObject("mSrcType");
					...
					if (tmpMTrgType instanceof Type) {
						...
						if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
							...
							if (tmpMSrcType instanceof MClass) {
								...
								if (tmpUUsage instanceof Usage) {
									Usage uUsage = (Usage) tmpUUsage;
									return new Object[] { uPackage, mPackage, uTrgType, mTrgType, uSrcType, mSrcType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage, Classifier uTrgType,
			Type mTrgType, org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage, Match sourceMatch,
			Match targetMatch) {
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { uPackage, mPackage, uTrgType, mTrgType, uSrcType, mSrcType, uUsage,
							sourceMatch, targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding != null) {
			...
			MClass mSrcType = (MClass) result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black = pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					uPackage, mPackage, uTrgType, mTrgType, uSrcType, mSrcType, uUsage, sourceMatch, targetMatch);
			if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { uPackage, mPackage, uTrgType, mTrgType, uSrcType, mSrcType, uUsage, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
			TypeDependency2UsageDependency _this, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, Type mTrgType,
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(uPackage, mPackage, uTrgType, mTrgType, uSrcType,
				mSrcType, uUsage, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, uPackage, mPackage, uTrgType, mTrgType, uSrcType, mSrcType, uUsage,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_24_3_solvecsp_binding = pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, uPackage, mPackage, uTrgType, mTrgType, uSrcType, mSrcType, uUsage, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBFFBBFBBBBB(
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage, Classifier uTrgType,
								...
								if (mPackage.equals(p2p.getSource())) {
									for (ASTNode2Element src2Src : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (!src2Src.equals(trg2Trg)) {
											if (uSrcType.equals(src2Src.getTarget())) {
												_result.add(new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType,
														trg2Trg, mTrgType, uSrcType, mSrcType, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage, Classifier uTrgType,
			Type mTrgType, org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Usage uUsage, CCMatch ccMatch) {
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				return new Object[] { uPackage, mPackage, uTrgType, mTrgType, uSrcType, mSrcType, uUsage, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_957340 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_957340)) {
					if (!uPackage.equals(__DEC_uUsage_client_957340)) {
						if (!uTrgType.equals(__DEC_uUsage_client_957340)) {
							if (!uSrcType.equals(__DEC_uUsage_client_957340)) {
								return new Object[] { uUsage, uPackage, uTrgType, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_259500 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_259500)) {
					if (!uPackage.equals(__DEC_uUsage_supplier_259500)) {
						if (!uTrgType.equals(__DEC_uUsage_supplier_259500)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_259500)) {
								return new Object[] { uUsage, uPackage, uTrgType, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, uPackage, src2Src, p2p, mPackage,
				uTrgType, trg2Trg, mTrgType, uSrcType, mSrcType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg,
					mTrgType, uSrcType, mSrcType, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, uPackage, src2Src, p2p, mPackage, uTrgType,
						trg2Trg, mTrgType, uSrcType, mSrcType, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(
		...
		if (!src2Src.equals(trg2Trg)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
					return new Object[] { uPackage, src2Src, p2p, mPackage, uTrgType, trg2Trg, mTrgType, uSrcType,
							mSrcType };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_greenBBBBBFB(
		...
		return new Object[] { uPackage, uTrgType, mTrgType, uSrcType, mSrcType, uUsage, ruleResult };
	}
