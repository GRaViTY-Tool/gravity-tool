...
public class TypeDependency2UsageDependencyImpl extends AbstractRuleImpl implements TypeDependency2UsageDependency {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result1_bindingAndBlack[2];
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, mSrcType,
						uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType, mPackage, mTrgType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mSrcType] = " + mSrcType + ", " + "[uTrgType] = " + uTrgType + ", " + "[trg2Trg] = "
					+ trg2Trg + ", " + "[p2p] = " + p2p + ", " + "[uUsage] = " + uUsage + ", " + "[src2Src] = "
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(ruleresult, mSrcType,
						uTrgType, uUsage, uPackage, uSrcType, mTrgType);
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
						mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType, mPackage, mTrgType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_2_2_corematch_blackBFFFFFFBBB(mSrcType, mPackage, mTrgType,
						match)) {
			...
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(mSrcType, uTrgType, trg2Trg,
							p2p, src2Src, uPackage, uSrcType, mPackage, mTrgType)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(mSrcType,
								uTrgType, trg2Trg, p2p, src2Src, uPackage, uSrcType, mPackage, mTrgType);
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage, uSrcType,
								mPackage, mTrgType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSrcType] = " + mSrcType + ", "
							+ "[uTrgType] = " + uTrgType + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[p2p] = " + p2p
							+ ", " + "[src2Src] = " + src2Src + ", " + "[uPackage] = " + uPackage + ", "
							+ "[uSrcType] = " + uSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[mTrgType] = "
							+ mTrgType + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MClass mSrcType, Classifier uTrgType,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mSrcType, EObject uTrgType, EObject trg2Trg,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_12_2_corematch_blackFBFFBFBBFFB(uTrgType, uUsage, uPackage,
						uSrcType, match)) {
			...
			// ForEach 
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(mSrcType, uTrgType,
							trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType, mPackage, mTrgType)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
				...
				//nothing EMoflonEdge uUsage__uSrcType____client = (EMoflonEdge) result3_green[16];
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage,
								uSrcType, mPackage, mTrgType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSrcType] = " + mSrcType + ", "
							+ "[uTrgType] = " + uTrgType + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[p2p] = " + p2p
							+ ", " + "[uUsage] = " + uUsage + ", " + "[src2Src] = " + src2Src + ", " + "[uPackage] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MClass mSrcType, Classifier uTrgType,
			...
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage, Type mTrgType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mSrcType, EObject uTrgType, EObject trg2Trg,
			EObject p2p, EObject uUsage, EObject src2Src, EObject uPackage, EObject uSrcType, EObject mPackage,
			EObject mTrgType) {
		ruleresult.registerObject("mSrcType", mSrcType);
		ruleresult.registerObject("uTrgType", uTrgType);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_78(EMoflonEdge _edge_supplier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_79(EMoflonEdge _edge_dependencies) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, mSrcType,
						uTrgType, uUsage, uPackage, uSrcType, mPackage, mTrgType, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mSrcType] = " + mSrcType + ", " + "[uTrgType] = " + uTrgType + ", " + "[uUsage] = " + uUsage
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBBFFFBBBBBB(mSrcType, uTrgType,
							uPackage, uSrcType, mPackage, mTrgType, sourceMatch, targetMatch)) {
				NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result5_black[2];
				...
				Object[] result6_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(mSrcType,
								uTrgType, uUsage, uPackage, uSrcType, mPackage, mTrgType, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MClass mSrcType, Classifier uTrgType, Usage uUsage,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			NamedElement2NamedElement src2Src = (NamedElement2NamedElement) result2_black[2];
			org.eclipse.uml2.uml.Class uSrcType = (org.eclipse.uml2.uml.Class) result2_black[3];
			...
			Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage, uSrcType, mPackage,
							mTrgType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mSrcType] = " + mSrcType + ", "
						...
						+ uSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[mTrgType] = " + mTrgType + ", "
			...
			if (TypeDependency2UsageDependencyImpl
				...
				// 
				Object[] result5_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(mSrcType, uTrgType,
								trg2Trg, p2p, src2Src, uPackage, uSrcType, mPackage, mTrgType);
				if (result5_black != null) {

					Object[] result6_black = TypeDependency2UsageDependencyImpl
							.pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(mSrcType, uTrgType,
									trg2Trg, p2p, src2Src, uPackage, uSrcType, mPackage, mTrgType, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mSrcType] = "
								+ mSrcType + ", " + "[uTrgType] = " + uTrgType + ", " + "[trg2Trg] = " + trg2Trg + ", "
								+ "[p2p] = " + p2p + ", " + "[src2Src] = " + src2Src + ", " + "[uPackage] = " + uPackage
					...
					TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_29_6_perform_greenBBFBBBB(
							mSrcType, uTrgType, uPackage, uSrcType, mTrgType, ruleResult);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MClass mSrcType, Classifier uTrgType,
			NamedElement2NamedElement trg2Trg, JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, Type mTrgType, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MCLASS_CLASSIFIER_NAMEDELEMENT2NAMEDELEMENT_JAVAPACKAGE2UMLPACKAGE_NAMEDELEMENT2NAMEDELEMENT_PACKAGE_CLASS_PACKAGE_TYPE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MClass) arguments.get(1),
					(Classifier) arguments.get(2), (NamedElement2NamedElement) arguments.get(3),
					(JavaPackage2UmlPackage) arguments.get(4), (NamedElement2NamedElement) arguments.get(5),
					(org.eclipse.uml2.uml.Package) arguments.get(6), (org.eclipse.uml2.uml.Class) arguments.get(7),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MCLASS_CLASSIFIER_NAMEDELEMENT2NAMEDELEMENT_JAVAPACKAGE2UMLPACKAGE_USAGE_NAMEDELEMENT2NAMEDELEMENT_PACKAGE_CLASS_PACKAGE_TYPE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (MClass) arguments.get(1),
					(Classifier) arguments.get(2), (NamedElement2NamedElement) arguments.get(3),
					(JavaPackage2UmlPackage) arguments.get(4), (Usage) arguments.get(5),
					(NamedElement2NamedElement) arguments.get(6), (org.eclipse.uml2.uml.Package) arguments.get(7),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_78__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_78((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_79__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_CC__MCLASS_CLASSIFIER_USAGE_PACKAGE_CLASS_PACKAGE_TYPE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MClass) arguments.get(0), (Classifier) arguments.get(1),
					(Usage) arguments.get(2), (org.eclipse.uml2.uml.Package) arguments.get(3),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MCLASS_CLASSIFIER_NAMEDELEMENT2NAMEDELEMENT_JAVAPACKAGE2UMLPACKAGE_NAMEDELEMENT2NAMEDELEMENT_PACKAGE_CLASS_PACKAGE_TYPE_MODELGENERATORRULERESULT:
								...
								if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
									...
									if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
										...
										if (tmpMTrgType instanceof Type) {
											...
											return new Object[] { mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage,
													uSrcType, mPackage, mTrgType, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
			MClass mSrcType, Classifier uTrgType, NamedElement2NamedElement trg2Trg, JavaPackage2UmlPackage p2p,
			NamedElement2NamedElement src2Src, org.eclipse.uml2.uml.Package uPackage,
				...
				if (!uSrcType.equals(uTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage, uSrcType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding != null) {
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding[2];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black = pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
					mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage, uSrcType, mPackage, mTrgType, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black != null) {
				...
				return new Object[] { mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage, uSrcType, mPackage, mTrgType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mSrcType, EObject uTrgType, EObject trg2Trg, EObject p2p,
			EObject uUsage, EObject src2Src, EObject uPackage, EObject uSrcType, EObject mPackage, EObject mTrgType) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject mSrcType, EObject uTrgType, EObject uUsage, EObject uPackage,
		...
		return new Object[] { ruleresult, mSrcType, uTrgType, uUsage, uPackage, uSrcType, mTrgType,
	...
	public static final void pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, PerformRuleResult ruleresult, EObject mSrcType, EObject uTrgType,
			EObject trg2Trg, EObject p2p, EObject uUsage, EObject src2Src, EObject uPackage, EObject uSrcType,
			EObject mPackage, EObject mTrgType) {
		_this.registerObjects_FWD(ruleresult, mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType,
				mPackage, mTrgType);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_2_corematch_blackBFFFFFFBBB(
							...
							for (NamedElement2NamedElement trg2Trg : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!src2Src.equals(trg2Trg)) {
									...
									if (tmpUTrgType instanceof Classifier) {
										Classifier uTrgType = (Classifier) tmpUTrgType;
										if (!uSrcType.equals(uTrgType)) {
											_result.add(new Object[] { mSrcType, uTrgType, trg2Trg, p2p, src2Src,
													uPackage, uSrcType, mPackage, mTrgType, match });
										}
									}
											...
											if (mPackage.getOwnedElements().contains(mSrcType)) {
												if (mPackage.equals(p2p.getSource())) {
													if (mTrgType.equals(trg2Trg.getSource())) {
														_result.add(new Object[] { mSrcType, uTrgType, trg2Trg, p2p,
																src2Src, uPackage, uSrcType, mPackage, mTrgType });
													}
												}
											}
										}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage, uSrcType, mPackage, mTrgType,
				isApplicableMatch, mSrcType__mTrgType____dependencies, src2Src__mSrcType____source,
				uPackage__uSrcType____ownedElement, uSrcType__uPackage____owner, trg2Trg__uTrgType____target,
				src2Src__uSrcType____target, p2p__uPackage____target, mPackage__mSrcType____ownedElements,
				mSrcType__mPackage____package, p2p__mPackage____source, trg2Trg__mTrgType____source };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			Classifier uTrgType, NamedElement2NamedElement trg2Trg, JavaPackage2UmlPackage p2p,
			NamedElement2NamedElement src2Src, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage, Type mTrgType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p,
				src2Src, uPackage, uSrcType, mPackage, mTrgType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage,
					uSrcType, mPackage, mTrgType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage, uSrcType, mPackage,
				mTrgType);
		if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, src2Src,
						uPackage, uSrcType, mPackage, mTrgType };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_greenBBBBBFFF(
		...
		uPackage__uUsage____packagedElement.setName(uPackage__uUsage____packagedElement_name_prime);
		uUsage__uSrcType____client.setName(uUsage__uSrcType____client_name_prime);
		return new Object[] { match, uTrgType, uUsage, uPackage, uSrcType, uUsage__uTrgType____supplier,
								...
								if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
									...
									if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
										...
										if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
											...
											if (tmpMTrgType instanceof Type) {
												Type mTrgType = (Type) tmpMTrgType;
												return new Object[] { mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src,
														uPackage, uSrcType, mPackage, mTrgType, isApplicableMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
			MClass mSrcType, Classifier uTrgType, NamedElement2NamedElement trg2Trg, JavaPackage2UmlPackage p2p,
			Usage uUsage, NamedElement2NamedElement src2Src, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage, Type mTrgType,
			TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch) {
		if (!mSrcType.equals(mTrgType)) {
			if (!src2Src.equals(trg2Trg)) {
				if (!uSrcType.equals(uTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType,
									mPackage, mTrgType, csp, _this, isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding != null) {
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black = pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
					mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType, mPackage, mTrgType, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black != null) {
				...
				return new Object[] { mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType, mPackage,
	...
	public static final void pattern_TypeDependency2UsageDependency_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject trg2Trg, EObject p2p, EObject uUsage, EObject src2Src, EObject uPackage, EObject uSrcType,
			EObject mPackage, EObject mTrgType) {
		_this.registerObjects_BWD(ruleresult, mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType,
				mPackage, mTrgType);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_2_corematch_blackFBFFBFBBFFB(
							...
							if (tmpMSrcType instanceof MClass) {
								...
								if (!mSrcType.equals(mTrgType)) {
									for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (mPackage != null) {
											_result.add(new Object[] { mSrcType, uTrgType, trg2Trg, p2p, uUsage,
													src2Src, uPackage, uSrcType, mPackage, mTrgType, match });
										}
											...
											if (uSrcType.equals(src2Src.getTarget())) {
												if (uPackage.equals(p2p.getTarget())) {
													if (mPackage.getOwnedElements().contains(mSrcType)) {
														if (mPackage.equals(p2p.getSource())) {
															if (mTrgType.equals(trg2Trg.getSource())) {
																_result.add(new Object[] { mSrcType, uTrgType, trg2Trg,
																		p2p, uUsage, src2Src, uPackage, uSrcType,
																		mPackage, mTrgType });
															}
														}
													}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(
		...
		p2p__mPackage____source.setName(p2p__mPackage____source_name_prime);
		trg2Trg__mTrgType____source.setName(trg2Trg__mTrgType____source_name_prime);
		return new Object[] { mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType, mPackage, mTrgType,
				isApplicableMatch, uUsage__uTrgType____supplier, src2Src__mSrcType____source,
				uPackage__uSrcType____ownedElement, uSrcType__uPackage____owner, uPackage__uUsage____packagedElement,
				uUsage__uSrcType____client, trg2Trg__uTrgType____target, src2Src__uSrcType____target,
				p2p__uPackage____target, mPackage__mSrcType____ownedElements, mSrcType__mPackage____package,
				p2p__mPackage____source, trg2Trg__mTrgType____source };
	}

	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch, MClass mSrcType,
			Classifier uTrgType, NamedElement2NamedElement trg2Trg, JavaPackage2UmlPackage p2p, Usage uUsage,
			NamedElement2NamedElement src2Src, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage, Type mTrgType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p,
				uUsage, src2Src, uPackage, uSrcType, mPackage, mTrgType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src,
					uPackage, uSrcType, mPackage, mTrgType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_12_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, uUsage, src2Src, uPackage, uSrcType,
				mPackage, mTrgType);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_321144 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_321144)) {
					if (!uTrgType.equals(__DEC_uUsage_client_321144)) {
						if (!uPackage.equals(__DEC_uUsage_client_321144)) {
							if (!uSrcType.equals(__DEC_uUsage_client_321144)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_282307 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_282307)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_282307)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_282307)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_282307)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
					...
					if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
						...
						if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
							...
							if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
								...
								if (tmpMTrgType instanceof Type) {
									Type mTrgType = (Type) tmpMTrgType;
									return new Object[] { mSrcType, uTrgType, uUsage, uPackage, uSrcType, mPackage,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			MClass mSrcType, Classifier uTrgType, Usage uUsage, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage, Type mTrgType,
			Match sourceMatch, Match targetMatch) {
		if (!mSrcType.equals(mTrgType)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { mSrcType, uTrgType, uUsage, uPackage, uSrcType, mPackage, mTrgType,
							sourceMatch, targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black = pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					mSrcType, uTrgType, uUsage, uPackage, uSrcType, mPackage, mTrgType, sourceMatch, targetMatch);
			if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { mSrcType, uTrgType, uUsage, uPackage, uSrcType, mPackage, mTrgType, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
			TypeDependency2UsageDependency _this, MClass mSrcType, Classifier uTrgType, Usage uUsage,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, Type mTrgType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(mSrcType, uTrgType, uUsage, uPackage, uSrcType, mPackage,
				mTrgType, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, mSrcType, uTrgType, uUsage, uPackage, uSrcType, mPackage, mTrgType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_24_3_solvecsp_binding = pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, mSrcType, uTrgType, uUsage, uPackage, uSrcType, mPackage, mTrgType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBBFFFBBBBBB(
								...
								if (!src2Src.equals(trg2Trg)) {
									if (mTrgType.equals(trg2Trg.getSource())) {
										for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
											...
											if (mPackage.equals(p2p.getSource())) {
												_result.add(new Object[] { mSrcType, uTrgType, trg2Trg, p2p, src2Src,
														uPackage, uSrcType, mPackage, mTrgType, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(
		...
		if (!mSrcType.equals(mTrgType)) {
			if (!uSrcType.equals(uTrgType)) {
				return new Object[] { mSrcType, uTrgType, uUsage, uPackage, uSrcType, mPackage, mTrgType, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_97325 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_97325)) {
					if (!uTrgType.equals(__DEC_uUsage_client_97325)) {
						if (!uPackage.equals(__DEC_uUsage_client_97325)) {
							if (!uSrcType.equals(__DEC_uUsage_client_97325)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_964149 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_964149)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_964149)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_964149)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_964149)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p,
				src2Src, uPackage, uSrcType, mPackage, mTrgType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage,
					uSrcType, mPackage, mTrgType, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mSrcType, uTrgType, trg2Trg, p2p, src2Src,
						uPackage, uSrcType, mPackage, mTrgType, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(MClass mSrcType,
		...
		if (!mSrcType.equals(mTrgType)) {
			if (!src2Src.equals(trg2Trg)) {
				if (!uSrcType.equals(uTrgType)) {
					return new Object[] { mSrcType, uTrgType, trg2Trg, p2p, src2Src, uPackage, uSrcType, mPackage,
							mTrgType };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_greenBBFBBBB(MClass mSrcType,
		...
		return new Object[] { mSrcType, uTrgType, uUsage, uPackage, uSrcType, mTrgType, ruleResult };
	}
