...
public class TypeDependency2UsageDependencyImpl extends AbstractRuleImpl implements TypeDependency2UsageDependency {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		org.eclipse.uml2.uml.Class uSrcType = (org.eclipse.uml2.uml.Class) result1_bindingAndBlack[0];
		...
		NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result1_bindingAndBlack[8];
		//nothing CSP csp = (CSP) result1_bindingAndBlack[9];
		Object[] result1_green = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_1_performtransformation_greenBBBF(uSrcType, uPackage,
						uTrgType);
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, uSrcType,
						uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, uUsage, trg2Trg);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uSrcType] = " + uSrcType + ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = "
					+ mSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[p2p] = " + p2p + ", " + "[src2Src] = "
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(ruleresult, uSrcType,
						uPackage, mSrcType, uTrgType, mTrgType, uUsage);
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
						uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, uUsage, trg2Trg);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFBBFFFBFB(mSrcType, mPackage, mTrgType,
						match)) {
			...
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(uSrcType, uPackage, mSrcType,
							mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(uSrcType,
								uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg);
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType,
								mTrgType, trg2Trg);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uSrcType] = " + uSrcType + ", "
							+ "[uPackage] = " + uPackage + ", " + "[mSrcType] = " + mSrcType + ", " + "[mPackage] = "
							+ mPackage + ", " + "[p2p] = " + p2p + ", " + "[src2Src] = " + src2Src + ", "
							+ "[uTrgType] = " + uTrgType + ", " + "[mTrgType] = " + mTrgType + ", " + "[trg2Trg] = "
							+ trg2Trg + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.modisco.java.Package mPackage,
			JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src, Classifier uTrgType, Type mTrgType,
			NamedElement2NamedElement trg2Trg) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject uSrcType, EObject uPackage, EObject mSrcType,
			EObject mPackage, EObject p2p, EObject src2Src, EObject uTrgType, EObject mTrgType, EObject uUsage,
			EObject trg2Trg) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, org.eclipse.uml2.uml.Class uSrcType,
		...
		Object[] result1_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_10_1_initialbindings_blackBBBBBB(this, match, uSrcType,
						uPackage, uTrgType, uUsage);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[uSrcType] = " + uSrcType + ", " + "[uPackage] = " + uPackage
					+ ", " + "[uTrgType] = " + uTrgType + ", " + "[uUsage] = " + uUsage + ".");
		}
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_10_3_CheckCSP_expressionFBB(this,
			...
			Object[] result4_black = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_blackBBBBB(match,
							uSrcType, uPackage, uTrgType, uUsage);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[uSrcType] = " + uSrcType + ", " + "[uPackage] = " + uPackage + ", " + "[uTrgType] = "
						+ uTrgType + ", " + "[uUsage] = " + uUsage + ".");
			}
			TypeDependency2UsageDependencyImpl
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result1_bindingAndBlack[9];
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, uSrcType,
						uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, uUsage, trg2Trg);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uSrcType] = " + uSrcType + ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_12_2_corematch_blackBBFFFFBFBFB(uSrcType, uPackage, uTrgType,
						uUsage, match)) {
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result2_black[9];
			// ForEach 
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(uSrcType, uPackage,
							mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, uUsage, trg2Trg)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(uSrcType,
								uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, uUsage, trg2Trg);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[uPackage] = " + uPackage + ", " + "[mSrcType] = " + mSrcType + ", " + "[mPackage] = "
							+ mPackage + ", " + "[p2p] = " + p2p + ", " + "[src2Src] = " + src2Src + ", "
							+ "[uTrgType] = " + uTrgType + ", " + "[mTrgType] = " + mTrgType + ", " + "[uUsage] = "
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, Usage uUsage) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, Usage uUsage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.modisco.java.Package mPackage,
			JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src, Classifier uTrgType, Type mTrgType,
			Usage uUsage, NamedElement2NamedElement trg2Trg) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject uSrcType, EObject uPackage, EObject mSrcType,
			EObject mPackage, EObject p2p, EObject src2Src, EObject uTrgType, EObject mTrgType, EObject uUsage,
			EObject trg2Trg) {
		ruleresult.registerObject("uSrcType", uSrcType);
		ruleresult.registerObject("uPackage", uPackage);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_1001(EMoflonEdge _edge_packagedElement) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			if (TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
							this, match, uSrcType, uPackage, uTrgType, uUsage)) {
				// 
				if (TypeDependency2UsageDependencyImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_1025(EMoflonEdge _edge_dependencies) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, uSrcType,
						uPackage, mSrcType, mPackage, uTrgType, mTrgType, uUsage, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[uSrcType] = " + uSrcType + ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = " + mSrcType
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBBBBFFBBFBB(uSrcType, uPackage,
							mSrcType, mPackage, uTrgType, mTrgType, sourceMatch, targetMatch)) {
				...
				NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result5_black[8];
				...
				Object[] result6_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(uSrcType,
								uPackage, mSrcType, mPackage, uTrgType, mTrgType, uUsage, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage,
			MClass mSrcType, org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, Type mTrgType,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage,
			Classifier uTrgType, Usage uUsage) {// 
		Object[] result1_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_blackBBBB(uSrcType, uPackage, uTrgType,
						uUsage);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
			JavaPackage2UmlPackage p2pParameter, NamedElement2NamedElement trg2TrgParameter) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType,
							trg2Trg, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uSrcType] = " + uSrcType + ", "
						+ "[uPackage] = " + uPackage + ", " + "[mSrcType] = " + mSrcType + ", " + "[mPackage] = "
						+ mPackage + ", " + "[p2p] = " + p2p + ", " + "[src2Src] = " + src2Src + ", " + "[uTrgType] = "
						+ uTrgType + ", " + "[mTrgType] = " + mTrgType + ", " + "[trg2Trg] = " + trg2Trg + ", "
			...
			if (TypeDependency2UsageDependencyImpl
				...
				// 
				Object[] result5_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(uSrcType, uPackage,
								mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg);
				if (result5_black != null) {

					Object[] result6_black = TypeDependency2UsageDependencyImpl
							.pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(uSrcType, uPackage,
									mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uSrcType] = "
								+ uSrcType + ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = " + mSrcType
								+ ", " + "[mPackage] = " + mPackage + ", " + "[p2p] = " + p2p + ", " + "[src2Src] = "
								+ src2Src + ", " + "[uTrgType] = " + uTrgType + ", " + "[mTrgType] = " + mTrgType + ", "
					...
					TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_29_6_perform_greenBBBBBFB(
							uSrcType, uPackage, mSrcType, uTrgType, mTrgType, ruleResult);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.modisco.java.Package mPackage,
			JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src, Classifier uTrgType, Type mTrgType,
			NamedElement2NamedElement trg2Trg, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASS_PACKAGE_MCLASS_PACKAGE_JAVAPACKAGE2UMLPACKAGE_NAMEDELEMENT2NAMEDELEMENT_CLASSIFIER_TYPE_NAMEDELEMENT2NAMEDELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(org.eclipse.uml2.uml.Class) arguments.get(1), (org.eclipse.uml2.uml.Package) arguments.get(2),
					(MClass) arguments.get(3), (org.eclipse.modisco.java.Package) arguments.get(4),
					(JavaPackage2UmlPackage) arguments.get(5), (NamedElement2NamedElement) arguments.get(6),
					(Classifier) arguments.get(7), (Type) arguments.get(8),
					(NamedElement2NamedElement) arguments.get(9));
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD__MATCH_CLASS_PACKAGE_CLASSIFIER_USAGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_CLASS_PACKAGE_CLASSIFIER_USAGE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (org.eclipse.uml2.uml.Class) arguments.get(1),
					(org.eclipse.uml2.uml.Package) arguments.get(2), (Classifier) arguments.get(3),
					(Usage) arguments.get(4));
			return null;
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_CLASS_PACKAGE_CLASSIFIER_USAGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_PACKAGE_MCLASS_PACKAGE_JAVAPACKAGE2UMLPACKAGE_NAMEDELEMENT2NAMEDELEMENT_CLASSIFIER_TYPE_USAGE_NAMEDELEMENT2NAMEDELEMENT:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(org.eclipse.uml2.uml.Class) arguments.get(1), (org.eclipse.uml2.uml.Package) arguments.get(2),
					(MClass) arguments.get(3), (org.eclipse.modisco.java.Package) arguments.get(4),
					(JavaPackage2UmlPackage) arguments.get(5), (NamedElement2NamedElement) arguments.get(6),
					(Classifier) arguments.get(7), (Type) arguments.get(8), (Usage) arguments.get(9),
					(NamedElement2NamedElement) arguments.get(10));
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_1001__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_1001((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_1025__EMOFLONEDGE:
			return isAppropriate_FWD_EMoflonEdge_1025((EMoflonEdge) arguments.get(0));
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_CC__CLASS_PACKAGE_MCLASS_PACKAGE_CLASSIFIER_TYPE_USAGE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((org.eclipse.uml2.uml.Class) arguments.get(0),
					...
					(org.eclipse.modisco.java.Package) arguments.get(3), (Classifier) arguments.get(4),
					(Type) arguments.get(5), (Usage) arguments.get(6), (Match) arguments.get(7),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___CHECK_DEC_BWD__CLASS_PACKAGE_CLASSIFIER_USAGE:
			return checkDEC_BWD((org.eclipse.uml2.uml.Class) arguments.get(0),
					...
					(Usage) arguments.get(3));
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL__RULEENTRYCONTAINER_JAVAPACKAGE2UMLPACKAGE_NAMEDELEMENT2NAMEDELEMENT:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_PACKAGE_MCLASS_PACKAGE_JAVAPACKAGE2UMLPACKAGE_NAMEDELEMENT2NAMEDELEMENT_CLASSIFIER_TYPE_NAMEDELEMENT2NAMEDELEMENT_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingFFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		EObject _localVariable_0 = isApplicableMatch.getObject("uSrcType");
								...
								if (tmpUTrgType instanceof Classifier) {
									...
									if (tmpMTrgType instanceof Type) {
										...
										if (tmpTrg2Trg instanceof NamedElement2NamedElement) {
											...
											return new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src,
													uTrgType, mTrgType, trg2Trg, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src,
			Classifier uTrgType, Type mTrgType, NamedElement2NamedElement trg2Trg, TypeDependency2UsageDependency _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!src2Src.equals(trg2Trg)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding != null) {
			org.eclipse.uml2.uml.Class uSrcType = (org.eclipse.uml2.uml.Class) result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding[0];
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding[8];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black = pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
					uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black != null) {
				...
				return new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_greenBBBF(
		...
		return new Object[] { uSrcType, uPackage, uTrgType, uUsage };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject uSrcType, EObject uPackage, EObject mSrcType, EObject mPackage,
			EObject p2p, EObject src2Src, EObject uTrgType, EObject mTrgType, EObject uUsage, EObject trg2Trg) {
		if (!uSrcType.equals(uTrgType)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject uSrcType, EObject uPackage, EObject mSrcType, EObject uTrgType,
		...
		return new Object[] { ruleresult, uSrcType, uPackage, mSrcType, uTrgType, mTrgType, uUsage,
				uPackage__uUsage____packagedElement, mSrcType__mTrgType____dependencies, uUsage__uSrcType____client,
	...
	public static final void pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, PerformRuleResult ruleresult, EObject uSrcType, EObject uPackage,
			EObject mSrcType, EObject mPackage, EObject p2p, EObject src2Src, EObject uTrgType, EObject mTrgType,
			EObject uUsage, EObject trg2Trg) {
		_this.registerObjects_FWD(ruleresult, uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType,
				uUsage, trg2Trg);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFBBFFFBFB(
							...
							for (NamedElement2NamedElement trg2Trg : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!src2Src.equals(trg2Trg)) {
									...
									if (tmpUTrgType instanceof Classifier) {
										Classifier uTrgType = (Classifier) tmpUTrgType;
										if (!uSrcType.equals(uTrgType)) {
											_result.add(new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p,
													src2Src, uTrgType, mTrgType, trg2Trg, match });
										}
									}
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src,
			Classifier uTrgType, Type mTrgType, NamedElement2NamedElement trg2Trg) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!src2Src.equals(trg2Trg)) {
											...
											if (mSrcType.equals(src2Src.getSource())) {
												if (uTrgType.equals(trg2Trg.getTarget())) {
													if (mTrgType.equals(trg2Trg.getSource())) {
														_result.add(new Object[] { uSrcType, uPackage, mSrcType,
																mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg });
													}
												}
											}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg,
				...
				src2Src__mSrcType____source, trg2Trg__uTrgType____target, trg2Trg__mTrgType____source };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src,
			Classifier uTrgType, Type mTrgType, NamedElement2NamedElement trg2Trg) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, uSrcType, uPackage, mSrcType,
				mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src,
					uTrgType, mTrgType, trg2Trg };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType,
				trg2Trg);
		if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, uSrcType, uPackage, mSrcType, mPackage, p2p,
						src2Src, uTrgType, mTrgType, trg2Trg };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_1_initialbindings_blackBBBBBB(
			TypeDependency2UsageDependency _this, Match match, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, Usage uUsage) {
		if (!uSrcType.equals(uTrgType)) {
			return new Object[] { _this, match, uSrcType, uPackage, uTrgType, uUsage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_2_SolveCSP_bindingFBBBBBB(
			TypeDependency2UsageDependency _this, Match match, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, Usage uUsage) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, uSrcType, uPackage, uTrgType, uUsage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, uSrcType, uPackage, uTrgType, uUsage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_10_2_SolveCSP_binding = pattern_TypeDependency2UsageDependency_10_2_SolveCSP_bindingFBBBBBB(
				_this, match, uSrcType, uPackage, uTrgType, uUsage);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_blackBBBBB(
			...
			Classifier uTrgType, Usage uUsage) {
		if (!uSrcType.equals(uTrgType)) {
			return new Object[] { match, uSrcType, uPackage, uTrgType, uUsage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_greenBBBBBFFF(
		...
		uUsage__uSrcType____client.setName(uUsage__uSrcType____client_name_prime);
		uUsage__uTrgType____supplier.setName(uUsage__uTrgType____supplier_name_prime);
		return new Object[] { match, uSrcType, uPackage, uTrgType, uUsage, uPackage__uUsage____packagedElement,
	...
	public static final void pattern_TypeDependency2UsageDependency_10_6_registerobjectstomatch_expressionBBBBBB(
			TypeDependency2UsageDependency _this, Match match, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, Usage uUsage) {
		_this.registerObjectsToMatch_BWD(match, uSrcType, uPackage, uTrgType, uUsage);
								...
								if (tmpUTrgType instanceof Classifier) {
									...
									if (tmpMTrgType instanceof Type) {
										...
										if (tmpUUsage instanceof Usage) {
											...
											if (tmpTrg2Trg instanceof NamedElement2NamedElement) {
												NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) tmpTrg2Trg;
												return new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p,
														src2Src, uTrgType, mTrgType, uUsage, trg2Trg,
														isApplicableMatch };
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src,
			Classifier uTrgType, Type mTrgType, Usage uUsage, NamedElement2NamedElement trg2Trg,
			TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch) {
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!src2Src.equals(trg2Trg)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding != null) {
			org.eclipse.uml2.uml.Class uSrcType = (org.eclipse.uml2.uml.Class) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[0];
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[9];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black = pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
					uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, uUsage, trg2Trg, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black != null) {
				...
				return new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, uUsage,
	...
	public static final void pattern_TypeDependency2UsageDependency_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject mSrcType, EObject mPackage, EObject p2p, EObject src2Src, EObject uTrgType, EObject mTrgType,
			EObject uUsage, EObject trg2Trg) {
		_this.registerObjects_BWD(ruleresult, uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType,
				uUsage, trg2Trg);
		...
		if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
			...
			if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
				...
				if (tmpUTrgType instanceof Classifier) {
					...
					if (tmpUUsage instanceof Usage) {
						Usage uUsage = (Usage) tmpUUsage;
						return new Object[] { uSrcType, uPackage, uTrgType, uUsage, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_2_corematch_blackBBFFFFBFBFB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType,
							...
							for (NamedElement2NamedElement trg2Trg : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!src2Src.equals(trg2Trg)) {
									...
									if (tmpMTrgType instanceof Type) {
										...
										if (!mSrcType.equals(mTrgType)) {
											_result.add(new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p,
													src2Src, uTrgType, mTrgType, uUsage, trg2Trg, match });
										}
									}
												...
												if (uUsage.getClients().contains(uSrcType)) {
													if (uUsage.getSuppliers().contains(uTrgType)) {
														if (uTrgType.equals(trg2Trg.getTarget())) {
															if (mTrgType.equals(trg2Trg.getSource())) {
																_result.add(new Object[] { uSrcType, uPackage, mSrcType,
																		mPackage, p2p, src2Src, uTrgType, mTrgType,
																		uUsage, trg2Trg });
															}
														}
													}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(
		...
		trg2Trg__uTrgType____target.setName(trg2Trg__uTrgType____target_name_prime);
		trg2Trg__mTrgType____source.setName(trg2Trg__mTrgType____source_name_prime);
		return new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType, uUsage, trg2Trg,
				isApplicableMatch, uPackage__uUsage____packagedElement, uPackage__uSrcType____ownedElement,
				uSrcType__uPackage____owner, mPackage__mSrcType____ownedElements, mSrcType__mPackage____package,
				p2p__mPackage____source, p2p__uPackage____target, src2Src__uSrcType____target,
				src2Src__mSrcType____source, uUsage__uSrcType____client, uUsage__uTrgType____supplier,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			...
			org.eclipse.modisco.java.Package mPackage, JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src,
			Classifier uTrgType, Type mTrgType, Usage uUsage, NamedElement2NamedElement trg2Trg) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, uSrcType, uPackage, mSrcType,
				mPackage, p2p, src2Src, uTrgType, mTrgType, uUsage, trg2Trg);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src,
					uTrgType, mTrgType, uUsage, trg2Trg };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
			...
			Classifier uTrgType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_461912 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_461912)) {
					if (!uSrcType.equals(__DEC_uUsage_client_461912)) {
						if (!uPackage.equals(__DEC_uUsage_client_461912)) {
							if (!uTrgType.equals(__DEC_uUsage_client_461912)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
			...
			Classifier uTrgType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_990819 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_990819)) {
					if (!uSrcType.equals(__DEC_uUsage_supplier_990819)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_990819)) {
							if (!uTrgType.equals(__DEC_uUsage_supplier_990819)) {
								return new Object[] { uUsage, uSrcType, uPackage, uTrgType };
							}
						}
					}
														...
														if (pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
															...
															if (pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
																...
																if (pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_3BB(
																	...
																	_result.add(new Object[] { uSrcType, uPackage,
																			uTrgType, uUsage, _edge_packagedElement });
																}
															}
														}
													}
	...
	public static final boolean pattern_TypeDependency2UsageDependency_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			TypeDependency2UsageDependency _this, Match match, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, Usage uUsage) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, uSrcType, uPackage, uTrgType, uUsage);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
					...
					if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
						...
						if (tmpUTrgType instanceof Classifier) {
							...
							if (tmpMTrgType instanceof Type) {
								...
								if (tmpUUsage instanceof Usage) {
									Usage uUsage = (Usage) tmpUUsage;
									return new Object[] { uSrcType, uPackage, mSrcType, mPackage, uTrgType, mTrgType,
											uUsage, targetMatch, sourceMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, Type mTrgType, Usage uUsage,
			Match sourceMatch, Match targetMatch) {
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { uSrcType, uPackage, mSrcType, mPackage, uTrgType, mTrgType, uUsage,
							sourceMatch, targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black = pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					uSrcType, uPackage, mSrcType, mPackage, uTrgType, mTrgType, uUsage, sourceMatch, targetMatch);
			if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { uSrcType, uPackage, mSrcType, mPackage, uTrgType, mTrgType, uUsage, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
			TypeDependency2UsageDependency _this, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.modisco.java.Package mPackage,
			Classifier uTrgType, Type mTrgType, Usage uUsage, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(uSrcType, uPackage, mSrcType, mPackage, uTrgType,
				mTrgType, uUsage, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, uSrcType, uPackage, mSrcType, mPackage, uTrgType, mTrgType, uUsage,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_24_3_solvecsp_binding = pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, uSrcType, uPackage, mSrcType, mPackage, uTrgType, mTrgType, uUsage, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBBBBFFBBFBB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
			org.eclipse.modisco.java.Package mPackage, Classifier uTrgType, Type mTrgType, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
								...
								if (mSrcType.equals(src2Src.getSource())) {
									for (NamedElement2NamedElement trg2Trg : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (!src2Src.equals(trg2Trg)) {
											if (mTrgType.equals(trg2Trg.getSource())) {
												_result.add(new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p,
														src2Src, uTrgType, mTrgType, trg2Trg, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_greenBBBBBF(
			JavaPackage2UmlPackage p2p, NamedElement2NamedElement src2Src, NamedElement2NamedElement trg2Trg,
			Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(
		...
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				return new Object[] { uSrcType, uPackage, mSrcType, mPackage, uTrgType, mTrgType, uUsage, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_0BBBB(
			...
			Classifier uTrgType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_349654 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_349654)) {
					if (!uSrcType.equals(__DEC_uUsage_client_349654)) {
						if (!uPackage.equals(__DEC_uUsage_client_349654)) {
							if (!uTrgType.equals(__DEC_uUsage_client_349654)) {
								return new Object[] { uUsage, uSrcType, uPackage, uTrgType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_1BBBB(
			...
			Classifier uTrgType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_474425 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_474425)) {
					if (!uSrcType.equals(__DEC_uUsage_supplier_474425)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_474425)) {
							if (!uTrgType.equals(__DEC_uUsage_supplier_474425)) {
								return new Object[] { uUsage, uSrcType, uPackage, uTrgType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, uSrcType, uPackage, mSrcType,
				mPackage, p2p, src2Src, uTrgType, mTrgType, trg2Trg, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src,
					uTrgType, mTrgType, trg2Trg, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, uSrcType, uPackage, mSrcType, mPackage, p2p,
						src2Src, uTrgType, mTrgType, trg2Trg, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(
		...
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!src2Src.equals(trg2Trg)) {
					return new Object[] { uSrcType, uPackage, mSrcType, mPackage, p2p, src2Src, uTrgType, mTrgType,
							trg2Trg };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_greenBBBBBFB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
		...
		return new Object[] { uSrcType, uPackage, mSrcType, uTrgType, mTrgType, uUsage, ruleResult };
	}
