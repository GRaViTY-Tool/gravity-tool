...
public class TypeDependency2UsageDependencyImpl extends AbstractRuleImpl implements TypeDependency2UsageDependency {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, uSrcType,
						mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uSrcType] = " + uSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[mSrcType] = "
					+ mSrcType + ", " + "[uUsage] = " + uUsage + ", " + "[trg2Trg] = " + trg2Trg + ", "
					+ "[mTrgType] = " + mTrgType + ", " + "[src2Src] = " + src2Src + ", " + "[uPackage] = " + uPackage
					+ ", " + "[uTrgType] = " + uTrgType + ", " + "[p2p] = " + p2p + ".");
		}
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(ruleresult, uSrcType,
						mSrcType, uUsage, mTrgType, uPackage, uTrgType);
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
						uSrcType, mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_2_2_corematch_blackFBBFBFFFFB(mPackage, mSrcType, mTrgType,
						match)) {
			...
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(uSrcType, mPackage, mSrcType,
							trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(uSrcType,
								mPackage, mSrcType, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p);
				...
				//nothing EMoflonEdge mSrcType__mTrgType____dependencies = (EMoflonEdge) result3_green[13];
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, uSrcType, mPackage, mSrcType, trg2Trg, mTrgType, src2Src, uPackage,
								uTrgType, p2p);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uSrcType] = " + uSrcType + ", "
							+ "[mPackage] = " + mPackage + ", " + "[mSrcType] = " + mSrcType + ", " + "[trg2Trg] = "
							+ trg2Trg + ", " + "[mTrgType] = " + mTrgType + ", " + "[src2Src] = " + src2Src + ", "
							+ "[uPackage] = " + uPackage + ", " + "[uTrgType] = " + uTrgType + ", " + "[p2p] = " + p2p
							+ ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, MClass mSrcType, ASTNode2Element trg2Trg, Type mTrgType,
			ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject uSrcType, EObject mPackage, EObject mSrcType,
			EObject uUsage, EObject trg2Trg, EObject mTrgType, EObject src2Src, EObject uPackage, EObject uTrgType,
			EObject p2p) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result1_bindingAndBlack[9];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_12_2_corematch_blackBFFBFFFBBFB(uSrcType, uUsage, uPackage,
						uTrgType, match)) {
			...
			// ForEach 
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(uSrcType, mPackage,
							mSrcType, uUsage, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
				...
				//nothing EMoflonEdge p2p__mPackage____source = (EMoflonEdge) result3_green[20];
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, uSrcType, mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src,
								uPackage, uTrgType, p2p);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uSrcType] = " + uSrcType + ", "
							+ "[mPackage] = " + mPackage + ", " + "[mSrcType] = " + mSrcType + ", " + "[uUsage] = "
							+ uUsage + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[mTrgType] = " + mTrgType + ", "
							+ "[src2Src] = " + src2Src + ", " + "[uPackage] = " + uPackage + ", " + "[uTrgType] = "
							+ uTrgType + ", " + "[p2p] = " + p2p + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Class uSrcType,
			org.eclipse.modisco.java.Package mPackage, MClass mSrcType, Usage uUsage, ASTNode2Element trg2Trg,
			Type mTrgType, ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType,
			JavaPackage2UmlPackage p2p) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject uSrcType, EObject mPackage, EObject mSrcType,
			EObject uUsage, EObject trg2Trg, EObject mTrgType, EObject src2Src, EObject uPackage, EObject uTrgType,
			EObject p2p) {
		ruleresult.registerObject("uSrcType", uSrcType);
		ruleresult.registerObject("mPackage", mPackage);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_113(EMoflonEdge _edge_client) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_122(EMoflonEdge _edge_dependencies) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, uSrcType,
						mPackage, mSrcType, uUsage, mTrgType, uPackage, uTrgType, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[uSrcType] = " + uSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[mSrcType] = " + mSrcType
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBBBFBFBBFBB(uSrcType, mPackage,
							mSrcType, mTrgType, uPackage, uTrgType, sourceMatch, targetMatch)) {
				...
				Object[] result5_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_greenBBBBBF(trg2Trg, src2Src, p2p,
				...
				Object[] result6_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(uSrcType,
								mPackage, mSrcType, uUsage, mTrgType, uPackage, uTrgType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uSrcType] = " + uSrcType
							+ ", " + "[mPackage] = " + mPackage + ", " + "[mSrcType] = " + mSrcType + ", "
							+ "[uUsage] = " + uUsage + ", " + "[mTrgType] = " + mTrgType + ", " + "[uPackage] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage,
			MClass mSrcType, Usage uUsage, Type mTrgType, org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			if (TypeDependency2UsageDependencyImpl
				...
				// 
				Object[] result5_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(uSrcType, mPackage,
								mSrcType, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p);
				if (result5_black != null) {

					Object[] result6_black = TypeDependency2UsageDependencyImpl
							.pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(uSrcType, mPackage,
									mSrcType, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uSrcType] = "
								+ uSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[mSrcType] = " + mSrcType
								+ ", " + "[trg2Trg] = " + trg2Trg + ", " + "[mTrgType] = " + mTrgType + ", "
								+ "[src2Src] = " + src2Src + ", " + "[uPackage] = " + uPackage + ", " + "[uTrgType] = "
								+ uTrgType + ", " + "[p2p] = " + p2p + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_29_6_perform_greenBBFBBBB(
							uSrcType, mSrcType, mTrgType, uPackage, uTrgType, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASS_PACKAGE_MCLASS_ASTNODE2ELEMENT_TYPE_ASTNODE2ELEMENT_PACKAGE_CLASSIFIER_JAVAPACKAGE2UMLPACKAGE:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						...
						(org.eclipse.uml2.uml.Package) arguments.get(7), (Classifier) arguments.get(8),
						(JavaPackage2UmlPackage) arguments.get(9));
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_CLASS_USAGE_PACKAGE_CLASSIFIER:
				return isAppropriate_solveCsp_BWD((Match) arguments.get(0),
						(org.eclipse.uml2.uml.Class) arguments.get(1), (Usage) arguments.get(2),
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_PACKAGE_MCLASS_USAGE_ASTNODE2ELEMENT_TYPE_ASTNODE2ELEMENT_PACKAGE_CLASSIFIER_JAVAPACKAGE2UMLPACKAGE:
				return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
						(org.eclipse.uml2.uml.Class) arguments.get(1),
						(org.eclipse.modisco.java.Package) arguments.get(2), (MClass) arguments.get(3),
						(Usage) arguments.get(4), (ASTNode2Element) arguments.get(5), (Type) arguments.get(6),
						(ASTNode2Element) arguments.get(7), (org.eclipse.uml2.uml.Package) arguments.get(8),
						(Classifier) arguments.get(9), (JavaPackage2UmlPackage) arguments.get(10));
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_122__EMOFLONEDGE:
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_CC__CLASS_PACKAGE_MCLASS_USAGE_TYPE_PACKAGE_CLASSIFIER_MATCH_MATCH:
				return isApplicable_solveCsp_CC((org.eclipse.uml2.uml.Class) arguments.get(0),
						(org.eclipse.modisco.java.Package) arguments.get(1), (MClass) arguments.get(2),
						(Usage) arguments.get(3), (Type) arguments.get(4),
						(org.eclipse.uml2.uml.Package) arguments.get(5), (Classifier) arguments.get(6),
			...
			case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASS_PACKAGE_MCLASS_ASTNODE2ELEMENT_TYPE_ASTNODE2ELEMENT_PACKAGE_CLASSIFIER_JAVAPACKAGE2UMLPACKAGE_MODELGENERATORRULERESULT:
				return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
						(org.eclipse.uml2.uml.Class) arguments.get(1),
						(org.eclipse.modisco.java.Package) arguments.get(2), (MClass) arguments.get(3),
						(ASTNode2Element) arguments.get(4), (Type) arguments.get(5), (ASTNode2Element) arguments.get(6),
						(org.eclipse.uml2.uml.Package) arguments.get(7), (Classifier) arguments.get(8),
						(JavaPackage2UmlPackage) arguments.get(9), (ModelgeneratorRuleResult) arguments.get(10));
								...
								if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
									...
									if (tmpUTrgType instanceof Classifier) {
										...
										if (tmpP2p instanceof JavaPackage2UmlPackage) {
											...
											return new Object[] { uSrcType, mPackage, mSrcType, trg2Trg, mTrgType,
													src2Src, uPackage, uTrgType, p2p, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
			...
			ASTNode2Element trg2Trg, Type mTrgType, ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage,
			Classifier uTrgType, JavaPackage2UmlPackage p2p, TypeDependency2UsageDependency _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!src2Src.equals(trg2Trg)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uSrcType, mPackage, mSrcType, trg2Trg, mTrgType, src2Src, uPackage,
									uTrgType, p2p, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black = pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
					uSrcType, mPackage, mSrcType, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black != null) {
				...
				return new Object[] { uSrcType, mPackage, mSrcType, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject uSrcType, EObject mPackage, EObject mSrcType, EObject uUsage,
			EObject trg2Trg, EObject mTrgType, EObject src2Src, EObject uPackage, EObject uTrgType, EObject p2p) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject uSrcType, EObject mSrcType, EObject uUsage, EObject mTrgType,
		...
		return new Object[] { ruleresult, uSrcType, mSrcType, uUsage, mTrgType, uPackage, uTrgType,
				uUsage__uSrcType____client, mSrcType__mTrgType____dependencies, uPackage__uUsage____packagedElement,
	...
	public static final void pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, PerformRuleResult ruleresult, EObject uSrcType, EObject mPackage,
			EObject mSrcType, EObject uUsage, EObject trg2Trg, EObject mTrgType, EObject src2Src, EObject uPackage,
			EObject uTrgType, EObject p2p) {
		_this.registerObjects_FWD(ruleresult, uSrcType, mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src,
				uPackage, uTrgType, p2p);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_2_corematch_blackFBBFBFFFFB(
							...
							if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
								...
								if (!uSrcType.equals(uTrgType)) {
									for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (uPackage != null) {
											_result.add(new Object[] { uSrcType, mPackage, mSrcType, trg2Trg, mTrgType,
													src2Src, uPackage, uTrgType, p2p, match });
										}
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage, MClass mSrcType,
			ASTNode2Element trg2Trg, Type mTrgType, ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage,
			Classifier uTrgType, JavaPackage2UmlPackage p2p) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!src2Src.equals(trg2Trg)) {
											...
											if (uPackage.equals(p2p.getTarget())) {
												if (mPackage.equals(p2p.getSource())) {
													if (mPackage.getOwnedElements().contains(mSrcType)) {
														_result.add(new Object[] { uSrcType, mPackage, mSrcType,
																trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p });
													}
												}
											}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		mSrcType__mPackage____package.setName(mSrcType__mPackage____package_name_prime);
		return new Object[] { uSrcType, mPackage, mSrcType, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p,
				isApplicableMatch, trg2Trg__mTrgType____source, src2Src__mSrcType____source,
				src2Src__uSrcType____target, mSrcType__mTrgType____dependencies, uPackage__uSrcType____ownedElement,
				uSrcType__uPackage____owner, trg2Trg__uTrgType____target, p2p__uPackage____target,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			ASTNode2Element trg2Trg, Type mTrgType, ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage,
			Classifier uTrgType, JavaPackage2UmlPackage p2p) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, uSrcType, mPackage, mSrcType, trg2Trg,
				mTrgType, src2Src, uPackage, uTrgType, p2p);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uSrcType, mPackage, mSrcType, trg2Trg, mTrgType,
					src2Src, uPackage, uTrgType, p2p };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, uSrcType, mPackage, mSrcType, trg2Trg, mTrgType, src2Src, uPackage, uTrgType,
				p2p);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_greenBBBBBFFF(
		...
		uPackage__uUsage____packagedElement.setName(uPackage__uUsage____packagedElement_name_prime);
		uUsage__uTrgType____supplier.setName(uUsage__uTrgType____supplier_name_prime);
		return new Object[] { match, uSrcType, uUsage, uPackage, uTrgType, uUsage__uSrcType____client,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingFFFFFFFFFFB(
		...
		EObject _localVariable_9 = isApplicableMatch.getObject("p2p");
		EObject tmpUSrcType = _localVariable_0;
		EObject tmpMPackage = _localVariable_1;
		EObject tmpMSrcType = _localVariable_2;
		...
		EObject tmpP2p = _localVariable_9;
		if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
			org.eclipse.uml2.uml.Class uSrcType = (org.eclipse.uml2.uml.Class) tmpUSrcType;
			if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
				org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) tmpMPackage;
								...
								if (tmpSrc2Src instanceof ASTNode2Element) {
									...
									if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
										...
										if (tmpUTrgType instanceof Classifier) {
											...
											if (tmpP2p instanceof JavaPackage2UmlPackage) {
												JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) tmpP2p;
												return new Object[] { uSrcType, mPackage, mSrcType, uUsage, trg2Trg,
														mTrgType, src2Src, uPackage, uTrgType, p2p, isApplicableMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage, MClass mSrcType,
			Usage uUsage, ASTNode2Element trg2Trg, Type mTrgType, ASTNode2Element src2Src,
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, JavaPackage2UmlPackage p2p,
			TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch) {
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!src2Src.equals(trg2Trg)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uSrcType, mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src,
									uPackage, uTrgType, p2p, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding != null) {
			...
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[9];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black = pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
					uSrcType, mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black != null) {
				...
				return new Object[] { uSrcType, mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src, uPackage,
						uTrgType, p2p, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_TypeDependency2UsageDependency_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject mSrcType, EObject uUsage, EObject trg2Trg, EObject mTrgType, EObject src2Src, EObject uPackage,
			EObject uTrgType, EObject p2p) {
		_this.registerObjects_BWD(ruleresult, uSrcType, mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src,
				uPackage, uTrgType, p2p);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_2_corematch_blackBFFBFFFBBFB(
							...
							if (tmpMTrgType instanceof Type) {
								...
								if (!mSrcType.equals(mTrgType)) {
									for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (mPackage != null) {
											_result.add(new Object[] { uSrcType, mPackage, mSrcType, uUsage, trg2Trg,
													mTrgType, src2Src, uPackage, uTrgType, p2p, match });
										}
												...
												if (uPackage.equals(p2p.getTarget())) {
													if (mPackage.equals(p2p.getSource())) {
														if (uUsage.getSuppliers().contains(uTrgType)) {
															if (mPackage.getOwnedElements().contains(mSrcType)) {
																_result.add(new Object[] { uSrcType, mPackage, mSrcType,
																		uUsage, trg2Trg, mTrgType, src2Src, uPackage,
																		uTrgType, p2p });
															}
														}
													}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(
		...
		mPackage__mSrcType____ownedElements.setName(mPackage__mSrcType____ownedElements_name_prime);
		mSrcType__mPackage____package.setName(mSrcType__mPackage____package_name_prime);
		return new Object[] { uSrcType, mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p,
				isApplicableMatch, uUsage__uSrcType____client, trg2Trg__mTrgType____source, src2Src__mSrcType____source,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			...
			Usage uUsage, ASTNode2Element trg2Trg, Type mTrgType, ASTNode2Element src2Src,
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, JavaPackage2UmlPackage p2p) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, uSrcType, mPackage, mSrcType, uUsage,
				trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uSrcType, mPackage, mSrcType, uUsage, trg2Trg,
					mTrgType, src2Src, uPackage, uTrgType, p2p };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_12_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, uSrcType, mPackage, mSrcType, uUsage, trg2Trg, mTrgType, src2Src, uPackage,
				uTrgType, p2p);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
			...
			Classifier uTrgType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_742671 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_742671)) {
					if (!uSrcType.equals(__DEC_uUsage_client_742671)) {
						if (!uPackage.equals(__DEC_uUsage_client_742671)) {
							if (!uTrgType.equals(__DEC_uUsage_client_742671)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
			...
			Classifier uTrgType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_858184 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_858184)) {
					if (!uSrcType.equals(__DEC_uUsage_supplier_858184)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_858184)) {
							if (!uTrgType.equals(__DEC_uUsage_supplier_858184)) {
								return new Object[] { uUsage, uSrcType, uPackage, uTrgType };
							}
						}
					}
					...
					if (tmpUUsage instanceof Usage) {
						...
						if (tmpMTrgType instanceof Type) {
							...
							if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
								...
								if (tmpUTrgType instanceof Classifier) {
									Classifier uTrgType = (Classifier) tmpUTrgType;
									return new Object[] { uSrcType, mPackage, mSrcType, uUsage, mTrgType, uPackage,
		...
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { uSrcType, mPackage, mSrcType, uUsage, mTrgType, uPackage, uTrgType,
							sourceMatch, targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black = pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					uSrcType, mPackage, mSrcType, uUsage, mTrgType, uPackage, uTrgType, sourceMatch, targetMatch);
			if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { uSrcType, mPackage, mSrcType, uUsage, mTrgType, uPackage, uTrgType, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
			...
			org.eclipse.modisco.java.Package mPackage, MClass mSrcType, Usage uUsage, Type mTrgType,
			org.eclipse.uml2.uml.Package uPackage, Classifier uTrgType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(uSrcType, mPackage, mSrcType, uUsage, mTrgType, uPackage,
				uTrgType, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, uSrcType, mPackage, mSrcType, uUsage, mTrgType, uPackage, uTrgType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_24_3_solvecsp_binding = pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, uSrcType, mPackage, mSrcType, uUsage, mTrgType, uPackage, uTrgType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBBBFBFBBFBB(
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage, MClass mSrcType,
									...
									if (uSrcType.equals(src2Src.getTarget())) {
										for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(uPackage, JavaPackage2UmlPackage.class,
														"target")) {
											if (mPackage.equals(p2p.getSource())) {
												_result.add(new Object[] { uSrcType, mPackage, mSrcType, trg2Trg,
														mTrgType, src2Src, uPackage, uTrgType, p2p, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_greenBBBBBF(
			ASTNode2Element trg2Trg, ASTNode2Element src2Src, JavaPackage2UmlPackage p2p, Match sourceMatch,
			Match targetMatch) {
		...
		return new Object[] { trg2Trg, src2Src, p2p, sourceMatch, targetMatch, ccMatch };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(
		...
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				return new Object[] { uSrcType, mPackage, mSrcType, uUsage, mTrgType, uPackage, uTrgType, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_0BBBB(
			...
			Classifier uTrgType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_654018 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_654018)) {
					if (!uSrcType.equals(__DEC_uUsage_client_654018)) {
						if (!uPackage.equals(__DEC_uUsage_client_654018)) {
							if (!uTrgType.equals(__DEC_uUsage_client_654018)) {
								return new Object[] { uUsage, uSrcType, uPackage, uTrgType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_1BBBB(
			...
			Classifier uTrgType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_15493 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_15493)) {
					if (!uSrcType.equals(__DEC_uUsage_supplier_15493)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_15493)) {
							if (!uTrgType.equals(__DEC_uUsage_supplier_15493)) {
								return new Object[] { uUsage, uSrcType, uPackage, uTrgType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingFBBBBBBBBBBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType, org.eclipse.modisco.java.Package mPackage, MClass mSrcType,
			ASTNode2Element trg2Trg, Type mTrgType, ASTNode2Element src2Src, org.eclipse.uml2.uml.Package uPackage,
			Classifier uTrgType, JavaPackage2UmlPackage p2p, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, uSrcType, mPackage, mSrcType,
				trg2Trg, mTrgType, src2Src, uPackage, uTrgType, p2p, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uSrcType, mPackage, mSrcType, trg2Trg, mTrgType,
					src2Src, uPackage, uTrgType, p2p, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(
		...
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!src2Src.equals(trg2Trg)) {
					return new Object[] { uSrcType, mPackage, mSrcType, trg2Trg, mTrgType, src2Src, uPackage, uTrgType,
							p2p };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_greenBBFBBBB(
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Type mTrgType, org.eclipse.uml2.uml.Package uPackage,
		...
		return new Object[] { uSrcType, mSrcType, uUsage, mTrgType, uPackage, uTrgType, ruleResult };
	}
