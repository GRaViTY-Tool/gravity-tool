...
public class TypeDependency2UsageDependencyImpl extends AbstractRuleImpl implements TypeDependency2UsageDependency {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Classifier uTrgType = (Classifier) result1_bindingAndBlack[4];
		...
		Object[] result1_green = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_1_performtransformation_greenBFBB(uSrcType, uTrgType,
						uPackage);
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, src2Src,
						trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[src2Src] = " + src2Src + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[uSrcType] = "
					+ uSrcType + ", " + "[uUsage] = " + uUsage + ", " + "[mSrcType] = " + mSrcType + ", "
					+ "[uTrgType] = " + uTrgType + ", " + "[mTrgType] = " + mTrgType + ", " + "[p2p] = " + p2p + ", "
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(ruleresult, uSrcType,
						uUsage, mSrcType, uTrgType, mTrgType, uPackage);
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
						src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFFBFBFFBB(mSrcType, mTrgType, mPackage,
						match)) {
			...
			Classifier uTrgType = (Classifier) result2_black[4];
			...
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(src2Src, trg2Trg, uSrcType,
							mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(src2Src,
								trg2Trg, uSrcType, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage);
				...
				//nothing EMoflonEdge uPackage__uSrcType____ownedElement = (EMoflonEdge) result3_green[19];
				//nothing EMoflonEdge uSrcType__uPackage____owner = (EMoflonEdge) result3_green[20];
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, src2Src, trg2Trg, uSrcType, mSrcType, uTrgType, mTrgType, p2p,
								uPackage, mPackage);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[src2Src] = " + src2Src + ", "
							+ "[trg2Trg] = " + trg2Trg + ", " + "[uSrcType] = " + uSrcType + ", " + "[mSrcType] = "
							+ mSrcType + ", " + "[uTrgType] = " + uTrgType + ", " + "[mTrgType] = " + mTrgType + ", "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element src2Src,
			ASTNode2Element trg2Trg, org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Classifier uTrgType,
			Type mTrgType, JavaPackage2UmlPackage p2p, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject src2Src, EObject trg2Trg, EObject uSrcType,
			EObject uUsage, EObject mSrcType, EObject uTrgType, EObject mTrgType, EObject p2p, EObject uPackage,
			EObject mPackage) {
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_10_3_CheckCSP_expressionFBB(this,
			...
			Object[] result4_black = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_blackBBBBB(match,
							uSrcType, uUsage, uTrgType, uPackage);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[uSrcType] = " + uSrcType + ", " + "[uUsage] = " + uUsage + ", " + "[uTrgType] = " + uTrgType
						+ ", " + "[uPackage] = " + uPackage + ".");
			}
			TypeDependency2UsageDependencyImpl
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_12_2_corematch_blackFFBBFBFFBFB(uSrcType, uUsage, uTrgType,
						uPackage, match)) {
			ASTNode2Element src2Src = (ASTNode2Element) result2_black[0];
			ASTNode2Element trg2Trg = (ASTNode2Element) result2_black[1];
			...
			// ForEach 
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(src2Src, trg2Trg, uSrcType,
							uUsage, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
				...
				//nothing EMoflonEdge trg2Trg__uTrgType____target = (EMoflonEdge) result3_green[16];
				...
				//nothing EMoflonEdge uPackage__uUsage____packagedElement = (EMoflonEdge) result3_green[19];
				//nothing EMoflonEdge mPackage__mSrcType____ownedElements = (EMoflonEdge) result3_green[20];
				//nothing EMoflonEdge mSrcType__mPackage____package = (EMoflonEdge) result3_green[21];
				//nothing EMoflonEdge uPackage__uSrcType____ownedElement = (EMoflonEdge) result3_green[22];
				//nothing EMoflonEdge uSrcType__uPackage____owner = (EMoflonEdge) result3_green[23];

				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType,
								p2p, uPackage, mPackage);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[src2Src] = " + src2Src + ", "
							+ "[trg2Trg] = " + trg2Trg + ", " + "[uSrcType] = " + uSrcType + ", " + "[uUsage] = "
							+ uUsage + ", " + "[mSrcType] = " + mSrcType + ", " + "[uTrgType] = " + uTrgType + ", "
							+ "[mTrgType] = " + mTrgType + ", " + "[p2p] = " + p2p + ", " + "[uPackage] = " + uPackage
							+ ", " + "[mPackage] = " + mPackage + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element src2Src,
			ASTNode2Element trg2Trg, org.eclipse.uml2.uml.Class uSrcType, Usage uUsage, MClass mSrcType,
			Classifier uTrgType, Type mTrgType, JavaPackage2UmlPackage p2p, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject src2Src, EObject trg2Trg, EObject uSrcType,
			EObject uUsage, EObject mSrcType, EObject uTrgType, EObject mTrgType, EObject p2p, EObject uPackage,
			EObject mPackage) {
		ruleresult.registerObject("src2Src", src2Src);
		ruleresult.registerObject("trg2Trg", trg2Trg);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_134(EMoflonEdge _edge_client) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			if (TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
							this, match, uSrcType, uUsage, uTrgType, uPackage)) {
				// 
				if (TypeDependency2UsageDependencyImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, uSrcType, uUsage,
						mSrcType, uTrgType, mTrgType, uPackage, mPackage, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[uSrcType] = " + uSrcType + ", " + "[uUsage] = " + uUsage + ", " + "[mSrcType] = " + mSrcType
					+ ", " + "[uTrgType] = " + uTrgType + ", " + "[mTrgType] = " + mTrgType + ", " + "[uPackage] = "
					+ uPackage + ", " + "[mPackage] = " + mPackage + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackFFBBBBFBBBB(uSrcType, mSrcType,
							uTrgType, mTrgType, uPackage, mPackage, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(uSrcType,
								uUsage, mSrcType, uTrgType, mTrgType, uPackage, mPackage, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uSrcType] = " + uSrcType
							+ ", " + "[uUsage] = " + uUsage + ", " + "[mSrcType] = " + mSrcType + ", " + "[uTrgType] = "
							+ uTrgType + ", " + "[mTrgType] = " + mTrgType + ", " + "[uPackage] = " + uPackage + ", "
							+ "[mPackage] = " + mPackage + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Class uSrcType, Usage uUsage, MClass mSrcType,
			Classifier uTrgType, Type mTrgType, org.eclipse.uml2.uml.Package uPackage,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(org.eclipse.uml2.uml.Class uSrcType, Usage uUsage, Classifier uTrgType,
			org.eclipse.uml2.uml.Package uPackage) {// 
		Object[] result1_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_blackBBBB(uSrcType, uUsage, uTrgType,
						uPackage);
		if (result1_black != null) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, src2Src, trg2Trg, uSrcType, mSrcType, uTrgType, mTrgType, p2p, uPackage,
							mPackage, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[src2Src] = " + src2Src + ", "
			...
			if (TypeDependency2UsageDependencyImpl
				...
				Object[] result5_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(src2Src, trg2Trg,
								uSrcType, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage);
				if (result5_black != null) {

					Object[] result6_black = TypeDependency2UsageDependencyImpl
							.pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(src2Src, trg2Trg,
									uSrcType, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[src2Src] = "
								+ src2Src + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[uSrcType] = " + uSrcType + ", "
								+ "[mSrcType] = " + mSrcType + ", " + "[uTrgType] = " + uTrgType + ", "
								+ "[mTrgType] = " + mTrgType + ", " + "[p2p] = " + p2p + ", " + "[uPackage] = "
					...
					TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_29_6_perform_greenBFBBBBB(
							uSrcType, mSrcType, uTrgType, mTrgType, uPackage, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_CLASS_MCLASS_CLASSIFIER_TYPE_JAVAPACKAGE2UMLPACKAGE_PACKAGE_PACKAGE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(MClass) arguments.get(4), (Classifier) arguments.get(5), (Type) arguments.get(6),
					(JavaPackage2UmlPackage) arguments.get(7), (org.eclipse.uml2.uml.Package) arguments.get(8),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD__MATCH_CLASS_USAGE_CLASSIFIER_PACKAGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_CLASS_USAGE_CLASSIFIER_PACKAGE:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (org.eclipse.uml2.uml.Class) arguments.get(1),
					(Usage) arguments.get(2), (Classifier) arguments.get(3),
					(org.eclipse.uml2.uml.Package) arguments.get(4));
			return null;
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_CLASS_USAGE_CLASSIFIER_PACKAGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_CLASS_USAGE_MCLASS_CLASSIFIER_TYPE_JAVAPACKAGE2UMLPACKAGE_PACKAGE_PACKAGE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(ASTNode2Element) arguments.get(2), (org.eclipse.uml2.uml.Class) arguments.get(3),
					(Usage) arguments.get(4), (MClass) arguments.get(5), (Classifier) arguments.get(6),
					(Type) arguments.get(7), (JavaPackage2UmlPackage) arguments.get(8),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_134__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_CC__CLASS_USAGE_MCLASS_CLASSIFIER_TYPE_PACKAGE_PACKAGE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((org.eclipse.uml2.uml.Class) arguments.get(0), (Usage) arguments.get(1),
					(MClass) arguments.get(2), (Classifier) arguments.get(3), (Type) arguments.get(4),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___CHECK_DEC_BWD__CLASS_USAGE_CLASSIFIER_PACKAGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_CLASS_MCLASS_CLASSIFIER_TYPE_JAVAPACKAGE2UMLPACKAGE_PACKAGE_PACKAGE_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(ASTNode2Element) arguments.get(2), (org.eclipse.uml2.uml.Class) arguments.get(3),
					(MClass) arguments.get(4), (Classifier) arguments.get(5), (Type) arguments.get(6),
					(JavaPackage2UmlPackage) arguments.get(7), (org.eclipse.uml2.uml.Package) arguments.get(8),
					(org.eclipse.modisco.java.Package) arguments.get(9), (ModelgeneratorRuleResult) arguments.get(10));
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingFFFFFFFFFB(
		...
		EObject _localVariable_4 = isApplicableMatch.getObject("uTrgType");
								...
								if (tmpP2p instanceof JavaPackage2UmlPackage) {
									...
									if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
										...
										if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
											...
											return new Object[] { src2Src, trg2Trg, uSrcType, mSrcType, uTrgType,
													mTrgType, p2p, uPackage, mPackage, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
			ASTNode2Element src2Src, ASTNode2Element trg2Trg, org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType,
			Classifier uTrgType, Type mTrgType, JavaPackage2UmlPackage p2p, org.eclipse.uml2.uml.Package uPackage,
				...
				if (!mSrcType.equals(mTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { src2Src, trg2Trg, uSrcType, mSrcType, uTrgType, mTrgType, p2p,
									uPackage, mPackage, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding != null) {
			...
			Classifier uTrgType = (Classifier) result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black = pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
					src2Src, trg2Trg, uSrcType, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black != null) {
				...
				return new Object[] { src2Src, trg2Trg, uSrcType, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_greenBFBB(
		...
		return new Object[] { uSrcType, uUsage, uTrgType, uPackage };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject src2Src, EObject trg2Trg, EObject uSrcType, EObject uUsage,
			EObject mSrcType, EObject uTrgType, EObject mTrgType, EObject p2p, EObject uPackage, EObject mPackage) {
		if (!src2Src.equals(trg2Trg)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject uSrcType, EObject uUsage, EObject mSrcType, EObject uTrgType,
		...
		return new Object[] { ruleresult, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage,
				uUsage__uSrcType____client, mSrcType__mTrgType____dependencies, uUsage__uTrgType____supplier,
	...
	public static final void pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject uSrcType, EObject uUsage, EObject mSrcType, EObject uTrgType, EObject mTrgType, EObject p2p,
			EObject uPackage, EObject mPackage) {
		_this.registerObjects_FWD(ruleresult, src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, p2p,
				uPackage, mPackage);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFFBFBFFBB(
							...
							if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
								...
								if (!uSrcType.equals(uTrgType)) {
									for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (uPackage != null) {
											_result.add(new Object[] { src2Src, trg2Trg, uSrcType, mSrcType, uTrgType,
													mTrgType, p2p, uPackage, mPackage, match });
										}
											...
											if (mPackage.equals(p2p.getSource())) {
												if (mPackage.getOwnedElements().contains(mSrcType)) {
													if (uPackage.getOwnedElements().contains(uSrcType)) {
														_result.add(new Object[] { src2Src, trg2Trg, uSrcType, mSrcType,
																uTrgType, mTrgType, p2p, uPackage, mPackage });
													}
												}
											}
										}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { src2Src, trg2Trg, uSrcType, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage,
				isApplicableMatch, mSrcType__mTrgType____dependencies, trg2Trg__mTrgType____source,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			Type mTrgType, JavaPackage2UmlPackage p2p, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, src2Src, trg2Trg, uSrcType, mSrcType,
				uTrgType, mTrgType, p2p, uPackage, mPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, src2Src, trg2Trg, uSrcType, mSrcType, uTrgType,
					mTrgType, p2p, uPackage, mPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, src2Src, trg2Trg, uSrcType, mSrcType, uTrgType, mTrgType, p2p, uPackage,
				mPackage);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_1_initialbindings_blackBBBBBB(
			...
			Classifier uTrgType, org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			return new Object[] { _this, match, uSrcType, uUsage, uTrgType, uPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_2_SolveCSP_bindingFBBBBBB(
			TypeDependency2UsageDependency _this, Match match, org.eclipse.uml2.uml.Class uSrcType, Usage uUsage,
			Classifier uTrgType, org.eclipse.uml2.uml.Package uPackage) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, uSrcType, uUsage, uTrgType, uPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, uSrcType, uUsage, uTrgType, uPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_10_2_SolveCSP_binding = pattern_TypeDependency2UsageDependency_10_2_SolveCSP_bindingFBBBBBB(
				_this, match, uSrcType, uUsage, uTrgType, uPackage);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_blackBBBBB(
			Match match, org.eclipse.uml2.uml.Class uSrcType, Usage uUsage, Classifier uTrgType,
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			return new Object[] { match, uSrcType, uUsage, uTrgType, uPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_10_4_collectelementstobetranslated_greenBBBBBFFF(
		...
		uUsage__uTrgType____supplier.setName(uUsage__uTrgType____supplier_name_prime);
		uPackage__uUsage____packagedElement.setName(uPackage__uUsage____packagedElement_name_prime);
		return new Object[] { match, uSrcType, uUsage, uTrgType, uPackage, uUsage__uSrcType____client,
	...
	public static final void pattern_TypeDependency2UsageDependency_10_6_registerobjectstomatch_expressionBBBBBB(
			TypeDependency2UsageDependency _this, Match match, org.eclipse.uml2.uml.Class uSrcType, Usage uUsage,
			Classifier uTrgType, org.eclipse.uml2.uml.Package uPackage) {
		_this.registerObjectsToMatch_BWD(match, uSrcType, uUsage, uTrgType, uPackage);
								...
								if (tmpMTrgType instanceof Type) {
									...
									if (tmpP2p instanceof JavaPackage2UmlPackage) {
										...
										if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
											...
											if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
												org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) tmpMPackage;
												return new Object[] { src2Src, trg2Trg, uSrcType, uUsage, mSrcType,
														uTrgType, mTrgType, p2p, uPackage, mPackage,
														isApplicableMatch };
											}
										}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
			ASTNode2Element src2Src, ASTNode2Element trg2Trg, org.eclipse.uml2.uml.Class uSrcType, Usage uUsage,
			MClass mSrcType, Classifier uTrgType, Type mTrgType, JavaPackage2UmlPackage p2p,
			...
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, p2p,
									uPackage, mPackage, csp, _this, isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black = pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
					src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black != null) {
				...
				return new Object[] { src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, p2p, uPackage,
	...
	public static final void pattern_TypeDependency2UsageDependency_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject uSrcType, EObject uUsage, EObject mSrcType, EObject uTrgType, EObject mTrgType, EObject p2p,
			EObject uPackage, EObject mPackage) {
		_this.registerObjects_BWD(ruleresult, src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, p2p,
				uPackage, mPackage);
		...
		if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
			...
			if (tmpUUsage instanceof Usage) {
				...
				if (tmpUTrgType instanceof Classifier) {
					...
					if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
						org.eclipse.uml2.uml.Package uPackage = (org.eclipse.uml2.uml.Package) tmpUPackage;
						return new Object[] { uSrcType, uUsage, uTrgType, uPackage, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_2_corematch_blackFFBBFBFFBFB(
			org.eclipse.uml2.uml.Class uSrcType, Usage uUsage, Classifier uTrgType,
							...
							if (tmpMTrgType instanceof Type) {
								...
								if (!mSrcType.equals(mTrgType)) {
									for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (mPackage != null) {
											_result.add(new Object[] { src2Src, trg2Trg, uSrcType, uUsage, mSrcType,
													uTrgType, mTrgType, p2p, uPackage, mPackage, match });
										}
											...
											if (uPackage.equals(p2p.getTarget())) {
												if (mPackage.equals(p2p.getSource())) {
													if (uPackage.getPackagedElements().contains(uUsage)) {
														if (mPackage.getOwnedElements().contains(mSrcType)) {
															if (uPackage.getOwnedElements().contains(uSrcType)) {
																_result.add(new Object[] { src2Src, trg2Trg, uSrcType,
																		uUsage, mSrcType, uTrgType, mTrgType, p2p,
																		uPackage, mPackage });
															}
														}
													}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(
		...
		uPackage__uSrcType____ownedElement.setName(uPackage__uSrcType____ownedElement_name_prime);
		uSrcType__uPackage____owner.setName(uSrcType__uPackage____owner_name_prime);
		return new Object[] { src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage,
				isApplicableMatch, uUsage__uSrcType____client, uUsage__uTrgType____supplier,
				trg2Trg__mTrgType____source, src2Src__mSrcType____source, src2Src__uSrcType____target,
				trg2Trg__uTrgType____target, p2p__uPackage____target, p2p__mPackage____source,
				uPackage__uUsage____packagedElement, mPackage__mSrcType____ownedElements, mSrcType__mPackage____package,
				uPackage__uSrcType____ownedElement, uSrcType__uPackage____owner };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			...
			Classifier uTrgType, Type mTrgType, JavaPackage2UmlPackage p2p, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, src2Src, trg2Trg, uSrcType, uUsage,
				mSrcType, uTrgType, mTrgType, p2p, uPackage, mPackage);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType,
					mTrgType, p2p, uPackage, mPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_12_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, src2Src, trg2Trg, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, p2p,
				uPackage, mPackage);
		if (result_pattern_TypeDependency2UsageDependency_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_TypeDependency2UsageDependency_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, src2Src, trg2Trg, uSrcType, uUsage, mSrcType,
						uTrgType, mTrgType, p2p, uPackage, mPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_940709 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_940709)) {
					if (!uSrcType.equals(__DEC_uUsage_client_940709)) {
						if (!uTrgType.equals(__DEC_uUsage_client_940709)) {
							if (!uPackage.equals(__DEC_uUsage_client_940709)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_214846 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_214846)) {
					if (!uSrcType.equals(__DEC_uUsage_supplier_214846)) {
						if (!uTrgType.equals(__DEC_uUsage_supplier_214846)) {
							if (!uPackage.equals(__DEC_uUsage_supplier_214846)) {
								return new Object[] { uUsage, uSrcType, uTrgType, uPackage };
							}
						}
					}
													...
													if (pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
														...
														if (pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
															...
															if (pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_2BB(
																...
																_result.add(new Object[] { uSrcType, uUsage, uTrgType,
	...
	public static final boolean pattern_TypeDependency2UsageDependency_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			TypeDependency2UsageDependency _this, Match match, org.eclipse.uml2.uml.Class uSrcType, Usage uUsage,
			Classifier uTrgType, org.eclipse.uml2.uml.Package uPackage) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, uSrcType, uUsage, uTrgType, uPackage);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
					...
					if (tmpUTrgType instanceof Classifier) {
						...
						if (tmpMTrgType instanceof Type) {
							...
							if (tmpUPackage instanceof org.eclipse.uml2.uml.Package) {
								...
								if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
									org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) tmpMPackage;
									return new Object[] { uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			org.eclipse.uml2.uml.Class uSrcType, Usage uUsage, MClass mSrcType, Classifier uTrgType, Type mTrgType,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage, Match sourceMatch,
			Match targetMatch) {
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage, mPackage,
							sourceMatch, targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black = pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage, mPackage, sourceMatch, targetMatch);
			if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage, mPackage, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
			TypeDependency2UsageDependency _this, org.eclipse.uml2.uml.Class uSrcType, Usage uUsage, MClass mSrcType,
			Classifier uTrgType, Type mTrgType, org.eclipse.uml2.uml.Package uPackage,
			org.eclipse.modisco.java.Package mPackage, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage,
				mPackage, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage, mPackage,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_24_3_solvecsp_binding = pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage, mPackage, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackFFBBBBFBBBB(
			org.eclipse.uml2.uml.Class uSrcType, MClass mSrcType, Classifier uTrgType, Type mTrgType,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!uSrcType.equals(uTrgType)) {
								...
								if (!src2Src.equals(trg2Trg)) {
									if (uSrcType.equals(src2Src.getTarget())) {
										for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
											...
											if (mPackage.equals(p2p.getSource())) {
												_result.add(new Object[] { src2Src, trg2Trg, uSrcType, mSrcType,
														uTrgType, mTrgType, p2p, uPackage, mPackage, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(
			org.eclipse.uml2.uml.Class uSrcType, Usage uUsage, MClass mSrcType, Classifier uTrgType, Type mTrgType,
			org.eclipse.uml2.uml.Package uPackage, org.eclipse.modisco.java.Package mPackage, CCMatch ccMatch) {
		if (!uSrcType.equals(uTrgType)) {
			if (!mSrcType.equals(mTrgType)) {
				return new Object[] { uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage, mPackage, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_383337 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_383337)) {
					if (!uSrcType.equals(__DEC_uUsage_client_383337)) {
						if (!uTrgType.equals(__DEC_uUsage_client_383337)) {
							if (!uPackage.equals(__DEC_uUsage_client_383337)) {
								return new Object[] { uUsage, uSrcType, uTrgType, uPackage };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Package uPackage) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_587245 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_587245)) {
					if (!uSrcType.equals(__DEC_uUsage_supplier_587245)) {
						if (!uTrgType.equals(__DEC_uUsage_supplier_587245)) {
							if (!uPackage.equals(__DEC_uUsage_supplier_587245)) {
								return new Object[] { uUsage, uSrcType, uTrgType, uPackage };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, src2Src, trg2Trg, uSrcType, mSrcType,
				uTrgType, mTrgType, p2p, uPackage, mPackage, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, src2Src, trg2Trg, uSrcType, mSrcType, uTrgType,
					mTrgType, p2p, uPackage, mPackage, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(
		...
		if (!src2Src.equals(trg2Trg)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!mSrcType.equals(mTrgType)) {
					return new Object[] { src2Src, trg2Trg, uSrcType, mSrcType, uTrgType, mTrgType, p2p, uPackage,
							mPackage };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_greenBFBBBBB(
		...
		return new Object[] { uSrcType, uUsage, mSrcType, uTrgType, mTrgType, uPackage, ruleResult };
	}
