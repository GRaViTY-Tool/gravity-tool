...
public class TypeDependency2UsageDependencyImpl extends AbstractRuleImpl implements TypeDependency2UsageDependency {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result1_bindingAndBlack[6];
		...
		Object[] result3_black = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, uTrgType,
						uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uTrgType] = " + uTrgType + ", " + "[uUsage] = " + uUsage + ", " + "[uPackage] = "
					+ uPackage + ", " + "[mSrcType] = " + mSrcType + ", " + "[mPackage] = " + mPackage + ", "
					+ "[src2Src] = " + src2Src + ", " + "[uSrcType] = " + uSrcType + ", " + "[trg2Trg] = " + trg2Trg
					+ ", " + "[p2p] = " + p2p + ", " + "[mTrgType] = " + mTrgType + ".");
		}
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(ruleresult, uTrgType,
						uUsage, uPackage, mSrcType, uSrcType, mTrgType);
		...
		TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(this, ruleresult,
						uTrgType, uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFBBFFFFBB(mSrcType, mPackage, mTrgType,
						match)) {
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result2_black[6];
			...
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_2_3_findcontext_blackBBBBBBBBB(uTrgType, uPackage, mSrcType,
							mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(uTrgType,
								uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType);
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this,
								isApplicableMatch, uTrgType, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg,
								p2p, mTrgType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uTrgType] = " + uTrgType + ", "
							+ "[uPackage] = " + uPackage + ", " + "[mSrcType] = " + mSrcType + ", " + "[mPackage] = "
							+ mPackage + ", " + "[src2Src] = " + src2Src + ", " + "[uSrcType] = " + uSrcType + ", "
							+ "[trg2Trg] = " + trg2Trg + ", " + "[p2p] = " + p2p + ", " + "[mTrgType] = " + mTrgType
							+ ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Classifier uTrgType,
			...
			JavaPackage2UmlPackage p2p, Type mTrgType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject uTrgType, EObject uUsage, EObject uPackage,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result1_bindingAndBlack[7];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_12_2_corematch_blackBBBFFFBFFFB(uTrgType, uUsage, uPackage,
						uSrcType, match)) {
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result2_black[7];
			JavaPackage2UmlPackage p2p = (JavaPackage2UmlPackage) result2_black[8];
			Type mTrgType = (Type) result2_black[9];
			// ForEach 
			for (Object[] result3_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_12_3_findcontext_blackBBBBBBBBBB(uTrgType, uUsage, uPackage,
							mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType)) {
				Object[] result3_green = TypeDependency2UsageDependencyImpl
				...
				Object[] result4_bindingAndBlack = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
								isApplicableMatch, uTrgType, uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType,
								trg2Trg, p2p, mTrgType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uTrgType] = " + uTrgType + ", "
							+ "[uUsage] = " + uUsage + ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = "
							+ mSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[src2Src] = " + src2Src + ", "
							+ "[uSrcType] = " + uSrcType + ", " + "[trg2Trg] = " + trg2Trg + ", " + "[p2p] = " + p2p
							+ ", " + "[mTrgType] = " + mTrgType + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Classifier uTrgType, Usage uUsage,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.modisco.java.Package mPackage,
			NamedElement2NamedElement src2Src, org.eclipse.uml2.uml.Class uSrcType, NamedElement2NamedElement trg2Trg,
			JavaPackage2UmlPackage p2p, Type mTrgType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject uTrgType, EObject uUsage, EObject uPackage,
			EObject mSrcType, EObject mPackage, EObject src2Src, EObject uSrcType, EObject trg2Trg, EObject p2p,
			EObject mTrgType) {
		ruleresult.registerObject("uTrgType", uTrgType);
		ruleresult.registerObject("uUsage", uUsage);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_299(EMoflonEdge _edge_packagedElement) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_308(EMoflonEdge _edge_dependencies) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
				.pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, uTrgType, uUsage,
						uPackage, mSrcType, mPackage, uSrcType, mTrgType, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[uTrgType] = " + uTrgType + ", " + "[uUsage] = " + uUsage + ", " + "[uPackage] = " + uPackage
					+ ", " + "[mSrcType] = " + mSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[uSrcType] = "
		...
		if (TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBBBBFBFFBBB(uTrgType, uPackage,
							mSrcType, mPackage, uSrcType, mTrgType, sourceMatch, targetMatch)) {
				NamedElement2NamedElement src2Src = (NamedElement2NamedElement) result5_black[4];
				NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result5_black[6];
				...
				Object[] result6_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(uTrgType,
								uUsage, uPackage, mSrcType, mPackage, uSrcType, mTrgType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uTrgType] = " + uTrgType
							+ ", " + "[uUsage] = " + uUsage + ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = "
							+ mSrcType + ", " + "[mPackage] = " + mPackage + ", " + "[uSrcType] = " + uSrcType + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Classifier uTrgType, Usage uUsage, org.eclipse.uml2.uml.Package uPackage,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : TypeDependency2UsageDependencyImpl
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result2_black[2];
			...
			NamedElement2NamedElement src2Src = (NamedElement2NamedElement) result2_black[7];
			...
			Object[] result3_bindingAndBlack = TypeDependency2UsageDependencyImpl
					.pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(this,
							isApplicableMatch, uTrgType, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p,
							mTrgType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uTrgType] = " + uTrgType + ", "
			...
			if (TypeDependency2UsageDependencyImpl
				...
				// 
				Object[] result5_black = TypeDependency2UsageDependencyImpl
						.pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(uTrgType, uPackage,
								mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType);
				if (result5_black != null) {

					Object[] result6_black = TypeDependency2UsageDependencyImpl
							.pattern_TypeDependency2UsageDependency_29_6_perform_blackBBBBBBBBBB(uTrgType, uPackage,
									mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uTrgType] = "
								+ uTrgType + ", " + "[uPackage] = " + uPackage + ", " + "[mSrcType] = " + mSrcType
					...
					TypeDependency2UsageDependencyImpl.pattern_TypeDependency2UsageDependency_29_6_perform_greenBFBBBBB(
							uTrgType, uPackage, mSrcType, uSrcType, mTrgType, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Classifier uTrgType,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.modisco.java.Package mPackage,
			NamedElement2NamedElement src2Src, org.eclipse.uml2.uml.Class uSrcType, NamedElement2NamedElement trg2Trg,
			JavaPackage2UmlPackage p2p, Type mTrgType, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSIFIER_PACKAGE_MCLASS_PACKAGE_NAMEDELEMENT2NAMEDELEMENT_CLASS_NAMEDELEMENT2NAMEDELEMENT_JAVAPACKAGE2UMLPACKAGE_TYPE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Classifier) arguments.get(1),
					...
					(org.eclipse.modisco.java.Package) arguments.get(4), (NamedElement2NamedElement) arguments.get(5),
					(org.eclipse.uml2.uml.Class) arguments.get(6), (NamedElement2NamedElement) arguments.get(7),
					(JavaPackage2UmlPackage) arguments.get(8), (Type) arguments.get(9));
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD__MATCH_CLASSIFIER_USAGE_PACKAGE_CLASS:
			return isAppropriate_BWD((Match) arguments.get(0), (Classifier) arguments.get(1), (Usage) arguments.get(2),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSIFIER_USAGE_PACKAGE_MCLASS_PACKAGE_NAMEDELEMENT2NAMEDELEMENT_CLASS_NAMEDELEMENT2NAMEDELEMENT_JAVAPACKAGE2UMLPACKAGE_TYPE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Classifier) arguments.get(1),
					...
					(NamedElement2NamedElement) arguments.get(6), (org.eclipse.uml2.uml.Class) arguments.get(7),
					(NamedElement2NamedElement) arguments.get(8), (JavaPackage2UmlPackage) arguments.get(9),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_299__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_299((EMoflonEdge) arguments.get(0));
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_308__EMOFLONEDGE:
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___IS_APPLICABLE_SOLVE_CSP_CC__CLASSIFIER_USAGE_PACKAGE_MCLASS_PACKAGE_CLASS_TYPE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Classifier) arguments.get(0), (Usage) arguments.get(1),
					(org.eclipse.uml2.uml.Package) arguments.get(2), (MClass) arguments.get(3),
					(org.eclipse.modisco.java.Package) arguments.get(4), (org.eclipse.uml2.uml.Class) arguments.get(5),
		...
		case RulesPackage.TYPE_DEPENDENCY2_USAGE_DEPENDENCY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSIFIER_PACKAGE_MCLASS_PACKAGE_NAMEDELEMENT2NAMEDELEMENT_CLASS_NAMEDELEMENT2NAMEDELEMENT_JAVAPACKAGE2UMLPACKAGE_TYPE_MODELGENERATORRULERESULT:
								...
								if (tmpTrg2Trg instanceof NamedElement2NamedElement) {
									...
									if (tmpP2p instanceof JavaPackage2UmlPackage) {
										...
										if (tmpMTrgType instanceof Type) {
											...
											return new Object[] { uTrgType, uPackage, mSrcType, mPackage, src2Src,
													uSrcType, trg2Trg, p2p, mTrgType, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
			...
			org.eclipse.modisco.java.Package mPackage, NamedElement2NamedElement src2Src,
			org.eclipse.uml2.uml.Class uSrcType, NamedElement2NamedElement trg2Trg, JavaPackage2UmlPackage p2p,
			Type mTrgType, TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch) {
		if (!mSrcType.equals(mTrgType)) {
				...
				if (!uSrcType.equals(uTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uTrgType, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg,
									p2p, mTrgType, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding != null) {
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_binding[6];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black = pattern_TypeDependency2UsageDependency_1_1_performtransformation_blackBBBBBBBBBFBB(
					uTrgType, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_1_1_performtransformation_black != null) {
				...
				return new Object[] { uTrgType, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType,
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject uTrgType, EObject uUsage, EObject uPackage, EObject mSrcType,
			EObject mPackage, EObject src2Src, EObject uSrcType, EObject trg2Trg, EObject p2p, EObject mTrgType) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_1_3_bookkeepingforedges_greenBBBBBBBFFFF(
		...
		mSrcType__mTrgType____dependencies.setName(mSrcType__mTrgType____dependencies_name_prime);
		return new Object[] { ruleresult, uTrgType, uUsage, uPackage, mSrcType, uSrcType, mTrgType,
	...
	public static final void pattern_TypeDependency2UsageDependency_1_5_registerobjects_expressionBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, PerformRuleResult ruleresult, EObject uTrgType, EObject uUsage,
			EObject uPackage, EObject mSrcType, EObject mPackage, EObject src2Src, EObject uSrcType, EObject trg2Trg,
			EObject p2p, EObject mTrgType) {
		_this.registerObjects_FWD(ruleresult, uTrgType, uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType,
				trg2Trg, p2p, mTrgType);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_2_2_corematch_blackFFBBFFFFBB(
							...
							for (NamedElement2NamedElement trg2Trg : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!src2Src.equals(trg2Trg)) {
									...
									if (tmpUTrgType instanceof Classifier) {
										Classifier uTrgType = (Classifier) tmpUTrgType;
										if (!uSrcType.equals(uTrgType)) {
											_result.add(new Object[] { uTrgType, uPackage, mSrcType, mPackage, src2Src,
													uSrcType, trg2Trg, p2p, mTrgType, match });
										}
									}
											...
											if (mPackage.equals(p2p.getSource())) {
												if (uPackage.equals(p2p.getTarget())) {
													if (mTrgType.equals(trg2Trg.getSource())) {
														_result.add(new Object[] { uTrgType, uPackage, mSrcType,
																mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType });
													}
												}
											}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { uTrgType, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType,
				...
				src2Src__mSrcType____source, mSrcType__mTrgType____dependencies, mPackage__mSrcType____ownedElements,
				mSrcType__mPackage____package, trg2Trg__uTrgType____target, src2Src__uSrcType____target,
				p2p__mPackage____source, p2p__uPackage____target, trg2Trg__mTrgType____source };
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, uTrgType, uPackage, mSrcType,
				mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uTrgType, uPackage, mSrcType, mPackage, src2Src,
					uSrcType, trg2Trg, p2p, mTrgType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_2_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, uTrgType, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p,
				mTrgType);
								...
								if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
									...
									if (tmpTrg2Trg instanceof NamedElement2NamedElement) {
										...
										if (tmpP2p instanceof JavaPackage2UmlPackage) {
											...
											if (tmpMTrgType instanceof Type) {
												Type mTrgType = (Type) tmpMTrgType;
												return new Object[] { uTrgType, uUsage, uPackage, mSrcType, mPackage,
														src2Src, uSrcType, trg2Trg, p2p, mTrgType, isApplicableMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
			Classifier uTrgType, Usage uUsage, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
			org.eclipse.modisco.java.Package mPackage, NamedElement2NamedElement src2Src,
			org.eclipse.uml2.uml.Class uSrcType, NamedElement2NamedElement trg2Trg, JavaPackage2UmlPackage p2p,
			Type mTrgType, TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch) {
		if (!mSrcType.equals(mTrgType)) {
			if (!src2Src.equals(trg2Trg)) {
				if (!uSrcType.equals(uTrgType)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { uTrgType, uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType,
									trg2Trg, p2p, mTrgType, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_11_1_performtransformation_bindingAndBlackFFFFFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding != null) {
			...
			NamedElement2NamedElement trg2Trg = (NamedElement2NamedElement) result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_binding[7];
			...
			Object[] result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black = pattern_TypeDependency2UsageDependency_11_1_performtransformation_blackBBBBBBBBBBFBB(
					uTrgType, uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType, _this,
					isApplicableMatch);
			if (result_pattern_TypeDependency2UsageDependency_11_1_performtransformation_black != null) {
				...
				return new Object[] { uTrgType, uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p,
	...
	public static final void pattern_TypeDependency2UsageDependency_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject uPackage, EObject mSrcType, EObject mPackage, EObject src2Src, EObject uSrcType, EObject trg2Trg,
			EObject p2p, EObject mTrgType) {
		_this.registerObjects_BWD(ruleresult, uTrgType, uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType,
				trg2Trg, p2p, mTrgType);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_12_2_corematch_blackBBBFFFBFFFB(
							...
							if (tmpMSrcType instanceof MClass) {
								...
								if (!mSrcType.equals(mTrgType)) {
									for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
										...
										if (mPackage != null) {
											_result.add(new Object[] { uTrgType, uUsage, uPackage, mSrcType, mPackage,
													src2Src, uSrcType, trg2Trg, p2p, mTrgType, match });
										}
														...
														if (uPackage.equals(p2p.getTarget())) {
															if (mTrgType.equals(trg2Trg.getSource())) {
																_result.add(new Object[] { uTrgType, uUsage, uPackage,
																		mSrcType, mPackage, src2Src, uSrcType, trg2Trg,
																		p2p, mTrgType });
															}
														}
													}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_3_findcontext_greenBBBBBBBBBBFFFFFFFFFFFFFF(
		...
		p2p__uPackage____target.setName(p2p__uPackage____target_name_prime);
		trg2Trg__mTrgType____source.setName(trg2Trg__mTrgType____source_name_prime);
		return new Object[] { uTrgType, uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType,
				isApplicableMatch, uPackage__uSrcType____ownedElement, uSrcType__uPackage____owner,
				uPackage__uUsage____packagedElement, uUsage__uSrcType____client, uUsage__uTrgType____supplier,
				src2Src__mSrcType____source, mPackage__mSrcType____ownedElements, mSrcType__mPackage____package,
				trg2Trg__uTrgType____target, src2Src__uSrcType____target, p2p__mPackage____source,
				p2p__uPackage____target, trg2Trg__mTrgType____source };
	}

	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
			TypeDependency2UsageDependency _this, IsApplicableMatch isApplicableMatch, Classifier uTrgType,
			Usage uUsage, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
			org.eclipse.modisco.java.Package mPackage, NamedElement2NamedElement src2Src,
			org.eclipse.uml2.uml.Class uSrcType, NamedElement2NamedElement trg2Trg, JavaPackage2UmlPackage p2p,
			Type mTrgType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, uTrgType, uUsage, uPackage, mSrcType,
				mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uTrgType, uUsage, uPackage, mSrcType, mPackage,
					src2Src, uSrcType, trg2Trg, p2p, mTrgType };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_12_4_solveCSP_binding = pattern_TypeDependency2UsageDependency_12_4_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, uTrgType, uUsage, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg,
				p2p, mTrgType);
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_933941 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_933941)) {
					if (!uTrgType.equals(__DEC_uUsage_client_933941)) {
						if (!uPackage.equals(__DEC_uUsage_client_933941)) {
							if (!uSrcType.equals(__DEC_uUsage_client_933941)) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_20_2_testcorematchandDECs_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_953422 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_953422)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_953422)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_953422)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_953422)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
					...
					if (tmpMSrcType instanceof MClass) {
						...
						if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
							...
							if (tmpUSrcType instanceof org.eclipse.uml2.uml.Class) {
								...
								if (tmpMTrgType instanceof Type) {
									Type mTrgType = (Type) tmpMTrgType;
									return new Object[] { uTrgType, uUsage, uPackage, mSrcType, mPackage, uSrcType,
		...
		if (!mSrcType.equals(mTrgType)) {
			if (!uSrcType.equals(uTrgType)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { uTrgType, uUsage, uPackage, mSrcType, mPackage, uSrcType, mTrgType,
							sourceMatch, targetMatch };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black = pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					uTrgType, uUsage, uPackage, mSrcType, mPackage, uSrcType, mTrgType, sourceMatch, targetMatch);
			if (result_pattern_TypeDependency2UsageDependency_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { uTrgType, uUsage, uPackage, mSrcType, mPackage, uSrcType, mTrgType, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
			TypeDependency2UsageDependency _this, Classifier uTrgType, Usage uUsage,
			org.eclipse.uml2.uml.Package uPackage, MClass mSrcType, org.eclipse.modisco.java.Package mPackage,
			org.eclipse.uml2.uml.Class uSrcType, Type mTrgType, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_7 = _this.isApplicable_solveCsp_CC(uTrgType, uUsage, uPackage, mSrcType, mPackage, uSrcType,
				mTrgType, sourceMatch, targetMatch);
		CSP csp = _localVariable_7;
		if (csp != null) {
			return new Object[] { csp, _this, uTrgType, uUsage, uPackage, mSrcType, mPackage, uSrcType, mTrgType,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_TypeDependency2UsageDependency_24_3_solvecsp_binding = pattern_TypeDependency2UsageDependency_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, uTrgType, uUsage, uPackage, mSrcType, mPackage, uSrcType, mTrgType, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_blackBBBBFBFFBBB(
			Classifier uTrgType, org.eclipse.uml2.uml.Package uPackage, MClass mSrcType,
			org.eclipse.modisco.java.Package mPackage, org.eclipse.uml2.uml.Class uSrcType, Type mTrgType,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
									...
									if (mTrgType.equals(trg2Trg.getSource())) {
										for (JavaPackage2UmlPackage p2p : org.moflon.core.utilities.eMoflonEMFUtil
												.getOppositeReferenceTyped(mPackage, JavaPackage2UmlPackage.class,
														"source")) {
											if (uPackage.equals(p2p.getTarget())) {
												_result.add(new Object[] { uTrgType, uPackage, mSrcType, mPackage,
														src2Src, uSrcType, trg2Trg, p2p, mTrgType, sourceMatch,
														targetMatch });
											}
										}
									}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_5_matchcorrcontext_greenBBBBBF(
			NamedElement2NamedElement src2Src, NamedElement2NamedElement trg2Trg, JavaPackage2UmlPackage p2p,
			Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_24_6_createcorrespondence_blackBBBBBBBB(
		...
		if (!mSrcType.equals(mTrgType)) {
			if (!uSrcType.equals(uTrgType)) {
				return new Object[] { uTrgType, uUsage, uPackage, mSrcType, mPackage, uSrcType, mTrgType, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_0BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_client_224525 : uUsage.getClients()) {
				if (!uUsage.equals(__DEC_uUsage_client_224525)) {
					if (!uTrgType.equals(__DEC_uUsage_client_224525)) {
						if (!uPackage.equals(__DEC_uUsage_client_224525)) {
							if (!uSrcType.equals(__DEC_uUsage_client_224525)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_28_1_matchtggpattern_black_nac_1BBBB(
			...
			org.eclipse.uml2.uml.Class uSrcType) {
		if (!uSrcType.equals(uTrgType)) {
			for (NamedElement __DEC_uUsage_supplier_705518 : uUsage.getSuppliers()) {
				if (!uUsage.equals(__DEC_uUsage_supplier_705518)) {
					if (!uTrgType.equals(__DEC_uUsage_supplier_705518)) {
						if (!uPackage.equals(__DEC_uUsage_supplier_705518)) {
							if (!uSrcType.equals(__DEC_uUsage_supplier_705518)) {
								return new Object[] { uUsage, uTrgType, uPackage, uSrcType };
							}
						}
					}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_3_solveCSP_bindingFBBBBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, uTrgType, uPackage, mSrcType,
				mPackage, src2Src, uSrcType, trg2Trg, p2p, mTrgType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uTrgType, uPackage, mSrcType, mPackage, src2Src,
					uSrcType, trg2Trg, p2p, mTrgType, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_5_checknacs_blackBBBBBBBBB(
		...
		if (!mSrcType.equals(mTrgType)) {
			if (!src2Src.equals(trg2Trg)) {
				if (!uSrcType.equals(uTrgType)) {
					return new Object[] { uTrgType, uPackage, mSrcType, mPackage, src2Src, uSrcType, trg2Trg, p2p,
							mTrgType };
				}
			}
		}
	...
	public static final Object[] pattern_TypeDependency2UsageDependency_29_6_perform_greenBFBBBBB(Classifier uTrgType,
		...
		return new Object[] { uTrgType, uUsage, uPackage, mSrcType, uSrcType, mTrgType, ruleResult };
	}
