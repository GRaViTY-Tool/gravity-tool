...
public class AbstractTypeAccess2ReturnParamImpl extends AbstractRuleImpl implements AbstractTypeAccess2ReturnParam {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		MMethodDefinition method = (MMethodDefinition) result1_bindingAndBlack[6];
		CSP csp = (CSP) result1_bindingAndBlack[7];
		Object[] result1_green = AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_greenBBFBFB(uType, operation,
						typeAccess, csp);
		...
		Object[] result3_black = AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, m2o, ne2ne,
						uType, operation, returnParam, typeAccess, jType, ta2p, method);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[m2o] = " + m2o + ", " + "[ne2ne] = " + ne2ne + ", " + "[uType] = " + uType + ", "
					+ "[operation] = " + operation + ", " + "[returnParam] = " + returnParam + ", " + "[typeAccess] = "
					+ typeAccess + ", " + "[jType] = " + jType + ", " + "[ta2p] = " + ta2p + ", " + "[method] = "
					+ method + ".");
		}
		AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFF(ruleresult, uType,
						operation, returnParam, typeAccess, jType, ta2p, method);
		...
		AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, m2o,
						ne2ne, uType, operation, returnParam, typeAccess, jType, ta2p, method);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_2_2_corematch_blackFFFFBBBB(typeAccess, jType, method, match)) {
			...
			for (Object[] result3_black : AbstractTypeAccess2ReturnParamImpl
					.pattern_AbstractTypeAccess2ReturnParam_2_3_findcontext_blackBBBBBBB(m2o, ne2ne, uType, operation,
							typeAccess, jType, method)) {
				Object[] result3_green = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_2_3_findcontext_greenBBBBBBBFFFFFFFF(m2o, ne2ne, uType,
								operation, typeAccess, jType, method);
				...
				Object[] result4_bindingAndBlack = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, m2o, ne2ne, uType, operation, typeAccess, jType, method);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[m2o] = " + m2o + ", "
							+ "[ne2ne] = " + ne2ne + ", " + "[uType] = " + uType + ", " + "[operation] = " + operation
							+ ", " + "[typeAccess] = " + typeAccess + ", " + "[jType] = " + jType + ", " + "[method] = "
							+ method + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element m2o,
			ASTNode2Element ne2ne, org.eclipse.uml2.uml.Type uType, Operation operation, TypeAccess typeAccess,
			Type jType, MMethodDefinition method) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject m2o, EObject ne2ne, EObject uType,
			EObject operation, EObject returnParam, EObject typeAccess, EObject jType, EObject ta2p, EObject method) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_greenBFBFB(returnParam, jType,
						method);
		...
		Object[] result3_black = AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, m2o, ne2ne,
						uType, operation, returnParam, typeAccess, jType, ta2p, method);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[m2o] = " + m2o + ", " + "[ne2ne] = " + ne2ne + ", " + "[uType] = " + uType + ", "
		...
		AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_11_3_bookkeepingforedges_greenBBBBBBBBFFFFFFF(ruleresult, uType,
						operation, returnParam, typeAccess, jType, ta2p, method);
		//nothing EMoflonEdge typeAccess__jType____type = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge jType__typeAccess____usagesInTypeAccess = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge operation__returnParam____ownedParameter = (EMoflonEdge) result3_green[10];
		...
		AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						m2o, ne2ne, uType, operation, returnParam, typeAccess, jType, ta2p, method);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AbstractTypeAccess2ReturnParamImpl
			...
			// ForEach 
			for (Object[] result3_black : AbstractTypeAccess2ReturnParamImpl
					.pattern_AbstractTypeAccess2ReturnParam_12_3_findcontext_blackBBBBBBB(m2o, ne2ne, uType, operation,
							returnParam, jType, method)) {
				Object[] result3_green = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_12_3_findcontext_greenBBBBBBBFFFFFFF(m2o, ne2ne, uType,
								operation, returnParam, jType, method);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge ne2ne__uType____target = (EMoflonEdge) result3_green[8];
				...
				Object[] result4_bindingAndBlack = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, m2o, ne2ne, uType, operation, returnParam, jType, method);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[m2o] = " + m2o + ", "
							+ "[ne2ne] = " + ne2ne + ", " + "[uType] = " + uType + ", " + "[operation] = " + operation
							+ ", " + "[returnParam] = " + returnParam + ", " + "[jType] = " + jType + ", "
							+ "[method] = " + method + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element m2o,
			ASTNode2Element ne2ne, org.eclipse.uml2.uml.Type uType, Operation operation, Parameter returnParam,
			Type jType, MMethodDefinition method) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject m2o, EObject ne2ne, EObject uType,
			EObject operation, EObject returnParam, EObject typeAccess, EObject jType, EObject ta2p, EObject method) {
		ruleresult.registerObject("m2o", m2o);
		ruleresult.registerObject("ne2ne", ne2ne);
		ruleresult.registerObject("uType", uType);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, uType, operation,
						returnParam, typeAccess, jType, method, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[uType] = " + uType + ", " + "[operation] = " + operation + ", " + "[returnParam] = "
					+ returnParam + ", " + "[typeAccess] = " + typeAccess + ", " + "[jType] = " + jType + ", "
					+ "[method] = " + method + ", " + "[sourceMatch] = " + sourceMatch + ", " + "[targetMatch] = "
					+ targetMatch + ".");
		}
		...
		if (AbstractTypeAccess2ReturnParamImpl.pattern_AbstractTypeAccess2ReturnParam_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AbstractTypeAccess2ReturnParamImpl
					.pattern_AbstractTypeAccess2ReturnParam_24_5_matchcorrcontext_blackFFBBBBBB(uType, operation, jType,
				...
				Object[] result6_black = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_24_6_createcorrespondence_blackBBBBBBB(uType, operation,
								returnParam, typeAccess, jType, method, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uType] = " + uType + ", "
							+ "[operation] = " + operation + ", " + "[returnParam] = " + returnParam + ", "
							+ "[typeAccess] = " + typeAccess + ", " + "[jType] = " + jType + ", " + "[method] = "
							+ method + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				AbstractTypeAccess2ReturnParamImpl
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Type uType, Operation operation, Parameter returnParam,
			TypeAccess typeAccess, Type jType, MMethodDefinition method, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : AbstractTypeAccess2ReturnParamImpl
			...
			Object[] result3_bindingAndBlack = AbstractTypeAccess2ReturnParamImpl
					.pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, m2o, ne2ne, uType, operation, jType, method, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[m2o] = " + m2o + ", " + "[ne2ne] = "
						+ ne2ne + ", " + "[uType] = " + uType + ", " + "[operation] = " + operation + ", "
			...
			if (AbstractTypeAccess2ReturnParamImpl
				...
				// 
				Object[] result5_black = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_29_5_checknacs_blackBBBBBB(m2o, ne2ne, uType, operation,
								jType, method);
				if (result5_black != null) {

					Object[] result6_black = AbstractTypeAccess2ReturnParamImpl
							.pattern_AbstractTypeAccess2ReturnParam_29_6_perform_blackBBBBBBB(m2o, ne2ne, uType,
									operation, jType, method, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[m2o] = " + m2o + ", "
								+ "[ne2ne] = " + ne2ne + ", " + "[uType] = " + uType + ", " + "[operation] = "
								+ operation + ", " + "[jType] = " + jType + ", " + "[method] = " + method + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					AbstractTypeAccess2ReturnParamImpl
							.pattern_AbstractTypeAccess2ReturnParam_29_6_perform_greenBBFFBFBBB(uType, operation, jType,
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element m2o,
			ASTNode2Element ne2ne, org.eclipse.uml2.uml.Type uType, Operation operation, Type jType,
			MMethodDefinition method, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_TYPE_OPERATION_TYPEACCESS_TYPE_MMETHODDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(Operation) arguments.get(4), (TypeAccess) arguments.get(5), (Type) arguments.get(6),
					(MMethodDefinition) arguments.get(7));
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_TYPE_OPERATION_PARAMETER_TYPE_MMETHODDEFINITION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(ASTNode2Element) arguments.get(2), (org.eclipse.uml2.uml.Type) arguments.get(3),
					(Operation) arguments.get(4), (Parameter) arguments.get(5), (Type) arguments.get(6),
					(MMethodDefinition) arguments.get(7));
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_114__EMOFLONEDGE:
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___IS_APPLICABLE_SOLVE_CSP_CC__TYPE_OPERATION_PARAMETER_TYPEACCESS_TYPE_MMETHODDEFINITION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((org.eclipse.uml2.uml.Type) arguments.get(0), (Operation) arguments.get(1),
					(Parameter) arguments.get(2), (TypeAccess) arguments.get(3), (Type) arguments.get(4),
					(MMethodDefinition) arguments.get(5), (Match) arguments.get(6), (Match) arguments.get(7));
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_TYPE_OPERATION_TYPE_MMETHODDEFINITION_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(ASTNode2Element) arguments.get(2), (org.eclipse.uml2.uml.Type) arguments.get(3),
					(Operation) arguments.get(4), (Type) arguments.get(5), (MMethodDefinition) arguments.get(6),
						...
						if (tmpTypeAccess instanceof TypeAccess) {
							...
							if (tmpJType instanceof Type) {
								...
								if (tmpMethod instanceof MMethodDefinition) {
									...
									return new Object[] { m2o, ne2ne, uType, operation, typeAccess, jType, method,
											isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_blackBBBBBBBFBB(
			ASTNode2Element m2o, ASTNode2Element ne2ne, org.eclipse.uml2.uml.Type uType, Operation operation,
			TypeAccess typeAccess, Type jType, MMethodDefinition method, AbstractTypeAccess2ReturnParam _this,
			IsApplicableMatch isApplicableMatch) {
		if (!m2o.equals(ne2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { m2o, ne2ne, uType, operation, typeAccess, jType, method, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_binding != null) {
			...
			MMethodDefinition method = (MMethodDefinition) result_pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_binding[6];
			...
			Object[] result_pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_black = pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_blackBBBBBBBFBB(
					m2o, ne2ne, uType, operation, typeAccess, jType, method, _this, isApplicableMatch);
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_greenBBFBFB(
		...
		return new Object[] { uType, operation, returnParam, typeAccess, ta2p, csp };
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject m2o, EObject ne2ne, EObject uType, EObject operation,
			EObject returnParam, EObject typeAccess, EObject jType, EObject ta2p, EObject method) {
		if (!m2o.equals(ne2ne)) {
			if (!m2o.equals(uType)) {
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject uType, EObject operation, EObject returnParam, EObject typeAccess,
			EObject jType, EObject ta2p, EObject method) {
		EMoflonEdge typeAccess__jType____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge jType__typeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		method__typeAccess____returnType.setName(method__typeAccess____returnType_name_prime);
		return new Object[] { ruleresult, uType, operation, returnParam, typeAccess, jType, ta2p, method,
	...
	public static final void pattern_AbstractTypeAccess2ReturnParam_1_5_registerobjects_expressionBBBBBBBBBBB(
			AbstractTypeAccess2ReturnParam _this, PerformRuleResult ruleresult, EObject m2o, EObject ne2ne,
			EObject uType, EObject operation, EObject returnParam, EObject typeAccess, EObject jType, EObject ta2p,
			EObject method) {
		_this.registerObjects_FWD(ruleresult, m2o, ne2ne, uType, operation, returnParam, typeAccess, jType, ta2p,
				method);
				...
				for (ASTNode2Element m2o : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(method,
					...
					if (!m2o.equals(ne2ne)) {
						...
						if (tmpOperation instanceof Operation) {
							Operation operation = (Operation) tmpOperation;
							_result.add(
									new Object[] { m2o, ne2ne, uType, operation, typeAccess, jType, method, match });
						}
						...
						if (typeAccess.equals(method.getReturnType())) {
							if (operation.equals(m2o.getTarget())) {
								if (method.equals(m2o.getSource())) {
									_result.add(
											new Object[] { m2o, ne2ne, uType, operation, typeAccess, jType, method });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { m2o, ne2ne, uType, operation, typeAccess, jType, method, isApplicableMatch,
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_bindingFBBBBBBBBB(
			AbstractTypeAccess2ReturnParam _this, IsApplicableMatch isApplicableMatch, ASTNode2Element m2o,
			ASTNode2Element ne2ne, org.eclipse.uml2.uml.Type uType, Operation operation, TypeAccess typeAccess,
			Type jType, MMethodDefinition method) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, m2o, ne2ne, uType, operation,
				typeAccess, jType, method);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, m2o, ne2ne, uType, operation, typeAccess, jType,
					method };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_binding = pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, m2o, ne2ne, uType, operation, typeAccess, jType, method);
					...
					if (tmpOperation instanceof Operation) {
						...
						if (tmpReturnParam instanceof Parameter) {
							...
							if (tmpJType instanceof Type) {
								...
								if (tmpMethod instanceof MMethodDefinition) {
									MMethodDefinition method = (MMethodDefinition) tmpMethod;
									return new Object[] { m2o, ne2ne, uType, operation, returnParam, jType, method,
											isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_blackBBBBBBBFBB(
			ASTNode2Element m2o, ASTNode2Element ne2ne, org.eclipse.uml2.uml.Type uType, Operation operation,
			Parameter returnParam, Type jType, MMethodDefinition method, AbstractTypeAccess2ReturnParam _this,
			IsApplicableMatch isApplicableMatch) {
		if (!m2o.equals(ne2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { m2o, ne2ne, uType, operation, returnParam, jType, method, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_binding != null) {
			...
			MMethodDefinition method = (MMethodDefinition) result_pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_binding[6];
			...
			Object[] result_pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_black = pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_blackBBBBBBBFBB(
					m2o, ne2ne, uType, operation, returnParam, jType, method, _this, isApplicableMatch);
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_greenBFBFB(
		...
		ta2p.setSource(typeAccess);
		ta2p.setTarget(returnParam);
		return new Object[] { returnParam, typeAccess, jType, ta2p, method };
	}
	...
	public static final void pattern_AbstractTypeAccess2ReturnParam_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject uType, EObject operation, EObject returnParam, EObject typeAccess, EObject jType, EObject ta2p,
			EObject method) {
		_this.registerObjects_BWD(ruleresult, m2o, ne2ne, uType, operation, returnParam, typeAccess, jType, ta2p,
				method);
				...
				for (ASTNode2Element m2o : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(operation,
					...
					if (!m2o.equals(ne2ne)) {
						...
						if (tmpMethod instanceof MMethodDefinition) {
							MMethodDefinition method = (MMethodDefinition) tmpMethod;
							_result.add(
									new Object[] { m2o, ne2ne, uType, operation, returnParam, jType, method, match });
						}
					...
					if (jType.equals(ne2ne.getSource())) {
						if (uType.equals(returnParam.getType())) {
							if (operation.equals(m2o.getTarget())) {
								if (method.equals(m2o.getSource())) {
									_result.add(
											new Object[] { m2o, ne2ne, uType, operation, returnParam, jType, method });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		m2o__operation____target.setName(m2o__operation____target_name_prime);
		m2o__method____source.setName(m2o__method____source_name_prime);
		return new Object[] { m2o, ne2ne, uType, operation, returnParam, jType, method, isApplicableMatch,
				ne2ne__uType____target, operation__returnParam____ownedParameter, ne2ne__jType____source,
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			ASTNode2Element ne2ne, org.eclipse.uml2.uml.Type uType, Operation operation, Parameter returnParam,
			Type jType, MMethodDefinition method) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, m2o, ne2ne, uType, operation,
				returnParam, jType, method);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, m2o, ne2ne, uType, operation, returnParam, jType,
					method };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_binding = pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, m2o, ne2ne, uType, operation, returnParam, jType, method);
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_typeAccess_superInterfaces_59136 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!jType.equals(__DEC_typeAccess_superInterfaces_59136)) {
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_typeAccess_type_582947 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_2BB(
			TypeAccess typeAccess, Type jType) {
		for (ArrayType __DEC_typeAccess_elementType_128668 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ArrayType.class, "elementType")) {
			if (!jType.equals(__DEC_typeAccess_elementType_128668)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_3BB(
			TypeAccess typeAccess, Type jType) {
		for (ClassDeclaration __DEC_typeAccess_superClass_201274 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ClassDeclaration.class, "superClass")) {
			if (!jType.equals(__DEC_typeAccess_superClass_201274)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_4BB(
			TypeAccess typeAccess, Type jType) {
		for (ParameterizedType __DEC_typeAccess_type_422307 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ParameterizedType.class, "type")) {
			if (!jType.equals(__DEC_typeAccess_type_422307)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess typeAccess) {
		for (SingleVariableDeclaration __DEC_typeAccess_type_380202 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAccess) {
		for (AnnotationMemberValuePair __DEC_typeAccess_value_306740 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpReturnParam instanceof Parameter) {
					...
					if (tmpTypeAccess instanceof TypeAccess) {
						...
						if (tmpJType instanceof Type) {
							...
							if (tmpMethod instanceof MMethodDefinition) {
								MMethodDefinition method = (MMethodDefinition) tmpMethod;
								return new Object[] { uType, operation, returnParam, typeAccess, jType, method,
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_blackBBBBBBBB(
			org.eclipse.uml2.uml.Type uType, Operation operation, Parameter returnParam, TypeAccess typeAccess,
			Type jType, MMethodDefinition method, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { uType, operation, returnParam, typeAccess, jType, method, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_black = pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_blackBBBBBBBB(
					uType, operation, returnParam, typeAccess, jType, method, sourceMatch, targetMatch);
			if (result_pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { uType, operation, returnParam, typeAccess, jType, method, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_bindingFBBBBBBBBB(
			AbstractTypeAccess2ReturnParam _this, org.eclipse.uml2.uml.Type uType, Operation operation,
			Parameter returnParam, TypeAccess typeAccess, Type jType, MMethodDefinition method, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(uType, operation, returnParam, typeAccess, jType, method,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, uType, operation, returnParam, typeAccess, jType, method, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_binding = pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, uType, operation, returnParam, typeAccess, jType, method, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_AbstractTypeAccess2ReturnParam_24_5_matchcorrcontext_blackFFBBBBBB(
			org.eclipse.uml2.uml.Type uType, Operation operation, Type jType, MMethodDefinition method,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (ASTNode2Element ne2ne : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(uType,
				...
				if (jType.equals(ne2ne.getSource())) {
					for (ASTNode2Element m2o : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!m2o.equals(ne2ne)) {
							if (method.equals(m2o.getSource())) {
								_result.add(new Object[] { m2o, ne2ne, uType, operation, jType, method, sourceMatch,
										targetMatch });
							}
						}
					}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { uType, operation, returnParam, typeAccess, jType, method, ccMatch };
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_0BB(
			TypeAccess typeAccess, Type jType) {
		for (AbstractTypeDeclaration __DEC_typeAccess_superInterfaces_756733 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!jType.equals(__DEC_typeAccess_superInterfaces_756733)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAccess) {
		for (Annotation __DEC_typeAccess_type_619110 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, Annotation.class, "type")) {
			return new Object[] { typeAccess };
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess typeAccess, Type jType) {
		for (ArrayType __DEC_typeAccess_elementType_392768 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ArrayType.class, "elementType")) {
			if (!jType.equals(__DEC_typeAccess_elementType_392768)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_3BB(
			TypeAccess typeAccess, Type jType) {
		for (ClassDeclaration __DEC_typeAccess_superClass_858670 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ClassDeclaration.class, "superClass")) {
			if (!jType.equals(__DEC_typeAccess_superClass_858670)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_4BB(
			TypeAccess typeAccess, Type jType) {
		for (ParameterizedType __DEC_typeAccess_type_912354 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ParameterizedType.class, "type")) {
			if (!jType.equals(__DEC_typeAccess_type_912354)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_5B(
			TypeAccess typeAccess) {
		for (SingleVariableDeclaration __DEC_typeAccess_type_293647 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, SingleVariableDeclaration.class, "type")) {
			return new Object[] { typeAccess };
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAccess) {
		for (AnnotationMemberValuePair __DEC_typeAccess_value_520730 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAccess };
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_bindingFBBBBBBBBB(
			AbstractTypeAccess2ReturnParam _this, IsApplicableMatch isApplicableMatch, ASTNode2Element m2o,
			ASTNode2Element ne2ne, org.eclipse.uml2.uml.Type uType, Operation operation, Type jType,
			MMethodDefinition method, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, m2o, ne2ne, uType, operation, jType,
				method, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, m2o, ne2ne, uType, operation, jType, method,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_binding = pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, m2o, ne2ne, uType, operation, jType, method, ruleResult);
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_5_checknacs_blackBBBBBB(ASTNode2Element m2o,
			...
			MMethodDefinition method) {
		if (!m2o.equals(ne2ne)) {
			return new Object[] { m2o, ne2ne, uType, operation, jType, method };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_6_perform_blackBBBBBBB(ASTNode2Element m2o,
			...
			MMethodDefinition method, ModelgeneratorRuleResult ruleResult) {
		if (!m2o.equals(ne2ne)) {
			return new Object[] { m2o, ne2ne, uType, operation, jType, method, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_6_perform_greenBBFFBFBBB(
		...
		return new Object[] { uType, operation, returnParam, typeAccess, jType, ta2p, method, ruleResult, csp };
	}
