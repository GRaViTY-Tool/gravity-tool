...
public class AbstractTypeAccess2ReturnParamImpl extends AbstractRuleImpl implements AbstractTypeAccess2ReturnParam {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, ne2ne,
						typeAccess, m2o, method, operation, uType, jType, returnParam, ta2p);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[ne2ne] = " + ne2ne + ", " + "[typeAccess] = " + typeAccess + ", " + "[m2o] = " + m2o
					+ ", " + "[method] = " + method + ", " + "[operation] = " + operation + ", " + "[uType] = " + uType
					+ ", " + "[jType] = " + jType + ", " + "[returnParam] = " + returnParam + ", " + "[ta2p] = " + ta2p
					+ ".");
		}
		AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFF(ruleresult,
						typeAccess, method, operation, uType, jType, returnParam, ta2p);
		...
		AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						ne2ne, typeAccess, m2o, method, operation, uType, jType, returnParam, ta2p);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_2_2_corematch_blackFBFBFFBB(typeAccess, method, jType, match)) {
			...
			for (Object[] result3_black : AbstractTypeAccess2ReturnParamImpl
					.pattern_AbstractTypeAccess2ReturnParam_2_3_findcontext_blackBBBBBBB(ne2ne, typeAccess, m2o, method,
							operation, uType, jType)) {
				Object[] result3_green = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_2_3_findcontext_greenBBBBBBBFFFFFFFF(ne2ne, typeAccess,
								m2o, method, operation, uType, jType);
				...
				Object[] result4_bindingAndBlack = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, ne2ne, typeAccess, m2o, method, operation, uType, jType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[ne2ne] = " + ne2ne + ", "
							+ "[typeAccess] = " + typeAccess + ", " + "[m2o] = " + m2o + ", " + "[method] = " + method
							+ ", " + "[operation] = " + operation + ", " + "[uType] = " + uType + ", " + "[jType] = "
							+ jType + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element ne2ne,
			TypeAccess typeAccess, ASTNode2Element m2o, MMethodDefinition method, Operation operation,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject ne2ne, EObject typeAccess, EObject m2o,
			EObject method, EObject operation, EObject uType, EObject jType, EObject returnParam, EObject ta2p) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_greenFBBBF(method, jType,
						returnParam);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_12_2_corematch_blackFFFBBFBB(operation, uType, returnParam,
						match)) {
			ASTNode2Element ne2ne = (ASTNode2Element) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : AbstractTypeAccess2ReturnParamImpl
					.pattern_AbstractTypeAccess2ReturnParam_12_3_findcontext_blackBBBBBBB(ne2ne, m2o, method, operation,
							uType, jType, returnParam)) {
				Object[] result3_green = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_12_3_findcontext_greenBBBBBBBFFFFFFF(ne2ne, m2o, method,
								operation, uType, jType, returnParam);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge operation__returnParam____ownedParameter = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge m2o__operation____target = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge ne2ne__uType____target = (EMoflonEdge) result3_green[10];
				...
				Object[] result4_bindingAndBlack = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, ne2ne, m2o, method, operation, uType, jType, returnParam);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[ne2ne] = " + ne2ne + ", "
							+ "[m2o] = " + m2o + ", " + "[method] = " + method + ", " + "[operation] = " + operation
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element ne2ne,
			...
			Type jType, Parameter returnParam) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject ne2ne, EObject typeAccess, EObject m2o,
			EObject method, EObject operation, EObject uType, EObject jType, EObject returnParam, EObject ta2p) {
		ruleresult.registerObject("ne2ne", ne2ne);
		ruleresult.registerObject("typeAccess", typeAccess);
		ruleresult.registerObject("m2o", m2o);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_125(EMoflonEdge _edge_ownedParameter) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_130(EMoflonEdge _edge_returnType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AbstractTypeAccess2ReturnParamImpl
				.pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, typeAccess,
						method, operation, uType, jType, returnParam, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[typeAccess] = " + typeAccess + ", " + "[method] = " + method + ", " + "[operation] = "
					+ operation + ", " + "[uType] = " + uType + ", " + "[jType] = " + jType + ", " + "[returnParam] = "
		...
		if (AbstractTypeAccess2ReturnParamImpl.pattern_AbstractTypeAccess2ReturnParam_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AbstractTypeAccess2ReturnParamImpl
					.pattern_AbstractTypeAccess2ReturnParam_24_5_matchcorrcontext_blackFFBBBBBB(method, operation,
				...
				Object[] result6_black = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_24_6_createcorrespondence_blackBBBBBBB(typeAccess,
								method, operation, uType, jType, returnParam, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[typeAccess] = "
							+ typeAccess + ", " + "[method] = " + method + ", " + "[operation] = " + operation + ", "
							+ "[uType] = " + uType + ", " + "[jType] = " + jType + ", " + "[returnParam] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess typeAccess, MMethodDefinition method, Operation operation,
		...
		for (Object[] result2_black : AbstractTypeAccess2ReturnParamImpl
			...
			Object[] result3_bindingAndBlack = AbstractTypeAccess2ReturnParamImpl
					.pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, ne2ne, m2o, method, operation, uType, jType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (AbstractTypeAccess2ReturnParamImpl
				...
				// 
				Object[] result5_black = AbstractTypeAccess2ReturnParamImpl
						.pattern_AbstractTypeAccess2ReturnParam_29_5_checknacs_blackBBBBBB(ne2ne, m2o, method,
								operation, uType, jType);
				if (result5_black != null) {

					Object[] result6_black = AbstractTypeAccess2ReturnParamImpl
							.pattern_AbstractTypeAccess2ReturnParam_29_6_perform_blackBBBBBBB(ne2ne, m2o, method,
									operation, uType, jType, ruleResult);
					if (result6_black == null) {
					...
					AbstractTypeAccess2ReturnParamImpl
							.pattern_AbstractTypeAccess2ReturnParam_29_6_perform_greenFBBBBFFBB(method, operation,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_TYPEACCESS_ASTNODE2ELEMENT_MMETHODDEFINITION_OPERATION_TYPE_TYPE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(MMethodDefinition) arguments.get(4), (Operation) arguments.get(5),
					(org.eclipse.uml2.uml.Type) arguments.get(6), (Type) arguments.get(7));
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MMETHODDEFINITION_OPERATION_TYPE_TYPE_PARAMETER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(Operation) arguments.get(4), (org.eclipse.uml2.uml.Type) arguments.get(5), (Type) arguments.get(6),
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_125__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_125((EMoflonEdge) arguments.get(0));
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_130__EMOFLONEDGE:
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_MMETHODDEFINITION_OPERATION_TYPE_TYPE_PARAMETER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeAccess) arguments.get(0), (MMethodDefinition) arguments.get(1),
					(Operation) arguments.get(2), (org.eclipse.uml2.uml.Type) arguments.get(3), (Type) arguments.get(4),
		...
		case RulesPackage.ABSTRACT_TYPE_ACCESS2_RETURN_PARAM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MMETHODDEFINITION_OPERATION_TYPE_TYPE_MODELGENERATORRULERESULT:
						...
						if (tmpOperation instanceof Operation) {
							...
							if (tmpUType instanceof org.eclipse.uml2.uml.Type) {
								...
								if (tmpJType instanceof Type) {
									...
									return new Object[] { ne2ne, typeAccess, m2o, method, operation, uType, jType,
											isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_blackBBBBBBBFBB(
			ASTNode2Element ne2ne, TypeAccess typeAccess, ASTNode2Element m2o, MMethodDefinition method,
			Operation operation, org.eclipse.uml2.uml.Type uType, Type jType, AbstractTypeAccess2ReturnParam _this,
			IsApplicableMatch isApplicableMatch) {
		if (!m2o.equals(ne2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { ne2ne, typeAccess, m2o, method, operation, uType, jType, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_black = pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_blackBBBBBBBFBB(
					ne2ne, typeAccess, m2o, method, operation, uType, jType, _this, isApplicableMatch);
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_1_performtransformation_greenBBBFFB(
		...
		return new Object[] { typeAccess, operation, uType, returnParam, ta2p, csp };
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject ne2ne, EObject typeAccess, EObject m2o, EObject method,
			EObject operation, EObject uType, EObject jType, EObject returnParam, EObject ta2p) {
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject typeAccess, EObject method, EObject operation, EObject uType,
			EObject jType, EObject returnParam, EObject ta2p) {
		...
		typeAccess__jType____type.setName(typeAccess__jType____type_name_prime);
		jType__typeAccess____usagesInTypeAccess.setName(jType__typeAccess____usagesInTypeAccess_name_prime);
		return new Object[] { ruleresult, typeAccess, method, operation, uType, jType, returnParam, ta2p,
	...
	public static final void pattern_AbstractTypeAccess2ReturnParam_1_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject m2o, EObject method, EObject operation, EObject uType, EObject jType, EObject returnParam,
			EObject ta2p) {
		_this.registerObjects_FWD(ruleresult, ne2ne, typeAccess, m2o, method, operation, uType, jType, returnParam,
				ta2p);
				...
				for (ASTNode2Element m2o : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(method,
					...
					if (!m2o.equals(ne2ne)) {
						...
						if (tmpOperation instanceof Operation) {
							Operation operation = (Operation) tmpOperation;
							_result.add(
									new Object[] { ne2ne, typeAccess, m2o, method, operation, uType, jType, match });
						}
	...
	public static final Iterable<Object[]> pattern_AbstractTypeAccess2ReturnParam_2_3_findcontext_blackBBBBBBB(
			ASTNode2Element ne2ne, TypeAccess typeAccess, ASTNode2Element m2o, MMethodDefinition method,
			Operation operation, org.eclipse.uml2.uml.Type uType, Type jType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!m2o.equals(ne2ne)) {
						...
						if (jType.equals(ne2ne.getSource())) {
							if (method.equals(m2o.getSource())) {
								if (jType.equals(typeAccess.getType())) {
									_result.add(
											new Object[] { ne2ne, typeAccess, m2o, method, operation, uType, jType });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		typeAccess__jType____type.setName(typeAccess__jType____type_name_prime);
		jType__typeAccess____usagesInTypeAccess.setName(jType__typeAccess____usagesInTypeAccess_name_prime);
		return new Object[] { ne2ne, typeAccess, m2o, method, operation, uType, jType, isApplicableMatch,
				method__typeAccess____returnType, m2o__operation____target, ne2ne__uType____target,
				ne2ne__jType____source, m2o__method____source, typeAccess__jType____type,
				jType__typeAccess____usagesInTypeAccess };
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, ne2ne, typeAccess, m2o, method,
				operation, uType, jType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ne2ne, typeAccess, m2o, method, operation, uType,
					jType };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_binding = pattern_AbstractTypeAccess2ReturnParam_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, ne2ne, typeAccess, m2o, method, operation, uType, jType);
						...
						if (tmpUType instanceof org.eclipse.uml2.uml.Type) {
							...
							if (tmpJType instanceof Type) {
								...
								if (tmpReturnParam instanceof Parameter) {
									...
									return new Object[] { ne2ne, m2o, method, operation, uType, jType, returnParam,
											isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_blackBBBBBBBFBB(
			ASTNode2Element ne2ne, ASTNode2Element m2o, MMethodDefinition method, Operation operation,
			org.eclipse.uml2.uml.Type uType, Type jType, Parameter returnParam, AbstractTypeAccess2ReturnParam _this,
			IsApplicableMatch isApplicableMatch) {
		if (!m2o.equals(ne2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { ne2ne, m2o, method, operation, uType, jType, returnParam, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_black = pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_blackBBBBBBBFBB(
					ne2ne, m2o, method, operation, uType, jType, returnParam, _this, isApplicableMatch);
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_11_1_performtransformation_greenFBBBF(
		...
		ta2p.setTarget(returnParam);
		ta2p.setSource(typeAccess);
		return new Object[] { typeAccess, method, jType, returnParam, ta2p };
	}
	...
	public static final void pattern_AbstractTypeAccess2ReturnParam_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject m2o, EObject method, EObject operation, EObject uType, EObject jType, EObject returnParam,
			EObject ta2p) {
		_this.registerObjects_BWD(ruleresult, ne2ne, typeAccess, m2o, method, operation, uType, jType, returnParam,
				ta2p);
	...
	public static final Iterable<Object[]> pattern_AbstractTypeAccess2ReturnParam_12_2_corematch_blackFFFBBFBB(
				...
				for (ASTNode2Element ne2ne : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(uType,
					...
					if (!m2o.equals(ne2ne)) {
						...
						if (tmpJType instanceof Type) {
							Type jType = (Type) tmpJType;
							_result.add(
									new Object[] { ne2ne, m2o, method, operation, uType, jType, returnParam, match });
						}
	...
	public static final Iterable<Object[]> pattern_AbstractTypeAccess2ReturnParam_12_3_findcontext_blackBBBBBBB(
			ASTNode2Element ne2ne, ASTNode2Element m2o, MMethodDefinition method, Operation operation,
			org.eclipse.uml2.uml.Type uType, Type jType, Parameter returnParam) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!m2o.equals(ne2ne)) {
						...
						if (jType.equals(ne2ne.getSource())) {
							if (method.equals(m2o.getSource())) {
								if (uType.equals(returnParam.getType())) {
									_result.add(
											new Object[] { ne2ne, m2o, method, operation, uType, jType, returnParam });
								}
							}
						}
					}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		m2o__method____source.setName(m2o__method____source_name_prime);
		returnParam__uType____type.setName(returnParam__uType____type_name_prime);
		return new Object[] { ne2ne, m2o, method, operation, uType, jType, returnParam, isApplicableMatch,
				operation__returnParam____ownedParameter, m2o__operation____target, ne2ne__uType____target,
				ne2ne__jType____source, m2o__method____source, returnParam__uType____type };
	}

	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_bindingFBBBBBBBBB(
			AbstractTypeAccess2ReturnParam _this, IsApplicableMatch isApplicableMatch, ASTNode2Element ne2ne,
			ASTNode2Element m2o, MMethodDefinition method, Operation operation, org.eclipse.uml2.uml.Type uType,
			Type jType, Parameter returnParam) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, ne2ne, m2o, method, operation, uType,
				jType, returnParam);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ne2ne, m2o, method, operation, uType, jType,
					returnParam };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_binding = pattern_AbstractTypeAccess2ReturnParam_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, ne2ne, m2o, method, operation, uType, jType, returnParam);
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_typeAccess_superInterfaces_896108 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!jType.equals(__DEC_typeAccess_superInterfaces_896108)) {
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_typeAccess_type_841970 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_2BB(
			TypeAccess typeAccess, Type jType) {
		for (ArrayType __DEC_typeAccess_elementType_6845 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ArrayType.class, "elementType")) {
			if (!jType.equals(__DEC_typeAccess_elementType_6845)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_3BB(
			TypeAccess typeAccess, Type jType) {
		for (ClassDeclaration __DEC_typeAccess_superClass_914616 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ClassDeclaration.class, "superClass")) {
			if (!jType.equals(__DEC_typeAccess_superClass_914616)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_4BB(
			TypeAccess typeAccess, Type jType) {
		for (ParameterizedType __DEC_typeAccess_type_998005 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ParameterizedType.class, "type")) {
			if (!jType.equals(__DEC_typeAccess_type_998005)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess typeAccess) {
		for (SingleVariableDeclaration __DEC_typeAccess_type_382818 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess typeAccess) {
		for (AnnotationMemberValuePair __DEC_typeAccess_value_344 : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tmpOperation instanceof Operation) {
					...
					if (tmpUType instanceof org.eclipse.uml2.uml.Type) {
						...
						if (tmpJType instanceof Type) {
							...
							if (tmpReturnParam instanceof Parameter) {
								Parameter returnParam = (Parameter) tmpReturnParam;
								return new Object[] { typeAccess, method, operation, uType, jType, returnParam,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TypeAccess typeAccess, MMethodDefinition method, Operation operation, org.eclipse.uml2.uml.Type uType,
			Type jType, Parameter returnParam, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { typeAccess, method, operation, uType, jType, returnParam, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_black = pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_blackBBBBBBBB(
					typeAccess, method, operation, uType, jType, returnParam, sourceMatch, targetMatch);
			if (result_pattern_AbstractTypeAccess2ReturnParam_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { typeAccess, method, operation, uType, jType, returnParam, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_bindingFBBBBBBBBB(
			AbstractTypeAccess2ReturnParam _this, TypeAccess typeAccess, MMethodDefinition method, Operation operation,
			org.eclipse.uml2.uml.Type uType, Type jType, Parameter returnParam, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(typeAccess, method, operation, uType, jType, returnParam,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, typeAccess, method, operation, uType, jType, returnParam, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_binding = pattern_AbstractTypeAccess2ReturnParam_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, typeAccess, method, operation, uType, jType, returnParam, sourceMatch, targetMatch);
			...
			for (ASTNode2Element m2o : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(operation,
				...
				if (method.equals(m2o.getSource())) {
					for (ASTNode2Element ne2ne : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!m2o.equals(ne2ne)) {
							if (jType.equals(ne2ne.getSource())) {
								_result.add(new Object[] { ne2ne, m2o, method, operation, uType, jType, sourceMatch,
										targetMatch });
							}
						}
					}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { typeAccess, method, operation, uType, jType, returnParam, ccMatch };
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_0BB(
			TypeAccess typeAccess, Type jType) {
		for (AbstractTypeDeclaration __DEC_typeAccess_superInterfaces_386730 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!jType.equals(__DEC_typeAccess_superInterfaces_386730)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_1B(
			TypeAccess typeAccess) {
		for (Annotation __DEC_typeAccess_type_724989 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, Annotation.class, "type")) {
			return new Object[] { typeAccess };
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_2BB(
			TypeAccess typeAccess, Type jType) {
		for (ArrayType __DEC_typeAccess_elementType_531208 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ArrayType.class, "elementType")) {
			if (!jType.equals(__DEC_typeAccess_elementType_531208)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_3BB(
			TypeAccess typeAccess, Type jType) {
		for (ClassDeclaration __DEC_typeAccess_superClass_826718 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ClassDeclaration.class, "superClass")) {
			if (!jType.equals(__DEC_typeAccess_superClass_826718)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_4BB(
			TypeAccess typeAccess, Type jType) {
		for (ParameterizedType __DEC_typeAccess_type_172154 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, ParameterizedType.class, "type")) {
			if (!jType.equals(__DEC_typeAccess_type_172154)) {
				return new Object[] { typeAccess, jType };
			}
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_5B(
			TypeAccess typeAccess) {
		for (SingleVariableDeclaration __DEC_typeAccess_type_611319 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, SingleVariableDeclaration.class, "type")) {
			return new Object[] { typeAccess };
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_27_1_matchtggpattern_black_nac_6B(
			TypeAccess typeAccess) {
		for (AnnotationMemberValuePair __DEC_typeAccess_value_881322 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(typeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { typeAccess };
		}
		return null;
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, ne2ne, m2o, method, operation, uType,
				jType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, ne2ne, m2o, method, operation, uType, jType,
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_binding = pattern_AbstractTypeAccess2ReturnParam_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, ne2ne, m2o, method, operation, uType, jType, ruleResult);
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_5_checknacs_blackBBBBBB(
			...
			org.eclipse.uml2.uml.Type uType, Type jType) {
		if (!m2o.equals(ne2ne)) {
			return new Object[] { ne2ne, m2o, method, operation, uType, jType };
		}
		return null;
	}
	...
	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_6_perform_blackBBBBBBB(ASTNode2Element ne2ne,
			...
			Type jType, ModelgeneratorRuleResult ruleResult) {
		if (!m2o.equals(ne2ne)) {
			return new Object[] { ne2ne, m2o, method, operation, uType, jType, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_AbstractTypeAccess2ReturnParam_29_6_perform_greenFBBBBFFBB(
			MMethodDefinition method, Operation operation, org.eclipse.uml2.uml.Type uType, Type jType,
		...
		return new Object[] { typeAccess, method, operation, uType, jType, returnParam, ta2p, ruleResult, csp };
	}
