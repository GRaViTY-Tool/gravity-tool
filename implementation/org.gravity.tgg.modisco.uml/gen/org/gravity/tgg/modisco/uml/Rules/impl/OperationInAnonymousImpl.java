...
public class OperationInAnonymousImpl extends AbstractRuleImpl implements OperationInAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		AnonymousClassDeclaration classDec = (AnonymousClassDeclaration) result1_bindingAndBlack[0];
		...
		Object[] result3_black = OperationInAnonymousImpl
				.pattern_OperationInAnonymous_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, classDec, a2c, bd2ne,
						umlClass, feature, bodyDeclaration);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[classDec] = " + classDec + ", " + "[a2c] = " + a2c + ", " + "[bd2ne] = " + bd2ne + ", "
		...
		OperationInAnonymousImpl.pattern_OperationInAnonymous_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				classDec, umlClass, feature, bodyDeclaration);
		...
		OperationInAnonymousImpl.pattern_OperationInAnonymous_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInAnonymousImpl
				.pattern_OperationInAnonymous_2_2_corematch_blackBFFFFBB(classDec, bodyDeclaration, match)) {
			...
			for (Object[] result3_black : OperationInAnonymousImpl
					.pattern_OperationInAnonymous_2_3_findcontext_blackBBBBBB(classDec, a2c, bd2ne, umlClass, feature,
							bodyDeclaration)) {
				Object[] result3_green = OperationInAnonymousImpl
						.pattern_OperationInAnonymous_2_3_findcontext_greenBBBBBBFFFFFFF(classDec, a2c, bd2ne, umlClass,
								feature, bodyDeclaration);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge a2c__classDec____source = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AnonymousClassDeclaration classDec,
			ASTNode2Element a2c, ASTNode2Element bd2ne, org.eclipse.uml2.uml.Class umlClass, Operation feature,
			MAbstractMethodDefinition bodyDeclaration) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject classDec, EObject a2c, EObject bd2ne,
			EObject umlClass, EObject feature, EObject bodyDeclaration) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInAnonymousImpl
				.pattern_OperationInAnonymous_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, classDec, a2c, bd2ne,
						umlClass, feature, bodyDeclaration);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[classDec] = " + classDec + ", " + "[a2c] = " + a2c + ", " + "[bd2ne] = " + bd2ne + ", "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInAnonymousImpl
			...
			// ForEach 
			for (Object[] result3_black : OperationInAnonymousImpl
					.pattern_OperationInAnonymous_12_3_findcontext_blackBBBBBB(classDec, a2c, bd2ne, umlClass, feature,
							bodyDeclaration)) {
				Object[] result3_green = OperationInAnonymousImpl
						.pattern_OperationInAnonymous_12_3_findcontext_greenBBBBBBFFFFFFF(classDec, a2c, bd2ne,
								umlClass, feature, bodyDeclaration);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge a2c__classDec____source = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge a2c__umlClass____target = (EMoflonEdge) result3_green[8];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, AnonymousClassDeclaration classDec,
			ASTNode2Element a2c, ASTNode2Element bd2ne, org.eclipse.uml2.uml.Class umlClass, Operation feature,
			MAbstractMethodDefinition bodyDeclaration) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject classDec, EObject a2c, EObject bd2ne,
			EObject umlClass, EObject feature, EObject bodyDeclaration) {
		ruleresult.registerObject("classDec", classDec);
		ruleresult.registerObject("a2c", a2c);
		ruleresult.registerObject("bd2ne", bd2ne);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_128(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		AnonymousClassDeclaration classDec = (AnonymousClassDeclaration) result2_bindingAndBlack[0];
		...
		Object[] result3_bindingAndBlack = OperationInAnonymousImpl
				.pattern_OperationInAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, classDec, umlClass, feature,
		...
		if (OperationInAnonymousImpl.pattern_OperationInAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInAnonymousImpl
					.pattern_OperationInAnonymous_24_5_matchcorrcontext_blackBFFBBBBB(classDec, umlClass, feature,
							bodyDeclaration, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = OperationInAnonymousImpl
						.pattern_OperationInAnonymous_24_6_createcorrespondence_blackBBBBB(classDec, umlClass, feature,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AnonymousClassDeclaration classDec, org.eclipse.uml2.uml.Class umlClass,
			Operation feature, MAbstractMethodDefinition bodyDeclaration, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : OperationInAnonymousImpl
			...
			Object[] result3_bindingAndBlack = OperationInAnonymousImpl
					.pattern_OperationInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
						+ "[a2c] = " + a2c + ", " + "[bd2ne] = " + bd2ne + ", " + "[umlClass] = " + umlClass + ", "
			...
			if (OperationInAnonymousImpl.pattern_OperationInAnonymous_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = OperationInAnonymousImpl
						.pattern_OperationInAnonymous_29_5_checknacs_blackBBBBBB(classDec, a2c, bd2ne, umlClass,
								feature, bodyDeclaration);
				if (result5_black != null) {

					Object[] result6_black = OperationInAnonymousImpl
							.pattern_OperationInAnonymous_29_6_perform_blackBBBBBBB(classDec, a2c, bd2ne, umlClass,
									feature, bodyDeclaration, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching failed." + " Variables: " + "[classDec] = " + classDec + ", "
										+ "[a2c] = " + a2c + ", " + "[bd2ne] = " + bd2ne + ", " + "[umlClass] = "
										+ umlClass + ", " + "[feature] = " + feature + ", " + "[bodyDeclaration] = "
										+ bodyDeclaration + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					OperationInAnonymousImpl.pattern_OperationInAnonymous_29_6_perform_greenBBBBB(classDec, umlClass,
							feature, bodyDeclaration, ruleResult);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, AnonymousClassDeclaration classDec,
			ASTNode2Element a2c, ASTNode2Element bd2ne, org.eclipse.uml2.uml.Class umlClass, Operation feature,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_CLASS_OPERATION_MABSTRACTMETHODDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					...
					(Operation) arguments.get(5), (MAbstractMethodDefinition) arguments.get(6));
		...
		case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_CLASS_OPERATION_MABSTRACTMETHODDEFINITION:
		...
		case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_128__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_128((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_135__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__ANONYMOUSCLASSDECLARATION_CLASS_OPERATION_MABSTRACTMETHODDEFINITION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((AnonymousClassDeclaration) arguments.get(0),
					...
					(MAbstractMethodDefinition) arguments.get(3), (Match) arguments.get(4), (Match) arguments.get(5));
		...
		case RulesPackage.OPERATION_IN_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_CLASS_OPERATION_MABSTRACTMETHODDEFINITION_MODELGENERATORRULERESULT:
					...
					if (tmpUmlClass instanceof org.eclipse.uml2.uml.Class) {
						...
						if (tmpFeature instanceof Operation) {
							...
							if (tmpBodyDeclaration instanceof MAbstractMethodDefinition) {
								...
								return new Object[] { classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInAnonymous_1_1_performtransformation_blackBBBBBBFBB(
			AnonymousClassDeclaration classDec, ASTNode2Element a2c, ASTNode2Element bd2ne,
		...
		if (!a2c.equals(bd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInAnonymous_1_1_performtransformation_binding != null) {
			AnonymousClassDeclaration classDec = (AnonymousClassDeclaration) result_pattern_OperationInAnonymous_1_1_performtransformation_binding[0];
			...
			Object[] result_pattern_OperationInAnonymous_1_1_performtransformation_black = pattern_OperationInAnonymous_1_1_performtransformation_blackBBBBBBFBB(
					classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInAnonymous_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject classDec, EObject a2c, EObject bd2ne, EObject umlClass,
														...
														if (!bodyDeclaration.equals(classDec)) {
															if (!bodyDeclaration.equals(umlClass)) {
																if (!bodyDeclaration.equals(feature)) {
																	return new Object[] { ruleresult, classDec, a2c,
																			bd2ne, umlClass, feature, bodyDeclaration };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInAnonymous_1_5_registerobjects_expressionBBBBBBBB(
			OperationInAnonymous _this, PerformRuleResult ruleresult, EObject classDec, EObject a2c, EObject bd2ne,
			EObject umlClass, EObject feature, EObject bodyDeclaration) {
		_this.registerObjects_FWD(ruleresult, classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration);
	...
	public static final Iterable<Object[]> pattern_OperationInAnonymous_2_2_corematch_blackBFFFFBB(
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!a2c.equals(bd2ne)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration, match });
						}
					...
					if (umlClass.equals(a2c.getTarget())) {
						if (bodyDeclaration.equals(bd2ne.getSource())) {
							if (feature.equals(bd2ne.getTarget())) {
								_result.add(new Object[] { classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInAnonymous_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration, isApplicableMatch,
				a2c__classDec____source, classDec__bodyDeclaration____bodyDeclarations,
				bodyDeclaration__classDec____anonymousClassDeclarationOwner, a2c__umlClass____target,
	...
	public static final Object[] pattern_OperationInAnonymous_2_4_solveCSP_bindingFBBBBBBBB(OperationInAnonymous _this,
			IsApplicableMatch isApplicableMatch, AnonymousClassDeclaration classDec, ASTNode2Element a2c,
			ASTNode2Element bd2ne, org.eclipse.uml2.uml.Class umlClass, Operation feature,
			MAbstractMethodDefinition bodyDeclaration) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, classDec, a2c, bd2ne, umlClass,
				feature, bodyDeclaration);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, a2c, bd2ne, umlClass, feature,
					bodyDeclaration };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			OperationInAnonymous _this, IsApplicableMatch isApplicableMatch, AnonymousClassDeclaration classDec,
			ASTNode2Element a2c, ASTNode2Element bd2ne, org.eclipse.uml2.uml.Class umlClass, Operation feature,
			MAbstractMethodDefinition bodyDeclaration) {
		Object[] result_pattern_OperationInAnonymous_2_4_solveCSP_binding = pattern_OperationInAnonymous_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration);
	...
	public static final Object[] pattern_OperationInAnonymous_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInAnonymous_11_1_performtransformation_binding != null) {
			AnonymousClassDeclaration classDec = (AnonymousClassDeclaration) result_pattern_OperationInAnonymous_11_1_performtransformation_binding[0];
	...
	public static final void pattern_OperationInAnonymous_11_5_registerobjects_expressionBBBBBBBB(
			OperationInAnonymous _this, PerformRuleResult ruleresult, EObject classDec, EObject a2c, EObject bd2ne,
			EObject umlClass, EObject feature, EObject bodyDeclaration) {
		_this.registerObjects_BWD(ruleresult, classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration);
	...
	public static final Object[] pattern_OperationInAnonymous_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		bd2ne__feature____target.setName(bd2ne__feature____target_name_prime);
		return new Object[] { classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration, isApplicableMatch,
				a2c__classDec____source, a2c__umlClass____target, umlClass__feature____ownedOperation,
				feature__umlClass____class, bd2ne__bodyDeclaration____source, bd2ne__feature____target };
	}
	...
	public static final Object[] pattern_OperationInAnonymous_12_4_solveCSP_bindingFBBBBBBBB(OperationInAnonymous _this,
			...
			ASTNode2Element bd2ne, org.eclipse.uml2.uml.Class umlClass, Operation feature,
			MAbstractMethodDefinition bodyDeclaration) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, classDec, a2c, bd2ne, umlClass,
				feature, bodyDeclaration);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, a2c, bd2ne, umlClass, feature,
	...
	public static final Object[] pattern_OperationInAnonymous_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_OperationInAnonymous_24_2_matchsrctrgcontext_binding != null) {
			AnonymousClassDeclaration classDec = (AnonymousClassDeclaration) result_pattern_OperationInAnonymous_24_2_matchsrctrgcontext_binding[0];
			...
			Operation feature = (Operation) result_pattern_OperationInAnonymous_24_2_matchsrctrgcontext_binding[2];
	...
	public static final Object[] pattern_OperationInAnonymous_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			OperationInAnonymous _this, AnonymousClassDeclaration classDec, org.eclipse.uml2.uml.Class umlClass,
			Operation feature, MAbstractMethodDefinition bodyDeclaration, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_OperationInAnonymous_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, classDec, a2c, bd2ne, umlClass,
				feature, bodyDeclaration, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, a2c, bd2ne, umlClass, feature,
	...
	public static final Object[] pattern_OperationInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInAnonymous_29_3_solveCSP_binding = pattern_OperationInAnonymous_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration, ruleResult);
	...
	public static final Object[] pattern_OperationInAnonymous_29_6_perform_blackBBBBBBB(
		...
		if (!a2c.equals(bd2ne)) {
			return new Object[] { classDec, a2c, bd2ne, umlClass, feature, bodyDeclaration, ruleResult };
		}
		return null;
	}
