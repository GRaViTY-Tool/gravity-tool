...
public class OperationInAnonymousImpl extends AbstractRuleImpl implements OperationInAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInAnonymousImpl
				.pattern_OperationInAnonymous_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bodyDeclaration,
						umlClass, feature, a2c, bd2ne, classDec);
		...
		OperationInAnonymousImpl.pattern_OperationInAnonymous_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInAnonymousImpl
			...
			for (Object[] result3_black : OperationInAnonymousImpl
					.pattern_OperationInAnonymous_2_3_findcontext_blackBBBBBB(bodyDeclaration, umlClass, feature, a2c,
							bd2ne, classDec)) {
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ ", " + "[a2c] = " + a2c + ", " + "[bd2ne] = " + bd2ne + ", " + "[classDec] = " + classDec
							+ ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MAbstractMethodDefinition bodyDeclaration,
			org.eclipse.uml2.uml.Class umlClass, Operation feature, ASTNode2Element a2c, ASTNode2Element bd2ne,
			AnonymousClassDeclaration classDec) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject umlClass,
			EObject feature, EObject a2c, EObject bd2ne, EObject classDec) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInAnonymousImpl
				.pattern_OperationInAnonymous_12_2_corematch_blackFBBFFFB(umlClass, feature, match)) {
			...
			// ForEach 
			for (Object[] result3_black : OperationInAnonymousImpl
					.pattern_OperationInAnonymous_12_3_findcontext_blackBBBBBB(bodyDeclaration, umlClass, feature, a2c,
							bd2ne, classDec)) {
				Object[] result3_green = OperationInAnonymousImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_153(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInAnonymousImpl.pattern_OperationInAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInAnonymousImpl
					.pattern_OperationInAnonymous_24_5_matchcorrcontext_blackBBBFFBBB(bodyDeclaration, umlClass,
							feature, classDec, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : OperationInAnonymousImpl
			...
			Object[] result3_bindingAndBlack = OperationInAnonymousImpl
					.pattern_OperationInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (OperationInAnonymousImpl.pattern_OperationInAnonymous_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = OperationInAnonymousImpl
						.pattern_OperationInAnonymous_29_5_checknacs_blackBBBBBB(bodyDeclaration, umlClass, feature,
								a2c, bd2ne, classDec);
				if (result5_black != null) {

					Object[] result6_black = OperationInAnonymousImpl
							.pattern_OperationInAnonymous_29_6_perform_blackBBBBBBB(bodyDeclaration, umlClass, feature,
									a2c, bd2ne, classDec, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[bodyDeclaration] = "
								+ bodyDeclaration + ", " + "[umlClass] = " + umlClass + ", " + "[feature] = " + feature
								+ ", " + "[a2c] = " + a2c + ", " + "[bd2ne] = " + bd2ne + ", " + "[classDec] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			...
			ASTNode2Element a2c, ASTNode2Element bd2ne, AnonymousClassDeclaration classDec,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_CLASS_OPERATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_ANONYMOUSCLASSDECLARATION:
			...
			case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_CLASS_OPERATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_ANONYMOUSCLASSDECLARATION:
			...
			case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_153__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_153((EMoflonEdge) arguments.get(0));
			case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_168__EMOFLONEDGE:
			...
			case RulesPackage.OPERATION_IN_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_CLASS_OPERATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_ANONYMOUSCLASSDECLARATION_MODELGENERATORRULERESULT:
					...
					if (tmpA2c instanceof ASTNode2Element) {
						...
						if (tmpBd2ne instanceof ASTNode2Element) {
							...
							if (tmpClassDec instanceof AnonymousClassDeclaration) {
								...
								return new Object[] { bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInAnonymous_1_1_performtransformation_blackBBBBBBFBB(
			MAbstractMethodDefinition bodyDeclaration, org.eclipse.uml2.uml.Class umlClass, Operation feature,
			ASTNode2Element a2c, ASTNode2Element bd2ne, AnonymousClassDeclaration classDec, OperationInAnonymous _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a2c.equals(bd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInAnonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInAnonymous_1_1_performtransformation_black = pattern_OperationInAnonymous_1_1_performtransformation_blackBBBBBBFBB(
					bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInAnonymous_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject umlClass, EObject feature, EObject a2c,
	...
	public static final void pattern_OperationInAnonymous_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject feature, EObject a2c, EObject bd2ne, EObject classDec) {
		_this.registerObjects_FWD(ruleresult, bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec);
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!a2c.equals(bd2ne)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec, match });
						}
					...
					if (umlClass.equals(a2c.getTarget())) {
						if (bodyDeclaration.equals(bd2ne.getSource())) {
							if (feature.equals(bd2ne.getTarget())) {
								_result.add(new Object[] { bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInAnonymous_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec, isApplicableMatch,
				classDec__bodyDeclaration____bodyDeclarations,
	...
	public static final Object[] pattern_OperationInAnonymous_2_4_solveCSP_bindingFBBBBBBBB(OperationInAnonymous _this,
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, umlClass, feature, a2c, bd2ne,
					classDec };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_OperationInAnonymous_2_4_solveCSP_binding = pattern_OperationInAnonymous_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec);
	...
	public static final void pattern_OperationInAnonymous_11_5_registerobjects_expressionBBBBBBBB(
			OperationInAnonymous _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject umlClass,
			EObject feature, EObject a2c, EObject bd2ne, EObject classDec) {
		_this.registerObjects_BWD(ruleresult, bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec);
	...
	public static final Iterable<Object[]> pattern_OperationInAnonymous_12_2_corematch_blackFBBFFFB(
	...
	public static final Object[] pattern_OperationInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInAnonymous_29_3_solveCSP_binding = pattern_OperationInAnonymous_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec, ruleResult);
	...
	public static final Object[] pattern_OperationInAnonymous_29_6_perform_blackBBBBBBB(
		...
		if (!a2c.equals(bd2ne)) {
			return new Object[] { bodyDeclaration, umlClass, feature, a2c, bd2ne, classDec, ruleResult };
		}
		return null;
	}
