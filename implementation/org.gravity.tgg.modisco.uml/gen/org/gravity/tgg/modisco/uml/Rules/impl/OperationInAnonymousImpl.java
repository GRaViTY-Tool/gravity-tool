...
public class OperationInAnonymousImpl extends AbstractRuleImpl implements OperationInAnonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInAnonymousImpl
				.pattern_OperationInAnonymous_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bd2ne, umlClass,
						bodyDeclaration, classDec, a2c, feature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bd2ne] = " + bd2ne + ", " + "[umlClass] = " + umlClass + ", " + "[bodyDeclaration] = "
					+ bodyDeclaration + ", " + "[classDec] = " + classDec + ", " + "[a2c] = " + a2c + ", "
					+ "[feature] = " + feature + ".");
		}
		...
		OperationInAnonymousImpl.pattern_OperationInAnonymous_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInAnonymousImpl
				.pattern_OperationInAnonymous_2_2_corematch_blackFFBBFFB(bodyDeclaration, classDec, match)) {
			...
			for (Object[] result3_black : OperationInAnonymousImpl
					.pattern_OperationInAnonymous_2_3_findcontext_blackBBBBBB(bd2ne, umlClass, bodyDeclaration,
							classDec, a2c, feature)) {
				Object[] result3_green = OperationInAnonymousImpl
						.pattern_OperationInAnonymous_2_3_findcontext_greenBBBBBBFFFFFFF(bd2ne, umlClass,
								bodyDeclaration, classDec, a2c, feature);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[classDec] = " + classDec + ", " + "[a2c] = " + a2c + ", " + "[feature] = " + feature
							+ ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne,
			...
			AnonymousClassDeclaration classDec, ASTNode2Element a2c, Operation feature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bd2ne, EObject umlClass,
			EObject bodyDeclaration, EObject classDec, EObject a2c, EObject feature) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInAnonymousImpl
				.pattern_OperationInAnonymous_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bd2ne, umlClass,
						bodyDeclaration, classDec, a2c, feature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bd2ne] = " + bd2ne + ", " + "[umlClass] = " + umlClass + ", " + "[bodyDeclaration] = "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInAnonymousImpl
			...
			// ForEach 
			for (Object[] result3_black : OperationInAnonymousImpl
					.pattern_OperationInAnonymous_12_3_findcontext_blackBBBBBB(bd2ne, umlClass, bodyDeclaration,
							classDec, a2c, feature)) {
				Object[] result3_green = OperationInAnonymousImpl
						.pattern_OperationInAnonymous_12_3_findcontext_greenBBBBBBFFFFFFF(bd2ne, umlClass,
								bodyDeclaration, classDec, a2c, feature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_121(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInAnonymousImpl.pattern_OperationInAnonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInAnonymousImpl
					.pattern_OperationInAnonymous_24_5_matchcorrcontext_blackFBBBFBBB(umlClass, bodyDeclaration,
							classDec, feature, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : OperationInAnonymousImpl
			...
			Object[] result3_bindingAndBlack = OperationInAnonymousImpl
					.pattern_OperationInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[bd2ne] = " + bd2ne + ", "
						+ "[umlClass] = " + umlClass + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
			...
			if (OperationInAnonymousImpl.pattern_OperationInAnonymous_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = OperationInAnonymousImpl
						.pattern_OperationInAnonymous_29_5_checknacs_blackBBBBBB(bd2ne, umlClass, bodyDeclaration,
								classDec, a2c, feature);
				if (result5_black != null) {

					Object[] result6_black = OperationInAnonymousImpl
							.pattern_OperationInAnonymous_29_6_perform_blackBBBBBBB(bd2ne, umlClass, bodyDeclaration,
									classDec, a2c, feature, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[bd2ne] = " + bd2ne
								+ ", " + "[umlClass] = " + umlClass + ", " + "[bodyDeclaration] = " + bodyDeclaration
								+ ", " + "[classDec] = " + classDec + ", " + "[a2c] = " + a2c + ", " + "[feature] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne,
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration,
			AnonymousClassDeclaration classDec, ASTNode2Element a2c, Operation feature,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASS_MABSTRACTMETHODDEFINITION_ANONYMOUSCLASSDECLARATION_ASTNODE2ELEMENT_OPERATION:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(ASTNode2Element) arguments.get(1), (org.eclipse.uml2.uml.Class) arguments.get(2),
						(MAbstractMethodDefinition) arguments.get(3), (AnonymousClassDeclaration) arguments.get(4),
			...
			case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASS_MABSTRACTMETHODDEFINITION_ANONYMOUSCLASSDECLARATION_ASTNODE2ELEMENT_OPERATION:
			...
			case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_121__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_121((EMoflonEdge) arguments.get(0));
			case RulesPackage.OPERATION_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_133__EMOFLONEDGE:
			...
			case RulesPackage.OPERATION_IN_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASS_MABSTRACTMETHODDEFINITION_ANONYMOUSCLASSDECLARATION_ASTNODE2ELEMENT_OPERATION_MODELGENERATORRULERESULT:
					...
					if (tmpClassDec instanceof AnonymousClassDeclaration) {
						...
						if (tmpA2c instanceof ASTNode2Element) {
							...
							if (tmpFeature instanceof Operation) {
								...
								return new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInAnonymous_1_1_performtransformation_blackBBBBBBFBB(
			...
			AnonymousClassDeclaration classDec, ASTNode2Element a2c, Operation feature, OperationInAnonymous _this,
			IsApplicableMatch isApplicableMatch) {
		if (!a2c.equals(bd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInAnonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInAnonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInAnonymous_1_1_performtransformation_black = pattern_OperationInAnonymous_1_1_performtransformation_blackBBBBBBFBB(
					bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature, _this, isApplicableMatch);
	...
	public static final void pattern_OperationInAnonymous_1_5_registerobjects_expressionBBBBBBBB(
			OperationInAnonymous _this, PerformRuleResult ruleresult, EObject bd2ne, EObject umlClass,
			EObject bodyDeclaration, EObject classDec, EObject a2c, EObject feature) {
		_this.registerObjects_FWD(ruleresult, bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature);
				...
				for (ASTNode2Element a2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!a2c.equals(bd2ne)) {
						...
						if (tmpUmlClass instanceof org.eclipse.uml2.uml.Class) {
							org.eclipse.uml2.uml.Class umlClass = (org.eclipse.uml2.uml.Class) tmpUmlClass;
							_result.add(
									new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature, match });
						}
					...
					if (classDec.equals(a2c.getSource())) {
						if (umlClass.equals(a2c.getTarget())) {
							if (feature.equals(bd2ne.getTarget())) {
								_result.add(new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInAnonymous_2_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element bd2ne,
		...
		return new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature, isApplicableMatch,
	...
	public static final Object[] pattern_OperationInAnonymous_2_4_solveCSP_bindingFBBBBBBBB(OperationInAnonymous _this,
			...
			MAbstractMethodDefinition bodyDeclaration, AnonymousClassDeclaration classDec, ASTNode2Element a2c,
			Operation feature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, bd2ne, umlClass, bodyDeclaration,
				classDec, a2c, feature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bd2ne, umlClass, bodyDeclaration, classDec, a2c,
					feature };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInAnonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_OperationInAnonymous_2_4_solveCSP_binding = pattern_OperationInAnonymous_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature);
	...
	public static final void pattern_OperationInAnonymous_11_5_registerobjects_expressionBBBBBBBB(
			OperationInAnonymous _this, PerformRuleResult ruleresult, EObject bd2ne, EObject umlClass,
			EObject bodyDeclaration, EObject classDec, EObject a2c, EObject feature) {
		_this.registerObjects_BWD(ruleresult, bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature);
	...
	public static final Object[] pattern_OperationInAnonymous_12_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element bd2ne,
		...
		return new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature, isApplicableMatch,
				...
				a2c__classDec____source, a2c__umlClass____target, bd2ne__feature____target };
	}
	...
	public static final Iterable<Object[]> pattern_OperationInAnonymous_24_5_matchcorrcontext_blackFBBBFBBB(
			org.eclipse.uml2.uml.Class umlClass, MAbstractMethodDefinition bodyDeclaration,
			AnonymousClassDeclaration classDec, Operation feature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInAnonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInAnonymous_29_3_solveCSP_binding = pattern_OperationInAnonymous_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature, ruleResult);
	...
	public static final Object[] pattern_OperationInAnonymous_29_6_perform_blackBBBBBBB(ASTNode2Element bd2ne,
			...
			ModelgeneratorRuleResult ruleResult) {
		if (!a2c.equals(bd2ne)) {
			return new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, a2c, feature, ruleResult };
		}
		return null;
	}
