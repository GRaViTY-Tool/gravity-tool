...
public class OperationInAnnotationTypeImpl extends AbstractRuleImpl implements OperationInAnnotationType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInAnnotationTypeImpl
				.pattern_OperationInAnnotationType_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bodyDeclaration,
						feature, classDec, umlClass, bd2ne, c2c);
		...
		OperationInAnnotationTypeImpl.pattern_OperationInAnnotationType_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInAnnotationTypeImpl
			...
			for (Object[] result3_black : OperationInAnnotationTypeImpl
					.pattern_OperationInAnnotationType_2_3_findcontext_blackBBBBBB(bodyDeclaration, feature, classDec,
							umlClass, bd2ne, c2c)) {
				Object[] result3_green = OperationInAnnotationTypeImpl
						.pattern_OperationInAnnotationType_2_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, feature,
								classDec, umlClass, bd2ne, c2c);
				...
				Object[] result4_bindingAndBlack = OperationInAnnotationTypeImpl
						.pattern_OperationInAnnotationType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MAbstractMethodDefinition bodyDeclaration,
			Operation feature, AnnotationTypeDeclaration classDec, Interface umlClass, ASTNode2Element bd2ne,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject feature,
			EObject classDec, EObject umlClass, EObject bd2ne, EObject c2c) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInAnnotationTypeImpl
				.pattern_OperationInAnnotationType_12_2_corematch_blackFBFBFFB(feature, umlClass, match)) {
			...
			// ForEach 
			for (Object[] result3_black : OperationInAnnotationTypeImpl
					.pattern_OperationInAnnotationType_12_3_findcontext_blackBBBBBB(bodyDeclaration, feature, classDec,
							umlClass, bd2ne, c2c)) {
				Object[] result3_green = OperationInAnnotationTypeImpl
						.pattern_OperationInAnnotationType_12_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, feature,
								classDec, umlClass, bd2ne, c2c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge bd2ne__feature____target = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge c2c__umlClass____target = (EMoflonEdge) result3_green[8];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInAnnotationTypeImpl.pattern_OperationInAnnotationType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInAnnotationTypeImpl
					.pattern_OperationInAnnotationType_24_5_matchcorrcontext_blackBBBBFFBB(bodyDeclaration, feature,
							classDec, umlClass, sourceMatch, targetMatch)) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, ASTNode2Element bd2neParameter,
		...
		for (Object[] result2_black : OperationInAnnotationTypeImpl
			...
			if (OperationInAnnotationTypeImpl.pattern_OperationInAnnotationType_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = OperationInAnnotationTypeImpl
						.pattern_OperationInAnnotationType_29_5_checknacs_blackBBBBBB(bodyDeclaration, feature,
								classDec, umlClass, bd2ne, c2c);
				if (result5_black != null) {

					Object[] result6_black = OperationInAnnotationTypeImpl
							.pattern_OperationInAnnotationType_29_6_perform_blackBBBBBBB(bodyDeclaration, feature,
									classDec, umlClass, bd2ne, c2c, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[bodyDeclaration] = "
								+ bodyDeclaration + ", " + "[feature] = " + feature + ", " + "[classDec] = " + classDec
								+ ", " + "[umlClass] = " + umlClass + ", " + "[bd2ne] = " + bd2ne + ", " + "[c2c] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			...
			Interface umlClass, ASTNode2Element bd2ne, ASTNode2Element c2c, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_ANNOTATION_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_OPERATION_ANNOTATIONTYPEDECLARATION_INTERFACE_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MAbstractMethodDefinition) arguments.get(1), (Operation) arguments.get(2),
					(AnnotationTypeDeclaration) arguments.get(3), (Interface) arguments.get(4),
		...
		case RulesPackage.OPERATION_IN_ANNOTATION_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_OPERATION_ANNOTATIONTYPEDECLARATION_INTERFACE_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_ANNOTATION_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_133__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_ANNOTATION_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MABSTRACTMETHODDEFINITION_OPERATION_ANNOTATIONTYPEDECLARATION_INTERFACE_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpUmlClass instanceof Interface) {
						...
						if (tmpBd2ne instanceof ASTNode2Element) {
							...
							if (tmpC2c instanceof ASTNode2Element) {
								...
								return new Object[] { bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInAnnotationType_1_1_performtransformation_blackBBBBBBFBB(
			MAbstractMethodDefinition bodyDeclaration, Operation feature, AnnotationTypeDeclaration classDec,
			Interface umlClass, ASTNode2Element bd2ne, ASTNode2Element c2c, OperationInAnnotationType _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInAnnotationType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInAnnotationType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInAnnotationType_1_1_performtransformation_black = pattern_OperationInAnnotationType_1_1_performtransformation_blackBBBBBBFBB(
					bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInAnnotationType_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject feature, EObject classDec, EObject umlClass,
	...
	public static final void pattern_OperationInAnnotationType_1_5_registerobjects_expressionBBBBBBBB(
			OperationInAnnotationType _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject feature,
			EObject classDec, EObject umlClass, EObject bd2ne, EObject c2c) {
		_this.registerObjects_FWD(ruleresult, bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c);
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c, match });
						}
	...
	public static final Iterable<Object[]> pattern_OperationInAnnotationType_2_3_findcontext_blackBBBBBB(
			MAbstractMethodDefinition bodyDeclaration, Operation feature, AnnotationTypeDeclaration classDec,
			Interface umlClass, ASTNode2Element bd2ne, ASTNode2Element c2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
					...
					if (classDec.equals(c2c.getSource())) {
						if (bodyDeclaration.equals(bd2ne.getSource())) {
							if (classDec.getBodyDeclarations().contains(bodyDeclaration)) {
								_result.add(new Object[] { bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInAnnotationType_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		bodyDeclaration__classDec____abstractTypeDeclaration
				.setName(bodyDeclaration__classDec____abstractTypeDeclaration_name_prime);
		return new Object[] { bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c, isApplicableMatch,
	...
	public static final Object[] pattern_OperationInAnnotationType_2_4_solveCSP_bindingFBBBBBBBB(
			...
			MAbstractMethodDefinition bodyDeclaration, Operation feature, AnnotationTypeDeclaration classDec,
			Interface umlClass, ASTNode2Element bd2ne, ASTNode2Element c2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, bodyDeclaration, feature, classDec,
				umlClass, bd2ne, c2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, feature, classDec, umlClass, bd2ne,
					c2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInAnnotationType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_OperationInAnnotationType_2_4_solveCSP_binding = pattern_OperationInAnnotationType_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c);
		if (result_pattern_OperationInAnnotationType_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_OperationInAnnotationType_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, feature, classDec, umlClass,
						bd2ne, c2c };
			}
		}
		return null;
	...
	public static final void pattern_OperationInAnnotationType_11_5_registerobjects_expressionBBBBBBBB(
			OperationInAnnotationType _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject feature,
			EObject classDec, EObject umlClass, EObject bd2ne, EObject c2c) {
		_this.registerObjects_BWD(ruleresult, bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c);
	...
	public static final Object[] pattern_OperationInAnnotationType_12_4_solveCSP_bindingFBBBBBBBB(
			...
			MAbstractMethodDefinition bodyDeclaration, Operation feature, AnnotationTypeDeclaration classDec,
			Interface umlClass, ASTNode2Element bd2ne, ASTNode2Element c2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, bodyDeclaration, feature, classDec,
				umlClass, bd2ne, c2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, feature, classDec, umlClass, bd2ne,
	...
	public static final Iterable<Object[]> pattern_OperationInAnnotationType_24_5_matchcorrcontext_blackBBBBFFBB(
			MAbstractMethodDefinition bodyDeclaration, Operation feature, AnnotationTypeDeclaration classDec,
			Interface umlClass, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInAnnotationType_29_3_solveCSP_bindingFBBBBBBBBB(
			OperationInAnnotationType _this, IsApplicableMatch isApplicableMatch,
			MAbstractMethodDefinition bodyDeclaration, Operation feature, AnnotationTypeDeclaration classDec,
			Interface umlClass, ASTNode2Element bd2ne, ASTNode2Element c2c, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, bodyDeclaration, feature, classDec,
				umlClass, bd2ne, c2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, feature, classDec, umlClass, bd2ne,
					c2c, ruleResult };
	...
	public static final Object[] pattern_OperationInAnnotationType_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_OperationInAnnotationType_29_3_solveCSP_binding = pattern_OperationInAnnotationType_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c, ruleResult);
	...
	public static final Object[] pattern_OperationInAnnotationType_29_6_perform_blackBBBBBBB(
			...
			Interface umlClass, ASTNode2Element bd2ne, ASTNode2Element c2c, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { bodyDeclaration, feature, classDec, umlClass, bd2ne, c2c, ruleResult };
		}
		return null;
	}
