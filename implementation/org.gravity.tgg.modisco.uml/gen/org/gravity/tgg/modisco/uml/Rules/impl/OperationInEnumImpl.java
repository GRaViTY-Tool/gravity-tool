...
public class OperationInEnumImpl extends AbstractRuleImpl implements OperationInEnum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Enumeration umlClass = (Enumeration) result1_bindingAndBlack[4];
		...
		Object[] result3_black = OperationInEnumImpl.pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[feature] = " + feature + ", " + "[classDec] = " + classDec + ", " + "[bd2ne] = " + bd2ne
		...
		OperationInEnumImpl.pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, feature,
				classDec, bd2ne, bodyDeclaration, umlClass, c2c);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_2_2_corematch_blackFBFBFFB(classDec,
				bodyDeclaration, match)) {
			Operation feature = (Operation) result2_black[0];
			ASTNode2Element bd2ne = (ASTNode2Element) result2_black[2];
			Enumeration umlClass = (Enumeration) result2_black[4];
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_2_3_findcontext_blackBBBBBB(
					feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c)) {
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ bodyDeclaration + ", " + "[umlClass] = " + umlClass + ", " + "[c2c] = " + c2c + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Operation feature,
			EnumDeclaration classDec, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration,
			Enumeration umlClass, ASTNode2Element c2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject feature, EObject classDec, EObject bd2ne,
			EObject bodyDeclaration, EObject umlClass, EObject c2c) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_12_2_corematch_blackBFFFBFB(feature,
				umlClass, match)) {
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_12_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = OperationInEnumImpl
						.pattern_OperationInEnum_12_3_findcontext_greenBBBBBBFFFFFFF(feature, classDec, bd2ne,
								bodyDeclaration, umlClass, c2c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge umlClass__feature____ownedOperation = (EMoflonEdge) result3_green[7];
				//nothing EMoflonEdge feature__umlClass____datatype = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge bd2ne__feature____target = (EMoflonEdge) result3_green[9];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject feature, EObject classDec, EObject bd2ne,
			EObject bodyDeclaration, EObject umlClass, EObject c2c) {
		ruleresult.registerObject("feature", feature);
		ruleresult.registerObject("classDec", classDec);
		ruleresult.registerObject("bd2ne", bd2ne);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_680(EMoflonEdge _edge_ownedOperation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_729(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInEnumImpl.pattern_OperationInEnum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInEnumImpl
					.pattern_OperationInEnum_24_5_matchcorrcontext_blackBBFBBFBB(feature, classDec, bodyDeclaration,
							umlClass, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : OperationInEnumImpl
			...
			Object[] result3_bindingAndBlack = OperationInEnumImpl
					.pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, feature,
							classDec, bd2ne, bodyDeclaration, umlClass, c2c, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[feature] = " + feature + ", "
						+ "[classDec] = " + classDec + ", " + "[bd2ne] = " + bd2ne + ", " + "[bodyDeclaration] = "
			...
			if (OperationInEnumImpl.pattern_OperationInEnum_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInEnumImpl.pattern_OperationInEnum_29_6_perform_blackBBBBBBB(
							feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[feature] = "
								+ feature + ", " + "[classDec] = " + classDec + ", " + "[bd2ne] = " + bd2ne + ", "
								+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[umlClass] = " + umlClass + ", "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Operation feature,
			EnumDeclaration classDec, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration,
			Enumeration umlClass, ASTNode2Element c2c, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_OPERATION_ENUMDECLARATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_ENUMERATION_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Operation) arguments.get(1),
					...
					(MAbstractMethodDefinition) arguments.get(4), (Enumeration) arguments.get(5),
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_OPERATION_ENUMDECLARATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_ENUMERATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_680__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_680((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_729__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_OPERATION_ENUMDECLARATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_ENUMERATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpBodyDeclaration instanceof MAbstractMethodDefinition) {
						...
						if (tmpUmlClass instanceof Enumeration) {
							...
							if (tmpC2c instanceof ASTNode2Element) {
								...
								return new Object[] { feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(Operation feature,
			EnumDeclaration classDec, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration,
			Enumeration umlClass, ASTNode2Element c2c, OperationInEnum _this, IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInEnum_1_1_performtransformation_binding != null) {
			...
			Enumeration umlClass = (Enumeration) result_pattern_OperationInEnum_1_1_performtransformation_binding[4];
			...
			Object[] result_pattern_OperationInEnum_1_1_performtransformation_black = pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(
					feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject feature, EObject classDec, EObject bd2ne, EObject bodyDeclaration,
			EObject umlClass, EObject c2c) {
															...
															if (!c2c.equals(classDec)) {
																if (!c2c.equals(umlClass)) {
																	return new Object[] { ruleresult, feature, classDec,
																			bd2ne, bodyDeclaration, umlClass, c2c };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject feature, EObject classDec, EObject bd2ne, EObject bodyDeclaration,
			EObject umlClass, EObject c2c) {
		_this.registerObjects_FWD(ruleresult, feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c);
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_2_2_corematch_blackFBFBFFB(EnumDeclaration classDec,
				...
				for (ASTNode2Element c2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpUmlClass instanceof Enumeration) {
							Enumeration umlClass = (Enumeration) tmpUmlClass;
							_result.add(
									new Object[] { feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c, match });
						}
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_2_3_findcontext_blackBBBBBB(Operation feature,
			EnumDeclaration classDec, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration,
			Enumeration umlClass, ASTNode2Element c2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
					...
					if (bodyDeclaration.equals(bd2ne.getSource())) {
						if (classDec.equals(c2c.getSource())) {
							if (umlClass.equals(c2c.getTarget())) {
								_result.add(new Object[] { feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInEnum_2_3_findcontext_greenBBBBBBFFFFFFF(Operation feature,
		...
		return new Object[] { feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c, isApplicableMatch,
				classDec__bodyDeclaration____bodyDeclarations, bodyDeclaration__classDec____abstractTypeDeclaration,
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, Operation feature, EnumDeclaration classDec, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, Enumeration umlClass, ASTNode2Element c2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, feature, classDec, bd2ne,
				bodyDeclaration, umlClass, c2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, feature, classDec, bd2ne, bodyDeclaration, umlClass,
					c2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_2_4_solveCSP_binding = pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c);
		if (result_pattern_OperationInEnum_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_OperationInEnum_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, feature, classDec, bd2ne, bodyDeclaration,
						umlClass, c2c };
			}
		}
		return null;
	...
	public static final Object[] pattern_OperationInEnum_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInEnum_11_1_performtransformation_binding != null) {
			...
			Enumeration umlClass = (Enumeration) result_pattern_OperationInEnum_11_1_performtransformation_binding[4];
	...
	public static final void pattern_OperationInEnum_11_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject feature, EObject classDec, EObject bd2ne, EObject bodyDeclaration,
			EObject umlClass, EObject c2c) {
		_this.registerObjects_BWD(ruleresult, feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c);
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_12_2_corematch_blackBFFFBFB(Operation feature,
	...
	public static final Object[] pattern_OperationInEnum_12_3_findcontext_greenBBBBBBFFFFFFF(Operation feature,
		...
		return new Object[] { feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c, isApplicableMatch,
				...
				bd2ne__bodyDeclaration____source, c2c__classDec____source, c2c__umlClass____target };
	}

	public static final Object[] pattern_OperationInEnum_12_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, Operation feature, EnumDeclaration classDec, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, Enumeration umlClass, ASTNode2Element c2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, feature, classDec, bd2ne,
				bodyDeclaration, umlClass, c2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, feature, classDec, bd2ne, bodyDeclaration, umlClass,
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(OperationInEnum _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, feature, classDec, bd2ne,
				bodyDeclaration, umlClass, c2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, feature, classDec, bd2ne, bodyDeclaration, umlClass,
					c2c, ruleResult };
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_29_3_solveCSP_binding = pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c, ruleResult);
	...
	public static final Object[] pattern_OperationInEnum_29_6_perform_blackBBBBBBB(Operation feature,
			EnumDeclaration classDec, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration,
			Enumeration umlClass, ASTNode2Element c2c, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { feature, classDec, bd2ne, bodyDeclaration, umlClass, c2c, ruleResult };
		}
		return null;
	}
