...
public class OperationInEnumImpl extends AbstractRuleImpl implements OperationInEnum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInEnumImpl.pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[classDec] = " + classDec + ", " + "[feature] = " + feature + ", "
					+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[bd2ne] = " + bd2ne + ", " + "[umlClass] = "
					+ umlClass + ", " + "[c2c] = " + c2c + ".");
		}
		...
		OperationInEnumImpl.pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, classDec,
				feature, bodyDeclaration, bd2ne, umlClass, c2c);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_2_2_corematch_blackBFBFFFB(classDec,
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_2_3_findcontext_blackBBBBBB(
					classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, EnumDeclaration classDec,
			Operation feature, MAbstractMethodDefinition bodyDeclaration, ASTNode2Element bd2ne, Enumeration umlClass,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject classDec, EObject feature,
			EObject bodyDeclaration, EObject bd2ne, EObject umlClass, EObject c2c) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_12_2_corematch_blackFBFFBFB(feature,
				umlClass, match)) {
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_12_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = OperationInEnumImpl
						.pattern_OperationInEnum_12_3_findcontext_greenBBBBBBFFFFFFF(classDec, feature, bodyDeclaration,
								bd2ne, umlClass, c2c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge bd2ne__feature____target = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject classDec, EObject feature,
			EObject bodyDeclaration, EObject bd2ne, EObject umlClass, EObject c2c) {
		ruleresult.registerObject("classDec", classDec);
		ruleresult.registerObject("feature", feature);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_261(EMoflonEdge _edge_ownedOperation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_281(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInEnumImpl.pattern_OperationInEnum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInEnumImpl
					.pattern_OperationInEnum_24_5_matchcorrcontext_blackBBBFBFBB(classDec, feature, bodyDeclaration,
							umlClass, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : OperationInEnumImpl
			...
			Object[] result3_bindingAndBlack = OperationInEnumImpl
					.pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, classDec,
							feature, bodyDeclaration, bd2ne, umlClass, c2c, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
						+ "[feature] = " + feature + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
			...
			if (OperationInEnumImpl.pattern_OperationInEnum_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInEnumImpl.pattern_OperationInEnum_29_6_perform_blackBBBBBBB(
							classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[classDec] = "
								+ classDec + ", " + "[feature] = " + feature + ", " + "[bodyDeclaration] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ENUMDECLARATION_OPERATION_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_ENUMERATION_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (EnumDeclaration) arguments.get(1),
					...
					(ASTNode2Element) arguments.get(4), (Enumeration) arguments.get(5),
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMDECLARATION_OPERATION_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_ENUMERATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_261__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_261((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_281__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMDECLARATION_OPERATION_MABSTRACTMETHODDEFINITION_ASTNODE2ELEMENT_ENUMERATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpBd2ne instanceof ASTNode2Element) {
						...
						if (tmpUmlClass instanceof Enumeration) {
							...
							if (tmpC2c instanceof ASTNode2Element) {
								...
								return new Object[] { classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(
			...
			ASTNode2Element bd2ne, Enumeration umlClass, ASTNode2Element c2c, OperationInEnum _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInEnum_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInEnum_1_1_performtransformation_black = pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(
					classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject classDec, EObject feature, EObject bodyDeclaration, EObject bd2ne,
															...
															if (!c2c.equals(feature)) {
																if (!c2c.equals(umlClass)) {
																	return new Object[] { ruleresult, classDec, feature,
																			bodyDeclaration, bd2ne, umlClass, c2c };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject classDec, EObject feature, EObject bodyDeclaration, EObject bd2ne,
			EObject umlClass, EObject c2c) {
		_this.registerObjects_FWD(ruleresult, classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c);
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_2_2_corematch_blackBFBFFFB(EnumDeclaration classDec,
				...
				for (ASTNode2Element c2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpUmlClass instanceof Enumeration) {
							Enumeration umlClass = (Enumeration) tmpUmlClass;
							_result.add(
									new Object[] { classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c, match });
						}
					...
					if (bodyDeclaration.equals(bd2ne.getSource())) {
						if (classDec.equals(c2c.getSource())) {
							if (umlClass.equals(c2c.getTarget())) {
								_result.add(new Object[] { classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInEnum_2_3_findcontext_greenBBBBBBFFFFFFF(EnumDeclaration classDec,
		...
		return new Object[] { classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c, isApplicableMatch,
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, EnumDeclaration classDec, Operation feature,
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element bd2ne, Enumeration umlClass,
			ASTNode2Element c2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, classDec, feature, bodyDeclaration,
				bd2ne, umlClass, c2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, feature, bodyDeclaration, bd2ne, umlClass,
					c2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_2_4_solveCSP_binding = pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c);
		if (result_pattern_OperationInEnum_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_OperationInEnum_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, classDec, feature, bodyDeclaration, bd2ne,
						umlClass, c2c };
			}
		}
		return null;
	...
	public static final void pattern_OperationInEnum_11_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject classDec, EObject feature, EObject bodyDeclaration, EObject bd2ne,
			EObject umlClass, EObject c2c) {
		_this.registerObjects_BWD(ruleresult, classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c);
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_12_2_corematch_blackFBFFBFB(Operation feature,
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_12_3_findcontext_blackBBBBBB(
			EnumDeclaration classDec, Operation feature, MAbstractMethodDefinition bodyDeclaration,
			ASTNode2Element bd2ne, Enumeration umlClass, ASTNode2Element c2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
			if (feature.equals(bd2ne.getTarget())) {
	...
	public static final Object[] pattern_OperationInEnum_12_3_findcontext_greenBBBBBBFFFFFFF(EnumDeclaration classDec,
		...
		c2c__umlClass____target.setName(c2c__umlClass____target_name_prime);
		return new Object[] { classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c, isApplicableMatch,
				bd2ne__feature____target, umlClass__feature____ownedOperation, feature__umlClass____datatype,
	...
	public static final Object[] pattern_OperationInEnum_12_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			...
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element bd2ne, Enumeration umlClass,
			ASTNode2Element c2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, classDec, feature, bodyDeclaration,
				bd2ne, umlClass, c2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, feature, bodyDeclaration, bd2ne, umlClass,
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, EnumDeclaration classDec, Operation feature,
			MAbstractMethodDefinition bodyDeclaration, ASTNode2Element bd2ne, Enumeration umlClass, ASTNode2Element c2c,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, classDec, feature, bodyDeclaration,
				bd2ne, umlClass, c2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, feature, bodyDeclaration, bd2ne, umlClass,
					c2c, ruleResult };
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_29_3_solveCSP_binding = pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c, ruleResult);
	...
	public static final Object[] pattern_OperationInEnum_29_6_perform_blackBBBBBBB(EnumDeclaration classDec,
		...
		if (!bd2ne.equals(c2c)) {
			return new Object[] { classDec, feature, bodyDeclaration, bd2ne, umlClass, c2c, ruleResult };
		}
		return null;
	}
