...
public class OperationInEnumImpl extends AbstractRuleImpl implements OperationInEnum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInEnumImpl.pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c);
		...
		OperationInEnumImpl.pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, bd2ne,
				umlClass, bodyDeclaration, classDec, feature, c2c);
		...
		for (Object[] result2_black : OperationInEnumImpl
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_2_3_findcontext_blackBBBBBB(bd2ne,
				...
				Object[] result3_green = OperationInEnumImpl.pattern_OperationInEnum_2_3_findcontext_greenBBBBBBFFFFFFF(
						bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne,
			...
			Operation feature, ASTNode2Element c2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bd2ne, EObject umlClass,
			EObject bodyDeclaration, EObject classDec, EObject feature, EObject c2c) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_12_2_corematch_blackFBFFBFB(umlClass,
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_12_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = OperationInEnumImpl
						.pattern_OperationInEnum_12_3_findcontext_greenBBBBBBFFFFFFF(bd2ne, umlClass, bodyDeclaration,
								classDec, feature, c2c);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_100(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = OperationInEnumImpl
				.pattern_OperationInEnum_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, umlClass, bodyDeclaration,
		...
		if (OperationInEnumImpl.pattern_OperationInEnum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInEnumImpl
					.pattern_OperationInEnum_24_5_matchcorrcontext_blackFBBBBFBB(umlClass, bodyDeclaration, classDec,
				...
				Object[] result6_black = OperationInEnumImpl
						.pattern_OperationInEnum_24_6_createcorrespondence_blackBBBBB(umlClass, bodyDeclaration,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Enumeration umlClass, MAbstractMethodDefinition bodyDeclaration,
		...
		for (Object[] result2_black : OperationInEnumImpl
			...
			Object[] result3_bindingAndBlack = OperationInEnumImpl
					.pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, bd2ne,
							umlClass, bodyDeclaration, classDec, feature, c2c, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[bd2ne] = " + bd2ne + ", "
						+ "[umlClass] = " + umlClass + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
			...
			if (OperationInEnumImpl.pattern_OperationInEnum_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInEnumImpl.pattern_OperationInEnum_29_6_perform_blackBBBBBBB(
							bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c, ruleResult);
					if (result6_black == null) {
					...
					OperationInEnumImpl.pattern_OperationInEnum_29_6_perform_greenBBBBB(umlClass, bodyDeclaration,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne,
			Enumeration umlClass, MAbstractMethodDefinition bodyDeclaration, EnumDeclaration classDec,
			Operation feature, ASTNode2Element c2c, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ENUMERATION_MABSTRACTMETHODDEFINITION_ENUMDECLARATION_OPERATION_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(EnumDeclaration) arguments.get(4), (Operation) arguments.get(5),
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ENUMERATION_MABSTRACTMETHODDEFINITION_ENUMDECLARATION_OPERATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_100__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_100((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_107__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_CC__ENUMERATION_MABSTRACTMETHODDEFINITION_ENUMDECLARATION_OPERATION_MATCH_MATCH:
		...
		case RulesPackage.OPERATION_IN_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ENUMERATION_MABSTRACTMETHODDEFINITION_ENUMDECLARATION_OPERATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpClassDec instanceof EnumDeclaration) {
						...
						if (tmpFeature instanceof Operation) {
							...
							if (tmpC2c instanceof ASTNode2Element) {
								...
								return new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(ASTNode2Element bd2ne,
			Enumeration umlClass, MAbstractMethodDefinition bodyDeclaration, EnumDeclaration classDec,
			Operation feature, ASTNode2Element c2c, OperationInEnum _this, IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInEnum_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInEnum_1_1_performtransformation_black = pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(
					bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject bd2ne, EObject umlClass, EObject bodyDeclaration, EObject classDec,
	...
	public static final void pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject bd2ne, EObject umlClass, EObject bodyDeclaration, EObject classDec,
			EObject feature, EObject c2c) {
		_this.registerObjects_FWD(ruleresult, bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c);
				...
				for (ASTNode2Element c2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(classDec,
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpUmlClass instanceof Enumeration) {
							Enumeration umlClass = (Enumeration) tmpUmlClass;
							_result.add(
									new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c, match });
						}
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_2_3_findcontext_blackBBBBBB(ASTNode2Element bd2ne,
			Enumeration umlClass, MAbstractMethodDefinition bodyDeclaration, EnumDeclaration classDec,
			Operation feature, ASTNode2Element c2c) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
					...
					if (feature.equals(bd2ne.getTarget())) {
						if (classDec.equals(c2c.getSource())) {
							if (umlClass.equals(c2c.getTarget())) {
								_result.add(new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInEnum_2_3_findcontext_greenBBBBBBFFFFFFF(ASTNode2Element bd2ne,
		...
		return new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c, isApplicableMatch,
				classDec__bodyDeclaration____bodyDeclarations, bodyDeclaration__classDec____abstractTypeDeclaration,
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne, Enumeration umlClass,
			MAbstractMethodDefinition bodyDeclaration, EnumDeclaration classDec, Operation feature,
			ASTNode2Element c2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, bd2ne, umlClass, bodyDeclaration,
				classDec, feature, c2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bd2ne, umlClass, bodyDeclaration, classDec, feature,
					c2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_2_4_solveCSP_binding = pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c);
		if (result_pattern_OperationInEnum_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_OperationInEnum_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, bd2ne, umlClass, bodyDeclaration, classDec,
						feature, c2c };
			}
		}
		return null;
	...
	public static final Object[] pattern_OperationInEnum_11_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element bd2ne, Enumeration umlClass, MAbstractMethodDefinition bodyDeclaration,
			EnumDeclaration classDec, Operation feature, ASTNode2Element c2c, OperationInEnum _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
	...
	public static final void pattern_OperationInEnum_11_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject bd2ne, EObject umlClass, EObject bodyDeclaration, EObject classDec,
			EObject feature, EObject c2c) {
		_this.registerObjects_BWD(ruleresult, bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c);
	...
	public static final Object[] pattern_OperationInEnum_24_2_matchsrctrgcontext_blackBBBBBB(Enumeration umlClass,
			MAbstractMethodDefinition bodyDeclaration, EnumDeclaration classDec, Operation feature, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_OperationInEnum_24_6_createcorrespondence_blackBBBBB(Enumeration umlClass,
			MAbstractMethodDefinition bodyDeclaration, EnumDeclaration classDec, Operation feature, CCMatch ccMatch) {
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, ASTNode2Element bd2ne, Enumeration umlClass,
			MAbstractMethodDefinition bodyDeclaration, EnumDeclaration classDec, Operation feature, ASTNode2Element c2c,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, bd2ne, umlClass, bodyDeclaration,
				classDec, feature, c2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bd2ne, umlClass, bodyDeclaration, classDec, feature,
					c2c, ruleResult };
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_29_3_solveCSP_binding = pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c, ruleResult);
	...
	public static final Object[] pattern_OperationInEnum_29_6_perform_blackBBBBBBB(ASTNode2Element bd2ne,
			Enumeration umlClass, MAbstractMethodDefinition bodyDeclaration, EnumDeclaration classDec,
			Operation feature, ASTNode2Element c2c, ModelgeneratorRuleResult ruleResult) {
		if (!bd2ne.equals(c2c)) {
			return new Object[] { bd2ne, umlClass, bodyDeclaration, classDec, feature, c2c, ruleResult };
		}
		return null;
	}
