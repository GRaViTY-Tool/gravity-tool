...
public class OperationInEnumImpl extends AbstractRuleImpl implements OperationInEnum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInEnumImpl.pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature);
		...
		OperationInEnumImpl.pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, umlClass,
				classDec, c2c, bd2ne, bodyDeclaration, feature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_2_2_corematch_blackFBFFBFB(classDec,
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_2_3_findcontext_blackBBBBBB(
					umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature)) {
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[classDec] = " + classDec + ", " + "[c2c] = " + c2c + ", " + "[bd2ne] = " + bd2ne + ", "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Enumeration umlClass,
			EnumDeclaration classDec, ASTNode2Element c2c, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, Operation feature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject umlClass, EObject classDec, EObject c2c,
			EObject bd2ne, EObject bodyDeclaration, EObject feature) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_12_2_corematch_blackBFFFFBB(umlClass,
				feature, match)) {
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_12_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = OperationInEnumImpl
						.pattern_OperationInEnum_12_3_findcontext_greenBBBBBBFFFFFFF(umlClass, classDec, c2c, bd2ne,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_116(EMoflonEdge _edge_ownedOperation) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = OperationInEnumImpl
				.pattern_OperationInEnum_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, umlClass, classDec,
		...
		if (OperationInEnumImpl.pattern_OperationInEnum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInEnumImpl
					.pattern_OperationInEnum_24_5_matchcorrcontext_blackBBFFBBBB(umlClass, classDec, bodyDeclaration,
				...
				Object[] result6_black = OperationInEnumImpl
						.pattern_OperationInEnum_24_6_createcorrespondence_blackBBBBB(umlClass, classDec,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Enumeration umlClass, EnumDeclaration classDec,
		...
		for (Object[] result2_black : OperationInEnumImpl
			...
			Object[] result3_bindingAndBlack = OperationInEnumImpl
					.pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, umlClass,
							classDec, c2c, bd2ne, bodyDeclaration, feature, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[umlClass] = " + umlClass + ", "
						+ "[classDec] = " + classDec + ", " + "[c2c] = " + c2c + ", " + "[bd2ne] = " + bd2ne + ", "
			...
			if (OperationInEnumImpl.pattern_OperationInEnum_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInEnumImpl.pattern_OperationInEnum_29_6_perform_blackBBBBBBB(
							umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature, ruleResult);
					if (result6_black == null) {
					...
					OperationInEnumImpl.pattern_OperationInEnum_29_6_perform_greenBBBBB(umlClass, classDec,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ENUMERATION_ENUMDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_OPERATION:
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMERATION_ENUMDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_OPERATION:
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_116__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_116((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_122__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_CC__ENUMERATION_ENUMDECLARATION_MABSTRACTMETHODDEFINITION_OPERATION_MATCH_MATCH:
		...
		case RulesPackage.OPERATION_IN_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMERATION_ENUMDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_OPERATION_MODELGENERATORRULERESULT:
					...
					if (tmpBd2ne instanceof ASTNode2Element) {
						...
						if (tmpBodyDeclaration instanceof MAbstractMethodDefinition) {
							...
							if (tmpFeature instanceof Operation) {
								...
								return new Object[] { umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(Enumeration umlClass,
			EnumDeclaration classDec, ASTNode2Element c2c, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration, Operation feature, OperationInEnum _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInEnum_1_1_performtransformation_binding != null) {
			...
			Operation feature = (Operation) result_pattern_OperationInEnum_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_OperationInEnum_1_1_performtransformation_black = pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(
					umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject umlClass, EObject classDec, EObject c2c, EObject bd2ne,
															...
															if (!bodyDeclaration.equals(feature)) {
																if (!feature.equals(umlClass)) {
																	return new Object[] { ruleresult, umlClass,
																			classDec, c2c, bd2ne, bodyDeclaration,
																			feature };
																}
															}
														}
	...
	public static final void pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject umlClass, EObject classDec, EObject c2c, EObject bd2ne,
			EObject bodyDeclaration, EObject feature) {
		_this.registerObjects_FWD(ruleresult, umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature);
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_2_2_corematch_blackFBFFBFB(EnumDeclaration classDec,
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature, match });
						}
					...
					if (umlClass.equals(c2c.getTarget())) {
						if (bodyDeclaration.equals(bd2ne.getSource())) {
							if (feature.equals(bd2ne.getTarget())) {
								_result.add(new Object[] { umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInEnum_2_3_findcontext_greenBBBBBBFFFFFFF(Enumeration umlClass,
		...
		return new Object[] { umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature, isApplicableMatch,
				classDec__bodyDeclaration____bodyDeclarations, bodyDeclaration__classDec____abstractTypeDeclaration,
				c2c__classDec____source, c2c__umlClass____target, bd2ne__bodyDeclaration____source,
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, umlClass, classDec, c2c, bd2ne,
				bodyDeclaration, feature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlClass, classDec, c2c, bd2ne, bodyDeclaration,
					feature };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_2_4_solveCSP_binding = pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature);
	...
	public static final Object[] pattern_OperationInEnum_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInEnum_11_1_performtransformation_binding != null) {
			...
			Operation feature = (Operation) result_pattern_OperationInEnum_11_1_performtransformation_binding[5];
	...
	public static final void pattern_OperationInEnum_11_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject umlClass, EObject classDec, EObject c2c, EObject bd2ne,
			EObject bodyDeclaration, EObject feature) {
		_this.registerObjects_BWD(ruleresult, umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature);
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_12_2_corematch_blackBFFFFBB(Enumeration umlClass,
	...
	public static final Object[] pattern_OperationInEnum_12_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, Enumeration umlClass, EnumDeclaration classDec, ASTNode2Element c2c,
			ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration, Operation feature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, umlClass, classDec, c2c, bd2ne,
				bodyDeclaration, feature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlClass, classDec, c2c, bd2ne, bodyDeclaration,
	...
	public static final Object[] pattern_OperationInEnum_24_2_matchsrctrgcontext_blackBBBBBB(Enumeration umlClass,
			EnumDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_24_5_matchcorrcontext_blackBBFFBBBB(
			Enumeration umlClass, EnumDeclaration classDec, MAbstractMethodDefinition bodyDeclaration,
			Operation feature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInEnum_24_6_createcorrespondence_blackBBBBB(Enumeration umlClass,
			EnumDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature, CCMatch ccMatch) {
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(OperationInEnum _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, umlClass, classDec, c2c, bd2ne,
				bodyDeclaration, feature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlClass, classDec, c2c, bd2ne, bodyDeclaration,
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_29_3_solveCSP_binding = pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature, ruleResult);
	...
	public static final Object[] pattern_OperationInEnum_29_6_perform_blackBBBBBBB(Enumeration umlClass,
		...
		if (!bd2ne.equals(c2c)) {
			return new Object[] { umlClass, classDec, c2c, bd2ne, bodyDeclaration, feature, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_OperationInEnum_29_6_perform_greenBBBBB(Enumeration umlClass,
			EnumDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Operation feature,
			ModelgeneratorRuleResult ruleResult) {
		umlClass.getOwnedOperations().add(feature);
		classDec.getBodyDeclarations().add(bodyDeclaration);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
