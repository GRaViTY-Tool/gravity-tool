...
public class OperationInEnumImpl extends AbstractRuleImpl implements OperationInEnum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		EnumDeclaration classDec = (EnumDeclaration) result1_bindingAndBlack[1];
		...
		Object[] result3_black = OperationInEnumImpl.pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[umlClass] = " + umlClass + ", " + "[classDec] = " + classDec + ", " + "[c2c] = " + c2c
		...
		OperationInEnumImpl.pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, umlClass,
				classDec, c2c, feature, bd2ne, bodyDeclaration);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_2_2_corematch_blackFBFFFBB(classDec,
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_2_3_findcontext_blackBBBBBB(
					umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration)) {
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[classDec] = " + classDec + ", " + "[c2c] = " + c2c + ", " + "[feature] = " + feature
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Enumeration umlClass,
			EnumDeclaration classDec, ASTNode2Element c2c, Operation feature, ASTNode2Element bd2ne,
			MAbstractMethodDefinition bodyDeclaration) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject umlClass, EObject classDec, EObject c2c,
			EObject feature, EObject bd2ne, EObject bodyDeclaration) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_12_2_corematch_blackBFFBFFB(umlClass,
				feature, match)) {
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_12_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = OperationInEnumImpl
						.pattern_OperationInEnum_12_3_findcontext_greenBBBBBBFFFFFFF(umlClass, classDec, c2c, feature,
				...
				//nothing EMoflonEdge feature__umlClass____datatype = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge bd2ne__bodyDeclaration____source = (EMoflonEdge) result3_green[12];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject umlClass, EObject classDec, EObject c2c,
			EObject feature, EObject bd2ne, EObject bodyDeclaration) {
		ruleresult.registerObject("umlClass", umlClass);
		ruleresult.registerObject("classDec", classDec);
		ruleresult.registerObject("c2c", c2c);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInEnumImpl.pattern_OperationInEnum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInEnumImpl
					.pattern_OperationInEnum_24_5_matchcorrcontext_blackBBFBFBBB(umlClass, classDec, feature,
							bodyDeclaration, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : OperationInEnumImpl
			...
			Object[] result3_bindingAndBlack = OperationInEnumImpl
					.pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, umlClass,
							classDec, c2c, feature, bd2ne, bodyDeclaration, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[umlClass] = " + umlClass + ", "
						+ "[classDec] = " + classDec + ", " + "[c2c] = " + c2c + ", " + "[feature] = " + feature + ", "
			...
			if (OperationInEnumImpl.pattern_OperationInEnum_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInEnumImpl.pattern_OperationInEnum_29_6_perform_blackBBBBBBB(
							umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[umlClass] = "
								+ umlClass + ", " + "[classDec] = " + classDec + ", " + "[c2c] = " + c2c + ", "
								+ "[feature] = " + feature + ", " + "[bd2ne] = " + bd2ne + ", " + "[bodyDeclaration] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ENUMERATION_ENUMDECLARATION_ASTNODE2ELEMENT_OPERATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Enumeration) arguments.get(1),
						(EnumDeclaration) arguments.get(2), (ASTNode2Element) arguments.get(3),
			...
			case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMERATION_ENUMDECLARATION_ASTNODE2ELEMENT_OPERATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION:
			...
			case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_110__EMOFLONEDGE:
			...
			case RulesPackage.OPERATION_IN_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMERATION_ENUMDECLARATION_ASTNODE2ELEMENT_OPERATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_MODELGENERATORRULERESULT:
					...
					if (tmpFeature instanceof Operation) {
						...
						if (tmpBd2ne instanceof ASTNode2Element) {
							...
							if (tmpBodyDeclaration instanceof MAbstractMethodDefinition) {
								...
								return new Object[] { umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration,
										isApplicableMatch };
							}
						}
					}
		...
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInEnum_1_1_performtransformation_binding != null) {
			...
			EnumDeclaration classDec = (EnumDeclaration) result_pattern_OperationInEnum_1_1_performtransformation_binding[1];
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInEnum_1_1_performtransformation_binding[2];
			Operation feature = (Operation) result_pattern_OperationInEnum_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_OperationInEnum_1_1_performtransformation_black = pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(
					umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject umlClass, EObject classDec, EObject c2c, EObject feature,
	...
	public static final void pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject umlClass, EObject classDec, EObject c2c, EObject feature,
			EObject bd2ne, EObject bodyDeclaration) {
		_this.registerObjects_FWD(ruleresult, umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration);
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_2_2_corematch_blackFBFFFBB(EnumDeclaration classDec,
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration, match });
						}
					...
					if (umlClass.equals(c2c.getTarget())) {
						if (feature.equals(bd2ne.getTarget())) {
							if (bodyDeclaration.equals(bd2ne.getSource())) {
								_result.add(new Object[] { umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInEnum_2_3_findcontext_greenBBBBBBFFFFFFF(Enumeration umlClass,
		...
		return new Object[] { umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration, isApplicableMatch,
				classDec__bodyDeclaration____bodyDeclarations, bodyDeclaration__classDec____abstractTypeDeclaration,
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, Enumeration umlClass, EnumDeclaration classDec, ASTNode2Element c2c,
			Operation feature, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, umlClass, classDec, c2c, feature,
				bd2ne, bodyDeclaration);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlClass, classDec, c2c, feature, bd2ne,
					bodyDeclaration };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_2_4_solveCSP_binding = pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration);
	...
	public static final Object[] pattern_OperationInEnum_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInEnum_11_1_performtransformation_binding != null) {
			...
			EnumDeclaration classDec = (EnumDeclaration) result_pattern_OperationInEnum_11_1_performtransformation_binding[1];
			ASTNode2Element c2c = (ASTNode2Element) result_pattern_OperationInEnum_11_1_performtransformation_binding[2];
			Operation feature = (Operation) result_pattern_OperationInEnum_11_1_performtransformation_binding[3];
	...
	public static final void pattern_OperationInEnum_11_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject umlClass, EObject classDec, EObject c2c, EObject feature,
			EObject bd2ne, EObject bodyDeclaration) {
		_this.registerObjects_BWD(ruleresult, umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration);
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_12_2_corematch_blackBFFBFFB(Enumeration umlClass,
	...
	public static final Object[] pattern_OperationInEnum_12_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, Enumeration umlClass, EnumDeclaration classDec, ASTNode2Element c2c,
			Operation feature, ASTNode2Element bd2ne, MAbstractMethodDefinition bodyDeclaration) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, umlClass, classDec, c2c, feature,
				bd2ne, bodyDeclaration);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlClass, classDec, c2c, feature, bd2ne,
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_24_5_matchcorrcontext_blackBBFBFBBB(
			Enumeration umlClass, EnumDeclaration classDec, Operation feature,
			MAbstractMethodDefinition bodyDeclaration, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(OperationInEnum _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, umlClass, classDec, c2c, feature,
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_29_3_solveCSP_binding = pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration, ruleResult);
	...
	public static final Object[] pattern_OperationInEnum_29_6_perform_blackBBBBBBB(Enumeration umlClass,
		...
		if (!bd2ne.equals(c2c)) {
			return new Object[] { umlClass, classDec, c2c, feature, bd2ne, bodyDeclaration, ruleResult };
		}
		return null;
	}
