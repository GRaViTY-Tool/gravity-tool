...
public class OperationInEnumImpl extends AbstractRuleImpl implements OperationInEnum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = OperationInEnumImpl.pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne);
		...
		OperationInEnumImpl.pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, classDec,
				c2c, bodyDeclaration, umlClass, feature, bd2ne);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_2_2_corematch_blackBFBFFFB(classDec,
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_2_3_findcontext_blackBBBBBB(
					classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, EnumDeclaration classDec,
			ASTNode2Element c2c, MAbstractMethodDefinition bodyDeclaration, Enumeration umlClass, Operation feature,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject classDec, EObject c2c,
			EObject bodyDeclaration, EObject umlClass, EObject feature, EObject bd2ne) {
		...
		for (Object[] result2_black : OperationInEnumImpl.pattern_OperationInEnum_12_2_corematch_blackFFFBBFB(umlClass,
			...
			for (Object[] result3_black : OperationInEnumImpl.pattern_OperationInEnum_12_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = OperationInEnumImpl
						.pattern_OperationInEnum_12_3_findcontext_greenBBBBBBFFFFFFF(classDec, c2c, bodyDeclaration,
								umlClass, feature, bd2ne);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge c2c__classDec____source = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject classDec, EObject c2c,
			EObject bodyDeclaration, EObject umlClass, EObject feature, EObject bd2ne) {
		ruleresult.registerObject("classDec", classDec);
		ruleresult.registerObject("c2c", c2c);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_126(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (OperationInEnumImpl.pattern_OperationInEnum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : OperationInEnumImpl
					.pattern_OperationInEnum_24_5_matchcorrcontext_blackBFBBBFBB(classDec, bodyDeclaration, umlClass,
		...
		for (Object[] result2_black : OperationInEnumImpl
			...
			Object[] result3_bindingAndBlack = OperationInEnumImpl
					.pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, classDec,
							c2c, bodyDeclaration, umlClass, feature, bd2ne, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[classDec] = " + classDec + ", "
			...
			if (OperationInEnumImpl.pattern_OperationInEnum_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = OperationInEnumImpl.pattern_OperationInEnum_29_6_perform_blackBBBBBBB(
							classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne, ruleResult);
					if (result6_black == null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ENUMDECLARATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_ENUMERATION_OPERATION_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (EnumDeclaration) arguments.get(1),
					...
					(Enumeration) arguments.get(4), (Operation) arguments.get(5), (ASTNode2Element) arguments.get(6));
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMDECLARATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_ENUMERATION_OPERATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_117__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_117((EMoflonEdge) arguments.get(0));
		case RulesPackage.OPERATION_IN_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_126__EMOFLONEDGE:
		...
		case RulesPackage.OPERATION_IN_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMDECLARATION_ASTNODE2ELEMENT_MABSTRACTMETHODDEFINITION_ENUMERATION_OPERATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpUmlClass instanceof Enumeration) {
						...
						if (tmpFeature instanceof Operation) {
							...
							if (tmpBd2ne instanceof ASTNode2Element) {
								...
								return new Object[] { classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(
			EnumDeclaration classDec, ASTNode2Element c2c, MAbstractMethodDefinition bodyDeclaration,
			Enumeration umlClass, Operation feature, ASTNode2Element bd2ne, OperationInEnum _this,
			IsApplicableMatch isApplicableMatch) {
		if (!bd2ne.equals(c2c)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_OperationInEnum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_OperationInEnum_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_OperationInEnum_1_1_performtransformation_black = pattern_OperationInEnum_1_1_performtransformation_blackBBBBBBFBB(
					classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne, _this, isApplicableMatch);
	...
	public static final Object[] pattern_OperationInEnum_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject classDec, EObject c2c, EObject bodyDeclaration, EObject umlClass,
															...
															if (!bd2ne.equals(umlClass)) {
																if (!bd2ne.equals(feature)) {
																	return new Object[] { ruleresult, classDec, c2c,
																			bodyDeclaration, umlClass, feature, bd2ne };
																}
															}
														}
													}
	...
	public static final void pattern_OperationInEnum_1_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject classDec, EObject c2c, EObject bodyDeclaration, EObject umlClass,
			EObject feature, EObject bd2ne) {
		_this.registerObjects_FWD(ruleresult, classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne);
				...
				for (ASTNode2Element bd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!bd2ne.equals(c2c)) {
						...
						if (tmpFeature instanceof Operation) {
							Operation feature = (Operation) tmpFeature;
							_result.add(
									new Object[] { classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne, match });
						}
					...
					if (umlClass.equals(c2c.getTarget())) {
						if (bodyDeclaration.equals(bd2ne.getSource())) {
							if (feature.equals(bd2ne.getTarget())) {
								_result.add(new Object[] { classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne });
							}
						}
					}
				}
	...
	public static final Object[] pattern_OperationInEnum_2_3_findcontext_greenBBBBBBFFFFFFF(EnumDeclaration classDec,
		...
		return new Object[] { classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne, isApplicableMatch,
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, EnumDeclaration classDec, ASTNode2Element c2c,
			MAbstractMethodDefinition bodyDeclaration, Enumeration umlClass, Operation feature, ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, classDec, c2c, bodyDeclaration,
				umlClass, feature, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, c2c, bodyDeclaration, umlClass, feature,
					bd2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_OperationInEnum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_2_4_solveCSP_binding = pattern_OperationInEnum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne);
	...
	public static final void pattern_OperationInEnum_11_5_registerobjects_expressionBBBBBBBB(OperationInEnum _this,
			PerformRuleResult ruleresult, EObject classDec, EObject c2c, EObject bodyDeclaration, EObject umlClass,
			EObject feature, EObject bd2ne) {
		_this.registerObjects_BWD(ruleresult, classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne);
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_12_3_findcontext_blackBBBBBB(
			EnumDeclaration classDec, ASTNode2Element c2c, MAbstractMethodDefinition bodyDeclaration,
			Enumeration umlClass, Operation feature, ASTNode2Element bd2ne) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!bd2ne.equals(c2c)) {
			if (classDec.equals(c2c.getSource())) {
				if (umlClass.equals(c2c.getTarget())) {
	...
	public static final Object[] pattern_OperationInEnum_12_3_findcontext_greenBBBBBBFFFFFFF(EnumDeclaration classDec,
		...
		return new Object[] { classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne, isApplicableMatch,
				...
				feature__umlClass____datatype, bd2ne__bodyDeclaration____source, bd2ne__feature____target };
	}

	public static final Object[] pattern_OperationInEnum_12_4_solveCSP_bindingFBBBBBBBB(OperationInEnum _this,
			IsApplicableMatch isApplicableMatch, EnumDeclaration classDec, ASTNode2Element c2c,
			MAbstractMethodDefinition bodyDeclaration, Enumeration umlClass, Operation feature, ASTNode2Element bd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, classDec, c2c, bodyDeclaration,
				umlClass, feature, bd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, c2c, bodyDeclaration, umlClass, feature,
	...
	public static final Iterable<Object[]> pattern_OperationInEnum_24_5_matchcorrcontext_blackBFBBBFBB(
			EnumDeclaration classDec, MAbstractMethodDefinition bodyDeclaration, Enumeration umlClass,
			Operation feature, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(OperationInEnum _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, classDec, c2c, bodyDeclaration,
				umlClass, feature, bd2ne, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, classDec, c2c, bodyDeclaration, umlClass, feature,
					bd2ne, ruleResult };
	...
	public static final Object[] pattern_OperationInEnum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(OperationInEnum _this,
		...
		Object[] result_pattern_OperationInEnum_29_3_solveCSP_binding = pattern_OperationInEnum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne, ruleResult);
	...
	public static final Object[] pattern_OperationInEnum_29_6_perform_blackBBBBBBB(EnumDeclaration classDec,
		...
		if (!bd2ne.equals(c2c)) {
			return new Object[] { classDec, c2c, bodyDeclaration, umlClass, feature, bd2ne, ruleResult };
		}
		return null;
	}
