...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(javaModel, rootModel,
						commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes, umlModel, externalModel, sourceRefModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = " + javaModel + ", "
					...
					+ jm2um3 + ", " + "[jm2um] = " + jm2um + ", " + "[jm2um2] = " + jm2um2 + ", "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(javaModel, rootModel,
						commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes, umlModel, externalModel, sourceRefModel);
		...
		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, javaModel,
						rootModel, commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes, umlModel, externalModel,
						sourceRefModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[javaModel] = " + javaModel + ", " + "[rootModel] = " + rootModel + ", "
					+ "[commonTypes] = " + commonTypes + ", " + "[jm2um3] = " + jm2um3 + ", " + "[jm2um] = " + jm2um
		...
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, javaModel, rootModel, commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes, umlModel,
		...
		//nothing EMoflonEdge umlModel__commonTypes____packagedElement = (EMoflonEdge) result3_green[19];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject javaModel, EObject rootModel,
			EObject commonTypes, EObject jm2um3, EObject jm2um, EObject jm2um2, EObject jm2commonTypes,
			EObject umlModel, EObject externalModel, EObject sourceRefModel) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFBFFFFBBBB(commonTypes, umlModel,
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(javaModel, rootModel,
						commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes, umlModel, externalModel, sourceRefModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = " + javaModel + ", "
					+ "[rootModel] = " + rootModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[jm2um3] = "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(javaModel, rootModel,
						commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes, umlModel, externalModel, sourceRefModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject javaModel, EObject rootModel,
			EObject commonTypes, EObject jm2um3, EObject jm2um, EObject jm2um2, EObject jm2commonTypes,
			EObject umlModel, EObject externalModel, EObject sourceRefModel) {
		ruleresult.registerObject("javaModel", javaModel);
		ruleresult.registerObject("rootModel", rootModel);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_283(EMoflonEdge _edge_packagedElement) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, javaModel, rootModel,
						commonTypes, umlModel, externalModel, sourceRefModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[javaModel] = " + javaModel + ", " + "[rootModel] = " + rootModel + ", " + "[commonTypes] = "
					+ commonTypes + ", " + "[umlModel] = " + umlModel + ", " + "[externalModel] = " + externalModel
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(javaModel, rootModel,
				...
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = "
							+ javaModel + ", " + "[rootModel] = " + rootModel + ", " + "[commonTypes] = " + commonTypes
							+ ", " + "[umlModel] = " + umlModel + ", " + "[externalModel] = " + externalModel + ", "
							+ "[sourceRefModel] = " + sourceRefModel + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBBFFFFBBBB(
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MGravityModel javaModel, Model rootModel,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_283__EMOFLONEDGE:
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPLICABLE_SOLVE_CSP_CC__MGRAVITYMODEL_MODEL_PACKAGE_MODEL_MODEL_MODEL_MATCH_MATCH:
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenBFFFFFFFFFB(
		...
		return new Object[] { javaModel, rootModel, commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes, umlModel,
				externalModel, sourceRefModel, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			MGravityModel javaModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes,
			JavaModel2UMLPackage jm2um3, JavaModel2UMLPackage jm2um, JavaModel2UMLPackage jm2um2,
			JavaModel2UMLPackage jm2commonTypes, Model umlModel, Model externalModel, Model sourceRefModel) {
															...
															if (!externalModel.equals(umlModel)) {
																if (!externalModel.equals(sourceRefModel)) {
																	if (!sourceRefModel.equals(umlModel)) {
																		return new Object[] { javaModel, rootModel,
																				commonTypes, jm2um3, jm2um, jm2um2,
																				jm2commonTypes, umlModel, externalModel,
																				sourceRefModel };
																	}
																}
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, javaModel, rootModel, commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes,
				umlModel, externalModel, sourceRefModel };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject javaModel, EObject rootModel, EObject commonTypes, EObject jm2um3,
			EObject jm2um, EObject jm2um2, EObject jm2commonTypes, EObject umlModel, EObject externalModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, javaModel, rootModel, commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes,
				umlModel, externalModel, sourceRefModel, jm2commonTypes__javaModel____source,
				jm2commonTypes__commonTypes____target, rootModel__umlModel____packagedElement,
				jm2um2__javaModel____source, jm2um__javaModel____source, rootModel__sourceRefModel____packagedElement,
	...
	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject javaModel, EObject rootModel,
			EObject commonTypes, EObject jm2um3, EObject jm2um, EObject jm2um2, EObject jm2commonTypes,
			EObject umlModel, EObject externalModel, EObject sourceRefModel) {
		_this.registerObjects_FWD(ruleresult, javaModel, rootModel, commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes,
				umlModel, externalModel, sourceRefModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFBFFFFBBBB(
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model externalModel, Model sourceRefModel,
			CSP csp) {
		...
		return new Object[] { javaModel, commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes, umlModel, externalModel,
				sourceRefModel, csp };
	}
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject commonTypes, EObject jm2um3, EObject jm2um, EObject jm2um2, EObject jm2commonTypes,
			EObject umlModel, EObject externalModel, EObject sourceRefModel) {
		_this.registerObjects_BWD(ruleresult, javaModel, rootModel, commonTypes, jm2um3, jm2um, jm2um2, jm2commonTypes,
				umlModel, externalModel, sourceRefModel);
				...
				if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
					...
					if (tmpUmlModel instanceof Model) {
						...
						if (tmpExternalModel instanceof Model) {
							...
							if (tmpSourceRefModel instanceof Model) {
								Model sourceRefModel = (Model) tmpSourceRefModel;
								return new Object[] { javaModel, rootModel, commonTypes, umlModel, externalModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MGravityModel javaModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					javaModel, rootModel, commonTypes, umlModel, externalModel, sourceRefModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { javaModel, rootModel, commonTypes, umlModel, externalModel, sourceRefModel,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, MGravityModel javaModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model externalModel, Model sourceRefModel,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(javaModel, rootModel, commonTypes, umlModel,
				externalModel, sourceRefModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, javaModel, rootModel, commonTypes, umlModel, externalModel,
					sourceRefModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, javaModel, rootModel, commonTypes, umlModel, externalModel, sourceRefModel, sourceMatch,
				targetMatch);
							...
							if (!commonTypes.equals(sourceRefModel)) {
								if (!externalModel.equals(rootModel)) {
									if (!externalModel.equals(umlModel)) {
										if (!externalModel.equals(sourceRefModel)) {
											if (!sourceRefModel.equals(umlModel)) {
												return new Object[] { javaModel, rootModel, commonTypes, umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBBFFFFBBBB(
