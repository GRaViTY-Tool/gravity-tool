...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFBFFFFFFFFB(javaModel, csp);
		JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result1_green[0];
		Model externalModel = (Model) result1_green[2];
		JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result1_green[3];
		Model umlModel = (Model) result1_green[4];
		...
		Model rootModel = (Model) result1_green[8];
		Model sourceRefModel = (Model) result1_green[9];

		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(jm2um, javaModel,
						externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes, commonTypes, rootModel,
						sourceRefModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jm2um] = " + jm2um + ", "
					+ "[javaModel] = " + javaModel + ", " + "[externalModel] = " + externalModel + ", " + "[jm2um2] = "
					+ jm2um2 + ", " + "[umlModel] = " + umlModel + ", " + "[jm2um3] = " + jm2um3 + ", "
					+ "[jm2commonTypes] = " + jm2commonTypes + ", " + "[commonTypes] = " + commonTypes + ", "
					+ "[rootModel] = " + rootModel + ", " + "[sourceRefModel] = " + sourceRefModel + ".");
		}
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(jm2um, javaModel,
						externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes, commonTypes, rootModel,
						sourceRefModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, jm2um, javaModel,
						externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes, commonTypes, rootModel,
						sourceRefModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[jm2um] = " + jm2um + ", " + "[javaModel] = " + javaModel + ", " + "[externalModel] = "
					+ externalModel + ", " + "[jm2um2] = " + jm2um2 + ", " + "[umlModel] = " + umlModel + ", "
					+ "[jm2um3] = " + jm2um3 + ", " + "[jm2commonTypes] = " + jm2commonTypes + ", " + "[commonTypes] = "
					+ commonTypes + ", " + "[rootModel] = " + rootModel + ", " + "[sourceRefModel] = " + sourceRefModel
					+ ".");
		}
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, jm2um, javaModel, externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes, commonTypes,
				rootModel, sourceRefModel);
		//nothing EMoflonEdge jm2um2__javaModel____source = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge jm2um2__externalModel____target = (EMoflonEdge) result3_green[12];
		...
		//nothing EMoflonEdge jm2um3__sourceRefModel____target = (EMoflonEdge) result3_green[20];
		//nothing EMoflonEdge rootModel__umlModel____packagedElement = (EMoflonEdge) result3_green[21];
		//nothing EMoflonEdge rootModel__externalModel____packagedElement = (EMoflonEdge) result3_green[22];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject jm2um, EObject javaModel,
			EObject externalModel, EObject jm2um2, EObject umlModel, EObject jm2um3, EObject jm2commonTypes,
			EObject commonTypes, EObject rootModel, EObject sourceRefModel) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {

		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(this, match, externalModel, umlModel,
						commonTypes, rootModel, sourceRefModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[externalModel] = " + externalModel + ", " + "[umlModel] = "
					+ umlModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[rootModel] = " + rootModel + ", "
		...
		Object[] result2_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, externalModel,
						umlModel, commonTypes, rootModel, sourceRefModel);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[externalModel] = " + externalModel + ", " + "[umlModel] = "
					+ umlModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[rootModel] = " + rootModel + ", "
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[externalModel] = " + externalModel + ", " + "[umlModel] = " + umlModel + ", "
			...
			JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(match,
							externalModel, umlModel, commonTypes, rootModel, sourceRefModel);
			...
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
					this, match, externalModel, umlModel, commonTypes, rootModel, sourceRefModel);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFFBFBFFBBB(externalModel, umlModel,
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(jm2um, javaModel,
						externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes, commonTypes, rootModel,
						sourceRefModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jm2um] = " + jm2um + ", "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(jm2um, javaModel,
						externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes, commonTypes, rootModel,
						sourceRefModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, jm2um, javaModel,
						externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes, commonTypes, rootModel,
						sourceRefModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_12_2_corematch_blackBBBBBB(externalModel, umlModel, commonTypes,
						rootModel, sourceRefModel, match)) {
			// ForEach 
			for (Object[] result3_black : JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_12_3_findcontext_blackBBBBB(externalModel, umlModel, commonTypes,
							rootModel, sourceRefModel)) {
				Object[] result3_green = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(externalModel, umlModel,
								commonTypes, rootModel, sourceRefModel);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject jm2um, EObject javaModel,
			EObject externalModel, EObject jm2um2, EObject umlModel, EObject jm2um3, EObject jm2commonTypes,
			EObject commonTypes, EObject rootModel, EObject sourceRefModel) {
		ruleresult.registerObject("jm2um", jm2um);
		ruleresult.registerObject("javaModel", javaModel);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_89(EMoflonEdge _edge_packagedElement) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, javaModel, externalModel,
						umlModel, commonTypes, rootModel, sourceRefModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[javaModel] = " + javaModel + ", " + "[externalModel] = " + externalModel + ", "
					+ "[umlModel] = " + umlModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[rootModel] = "
					+ rootModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[sourceMatch] = "
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(javaModel, externalModel,
								umlModel, commonTypes, rootModel, sourceRefModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = "
							+ javaModel + ", " + "[externalModel] = " + externalModel + ", " + "[umlModel] = "
							+ umlModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[rootModel] = " + rootModel
							+ ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFBBFBFFBBB(
						javaModel, externalModel, umlModel, commonTypes, sourceRefModel, ccMatch);
				//nothing JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result6_green[0];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MGravityModel javaModel, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Model externalModel, Model umlModel, org.eclipse.uml2.uml.Package commonTypes,
			Model rootModel, Model sourceRefModel) {// 
		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_blackBBBBB(externalModel, umlModel, commonTypes,
						rootModel, sourceRefModel);
		if (result1_black != null) {
		...
		if (result2_black != null) {
			...
			if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(ruleResult,
						csp);
				//nothing JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result6_green[0];
				//nothing MGravityModel javaModel = (MGravityModel) result6_green[1];
				//nothing Model externalModel = (Model) result6_green[2];
				//nothing JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result6_green[3];
				//nothing Model umlModel = (Model) result6_green[4];
				//nothing JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result6_green[5];
				//nothing JavaModel2UMLPackage jm2commonTypes = (JavaModel2UMLPackage) result6_green[6];
				//nothing org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) result6_green[7];
				//nothing Model rootModel = (Model) result6_green[8];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_89__EMOFLONEDGE:
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFBFFFFFFFFB(
		...
		return new Object[] { jm2um, javaModel, externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes, commonTypes,
				rootModel, sourceRefModel, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			JavaModel2UMLPackage jm2um, MGravityModel javaModel, Model externalModel, JavaModel2UMLPackage jm2um2,
			Model umlModel, JavaModel2UMLPackage jm2um3, JavaModel2UMLPackage jm2commonTypes,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {
															...
															if (!rootModel.equals(umlModel)) {
																if (!rootModel.equals(sourceRefModel)) {
																	if (!sourceRefModel.equals(umlModel)) {
																		return new Object[] { jm2um, javaModel,
																				externalModel, jm2um2, umlModel, jm2um3,
																				jm2commonTypes, commonTypes, rootModel,
																				sourceRefModel };
																	}
																}
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, jm2um, javaModel, externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes,
				commonTypes, rootModel, sourceRefModel };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject jm2um, EObject javaModel, EObject externalModel, EObject jm2um2,
			EObject umlModel, EObject jm2um3, EObject jm2commonTypes, EObject commonTypes, EObject rootModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, jm2um, javaModel, externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes,
				commonTypes, rootModel, sourceRefModel, jm2um2__javaModel____source, jm2um2__externalModel____target,
				jm2um__javaModel____source, jm2um__umlModel____target, jm2um3__javaModel____source,
				jm2commonTypes__javaModel____source, umlModel__commonTypes____packagedElement,
				jm2commonTypes__commonTypes____target, rootModel__sourceRefModel____packagedElement,
				jm2um3__sourceRefModel____target, rootModel__umlModel____packagedElement,
				rootModel__externalModel____packagedElement };
	}

	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject jm2um, EObject javaModel,
			EObject externalModel, EObject jm2um2, EObject umlModel, EObject jm2um3, EObject jm2commonTypes,
			EObject commonTypes, EObject rootModel, EObject sourceRefModel) {
		_this.registerObjects_FWD(ruleresult, jm2um, javaModel, externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes,
				commonTypes, rootModel, sourceRefModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(rootModel)) {
				if (!externalModel.equals(sourceRefModel)) {
							...
							if (!commonTypes.equals(rootModel)) {
								if (!commonTypes.equals(sourceRefModel)) {
									if (!rootModel.equals(umlModel)) {
										if (!rootModel.equals(sourceRefModel)) {
											if (!sourceRefModel.equals(umlModel)) {
												return new Object[] { _this, match, externalModel, umlModel,
														commonTypes, rootModel, sourceRefModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, externalModel, umlModel, commonTypes, rootModel,
				sourceRefModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, externalModel, umlModel, commonTypes, rootModel, sourceRefModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding = pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, externalModel, umlModel, commonTypes, rootModel, sourceRefModel);
		if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, externalModel, umlModel, commonTypes, rootModel,
						sourceRefModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, Model externalModel, Model umlModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
							...
							if (!commonTypes.equals(rootModel)) {
								if (!commonTypes.equals(sourceRefModel)) {
									if (!rootModel.equals(umlModel)) {
										if (!rootModel.equals(sourceRefModel)) {
											if (!sourceRefModel.equals(umlModel)) {
												return new Object[] { match, externalModel, umlModel, commonTypes,
														rootModel, sourceRefModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		rootModel__externalModel____packagedElement.setName(rootModel__externalModel____packagedElement_name_prime);
		return new Object[] { match, externalModel, umlModel, commonTypes, rootModel, sourceRefModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_5_collectcontextelements_blackBBBBBB(Match match,
			Model externalModel, Model umlModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
			Model sourceRefModel) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(rootModel)) {
				if (!externalModel.equals(sourceRefModel)) {
	...
	public static final void pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {
		_this.registerObjectsToMatch_BWD(match, externalModel, umlModel, commonTypes, rootModel, sourceRefModel);
				...
				if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
					...
					if (tmpRootModel instanceof Model) {
						...
						if (tmpSourceRefModel instanceof Model) {
							...
							return new Object[] { externalModel, umlModel, commonTypes, rootModel, sourceRefModel,
									isApplicableMatch };
						}
					}
				}
										...
										if (!rootModel.equals(sourceRefModel)) {
											if (!sourceRefModel.equals(umlModel)) {
												for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
													if (tmpCsp instanceof CSP) {
														CSP csp = (CSP) tmpCsp;
														return new Object[] { externalModel, umlModel, commonTypes,
																rootModel, sourceRefModel, csp, _this,
																isApplicableMatch };
													}
												}
											}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black = pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
					externalModel, umlModel, commonTypes, rootModel, sourceRefModel, _this, isApplicableMatch);
			if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black != null) {
				...
				return new Object[] { externalModel, umlModel, commonTypes, rootModel, sourceRefModel, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFFBFBFFBBB(
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject externalModel, EObject jm2um2, EObject umlModel, EObject jm2um3, EObject jm2commonTypes,
			EObject commonTypes, EObject rootModel, EObject sourceRefModel) {
		_this.registerObjects_BWD(ruleresult, jm2um, javaModel, externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes,
				commonTypes, rootModel, sourceRefModel);
													...
													if (commonTypes_name.equals("Common Java datatypes")) {
														...
														if (rootModel_name.equals("root model")) {
															...
															if (sourceRefModel_name.equals("source references")) {
																_result.add(new Object[] { externalModel, umlModel,
																		commonTypes, rootModel, sourceRefModel,
																		match });
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(Model externalModel,
			Model umlModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge umlModel__commonTypes____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge rootModel__sourceRefModel____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge rootModel__umlModel____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		rootModel__externalModel____packagedElement.setName(rootModel__externalModel____packagedElement_name_prime);
		return new Object[] { externalModel, umlModel, commonTypes, rootModel, sourceRefModel, isApplicableMatch,
				umlModel__commonTypes____packagedElement, rootModel__sourceRefModel____packagedElement,
				rootModel__umlModel____packagedElement, rootModel__externalModel____packagedElement };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, IsApplicableMatch isApplicableMatch, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, externalModel, umlModel, commonTypes,
				rootModel, sourceRefModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, externalModel, umlModel, commonTypes, rootModel,
					sourceRefModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding = pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, externalModel, umlModel, commonTypes, rootModel, sourceRefModel);
	...
	public static final boolean pattern_JavaModel2UmlModelRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, externalModel, umlModel, commonTypes, rootModel,
				sourceRefModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpUmlModel instanceof Model) {
					...
					if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
						...
						if (tmpRootModel instanceof Model) {
							...
							if (tmpSourceRefModel instanceof Model) {
								Model sourceRefModel = (Model) tmpSourceRefModel;
								return new Object[] { javaModel, externalModel, umlModel, commonTypes, rootModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MGravityModel javaModel, Model externalModel, Model umlModel, org.eclipse.uml2.uml.Package commonTypes,
			Model rootModel, Model sourceRefModel, Match sourceMatch, Match targetMatch) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(rootModel)) {
				if (!externalModel.equals(sourceRefModel)) {
					if (!commonTypes.equals(externalModel)) {
															...
															if (rootModel_name.equals("root model")) {
																...
																if (sourceRefModel_name.equals("source references")) {
																	return new Object[] { javaModel, externalModel,
																			umlModel, commonTypes, rootModel,
																			sourceRefModel, sourceMatch, targetMatch };
																}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					javaModel, externalModel, umlModel, commonTypes, rootModel, sourceRefModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { javaModel, externalModel, umlModel, commonTypes, rootModel, sourceRefModel,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, MGravityModel javaModel, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(javaModel, externalModel, umlModel, commonTypes,
				rootModel, sourceRefModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, javaModel, externalModel, umlModel, commonTypes, rootModel,
					sourceRefModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, javaModel, externalModel, umlModel, commonTypes, rootModel, sourceRefModel, sourceMatch,
				targetMatch);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(
			MGravityModel javaModel, Model externalModel, Model umlModel, org.eclipse.uml2.uml.Package commonTypes,
			Model rootModel, Model sourceRefModel, CCMatch ccMatch) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(rootModel)) {
				if (!externalModel.equals(sourceRefModel)) {
					if (!commonTypes.equals(externalModel)) {
							...
							if (!commonTypes.equals(rootModel)) {
								if (!commonTypes.equals(sourceRefModel)) {
									if (!rootModel.equals(umlModel)) {
										if (!rootModel.equals(sourceRefModel)) {
											if (!sourceRefModel.equals(umlModel)) {
												return new Object[] { javaModel, externalModel, umlModel, commonTypes,
														rootModel, sourceRefModel, ccMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFBBFBFFBBB(
			MGravityModel javaModel, Model externalModel, Model umlModel, org.eclipse.uml2.uml.Package commonTypes,
												...
												if (umlModel.getPackagedElements().contains(commonTypes)) {
													if (rootModel.getPackagedElements().contains(sourceRefModel)) {
														if (rootModel.getPackagedElements().contains(umlModel)) {
															if (rootModel.getPackagedElements()
																	.contains(externalModel)) {
																return new Object[] { externalModel, umlModel,
																		commonTypes, rootModel, sourceRefModel };
															}
														}
													}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_greenBBBB(Model externalModel,
		...
		rootModel.setName(rootModel_name_prime);
		sourceRefModel.setName(sourceRefModel_name_prime);
		return new Object[] { externalModel, commonTypes, rootModel, sourceRefModel };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(
		...
		return new Object[] { jm2um, javaModel, externalModel, jm2um2, umlModel, jm2um3, jm2commonTypes, commonTypes,
				rootModel, sourceRefModel, ruleResult, csp };
	}
