...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) result1_green[4];
		JavaModel2UMLPackage jm2commonTypes = (JavaModel2UMLPackage) result1_green[5];
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(javaModel, externalModel,
						rootModel, jm2um2, commonTypes, jm2commonTypes, umlModel, jm2um3, jm2um, sourceRefModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = " + javaModel + ", "
					+ "[externalModel] = " + externalModel + ", " + "[rootModel] = " + rootModel + ", " + "[jm2um2] = "
					+ jm2um2 + ", " + "[commonTypes] = " + commonTypes + ", " + "[jm2commonTypes] = " + jm2commonTypes
					+ ", " + "[umlModel] = " + umlModel + ", " + "[jm2um3] = " + jm2um3 + ", " + "[jm2um] = " + jm2um
					+ ", " + "[sourceRefModel] = " + sourceRefModel + ".");
		}
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(javaModel, externalModel,
						rootModel, jm2um2, commonTypes, jm2commonTypes, umlModel, jm2um3, jm2um, sourceRefModel);
		...
		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, javaModel,
						externalModel, rootModel, jm2um2, commonTypes, jm2commonTypes, umlModel, jm2um3, jm2um,
						sourceRefModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[javaModel] = " + javaModel + ", " + "[externalModel] = " + externalModel + ", "
					+ "[rootModel] = " + rootModel + ", " + "[jm2um2] = " + jm2um2 + ", " + "[commonTypes] = "
					+ commonTypes + ", " + "[jm2commonTypes] = " + jm2commonTypes + ", " + "[umlModel] = " + umlModel
					+ ", " + "[jm2um3] = " + jm2um3 + ", " + "[jm2um] = " + jm2um + ", " + "[sourceRefModel] = "
					+ sourceRefModel + ".");
		}
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, javaModel, externalModel, rootModel, jm2um2, commonTypes, jm2commonTypes, umlModel, jm2um3,
				jm2um, sourceRefModel);
		...
		//nothing EMoflonEdge jm2commonTypes__commonTypes____target = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge rootModel__externalModel____packagedElement = (EMoflonEdge) result3_green[14];
		//nothing EMoflonEdge umlModel__commonTypes____packagedElement = (EMoflonEdge) result3_green[15];
		//nothing EMoflonEdge jm2um3__javaModel____source = (EMoflonEdge) result3_green[16];
		//nothing EMoflonEdge jm2um2__externalModel____target = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge jm2um2__javaModel____source = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge jm2um__umlModel____target = (EMoflonEdge) result3_green[19];
		//nothing EMoflonEdge jm2um__javaModel____source = (EMoflonEdge) result3_green[20];
		//nothing EMoflonEdge rootModel__sourceRefModel____packagedElement = (EMoflonEdge) result3_green[21];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject javaModel, EObject externalModel,
			EObject rootModel, EObject jm2um2, EObject commonTypes, EObject jm2commonTypes, EObject umlModel,
			EObject jm2um3, EObject jm2um, EObject sourceRefModel) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Model externalModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel) {

		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(this, match, externalModel, rootModel,
						commonTypes, umlModel, sourceRefModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[externalModel] = " + externalModel + ", " + "[rootModel] = "
					+ rootModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[umlModel] = " + umlModel + ", "
					+ "[sourceRefModel] = " + sourceRefModel + ".");
		}

		Object[] result2_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, externalModel,
						rootModel, commonTypes, umlModel, sourceRefModel);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[externalModel] = " + externalModel + ", " + "[rootModel] = "
					+ rootModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[umlModel] = " + umlModel + ", "
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(match,
							externalModel, rootModel, commonTypes, umlModel, sourceRefModel);
			...
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
					this, match, externalModel, rootModel, commonTypes, umlModel, sourceRefModel);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) result1_bindingAndBlack[2];
		Model umlModel = (Model) result1_bindingAndBlack[3];
		Model sourceRefModel = (Model) result1_bindingAndBlack[4];
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFBFBFBFFBB(externalModel, commonTypes,
						umlModel, sourceRefModel, csp);
		MGravityModel javaModel = (MGravityModel) result1_green[0];
		JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result1_green[2];
		JavaModel2UMLPackage jm2commonTypes = (JavaModel2UMLPackage) result1_green[4];
		JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result1_green[6];
		JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result1_green[7];

		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(javaModel, externalModel,
						rootModel, jm2um2, commonTypes, jm2commonTypes, umlModel, jm2um3, jm2um, sourceRefModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = " + javaModel + ", "
					+ "[externalModel] = " + externalModel + ", " + "[rootModel] = " + rootModel + ", " + "[jm2um2] = "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(javaModel,
						externalModel, rootModel, jm2um2, commonTypes, jm2commonTypes, umlModel, jm2um3, jm2um,
						sourceRefModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) result2_binding[2];
		Model umlModel = (Model) result2_binding[3];
		Model sourceRefModel = (Model) result2_binding[4];
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_12_2_corematch_blackBBBBBB(externalModel, rootModel, commonTypes,
						umlModel, sourceRefModel, match)) {
			// ForEach 
			for (Object[] result3_black : JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_12_3_findcontext_blackBBBBB(externalModel, rootModel, commonTypes,
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Model externalModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Model externalModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject javaModel, EObject externalModel,
			EObject rootModel, EObject jm2um2, EObject commonTypes, EObject jm2commonTypes, EObject umlModel,
			EObject jm2um3, EObject jm2um, EObject sourceRefModel) {
		ruleresult.registerObject("javaModel", javaModel);
		ruleresult.registerObject("externalModel", externalModel);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_MGravityModel_3(MGravityModel javaModel) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_239(EMoflonEdge _edge_packagedElement) {
		...
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
			...
			org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) result2_black[2];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Model rootModel = (Model) result2_bindingAndBlack[2];
		...
		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, javaModel, externalModel,
						rootModel, commonTypes, umlModel, sourceRefModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[javaModel] = " + javaModel + ", " + "[externalModel] = " + externalModel + ", "
					+ "[rootModel] = " + rootModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[umlModel] = "
					+ umlModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(javaModel, externalModel,
								rootModel, commonTypes, umlModel, sourceRefModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = "
							+ javaModel + ", " + "[externalModel] = " + externalModel + ", " + "[rootModel] = "
							+ rootModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[umlModel] = " + umlModel
							+ ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBBFBFBFFBB(
						javaModel, externalModel, commonTypes, umlModel, sourceRefModel, ccMatch);
				//nothing JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result6_green[2];
				//nothing JavaModel2UMLPackage jm2commonTypes = (JavaModel2UMLPackage) result6_green[4];
				//nothing JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result6_green[6];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MGravityModel javaModel, Model externalModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Model externalModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes,
			Model umlModel, Model sourceRefModel) {// 
		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_blackBBBBB(externalModel, rootModel, commonTypes,
						umlModel, sourceRefModel);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer) {
		...
		if (result2_black != null) {
			...
			if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				//nothing org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) result6_green[4];
				//nothing JavaModel2UMLPackage jm2commonTypes = (JavaModel2UMLPackage) result6_green[5];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD__MATCH_MODEL_MODEL_PACKAGE_MODEL_MODEL:
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_MODEL_MODEL_PACKAGE_MODEL_MODEL:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (Model) arguments.get(1), (Model) arguments.get(2),
					(org.eclipse.uml2.uml.Package) arguments.get(3), (Model) arguments.get(4),
					(Model) arguments.get(5));
			return null;
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_MODEL_MODEL_PACKAGE_MODEL_MODEL:
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODEL_MODEL_PACKAGE_MODEL_MODEL:
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_FWD_MGRAVITY_MODEL_3__MGRAVITYMODEL:
			return isAppropriate_FWD_MGravityModel_3((MGravityModel) arguments.get(0));
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_239__EMOFLONEDGE:
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPLICABLE_SOLVE_CSP_CC__MGRAVITYMODEL_MODEL_MODEL_PACKAGE_MODEL_MODEL_MATCH_MATCH:
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___CHECK_DEC_BWD__MODEL_MODEL_PACKAGE_MODEL_MODEL:
			return checkDEC_BWD((Model) arguments.get(0), (Model) arguments.get(1),
					(org.eclipse.uml2.uml.Package) arguments.get(2), (Model) arguments.get(3),
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenBFFFFFFFFFB(
		...
		return new Object[] { javaModel, externalModel, rootModel, jm2um2, commonTypes, jm2commonTypes, umlModel,
				jm2um3, jm2um, sourceRefModel, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			MGravityModel javaModel, Model externalModel, Model rootModel, JavaModel2UMLPackage jm2um2,
			org.eclipse.uml2.uml.Package commonTypes, JavaModel2UMLPackage jm2commonTypes, Model umlModel,
			JavaModel2UMLPackage jm2um3, JavaModel2UMLPackage jm2um, Model sourceRefModel) {
															...
															if (!jm2um.equals(jm2um2)) {
																if (!jm2um.equals(jm2um3)) {
																	if (!sourceRefModel.equals(umlModel)) {
																		return new Object[] { javaModel, externalModel,
																				rootModel, jm2um2, commonTypes,
																				jm2commonTypes, umlModel, jm2um3, jm2um,
																				sourceRefModel };
																	}
																}
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, javaModel, externalModel, rootModel, jm2um2, commonTypes, jm2commonTypes,
				umlModel, jm2um3, jm2um, sourceRefModel };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject javaModel, EObject externalModel, EObject rootModel, EObject jm2um2,
			EObject commonTypes, EObject jm2commonTypes, EObject umlModel, EObject jm2um3, EObject jm2um,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, javaModel, externalModel, rootModel, jm2um2, commonTypes, jm2commonTypes,
				umlModel, jm2um3, jm2um, sourceRefModel, rootModel__umlModel____packagedElement,
				jm2commonTypes__javaModel____source, jm2commonTypes__commonTypes____target,
				rootModel__externalModel____packagedElement, umlModel__commonTypes____packagedElement,
				jm2um3__javaModel____source, jm2um2__externalModel____target, jm2um2__javaModel____source,
				jm2um__umlModel____target, jm2um__javaModel____source, rootModel__sourceRefModel____packagedElement,
				jm2um3__sourceRefModel____target };
	}

	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject javaModel, EObject externalModel,
			EObject rootModel, EObject jm2um2, EObject commonTypes, EObject jm2commonTypes, EObject umlModel,
			EObject jm2um3, EObject jm2um, EObject sourceRefModel) {
		_this.registerObjects_FWD(ruleresult, javaModel, externalModel, rootModel, jm2um2, commonTypes, jm2commonTypes,
				umlModel, jm2um3, jm2um, sourceRefModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model externalModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel) {
		if (!externalModel.equals(rootModel)) {
			if (!externalModel.equals(umlModel)) {
				if (!externalModel.equals(sourceRefModel)) {
							...
							if (!commonTypes.equals(externalModel)) {
								if (!commonTypes.equals(rootModel)) {
									if (!commonTypes.equals(umlModel)) {
										if (!commonTypes.equals(sourceRefModel)) {
											if (!sourceRefModel.equals(umlModel)) {
												return new Object[] { _this, match, externalModel, rootModel,
														commonTypes, umlModel, sourceRefModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model externalModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, externalModel, rootModel, commonTypes, umlModel,
				sourceRefModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, externalModel, rootModel, commonTypes, umlModel, sourceRefModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding = pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, externalModel, rootModel, commonTypes, umlModel, sourceRefModel);
		if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, externalModel, rootModel, commonTypes, umlModel,
						sourceRefModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, Model externalModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel,
							...
							if (!commonTypes.equals(externalModel)) {
								if (!commonTypes.equals(rootModel)) {
									if (!commonTypes.equals(umlModel)) {
										if (!commonTypes.equals(sourceRefModel)) {
											if (!sourceRefModel.equals(umlModel)) {
												return new Object[] { match, externalModel, rootModel, commonTypes,
														umlModel, sourceRefModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		umlModel__commonTypes____packagedElement.setName(umlModel__commonTypes____packagedElement_name_prime);
		rootModel__sourceRefModel____packagedElement.setName(rootModel__sourceRefModel____packagedElement_name_prime);
		return new Object[] { match, externalModel, rootModel, commonTypes, umlModel, sourceRefModel,
				rootModel__umlModel____packagedElement, rootModel__externalModel____packagedElement,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_5_collectcontextelements_blackBBBBBB(Match match,
			Model externalModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel,
			Model sourceRefModel) {
		if (!externalModel.equals(rootModel)) {
			if (!externalModel.equals(umlModel)) {
				if (!externalModel.equals(sourceRefModel)) {
	...
	public static final void pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model externalModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel) {
		_this.registerObjectsToMatch_BWD(match, externalModel, rootModel, commonTypes, umlModel, sourceRefModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingFFFFFB(
		...
		EObject _localVariable_2 = isApplicableMatch.getObject("commonTypes");
				...
				if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
					...
					if (tmpUmlModel instanceof Model) {
						...
						if (tmpSourceRefModel instanceof Model) {
							...
							return new Object[] { externalModel, rootModel, commonTypes, umlModel, sourceRefModel,
									isApplicableMatch };
						}
					}
				}
										...
										if (!commonTypes.equals(sourceRefModel)) {
											if (!sourceRefModel.equals(umlModel)) {
												for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
													if (tmpCsp instanceof CSP) {
														CSP csp = (CSP) tmpCsp;
														return new Object[] { externalModel, rootModel, commonTypes,
																umlModel, sourceRefModel, csp, _this,
																isApplicableMatch };
													}
												}
											}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding != null) {
			...
			org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black = pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
					externalModel, rootModel, commonTypes, umlModel, sourceRefModel, _this, isApplicableMatch);
			if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black != null) {
				...
				return new Object[] { externalModel, rootModel, commonTypes, umlModel, sourceRefModel, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFBFBFBFFBB(
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel,
			CSP csp) {
		...
		return new Object[] { javaModel, externalModel, jm2um2, commonTypes, jm2commonTypes, umlModel, jm2um3, jm2um,
				sourceRefModel, csp };
	}
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject rootModel, EObject jm2um2, EObject commonTypes, EObject jm2commonTypes, EObject umlModel,
			EObject jm2um3, EObject jm2um, EObject sourceRefModel) {
		_this.registerObjects_BWD(ruleresult, javaModel, externalModel, rootModel, jm2um2, commonTypes, jm2commonTypes,
				umlModel, jm2um3, jm2um, sourceRefModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_2_corematch_bindingFFFFFB(Match match) {
		...
		EObject _localVariable_2 = match.getObject("commonTypes");
														...
														if (commonTypes_name.equals("Common Java datatypes")) {
															...
															if (sourceRefModel_name.equals("source references")) {
																_result.add(new Object[] { externalModel, rootModel,
																		commonTypes, umlModel, sourceRefModel, match });
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(Model externalModel,
			Model rootModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge rootModel__umlModel____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge rootModel__externalModel____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge umlModel__commonTypes____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		umlModel__commonTypes____packagedElement.setName(umlModel__commonTypes____packagedElement_name_prime);
		rootModel__sourceRefModel____packagedElement.setName(rootModel__sourceRefModel____packagedElement_name_prime);
		return new Object[] { externalModel, rootModel, commonTypes, umlModel, sourceRefModel, isApplicableMatch,
				rootModel__umlModel____packagedElement, rootModel__externalModel____packagedElement,
				umlModel__commonTypes____packagedElement, rootModel__sourceRefModel____packagedElement };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
			...
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, externalModel, rootModel, commonTypes,
				umlModel, sourceRefModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, externalModel, rootModel, commonTypes, umlModel,
					sourceRefModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding = pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, externalModel, rootModel, commonTypes, umlModel, sourceRefModel);
	...
	public static final boolean pattern_JavaModel2UmlModelRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model externalModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, externalModel, rootModel, commonTypes, umlModel,
				sourceRefModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingFFFFFFBB(
		...
		EObject _localVariable_2 = targetMatch.getObject("rootModel");
				...
				if (tmpRootModel instanceof Model) {
					...
					if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
						...
						if (tmpUmlModel instanceof Model) {
							...
							if (tmpSourceRefModel instanceof Model) {
								Model sourceRefModel = (Model) tmpSourceRefModel;
								return new Object[] { javaModel, externalModel, rootModel, commonTypes, umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MGravityModel javaModel, Model externalModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes,
			Model umlModel, Model sourceRefModel, Match sourceMatch, Match targetMatch) {
		if (!externalModel.equals(rootModel)) {
			if (!externalModel.equals(umlModel)) {
				if (!externalModel.equals(sourceRefModel)) {
					if (!rootModel.equals(umlModel)) {
													...
													if (externalModel_name.equals("externals")) {
														...
														if (rootModel_name.equals("root model")) {
															...
															if (commonTypes_name.equals("Common Java datatypes")) {
																...
																if (sourceRefModel_name.equals("source references")) {
																	return new Object[] { javaModel, externalModel,
																			rootModel, commonTypes, umlModel,
																			sourceRefModel, sourceMatch, targetMatch };
																}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Model rootModel = (Model) result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding[2];
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					javaModel, externalModel, rootModel, commonTypes, umlModel, sourceRefModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { javaModel, externalModel, rootModel, commonTypes, umlModel, sourceRefModel,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, MGravityModel javaModel, Model externalModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(javaModel, externalModel, rootModel, commonTypes,
				umlModel, sourceRefModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, javaModel, externalModel, rootModel, commonTypes, umlModel,
					sourceRefModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, javaModel, externalModel, rootModel, commonTypes, umlModel, sourceRefModel, sourceMatch,
				targetMatch);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(
			MGravityModel javaModel, Model externalModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes,
			Model umlModel, Model sourceRefModel, CCMatch ccMatch) {
		if (!externalModel.equals(rootModel)) {
			if (!externalModel.equals(umlModel)) {
				if (!externalModel.equals(sourceRefModel)) {
					if (!rootModel.equals(umlModel)) {
							...
							if (!commonTypes.equals(externalModel)) {
								if (!commonTypes.equals(rootModel)) {
									if (!commonTypes.equals(umlModel)) {
										if (!commonTypes.equals(sourceRefModel)) {
											if (!sourceRefModel.equals(umlModel)) {
												return new Object[] { javaModel, externalModel, rootModel, commonTypes,
														umlModel, sourceRefModel, ccMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBBFBFBFFBB(
			MGravityModel javaModel, Model externalModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(
		...
		return new Object[] { javaModel, externalModel, rootModel, jm2um2, commonTypes, jm2commonTypes, umlModel,
				jm2um3, jm2um, sourceRefModel, ruleResult, csp };
	}
