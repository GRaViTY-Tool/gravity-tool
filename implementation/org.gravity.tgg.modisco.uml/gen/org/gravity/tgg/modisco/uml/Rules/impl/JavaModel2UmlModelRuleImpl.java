...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Model sourceRefModel = (Model) result1_green[2];
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(javaModel, jm2um,
						sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes, externalModel, commonTypes,
						umlModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = " + javaModel + ", "
					+ "[jm2um] = " + jm2um + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[jm2um3] = "
					+ jm2um3 + ", " + "[jm2um2] = " + jm2um2 + ", " + "[rootModel] = " + rootModel + ", "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(javaModel, jm2um,
						sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes, externalModel, commonTypes,
						umlModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, javaModel, jm2um,
						sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes, externalModel, commonTypes,
						umlModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[javaModel] = " + javaModel + ", " + "[jm2um] = " + jm2um + ", " + "[sourceRefModel] = "
					+ sourceRefModel + ", " + "[jm2um3] = " + jm2um3 + ", " + "[jm2um2] = " + jm2um2 + ", "
					+ "[rootModel] = " + rootModel + ", " + "[jm2commonTypes] = " + jm2commonTypes + ", "
		...
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, javaModel, jm2um, sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes, externalModel,
				commonTypes, umlModel);
		//nothing EMoflonEdge jm2um3__sourceRefModel____target = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge jm2um__javaModel____source = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge jm2um2__javaModel____source = (EMoflonEdge) result3_green[13];
		...
		//nothing EMoflonEdge jm2commonTypes__commonTypes____target = (EMoflonEdge) result3_green[16];
		//nothing EMoflonEdge rootModel__sourceRefModel____packagedElement = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge jm2um__umlModel____target = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge rootModel__umlModel____packagedElement = (EMoflonEdge) result3_green[19];
		//nothing EMoflonEdge jm2um2__externalModel____target = (EMoflonEdge) result3_green[20];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject javaModel, EObject jm2um,
			EObject sourceRefModel, EObject jm2um3, EObject jm2um2, EObject rootModel, EObject jm2commonTypes,
			EObject externalModel, EObject commonTypes, EObject umlModel) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {

		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(this, match, sourceRefModel,
						rootModel, externalModel, commonTypes, umlModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[rootModel] = "
					+ rootModel + ", " + "[externalModel] = " + externalModel + ", " + "[commonTypes] = " + commonTypes
					+ ", " + "[umlModel] = " + umlModel + ".");
		}
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(match,
							sourceRefModel, rootModel, externalModel, commonTypes, umlModel);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
			...
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
					this, match, sourceRefModel, rootModel, externalModel, commonTypes, umlModel);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Model externalModel = (Model) result1_bindingAndBlack[2];
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFFBFFFBBBB(sourceRefModel,
						externalModel, commonTypes, umlModel, csp);
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(javaModel, jm2um,
						sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes, externalModel, commonTypes,
						umlModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = " + javaModel + ", "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(javaModel, jm2um,
						sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes, externalModel, commonTypes,
						umlModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, javaModel, jm2um,
						sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes, externalModel, commonTypes,
						umlModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Model externalModel = (Model) result2_binding[2];
		...
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_12_2_corematch_blackBBBBBB(sourceRefModel, rootModel, externalModel,
						commonTypes, umlModel, match)) {
			// ForEach 
			for (Object[] result3_black : JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_12_3_findcontext_blackBBBBB(sourceRefModel, rootModel,
							externalModel, commonTypes, umlModel)) {
				Object[] result3_green = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(sourceRefModel, rootModel,
								externalModel, commonTypes, umlModel);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ sourceRefModel + ", " + "[rootModel] = " + rootModel + ", " + "[externalModel] = "
							+ externalModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[umlModel] = "
							+ umlModel + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject javaModel, EObject jm2um,
			EObject sourceRefModel, EObject jm2um3, EObject jm2um2, EObject rootModel, EObject jm2commonTypes,
			EObject externalModel, EObject commonTypes, EObject umlModel) {
		ruleresult.registerObject("javaModel", javaModel);
		ruleresult.registerObject("jm2um", jm2um);
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_144(EMoflonEdge _edge_packagedElement) {
		...
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
			...
			Model externalModel = (Model) result2_black[2];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, javaModel, sourceRefModel,
						rootModel, externalModel, commonTypes, umlModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[javaModel] = " + javaModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", "
					+ "[rootModel] = " + rootModel + ", " + "[externalModel] = " + externalModel + ", "
					+ "[commonTypes] = " + commonTypes + ", " + "[umlModel] = " + umlModel + ", " + "[sourceMatch] = "
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(javaModel,
								sourceRefModel, rootModel, externalModel, commonTypes, umlModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[javaModel] = "
							+ javaModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[rootModel] = "
							+ rootModel + ", " + "[externalModel] = " + externalModel + ", " + "[commonTypes] = "
							+ commonTypes + ", " + "[umlModel] = " + umlModel + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBFBFFFBBBB(
						javaModel, sourceRefModel, externalModel, commonTypes, umlModel, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MGravityModel javaModel, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {// 
		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_blackBBBBB(sourceRefModel, rootModel,
						externalModel, commonTypes, umlModel);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer) {
		...
		if (result2_black != null) {
			...
			if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				//nothing JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result6_green[1];
				//nothing Model sourceRefModel = (Model) result6_green[2];
				//nothing JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result6_green[3];
				//nothing JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result6_green[4];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_144__EMOFLONEDGE:
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenBFFFFFFFFFB(
		...
		return new Object[] { javaModel, jm2um, sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes,
				externalModel, commonTypes, umlModel, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			MGravityModel javaModel, JavaModel2UMLPackage jm2um, Model sourceRefModel, JavaModel2UMLPackage jm2um3,
			JavaModel2UMLPackage jm2um2, Model rootModel, JavaModel2UMLPackage jm2commonTypes, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
															...
															if (!commonTypes.equals(rootModel)) {
																if (!commonTypes.equals(externalModel)) {
																	if (!commonTypes.equals(umlModel)) {
																		return new Object[] { javaModel, jm2um,
																				sourceRefModel, jm2um3, jm2um2,
																				rootModel, jm2commonTypes,
																				externalModel, commonTypes, umlModel };
																	}
																}
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, javaModel, jm2um, sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes,
				externalModel, commonTypes, umlModel };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject javaModel, EObject jm2um, EObject sourceRefModel, EObject jm2um3,
			EObject jm2um2, EObject rootModel, EObject jm2commonTypes, EObject externalModel, EObject commonTypes,
			EObject umlModel) {
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, javaModel, jm2um, sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes,
				externalModel, commonTypes, umlModel, jm2um3__sourceRefModel____target, jm2um__javaModel____source,
				jm2um2__javaModel____source, jm2um3__javaModel____source, jm2commonTypes__javaModel____source,
				jm2commonTypes__commonTypes____target, rootModel__sourceRefModel____packagedElement,
				jm2um__umlModel____target, rootModel__umlModel____packagedElement, jm2um2__externalModel____target,
	...
	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject javaModel, EObject jm2um,
			EObject sourceRefModel, EObject jm2um3, EObject jm2um2, EObject rootModel, EObject jm2commonTypes,
			EObject externalModel, EObject commonTypes, EObject umlModel) {
		_this.registerObjects_FWD(ruleresult, javaModel, jm2um, sourceRefModel, jm2um3, jm2um2, rootModel,
				jm2commonTypes, externalModel, commonTypes, umlModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(sourceRefModel)) {
				if (!rootModel.equals(umlModel)) {
							...
							if (!externalModel.equals(umlModel)) {
								if (!commonTypes.equals(sourceRefModel)) {
									if (!commonTypes.equals(rootModel)) {
										if (!commonTypes.equals(externalModel)) {
											if (!commonTypes.equals(umlModel)) {
												return new Object[] { _this, match, sourceRefModel, rootModel,
														externalModel, commonTypes, umlModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, sourceRefModel, rootModel, externalModel,
				commonTypes, umlModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, sourceRefModel, rootModel, externalModel, commonTypes, umlModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding = pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, sourceRefModel, rootModel, externalModel, commonTypes, umlModel);
		if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, sourceRefModel, rootModel, externalModel, commonTypes,
						umlModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(sourceRefModel)) {
				if (!rootModel.equals(umlModel)) {
							...
							if (!externalModel.equals(umlModel)) {
								if (!commonTypes.equals(sourceRefModel)) {
									if (!commonTypes.equals(rootModel)) {
										if (!commonTypes.equals(externalModel)) {
											if (!commonTypes.equals(umlModel)) {
												return new Object[] { match, sourceRefModel, rootModel, externalModel,
														commonTypes, umlModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		umlModel__commonTypes____packagedElement.setName(umlModel__commonTypes____packagedElement_name_prime);
		rootModel__externalModel____packagedElement.setName(rootModel__externalModel____packagedElement_name_prime);
		return new Object[] { match, sourceRefModel, rootModel, externalModel, commonTypes, umlModel,
				rootModel__sourceRefModel____packagedElement, rootModel__umlModel____packagedElement,
				umlModel__commonTypes____packagedElement, rootModel__externalModel____packagedElement };
	}
	...
	public static final void pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		_this.registerObjectsToMatch_BWD(match, sourceRefModel, rootModel, externalModel, commonTypes, umlModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingFFFFFB(
		...
		EObject _localVariable_2 = isApplicableMatch.getObject("externalModel");
				...
				if (tmpExternalModel instanceof Model) {
					...
					if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
						...
						if (tmpUmlModel instanceof Model) {
							...
							return new Object[] { sourceRefModel, rootModel, externalModel, commonTypes, umlModel,
									isApplicableMatch };
						}
					}
				}
										...
										if (!commonTypes.equals(externalModel)) {
											if (!commonTypes.equals(umlModel)) {
												for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
													if (tmpCsp instanceof CSP) {
														CSP csp = (CSP) tmpCsp;
														return new Object[] { sourceRefModel, rootModel, externalModel,
																commonTypes, umlModel, csp, _this, isApplicableMatch };
													}
												}
											}
										}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding != null) {
			...
			Model externalModel = (Model) result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black = pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
					sourceRefModel, rootModel, externalModel, commonTypes, umlModel, _this, isApplicableMatch);
			if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black != null) {
				...
				return new Object[] { sourceRefModel, rootModel, externalModel, commonTypes, umlModel, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFFBFFFBBBB(
			Model sourceRefModel, Model externalModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel,
			CSP csp) {
		...
		return new Object[] { javaModel, jm2um, sourceRefModel, jm2um3, jm2um2, jm2commonTypes, externalModel,
				commonTypes, umlModel, csp };
	}
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject sourceRefModel, EObject jm2um3, EObject jm2um2, EObject rootModel, EObject jm2commonTypes,
			EObject externalModel, EObject commonTypes, EObject umlModel) {
		_this.registerObjects_BWD(ruleresult, javaModel, jm2um, sourceRefModel, jm2um3, jm2um2, rootModel,
				jm2commonTypes, externalModel, commonTypes, umlModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_2_corematch_bindingFFFFFB(Match match) {
		...
		EObject _localVariable_2 = match.getObject("externalModel");
													...
													if (rootModel_name.equals("root model")) {
														...
														if (externalModel_name.equals("externals")) {
															...
															if (commonTypes_name.equals("Common Java datatypes")) {
																_result.add(new Object[] { sourceRefModel, rootModel,
																		externalModel, commonTypes, umlModel, match });
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(Model sourceRefModel,
			Model rootModel, Model externalModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge rootModel__sourceRefModel____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge rootModel__umlModel____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge umlModel__commonTypes____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		umlModel__commonTypes____packagedElement.setName(umlModel__commonTypes____packagedElement_name_prime);
		rootModel__externalModel____packagedElement.setName(rootModel__externalModel____packagedElement_name_prime);
		return new Object[] { sourceRefModel, rootModel, externalModel, commonTypes, umlModel, isApplicableMatch,
				rootModel__sourceRefModel____packagedElement, rootModel__umlModel____packagedElement,
				umlModel__commonTypes____packagedElement, rootModel__externalModel____packagedElement };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, IsApplicableMatch isApplicableMatch, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, sourceRefModel, rootModel,
				externalModel, commonTypes, umlModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, sourceRefModel, rootModel, externalModel, commonTypes,
					umlModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding = pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, sourceRefModel, rootModel, externalModel, commonTypes, umlModel);
		if (result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, sourceRefModel, rootModel, externalModel,
						commonTypes, umlModel };
			}
		}
		return null;
	...
	public static final boolean pattern_JavaModel2UmlModelRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, sourceRefModel, rootModel, externalModel, commonTypes,
				umlModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpRootModel instanceof Model) {
					...
					if (tmpExternalModel instanceof Model) {
						...
						if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
							...
							if (tmpUmlModel instanceof Model) {
								Model umlModel = (Model) tmpUmlModel;
								return new Object[] { javaModel, sourceRefModel, rootModel, externalModel, commonTypes,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
			MGravityModel javaModel, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Match sourceMatch, Match targetMatch) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(sourceRefModel)) {
				if (!rootModel.equals(umlModel)) {
					if (!externalModel.equals(sourceRefModel)) {
													...
													if (sourceRefModel_name.equals("source references")) {
														...
														if (rootModel_name.equals("root model")) {
															...
															if (externalModel_name.equals("externals")) {
																String commonTypes_name = commonTypes.getName();
																if (commonTypes_name.equals("Common Java datatypes")) {
																	return new Object[] { javaModel, sourceRefModel,
																			rootModel, externalModel, commonTypes,
																			umlModel, sourceMatch, targetMatch };
																}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					javaModel, sourceRefModel, rootModel, externalModel, commonTypes, umlModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { javaModel, sourceRefModel, rootModel, externalModel, commonTypes, umlModel,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, MGravityModel javaModel, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(javaModel, sourceRefModel, rootModel, externalModel,
				commonTypes, umlModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, javaModel, sourceRefModel, rootModel, externalModel, commonTypes,
					umlModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, javaModel, sourceRefModel, rootModel, externalModel, commonTypes, umlModel, sourceMatch,
				targetMatch);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(
			MGravityModel javaModel, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, CCMatch ccMatch) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(sourceRefModel)) {
				if (!rootModel.equals(umlModel)) {
					if (!externalModel.equals(sourceRefModel)) {
							...
							if (!externalModel.equals(umlModel)) {
								if (!commonTypes.equals(sourceRefModel)) {
									if (!commonTypes.equals(rootModel)) {
										if (!commonTypes.equals(externalModel)) {
											if (!commonTypes.equals(umlModel)) {
												return new Object[] { javaModel, sourceRefModel, rootModel,
														externalModel, commonTypes, umlModel, ccMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBFBFFFBBBB(
			MGravityModel javaModel, Model sourceRefModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, CCMatch ccMatch) {
		JavaModel2UMLPackage jm2um = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2um3 = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2um2 = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
												...
												if (rootModel.getPackagedElements().contains(sourceRefModel)) {
													if (rootModel.getPackagedElements().contains(umlModel)) {
														if (umlModel.getPackagedElements().contains(commonTypes)) {
															if (rootModel.getPackagedElements()
																	.contains(externalModel)) {
																return new Object[] { sourceRefModel, rootModel,
																		externalModel, commonTypes, umlModel };
															}
														}
													}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(
		...
		return new Object[] { javaModel, jm2um, sourceRefModel, jm2um3, jm2um2, rootModel, jm2commonTypes,
				externalModel, commonTypes, umlModel, ruleResult, csp };
	}
