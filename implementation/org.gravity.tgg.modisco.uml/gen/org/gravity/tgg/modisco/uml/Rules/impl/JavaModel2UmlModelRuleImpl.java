...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(commonTypes, javaModel,
						rootModel, umlModel, jm2um2, jm2um3, sourceRefModel, externalModel, jm2um, jm2commonTypes);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[commonTypes] = " + commonTypes
					+ ", " + "[javaModel] = " + javaModel + ", " + "[rootModel] = " + rootModel + ", " + "[umlModel] = "
					+ umlModel + ", " + "[jm2um2] = " + jm2um2 + ", " + "[jm2um3] = " + jm2um3 + ", "
					+ "[sourceRefModel] = " + sourceRefModel + ", " + "[externalModel] = " + externalModel + ", "
					+ "[jm2um] = " + jm2um + ", " + "[jm2commonTypes] = " + jm2commonTypes + ".");
		}
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(commonTypes, javaModel,
						rootModel, umlModel, jm2um2, jm2um3, sourceRefModel, externalModel, jm2um, jm2commonTypes);
		...
		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, commonTypes,
						javaModel, rootModel, umlModel, jm2um2, jm2um3, sourceRefModel, externalModel, jm2um,
						jm2commonTypes);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[commonTypes] = " + commonTypes + ", " + "[javaModel] = " + javaModel + ", "
					+ "[rootModel] = " + rootModel + ", " + "[umlModel] = " + umlModel + ", " + "[jm2um2] = " + jm2um2
					+ ", " + "[jm2um3] = " + jm2um3 + ", " + "[sourceRefModel] = " + sourceRefModel + ", "
					+ "[externalModel] = " + externalModel + ", " + "[jm2um] = " + jm2um + ", " + "[jm2commonTypes] = "
					+ jm2commonTypes + ".");
		}
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, commonTypes, javaModel, rootModel, umlModel, jm2um2, jm2um3, sourceRefModel, externalModel,
				jm2um, jm2commonTypes);
		//nothing EMoflonEdge rootModel__externalModel____packagedElement = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge rootModel__sourceRefModel____packagedElement = (EMoflonEdge) result3_green[12];
		...
		//nothing EMoflonEdge jm2um__javaModel____source = (EMoflonEdge) result3_green[18];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject commonTypes, EObject javaModel,
			EObject rootModel, EObject umlModel, EObject jm2um2, EObject jm2um3, EObject sourceRefModel,
			EObject externalModel, EObject jm2um, EObject jm2commonTypes) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
			Model umlModel, Model sourceRefModel, Model externalModel) {

		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(this, match, commonTypes, rootModel,
						umlModel, sourceRefModel, externalModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[commonTypes] = " + commonTypes + ", " + "[rootModel] = "
					+ rootModel + ", " + "[umlModel] = " + umlModel + ", " + "[sourceRefModel] = " + sourceRefModel
					+ ", " + "[externalModel] = " + externalModel + ".");
		}

		Object[] result2_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, commonTypes,
						rootModel, umlModel, sourceRefModel, externalModel);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[commonTypes] = " + commonTypes + ", " + "[rootModel] = "
					+ rootModel + ", " + "[umlModel] = " + umlModel + ", " + "[sourceRefModel] = " + sourceRefModel
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(match,
							commonTypes, rootModel, umlModel, sourceRefModel, externalModel);
			...
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
					this, match, commonTypes, rootModel, umlModel, sourceRefModel, externalModel);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Model sourceRefModel = (Model) result1_bindingAndBlack[3];
		Model externalModel = (Model) result1_bindingAndBlack[4];
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenBFBFFBBFFB(commonTypes, umlModel,
						sourceRefModel, externalModel, csp);
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(commonTypes, javaModel,
						rootModel, umlModel, jm2um2, jm2um3, sourceRefModel, externalModel, jm2um, jm2commonTypes);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[commonTypes] = " + commonTypes
					+ ", " + "[javaModel] = " + javaModel + ", " + "[rootModel] = " + rootModel + ", " + "[umlModel] = "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(commonTypes, javaModel,
						rootModel, umlModel, jm2um2, jm2um3, sourceRefModel, externalModel, jm2um, jm2commonTypes);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Model sourceRefModel = (Model) result2_binding[3];
		Model externalModel = (Model) result2_binding[4];
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_12_2_corematch_blackBBBBBB(commonTypes, rootModel, umlModel,
						sourceRefModel, externalModel, match)) {
			// ForEach 
			for (Object[] result3_black : JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_12_3_findcontext_blackBBBBB(commonTypes, rootModel, umlModel,
							sourceRefModel, externalModel)) {
				Object[] result3_green = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(commonTypes, rootModel,
								umlModel, sourceRefModel, externalModel);
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
			Model umlModel, Model sourceRefModel, Model externalModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
			Model umlModel, Model sourceRefModel, Model externalModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Package commonTypes,
			Model rootModel, Model umlModel, Model sourceRefModel, Model externalModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject commonTypes, EObject javaModel,
			EObject rootModel, EObject umlModel, EObject jm2um2, EObject jm2um3, EObject sourceRefModel,
			EObject externalModel, EObject jm2um, EObject jm2commonTypes) {
		ruleresult.registerObject("commonTypes", commonTypes);
		ruleresult.registerObject("javaModel", javaModel);
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_142(EMoflonEdge _edge_packagedElement) {
		...
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
			...
			Model sourceRefModel = (Model) result2_black[3];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Model sourceRefModel = (Model) result2_bindingAndBlack[4];
		Model externalModel = (Model) result2_bindingAndBlack[5];

		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, commonTypes, javaModel,
						rootModel, umlModel, sourceRefModel, externalModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[commonTypes] = " + commonTypes + ", " + "[javaModel] = " + javaModel + ", " + "[rootModel] = "
					+ rootModel + ", " + "[umlModel] = " + umlModel + ", " + "[sourceRefModel] = " + sourceRefModel
					+ ", " + "[externalModel] = " + externalModel + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(commonTypes, javaModel,
								rootModel, umlModel, sourceRefModel, externalModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[commonTypes] = "
							+ commonTypes + ", " + "[javaModel] = " + javaModel + ", " + "[rootModel] = " + rootModel
							+ ", " + "[umlModel] = " + umlModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", "
							+ "[externalModel] = " + externalModel + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBBBFFBBFFB(
						commonTypes, javaModel, umlModel, sourceRefModel, externalModel, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Package commonTypes, MGravityModel javaModel,
			Model rootModel, Model umlModel, Model sourceRefModel, Model externalModel, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model umlModel,
			Model sourceRefModel, Model externalModel) {// 
		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_blackBBBBB(commonTypes, rootModel, umlModel,
						sourceRefModel, externalModel);
		if (result1_black != null) {
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_greenBBBB(commonTypes,
					rootModel, sourceRefModel, externalModel);
		...
		switch (operationID) {
			...
			case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_PACKAGE_MODEL_MODEL_MODEL_MODEL:
				return isAppropriate_solveCsp_BWD((Match) arguments.get(0),
						(org.eclipse.uml2.uml.Package) arguments.get(1), (Model) arguments.get(2),
						(Model) arguments.get(3), (Model) arguments.get(4), (Model) arguments.get(5));
			...
			case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_142__EMOFLONEDGE:
			...
			case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPLICABLE_SOLVE_CSP_CC__PACKAGE_MGRAVITYMODEL_MODEL_MODEL_MODEL_MODEL_MATCH_MATCH:
				return isApplicable_solveCsp_CC((org.eclipse.uml2.uml.Package) arguments.get(0),
						(MGravityModel) arguments.get(1), (Model) arguments.get(2), (Model) arguments.get(3),
						(Model) arguments.get(4), (Model) arguments.get(5), (Match) arguments.get(6),
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFBFFFFFFFFB(
		...
		return new Object[] { commonTypes, javaModel, rootModel, umlModel, jm2um2, jm2um3, sourceRefModel,
				externalModel, jm2um, jm2commonTypes, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			org.eclipse.uml2.uml.Package commonTypes, MGravityModel javaModel, Model rootModel, Model umlModel,
			JavaModel2UMLPackage jm2um2, JavaModel2UMLPackage jm2um3, Model sourceRefModel, Model externalModel,
			JavaModel2UMLPackage jm2um, JavaModel2UMLPackage jm2commonTypes) {
															...
															if (!jm2commonTypes.equals(jm2um2)) {
																if (!jm2commonTypes.equals(jm2um3)) {
																	if (!jm2commonTypes.equals(jm2um)) {
																		return new Object[] { commonTypes, javaModel,
																				rootModel, umlModel, jm2um2, jm2um3,
																				sourceRefModel, externalModel, jm2um,
																				jm2commonTypes };
																	}
																}
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, commonTypes, javaModel, rootModel, umlModel, jm2um2, jm2um3, sourceRefModel,
				externalModel, jm2um, jm2commonTypes };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject commonTypes, EObject javaModel, EObject rootModel, EObject umlModel,
			EObject jm2um2, EObject jm2um3, EObject sourceRefModel, EObject externalModel, EObject jm2um,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, commonTypes, javaModel, rootModel, umlModel, jm2um2, jm2um3, sourceRefModel,
				externalModel, jm2um, jm2commonTypes, rootModel__externalModel____packagedElement,
				rootModel__sourceRefModel____packagedElement, rootModel__umlModel____packagedElement,
				jm2um2__javaModel____source, jm2um3__javaModel____source, jm2um3__sourceRefModel____target,
				jm2um2__externalModel____target, jm2um__javaModel____source, jm2um__umlModel____target,
				umlModel__commonTypes____packagedElement, jm2commonTypes__commonTypes____target,
	...
	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject commonTypes, EObject javaModel,
			EObject rootModel, EObject umlModel, EObject jm2um2, EObject jm2um3, EObject sourceRefModel,
			EObject externalModel, EObject jm2um, EObject jm2commonTypes) {
		_this.registerObjects_FWD(ruleresult, commonTypes, javaModel, rootModel, umlModel, jm2um2, jm2um3,
				sourceRefModel, externalModel, jm2um, jm2commonTypes);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
			Model umlModel, Model sourceRefModel, Model externalModel) {
		if (!commonTypes.equals(rootModel)) {
			if (!commonTypes.equals(umlModel)) {
				if (!commonTypes.equals(sourceRefModel)) {
							...
							if (!rootModel.equals(sourceRefModel)) {
								if (!sourceRefModel.equals(umlModel)) {
									if (!externalModel.equals(rootModel)) {
										if (!externalModel.equals(umlModel)) {
											if (!externalModel.equals(sourceRefModel)) {
												return new Object[] { _this, match, commonTypes, rootModel, umlModel,
														sourceRefModel, externalModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
			Model umlModel, Model sourceRefModel, Model externalModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, commonTypes, rootModel, umlModel, sourceRefModel,
				externalModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, commonTypes, rootModel, umlModel, sourceRefModel, externalModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding = pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, commonTypes, rootModel, umlModel, sourceRefModel, externalModel);
		if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, commonTypes, rootModel, umlModel, sourceRefModel,
						externalModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model umlModel,
			Model sourceRefModel, Model externalModel) {
		if (!commonTypes.equals(rootModel)) {
			if (!commonTypes.equals(umlModel)) {
				if (!commonTypes.equals(sourceRefModel)) {
							...
							if (!rootModel.equals(sourceRefModel)) {
								if (!sourceRefModel.equals(umlModel)) {
									if (!externalModel.equals(rootModel)) {
										if (!externalModel.equals(umlModel)) {
											if (!externalModel.equals(sourceRefModel)) {
												return new Object[] { match, commonTypes, rootModel, umlModel,
														sourceRefModel, externalModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		umlModel__commonTypes____packagedElement.setName(umlModel__commonTypes____packagedElement_name_prime);
		return new Object[] { match, commonTypes, rootModel, umlModel, sourceRefModel, externalModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_5_collectcontextelements_blackBBBBBB(Match match,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model umlModel, Model sourceRefModel,
			Model externalModel) {
		if (!commonTypes.equals(rootModel)) {
			if (!commonTypes.equals(umlModel)) {
				if (!commonTypes.equals(sourceRefModel)) {
	...
	public static final void pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
			Model umlModel, Model sourceRefModel, Model externalModel) {
		_this.registerObjectsToMatch_BWD(match, commonTypes, rootModel, umlModel, sourceRefModel, externalModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingFFFFFB(
		...
		EObject _localVariable_3 = isApplicableMatch.getObject("sourceRefModel");
				...
				if (tmpUmlModel instanceof Model) {
					...
					if (tmpSourceRefModel instanceof Model) {
						...
						if (tmpExternalModel instanceof Model) {
							...
							return new Object[] { commonTypes, rootModel, umlModel, sourceRefModel, externalModel,
									isApplicableMatch };
						}
					}
				}
										...
										if (!externalModel.equals(umlModel)) {
											if (!externalModel.equals(sourceRefModel)) {
												for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
													if (tmpCsp instanceof CSP) {
														CSP csp = (CSP) tmpCsp;
														return new Object[] { commonTypes, rootModel, umlModel,
																sourceRefModel, externalModel, csp, _this,
																isApplicableMatch };
													}
												}
											}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding != null) {
			...
			Model sourceRefModel = (Model) result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding[3];
			...
			Object[] result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black = pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
					commonTypes, rootModel, umlModel, sourceRefModel, externalModel, _this, isApplicableMatch);
			if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black != null) {
				...
				return new Object[] { commonTypes, rootModel, umlModel, sourceRefModel, externalModel, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenBFBFFBBFFB(
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Model sourceRefModel, Model externalModel,
			CSP csp) {
		...
		return new Object[] { commonTypes, javaModel, umlModel, jm2um2, jm2um3, sourceRefModel, externalModel, jm2um,
				jm2commonTypes, csp };
	}
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject rootModel, EObject umlModel, EObject jm2um2, EObject jm2um3, EObject sourceRefModel,
			EObject externalModel, EObject jm2um, EObject jm2commonTypes) {
		_this.registerObjects_BWD(ruleresult, commonTypes, javaModel, rootModel, umlModel, jm2um2, jm2um3,
				sourceRefModel, externalModel, jm2um, jm2commonTypes);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_2_corematch_bindingFFFFFB(Match match) {
		...
		EObject _localVariable_3 = match.getObject("sourceRefModel");
	...
	public static final Iterable<Object[]> pattern_JavaModel2UmlModelRule_12_2_corematch_blackBBBBBB(
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model umlModel, Model sourceRefModel,
			Model externalModel, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!commonTypes.equals(rootModel)) {
			if (!commonTypes.equals(umlModel)) {
				if (!commonTypes.equals(sourceRefModel)) {
													...
													if (rootModel_name.equals("root model")) {
														...
														if (sourceRefModel_name.equals("source references")) {
															...
															if (externalModel_name.equals("externals")) {
																_result.add(
																		new Object[] { commonTypes, rootModel, umlModel,
																				sourceRefModel, externalModel, match });
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(
		...
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		umlModel__commonTypes____packagedElement.setName(umlModel__commonTypes____packagedElement_name_prime);
		return new Object[] { commonTypes, rootModel, umlModel, sourceRefModel, externalModel, isApplicableMatch,
				rootModel__externalModel____packagedElement, rootModel__sourceRefModel____packagedElement,
				rootModel__umlModel____packagedElement, umlModel__commonTypes____packagedElement };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
			...
			Model rootModel, Model umlModel, Model sourceRefModel, Model externalModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, commonTypes, rootModel, umlModel,
				sourceRefModel, externalModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, commonTypes, rootModel, umlModel, sourceRefModel,
					externalModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding = pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, commonTypes, rootModel, umlModel, sourceRefModel, externalModel);
	...
	public static final boolean pattern_JavaModel2UmlModelRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
			Model umlModel, Model sourceRefModel, Model externalModel) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, commonTypes, rootModel, umlModel, sourceRefModel,
				externalModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingFFFFFFBB(
		...
		EObject _localVariable_4 = targetMatch.getObject("sourceRefModel");
				...
				if (tmpRootModel instanceof Model) {
					...
					if (tmpUmlModel instanceof Model) {
						...
						if (tmpSourceRefModel instanceof Model) {
							...
							if (tmpExternalModel instanceof Model) {
								Model externalModel = (Model) tmpExternalModel;
								return new Object[] { commonTypes, javaModel, rootModel, umlModel, sourceRefModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
			org.eclipse.uml2.uml.Package commonTypes, MGravityModel javaModel, Model rootModel, Model umlModel,
			Model sourceRefModel, Model externalModel, Match sourceMatch, Match targetMatch) {
		if (!commonTypes.equals(rootModel)) {
			if (!commonTypes.equals(umlModel)) {
				if (!commonTypes.equals(sourceRefModel)) {
					if (!commonTypes.equals(externalModel)) {
													...
													if (commonTypes_name.equals("Common Java datatypes")) {
														...
														if (rootModel_name.equals("root model")) {
															...
															if (sourceRefModel_name.equals("source references")) {
																...
																if (externalModel_name.equals("externals")) {
																	return new Object[] { commonTypes, javaModel,
																			rootModel, umlModel, sourceRefModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Model sourceRefModel = (Model) result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					commonTypes, javaModel, rootModel, umlModel, sourceRefModel, externalModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { commonTypes, javaModel, rootModel, umlModel, sourceRefModel, externalModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, org.eclipse.uml2.uml.Package commonTypes, MGravityModel javaModel,
			Model rootModel, Model umlModel, Model sourceRefModel, Model externalModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(commonTypes, javaModel, rootModel, umlModel,
				sourceRefModel, externalModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, commonTypes, javaModel, rootModel, umlModel, sourceRefModel,
					externalModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, commonTypes, javaModel, rootModel, umlModel, sourceRefModel, externalModel, sourceMatch,
				targetMatch);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(
			org.eclipse.uml2.uml.Package commonTypes, MGravityModel javaModel, Model rootModel, Model umlModel,
			Model sourceRefModel, Model externalModel, CCMatch ccMatch) {
		if (!commonTypes.equals(rootModel)) {
			if (!commonTypes.equals(umlModel)) {
				if (!commonTypes.equals(sourceRefModel)) {
					if (!commonTypes.equals(externalModel)) {
							...
							if (!rootModel.equals(sourceRefModel)) {
								if (!sourceRefModel.equals(umlModel)) {
									if (!externalModel.equals(rootModel)) {
										if (!externalModel.equals(umlModel)) {
											if (!externalModel.equals(sourceRefModel)) {
												return new Object[] { commonTypes, javaModel, rootModel, umlModel,
														sourceRefModel, externalModel, ccMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBBBFFBBFFB(
			org.eclipse.uml2.uml.Package commonTypes, MGravityModel javaModel, Model umlModel, Model sourceRefModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_greenBBBB(
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Model sourceRefModel, Model externalModel) {
		String commonTypes_name_prime = "Common Java datatypes";
		String rootModel_name_prime = "root model";
		String sourceRefModel_name_prime = "source references";
		String externalModel_name_prime = "externals";
		...
		sourceRefModel.setName(sourceRefModel_name_prime);
		externalModel.setName(externalModel_name_prime);
		return new Object[] { commonTypes, rootModel, sourceRefModel, externalModel };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(
		...
		return new Object[] { commonTypes, javaModel, rootModel, umlModel, jm2um2, jm2um3, sourceRefModel,
				externalModel, jm2um, jm2commonTypes, ruleResult, csp };
	}
