...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFFFFBFFFFFB(javaModel, csp);
		Model umlModel = (Model) result1_green[0];
		...
		Model externalModel = (Model) result1_green[3];
		JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result1_green[5];
		JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result1_green[6];
		Model sourceRefModel = (Model) result1_green[7];
		org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) result1_green[8];
		Model rootModel = (Model) result1_green[9];

		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(umlModel, jm2commonTypes,
						jm2um, externalModel, javaModel, jm2um3, jm2um2, sourceRefModel, commonTypes, rootModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[umlModel] = " + umlModel + ", "
					+ "[jm2commonTypes] = " + jm2commonTypes + ", " + "[jm2um] = " + jm2um + ", " + "[externalModel] = "
					+ externalModel + ", " + "[javaModel] = " + javaModel + ", " + "[jm2um3] = " + jm2um3 + ", "
					+ "[jm2um2] = " + jm2um2 + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[commonTypes] = "
					+ commonTypes + ", " + "[rootModel] = " + rootModel + ".");
		}
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(umlModel, jm2commonTypes,
						jm2um, externalModel, javaModel, jm2um3, jm2um2, sourceRefModel, commonTypes, rootModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, umlModel,
						jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2, sourceRefModel, commonTypes,
						rootModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[umlModel] = " + umlModel + ", " + "[jm2commonTypes] = " + jm2commonTypes + ", "
					+ "[jm2um] = " + jm2um + ", " + "[externalModel] = " + externalModel + ", " + "[javaModel] = "
					+ javaModel + ", " + "[jm2um3] = " + jm2um3 + ", " + "[jm2um2] = " + jm2um2 + ", "
		...
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, umlModel, jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2, sourceRefModel,
				commonTypes, rootModel);
		//nothing EMoflonEdge jm2um__umlModel____target = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge jm2um__javaModel____source = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge jm2commonTypes__javaModel____source = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge jm2um3__javaModel____source = (EMoflonEdge) result3_green[14];
		...
		//nothing EMoflonEdge umlModel__commonTypes____packagedElement = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge jm2um3__sourceRefModel____target = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge rootModel__sourceRefModel____packagedElement = (EMoflonEdge) result3_green[19];
		//nothing EMoflonEdge rootModel__externalModel____packagedElement = (EMoflonEdge) result3_green[20];
		//nothing EMoflonEdge rootModel__umlModel____packagedElement = (EMoflonEdge) result3_green[21];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject umlModel, EObject jm2commonTypes,
			EObject jm2um, EObject externalModel, EObject javaModel, EObject jm2um3, EObject jm2um2,
			EObject sourceRefModel, EObject commonTypes, EObject rootModel) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Model umlModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {

		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(this, match, umlModel, externalModel,
						sourceRefModel, commonTypes, rootModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[umlModel] = " + umlModel + ", " + "[externalModel] = "
					+ externalModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[commonTypes] = "
					+ commonTypes + ", " + "[rootModel] = " + rootModel + ".");
		}

		Object[] result2_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, umlModel,
						externalModel, sourceRefModel, commonTypes, rootModel);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[umlModel] = " + umlModel + ", " + "[externalModel] = "
					+ externalModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[commonTypes] = "
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
					this, match, umlModel, externalModel, sourceRefModel, commonTypes, rootModel);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Model rootModel = (Model) result1_bindingAndBlack[4];
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenBFFBFFFBBB(umlModel, externalModel,
						sourceRefModel, commonTypes, csp);
		JavaModel2UMLPackage jm2commonTypes = (JavaModel2UMLPackage) result1_green[1];
		JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result1_green[2];
		MGravityModel javaModel = (MGravityModel) result1_green[4];
		JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result1_green[5];
		JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result1_green[6];

		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(umlModel, jm2commonTypes,
						jm2um, externalModel, javaModel, jm2um3, jm2um2, sourceRefModel, commonTypes, rootModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[umlModel] = " + umlModel + ", "
					+ "[jm2commonTypes] = " + jm2commonTypes + ", " + "[jm2um] = " + jm2um + ", " + "[externalModel] = "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(umlModel,
						jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2, sourceRefModel, commonTypes,
						rootModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, umlModel,
						jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2, sourceRefModel, commonTypes,
						rootModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Model rootModel = (Model) result2_binding[4];
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_12_2_corematch_blackBBBBBB(umlModel, externalModel, sourceRefModel,
						commonTypes, rootModel, match)) {
			// ForEach 
			for (Object[] result3_black : JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_12_3_findcontext_blackBBBBB(umlModel, externalModel, sourceRefModel,
							commonTypes, rootModel)) {
				Object[] result3_green = JavaModel2UmlModelRuleImpl
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Model umlModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Model umlModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Model umlModel, Model externalModel,
			Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject umlModel, EObject jm2commonTypes,
			EObject jm2um, EObject externalModel, EObject javaModel, EObject jm2um3, EObject jm2um2,
			EObject sourceRefModel, EObject commonTypes, EObject rootModel) {
		ruleresult.registerObject("umlModel", umlModel);
		ruleresult.registerObject("jm2commonTypes", jm2commonTypes);
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_95(EMoflonEdge _edge_packagedElement) {
		...
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
			...
			Model rootModel = (Model) result2_black[4];
			Object[] result2_green = JavaModel2UmlModelRuleImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Model umlModel = (Model) result2_bindingAndBlack[0];
		...
		Model rootModel = (Model) result2_bindingAndBlack[5];

		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, umlModel, externalModel,
						javaModel, sourceRefModel, commonTypes, rootModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[umlModel] = " + umlModel + ", " + "[externalModel] = " + externalModel + ", " + "[javaModel] = "
					+ javaModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[commonTypes] = "
					+ commonTypes + ", " + "[rootModel] = " + rootModel + ", " + "[sourceMatch] = " + sourceMatch + ", "
					+ "[targetMatch] = " + targetMatch + ".");
		}
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(umlModel, externalModel,
								javaModel, sourceRefModel, commonTypes, rootModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[umlModel] = " + umlModel
							+ ", " + "[externalModel] = " + externalModel + ", " + "[javaModel] = " + javaModel + ", "
							+ "[sourceRefModel] = " + sourceRefModel + ", " + "[commonTypes] = " + commonTypes + ", "
							+ "[rootModel] = " + rootModel + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBFFBBFFBBB(
						umlModel, externalModel, javaModel, sourceRefModel, commonTypes, ccMatch);
				...
				//nothing JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result6_green[5];
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Model umlModel, Model externalModel, MGravityModel javaModel,
			Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Model umlModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {// 
		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_blackBBBBB(umlModel, externalModel, sourceRefModel,
						commonTypes, rootModel);
		if (result1_black != null) {
		...
		if (result2_black != null) {
			...
			if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(ruleResult,
						csp);
				//nothing Model umlModel = (Model) result6_green[0];
				//nothing JavaModel2UMLPackage jm2commonTypes = (JavaModel2UMLPackage) result6_green[1];
				//nothing JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result6_green[2];
				//nothing Model externalModel = (Model) result6_green[3];
				//nothing MGravityModel javaModel = (MGravityModel) result6_green[4];
				//nothing JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result6_green[5];
				//nothing JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result6_green[6];
				//nothing Model sourceRefModel = (Model) result6_green[7];
				//nothing org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) result6_green[8];
				//nothing Model rootModel = (Model) result6_green[9];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_95__EMOFLONEDGE:
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFFFFBFFFFFB(
		...
		return new Object[] { umlModel, jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2, sourceRefModel,
				commonTypes, rootModel, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			Model umlModel, JavaModel2UMLPackage jm2commonTypes, JavaModel2UMLPackage jm2um, Model externalModel,
			MGravityModel javaModel, JavaModel2UMLPackage jm2um3, JavaModel2UMLPackage jm2um2, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
															...
															if (!commonTypes.equals(rootModel)) {
																if (!rootModel.equals(umlModel)) {
																	if (!rootModel.equals(sourceRefModel)) {
																		return new Object[] { umlModel, jm2commonTypes,
																				jm2um, externalModel, javaModel, jm2um3,
																				jm2um2, sourceRefModel, commonTypes,
																				rootModel };
																	}
																}
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, umlModel, jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2,
				sourceRefModel, commonTypes, rootModel };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject umlModel, EObject jm2commonTypes, EObject jm2um,
			EObject externalModel, EObject javaModel, EObject jm2um3, EObject jm2um2, EObject sourceRefModel,
			EObject commonTypes, EObject rootModel) {
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, umlModel, jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2,
				sourceRefModel, commonTypes, rootModel, jm2um__umlModel____target, jm2um__javaModel____source,
				jm2commonTypes__javaModel____source, jm2um3__javaModel____source, jm2um2__javaModel____source,
				jm2um2__externalModel____target, umlModel__commonTypes____packagedElement,
				jm2um3__sourceRefModel____target, rootModel__sourceRefModel____packagedElement,
	...
	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject umlModel, EObject jm2commonTypes,
			EObject jm2um, EObject externalModel, EObject javaModel, EObject jm2um3, EObject jm2um2,
			EObject sourceRefModel, EObject commonTypes, EObject rootModel) {
		_this.registerObjects_FWD(ruleresult, umlModel, jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2,
				sourceRefModel, commonTypes, rootModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model umlModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(sourceRefModel)) {
				if (!externalModel.equals(rootModel)) {
							...
							if (!commonTypes.equals(externalModel)) {
								if (!commonTypes.equals(sourceRefModel)) {
									if (!commonTypes.equals(rootModel)) {
										if (!rootModel.equals(umlModel)) {
											if (!rootModel.equals(sourceRefModel)) {
												return new Object[] { _this, match, umlModel, externalModel,
														sourceRefModel, commonTypes, rootModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model umlModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, umlModel, externalModel, sourceRefModel,
				commonTypes, rootModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, umlModel, externalModel, sourceRefModel, commonTypes, rootModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding = pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, umlModel, externalModel, sourceRefModel, commonTypes, rootModel);
		if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, umlModel, externalModel, sourceRefModel, commonTypes,
						rootModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, Model umlModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(sourceRefModel)) {
				if (!externalModel.equals(rootModel)) {
							...
							if (!commonTypes.equals(externalModel)) {
								if (!commonTypes.equals(sourceRefModel)) {
									if (!commonTypes.equals(rootModel)) {
										if (!rootModel.equals(umlModel)) {
											if (!rootModel.equals(sourceRefModel)) {
												return new Object[] { match, umlModel, externalModel, sourceRefModel,
														commonTypes, rootModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		rootModel__externalModel____packagedElement.setName(rootModel__externalModel____packagedElement_name_prime);
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		return new Object[] { match, umlModel, externalModel, sourceRefModel, commonTypes, rootModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_5_collectcontextelements_blackBBBBBB(Match match,
			Model umlModel, Model externalModel, Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes,
			Model rootModel) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(sourceRefModel)) {
				if (!externalModel.equals(rootModel)) {
	...
	public static final void pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model umlModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		_this.registerObjectsToMatch_BWD(match, umlModel, externalModel, sourceRefModel, commonTypes, rootModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingFFFFFB(
		...
		EObject _localVariable_4 = isApplicableMatch.getObject("rootModel");
				...
				if (tmpSourceRefModel instanceof Model) {
					...
					if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
						...
						if (tmpRootModel instanceof Model) {
							...
							return new Object[] { umlModel, externalModel, sourceRefModel, commonTypes, rootModel,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(Model umlModel,
			Model externalModel, Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel,
			JavaModel2UmlModelRule _this, IsApplicableMatch isApplicableMatch) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(sourceRefModel)) {
				if (!externalModel.equals(rootModel)) {
										...
										if (!rootModel.equals(umlModel)) {
											if (!rootModel.equals(sourceRefModel)) {
												for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
													if (tmpCsp instanceof CSP) {
														CSP csp = (CSP) tmpCsp;
														return new Object[] { umlModel, externalModel, sourceRefModel,
																commonTypes, rootModel, csp, _this, isApplicableMatch };
													}
												}
											}
										}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding != null) {
			...
			Model rootModel = (Model) result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding[4];
			...
			Object[] result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black = pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
					umlModel, externalModel, sourceRefModel, commonTypes, rootModel, _this, isApplicableMatch);
			if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black != null) {
				...
				return new Object[] { umlModel, externalModel, sourceRefModel, commonTypes, rootModel, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenBFFBFFFBBB(
			Model umlModel, Model externalModel, Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes,
			CSP csp) {
		JavaModel2UMLPackage jm2commonTypes = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2um = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject jm2um, EObject externalModel, EObject javaModel, EObject jm2um3, EObject jm2um2,
			EObject sourceRefModel, EObject commonTypes, EObject rootModel) {
		_this.registerObjects_BWD(ruleresult, umlModel, jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2,
				sourceRefModel, commonTypes, rootModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_2_corematch_bindingFFFFFB(Match match) {
		...
		EObject _localVariable_4 = match.getObject("rootModel");
		EObject tmpUmlModel = _localVariable_0;
		EObject tmpExternalModel = _localVariable_1;
		EObject tmpSourceRefModel = _localVariable_2;
		EObject tmpCommonTypes = _localVariable_3;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(Model umlModel,
		...
		rootModel__externalModel____packagedElement.setName(rootModel__externalModel____packagedElement_name_prime);
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		return new Object[] { umlModel, externalModel, sourceRefModel, commonTypes, rootModel, isApplicableMatch,
				umlModel__commonTypes____packagedElement, rootModel__sourceRefModel____packagedElement,
				rootModel__externalModel____packagedElement, rootModel__umlModel____packagedElement };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
			...
			Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, umlModel, externalModel,
				sourceRefModel, commonTypes, rootModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlModel, externalModel, sourceRefModel, commonTypes,
					rootModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding = pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, umlModel, externalModel, sourceRefModel, commonTypes, rootModel);
		if (result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, umlModel, externalModel, sourceRefModel,
						commonTypes, rootModel };
			}
		}
		return null;
	...
	public static final boolean pattern_JavaModel2UmlModelRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model umlModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, umlModel, externalModel, sourceRefModel, commonTypes,
				rootModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingFFFFFFBB(
		...
		EObject _localVariable_0 = targetMatch.getObject("umlModel");
				...
				if (tmpJavaModel instanceof MGravityModel) {
					...
					if (tmpSourceRefModel instanceof Model) {
						...
						if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
							...
							if (tmpRootModel instanceof Model) {
								Model rootModel = (Model) tmpRootModel;
								return new Object[] { umlModel, externalModel, javaModel, sourceRefModel, commonTypes,
										rootModel, targetMatch, sourceMatch };
							}
						}
					}
				}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(Model umlModel,
			Model externalModel, MGravityModel javaModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Match sourceMatch, Match targetMatch) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(sourceRefModel)) {
				if (!externalModel.equals(rootModel)) {
					if (!sourceRefModel.equals(umlModel)) {
													...
													if (externalModel_name.equals("externals")) {
														...
														if (sourceRefModel_name.equals("source references")) {
															...
															if (commonTypes_name.equals("Common Java datatypes")) {
																String rootModel_name = rootModel.getName();
																if (rootModel_name.equals("root model")) {
																	return new Object[] { umlModel, externalModel,
																			javaModel, sourceRefModel, commonTypes,
																			rootModel, sourceMatch, targetMatch };
																}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			Model umlModel = (Model) result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding[0];
			...
			Model rootModel = (Model) result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					umlModel, externalModel, javaModel, sourceRefModel, commonTypes, rootModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { umlModel, externalModel, javaModel, sourceRefModel, commonTypes, rootModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, Model umlModel, Model externalModel, MGravityModel javaModel,
			Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(umlModel, externalModel, javaModel, sourceRefModel,
				commonTypes, rootModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, umlModel, externalModel, javaModel, sourceRefModel, commonTypes,
					rootModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, umlModel, externalModel, javaModel, sourceRefModel, commonTypes, rootModel, sourceMatch,
				targetMatch);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(Model umlModel,
			Model externalModel, MGravityModel javaModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel, CCMatch ccMatch) {
		if (!externalModel.equals(umlModel)) {
			if (!externalModel.equals(sourceRefModel)) {
				if (!externalModel.equals(rootModel)) {
					if (!sourceRefModel.equals(umlModel)) {
							...
							if (!commonTypes.equals(externalModel)) {
								if (!commonTypes.equals(sourceRefModel)) {
									if (!commonTypes.equals(rootModel)) {
										if (!rootModel.equals(umlModel)) {
											if (!rootModel.equals(sourceRefModel)) {
												return new Object[] { umlModel, externalModel, javaModel,
														sourceRefModel, commonTypes, rootModel, ccMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBFFBBFFBBB(
			Model umlModel, Model externalModel, MGravityModel javaModel, Model sourceRefModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_greenBBBB(Model externalModel,
		...
		commonTypes.setName(commonTypes_name_prime);
		rootModel.setName(rootModel_name_prime);
		return new Object[] { externalModel, sourceRefModel, commonTypes, rootModel };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(
		...
		return new Object[] { umlModel, jm2commonTypes, jm2um, externalModel, javaModel, jm2um3, jm2um2, sourceRefModel,
				commonTypes, rootModel, ruleResult, csp };
	}
