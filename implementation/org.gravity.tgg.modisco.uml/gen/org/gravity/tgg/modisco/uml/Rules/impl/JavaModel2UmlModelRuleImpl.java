...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result1_green[9];

		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(rootModel, jm2um2,
						externalModel, jm2um, javaModel, sourceRefModel, commonTypes, jm2commonTypes, umlModel, jm2um3);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[rootModel] = " + rootModel + ", "
					+ "[jm2um2] = " + jm2um2 + ", " + "[externalModel] = " + externalModel + ", " + "[jm2um] = " + jm2um
					+ ", " + "[javaModel] = " + javaModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", "
					+ "[commonTypes] = " + commonTypes + ", " + "[jm2commonTypes] = " + jm2commonTypes + ", "
					+ "[umlModel] = " + umlModel + ", " + "[jm2um3] = " + jm2um3 + ".");
		}
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(rootModel, jm2um2,
						externalModel, jm2um, javaModel, sourceRefModel, commonTypes, jm2commonTypes, umlModel, jm2um3);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, rootModel, jm2um2,
						externalModel, jm2um, javaModel, sourceRefModel, commonTypes, jm2commonTypes, umlModel, jm2um3);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[rootModel] = " + rootModel + ", " + "[jm2um2] = " + jm2um2 + ", " + "[externalModel] = "
					+ externalModel + ", " + "[jm2um] = " + jm2um + ", " + "[javaModel] = " + javaModel + ", "
					+ "[sourceRefModel] = " + sourceRefModel + ", " + "[commonTypes] = " + commonTypes + ", "
					+ "[jm2commonTypes] = " + jm2commonTypes + ", " + "[umlModel] = " + umlModel + ", " + "[jm2um3] = "
					+ jm2um3 + ".");
		}
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, rootModel, jm2um2, externalModel, jm2um, javaModel, sourceRefModel, commonTypes,
				jm2commonTypes, umlModel, jm2um3);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject rootModel, EObject jm2um2,
			EObject externalModel, EObject jm2um, EObject javaModel, EObject sourceRefModel, EObject commonTypes,
			EObject jm2commonTypes, EObject umlModel, EObject jm2um3) {
	...
	public boolean isAppropriate_BWD(Match match, Model rootModel, Model externalModel, Model sourceRefModel,
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
					this, match, rootModel, externalModel, sourceRefModel, commonTypes, umlModel);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFBFFBBFBFB(externalModel,
						sourceRefModel, commonTypes, umlModel, csp);
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(rootModel, jm2um2,
						externalModel, jm2um, javaModel, sourceRefModel, commonTypes, jm2commonTypes, umlModel, jm2um3);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[rootModel] = " + rootModel + ", "
					+ "[jm2um2] = " + jm2um2 + ", " + "[externalModel] = " + externalModel + ", " + "[jm2um] = " + jm2um
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(rootModel, jm2um2,
						externalModel, jm2um, javaModel, sourceRefModel, commonTypes, jm2commonTypes, umlModel, jm2um3);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, rootModel, jm2um2,
						externalModel, jm2um, javaModel, sourceRefModel, commonTypes, jm2commonTypes, umlModel, jm2um3);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[rootModel] = " + rootModel + ", " + "[jm2um2] = " + jm2um2 + ", " + "[externalModel] = "
			...
			for (Object[] result3_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result4_bindingAndBlack = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
								rootModel, externalModel, sourceRefModel, commonTypes, umlModel);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Model rootModel, Model externalModel,
			Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject rootModel, EObject jm2um2,
			EObject externalModel, EObject jm2um, EObject javaModel, EObject sourceRefModel, EObject commonTypes,
			EObject jm2commonTypes, EObject umlModel, EObject jm2um3) {
		ruleresult.registerObject("rootModel", rootModel);
		ruleresult.registerObject("jm2um2", jm2um2);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_262(EMoflonEdge _edge_packagedElement) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, rootModel, externalModel,
						javaModel, sourceRefModel, commonTypes, umlModel, sourceMatch, targetMatch);
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(rootModel, externalModel,
								javaModel, sourceRefModel, commonTypes, umlModel, ccMatch);
				if (result6_black == null) {
				...
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFBFBBBFBFB(
						externalModel, javaModel, sourceRefModel, commonTypes, umlModel, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Model rootModel, Model externalModel, MGravityModel javaModel,
			Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Model rootModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {// 
		Object[] result1_black = JavaModel2UmlModelRuleImpl
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer) {
		...
		if (result2_black != null) {
			...
			if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				//nothing JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result6_green[9];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_262__EMOFLONEDGE:
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFFFFBFFFFFB(
		...
		return new Object[] { rootModel, jm2um2, externalModel, jm2um, javaModel, sourceRefModel, commonTypes,
				jm2commonTypes, umlModel, jm2um3, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			Model rootModel, JavaModel2UMLPackage jm2um2, Model externalModel, JavaModel2UMLPackage jm2um,
			MGravityModel javaModel, Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes,
			JavaModel2UMLPackage jm2commonTypes, Model umlModel, JavaModel2UMLPackage jm2um3) {
															...
															if (!jm2commonTypes.equals(jm2um2)) {
																if (!jm2commonTypes.equals(jm2um)) {
																	if (!jm2commonTypes.equals(jm2um3)) {
																		return new Object[] { rootModel, jm2um2,
																				externalModel, jm2um, javaModel,
																				sourceRefModel, commonTypes,
																				jm2commonTypes, umlModel, jm2um3 };
																	}
																}
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, rootModel, jm2um2, externalModel, jm2um, javaModel, sourceRefModel,
				commonTypes, jm2commonTypes, umlModel, jm2um3 };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject rootModel, EObject jm2um2, EObject externalModel, EObject jm2um,
			EObject javaModel, EObject sourceRefModel, EObject commonTypes, EObject jm2commonTypes, EObject umlModel,
			EObject jm2um3) {
		if (!rootModel.equals(sourceRefModel)) {
			if (!rootModel.equals(umlModel)) {
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, rootModel, jm2um2, externalModel, jm2um, javaModel, sourceRefModel,
				commonTypes, jm2commonTypes, umlModel, jm2um3, rootModel__umlModel____packagedElement,
				jm2um2__externalModel____target, jm2um2__javaModel____source, jm2um__javaModel____source,
				rootModel__externalModel____packagedElement, jm2commonTypes__commonTypes____target,
				jm2commonTypes__javaModel____source, jm2um__umlModel____target,
				rootModel__sourceRefModel____packagedElement, umlModel__commonTypes____packagedElement,
				jm2um3__javaModel____source, jm2um3__sourceRefModel____target };
	}

	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject rootModel, EObject jm2um2,
			EObject externalModel, EObject jm2um, EObject javaModel, EObject sourceRefModel, EObject commonTypes,
			EObject jm2commonTypes, EObject umlModel, EObject jm2um3) {
		_this.registerObjects_FWD(ruleresult, rootModel, jm2um2, externalModel, jm2um, javaModel, sourceRefModel,
				commonTypes, jm2commonTypes, umlModel, jm2um3);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, rootModel, externalModel, sourceRefModel, commonTypes, umlModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding = pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, rootModel, externalModel, sourceRefModel, commonTypes, umlModel);
		if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, rootModel, externalModel, sourceRefModel, commonTypes,
						umlModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, Model rootModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		if (!rootModel.equals(sourceRefModel)) {
			if (!rootModel.equals(umlModel)) {
				if (!externalModel.equals(rootModel)) {
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		rootModel__sourceRefModel____packagedElement.setName(rootModel__sourceRefModel____packagedElement_name_prime);
		umlModel__commonTypes____packagedElement.setName(umlModel__commonTypes____packagedElement_name_prime);
		return new Object[] { match, rootModel, externalModel, sourceRefModel, commonTypes, umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_5_collectcontextelements_blackBBBBBB(Match match,
			Model rootModel, Model externalModel, Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes,
			Model umlModel) {
		if (!rootModel.equals(sourceRefModel)) {
			if (!rootModel.equals(umlModel)) {
				if (!externalModel.equals(rootModel)) {
	...
	public static final void pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model rootModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		_this.registerObjectsToMatch_BWD(match, rootModel, externalModel, sourceRefModel, commonTypes, umlModel);
				...
				if (tmpSourceRefModel instanceof Model) {
					...
					if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
						...
						if (tmpUmlModel instanceof Model) {
							...
							return new Object[] { rootModel, externalModel, sourceRefModel, commonTypes, umlModel,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black = pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
					rootModel, externalModel, sourceRefModel, commonTypes, umlModel, _this, isApplicableMatch);
			if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black != null) {
				...
				return new Object[] { rootModel, externalModel, sourceRefModel, commonTypes, umlModel, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFBFFBBFBFB(
			Model externalModel, Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel,
			CSP csp) {
		JavaModel2UMLPackage jm2um2 = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2um = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		...
		return new Object[] { jm2um2, externalModel, jm2um, javaModel, sourceRefModel, commonTypes, jm2commonTypes,
				umlModel, jm2um3, csp };
	}
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject externalModel, EObject jm2um, EObject javaModel, EObject sourceRefModel, EObject commonTypes,
			EObject jm2commonTypes, EObject umlModel, EObject jm2um3) {
		_this.registerObjects_BWD(ruleresult, rootModel, jm2um2, externalModel, jm2um, javaModel, sourceRefModel,
				commonTypes, jm2commonTypes, umlModel, jm2um3);
														...
														if (sourceRefModel_name.equals("source references")) {
															...
															if (commonTypes_name.equals("Common Java datatypes")) {
																_result.add(new Object[] { rootModel, externalModel,
																		sourceRefModel, commonTypes, umlModel, match });
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(Model rootModel,
		...
		rootModel__sourceRefModel____packagedElement.setName(rootModel__sourceRefModel____packagedElement_name_prime);
		umlModel__commonTypes____packagedElement.setName(umlModel__commonTypes____packagedElement_name_prime);
		return new Object[] { rootModel, externalModel, sourceRefModel, commonTypes, umlModel, isApplicableMatch,
				rootModel__umlModel____packagedElement, rootModel__externalModel____packagedElement,
				rootModel__sourceRefModel____packagedElement, umlModel__commonTypes____packagedElement };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
			...
			Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, rootModel, externalModel,
				sourceRefModel, commonTypes, umlModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, rootModel, externalModel, sourceRefModel, commonTypes,
					umlModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding = pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, rootModel, externalModel, sourceRefModel, commonTypes, umlModel);
		if (result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, rootModel, externalModel, sourceRefModel,
						commonTypes, umlModel };
			}
		}
		return null;
							...
							if (!sourceRefModel.equals(umlModel)) {
								if (!commonTypes.equals(rootModel)) {
									if (!commonTypes.equals(externalModel)) {
										if (!commonTypes.equals(sourceRefModel)) {
											if (!commonTypes.equals(umlModel)) {
												for (org.eclipse.uml2.uml.Package __DEC_rootModel_packagedElement_458715 : org.moflon.core.utilities.eMoflonEMFUtil
														.getOppositeReferenceTyped(rootModel,
																org.eclipse.uml2.uml.Package.class,
																"packagedElement")) {
													if (!rootModel.equals(__DEC_rootModel_packagedElement_458715)) {
														if (!externalModel
																.equals(__DEC_rootModel_packagedElement_458715)) {
															if (!sourceRefModel
																	.equals(__DEC_rootModel_packagedElement_458715)) {
																if (!commonTypes.equals(
																		__DEC_rootModel_packagedElement_458715)) {
																	if (!umlModel.equals(
																			__DEC_rootModel_packagedElement_458715)) {
	...
	public static final boolean pattern_JavaModel2UmlModelRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model rootModel, Model externalModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, rootModel, externalModel, sourceRefModel, commonTypes,
				umlModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpJavaModel instanceof MGravityModel) {
					...
					if (tmpSourceRefModel instanceof Model) {
						...
						if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
							...
							if (tmpUmlModel instanceof Model) {
								Model umlModel = (Model) tmpUmlModel;
								return new Object[] { rootModel, externalModel, javaModel, sourceRefModel, commonTypes,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					rootModel, externalModel, javaModel, sourceRefModel, commonTypes, umlModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { rootModel, externalModel, javaModel, sourceRefModel, commonTypes, umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, Model rootModel, Model externalModel, MGravityModel javaModel,
			Model sourceRefModel, org.eclipse.uml2.uml.Package commonTypes, Model umlModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(rootModel, externalModel, javaModel, sourceRefModel,
				commonTypes, umlModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, rootModel, externalModel, javaModel, sourceRefModel, commonTypes,
					umlModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, rootModel, externalModel, javaModel, sourceRefModel, commonTypes, umlModel, sourceMatch,
				targetMatch);
							...
							if (!sourceRefModel.equals(umlModel)) {
								if (!commonTypes.equals(rootModel)) {
									if (!commonTypes.equals(externalModel)) {
										if (!commonTypes.equals(sourceRefModel)) {
											if (!commonTypes.equals(umlModel)) {
												return new Object[] { rootModel, externalModel, javaModel,
														sourceRefModel, commonTypes, umlModel, ccMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFBFBBBFBFB(
			Model externalModel, MGravityModel javaModel, Model sourceRefModel,
			org.eclipse.uml2.uml.Package commonTypes, Model umlModel, CCMatch ccMatch) {
		JavaModel2UMLPackage jm2um2 = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2um = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
							...
							if (!sourceRefModel.equals(umlModel)) {
								if (!commonTypes.equals(rootModel)) {
									if (!commonTypes.equals(externalModel)) {
										if (!commonTypes.equals(sourceRefModel)) {
											if (!commonTypes.equals(umlModel)) {
												for (org.eclipse.uml2.uml.Package __DEC_rootModel_packagedElement_184291 : org.moflon.core.utilities.eMoflonEMFUtil
														.getOppositeReferenceTyped(rootModel,
																org.eclipse.uml2.uml.Package.class,
																"packagedElement")) {
													if (!rootModel.equals(__DEC_rootModel_packagedElement_184291)) {
														if (!externalModel
																.equals(__DEC_rootModel_packagedElement_184291)) {
															if (!sourceRefModel
																	.equals(__DEC_rootModel_packagedElement_184291)) {
																if (!commonTypes.equals(
																		__DEC_rootModel_packagedElement_184291)) {
																	if (!umlModel.equals(
																			__DEC_rootModel_packagedElement_184291)) {
																		return new Object[] { rootModel, externalModel,
																				sourceRefModel, commonTypes, umlModel };
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(
		...
		return new Object[] { rootModel, jm2um2, externalModel, jm2um, javaModel, sourceRefModel, commonTypes,
				jm2commonTypes, umlModel, jm2um3, ruleResult, csp };
	}
