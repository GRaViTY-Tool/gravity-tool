...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFFFFFFFFFBB(javaModel, csp);
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(jm2um, jm2um2,
						sourceRefModel, umlModel, jm2commonTypes, rootModel, commonTypes, jm2um3, externalModel,
						javaModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jm2um] = " + jm2um + ", "
					+ "[jm2um2] = " + jm2um2 + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[umlModel] = "
					+ umlModel + ", " + "[jm2commonTypes] = " + jm2commonTypes + ", " + "[rootModel] = " + rootModel
					+ ", " + "[commonTypes] = " + commonTypes + ", " + "[jm2um3] = " + jm2um3 + ", "
					+ "[externalModel] = " + externalModel + ", " + "[javaModel] = " + javaModel + ".");
		}
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(jm2um, jm2um2,
						sourceRefModel, umlModel, jm2commonTypes, rootModel, commonTypes, jm2um3, externalModel,
						javaModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, jm2um, jm2um2,
						sourceRefModel, umlModel, jm2commonTypes, rootModel, commonTypes, jm2um3, externalModel,
						javaModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[jm2um] = " + jm2um + ", " + "[jm2um2] = " + jm2um2 + ", " + "[sourceRefModel] = "
					+ sourceRefModel + ", " + "[umlModel] = " + umlModel + ", " + "[jm2commonTypes] = " + jm2commonTypes
					+ ", " + "[rootModel] = " + rootModel + ", " + "[commonTypes] = " + commonTypes + ", "
					+ "[jm2um3] = " + jm2um3 + ", " + "[externalModel] = " + externalModel + ", " + "[javaModel] = "
					+ javaModel + ".");
		}
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, jm2um, jm2um2, sourceRefModel, umlModel, jm2commonTypes, rootModel, commonTypes, jm2um3,
				externalModel, javaModel);
		...
		//nothing EMoflonEdge jm2um3__javaModel____source = (EMoflonEdge) result3_green[19];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject jm2um, EObject jm2um2, EObject sourceRefModel,
			EObject umlModel, EObject jm2commonTypes, EObject rootModel, EObject commonTypes, EObject jm2um3,
			EObject externalModel, EObject javaModel) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Model sourceRefModel, Model umlModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {

		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(this, match, sourceRefModel, umlModel,
						rootModel, commonTypes, externalModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[umlModel] = "
		...
		Object[] result2_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, sourceRefModel,
						umlModel, rootModel, commonTypes, externalModel);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[umlModel] = "
					+ umlModel + ", " + "[rootModel] = " + rootModel + ", " + "[commonTypes] = " + commonTypes + ", "
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(match,
							sourceRefModel, umlModel, rootModel, commonTypes, externalModel);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
			...
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
					this, match, sourceRefModel, umlModel, rootModel, commonTypes, externalModel);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFFBBFBFBFB(sourceRefModel, umlModel,
						commonTypes, externalModel, csp);
		JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result1_green[0];
		JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result1_green[1];
		JavaModel2UMLPackage jm2commonTypes = (JavaModel2UMLPackage) result1_green[4];
		JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result1_green[6];
		MGravityModel javaModel = (MGravityModel) result1_green[8];

		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(jm2um, jm2um2,
						sourceRefModel, umlModel, jm2commonTypes, rootModel, commonTypes, jm2um3, externalModel,
						javaModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jm2um] = " + jm2um + ", "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(jm2um, jm2um2,
						sourceRefModel, umlModel, jm2commonTypes, rootModel, commonTypes, jm2um3, externalModel,
						javaModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, jm2um, jm2um2,
						sourceRefModel, umlModel, jm2commonTypes, rootModel, commonTypes, jm2um3, externalModel,
						javaModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_12_2_corematch_blackBBBBBB(sourceRefModel, umlModel, rootModel,
						commonTypes, externalModel, match)) {
			// ForEach 
			for (Object[] result3_black : JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_12_3_findcontext_blackBBBBB(sourceRefModel, umlModel, rootModel,
							commonTypes, externalModel)) {
				Object[] result3_green = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(sourceRefModel, umlModel,
								rootModel, commonTypes, externalModel);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ sourceRefModel + ", " + "[umlModel] = " + umlModel + ", " + "[rootModel] = " + rootModel
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Model sourceRefModel, Model umlModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Model sourceRefModel, Model umlModel, Model rootModel,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Model sourceRefModel, Model umlModel,
			Model rootModel, org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject jm2um, EObject jm2um2, EObject sourceRefModel,
			EObject umlModel, EObject jm2commonTypes, EObject rootModel, EObject commonTypes, EObject jm2um3,
			EObject externalModel, EObject javaModel) {
		ruleresult.registerObject("jm2um", jm2um);
		ruleresult.registerObject("jm2um2", jm2um2);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, sourceRefModel, umlModel,
						rootModel, commonTypes, externalModel, javaModel, sourceMatch, targetMatch);
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(sourceRefModel, umlModel,
								rootModel, commonTypes, externalModel, javaModel, ccMatch);
				if (result6_black == null) {
				...
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFFBBFBFBBB(
						sourceRefModel, umlModel, commonTypes, externalModel, javaModel, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Model sourceRefModel, Model umlModel, Model rootModel,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Model sourceRefModel, Model umlModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {// 
		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_blackBBBBB(sourceRefModel, umlModel, rootModel,
						commonTypes, externalModel);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer) {
		...
		if (result2_black != null) {
			...
			if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				//nothing MGravityModel javaModel = (MGravityModel) result6_green[9];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_135__EMOFLONEDGE:
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFFFFFFFFFBB(
		...
		return new Object[] { jm2um, jm2um2, sourceRefModel, umlModel, jm2commonTypes, rootModel, commonTypes, jm2um3,
				externalModel, javaModel, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			JavaModel2UMLPackage jm2um, JavaModel2UMLPackage jm2um2, Model sourceRefModel, Model umlModel,
			JavaModel2UMLPackage jm2commonTypes, Model rootModel, org.eclipse.uml2.uml.Package commonTypes,
			JavaModel2UMLPackage jm2um3, Model externalModel, MGravityModel javaModel) {
															...
															if (!externalModel.equals(sourceRefModel)) {
																if (!externalModel.equals(umlModel)) {
																	if (!externalModel.equals(rootModel)) {
																		return new Object[] { jm2um, jm2um2,
																				sourceRefModel, umlModel,
																				jm2commonTypes, rootModel, commonTypes,
																				jm2um3, externalModel, javaModel };
																	}
																}
															}
														}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, jm2um, jm2um2, sourceRefModel, umlModel, jm2commonTypes, rootModel,
				commonTypes, jm2um3, externalModel, javaModel };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject jm2um, EObject jm2um2, EObject sourceRefModel, EObject umlModel,
			EObject jm2commonTypes, EObject rootModel, EObject commonTypes, EObject jm2um3, EObject externalModel,
			EObject javaModel) {
		if (!jm2um.equals(jm2um2)) {
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, jm2um, jm2um2, sourceRefModel, umlModel, jm2commonTypes, rootModel,
				commonTypes, jm2um3, externalModel, javaModel, jm2um__umlModel____target,
				...
				rootModel__umlModel____packagedElement, jm2um3__javaModel____source, jm2um__javaModel____source,
				jm2commonTypes__javaModel____source, jm2um2__javaModel____source };
	}

	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject jm2um, EObject jm2um2,
			EObject sourceRefModel, EObject umlModel, EObject jm2commonTypes, EObject rootModel, EObject commonTypes,
			EObject jm2um3, EObject externalModel, EObject javaModel) {
		_this.registerObjects_FWD(ruleresult, jm2um, jm2um2, sourceRefModel, umlModel, jm2commonTypes, rootModel,
				commonTypes, jm2um3, externalModel, javaModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model umlModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(sourceRefModel)) {
				if (!rootModel.equals(umlModel)) {
							...
							if (!commonTypes.equals(rootModel)) {
								if (!commonTypes.equals(externalModel)) {
									if (!externalModel.equals(sourceRefModel)) {
										if (!externalModel.equals(umlModel)) {
											if (!externalModel.equals(rootModel)) {
												return new Object[] { _this, match, sourceRefModel, umlModel, rootModel,
														commonTypes, externalModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model umlModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, sourceRefModel, umlModel, rootModel, commonTypes,
				externalModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, sourceRefModel, umlModel, rootModel, commonTypes, externalModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding = pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, sourceRefModel, umlModel, rootModel, commonTypes, externalModel);
		if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, sourceRefModel, umlModel, rootModel, commonTypes,
						externalModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, Model sourceRefModel, Model umlModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(sourceRefModel)) {
				if (!rootModel.equals(umlModel)) {
							...
							if (!commonTypes.equals(rootModel)) {
								if (!commonTypes.equals(externalModel)) {
									if (!externalModel.equals(sourceRefModel)) {
										if (!externalModel.equals(umlModel)) {
											if (!externalModel.equals(rootModel)) {
												return new Object[] { match, sourceRefModel, umlModel, rootModel,
														commonTypes, externalModel };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		rootModel__sourceRefModel____packagedElement.setName(rootModel__sourceRefModel____packagedElement_name_prime);
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		return new Object[] { match, sourceRefModel, umlModel, rootModel, commonTypes, externalModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_5_collectcontextelements_blackBBBBBB(Match match,
			Model sourceRefModel, Model umlModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes,
			Model externalModel) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(sourceRefModel)) {
				if (!rootModel.equals(umlModel)) {
	...
	public static final void pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model umlModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {
		_this.registerObjectsToMatch_BWD(match, sourceRefModel, umlModel, rootModel, commonTypes, externalModel);
				...
				if (tmpRootModel instanceof Model) {
					...
					if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
						...
						if (tmpExternalModel instanceof Model) {
							...
							return new Object[] { sourceRefModel, umlModel, rootModel, commonTypes, externalModel,
									isApplicableMatch };
						}
					}
				}
										...
										if (!externalModel.equals(umlModel)) {
											if (!externalModel.equals(rootModel)) {
												for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
													if (tmpCsp instanceof CSP) {
														CSP csp = (CSP) tmpCsp;
														return new Object[] { sourceRefModel, umlModel, rootModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black = pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
					sourceRefModel, umlModel, rootModel, commonTypes, externalModel, _this, isApplicableMatch);
			if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black != null) {
				...
				return new Object[] { sourceRefModel, umlModel, rootModel, commonTypes, externalModel, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFFBBFBFBFB(
		...
		return new Object[] { jm2um, jm2um2, sourceRefModel, umlModel, jm2commonTypes, commonTypes, jm2um3,
				externalModel, javaModel, csp };
	}
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject sourceRefModel, EObject umlModel, EObject jm2commonTypes, EObject rootModel, EObject commonTypes,
			EObject jm2um3, EObject externalModel, EObject javaModel) {
		_this.registerObjects_BWD(ruleresult, jm2um, jm2um2, sourceRefModel, umlModel, jm2commonTypes, rootModel,
				commonTypes, jm2um3, externalModel, javaModel);
													...
													if (rootModel_name.equals("root model")) {
														...
														if (commonTypes_name.equals("Common Java datatypes")) {
															...
															if (externalModel_name.equals("externals")) {
																_result.add(new Object[] { sourceRefModel, umlModel,
																		rootModel, commonTypes, externalModel, match });
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(Model sourceRefModel,
			Model umlModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		EMoflonEdge umlModel__commonTypes____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge rootModel__externalModel____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge rootModel__sourceRefModel____packagedElement = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		rootModel__sourceRefModel____packagedElement.setName(rootModel__sourceRefModel____packagedElement_name_prime);
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		return new Object[] { sourceRefModel, umlModel, rootModel, commonTypes, externalModel, isApplicableMatch,
				umlModel__commonTypes____packagedElement, rootModel__externalModel____packagedElement,
				rootModel__sourceRefModel____packagedElement, rootModel__umlModel____packagedElement };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, IsApplicableMatch isApplicableMatch, Model sourceRefModel, Model umlModel,
			Model rootModel, org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, sourceRefModel, umlModel, rootModel,
				commonTypes, externalModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, sourceRefModel, umlModel, rootModel, commonTypes,
					externalModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding = pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, sourceRefModel, umlModel, rootModel, commonTypes, externalModel);
	...
	public static final boolean pattern_JavaModel2UmlModelRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model umlModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model externalModel) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, sourceRefModel, umlModel, rootModel, commonTypes,
				externalModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
			Model sourceRefModel, Model umlModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes,
			Model externalModel, MGravityModel javaModel, Match sourceMatch, Match targetMatch) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(sourceRefModel)) {
				if (!rootModel.equals(umlModel)) {
					if (!commonTypes.equals(sourceRefModel)) {
													...
													if (sourceRefModel_name.equals("source references")) {
														...
														if (rootModel_name.equals("root model")) {
															...
															if (commonTypes_name.equals("Common Java datatypes")) {
																String externalModel_name = externalModel.getName();
																if (externalModel_name.equals("externals")) {
																	return new Object[] { sourceRefModel, umlModel,
																			rootModel, commonTypes, externalModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					sourceRefModel, umlModel, rootModel, commonTypes, externalModel, javaModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { sourceRefModel, umlModel, rootModel, commonTypes, externalModel, javaModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, Model sourceRefModel, Model umlModel, Model rootModel,
			org.eclipse.uml2.uml.Package commonTypes, Model externalModel, MGravityModel javaModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(sourceRefModel, umlModel, rootModel, commonTypes,
				externalModel, javaModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, sourceRefModel, umlModel, rootModel, commonTypes, externalModel,
					javaModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, sourceRefModel, umlModel, rootModel, commonTypes, externalModel, javaModel, sourceMatch,
				targetMatch);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(
			Model sourceRefModel, Model umlModel, Model rootModel, org.eclipse.uml2.uml.Package commonTypes,
			Model externalModel, MGravityModel javaModel, CCMatch ccMatch) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(sourceRefModel)) {
				if (!rootModel.equals(umlModel)) {
					if (!commonTypes.equals(sourceRefModel)) {
							...
							if (!commonTypes.equals(rootModel)) {
								if (!commonTypes.equals(externalModel)) {
									if (!externalModel.equals(sourceRefModel)) {
										if (!externalModel.equals(umlModel)) {
											if (!externalModel.equals(rootModel)) {
												return new Object[] { sourceRefModel, umlModel, rootModel, commonTypes,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFFBBFBFBBB(
			Model sourceRefModel, Model umlModel, org.eclipse.uml2.uml.Package commonTypes, Model externalModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_greenBBBB(Model sourceRefModel,
		...
		commonTypes.setName(commonTypes_name_prime);
		externalModel.setName(externalModel_name_prime);
		return new Object[] { sourceRefModel, rootModel, commonTypes, externalModel };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(
		...
		return new Object[] { jm2um, jm2um2, sourceRefModel, umlModel, jm2commonTypes, rootModel, commonTypes, jm2um3,
				externalModel, javaModel, ruleResult, csp };
	}
