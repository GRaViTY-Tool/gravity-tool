...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(commonTypes, jm2um3,
						sourceRefModel, jm2commonTypes, externalModel, jm2um2, rootModel, jm2um, javaModel, umlModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[commonTypes] = " + commonTypes
					...
					+ "[jm2um2] = " + jm2um2 + ", " + "[rootModel] = " + rootModel + ", " + "[jm2um] = " + jm2um + ", "
					+ "[javaModel] = " + javaModel + ", " + "[umlModel] = " + umlModel + ".");
		}
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(commonTypes, jm2um3,
						sourceRefModel, jm2commonTypes, externalModel, jm2um2, rootModel, jm2um, javaModel, umlModel);
		...
		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, commonTypes,
						jm2um3, sourceRefModel, jm2commonTypes, externalModel, jm2um2, rootModel, jm2um, javaModel,
						umlModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[commonTypes] = " + commonTypes + ", " + "[jm2um3] = " + jm2um3 + ", "
					+ "[sourceRefModel] = " + sourceRefModel + ", " + "[jm2commonTypes] = " + jm2commonTypes + ", "
					+ "[externalModel] = " + externalModel + ", " + "[jm2um2] = " + jm2um2 + ", " + "[rootModel] = "
					+ rootModel + ", " + "[jm2um] = " + jm2um + ", " + "[javaModel] = " + javaModel + ", "
					+ "[umlModel] = " + umlModel + ".");
		}
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, commonTypes, jm2um3, sourceRefModel, jm2commonTypes, externalModel, jm2um2, rootModel,
				jm2um, javaModel, umlModel);
		...
		//nothing EMoflonEdge jm2um2__externalModel____target = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge rootModel__umlModel____packagedElement = (EMoflonEdge) result3_green[14];
		//nothing EMoflonEdge rootModel__sourceRefModel____packagedElement = (EMoflonEdge) result3_green[15];
		//nothing EMoflonEdge rootModel__externalModel____packagedElement = (EMoflonEdge) result3_green[16];
		...
		//nothing EMoflonEdge jm2um__umlModel____target = (EMoflonEdge) result3_green[21];
		//nothing EMoflonEdge umlModel__commonTypes____packagedElement = (EMoflonEdge) result3_green[22];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject commonTypes, EObject jm2um3,
			EObject sourceRefModel, EObject jm2commonTypes, EObject externalModel, EObject jm2um2, EObject rootModel,
			EObject jm2um, EObject javaModel, EObject umlModel) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenBFBFBFFFBB(commonTypes, sourceRefModel,
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(commonTypes, jm2um3,
						sourceRefModel, jm2commonTypes, externalModel, jm2um2, rootModel, jm2um, javaModel, umlModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[commonTypes] = " + commonTypes
					+ ", " + "[jm2um3] = " + jm2um3 + ", " + "[sourceRefModel] = " + sourceRefModel + ", "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(commonTypes, jm2um3,
						sourceRefModel, jm2commonTypes, externalModel, jm2um2, rootModel, jm2um, javaModel, umlModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject commonTypes, EObject jm2um3,
			EObject sourceRefModel, EObject jm2commonTypes, EObject externalModel, EObject jm2um2, EObject rootModel,
			EObject jm2um, EObject javaModel, EObject umlModel) {
		ruleresult.registerObject("commonTypes", commonTypes);
		ruleresult.registerObject("jm2um3", jm2um3);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, commonTypes,
						sourceRefModel, externalModel, rootModel, javaModel, umlModel, sourceMatch, targetMatch);
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(commonTypes,
								sourceRefModel, externalModel, rootModel, javaModel, umlModel, ccMatch);
				if (result6_black == null) {
				...
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBFBFBFFBBB(
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Package commonTypes, Model sourceRefModel,
			Model externalModel, Model rootModel, MGravityModel javaModel, Model umlModel, Match sourceMatch,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFFFFFFFFBFB(
		...
		return new Object[] { commonTypes, jm2um3, sourceRefModel, jm2commonTypes, externalModel, jm2um2, rootModel,
				jm2um, javaModel, umlModel, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			org.eclipse.uml2.uml.Package commonTypes, JavaModel2UMLPackage jm2um3, Model sourceRefModel,
			JavaModel2UMLPackage jm2commonTypes, Model externalModel, JavaModel2UMLPackage jm2um2, Model rootModel,
			JavaModel2UMLPackage jm2um, MGravityModel javaModel, Model umlModel) {
															...
															if (!rootModel.equals(umlModel)) {
																if (!jm2um.equals(jm2um3)) {
																	if (!jm2um.equals(jm2um2)) {
																		return new Object[] { commonTypes, jm2um3,
																				sourceRefModel, jm2commonTypes,
																				externalModel, jm2um2, rootModel, jm2um,
																				javaModel, umlModel };
																	}
																}
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, commonTypes, jm2um3, sourceRefModel, jm2commonTypes, externalModel, jm2um2,
				rootModel, jm2um, javaModel, umlModel };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject commonTypes, EObject jm2um3, EObject sourceRefModel,
			EObject jm2commonTypes, EObject externalModel, EObject jm2um2, EObject rootModel, EObject jm2um,
			EObject javaModel, EObject umlModel) {
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, commonTypes, jm2um3, sourceRefModel, jm2commonTypes, externalModel, jm2um2,
				rootModel, jm2um, javaModel, umlModel, jm2commonTypes__commonTypes____target,
				...
				rootModel__externalModel____packagedElement, jm2commonTypes__javaModel____source,
				jm2um3__javaModel____source, jm2um2__javaModel____source, jm2um__javaModel____source,
				jm2um__umlModel____target, umlModel__commonTypes____packagedElement };
	}

	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject commonTypes, EObject jm2um3,
			EObject sourceRefModel, EObject jm2commonTypes, EObject externalModel, EObject jm2um2, EObject rootModel,
			EObject jm2um, EObject javaModel, EObject umlModel) {
		_this.registerObjects_FWD(ruleresult, commonTypes, jm2um3, sourceRefModel, jm2commonTypes, externalModel,
				jm2um2, rootModel, jm2um, javaModel, umlModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenBFBFBFFFBB(
		...
		return new Object[] { commonTypes, jm2um3, sourceRefModel, jm2commonTypes, externalModel, jm2um2, jm2um,
				javaModel, umlModel, csp };
	}
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject sourceRefModel, EObject jm2commonTypes, EObject externalModel, EObject jm2um2, EObject rootModel,
			EObject jm2um, EObject javaModel, EObject umlModel) {
		_this.registerObjects_BWD(ruleresult, commonTypes, jm2um3, sourceRefModel, jm2commonTypes, externalModel,
				jm2um2, rootModel, jm2um, javaModel, umlModel);
				...
				if (tmpExternalModel instanceof Model) {
					...
					if (tmpRootModel instanceof Model) {
						...
						if (tmpJavaModel instanceof MGravityModel) {
							...
							if (tmpUmlModel instanceof Model) {
								Model umlModel = (Model) tmpUmlModel;
								return new Object[] { commonTypes, sourceRefModel, externalModel, rootModel, javaModel,
													...
													if (commonTypes_name.equals("Common Java datatypes")) {
														...
														if (sourceRefModel_name.equals("source references")) {
															...
															if (externalModel_name.equals("externals")) {
																...
																if (rootModel_name.equals("root model")) {
																	return new Object[] { commonTypes, sourceRefModel,
																			externalModel, rootModel, javaModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					commonTypes, sourceRefModel, externalModel, rootModel, javaModel, umlModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { commonTypes, sourceRefModel, externalModel, rootModel, javaModel, umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			...
			Model externalModel, Model rootModel, MGravityModel javaModel, Model umlModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(commonTypes, sourceRefModel, externalModel, rootModel,
				javaModel, umlModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, commonTypes, sourceRefModel, externalModel, rootModel, javaModel,
					umlModel, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, commonTypes, sourceRefModel, externalModel, rootModel, javaModel, umlModel, sourceMatch,
				targetMatch);
							...
							if (!externalModel.equals(sourceRefModel)) {
								if (!externalModel.equals(rootModel)) {
									if (!externalModel.equals(umlModel)) {
										if (!rootModel.equals(sourceRefModel)) {
											if (!rootModel.equals(umlModel)) {
												return new Object[] { commonTypes, sourceRefModel, externalModel,
														rootModel, javaModel, umlModel, ccMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenBFBFBFFBBB(
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(
		...
		return new Object[] { commonTypes, jm2um3, sourceRefModel, jm2commonTypes, externalModel, jm2um2, rootModel,
				jm2um, javaModel, umlModel, ruleResult, csp };
	}
