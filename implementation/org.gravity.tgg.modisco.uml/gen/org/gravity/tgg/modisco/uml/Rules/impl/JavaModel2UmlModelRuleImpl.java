...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Model umlModel = (Model) result1_green[3];
		JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result1_green[4];
		Model sourceRefModel = (Model) result1_green[5];
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(jm2commonTypes, jm2um,
						jm2um2, umlModel, jm2um3, sourceRefModel, rootModel, externalModel, javaModel, commonTypes);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jm2commonTypes] = "
					+ jm2commonTypes + ", " + "[jm2um] = " + jm2um + ", " + "[jm2um2] = " + jm2um2 + ", "
					+ "[umlModel] = " + umlModel + ", " + "[jm2um3] = " + jm2um3 + ", " + "[sourceRefModel] = "
					+ sourceRefModel + ", " + "[rootModel] = " + rootModel + ", " + "[externalModel] = " + externalModel
					+ ", " + "[javaModel] = " + javaModel + ", " + "[commonTypes] = " + commonTypes + ".");
		}
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(jm2commonTypes, jm2um,
						jm2um2, umlModel, jm2um3, sourceRefModel, rootModel, externalModel, javaModel, commonTypes);
		...
		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, jm2commonTypes,
						jm2um, jm2um2, umlModel, jm2um3, sourceRefModel, rootModel, externalModel, javaModel,
						commonTypes);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[jm2commonTypes] = " + jm2commonTypes + ", " + "[jm2um] = " + jm2um + ", " + "[jm2um2] = "
		...
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, jm2commonTypes, jm2um, jm2um2, umlModel, jm2um3, sourceRefModel, rootModel, externalModel,
				javaModel, commonTypes);
		//nothing EMoflonEdge jm2um__umlModel____target = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge jm2um3__sourceRefModel____target = (EMoflonEdge) result3_green[12];
		//nothing EMoflonEdge rootModel__sourceRefModel____packagedElement = (EMoflonEdge) result3_green[13];
		//nothing EMoflonEdge umlModel__commonTypes____packagedElement = (EMoflonEdge) result3_green[14];
		//nothing EMoflonEdge rootModel__umlModel____packagedElement = (EMoflonEdge) result3_green[15];
		...
		//nothing EMoflonEdge jm2um3__javaModel____source = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge jm2commonTypes__javaModel____source = (EMoflonEdge) result3_green[19];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject jm2commonTypes, EObject jm2um, EObject jm2um2,
			EObject umlModel, EObject jm2um3, EObject sourceRefModel, EObject rootModel, EObject externalModel,
			EObject javaModel, EObject commonTypes) {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, Model umlModel, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes) {

		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(this, match, umlModel, sourceRefModel,
						rootModel, externalModel, commonTypes);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[umlModel] = " + umlModel + ", " + "[sourceRefModel] = "
					+ sourceRefModel + ", " + "[rootModel] = " + rootModel + ", " + "[externalModel] = " + externalModel
					+ ", " + "[commonTypes] = " + commonTypes + ".");
		}
		...
		Object[] result2_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(this, match, umlModel,
						sourceRefModel, rootModel, externalModel, commonTypes);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[umlModel] = " + umlModel + ", " + "[sourceRefModel] = "
					+ sourceRefModel + ", " + "[rootModel] = " + rootModel + ", " + "[externalModel] = " + externalModel
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
					this, match, umlModel, sourceRefModel, rootModel, externalModel, commonTypes);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Model sourceRefModel = (Model) result1_bindingAndBlack[1];
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFFFBFBBFBB(umlModel, sourceRefModel,
						externalModel, commonTypes, csp);
		JavaModel2UMLPackage jm2commonTypes = (JavaModel2UMLPackage) result1_green[0];
		JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result1_green[1];
		JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result1_green[2];
		JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result1_green[4];
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(jm2commonTypes, jm2um,
						jm2um2, umlModel, jm2um3, sourceRefModel, rootModel, externalModel, javaModel, commonTypes);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jm2commonTypes] = "
					+ jm2commonTypes + ", " + "[jm2um] = " + jm2um + ", " + "[jm2um2] = " + jm2um2 + ", "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(jm2commonTypes, jm2um,
						jm2um2, umlModel, jm2um3, sourceRefModel, rootModel, externalModel, javaModel, commonTypes);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Model sourceRefModel = (Model) result2_binding[1];
		...
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_12_2_corematch_blackBBBBBB(umlModel, sourceRefModel, rootModel,
						externalModel, commonTypes, match)) {
			// ForEach 
			for (Object[] result3_black : JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_12_3_findcontext_blackBBBBB(umlModel, sourceRefModel, rootModel,
							externalModel, commonTypes)) {
				Object[] result3_green = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(umlModel, sourceRefModel,
								rootModel, externalModel, commonTypes);
				...
				Object[] result4_bindingAndBlack = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
								umlModel, sourceRefModel, rootModel, externalModel, commonTypes);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[umlModel] = " + umlModel + ", "
							+ "[sourceRefModel] = " + sourceRefModel + ", " + "[rootModel] = " + rootModel + ", "
							+ "[externalModel] = " + externalModel + ", " + "[commonTypes] = " + commonTypes + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, Model umlModel, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, Model umlModel, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Model umlModel, Model sourceRefModel,
			Model rootModel, Model externalModel, org.eclipse.uml2.uml.Package commonTypes) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject jm2commonTypes, EObject jm2um, EObject jm2um2,
			EObject umlModel, EObject jm2um3, EObject sourceRefModel, EObject rootModel, EObject externalModel,
			EObject javaModel, EObject commonTypes) {
		ruleresult.registerObject("jm2commonTypes", jm2commonTypes);
		ruleresult.registerObject("jm2um", jm2um);
	...
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_130(EMoflonEdge _edge_packagedElement) {
		...
		for (Object[] result2_black : JavaModel2UmlModelRuleImpl
			...
			Model sourceRefModel = (Model) result2_black[1];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Model sourceRefModel = (Model) result2_bindingAndBlack[1];
		Model rootModel = (Model) result2_bindingAndBlack[2];
		Model externalModel = (Model) result2_bindingAndBlack[3];
		...
		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, umlModel, sourceRefModel,
						rootModel, externalModel, javaModel, commonTypes, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[umlModel] = " + umlModel + ", " + "[sourceRefModel] = " + sourceRefModel + ", "
					+ "[rootModel] = " + rootModel + ", " + "[externalModel] = " + externalModel + ", "
					+ "[javaModel] = " + javaModel + ", " + "[commonTypes] = " + commonTypes + ", " + "[sourceMatch] = "
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(umlModel, sourceRefModel,
								rootModel, externalModel, javaModel, commonTypes, ccMatch);
				if (result6_black == null) {
				...
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFFFBFBBBBB(
						umlModel, sourceRefModel, externalModel, javaModel, commonTypes, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Model umlModel, Model sourceRefModel, Model rootModel, Model externalModel,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Model umlModel, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes) {// 
		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_blackBBBBB(umlModel, sourceRefModel, rootModel,
						externalModel, commonTypes);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer) {
		...
		if (result2_black != null) {
			...
			if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				//nothing JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) result6_green[1];
				//nothing JavaModel2UMLPackage jm2um2 = (JavaModel2UMLPackage) result6_green[2];
				//nothing Model umlModel = (Model) result6_green[3];
				//nothing JavaModel2UMLPackage jm2um3 = (JavaModel2UMLPackage) result6_green[4];
				//nothing Model sourceRefModel = (Model) result6_green[5];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_130__EMOFLONEDGE:
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFFFFFFFFBFB(
		...
		return new Object[] { jm2commonTypes, jm2um, jm2um2, umlModel, jm2um3, sourceRefModel, rootModel, externalModel,
				javaModel, commonTypes, csp };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			JavaModel2UMLPackage jm2commonTypes, JavaModel2UMLPackage jm2um, JavaModel2UMLPackage jm2um2,
			Model umlModel, JavaModel2UMLPackage jm2um3, Model sourceRefModel, Model rootModel, Model externalModel,
			MGravityModel javaModel, org.eclipse.uml2.uml.Package commonTypes) {
															...
															if (!commonTypes.equals(sourceRefModel)) {
																if (!commonTypes.equals(rootModel)) {
																	if (!commonTypes.equals(externalModel)) {
																		return new Object[] { jm2commonTypes, jm2um,
																				jm2um2, umlModel, jm2um3,
																				sourceRefModel, rootModel,
																				externalModel, javaModel, commonTypes };
																	}
																}
															}
														}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, jm2commonTypes, jm2um, jm2um2, umlModel, jm2um3, sourceRefModel, rootModel,
				externalModel, javaModel, commonTypes };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject jm2commonTypes, EObject jm2um, EObject jm2um2, EObject umlModel,
			EObject jm2um3, EObject sourceRefModel, EObject rootModel, EObject externalModel, EObject javaModel,
			EObject commonTypes) {
		if (!jm2commonTypes.equals(jm2um)) {
			if (!jm2commonTypes.equals(jm2um2)) {
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, jm2commonTypes, jm2um, jm2um2, umlModel, jm2um3, sourceRefModel, rootModel,
				externalModel, javaModel, commonTypes, jm2um__umlModel____target, jm2um3__sourceRefModel____target,
				rootModel__sourceRefModel____packagedElement, umlModel__commonTypes____packagedElement,
				rootModel__umlModel____packagedElement, jm2um2__externalModel____target,
				rootModel__externalModel____packagedElement, jm2um3__javaModel____source,
				jm2commonTypes__javaModel____source, jm2um__javaModel____source, jm2um2__javaModel____source,
	...
	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject jm2commonTypes, EObject jm2um,
			EObject jm2um2, EObject umlModel, EObject jm2um3, EObject sourceRefModel, EObject rootModel,
			EObject externalModel, EObject javaModel, EObject commonTypes) {
		_this.registerObjects_FWD(ruleresult, jm2commonTypes, jm2um, jm2um2, umlModel, jm2um3, sourceRefModel,
				rootModel, externalModel, javaModel, commonTypes);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model umlModel, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(umlModel)) {
				if (!rootModel.equals(sourceRefModel)) {
							...
							if (!externalModel.equals(rootModel)) {
								if (!commonTypes.equals(umlModel)) {
									if (!commonTypes.equals(sourceRefModel)) {
										if (!commonTypes.equals(rootModel)) {
											if (!commonTypes.equals(externalModel)) {
												return new Object[] { _this, match, umlModel, sourceRefModel, rootModel,
														externalModel, commonTypes };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model umlModel, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_BWD(match, umlModel, sourceRefModel, rootModel,
				externalModel, commonTypes);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, umlModel, sourceRefModel, rootModel, externalModel, commonTypes };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding = pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, umlModel, sourceRefModel, rootModel, externalModel, commonTypes);
		if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, umlModel, sourceRefModel, rootModel, externalModel,
						commonTypes };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, Model umlModel, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(umlModel)) {
				if (!rootModel.equals(sourceRefModel)) {
							...
							if (!externalModel.equals(rootModel)) {
								if (!commonTypes.equals(umlModel)) {
									if (!commonTypes.equals(sourceRefModel)) {
										if (!commonTypes.equals(rootModel)) {
											if (!commonTypes.equals(externalModel)) {
												return new Object[] { match, umlModel, sourceRefModel, rootModel,
														externalModel, commonTypes };
											}
										}
									}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		rootModel__externalModel____packagedElement.setName(rootModel__externalModel____packagedElement_name_prime);
		return new Object[] { match, umlModel, sourceRefModel, rootModel, externalModel, commonTypes,
				rootModel__sourceRefModel____packagedElement, umlModel__commonTypes____packagedElement,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_5_collectcontextelements_blackBBBBBB(Match match,
			Model umlModel, Model sourceRefModel, Model rootModel, Model externalModel,
			org.eclipse.uml2.uml.Package commonTypes) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(umlModel)) {
				if (!rootModel.equals(sourceRefModel)) {
	...
	public static final void pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model umlModel, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes) {
		_this.registerObjectsToMatch_BWD(match, umlModel, sourceRefModel, rootModel, externalModel, commonTypes);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingFFFFFB(
		...
		EObject _localVariable_1 = isApplicableMatch.getObject("sourceRefModel");
		...
		EObject tmpSourceRefModel = _localVariable_1;
				...
				if (tmpRootModel instanceof Model) {
					...
					if (tmpExternalModel instanceof Model) {
						...
						if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
							...
							return new Object[] { umlModel, sourceRefModel, rootModel, externalModel, commonTypes,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(Model umlModel,
			Model sourceRefModel, Model rootModel, Model externalModel, org.eclipse.uml2.uml.Package commonTypes,
			JavaModel2UmlModelRule _this, IsApplicableMatch isApplicableMatch) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!rootModel.equals(umlModel)) {
				if (!rootModel.equals(sourceRefModel)) {
										...
										if (!commonTypes.equals(rootModel)) {
											if (!commonTypes.equals(externalModel)) {
												for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
													if (tmpCsp instanceof CSP) {
														CSP csp = (CSP) tmpCsp;
														return new Object[] { umlModel, sourceRefModel, rootModel,
																externalModel, commonTypes, csp, _this,
																isApplicableMatch };
													}
												}
											}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding != null) {
			...
			Model sourceRefModel = (Model) result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding[1];
			...
			Object[] result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black = pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
					umlModel, sourceRefModel, rootModel, externalModel, commonTypes, _this, isApplicableMatch);
			if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black != null) {
				...
				return new Object[] { umlModel, sourceRefModel, rootModel, externalModel, commonTypes, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFFFBFBBFBB(
			Model umlModel, Model sourceRefModel, Model externalModel, org.eclipse.uml2.uml.Package commonTypes,
			CSP csp) {
		JavaModel2UMLPackage jm2commonTypes = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2um = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2um2 = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		...
		return new Object[] { jm2commonTypes, jm2um, jm2um2, umlModel, jm2um3, sourceRefModel, externalModel, javaModel,
				commonTypes, csp };
	}
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject jm2um2, EObject umlModel, EObject jm2um3, EObject sourceRefModel, EObject rootModel,
			EObject externalModel, EObject javaModel, EObject commonTypes) {
		_this.registerObjects_BWD(ruleresult, jm2commonTypes, jm2um, jm2um2, umlModel, jm2um3, sourceRefModel,
				rootModel, externalModel, javaModel, commonTypes);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_2_corematch_bindingFFFFFB(Match match) {
		...
		EObject _localVariable_1 = match.getObject("sourceRefModel");
													...
													if (rootModel_name.equals("root model")) {
														...
														if (externalModel_name.equals("externals")) {
															...
															if (commonTypes_name.equals("Common Java datatypes")) {
																_result.add(new Object[] { umlModel, sourceRefModel,
																		rootModel, externalModel, commonTypes, match });
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(Model umlModel,
		...
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		rootModel__externalModel____packagedElement.setName(rootModel__externalModel____packagedElement_name_prime);
		return new Object[] { umlModel, sourceRefModel, rootModel, externalModel, commonTypes, isApplicableMatch,
				rootModel__sourceRefModel____packagedElement, umlModel__commonTypes____packagedElement,
				rootModel__umlModel____packagedElement, rootModel__externalModel____packagedElement };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
			JavaModel2UmlModelRule _this, IsApplicableMatch isApplicableMatch, Model umlModel, Model sourceRefModel,
			Model rootModel, Model externalModel, org.eclipse.uml2.uml.Package commonTypes) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, umlModel, sourceRefModel, rootModel,
				externalModel, commonTypes);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, umlModel, sourceRefModel, rootModel, externalModel,
					commonTypes };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding = pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, umlModel, sourceRefModel, rootModel, externalModel, commonTypes);
	...
	public static final boolean pattern_JavaModel2UmlModelRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model umlModel, Model sourceRefModel, Model rootModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, umlModel, sourceRefModel, rootModel, externalModel,
				commonTypes);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingFFFFFFBB(
		...
		EObject _localVariable_1 = targetMatch.getObject("sourceRefModel");
		EObject _localVariable_2 = targetMatch.getObject("rootModel");
		EObject _localVariable_3 = targetMatch.getObject("externalModel");
				...
				if (tmpRootModel instanceof Model) {
					...
					if (tmpExternalModel instanceof Model) {
						...
						if (tmpJavaModel instanceof MGravityModel) {
							...
							if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
								org.eclipse.uml2.uml.Package commonTypes = (org.eclipse.uml2.uml.Package) tmpCommonTypes;
								return new Object[] { umlModel, sourceRefModel, rootModel, externalModel, javaModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(Model umlModel,
			Model sourceRefModel, Model rootModel, Model externalModel, MGravityModel javaModel,
													...
													if (sourceRefModel_name.equals("source references")) {
														...
														if (rootModel_name.equals("root model")) {
															...
															if (externalModel_name.equals("externals")) {
																String commonTypes_name = commonTypes.getName();
																if (commonTypes_name.equals("Common Java datatypes")) {
																	return new Object[] { umlModel, sourceRefModel,
																			rootModel, externalModel, javaModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Model sourceRefModel = (Model) result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding[1];
			Model rootModel = (Model) result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding[2];
			Model externalModel = (Model) result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					umlModel, sourceRefModel, rootModel, externalModel, javaModel, commonTypes, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { umlModel, sourceRefModel, rootModel, externalModel, javaModel, commonTypes,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, Model umlModel, Model sourceRefModel, Model rootModel, Model externalModel,
			MGravityModel javaModel, org.eclipse.uml2.uml.Package commonTypes, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(umlModel, sourceRefModel, rootModel, externalModel,
				javaModel, commonTypes, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, umlModel, sourceRefModel, rootModel, externalModel, javaModel,
					commonTypes, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, umlModel, sourceRefModel, rootModel, externalModel, javaModel, commonTypes, sourceMatch,
				targetMatch);
								...
								if (!commonTypes.equals(umlModel)) {
									if (!commonTypes.equals(sourceRefModel)) {
										if (!commonTypes.equals(rootModel)) {
											if (!commonTypes.equals(externalModel)) {
												return new Object[] { umlModel, sourceRefModel, rootModel,
														externalModel, javaModel, commonTypes, ccMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFFFBFBBBBB(
			Model umlModel, Model sourceRefModel, Model externalModel, MGravityModel javaModel,
			org.eclipse.uml2.uml.Package commonTypes, CCMatch ccMatch) {
		JavaModel2UMLPackage jm2commonTypes = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2um = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2um2 = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_greenBBBB(Model sourceRefModel,
		...
		externalModel.setName(externalModel_name_prime);
		commonTypes.setName(commonTypes_name_prime);
		return new Object[] { sourceRefModel, rootModel, externalModel, commonTypes };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_29_6_perform_greenFFFFFFFFFFBB(
		...
		return new Object[] { jm2commonTypes, jm2um, jm2um2, umlModel, jm2um3, sourceRefModel, rootModel, externalModel,
				javaModel, commonTypes, ruleResult, csp };
	}
