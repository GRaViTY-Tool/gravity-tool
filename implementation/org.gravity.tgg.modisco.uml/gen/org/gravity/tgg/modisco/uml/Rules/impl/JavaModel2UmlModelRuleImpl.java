...
public class JavaModel2UmlModelRuleImpl extends AbstractRuleImpl implements JavaModel2UmlModelRule {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Model sourceRefModel = (Model) result1_green[1];
		...
		Model umlModel = (Model) result1_green[7];
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(jm2um, sourceRefModel,
						externalModel, jm2commonTypes, jm2um2, jm2um3, javaModel, umlModel, commonTypes, rootModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jm2um] = " + jm2um + ", "
					...
					+ "[jm2commonTypes] = " + jm2commonTypes + ", " + "[jm2um2] = " + jm2um2 + ", " + "[jm2um3] = "
					+ jm2um3 + ", " + "[javaModel] = " + javaModel + ", " + "[umlModel] = " + umlModel + ", "
					+ "[commonTypes] = " + commonTypes + ", " + "[rootModel] = " + rootModel + ".");
		}
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(jm2um, sourceRefModel,
						externalModel, jm2commonTypes, jm2um2, jm2um3, javaModel, umlModel, commonTypes, rootModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, jm2um,
						sourceRefModel, externalModel, jm2commonTypes, jm2um2, jm2um3, javaModel, umlModel, commonTypes,
						rootModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[jm2um] = " + jm2um + ", " + "[sourceRefModel] = " + sourceRefModel + ", "
					+ "[externalModel] = " + externalModel + ", " + "[jm2commonTypes] = " + jm2commonTypes + ", "
					+ "[jm2um2] = " + jm2um2 + ", " + "[jm2um3] = " + jm2um3 + ", " + "[javaModel] = " + javaModel
		...
		JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
				ruleresult, jm2um, sourceRefModel, externalModel, jm2commonTypes, jm2um2, jm2um3, javaModel, umlModel,
				commonTypes, rootModel);
		//nothing EMoflonEdge jm2um2__externalModel____target = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge jm2um3__javaModel____source = (EMoflonEdge) result3_green[12];
		...
		//nothing EMoflonEdge jm2commonTypes__commonTypes____target = (EMoflonEdge) result3_green[19];
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject jm2um, EObject sourceRefModel,
			EObject externalModel, EObject jm2commonTypes, EObject jm2um2, EObject jm2um3, EObject javaModel,
			EObject umlModel, EObject commonTypes, EObject rootModel) {
	...
	public boolean isAppropriate_BWD(Match match, Model sourceRefModel, Model externalModel, Model umlModel,
		...
		Object[] result1_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_10_1_initialbindings_blackBBBBBBB(this, match, sourceRefModel,
						externalModel, umlModel, commonTypes, rootModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[sourceRefModel] = " + sourceRefModel + ", " + "[externalModel] = "
					+ externalModel + ", " + "[umlModel] = " + umlModel + ", " + "[commonTypes] = " + commonTypes + ", "
					+ "[rootModel] = " + rootModel + ".");
		}
		...
		if (JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = JavaModel2UmlModelRuleImpl
					.pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(match,
							sourceRefModel, externalModel, umlModel, commonTypes, rootModel);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[sourceRefModel] = " + sourceRefModel + ", " + "[externalModel] = " + externalModel + ", "
			...
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
					this, match, sourceRefModel, externalModel, umlModel, commonTypes, rootModel);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFBBFFFFBBB(sourceRefModel,
		...
		Object[] result2_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_blackBBBBBBBBBB(jm2um, sourceRefModel,
						externalModel, jm2commonTypes, jm2um2, jm2um3, javaModel, umlModel, commonTypes, rootModel);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jm2um] = " + jm2um + ", "
					+ "[sourceRefModel] = " + sourceRefModel + ", " + "[externalModel] = " + externalModel + ", "
		...
		Object[] result2_green = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_2_collecttranslatedelements_greenFBBBBBBBBBB(jm2um, sourceRefModel,
						externalModel, jm2commonTypes, jm2um2, jm2um3, javaModel, umlModel, commonTypes, rootModel);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_11_3_bookkeepingforedges_blackBBBBBBBBBBB(ruleresult, jm2um,
						sourceRefModel, externalModel, jm2commonTypes, jm2um2, jm2um3, javaModel, umlModel, commonTypes,
						rootModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Model sourceRefModel, Model externalModel,
			Model umlModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject jm2um, EObject sourceRefModel,
			EObject externalModel, EObject jm2commonTypes, EObject jm2um2, EObject jm2um3, EObject javaModel,
			EObject umlModel, EObject commonTypes, EObject rootModel) {
		ruleresult.registerObject("jm2um", jm2um);
		ruleresult.registerObject("sourceRefModel", sourceRefModel);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_MGravityModel_8(MGravityModel javaModel) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_714(EMoflonEdge _edge_packagedElement) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = JavaModel2UmlModelRuleImpl
				.pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, sourceRefModel,
						externalModel, javaModel, umlModel, commonTypes, rootModel, sourceMatch, targetMatch);
			...
			for (Object[] result5_black : JavaModel2UmlModelRuleImpl
				...
				Object[] result6_black = JavaModel2UmlModelRuleImpl
						.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_blackBBBBBBB(sourceRefModel,
								externalModel, javaModel, umlModel, commonTypes, rootModel, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[sourceRefModel] = "
							+ sourceRefModel + ", " + "[externalModel] = " + externalModel + ", " + "[javaModel] = "
							+ javaModel + ", " + "[umlModel] = " + umlModel + ", " + "[commonTypes] = " + commonTypes
							+ ", " + "[rootModel] = " + rootModel + ", " + "[ccMatch] = " + ccMatch + ".");
				}
				JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFBBFFFBBBB(
						sourceRefModel, externalModel, javaModel, umlModel, commonTypes, ccMatch);
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Model sourceRefModel, Model externalModel, MGravityModel javaModel,
			Model umlModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(Model sourceRefModel, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {// 
		Object[] result1_black = JavaModel2UmlModelRuleImpl
		...
		if (result1_black != null) {
			JavaModel2UmlModelRuleImpl.pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_greenBBBB(sourceRefModel,
					externalModel, commonTypes, rootModel);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_FWD_MGRAVITY_MODEL_8__MGRAVITYMODEL:
			return isAppropriate_FWD_MGravityModel_8((MGravityModel) arguments.get(0));
		case RulesPackage.JAVA_MODEL2_UML_MODEL_RULE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_714__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_714((EMoflonEdge) arguments.get(0));
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_1_performtransformation_greenFFFFFFBFFFB(
		...
		return new Object[] { jm2um, sourceRefModel, externalModel, jm2commonTypes, jm2um2, jm2um3, javaModel, umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_blackBBBBBBBBBB(
			JavaModel2UMLPackage jm2um, Model sourceRefModel, Model externalModel, JavaModel2UMLPackage jm2commonTypes,
			JavaModel2UMLPackage jm2um2, JavaModel2UMLPackage jm2um3, MGravityModel javaModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
															...
															if (!commonTypes.equals(rootModel)) {
																if (!rootModel.equals(sourceRefModel)) {
																	if (!rootModel.equals(umlModel)) {
																		return new Object[] { jm2um, sourceRefModel,
																				externalModel, jm2commonTypes, jm2um2,
																				jm2um3, javaModel, umlModel,
																				commonTypes, rootModel };
																	}
																}
															}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_2_collecttranslatedelements_greenFBBBBBBBBBB(
		...
		return new Object[] { ruleresult, jm2um, sourceRefModel, externalModel, jm2commonTypes, jm2um2, jm2um3,
				javaModel, umlModel, commonTypes, rootModel };
	}

	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_blackBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject jm2um, EObject sourceRefModel, EObject externalModel,
			EObject jm2commonTypes, EObject jm2um2, EObject jm2um3, EObject javaModel, EObject umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, jm2um, sourceRefModel, externalModel, jm2commonTypes, jm2um2, jm2um3,
				javaModel, umlModel, commonTypes, rootModel, jm2um2__externalModel____target,
				jm2um3__javaModel____source, jm2commonTypes__javaModel____source, jm2um2__javaModel____source,
				jm2um__javaModel____source, jm2um3__sourceRefModel____target, umlModel__commonTypes____packagedElement,
				jm2um__umlModel____target, jm2commonTypes__commonTypes____target,
	...
	public static final void pattern_JavaModel2UmlModelRule_1_5_registerobjects_expressionBBBBBBBBBBBB(
			JavaModel2UmlModelRule _this, PerformRuleResult ruleresult, EObject jm2um, EObject sourceRefModel,
			EObject externalModel, EObject jm2commonTypes, EObject jm2um2, EObject jm2um3, EObject javaModel,
			EObject umlModel, EObject commonTypes, EObject rootModel) {
		_this.registerObjects_FWD(ruleresult, jm2um, sourceRefModel, externalModel, jm2commonTypes, jm2um2, jm2um3,
				javaModel, umlModel, commonTypes, rootModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, sourceRefModel, externalModel, umlModel, commonTypes, rootModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding = pattern_JavaModel2UmlModelRule_10_2_SolveCSP_bindingFBBBBBBB(
				_this, match, sourceRefModel, externalModel, umlModel, commonTypes, rootModel);
		if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_10_2_SolveCSP_black != null) {
				...
				return new Object[] { csp, _this, match, sourceRefModel, externalModel, umlModel, commonTypes,
						rootModel };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_blackBBBBBB(
			Match match, Model sourceRefModel, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!externalModel.equals(sourceRefModel)) {
				if (!externalModel.equals(umlModel)) {
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_10_4_collectelementstobetranslated_greenBBBBBBFFFF(
		...
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		rootModel__sourceRefModel____packagedElement.setName(rootModel__sourceRefModel____packagedElement_name_prime);
		return new Object[] { match, sourceRefModel, externalModel, umlModel, commonTypes, rootModel,
	...
	public static final void pattern_JavaModel2UmlModelRule_10_6_registerobjectstomatch_expressionBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		_this.registerObjectsToMatch_BWD(match, sourceRefModel, externalModel, umlModel, commonTypes, rootModel);
				...
				if (tmpUmlModel instanceof Model) {
					...
					if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
						...
						if (tmpRootModel instanceof Model) {
							...
							return new Object[] { sourceRefModel, externalModel, umlModel, commonTypes, rootModel,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
			Model sourceRefModel, Model externalModel, Model umlModel, org.eclipse.uml2.uml.Package commonTypes,
			Model rootModel, JavaModel2UmlModelRule _this, IsApplicableMatch isApplicableMatch) {
		if (!sourceRefModel.equals(umlModel)) {
			if (!externalModel.equals(sourceRefModel)) {
				if (!externalModel.equals(umlModel)) {
					if (!externalModel.equals(rootModel)) {
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black = pattern_JavaModel2UmlModelRule_11_1_performtransformation_blackBBBBBFBB(
					sourceRefModel, externalModel, umlModel, commonTypes, rootModel, _this, isApplicableMatch);
			if (result_pattern_JavaModel2UmlModelRule_11_1_performtransformation_black != null) {
				...
				return new Object[] { sourceRefModel, externalModel, umlModel, commonTypes, rootModel, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_11_1_performtransformation_greenFBBFFFFBBB(
			Model sourceRefModel, Model externalModel, Model umlModel, org.eclipse.uml2.uml.Package commonTypes,
			CSP csp) {
		JavaModel2UMLPackage jm2um = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
		JavaModel2UMLPackage jm2commonTypes = UmlFactory.eINSTANCE.createJavaModel2UMLPackage();
	...
	public static final void pattern_JavaModel2UmlModelRule_11_5_registerobjects_expressionBBBBBBBBBBBB(
			...
			EObject externalModel, EObject jm2commonTypes, EObject jm2um2, EObject jm2um3, EObject javaModel,
			EObject umlModel, EObject commonTypes, EObject rootModel) {
		_this.registerObjects_BWD(ruleresult, jm2um, sourceRefModel, externalModel, jm2commonTypes, jm2um2, jm2um3,
				javaModel, umlModel, commonTypes, rootModel);
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_3_findcontext_greenBBBBBFFFFF(Model sourceRefModel,
		...
		rootModel__umlModel____packagedElement.setName(rootModel__umlModel____packagedElement_name_prime);
		rootModel__sourceRefModel____packagedElement.setName(rootModel__sourceRefModel____packagedElement_name_prime);
		return new Object[] { sourceRefModel, externalModel, umlModel, commonTypes, rootModel, isApplicableMatch,
				umlModel__commonTypes____packagedElement, rootModel__externalModel____packagedElement,
				rootModel__umlModel____packagedElement, rootModel__sourceRefModel____packagedElement };
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, sourceRefModel, externalModel, umlModel, commonTypes,
					rootModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding = pattern_JavaModel2UmlModelRule_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, sourceRefModel, externalModel, umlModel, commonTypes, rootModel);
		if (result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_JavaModel2UmlModelRule_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, sourceRefModel, externalModel, umlModel,
						commonTypes, rootModel };
			}
		}
		return null;
	...
	public static final boolean pattern_JavaModel2UmlModelRule_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			JavaModel2UmlModelRule _this, Match match, Model sourceRefModel, Model externalModel, Model umlModel,
			org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, sourceRefModel, externalModel, umlModel, commonTypes,
				rootModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpJavaModel instanceof MGravityModel) {
					...
					if (tmpUmlModel instanceof Model) {
						...
						if (tmpCommonTypes instanceof org.eclipse.uml2.uml.Package) {
							...
							if (tmpRootModel instanceof Model) {
								Model rootModel = (Model) tmpRootModel;
								return new Object[] { sourceRefModel, externalModel, javaModel, umlModel, commonTypes,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
			Model sourceRefModel, Model externalModel, MGravityModel javaModel, Model umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black = pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_blackBBBBBBBB(
					sourceRefModel, externalModel, javaModel, umlModel, commonTypes, rootModel, sourceMatch,
					targetMatch);
			if (result_pattern_JavaModel2UmlModelRule_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { sourceRefModel, externalModel, javaModel, umlModel, commonTypes, rootModel,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
			JavaModel2UmlModelRule _this, Model sourceRefModel, Model externalModel, MGravityModel javaModel,
			Model umlModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(sourceRefModel, externalModel, javaModel, umlModel,
				commonTypes, rootModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, sourceRefModel, externalModel, javaModel, umlModel, commonTypes,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_JavaModel2UmlModelRule_24_3_solvecsp_binding = pattern_JavaModel2UmlModelRule_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, sourceRefModel, externalModel, javaModel, umlModel, commonTypes, rootModel, sourceMatch,
				targetMatch);
							...
							if (!commonTypes.equals(externalModel)) {
								if (!commonTypes.equals(umlModel)) {
									if (!commonTypes.equals(rootModel)) {
										if (!rootModel.equals(sourceRefModel)) {
											if (!rootModel.equals(umlModel)) {
												return new Object[] { sourceRefModel, externalModel, javaModel,
														umlModel, commonTypes, rootModel, ccMatch };
											}
										}
									}
								}
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_24_6_createcorrespondence_greenFBBFFFBBBB(
			Model sourceRefModel, Model externalModel, MGravityModel javaModel, Model umlModel,
	...
	public static final Object[] pattern_JavaModel2UmlModelRule_28_1_matchtggpattern_greenBBBB(Model sourceRefModel,
			Model externalModel, org.eclipse.uml2.uml.Package commonTypes, Model rootModel) {
		String sourceRefModel_name_prime = "source references";
		String externalModel_name_prime = "externals";
		String commonTypes_name_prime = "Common Java datatypes";
		String rootModel_name_prime = "root model";
		...
		commonTypes.setName(commonTypes_name_prime);
		rootModel.setName(rootModel_name_prime);
		return new Object[] { sourceRefModel, externalModel, commonTypes, rootModel };
	}
