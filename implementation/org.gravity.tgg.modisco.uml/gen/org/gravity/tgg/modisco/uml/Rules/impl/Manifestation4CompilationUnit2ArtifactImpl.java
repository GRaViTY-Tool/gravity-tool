...
public class Manifestation4CompilationUnit2ArtifactImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
						artifact, classifier, manifestation, c2a, type, t2c, compilationUnit);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[artifact] = " + artifact + ", " + "[classifier] = " + classifier + ", "
					+ "[manifestation] = " + manifestation + ", " + "[c2a] = " + c2a + ", " + "[type] = " + type + ", "
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(ruleresult,
						artifact, classifier, manifestation, type, compilationUnit);
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(this,
						ruleresult, artifact, classifier, manifestation, c2a, type, t2c, compilationUnit);
		return Manifestation4CompilationUnit2ArtifactImpl
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_blackBBBBBB(artifact, classifier,
							c2a, type, t2c, compilationUnit)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(artifact,
								classifier, c2a, type, t2c, compilationUnit);
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, artifact, classifier, c2a, type, t2c, compilationUnit);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[artifact] = " + artifact + ", "
							+ "[classifier] = " + classifier + ", " + "[c2a] = " + c2a + ", " + "[type] = " + type
							+ ", " + "[t2c] = " + t2c + ", " + "[compilationUnit] = " + compilationUnit + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Artifact artifact, Classifier classifier,
			CompilationUnit2Artifact c2a, AbstractTypeDeclaration type, ASTNode2Element t2c,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject artifact, EObject classifier,
			EObject manifestation, EObject c2a, EObject type, EObject t2c, EObject compilationUnit) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_12_2_corematch_blackBBBFFFFB(artifact, classifier,
						manifestation, match)) {
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_blackBBBBBBB(artifact, classifier,
							manifestation, c2a, type, t2c, compilationUnit)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_greenBBBBBBBFFFFFFF(artifact,
								classifier, manifestation, c2a, type, t2c, compilationUnit);
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, artifact, classifier, manifestation, c2a, type, t2c,
								compilationUnit);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[artifact] = " + artifact + ", "
							+ "[classifier] = " + classifier + ", " + "[manifestation] = " + manifestation + ", "
							+ "[c2a] = " + c2a + ", " + "[type] = " + type + ", " + "[t2c] = " + t2c + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Artifact artifact, Classifier classifier,
			Manifestation manifestation, CompilationUnit2Artifact c2a, AbstractTypeDeclaration type,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject artifact, EObject classifier,
			EObject manifestation, EObject c2a, EObject type, EObject t2c, EObject compilationUnit) {
		ruleresult.registerObject("artifact", artifact);
		ruleresult.registerObject("classifier", classifier);
		ruleresult.registerObject("manifestation", manifestation);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_129(EMoflonEdge _edge_manifestation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_140(EMoflonEdge _edge_types) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, artifact,
						classifier, manifestation, type, compilationUnit, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[artifact] = " + artifact + ", " + "[classifier] = " + classifier + ", " + "[manifestation] = "
					+ manifestation + ", " + "[type] = " + type + ", " + "[compilationUnit] = " + compilationUnit + ", "
		...
		if (Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result5_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBBFBFBBB(artifact,
				...
				Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(artifact,
								classifier, manifestation, type, compilationUnit, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Artifact artifact, Classifier classifier, Manifestation manifestation,
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, artifact, classifier, c2a, type, t2c, compilationUnit, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[artifact] = " + artifact + ", "
						+ "[classifier] = " + classifier + ", " + "[c2a] = " + c2a + ", " + "[type] = " + type + ", "
				...
				if (result5_black != null) {
					...
					Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(artifact,
									classifier, c2a, type, t2c, compilationUnit, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[artifact] = "
								+ artifact + ", " + "[classifier] = " + classifier + ", " + "[c2a] = " + c2a + ", "
								+ "[type] = " + type + ", " + "[t2c] = " + t2c + ", " + "[compilationUnit] = "
								+ compilationUnit + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBFBBB(artifact,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ARTIFACT_CLASSIFIER_COMPILATIONUNIT2ARTIFACT_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_COMPILATIONUNIT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Artifact) arguments.get(1),
					...
					(AbstractTypeDeclaration) arguments.get(4), (ASTNode2Element) arguments.get(5),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ARTIFACT_CLASSIFIER_MANIFESTATION_COMPILATIONUNIT2ARTIFACT_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_COMPILATIONUNIT:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Artifact) arguments.get(1),
					(Classifier) arguments.get(2), (Manifestation) arguments.get(3),
					(CompilationUnit2Artifact) arguments.get(4), (AbstractTypeDeclaration) arguments.get(5),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_129__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_129((EMoflonEdge) arguments.get(0));
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_140__EMOFLONEDGE:
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_CC__ARTIFACT_CLASSIFIER_MANIFESTATION_ABSTRACTTYPEDECLARATION_COMPILATIONUNIT_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Artifact) arguments.get(0), (Classifier) arguments.get(1),
					(Manifestation) arguments.get(2), (AbstractTypeDeclaration) arguments.get(3),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ARTIFACT_CLASSIFIER_COMPILATIONUNIT2ARTIFACT_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_COMPILATIONUNIT_MODELGENERATORRULERESULT:
					...
					if (tmpType instanceof AbstractTypeDeclaration) {
						...
						if (tmpT2c instanceof ASTNode2Element) {
							...
							if (tmpCompilationUnit instanceof CompilationUnit) {
								...
								return new Object[] { artifact, classifier, c2a, type, t2c, compilationUnit,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
			Artifact artifact, Classifier classifier, CompilationUnit2Artifact c2a, AbstractTypeDeclaration type,
		...
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { artifact, classifier, c2a, type, t2c, compilationUnit, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
					artifact, classifier, c2a, type, t2c, compilationUnit, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject artifact, EObject classifier, EObject manifestation, EObject c2a,
			EObject type, EObject t2c, EObject compilationUnit) {
		if (!artifact.equals(classifier)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(
			PerformRuleResult ruleresult, EObject artifact, EObject classifier, EObject manifestation, EObject type,
		...
		compilationUnit__type____types.setName(compilationUnit__type____types_name_prime);
		return new Object[] { ruleresult, artifact, classifier, manifestation, type, compilationUnit,
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject classifier, EObject manifestation, EObject c2a, EObject type, EObject t2c,
			EObject compilationUnit) {
		_this.registerObjects_FWD(ruleresult, artifact, classifier, manifestation, c2a, type, t2c, compilationUnit);
		...
		for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(type,
			...
			if (tmpClassifier instanceof Classifier) {
				...
				for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (artifact != null) {
						if (!artifact.equals(classifier)) {
							_result.add(new Object[] { artifact, classifier, c2a, type, t2c, compilationUnit, match });
						}
					}
					...
					if (type.equals(t2c.getSource())) {
						if (compilationUnit.getTypes().contains(type)) {
							if (compilationUnit.equals(c2a.getSource())) {
								_result.add(new Object[] { artifact, classifier, c2a, type, t2c, compilationUnit });
							}
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { artifact, classifier, c2a, type, t2c, compilationUnit, isApplicableMatch,
				c2a__artifact____target, t2c__classifier____target, t2c__type____source, compilationUnit__type____types,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
			...
			Classifier classifier, CompilationUnit2Artifact c2a, AbstractTypeDeclaration type, ASTNode2Element t2c,
			CompilationUnit compilationUnit) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, artifact, classifier, c2a, type, t2c,
				compilationUnit);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, artifact, classifier, c2a, type, t2c,
					compilationUnit };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, artifact, classifier, c2a, type, t2c, compilationUnit);
					...
					if (tmpC2a instanceof CompilationUnit2Artifact) {
						...
						if (tmpType instanceof AbstractTypeDeclaration) {
							...
							if (tmpT2c instanceof ASTNode2Element) {
								...
								if (tmpCompilationUnit instanceof CompilationUnit) {
									CompilationUnit compilationUnit = (CompilationUnit) tmpCompilationUnit;
									return new Object[] { artifact, classifier, manifestation, c2a, type, t2c,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
			Artifact artifact, Classifier classifier, Manifestation manifestation, CompilationUnit2Artifact c2a,
			AbstractTypeDeclaration type, ASTNode2Element t2c, CompilationUnit compilationUnit,
			Manifestation4CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch) {
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { artifact, classifier, manifestation, c2a, type, t2c, compilationUnit, csp,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
					artifact, classifier, manifestation, c2a, type, t2c, compilationUnit, _this, isApplicableMatch);
			if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black != null) {
				...
				return new Object[] { artifact, classifier, manifestation, c2a, type, t2c, compilationUnit, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject classifier, EObject manifestation, EObject c2a, EObject type, EObject t2c,
			EObject compilationUnit) {
		_this.registerObjects_BWD(ruleresult, artifact, classifier, manifestation, c2a, type, t2c, compilationUnit);
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_12_2_corematch_blackBBBFFFFB(
			...
			for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (compilationUnit != null) {
					for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tmpType instanceof AbstractTypeDeclaration) {
							AbstractTypeDeclaration type = (AbstractTypeDeclaration) tmpType;
							_result.add(new Object[] { artifact, classifier, manifestation, c2a, type, t2c,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		t2c__type____source.setName(t2c__type____source_name_prime);
		c2a__compilationUnit____source.setName(c2a__compilationUnit____source_name_prime);
		return new Object[] { artifact, classifier, manifestation, c2a, type, t2c, compilationUnit, isApplicableMatch,
				artifact__manifestation____manifestation, c2a__artifact____target,
				manifestation__classifier____utilizedElement, t2c__classifier____target, t2c__type____source,
				c2a__compilationUnit____source };
	}

	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch, Artifact artifact,
			Classifier classifier, Manifestation manifestation, CompilationUnit2Artifact c2a,
			AbstractTypeDeclaration type, ASTNode2Element t2c, CompilationUnit compilationUnit) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, artifact, classifier, manifestation,
				c2a, type, t2c, compilationUnit);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, artifact, classifier, manifestation, c2a, type, t2c,
					compilationUnit };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, artifact, classifier, manifestation, c2a, type, t2c, compilationUnit);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, artifact, classifier, manifestation, c2a, type,
						t2c, compilationUnit };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_568839 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_568839)) {
					if (!artifact.equals(__DEC_manifestation_client_568839)) {
						if (!classifier.equals(__DEC_manifestation_client_568839)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_943759 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_943759)) {
					if (!artifact.equals(__DEC_manifestation_supplier_943759)) {
						if (!classifier.equals(__DEC_manifestation_supplier_943759)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
			...
			if (tmpClassifier instanceof Classifier) {
				...
				if (tmpManifestation instanceof Manifestation) {
					...
					if (tmpType instanceof AbstractTypeDeclaration) {
						...
						if (tmpCompilationUnit instanceof CompilationUnit) {
							CompilationUnit compilationUnit = (CompilationUnit) tmpCompilationUnit;
							return new Object[] { artifact, classifier, manifestation, type, compilationUnit,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
			Artifact artifact, Classifier classifier, Manifestation manifestation, AbstractTypeDeclaration type,
			CompilationUnit compilationUnit, Match sourceMatch, Match targetMatch) {
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { artifact, classifier, manifestation, type, compilationUnit, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_black = pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
					artifact, classifier, manifestation, type, compilationUnit, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
			...
			Manifestation manifestation, AbstractTypeDeclaration type, CompilationUnit compilationUnit,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(artifact, classifier, manifestation, type,
				compilationUnit, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, artifact, classifier, manifestation, type, compilationUnit, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding = pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
				_this, artifact, classifier, manifestation, type, compilationUnit, sourceMatch, targetMatch);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, artifact, classifier, manifestation, type, compilationUnit,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBBFBFBBB(
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { artifact, classifier, manifestation, type, compilationUnit, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_0BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_948718 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_948718)) {
					if (!artifact.equals(__DEC_manifestation_client_948718)) {
						if (!classifier.equals(__DEC_manifestation_client_948718)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_582940 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_582940)) {
					if (!artifact.equals(__DEC_manifestation_supplier_582940)) {
						if (!classifier.equals(__DEC_manifestation_supplier_582940)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, artifact, classifier, c2a, type, t2c,
				compilationUnit, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, artifact, classifier, c2a, type, t2c, compilationUnit,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, artifact, classifier, c2a, type, t2c, compilationUnit, ruleResult);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { artifact, classifier, c2a, type, t2c, compilationUnit, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBFBBB(
		...
		return new Object[] { artifact, classifier, manifestation, type, compilationUnit, ruleResult };
	}
