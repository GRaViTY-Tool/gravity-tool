...
public class Manifestation4CompilationUnit2ArtifactImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
						manifestation, type, artifact, compilationUnit, c2a, classifier, t2c);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[manifestation] = " + manifestation + ", " + "[type] = " + type + ", " + "[artifact] = "
					+ artifact + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[c2a] = " + c2a + ", "
					+ "[classifier] = " + classifier + ", " + "[t2c] = " + t2c + ".");
		}
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult,
						manifestation, type, artifact, compilationUnit, classifier);
		//nothing EMoflonEdge type__compilationUnit____originalCompilationUnit = (EMoflonEdge) result3_green[6];
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(this,
						ruleresult, manifestation, type, artifact, compilationUnit, c2a, classifier, t2c);
		return Manifestation4CompilationUnit2ArtifactImpl
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_blackBBBBBB(type, artifact,
							compilationUnit, c2a, classifier, t2c)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFFF(type,
								artifact, compilationUnit, c2a, classifier, t2c);
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, type, artifact, compilationUnit, c2a, classifier, t2c);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AbstractTypeDeclaration type,
			Artifact artifact, CompilationUnit compilationUnit, CompilationUnit2Artifact c2a, Classifier classifier,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject manifestation, EObject type, EObject artifact,
			EObject compilationUnit, EObject c2a, EObject classifier, EObject t2c) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_12_2_corematch_blackBFBFFBFB(manifestation, artifact,
						classifier, match)) {
			...
			// ForEach 
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_blackBBBBBBB(manifestation, type,
							artifact, compilationUnit, c2a, classifier, t2c)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, manifestation, type, artifact, compilationUnit, c2a, classifier,
								t2c);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Manifestation manifestation,
			AbstractTypeDeclaration type, Artifact artifact, CompilationUnit compilationUnit,
			CompilationUnit2Artifact c2a, Classifier classifier, ASTNode2Element t2c) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject manifestation, EObject type, EObject artifact,
			EObject compilationUnit, EObject c2a, EObject classifier, EObject t2c) {
		ruleresult.registerObject("manifestation", manifestation);
		ruleresult.registerObject("type", type);
		ruleresult.registerObject("artifact", artifact);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_316(EMoflonEdge _edge_manifestation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_326(EMoflonEdge _edge_originalCompilationUnit) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this,
						manifestation, type, artifact, compilationUnit, classifier, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[manifestation] = " + manifestation + ", " + "[type] = " + type + ", " + "[artifact] = "
					+ artifact + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[classifier] = " + classifier
		...
		if (Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result5_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBBBFBFBB(type, artifact,
				...
				Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
								manifestation, type, artifact, compilationUnit, classifier, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[manifestation] = "
							+ manifestation + ", " + "[type] = " + type + ", " + "[artifact] = " + artifact + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Manifestation manifestation, AbstractTypeDeclaration type, Artifact artifact,
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, type, artifact, compilationUnit, c2a, classifier, t2c, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[type] = " + type + ", "
						+ "[artifact] = " + artifact + ", " + "[compilationUnit] = " + compilationUnit + ", "
			...
			if (Manifestation4CompilationUnit2ArtifactImpl
				...
				// 
				Object[] result5_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_29_5_checknacs_blackBBBBBB(type, artifact,
								compilationUnit, c2a, classifier, t2c);
				if (result5_black != null) {

					Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(type, artifact,
									compilationUnit, c2a, classifier, t2c, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[type] = " + type
								+ ", " + "[artifact] = " + artifact + ", " + "[compilationUnit] = " + compilationUnit
								+ ", " + "[c2a] = " + c2a + ", " + "[classifier] = " + classifier + ", " + "[t2c] = "
								+ t2c + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenFBBBBB(type, artifact,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_ARTIFACT_COMPILATIONUNIT_COMPILATIONUNIT2ARTIFACT_CLASSIFIER_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractTypeDeclaration) arguments.get(1), (Artifact) arguments.get(2),
					(CompilationUnit) arguments.get(3), (CompilationUnit2Artifact) arguments.get(4),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MANIFESTATION_ABSTRACTTYPEDECLARATION_ARTIFACT_COMPILATIONUNIT_COMPILATIONUNIT2ARTIFACT_CLASSIFIER_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Manifestation) arguments.get(1),
					(AbstractTypeDeclaration) arguments.get(2), (Artifact) arguments.get(3),
					(CompilationUnit) arguments.get(4), (CompilationUnit2Artifact) arguments.get(5),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_316__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_316((EMoflonEdge) arguments.get(0));
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_326__EMOFLONEDGE:
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_CC__MANIFESTATION_ABSTRACTTYPEDECLARATION_ARTIFACT_COMPILATIONUNIT_CLASSIFIER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Manifestation) arguments.get(0),
					(AbstractTypeDeclaration) arguments.get(1), (Artifact) arguments.get(2),
					(CompilationUnit) arguments.get(3), (Classifier) arguments.get(4), (Match) arguments.get(5),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_ARTIFACT_COMPILATIONUNIT_COMPILATIONUNIT2ARTIFACT_CLASSIFIER_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpC2a instanceof CompilationUnit2Artifact) {
						...
						if (tmpClassifier instanceof Classifier) {
							...
							if (tmpT2c instanceof ASTNode2Element) {
								...
								return new Object[] { type, artifact, compilationUnit, c2a, classifier, t2c,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
			AbstractTypeDeclaration type, Artifact artifact, CompilationUnit compilationUnit,
			CompilationUnit2Artifact c2a, Classifier classifier, ASTNode2Element t2c,
		...
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { type, artifact, compilationUnit, c2a, classifier, t2c, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
					type, artifact, compilationUnit, c2a, classifier, t2c, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject manifestation, EObject type, EObject artifact,
			EObject compilationUnit, EObject c2a, EObject classifier, EObject t2c) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(
		...
		compilationUnit__type____types.setName(compilationUnit__type____types_name_prime);
		return new Object[] { ruleresult, manifestation, type, artifact, compilationUnit, classifier,
				type__compilationUnit____originalCompilationUnit, artifact__manifestation____manifestation,
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject type, EObject artifact, EObject compilationUnit, EObject c2a, EObject classifier, EObject t2c) {
		_this.registerObjects_FWD(ruleresult, manifestation, type, artifact, compilationUnit, c2a, classifier, t2c);
			...
			if (artifact != null) {
				for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(type,
					...
					if (tmpClassifier instanceof Classifier) {
						Classifier classifier = (Classifier) tmpClassifier;
						if (!artifact.equals(classifier)) {
							_result.add(new Object[] { type, artifact, compilationUnit, c2a, classifier, t2c, match });
						}
					}
						...
						if (compilationUnit.getTypes().contains(type)) {
							if (type.equals(t2c.getSource())) {
								if (classifier.equals(t2c.getTarget())) {
									_result.add(new Object[] { type, artifact, compilationUnit, c2a, classifier, t2c });
								}
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { type, artifact, compilationUnit, c2a, classifier, t2c, isApplicableMatch,
				type__compilationUnit____originalCompilationUnit, c2a__artifact____target,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractTypeDeclaration type, Artifact artifact, CompilationUnit compilationUnit,
			CompilationUnit2Artifact c2a, Classifier classifier, ASTNode2Element t2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, type, artifact, compilationUnit, c2a,
				classifier, t2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, type, artifact, compilationUnit, c2a, classifier,
					t2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, type, artifact, compilationUnit, c2a, classifier, t2c);
					...
					if (tmpCompilationUnit instanceof CompilationUnit) {
						...
						if (tmpC2a instanceof CompilationUnit2Artifact) {
							...
							if (tmpClassifier instanceof Classifier) {
								...
								if (tmpT2c instanceof ASTNode2Element) {
									ASTNode2Element t2c = (ASTNode2Element) tmpT2c;
									return new Object[] { manifestation, type, artifact, compilationUnit, c2a,
											classifier, t2c, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
			Manifestation manifestation, AbstractTypeDeclaration type, Artifact artifact,
			CompilationUnit compilationUnit, CompilationUnit2Artifact c2a, Classifier classifier, ASTNode2Element t2c,
			Manifestation4CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch) {
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { manifestation, type, artifact, compilationUnit, c2a, classifier, t2c, csp,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
					manifestation, type, artifact, compilationUnit, c2a, classifier, t2c, _this, isApplicableMatch);
			if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black != null) {
				...
				return new Object[] { manifestation, type, artifact, compilationUnit, c2a, classifier, t2c, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject manifestation,
			EObject type, EObject artifact, EObject compilationUnit, EObject c2a, EObject classifier, EObject t2c) {
		_this.registerObjects_BWD(ruleresult, manifestation, type, artifact, compilationUnit, c2a, classifier, t2c);
			...
			for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (compilationUnit != null) {
					for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tmpType instanceof AbstractTypeDeclaration) {
							AbstractTypeDeclaration type = (AbstractTypeDeclaration) tmpType;
							_result.add(new Object[] { manifestation, type, artifact, compilationUnit, c2a, classifier,
									t2c, match });
						}
				...
				if (classifier.equals(manifestation.getUtilizedElement())) {
					if (artifact.equals(c2a.getTarget())) {
						if (compilationUnit.equals(c2a.getSource())) {
							if (type.equals(t2c.getSource())) {
								if (classifier.equals(t2c.getTarget())) {
									_result.add(new Object[] { manifestation, type, artifact, compilationUnit, c2a,
											classifier, t2c });
								}
							}
						}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		t2c__type____source.setName(t2c__type____source_name_prime);
		t2c__classifier____target.setName(t2c__classifier____target_name_prime);
		return new Object[] { manifestation, type, artifact, compilationUnit, c2a, classifier, t2c, isApplicableMatch,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			Manifestation manifestation, AbstractTypeDeclaration type, Artifact artifact,
			CompilationUnit compilationUnit, CompilationUnit2Artifact c2a, Classifier classifier, ASTNode2Element t2c) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, manifestation, type, artifact,
				compilationUnit, c2a, classifier, t2c);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, manifestation, type, artifact, compilationUnit, c2a,
					classifier, t2c };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, manifestation, type, artifact, compilationUnit, c2a, classifier, t2c);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, manifestation, type, artifact, compilationUnit,
						c2a, classifier, t2c };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_605580 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_605580)) {
					if (!artifact.equals(__DEC_manifestation_client_605580)) {
						if (!classifier.equals(__DEC_manifestation_client_605580)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_419609 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_419609)) {
					if (!artifact.equals(__DEC_manifestation_supplier_419609)) {
						if (!classifier.equals(__DEC_manifestation_supplier_419609)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_2B(
			Manifestation manifestation) {
		for (org.eclipse.uml2.uml.Package __DEC_manifestation_packagedElement_306398 : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpType instanceof AbstractTypeDeclaration) {
				...
				if (tmpArtifact instanceof Artifact) {
					...
					if (tmpCompilationUnit instanceof CompilationUnit) {
						...
						if (tmpClassifier instanceof Classifier) {
							Classifier classifier = (Classifier) tmpClassifier;
							return new Object[] { manifestation, type, artifact, compilationUnit, classifier,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { manifestation, type, artifact, compilationUnit, classifier, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, Manifestation manifestation, AbstractTypeDeclaration type,
			Artifact artifact, CompilationUnit compilationUnit, Classifier classifier, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(manifestation, type, artifact, compilationUnit,
				classifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, manifestation, type, artifact, compilationUnit, classifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding = pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
				_this, manifestation, type, artifact, compilationUnit, classifier, sourceMatch, targetMatch);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, manifestation, type, artifact, compilationUnit, classifier,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBBBFBFBB(
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { manifestation, type, artifact, compilationUnit, classifier, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_0BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_637695 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_637695)) {
					if (!artifact.equals(__DEC_manifestation_client_637695)) {
						if (!classifier.equals(__DEC_manifestation_client_637695)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_992877 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_992877)) {
					if (!artifact.equals(__DEC_manifestation_supplier_992877)) {
						if (!classifier.equals(__DEC_manifestation_supplier_992877)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_2B(
			Manifestation manifestation) {
		for (org.eclipse.uml2.uml.Package __DEC_manifestation_packagedElement_198840 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(manifestation, org.eclipse.uml2.uml.Package.class, "packagedElement")) {
			return new Object[] { manifestation };
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, type, artifact, compilationUnit, c2a,
				classifier, t2c, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, type, artifact, compilationUnit, c2a, classifier, t2c,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, type, artifact, compilationUnit, c2a, classifier, t2c, ruleResult);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(
			...
			ModelgeneratorRuleResult ruleResult) {
		if (!artifact.equals(classifier)) {
			return new Object[] { type, artifact, compilationUnit, c2a, classifier, t2c, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenFBBBBB(
		...
		return new Object[] { manifestation, type, artifact, compilationUnit, classifier, ruleResult };
	}
