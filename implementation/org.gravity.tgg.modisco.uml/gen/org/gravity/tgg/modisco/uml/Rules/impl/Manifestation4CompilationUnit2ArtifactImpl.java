...
public class Manifestation4CompilationUnit2ArtifactImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, c2a,
						compilationUnit, type, manifestation, t2c, artifact, classifier);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c2a] = " + c2a + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[type] = "
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(ruleresult,
						compilationUnit, type, manifestation, artifact, classifier);
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(this,
						ruleresult, c2a, compilationUnit, type, manifestation, t2c, artifact, classifier);
		return Manifestation4CompilationUnit2ArtifactImpl
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_2_2_corematch_blackFBBFFFB(compilationUnit, type,
						match)) {
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_blackBBBBBB(c2a, compilationUnit,
							type, t2c, artifact, classifier)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(c2a,
								compilationUnit, type, t2c, artifact, classifier);
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, c2a, compilationUnit, type, t2c, artifact, classifier);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[c2a] = " + c2a + ", "
							+ "[compilationUnit] = " + compilationUnit + ", " + "[type] = " + type + ", " + "[t2c] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, CompilationUnit2Artifact c2a,
			CompilationUnit compilationUnit, AbstractTypeDeclaration type, ASTNode2Element t2c, Artifact artifact,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject c2a, EObject compilationUnit, EObject type,
			EObject manifestation, EObject t2c, EObject artifact, EObject classifier) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_12_2_corematch_blackFFFBFBBB(manifestation, artifact,
						classifier, match)) {
			CompilationUnit2Artifact c2a = (CompilationUnit2Artifact) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_blackBBBBBBB(c2a, compilationUnit,
							type, manifestation, t2c, artifact, classifier)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, c2a, compilationUnit, type, manifestation, t2c, artifact,
								classifier);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[c2a] = " + c2a + ", "
							+ "[compilationUnit] = " + compilationUnit + ", " + "[type] = " + type + ", "
							+ "[manifestation] = " + manifestation + ", " + "[t2c] = " + t2c + ", " + "[artifact] = "
							+ artifact + ", " + "[classifier] = " + classifier + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, CompilationUnit2Artifact c2a,
			CompilationUnit compilationUnit, AbstractTypeDeclaration type, Manifestation manifestation,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject c2a, EObject compilationUnit, EObject type,
			EObject manifestation, EObject t2c, EObject artifact, EObject classifier) {
		ruleresult.registerObject("c2a", c2a);
		ruleresult.registerObject("compilationUnit", compilationUnit);
		ruleresult.registerObject("type", type);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_253(EMoflonEdge _edge_manifestation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_266(EMoflonEdge _edge_types) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this,
						compilationUnit, type, manifestation, artifact, classifier, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[compilationUnit] = " + compilationUnit + ", " + "[type] = " + type + ", " + "[manifestation] = "
					+ manifestation + ", " + "[artifact] = " + artifact + ", " + "[classifier] = " + classifier + ", "
		...
		if (Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result5_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackFBBFBBBB(compilationUnit,
							type, artifact, classifier, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
								compilationUnit, type, manifestation, artifact, classifier, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(CompilationUnit compilationUnit, AbstractTypeDeclaration type,
			Manifestation manifestation, Artifact artifact, Classifier classifier, Match sourceMatch,
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, c2a, compilationUnit, type, t2c, artifact, classifier, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[c2a] = " + c2a + ", "
						+ "[compilationUnit] = " + compilationUnit + ", " + "[type] = " + type + ", " + "[t2c] = " + t2c
						+ ", " + "[artifact] = " + artifact + ", " + "[classifier] = " + classifier + ", "
			...
			if (Manifestation4CompilationUnit2ArtifactImpl
				...
				// 
				Object[] result5_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_29_5_checknacs_blackBBBBBB(c2a, compilationUnit,
								type, t2c, artifact, classifier);
				if (result5_black != null) {

					Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(c2a,
									compilationUnit, type, t2c, artifact, classifier, ruleResult);
					if (result6_black == null) {
					...
					Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBFBBB(compilationUnit,
									type, artifact, classifier, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_COMPILATIONUNIT2ARTIFACT_COMPILATIONUNIT_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_ARTIFACT_CLASSIFIER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(CompilationUnit2Artifact) arguments.get(1), (CompilationUnit) arguments.get(2),
					(AbstractTypeDeclaration) arguments.get(3), (ASTNode2Element) arguments.get(4),
					(Artifact) arguments.get(5), (Classifier) arguments.get(6));
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_COMPILATIONUNIT2ARTIFACT_COMPILATIONUNIT_ABSTRACTTYPEDECLARATION_MANIFESTATION_ASTNODE2ELEMENT_ARTIFACT_CLASSIFIER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(CompilationUnit2Artifact) arguments.get(1), (CompilationUnit) arguments.get(2),
					(AbstractTypeDeclaration) arguments.get(3), (Manifestation) arguments.get(4),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_253__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_253((EMoflonEdge) arguments.get(0));
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_266__EMOFLONEDGE:
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_CC__COMPILATIONUNIT_ABSTRACTTYPEDECLARATION_MANIFESTATION_ARTIFACT_CLASSIFIER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((CompilationUnit) arguments.get(0),
					(AbstractTypeDeclaration) arguments.get(1), (Manifestation) arguments.get(2),
					(Artifact) arguments.get(3), (Classifier) arguments.get(4), (Match) arguments.get(5),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_COMPILATIONUNIT2ARTIFACT_COMPILATIONUNIT_ABSTRACTTYPEDECLARATION_ASTNODE2ELEMENT_ARTIFACT_CLASSIFIER_MODELGENERATORRULERESULT:
					...
					if (tmpT2c instanceof ASTNode2Element) {
						...
						if (tmpArtifact instanceof Artifact) {
							...
							if (tmpClassifier instanceof Classifier) {
								...
								return new Object[] { c2a, compilationUnit, type, t2c, artifact, classifier,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
			CompilationUnit2Artifact c2a, CompilationUnit compilationUnit, AbstractTypeDeclaration type,
		...
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { c2a, compilationUnit, type, t2c, artifact, classifier, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
					c2a, compilationUnit, type, t2c, artifact, classifier, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject c2a, EObject compilationUnit, EObject type, EObject manifestation,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(
			PerformRuleResult ruleresult, EObject compilationUnit, EObject type, EObject manifestation,
		...
		return new Object[] { ruleresult, compilationUnit, type, manifestation, artifact, classifier,
				compilationUnit__type____types, artifact__manifestation____manifestation,
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject c2a,
			EObject compilationUnit, EObject type, EObject manifestation, EObject t2c, EObject artifact,
			EObject classifier) {
		_this.registerObjects_FWD(ruleresult, c2a, compilationUnit, type, manifestation, t2c, artifact, classifier);
		...
		for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(type,
			...
			if (tmpClassifier instanceof Classifier) {
				...
				for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (artifact != null) {
						if (!artifact.equals(classifier)) {
							_result.add(new Object[] { c2a, compilationUnit, type, t2c, artifact, classifier, match });
						}
					}
					...
					if (compilationUnit.equals(c2a.getSource())) {
						if (artifact.equals(c2a.getTarget())) {
							if (classifier.equals(t2c.getTarget())) {
								_result.add(new Object[] { c2a, compilationUnit, type, t2c, artifact, classifier });
							}
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { c2a, compilationUnit, type, t2c, artifact, classifier, isApplicableMatch,
				compilationUnit__type____types, t2c__type____source, c2a__compilationUnit____source,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
			...
			CompilationUnit2Artifact c2a, CompilationUnit compilationUnit, AbstractTypeDeclaration type,
			ASTNode2Element t2c, Artifact artifact, Classifier classifier) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, c2a, compilationUnit, type, t2c,
				artifact, classifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2a, compilationUnit, type, t2c, artifact,
					classifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, c2a, compilationUnit, type, t2c, artifact, classifier);
					...
					if (tmpManifestation instanceof Manifestation) {
						...
						if (tmpT2c instanceof ASTNode2Element) {
							...
							if (tmpArtifact instanceof Artifact) {
								...
								if (tmpClassifier instanceof Classifier) {
									Classifier classifier = (Classifier) tmpClassifier;
									return new Object[] { c2a, compilationUnit, type, manifestation, t2c, artifact,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
			CompilationUnit2Artifact c2a, CompilationUnit compilationUnit, AbstractTypeDeclaration type,
			Manifestation manifestation, ASTNode2Element t2c, Artifact artifact, Classifier classifier,
			Manifestation4CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch) {
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { c2a, compilationUnit, type, manifestation, t2c, artifact, classifier, csp,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
					c2a, compilationUnit, type, manifestation, t2c, artifact, classifier, _this, isApplicableMatch);
			if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black != null) {
				...
				return new Object[] { c2a, compilationUnit, type, manifestation, t2c, artifact, classifier, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject compilationUnit, EObject type, EObject manifestation, EObject t2c, EObject artifact,
			EObject classifier) {
		_this.registerObjects_BWD(ruleresult, c2a, compilationUnit, type, manifestation, t2c, artifact, classifier);
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_12_2_corematch_blackFFFBFBBB(
			...
			for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (compilationUnit != null) {
					for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tmpType instanceof AbstractTypeDeclaration) {
							AbstractTypeDeclaration type = (AbstractTypeDeclaration) tmpType;
							_result.add(new Object[] { c2a, compilationUnit, type, manifestation, t2c, artifact,
									classifier, match });
						}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		manifestation__classifier____utilizedElement.setName(manifestation__classifier____utilizedElement_name_prime);
		t2c__classifier____target.setName(t2c__classifier____target_name_prime);
		return new Object[] { c2a, compilationUnit, type, manifestation, t2c, artifact, classifier, isApplicableMatch,
				t2c__type____source, artifact__manifestation____manifestation, c2a__compilationUnit____source,
				c2a__artifact____target, manifestation__classifier____utilizedElement, t2c__classifier____target };
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			CompilationUnit2Artifact c2a, CompilationUnit compilationUnit, AbstractTypeDeclaration type,
			Manifestation manifestation, ASTNode2Element t2c, Artifact artifact, Classifier classifier) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, c2a, compilationUnit, type,
				manifestation, t2c, artifact, classifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2a, compilationUnit, type, manifestation, t2c,
					artifact, classifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, c2a, compilationUnit, type, manifestation, t2c, artifact, classifier);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_97702 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_97702)) {
					if (!artifact.equals(__DEC_manifestation_client_97702)) {
						if (!classifier.equals(__DEC_manifestation_client_97702)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_505999 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_505999)) {
					if (!artifact.equals(__DEC_manifestation_supplier_505999)) {
						if (!classifier.equals(__DEC_manifestation_supplier_505999)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
			...
			if (tmpType instanceof AbstractTypeDeclaration) {
				...
				if (tmpManifestation instanceof Manifestation) {
					...
					if (tmpArtifact instanceof Artifact) {
						...
						if (tmpClassifier instanceof Classifier) {
							Classifier classifier = (Classifier) tmpClassifier;
							return new Object[] { compilationUnit, type, manifestation, artifact, classifier,
									sourceMatch, targetMatch };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { compilationUnit, type, manifestation, artifact, classifier, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, CompilationUnit compilationUnit, AbstractTypeDeclaration type,
			Manifestation manifestation, Artifact artifact, Classifier classifier, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(compilationUnit, type, manifestation, artifact,
				classifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, compilationUnit, type, manifestation, artifact, classifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding = pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
				_this, compilationUnit, type, manifestation, artifact, classifier, sourceMatch, targetMatch);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, compilationUnit, type, manifestation, artifact, classifier,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackFBBFBBBB(
			CompilationUnit compilationUnit, AbstractTypeDeclaration type, Artifact artifact, Classifier classifier,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { compilationUnit, type, manifestation, artifact, classifier, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_0BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_906719 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_906719)) {
					if (!artifact.equals(__DEC_manifestation_client_906719)) {
						if (!classifier.equals(__DEC_manifestation_client_906719)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_56387 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_56387)) {
					if (!artifact.equals(__DEC_manifestation_supplier_56387)) {
						if (!classifier.equals(__DEC_manifestation_supplier_56387)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, c2a, compilationUnit, type, t2c,
				artifact, classifier, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, c2a, compilationUnit, type, t2c, artifact, classifier,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, c2a, compilationUnit, type, t2c, artifact, classifier, ruleResult);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(
			...
			ASTNode2Element t2c, Artifact artifact, Classifier classifier, ModelgeneratorRuleResult ruleResult) {
		if (!artifact.equals(classifier)) {
			return new Object[] { c2a, compilationUnit, type, t2c, artifact, classifier, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBFBBB(
		...
		return new Object[] { compilationUnit, type, manifestation, artifact, classifier, ruleResult };
	}
