...
public class Manifestation4CompilationUnit2ArtifactImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, t2c,
						compilationUnit, type, classifier, artifact, manifestation, c2a);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[t2c] = " + t2c + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[type] = "
					+ type + ", " + "[classifier] = " + classifier + ", " + "[artifact] = " + artifact + ", "
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(ruleresult,
						compilationUnit, type, classifier, artifact, manifestation);
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(this,
						ruleresult, t2c, compilationUnit, type, classifier, artifact, manifestation, c2a);
		return Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
				...
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(t2c,
								compilationUnit, type, classifier, artifact, c2a);
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, t2c, compilationUnit, type, classifier, artifact, c2a);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[t2c] = " + t2c + ", "
							+ "[compilationUnit] = " + compilationUnit + ", " + "[type] = " + type + ", "
							+ "[classifier] = " + classifier + ", " + "[artifact] = " + artifact + ", " + "[c2a] = "
							+ c2a + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element t2c,
			CompilationUnit compilationUnit, AbstractTypeDeclaration type, Classifier classifier, Artifact artifact,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject t2c, EObject compilationUnit, EObject type,
			EObject classifier, EObject artifact, EObject manifestation, EObject c2a) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_blackBBBBBBB(t2c, compilationUnit,
							type, classifier, artifact, manifestation, c2a)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, t2c, compilationUnit, type, classifier, artifact, manifestation,
								c2a);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[t2c] = " + t2c + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject t2c, EObject compilationUnit, EObject type,
			EObject classifier, EObject artifact, EObject manifestation, EObject c2a) {
		ruleresult.registerObject("t2c", t2c);
		ruleresult.registerObject("compilationUnit", compilationUnit);
		ruleresult.registerObject("type", type);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_50(EMoflonEdge _edge_manifestation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_57(EMoflonEdge _edge_types) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this,
						compilationUnit, type, classifier, artifact, manifestation, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[compilationUnit] = " + compilationUnit + ", " + "[type] = " + type + ", " + "[classifier] = "
					+ classifier + ", " + "[artifact] = " + artifact + ", " + "[manifestation] = " + manifestation
		...
		if (Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result5_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackFBBBBFBB(compilationUnit,
							type, classifier, artifact, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
								compilationUnit, type, classifier, artifact, manifestation, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[compilationUnit] = "
							+ compilationUnit + ", " + "[type] = " + type + ", " + "[classifier] = " + classifier + ", "
	...
	public CSP isApplicable_solveCsp_CC(CompilationUnit compilationUnit, AbstractTypeDeclaration type,
			Classifier classifier, Artifact artifact, Manifestation manifestation, Match sourceMatch,
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, t2c, compilationUnit, type, classifier, artifact, c2a, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[t2c] = " + t2c + ", "
						+ "[compilationUnit] = " + compilationUnit + ", " + "[type] = " + type + ", "
						+ "[classifier] = " + classifier + ", " + "[artifact] = " + artifact + ", " + "[c2a] = " + c2a
				...
				if (result5_black != null) {
					...
					Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(t2c,
									compilationUnit, type, classifier, artifact, c2a, ruleResult);
					if (result6_black == null) {
					...
					Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBBBFB(compilationUnit,
									type, classifier, artifact, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_COMPILATIONUNIT_ABSTRACTTYPEDECLARATION_CLASSIFIER_ARTIFACT_COMPILATIONUNIT2ARTIFACT:
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_COMPILATIONUNIT_ABSTRACTTYPEDECLARATION_CLASSIFIER_ARTIFACT_MANIFESTATION_COMPILATIONUNIT2ARTIFACT:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(CompilationUnit) arguments.get(2), (AbstractTypeDeclaration) arguments.get(3),
					(Classifier) arguments.get(4), (Artifact) arguments.get(5), (Manifestation) arguments.get(6),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_50__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_50((EMoflonEdge) arguments.get(0));
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_57__EMOFLONEDGE:
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_CC__COMPILATIONUNIT_ABSTRACTTYPEDECLARATION_CLASSIFIER_ARTIFACT_MANIFESTATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((CompilationUnit) arguments.get(0),
					...
					(Artifact) arguments.get(3), (Manifestation) arguments.get(4), (Match) arguments.get(5),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_COMPILATIONUNIT_ABSTRACTTYPEDECLARATION_CLASSIFIER_ARTIFACT_COMPILATIONUNIT2ARTIFACT_MODELGENERATORRULERESULT:
					...
					if (tmpClassifier instanceof Classifier) {
						...
						if (tmpArtifact instanceof Artifact) {
							...
							if (tmpC2a instanceof CompilationUnit2Artifact) {
								...
								return new Object[] { t2c, compilationUnit, type, classifier, artifact, c2a,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element t2c, CompilationUnit compilationUnit, AbstractTypeDeclaration type, Classifier classifier,
		...
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { t2c, compilationUnit, type, classifier, artifact, c2a, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
					t2c, compilationUnit, type, classifier, artifact, c2a, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject t2c, EObject compilationUnit, EObject type, EObject classifier,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(
			PerformRuleResult ruleresult, EObject compilationUnit, EObject type, EObject classifier, EObject artifact,
		...
		compilationUnit__type____types.setName(compilationUnit__type____types_name_prime);
		return new Object[] { ruleresult, compilationUnit, type, classifier, artifact, manifestation,
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject compilationUnit, EObject type, EObject classifier, EObject artifact, EObject manifestation,
			EObject c2a) {
		_this.registerObjects_FWD(ruleresult, t2c, compilationUnit, type, classifier, artifact, manifestation, c2a);
			...
			if (artifact != null) {
				for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(type,
					...
					if (tmpClassifier instanceof Classifier) {
						Classifier classifier = (Classifier) tmpClassifier;
						if (!artifact.equals(classifier)) {
							_result.add(new Object[] { t2c, compilationUnit, type, classifier, artifact, c2a, match });
						}
					}
					...
					if (artifact.equals(c2a.getTarget())) {
						if (compilationUnit.equals(c2a.getSource())) {
							if (type.equals(t2c.getSource())) {
								_result.add(new Object[] { t2c, compilationUnit, type, classifier, artifact, c2a });
							}
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { t2c, compilationUnit, type, classifier, artifact, c2a, isApplicableMatch,
				t2c__classifier____target, compilationUnit__type____types, c2a__artifact____target,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, t2c, compilationUnit, type,
				classifier, artifact, c2a);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t2c, compilationUnit, type, classifier, artifact,
					c2a };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, t2c, compilationUnit, type, classifier, artifact, c2a);
					...
					if (tmpClassifier instanceof Classifier) {
						...
						if (tmpArtifact instanceof Artifact) {
							...
							if (tmpManifestation instanceof Manifestation) {
								...
								if (tmpC2a instanceof CompilationUnit2Artifact) {
									CompilationUnit2Artifact c2a = (CompilationUnit2Artifact) tmpC2a;
									return new Object[] { t2c, compilationUnit, type, classifier, artifact,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
		...
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { t2c, compilationUnit, type, classifier, artifact, manifestation, c2a, csp,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
					t2c, compilationUnit, type, classifier, artifact, manifestation, c2a, _this, isApplicableMatch);
			if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black != null) {
				...
				return new Object[] { t2c, compilationUnit, type, classifier, artifact, manifestation, c2a, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject compilationUnit, EObject type, EObject classifier, EObject artifact, EObject manifestation,
			EObject c2a) {
		_this.registerObjects_BWD(ruleresult, t2c, compilationUnit, type, classifier, artifact, manifestation, c2a);
				...
				if (tmpType instanceof AbstractTypeDeclaration) {
					...
					for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (compilationUnit != null) {
							_result.add(new Object[] { t2c, compilationUnit, type, classifier, artifact, manifestation,
									c2a, match });
						}
				...
				if (artifact.getManifestations().contains(manifestation)) {
					if (classifier.equals(manifestation.getUtilizedElement())) {
						if (artifact.equals(c2a.getTarget())) {
							if (compilationUnit.equals(c2a.getSource())) {
								if (type.equals(t2c.getSource())) {
									_result.add(new Object[] { t2c, compilationUnit, type, classifier, artifact,
											manifestation, c2a });
								}
							}
						}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		c2a__compilationUnit____source.setName(c2a__compilationUnit____source_name_prime);
		t2c__type____source.setName(t2c__type____source_name_prime);
		return new Object[] { t2c, compilationUnit, type, classifier, artifact, manifestation, c2a, isApplicableMatch,
				t2c__classifier____target, artifact__manifestation____manifestation,
				manifestation__classifier____utilizedElement, c2a__artifact____target, c2a__compilationUnit____source,
				t2c__type____source };
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, t2c, compilationUnit, type,
				classifier, artifact, manifestation, c2a);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t2c, compilationUnit, type, classifier, artifact,
					manifestation, c2a };
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, t2c, compilationUnit, type, classifier, artifact, manifestation, c2a);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_930247 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_930247)) {
					if (!classifier.equals(__DEC_manifestation_client_930247)) {
						if (!artifact.equals(__DEC_manifestation_client_930247)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_1BBB(
			Manifestation manifestation, Classifier classifier, Artifact artifact) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_783091 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_783091)) {
					if (!classifier.equals(__DEC_manifestation_supplier_783091)) {
						if (!artifact.equals(__DEC_manifestation_supplier_783091)) {
							return new Object[] { manifestation, classifier, artifact };
						}
					}
				}
			...
			if (tmpType instanceof AbstractTypeDeclaration) {
				...
				if (tmpClassifier instanceof Classifier) {
					...
					if (tmpArtifact instanceof Artifact) {
						...
						if (tmpManifestation instanceof Manifestation) {
							Manifestation manifestation = (Manifestation) tmpManifestation;
							return new Object[] { compilationUnit, type, classifier, artifact, manifestation,
									sourceMatch, targetMatch };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { compilationUnit, type, classifier, artifact, manifestation, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
			...
			Classifier classifier, Artifact artifact, Manifestation manifestation, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(compilationUnit, type, classifier, artifact,
				manifestation, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, compilationUnit, type, classifier, artifact, manifestation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding = pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
				_this, compilationUnit, type, classifier, artifact, manifestation, sourceMatch, targetMatch);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, compilationUnit, type, classifier, artifact, manifestation,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { compilationUnit, type, classifier, artifact, manifestation, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_0BBB(
			Manifestation manifestation, Classifier classifier, Artifact artifact) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_508134 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_508134)) {
					if (!classifier.equals(__DEC_manifestation_client_508134)) {
						if (!artifact.equals(__DEC_manifestation_client_508134)) {
							return new Object[] { manifestation, classifier, artifact };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_1BBB(
			Manifestation manifestation, Classifier classifier, Artifact artifact) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_652501 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_652501)) {
					if (!classifier.equals(__DEC_manifestation_supplier_652501)) {
						if (!artifact.equals(__DEC_manifestation_supplier_652501)) {
							return new Object[] { manifestation, classifier, artifact };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, t2c, compilationUnit, type,
				classifier, artifact, c2a, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, t2c, compilationUnit, type, classifier, artifact, c2a,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, t2c, compilationUnit, type, classifier, artifact, c2a, ruleResult);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { t2c, compilationUnit, type, classifier, artifact, c2a, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBBBFB(
		...
		return new Object[] { compilationUnit, type, classifier, artifact, manifestation, ruleResult };
	}
