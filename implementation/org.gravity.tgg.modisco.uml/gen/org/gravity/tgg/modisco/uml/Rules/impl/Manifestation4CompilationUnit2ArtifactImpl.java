...
public class Manifestation4CompilationUnit2ArtifactImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		AbstractTypeDeclaration type = (AbstractTypeDeclaration) result1_bindingAndBlack[2];
		...
		Object[] result3_black = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
						artifact, classifier, type, manifestation, c2a, t2c, compilationUnit);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[artifact] = " + artifact + ", " + "[classifier] = " + classifier + ", " + "[type] = "
					+ type + ", " + "[manifestation] = " + manifestation + ", " + "[c2a] = " + c2a + ", " + "[t2c] = "
					+ t2c + ", " + "[compilationUnit] = " + compilationUnit + ".");
		}
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(ruleresult,
						artifact, classifier, type, manifestation, compilationUnit);
		//nothing EMoflonEdge artifact__manifestation____manifestation = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge type__compilationUnit____originalCompilationUnit = (EMoflonEdge) result3_green[7];
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(this,
						ruleresult, artifact, classifier, type, manifestation, c2a, t2c, compilationUnit);
		return Manifestation4CompilationUnit2ArtifactImpl
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_2_2_corematch_blackFFBFFBB(type, compilationUnit,
						match)) {
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_blackBBBBBB(artifact, classifier,
							type, c2a, t2c, compilationUnit)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFFF(artifact,
								classifier, type, c2a, t2c, compilationUnit);
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, artifact, classifier, type, c2a, t2c, compilationUnit);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[artifact] = " + artifact + ", "
							+ "[classifier] = " + classifier + ", " + "[type] = " + type + ", " + "[c2a] = " + c2a
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Artifact artifact, Classifier classifier,
			AbstractTypeDeclaration type, CompilationUnit2Artifact c2a, ASTNode2Element t2c,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject artifact, EObject classifier, EObject type,
			EObject manifestation, EObject c2a, EObject t2c, EObject compilationUnit) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Classifier classifier = (Classifier) result1_bindingAndBlack[1];
		AbstractTypeDeclaration type = (AbstractTypeDeclaration) result1_bindingAndBlack[2];
		Manifestation manifestation = (Manifestation) result1_bindingAndBlack[3];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_12_2_corematch_blackBBFBFFFB(artifact, classifier,
						manifestation, match)) {
			AbstractTypeDeclaration type = (AbstractTypeDeclaration) result2_black[2];
			...
			// ForEach 
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_blackBBBBBBB(artifact, classifier,
							type, manifestation, c2a, t2c, compilationUnit)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_greenBBBBBBBFFFFFFF(artifact,
								classifier, type, manifestation, c2a, t2c, compilationUnit);
				...
				//nothing EMoflonEdge manifestation__classifier____utilizedElement = (EMoflonEdge) result3_green[12];
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, artifact, classifier, type, manifestation, c2a, t2c,
								compilationUnit);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[artifact] = " + artifact + ", "
							+ "[classifier] = " + classifier + ", " + "[type] = " + type + ", " + "[manifestation] = "
							+ manifestation + ", " + "[c2a] = " + c2a + ", " + "[t2c] = " + t2c + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Artifact artifact, Classifier classifier,
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject artifact, EObject classifier, EObject type,
			EObject manifestation, EObject c2a, EObject t2c, EObject compilationUnit) {
		ruleresult.registerObject("artifact", artifact);
		ruleresult.registerObject("classifier", classifier);
		ruleresult.registerObject("type", type);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_151(EMoflonEdge _edge_manifestation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_156(EMoflonEdge _edge_originalCompilationUnit) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, artifact,
						classifier, type, manifestation, compilationUnit, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[artifact] = " + artifact + ", " + "[classifier] = " + classifier + ", " + "[type] = " + type
		...
		if (Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result5_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBBBFFBBB(artifact,
							classifier, type, compilationUnit, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(artifact,
								classifier, type, manifestation, compilationUnit, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Artifact artifact, Classifier classifier, AbstractTypeDeclaration type,
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, artifact, classifier, type, c2a, t2c, compilationUnit, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[artifact] = " + artifact + ", "
						+ "[classifier] = " + classifier + ", " + "[type] = " + type + ", " + "[c2a] = " + c2a + ", "
						+ "[t2c] = " + t2c + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[ruleResult] = "
						+ ruleResult + ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (Manifestation4CompilationUnit2ArtifactImpl
				...
				// 
				Object[] result5_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_29_5_checknacs_blackBBBBBB(artifact, classifier,
								type, c2a, t2c, compilationUnit);
				if (result5_black != null) {

					Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(artifact,
									classifier, type, c2a, t2c, compilationUnit, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[artifact] = "
								+ artifact + ", " + "[classifier] = " + classifier + ", " + "[type] = " + type + ", "
								+ "[c2a] = " + c2a + ", " + "[t2c] = " + t2c + ", " + "[compilationUnit] = "
								+ compilationUnit + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBBFBB(artifact,
									classifier, type, compilationUnit, ruleResult);
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Artifact artifact, Classifier classifier,
			AbstractTypeDeclaration type, CompilationUnit2Artifact c2a, ASTNode2Element t2c,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ARTIFACT_CLASSIFIER_ABSTRACTTYPEDECLARATION_COMPILATIONUNIT2ARTIFACT_ASTNODE2ELEMENT_COMPILATIONUNIT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Artifact) arguments.get(1),
					(Classifier) arguments.get(2), (AbstractTypeDeclaration) arguments.get(3),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ARTIFACT_CLASSIFIER_ABSTRACTTYPEDECLARATION_MANIFESTATION_COMPILATIONUNIT2ARTIFACT_ASTNODE2ELEMENT_COMPILATIONUNIT:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Artifact) arguments.get(1),
					(Classifier) arguments.get(2), (AbstractTypeDeclaration) arguments.get(3),
					(Manifestation) arguments.get(4), (CompilationUnit2Artifact) arguments.get(5),
					(ASTNode2Element) arguments.get(6), (CompilationUnit) arguments.get(7));
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_151__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_151((EMoflonEdge) arguments.get(0));
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_156__EMOFLONEDGE:
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_CC__ARTIFACT_CLASSIFIER_ABSTRACTTYPEDECLARATION_MANIFESTATION_COMPILATIONUNIT_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Artifact) arguments.get(0), (Classifier) arguments.get(1),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ARTIFACT_CLASSIFIER_ABSTRACTTYPEDECLARATION_COMPILATIONUNIT2ARTIFACT_ASTNODE2ELEMENT_COMPILATIONUNIT_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_0_4_collectelementstobetranslated_greenBBBFF(
		...
		return new Object[] { match, type, compilationUnit, type__compilationUnit____originalCompilationUnit,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_bindingFFFFFFB(
		...
		EObject _localVariable_2 = isApplicableMatch.getObject("type");
					...
					if (tmpC2a instanceof CompilationUnit2Artifact) {
						...
						if (tmpT2c instanceof ASTNode2Element) {
							...
							if (tmpCompilationUnit instanceof CompilationUnit) {
								...
								return new Object[] { artifact, classifier, type, c2a, t2c, compilationUnit,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
			Artifact artifact, Classifier classifier, AbstractTypeDeclaration type, CompilationUnit2Artifact c2a,
		...
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { artifact, classifier, type, c2a, t2c, compilationUnit, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_binding != null) {
			...
			AbstractTypeDeclaration type = (AbstractTypeDeclaration) result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_binding[2];
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
					artifact, classifier, type, c2a, t2c, compilationUnit, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject artifact, EObject classifier, EObject type, EObject manifestation,
			EObject c2a, EObject t2c, EObject compilationUnit) {
		if (!artifact.equals(classifier)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(
		...
		compilationUnit__type____types.setName(compilationUnit__type____types_name_prime);
		return new Object[] { ruleresult, artifact, classifier, type, manifestation, compilationUnit,
				artifact__manifestation____manifestation, type__compilationUnit____originalCompilationUnit,
				manifestation__classifier____utilizedElement, compilationUnit__type____types };
	}

	public static final void pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject artifact,
			EObject classifier, EObject type, EObject manifestation, EObject c2a, EObject t2c,
			EObject compilationUnit) {
		_this.registerObjects_FWD(ruleresult, artifact, classifier, type, manifestation, c2a, t2c, compilationUnit);
		...
		for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(type,
			...
			if (tmpClassifier instanceof Classifier) {
				...
				for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (artifact != null) {
						if (!artifact.equals(classifier)) {
							_result.add(new Object[] { artifact, classifier, type, c2a, t2c, compilationUnit, match });
						}
					}
						...
						if (classifier.equals(t2c.getTarget())) {
							if (compilationUnit.getTypes().contains(type)) {
								if (compilationUnit.equals(c2a.getSource())) {
									_result.add(new Object[] { artifact, classifier, type, c2a, t2c, compilationUnit });
								}
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { artifact, classifier, type, c2a, t2c, compilationUnit, isApplicableMatch,
				type__compilationUnit____originalCompilationUnit, t2c__type____source, c2a__artifact____target,
				t2c__classifier____target, compilationUnit__type____types, c2a__compilationUnit____source };
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
			...
			Classifier classifier, AbstractTypeDeclaration type, CompilationUnit2Artifact c2a, ASTNode2Element t2c,
			CompilationUnit compilationUnit) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, artifact, classifier, type, c2a, t2c,
				compilationUnit);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, artifact, classifier, type, c2a, t2c,
					compilationUnit };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, artifact, classifier, type, c2a, t2c, compilationUnit);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_bindingFFFFFFFB(
		...
		EObject _localVariable_1 = isApplicableMatch.getObject("classifier");
		EObject _localVariable_2 = isApplicableMatch.getObject("type");
		EObject _localVariable_3 = isApplicableMatch.getObject("manifestation");
					...
					if (tmpManifestation instanceof Manifestation) {
						...
						if (tmpC2a instanceof CompilationUnit2Artifact) {
							...
							if (tmpT2c instanceof ASTNode2Element) {
								...
								if (tmpCompilationUnit instanceof CompilationUnit) {
									CompilationUnit compilationUnit = (CompilationUnit) tmpCompilationUnit;
									return new Object[] { artifact, classifier, type, manifestation, c2a, t2c,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
			Artifact artifact, Classifier classifier, AbstractTypeDeclaration type, Manifestation manifestation,
			CompilationUnit2Artifact c2a, ASTNode2Element t2c, CompilationUnit compilationUnit,
			Manifestation4CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch) {
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { artifact, classifier, type, manifestation, c2a, t2c, compilationUnit, csp,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_binding != null) {
			...
			AbstractTypeDeclaration type = (AbstractTypeDeclaration) result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_binding[2];
			Manifestation manifestation = (Manifestation) result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_binding[3];
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
					artifact, classifier, type, manifestation, c2a, t2c, compilationUnit, _this, isApplicableMatch);
			if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black != null) {
				...
				return new Object[] { artifact, classifier, type, manifestation, c2a, t2c, compilationUnit, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject classifier, EObject type, EObject manifestation, EObject c2a, EObject t2c,
			EObject compilationUnit) {
		_this.registerObjects_BWD(ruleresult, artifact, classifier, type, manifestation, c2a, t2c, compilationUnit);
			...
			for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (compilationUnit != null) {
					for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tmpType instanceof AbstractTypeDeclaration) {
							AbstractTypeDeclaration type = (AbstractTypeDeclaration) tmpType;
							_result.add(new Object[] { artifact, classifier, type, manifestation, c2a, t2c,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		manifestation__classifier____utilizedElement.setName(manifestation__classifier____utilizedElement_name_prime);
		c2a__compilationUnit____source.setName(c2a__compilationUnit____source_name_prime);
		return new Object[] { artifact, classifier, type, manifestation, c2a, t2c, compilationUnit, isApplicableMatch,
				artifact__manifestation____manifestation, t2c__type____source, c2a__artifact____target,
				t2c__classifier____target, manifestation__classifier____utilizedElement,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch, Artifact artifact,
			Classifier classifier, AbstractTypeDeclaration type, Manifestation manifestation,
			CompilationUnit2Artifact c2a, ASTNode2Element t2c, CompilationUnit compilationUnit) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, artifact, classifier, type,
				manifestation, c2a, t2c, compilationUnit);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, artifact, classifier, type, manifestation, c2a, t2c,
					compilationUnit };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, artifact, classifier, type, manifestation, c2a, t2c, compilationUnit);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, artifact, classifier, type, manifestation, c2a,
						t2c, compilationUnit };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_474542 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_474542)) {
					if (!artifact.equals(__DEC_manifestation_client_474542)) {
						if (!classifier.equals(__DEC_manifestation_client_474542)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_37786 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_37786)) {
					if (!artifact.equals(__DEC_manifestation_supplier_37786)) {
						if (!classifier.equals(__DEC_manifestation_supplier_37786)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_2B(
			Manifestation manifestation) {
		for (org.eclipse.uml2.uml.Package __DEC_manifestation_packagedElement_777108 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_21_2_testcorematchandDECs_blackFFB(
		...
		if (tmpType instanceof AbstractTypeDeclaration) {
			...
			if (tmpCompilationUnit instanceof CompilationUnit) {
				...
				if (compilationUnit.equals(type.getOriginalCompilationUnit())) {
					if (compilationUnit.getTypes().contains(type)) {
						_result.add(new Object[] { type, compilationUnit, _edge_originalCompilationUnit });
					}
				}
			}
			...
			if (tmpClassifier instanceof Classifier) {
				...
				if (tmpType instanceof AbstractTypeDeclaration) {
					...
					if (tmpManifestation instanceof Manifestation) {
						...
						if (tmpCompilationUnit instanceof CompilationUnit) {
							CompilationUnit compilationUnit = (CompilationUnit) tmpCompilationUnit;
							return new Object[] { artifact, classifier, type, manifestation, compilationUnit,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { artifact, classifier, type, manifestation, compilationUnit, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_black = pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
					artifact, classifier, type, manifestation, compilationUnit, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, Artifact artifact, Classifier classifier,
			AbstractTypeDeclaration type, Manifestation manifestation, CompilationUnit compilationUnit,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(artifact, classifier, type, manifestation,
				compilationUnit, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, artifact, classifier, type, manifestation, compilationUnit, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding = pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
				_this, artifact, classifier, type, manifestation, compilationUnit, sourceMatch, targetMatch);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, artifact, classifier, type, manifestation, compilationUnit,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBBBFFBBB(
			Artifact artifact, Classifier classifier, AbstractTypeDeclaration type, CompilationUnit compilationUnit,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { artifact, classifier, type, manifestation, compilationUnit, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_0BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_501011 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_501011)) {
					if (!artifact.equals(__DEC_manifestation_client_501011)) {
						if (!classifier.equals(__DEC_manifestation_client_501011)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_608027 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_608027)) {
					if (!artifact.equals(__DEC_manifestation_supplier_608027)) {
						if (!classifier.equals(__DEC_manifestation_supplier_608027)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_2B(
			Manifestation manifestation) {
		for (org.eclipse.uml2.uml.Package __DEC_manifestation_packagedElement_705595 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(manifestation, org.eclipse.uml2.uml.Package.class, "packagedElement")) {
			return new Object[] { manifestation };
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, artifact, classifier, type, c2a, t2c,
				compilationUnit, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, artifact, classifier, type, c2a, t2c, compilationUnit,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, artifact, classifier, type, c2a, t2c, compilationUnit, ruleResult);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { artifact, classifier, type, c2a, t2c, compilationUnit, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBBFBB(
		...
		return new Object[] { artifact, classifier, type, manifestation, compilationUnit, ruleResult };
	}
