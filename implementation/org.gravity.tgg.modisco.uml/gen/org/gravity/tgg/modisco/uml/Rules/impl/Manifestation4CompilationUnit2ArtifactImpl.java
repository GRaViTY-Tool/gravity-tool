...
public class Manifestation4CompilationUnit2ArtifactImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
						manifestation, artifact, c2a, t2c, type, classifier, compilationUnit);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[manifestation] = " + manifestation + ", " + "[artifact] = " + artifact + ", "
					+ "[c2a] = " + c2a + ", " + "[t2c] = " + t2c + ", " + "[type] = " + type + ", " + "[classifier] = "
					+ classifier + ", " + "[compilationUnit] = " + compilationUnit + ".");
		}
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(ruleresult,
						manifestation, artifact, type, classifier, compilationUnit);
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(this,
						ruleresult, manifestation, artifact, c2a, t2c, type, classifier, compilationUnit);
		return Manifestation4CompilationUnit2ArtifactImpl
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_blackBBBBBB(artifact, c2a, t2c,
							type, classifier, compilationUnit)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(artifact, c2a,
								t2c, type, classifier, compilationUnit);
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, artifact, c2a, t2c, type, classifier, compilationUnit);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject manifestation, EObject artifact, EObject c2a,
			EObject t2c, EObject type, EObject classifier, EObject compilationUnit) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_blackBBBBBBB(manifestation,
							artifact, c2a, t2c, type, classifier, compilationUnit)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, manifestation, artifact, c2a, t2c, type, classifier,
								compilationUnit);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Manifestation manifestation,
			Artifact artifact, CompilationUnit2Artifact c2a, ASTNode2Element t2c, AbstractTypeDeclaration type,
			Classifier classifier, CompilationUnit compilationUnit) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_146(EMoflonEdge _edge_manifestation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_157(EMoflonEdge _edge_types) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this,
						manifestation, artifact, type, classifier, compilationUnit, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[manifestation] = " + manifestation + ", " + "[artifact] = " + artifact + ", " + "[type] = "
					+ type + ", " + "[classifier] = " + classifier + ", " + "[compilationUnit] = " + compilationUnit
		...
		if (Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result5_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBFFBBBBB(artifact, type,
				...
				Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
								manifestation, artifact, type, classifier, compilationUnit, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[manifestation] = "
							+ manifestation + ", " + "[artifact] = " + artifact + ", " + "[type] = " + type + ", "
							+ "[classifier] = " + classifier + ", " + "[compilationUnit] = " + compilationUnit + ", "
							+ "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Manifestation manifestation, Artifact artifact, AbstractTypeDeclaration type,
			Classifier classifier, CompilationUnit compilationUnit, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, artifact, c2a, t2c, type, classifier, compilationUnit, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[artifact] = " + artifact + ", "
						+ "[c2a] = " + c2a + ", " + "[t2c] = " + t2c + ", " + "[type] = " + type + ", "
				...
				if (result5_black != null) {
					...
					Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(artifact, c2a,
									t2c, type, classifier, compilationUnit, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[artifact] = "
								+ artifact + ", " + "[c2a] = " + c2a + ", " + "[t2c] = " + t2c + ", " + "[type] = "
								+ type + ", " + "[classifier] = " + classifier + ", " + "[compilationUnit] = "
								+ compilationUnit + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenFBBBBB(artifact, type,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ARTIFACT_COMPILATIONUNIT2ARTIFACT_ASTNODE2ELEMENT_ABSTRACTTYPEDECLARATION_CLASSIFIER_COMPILATIONUNIT:
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MANIFESTATION_ARTIFACT_COMPILATIONUNIT2ARTIFACT_ASTNODE2ELEMENT_ABSTRACTTYPEDECLARATION_CLASSIFIER_COMPILATIONUNIT:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Manifestation) arguments.get(1),
					...
					(Classifier) arguments.get(6), (CompilationUnit) arguments.get(7));
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_146__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_146((EMoflonEdge) arguments.get(0));
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_157__EMOFLONEDGE:
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_CC__MANIFESTATION_ARTIFACT_ABSTRACTTYPEDECLARATION_CLASSIFIER_COMPILATIONUNIT_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Manifestation) arguments.get(0), (Artifact) arguments.get(1),
					(AbstractTypeDeclaration) arguments.get(2), (Classifier) arguments.get(3),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ARTIFACT_COMPILATIONUNIT2ARTIFACT_ASTNODE2ELEMENT_ABSTRACTTYPEDECLARATION_CLASSIFIER_COMPILATIONUNIT_MODELGENERATORRULERESULT:
					...
					if (tmpType instanceof AbstractTypeDeclaration) {
						...
						if (tmpClassifier instanceof Classifier) {
							...
							if (tmpCompilationUnit instanceof CompilationUnit) {
								...
								return new Object[] { artifact, c2a, t2c, type, classifier, compilationUnit,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
			Artifact artifact, CompilationUnit2Artifact c2a, ASTNode2Element t2c, AbstractTypeDeclaration type,
			Classifier classifier, CompilationUnit compilationUnit, Manifestation4CompilationUnit2Artifact _this,
			IsApplicableMatch isApplicableMatch) {
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { artifact, c2a, t2c, type, classifier, compilationUnit, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
					artifact, c2a, t2c, type, classifier, compilationUnit, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(
			...
			EObject type, EObject classifier, EObject compilationUnit) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(
			PerformRuleResult ruleresult, EObject manifestation, EObject artifact, EObject type, EObject classifier,
		...
		compilationUnit__type____types.setName(compilationUnit__type____types_name_prime);
		return new Object[] { ruleresult, manifestation, artifact, type, classifier, compilationUnit,
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject artifact, EObject c2a, EObject t2c, EObject type, EObject classifier, EObject compilationUnit) {
		_this.registerObjects_FWD(ruleresult, manifestation, artifact, c2a, t2c, type, classifier, compilationUnit);
		...
		for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(type,
			...
			if (tmpClassifier instanceof Classifier) {
				...
				for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (artifact != null) {
						if (!artifact.equals(classifier)) {
							_result.add(new Object[] { artifact, c2a, t2c, type, classifier, compilationUnit, match });
						}
					}
					...
					if (type.equals(t2c.getSource())) {
						if (compilationUnit.getTypes().contains(type)) {
							if (compilationUnit.equals(c2a.getSource())) {
								_result.add(new Object[] { artifact, c2a, t2c, type, classifier, compilationUnit });
							}
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { artifact, c2a, t2c, type, classifier, compilationUnit, isApplicableMatch,
				t2c__classifier____target, c2a__artifact____target, t2c__type____source, compilationUnit__type____types,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
			...
			CompilationUnit2Artifact c2a, ASTNode2Element t2c, AbstractTypeDeclaration type, Classifier classifier,
			CompilationUnit compilationUnit) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, artifact, c2a, t2c, type, classifier,
				compilationUnit);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, artifact, c2a, t2c, type, classifier,
					compilationUnit };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, artifact, c2a, t2c, type, classifier, compilationUnit);
					...
					if (tmpT2c instanceof ASTNode2Element) {
						...
						if (tmpType instanceof AbstractTypeDeclaration) {
							...
							if (tmpClassifier instanceof Classifier) {
								...
								if (tmpCompilationUnit instanceof CompilationUnit) {
									CompilationUnit compilationUnit = (CompilationUnit) tmpCompilationUnit;
									return new Object[] { manifestation, artifact, c2a, t2c, type, classifier,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
			...
			AbstractTypeDeclaration type, Classifier classifier, CompilationUnit compilationUnit,
			Manifestation4CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch) {
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { manifestation, artifact, c2a, t2c, type, classifier, compilationUnit, csp,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
					manifestation, artifact, c2a, t2c, type, classifier, compilationUnit, _this, isApplicableMatch);
			if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black != null) {
				...
				return new Object[] { manifestation, artifact, c2a, t2c, type, classifier, compilationUnit, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject manifestation,
			EObject artifact, EObject c2a, EObject t2c, EObject type, EObject classifier, EObject compilationUnit) {
		_this.registerObjects_BWD(ruleresult, manifestation, artifact, c2a, t2c, type, classifier, compilationUnit);
				...
				if (tmpType instanceof AbstractTypeDeclaration) {
					...
					for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (compilationUnit != null) {
							_result.add(new Object[] { manifestation, artifact, c2a, t2c, type, classifier,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		manifestation__classifier____utilizedElement.setName(manifestation__classifier____utilizedElement_name_prime);
		c2a__compilationUnit____source.setName(c2a__compilationUnit____source_name_prime);
		return new Object[] { manifestation, artifact, c2a, t2c, type, classifier, compilationUnit, isApplicableMatch,
				artifact__manifestation____manifestation, t2c__classifier____target, c2a__artifact____target,
				t2c__type____source, manifestation__classifier____utilizedElement, c2a__compilationUnit____source };
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, manifestation, artifact, c2a, t2c, type, classifier,
					compilationUnit };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, manifestation, artifact, c2a, t2c, type, classifier, compilationUnit);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, manifestation, artifact, c2a, t2c, type,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_634340 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_634340)) {
					if (!artifact.equals(__DEC_manifestation_client_634340)) {
						if (!classifier.equals(__DEC_manifestation_client_634340)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_452192 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_452192)) {
					if (!artifact.equals(__DEC_manifestation_supplier_452192)) {
						if (!classifier.equals(__DEC_manifestation_supplier_452192)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
			...
			if (tmpArtifact instanceof Artifact) {
				...
				if (tmpType instanceof AbstractTypeDeclaration) {
					...
					if (tmpClassifier instanceof Classifier) {
						...
						if (tmpCompilationUnit instanceof CompilationUnit) {
							CompilationUnit compilationUnit = (CompilationUnit) tmpCompilationUnit;
							return new Object[] { manifestation, artifact, type, classifier, compilationUnit,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
			Manifestation manifestation, Artifact artifact, AbstractTypeDeclaration type, Classifier classifier,
			CompilationUnit compilationUnit, Match sourceMatch, Match targetMatch) {
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { manifestation, artifact, type, classifier, compilationUnit, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
			...
			AbstractTypeDeclaration type, Classifier classifier, CompilationUnit compilationUnit, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(manifestation, artifact, type, classifier,
				compilationUnit, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, manifestation, artifact, type, classifier, compilationUnit, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding = pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
				_this, manifestation, artifact, type, classifier, compilationUnit, sourceMatch, targetMatch);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, manifestation, artifact, type, classifier, compilationUnit,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBFFBBBBB(
			Artifact artifact, AbstractTypeDeclaration type, Classifier classifier, CompilationUnit compilationUnit,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { manifestation, artifact, type, classifier, compilationUnit, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_0BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_603184 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_603184)) {
					if (!artifact.equals(__DEC_manifestation_client_603184)) {
						if (!classifier.equals(__DEC_manifestation_client_603184)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_1BBB(
			Manifestation manifestation, Artifact artifact, Classifier classifier) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_178632 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_178632)) {
					if (!artifact.equals(__DEC_manifestation_supplier_178632)) {
						if (!classifier.equals(__DEC_manifestation_supplier_178632)) {
							return new Object[] { manifestation, artifact, classifier };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, artifact, c2a, t2c, type, classifier,
				compilationUnit, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, artifact, c2a, t2c, type, classifier, compilationUnit,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, artifact, c2a, t2c, type, classifier, compilationUnit, ruleResult);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(
			Artifact artifact, CompilationUnit2Artifact c2a, ASTNode2Element t2c, AbstractTypeDeclaration type,
			Classifier classifier, CompilationUnit compilationUnit, ModelgeneratorRuleResult ruleResult) {
		if (!artifact.equals(classifier)) {
			return new Object[] { artifact, c2a, t2c, type, classifier, compilationUnit, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenFBBBBB(
		...
		return new Object[] { manifestation, artifact, type, classifier, compilationUnit, ruleResult };
	}
