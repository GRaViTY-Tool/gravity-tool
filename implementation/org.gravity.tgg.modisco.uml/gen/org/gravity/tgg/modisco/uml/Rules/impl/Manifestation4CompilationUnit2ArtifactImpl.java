...
public class Manifestation4CompilationUnit2ArtifactImpl extends AbstractRuleImpl
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, type,
						classifier, t2c, compilationUnit, artifact, manifestation, c2a);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[type] = " + type + ", " + "[classifier] = " + classifier + ", " + "[t2c] = " + t2c + ", "
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(ruleresult, type,
						classifier, compilationUnit, artifact, manifestation);
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(this,
						ruleresult, type, classifier, t2c, compilationUnit, artifact, manifestation, c2a);
		return Manifestation4CompilationUnit2ArtifactImpl
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_2_2_corematch_blackBFFBFFB(type, compilationUnit,
						match)) {
			...
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_blackBBBBBB(type, classifier, t2c,
							compilationUnit, artifact, c2a)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(type,
								classifier, t2c, compilationUnit, artifact, c2a);
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, type, classifier, t2c, compilationUnit, artifact, c2a);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[type] = " + type + ", "
							+ "[classifier] = " + classifier + ", " + "[t2c] = " + t2c + ", " + "[compilationUnit] = "
							+ compilationUnit + ", " + "[artifact] = " + artifact + ", " + "[c2a] = " + c2a + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AbstractTypeDeclaration type,
			Classifier classifier, ASTNode2Element t2c, CompilationUnit compilationUnit, Artifact artifact,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject type, EObject classifier, EObject t2c,
			EObject compilationUnit, EObject artifact, EObject manifestation, EObject c2a) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_11_3_bookkeepingforedges_greenBBBBBBFFF(ruleresult,
						type, classifier, compilationUnit, artifact, manifestation);
		//nothing EMoflonEdge artifact__manifestation____manifestation = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge compilationUnit__type____types = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge manifestation__classifier____utilizedElement = (EMoflonEdge) result3_green[8];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_12_2_corematch_blackFBFFBBFB(classifier, artifact,
						manifestation, match)) {
			...
			// ForEach 
			for (Object[] result3_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_blackBBBBBBB(type, classifier, t2c,
							compilationUnit, artifact, manifestation, c2a)) {
				Object[] result3_green = Manifestation4CompilationUnit2ArtifactImpl
				...
				Object[] result4_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, type, classifier, t2c, compilationUnit, artifact, manifestation,
								c2a);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[type] = " + type + ", "
							+ "[classifier] = " + classifier + ", " + "[t2c] = " + t2c + ", " + "[compilationUnit] = "
							+ compilationUnit + ", " + "[artifact] = " + artifact + ", " + "[manifestation] = "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject type, EObject classifier, EObject t2c,
			EObject compilationUnit, EObject artifact, EObject manifestation, EObject c2a) {
		ruleresult.registerObject("type", type);
		ruleresult.registerObject("classifier", classifier);
		ruleresult.registerObject("t2c", t2c);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_94(EMoflonEdge _edge_manifestation) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_100(EMoflonEdge _edge_types) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
				.pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, type,
						classifier, compilationUnit, artifact, manifestation, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[type] = " + type + ", " + "[classifier] = " + classifier + ", " + "[compilationUnit] = "
					+ compilationUnit + ", " + "[artifact] = " + artifact + ", " + "[manifestation] = " + manifestation
		...
		if (Manifestation4CompilationUnit2ArtifactImpl
			...
			for (Object[] result5_black : Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBBFBBFBB(type,
							classifier, compilationUnit, artifact, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(type,
								classifier, compilationUnit, artifact, manifestation, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(AbstractTypeDeclaration type, Classifier classifier,
			CompilationUnit compilationUnit, Artifact artifact, Manifestation manifestation, Match sourceMatch,
		...
		for (Object[] result2_black : Manifestation4CompilationUnit2ArtifactImpl
			...
			Object[] result3_bindingAndBlack = Manifestation4CompilationUnit2ArtifactImpl
					.pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, type, classifier, t2c, compilationUnit, artifact, c2a, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[type] = " + type + ", "
						+ "[classifier] = " + classifier + ", " + "[t2c] = " + t2c + ", " + "[compilationUnit] = "
			...
			if (Manifestation4CompilationUnit2ArtifactImpl
				...
				// 
				Object[] result5_black = Manifestation4CompilationUnit2ArtifactImpl
						.pattern_Manifestation4CompilationUnit2Artifact_29_5_checknacs_blackBBBBBB(type, classifier,
								t2c, compilationUnit, artifact, c2a);
				if (result5_black != null) {

					Object[] result6_black = Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(type, classifier,
									t2c, compilationUnit, artifact, c2a, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[type] = " + type
					...
					Manifestation4CompilationUnit2ArtifactImpl
							.pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBBBFB(type, classifier,
									compilationUnit, artifact, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_CLASSIFIER_ASTNODE2ELEMENT_COMPILATIONUNIT_ARTIFACT_COMPILATIONUNIT2ARTIFACT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(AbstractTypeDeclaration) arguments.get(1), (Classifier) arguments.get(2),
					(ASTNode2Element) arguments.get(3), (CompilationUnit) arguments.get(4), (Artifact) arguments.get(5),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_CLASSIFIER_ASTNODE2ELEMENT_COMPILATIONUNIT_ARTIFACT_MANIFESTATION_COMPILATIONUNIT2ARTIFACT:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(AbstractTypeDeclaration) arguments.get(1), (Classifier) arguments.get(2),
					(ASTNode2Element) arguments.get(3), (CompilationUnit) arguments.get(4), (Artifact) arguments.get(5),
					(Manifestation) arguments.get(6), (CompilationUnit2Artifact) arguments.get(7));
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_94__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_94((EMoflonEdge) arguments.get(0));
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_100__EMOFLONEDGE:
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_CC__ABSTRACTTYPEDECLARATION_CLASSIFIER_COMPILATIONUNIT_ARTIFACT_MANIFESTATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((AbstractTypeDeclaration) arguments.get(0), (Classifier) arguments.get(1),
					(CompilationUnit) arguments.get(2), (Artifact) arguments.get(3), (Manifestation) arguments.get(4),
		...
		case RulesPackage.MANIFESTATION4_COMPILATION_UNIT2_ARTIFACT___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ABSTRACTTYPEDECLARATION_CLASSIFIER_ASTNODE2ELEMENT_COMPILATIONUNIT_ARTIFACT_COMPILATIONUNIT2ARTIFACT_MODELGENERATORRULERESULT:
					...
					if (tmpCompilationUnit instanceof CompilationUnit) {
						...
						if (tmpArtifact instanceof Artifact) {
							...
							if (tmpC2a instanceof CompilationUnit2Artifact) {
								...
								return new Object[] { type, classifier, t2c, compilationUnit, artifact, c2a,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
			AbstractTypeDeclaration type, Classifier classifier, ASTNode2Element t2c, CompilationUnit compilationUnit,
			Artifact artifact, CompilationUnit2Artifact c2a, Manifestation4CompilationUnit2Artifact _this,
			IsApplicableMatch isApplicableMatch) {
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { type, classifier, t2c, compilationUnit, artifact, c2a, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_1_1_performtransformation_blackBBBBBBFBB(
					type, classifier, t2c, compilationUnit, artifact, c2a, _this, isApplicableMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject type, EObject classifier, EObject t2c, EObject compilationUnit,
			EObject artifact, EObject manifestation, EObject c2a) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFF(
			PerformRuleResult ruleresult, EObject type, EObject classifier, EObject compilationUnit, EObject artifact,
		...
		return new Object[] { ruleresult, type, classifier, compilationUnit, artifact, manifestation,
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject classifier, EObject t2c, EObject compilationUnit, EObject artifact, EObject manifestation,
			EObject c2a) {
		_this.registerObjects_FWD(ruleresult, type, classifier, t2c, compilationUnit, artifact, manifestation, c2a);
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_2_2_corematch_blackBFFBFFB(
		...
		for (ASTNode2Element t2c : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(type,
			...
			if (tmpClassifier instanceof Classifier) {
				...
				for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (artifact != null) {
						if (!artifact.equals(classifier)) {
							_result.add(new Object[] { type, classifier, t2c, compilationUnit, artifact, c2a, match });
						}
					}
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_blackBBBBBB(
			AbstractTypeDeclaration type, Classifier classifier, ASTNode2Element t2c, CompilationUnit compilationUnit,
			Artifact artifact, CompilationUnit2Artifact c2a) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!artifact.equals(classifier)) {
					...
					if (compilationUnit.equals(c2a.getSource())) {
						if (artifact.equals(c2a.getTarget())) {
							if (compilationUnit.getTypes().contains(type)) {
								_result.add(new Object[] { type, classifier, t2c, compilationUnit, artifact, c2a });
							}
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_3_findcontext_greenBBBBBBFFFFFF(
		...
		compilationUnit__type____types.setName(compilationUnit__type____types_name_prime);
		return new Object[] { type, classifier, t2c, compilationUnit, artifact, c2a, isApplicableMatch,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
			...
			AbstractTypeDeclaration type, Classifier classifier, ASTNode2Element t2c, CompilationUnit compilationUnit,
			Artifact artifact, CompilationUnit2Artifact c2a) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, type, classifier, t2c,
				compilationUnit, artifact, c2a);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, type, classifier, t2c, compilationUnit, artifact,
					c2a };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, type, classifier, t2c, compilationUnit, artifact, c2a);
					...
					if (tmpCompilationUnit instanceof CompilationUnit) {
						...
						if (tmpArtifact instanceof Artifact) {
							...
							if (tmpManifestation instanceof Manifestation) {
								...
								if (tmpC2a instanceof CompilationUnit2Artifact) {
									CompilationUnit2Artifact c2a = (CompilationUnit2Artifact) tmpC2a;
									return new Object[] { type, classifier, t2c, compilationUnit, artifact,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
			AbstractTypeDeclaration type, Classifier classifier, ASTNode2Element t2c, CompilationUnit compilationUnit,
			Artifact artifact, Manifestation manifestation, CompilationUnit2Artifact c2a,
			Manifestation4CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch) {
		if (!artifact.equals(classifier)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { type, classifier, t2c, compilationUnit, artifact, manifestation, c2a, csp,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black = pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_blackBBBBBBBFBB(
					type, classifier, t2c, compilationUnit, artifact, manifestation, c2a, _this, isApplicableMatch);
			if (result_pattern_Manifestation4CompilationUnit2Artifact_11_1_performtransformation_black != null) {
				...
				return new Object[] { type, classifier, t2c, compilationUnit, artifact, manifestation, c2a, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final void pattern_Manifestation4CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject classifier, EObject t2c, EObject compilationUnit, EObject artifact, EObject manifestation,
			EObject c2a) {
		_this.registerObjects_BWD(ruleresult, type, classifier, t2c, compilationUnit, artifact, manifestation, c2a);
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_12_2_corematch_blackFBFFBBFB(
				...
				if (tmpType instanceof AbstractTypeDeclaration) {
					...
					for (CompilationUnit2Artifact c2a : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (compilationUnit != null) {
							_result.add(new Object[] { type, classifier, t2c, compilationUnit, artifact, manifestation,
									c2a, match });
						}
						...
						if (artifact.equals(c2a.getTarget())) {
							if (artifact.getManifestations().contains(manifestation)) {
								if (classifier.equals(manifestation.getUtilizedElement())) {
									_result.add(new Object[] { type, classifier, t2c, compilationUnit, artifact,
											manifestation, c2a });
								}
							}
						}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_3_findcontext_greenBBBBBBBFFFFFFF(
		...
		artifact__manifestation____manifestation.setName(artifact__manifestation____manifestation_name_prime);
		manifestation__classifier____utilizedElement.setName(manifestation__classifier____utilizedElement_name_prime);
		return new Object[] { type, classifier, t2c, compilationUnit, artifact, manifestation, c2a, isApplicableMatch,
				t2c__type____source, t2c__classifier____target, c2a__compilationUnit____source, c2a__artifact____target,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			AbstractTypeDeclaration type, Classifier classifier, ASTNode2Element t2c, CompilationUnit compilationUnit,
			Artifact artifact, Manifestation manifestation, CompilationUnit2Artifact c2a) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, type, classifier, t2c,
				compilationUnit, artifact, manifestation, c2a);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, type, classifier, t2c, compilationUnit, artifact,
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, type, classifier, t2c, compilationUnit, artifact, manifestation, c2a);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_428454 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_428454)) {
					if (!classifier.equals(__DEC_manifestation_client_428454)) {
						if (!artifact.equals(__DEC_manifestation_client_428454)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_1BBB(
			Manifestation manifestation, Classifier classifier, Artifact artifact) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_31418 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_31418)) {
					if (!classifier.equals(__DEC_manifestation_supplier_31418)) {
						if (!artifact.equals(__DEC_manifestation_supplier_31418)) {
							return new Object[] { manifestation, classifier, artifact };
						}
					}
				}
			...
			if (tmpClassifier instanceof Classifier) {
				...
				if (tmpCompilationUnit instanceof CompilationUnit) {
					...
					if (tmpArtifact instanceof Artifact) {
						...
						if (tmpManifestation instanceof Manifestation) {
							Manifestation manifestation = (Manifestation) tmpManifestation;
							return new Object[] { type, classifier, compilationUnit, artifact, manifestation,
									sourceMatch, targetMatch };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
			AbstractTypeDeclaration type, Classifier classifier, CompilationUnit compilationUnit, Artifact artifact,
			Manifestation manifestation, Match sourceMatch, Match targetMatch) {
		if (!artifact.equals(classifier)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { type, classifier, compilationUnit, artifact, manifestation, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_black = pattern_Manifestation4CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBBB(
					type, classifier, compilationUnit, artifact, manifestation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
			...
			CompilationUnit compilationUnit, Artifact artifact, Manifestation manifestation, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(type, classifier, compilationUnit, artifact,
				manifestation, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, type, classifier, compilationUnit, artifact, manifestation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding = pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBBB(
				_this, type, classifier, compilationUnit, artifact, manifestation, sourceMatch, targetMatch);
		if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_Manifestation4CompilationUnit2Artifact_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, type, classifier, compilationUnit, artifact, manifestation,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_Manifestation4CompilationUnit2Artifact_24_5_matchcorrcontext_blackBBFBBFBB(
			AbstractTypeDeclaration type, Classifier classifier, CompilationUnit compilationUnit, Artifact artifact,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!artifact.equals(classifier)) {
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBBB(
		...
		if (!artifact.equals(classifier)) {
			return new Object[] { type, classifier, compilationUnit, artifact, manifestation, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_0BBB(
			Manifestation manifestation, Classifier classifier, Artifact artifact) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_client_281305 : manifestation.getClients()) {
				if (!manifestation.equals(__DEC_manifestation_client_281305)) {
					if (!classifier.equals(__DEC_manifestation_client_281305)) {
						if (!artifact.equals(__DEC_manifestation_client_281305)) {
							return new Object[] { manifestation, classifier, artifact };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_1BBB(
			Manifestation manifestation, Classifier classifier, Artifact artifact) {
		if (!artifact.equals(classifier)) {
			for (NamedElement __DEC_manifestation_supplier_308937 : manifestation.getSuppliers()) {
				if (!manifestation.equals(__DEC_manifestation_supplier_308937)) {
					if (!classifier.equals(__DEC_manifestation_supplier_308937)) {
						if (!artifact.equals(__DEC_manifestation_supplier_308937)) {
							return new Object[] { manifestation, classifier, artifact };
						}
					}
				}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
			Manifestation4CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch,
			AbstractTypeDeclaration type, Classifier classifier, ASTNode2Element t2c, CompilationUnit compilationUnit,
			Artifact artifact, CompilationUnit2Artifact c2a, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, type, classifier, t2c,
				compilationUnit, artifact, c2a, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, type, classifier, t2c, compilationUnit, artifact, c2a,
					ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_binding = pattern_Manifestation4CompilationUnit2Artifact_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, type, classifier, t2c, compilationUnit, artifact, c2a, ruleResult);
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_blackBBBBBBB(
			...
			Artifact artifact, CompilationUnit2Artifact c2a, ModelgeneratorRuleResult ruleResult) {
		if (!artifact.equals(classifier)) {
			return new Object[] { type, classifier, t2c, compilationUnit, artifact, c2a, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_Manifestation4CompilationUnit2Artifact_29_6_perform_greenBBBBFB(
		...
		return new Object[] { type, classifier, compilationUnit, artifact, manifestation, ruleResult };
	}
