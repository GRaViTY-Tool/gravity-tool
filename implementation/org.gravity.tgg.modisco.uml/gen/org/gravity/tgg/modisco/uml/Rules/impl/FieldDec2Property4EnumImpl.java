...
public class FieldDec2Property4EnumImpl extends AbstractRuleImpl implements FieldDec2Property4Enum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bodyDeclaration,
						uOwnerType, feature, jo2uo, jOwnerType, nd2ne);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[uOwnerType] = " + uOwnerType + ", "
					+ "[feature] = " + feature + ", " + "[jo2uo] = " + jo2uo + ", " + "[jOwnerType] = " + jOwnerType
					+ ", " + "[nd2ne] = " + nd2ne + ".");
		}
		...
		FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
			...
			for (Object[] result3_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_2_3_findcontext_blackBBBBBB(bodyDeclaration, uOwnerType, feature,
							jo2uo, jOwnerType, nd2ne)) {
				Object[] result3_green = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_2_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, uOwnerType,
								feature, jo2uo, jOwnerType, nd2ne);
				...
				Object[] result4_bindingAndBlack = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MFieldDefinition bodyDeclaration,
			Enumeration uOwnerType, Property feature, ASTNode2Element jo2uo, EnumDeclaration jOwnerType,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject uOwnerType,
			EObject feature, EObject jo2uo, EObject jOwnerType, EObject nd2ne) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_12_2_corematch_blackFBBFFFB(uOwnerType, feature, match)) {
			...
			// ForEach 
			for (Object[] result3_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_12_3_findcontext_blackBBBBBB(bodyDeclaration, uOwnerType, feature,
							jo2uo, jOwnerType, nd2ne)) {
				Object[] result3_green = FieldDec2Property4EnumImpl
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_24_5_matchcorrcontext_blackBBBFBFBB(bodyDeclaration, uOwnerType,
							feature, jOwnerType, sourceMatch, targetMatch)) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, ASTNode2Element nd2neParameter,
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
			...
			if (FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_29_5_checknacs_blackBBBBBB(bodyDeclaration, uOwnerType, feature,
								jo2uo, jOwnerType, nd2ne);
				if (result5_black != null) {

					Object[] result6_black = FieldDec2Property4EnumImpl
							.pattern_FieldDec2Property4Enum_29_6_perform_blackBBBBBBB(bodyDeclaration, uOwnerType,
									feature, jo2uo, jOwnerType, nd2ne, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[bodyDeclaration] = "
								+ bodyDeclaration + ", " + "[uOwnerType] = " + uOwnerType + ", " + "[feature] = "
								+ feature + ", " + "[jo2uo] = " + jo2uo + ", " + "[jOwnerType] = " + jOwnerType + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MFIELDDEFINITION_ENUMERATION_PROPERTY_ASTNODE2ELEMENT_ENUMDECLARATION_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MFieldDefinition) arguments.get(1),
					(Enumeration) arguments.get(2), (Property) arguments.get(3), (ASTNode2Element) arguments.get(4),
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MFIELDDEFINITION_ENUMERATION_PROPERTY_ASTNODE2ELEMENT_ENUMDECLARATION_ASTNODE2ELEMENT:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_122__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_122((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_127__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MFIELDDEFINITION_ENUMERATION_PROPERTY_ASTNODE2ELEMENT_ENUMDECLARATION_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpJo2uo instanceof ASTNode2Element) {
						...
						if (tmpJOwnerType instanceof EnumDeclaration) {
							...
							if (tmpNd2ne instanceof ASTNode2Element) {
								...
								return new Object[] { bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_1_performtransformation_blackBBBBBBFBB(
			MFieldDefinition bodyDeclaration, Enumeration uOwnerType, Property feature, ASTNode2Element jo2uo,
		...
		if (!jo2uo.equals(nd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_FieldDec2Property4Enum_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldDec2Property4Enum_1_1_performtransformation_black = pattern_FieldDec2Property4Enum_1_1_performtransformation_blackBBBBBBFBB(
					bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne, _this, isApplicableMatch);
															...
															if (!jOwnerType.equals(nd2ne)) {
																if (!nd2ne.equals(uOwnerType)) {
																	return new Object[] { ruleresult, bodyDeclaration,
																			uOwnerType, feature, jo2uo, jOwnerType,
																			nd2ne };
																}
															}
														}
	...
	public static final void pattern_FieldDec2Property4Enum_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject feature, EObject jo2uo, EObject jOwnerType, EObject nd2ne) {
		_this.registerObjects_FWD(ruleresult, bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne);
			...
			if (tmpUOwnerType instanceof Enumeration) {
				...
				for (ASTNode2Element nd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!jo2uo.equals(nd2ne)) {
						...
						if (tmpFeature instanceof Property) {
							Property feature = (Property) tmpFeature;
							_result.add(new Object[] { bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne,
									match });
						}
					...
					if (feature.equals(nd2ne.getTarget())) {
						if (jOwnerType.equals(jo2uo.getSource())) {
							if (bodyDeclaration.equals(nd2ne.getSource())) {
								_result.add(new Object[] { bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType,
										nd2ne });
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne, isApplicableMatch,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, uOwnerType, feature, jo2uo,
					jOwnerType, nd2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4Enum_2_4_solveCSP_binding = pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne);
	...
	public static final void pattern_FieldDec2Property4Enum_11_5_registerobjects_expressionBBBBBBBB(
			FieldDec2Property4Enum _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject uOwnerType,
			EObject feature, EObject jo2uo, EObject jOwnerType, EObject nd2ne) {
		_this.registerObjects_BWD(ruleresult, bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne);
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4Enum_12_2_corematch_blackFBBFFFB(
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, bodyDeclaration, uOwnerType, feature,
				jo2uo, jOwnerType, nd2ne, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, uOwnerType, feature, jo2uo,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4Enum_29_3_solveCSP_binding = pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne, ruleResult);
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_6_perform_blackBBBBBBB(
		...
		if (!jo2uo.equals(nd2ne)) {
			return new Object[] { bodyDeclaration, uOwnerType, feature, jo2uo, jOwnerType, nd2ne, ruleResult };
		}
		return null;
	}
