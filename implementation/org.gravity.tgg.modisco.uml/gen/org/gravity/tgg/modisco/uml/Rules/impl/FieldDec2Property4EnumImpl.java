...
public class FieldDec2Property4EnumImpl extends AbstractRuleImpl implements FieldDec2Property4Enum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, bodyDeclaration,
						uOwnerType, jo2uo, jOwnerType, feature, nd2ne);
		...
		FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
			...
			for (Object[] result3_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_2_3_findcontext_blackBBBBBB(bodyDeclaration, uOwnerType, jo2uo,
							jOwnerType, feature, nd2ne)) {
				Object[] result3_green = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_2_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, uOwnerType,
								jo2uo, jOwnerType, feature, nd2ne);
				...
				Object[] result4_bindingAndBlack = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MFieldDefinition bodyDeclaration,
			Enumeration uOwnerType, ASTNode2Element jo2uo, EnumDeclaration jOwnerType, Property feature,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject bodyDeclaration, EObject uOwnerType,
			EObject jo2uo, EObject jOwnerType, EObject feature, EObject nd2ne) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_12_2_corematch_blackFBFFBFB(uOwnerType, feature, match)) {
			...
			// ForEach 
			for (Object[] result3_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_12_3_findcontext_blackBBBBBB(bodyDeclaration, uOwnerType, jo2uo,
							jOwnerType, feature, nd2ne)) {
				Object[] result3_green = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_12_3_findcontext_greenBBBBBBFFFFFFF(bodyDeclaration, uOwnerType,
								jo2uo, jOwnerType, feature, nd2ne);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_134(EMoflonEdge _edge_ownedAttribute) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_24_5_matchcorrcontext_blackBBFBBFBB(bodyDeclaration, uOwnerType,
							jOwnerType, feature, sourceMatch, targetMatch)) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MFieldDefinition bodyDeclaration, Enumeration uOwnerType,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, ASTNode2Element nd2neParameter,
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
			...
			if (FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_29_5_checknacs_blackBBBBBB(bodyDeclaration, uOwnerType, jo2uo,
								jOwnerType, feature, nd2ne);
				if (result5_black != null) {

					Object[] result6_black = FieldDec2Property4EnumImpl
							.pattern_FieldDec2Property4Enum_29_6_perform_blackBBBBBBB(bodyDeclaration, uOwnerType,
									jo2uo, jOwnerType, feature, nd2ne, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[bodyDeclaration] = "
								+ bodyDeclaration + ", " + "[uOwnerType] = " + uOwnerType + ", " + "[jo2uo] = " + jo2uo
								+ ", " + "[jOwnerType] = " + jOwnerType + ", " + "[feature] = " + feature + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MFIELDDEFINITION_ENUMERATION_ASTNODE2ELEMENT_ENUMDECLARATION_PROPERTY_ASTNODE2ELEMENT:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MFieldDefinition) arguments.get(1),
					...
					(EnumDeclaration) arguments.get(4), (Property) arguments.get(5),
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MFIELDDEFINITION_ENUMERATION_ASTNODE2ELEMENT_ENUMDECLARATION_PROPERTY_ASTNODE2ELEMENT:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_134__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_CC__MFIELDDEFINITION_ENUMERATION_ENUMDECLARATION_PROPERTY_MATCH_MATCH:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MFIELDDEFINITION_ENUMERATION_ASTNODE2ELEMENT_ENUMDECLARATION_PROPERTY_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (MFieldDefinition) arguments.get(1),
					(Enumeration) arguments.get(2), (ASTNode2Element) arguments.get(3),
					(EnumDeclaration) arguments.get(4), (Property) arguments.get(5), (ASTNode2Element) arguments.get(6),
					...
					if (tmpJOwnerType instanceof EnumDeclaration) {
						...
						if (tmpFeature instanceof Property) {
							...
							if (tmpNd2ne instanceof ASTNode2Element) {
								...
								return new Object[] { bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_1_performtransformation_blackBBBBBBFBB(
			MFieldDefinition bodyDeclaration, Enumeration uOwnerType, ASTNode2Element jo2uo, EnumDeclaration jOwnerType,
		...
		if (!jo2uo.equals(nd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_FieldDec2Property4Enum_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldDec2Property4Enum_1_1_performtransformation_black = pattern_FieldDec2Property4Enum_1_1_performtransformation_blackBBBBBBFBB(
					bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject bodyDeclaration, EObject uOwnerType, EObject jo2uo,
			EObject jOwnerType, EObject feature, EObject nd2ne) {
	...
	public static final void pattern_FieldDec2Property4Enum_1_5_registerobjects_expressionBBBBBBBB(
			FieldDec2Property4Enum _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject uOwnerType,
			EObject jo2uo, EObject jOwnerType, EObject feature, EObject nd2ne) {
		_this.registerObjects_FWD(ruleresult, bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne);
			...
			if (tmpUOwnerType instanceof Enumeration) {
				...
				for (ASTNode2Element nd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!jo2uo.equals(nd2ne)) {
						...
						if (tmpFeature instanceof Property) {
							Property feature = (Property) tmpFeature;
							_result.add(new Object[] { bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne,
									match });
						}
					...
					if (bodyDeclaration.equals(nd2ne.getSource())) {
						if (feature.equals(nd2ne.getTarget())) {
							if (jOwnerType.getBodyDeclarations().contains(bodyDeclaration)) {
								_result.add(new Object[] { bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature,
										nd2ne });
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		bodyDeclaration__jOwnerType____abstractTypeDeclaration
				.setName(bodyDeclaration__jOwnerType____abstractTypeDeclaration_name_prime);
		return new Object[] { bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne, isApplicableMatch,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, bodyDeclaration, uOwnerType, jo2uo,
				jOwnerType, feature, nd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, uOwnerType, jo2uo, jOwnerType,
					feature, nd2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4Enum_2_4_solveCSP_binding = pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne);
	...
	public static final void pattern_FieldDec2Property4Enum_11_5_registerobjects_expressionBBBBBBBB(
			FieldDec2Property4Enum _this, PerformRuleResult ruleresult, EObject bodyDeclaration, EObject uOwnerType,
			EObject jo2uo, EObject jOwnerType, EObject feature, EObject nd2ne) {
		_this.registerObjects_BWD(ruleresult, bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne);
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4Enum_12_2_corematch_blackFBFFBFB(
	...
	public static final Object[] pattern_FieldDec2Property4Enum_12_4_solveCSP_bindingFBBBBBBBB(
			...
			Enumeration uOwnerType, ASTNode2Element jo2uo, EnumDeclaration jOwnerType, Property feature,
			ASTNode2Element nd2ne) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, bodyDeclaration, uOwnerType, jo2uo,
				jOwnerType, feature, nd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, uOwnerType, jo2uo, jOwnerType,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_24_2_matchsrctrgcontext_blackBBBBBB(
			MFieldDefinition bodyDeclaration, Enumeration uOwnerType, EnumDeclaration jOwnerType, Property feature,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_24_3_solvecsp_bindingFBBBBBBB(
			FieldDec2Property4Enum _this, MFieldDefinition bodyDeclaration, Enumeration uOwnerType,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, bodyDeclaration, uOwnerType, jo2uo,
				jOwnerType, feature, nd2ne, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, bodyDeclaration, uOwnerType, jo2uo, jOwnerType,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4Enum_29_3_solveCSP_binding = pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne, ruleResult);
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_6_perform_blackBBBBBBB(
		...
		if (!jo2uo.equals(nd2ne)) {
			return new Object[] { bodyDeclaration, uOwnerType, jo2uo, jOwnerType, feature, nd2ne, ruleResult };
		}
		return null;
	}
