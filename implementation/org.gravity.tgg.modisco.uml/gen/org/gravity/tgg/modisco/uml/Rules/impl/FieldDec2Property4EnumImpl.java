...
public class FieldDec2Property4EnumImpl extends AbstractRuleImpl implements FieldDec2Property4Enum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, jo2uo, bodyDeclaration,
						nd2ne, feature, uOwnerType, jOwnerType);
		...
		FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
			...
			for (Object[] result3_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_2_3_findcontext_blackBBBBBB(jo2uo, bodyDeclaration, nd2ne, feature,
				...
				Object[] result4_bindingAndBlack = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element jo2uo,
			MFieldDefinition bodyDeclaration, ASTNode2Element nd2ne, Property feature, Enumeration uOwnerType,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject jo2uo, EObject bodyDeclaration, EObject nd2ne,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, jo2uo,
						bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[jo2uo] = " + jo2uo + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
					+ "[nd2ne] = " + nd2ne + ", " + "[feature] = " + feature + ", " + "[uOwnerType] = " + uOwnerType
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_12_2_corematch_blackFFFBBFB(feature, uOwnerType, match)) {
			ASTNode2Element jo2uo = (ASTNode2Element) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_12_3_findcontext_blackBBBBBB(jo2uo, bodyDeclaration, nd2ne, feature,
							uOwnerType, jOwnerType)) {
				Object[] result3_green = FieldDec2Property4EnumImpl
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject jo2uo, EObject bodyDeclaration, EObject nd2ne,
			EObject feature, EObject uOwnerType, EObject jOwnerType) {
		ruleresult.registerObject("jo2uo", jo2uo);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
		ruleresult.registerObject("nd2ne", nd2ne);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_7(EMoflonEdge _edge_ownedAttribute) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_24_5_matchcorrcontext_blackFBFBBBBB(bodyDeclaration, feature,
							uOwnerType, jOwnerType, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
			...
			Object[] result3_bindingAndBlack = FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[jo2uo] = " + jo2uo + ", "
			...
			if (FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_29_5_checknacs_blackBBBBBB(jo2uo, bodyDeclaration, nd2ne,
								feature, uOwnerType, jOwnerType);
				if (result5_black != null) {

					Object[] result6_black = FieldDec2Property4EnumImpl
							.pattern_FieldDec2Property4Enum_29_6_perform_blackBBBBBBB(jo2uo, bodyDeclaration, nd2ne,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_MFIELDDEFINITION_ASTNODE2ELEMENT_PROPERTY_ENUMERATION_ENUMDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(Property) arguments.get(4), (Enumeration) arguments.get(5), (EnumDeclaration) arguments.get(6));
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_MFIELDDEFINITION_ASTNODE2ELEMENT_PROPERTY_ENUMERATION_ENUMDECLARATION:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_7__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_7((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_9__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_MFIELDDEFINITION_ASTNODE2ELEMENT_PROPERTY_ENUMERATION_ENUMDECLARATION_MODELGENERATORRULERESULT:
					...
					if (tmpFeature instanceof Property) {
						...
						if (tmpUOwnerType instanceof Enumeration) {
							...
							if (tmpJOwnerType instanceof EnumDeclaration) {
								...
								return new Object[] { jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element jo2uo, MFieldDefinition bodyDeclaration, ASTNode2Element nd2ne, Property feature,
		...
		if (!jo2uo.equals(nd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_FieldDec2Property4Enum_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldDec2Property4Enum_1_1_performtransformation_black = pattern_FieldDec2Property4Enum_1_1_performtransformation_blackBBBBBBFBB(
					jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject jo2uo, EObject bodyDeclaration, EObject nd2ne, EObject feature,
	...
	public static final void pattern_FieldDec2Property4Enum_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject nd2ne, EObject feature, EObject uOwnerType, EObject jOwnerType) {
		_this.registerObjects_FWD(ruleresult, jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType);
			...
			if (tmpFeature instanceof Property) {
				...
				for (ASTNode2Element jo2uo : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!jo2uo.equals(nd2ne)) {
						...
						if (tmpUOwnerType instanceof Enumeration) {
							Enumeration uOwnerType = (Enumeration) tmpUOwnerType;
							_result.add(new Object[] { jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType,
									match });
						}
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4Enum_2_3_findcontext_blackBBBBBB(
			ASTNode2Element jo2uo, MFieldDefinition bodyDeclaration, ASTNode2Element nd2ne, Property feature,
			Enumeration uOwnerType, EnumDeclaration jOwnerType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!jo2uo.equals(nd2ne)) {
					...
					if (bodyDeclaration.equals(nd2ne.getSource())) {
						if (jOwnerType.getBodyDeclarations().contains(bodyDeclaration)) {
							if (jOwnerType.equals(jo2uo.getSource())) {
								_result.add(new Object[] { jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType,
										jOwnerType });
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType, isApplicableMatch,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, jo2uo, bodyDeclaration, nd2ne,
				feature, uOwnerType, jOwnerType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType,
					jOwnerType };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4Enum_2_4_solveCSP_binding = pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType);
	...
	public static final void pattern_FieldDec2Property4Enum_11_5_registerobjects_expressionBBBBBBBB(
			FieldDec2Property4Enum _this, PerformRuleResult ruleresult, EObject jo2uo, EObject bodyDeclaration,
			EObject nd2ne, EObject feature, EObject uOwnerType, EObject jOwnerType) {
		_this.registerObjects_BWD(ruleresult, jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType);
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4Enum_12_2_corematch_blackFFFBBFB(Property feature,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_12_4_solveCSP_bindingFBBBBBBBB(
			...
			MFieldDefinition bodyDeclaration, ASTNode2Element nd2ne, Property feature, Enumeration uOwnerType,
			EnumDeclaration jOwnerType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, jo2uo, bodyDeclaration, nd2ne,
				feature, uOwnerType, jOwnerType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, jo2uo, bodyDeclaration, nd2ne,
				feature, uOwnerType, jOwnerType, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4Enum_29_3_solveCSP_binding = pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType, ruleResult);
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_6_perform_blackBBBBBBB(ASTNode2Element jo2uo,
			...
			EnumDeclaration jOwnerType, ModelgeneratorRuleResult ruleResult) {
		if (!jo2uo.equals(nd2ne)) {
			return new Object[] { jo2uo, bodyDeclaration, nd2ne, feature, uOwnerType, jOwnerType, ruleResult };
		}
		return null;
	}
