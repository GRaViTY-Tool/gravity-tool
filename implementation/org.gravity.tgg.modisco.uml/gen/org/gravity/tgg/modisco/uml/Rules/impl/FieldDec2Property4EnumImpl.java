		...
		switch (operationID) {
			...
			case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MFIELDDEFINITION_ENUMDECLARATION_ASTNODE2ELEMENT_ENUMERATION_PROPERTY_ASTNODE2ELEMENT:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(MFieldDefinition) arguments.get(1), (EnumDeclaration) arguments.get(2),
						(ASTNode2Element) arguments.get(3), (Enumeration) arguments.get(4), (Property) arguments.get(5),
			...
			case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_147__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_147((EMoflonEdge) arguments.get(0));
			case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_161__EMOFLONEDGE:
