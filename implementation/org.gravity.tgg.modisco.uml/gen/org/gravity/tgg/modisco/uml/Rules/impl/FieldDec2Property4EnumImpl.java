...
public class FieldDec2Property4EnumImpl extends AbstractRuleImpl implements FieldDec2Property4Enum {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		EnumDeclaration jOwnerType = (EnumDeclaration) result1_bindingAndBlack[2];
		...
		Object[] result3_black = FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, uOwnerType,
						bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[uOwnerType] = " + uOwnerType + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", "
					+ "[jOwnerType] = " + jOwnerType + ", " + "[nd2ne] = " + nd2ne + ", " + "[jo2uo] = " + jo2uo + ", "
					+ "[feature] = " + feature + ".");
		}
		FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				uOwnerType, bodyDeclaration, jOwnerType, feature);
		...
		FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_2_2_corematch_blackFBBFFFB(bodyDeclaration, jOwnerType, match)) {
			...
			for (Object[] result3_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_2_3_findcontext_blackBBBBBB(uOwnerType, bodyDeclaration, jOwnerType,
							nd2ne, jo2uo, feature)) {
				Object[] result3_green = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_2_3_findcontext_greenBBBBBBFFFFFFF(uOwnerType, bodyDeclaration,
								jOwnerType, nd2ne, jo2uo, feature);
				...
				Object[] result4_bindingAndBlack = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uOwnerType] = " + uOwnerType
							+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[jOwnerType] = " + jOwnerType
							+ ", " + "[nd2ne] = " + nd2ne + ", " + "[jo2uo] = " + jo2uo + ", " + "[feature] = "
							+ feature + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Enumeration uOwnerType,
			MFieldDefinition bodyDeclaration, EnumDeclaration jOwnerType, ASTNode2Element nd2ne, ASTNode2Element jo2uo,
			Property feature) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject uOwnerType, EObject bodyDeclaration,
			EObject jOwnerType, EObject nd2ne, EObject jo2uo, EObject feature) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_12_2_corematch_blackBFFFFBB(uOwnerType, feature, match)) {
			MFieldDefinition bodyDeclaration = (MFieldDefinition) result2_black[1];
			EnumDeclaration jOwnerType = (EnumDeclaration) result2_black[2];
			ASTNode2Element nd2ne = (ASTNode2Element) result2_black[3];
			ASTNode2Element jo2uo = (ASTNode2Element) result2_black[4];
			// ForEach 
			for (Object[] result3_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_12_3_findcontext_blackBBBBBB(uOwnerType, bodyDeclaration,
							jOwnerType, nd2ne, jo2uo, feature)) {
				Object[] result3_green = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_12_3_findcontext_greenBBBBBBFFFFFFF(uOwnerType, bodyDeclaration,
								jOwnerType, nd2ne, jo2uo, feature);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject uOwnerType, EObject bodyDeclaration,
			EObject jOwnerType, EObject nd2ne, EObject jo2uo, EObject feature) {
		ruleresult.registerObject("uOwnerType", uOwnerType);
		ruleresult.registerObject("bodyDeclaration", bodyDeclaration);
		ruleresult.registerObject("jOwnerType", jOwnerType);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_141(EMoflonEdge _edge_ownedAttribute) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = FieldDec2Property4EnumImpl
				.pattern_FieldDec2Property4Enum_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, uOwnerType, bodyDeclaration,
		...
		if (FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_24_5_matchcorrcontext_blackBBBFFBBB(uOwnerType, bodyDeclaration,
							jOwnerType, feature, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_24_6_createcorrespondence_blackBBBBB(uOwnerType,
								bodyDeclaration, jOwnerType, feature, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[uOwnerType] = "
							+ uOwnerType + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[jOwnerType] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Enumeration uOwnerType, MFieldDefinition bodyDeclaration,
			EnumDeclaration jOwnerType, Property feature, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : FieldDec2Property4EnumImpl
			...
			Object[] result3_bindingAndBlack = FieldDec2Property4EnumImpl
					.pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[uOwnerType] = " + uOwnerType + ", "
						+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[jOwnerType] = " + jOwnerType + ", "
						+ "[nd2ne] = " + nd2ne + ", " + "[jo2uo] = " + jo2uo + ", " + "[feature] = " + feature + ", "
			...
			if (FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = FieldDec2Property4EnumImpl
						.pattern_FieldDec2Property4Enum_29_5_checknacs_blackBBBBBB(uOwnerType, bodyDeclaration,
								jOwnerType, nd2ne, jo2uo, feature);
				if (result5_black != null) {

					Object[] result6_black = FieldDec2Property4EnumImpl
							.pattern_FieldDec2Property4Enum_29_6_perform_blackBBBBBBB(uOwnerType, bodyDeclaration,
									jOwnerType, nd2ne, jo2uo, feature, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching failed." + " Variables: " + "[uOwnerType] = " + uOwnerType + ", "
										+ "[bodyDeclaration] = " + bodyDeclaration + ", " + "[jOwnerType] = "
										+ jOwnerType + ", " + "[nd2ne] = " + nd2ne + ", " + "[jo2uo] = " + jo2uo + ", "
					...
					FieldDec2Property4EnumImpl.pattern_FieldDec2Property4Enum_29_6_perform_greenBBBBB(uOwnerType,
							bodyDeclaration, jOwnerType, feature, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Enumeration uOwnerType,
			MFieldDefinition bodyDeclaration, EnumDeclaration jOwnerType, ASTNode2Element nd2ne, ASTNode2Element jo2uo,
			Property feature, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ENUMERATION_MFIELDDEFINITION_ENUMDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_PROPERTY:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMERATION_MFIELDDEFINITION_ENUMDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_PROPERTY:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPROPRIATE_BWD_EMOFLON_EDGE_141__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_141((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPROPRIATE_FWD_EMOFLON_EDGE_149__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___IS_APPLICABLE_SOLVE_CSP_CC__ENUMERATION_MFIELDDEFINITION_ENUMDECLARATION_PROPERTY_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Enumeration) arguments.get(0), (MFieldDefinition) arguments.get(1),
					(EnumDeclaration) arguments.get(2), (Property) arguments.get(3), (Match) arguments.get(4),
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ENUM___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ENUMERATION_MFIELDDEFINITION_ENUMDECLARATION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_PROPERTY_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (Enumeration) arguments.get(1),
					(MFieldDefinition) arguments.get(2), (EnumDeclaration) arguments.get(3),
					(ASTNode2Element) arguments.get(4), (ASTNode2Element) arguments.get(5), (Property) arguments.get(6),
					...
					if (tmpNd2ne instanceof ASTNode2Element) {
						...
						if (tmpJo2uo instanceof ASTNode2Element) {
							...
							if (tmpFeature instanceof Property) {
								...
								return new Object[] { uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_1_performtransformation_blackBBBBBBFBB(
			Enumeration uOwnerType, MFieldDefinition bodyDeclaration, EnumDeclaration jOwnerType, ASTNode2Element nd2ne,
			ASTNode2Element jo2uo, Property feature, FieldDec2Property4Enum _this,
			IsApplicableMatch isApplicableMatch) {
		if (!jo2uo.equals(nd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_FieldDec2Property4Enum_1_1_performtransformation_binding != null) {
			...
			EnumDeclaration jOwnerType = (EnumDeclaration) result_pattern_FieldDec2Property4Enum_1_1_performtransformation_binding[2];
			...
			Property feature = (Property) result_pattern_FieldDec2Property4Enum_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_FieldDec2Property4Enum_1_1_performtransformation_black = pattern_FieldDec2Property4Enum_1_1_performtransformation_blackBBBBBBFBB(
					uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject uOwnerType, EObject bodyDeclaration, EObject jOwnerType,
			EObject nd2ne, EObject jo2uo, EObject feature) {
															...
															if (!feature.equals(nd2ne)) {
																if (!feature.equals(jo2uo)) {
																	return new Object[] { ruleresult, uOwnerType,
																			bodyDeclaration, jOwnerType, nd2ne, jo2uo,
																			feature };
																}
															}
														}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_1_3_bookkeepingforedges_greenBBBBBFFFF(
		...
		bodyDeclaration__jOwnerType____abstractTypeDeclaration
				.setName(bodyDeclaration__jOwnerType____abstractTypeDeclaration_name_prime);
		return new Object[] { ruleresult, uOwnerType, bodyDeclaration, jOwnerType, feature,
	...
	public static final void pattern_FieldDec2Property4Enum_1_5_registerobjects_expressionBBBBBBBB(
			FieldDec2Property4Enum _this, PerformRuleResult ruleresult, EObject uOwnerType, EObject bodyDeclaration,
			EObject jOwnerType, EObject nd2ne, EObject jo2uo, EObject feature) {
		_this.registerObjects_FWD(ruleresult, uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature);
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4Enum_2_2_corematch_blackFBBFFFB(
			...
			if (tmpFeature instanceof Property) {
				...
				for (ASTNode2Element jo2uo : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!jo2uo.equals(nd2ne)) {
						...
						if (tmpUOwnerType instanceof Enumeration) {
							Enumeration uOwnerType = (Enumeration) tmpUOwnerType;
							_result.add(new Object[] { uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature,
									match });
						}
					...
					if (uOwnerType.equals(jo2uo.getTarget())) {
						if (jOwnerType.equals(jo2uo.getSource())) {
							if (feature.equals(nd2ne.getTarget())) {
								_result.add(new Object[] { uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo,
										feature });
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature, isApplicableMatch,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingFBBBBBBBB(
			...
			MFieldDefinition bodyDeclaration, EnumDeclaration jOwnerType, ASTNode2Element nd2ne, ASTNode2Element jo2uo,
			Property feature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, uOwnerType, bodyDeclaration,
				jOwnerType, nd2ne, jo2uo, feature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo,
					feature };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4Enum_2_4_solveCSP_binding = pattern_FieldDec2Property4Enum_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature);
		if (result_pattern_FieldDec2Property4Enum_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_FieldDec2Property4Enum_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, uOwnerType, bodyDeclaration, jOwnerType, nd2ne,
						jo2uo, feature };
			}
		}
		return null;
	...
	public static final Object[] pattern_FieldDec2Property4Enum_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_FieldDec2Property4Enum_11_1_performtransformation_binding != null) {
			...
			EnumDeclaration jOwnerType = (EnumDeclaration) result_pattern_FieldDec2Property4Enum_11_1_performtransformation_binding[2];
			...
			Property feature = (Property) result_pattern_FieldDec2Property4Enum_11_1_performtransformation_binding[5];
	...
	public static final void pattern_FieldDec2Property4Enum_11_5_registerobjects_expressionBBBBBBBB(
			FieldDec2Property4Enum _this, PerformRuleResult ruleresult, EObject uOwnerType, EObject bodyDeclaration,
			EObject jOwnerType, EObject nd2ne, EObject jo2uo, EObject feature) {
		_this.registerObjects_BWD(ruleresult, uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature);
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4Enum_12_2_corematch_blackBFFFFBB(
	...
	public static final Object[] pattern_FieldDec2Property4Enum_12_4_solveCSP_bindingFBBBBBBBB(
			...
			MFieldDefinition bodyDeclaration, EnumDeclaration jOwnerType, ASTNode2Element nd2ne, ASTNode2Element jo2uo,
			Property feature) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, uOwnerType, bodyDeclaration,
				jOwnerType, nd2ne, jo2uo, feature);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo,
		...
		if (tmpUOwnerType instanceof Enumeration) {
			...
			if (tmpBodyDeclaration instanceof MFieldDefinition) {
				...
				if (tmpJOwnerType instanceof EnumDeclaration) {
					...
					if (tmpFeature instanceof Property) {
						Property feature = (Property) tmpFeature;
						return new Object[] { uOwnerType, bodyDeclaration, jOwnerType, feature, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_24_2_matchsrctrgcontext_blackBBBBBB(
			Enumeration uOwnerType, MFieldDefinition bodyDeclaration, EnumDeclaration jOwnerType, Property feature,
			Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { uOwnerType, bodyDeclaration, jOwnerType, feature, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_FieldDec2Property4Enum_24_2_matchsrctrgcontext_binding != null) {
			...
			Property feature = (Property) result_pattern_FieldDec2Property4Enum_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_FieldDec2Property4Enum_24_2_matchsrctrgcontext_black = pattern_FieldDec2Property4Enum_24_2_matchsrctrgcontext_blackBBBBBB(
					uOwnerType, bodyDeclaration, jOwnerType, feature, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldDec2Property4Enum_24_3_solvecsp_bindingFBBBBBBB(
			FieldDec2Property4Enum _this, Enumeration uOwnerType, MFieldDefinition bodyDeclaration,
			EnumDeclaration jOwnerType, Property feature, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(uOwnerType, bodyDeclaration, jOwnerType, feature,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, uOwnerType, bodyDeclaration, jOwnerType, feature, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4Enum_24_3_solvecsp_binding = pattern_FieldDec2Property4Enum_24_3_solvecsp_bindingFBBBBBBB(
				_this, uOwnerType, bodyDeclaration, jOwnerType, feature, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4Enum_24_5_matchcorrcontext_blackBBBFFBBB(
			Enumeration uOwnerType, MFieldDefinition bodyDeclaration, EnumDeclaration jOwnerType, Property feature,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_FieldDec2Property4Enum_24_6_createcorrespondence_blackBBBBB(
			Enumeration uOwnerType, MFieldDefinition bodyDeclaration, EnumDeclaration jOwnerType, Property feature,
			CCMatch ccMatch) {
		return new Object[] { uOwnerType, bodyDeclaration, jOwnerType, feature, ccMatch };
	}
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, uOwnerType, bodyDeclaration,
				jOwnerType, nd2ne, jo2uo, feature, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo,
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4Enum_29_3_solveCSP_binding = pattern_FieldDec2Property4Enum_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature, ruleResult);
	...
	public static final Object[] pattern_FieldDec2Property4Enum_29_6_perform_blackBBBBBBB(Enumeration uOwnerType,
			...
			Property feature, ModelgeneratorRuleResult ruleResult) {
		if (!jo2uo.equals(nd2ne)) {
			return new Object[] { uOwnerType, bodyDeclaration, jOwnerType, nd2ne, jo2uo, feature, ruleResult };
		}
		return null;
	}

	public static final Object[] pattern_FieldDec2Property4Enum_29_6_perform_greenBBBBB(Enumeration uOwnerType,
			MFieldDefinition bodyDeclaration, EnumDeclaration jOwnerType, Property feature,
		...
		return new Object[] { uOwnerType, bodyDeclaration, jOwnerType, feature, ruleResult };
	}
