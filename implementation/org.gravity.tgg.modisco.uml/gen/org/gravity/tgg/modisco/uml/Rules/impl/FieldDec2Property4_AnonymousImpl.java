...
public class FieldDec2Property4_AnonymousImpl extends AbstractRuleImpl implements FieldDec2Property4_Anonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FieldDec2Property4_AnonymousImpl
				.pattern_FieldDec2Property4_Anonymous_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, jOwnerType,
						uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[jOwnerType] = " + jOwnerType + ", " + "[uOwnerType] = " + uOwnerType + ", "
					+ "[feature] = " + feature + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[nd2ne] = "
					+ nd2ne + ", " + "[jo2uo] = " + jo2uo + ".");
		}
		...
		FieldDec2Property4_AnonymousImpl.pattern_FieldDec2Property4_Anonymous_1_5_registerobjects_expressionBBBBBBBB(
				this, ruleresult, jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4_AnonymousImpl
				.pattern_FieldDec2Property4_Anonymous_2_2_corematch_blackBFFBFFB(jOwnerType, bodyDeclaration, match)) {
			...
			for (Object[] result3_black : FieldDec2Property4_AnonymousImpl
					.pattern_FieldDec2Property4_Anonymous_2_3_findcontext_blackBBBBBB(jOwnerType, uOwnerType, feature,
							bodyDeclaration, nd2ne, jo2uo)) {
				...
				Object[] result4_bindingAndBlack = FieldDec2Property4_AnonymousImpl
						.pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject jOwnerType, EObject uOwnerType,
			EObject feature, EObject bodyDeclaration, EObject nd2ne, EObject jo2uo) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4_AnonymousImpl
				.pattern_FieldDec2Property4_Anonymous_12_2_corematch_blackFBBFFFB(uOwnerType, feature, match)) {
			...
			// ForEach 
			for (Object[] result3_black : FieldDec2Property4_AnonymousImpl
					.pattern_FieldDec2Property4_Anonymous_12_3_findcontext_blackBBBBBB(jOwnerType, uOwnerType, feature,
							bodyDeclaration, nd2ne, jo2uo)) {
				Object[] result3_green = FieldDec2Property4_AnonymousImpl
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_161(EMoflonEdge _edge_bodyDeclarations) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = FieldDec2Property4_AnonymousImpl
				.pattern_FieldDec2Property4_Anonymous_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, jOwnerType,
						uOwnerType, feature, bodyDeclaration, sourceMatch, targetMatch);
				...
				if (result5_black != null) {
					...
					Object[] result6_black = FieldDec2Property4_AnonymousImpl
							.pattern_FieldDec2Property4_Anonymous_29_6_perform_blackBBBBBBB(jOwnerType, uOwnerType,
									feature, bodyDeclaration, nd2ne, jo2uo, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[jOwnerType] = "
								+ jOwnerType + ", " + "[uOwnerType] = " + uOwnerType + ", " + "[feature] = " + feature
								+ ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[nd2ne] = " + nd2ne + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_CLASS_PROPERTY_MFIELDDEFINITION_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
				return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
						(AnonymousClassDeclaration) arguments.get(1), (org.eclipse.uml2.uml.Class) arguments.get(2),
						(Property) arguments.get(3), (MFieldDefinition) arguments.get(4),
			...
			case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_CLASS_PROPERTY_MFIELDDEFINITION_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
			...
			case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_148__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_148((EMoflonEdge) arguments.get(0));
			case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_161__EMOFLONEDGE:
			...
			case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__ANONYMOUSCLASSDECLARATION_CLASS_PROPERTY_MFIELDDEFINITION_MATCH_MATCH:
			...
			case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_CLASS_PROPERTY_MFIELDDEFINITION_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpBodyDeclaration instanceof MFieldDefinition) {
						...
						if (tmpNd2ne instanceof ASTNode2Element) {
							...
							if (tmpJo2uo instanceof ASTNode2Element) {
								...
								return new Object[] { jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_blackBBBBBBFBB(
			AnonymousClassDeclaration jOwnerType, org.eclipse.uml2.uml.Class uOwnerType, Property feature,
			MFieldDefinition bodyDeclaration, ASTNode2Element nd2ne, ASTNode2Element jo2uo,
			FieldDec2Property4_Anonymous _this, IsApplicableMatch isApplicableMatch) {
		if (!jo2uo.equals(nd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_black = pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_blackBBBBBBFBB(
					jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject bodyDeclaration, EObject nd2ne, EObject jo2uo) {
															...
															if (!jo2uo.equals(uOwnerType)) {
																if (!jo2uo.equals(nd2ne)) {
																	return new Object[] { ruleresult, jOwnerType,
																			uOwnerType, feature, bodyDeclaration, nd2ne,
																			jo2uo };
																}
															}
														}
	...
	public static final void pattern_FieldDec2Property4_Anonymous_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject feature, EObject bodyDeclaration, EObject nd2ne, EObject jo2uo) {
		_this.registerObjects_FWD(ruleresult, jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo);
			...
			if (tmpFeature instanceof Property) {
				...
				for (ASTNode2Element jo2uo : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!jo2uo.equals(nd2ne)) {
						...
						if (tmpUOwnerType instanceof org.eclipse.uml2.uml.Class) {
							org.eclipse.uml2.uml.Class uOwnerType = (org.eclipse.uml2.uml.Class) tmpUOwnerType;
							_result.add(new Object[] { jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo,
									match });
						}
					...
					if (jOwnerType.equals(jo2uo.getSource())) {
						if (uOwnerType.equals(jo2uo.getTarget())) {
							if (feature.equals(nd2ne.getTarget())) {
								_result.add(new Object[] { jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne,
										jo2uo });
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo, isApplicableMatch,
				jOwnerType__bodyDeclaration____bodyDeclarations,
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingFBBBBBBBB(
			...
			AnonymousClassDeclaration jOwnerType, org.eclipse.uml2.uml.Class uOwnerType, Property feature,
			MFieldDefinition bodyDeclaration, ASTNode2Element nd2ne, ASTNode2Element jo2uo) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, jOwnerType, uOwnerType, feature,
				bodyDeclaration, nd2ne, jo2uo);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jOwnerType, uOwnerType, feature, bodyDeclaration,
					nd2ne, jo2uo };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_binding = pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo);
	...
	public static final void pattern_FieldDec2Property4_Anonymous_11_5_registerobjects_expressionBBBBBBBB(
			FieldDec2Property4_Anonymous _this, PerformRuleResult ruleresult, EObject jOwnerType, EObject uOwnerType,
			EObject feature, EObject bodyDeclaration, EObject nd2ne, EObject jo2uo) {
		_this.registerObjects_BWD(ruleresult, jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo);
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4_Anonymous_12_2_corematch_blackFBBFFFB(
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		nd2ne__feature____target.setName(nd2ne__feature____target_name_prime);
		return new Object[] { jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo, isApplicableMatch,
				uOwnerType__feature____ownedAttribute, nd2ne__bodyDeclaration____source, jo2uo__jOwnerType____source,
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_12_4_solveCSP_bindingFBBBBBBBB(
			...
			AnonymousClassDeclaration jOwnerType, org.eclipse.uml2.uml.Class uOwnerType, Property feature,
			MFieldDefinition bodyDeclaration, ASTNode2Element nd2ne, ASTNode2Element jo2uo) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, jOwnerType, uOwnerType, feature,
				bodyDeclaration, nd2ne, jo2uo);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jOwnerType, uOwnerType, feature, bodyDeclaration,
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, jOwnerType, uOwnerType, feature,
				bodyDeclaration, nd2ne, jo2uo, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jOwnerType, uOwnerType, feature, bodyDeclaration,
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_binding = pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo, ruleResult);
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_29_6_perform_blackBBBBBBB(
			...
			ModelgeneratorRuleResult ruleResult) {
		if (!jo2uo.equals(nd2ne)) {
			return new Object[] { jOwnerType, uOwnerType, feature, bodyDeclaration, nd2ne, jo2uo, ruleResult };
		}
		return null;
	}
