...
public class FieldDec2Property4_AnonymousImpl extends AbstractRuleImpl implements FieldDec2Property4_Anonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FieldDec2Property4_AnonymousImpl
				.pattern_FieldDec2Property4_Anonymous_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, jOwnerType,
						feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne);
		...
		FieldDec2Property4_AnonymousImpl.pattern_FieldDec2Property4_Anonymous_1_5_registerobjects_expressionBBBBBBBB(
				this, ruleresult, jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne);
		...
		for (Object[] result2_black : FieldDec2Property4_AnonymousImpl
			...
			for (Object[] result3_black : FieldDec2Property4_AnonymousImpl
					.pattern_FieldDec2Property4_Anonymous_2_3_findcontext_blackBBBBBB(jOwnerType, feature,
							bodyDeclaration, uOwnerType, jo2uo, nd2ne)) {
				...
				Object[] result4_bindingAndBlack = FieldDec2Property4_AnonymousImpl
						.pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, AnonymousClassDeclaration jOwnerType,
			...
			ASTNode2Element jo2uo, ASTNode2Element nd2ne) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject jOwnerType, EObject feature,
			EObject bodyDeclaration, EObject uOwnerType, EObject jo2uo, EObject nd2ne) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (FieldDec2Property4_AnonymousImpl.pattern_FieldDec2Property4_Anonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldDec2Property4_AnonymousImpl
					.pattern_FieldDec2Property4_Anonymous_24_5_matchcorrcontext_blackBBBBFFBB(jOwnerType, feature,
							bodyDeclaration, uOwnerType, sourceMatch, targetMatch)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = FieldDec2Property4_AnonymousImpl
							.pattern_FieldDec2Property4_Anonymous_29_6_perform_blackBBBBBBB(jOwnerType, feature,
									bodyDeclaration, uOwnerType, jo2uo, nd2ne, ruleResult);
					if (result6_black == null) {
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, AnonymousClassDeclaration jOwnerType,
			Property feature, MFieldDefinition bodyDeclaration, org.eclipse.uml2.uml.Class uOwnerType,
			ASTNode2Element jo2uo, ASTNode2Element nd2ne, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_PROPERTY_MFIELDDEFINITION_CLASS_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_PROPERTY_MFIELDDEFINITION_CLASS_ASTNODE2ELEMENT_ASTNODE2ELEMENT:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_120__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_120((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_128__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ANONYMOUSCLASSDECLARATION_PROPERTY_MFIELDDEFINITION_CLASS_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MODELGENERATORRULERESULT:
					...
					if (tmpUOwnerType instanceof org.eclipse.uml2.uml.Class) {
						...
						if (tmpJo2uo instanceof ASTNode2Element) {
							...
							if (tmpNd2ne instanceof ASTNode2Element) {
								...
								return new Object[] { jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne,
										isApplicableMatch };
							}
						}
					}
		...
		if (!jo2uo.equals(nd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_black = pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_blackBBBBBBFBB(
					jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject uOwnerType, EObject jo2uo, EObject nd2ne) {
															...
															if (!jo2uo.equals(nd2ne)) {
																if (!nd2ne.equals(uOwnerType)) {
																	return new Object[] { ruleresult, jOwnerType,
																			feature, bodyDeclaration, uOwnerType, jo2uo,
																			nd2ne };
																}
															}
														}
	...
	public static final void pattern_FieldDec2Property4_Anonymous_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject bodyDeclaration, EObject uOwnerType, EObject jo2uo, EObject nd2ne) {
		_this.registerObjects_FWD(ruleresult, jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne);
			...
			if (tmpUOwnerType instanceof org.eclipse.uml2.uml.Class) {
				...
				for (ASTNode2Element nd2ne : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!jo2uo.equals(nd2ne)) {
						...
						if (tmpFeature instanceof Property) {
							Property feature = (Property) tmpFeature;
							_result.add(new Object[] { jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne,
									match });
						}
					...
					if (uOwnerType.equals(jo2uo.getTarget())) {
						if (bodyDeclaration.equals(nd2ne.getSource())) {
							if (feature.equals(nd2ne.getTarget())) {
								_result.add(new Object[] { jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo,
										nd2ne });
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne, isApplicableMatch,
				jOwnerType__bodyDeclaration____bodyDeclarations,
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, jOwnerType, feature, bodyDeclaration,
				uOwnerType, jo2uo, nd2ne);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jOwnerType, feature, bodyDeclaration, uOwnerType,
					jo2uo, nd2ne };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_binding = pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne);
	...
	public static final void pattern_FieldDec2Property4_Anonymous_11_5_registerobjects_expressionBBBBBBBB(
			FieldDec2Property4_Anonymous _this, PerformRuleResult ruleresult, EObject jOwnerType, EObject feature,
			EObject bodyDeclaration, EObject uOwnerType, EObject jo2uo, EObject nd2ne) {
		_this.registerObjects_BWD(ruleresult, jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne);
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		nd2ne__feature____target.setName(nd2ne__feature____target_name_prime);
		return new Object[] { jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne, isApplicableMatch,
				uOwnerType__feature____ownedAttribute, jo2uo__jOwnerType____source, jo2uo__uOwnerType____target,
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, jOwnerType, feature, bodyDeclaration,
				uOwnerType, jo2uo, nd2ne, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jOwnerType, feature, bodyDeclaration, uOwnerType,
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_binding = pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne, ruleResult);
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_29_6_perform_blackBBBBBBB(
			...
			ModelgeneratorRuleResult ruleResult) {
		if (!jo2uo.equals(nd2ne)) {
			return new Object[] { jOwnerType, feature, bodyDeclaration, uOwnerType, jo2uo, nd2ne, ruleResult };
		}
		return null;
	}
