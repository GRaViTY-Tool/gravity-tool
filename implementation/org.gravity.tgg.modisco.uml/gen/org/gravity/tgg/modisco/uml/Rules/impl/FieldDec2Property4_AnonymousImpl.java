...
public class FieldDec2Property4_AnonymousImpl extends AbstractRuleImpl implements FieldDec2Property4_Anonymous {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		FieldDec2Property4_AnonymousImpl.pattern_FieldDec2Property4_Anonymous_1_5_registerobjects_expressionBBBBBBBB(
				this, ruleresult, nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType);
			...
			for (Object[] result3_black : FieldDec2Property4_AnonymousImpl
				...
				Object[] result4_bindingAndBlack = FieldDec2Property4_AnonymousImpl
						.pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element nd2ne,
			ASTNode2Element jo2uo, MFieldDefinition bodyDeclaration, Property feature,
			org.eclipse.uml2.uml.Class uOwnerType, AnonymousClassDeclaration jOwnerType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject nd2ne, EObject jo2uo, EObject bodyDeclaration,
			EObject feature, EObject uOwnerType, EObject jOwnerType) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4_AnonymousImpl
				.pattern_FieldDec2Property4_Anonymous_12_2_corematch_blackFFFBBFB(feature, uOwnerType, match)) {
			ASTNode2Element nd2ne = (ASTNode2Element) result2_black[0];
			ASTNode2Element jo2uo = (ASTNode2Element) result2_black[1];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (FieldDec2Property4_AnonymousImpl.pattern_FieldDec2Property4_Anonymous_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldDec2Property4_AnonymousImpl
					.pattern_FieldDec2Property4_Anonymous_24_5_matchcorrcontext_blackFFBBBBBB(bodyDeclaration, feature,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer, ASTNode2Element nd2neParameter,
		...
		for (Object[] result2_black : FieldDec2Property4_AnonymousImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[nd2ne] = " + nd2ne + ", "
						+ "[jo2uo] = " + jo2uo + ", " + "[bodyDeclaration] = " + bodyDeclaration + ", " + "[feature] = "
						+ feature + ", " + "[uOwnerType] = " + uOwnerType + ", " + "[jOwnerType] = " + jOwnerType + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MFIELDDEFINITION_PROPERTY_CLASS_ANONYMOUSCLASSDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					...
					(Property) arguments.get(4), (org.eclipse.uml2.uml.Class) arguments.get(5),
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MFIELDDEFINITION_PROPERTY_CLASS_ANONYMOUSCLASSDECLARATION:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_103__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_103((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_111__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___IS_APPLICABLE_SOLVE_CSP_CC__MFIELDDEFINITION_PROPERTY_CLASS_ANONYMOUSCLASSDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_ANONYMOUS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_ASTNODE2ELEMENT_MFIELDDEFINITION_PROPERTY_CLASS_ANONYMOUSCLASSDECLARATION_MODELGENERATORRULERESULT:
					...
					if (tmpFeature instanceof Property) {
						...
						if (tmpUOwnerType instanceof org.eclipse.uml2.uml.Class) {
							...
							if (tmpJOwnerType instanceof AnonymousClassDeclaration) {
								...
								return new Object[] { nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType,
										isApplicableMatch };
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element nd2ne, ASTNode2Element jo2uo, MFieldDefinition bodyDeclaration, Property feature,
			org.eclipse.uml2.uml.Class uOwnerType, AnonymousClassDeclaration jOwnerType,
		...
		if (!jo2uo.equals(nd2ne)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_black = pattern_FieldDec2Property4_Anonymous_1_1_performtransformation_blackBBBBBBFBB(
					nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType, _this, isApplicableMatch);
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject nd2ne, EObject jo2uo, EObject bodyDeclaration, EObject feature,
															...
															if (!jOwnerType.equals(jo2uo)) {
																if (!jOwnerType.equals(uOwnerType)) {
																	return new Object[] { ruleresult, nd2ne, jo2uo,
																			bodyDeclaration, feature, uOwnerType,
																			jOwnerType };
																}
															}
														}
	...
	public static final void pattern_FieldDec2Property4_Anonymous_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject bodyDeclaration, EObject feature, EObject uOwnerType, EObject jOwnerType) {
		_this.registerObjects_FWD(ruleresult, nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType);
			...
			if (tmpFeature instanceof Property) {
				...
				for (ASTNode2Element jo2uo : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (!jo2uo.equals(nd2ne)) {
						...
						if (tmpUOwnerType instanceof org.eclipse.uml2.uml.Class) {
							org.eclipse.uml2.uml.Class uOwnerType = (org.eclipse.uml2.uml.Class) tmpUOwnerType;
							_result.add(new Object[] { nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType,
									match });
						}
					...
					if (feature.equals(nd2ne.getTarget())) {
						if (jOwnerType.equals(jo2uo.getSource())) {
							if (jOwnerType.getBodyDeclarations().contains(bodyDeclaration)) {
								_result.add(new Object[] { nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType,
										jOwnerType });
							}
						}
					}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		bodyDeclaration__jOwnerType____anonymousClassDeclarationOwner
				.setName(bodyDeclaration__jOwnerType____anonymousClassDeclarationOwner_name_prime);
		return new Object[] { nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType, isApplicableMatch,
				nd2ne__bodyDeclaration____source, jo2uo__uOwnerType____target, nd2ne__feature____target,
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType,
					jOwnerType };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_binding = pattern_FieldDec2Property4_Anonymous_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType);
	...
	public static final void pattern_FieldDec2Property4_Anonymous_11_5_registerobjects_expressionBBBBBBBB(
			FieldDec2Property4_Anonymous _this, PerformRuleResult ruleresult, EObject nd2ne, EObject jo2uo,
			EObject bodyDeclaration, EObject feature, EObject uOwnerType, EObject jOwnerType) {
		_this.registerObjects_BWD(ruleresult, nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType);
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		jo2uo__jOwnerType____source.setName(jo2uo__jOwnerType____source_name_prime);
		return new Object[] { nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType, isApplicableMatch,
				nd2ne__bodyDeclaration____source, jo2uo__uOwnerType____target, uOwnerType__feature____ownedAttribute,
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_24_3_solvecsp_bindingFBBBBBBB(
			FieldDec2Property4_Anonymous _this, MFieldDefinition bodyDeclaration, Property feature,
			org.eclipse.uml2.uml.Class uOwnerType, AnonymousClassDeclaration jOwnerType, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_binding = pattern_FieldDec2Property4_Anonymous_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType, ruleResult);
	...
	public static final Object[] pattern_FieldDec2Property4_Anonymous_29_6_perform_blackBBBBBBB(ASTNode2Element nd2ne,
			...
			ModelgeneratorRuleResult ruleResult) {
		if (!jo2uo.equals(nd2ne)) {
			return new Object[] { nd2ne, jo2uo, bodyDeclaration, feature, uOwnerType, jOwnerType, ruleResult };
		}
		return null;
	}
