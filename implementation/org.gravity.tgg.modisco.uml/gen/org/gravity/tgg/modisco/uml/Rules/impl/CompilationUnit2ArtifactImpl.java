...
public class CompilationUnit2ArtifactImpl extends AbstractRuleImpl implements CompilationUnit2Artifact {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_1_1_performtransformation_greenBFFBB(compilationUnit, um, csp);
		...
		CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, jm2um, jm, compilationUnit, c2a, artifact, um);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject jm2um, EObject jm, EObject compilationUnit,
			EObject c2a, EObject artifact, EObject um) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, jm2um, jm,
						compilationUnit, c2a, artifact, um);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[jm2um] = "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject jm2um, EObject jm, EObject compilationUnit,
			EObject c2a, EObject artifact, EObject um) {
		ruleresult.registerObject("jm2um", jm2um);
		ruleresult.registerObject("jm", jm);
		ruleresult.registerObject("compilationUnit", compilationUnit);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_713(EMoflonEdge _edge_packagedElement) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_770(EMoflonEdge _edge_compilationUnits) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_713__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_713((EMoflonEdge) arguments.get(0));
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_770__EMOFLONEDGE:
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_1_performtransformation_greenBFFBB(
		...
		return new Object[] { compilationUnit, c2a, artifact, um, csp };
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject jm2um, EObject jm, EObject compilationUnit, EObject c2a,
														...
														if (!artifact.equals(compilationUnit)) {
															if (!artifact.equals(c2a)) {
																if (!artifact.equals(um)) {
																	return new Object[] { ruleresult, jm2um, jm,
																			compilationUnit, c2a, artifact, um };
																}
															}
														}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject jm, EObject compilationUnit, EObject c2a, EObject artifact,
			EObject um) {
		...
		jm__compilationUnit____compilationUnits.setName(jm__compilationUnit____compilationUnits_name_prime);
		return new Object[] { ruleresult, jm, compilationUnit, c2a, artifact, um, c2a__compilationUnit____source,
				um__artifact____packagedElement, c2a__artifact____target, jm__compilationUnit____compilationUnits };
	}

	public static final void pattern_CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBB(
			CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject jm2um, EObject jm,
			EObject compilationUnit, EObject c2a, EObject artifact, EObject um) {
		_this.registerObjects_FWD(ruleresult, jm2um, jm, compilationUnit, c2a, artifact, um);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_2_3_findcontext_greenBBBBFFFF(
		...
		return new Object[] { jm2um, jm, compilationUnit, um, isApplicableMatch, jm2um__jm____source,
				jm2um__um____target, jm__compilationUnit____compilationUnits };
	}
	...
	public static final void pattern_CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBB(
			CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject jm2um, EObject jm,
			EObject compilationUnit, EObject c2a, EObject artifact, EObject um) {
		_this.registerObjects_BWD(ruleresult, jm2um, jm, compilationUnit, c2a, artifact, um);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_29_6_perform_greenBFFFBBB(Model jm,
		...
		return new Object[] { jm, compilationUnit, c2a, artifact, um, ruleResult, csp };
	}
