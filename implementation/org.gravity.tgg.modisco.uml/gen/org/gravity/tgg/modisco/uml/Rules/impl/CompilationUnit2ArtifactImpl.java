...
public class CompilationUnit2ArtifactImpl extends AbstractRuleImpl implements CompilationUnit2Artifact {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, artifact, jm2um, um,
						c2a, compilationUnit, jm);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[artifact] = " + artifact + ", " + "[jm2um] = " + jm2um + ", " + "[um] = " + um + ", "
					+ "[c2a] = " + c2a + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[jm] = " + jm + ".");
		}
		CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(
				ruleresult, artifact, um, c2a, compilationUnit, jm);
		...
		CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, artifact, jm2um, um, c2a, compilationUnit, jm);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_2_2_corematch_blackFFBBB(compilationUnit, jm, match)) {
			...
			for (Object[] result3_black : CompilationUnit2ArtifactImpl
					.pattern_CompilationUnit2Artifact_2_3_findcontext_blackBBBB(jm2um, um, compilationUnit, jm)) {
				Object[] result3_green = CompilationUnit2ArtifactImpl
						.pattern_CompilationUnit2Artifact_2_3_findcontext_greenBBBBFFFF(jm2um, um, compilationUnit, jm);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage jm2um,
			org.eclipse.uml2.uml.Model um, CompilationUnit compilationUnit, Model jm) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject artifact, EObject jm2um, EObject um,
			EObject c2a, EObject compilationUnit, EObject jm) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, artifact, jm2um, um,
						c2a, compilationUnit, jm);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[artifact] = " + artifact + ", " + "[jm2um] = " + jm2um + ", " + "[um] = " + um + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject artifact, EObject jm2um, EObject um,
			EObject c2a, EObject compilationUnit, EObject jm) {
		ruleresult.registerObject("artifact", artifact);
		ruleresult.registerObject("jm2um", jm2um);
		ruleresult.registerObject("um", um);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_148(EMoflonEdge _edge_packagedElement) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_160(EMoflonEdge _edge_compilationUnits) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, artifact, um,
		...
		if (CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : CompilationUnit2ArtifactImpl
				...
				Object[] result6_black = CompilationUnit2ArtifactImpl
						.pattern_CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBB(artifact, um,
								compilationUnit, jm, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[artifact] = " + artifact
							+ ", " + "[um] = " + um + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[jm] = "
							+ jm + ", " + "[ccMatch] = " + ccMatch + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Artifact artifact, org.eclipse.uml2.uml.Model um,
		...
		for (Object[] result2_black : CompilationUnit2ArtifactImpl
			...
			if (CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_29_6_perform_greenFBFFBBB(um, jm,
							ruleResult, csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_JAVAMODEL2UMLPACKAGE_MODEL_COMPILATIONUNIT_MODEL:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					...
					(CompilationUnit) arguments.get(3), (Model) arguments.get(4));
		...
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_148__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_148((EMoflonEdge) arguments.get(0));
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_160__EMOFLONEDGE:
			...
			if (tmpUm instanceof org.eclipse.uml2.uml.Model) {
				...
				if (tmpCompilationUnit instanceof CompilationUnit) {
					...
					if (tmpJm instanceof Model) {
						...
						return new Object[] { jm2um, um, compilationUnit, jm, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_1_performtransformation_blackBBBBFBB(
			JavaModel2UMLPackage jm2um, org.eclipse.uml2.uml.Model um, CompilationUnit compilationUnit, Model jm,
			CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { jm2um, um, compilationUnit, jm, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_CompilationUnit2Artifact_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_CompilationUnit2Artifact_1_1_performtransformation_black = pattern_CompilationUnit2Artifact_1_1_performtransformation_blackBBBBFBB(
					jm2um, um, compilationUnit, jm, _this, isApplicableMatch);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject artifact, EObject jm2um, EObject um, EObject c2a,
			EObject compilationUnit, EObject jm) {
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject artifact, EObject um, EObject c2a, EObject compilationUnit,
			EObject jm) {
		...
		jm__compilationUnit____compilationUnits.setName(jm__compilationUnit____compilationUnits_name_prime);
		return new Object[] { ruleresult, artifact, um, c2a, compilationUnit, jm, um__artifact____packagedElement,
				c2a__artifact____target, c2a__compilationUnit____source, jm__compilationUnit____compilationUnits };
	}

	public static final void pattern_CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBB(
			CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject artifact, EObject jm2um, EObject um,
			EObject c2a, EObject compilationUnit, EObject jm) {
		_this.registerObjects_FWD(ruleresult, artifact, jm2um, um, c2a, compilationUnit, jm);
	...
	public static final Iterable<Object[]> pattern_CompilationUnit2Artifact_2_2_corematch_blackFFBBB(
		...
		for (JavaModel2UMLPackage jm2um : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(jm,
			...
			if (tmpUm instanceof org.eclipse.uml2.uml.Model) {
				...
				if (um_name.equals("source references")) {
					_result.add(new Object[] { jm2um, um, compilationUnit, jm, match });
				}
		...
		if (um.equals(jm2um.getTarget())) {
			if (jm.equals(jm2um.getSource())) {
				if (jm.getCompilationUnits().contains(compilationUnit)) {
					String um_name = um.getName();
					if (um_name.equals("source references")) {
						_result.add(new Object[] { jm2um, um, compilationUnit, jm });
					}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_2_3_findcontext_greenBBBBFFFF(
		...
		jm__compilationUnit____compilationUnits.setName(jm__compilationUnit____compilationUnits_name_prime);
		return new Object[] { jm2um, um, compilationUnit, jm, isApplicableMatch, jm2um__um____target,
	...
	public static final Object[] pattern_CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBB(
			...
			org.eclipse.uml2.uml.Model um, CompilationUnit compilationUnit, Model jm) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, jm2um, um, compilationUnit, jm);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, jm2um, um, compilationUnit, jm };
		}
		return null;
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_CompilationUnit2Artifact_2_4_solveCSP_binding = pattern_CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, jm2um, um, compilationUnit, jm);
	...
	public static final void pattern_CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBB(
			CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject artifact, EObject jm2um, EObject um,
			EObject c2a, EObject compilationUnit, EObject jm) {
		_this.registerObjects_BWD(ruleresult, artifact, jm2um, um, c2a, compilationUnit, jm);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_12_3_findcontext_greenBBBBFFFF(Artifact artifact,
		...
		jm2um__um____target.setName(jm2um__um____target_name_prime);
		jm2um__jm____source.setName(jm2um__jm____source_name_prime);
		return new Object[] { artifact, jm2um, um, jm, isApplicableMatch, um__artifact____packagedElement,
		...
		if (tmpArtifact instanceof Artifact) {
			...
			if (tmpUm instanceof org.eclipse.uml2.uml.Model) {
				...
				if (tmpCompilationUnit instanceof CompilationUnit) {
					...
					if (tmpJm instanceof Model) {
						Model jm = (Model) tmpJm;
						return new Object[] { artifact, um, compilationUnit, jm, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBB(Artifact artifact,
			org.eclipse.uml2.uml.Model um, CompilationUnit compilationUnit, Model jm, Match sourceMatch,
			Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			String um_name = um.getName();
			if (um_name.equals("source references")) {
				return new Object[] { artifact, um, compilationUnit, jm, sourceMatch, targetMatch };
			}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_black = pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBB(
					artifact, um, compilationUnit, jm, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBB(
			CompilationUnit2Artifact _this, Artifact artifact, org.eclipse.uml2.uml.Model um,
			CompilationUnit compilationUnit, Model jm, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(artifact, um, compilationUnit, jm, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, artifact, um, compilationUnit, jm, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_CompilationUnit2Artifact_24_3_solvecsp_binding = pattern_CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBB(
				_this, artifact, um, compilationUnit, jm, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBB(
			Artifact artifact, org.eclipse.uml2.uml.Model um, CompilationUnit compilationUnit, Model jm,
			CCMatch ccMatch) {
		return new Object[] { artifact, um, compilationUnit, jm, ccMatch };
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_29_6_perform_greenFBFFBBB(
		...
		return new Object[] { artifact, um, c2a, compilationUnit, jm, ruleResult, csp };
	}
