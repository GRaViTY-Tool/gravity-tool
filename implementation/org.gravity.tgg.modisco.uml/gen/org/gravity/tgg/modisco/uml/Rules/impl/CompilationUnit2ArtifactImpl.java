...
public class CompilationUnit2ArtifactImpl extends AbstractRuleImpl implements CompilationUnit2Artifact {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, c2a, um, jm,
						compilationUnit, artifact, jm2um);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[c2a] = "
							+ c2a + ", " + "[um] = " + um + ", " + "[jm] = " + jm + ", " + "[compilationUnit] = "
		...
		CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(
				ruleresult, c2a, um, jm, compilationUnit, artifact);
		...
		CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, c2a, um, jm, compilationUnit, artifact, jm2um);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_2_2_corematch_blackFBBFB(jm, compilationUnit, match)) {
			...
			for (Object[] result3_black : CompilationUnit2ArtifactImpl
					.pattern_CompilationUnit2Artifact_2_3_findcontext_blackBBBB(um, jm, compilationUnit, jm2um)) {
				Object[] result3_green = CompilationUnit2ArtifactImpl
						.pattern_CompilationUnit2Artifact_2_3_findcontext_greenBBBBFFFF(um, jm, compilationUnit, jm2um);
				...
				Object[] result4_bindingAndBlack = CompilationUnit2ArtifactImpl
						.pattern_CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch,
								um, jm, compilationUnit, jm2um);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[um] = " + um + ", " + "[jm] = "
							+ jm + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[jm2um] = " + jm2um + ".");
				}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Model um, Model jm,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject c2a, EObject um, EObject jm,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, c2a, um, jm,
						compilationUnit, artifact, jm2um);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[c2a] = "
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : CompilationUnit2ArtifactImpl
			...
			// ForEach 
			for (Object[] result3_black : CompilationUnit2ArtifactImpl
					.pattern_CompilationUnit2Artifact_12_3_findcontext_blackBBBB(um, jm, artifact, jm2um)) {
				Object[] result3_green = CompilationUnit2ArtifactImpl
						.pattern_CompilationUnit2Artifact_12_3_findcontext_greenBBBBFFFF(um, jm, artifact, jm2um);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				...
				Object[] result4_bindingAndBlack = CompilationUnit2ArtifactImpl
						.pattern_CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch,
								um, jm, artifact, jm2um);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[um] = " + um + ", " + "[jm] = "
							+ jm + ", " + "[artifact] = " + artifact + ", " + "[jm2um] = " + jm2um + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject c2a, EObject um, EObject jm,
			EObject compilationUnit, EObject artifact, EObject jm2um) {
		ruleresult.registerObject("c2a", c2a);
		ruleresult.registerObject("um", um);
		ruleresult.registerObject("jm", jm);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_51(EMoflonEdge _edge_packagedElement) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_52(EMoflonEdge _edge_compilationUnits) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, um, jm, compilationUnit,
		...
		if (CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : CompilationUnit2ArtifactImpl
				...
				Object[] result6_black = CompilationUnit2ArtifactImpl
						.pattern_CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBB(um, jm, compilationUnit,
								artifact, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Model um, Model jm, CompilationUnit compilationUnit,
		...
		for (Object[] result2_black : CompilationUnit2ArtifactImpl
			...
			if (CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_29_6_perform_greenFBBFFBB(um, jm,
							ruleResult, csp);
					//nothing org.gravity.tgg.modisco.uml.CompilationUnit2Artifact c2a = (org.gravity.tgg.modisco.uml.CompilationUnit2Artifact) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODEL_MODEL_COMPILATIONUNIT_JAVAMODEL2UMLPACKAGE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					...
					(CompilationUnit) arguments.get(3), (JavaModel2UMLPackage) arguments.get(4));
		...
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODEL_MODEL_ARTIFACT_JAVAMODEL2UMLPACKAGE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(org.eclipse.uml2.uml.Model) arguments.get(1), (Model) arguments.get(2),
					(Artifact) arguments.get(3), (JavaModel2UMLPackage) arguments.get(4));
		...
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_51__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_51((EMoflonEdge) arguments.get(0));
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_52__EMOFLONEDGE:
			...
			if (tmpJm instanceof Model) {
				...
				if (tmpCompilationUnit instanceof CompilationUnit) {
					...
					if (tmpJm2um instanceof JavaModel2UMLPackage) {
						...
						return new Object[] { um, jm, compilationUnit, jm2um, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_1_performtransformation_blackBBBBFBB(
			org.eclipse.uml2.uml.Model um, Model jm, CompilationUnit compilationUnit, JavaModel2UMLPackage jm2um,
			CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { um, jm, compilationUnit, jm2um, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_CompilationUnit2Artifact_1_1_performtransformation_binding != null) {
			...
			Model jm = (Model) result_pattern_CompilationUnit2Artifact_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_CompilationUnit2Artifact_1_1_performtransformation_black = pattern_CompilationUnit2Artifact_1_1_performtransformation_blackBBBBFBB(
					um, jm, compilationUnit, jm2um, _this, isApplicableMatch);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject c2a, EObject um, EObject jm, EObject compilationUnit,
													...
													if (!artifact.equals(jm)) {
														if (!artifact.equals(compilationUnit)) {
															if (!artifact.equals(jm2um)) {
																if (!jm2um.equals(um)) {
																	return new Object[] { ruleresult, c2a, um, jm,
																			compilationUnit, artifact, jm2um };
																}
															}
														}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(
		...
		return new Object[] { ruleresult, c2a, um, jm, compilationUnit, artifact,
	...
	public static final void pattern_CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBB(
			CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject c2a, EObject um, EObject jm,
			EObject compilationUnit, EObject artifact, EObject jm2um) {
		_this.registerObjects_FWD(ruleresult, c2a, um, jm, compilationUnit, artifact, jm2um);
	...
	public static final Iterable<Object[]> pattern_CompilationUnit2Artifact_2_2_corematch_blackFBBFB(Model jm,
		...
		for (JavaModel2UMLPackage jm2um : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(jm,
			...
			if (tmpUm instanceof org.eclipse.uml2.uml.Model) {
				org.eclipse.uml2.uml.Model um = (org.eclipse.uml2.uml.Model) tmpUm;
				_result.add(new Object[] { um, jm, compilationUnit, jm2um, match });
			}
		...
		if (jm.getCompilationUnits().contains(compilationUnit)) {
			if (um.equals(jm2um.getTarget())) {
				if (jm.equals(jm2um.getSource())) {
					_result.add(new Object[] { um, jm, compilationUnit, jm2um });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBB(
			...
			Model jm, CompilationUnit compilationUnit, JavaModel2UMLPackage jm2um) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, um, jm, compilationUnit, jm2um);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, um, jm, compilationUnit, jm2um };
		}
		return null;
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_2_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_CompilationUnit2Artifact_2_4_solveCSP_binding = pattern_CompilationUnit2Artifact_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, um, jm, compilationUnit, jm2um);
		...
		if (tmpUm instanceof org.eclipse.uml2.uml.Model) {
			...
			if (tmpJm instanceof Model) {
				...
				if (tmpArtifact instanceof Artifact) {
					...
					if (tmpJm2um instanceof JavaModel2UMLPackage) {
						JavaModel2UMLPackage jm2um = (JavaModel2UMLPackage) tmpJm2um;
						return new Object[] { um, jm, artifact, jm2um, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_11_1_performtransformation_blackBBBBFBB(
			org.eclipse.uml2.uml.Model um, Model jm, Artifact artifact, JavaModel2UMLPackage jm2um,
			CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { um, jm, artifact, jm2um, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_11_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_CompilationUnit2Artifact_11_1_performtransformation_binding != null) {
			...
			Model jm = (Model) result_pattern_CompilationUnit2Artifact_11_1_performtransformation_binding[1];
			...
			Object[] result_pattern_CompilationUnit2Artifact_11_1_performtransformation_black = pattern_CompilationUnit2Artifact_11_1_performtransformation_blackBBBBFBB(
					um, jm, artifact, jm2um, _this, isApplicableMatch);
	...
	public static final void pattern_CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBB(
			CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject c2a, EObject um, EObject jm,
			EObject compilationUnit, EObject artifact, EObject jm2um) {
		_this.registerObjects_BWD(ruleresult, c2a, um, jm, compilationUnit, artifact, jm2um);
	...
	public static final Iterable<Object[]> pattern_CompilationUnit2Artifact_12_2_corematch_blackBFBFB(
		...
		for (JavaModel2UMLPackage jm2um : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(um,
			...
			if (jm != null) {
				_result.add(new Object[] { um, jm, artifact, jm2um, match });
			}
	...
	public static final Iterable<Object[]> pattern_CompilationUnit2Artifact_12_3_findcontext_blackBBBB(
		...
		if (um.getPackagedElements().contains(artifact)) {
			if (um.equals(jm2um.getTarget())) {
				if (jm.equals(jm2um.getSource())) {
					_result.add(new Object[] { um, jm, artifact, jm2um });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_CompilationUnit2Artifact_12_3_findcontext_greenBBBBFFFF(
		...
		jm2um__um____target.setName(jm2um__um____target_name_prime);
		jm2um__jm____source.setName(jm2um__jm____source_name_prime);
		return new Object[] { um, jm, artifact, jm2um, isApplicableMatch, um__artifact____packagedElement,
	...
	public static final Object[] pattern_CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBB(
			CompilationUnit2Artifact _this, IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Model um,
			Model jm, Artifact artifact, JavaModel2UMLPackage jm2um) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, um, jm, artifact, jm2um);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, um, jm, artifact, jm2um };
		}
		return null;
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_12_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_CompilationUnit2Artifact_12_4_solveCSP_binding = pattern_CompilationUnit2Artifact_12_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, um, jm, artifact, jm2um);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_0B(
			Artifact artifact) {
		for (org.eclipse.uml2.uml.Class __DEC_artifact_nestedClassifier_124417 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_CompilationUnit2Artifact_20_2_testcorematchandDECs_black_nac_1B(
			Artifact artifact) {
		for (Interface __DEC_artifact_nestedClassifier_494863 : org.moflon.core.utilities.eMoflonEMFUtil
		...
		if (tmpUm instanceof org.eclipse.uml2.uml.Model) {
			...
			if (tmpJm instanceof Model) {
				...
				if (tmpCompilationUnit instanceof CompilationUnit) {
					...
					if (tmpArtifact instanceof Artifact) {
						Artifact artifact = (Artifact) tmpArtifact;
						return new Object[] { um, jm, compilationUnit, artifact, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBB(
			org.eclipse.uml2.uml.Model um, Model jm, CompilationUnit compilationUnit, Artifact artifact,
			Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { um, jm, compilationUnit, artifact, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_binding != null) {
			...
			Model jm = (Model) result_pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_binding[1];
			...
			Object[] result_pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_black = pattern_CompilationUnit2Artifact_24_2_matchsrctrgcontext_blackBBBBBB(
					um, jm, compilationUnit, artifact, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBB(
			CompilationUnit2Artifact _this, org.eclipse.uml2.uml.Model um, Model jm, CompilationUnit compilationUnit,
			Artifact artifact, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(um, jm, compilationUnit, artifact, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, um, jm, compilationUnit, artifact, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_CompilationUnit2Artifact_24_3_solvecsp_binding = pattern_CompilationUnit2Artifact_24_3_solvecsp_bindingFBBBBBBB(
				_this, um, jm, compilationUnit, artifact, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_24_6_createcorrespondence_blackBBBBB(
			org.eclipse.uml2.uml.Model um, Model jm, CompilationUnit compilationUnit, Artifact artifact,
			CCMatch ccMatch) {
		return new Object[] { um, jm, compilationUnit, artifact, ccMatch };
	}
	...
	public static final Object[] pattern_CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_0B(Artifact artifact) {
		for (org.eclipse.uml2.uml.Class __DEC_artifact_nestedClassifier_408425 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(artifact, org.eclipse.uml2.uml.Class.class, "nestedClassifier")) {
			return new Object[] { artifact };
		}
		return null;
	...
	public static final Object[] pattern_CompilationUnit2Artifact_28_1_matchtggpattern_black_nac_1B(Artifact artifact) {
		for (Interface __DEC_artifact_nestedClassifier_1194 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(artifact, Interface.class, "nestedClassifier")) {
			return new Object[] { artifact };
		}
		return null;
	...
	public static final Object[] pattern_CompilationUnit2Artifact_29_6_perform_greenFBBFFBB(
		...
		return new Object[] { c2a, um, jm, compilationUnit, artifact, ruleResult, csp };
	}
