...
public class CompilationUnit2ArtifactImpl extends AbstractRuleImpl implements CompilationUnit2Artifact {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, c2a, compilationUnit,
						jm2um, artifact, um, jm);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c2a] = " + c2a + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[jm2um] = "
					+ jm2um + ", " + "[artifact] = " + artifact + ", " + "[um] = " + um + ", " + "[jm] = " + jm + ".");
		}
		CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(
				ruleresult, c2a, compilationUnit, artifact, um, jm);
		...
		CompilationUnit2ArtifactImpl.pattern_CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, c2a, compilationUnit, jm2um, artifact, um, jm);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject c2a, EObject compilationUnit, EObject jm2um,
			EObject artifact, EObject um, EObject jm) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_11_1_performtransformation_greenFFBBB(artifact, jm, csp);
		org.gravity.tgg.modisco.uml.CompilationUnit2Artifact c2a = (org.gravity.tgg.modisco.uml.CompilationUnit2Artifact) result1_green[0];
		...
		Object[] result3_black = CompilationUnit2ArtifactImpl
				.pattern_CompilationUnit2Artifact_11_3_bookkeepingforedges_blackBBBBBBB(ruleresult, c2a,
						compilationUnit, jm2um, artifact, um, jm);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[c2a] = " + c2a + ", " + "[compilationUnit] = " + compilationUnit + ", " + "[jm2um] = "
					+ jm2um + ", " + "[artifact] = " + artifact + ", " + "[um] = " + um + ", " + "[jm] = " + jm + ".");
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject c2a, EObject compilationUnit, EObject jm2um,
			EObject artifact, EObject um, EObject jm) {
		ruleresult.registerObject("c2a", c2a);
		ruleresult.registerObject("compilationUnit", compilationUnit);
		ruleresult.registerObject("jm2um", jm2um);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_149(EMoflonEdge _edge_compilationUnits) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_BWD_EMOFLON_EDGE_139__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_139((EMoflonEdge) arguments.get(0));
		case RulesPackage.COMPILATION_UNIT2_ARTIFACT___IS_APPROPRIATE_FWD_EMOFLON_EDGE_149__EMOFLONEDGE:
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject c2a, EObject compilationUnit, EObject jm2um, EObject artifact,
	...
	public static final Object[] pattern_CompilationUnit2Artifact_1_3_bookkeepingforedges_greenBBBBBBFFFF(
			PerformRuleResult ruleresult, EObject c2a, EObject compilationUnit, EObject artifact, EObject um,
			EObject jm) {
		...
		return new Object[] { ruleresult, c2a, compilationUnit, artifact, um, jm, c2a__compilationUnit____source,
	...
	public static final void pattern_CompilationUnit2Artifact_1_5_registerobjects_expressionBBBBBBBB(
			CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject c2a, EObject compilationUnit,
			EObject jm2um, EObject artifact, EObject um, EObject jm) {
		_this.registerObjects_FWD(ruleresult, c2a, compilationUnit, jm2um, artifact, um, jm);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_11_1_performtransformation_greenFFBBB(
		...
		return new Object[] { c2a, compilationUnit, artifact, jm, csp };
	}
	...
	public static final void pattern_CompilationUnit2Artifact_11_5_registerobjects_expressionBBBBBBBB(
			CompilationUnit2Artifact _this, PerformRuleResult ruleresult, EObject c2a, EObject compilationUnit,
			EObject jm2um, EObject artifact, EObject um, EObject jm) {
		_this.registerObjects_BWD(ruleresult, c2a, compilationUnit, jm2um, artifact, um, jm);
	...
	public static final Object[] pattern_CompilationUnit2Artifact_12_3_findcontext_greenBBBBFFFF(
		...
		jm2um__jm____source.setName(jm2um__jm____source_name_prime);
		um__artifact____packagedElement.setName(um__artifact____packagedElement_name_prime);
		return new Object[] { jm2um, artifact, um, jm, isApplicableMatch, jm2um__um____target, jm2um__jm____source,
	...
	public static final Object[] pattern_CompilationUnit2Artifact_29_6_perform_greenFFFBBBB(
		...
		return new Object[] { c2a, compilationUnit, artifact, um, jm, ruleResult, csp };
	}
