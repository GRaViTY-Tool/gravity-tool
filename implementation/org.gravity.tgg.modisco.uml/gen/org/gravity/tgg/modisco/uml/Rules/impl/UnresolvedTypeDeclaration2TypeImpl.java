...
public class UnresolvedTypeDeclaration2TypeImpl extends AbstractRuleImpl implements UnresolvedTypeDeclaration2Type {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_greenBFFBB(mType, externals, csp);
		...
		Object[] result3_black = UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, m2m, mType,
						u2c, model, uClass, externals);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[m2m] = " + m2m + ", " + "[mType] = " + mType + ", " + "[u2c] = " + u2c + ", "
					+ "[model] = " + model + ", " + "[uClass] = " + uClass + ", " + "[externals] = " + externals + ".");
		}
		UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, mType, u2c,
						model, uClass, externals);
		//nothing EMoflonEdge u2c__mType____source = (EMoflonEdge) result3_green[6];
		...
		UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, m2m,
						mType, u2c, model, uClass, externals);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_2_2_corematch_blackFBBFB(mType, model, match)) {
			...
			for (Object[] result3_black : UnresolvedTypeDeclaration2TypeImpl
					.pattern_UnresolvedTypeDeclaration2Type_2_3_findcontext_blackBBBB(m2m, mType, model, externals)) {
				Object[] result3_green = UnresolvedTypeDeclaration2TypeImpl
						.pattern_UnresolvedTypeDeclaration2Type_2_3_findcontext_greenBBBBFFFF(m2m, mType, model,
								externals);
				...
				Object[] result4_bindingAndBlack = UnresolvedTypeDeclaration2TypeImpl
						.pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_bindingAndBlackFBBBBBB(this,
								isApplicableMatch, m2m, mType, model, externals);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[m2m] = " + m2m + ", "
							+ "[mType] = " + mType + ", " + "[model] = " + model + ", " + "[externals] = " + externals
							+ ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage m2m,
			UnresolvedTypeDeclaration mType, Model model, org.eclipse.uml2.uml.Model externals) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject m2m, EObject mType, EObject u2c,
			EObject model, EObject uClass, EObject externals) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_11_1_performtransformation_greenFFBBB(model, uClass, csp);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_12_2_corematch_blackFFBBB(uClass, externals, match)) {
			JavaModel2UMLPackage m2m = (JavaModel2UMLPackage) result2_black[0];
			Model model = (Model) result2_black[1];
			// ForEach 
			for (Object[] result3_black : UnresolvedTypeDeclaration2TypeImpl
					.pattern_UnresolvedTypeDeclaration2Type_12_3_findcontext_blackBBBB(m2m, model, uClass, externals)) {
				Object[] result3_green = UnresolvedTypeDeclaration2TypeImpl
						.pattern_UnresolvedTypeDeclaration2Type_12_3_findcontext_greenBBBBFFFFF(m2m, model, uClass,
								externals);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				...
				Object[] result4_bindingAndBlack = UnresolvedTypeDeclaration2TypeImpl
						.pattern_UnresolvedTypeDeclaration2Type_12_4_solveCSP_bindingAndBlackFBBBBBB(this,
								isApplicableMatch, m2m, model, uClass, externals);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[m2m] = " + m2m + ", "
							+ "[model] = " + model + ", " + "[uClass] = " + uClass + ", " + "[externals] = " + externals
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage m2m, Model model,
			org.eclipse.uml2.uml.Class uClass, org.eclipse.uml2.uml.Model externals) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject m2m, EObject mType, EObject u2c,
			EObject model, EObject uClass, EObject externals) {
		ruleresult.registerObject("m2m", m2m);
		ruleresult.registerObject("mType", mType);
		ruleresult.registerObject("u2c", u2c);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_111(EMoflonEdge _edge_package) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_118(EMoflonEdge _edge_unresolvedItems) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, mType, model,
						uClass, externals, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mType] = " + mType + ", " + "[model] = " + model + ", " + "[uClass] = " + uClass + ", "
		...
		if (UnresolvedTypeDeclaration2TypeImpl.pattern_UnresolvedTypeDeclaration2Type_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : UnresolvedTypeDeclaration2TypeImpl
				...
				Object[] result6_black = UnresolvedTypeDeclaration2TypeImpl
						.pattern_UnresolvedTypeDeclaration2Type_24_6_createcorrespondence_blackBBBBB(mType, model,
								uClass, externals, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mType] = " + mType + ", "
							+ "[model] = " + model + ", " + "[uClass] = " + uClass + ", " + "[externals] = " + externals
							+ ", " + "[ccMatch] = " + ccMatch + ".");
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(UnresolvedTypeDeclaration mType, Model model, org.eclipse.uml2.uml.Class uClass,
		...
		for (Object[] result2_black : UnresolvedTypeDeclaration2TypeImpl
			...
			if (UnresolvedTypeDeclaration2TypeImpl
				...
				if (result5_black != null) {
					...
					UnresolvedTypeDeclaration2TypeImpl.pattern_UnresolvedTypeDeclaration2Type_29_6_perform_greenFFBFBBB(
		...
		switch (operationID) {
			...
			case RulesPackage.UNRESOLVED_TYPE_DECLARATION2_TYPE___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_CLASS_MODEL:
				return isAppropriate_solveCsp_BWD((Match) arguments.get(0),
						(org.eclipse.uml2.uml.Class) arguments.get(1), (org.eclipse.uml2.uml.Model) arguments.get(2));
			...
			case RulesPackage.UNRESOLVED_TYPE_DECLARATION2_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_JAVAMODEL2UMLPACKAGE_MODEL_CLASS_MODEL:
				return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
						...
						(org.eclipse.uml2.uml.Class) arguments.get(3), (org.eclipse.uml2.uml.Model) arguments.get(4));
			...
			case RulesPackage.UNRESOLVED_TYPE_DECLARATION2_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_111__EMOFLONEDGE:
				return isAppropriate_BWD_EMoflonEdge_111((EMoflonEdge) arguments.get(0));
			case RulesPackage.UNRESOLVED_TYPE_DECLARATION2_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_118__EMOFLONEDGE:
			...
			case RulesPackage.UNRESOLVED_TYPE_DECLARATION2_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__UNRESOLVEDTYPEDECLARATION_MODEL_CLASS_MODEL_MATCH_MATCH:
				return isApplicable_solveCsp_CC((UnresolvedTypeDeclaration) arguments.get(0), (Model) arguments.get(1),
			...
			if (tmpMType instanceof UnresolvedTypeDeclaration) {
				...
				if (tmpModel instanceof Model) {
					...
					if (tmpExternals instanceof org.eclipse.uml2.uml.Model) {
						...
						return new Object[] { m2m, mType, model, externals, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_blackBBBBFBB(
			JavaModel2UMLPackage m2m, UnresolvedTypeDeclaration mType, Model model,
			org.eclipse.uml2.uml.Model externals, UnresolvedTypeDeclaration2Type _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { m2m, mType, model, externals, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_black = pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_blackBBBBFBB(
					m2m, mType, model, externals, _this, isApplicableMatch);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_greenBFFBB(
		...
		return new Object[] { mType, u2c, uClass, externals, csp };
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject m2m, EObject mType, EObject u2c, EObject model, EObject uClass,
			EObject externals) {
		if (!m2m.equals(mType)) {
			if (!m2m.equals(u2c)) {
				if (!m2m.equals(model)) {
														...
														if (!externals.equals(u2c)) {
															if (!externals.equals(model)) {
																if (!externals.equals(uClass)) {
																	return new Object[] { ruleresult, m2m, mType, u2c,
																			model, uClass, externals };
																}
															}
														}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mType, EObject u2c, EObject model, EObject uClass,
			EObject externals) {
		...
		model__mType____unresolvedItems.setName(model__mType____unresolvedItems_name_prime);
		return new Object[] { ruleresult, mType, u2c, model, uClass, externals, u2c__mType____source,
	...
	public static final void pattern_UnresolvedTypeDeclaration2Type_1_5_registerobjects_expressionBBBBBBBB(
			UnresolvedTypeDeclaration2Type _this, PerformRuleResult ruleresult, EObject m2m, EObject mType, EObject u2c,
			EObject model, EObject uClass, EObject externals) {
		_this.registerObjects_FWD(ruleresult, m2m, mType, u2c, model, uClass, externals);
	...
	public static final Iterable<Object[]> pattern_UnresolvedTypeDeclaration2Type_2_2_corematch_blackFBBFB(
		...
		for (JavaModel2UMLPackage m2m : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(model,
			...
			if (tmpExternals instanceof org.eclipse.uml2.uml.Model) {
				...
				if (externals_name.equals("externals")) {
					_result.add(new Object[] { m2m, mType, model, externals, match });
				}
		...
		if (externals.equals(m2m.getTarget())) {
			if (model.equals(m2m.getSource())) {
				if (model.getUnresolvedItems().contains(mType)) {
					String externals_name = externals.getName();
					if (externals_name.equals("externals")) {
						_result.add(new Object[] { m2m, mType, model, externals });
					}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_2_3_findcontext_greenBBBBFFFF(
		...
		model__mType____unresolvedItems.setName(model__mType____unresolvedItems_name_prime);
		return new Object[] { m2m, mType, model, externals, isApplicableMatch, m2m__externals____target,
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_bindingFBBBBBB(
			...
			UnresolvedTypeDeclaration mType, Model model, org.eclipse.uml2.uml.Model externals) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, m2m, mType, model, externals);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, m2m, mType, model, externals };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_binding = pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, m2m, mType, model, externals);
		...
		if (tmpM2m instanceof JavaModel2UMLPackage) {
			...
			if (tmpModel instanceof Model) {
				...
				if (tmpUClass instanceof org.eclipse.uml2.uml.Class) {
					...
					if (tmpExternals instanceof org.eclipse.uml2.uml.Model) {
						org.eclipse.uml2.uml.Model externals = (org.eclipse.uml2.uml.Model) tmpExternals;
						return new Object[] { m2m, model, uClass, externals, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_11_1_performtransformation_blackBBBBFBB(
			JavaModel2UMLPackage m2m, Model model, org.eclipse.uml2.uml.Class uClass,
			org.eclipse.uml2.uml.Model externals, UnresolvedTypeDeclaration2Type _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { m2m, model, uClass, externals, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_11_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_UnresolvedTypeDeclaration2Type_11_1_performtransformation_binding != null) {
			...
			Model model = (Model) result_pattern_UnresolvedTypeDeclaration2Type_11_1_performtransformation_binding[1];
			...
			Object[] result_pattern_UnresolvedTypeDeclaration2Type_11_1_performtransformation_black = pattern_UnresolvedTypeDeclaration2Type_11_1_performtransformation_blackBBBBFBB(
					m2m, model, uClass, externals, _this, isApplicableMatch);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_11_1_performtransformation_greenFFBBB(
		...
		return new Object[] { mType, u2c, model, uClass, csp };
	}
	...
	public static final void pattern_UnresolvedTypeDeclaration2Type_11_5_registerobjects_expressionBBBBBBBB(
			UnresolvedTypeDeclaration2Type _this, PerformRuleResult ruleresult, EObject m2m, EObject mType, EObject u2c,
			EObject model, EObject uClass, EObject externals) {
		_this.registerObjects_BWD(ruleresult, m2m, mType, u2c, model, uClass, externals);
	...
	public static final Iterable<Object[]> pattern_UnresolvedTypeDeclaration2Type_12_2_corematch_blackFFBBB(
		...
		if (externals_name.equals("externals")) {
			for (JavaModel2UMLPackage m2m : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (model != null) {
					_result.add(new Object[] { m2m, model, uClass, externals, match });
				}
		...
		if (externals.equals(uClass.getPackage())) {
			if (externals.equals(m2m.getTarget())) {
				if (model.equals(m2m.getSource())) {
					String externals_name = externals.getName();
					if (externals_name.equals("externals")) {
						_result.add(new Object[] { m2m, model, uClass, externals });
					}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_12_3_findcontext_greenBBBBFFFFF(
		...
		m2m__externals____target.setName(m2m__externals____target_name_prime);
		m2m__model____source.setName(m2m__model____source_name_prime);
		return new Object[] { m2m, model, uClass, externals, isApplicableMatch, uClass__externals____package,
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_12_4_solveCSP_bindingFBBBBBB(
			UnresolvedTypeDeclaration2Type _this, IsApplicableMatch isApplicableMatch, JavaModel2UMLPackage m2m,
			Model model, org.eclipse.uml2.uml.Class uClass, org.eclipse.uml2.uml.Model externals) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, m2m, model, uClass, externals);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, m2m, model, uClass, externals };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_12_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_UnresolvedTypeDeclaration2Type_12_4_solveCSP_binding = pattern_UnresolvedTypeDeclaration2Type_12_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, m2m, model, uClass, externals);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_21_2_testcorematchandDECs_black_nac_0B(
		...
		Modifier __DEC_mType_modifier_36288 = mType.getModifier();
		if (__DEC_mType_modifier_36288 != null) {
		...
		if (tmpMType instanceof UnresolvedTypeDeclaration) {
			...
			if (tmpModel instanceof Model) {
				...
				if (tmpUClass instanceof org.eclipse.uml2.uml.Class) {
					...
					if (tmpExternals instanceof org.eclipse.uml2.uml.Model) {
						org.eclipse.uml2.uml.Model externals = (org.eclipse.uml2.uml.Model) tmpExternals;
						return new Object[] { mType, model, uClass, externals, sourceMatch, targetMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_blackBBBBBB(
			UnresolvedTypeDeclaration mType, Model model, org.eclipse.uml2.uml.Class uClass,
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_binding != null) {
			...
			Model model = (Model) result_pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_binding[1];
			...
			Object[] result_pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_black = pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_blackBBBBBB(
					mType, model, uClass, externals, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_bindingFBBBBBBB(
			UnresolvedTypeDeclaration2Type _this, UnresolvedTypeDeclaration mType, Model model,
			org.eclipse.uml2.uml.Class uClass, org.eclipse.uml2.uml.Model externals, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mType, model, uClass, externals, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mType, model, uClass, externals, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_binding = pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_bindingFBBBBBBB(
				_this, mType, model, uClass, externals, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { mType, model, uClass, externals, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_27_1_matchtggpattern_black_nac_0B(
			UnresolvedTypeDeclaration mType) {
		Modifier __DEC_mType_modifier_936980 = mType.getModifier();
		if (__DEC_mType_modifier_936980 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_29_6_perform_greenFFBFBBB(Model model,
		...
		return new Object[] { mType, u2c, model, uClass, externals, ruleResult, csp };
	}
