...
public class UnresolvedTypeDeclaration2TypeImpl extends AbstractRuleImpl implements UnresolvedTypeDeclaration2Type {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, externals, m2m,
						u2c, uClass, model, mType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[externals] = " + externals + ", " + "[m2m] = " + m2m + ", " + "[u2c] = " + u2c + ", "
					+ "[uClass] = " + uClass + ", " + "[model] = " + model + ", " + "[mType] = " + mType + ".");
		}
		UnresolvedTypeDeclaration2TypeImpl
		...
		//nothing EMoflonEdge model__mType____unresolvedItems = (EMoflonEdge) result3_green[9];
		...
		UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
						externals, m2m, u2c, uClass, model, mType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_2_2_corematch_blackFFBBB(model, mType, match)) {
			...
			for (Object[] result3_black : UnresolvedTypeDeclaration2TypeImpl
					.pattern_UnresolvedTypeDeclaration2Type_2_3_findcontext_blackBBBB(externals, m2m, model, mType)) {
				Object[] result3_green = UnresolvedTypeDeclaration2TypeImpl
						.pattern_UnresolvedTypeDeclaration2Type_2_3_findcontext_greenBBBBFFFF(externals, m2m, model,
								mType);
				...
				Object[] result4_bindingAndBlack = UnresolvedTypeDeclaration2TypeImpl
						.pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_bindingAndBlackFBBBBBB(this,
								isApplicableMatch, externals, m2m, model, mType);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[externals] = " + externals + ", "
							+ "[m2m] = " + m2m + ", " + "[model] = " + model + ", " + "[mType] = " + mType + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.uml2.uml.Model externals,
			JavaModel2UMLPackage m2m, Model model, UnresolvedTypeDeclaration mType) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject externals, EObject m2m, EObject u2c,
			EObject uClass, EObject model, EObject mType) {
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject externals, EObject m2m, EObject u2c,
			EObject uClass, EObject model, EObject mType) {
		ruleresult.registerObject("externals", externals);
		ruleresult.registerObject("m2m", m2m);
		ruleresult.registerObject("u2c", u2c);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_108(EMoflonEdge _edge_package) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_113(EMoflonEdge _edge_unresolvedItems) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedTypeDeclaration2TypeImpl
				.pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, externals, uClass,
						model, mType, sourceMatch, targetMatch);
		...
		if (UnresolvedTypeDeclaration2TypeImpl.pattern_UnresolvedTypeDeclaration2Type_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : UnresolvedTypeDeclaration2TypeImpl
				...
				Object[] result6_black = UnresolvedTypeDeclaration2TypeImpl
						.pattern_UnresolvedTypeDeclaration2Type_24_6_createcorrespondence_blackBBBBB(externals, uClass,
								model, mType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[externals] = "
							+ externals + ", " + "[uClass] = " + uClass + ", " + "[model] = " + model + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(org.eclipse.uml2.uml.Model externals, org.eclipse.uml2.uml.Class uClass,
			Model model, UnresolvedTypeDeclaration mType, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : UnresolvedTypeDeclaration2TypeImpl
			...
			if (UnresolvedTypeDeclaration2TypeImpl
				...
				if (result5_black != null) {
					...
					UnresolvedTypeDeclaration2TypeImpl.pattern_UnresolvedTypeDeclaration2Type_29_6_perform_greenBFFBFBB(
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.UNRESOLVED_TYPE_DECLARATION2_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODEL_JAVAMODEL2UMLPACKAGE_MODEL_UNRESOLVEDTYPEDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					...
					(Model) arguments.get(3), (UnresolvedTypeDeclaration) arguments.get(4));
		...
		case RulesPackage.UNRESOLVED_TYPE_DECLARATION2_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_108__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_108((EMoflonEdge) arguments.get(0));
		case RulesPackage.UNRESOLVED_TYPE_DECLARATION2_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_113__EMOFLONEDGE:
		...
		case RulesPackage.UNRESOLVED_TYPE_DECLARATION2_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__MODEL_CLASS_MODEL_UNRESOLVEDTYPEDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((org.eclipse.uml2.uml.Model) arguments.get(0),
					...
					(UnresolvedTypeDeclaration) arguments.get(3), (Match) arguments.get(4), (Match) arguments.get(5));
			...
			if (tmpM2m instanceof JavaModel2UMLPackage) {
				...
				if (tmpModel instanceof Model) {
					...
					if (tmpMType instanceof UnresolvedTypeDeclaration) {
						...
						return new Object[] { externals, m2m, model, mType, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_blackBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { externals, m2m, model, mType, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_black = pattern_UnresolvedTypeDeclaration2Type_1_1_performtransformation_blackBBBBFBB(
					externals, m2m, model, mType, _this, isApplicableMatch);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject externals, EObject m2m, EObject u2c, EObject uClass, EObject model,
			EObject mType) {
														...
														if (!mType.equals(u2c)) {
															if (!mType.equals(uClass)) {
																if (!mType.equals(model)) {
																	return new Object[] { ruleresult, externals, m2m,
																			u2c, uClass, model, mType };
																}
															}
														}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject externals, EObject u2c, EObject uClass, EObject model,
			EObject mType) {
		...
		return new Object[] { ruleresult, externals, u2c, uClass, model, mType, uClass__externals____package,
				externals__uClass____ownedType, u2c__uClass____target, model__mType____unresolvedItems,
	...
	public static final void pattern_UnresolvedTypeDeclaration2Type_1_5_registerobjects_expressionBBBBBBBB(
			UnresolvedTypeDeclaration2Type _this, PerformRuleResult ruleresult, EObject externals, EObject m2m,
			EObject u2c, EObject uClass, EObject model, EObject mType) {
		_this.registerObjects_FWD(ruleresult, externals, m2m, u2c, uClass, model, mType);
	...
	public static final Iterable<Object[]> pattern_UnresolvedTypeDeclaration2Type_2_2_corematch_blackFFBBB(Model model,
		...
		for (JavaModel2UMLPackage m2m : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(model,
			...
			if (tmpExternals instanceof org.eclipse.uml2.uml.Model) {
				...
				if (externals_name.equals("externals")) {
					_result.add(new Object[] { externals, m2m, model, mType, match });
				}
		...
		if (externals.equals(m2m.getTarget())) {
			if (model.equals(m2m.getSource())) {
				if (model.getUnresolvedItems().contains(mType)) {
					String externals_name = externals.getName();
					if (externals_name.equals("externals")) {
						_result.add(new Object[] { externals, m2m, model, mType });
					}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_2_3_findcontext_greenBBBBFFFF(
		...
		model__mType____unresolvedItems.setName(model__mType____unresolvedItems_name_prime);
		return new Object[] { externals, m2m, model, mType, isApplicableMatch, m2m__externals____target,
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_bindingFBBBBBB(
			...
			org.eclipse.uml2.uml.Model externals, JavaModel2UMLPackage m2m, Model model,
			UnresolvedTypeDeclaration mType) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, externals, m2m, model, mType);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, externals, m2m, model, mType };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_binding = pattern_UnresolvedTypeDeclaration2Type_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, externals, m2m, model, mType);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_11_1_performtransformation_greenFBBFB(
		...
		return new Object[] { u2c, uClass, model, mType, csp };
	}
	...
	public static final void pattern_UnresolvedTypeDeclaration2Type_11_5_registerobjects_expressionBBBBBBBB(
			UnresolvedTypeDeclaration2Type _this, PerformRuleResult ruleresult, EObject externals, EObject m2m,
			EObject u2c, EObject uClass, EObject model, EObject mType) {
		_this.registerObjects_BWD(ruleresult, externals, m2m, u2c, uClass, model, mType);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_21_2_testcorematchandDECs_black_nac_0B(
			UnresolvedTypeDeclaration mType) {
		Modifier __DEC_mType_modifier_155570 = mType.getModifier();
		if (__DEC_mType_modifier_155570 != null) {
		...
		if (tmpExternals instanceof org.eclipse.uml2.uml.Model) {
			...
			if (tmpUClass instanceof org.eclipse.uml2.uml.Class) {
				...
				if (tmpModel instanceof Model) {
					...
					if (tmpMType instanceof UnresolvedTypeDeclaration) {
						UnresolvedTypeDeclaration mType = (UnresolvedTypeDeclaration) tmpMType;
						return new Object[] { externals, uClass, model, mType, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_blackBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			String externals_name = externals.getName();
			if (externals_name.equals("externals")) {
				return new Object[] { externals, uClass, model, mType, sourceMatch, targetMatch };
			}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_black = pattern_UnresolvedTypeDeclaration2Type_24_2_matchsrctrgcontext_blackBBBBBB(
					externals, uClass, model, mType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_bindingFBBBBBBB(
			UnresolvedTypeDeclaration2Type _this, org.eclipse.uml2.uml.Model externals,
			org.eclipse.uml2.uml.Class uClass, Model model, UnresolvedTypeDeclaration mType, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(externals, uClass, model, mType, sourceMatch,
				targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, externals, uClass, model, mType, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_binding = pattern_UnresolvedTypeDeclaration2Type_24_3_solvecsp_bindingFBBBBBBB(
				_this, externals, uClass, model, mType, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { externals, uClass, model, mType, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_27_1_matchtggpattern_black_nac_0B(
			UnresolvedTypeDeclaration mType) {
		Modifier __DEC_mType_modifier_915765 = mType.getModifier();
		if (__DEC_mType_modifier_915765 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_UnresolvedTypeDeclaration2Type_29_6_perform_greenBFFBFBB(
		...
		return new Object[] { externals, u2c, uClass, model, mType, ruleResult, csp };
	}
