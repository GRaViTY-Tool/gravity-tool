...
public class FieldDec2Property4ClassImpl extends AbstractRuleImpl implements FieldDec2Property4Class {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		FieldDec2Property4ClassImpl.pattern_FieldDec2Property4Class_1_3_bookkeepingforedges_greenBBBBBFFF(ruleresult,
				jOwnerType, feature, bodyDeclaration, uOwnerType);
		...
		FieldDec2Property4ClassImpl.pattern_FieldDec2Property4Class_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, nd2ne, jOwnerType, feature, bodyDeclaration, jo2uo, uOwnerType);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4ClassImpl
				.pattern_FieldDec2Property4Class_2_2_corematch_blackFBFBFFB(jOwnerType, bodyDeclaration, match)) {
			...
			for (Object[] result3_black : FieldDec2Property4ClassImpl
					.pattern_FieldDec2Property4Class_2_3_findcontext_blackBBBBBB(nd2ne, jOwnerType, feature,
							bodyDeclaration, jo2uo, uOwnerType)) {
				Object[] result3_green = FieldDec2Property4ClassImpl
						.pattern_FieldDec2Property4Class_2_3_findcontext_greenBBBBBBFFFFFFF(nd2ne, jOwnerType, feature,
								bodyDeclaration, jo2uo, uOwnerType);
				...
				Object[] result4_bindingAndBlack = FieldDec2Property4ClassImpl
						.pattern_FieldDec2Property4Class_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								nd2ne, jOwnerType, feature, bodyDeclaration, jo2uo, uOwnerType);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ASTNode2Element nd2ne,
			ClassDeclaration jOwnerType, Property feature, MFieldDefinition bodyDeclaration, ASTNode2Element jo2uo,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : FieldDec2Property4ClassImpl
				.pattern_FieldDec2Property4Class_12_2_corematch_blackFFBFFBB(feature, uOwnerType, match)) {
			ASTNode2Element nd2ne = (ASTNode2Element) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : FieldDec2Property4ClassImpl
					.pattern_FieldDec2Property4Class_12_3_findcontext_blackBBBBBB(nd2ne, jOwnerType, feature,
							bodyDeclaration, jo2uo, uOwnerType)) {
				Object[] result3_green = FieldDec2Property4ClassImpl
						.pattern_FieldDec2Property4Class_12_3_findcontext_greenBBBBBBFFFFFF(nd2ne, jOwnerType, feature,
								bodyDeclaration, jo2uo, uOwnerType);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				...
				//nothing EMoflonEdge uOwnerType__feature____ownedAttribute = (EMoflonEdge) result3_green[11];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_111(EMoflonEdge _edge_ownedAttribute) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (FieldDec2Property4ClassImpl.pattern_FieldDec2Property4Class_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : FieldDec2Property4ClassImpl
					.pattern_FieldDec2Property4Class_24_5_matchcorrcontext_blackFBBBFBBB(jOwnerType, feature,
							bodyDeclaration, uOwnerType, sourceMatch, targetMatch)) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ClassDeclaration jOwnerType, Property feature, MFieldDefinition bodyDeclaration,
		...
		for (Object[] result2_black : FieldDec2Property4ClassImpl
			...
			Object[] result3_bindingAndBlack = FieldDec2Property4ClassImpl
					.pattern_FieldDec2Property4Class_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							nd2ne, jOwnerType, feature, bodyDeclaration, jo2uo, uOwnerType, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[nd2ne] = " + nd2ne + ", "
						+ "[jOwnerType] = " + jOwnerType + ", " + "[feature] = " + feature + ", "
			...
			if (FieldDec2Property4ClassImpl.pattern_FieldDec2Property4Class_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = FieldDec2Property4ClassImpl
						.pattern_FieldDec2Property4Class_29_5_checknacs_blackBBBBBB(nd2ne, jOwnerType, feature,
								bodyDeclaration, jo2uo, uOwnerType);
				if (result5_black != null) {

					Object[] result6_black = FieldDec2Property4ClassImpl
							.pattern_FieldDec2Property4Class_29_6_perform_blackBBBBBBB(nd2ne, jOwnerType, feature,
					...
					FieldDec2Property4ClassImpl.pattern_FieldDec2Property4Class_29_6_perform_greenBBBBB(jOwnerType,
							feature, bodyDeclaration, uOwnerType, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASSDECLARATION_PROPERTY_MFIELDDEFINITION_ASTNODE2ELEMENT_CLASS:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ASTNode2Element) arguments.get(1),
					(ClassDeclaration) arguments.get(2), (Property) arguments.get(3),
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASSDECLARATION_PROPERTY_MFIELDDEFINITION_ASTNODE2ELEMENT_CLASS:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_111__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_111((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_DEC2_PROPERTY4_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_116__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__CLASSDECLARATION_PROPERTY_MFIELDDEFINITION_CLASS_MATCH_MATCH:
		...
		case RulesPackage.FIELD_DEC2_PROPERTY4_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_ASTNODE2ELEMENT_CLASSDECLARATION_PROPERTY_MFIELDDEFINITION_ASTNODE2ELEMENT_CLASS_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_FieldDec2Property4Class_1_1_performtransformation_blackBBBBBBFBB(
			ASTNode2Element nd2ne, ClassDeclaration jOwnerType, Property feature, MFieldDefinition bodyDeclaration,
			ASTNode2Element jo2uo, org.eclipse.uml2.uml.Class uOwnerType, FieldDec2Property4Class _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4Class_2_2_corematch_blackFBFBFFB(
	...
	public static final Iterable<Object[]> pattern_FieldDec2Property4Class_12_2_corematch_blackFFBFFBB(Property feature,
	...
	public static final Object[] pattern_FieldDec2Property4Class_12_3_findcontext_greenBBBBBBFFFFFF(
		...
		return new Object[] { nd2ne, jOwnerType, feature, bodyDeclaration, jo2uo, uOwnerType, isApplicableMatch,
				nd2ne__feature____target, nd2ne__bodyDeclaration____source, jo2uo__jOwnerType____source,
				jo2uo__uOwnerType____target, uOwnerType__feature____ownedAttribute };
	}
	...
	public static final Object[] pattern_FieldDec2Property4Class_24_2_matchsrctrgcontext_blackBBBBBB(
			ClassDeclaration jOwnerType, Property feature, MFieldDefinition bodyDeclaration,
	...
	public static final Object[] pattern_FieldDec2Property4Class_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_FieldDec2Property4Class_24_2_matchsrctrgcontext_binding != null) {
			...
			MFieldDefinition bodyDeclaration = (MFieldDefinition) result_pattern_FieldDec2Property4Class_24_2_matchsrctrgcontext_binding[2];
