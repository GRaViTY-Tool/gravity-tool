...
public class AnnotationsAdapterFactory extends AdapterFactoryImpl {
	...
	protected AnnotationsSwitch<Adapter> modelSwitch = new AnnotationsSwitch<Adapter>() {
		@Override
		public Adapter caseTCounterMeasure(TCounterMeasure object) {
			return createTCounterMeasureAdapter();
		}

		@Override
		public Adapter caseTTainted(TTainted object) {
			return createTTaintedAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.gravity.security.annotations.TCounterMeasure <em>TCounter Measure</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTCounterMeasureAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.gravity.security.annotations.TTainted <em>TTainted</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTTaintedAdapter() {
		return null;
	}
