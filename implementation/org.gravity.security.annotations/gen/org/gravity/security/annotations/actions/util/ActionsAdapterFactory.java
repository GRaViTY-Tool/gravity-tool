...
public class ActionsAdapterFactory extends AdapterFactoryImpl {
	...
	protected ActionsSwitch<Adapter> modelSwitch = new ActionsSwitch<Adapter>() {
		@Override
		public Adapter caseTSanitizing(TSanitizing object) {
			return createTSanitizingAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.gravity.security.annotations.actions.TSanitizing <em>TSanitizing</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTSanitizingAdapter() {
		return null;
	}
