/**
 */
package org.gravity.security.annotations.actions.util;
...
public class ActionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ActionsPackage.TSANITIZING: {
			TSanitizing tSanitizing = (TSanitizing) theEObject;
			T result = caseTSanitizing(tSanitizing);
			if (result == null)
				result = caseTAnnotation(tSanitizing);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>TSanitizing</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>TSanitizing</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTSanitizing(TSanitizing object) {
		return null;
	}
