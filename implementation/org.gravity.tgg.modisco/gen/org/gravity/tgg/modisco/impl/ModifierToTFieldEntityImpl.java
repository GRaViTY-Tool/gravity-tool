...
import org.gravity.tgg.modisco.ModifierToTFieldEntity;
 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.ModifierToTFieldEntityImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.ModifierToTFieldEntityImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModifierToTFieldEntityImpl extends AbstractCorrespondenceImpl implements ModifierToTFieldEntity {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.MODIFIER_TO_TFIELD_ENTITY;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MODIFIER_TO_TFIELD_ENTITY__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Modifier newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MODIFIER_TO_TFIELD_ENTITY__SOURCE,
					oldSource, source));
	}
	...
	public TFieldDefinition getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MODIFIER_TO_TFIELD_ENTITY__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TFieldDefinition newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MODIFIER_TO_TFIELD_ENTITY__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.MODIFIER_TO_TFIELD_ENTITY__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.MODIFIER_TO_TFIELD_ENTITY__TARGET:
			if (resolve)
				return getTarget();
