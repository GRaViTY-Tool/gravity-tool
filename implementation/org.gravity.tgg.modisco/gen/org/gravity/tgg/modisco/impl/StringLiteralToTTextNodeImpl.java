 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.StringLiteralToTTextNodeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.StringLiteralToTTextNodeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralToTTextNodeImpl extends AbstractCorrespondenceImpl implements StringLiteralToTTextNode {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.STRING_LITERAL_TO_TTEXT_NODE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.STRING_LITERAL_TO_TTEXT_NODE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(StringLiteral newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.STRING_LITERAL_TO_TTEXT_NODE__SOURCE,
					oldSource, source));
	}
	...
	public TTextNode getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.STRING_LITERAL_TO_TTEXT_NODE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TTextNode newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.STRING_LITERAL_TO_TTEXT_NODE__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.STRING_LITERAL_TO_TTEXT_NODE__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.STRING_LITERAL_TO_TTEXT_NODE__TARGET:
			if (resolve)
				return getTarget();
