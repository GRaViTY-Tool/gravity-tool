 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.AnnotationMemberValuePairToTAnnotationValueImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.AnnotationMemberValuePairToTAnnotationValueImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AnnotationMemberValuePairToTAnnotationValueImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE__SOURCE, oldSource,
							source));
			}
		}
		return source;
	...
	public void setSource(AnnotationMemberValuePair newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE__SOURCE, oldSource, source));
	}
	...
	public TAnnotationValue getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE__TARGET, oldTarget,
							target));
			}
		}
		return target;
	...
	public void setTarget(TAnnotationValue newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.ANNOTATION_MEMBER_VALUE_PAIR_TO_TANNOTATION_VALUE__TARGET:
			if (resolve)
				return getTarget();
