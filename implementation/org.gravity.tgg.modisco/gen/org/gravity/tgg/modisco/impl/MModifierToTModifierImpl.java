 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.MModifierToTModifierImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.MModifierToTModifierImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MModifierToTModifierImpl extends AbstractCorrespondenceImpl implements MModifierToTModifier {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.MMODIFIER_TO_TMODIFIER;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MMODIFIER_TO_TMODIFIER__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Modifier newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MMODIFIER_TO_TMODIFIER__SOURCE,
					oldSource, source));
	}
	...
	public TModifier getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MMODIFIER_TO_TMODIFIER__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TModifier newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MMODIFIER_TO_TMODIFIER__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.MMODIFIER_TO_TMODIFIER__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.MMODIFIER_TO_TMODIFIER__TARGET:
			if (resolve)
				return getTarget();
