...
import org.gravity.tgg.modisco.ModifierToTClassEntity;
 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.ModifierToTClassEntityImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.ModifierToTClassEntityImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModifierToTClassEntityImpl extends AbstractCorrespondenceImpl implements ModifierToTClassEntity {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.MODIFIER_TO_TCLASS_ENTITY;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MODIFIER_TO_TCLASS_ENTITY__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Modifier newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MODIFIER_TO_TCLASS_ENTITY__SOURCE,
					oldSource, source));
	}
	...
	public TClass getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MODIFIER_TO_TCLASS_ENTITY__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TClass newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MODIFIER_TO_TCLASS_ENTITY__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.MODIFIER_TO_TCLASS_ENTITY__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.MODIFIER_TO_TCLASS_ENTITY__TARGET:
			if (resolve)
				return getTarget();
