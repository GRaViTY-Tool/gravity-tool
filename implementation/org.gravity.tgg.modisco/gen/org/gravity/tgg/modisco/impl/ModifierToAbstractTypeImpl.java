...
import org.gravity.tgg.modisco.ModifierToAbstractType;
 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.ModifierToAbstractTypeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.ModifierToAbstractTypeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModifierToAbstractTypeImpl extends AbstractCorrespondenceImpl implements ModifierToAbstractType {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.MODIFIER_TO_ABSTRACT_TYPE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MODIFIER_TO_ABSTRACT_TYPE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(Modifier newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MODIFIER_TO_ABSTRACT_TYPE__SOURCE,
					oldSource, source));
	}
	...
	public TAbstractType getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MODIFIER_TO_ABSTRACT_TYPE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TAbstractType newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.MODIFIER_TO_ABSTRACT_TYPE__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.MODIFIER_TO_ABSTRACT_TYPE__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.MODIFIER_TO_ABSTRACT_TYPE__TARGET:
			if (resolve)
				return getTarget();
