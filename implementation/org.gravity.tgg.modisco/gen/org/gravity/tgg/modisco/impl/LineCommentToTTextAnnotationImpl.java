 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.LineCommentToTTextAnnotationImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.LineCommentToTTextAnnotationImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LineCommentToTTextAnnotationImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.LINE_COMMENT_TO_TTEXT_ANNOTATION;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.LINE_COMMENT_TO_TTEXT_ANNOTATION__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public TTextAnnotation getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.LINE_COMMENT_TO_TTEXT_ANNOTATION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.LINE_COMMENT_TO_TTEXT_ANNOTATION__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.LINE_COMMENT_TO_TTEXT_ANNOTATION__TARGET:
			if (resolve)
				return getTarget();
