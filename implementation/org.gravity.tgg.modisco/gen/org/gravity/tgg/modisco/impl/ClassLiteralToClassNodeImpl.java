 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.ClassLiteralToClassNodeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.ClassLiteralToClassNodeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassLiteralToClassNodeImpl extends AbstractCorrespondenceImpl implements ClassLiteralToClassNode {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.CLASS_LITERAL_TO_CLASS_NODE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.CLASS_LITERAL_TO_CLASS_NODE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(TypeLiteral newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.CLASS_LITERAL_TO_CLASS_NODE__SOURCE,
					oldSource, source));
	}
	...
	public TClassNode getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.CLASS_LITERAL_TO_CLASS_NODE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TClassNode newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.CLASS_LITERAL_TO_CLASS_NODE__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.CLASS_LITERAL_TO_CLASS_NODE__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.CLASS_LITERAL_TO_CLASS_NODE__TARGET:
			if (resolve)
				return getTarget();
