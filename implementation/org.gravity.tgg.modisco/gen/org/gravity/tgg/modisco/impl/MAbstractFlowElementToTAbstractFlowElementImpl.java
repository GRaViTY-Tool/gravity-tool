 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.MAbstractFlowElementToTAbstractFlowElementImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.MAbstractFlowElementToTAbstractFlowElementImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MAbstractFlowElementToTAbstractFlowElementImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.MABSTRACT_FLOW_ELEMENT_TO_TABSTRACT_FLOW_ELEMENT;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MABSTRACT_FLOW_ELEMENT_TO_TABSTRACT_FLOW_ELEMENT__SOURCE, oldSource,
							source));
			}
		}
		return source;
	...
	public void setSource(MAbstractFlowElement newSource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.MABSTRACT_FLOW_ELEMENT_TO_TABSTRACT_FLOW_ELEMENT__SOURCE, oldSource, source));
	}
	...
	public TAbstractFlowElement getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MABSTRACT_FLOW_ELEMENT_TO_TABSTRACT_FLOW_ELEMENT__TARGET, oldTarget,
							target));
			}
		}
		return target;
	...
	public void setTarget(TAbstractFlowElement newTarget) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ModiscoPackage.MABSTRACT_FLOW_ELEMENT_TO_TABSTRACT_FLOW_ELEMENT__TARGET, oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.MABSTRACT_FLOW_ELEMENT_TO_TABSTRACT_FLOW_ELEMENT__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.MABSTRACT_FLOW_ELEMENT_TO_TABSTRACT_FLOW_ELEMENT__TARGET:
			if (resolve)
				return getTarget();
