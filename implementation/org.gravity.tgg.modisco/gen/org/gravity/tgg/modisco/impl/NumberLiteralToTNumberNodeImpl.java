 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.NumberLiteralToTNumberNodeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.NumberLiteralToTNumberNodeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NumberLiteralToTNumberNodeImpl extends AbstractCorrespondenceImpl implements NumberLiteralToTNumberNode {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.NUMBER_LITERAL_TO_TNUMBER_NODE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.NUMBER_LITERAL_TO_TNUMBER_NODE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(NumberLiteral newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.NUMBER_LITERAL_TO_TNUMBER_NODE__SOURCE,
					oldSource, source));
	}
	...
	public TNumberNode getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.NUMBER_LITERAL_TO_TNUMBER_NODE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TNumberNode newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.NUMBER_LITERAL_TO_TNUMBER_NODE__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.NUMBER_LITERAL_TO_TNUMBER_NODE__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.NUMBER_LITERAL_TO_TNUMBER_NODE__TARGET:
			if (resolve)
				return getTarget();
