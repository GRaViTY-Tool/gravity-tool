 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.BooleanLiteralToTBoolNodeImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.BooleanLiteralToTBoolNodeImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanLiteralToTBoolNodeImpl extends AbstractCorrespondenceImpl implements BooleanLiteralToTBoolNode {
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.BOOLEAN_LITERAL_TO_TBOOL_NODE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.BOOLEAN_LITERAL_TO_TBOOL_NODE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(BooleanLiteral newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.BOOLEAN_LITERAL_TO_TBOOL_NODE__SOURCE,
					oldSource, source));
	}
	...
	public TBoolNode getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.BOOLEAN_LITERAL_TO_TBOOL_NODE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TBoolNode newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModiscoPackage.BOOLEAN_LITERAL_TO_TBOOL_NODE__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.BOOLEAN_LITERAL_TO_TBOOL_NODE__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.BOOLEAN_LITERAL_TO_TBOOL_NODE__TARGET:
			if (resolve)
				return getTarget();
