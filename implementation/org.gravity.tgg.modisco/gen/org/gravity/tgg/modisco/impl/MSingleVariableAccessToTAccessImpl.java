 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.MSingleVariableAccessToTAccessImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.MSingleVariableAccessToTAccessImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MSingleVariableAccessToTAccessImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.MSINGLE_VARIABLE_ACCESS_TO_TACCESS;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MSINGLE_VARIABLE_ACCESS_TO_TACCESS__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public TAccess getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.MSINGLE_VARIABLE_ACCESS_TO_TACCESS__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.MSINGLE_VARIABLE_ACCESS_TO_TACCESS__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.MSINGLE_VARIABLE_ACCESS_TO_TACCESS__TARGET:
			if (resolve)
				return getTarget();
