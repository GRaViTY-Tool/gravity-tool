 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.impl.InterfaceDeclarationToTInterfaceImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.impl.InterfaceDeclarationToTInterfaceImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InterfaceDeclarationToTInterfaceImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return ModiscoPackage.Literals.INTERFACE_DECLARATION_TO_TINTERFACE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.INTERFACE_DECLARATION_TO_TINTERFACE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public TInterface getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							ModiscoPackage.INTERFACE_DECLARATION_TO_TINTERFACE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ModiscoPackage.INTERFACE_DECLARATION_TO_TINTERFACE__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case ModiscoPackage.INTERFACE_DECLARATION_TO_TINTERFACE__TARGET:
			if (resolve)
				return getTarget();
