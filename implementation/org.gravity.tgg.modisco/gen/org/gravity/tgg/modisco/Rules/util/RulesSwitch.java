...
public class RulesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE_ARRAY: {
			MethodInvocationStaticTypeArray methodInvocationStaticTypeArray = (MethodInvocationStaticTypeArray) theEObject;
			T result = caseMethodInvocationStaticTypeArray(methodInvocationStaticTypeArray);
			if (result == null)
				result = caseAbstractRule(methodInvocationStaticTypeArray);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RulesPackage.METHOD_INVOCATION_RECURSIVE: {
			MethodInvocationRecursive methodInvocationRecursive = (MethodInvocationRecursive) theEObject;
			T result = caseMethodInvocationRecursive(methodInvocationRecursive);
			if (result == null)
				result = caseAbstractRule(methodInvocationRecursive);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RulesPackage.DATA_FLOW: {
			...
			if (result == null)
				result = caseAbstractRule(dataFlow);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RulesPackage.METHOD_INVOCATION_STATIC_TYPE_ABSTRACT: {
			MethodInvocationStaticType_abstract methodInvocationStaticType_abstract = (MethodInvocationStaticType_abstract) theEObject;
			T result = caseMethodInvocationStaticType_abstract(methodInvocationStaticType_abstract);
			if (result == null)
				result = caseAbstractRule(methodInvocationStaticType_abstract);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Method Invocation Static Type Array</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Method Invocation Static Type Array</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMethodInvocationStaticTypeArray(MethodInvocationStaticTypeArray object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Method Invocation Recursive</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Method Invocation Recursive</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMethodInvocationRecursive(MethodInvocationRecursive object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Method Invocation Static Type abstract</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Method Invocation Static Type abstract</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMethodInvocationStaticType_abstract(MethodInvocationStaticType_abstract object) {
		return null;
	}
