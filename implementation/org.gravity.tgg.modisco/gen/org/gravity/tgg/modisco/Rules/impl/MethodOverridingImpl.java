...
public class MethodOverridingImpl extends AbstractRuleImpl implements MethodOverriding {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodOverridingImpl.pattern_MethodOverriding_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding, tMethod, tOverriding);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mOverridingToTOverriding] = " + mOverridingToTOverriding + ", " + "[mMethodToTMethod] = "
					+ mMethodToTMethod + ", " + "[mMethod] = " + mMethod + ", " + "[mOverriding] = " + mOverriding
		...
		MethodOverridingImpl.pattern_MethodOverriding_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult,
				mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding, tMethod, tOverriding);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodOverridingImpl.pattern_MethodOverriding_2_2_corematch_blackFFBBFFB(mMethod,
				mOverriding, match)) {
			...
			for (Object[] result3_black : MethodOverridingImpl.pattern_MethodOverriding_2_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = MethodOverridingImpl
						.pattern_MethodOverriding_2_3_findcontext_greenBBBBBBFFFFFFF(mOverridingToTOverriding,
								mMethodToTMethod, mMethod, mOverriding, tMethod, tOverriding);
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ tMethod + ", " + "[tOverriding] = " + tOverriding + ".");
				}
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			TMethodDefinition tOverriding) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mOverridingToTOverriding,
			EObject mMethodToTMethod, EObject mMethod, EObject mOverriding, EObject tMethod, EObject tOverriding) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodOverridingImpl.pattern_MethodOverriding_12_2_corematch_blackFFFFBBB(tMethod,
				tOverriding, match)) {
			MDefinitionToTMember mOverridingToTOverriding = (MDefinitionToTMember) result2_black[0];
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result2_black[1];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_253(EMoflonEdge _edge_overriddenBy) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_262(EMoflonEdge _edge_redefinitions) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodOverridingImpl.pattern_MethodOverriding_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodOverridingImpl
					.pattern_MethodOverriding_24_5_matchcorrcontext_blackFFBBBBBB(mMethod, mOverriding, tMethod,
							tOverriding, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : MethodOverridingImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ mOverridingToTOverriding + ", " + "[mMethodToTMethod] = " + mMethodToTMethod + ", "
						+ "[mMethod] = " + mMethod + ", " + "[mOverriding] = " + mOverriding + ", " + "[tMethod] = "
						+ tMethod + ", " + "[tOverriding] = " + tOverriding + ", " + "[ruleResult] = " + ruleResult
						+ ".");
			}
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								...
								+ "[mOverriding] = " + mOverriding + ", " + "[tMethod] = " + tMethod + ", "
								+ "[tOverriding] = " + tOverriding + ", " + "[ruleResult] = " + ruleResult + ".");
					}
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			MDefinitionToTMember mOverridingToTOverriding, MDefinitionToTMember mMethodToTMethod,
			MMethodDefinition mMethod, MMethodDefinition mOverriding, TMethodDefinition tMethod,
			TMethodDefinition tOverriding, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_OVERRIDING___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_MMETHODDEFINITION_TMETHODDEFINITION_TMETHODDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (MDefinitionToTMember) arguments.get(2),
					(MMethodDefinition) arguments.get(3), (MMethodDefinition) arguments.get(4),
					(TMethodDefinition) arguments.get(5), (TMethodDefinition) arguments.get(6));
		...
		case RulesPackage.METHOD_OVERRIDING___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_MMETHODDEFINITION_TMETHODDEFINITION_TMETHODDEFINITION:
		...
		case RulesPackage.METHOD_OVERRIDING___IS_APPROPRIATE_BWD_EMOFLON_EDGE_253__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_253((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_OVERRIDING___IS_APPROPRIATE_FWD_EMOFLON_EDGE_262__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_OVERRIDING___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_MMETHODDEFINITION_TMETHODDEFINITION_TMETHODDEFINITION_MODELGENERATORRULERESULT:
					...
					if (tmpMOverriding instanceof MMethodDefinition) {
						...
						if (tmpTMethod instanceof TMethodDefinition) {
							...
							if (tmpTOverriding instanceof TMethodDefinition) {
								...
								return new Object[] { mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding,
										tMethod, tOverriding, isApplicableMatch };
							}
						}
					}
				}
				...
				if (!tMethod.equals(tOverriding)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding,
									tMethod, tOverriding, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_MethodOverriding_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodOverriding_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodOverriding_1_1_performtransformation_black = pattern_MethodOverriding_1_1_performtransformation_blackBBBBBBFBB(
					mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding, tMethod, tOverriding, _this,
					isApplicableMatch);
			if (result_pattern_MethodOverriding_1_1_performtransformation_black != null) {
				...
				return new Object[] { mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding, tMethod,
	...
	public static final Object[] pattern_MethodOverriding_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject mOverriding, EObject tMethod, EObject tOverriding) {
	...
	public static final void pattern_MethodOverriding_1_5_registerobjects_expressionBBBBBBBB(MethodOverriding _this,
			PerformRuleResult ruleresult, EObject mOverridingToTOverriding, EObject mMethodToTMethod, EObject mMethod,
			EObject mOverriding, EObject tMethod, EObject tOverriding) {
		_this.registerObjects_FWD(ruleresult, mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding, tMethod,
				tOverriding);
	...
	public static final Iterable<Object[]> pattern_MethodOverriding_2_2_corematch_blackFFBBFFB(
							...
							if (tmpTOverriding instanceof TMethodDefinition) {
								...
								if (!tMethod.equals(tOverriding)) {
									_result.add(new Object[] { mOverridingToTOverriding, mMethodToTMethod, mMethod,
											mOverriding, tMethod, tOverriding, match });
								}
							}
	...
	public static final Object[] pattern_MethodOverriding_2_3_findcontext_greenBBBBBBFFFFFFF(
		...
		return new Object[] { mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding, tMethod, tOverriding,
	...
	public static final Object[] pattern_MethodOverriding_2_4_solveCSP_bindingFBBBBBBBB(MethodOverriding _this,
			...
			MDefinitionToTMember mMethodToTMethod, MMethodDefinition mMethod, MMethodDefinition mOverriding,
	...
	public static final Object[] pattern_MethodOverriding_2_4_solveCSP_bindingAndBlackFBBBBBBBB(MethodOverriding _this,
		...
		Object[] result_pattern_MethodOverriding_2_4_solveCSP_binding = pattern_MethodOverriding_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding, tMethod,
				tOverriding);
		if (result_pattern_MethodOverriding_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodOverriding_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mOverridingToTOverriding, mMethodToTMethod,
						mMethod, mOverriding, tMethod, tOverriding };
			}
		}
		return null;
	}
	...
	public static final void pattern_MethodOverriding_11_5_registerobjects_expressionBBBBBBBB(MethodOverriding _this,
			PerformRuleResult ruleresult, EObject mOverridingToTOverriding, EObject mMethodToTMethod, EObject mMethod,
			EObject mOverriding, EObject tMethod, EObject tOverriding) {
		_this.registerObjects_BWD(ruleresult, mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding, tMethod,
				tOverriding);
	...
	public static final Iterable<Object[]> pattern_MethodOverriding_12_2_corematch_blackFFFFBBB(
						...
						if (tMethod.equals(mMethodToTMethod.getTarget())) {
							for (MDefinitionToTMember mOverridingToTOverriding : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!mMethodToTMethod.equals(mOverridingToTOverriding)) {
									if (tOverriding.equals(mOverridingToTOverriding.getTarget())) {
										_result.add(new Object[] { mOverridingToTOverriding, mMethodToTMethod, mMethod,
												mOverriding, tMethod, tOverriding, sourceMatch, targetMatch });
									}
								}
							}
						}
	...
	public static final Object[] pattern_MethodOverriding_29_3_solveCSP_bindingFBBBBBBBBB(MethodOverriding _this,
			IsApplicableMatch isApplicableMatch, MDefinitionToTMember mOverridingToTOverriding,
			MDefinitionToTMember mMethodToTMethod, MMethodDefinition mMethod, MMethodDefinition mOverriding,
			TMethodDefinition tMethod, TMethodDefinition tOverriding, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mOverridingToTOverriding,
				mMethodToTMethod, mMethod, mOverriding, tMethod, tOverriding, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mOverridingToTOverriding, mMethodToTMethod, mMethod,
					mOverriding, tMethod, tOverriding, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodOverriding_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		if (result_pattern_MethodOverriding_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_MethodOverriding_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mOverridingToTOverriding, mMethodToTMethod,
						mMethod, mOverriding, tMethod, tOverriding, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodOverriding_29_6_perform_blackBBBBBBB(
			MDefinitionToTMember mOverridingToTOverriding, MDefinitionToTMember mMethodToTMethod,
			MMethodDefinition mMethod, MMethodDefinition mOverriding, TMethodDefinition tMethod,
			TMethodDefinition tOverriding, ModelgeneratorRuleResult ruleResult) {
		if (!mMethodToTMethod.equals(mOverridingToTOverriding)) {
			if (!mMethod.equals(mOverriding)) {
				if (!tMethod.equals(tOverriding)) {
					return new Object[] { mOverridingToTOverriding, mMethodToTMethod, mMethod, mOverriding, tMethod,
