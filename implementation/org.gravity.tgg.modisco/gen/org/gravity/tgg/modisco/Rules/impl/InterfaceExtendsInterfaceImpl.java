...
public class InterfaceExtendsInterfaceImpl extends AbstractRuleImpl implements InterfaceExtendsInterface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		InterfaceDeclarationToTInterface eSuperInterfaceToTSuperInterface = (InterfaceDeclarationToTInterface) result1_bindingAndBlack[1];
		...
		Object[] result3_black = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
						eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
						eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface);
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, eInterfaceDeclaration, eTypeAccess, eSuperInterface, tInterface, tSuperInterface);
		...
		InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
				eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_2_2_corematch_blackBFBFBFFB(eInterfaceDeclaration, eTypeAccess,
			...
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_2_3_findcontext_blackBBBBBBB(eInterfaceDeclaration,
							...
							eSuperInterface, tInterface, tSuperInterface)) {
				...
				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
								eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			InterfaceDeclarationToTInterface eInterfaceDeclarationToTInterface, InterfaceDeclaration eSuperInterface,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eInterfaceDeclaration,
			EObject eSuperInterfaceToTSuperInterface, EObject eTypeAccess, EObject eInterfaceDeclarationToTInterface,
			EObject eSuperInterface, EObject tInterface, EObject tSuperInterface) {
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
			...
			for (Object[] result3_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_12_3_findcontext_blackBBBBBB(eInterfaceDeclaration,
							eSuperInterfaceToTSuperInterface, eInterfaceDeclarationToTInterface, eSuperInterface,
							tInterface, tSuperInterface)) {
				Object[] result3_green = InterfaceExtendsInterfaceImpl
				...
				Object[] result4_bindingAndBlack = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
								eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eInterfaceDeclaration] = "
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_220(EMoflonEdge _edge_type) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
				.pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eInterfaceDeclaration,
						eTypeAccess, eSuperInterface, tInterface, tSuperInterface, sourceMatch, targetMatch);
		...
		if (InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_24_5_matchcorrcontext_blackBFFBBBBB(eInterfaceDeclaration,
							eSuperInterface, tInterface, tSuperInterface, sourceMatch, targetMatch)) {
				InterfaceDeclarationToTInterface eSuperInterfaceToTSuperInterface = (InterfaceDeclarationToTInterface) result5_black[1];
				InterfaceDeclarationToTInterface eInterfaceDeclarationToTInterface = (InterfaceDeclarationToTInterface) result5_black[2];
				...
				Object[] result6_black = InterfaceExtendsInterfaceImpl
						.pattern_InterfaceExtendsInterface_24_6_createcorrespondence_blackBBBBBB(eInterfaceDeclaration,
								eTypeAccess, eSuperInterface, tInterface, tSuperInterface, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: "
							+ "[eInterfaceDeclaration] = " + eInterfaceDeclaration + ", " + "[eTypeAccess] = "
							+ eTypeAccess + ", " + "[eSuperInterface] = " + eSuperInterface + ", " + "[tInterface] = "
							+ tInterface + ", " + "[tSuperInterface] = " + tSuperInterface + ", " + "[ccMatch] = "
							+ ccMatch + ".");
				}
	...
	public CSP isApplicable_solveCsp_CC(InterfaceDeclaration eInterfaceDeclaration, TypeAccess eTypeAccess,
			InterfaceDeclaration eSuperInterface, TInterface tInterface, TInterface tSuperInterface, Match sourceMatch,
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : InterfaceExtendsInterfaceImpl
			...
			InterfaceDeclarationToTInterface eSuperInterfaceToTSuperInterface = (InterfaceDeclarationToTInterface) result2_black[5];
			...
			Object[] result3_bindingAndBlack = InterfaceExtendsInterfaceImpl
					.pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eInterfaceDeclarationToTInterface,
							eSuperInterface, tInterface, tSuperInterface, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eInterfaceDeclaration] = "
						+ eInterfaceDeclaration + ", " + "[eSuperInterfaceToTSuperInterface] = "
				...
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								...
								+ "[eInterfaceDeclarationToTInterface] = " + eInterfaceDeclarationToTInterface + ", "
								+ "[eSuperInterface] = " + eSuperInterface + ", " + "[tInterface] = " + tInterface
								+ ", " + "[tSuperInterface] = " + tSuperInterface + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
					InterfaceExtendsInterfaceImpl.pattern_InterfaceExtendsInterface_29_6_perform_greenBFBBBB(
							eInterfaceDeclaration, eSuperInterface, tInterface, tSuperInterface, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_INTERFACEDECLARATIONTOTINTERFACE_TYPEACCESS_INTERFACEDECLARATIONTOTINTERFACE_INTERFACEDECLARATION_TINTERFACE_TINTERFACE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(InterfaceDeclaration) arguments.get(1), (InterfaceDeclarationToTInterface) arguments.get(2),
					(TypeAccess) arguments.get(3), (InterfaceDeclarationToTInterface) arguments.get(4),
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_INTERFACEDECLARATIONTOTINTERFACE_INTERFACEDECLARATIONTOTINTERFACE_INTERFACEDECLARATION_TINTERFACE_TINTERFACE:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_220__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__INTERFACEDECLARATION_TYPEACCESS_INTERFACEDECLARATION_TINTERFACE_TINTERFACE_MATCH_MATCH:
		...
		case RulesPackage.INTERFACE_EXTENDS_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_INTERFACEDECLARATION_INTERFACEDECLARATIONTOTINTERFACE_INTERFACEDECLARATIONTOTINTERFACE_INTERFACEDECLARATION_TINTERFACE_TINTERFACE_MODELGENERATORRULERESULT:
						...
						if (tmpESuperInterface instanceof InterfaceDeclaration) {
							...
							if (tmpTInterface instanceof TInterface) {
								...
								if (tmpTSuperInterface instanceof TInterface) {
									...
									return new Object[] { eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
											eTypeAccess, eInterfaceDeclarationToTInterface, eSuperInterface, tInterface,
				...
				if (!tInterface.equals(tSuperInterface)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
									eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding != null) {
			...
			InterfaceDeclarationToTInterface eSuperInterfaceToTSuperInterface = (InterfaceDeclarationToTInterface) result_pattern_InterfaceExtendsInterface_1_1_performtransformation_binding[1];
			...
			Object[] result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black = pattern_InterfaceExtendsInterface_1_1_performtransformation_blackBBBBBBBFBB(
					eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
					eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface, _this,
					isApplicableMatch);
			if (result_pattern_InterfaceExtendsInterface_1_1_performtransformation_black != null) {
				...
				return new Object[] { eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
						eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eInterfaceDeclaration, EObject eSuperInterfaceToTSuperInterface,
			EObject eTypeAccess, EObject eInterfaceDeclarationToTInterface, EObject eSuperInterface, EObject tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject eInterfaceDeclaration, EObject eTypeAccess, EObject eSuperInterface,
		...
		return new Object[] { ruleresult, eInterfaceDeclaration, eTypeAccess, eSuperInterface, tInterface,
	...
	public static final void pattern_InterfaceExtendsInterface_1_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eSuperInterfaceToTSuperInterface, EObject eTypeAccess, EObject eInterfaceDeclarationToTInterface,
			EObject eSuperInterface, EObject tInterface, EObject tSuperInterface) {
		_this.registerObjects_FWD(ruleresult, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
				eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface);
					...
					for (InterfaceDeclarationToTInterface eSuperInterfaceToTSuperInterface : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
							...
							if (tSuperInterface != null) {
								if (!tInterface.equals(tSuperInterface)) {
									_result.add(new Object[] { eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
											eTypeAccess, eInterfaceDeclarationToTInterface, eSuperInterface, tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
				eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface, isApplicableMatch,
				eTypeAccess__eSuperInterface____type, eSuperInterface__eTypeAccess____usagesInTypeAccess,
				eInterfaceDeclarationToTInterface__eInterfaceDeclaration____source,
				eInterfaceDeclarationToTInterface__tInterface____target,
				eInterfaceDeclaration__eTypeAccess____superInterfaces,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eInterfaceDeclaration,
				eSuperInterfaceToTSuperInterface, eTypeAccess, eInterfaceDeclarationToTInterface, eSuperInterface,
				tInterface, tSuperInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
	...
	public static final Object[] pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_2_4_solveCSP_binding = pattern_InterfaceExtendsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
				eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_11_1_performtransformation_binding != null) {
			...
			InterfaceDeclarationToTInterface eSuperInterfaceToTSuperInterface = (InterfaceDeclarationToTInterface) result_pattern_InterfaceExtendsInterface_11_1_performtransformation_binding[1];
			InterfaceDeclarationToTInterface eInterfaceDeclarationToTInterface = (InterfaceDeclarationToTInterface) result_pattern_InterfaceExtendsInterface_11_1_performtransformation_binding[2];
			...
			Object[] result_pattern_InterfaceExtendsInterface_11_1_performtransformation_black = pattern_InterfaceExtendsInterface_11_1_performtransformation_blackBBBBBBFBB(
					eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eInterfaceDeclarationToTInterface,
					eSuperInterface, tInterface, tSuperInterface, _this, isApplicableMatch);
	...
	public static final void pattern_InterfaceExtendsInterface_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject eSuperInterfaceToTSuperInterface, EObject eTypeAccess, EObject eInterfaceDeclarationToTInterface,
			EObject eSuperInterface, EObject tInterface, EObject tSuperInterface) {
		_this.registerObjects_BWD(ruleresult, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface, eTypeAccess,
				eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, eInterfaceDeclaration,
				eSuperInterfaceToTSuperInterface, eInterfaceDeclarationToTInterface, eSuperInterface, tInterface,
				tSuperInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eInterfaceDeclaration,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_12_4_solveCSP_binding = pattern_InterfaceExtendsInterface_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
				eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface);
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_441656 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_817914 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_490327 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_156160 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_733151 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_971695 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_84094 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_InterfaceExtendsInterface_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_668483 : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpETypeAccess instanceof TypeAccess) {
				...
				if (tmpESuperInterface instanceof InterfaceDeclaration) {
					...
					if (tmpTInterface instanceof TInterface) {
						...
						if (tmpTSuperInterface instanceof TInterface) {
							TInterface tSuperInterface = (TInterface) tmpTSuperInterface;
							return new Object[] { eInterfaceDeclaration, eTypeAccess, eSuperInterface, tInterface,
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black = pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
					eInterfaceDeclaration, eTypeAccess, eSuperInterface, tInterface, tSuperInterface, sourceMatch,
					targetMatch);
			if (result_pattern_InterfaceExtendsInterface_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { eInterfaceDeclaration, eTypeAccess, eSuperInterface, tInterface, tSuperInterface,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
			...
			InterfaceDeclaration eSuperInterface, TInterface tInterface, TInterface tSuperInterface, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eInterfaceDeclaration, eTypeAccess, eSuperInterface,
				tInterface, tSuperInterface, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eInterfaceDeclaration, eTypeAccess, eSuperInterface, tInterface,
					tSuperInterface, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_24_3_solvecsp_binding = pattern_InterfaceExtendsInterface_24_3_solvecsp_bindingFBBBBBBBB(
				_this, eInterfaceDeclaration, eTypeAccess, eSuperInterface, tInterface, tSuperInterface, sourceMatch,
				targetMatch);
						...
						if (tInterface.equals(eInterfaceDeclarationToTInterface.getTarget())) {
							for (InterfaceDeclarationToTInterface eSuperInterfaceToTSuperInterface : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!eInterfaceDeclarationToTInterface.equals(eSuperInterfaceToTSuperInterface)) {
									if (tSuperInterface.equals(eSuperInterfaceToTSuperInterface.getTarget())) {
										_result.add(
												new Object[] { eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
														eInterfaceDeclarationToTInterface, eSuperInterface, tInterface,
														tSuperInterface, sourceMatch, targetMatch });
									}
								}
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_709027 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_996261 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_988981 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_827778 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_572249 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_719126 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_902962 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_27_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_931988 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_InterfaceExtendsInterface_29_3_solveCSP_binding = pattern_InterfaceExtendsInterface_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eInterfaceDeclaration, eSuperInterfaceToTSuperInterface,
				eInterfaceDeclarationToTInterface, eSuperInterface, tInterface, tSuperInterface, ruleResult);
		if (result_pattern_InterfaceExtendsInterface_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_InterfaceExtendsInterface_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, eInterfaceDeclaration,
						eSuperInterfaceToTSuperInterface, eInterfaceDeclarationToTInterface, eSuperInterface,
						tInterface, tSuperInterface, ruleResult };
			}
		}
		return null;
	}
