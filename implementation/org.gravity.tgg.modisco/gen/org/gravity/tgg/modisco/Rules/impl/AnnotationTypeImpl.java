...
public class AnnotationTypeImpl extends AbstractRuleImpl implements AnnotationType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationTypeImpl.pattern_AnnotationType_1_3_bookkeepingforedges_blackBBBBBBBBB(
				ruleresult, mPackageToTPackage, mTypeToTType, tType, tPackage, mPackage, pg, mBodyToTAnnotation, mType);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mPackageToTPackage] = " + mPackageToTPackage + ", " + "[mTypeToTType] = " + mTypeToTType
					+ ", " + "[tType] = " + tType + ", " + "[tPackage] = " + tPackage + ", " + "[mPackage] = "
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject mTypeToTType,
			EObject tType, EObject tPackage, EObject mPackage, EObject pg, EObject mBodyToTAnnotation, EObject mType) {
	...
	public boolean isAppropriate_BWD(Match match, TAnnotationType tType, TPackage tPackage, TypeGraph pg) {
		...
		if (AnnotationTypeImpl.pattern_AnnotationType_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			//nothing EMoflonEdge tType__pg____pg = (EMoflonEdge) result4_green[8];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationTypeImpl.pattern_AnnotationType_12_2_corematch_blackFBBFBB(tType,
			...
			for (Object[] result3_black : AnnotationTypeImpl.pattern_AnnotationType_12_3_findcontext_blackBBBBB(
				...
				//nothing EMoflonEdge tType__pg____pg = (EMoflonEdge) result3_green[12];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_249(EMoflonEdge _edge_ownedTypes) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_258(EMoflonEdge _edge_ownedElements) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_249__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_249((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_258__EMOFLONEDGE:
	...
	public static final Object[] pattern_AnnotationType_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mTypeToTType, EObject tType, EObject tPackage, EObject mPackage,
		...
		mPackage__mType____ownedElements.setName(mPackage__mType____ownedElements_name_prime);
		mType__mPackage____package.setName(mType__mPackage____package_name_prime);
		return new Object[] { ruleresult, mTypeToTType, tType, tPackage, mPackage, pg, mBodyToTAnnotation, mType,
	...
	public static final void pattern_AnnotationType_1_5_registerobjects_expressionBBBBBBBBBB(AnnotationType _this,
			PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject mTypeToTType, EObject tType,
			EObject tPackage, EObject mPackage, EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		_this.registerObjects_FWD(ruleresult, mPackageToTPackage, mTypeToTType, tType, tPackage, mPackage, pg,
	...
	public static final void pattern_AnnotationType_11_5_registerobjects_expressionBBBBBBBBBB(AnnotationType _this,
			PerformRuleResult ruleresult, EObject mPackageToTPackage, EObject mTypeToTType, EObject tType,
			EObject tPackage, EObject mPackage, EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		_this.registerObjects_BWD(ruleresult, mPackageToTPackage, mTypeToTType, tType, tPackage, mPackage, pg,
				mBodyToTAnnotation, mType);
	...
	public static final Object[] pattern_AnnotationType_20_2_testcorematchandDECs_black_nac_0BB(TAnnotationType tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_tAnnotationTypes_369604 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "tAnnotationTypes")) {
			if (!pg.equals(__DEC_tType_tAnnotationTypes_369604)) {
	...
	public static final Object[] pattern_AnnotationType_20_2_testcorematchandDECs_black_nac_1BB(TAnnotationType tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_891443 = tType.getPackage();
		if (__DEC_tType_ownedTypes_891443 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_891443)) {
	...
	public static final Object[] pattern_AnnotationType_20_2_testcorematchandDECs_black_nac_2B(TAnnotationType tType) {
		TAbstractType __DEC_tType_innerTypes_908176 = tType.getOuterType();
		if (__DEC_tType_innerTypes_908176 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_908176)) {
	...
	public static final Object[] pattern_AnnotationType_21_2_testcorematchandDECs_black_nac_0B(
			AnnotationTypeDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_181856 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_181856 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_181856)) {
	...
	public static final Object[] pattern_AnnotationType_21_2_testcorematchandDECs_black_nac_1B(
			AnnotationTypeDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_706183 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_706183 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_AnnotationType_21_2_testcorematchandDECs_black_nac_2B(
			AnnotationTypeDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_128929 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationType_21_2_testcorematchandDECs_black_nac_3B(
			AnnotationTypeDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_226996 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationType_27_1_matchtggpattern_black_nac_0B(
			AnnotationTypeDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_348380 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_348380 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_348380)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_AnnotationType_27_1_matchtggpattern_black_nac_1B(
			AnnotationTypeDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_844764 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_844764 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_AnnotationType_27_1_matchtggpattern_black_nac_2B(
			AnnotationTypeDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_212192 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, Model.class, "orphanTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationType_27_1_matchtggpattern_black_nac_3B(
			AnnotationTypeDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_173992 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationType_28_1_matchtggpattern_black_nac_0BB(TAnnotationType tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_tAnnotationTypes_824681 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "tAnnotationTypes")) {
			if (!pg.equals(__DEC_tType_tAnnotationTypes_824681)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationType_28_1_matchtggpattern_black_nac_1BB(TAnnotationType tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_354739 = tType.getPackage();
		if (__DEC_tType_ownedTypes_354739 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_354739)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_AnnotationType_28_1_matchtggpattern_black_nac_2B(TAnnotationType tType) {
		TAbstractType __DEC_tType_innerTypes_496808 = tType.getOuterType();
		if (__DEC_tType_innerTypes_496808 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_496808)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_AnnotationType_29_6_perform_greenFFBBBFFBB(TPackage tPackage,
		...
		return new Object[] { mTypeToTType, tType, tPackage, mPackage, pg, mBodyToTAnnotation, mType, ruleResult, csp };
	}
