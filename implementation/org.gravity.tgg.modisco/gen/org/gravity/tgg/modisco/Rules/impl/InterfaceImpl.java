...
public class InterfaceImpl extends AbstractRuleImpl implements Interface {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = InterfaceImpl.pattern_Interface_1_1_performtransformation_greenFBFBFFBB(tPackage, pg,
				mType, csp);
		...
		Object[] result3_black = InterfaceImpl.pattern_Interface_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
				mPackageToTPackage, tType, tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation,
		...
		InterfaceImpl.pattern_Interface_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(ruleresult, tType,
				tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation, mInterfaceDeclarationtoTInterface, mType);
		...
		InterfaceImpl.pattern_Interface_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, mPackageToTPackage,
				tType, tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation, mInterfaceDeclarationtoTInterface,
				mType);
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = InterfaceImpl.pattern_Interface_11_1_performtransformation_greenBFBFFFB(tType,
				mPackage, csp);
		...
		InterfaceImpl.pattern_Interface_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(ruleresult, tType,
				tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation, mInterfaceDeclarationtoTInterface, mType);
		//nothing EMoflonEdge mBodyToTAnnotation__tType____target = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge pg__tType____interfaces = (EMoflonEdge) result3_green[10];
		//nothing EMoflonEdge mBodyToTAnnotation__mType____source = (EMoflonEdge) result3_green[11];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_199(EMoflonEdge _edge_interfaces) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (InterfaceImpl.pattern_Interface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceImpl.pattern_Interface_24_5_matchcorrcontext_blackFBBBB(tPackage,
				...
				Object[] result6_black = InterfaceImpl.pattern_Interface_24_6_createcorrespondence_blackBBBBBB(tType,
						tPackage, mPackage, pg, mType, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tType] = " + tType + ", "
		...
		for (Object[] result2_black : InterfaceImpl
			...
			if (InterfaceImpl.pattern_Interface_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					InterfaceImpl.pattern_Interface_29_6_perform_greenFBFBBFFFBB(tPackage, mPackage, pg, ruleResult,
							csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_199__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_199((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_205__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__TINTERFACE_TPACKAGE_PACKAGE_TYPEGRAPH_INTERFACEDECLARATION_MATCH_MATCH:
	...
	public static final Object[] pattern_Interface_1_1_performtransformation_greenFBFBFFBB(TPackage tPackage,
		...
		return new Object[] { tType, tPackage, mTypeToTType, pg, mBodyToTAnnotation, mInterfaceDeclarationtoTInterface,
				mType, csp };
	}
	...
	public static final Object[] pattern_Interface_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
		...
		return new Object[] { ruleresult, tType, tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation,
	...
	public static final void pattern_Interface_1_5_registerobjects_expressionBBBBBBBBBBB(Interface _this,
			...
			EObject mTypeToTType, EObject mPackage, EObject pg, EObject mBodyToTAnnotation,
			EObject mInterfaceDeclarationtoTInterface, EObject mType) {
	...
	public static final Object[] pattern_Interface_10_4_collectelementstobetranslated_greenBBBBFFFFFF(Match match,
		...
		tPackage__tType____ownedTypes.setName(tPackage__tType____ownedTypes_name_prime);
		tType__tPackage____package.setName(tType__tPackage____package_name_prime);
		return new Object[] { match, tType, tPackage, pg, pg__tType____interfaces, tPackage__tType____interfaces,
	...
	public static final Object[] pattern_Interface_11_1_performtransformation_greenBFBFFFB(TInterface tType,
		...
		return new Object[] { tType, mTypeToTType, mPackage, mBodyToTAnnotation, mInterfaceDeclarationtoTInterface,
				mType, csp };
	}
	...
	public static final Object[] pattern_Interface_20_2_testcorematchandDECs_black_nac_0BB(TInterface tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_interfaces_10358 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "interfaces")) {
			if (!tPackage.equals(__DEC_tType_interfaces_10358)) {
	...
	public static final Object[] pattern_Interface_20_2_testcorematchandDECs_black_nac_1BB(TInterface tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_interfaces_72570 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tType_interfaces_72570)) {
	...
	public static final Object[] pattern_Interface_20_2_testcorematchandDECs_black_nac_2BB(TInterface tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_32815 = tType.getPackage();
		if (__DEC_tType_ownedTypes_32815 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_32815)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Interface_20_2_testcorematchandDECs_black_nac_3B(TInterface tType) {
		TAbstractType __DEC_tType_innerTypes_974288 = tType.getOuterType();
		if (__DEC_tType_innerTypes_974288 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_974288)) {
										...
										if (pattern_Interface_20_2_testcorematchandDECs_black_nac_3B(tType) == null) {
											if (pattern_Interface_20_2_testcorematchandDECs_black_nac_0BB(tType,
												...
												if (pattern_Interface_20_2_testcorematchandDECs_black_nac_2BB(tType,
														tPackage) == null) {
													_result.add(new Object[] { tType, tPackage, pg, _edge_interfaces });
												}
											}
										}
									}
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_0B(InterfaceDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_597179 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_597179 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_597179)) {
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_1B(InterfaceDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_227456 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_227456 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_2B(InterfaceDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_112562 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_3B(InterfaceDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_652504 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Interface_24_2_matchsrctrgcontext_blackBBBBBBB(TInterface tType,
	...
	public static final Object[] pattern_Interface_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(Match sourceMatch,
		...
		if (result_pattern_Interface_24_2_matchsrctrgcontext_binding != null) {
			TInterface tType = (TInterface) result_pattern_Interface_24_2_matchsrctrgcontext_binding[0];
			TPackage tPackage = (TPackage) result_pattern_Interface_24_2_matchsrctrgcontext_binding[1];
	...
	public static final Object[] pattern_Interface_24_3_solvecsp_bindingFBBBBBBBB(Interface _this, TInterface tType,
			TPackage tPackage, org.eclipse.modisco.java.Package mPackage, TypeGraph pg, InterfaceDeclaration mType,
			Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_Interface_24_6_createcorrespondence_blackBBBBBB(TInterface tType,
			TPackage tPackage, org.eclipse.modisco.java.Package mPackage, TypeGraph pg, InterfaceDeclaration mType,
			CCMatch ccMatch) {
	...
	public static final Object[] pattern_Interface_27_1_matchtggpattern_black_nac_0B(InterfaceDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_819414 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_819414 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_819414)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_Interface_27_1_matchtggpattern_black_nac_1B(InterfaceDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_506359 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_506359 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Interface_27_1_matchtggpattern_black_nac_2B(InterfaceDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_206983 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, Model.class, "orphanTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Interface_27_1_matchtggpattern_black_nac_3B(InterfaceDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_497604 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_0BB(TInterface tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_interfaces_318430 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "interfaces")) {
			if (!tPackage.equals(__DEC_tType_interfaces_318430)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_1BB(TInterface tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_interfaces_211532 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tType_interfaces_211532)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_2BB(TInterface tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_151067 = tType.getPackage();
		if (__DEC_tType_ownedTypes_151067 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_151067)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_3B(TInterface tType) {
		TAbstractType __DEC_tType_innerTypes_953782 = tType.getOuterType();
		if (__DEC_tType_innerTypes_953782 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_953782)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_Interface_29_6_perform_greenFBFBBFFFBB(TPackage tPackage,
		...
		return new Object[] { tType, tPackage, mTypeToTType, mPackage, pg, mBodyToTAnnotation,
