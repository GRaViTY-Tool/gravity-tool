...
public class MemberInAnnotationVisibilityImpl extends AbstractRuleImpl implements MemberInAnnotationVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_1_1_performtransformation_greenBFBFB(mModifier, tMember, csp);
		...
		Object[] result3_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mModifier,
						tModifier, tMember, mModifierToTModifier, mTypeToTType, tAnnotation, defToMember, mDefinition,
						Annotation);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mModifier] = " + mModifier + ", " + "[tModifier] = " + tModifier + ", " + "[tMember] = "
					+ tMember + ", " + "[mModifierToTModifier] = " + mModifierToTModifier + ", " + "[mTypeToTType] = "
					+ mTypeToTType + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[defToMember] = " + defToMember
		...
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, mModifier, tModifier, tMember, mModifierToTModifier, mDefinition);
		...
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
				this, ruleresult, mModifier, tModifier, tMember, mModifierToTModifier, mTypeToTType, tAnnotation,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_2_2_corematch_blackBFFFFBBB(mModifier, mDefinition, Annotation,
						match)) {
			...
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_2_3_findcontext_blackBBBBBBB(mModifier, tMember, mTypeToTType,
							tAnnotation, defToMember, mDefinition, Annotation)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mModifier,
								tMember, mTypeToTType, tAnnotation, defToMember, mDefinition, Annotation);
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mModifier, tMember, mTypeToTType, tAnnotation, defToMember,
								mDefinition, Annotation);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject tModifier, EObject tMember,
			EObject mModifierToTModifier, EObject mTypeToTType, EObject tAnnotation, EObject defToMember,
			EObject mDefinition, EObject Annotation) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						mModifier, tModifier, tMember, mModifierToTModifier, mTypeToTType, tAnnotation, defToMember,
						mDefinition, Annotation);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_12_2_corematch_blackBBFBFFFB(tModifier, tMember, tAnnotation,
						match)) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[2];
			MDefinitionToTMember defToMember = (MDefinitionToTMember) result2_black[4];
			...
			// ForEach 
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_12_3_findcontext_blackBBBBBBB(tModifier, tMember,
							mTypeToTType, tAnnotation, defToMember, mDefinition, Annotation)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, tModifier, tMember, mTypeToTType, tAnnotation, defToMember,
								mDefinition, Annotation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mModifier, EObject tModifier, EObject tMember,
			EObject mModifierToTModifier, EObject mTypeToTType, EObject tAnnotation, EObject defToMember,
			EObject mDefinition, EObject Annotation) {
		ruleresult.registerObject("mModifier", mModifier);
		ruleresult.registerObject("tModifier", tModifier);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_195(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_201(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mModifier,
						tModifier, tMember, tAnnotation, mDefinition, Annotation, sourceMatch, targetMatch);
		...
		if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_24_5_matchcorrcontext_blackBFBFBBBB(tMember, tAnnotation,
				...
				Object[] result6_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(mModifier,
								tModifier, tMember, tAnnotation, mDefinition, Annotation, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Modifier mModifier, TModifier tModifier, TMember tMember,
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition, Annotation,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MemberInAnnotationVisibilityImpl
							.pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(tMember, mTypeToTType,
									tAnnotation, defToMember, mDefinition, Annotation, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMember] = "
								+ tMember + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tAnnotation] = "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_TMEMBER_TYPETOTABSTRACTTYPE_TANNOTATIONTYPE_MDEFINITIONTOTMEMBER_MDEFINITION_ANNOTATIONTYPEDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Modifier) arguments.get(1),
					...
					(MDefinition) arguments.get(6), (AnnotationTypeDeclaration) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMODIFIER_TMEMBER_TYPETOTABSTRACTTYPE_TANNOTATIONTYPE_MDEFINITIONTOTMEMBER_MDEFINITION_ANNOTATIONTYPEDECLARATION:
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_195__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_195((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_201__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__MODIFIER_TMODIFIER_TMEMBER_TANNOTATIONTYPE_MDEFINITION_ANNOTATIONTYPEDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Modifier) arguments.get(0), (TModifier) arguments.get(1),
					(TMember) arguments.get(2), (TAnnotationType) arguments.get(3), (MDefinition) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_TYPETOTABSTRACTTYPE_TANNOTATIONTYPE_MDEFINITIONTOTMEMBER_MDEFINITION_ANNOTATIONTYPEDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
									...
									return new Object[] { mModifier, tMember, mTypeToTType, tAnnotation, defToMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			Modifier mModifier, TMember tMember, TypeToTAbstractType mTypeToTType, TAnnotationType tAnnotation,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_black = pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition, annotation, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_greenBFBFB(
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifier, EObject tModifier, EObject tMember,
			EObject mModifierToTModifier, EObject mTypeToTType, EObject tAnnotation, EObject defToMember,
			EObject mDefinition, EObject annotation) {
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, mModifier, tModifier, tMember, mModifierToTModifier, mDefinition,
	...
	public static final void pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInAnnotationVisibility _this, PerformRuleResult ruleresult, EObject mModifier, EObject tModifier,
			EObject tMember, EObject mModifierToTModifier, EObject mTypeToTType, EObject tAnnotation,
			EObject defToMember, EObject mDefinition, EObject annotation) {
		_this.registerObjects_FWD(ruleresult, mModifier, tModifier, tMember, mModifierToTModifier, mTypeToTType,
				tAnnotation, defToMember, mDefinition, annotation);
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTAnnotation instanceof TAnnotationType) {
						TAnnotationType tAnnotation = (TAnnotationType) tmpTAnnotation;
						_result.add(new Object[] { mModifier, tMember, mTypeToTType, tAnnotation, defToMember,
						...
						if (mModifier.equals(mDefinition.getModifier())) {
							if (annotation.equals(mTypeToTType.getSource())) {
								if (annotation.getBodyDeclarations().contains(mDefinition)) {
									_result.add(new Object[] { mModifier, tMember, mTypeToTType, tAnnotation,
											defToMember, mDefinition, annotation });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		mDefinition__Annotation____abstractTypeDeclaration
				.setName(mDefinition__Annotation____abstractTypeDeclaration_name_prime);
		return new Object[] { mModifier, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition, annotation,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			TMember tMember, TypeToTAbstractType mTypeToTType, TAnnotationType tAnnotation,
			MDefinitionToTMember defToMember, MDefinition mDefinition, AnnotationTypeDeclaration annotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModifier, tMember, mTypeToTType,
				tAnnotation, defToMember, mDefinition, annotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, tMember, mTypeToTType, tAnnotation,
					defToMember, mDefinition, annotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_2_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition,
				annotation);
					...
					if (tmpTAnnotation instanceof TAnnotationType) {
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
									AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
									return new Object[] { tModifier, tMember, mTypeToTType, tAnnotation, defToMember,
											mDefinition, annotation, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TModifier tModifier, TMember tMember, TypeToTAbstractType mTypeToTType, TAnnotationType tAnnotation,
			MDefinitionToTMember defToMember, MDefinition mDefinition, AnnotationTypeDeclaration annotation,
			MemberInAnnotationVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tModifier, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition,
						annotation, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_black = pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					tModifier, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition, annotation, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tMember, EObject mModifierToTModifier, EObject mTypeToTType, EObject tAnnotation,
			EObject defToMember, EObject mDefinition, EObject annotation) {
		_this.registerObjects_BWD(ruleresult, mModifier, tModifier, tMember, mModifierToTModifier, mTypeToTType,
				tAnnotation, defToMember, mDefinition, annotation);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_12_2_corematch_blackBBFBFFFB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tModifier, tMember, mTypeToTType, tAnnotation, defToMember,
								mDefinition, annotation, match });
					}
						...
						if (annotation.equals(mTypeToTType.getSource())) {
							if (annotation.getBodyDeclarations().contains(mDefinition)) {
								if (tModifier.equals(tMember.getTModifier())) {
									_result.add(new Object[] { tModifier, tMember, mTypeToTType, tAnnotation,
											defToMember, mDefinition, annotation });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mDefinition__Annotation____abstractTypeDeclaration
				.setName(mDefinition__Annotation____abstractTypeDeclaration_name_prime);
		tMember__tModifier____tModifier.setName(tMember__tModifier____tModifier_name_prime);
		return new Object[] { tModifier, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition, annotation,
				isApplicableMatch, tAnnotation__tMember____defines, tMember__tAnnotation____definedBy,
				mTypeToTType__tAnnotation____target, defToMember__mDefinition____source, defToMember__tMember____target,
				mTypeToTType__Annotation____source, annotation__mDefinition____bodyDeclarations,
				mDefinition__Annotation____abstractTypeDeclaration, tMember__tModifier____tModifier };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			TMember tMember, TypeToTAbstractType mTypeToTType, TAnnotationType tAnnotation,
			MDefinitionToTMember defToMember, MDefinition mDefinition, AnnotationTypeDeclaration annotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tModifier, tMember, mTypeToTType,
				tAnnotation, defToMember, mDefinition, annotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tModifier, tMember, mTypeToTType, tAnnotation,
					defToMember, mDefinition, annotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_12_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tModifier, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition,
				annotation);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_684575 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_684575)) {
				...
				if (tmpTMember instanceof TMember) {
					...
					if (tmpTAnnotation instanceof TAnnotationType) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
								AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
								return new Object[] { mModifier, tModifier, tMember, tAnnotation, mDefinition,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			Modifier mModifier, TModifier tModifier, TMember tMember, TAnnotationType tAnnotation,
			MDefinition mDefinition, AnnotationTypeDeclaration annotation, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mModifier, tModifier, tMember, tAnnotation, mDefinition, annotation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mModifier, tModifier, tMember, tAnnotation, mDefinition, annotation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInAnnotationVisibility _this, Modifier mModifier, TModifier tModifier, TMember tMember,
			TAnnotationType tAnnotation, MDefinition mDefinition, AnnotationTypeDeclaration annotation,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mModifier, tModifier, tMember, tAnnotation, mDefinition,
				annotation, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mModifier, tModifier, tMember, tAnnotation, mDefinition, annotation,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_24_3_solvecsp_binding = pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mModifier, tModifier, tMember, tAnnotation, mDefinition, annotation, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_24_5_matchcorrcontext_blackBFBFBBBB(
			TMember tMember, TAnnotationType tAnnotation, MDefinition mDefinition, AnnotationTypeDeclaration annotation,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (annotation.equals(mTypeToTType.getSource())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { tMember, mTypeToTType, tAnnotation, defToMember, mDefinition,
									annotation, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(
			Modifier mModifier, TModifier tModifier, TMember tMember, TAnnotationType tAnnotation,
			MDefinition mDefinition, AnnotationTypeDeclaration annotation, CCMatch ccMatch) {
		return new Object[] { mModifier, tModifier, tMember, tAnnotation, mDefinition, annotation, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_28_1_matchtggpattern_black_nac_0BB(
			TModifier tModifier, TAnnotationType tAnnotation) {
		for (TAbstractType __DEC_tModifier_tModifier_671827 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_671827)) {
				return new Object[] { tModifier, tAnnotation };
			}
		}
		return null;
			...
			for (EObject tmpMTypeToTType : mTypeToTTypeList.getEntryObjects()) {
				if (tmpMTypeToTType instanceof TypeToTAbstractType) {
					...
					if (tmpTAnnotation instanceof TAnnotationType) {
						...
						if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
							AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
							if (pattern_MemberInAnnotationVisibility_29_2_isapplicablecore_black_nac_2BB(ruleResult,
									mTypeToTType) == null) {
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tMember, mTypeToTType, tAnnotation,
				defToMember, mDefinition, annotation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, mTypeToTType, tAnnotation, defToMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_29_3_solveCSP_binding = pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, mTypeToTType, tAnnotation, defToMember, mDefinition, annotation,
				ruleResult);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_5_checknacs_blackBBBBBB(TMember tMember,
			TypeToTAbstractType mTypeToTType, TAnnotationType tAnnotation, MDefinitionToTMember defToMember,
			MDefinition mDefinition, AnnotationTypeDeclaration annotation) {
		return new Object[] { tMember, mTypeToTType, tAnnotation, defToMember, mDefinition, annotation };
	}

	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(TMember tMember,
			TypeToTAbstractType mTypeToTType, TAnnotationType tAnnotation, MDefinitionToTMember defToMember,
			MDefinition mDefinition, AnnotationTypeDeclaration annotation, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tMember, mTypeToTType, tAnnotation, defToMember, mDefinition, annotation, ruleResult };
	}

	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_greenFFBFBBB(TMember tMember,
		...
		return new Object[] { mModifier, tModifier, tMember, mModifierToTModifier, mDefinition, ruleResult, csp };
	}
