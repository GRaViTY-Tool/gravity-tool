...
import org.gravity.tgg.modisco.MFlowToTFlow;
...
public class FlowNodeImpl extends AbstractRuleImpl implements FlowNode {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, tOwner,
				mFlow, mAbstFlowToTAbstFlow, tFlow, mOwnerToTOwner, mOwner, mFlowToTFlow);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tOwner] = " + tOwner + ", " + "[mFlow] = " + mFlow + ", " + "[mAbstFlowToTAbstFlow] = "
					+ mAbstFlowToTAbstFlow + ", " + "[tFlow] = " + tFlow + ", " + "[mOwnerToTOwner] = " + mOwnerToTOwner
		...
		//nothing EMoflonEdge mFlowToTFlow__mFlow____source = (EMoflonEdge) result3_green[13];
		...
		FlowNodeImpl.pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, tOwner, mFlow,
				mAbstFlowToTAbstFlow, tFlow, mOwnerToTOwner, mOwner, mFlowToTFlow);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tOwner, EObject mFlow,
			EObject mAbstFlowToTAbstFlow, EObject tFlow, EObject mOwnerToTOwner, EObject mOwner, EObject mFlowToTFlow) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_11_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
				tOwner, mFlow, mAbstFlowToTAbstFlow, tFlow, mOwnerToTOwner, mOwner, mFlowToTFlow);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tOwner] = " + tOwner + ", " + "[mFlow] = " + mFlow + ", " + "[mAbstFlowToTAbstFlow] = "
					+ mAbstFlowToTAbstFlow + ", " + "[tFlow] = " + tFlow + ", " + "[mOwnerToTOwner] = " + mOwnerToTOwner
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_197(EMoflonEdge _edge_ownedFlows) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_203(EMoflonEdge _edge_ownedFlows) {
		...
		for (Object[] result2_black : FlowNodeImpl
			...
			if (FlowNodeImpl.pattern_FlowNode_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					FlowNodeImpl.pattern_FlowNode_29_6_perform_greenBFFFBFB(tOwner, mOwner, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_197__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_197((EMoflonEdge) arguments.get(0));
		case RulesPackage.FLOW_NODE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_203__EMOFLONEDGE:
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_greenBBFFF(TAbstractFlowElement tOwner,
			MFlow mFlow) {
		MAbstractFlowElementToTAbstractFlowElement mAbstFlowToTAbstFlow = ModiscoFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		TFlow tFlow = BasicFactory.eINSTANCE.createTFlow();
		MFlowToTFlow mFlowToTFlow = ModiscoFactory.eINSTANCE.createMFlowToTFlow();
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(PerformRuleResult ruleresult,
			EObject tOwner, EObject mFlow, EObject mAbstFlowToTAbstFlow, EObject tFlow, EObject mOwnerToTOwner,
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { ruleresult, tOwner, mFlow, mAbstFlowToTAbstFlow, tFlow, mOwner, mFlowToTFlow,
				...
				mFlowToTFlow__mFlow____source, mFlowToTFlow__tFlow____target };
	}
	...
	public static final void pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
		...
		_this.registerObjects_FWD(ruleresult, tOwner, mFlow, mAbstFlowToTAbstFlow, tFlow, mOwnerToTOwner, mOwner,
				mFlowToTFlow);
	...
	public static final Object[] pattern_FlowNode_11_1_performtransformation_greenFFBBF(TFlow tFlow,
			MAbstractFlowElement mOwner) {
		MFlow mFlow = org.gravity.modisco.ModiscoFactory.eINSTANCE.createMFlow();
		MAbstractFlowElementToTAbstractFlowElement mAbstFlowToTAbstFlow = ModiscoFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MFlowToTFlow mFlowToTFlow = ModiscoFactory.eINSTANCE.createMFlowToTFlow();
	...
	public static final void pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject tOwner, EObject mFlow, EObject mAbstFlowToTAbstFlow, EObject tFlow,
			EObject mOwnerToTOwner, EObject mOwner, EObject mFlowToTFlow) {
		_this.registerObjects_BWD(ruleresult, tOwner, mFlow, mAbstFlowToTAbstFlow, tFlow, mOwnerToTOwner, mOwner,
				mFlowToTFlow);
	...
	public static final Object[] pattern_FlowNode_29_6_perform_greenBFFFBFB(TAbstractFlowElement tOwner,
		...
		return new Object[] { tOwner, mFlow, mAbstFlowToTAbstFlow, tFlow, mOwner, mFlowToTFlow, ruleResult };
	}
