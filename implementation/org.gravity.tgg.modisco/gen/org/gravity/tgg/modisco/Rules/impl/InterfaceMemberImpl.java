...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mTypeToTType, mModifierToTModifier, mDefinition, defToMember, tInterface, mModifier,
				tModifier, mInterface, tMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ defToMember + ", " + "[tInterface] = " + tInterface + ", " + "[mModifier] = " + mModifier + ", "
					+ "[tModifier] = " + tModifier + ", " + "[mInterface] = " + mInterface + ", " + "[tMember] = "
					+ tMember + ".");
		}
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mTypeToTType, mModifierToTModifier, mDefinition, defToMember, tInterface, mModifier, tModifier,
				mInterface, tMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_2_2_corematch_blackFBFFBBFB(mDefinition, mModifier, mInterface, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					mTypeToTType, mDefinition, defToMember, tInterface, mModifier, mInterface, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mTypeToTType, mDefinition,
								defToMember, tInterface, mModifier, mInterface, tMember);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			MDefinition mDefinition, MDefinitionToTMember defToMember, TInterface tInterface, Modifier mModifier,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mTypeToTType, EObject mModifierToTModifier,
			EObject mDefinition, EObject defToMember, EObject tInterface, EObject mModifier, EObject tModifier,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					mTypeToTType, mDefinition, defToMember, tInterface, tModifier, mInterface, tMember)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mTypeToTType, mDefinition,
								defToMember, tInterface, tModifier, mInterface, tMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge defToMember__mDefinition____source = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge mTypeToTType__tInterface____target = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge mTypeToTType__mInterface____source = (EMoflonEdge) result3_green[10];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			MDefinition mDefinition, MDefinitionToTMember defToMember, TInterface tInterface, TModifier tModifier,
			InterfaceDeclaration mInterface, TMember tMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_190(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_196(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mDefinition, tInterface,
						mModifier, tModifier, mInterface, tMember, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mDefinition] = " + mDefinition + ", " + "[tInterface] = " + tInterface + ", " + "[mModifier] = "
		...
		if (InterfaceMemberImpl.pattern_InterfaceMember_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : InterfaceMemberImpl
					.pattern_InterfaceMember_24_5_matchcorrcontext_blackFBFBBBBB(mDefinition, tInterface, mInterface,
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(mDefinition, tInterface,
								mModifier, tModifier, mInterface, tMember, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mDefinition] = "
							+ mDefinition + ", " + "[tInterface] = " + tInterface + ", " + "[mModifier] = " + mModifier
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MDefinition mDefinition, TInterface tInterface, Modifier mModifier,
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mTypeToTType, mDefinition, defToMember, tInterface, mInterface, tMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTypeToTType] = " + mTypeToTType
						+ ", " + "[mDefinition] = " + mDefinition + ", " + "[defToMember] = " + defToMember + ", "
						+ "[tInterface] = " + tInterface + ", " + "[mInterface] = " + mInterface + ", " + "[tMember] = "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(
						mTypeToTType, mDefinition, defToMember, tInterface, mInterface, tMember);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mTypeToTType] = "
								...
								+ defToMember + ", " + "[tInterface] = " + tInterface + ", " + "[mInterface] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			MDefinition mDefinition, MDefinitionToTMember defToMember, TInterface tInterface,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_MDEFINITION_MDEFINITIONTOTMEMBER_TINTERFACE_MODIFIER_INTERFACEDECLARATION_TMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (MDefinition) arguments.get(2),
					(MDefinitionToTMember) arguments.get(3), (TInterface) arguments.get(4), (Modifier) arguments.get(5),
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_MDEFINITION_MDEFINITIONTOTMEMBER_TINTERFACE_TMODIFIER_INTERFACEDECLARATION_TMEMBER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (MDefinition) arguments.get(2),
					(MDefinitionToTMember) arguments.get(3), (TInterface) arguments.get(4),
					(TModifier) arguments.get(5), (InterfaceDeclaration) arguments.get(6), (TMember) arguments.get(7));
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_190__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_190((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_196__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__MDEFINITION_TINTERFACE_MODIFIER_TMODIFIER_INTERFACEDECLARATION_TMEMBER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MDefinition) arguments.get(0), (TInterface) arguments.get(1),
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_MDEFINITION_MDEFINITIONTOTMEMBER_TINTERFACE_INTERFACEDECLARATION_TMEMBER_MODELGENERATORRULERESULT:
						...
						if (tmpMModifier instanceof Modifier) {
							...
							if (tmpMInterface instanceof InterfaceDeclaration) {
								...
								if (tmpTMember instanceof TMember) {
									...
									return new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, mModifier,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
			...
			TInterface tInterface, Modifier mModifier, InterfaceDeclaration mInterface, TMember tMember,
			InterfaceMember _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, mModifier, mInterface,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					mTypeToTType, mDefinition, defToMember, tInterface, mModifier, mInterface, tMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject defToMember, EObject tInterface, EObject mModifier, EObject tModifier, EObject mInterface,
			EObject tMember) {
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject defToMember, EObject tInterface, EObject mModifier, EObject tModifier, EObject mInterface,
			EObject tMember) {
		_this.registerObjects_FWD(ruleresult, mTypeToTType, mModifierToTModifier, mDefinition, defToMember, tInterface,
				mModifier, tModifier, mInterface, tMember);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_2_2_corematch_blackFBFFBBFB(MDefinition mDefinition,
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTInterface instanceof TInterface) {
						TInterface tInterface = (TInterface) tmpTInterface;
						_result.add(new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, mModifier,
						...
						if (mInterface.getBodyDeclarations().contains(mDefinition)) {
							if (tInterface.getDefines().contains(tMember)) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { mTypeToTType, mDefinition, defToMember, tInterface,
											mModifier, mInterface, tMember });
								}
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, mModifier, mInterface, tMember,
				isApplicableMatch, defToMember__mDefinition____source, mTypeToTType__tInterface____target,
				...
				tMember__tInterface____definedBy, defToMember__tMember____target };
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			...
			MDefinitionToTMember defToMember, TInterface tInterface, Modifier mModifier,
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, mDefinition, defToMember, tInterface,
					mModifier, mInterface, tMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, mDefinition, defToMember, tInterface, mModifier, mInterface,
				tMember);
					...
					if (tmpTInterface instanceof TInterface) {
						...
						if (tmpTModifier instanceof TModifier) {
							...
							if (tmpMInterface instanceof InterfaceDeclaration) {
								...
								if (tmpTMember instanceof TMember) {
									TMember tMember = (TMember) tmpTMember;
									return new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, tModifier,
											mInterface, tMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
			TypeToTAbstractType mTypeToTType, MDefinition mDefinition, MDefinitionToTMember defToMember,
			TInterface tInterface, TModifier tModifier, InterfaceDeclaration mInterface, TMember tMember,
			InterfaceMember _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, tModifier, mInterface,
						tMember, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					mTypeToTType, mDefinition, defToMember, tInterface, tModifier, mInterface, tMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject defToMember, EObject tInterface, EObject mModifier, EObject tModifier, EObject mInterface,
			EObject tMember) {
		_this.registerObjects_BWD(ruleresult, mTypeToTType, mModifierToTModifier, mDefinition, defToMember, tInterface,
				mModifier, tModifier, mInterface, tMember);
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMInterface instanceof InterfaceDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, tModifier,
								mInterface, tMember, match });
					}
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		tMember__tInterface____definedBy.setName(tMember__tInterface____definedBy_name_prime);
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		return new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, tModifier, mInterface, tMember,
				isApplicableMatch, defToMember__mDefinition____source, mTypeToTType__tInterface____target,
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType, MDefinition mDefinition,
			MDefinitionToTMember defToMember, TInterface tInterface, TModifier tModifier,
			InterfaceDeclaration mInterface, TMember tMember) {
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, mDefinition, defToMember, tInterface, tModifier, mInterface,
				tMember);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_541078 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_541078)) {
				...
				if (tmpMModifier instanceof Modifier) {
					...
					if (tmpTModifier instanceof TModifier) {
						...
						if (tmpMInterface instanceof InterfaceDeclaration) {
							...
							if (tmpTMember instanceof TMember) {
								TMember tMember = (TMember) tmpTMember;
								return new Object[] { mDefinition, tInterface, mModifier, tModifier, mInterface,
										tMember, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(MDefinition mDefinition,
			TInterface tInterface, Modifier mModifier, TModifier tModifier, InterfaceDeclaration mInterface,
			TMember tMember, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mDefinition, tInterface, mModifier, tModifier, mInterface, tMember, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mDefinition, tInterface, mModifier, tModifier, mInterface, tMember, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
			MDefinition mDefinition, TInterface tInterface, Modifier mModifier, TModifier tModifier,
			InterfaceDeclaration mInterface, TMember tMember, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mDefinition, tInterface, mModifier, tModifier, mInterface,
				tMember, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mDefinition, tInterface, mModifier, tModifier, mInterface, tMember,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mDefinition, tInterface, mModifier, tModifier, mInterface, tMember, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_InterfaceMember_24_5_matchcorrcontext_blackFBFBBBBB(
			MDefinition mDefinition, TInterface tInterface, InterfaceDeclaration mInterface, TMember tMember,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tMember.equals(defToMember.getTarget())) {
					for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tInterface, TypeToTAbstractType.class, "target")) {
						if (mInterface.equals(mTypeToTType.getSource())) {
							_result.add(new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, mInterface,
									tMember, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(MDefinition mDefinition,
			TInterface tInterface, Modifier mModifier, TModifier tModifier, InterfaceDeclaration mInterface,
			TMember tMember, CCMatch ccMatch) {
		return new Object[] { mDefinition, tInterface, mModifier, tModifier, mInterface, tMember, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_911807 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_911807)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType, MDefinition mDefinition,
			MDefinitionToTMember defToMember, TInterface tInterface, InterfaceDeclaration mInterface, TMember tMember,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mTypeToTType, mDefinition,
				defToMember, tInterface, mInterface, tMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, mDefinition, defToMember, tInterface,
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_29_3_solveCSP_binding = pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, mDefinition, defToMember, tInterface, mInterface, tMember,
				ruleResult);
	...
	public static final Object[] pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(TypeToTAbstractType mTypeToTType,
			MDefinition mDefinition, MDefinitionToTMember defToMember, TInterface tInterface,
			InterfaceDeclaration mInterface, TMember tMember) {
		return new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, mInterface, tMember };
	}
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(TypeToTAbstractType mTypeToTType,
		...
		return new Object[] { mTypeToTType, mDefinition, defToMember, tInterface, mInterface, tMember, ruleResult };
	}
