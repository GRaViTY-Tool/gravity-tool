...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Field Access Read</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class FieldAccessReadImpl extends AbstractRuleImpl implements FieldAccessRead {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected FieldAccessReadImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getFieldAccessRead();
	}
	...
	public boolean isAppropriate_FWD(Match match, MSingleVariableAccess mAccess,
		...
		Object[] result1_black = FieldAccessReadImpl.pattern_FieldAccessRead_0_1_initialbindings_blackBBBBBB(this,
		...
		Object[] result2_bindingAndBlack = FieldAccessReadImpl
				.pattern_FieldAccessRead_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, mAccess, varDeclFrag, mField,
						mMember);
		...
		// 
		if (FieldAccessReadImpl.pattern_FieldAccessRead_0_3_CheckCSP_expressionFBB(this, csp)) {

			Object[] result4_black = FieldAccessReadImpl
					.pattern_FieldAccessRead_0_4_collectelementstobetranslated_blackBBBBB(match, mAccess, varDeclFrag,
							mField, mMember);
			...
			FieldAccessReadImpl.pattern_FieldAccessRead_0_4_collectelementstobetranslated_greenBBBBFFF(match, mAccess,
					varDeclFrag, mMember);
			...
			Object[] result5_black = FieldAccessReadImpl.pattern_FieldAccessRead_0_5_collectcontextelements_blackBBBBB(
					match, mAccess, varDeclFrag, mField, mMember);
			...
			FieldAccessReadImpl.pattern_FieldAccessRead_0_5_collectcontextelements_greenBBBBFF(match, varDeclFrag,
					mField, mMember);
			...
			// 
			FieldAccessReadImpl.pattern_FieldAccessRead_0_6_registerobjectstomatch_expressionBBBBBB(this, match,
					mAccess, varDeclFrag, mField, mMember);
			return FieldAccessReadImpl.pattern_FieldAccessRead_0_7_expressionF();
		} else {
			return FieldAccessReadImpl.pattern_FieldAccessRead_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = FieldAccessReadImpl
				.pattern_FieldAccessRead_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(this, isApplicableMatch);
		...
		Object[] result1_green = FieldAccessReadImpl
				.pattern_FieldAccessRead_1_1_performtransformation_greenBBFFBF(mAccess, tMember, tField);
		TRead tAccess = (TRead) result1_green[2];
		...
		Object[] result2_black = FieldAccessReadImpl.pattern_FieldAccessRead_1_2_collecttranslatedelements_blackBBBB(
		...
		Object[] result2_green = FieldAccessReadImpl.pattern_FieldAccessRead_1_2_collecttranslatedelements_greenFBBBB(
				mAccess, tAccess, mFlowOwnerToTFlowOwner, mAccessToTAccess);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = FieldAccessReadImpl.pattern_FieldAccessRead_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(
		...
		// 
		// 
		FieldAccessReadImpl.pattern_FieldAccessRead_1_5_registerobjects_expressionBBBBBBBBBBBBB(this, ruleresult,
				mAccess, mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod,
				mFlowOwnerToTFlowOwner, mMember, tField, mAccessToTAccess);
		return FieldAccessReadImpl.pattern_FieldAccessRead_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = FieldAccessReadImpl
				.pattern_FieldAccessRead_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		...
		Object[] result1_green = FieldAccessReadImpl
				.pattern_FieldAccessRead_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = FieldAccessReadImpl.pattern_FieldAccessRead_2_2_corematch_bindingFFFFB(match);
		...
		for (Object[] result2_black : FieldAccessReadImpl.pattern_FieldAccessRead_2_2_corematch_blackBFBFBFBFB(mAccess,
				varDeclFrag, mField, mMember, match)) {
			...
			// ForEach 
			for (Object[] result3_black : FieldAccessReadImpl.pattern_FieldAccessRead_2_3_findcontext_blackBBBBBBBB(
					mAccess, mMemberToTMember, varDeclFrag, tMember, mField, mMethodToTMethod, mMember, tField)) {
				Object[] result3_green = FieldAccessReadImpl
						.pattern_FieldAccessRead_2_3_findcontext_greenBBBBBBBBFFFFFFFFFF(mAccess, mMemberToTMember,
				...
				Object[] result4_bindingAndBlack = FieldAccessReadImpl
						.pattern_FieldAccessRead_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
				...
				// 
				if (FieldAccessReadImpl.pattern_FieldAccessRead_2_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = FieldAccessReadImpl
							.pattern_FieldAccessRead_2_6_addmatchtoruleresult_blackBB(ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					FieldAccessReadImpl.pattern_FieldAccessRead_2_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return FieldAccessReadImpl.pattern_FieldAccessRead_2_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TMember tMember, TRead tAccess, TFieldDefinition tField) {

		Object[] result1_black = FieldAccessReadImpl.pattern_FieldAccessRead_10_1_initialbindings_blackBBBBB(this,
		...
		Object[] result2_bindingAndBlack = FieldAccessReadImpl
				.pattern_FieldAccessRead_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, tMember, tAccess, tField);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tMember] = " + tMember + ", " + "[tAccess] = " + tAccess + ", "
					+ "[tField] = " + tField + ".");
		...
		CSP csp = (CSP) result2_bindingAndBlack[0];
		// 
		if (FieldAccessReadImpl.pattern_FieldAccessRead_10_3_CheckCSP_expressionFBB(this, csp)) {

			Object[] result4_black = FieldAccessReadImpl
					.pattern_FieldAccessRead_10_4_collectelementstobetranslated_blackBBBB(match, tMember, tAccess,
							tField);
			if (result4_black == null) {
				throw new RuntimeException(
			...
			Object[] result5_black = FieldAccessReadImpl
					.pattern_FieldAccessRead_10_5_collectcontextelements_blackBBBB(match, tMember, tAccess, tField);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[tMember] = "
								+ tMember + ", " + "[tAccess] = " + tAccess + ", " + "[tField] = " + tField + ".");
			}
			FieldAccessReadImpl.pattern_FieldAccessRead_10_5_collectcontextelements_greenBBB(match, tMember, tField);

			// 
			FieldAccessReadImpl.pattern_FieldAccessRead_10_6_registerobjectstomatch_expressionBBBBB(this, match,
					tMember, tAccess, tField);
			return FieldAccessReadImpl.pattern_FieldAccessRead_10_7_expressionF();
		} else {
			return FieldAccessReadImpl.pattern_FieldAccessRead_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = FieldAccessReadImpl
				.pattern_FieldAccessRead_11_1_performtransformation_bindingAndBlackFFFFFFFFFBB(this, isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		}
		...
		TRead tAccess = (TRead) result1_bindingAndBlack[4];
		MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result1_bindingAndBlack[5];
		MDefinition mMember = (MDefinition) result1_bindingAndBlack[6];
		TFieldDefinition tField = (TFieldDefinition) result1_bindingAndBlack[7];
		//nothing CSP csp = (CSP) result1_bindingAndBlack[8];
		Object[] result1_green = FieldAccessReadImpl
				.pattern_FieldAccessRead_11_1_performtransformation_greenFBBFBF(varDeclFrag, tAccess, mMember);
		MSingleVariableAccess mAccess = (MSingleVariableAccess) result1_green[0];
		MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner = (MAbstractFlowElementToTAbstractFlowElement) result1_green[3];
		MSingleVariableAccessToTAccess mAccessToTAccess = (MSingleVariableAccessToTAccess) result1_green[5];

		Object[] result2_black = FieldAccessReadImpl.pattern_FieldAccessRead_11_2_collecttranslatedelements_blackBBBB(
				mAccess, tAccess, mFlowOwnerToTFlowOwner, mAccessToTAccess);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mAccess] = " + mAccess + ", "
					+ "[tAccess] = " + tAccess + ", " + "[mFlowOwnerToTFlowOwner] = " + mFlowOwnerToTFlowOwner + ", "
		...
		Object[] result2_green = FieldAccessReadImpl.pattern_FieldAccessRead_11_2_collecttranslatedelements_greenFBBBB(
				mAccess, tAccess, mFlowOwnerToTFlowOwner, mAccessToTAccess);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = FieldAccessReadImpl.pattern_FieldAccessRead_11_3_bookkeepingforedges_blackBBBBBBBBBBBB(
				ruleresult, mAccess, mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod,
				mFlowOwnerToTFlowOwner, mMember, tField, mAccessToTAccess);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
		...
		// 
		// 
		FieldAccessReadImpl.pattern_FieldAccessRead_11_5_registerobjects_expressionBBBBBBBBBBBBB(this, ruleresult,
				mAccess, mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod,
				mFlowOwnerToTFlowOwner, mMember, tField, mAccessToTAccess);
		return FieldAccessReadImpl.pattern_FieldAccessRead_11_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Object[] result1_bindingAndBlack = FieldAccessReadImpl
				.pattern_FieldAccessRead_12_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		EOperation performOperation = (EOperation) result1_bindingAndBlack[0];
		//nothing EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = FieldAccessReadImpl
				.pattern_FieldAccessRead_12_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = FieldAccessReadImpl.pattern_FieldAccessRead_12_2_corematch_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		TMember tMember = (TMember) result2_binding[0];
		TRead tAccess = (TRead) result2_binding[1];
		TFieldDefinition tField = (TFieldDefinition) result2_binding[2];
		for (Object[] result2_black : FieldAccessReadImpl.pattern_FieldAccessRead_12_2_corematch_blackFBFBFFBB(tMember,
				tAccess, tField, match)) {
			...
			// ForEach 
			for (Object[] result3_black : FieldAccessReadImpl.pattern_FieldAccessRead_12_3_findcontext_blackBFBBBBBB(
				...
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
				if (FieldAccessReadImpl.pattern_FieldAccessRead_12_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = FieldAccessReadImpl
							.pattern_FieldAccessRead_12_6_addmatchtoruleresult_blackBB(ruleresult, isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					FieldAccessReadImpl.pattern_FieldAccessRead_12_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return FieldAccessReadImpl.pattern_FieldAccessRead_12_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TMember tMember, TRead tAccess, TFieldDefinition tField) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TMember tMember, TRead tAccess, TFieldDefinition tField) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField, TRead tAccess,
	...
	public boolean checkTypes_BWD(Match match) {
		return true
				&& org.moflon.util.eMoflonSDMUtil.getFQN(match.getObject("tAccess").eClass()).equals("basic.TRead.");
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_236(EMoflonEdge _edge_tAccessing) {
		...
		Object[] result1_green = FieldAccessReadImpl.pattern_FieldAccessRead_20_1_preparereturnvalue_greenF();
		...
		for (Object[] result2_black : FieldAccessReadImpl
			...
			Object[] result2_green = FieldAccessReadImpl
					.pattern_FieldAccessRead_20_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// 
			if (FieldAccessReadImpl
					.pattern_FieldAccessRead_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, tMember, tAccess, tField)) {
				// 
				if (FieldAccessReadImpl
						.pattern_FieldAccessRead_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(this,
								match)) {

					Object[] result5_black = FieldAccessReadImpl
							.pattern_FieldAccessRead_20_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
					...
					FieldAccessReadImpl.pattern_FieldAccessRead_20_5_Addmatchtoruleresult_greenBBBB(match,
		...
		return FieldAccessReadImpl.pattern_FieldAccessRead_20_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_244(EMoflonEdge _edge_mAbstractFieldAccess) {
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		EOperation isApplicableCC = (EOperation) result1_bindingAndBlack[3];
		Object[] result1_green = FieldAccessReadImpl.pattern_FieldAccessRead_21_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach 
		for (Object[] result2_black : FieldAccessReadImpl
				.pattern_FieldAccessRead_21_2_testcorematchandDECs_blackFFFFB(_edge_mAbstractFieldAccess)) {
			...
			Object[] result2_green = FieldAccessReadImpl
					.pattern_FieldAccessRead_21_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// 
			if (FieldAccessReadImpl
					.pattern_FieldAccessRead_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(this,
							match, mAccess, varDeclFrag, mField, mMember)) {
				// 
				if (FieldAccessReadImpl
						.pattern_FieldAccessRead_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(this,
								match)) {

					Object[] result5_black = FieldAccessReadImpl
							.pattern_FieldAccessRead_21_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
									__result, isApplicableCC);
					if (result5_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match
								+ ", " + "[__performOperation] = " + __performOperation + ", " + "[__result] = "
					...
					FieldAccessReadImpl.pattern_FieldAccessRead_21_5_Addmatchtoruleresult_greenBBBB(match,
							__performOperation, __result, isApplicableCC);
		...
		return FieldAccessReadImpl.pattern_FieldAccessRead_21_6_expressionFB(__result);
	}
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result1_black = FieldAccessReadImpl.pattern_FieldAccessRead_24_1_prepare_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = FieldAccessReadImpl.pattern_FieldAccessRead_24_1_prepare_greenF();
		IsApplicableRuleResult result = (IsApplicableRuleResult) result1_green[0];

		Object[] result2_bindingAndBlack = FieldAccessReadImpl
				.pattern_FieldAccessRead_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		TRead tAccess = (TRead) result2_bindingAndBlack[4];
		...
		Object[] result3_bindingAndBlack = FieldAccessReadImpl
				.pattern_FieldAccessRead_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, mAccess, varDeclFrag, tMember,
		...
		// 
		if (FieldAccessReadImpl.pattern_FieldAccessRead_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : FieldAccessReadImpl
					.pattern_FieldAccessRead_24_5_matchcorrcontext_blackFBBFBBBB(tMember, mField, mMember, tField,
				...
				Object[] result5_green = FieldAccessReadImpl.pattern_FieldAccessRead_24_5_matchcorrcontext_greenBBBBF(
						mMemberToTMember, mMethodToTMethod, sourceMatch, targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[4];

				Object[] result6_black = FieldAccessReadImpl
						.pattern_FieldAccessRead_24_6_createcorrespondence_blackBBBBBBBB(mAccess, varDeclFrag, tMember,
				...
				FieldAccessReadImpl.pattern_FieldAccessRead_24_6_createcorrespondence_greenBBFFB(mAccess, tAccess,
						ccMatch);
				...
				Object[] result7_black = FieldAccessReadImpl
						.pattern_FieldAccessRead_24_7_addtoreturnedresult_blackBB(result, ccMatch);
				if (result7_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[result] = " + result
							+ ", " + "[ccMatch] = " + ccMatch + ".");
				}
				FieldAccessReadImpl.pattern_FieldAccessRead_24_7_addtoreturnedresult_greenBB(result, ccMatch);

			}

		} else {
		}
		return FieldAccessReadImpl.pattern_FieldAccessRead_24_8_expressionFB(result);
	}
	...
	public CSP isApplicable_solveCsp_CC(MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag,
			TMember tMember, MFieldDefinition mField, TRead tAccess, MDefinition mMember, TFieldDefinition tField,
	...
	public boolean checkDEC_FWD(MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag,
		...
		Object[] result1_black = FieldAccessReadImpl.pattern_FieldAccessRead_27_1_matchtggpattern_blackBBBB(mAccess,
				varDeclFrag, mField, mMember);
		if (result1_black != null) {
			FieldAccessReadImpl.pattern_FieldAccessRead_27_1_matchtggpattern_greenB(mAccess);

			return FieldAccessReadImpl.pattern_FieldAccessRead_27_2_expressionF();
		} else {
			return FieldAccessReadImpl.pattern_FieldAccessRead_27_3_expressionF();
		}
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TMember tMember, TRead tAccess, TFieldDefinition tField) {// 
		Object[] result1_black = FieldAccessReadImpl.pattern_FieldAccessRead_28_1_matchtggpattern_blackBBB(tMember,
				tAccess, tField);
		if (result1_black != null) {
			return FieldAccessReadImpl.pattern_FieldAccessRead_28_2_expressionF();
		} else {
			return FieldAccessReadImpl.pattern_FieldAccessRead_28_3_expressionF();
		}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		Object[] result1_black = FieldAccessReadImpl.pattern_FieldAccessRead_29_1_createresult_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = FieldAccessReadImpl.pattern_FieldAccessRead_29_1_createresult_greenFF();
		...
		for (Object[] result2_black : FieldAccessReadImpl
			...
			Object[] result3_bindingAndBlack = FieldAccessReadImpl
					.pattern_FieldAccessRead_29_3_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
			...
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (FieldAccessReadImpl.pattern_FieldAccessRead_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = FieldAccessReadImpl.pattern_FieldAccessRead_29_5_checknacs_blackBBBBBBB(
						mMemberToTMember, varDeclFrag, tMember, mField, mMethodToTMethod, mMember, tField);
				if (result5_black != null) {

					Object[] result6_black = FieldAccessReadImpl.pattern_FieldAccessRead_29_6_perform_blackBBBBBBBB(
							mMemberToTMember, varDeclFrag, tMember, mField, mMethodToTMethod, mMember, tField,
							ruleResult);
					if (result6_black == null) {
					...
					FieldAccessReadImpl.pattern_FieldAccessRead_29_6_perform_greenFBBFFBBFB(varDeclFrag, tMember,
							mMember, tField, ruleResult);
					//nothing MSingleVariableAccess mAccess = (MSingleVariableAccess) result6_green[0];
					//nothing TRead tAccess = (TRead) result6_green[3];
		...
		return FieldAccessReadImpl.pattern_FieldAccessRead_29_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.FIELD_ACCESS_READ___IS_APPROPRIATE_FWD__MATCH_MSINGLEVARIABLEACCESS_VARIABLEDECLARATIONFRAGMENT_MFIELDDEFINITION_MDEFINITION:
		...
		case RulesPackage.FIELD_ACCESS_READ___PERFORM_FWD__ISAPPLICABLEMATCH:
			return perform_FWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPLICABLE_FWD__MATCH:
			return isApplicable_FWD((Match) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MSINGLEVARIABLEACCESS_VARIABLEDECLARATIONFRAGMENT_MFIELDDEFINITION_MDEFINITION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (MSingleVariableAccess) arguments.get(1),
					(VariableDeclarationFragment) arguments.get(2), (MFieldDefinition) arguments.get(3),
					(MDefinition) arguments.get(4));
			return null;
		case RulesPackage.FIELD_ACCESS_READ___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MSINGLEVARIABLEACCESS_VARIABLEDECLARATIONFRAGMENT_MFIELDDEFINITION_MDEFINITION:
			return isAppropriate_solveCsp_FWD((Match) arguments.get(0), (MSingleVariableAccess) arguments.get(1),
					(VariableDeclarationFragment) arguments.get(2), (MFieldDefinition) arguments.get(3),
					(MDefinition) arguments.get(4));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPROPRIATE_CHECK_CSP_FWD__CSP:
			return isAppropriate_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MSINGLEVARIABLEACCESS_MDEFINITIONTOTMEMBER_VARIABLEDECLARATIONFRAGMENT_TMEMBER_MFIELDDEFINITION_MDEFINITIONTOTMEMBER_MDEFINITION_TFIELDDEFINITION:
		...
		case RulesPackage.FIELD_ACCESS_READ___IS_APPLICABLE_CHECK_CSP_FWD__CSP:
			return isApplicable_checkCsp_FWD((CSP) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
			...
			return null;
		case RulesPackage.FIELD_ACCESS_READ___CHECK_TYPES_FWD__MATCH:
			return checkTypes_FWD((Match) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPROPRIATE_BWD__MATCH_TMEMBER_TREAD_TFIELDDEFINITION:
			return isAppropriate_BWD((Match) arguments.get(0), (TMember) arguments.get(1), (TRead) arguments.get(2),
					(TFieldDefinition) arguments.get(3));
		case RulesPackage.FIELD_ACCESS_READ___PERFORM_BWD__ISAPPLICABLEMATCH:
			return perform_BWD((IsApplicableMatch) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPLICABLE_BWD__MATCH:
			return isApplicable_BWD((Match) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___REGISTER_OBJECTS_TO_MATCH_BWD__MATCH_TMEMBER_TREAD_TFIELDDEFINITION:
			registerObjectsToMatch_BWD((Match) arguments.get(0), (TMember) arguments.get(1), (TRead) arguments.get(2),
					(TFieldDefinition) arguments.get(3));
			return null;
		case RulesPackage.FIELD_ACCESS_READ___IS_APPROPRIATE_SOLVE_CSP_BWD__MATCH_TMEMBER_TREAD_TFIELDDEFINITION:
			return isAppropriate_solveCsp_BWD((Match) arguments.get(0), (TMember) arguments.get(1),
					(TRead) arguments.get(2), (TFieldDefinition) arguments.get(3));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPROPRIATE_CHECK_CSP_BWD__CSP:
			return isAppropriate_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_VARIABLEDECLARATIONFRAGMENT_TMEMBER_MFIELDDEFINITION_TREAD_MDEFINITIONTOTMEMBER_MDEFINITION_TFIELDDEFINITION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(MDefinitionToTMember) arguments.get(1), (VariableDeclarationFragment) arguments.get(2),
					(TMember) arguments.get(3), (MFieldDefinition) arguments.get(4), (TRead) arguments.get(5),
					(MDefinitionToTMember) arguments.get(6), (MDefinition) arguments.get(7),
					(TFieldDefinition) arguments.get(8));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPLICABLE_CHECK_CSP_BWD__CSP:
			return isApplicable_checkCsp_BWD((CSP) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.FIELD_ACCESS_READ___IS_APPROPRIATE_BWD_EMOFLON_EDGE_236__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_236((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPROPRIATE_FWD_EMOFLON_EDGE_244__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_ACCESS_READ___IS_APPLICABLE_CC__MATCH_MATCH:
			return isApplicable_CC((Match) arguments.get(0), (Match) arguments.get(1));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPLICABLE_SOLVE_CSP_CC__MSINGLEVARIABLEACCESS_VARIABLEDECLARATIONFRAGMENT_TMEMBER_MFIELDDEFINITION_TREAD_MDEFINITION_TFIELDDEFINITION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MSingleVariableAccess) arguments.get(0),
					...
					(MFieldDefinition) arguments.get(3), (TRead) arguments.get(4), (MDefinition) arguments.get(5),
					(TFieldDefinition) arguments.get(6), (Match) arguments.get(7), (Match) arguments.get(8));
		case RulesPackage.FIELD_ACCESS_READ___IS_APPLICABLE_CHECK_CSP_CC__CSP:
			return isApplicable_checkCsp_CC((CSP) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ___CHECK_DEC_FWD__MSINGLEVARIABLEACCESS_VARIABLEDECLARATIONFRAGMENT_MFIELDDEFINITION_MDEFINITION:
		...
		case RulesPackage.FIELD_ACCESS_READ___CHECK_DEC_BWD__TMEMBER_TREAD_TFIELDDEFINITION:
			return checkDEC_BWD((TMember) arguments.get(0), (TRead) arguments.get(1),
					(TFieldDefinition) arguments.get(2));
		case RulesPackage.FIELD_ACCESS_READ___GENERATE_MODEL__RULEENTRYCONTAINER_MDEFINITIONTOTMEMBER_MDEFINITIONTOTMEMBER:
			return generateModel((RuleEntryContainer) arguments.get(0), (MDefinitionToTMember) arguments.get(1),
					(MDefinitionToTMember) arguments.get(2));
		case RulesPackage.FIELD_ACCESS_READ___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITIONTOTMEMBER_VARIABLEDECLARATIONFRAGMENT_TMEMBER_MFIELDDEFINITION_MDEFINITIONTOTMEMBER_MDEFINITION_TFIELDDEFINITION_MODELGENERATORRULERESULT:
		...
		case RulesPackage.FIELD_ACCESS_READ___GENERATE_MODEL_CHECK_CSP_BWD__CSP:
			return generateModel_checkCsp_BWD((CSP) arguments.get(0));
		}
		return super.eInvoke(operationID, arguments);
	}

	public static final Object[] pattern_FieldAccessRead_0_1_initialbindings_blackBBBBBB(FieldAccessRead _this,
	...
	public static final Object[] pattern_FieldAccessRead_0_2_SolveCSP_bindingFBBBBBB(FieldAccessRead _this, Match match,
	...
	public static final Object[] pattern_FieldAccessRead_0_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessRead_0_2_SolveCSP_bindingAndBlackFBBBBBB(FieldAccessRead _this,
			Match match, MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag,
			MFieldDefinition mField, MDefinition mMember) {
		Object[] result_pattern_FieldAccessRead_0_2_SolveCSP_binding = pattern_FieldAccessRead_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, mAccess, varDeclFrag, mField, mMember);
		if (result_pattern_FieldAccessRead_0_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessRead_0_2_SolveCSP_binding[0];

			Object[] result_pattern_FieldAccessRead_0_2_SolveCSP_black = pattern_FieldAccessRead_0_2_SolveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessRead_0_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessRead_0_3_CheckCSP_expressionFBB(FieldAccessRead _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, MFieldDefinition mField,
			MDefinition mMember) {
		if (!mField.equals(mMember)) {
	...
	public static final Object[] pattern_FieldAccessRead_0_4_collectelementstobetranslated_greenBBBBFFF(Match match,
	...
	public static final Object[] pattern_FieldAccessRead_0_5_collectcontextelements_blackBBBBB(Match match,
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, MFieldDefinition mField,
			MDefinition mMember) {
		if (!mField.equals(mMember)) {
			return new Object[] { match, mAccess, varDeclFrag, mField, mMember };
	...
	public static final Object[] pattern_FieldAccessRead_0_5_collectcontextelements_greenBBBBFF(Match match,
			VariableDeclarationFragment varDeclFrag, MFieldDefinition mField, MDefinition mMember) {
	...
	public static final void pattern_FieldAccessRead_0_6_registerobjectstomatch_expressionBBBBBB(FieldAccessRead _this,
			Match match, MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag,
			MFieldDefinition mField, MDefinition mMember) {
	...
	public static final boolean pattern_FieldAccessRead_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FieldAccessRead_0_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_1_1_performtransformation_bindingFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_FieldAccessRead_1_1_performtransformation_blackBBBBBBBBFBB(
			MSingleVariableAccess mAccess, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField, FieldAccessRead _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_FieldAccessRead_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
			FieldAccessRead _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_FieldAccessRead_1_1_performtransformation_binding = pattern_FieldAccessRead_1_1_performtransformation_bindingFFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_FieldAccessRead_1_1_performtransformation_binding != null) {
			MSingleVariableAccess mAccess = (MSingleVariableAccess) result_pattern_FieldAccessRead_1_1_performtransformation_binding[0];
			MDefinitionToTMember mMemberToTMember = (MDefinitionToTMember) result_pattern_FieldAccessRead_1_1_performtransformation_binding[1];
			VariableDeclarationFragment varDeclFrag = (VariableDeclarationFragment) result_pattern_FieldAccessRead_1_1_performtransformation_binding[2];
			TMember tMember = (TMember) result_pattern_FieldAccessRead_1_1_performtransformation_binding[3];
			MFieldDefinition mField = (MFieldDefinition) result_pattern_FieldAccessRead_1_1_performtransformation_binding[4];
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_FieldAccessRead_1_1_performtransformation_binding[5];
			MDefinition mMember = (MDefinition) result_pattern_FieldAccessRead_1_1_performtransformation_binding[6];
			TFieldDefinition tField = (TFieldDefinition) result_pattern_FieldAccessRead_1_1_performtransformation_binding[7];

			Object[] result_pattern_FieldAccessRead_1_1_performtransformation_black = pattern_FieldAccessRead_1_1_performtransformation_blackBBBBBBBBFBB(
					mAccess, mMemberToTMember, varDeclFrag, tMember, mField, mMethodToTMethod, mMember, tField, _this,
					isApplicableMatch);
			if (result_pattern_FieldAccessRead_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_FieldAccessRead_1_1_performtransformation_black[8];
	...
	public static final Object[] pattern_FieldAccessRead_1_1_performtransformation_greenBBFFBF(
			MSingleVariableAccess mAccess, TMember tMember, TFieldDefinition tField) {
		TRead tAccess = BasicFactory.eINSTANCE.createTRead();
	...
	public static final Object[] pattern_FieldAccessRead_1_2_collecttranslatedelements_blackBBBB(
			MSingleVariableAccess mAccess, TRead tAccess,
	...
	public static final Object[] pattern_FieldAccessRead_1_2_collecttranslatedelements_greenFBBBB(
			MSingleVariableAccess mAccess, TRead tAccess,
			MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner,
			MSingleVariableAccessToTAccess mAccessToTAccess) {
	...
	public static final Object[] pattern_FieldAccessRead_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(
	...
	public static final PerformRuleResult pattern_FieldAccessRead_1_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_2_1_preparereturnvalue_bindingFB(FieldAccessRead _this) {
	...
	public static final Object[] pattern_FieldAccessRead_2_1_preparereturnvalue_blackFBB(EClass eClass,
			FieldAccessRead _this) {
	...
	public static final Object[] pattern_FieldAccessRead_2_1_preparereturnvalue_bindingAndBlackFFB(
			FieldAccessRead _this) {
		Object[] result_pattern_FieldAccessRead_2_1_preparereturnvalue_binding = pattern_FieldAccessRead_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FieldAccessRead_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_FieldAccessRead_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FieldAccessRead_2_1_preparereturnvalue_black = pattern_FieldAccessRead_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_FieldAccessRead_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_FieldAccessRead_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_FieldAccessRead_2_1_preparereturnvalue_greenBF(EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "FieldAccessRead";
	...
	public static final Object[] pattern_FieldAccessRead_2_2_corematch_bindingFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_FieldAccessRead_2_2_corematch_blackBFBFBFBFB(
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, MFieldDefinition mField,
			MDefinition mMember, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mField.equals(mMember)) {
			AccessKind mAccess_accessKind = mAccess.getAccessKind();
			if (mAccess_accessKind.equals(AccessKind.READ)) {
	...
	public static final Iterable<Object[]> pattern_FieldAccessRead_2_3_findcontext_blackBBBBBBBB(
			MSingleVariableAccess mAccess, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_FieldAccessRead_2_3_findcontext_greenBBBBBBBBFFFFFFFFFF(
			MSingleVariableAccess mAccess, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
	...
	public static final Object[] pattern_FieldAccessRead_2_4_solveCSP_bindingFBBBBBBBBBB(FieldAccessRead _this,
	...
	public static final Object[] pattern_FieldAccessRead_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessRead_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(FieldAccessRead _this,
			IsApplicableMatch isApplicableMatch, MSingleVariableAccess mAccess, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
		Object[] result_pattern_FieldAccessRead_2_4_solveCSP_binding = pattern_FieldAccessRead_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mAccess, mMemberToTMember, varDeclFrag, tMember, mField, mMethodToTMethod,
				mMember, tField);
		if (result_pattern_FieldAccessRead_2_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessRead_2_4_solveCSP_binding[0];

			Object[] result_pattern_FieldAccessRead_2_4_solveCSP_black = pattern_FieldAccessRead_2_4_solveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessRead_2_4_solveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessRead_2_5_checkCSP_expressionFBB(FieldAccessRead _this, CSP csp) {
		boolean _localVariable_0 = _this.isApplicable_checkCsp_FWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_FieldAccessRead_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "FieldAccessRead";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_FieldAccessRead_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_10_1_initialbindings_blackBBBBB(FieldAccessRead _this,
			Match match, TMember tMember, TRead tAccess, TFieldDefinition tField) {
		if (!tField.equals(tMember)) {
	...
	public static final Object[] pattern_FieldAccessRead_10_2_SolveCSP_bindingFBBBBB(FieldAccessRead _this, Match match,
	...
	public static final Object[] pattern_FieldAccessRead_10_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessRead_10_2_SolveCSP_bindingAndBlackFBBBBB(FieldAccessRead _this,
			Match match, TMember tMember, TRead tAccess, TFieldDefinition tField) {
		Object[] result_pattern_FieldAccessRead_10_2_SolveCSP_binding = pattern_FieldAccessRead_10_2_SolveCSP_bindingFBBBBB(
				_this, match, tMember, tAccess, tField);
		if (result_pattern_FieldAccessRead_10_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessRead_10_2_SolveCSP_binding[0];

			Object[] result_pattern_FieldAccessRead_10_2_SolveCSP_black = pattern_FieldAccessRead_10_2_SolveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessRead_10_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessRead_10_3_CheckCSP_expressionFBB(FieldAccessRead _this, CSP csp) {
		boolean _localVariable_0 = _this.isAppropriate_checkCsp_BWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_10_4_collectelementstobetranslated_blackBBBB(Match match,
			TMember tMember, TRead tAccess, TFieldDefinition tField) {
		if (!tField.equals(tMember)) {
	...
	public static final Object[] pattern_FieldAccessRead_10_5_collectcontextelements_greenBBB(Match match,
	...
	public static final void pattern_FieldAccessRead_10_6_registerobjectstomatch_expressionBBBBB(FieldAccessRead _this,
			Match match, TMember tMember, TRead tAccess, TFieldDefinition tField) {
		_this.registerObjectsToMatch_BWD(match, tMember, tAccess, tField);

	}

	public static final boolean pattern_FieldAccessRead_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FieldAccessRead_10_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_11_1_performtransformation_bindingFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_FieldAccessRead_11_1_performtransformation_blackBBBBBBBBFBB(
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TRead tAccess, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
			TFieldDefinition tField, FieldAccessRead _this, IsApplicableMatch isApplicableMatch) {
		if (!mMemberToTMember.equals(mMethodToTMethod)) {
			if (!mField.equals(mMember)) {
				if (!tField.equals(tMember)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
	...
	public static final Object[] pattern_FieldAccessRead_11_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
			FieldAccessRead _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_FieldAccessRead_11_1_performtransformation_binding = pattern_FieldAccessRead_11_1_performtransformation_bindingFFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_FieldAccessRead_11_1_performtransformation_binding != null) {
			MDefinitionToTMember mMemberToTMember = (MDefinitionToTMember) result_pattern_FieldAccessRead_11_1_performtransformation_binding[0];
			VariableDeclarationFragment varDeclFrag = (VariableDeclarationFragment) result_pattern_FieldAccessRead_11_1_performtransformation_binding[1];
			TMember tMember = (TMember) result_pattern_FieldAccessRead_11_1_performtransformation_binding[2];
			MFieldDefinition mField = (MFieldDefinition) result_pattern_FieldAccessRead_11_1_performtransformation_binding[3];
			TRead tAccess = (TRead) result_pattern_FieldAccessRead_11_1_performtransformation_binding[4];
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_FieldAccessRead_11_1_performtransformation_binding[5];
			MDefinition mMember = (MDefinition) result_pattern_FieldAccessRead_11_1_performtransformation_binding[6];
			TFieldDefinition tField = (TFieldDefinition) result_pattern_FieldAccessRead_11_1_performtransformation_binding[7];

			Object[] result_pattern_FieldAccessRead_11_1_performtransformation_black = pattern_FieldAccessRead_11_1_performtransformation_blackBBBBBBBBFBB(
					mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod, mMember, tField, _this,
					isApplicableMatch);
			if (result_pattern_FieldAccessRead_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_FieldAccessRead_11_1_performtransformation_black[8];
	...
	public static final Object[] pattern_FieldAccessRead_11_1_performtransformation_greenFBBFBF(
			VariableDeclarationFragment varDeclFrag, TRead tAccess, MDefinition mMember) {
		MSingleVariableAccess mAccess = org.gravity.modisco.ModiscoFactory.eINSTANCE.createMSingleVariableAccess();
		MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner = ModiscoFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MSingleVariableAccessToTAccess mAccessToTAccess = ModiscoFactory.eINSTANCE
				.createMSingleVariableAccessToTAccess();
		AccessKind mAccess_accessKind_prime = AccessKind.READ;
	...
	public static final Object[] pattern_FieldAccessRead_11_2_collecttranslatedelements_blackBBBB(
			MSingleVariableAccess mAccess, TRead tAccess,
			MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner,
			MSingleVariableAccessToTAccess mAccessToTAccess) {
		return new Object[] { mAccess, tAccess, mFlowOwnerToTFlowOwner, mAccessToTAccess };
	...
	public static final Object[] pattern_FieldAccessRead_11_2_collecttranslatedelements_greenFBBBB(
			MSingleVariableAccess mAccess, TRead tAccess,
			MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner,
			MSingleVariableAccessToTAccess mAccessToTAccess) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_FieldAccessRead_11_3_bookkeepingforedges_blackBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mAccess, EObject mMemberToTMember, EObject varDeclFrag,
			EObject tMember, EObject mField, EObject tAccess, EObject mMethodToTMethod, EObject mFlowOwnerToTFlowOwner,
			EObject mMember, EObject tField, EObject mAccessToTAccess) {
		if (!mAccess.equals(mMemberToTMember)) {
	...
	public static final PerformRuleResult pattern_FieldAccessRead_11_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_12_1_preparereturnvalue_bindingFB(FieldAccessRead _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
			return new Object[] { eClass, _this };
	...
	public static final Object[] pattern_FieldAccessRead_12_1_preparereturnvalue_blackFBB(EClass eClass,
			FieldAccessRead _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperation_name = performOperation.getName();
	...
	public static final Object[] pattern_FieldAccessRead_12_1_preparereturnvalue_bindingAndBlackFFB(
			FieldAccessRead _this) {
		Object[] result_pattern_FieldAccessRead_12_1_preparereturnvalue_binding = pattern_FieldAccessRead_12_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FieldAccessRead_12_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_FieldAccessRead_12_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FieldAccessRead_12_1_preparereturnvalue_black = pattern_FieldAccessRead_12_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_FieldAccessRead_12_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_FieldAccessRead_12_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_FieldAccessRead_12_1_preparereturnvalue_greenBF(EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "FieldAccessRead";
		ruleresult.setPerformOperation(performOperation);
	...
	public static final Object[] pattern_FieldAccessRead_12_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_FieldAccessRead_12_2_corematch_blackFBFBFFBB(TMember tMember,
			TRead tAccess, TFieldDefinition tField, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tField.equals(tMember)) {
			for (MDefinitionToTMember mMethodToTMethod : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_FieldAccessRead_12_3_findcontext_blackBFBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MFieldDefinition mField, TRead tAccess,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mMemberToTMember.equals(mMethodToTMethod)) {
			if (!mField.equals(mMember)) {
	...
	public static final Object[] pattern_FieldAccessRead_12_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TRead tAccess, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
	...
	public static final Object[] pattern_FieldAccessRead_12_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessRead_12_4_solveCSP_bindingAndBlackFBBBBBBBBBB(FieldAccessRead _this,
			IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField, TRead tAccess,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
		Object[] result_pattern_FieldAccessRead_12_4_solveCSP_binding = pattern_FieldAccessRead_12_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod,
				mMember, tField);
		if (result_pattern_FieldAccessRead_12_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessRead_12_4_solveCSP_binding[0];

			Object[] result_pattern_FieldAccessRead_12_4_solveCSP_black = pattern_FieldAccessRead_12_4_solveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessRead_12_4_solveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessRead_12_5_checkCSP_expressionFBB(FieldAccessRead _this, CSP csp) {
		boolean _localVariable_0 = _this.isApplicable_checkCsp_BWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_12_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_FieldAccessRead_12_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "FieldAccessRead";
	...
	public static final IsApplicableRuleResult pattern_FieldAccessRead_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_20_1_preparereturnvalue_bindingFB(FieldAccessRead _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_FieldAccessRead_20_1_preparereturnvalue_blackFBBF(EClass __eClass,
			FieldAccessRead _this) {
	...
	public static final Object[] pattern_FieldAccessRead_20_1_preparereturnvalue_bindingAndBlackFFBF(
			FieldAccessRead _this) {
		Object[] result_pattern_FieldAccessRead_20_1_preparereturnvalue_binding = pattern_FieldAccessRead_20_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FieldAccessRead_20_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_FieldAccessRead_20_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FieldAccessRead_20_1_preparereturnvalue_black = pattern_FieldAccessRead_20_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_FieldAccessRead_20_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_FieldAccessRead_20_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_FieldAccessRead_20_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_FieldAccessRead_20_1_preparereturnvalue_greenF() {
	...
	public static final Object[] pattern_FieldAccessRead_20_2_testcorematchandDECs_greenFB(EClass __eClass) {
	...
	public static final boolean pattern_FieldAccessRead_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			FieldAccessRead _this, Match match, TMember tMember, TRead tAccess, TFieldDefinition tField) {
		boolean _localVariable_0 = _this.isAppropriate_BWD(match, tMember, tAccess, tField);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final boolean pattern_FieldAccessRead_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			FieldAccessRead _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_BWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_20_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_FieldAccessRead_20_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_FieldAccessRead_20_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_21_1_preparereturnvalue_bindingFB(FieldAccessRead _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
			return new Object[] { __eClass, _this };
	...
	public static final Object[] pattern_FieldAccessRead_21_1_preparereturnvalue_blackFBBF(EClass __eClass,
			FieldAccessRead _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperation_name = __performOperation.getName();
	...
	public static final Object[] pattern_FieldAccessRead_21_1_preparereturnvalue_bindingAndBlackFFBF(
			FieldAccessRead _this) {
		Object[] result_pattern_FieldAccessRead_21_1_preparereturnvalue_binding = pattern_FieldAccessRead_21_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FieldAccessRead_21_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_FieldAccessRead_21_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FieldAccessRead_21_1_preparereturnvalue_black = pattern_FieldAccessRead_21_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_FieldAccessRead_21_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_FieldAccessRead_21_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_FieldAccessRead_21_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_FieldAccessRead_21_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_FieldAccessRead_21_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!mField.equals(mMember)) {
			for (MDefinition __DEC_mAccess_mAbstractFieldAccess_695128 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mAccess, MDefinition.class, "mAbstractFieldAccess")) {
				if (!mField.equals(__DEC_mAccess_mAbstractFieldAccess_695128)) {
					if (!mMember.equals(__DEC_mAccess_mAbstractFieldAccess_695128)) {
	...
	public static final Object[] pattern_FieldAccessRead_21_2_testcorematchandDECs_black_nac_1B(
		...
		for (AnnotationMemberValuePair __DEC_mAccess_value_773818 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_FieldAccessRead_21_2_testcorematchandDECs_black_nac_2BB(
	...
	public static final Iterable<Object[]> pattern_FieldAccessRead_21_2_testcorematchandDECs_blackFFFFB(
					...
					if (tmpVarDeclFrag instanceof VariableDeclarationFragment) {
						...
						if (mAccess_accessKind.equals(AccessKind.READ)) {
							...
							if (tmpMField instanceof MFieldDefinition) {
								MFieldDefinition mField = (MFieldDefinition) tmpMField;
								if (!mField.equals(mMember)) {
									if (pattern_FieldAccessRead_21_2_testcorematchandDECs_black_nac_1B(
											mAccess) == null) {
										if (pattern_FieldAccessRead_21_2_testcorematchandDECs_black_nac_0BBB(mAccess,
												mField, mMember) == null) {
											if (pattern_FieldAccessRead_21_2_testcorematchandDECs_black_nac_2BB(mField,
													mAccess) == null) {
	...
	public static final Object[] pattern_FieldAccessRead_21_2_testcorematchandDECs_greenFB(EClass __eClass) {
		Match match = RuntimeFactory.eINSTANCE.createMatch();
		String __eClass_name = __eClass.getName();
		String match_ruleName_prime = __eClass_name;
		match.setRuleName(match_ruleName_prime);
	...
	public static final boolean pattern_FieldAccessRead_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			FieldAccessRead _this, Match match, MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag,
			MFieldDefinition mField, MDefinition mMember) {
	...
	public static final boolean pattern_FieldAccessRead_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			FieldAccessRead _this, Match match) {
	...
	public static final Object[] pattern_FieldAccessRead_21_5_Addmatchtoruleresult_blackBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		if (!__performOperation.equals(isApplicableCC)) {
			return new Object[] { match, __performOperation, __result, isApplicableCC };
		}
	...
	public static final Object[] pattern_FieldAccessRead_21_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
		match.setIsApplicableCCOperation(isApplicableCC);
	...
	public static final EObjectContainer pattern_FieldAccessRead_21_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_24_1_prepare_blackB(FieldAccessRead _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_FieldAccessRead_24_1_prepare_greenF() {
		IsApplicableRuleResult result = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		return new Object[] { result };
	}

	public static final Object[] pattern_FieldAccessRead_24_2_matchsrctrgcontext_bindingFFFFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_FieldAccessRead_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TRead tAccess, MDefinition mMember, TFieldDefinition tField, Match sourceMatch,
			Match targetMatch) {
		if (!mField.equals(mMember)) {
			if (!tField.equals(tMember)) {
	...
	public static final Object[] pattern_FieldAccessRead_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_binding = pattern_FieldAccessRead_24_2_matchsrctrgcontext_bindingFFFFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_binding != null) {
			MSingleVariableAccess mAccess = (MSingleVariableAccess) result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_binding[0];
			VariableDeclarationFragment varDeclFrag = (VariableDeclarationFragment) result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_binding[1];
			TMember tMember = (TMember) result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_binding[2];
			MFieldDefinition mField = (MFieldDefinition) result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_binding[3];
			TRead tAccess = (TRead) result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_binding[4];
			MDefinition mMember = (MDefinition) result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_binding[5];
			TFieldDefinition tField = (TFieldDefinition) result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_binding[6];

			Object[] result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_black = pattern_FieldAccessRead_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					mAccess, varDeclFrag, tMember, mField, tAccess, mMember, tField, sourceMatch, targetMatch);
			if (result_pattern_FieldAccessRead_24_2_matchsrctrgcontext_black != null) {
	...
	public static final Object[] pattern_FieldAccessRead_24_3_solvecsp_bindingFBBBBBBBBBB(FieldAccessRead _this,
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TRead tAccess, MDefinition mMember, TFieldDefinition tField, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_FieldAccessRead_24_3_solvecsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessRead_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(FieldAccessRead _this,
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TRead tAccess, MDefinition mMember, TFieldDefinition tField, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_FieldAccessRead_24_3_solvecsp_binding = pattern_FieldAccessRead_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, mAccess, varDeclFrag, tMember, mField, tAccess, mMember, tField, sourceMatch, targetMatch);
		if (result_pattern_FieldAccessRead_24_3_solvecsp_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessRead_24_3_solvecsp_binding[0];

			Object[] result_pattern_FieldAccessRead_24_3_solvecsp_black = pattern_FieldAccessRead_24_3_solvecsp_blackB(
					csp);
			if (result_pattern_FieldAccessRead_24_3_solvecsp_black != null) {
	...
	public static final boolean pattern_FieldAccessRead_24_4_checkCSP_expressionFB(CSP csp) {
		boolean _localVariable_0 = csp.check();
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Iterable<Object[]> pattern_FieldAccessRead_24_5_matchcorrcontext_blackFBBFBBBB(TMember tMember,
	...
	public static final Object[] pattern_FieldAccessRead_24_5_matchcorrcontext_greenBBBBF(
			MDefinitionToTMember mMemberToTMember, MDefinitionToTMember mMethodToTMethod, Match sourceMatch,
			Match targetMatch) {
		CCMatch ccMatch = RuntimeFactory.eINSTANCE.createCCMatch();
		String ccMatch_ruleName_prime = "FieldAccessRead";
	...
	public static final Object[] pattern_FieldAccessRead_24_6_createcorrespondence_blackBBBBBBBB(
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TRead tAccess, MDefinition mMember, TFieldDefinition tField, CCMatch ccMatch) {
		if (!mField.equals(mMember)) {
			if (!tField.equals(tMember)) {
	...
	public static final Object[] pattern_FieldAccessRead_24_6_createcorrespondence_greenBBFFB(
			MSingleVariableAccess mAccess, TRead tAccess, CCMatch ccMatch) {
		MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner = ModiscoFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MSingleVariableAccessToTAccess mAccessToTAccess = ModiscoFactory.eINSTANCE
				.createMSingleVariableAccessToTAccess();
	...
	public static final Object[] pattern_FieldAccessRead_24_7_addtoreturnedresult_blackBB(IsApplicableRuleResult result,
			CCMatch ccMatch) {
		return new Object[] { result, ccMatch };
	}

	public static final Object[] pattern_FieldAccessRead_24_7_addtoreturnedresult_greenBB(IsApplicableRuleResult result,
			CCMatch ccMatch) {
	...
	public static final IsApplicableRuleResult pattern_FieldAccessRead_24_8_expressionFB(
	...
	public static final Object[] pattern_FieldAccessRead_27_1_matchtggpattern_black_nac_0BBB(
			MSingleVariableAccess mAccess, MFieldDefinition mField, MDefinition mMember) {
		if (!mField.equals(mMember)) {
			for (MDefinition __DEC_mAccess_mAbstractFieldAccess_891410 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mAccess, MDefinition.class, "mAbstractFieldAccess")) {
				if (!mField.equals(__DEC_mAccess_mAbstractFieldAccess_891410)) {
					if (!mMember.equals(__DEC_mAccess_mAbstractFieldAccess_891410)) {
						return new Object[] { mAccess, mField, mMember };
					}
				}
			}
	...
	public static final Object[] pattern_FieldAccessRead_27_1_matchtggpattern_black_nac_1B(
			MSingleVariableAccess mAccess) {
		for (AnnotationMemberValuePair __DEC_mAccess_value_529762 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mAccess };
		}
		return null;
	...
	public static final Object[] pattern_FieldAccessRead_27_1_matchtggpattern_black_nac_2BB(MFieldDefinition mField,
			MSingleVariableAccess mAccess) {
		if (mField.getMAbstractFieldAccess().contains(mAccess)) {
			return new Object[] { mField, mAccess };
		}
	...
	public static final Object[] pattern_FieldAccessRead_27_1_matchtggpattern_blackBBBB(MSingleVariableAccess mAccess,
			VariableDeclarationFragment varDeclFrag, MFieldDefinition mField, MDefinition mMember) {
		if (!mField.equals(mMember)) {
			if (mField.equals(varDeclFrag.getVariablesContainer())) {
				if (mMember.getMAbstractFieldAccess().contains(mAccess)) {
					if (varDeclFrag.equals(mAccess.getVariable())) {
						if (pattern_FieldAccessRead_27_1_matchtggpattern_black_nac_0BBB(mAccess, mField,
								mMember) == null) {
							if (pattern_FieldAccessRead_27_1_matchtggpattern_black_nac_1B(mAccess) == null) {
								if (pattern_FieldAccessRead_27_1_matchtggpattern_black_nac_2BB(mField,
										mAccess) == null) {
	...
	public static final Object[] pattern_FieldAccessRead_27_1_matchtggpattern_greenB(MSingleVariableAccess mAccess) {
		AccessKind mAccess_accessKind_prime = AccessKind.READ;
		mAccess.setAccessKind(mAccess_accessKind_prime);
		return new Object[] { mAccess };
	}

	public static final boolean pattern_FieldAccessRead_27_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FieldAccessRead_27_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}
	...
	public static final boolean pattern_FieldAccessRead_28_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FieldAccessRead_28_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_29_1_createresult_blackB(FieldAccessRead _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_FieldAccessRead_29_1_createresult_greenFF() {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_FieldAccessRead_29_2_isapplicablecore_black_nac_0BB(
	...
	public static final Object[] pattern_FieldAccessRead_29_2_isapplicablecore_black_nac_3BB(
	...
	public static final Object[] pattern_FieldAccessRead_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_FieldAccessRead_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Object[] pattern_FieldAccessRead_29_2_isapplicablecore_black_nac_6BB(
	...
	public static final Iterable<Object[]> pattern_FieldAccessRead_29_2_isapplicablecore_blackFFFFFFFFFBB(
															...
															if (tmpMField instanceof MFieldDefinition) {
																...
																if (!mField.equals(mMember)) {
																	...
																	if (tmpTField instanceof TFieldDefinition) {
																		TFieldDefinition tField = (TFieldDefinition) tmpTField;
																		if (!tField.equals(tMember)) {
																			if (pattern_FieldAccessRead_29_2_isapplicablecore_black_nac_5BB(
																					ruleResult,
																					mMethodToTMethod) == null) {
																				if (pattern_FieldAccessRead_29_2_isapplicablecore_black_nac_4BB(
																						ruleResult, mField) == null) {
																					if (pattern_FieldAccessRead_29_2_isapplicablecore_black_nac_6BB(
																							ruleResult,
																							tField) == null) {
																						for (VariableDeclarationFragment varDeclFrag : mField
																								.getFragments()) {
																							if (pattern_FieldAccessRead_29_2_isapplicablecore_black_nac_3BB(
																									ruleResult,
																									varDeclFrag) == null) {
																								_result.add(
																										new Object[] {
	...
	public static final Object[] pattern_FieldAccessRead_29_3_solveCSP_bindingFBBBBBBBBBB(FieldAccessRead _this,
			IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField,
	...
	public static final Object[] pattern_FieldAccessRead_29_3_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessRead_29_3_solveCSP_bindingAndBlackFBBBBBBBBBB(FieldAccessRead _this,
			IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField,
			ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_FieldAccessRead_29_3_solveCSP_binding = pattern_FieldAccessRead_29_3_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mMemberToTMember, varDeclFrag, tMember, mField, mMethodToTMethod, mMember,
				tField, ruleResult);
		if (result_pattern_FieldAccessRead_29_3_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessRead_29_3_solveCSP_binding[0];

			Object[] result_pattern_FieldAccessRead_29_3_solveCSP_black = pattern_FieldAccessRead_29_3_solveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessRead_29_3_solveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessRead_29_4_checkCSP_expressionFBB(FieldAccessRead _this, CSP csp) {
		boolean _localVariable_0 = _this.generateModel_checkCsp_BWD(csp);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_FieldAccessRead_29_5_checknacs_blackBBBBBBB(
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
			TFieldDefinition tField) {
		if (!mMemberToTMember.equals(mMethodToTMethod)) {
	...
	public static final Object[] pattern_FieldAccessRead_29_6_perform_blackBBBBBBBB(
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
	...
	public static final Object[] pattern_FieldAccessRead_29_6_perform_greenFBBFFBBFB(
	...
	public static final ModelgeneratorRuleResult pattern_FieldAccessRead_29_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
