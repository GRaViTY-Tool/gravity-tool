...
public class ArrayTypeToClassImpl extends AbstractRuleImpl implements ArrayTypeToClass {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType,
			Model eModel) {

		Object[] result1_black = ArrayTypeToClassImpl.pattern_ArrayTypeToClass_0_1_initialbindings_blackBBBBBB(this,
				match, eTypeAccess, eArrayType, eType, eModel);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[eTypeAccess] = " + eTypeAccess + ", " + "[eArrayType] = "
					+ eArrayType + ", " + "[eType] = " + eType + ", " + "[eModel] = " + eModel + ".");
		}

		Object[] result2_bindingAndBlack = ArrayTypeToClassImpl
				.pattern_ArrayTypeToClass_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, eTypeAccess, eArrayType,
						eType, eModel);
		...
		if (ArrayTypeToClassImpl.pattern_ArrayTypeToClass_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = ArrayTypeToClassImpl
					.pattern_ArrayTypeToClass_0_4_collectelementstobetranslated_blackBBBBB(match, eTypeAccess,
							eArrayType, eType, eModel);
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[eTypeAccess] = " + eTypeAccess + ", " + "[eArrayType] = " + eArrayType + ", " + "[eType] = "
						+ eType + ", " + "[eModel] = " + eModel + ".");
			}
			ArrayTypeToClassImpl.pattern_ArrayTypeToClass_0_4_collectelementstobetranslated_greenBBBBBFFFF(match,
					eTypeAccess, eArrayType, eType, eModel);
			...
			Object[] result5_black = ArrayTypeToClassImpl
					.pattern_ArrayTypeToClass_0_5_collectcontextelements_blackBBBBB(match, eTypeAccess, eArrayType,
							eType, eModel);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ArrayTypeToClassImpl.pattern_ArrayTypeToClass_1_3_bookkeepingforedges_blackBBBBBBBBB(
				ruleresult, eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType, eType, typeGraph,
				tArrayClass, eModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[eTypeToTArrayClass] = " + eTypeToTArrayClass + ", " + "[eModelToTypeGraph] = "
					+ eModelToTypeGraph + ", " + "[eTypeAccess] = " + eTypeAccess + ", " + "[eArrayType] = "
					+ eArrayType + ", " + "[eType] = " + eType + ", " + "[typeGraph] = " + typeGraph + ", "
					+ "[tArrayClass] = " + tArrayClass + ", " + "[eModel] = " + eModel + ".");
		}
		ArrayTypeToClassImpl.pattern_ArrayTypeToClass_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult, eTypeAccess,
				eArrayType, eType, eModel);
		...
		ArrayTypeToClassImpl.pattern_ArrayTypeToClass_1_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult,
				eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ArrayTypeToClassImpl
				.pattern_ArrayTypeToClass_2_2_corematch_blackFFBBBFFBB(eTypeAccess, eArrayType, eType, eModel, match)) {
			...
			TypeGraph typeGraph = (TypeGraph) result2_black[5];
			...
			for (Object[] result3_black : ArrayTypeToClassImpl.pattern_ArrayTypeToClass_2_3_findcontext_blackBBBBBBBB(
					eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType, eType, typeGraph, tArrayClass,
					eModel)) {
				Object[] result3_green = ArrayTypeToClassImpl
						.pattern_ArrayTypeToClass_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(eTypeToTArrayClass,
								eModelToTypeGraph, eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[8];
				//nothing EMoflonEdge eArrayType__eTypeAccess____elementType = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge eModelToTypeGraph__typeGraph____target = (EMoflonEdge) result3_green[10];
				//nothing EMoflonEdge eTypeToTArrayClass__eType____source = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge eTypeToTArrayClass__tArrayClass____target = (EMoflonEdge) result3_green[12];
				//nothing EMoflonEdge typeGraph__tArrayClass____ownedTypes = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge tArrayClass__typeGraph____pg = (EMoflonEdge) result3_green[14];
				...
				//nothing EMoflonEdge eModelToTypeGraph__eModel____source = (EMoflonEdge) result3_green[17];
				...
				Object[] result4_bindingAndBlack = ArrayTypeToClassImpl
						.pattern_ArrayTypeToClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
								eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType, eType, typeGraph,
								tArrayClass, eModel);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[eType] = " + eType + ", " + "[typeGraph] = " + typeGraph + ", " + "[tArrayClass] = "
							+ tArrayClass + ", " + "[eModel] = " + eModel + ".");
				}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType,
			Model eModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType eTypeToTArrayClass,
			ModelToTypeGraph eModelToTypeGraph, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType,
			TypeGraph typeGraph, TAbstractType tArrayClass, Model eModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eTypeToTArrayClass, EObject eModelToTypeGraph,
			EObject eTypeAccess, EObject eArrayType, EObject eType, EObject typeGraph, EObject tArrayClass,
			EObject eModel) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_214(EMoflonEdge _edge_elementType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		ArrayType eArrayType = (ArrayType) result2_bindingAndBlack[1];
		...
		Object[] result3_bindingAndBlack = ArrayTypeToClassImpl
				.pattern_ArrayTypeToClass_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, eTypeAccess, eArrayType, eType,
						typeGraph, tArrayClass, eModel, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[eTypeAccess] = " + eTypeAccess + ", " + "[eArrayType] = " + eArrayType + ", " + "[eType] = "
					+ eType + ", " + "[typeGraph] = " + typeGraph + ", " + "[tArrayClass] = " + tArrayClass + ", "
		...
		if (ArrayTypeToClassImpl.pattern_ArrayTypeToClass_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ArrayTypeToClassImpl
					.pattern_ArrayTypeToClass_21_5_matchcorrcontext_blackFFBBBBBB(eType, typeGraph, tArrayClass, eModel,
				...
				Object[] result6_black = ArrayTypeToClassImpl
						.pattern_ArrayTypeToClass_21_6_createcorrespondence_blackBBBBBBB(eTypeAccess, eArrayType, eType,
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess eTypeAccess, ArrayType eArrayType, Type eType, TypeGraph typeGraph,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(TypeAccess eTypeAccess, ArrayType eArrayType, Type eType, Model eModel) {// 
		Object[] result1_black = ArrayTypeToClassImpl
				.pattern_ArrayTypeToClass_24_1_matchtggpattern_blackBBBB(eTypeAccess, eArrayType, eType, eModel);
		if (result1_black != null) {
		...
		for (Object[] result2_black : ArrayTypeToClassImpl
			...
			Object[] result3_bindingAndBlack = ArrayTypeToClassImpl
					.pattern_ArrayTypeToClass_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							eTypeToTArrayClass, eModelToTypeGraph, eType, typeGraph, tArrayClass, eModel, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[eTypeToTArrayClass] = "
						+ eTypeToTArrayClass + ", " + "[eModelToTypeGraph] = " + eModelToTypeGraph + ", " + "[eType] = "
						+ eType + ", " + "[typeGraph] = " + typeGraph + ", " + "[tArrayClass] = " + tArrayClass + ", "
			...
			if (ArrayTypeToClassImpl.pattern_ArrayTypeToClass_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = ArrayTypeToClassImpl.pattern_ArrayTypeToClass_26_5_checknacs_blackBBBBBB(
						eTypeToTArrayClass, eModelToTypeGraph, eType, typeGraph, tArrayClass, eModel);
				if (result5_black != null) {
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: "
								+ "[eTypeToTArrayClass] = " + eTypeToTArrayClass + ", " + "[eModelToTypeGraph] = "
								+ eModelToTypeGraph + ", " + "[eType] = " + eType + ", " + "[typeGraph] = " + typeGraph
								+ ", " + "[tArrayClass] = " + tArrayClass + ", " + "[eModel] = " + eModel + ", "
								+ "[ruleResult] = " + ruleResult + ".");
					}
					ArrayTypeToClassImpl.pattern_ArrayTypeToClass_26_6_perform_greenFFBBB(eType, eModel, ruleResult);
					//nothing TypeAccess eTypeAccess = (TypeAccess) result6_green[0];
					//nothing ArrayType eArrayType = (ArrayType) result6_green[1];
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType eTypeToTArrayClass,
			ModelToTypeGraph eModelToTypeGraph, Type eType, TypeGraph typeGraph, TAbstractType tArrayClass,
			Model eModel, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPROPRIATE_FWD__MATCH_TYPEACCESS_ARRAYTYPE_TYPE_MODEL:
			return isAppropriate_FWD((Match) arguments.get(0), (TypeAccess) arguments.get(1),
					(ArrayType) arguments.get(2), (Type) arguments.get(3), (Model) arguments.get(4));
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_TYPEACCESS_ARRAYTYPE_TYPE_MODEL:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (TypeAccess) arguments.get(1),
					(ArrayType) arguments.get(2), (Type) arguments.get(3), (Model) arguments.get(4));
			return null;
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_TYPEACCESS_ARRAYTYPE_TYPE_MODEL:
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_MODELTOTYPEGRAPH_TYPEACCESS_ARRAYTYPE_TYPE_TYPEGRAPH_TABSTRACTTYPE_MODEL:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (ModelToTypeGraph) arguments.get(2),
					(TypeAccess) arguments.get(3), (ArrayType) arguments.get(4), (Type) arguments.get(5),
					(TypeGraph) arguments.get(6), (TAbstractType) arguments.get(7), (Model) arguments.get(8));
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_214__EMOFLONEDGE:
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_ARRAYTYPE_TYPE_TYPEGRAPH_TABSTRACTTYPE_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeAccess) arguments.get(0), (ArrayType) arguments.get(1),
					(Type) arguments.get(2), (TypeGraph) arguments.get(3), (TAbstractType) arguments.get(4),
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___CHECK_DEC_FWD__TYPEACCESS_ARRAYTYPE_TYPE_MODEL:
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_MODELTOTYPEGRAPH_TYPE_TYPEGRAPH_TABSTRACTTYPE_MODEL_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ArrayTypeToClass_0_1_initialbindings_blackBBBBBB(ArrayTypeToClass _this,
			Match match, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType, Model eModel) {
		if (!eArrayType.equals(eType)) {
			return new Object[] { _this, match, eTypeAccess, eArrayType, eType, eModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_0_2_SolveCSP_bindingFBBBBBB(ArrayTypeToClass _this,
			Match match, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType, Model eModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, eTypeAccess, eArrayType, eType, eModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, eTypeAccess, eArrayType, eType, eModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_0_2_SolveCSP_bindingAndBlackFBBBBBB(ArrayTypeToClass _this,
		...
		Object[] result_pattern_ArrayTypeToClass_0_2_SolveCSP_binding = pattern_ArrayTypeToClass_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, eTypeAccess, eArrayType, eType, eModel);
	...
	public static final Object[] pattern_ArrayTypeToClass_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			TypeAccess eTypeAccess, ArrayType eArrayType, Type eType, Model eModel) {
		if (!eArrayType.equals(eType)) {
			return new Object[] { match, eTypeAccess, eArrayType, eType, eModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_0_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		return new Object[] { match, eTypeAccess, eArrayType, eType, eModel, eArrayType__eTypeAccess____elementType,
	...
	public static final void pattern_ArrayTypeToClass_0_6_registerobjectstomatch_expressionBBBBBB(
			ArrayTypeToClass _this, Match match, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType,
			Model eModel) {
		_this.registerObjectsToMatch_FWD(match, eTypeAccess, eArrayType, eType, eModel);
							...
							if (tmpTypeGraph instanceof TypeGraph) {
								...
								if (tmpTArrayClass instanceof TAbstractType) {
									...
									if (tmpEModel instanceof Model) {
										...
										return new Object[] { eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess,
												eArrayType, eType, typeGraph, tArrayClass, eModel, isApplicableMatch };
									}
								}
							}
						}
	...
	public static final Object[] pattern_ArrayTypeToClass_1_1_performtransformation_blackBBBBBBBBFBB(
			TypeToTAbstractType eTypeToTArrayClass, ModelToTypeGraph eModelToTypeGraph, TypeAccess eTypeAccess,
			ArrayType eArrayType, Type eType, TypeGraph typeGraph, TAbstractType tArrayClass, Model eModel,
			ArrayTypeToClass _this, IsApplicableMatch isApplicableMatch) {
		if (!eArrayType.equals(eType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType, eType,
							typeGraph, tArrayClass, eModel, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToClass_1_1_performtransformation_binding != null) {
			...
			Type eType = (Type) result_pattern_ArrayTypeToClass_1_1_performtransformation_binding[4];
			TypeGraph typeGraph = (TypeGraph) result_pattern_ArrayTypeToClass_1_1_performtransformation_binding[5];
			...
			if (result_pattern_ArrayTypeToClass_1_1_performtransformation_black != null) {
				...
				return new Object[] { eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType, eType, typeGraph,
	...
	public static final Object[] pattern_ArrayTypeToClass_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject eTypeToTArrayClass, EObject eModelToTypeGraph, EObject eTypeAccess,
			EObject eArrayType, EObject eType, EObject typeGraph, EObject tArrayClass, EObject eModel) {
	...
	public static final Object[] pattern_ArrayTypeToClass_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject eTypeAccess, EObject eArrayType, EObject eType, EObject eModel) {
		EMoflonEdge eArrayType__eTypeAccess____elementType = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eTypeAccess__eType____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eType__eTypeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eModel__eArrayType____orphanTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		eType__eTypeAccess____usagesInTypeAccess.setName(eType__eTypeAccess____usagesInTypeAccess_name_prime);
		eModel__eArrayType____orphanTypes.setName(eModel__eArrayType____orphanTypes_name_prime);
		return new Object[] { ruleresult, eTypeAccess, eArrayType, eType, eModel,
	...
	public static final void pattern_ArrayTypeToClass_1_5_registerobjects_expressionBBBBBBBBBB(ArrayTypeToClass _this,
			PerformRuleResult ruleresult, EObject eTypeToTArrayClass, EObject eModelToTypeGraph, EObject eTypeAccess,
			EObject eArrayType, EObject eType, EObject typeGraph, EObject tArrayClass, EObject eModel) {
		_this.registerObjects_FWD(ruleresult, eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType, eType,
				typeGraph, tArrayClass, eModel);
		...
		if (tmpETypeAccess instanceof TypeAccess) {
			...
			if (tmpEArrayType instanceof ArrayType) {
				...
				if (tmpEType instanceof Type) {
					...
					if (tmpEModel instanceof Model) {
						Model eModel = (Model) tmpEModel;
						return new Object[] { eTypeAccess, eArrayType, eType, eModel, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToClass_2_2_corematch_blackFFBBBFFBB(TypeAccess eTypeAccess,
			ArrayType eArrayType, Type eType, Model eModel, Match match) {
			...
			for (TypeToTAbstractType eTypeToTArrayClass : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tArrayClass != null) {
					for (ModelToTypeGraph eModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (typeGraph != null) {
							_result.add(new Object[] { eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType,
									eType, typeGraph, tArrayClass, eModel, match });
						}
								...
								if (eType.equals(eTypeAccess.getType())) {
									if (eModel.equals(eModelToTypeGraph.getSource())) {
										if (eModel.getOrphanTypes().contains(eArrayType)) {
											_result.add(new Object[] { eTypeToTArrayClass, eModelToTypeGraph,
													eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel });
										}
									}
								}
							}
	...
	public static final Object[] pattern_ArrayTypeToClass_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(
		...
		eModel__eArrayType____orphanTypes.setName(eModel__eArrayType____orphanTypes_name_prime);
		return new Object[] { eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType, eType, typeGraph,
				tArrayClass, eModel, isApplicableMatch, eArrayType__eTypeAccess____elementType,
				eModelToTypeGraph__typeGraph____target, eTypeToTArrayClass__eType____source,
				eTypeToTArrayClass__tArrayClass____target, typeGraph__tArrayClass____ownedTypes,
				tArrayClass__typeGraph____pg, eTypeAccess__eType____type, eType__eTypeAccess____usagesInTypeAccess,
	...
	public static final Object[] pattern_ArrayTypeToClass_2_4_solveCSP_bindingFBBBBBBBBBB(ArrayTypeToClass _this,
			...
			ModelToTypeGraph eModelToTypeGraph, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType,
			TypeGraph typeGraph, TAbstractType tArrayClass, Model eModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eTypeToTArrayClass, eModelToTypeGraph,
				eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess,
					eArrayType, eType, typeGraph, tArrayClass, eModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_ArrayTypeToClass_2_4_solveCSP_binding = pattern_ArrayTypeToClass_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, eTypeToTArrayClass, eModelToTypeGraph, eTypeAccess, eArrayType, eType,
				typeGraph, tArrayClass, eModel);
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_636782 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_636782)) {
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_1B(
		...
		for (Annotation __DEC_eTypeAccess_type_973126 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_269429 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_3BB(
			TypeAccess eTypeAccess, Type eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_584699 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_584699)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_32203 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess eTypeAccess, Type eType) {
		for (ParameterizedType __DEC_eTypeAccess_type_95019 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			if (!eType.equals(__DEC_eTypeAccess_type_95019)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_569019 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_139414 : org.moflon.core.utilities.eMoflonEMFUtil
														...
														if (pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_5BB(
															...
															for (Model eModel : org.moflon.core.utilities.eMoflonEMFUtil
																	.getOppositeReferenceTyped(eArrayType, Model.class,
																			"orphanTypes")) {
																_result.add(new Object[] { eTypeAccess, eArrayType,
																		eType, eModel, _edge_elementType });
															}
														}
													}
												}
	...
	public static final boolean pattern_ArrayTypeToClass_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ArrayTypeToClass _this, Match match, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType,
			Model eModel) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, eTypeAccess, eArrayType, eType, eModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_bindingFFFFFFBB(Match sourceMatch,
		...
		EObject _localVariable_1 = sourceMatch.getObject("eArrayType");
				...
				if (tmpEType instanceof Type) {
					...
					if (tmpTypeGraph instanceof TypeGraph) {
						...
						if (tmpTArrayClass instanceof TAbstractType) {
							...
							if (tmpEModel instanceof Model) {
								Model eModel = (Model) tmpEModel;
								return new Object[] { eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_blackBBBBBBBB(TypeAccess eTypeAccess,
			ArrayType eArrayType, Type eType, TypeGraph typeGraph, TAbstractType tArrayClass, Model eModel,
			Match sourceMatch, Match targetMatch) {
		if (!eArrayType.equals(eType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_binding != null) {
			TypeAccess eTypeAccess = (TypeAccess) result_pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_binding[0];
			ArrayType eArrayType = (ArrayType) result_pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_binding[1];
			Type eType = (Type) result_pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_binding[2];
			...
			Object[] result_pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_black = pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_blackBBBBBBBB(
					eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ArrayTypeToClass_21_3_solvecsp_bindingFBBBBBBBBB(ArrayTypeToClass _this,
			TypeAccess eTypeAccess, ArrayType eArrayType, Type eType, TypeGraph typeGraph, TAbstractType tArrayClass,
			Model eModel, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(eTypeAccess, eArrayType, eType, typeGraph, tArrayClass,
				eModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			ArrayTypeToClass _this, TypeAccess eTypeAccess, ArrayType eArrayType, Type eType, TypeGraph typeGraph,
		...
		Object[] result_pattern_ArrayTypeToClass_21_3_solvecsp_binding = pattern_ArrayTypeToClass_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToClass_21_5_matchcorrcontext_blackFFBBBBBB(Type eType,
			...
			for (ModelToTypeGraph eModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (eModel.equals(eModelToTypeGraph.getSource())) {
					for (TypeToTAbstractType eTypeToTArrayClass : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(eType, TypeToTAbstractType.class, "source")) {
						if (tArrayClass.equals(eTypeToTArrayClass.getTarget())) {
							_result.add(new Object[] { eTypeToTArrayClass, eModelToTypeGraph, eType, typeGraph,
	...
	public static final Object[] pattern_ArrayTypeToClass_21_6_createcorrespondence_blackBBBBBBB(TypeAccess eTypeAccess,
			ArrayType eArrayType, Type eType, TypeGraph typeGraph, TAbstractType tArrayClass, Model eModel,
			CCMatch ccMatch) {
		if (!eArrayType.equals(eType)) {
			return new Object[] { eTypeAccess, eArrayType, eType, typeGraph, tArrayClass, eModel, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_0BB(TypeAccess eTypeAccess,
			Type eType) {
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_430493 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_430493)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_1B(TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_751606 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_2B(TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_309021 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_3BB(TypeAccess eTypeAccess,
			Type eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_664301 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_664301)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_4B(TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_967404 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_5BB(TypeAccess eTypeAccess,
			Type eType) {
		for (ParameterizedType __DEC_eTypeAccess_type_617959 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			if (!eType.equals(__DEC_eTypeAccess_type_617959)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_6B(TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_911368 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_7B(TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_187646 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_blackBBBB(TypeAccess eTypeAccess,
			ArrayType eArrayType, Type eType, Model eModel) {
		if (!eArrayType.equals(eType)) {
			if (eTypeAccess.equals(eArrayType.getElementType())) {
				if (eType.equals(eTypeAccess.getType())) {
					if (eModel.getOrphanTypes().contains(eArrayType)) {
											...
											if (pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_5BB(eTypeAccess,
												...
												if (pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_6B(
													...
													if (pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_7B(
															eTypeAccess) == null) {
														return new Object[] { eTypeAccess, eArrayType, eType, eModel };
													}
												}
											}
										}
	...
	public static final Object[] pattern_ArrayTypeToClass_26_3_solveCSP_bindingFBBBBBBBBB(ArrayTypeToClass _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, eTypeToTArrayClass,
				eModelToTypeGraph, eType, typeGraph, tArrayClass, eModel, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eTypeToTArrayClass, eModelToTypeGraph, eType,
					typeGraph, tArrayClass, eModel, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ArrayTypeToClass_26_3_solveCSP_binding = pattern_ArrayTypeToClass_26_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eTypeToTArrayClass, eModelToTypeGraph, eType, typeGraph, tArrayClass, eModel,
				ruleResult);
	...
	public static final Object[] pattern_ArrayTypeToClass_26_5_checknacs_blackBBBBBB(
			TypeToTAbstractType eTypeToTArrayClass, ModelToTypeGraph eModelToTypeGraph, Type eType, TypeGraph typeGraph,
			TAbstractType tArrayClass, Model eModel) {
		return new Object[] { eTypeToTArrayClass, eModelToTypeGraph, eType, typeGraph, tArrayClass, eModel };
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_26_6_perform_greenFFBBB(Type eType, Model eModel,
		...
		return new Object[] { eTypeAccess, eArrayType, eType, eModel, ruleResult };
	}
