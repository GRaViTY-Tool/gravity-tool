...
public class ConstructorDefinitionImpl extends AbstractRuleImpl implements ConstructorDefinition {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_244(EMoflonEdge _edge_definitions) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_253(EMoflonEdge _edge_mDefinitions) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CONSTRUCTOR_DEFINITION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_244__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_244((EMoflonEdge) arguments.get(0));
		case RulesPackage.CONSTRUCTOR_DEFINITION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_253__EMOFLONEDGE:
	...
	public static final Object[] pattern_ConstructorDefinition_11_1_performtransformation_greenFBFFFB(
		...
		MDefinitionToTMember mDefinitionToTMember = ModiscoFactory.eINSTANCE.createMDefinitionToTMember();
		MConstructorDefinition mDefinition = org.gravity.modisco.ModiscoFactory.eINSTANCE
	...
	public static final Iterable<Object[]> pattern_ConstructorDefinition_12_2_corematch_blackBBFBFB(
		...
		for (MSignatureToTSignature mSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMSignature instanceof MMethodSignature) {
				MMethodSignature mSignature = (MMethodSignature) tmpMSignature;
				_result.add(new Object[] { tAnnotation, tMethodSignature, mSignatureToTMethodSignature, tDefinition,
						mSignature, match });
			}
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_660263 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_660263 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_660263)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_660263)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tDefinition_signature_534351 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_534351 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_534351)) {
	...
	public static final Object[] pattern_ConstructorDefinition_20_2_testcorematchandDECs_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_837791 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_837791 != null) {
	...
	public static final Object[] pattern_ConstructorDefinition_21_2_testcorematchandDECs_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_377792 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_377792 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_377792)) {
	...
	public static final Object[] pattern_ConstructorDefinition_27_1_matchtggpattern_black_nac_0BB(
			MConstructorDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_883111 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_883111 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_883111)) {
				return new Object[] { mDefinition, mSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_0BBB(
			TConstructor tAnnotation, TMethodSignature tMethodSignature, TMethodDefinition tDefinition) {
		TAnnotatable __DEC_tAnnotation_tAnnotated_576633 = tAnnotation.getTAnnotated();
		if (__DEC_tAnnotation_tAnnotated_576633 != null) {
			if (!tMethodSignature.equals(__DEC_tAnnotation_tAnnotated_576633)) {
				if (!tDefinition.equals(__DEC_tAnnotation_tAnnotated_576633)) {
					return new Object[] { tAnnotation, tMethodSignature, tDefinition };
				}
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_1BB(
			TMethodDefinition tDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tDefinition_signature_218454 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_218454 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_218454)) {
				return new Object[] { tDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_ConstructorDefinition_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tDefinition) {
		TAbstractType __DEC_tDefinition_returnType_167537 = tDefinition.getReturnType();
		if (__DEC_tDefinition_returnType_167537 != null) {
			return new Object[] { tDefinition };
		}
