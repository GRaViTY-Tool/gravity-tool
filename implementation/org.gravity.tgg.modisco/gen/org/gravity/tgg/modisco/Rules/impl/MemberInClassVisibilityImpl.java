...
public class MemberInClassVisibilityImpl extends AbstractRuleImpl implements MemberInClassVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_1_performtransformation_greenFFBBB(mModifier, tMember, csp);
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tModifier,
						mModifierToTModifier, mDefinition, mModifier, tClass, mTypeToTType, tMember, mClass,
						defToMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tClass] = " + tClass + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tMember] = "
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				tModifier, mModifierToTModifier, mDefinition, mModifier, tMember);
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tModifier, mModifierToTModifier, mDefinition, mModifier, tClass, mTypeToTType, tMember,
				mClass, defToMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_2_2_corematch_blackBBFFFBFB(mDefinition, mModifier, mClass, match)) {
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(mDefinition, mModifier, tClass,
							mTypeToTType, tMember, mClass, defToMember)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mDefinition, mModifier,
								tClass, mTypeToTType, tMember, mClass, defToMember);
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mDefinition, mModifier, tClass, mTypeToTType, tMember, mClass, defToMember);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition,
			Modifier mModifier, TClass tClass, TypeToTAbstractType mTypeToTType, TMember tMember,
			ClassDeclaration mClass, MDefinitionToTMember defToMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tModifier, EObject mModifierToTModifier,
			EObject mDefinition, EObject mModifier, EObject tClass, EObject mTypeToTType, EObject tMember,
			EObject mClass, EObject defToMember) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_11_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, tModifier, mModifierToTModifier, mDefinition, mModifier, tMember);
		//nothing EMoflonEdge mModifierToTModifier__tModifier____target = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge mDefinition__mModifier____modifier = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mModifier__mDefinition____bodyDeclaration = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge tMember__tModifier____tModifier = (EMoflonEdge) result3_green[9];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_12_2_corematch_blackBFBFBFFB(tModifier, tClass, tMember, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_12_3_findcontext_blackBBBBBBB(tModifier, mDefinition, tClass,
							mTypeToTType, tMember, mClass, defToMember)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tModifier, mDefinition,
								tClass, mTypeToTType, tMember, mClass, defToMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, tModifier, mDefinition, tClass, mTypeToTType, tMember, mClass,
								defToMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TModifier tModifier,
			MDefinition mDefinition, TClass tClass, TypeToTAbstractType mTypeToTType, TMember tMember,
			ClassDeclaration mClass, MDefinitionToTMember defToMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tModifier, EObject mModifierToTModifier,
			EObject mDefinition, EObject mModifier, EObject tClass, EObject mTypeToTType, EObject tMember,
			EObject mClass, EObject defToMember) {
		ruleresult.registerObject("tModifier", tModifier);
		ruleresult.registerObject("mModifierToTModifier", mModifierToTModifier);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_193(EMoflonEdge _edge_tModifier) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_199(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tModifier, mDefinition,
						mModifier, tClass, tMember, mClass, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tModifier] = " + tModifier + ", " + "[mDefinition] = " + mDefinition + ", " + "[mModifier] = "
					+ mModifier + ", " + "[tClass] = " + tClass + ", " + "[tMember] = " + tMember + ", " + "[mClass] = "
		...
		if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackBBFBBFBB(mDefinition, tClass, tMember,
				...
				Object[] result6_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(tModifier, mDefinition,
								mModifier, tClass, tMember, mClass, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tModifier] = "
							+ tModifier + ", " + "[mDefinition] = " + mDefinition + ", " + "[mModifier] = " + mModifier
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TModifier tModifier, MDefinition mDefinition, Modifier mModifier, TClass tClass,
			TMember tMember, ClassDeclaration mClass, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mDefinition, tClass, mTypeToTType, tMember, mClass, defToMember, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition + ", "
						+ "[tClass] = " + tClass + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tMember] = "
			...
			if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(mDefinition, tClass, mTypeToTType,
								tMember, mClass, defToMember);
				if (result5_black != null) {

					Object[] result6_black = MemberInClassVisibilityImpl
							.pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(mDefinition, tClass,
									mTypeToTType, tMember, mClass, defToMember, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mDefinition] = "
								+ mDefinition + ", " + "[tClass] = " + tClass + ", " + "[mTypeToTType] = "
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition, TClass tClass,
			TypeToTAbstractType mTypeToTType, TMember tMember, ClassDeclaration mClass,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MDEFINITION_MODIFIER_TCLASS_TYPETOTABSTRACTTYPE_TMEMBER_CLASSDECLARATION_MDEFINITIONTOTMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (MDefinition) arguments.get(1),
					(Modifier) arguments.get(2), (TClass) arguments.get(3), (TypeToTAbstractType) arguments.get(4),
					(TMember) arguments.get(5), (ClassDeclaration) arguments.get(6),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMODIFIER_MDEFINITION_TCLASS_TYPETOTABSTRACTTYPE_TMEMBER_CLASSDECLARATION_MDEFINITIONTOTMEMBER:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_193__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_193((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_199__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__TMODIFIER_MDEFINITION_MODIFIER_TCLASS_TMEMBER_CLASSDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TModifier) arguments.get(0), (MDefinition) arguments.get(1),
					(Modifier) arguments.get(2), (TClass) arguments.get(3), (TMember) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_TCLASS_TYPETOTABSTRACTTYPE_TMEMBER_CLASSDECLARATION_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (MDefinition) arguments.get(1),
					(TClass) arguments.get(2), (TypeToTAbstractType) arguments.get(3), (TMember) arguments.get(4),
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpMClass instanceof ClassDeclaration) {
								...
								if (tmpDefToMember instanceof MDefinitionToTMember) {
									...
									return new Object[] { mDefinition, mModifier, tClass, mTypeToTType, tMember, mClass,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			MDefinition mDefinition, Modifier mModifier, TClass tClass, TypeToTAbstractType mTypeToTType,
			TMember tMember, ClassDeclaration mClass, MDefinitionToTMember defToMember, MemberInClassVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinition, mModifier, tClass, mTypeToTType, tMember, mClass, defToMember, csp,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_1_1_performtransformation_black = pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mDefinition, mModifier, tClass, mTypeToTType, tMember, mClass, defToMember, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_greenFFBBB(
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject mModifier, EObject tClass, EObject mTypeToTType, EObject tMember, EObject mClass,
			EObject defToMember) {
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, tModifier, mModifierToTModifier, mDefinition, mModifier, tMember,
	...
	public static final void pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInClassVisibility _this, PerformRuleResult ruleresult, EObject tModifier,
			EObject mModifierToTModifier, EObject mDefinition, EObject mModifier, EObject tClass, EObject mTypeToTType,
			EObject tMember, EObject mClass, EObject defToMember) {
		_this.registerObjects_FWD(ruleresult, tModifier, mModifierToTModifier, mDefinition, mModifier, tClass,
				mTypeToTType, tMember, mClass, defToMember);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_2_2_corematch_blackBBFFFBFB(
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTClass instanceof TClass) {
						TClass tClass = (TClass) tmpTClass;
						_result.add(new Object[] { mDefinition, mModifier, tClass, mTypeToTType, tMember, mClass,
								defToMember, match });
					}
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(
			MDefinition mDefinition, Modifier mModifier, TClass tClass, TypeToTAbstractType mTypeToTType,
			TMember tMember, ClassDeclaration mClass, MDefinitionToTMember defToMember) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
						...
						if (mDefinition.equals(defToMember.getSource())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (mClass.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { mDefinition, mModifier, tClass, mTypeToTType, tMember,
											mClass, defToMember });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mDefinition, mModifier, tClass, mTypeToTType, tMember, mClass, defToMember,
				...
				defToMember__mDefinition____source, defToMember__tMember____target, mTypeToTType__mClass____source };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mDefinition, mModifier, tClass,
				mTypeToTType, tMember, mClass, defToMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, mModifier, tClass, mTypeToTType, tMember,
					mClass, defToMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_2_4_solveCSP_binding = pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, mModifier, tClass, mTypeToTType, tMember, mClass, defToMember);
		if (result_pattern_MemberInClassVisibility_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mDefinition, mModifier, tClass, mTypeToTType,
						tMember, mClass, defToMember };
			}
		}
		return null;
					...
					if (tmpMTypeToTType instanceof TypeToTAbstractType) {
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpMClass instanceof ClassDeclaration) {
								...
								if (tmpDefToMember instanceof MDefinitionToTMember) {
									MDefinitionToTMember defToMember = (MDefinitionToTMember) tmpDefToMember;
									return new Object[] { tModifier, mDefinition, tClass, mTypeToTType, tMember, mClass,
											defToMember, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TModifier tModifier, MDefinition mDefinition, TClass tClass, TypeToTAbstractType mTypeToTType,
			TMember tMember, ClassDeclaration mClass, MDefinitionToTMember defToMember, MemberInClassVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tModifier, mDefinition, tClass, mTypeToTType, tMember, mClass, defToMember, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_11_1_performtransformation_binding != null) {
			...
			TClass tClass = (TClass) result_pattern_MemberInClassVisibility_11_1_performtransformation_binding[2];
			...
			TMember tMember = (TMember) result_pattern_MemberInClassVisibility_11_1_performtransformation_binding[4];
			...
			Object[] result_pattern_MemberInClassVisibility_11_1_performtransformation_black = pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					tModifier, mDefinition, tClass, mTypeToTType, tMember, mClass, defToMember, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInClassVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mModifierToTModifier, EObject mDefinition, EObject mModifier, EObject tClass, EObject mTypeToTType,
			EObject tMember, EObject mClass, EObject defToMember) {
		_this.registerObjects_BWD(ruleresult, tModifier, mModifierToTModifier, mDefinition, mModifier, tClass,
				mTypeToTType, tMember, mClass, defToMember);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_12_2_corematch_blackBFBFBFFB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMClass instanceof ClassDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tModifier, mDefinition, tClass, mTypeToTType, tMember, mClass,
								defToMember, match });
					}
				...
				if (tClass.getDefines().contains(tMember)) {
					if (tClass.equals(mTypeToTType.getTarget())) {
						if (mDefinition.equals(defToMember.getSource())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (mClass.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { tModifier, mDefinition, tClass, mTypeToTType, tMember,
											mClass, defToMember });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		mTypeToTType__mClass____source.setName(mTypeToTType__mClass____source_name_prime);
		return new Object[] { tModifier, mDefinition, tClass, mTypeToTType, tMember, mClass, defToMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch, TModifier tModifier,
			MDefinition mDefinition, TClass tClass, TypeToTAbstractType mTypeToTType, TMember tMember,
			ClassDeclaration mClass, MDefinitionToTMember defToMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tModifier, mDefinition, tClass,
				mTypeToTType, tMember, mClass, defToMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tModifier, mDefinition, tClass, mTypeToTType, tMember,
					mClass, defToMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_12_4_solveCSP_binding = pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tModifier, mDefinition, tClass, mTypeToTType, tMember, mClass, defToMember);
		if (result_pattern_MemberInClassVisibility_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tModifier, mDefinition, tClass, mTypeToTType,
						tMember, mClass, defToMember };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_488975 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_488975)) {
				...
				if (tmpMModifier instanceof Modifier) {
					...
					if (tmpTClass instanceof TClass) {
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpMClass instanceof ClassDeclaration) {
								ClassDeclaration mClass = (ClassDeclaration) tmpMClass;
								return new Object[] { tModifier, mDefinition, mModifier, tClass, tMember, mClass,
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			TModifier tModifier, MDefinition mDefinition, Modifier mModifier, TClass tClass, TMember tMember,
			ClassDeclaration mClass, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tModifier, mDefinition, mModifier, tClass, tMember, mClass, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			TMember tMember = (TMember) result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tModifier, mDefinition, mModifier, tClass, tMember, mClass, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, TModifier tModifier, MDefinition mDefinition, Modifier mModifier,
			TClass tClass, TMember tMember, ClassDeclaration mClass, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tModifier, mDefinition, mModifier, tClass, tMember,
				mClass, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tModifier, mDefinition, mModifier, tClass, tMember, mClass, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_24_3_solvecsp_binding = pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tModifier, mDefinition, mModifier, tClass, tMember, mClass, sourceMatch, targetMatch);
		if (result_pattern_MemberInClassVisibility_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tModifier, mDefinition, mModifier, tClass, tMember, mClass,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackBBFBBFBB(
			MDefinition mDefinition, TClass tClass, TMember tMember, ClassDeclaration mClass, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mClass.equals(mTypeToTType.getSource())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { mDefinition, tClass, mTypeToTType, tMember, mClass, defToMember,
									sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { tModifier, mDefinition, mModifier, tClass, tMember, mClass, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_17860 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_17860)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, IsApplicableMatch isApplicableMatch, MDefinition mDefinition, TClass tClass,
			TypeToTAbstractType mTypeToTType, TMember tMember, ClassDeclaration mClass,
			MDefinitionToTMember defToMember, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mDefinition, tClass, mTypeToTType,
				tMember, mClass, defToMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, tClass, mTypeToTType, tMember, mClass,
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_29_3_solveCSP_binding = pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, tClass, mTypeToTType, tMember, mClass, defToMember, ruleResult);
	...
	public static final Object[] pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(MDefinition mDefinition,
			TClass tClass, TypeToTAbstractType mTypeToTType, TMember tMember, ClassDeclaration mClass,
			MDefinitionToTMember defToMember) {
		return new Object[] { mDefinition, tClass, mTypeToTType, tMember, mClass, defToMember };
	}

	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(MDefinition mDefinition,
			TClass tClass, TypeToTAbstractType mTypeToTType, TMember tMember, ClassDeclaration mClass,
			MDefinitionToTMember defToMember, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mDefinition, tClass, mTypeToTType, tMember, mClass, defToMember, ruleResult };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_greenFFBFBBB(MDefinition mDefinition,
		...
		return new Object[] { tModifier, mModifierToTModifier, mDefinition, mModifier, tMember, ruleResult, csp };
	}
