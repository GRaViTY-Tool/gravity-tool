...
public class ClassInnerClassMemberImpl extends AbstractRuleImpl implements ClassInnerClassMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ClassInnerClassMemberImpl
				.pattern_ClassInnerClassMember_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(ruleresult,
						tInnerTypeToTInnerAbstractType, typeGraph, mInnerClass, eOuterClass, tInnerPackage, mDefinition,
		...
		ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
				ruleresult, tInnerTypeToTInnerAbstractType, typeGraph, mInnerClass, tInnerPackage, mDefinition,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ClassInnerClassMemberImpl.pattern_ClassInnerClassMember_2_2_corematch_blackBBBFFB(
			...
			for (Object[] result3_black : ClassInnerClassMemberImpl
					.pattern_ClassInnerClassMember_2_3_findcontext_blackFBBBBBF(mInnerClass, eOuterClass, mDefinition,
				...
				Object[] result4_bindingAndBlack = ClassInnerClassMemberImpl
						.pattern_ClassInnerClassMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								typeGraph, mInnerClass, eOuterClass, mDefinition, tOuterClass, eOuterClassToTOuterClass,
								tOuterPackage);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType,
			EObject typeGraph, EObject mInnerClass, EObject eOuterClass, EObject tInnerPackage, EObject mDefinition,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_210(EMoflonEdge _edge_classes) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEGRAPH_MCLASS_CLASSDECLARATION_MABSTRACTMETHODDEFINITION_TCLASS_TYPETOTABSTRACTTYPE_TPACKAGE:
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_210__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_210((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_217__EMOFLONEDGE:
		...
		case RulesPackage.CLASS_INNER_CLASS_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__TYPEGRAPH_MCLASS_CLASSDECLARATION_TPACKAGE_MABSTRACTMETHODDEFINITION_TCLASS_TCLASS_TPACKAGE_MATCH_MATCH:
						...
						if (tmpTOuterClass instanceof TClass) {
							...
							if (tmpEOuterClassToTOuterClass instanceof TypeToTAbstractType) {
								...
								if (tmpTOuterPackage instanceof TPackage) {
									...
									return new Object[] { typeGraph, mInnerClass, eOuterClass, mDefinition, tOuterClass,
	...
	public static final Object[] pattern_ClassInnerClassMember_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(
			...
			EObject mInnerClass, EObject eOuterClass, EObject tInnerPackage, EObject mDefinition, EObject tOuterClass,
	...
	public static final Object[] pattern_ClassInnerClassMember_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject tInnerTypeToTInnerAbstractType, EObject typeGraph,
			EObject mInnerClass, EObject tInnerPackage, EObject mDefinition, EObject tOuterClass, EObject tInnerClass,
			EObject tInnerClassToTInnerClass, EObject tOuterPackage) {
						...
						if (mDefinition.getMInnerTypes().contains(mInnerClass)) {
							...
							if (typeGraph != null) {
								...
								if (tOuterPackage != null) {
									_result.add(new Object[] { typeGraph, mInnerClass, eOuterClass, mDefinition,
											tOuterClass, eOuterClassToTOuterClass, tOuterPackage });
								}
	...
	public static final Object[] pattern_ClassInnerClassMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mDefinition__mInnerClass____mInnerTypes.setName(mDefinition__mInnerClass____mInnerTypes_name_prime);
		return new Object[] { typeGraph, mInnerClass, eOuterClass, mDefinition, tOuterClass, eOuterClassToTOuterClass,
	...
	public static final Object[] pattern_ClassInnerClassMember_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, typeGraph, mInnerClass, eOuterClass, mDefinition,
					tOuterClass, eOuterClassToTOuterClass, tOuterPackage };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassInnerClassMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ClassInnerClassMember_2_4_solveCSP_binding = pattern_ClassInnerClassMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, typeGraph, mInnerClass, eOuterClass, mDefinition, tOuterClass,
				eOuterClassToTOuterClass, tOuterPackage);
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TypeGraph __DEC_tInnerPackage_typeGraph_17230 = tInnerPackage.getTypeGraph();
		if (__DEC_tInnerPackage_typeGraph_17230 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_typeGraph_17230)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_1BB(
		...
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerPackage_subpackage_609231 = tInnerPackage.getParent();
			if (__DEC_tInnerPackage_subpackage_609231 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerPackage_subpackage_609231)) {
					if (!tOuterPackage.equals(__DEC_tInnerPackage_subpackage_609231)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_2BB(
			TPackage tInnerPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tInnerPackage_packages_26917 = tInnerPackage.getPg();
		if (__DEC_tInnerPackage_packages_26917 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_packages_26917)) {
				return new Object[] { tInnerPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_3BBB(
		...
		if (!tInnerPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tInnerClass_classes_756097 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tInnerClass, TPackage.class, "classes")) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_classes_756097)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_classes_756097)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_4BB(
		...
		for (TypeGraph __DEC_tInnerClass_classes_133093 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tInnerClass_classes_133093)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_5BBB(
			TClass tInnerClass, TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerClass_ownedTypes_284707 = tInnerClass.getPackage();
			if (__DEC_tInnerClass_ownedTypes_284707 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_ownedTypes_284707)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_ownedTypes_284707)) {
						return new Object[] { tInnerClass, tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_20_2_testcorematchandDECs_black_nac_6BB(
		...
		if (!tInnerClass.equals(tOuterClass)) {
			TAbstractType __DEC_tInnerClass_innerTypes_811768 = tInnerClass.getOuterType();
			if (__DEC_tInnerClass_innerTypes_811768 != null) {
				if (!tInnerClass.equals(__DEC_tInnerClass_innerTypes_811768)) {
					if (!tOuterClass.equals(__DEC_tInnerClass_innerTypes_811768)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_0BB(
		...
		if (!eOuterClass.equals(mInnerClass)) {
			AbstractTypeDeclaration __DEC_mInnerClass_abstractTypeDeclaration_209549 = mInnerClass
					.getAbstractTypeDeclaration();
			if (__DEC_mInnerClass_abstractTypeDeclaration_209549 != null) {
				if (!mInnerClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_209549)) {
					if (!eOuterClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_209549)) {
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_1B(
			MClass mInnerClass) {
		AnonymousClassDeclaration __DEC_mInnerClass_anonymousClassDeclarationOwner_785662 = mInnerClass
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mInnerClass_anonymousClassDeclarationOwner_785662 != null) {
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_2B(
			MClass mInnerClass) {
		for (Model __DEC_mInnerClass_orphanTypes_303379 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_3B(
			MClass mInnerClass) {
		org.eclipse.modisco.java.Package __DEC_mInnerClass_ownedElements_873759 = mInnerClass.getPackage();
		if (__DEC_mInnerClass_ownedElements_873759 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_21_2_testcorematchandDECs_black_nac_4BB(
			MClass mInnerClass, MAbstractMethodDefinition mDefinition) {
		for (MAbstractMethodDefinition __DEC_mInnerClass_mInnerTypes_780300 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, MAbstractMethodDefinition.class, "mInnerTypes")) {
			if (!mDefinition.equals(__DEC_mInnerClass_mInnerTypes_780300)) {
								...
								if (tmpTInnerClass instanceof TClass) {
									...
									if (tmpTOuterPackage instanceof TPackage) {
										...
										return new Object[] { typeGraph, mInnerClass, eOuterClass, tInnerPackage,
												mDefinition, tOuterClass, tInnerClass, tOuterPackage, targetMatch,
												sourceMatch };
									}
								}
							}
			...
			if (!tInnerPackage.equals(tOuterPackage)) {
				if (!tInnerClass.equals(tOuterClass)) {
					if (!sourceMatch.equals(targetMatch)) {
						return new Object[] { typeGraph, mInnerClass, eOuterClass, tInnerPackage, mDefinition,
	...
	public static final Object[] pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_black = pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_blackBBBBBBBBBB(
					typeGraph, mInnerClass, eOuterClass, tInnerPackage, mDefinition, tOuterClass, tInnerClass,
					tOuterPackage, sourceMatch, targetMatch);
			if (result_pattern_ClassInnerClassMember_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { typeGraph, mInnerClass, eOuterClass, tInnerPackage, mDefinition, tOuterClass,
	...
	public static final Object[] pattern_ClassInnerClassMember_24_3_solvecsp_bindingFBBBBBBBBBBB(
		...
		if (csp != null) {
			return new Object[] { csp, _this, typeGraph, mInnerClass, eOuterClass, tInnerPackage, mDefinition,
					tOuterClass, tInnerClass, tOuterPackage, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassInnerClassMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_ClassInnerClassMember_24_3_solvecsp_binding = pattern_ClassInnerClassMember_24_3_solvecsp_bindingFBBBBBBBBBBB(
				_this, typeGraph, mInnerClass, eOuterClass, tInnerPackage, mDefinition, tOuterClass, tInnerClass,
				tOuterPackage, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_0BB(MClass mInnerClass,
		...
		if (!eOuterClass.equals(mInnerClass)) {
			AbstractTypeDeclaration __DEC_mInnerClass_abstractTypeDeclaration_546288 = mInnerClass
					.getAbstractTypeDeclaration();
			if (__DEC_mInnerClass_abstractTypeDeclaration_546288 != null) {
				if (!mInnerClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_546288)) {
					if (!eOuterClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_546288)) {
						return new Object[] { mInnerClass, eOuterClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_1B(MClass mInnerClass) {
		AnonymousClassDeclaration __DEC_mInnerClass_anonymousClassDeclarationOwner_234926 = mInnerClass
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mInnerClass_anonymousClassDeclarationOwner_234926 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_2B(MClass mInnerClass) {
		for (Model __DEC_mInnerClass_orphanTypes_656112 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, Model.class, "orphanTypes")) {
			return new Object[] { mInnerClass };
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_3B(MClass mInnerClass) {
		org.eclipse.modisco.java.Package __DEC_mInnerClass_ownedElements_148097 = mInnerClass.getPackage();
		if (__DEC_mInnerClass_ownedElements_148097 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_27_1_matchtggpattern_black_nac_4BB(MClass mInnerClass,
			MAbstractMethodDefinition mDefinition) {
		for (MAbstractMethodDefinition __DEC_mInnerClass_mInnerTypes_912568 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, MAbstractMethodDefinition.class, "mInnerTypes")) {
			if (!mDefinition.equals(__DEC_mInnerClass_mInnerTypes_912568)) {
				return new Object[] { mInnerClass, mDefinition };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_0BB(
			TPackage tInnerPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tInnerPackage_typeGraph_78822 = tInnerPackage.getTypeGraph();
		if (__DEC_tInnerPackage_typeGraph_78822 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_typeGraph_78822)) {
				return new Object[] { tInnerPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_1BB(
			TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerPackage_subpackage_790139 = tInnerPackage.getParent();
			if (__DEC_tInnerPackage_subpackage_790139 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerPackage_subpackage_790139)) {
					if (!tOuterPackage.equals(__DEC_tInnerPackage_subpackage_790139)) {
						return new Object[] { tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_2BB(
			TPackage tInnerPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tInnerPackage_packages_434698 = tInnerPackage.getPg();
		if (__DEC_tInnerPackage_packages_434698 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_packages_434698)) {
				return new Object[] { tInnerPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_3BBB(TClass tInnerClass,
			TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tInnerClass_classes_885118 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tInnerClass, TPackage.class, "classes")) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_classes_885118)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_classes_885118)) {
						return new Object[] { tInnerClass, tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_4BB(TClass tInnerClass,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tInnerClass_classes_698229 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tInnerClass_classes_698229)) {
				return new Object[] { tInnerClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_5BBB(TClass tInnerClass,
			TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerClass_ownedTypes_588272 = tInnerClass.getPackage();
			if (__DEC_tInnerClass_ownedTypes_588272 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_ownedTypes_588272)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_ownedTypes_588272)) {
						return new Object[] { tInnerClass, tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_28_1_matchtggpattern_black_nac_6BB(TClass tInnerClass,
			TClass tOuterClass) {
		if (!tInnerClass.equals(tOuterClass)) {
			TAbstractType __DEC_tInnerClass_innerTypes_1017 = tInnerClass.getOuterType();
			if (__DEC_tInnerClass_innerTypes_1017 != null) {
				if (!tInnerClass.equals(__DEC_tInnerClass_innerTypes_1017)) {
					if (!tOuterClass.equals(__DEC_tInnerClass_innerTypes_1017)) {
						return new Object[] { tInnerClass, tOuterClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerClassMember_29_6_perform_greenFBFFBBFFBBB(TypeGraph typeGraph,
		...
		return new Object[] { tInnerTypeToTInnerAbstractType, typeGraph, mInnerClass, tInnerPackage, mDefinition,
