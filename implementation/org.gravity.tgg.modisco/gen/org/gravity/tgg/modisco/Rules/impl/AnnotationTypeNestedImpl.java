...
public class AnnotationTypeNestedImpl extends AbstractRuleImpl implements AnnotationTypeNested {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_233(EMoflonEdge _edge_ownedTypes) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_241(EMoflonEdge _edge_abstractTypeDeclaration) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_TYPE_NESTED___IS_APPROPRIATE_BWD_EMOFLON_EDGE_233__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_233((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_TYPE_NESTED___IS_APPROPRIATE_FWD_EMOFLON_EDGE_241__EMOFLONEDGE:
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_0BB(
		...
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_318023 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_318023 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_318023)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_318023)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TypeGraph __DEC_tNestedPackage_packages_441269 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_441269 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_441269)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_2BB(
		...
		for (TypeGraph __DEC_tNestedType_tAnnotationTypes_115340 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "tAnnotationTypes")) {
			if (!typeGraph.equals(__DEC_tNestedType_tAnnotationTypes_115340)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_3BBB(
		...
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_141945 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_141945 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_141945)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_141945)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_20_2_testcorematchandDECs_black_nac_4BB(
		...
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_314170 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_314170 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_314170)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_314170)) {
	...
	public static final Object[] pattern_AnnotationTypeNested_21_2_testcorematchandDECs_black_nac_0B(
		...
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_634681 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_634681 != null) {
	...
	public static final Object[] pattern_AnnotationTypeNested_21_2_testcorematchandDECs_black_nac_1B(
			AnnotationTypeDeclaration eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_755566 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeNested_21_2_testcorematchandDECs_black_nac_2B(
			AnnotationTypeDeclaration eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_419593 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_419593 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeNested_21_2_testcorematchandDECs_black_nac_3B(
			AnnotationTypeDeclaration eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_896034 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeNested_27_1_matchtggpattern_black_nac_0B(
			AnnotationTypeDeclaration eNestedType) {
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_919703 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_919703 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeNested_27_1_matchtggpattern_black_nac_1B(
			AnnotationTypeDeclaration eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_121276 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, Model.class, "orphanTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeNested_27_1_matchtggpattern_black_nac_2B(
			AnnotationTypeDeclaration eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_274948 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_274948 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeNested_27_1_matchtggpattern_black_nac_3B(
			AnnotationTypeDeclaration eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_663795 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_0BB(
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_52282 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_52282 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_52282)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_52282)) {
						return new Object[] { tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_1BB(
			TPackage tNestedPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tNestedPackage_packages_569822 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_569822 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_569822)) {
				return new Object[] { tNestedPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_2BB(
			TAnnotationType tNestedType, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_tAnnotationTypes_686086 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "tAnnotationTypes")) {
			if (!typeGraph.equals(__DEC_tNestedType_tAnnotationTypes_686086)) {
				return new Object[] { tNestedType, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_3BBB(
			TAnnotationType tNestedType, TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_944258 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_944258 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_944258)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_944258)) {
						return new Object[] { tNestedType, tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_AnnotationTypeNested_28_1_matchtggpattern_black_nac_4BB(
			TAnnotationType tNestedType, TAbstractType tOuterType) {
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_42567 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_42567 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_42567)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_42567)) {
						return new Object[] { tNestedType, tOuterType };
					}
				}
			}
