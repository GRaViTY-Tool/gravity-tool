...
public class ClassExtendsClassImpl extends AbstractRuleImpl implements ClassExtendsClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ClassDeclarationToTClass eExtendedClassToTExtendedClass = (ClassDeclarationToTClass) result1_bindingAndBlack[1];
		...
		Object[] result3_black = ClassExtendsClassImpl.pattern_ClassExtendsClass_1_3_bookkeepingforedges_blackBBBBBBBB(
				ruleresult, tClass, eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass,
				eTypeAccess, eClassDeclaration, eExtendedClass);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tClass] = " + tClass + ", " + "[eExtendedClassToTExtendedClass] = "
					+ eExtendedClassToTExtendedClass + ", " + "[tExtendedClass] = " + tExtendedClass + ", "
					+ "[eClassDeclarationToTClass] = " + eClassDeclarationToTClass + ", " + "[eTypeAccess] = "
					+ eTypeAccess + ", " + "[eClassDeclaration] = " + eClassDeclaration + ", " + "[eExtendedClass] = "
					+ eExtendedClass + ".");
		}
		ClassExtendsClassImpl.pattern_ClassExtendsClass_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tClass,
				tExtendedClass, eTypeAccess, eClassDeclaration, eExtendedClass);
		//nothing EMoflonEdge tClass__tExtendedClass____parentClass = (EMoflonEdge) result3_green[6];
		...
		ClassExtendsClassImpl.pattern_ClassExtendsClass_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult,
				tClass, eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass, eTypeAccess,
				eClassDeclaration, eExtendedClass);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ClassExtendsClassImpl.pattern_ClassExtendsClass_2_2_corematch_blackFFFFBBBB(
				eTypeAccess, eClassDeclaration, eExtendedClass, match)) {
			TClass tClass = (TClass) result2_black[0];
			ClassDeclarationToTClass eExtendedClassToTExtendedClass = (ClassDeclarationToTClass) result2_black[1];
			...
			for (Object[] result3_black : ClassExtendsClassImpl.pattern_ClassExtendsClass_2_3_findcontext_blackBBBBBBB(
				...
				Object[] result3_green = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_2_3_findcontext_greenBBBBBBBFFFFFFFF(tClass,
								eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass, eTypeAccess,
								eClassDeclaration, eExtendedClass);
				...
				Object[] result4_bindingAndBlack = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tClass, eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass,
								eTypeAccess, eClassDeclaration, eExtendedClass);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ eClassDeclarationToTClass + ", " + "[eTypeAccess] = " + eTypeAccess + ", "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TClass tClass,
			ClassDeclarationToTClass eExtendedClassToTExtendedClass, TClass tExtendedClass,
			ClassDeclarationToTClass eClassDeclarationToTClass, TypeAccess eTypeAccess,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tClass,
			EObject eExtendedClassToTExtendedClass, EObject tExtendedClass, EObject eClassDeclarationToTClass,
			EObject eTypeAccess, EObject eClassDeclaration, EObject eExtendedClass) {
			...
			for (Object[] result3_black : ClassExtendsClassImpl.pattern_ClassExtendsClass_12_3_findcontext_blackBBBBBB(
				...
				Object[] result3_green = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_12_3_findcontext_greenBBBBBBFFFFFFF(tClass,
								eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass,
								eClassDeclaration, eExtendedClass);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
				//nothing EMoflonEdge tClass__tExtendedClass____parentClass = (EMoflonEdge) result3_green[7];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tClass,
			EObject eExtendedClassToTExtendedClass, EObject tExtendedClass, EObject eClassDeclarationToTClass,
			EObject eTypeAccess, EObject eClassDeclaration, EObject eExtendedClass) {
		ruleresult.registerObject("tClass", tClass);
		ruleresult.registerObject("eExtendedClassToTExtendedClass", eExtendedClassToTExtendedClass);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_178(EMoflonEdge _edge_parentClass) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ClassExtendsClassImpl
				.pattern_ClassExtendsClass_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, tClass, tExtendedClass,
						eTypeAccess, eClassDeclaration, eExtendedClass, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tClass] = " + tClass + ", " + "[tExtendedClass] = " + tExtendedClass + ", " + "[eTypeAccess] = "
					+ eTypeAccess + ", " + "[eClassDeclaration] = " + eClassDeclaration + ", " + "[eExtendedClass] = "
		...
		if (ClassExtendsClassImpl.pattern_ClassExtendsClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ClassExtendsClassImpl
					.pattern_ClassExtendsClass_24_5_matchcorrcontext_blackBFBFBBBB(tClass, tExtendedClass,
							eClassDeclaration, eExtendedClass, sourceMatch, targetMatch)) {
				ClassDeclarationToTClass eExtendedClassToTExtendedClass = (ClassDeclarationToTClass) result5_black[1];
				ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result5_black[3];
				...
				Object[] result6_black = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_24_6_createcorrespondence_blackBBBBBB(tClass, tExtendedClass,
								eTypeAccess, eClassDeclaration, eExtendedClass, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TClass tClass, TClass tExtendedClass, TypeAccess eTypeAccess,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : ClassExtendsClassImpl
			...
			Object[] result3_bindingAndBlack = ClassExtendsClassImpl
					.pattern_ClassExtendsClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, tClass,
							eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass,
							eClassDeclaration, eExtendedClass, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tClass] = " + tClass + ", "
						+ "[eExtendedClassToTExtendedClass] = " + eExtendedClassToTExtendedClass + ", "
			...
			if (ClassExtendsClassImpl.pattern_ClassExtendsClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					ClassExtendsClassImpl.pattern_ClassExtendsClass_29_6_perform_greenBBFBBB(tClass, tExtendedClass,
							eClassDeclaration, eExtendedClass, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TCLASS_CLASSDECLARATIONTOTCLASS_TCLASS_CLASSDECLARATIONTOTCLASS_TYPEACCESS_CLASSDECLARATION_CLASSDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TClass) arguments.get(1),
					(ClassDeclarationToTClass) arguments.get(2), (TClass) arguments.get(3),
					(ClassDeclarationToTClass) arguments.get(4), (TypeAccess) arguments.get(5),
					(ClassDeclaration) arguments.get(6), (ClassDeclaration) arguments.get(7));
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TCLASS_CLASSDECLARATIONTOTCLASS_TCLASS_CLASSDECLARATIONTOTCLASS_CLASSDECLARATION_CLASSDECLARATION:
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_183__EMOFLONEDGE:
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__TCLASS_TCLASS_TYPEACCESS_CLASSDECLARATION_CLASSDECLARATION_MATCH_MATCH:
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TCLASS_CLASSDECLARATIONTOTCLASS_TCLASS_CLASSDECLARATIONTOTCLASS_CLASSDECLARATION_CLASSDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpETypeAccess instanceof TypeAccess) {
							...
							if (tmpEClassDeclaration instanceof ClassDeclaration) {
								...
								if (tmpEExtendedClass instanceof ClassDeclaration) {
									...
									return new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass,
											eClassDeclarationToTClass, eTypeAccess, eClassDeclaration, eExtendedClass,
											isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_ClassExtendsClass_1_1_performtransformation_blackBBBBBBBFBB(TClass tClass,
			ClassDeclarationToTClass eExtendedClassToTExtendedClass, TClass tExtendedClass,
			ClassDeclarationToTClass eClassDeclarationToTClass, TypeAccess eTypeAccess,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass, ClassExtendsClass _this,
			IsApplicableMatch isApplicableMatch) {
				...
				if (!eClassDeclaration.equals(eExtendedClass)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass,
									eClassDeclarationToTClass, eTypeAccess, eClassDeclaration, eExtendedClass, csp,
	...
	public static final Object[] pattern_ClassExtendsClass_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_ClassExtendsClass_1_1_performtransformation_binding != null) {
			...
			ClassDeclarationToTClass eExtendedClassToTExtendedClass = (ClassDeclarationToTClass) result_pattern_ClassExtendsClass_1_1_performtransformation_binding[1];
			TClass tExtendedClass = (TClass) result_pattern_ClassExtendsClass_1_1_performtransformation_binding[2];
			ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result_pattern_ClassExtendsClass_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_ClassExtendsClass_1_1_performtransformation_black = pattern_ClassExtendsClass_1_1_performtransformation_blackBBBBBBBFBB(
					tClass, eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass, eTypeAccess,
					eClassDeclaration, eExtendedClass, _this, isApplicableMatch);
			if (result_pattern_ClassExtendsClass_1_1_performtransformation_black != null) {
				...
				return new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass,
						eTypeAccess, eClassDeclaration, eExtendedClass, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject tClass, EObject eExtendedClassToTExtendedClass,
			EObject tExtendedClass, EObject eClassDeclarationToTClass, EObject eTypeAccess, EObject eClassDeclaration,
	...
	public static final Object[] pattern_ClassExtendsClass_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tClass, EObject tExtendedClass, EObject eTypeAccess,
			EObject eClassDeclaration, EObject eExtendedClass) {
		...
		eExtendedClass__eTypeAccess____usagesInTypeAccess
				.setName(eExtendedClass__eTypeAccess____usagesInTypeAccess_name_prime);
		eClassDeclaration__eTypeAccess____superClass.setName(eClassDeclaration__eTypeAccess____superClass_name_prime);
		return new Object[] { ruleresult, tClass, tExtendedClass, eTypeAccess, eClassDeclaration, eExtendedClass,
	...
	public static final void pattern_ClassExtendsClass_1_5_registerobjects_expressionBBBBBBBBB(ClassExtendsClass _this,
			...
			EObject tExtendedClass, EObject eClassDeclarationToTClass, EObject eTypeAccess, EObject eClassDeclaration,
			EObject eExtendedClass) {
		_this.registerObjects_FWD(ruleresult, tClass, eExtendedClassToTExtendedClass, tExtendedClass,
				eClassDeclarationToTClass, eTypeAccess, eClassDeclaration, eExtendedClass);
	...
	public static final Iterable<Object[]> pattern_ClassExtendsClass_2_2_corematch_blackFFFFBBBB(TypeAccess eTypeAccess,
					...
					for (ClassDeclarationToTClass eExtendedClassToTExtendedClass : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eClassDeclarationToTClass.equals(eExtendedClassToTExtendedClass)) {
							...
							if (tExtendedClass != null) {
								if (!tClass.equals(tExtendedClass)) {
									_result.add(new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass,
											eClassDeclarationToTClass, eTypeAccess, eClassDeclaration, eExtendedClass,
											match });
								}
							}
								...
								if (tExtendedClass.equals(eExtendedClassToTExtendedClass.getTarget())) {
									if (eTypeAccess.equals(eClassDeclaration.getSuperClass())) {
										if (eExtendedClass.equals(eExtendedClassToTExtendedClass.getSource())) {
											_result.add(new Object[] { tClass, eExtendedClassToTExtendedClass,
													tExtendedClass, eClassDeclarationToTClass, eTypeAccess,
													eClassDeclaration, eExtendedClass });
										}
									}
								}
	...
	public static final Object[] pattern_ClassExtendsClass_2_3_findcontext_greenBBBBBBBFFFFFFFF(TClass tClass,
		...
		return new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass,
				eTypeAccess, eClassDeclaration, eExtendedClass, isApplicableMatch,
	...
	public static final Object[] pattern_ClassExtendsClass_2_4_solveCSP_bindingFBBBBBBBBB(ClassExtendsClass _this,
			IsApplicableMatch isApplicableMatch, TClass tClass, ClassDeclarationToTClass eExtendedClassToTExtendedClass,
			TClass tExtendedClass, ClassDeclarationToTClass eClassDeclarationToTClass, TypeAccess eTypeAccess,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tClass,
				eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass, eTypeAccess,
				eClassDeclaration, eExtendedClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tClass, eExtendedClassToTExtendedClass, tExtendedClass,
					eClassDeclarationToTClass, eTypeAccess, eClassDeclaration, eExtendedClass };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ClassExtendsClass_2_4_solveCSP_binding = pattern_ClassExtendsClass_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tClass, eExtendedClassToTExtendedClass, tExtendedClass,
				eClassDeclarationToTClass, eTypeAccess, eClassDeclaration, eExtendedClass);
		if (result_pattern_ClassExtendsClass_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_ClassExtendsClass_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tClass, eExtendedClassToTExtendedClass,
						tExtendedClass, eClassDeclarationToTClass, eTypeAccess, eClassDeclaration, eExtendedClass };
			}
		}
		return null;
	}
				...
				if (!eClassDeclaration.equals(eExtendedClass)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass,
									eClassDeclarationToTClass, eClassDeclaration, eExtendedClass, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_ClassExtendsClass_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_ClassExtendsClass_11_1_performtransformation_binding != null) {
			...
			ClassDeclarationToTClass eExtendedClassToTExtendedClass = (ClassDeclarationToTClass) result_pattern_ClassExtendsClass_11_1_performtransformation_binding[1];
			TClass tExtendedClass = (TClass) result_pattern_ClassExtendsClass_11_1_performtransformation_binding[2];
			ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result_pattern_ClassExtendsClass_11_1_performtransformation_binding[3];
			...
			if (result_pattern_ClassExtendsClass_11_1_performtransformation_black != null) {
				...
				return new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass,
						eClassDeclaration, eExtendedClass, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final void pattern_ClassExtendsClass_11_5_registerobjects_expressionBBBBBBBBB(ClassExtendsClass _this,
			...
			EObject tExtendedClass, EObject eClassDeclarationToTClass, EObject eTypeAccess, EObject eClassDeclaration,
			EObject eExtendedClass) {
		_this.registerObjects_BWD(ruleresult, tClass, eExtendedClassToTExtendedClass, tExtendedClass,
				eClassDeclarationToTClass, eTypeAccess, eClassDeclaration, eExtendedClass);
					...
					for (ClassDeclarationToTClass eExtendedClassToTExtendedClass : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eClassDeclarationToTClass.equals(eExtendedClassToTExtendedClass)) {
							...
							if (eExtendedClass != null) {
								if (!eClassDeclaration.equals(eExtendedClass)) {
									_result.add(new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass,
											eClassDeclarationToTClass, eClassDeclaration, eExtendedClass, match });
								}
							}
						...
						if (eClassDeclaration.equals(eClassDeclarationToTClass.getSource())) {
							if (tClass.equals(eClassDeclarationToTClass.getTarget())) {
								if (tExtendedClass.equals(eExtendedClassToTExtendedClass.getTarget())) {
									if (eExtendedClass.equals(eExtendedClassToTExtendedClass.getSource())) {
										_result.add(
												new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass,
														eClassDeclarationToTClass, eClassDeclaration, eExtendedClass });
									}
								}
							}
	...
	public static final Object[] pattern_ClassExtendsClass_12_3_findcontext_greenBBBBBBFFFFFFF(TClass tClass,
		...
		eExtendedClassToTExtendedClass__eExtendedClass____source
				.setName(eExtendedClassToTExtendedClass__eExtendedClass____source_name_prime);
		return new Object[] { tClass, eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass,
				eClassDeclaration, eExtendedClass, isApplicableMatch, tClass__tExtendedClass____parentClass,
				tExtendedClass__tClass____childClasses, eClassDeclarationToTClass__eClassDeclaration____source,
				eClassDeclarationToTClass__tClass____target, eExtendedClassToTExtendedClass__tExtendedClass____target,
				eExtendedClassToTExtendedClass__eExtendedClass____source };
	}

	public static final Object[] pattern_ClassExtendsClass_12_4_solveCSP_bindingFBBBBBBBB(ClassExtendsClass _this,
			IsApplicableMatch isApplicableMatch, TClass tClass, ClassDeclarationToTClass eExtendedClassToTExtendedClass,
			TClass tExtendedClass, ClassDeclarationToTClass eClassDeclarationToTClass,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tClass,
				eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass, eClassDeclaration,
				eExtendedClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tClass, eExtendedClassToTExtendedClass, tExtendedClass,
	...
	public static final Object[] pattern_ClassExtendsClass_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		if (result_pattern_ClassExtendsClass_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_ClassExtendsClass_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tClass, eExtendedClassToTExtendedClass,
						tExtendedClass, eClassDeclarationToTClass, eClassDeclaration, eExtendedClass };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_0BBB(
			TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass) {
		if (!eClassDeclaration.equals(eExtendedClass)) {
			for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_279812 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!eClassDeclaration.equals(__DEC_eTypeAccess_superInterfaces_279812)) {
					if (!eExtendedClass.equals(__DEC_eTypeAccess_superInterfaces_279812)) {
						return new Object[] { eTypeAccess, eClassDeclaration, eExtendedClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_855165 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_590682 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_978146 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_306956 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_908899 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_528979 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_611592 : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTExtendedClass instanceof TClass) {
				...
				if (tmpETypeAccess instanceof TypeAccess) {
					...
					if (tmpEClassDeclaration instanceof ClassDeclaration) {
						...
						if (tmpEExtendedClass instanceof ClassDeclaration) {
							ClassDeclaration eExtendedClass = (ClassDeclaration) tmpEExtendedClass;
							return new Object[] { tClass, tExtendedClass, eTypeAccess, eClassDeclaration,
	...
	public static final Object[] pattern_ClassExtendsClass_24_2_matchsrctrgcontext_blackBBBBBBB(TClass tClass,
			TClass tExtendedClass, TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration,
			ClassDeclaration eExtendedClass, Match sourceMatch, Match targetMatch) {
		if (!tClass.equals(tExtendedClass)) {
			if (!eClassDeclaration.equals(eExtendedClass)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tClass, tExtendedClass, eTypeAccess, eClassDeclaration, eExtendedClass,
	...
	public static final Object[] pattern_ClassExtendsClass_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_ClassExtendsClass_24_2_matchsrctrgcontext_binding != null) {
			...
			TypeAccess eTypeAccess = (TypeAccess) result_pattern_ClassExtendsClass_24_2_matchsrctrgcontext_binding[2];
			...
			Object[] result_pattern_ClassExtendsClass_24_2_matchsrctrgcontext_black = pattern_ClassExtendsClass_24_2_matchsrctrgcontext_blackBBBBBBB(
					tClass, tExtendedClass, eTypeAccess, eClassDeclaration, eExtendedClass, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ClassExtendsClass_24_3_solvecsp_bindingFBBBBBBBB(ClassExtendsClass _this,
			TClass tClass, TClass tExtendedClass, TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration,
			ClassDeclaration eExtendedClass, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(tClass, tExtendedClass, eTypeAccess, eClassDeclaration,
				eExtendedClass, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, tClass, tExtendedClass, eTypeAccess, eClassDeclaration, eExtendedClass,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
			ClassExtendsClass _this, TClass tClass, TClass tExtendedClass, TypeAccess eTypeAccess,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_ClassExtendsClass_24_3_solvecsp_binding = pattern_ClassExtendsClass_24_3_solvecsp_bindingFBBBBBBBB(
				_this, tClass, tExtendedClass, eTypeAccess, eClassDeclaration, eExtendedClass, sourceMatch,
				targetMatch);
		if (result_pattern_ClassExtendsClass_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_ClassExtendsClass_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tClass, tExtendedClass, eTypeAccess, eClassDeclaration,
						eExtendedClass, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_ClassExtendsClass_24_5_matchcorrcontext_blackBFBFBBBB(TClass tClass,
			TClass tExtendedClass, ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tClass.equals(tExtendedClass)) {
			if (!eClassDeclaration.equals(eExtendedClass)) {
						...
						if (tClass.equals(eClassDeclarationToTClass.getTarget())) {
							for (ClassDeclarationToTClass eExtendedClassToTExtendedClass : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!eClassDeclarationToTClass.equals(eExtendedClassToTExtendedClass)) {
									if (eExtendedClass.equals(eExtendedClassToTExtendedClass.getSource())) {
										_result.add(new Object[] { tClass, eExtendedClassToTExtendedClass,
												tExtendedClass, eClassDeclarationToTClass, eClassDeclaration,
												eExtendedClass, sourceMatch, targetMatch });
									}
								}
							}
	...
	public static final Object[] pattern_ClassExtendsClass_24_5_matchcorrcontext_greenBBBBF(
			ClassDeclarationToTClass eExtendedClassToTExtendedClass, ClassDeclarationToTClass eClassDeclarationToTClass,
			Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_ClassExtendsClass_24_6_createcorrespondence_blackBBBBBB(TClass tClass,
		...
		if (!tClass.equals(tExtendedClass)) {
			if (!eClassDeclaration.equals(eExtendedClass)) {
				return new Object[] { tClass, tExtendedClass, eTypeAccess, eClassDeclaration, eExtendedClass, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_0BBB(TypeAccess eTypeAccess,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass) {
		if (!eClassDeclaration.equals(eExtendedClass)) {
			for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_820190 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!eClassDeclaration.equals(__DEC_eTypeAccess_superInterfaces_820190)) {
					if (!eExtendedClass.equals(__DEC_eTypeAccess_superInterfaces_820190)) {
						return new Object[] { eTypeAccess, eClassDeclaration, eExtendedClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_1B(TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_899442 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_2B(TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_645169 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_3B(TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_72534 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_4B(TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_91324 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_5B(TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_40007 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_6B(TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_404345 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_7B(TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_692532 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_29_3_solveCSP_bindingFBBBBBBBBB(ClassExtendsClass _this,
			IsApplicableMatch isApplicableMatch, TClass tClass, ClassDeclarationToTClass eExtendedClassToTExtendedClass,
			TClass tExtendedClass, ClassDeclarationToTClass eClassDeclarationToTClass,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tClass,
				eExtendedClassToTExtendedClass, tExtendedClass, eClassDeclarationToTClass, eClassDeclaration,
				eExtendedClass, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tClass, eExtendedClassToTExtendedClass, tExtendedClass,
					eClassDeclarationToTClass, eClassDeclaration, eExtendedClass, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		if (result_pattern_ClassExtendsClass_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_ClassExtendsClass_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, tClass, eExtendedClassToTExtendedClass,
						tExtendedClass, eClassDeclarationToTClass, eClassDeclaration, eExtendedClass, ruleResult };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_29_6_perform_greenBBFBBB(TClass tClass,
			TClass tExtendedClass, ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass,
		...
		return new Object[] { tClass, tExtendedClass, eTypeAccess, eClassDeclaration, eExtendedClass, ruleResult };
	}
