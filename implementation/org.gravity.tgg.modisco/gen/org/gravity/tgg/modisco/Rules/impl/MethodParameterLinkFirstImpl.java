...
public class MethodParameterLinkFirstImpl extends AbstractRuleImpl implements MethodParameterLinkFirst {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkFirstImpl
				.pattern_MethodParameterLinkFirst_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult, tMethodSignature,
						eSingleVariableDeclarationToTParameter, mParameterList, mEntry, tParameter,
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ tParameter + ", " + "[mmethodSignatureToTMethodSignature] = " + mmethodSignatureToTMethodSignature
					+ ".");
		}
		...
		MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, tMethodSignature, eSingleVariableDeclarationToTParameter, mParameterList, mEntry,
			...
			for (Object[] result3_black : MethodParameterLinkFirstImpl
				...
				Object[] result4_bindingAndBlack = MethodParameterLinkFirstImpl
						.pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingAndBlackFBBBBBBBB(this, isApplicableMatch,
								tMethodSignature, eSingleVariableDeclarationToTParameter, mParameterList, mEntry,
								tParameter, mmethodSignatureToTMethodSignature);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMethodSignature tMethodSignature,
			MEntryToTParameter eSingleVariableDeclarationToTParameter, MMethodSignature mParameterList, MEntry mEntry,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tMethodSignature,
			EObject eSingleVariableDeclarationToTParameter, EObject mParameterList, EObject mEntry, EObject tParameter,
			...
			for (Object[] result3_black : MethodParameterLinkFirstImpl
				...
				Object[] result4_bindingAndBlack = MethodParameterLinkFirstImpl
						.pattern_MethodParameterLinkFirst_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tMethodSignature, eSingleVariableDeclarationToTParameter,
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_183(EMoflonEdge _edge_firstParameter) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_188(EMoflonEdge _edge_mFirstEntry) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkFirstImpl
					.pattern_MethodParameterLinkFirst_24_5_matchcorrcontext_blackBFBBBFBB(tMethodSignature,
							mParameterList, mEntry, tParameter, sourceMatch, targetMatch)) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_MENTRYTOTPARAMETER_MMETHODSIGNATURE_MENTRY_TPARAMETER_MSIGNATURETOTSIGNATURE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_MENTRYTOTPARAMETER_MMETHODSIGNATURE_MENTRY_TPARAMETER_MSIGNATURETOTSIGNATURE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPROPRIATE_BWD_EMOFLON_EDGE_183__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_183((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPROPRIATE_FWD_EMOFLON_EDGE_188__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_MENTRYTOTPARAMETER_MMETHODSIGNATURE_MENTRY_TPARAMETER_MSIGNATURETOTSIGNATURE_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TMethodSignature) arguments.get(1),
					(MEntryToTParameter) arguments.get(2), (MMethodSignature) arguments.get(3),
					(MEntry) arguments.get(4), (TParameter) arguments.get(5), (MSignatureToTSignature) arguments.get(6),
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMethodSignature, eSingleVariableDeclarationToTParameter, mParameterList, mEntry,
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLinkFirst_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodParameterLinkFirst_1_1_performtransformation_black = pattern_MethodParameterLinkFirst_1_1_performtransformation_blackBBBBBBFBB(
					tMethodSignature, eSingleVariableDeclarationToTParameter, mParameterList, mEntry, tParameter,
															...
															if (!mmethodSignatureToTMethodSignature
																...
																if (!mmethodSignatureToTMethodSignature
																	...
																	return new Object[] { ruleresult, tMethodSignature,
																			eSingleVariableDeclarationToTParameter,
																			mParameterList, mEntry, tParameter,
																			mmethodSignatureToTMethodSignature };
																}
															}
														}
	...
	public static final void pattern_MethodParameterLinkFirst_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject eSingleVariableDeclarationToTParameter, EObject mParameterList, EObject mEntry, EObject tParameter,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_FWD(ruleresult, tMethodSignature, eSingleVariableDeclarationToTParameter, mParameterList,
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLinkFirst_2_4_solveCSP_binding = pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tMethodSignature, eSingleVariableDeclarationToTParameter, mParameterList,
				mEntry, tParameter, mmethodSignatureToTMethodSignature);
	...
	public static final void pattern_MethodParameterLinkFirst_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject eSingleVariableDeclarationToTParameter, EObject mParameterList, EObject mEntry, EObject tParameter,
			EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_BWD(ruleresult, tMethodSignature, eSingleVariableDeclarationToTParameter, mParameterList,
				mEntry, tParameter, mmethodSignatureToTMethodSignature);
