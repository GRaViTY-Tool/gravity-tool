...
public class MethodParameterLinkImpl extends AbstractRuleImpl implements MethodParameterLink {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkImpl
				.pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						mmethodSignatureToTMethodSignature, tParameter, tPrevParameter, mPrevEntry,
		...
		MethodParameterLinkImpl.pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(ruleresult,
				tParameter, tPrevParameter, mPrevEntry, mEntry);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_2_2_corematch_blackFFFBFBB(mPrevEntry, mEntry, match)) {
			...
			for (Object[] result3_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_2_3_findcontext_blackBBBBBB(mmethodSignatureToTMethodSignature,
							tParameter, tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter, mEntry)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			MEntryToTParameter mmethodSignatureToTMethodSignature, TParameter tParameter, TParameter tPrevParameter,
			MEntry mPrevEntry, MEntryToTParameter eSingleVariableDeclarationToTParameter, MEntry mEntry) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mmethodSignatureToTMethodSignature,
			EObject tParameter, EObject tPrevParameter, EObject mPrevEntry,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkImpl
				.pattern_MethodParameterLink_12_2_corematch_blackFBBFFFB(tParameter, tPrevParameter, match)) {
			MEntryToTParameter mmethodSignatureToTMethodSignature = (MEntryToTParameter) result2_black[0];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_181(EMoflonEdge _edge_next) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_186(EMoflonEdge _edge_mNext) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodParameterLinkImpl.pattern_MethodParameterLink_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkImpl
					.pattern_MethodParameterLink_24_5_matchcorrcontext_blackFBBBFBBB(tParameter, tPrevParameter,
							mPrevEntry, mEntry, sourceMatch, targetMatch)) {
				...
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tParameter] = "
							+ tParameter + ", " + "[tPrevParameter] = " + tPrevParameter + ", " + "[mPrevEntry] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TParameter tParameter, TParameter tPrevParameter, MEntry mPrevEntry,
				...
				if (result5_black != null) {
					...
					Object[] result6_black = MethodParameterLinkImpl
							.pattern_MethodParameterLink_29_6_perform_blackBBBBBBB(mmethodSignatureToTMethodSignature,
									tParameter, tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter,
									mEntry, ruleResult);
					if (result6_black == null) {
					...
					MethodParameterLinkImpl.pattern_MethodParameterLink_29_6_perform_greenBBBBB(tParameter,
							tPrevParameter, mPrevEntry, mEntry, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_TPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRY:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MEntryToTParameter) arguments.get(1), (TParameter) arguments.get(2), (TParameter) arguments.get(3),
					(MEntry) arguments.get(4), (MEntryToTParameter) arguments.get(5), (MEntry) arguments.get(6));
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_TPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRY:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_BWD_EMOFLON_EDGE_181__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_181((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_PARAMETER_LINK___IS_APPROPRIATE_FWD_EMOFLON_EDGE_186__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_TPARAMETER_TPARAMETER_MENTRY_MENTRYTOTPARAMETER_MENTRY_MODELGENERATORRULERESULT:
					...
					if (tmpMPrevEntry instanceof MEntry) {
						...
						if (tmpESingleVariableDeclarationToTParameter instanceof MEntryToTParameter) {
							...
							if (tmpMEntry instanceof MEntry) {
								...
								return new Object[] { mmethodSignatureToTMethodSignature, tParameter, tPrevParameter,
										mPrevEntry, eSingleVariableDeclarationToTParameter, mEntry, isApplicableMatch };
							}
						}
					}
				}
				...
				if (!mEntry.equals(mPrevEntry)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { mmethodSignatureToTMethodSignature, tParameter, tPrevParameter,
									mPrevEntry, eSingleVariableDeclarationToTParameter, mEntry, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLink_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodParameterLink_1_1_performtransformation_binding != null) {
			...
			if (result_pattern_MethodParameterLink_1_1_performtransformation_black != null) {
				...
				return new Object[] { mmethodSignatureToTMethodSignature, tParameter, tPrevParameter, mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_blackBBBBBBB(
			...
			EObject tPrevParameter, EObject mPrevEntry, EObject eSingleVariableDeclarationToTParameter,
			EObject mEntry) {
	...
	public static final Object[] pattern_MethodParameterLink_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject tParameter, EObject tPrevParameter, EObject mPrevEntry,
			EObject mEntry) {
		...
		mPrevEntry__mEntry____mNext.setName(mPrevEntry__mEntry____mNext_name_prime);
		mEntry__mPrevEntry____mPrevious.setName(mEntry__mPrevEntry____mPrevious_name_prime);
		return new Object[] { ruleresult, tParameter, tPrevParameter, mPrevEntry, mEntry,
	...
	public static final void pattern_MethodParameterLink_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tParameter, EObject tPrevParameter, EObject mPrevEntry,
			EObject eSingleVariableDeclarationToTParameter, EObject mEntry) {
		_this.registerObjects_FWD(ruleresult, mmethodSignatureToTMethodSignature, tParameter, tPrevParameter,
				mPrevEntry, eSingleVariableDeclarationToTParameter, mEntry);
	...
	public static final Iterable<Object[]> pattern_MethodParameterLink_2_2_corematch_blackFFFBFBB(MEntry mPrevEntry,
				...
				if (tPrevParameter != null) {
					for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eSingleVariableDeclarationToTParameter.equals(mmethodSignatureToTMethodSignature)) {
							...
							if (tParameter != null) {
								if (!tParameter.equals(tPrevParameter)) {
									_result.add(new Object[] { mmethodSignatureToTMethodSignature, tParameter,
											tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter, mEntry,
											match });
								}
							}
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(MethodParameterLink _this,
			...
			TParameter tParameter, TParameter tPrevParameter, MEntry mPrevEntry,
	...
	public static final Object[] pattern_MethodParameterLink_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLink_2_4_solveCSP_binding = pattern_MethodParameterLink_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mmethodSignatureToTMethodSignature, tParameter, tPrevParameter, mPrevEntry,
				eSingleVariableDeclarationToTParameter, mEntry);
	...
	public static final void pattern_MethodParameterLink_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject tParameter, EObject tPrevParameter, EObject mPrevEntry,
			EObject eSingleVariableDeclarationToTParameter, EObject mEntry) {
		_this.registerObjects_BWD(ruleresult, mmethodSignatureToTMethodSignature, tParameter, tPrevParameter,
				mPrevEntry, eSingleVariableDeclarationToTParameter, mEntry);
		...
		if (tmpTParameter instanceof TParameter) {
			...
			if (tmpTPrevParameter instanceof TParameter) {
				...
				if (tmpMPrevEntry instanceof MEntry) {
					...
					if (tmpMEntry instanceof MEntry) {
						MEntry mEntry = (MEntry) tmpMEntry;
						return new Object[] { tParameter, tPrevParameter, mPrevEntry, mEntry, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(TParameter tParameter,
			TParameter tPrevParameter, MEntry mPrevEntry, MEntry mEntry, Match sourceMatch, Match targetMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { tParameter, tPrevParameter, mPrevEntry, mEntry, sourceMatch, targetMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodParameterLink_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodParameterLink_24_2_matchsrctrgcontext_black = pattern_MethodParameterLink_24_2_matchsrctrgcontext_blackBBBBBB(
					tParameter, tPrevParameter, mPrevEntry, mEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(MethodParameterLink _this,
			TParameter tParameter, TParameter tPrevParameter, MEntry mPrevEntry, MEntry mEntry, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tParameter, tPrevParameter, mPrevEntry, mEntry,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tParameter, tPrevParameter, mPrevEntry, mEntry, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_24_3_solvecsp_bindingAndBlackFBBBBBBB(
			MethodParameterLink _this, TParameter tParameter, TParameter tPrevParameter, MEntry mPrevEntry,
		...
		Object[] result_pattern_MethodParameterLink_24_3_solvecsp_binding = pattern_MethodParameterLink_24_3_solvecsp_bindingFBBBBBBB(
				_this, tParameter, tPrevParameter, mPrevEntry, mEntry, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLink_24_6_createcorrespondence_blackBBBBB(TParameter tParameter,
			TParameter tPrevParameter, MEntry mPrevEntry, MEntry mEntry, CCMatch ccMatch) {
		if (!tParameter.equals(tPrevParameter)) {
			if (!mEntry.equals(mPrevEntry)) {
				return new Object[] { tParameter, tPrevParameter, mPrevEntry, mEntry, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_3_solveCSP_bindingFBBBBBBBBB(MethodParameterLink _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mmethodSignatureToTMethodSignature,
				tParameter, tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter, mEntry, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mmethodSignatureToTMethodSignature, tParameter,
					tPrevParameter, mPrevEntry, eSingleVariableDeclarationToTParameter, mEntry, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLink_29_6_perform_greenBBBBB(TParameter tParameter,
			TParameter tPrevParameter, MEntry mPrevEntry, MEntry mEntry, ModelgeneratorRuleResult ruleResult) {
		tPrevParameter.setNext(tParameter);
		mPrevEntry.setMNext(mEntry);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { tParameter, tPrevParameter, mPrevEntry, mEntry, ruleResult };
	}
