...
public class ClassImpl extends AbstractRuleImpl implements org.gravity.tgg.modisco.Rules.Class {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = ClassImpl.pattern_Class_1_1_performtransformation_greenFBFFBFBB(tPackage, pg, mType,
				csp);
		...
		Object[] result3_black = ClassImpl.pattern_Class_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult,
				mClassDeclarationToTClass, mPackageToTPackage, tPackage, tType, mTypeToTType, mPackage, pg,
		...
		ClassImpl.pattern_Class_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(ruleresult,
				mClassDeclarationToTClass, tPackage, tType, mTypeToTType, mPackage, pg, mBodyToTAnnotation, mType);
		...
		ClassImpl.pattern_Class_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult, mClassDeclarationToTClass,
				mPackageToTPackage, tPackage, tType, mTypeToTType, mPackage, pg, mBodyToTAnnotation, mType);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mClassDeclarationToTClass,
			EObject mPackageToTPackage, EObject tPackage, EObject tType, EObject mTypeToTType, EObject mPackage,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = ClassImpl.pattern_Class_11_1_performtransformation_greenFBFBFFB(tType, mPackage, csp);
		ClassDeclarationToTClass mClassDeclarationToTClass = (ClassDeclarationToTClass) result1_green[0];
		...
		for (Object[] result2_black : ClassImpl.pattern_Class_29_2_isapplicablecore_blackFFFFFBB(ruleEntryContainer,
			...
			if (ClassImpl.pattern_Class_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					ClassImpl.pattern_Class_29_6_perform_greenFBFFBBFFBB(tPackage, mPackage, pg, ruleResult, csp);
					//nothing ClassDeclarationToTClass mClassDeclarationToTClass = (ClassDeclarationToTClass) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_218__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_218((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_226__EMOFLONEDGE:
	...
	public static final Object[] pattern_Class_0_2_SolveCSP_bindingAndBlackFBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, Match match, org.eclipse.modisco.java.Package mPackage,
			MClass mType) {
	...
	public static final Object[] pattern_Class_1_1_performtransformation_blackBBBBBFBB(
			...
			TypeGraph pg, MClass mType, org.gravity.tgg.modisco.Rules.Class _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_Class_1_1_performtransformation_greenFBFFBFBB(TPackage tPackage, TypeGraph pg,
		...
		return new Object[] { mClassDeclarationToTClass, tPackage, tType, mTypeToTType, pg, mBodyToTAnnotation, mType,
				csp };
	}
	...
	public static final Object[] pattern_Class_1_3_bookkeepingforedges_blackBBBBBBBBBB(PerformRuleResult ruleresult,
			EObject mClassDeclarationToTClass, EObject mPackageToTPackage, EObject tPackage, EObject tType,
	...
	public static final Object[] pattern_Class_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mClassDeclarationToTClass, EObject tPackage, EObject tType,
			EObject mTypeToTType, EObject mPackage, EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		...
		return new Object[] { ruleresult, mClassDeclarationToTClass, tPackage, tType, mTypeToTType, mPackage, pg,
	...
	public static final void pattern_Class_1_5_registerobjects_expressionBBBBBBBBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, PerformRuleResult ruleresult, EObject mClassDeclarationToTClass,
			EObject mPackageToTPackage, EObject tPackage, EObject tType, EObject mTypeToTType, EObject mPackage,
			EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		_this.registerObjects_FWD(ruleresult, mClassDeclarationToTClass, mPackageToTPackage, tPackage, tType,
	...
	public static final Object[] pattern_Class_10_1_initialbindings_blackBBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, Match match, TPackage tPackage, TClass tType, TypeGraph pg) {
	...
	public static final Object[] pattern_Class_10_4_collectelementstobetranslated_greenBBBBFFFFFF(Match match,
		...
		tType__tPackage____package.setName(tType__tPackage____package_name_prime);
		pg__tType____classes.setName(pg__tType____classes_name_prime);
		return new Object[] { match, tPackage, tType, pg, tPackage__tType____classes, pg__tType____ownedTypes,
	...
	public static final Object[] pattern_Class_11_1_performtransformation_blackBBBBBFBB(
			...
			org.eclipse.modisco.java.Package mPackage, TypeGraph pg, org.gravity.tgg.modisco.Rules.Class _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
	...
	public static final Object[] pattern_Class_11_1_performtransformation_greenFBFBFFB(TClass tType,
		...
		return new Object[] { mClassDeclarationToTClass, tType, mTypeToTType, mPackage, mBodyToTAnnotation, mType,
				csp };
	}
	...
	public static final void pattern_Class_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mPackageToTPackage, EObject tPackage, EObject tType, EObject mTypeToTType, EObject mPackage,
			EObject pg, EObject mBodyToTAnnotation, EObject mType) {
		_this.registerObjects_BWD(ruleresult, mClassDeclarationToTClass, mPackageToTPackage, tPackage, tType,
				mTypeToTType, mPackage, pg, mBodyToTAnnotation, mType);
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_0BB(TClass tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_classes_629256 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_629256)) {
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_374122 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_374122)) {
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_2BB(TClass tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_557054 = tType.getPackage();
		if (__DEC_tType_ownedTypes_557054 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_557054)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_822465 = tType.getOuterType();
		if (__DEC_tType_innerTypes_822465 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_822465)) {
										...
										if (pattern_Class_20_2_testcorematchandDECs_black_nac_2BB(tType,
											...
											if (pattern_Class_20_2_testcorematchandDECs_black_nac_3B(tType) == null) {
												if (pattern_Class_20_2_testcorematchandDECs_black_nac_1BB(tType,
														pg) == null) {
													_result.add(new Object[] { tPackage, tType, pg, _edge_classes });
												}
											}
										}
									}
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_0B(MClass mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_128662 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_128662 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_128662)) {
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_1B(MClass mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_966384 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_966384 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_2B(MClass mType) {
		for (Model __DEC_mType_orphanTypes_418377 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_3B(MClass mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_364604 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Class_24_3_solvecsp_bindingFBBBBBBBB(org.gravity.tgg.modisco.Rules.Class _this,
	...
	public static final Object[] pattern_Class_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
			org.gravity.tgg.modisco.Rules.Class _this, TPackage tPackage, TClass tType,
			org.eclipse.modisco.java.Package mPackage, TypeGraph pg, MClass mType, Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_0B(MClass mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_657652 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_657652 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_657652)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_1B(MClass mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_55230 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_55230 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_2B(MClass mType) {
		for (Model __DEC_mType_orphanTypes_606491 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, Model.class, "orphanTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_3B(MClass mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_502659 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_0BB(TClass tType, TPackage tPackage) {
		for (TPackage __DEC_tType_classes_382145 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_382145)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_373162 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_373162)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_2BB(TClass tType, TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_253475 = tType.getPackage();
		if (__DEC_tType_ownedTypes_253475 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_253475)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_123755 = tType.getOuterType();
		if (__DEC_tType_innerTypes_123755 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_123755)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_Class_29_6_perform_greenFBFFBBFFBB(TPackage tPackage,
		...
		return new Object[] { mClassDeclarationToTClass, tPackage, tType, mTypeToTType, mPackage, pg,
