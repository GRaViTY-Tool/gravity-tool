...
import org.gravity.tgg.modisco.MSingleVariableAccessToTAccess;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Field Access Read Write</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * </p>
 *
 * @generated
 */
public class FieldAccessReadWriteImpl extends AbstractRuleImpl implements FieldAccessReadWrite {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected FieldAccessReadWriteImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RulesPackage.eINSTANCE.getFieldAccessReadWrite();
	}
	...
	public boolean isAppropriate_FWD(Match match, MSingleVariableAccess mAccess,
		...
		Object[] result1_black = FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_0_1_initialbindings_blackBBBBBB(
				this, match, mAccess, varDeclFrag, mField, mMember);
		...
		Object[] result2_bindingAndBlack = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, mAccess, varDeclFrag,
						mField, mMember);
		...
		// 
		if (FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_0_3_CheckCSP_expressionFBB(this, csp)) {

			Object[] result4_black = FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_0_4_collectelementstobetranslated_blackBBBBB(match, mAccess,
			...
			FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_0_4_collectelementstobetranslated_greenBBBBFFF(match,
					mAccess, varDeclFrag, mMember);
			...
			Object[] result5_black = FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_0_5_collectcontextelements_blackBBBBB(match, mAccess, varDeclFrag,
							mField, mMember);
			...
			FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_0_5_collectcontextelements_greenBBBBFF(match,
					varDeclFrag, mField, mMember);
			...
			// 
			FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_0_6_registerobjectstomatch_expressionBBBBBB(this,
					match, mAccess, varDeclFrag, mField, mMember);
			return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_0_7_expressionF();
		} else {
			return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_0_8_expressionF();
		}
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(this,
						isApplicableMatch);
		...
		Object[] result1_green = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_1_1_performtransformation_greenBBFFBF(mAccess, tMember, tField);
		TReadWrite tAccess = (TReadWrite) result1_green[2];
		...
		Object[] result2_black = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_1_2_collecttranslatedelements_blackBBBB(mAccess, tAccess,
		...
		Object[] result2_green = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_1_2_collecttranslatedelements_greenFBBBB(mAccess, tAccess,
						mFlowOwnerToTFlowOwner, mAccessToTAccess);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(ruleresult, mAccess,
		...
		FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
				ruleresult, mAccess, varDeclFrag, tMember, tAccess, mFlowOwnerToTFlowOwner, mMember, tField,
				mAccessToTAccess);
		...
		// 
		// 
		FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_1_5_registerobjects_expressionBBBBBBBBBBBBB(this,
				ruleresult, mAccess, mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod,
				mFlowOwnerToTFlowOwner, mMember, tField, mAccessToTAccess);
		return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_1_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		Object[] result1_bindingAndBlack = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_2_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		...
		Object[] result1_green = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_2_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_2_2_corematch_bindingFFFFB(match);
		...
		for (Object[] result2_black : FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_2_2_corematch_blackBFBFBFBFB(mAccess, varDeclFrag, mField, mMember,
						match)) {
			...
			// ForEach 
			for (Object[] result3_black : FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_2_3_findcontext_blackBBBBBBBB(mAccess, mMemberToTMember, varDeclFrag,
							tMember, mField, mMethodToTMethod, mMember, tField)) {
				Object[] result3_green = FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_2_3_findcontext_greenBBBBBBBBFFFFFFFFFF(mAccess, mMemberToTMember,
				...
				Object[] result4_bindingAndBlack = FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
				...
				// 
				if (FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_2_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = FieldAccessReadWriteImpl
							.pattern_FieldAccessReadWrite_2_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_2_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_2_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public boolean isAppropriate_BWD(Match match, TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {

		Object[] result1_black = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_10_1_initialbindings_blackBBBBB(this, match, tMember, tAccess, tField);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
		...
		Object[] result2_bindingAndBlack = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_10_2_SolveCSP_bindingAndBlackFBBBBB(this, match, tMember, tAccess,
						tField);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[match] = " + match + ", " + "[tMember] = " + tMember + ", " + "[tAccess] = " + tAccess + ", "
		...
		CSP csp = (CSP) result2_bindingAndBlack[0];
		// 
		if (FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_10_3_CheckCSP_expressionFBB(this, csp)) {

			Object[] result4_black = FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_10_4_collectelementstobetranslated_blackBBBB(match, tMember, tAccess,
							tField);
			if (result4_black == null) {
				throw new RuntimeException(
			...
			FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_10_4_collectelementstobetranslated_greenBBBBFFFF(
			...
			Object[] result5_black = FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_10_5_collectcontextelements_blackBBBB(match, tMember, tAccess,
							tField);
			if (result5_black == null) {
				throw new RuntimeException(
						"Pattern matching failed." + " Variables: " + "[match] = " + match + ", " + "[tMember] = "
			...
			FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_10_5_collectcontextelements_greenBBB(match, tMember,
					tField);

			// 
			FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_10_6_registerobjectstomatch_expressionBBBBB(this,
					match, tMember, tAccess, tField);
			return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_10_7_expressionF();
		} else {
			return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_10_8_expressionF();
		}
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_bindingAndBlack = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_11_1_performtransformation_bindingAndBlackFFFFFFFFFBB(this,
						isApplicableMatch);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[isApplicableMatch] = " + isApplicableMatch + ".");
		...
		TReadWrite tAccess = (TReadWrite) result1_bindingAndBlack[4];
		MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result1_bindingAndBlack[5];
		MDefinition mMember = (MDefinition) result1_bindingAndBlack[6];
		TFieldDefinition tField = (TFieldDefinition) result1_bindingAndBlack[7];
		//nothing CSP csp = (CSP) result1_bindingAndBlack[8];
		Object[] result1_green = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_11_1_performtransformation_greenFBBFBF(varDeclFrag, tAccess, mMember);
		MSingleVariableAccess mAccess = (MSingleVariableAccess) result1_green[0];
		MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner = (MAbstractFlowElementToTAbstractFlowElement) result1_green[3];
		MSingleVariableAccessToTAccess mAccessToTAccess = (MSingleVariableAccessToTAccess) result1_green[5];

		Object[] result2_black = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_11_2_collecttranslatedelements_blackBBBB(mAccess, tAccess,
						mFlowOwnerToTFlowOwner, mAccessToTAccess);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mAccess] = " + mAccess + ", "
					+ "[tAccess] = " + tAccess + ", " + "[mFlowOwnerToTFlowOwner] = " + mFlowOwnerToTFlowOwner + ", "
		...
		Object[] result2_green = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_11_2_collecttranslatedelements_greenFBBBB(mAccess, tAccess,
						mFlowOwnerToTFlowOwner, mAccessToTAccess);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_11_3_bookkeepingforedges_blackBBBBBBBBBBBB(ruleresult, mAccess,
						mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod,
						mFlowOwnerToTFlowOwner, mMember, tField, mAccessToTAccess);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
		...
		FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
				ruleresult, mAccess, varDeclFrag, tMember, tAccess, mFlowOwnerToTFlowOwner, mMember, tField,
				mAccessToTAccess);
		//nothing EMoflonEdge tMember__tAccess____tAccessing = (EMoflonEdge) result3_green[9];
		//nothing EMoflonEdge tAccess__tMember____tSource = (EMoflonEdge) result3_green[10];
		...
		// 
		// 
		FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_11_5_registerobjects_expressionBBBBBBBBBBBBB(this,
				ruleresult, mAccess, mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod,
				mFlowOwnerToTFlowOwner, mMember, tField, mAccessToTAccess);
		return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_11_6_expressionFB(ruleresult);
	}
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		Object[] result1_bindingAndBlack = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_12_1_preparereturnvalue_bindingAndBlackFFB(this);
		if (result1_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		EOperation performOperation = (EOperation) result1_bindingAndBlack[0];
		//nothing EClass eClass = (EClass) result1_bindingAndBlack[1];
		Object[] result1_green = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_12_1_preparereturnvalue_greenBF(performOperation);
		IsApplicableRuleResult ruleresult = (IsApplicableRuleResult) result1_green[1];

		// ForEach 
		Object[] result2_binding = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_12_2_corematch_bindingFFFB(match);
		if (result2_binding == null) {
			throw new RuntimeException(
					"Binding in node core match failed." + " Variables: " + "[match] = " + match + ".");
		}
		TMember tMember = (TMember) result2_binding[0];
		TReadWrite tAccess = (TReadWrite) result2_binding[1];
		TFieldDefinition tField = (TFieldDefinition) result2_binding[2];
		for (Object[] result2_black : FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_12_2_corematch_blackFBFBFFBB(tMember, tAccess, tField, match)) {
			...
			// ForEach 
			for (Object[] result3_black : FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_12_3_findcontext_blackBFBBBBBB(mMemberToTMember, tMember, mField,
				...
				Object[] result3_green = FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_12_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(mMemberToTMember,
				...
				Object[] result4_bindingAndBlack = FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_12_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
				...
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
				if (FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_12_5_checkCSP_expressionFBB(this, csp)) {

					Object[] result6_black = FieldAccessReadWriteImpl
							.pattern_FieldAccessReadWrite_12_6_addmatchtoruleresult_blackBB(ruleresult,
									isApplicableMatch);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = "
								+ ruleresult + ", " + "[isApplicableMatch] = " + isApplicableMatch + ".");
					}
					FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_12_6_addmatchtoruleresult_greenBB(ruleresult,
							isApplicableMatch);
		...
		return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_12_7_expressionFB(ruleresult);
	}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_BWD(Match match, TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_BWD(Match match, TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField, TReadWrite tAccess,
	...
	public boolean checkTypes_BWD(Match match) {
		return true && org.moflon.util.eMoflonSDMUtil.getFQN(match.getObject("tAccess").eClass())
				.equals("basic.TReadWrite.");
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_173(EMoflonEdge _edge_tAccessing) {
		...
		Object[] result1_green = FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_20_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach 
		for (Object[] result2_black : FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_20_2_testcorematchandDECs_blackFFFB(_edge_tAccessing)) {
			TMember tMember = (TMember) result2_black[0];
			TReadWrite tAccess = (TReadWrite) result2_black[1];
			TFieldDefinition tField = (TFieldDefinition) result2_black[2];
			Object[] result2_green = FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_20_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// 
			if (FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(this,
							match, tMember, tAccess, tField)) {
				// 
				if (FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					Object[] result5_black = FieldAccessReadWriteImpl
							.pattern_FieldAccessReadWrite_20_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
					...
					FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_20_5_Addmatchtoruleresult_greenBBBB(match,
		...
		return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_20_6_expressionFB(__result);
	}
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_178(EMoflonEdge _edge_mAbstractFieldAccess) {
		...
		EClass __eClass = (EClass) result1_bindingAndBlack[1];
		EOperation isApplicableCC = (EOperation) result1_bindingAndBlack[3];
		Object[] result1_green = FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_21_1_preparereturnvalue_greenF();
		EObjectContainer __result = (EObjectContainer) result1_green[0];

		// ForEach 
		for (Object[] result2_black : FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_blackFFFFB(_edge_mAbstractFieldAccess)) {
			...
			Object[] result2_green = FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_greenFB(__eClass);
			Match match = (Match) result2_green[0];

			// 
			if (FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(this,
							match, mAccess, varDeclFrag, mField, mMember)) {
				// 
				if (FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
								this, match)) {

					Object[] result5_black = FieldAccessReadWriteImpl
							.pattern_FieldAccessReadWrite_21_5_Addmatchtoruleresult_blackBBBB(match, __performOperation,
									__result, isApplicableCC);
					if (result5_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match
								+ ", " + "[__performOperation] = " + __performOperation + ", " + "[__result] = "
					...
					FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_21_5_Addmatchtoruleresult_greenBBBB(match,
							__performOperation, __result, isApplicableCC);
		...
		return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_21_6_expressionFB(__result);
	}
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result1_black = FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_24_1_prepare_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_24_1_prepare_greenF();
		IsApplicableRuleResult result = (IsApplicableRuleResult) result1_green[0];

		Object[] result2_bindingAndBlack = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(sourceMatch,
						targetMatch);
		if (result2_bindingAndBlack == null) {
		...
		TReadWrite tAccess = (TReadWrite) result2_bindingAndBlack[4];
		...
		Object[] result3_bindingAndBlack = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, mAccess, varDeclFrag,
						tMember, mField, tAccess, mMember, tField, sourceMatch, targetMatch);
		...
		// 
		if (FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_24_5_matchcorrcontext_blackFBBFBBBB(tMember, mField, mMember, tField,
				...
				Object[] result5_green = FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_24_5_matchcorrcontext_greenBBBBF(mMemberToTMember,
								mMethodToTMethod, sourceMatch, targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[4];

				Object[] result6_black = FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_24_6_createcorrespondence_blackBBBBBBBB(mAccess, varDeclFrag,
								tMember, mField, tAccess, mMember, tField, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mAccess] = " + mAccess
				...
				FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_24_6_createcorrespondence_greenBBFFB(mAccess,
						tAccess, ccMatch);
				...
				Object[] result7_black = FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_24_7_addtoreturnedresult_blackBB(result, ccMatch);
				if (result7_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[result] = " + result
							+ ", " + "[ccMatch] = " + ccMatch + ".");
				}
				FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_24_7_addtoreturnedresult_greenBB(result, ccMatch);

			}

		} else {
		}
		return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_24_8_expressionFB(result);
	}
	...
	public CSP isApplicable_solveCsp_CC(MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag,
			TMember tMember, MFieldDefinition mField, TReadWrite tAccess, MDefinition mMember, TFieldDefinition tField,
	...
	public boolean checkDEC_FWD(MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag,
		...
		Object[] result1_black = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_27_1_matchtggpattern_blackBBBB(mAccess, varDeclFrag, mField, mMember);
		if (result1_black != null) {
			FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_27_1_matchtggpattern_greenB(mAccess);

			return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_27_2_expressionF();
		} else {
			return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_27_3_expressionF();
		}
	 ...
	 * @generated
	 */
	public boolean checkDEC_BWD(TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {// 
		Object[] result1_black = FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_28_1_matchtggpattern_blackBBB(tMember, tAccess, tField);
		if (result1_black != null) {
			return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_28_2_expressionF();
		} else {
			return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_28_3_expressionF();
		}
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		Object[] result1_black = FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_29_1_createresult_blackB(this);
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ".");
		}
		Object[] result1_green = FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_29_1_createresult_greenFF();
		IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result1_green[0];
		ModelgeneratorRuleResult ruleResult = (ModelgeneratorRuleResult) result1_green[1];

		// ForEach 
		for (Object[] result2_black : FieldAccessReadWriteImpl
				.pattern_FieldAccessReadWrite_29_2_isapplicablecore_blackFFFFFFFFFBB(ruleEntryContainer, ruleResult)) {
			...
			Object[] result3_bindingAndBlack = FieldAccessReadWriteImpl
					.pattern_FieldAccessReadWrite_29_3_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
			...
			CSP csp = (CSP) result3_bindingAndBlack[0];
			// 
			if (FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = FieldAccessReadWriteImpl
						.pattern_FieldAccessReadWrite_29_5_checknacs_blackBBBBBBB(mMemberToTMember, varDeclFrag,
								tMember, mField, mMethodToTMethod, mMember, tField);
				if (result5_black != null) {

					Object[] result6_black = FieldAccessReadWriteImpl
							.pattern_FieldAccessReadWrite_29_6_perform_blackBBBBBBBB(mMemberToTMember, varDeclFrag,
					...
					FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_29_6_perform_greenFBBFFBBFB(varDeclFrag,
							tMember, mMember, tField, ruleResult);
					//nothing MSingleVariableAccess mAccess = (MSingleVariableAccess) result6_green[0];
					//nothing TReadWrite tAccess = (TReadWrite) result6_green[3];
		...
		return FieldAccessReadWriteImpl.pattern_FieldAccessReadWrite_29_7_expressionFB(ruleResult);
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_ACCESS_READ_WRITE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_173__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_173((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_ACCESS_READ_WRITE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_178__EMOFLONEDGE:
	...
	public static final Object[] pattern_FieldAccessReadWrite_0_1_initialbindings_blackBBBBBB(
			FieldAccessReadWrite _this, Match match, MSingleVariableAccess mAccess,
			VariableDeclarationFragment varDeclFrag, MFieldDefinition mField, MDefinition mMember) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_0_2_SolveCSP_bindingFBBBBBB(FieldAccessReadWrite _this,
	...
	public static final Object[] pattern_FieldAccessReadWrite_0_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessReadWrite_0_2_SolveCSP_bindingAndBlackFBBBBBB(
			FieldAccessReadWrite _this, Match match, MSingleVariableAccess mAccess,
			VariableDeclarationFragment varDeclFrag, MFieldDefinition mField, MDefinition mMember) {
		Object[] result_pattern_FieldAccessReadWrite_0_2_SolveCSP_binding = pattern_FieldAccessReadWrite_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, mAccess, varDeclFrag, mField, mMember);
		if (result_pattern_FieldAccessReadWrite_0_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessReadWrite_0_2_SolveCSP_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_0_2_SolveCSP_black = pattern_FieldAccessReadWrite_0_2_SolveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessReadWrite_0_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessReadWrite_0_3_CheckCSP_expressionFBB(FieldAccessReadWrite _this,
			CSP csp) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_0_4_collectelementstobetranslated_blackBBBBB(Match match,
	...
	public static final Object[] pattern_FieldAccessReadWrite_0_4_collectelementstobetranslated_greenBBBBFFF(
			Match match, MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, MDefinition mMember) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_0_5_collectcontextelements_blackBBBBB(Match match,
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, MFieldDefinition mField,
			MDefinition mMember) {
		if (!mField.equals(mMember)) {
			return new Object[] { match, mAccess, varDeclFrag, mField, mMember };
	...
	public static final Object[] pattern_FieldAccessReadWrite_0_5_collectcontextelements_greenBBBBFF(Match match,
			VariableDeclarationFragment varDeclFrag, MFieldDefinition mField, MDefinition mMember) {
	...
	public static final void pattern_FieldAccessReadWrite_0_6_registerobjectstomatch_expressionBBBBBB(
			FieldAccessReadWrite _this, Match match, MSingleVariableAccess mAccess,
			VariableDeclarationFragment varDeclFrag, MFieldDefinition mField, MDefinition mMember) {
	...
	public static final boolean pattern_FieldAccessReadWrite_0_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FieldAccessReadWrite_0_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_1_1_performtransformation_bindingFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_1_1_performtransformation_blackBBBBBBBBFBB(
			MSingleVariableAccess mAccess, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField,
			FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
			FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding = pattern_FieldAccessReadWrite_1_1_performtransformation_bindingFFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding != null) {
			MSingleVariableAccess mAccess = (MSingleVariableAccess) result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding[0];
			MDefinitionToTMember mMemberToTMember = (MDefinitionToTMember) result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding[1];
			VariableDeclarationFragment varDeclFrag = (VariableDeclarationFragment) result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding[2];
			TMember tMember = (TMember) result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding[3];
			MFieldDefinition mField = (MFieldDefinition) result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding[4];
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding[5];
			MDefinition mMember = (MDefinition) result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding[6];
			TFieldDefinition tField = (TFieldDefinition) result_pattern_FieldAccessReadWrite_1_1_performtransformation_binding[7];

			Object[] result_pattern_FieldAccessReadWrite_1_1_performtransformation_black = pattern_FieldAccessReadWrite_1_1_performtransformation_blackBBBBBBBBFBB(
					mAccess, mMemberToTMember, varDeclFrag, tMember, mField, mMethodToTMethod, mMember, tField, _this,
					isApplicableMatch);
			if (result_pattern_FieldAccessReadWrite_1_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_FieldAccessReadWrite_1_1_performtransformation_black[8];
	...
	public static final Object[] pattern_FieldAccessReadWrite_1_1_performtransformation_greenBBFFBF(
			MSingleVariableAccess mAccess, TMember tMember, TFieldDefinition tField) {
		TReadWrite tAccess = BasicFactory.eINSTANCE.createTReadWrite();
		MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner = ModiscoFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MSingleVariableAccessToTAccess mAccessToTAccess = ModiscoFactory.eINSTANCE
				.createMSingleVariableAccessToTAccess();
	...
	public static final Object[] pattern_FieldAccessReadWrite_1_2_collecttranslatedelements_blackBBBB(
			MSingleVariableAccess mAccess, TReadWrite tAccess,
	...
	public static final Object[] pattern_FieldAccessReadWrite_1_2_collecttranslatedelements_greenFBBBB(
			MSingleVariableAccess mAccess, TReadWrite tAccess,
			MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner,
			MSingleVariableAccessToTAccess mAccessToTAccess) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_1_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
		...
		String ruleresult_ruleName_prime = "FieldAccessReadWrite";
	...
	public static final void pattern_FieldAccessReadWrite_1_5_registerobjects_expressionBBBBBBBBBBBBB(
			FieldAccessReadWrite _this, PerformRuleResult ruleresult, EObject mAccess, EObject mMemberToTMember,
			EObject varDeclFrag, EObject tMember, EObject mField, EObject tAccess, EObject mMethodToTMethod,
			EObject mFlowOwnerToTFlowOwner, EObject mMember, EObject tField, EObject mAccessToTAccess) {
	...
	public static final PerformRuleResult pattern_FieldAccessReadWrite_1_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_2_1_preparereturnvalue_bindingFB(
			FieldAccessReadWrite _this) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_2_1_preparereturnvalue_blackFBB(EClass eClass,
			FieldAccessReadWrite _this) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_2_1_preparereturnvalue_bindingAndBlackFFB(
			FieldAccessReadWrite _this) {
		Object[] result_pattern_FieldAccessReadWrite_2_1_preparereturnvalue_binding = pattern_FieldAccessReadWrite_2_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FieldAccessReadWrite_2_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_FieldAccessReadWrite_2_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_2_1_preparereturnvalue_black = pattern_FieldAccessReadWrite_2_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_FieldAccessReadWrite_2_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_FieldAccessReadWrite_2_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_FieldAccessReadWrite_2_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "FieldAccessReadWrite";
	...
	public static final Object[] pattern_FieldAccessReadWrite_2_2_corematch_bindingFFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_FieldAccessReadWrite_2_2_corematch_blackBFBFBFBFB(
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, MFieldDefinition mField,
			MDefinition mMember, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mField.equals(mMember)) {
			AccessKind mAccess_accessKind = mAccess.getAccessKind();
			if (mAccess_accessKind.equals(AccessKind.READWRITE)) {
	...
	public static final Iterable<Object[]> pattern_FieldAccessReadWrite_2_3_findcontext_blackBBBBBBBB(
			MSingleVariableAccess mAccess, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
	...
	public static final Object[] pattern_FieldAccessReadWrite_2_3_findcontext_greenBBBBBBBBFFFFFFFFFF(
			MSingleVariableAccess mAccess, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_2_4_solveCSP_bindingFBBBBBBBBBB(
			FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch, MSingleVariableAccess mAccess,
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
	...
	public static final Object[] pattern_FieldAccessReadWrite_2_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessReadWrite_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
			FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch, MSingleVariableAccess mAccess,
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
			TFieldDefinition tField) {
		Object[] result_pattern_FieldAccessReadWrite_2_4_solveCSP_binding = pattern_FieldAccessReadWrite_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mAccess, mMemberToTMember, varDeclFrag, tMember, mField, mMethodToTMethod,
				mMember, tField);
		if (result_pattern_FieldAccessReadWrite_2_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessReadWrite_2_4_solveCSP_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_2_4_solveCSP_black = pattern_FieldAccessReadWrite_2_4_solveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessReadWrite_2_4_solveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessReadWrite_2_5_checkCSP_expressionFBB(FieldAccessReadWrite _this,
			CSP csp) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_2_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_FieldAccessReadWrite_2_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "FieldAccessReadWrite";
		ruleresult.setSuccess(Boolean.valueOf(ruleresult_success_prime));
		isApplicableMatch.setRuleName(isApplicableMatch_ruleName_prime);
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final IsApplicableRuleResult pattern_FieldAccessReadWrite_2_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_10_1_initialbindings_blackBBBBB(
			FieldAccessReadWrite _this, Match match, TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {
		if (!tField.equals(tMember)) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_10_2_SolveCSP_bindingFBBBBB(FieldAccessReadWrite _this,
			Match match, TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_10_2_SolveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessReadWrite_10_2_SolveCSP_bindingAndBlackFBBBBB(
			FieldAccessReadWrite _this, Match match, TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {
		Object[] result_pattern_FieldAccessReadWrite_10_2_SolveCSP_binding = pattern_FieldAccessReadWrite_10_2_SolveCSP_bindingFBBBBB(
				_this, match, tMember, tAccess, tField);
		if (result_pattern_FieldAccessReadWrite_10_2_SolveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessReadWrite_10_2_SolveCSP_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_10_2_SolveCSP_black = pattern_FieldAccessReadWrite_10_2_SolveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessReadWrite_10_2_SolveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessReadWrite_10_3_CheckCSP_expressionFBB(FieldAccessReadWrite _this,
			CSP csp) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_10_4_collectelementstobetranslated_blackBBBB(Match match,
			TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {
		if (!tField.equals(tMember)) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_10_4_collectelementstobetranslated_greenBBBBFFFF(
			Match match, TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {
		EMoflonEdge tMember__tAccess____tAccessing = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAccess__tMember____tSource = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAccess__tField____tTarget = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_FieldAccessReadWrite_10_5_collectcontextelements_blackBBBB(Match match,
			TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {
		if (!tField.equals(tMember)) {
			return new Object[] { match, tMember, tAccess, tField };
		}
	...
	public static final Object[] pattern_FieldAccessReadWrite_10_5_collectcontextelements_greenBBB(Match match,
	...
	public static final void pattern_FieldAccessReadWrite_10_6_registerobjectstomatch_expressionBBBBB(
			FieldAccessReadWrite _this, Match match, TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {
		_this.registerObjectsToMatch_BWD(match, tMember, tAccess, tField);

	}

	public static final boolean pattern_FieldAccessReadWrite_10_7_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FieldAccessReadWrite_10_8_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_11_1_performtransformation_bindingFFFFFFFFB(
			IsApplicableMatch isApplicableMatch) {
		...
		if (tmpMMemberToTMember instanceof MDefinitionToTMember) {
			...
			if (tmpVarDeclFrag instanceof VariableDeclarationFragment) {
				...
				if (tmpTMember instanceof TMember) {
					...
					if (tmpMField instanceof MFieldDefinition) {
						MFieldDefinition mField = (MFieldDefinition) tmpMField;
						if (tmpTAccess instanceof TReadWrite) {
							TReadWrite tAccess = (TReadWrite) tmpTAccess;
							if (tmpMMethodToTMethod instanceof MDefinitionToTMember) {
								MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) tmpMMethodToTMethod;
								if (tmpMMember instanceof MDefinition) {
									MDefinition mMember = (MDefinition) tmpMMember;
	...
	public static final Object[] pattern_FieldAccessReadWrite_11_1_performtransformation_blackBBBBBBBBFBB(
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TReadWrite tAccess, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
			TFieldDefinition tField, FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch) {
		if (!mMemberToTMember.equals(mMethodToTMethod)) {
			if (!mField.equals(mMember)) {
				if (!tField.equals(tMember)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_11_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
			FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch) {
		Object[] result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding = pattern_FieldAccessReadWrite_11_1_performtransformation_bindingFFFFFFFFB(
				isApplicableMatch);
		if (result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding != null) {
			MDefinitionToTMember mMemberToTMember = (MDefinitionToTMember) result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding[0];
			VariableDeclarationFragment varDeclFrag = (VariableDeclarationFragment) result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding[1];
			TMember tMember = (TMember) result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding[2];
			MFieldDefinition mField = (MFieldDefinition) result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding[3];
			TReadWrite tAccess = (TReadWrite) result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding[4];
			MDefinitionToTMember mMethodToTMethod = (MDefinitionToTMember) result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding[5];
			MDefinition mMember = (MDefinition) result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding[6];
			TFieldDefinition tField = (TFieldDefinition) result_pattern_FieldAccessReadWrite_11_1_performtransformation_binding[7];

			Object[] result_pattern_FieldAccessReadWrite_11_1_performtransformation_black = pattern_FieldAccessReadWrite_11_1_performtransformation_blackBBBBBBBBFBB(
					mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod, mMember, tField, _this,
					isApplicableMatch);
			if (result_pattern_FieldAccessReadWrite_11_1_performtransformation_black != null) {
				CSP csp = (CSP) result_pattern_FieldAccessReadWrite_11_1_performtransformation_black[8];
	...
	public static final Object[] pattern_FieldAccessReadWrite_11_1_performtransformation_greenFBBFBF(
			VariableDeclarationFragment varDeclFrag, TReadWrite tAccess, MDefinition mMember) {
		MSingleVariableAccess mAccess = org.gravity.modisco.ModiscoFactory.eINSTANCE.createMSingleVariableAccess();
		MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner = ModiscoFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MSingleVariableAccessToTAccess mAccessToTAccess = ModiscoFactory.eINSTANCE
				.createMSingleVariableAccessToTAccess();
		AccessKind mAccess_accessKind_prime = AccessKind.READWRITE;
	...
	public static final Object[] pattern_FieldAccessReadWrite_11_2_collecttranslatedelements_blackBBBB(
			MSingleVariableAccess mAccess, TReadWrite tAccess,
			MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner,
			MSingleVariableAccessToTAccess mAccessToTAccess) {
		return new Object[] { mAccess, tAccess, mFlowOwnerToTFlowOwner, mAccessToTAccess };
	...
	public static final Object[] pattern_FieldAccessReadWrite_11_2_collecttranslatedelements_greenFBBBB(
			MSingleVariableAccess mAccess, TReadWrite tAccess,
			MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner,
			MSingleVariableAccessToTAccess mAccessToTAccess) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_FieldAccessReadWrite_11_3_bookkeepingforedges_blackBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mAccess, EObject mMemberToTMember, EObject varDeclFrag,
			EObject tMember, EObject mField, EObject tAccess, EObject mMethodToTMethod, EObject mFlowOwnerToTFlowOwner,
			EObject mMember, EObject tField, EObject mAccessToTAccess) {
		if (!mAccess.equals(mMemberToTMember)) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_11_3_bookkeepingforedges_greenBBBBBBBBBFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject mAccess, EObject varDeclFrag, EObject tMember, EObject tAccess,
			EObject mFlowOwnerToTFlowOwner, EObject mMember, EObject tField, EObject mAccessToTAccess) {
		EMoflonEdge tMember__tAccess____tAccessing = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tAccess__tMember____tSource = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_FieldAccessReadWrite_11_5_registerobjects_expressionBBBBBBBBBBBBB(
			FieldAccessReadWrite _this, PerformRuleResult ruleresult, EObject mAccess, EObject mMemberToTMember,
			EObject varDeclFrag, EObject tMember, EObject mField, EObject tAccess, EObject mMethodToTMethod,
			EObject mFlowOwnerToTFlowOwner, EObject mMember, EObject tField, EObject mAccessToTAccess) {
	...
	public static final PerformRuleResult pattern_FieldAccessReadWrite_11_6_expressionFB(PerformRuleResult ruleresult) {
		PerformRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_12_1_preparereturnvalue_bindingFB(
			FieldAccessReadWrite _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass eClass = _localVariable_0;
		if (eClass != null) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_12_1_preparereturnvalue_blackFBB(EClass eClass,
			FieldAccessReadWrite _this) {
		for (EOperation performOperation : eClass.getEOperations()) {
			String performOperation_name = performOperation.getName();
	...
	public static final Object[] pattern_FieldAccessReadWrite_12_1_preparereturnvalue_bindingAndBlackFFB(
			FieldAccessReadWrite _this) {
		Object[] result_pattern_FieldAccessReadWrite_12_1_preparereturnvalue_binding = pattern_FieldAccessReadWrite_12_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FieldAccessReadWrite_12_1_preparereturnvalue_binding != null) {
			EClass eClass = (EClass) result_pattern_FieldAccessReadWrite_12_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_12_1_preparereturnvalue_black = pattern_FieldAccessReadWrite_12_1_preparereturnvalue_blackFBB(
					eClass, _this);
			if (result_pattern_FieldAccessReadWrite_12_1_preparereturnvalue_black != null) {
				EOperation performOperation = (EOperation) result_pattern_FieldAccessReadWrite_12_1_preparereturnvalue_black[0];
	...
	public static final Object[] pattern_FieldAccessReadWrite_12_1_preparereturnvalue_greenBF(
			EOperation performOperation) {
		IsApplicableRuleResult ruleresult = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		boolean ruleresult_success_prime = Boolean.valueOf(false);
		String ruleresult_rule_prime = "FieldAccessReadWrite";
	...
	public static final Object[] pattern_FieldAccessReadWrite_12_2_corematch_bindingFFFB(Match match) {
	...
	public static final Iterable<Object[]> pattern_FieldAccessReadWrite_12_2_corematch_blackFBFBFFBB(TMember tMember,
			TReadWrite tAccess, TFieldDefinition tField, Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!tField.equals(tMember)) {
			for (MDefinitionToTMember mMethodToTMethod : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_FieldAccessReadWrite_12_3_findcontext_blackBFBBBBBB(
			MDefinitionToTMember mMemberToTMember, TMember tMember, MFieldDefinition mField, TReadWrite tAccess,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mMemberToTMember.equals(mMethodToTMethod)) {
			if (!mField.equals(mMember)) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_12_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TReadWrite tAccess, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
			TFieldDefinition tField) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
		...
		return new Object[] { mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod, mMember,
				...
				mMethodToTMethod__mField____source, mMethodToTMethod__tField____target, tAccess__tField____tTarget,
				tField__tAccess____accessedBy, mMemberToTMember__tMember____target };
	}

	public static final Object[] pattern_FieldAccessReadWrite_12_4_solveCSP_bindingFBBBBBBBBBB(
			FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField, TReadWrite tAccess,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_12_4_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessReadWrite_12_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
			FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField, TReadWrite tAccess,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField) {
		Object[] result_pattern_FieldAccessReadWrite_12_4_solveCSP_binding = pattern_FieldAccessReadWrite_12_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mMemberToTMember, varDeclFrag, tMember, mField, tAccess, mMethodToTMethod,
				mMember, tField);
		if (result_pattern_FieldAccessReadWrite_12_4_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessReadWrite_12_4_solveCSP_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_12_4_solveCSP_black = pattern_FieldAccessReadWrite_12_4_solveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessReadWrite_12_4_solveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessReadWrite_12_5_checkCSP_expressionFBB(FieldAccessReadWrite _this,
			CSP csp) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_12_6_addmatchtoruleresult_blackBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		return new Object[] { ruleresult, isApplicableMatch };
	}

	public static final Object[] pattern_FieldAccessReadWrite_12_6_addmatchtoruleresult_greenBB(
			IsApplicableRuleResult ruleresult, IsApplicableMatch isApplicableMatch) {
		ruleresult.getIsApplicableMatch().add(isApplicableMatch);
		boolean ruleresult_success_prime = Boolean.valueOf(true);
		String isApplicableMatch_ruleName_prime = "FieldAccessReadWrite";
	...
	public static final IsApplicableRuleResult pattern_FieldAccessReadWrite_12_7_expressionFB(
			IsApplicableRuleResult ruleresult) {
		IsApplicableRuleResult _result = ruleresult;
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_20_1_preparereturnvalue_bindingFB(
			FieldAccessReadWrite _this) {
		EClass _localVariable_0 = _this.eClass();
	...
	public static final Object[] pattern_FieldAccessReadWrite_20_1_preparereturnvalue_blackFBBF(EClass __eClass,
			FieldAccessReadWrite _this) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_20_1_preparereturnvalue_bindingAndBlackFFBF(
			FieldAccessReadWrite _this) {
		Object[] result_pattern_FieldAccessReadWrite_20_1_preparereturnvalue_binding = pattern_FieldAccessReadWrite_20_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FieldAccessReadWrite_20_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_FieldAccessReadWrite_20_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_20_1_preparereturnvalue_black = pattern_FieldAccessReadWrite_20_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_FieldAccessReadWrite_20_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_FieldAccessReadWrite_20_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_FieldAccessReadWrite_20_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_FieldAccessReadWrite_20_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}

	public static final Iterable<Object[]> pattern_FieldAccessReadWrite_20_2_testcorematchandDECs_blackFFFB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_20_2_testcorematchandDECs_greenFB(EClass __eClass) {
	...
	public static final boolean pattern_FieldAccessReadWrite_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			FieldAccessReadWrite _this, Match match, TMember tMember, TReadWrite tAccess, TFieldDefinition tField) {
	...
	public static final boolean pattern_FieldAccessReadWrite_20_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			FieldAccessReadWrite _this, Match match) {
		boolean _localVariable_0 = _this.checkTypes_BWD(match);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_20_5_Addmatchtoruleresult_blackBBBB(Match match,
	...
	public static final Object[] pattern_FieldAccessReadWrite_20_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
	...
	public static final EObjectContainer pattern_FieldAccessReadWrite_20_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_21_1_preparereturnvalue_bindingFB(
			FieldAccessReadWrite _this) {
		EClass _localVariable_0 = _this.eClass();
		EClass __eClass = _localVariable_0;
		if (__eClass != null) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_21_1_preparereturnvalue_blackFBBF(EClass __eClass,
			FieldAccessReadWrite _this) {
		for (EOperation __performOperation : __eClass.getEOperations()) {
			String __performOperation_name = __performOperation.getName();
	...
	public static final Object[] pattern_FieldAccessReadWrite_21_1_preparereturnvalue_bindingAndBlackFFBF(
			FieldAccessReadWrite _this) {
		Object[] result_pattern_FieldAccessReadWrite_21_1_preparereturnvalue_binding = pattern_FieldAccessReadWrite_21_1_preparereturnvalue_bindingFB(
				_this);
		if (result_pattern_FieldAccessReadWrite_21_1_preparereturnvalue_binding != null) {
			EClass __eClass = (EClass) result_pattern_FieldAccessReadWrite_21_1_preparereturnvalue_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_21_1_preparereturnvalue_black = pattern_FieldAccessReadWrite_21_1_preparereturnvalue_blackFBBF(
					__eClass, _this);
			if (result_pattern_FieldAccessReadWrite_21_1_preparereturnvalue_black != null) {
				EOperation __performOperation = (EOperation) result_pattern_FieldAccessReadWrite_21_1_preparereturnvalue_black[0];
				EOperation isApplicableCC = (EOperation) result_pattern_FieldAccessReadWrite_21_1_preparereturnvalue_black[3];
	...
	public static final Object[] pattern_FieldAccessReadWrite_21_1_preparereturnvalue_greenF() {
		EObjectContainer __result = RuntimeFactory.eINSTANCE.createEObjectContainer();
		return new Object[] { __result };
	}
	...
	public static final Object[] pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_black_nac_0BBB(
		...
		if (!mField.equals(mMember)) {
			for (MDefinition __DEC_mAccess_mAbstractFieldAccess_462004 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mAccess, MDefinition.class, "mAbstractFieldAccess")) {
				if (!mField.equals(__DEC_mAccess_mAbstractFieldAccess_462004)) {
					if (!mMember.equals(__DEC_mAccess_mAbstractFieldAccess_462004)) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_black_nac_1B(
		...
		for (AnnotationMemberValuePair __DEC_mAccess_value_468343 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_black_nac_2BB(
	...
	public static final Iterable<Object[]> pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_blackFFFFB(
					...
					if (tmpVarDeclFrag instanceof VariableDeclarationFragment) {
						...
						if (mAccess_accessKind.equals(AccessKind.READWRITE)) {
							...
							if (tmpMField instanceof MFieldDefinition) {
								MFieldDefinition mField = (MFieldDefinition) tmpMField;
								if (!mField.equals(mMember)) {
									if (pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_black_nac_1B(
											mAccess) == null) {
										if (pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_black_nac_0BBB(
												mAccess, mField, mMember) == null) {
											if (pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_black_nac_2BB(
													mField, mAccess) == null) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_21_2_testcorematchandDECs_greenFB(EClass __eClass) {
		Match match = RuntimeFactory.eINSTANCE.createMatch();
		String __eClass_name = __eClass.getName();
		String match_ruleName_prime = __eClass_name;
		match.setRuleName(match_ruleName_prime);
	...
	public static final boolean pattern_FieldAccessReadWrite_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			FieldAccessReadWrite _this, Match match, MSingleVariableAccess mAccess,
			VariableDeclarationFragment varDeclFrag, MFieldDefinition mField, MDefinition mMember) {
	...
	public static final boolean pattern_FieldAccessReadWrite_21_4_Ensurethatthecorrecttypesofelementsarematched_expressionFBB(
			FieldAccessReadWrite _this, Match match) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_21_5_Addmatchtoruleresult_blackBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		if (!__performOperation.equals(isApplicableCC)) {
			return new Object[] { match, __performOperation, __result, isApplicableCC };
		}
	...
	public static final Object[] pattern_FieldAccessReadWrite_21_5_Addmatchtoruleresult_greenBBBB(Match match,
			EOperation __performOperation, EObjectContainer __result, EOperation isApplicableCC) {
		__result.getContents().add(match);
		match.setIsApplicableOperation(__performOperation);
		match.setIsApplicableCCOperation(isApplicableCC);
	...
	public static final EObjectContainer pattern_FieldAccessReadWrite_21_6_expressionFB(EObjectContainer __result) {
		EObjectContainer _result = __result;
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_24_1_prepare_blackB(FieldAccessReadWrite _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_FieldAccessReadWrite_24_1_prepare_greenF() {
		IsApplicableRuleResult result = RuntimeFactory.eINSTANCE.createIsApplicableRuleResult();
		return new Object[] { result };
	}

	public static final Object[] pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_bindingFFFFFFFBB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_blackBBBBBBBBB(
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TReadWrite tAccess, MDefinition mMember, TFieldDefinition tField,
			Match sourceMatch, Match targetMatch) {
		if (!mField.equals(mMember)) {
			if (!tField.equals(tMember)) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_binding = pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_bindingFFFFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_binding != null) {
			MSingleVariableAccess mAccess = (MSingleVariableAccess) result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_binding[0];
			VariableDeclarationFragment varDeclFrag = (VariableDeclarationFragment) result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_binding[1];
			TMember tMember = (TMember) result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_binding[2];
			MFieldDefinition mField = (MFieldDefinition) result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_binding[3];
			TReadWrite tAccess = (TReadWrite) result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_binding[4];
			MDefinition mMember = (MDefinition) result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_binding[5];
			TFieldDefinition tField = (TFieldDefinition) result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_binding[6];

			Object[] result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_black = pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					mAccess, varDeclFrag, tMember, mField, tAccess, mMember, tField, sourceMatch, targetMatch);
			if (result_pattern_FieldAccessReadWrite_24_2_matchsrctrgcontext_black != null) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_24_3_solvecsp_bindingFBBBBBBBBBB(
			FieldAccessReadWrite _this, MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag,
			TMember tMember, MFieldDefinition mField, TReadWrite tAccess, MDefinition mMember, TFieldDefinition tField,
			Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_24_3_solvecsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessReadWrite_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
			FieldAccessReadWrite _this, MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag,
			TMember tMember, MFieldDefinition mField, TReadWrite tAccess, MDefinition mMember, TFieldDefinition tField,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_FieldAccessReadWrite_24_3_solvecsp_binding = pattern_FieldAccessReadWrite_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, mAccess, varDeclFrag, tMember, mField, tAccess, mMember, tField, sourceMatch, targetMatch);
		if (result_pattern_FieldAccessReadWrite_24_3_solvecsp_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessReadWrite_24_3_solvecsp_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_24_3_solvecsp_black = pattern_FieldAccessReadWrite_24_3_solvecsp_blackB(
					csp);
			if (result_pattern_FieldAccessReadWrite_24_3_solvecsp_black != null) {
	...
	public static final boolean pattern_FieldAccessReadWrite_24_4_checkCSP_expressionFB(CSP csp) {
		boolean _localVariable_0 = csp.check();
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Iterable<Object[]> pattern_FieldAccessReadWrite_24_5_matchcorrcontext_blackFBBFBBBB(
			TMember tMember, MFieldDefinition mField, MDefinition mMember, TFieldDefinition tField, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!mField.equals(mMember)) {
			if (!tField.equals(tMember)) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_24_5_matchcorrcontext_greenBBBBF(
			MDefinitionToTMember mMemberToTMember, MDefinitionToTMember mMethodToTMethod, Match sourceMatch,
			Match targetMatch) {
		CCMatch ccMatch = RuntimeFactory.eINSTANCE.createCCMatch();
		String ccMatch_ruleName_prime = "FieldAccessReadWrite";
	...
	public static final Object[] pattern_FieldAccessReadWrite_24_6_createcorrespondence_blackBBBBBBBB(
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, TReadWrite tAccess, MDefinition mMember, TFieldDefinition tField,
			CCMatch ccMatch) {
		if (!mField.equals(mMember)) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_24_6_createcorrespondence_greenBBFFB(
			MSingleVariableAccess mAccess, TReadWrite tAccess, CCMatch ccMatch) {
		MAbstractFlowElementToTAbstractFlowElement mFlowOwnerToTFlowOwner = ModiscoFactory.eINSTANCE
				.createMAbstractFlowElementToTAbstractFlowElement();
		MSingleVariableAccessToTAccess mAccessToTAccess = ModiscoFactory.eINSTANCE
				.createMSingleVariableAccessToTAccess();
	...
	public static final Object[] pattern_FieldAccessReadWrite_24_7_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
		return new Object[] { result, ccMatch };
	}

	public static final Object[] pattern_FieldAccessReadWrite_24_7_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
	...
	public static final IsApplicableRuleResult pattern_FieldAccessReadWrite_24_8_expressionFB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_27_1_matchtggpattern_black_nac_0BBB(
			MSingleVariableAccess mAccess, MFieldDefinition mField, MDefinition mMember) {
		if (!mField.equals(mMember)) {
			for (MDefinition __DEC_mAccess_mAbstractFieldAccess_85331 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mAccess, MDefinition.class, "mAbstractFieldAccess")) {
				if (!mField.equals(__DEC_mAccess_mAbstractFieldAccess_85331)) {
					if (!mMember.equals(__DEC_mAccess_mAbstractFieldAccess_85331)) {
						return new Object[] { mAccess, mField, mMember };
					}
				}
			}
	...
	public static final Object[] pattern_FieldAccessReadWrite_27_1_matchtggpattern_black_nac_1B(
			MSingleVariableAccess mAccess) {
		for (AnnotationMemberValuePair __DEC_mAccess_value_861295 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mAccess };
		}
		return null;
	...
	public static final Object[] pattern_FieldAccessReadWrite_27_1_matchtggpattern_black_nac_2BB(
			MFieldDefinition mField, MSingleVariableAccess mAccess) {
		if (mField.getMAbstractFieldAccess().contains(mAccess)) {
			return new Object[] { mField, mAccess };
		}
	...
	public static final Object[] pattern_FieldAccessReadWrite_27_1_matchtggpattern_blackBBBB(
			MSingleVariableAccess mAccess, VariableDeclarationFragment varDeclFrag, MFieldDefinition mField,
			MDefinition mMember) {
		if (!mField.equals(mMember)) {
			if (mField.equals(varDeclFrag.getVariablesContainer())) {
				if (mMember.getMAbstractFieldAccess().contains(mAccess)) {
					if (varDeclFrag.equals(mAccess.getVariable())) {
						if (pattern_FieldAccessReadWrite_27_1_matchtggpattern_black_nac_0BBB(mAccess, mField,
								mMember) == null) {
							if (pattern_FieldAccessReadWrite_27_1_matchtggpattern_black_nac_1B(mAccess) == null) {
								if (pattern_FieldAccessReadWrite_27_1_matchtggpattern_black_nac_2BB(mField,
										mAccess) == null) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_27_1_matchtggpattern_greenB(
			MSingleVariableAccess mAccess) {
		AccessKind mAccess_accessKind_prime = AccessKind.READWRITE;
		mAccess.setAccessKind(mAccess_accessKind_prime);
		return new Object[] { mAccess };
	...
	public static final boolean pattern_FieldAccessReadWrite_27_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FieldAccessReadWrite_27_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_28_1_matchtggpattern_blackBBB(TMember tMember,
			TReadWrite tAccess, TFieldDefinition tField) {
		if (!tField.equals(tMember)) {
			if (tMember.getTAccessing().contains(tAccess)) {
				if (tField.equals(tAccess.getTTarget())) {
	...
	public static final boolean pattern_FieldAccessReadWrite_28_2_expressionF() {
		boolean _result = Boolean.valueOf(true);
		return _result;
	}

	public static final boolean pattern_FieldAccessReadWrite_28_3_expressionF() {
		boolean _result = Boolean.valueOf(false);
		return _result;
	}

	public static final Object[] pattern_FieldAccessReadWrite_29_1_createresult_blackB(FieldAccessReadWrite _this) {
		return new Object[] { _this };
	}

	public static final Object[] pattern_FieldAccessReadWrite_29_1_createresult_greenFF() {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_0BB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_1BB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_2BB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_3BB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_4BB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_5BB(
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_6BB(
	...
	public static final Iterable<Object[]> pattern_FieldAccessReadWrite_29_2_isapplicablecore_blackFFFFFFFFFBB(
					...
					for (EObject tmpMMemberToTMember : mMemberToTMemberList.getEntryObjects()) {
						if (tmpMMemberToTMember instanceof MDefinitionToTMember) {
							...
							if (tmpMMember instanceof MDefinition) {
								...
								TMember tMember = mMemberToTMember.getTarget();
								if (tMember != null) {
									if (pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_0BB(ruleResult,
											mMemberToTMember) == null) {
										if (pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_1BB(ruleResult,
												mMember) == null) {
											if (pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_2BB(
															...
															if (tmpMField instanceof MFieldDefinition) {
																...
																if (!mField.equals(mMember)) {
																	...
																	if (tmpTField instanceof TFieldDefinition) {
																		TFieldDefinition tField = (TFieldDefinition) tmpTField;
																		if (!tField.equals(tMember)) {
																			if (pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_5BB(
																					ruleResult,
																					mMethodToTMethod) == null) {
																				if (pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_4BB(
																						ruleResult, mField) == null) {
																					if (pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_6BB(
																							ruleResult,
																							tField) == null) {
																						for (VariableDeclarationFragment varDeclFrag : mField
																								.getFragments()) {
																							if (pattern_FieldAccessReadWrite_29_2_isapplicablecore_black_nac_3BB(
																									ruleResult,
																									varDeclFrag) == null) {
																								_result.add(
																										new Object[] {
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_3_solveCSP_bindingFBBBBBBBBBB(
			FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField,
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_3_solveCSP_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_FieldAccessReadWrite_29_3_solveCSP_bindingAndBlackFBBBBBBBBBB(
			FieldAccessReadWrite _this, IsApplicableMatch isApplicableMatch, MDefinitionToTMember mMemberToTMember,
			VariableDeclarationFragment varDeclFrag, TMember tMember, MFieldDefinition mField,
			MDefinitionToTMember mMethodToTMethod, MDefinition mMember, TFieldDefinition tField,
			ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_FieldAccessReadWrite_29_3_solveCSP_binding = pattern_FieldAccessReadWrite_29_3_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, mMemberToTMember, varDeclFrag, tMember, mField, mMethodToTMethod, mMember,
				tField, ruleResult);
		if (result_pattern_FieldAccessReadWrite_29_3_solveCSP_binding != null) {
			CSP csp = (CSP) result_pattern_FieldAccessReadWrite_29_3_solveCSP_binding[0];

			Object[] result_pattern_FieldAccessReadWrite_29_3_solveCSP_black = pattern_FieldAccessReadWrite_29_3_solveCSP_blackB(
					csp);
			if (result_pattern_FieldAccessReadWrite_29_3_solveCSP_black != null) {
	...
	public static final boolean pattern_FieldAccessReadWrite_29_4_checkCSP_expressionFBB(FieldAccessReadWrite _this,
			CSP csp) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_5_checknacs_blackBBBBBBB(
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
			TFieldDefinition tField) {
		if (!mMemberToTMember.equals(mMethodToTMethod)) {
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_6_perform_blackBBBBBBBB(
			MDefinitionToTMember mMemberToTMember, VariableDeclarationFragment varDeclFrag, TMember tMember,
			MFieldDefinition mField, MDefinitionToTMember mMethodToTMethod, MDefinition mMember,
	...
	public static final Object[] pattern_FieldAccessReadWrite_29_6_perform_greenFBBFFBBFB(
	...
	public static final ModelgeneratorRuleResult pattern_FieldAccessReadWrite_29_7_expressionFB(
			ModelgeneratorRuleResult ruleResult) {
