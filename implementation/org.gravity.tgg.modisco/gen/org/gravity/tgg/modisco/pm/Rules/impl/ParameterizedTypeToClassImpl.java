...
public class ParameterizedTypeToClassImpl extends AbstractRuleImpl implements ParameterizedTypeToClass {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, Type eType, ParameterizedType eParameterizedType,
			TypeAccess eTypeAccess, Model eModel) {

		Object[] result1_black = ParameterizedTypeToClassImpl
				.pattern_ParameterizedTypeToClass_0_1_initialbindings_blackBBBBBB(this, match, eType,
						eParameterizedType, eTypeAccess, eModel);
		...
		Object[] result2_bindingAndBlack = ParameterizedTypeToClassImpl
				.pattern_ParameterizedTypeToClass_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, eType,
						eParameterizedType, eTypeAccess, eModel);
		...
		if (ParameterizedTypeToClassImpl.pattern_ParameterizedTypeToClass_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			Object[] result4_black = ParameterizedTypeToClassImpl
					.pattern_ParameterizedTypeToClass_0_4_collectelementstobetranslated_blackBBBBB(match, eType,
							eParameterizedType, eTypeAccess, eModel);
			...
			ParameterizedTypeToClassImpl
					.pattern_ParameterizedTypeToClass_0_4_collectelementstobetranslated_greenBBBBBFFFF(match, eType,
							eParameterizedType, eTypeAccess, eModel);
			...
			//nothing EMoflonEdge eModel__eParameterizedType____orphanTypes = (EMoflonEdge) result4_green[8];

			Object[] result5_black = ParameterizedTypeToClassImpl
					.pattern_ParameterizedTypeToClass_0_5_collectcontextelements_blackBBBBB(match, eType,
							eParameterizedType, eTypeAccess, eModel);
			...
			ParameterizedTypeToClassImpl.pattern_ParameterizedTypeToClass_0_6_registerobjectstomatch_expressionBBBBBB(
					this, match, eType, eParameterizedType, eTypeAccess, eModel);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ParameterizedTypeToClassImpl
				.pattern_ParameterizedTypeToClass_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, pg,
						eTypeToTAbstractType, eParameterizedTypeToTAbstractType, eType, eModelToPg, tAbstractType,
						eParameterizedType, eTypeAccess, eModel);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[pg] = " + pg + ", " + "[eTypeToTAbstractType] = " + eTypeToTAbstractType + ", "
					+ "[eParameterizedTypeToTAbstractType] = " + eParameterizedTypeToTAbstractType + ", " + "[eType] = "
					+ eType + ", " + "[eModelToPg] = " + eModelToPg + ", " + "[tAbstractType] = " + tAbstractType + ", "
					+ "[eParameterizedType] = " + eParameterizedType + ", " + "[eTypeAccess] = " + eTypeAccess + ", "
					+ "[eModel] = " + eModel + ".");
		}
		ParameterizedTypeToClassImpl.pattern_ParameterizedTypeToClass_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
				ruleresult, eParameterizedTypeToTAbstractType, eType, tAbstractType, eParameterizedType, eTypeAccess,
				eModel);
		...
		//nothing EMoflonEdge eModel__eParameterizedType____orphanTypes = (EMoflonEdge) result3_green[12];

		// 
		// 
		ParameterizedTypeToClassImpl.pattern_ParameterizedTypeToClass_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, pg, eTypeToTAbstractType, eParameterizedTypeToTAbstractType, eType, eModelToPg,
				tAbstractType, eParameterizedType, eTypeAccess, eModel);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ParameterizedTypeToClassImpl
				.pattern_ParameterizedTypeToClass_2_2_corematch_blackFFBFFBBBB(eType, eParameterizedType, eTypeAccess,
						eModel, match)) {
			...
			for (Object[] result3_black : ParameterizedTypeToClassImpl
					.pattern_ParameterizedTypeToClass_2_3_findcontext_blackBBBBBBBB(pg, eTypeToTAbstractType, eType,
							eModelToPg, tAbstractType, eParameterizedType, eTypeAccess, eModel)) {
				Object[] result3_green = ParameterizedTypeToClassImpl
						.pattern_ParameterizedTypeToClass_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(pg,
								eTypeToTAbstractType, eType, eModelToPg, tAbstractType, eParameterizedType, eTypeAccess,
								eModel);
				...
				//nothing EMoflonEdge eModelToPg__eModel____source = (EMoflonEdge) result3_green[16];
				//nothing EMoflonEdge pg__tAbstractType____ownedTypes = (EMoflonEdge) result3_green[17];
				//nothing EMoflonEdge tAbstractType__pg____pg = (EMoflonEdge) result3_green[18];
				...
				Object[] result4_bindingAndBlack = ParameterizedTypeToClassImpl
						.pattern_ParameterizedTypeToClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this,
								isApplicableMatch, pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType,
								eParameterizedType, eTypeAccess, eModel);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[pg] = " + pg + ", "
							+ "[eTypeToTAbstractType] = " + eTypeToTAbstractType + ", " + "[eType] = " + eType + ", "
							+ "[eModelToPg] = " + eModelToPg + ", " + "[tAbstractType] = " + tAbstractType + ", "
							+ "[eParameterizedType] = " + eParameterizedType + ", " + "[eTypeAccess] = " + eTypeAccess
							+ ", " + "[eModel] = " + eModel + ".");
				}
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, Type eType, ParameterizedType eParameterizedType,
			TypeAccess eTypeAccess, Model eModel) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, Type eType, ParameterizedType eParameterizedType,
			TypeAccess eTypeAccess, Model eModel) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeGraph pg,
			TypeToTAbstractType eTypeToTAbstractType, Type eType, ModelToTypeGraph eModelToPg,
			TAbstractType tAbstractType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject pg, EObject eTypeToTAbstractType,
			EObject eParameterizedTypeToTAbstractType, EObject eType, EObject eModelToPg, EObject tAbstractType,
			EObject eParameterizedType, EObject eTypeAccess, EObject eModel) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ParameterizedTypeToClassImpl
				.pattern_ParameterizedTypeToClass_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, pg, eType,
						tAbstractType, eParameterizedType, eTypeAccess, eModel, sourceMatch, targetMatch);
		...
		if (ParameterizedTypeToClassImpl.pattern_ParameterizedTypeToClass_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ParameterizedTypeToClassImpl
					.pattern_ParameterizedTypeToClass_21_5_matchcorrcontext_blackBFBFBBBB(pg, eType, tAbstractType,
				...
				Object[] result6_black = ParameterizedTypeToClassImpl
						.pattern_ParameterizedTypeToClass_21_6_createcorrespondence_blackBBBBBBB(pg, eType,
								tAbstractType, eParameterizedType, eTypeAccess, eModel, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeGraph pg, Type eType, TAbstractType tAbstractType,
			ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel, Match sourceMatch,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(Type eType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			Model eModel) {// 
		Object[] result1_black = ParameterizedTypeToClassImpl
				.pattern_ParameterizedTypeToClass_24_1_matchtggpattern_blackBBBB(eType, eParameterizedType, eTypeAccess,
						eModel);
		if (result1_black != null) {
	...
	public ModelgeneratorRuleResult generateModel(RuleEntryContainer ruleEntryContainer,
		...
		for (Object[] result2_black : ParameterizedTypeToClassImpl
			...
			Type eType = (Type) result2_black[4];
			...
			Object[] result3_bindingAndBlack = ParameterizedTypeToClassImpl
					.pattern_ParameterizedTypeToClass_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType, eModel, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[pg] = " + pg + ", "
						+ "[eTypeToTAbstractType] = " + eTypeToTAbstractType + ", " + "[eType] = " + eType + ", "
			...
			if (ParameterizedTypeToClassImpl.pattern_ParameterizedTypeToClass_26_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = ParameterizedTypeToClassImpl
						.pattern_ParameterizedTypeToClass_26_5_checknacs_blackBBBBBB(pg, eTypeToTAbstractType, eType,
								eModelToPg, tAbstractType, eModel);
				if (result5_black != null) {

					Object[] result6_black = ParameterizedTypeToClassImpl
							.pattern_ParameterizedTypeToClass_26_6_perform_blackBBBBBBB(pg, eTypeToTAbstractType, eType,
									eModelToPg, tAbstractType, eModel, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[pg] = " + pg + ", "
								+ "[eTypeToTAbstractType] = " + eTypeToTAbstractType + ", " + "[eType] = " + eType
								+ ", " + "[eModelToPg] = " + eModelToPg + ", " + "[tAbstractType] = " + tAbstractType
					...
					ParameterizedTypeToClassImpl.pattern_ParameterizedTypeToClass_26_6_perform_greenFBBFFBB(eType,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeGraph pg,
			TypeToTAbstractType eTypeToTAbstractType, Type eType, ModelToTypeGraph eModelToPg,
			TAbstractType tAbstractType, Model eModel, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.PARAMETERIZED_TYPE_TO_CLASS___IS_APPROPRIATE_FWD__MATCH_TYPE_PARAMETERIZEDTYPE_TYPEACCESS_MODEL:
			return isAppropriate_FWD((Match) arguments.get(0), (Type) arguments.get(1),
					(ParameterizedType) arguments.get(2), (TypeAccess) arguments.get(3), (Model) arguments.get(4));
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_CLASS___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_TYPE_PARAMETERIZEDTYPE_TYPEACCESS_MODEL:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (Type) arguments.get(1),
					(ParameterizedType) arguments.get(2), (TypeAccess) arguments.get(3), (Model) arguments.get(4));
			return null;
		case RulesPackage.PARAMETERIZED_TYPE_TO_CLASS___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_TYPE_PARAMETERIZEDTYPE_TYPEACCESS_MODEL:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEGRAPH_TYPETOTABSTRACTTYPE_TYPE_MODELTOTYPEGRAPH_TABSTRACTTYPE_PARAMETERIZEDTYPE_TYPEACCESS_MODEL:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TypeGraph) arguments.get(1),
					...
					(ModelToTypeGraph) arguments.get(4), (TAbstractType) arguments.get(5),
					(ParameterizedType) arguments.get(6), (TypeAccess) arguments.get(7), (Model) arguments.get(8));
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_26__EMOFLONEDGE:
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__TYPEGRAPH_TYPE_TABSTRACTTYPE_PARAMETERIZEDTYPE_TYPEACCESS_MODEL_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeGraph) arguments.get(0), (Type) arguments.get(1),
					...
					(TypeAccess) arguments.get(4), (Model) arguments.get(5), (Match) arguments.get(6),
					(Match) arguments.get(7));
		case RulesPackage.PARAMETERIZED_TYPE_TO_CLASS___IS_APPLICABLE_CHECK_CSP_CC__CSP:
			return isApplicable_checkCsp_CC((CSP) arguments.get(0));
		case RulesPackage.PARAMETERIZED_TYPE_TO_CLASS___CHECK_DEC_FWD__TYPE_PARAMETERIZEDTYPE_TYPEACCESS_MODEL:
			return checkDEC_FWD((Type) arguments.get(0), (ParameterizedType) arguments.get(1),
		...
		case RulesPackage.PARAMETERIZED_TYPE_TO_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_TYPETOTABSTRACTTYPE_TYPE_MODELTOTYPEGRAPH_TABSTRACTTYPE_MODEL_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ParameterizedTypeToClass_0_1_initialbindings_blackBBBBBB(
			ParameterizedTypeToClass _this, Match match, Type eType, ParameterizedType eParameterizedType,
			TypeAccess eTypeAccess, Model eModel) {
		if (!eParameterizedType.equals(eType)) {
			return new Object[] { _this, match, eType, eParameterizedType, eTypeAccess, eModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToClass_0_2_SolveCSP_bindingFBBBBBB(
			ParameterizedTypeToClass _this, Match match, Type eType, ParameterizedType eParameterizedType,
			TypeAccess eTypeAccess, Model eModel) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, eType, eParameterizedType, eTypeAccess, eModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, eType, eParameterizedType, eTypeAccess, eModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToClass_0_2_SolveCSP_bindingAndBlackFBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToClass_0_2_SolveCSP_binding = pattern_ParameterizedTypeToClass_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, eType, eParameterizedType, eTypeAccess, eModel);
	...
	public static final Object[] pattern_ParameterizedTypeToClass_0_4_collectelementstobetranslated_blackBBBBB(
			Match match, Type eType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel) {
		if (!eParameterizedType.equals(eType)) {
			return new Object[] { match, eType, eParameterizedType, eTypeAccess, eModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToClass_0_5_collectcontextelements_blackBBBBB(Match match,
			Type eType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel) {
		if (!eParameterizedType.equals(eType)) {
			return new Object[] { match, eType, eParameterizedType, eTypeAccess, eModel };
		}
		return null;
	...
	public static final void pattern_ParameterizedTypeToClass_0_6_registerobjectstomatch_expressionBBBBBB(
			ParameterizedTypeToClass _this, Match match, Type eType, ParameterizedType eParameterizedType,
			TypeAccess eTypeAccess, Model eModel) {
		_this.registerObjectsToMatch_FWD(match, eType, eParameterizedType, eTypeAccess, eModel);
							...
							if (tmpEParameterizedType instanceof ParameterizedType) {
								...
								if (tmpETypeAccess instanceof TypeAccess) {
									...
									if (tmpEModel instanceof Model) {
										...
										return new Object[] { pg, eTypeToTAbstractType, eType, eModelToPg,
												tAbstractType, eParameterizedType, eTypeAccess, eModel,
												isApplicableMatch };
									}
								}
	...
	public static final Object[] pattern_ParameterizedTypeToClass_1_1_performtransformation_blackBBBBBBBBFBB(
			TypeGraph pg, TypeToTAbstractType eTypeToTAbstractType, Type eType, ModelToTypeGraph eModelToPg,
			TAbstractType tAbstractType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel,
			ParameterizedTypeToClass _this, IsApplicableMatch isApplicableMatch) {
		if (!eParameterizedType.equals(eType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType,
							eParameterizedType, eTypeAccess, eModel, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToClass_1_1_performtransformation_binding != null) {
			TypeGraph pg = (TypeGraph) result_pattern_ParameterizedTypeToClass_1_1_performtransformation_binding[0];
			...
			ParameterizedType eParameterizedType = (ParameterizedType) result_pattern_ParameterizedTypeToClass_1_1_performtransformation_binding[5];
			TypeAccess eTypeAccess = (TypeAccess) result_pattern_ParameterizedTypeToClass_1_1_performtransformation_binding[6];
			Model eModel = (Model) result_pattern_ParameterizedTypeToClass_1_1_performtransformation_binding[7];
			...
			Object[] result_pattern_ParameterizedTypeToClass_1_1_performtransformation_black = pattern_ParameterizedTypeToClass_1_1_performtransformation_blackBBBBBBBBFBB(
					pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType, eParameterizedType, eTypeAccess, eModel,
			...
			if (result_pattern_ParameterizedTypeToClass_1_1_performtransformation_black != null) {
				...
				return new Object[] { pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType, eParameterizedType,
						eTypeAccess, eModel, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToClass_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject pg, EObject eTypeToTAbstractType,
			EObject eParameterizedTypeToTAbstractType, EObject eType, EObject eModelToPg, EObject tAbstractType,
			EObject eParameterizedType, EObject eTypeAccess, EObject eModel) {
	...
	public static final Object[] pattern_ParameterizedTypeToClass_1_3_bookkeepingforedges_greenBBBBBBBFFFFFF(
			PerformRuleResult ruleresult, EObject eParameterizedTypeToTAbstractType, EObject eType,
			EObject tAbstractType, EObject eParameterizedType, EObject eTypeAccess, EObject eModel) {
		...
		eModel__eParameterizedType____orphanTypes.setName(eModel__eParameterizedType____orphanTypes_name_prime);
		return new Object[] { ruleresult, eParameterizedTypeToTAbstractType, eType, tAbstractType, eParameterizedType,
				eTypeAccess, eModel, eParameterizedTypeToTAbstractType__tAbstractType____target,
				eParameterizedType__eTypeAccess____type, eTypeAccess__eType____type,
	...
	public static final void pattern_ParameterizedTypeToClass_1_5_registerobjects_expressionBBBBBBBBBBB(
			ParameterizedTypeToClass _this, PerformRuleResult ruleresult, EObject pg, EObject eTypeToTAbstractType,
			EObject eParameterizedTypeToTAbstractType, EObject eType, EObject eModelToPg, EObject tAbstractType,
			EObject eParameterizedType, EObject eTypeAccess, EObject eModel) {
		_this.registerObjects_FWD(ruleresult, pg, eTypeToTAbstractType, eParameterizedTypeToTAbstractType, eType,
				eModelToPg, tAbstractType, eParameterizedType, eTypeAccess, eModel);
		...
		if (tmpEType instanceof Type) {
			...
			if (tmpEParameterizedType instanceof ParameterizedType) {
				...
				if (tmpETypeAccess instanceof TypeAccess) {
					...
					if (tmpEModel instanceof Model) {
						Model eModel = (Model) tmpEModel;
						return new Object[] { eType, eParameterizedType, eTypeAccess, eModel, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_ParameterizedTypeToClass_2_2_corematch_blackFFBFFBBBB(Type eType,
			ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel, Match match) {
			...
			for (TypeToTAbstractType eTypeToTAbstractType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tAbstractType != null) {
					for (ModelToTypeGraph eModelToPg : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (pg != null) {
							_result.add(new Object[] { pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType,
									eParameterizedType, eTypeAccess, eModel, match });
						}
	...
	public static final Iterable<Object[]> pattern_ParameterizedTypeToClass_2_3_findcontext_blackBBBBBBBB(TypeGraph pg,
			TypeToTAbstractType eTypeToTAbstractType, Type eType, ModelToTypeGraph eModelToPg,
			TAbstractType tAbstractType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!eParameterizedType.equals(eType)) {
								...
								if (eModel.getOrphanTypes().contains(eParameterizedType)) {
									if (eModel.equals(eModelToPg.getSource())) {
										if (pg.getOwnedTypes().contains(tAbstractType)) {
											_result.add(new Object[] { pg, eTypeToTAbstractType, eType, eModelToPg,
													tAbstractType, eParameterizedType, eTypeAccess, eModel });
										}
									}
								}
	...
	public static final Object[] pattern_ParameterizedTypeToClass_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(TypeGraph pg,
			TypeToTAbstractType eTypeToTAbstractType, Type eType, ModelToTypeGraph eModelToPg,
			TAbstractType tAbstractType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel) {
		...
		return new Object[] { pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType, eParameterizedType,
				eTypeAccess, eModel, isApplicableMatch, eParameterizedType__eTypeAccess____type,
				eModelToPg__pg____target, eTypeAccess__eType____type, eType__eTypeAccess____usagesInTypeAccess,
				eTypeToTAbstractType__eType____source, eTypeToTAbstractType__tAbstractType____target,
				eModel__eParameterizedType____orphanTypes, eModelToPg__eModel____source,
				pg__tAbstractType____ownedTypes, tAbstractType__pg____pg };
	}

	public static final Object[] pattern_ParameterizedTypeToClass_2_4_solveCSP_bindingFBBBBBBBBBB(
			ParameterizedTypeToClass _this, IsApplicableMatch isApplicableMatch, TypeGraph pg,
			TypeToTAbstractType eTypeToTAbstractType, Type eType, ModelToTypeGraph eModelToPg,
			TAbstractType tAbstractType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, pg, eTypeToTAbstractType, eType,
				eModelToPg, tAbstractType, eParameterizedType, eTypeAccess, eModel);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, pg, eTypeToTAbstractType, eType, eModelToPg,
					tAbstractType, eParameterizedType, eTypeAccess, eModel };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToClass_2_4_solveCSP_binding = pattern_ParameterizedTypeToClass_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType,
				eParameterizedType, eTypeAccess, eModel);
	...
	public static final Object[] pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_385339 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_385339)) {
	...
	public static final Object[] pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_250735 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_2BB(
			TypeAccess eTypeAccess, Type eType) {
		for (ArrayType __DEC_eTypeAccess_elementType_943103 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			if (!eType.equals(__DEC_eTypeAccess_elementType_943103)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_382362 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_4BB(
			TypeAccess eTypeAccess, Type eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_504830 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_504830)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_452174 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_766910 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_118857 : org.moflon.core.utilities.eMoflonEMFUtil
													...
													if (pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_2BB(
														...
														if (pattern_ParameterizedTypeToClass_18_2_testcorematchandDECs_black_nac_4BB(
															...
															for (Model eModel : org.moflon.core.utilities.eMoflonEMFUtil
																...
																_result.add(new Object[] { eType, eParameterizedType,
	...
	public static final boolean pattern_ParameterizedTypeToClass_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ParameterizedTypeToClass _this, Match match, Type eType, ParameterizedType eParameterizedType,
			TypeAccess eTypeAccess, Model eModel) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, eType, eParameterizedType, eTypeAccess, eModel);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpTAbstractType instanceof TAbstractType) {
					...
					if (tmpEParameterizedType instanceof ParameterizedType) {
						...
						if (tmpETypeAccess instanceof TypeAccess) {
							...
							if (tmpEModel instanceof Model) {
								Model eModel = (Model) tmpEModel;
								return new Object[] { pg, eType, tAbstractType, eParameterizedType, eTypeAccess, eModel,
	...
	public static final Object[] pattern_ParameterizedTypeToClass_21_2_matchsrctrgcontext_blackBBBBBBBB(TypeGraph pg,
			Type eType, TAbstractType tAbstractType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			Model eModel, Match sourceMatch, Match targetMatch) {
		if (!eParameterizedType.equals(eType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { pg, eType, tAbstractType, eParameterizedType, eTypeAccess, eModel, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ParameterizedTypeToClass_21_2_matchsrctrgcontext_binding != null) {
			TypeGraph pg = (TypeGraph) result_pattern_ParameterizedTypeToClass_21_2_matchsrctrgcontext_binding[0];
			Type eType = (Type) result_pattern_ParameterizedTypeToClass_21_2_matchsrctrgcontext_binding[1];
			TAbstractType tAbstractType = (TAbstractType) result_pattern_ParameterizedTypeToClass_21_2_matchsrctrgcontext_binding[2];
			...
			Model eModel = (Model) result_pattern_ParameterizedTypeToClass_21_2_matchsrctrgcontext_binding[5];
			...
			Object[] result_pattern_ParameterizedTypeToClass_21_2_matchsrctrgcontext_black = pattern_ParameterizedTypeToClass_21_2_matchsrctrgcontext_blackBBBBBBBB(
					pg, eType, tAbstractType, eParameterizedType, eTypeAccess, eModel, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ParameterizedTypeToClass_21_3_solvecsp_bindingFBBBBBBBBB(
			ParameterizedTypeToClass _this, TypeGraph pg, Type eType, TAbstractType tAbstractType,
			ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel, Match sourceMatch,
			Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(pg, eType, tAbstractType, eParameterizedType, eTypeAccess,
				eModel, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, pg, eType, tAbstractType, eParameterizedType, eTypeAccess, eModel,
	...
	public static final Object[] pattern_ParameterizedTypeToClass_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToClass_21_3_solvecsp_binding = pattern_ParameterizedTypeToClass_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, pg, eType, tAbstractType, eParameterizedType, eTypeAccess, eModel, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_ParameterizedTypeToClass_21_5_matchcorrcontext_blackBFBFBBBB(
			TypeGraph pg, Type eType, TAbstractType tAbstractType, Model eModel, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_ParameterizedTypeToClass_21_6_createcorrespondence_blackBBBBBBB(TypeGraph pg,
			Type eType, TAbstractType tAbstractType, ParameterizedType eParameterizedType, TypeAccess eTypeAccess,
			Model eModel, CCMatch ccMatch) {
		if (!eParameterizedType.equals(eType)) {
			return new Object[] { pg, eType, tAbstractType, eParameterizedType, eTypeAccess, eModel, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_0BB(
			TypeAccess eTypeAccess, Type eType) {
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_927239 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_927239)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_53226 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_2BB(
			TypeAccess eTypeAccess, Type eType) {
		for (ArrayType __DEC_eTypeAccess_elementType_115748 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			if (!eType.equals(__DEC_eTypeAccess_elementType_115748)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_808138 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_4BB(
			TypeAccess eTypeAccess, Type eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_548367 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_548367)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_168220 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_382343 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_666472 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ParameterizedTypeToClass_24_1_matchtggpattern_blackBBBB(Type eType,
			ParameterizedType eParameterizedType, TypeAccess eTypeAccess, Model eModel) {
		if (!eParameterizedType.equals(eType)) {
			if (eTypeAccess.equals(eParameterizedType.getType())) {
				if (eType.equals(eTypeAccess.getType())) {
					if (eModel.getOrphanTypes().contains(eParameterizedType)) {
											...
											if (pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_5B(
												...
												if (pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_6B(
													...
													if (pattern_ParameterizedTypeToClass_24_1_matchtggpattern_black_nac_7B(
															eTypeAccess) == null) {
														return new Object[] { eType, eParameterizedType, eTypeAccess,
																eModel };
													}
												}
											}
								...
								if (pattern_ParameterizedTypeToClass_26_2_isapplicablecore_black_nac_2BB(ruleResult,
									...
									if (pattern_ParameterizedTypeToClass_26_2_isapplicablecore_black_nac_1BB(ruleResult,
										...
										if (pattern_ParameterizedTypeToClass_26_2_isapplicablecore_black_nac_3BB(
											...
											if (pattern_ParameterizedTypeToClass_26_2_isapplicablecore_black_nac_0BB(
													ruleResult, pg) == null) {
												for (ModelToTypeGraph eModelToPg : org.moflon.core.utilities.eMoflonEMFUtil
													...
													if (eModel != null) {
														if (pattern_ParameterizedTypeToClass_26_2_isapplicablecore_black_nac_4BB(
															...
															if (pattern_ParameterizedTypeToClass_26_2_isapplicablecore_black_nac_5BB(
																...
																_result.add(new Object[] { eTypeToTAbstractTypeList, pg,
	...
	public static final Object[] pattern_ParameterizedTypeToClass_26_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, pg, eTypeToTAbstractType, eType,
				eModelToPg, tAbstractType, eModel, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, pg, eTypeToTAbstractType, eType, eModelToPg,
	...
	public static final Object[] pattern_ParameterizedTypeToClass_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ParameterizedTypeToClass_26_3_solveCSP_binding = pattern_ParameterizedTypeToClass_26_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType, eModel,
				ruleResult);
	...
	public static final Object[] pattern_ParameterizedTypeToClass_26_5_checknacs_blackBBBBBB(TypeGraph pg,
			TypeToTAbstractType eTypeToTAbstractType, Type eType, ModelToTypeGraph eModelToPg,
			TAbstractType tAbstractType, Model eModel) {
		return new Object[] { pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType, eModel };
	}

	public static final Object[] pattern_ParameterizedTypeToClass_26_6_perform_blackBBBBBBB(TypeGraph pg,
			TypeToTAbstractType eTypeToTAbstractType, Type eType, ModelToTypeGraph eModelToPg,
			TAbstractType tAbstractType, Model eModel, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { pg, eTypeToTAbstractType, eType, eModelToPg, tAbstractType, eModel, ruleResult };
	}

	public static final Object[] pattern_ParameterizedTypeToClass_26_6_perform_greenFBBFFBB(Type eType,
			TAbstractType tAbstractType, Model eModel, ModelgeneratorRuleResult ruleResult) {
		TypeToTAbstractType eParameterizedTypeToTAbstractType = PmFactory.eINSTANCE.createTypeToTAbstractType();
		...
		return new Object[] { eParameterizedTypeToTAbstractType, eType, tAbstractType, eParameterizedType, eTypeAccess,
				eModel, ruleResult };
	}
