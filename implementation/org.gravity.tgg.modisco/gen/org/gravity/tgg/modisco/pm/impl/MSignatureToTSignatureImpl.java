 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MSignatureToTSignatureImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MSignatureToTSignatureImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MSignatureToTSignatureImpl extends AbstractCorrespondenceImpl implements MSignatureToTSignature {
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.MSIGNATURE_TO_TSIGNATURE;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.MSIGNATURE_TO_TSIGNATURE__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(MSignature newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.MSIGNATURE_TO_TSIGNATURE__SOURCE, oldSource,
					source));
	}
	...
	public TSignature getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.MSIGNATURE_TO_TSIGNATURE__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TSignature newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.MSIGNATURE_TO_TSIGNATURE__TARGET, oldTarget,
					target));
	}
