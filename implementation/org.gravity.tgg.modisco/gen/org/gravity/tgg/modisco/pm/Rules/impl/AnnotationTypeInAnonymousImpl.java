...
public class AnnotationTypeInAnonymousImpl extends AbstractRuleImpl implements AnnotationTypeInAnonymous {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_35(EMoflonEdge _edge_innerTypes) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_36(EMoflonEdge _edge_anonymousClassDeclarationOwner) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_35__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_35((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_TYPE_IN_ANONYMOUS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_36__EMOFLONEDGE:
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_12_3_findcontext_greenBBBBBFFFFFFFFFF(TClass tClass,
		...
		return new Object[] { tClass, pg, tNestedType, eAnonymousClassDeclarationToTClass, eAnonymousClassDeclaration,
				isApplicableMatch, pg__tClass____classes, eAnonymousClassDeclarationToTClass__tClass____target,
				eAnonymousClassDeclarationToTClass__eAnonymousClassDeclaration____source, pg__tClass____ownedTypes,
				tClass__pg____pg, tClass__tNestedType____innerTypes, tNestedType__tClass____outerType,
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TypeGraph __DEC_tNestedType_tAnnotationTypes_701777 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "tAnnotationTypes")) {
			if (!pg.equals(__DEC_tNestedType_tAnnotationTypes_701777)) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_black_nac_1B(
		...
		TPackage __DEC_tNestedType_ownedTypes_991229 = tNestedType.getPackage();
		if (__DEC_tNestedType_ownedTypes_991229 != null) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_20_2_testcorematchandDECs_black_nac_2BB(
		...
		TAbstractType __DEC_tNestedType_innerTypes_378227 = tNestedType.getOuterType();
		if (__DEC_tNestedType_innerTypes_378227 != null) {
			if (!tNestedType.equals(__DEC_tNestedType_innerTypes_378227)) {
				if (!tClass.equals(__DEC_tNestedType_innerTypes_378227)) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_21_2_testcorematchandDECs_black_nac_0B(
		...
		AbstractTypeDeclaration __DEC_mNestedType_abstractTypeDeclaration_658785 = mNestedType
				.getAbstractTypeDeclaration();
		if (__DEC_mNestedType_abstractTypeDeclaration_658785 != null) {
			if (!mNestedType.equals(__DEC_mNestedType_abstractTypeDeclaration_658785)) {
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_21_2_testcorematchandDECs_black_nac_1B(
			AnnotationTypeDeclaration mNestedType) {
		for (Model __DEC_mNestedType_orphanTypes_56734 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_21_2_testcorematchandDECs_black_nac_2B(
			AnnotationTypeDeclaration mNestedType) {
		org.eclipse.modisco.java.Package __DEC_mNestedType_ownedElements_563560 = mNestedType.getPackage();
		if (__DEC_mNestedType_ownedElements_563560 != null) {
			return new Object[] { mNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_21_2_testcorematchandDECs_black_nac_3B(
			AnnotationTypeDeclaration mNestedType) {
		for (MAbstractMethodDefinition __DEC_mNestedType_mInnerTypes_767678 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_27_1_matchtggpattern_black_nac_0B(
			AnnotationTypeDeclaration mNestedType) {
		AbstractTypeDeclaration __DEC_mNestedType_abstractTypeDeclaration_90586 = mNestedType
				.getAbstractTypeDeclaration();
		if (__DEC_mNestedType_abstractTypeDeclaration_90586 != null) {
			if (!mNestedType.equals(__DEC_mNestedType_abstractTypeDeclaration_90586)) {
				return new Object[] { mNestedType };
			}
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_27_1_matchtggpattern_black_nac_1B(
			AnnotationTypeDeclaration mNestedType) {
		for (Model __DEC_mNestedType_orphanTypes_100259 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mNestedType, Model.class, "orphanTypes")) {
			return new Object[] { mNestedType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_27_1_matchtggpattern_black_nac_2B(
			AnnotationTypeDeclaration mNestedType) {
		org.eclipse.modisco.java.Package __DEC_mNestedType_ownedElements_723985 = mNestedType.getPackage();
		if (__DEC_mNestedType_ownedElements_723985 != null) {
			return new Object[] { mNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_27_1_matchtggpattern_black_nac_3B(
			AnnotationTypeDeclaration mNestedType) {
		for (MAbstractMethodDefinition __DEC_mNestedType_mInnerTypes_302235 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mNestedType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mNestedType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_0BB(
			TAnnotationType tNestedType, TypeGraph pg) {
		for (TypeGraph __DEC_tNestedType_tAnnotationTypes_891395 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "tAnnotationTypes")) {
			if (!pg.equals(__DEC_tNestedType_tAnnotationTypes_891395)) {
				return new Object[] { tNestedType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_1B(
			TAnnotationType tNestedType) {
		TPackage __DEC_tNestedType_ownedTypes_304982 = tNestedType.getPackage();
		if (__DEC_tNestedType_ownedTypes_304982 != null) {
			return new Object[] { tNestedType };
		}
	...
	public static final Object[] pattern_AnnotationTypeInAnonymous_28_1_matchtggpattern_black_nac_2BB(
			TAnnotationType tNestedType, TClass tClass) {
		TAbstractType __DEC_tNestedType_innerTypes_276351 = tNestedType.getOuterType();
		if (__DEC_tNestedType_innerTypes_276351 != null) {
			if (!tNestedType.equals(__DEC_tNestedType_innerTypes_276351)) {
				if (!tClass.equals(__DEC_tNestedType_innerTypes_276351)) {
					return new Object[] { tNestedType, tClass };
				}
			}
		}
