...
public class InterfaceImpl extends AbstractRuleImpl implements Interface {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_16__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_16((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_16__EMOFLONEDGE:
	...
	public static final Object[] pattern_Interface_20_2_testcorematchandDECs_black_nac_0BB(TInterface tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_interfaces_649846 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "interfaces")) {
			if (!tPackage.equals(__DEC_tType_interfaces_649846)) {
	...
	public static final Object[] pattern_Interface_20_2_testcorematchandDECs_black_nac_1BB(TInterface tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_interfaces_792274 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tType_interfaces_792274)) {
	...
	public static final Object[] pattern_Interface_20_2_testcorematchandDECs_black_nac_2BB(TInterface tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_628039 = tType.getPackage();
		if (__DEC_tType_ownedTypes_628039 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_628039)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Interface_20_2_testcorematchandDECs_black_nac_3B(TInterface tType) {
		TAbstractType __DEC_tType_innerTypes_720746 = tType.getOuterType();
		if (__DEC_tType_innerTypes_720746 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_720746)) {
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_0B(InterfaceDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_670498 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_670498 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_670498)) {
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_1B(InterfaceDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_817465 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_817465 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_2B(InterfaceDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_978656 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Interface_21_2_testcorematchandDECs_black_nac_3B(InterfaceDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_106076 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Interface_27_1_matchtggpattern_black_nac_0B(InterfaceDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_407446 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_407446 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_407446)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_Interface_27_1_matchtggpattern_black_nac_1B(InterfaceDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_242323 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_242323 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Interface_27_1_matchtggpattern_black_nac_2B(InterfaceDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_849416 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, Model.class, "orphanTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Interface_27_1_matchtggpattern_black_nac_3B(InterfaceDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_594223 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_0BB(TInterface tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_interfaces_547615 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "interfaces")) {
			if (!tPackage.equals(__DEC_tType_interfaces_547615)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_1BB(TInterface tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_interfaces_187019 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "interfaces")) {
			if (!pg.equals(__DEC_tType_interfaces_187019)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_2BB(TInterface tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_97316 = tType.getPackage();
		if (__DEC_tType_ownedTypes_97316 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_97316)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Interface_28_1_matchtggpattern_black_nac_3B(TInterface tType) {
		TAbstractType __DEC_tType_innerTypes_313319 = tType.getOuterType();
		if (__DEC_tType_innerTypes_313319 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_313319)) {
				return new Object[] { tType };
			}
		}
