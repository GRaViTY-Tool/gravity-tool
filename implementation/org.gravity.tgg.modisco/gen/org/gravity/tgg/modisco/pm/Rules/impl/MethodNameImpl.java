...
public class MethodNameImpl extends AbstractRuleImpl implements MethodName {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
				tName, modelToPg, mNameToTName, pg, mModel, mName);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tName] = " + tName + ", " + "[modelToPg] = " + modelToPg + ", " + "[mNameToTName] = "
					+ mNameToTName + ", " + "[pg] = " + pg + ", " + "[mModel] = " + mModel + ", " + "[mName] = " + mName
					+ ".");
		}
		MethodNameImpl.pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tName, mNameToTName, pg,
				mModel, mName);
		...
		// 
		// 
		MethodNameImpl.pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, tName, modelToPg,
				mNameToTName, pg, mModel, mName);
			...
			for (Object[] result3_black : MethodNameImpl.pattern_MethodName_2_3_findcontext_blackBBBB(modelToPg, pg,
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[pg] = " + pg + ", " + "[mModel] = " + mModel + ", " + "[mName] = " + mName + ".");
				}
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tName, EObject modelToPg,
			EObject mNameToTName, EObject pg, EObject mModel, EObject mName) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MethodNameImpl.pattern_MethodName_11_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult, tName, mNameToTName, pg,
				mModel, mName);
		//nothing EMoflonEdge mNameToTName__tName____target = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge pg__tName____methods = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge tName__pg____pg = (EMoflonEdge) result3_green[8];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tName, EObject modelToPg,
			EObject mNameToTName, EObject pg, EObject mModel, EObject mName) {
		ruleresult.registerObject("tName", tName);
		ruleresult.registerObject("modelToPg", modelToPg);
		ruleresult.registerObject("mNameToTName", mNameToTName);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodNameImpl.pattern_MethodName_24_3_solvecsp_bindingAndBlackFBBBBBBB(this,
				tName, pg, mModel, mName, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tName] = " + tName + ", " + "[pg] = " + pg + ", " + "[mModel] = " + mModel + ", " + "[mName] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMethod tName, TypeGraph pg, MGravityModel mModel, MMethodName mName,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_NAME___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_TYPEGRAPH_MGRAVITYMODEL_MMETHODNAME:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ModelToTypeGraph) arguments.get(1),
					(TypeGraph) arguments.get(2), (MGravityModel) arguments.get(3), (MMethodName) arguments.get(4));
		...
		case RulesPackage.METHOD_NAME___IS_APPLICABLE_SOLVE_CSP_CC__TMETHOD_TYPEGRAPH_MGRAVITYMODEL_MMETHODNAME_MATCH_MATCH:
			...
			if (tmpPg instanceof TypeGraph) {
				...
				if (tmpMModel instanceof MGravityModel) {
					...
					if (tmpMName instanceof MMethodName) {
						...
						return new Object[] { modelToPg, pg, mModel, mName, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodName_1_1_performtransformation_blackBBBBFBB(ModelToTypeGraph modelToPg,
			TypeGraph pg, MGravityModel mModel, MMethodName mName, MethodName _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { modelToPg, pg, mModel, mName, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_1_1_performtransformation_bindingAndBlackFFFFFBB(MethodName _this,
		...
		if (result_pattern_MethodName_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodName_1_1_performtransformation_black = pattern_MethodName_1_1_performtransformation_blackBBBBFBB(
					modelToPg, pg, mModel, mName, _this, isApplicableMatch);
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_blackBBBBBBB(PerformRuleResult ruleresult,
			EObject tName, EObject modelToPg, EObject mNameToTName, EObject pg, EObject mModel, EObject mName) {
	...
	public static final Object[] pattern_MethodName_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tName, EObject mNameToTName, EObject pg, EObject mModel,
			EObject mName) {
		...
		return new Object[] { ruleresult, tName, mNameToTName, pg, mModel, mName, mNameToTName__tName____target,
				pg__tName____methods, tName__pg____pg, mModel__mName____mMethodNames, mNameToTName__mName____source };
	}

	public static final void pattern_MethodName_1_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject tName, EObject modelToPg, EObject mNameToTName, EObject pg,
			EObject mModel, EObject mName) {
		_this.registerObjects_FWD(ruleresult, tName, modelToPg, mNameToTName, pg, mModel, mName);
	...
	public static final Iterable<Object[]> pattern_MethodName_2_2_corematch_blackFFBBB(MGravityModel mModel,
		...
		for (ModelToTypeGraph modelToPg : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(mModel,
			...
			if (pg != null) {
				_result.add(new Object[] { modelToPg, pg, mModel, mName, match });
			}
	...
	public static final Object[] pattern_MethodName_2_3_findcontext_greenBBBBFFFF(ModelToTypeGraph modelToPg,
		...
		return new Object[] { modelToPg, pg, mModel, mName, isApplicableMatch, mModel__mName____mMethodNames,
	...
	public static final Object[] pattern_MethodName_2_4_solveCSP_bindingFBBBBBB(MethodName _this,
			...
			MMethodName mName) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, modelToPg, pg, mModel, mName);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, modelToPg, pg, mModel, mName };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_2_4_solveCSP_bindingAndBlackFBBBBBB(MethodName _this,
		...
		Object[] result_pattern_MethodName_2_4_solveCSP_binding = pattern_MethodName_2_4_solveCSP_bindingFBBBBBB(_this,
				isApplicableMatch, modelToPg, pg, mModel, mName);
	...
	public static final void pattern_MethodName_11_5_registerobjects_expressionBBBBBBBB(MethodName _this,
			PerformRuleResult ruleresult, EObject tName, EObject modelToPg, EObject mNameToTName, EObject pg,
			EObject mModel, EObject mName) {
		_this.registerObjects_BWD(ruleresult, tName, modelToPg, mNameToTName, pg, mModel, mName);
	...
	public static final Object[] pattern_MethodName_12_3_findcontext_greenBBBBFFFFF(TMethod tName,
		...
		modelToPg__mModel____source.setName(modelToPg__mModel____source_name_prime);
		modelToPg__pg____target.setName(modelToPg__pg____target_name_prime);
		return new Object[] { tName, modelToPg, pg, mModel, isApplicableMatch, pg__tName____methods, tName__pg____pg,
				modelToPg__mModel____source, modelToPg__pg____target };
	}
		...
		if (tmpTName instanceof TMethod) {
			...
			if (tmpPg instanceof TypeGraph) {
				...
				if (tmpMModel instanceof MGravityModel) {
					...
					if (tmpMName instanceof MMethodName) {
						MMethodName mName = (MMethodName) tmpMName;
						return new Object[] { tName, pg, mModel, mName, targetMatch, sourceMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_MethodName_24_2_matchsrctrgcontext_blackBBBBBB(TMethod tName, TypeGraph pg,
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tName, pg, mModel, mName, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_24_3_solvecsp_bindingFBBBBBBB(MethodName _this, TMethod tName,
			TypeGraph pg, MGravityModel mModel, MMethodName mName, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tName, pg, mModel, mName, sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tName, pg, mModel, mName, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodName_24_3_solvecsp_bindingAndBlackFBBBBBBB(MethodName _this,
			TMethod tName, TypeGraph pg, MGravityModel mModel, MMethodName mName, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_MethodName_24_3_solvecsp_binding = pattern_MethodName_24_3_solvecsp_bindingFBBBBBBB(
				_this, tName, pg, mModel, mName, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodName_24_6_createcorrespondence_blackBBBBB(TMethod tName, TypeGraph pg,
		...
		return new Object[] { tName, pg, mModel, mName, ccMatch };
	}
	...
	public static final Object[] pattern_MethodName_29_6_perform_greenFFBBFBB(TypeGraph pg, MGravityModel mModel,
		...
		return new Object[] { tName, mNameToTName, pg, mModel, mName, ruleResult, csp };
	}
