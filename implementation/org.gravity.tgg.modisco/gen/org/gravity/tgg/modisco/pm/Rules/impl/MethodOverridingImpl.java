...
public class MethodOverridingImpl extends AbstractRuleImpl implements MethodOverriding {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodOverridingImpl.pattern_MethodOverriding_1_3_bookkeepingforedges_blackBBBBBBB(
				ruleresult, mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding);
		if (result3_black == null) {
			throw new RuntimeException(
					"Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult + ", " + "[mMethod] = "
							+ mMethod + ", " + "[tOverriding] = " + tOverriding + ", " + "[mMethodToTMethod] = "
							+ mMethodToTMethod + ", " + "[mOverriding] = " + mOverriding + ", " + "[tMethod] = "
							+ tMethod + ", " + "[mOverridingToTOverriding] = " + mOverridingToTOverriding + ".");
		}
		...
		MethodOverridingImpl.pattern_MethodOverriding_1_5_registerobjects_expressionBBBBBBBB(this, ruleresult, mMethod,
				tOverriding, mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodOverridingImpl.pattern_MethodOverriding_2_2_corematch_blackBFFBFFB(mMethod,
				mOverriding, match)) {
			...
			for (Object[] result3_black : MethodOverridingImpl.pattern_MethodOverriding_2_3_findcontext_blackBBBBBB(
					mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding)) {
				Object[] result3_green = MethodOverridingImpl
						.pattern_MethodOverriding_2_3_findcontext_greenBBBBBBFFFFFFF(mMethod, tOverriding,
								mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MMethodDefinition mMethod,
			TMethodDefinition tOverriding, MDefinitionToTMember mMethodToTMethod, MMethodDefinition mOverriding,
			TMethodDefinition tMethod, MDefinitionToTMember mOverridingToTOverriding) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mMethod, EObject tOverriding,
			EObject mMethodToTMethod, EObject mOverriding, EObject tMethod, EObject mOverridingToTOverriding) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodOverridingImpl
			...
			for (Object[] result3_black : MethodOverridingImpl.pattern_MethodOverriding_12_3_findcontext_blackBBBBBB(
					mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding)) {
				Object[] result3_green = MethodOverridingImpl
						.pattern_MethodOverriding_12_3_findcontext_greenBBBBBBFFFFFFF(mMethod, tOverriding,
								mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[6];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mMethod, EObject tOverriding,
			EObject mMethodToTMethod, EObject mOverriding, EObject tMethod, EObject mOverridingToTOverriding) {
		ruleresult.registerObject("mMethod", mMethod);
		ruleresult.registerObject("tOverriding", tOverriding);
		ruleresult.registerObject("mMethodToTMethod", mMethodToTMethod);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_74(EMoflonEdge _edge_overriddenBy) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_78(EMoflonEdge _edge_redefinitions) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodOverridingImpl.pattern_MethodOverriding_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodOverridingImpl
					.pattern_MethodOverriding_24_5_matchcorrcontext_blackBBFBBFBB(mMethod, tOverriding, mOverriding,
							tMethod, sourceMatch, targetMatch)) {
		...
		for (Object[] result2_black : MethodOverridingImpl
			...
			Object[] result3_bindingAndBlack = MethodOverridingImpl
					.pattern_MethodOverriding_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, mMethod,
							tOverriding, mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mMethod] = " + mMethod + ", "
						+ "[tOverriding] = " + tOverriding + ", " + "[mMethodToTMethod] = " + mMethodToTMethod + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_OVERRIDING___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MMETHODDEFINITION_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_TMETHODDEFINITION_MDEFINITIONTOTMEMBER:
		...
		case RulesPackage.METHOD_OVERRIDING___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MMETHODDEFINITION_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_TMETHODDEFINITION_MDEFINITIONTOTMEMBER:
		...
		case RulesPackage.METHOD_OVERRIDING___IS_APPROPRIATE_BWD_EMOFLON_EDGE_74__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_74((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_OVERRIDING___IS_APPROPRIATE_FWD_EMOFLON_EDGE_78__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_OVERRIDING___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MMETHODDEFINITION_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MMETHODDEFINITION_TMETHODDEFINITION_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
					...
					if (tmpMOverriding instanceof MMethodDefinition) {
						...
						if (tmpTMethod instanceof TMethodDefinition) {
							...
							if (tmpMOverridingToTOverriding instanceof MDefinitionToTMember) {
								...
								return new Object[] { mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod,
	...
	public static final Object[] pattern_MethodOverriding_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_MethodOverriding_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MethodOverriding_1_1_performtransformation_black = pattern_MethodOverriding_1_1_performtransformation_blackBBBBBBFBB(
					mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MethodOverriding_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject mMethod, EObject tOverriding, EObject mMethodToTMethod,
			EObject mOverriding, EObject tMethod, EObject mOverridingToTOverriding) {
															...
															if (!mOverridingToTOverriding.equals(tOverriding)) {
																if (!mOverridingToTOverriding.equals(tMethod)) {
																	return new Object[] { ruleresult, mMethod,
																			tOverriding, mMethodToTMethod, mOverriding,
	...
	public static final void pattern_MethodOverriding_1_5_registerobjects_expressionBBBBBBBB(MethodOverriding _this,
			PerformRuleResult ruleresult, EObject mMethod, EObject tOverriding, EObject mMethodToTMethod,
			EObject mOverriding, EObject tMethod, EObject mOverridingToTOverriding) {
		_this.registerObjects_FWD(ruleresult, mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod,
	...
	public static final Iterable<Object[]> pattern_MethodOverriding_2_2_corematch_blackBFFBFFB(
					...
					for (MDefinitionToTMember mOverridingToTOverriding : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!mMethodToTMethod.equals(mOverridingToTOverriding)) {
							...
							if (tmpTOverriding instanceof TMethodDefinition) {
								TMethodDefinition tOverriding = (TMethodDefinition) tmpTOverriding;
								if (!tMethod.equals(tOverriding)) {
									_result.add(new Object[] { mMethod, tOverriding, mMethodToTMethod, mOverriding,
											tMethod, mOverridingToTOverriding, match });
								}
							}
	...
	public static final Object[] pattern_MethodOverriding_2_3_findcontext_greenBBBBBBFFFFFFF(MMethodDefinition mMethod,
		...
		return new Object[] { mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding,
	...
	public static final Object[] pattern_MethodOverriding_2_4_solveCSP_bindingFBBBBBBBB(MethodOverriding _this,
			IsApplicableMatch isApplicableMatch, MMethodDefinition mMethod, TMethodDefinition tOverriding,
			MDefinitionToTMember mMethodToTMethod, MMethodDefinition mOverriding, TMethodDefinition tMethod,
			MDefinitionToTMember mOverridingToTOverriding) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mMethod, tOverriding,
				mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mMethod, tOverriding, mMethodToTMethod, mOverriding,
					tMethod, mOverridingToTOverriding };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodOverriding_2_4_solveCSP_bindingAndBlackFBBBBBBBB(MethodOverriding _this,
		...
		Object[] result_pattern_MethodOverriding_2_4_solveCSP_binding = pattern_MethodOverriding_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod,
				mOverridingToTOverriding);
		if (result_pattern_MethodOverriding_2_4_solveCSP_binding != null) {
			...
			if (result_pattern_MethodOverriding_2_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mMethod, tOverriding, mMethodToTMethod,
						mOverriding, tMethod, mOverridingToTOverriding };
			}
		}
		return null;
	}
	...
	public static final void pattern_MethodOverriding_11_5_registerobjects_expressionBBBBBBBB(MethodOverriding _this,
			PerformRuleResult ruleresult, EObject mMethod, EObject tOverriding, EObject mMethodToTMethod,
			EObject mOverriding, EObject tMethod, EObject mOverridingToTOverriding) {
		_this.registerObjects_BWD(ruleresult, mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod,
				mOverridingToTOverriding);
	...
	public static final Object[] pattern_MethodOverriding_12_3_findcontext_greenBBBBBBFFFFFFF(MMethodDefinition mMethod,
		...
		mOverridingToTOverriding__mOverriding____source
				.setName(mOverridingToTOverriding__mOverriding____source_name_prime);
		return new Object[] { mMethod, tOverriding, mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding,
				isApplicableMatch, mMethodToTMethod__mMethod____source, mMethodToTMethod__tMethod____target,
				tMethod__tOverriding____overriddenBy, tOverriding__tMethod____overriding,
	...
	public static final Object[] pattern_MethodOverriding_12_4_solveCSP_bindingFBBBBBBBB(MethodOverriding _this,
			...
			MDefinitionToTMember mMethodToTMethod, MMethodDefinition mOverriding, TMethodDefinition tMethod,
			MDefinitionToTMember mOverridingToTOverriding) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mMethod, tOverriding,
				mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mMethod, tOverriding, mMethodToTMethod, mOverriding,
						...
						if (tMethod.equals(mMethodToTMethod.getTarget())) {
							for (MDefinitionToTMember mOverridingToTOverriding : org.moflon.core.utilities.eMoflonEMFUtil
								...
								if (!mMethodToTMethod.equals(mOverridingToTOverriding)) {
									if (mOverriding.equals(mOverridingToTOverriding.getSource())) {
										_result.add(new Object[] { mMethod, tOverriding, mMethodToTMethod, mOverriding,
												tMethod, mOverridingToTOverriding, sourceMatch, targetMatch });
									}
								}
							}
						}
	...
	public static final Object[] pattern_MethodOverriding_29_3_solveCSP_bindingFBBBBBBBBB(MethodOverriding _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mMethod, tOverriding,
				mMethodToTMethod, mOverriding, tMethod, mOverridingToTOverriding, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mMethod, tOverriding, mMethodToTMethod, mOverriding,
					tMethod, mOverridingToTOverriding, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodOverriding_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		if (result_pattern_MethodOverriding_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_MethodOverriding_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mMethod, tOverriding, mMethodToTMethod,
						mOverriding, tMethod, mOverridingToTOverriding, ruleResult };
			}
		}
		return null;
	}
