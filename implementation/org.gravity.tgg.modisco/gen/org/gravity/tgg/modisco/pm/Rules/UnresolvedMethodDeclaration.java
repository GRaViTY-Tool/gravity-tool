...
public interface UnresolvedMethodDeclaration extends EObject, AbstractRule {
	...
	void registerObjects_FWD(PerformRuleResult ruleresult, EObject unresolved2Definiton, EObject tMethodSignature,
			EObject mModel, EObject model2pm, EObject mMethod, EObject tModel, EObject tMethodName,
	...
	CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMethodSignature tMethodSignature, Model mModel,
			ModelToTypeGraph model2pm, TypeGraph tModel, TMethod tMethodName, TMethodDefinition tMethodDefinition);
	 ...
	 * @generated
	 */
	CSP isApplicable_solveCsp_CC(TMethodSignature tMethodSignature, Model mModel,
