...
public class ClassInnerAnonClassMemberImpl extends AbstractRuleImpl implements ClassInnerAnonClassMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ClassInnerAnonClassMemberImpl
				.pattern_ClassInnerAnonClassMember_1_3_bookkeepingforedges_greenBBBBBBBBBBFFFFFFFFFFFFFFF(ruleresult,
						tInnerTypeToTInnerAbstractType, mInnerClass, typeGraph, tInnerPackage, mDefinition, tOuterClass,
			...
			for (Object[] result3_black : ClassInnerAnonClassMemberImpl
				...
				Object[] result4_bindingAndBlack = ClassInnerAnonClassMemberImpl
						.pattern_ClassInnerAnonClassMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mInnerClass, typeGraph, eOuterClass, mDefinition, tOuterClass,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : ClassInnerAnonClassMemberImpl
			...
			// ForEach 
			for (Object[] result3_black : ClassInnerAnonClassMemberImpl
					.pattern_ClassInnerAnonClassMember_12_3_findcontext_blackBBBFBBBB(typeGraph, eOuterClass,
				...
				Object[] result4_bindingAndBlack = ClassInnerAnonClassMemberImpl
						.pattern_ClassInnerAnonClassMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this,
								isApplicableMatch, typeGraph, eOuterClass, tInnerPackage, mDefinition, tOuterClass,
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeGraph typeGraph,
			AnonymousClassDeclaration eOuterClass, TPackage tInnerPackage, MAbstractMethodDefinition mDefinition,
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ClassInnerAnonClassMemberImpl
				.pattern_ClassInnerAnonClassMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBBBB(this, mInnerClass,
						typeGraph, eOuterClass, tInnerPackage, mDefinition, tOuterClass, tInnerClass, tOuterPackage,
			...
			if (ClassInnerAnonClassMemberImpl.pattern_ClassInnerAnonClassMember_29_4_checkCSP_expressionFBB(this,
				...
				if (result5_black != null) {
					...
					ClassInnerAnonClassMemberImpl.pattern_ClassInnerAnonClassMember_29_6_perform_greenFFBFBBFFBBB(
							typeGraph, mDefinition, tOuterClass, tOuterPackage, ruleResult, csp);
					//nothing TypeToTAbstractType tInnerTypeToTInnerAbstractType = (TypeToTAbstractType) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS_INNER_ANON_CLASS_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MCLASS_TYPEGRAPH_ANONYMOUSCLASSDECLARATION_MABSTRACTMETHODDEFINITION_TCLASS_ANONYMOUSCLASSDECLARATIONTOTCLASS_TPACKAGE:
		...
		case RulesPackage.CLASS_INNER_ANON_CLASS_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_ANONYMOUSCLASSDECLARATION_TPACKAGE_MABSTRACTMETHODDEFINITION_TCLASS_TCLASS_ANONYMOUSCLASSDECLARATIONTOTCLASS_TPACKAGE:
		...
		case RulesPackage.CLASS_INNER_ANON_CLASS_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_26__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_26((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS_INNER_ANON_CLASS_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_27__EMOFLONEDGE:
		...
		case RulesPackage.CLASS_INNER_ANON_CLASS_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__MCLASS_TYPEGRAPH_ANONYMOUSCLASSDECLARATION_TPACKAGE_MABSTRACTMETHODDEFINITION_TCLASS_TCLASS_TPACKAGE_MATCH_MATCH:
		...
		case RulesPackage.CLASS_INNER_ANON_CLASS_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPEGRAPH_ANONYMOUSCLASSDECLARATION_MABSTRACTMETHODDEFINITION_TCLASS_ANONYMOUSCLASSDECLARATIONTOTCLASS_TPACKAGE_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TypeGraph) arguments.get(1),
					(AnonymousClassDeclaration) arguments.get(2), (MAbstractMethodDefinition) arguments.get(3),
					(TClass) arguments.get(4), (AnonymousClassDeclarationToTClass) arguments.get(5),
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_1_1_performtransformation_blackBBBBBBBFBB(
			MClass mInnerClass, TypeGraph typeGraph, AnonymousClassDeclaration eOuterClass,
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_ClassInnerAnonClassMember_1_1_performtransformation_binding != null) {
			...
			MAbstractMethodDefinition mDefinition = (MAbstractMethodDefinition) result_pattern_ClassInnerAnonClassMember_1_1_performtransformation_binding[3];
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			TClass tOuterClass, AnonymousClassDeclarationToTClass eOuterClassToTOuterClass, TPackage tOuterPackage) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_11_1_performtransformation_blackBBBBBBBBFBB(
			TypeGraph typeGraph, AnonymousClassDeclaration eOuterClass, TPackage tInnerPackage,
	...
	public static final Iterable<Object[]> pattern_ClassInnerAnonClassMember_12_3_findcontext_blackBBBFBBBB(
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TypeGraph __DEC_tInnerPackage_typeGraph_769872 = tInnerPackage.getTypeGraph();
		if (__DEC_tInnerPackage_typeGraph_769872 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_typeGraph_769872)) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_20_2_testcorematchandDECs_black_nac_1BB(
		...
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerPackage_subpackage_58118 = tInnerPackage.getParent();
			if (__DEC_tInnerPackage_subpackage_58118 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerPackage_subpackage_58118)) {
					if (!tOuterPackage.equals(__DEC_tInnerPackage_subpackage_58118)) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_20_2_testcorematchandDECs_black_nac_2BB(
			TPackage tInnerPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tInnerPackage_packages_216760 = tInnerPackage.getPg();
		if (__DEC_tInnerPackage_packages_216760 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_packages_216760)) {
				return new Object[] { tInnerPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_20_2_testcorematchandDECs_black_nac_3BBB(
		...
		if (!tInnerPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tInnerClass_classes_52401 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tInnerClass, TPackage.class, "classes")) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_classes_52401)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_classes_52401)) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_20_2_testcorematchandDECs_black_nac_4BB(
		...
		for (TypeGraph __DEC_tInnerClass_classes_663033 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tInnerClass_classes_663033)) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_20_2_testcorematchandDECs_black_nac_5BBB(
			TClass tInnerClass, TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerClass_ownedTypes_433035 = tInnerClass.getPackage();
			if (__DEC_tInnerClass_ownedTypes_433035 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_ownedTypes_433035)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_ownedTypes_433035)) {
						return new Object[] { tInnerClass, tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_20_2_testcorematchandDECs_black_nac_6BB(
		...
		if (!tInnerClass.equals(tOuterClass)) {
			TAbstractType __DEC_tInnerClass_innerTypes_493186 = tInnerClass.getOuterType();
			if (__DEC_tInnerClass_innerTypes_493186 != null) {
				if (!tInnerClass.equals(__DEC_tInnerClass_innerTypes_493186)) {
					if (!tOuterClass.equals(__DEC_tInnerClass_innerTypes_493186)) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_21_2_testcorematchandDECs_black_nac_0B(
			MClass mInnerClass) {
		AbstractTypeDeclaration __DEC_mInnerClass_abstractTypeDeclaration_301921 = mInnerClass
				.getAbstractTypeDeclaration();
		if (__DEC_mInnerClass_abstractTypeDeclaration_301921 != null) {
			if (!mInnerClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_301921)) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_21_2_testcorematchandDECs_black_nac_1BB(
		...
		AnonymousClassDeclaration __DEC_mInnerClass_anonymousClassDeclarationOwner_528998 = mInnerClass
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mInnerClass_anonymousClassDeclarationOwner_528998 != null) {
			if (!eOuterClass.equals(__DEC_mInnerClass_anonymousClassDeclarationOwner_528998)) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_21_2_testcorematchandDECs_black_nac_2B(
			MClass mInnerClass) {
		for (Model __DEC_mInnerClass_orphanTypes_679620 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_21_2_testcorematchandDECs_black_nac_3B(
			MClass mInnerClass) {
		org.eclipse.modisco.java.Package __DEC_mInnerClass_ownedElements_630956 = mInnerClass.getPackage();
		if (__DEC_mInnerClass_ownedElements_630956 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_21_2_testcorematchandDECs_black_nac_4BB(
		...
		for (MAbstractMethodDefinition __DEC_mInnerClass_mInnerTypes_790586 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, MAbstractMethodDefinition.class, "mInnerTypes")) {
			if (!mDefinition.equals(__DEC_mInnerClass_mInnerTypes_790586)) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_24_3_solvecsp_bindingFBBBBBBBBBBB(
			...
			AnonymousClassDeclaration eOuterClass, TPackage tInnerPackage, MAbstractMethodDefinition mDefinition,
			TClass tOuterClass, TClass tInnerClass, TPackage tOuterPackage, Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_27_1_matchtggpattern_black_nac_0B(
			MClass mInnerClass) {
		AbstractTypeDeclaration __DEC_mInnerClass_abstractTypeDeclaration_8474 = mInnerClass
				.getAbstractTypeDeclaration();
		if (__DEC_mInnerClass_abstractTypeDeclaration_8474 != null) {
			if (!mInnerClass.equals(__DEC_mInnerClass_abstractTypeDeclaration_8474)) {
				return new Object[] { mInnerClass };
			}
		}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_27_1_matchtggpattern_black_nac_1BB(
			MClass mInnerClass, AnonymousClassDeclaration eOuterClass) {
		AnonymousClassDeclaration __DEC_mInnerClass_anonymousClassDeclarationOwner_86280 = mInnerClass
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mInnerClass_anonymousClassDeclarationOwner_86280 != null) {
			if (!eOuterClass.equals(__DEC_mInnerClass_anonymousClassDeclarationOwner_86280)) {
				return new Object[] { mInnerClass, eOuterClass };
			}
		}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_27_1_matchtggpattern_black_nac_2B(
			MClass mInnerClass) {
		for (Model __DEC_mInnerClass_orphanTypes_812660 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, Model.class, "orphanTypes")) {
			return new Object[] { mInnerClass };
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_27_1_matchtggpattern_black_nac_3B(
			MClass mInnerClass) {
		org.eclipse.modisco.java.Package __DEC_mInnerClass_ownedElements_602475 = mInnerClass.getPackage();
		if (__DEC_mInnerClass_ownedElements_602475 != null) {
			return new Object[] { mInnerClass };
		}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_27_1_matchtggpattern_black_nac_4BB(
			MClass mInnerClass, MAbstractMethodDefinition mDefinition) {
		for (MAbstractMethodDefinition __DEC_mInnerClass_mInnerTypes_356763 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mInnerClass, MAbstractMethodDefinition.class, "mInnerTypes")) {
			if (!mDefinition.equals(__DEC_mInnerClass_mInnerTypes_356763)) {
				return new Object[] { mInnerClass, mDefinition };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_28_1_matchtggpattern_black_nac_0BB(
			TPackage tInnerPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tInnerPackage_typeGraph_20165 = tInnerPackage.getTypeGraph();
		if (__DEC_tInnerPackage_typeGraph_20165 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_typeGraph_20165)) {
				return new Object[] { tInnerPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_28_1_matchtggpattern_black_nac_1BB(
			TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerPackage_subpackage_428803 = tInnerPackage.getParent();
			if (__DEC_tInnerPackage_subpackage_428803 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerPackage_subpackage_428803)) {
					if (!tOuterPackage.equals(__DEC_tInnerPackage_subpackage_428803)) {
						return new Object[] { tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_28_1_matchtggpattern_black_nac_2BB(
			TPackage tInnerPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tInnerPackage_packages_853813 = tInnerPackage.getPg();
		if (__DEC_tInnerPackage_packages_853813 != null) {
			if (!typeGraph.equals(__DEC_tInnerPackage_packages_853813)) {
				return new Object[] { tInnerPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_28_1_matchtggpattern_black_nac_3BBB(
			TClass tInnerClass, TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tInnerClass_classes_231505 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tInnerClass, TPackage.class, "classes")) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_classes_231505)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_classes_231505)) {
						return new Object[] { tInnerClass, tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_28_1_matchtggpattern_black_nac_4BB(
			TClass tInnerClass, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tInnerClass_classes_716237 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tInnerClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tInnerClass_classes_716237)) {
				return new Object[] { tInnerClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_28_1_matchtggpattern_black_nac_5BBB(
			TClass tInnerClass, TPackage tInnerPackage, TPackage tOuterPackage) {
		if (!tInnerPackage.equals(tOuterPackage)) {
			TPackage __DEC_tInnerClass_ownedTypes_822716 = tInnerClass.getPackage();
			if (__DEC_tInnerClass_ownedTypes_822716 != null) {
				if (!tInnerPackage.equals(__DEC_tInnerClass_ownedTypes_822716)) {
					if (!tOuterPackage.equals(__DEC_tInnerClass_ownedTypes_822716)) {
						return new Object[] { tInnerClass, tInnerPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_ClassInnerAnonClassMember_28_1_matchtggpattern_black_nac_6BB(
			TClass tInnerClass, TClass tOuterClass) {
		if (!tInnerClass.equals(tOuterClass)) {
			TAbstractType __DEC_tInnerClass_innerTypes_42975 = tInnerClass.getOuterType();
			if (__DEC_tInnerClass_innerTypes_42975 != null) {
				if (!tInnerClass.equals(__DEC_tInnerClass_innerTypes_42975)) {
					if (!tOuterClass.equals(__DEC_tInnerClass_innerTypes_42975)) {
						return new Object[] { tInnerClass, tOuterClass };
					}
				}
			}
