...
public class SubPackageToPGPackageImpl extends AbstractRuleImpl implements SubPackageToPGPackage {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_1_1_performtransformation_greenBFBFBB(mPackage, tParent, typeGraph, csp);
		...
		Object[] result2_black = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_1_2_collecttranslatedelements_blackBBB(mPackage, mPackageToTSub, tSub);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPackage] = " + mPackage + ", "
					+ "[mPackageToTSub] = " + mPackageToTSub + ", " + "[tSub] = " + tSub + ".");
		}
		Object[] result2_green = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_1_2_collecttranslatedelements_greenFBBB(mPackage, mPackageToTSub, tSub);
		...
		Object[] result3_black = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, mPackage,
						mPackageToTSub, mParentPackage, tParent, tSub, mParentPackageToTParent, typeGraph);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mPackage] = " + mPackage + ", " + "[mPackageToTSub] = " + mPackageToTSub + ", "
					+ "[mParentPackage] = " + mParentPackage + ", " + "[tParent] = " + tParent + ", " + "[tSub] = "
					+ tSub + ", " + "[mParentPackageToTParent] = " + mParentPackageToTParent + ", " + "[typeGraph] = "
					+ typeGraph + ".");
		}
		SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(ruleresult,
				mPackage, mPackageToTSub, mParentPackage, tParent, tSub, typeGraph);
		...
		SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, mPackage, mPackageToTSub, mParentPackage, tParent, tSub, mParentPackageToTParent,
				typeGraph);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : SubPackageToPGPackageImpl
			...
			for (Object[] result3_black : SubPackageToPGPackageImpl
					.pattern_SubPackageToPGPackage_2_3_findcontext_blackBBBBF(mPackage, mParentPackage, tParent,
				...
				Object[] result3_green = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_2_3_findcontext_greenBBBBBFFFFFF(mPackage, mParentPackage,
								tParent, mParentPackageToTParent, typeGraph);
				...
				//nothing EMoflonEdge tParent__typeGraph____typeGraph = (EMoflonEdge) result3_green[8];
				...
				Object[] result4_bindingAndBlack = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_2_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
								mPackage, mParentPackage, tParent, mParentPackageToTParent, typeGraph);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mPackage] = " + mPackage + ", "
							+ "[mParentPackage] = " + mParentPackage + ", " + "[tParent] = " + tParent + ", "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, org.eclipse.modisco.java.Package mPackage,
			org.eclipse.modisco.java.Package mParentPackage, TPackage tParent,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mPackage, EObject mPackageToTSub,
			EObject mParentPackage, EObject tParent, EObject tSub, EObject mParentPackageToTParent, EObject typeGraph) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		CSP csp = (CSP) result1_bindingAndBlack[5];
		Object[] result1_green = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_11_1_performtransformation_greenFFBBB(mParentPackage, tSub, csp);
		org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) result1_green[0];
		PackageToTPackage mPackageToTSub = (PackageToTPackage) result1_green[1];

		Object[] result2_black = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_11_2_collecttranslatedelements_blackBBB(mPackage, mPackageToTSub, tSub);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPackage] = " + mPackage + ", "
					+ "[mPackageToTSub] = " + mPackageToTSub + ", " + "[tSub] = " + tSub + ".");
		}
		Object[] result2_green = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_11_2_collecttranslatedelements_greenFBBB(mPackage, mPackageToTSub, tSub);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_12_2_corematch_blackFBBFBB(tParent, tSub, typeGraph, match)) {
			org.eclipse.modisco.java.Package mParentPackage = (org.eclipse.modisco.java.Package) result2_black[0];
			PackageToTPackage mParentPackageToTParent = (PackageToTPackage) result2_black[3];
			// ForEach 
			for (Object[] result3_black : SubPackageToPGPackageImpl
					.pattern_SubPackageToPGPackage_12_3_findcontext_blackBBBBB(mParentPackage, tParent, tSub,
							mParentPackageToTParent, typeGraph)) {
				Object[] result3_green = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_12_3_findcontext_greenBBBBBFFFFFFF(mParentPackage, tParent, tSub,
								mParentPackageToTParent, typeGraph);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[5];
				...
				//nothing EMoflonEdge tSub__typeGraph____typeGraph = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tParent__tSub____subpackage = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_12_4_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
								mParentPackage, tParent, tSub, mParentPackageToTParent, typeGraph);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mParentPackage] = "
							+ mParentPackage + ", " + "[tParent] = " + tParent + ", " + "[tSub] = " + tSub + ", "
							+ "[mParentPackageToTParent] = " + mParentPackageToTParent + ", " + "[typeGraph] = "
							+ typeGraph + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			org.eclipse.modisco.java.Package mParentPackage, TPackage tParent, TPackage tSub,
			PackageToTPackage mParentPackageToTParent, TypeGraph typeGraph) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mPackage, EObject mPackageToTSub,
			EObject mParentPackage, EObject tParent, EObject tSub, EObject mParentPackageToTParent, EObject typeGraph) {
		ruleresult.registerObject("mPackage", mPackage);
		ruleresult.registerObject("mPackageToTSub", mPackageToTSub);
		ruleresult.registerObject("mParentPackage", mParentPackage);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_58(EMoflonEdge _edge_typeGraph) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_60(EMoflonEdge _edge_package) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		TPackage tParent = (TPackage) result2_bindingAndBlack[2];
		TPackage tSub = (TPackage) result2_bindingAndBlack[3];
		...
		Object[] result3_bindingAndBlack = SubPackageToPGPackageImpl
				.pattern_SubPackageToPGPackage_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, mPackage, mParentPackage,
						tParent, tSub, typeGraph, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mPackage] = " + mPackage + ", " + "[mParentPackage] = " + mParentPackage + ", " + "[tParent] = "
					+ tParent + ", " + "[tSub] = " + tSub + ", " + "[typeGraph] = " + typeGraph + ", "
			...
			for (Object[] result5_black : SubPackageToPGPackageImpl
				...
				Object[] result6_black = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_24_6_createcorrespondence_blackBBBBBB(mPackage, mParentPackage,
								tParent, tSub, typeGraph, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mPackage] = " + mPackage
							+ ", " + "[mParentPackage] = " + mParentPackage + ", " + "[tParent] = " + tParent + ", "
							+ "[tSub] = " + tSub + ", " + "[typeGraph] = " + typeGraph + ", " + "[ccMatch] = " + ccMatch
							+ ".");
				}
				SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_24_6_createcorrespondence_greenBFBB(mPackage,
						tSub, ccMatch);
	...
	public CSP isApplicable_solveCsp_CC(org.eclipse.modisco.java.Package mPackage,
			org.eclipse.modisco.java.Package mParentPackage, TPackage tParent, TPackage tSub, TypeGraph typeGraph,
		...
		for (Object[] result2_black : SubPackageToPGPackageImpl
			...
			Object[] result3_bindingAndBlack = SubPackageToPGPackageImpl
					.pattern_SubPackageToPGPackage_29_3_solveCSP_bindingAndBlackFBBBBBBB(this, isApplicableMatch,
							mParentPackage, tParent, mParentPackageToTParent, typeGraph, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mParentPackage] = " + mParentPackage
						+ ", " + "[tParent] = " + tParent + ", " + "[mParentPackageToTParent] = "
			...
			if (SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = SubPackageToPGPackageImpl
						.pattern_SubPackageToPGPackage_29_5_checknacs_blackBBBB(mParentPackage, tParent,
								mParentPackageToTParent, typeGraph);
				if (result5_black != null) {

					Object[] result6_black = SubPackageToPGPackageImpl
							.pattern_SubPackageToPGPackage_29_6_perform_blackBBBBB(mParentPackage, tParent,
									mParentPackageToTParent, typeGraph, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mParentPackage] = "
								+ mParentPackage + ", " + "[tParent] = " + tParent + ", "
								+ "[mParentPackageToTParent] = " + mParentPackageToTParent + ", " + "[typeGraph] = "
								+ typeGraph + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					SubPackageToPGPackageImpl.pattern_SubPackageToPGPackage_29_6_perform_greenFFBBFBBB(mParentPackage,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.SUB_PACKAGE_TO_PG_PACKAGE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_PACKAGE_TPACKAGE_TPACKAGE_PACKAGETOTPACKAGE_TYPEGRAPH:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					...
					(TPackage) arguments.get(3), (PackageToTPackage) arguments.get(4), (TypeGraph) arguments.get(5));
		...
		case RulesPackage.SUB_PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_58__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_58((EMoflonEdge) arguments.get(0));
		case RulesPackage.SUB_PACKAGE_TO_PG_PACKAGE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_60__EMOFLONEDGE:
		...
		case RulesPackage.SUB_PACKAGE_TO_PG_PACKAGE___IS_APPLICABLE_SOLVE_CSP_CC__PACKAGE_PACKAGE_TPACKAGE_TPACKAGE_TYPEGRAPH_MATCH_MATCH:
				...
				if (tmpTParent instanceof TPackage) {
					...
					if (tmpMParentPackageToTParent instanceof PackageToTPackage) {
						...
						if (tmpTypeGraph instanceof TypeGraph) {
							...
							return new Object[] { mPackage, mParentPackage, tParent, mParentPackageToTParent, typeGraph,
									isApplicableMatch };
						}
					}
				}
		...
		if (!mPackage.equals(mParentPackage)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { mPackage, mParentPackage, tParent, mParentPackageToTParent, typeGraph, csp,
	...
	public static final Object[] pattern_SubPackageToPGPackage_1_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_SubPackageToPGPackage_1_1_performtransformation_binding != null) {
			...
			TPackage tParent = (TPackage) result_pattern_SubPackageToPGPackage_1_1_performtransformation_binding[2];
			...
			Object[] result_pattern_SubPackageToPGPackage_1_1_performtransformation_black = pattern_SubPackageToPGPackage_1_1_performtransformation_blackBBBBBFBB(
					mPackage, mParentPackage, tParent, mParentPackageToTParent, typeGraph, _this, isApplicableMatch);
			if (result_pattern_SubPackageToPGPackage_1_1_performtransformation_black != null) {
				...
				return new Object[] { mPackage, mParentPackage, tParent, mParentPackageToTParent, typeGraph, csp, _this,
						isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_SubPackageToPGPackage_1_1_performtransformation_greenBFBFBB(
		...
		return new Object[] { mPackage, mPackageToTSub, tParent, tSub, typeGraph, csp };
	}

	public static final Object[] pattern_SubPackageToPGPackage_1_2_collecttranslatedelements_blackBBB(
			org.eclipse.modisco.java.Package mPackage, PackageToTPackage mPackageToTSub, TPackage tSub) {
		return new Object[] { mPackage, mPackageToTSub, tSub };
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_1_2_collecttranslatedelements_greenFBBB(
		...
		return new Object[] { ruleresult, mPackage, mPackageToTSub, tSub };
	}

	public static final Object[] pattern_SubPackageToPGPackage_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject mPackage, EObject mPackageToTSub, EObject mParentPackage,
			EObject tParent, EObject tSub, EObject mParentPackageToTParent, EObject typeGraph) {
	...
	public static final Object[] pattern_SubPackageToPGPackage_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject mPackage, EObject mPackageToTSub, EObject mParentPackage,
			EObject tParent, EObject tSub, EObject typeGraph) {
		EMoflonEdge mPackage__mParentPackage____package = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mParentPackage__mPackage____ownedPackages = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mPackage, mPackageToTSub, mParentPackage, tParent, tSub, typeGraph,
				mPackage__mParentPackage____package, mParentPackage__mPackage____ownedPackages,
				mPackageToTSub__mPackage____source, mPackageToTSub__tSub____target, tSub__typeGraph____typeGraph,
	...
	public static final void pattern_SubPackageToPGPackage_1_5_registerobjects_expressionBBBBBBBBB(
			SubPackageToPGPackage _this, PerformRuleResult ruleresult, EObject mPackage, EObject mPackageToTSub,
			EObject mParentPackage, EObject tParent, EObject tSub, EObject mParentPackageToTParent, EObject typeGraph) {
		_this.registerObjects_FWD(ruleresult, mPackage, mPackageToTSub, mParentPackage, tParent, tSub,
				mParentPackageToTParent, typeGraph);
			...
			if (mParentPackage.equals(mPackage.getPackage())) {
				if (mParentPackage.equals(mParentPackageToTParent.getSource())) {
					if (tParent.equals(mParentPackageToTParent.getTarget())) {
						...
						if (typeGraph != null) {
							_result.add(new Object[] { mPackage, mParentPackage, tParent, mParentPackageToTParent,
									typeGraph });
						}
	...
	public static final Object[] pattern_SubPackageToPGPackage_2_3_findcontext_greenBBBBBFFFFFF(
		...
		return new Object[] { mPackage, mParentPackage, tParent, mParentPackageToTParent, typeGraph, isApplicableMatch,
				mPackage__mParentPackage____package, mParentPackage__mPackage____ownedPackages,
	...
	public static final Object[] pattern_SubPackageToPGPackage_2_4_solveCSP_bindingFBBBBBBB(SubPackageToPGPackage _this,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mPackage, mParentPackage, tParent,
				mParentPackageToTParent, typeGraph);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mPackage, mParentPackage, tParent,
					mParentPackageToTParent, typeGraph };
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_2_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_SubPackageToPGPackage_2_4_solveCSP_binding = pattern_SubPackageToPGPackage_2_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mPackage, mParentPackage, tParent, mParentPackageToTParent, typeGraph);
	...
	public static final Object[] pattern_SubPackageToPGPackage_10_4_collectelementstobetranslated_greenBBBBFFF(
		...
		tParent__tSub____subpackage.setName(tParent__tSub____subpackage_name_prime);
		tSub__tParent____parent.setName(tSub__tParent____parent_name_prime);
		return new Object[] { match, tParent, tSub, typeGraph, tSub__typeGraph____typeGraph,
				tParent__tSub____subpackage, tSub__tParent____parent };
	}
			...
			if (tmpTParent instanceof TPackage) {
				...
				if (tmpTSub instanceof TPackage) {
					...
					if (tmpMParentPackageToTParent instanceof PackageToTPackage) {
						...
						if (tmpTypeGraph instanceof TypeGraph) {
							TypeGraph typeGraph = (TypeGraph) tmpTypeGraph;
							return new Object[] { mParentPackage, tParent, tSub, mParentPackageToTParent, typeGraph,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_SubPackageToPGPackage_11_1_performtransformation_blackBBBBBFBB(
		...
		if (!tParent.equals(tSub)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { mParentPackage, tParent, tSub, mParentPackageToTParent, typeGraph, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_SubPackageToPGPackage_11_1_performtransformation_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_SubPackageToPGPackage_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_SubPackageToPGPackage_11_1_performtransformation_black = pattern_SubPackageToPGPackage_11_1_performtransformation_blackBBBBBFBB(
					mParentPackage, tParent, tSub, mParentPackageToTParent, typeGraph, _this, isApplicableMatch);
	...
	public static final Object[] pattern_SubPackageToPGPackage_11_1_performtransformation_greenFFBBB(
		...
		return new Object[] { mPackage, mPackageToTSub, mParentPackage, tSub, csp };
	}
	...
	public static final void pattern_SubPackageToPGPackage_11_5_registerobjects_expressionBBBBBBBBB(
			SubPackageToPGPackage _this, PerformRuleResult ruleresult, EObject mPackage, EObject mPackageToTSub,
			EObject mParentPackage, EObject tParent, EObject tSub, EObject mParentPackageToTParent, EObject typeGraph) {
		_this.registerObjects_BWD(ruleresult, mPackage, mPackageToTSub, mParentPackage, tParent, tSub,
				mParentPackageToTParent, typeGraph);
	...
	public static final Iterable<Object[]> pattern_SubPackageToPGPackage_12_2_corematch_blackFBBFBB(TPackage tParent,
		...
		if (!tParent.equals(tSub)) {
			for (PackageToTPackage mParentPackageToTParent : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mParentPackage != null) {
					_result.add(
							new Object[] { mParentPackage, tParent, tSub, mParentPackageToTParent, typeGraph, match });
				}
				...
				if (mParentPackage.equals(mParentPackageToTParent.getSource())) {
					if (typeGraph.equals(tSub.getTypeGraph())) {
						if (tParent.getSubpackage().contains(tSub)) {
							if (tParent.equals(mParentPackageToTParent.getTarget())) {
								_result.add(new Object[] { mParentPackage, tParent, tSub, mParentPackageToTParent,
										typeGraph });
							}
						}
					}
	...
	public static final Object[] pattern_SubPackageToPGPackage_12_3_findcontext_greenBBBBBFFFFFFF(
		...
		tSub__tParent____parent.setName(tSub__tParent____parent_name_prime);
		mParentPackageToTParent__tParent____target.setName(mParentPackageToTParent__tParent____target_name_prime);
		return new Object[] { mParentPackage, tParent, tSub, mParentPackageToTParent, typeGraph, isApplicableMatch,
				tParent__typeGraph____typeGraph, mParentPackageToTParent__mParentPackage____source,
	...
	public static final Object[] pattern_SubPackageToPGPackage_12_4_solveCSP_bindingFBBBBBBB(
			...
			org.eclipse.modisco.java.Package mParentPackage, TPackage tParent, TPackage tSub,
			PackageToTPackage mParentPackageToTParent, TypeGraph typeGraph) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mParentPackage, tParent, tSub,
				mParentPackageToTParent, typeGraph);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mParentPackage, tParent, tSub, mParentPackageToTParent,
					typeGraph };
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_12_4_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_SubPackageToPGPackage_12_4_solveCSP_binding = pattern_SubPackageToPGPackage_12_4_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mParentPackage, tParent, tSub, mParentPackageToTParent, typeGraph);
		if (result_pattern_SubPackageToPGPackage_12_4_solveCSP_binding != null) {
			...
			if (result_pattern_SubPackageToPGPackage_12_4_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mParentPackage, tParent, tSub,
						mParentPackageToTParent, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_0BB(TPackage tSub,
			TPackage tParent) {
		if (!tParent.equals(tSub)) {
			TPackage __DEC_tSub_parent_279543 = tSub.getParent();
			if (__DEC_tSub_parent_279543 != null) {
				if (!tSub.equals(__DEC_tSub_parent_279543)) {
					if (!tParent.equals(__DEC_tSub_parent_279543)) {
	...
	public static final Object[] pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_1BB(TPackage tSub,
			TypeGraph typeGraph) {
		TypeGraph __DEC_tSub_packages_805548 = tSub.getPg();
		if (__DEC_tSub_packages_805548 != null) {
			if (!typeGraph.equals(__DEC_tSub_packages_805548)) {
								...
								if (pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_1BB(tSub,
									...
									if (pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_2BB(typeGraph,
										...
										if (pattern_SubPackageToPGPackage_20_2_testcorematchandDECs_black_nac_0BB(tSub,
												tParent) == null) {
											_result.add(new Object[] { tParent, tSub, typeGraph, _edge_typeGraph });
										}
									}
								}
							}
	...
	public static final Object[] pattern_SubPackageToPGPackage_21_2_testcorematchandDECs_black_nac_0B(
		...
		Model __DEC_mPackage_model_297199 = mPackage.getModel();
		if (__DEC_mPackage_model_297199 != null) {
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_bindingFFFFFBB(Match sourceMatch,
		...
		EObject _localVariable_2 = targetMatch.getObject("tParent");
		EObject _localVariable_3 = targetMatch.getObject("tSub");
		EObject _localVariable_4 = targetMatch.getObject("typeGraph");
		EObject tmpMPackage = _localVariable_0;
		EObject tmpMParentPackage = _localVariable_1;
		EObject tmpTParent = _localVariable_2;
		EObject tmpTSub = _localVariable_3;
		EObject tmpTypeGraph = _localVariable_4;
		if (tmpMPackage instanceof org.eclipse.modisco.java.Package) {
			org.eclipse.modisco.java.Package mPackage = (org.eclipse.modisco.java.Package) tmpMPackage;
			if (tmpMParentPackage instanceof org.eclipse.modisco.java.Package) {
				...
				if (tmpTParent instanceof TPackage) {
					...
					if (tmpTSub instanceof TPackage) {
						...
						if (tmpTypeGraph instanceof TypeGraph) {
							TypeGraph typeGraph = (TypeGraph) tmpTypeGraph;
							return new Object[] { mPackage, mParentPackage, tParent, tSub, typeGraph, sourceMatch,
									targetMatch };
						}
					}
				}
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_blackBBBBBBB(
			org.eclipse.modisco.java.Package mPackage, org.eclipse.modisco.java.Package mParentPackage,
			TPackage tParent, TPackage tSub, TypeGraph typeGraph, Match sourceMatch, Match targetMatch) {
		if (!mPackage.equals(mParentPackage)) {
			if (!tParent.equals(tSub)) {
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_binding != null) {
			...
			TPackage tParent = (TPackage) result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_binding[2];
			TPackage tSub = (TPackage) result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_black = pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_blackBBBBBBB(
					mPackage, mParentPackage, tParent, tSub, typeGraph, sourceMatch, targetMatch);
			if (result_pattern_SubPackageToPGPackage_24_2_matchsrctrgcontext_black != null) {

				return new Object[] { mPackage, mParentPackage, tParent, tSub, typeGraph, sourceMatch, targetMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_3_solvecsp_bindingFBBBBBBBB(
			...
			org.eclipse.modisco.java.Package mParentPackage, TPackage tParent, TPackage tSub, TypeGraph typeGraph,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(mPackage, mParentPackage, tParent, tSub, typeGraph,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, mPackage, mParentPackage, tParent, tSub, typeGraph, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_SubPackageToPGPackage_24_3_solvecsp_binding = pattern_SubPackageToPGPackage_24_3_solvecsp_bindingFBBBBBBBB(
				_this, mPackage, mParentPackage, tParent, tSub, typeGraph, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_6_createcorrespondence_blackBBBBBB(
			org.eclipse.modisco.java.Package mPackage, org.eclipse.modisco.java.Package mParentPackage,
			TPackage tParent, TPackage tSub, TypeGraph typeGraph, CCMatch ccMatch) {
		if (!mPackage.equals(mParentPackage)) {
			if (!tParent.equals(tSub)) {
				return new Object[] { mPackage, mParentPackage, tParent, tSub, typeGraph, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_24_6_createcorrespondence_greenBFBB(
		...
		return new Object[] { mPackage, mPackageToTSub, tSub, ccMatch };
	}
	...
	public static final Object[] pattern_SubPackageToPGPackage_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.Package mPackage) {
		Model __DEC_mPackage_model_266159 = mPackage.getModel();
		if (__DEC_mPackage_model_266159 != null) {
			return new Object[] { mPackage };
		}
	...
	public static final Object[] pattern_SubPackageToPGPackage_28_1_matchtggpattern_black_nac_0BB(TPackage tSub,
			TPackage tParent) {
		if (!tParent.equals(tSub)) {
			TPackage __DEC_tSub_parent_679682 = tSub.getParent();
			if (__DEC_tSub_parent_679682 != null) {
				if (!tSub.equals(__DEC_tSub_parent_679682)) {
					if (!tParent.equals(__DEC_tSub_parent_679682)) {
						return new Object[] { tSub, tParent };
					}
				}
			}
	...
	public static final Object[] pattern_SubPackageToPGPackage_28_1_matchtggpattern_black_nac_1BB(TPackage tSub,
			TypeGraph typeGraph) {
		TypeGraph __DEC_tSub_packages_141702 = tSub.getPg();
		if (__DEC_tSub_packages_141702 != null) {
			if (!typeGraph.equals(__DEC_tSub_packages_141702)) {
				return new Object[] { tSub, typeGraph };
			}
		}
	...
	public static final Object[] pattern_SubPackageToPGPackage_29_3_solveCSP_bindingFBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mParentPackage, tParent,
				mParentPackageToTParent, typeGraph, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mParentPackage, tParent, mParentPackageToTParent,
	...
	public static final Object[] pattern_SubPackageToPGPackage_29_3_solveCSP_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_SubPackageToPGPackage_29_3_solveCSP_binding = pattern_SubPackageToPGPackage_29_3_solveCSP_bindingFBBBBBBB(
				_this, isApplicableMatch, mParentPackage, tParent, mParentPackageToTParent, typeGraph, ruleResult);
	...
	public static final Object[] pattern_SubPackageToPGPackage_29_5_checknacs_blackBBBB(
			org.eclipse.modisco.java.Package mParentPackage, TPackage tParent,
			PackageToTPackage mParentPackageToTParent, TypeGraph typeGraph) {
		return new Object[] { mParentPackage, tParent, mParentPackageToTParent, typeGraph };
	}

	public static final Object[] pattern_SubPackageToPGPackage_29_6_perform_blackBBBBB(
			org.eclipse.modisco.java.Package mParentPackage, TPackage tParent,
			PackageToTPackage mParentPackageToTParent, TypeGraph typeGraph, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mParentPackage, tParent, mParentPackageToTParent, typeGraph, ruleResult };
	}

	public static final Object[] pattern_SubPackageToPGPackage_29_6_perform_greenFFBBFBBB(
		...
		return new Object[] { mPackage, mPackageToTSub, mParentPackage, tParent, tSub, typeGraph, ruleResult, csp };
	}
