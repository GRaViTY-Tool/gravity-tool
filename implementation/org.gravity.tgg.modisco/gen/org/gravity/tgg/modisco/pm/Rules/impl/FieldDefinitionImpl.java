...
public class FieldDefinitionImpl extends AbstractRuleImpl implements FieldDefinition {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FieldDefinitionImpl
				.pattern_FieldDefinition_1_1_performtransformation_greenFFFFBB(tFieldSignature, mDefinition);
		...
		Object[] result2_black = FieldDefinitionImpl.pattern_FieldDefinition_1_2_collecttranslatedelements_blackBBBBB(
				mDefinitionToTMember, mBodyToTAnnotation, tDefinition, mDefinitionToTDefinition, mDefinition);
		...
		Object[] result3_black = FieldDefinitionImpl.pattern_FieldDefinition_1_3_bookkeepingforedges_blackBBBBBBBBB(
				ruleresult, mDefinitionToTMember, mSignatureToTFieldSignature, mBodyToTAnnotation, mSignature,
				tDefinition, mDefinitionToTDefinition, tFieldSignature, mDefinition);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mDefinitionToTMember] = " + mDefinitionToTMember + ", "
					+ "[mSignatureToTFieldSignature] = " + mSignatureToTFieldSignature + ", "
					+ "[mBodyToTAnnotation] = " + mBodyToTAnnotation + ", " + "[mSignature] = " + mSignature + ", "
					+ "[tDefinition] = " + tDefinition + ", " + "[mDefinitionToTDefinition] = "
		...
		FieldDefinitionImpl.pattern_FieldDefinition_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFF(ruleresult,
				mDefinitionToTMember, mBodyToTAnnotation, mSignature, tDefinition, mDefinitionToTDefinition,
		...
		//nothing EMoflonEdge mDefinitionToTDefinition__tDefinition____target = (EMoflonEdge) result3_green[12];
		...
		FieldDefinitionImpl.pattern_FieldDefinition_1_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult,
				mDefinitionToTMember, mSignatureToTFieldSignature, mBodyToTAnnotation, mSignature, tDefinition,
				mDefinitionToTDefinition, tFieldSignature, mDefinition);
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mDefinitionToTMember,
			EObject mSignatureToTFieldSignature, EObject mBodyToTAnnotation, EObject mSignature, EObject tDefinition,
			EObject mDefinitionToTDefinition, EObject tFieldSignature, EObject mDefinition) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_23(EMoflonEdge _edge_mDefinitions) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.FIELD_DEFINITION___IS_APPROPRIATE_BWD_EMOFLON_EDGE_23__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_23((EMoflonEdge) arguments.get(0));
		case RulesPackage.FIELD_DEFINITION___IS_APPROPRIATE_FWD_EMOFLON_EDGE_23__EMOFLONEDGE:
		...
		case RulesPackage.FIELD_DEFINITION___IS_APPLICABLE_SOLVE_CSP_CC__MFIELDSIGNATURE_TFIELDDEFINITION_TFIELDSIGNATURE_MFIELDDEFINITION_MATCH_MATCH:
	...
	public static final Object[] pattern_FieldDefinition_1_1_performtransformation_greenFFFFBB(
		...
		return new Object[] { mDefinitionToTMember, mBodyToTAnnotation, tDefinition, mDefinitionToTDefinition,
				tFieldSignature, mDefinition };
	}
	...
	public static final Object[] pattern_FieldDefinition_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, mDefinitionToTMember, mBodyToTAnnotation, tDefinition,
				mDefinitionToTDefinition, mDefinition };
	}

	public static final Object[] pattern_FieldDefinition_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mDefinitionToTMember, EObject mSignatureToTFieldSignature,
			EObject mBodyToTAnnotation, EObject mSignature, EObject tDefinition, EObject mDefinitionToTDefinition,
			EObject tFieldSignature, EObject mDefinition) {
	...
	public static final Object[] pattern_FieldDefinition_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFFF(
			...
			EObject tDefinition, EObject mDefinitionToTDefinition, EObject tFieldSignature, EObject mDefinition) {
		EMoflonEdge mSignature__mDefinition____mDefinitions = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mDefinition__mSignature____mSignature = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mDefinitionToTMember, mBodyToTAnnotation, mSignature, tDefinition,
				mDefinitionToTDefinition, tFieldSignature, mDefinition, mSignature__mDefinition____mDefinitions,
	...
	public static final void pattern_FieldDefinition_1_5_registerobjects_expressionBBBBBBBBBB(FieldDefinition _this,
			...
			EObject mBodyToTAnnotation, EObject mSignature, EObject tDefinition, EObject mDefinitionToTDefinition,
			EObject tFieldSignature, EObject mDefinition) {
		_this.registerObjects_FWD(ruleresult, mDefinitionToTMember, mSignatureToTFieldSignature, mBodyToTAnnotation,
				mSignature, tDefinition, mDefinitionToTDefinition, tFieldSignature, mDefinition);
	...
	public static final Object[] pattern_FieldDefinition_11_1_performtransformation_greenFFBBFF(
		...
		mBodyToTAnnotation.setSource(mDefinition);
		mDefinitionToTDefinition.setSource(mDefinition);
		return new Object[] { mDefinitionToTMember, mBodyToTAnnotation, mSignature, tDefinition,
				mDefinitionToTDefinition, mDefinition };
	}
	...
	public static final void pattern_FieldDefinition_11_5_registerobjects_expressionBBBBBBBBBB(FieldDefinition _this,
			...
			EObject mBodyToTAnnotation, EObject mSignature, EObject tDefinition, EObject mDefinitionToTDefinition,
			EObject tFieldSignature, EObject mDefinition) {
		_this.registerObjects_BWD(ruleresult, mDefinitionToTMember, mSignatureToTFieldSignature, mBodyToTAnnotation,
				mSignature, tDefinition, mDefinitionToTDefinition, tFieldSignature, mDefinition);
	...
	public static final Object[] pattern_FieldDefinition_20_2_testcorematchandDECs_black_nac_0BB(
			TFieldDefinition tDefinition, TFieldSignature tFieldSignature) {
		TSignature __DEC_tDefinition_signature_273327 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_273327 != null) {
			if (!tFieldSignature.equals(__DEC_tDefinition_signature_273327)) {
	...
	public static final Object[] pattern_FieldDefinition_21_2_testcorematchandDECs_black_nac_0BB(
		...
		MSignature __DEC_mDefinition_mDefinitions_245388 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_245388 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_245388)) {
		...
		if (tmpMSignature instanceof MFieldSignature) {
			...
			if (tmpTDefinition instanceof TFieldDefinition) {
				...
				if (tmpTFieldSignature instanceof TFieldSignature) {
					...
					if (tmpMDefinition instanceof MFieldDefinition) {
						MFieldDefinition mDefinition = (MFieldDefinition) tmpMDefinition;
						return new Object[] { mSignature, tDefinition, tFieldSignature, mDefinition, sourceMatch,
								targetMatch };
					}
				}
			}
	...
	public static final Object[] pattern_FieldDefinition_24_2_matchsrctrgcontext_blackBBBBBB(MFieldSignature mSignature,
			TFieldDefinition tDefinition, TFieldSignature tFieldSignature, MFieldDefinition mDefinition,
			Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mSignature, tDefinition, tFieldSignature, mDefinition, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDefinition_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_FieldDefinition_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_FieldDefinition_24_2_matchsrctrgcontext_black = pattern_FieldDefinition_24_2_matchsrctrgcontext_blackBBBBBB(
					mSignature, tDefinition, tFieldSignature, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldDefinition_24_3_solvecsp_bindingFBBBBBBB(FieldDefinition _this,
		...
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(mSignature, tDefinition, tFieldSignature, mDefinition,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, mSignature, tDefinition, tFieldSignature, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_FieldDefinition_24_3_solvecsp_bindingAndBlackFBBBBBBB(FieldDefinition _this,
		...
		Object[] result_pattern_FieldDefinition_24_3_solvecsp_binding = pattern_FieldDefinition_24_3_solvecsp_bindingFBBBBBBB(
				_this, mSignature, tDefinition, tFieldSignature, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_FieldDefinition_24_6_createcorrespondence_blackBBBBB(
		...
		return new Object[] { mSignature, tDefinition, tFieldSignature, mDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_FieldDefinition_27_1_matchtggpattern_black_nac_0BB(
			MFieldDefinition mDefinition, MFieldSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_455863 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_455863 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_455863)) {
				return new Object[] { mDefinition, mSignature };
			}
		}
	...
	public static final Object[] pattern_FieldDefinition_28_1_matchtggpattern_black_nac_0BB(
			TFieldDefinition tDefinition, TFieldSignature tFieldSignature) {
		TSignature __DEC_tDefinition_signature_531624 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_531624 != null) {
			if (!tFieldSignature.equals(__DEC_tDefinition_signature_531624)) {
				return new Object[] { tDefinition, tFieldSignature };
			}
		}
	...
	public static final Object[] pattern_FieldDefinition_29_6_perform_greenFFBFFBFB(MFieldSignature mSignature,
		...
		return new Object[] { mDefinitionToTMember, mBodyToTAnnotation, mSignature, tDefinition,
				mDefinitionToTDefinition, tFieldSignature, mDefinition, ruleResult };
	}
