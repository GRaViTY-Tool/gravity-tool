 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MSyntethicMethodToTSyntethicMethodImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.MSyntethicMethodToTSyntethicMethodImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MSyntethicMethodToTSyntethicMethodImpl extends AbstractCorrespondenceImpl
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.MSYNTETHIC_METHOD_TO_TSYNTETHIC_METHOD;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.MSYNTETHIC_METHOD_TO_TSYNTETHIC_METHOD__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public TSyntethicMethod getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.MSYNTETHIC_METHOD_TO_TSYNTETHIC_METHOD__TARGET, oldTarget, target));
			}
		}
		return target;
	}
