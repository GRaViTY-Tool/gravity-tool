...
public class AnnotationTypeImpl extends AbstractRuleImpl implements AnnotationType {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_0__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_0((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_0__EMOFLONEDGE:
	...
	public static final Object[] pattern_AnnotationType_20_2_testcorematchandDECs_black_nac_0BB(TAnnotationType tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_tAnnotationTypes_923835 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "tAnnotationTypes")) {
			if (!pg.equals(__DEC_tType_tAnnotationTypes_923835)) {
	...
	public static final Object[] pattern_AnnotationType_20_2_testcorematchandDECs_black_nac_1BB(TAnnotationType tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_139747 = tType.getPackage();
		if (__DEC_tType_ownedTypes_139747 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_139747)) {
	...
	public static final Object[] pattern_AnnotationType_20_2_testcorematchandDECs_black_nac_2B(TAnnotationType tType) {
		TAbstractType __DEC_tType_innerTypes_405166 = tType.getOuterType();
		if (__DEC_tType_innerTypes_405166 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_405166)) {
	...
	public static final Object[] pattern_AnnotationType_21_2_testcorematchandDECs_black_nac_0B(
			AnnotationTypeDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_594776 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_594776 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_594776)) {
	...
	public static final Object[] pattern_AnnotationType_21_2_testcorematchandDECs_black_nac_1B(
			AnnotationTypeDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_552039 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_552039 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_AnnotationType_21_2_testcorematchandDECs_black_nac_2B(
			AnnotationTypeDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_319642 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationType_21_2_testcorematchandDECs_black_nac_3B(
			AnnotationTypeDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_969912 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_AnnotationType_27_1_matchtggpattern_black_nac_0B(
			AnnotationTypeDeclaration mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_913782 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_913782 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_913782)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_AnnotationType_27_1_matchtggpattern_black_nac_1B(
			AnnotationTypeDeclaration mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_476098 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_476098 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_AnnotationType_27_1_matchtggpattern_black_nac_2B(
			AnnotationTypeDeclaration mType) {
		for (Model __DEC_mType_orphanTypes_295849 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, Model.class, "orphanTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationType_27_1_matchtggpattern_black_nac_3B(
			AnnotationTypeDeclaration mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_604397 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_AnnotationType_28_1_matchtggpattern_black_nac_0BB(TAnnotationType tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_tAnnotationTypes_651356 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "tAnnotationTypes")) {
			if (!pg.equals(__DEC_tType_tAnnotationTypes_651356)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationType_28_1_matchtggpattern_black_nac_1BB(TAnnotationType tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_174207 = tType.getPackage();
		if (__DEC_tType_ownedTypes_174207 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_174207)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_AnnotationType_28_1_matchtggpattern_black_nac_2B(TAnnotationType tType) {
		TAbstractType __DEC_tType_innerTypes_900863 = tType.getOuterType();
		if (__DEC_tType_innerTypes_900863 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_900863)) {
				return new Object[] { tType };
			}
		}
