...
public class MemberInEnumVisibilityImpl extends AbstractRuleImpl implements MemberInEnumVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mModifier,
						mModifierToTModifier, tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition,
						tModifier);
		...
		MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				mModifier, mModifierToTModifier, tMember, mDefinition, tModifier);
		...
		MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mModifier, mModifierToTModifier, tClass, tMember, mTypeToTType, mClass, defToMember,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInEnumVisibilityImpl
			...
			for (Object[] result3_black : MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_2_3_findcontext_blackBBBBBBB(mModifier, tClass, tMember,
							mTypeToTType, mClass, defToMember, mDefinition)) {
				Object[] result3_green = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mModifier, tClass,
								tMember, mTypeToTType, mClass, defToMember, mDefinition);
				...
				Object[] result4_bindingAndBlack = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mModifier, tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Modifier mModifier, TClass tClass,
			TMember tMember, TypeToTAbstractType mTypeToTType, EnumDeclaration mClass, MDefinitionToTMember defToMember,
			MDefinition mDefinition) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject mModifierToTModifier,
			EObject tClass, EObject tMember, EObject mTypeToTType, EObject mClass, EObject defToMember,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_12_2_corematch_blackBBFFFFBB(tClass, tMember, tModifier, match)) {
			...
			// ForEach 
			for (Object[] result3_black : MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_12_3_findcontext_blackBBBBBBB(tClass, tMember, mTypeToTType, mClass,
							defToMember, mDefinition, tModifier)) {
				Object[] result3_green = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tClass, tMember,
								mTypeToTType, mClass, defToMember, mDefinition, tModifier);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tClass__tMember____defines = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tMember__tClass____definedBy = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, tModifier);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TClass tClass, TMember tMember,
			TypeToTAbstractType mTypeToTType, EnumDeclaration mClass, MDefinitionToTMember defToMember,
			MDefinition mDefinition, TModifier tModifier) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInEnumVisibilityImpl
				.pattern_MemberInEnumVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mModifier, tClass,
						tMember, mClass, mDefinition, tModifier, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mModifier] = " + mModifier + ", " + "[tClass] = " + tClass + ", " + "[tMember] = " + tMember
					+ ", " + "[mClass] = " + mClass + ", " + "[mDefinition] = " + mDefinition + ", " + "[tModifier] = "
		...
		if (MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_24_5_matchcorrcontext_blackBBFBFBBB(tClass, tMember, mClass,
				...
				Object[] result6_black = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_24_6_createcorrespondence_blackBBBBBBB(mModifier, tClass,
								tMember, mClass, mDefinition, tModifier, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Modifier mModifier, TClass tClass, TMember tMember, EnumDeclaration mClass,
			MDefinition mDefinition, TModifier tModifier, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : MemberInEnumVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInEnumVisibilityImpl
					.pattern_MemberInEnumVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tClass] = " + tClass + ", "
						+ "[tMember] = " + tMember + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[mClass] = "
						+ mClass + ", " + "[defToMember] = " + defToMember + ", " + "[mDefinition] = " + mDefinition
			...
			if (MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MemberInEnumVisibilityImpl
						.pattern_MemberInEnumVisibility_29_5_checknacs_blackBBBBBB(tClass, tMember, mTypeToTType,
								mClass, defToMember, mDefinition);
				if (result5_black != null) {

					Object[] result6_black = MemberInEnumVisibilityImpl
							.pattern_MemberInEnumVisibility_29_6_perform_blackBBBBBBB(tClass, tMember, mTypeToTType,
									mClass, defToMember, mDefinition, ruleResult);
					if (result6_black == null) {
					...
					MemberInEnumVisibilityImpl.pattern_MemberInEnumVisibility_29_6_perform_greenFFBBFBB(tMember,
	 ...
	 * @generated
	 */
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TClass tClass, TMember tMember,
			TypeToTAbstractType mTypeToTType, EnumDeclaration mClass, MDefinitionToTMember defToMember,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_TCLASS_TMEMBER_TYPETOTABSTRACTTYPE_ENUMDECLARATION_MDEFINITIONTOTMEMBER_MDEFINITION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Modifier) arguments.get(1),
					(TClass) arguments.get(2), (TMember) arguments.get(3), (TypeToTAbstractType) arguments.get(4),
					(EnumDeclaration) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TCLASS_TMEMBER_TYPETOTABSTRACTTYPE_ENUMDECLARATION_MDEFINITIONTOTMEMBER_MDEFINITION_TMODIFIER:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TClass) arguments.get(1),
					...
					(MDefinition) arguments.get(6), (TModifier) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_28__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__MODIFIER_TCLASS_TMEMBER_ENUMDECLARATION_MDEFINITION_TMODIFIER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Modifier) arguments.get(0), (TClass) arguments.get(1),
					(TMember) arguments.get(2), (EnumDeclaration) arguments.get(3), (MDefinition) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_ENUM_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TCLASS_TMEMBER_TYPETOTABSTRACTTYPE_ENUMDECLARATION_MDEFINITIONTOTMEMBER_MDEFINITION_MODELGENERATORRULERESULT:
						...
						if (tmpMClass instanceof EnumDeclaration) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									...
									return new Object[] { mModifier, tClass, tMember, mTypeToTType, mClass, defToMember,
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			Modifier mModifier, TClass tClass, TMember tMember, TypeToTAbstractType mTypeToTType,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, csp,
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInEnumVisibility_1_1_performtransformation_binding != null) {
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_MemberInEnumVisibility_1_1_performtransformation_binding[3];
			...
			Object[] result_pattern_MemberInEnumVisibility_1_1_performtransformation_black = pattern_MemberInEnumVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			...
			EObject tMember, EObject mTypeToTType, EObject mClass, EObject defToMember, EObject mDefinition,
			EObject tModifier) {
	...
	public static final Object[] pattern_MemberInEnumVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mModifier, EObject mModifierToTModifier, EObject tMember,
			EObject mDefinition, EObject tModifier) {
		...
		return new Object[] { ruleresult, mModifier, mModifierToTModifier, tMember, mDefinition, tModifier,
	...
	public static final void pattern_MemberInEnumVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInEnumVisibility _this, PerformRuleResult ruleresult, EObject mModifier, EObject mModifierToTModifier,
			EObject tClass, EObject tMember, EObject mTypeToTType, EObject mClass, EObject defToMember,
			EObject mDefinition, EObject tModifier) {
		_this.registerObjects_FWD(ruleresult, mModifier, mModifierToTModifier, tClass, tMember, mTypeToTType, mClass,
				defToMember, mDefinition, tModifier);
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpTClass instanceof TClass) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tMember != null) {
						_result.add(new Object[] { mModifier, tClass, tMember, mTypeToTType, mClass, defToMember,
								mDefinition, match });
					}
						...
						if (mDefinition.equals(defToMember.getSource())) {
							if (mClass.getBodyDeclarations().contains(mDefinition)) {
								if (mModifier.equals(mDefinition.getModifier())) {
									_result.add(new Object[] { mModifier, tClass, tMember, mTypeToTType, mClass,
	...
	public static final Object[] pattern_MemberInEnumVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		mDefinition__mModifier____modifier.setName(mDefinition__mModifier____modifier_name_prime);
		mModifier__mDefinition____bodyDeclaration.setName(mModifier__mDefinition____bodyDeclaration_name_prime);
		return new Object[] { mModifier, tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition,
				isApplicableMatch, tClass__tMember____defines, tMember__tClass____definedBy,
				mTypeToTType__mClass____source, mTypeToTType__tClass____target, defToMember__tMember____target,
	...
	public static final Object[] pattern_MemberInEnumVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
			MemberInEnumVisibility _this, IsApplicableMatch isApplicableMatch, Modifier mModifier, TClass tClass,
			TMember tMember, TypeToTAbstractType mTypeToTType, EnumDeclaration mClass, MDefinitionToTMember defToMember,
			MDefinition mDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModifier, tClass, tMember,
				mTypeToTType, mClass, defToMember, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, tClass, tMember, mTypeToTType, mClass,
					defToMember, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_2_4_solveCSP_binding = pattern_MemberInEnumVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition);
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpTModifier instanceof TModifier) {
									...
									return new Object[] { tClass, tMember, mTypeToTType, mClass, defToMember,
	...
	public static final Object[] pattern_MemberInEnumVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TClass tClass, TMember tMember, TypeToTAbstractType mTypeToTType, EnumDeclaration mClass,
			MDefinitionToTMember defToMember, MDefinition mDefinition, TModifier tModifier,
			MemberInEnumVisibility _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, tModifier, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInEnumVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInEnumVisibility_11_1_performtransformation_binding != null) {
			...
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result_pattern_MemberInEnumVisibility_11_1_performtransformation_binding[2];
			...
			MDefinition mDefinition = (MDefinition) result_pattern_MemberInEnumVisibility_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_MemberInEnumVisibility_11_1_performtransformation_black = pattern_MemberInEnumVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, tModifier, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInEnumVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tClass, EObject tMember, EObject mTypeToTType, EObject mClass, EObject defToMember,
			EObject mDefinition, EObject tModifier) {
		_this.registerObjects_BWD(ruleresult, mModifier, mModifierToTModifier, tClass, tMember, mTypeToTType, mClass,
				defToMember, mDefinition, tModifier);
	...
	public static final Iterable<Object[]> pattern_MemberInEnumVisibility_12_2_corematch_blackBBFFFFBB(TClass tClass,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMClass instanceof EnumDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition,
								tModifier, match });
					}
				...
				if (mClass.equals(mTypeToTType.getSource())) {
					if (tClass.equals(mTypeToTType.getTarget())) {
						if (tMember.equals(defToMember.getTarget())) {
							if (mDefinition.equals(defToMember.getSource())) {
								if (mClass.getBodyDeclarations().contains(mDefinition)) {
									_result.add(new Object[] { tClass, tMember, mTypeToTType, mClass, defToMember,
											mDefinition, tModifier });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInEnumVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(TClass tClass,
		...
		mDefinition__mClass____abstractTypeDeclaration
				.setName(mDefinition__mClass____abstractTypeDeclaration_name_prime);
		return new Object[] { tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, tModifier,
				isApplicableMatch, tClass__tMember____defines, tMember__tClass____definedBy,
	...
	public static final Object[] pattern_MemberInEnumVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			MemberInEnumVisibility _this, IsApplicableMatch isApplicableMatch, TClass tClass, TMember tMember,
			TypeToTAbstractType mTypeToTType, EnumDeclaration mClass, MDefinitionToTMember defToMember,
			MDefinition mDefinition, TModifier tModifier) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tClass, tMember, mTypeToTType, mClass,
				defToMember, mDefinition, tModifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tClass, tMember, mTypeToTType, mClass, defToMember,
					mDefinition, tModifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_12_4_solveCSP_binding = pattern_MemberInEnumVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, tModifier);
	...
	public static final Object[] pattern_MemberInEnumVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_489967 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_489967)) {
				...
				if (tmpTMember instanceof TMember) {
					...
					if (tmpMClass instanceof EnumDeclaration) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpTModifier instanceof TModifier) {
								TModifier tModifier = (TModifier) tmpTModifier;
								return new Object[] { mModifier, tClass, tMember, mClass, mDefinition, tModifier,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			Modifier mModifier, TClass tClass, TMember tMember, EnumDeclaration mClass, MDefinition mDefinition,
			TModifier tModifier, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mModifier, tClass, tMember, mClass, mDefinition, tModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			MDefinition mDefinition = (MDefinition) result_pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_binding[4];
			...
			Object[] result_pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInEnumVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mModifier, tClass, tMember, mClass, mDefinition, tModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInEnumVisibility _this, Modifier mModifier, TClass tClass, TMember tMember, EnumDeclaration mClass,
			MDefinition mDefinition, TModifier tModifier, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mModifier, tClass, tMember, mClass, mDefinition,
				tModifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mModifier, tClass, tMember, mClass, mDefinition, tModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_24_3_solvecsp_binding = pattern_MemberInEnumVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mModifier, tClass, tMember, mClass, mDefinition, tModifier, sourceMatch, targetMatch);
		if (result_pattern_MemberInEnumVisibility_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MemberInEnumVisibility_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mModifier, tClass, tMember, mClass, mDefinition, tModifier,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MemberInEnumVisibility_24_5_matchcorrcontext_blackBBFBFBBB(
			TClass tClass, TMember tMember, EnumDeclaration mClass, MDefinition mDefinition, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_MemberInEnumVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mModifier, tClass, tMember, mClass, mDefinition, tModifier, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInEnumVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_182758 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_182758)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInEnumVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tClass, tMember, mTypeToTType,
				mClass, defToMember, mDefinition, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tClass, tMember, mTypeToTType, mClass, defToMember,
	...
	public static final Object[] pattern_MemberInEnumVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInEnumVisibility_29_3_solveCSP_binding = pattern_MemberInEnumVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, ruleResult);
	...
	public static final Object[] pattern_MemberInEnumVisibility_29_5_checknacs_blackBBBBBB(TClass tClass,
			TMember tMember, TypeToTAbstractType mTypeToTType, EnumDeclaration mClass, MDefinitionToTMember defToMember,
			MDefinition mDefinition) {
		return new Object[] { tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition };
	}

	public static final Object[] pattern_MemberInEnumVisibility_29_6_perform_blackBBBBBBB(TClass tClass,
			TMember tMember, TypeToTAbstractType mTypeToTType, EnumDeclaration mClass, MDefinitionToTMember defToMember,
			MDefinition mDefinition, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { tClass, tMember, mTypeToTType, mClass, defToMember, mDefinition, ruleResult };
	}

	public static final Object[] pattern_MemberInEnumVisibility_29_6_perform_greenFFBBFBB(TMember tMember,
		...
		return new Object[] { mModifier, mModifierToTModifier, tMember, mDefinition, tModifier, ruleResult, csp };
	}
