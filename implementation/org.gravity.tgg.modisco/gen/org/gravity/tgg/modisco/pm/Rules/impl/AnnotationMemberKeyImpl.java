...
public class AnnotationMemberKeyImpl extends AbstractRuleImpl implements AnnotationMemberKey {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mOwner, mValue, tOwner,
						tAnnotation, tAnnotationValue, annotationMemberValuePairToTAnnotationValue,
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ mAnnotation + ", " + "[ownerToWoner] = " + ownerToWoner + ".");
		}
		...
		AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mOwner, mValue, tOwner, tAnnotation, tAnnotationValue, annotationMemberValuePairToTAnnotationValue,
				annotationToTAnnotation, mAnnotation, ownerToWoner);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_2_2_corematch_blackBBFFFBFB(mOwner, mValue, mAnnotation, match)) {
			...
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_2_3_findcontext_blackBBBBBBB(mOwner, mValue, tOwner, tAnnotation,
							annotationToTAnnotation, mAnnotation, ownerToWoner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(mOwner, mValue, tOwner,
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mOwner, mValue, tOwner, tAnnotation, annotationToTAnnotation, mAnnotation,
								ownerToWoner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mOwner] = " + mOwner + ", "
							+ "[mValue] = " + mValue + ", " + "[tOwner] = " + tOwner + ", " + "[tAnnotation] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, BodyDeclaration mOwner,
			AnnotationMemberValuePair mValue, TAnnotatable tOwner, TAnnotation tAnnotation,
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mOwner, EObject mValue, EObject tOwner,
			EObject tAnnotation, EObject tAnnotationValue, EObject annotationMemberValuePairToTAnnotationValue,
			EObject annotationToTAnnotation, EObject mAnnotation, EObject ownerToWoner) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mOwner, mValue,
						tOwner, tAnnotation, tAnnotationValue, annotationMemberValuePairToTAnnotationValue,
						annotationToTAnnotation, mAnnotation, ownerToWoner);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mOwner] = " + mOwner + ", " + "[mValue] = " + mValue + ", " + "[tOwner] = " + tOwner
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_12_2_corematch_blackFBBBFFFB(
			...
			// ForEach 
			for (Object[] result3_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_12_3_findcontext_blackBBBBBBB(mOwner, tOwner, tAnnotation,
							tAnnotationValue, annotationToTAnnotation, mAnnotation, ownerToWoner)) {
				Object[] result3_green = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(mOwner, tOwner, tAnnotation,
								tAnnotationValue, annotationToTAnnotation, mAnnotation, ownerToWoner);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tOwner__tAnnotation____tAnnotation = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tAnnotation__tOwner____tAnnotated = (EMoflonEdge) result3_green[9];
				...
				Object[] result4_bindingAndBlack = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mOwner, tOwner, tAnnotation, tAnnotationValue, annotationToTAnnotation, mAnnotation,
								ownerToWoner);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mOwner] = " + mOwner + ", "
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mOwner, EObject mValue, EObject tOwner,
			EObject tAnnotation, EObject tAnnotationValue, EObject annotationMemberValuePairToTAnnotationValue,
			EObject annotationToTAnnotation, EObject mAnnotation, EObject ownerToWoner) {
		ruleresult.registerObject("mOwner", mOwner);
		ruleresult.registerObject("mValue", mValue);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_73(EMoflonEdge _edge_tValues) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_77(EMoflonEdge _edge_values) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
				.pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mOwner, mValue, tOwner,
						tAnnotation, tAnnotationValue, mAnnotation, sourceMatch, targetMatch);
		...
		if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackBBBFBFBB(mOwner, tOwner, tAnnotation,
				...
				Object[] result6_black = AnnotationMemberKeyImpl
						.pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(mOwner, mValue, tOwner,
								tAnnotation, tAnnotationValue, mAnnotation, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mOwner] = " + mOwner
							+ ", " + "[mValue] = " + mValue + ", " + "[tOwner] = " + tOwner + ", " + "[tAnnotation] = "
							+ tAnnotation + ", " + "[tAnnotationValue] = " + tAnnotationValue + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(BodyDeclaration mOwner, AnnotationMemberValuePair mValue, TAnnotatable tOwner,
			TAnnotation tAnnotation, TAnnotationValue tAnnotationValue, Annotation mAnnotation, Match sourceMatch,
		...
		for (Object[] result2_black : AnnotationMemberKeyImpl
			...
			Object[] result3_bindingAndBlack = AnnotationMemberKeyImpl
					.pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mOwner, tOwner, tAnnotation, annotationToTAnnotation, mAnnotation, ownerToWoner,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mOwner] = " + mOwner + ", "
			...
			if (AnnotationMemberKeyImpl.pattern_AnnotationMemberKey_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					Object[] result6_black = AnnotationMemberKeyImpl
							.pattern_AnnotationMemberKey_29_6_perform_blackBBBBBBB(mOwner, tOwner, tAnnotation,
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, BodyDeclaration mOwner,
			TAnnotatable tOwner, TAnnotation tAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_BODYDECLARATION_ANNOTATIONMEMBERVALUEPAIR_TANNOTATABLE_TANNOTATION_ANNOTATIONTOTANNOTATION_ANNOTATION_ASTNODETOTANNOTATABLE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (BodyDeclaration) arguments.get(1),
					(AnnotationMemberValuePair) arguments.get(2), (TAnnotatable) arguments.get(3),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BODYDECLARATION_TANNOTATABLE_TANNOTATION_TANNOTATIONVALUE_ANNOTATIONTOTANNOTATION_ANNOTATION_ASTNODETOTANNOTATABLE:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_73__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_73((EMoflonEdge) arguments.get(0));
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_77__EMOFLONEDGE:
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___IS_APPLICABLE_SOLVE_CSP_CC__BODYDECLARATION_ANNOTATIONMEMBERVALUEPAIR_TANNOTATABLE_TANNOTATION_TANNOTATIONVALUE_ANNOTATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((BodyDeclaration) arguments.get(0),
					(AnnotationMemberValuePair) arguments.get(1), (TAnnotatable) arguments.get(2),
					(TAnnotation) arguments.get(3), (TAnnotationValue) arguments.get(4), (Annotation) arguments.get(5),
		...
		case RulesPackage.ANNOTATION_MEMBER_KEY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_BODYDECLARATION_TANNOTATABLE_TANNOTATION_ANNOTATIONTOTANNOTATION_ANNOTATION_ASTNODETOTANNOTATABLE_MODELGENERATORRULERESULT:
						...
						if (tmpAnnotationToTAnnotation instanceof AnnotationToTAnnotation) {
							...
							if (tmpMAnnotation instanceof Annotation) {
								...
								if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
									...
									return new Object[] { mOwner, mValue, tOwner, tAnnotation, annotationToTAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
			BodyDeclaration mOwner, AnnotationMemberValuePair mValue, TAnnotatable tOwner, TAnnotation tAnnotation,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mOwner, mValue, tOwner, tAnnotation, annotationToTAnnotation, mAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_1_1_performtransformation_black = pattern_AnnotationMemberKey_1_1_performtransformation_blackBBBBBBBFBB(
					mOwner, mValue, tOwner, tAnnotation, annotationToTAnnotation, mAnnotation, ownerToWoner, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mOwner, EObject mValue, EObject tOwner, EObject tAnnotation,
			EObject tAnnotationValue, EObject annotationMemberValuePairToTAnnotationValue,
			EObject annotationToTAnnotation, EObject mAnnotation, EObject ownerToWoner) {
	...
	public static final void pattern_AnnotationMemberKey_1_5_registerobjects_expressionBBBBBBBBBBB(
			AnnotationMemberKey _this, PerformRuleResult ruleresult, EObject mOwner, EObject mValue, EObject tOwner,
			EObject tAnnotation, EObject tAnnotationValue, EObject annotationMemberValuePairToTAnnotationValue,
			EObject annotationToTAnnotation, EObject mAnnotation, EObject ownerToWoner) {
		_this.registerObjects_FWD(ruleresult, mOwner, mValue, tOwner, tAnnotation, tAnnotationValue,
				annotationMemberValuePairToTAnnotationValue, annotationToTAnnotation, mAnnotation, ownerToWoner);
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tOwner != null) {
						_result.add(new Object[] { mOwner, mValue, tOwner, tAnnotation, annotationToTAnnotation,
						...
						if (mOwner.getAnnotations().contains(mAnnotation)) {
							if (tOwner.equals(ownerToWoner.getTarget())) {
								if (mOwner.equals(ownerToWoner.getSource())) {
									_result.add(new Object[] { mOwner, mValue, tOwner, tAnnotation,
											annotationToTAnnotation, mAnnotation, ownerToWoner });
								}
							}
						}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		return new Object[] { mOwner, mValue, tOwner, tAnnotation, annotationToTAnnotation, mAnnotation, ownerToWoner,
				...
				mAnnotation__mValue____values, mOwner__mAnnotation____annotations, ownerToWoner__tOwner____target,
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, BodyDeclaration mOwner, AnnotationMemberValuePair mValue,
			TAnnotatable tOwner, TAnnotation tAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, ASTNodeToTAnnotatable ownerToWoner) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mOwner, mValue, tOwner, tAnnotation,
				annotationToTAnnotation, mAnnotation, ownerToWoner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mOwner, mValue, tOwner, tAnnotation,
					annotationToTAnnotation, mAnnotation, ownerToWoner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_2_4_solveCSP_binding = pattern_AnnotationMemberKey_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mOwner, mValue, tOwner, tAnnotation, annotationToTAnnotation, mAnnotation,
				ownerToWoner);
					...
					if (tmpTAnnotationValue instanceof TAnnotationValue) {
						...
						if (tmpAnnotationToTAnnotation instanceof AnnotationToTAnnotation) {
							...
							if (tmpMAnnotation instanceof Annotation) {
								...
								if (tmpOwnerToWoner instanceof ASTNodeToTAnnotatable) {
									ASTNodeToTAnnotatable ownerToWoner = (ASTNodeToTAnnotatable) tmpOwnerToWoner;
									return new Object[] { mOwner, tOwner, tAnnotation, tAnnotationValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
			BodyDeclaration mOwner, TAnnotatable tOwner, TAnnotation tAnnotation, TAnnotationValue tAnnotationValue,
			AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation, ASTNodeToTAnnotatable ownerToWoner,
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mOwner, tOwner, tAnnotation, tAnnotationValue, annotationToTAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_11_1_performtransformation_black = pattern_AnnotationMemberKey_11_1_performtransformation_blackBBBBBBBFBB(
					mOwner, tOwner, tAnnotation, tAnnotationValue, annotationToTAnnotation, mAnnotation, ownerToWoner,
	...
	public static final void pattern_AnnotationMemberKey_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tAnnotation, EObject tAnnotationValue, EObject annotationMemberValuePairToTAnnotationValue,
			EObject annotationToTAnnotation, EObject mAnnotation, EObject ownerToWoner) {
		_this.registerObjects_BWD(ruleresult, mOwner, mValue, tOwner, tAnnotation, tAnnotationValue,
				annotationMemberValuePairToTAnnotationValue, annotationToTAnnotation, mAnnotation, ownerToWoner);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_12_2_corematch_blackFBBBFFFB(TAnnotatable tOwner,
		...
		for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (mAnnotation != null) {
				for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMOwner instanceof BodyDeclaration) {
						BodyDeclaration mOwner = (BodyDeclaration) tmpMOwner;
						_result.add(new Object[] { mOwner, tOwner, tAnnotation, tAnnotationValue,
	...
	public static final Object[] pattern_AnnotationMemberKey_12_3_findcontext_greenBBBBBBBFFFFFFFFF(
		...
		ownerToWoner__tOwner____target.setName(ownerToWoner__tOwner____target_name_prime);
		ownerToWoner__mOwner____source.setName(ownerToWoner__mOwner____source_name_prime);
		return new Object[] { mOwner, tOwner, tAnnotation, tAnnotationValue, annotationToTAnnotation, mAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			IsApplicableMatch isApplicableMatch, BodyDeclaration mOwner, TAnnotatable tOwner, TAnnotation tAnnotation,
			TAnnotationValue tAnnotationValue, AnnotationToTAnnotation annotationToTAnnotation, Annotation mAnnotation,
			ASTNodeToTAnnotatable ownerToWoner) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mOwner, tOwner, tAnnotation,
				tAnnotationValue, annotationToTAnnotation, mAnnotation, ownerToWoner);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mOwner, tOwner, tAnnotation, tAnnotationValue,
					annotationToTAnnotation, mAnnotation, ownerToWoner };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, IsApplicableMatch isApplicableMatch, BodyDeclaration mOwner, TAnnotatable tOwner,
			TAnnotation tAnnotation, TAnnotationValue tAnnotationValue, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, ASTNodeToTAnnotatable ownerToWoner) {
		Object[] result_pattern_AnnotationMemberKey_12_4_solveCSP_binding = pattern_AnnotationMemberKey_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mOwner, tOwner, tAnnotation, tAnnotationValue, annotationToTAnnotation,
				...
				if (tmpTOwner instanceof TAnnotatable) {
					...
					if (tmpTAnnotation instanceof TAnnotation) {
						...
						if (tmpTAnnotationValue instanceof TAnnotationValue) {
							...
							if (tmpMAnnotation instanceof Annotation) {
								Annotation mAnnotation = (Annotation) tmpMAnnotation;
								return new Object[] { mOwner, mValue, tOwner, tAnnotation, tAnnotationValue,
										mAnnotation, sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
			BodyDeclaration mOwner, AnnotationMemberValuePair mValue, TAnnotatable tOwner, TAnnotation tAnnotation,
			TAnnotationValue tAnnotationValue, Annotation mAnnotation, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mOwner, mValue, tOwner, tAnnotation, tAnnotationValue, mAnnotation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_black = pattern_AnnotationMemberKey_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mOwner, mValue, tOwner, tAnnotation, tAnnotationValue, mAnnotation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(AnnotationMemberKey _this,
			BodyDeclaration mOwner, AnnotationMemberValuePair mValue, TAnnotatable tOwner, TAnnotation tAnnotation,
			TAnnotationValue tAnnotationValue, Annotation mAnnotation, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mOwner, mValue, tOwner, tAnnotation, tAnnotationValue,
				mAnnotation, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mOwner, mValue, tOwner, tAnnotation, tAnnotationValue, mAnnotation,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			AnnotationMemberKey _this, BodyDeclaration mOwner, AnnotationMemberValuePair mValue, TAnnotatable tOwner,
			TAnnotation tAnnotation, TAnnotationValue tAnnotationValue, Annotation mAnnotation, Match sourceMatch,
			Match targetMatch) {
		Object[] result_pattern_AnnotationMemberKey_24_3_solvecsp_binding = pattern_AnnotationMemberKey_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mOwner, mValue, tOwner, tAnnotation, tAnnotationValue, mAnnotation, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_AnnotationMemberKey_24_5_matchcorrcontext_blackBBBFBFBB(
			BodyDeclaration mOwner, TAnnotatable tOwner, TAnnotation tAnnotation, Annotation mAnnotation,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (AnnotationToTAnnotation annotationToTAnnotation : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (mAnnotation.equals(annotationToTAnnotation.getSource())) {
					for (ASTNodeToTAnnotatable ownerToWoner : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(tOwner, ASTNodeToTAnnotatable.class, "target")) {
						if (mOwner.equals(ownerToWoner.getSource())) {
							_result.add(new Object[] { mOwner, tOwner, tAnnotation, annotationToTAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_24_6_createcorrespondence_blackBBBBBBB(
			BodyDeclaration mOwner, AnnotationMemberValuePair mValue, TAnnotatable tOwner, TAnnotation tAnnotation,
			TAnnotationValue tAnnotationValue, Annotation mAnnotation, CCMatch ccMatch) {
		return new Object[] { mOwner, mValue, tOwner, tAnnotation, tAnnotationValue, mAnnotation, ccMatch };
	}
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(AnnotationMemberKey _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mOwner, tOwner, tAnnotation,
				annotationToTAnnotation, mAnnotation, ownerToWoner, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mOwner, tOwner, tAnnotation, annotationToTAnnotation,
	...
	public static final Object[] pattern_AnnotationMemberKey_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_AnnotationMemberKey_29_3_solveCSP_binding = pattern_AnnotationMemberKey_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mOwner, tOwner, tAnnotation, annotationToTAnnotation, mAnnotation,
		...
		if (result_pattern_AnnotationMemberKey_29_3_solveCSP_binding != null) {
			...
			if (result_pattern_AnnotationMemberKey_29_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, mOwner, tOwner, tAnnotation,
						annotationToTAnnotation, mAnnotation, ownerToWoner, ruleResult };
			}
		}
		return null;
	...
	public static final Object[] pattern_AnnotationMemberKey_29_5_checknacs_blackBBBBBB(BodyDeclaration mOwner,
			TAnnotatable tOwner, TAnnotation tAnnotation, AnnotationToTAnnotation annotationToTAnnotation,
			Annotation mAnnotation, ASTNodeToTAnnotatable ownerToWoner) {
		return new Object[] { mOwner, tOwner, tAnnotation, annotationToTAnnotation, mAnnotation, ownerToWoner };
	}
