...
public class ClassImplementsInterfaceImpl extends AbstractRuleImpl implements ClassImplementsInterface {
	...
	public boolean isAppropriate_FWD(Match match, TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration,
		...
		if (result1_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					...
					+ eClassDeclaration + ", " + "[eSuperInterface] = " + eSuperInterface + ".");
		}
		...
		if (ClassImplementsInterfaceImpl.pattern_ClassImplementsInterface_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			ClassImplementsInterfaceImpl.pattern_ClassImplementsInterface_0_6_registerobjectstomatch_expressionBBBBB(
					this, match, eTypeAccess, eClassDeclaration, eSuperInterface);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result1_bindingAndBlack[3];
		...
		Object[] result3_black = ClassImplementsInterfaceImpl
				.pattern_ClassImplementsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, eTypeAccess,
						tSuperInterface, tClass, eClassDeclarationToTClass, eClassDeclaration,
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tClass] = " + tClass + ", " + "[eClassDeclarationToTClass] = " + eClassDeclarationToTClass
		...
		ClassImplementsInterfaceImpl.pattern_ClassImplementsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, eTypeAccess, tSuperInterface, tClass, eClassDeclaration, eSuperInterface);
		...
		ClassImplementsInterfaceImpl.pattern_ClassImplementsInterface_1_5_registerobjects_expressionBBBBBBBBB(this,
				ruleresult, eTypeAccess, tSuperInterface, tClass, eClassDeclarationToTClass, eClassDeclaration,
				eSuperInterfaceToTSuperInterface, eSuperInterface);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ClassImplementsInterfaceImpl
				.pattern_ClassImplementsInterface_2_2_corematch_blackBFFFBFBB(eTypeAccess, eClassDeclaration,
						eSuperInterface, match)) {
			TInterface tSuperInterface = (TInterface) result2_black[1];
			TClass tClass = (TClass) result2_black[2];
			ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result2_black[3];
			...
			for (Object[] result3_black : ClassImplementsInterfaceImpl
					.pattern_ClassImplementsInterface_2_3_findcontext_blackBBBBBBB(eTypeAccess, tSuperInterface, tClass,
							eClassDeclarationToTClass, eClassDeclaration, eSuperInterfaceToTSuperInterface,
							eSuperInterface)) {
				...
				Object[] result4_bindingAndBlack = ClassImplementsInterfaceImpl
						.pattern_ClassImplementsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, eTypeAccess, tSuperInterface, tClass, eClassDeclarationToTClass,
								eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeAccess eTypeAccess,
			TInterface tSuperInterface, TClass tClass, ClassDeclarationToTClass eClassDeclarationToTClass,
			ClassDeclaration eClassDeclaration, TypeToTAbstractType eSuperInterfaceToTSuperInterface,
			Type eSuperInterface) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eTypeAccess, EObject tSuperInterface,
			EObject tClass, EObject eClassDeclarationToTClass, EObject eClassDeclaration,
			EObject eSuperInterfaceToTSuperInterface, EObject eSuperInterface) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = ClassImplementsInterfaceImpl
				.pattern_ClassImplementsInterface_11_1_performtransformation_greenFBB(eClassDeclaration,
						eSuperInterface);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : ClassImplementsInterfaceImpl
				.pattern_ClassImplementsInterface_12_2_corematch_blackBBFFFFB(tSuperInterface, tClass, match)) {
			...
			// ForEach 
			for (Object[] result3_black : ClassImplementsInterfaceImpl
					.pattern_ClassImplementsInterface_12_3_findcontext_blackBBBBBB(tSuperInterface, tClass,
							eClassDeclarationToTClass, eClassDeclaration, eSuperInterfaceToTSuperInterface,
							eSuperInterface)) {
				Object[] result3_green = ClassImplementsInterfaceImpl
						.pattern_ClassImplementsInterface_12_3_findcontext_greenBBBBBBFFFFFFF(tSuperInterface, tClass,
								eClassDeclarationToTClass, eClassDeclaration, eSuperInterfaceToTSuperInterface,
								eSuperInterface);
				...
				Object[] result4_bindingAndBlack = ClassImplementsInterfaceImpl
						.pattern_ClassImplementsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tSuperInterface, tClass, eClassDeclarationToTClass,
								eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tSuperInterface] = "
							+ tSuperInterface + ", " + "[tClass] = " + tClass + ", " + "[eClassDeclarationToTClass] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TInterface tSuperInterface, TClass tClass,
			ClassDeclarationToTClass eClassDeclarationToTClass, ClassDeclaration eClassDeclaration,
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, Type eSuperInterface) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_20(EMoflonEdge _edge_implementedBy) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ClassImplementsInterfaceImpl
				.pattern_ClassImplementsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eTypeAccess,
						tSuperInterface, tClass, eClassDeclaration, eSuperInterface, sourceMatch, targetMatch);
		...
		if (ClassImplementsInterfaceImpl.pattern_ClassImplementsInterface_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ClassImplementsInterfaceImpl
					.pattern_ClassImplementsInterface_24_5_matchcorrcontext_blackBBFBFBBB(tSuperInterface, tClass,
							eClassDeclaration, eSuperInterface, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = ClassImplementsInterfaceImpl
						.pattern_ClassImplementsInterface_24_6_createcorrespondence_blackBBBBBB(eTypeAccess,
								tSuperInterface, tClass, eClassDeclaration, eSuperInterface, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eTypeAccess] = "
							+ eTypeAccess + ", " + "[tSuperInterface] = " + tSuperInterface + ", " + "[tClass] = "
							+ tClass + ", " + "[eClassDeclaration] = " + eClassDeclaration + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess eTypeAccess, TInterface tSuperInterface, TClass tClass,
			ClassDeclaration eClassDeclaration, Type eSuperInterface, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, Type eSuperInterface) {// 
		Object[] result1_black = ClassImplementsInterfaceImpl
				.pattern_ClassImplementsInterface_27_1_matchtggpattern_blackBBB(eTypeAccess, eClassDeclaration,
						eSuperInterface);
		if (result1_black != null) {
		...
		for (Object[] result2_black : ClassImplementsInterfaceImpl
			...
			Object[] result3_bindingAndBlack = ClassImplementsInterfaceImpl
					.pattern_ClassImplementsInterface_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							tSuperInterface, tClass, eClassDeclarationToTClass, eClassDeclaration,
							eSuperInterfaceToTSuperInterface, eSuperInterface, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (ClassImplementsInterfaceImpl.pattern_ClassImplementsInterface_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = ClassImplementsInterfaceImpl
						.pattern_ClassImplementsInterface_29_5_checknacs_blackBBBBBB(tSuperInterface, tClass,
								eClassDeclarationToTClass, eClassDeclaration, eSuperInterfaceToTSuperInterface,
								eSuperInterface);
				if (result5_black != null) {

					Object[] result6_black = ClassImplementsInterfaceImpl
							.pattern_ClassImplementsInterface_29_6_perform_blackBBBBBBB(tSuperInterface, tClass,
									eClassDeclarationToTClass, eClassDeclaration, eSuperInterfaceToTSuperInterface,
					...
					if (result6_black == null) {
						throw new RuntimeException(
								"Pattern matching failed." + " Variables: " + "[tSuperInterface] = " + tSuperInterface
										...
										+ eSuperInterfaceToTSuperInterface + ", " + "[eSuperInterface] = "
										+ eSuperInterface + ", " + "[ruleResult] = " + ruleResult + ".");
					}
					ClassImplementsInterfaceImpl.pattern_ClassImplementsInterface_29_6_perform_greenFBBBBB(
							tSuperInterface, tClass, eClassDeclaration, eSuperInterface, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TInterface tSuperInterface,
			TClass tClass, ClassDeclarationToTClass eClassDeclarationToTClass, ClassDeclaration eClassDeclaration,
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, Type eSuperInterface,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___IS_APPROPRIATE_FWD__MATCH_TYPEACCESS_CLASSDECLARATION_TYPE:
		...
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_TYPEACCESS_CLASSDECLARATION_TYPE:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (TypeAccess) arguments.get(1),
					(ClassDeclaration) arguments.get(2), (Type) arguments.get(3));
			return null;
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_TYPEACCESS_CLASSDECLARATION_TYPE:
		...
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPEACCESS_TINTERFACE_TCLASS_CLASSDECLARATIONTOTCLASS_CLASSDECLARATION_TYPETOTABSTRACTTYPE_TYPE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TypeAccess) arguments.get(1),
					(TInterface) arguments.get(2), (TClass) arguments.get(3),
		...
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_TCLASS_CLASSDECLARATIONTOTCLASS_CLASSDECLARATION_TYPETOTABSTRACTTYPE_TYPE:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (TInterface) arguments.get(1),
					(TClass) arguments.get(2), (ClassDeclarationToTClass) arguments.get(3),
					(ClassDeclaration) arguments.get(4), (TypeToTAbstractType) arguments.get(5),
					(Type) arguments.get(6));
		...
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_20__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_20((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_20__EMOFLONEDGE:
		...
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_TINTERFACE_TCLASS_CLASSDECLARATION_TYPE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeAccess) arguments.get(0), (TInterface) arguments.get(1),
					(TClass) arguments.get(2), (ClassDeclaration) arguments.get(3), (Type) arguments.get(4),
		...
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___CHECK_DEC_FWD__TYPEACCESS_CLASSDECLARATION_TYPE:
		...
		case RulesPackage.CLASS_IMPLEMENTS_INTERFACE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TINTERFACE_TCLASS_CLASSDECLARATIONTOTCLASS_CLASSDECLARATION_TYPETOTABSTRACTTYPE_TYPE_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ClassImplementsInterface_0_1_initialbindings_blackBBBBB(
			ClassImplementsInterface _this, Match match, TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration,
			Type eSuperInterface) {
		if (!eClassDeclaration.equals(eSuperInterface)) {
			return new Object[] { _this, match, eTypeAccess, eClassDeclaration, eSuperInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassImplementsInterface_0_2_SolveCSP_bindingFBBBBB(
			ClassImplementsInterface _this, Match match, TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration,
			Type eSuperInterface) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, eTypeAccess, eClassDeclaration, eSuperInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, eTypeAccess, eClassDeclaration, eSuperInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassImplementsInterface_0_2_SolveCSP_bindingAndBlackFBBBBB(
		...
		Object[] result_pattern_ClassImplementsInterface_0_2_SolveCSP_binding = pattern_ClassImplementsInterface_0_2_SolveCSP_bindingFBBBBB(
				_this, match, eTypeAccess, eClassDeclaration, eSuperInterface);
	...
	public static final Object[] pattern_ClassImplementsInterface_0_4_collectelementstobetranslated_blackBBBB(
			Match match, TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, Type eSuperInterface) {
		if (!eClassDeclaration.equals(eSuperInterface)) {
			return new Object[] { match, eTypeAccess, eClassDeclaration, eSuperInterface };
		}
		return null;
	}
	...
	public static final void pattern_ClassImplementsInterface_0_6_registerobjectstomatch_expressionBBBBB(
			ClassImplementsInterface _this, Match match, TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration,
			Type eSuperInterface) {
		_this.registerObjectsToMatch_FWD(match, eTypeAccess, eClassDeclaration, eSuperInterface);
						...
						if (tmpEClassDeclaration instanceof ClassDeclaration) {
							...
							if (tmpESuperInterfaceToTSuperInterface instanceof TypeToTAbstractType) {
								...
								if (tmpESuperInterface instanceof Type) {
									...
									return new Object[] { eTypeAccess, tSuperInterface, tClass,
											eClassDeclarationToTClass, eClassDeclaration,
											eSuperInterfaceToTSuperInterface, eSuperInterface, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_ClassImplementsInterface_1_1_performtransformation_blackBBBBBBBFBB(
			TypeAccess eTypeAccess, TInterface tSuperInterface, TClass tClass,
			ClassDeclarationToTClass eClassDeclarationToTClass, ClassDeclaration eClassDeclaration,
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, Type eSuperInterface, ClassImplementsInterface _this,
			IsApplicableMatch isApplicableMatch) {
		if (!eClassDeclaration.equals(eSuperInterface)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { eTypeAccess, tSuperInterface, tClass, eClassDeclarationToTClass,
							eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface, csp, _this,
							isApplicableMatch };
				}
			}
		}
	...
	public static final Object[] pattern_ClassImplementsInterface_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_ClassImplementsInterface_1_1_performtransformation_binding != null) {
			...
			ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result_pattern_ClassImplementsInterface_1_1_performtransformation_binding[3];
			...
			TypeToTAbstractType eSuperInterfaceToTSuperInterface = (TypeToTAbstractType) result_pattern_ClassImplementsInterface_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_ClassImplementsInterface_1_1_performtransformation_black = pattern_ClassImplementsInterface_1_1_performtransformation_blackBBBBBBBFBB(
					eTypeAccess, tSuperInterface, tClass, eClassDeclarationToTClass, eClassDeclaration,
					eSuperInterfaceToTSuperInterface, eSuperInterface, _this, isApplicableMatch);
	...
	public static final Object[] pattern_ClassImplementsInterface_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eTypeAccess, EObject tSuperInterface, EObject tClass,
			EObject eClassDeclarationToTClass, EObject eClassDeclaration, EObject eSuperInterfaceToTSuperInterface,
	...
	public static final Object[] pattern_ClassImplementsInterface_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject eTypeAccess, EObject tSuperInterface, EObject tClass,
			EObject eClassDeclaration, EObject eSuperInterface) {
		EMoflonEdge eTypeAccess__eSuperInterface____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eSuperInterface__eTypeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		eClassDeclaration__eTypeAccess____superInterfaces
				.setName(eClassDeclaration__eTypeAccess____superInterfaces_name_prime);
		return new Object[] { ruleresult, eTypeAccess, tSuperInterface, tClass, eClassDeclaration, eSuperInterface,
				eTypeAccess__eSuperInterface____type, eSuperInterface__eTypeAccess____usagesInTypeAccess,
	...
	public static final void pattern_ClassImplementsInterface_1_5_registerobjects_expressionBBBBBBBBB(
			ClassImplementsInterface _this, PerformRuleResult ruleresult, EObject eTypeAccess, EObject tSuperInterface,
			EObject tClass, EObject eClassDeclarationToTClass, EObject eClassDeclaration,
			EObject eSuperInterfaceToTSuperInterface, EObject eSuperInterface) {
		_this.registerObjects_FWD(ruleresult, eTypeAccess, tSuperInterface, tClass, eClassDeclarationToTClass,
				eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
	...
	public static final Object[] pattern_ClassImplementsInterface_2_2_corematch_bindingFFFB(Match match) {
		...
		if (tmpETypeAccess instanceof TypeAccess) {
			...
			if (tmpEClassDeclaration instanceof ClassDeclaration) {
				...
				if (tmpESuperInterface instanceof Type) {
					Type eSuperInterface = (Type) tmpESuperInterface;
					return new Object[] { eTypeAccess, eClassDeclaration, eSuperInterface, match };
				}
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_ClassImplementsInterface_2_2_corematch_blackBFFFBFBB(
			TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, Type eSuperInterface, Match match) {
			...
			for (ClassDeclarationToTClass eClassDeclarationToTClass : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tClass != null) {
					for (TypeToTAbstractType eSuperInterfaceToTSuperInterface : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tmpTSuperInterface instanceof TInterface) {
							TInterface tSuperInterface = (TInterface) tmpTSuperInterface;
							_result.add(new Object[] { eTypeAccess, tSuperInterface, tClass, eClassDeclarationToTClass,
									eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface, match });
						}
						...
						if (tClass.equals(eClassDeclarationToTClass.getTarget())) {
							if (tSuperInterface.equals(eSuperInterfaceToTSuperInterface.getTarget())) {
								if (eSuperInterface.equals(eSuperInterfaceToTSuperInterface.getSource())) {
									_result.add(new Object[] { eTypeAccess, tSuperInterface, tClass,
											eClassDeclarationToTClass, eClassDeclaration,
											eSuperInterfaceToTSuperInterface, eSuperInterface });
								}
							}
	...
	public static final Object[] pattern_ClassImplementsInterface_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { eTypeAccess, tSuperInterface, tClass, eClassDeclarationToTClass, eClassDeclaration,
				eSuperInterfaceToTSuperInterface, eSuperInterface, isApplicableMatch,
				eTypeAccess__eSuperInterface____type, eSuperInterface__eTypeAccess____usagesInTypeAccess,
				eClassDeclarationToTClass__eClassDeclaration____source,
	...
	public static final Object[] pattern_ClassImplementsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			ClassDeclaration eClassDeclaration, TypeToTAbstractType eSuperInterfaceToTSuperInterface,
			Type eSuperInterface) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eTypeAccess, tSuperInterface, tClass,
				eClassDeclarationToTClass, eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eTypeAccess, tSuperInterface, tClass,
					eClassDeclarationToTClass, eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassImplementsInterface_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ClassImplementsInterface_2_4_solveCSP_binding = pattern_ClassImplementsInterface_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eTypeAccess, tSuperInterface, tClass, eClassDeclarationToTClass,
				eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
				...
				if (tmpEClassDeclarationToTClass instanceof ClassDeclarationToTClass) {
					...
					if (tmpEClassDeclaration instanceof ClassDeclaration) {
						...
						if (tmpESuperInterfaceToTSuperInterface instanceof TypeToTAbstractType) {
							...
							if (tmpESuperInterface instanceof Type) {
								Type eSuperInterface = (Type) tmpESuperInterface;
								return new Object[] { tSuperInterface, tClass, eClassDeclarationToTClass,
										eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface,
										isApplicableMatch };
							}
						}
	...
	public static final Object[] pattern_ClassImplementsInterface_11_1_performtransformation_blackBBBBBBFBB(
		...
		if (!eClassDeclaration.equals(eSuperInterface)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { tSuperInterface, tClass, eClassDeclarationToTClass, eClassDeclaration,
							eSuperInterfaceToTSuperInterface, eSuperInterface, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassImplementsInterface_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_ClassImplementsInterface_11_1_performtransformation_binding != null) {
			...
			TClass tClass = (TClass) result_pattern_ClassImplementsInterface_11_1_performtransformation_binding[1];
			...
			TypeToTAbstractType eSuperInterfaceToTSuperInterface = (TypeToTAbstractType) result_pattern_ClassImplementsInterface_11_1_performtransformation_binding[4];
	...
	public static final void pattern_ClassImplementsInterface_11_5_registerobjects_expressionBBBBBBBBB(
			...
			EObject tClass, EObject eClassDeclarationToTClass, EObject eClassDeclaration,
			EObject eSuperInterfaceToTSuperInterface, EObject eSuperInterface) {
		_this.registerObjects_BWD(ruleresult, eTypeAccess, tSuperInterface, tClass, eClassDeclarationToTClass,
				eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
	...
	public static final Iterable<Object[]> pattern_ClassImplementsInterface_12_2_corematch_blackBBFFFFB(
			...
			if (eClassDeclaration != null) {
				for (TypeToTAbstractType eSuperInterfaceToTSuperInterface : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (eSuperInterface != null) {
						if (!eClassDeclaration.equals(eSuperInterface)) {
							_result.add(new Object[] { tSuperInterface, tClass, eClassDeclarationToTClass,
									eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface, match });
						}
					}
	...
	public static final Object[] pattern_ClassImplementsInterface_12_4_solveCSP_bindingFBBBBBBBB(
			...
			TClass tClass, ClassDeclarationToTClass eClassDeclarationToTClass, ClassDeclaration eClassDeclaration,
			TypeToTAbstractType eSuperInterfaceToTSuperInterface, Type eSuperInterface) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tSuperInterface, tClass,
				eClassDeclarationToTClass, eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSuperInterface, tClass, eClassDeclarationToTClass,
					eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassImplementsInterface_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ClassImplementsInterface_12_4_solveCSP_binding = pattern_ClassImplementsInterface_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tSuperInterface, tClass, eClassDeclarationToTClass, eClassDeclaration,
				eSuperInterfaceToTSuperInterface, eSuperInterface);
	...
	public static final Object[] pattern_ClassImplementsInterface_21_2_testcorematchandDECs_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_468538 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassImplementsInterface_21_2_testcorematchandDECs_black_nac_1BB(
		...
		for (ArrayType __DEC_eTypeAccess_elementType_899203 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			if (!eSuperInterface.equals(__DEC_eTypeAccess_elementType_899203)) {
	...
	public static final Object[] pattern_ClassImplementsInterface_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_957854 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassImplementsInterface_21_2_testcorematchandDECs_black_nac_3BBB(
			TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, Type eSuperInterface) {
		if (!eClassDeclaration.equals(eSuperInterface)) {
			for (ClassDeclaration __DEC_eTypeAccess_superClass_517757 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
				if (!eClassDeclaration.equals(__DEC_eTypeAccess_superClass_517757)) {
					if (!eSuperInterface.equals(__DEC_eTypeAccess_superClass_517757)) {
						return new Object[] { eTypeAccess, eClassDeclaration, eSuperInterface };
					}
				}
			}
	...
	public static final Object[] pattern_ClassImplementsInterface_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_911326 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassImplementsInterface_21_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess eTypeAccess, Type eSuperInterface) {
		for (ParameterizedType __DEC_eTypeAccess_type_303199 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			if (!eSuperInterface.equals(__DEC_eTypeAccess_type_303199)) {
				return new Object[] { eTypeAccess, eSuperInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassImplementsInterface_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_433030 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassImplementsInterface_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_341642 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final boolean pattern_ClassImplementsInterface_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBB(
			ClassImplementsInterface _this, Match match, TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration,
			Type eSuperInterface) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, eTypeAccess, eClassDeclaration, eSuperInterface);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
			...
			if (tmpTSuperInterface instanceof TInterface) {
				...
				if (tmpTClass instanceof TClass) {
					...
					if (tmpEClassDeclaration instanceof ClassDeclaration) {
						...
						if (tmpESuperInterface instanceof Type) {
							Type eSuperInterface = (Type) tmpESuperInterface;
							return new Object[] { eTypeAccess, tSuperInterface, tClass, eClassDeclaration,
	...
	public static final Object[] pattern_ClassImplementsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
			TypeAccess eTypeAccess, TInterface tSuperInterface, TClass tClass, ClassDeclaration eClassDeclaration,
			Type eSuperInterface, Match sourceMatch, Match targetMatch) {
		if (!eClassDeclaration.equals(eSuperInterface)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { eTypeAccess, tSuperInterface, tClass, eClassDeclaration, eSuperInterface,
	...
	public static final Object[] pattern_ClassImplementsInterface_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_ClassImplementsInterface_24_2_matchsrctrgcontext_binding != null) {
			...
			TInterface tSuperInterface = (TInterface) result_pattern_ClassImplementsInterface_24_2_matchsrctrgcontext_binding[1];
			TClass tClass = (TClass) result_pattern_ClassImplementsInterface_24_2_matchsrctrgcontext_binding[2];
			ClassDeclaration eClassDeclaration = (ClassDeclaration) result_pattern_ClassImplementsInterface_24_2_matchsrctrgcontext_binding[3];
			...
			Object[] result_pattern_ClassImplementsInterface_24_2_matchsrctrgcontext_black = pattern_ClassImplementsInterface_24_2_matchsrctrgcontext_blackBBBBBBB(
					eTypeAccess, tSuperInterface, tClass, eClassDeclaration, eSuperInterface, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ClassImplementsInterface_24_3_solvecsp_bindingFBBBBBBBB(
			ClassImplementsInterface _this, TypeAccess eTypeAccess, TInterface tSuperInterface, TClass tClass,
			ClassDeclaration eClassDeclaration, Type eSuperInterface, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eTypeAccess, tSuperInterface, tClass, eClassDeclaration,
				eSuperInterface, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eTypeAccess, tSuperInterface, tClass, eClassDeclaration, eSuperInterface,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassImplementsInterface_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ClassImplementsInterface_24_3_solvecsp_binding = pattern_ClassImplementsInterface_24_3_solvecsp_bindingFBBBBBBBB(
				_this, eTypeAccess, tSuperInterface, tClass, eClassDeclaration, eSuperInterface, sourceMatch,
				targetMatch);
		if (result_pattern_ClassImplementsInterface_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_ClassImplementsInterface_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, eTypeAccess, tSuperInterface, tClass, eClassDeclaration,
						eSuperInterface, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_ClassImplementsInterface_24_5_matchcorrcontext_blackBBFBFBBB(
			TInterface tSuperInterface, TClass tClass, ClassDeclaration eClassDeclaration, Type eSuperInterface,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!eClassDeclaration.equals(eSuperInterface)) {
			if (!sourceMatch.equals(targetMatch)) {
	...
	public static final Object[] pattern_ClassImplementsInterface_24_5_matchcorrcontext_greenBBBBF(
			ClassDeclarationToTClass eClassDeclarationToTClass, TypeToTAbstractType eSuperInterfaceToTSuperInterface,
			Match sourceMatch, Match targetMatch) {
	...
	public static final Object[] pattern_ClassImplementsInterface_24_6_createcorrespondence_blackBBBBBB(
		...
		if (!eClassDeclaration.equals(eSuperInterface)) {
			return new Object[] { eTypeAccess, tSuperInterface, tClass, eClassDeclaration, eSuperInterface, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassImplementsInterface_27_1_matchtggpattern_black_nac_0B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_824842 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassImplementsInterface_27_1_matchtggpattern_black_nac_1BB(
			TypeAccess eTypeAccess, Type eSuperInterface) {
		for (ArrayType __DEC_eTypeAccess_elementType_219715 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			if (!eSuperInterface.equals(__DEC_eTypeAccess_elementType_219715)) {
				return new Object[] { eTypeAccess, eSuperInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassImplementsInterface_27_1_matchtggpattern_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_950627 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassImplementsInterface_27_1_matchtggpattern_black_nac_3BBB(
			TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, Type eSuperInterface) {
		if (!eClassDeclaration.equals(eSuperInterface)) {
			for (ClassDeclaration __DEC_eTypeAccess_superClass_166327 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
				if (!eClassDeclaration.equals(__DEC_eTypeAccess_superClass_166327)) {
					if (!eSuperInterface.equals(__DEC_eTypeAccess_superClass_166327)) {
						return new Object[] { eTypeAccess, eClassDeclaration, eSuperInterface };
					}
				}
			}
	...
	public static final Object[] pattern_ClassImplementsInterface_27_1_matchtggpattern_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_418773 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassImplementsInterface_27_1_matchtggpattern_black_nac_5BB(
			TypeAccess eTypeAccess, Type eSuperInterface) {
		for (ParameterizedType __DEC_eTypeAccess_type_845753 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			if (!eSuperInterface.equals(__DEC_eTypeAccess_type_845753)) {
				return new Object[] { eTypeAccess, eSuperInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_ClassImplementsInterface_27_1_matchtggpattern_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_853522 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassImplementsInterface_27_1_matchtggpattern_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_395500 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassImplementsInterface_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tSuperInterface, tClass,
				eClassDeclarationToTClass, eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface,
				ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tSuperInterface, tClass, eClassDeclarationToTClass,
					eClassDeclaration, eSuperInterfaceToTSuperInterface, eSuperInterface, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassImplementsInterface_29_6_perform_greenFBBBBB(TInterface tSuperInterface,
			TClass tClass, ClassDeclaration eClassDeclaration, Type eSuperInterface,
			ModelgeneratorRuleResult ruleResult) {
		TypeAccess eTypeAccess = JavaFactory.eINSTANCE.createTypeAccess();
		tSuperInterface.getImplementedBy().add(tClass);
		boolean ruleResult_success_prime = Boolean.valueOf(true);
		...
		return new Object[] { eTypeAccess, tSuperInterface, tClass, eClassDeclaration, eSuperInterface, ruleResult };
	}
