...
public class InterfaceMemberImpl extends AbstractRuleImpl implements InterfaceMember {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
				ruleresult, mModifierToTModifier, tMember, defToMember, tInterface, mDefinition, mTypeToTType,
				tModifier, mInterface, mModifier);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				mModifierToTModifier, tMember, mDefinition, tModifier, mModifier);
		...
		InterfaceMemberImpl.pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
				mModifierToTModifier, tMember, defToMember, tInterface, mDefinition, mTypeToTType, tModifier,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl
				.pattern_InterfaceMember_2_2_corematch_blackFFFBFBBB(mDefinition, mInterface, mModifier, match)) {
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_2_3_findcontext_blackBBBBBBB(
					tMember, defToMember, tInterface, mDefinition, mTypeToTType, mInterface, mModifier)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(tMember, defToMember,
								tInterface, mDefinition, mTypeToTType, mInterface, mModifier);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMember tMember,
			MDefinitionToTMember defToMember, TInterface tInterface, MDefinition mDefinition,
			TypeToTAbstractType mTypeToTType, InterfaceDeclaration mInterface, Modifier mModifier) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifierToTModifier, EObject tMember,
			EObject defToMember, EObject tInterface, EObject mDefinition, EObject mTypeToTType, EObject tModifier,
			EObject mInterface, EObject mModifier) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : InterfaceMemberImpl.pattern_InterfaceMember_12_2_corematch_blackBFBFFBFB(tMember,
			...
			for (Object[] result3_black : InterfaceMemberImpl.pattern_InterfaceMember_12_3_findcontext_blackBBBBBBB(
					tMember, defToMember, tInterface, mDefinition, mTypeToTType, tModifier, mInterface)) {
				Object[] result3_green = InterfaceMemberImpl
						.pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(tMember, defToMember,
								tInterface, mDefinition, mTypeToTType, tModifier, mInterface);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMember tMember,
			MDefinitionToTMember defToMember, TInterface tInterface, MDefinition mDefinition,
			TypeToTAbstractType mTypeToTType, TModifier tModifier, InterfaceDeclaration mInterface) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_84(EMoflonEdge _edge_modifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = InterfaceMemberImpl
				.pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tMember, tInterface, mDefinition,
						tModifier, mInterface, mModifier, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tMember] = " + tMember + ", " + "[tInterface] = " + tInterface + ", " + "[mDefinition] = "
					+ mDefinition + ", " + "[tModifier] = " + tModifier + ", " + "[mInterface] = " + mInterface + ", "
			...
			for (Object[] result5_black : InterfaceMemberImpl
				...
				Object[] result6_black = InterfaceMemberImpl
						.pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(tMember, tInterface,
								mDefinition, tModifier, mInterface, mModifier, ccMatch);
				if (result6_black == null) {
	...
	public CSP isApplicable_solveCsp_CC(TMember tMember, TInterface tInterface, MDefinition mDefinition,
			TModifier tModifier, InterfaceDeclaration mInterface, Modifier mModifier, Match sourceMatch,
		...
		for (Object[] result2_black : InterfaceMemberImpl
			...
			Object[] result3_bindingAndBlack = InterfaceMemberImpl
					.pattern_InterfaceMember_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, tMember,
							defToMember, tInterface, mDefinition, mTypeToTType, mInterface, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tMember] = " + tMember + ", "
						+ "[defToMember] = " + defToMember + ", " + "[tInterface] = " + tInterface + ", "
			...
			if (InterfaceMemberImpl.pattern_InterfaceMember_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = InterfaceMemberImpl.pattern_InterfaceMember_29_5_checknacs_blackBBBBBB(tMember,
						defToMember, tInterface, mDefinition, mTypeToTType, mInterface);
				if (result5_black != null) {

					Object[] result6_black = InterfaceMemberImpl.pattern_InterfaceMember_29_6_perform_blackBBBBBBB(
							tMember, defToMember, tInterface, mDefinition, mTypeToTType, mInterface, ruleResult);
					if (result6_black == null) {
					...
					InterfaceMemberImpl.pattern_InterfaceMember_29_6_perform_greenFBBFFBB(tMember, mDefinition,
							ruleResult, csp);
					//nothing MModifierToTModifier mModifierToTModifier = (MModifierToTModifier) result6_green[0];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMEMBER_MDEFINITIONTOTMEMBER_TINTERFACE_MDEFINITION_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_MODIFIER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TMember) arguments.get(1),
					(MDefinitionToTMember) arguments.get(2), (TInterface) arguments.get(3),
					(MDefinition) arguments.get(4), (TypeToTAbstractType) arguments.get(5),
					(InterfaceDeclaration) arguments.get(6), (Modifier) arguments.get(7));
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_MDEFINITIONTOTMEMBER_TINTERFACE_MDEFINITION_TYPETOTABSTRACTTYPE_TMODIFIER_INTERFACEDECLARATION:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_BWD_EMOFLON_EDGE_80__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_80((EMoflonEdge) arguments.get(0));
		case RulesPackage.INTERFACE_MEMBER___IS_APPROPRIATE_FWD_EMOFLON_EDGE_84__EMOFLONEDGE:
		...
		case RulesPackage.INTERFACE_MEMBER___IS_APPLICABLE_SOLVE_CSP_CC__TMEMBER_TINTERFACE_MDEFINITION_TMODIFIER_INTERFACEDECLARATION_MODIFIER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TMember) arguments.get(0), (TInterface) arguments.get(1),
					(MDefinition) arguments.get(2), (TModifier) arguments.get(3),
					(InterfaceDeclaration) arguments.get(4), (Modifier) arguments.get(5), (Match) arguments.get(6),
		...
		case RulesPackage.INTERFACE_MEMBER___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_MDEFINITIONTOTMEMBER_TINTERFACE_MDEFINITION_TYPETOTABSTRACTTYPE_INTERFACEDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpMTypeToTType instanceof TypeToTAbstractType) {
							...
							if (tmpMInterface instanceof InterfaceDeclaration) {
								...
								if (tmpMModifier instanceof Modifier) {
									...
									return new Object[] { tMember, defToMember, tInterface, mDefinition, mTypeToTType,
											mInterface, mModifier, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(TMember tMember,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMember, defToMember, tInterface, mDefinition, mTypeToTType, mInterface,
	...
	public static final Object[] pattern_InterfaceMember_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_1_1_performtransformation_black = pattern_InterfaceMember_1_1_performtransformation_blackBBBBBBBFBB(
					tMember, defToMember, tInterface, mDefinition, mTypeToTType, mInterface, mModifier, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifierToTModifier, EObject tMember, EObject defToMember,
			EObject tInterface, EObject mDefinition, EObject mTypeToTType, EObject tModifier, EObject mInterface,
			EObject mModifier) {
	...
	public static final Object[] pattern_InterfaceMember_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
		...
		return new Object[] { ruleresult, mModifierToTModifier, tMember, mDefinition, tModifier, mModifier,
	...
	public static final void pattern_InterfaceMember_1_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject tInterface, EObject mDefinition, EObject mTypeToTType, EObject tModifier, EObject mInterface,
			EObject mModifier) {
		_this.registerObjects_FWD(ruleresult, mModifierToTModifier, tMember, defToMember, tInterface, mDefinition,
				mTypeToTType, tModifier, mInterface, mModifier);
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTInterface instanceof TInterface) {
						TInterface tInterface = (TInterface) tmpTInterface;
						_result.add(new Object[] { tMember, defToMember, tInterface, mDefinition, mTypeToTType,
								mInterface, mModifier, match });
					}
						...
						if (tInterface.equals(mTypeToTType.getTarget())) {
							if (mInterface.getBodyDeclarations().contains(mDefinition)) {
								if (mInterface.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { tMember, defToMember, tInterface, mDefinition,
											mTypeToTType, mInterface, mModifier });
								}
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(TMember tMember,
		...
		return new Object[] { tMember, defToMember, tInterface, mDefinition, mTypeToTType, mInterface, mModifier,
				isApplicableMatch, defToMember__tMember____target, tInterface__tMember____defines,
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TMember tMember, MDefinitionToTMember defToMember,
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tMember, defToMember, tInterface,
				mDefinition, mTypeToTType, mInterface, mModifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, defToMember, tInterface, mDefinition,
					mTypeToTType, mInterface, mModifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_2_4_solveCSP_binding = pattern_InterfaceMember_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, defToMember, tInterface, mDefinition, mTypeToTType, mInterface,
				mModifier);
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(TMember tMember,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMember, defToMember, tInterface, mDefinition, mTypeToTType, tModifier,
	...
	public static final Object[] pattern_InterfaceMember_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_11_1_performtransformation_black = pattern_InterfaceMember_11_1_performtransformation_blackBBBBBBBFBB(
					tMember, defToMember, tInterface, mDefinition, mTypeToTType, tModifier, mInterface, _this,
					isApplicableMatch);
	...
	public static final void pattern_InterfaceMember_11_5_registerobjects_expressionBBBBBBBBBBB(InterfaceMember _this,
			...
			EObject tInterface, EObject mDefinition, EObject mTypeToTType, EObject tModifier, EObject mInterface,
			EObject mModifier) {
		_this.registerObjects_BWD(ruleresult, mModifierToTModifier, tMember, defToMember, tInterface, mDefinition,
				mTypeToTType, tModifier, mInterface, mModifier);
					...
					if (mDefinition.equals(defToMember.getSource())) {
						if (tInterface.equals(mTypeToTType.getTarget())) {
							if (mInterface.getBodyDeclarations().contains(mDefinition)) {
								if (mInterface.equals(mTypeToTType.getSource())) {
									_result.add(new Object[] { tMember, defToMember, tInterface, mDefinition,
											mTypeToTType, tModifier, mInterface });
								}
							}
						}
					}
	...
	public static final Object[] pattern_InterfaceMember_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(TMember tMember,
		...
		mDefinition__mInterface____abstractTypeDeclaration
				.setName(mDefinition__mInterface____abstractTypeDeclaration_name_prime);
		mTypeToTType__mInterface____source.setName(mTypeToTType__mInterface____source_name_prime);
		return new Object[] { tMember, defToMember, tInterface, mDefinition, mTypeToTType, tModifier, mInterface,
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
			IsApplicableMatch isApplicableMatch, TMember tMember, MDefinitionToTMember defToMember,
			TInterface tInterface, MDefinition mDefinition, TypeToTAbstractType mTypeToTType, TModifier tModifier,
			InterfaceDeclaration mInterface) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tMember, defToMember, tInterface,
				mDefinition, mTypeToTType, tModifier, mInterface);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, defToMember, tInterface, mDefinition,
					mTypeToTType, tModifier, mInterface };
	...
	public static final Object[] pattern_InterfaceMember_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_12_4_solveCSP_binding = pattern_InterfaceMember_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, tMember, defToMember, tInterface, mDefinition, mTypeToTType, tModifier,
				mInterface);
	...
	public static final Object[] pattern_InterfaceMember_20_2_testcorematchandDECs_black_nac_0BB(TModifier tModifier,
		...
		for (TAbstractType __DEC_tModifier_tModifier_528080 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_528080)) {
				...
				if (tmpMDefinition instanceof MDefinition) {
					...
					if (tmpTModifier instanceof TModifier) {
						...
						if (tmpMInterface instanceof InterfaceDeclaration) {
							...
							if (tmpMModifier instanceof Modifier) {
								Modifier mModifier = (Modifier) tmpMModifier;
								return new Object[] { tMember, tInterface, mDefinition, tModifier, mInterface,
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(TMember tMember,
			TInterface tInterface, MDefinition mDefinition, TModifier tModifier, InterfaceDeclaration mInterface,
			Modifier mModifier, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMember, tInterface, mDefinition, tModifier, mInterface, mModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_InterfaceMember_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_InterfaceMember_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_InterfaceMember_24_2_matchsrctrgcontext_black = pattern_InterfaceMember_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tMember, tInterface, mDefinition, tModifier, mInterface, mModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(InterfaceMember _this,
			TMember tMember, TInterface tInterface, MDefinition mDefinition, TModifier tModifier,
			InterfaceDeclaration mInterface, Modifier mModifier, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tMember, tInterface, mDefinition, tModifier, mInterface,
				mModifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tMember, tInterface, mDefinition, tModifier, mInterface, mModifier,
	...
	public static final Object[] pattern_InterfaceMember_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(InterfaceMember _this,
		...
		Object[] result_pattern_InterfaceMember_24_3_solvecsp_binding = pattern_InterfaceMember_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tMember, tInterface, mDefinition, tModifier, mInterface, mModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_InterfaceMember_24_6_createcorrespondence_blackBBBBBBB(TMember tMember,
		...
		return new Object[] { tMember, tInterface, mDefinition, tModifier, mInterface, mModifier, ccMatch };
	}
	...
	public static final Object[] pattern_InterfaceMember_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TInterface tInterface) {
		for (TAbstractType __DEC_tModifier_tModifier_578835 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tInterface.equals(__DEC_tModifier_tModifier_578835)) {
				return new Object[] { tModifier, tInterface };
			}
		}
		return null;
	...
	public static final Object[] pattern_InterfaceMember_29_3_solveCSP_bindingFBBBBBBBBB(InterfaceMember _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tMember, defToMember, tInterface,
				mDefinition, mTypeToTType, mInterface, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMember, defToMember, tInterface, mDefinition,
	...
	public static final Object[] pattern_InterfaceMember_29_6_perform_blackBBBBBBB(TMember tMember,
		...
		return new Object[] { tMember, defToMember, tInterface, mDefinition, mTypeToTType, mInterface, ruleResult };
	}

	public static final Object[] pattern_InterfaceMember_29_6_perform_greenFBBFFBB(TMember tMember,
		...
		return new Object[] { mModifierToTModifier, tMember, mDefinition, tModifier, mModifier, ruleResult, csp };
	}
