 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.ClassDeclarationToTClassImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.ClassDeclarationToTClassImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassDeclarationToTClassImpl extends AbstractCorrespondenceImpl implements ClassDeclarationToTClass {
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.CLASS_DECLARATION_TO_TCLASS;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.CLASS_DECLARATION_TO_TCLASS__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(ClassDeclaration newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.CLASS_DECLARATION_TO_TCLASS__SOURCE,
					oldSource, source));
	}
	...
	public TClass getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.CLASS_DECLARATION_TO_TCLASS__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TClass newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.CLASS_DECLARATION_TO_TCLASS__TARGET,
					oldTarget, target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PmPackage.CLASS_DECLARATION_TO_TCLASS__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case PmPackage.CLASS_DECLARATION_TO_TCLASS__TARGET:
			if (resolve)
				return getTarget();
