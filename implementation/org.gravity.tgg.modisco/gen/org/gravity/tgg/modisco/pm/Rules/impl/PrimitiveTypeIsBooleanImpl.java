...
public class PrimitiveTypeIsBooleanImpl extends AbstractRuleImpl implements PrimitiveTypeIsBoolean {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPROPRIATE_BWD_EMOFLON_EDGE_36__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_36((EMoflonEdge) arguments.get(0));
		case RulesPackage.PRIMITIVE_TYPE_IS_BOOLEAN___IS_APPROPRIATE_FWD_EMOFLON_EDGE_37__EMOFLONEDGE:
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_0B(
		...
		for (TPackage __DEC_tPrimitiveClass_classes_641238 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_1BB(
		...
		for (TypeGraph __DEC_tPrimitiveClass_classes_408172 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_408172)) {
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_2B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_ownedTypes_627968 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_ownedTypes_627968 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_20_2_testcorematchandDECs_black_nac_3B(
			TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_586557 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_586557 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_586557)) {
				return new Object[] { tPrimitiveClass };
			}
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_0B(
			TClass tPrimitiveClass) {
		for (TPackage __DEC_tPrimitiveClass_classes_221495 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TPackage.class, "classes")) {
			return new Object[] { tPrimitiveClass };
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_1BB(
			TClass tPrimitiveClass, TypeGraph typeGraph) {
		for (TypeGraph __DEC_tPrimitiveClass_classes_345957 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tPrimitiveClass, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tPrimitiveClass_classes_345957)) {
				return new Object[] { tPrimitiveClass, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_2B(
			TClass tPrimitiveClass) {
		TPackage __DEC_tPrimitiveClass_ownedTypes_739097 = tPrimitiveClass.getPackage();
		if (__DEC_tPrimitiveClass_ownedTypes_739097 != null) {
			return new Object[] { tPrimitiveClass };
		}
	...
	public static final Object[] pattern_PrimitiveTypeIsBoolean_28_1_matchtggpattern_black_nac_3B(
			TClass tPrimitiveClass) {
		TAbstractType __DEC_tPrimitiveClass_innerTypes_876405 = tPrimitiveClass.getOuterType();
		if (__DEC_tPrimitiveClass_innerTypes_876405 != null) {
			if (!tPrimitiveClass.equals(__DEC_tPrimitiveClass_innerTypes_876405)) {
				return new Object[] { tPrimitiveClass };
			}
		}
