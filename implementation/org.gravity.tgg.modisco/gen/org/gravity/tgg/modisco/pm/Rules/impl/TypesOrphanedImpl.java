...
public class TypesOrphanedImpl extends AbstractRuleImpl implements TypesOrphaned {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = TypesOrphanedImpl.pattern_TypesOrphaned_1_1_performtransformation_greenFFBFBB(mType,
				pg, csp);
		...
		Object[] result2_black = TypesOrphanedImpl.pattern_TypesOrphaned_1_2_collecttranslatedelements_blackBBBB(
				mBodyToTAnnotation, mTypeToTType, mType, tType);
		...
		Object[] result3_black = TypesOrphanedImpl.pattern_TypesOrphaned_1_3_bookkeepingforedges_blackBBBBBBBB(
				ruleresult, mBodyToTAnnotation, mTypeToTType, mType, mModelToTypeGraph, tType, mModel, pg);
		...
		TypesOrphanedImpl.pattern_TypesOrphaned_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(ruleresult,
				mBodyToTAnnotation, mTypeToTType, mType, tType, mModel, pg);
		...
		//nothing EMoflonEdge mBodyToTAnnotation__tType____target = (EMoflonEdge) result3_green[11];
		...
		TypesOrphanedImpl.pattern_TypesOrphaned_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult,
				mBodyToTAnnotation, mTypeToTType, mType, mModelToTypeGraph, tType, mModel, pg);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : TypesOrphanedImpl.pattern_TypesOrphaned_2_2_corematch_blackBFBFB(mType, mModel,
				match)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MClass mType,
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mTypeToTType,
			EObject mType, EObject mModelToTypeGraph, EObject tType, EObject mModel, EObject pg) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		TypeGraph pg = (TypeGraph) result1_bindingAndBlack[3];
		CSP csp = (CSP) result1_bindingAndBlack[4];
		Object[] result1_green = TypesOrphanedImpl.pattern_TypesOrphaned_11_1_performtransformation_greenFFFBBB(tType,
				mModel, csp);
		ASTNodeToTAnnotatable mBodyToTAnnotation = (ASTNodeToTAnnotatable) result1_green[0];
		TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result1_green[1];
		...
		TypesOrphanedImpl.pattern_TypesOrphaned_11_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(ruleresult,
				mBodyToTAnnotation, mTypeToTType, mType, tType, mModel, pg);
		//nothing EMoflonEdge mBodyToTAnnotation__mType____source = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mTypeToTType__mType____source = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge mTypeToTType__tType____target = (EMoflonEdge) result3_green[9];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : TypesOrphanedImpl.pattern_TypesOrphaned_12_2_corematch_blackFBFBB(tType, pg,
				match)) {
			...
			for (Object[] result3_black : TypesOrphanedImpl
					.pattern_TypesOrphaned_12_3_findcontext_blackBBBB(mModelToTypeGraph, tType, mModel, pg)) {
				Object[] result3_green = TypesOrphanedImpl
						.pattern_TypesOrphaned_12_3_findcontext_greenBBBBFFFFF(mModelToTypeGraph, tType, mModel, pg);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[4];
				...
				Object[] result4_bindingAndBlack = TypesOrphanedImpl
						.pattern_TypesOrphaned_12_4_solveCSP_bindingAndBlackFBBBBBB(this, isApplicableMatch,
								mModelToTypeGraph, tType, mModel, pg);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mModelToTypeGraph] = "
							+ mModelToTypeGraph + ", " + "[tType] = " + tType + ", " + "[mModel] = " + mModel + ", "
							+ "[pg] = " + pg + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, ModelToTypeGraph mModelToTypeGraph,
			TClass tType, Model mModel, TypeGraph pg) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mTypeToTType,
			EObject mType, EObject mModelToTypeGraph, EObject tType, EObject mModel, EObject pg) {
		ruleresult.registerObject("mBodyToTAnnotation", mBodyToTAnnotation);
		ruleresult.registerObject("mTypeToTType", mTypeToTType);
		ruleresult.registerObject("mType", mType);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MCLASS_MODELTOTYPEGRAPH_MODEL_TYPEGRAPH:
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MODELTOTYPEGRAPH_TCLASS_MODEL_TYPEGRAPH:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (ModelToTypeGraph) arguments.get(1),
					(TClass) arguments.get(2), (Model) arguments.get(3), (TypeGraph) arguments.get(4));
		...
		case RulesPackage.TYPES_ORPHANED___IS_APPROPRIATE_FWD_EMOFLON_EDGE_87__EMOFLONEDGE:
			...
			if (tmpMModelToTypeGraph instanceof ModelToTypeGraph) {
				...
				if (tmpMModel instanceof Model) {
					...
					if (tmpPg instanceof TypeGraph) {
						...
						return new Object[] { mType, mModelToTypeGraph, mModel, pg, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_TypesOrphaned_1_1_performtransformation_blackBBBBFBB(MClass mType,
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg, TypesOrphaned _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mType, mModelToTypeGraph, mModel, pg, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesOrphaned_1_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_TypesOrphaned_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypesOrphaned_1_1_performtransformation_black = pattern_TypesOrphaned_1_1_performtransformation_blackBBBBFBB(
					mType, mModelToTypeGraph, mModel, pg, _this, isApplicableMatch);
	...
	public static final Object[] pattern_TypesOrphaned_1_1_performtransformation_greenFFBFBB(MClass mType, TypeGraph pg,
			CSP csp) {
		...
		return new Object[] { mBodyToTAnnotation, mTypeToTType, mType, tType, pg, csp };
	}

	public static final Object[] pattern_TypesOrphaned_1_2_collecttranslatedelements_blackBBBB(
			ASTNodeToTAnnotatable mBodyToTAnnotation, TypeToTAbstractType mTypeToTType, MClass mType, TClass tType) {
		return new Object[] { mBodyToTAnnotation, mTypeToTType, mType, tType };
	}
	...
	public static final Object[] pattern_TypesOrphaned_1_2_collecttranslatedelements_greenFBBBB(
		...
		return new Object[] { ruleresult, mBodyToTAnnotation, mTypeToTType, mType, tType };
	}

	public static final Object[] pattern_TypesOrphaned_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mTypeToTType, EObject mType,
			EObject mModelToTypeGraph, EObject tType, EObject mModel, EObject pg) {
	...
	public static final Object[] pattern_TypesOrphaned_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFF(
			PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mTypeToTType, EObject mType,
			EObject tType, EObject mModel, EObject pg) {
		...
		return new Object[] { ruleresult, mBodyToTAnnotation, mTypeToTType, mType, tType, mModel, pg,
				mBodyToTAnnotation__mType____source, mTypeToTType__mType____source, mTypeToTType__tType____target,
				mModel__mType____orphanTypes, mBodyToTAnnotation__tType____target, pg__tType____ownedTypes,
				tType__pg____pg };
	}
	...
	public static final void pattern_TypesOrphaned_1_5_registerobjects_expressionBBBBBBBBB(TypesOrphaned _this,
			PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mTypeToTType, EObject mType,
			EObject mModelToTypeGraph, EObject tType, EObject mModel, EObject pg) {
		_this.registerObjects_FWD(ruleresult, mBodyToTAnnotation, mTypeToTType, mType, mModelToTypeGraph, tType, mModel,
				pg);
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_2_2_corematch_blackBFBFB(MClass mType, Model mModel,
			Match match) {
		...
		for (ModelToTypeGraph mModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (pg != null) {
				_result.add(new Object[] { mType, mModelToTypeGraph, mModel, pg, match });
			}
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_2_3_findcontext_blackBBBB(MClass mType,
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (mModel.getOrphanTypes().contains(mType)) {
			if (mModel.equals(mModelToTypeGraph.getSource())) {
				if (pg.equals(mModelToTypeGraph.getTarget())) {
					_result.add(new Object[] { mType, mModelToTypeGraph, mModel, pg });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_TypesOrphaned_2_3_findcontext_greenBBBBFFFF(MClass mType,
			ModelToTypeGraph mModelToTypeGraph, Model mModel, TypeGraph pg) {
		...
		return new Object[] { mType, mModelToTypeGraph, mModel, pg, isApplicableMatch, mModel__mType____orphanTypes,
	...
	public static final Object[] pattern_TypesOrphaned_2_4_solveCSP_bindingFBBBBBB(TypesOrphaned _this,
		...
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mType, mModelToTypeGraph, mModel, pg };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesOrphaned_2_4_solveCSP_bindingAndBlackFBBBBBB(TypesOrphaned _this,
		...
		Object[] result_pattern_TypesOrphaned_2_4_solveCSP_binding = pattern_TypesOrphaned_2_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, mType, mModelToTypeGraph, mModel, pg);
		...
		if (tmpMModelToTypeGraph instanceof ModelToTypeGraph) {
			...
			if (tmpTType instanceof TClass) {
				...
				if (tmpMModel instanceof Model) {
					...
					if (tmpPg instanceof TypeGraph) {
						TypeGraph pg = (TypeGraph) tmpPg;
						return new Object[] { mModelToTypeGraph, tType, mModel, pg, isApplicableMatch };
					}
				}
			}
		}
	...
	public static final Object[] pattern_TypesOrphaned_11_1_performtransformation_blackBBBBFBB(
			ModelToTypeGraph mModelToTypeGraph, TClass tType, Model mModel, TypeGraph pg, TypesOrphaned _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModelToTypeGraph, tType, mModel, pg, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesOrphaned_11_1_performtransformation_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_TypesOrphaned_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_TypesOrphaned_11_1_performtransformation_black = pattern_TypesOrphaned_11_1_performtransformation_blackBBBBFBB(
					mModelToTypeGraph, tType, mModel, pg, _this, isApplicableMatch);
	...
	public static final Object[] pattern_TypesOrphaned_11_1_performtransformation_greenFFFBBB(TClass tType,
		...
		return new Object[] { mBodyToTAnnotation, mTypeToTType, mType, tType, mModel, csp };
	}
	...
	public static final void pattern_TypesOrphaned_11_5_registerobjects_expressionBBBBBBBBB(TypesOrphaned _this,
			PerformRuleResult ruleresult, EObject mBodyToTAnnotation, EObject mTypeToTType, EObject mType,
			EObject mModelToTypeGraph, EObject tType, EObject mModel, EObject pg) {
		_this.registerObjects_BWD(ruleresult, mBodyToTAnnotation, mTypeToTType, mType, mModelToTypeGraph, tType, mModel,
				pg);
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_12_2_corematch_blackFBFBB(TClass tType, TypeGraph pg,
			Match match) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		for (ModelToTypeGraph mModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(pg,
			...
			if (mModel != null) {
				_result.add(new Object[] { mModelToTypeGraph, tType, mModel, pg, match });
			}
	...
	public static final Iterable<Object[]> pattern_TypesOrphaned_12_3_findcontext_blackBBBB(
			ModelToTypeGraph mModelToTypeGraph, TClass tType, Model mModel, TypeGraph pg) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (mModel.equals(mModelToTypeGraph.getSource())) {
			if (pg.equals(mModelToTypeGraph.getTarget())) {
				if (pg.getOwnedTypes().contains(tType)) {
					_result.add(new Object[] { mModelToTypeGraph, tType, mModel, pg });
				}
			}
		}
		return _result;
	...
	public static final Object[] pattern_TypesOrphaned_12_4_solveCSP_bindingFBBBBBB(TypesOrphaned _this,
			IsApplicableMatch isApplicableMatch, ModelToTypeGraph mModelToTypeGraph, TClass tType, Model mModel,
			TypeGraph pg) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mModelToTypeGraph, tType, mModel, pg);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModelToTypeGraph, tType, mModel, pg };
		}
		return null;
	}
	...
	public static final Object[] pattern_TypesOrphaned_12_4_solveCSP_bindingAndBlackFBBBBBB(TypesOrphaned _this,
		...
		Object[] result_pattern_TypesOrphaned_12_4_solveCSP_binding = pattern_TypesOrphaned_12_4_solveCSP_bindingFBBBBBB(
				_this, isApplicableMatch, mModelToTypeGraph, tType, mModel, pg);
	...
	public static final Object[] pattern_TypesOrphaned_20_2_testcorematchandDECs_black_nac_0B(TClass tType) {
		for (TPackage __DEC_tType_classes_790991 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypesOrphaned_20_2_testcorematchandDECs_black_nac_1BB(TClass tType,
			TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_283964 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_283964)) {
	...
	public static final Object[] pattern_TypesOrphaned_20_2_testcorematchandDECs_black_nac_2B(TClass tType) {
		TPackage __DEC_tType_ownedTypes_372530 = tType.getPackage();
		if (__DEC_tType_ownedTypes_372530 != null) {
			return new Object[] { tType };
		}
	...
	public static final Object[] pattern_TypesOrphaned_20_2_testcorematchandDECs_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_185476 = tType.getOuterType();
		if (__DEC_tType_innerTypes_185476 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_185476)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_TypesOrphaned_21_2_testcorematchandDECs_black_nac_0B(MClass mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_572334 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_572334 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_572334)) {
	...
	public static final Object[] pattern_TypesOrphaned_21_2_testcorematchandDECs_black_nac_1B(MClass mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_305367 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_305367 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_TypesOrphaned_21_2_testcorematchandDECs_black_nac_2B(MClass mType) {
		org.eclipse.modisco.java.Package __DEC_mType_ownedElements_566206 = mType.getPackage();
		if (__DEC_mType_ownedElements_566206 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_TypesOrphaned_21_2_testcorematchandDECs_black_nac_3B(MClass mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_95757 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_TypesOrphaned_24_6_createcorrespondence_greenFFBBB(MClass mType, TClass tType,
		...
		return new Object[] { mBodyToTAnnotation, mTypeToTType, mType, tType, ccMatch };
	}
	...
	public static final Object[] pattern_TypesOrphaned_27_1_matchtggpattern_black_nac_0B(MClass mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_45408 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_45408 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_45408)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_TypesOrphaned_27_1_matchtggpattern_black_nac_1B(MClass mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_604805 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_604805 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_TypesOrphaned_27_1_matchtggpattern_black_nac_2B(MClass mType) {
		org.eclipse.modisco.java.Package __DEC_mType_ownedElements_815125 = mType.getPackage();
		if (__DEC_mType_ownedElements_815125 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_TypesOrphaned_27_1_matchtggpattern_black_nac_3B(MClass mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_215325 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_TypesOrphaned_28_1_matchtggpattern_black_nac_0B(TClass tType) {
		for (TPackage __DEC_tType_classes_608219 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			return new Object[] { tType };
		}
		return null;
	...
	public static final Object[] pattern_TypesOrphaned_28_1_matchtggpattern_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_23598 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_23598)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_TypesOrphaned_28_1_matchtggpattern_black_nac_2B(TClass tType) {
		TPackage __DEC_tType_ownedTypes_669756 = tType.getPackage();
		if (__DEC_tType_ownedTypes_669756 != null) {
			return new Object[] { tType };
		}
	...
	public static final Object[] pattern_TypesOrphaned_28_1_matchtggpattern_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_701421 = tType.getOuterType();
		if (__DEC_tType_innerTypes_701421 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_701421)) {
				return new Object[] { tType };
			}
		}
	...
	public static final Object[] pattern_TypesOrphaned_29_6_perform_greenFFFFBBBB(Model mModel, TypeGraph pg,
		...
		return new Object[] { mBodyToTAnnotation, mTypeToTType, mType, tType, mModel, pg, ruleResult, csp };
	}
