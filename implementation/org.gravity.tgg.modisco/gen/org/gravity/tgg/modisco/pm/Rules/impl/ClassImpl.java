...
public class ClassImpl extends AbstractRuleImpl implements org.gravity.tgg.modisco.pm.Rules.Class {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_49__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_49((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_50__EMOFLONEDGE:
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_0BB(TClass tType,
			TPackage tPackage) {
		for (TPackage __DEC_tType_classes_397795 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_397795)) {
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_750826 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_750826)) {
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_2BB(TClass tType,
			TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_783462 = tType.getPackage();
		if (__DEC_tType_ownedTypes_783462 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_783462)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Class_20_2_testcorematchandDECs_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_682380 = tType.getOuterType();
		if (__DEC_tType_innerTypes_682380 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_682380)) {
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_0B(MClass mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_617354 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_617354 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_617354)) {
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_1B(MClass mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_576065 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_576065 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_2B(MClass mType) {
		for (Model __DEC_mType_orphanTypes_472451 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Class_21_2_testcorematchandDECs_black_nac_3B(MClass mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_170550 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_0B(MClass mType) {
		AbstractTypeDeclaration __DEC_mType_abstractTypeDeclaration_592436 = mType.getAbstractTypeDeclaration();
		if (__DEC_mType_abstractTypeDeclaration_592436 != null) {
			if (!mType.equals(__DEC_mType_abstractTypeDeclaration_592436)) {
				return new Object[] { mType };
			}
		}
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_1B(MClass mType) {
		AnonymousClassDeclaration __DEC_mType_anonymousClassDeclarationOwner_527643 = mType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mType_anonymousClassDeclarationOwner_527643 != null) {
			return new Object[] { mType };
		}
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_2B(MClass mType) {
		for (Model __DEC_mType_orphanTypes_239601 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, Model.class, "orphanTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Class_27_1_matchtggpattern_black_nac_3B(MClass mType) {
		for (MAbstractMethodDefinition __DEC_mType_mInnerTypes_659662 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { mType };
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_0BB(TClass tType, TPackage tPackage) {
		for (TPackage __DEC_tType_classes_558762 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TPackage.class, "classes")) {
			if (!tPackage.equals(__DEC_tType_classes_558762)) {
				return new Object[] { tType, tPackage };
			}
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_1BB(TClass tType, TypeGraph pg) {
		for (TypeGraph __DEC_tType_classes_652886 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tType, TypeGraph.class, "classes")) {
			if (!pg.equals(__DEC_tType_classes_652886)) {
				return new Object[] { tType, pg };
			}
		}
		return null;
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_2BB(TClass tType, TPackage tPackage) {
		TPackage __DEC_tType_ownedTypes_87569 = tType.getPackage();
		if (__DEC_tType_ownedTypes_87569 != null) {
			if (!tPackage.equals(__DEC_tType_ownedTypes_87569)) {
				return new Object[] { tType, tPackage };
			}
		}
	...
	public static final Object[] pattern_Class_28_1_matchtggpattern_black_nac_3B(TClass tType) {
		TAbstractType __DEC_tType_innerTypes_636868 = tType.getOuterType();
		if (__DEC_tType_innerTypes_636868 != null) {
			if (!tType.equals(__DEC_tType_innerTypes_636868)) {
				return new Object[] { tType };
			}
		}
