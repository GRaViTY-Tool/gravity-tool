...
public class MemberInAnnotationVisibilityImpl extends AbstractRuleImpl implements MemberInAnnotationVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_1_1_performtransformation_greenBBFFB(mModifier, tMember, csp);
		...
		Object[] result3_black = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mModifier,
						mDefinition, tAnnotation, mTypeToTType, tMember, mModifierToTModifier, tModifier, defToMember,
						Annotation);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ "[tModifier] = " + tModifier + ", " + "[defToMember] = " + defToMember + ", " + "[Annotation] = "
					+ Annotation + ".");
		}
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, mModifier, mDefinition, tMember, mModifierToTModifier, tModifier);
		...
		MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
				this, ruleresult, mModifier, mDefinition, tAnnotation, mTypeToTType, tMember, mModifierToTModifier,
				tModifier, defToMember, Annotation);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_2_2_corematch_blackBBFFFFBB(mModifier, mDefinition, Annotation,
						match)) {
			...
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_2_3_findcontext_blackBBBBBBB(mModifier, mDefinition,
							tAnnotation, mTypeToTType, tMember, defToMember, Annotation)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mModifier,
								mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, Annotation);
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mModifier, mDefinition, tAnnotation, mTypeToTType, tMember,
								defToMember, Annotation);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, Modifier mModifier,
			MDefinition mDefinition, TAnnotationType tAnnotation, TypeToTAbstractType mTypeToTType, TMember tMember,
			MDefinitionToTMember defToMember, AnnotationTypeDeclaration Annotation) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mModifier, EObject mDefinition,
			EObject tAnnotation, EObject mTypeToTType, EObject tMember, EObject mModifierToTModifier, EObject tModifier,
			EObject defToMember, EObject Annotation) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(this, ruleresult,
						mModifier, mDefinition, tAnnotation, mTypeToTType, tMember, mModifierToTModifier, tModifier,
						defToMember, Annotation);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_12_2_corematch_blackFBFBBFFB(tAnnotation, tMember, tModifier,
						match)) {
			...
			// ForEach 
			for (Object[] result3_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_12_3_findcontext_blackBBBBBBB(mDefinition, tAnnotation,
							mTypeToTType, tMember, tModifier, defToMember, Annotation)) {
				Object[] result3_green = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mDefinition,
								tAnnotation, mTypeToTType, tMember, tModifier, defToMember, Annotation);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier,
								defToMember, Annotation);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition
							+ ", " + "[tAnnotation] = " + tAnnotation + ", " + "[mTypeToTType] = " + mTypeToTType + ", "
							+ "[tMember] = " + tMember + ", " + "[tModifier] = " + tModifier + ", " + "[defToMember] = "
							+ defToMember + ", " + "[Annotation] = " + Annotation + ".");
				}
				CSP csp = (CSP) result4_bindingAndBlack[0];
				// 
				if (MemberInAnnotationVisibilityImpl
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition,
			TAnnotationType tAnnotation, TypeToTAbstractType mTypeToTType, TMember tMember, TModifier tModifier,
			MDefinitionToTMember defToMember, AnnotationTypeDeclaration Annotation) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mModifier, EObject mDefinition,
			EObject tAnnotation, EObject mTypeToTType, EObject tMember, EObject mModifierToTModifier, EObject tModifier,
			EObject defToMember, EObject Annotation) {
		ruleresult.registerObject("mModifier", mModifier);
		ruleresult.registerObject("mDefinition", mDefinition);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_39(EMoflonEdge _edge_tModifier) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
				.pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mModifier,
						mDefinition, tAnnotation, tMember, tModifier, Annotation, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mModifier] = " + mModifier + ", " + "[mDefinition] = " + mDefinition + ", " + "[tAnnotation] = "
					+ tAnnotation + ", " + "[tMember] = " + tMember + ", " + "[tModifier] = " + tModifier + ", "
		...
		if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_24_5_matchcorrcontext_blackBBFBFBBB(mDefinition, tAnnotation,
				...
				Object[] result6_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(mModifier,
								mDefinition, tAnnotation, tMember, tModifier, Annotation, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mModifier] = "
							+ mModifier + ", " + "[mDefinition] = " + mDefinition + ", " + "[tAnnotation] = "
							+ tAnnotation + ", " + "[tMember] = " + tMember + ", " + "[tModifier] = " + tModifier + ", "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(Modifier mModifier, MDefinition mDefinition, TAnnotationType tAnnotation,
			TMember tMember, TModifier tModifier, AnnotationTypeDeclaration Annotation, Match sourceMatch,
		...
		for (Object[] result2_black : MemberInAnnotationVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInAnnotationVisibilityImpl
					.pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this,
							isApplicableMatch, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, Annotation,
							ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mDefinition] = " + mDefinition + ", "
			...
			if (MemberInAnnotationVisibilityImpl.pattern_MemberInAnnotationVisibility_29_4_checkCSP_expressionFBB(this,
				...
				// 
				Object[] result5_black = MemberInAnnotationVisibilityImpl
						.pattern_MemberInAnnotationVisibility_29_5_checknacs_blackBBBBBB(mDefinition, tAnnotation,
								mTypeToTType, tMember, defToMember, Annotation);
				if (result5_black != null) {

					Object[] result6_black = MemberInAnnotationVisibilityImpl
							.pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(mDefinition, tAnnotation,
									mTypeToTType, tMember, defToMember, Annotation, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mDefinition] = "
								+ mDefinition + ", " + "[tAnnotation] = " + tAnnotation + ", " + "[mTypeToTType] = "
								+ mTypeToTType + ", " + "[tMember] = " + tMember + ", " + "[defToMember] = "
								+ defToMember + ", " + "[Annotation] = " + Annotation + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, MDefinition mDefinition,
			...
			MDefinitionToTMember defToMember, AnnotationTypeDeclaration Annotation,
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MODIFIER_MDEFINITION_TANNOTATIONTYPE_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER_ANNOTATIONTYPEDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (Modifier) arguments.get(1),
					(MDefinition) arguments.get(2), (TAnnotationType) arguments.get(3),
					(TypeToTAbstractType) arguments.get(4), (TMember) arguments.get(5),
					(MDefinitionToTMember) arguments.get(6), (AnnotationTypeDeclaration) arguments.get(7));
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_TANNOTATIONTYPE_TYPETOTABSTRACTTYPE_TMEMBER_TMODIFIER_MDEFINITIONTOTMEMBER_ANNOTATIONTYPEDECLARATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (MDefinition) arguments.get(1),
					...
					(TMember) arguments.get(4), (TModifier) arguments.get(5), (MDefinitionToTMember) arguments.get(6),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_39__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_39((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_40__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__MODIFIER_MDEFINITION_TANNOTATIONTYPE_TMEMBER_TMODIFIER_ANNOTATIONTYPEDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((Modifier) arguments.get(0), (MDefinition) arguments.get(1),
					(TAnnotationType) arguments.get(2), (TMember) arguments.get(3), (TModifier) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_ANNOTATION_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MDEFINITION_TANNOTATIONTYPE_TYPETOTABSTRACTTYPE_TMEMBER_MDEFINITIONTOTMEMBER_ANNOTATIONTYPEDECLARATION_MODELGENERATORRULERESULT:
			return generateModel_solveCsp_BWD((IsApplicableMatch) arguments.get(0), (MDefinition) arguments.get(1),
					(TAnnotationType) arguments.get(2), (TypeToTAbstractType) arguments.get(3),
					(TMember) arguments.get(4), (MDefinitionToTMember) arguments.get(5),
						...
						if (tmpTMember instanceof TMember) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
									...
									return new Object[] { mModifier, mDefinition, tAnnotation, mTypeToTType, tMember,
											defToMember, annotation, isApplicableMatch };
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			Modifier mModifier, MDefinition mDefinition, TAnnotationType tAnnotation, TypeToTAbstractType mTypeToTType,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mModifier, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_binding != null) {
			...
			MDefinitionToTMember defToMember = (MDefinitionToTMember) result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_binding[5];
			...
			Object[] result_pattern_MemberInAnnotationVisibility_1_1_performtransformation_black = pattern_MemberInAnnotationVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mModifier, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, annotation, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mModifier, EObject mDefinition, EObject tAnnotation,
			EObject mTypeToTType, EObject tMember, EObject mModifierToTModifier, EObject tModifier, EObject defToMember,
			EObject annotation) {
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject mModifier, EObject mDefinition, EObject tMember,
		...
		return new Object[] { ruleresult, mModifier, mDefinition, tMember, mModifierToTModifier, tModifier,
	...
	public static final void pattern_MemberInAnnotationVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInAnnotationVisibility _this, PerformRuleResult ruleresult, EObject mModifier, EObject mDefinition,
			EObject tAnnotation, EObject mTypeToTType, EObject tMember, EObject mModifierToTModifier, EObject tModifier,
			EObject defToMember, EObject annotation) {
		_this.registerObjects_FWD(ruleresult, mModifier, mDefinition, tAnnotation, mTypeToTType, tMember,
				mModifierToTModifier, tModifier, defToMember, annotation);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_2_2_corematch_blackBBFFFFBB(
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTAnnotation instanceof TAnnotationType) {
						TAnnotationType tAnnotation = (TAnnotationType) tmpTAnnotation;
						_result.add(new Object[] { mModifier, mDefinition, tAnnotation, mTypeToTType, tMember,
								defToMember, annotation, match });
					}
						...
						if (annotation.equals(mTypeToTType.getSource())) {
							if (annotation.getBodyDeclarations().contains(mDefinition)) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { mModifier, mDefinition, tAnnotation, mTypeToTType,
											tMember, defToMember, annotation });
								}
							}
						}
					}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mModifier, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, annotation,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
			...
			MDefinition mDefinition, TAnnotationType tAnnotation, TypeToTAbstractType mTypeToTType, TMember tMember,
			MDefinitionToTMember defToMember, AnnotationTypeDeclaration annotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mModifier, mDefinition, tAnnotation,
				mTypeToTType, tMember, defToMember, annotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mModifier, mDefinition, tAnnotation, mTypeToTType,
					tMember, defToMember, annotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_2_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mModifier, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember,
				annotation);
					...
					if (tmpTMember instanceof TMember) {
						...
						if (tmpTModifier instanceof TModifier) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
									AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
									return new Object[] { mDefinition, tAnnotation, mTypeToTType, tMember, tModifier,
											defToMember, annotation, isApplicableMatch };
								}
							}
						}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mDefinition, tAnnotation, mTypeToTType, tMember, tModifier, defToMember,
						annotation, csp, _this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding != null) {
			...
			MDefinitionToTMember defToMember = (MDefinitionToTMember) result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_binding[5];
			...
			Object[] result_pattern_MemberInAnnotationVisibility_11_1_performtransformation_black = pattern_MemberInAnnotationVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					mDefinition, tAnnotation, mTypeToTType, tMember, tModifier, defToMember, annotation, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInAnnotationVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject tAnnotation, EObject mTypeToTType, EObject tMember, EObject mModifierToTModifier, EObject tModifier,
			EObject defToMember, EObject annotation) {
		_this.registerObjects_BWD(ruleresult, mModifier, mDefinition, tAnnotation, mTypeToTType, tMember,
				mModifierToTModifier, tModifier, defToMember, annotation);
	...
	public static final Iterable<Object[]> pattern_MemberInAnnotationVisibility_12_2_corematch_blackFBFBBFFB(
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { mDefinition, tAnnotation, mTypeToTType, tMember, tModifier,
								defToMember, annotation, match });
					}
				...
				if (tAnnotation.getDefines().contains(tMember)) {
					if (mDefinition.equals(defToMember.getSource())) {
						if (annotation.equals(mTypeToTType.getSource())) {
							if (annotation.getBodyDeclarations().contains(mDefinition)) {
								if (tMember.equals(defToMember.getTarget())) {
									_result.add(new Object[] { mDefinition, tAnnotation, mTypeToTType, tMember,
											tModifier, defToMember, annotation });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		mDefinition__Annotation____abstractTypeDeclaration
				.setName(mDefinition__Annotation____abstractTypeDeclaration_name_prime);
		defToMember__tMember____target.setName(defToMember__tMember____target_name_prime);
		return new Object[] { mDefinition, tAnnotation, mTypeToTType, tMember, tModifier, defToMember, annotation,
				isApplicableMatch, mTypeToTType__tAnnotation____target, tMember__tModifier____tModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
			...
			TAnnotationType tAnnotation, TypeToTAbstractType mTypeToTType, TMember tMember, TModifier tModifier,
			MDefinitionToTMember defToMember, AnnotationTypeDeclaration annotation) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mDefinition, tAnnotation,
				mTypeToTType, tMember, tModifier, defToMember, annotation);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, tAnnotation, mTypeToTType, tMember,
					tModifier, defToMember, annotation };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_12_4_solveCSP_binding = pattern_MemberInAnnotationVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, tAnnotation, mTypeToTType, tMember, tModifier, defToMember,
				annotation);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_955778 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_955778)) {
				...
				if (tmpTAnnotation instanceof TAnnotationType) {
					...
					if (tmpTMember instanceof TMember) {
						...
						if (tmpTModifier instanceof TModifier) {
							...
							if (tmpAnnotation instanceof AnnotationTypeDeclaration) {
								AnnotationTypeDeclaration annotation = (AnnotationTypeDeclaration) tmpAnnotation;
								return new Object[] { mModifier, mDefinition, tAnnotation, tMember, tModifier,
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			Modifier mModifier, MDefinition mDefinition, TAnnotationType tAnnotation, TMember tMember,
			TModifier tModifier, AnnotationTypeDeclaration annotation, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mModifier, mDefinition, tAnnotation, tMember, tModifier, annotation, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInAnnotationVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mModifier, mDefinition, tAnnotation, tMember, tModifier, annotation, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInAnnotationVisibility _this, Modifier mModifier, MDefinition mDefinition,
			TAnnotationType tAnnotation, TMember tMember, TModifier tModifier, AnnotationTypeDeclaration annotation,
			Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mModifier, mDefinition, tAnnotation, tMember, tModifier,
				annotation, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mModifier, mDefinition, tAnnotation, tMember, tModifier, annotation,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_24_3_solvecsp_binding = pattern_MemberInAnnotationVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mModifier, mDefinition, tAnnotation, tMember, tModifier, annotation, sourceMatch, targetMatch);
			...
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (annotation.equals(mTypeToTType.getSource())) {
					for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(mDefinition, MDefinitionToTMember.class, "source")) {
						if (tMember.equals(defToMember.getTarget())) {
							_result.add(new Object[] { mDefinition, tAnnotation, mTypeToTType, tMember, defToMember,
									annotation, sourceMatch, targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mModifier, mDefinition, tAnnotation, tMember, tModifier, annotation, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_28_1_matchtggpattern_black_nac_0BB(
			TModifier tModifier, TAnnotationType tAnnotation) {
		for (TAbstractType __DEC_tModifier_tModifier_998443 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tAnnotation.equals(__DEC_tModifier_tModifier_998443)) {
				return new Object[] { tModifier, tAnnotation };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mDefinition, tAnnotation,
				mTypeToTType, tMember, defToMember, annotation, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mDefinition, tAnnotation, mTypeToTType, tMember,
					defToMember, annotation, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInAnnotationVisibility_29_3_solveCSP_binding = pattern_MemberInAnnotationVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, annotation,
				ruleResult);
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_5_checknacs_blackBBBBBB(
			MDefinition mDefinition, TAnnotationType tAnnotation, TypeToTAbstractType mTypeToTType, TMember tMember,
			MDefinitionToTMember defToMember, AnnotationTypeDeclaration annotation) {
		return new Object[] { mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, annotation };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_blackBBBBBBB(MDefinition mDefinition,
			...
			MDefinitionToTMember defToMember, AnnotationTypeDeclaration annotation,
			ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mDefinition, tAnnotation, mTypeToTType, tMember, defToMember, annotation, ruleResult };
	}
	...
	public static final Object[] pattern_MemberInAnnotationVisibility_29_6_perform_greenFBBFFBB(MDefinition mDefinition,
		...
		return new Object[] { mModifier, mDefinition, tMember, mModifierToTModifier, tModifier, ruleResult, csp };
	}
