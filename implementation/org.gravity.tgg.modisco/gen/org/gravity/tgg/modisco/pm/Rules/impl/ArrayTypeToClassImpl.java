...
public class ArrayTypeToClassImpl extends AbstractRuleImpl implements ArrayTypeToClass {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, ArrayType eArrayType, Type eType, Model eModel,
		...
		Object[] result1_black = ArrayTypeToClassImpl.pattern_ArrayTypeToClass_0_1_initialbindings_blackBBBBBB(this,
				match, eArrayType, eType, eModel, eTypeAccess);
		...
		Object[] result2_bindingAndBlack = ArrayTypeToClassImpl
				.pattern_ArrayTypeToClass_0_2_SolveCSP_bindingAndBlackFBBBBBB(this, match, eArrayType, eType, eModel,
						eTypeAccess);
		...
		if (ArrayTypeToClassImpl.pattern_ArrayTypeToClass_0_3_CheckCSP_expressionFBB(this, csp)) {
			...
			if (result4_black == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[match] = " + match + ", "
						+ "[eArrayType] = " + eArrayType + ", " + "[eType] = " + eType + ", " + "[eModel] = " + eModel
			...
			ArrayTypeToClassImpl.pattern_ArrayTypeToClass_0_4_collectelementstobetranslated_greenBBBBBFFFF(match,
					eArrayType, eType, eModel, eTypeAccess);
			...
			Object[] result5_black = ArrayTypeToClassImpl
					.pattern_ArrayTypeToClass_0_5_collectcontextelements_blackBBBBB(match, eArrayType, eType, eModel,
							eTypeAccess);
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = ArrayTypeToClassImpl.pattern_ArrayTypeToClass_1_3_bookkeepingforedges_blackBBBBBBBBB(
				ruleresult, eArrayType, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, eTypeAccess, tArrayClass,
				typeGraph);
		...
		ArrayTypeToClassImpl.pattern_ArrayTypeToClass_1_5_registerobjects_expressionBBBBBBBBBB(this, ruleresult,
				eArrayType, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, eTypeAccess, tArrayClass, typeGraph);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ArrayTypeToClassImpl
				.pattern_ArrayTypeToClass_2_2_corematch_blackBBFBFBFFB(eArrayType, eType, eModel, eTypeAccess, match)) {
			...
			for (Object[] result3_black : ArrayTypeToClassImpl.pattern_ArrayTypeToClass_2_3_findcontext_blackBBBBBBBB(
					eArrayType, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, eTypeAccess, tArrayClass,
					typeGraph)) {
				Object[] result3_green = ArrayTypeToClassImpl
						.pattern_ArrayTypeToClass_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(eArrayType, eType,
								eTypeToTArrayClass, eModel, eModelToTypeGraph, eTypeAccess, tArrayClass, typeGraph);
				...
				//nothing EMoflonEdge eTypeToTArrayClass__tArrayClass____target = (EMoflonEdge) result3_green[11];
				//nothing EMoflonEdge eTypeAccess__eType____type = (EMoflonEdge) result3_green[12];
				//nothing EMoflonEdge eType__eTypeAccess____usagesInTypeAccess = (EMoflonEdge) result3_green[13];
				...
				//nothing EMoflonEdge tArrayClass__typeGraph____pg = (EMoflonEdge) result3_green[17];
				...
				Object[] result4_bindingAndBlack = ArrayTypeToClassImpl
						.pattern_ArrayTypeToClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this, isApplicableMatch,
								eArrayType, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, eTypeAccess,
				...
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							...
							+ "[eModel] = " + eModel + ", " + "[eModelToTypeGraph] = " + eModelToTypeGraph + ", "
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, ArrayType eArrayType, Type eType, Model eModel,
			TypeAccess eTypeAccess) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, ArrayType eArrayType, Type eType, Model eModel,
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, ArrayType eArrayType, Type eType,
			TypeToTAbstractType eTypeToTArrayClass, Model eModel, ModelToTypeGraph eModelToTypeGraph,
			TypeAccess eTypeAccess, TAbstractType tArrayClass, TypeGraph typeGraph) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eArrayType, EObject eType,
			EObject eTypeToTArrayClass, EObject eModel, EObject eModelToTypeGraph, EObject eTypeAccess,
			EObject tArrayClass, EObject typeGraph) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_58(EMoflonEdge _edge_elementType) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ArrayTypeToClassImpl
				.pattern_ArrayTypeToClass_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, eArrayType, eType, eModel,
						eTypeAccess, tArrayClass, typeGraph, sourceMatch, targetMatch);
		...
		if (ArrayTypeToClassImpl.pattern_ArrayTypeToClass_21_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ArrayTypeToClassImpl
					.pattern_ArrayTypeToClass_21_5_matchcorrcontext_blackBFBFBBBB(eType, eModel, tArrayClass, typeGraph,
							sourceMatch, targetMatch)) {
				TypeToTAbstractType eTypeToTArrayClass = (TypeToTAbstractType) result5_black[1];
				ModelToTypeGraph eModelToTypeGraph = (ModelToTypeGraph) result5_black[3];
				...
				Object[] result6_black = ArrayTypeToClassImpl
						.pattern_ArrayTypeToClass_21_6_createcorrespondence_blackBBBBBBB(eArrayType, eType, eModel,
								eTypeAccess, tArrayClass, typeGraph, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ArrayType eArrayType, Type eType, Model eModel, TypeAccess eTypeAccess,
			TAbstractType tArrayClass, TypeGraph typeGraph, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(ArrayType eArrayType, Type eType, Model eModel, TypeAccess eTypeAccess) {// 
		Object[] result1_black = ArrayTypeToClassImpl
				.pattern_ArrayTypeToClass_24_1_matchtggpattern_blackBBBB(eArrayType, eType, eModel, eTypeAccess);
		if (result1_black != null) {
		...
		for (Object[] result2_black : ArrayTypeToClassImpl
			...
			Object[] result3_bindingAndBlack = ArrayTypeToClassImpl
					.pattern_ArrayTypeToClass_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch, eType,
							eTypeToTArrayClass, eModel, eModelToTypeGraph, tArrayClass, typeGraph, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
			...
			if (ArrayTypeToClassImpl.pattern_ArrayTypeToClass_26_4_checkCSP_expressionFBB(this, csp)) {
				...
				Object[] result5_black = ArrayTypeToClassImpl.pattern_ArrayTypeToClass_26_5_checknacs_blackBBBBBB(eType,
						eTypeToTArrayClass, eModel, eModelToTypeGraph, tArrayClass, typeGraph);
				if (result5_black != null) {

					Object[] result6_black = ArrayTypeToClassImpl.pattern_ArrayTypeToClass_26_6_perform_blackBBBBBBB(
							eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, tArrayClass, typeGraph, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eType] = " + eType
								+ ", " + "[eTypeToTArrayClass] = " + eTypeToTArrayClass + ", " + "[eModel] = " + eModel
								+ ", " + "[eModelToTypeGraph] = " + eModelToTypeGraph + ", " + "[tArrayClass] = "
								+ tArrayClass + ", " + "[typeGraph] = " + typeGraph + ", " + "[ruleResult] = "
								+ ruleResult + ".");
					}
					ArrayTypeToClassImpl.pattern_ArrayTypeToClass_26_6_perform_greenFBBFB(eType, eModel, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, Type eType,
			TypeToTAbstractType eTypeToTArrayClass, Model eModel, ModelToTypeGraph eModelToTypeGraph,
			TAbstractType tArrayClass, TypeGraph typeGraph, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPROPRIATE_FWD__MATCH_ARRAYTYPE_TYPE_MODEL_TYPEACCESS:
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_ARRAYTYPE_TYPE_MODEL_TYPEACCESS:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (ArrayType) arguments.get(1), (Type) arguments.get(2),
					(Model) arguments.get(3), (TypeAccess) arguments.get(4));
			return null;
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_ARRAYTYPE_TYPE_MODEL_TYPEACCESS:
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_ARRAYTYPE_TYPE_TYPETOTABSTRACTTYPE_MODEL_MODELTOTYPEGRAPH_TYPEACCESS_TABSTRACTTYPE_TYPEGRAPH:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (ArrayType) arguments.get(1),
					...
					(ModelToTypeGraph) arguments.get(5), (TypeAccess) arguments.get(6),
					(TAbstractType) arguments.get(7), (TypeGraph) arguments.get(8));
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_58__EMOFLONEDGE:
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__ARRAYTYPE_TYPE_MODEL_TYPEACCESS_TABSTRACTTYPE_TYPEGRAPH_MATCH_MATCH:
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___CHECK_DEC_FWD__ARRAYTYPE_TYPE_MODEL_TYPEACCESS:
		...
		case RulesPackage.ARRAY_TYPE_TO_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPE_TYPETOTABSTRACTTYPE_MODEL_MODELTOTYPEGRAPH_TABSTRACTTYPE_TYPEGRAPH_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_ArrayTypeToClass_0_1_initialbindings_blackBBBBBB(ArrayTypeToClass _this,
			Match match, ArrayType eArrayType, Type eType, Model eModel, TypeAccess eTypeAccess) {
		if (!eArrayType.equals(eType)) {
			return new Object[] { _this, match, eArrayType, eType, eModel, eTypeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_0_2_SolveCSP_bindingFBBBBBB(ArrayTypeToClass _this,
			Match match, ArrayType eArrayType, Type eType, Model eModel, TypeAccess eTypeAccess) {
		CSP _localVariable_0 = _this.isAppropriate_solveCsp_FWD(match, eArrayType, eType, eModel, eTypeAccess);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, match, eArrayType, eType, eModel, eTypeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_0_2_SolveCSP_bindingAndBlackFBBBBBB(ArrayTypeToClass _this,
		...
		Object[] result_pattern_ArrayTypeToClass_0_2_SolveCSP_binding = pattern_ArrayTypeToClass_0_2_SolveCSP_bindingFBBBBBB(
				_this, match, eArrayType, eType, eModel, eTypeAccess);
	...
	public static final Object[] pattern_ArrayTypeToClass_0_4_collectelementstobetranslated_blackBBBBB(Match match,
			ArrayType eArrayType, Type eType, Model eModel, TypeAccess eTypeAccess) {
		if (!eArrayType.equals(eType)) {
			return new Object[] { match, eArrayType, eType, eModel, eTypeAccess };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_0_4_collectelementstobetranslated_greenBBBBBFFFF(Match match,
		...
		return new Object[] { match, eArrayType, eType, eModel, eTypeAccess, eArrayType__eTypeAccess____elementType,
	...
	public static final void pattern_ArrayTypeToClass_0_6_registerobjectstomatch_expressionBBBBBB(
			ArrayTypeToClass _this, Match match, ArrayType eArrayType, Type eType, Model eModel,
			TypeAccess eTypeAccess) {
		_this.registerObjectsToMatch_FWD(match, eArrayType, eType, eModel, eTypeAccess);
							...
							if (tmpETypeAccess instanceof TypeAccess) {
								...
								if (tmpTArrayClass instanceof TAbstractType) {
									...
									if (tmpTypeGraph instanceof TypeGraph) {
										...
										return new Object[] { eArrayType, eType, eTypeToTArrayClass, eModel,
												eModelToTypeGraph, eTypeAccess, tArrayClass, typeGraph,
												isApplicableMatch };
									}
								}
							}
	...
	public static final Object[] pattern_ArrayTypeToClass_1_1_performtransformation_blackBBBBBBBBFBB(
			ArrayType eArrayType, Type eType, TypeToTAbstractType eTypeToTArrayClass, Model eModel,
			ModelToTypeGraph eModelToTypeGraph, TypeAccess eTypeAccess, TAbstractType tArrayClass, TypeGraph typeGraph,
			ArrayTypeToClass _this, IsApplicableMatch isApplicableMatch) {
		if (!eArrayType.equals(eType)) {
			for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
				if (tmpCsp instanceof CSP) {
					CSP csp = (CSP) tmpCsp;
					return new Object[] { eArrayType, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, eTypeAccess,
							tArrayClass, typeGraph, csp, _this, isApplicableMatch };
				}
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToClass_1_1_performtransformation_binding != null) {
			...
			Model eModel = (Model) result_pattern_ArrayTypeToClass_1_1_performtransformation_binding[3];
	...
	public static final Object[] pattern_ArrayTypeToClass_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject eArrayType, EObject eType, EObject eTypeToTArrayClass, EObject eModel,
			EObject eModelToTypeGraph, EObject eTypeAccess, EObject tArrayClass, EObject typeGraph) {
		if (!eArrayType.equals(eType)) {
	...
	public static final Object[] pattern_ArrayTypeToClass_1_3_bookkeepingforedges_greenBBBBBFFFF(
			PerformRuleResult ruleresult, EObject eArrayType, EObject eType, EObject eModel, EObject eTypeAccess) {
		EMoflonEdge eArrayType__eTypeAccess____elementType = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eTypeAccess__eType____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eType__eTypeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eModel__eArrayType____orphanTypes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		eType__eTypeAccess____usagesInTypeAccess.setName(eType__eTypeAccess____usagesInTypeAccess_name_prime);
		eModel__eArrayType____orphanTypes.setName(eModel__eArrayType____orphanTypes_name_prime);
		return new Object[] { ruleresult, eArrayType, eType, eModel, eTypeAccess,
	...
	public static final void pattern_ArrayTypeToClass_1_5_registerobjects_expressionBBBBBBBBBB(ArrayTypeToClass _this,
			PerformRuleResult ruleresult, EObject eArrayType, EObject eType, EObject eTypeToTArrayClass, EObject eModel,
			EObject eModelToTypeGraph, EObject eTypeAccess, EObject tArrayClass, EObject typeGraph) {
		_this.registerObjects_FWD(ruleresult, eArrayType, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph,
				eTypeAccess, tArrayClass, typeGraph);
		...
		if (tmpEArrayType instanceof ArrayType) {
			...
			if (tmpEType instanceof Type) {
				...
				if (tmpEModel instanceof Model) {
					...
					if (tmpETypeAccess instanceof TypeAccess) {
						TypeAccess eTypeAccess = (TypeAccess) tmpETypeAccess;
						return new Object[] { eArrayType, eType, eModel, eTypeAccess, match };
					}
				}
			}
		}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToClass_2_2_corematch_blackBBFBFBFFB(ArrayType eArrayType,
			Type eType, Model eModel, TypeAccess eTypeAccess, Match match) {
			...
			for (TypeToTAbstractType eTypeToTArrayClass : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tArrayClass != null) {
					for (ModelToTypeGraph eModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (typeGraph != null) {
							_result.add(new Object[] { eArrayType, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph,
									eTypeAccess, tArrayClass, typeGraph, match });
						}
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToClass_2_3_findcontext_blackBBBBBBBB(ArrayType eArrayType,
			Type eType, TypeToTAbstractType eTypeToTArrayClass, Model eModel, ModelToTypeGraph eModelToTypeGraph,
			TypeAccess eTypeAccess, TAbstractType tArrayClass, TypeGraph typeGraph) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!eArrayType.equals(eType)) {
								...
								if (typeGraph.equals(eModelToTypeGraph.getTarget())) {
									if (typeGraph.getOwnedTypes().contains(tArrayClass)) {
										if (eModel.getOrphanTypes().contains(eArrayType)) {
											_result.add(new Object[] { eArrayType, eType, eTypeToTArrayClass, eModel,
													eModelToTypeGraph, eTypeAccess, tArrayClass, typeGraph });
										}
									}
								}
	...
	public static final Object[] pattern_ArrayTypeToClass_2_3_findcontext_greenBBBBBBBBFFFFFFFFFFF(ArrayType eArrayType,
		...
		eModel__eArrayType____orphanTypes.setName(eModel__eArrayType____orphanTypes_name_prime);
		return new Object[] { eArrayType, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, eTypeAccess,
				tArrayClass, typeGraph, isApplicableMatch, eArrayType__eTypeAccess____elementType,
				eTypeToTArrayClass__eType____source, eTypeToTArrayClass__tArrayClass____target,
				eTypeAccess__eType____type, eType__eTypeAccess____usagesInTypeAccess,
				eModelToTypeGraph__eModel____source, eModelToTypeGraph__typeGraph____target,
				typeGraph__tArrayClass____ownedTypes, tArrayClass__typeGraph____pg, eModel__eArrayType____orphanTypes };
	}

	public static final Object[] pattern_ArrayTypeToClass_2_4_solveCSP_bindingFBBBBBBBBBB(ArrayTypeToClass _this,
			IsApplicableMatch isApplicableMatch, ArrayType eArrayType, Type eType,
			TypeToTAbstractType eTypeToTArrayClass, Model eModel, ModelToTypeGraph eModelToTypeGraph,
			TypeAccess eTypeAccess, TAbstractType tArrayClass, TypeGraph typeGraph) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eArrayType, eType, eTypeToTArrayClass,
				eModel, eModelToTypeGraph, eTypeAccess, tArrayClass, typeGraph);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eArrayType, eType, eTypeToTArrayClass, eModel,
					eModelToTypeGraph, eTypeAccess, tArrayClass, typeGraph };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(
		...
		Object[] result_pattern_ArrayTypeToClass_2_4_solveCSP_binding = pattern_ArrayTypeToClass_2_4_solveCSP_bindingFBBBBBBBBBB(
				_this, isApplicableMatch, eArrayType, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, eTypeAccess,
				tArrayClass, typeGraph);
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_0BB(
		...
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_475957 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_475957)) {
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_221748 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_70728 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_3BB(
			TypeAccess eTypeAccess, Type eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_374837 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_374837)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_259313 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess eTypeAccess, Type eType) {
		for (ParameterizedType __DEC_eTypeAccess_type_756210 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			if (!eType.equals(__DEC_eTypeAccess_type_756210)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_348765 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_340923 : org.moflon.core.utilities.eMoflonEMFUtil
														...
														if (pattern_ArrayTypeToClass_18_2_testcorematchandDECs_black_nac_5BB(
															...
															for (Model eModel : org.moflon.core.utilities.eMoflonEMFUtil
																	.getOppositeReferenceTyped(eArrayType, Model.class,
																			"orphanTypes")) {
																_result.add(new Object[] { eArrayType, eType, eModel,
	...
	public static final boolean pattern_ArrayTypeToClass_18_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBB(
			ArrayTypeToClass _this, Match match, ArrayType eArrayType, Type eType, Model eModel,
			TypeAccess eTypeAccess) {
		boolean _localVariable_0 = _this.isAppropriate_FWD(match, eArrayType, eType, eModel, eTypeAccess);
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}
				...
				if (tmpEModel instanceof Model) {
					...
					if (tmpETypeAccess instanceof TypeAccess) {
						...
						if (tmpTArrayClass instanceof TAbstractType) {
							...
							if (tmpTypeGraph instanceof TypeGraph) {
								TypeGraph typeGraph = (TypeGraph) tmpTypeGraph;
								return new Object[] { eArrayType, eType, eModel, eTypeAccess, tArrayClass, typeGraph,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_blackBBBBBBBB(ArrayType eArrayType,
			Type eType, Model eModel, TypeAccess eTypeAccess, TAbstractType tArrayClass, TypeGraph typeGraph,
			Match sourceMatch, Match targetMatch) {
		if (!eArrayType.equals(eType)) {
			if (!sourceMatch.equals(targetMatch)) {
				return new Object[] { eArrayType, eType, eModel, eTypeAccess, tArrayClass, typeGraph, sourceMatch,
						targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_black = pattern_ArrayTypeToClass_21_2_matchsrctrgcontext_blackBBBBBBBB(
					eArrayType, eType, eModel, eTypeAccess, tArrayClass, typeGraph, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ArrayTypeToClass_21_3_solvecsp_bindingFBBBBBBBBB(ArrayTypeToClass _this,
			ArrayType eArrayType, Type eType, Model eModel, TypeAccess eTypeAccess, TAbstractType tArrayClass,
			TypeGraph typeGraph, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(eArrayType, eType, eModel, eTypeAccess, tArrayClass,
				typeGraph, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, eArrayType, eType, eModel, eTypeAccess, tArrayClass, typeGraph,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_21_3_solvecsp_bindingAndBlackFBBBBBBBBB(
			ArrayTypeToClass _this, ArrayType eArrayType, Type eType, Model eModel, TypeAccess eTypeAccess,
			TAbstractType tArrayClass, TypeGraph typeGraph, Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_ArrayTypeToClass_21_3_solvecsp_binding = pattern_ArrayTypeToClass_21_3_solvecsp_bindingFBBBBBBBBB(
				_this, eArrayType, eType, eModel, eTypeAccess, tArrayClass, typeGraph, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_ArrayTypeToClass_21_5_matchcorrcontext_blackBFBFBBBB(Type eType,
			Model eModel, TAbstractType tArrayClass, TypeGraph typeGraph, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType eTypeToTArrayClass : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(eType, TypeToTAbstractType.class, "source")) {
				if (tArrayClass.equals(eTypeToTArrayClass.getTarget())) {
					for (ModelToTypeGraph eModelToTypeGraph : org.moflon.core.utilities.eMoflonEMFUtil
							.getOppositeReferenceTyped(eModel, ModelToTypeGraph.class, "source")) {
						if (typeGraph.equals(eModelToTypeGraph.getTarget())) {
							_result.add(new Object[] { eType, eTypeToTArrayClass, eModel, eModelToTypeGraph,
									tArrayClass, typeGraph, sourceMatch, targetMatch });
						}
					}
				}
			}
	...
	public static final Object[] pattern_ArrayTypeToClass_21_6_createcorrespondence_blackBBBBBBB(ArrayType eArrayType,
			...
			CCMatch ccMatch) {
		if (!eArrayType.equals(eType)) {
			return new Object[] { eArrayType, eType, eModel, eTypeAccess, tArrayClass, typeGraph, ccMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_0BB(TypeAccess eTypeAccess,
			Type eType) {
		for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_269326 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!eType.equals(__DEC_eTypeAccess_superInterfaces_269326)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_1B(TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_95807 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_2B(TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_468649 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_3BB(TypeAccess eTypeAccess,
			Type eType) {
		for (ClassDeclaration __DEC_eTypeAccess_superClass_239652 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!eType.equals(__DEC_eTypeAccess_superClass_239652)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_4B(TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_600864 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_5BB(TypeAccess eTypeAccess,
			Type eType) {
		for (ParameterizedType __DEC_eTypeAccess_type_502244 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			if (!eType.equals(__DEC_eTypeAccess_type_502244)) {
				return new Object[] { eTypeAccess, eType };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_6B(TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_375499 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_7B(TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_5424 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_24_1_matchtggpattern_blackBBBB(ArrayType eArrayType,
			Type eType, Model eModel, TypeAccess eTypeAccess) {
		if (!eArrayType.equals(eType)) {
			if (eTypeAccess.equals(eArrayType.getElementType())) {
				if (eType.equals(eTypeAccess.getType())) {
					if (eModel.getOrphanTypes().contains(eArrayType)) {
											...
											if (pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_5BB(eTypeAccess,
												...
												if (pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_6B(
													...
													if (pattern_ArrayTypeToClass_24_1_matchtggpattern_black_nac_7B(
															eTypeAccess) == null) {
														return new Object[] { eArrayType, eType, eModel, eTypeAccess };
													}
												}
											}
										}
	...
	public static final Object[] pattern_ArrayTypeToClass_26_3_solveCSP_bindingFBBBBBBBBB(ArrayTypeToClass _this,
			IsApplicableMatch isApplicableMatch, Type eType, TypeToTAbstractType eTypeToTArrayClass, Model eModel,
			ModelToTypeGraph eModelToTypeGraph, TAbstractType tArrayClass, TypeGraph typeGraph,
			ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, eType, eTypeToTArrayClass, eModel,
				eModelToTypeGraph, tArrayClass, typeGraph, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph,
					tArrayClass, typeGraph, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_26_3_solveCSP_bindingAndBlackFBBBBBBBBB(
			...
			TypeToTAbstractType eTypeToTArrayClass, Model eModel, ModelToTypeGraph eModelToTypeGraph,
			TAbstractType tArrayClass, TypeGraph typeGraph, ModelgeneratorRuleResult ruleResult) {
		Object[] result_pattern_ArrayTypeToClass_26_3_solveCSP_binding = pattern_ArrayTypeToClass_26_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, tArrayClass, typeGraph,
				ruleResult);
		if (result_pattern_ArrayTypeToClass_26_3_solveCSP_binding != null) {
			...
			if (result_pattern_ArrayTypeToClass_26_3_solveCSP_black != null) {
				...
				return new Object[] { csp, _this, isApplicableMatch, eType, eTypeToTArrayClass, eModel,
						eModelToTypeGraph, tArrayClass, typeGraph, ruleResult };
			}
		}
		return null;
	...
	public static final Object[] pattern_ArrayTypeToClass_26_5_checknacs_blackBBBBBB(Type eType,
			TypeToTAbstractType eTypeToTArrayClass, Model eModel, ModelToTypeGraph eModelToTypeGraph,
			TAbstractType tArrayClass, TypeGraph typeGraph) {
		return new Object[] { eType, eTypeToTArrayClass, eModel, eModelToTypeGraph, tArrayClass, typeGraph };
	}
	...
	public static final Object[] pattern_ArrayTypeToClass_26_6_perform_greenFBBFB(Type eType, Model eModel,
			ModelgeneratorRuleResult ruleResult) {
		...
		return new Object[] { eArrayType, eType, eModel, eTypeAccess, ruleResult };
	}
