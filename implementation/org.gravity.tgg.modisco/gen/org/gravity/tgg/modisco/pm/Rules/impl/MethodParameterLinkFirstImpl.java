...
public class MethodParameterLinkFirstImpl extends AbstractRuleImpl implements MethodParameterLinkFirst {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodParameterLinkFirstImpl
				.pattern_MethodParameterLinkFirst_1_3_bookkeepingforedges_blackBBBBBBB(ruleresult,
						eSingleVariableDeclarationToTParameter, tMethodSignature, mParameterList, mEntry, tParameter,
		...
		MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_1_3_bookkeepingforedges_greenBBBBBFF(ruleresult,
				tMethodSignature, mParameterList, mEntry, tParameter);
		...
		MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_1_5_registerobjects_expressionBBBBBBBB(this,
				ruleresult, eSingleVariableDeclarationToTParameter, tMethodSignature, mParameterList, mEntry,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MethodParameterLinkFirstImpl
				.pattern_MethodParameterLinkFirst_2_2_corematch_blackFFBBFFB(mParameterList, mEntry, match)) {
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			MMethodSignature mParameterList, MEntry mEntry, TParameter tParameter,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eSingleVariableDeclarationToTParameter,
			EObject tMethodSignature, EObject mParameterList, EObject mEntry, EObject tParameter,
			...
			for (Object[] result3_black : MethodParameterLinkFirstImpl
				...
				Object[] result4_bindingAndBlack = MethodParameterLinkFirstImpl
						.pattern_MethodParameterLinkFirst_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, eSingleVariableDeclarationToTParameter, tMethodSignature,
								mParameterList, mEntry, tParameter, mmethodSignatureToTMethodSignature);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", "
							+ "[eSingleVariableDeclarationToTParameter] = " + eSingleVariableDeclarationToTParameter
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_46(EMoflonEdge _edge_mFirstEntry) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MethodParameterLinkFirstImpl
				.pattern_MethodParameterLinkFirst_24_3_solvecsp_bindingAndBlackFBBBBBBB(this, tMethodSignature,
						mParameterList, mEntry, tParameter, sourceMatch, targetMatch);
		...
		if (MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodParameterLinkFirstImpl
					.pattern_MethodParameterLinkFirst_24_5_matchcorrcontext_blackFBBBBFBB(tMethodSignature,
							mParameterList, mEntry, tParameter, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = MethodParameterLinkFirstImpl
						.pattern_MethodParameterLinkFirst_24_6_createcorrespondence_blackBBBBB(tMethodSignature,
								mParameterList, mEntry, tParameter, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodSignature] = "
							+ tMethodSignature + ", " + "[mParameterList] = " + mParameterList + ", " + "[mEntry] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMethodSignature tMethodSignature, MMethodSignature mParameterList,
			...
			if (MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					MethodParameterLinkFirstImpl.pattern_MethodParameterLinkFirst_29_6_perform_greenBBBBB(
							tMethodSignature, mParameterList, mEntry, tParameter, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_TMETHODSIGNATURE_MMETHODSIGNATURE_MENTRY_TPARAMETER_MSIGNATURETOTSIGNATURE:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(MEntryToTParameter) arguments.get(1), (TMethodSignature) arguments.get(2),
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_TMETHODSIGNATURE_MMETHODSIGNATURE_MENTRY_TPARAMETER_MSIGNATURETOTSIGNATURE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPROPRIATE_FWD_EMOFLON_EDGE_46__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___IS_APPLICABLE_SOLVE_CSP_CC__TMETHODSIGNATURE_MMETHODSIGNATURE_MENTRY_TPARAMETER_MATCH_MATCH:
		...
		case RulesPackage.METHOD_PARAMETER_LINK_FIRST___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_MENTRYTOTPARAMETER_TMETHODSIGNATURE_MMETHODSIGNATURE_MENTRY_TPARAMETER_MSIGNATURETOTSIGNATURE_MODELGENERATORRULERESULT:
					...
					if (tmpMEntry instanceof MEntry) {
						...
						if (tmpTParameter instanceof TParameter) {
							...
							if (tmpMmethodSignatureToTMethodSignature instanceof MSignatureToTSignature) {
								...
								return new Object[] { eSingleVariableDeclarationToTParameter, tMethodSignature,
										mParameterList, mEntry, tParameter, mmethodSignatureToTMethodSignature,
										isApplicableMatch };
							}
						}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_1_performtransformation_blackBBBBBBFBB(
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { eSingleVariableDeclarationToTParameter, tMethodSignature, mParameterList, mEntry,
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_3_bookkeepingforedges_blackBBBBBBB(
			PerformRuleResult ruleresult, EObject eSingleVariableDeclarationToTParameter, EObject tMethodSignature,
			EObject mParameterList, EObject mEntry, EObject tParameter, EObject mmethodSignatureToTMethodSignature) {
	...
	public static final Object[] pattern_MethodParameterLinkFirst_1_3_bookkeepingforedges_greenBBBBBFF(
			PerformRuleResult ruleresult, EObject tMethodSignature, EObject mParameterList, EObject mEntry,
			EObject tParameter) {
		EMoflonEdge mParameterList__mEntry____mFirstEntry = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, tMethodSignature, mParameterList, mEntry, tParameter,
	...
	public static final void pattern_MethodParameterLinkFirst_1_5_registerobjects_expressionBBBBBBBB(
			...
			EObject mEntry, EObject tParameter, EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_FWD(ruleresult, eSingleVariableDeclarationToTParameter, tMethodSignature, mParameterList,
	...
	public static final Iterable<Object[]> pattern_MethodParameterLinkFirst_2_2_corematch_blackFFBBFFB(
		...
		for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tParameter != null) {
				for (MSignatureToTSignature mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTMethodSignature instanceof TMethodSignature) {
						TMethodSignature tMethodSignature = (TMethodSignature) tmpTMethodSignature;
						_result.add(new Object[] { eSingleVariableDeclarationToTParameter, tMethodSignature,
								mParameterList, mEntry, tParameter, mmethodSignatureToTMethodSignature, match });
					}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingFBBBBBBBB(
		...
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eSingleVariableDeclarationToTParameter,
					tMethodSignature, mParameterList, mEntry, tParameter, mmethodSignatureToTMethodSignature };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLinkFirst_2_4_solveCSP_binding = pattern_MethodParameterLinkFirst_2_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eSingleVariableDeclarationToTParameter, tMethodSignature, mParameterList,
				mEntry, tParameter, mmethodSignatureToTMethodSignature);
	...
	public static final void pattern_MethodParameterLinkFirst_11_5_registerobjects_expressionBBBBBBBB(
			...
			EObject eSingleVariableDeclarationToTParameter, EObject tMethodSignature, EObject mParameterList,
			EObject mEntry, EObject tParameter, EObject mmethodSignatureToTMethodSignature) {
		_this.registerObjects_BWD(ruleresult, eSingleVariableDeclarationToTParameter, tMethodSignature, mParameterList,
				mEntry, tParameter, mmethodSignatureToTMethodSignature);
		...
		if (tmpTMethodSignature instanceof TMethodSignature) {
			...
			if (tmpMParameterList instanceof MMethodSignature) {
				...
				if (tmpMEntry instanceof MEntry) {
					...
					if (tmpTParameter instanceof TParameter) {
						TParameter tParameter = (TParameter) tmpTParameter;
						return new Object[] { tMethodSignature, mParameterList, mEntry, tParameter, targetMatch,
								sourceMatch };
					}
				}
			}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_24_2_matchsrctrgcontext_blackBBBBBB(
			TMethodSignature tMethodSignature, MMethodSignature mParameterList, MEntry mEntry, TParameter tParameter,
			Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMethodSignature, mParameterList, mEntry, tParameter, sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_24_2_matchsrctrgcontext_bindingAndBlackFFFFBB(
		...
		if (result_pattern_MethodParameterLinkFirst_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MethodParameterLinkFirst_24_2_matchsrctrgcontext_black = pattern_MethodParameterLinkFirst_24_2_matchsrctrgcontext_blackBBBBBB(
					tMethodSignature, mParameterList, mEntry, tParameter, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MethodParameterLinkFirst_24_3_solvecsp_bindingFBBBBBBB(
			MethodParameterLinkFirst _this, TMethodSignature tMethodSignature, MMethodSignature mParameterList,
			MEntry mEntry, TParameter tParameter, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_4 = _this.isApplicable_solveCsp_CC(tMethodSignature, mParameterList, mEntry, tParameter,
				sourceMatch, targetMatch);
		CSP csp = _localVariable_4;
		if (csp != null) {
			return new Object[] { csp, _this, tMethodSignature, mParameterList, mEntry, tParameter, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_24_3_solvecsp_bindingAndBlackFBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLinkFirst_24_3_solvecsp_binding = pattern_MethodParameterLinkFirst_24_3_solvecsp_bindingFBBBBBBB(
				_this, tMethodSignature, mParameterList, mEntry, tParameter, sourceMatch, targetMatch);
			...
			for (MEntryToTParameter eSingleVariableDeclarationToTParameter : org.moflon.core.utilities.eMoflonEMFUtil
				...
				if (tParameter.equals(eSingleVariableDeclarationToTParameter.getTarget())) {
					for (MSignatureToTSignature mmethodSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (mParameterList.equals(mmethodSignatureToTMethodSignature.getSource())) {
							_result.add(new Object[] { eSingleVariableDeclarationToTParameter, tMethodSignature,
									mParameterList, mEntry, tParameter, mmethodSignatureToTMethodSignature, sourceMatch,
									targetMatch });
						}
					}
				}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_24_6_createcorrespondence_blackBBBBB(
			TMethodSignature tMethodSignature, MMethodSignature mParameterList, MEntry mEntry, TParameter tParameter,
			CCMatch ccMatch) {
		return new Object[] { tMethodSignature, mParameterList, mEntry, tParameter, ccMatch };
	}
	...
	public static final Object[] pattern_MethodParameterLinkFirst_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MethodParameterLinkFirst_29_3_solveCSP_binding = pattern_MethodParameterLinkFirst_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eSingleVariableDeclarationToTParameter, tMethodSignature, mParameterList,
				mEntry, tParameter, mmethodSignatureToTMethodSignature, ruleResult);
	...
	public static final Object[] pattern_MethodParameterLinkFirst_29_6_perform_greenBBBBB(
		...
		return new Object[] { tMethodSignature, mParameterList, mEntry, tParameter, ruleResult };
	}
