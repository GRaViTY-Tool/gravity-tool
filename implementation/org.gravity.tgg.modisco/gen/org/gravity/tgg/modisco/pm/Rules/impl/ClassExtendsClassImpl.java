...
public class ClassExtendsClassImpl extends AbstractRuleImpl implements ClassExtendsClass {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result1_bindingAndBlack[0];
		...
		Object[] result3_black = ClassExtendsClassImpl.pattern_ClassExtendsClass_1_3_bookkeepingforedges_blackBBBBBBBB(
				ruleresult, eClassDeclarationToTClass, eTypeAccess, eExtendedClassToTExtendedClass, eClassDeclaration,
				tClass, tExtendedClass, eExtendedClass);
		...
		ClassExtendsClassImpl.pattern_ClassExtendsClass_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				eTypeAccess, eClassDeclaration, tClass, tExtendedClass, eExtendedClass);
		...
		ClassExtendsClassImpl.pattern_ClassExtendsClass_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult,
				eClassDeclarationToTClass, eTypeAccess, eExtendedClassToTExtendedClass, eClassDeclaration, tClass,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : ClassExtendsClassImpl.pattern_ClassExtendsClass_2_2_corematch_blackFBFBFFBB(
			...
			ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result2_black[0];
			...
			for (Object[] result3_black : ClassExtendsClassImpl.pattern_ClassExtendsClass_2_3_findcontext_blackBBBBBBB(
				...
				Object[] result3_green = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_2_3_findcontext_greenBBBBBBBFFFFFFFF(eClassDeclarationToTClass,
								eTypeAccess, eExtendedClassToTExtendedClass, eClassDeclaration, tClass, tExtendedClass,
								eExtendedClass);
				...
				Object[] result4_bindingAndBlack = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								eClassDeclarationToTClass, eTypeAccess, eExtendedClassToTExtendedClass,
								eClassDeclaration, tClass, tExtendedClass, eExtendedClass);
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch,
			...
			ClassDeclarationToTClass eExtendedClassToTExtendedClass, ClassDeclaration eClassDeclaration, TClass tClass,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eClassDeclarationToTClass,
			EObject eTypeAccess, EObject eExtendedClassToTExtendedClass, EObject eClassDeclaration, EObject tClass,
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : ClassExtendsClassImpl
				.pattern_ClassExtendsClass_12_2_corematch_blackFFFBBFB(tClass, tExtendedClass, match)) {
			ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result2_black[0];
			...
			for (Object[] result3_black : ClassExtendsClassImpl.pattern_ClassExtendsClass_12_3_findcontext_blackBBBBBB(
					eClassDeclarationToTClass, eExtendedClassToTExtendedClass, eClassDeclaration, tClass,
					tExtendedClass, eExtendedClass)) {
				Object[] result3_green = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_12_3_findcontext_greenBBBBBBFFFFFFF(eClassDeclarationToTClass,
								eExtendedClassToTExtendedClass, eClassDeclaration, tClass, tExtendedClass,
								eExtendedClass);
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch,
			...
			ClassDeclaration eClassDeclaration, TClass tClass, TClass tExtendedClass, ClassDeclaration eExtendedClass) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_85(EMoflonEdge _edge_parentClass) {
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_89(EMoflonEdge _edge_type) {
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = ClassExtendsClassImpl
				.pattern_ClassExtendsClass_24_3_solvecsp_bindingAndBlackFBBBBBBBB(this, eTypeAccess, eClassDeclaration,
						tClass, tExtendedClass, eExtendedClass, sourceMatch, targetMatch);
		...
		if (ClassExtendsClassImpl.pattern_ClassExtendsClass_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : ClassExtendsClassImpl
					.pattern_ClassExtendsClass_24_5_matchcorrcontext_blackFFBBBBBB(eClassDeclaration, tClass,
							tExtendedClass, eExtendedClass, sourceMatch, targetMatch)) {
				ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result5_black[0];
				...
				Object[] result6_black = ClassExtendsClassImpl
						.pattern_ClassExtendsClass_24_6_createcorrespondence_blackBBBBBB(eTypeAccess, eClassDeclaration,
								tClass, tExtendedClass, eExtendedClass, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eTypeAccess] = "
							+ eTypeAccess + ", " + "[eClassDeclaration] = " + eClassDeclaration + ", " + "[tClass] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, TClass tClass,
		...
		for (Object[] result2_black : ClassExtendsClassImpl
			...
			if (ClassExtendsClassImpl.pattern_ClassExtendsClass_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					ClassExtendsClassImpl.pattern_ClassExtendsClass_29_6_perform_greenFBBBBB(eClassDeclaration, tClass,
							tExtendedClass, eExtendedClass, ruleResult);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_CLASSDECLARATIONTOTCLASS_TYPEACCESS_CLASSDECLARATIONTOTCLASS_CLASSDECLARATION_TCLASS_TCLASS_CLASSDECLARATION:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(ClassDeclarationToTClass) arguments.get(1), (TypeAccess) arguments.get(2),
					(ClassDeclarationToTClass) arguments.get(3), (ClassDeclaration) arguments.get(4),
					(TClass) arguments.get(5), (TClass) arguments.get(6), (ClassDeclaration) arguments.get(7));
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATIONTOTCLASS_CLASSDECLARATIONTOTCLASS_CLASSDECLARATION_TCLASS_TCLASS_CLASSDECLARATION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(ClassDeclarationToTClass) arguments.get(1), (ClassDeclarationToTClass) arguments.get(2),
					(ClassDeclaration) arguments.get(3), (TClass) arguments.get(4), (TClass) arguments.get(5),
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPROPRIATE_BWD_EMOFLON_EDGE_85__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_85((EMoflonEdge) arguments.get(0));
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPROPRIATE_FWD_EMOFLON_EDGE_89__EMOFLONEDGE:
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___IS_APPLICABLE_SOLVE_CSP_CC__TYPEACCESS_CLASSDECLARATION_TCLASS_TCLASS_CLASSDECLARATION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TypeAccess) arguments.get(0), (ClassDeclaration) arguments.get(1),
					(TClass) arguments.get(2), (TClass) arguments.get(3), (ClassDeclaration) arguments.get(4),
		...
		case RulesPackage.CLASS_EXTENDS_CLASS___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_CLASSDECLARATIONTOTCLASS_CLASSDECLARATIONTOTCLASS_CLASSDECLARATION_TCLASS_TCLASS_CLASSDECLARATION_MODELGENERATORRULERESULT:
						...
						if (tmpTClass instanceof TClass) {
							...
							if (tmpTExtendedClass instanceof TClass) {
								...
								if (tmpEExtendedClass instanceof ClassDeclaration) {
									...
									return new Object[] { eClassDeclarationToTClass, eTypeAccess,
											eExtendedClassToTExtendedClass, eClassDeclaration, tClass, tExtendedClass,
				...
				if (!tClass.equals(tExtendedClass)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							...
							return new Object[] { eClassDeclarationToTClass, eTypeAccess,
									eExtendedClassToTExtendedClass, eClassDeclaration, tClass, tExtendedClass,
									eExtendedClass, csp, _this, isApplicableMatch };
						}
					}
				}
			}
	...
	public static final Object[] pattern_ClassExtendsClass_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_ClassExtendsClass_1_1_performtransformation_binding != null) {
			ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result_pattern_ClassExtendsClass_1_1_performtransformation_binding[0];
			TypeAccess eTypeAccess = (TypeAccess) result_pattern_ClassExtendsClass_1_1_performtransformation_binding[1];
			ClassDeclarationToTClass eExtendedClassToTExtendedClass = (ClassDeclarationToTClass) result_pattern_ClassExtendsClass_1_1_performtransformation_binding[2];
			ClassDeclaration eClassDeclaration = (ClassDeclaration) result_pattern_ClassExtendsClass_1_1_performtransformation_binding[3];
			TClass tClass = (TClass) result_pattern_ClassExtendsClass_1_1_performtransformation_binding[4];
			...
			if (result_pattern_ClassExtendsClass_1_1_performtransformation_black != null) {
				...
				return new Object[] { eClassDeclarationToTClass, eTypeAccess, eExtendedClassToTExtendedClass,
						eClassDeclaration, tClass, tExtendedClass, eExtendedClass, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_1_3_bookkeepingforedges_blackBBBBBBBB(
			PerformRuleResult ruleresult, EObject eClassDeclarationToTClass, EObject eTypeAccess,
			EObject eExtendedClassToTExtendedClass, EObject eClassDeclaration, EObject tClass, EObject tExtendedClass,
	...
	public static final Object[] pattern_ClassExtendsClass_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject eTypeAccess, EObject eClassDeclaration, EObject tClass,
			EObject tExtendedClass, EObject eExtendedClass) {
		EMoflonEdge eTypeAccess__eExtendedClass____type = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eExtendedClass__eTypeAccess____usagesInTypeAccess = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge eClassDeclaration__eTypeAccess____superClass = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, eTypeAccess, eClassDeclaration, tClass, tExtendedClass, eExtendedClass,
				eTypeAccess__eExtendedClass____type, eExtendedClass__eTypeAccess____usagesInTypeAccess,
	...
	public static final void pattern_ClassExtendsClass_1_5_registerobjects_expressionBBBBBBBBB(ClassExtendsClass _this,
			...
			EObject eExtendedClassToTExtendedClass, EObject eClassDeclaration, EObject tClass, EObject tExtendedClass,
			EObject eExtendedClass) {
		_this.registerObjects_FWD(ruleresult, eClassDeclarationToTClass, eTypeAccess, eExtendedClassToTExtendedClass,
				eClassDeclaration, tClass, tExtendedClass, eExtendedClass);
	...
	public static final Iterable<Object[]> pattern_ClassExtendsClass_2_2_corematch_blackFBFBFFBB(TypeAccess eTypeAccess,
					...
					for (ClassDeclarationToTClass eExtendedClassToTExtendedClass : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eClassDeclarationToTClass.equals(eExtendedClassToTExtendedClass)) {
							...
							if (tExtendedClass != null) {
								if (!tClass.equals(tExtendedClass)) {
									_result.add(new Object[] { eClassDeclarationToTClass, eTypeAccess,
											eExtendedClassToTExtendedClass, eClassDeclaration, tClass, tExtendedClass,
								...
								if (tClass.equals(eClassDeclarationToTClass.getTarget())) {
									if (eExtendedClass.equals(eExtendedClassToTExtendedClass.getSource())) {
										if (tExtendedClass.equals(eExtendedClassToTExtendedClass.getTarget())) {
											_result.add(new Object[] { eClassDeclarationToTClass, eTypeAccess,
													eExtendedClassToTExtendedClass, eClassDeclaration, tClass,
													tExtendedClass, eExtendedClass });
										}
									}
								}
	...
	public static final Object[] pattern_ClassExtendsClass_2_3_findcontext_greenBBBBBBBFFFFFFFF(
		...
		return new Object[] { eClassDeclarationToTClass, eTypeAccess, eExtendedClassToTExtendedClass, eClassDeclaration,
				tClass, tExtendedClass, eExtendedClass, isApplicableMatch, eTypeAccess__eExtendedClass____type,
				eExtendedClass__eTypeAccess____usagesInTypeAccess,
	...
	public static final Object[] pattern_ClassExtendsClass_2_4_solveCSP_bindingFBBBBBBBBB(ClassExtendsClass _this,
			IsApplicableMatch isApplicableMatch, ClassDeclarationToTClass eClassDeclarationToTClass,
			TypeAccess eTypeAccess, ClassDeclarationToTClass eExtendedClassToTExtendedClass,
			ClassDeclaration eClassDeclaration, TClass tClass, TClass tExtendedClass, ClassDeclaration eExtendedClass) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, eClassDeclarationToTClass,
				eTypeAccess, eExtendedClassToTExtendedClass, eClassDeclaration, tClass, tExtendedClass, eExtendedClass);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eClassDeclarationToTClass, eTypeAccess,
					eExtendedClassToTExtendedClass, eClassDeclaration, tClass, tExtendedClass, eExtendedClass };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ClassExtendsClass_2_4_solveCSP_binding = pattern_ClassExtendsClass_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eClassDeclarationToTClass, eTypeAccess, eExtendedClassToTExtendedClass,
				eClassDeclaration, tClass, tExtendedClass, eExtendedClass);
				...
				if (tmpEClassDeclaration instanceof ClassDeclaration) {
					...
					if (tmpTClass instanceof TClass) {
						...
						if (tmpTExtendedClass instanceof TClass) {
							...
							if (tmpEExtendedClass instanceof ClassDeclaration) {
								ClassDeclaration eExtendedClass = (ClassDeclaration) tmpEExtendedClass;
								return new Object[] { eClassDeclarationToTClass, eExtendedClassToTExtendedClass,
										eClassDeclaration, tClass, tExtendedClass, eExtendedClass, isApplicableMatch };
							}
						}
					}
				}
				...
				if (!tClass.equals(tExtendedClass)) {
					for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
						if (tmpCsp instanceof CSP) {
							CSP csp = (CSP) tmpCsp;
							return new Object[] { eClassDeclarationToTClass, eExtendedClassToTExtendedClass,
									eClassDeclaration, tClass, tExtendedClass, eExtendedClass, csp, _this,
									isApplicableMatch };
						}
					}
				}
	...
	public static final Object[] pattern_ClassExtendsClass_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_ClassExtendsClass_11_1_performtransformation_binding != null) {
			ClassDeclarationToTClass eClassDeclarationToTClass = (ClassDeclarationToTClass) result_pattern_ClassExtendsClass_11_1_performtransformation_binding[0];
			...
			ClassDeclaration eClassDeclaration = (ClassDeclaration) result_pattern_ClassExtendsClass_11_1_performtransformation_binding[2];
			...
			if (result_pattern_ClassExtendsClass_11_1_performtransformation_black != null) {
				...
				return new Object[] { eClassDeclarationToTClass, eExtendedClassToTExtendedClass, eClassDeclaration,
						tClass, tExtendedClass, eExtendedClass, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final void pattern_ClassExtendsClass_11_5_registerobjects_expressionBBBBBBBBB(ClassExtendsClass _this,
			...
			EObject eExtendedClassToTExtendedClass, EObject eClassDeclaration, EObject tClass, EObject tExtendedClass,
			EObject eExtendedClass) {
		_this.registerObjects_BWD(ruleresult, eClassDeclarationToTClass, eTypeAccess, eExtendedClassToTExtendedClass,
				eClassDeclaration, tClass, tExtendedClass, eExtendedClass);
	...
	public static final Iterable<Object[]> pattern_ClassExtendsClass_12_2_corematch_blackFFFBBFB(TClass tClass,
					...
					for (ClassDeclarationToTClass eExtendedClassToTExtendedClass : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (!eClassDeclarationToTClass.equals(eExtendedClassToTExtendedClass)) {
							...
							if (eExtendedClass != null) {
								if (!eClassDeclaration.equals(eExtendedClass)) {
									_result.add(
											new Object[] { eClassDeclarationToTClass, eExtendedClassToTExtendedClass,
													eClassDeclaration, tClass, tExtendedClass, eExtendedClass, match });
								}
							}
	...
	public static final Object[] pattern_ClassExtendsClass_12_3_findcontext_greenBBBBBBFFFFFFF(
		...
		eExtendedClassToTExtendedClass__tExtendedClass____target
				.setName(eExtendedClassToTExtendedClass__tExtendedClass____target_name_prime);
		return new Object[] { eClassDeclarationToTClass, eExtendedClassToTExtendedClass, eClassDeclaration, tClass,
				tExtendedClass, eExtendedClass, isApplicableMatch,
	...
	public static final Object[] pattern_ClassExtendsClass_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_ClassExtendsClass_12_4_solveCSP_binding = pattern_ClassExtendsClass_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, eClassDeclarationToTClass, eExtendedClassToTExtendedClass, eClassDeclaration,
				tClass, tExtendedClass, eExtendedClass);
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_0BBB(
			TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass) {
		if (!eClassDeclaration.equals(eExtendedClass)) {
			for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_754130 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!eClassDeclaration.equals(__DEC_eTypeAccess_superInterfaces_754130)) {
					if (!eExtendedClass.equals(__DEC_eTypeAccess_superInterfaces_754130)) {
						return new Object[] { eTypeAccess, eClassDeclaration, eExtendedClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_1B(
			TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_842766 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_2B(
			TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_677134 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_3B(
			TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_454033 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_469555 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_5B(
			TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_790633 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_6B(
			TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_444525 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_ClassExtendsClass_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_759932 : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpEClassDeclaration instanceof ClassDeclaration) {
				...
				if (tmpTClass instanceof TClass) {
					...
					if (tmpTExtendedClass instanceof TClass) {
						...
						if (tmpEExtendedClass instanceof ClassDeclaration) {
							ClassDeclaration eExtendedClass = (ClassDeclaration) tmpEExtendedClass;
							return new Object[] { eTypeAccess, eClassDeclaration, tClass, tExtendedClass,
		...
		if (!eClassDeclaration.equals(eExtendedClass)) {
			if (!tClass.equals(tExtendedClass)) {
				if (!sourceMatch.equals(targetMatch)) {
					return new Object[] { eTypeAccess, eClassDeclaration, tClass, tExtendedClass, eExtendedClass,
	...
	public static final Object[] pattern_ClassExtendsClass_24_2_matchsrctrgcontext_bindingAndBlackFFFFFBB(
		...
		if (result_pattern_ClassExtendsClass_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_ClassExtendsClass_24_2_matchsrctrgcontext_black = pattern_ClassExtendsClass_24_2_matchsrctrgcontext_blackBBBBBBB(
					eTypeAccess, eClassDeclaration, tClass, tExtendedClass, eExtendedClass, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_ClassExtendsClass_24_3_solvecsp_bindingFBBBBBBBB(ClassExtendsClass _this,
			TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, TClass tClass, TClass tExtendedClass,
			ClassDeclaration eExtendedClass, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_5 = _this.isApplicable_solveCsp_CC(eTypeAccess, eClassDeclaration, tClass, tExtendedClass,
				eExtendedClass, sourceMatch, targetMatch);
		CSP csp = _localVariable_5;
		if (csp != null) {
			return new Object[] { csp, _this, eTypeAccess, eClassDeclaration, tClass, tExtendedClass, eExtendedClass,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_24_3_solvecsp_bindingAndBlackFBBBBBBBB(
			ClassExtendsClass _this, TypeAccess eTypeAccess, ClassDeclaration eClassDeclaration, TClass tClass,
		...
		Object[] result_pattern_ClassExtendsClass_24_3_solvecsp_binding = pattern_ClassExtendsClass_24_3_solvecsp_bindingFBBBBBBBB(
				_this, eTypeAccess, eClassDeclaration, tClass, tExtendedClass, eExtendedClass, sourceMatch,
				targetMatch);
		if (result_pattern_ClassExtendsClass_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_ClassExtendsClass_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, eTypeAccess, eClassDeclaration, tClass, tExtendedClass,
						eExtendedClass, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_ClassExtendsClass_24_5_matchcorrcontext_blackFFBBBBBB(
			ClassDeclaration eClassDeclaration, TClass tClass, TClass tExtendedClass, ClassDeclaration eExtendedClass,
			Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!eClassDeclaration.equals(eExtendedClass)) {
			if (!tClass.equals(tExtendedClass)) {
				if (!sourceMatch.equals(targetMatch)) {
					for (ClassDeclarationToTClass eClassDeclarationToTClass : org.moflon.core.utilities.eMoflonEMFUtil
						...
						if (tClass.equals(eClassDeclarationToTClass.getTarget())) {
							for (ClassDeclarationToTClass eExtendedClassToTExtendedClass : org.moflon.core.utilities.eMoflonEMFUtil
									.getOppositeReferenceTyped(eExtendedClass, ClassDeclarationToTClass.class,
											"source")) {
								if (!eClassDeclarationToTClass.equals(eExtendedClassToTExtendedClass)) {
									if (tExtendedClass.equals(eExtendedClassToTExtendedClass.getTarget())) {
										_result.add(new Object[] { eClassDeclarationToTClass,
	...
	public static final Object[] pattern_ClassExtendsClass_24_6_createcorrespondence_blackBBBBBB(TypeAccess eTypeAccess,
		...
		if (!eClassDeclaration.equals(eExtendedClass)) {
			if (!tClass.equals(tExtendedClass)) {
				return new Object[] { eTypeAccess, eClassDeclaration, tClass, tExtendedClass, eExtendedClass, ccMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_0BBB(TypeAccess eTypeAccess,
			ClassDeclaration eClassDeclaration, ClassDeclaration eExtendedClass) {
		if (!eClassDeclaration.equals(eExtendedClass)) {
			for (AbstractTypeDeclaration __DEC_eTypeAccess_superInterfaces_982496 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(eTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
				if (!eClassDeclaration.equals(__DEC_eTypeAccess_superInterfaces_982496)) {
					if (!eExtendedClass.equals(__DEC_eTypeAccess_superInterfaces_982496)) {
						return new Object[] { eTypeAccess, eClassDeclaration, eExtendedClass };
					}
				}
			}
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_1B(TypeAccess eTypeAccess) {
		for (Annotation __DEC_eTypeAccess_type_547537 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, Annotation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_2B(TypeAccess eTypeAccess) {
		for (ArrayType __DEC_eTypeAccess_elementType_631999 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ArrayType.class, "elementType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_3B(TypeAccess eTypeAccess) {
		for (ClassInstanceCreation __DEC_eTypeAccess_type_750322 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_4B(TypeAccess eTypeAccess) {
		for (MethodDeclaration __DEC_eTypeAccess_returnType_847568 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, MethodDeclaration.class, "returnType")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_5B(TypeAccess eTypeAccess) {
		for (ParameterizedType __DEC_eTypeAccess_type_337501 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, ParameterizedType.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_6B(TypeAccess eTypeAccess) {
		for (TypeLiteral __DEC_eTypeAccess_type_878017 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_27_1_matchtggpattern_black_nac_7B(TypeAccess eTypeAccess) {
		for (AnnotationMemberValuePair __DEC_eTypeAccess_value_836867 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { eTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_ClassExtendsClass_29_3_solveCSP_bindingFBBBBBBBBB(ClassExtendsClass _this,
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, eClassDeclarationToTClass,
				eExtendedClassToTExtendedClass, eClassDeclaration, tClass, tExtendedClass, eExtendedClass, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, eClassDeclarationToTClass,
					eExtendedClassToTExtendedClass, eClassDeclaration, tClass, tExtendedClass, eExtendedClass,
	...
	public static final Object[] pattern_ClassExtendsClass_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_ClassExtendsClass_29_3_solveCSP_binding = pattern_ClassExtendsClass_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, eClassDeclarationToTClass, eExtendedClassToTExtendedClass, eClassDeclaration,
				tClass, tExtendedClass, eExtendedClass, ruleResult);
	...
	public static final Object[] pattern_ClassExtendsClass_29_6_perform_greenFBBBBB(ClassDeclaration eClassDeclaration,
		...
		return new Object[] { eTypeAccess, eClassDeclaration, tClass, tExtendedClass, eExtendedClass, ruleResult };
	}
