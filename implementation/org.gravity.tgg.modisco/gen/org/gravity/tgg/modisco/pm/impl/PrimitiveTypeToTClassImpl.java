 ...
 * <ul>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.PrimitiveTypeToTClassImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.gravity.tgg.modisco.pm.impl.PrimitiveTypeToTClassImpl#getTarget <em>Target</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrimitiveTypeToTClassImpl extends AbstractCorrespondenceImpl implements PrimitiveTypeToTClass {
	...
	protected EClass eStaticClass() {
		return PmPackage.Literals.PRIMITIVE_TYPE_TO_TCLASS;
	}
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.PRIMITIVE_TYPE_TO_TCLASS__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public void setSource(PrimitiveType newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.PRIMITIVE_TYPE_TO_TCLASS__SOURCE, oldSource,
					source));
	}
	...
	public TClass getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PmPackage.PRIMITIVE_TYPE_TO_TCLASS__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public void setTarget(TClass newTarget) {
		...
		target = newTarget;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PmPackage.PRIMITIVE_TYPE_TO_TCLASS__TARGET, oldTarget,
					target));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PmPackage.PRIMITIVE_TYPE_TO_TCLASS__SOURCE:
			if (resolve)
				return getSource();
			return basicGetSource();
		case PmPackage.PRIMITIVE_TYPE_TO_TCLASS__TARGET:
			if (resolve)
				return getTarget();
