...
public class NestedClassInTypeImpl extends AbstractRuleImpl implements NestedClassInType {
	 ...
	 * @generated
	 */
	public boolean isAppropriate_FWD(Match match, MClass eNestedType, AbstractTypeDeclaration eOuterType) {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		MClass eNestedType = (MClass) result1_bindingAndBlack[0];
		...
		Object[] result1_green = NestedClassInTypeImpl
				.pattern_NestedClassInType_1_1_performtransformation_greenBFFBFFBFBB(eNestedType, typeGraph, tOuterType,
						tOuterPackage, csp);
		...
		ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass = (ClassDeclarationToTClass) result1_green[5];
		ASTNodeToTAnnotatable mBodyToTAnnotation = (ASTNodeToTAnnotatable) result1_green[7];

		Object[] result2_black = NestedClassInTypeImpl
				.pattern_NestedClassInType_1_2_collecttranslatedelements_blackBBBBBB(eNestedType, tNestedPackage,
						eNestedTypeToTNestedType, tNestedType, mNestedClassDeclarationToTNestedClass,
						mBodyToTAnnotation);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eNestedType] = " + eNestedType
					...
					+ "[mNestedClassDeclarationToTNestedClass] = " + mNestedClassDeclarationToTNestedClass + ", "
					+ "[mBodyToTAnnotation] = " + mBodyToTAnnotation + ".");
		}
		Object[] result2_green = NestedClassInTypeImpl
				.pattern_NestedClassInType_1_2_collecttranslatedelements_greenFBBBBBB(eNestedType, tNestedPackage,
						eNestedTypeToTNestedType, tNestedType, mNestedClassDeclarationToTNestedClass,
						mBodyToTAnnotation);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = NestedClassInTypeImpl
				.pattern_NestedClassInType_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(ruleresult, eNestedType,
						tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType,
						mNestedClassDeclarationToTNestedClass, tOuterType, eOuterTypeToTOuterInterface,
		...
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ ", " + "[tNestedType] = " + tNestedType + ", " + "[mNestedClassDeclarationToTNestedClass] = "
					+ mNestedClassDeclarationToTNestedClass + ", " + "[tOuterType] = " + tOuterType + ", "
		...
		NestedClassInTypeImpl.pattern_NestedClassInType_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFFFF(
				ruleresult, eNestedType, tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType,
				mNestedClassDeclarationToTNestedClass, tOuterType, mBodyToTAnnotation, eOuterType, tOuterPackage);
		...
		//nothing EMoflonEdge tNestedPackage__tNestedType____ownedTypes = (EMoflonEdge) result3_green[15];
		//nothing EMoflonEdge tNestedType__tNestedPackage____package = (EMoflonEdge) result3_green[16];
		//nothing EMoflonEdge mNestedClassDeclarationToTNestedClass__tNestedType____target = (EMoflonEdge) result3_green[17];
		//nothing EMoflonEdge typeGraph__tNestedType____ownedTypes = (EMoflonEdge) result3_green[18];
		//nothing EMoflonEdge tNestedType__typeGraph____pg = (EMoflonEdge) result3_green[19];
		//nothing EMoflonEdge tOuterType__tNestedType____innerTypes = (EMoflonEdge) result3_green[20];
		//nothing EMoflonEdge tNestedType__tOuterType____outerType = (EMoflonEdge) result3_green[21];
		//nothing EMoflonEdge tNestedPackage__typeGraph____typeGraph = (EMoflonEdge) result3_green[22];
		//nothing EMoflonEdge mBodyToTAnnotation__tNestedType____target = (EMoflonEdge) result3_green[23];
		//nothing EMoflonEdge eNestedType__eOuterType____abstractTypeDeclaration = (EMoflonEdge) result3_green[24];
		//nothing EMoflonEdge eOuterType__eNestedType____bodyDeclarations = (EMoflonEdge) result3_green[25];
		//nothing EMoflonEdge eNestedTypeToTNestedType__eNestedType____source = (EMoflonEdge) result3_green[26];
		//nothing EMoflonEdge typeGraph__tNestedType____classes = (EMoflonEdge) result3_green[27];
		//nothing EMoflonEdge mNestedClassDeclarationToTNestedClass__eNestedType____source = (EMoflonEdge) result3_green[28];
		//nothing EMoflonEdge eNestedTypeToTNestedType__tNestedType____target = (EMoflonEdge) result3_green[29];

		// 
		// 
		NestedClassInTypeImpl.pattern_NestedClassInType_1_5_registerobjects_expressionBBBBBBBBBBBBB(this, ruleresult,
				eNestedType, tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType,
				mNestedClassDeclarationToTNestedClass, tOuterType, eOuterTypeToTOuterInterface, mBodyToTAnnotation,
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		MClass eNestedType = (MClass) result2_binding[0];
	 ...
	 * @generated
	 */
	public void registerObjectsToMatch_FWD(Match match, MClass eNestedType, AbstractTypeDeclaration eOuterType) {
	 ...
	 * @generated
	 */
	public CSP isAppropriate_solveCsp_FWD(Match match, MClass eNestedType, AbstractTypeDeclaration eOuterType) {// Create CSP
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, MClass eNestedType, TypeGraph typeGraph,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage,
		...
		ruleresult.registerObject("mNestedClassDeclarationToTNestedClass", mNestedClassDeclarationToTNestedClass);
	...
	public boolean isAppropriate_BWD(Match match, TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType,
		...
		if (NestedClassInTypeImpl.pattern_NestedClassInType_10_3_CheckCSP_expressionFBB(this, csp)) {
			...
			NestedClassInTypeImpl.pattern_NestedClassInType_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFFF(
					match, tNestedPackage, typeGraph, tNestedType, tOuterType, tOuterPackage);
			//nothing EMoflonEdge tNestedPackage__tNestedType____classes = (EMoflonEdge) result4_green[6];
			//nothing EMoflonEdge tOuterPackage__tNestedPackage____subpackage = (EMoflonEdge) result4_green[7];
			//nothing EMoflonEdge tNestedPackage__tOuterPackage____parent = (EMoflonEdge) result4_green[8];
			//nothing EMoflonEdge tNestedPackage__tNestedType____ownedTypes = (EMoflonEdge) result4_green[9];
			//nothing EMoflonEdge tNestedType__tNestedPackage____package = (EMoflonEdge) result4_green[10];
			//nothing EMoflonEdge typeGraph__tNestedType____ownedTypes = (EMoflonEdge) result4_green[11];
			//nothing EMoflonEdge tNestedType__typeGraph____pg = (EMoflonEdge) result4_green[12];
			//nothing EMoflonEdge tOuterType__tNestedType____innerTypes = (EMoflonEdge) result4_green[13];
			//nothing EMoflonEdge tNestedType__tOuterType____outerType = (EMoflonEdge) result4_green[14];
			//nothing EMoflonEdge tNestedPackage__typeGraph____typeGraph = (EMoflonEdge) result4_green[15];
			//nothing EMoflonEdge typeGraph__tNestedType____classes = (EMoflonEdge) result4_green[16];
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = NestedClassInTypeImpl
				.pattern_NestedClassInType_11_1_performtransformation_greenFFBFFBB(tNestedType, eOuterType, csp);
		MClass eNestedType = (MClass) result1_green[0];
		TypeToTAbstractType eNestedTypeToTNestedType = (TypeToTAbstractType) result1_green[1];
		ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass = (ClassDeclarationToTClass) result1_green[3];
		ASTNodeToTAnnotatable mBodyToTAnnotation = (ASTNodeToTAnnotatable) result1_green[4];

		Object[] result2_black = NestedClassInTypeImpl
				.pattern_NestedClassInType_11_2_collecttranslatedelements_blackBBBBBB(eNestedType, tNestedPackage,
						eNestedTypeToTNestedType, tNestedType, mNestedClassDeclarationToTNestedClass,
						mBodyToTAnnotation);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[eNestedType] = " + eNestedType
		...
		Object[] result2_green = NestedClassInTypeImpl
				.pattern_NestedClassInType_11_2_collecttranslatedelements_greenFBBBBBB(eNestedType, tNestedPackage,
						eNestedTypeToTNestedType, tNestedType, mNestedClassDeclarationToTNestedClass,
						mBodyToTAnnotation);
		PerformRuleResult ruleresult = (PerformRuleResult) result2_green[0];

		Object[] result3_black = NestedClassInTypeImpl
				.pattern_NestedClassInType_11_3_bookkeepingforedges_blackBBBBBBBBBBBB(ruleresult, eNestedType,
						tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType,
						mNestedClassDeclarationToTNestedClass, tOuterType, eOuterTypeToTOuterInterface,
						mBodyToTAnnotation, eOuterType, tOuterPackage);
		if (result3_black == null) {
		...
		NestedClassInTypeImpl.pattern_NestedClassInType_11_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFFFF(
				ruleresult, eNestedType, tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType,
				mNestedClassDeclarationToTNestedClass, tOuterType, mBodyToTAnnotation, eOuterType, tOuterPackage);
		//nothing EMoflonEdge tNestedPackage__tNestedType____classes = (EMoflonEdge) result3_green[11];
		//nothing EMoflonEdge mBodyToTAnnotation__eNestedType____source = (EMoflonEdge) result3_green[12];
		...
		// 
		// 
		NestedClassInTypeImpl.pattern_NestedClassInType_11_5_registerobjects_expressionBBBBBBBBBBBBB(this, ruleresult,
				eNestedType, tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType,
				mNestedClassDeclarationToTNestedClass, tOuterType, eOuterTypeToTOuterInterface, mBodyToTAnnotation,
				eOuterType, tOuterPackage);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : NestedClassInTypeImpl.pattern_NestedClassInType_12_2_corematch_blackBBBBFFBB(
			...
			for (Object[] result3_black : NestedClassInTypeImpl.pattern_NestedClassInType_12_3_findcontext_blackBBBBBBB(
					...
					tOuterPackage)) {
				Object[] result3_green = NestedClassInTypeImpl
						.pattern_NestedClassInType_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFFFFF(tNestedPackage,
								typeGraph, tNestedType, tOuterType, eOuterTypeToTOuterInterface, eOuterType,
								tOuterPackage);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				//nothing EMoflonEdge tNestedPackage__tNestedType____classes = (EMoflonEdge) result3_green[8];
				//nothing EMoflonEdge tOuterPackage__tNestedPackage____subpackage = (EMoflonEdge) result3_green[9];
				//nothing EMoflonEdge tNestedPackage__tOuterPackage____parent = (EMoflonEdge) result3_green[10];
				...
				//nothing EMoflonEdge eOuterTypeToTOuterInterface__eOuterType____source = (EMoflonEdge) result3_green[13];
				//nothing EMoflonEdge typeGraph__tOuterType____ownedTypes = (EMoflonEdge) result3_green[14];
				//nothing EMoflonEdge tOuterType__typeGraph____pg = (EMoflonEdge) result3_green[15];
				...
				//nothing EMoflonEdge tNestedType__tOuterType____outerType = (EMoflonEdge) result3_green[21];
				//nothing EMoflonEdge tNestedPackage__typeGraph____typeGraph = (EMoflonEdge) result3_green[22];
				//nothing EMoflonEdge typeGraph__tNestedType____classes = (EMoflonEdge) result3_green[23];
	 ...
	 * @generated
	 */
	public EObjectContainer isAppropriate_BWD_EMoflonEdge_5(EMoflonEdge _edge_classes) {
		...
		// ForEach 
		for (Object[] result2_black : NestedClassInTypeImpl
				.pattern_NestedClassInType_20_2_testcorematchandDECs_blackFFFFFB(_edge_classes)) {
			...
			if (NestedClassInTypeImpl
					.pattern_NestedClassInType_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(this,
							match, tNestedPackage, typeGraph, tNestedType, tOuterType, tOuterPackage)) {
				// 
				if (NestedClassInTypeImpl
	...
	public EObjectContainer isAppropriate_FWD_EMoflonEdge_5(EMoflonEdge _edge_abstractTypeDeclaration) {
		...
		// ForEach 
		for (Object[] result2_black : NestedClassInTypeImpl
				.pattern_NestedClassInType_21_2_testcorematchandDECs_blackFFB(_edge_abstractTypeDeclaration)) {
			MClass eNestedType = (MClass) result2_black[0];
			...
			// 
			if (NestedClassInTypeImpl
					.pattern_NestedClassInType_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(this,
							match, eNestedType, eOuterType)) {
				// 
				if (NestedClassInTypeImpl
	...
	public AttributeConstraintsRuleResult checkAttributes_FWD(TripleMatch __tripleMatch) {
		...
		eq1.setRuleName("NestedClassInType");
	...
	public AttributeConstraintsRuleResult checkAttributes_BWD(TripleMatch __tripleMatch) {
		...
		addSuffix0.setRuleName("NestedClassInType");
		...
		eq2.setRuleName("NestedClassInType");
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result2_bindingAndBlack = NestedClassInTypeImpl
				.pattern_NestedClassInType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(sourceMatch, targetMatch);
		if (result2_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[sourceMatch] = " + sourceMatch
					+ ", " + "[targetMatch] = " + targetMatch + ".");
		}
		MClass eNestedType = (MClass) result2_bindingAndBlack[0];
		...
		Object[] result3_bindingAndBlack = NestedClassInTypeImpl
				.pattern_NestedClassInType_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(this, eNestedType, tNestedPackage,
						typeGraph, tNestedType, tOuterType, eOuterType, tOuterPackage, sourceMatch, targetMatch);
		...
		// 
		if (NestedClassInTypeImpl.pattern_NestedClassInType_24_4_checkCSP_expressionFB(csp)) {
			// ForEach 
			for (Object[] result5_black : NestedClassInTypeImpl
					.pattern_NestedClassInType_24_5_matchcorrcontext_blackBFBBB(tOuterType, eOuterType, sourceMatch,
							targetMatch)) {
				TypeToTAbstractType eOuterTypeToTOuterInterface = (TypeToTAbstractType) result5_black[1];
				Object[] result5_green = NestedClassInTypeImpl
						.pattern_NestedClassInType_24_5_matchcorrcontext_greenBBBF(eOuterTypeToTOuterInterface,
								sourceMatch, targetMatch);
				CCMatch ccMatch = (CCMatch) result5_green[3];

				Object[] result6_black = NestedClassInTypeImpl
						.pattern_NestedClassInType_24_6_createcorrespondence_blackBBBBBBBB(eNestedType, tNestedPackage,
								typeGraph, tNestedType, tOuterType, eOuterType, tOuterPackage, ccMatch);
				if (result6_black == null) {
				...
				NestedClassInTypeImpl.pattern_NestedClassInType_24_6_createcorrespondence_greenBFBFFB(eNestedType,
						tNestedType, ccMatch);
				//nothing TypeToTAbstractType eNestedTypeToTNestedType = (TypeToTAbstractType) result6_green[1];
				//nothing ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass = (ClassDeclarationToTClass) result6_green[3];
				//nothing ASTNodeToTAnnotatable mBodyToTAnnotation = (ASTNodeToTAnnotatable) result6_green[4];

				Object[] result7_black = NestedClassInTypeImpl
						.pattern_NestedClassInType_24_7_addtoreturnedresult_blackBB(result, ccMatch);
				if (result7_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[result] = " + result
							+ ", " + "[ccMatch] = " + ccMatch + ".");
				}
				NestedClassInTypeImpl.pattern_NestedClassInType_24_7_addtoreturnedresult_greenBB(result, ccMatch);

			}

		} else {
		}
		return NestedClassInTypeImpl.pattern_NestedClassInType_24_8_expressionFB(result);
	}
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(MClass eNestedType, TPackage tNestedPackage, TypeGraph typeGraph,
	 ...
	 * @generated
	 */
	public boolean checkDEC_FWD(MClass eNestedType, AbstractTypeDeclaration eOuterType) {// 
		...
		for (Object[] result2_black : NestedClassInTypeImpl
			...
			if (NestedClassInTypeImpl.pattern_NestedClassInType_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					NestedClassInTypeImpl.pattern_NestedClassInType_29_6_perform_greenFFFBFFBFBBBB(typeGraph,
							tOuterType, eOuterType, tOuterPackage, ruleResult, csp);
					//nothing MClass eNestedType = (MClass) result6_green[0];
					...
					//nothing ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass = (ClassDeclarationToTClass) result6_green[5];
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPROPRIATE_FWD__MATCH_MCLASS_ABSTRACTTYPEDECLARATION:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___REGISTER_OBJECTS_TO_MATCH_FWD__MATCH_MCLASS_ABSTRACTTYPEDECLARATION:
			registerObjectsToMatch_FWD((Match) arguments.get(0), (MClass) arguments.get(1),
					(AbstractTypeDeclaration) arguments.get(2));
			return null;
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPROPRIATE_SOLVE_CSP_FWD__MATCH_MCLASS_ABSTRACTTYPEDECLARATION:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_MCLASS_TYPEGRAPH_TABSTRACTTYPE_TYPETOTABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___REGISTER_OBJECTS_FWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___REGISTER_OBJECTS_BWD__PERFORMRULERESULT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT_EOBJECT:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_5__EMOFLONEDGE:
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__MCLASS_TPACKAGE_TYPEGRAPH_TCLASS_TABSTRACTTYPE_ABSTRACTTYPEDECLARATION_TPACKAGE_MATCH_MATCH:
			return isApplicable_solveCsp_CC((MClass) arguments.get(0), (TPackage) arguments.get(1),
					(TypeGraph) arguments.get(2), (TClass) arguments.get(3), (TAbstractType) arguments.get(4),
		...
		case RulesPackage.NESTED_CLASS_IN_TYPE___CHECK_DEC_FWD__MCLASS_ABSTRACTTYPEDECLARATION:
	...
	public static final Object[] pattern_NestedClassInType_0_1_initialbindings_blackBBBB(NestedClassInType _this,
			Match match, MClass eNestedType, AbstractTypeDeclaration eOuterType) {
	...
	public static final Object[] pattern_NestedClassInType_0_4_collectelementstobetranslated_blackBBB(Match match,
			MClass eNestedType, AbstractTypeDeclaration eOuterType) {
		if (!eNestedType.equals(eOuterType)) {
	...
	public static final void pattern_NestedClassInType_0_6_registerobjectstomatch_expressionBBBB(
			NestedClassInType _this, Match match, MClass eNestedType, AbstractTypeDeclaration eOuterType) {
	...
	public static final Object[] pattern_NestedClassInType_1_1_performtransformation_bindingFFFFFFB(
		...
		if (tmpENestedType instanceof MClass) {
			MClass eNestedType = (MClass) tmpENestedType;
	...
	public static final Object[] pattern_NestedClassInType_1_1_performtransformation_blackBBBBBBFBB(MClass eNestedType,
			TypeGraph typeGraph, TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage, NestedClassInType _this,
			IsApplicableMatch isApplicableMatch) {
		if (!eNestedType.equals(eOuterType)) {
	...
	public static final Object[] pattern_NestedClassInType_1_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_NestedClassInType_1_1_performtransformation_binding != null) {
			MClass eNestedType = (MClass) result_pattern_NestedClassInType_1_1_performtransformation_binding[0];
	...
	public static final Object[] pattern_NestedClassInType_1_1_performtransformation_greenBFFBFFBFBB(MClass eNestedType,
			TypeGraph typeGraph, TAbstractType tOuterType, TPackage tOuterPackage, CSP csp) {
		...
		ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass = PmFactory.eINSTANCE
				.createClassDeclarationToTClass();
		...
		mNestedClassDeclarationToTNestedClass.setTarget(tNestedType);
		mNestedClassDeclarationToTNestedClass.setSource(eNestedType);
		...
		return new Object[] { eNestedType, tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType,
				mNestedClassDeclarationToTNestedClass, tOuterType, mBodyToTAnnotation, tOuterPackage, csp };
	}

	public static final Object[] pattern_NestedClassInType_1_2_collecttranslatedelements_blackBBBBBB(MClass eNestedType,
			TPackage tNestedPackage, TypeToTAbstractType eNestedTypeToTNestedType, TClass tNestedType,
			ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass, ASTNodeToTAnnotatable mBodyToTAnnotation) {
		return new Object[] { eNestedType, tNestedPackage, eNestedTypeToTNestedType, tNestedType,
				mNestedClassDeclarationToTNestedClass, mBodyToTAnnotation };
	}

	public static final Object[] pattern_NestedClassInType_1_2_collecttranslatedelements_greenFBBBBBB(
			MClass eNestedType, TPackage tNestedPackage, TypeToTAbstractType eNestedTypeToTNestedType,
			TClass tNestedType, ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass,
		...
		ruleresult.getCreatedLinkElements().add(mNestedClassDeclarationToTNestedClass);
	...
	public static final Object[] pattern_NestedClassInType_1_3_bookkeepingforedges_blackBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage, EObject eNestedTypeToTNestedType,
			EObject typeGraph, EObject tNestedType, EObject mNestedClassDeclarationToTNestedClass, EObject tOuterType,
			...
			if (!eNestedType.equals(eNestedTypeToTNestedType)) {
				if (!eNestedType.equals(typeGraph)) {
					if (!eNestedType.equals(tNestedType)) {
						if (!eNestedType.equals(mNestedClassDeclarationToTNestedClass)) {
																	...
																	if (!eNestedTypeToTNestedType.equals(typeGraph)) {
																		if (!eNestedTypeToTNestedType
																			...
																			if (!eNestedTypeToTNestedType.equals(
																					mNestedClassDeclarationToTNestedClass)) {
																				if (!eNestedTypeToTNestedType
																						.equals(tOuterType)) {
																					if (!eNestedTypeToTNestedType
																								...
																								if (!eNestedTypeToTNestedType
																									...
																									if (!tNestedType
																										...
																										if (!tNestedType
																											...
																											if (!tNestedType
																													.equals(tOuterPackage)) {
																												if (!mNestedClassDeclarationToTNestedClass
																																		...
																																		if (!eOuterTypeToTOuterInterface
																																			...
																																			if (!eOuterTypeToTOuterInterface
																																				...
																																				if (!eOuterTypeToTOuterInterface
																																						.equals(tNestedType)) {
																																					if (!eOuterTypeToTOuterInterface
																																							.equals(mNestedClassDeclarationToTNestedClass)) {
																																						if (!eOuterTypeToTOuterInterface
																																								.equals(tOuterType)) {
																																							if (!eOuterTypeToTOuterInterface
																																									.equals(mBodyToTAnnotation)) {
	...
	public static final Object[] pattern_NestedClassInType_1_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage, EObject eNestedTypeToTNestedType,
			EObject typeGraph, EObject tNestedType, EObject mNestedClassDeclarationToTNestedClass, EObject tOuterType,
			EObject mBodyToTAnnotation, EObject eOuterType, EObject tOuterPackage) {
		...
		EMoflonEdge mNestedClassDeclarationToTNestedClass__tNestedType____target = RuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		...
		EMoflonEdge mNestedClassDeclarationToTNestedClass__eNestedType____source = RuntimeFactory.eINSTANCE
				.createEMoflonEdge();
		...
		String mNestedClassDeclarationToTNestedClass__tNestedType____target_name_prime = "target";
		...
		String mNestedClassDeclarationToTNestedClass__eNestedType____source_name_prime = "source";
		...
		mNestedClassDeclarationToTNestedClass__tNestedType____target.setSrc(mNestedClassDeclarationToTNestedClass);
		mNestedClassDeclarationToTNestedClass__tNestedType____target.setTrg(tNestedType);
		ruleresult.getCreatedEdges().add(mNestedClassDeclarationToTNestedClass__tNestedType____target);
		...
		mNestedClassDeclarationToTNestedClass__eNestedType____source.setSrc(mNestedClassDeclarationToTNestedClass);
		mNestedClassDeclarationToTNestedClass__eNestedType____source.setTrg(eNestedType);
		ruleresult.getCreatedEdges().add(mNestedClassDeclarationToTNestedClass__eNestedType____source);
		...
		mNestedClassDeclarationToTNestedClass__tNestedType____target
				.setName(mNestedClassDeclarationToTNestedClass__tNestedType____target_name_prime);
		...
		mNestedClassDeclarationToTNestedClass__eNestedType____source
				.setName(mNestedClassDeclarationToTNestedClass__eNestedType____source_name_prime);
		...
		return new Object[] { ruleresult, eNestedType, tNestedPackage, eNestedTypeToTNestedType, typeGraph, tNestedType,
				...
				mNestedClassDeclarationToTNestedClass__tNestedType____target, typeGraph__tNestedType____ownedTypes,
				tNestedType__typeGraph____pg, tOuterType__tNestedType____innerTypes,
				tNestedType__tOuterType____outerType, tNestedPackage__typeGraph____typeGraph,
				mBodyToTAnnotation__tNestedType____target, eNestedType__eOuterType____abstractTypeDeclaration,
				eOuterType__eNestedType____bodyDeclarations, eNestedTypeToTNestedType__eNestedType____source,
				typeGraph__tNestedType____classes, mNestedClassDeclarationToTNestedClass__eNestedType____source,
				eNestedTypeToTNestedType__tNestedType____target };
	}

	public static final void pattern_NestedClassInType_1_5_registerobjects_expressionBBBBBBBBBBBBB(
		...
		_this.registerObjects_FWD(ruleresult, eNestedType, tNestedPackage, eNestedTypeToTNestedType, typeGraph,
				tNestedType, mNestedClassDeclarationToTNestedClass, tOuterType, eOuterTypeToTOuterInterface,
				mBodyToTAnnotation, eOuterType, tOuterPackage);
	...
	public static final Iterable<Object[]> pattern_NestedClassInType_2_2_corematch_blackBFFBB(MClass eNestedType,
	...
	public static final Iterable<Object[]> pattern_NestedClassInType_2_3_findcontext_blackBFBBBF(MClass eNestedType,
			TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!eNestedType.equals(eOuterType)) {
	...
	public static final Object[] pattern_NestedClassInType_2_3_findcontext_greenBBBBBBFFFFFFFFFF(MClass eNestedType,
			TypeGraph typeGraph, TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
	...
	public static final Object[] pattern_NestedClassInType_2_4_solveCSP_bindingFBBBBBBBB(NestedClassInType _this,
			IsApplicableMatch isApplicableMatch, MClass eNestedType, TypeGraph typeGraph, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
	...
	public static final Object[] pattern_NestedClassInType_2_4_solveCSP_bindingAndBlackFBBBBBBBB(
			NestedClassInType _this, IsApplicableMatch isApplicableMatch, MClass eNestedType, TypeGraph typeGraph,
			TAbstractType tOuterType, TypeToTAbstractType eOuterTypeToTOuterInterface,
			AbstractTypeDeclaration eOuterType, TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedClassInType_10_4_collectelementstobetranslated_greenBBBBBBFFFFFFFFFFF(
			Match match, TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TPackage tOuterPackage) {
		EMoflonEdge tNestedPackage__tNestedType____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge tOuterPackage__tNestedPackage____subpackage = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final Object[] pattern_NestedClassInType_11_1_performtransformation_greenFFBFFBB(TClass tNestedType,
			AbstractTypeDeclaration eOuterType, CSP csp) {
		MClass eNestedType = ModiscoFactory.eINSTANCE.createMClass();
		TypeToTAbstractType eNestedTypeToTNestedType = PmFactory.eINSTANCE.createTypeToTAbstractType();
		ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass = PmFactory.eINSTANCE
				.createClassDeclarationToTClass();
		ASTNodeToTAnnotatable mBodyToTAnnotation = PmFactory.eINSTANCE.createASTNodeToTAnnotatable();
		...
		return new Object[] { eNestedType, eNestedTypeToTNestedType, tNestedType, mNestedClassDeclarationToTNestedClass,
				mBodyToTAnnotation, eOuterType, csp };
	}

	public static final Object[] pattern_NestedClassInType_11_2_collecttranslatedelements_blackBBBBBB(
			MClass eNestedType, TPackage tNestedPackage, TypeToTAbstractType eNestedTypeToTNestedType,
			TClass tNestedType, ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass,
			ASTNodeToTAnnotatable mBodyToTAnnotation) {
		return new Object[] { eNestedType, tNestedPackage, eNestedTypeToTNestedType, tNestedType,
	...
	public static final Object[] pattern_NestedClassInType_11_2_collecttranslatedelements_greenFBBBBBB(
			MClass eNestedType, TPackage tNestedPackage, TypeToTAbstractType eNestedTypeToTNestedType,
			TClass tNestedType, ClassDeclarationToTClass mNestedClassDeclarationToTNestedClass,
			ASTNodeToTAnnotatable mBodyToTAnnotation) {
		PerformRuleResult ruleresult = RuntimeFactory.eINSTANCE.createPerformRuleResult();
	...
	public static final Object[] pattern_NestedClassInType_11_3_bookkeepingforedges_blackBBBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage, EObject eNestedTypeToTNestedType,
			EObject typeGraph, EObject tNestedType, EObject mNestedClassDeclarationToTNestedClass, EObject tOuterType,
			EObject eOuterTypeToTOuterInterface, EObject mBodyToTAnnotation, EObject eOuterType,
			EObject tOuterPackage) {
	...
	public static final Object[] pattern_NestedClassInType_11_3_bookkeepingforedges_greenBBBBBBBBBBBFFFFFFFFFFFFFFFFFFF(
			PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage, EObject eNestedTypeToTNestedType,
			EObject typeGraph, EObject tNestedType, EObject mNestedClassDeclarationToTNestedClass, EObject tOuterType,
			EObject mBodyToTAnnotation, EObject eOuterType, EObject tOuterPackage) {
		EMoflonEdge tNestedPackage__tNestedType____classes = RuntimeFactory.eINSTANCE.createEMoflonEdge();
	...
	public static final void pattern_NestedClassInType_11_5_registerobjects_expressionBBBBBBBBBBBBB(
			NestedClassInType _this, PerformRuleResult ruleresult, EObject eNestedType, EObject tNestedPackage,
			EObject eNestedTypeToTNestedType, EObject typeGraph, EObject tNestedType,
			EObject mNestedClassDeclarationToTNestedClass, EObject tOuterType, EObject eOuterTypeToTOuterInterface,
			EObject mBodyToTAnnotation, EObject eOuterType, EObject tOuterPackage) {
	...
	public static final Object[] pattern_NestedClassInType_12_3_findcontext_greenBBBBBBBFFFFFFFFFFFFFFFFFFF(
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
			TypeToTAbstractType eOuterTypeToTOuterInterface, AbstractTypeDeclaration eOuterType,
			TPackage tOuterPackage) {
		IsApplicableMatch isApplicableMatch = RuntimeFactory.eINSTANCE.createIsApplicableMatch();
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_0BB(
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_231051 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_231051 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_231051)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_231051)) {
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_1BB(
			TPackage tNestedPackage, TypeGraph typeGraph) {
		TypeGraph __DEC_tNestedPackage_packages_457585 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_457585 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_457585)) {
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_2BBB(TClass tNestedType,
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tNestedType_classes_175760 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tNestedType, TPackage.class, "classes")) {
				if (!tNestedPackage.equals(__DEC_tNestedType_classes_175760)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_classes_175760)) {
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_3BB(TClass tNestedType,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_classes_865328 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tNestedType_classes_865328)) {
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_4BBB(TClass tNestedType,
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_724511 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_724511 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_724511)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_724511)) {
						return new Object[] { tNestedType, tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_5BB(TClass tNestedType,
			TAbstractType tOuterType) {
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_564018 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_564018 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_564018)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_564018)) {
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_6BB(TypeGraph typeGraph,
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_7BB(
	...
	public static final Object[] pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_8BB(
			TPackage tOuterPackage, TClass tNestedType) {
	...
	public static final Iterable<Object[]> pattern_NestedClassInType_20_2_testcorematchandDECs_blackFFFFFB(
											...
											if (typeGraph.equals(tOuterPackage.getTypeGraph())) {
												...
												if (tOuterType != null) {
													if (!tNestedType.equals(tOuterType)) {
														if (typeGraph.getOwnedTypes().contains(tOuterType)) {
															if (tOuterPackage.getOwnedTypes().contains(tOuterType)) {
																if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_0BB(
																		tNestedPackage, tOuterPackage) == null) {
																	if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_2BBB(
																			tNestedType, tNestedPackage,
																			tOuterPackage) == null) {
																		if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_4BBB(
																				tNestedType, tNestedPackage,
																				tOuterPackage) == null) {
																			if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_7BB(
																					tOuterPackage,
																					tNestedType) == null) {
																				if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_8BB(
																						tOuterPackage,
																						tNestedType) == null) {
																					if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_1BB(
																							tNestedPackage,
																							typeGraph) == null) {
																						if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_3BB(
																								tNestedType,
																								typeGraph) == null) {
																							if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_6BB(
																									typeGraph,
																									tNestedPackage) == null) {
																								if (pattern_NestedClassInType_20_2_testcorematchandDECs_black_nac_5BB(
																										tNestedType,
																										tOuterType) == null) {
																									_result.add(
																											new Object[] {
	...
	public static final boolean pattern_NestedClassInType_20_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBBBBB(
			NestedClassInType _this, Match match, TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType,
			TAbstractType tOuterType, TPackage tOuterPackage) {
	...
	public static final Object[] pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_0B(MClass eNestedType) {
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_299557 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_299557 != null) {
	...
	public static final Object[] pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_1B(MClass eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_779250 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_2B(MClass eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_978691 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_978691 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_3B(MClass eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_635372 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_NestedClassInType_21_2_testcorematchandDECs_blackFFB(
		...
		if (tmpENestedType instanceof MClass) {
			...
			if (tmpEOuterType instanceof AbstractTypeDeclaration) {
				...
				if (!eNestedType.equals(eOuterType)) {
					if (eOuterType.equals(eNestedType.getAbstractTypeDeclaration())) {
						if (pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_0B(eNestedType) == null) {
							if (pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_1B(eNestedType) == null) {
								if (pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_2B(
										eNestedType) == null) {
									if (pattern_NestedClassInType_21_2_testcorematchandDECs_black_nac_3B(
											eNestedType) == null) {
	...
	public static final boolean pattern_NestedClassInType_21_3_bookkeepingwithgenericisAppropriatemethod_expressionFBBBB(
			NestedClassInType _this, Match match, MClass eNestedType, AbstractTypeDeclaration eOuterType) {
	...
	public static final Object[] pattern_NestedClassInType_24_2_matchsrctrgcontext_bindingFFFFFFFBB(Match sourceMatch,
			Match targetMatch) {
	...
	public static final Object[] pattern_NestedClassInType_24_2_matchsrctrgcontext_blackBBBBBBBBB(MClass eNestedType,
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
	...
	public static final Object[] pattern_NestedClassInType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFFBB(
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding = pattern_NestedClassInType_24_2_matchsrctrgcontext_bindingFFFFFFFBB(
				sourceMatch, targetMatch);
		if (result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding != null) {
			MClass eNestedType = (MClass) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[0];
			TPackage tNestedPackage = (TPackage) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[1];
			TypeGraph typeGraph = (TypeGraph) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[2];
			TClass tNestedType = (TClass) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[3];
			TAbstractType tOuterType = (TAbstractType) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[4];
			AbstractTypeDeclaration eOuterType = (AbstractTypeDeclaration) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[5];
			TPackage tOuterPackage = (TPackage) result_pattern_NestedClassInType_24_2_matchsrctrgcontext_binding[6];

			Object[] result_pattern_NestedClassInType_24_2_matchsrctrgcontext_black = pattern_NestedClassInType_24_2_matchsrctrgcontext_blackBBBBBBBBB(
					eNestedType, tNestedPackage, typeGraph, tNestedType, tOuterType, eOuterType, tOuterPackage,
					sourceMatch, targetMatch);
			if (result_pattern_NestedClassInType_24_2_matchsrctrgcontext_black != null) {
	...
	public static final Object[] pattern_NestedClassInType_24_3_solvecsp_bindingFBBBBBBBBBB(NestedClassInType _this,
			MClass eNestedType, TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType,
	...
	public static final Object[] pattern_NestedClassInType_24_3_solvecsp_blackB(CSP csp) {
		return new Object[] { csp };
	}

	public static final Object[] pattern_NestedClassInType_24_3_solvecsp_bindingAndBlackFBBBBBBBBBB(
			NestedClassInType _this, MClass eNestedType, TPackage tNestedPackage, TypeGraph typeGraph,
			TClass tNestedType, TAbstractType tOuterType, AbstractTypeDeclaration eOuterType, TPackage tOuterPackage,
			Match sourceMatch, Match targetMatch) {
		Object[] result_pattern_NestedClassInType_24_3_solvecsp_binding = pattern_NestedClassInType_24_3_solvecsp_bindingFBBBBBBBBBB(
				_this, eNestedType, tNestedPackage, typeGraph, tNestedType, tOuterType, eOuterType, tOuterPackage,
				sourceMatch, targetMatch);
		if (result_pattern_NestedClassInType_24_3_solvecsp_binding != null) {
			CSP csp = (CSP) result_pattern_NestedClassInType_24_3_solvecsp_binding[0];

			Object[] result_pattern_NestedClassInType_24_3_solvecsp_black = pattern_NestedClassInType_24_3_solvecsp_blackB(
					csp);
			if (result_pattern_NestedClassInType_24_3_solvecsp_black != null) {
	...
	public static final boolean pattern_NestedClassInType_24_4_checkCSP_expressionFB(CSP csp) {
		boolean _localVariable_0 = csp.check();
		boolean _result = Boolean.valueOf(_localVariable_0);
		return _result;
	}

	public static final Iterable<Object[]> pattern_NestedClassInType_24_5_matchcorrcontext_blackBFBBB(
	...
	public static final Object[] pattern_NestedClassInType_24_5_matchcorrcontext_greenBBBF(
			TypeToTAbstractType eOuterTypeToTOuterInterface, Match sourceMatch, Match targetMatch) {
		CCMatch ccMatch = RuntimeFactory.eINSTANCE.createCCMatch();
		String ccMatch_ruleName_prime = "NestedClassInType";
	...
	public static final Object[] pattern_NestedClassInType_24_6_createcorrespondence_blackBBBBBBBB(MClass eNestedType,
			TPackage tNestedPackage, TypeGraph typeGraph, TClass tNestedType, TAbstractType tOuterType,
	...
	public static final Object[] pattern_NestedClassInType_24_6_createcorrespondence_greenBFBFFB(MClass eNestedType,
		...
		mNestedClassDeclarationToTNestedClass.setTarget(tNestedType);
		mNestedClassDeclarationToTNestedClass.setSource(eNestedType);
		ccMatch.getCreateCorr().add(mNestedClassDeclarationToTNestedClass);
		mBodyToTAnnotation.setSource(eNestedType);
		mBodyToTAnnotation.setTarget(tNestedType);
	...
	public static final Object[] pattern_NestedClassInType_24_7_addtoreturnedresult_blackBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
		return new Object[] { result, ccMatch };
	}

	public static final Object[] pattern_NestedClassInType_24_7_addtoreturnedresult_greenBB(
			IsApplicableRuleResult result, CCMatch ccMatch) {
	...
	public static final IsApplicableRuleResult pattern_NestedClassInType_24_8_expressionFB(
			IsApplicableRuleResult result) {
		IsApplicableRuleResult _result = result;
		return _result;
	}

	public static final Object[] pattern_NestedClassInType_27_1_matchtggpattern_black_nac_0B(MClass eNestedType) {
		AnonymousClassDeclaration __DEC_eNestedType_anonymousClassDeclarationOwner_881826 = eNestedType
				.getAnonymousClassDeclarationOwner();
		if (__DEC_eNestedType_anonymousClassDeclarationOwner_881826 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_NestedClassInType_27_1_matchtggpattern_black_nac_1B(MClass eNestedType) {
		for (Model __DEC_eNestedType_orphanTypes_117513 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, Model.class, "orphanTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_NestedClassInType_27_1_matchtggpattern_black_nac_2B(MClass eNestedType) {
		org.eclipse.modisco.java.Package __DEC_eNestedType_ownedElements_716912 = eNestedType.getPackage();
		if (__DEC_eNestedType_ownedElements_716912 != null) {
			return new Object[] { eNestedType };
		}
	...
	public static final Object[] pattern_NestedClassInType_27_1_matchtggpattern_black_nac_3B(MClass eNestedType) {
		for (MAbstractMethodDefinition __DEC_eNestedType_mInnerTypes_535068 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(eNestedType, MAbstractMethodDefinition.class, "mInnerTypes")) {
			return new Object[] { eNestedType };
		}
		return null;
	...
	public static final Object[] pattern_NestedClassInType_27_1_matchtggpattern_blackBB(MClass eNestedType,
			AbstractTypeDeclaration eOuterType) {
		if (!eNestedType.equals(eOuterType)) {
			if (eOuterType.equals(eNestedType.getAbstractTypeDeclaration())) {
				if (pattern_NestedClassInType_27_1_matchtggpattern_black_nac_0B(eNestedType) == null) {
					if (pattern_NestedClassInType_27_1_matchtggpattern_black_nac_1B(eNestedType) == null) {
						if (pattern_NestedClassInType_27_1_matchtggpattern_black_nac_2B(eNestedType) == null) {
							if (pattern_NestedClassInType_27_1_matchtggpattern_black_nac_3B(eNestedType) == null) {
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_0BB(TPackage tNestedPackage,
			TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedPackage_parent_518289 = tNestedPackage.getParent();
			if (__DEC_tNestedPackage_parent_518289 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedPackage_parent_518289)) {
					if (!tOuterPackage.equals(__DEC_tNestedPackage_parent_518289)) {
						return new Object[] { tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_1BB(TPackage tNestedPackage,
			TypeGraph typeGraph) {
		TypeGraph __DEC_tNestedPackage_packages_609992 = tNestedPackage.getPg();
		if (__DEC_tNestedPackage_packages_609992 != null) {
			if (!typeGraph.equals(__DEC_tNestedPackage_packages_609992)) {
				return new Object[] { tNestedPackage, typeGraph };
			}
		}
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_2BBB(TClass tNestedType,
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			for (TPackage __DEC_tNestedType_classes_704043 : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(tNestedType, TPackage.class, "classes")) {
				if (!tNestedPackage.equals(__DEC_tNestedType_classes_704043)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_classes_704043)) {
						return new Object[] { tNestedType, tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_3BB(TClass tNestedType,
			TypeGraph typeGraph) {
		for (TypeGraph __DEC_tNestedType_classes_326685 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tNestedType, TypeGraph.class, "classes")) {
			if (!typeGraph.equals(__DEC_tNestedType_classes_326685)) {
				return new Object[] { tNestedType, typeGraph };
			}
		}
		return null;
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_4BBB(TClass tNestedType,
			TPackage tNestedPackage, TPackage tOuterPackage) {
		if (!tNestedPackage.equals(tOuterPackage)) {
			TPackage __DEC_tNestedType_ownedTypes_79158 = tNestedType.getPackage();
			if (__DEC_tNestedType_ownedTypes_79158 != null) {
				if (!tNestedPackage.equals(__DEC_tNestedType_ownedTypes_79158)) {
					if (!tOuterPackage.equals(__DEC_tNestedType_ownedTypes_79158)) {
						return new Object[] { tNestedType, tNestedPackage, tOuterPackage };
					}
				}
			}
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_5BB(TClass tNestedType,
			TAbstractType tOuterType) {
		if (!tNestedType.equals(tOuterType)) {
			TAbstractType __DEC_tNestedType_innerTypes_434838 = tNestedType.getOuterType();
			if (__DEC_tNestedType_innerTypes_434838 != null) {
				if (!tNestedType.equals(__DEC_tNestedType_innerTypes_434838)) {
					if (!tOuterType.equals(__DEC_tNestedType_innerTypes_434838)) {
						return new Object[] { tNestedType, tOuterType };
					}
				}
			}
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_6BB(TypeGraph typeGraph,
			TPackage tNestedPackage) {
		if (typeGraph.getPackages().contains(tNestedPackage)) {
			return new Object[] { typeGraph, tNestedPackage };
		}
	...
	public static final Object[] pattern_NestedClassInType_28_1_matchtggpattern_black_nac_8BB(TPackage tOuterPackage,
			TClass tNestedType) {
		if (tOuterPackage.getOwnedTypes().contains(tNestedType)) {
			return new Object[] { tOuterPackage, tNestedType };
		}
																			...
																			if (pattern_NestedClassInType_28_1_matchtggpattern_black_nac_5BB(
																				...
																				if (pattern_NestedClassInType_28_1_matchtggpattern_black_nac_6BB(
																					...
																					if (pattern_NestedClassInType_28_1_matchtggpattern_black_nac_7BB(
																							tOuterPackage,
																							tNestedType) == null) {
																						if (pattern_NestedClassInType_28_1_matchtggpattern_black_nac_8BB(
																								tOuterPackage,
																								tNestedType) == null) {
																							return new Object[] {
																									tNestedPackage,
					...
					if (tOuterType != null) {
						...
						if (tmpEOuterType instanceof AbstractTypeDeclaration) {
							...
							if (typeGraph != null) {
								...
								if (tOuterPackage != null) {
									if (typeGraph.equals(tOuterPackage.getTypeGraph())) {
										if (pattern_NestedClassInType_29_2_isapplicablecore_black_nac_3BB(ruleResult,
											...
											if (pattern_NestedClassInType_29_2_isapplicablecore_black_nac_1BB(
												...
												if (pattern_NestedClassInType_29_2_isapplicablecore_black_nac_4BB(
													...
													if (pattern_NestedClassInType_29_2_isapplicablecore_black_nac_0BB(
														...
														if (pattern_NestedClassInType_29_2_isapplicablecore_black_nac_2BB(
	...
	public static final Object[] pattern_NestedClassInType_29_6_perform_greenFFFBFFBFBBBB(TypeGraph typeGraph,
		...
		mNestedClassDeclarationToTNestedClass.setTarget(tNestedType);
		mNestedClassDeclarationToTNestedClass.setSource(eNestedType);
		ruleResult.getCorrObjects().add(mNestedClassDeclarationToTNestedClass);
		mBodyToTAnnotation.setSource(eNestedType);
		mBodyToTAnnotation.setTarget(tNestedType);
