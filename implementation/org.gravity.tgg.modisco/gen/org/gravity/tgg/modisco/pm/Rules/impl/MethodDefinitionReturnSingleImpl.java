...
public class MethodDefinitionReturnSingleImpl extends AbstractRuleImpl implements MethodDefinitionReturnSingle {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MethodDefinitionReturnSingleImpl
				.pattern_MethodDefinitionReturnSingle_1_3_bookkeepingforedges_blackBBBBBBBBBBBBB(ruleresult,
						mTypeToTType, tType, mDefinitionToTMember, tMethodSignature, mSignatureToTMethodSignature,
			...
			for (Object[] result3_black : MethodDefinitionReturnSingleImpl
				...
				Object[] result3_green = MethodDefinitionReturnSingleImpl
						.pattern_MethodDefinitionReturnSingle_2_3_findcontext_greenBBBBBBBBFFFFFFFFFF(mTypeToTType,
								tType, tMethodSignature, mSignatureToTMethodSignature, mDefinition, mTypeAccess, mType,
								mSignature);
				...
				Object[] result4_bindingAndBlack = MethodDefinitionReturnSingleImpl
						.pattern_MethodDefinitionReturnSingle_2_4_solveCSP_bindingAndBlackFBBBBBBBBBB(this,
								isApplicableMatch, mTypeToTType, tType, tMethodSignature, mSignatureToTMethodSignature,
								mDefinition, mTypeAccess, mType, mSignature);
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MethodDefinitionReturnSingleImpl
				.pattern_MethodDefinitionReturnSingle_12_2_corematch_blackFBBFBFFB(tType, tMethodSignature, tDefinition,
						match)) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[0];
			MSignatureToTSignature mSignatureToTMethodSignature = (MSignatureToTSignature) result2_black[3];
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		if (MethodDefinitionReturnSingleImpl.pattern_MethodDefinitionReturnSingle_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MethodDefinitionReturnSingleImpl
					.pattern_MethodDefinitionReturnSingle_24_5_matchcorrcontext_blackFBBFBBBB(tType, tMethodSignature,
			...
			if (MethodDefinitionReturnSingleImpl.pattern_MethodDefinitionReturnSingle_29_4_checkCSP_expressionFBB(this,
				...
				Object[] result5_black = MethodDefinitionReturnSingleImpl
						.pattern_MethodDefinitionReturnSingle_29_5_checknacs_blackBBBBBB(mTypeToTType, tType,
								tMethodSignature, mSignatureToTMethodSignature, mType, mSignature);
				if (result5_black != null) {
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.METHOD_DEFINITION_RETURN_SINGLE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_MMETHODDEFINITION_TYPEACCESS_TYPE_MMETHODSIGNATURE:
		...
		case RulesPackage.METHOD_DEFINITION_RETURN_SINGLE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_TMETHODDEFINITION_TYPE_MMETHODSIGNATURE:
		...
		case RulesPackage.METHOD_DEFINITION_RETURN_SINGLE___IS_APPROPRIATE_BWD_EMOFLON_EDGE_33__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_33((EMoflonEdge) arguments.get(0));
		case RulesPackage.METHOD_DEFINITION_RETURN_SINGLE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_34__EMOFLONEDGE:
		...
		case RulesPackage.METHOD_DEFINITION_RETURN_SINGLE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_TABSTRACTTYPE_TMETHODSIGNATURE_MSIGNATURETOTSIGNATURE_TYPE_MMETHODSIGNATURE_MODELGENERATORRULERESULT:
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_1_1_performtransformation_blackBBBBBBBBFBB(
			...
			Type mType, MMethodSignature mSignature, MethodDefinitionReturnSingle _this,
			IsApplicableMatch isApplicableMatch) {
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_1_1_performtransformation_bindingAndBlackFFFFFFFFFBB(
		...
		if (result_pattern_MethodDefinitionReturnSingle_1_1_performtransformation_binding != null) {
			...
			TMethodSignature tMethodSignature = (TMethodSignature) result_pattern_MethodDefinitionReturnSingle_1_1_performtransformation_binding[2];
			MSignatureToTSignature mSignatureToTMethodSignature = (MSignatureToTSignature) result_pattern_MethodDefinitionReturnSingle_1_1_performtransformation_binding[3];
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MethodDefinitionReturnSingle_11_1_performtransformation_binding != null) {
			...
			TMethodSignature tMethodSignature = (TMethodSignature) result_pattern_MethodDefinitionReturnSingle_11_1_performtransformation_binding[2];
			MSignatureToTSignature mSignatureToTMethodSignature = (MSignatureToTSignature) result_pattern_MethodDefinitionReturnSingle_11_1_performtransformation_binding[3];
	...
	public static final Iterable<Object[]> pattern_MethodDefinitionReturnSingle_12_2_corematch_blackFBBFBFFB(
				...
				for (MSignatureToTSignature mSignatureToTMethodSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMSignature instanceof MMethodSignature) {
						...
						for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (mType != null) {
								_result.add(new Object[] { mTypeToTType, tType, tMethodSignature,
										mSignatureToTMethodSignature, tDefinition, mType, mSignature, match });
							}
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_20_2_testcorematchandDECs_black_nac_0BB(
		...
		TSignature __DEC_tDefinition_signature_405635 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_405635 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_405635)) {
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_21_2_testcorematchandDECs_black_nac_0BB(
		...
		MSignature __DEC_mDefinition_mDefinitions_844953 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_844953 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_844953)) {
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_21_2_testcorematchandDECs_black_nac_1BB(
		...
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_793280 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_793280)) {
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_21_2_testcorematchandDECs_black_nac_2B(
		...
		for (Annotation __DEC_mTypeAccess_type_347828 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_21_2_testcorematchandDECs_black_nac_3BB(
			TypeAccess mTypeAccess, Type mType) {
		for (ArrayType __DEC_mTypeAccess_elementType_583453 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ArrayType.class, "elementType")) {
			if (!mType.equals(__DEC_mTypeAccess_elementType_583453)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_21_2_testcorematchandDECs_black_nac_4B(
			TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_743791 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_21_2_testcorematchandDECs_black_nac_5BB(
			TypeAccess mTypeAccess, Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_861259 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_861259)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_21_2_testcorematchandDECs_black_nac_6BB(
			TypeAccess mTypeAccess, Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_725284 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_725284)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_21_2_testcorematchandDECs_black_nac_7B(
			TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_720716 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_21_2_testcorematchandDECs_black_nac_8B(
			TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_161073 : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Iterable<Object[]> pattern_MethodDefinitionReturnSingle_24_5_matchcorrcontext_blackFBBFBBBB(
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_27_1_matchtggpattern_black_nac_0BB(
			MMethodDefinition mDefinition, MMethodSignature mSignature) {
		MSignature __DEC_mDefinition_mDefinitions_368888 = mDefinition.getMSignature();
		if (__DEC_mDefinition_mDefinitions_368888 != null) {
			if (!mSignature.equals(__DEC_mDefinition_mDefinitions_368888)) {
				return new Object[] { mDefinition, mSignature };
			}
		}
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_27_1_matchtggpattern_black_nac_1BB(
			TypeAccess mTypeAccess, Type mType) {
		for (AbstractTypeDeclaration __DEC_mTypeAccess_superInterfaces_473102 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AbstractTypeDeclaration.class, "superInterfaces")) {
			if (!mType.equals(__DEC_mTypeAccess_superInterfaces_473102)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_27_1_matchtggpattern_black_nac_2B(
			TypeAccess mTypeAccess) {
		for (Annotation __DEC_mTypeAccess_type_871803 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, Annotation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_27_1_matchtggpattern_black_nac_3BB(
			TypeAccess mTypeAccess, Type mType) {
		for (ArrayType __DEC_mTypeAccess_elementType_304287 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ArrayType.class, "elementType")) {
			if (!mType.equals(__DEC_mTypeAccess_elementType_304287)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_27_1_matchtggpattern_black_nac_4B(
			TypeAccess mTypeAccess) {
		for (ClassInstanceCreation __DEC_mTypeAccess_type_696848 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassInstanceCreation.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_27_1_matchtggpattern_black_nac_5BB(
			TypeAccess mTypeAccess, Type mType) {
		for (ClassDeclaration __DEC_mTypeAccess_superClass_208340 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ClassDeclaration.class, "superClass")) {
			if (!mType.equals(__DEC_mTypeAccess_superClass_208340)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_27_1_matchtggpattern_black_nac_6BB(
			TypeAccess mTypeAccess, Type mType) {
		for (ParameterizedType __DEC_mTypeAccess_type_717204 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, ParameterizedType.class, "type")) {
			if (!mType.equals(__DEC_mTypeAccess_type_717204)) {
				return new Object[] { mTypeAccess, mType };
			}
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_27_1_matchtggpattern_black_nac_7B(
			TypeAccess mTypeAccess) {
		for (TypeLiteral __DEC_mTypeAccess_type_387521 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, TypeLiteral.class, "type")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_27_1_matchtggpattern_black_nac_8B(
			TypeAccess mTypeAccess) {
		for (AnnotationMemberValuePair __DEC_mTypeAccess_value_332602 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(mTypeAccess, AnnotationMemberValuePair.class, "value")) {
			return new Object[] { mTypeAccess };
		}
		return null;
	...
	public static final Object[] pattern_MethodDefinitionReturnSingle_28_1_matchtggpattern_black_nac_0BB(
			TMethodDefinition tDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tDefinition_signature_149554 = tDefinition.getSignature();
		if (__DEC_tDefinition_signature_149554 != null) {
			if (!tMethodSignature.equals(__DEC_tDefinition_signature_149554)) {
				return new Object[] { tDefinition, tMethodSignature };
			}
		}
