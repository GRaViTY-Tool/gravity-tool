...
public class LinkDefinitionToTypeImpl extends AbstractRuleImpl implements LinkDefinitionToType {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tDefinition, mType,
						mSignature, mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition,
						mDefinitionToTMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[tDefinition] = " + tDefinition + ", " + "[mType] = " + mType + ", " + "[mSignature] = "
					+ mSignature + ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tSignature] = " + tSignature
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(ruleresult,
				tDefinition, mType, tSignature, tType, mDefinition);
		...
		LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, tDefinition, mType, mSignature, mTypeToTType, tSignature, mSignatureToTSignature, tType,
				mDefinition, mDefinitionToTMember);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_2_2_corematch_blackFBBFFFFBFB(mType, mSignature, mDefinition, match)) {
			...
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_2_3_findcontext_blackBBBBBBBBB(tDefinition, mType, mSignature,
							mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition,
							mDefinitionToTMember)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(tDefinition, mType,
								mSignature, mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition,
								mDefinitionToTMember);
				...
				Object[] result4_bindingAndBlack = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(this, isApplicableMatch,
								tDefinition, mType, mSignature, mTypeToTType, tSignature, mSignatureToTSignature, tType,
								mDefinition, mDefinitionToTMember);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[tDefinition] = " + tDefinition
							+ ", " + "[mType] = " + mType + ", " + "[mSignature] = " + mSignature + ", "
							+ "[mTypeToTType] = " + mTypeToTType + ", " + "[tSignature] = " + tSignature + ", "
							+ "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[tType] = " + tType
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TMember tDefinition,
			...
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, TAbstractType tType,
			MDefinition mDefinition, MDefinitionToTMember mDefinitionToTMember) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject tDefinition, EObject mType,
			EObject mSignature, EObject mTypeToTType, EObject tSignature, EObject mSignatureToTSignature, EObject tType,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_11_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, tDefinition, mType,
						mSignature, mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition,
						mDefinitionToTMember);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_12_2_corematch_blackBFFFBFBFFB(tDefinition, tSignature, tType, match)) {
			...
			// ForEach 
			for (Object[] result3_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_12_3_findcontext_blackBBBBBBBBB(tDefinition, mType, mSignature,
							mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition,
							mDefinitionToTMember)) {
				Object[] result3_green = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(tDefinition, mType,
								mSignature, mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition,
								mDefinitionToTMember);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[9];
				...
				//nothing EMoflonEdge tType__tSignature____signature = (EMoflonEdge) result3_green[17];
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject tDefinition, EObject mType,
			EObject mSignature, EObject mTypeToTType, EObject tSignature, EObject mSignatureToTSignature, EObject tType,
			EObject mDefinition, EObject mDefinitionToTMember) {
		ruleresult.registerObject("tDefinition", tDefinition);
		ruleresult.registerObject("mType", mType);
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = LinkDefinitionToTypeImpl
				.pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tDefinition, mType,
						mSignature, tSignature, tType, mDefinition, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tDefinition] = " + tDefinition + ", " + "[mType] = " + mType + ", " + "[mSignature] = "
					+ mSignature + ", " + "[tSignature] = " + tSignature + ", " + "[tType] = " + tType + ", "
		...
		if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : LinkDefinitionToTypeImpl
					.pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackBBBFBFBBFBB(tDefinition, mType, mSignature,
							tSignature, tType, mDefinition, sourceMatch, targetMatch)) {
				...
				Object[] result6_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(tDefinition, mType,
								mSignature, tSignature, tType, mDefinition, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tDefinition] = "
							+ tDefinition + ", " + "[mType] = " + mType + ", " + "[mSignature] = " + mSignature + ", "
							+ "[tSignature] = " + tSignature + ", " + "[tType] = " + tType + ", " + "[mDefinition] = "
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(TMember tDefinition, AbstractTypeDeclaration mType, MSignature mSignature,
			TSignature tSignature, TAbstractType tType, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		...
		for (Object[] result2_black : LinkDefinitionToTypeImpl
			...
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						...
						+ mTypeToTType + ", " + "[tSignature] = " + tSignature + ", " + "[mSignatureToTSignature] = "
						+ mSignatureToTSignature + ", " + "[tType] = " + tType + ", " + "[mDefinition] = " + mDefinition
			...
			if (LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = LinkDefinitionToTypeImpl
						.pattern_LinkDefinitionToType_29_5_checknacs_blackBBBBBBBBB(tDefinition, mType, mSignature,
								mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition,
								mDefinitionToTMember);
				if (result5_black != null) {

					Object[] result6_black = LinkDefinitionToTypeImpl
							.pattern_LinkDefinitionToType_29_6_perform_blackBBBBBBBBBB(tDefinition, mType, mSignature,
									mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition,
					...
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tDefinition] = "
								+ tDefinition + ", " + "[mType] = " + mType + ", " + "[mSignature] = " + mSignature
								+ ", " + "[mTypeToTType] = " + mTypeToTType + ", " + "[tSignature] = " + tSignature
								+ ", " + "[mSignatureToTSignature] = " + mSignatureToTSignature + ", " + "[tType] = "
								+ tType + ", " + "[mDefinition] = " + mDefinition + ", " + "[mDefinitionToTMember] = "
					...
					LinkDefinitionToTypeImpl.pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(tDefinition, mType,
							tSignature, tType, mDefinition, ruleResult);
	...
	public CSP generateModel_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TMember tDefinition,
			AbstractTypeDeclaration mType, MSignature mSignature, TypeToTAbstractType mTypeToTType,
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, TAbstractType tType,
			MDefinition mDefinition, MDefinitionToTMember mDefinitionToTMember, ModelgeneratorRuleResult ruleResult) {// Create CSP
		CSP csp = CspFactory.eINSTANCE.createCSP();
		isApplicableMatch.getAttributeInfo().add(csp);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TMEMBER_ABSTRACTTYPEDECLARATION_MSIGNATURE_TYPETOTABSTRACTTYPE_TSIGNATURE_MSIGNATURETOTSIGNATURE_TABSTRACTTYPE_MDEFINITION_MDEFINITIONTOTMEMBER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0), (TMember) arguments.get(1),
					...
					(TypeToTAbstractType) arguments.get(4), (TSignature) arguments.get(5),
					(MSignatureToTSignature) arguments.get(6), (TAbstractType) arguments.get(7),
					(MDefinition) arguments.get(8), (MDefinitionToTMember) arguments.get(9));
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_ABSTRACTTYPEDECLARATION_MSIGNATURE_TYPETOTABSTRACTTYPE_TSIGNATURE_MSIGNATURETOTSIGNATURE_TABSTRACTTYPE_MDEFINITION_MDEFINITIONTOTMEMBER:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPROPRIATE_FWD_EMOFLON_EDGE_12__EMOFLONEDGE:
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___IS_APPLICABLE_SOLVE_CSP_CC__TMEMBER_ABSTRACTTYPEDECLARATION_MSIGNATURE_TSIGNATURE_TABSTRACTTYPE_MDEFINITION_MATCH_MATCH:
			return isApplicable_solveCsp_CC((TMember) arguments.get(0), (AbstractTypeDeclaration) arguments.get(1),
					(MSignature) arguments.get(2), (TSignature) arguments.get(3), (TAbstractType) arguments.get(4),
		...
		case RulesPackage.LINK_DEFINITION_TO_TYPE___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMEMBER_ABSTRACTTYPEDECLARATION_MSIGNATURE_TYPETOTABSTRACTTYPE_TSIGNATURE_MSIGNATURETOTSIGNATURE_TABSTRACTTYPE_MDEFINITION_MDEFINITIONTOTMEMBER_MODELGENERATORRULERESULT:
								...
								if (tmpTType instanceof TAbstractType) {
									...
									if (tmpMDefinition instanceof MDefinition) {
										...
										if (tmpMDefinitionToTMember instanceof MDefinitionToTMember) {
											...
											return new Object[] { tDefinition, mType, mSignature, mTypeToTType,
													tSignature, mSignatureToTSignature, tType, mDefinition,
													mDefinitionToTMember, isApplicableMatch };
										}
									}
								}
							}
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
			TMember tDefinition, AbstractTypeDeclaration mType, MSignature mSignature, TypeToTAbstractType mTypeToTType,
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, TAbstractType tType,
			MDefinition mDefinition, MDefinitionToTMember mDefinitionToTMember, LinkDefinitionToType _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tDefinition, mType, mSignature, mTypeToTType, tSignature, mSignatureToTSignature,
						tType, mDefinition, mDefinitionToTMember, csp, _this, isApplicableMatch };
			}
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_1_1_performtransformation_bindingAndBlackFFFFFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_1_1_performtransformation_black = pattern_LinkDefinitionToType_1_1_performtransformation_blackBBBBBBBBBFBB(
					tDefinition, mType, mSignature, mTypeToTType, tSignature, mSignatureToTSignature, tType,
					mDefinition, mDefinitionToTMember, _this, isApplicableMatch);
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject tDefinition, EObject mType, EObject mSignature, EObject mTypeToTType,
			EObject tSignature, EObject mSignatureToTSignature, EObject tType, EObject mDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToType_1_3_bookkeepingforedges_greenBBBBBBFFFFF(
			PerformRuleResult ruleresult, EObject tDefinition, EObject mType, EObject tSignature, EObject tType,
			EObject mDefinition) {
		EMoflonEdge mType__mDefinition____bodyDeclarations = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mDefinition__mType____abstractTypeDeclaration = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, tDefinition, mType, tSignature, tType, mDefinition,
	...
	public static final void pattern_LinkDefinitionToType_1_5_registerobjects_expressionBBBBBBBBBBB(
			LinkDefinitionToType _this, PerformRuleResult ruleresult, EObject tDefinition, EObject mType,
			EObject mSignature, EObject mTypeToTType, EObject tSignature, EObject mSignatureToTSignature, EObject tType,
			EObject mDefinition, EObject mDefinitionToTMember) {
		_this.registerObjects_FWD(ruleresult, tDefinition, mType, mSignature, mTypeToTType, tSignature,
				mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_2_2_corematch_blackFBBFFFFBFB(
				...
				for (MSignatureToTSignature mSignatureToTSignature : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tSignature != null) {
						for (MDefinitionToTMember mDefinitionToTMember : org.moflon.core.utilities.eMoflonEMFUtil
							...
							if (tDefinition != null) {
								_result.add(new Object[] { tDefinition, mType, mSignature, mTypeToTType, tSignature,
										mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember, match });
							}
								...
								if (tType.equals(mTypeToTType.getTarget())) {
									if (tDefinition.equals(mDefinitionToTMember.getTarget())) {
										if (mDefinition.equals(mDefinitionToTMember.getSource())) {
											_result.add(new Object[] { tDefinition, mType, mSignature, mTypeToTType,
													tSignature, mSignatureToTSignature, tType, mDefinition,
													mDefinitionToTMember });
										}
									}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFF(
		...
		return new Object[] { tDefinition, mType, mSignature, mTypeToTType, tSignature, mSignatureToTSignature, tType,
				mDefinition, mDefinitionToTMember, isApplicableMatch, mType__mDefinition____bodyDeclarations,
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, TAbstractType tType,
			MDefinition mDefinition, MDefinitionToTMember mDefinitionToTMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, tDefinition, mType, mSignature,
				mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tDefinition, mType, mSignature, mTypeToTType,
					tSignature, mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_2_4_solveCSP_bindingAndBlackFBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_2_4_solveCSP_binding = pattern_LinkDefinitionToType_2_4_solveCSP_bindingFBBBBBBBBBBB(
				_this, isApplicableMatch, tDefinition, mType, mSignature, mTypeToTType, tSignature,
				mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember);
	...
	public static final void pattern_LinkDefinitionToType_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mSignature, EObject mTypeToTType, EObject tSignature, EObject mSignatureToTSignature, EObject tType,
			EObject mDefinition, EObject mDefinitionToTMember) {
		_this.registerObjects_BWD(ruleresult, tDefinition, mType, mSignature, mTypeToTType, tSignature,
				mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_12_2_corematch_blackBFFFBFBFFB(
	...
	public static final Object[] pattern_LinkDefinitionToType_12_3_findcontext_greenBBBBBBBBBFFFFFFFFFFFFFF(
		...
		tDefinition__tType____definedBy.setName(tDefinition__tType____definedBy_name_prime);
		return new Object[] { tDefinition, mType, mSignature, mTypeToTType, tSignature, mSignatureToTSignature, tType,
				mDefinition, mDefinitionToTMember, isApplicableMatch, mTypeToTType__mType____source,
				mSignature__mDefinition____mDefinitions, mDefinition__mSignature____mSignature,
				tSignature__tDefinition____definitions, tDefinition__tSignature____signature,
				mSignatureToTSignature__mSignature____source, mSignatureToTSignature__tSignature____target,
	...
	public static final Object[] pattern_LinkDefinitionToType_12_4_solveCSP_bindingFBBBBBBBBBBB(
			...
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, TAbstractType tType,
			MDefinition mDefinition, MDefinitionToTMember mDefinitionToTMember) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tDefinition, mType, mSignature,
				mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tDefinition, mType, mSignature, mTypeToTType,
				...
				if (tmpMSignature instanceof MSignature) {
					...
					if (tmpTSignature instanceof TSignature) {
						...
						if (tmpTType instanceof TAbstractType) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								MDefinition mDefinition = (MDefinition) tmpMDefinition;
								return new Object[] { tDefinition, mType, mSignature, tSignature, tType, mDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(TMember tDefinition,
			AbstractTypeDeclaration mType, MSignature mSignature, TSignature tSignature, TAbstractType tType,
			MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tDefinition, mType, mSignature, tSignature, tType, mDefinition, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_black = pattern_LinkDefinitionToType_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tDefinition, mType, mSignature, tSignature, tType, mDefinition, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
			LinkDefinitionToType _this, TMember tDefinition, AbstractTypeDeclaration mType, MSignature mSignature,
			TSignature tSignature, TAbstractType tType, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tDefinition, mType, mSignature, tSignature, tType,
				mDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tDefinition, mType, mSignature, tSignature, tType, mDefinition,
	...
	public static final Object[] pattern_LinkDefinitionToType_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_24_3_solvecsp_binding = pattern_LinkDefinitionToType_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tDefinition, mType, mSignature, tSignature, tType, mDefinition, sourceMatch, targetMatch);
	...
	public static final Iterable<Object[]> pattern_LinkDefinitionToType_24_5_matchcorrcontext_blackBBBFBFBBFBB(
			TMember tDefinition, AbstractTypeDeclaration mType, MSignature mSignature, TSignature tSignature,
			TAbstractType tType, MDefinition mDefinition, Match sourceMatch, Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					.getOppositeReferenceTyped(mType, TypeToTAbstractType.class, "source")) {
	...
	public static final Object[] pattern_LinkDefinitionToType_24_6_createcorrespondence_blackBBBBBBB(
			TMember tDefinition, AbstractTypeDeclaration mType, MSignature mSignature, TSignature tSignature,
			TAbstractType tType, MDefinition mDefinition, CCMatch ccMatch) {
		return new Object[] { tDefinition, mType, mSignature, tSignature, tType, mDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
			...
			AbstractTypeDeclaration mType, MSignature mSignature, TypeToTAbstractType mTypeToTType,
			TSignature tSignature, MSignatureToTSignature mSignatureToTSignature, TAbstractType tType,
			MDefinition mDefinition, MDefinitionToTMember mDefinitionToTMember, ModelgeneratorRuleResult ruleResult) {
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, tDefinition, mType, mSignature,
				mTypeToTType, tSignature, mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tDefinition, mType, mSignature, mTypeToTType,
					tSignature, mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember, ruleResult };
		}
		return null;
	}
	...
	public static final Object[] pattern_LinkDefinitionToType_29_3_solveCSP_bindingAndBlackFBBBBBBBBBBBB(
		...
		Object[] result_pattern_LinkDefinitionToType_29_3_solveCSP_binding = pattern_LinkDefinitionToType_29_3_solveCSP_bindingFBBBBBBBBBBBB(
				_this, isApplicableMatch, tDefinition, mType, mSignature, mTypeToTType, tSignature,
				mSignatureToTSignature, tType, mDefinition, mDefinitionToTMember, ruleResult);
	...
	public static final Object[] pattern_LinkDefinitionToType_29_6_perform_greenBBBBBB(TMember tDefinition,
			AbstractTypeDeclaration mType, TSignature tSignature, TAbstractType tType, MDefinition mDefinition,
		...
		return new Object[] { tDefinition, mType, tSignature, tType, mDefinition, ruleResult };
	}
