...
public class MemberInClassVisibilityImpl extends AbstractRuleImpl implements MemberInClassVisibility {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(ruleresult, mTypeToTType,
						mModifierToTModifier, mClass, tMember, tModifier, tClass, defToMember, mDefinition, mModifier);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					...
					+ defToMember + ", " + "[mDefinition] = " + mDefinition + ", " + "[mModifier] = " + mModifier
					+ ".");
		}
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(this,
				ruleresult, mTypeToTType, mModifierToTModifier, mClass, tMember, tModifier, tClass, defToMember,
				mDefinition, mModifier);
	...
	public IsApplicableRuleResult isApplicable_FWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_2_2_corematch_blackFBFFFBBB(mClass, mDefinition, mModifier, match)) {
			...
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_2_3_findcontext_blackBBBBBBB(mTypeToTType, mClass, tMember, tClass,
							defToMember, mDefinition, mModifier)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(mTypeToTType, mClass,
								tMember, tClass, defToMember, mDefinition, mModifier);
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
								mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition, mModifier);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTypeToTType] = " + mTypeToTType
							+ ", " + "[mClass] = " + mClass + ", " + "[tMember] = " + tMember + ", " + "[tClass] = "
	...
	public CSP isApplicable_solveCsp_FWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			ClassDeclaration mClass, TMember tMember, TClass tClass, MDefinitionToTMember defToMember,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mTypeToTType, EObject mModifierToTModifier,
			EObject mClass, EObject tMember, EObject tModifier, EObject tClass, EObject defToMember,
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_11_3_bookkeepingforedges_greenBBBBBBFFFFF(
				ruleresult, mModifierToTModifier, tMember, tModifier, mDefinition, mModifier);
		//nothing EMoflonEdge mModifierToTModifier__tModifier____target = (EMoflonEdge) result3_green[6];
		//nothing EMoflonEdge tMember__tModifier____tModifier = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mDefinition__mModifier____modifier = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge mModifier__mDefinition____bodyDeclaration = (EMoflonEdge) result3_green[9];
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_12_2_corematch_blackFFBBBFFB(tMember, tModifier, tClass, match)) {
			TypeToTAbstractType mTypeToTType = (TypeToTAbstractType) result2_black[0];
			...
			// ForEach 
			for (Object[] result3_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_12_3_findcontext_blackBBBBBBB(mTypeToTType, mClass, tMember,
							tModifier, tClass, defToMember, mDefinition)) {
				Object[] result3_green = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(mTypeToTType, mClass,
								tMember, tModifier, tClass, defToMember, mDefinition);
				IsApplicableMatch isApplicableMatch = (IsApplicableMatch) result3_green[7];
				...
				Object[] result4_bindingAndBlack = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(this,
								isApplicableMatch, mTypeToTType, mClass, tMember, tModifier, tClass, defToMember,
								mDefinition);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
							+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTypeToTType] = " + mTypeToTType
							+ ", " + "[mClass] = " + mClass + ", " + "[tMember] = " + tMember + ", " + "[tModifier] = "
	...
	public CSP isApplicable_solveCsp_BWD(IsApplicableMatch isApplicableMatch, TypeToTAbstractType mTypeToTType,
			ClassDeclaration mClass, TMember tMember, TModifier tModifier, TClass tClass,
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
				.pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, mClass, tMember,
						tModifier, tClass, mDefinition, mModifier, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[mClass] = " + mClass + ", " + "[tMember] = " + tMember + ", " + "[tModifier] = " + tModifier
					+ ", " + "[tClass] = " + tClass + ", " + "[mDefinition] = " + mDefinition + ", " + "[mModifier] = "
		...
		if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_24_4_checkCSP_expressionFB(csp)) {
			...
			for (Object[] result5_black : MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackFBBBFBBB(mClass, tMember, tClass,
				...
				Object[] result6_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(mClass, tMember,
								tModifier, tClass, mDefinition, mModifier, ccMatch);
				if (result6_black == null) {
	 ...
	 * @generated
	 */
	public CSP isApplicable_solveCsp_CC(ClassDeclaration mClass, TMember tMember, TModifier tModifier, TClass tClass,
		...
		for (Object[] result2_black : MemberInClassVisibilityImpl
			...
			Object[] result3_bindingAndBlack = MemberInClassVisibilityImpl
					.pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(this, isApplicableMatch,
							mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition, ruleResult);
			if (result3_bindingAndBlack == null) {
				throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
						+ "[isApplicableMatch] = " + isApplicableMatch + ", " + "[mTypeToTType] = " + mTypeToTType
						+ ", " + "[mClass] = " + mClass + ", " + "[tMember] = " + tMember + ", " + "[tClass] = "
			...
			if (MemberInClassVisibilityImpl.pattern_MemberInClassVisibility_29_4_checkCSP_expressionFBB(this, csp)) {
				// 
				Object[] result5_black = MemberInClassVisibilityImpl
						.pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(mTypeToTType, mClass, tMember,
								tClass, defToMember, mDefinition);
				if (result5_black != null) {

					Object[] result6_black = MemberInClassVisibilityImpl
							.pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(mTypeToTType, mClass, tMember,
									tClass, defToMember, mDefinition, ruleResult);
					if (result6_black == null) {
						throw new RuntimeException("Pattern matching failed." + " Variables: " + "[mTypeToTType] = "
								+ mTypeToTType + ", " + "[mClass] = " + mClass + ", " + "[tMember] = " + tMember + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_FWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_CLASSDECLARATION_TMEMBER_TCLASS_MDEFINITIONTOTMEMBER_MDEFINITION_MODIFIER:
			return isApplicable_solveCsp_FWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (ClassDeclaration) arguments.get(2),
					(TMember) arguments.get(3), (TClass) arguments.get(4), (MDefinitionToTMember) arguments.get(5),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_CLASSDECLARATION_TMEMBER_TMODIFIER_TCLASS_MDEFINITIONTOTMEMBER_MDEFINITION:
			return isApplicable_solveCsp_BWD((IsApplicableMatch) arguments.get(0),
					(TypeToTAbstractType) arguments.get(1), (ClassDeclaration) arguments.get(2),
					(TMember) arguments.get(3), (TModifier) arguments.get(4), (TClass) arguments.get(5),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_BWD_EMOFLON_EDGE_72__EMOFLONEDGE:
			return isAppropriate_BWD_EMoflonEdge_72((EMoflonEdge) arguments.get(0));
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPROPRIATE_FWD_EMOFLON_EDGE_76__EMOFLONEDGE:
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___IS_APPLICABLE_SOLVE_CSP_CC__CLASSDECLARATION_TMEMBER_TMODIFIER_TCLASS_MDEFINITION_MODIFIER_MATCH_MATCH:
			return isApplicable_solveCsp_CC((ClassDeclaration) arguments.get(0), (TMember) arguments.get(1),
					(TModifier) arguments.get(2), (TClass) arguments.get(3), (MDefinition) arguments.get(4),
		...
		case RulesPackage.MEMBER_IN_CLASS_VISIBILITY___GENERATE_MODEL_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TYPETOTABSTRACTTYPE_CLASSDECLARATION_TMEMBER_TCLASS_MDEFINITIONTOTMEMBER_MDEFINITION_MODELGENERATORRULERESULT:
						...
						if (tmpDefToMember instanceof MDefinitionToTMember) {
							...
							if (tmpMDefinition instanceof MDefinition) {
								...
								if (tmpMModifier instanceof Modifier) {
									...
									return new Object[] { mTypeToTType, mClass, tMember, tClass, defToMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
			TypeToTAbstractType mTypeToTType, ClassDeclaration mClass, TMember tMember, TClass tClass,
		...
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition, mModifier, csp,
	...
	public static final Object[] pattern_MemberInClassVisibility_1_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_1_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_1_1_performtransformation_black = pattern_MemberInClassVisibility_1_1_performtransformation_blackBBBBBBBFBB(
					mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition, mModifier, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_1_3_bookkeepingforedges_blackBBBBBBBBBB(
			PerformRuleResult ruleresult, EObject mTypeToTType, EObject mModifierToTModifier, EObject mClass,
			EObject tMember, EObject tModifier, EObject tClass, EObject defToMember, EObject mDefinition,
			EObject mModifier) {
	...
	public static final void pattern_MemberInClassVisibility_1_5_registerobjects_expressionBBBBBBBBBBB(
			MemberInClassVisibility _this, PerformRuleResult ruleresult, EObject mTypeToTType,
			EObject mModifierToTModifier, EObject mClass, EObject tMember, EObject tModifier, EObject tClass,
			EObject defToMember, EObject mDefinition, EObject mModifier) {
		_this.registerObjects_FWD(ruleresult, mTypeToTType, mModifierToTModifier, mClass, tMember, tModifier, tClass,
				defToMember, mDefinition, mModifier);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_2_2_corematch_blackFBFFFBBB(
		...
		for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tMember != null) {
				for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpTClass instanceof TClass) {
						TClass tClass = (TClass) tmpTClass;
						_result.add(new Object[] { mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition,
								mModifier, match });
					}
						...
						if (tMember.equals(defToMember.getTarget())) {
							if (mModifier.equals(mDefinition.getModifier())) {
								if (tClass.getDefines().contains(tMember)) {
									_result.add(new Object[] { mTypeToTType, mClass, tMember, tClass, defToMember,
											mDefinition, mModifier });
								}
							}
						}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_3_findcontext_greenBBBBBBBFFFFFFFFFFF(
		...
		return new Object[] { mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition, mModifier,
				...
				mTypeToTType__mClass____source, defToMember__tMember____target, mDefinition__mModifier____modifier,
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_FWD(isApplicableMatch, mTypeToTType, mClass, tMember, tClass,
				defToMember, mDefinition, mModifier);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, mClass, tMember, tClass, defToMember,
					mDefinition, mModifier };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_2_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_2_4_solveCSP_binding = pattern_MemberInClassVisibility_2_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition, mModifier);
					...
					if (tmpTModifier instanceof TModifier) {
						...
						if (tmpTClass instanceof TClass) {
							...
							if (tmpDefToMember instanceof MDefinitionToTMember) {
								...
								if (tmpMDefinition instanceof MDefinition) {
									MDefinition mDefinition = (MDefinition) tmpMDefinition;
									return new Object[] { mTypeToTType, mClass, tMember, tModifier, tClass, defToMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
			TypeToTAbstractType mTypeToTType, ClassDeclaration mClass, TMember tMember, TModifier tModifier,
			TClass tClass, MDefinitionToTMember defToMember, MDefinition mDefinition, MemberInClassVisibility _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { mTypeToTType, mClass, tMember, tModifier, tClass, defToMember, mDefinition, csp,
						_this, isApplicableMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_11_1_performtransformation_bindingAndBlackFFFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_11_1_performtransformation_black = pattern_MemberInClassVisibility_11_1_performtransformation_blackBBBBBBBFBB(
					mTypeToTType, mClass, tMember, tModifier, tClass, defToMember, mDefinition, _this,
					isApplicableMatch);
	...
	public static final void pattern_MemberInClassVisibility_11_5_registerobjects_expressionBBBBBBBBBBB(
			...
			EObject mModifierToTModifier, EObject mClass, EObject tMember, EObject tModifier, EObject tClass,
			EObject defToMember, EObject mDefinition, EObject mModifier) {
		_this.registerObjects_BWD(ruleresult, mTypeToTType, mModifierToTModifier, mClass, tMember, tModifier, tClass,
				defToMember, mDefinition, mModifier);
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_12_2_corematch_blackFFBBBFFB(TMember tMember,
		...
		for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
			...
			if (tmpMClass instanceof ClassDeclaration) {
				...
				for (MDefinitionToTMember defToMember : org.moflon.core.utilities.eMoflonEMFUtil
					...
					if (tmpMDefinition instanceof MDefinition) {
						MDefinition mDefinition = (MDefinition) tmpMDefinition;
						_result.add(new Object[] { mTypeToTType, mClass, tMember, tModifier, tClass, defToMember,
								mDefinition, match });
					}
				...
				if (mClass.getBodyDeclarations().contains(mDefinition)) {
					if (mDefinition.equals(defToMember.getSource())) {
						if (mClass.equals(mTypeToTType.getSource())) {
							if (tMember.equals(defToMember.getTarget())) {
								if (tClass.getDefines().contains(tMember)) {
									_result.add(new Object[] { mTypeToTType, mClass, tMember, tModifier, tClass,
	...
	public static final Object[] pattern_MemberInClassVisibility_12_3_findcontext_greenBBBBBBBFFFFFFFFFF(
		...
		tClass__tMember____defines.setName(tClass__tMember____defines_name_prime);
		tMember__tClass____definedBy.setName(tMember__tClass____definedBy_name_prime);
		return new Object[] { mTypeToTType, mClass, tMember, tModifier, tClass, defToMember, mDefinition,
				isApplicableMatch, tMember__tModifier____tModifier, mTypeToTType__tClass____target,
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, mTypeToTType, mClass, tMember,
				tModifier, tClass, defToMember, mDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, mClass, tMember, tModifier, tClass,
					defToMember, mDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_12_4_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_12_4_solveCSP_binding = pattern_MemberInClassVisibility_12_4_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, mClass, tMember, tModifier, tClass, defToMember, mDefinition);
	...
	public static final Object[] pattern_MemberInClassVisibility_20_2_testcorematchandDECs_black_nac_0BB(
		...
		for (TAbstractType __DEC_tModifier_tModifier_124986 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_124986)) {
				...
				if (tmpTModifier instanceof TModifier) {
					...
					if (tmpTClass instanceof TClass) {
						...
						if (tmpMDefinition instanceof MDefinition) {
							...
							if (tmpMModifier instanceof Modifier) {
								Modifier mModifier = (Modifier) tmpMModifier;
								return new Object[] { mClass, tMember, tModifier, tClass, mDefinition, mModifier,
										sourceMatch, targetMatch };
							}
						}
					}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
			ClassDeclaration mClass, TMember tMember, TModifier tModifier, TClass tClass, MDefinition mDefinition,
			Modifier mModifier, Match sourceMatch, Match targetMatch) {
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { mClass, tMember, tModifier, tClass, mDefinition, mModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_black = pattern_MemberInClassVisibility_24_2_matchsrctrgcontext_blackBBBBBBBB(
					mClass, tMember, tModifier, tClass, mDefinition, mModifier, sourceMatch, targetMatch);
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
			MemberInClassVisibility _this, ClassDeclaration mClass, TMember tMember, TModifier tModifier, TClass tClass,
			MDefinition mDefinition, Modifier mModifier, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(mClass, tMember, tModifier, tClass, mDefinition,
				mModifier, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, mClass, tMember, tModifier, tClass, mDefinition, mModifier, sourceMatch,
					targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_24_3_solvecsp_binding = pattern_MemberInClassVisibility_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, mClass, tMember, tModifier, tClass, mDefinition, mModifier, sourceMatch, targetMatch);
		if (result_pattern_MemberInClassVisibility_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_MemberInClassVisibility_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, mClass, tMember, tModifier, tClass, mDefinition, mModifier,
						sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Iterable<Object[]> pattern_MemberInClassVisibility_24_5_matchcorrcontext_blackFBBBFBBB(
			ClassDeclaration mClass, TMember tMember, TClass tClass, MDefinition mDefinition, Match sourceMatch,
			Match targetMatch) {
		LinkedList<Object[]> _result = new LinkedList<Object[]>();
		if (!sourceMatch.equals(targetMatch)) {
			for (TypeToTAbstractType mTypeToTType : org.moflon.core.utilities.eMoflonEMFUtil
	...
	public static final Object[] pattern_MemberInClassVisibility_24_6_createcorrespondence_blackBBBBBBB(
		...
		return new Object[] { mClass, tMember, tModifier, tClass, mDefinition, mModifier, ccMatch };
	}
	...
	public static final Object[] pattern_MemberInClassVisibility_28_1_matchtggpattern_black_nac_0BB(TModifier tModifier,
			TClass tClass) {
		for (TAbstractType __DEC_tModifier_tModifier_786391 : org.moflon.core.utilities.eMoflonEMFUtil
				.getOppositeReferenceTyped(tModifier, TAbstractType.class, "tModifier")) {
			if (!tClass.equals(__DEC_tModifier_tModifier_786391)) {
				return new Object[] { tModifier, tClass };
			}
		}
		return null;
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
		...
		CSP _localVariable_0 = _this.generateModel_solveCsp_BWD(isApplicableMatch, mTypeToTType, mClass, tMember,
				tClass, defToMember, mDefinition, ruleResult);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, mTypeToTType, mClass, tMember, tClass, defToMember,
	...
	public static final Object[] pattern_MemberInClassVisibility_29_3_solveCSP_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_MemberInClassVisibility_29_3_solveCSP_binding = pattern_MemberInClassVisibility_29_3_solveCSP_bindingFBBBBBBBBB(
				_this, isApplicableMatch, mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition, ruleResult);
	...
	public static final Object[] pattern_MemberInClassVisibility_29_5_checknacs_blackBBBBBB(
			TypeToTAbstractType mTypeToTType, ClassDeclaration mClass, TMember tMember, TClass tClass,
			MDefinitionToTMember defToMember, MDefinition mDefinition) {
		return new Object[] { mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition };
	}

	public static final Object[] pattern_MemberInClassVisibility_29_6_perform_blackBBBBBBB(
			TypeToTAbstractType mTypeToTType, ClassDeclaration mClass, TMember tMember, TClass tClass,
			MDefinitionToTMember defToMember, MDefinition mDefinition, ModelgeneratorRuleResult ruleResult) {
		return new Object[] { mTypeToTType, mClass, tMember, tClass, defToMember, mDefinition, ruleResult };
	}
