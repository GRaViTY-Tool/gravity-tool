...
public class UnresolvedMethodDeclarationImpl extends AbstractRuleImpl implements UnresolvedMethodDeclaration {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFFBBFFB(mMethod, tModel, csp);
		...
		Object[] result2_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(unresolved2Definiton,
						tMethodSignature, mMethod, tMethodName, tMethodDefinition);
		if (result2_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[unresolved2Definiton] = "
					...
					+ mMethod + ", " + "[tMethodName] = " + tMethodName + ", " + "[tMethodDefinition] = "
					+ tMethodDefinition + ".");
		}
		...
		Object[] result3_black = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(ruleresult,
						unresolved2Definiton, tMethodSignature, mModel, model2pm, mMethod, tModel, tMethodName,
						tMethodDefinition);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[unresolved2Definiton] = " + unresolved2Definiton + ", " + "[tMethodSignature] = "
					+ tMethodSignature + ", " + "[mModel] = " + mModel + ", " + "[model2pm] = " + model2pm + ", "
		...
		UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(ruleresult,
						unresolved2Definiton, tMethodSignature, mModel, mMethod, tModel, tMethodName,
						tMethodDefinition);
		//nothing EMoflonEdge tModel__tMethodName____methods = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge tMethodName__tModel____pg = (EMoflonEdge) result3_green[9];
		...
		UnresolvedMethodDeclarationImpl.pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
				this, ruleresult, unresolved2Definiton, tMethodSignature, mModel, model2pm, mMethod, tModel,
	...
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject unresolved2Definiton,
			EObject tMethodSignature, EObject mModel, EObject model2pm, EObject mMethod, EObject tModel,
			EObject tMethodName, EObject tMethodDefinition) {
	...
	public IsApplicableRuleResult isApplicable_BWD(Match match) {
		...
		for (Object[] result2_black : UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBFFBBBB(tMethodSignature, tModel, tMethodName,
			...
			for (Object[] result3_black : UnresolvedMethodDeclarationImpl
					.pattern_UnresolvedMethodDeclaration_12_3_findcontext_blackBBBBBB(tMethodSignature, mModel,
							model2pm, tModel, tMethodName, tMethodDefinition)) {
				Object[] result3_green = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(tMethodSignature,
								mModel, model2pm, tModel, tMethodName, tMethodDefinition);
				...
				Object[] result4_bindingAndBlack = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(this,
								isApplicableMatch, tMethodSignature, mModel, model2pm, tModel, tMethodName,
								tMethodDefinition);
				if (result4_bindingAndBlack == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
	...
	public IsApplicableRuleResult isApplicable_CC(Match sourceMatch, Match targetMatch) {
		...
		Object[] result3_bindingAndBlack = UnresolvedMethodDeclarationImpl
				.pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(this, tMethodSignature,
						mModel, mMethod, tModel, tMethodName, tMethodDefinition, sourceMatch, targetMatch);
		if (result3_bindingAndBlack == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[this] = " + this + ", "
					+ "[tMethodSignature] = " + tMethodSignature + ", " + "[mModel] = " + mModel + ", " + "[mMethod] = "
					+ mMethod + ", " + "[tModel] = " + tModel + ", " + "[tMethodName] = " + tMethodName + ", "
			...
			for (Object[] result5_black : UnresolvedMethodDeclarationImpl
				...
				Object[] result6_black = UnresolvedMethodDeclarationImpl
						.pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(tMethodSignature,
								mModel, mMethod, tModel, tMethodName, tMethodDefinition, ccMatch);
				if (result6_black == null) {
					throw new RuntimeException("Pattern matching failed." + " Variables: " + "[tMethodSignature] = "
							+ tMethodSignature + ", " + "[mModel] = " + mModel + ", " + "[mMethod] = " + mMethod + ", "
							+ "[tModel] = " + tModel + ", " + "[tMethodName] = " + tMethodName + ", "
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_BWD__ISAPPLICABLEMATCH_TMETHODSIGNATURE_MODEL_MODELTOTYPEGRAPH_TYPEGRAPH_TMETHOD_TMETHODDEFINITION:
		...
		case RulesPackage.UNRESOLVED_METHOD_DECLARATION___IS_APPLICABLE_SOLVE_CSP_CC__TMETHODSIGNATURE_MODEL_UNRESOLVEDMETHODDECLARATION_TYPEGRAPH_TMETHOD_TMETHODDEFINITION_MATCH_MATCH:
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_1_performtransformation_greenFFBBFFB(
		...
		return new Object[] { unresolved2Definiton, tMethodSignature, mMethod, tModel, tMethodName, tMethodDefinition,
				csp };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_blackBBBBB(
			MDefinitionToTMember unresolved2Definiton, TMethodSignature tMethodSignature,
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TMethod tMethodName,
			TMethodDefinition tMethodDefinition) {
		return new Object[] { unresolved2Definiton, tMethodSignature, mMethod, tMethodName, tMethodDefinition };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_2_collecttranslatedelements_greenFBBBBB(
		...
		return new Object[] { ruleresult, unresolved2Definiton, tMethodSignature, mMethod, tMethodName,
				tMethodDefinition };
	}

	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_blackBBBBBBBBB(
			PerformRuleResult ruleresult, EObject unresolved2Definiton, EObject tMethodSignature, EObject mModel,
			EObject model2pm, EObject mMethod, EObject tModel, EObject tMethodName, EObject tMethodDefinition) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_1_3_bookkeepingforedges_greenBBBBBBBBFFFFFFFFF(
			PerformRuleResult ruleresult, EObject unresolved2Definiton, EObject tMethodSignature, EObject mModel,
			EObject mMethod, EObject tModel, EObject tMethodName, EObject tMethodDefinition) {
		...
		return new Object[] { ruleresult, unresolved2Definiton, tMethodSignature, mModel, mMethod, tModel, tMethodName,
				tMethodDefinition, tModel__tMethodName____methods, tMethodName__tModel____pg,
				unresolved2Definiton__mMethod____source, mModel__mMethod____unresolvedItems,
	...
	public static final void pattern_UnresolvedMethodDeclaration_1_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tMethodSignature, EObject mModel, EObject model2pm, EObject mMethod, EObject tModel,
			EObject tMethodName, EObject tMethodDefinition) {
		_this.registerObjects_FWD(ruleresult, unresolved2Definiton, tMethodSignature, mModel, model2pm, mMethod, tModel,
				tMethodName, tMethodDefinition);
					...
					if (tmpTModel instanceof TypeGraph) {
						...
						if (tmpTMethodName instanceof TMethod) {
							...
							if (tmpTMethodDefinition instanceof TMethodDefinition) {
								...
								return new Object[] { tMethodSignature, mModel, model2pm, tModel, tMethodName,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
			TMethodSignature tMethodSignature, Model mModel, ModelToTypeGraph model2pm, TypeGraph tModel,
			TMethod tMethodName, TMethodDefinition tMethodDefinition, UnresolvedMethodDeclaration _this,
			IsApplicableMatch isApplicableMatch) {
		for (EObject tmpCsp : isApplicableMatch.getAttributeInfo()) {
			if (tmpCsp instanceof CSP) {
				CSP csp = (CSP) tmpCsp;
				return new Object[] { tMethodSignature, mModel, model2pm, tModel, tMethodName, tMethodDefinition, csp,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_bindingAndBlackFFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_11_1_performtransformation_black = pattern_UnresolvedMethodDeclaration_11_1_performtransformation_blackBBBBBBFBB(
					tMethodSignature, mModel, model2pm, tModel, tMethodName, tMethodDefinition, _this,
					isApplicableMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_11_1_performtransformation_greenFBFBB(Model mModel,
		...
		return new Object[] { unresolved2Definiton, mModel, mMethod, tMethodDefinition, csp };
	}
	...
	public static final void pattern_UnresolvedMethodDeclaration_11_5_registerobjects_expressionBBBBBBBBBB(
			...
			EObject tMethodSignature, EObject mModel, EObject model2pm, EObject mMethod, EObject tModel,
			EObject tMethodName, EObject tMethodDefinition) {
		_this.registerObjects_BWD(ruleresult, unresolved2Definiton, tMethodSignature, mModel, model2pm, mMethod, tModel,
				tMethodName, tMethodDefinition);
	...
	public static final Iterable<Object[]> pattern_UnresolvedMethodDeclaration_12_2_corematch_blackBFFBBBB(
		...
		for (ModelToTypeGraph model2pm : org.moflon.core.utilities.eMoflonEMFUtil.getOppositeReferenceTyped(tModel,
			...
			if (mModel != null) {
				_result.add(new Object[] { tMethodSignature, mModel, model2pm, tModel, tMethodName, tMethodDefinition,
						match });
			}
				...
				if (tModel.equals(model2pm.getTarget())) {
					if (tMethodSignature.getDefinitions().contains(tMethodDefinition)) {
						if (tMethodName.getSignatures().contains(tMethodSignature)) {
							_result.add(new Object[] { tMethodSignature, mModel, model2pm, tModel, tMethodName,
									tMethodDefinition });
						}
					}
				}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_3_findcontext_greenBBBBBBFFFFFFFFF(
		...
		tMethodName__tMethodSignature____signatures.setName(tMethodName__tMethodSignature____signatures_name_prime);
		tMethodSignature__tMethodName____method.setName(tMethodSignature__tMethodName____method_name_prime);
		return new Object[] { tMethodSignature, mModel, model2pm, tModel, tMethodName, tMethodDefinition,
				isApplicableMatch, model2pm__mModel____source, tModel__tMethodName____methods,
				tMethodName__tModel____pg, model2pm__tModel____target,
				tMethodSignature__tMethodDefinition____definitions, tMethodDefinition__tMethodSignature____signature,
				tMethodName__tMethodSignature____signatures, tMethodSignature__tMethodName____method };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
			...
			Model mModel, ModelToTypeGraph model2pm, TypeGraph tModel, TMethod tMethodName,
			TMethodDefinition tMethodDefinition) {
		CSP _localVariable_0 = _this.isApplicable_solveCsp_BWD(isApplicableMatch, tMethodSignature, mModel, model2pm,
				tModel, tMethodName, tMethodDefinition);
		CSP csp = _localVariable_0;
		if (csp != null) {
			return new Object[] { csp, _this, isApplicableMatch, tMethodSignature, mModel, model2pm, tModel,
					tMethodName, tMethodDefinition };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingAndBlackFBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_12_4_solveCSP_binding = pattern_UnresolvedMethodDeclaration_12_4_solveCSP_bindingFBBBBBBBB(
				_this, isApplicableMatch, tMethodSignature, mModel, model2pm, tModel, tMethodName, tMethodDefinition);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_0B(
		...
		TAbstractType __DEC_tMethodSignature_returnType_963911 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_963911 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_1BB(
		...
		TSignature __DEC_tMethodDefinition_signature_449733 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_449733 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_449733)) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_20_2_testcorematchandDECs_black_nac_2B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_368536 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_368536 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_153524 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_153524 != null) {
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_590176 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_590176 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_21_2_testcorematchandDECs_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_422927 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_422927 != null) {
			return new Object[] { mMethod };
		}
				...
				if (tmpMMethod instanceof org.eclipse.modisco.java.UnresolvedMethodDeclaration) {
					...
					if (tmpTModel instanceof TypeGraph) {
						...
						if (tmpTMethodName instanceof TMethod) {
							...
							if (tmpTMethodDefinition instanceof TMethodDefinition) {
								TMethodDefinition tMethodDefinition = (TMethodDefinition) tmpTMethodDefinition;
								return new Object[] { tMethodSignature, mModel, mMethod, tModel, tMethodName,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
		...
		if (!sourceMatch.equals(targetMatch)) {
			return new Object[] { tMethodSignature, mModel, mMethod, tModel, tMethodName, tMethodDefinition,
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_bindingAndBlackFFFFFFBB(
		...
		if (result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_binding != null) {
			...
			Object[] result_pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_black = pattern_UnresolvedMethodDeclaration_24_2_matchsrctrgcontext_blackBBBBBBBB(
					tMethodSignature, mModel, mMethod, tModel, tMethodName, tMethodDefinition, sourceMatch,
					targetMatch);
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
			...
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TypeGraph tModel, TMethod tMethodName,
			TMethodDefinition tMethodDefinition, Match sourceMatch, Match targetMatch) {
		CSP _localVariable_6 = _this.isApplicable_solveCsp_CC(tMethodSignature, mModel, mMethod, tModel, tMethodName,
				tMethodDefinition, sourceMatch, targetMatch);
		CSP csp = _localVariable_6;
		if (csp != null) {
			return new Object[] { csp, _this, tMethodSignature, mModel, mMethod, tModel, tMethodName, tMethodDefinition,
					sourceMatch, targetMatch };
		}
		return null;
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingAndBlackFBBBBBBBBB(
		...
		Object[] result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding = pattern_UnresolvedMethodDeclaration_24_3_solvecsp_bindingFBBBBBBBBB(
				_this, tMethodSignature, mModel, mMethod, tModel, tMethodName, tMethodDefinition, sourceMatch,
				targetMatch);
		if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_binding != null) {
			...
			if (result_pattern_UnresolvedMethodDeclaration_24_3_solvecsp_black != null) {
				...
				return new Object[] { csp, _this, tMethodSignature, mModel, mMethod, tModel, tMethodName,
						tMethodDefinition, sourceMatch, targetMatch };
			}
		}
		return null;
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_24_6_createcorrespondence_blackBBBBBBB(
			...
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod, TypeGraph tModel, TMethod tMethodName,
			TMethodDefinition tMethodDefinition, CCMatch ccMatch) {
		return new Object[] { tMethodSignature, mModel, mMethod, tModel, tMethodName, tMethodDefinition, ccMatch };
	}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_0B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AbstractTypeDeclaration __DEC_mMethod_abstractTypeDeclaration_368983 = mMethod.getAbstractTypeDeclaration();
		if (__DEC_mMethod_abstractTypeDeclaration_368983 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_1B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		AnonymousClassDeclaration __DEC_mMethod_anonymousClassDeclarationOwner_92645 = mMethod
				.getAnonymousClassDeclarationOwner();
		if (__DEC_mMethod_anonymousClassDeclarationOwner_92645 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_27_1_matchtggpattern_black_nac_2B(
			org.eclipse.modisco.java.UnresolvedMethodDeclaration mMethod) {
		TypeAccess __DEC_mMethod_returnType_529703 = mMethod.getReturnType();
		if (__DEC_mMethod_returnType_529703 != null) {
			return new Object[] { mMethod };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0B(
			TMethodSignature tMethodSignature) {
		TAbstractType __DEC_tMethodSignature_returnType_335594 = tMethodSignature.getReturnType();
		if (__DEC_tMethodSignature_returnType_335594 != null) {
			return new Object[] { tMethodSignature };
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1BB(
			TMethodDefinition tMethodDefinition, TMethodSignature tMethodSignature) {
		TSignature __DEC_tMethodDefinition_signature_95214 = tMethodDefinition.getSignature();
		if (__DEC_tMethodDefinition_signature_95214 != null) {
			if (!tMethodSignature.equals(__DEC_tMethodDefinition_signature_95214)) {
				return new Object[] { tMethodDefinition, tMethodSignature };
			}
		}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2B(
			TMethodDefinition tMethodDefinition) {
		TAbstractType __DEC_tMethodDefinition_returnType_65127 = tMethodDefinition.getReturnType();
		if (__DEC_tMethodDefinition_returnType_65127 != null) {
			return new Object[] { tMethodDefinition };
		}
					...
					if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_0B(
						...
						if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_1BB(tMethodDefinition,
							...
							if (pattern_UnresolvedMethodDeclaration_28_1_matchtggpattern_black_nac_2B(
									tMethodDefinition) == null) {
								return new Object[] { tMethodSignature, tModel, tMethodName, tMethodDefinition };
							}
						}
					}
				}
	...
	public static final Object[] pattern_UnresolvedMethodDeclaration_29_6_perform_greenFFBFBFFBB(Model mModel,
		...
		return new Object[] { unresolved2Definiton, tMethodSignature, mModel, mMethod, tModel, tMethodName,
