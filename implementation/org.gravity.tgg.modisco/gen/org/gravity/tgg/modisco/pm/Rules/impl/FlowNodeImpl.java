...
public class FlowNodeImpl extends AbstractRuleImpl implements FlowNode {
	...
	public PerformRuleResult perform_FWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result1_green = FlowNodeImpl.pattern_FlowNode_1_1_performtransformation_greenBFBFF(tOwner, mFlow);
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(ruleresult, mOwner,
				tOwner, mOwnerToTOwner, mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow, tFlow);
		...
		FlowNodeImpl.pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, mOwner, tOwner,
				mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow, tFlow);
		...
		// 
		// 
		FlowNodeImpl.pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, mOwner, tOwner,
				mOwnerToTOwner, mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow, tFlow);
	 ...
	 * @generated
	 */
	public void registerObjects_FWD(PerformRuleResult ruleresult, EObject mOwner, EObject tOwner,
			EObject mOwnerToTOwner, EObject mFlowToTFlow, EObject mFlow, EObject mAbstFlowToTAbstFlow, EObject tFlow) {
	...
	public PerformRuleResult perform_BWD(IsApplicableMatch isApplicableMatch) {
		...
		Object[] result3_black = FlowNodeImpl.pattern_FlowNode_11_3_bookkeepingforedges_blackBBBBBBBB(ruleresult,
				mOwner, tOwner, mOwnerToTOwner, mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow, tFlow);
		if (result3_black == null) {
			throw new RuntimeException("Pattern matching failed." + " Variables: " + "[ruleresult] = " + ruleresult
					+ ", " + "[mOwner] = " + mOwner + ", " + "[tOwner] = " + tOwner + ", " + "[mOwnerToTOwner] = "
					+ mOwnerToTOwner + ", " + "[mFlowToTFlow] = " + mFlowToTFlow + ", " + "[mFlow] = " + mFlow + ", "
		...
		FlowNodeImpl.pattern_FlowNode_11_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(ruleresult, mOwner, tOwner,
				mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow, tFlow);
		//nothing EMoflonEdge mOwner__mFlow____ownedFlows = (EMoflonEdge) result3_green[7];
		//nothing EMoflonEdge mFlow__mOwner____flowOwner = (EMoflonEdge) result3_green[8];
		//nothing EMoflonEdge tOwner__tFlow____ownedFlows = (EMoflonEdge) result3_green[9];
		...
		// 
		// 
		FlowNodeImpl.pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(this, ruleresult, mOwner, tOwner,
				mOwnerToTOwner, mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow, tFlow);
	 ...
	 * @generated
	 */
	public void registerObjects_BWD(PerformRuleResult ruleresult, EObject mOwner, EObject tOwner,
			EObject mOwnerToTOwner, EObject mFlowToTFlow, EObject mFlow, EObject mAbstFlowToTAbstFlow, EObject tFlow) {
		ruleresult.registerObject("mOwner", mOwner);
		ruleresult.registerObject("tOwner", tOwner);
		ruleresult.registerObject("mOwnerToTOwner", mOwnerToTOwner);
		...
		for (Object[] result2_black : FlowNodeImpl
			...
			if (FlowNodeImpl.pattern_FlowNode_29_4_checkCSP_expressionFBB(this, csp)) {
				...
				if (result5_black != null) {
					...
					FlowNodeImpl.pattern_FlowNode_29_6_perform_greenBBFFFFB(mOwner, tOwner, ruleResult);
	...
	public static final Object[] pattern_FlowNode_1_1_performtransformation_greenBFBFF(TAbstractFlowElement tOwner,
			MFlow mFlow) {
		...
		return new Object[] { tOwner, mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow, tFlow };
	}
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_blackBBBBBBBB(PerformRuleResult ruleresult,
			EObject mOwner, EObject tOwner, EObject mOwnerToTOwner, EObject mFlowToTFlow, EObject mFlow,
			EObject mAbstFlowToTAbstFlow, EObject tFlow) {
	...
	public static final Object[] pattern_FlowNode_1_3_bookkeepingforedges_greenBBBBBBBFFFFFFFF(
			PerformRuleResult ruleresult, EObject mOwner, EObject tOwner, EObject mFlowToTFlow, EObject mFlow,
			EObject mAbstFlowToTAbstFlow, EObject tFlow) {
		EMoflonEdge mOwner__mFlow____ownedFlows = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		EMoflonEdge mFlow__mOwner____flowOwner = RuntimeFactory.eINSTANCE.createEMoflonEdge();
		...
		return new Object[] { ruleresult, mOwner, tOwner, mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow, tFlow,
				mOwner__mFlow____ownedFlows, mFlow__mOwner____flowOwner, tOwner__tFlow____ownedFlows,
				tFlow__tOwner____flowOwner, mAbstFlowToTAbstFlow__mFlow____source, mFlowToTFlow__mFlow____source,
	...
	public static final void pattern_FlowNode_1_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mOwner, EObject tOwner, EObject mOwnerToTOwner, EObject mFlowToTFlow,
			EObject mFlow, EObject mAbstFlowToTAbstFlow, EObject tFlow) {
		_this.registerObjects_FWD(ruleresult, mOwner, tOwner, mOwnerToTOwner, mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow,
				tFlow);
	...
	public static final void pattern_FlowNode_11_5_registerobjects_expressionBBBBBBBBB(FlowNode _this,
			PerformRuleResult ruleresult, EObject mOwner, EObject tOwner, EObject mOwnerToTOwner, EObject mFlowToTFlow,
			EObject mFlow, EObject mAbstFlowToTAbstFlow, EObject tFlow) {
		_this.registerObjects_BWD(ruleresult, mOwner, tOwner, mOwnerToTOwner, mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow,
				tFlow);
	...
	public static final Object[] pattern_FlowNode_29_6_perform_greenBBFFFFB(MAbstractFlowElement mOwner,
		...
		return new Object[] { mOwner, tOwner, mFlowToTFlow, mFlow, mAbstFlowToTAbstFlow, tFlow, ruleResult };
	}
