...
import org.gravity.security.annotations.ui.SecurityAnnotationsUIActivator;
...
public class SecurityAnnotationsLibraryTests {
	...
	public void testAddAnnotations() throws DuplicateProjectNameException, CoreException, IOException {
		...
		try {
			...
			// Add UMLsec lib
			final var path1 = SecurityAnnotationsUIActivator.applyUMLsecLib(project, monitor);
			...
			final var path2 = SecurityAnnotationsUIActivator.applyUMLsecLib(project, monitor);
