...
public abstract class ConstraintCalculator implements IFitnessCalculator{
	...
	public ViolationsMap  violations(EGraph graph) {
		return violations(Utility.getPG(graph));
	}
	public abstract ViolationsMap violations(TypeGraph graph);
	public abstract ViolationsMap memberLeadsToViolations(TMember member);
