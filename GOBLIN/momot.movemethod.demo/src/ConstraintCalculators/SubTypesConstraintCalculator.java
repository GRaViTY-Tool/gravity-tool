...
private static void fillParentMethods(List<TMethodDefinition> parentMethods, TClass tClass){
	...
	/*
	 * F�r jede Methode a gilt:
	 * wenn von a eine andere Methode b �berschrieben oder versteckt wird:
	...
	/*
	 * F�r jede Methode a gilt:
	 * Methoden m�ssen die gleiche Sichtbarkeit haben wie die Interface Methoden, von denen sie abgeleitet werden
