 ...
 *   <li>{@link org.gravity.typegraph.basic.TypeGraph#getTDeclaredEntities <em>TDeclared Entities</em>}</li>
 * </ul>
 *
...
public interface TypeGraph extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>TDeclared Entities</b></em>' containment reference list.
	 * The list contents are of type {@link org.gravity.typegraph.basic.TDeclaredEntity}.
	 * It is bidirectional and its opposite is '{@link org.gravity.typegraph.basic.TDeclaredEntity#getPg <em>Pg</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>TDeclared Entities</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>TDeclared Entities</em>' containment reference list.
	 * @see org.gravity.typegraph.basic.BasicPackage#getTypeGraph_TDeclaredEntities()
	 * @see org.gravity.typegraph.basic.TDeclaredEntity#getPg
	 * @model opposite="pg" containment="true"
	 * @generated
	 */
	EList<TDeclaredEntity> getTDeclaredEntities();
