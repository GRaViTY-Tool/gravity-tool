...
public class ContainersPackageImpl extends EPackageImpl implements ContainersPackage {
	...
	public static ContainersPackage init() {
		...
		ContainersPackageImpl theContainersPackage = (ContainersPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ContainersPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
	...
	public void initializePackageContents() {
		...
		initEClass(tTypeContainerEClass, TTypeContainer.class, "TTypeContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTTypeContainer_TAbstractTypes(), theBasicPackage.getTAbstractType(), null, "tAbstractTypes",
				null, 0, -1, TTypeContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tAccessContainerEClass, TAccessContainer.class, "TAccessContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTAccessContainer_TAccessEdges(), theBasicPackage.getTAccess(), null, "tAccessEdges", null, 0,
				-1, TAccessContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tMemberContainerEClass, TMemberContainer.class, "TMemberContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTMemberContainer_TMembers(), theBasicPackage.getTMember(), null, "tMembers", null, 0, -1,
				TMemberContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tClassContainerEClass, TClassContainer.class, "TClassContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTClassContainer_TClass(), theBasicPackage.getTClass(), null, "tClass", null, 0, -1,
				TClassContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tFieldContainerEClass, TFieldContainer.class, "TFieldContainer", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTFieldContainer_TFields(), theBasicPackage.getTField(), null, "tFields", null, 0, -1,
				TFieldContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tFieldDefinitionContainerEClass, TFieldDefinitionContainer.class, "TFieldDefinitionContainer",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTFieldDefinitionContainer_TFieldDefinitions(), theBasicPackage.getTFieldDefinition(), null,
				"tFieldDefinitions", null, 0, -1, TFieldDefinitionContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tFieldSignatureContainerEClass, TFieldSignatureContainer.class, "TFieldSignatureContainer",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTFieldSignatureContainer_TFieldSignatures(), theBasicPackage.getTFieldSignature(), null,
				"tFieldSignatures", null, 0, -1, TFieldSignatureContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tSignatureContainerEClass, TSignatureContainer.class, "TSignatureContainer", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTSignatureContainer_TSignatures(), theBasicPackage.getTSignature(), null, "tSignatures", null,
				0, -1, TSignatureContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tMethodDefinitionContainerEClass, TMethodDefinitionContainer.class, "TMethodDefinitionContainer",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTMethodDefinitionContainer_TMethodDefinitions(), theBasicPackage.getTMethodDefinition(), null,
				"tMethodDefinitions", null, 0, -1, TMethodDefinitionContainer.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
