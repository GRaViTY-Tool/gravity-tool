 ...
 * @generated
 */
public class TSignatureContainerImpl extends EObjectImpl implements TSignatureContainer {
	/**
	...
	public EList<TSignature> getTSignatures() {
		if (tSignatures == null) {
			tSignatures = new EObjectResolvingEList<TSignature>(TSignature.class, this,
					ContainersPackage.TSIGNATURE_CONTAINER__TSIGNATURES);
		}
		return tSignatures;
	}
