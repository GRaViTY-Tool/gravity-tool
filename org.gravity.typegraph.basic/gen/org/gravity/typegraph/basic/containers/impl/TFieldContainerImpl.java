 ...
 * @generated
 */
public class TFieldContainerImpl extends EObjectImpl implements TFieldContainer {
	/**
	...
	public EList<TField> getTFields() {
		if (tFields == null) {
			tFields = new EObjectResolvingEList<TField>(TField.class, this,
					ContainersPackage.TFIELD_CONTAINER__TFIELDS);
		}
		return tFields;
	}
