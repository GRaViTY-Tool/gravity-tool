 ...
 * @generated
 */
public class TTypeContainerImpl extends EObjectImpl implements TTypeContainer {
	/**
	...
	public EList<TAbstractType> getTAbstractTypes() {
		if (tAbstractTypes == null) {
			tAbstractTypes = new EObjectResolvingEList<TAbstractType>(TAbstractType.class, this,
					ContainersPackage.TTYPE_CONTAINER__TABSTRACT_TYPES);
		}
