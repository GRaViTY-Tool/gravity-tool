 ...
 * @generated
 */
public class TAccessContainerImpl extends EObjectImpl implements TAccessContainer {
	/**
	...
	public EList<TAccess> getTAccessEdges() {
		if (tAccessEdges == null) {
			tAccessEdges = new EObjectResolvingEList<TAccess>(TAccess.class, this,
					ContainersPackage.TACCESS_CONTAINER__TACCESS_EDGES);
		}
		return tAccessEdges;
	}
