 ...
 * @generated
 */
public class TFieldDefinitionContainerImpl extends EObjectImpl implements TFieldDefinitionContainer {
	/**
	...
	public EList<TFieldDefinition> getTFieldDefinitions() {
		if (tFieldDefinitions == null) {
			tFieldDefinitions = new EObjectResolvingEList<TFieldDefinition>(TFieldDefinition.class, this,
					ContainersPackage.TFIELD_DEFINITION_CONTAINER__TFIELD_DEFINITIONS);
		}
