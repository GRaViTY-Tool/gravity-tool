 ...
 * @generated
 */
public class TMethodDefinitionContainerImpl extends EObjectImpl implements TMethodDefinitionContainer {
	/**
	...
	public EList<TMethodDefinition> getTMethodDefinitions() {
		if (tMethodDefinitions == null) {
			tMethodDefinitions = new EObjectResolvingEList<TMethodDefinition>(TMethodDefinition.class, this,
					ContainersPackage.TMETHOD_DEFINITION_CONTAINER__TMETHOD_DEFINITIONS);
		}
