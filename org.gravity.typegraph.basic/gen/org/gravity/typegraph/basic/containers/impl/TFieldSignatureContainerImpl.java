 ...
 * @generated
 */
public class TFieldSignatureContainerImpl extends EObjectImpl implements TFieldSignatureContainer {
	/**
	...
	public EList<TFieldSignature> getTFieldSignatures() {
		if (tFieldSignatures == null) {
			tFieldSignatures = new EObjectResolvingEList<TFieldSignature>(TFieldSignature.class, this,
					ContainersPackage.TFIELD_SIGNATURE_CONTAINER__TFIELD_SIGNATURES);
		}
