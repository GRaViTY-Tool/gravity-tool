...
public interface ContainersPackage extends EPackage {
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference TFIELD_DEFINITION_CONTAINER__TFIELD_DEFINITIONS = eINSTANCE
				.getTFieldDefinitionContainer_TFieldDefinitions();
		 ...
		 * @generated
		 */
		EReference TFIELD_SIGNATURE_CONTAINER__TFIELD_SIGNATURES = eINSTANCE
				.getTFieldSignatureContainer_TFieldSignatures();
		 ...
		 * @generated
		 */
		EReference TMETHOD_DEFINITION_CONTAINER__TMETHOD_DEFINITIONS = eINSTANCE
				.getTMethodDefinitionContainer_TMethodDefinitions();
